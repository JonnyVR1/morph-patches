...
public final class giy extends fiy {
    ...
    public void mo13950a(@NotNull Context context, @NotNull PurchaseType type, @NotNull d.a detail) {
        ...
        String str = getNumberFormat().format(getPrice());
        detail.l0(getCurrencySymbol() + str);
    }
}
