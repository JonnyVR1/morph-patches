...
public final class ctn0 extends d1q<VoiceLiveManagerInviteItemView> {
    ...
    public ctn0(@NotNull BLiveVoiceManagerInvite bLiveVoiceManagerInvite, @NotNull e30<BLiveVoiceManagerInvite> e30Var) {
    ...
    public void m12844u(@Nullable VoiceLiveManagerInviteItemView itemView) {
        super.u(itemView);
        itemView.getClass();
        itemView.m8808k0(this.itemInfo, false, this.action);
    }
