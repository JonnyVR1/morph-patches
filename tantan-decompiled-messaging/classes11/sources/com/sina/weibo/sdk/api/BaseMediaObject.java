...
public abstract class BaseMediaObject implements Parcelable {
    ...
    public boolean checkArgs() {
        ...
        if (str == null || str.length() > 512) {
            LogUtil.m10830e("Weibo.BaseMediaObject", "checkArgs fail, actionUrl is invalid");
            return false;
        }
        String str2 = this.identify;
        if (str2 == null || str2.length() > 512) {
            LogUtil.m10830e("Weibo.BaseMediaObject", "checkArgs fail, identify is invalid");
            return false;
        }
        ...
        if (bArr == null || bArr.length > 32768) {
            ...
            LogUtil.m10830e("Weibo.BaseMediaObject", sb.toString());
            return false;
        }
        String str3 = this.title;
        if (str3 == null || str3.length() > 512) {
            LogUtil.m10830e("Weibo.BaseMediaObject", "checkArgs fail, title is invalid");
            return false;
        }
        ...
        LogUtil.m10830e("Weibo.BaseMediaObject", "checkArgs fail, description is invalid");
        return false;
    }
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        LogUtil.m10830e("Weibo.BaseMediaObject", "put thumb failed");
