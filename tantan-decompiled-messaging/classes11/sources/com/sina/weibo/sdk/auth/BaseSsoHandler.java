...
public class BaseSsoHandler {
    ...
    private void authorize(int i, WbAuthListener wbAuthListener, AuthType authType) {
        ...
        if (wbAuthListener == null) {
            upk0.a("please set auth listener");
            return;
        }
    ...
    public void authorizeCallBack(int i, int i2, Intent intent) {
        if (32973 == i) {
            ...
            LogUtil.m10829d(TAG, "error: " + strSafeString + ", error_type: " + strSafeString2 + ", error_description: " + strSafeString3);
            if (TextUtils.isEmpty(strSafeString) && TextUtils.isEmpty(strSafeString2) && TextUtils.isEmpty(strSafeString3)) {
                ...
                LogUtil.m10829d(TAG, "Login Success! " + accessToken.toString());
            ...
            if ("access_denied".equals(strSafeString) || "OAuthAccessDeniedException".equals(strSafeString)) {
                LogUtil.m10829d(TAG, "Login canceled by user.");
                this.authListener.cancel();
            } else {
                LogUtil.m10829d(TAG, "Login failed: " + strSafeString);
