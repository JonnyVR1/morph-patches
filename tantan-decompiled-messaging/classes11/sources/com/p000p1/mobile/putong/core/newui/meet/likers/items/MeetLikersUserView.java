...
public final class MeetLikersUserView extends CardView {
    ...
    public static void m4612b(MeetLikersUserView meetLikersUserView, User user, boolean z, View view) {
        zvf0.u("e_meet_see_card", meetLikersUserView.m4616h().pageId(), new j760[]{vwb.Y("other_user_id", ((DbObject) user).id)});
        if (z) {
            CoreModule.P().a().Nn(meetLikersUserView.m4616h(), ((DbObject) user).id, meetLikersUserView, false);
        } else {
            meetLikersUserView.m4616h().startActivityWithCustomTransition(CoreModule.P().a().n8(meetLikersUserView.m4616h(), vwb.f0(new String[]{((DbObject) user).id}), CoreModule.P().a().h7(), (ArrayList) null, "p_meet_see,card_button_pull"), CoreModule.P().a().hg(meetLikersUserView.m4616h()));
        }
    }

    /* JADX INFO: renamed from: e */
    public static void m4613e(e30 e30Var, User user, View view) {
        e30Var.call(user);
    }

    /* JADX INFO: renamed from: i */
    private final void m4614i() {
        xdl0.M0(get_like(), false);
        xdl0.M0(get_dislike(), false);
        xdl0.M(get_verification_icon(), false);
    }

    /* JADX INFO: renamed from: f */
    public final void m4615f(View view) {
        v4y.a(this, view);
    }
    ...
    public final VText get_tv_chat_immediately() {
        ...
        Intrinsics.r("_tv_chat_immediately");
        return null;
    }
    ...
    public final VText get_tv_newlikes_badges() {
        ...
        Intrinsics.r("_tv_newlikes_badges");
        return null;
    }
    ...
    public final VText get_tv_superlike_badges() {
        ...
        Intrinsics.r("_tv_superlike_badges");
        return null;
    }
    ...
    public final VText get_tv_verification_tag() {
        ...
        Intrinsics.r("_tv_verification_tag");
        return null;
    }
    ...
    public final boolean m4617j() {
        return this.userPosition % 2 == 0;
    }

    /* JADX INFO: renamed from: k */
    public final void m4618k(@NotNull p4y meetLikersUserItemData, @NotNull e30<User> actionCallback) {
        meetLikersUserItemData.getClass();
        actionCallback.getClass();
        setMUser(meetLikersUserItemData.getUser());
        m4614i();
        m4621n(getMUser(), actionCallback, meetLikersUserItemData.getCustomTag());
    }

    /* JADX INFO: renamed from: l */
    public final void m4619l(User me, User user) {
        boolean z = ((double) mqi0.m18550o()) - user.location.updatedTime > 1800000.0d;
        if (CoreModule.c.E0.B3(user) || (user.location.distance > 5000 && !z)) {
            xdl0.M(get_distance(), false);
            return;
        }
        xdl0.M(get_distance(), true);
        Region region = user.location.region;
        region.getClass();
        if (user.location.distance >= 10000 && TextUtils.equals(region.city, me.location.region.city) && !TextUtils.isEmpty(region.district)) {
        ...
        if (location.distance >= 10000) {
            ...
            get_distance().setText(i0g0.m16145q(location, true));
        }
    }
    ...
    public final void m4620m(User user, long lastReadTime, String customTag) {
        String str;
        xdl0.M(get_tv_superlike_badges(), false);
        xdl0.M(get_tv_chat_immediately(), false);
        xdl0.M(get_tv_newlikes_badges(), false);
        xdl0.M(get_tv_custom_tag(), false);
        xdl0.M(get_tv_verification_tag(), false);
        if (NullChecker.a(user.localRelationship)) {
            Relationship relationship = user.localRelationship;
            relationship.getClass();
            if (NullChecker.a(relationship.cardInfo)) {
                ...
                if (!vwb.J(swipeCardInfo.cardTypes)) {
                    ...
                    if (swipeCardInfo2.cardTypes.contains("newLikeAfterVerification")) {
                        xdl0.M(get_tv_verification_tag(), true);
                        return;
                    }
                }
            }
        ...
        if (!user.superLikedMe()) {
            if (CoreModule.c.u0.y5(user)) {
                xdl0.M(get_tv_chat_immediately(), true);
                return;
            }
            if (lastReadTime > 0 && NullChecker.a(user.localRelationship)) {
                ...
                if (d < relationship4.updateTime) {
                    ...
                    xdl0.M(get_tv_newlikes_badges(), true);
                    return;
                }
            }
            ...
            xdl0.M(get_tv_custom_tag(), true);
            return;
        }
        if (CoreModule.P().a().sf() && NullChecker.a(user.localRelationship)) {
            Relationship relationship5 = user.localRelationship;
            relationship5.getClass();
            if (NullChecker.a(relationship5.relationshipExtensions)) {
                ...
                if (coreBusinessServiceA.Hl(relationshipExtensions.recvSuperLikedNum) > 1) {
        ...
        xdl0.M(get_tv_superlike_badges(), true);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: n */
    public final void m4621n(final User user, final e30<User> actionCallback, String customTag) {
        boolean zE2 = CoreModule.l.a().e2();
        final boolean z = !zE2;
        User userP9 = CoreModule.c.e0.p9();
        if (zE2 || sb90.Companion.c(user)) {
            qib0.G.O(get_image(), user.fp().profile480().formatted(), 2, 30);
        } else {
            qib0.G.N0(get_image(), user.fp().profile480().formatted(), false);
        }
        Object obj = CoreModule.c.u0.k0.get();
        obj.getClass();
        m4620m(user, ((Number) obj).longValue(), customTag);
        if (zE2) {
            xdl0.M(get_verification_icon(), false);
        } else {
            qib0.b0.b.showUserVerificationLogo(m4616h(), user, get_verification_icon());
        }
        if (zE2) {
            ...
            get_tv_zodiac().setText(tae0.i(user, getContext()));
            get_active().setText(m4616h().string(R.string.N0));
            xdl0.M0(get_active(), tae0.q(user));
            xdl0.M(get_info(), false);
        } else {
            xdl0.M(get_info(), true);
            get_nickname().setText(user.name);
            if (LikersBigCardItemView.s(userP9, user)) {
            ...
            if (TextUtils.isEmpty(strM16138k0)) {
                get_tv_zodiac().setText("");
            } else {
                String strN = LikersBigCardItemView.n(userP9, user);
                if (!TextUtils.isEmpty(strN)) {
                    StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
                    strM16138k0 = strM16138k0 + String.format(" · 喜欢%s", Arrays.copyOf(new Object[]{strN}, 1));
                }
                get_tv_zodiac().setText(strM16138k0);
            }
            userP9.getClass();
            m4619l(userP9, user);
            m4622o(user);
        ...
        get_action_btn().setImageResource(b3c0.m1);
        xdl0.E0(get_action_btn(), new View.OnClickListener() { // from class: l.t4y
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetLikersUserView.m4613e(actionCallback, user, view);
            }
        });
        xdl0.E0(this, new View.OnClickListener() { // from class: l.u4y
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetLikersUserView.m4612b(this.f20993a, user, z, view);
            }
        });
    }

    /* JADX INFO: renamed from: o */
    public final void m4622o(User user) {
        double dM18550o = mqi0.m18550o();
        Location location = user.location;
        boolean z = dM18550o - location.updatedTime <= 1800000.0d;
        boolean z2 = location.distance > 5000;
        if (CoreModule.c.E0.w3(user) || !z2 || !z) {
            get_active().setVisibility(8);
            return;
        }
        get_active().setVisibility(0);
        String string = m4616h().getString(R.string.q1);
        string.getClass();
        String strM18538G = mqi0.m18538G(user.location.updatedTime);
        if (TextUtils.equals(string, strM18538G)) {
            get_active().setText("在线");
            return;
        }
        VText vText = get_active();
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        vText.setText(String.format("%s活跃", Arrays.copyOf(new Object[]{strM18538G}, 1)));
    }
