...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u000e\u0018\u0000 /2\u00020\u0001:\u0001\u001aB'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ/\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\n\u001a\u00020\u00062\u0006\u0010\u000b\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\u0006H\u0014¢\u0006\u0004\b\u000f\u0010\u0010J\u0017\u0010\u0013\u001a\u00020\u000e2\u0006\u0010\u0012\u001a\u00020\u0011H\u0014¢\u0006\u0004\b\u0013\u0010\u0014J\u0015\u0010\u0017\u001a\u00020\u000e2\u0006\u0010\u0016\u001a\u00020\u0015¢\u0006\u0004\b\u0017\u0010\u0018J\u0015\u0010\u001a\u001a\u00020\u000e2\u0006\u0010\u0019\u001a\u00020\u0006¢\u0006\u0004\b\u001a\u0010\u001bR\u0014\u0010\u001e\u001a\u00020\u001c8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001a\u0010\u001dR\u0014\u0010\u001f\u001a\u00020\u001c8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u001dR\u0014\u0010!\u001a\u00020\u001c8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b \u0010\u001dR\u0014\u0010%\u001a\u00020\"8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b#\u0010$R\u0016\u0010(\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b&\u0010'R\"\u0010.\u001a\u00020\u00158\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b)\u0010*\u001a\u0004\b+\u0010,\"\u0004\b-\u0010\u0018¨\u00060"}, d2 = {"Lcom/p1/mobile/putong/core/newui/messages/anim/view/QuickChatBgTopView;", "Landroid/view/View;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "w", "h", "oldw", "oldh", "", "onSizeChanged", "(IIII)V", "Landroid/graphics/Canvas;", "canvas", "onDraw", "(Landroid/graphics/Canvas;)V", "", "show", "b", "(Z)V", "heigh", "a", "(I)V", "Landroid/graphics/Paint;", "Landroid/graphics/Paint;", "paintWhite", "paintTrans", "c", "paintCover", "Landroid/graphics/Rect;", "d", "Landroid/graphics/Rect;", "rectBg", "e", "I", "rount", "f", "Z", "getTipsShow", "()Z", "setTipsShow", "tipsShow", "Companion", "b_core_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class QuickChatBgTopView extends View {

    /* JADX INFO: renamed from: g */
    public static final int f4345g = svq.c(16);

    /* JADX INFO: renamed from: h */
    public static final int f4346h = svq.c(4);

    /* JADX INFO: renamed from: i */
    public static final int f4347i = svq.c(24);

    /* JADX INFO: renamed from: j */
    public static final int f4348j = svq.c(4);

    /* JADX INFO: renamed from: k */
    public static final int f4349k = svq.c(160);
    ...
    public final void m6216a(int heigh) {
        int i;
        int i2 = f4348j;
        if (heigh <= i2) {
            i = f4346h;
            ...
            int i3 = f4347i;
            i = heigh >= i3 ? f4345g : (((heigh - i2) * (f4345g - f4346h)) / (i3 - i2)) + i2;
        }
        this.rount = i;
        ...
        if (z) {
            ...
            paint.setAlpha((int) (127.5f - ((heigh - i2) * (127.5f / (f4349k - i2)))));
        }
        invalidate();
    }

    /* JADX INFO: renamed from: b */
    public final void m6217b(boolean show) {
        ...
        if (show) {
            ...
            int i2 = f4348j;
            paint.setAlpha((int) (127.5f - ((i - i2) * (127.5f / (f4349k - i2)))));
        }
        invalidate();
    }
