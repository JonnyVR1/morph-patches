...
public final class MeetItemLikerHeadDefaultView extends FrameLayout {
    ...
    public MeetItemLikerHeadDefaultView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m7001a(layoutInflaterFrom, this);
        get_title().setTypeface(eqh0.c(3));
    ...
    public final View m7001a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewB = k2y.b(this, inflater, parent);
        viewB.getClass();
        return viewB;
    }
