...
public final class LiveHaloAvatar extends View {
    ...
    public LiveHaloAvatar(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        this.haloSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(e9c0.Y, 0);
    ...
    public static final void m5790c(LiveHaloAvatar liveHaloAvatar, ValueAnimator valueAnimator, ValueAnimator valueAnimator2) {
    ...
    public final void m5791b() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.fss
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                LiveHaloAvatar.m5790c(this.f13156a, valueAnimator, valueAnimator2);
            }
        });
    }

    /* JADX INFO: renamed from: d */
    public final void m5792d(int aSize, int hSize) {
    ...
    public final void m5793e(int haloStartColor, int haloEndColor) {
    ...
    public final void m5794f() {
        m5795g();
        this.animator.start();
    }

    /* JADX INFO: renamed from: g */
    public final void m5795g() {
