...
public class LinearMeasureOrderLayout extends FrameLayout {
    ...
    public LinearMeasureOrderLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f5705a = false;
        this.f5706b = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, g9c0.a);
        this.f5705a = typedArrayObtainStyledAttributes.getBoolean(g9c0.c, false);
        int i2 = typedArrayObtainStyledAttributes.getInt(g9c0.b, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
    ...
    /* JADX INFO: renamed from: a */
    public final View m7982a(int i) {
        return !this.f5705a ? getChildAt(i) : getChildAt((getChildCount() - 1) - i);
    }

    /* JADX INFO: renamed from: b */
    public final void m7983b(int i, int i2) {
    ...
    public final void m7984c(int i, int i2) {
        int childCount = getChildCount();
    ...
    public final void m7985d(int i, int i2) {
        ...
        int iMax = 0;
        while (i5 < childCount) {
            View viewM7982a = this.m7982a(i5);
            if (viewM7982a.getVisibility() == 8) {
                ...
                i3 = i;
                i4 = i2;
                linearMeasureOrderLayout.measureChildWithMargins(viewM7982a, i3, i6, i4, 0);
                int measuredWidth = i6 + viewM7982a.getMeasuredWidth();
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) viewM7982a.getLayoutParams();
                i6 = measuredWidth + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin;
                iMax = Math.max(iMax, viewM7982a.getMeasuredHeight());
            }
            i5++;
        ...
        linearMeasureOrderLayout2.m7987f(i, i2, Math.max(iMax + linearMeasureOrderLayout2.getPaddingTop() + linearMeasureOrderLayout2.getPaddingBottom(), linearMeasureOrderLayout2.getSuggestedMinimumHeight()), Math.max(paddingLeft, linearMeasureOrderLayout2.getSuggestedMinimumWidth()));
    }

    /* JADX INFO: renamed from: e */
    public final void m7986e(int i, int i2) {
        LinearMeasureOrderLayout linearMeasureOrderLayout;
        int i3;
        int i4;
        int childCount = getChildCount();
        ...
        while (i5 < childCount) {
            ...
            if (viewM7982a.getVisibility() == 8) {
                ...
                i3 = i;
                i4 = i2;
                linearMeasureOrderLayout.measureChildWithMargins(viewM7982a, i3, 0, i4, i6);
                int measuredHeight = i6 + viewM7982a.getMeasuredHeight();
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) viewM7982a.getLayoutParams();
                i6 = measuredHeight + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin;
                iMax = Math.max(iMax, viewM7982a.getMeasuredWidth());
            }
            i5++;
            this = linearMeasureOrderLayout;
            i = i3;
        ...
        linearMeasureOrderLayout2.m7987f(i, i2, Math.max(i6 + linearMeasureOrderLayout2.getPaddingTop() + linearMeasureOrderLayout2.getPaddingBottom(), linearMeasureOrderLayout2.getSuggestedMinimumHeight()), Math.max(paddingLeft, linearMeasureOrderLayout2.getSuggestedMinimumWidth()));
    }

    /* JADX INFO: renamed from: f */
    public final void m7987f(int i, int i2, int i3, int i4) {
