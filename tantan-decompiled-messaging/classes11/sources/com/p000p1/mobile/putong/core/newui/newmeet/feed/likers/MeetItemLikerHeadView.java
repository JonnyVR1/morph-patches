...
import com.p000p1.mobile.putong.core.newui.newmeet.feed.likers.MeetItemLikerHeadView;
...
public final class MeetItemLikerHeadView extends FrameLayout {
    ...
    public MeetItemLikerHeadView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        context.getClass();
        this.isNewHeadStyle = CoreModule.P().g().D9();
        LayoutInflater layoutInflaterFrom = LayoutInflater.from(context);
        layoutInflaterFrom.getClass();
        m7003b(layoutInflaterFrom, this);
    }

    /* JADX INFO: renamed from: a */
    public static void m7002a(d30 d30Var, View view) {
        d30Var.call();
    }

    @NotNull
    /* JADX INFO: renamed from: b */
    public final View m7003b(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewB = m2y.b(this, inflater, parent);
        viewB.getClass();
        return viewB;
    }

    /* JADX INFO: renamed from: c */
    public final CharSequence m7004c(User user) {
        String strR0 = zz6.r0(user.location.distance);
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String string = getContext().getString(R.string.b1);
        string.getClass();
        return String.format(string, Arrays.copyOf(new Object[]{strR0}, 1));
    }

    /* JADX INFO: renamed from: d */
    public final void m7005d(boolean hasSVIPPrivilege, int newLikersCount, int likersTotalCount, @Nullable User user) {
        String str;
        CharSequence charSequenceM7004c;
        if (newLikersCount > 0) {
            str = "收到新喜欢 · " + zz6.q0(newLikersCount);
        } else if (hasSVIPPrivilege) {
            str = "喜欢我的人 · " + zz6.q0(likersTotalCount);
        } else {
            str = "解密喜欢我的 " + zz6.q0(likersTotalCount) + "人";
        }
        if (hasSVIPPrivilege) {
            charSequenceM7004c = "TA喜欢了我? 右滑立即配对!";
        } else if (user == null || (charSequenceM7004c = m7004c(user)) == null) {
            charSequenceM7004c = "";
        }
        if (this.isInMyTabStyle) {
            get_meet_head_layout_my_tab_style().m7148b(str);
            xdl0.M(get_title_layout_default(), false);
            xdl0.M(get_meet_head_layout(), false);
            xdl0.M(get_meet_head_layout_my_tab_style(), true);
            return;
        }
        if (this.isNewHeadStyle) {
            get_meet_head_layout().m7146b(Integer.valueOf(b3c0.b1), str, charSequenceM7004c);
            xdl0.M(get_title_layout_default(), false);
            xdl0.M(get_meet_head_layout(), true);
            xdl0.M(get_meet_head_layout_my_tab_style(), false);
            return;
        }
        get_title_layout_default().get_title().setText(str);
        get_title_layout_default().get_subtitle().setText(charSequenceM7004c);
        xdl0.M(get_title_layout_default(), false);
        xdl0.M(get_meet_head_layout(), true);
        xdl0.M(get_meet_head_layout_my_tab_style(), false);
    }
    ...
    public final void m7006e(boolean hasSVIPPrivilege) {
        String str;
        String str2 = hasSVIPPrivilege ? "喜欢我的人" : "解密谁喜欢我";
        if (hasSVIPPrivilege) {
            str = "右滑越多, 配对越多!";
        } else {
            str = "偷偷知晓" + (zz6.u0() ? "他" : "她") + "的心意, 直接配对";
        }
        if (this.isInMyTabStyle) {
            get_meet_head_layout_my_tab_style().m7148b(str2);
            xdl0.M(get_title_layout_default(), false);
            xdl0.M(get_meet_head_layout(), false);
            xdl0.M(get_meet_head_layout_my_tab_style(), true);
            return;
        ...
        if (this.isNewHeadStyle) {
            get_meet_head_layout().m7146b(Integer.valueOf(b3c0.b1), str2, str);
            xdl0.M(get_title_layout_default(), false);
            xdl0.M(get_meet_head_layout(), true);
            xdl0.M(get_meet_head_layout_my_tab_style(), false);
            return;
    ...
    public final void m7007f(boolean isMyTabStyle, @NotNull final d30 e_meet_see_total) {
        e_meet_see_total.getClass();
        this.isInMyTabStyle = isMyTabStyle;
        if (isMyTabStyle) {
            xdl0.E0(get_meet_head_layout_my_tab_style().get_more(), new View.OnClickListener() { // from class: l.l2y
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    MeetItemLikerHeadView.m7002a(e_meet_see_total, view);
                }
            });
        }
    }
    ...
    public final MeetItemEntryHeadView get_meet_head_layout() {
        ...
        Intrinsics.r("_meet_head_layout");
        return null;
    }
    ...
    public final MeetItemEntryHeadViewMyTabStyle get_meet_head_layout_my_tab_style() {
        ...
        Intrinsics.r("_meet_head_layout_my_tab_style");
        return null;
    }
    ...
    public final MeetItemLikerHeadDefaultView get_title_layout_default() {
        ...
        Intrinsics.r("_title_layout_default");
        return null;
    }
