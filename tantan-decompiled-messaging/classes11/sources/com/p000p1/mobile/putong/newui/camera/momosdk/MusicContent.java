package com.p000p1.mobile.putong.newui.camera.momosdk;
...
public class MusicContent implements Parcelable, Serializable {
    public static final Parcelable.Creator<MusicContent> CREATOR = new C0466a();
    ...
    public class C0466a implements Parcelable.Creator<MusicContent> {
    ...
    public MusicContent(Parcel parcel) {
        ...
        this.updatetime = 0L;
        this.f7585id = parcel.readString();
    ...
    public void setData(MusicContent musicContent) {
        this.f7585id = musicContent.f7585id;
    ...
    public String toString() {
        return "MusicContent{id='" + this.f7585id + "', size=" + this.size + ", type=" + this.type + ", name='" + this.name + "', uri='" + this.uri + "', path='" + this.path + "', length=" + this.length + ", album='" + this.album + "', artist='" + this.artist + "', startMillTime=" + this.startMillTime + ", endMillTime=" + this.endMillTime + ", musicType=" + this.musicType + ", source=" + this.source + '}';
    }
    ...
    public void setData(JSONObject jSONObject) {
        if (jSONObject != null) {
            this.f7585id = jSONObject.optString("music_id", null);
            this.name = jSONObject.optString("title");
            setUri(jSONObject.optString("url"));
            this.musicType = jSONObject.optString(MiniWidgetProvider.KEY_TYPE);
