package com.p000p1.mobile.putong.live.livingroom.voice.membermanager.requestsettlein;
...
public final class MemberRequestSettleInView extends ConstraintLayout {
    ...
    public static final class Companion {
        ...
        public final MemberRequestSettleInView m8875a(@NotNull LayoutInflater inflater) {
            inflater.getClass();
            Object objInflate = inflater.inflate(t6c0.U3, (ViewGroup) null, false);
            objInflate.getClass();
            return (MemberRequestSettleInView) objInflate;
        }
    ...
    public static final MemberRequestSettleInView m8869i0(@NotNull LayoutInflater layoutInflater) {
        return INSTANCE.m8875a(layoutInflater);
    }
    ...
    public final void m8870h0(View view) {
        xdy.a(this, view);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m8871j0(@NotNull way memberAdapter) {
    ...
    public final void m8872k0(@NotNull way memberAdapter) {
        memberAdapter.getClass();
        m8871j0(memberAdapter);
    }

    /* JADX INFO: renamed from: l0 */
    public final void m8873l0(int position, @NotNull List<? extends BLiveVoiceSettle> newData) {
        newData.getClass();
        xdl0.M(get_empty(), newData.size() <= 1);
        xdl0.M(get_recyclerView(), newData.size() > 1);
        if (get_recyclerView().getAdapter() != null) {
            way adapter = get_recyclerView().getAdapter();
            adapter.getClass();
            adapter.m24040H(position, newData);
        }
    }

    /* JADX INFO: renamed from: m0 */
    public final void m8874m0(boolean empty) {
        xdl0.M(get_empty(), empty);
        xdl0.M(get_recyclerView(), !empty);
    }
