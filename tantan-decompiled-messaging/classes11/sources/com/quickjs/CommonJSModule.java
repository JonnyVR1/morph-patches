...
public abstract class CommonJSModule extends Module {
    ...
    public CommonJSModule(QuickJS quickJS) {
        ...
        registerJavaMethod(new JavaCallback() { // from class: l.uj5
            ...
            public final Object invoke(JSObject jSObject, JSArray jSArray) {
                return CommonJSModule.m10690i(this.f21209a, jSObject, jSArray);
            }
        }, "require");
    }
    ...
    public static /* synthetic */ Object m10690i(CommonJSModule commonJSModule, JSObject jSObject, JSArray jSArray) {
        String string;
