...
public class QuickJS implements Closeable {
    ...
    public static /* synthetic */ void m10723b(QuickJS quickJS) {
        if (quickJS.released) {
            return;
        }
    ...
    public static QuickJS createRuntimeWithEventQueue() {
        ...
        new Handler(handlerThread.getLooper()).post(new Runnable() { // from class: l.myb0
            ...
            public final void run() {
                QuickJS.m10724d(objArr, handlerThread);
            }
        });
        synchronized (objArr) {
            try {
    ...
    public static /* synthetic */ void m10724d(Object[] objArr, HandlerThread handlerThread) {
