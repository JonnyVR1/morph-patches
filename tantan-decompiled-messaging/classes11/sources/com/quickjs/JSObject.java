...
public class JSObject extends JSValue {
                ...
                if (method.getReturnType().equals(Void.TYPE)) {
                    jSObject.registerJavaMethod(new JavaVoidCallback() { // from class: l.yiq
                        ...
                        public final void invoke(JSObject jSObject2, JSArray jSArray) {
                            JSObject.m10720b(method, obj, jSObject2, jSArray);
                        }
                    }, name);
                } else {
                    jSObject.registerJavaMethod(new JavaCallback() { // from class: l.ziq
                        ...
                        public final Object invoke(JSObject jSObject2, JSArray jSArray) {
                            return JSObject.m10721d(method, obj, jSObject2, jSArray);
                        }
                    }, name);
                }
            }
    ...
    public static /* synthetic */ void m10720b(Method method, Object obj, JSObject jSObject, JSArray jSArray) {
        try {
    ...
    public static /* synthetic */ Object m10721d(Method method, Object obj, JSObject jSObject, JSArray jSArray) {
        try {
    ...
    public static /* synthetic */ Object m10722e(JavaConstructorCallback javaConstructorCallback, JSObject jSObject, JSArray jSArray) {
    ...
    public JSFunction registerClass(final JavaConstructorCallback javaConstructorCallback, String str) {
        JavaCallback javaCallback = new JavaCallback() { // from class: l.ajq
            ...
            public final Object invoke(JSObject jSObject, JSArray jSArray) {
                return JSObject.m10722e(javaConstructorCallback, jSObject, jSArray);
            }
        };
