...
public class CommonTipBox extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CommonTipBox> PROTOBUF_ADAPTER = new MessageNanoAdapter<CommonTipBox>() { // from class: com.p1.mobile.putong.core.data.CommonTipBox.1
        ...
        public int computeAndCacheSize(CommonTipBox commonTipBox) {
            ...
            ((MessageNano) commonTipBox).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public CommonTipBox m12229parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    commonTipBox.type = nb5Var.s();
                } else if (iU == 18) {
                    commonTipBox.title = nb5Var.s();
                } else if (iU == 26) {
                    commonTipBox.subtitle = nb5Var.s();
                } else if (iU == 34) {
                    commonTipBox.iconUrl = nb5Var.s();
                } else if (iU == 42) {
                    commonTipBox.button = nb5Var.s();
                } else if (iU == 50) {
                    commonTipBox.schema = nb5Var.s();
                } else if (iU == 58) {
                    commonTipBox.disabledButton = nb5Var.s();
                } else if (iU == 66) {
                    commonTipBox.statsModuleId = nb5Var.s();
                } else {
                    if (iU != 74) {
                        if (commonTipBox.type == null) {
                            commonTipBox.type = "";
                    ...
                    commonTipBox.statsModuleParameter = nb5Var.s();
                }
            }
            return commonTipBox;
        }
    ...
    public static JsonAdapter<CommonTipBox> JSON_ADAPTER = new ObjectJsonAdapter<CommonTipBox>() { // from class: com.p1.mobile.putong.core.data.CommonTipBox.2
        ...
        public CommonTipBox m12230newInstance() {
        ...
        public void serializeFields(CommonTipBox commonTipBox, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str5 = commonTipBox.button;
            if (str5 != null) {
                jsonGenerator.writeStringField(Button.TYPE, str5);
            }
            String str6 = commonTipBox.schema;
            if (str6 != null) {
    ...
    public CommonTipBox m12228clone() {
        CommonTipBox commonTipBox = new CommonTipBox();
