...
public class Literatures extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Literatures> PROTOBUF_ADAPTER = new MessageNanoAdapter<Literatures>() { // from class: com.p1.mobile.putong.core.data.Literatures.1
        ...
        public int computeAndCacheSize(Literatures literatures) {
            ...
            String str5 = literatures.f95id;
            if (str5 != null) {
                iO += CodedOutputByteBufferNano.o(7, str5);
            }
            ((MessageNano) literatures).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Literatures m13915parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    literatures.title = nb5Var.s();
                } else if (iU == 18) {
                    literatures.category = nb5Var.s();
                } else if (iU == 26) {
                    literatures.headUrl = nb5Var.s();
                } else if (iU == 34) {
                    literatures.kinds = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 42) {
                    literatures.bgColor = nb5Var.s();
                } else if (iU == 50) {
                    literatures.authors = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iU != 58) {
                        if (literatures.title == null) {
                            literatures.title = "";
    ...
    public static JsonAdapter<Literatures> JSON_ADAPTER = new ObjectJsonAdapter<Literatures>() { // from class: com.p1.mobile.putong.core.data.Literatures.2
        ...
        public Literatures m13916newInstance() {
        ...
        public boolean parseField(Literatures literatures, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "bgColor":
                    ...
                    return true;
                case "id":
                    literatures.f95id = jsonParser.getValueAsString();
                    return false;
                case "category":
    ...
    public static /* synthetic */ String m449a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m450b(String str) {
        return str;
    }
    ...
    public Literatures m13914clone() {
        Literatures literatures = new Literatures();
        ...
        if (list != null) {
            literatures.kinds = ValueObject.util_map(list, new w9j() { // from class: l.for
                public final Object call(Object obj) {
                    return Literatures.m450b((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            literatures.authors = ValueObject.util_map(list2, new w9j() { // from class: l.gor
                public final Object call(Object obj) {
                    return Literatures.m449a((String) obj);
                }
            });
        }
        literatures.f95id = this.f95id;
        return literatures;
    }
