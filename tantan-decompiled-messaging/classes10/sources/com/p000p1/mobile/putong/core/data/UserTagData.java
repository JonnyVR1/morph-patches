...
public class UserTagData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserTagData> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserTagData>() { // from class: com.p1.mobile.putong.core.data.UserTagData.1
        ...
        public int computeAndCacheSize(UserTagData userTagData) {
            ...
            int iB = iO + CodedOutputByteBufferNano.b(5, userTagData.highlighted);
            ...
            if (str6 != null) {
                iB += CodedOutputByteBufferNano.o(8, str6);
            }
            int iH = iB + CodedOutputByteBufferNano.h(9, userTagData.index) + CodedOutputByteBufferNano.h(10, userTagData.count);
            ((MessageNano) userTagData).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public UserTagData m16188parse(nb5 nb5Var) throws IOException {
            UserTagData userTagData = new UserTagData();
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        if (userTagData.f189id == null) {
                            userTagData.f189id = "";
                        }
                    ...
                    case Conversation.SURPRISE_LEVEL_TOP /* 10 */:
                        userTagData.f189id = nb5Var.s();
                        continue;
                    case 18:
                        userTagData.title = nb5Var.s();
                        continue;
                    case 26:
                        userTagData.icon = nb5Var.s();
                        continue;
                    case 34:
                        userTagData.subtitle = nb5Var.s();
                        continue;
                    case 40:
                        userTagData.highlighted = nb5Var.g();
                        continue;
                    case Conversation.EXPOSURE_LEVEL_TOP /* 50 */:
                        userTagData.categories = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        userTagData.status = nb5Var.s();
                        continue;
                    case 66:
                        userTagData.gender = nb5Var.s();
                        continue;
                    case 72:
                        userTagData.index = nb5Var.j();
                        continue;
                    case 80:
                        userTagData.count = nb5Var.j();
                        continue;
                    default:
                        if (userTagData.f189id == null) {
                            userTagData.f189id = "";
        ...
        public void serialize(UserTagData userTagData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(5, userTagData.highlighted);
            List<String> list = userTagData.categories;
            if (list != null) {
            ...
            codedOutputByteBufferNano.G(9, userTagData.index);
            codedOutputByteBufferNano.G(10, userTagData.count);
        }
    };
    public static JsonAdapter<UserTagData> JSON_ADAPTER = new ObjectJsonAdapter<UserTagData>() { // from class: com.p1.mobile.putong.core.data.UserTagData.2
        ...
        public UserTagData m16189newInstance() {
        ...
        public boolean parseField(UserTagData userTagData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    userTagData.f189id = jsonParser.getValueAsString();
                    return false;
                case "icon":
        ...
        public void serializeFields(UserTagData userTagData, JsonGenerator jsonGenerator) throws IOException {
            ...
            jsonGenerator.writeNumberField("index", userTagData.index);
    ...
    public static /* synthetic */ String m699a(String str) {
        return str;
    }
    ...
    public UserTagData m16187clone() {
        UserTagData userTagData = new UserTagData();
        userTagData.f189id = this.f189id;
        ...
        if (list != null) {
            userTagData.categories = ValueObject.util_map(list, new w9j() { // from class: l.z9k0
                public final Object call(Object obj) {
                    return UserTagData.m699a((String) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f189id, userTagData.f189id) && ValueObject.util_equals(this.title, userTagData.title) && ValueObject.util_equals(this.icon, userTagData.icon) && ValueObject.util_equals(this.subtitle, userTagData.subtitle) && this.highlighted == userTagData.highlighted && ValueObject.util_equals(this.categories, userTagData.categories) && ValueObject.util_equals(this.status, userTagData.status) && ValueObject.util_equals(this.gender, userTagData.gender) && this.index == userTagData.index && this.count == userTagData.count;
    }
