...
public class ProfileZodiac extends TEnum {
    ...
    static {
        TEnumJsonAdapter<ProfileZodiac> tEnumJsonAdapter = new TEnumJsonAdapter<ProfileZodiac>() { // from class: com.p1.mobile.putong.core.data.ProfileZodiac.1
            /* JADX INFO: renamed from: newTEnum, reason: merged with bridge method [inline-methods] */
            public ProfileZodiac m15043newTEnum(String str, int i) {
                return ProfileZodiac.getForData(str, i);
            }
        };
        JSON_ADAPTER = tEnumJsonAdapter;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new TEnumProtobufAdapter<ProfileZodiac>() { // from class: com.p1.mobile.putong.core.data.ProfileZodiac.2
            /* JADX INFO: renamed from: newTEnum, reason: merged with bridge method [inline-methods] */
            public ProfileZodiac m15044newTEnum(String str, int i) {
                return ProfileZodiac.getForData(str, i);
            }
        };
        tEnumJsonAdapter.addExtJsonValue("unknown_", int_unknown_);
        tEnumJsonAdapter.addExtJsonValue(aries, int_aries);
        ...
        tEnumJsonAdapter.addExtJsonValue(leo, int_leo);
        tEnumJsonAdapter.addExtJsonValue(virgo, 5);
        tEnumJsonAdapter.addExtJsonValue(libra, int_libra);
        tEnumJsonAdapter.addExtJsonValue(scorpio, int_scorpio);
        tEnumJsonAdapter.addExtJsonValue(sagittarius, int_sagittarius);
        tEnumJsonAdapter.addExtJsonValue(capricorn, int_capricorn);
        tEnumJsonAdapter.addExtJsonValue(aquarius, 10);
        tEnumJsonAdapter.addExtJsonValue(pisces, int_pisces);
        ...
        _ProfileZodiac = Collections.synchronizedMap(new e01());
    }
    ...
    public static ProfileZodiac get(String str) {
        ...
        if (profileZodiac == null) {
            ...
            profileZodiac = integer == null ? new ProfileZodiac(str, int_unknown_) : new ProfileZodiac(str, integer.intValue());
