...
public class TtcMigrateDisplayUserInfoData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TtcMigrateDisplayUserInfoData> PROTOBUF_ADAPTER = new MessageNanoAdapter<TtcMigrateDisplayUserInfoData>() { // from class: com.p1.mobile.putong.core.data.TtcMigrateDisplayUserInfoData.1
        ...
        public int computeAndCacheSize(TtcMigrateDisplayUserInfoData ttcMigrateDisplayUserInfoData) {
            ...
            String str3 = ttcMigrateDisplayUserInfoData.f186id;
            if (str3 != null) {
                iO += CodedOutputByteBufferNano.o(3, str3);
            }
            int iJ = iO + CodedOutputByteBufferNano.j(4, ttcMigrateDisplayUserInfoData.matchNum) + CodedOutputByteBufferNano.j(5, ttcMigrateDisplayUserInfoData.likedYouNum);
            ((MessageNano) ttcMigrateDisplayUserInfoData).cachedSize = iJ;
            return iJ;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public TtcMigrateDisplayUserInfoData m16064parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 0) {
                    ...
                    if (ttcMigrateDisplayUserInfoData.f186id != null) {
                        break;
                    }
                    ttcMigrateDisplayUserInfoData.f186id = "";
                    break;
                }
                if (iU == 10) {
                    ttcMigrateDisplayUserInfoData.nickname = nb5Var.s();
                } else if (iU == 18) {
                    ttcMigrateDisplayUserInfoData.avatar = nb5Var.s();
                } else if (iU == 26) {
                    ttcMigrateDisplayUserInfoData.f186id = nb5Var.s();
                } else if (iU == 32) {
                    ttcMigrateDisplayUserInfoData.matchNum = nb5Var.k();
                } else {
                    if (iU != 40) {
                        if (ttcMigrateDisplayUserInfoData.nickname == null) {
                            ttcMigrateDisplayUserInfoData.nickname = "";
                    ...
                    ttcMigrateDisplayUserInfoData.likedYouNum = nb5Var.k();
                }
            }
            return ttcMigrateDisplayUserInfoData;
        }
        ...
        public void serialize(TtcMigrateDisplayUserInfoData ttcMigrateDisplayUserInfoData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.I(4, ttcMigrateDisplayUserInfoData.matchNum);
            codedOutputByteBufferNano.I(5, ttcMigrateDisplayUserInfoData.likedYouNum);
        }
    };
    public static JsonAdapter<TtcMigrateDisplayUserInfoData> JSON_ADAPTER = new ObjectJsonAdapter<TtcMigrateDisplayUserInfoData>() { // from class: com.p1.mobile.putong.core.data.TtcMigrateDisplayUserInfoData.2
        ...
        public TtcMigrateDisplayUserInfoData m16065newInstance() {
        ...
        public boolean parseField(TtcMigrateDisplayUserInfoData ttcMigrateDisplayUserInfoData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "avatar":
                    ...
                    return true;
                case "id":
                    ttcMigrateDisplayUserInfoData.f186id = jsonParser.getValueAsString();
                    return false;
                case "nickname":
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.nickname, ttcMigrateDisplayUserInfoData.nickname) && ValueObject.util_equals(this.avatar, ttcMigrateDisplayUserInfoData.avatar) && ValueObject.util_equals(this.f186id, ttcMigrateDisplayUserInfoData.f186id) && this.matchNum == ttcMigrateDisplayUserInfoData.matchNum && this.likedYouNum == ttcMigrateDisplayUserInfoData.likedYouNum;
    }
