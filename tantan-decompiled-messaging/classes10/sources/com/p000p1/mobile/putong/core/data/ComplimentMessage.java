...
import com.p1.mobile.putong.data.AIPosition;
...
public class ComplimentMessage {
    ...
    private static ComplimentMessageMedia convertMedia(Media media) {
        ...
        complimentMessageMedia.status = mediaLocalStatus != null ? mediaLocalStatus.toString() : StickStatus.normal;
        ...
        int[] iArr3 = new int[2];
        if (aIPosition != null) {
            iArr3[0] = aIPosition.x;
            iArr3[1] = aIPosition.y;
        } else {
            iArr3[0] = 0;
            iArr3[1] = 0;
        }
    ...
    public String toJson() {
        try {
            ...
            pkq0.a("ComplimentMessage.toJson failed", e);
            return null;
        }
    }
}
