...
public class HideAndSeekPushData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<HideAndSeekPushData> PROTOBUF_ADAPTER = new MessageNanoAdapter<HideAndSeekPushData>() { // from class: com.p1.mobile.putong.core.data.HideAndSeekPushData.1
        ...
        public int computeAndCacheSize(HideAndSeekPushData hideAndSeekPushData) {
            ...
            int iL = list != null ? CodedOutputByteBufferNano.l(1, list, GameData.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            GameStage gameStage = hideAndSeekPushData.gameStage;
            if (gameStage != null) {
                iL += CodedOutputByteBufferNano.l(2, gameStage, GameStage.PROTOBUF_ADAPTER);
            }
            int iH = iL + CodedOutputByteBufferNano.h(3, hideAndSeekPushData.mouseCount);
            ((MessageNano) hideAndSeekPushData).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public HideAndSeekPushData m13287parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    hideAndSeekPushData.players = (List) nb5Var.l(GameData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 18) {
                    hideAndSeekPushData.gameStage = (GameStage) nb5Var.l(GameStage.PROTOBUF_ADAPTER);
                } else {
                    if (iU != 24) {
                        if (hideAndSeekPushData.players == null) {
                            hideAndSeekPushData.players = new ArrayList();
                    ...
                    hideAndSeekPushData.mouseCount = nb5Var.j();
                }
            }
            return hideAndSeekPushData;
        }
        ...
        public void serialize(HideAndSeekPushData hideAndSeekPushData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<GameData> list = hideAndSeekPushData.players;
            if (list != null) {
                codedOutputByteBufferNano.K(1, list, GameData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GameStage gameStage = hideAndSeekPushData.gameStage;
            if (gameStage != null) {
                codedOutputByteBufferNano.K(2, gameStage, GameStage.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(3, hideAndSeekPushData.mouseCount);
        }
    };
    public static JsonAdapter<HideAndSeekPushData> JSON_ADAPTER = new ObjectJsonAdapter<HideAndSeekPushData>() { // from class: com.p1.mobile.putong.core.data.HideAndSeekPushData.2
        ...
        public HideAndSeekPushData m13288newInstance() {
        ...
        public boolean parseField(HideAndSeekPushData hideAndSeekPushData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "mouseCount":
                    ...
                    return true;
                case "gameStage":
                    hideAndSeekPushData.gameStage = (GameStage) GameStage.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                default:
                    return false;
            }
