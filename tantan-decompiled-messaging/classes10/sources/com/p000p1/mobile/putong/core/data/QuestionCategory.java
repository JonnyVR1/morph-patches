...
public class QuestionCategory extends TEnum {
    ...
    static {
        TEnumJsonAdapter<QuestionCategory> tEnumJsonAdapter = new TEnumJsonAdapter<QuestionCategory>() { // from class: com.p1.mobile.putong.core.data.QuestionCategory.1
            ...
            public QuestionCategory m15117newTEnum(String str, int i) {
        ...
        PROTOBUF_ADAPTER = new TEnumProtobufAdapter<QuestionCategory>() { // from class: com.p1.mobile.putong.core.data.QuestionCategory.2
            /* JADX INFO: renamed from: newTEnum, reason: merged with bridge method [inline-methods] */
            public QuestionCategory m15118newTEnum(String str, int i) {
                return QuestionCategory.getForData(str, i);
            }
        };
        tEnumJsonAdapter.addExtJsonValue("unknown_", int_unknown_);
        tEnumJsonAdapter.addExtJsonValue("intimate", int_intimate);
        ...
        tEnumJsonAdapter.addExtJsonValue(newMaleQuestion, int_newMaleQuestion);
        ...
        _QuestionCategory = Collections.synchronizedMap(new e01());
    }
    ...
    public static QuestionCategory get(String str) {
        ...
        if (questionCategory == null) {
            ...
            questionCategory = integer == null ? new QuestionCategory(str, int_unknown_) : new QuestionCategory(str, integer.intValue());
