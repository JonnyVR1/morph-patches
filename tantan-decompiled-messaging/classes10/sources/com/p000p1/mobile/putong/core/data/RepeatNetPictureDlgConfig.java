...
public class RepeatNetPictureDlgConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RepeatNetPictureDlgConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<RepeatNetPictureDlgConfig>() { // from class: com.p1.mobile.putong.core.data.RepeatNetPictureDlgConfig.1
        ...
        public int computeAndCacheSize(RepeatNetPictureDlgConfig repeatNetPictureDlgConfig) {
            ...
            int iL = repeatNetPictureDlgContent != null ? CodedOutputByteBufferNano.l(1, repeatNetPictureDlgContent, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER) : 0;
            ...
            if (repeatNetPictureDlgContent2 != null) {
                iL += CodedOutputByteBufferNano.l(2, repeatNetPictureDlgContent2, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            ...
            if (repeatNetPictureDlgContent3 != null) {
                iL += CodedOutputByteBufferNano.l(3, repeatNetPictureDlgContent3, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureTrigger repeatNetPictureTrigger = repeatNetPictureDlgConfig.trigger;
            if (repeatNetPictureTrigger != null) {
                iL += CodedOutputByteBufferNano.l(4, repeatNetPictureTrigger, RepeatNetPictureTrigger.PROTOBUF_ADAPTER);
            }
            ...
            if (repeatNetPictureDlgContent4 != null) {
                iL += CodedOutputByteBufferNano.l(5, repeatNetPictureDlgContent4, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            int iB = iL + CodedOutputByteBufferNano.b(6, repeatNetPictureDlgConfig.enable);
            ((MessageNano) repeatNetPictureDlgConfig).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public RepeatNetPictureDlgConfig m15399parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    repeatNetPictureDlgConfig.repeatPictureDlg = (RepeatNetPictureDlgContent) nb5Var.l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else if (iU == 18) {
                    repeatNetPictureDlgConfig.netPictureDlg = (RepeatNetPictureDlgContent) nb5Var.l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else if (iU == 26) {
                    repeatNetPictureDlgConfig.swipeLimitDlg = (RepeatNetPictureDlgContent) nb5Var.l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else if (iU == 34) {
                    repeatNetPictureDlgConfig.trigger = (RepeatNetPictureTrigger) nb5Var.l(RepeatNetPictureTrigger.PROTOBUF_ADAPTER);
                } else if (iU == 42) {
                    repeatNetPictureDlgConfig.aiPictureDlg = (RepeatNetPictureDlgContent) nb5Var.l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else {
                    if (iU != 48) {
                        if (repeatNetPictureDlgConfig.repeatPictureDlg == null) {
                            repeatNetPictureDlgConfig.repeatPictureDlg = RepeatNetPictureDlgContent.new_();
                    ...
                    repeatNetPictureDlgConfig.enable = nb5Var.g();
                }
            }
            return repeatNetPictureDlgConfig;
        }
        ...
        public void serialize(RepeatNetPictureDlgConfig repeatNetPictureDlgConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (repeatNetPictureDlgContent != null) {
                codedOutputByteBufferNano.K(1, repeatNetPictureDlgContent, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureDlgContent repeatNetPictureDlgContent2 = repeatNetPictureDlgConfig.netPictureDlg;
            if (repeatNetPictureDlgContent2 != null) {
                codedOutputByteBufferNano.K(2, repeatNetPictureDlgContent2, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureDlgContent repeatNetPictureDlgContent3 = repeatNetPictureDlgConfig.swipeLimitDlg;
            if (repeatNetPictureDlgContent3 != null) {
                codedOutputByteBufferNano.K(3, repeatNetPictureDlgContent3, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureTrigger repeatNetPictureTrigger = repeatNetPictureDlgConfig.trigger;
            if (repeatNetPictureTrigger != null) {
                codedOutputByteBufferNano.K(4, repeatNetPictureTrigger, RepeatNetPictureTrigger.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureDlgContent repeatNetPictureDlgContent4 = repeatNetPictureDlgConfig.aiPictureDlg;
            if (repeatNetPictureDlgContent4 != null) {
                codedOutputByteBufferNano.K(5, repeatNetPictureDlgContent4, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(6, repeatNetPictureDlgConfig.enable);
        }
    };
    public static JsonAdapter<RepeatNetPictureDlgConfig> JSON_ADAPTER = new ObjectJsonAdapter<RepeatNetPictureDlgConfig>() { // from class: com.p1.mobile.putong.core.data.RepeatNetPictureDlgConfig.2
        ...
        public RepeatNetPictureDlgConfig m15400newInstance() {
        ...
        public boolean parseField(RepeatNetPictureDlgConfig repeatNetPictureDlgConfig, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "enable":
                    ...
                    return true;
                case "trigger":
                    repeatNetPictureDlgConfig.trigger = (RepeatNetPictureTrigger) RepeatNetPictureTrigger.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "aiPictureDlg":
                    repeatNetPictureDlgConfig.aiPictureDlg = (RepeatNetPictureDlgContent) RepeatNetPictureDlgContent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "netPictureDlg":
                    repeatNetPictureDlgConfig.netPictureDlg = (RepeatNetPictureDlgContent) RepeatNetPictureDlgContent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "repeatPictureDlg":
                    repeatNetPictureDlgConfig.repeatPictureDlg = (RepeatNetPictureDlgContent) RepeatNetPictureDlgContent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "swipeLimitDlg":
                    repeatNetPictureDlgConfig.swipeLimitDlg = (RepeatNetPictureDlgContent) RepeatNetPictureDlgContent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public RepeatNetPictureDlgConfig m15398clone() {
        RepeatNetPictureDlgConfig repeatNetPictureDlgConfig = new RepeatNetPictureDlgConfig();
        RepeatNetPictureDlgContent repeatNetPictureDlgContent = this.repeatPictureDlg;
        if (repeatNetPictureDlgContent != null) {
            repeatNetPictureDlgConfig.repeatPictureDlg = repeatNetPictureDlgContent.m15402clone();
        }
        RepeatNetPictureDlgContent repeatNetPictureDlgContent2 = this.netPictureDlg;
        if (repeatNetPictureDlgContent2 != null) {
            repeatNetPictureDlgConfig.netPictureDlg = repeatNetPictureDlgContent2.m15402clone();
        }
        RepeatNetPictureDlgContent repeatNetPictureDlgContent3 = this.swipeLimitDlg;
        if (repeatNetPictureDlgContent3 != null) {
            repeatNetPictureDlgConfig.swipeLimitDlg = repeatNetPictureDlgContent3.m15402clone();
        }
        RepeatNetPictureTrigger repeatNetPictureTrigger = this.trigger;
        if (repeatNetPictureTrigger != null) {
            repeatNetPictureDlgConfig.trigger = repeatNetPictureTrigger.m15406clone();
        }
        RepeatNetPictureDlgContent repeatNetPictureDlgContent4 = this.aiPictureDlg;
        if (repeatNetPictureDlgContent4 != null) {
            repeatNetPictureDlgConfig.aiPictureDlg = repeatNetPictureDlgContent4.m15402clone();
        }
