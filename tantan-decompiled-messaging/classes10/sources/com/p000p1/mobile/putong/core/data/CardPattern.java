...
public class CardPattern extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CardPattern> PROTOBUF_ADAPTER = new MessageNanoAdapter<CardPattern>() { // from class: com.p1.mobile.putong.core.data.CardPattern.1
        ...
        public int computeAndCacheSize(CardPattern cardPattern) {
            ...
            if (cardPatternCombinedIcon != null) {
                iO += CodedOutputByteBufferNano.l(2, cardPatternCombinedIcon, CardPatternCombinedIcon.PROTOBUF_ADAPTER);
            }
            CardPatternOptionIcon cardPatternOptionIcon = cardPattern.lowerRightIcon;
            if (cardPatternOptionIcon != null) {
                iO += CodedOutputByteBufferNano.l(3, cardPatternOptionIcon, CardPatternOptionIcon.PROTOBUF_ADAPTER);
            }
            CardPatternBottomContent cardPatternBottomContent = cardPattern.bottomContent;
            if (cardPatternBottomContent != null) {
                iO += CodedOutputByteBufferNano.l(4, cardPatternBottomContent, CardPatternBottomContent.PROTOBUF_ADAPTER);
            }
            ...
            if (list != null) {
                iO += CodedOutputByteBufferNano.l(7, list, CardOption.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ((MessageNano) cardPattern).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public CardPattern m11899parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    cardPattern.userId = nb5Var.s();
                } else if (iU == 18) {
                    cardPattern.topleftIcon = (CardPatternCombinedIcon) nb5Var.l(CardPatternCombinedIcon.PROTOBUF_ADAPTER);
                } else if (iU == 26) {
                    cardPattern.lowerRightIcon = (CardPatternOptionIcon) nb5Var.l(CardPatternOptionIcon.PROTOBUF_ADAPTER);
                } else if (iU == 34) {
                    cardPattern.bottomContent = (CardPatternBottomContent) nb5Var.l(CardPatternBottomContent.PROTOBUF_ADAPTER);
                } else if (iU == 42) {
                    cardPattern.realUser = nb5Var.s();
                } else if (iU == 50) {
                    cardPattern.cover = nb5Var.s();
                } else {
                    if (iU != 58) {
                        if (cardPattern.userId == null) {
                            cardPattern.userId = "";
                    ...
                    cardPattern.cardOptions = (List) nb5Var.l(CardOption.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return cardPattern;
        }
        ...
        public void serialize(CardPattern cardPattern, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CardPatternCombinedIcon cardPatternCombinedIcon = cardPattern.topleftIcon;
            if (cardPatternCombinedIcon != null) {
                codedOutputByteBufferNano.K(2, cardPatternCombinedIcon, CardPatternCombinedIcon.PROTOBUF_ADAPTER);
            }
            CardPatternOptionIcon cardPatternOptionIcon = cardPattern.lowerRightIcon;
            if (cardPatternOptionIcon != null) {
                codedOutputByteBufferNano.K(3, cardPatternOptionIcon, CardPatternOptionIcon.PROTOBUF_ADAPTER);
            }
            CardPatternBottomContent cardPatternBottomContent = cardPattern.bottomContent;
            if (cardPatternBottomContent != null) {
                codedOutputByteBufferNano.K(4, cardPatternBottomContent, CardPatternBottomContent.PROTOBUF_ADAPTER);
            }
            String str2 = cardPattern.realUser;
            if (str2 != null) {
            ...
            List<CardOption> list = cardPattern.cardOptions;
            if (list != null) {
                codedOutputByteBufferNano.K(7, list, CardOption.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    public static JsonAdapter<CardPattern> JSON_ADAPTER = new ObjectJsonAdapter<CardPattern>() { // from class: com.p1.mobile.putong.core.data.CardPattern.2
        ...
        public CardPattern m11900newInstance() {
        ...
        public boolean parseField(CardPattern cardPattern, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "topleftIcon":
                    cardPattern.topleftIcon = (CardPatternCombinedIcon) CardPatternCombinedIcon.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "realUser":
                ...
                case "userId":
                    ...
                    return true;
                case "lowerRightIcon":
                    cardPattern.lowerRightIcon = (CardPatternOptionIcon) CardPatternOptionIcon.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "bottomContent":
                    cardPattern.bottomContent = (CardPatternBottomContent) CardPatternBottomContent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
