...
public class SeeSwitchName extends TEnum {
    ...
    static {
        TEnumJsonAdapter<SeeSwitchName> tEnumJsonAdapter = new TEnumJsonAdapter<SeeSwitchName>() { // from class: com.p1.mobile.putong.core.data.SeeSwitchName.1
            ...
            public SeeSwitchName m15541newTEnum(String str, int i) {
        ...
        PROTOBUF_ADAPTER = new TEnumProtobufAdapter<SeeSwitchName>() { // from class: com.p1.mobile.putong.core.data.SeeSwitchName.2
            /* JADX INFO: renamed from: newTEnum, reason: merged with bridge method [inline-methods] */
            public SeeSwitchName m15542newTEnum(String str, int i) {
                return SeeSwitchName.getForData(str, i);
            }
        };
        tEnumJsonAdapter.addExtJsonValue("unknown_", int_unknown_);
        tEnumJsonAdapter.addExtJsonValue(message_tab, int_message_tab);
        ...
        tEnumJsonAdapter.addExtJsonValue(see_special, int_see_special);
        tEnumJsonAdapter.addExtJsonValue(see_who_likes_me, 5);
        tEnumJsonAdapter.addExtJsonValue(see_boost_guide, int_see_boost_guide);
        tEnumJsonAdapter.addExtJsonValue(see_float, int_see_float);
        tEnumJsonAdapter.addExtJsonValue(right_no_match, int_right_no_match);
        tEnumJsonAdapter.addExtJsonValue(call_to_buy_see, int_call_to_buy_see);
        tEnumJsonAdapter.addExtJsonValue(see_sms, 10);
        tEnumJsonAdapter.addExtJsonValue(my_privilege, int_my_privilege);
    ...
    public static SeeSwitchName get(String str) {
        ...
        if (seeSwitchName == null) {
            ...
            seeSwitchName = integer == null ? new SeeSwitchName(str, int_unknown_) : new SeeSwitchName(str, integer.intValue());
