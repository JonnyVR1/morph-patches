...
public class Conversation extends DbObject implements Cloneable, Serializable {
    ...
    @ProtobufIndex(index = TAG_LEVEL_TOP)
    ...
    @Nullable
    @ProtobufIndex(index = NEW_LEVEL_TOP)
    ...
    @NonNull
    @ProtobufIndex(index = LEVEL_TOP_PLATINUM)
    ...
    public static ProtobufAdapter<Conversation> PROTOBUF_ADAPTER = new MessageNanoAdapter<Conversation>() { // from class: com.p1.mobile.putong.core.data.Conversation.1
        ...
        public int computeAndCacheSize(Conversation conversation) {
            int iJ = CodedOutputByteBufferNano.j(1, ((DbObject) conversation)._id);
            String str = ((DbObject) conversation).id;
            if (str != null) {
                iJ += CodedOutputByteBufferNano.o(2, str);
            }
            int iB = iJ + CodedOutputByteBufferNano.b(51, conversation.localHasMessage);
            Boolean bool = conversation.read;
            if (bool != null) {
                iB += CodedOutputByteBufferNano.b(52, bool.booleanValue());
            }
            String str2 = conversation.otherUser;
            if (str2 != null) {
                iB += CodedOutputByteBufferNano.o(53, str2);
            }
            String str3 = conversation.readUntil;
            if (str3 != null) {
                iB += CodedOutputByteBufferNano.o(54, str3);
            }
            int iD = iB + CodedOutputByteBufferNano.d(55, conversation.latestTime) + CodedOutputByteBufferNano.d(56, conversation.createdTime);
            MatchFrom matchFrom = conversation.localMatchFrom;
            if (matchFrom != null) {
                iD += CodedOutputByteBufferNano.h(57, matchFrom.ordinal());
            }
            NotificationStatus notificationStatus = conversation.localNotificationStatus;
            if (notificationStatus != null) {
                iD += CodedOutputByteBufferNano.h(58, notificationStatus.ordinal());
            }
            int iD2 = iD + CodedOutputByteBufferNano.d(59, conversation.localBotheringTime);
            List<String> list = conversation.scenarios;
            if (list != null) {
                iD2 += CodedOutputByteBufferNano.l(60, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iD3 = iD2 + CodedOutputByteBufferNano.d(61, conversation.localActiveTime) + CodedOutputByteBufferNano.h(62, conversation.unreadMessages) + CodedOutputByteBufferNano.b(63, conversation.localEverHasMessage);
            Reminder reminder = conversation.reminder;
            if (reminder != null) {
                iD3 += CodedOutputByteBufferNano.l(64, reminder, Reminder.PROTOBUF_ADAPTER);
            }
            int iD4 = iD3 + CodedOutputByteBufferNano.d(65, conversation.localUserUpdatedTime);
            StickStatus stickStatus = conversation.importance;
            if (stickStatus != null) {
                iD4 += CodedOutputByteBufferNano.h(66, stickStatus.ordinal());
            }
            String str4 = conversation.localOnlineTabClick;
            if (str4 != null) {
                iD4 += CodedOutputByteBufferNano.o(67, str4);
            }
            int iB2 = iD4 + CodedOutputByteBufferNano.b(68, conversation.follow) + CodedOutputByteBufferNano.d(69, conversation.localBotherWxTime) + CodedOutputByteBufferNano.d(70, conversation.localBotherCodeTime);
            String str5 = conversation.clearedUntil;
            if (str5 != null) {
                iB2 += CodedOutputByteBufferNano.o(71, str5);
            }
            ConversationStatus conversationStatus = conversation.status;
            if (conversationStatus != null) {
                iB2 += CodedOutputByteBufferNano.h(72, conversationStatus.ordinal());
            }
            String str6 = conversation.place;
            if (str6 != null) {
                iB2 += CodedOutputByteBufferNano.o(73, str6);
            }
            ConversationType conversationType = conversation.subtype;
            if (conversationType != null) {
                iB2 += CodedOutputByteBufferNano.h(74, conversationType.ordinal());
            }
            TalkInfo talkInfo = conversation.myTalk;
            if (talkInfo != null) {
                iB2 += CodedOutputByteBufferNano.l(75, talkInfo, TalkInfo.PROTOBUF_ADAPTER);
            }
            TalkInfo talkInfo2 = conversation.otherTalk;
            if (talkInfo2 != null) {
                iB2 += CodedOutputByteBufferNano.l(76, talkInfo2, TalkInfo.PROTOBUF_ADAPTER);
            }
            String str7 = conversation.otherReadUntil;
            if (str7 != null) {
                iB2 += CodedOutputByteBufferNano.o(77, str7);
            }
            int iH = iB2 + CodedOutputByteBufferNano.h(78, conversation.enterTimes) + CodedOutputByteBufferNano.d(79, conversation.updatedTime) + CodedOutputByteBufferNano.b(80, conversation.unmatchConversation) + CodedOutputByteBufferNano.j(81, conversation.remainedTime) + CodedOutputByteBufferNano.d(82, conversation.localSafetyReminderTime) + CodedOutputByteBufferNano.d(83, conversation.localSpoofingReminderTime) + CodedOutputByteBufferNano.b(84, conversation.forceSend) + CodedOutputByteBufferNano.h(85, conversation.conversationUserDistance) + CodedOutputByteBufferNano.d(86, conversation.conversationUserUpdatedTime) + CodedOutputByteBufferNano.h(87, conversation.level);
            ConversationAdditional conversationAdditional = conversation.additional;
            if (conversationAdditional != null) {
                iH += CodedOutputByteBufferNano.l(88, conversationAdditional, ConversationAdditional.PROTOBUF_ADAPTER);
            }
            String str8 = conversation.convType;
            if (str8 != null) {
                iH += CodedOutputByteBufferNano.o(89, str8);
            }
            ConversationProperty conversationProperty = conversation.property;
            if (conversationProperty != null) {
                iH += CodedOutputByteBufferNano.l(90, conversationProperty, ConversationProperty.PROTOBUF_ADAPTER);
            }
            int iH2 = iH + CodedOutputByteBufferNano.h(91, conversation.userMessageCount) + CodedOutputByteBufferNano.d(92, conversation.latestFriendCommentCreatedTime);
            FriendHeatScore friendHeatScore = conversation.heat;
            if (friendHeatScore != null) {
                iH2 += CodedOutputByteBufferNano.l(93, friendHeatScore, FriendHeatScore.PROTOBUF_ADAPTER);
            }
            List<LocalBusinessType> list2 = conversation.localBusinessTypes;
            if (list2 != null) {
                iH2 += CodedOutputByteBufferNano.l(94, LocalBusinessType.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iB3 = iH2 + CodedOutputByteBufferNano.b(95, conversation.localGreetDelete) + CodedOutputByteBufferNano.d(96, conversation.suggestionScore) + CodedOutputByteBufferNano.h(97, conversation.localBotherStatus) + CodedOutputByteBufferNano.b(98, conversation.muted);
            ConversationGroupProperty conversationGroupProperty = conversation.group;
            if (conversationGroupProperty != null) {
                iB3 += CodedOutputByteBufferNano.l(99, conversationGroupProperty, ConversationGroupProperty.PROTOBUF_ADAPTER);
            }
            String str9 = conversation.localDraft;
            if (str9 != null) {
                iB3 += CodedOutputByteBufferNano.o(100, str9);
            }
            List<Picture> list3 = conversation.localChatBg;
            if (list3 != null) {
                iB3 += CodedOutputByteBufferNano.l(101, list3, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LocalPlaceBan localPlaceBan = conversation.localPlaceBan;
            if (localPlaceBan != null) {
                iB3 += CodedOutputByteBufferNano.h(102, localPlaceBan.ordinal());
            }
            String str10 = conversation.localMessageInsertReportHint;
            if (str10 != null) {
                iB3 += CodedOutputByteBufferNano.o(103, str10);
            }
            String str11 = conversation.localNotifyMomentId;
            if (str11 != null) {
                iB3 += CodedOutputByteBufferNano.o(104, str11);
            }
            String str12 = conversation.localInsertedMomentId;
            if (str12 != null) {
                iB3 += CodedOutputByteBufferNano.o(105, str12);
            }
            int iH3 = iB3 + CodedOutputByteBufferNano.h(106, conversation.f36mm);
            MatchFrom matchFrom2 = conversation.localMatchFrom;
            if (matchFrom2 != null) {
                iH3 += CodedOutputByteBufferNano.l(107, matchFrom2, MatchFrom.PROTOBUF_ADAPTER);
            }
            NotificationStatus notificationStatus2 = conversation.localNotificationStatus;
            if (notificationStatus2 != null) {
                iH3 += CodedOutputByteBufferNano.l(108, notificationStatus2, NotificationStatus.PROTOBUF_ADAPTER);
            }
            StickStatus stickStatus2 = conversation.importance;
            if (stickStatus2 != null) {
                iH3 += CodedOutputByteBufferNano.l(109, stickStatus2, StickStatus.PROTOBUF_ADAPTER);
            }
            ConversationStatus conversationStatus2 = conversation.status;
            if (conversationStatus2 != null) {
                iH3 += CodedOutputByteBufferNano.l(110, conversationStatus2, ConversationStatus.PROTOBUF_ADAPTER);
            }
            ConversationType conversationType2 = conversation.subtype;
            if (conversationType2 != null) {
                iH3 += CodedOutputByteBufferNano.l(111, conversationType2, ConversationType.PROTOBUF_ADAPTER);
            }
            List<LocalBusinessType> list4 = conversation.localBusinessTypes;
            if (list4 != null) {
                iH3 += CodedOutputByteBufferNano.l(112, list4, LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LocalPlaceBan localPlaceBan2 = conversation.localPlaceBan;
            if (localPlaceBan2 != null) {
                iH3 += CodedOutputByteBufferNano.l(113, localPlaceBan2, LocalPlaceBan.PROTOBUF_ADAPTER);
            }
            int iH4 = iH3 + CodedOutputByteBufferNano.h(114, conversation.intimacy) + CodedOutputByteBufferNano.h(115, conversation.quickChatProgress) + CodedOutputByteBufferNano.b(116, conversation.hasLocalBreakIce) + CodedOutputByteBufferNano.d(117, conversation.localSpoofingNewTime) + CodedOutputByteBufferNano.d(118, conversation.clearedTime);
            String str13 = conversation.localExtraInfo;
            if (str13 != null) {
                iH4 += CodedOutputByteBufferNano.o(119, str13);
            }
            int iD5 = iH4 + CodedOutputByteBufferNano.d(120, conversation.lastActivityTime);
            String str14 = conversation.otherStatus;
            if (str14 != null) {
                iD5 += CodedOutputByteBufferNano.o(121, str14);
            }
            int iB4 = iD5 + CodedOutputByteBufferNano.b(122, conversation.isFake) + CodedOutputByteBufferNano.h(123, conversation.localIsLimitedTrialSee);
            ((MessageNano) conversation).cachedSize = iB4;
            return iB4;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Conversation m12313parse(nb5 nb5Var) throws IOException {
                ...
                switch (nb5Var.u()) {
                    case 0:
                        if (conversation.localMatchFrom == null && numValueOf != null) {
                            conversation.localMatchFrom = MatchFrom.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
                        }
                        if (conversation.localNotificationStatus == null && numValueOf2 != null) {
                            conversation.localNotificationStatus = (NotificationStatus) NotificationStatus.JSON_ADAPTER.newTEnum((String) null, numValueOf2.intValue());
                        }
                        if (conversation.importance == null && numValueOf3 != null) {
                            conversation.importance = (StickStatus) StickStatus.JSON_ADAPTER.newTEnum((String) null, numValueOf3.intValue());
                        }
                        if (conversation.status == null && numValueOf4 != null) {
                            conversation.status = ConversationStatus.JSON_ADAPTER.newTEnum((String) null, numValueOf4.intValue());
                        }
                        if (conversation.subtype == null && numValueOf5 != null) {
                            conversation.subtype = (ConversationType) ConversationType.JSON_ADAPTER.newTEnum((String) null, numValueOf5.intValue());
                        }
                        ...
                        if (conversation.localPlaceBan == null && numValueOf6 != null) {
                            conversation.localPlaceBan = (LocalPlaceBan) LocalPlaceBan.JSON_ADAPTER.newTEnum((String) null, numValueOf6.intValue());
                        }
                        ...
                        if (conversation.status == null) {
                            conversation.status = ConversationStatus.JSON_ADAPTER.defaultEnum();
                        }
                        ...
                        break;
                    case 8:
                        ((DbObject) conversation)._id = nb5Var.k();
                        continue;
                    case 18:
                        ((DbObject) conversation).id = nb5Var.s();
                        continue;
                    case 408:
                        conversation.localHasMessage = nb5Var.g();
                        continue;
                    case 416:
                        conversation.read = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 426:
                        conversation.otherUser = nb5Var.s();
                        continue;
                    case 434:
                        conversation.readUntil = nb5Var.s();
                        continue;
                    case 441:
                        conversation.latestTime = nb5Var.h();
                        continue;
                    case 449:
                        conversation.createdTime = nb5Var.h();
                        continue;
                    case 456:
                    ...
                    case 464:
                        ...
                        continue;
                    case 473:
                        conversation.localBotheringTime = nb5Var.h();
                        continue;
                    case 482:
                        conversation.scenarios = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 489:
                        conversation.localActiveTime = nb5Var.h();
                        continue;
                    case 496:
                        conversation.unreadMessages = nb5Var.j();
                        continue;
                    case 504:
                        conversation.localEverHasMessage = nb5Var.g();
                        continue;
                    case 514:
                        conversation.reminder = (Reminder) nb5Var.l(Reminder.PROTOBUF_ADAPTER);
                        continue;
                    case 521:
                        conversation.localUserUpdatedTime = nb5Var.h();
                        continue;
                    case 528:
                        numValueOf3 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 538:
                        conversation.localOnlineTabClick = nb5Var.s();
                        continue;
                    case 544:
                        conversation.follow = nb5Var.g();
                        continue;
                    case 553:
                        conversation.localBotherWxTime = nb5Var.h();
                        continue;
                    case 561:
                        conversation.localBotherCodeTime = nb5Var.h();
                        continue;
                    case 570:
                        conversation.clearedUntil = nb5Var.s();
                        continue;
                    case 576:
                        numValueOf4 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 586:
                        conversation.place = nb5Var.s();
                        continue;
                    case 592:
                        numValueOf5 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 602:
                        conversation.myTalk = (TalkInfo) nb5Var.l(TalkInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 610:
                        conversation.otherTalk = (TalkInfo) nb5Var.l(TalkInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 618:
                        conversation.otherReadUntil = nb5Var.s();
                        continue;
                    case 624:
                        conversation.enterTimes = nb5Var.j();
                        continue;
                    case 633:
                        conversation.updatedTime = nb5Var.h();
                        continue;
                    case 640:
                        conversation.unmatchConversation = nb5Var.g();
                        continue;
                    case 648:
                        conversation.remainedTime = nb5Var.k();
                        continue;
                    case 657:
                        conversation.localSafetyReminderTime = nb5Var.h();
                        continue;
                    case 665:
                        conversation.localSpoofingReminderTime = nb5Var.h();
                        continue;
                    case 672:
                        conversation.forceSend = nb5Var.g();
                        continue;
                    case 680:
                        conversation.conversationUserDistance = nb5Var.j();
                        continue;
                    case 689:
                        conversation.conversationUserUpdatedTime = nb5Var.h();
                        continue;
                    case 696:
                        conversation.level = nb5Var.j();
                        continue;
                    case 706:
                        conversation.additional = (ConversationAdditional) nb5Var.l(ConversationAdditional.PROTOBUF_ADAPTER);
                        continue;
                    case 714:
                        conversation.convType = nb5Var.s();
                        continue;
                    case 722:
                        conversation.property = (ConversationProperty) nb5Var.l(ConversationProperty.PROTOBUF_ADAPTER);
                        continue;
                    case 728:
                        conversation.userMessageCount = nb5Var.j();
                        continue;
                    case 737:
                        conversation.latestFriendCommentCreatedTime = nb5Var.h();
                        continue;
                    case 746:
                        conversation.heat = (FriendHeatScore) nb5Var.l(FriendHeatScore.PROTOBUF_ADAPTER);
                        continue;
                    case 754:
                        list = (List) nb5Var.l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 760:
                        conversation.localGreetDelete = nb5Var.g();
                        continue;
                    case 769:
                        conversation.suggestionScore = nb5Var.h();
                        continue;
                    case 776:
                        conversation.localBotherStatus = nb5Var.j();
                        continue;
                    case 784:
                        conversation.muted = nb5Var.g();
                        continue;
                    case 794:
                        conversation.group = (ConversationGroupProperty) nb5Var.l(ConversationGroupProperty.PROTOBUF_ADAPTER);
                        continue;
                    case 802:
                        conversation.localDraft = nb5Var.s();
                        continue;
                    case 810:
                        conversation.localChatBg = (List) nb5Var.l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 816:
                        numValueOf6 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 826:
                        conversation.localMessageInsertReportHint = nb5Var.s();
                        continue;
                    case 834:
                        conversation.localNotifyMomentId = nb5Var.s();
                        continue;
                    case 842:
                        conversation.localInsertedMomentId = nb5Var.s();
                        continue;
                    case 848:
                        conversation.f36mm = nb5Var.j();
                        continue;
                    case 858:
                        conversation.localMatchFrom = (MatchFrom) nb5Var.l(MatchFrom.PROTOBUF_ADAPTER);
                        continue;
                    case 866:
                        conversation.localNotificationStatus = (NotificationStatus) nb5Var.l(NotificationStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 874:
                        conversation.importance = (StickStatus) nb5Var.l(StickStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 882:
                        conversation.status = (ConversationStatus) nb5Var.l(ConversationStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 890:
                        conversation.subtype = (ConversationType) nb5Var.l(ConversationType.PROTOBUF_ADAPTER);
                        continue;
                    case 898:
                        conversation.localBusinessTypes = (List) nb5Var.l(LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 906:
                        conversation.localPlaceBan = (LocalPlaceBan) nb5Var.l(LocalPlaceBan.PROTOBUF_ADAPTER);
                        continue;
                    case 912:
                        conversation.intimacy = nb5Var.j();
                        continue;
                    case 920:
                        conversation.quickChatProgress = nb5Var.j();
                        continue;
                    case 928:
                        conversation.hasLocalBreakIce = nb5Var.g();
                        continue;
                    case 937:
                        conversation.localSpoofingNewTime = nb5Var.h();
                        continue;
                    case 945:
                        conversation.clearedTime = nb5Var.h();
                        continue;
                    case 954:
                        conversation.localExtraInfo = nb5Var.s();
                        continue;
                    case 961:
                        conversation.lastActivityTime = nb5Var.h();
                        continue;
                    case 970:
                        conversation.otherStatus = nb5Var.s();
                        continue;
                    case 976:
                        conversation.isFake = nb5Var.g();
                        continue;
                    case 984:
                        conversation.localIsLimitedTrialSee = nb5Var.j();
                        continue;
                    default:
                        if (conversation.localMatchFrom == null && numValueOf != null) {
                            conversation.localMatchFrom = MatchFrom.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
        ...
        public void serialize(Conversation conversation, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.I(1, ((DbObject) conversation)._id);
            String str = ((DbObject) conversation).id;
            if (str != null) {
                codedOutputByteBufferNano.R(2, str);
            }
            codedOutputByteBufferNano.A(51, conversation.localHasMessage);
            Boolean bool = conversation.read;
            if (bool != null) {
                codedOutputByteBufferNano.A(52, bool.booleanValue());
            }
            String str2 = conversation.otherUser;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.C(55, conversation.latestTime);
            codedOutputByteBufferNano.C(56, conversation.createdTime);
            MatchFrom matchFrom = conversation.localMatchFrom;
            if (matchFrom != null) {
                codedOutputByteBufferNano.G(57, matchFrom.ordinal());
            }
            NotificationStatus notificationStatus = conversation.localNotificationStatus;
            if (notificationStatus != null) {
                codedOutputByteBufferNano.G(58, notificationStatus.ordinal());
            }
            codedOutputByteBufferNano.C(59, conversation.localBotheringTime);
            List<String> list = conversation.scenarios;
            if (list != null) {
                codedOutputByteBufferNano.K(60, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.C(61, conversation.localActiveTime);
            codedOutputByteBufferNano.G(62, conversation.unreadMessages);
            codedOutputByteBufferNano.A(63, conversation.localEverHasMessage);
            Reminder reminder = conversation.reminder;
            if (reminder != null) {
                codedOutputByteBufferNano.K(64, reminder, Reminder.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.C(65, conversation.localUserUpdatedTime);
            StickStatus stickStatus = conversation.importance;
            if (stickStatus != null) {
                codedOutputByteBufferNano.G(66, stickStatus.ordinal());
            }
            String str4 = conversation.localOnlineTabClick;
            if (str4 != null) {
                codedOutputByteBufferNano.R(67, str4);
            }
            codedOutputByteBufferNano.A(68, conversation.follow);
            codedOutputByteBufferNano.C(69, conversation.localBotherWxTime);
            codedOutputByteBufferNano.C(70, conversation.localBotherCodeTime);
            String str5 = conversation.clearedUntil;
            if (str5 != null) {
                codedOutputByteBufferNano.R(71, str5);
            }
            ConversationStatus conversationStatus = conversation.status;
            if (conversationStatus != null) {
                codedOutputByteBufferNano.G(72, conversationStatus.ordinal());
            }
            String str6 = conversation.place;
            if (str6 != null) {
                codedOutputByteBufferNano.R(73, str6);
            }
            ConversationType conversationType = conversation.subtype;
            if (conversationType != null) {
                codedOutputByteBufferNano.G(74, conversationType.ordinal());
            }
            TalkInfo talkInfo = conversation.myTalk;
            if (talkInfo != null) {
                codedOutputByteBufferNano.K(75, talkInfo, TalkInfo.PROTOBUF_ADAPTER);
            }
            TalkInfo talkInfo2 = conversation.otherTalk;
            if (talkInfo2 != null) {
                codedOutputByteBufferNano.K(76, talkInfo2, TalkInfo.PROTOBUF_ADAPTER);
            }
            String str7 = conversation.otherReadUntil;
            if (str7 != null) {
                codedOutputByteBufferNano.R(77, str7);
            }
            codedOutputByteBufferNano.G(78, conversation.enterTimes);
            codedOutputByteBufferNano.C(79, conversation.updatedTime);
            codedOutputByteBufferNano.A(80, conversation.unmatchConversation);
            codedOutputByteBufferNano.I(81, conversation.remainedTime);
            codedOutputByteBufferNano.C(82, conversation.localSafetyReminderTime);
            codedOutputByteBufferNano.C(83, conversation.localSpoofingReminderTime);
            codedOutputByteBufferNano.A(84, conversation.forceSend);
            codedOutputByteBufferNano.G(85, conversation.conversationUserDistance);
            codedOutputByteBufferNano.C(86, conversation.conversationUserUpdatedTime);
            codedOutputByteBufferNano.G(87, conversation.level);
            ConversationAdditional conversationAdditional = conversation.additional;
            if (conversationAdditional != null) {
                codedOutputByteBufferNano.K(88, conversationAdditional, ConversationAdditional.PROTOBUF_ADAPTER);
            }
            String str8 = conversation.convType;
            if (str8 != null) {
                codedOutputByteBufferNano.R(89, str8);
            }
            ConversationProperty conversationProperty = conversation.property;
            if (conversationProperty != null) {
                codedOutputByteBufferNano.K(90, conversationProperty, ConversationProperty.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(91, conversation.userMessageCount);
            codedOutputByteBufferNano.C(92, conversation.latestFriendCommentCreatedTime);
            FriendHeatScore friendHeatScore = conversation.heat;
            if (friendHeatScore != null) {
                codedOutputByteBufferNano.K(93, friendHeatScore, FriendHeatScore.PROTOBUF_ADAPTER);
            }
            List<LocalBusinessType> list2 = conversation.localBusinessTypes;
            if (list2 != null) {
                codedOutputByteBufferNano.K(94, LocalBusinessType.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.A(95, conversation.localGreetDelete);
            codedOutputByteBufferNano.C(96, conversation.suggestionScore);
            codedOutputByteBufferNano.G(97, conversation.localBotherStatus);
            codedOutputByteBufferNano.A(98, conversation.muted);
            ConversationGroupProperty conversationGroupProperty = conversation.group;
            if (conversationGroupProperty != null) {
                codedOutputByteBufferNano.K(99, conversationGroupProperty, ConversationGroupProperty.PROTOBUF_ADAPTER);
            }
            String str9 = conversation.localDraft;
            if (str9 != null) {
                codedOutputByteBufferNano.R(100, str9);
            }
            List<Picture> list3 = conversation.localChatBg;
            if (list3 != null) {
                codedOutputByteBufferNano.K(101, list3, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LocalPlaceBan localPlaceBan = conversation.localPlaceBan;
            if (localPlaceBan != null) {
                codedOutputByteBufferNano.G(102, localPlaceBan.ordinal());
            }
            String str10 = conversation.localMessageInsertReportHint;
            if (str10 != null) {
                codedOutputByteBufferNano.R(103, str10);
            }
            String str11 = conversation.localNotifyMomentId;
            if (str11 != null) {
                codedOutputByteBufferNano.R(104, str11);
            }
            String str12 = conversation.localInsertedMomentId;
            if (str12 != null) {
                codedOutputByteBufferNano.R(105, str12);
            }
            codedOutputByteBufferNano.G(106, conversation.f36mm);
            MatchFrom matchFrom2 = conversation.localMatchFrom;
            if (matchFrom2 != null) {
                codedOutputByteBufferNano.K(107, matchFrom2, MatchFrom.PROTOBUF_ADAPTER);
            }
            NotificationStatus notificationStatus2 = conversation.localNotificationStatus;
            if (notificationStatus2 != null) {
                codedOutputByteBufferNano.K(108, notificationStatus2, NotificationStatus.PROTOBUF_ADAPTER);
            }
            StickStatus stickStatus2 = conversation.importance;
            if (stickStatus2 != null) {
                codedOutputByteBufferNano.K(109, stickStatus2, StickStatus.PROTOBUF_ADAPTER);
            }
            ConversationStatus conversationStatus2 = conversation.status;
            if (conversationStatus2 != null) {
                codedOutputByteBufferNano.K(110, conversationStatus2, ConversationStatus.PROTOBUF_ADAPTER);
            }
            ConversationType conversationType2 = conversation.subtype;
            if (conversationType2 != null) {
                codedOutputByteBufferNano.K(111, conversationType2, ConversationType.PROTOBUF_ADAPTER);
            }
            List<LocalBusinessType> list4 = conversation.localBusinessTypes;
            if (list4 != null) {
                codedOutputByteBufferNano.K(112, list4, LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LocalPlaceBan localPlaceBan2 = conversation.localPlaceBan;
            if (localPlaceBan2 != null) {
                codedOutputByteBufferNano.K(113, localPlaceBan2, LocalPlaceBan.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(114, conversation.intimacy);
            codedOutputByteBufferNano.G(115, conversation.quickChatProgress);
            codedOutputByteBufferNano.A(116, conversation.hasLocalBreakIce);
            codedOutputByteBufferNano.C(117, conversation.localSpoofingNewTime);
            codedOutputByteBufferNano.C(118, conversation.clearedTime);
            String str13 = conversation.localExtraInfo;
            if (str13 != null) {
                codedOutputByteBufferNano.R(119, str13);
            }
            codedOutputByteBufferNano.C(120, conversation.lastActivityTime);
            String str14 = conversation.otherStatus;
            if (str14 != null) {
                codedOutputByteBufferNano.R(121, str14);
            }
            codedOutputByteBufferNano.A(122, conversation.isFake);
            codedOutputByteBufferNano.G(123, conversation.localIsLimitedTrialSee);
        }
    };
    public static JsonAdapter<Conversation> JSON_ADAPTER = new ObjectJsonAdapter<Conversation>() { // from class: com.p1.mobile.putong.core.data.Conversation.2
        ...
        public Conversation m12316newInstance() {
        ...
        public boolean parseField(Conversation conversation, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "userMessageCount":
                    ...
                    return true;
                case "otherTalk":
                    conversation.otherTalk = (TalkInfo) TalkInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "otherUser":
                    conversation.otherUser = (String) Converter.GROUP_ID.parse(jsonParser, str2);
                    return true;
                case "additional":
                    conversation.additional = (ConversationAdditional) ConversationAdditional.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "subtype":
                    conversation.subtype = (ConversationType) ConversationType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "otherStatus":
                    conversation.otherStatus = jsonParser.getValueAsString();
                    return true;
                case "suggestionScore":
                    conversation.suggestionScore = jsonParser.getValueAsDouble();
                    return true;
                case "quickChatProgress":
                ...
                case "readUntil":
                    ...
                    return true;
                case "clearedTime":
                    conversation.clearedTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "myTalk":
                    conversation.myTalk = (TalkInfo) TalkInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "property":
                    conversation.property = (ConversationProperty) ConversationProperty.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "status":
                    conversation.status = (ConversationStatus) ConversationStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "updatedTime":
                    conversation.updatedTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "otherReadUntil":
                ...
                case "convType":
                    ...
                    return true;
                case "createdTime":
                    conversation.createdTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "messages":
                    conversation.api_only_messages = (PartialIdList) PartialIdList.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "latestTime":
                    conversation.latestTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "id":
                    ((DbObject) conversation).id = jsonParser.getValueAsString();
                    return false;
                case "mm":
                    conversation.f36mm = jsonParser.getValueAsInt();
                    return true;
                case "heat":
                    conversation.heat = (FriendHeatScore) FriendHeatScore.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "read":
                    conversation.read = jsonParser.getCurrentToken() == JsonToken.VALUE_NULL ? null : Boolean.valueOf(jsonParser.getValueAsBoolean());
                    return true;
                case "group":
                    conversation.group = (ConversationGroupProperty) ConversationGroupProperty.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "level":
                ...
                case "place":
                    ...
                    return true;
                case "localNotificationStatus":
                    conversation.localNotificationStatus = (NotificationStatus) NotificationStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "localIsLimitedTrialSee":
                ...
                case "unreadMessages":
                    ...
                    return true;
                case "conversationUserUpdatedTime":
                    conversation.conversationUserUpdatedTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "localBotherStatus":
                ...
                case "scenarios":
                    ...
                    return true;
                case "latestFriendCommentCreatedTime":
                    conversation.latestFriendCommentCreatedTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "unmatchConversation":
                    conversation.unmatchConversation = jsonParser.getValueAsBoolean();
                    return true;
                case "conversationUserDistance":
                    conversation.conversationUserDistance = jsonParser.getValueAsInt();
                    return true;
                case "importance":
                    conversation.importance = (StickStatus) StickStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                default:
                    return false;
            }
        ...
        public void serializeFields(Conversation conversation, JsonGenerator jsonGenerator) throws IOException {
            ...
            Boolean bool = conversation.read;
            if (bool != null) {
                jsonGenerator.writeBooleanField(LimitTimePictureStatus.read, bool.booleanValue());
            }
            if (conversation.otherUser != null) {
            ...
            jsonGenerator.writeBooleanField(Relation.follow, conversation.follow);
            ...
            jsonGenerator.writeNumberField("level", conversation.level);
            if (conversation.additional != null) {
            ...
            if (conversation.group != null) {
                jsonGenerator.writeFieldName(MessageChannel.group);
                ConversationGroupProperty.JSON_ADAPTER.serialize(conversation.group, jsonGenerator, true);
            }
            jsonGenerator.writeNumberField("mm", conversation.f36mm);
    ...
    public static final LongColumn<Conversation> _ID = new LongColumn<Conversation>("_id") { // from class: com.p1.mobile.putong.core.data.Conversation.3
        public Long get(Conversation conversation) {
            return Long.valueOf(((DbObject) conversation)._id);
        }

        public void set(Conversation conversation, Long l2) {
            ((DbObject) conversation)._id = l2.longValue();
        }
    };

    /* JADX INFO: renamed from: ID */
    public static final StringColumn<Conversation> f34ID = new StringColumn<Conversation>("id_c") { // from class: com.p1.mobile.putong.core.data.Conversation.4
        public String get(Conversation conversation) {
            return ((DbObject) conversation).id;
        }
    ...
    public static final IntegerColumn<Conversation> HEAT_MM = new IntegerColumn<Conversation>("heat_mm_c") { // from class: com.p1.mobile.putong.core.data.Conversation.56
        public Integer get(Conversation conversation) {
            return Integer.valueOf(conversation.heat.f56mm);
        }

        public void set(Conversation conversation, Integer num) {
            conversation.heat.f56mm = num.intValue();
        }
    };
    ...
    /* JADX INFO: renamed from: MM */
    public static final IntegerColumn<Conversation> f35MM = new IntegerColumn<Conversation>("mm_c") { // from class: com.p1.mobile.putong.core.data.Conversation.83
        public Integer get(Conversation conversation) {
            return Integer.valueOf(conversation.f36mm);
        }

        public void set(Conversation conversation, Integer num) {
            conversation.f36mm = num.intValue();
        }
    };
    ...
    public static mrf0<Conversation> DB_ADAPTER = new mrf0<Conversation>() { // from class: com.p1.mobile.putong.core.data.Conversation.129
        ...
        public Conversation m12314init() {
            Conversation conversation = new Conversation();
            if (conversation.read == null) {
                conversation.read = Boolean.FALSE;
            }
        ...
        public Conversation m12315read(Cursor cursor, int i) {
            String string;
            String string2;
            String string3;
            String string4;
            ...
            TEnumJsonAdapter tEnumJsonAdapter3;
            ...
            try {
                ...
                ((DbObject) conversation)._id = cursor.getLong(i);
                int i9 = i + 1;
                ((DbObject) conversation).id = cursor.isNull(i9) ? null : cursor.getString(i9);
                ...
                try {
                    ...
                    try {
                        ...
                        int i15 = i + 11;
                        conversation.scenarios = cursor.isNull(i15) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i15));
                        ...
                        int i16 = i + 15;
                        conversation.reminder = cursor.isNull(i16) ? null : (Reminder) Reminder.PROTOBUF_ADAPTER.parse(cursor.getBlob(i16));
                        ...
                        try {
                            ...
                            try {
                                ...
                                int i23 = i + 26;
                                try {
                                    conversation.myTalk = cursor.isNull(i23) ? null : (TalkInfo) TalkInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i23));
                                    int i24 = i + 27;
                                    conversation.otherTalk = cursor.isNull(i24) ? null : (TalkInfo) TalkInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i24));
                                    int i25 = i + 28;
                                    ...
                                    int i31 = i + 47;
                                    conversation.property = cursor.isNull(i31) ? null : (ConversationProperty) ConversationProperty.PROTOBUF_ADAPTER.parse(cursor.getBlob(i31));
                                    ...
                                    conversation.heat.f56mm = cursor.getInt(i + 53);
                                    conversation.heat.score = cursor.getInt(i + 54);
                                    int i33 = i + 55;
                                    list2 = cursor.isNull(i33) ? null : (List) OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i33));
                                    int i34 = i + 56;
                                    try {
                                        ...
                                        try {
                                            ...
                                            int i36 = i + 66;
                                            conversation.additional.oneSide = cursor.isNull(i36) ? null : (ConversationAdditionalOneSide) ConversationAdditionalOneSide.PROTOBUF_ADAPTER.parse(cursor.getBlob(i36));
                                            int i37 = i + 67;
                                            conversation.localDraft = cursor.isNull(i37) ? null : cursor.getString(i37);
                                            int i38 = i + 68;
                                            conversation.localChatBg = cursor.isNull(i38) ? null : (List) Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i38));
                                            int i39 = i + 69;
                                            i3 = cursor.isNull(i39) ? -1 : cursor.getInt(i39);
                                            int i40 = i + 70;
                                            try {
                                                conversation.additional.kankan.contents = cursor.isNull(i40) ? null : (List) ConversationAdditionalKanKanContentIdWrapper.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i40));
                                                int i41 = i + 71;
                                                ...
                                                conversation.f36mm = cursor.getInt(i + 81);
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                int i52 = i + 88;
                                                                try {
                                                                    conversation.localBusinessTypes = cursor.isNull(i52) ? null : (List) LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i52));
                                                                    int i53 = i + 89;
                                                                    ...
                                                                    int i55 = i + 94;
                                                                    conversation.additional.feedStateCounter = cursor.isNull(i55) ? null : (CoreFeedStateCounter) CoreFeedStateCounter.PROTOBUF_ADAPTER.parse(cursor.getBlob(i55));
                                                                    int i56 = i + 95;
                                                                    conversation.additional.suggestedTimeLimitedMatch = cursor.isNull(i56) ? null : (SuggestedTimeLimitedMatch) SuggestedTimeLimitedMatch.PROTOBUF_ADAPTER.parse(cursor.getBlob(i56));
                                                                    int i57 = i + 96;
                                                                    ...
                                                                    int i60 = i + 99;
                                                                    conversation.additional.heartbeatMatch = cursor.isNull(i60) ? null : (HeartbeatMatch) HeartbeatMatch.PROTOBUF_ADAPTER.parse(cursor.getBlob(i60));
                                                                    conversation.hasLocalBreakIce = cursor.getInt(i + 100) == 1;
                                                                    int i61 = i + 101;
                                                                    conversation.additional.avatarSummary = cursor.isNull(i61) ? null : (AvatarSummaryCounter) AvatarSummaryCounter.PROTOBUF_ADAPTER.parse(cursor.getBlob(i61));
                                                                    int i62 = i + 102;
                                                                    conversation.additional.feedInteractionCounter = cursor.isNull(i62) ? null : (CoreInteractionMessageCounter) CoreInteractionMessageCounter.PROTOBUF_ADAPTER.parse(cursor.getBlob(i62));
                                                                    ...
                                                                    try {
                                                                        if (TextUtils.equals(cursor.getColumnName(104), "clearedTime_c")) {
                                                                            ...
                                                                            if (cursor.isNull(i8)) {
                                                                                ...
                                                                                virtualVoiceGroupConversationCell = (VirtualVoiceGroupConversationCell) VirtualVoiceGroupConversationCell.PROTOBUF_ADAPTER.parse(cursor.getBlob(i8));
                                                                            }
                                                                            conversationAdditional.liveVirtualVoice = virtualVoiceGroupConversationCell;
                                                                        } else {
                                                                            string6 = string6;
                                                                            conversation.additional.liveVirtualVoice = cursor.isNull(i63) ? null : (VirtualVoiceGroupConversationCell) VirtualVoiceGroupConversationCell.PROTOBUF_ADAPTER.parse(cursor.getBlob(i63));
                                                                            i8 = i + 105;
                                                                            conversation.clearedTime = cursor.getDouble(i8);
                                                                        }
                                                                        int i64 = i8 + 1;
                                                                        conversation.additional.localMomentInfo = cursor.isNull(i64) ? null : (ConversationMomentInfo) ConversationMomentInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i64));
                                                                        int i65 = i8 + 2;
                                                                        ...
                                                                        int i66 = i8 + 4;
                                                                        conversation.additional.liveActivity = cursor.isNull(i66) ? null : (LiveActivityConversation) LiveActivityConversation.PROTOBUF_ADAPTER.parse(cursor.getBlob(i66));
                                                                        int i67 = i8 + 5;
                                                                        conversation.additional.game = cursor.isNull(i67) ? null : (ConversationGame) ConversationGame.PROTOBUF_ADAPTER.parse(cursor.getBlob(i67));
                                                                        int i68 = i8 + 6;
                                                                        conversation.additional.tag = cursor.isNull(i68) ? null : (ConversationAdditionalTag) ConversationAdditionalTag.PROTOBUF_ADAPTER.parse(cursor.getBlob(i68));
                                                                        int i69 = i8 + 7;
                                                                        conversation.additional.chatAssistantQuestion = cursor.isNull(i69) ? null : (ConversationAdditionalChatAssistantQuestion) ConversationAdditionalChatAssistantQuestion.PROTOBUF_ADAPTER.parse(cursor.getBlob(i69));
                                                                        ...
                                                                        int i71 = i8 + 10;
                                                                        conversation.additional.continuousChat = cursor.isNull(i71) ? null : (ContinuousChat) ContinuousChat.PROTOBUF_ADAPTER.parse(cursor.getBlob(i71));
                                                                        int i72 = i8 + 11;
                                                                        conversation.additional.pinChat = cursor.isNull(i72) ? null : (PlatinumPinChat) PlatinumPinChat.PROTOBUF_ADAPTER.parse(cursor.getBlob(i72));
                                                                        int i73 = i8 + 12;
                                                                        conversation.additional.reSwipe = cursor.isNull(i73) ? null : (ReSwipeInfo) ReSwipeInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i73));
                                                                        int i74 = i8 + 13;
                                                                        conversation.additional.blindbox = cursor.isNull(i74) ? null : (GrowthConversationBlindBox) GrowthConversationBlindBox.PROTOBUF_ADAPTER.parse(cursor.getBlob(i74));
                                                                        int i75 = i8 + 14;
                                                                        conversation.additional.previewTexts = cursor.isNull(i75) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i75));
                                                                        int i76 = i8 + 15;
                                                                        conversation.additional.greetingInfo = cursor.isNull(i76) ? null : (GreetingInfo) GreetingInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i76));
                                                                        int i77 = i8 + 16;
                                                                        conversation.additional.fateRadar = cursor.isNull(i77) ? null : (ConversationAdditionalFateRadar) ConversationAdditionalFateRadar.PROTOBUF_ADAPTER.parse(cursor.getBlob(i77));
                                                                        boolean z = true;
                                                                        ...
                                                                        int i78 = i8 + 18;
                                                                        conversation.additional.lowPayOneside = cursor.isNull(i78) ? null : (LowPayOneside) LowPayOneside.PROTOBUF_ADAPTER.parse(cursor.getBlob(i78));
                                                                        int i79 = i8 + 19;
                                                                        conversation.additional.matchInfo = cursor.isNull(i79) ? null : (ConvAdditionalMatchInfo) ConvAdditionalMatchInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i79));
                                                                        int i80 = i8;
                                                                        conversation.additional.newMatch.labelExposureTime = cursor.getDouble(i8 + 20);
                                                                        int i81 = i80 + 21;
                                                                        conversation.additional.loveLetter = cursor.isNull(i81) ? null : (ConvAdditionalLoveLetter) ConvAdditionalLoveLetter.PROTOBUF_ADAPTER.parse(cursor.getBlob(i81));
                                                                        conversation.localIsLimitedTrialSee = cursor.getInt(i80 + 22);
                                                                        int i82 = i80 + 23;
                                                                        conversation.additional.chatMM = cursor.isNull(i82) ? null : (ChatMM) ChatMM.PROTOBUF_ADAPTER.parse(cursor.getBlob(i82));
                                                                        int i83 = i80 + 24;
                                                                        conversation.additional.blackList = cursor.isNull(i83) ? null : (BlackList) BlackList.PROTOBUF_ADAPTER.parse(cursor.getBlob(i83));
                                                                        int i84 = i80 + 25;
                                                                        conversation.additional.messageRelate = cursor.isNull(i84) ? null : (MessageRelate) MessageRelate.PROTOBUF_ADAPTER.parse(cursor.getBlob(i84));
                                                                        int i85 = i80 + 26;
                                                                        conversation.additional.compliment = cursor.isNull(i85) ? null : (ConvAdditionalCompliment) ConvAdditionalCompliment.PROTOBUF_ADAPTER.parse(cursor.getBlob(i85));
                                                                        int i86 = i80 + 27;
                                                                        conversation.additional.swiper = cursor.isNull(i86) ? null : (ConvAdditionalSwiper) ConvAdditionalSwiper.PROTOBUF_ADAPTER.parse(cursor.getBlob(i86));
                                                                        ((mrf0) this).readIndex = i80 + 28;
                                                                    } catch (Exception e) {
                                                                        e = e;
                                                                        list = list2;
                                                                        i2 = i2;
                                                                ...
                                                                String str2 = string4;
                                                                String str3 = string6;
                                                                conversation.localMatchFrom = MatchFrom.JSON_ADAPTER.newTEnum(string5, i2);
                                                                ...
                                                                conversation.status = tEnumJsonAdapter3.newTEnum(str, i5);
                                                                ...
                                                                if (conversation.status == null) {
                                                                    conversation.status = tEnumJsonAdapter3.defaultEnum();
                                                                }
                                                                if (conversation.subtype == null) {
                                                            ...
                                                            conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                                                            tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                                                            conversation.status = tEnumJsonAdapter3.newTEnum(str4, i5);
                                                            tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
                                                        ...
                                                        conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                                                        tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                                                        conversation.status = tEnumJsonAdapter3.newTEnum(str7, i5);
                                                        tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
                                            ...
                                            conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                                            tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                                            conversation.status = tEnumJsonAdapter3.newTEnum(str10, i5);
                                            tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
                                    ...
                                    conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                                    tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                                    conversation.status = tEnumJsonAdapter3.newTEnum(str13, i5);
                                    tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
                                ...
                                conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                                tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                                conversation.status = tEnumJsonAdapter3.newTEnum(str16, i5);
                                tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
                            ...
                            conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                            tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                            conversation.status = tEnumJsonAdapter3.newTEnum(str19, i5);
                            tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
                    ...
                    conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
                    tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
                    conversation.status = tEnumJsonAdapter3.newTEnum(str112, i5);
                    tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
            ...
            conversation.importance = (StickStatus) tEnumJsonAdapter2.newTEnum(string2, i4);
            tEnumJsonAdapter3 = ConversationStatus.JSON_ADAPTER;
            conversation.status = tEnumJsonAdapter3.newTEnum(str115, i5);
            tEnumJsonAdapter4 = ConversationType.JSON_ADAPTER;
        ...
        public void write(Conversation conversation, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", ((DbObject) conversation).id);
                ...
                DbObject.cvPut(contentValues, "heat_mm_c", Integer.valueOf(conversation.heat.f56mm));
                ...
                DbObject.cvPut(contentValues, "mm_c", Integer.valueOf(conversation.f36mm));
    ...
    public static /* synthetic */ String m95a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ LocalBusinessType m96b(LocalBusinessType localBusinessType) {
    ...
    public Conversation m12312clone() {
        Conversation conversation = new Conversation();
        ((DbObject) conversation)._id = ((DbObject) this)._id;
        ...
        if (partialIdList != null) {
            conversation.api_only_messages = partialIdList.clone();
        }
        ...
        if (list != null) {
            conversation.scenarios = ValueObject.util_map(list, new w9j() { // from class: l.m36
                public final Object call(Object obj) {
                    return Conversation.m95a((String) obj);
                }
            });
        }
        ...
        if (reminder != null) {
            conversation.reminder = reminder.m15386clone();
        }
        ...
        if (talkInfo != null) {
            conversation.myTalk = talkInfo.m15913clone();
        }
        TalkInfo talkInfo2 = this.otherTalk;
        if (talkInfo2 != null) {
            conversation.otherTalk = talkInfo2.m15913clone();
        }
        ...
        if (conversationAdditional != null) {
            conversation.additional = conversationAdditional.m12318clone();
        }
        conversation.convType = this.convType;
        ConversationProperty conversationProperty = this.property;
        if (conversationProperty != null) {
            conversation.property = conversationProperty.m12412clone();
        }
        ...
        if (friendHeatScore != null) {
            conversation.heat = friendHeatScore.m12848clone();
        }
        ...
        if (list2 != null) {
            conversation.localBusinessTypes = ValueObject.util_map(list2, new w9j() { // from class: l.n36
                public final Object call(Object obj) {
                    return Conversation.m96b((LocalBusinessType) obj);
                }
            });
        }
        ...
        if (conversationGroupProperty != null) {
            conversation.group = conversationGroupProperty.m12368clone();
        }
    ...
    public boolean hasReSwipeConvIceBreak() {
        if (NullChecker.a(Boolean.valueOf(NullChecker.a(this.additional))) && NullChecker.a(this.additional.reSwipe)) {
    ...
    public boolean hasRemoveLabel() {
        ConversationAdditional conversationAdditional = this.additional;
        return (conversationAdditional == null || vwb.J(conversationAdditional.previewTexts) || TextUtils.isEmpty(this.additional.previewTexts.get(0))) ? false : true;
    }
    ...
    public int hashCode() {
        ...
        int iHashCode30 = ((((((((iHashCode29 + (str11 != null ? str11.hashCode() : 0)) * 41) + this.f36mm) * 41) + this.intimacy) * 41) + this.quickChatProgress) * 41) + (this.hasLocalBreakIce ? 1231 : 1237);
    ...
    public boolean isConfessionFirstConv() {
        if (!NullChecker.a(this.additional) || !NullChecker.a(this.additional.greetingInfo)) {
            return false;
        }
        GreetingInfo greetingInfo = this.additional.greetingInfo;
        return greetingInfo.fromGreeting && TEnum.equals(greetingInfo.channel, "confession");
    }
    ...
    public boolean isFakeHeartbeatConv() {
        return isHeartbeatConv() && NullChecker.a(this.additional.heartbeatMatch) && this.additional.heartbeatMatch.guideFakeToGood;
    }
    ...
    public boolean isFakeQuickChatConv() {
        return isQuickChatConv() && NullChecker.a(this.additional.quickChat) && this.additional.quickChat.guideFakeToGood;
    }
    ...
    public boolean isHeartBeatLock() {
        return TextUtils.equals(this.convType, "heartbeatMatch") && NullChecker.a(this.additional) && NullChecker.a(this.additional.heartbeatMatch) && this.additional.heartbeatMatch.lock;
    }
    ...
    public boolean isLimitMatch() {
        return TextUtils.equals(this.convType, "heartbeatMatch") && NullChecker.a(this.additional) && NullChecker.a(this.additional.heartbeatMatch) && this.additional.heartbeatMatch.matchType == 1;
    }

    public boolean isLimitedTrialSee(String str) {
        return TextUtils.equals(this.convType, ConversationType.free_see_match) && NullChecker.a(this.property) && NullChecker.a(this.property.limitedTrialSee) && TextUtils.equals(this.property.limitedTrialSee.actorId, str);
    }
    ...
    public boolean isMediaBuzzConv() {
        if (!ConversationType.lovebuzz.equals(this.convType) || !NullChecker.a(this.property) || !NullChecker.a(this.property.intl_love_buzz)) {
            return false;
        }
    ...
    public boolean isOtherStatusInvalid() {
        return TextUtils.equals(this.otherStatus, OTHER_STATUS_INVALID);
    }
    ...
    public boolean isQuickChatClearAvatar(User user) {
        return NullChecker.a(this.property) && NullChecker.a(this.property.quickchat) && TextUtils.equals("true", this.property.quickchat.clearAvatar) && user.isFakeUser();
    }
    ...
    public boolean isReSwipeConv() {
        return NullChecker.a(this.additional) && NullChecker.a(this.additional.reSwipe) && TEnum.equals(this.additional.reSwipe.status, "liked");
    }
    ...
    public boolean isSeeUpgradedConv() {
        return TextUtils.equals(this.convType, SEE_UPGRADED_MATCH);
    }
    ...
    public double labelExposureTime() {
        if (NullChecker.a(this.additional) && NullChecker.a(this.additional.newMatch)) {
            return this.additional.newMatch.labelExposureTime;
        }
        return 0.0d;
    }
    ...
    public boolean lowPayOneSideConv() {
        return NullChecker.a(this.additional) && NullChecker.a(this.additional.lowPayOneside) && ConversationType.fake_one_side.equals(this.convType) && this.additional.lowPayOneside.isActor;
    }

    public boolean mutedByFriend() {
        return NullChecker.a(this.additional) && NullChecker.a(this.additional.blackList) && this.additional.blackList.mutedBy;
    }

    public boolean needCheckValidStatus() {
        return (TextUtils.isEmpty(((DbObject) this).id) || ((DbObject) this).id.startsWith("fake_id_") || TextUtils.equals(this.convType, MessageChannel.group)) ? false : true;
    }

    public boolean newMatchExpShowInList() {
        return NullChecker.a(this.property) && NullChecker.a(this.property.conversationTag) && this.property.conversationTag.showInList;
    }
    ...
    public void nullCheck() {
        ...
        if (this.status == null) {
            this.status = ConversationStatus.JSON_ADAPTER.defaultEnum();
        }
