...
public class RealPicturesConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RealPicturesConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<RealPicturesConfig>() { // from class: com.p1.mobile.putong.core.data.RealPicturesConfig.1
        ...
        public int computeAndCacheSize(RealPicturesConfig realPicturesConfig) {
            int iB = CodedOutputByteBufferNano.b(1, realPicturesConfig.enable) + CodedOutputByteBufferNano.h(2, realPicturesConfig.photo_reward_guide_limit) + CodedOutputByteBufferNano.h(3, realPicturesConfig.photo_reward_guide_no_match_days) + CodedOutputByteBufferNano.h(4, realPicturesConfig.photo_reward_guide_swipe_like_threshold);
            ((MessageNano) realPicturesConfig).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public RealPicturesConfig m15265parse(nb5 nb5Var) throws IOException {
            RealPicturesConfig realPicturesConfig = new RealPicturesConfig();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 8) {
                    realPicturesConfig.enable = nb5Var.g();
                } else if (iU == 16) {
                    realPicturesConfig.photo_reward_guide_limit = nb5Var.j();
                } else if (iU == 24) {
                    realPicturesConfig.photo_reward_guide_no_match_days = nb5Var.j();
                } else {
                    if (iU != 32) {
                        return realPicturesConfig;
                    }
                    realPicturesConfig.photo_reward_guide_swipe_like_threshold = nb5Var.j();
                }
            }
        }
        ...
        public void serialize(RealPicturesConfig realPicturesConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.A(1, realPicturesConfig.enable);
            codedOutputByteBufferNano.G(2, realPicturesConfig.photo_reward_guide_limit);
            codedOutputByteBufferNano.G(3, realPicturesConfig.photo_reward_guide_no_match_days);
            codedOutputByteBufferNano.G(4, realPicturesConfig.photo_reward_guide_swipe_like_threshold);
        }
    };
    public static JsonAdapter<RealPicturesConfig> JSON_ADAPTER = new ObjectJsonAdapter<RealPicturesConfig>() { // from class: com.p1.mobile.putong.core.data.RealPicturesConfig.2
        ...
        public RealPicturesConfig m15266newInstance() {
    ...
    public RealPicturesConfig m15264clone() {
        RealPicturesConfig realPicturesConfig = new RealPicturesConfig();
