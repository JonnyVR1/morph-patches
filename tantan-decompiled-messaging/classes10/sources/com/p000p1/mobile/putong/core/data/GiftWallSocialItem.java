...
public class GiftWallSocialItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GiftWallSocialItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<GiftWallSocialItem>() { // from class: com.p1.mobile.putong.core.data.GiftWallSocialItem.1
        ...
        public int computeAndCacheSize(GiftWallSocialItem giftWallSocialItem) {
            int iB = CodedOutputByteBufferNano.b(1, giftWallSocialItem.canChat);
            ...
            if (gender != null) {
                iB += CodedOutputByteBufferNano.h(6, gender.ordinal());
            }
            Gender gender2 = giftWallSocialItem.gender;
            if (gender2 != null) {
                iB += CodedOutputByteBufferNano.l(7, gender2, Gender.PROTOBUF_ADAPTER);
            }
            ((MessageNano) giftWallSocialItem).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public GiftWallSocialItem m12981parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 0) {
                    if (giftWallSocialItem.gender == null && numValueOf != null) {
                        giftWallSocialItem.gender = Gender.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
                    }
                    ...
                    giftWallSocialItem.gender = Gender.JSON_ADAPTER.defaultEnum();
                    break;
                }
                if (iU == 8) {
                    giftWallSocialItem.canChat = nb5Var.g();
                } else if (iU == 18) {
                    giftWallSocialItem.giftAmount = nb5Var.s();
                } else if (iU == 26) {
                    giftWallSocialItem.userAvatar = nb5Var.s();
                } else if (iU == 34) {
                    giftWallSocialItem.userID = nb5Var.s();
                } else if (iU == 42) {
                    giftWallSocialItem.userName = nb5Var.s();
                } else if (iU == 48) {
                    ...
                    giftWallSocialItem.gender = (Gender) nb5Var.l(Gender.PROTOBUF_ADAPTER);
                }
            }
            return giftWallSocialItem;
        }
        ...
        public void serialize(GiftWallSocialItem giftWallSocialItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.A(1, giftWallSocialItem.canChat);
            String str = giftWallSocialItem.giftAmount;
            if (str != null) {
            ...
            Gender gender = giftWallSocialItem.gender;
            if (gender != null) {
                codedOutputByteBufferNano.G(6, gender.ordinal());
            }
            Gender gender2 = giftWallSocialItem.gender;
            if (gender2 != null) {
                codedOutputByteBufferNano.K(7, gender2, Gender.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<GiftWallSocialItem> JSON_ADAPTER = new ObjectJsonAdapter<GiftWallSocialItem>() { // from class: com.p1.mobile.putong.core.data.GiftWallSocialItem.2
        ...
        public GiftWallSocialItem m12982newInstance() {
        ...
        public boolean parseField(GiftWallSocialItem giftWallSocialItem, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "gender":
                    giftWallSocialItem.gender = (Gender) Gender.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "userID":
    ...
    public GiftWallSocialItem m12980clone() {
        GiftWallSocialItem giftWallSocialItem = new GiftWallSocialItem();
