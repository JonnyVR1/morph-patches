...
public class TextCardData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TextCardData> PROTOBUF_ADAPTER = new MessageNanoAdapter<TextCardData>() { // from class: com.p1.mobile.putong.core.data.TextCardData.1
        ...
        public int computeAndCacheSize(TextCardData textCardData) {
            ...
            ((MessageNano) textCardData).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public TextCardData m15962parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    textCardData.userID = nb5Var.s();
                } else if (iU == 18) {
                    textCardData.secretKey = nb5Var.s();
                } else if (iU == 26) {
                    textCardData.stage = nb5Var.s();
                } else if (iU == 34) {
                    textCardData.biz = nb5Var.s();
                } else if (iU == 42) {
                    textCardData.fitReason = nb5Var.s();
                } else if (iU == 50) {
                    textCardData.zodiacFitPercent = nb5Var.s();
                } else {
                    if (iU != 58) {
                        if (textCardData.userID == null) {
                            textCardData.userID = "";
                    ...
                    textCardData.friendPurpose = nb5Var.s();
                }
            }
            return textCardData;
        }
    ...
    public static JsonAdapter<TextCardData> JSON_ADAPTER = new ObjectJsonAdapter<TextCardData>() { // from class: com.p1.mobile.putong.core.data.TextCardData.2
        ...
        public TextCardData m15963newInstance() {
    ...
    public TextCardData m15961clone() {
        TextCardData textCardData = new TextCardData();
