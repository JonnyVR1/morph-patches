...
public class ChallengeMsg extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChallengeMsg> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChallengeMsg>() { // from class: com.p1.mobile.putong.core.data.ChallengeMsg.1
        ...
        public int computeAndCacheSize(ChallengeMsg challengeMsg) {
            ...
            ((MessageNano) challengeMsg).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public ChallengeMsg m11949parse(nb5 nb5Var) throws IOException {
            ChallengeMsg challengeMsg = new ChallengeMsg();
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        if (challengeMsg.f21id == null) {
                            challengeMsg.f21id = "";
                        }
                    ...
                    case Conversation.SURPRISE_LEVEL_TOP /* 10 */:
                        challengeMsg.f21id = nb5Var.s();
                        continue;
                    case 18:
                        challengeMsg.type = nb5Var.s();
                        continue;
                    case 26:
                        challengeMsg.title = nb5Var.s();
                        continue;
                    case 34:
                        challengeMsg.subTitle = nb5Var.s();
                        continue;
                    case 42:
                        challengeMsg.buttonText = nb5Var.s();
                        continue;
                    case Conversation.EXPOSURE_LEVEL_TOP /* 50 */:
                        challengeMsg.link = nb5Var.s();
                        continue;
                    case 58:
                        challengeMsg.eventlog = nb5Var.s();
                        continue;
                    case 66:
                        challengeMsg.picUrl = nb5Var.s();
                        continue;
                    case 74:
                        challengeMsg.source = nb5Var.s();
                        continue;
                    case 82:
                        challengeMsg.roomId = nb5Var.s();
                        continue;
                    case Conversation.LEVEL_TOP_PLATINUM /* 90 */:
                        challengeMsg.scriptId = nb5Var.s();
                        continue;
                    default:
                        if (challengeMsg.f21id == null) {
                            challengeMsg.f21id = "";
    ...
    public static JsonAdapter<ChallengeMsg> JSON_ADAPTER = new ObjectJsonAdapter<ChallengeMsg>() { // from class: com.p1.mobile.putong.core.data.ChallengeMsg.2
        ...
        public ChallengeMsg m11950newInstance() {
        ...
        public boolean parseField(ChallengeMsg challengeMsg, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "scriptId":
                    ...
                    return true;
                case "id":
                    challengeMsg.f21id = jsonParser.getValueAsString();
                    return false;
                case "link":
        ...
        public void serializeFields(ChallengeMsg challengeMsg, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str6 = challengeMsg.link;
            if (str6 != null) {
                jsonGenerator.writeStringField("link", str6);
            }
            String str7 = challengeMsg.eventlog;
            if (str7 != null) {
    ...
    public ChallengeMsg m11948clone() {
        ChallengeMsg challengeMsg = new ChallengeMsg();
        challengeMsg.f21id = this.f21id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21id, challengeMsg.f21id) && ValueObject.util_equals(this.type, challengeMsg.type) && ValueObject.util_equals(this.title, challengeMsg.title) && ValueObject.util_equals(this.subTitle, challengeMsg.subTitle) && ValueObject.util_equals(this.buttonText, challengeMsg.buttonText) && ValueObject.util_equals(this.link, challengeMsg.link) && ValueObject.util_equals(this.eventlog, challengeMsg.eventlog) && ValueObject.util_equals(this.picUrl, challengeMsg.picUrl) && ValueObject.util_equals(this.source, challengeMsg.source) && ValueObject.util_equals(this.roomId, challengeMsg.roomId) && ValueObject.util_equals(this.scriptId, challengeMsg.scriptId);
    }
