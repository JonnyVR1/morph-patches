...
public class Identity extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Identity> PROTOBUF_ADAPTER = new MessageNanoAdapter<Identity>() { // from class: com.p1.mobile.putong.core.data.Identity.1
        ...
        public int computeAndCacheSize(Identity identity) {
            ...
            if (certificate != null) {
                iO += CodedOutputByteBufferNano.l(2, certificate, Certificate.PROTOBUF_ADAPTER);
            }
            VerificationStatus verificationStatus = identity.status;
            if (verificationStatus != null) {
                iO += CodedOutputByteBufferNano.h(3, verificationStatus.ordinal());
            }
            VerificationStatus verificationStatus2 = identity.status;
            if (verificationStatus2 != null) {
                iO += CodedOutputByteBufferNano.l(4, verificationStatus2, VerificationStatus.PROTOBUF_ADAPTER);
            }
            ((MessageNano) identity).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Identity m13437parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 0) {
                    if (identity.status == null && numValueOf != null) {
                        identity.status = (VerificationStatus) VerificationStatus.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
                    }
                ...
                if (iU == 10) {
                    identity.name = nb5Var.s();
                } else if (iU == 18) {
                    identity.certificate = (Certificate) nb5Var.l(Certificate.PROTOBUF_ADAPTER);
                } else if (iU == 24) {
                    ...
                    identity.status = (VerificationStatus) nb5Var.l(VerificationStatus.PROTOBUF_ADAPTER);
                }
            }
            return identity;
        }
        ...
        public void serialize(Identity identity, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Certificate certificate = identity.certificate;
            if (certificate != null) {
                codedOutputByteBufferNano.K(2, certificate, Certificate.PROTOBUF_ADAPTER);
            }
            VerificationStatus verificationStatus = identity.status;
            if (verificationStatus != null) {
                codedOutputByteBufferNano.G(3, verificationStatus.ordinal());
            }
            VerificationStatus verificationStatus2 = identity.status;
            if (verificationStatus2 != null) {
                codedOutputByteBufferNano.K(4, verificationStatus2, VerificationStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Identity> JSON_ADAPTER = new ObjectJsonAdapter<Identity>() { // from class: com.p1.mobile.putong.core.data.Identity.2
        ...
        public Identity m13438newInstance() {
            return new Identity();
        }
        ...
        public boolean parseField(Identity identity, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "status":
                    identity.status = (VerificationStatus) VerificationStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "name":
                    identity.name = jsonParser.getValueAsString();
                    return true;
                case "certificate":
                    identity.certificate = (Certificate) Certificate.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public Identity m13436clone() {
        Identity identity = new Identity();
        identity.name = this.name;
        Certificate certificate = this.certificate;
        if (certificate != null) {
            identity.certificate = certificate.m11934clone();
        }
