...
public class GreetSendGiftConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GreetSendGiftConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<GreetSendGiftConfig>() { // from class: com.p1.mobile.putong.core.data.GreetSendGiftConfig.1
        ...
        public int computeAndCacheSize(GreetSendGiftConfig greetSendGiftConfig) {
            ...
            ((MessageNano) greetSendGiftConfig).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public GreetSendGiftConfig m13009parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    ...
                    case Conversation.SURPRISE_LEVEL_TOP /* 10 */:
                        greetSendGiftConfig.maleTitle = nb5Var.s();
                        continue;
                    case 18:
                        greetSendGiftConfig.femaleTitle = nb5Var.s();
                        continue;
                    case 26:
                        greetSendGiftConfig.maleSubTitle = nb5Var.s();
                        continue;
                    case 34:
                        greetSendGiftConfig.femaleSubTitle = nb5Var.s();
                        continue;
                    case 42:
                        greetSendGiftConfig.maleSendTipsByMoment = nb5Var.s();
                        continue;
                    case Conversation.EXPOSURE_LEVEL_TOP /* 50 */:
                        greetSendGiftConfig.femaleSendTipsByMoment = nb5Var.s();
                        continue;
                    case 58:
                        greetSendGiftConfig.maleSendTips = nb5Var.s();
                        continue;
                    case 66:
                        greetSendGiftConfig.maleRefusedGiftTips = nb5Var.s();
                        continue;
                    case 74:
                        greetSendGiftConfig.femaleSendTips = nb5Var.s();
                        continue;
                    case 82:
                        greetSendGiftConfig.femaleRefusedGiftTips = nb5Var.s();
                        continue;
                    default:
                        if (greetSendGiftConfig.maleTitle == null) {
                            greetSendGiftConfig.maleTitle = "";
    ...
    public static JsonAdapter<GreetSendGiftConfig> JSON_ADAPTER = new ObjectJsonAdapter<GreetSendGiftConfig>() { // from class: com.p1.mobile.putong.core.data.GreetSendGiftConfig.2
        ...
        public GreetSendGiftConfig m13010newInstance() {
    ...
    public GreetSendGiftConfig m13008clone() {
        GreetSendGiftConfig greetSendGiftConfig = new GreetSendGiftConfig();
