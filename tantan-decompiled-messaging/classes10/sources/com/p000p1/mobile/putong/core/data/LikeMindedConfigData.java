...
import com.p000p1.mobile.putong.core.data.LikeMindedItemData;
...
public class LikeMindedConfigData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikeMindedConfigData> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikeMindedConfigData>() { // from class: com.p1.mobile.putong.core.data.LikeMindedConfigData.1
        ...
        public int computeAndCacheSize(LikeMindedConfigData likeMindedConfigData) {
            int iB = CodedOutputByteBufferNano.b(1, likeMindedConfigData.enable);
            Map<String, LikeMindedMccConfigData> map = likeMindedConfigData.mcc;
            if (map != null) {
                iB += CodedOutputByteBufferNano.l(2, map, LikeMindedMccConfigData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            Map<String, LikeMindedItemData> map2 = likeMindedConfigData.same;
            if (map2 != null) {
                iB += CodedOutputByteBufferNano.l(3, map2, LikeMindedItemData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            ((MessageNano) likeMindedConfigData).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public LikeMindedConfigData m13839parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 8) {
                    likeMindedConfigData.enable = nb5Var.g();
                } else if (iU == 18) {
                    likeMindedConfigData.mcc = (Map) nb5Var.l(LikeMindedMccConfigData.PROTOBUF_ADAPTER.MAP_ADAPTER());
                } else {
                    if (iU != 26) {
                        if (likeMindedConfigData.mcc == null) {
                            likeMindedConfigData.mcc = Collections.EMPTY_MAP;
                    ...
                    likeMindedConfigData.same = (Map) nb5Var.l(LikeMindedItemData.PROTOBUF_ADAPTER.MAP_ADAPTER());
                }
            }
            return likeMindedConfigData;
        }
        ...
        public void serialize(LikeMindedConfigData likeMindedConfigData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.A(1, likeMindedConfigData.enable);
            Map<String, LikeMindedMccConfigData> map = likeMindedConfigData.mcc;
            if (map != null) {
                codedOutputByteBufferNano.K(2, map, LikeMindedMccConfigData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            Map<String, LikeMindedItemData> map2 = likeMindedConfigData.same;
            if (map2 != null) {
                codedOutputByteBufferNano.K(3, map2, LikeMindedItemData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
        }
    };
    public static JsonAdapter<LikeMindedConfigData> JSON_ADAPTER = new ObjectJsonAdapter<LikeMindedConfigData>() { // from class: com.p1.mobile.putong.core.data.LikeMindedConfigData.2
        ...
        public LikeMindedConfigData m13840newInstance() {
    ...
    public LikeMindedConfigData m13838clone() {
        LikeMindedConfigData likeMindedConfigData = new LikeMindedConfigData();
        likeMindedConfigData.enable = this.enable;
        Map<String, LikeMindedMccConfigData> map = this.mcc;
        if (map != null) {
            likeMindedConfigData.mcc = ValueObject.util_map(map, new w9j() { // from class: l.edr
                public final Object call(Object obj) {
                    return ((LikeMindedMccConfigData) obj).m13866clone();
                }
            });
        }
        Map<String, LikeMindedItemData> map2 = this.same;
        if (map2 != null) {
            likeMindedConfigData.same = ValueObject.util_map(map2, new w9j() { // from class: l.fdr
                public final Object call(Object obj) {
                    return ((LikeMindedItemData) obj).m13850clone();
                }
            });
        }
        return likeMindedConfigData;
