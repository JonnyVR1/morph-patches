...
public class Figure extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Figure> PROTOBUF_ADAPTER = new MessageNanoAdapter<Figure>() { // from class: com.p1.mobile.putong.core.data.Figure.1
        ...
        public int computeAndCacheSize(Figure figure) {
            int iH = CodedOutputByteBufferNano.h(1, figure.total);
            FigureMessage figureMessage = figure.message;
            if (figureMessage != null) {
                iH += CodedOutputByteBufferNano.l(2, figureMessage, FigureMessage.PROTOBUF_ADAPTER);
            }
            FigureMessageType figureMessageType = figure.type;
            if (figureMessageType != null) {
                iH += CodedOutputByteBufferNano.h(3, figureMessageType.ordinal());
            }
            ...
            if (figureMessageType2 != null) {
                iH += CodedOutputByteBufferNano.l(6, figureMessageType2, FigureMessageType.PROTOBUF_ADAPTER);
            }
            ((MessageNano) figure).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Figure m12771parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 0) {
                    if (figure.type == null && numValueOf != null) {
                        figure.type = (FigureMessageType) FigureMessageType.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
                    }
                ...
                if (iU == 8) {
                    figure.total = nb5Var.j();
                } else if (iU == 18) {
                    figure.message = (FigureMessage) nb5Var.l(FigureMessage.PROTOBUF_ADAPTER);
                } else if (iU == 24) {
                    numValueOf = Integer.valueOf(nb5Var.j());
                } else if (iU == 34) {
                    figure.value = nb5Var.s();
                } else if (iU == 42) {
                    figure.name = nb5Var.s();
                } else {
                    if (iU != 50) {
                        if (figure.type == null && numValueOf != null) {
                            figure.type = (FigureMessageType) FigureMessageType.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
                    ...
                    figure.type = (FigureMessageType) nb5Var.l(FigureMessageType.PROTOBUF_ADAPTER);
                }
            }
            return figure;
        }
        ...
        public void serialize(Figure figure, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.G(1, figure.total);
            FigureMessage figureMessage = figure.message;
            if (figureMessage != null) {
                codedOutputByteBufferNano.K(2, figureMessage, FigureMessage.PROTOBUF_ADAPTER);
            }
            FigureMessageType figureMessageType = figure.type;
            if (figureMessageType != null) {
                codedOutputByteBufferNano.G(3, figureMessageType.ordinal());
            }
            String str = figure.value;
            if (str != null) {
            ...
            FigureMessageType figureMessageType2 = figure.type;
            if (figureMessageType2 != null) {
                codedOutputByteBufferNano.K(6, figureMessageType2, FigureMessageType.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Figure> JSON_ADAPTER = new ObjectJsonAdapter<Figure>() { // from class: com.p1.mobile.putong.core.data.Figure.2
        ...
        public Figure m12772newInstance() {
            return new Figure();
        }
        ...
        public boolean parseField(Figure figure, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "name":
                    ...
                    return true;
                case "type":
                    figure.type = (FigureMessageType) FigureMessageType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "total":
                ...
                case "value":
                    ...
                    return true;
                case "message":
                    figure.message = (FigureMessage) FigureMessage.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public Figure m12770clone() {
        Figure figure = new Figure();
        figure.total = this.total;
        FigureMessage figureMessage = this.message;
        if (figureMessage != null) {
            figure.message = figureMessage.m12774clone();
        }
