...
import com.p000p1.mobile.putong.core.data.SignedStatus;
...
public enum SignedStatus {
    ...
    public static String[] STRS = {"unknown_", StickStatus.normal, VoiceCallStatus.finished, "expired"};
    public static EnumJsonAdapter<SignedStatus> JSON_ADAPTER = new EnumJsonAdapter<>(STRS, VALUES);
    public static EnumProtobufAdapter<SignedStatus> PROTOBUF_ADAPTER = new EnumProtobufAdapter<>(VALUES, new w9j() { // from class: l.zef0
