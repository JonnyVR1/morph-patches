...
import com.p000p1.mobile.putong.core.data.CoreLiveVoiceRoomInProfile;
...
public class CoreLiveVoiceRoomInProfile extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreLiveVoiceRoomInProfile> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreLiveVoiceRoomInProfile>() { // from class: com.p1.mobile.putong.core.data.CoreLiveVoiceRoomInProfile.1
        ...
        public int computeAndCacheSize(CoreLiveVoiceRoomInProfile coreLiveVoiceRoomInProfile) {
            ...
            int iB = iO + CodedOutputByteBufferNano.b(3, coreLiveVoiceRoomInProfile.isPersonal);
            ...
            int iB2 = iB + CodedOutputByteBufferNano.b(6, coreLiveVoiceRoomInProfile.needBuild);
            String str4 = coreLiveVoiceRoomInProfile.voiceLiveId;
            if (str4 != null) {
                iB2 += CodedOutputByteBufferNano.o(7, str4);
            }
            String str5 = coreLiveVoiceRoomInProfile.voiceRoomId;
            if (str5 != null) {
                iB2 += CodedOutputByteBufferNano.o(8, str5);
            }
            String str6 = coreLiveVoiceRoomInProfile.anchorId;
            if (str6 != null) {
                iB2 += CodedOutputByteBufferNano.o(9, str6);
            }
            String str7 = coreLiveVoiceRoomInProfile.background;
            if (str7 != null) {
                iB2 += CodedOutputByteBufferNano.o(10, str7);
            }
            String str8 = coreLiveVoiceRoomInProfile.topicId;
            if (str8 != null) {
                iB2 += CodedOutputByteBufferNano.o(11, str8);
            }
            ((MessageNano) coreLiveVoiceRoomInProfile).cachedSize = iB2;
            return iB2;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public CoreLiveVoiceRoomInProfile m12515parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    ...
                    case Conversation.SURPRISE_LEVEL_TOP /* 10 */:
                        coreLiveVoiceRoomInProfile.title = nb5Var.s();
                        continue;
                    case 18:
                        coreLiveVoiceRoomInProfile.subTitle = nb5Var.s();
                        continue;
                    case 24:
                        coreLiveVoiceRoomInProfile.isPersonal = nb5Var.g();
                        continue;
                    case 34:
                        coreLiveVoiceRoomInProfile.membersText = nb5Var.s();
                        continue;
                    case 42:
                        coreLiveVoiceRoomInProfile.userAvatars = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 48:
                        coreLiveVoiceRoomInProfile.needBuild = nb5Var.g();
                        continue;
                    case 58:
                        coreLiveVoiceRoomInProfile.voiceLiveId = nb5Var.s();
                        continue;
                    case 66:
                        coreLiveVoiceRoomInProfile.voiceRoomId = nb5Var.s();
                        continue;
                    case 74:
                        coreLiveVoiceRoomInProfile.anchorId = nb5Var.s();
                        continue;
                    case 82:
                        coreLiveVoiceRoomInProfile.background = nb5Var.s();
                        continue;
                    case Conversation.LEVEL_TOP_PLATINUM /* 90 */:
                        coreLiveVoiceRoomInProfile.topicId = nb5Var.s();
                        continue;
                    default:
                        if (coreLiveVoiceRoomInProfile.title == null) {
                            coreLiveVoiceRoomInProfile.title = "";
        ...
        public void serialize(CoreLiveVoiceRoomInProfile coreLiveVoiceRoomInProfile, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(3, coreLiveVoiceRoomInProfile.isPersonal);
            String str3 = coreLiveVoiceRoomInProfile.membersText;
            if (str3 != null) {
            ...
            codedOutputByteBufferNano.A(6, coreLiveVoiceRoomInProfile.needBuild);
            String str4 = coreLiveVoiceRoomInProfile.voiceLiveId;
            if (str4 != null) {
    ...
    public static JsonAdapter<CoreLiveVoiceRoomInProfile> JSON_ADAPTER = new ObjectJsonAdapter<CoreLiveVoiceRoomInProfile>() { // from class: com.p1.mobile.putong.core.data.CoreLiveVoiceRoomInProfile.2
        ...
        public CoreLiveVoiceRoomInProfile m12516newInstance() {
    ...
    public static /* synthetic */ String m285a(String str) {
        return str;
    }
    ...
    public CoreLiveVoiceRoomInProfile m12514clone() {
        CoreLiveVoiceRoomInProfile coreLiveVoiceRoomInProfile = new CoreLiveVoiceRoomInProfile();
        ...
        if (list != null) {
            coreLiveVoiceRoomInProfile.userAvatars = ValueObject.util_map(list, new w9j() { // from class: l.jk9
                public final Object call(Object obj) {
                    return CoreLiveVoiceRoomInProfile.m285a((String) obj);
                }
            });
        }
