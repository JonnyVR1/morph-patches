package com.p000p1.mobile.putong.core.p001ui.home.member.likeme;
...
public final class LikeMeFilterView extends HorizontalScrollView implements View.OnClickListener {
    ...
    @Nullable
    public InterfaceC3147a callback;
    ...
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u001f\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H&¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\n\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H&¢\u0006\u0004\b\n\u0010\u000b¨\u0006\fÀ\u0006\u0003"}, d2 = {"Lcom/p1/mobile/putong/core/ui/home/member/likeme/LikeMeFilterView$a;", "", "", "type", "Landroid/view/View;", "view", "", "a", "(Ljava/lang/String;Landroid/view/View;)Z", "", "b", "(Ljava/lang/String;Landroid/view/View;)V", "member_intlGmsRelease"}, k = 1, mv = {QuickChatCardWrapper.QuickChatCardType.PASSIVE, QuickChatCardWrapper.QuickChatCardType.PASSIVE, 0}, xi = 48)
    public interface InterfaceC3147a {
        /* JADX INFO: renamed from: a */
        boolean m3457a(@NotNull String type, @NotNull View view);

        /* JADX INFO: renamed from: b */
        void m3458b(@NotNull String type, @NotNull View view);
    }
    ...
    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m3453a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM11170b = ycr.m11170b(this, inflater, parent);
        viewM11170b.getClass();
        return viewM11170b;
    }

    /* JADX INFO: renamed from: b */
    public final void m3454b(@NotNull InterfaceC3147a callback) {
        callback.getClass();
    ...
    public final String m3455c(View v) {
        if (Intrinsics.d(v, get_match_filter())) {
            return "match_filter";
        }
        if (Intrinsics.d(v, get_nearby_filter())) {
            return "NEARBY_FILTER";
        }
        if (Intrinsics.d(v, get_online_filter())) {
            return "ONLINE_FILTER";
        }
        if (Intrinsics.d(v, get_pop_filter())) {
            return "POP_FILTER";
        }
        if (Intrinsics.d(v, get_verified_filter())) {
            return "VERIFIED_FILTER";
        }
        if (Intrinsics.d(v, get_real_avatar_filter())) {
            return "REAL_AVATAR_FILTER";
        }
        if (Intrinsics.d(v, get_info_rich_filter())) {
    ...
    public final void m3456d(@NotNull Pair<String, Boolean>... types) {
        types.getClass();
        for (Pair<String, Boolean> pair : types) {
            String str = (String) pair.getFirst();
            switch (str.hashCode()) {
                case -1666779075:
                    if (str.equals("REAL_AVATAR_FILTER")) {
                        get_real_avatar_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
                case -1417978554:
                    if (str.equals("POP_FILTER")) {
                        get_pop_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
                case -1293615921:
                    if (str.equals("VERIFIED_FILTER")) {
                        get_verified_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
                case 419192548:
                    if (str.equals("ONLINE_FILTER")) {
                        get_online_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
                case 1079910712:
                    if (str.equals("NEARBY_FILTER")) {
                        get_nearby_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
                case 1107056434:
                    if (str.equals("match_filter")) {
                        get_match_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
                case 1743721002:
                    if (str.equals("INFO_RICH_FILTER")) {
                        get_info_rich_filter().setSelected(((Boolean) pair.getSecond()).booleanValue());
                    }
                    break;
            }
        }
    ...
    @Nullable
    public final InterfaceC3147a getCallback() {
    ...
    public final VText get_info_rich_filter() {
        ...
        Intrinsics.r("_info_rich_filter");
        return null;
    }
    ...
    public final View get_match_filter_match_dot() {
        ...
        Intrinsics.r("_match_filter_match_dot");
        return null;
    }
    ...
    public final VText get_match_filter_match_text() {
        ...
        Intrinsics.r("_match_filter_match_text");
        return null;
    }
    ...
    public final VText get_real_avatar_filter() {
        ...
        Intrinsics.r("_real_avatar_filter");
        return null;
    }
    ...
    public void onClick(@NotNull View v) {
        ...
        String strM3455c = m3455c(v);
        if (strM3455c != null) {
            InterfaceC3147a interfaceC3147a = this.callback;
            if (interfaceC3147a != null ? interfaceC3147a.m3457a(strM3455c, v) : true) {
                v.setSelected(!v.isSelected());
                InterfaceC3147a interfaceC3147a2 = this.callback;
                if (interfaceC3147a2 != null) {
                    interfaceC3147a2.m3458b(strM3455c, v);
                }
            }
        }
    }
    ...
    public final void setCallback(@Nullable InterfaceC3147a interfaceC3147a) {
        this.callback = interfaceC3147a;
    }
