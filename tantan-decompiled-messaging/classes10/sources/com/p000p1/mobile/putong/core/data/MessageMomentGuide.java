...
import com.p000p1.mobile.putong.core.data.MessageMomentGuide;
...
public class MessageMomentGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageMomentGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageMomentGuide>() { // from class: com.p1.mobile.putong.core.data.MessageMomentGuide.1
        ...
        public int computeAndCacheSize(MessageMomentGuide messageMomentGuide) {
            String str = messageMomentGuide.f108id;
            int iO = str != null ? CodedOutputByteBufferNano.o(1, str) : 0;
            String str2 = messageMomentGuide.ownerId;
            if (str2 != null) {
                iO += CodedOutputByteBufferNano.o(2, str2);
            }
            int iD = iO + CodedOutputByteBufferNano.d(3, messageMomentGuide.createdTime) + CodedOutputByteBufferNano.h(4, messageMomentGuide.type);
            List<String> list = messageMomentGuide.imageUrlList;
            if (list != null) {
                iD += CodedOutputByteBufferNano.l(5, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (str4 != null) {
                iD += CodedOutputByteBufferNano.o(7, str4);
            }
            String str5 = messageMomentGuide.videoDuration;
            if (str5 != null) {
                iD += CodedOutputByteBufferNano.o(8, str5);
            }
            ((MessageNano) messageMomentGuide).cachedSize = iD;
            return iD;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public MessageMomentGuide m14233parse(nb5 nb5Var) throws IOException {
            MessageMomentGuide messageMomentGuide = new MessageMomentGuide();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (messageMomentGuide.f108id == null) {
                        messageMomentGuide.f108id = "";
                    }
                ...
                if (iU == 10) {
                    messageMomentGuide.f108id = nb5Var.s();
                } else if (iU == 18) {
                    messageMomentGuide.ownerId = nb5Var.s();
                } else if (iU == 25) {
                    messageMomentGuide.createdTime = nb5Var.h();
                } else if (iU == 32) {
                    messageMomentGuide.type = nb5Var.j();
                } else if (iU == 42) {
                    messageMomentGuide.imageUrlList = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 50) {
                    messageMomentGuide.desc = nb5Var.s();
                } else if (iU == 58) {
                    messageMomentGuide.audioDuration = nb5Var.s();
                } else {
                    if (iU != 66) {
                        if (messageMomentGuide.f108id == null) {
                            messageMomentGuide.f108id = "";
                    ...
                    messageMomentGuide.videoDuration = nb5Var.s();
                }
            }
            return messageMomentGuide;
        }
        ...
        public void serialize(MessageMomentGuide messageMomentGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.C(3, messageMomentGuide.createdTime);
            codedOutputByteBufferNano.G(4, messageMomentGuide.type);
            List<String> list = messageMomentGuide.imageUrlList;
            if (list != null) {
    ...
    public static JsonAdapter<MessageMomentGuide> JSON_ADAPTER = new ObjectJsonAdapter<MessageMomentGuide>() { // from class: com.p1.mobile.putong.core.data.MessageMomentGuide.2
        ...
        public MessageMomentGuide m14234newInstance() {
        ...
        public boolean parseField(MessageMomentGuide messageMomentGuide, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "ownerId":
                    ...
                    return true;
                case "createdTime":
                    messageMomentGuide.createdTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "id":
                    messageMomentGuide.f108id = jsonParser.getValueAsString();
                    return false;
                case "desc":
        ...
        public void serializeFields(MessageMomentGuide messageMomentGuide, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str5 = messageMomentGuide.videoDuration;
            if (str5 != null) {
                jsonGenerator.writeStringField("videoDuration", str5);
            }
        }
    ...
    public static /* synthetic */ String m487a(String str) {
        return str;
    }
    ...
    public MessageMomentGuide m14232clone() {
        MessageMomentGuide messageMomentGuide = new MessageMomentGuide();
        messageMomentGuide.f108id = this.f108id;
        ...
        if (list != null) {
            messageMomentGuide.imageUrlList = ValueObject.util_map(list, new w9j() { // from class: l.psz
                public final Object call(Object obj) {
                    return MessageMomentGuide.m487a((String) obj);
                }
            });
        }
