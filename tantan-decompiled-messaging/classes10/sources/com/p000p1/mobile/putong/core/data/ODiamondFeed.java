...
import com.p000p1.mobile.putong.core.data.ODiamondFeed;
...
public class ODiamondFeed extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ODiamondFeed> PROTOBUF_ADAPTER = new MessageNanoAdapter<ODiamondFeed>() { // from class: com.p1.mobile.putong.core.data.ODiamondFeed.1
        ...
        public int computeAndCacheSize(ODiamondFeed oDiamondFeed) {
            int iB = CodedOutputByteBufferNano.b(1, oDiamondFeed.redDot);
            ...
            if (oDiamondFeedType != null) {
                iB += CodedOutputByteBufferNano.l(3, oDiamondFeedType, ODiamondFeedType.PROTOBUF_ADAPTER);
            }
            ...
            if (oDiamondFeedLatestVisitor != null) {
                iB += CodedOutputByteBufferNano.l(7, oDiamondFeedLatestVisitor, ODiamondFeedLatestVisitor.PROTOBUF_ADAPTER);
            }
            ODiamondFeedInstantChat oDiamondFeedInstantChat = oDiamondFeed.instantChat;
            if (oDiamondFeedInstantChat != null) {
                iB += CodedOutputByteBufferNano.l(8, oDiamondFeedInstantChat, ODiamondFeedInstantChat.PROTOBUF_ADAPTER);
            }
            ((MessageNano) oDiamondFeed).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public ODiamondFeed m14581parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 8) {
                    oDiamondFeed.redDot = nb5Var.g();
                } else if (iU == 18) {
                    oDiamondFeed.userIds = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 26) {
                    oDiamondFeed.feedType = (ODiamondFeedType) nb5Var.l(ODiamondFeedType.PROTOBUF_ADAPTER);
                } else if (iU == 34) {
                    oDiamondFeed.text = nb5Var.s();
                } else if (iU == 42) {
                    oDiamondFeed.subText = nb5Var.s();
                } else if (iU == 50) {
                    oDiamondFeed.highLight = nb5Var.s();
                } else if (iU == 58) {
                    oDiamondFeed.latestVisitor = (ODiamondFeedLatestVisitor) nb5Var.l(ODiamondFeedLatestVisitor.PROTOBUF_ADAPTER);
                } else {
                    if (iU != 66) {
                        if (oDiamondFeed.userIds == null) {
                            oDiamondFeed.userIds = new ArrayList();
                    ...
                    oDiamondFeed.instantChat = (ODiamondFeedInstantChat) nb5Var.l(ODiamondFeedInstantChat.PROTOBUF_ADAPTER);
                }
            }
            return oDiamondFeed;
        }
        ...
        public void serialize(ODiamondFeed oDiamondFeed, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.A(1, oDiamondFeed.redDot);
            List<String> list = oDiamondFeed.userIds;
            if (list != null) {
            ...
            ODiamondFeedType oDiamondFeedType = oDiamondFeed.feedType;
            if (oDiamondFeedType != null) {
                codedOutputByteBufferNano.K(3, oDiamondFeedType, ODiamondFeedType.PROTOBUF_ADAPTER);
            }
            String str = oDiamondFeed.text;
            if (str != null) {
            ...
            ODiamondFeedLatestVisitor oDiamondFeedLatestVisitor = oDiamondFeed.latestVisitor;
            if (oDiamondFeedLatestVisitor != null) {
                codedOutputByteBufferNano.K(7, oDiamondFeedLatestVisitor, ODiamondFeedLatestVisitor.PROTOBUF_ADAPTER);
            }
            ODiamondFeedInstantChat oDiamondFeedInstantChat = oDiamondFeed.instantChat;
            if (oDiamondFeedInstantChat != null) {
                codedOutputByteBufferNano.K(8, oDiamondFeedInstantChat, ODiamondFeedInstantChat.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<ODiamondFeed> JSON_ADAPTER = new ObjectJsonAdapter<ODiamondFeed>() { // from class: com.p1.mobile.putong.core.data.ODiamondFeed.2
        ...
        public ODiamondFeed m14582newInstance() {
        ...
        public boolean parseField(ODiamondFeed oDiamondFeed, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "instantChat":
                    oDiamondFeed.instantChat = (ODiamondFeedInstantChat) ODiamondFeedInstantChat.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "latestVisitor":
                    oDiamondFeed.latestVisitor = (ODiamondFeedLatestVisitor) ODiamondFeedLatestVisitor.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "subText":
                ...
                case "highLight":
                    ...
                    return true;
                case "feedType":
                    oDiamondFeed.feedType = (ODiamondFeedType) ODiamondFeedType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "userIds":
        ...
        public void serializeFields(ODiamondFeed oDiamondFeed, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeBooleanField("redDot", oDiamondFeed.redDot);
            if (oDiamondFeed.userIds != null) {
    ...
    public static /* synthetic */ String m527a(String str) {
        return str;
    }
    ...
    public ODiamondFeed m14580clone() {
        ODiamondFeed oDiamondFeed = new ODiamondFeed();
        ...
        if (list != null) {
            oDiamondFeed.userIds = ValueObject.util_map(list, new w9j() { // from class: l.xv40
                public final Object call(Object obj) {
                    return ODiamondFeed.m527a((String) obj);
                }
            });
        }
        ...
        if (oDiamondFeedLatestVisitor != null) {
            oDiamondFeed.latestVisitor = oDiamondFeedLatestVisitor.m14588clone();
        }
        ODiamondFeedInstantChat oDiamondFeedInstantChat = this.instantChat;
        if (oDiamondFeedInstantChat != null) {
            oDiamondFeed.instantChat = oDiamondFeedInstantChat.m14584clone();
        }
        return oDiamondFeed;
    }
