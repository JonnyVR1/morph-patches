...
import com.p000p1.mobile.putong.core.data.Bags;
import com.p000p1.mobile.putong.core.data.TreasurePrizeAd;
import com.p000p1.mobile.putong.core.data.TreasurePrizeInfo;
...
public class MonetizationTreasure extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MonetizationTreasure> PROTOBUF_ADAPTER = new MessageNanoAdapter<MonetizationTreasure>() { // from class: com.p1.mobile.putong.core.data.MonetizationTreasure.1
        ...
        public int computeAndCacheSize(MonetizationTreasure monetizationTreasure) {
            int iH = CodedOutputByteBufferNano.h(1, monetizationTreasure.freeTimes) + CodedOutputByteBufferNano.h(2, monetizationTreasure.gemRemaining) + CodedOutputByteBufferNano.h(3, monetizationTreasure.gemConsumeAmount) + CodedOutputByteBufferNano.h(4, monetizationTreasure.coinConsumeAmount) + CodedOutputByteBufferNano.h(5, monetizationTreasure.expiringCount) + CodedOutputByteBufferNano.h(6, monetizationTreasure.coinRemaining) + CodedOutputByteBufferNano.h(7, monetizationTreasure.coinAmount);
            List<TreasurePrizeInfo> list = monetizationTreasure.treasurePrizeInfos;
            if (list != null) {
                iH += CodedOutputByteBufferNano.l(8, list, TreasurePrizeInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<TreasurePrizeAd> list2 = monetizationTreasure.treasurePrizeAds;
            if (list2 != null) {
                iH += CodedOutputByteBufferNano.l(9, list2, TreasurePrizeAd.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Bags> list3 = monetizationTreasure.bags;
            if (list3 != null) {
                iH += CodedOutputByteBufferNano.l(10, list3, Bags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ((MessageNano) monetizationTreasure).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public MonetizationTreasure m14385parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        monetizationTreasure.freeTimes = nb5Var.j();
                        continue;
                    case 16:
                        monetizationTreasure.gemRemaining = nb5Var.j();
                        continue;
                    case 24:
                        monetizationTreasure.gemConsumeAmount = nb5Var.j();
                        continue;
                    case 32:
                        monetizationTreasure.coinConsumeAmount = nb5Var.j();
                        continue;
                    case 40:
                        monetizationTreasure.expiringCount = nb5Var.j();
                        continue;
                    case 48:
                        monetizationTreasure.coinRemaining = nb5Var.j();
                        continue;
                    case 56:
                        monetizationTreasure.coinAmount = nb5Var.j();
                        continue;
                    case 66:
                        monetizationTreasure.treasurePrizeInfos = (List) nb5Var.l(TreasurePrizeInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        monetizationTreasure.treasurePrizeAds = (List) nb5Var.l(TreasurePrizeAd.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 82:
                        monetizationTreasure.bags = (List) nb5Var.l(Bags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (monetizationTreasure.treasurePrizeInfos == null) {
                            monetizationTreasure.treasurePrizeInfos = new ArrayList();
        ...
        public void serialize(MonetizationTreasure monetizationTreasure, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.G(1, monetizationTreasure.freeTimes);
            codedOutputByteBufferNano.G(2, monetizationTreasure.gemRemaining);
            codedOutputByteBufferNano.G(3, monetizationTreasure.gemConsumeAmount);
            codedOutputByteBufferNano.G(4, monetizationTreasure.coinConsumeAmount);
            codedOutputByteBufferNano.G(5, monetizationTreasure.expiringCount);
            codedOutputByteBufferNano.G(6, monetizationTreasure.coinRemaining);
            codedOutputByteBufferNano.G(7, monetizationTreasure.coinAmount);
            List<TreasurePrizeInfo> list = monetizationTreasure.treasurePrizeInfos;
            if (list != null) {
                codedOutputByteBufferNano.K(8, list, TreasurePrizeInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<TreasurePrizeAd> list2 = monetizationTreasure.treasurePrizeAds;
            if (list2 != null) {
                codedOutputByteBufferNano.K(9, list2, TreasurePrizeAd.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Bags> list3 = monetizationTreasure.bags;
            if (list3 != null) {
                codedOutputByteBufferNano.K(10, list3, Bags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    public static JsonAdapter<MonetizationTreasure> JSON_ADAPTER = new ObjectJsonAdapter<MonetizationTreasure>() { // from class: com.p1.mobile.putong.core.data.MonetizationTreasure.2
        ...
        public MonetizationTreasure m14386newInstance() {
    ...
    public MonetizationTreasure m14384clone() {
        MonetizationTreasure monetizationTreasure = new MonetizationTreasure();
        ...
        if (list != null) {
            monetizationTreasure.treasurePrizeInfos = ValueObject.util_map(list, new w9j() { // from class: l.px00
                public final Object call(Object obj) {
                    return ((TreasurePrizeInfo) obj).m16021clone();
                }
            });
        }
        ...
        if (list2 != null) {
            monetizationTreasure.treasurePrizeAds = ValueObject.util_map(list2, new w9j() { // from class: l.qx00
                public final Object call(Object obj) {
                    return ((TreasurePrizeAd) obj).m16015clone();
                }
            });
        }
