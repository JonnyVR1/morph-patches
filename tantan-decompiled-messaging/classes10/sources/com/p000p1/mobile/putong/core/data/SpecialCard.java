...
import com.p000p1.mobile.putong.core.data.SpecialCard;
...
public class SpecialCard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpecialCard> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpecialCard>() { // from class: com.p1.mobile.putong.core.data.SpecialCard.1
        ...
        public int computeAndCacheSize(SpecialCard specialCard) {
            ...
            int iH = specialCardGender != null ? CodedOutputByteBufferNano.h(1, specialCardGender.ordinal()) : 0;
            DeviceType deviceType = specialCard.device_OS;
            if (deviceType != null) {
                iH += CodedOutputByteBufferNano.h(2, deviceType.ordinal());
            }
            ...
            int iH2 = iH + CodedOutputByteBufferNano.h(4, specialCard.actived_duration);
            List<Double> list2 = specialCard.interval_day;
            if (list2 != null) {
                iH2 += CodedOutputByteBufferNano.l(5, list2, ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            int iH3 = iH2 + CodedOutputByteBufferNano.h(6, specialCard.interval_hour_cycle_mode) + CodedOutputByteBufferNano.h(7, specialCard.swipe_wright_time) + CodedOutputByteBufferNano.h(8, specialCard.num_limited_left) + CodedOutputByteBufferNano.h(9, specialCard.version);
            SpecialCardGender specialCardGender2 = specialCard.gender;
            if (specialCardGender2 != null) {
                iH3 += CodedOutputByteBufferNano.l(10, specialCardGender2, SpecialCardGender.PROTOBUF_ADAPTER);
            }
            DeviceType deviceType2 = specialCard.device_OS;
            if (deviceType2 != null) {
                iH3 += CodedOutputByteBufferNano.l(11, deviceType2, DeviceType.PROTOBUF_ADAPTER);
            }
            ((MessageNano) specialCard).cachedSize = iH3;
            return iH3;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public SpecialCard m15692parse(nb5 nb5Var) throws IOException {
                ...
                switch (nb5Var.u()) {
                    case 0:
                        if (specialCard.gender == null && numValueOf != null) {
                            specialCard.gender = (SpecialCardGender) SpecialCardGender.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
                        }
                        if (specialCard.device_OS == null && numValueOf2 != null) {
                            specialCard.device_OS = (DeviceType) DeviceType.JSON_ADAPTER.newTEnum((String) null, numValueOf2.intValue());
                        }
                    ...
                    case 16:
                        ...
                        continue;
                    case 26:
                        specialCard.signup_country = (List) nb5Var.l(ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 32:
                        specialCard.actived_duration = nb5Var.j();
                        continue;
                    case 42:
                        specialCard.interval_day = (List) nb5Var.l(ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 48:
                        specialCard.interval_hour_cycle_mode = nb5Var.j();
                        continue;
                    case 56:
                        specialCard.swipe_wright_time = nb5Var.j();
                        continue;
                    case 64:
                        specialCard.num_limited_left = nb5Var.j();
                        continue;
                    case 72:
                        specialCard.version = nb5Var.j();
                        continue;
                    case 82:
                        specialCard.gender = (SpecialCardGender) nb5Var.l(SpecialCardGender.PROTOBUF_ADAPTER);
                        continue;
                    case Conversation.LEVEL_TOP_PLATINUM /* 90 */:
                        specialCard.device_OS = (DeviceType) nb5Var.l(DeviceType.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (specialCard.gender == null && numValueOf != null) {
                            specialCard.gender = (SpecialCardGender) SpecialCardGender.JSON_ADAPTER.newTEnum((String) null, numValueOf.intValue());
        ...
        public void serialize(SpecialCard specialCard, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (specialCardGender != null) {
                codedOutputByteBufferNano.G(1, specialCardGender.ordinal());
            }
            DeviceType deviceType = specialCard.device_OS;
            if (deviceType != null) {
                codedOutputByteBufferNano.G(2, deviceType.ordinal());
            }
            List<Integer> list = specialCard.signup_country;
            if (list != null) {
                codedOutputByteBufferNano.K(3, list, ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.G(4, specialCard.actived_duration);
            List<Double> list2 = specialCard.interval_day;
            if (list2 != null) {
                codedOutputByteBufferNano.K(5, list2, ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.G(6, specialCard.interval_hour_cycle_mode);
            codedOutputByteBufferNano.G(7, specialCard.swipe_wright_time);
            codedOutputByteBufferNano.G(8, specialCard.num_limited_left);
            codedOutputByteBufferNano.G(9, specialCard.version);
            SpecialCardGender specialCardGender2 = specialCard.gender;
            if (specialCardGender2 != null) {
                codedOutputByteBufferNano.K(10, specialCardGender2, SpecialCardGender.PROTOBUF_ADAPTER);
            }
            DeviceType deviceType2 = specialCard.device_OS;
            if (deviceType2 != null) {
                codedOutputByteBufferNano.K(11, deviceType2, DeviceType.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<SpecialCard> JSON_ADAPTER = new ObjectJsonAdapter<SpecialCard>() { // from class: com.p1.mobile.putong.core.data.SpecialCard.2
        ...
        public SpecialCard m15693newInstance() {
        ...
        public boolean parseField(SpecialCard specialCard, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "actived_duration":
                    ...
                    return true;
                case "gender":
                    specialCard.gender = (SpecialCardGender) SpecialCardGender.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "device_OS":
                    specialCard.device_OS = (DeviceType) DeviceType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "version":
        ...
        public void serializeFields(SpecialCard specialCard, JsonGenerator jsonGenerator) throws IOException {
            ...
            jsonGenerator.writeNumberField("version", specialCard.version);
        }
    ...
    public static /* synthetic */ Double m649a(Double d) {
        return d;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m650b(Integer num) {
        return num;
    }
    ...
    public SpecialCard m15691clone() {
        SpecialCard specialCard = new SpecialCard();
        specialCard.gender = this.gender;
        specialCard.device_OS = this.device_OS;
        List<Integer> list = this.signup_country;
        if (list != null) {
            specialCard.signup_country = ValueObject.util_map(list, new w9j() { // from class: l.dnf0
                public final Object call(Object obj) {
                    return SpecialCard.m650b((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            specialCard.interval_day = ValueObject.util_map(list2, new w9j() { // from class: l.enf0
                public final Object call(Object obj) {
                    return SpecialCard.m649a((Double) obj);
                }
            });
        }
