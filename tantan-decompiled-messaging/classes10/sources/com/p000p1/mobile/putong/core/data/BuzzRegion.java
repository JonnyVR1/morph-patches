...
public class BuzzRegion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BuzzRegion> PROTOBUF_ADAPTER = new MessageNanoAdapter<BuzzRegion>() { // from class: com.p1.mobile.putong.core.data.BuzzRegion.1
        ...
        public int computeAndCacheSize(BuzzRegion buzzRegion) {
            ...
            ((MessageNano) buzzRegion).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public BuzzRegion m11835parse(nb5 nb5Var) throws IOException {
            BuzzRegion buzzRegion = new BuzzRegion();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (buzzRegion.f19id == null) {
                        buzzRegion.f19id = "";
                    }
                ...
                if (iU == 10) {
                    buzzRegion.f19id = nb5Var.s();
                } else if (iU == 18) {
                    buzzRegion.type = nb5Var.s();
                } else if (iU == 26) {
                    buzzRegion.nameZh = nb5Var.s();
                } else if (iU == 34) {
                    buzzRegion.nameEn = nb5Var.s();
                } else if (iU == 42) {
                    buzzRegion.nameKo = nb5Var.s();
                } else if (iU == 50) {
                    buzzRegion.nameJa = nb5Var.s();
                } else if (iU == 58) {
                    buzzRegion.iconName = nb5Var.s();
                } else if (iU == 66) {
                    buzzRegion.countryCode = nb5Var.s();
                } else {
                    if (iU != 74) {
                        if (buzzRegion.f19id == null) {
                            buzzRegion.f19id = "";
    ...
    public static JsonAdapter<BuzzRegion> JSON_ADAPTER = new ObjectJsonAdapter<BuzzRegion>() { // from class: com.p1.mobile.putong.core.data.BuzzRegion.2
        ...
        public BuzzRegion m11836newInstance() {
        ...
        public boolean parseField(BuzzRegion buzzRegion, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "iconName":
                    ...
                    return true;
                case "id":
                    buzzRegion.f19id = jsonParser.getValueAsString();
                    return false;
                case "type":
        ...
        public void serializeFields(BuzzRegion buzzRegion, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str8 = buzzRegion.countryCode;
            if (str8 != null) {
                jsonGenerator.writeStringField("countryCode", str8);
            }
            String str9 = buzzRegion.emoji;
            if (str9 != null) {
    ...
    public BuzzRegion m11834clone() {
        BuzzRegion buzzRegion = new BuzzRegion();
        buzzRegion.f19id = this.f19id;
