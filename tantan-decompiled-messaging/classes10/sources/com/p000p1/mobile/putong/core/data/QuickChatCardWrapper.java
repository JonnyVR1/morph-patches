...
public class QuickChatCardWrapper {
    ...
    public void consume() {
        markAsConsumed();
        CoreModule.c.m0.F8(new w9j() { // from class: l.ftb0
            public final Object call(Object obj) {
                return this.f4511a.lambda$consume$0((CoreSuggested.UserInfo) obj);
            }
        });
    }
    ...
    public String getFitReason() {
        if (this.cardType == 1 && NullChecker.a(this.insertCard)) {
            return this.insertCard.fitReason;
        }
        if (this.cardType == 2 && NullChecker.a(this.broadcastCard)) {
    ...
    public User getUser() {
        if (this.cardType == 1 && NullChecker.a(this.insertCard)) {
            return CoreModule.c.e0.Pa(this.insertCard.userID);
        }
        int i = this.cardType;
        if ((i == 2 || i == 3) && NullChecker.a(this.broadcastCard)) {
