...
import com.p000p1.mobile.putong.core.data.RankingExtra;
import com.p000p1.mobile.putong.core.data.RankingTag;
...
public class RankingExtra extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RankingExtra> PROTOBUF_ADAPTER = new MessageNanoAdapter<RankingExtra>() { // from class: com.p1.mobile.putong.core.data.RankingExtra.1
        {
        ...
        public int computeAndCacheSize(RankingExtra rankingExtra) {
            ...
            ((MessageNano) rankingExtra).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public RankingExtra m15209parse(nb5 nb5Var) throws IOException {
    ...
    public static JsonAdapter<RankingExtra> JSON_ADAPTER = new ObjectJsonAdapter<RankingExtra>() { // from class: com.p1.mobile.putong.core.data.RankingExtra.2
        public Class getDataClass() {
            return RankingExtra.class;
        }

        /* JADX INFO: renamed from: newInstance, reason: merged with bridge method [inline-methods] */
        public RankingExtra m15210newInstance() {
    ...
    public static /* synthetic */ String m609a(String str) {
        return str;
    }
    ...
    public RankingExtra m15208clone() {
        RankingExtra rankingExtra = new RankingExtra();
        List<RankingTag> list = this.tags;
        if (list != null) {
            rankingExtra.tags = ValueObject.util_map(list, new w9j() { // from class: l.qcc0
                public final Object call(Object obj) {
                    return ((RankingTag) obj).m15212clone();
                }
            });
        }
        ...
        if (list2 != null) {
            rankingExtra.presetTexts = ValueObject.util_map(list2, new w9j() { // from class: l.scc0
                public final Object call(Object obj) {
                    return RankingExtra.m609a((String) obj);
                }
            });
        }
        return rankingExtra;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.tags, rankingExtra.tags) && this.showRedpacketIcon == rankingExtra.showRedpacketIcon && this.picToVideo == rankingExtra.picToVideo && ValueObject.util_equals(this.presetTexts, rankingExtra.presetTexts);
    }
