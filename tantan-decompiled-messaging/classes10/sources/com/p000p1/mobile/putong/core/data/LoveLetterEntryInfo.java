...
public class LoveLetterEntryInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LoveLetterEntryInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<LoveLetterEntryInfo>() { // from class: com.p1.mobile.putong.core.data.LoveLetterEntryInfo.1
        ...
        public int computeAndCacheSize(LoveLetterEntryInfo loveLetterEntryInfo) {
            int iB = CodedOutputByteBufferNano.b(1, loveLetterEntryInfo.display) + CodedOutputByteBufferNano.h(2, loveLetterEntryInfo.count) + CodedOutputByteBufferNano.d(3, loveLetterEntryInfo.startTime) + CodedOutputByteBufferNano.d(4, loveLetterEntryInfo.endTime);
            LoveLetterMessageInfo loveLetterMessageInfo = loveLetterEntryInfo.message;
            if (loveLetterMessageInfo != null) {
                iB += CodedOutputByteBufferNano.l(5, loveLetterMessageInfo, LoveLetterMessageInfo.PROTOBUF_ADAPTER);
            }
            int iH = iB + CodedOutputByteBufferNano.h(6, loveLetterEntryInfo.msgLimit);
            String str = loveLetterEntryInfo.shadingWord;
            if (str != null) {
                iH += CodedOutputByteBufferNano.o(7, str);
            }
            ((MessageNano) loveLetterEntryInfo).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public LoveLetterEntryInfo m14001parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 8) {
                    loveLetterEntryInfo.display = nb5Var.g();
                } else if (iU == 16) {
                    loveLetterEntryInfo.count = nb5Var.j();
                } else if (iU == 25) {
                    loveLetterEntryInfo.startTime = nb5Var.h();
                } else if (iU == 33) {
                    loveLetterEntryInfo.endTime = nb5Var.h();
                } else if (iU == 42) {
                    loveLetterEntryInfo.message = (LoveLetterMessageInfo) nb5Var.l(LoveLetterMessageInfo.PROTOBUF_ADAPTER);
                } else if (iU == 48) {
                    loveLetterEntryInfo.msgLimit = nb5Var.j();
                } else {
                    if (iU != 58) {
                        if (loveLetterEntryInfo.shadingWord != null) {
                            break;
                    ...
                    loveLetterEntryInfo.shadingWord = nb5Var.s();
                }
            }
            return loveLetterEntryInfo;
        }
        ...
        public void serialize(LoveLetterEntryInfo loveLetterEntryInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.A(1, loveLetterEntryInfo.display);
            codedOutputByteBufferNano.G(2, loveLetterEntryInfo.count);
            codedOutputByteBufferNano.C(3, loveLetterEntryInfo.startTime);
            codedOutputByteBufferNano.C(4, loveLetterEntryInfo.endTime);
            LoveLetterMessageInfo loveLetterMessageInfo = loveLetterEntryInfo.message;
            if (loveLetterMessageInfo != null) {
                codedOutputByteBufferNano.K(5, loveLetterMessageInfo, LoveLetterMessageInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(6, loveLetterEntryInfo.msgLimit);
            String str = loveLetterEntryInfo.shadingWord;
            if (str != null) {
    ...
    public static JsonAdapter<LoveLetterEntryInfo> JSON_ADAPTER = new ObjectJsonAdapter<LoveLetterEntryInfo>() { // from class: com.p1.mobile.putong.core.data.LoveLetterEntryInfo.2
        ...
        public LoveLetterEntryInfo m14002newInstance() {
        ...
        public boolean parseField(LoveLetterEntryInfo loveLetterEntryInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "startTime":
                    loveLetterEntryInfo.startTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "endTime":
                    loveLetterEntryInfo.endTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "msgLimit":
                ...
                case "count":
                    ...
                    return true;
                case "message":
                    loveLetterEntryInfo.message = (LoveLetterMessageInfo) LoveLetterMessageInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "shadingWord":
        ...
        public void serializeFields(LoveLetterEntryInfo loveLetterEntryInfo, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeBooleanField("display", loveLetterEntryInfo.display);
    ...
    public LoveLetterEntryInfo m14000clone() {
        LoveLetterEntryInfo loveLetterEntryInfo = new LoveLetterEntryInfo();
        ...
        if (loveLetterMessageInfo != null) {
            loveLetterEntryInfo.message = loveLetterMessageInfo.m14010clone();
        }
