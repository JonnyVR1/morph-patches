...
import com.p000p1.mobile.putong.core.data.PhotoLowConfig;
import com.p000p1.mobile.putong.core.data.ProfessionConfig;
import com.p000p1.mobile.putong.core.data.ProfileCompletionConfig;
import com.p000p1.mobile.putong.core.data.ProfileUiUpgradeExpConfig;
...
public class lqa {
    ...
    public static boolean m7767a() {
        return RemoteConfig.x().s("avatar_cards_enable");
    }

    /* JADX INFO: renamed from: b */
    public static boolean m7768b() {
        return RemoteConfig.x().s("book_movies_pic_2_txt");
    }

    /* JADX INFO: renamed from: c */
    public static ProfileCompletionConfig m7769c() {
        return CoreModule.P().a().xo();
    }

    /* JADX INFO: renamed from: d */
    public static PhotoLowConfig m7770d() {
        try {
            return (PhotoLowConfig) RemoteConfig.x().v("low_photo_config", PhotoLowConfig.JSON_ADAPTER);
    ...
    public static ProfileUiUpgradeExpConfig m7771e() {
        try {
            return (ProfileUiUpgradeExpConfig) RemoteConfig.x().v("profile_mytab_optimize_config", ProfileUiUpgradeExpConfig.JSON_ADAPTER);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static boolean m7772f() {
        return CoreModule.P().a().f4();
    }

    /* JADX INFO: renamed from: g */
    public static boolean m7773g() {
        return CoreModule.P().a().Hr();
    }

    /* JADX INFO: renamed from: h */
    public static boolean m7774h() {
        return CoreModule.P().a().lc();
    }

    /* JADX INFO: renamed from: i */
    public static boolean m7775i() {
        return CoreModule.P().a().cr();
    }

    /* JADX INFO: renamed from: j */
    public static boolean m7776j() {
        return CoreModule.P().a().Ho();
    }

    /* JADX INFO: renamed from: k */
    public static boolean m7777k() {
        return CoreModule.P().a().l6();
    }

    /* JADX INFO: renamed from: l */
    public static boolean m7778l() {
        return CoreModule.P().a().We();
    }

    /* JADX INFO: renamed from: m */
    public static boolean m7779m() {
        return CoreModule.P().a().p0();
    }

    /* JADX INFO: renamed from: n */
    public static boolean m7780n() {
        return CoreModule.P().a().rc();
    }

    /* JADX INFO: renamed from: o */
    public static boolean m7781o() {
        return false;
    }

    /* JADX INFO: renamed from: p */
    public static boolean m7782p() {
        return CoreModule.P().a().ij();
    }

    /* JADX INFO: renamed from: q */
    public static boolean m7783q() {
        return CoreModule.P().a().X5();
    }

    /* JADX INFO: renamed from: r */
    public static boolean m7784r() {
        return CoreModule.P().a().s();
    }

    /* JADX INFO: renamed from: s */
    public static NewProfileCompletionConfig m7785s() {
        NewProfileCompletionConfig newProfileCompletionConfigNew_;
        try {
            newProfileCompletionConfigNew_ = ura.e().d().w() ? (NewProfileCompletionConfig) RemoteConfig.x().v("home_completion_config", NewProfileCompletionConfig.JSON_ADAPTER) : (NewProfileCompletionConfig) RemoteConfig.x().v("profile_dating_completion_config", NewProfileCompletionConfig.JSON_ADAPTER);
        } catch (Exception unused) {
    ...
    public static boolean m7787u() {
        return CoreModule.P().a().Rn();
    }

    /* JADX INFO: renamed from: v */
    public static boolean m7788v() {
        return CoreModule.P().a().q0();
    }

    /* JADX INFO: renamed from: w */
    public static boolean m7789w() {
        return CoreModule.P().a().w();
    }
}
