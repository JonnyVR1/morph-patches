...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(LongLinkMessage.MsgTypeEnum.MSG_TYPE_LIVE_GIFT_RECEIVED_VALUE, 120), new Size(240, LongLinkMessage.MsgTypeEnum.MSG_TYPE_LIVE_GIFT_RECEIVED_VALUE), new Size(320, 240), new Size(XEGiftErrorCode.ERROR_CODE_UNKNOWN, 240), new Size(480, 320), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(800, 600), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, 600), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)));
    ...
    public static CaptureFormat.FramerateRange getClosestSupportedFramerateRange(List<CaptureFormat.FramerateRange> list, final int i) {
        return (CaptureFormat.FramerateRange) Collections.min(list, new ClosestComparator<CaptureFormat.FramerateRange>() { // from class: com.momo.rtcbase.CameraEnumerationAndroid.1
            ...
            @Override // com.momo.rtcbase.CameraEnumerationAndroid.ClosestComparator
            public int diff(CaptureFormat.FramerateRange framerateRange) {
                return progressivePenalty(framerateRange.min, MIN_FPS_THRESHOLD, 1, 4) + progressivePenalty(Math.abs((i * LongLinkMessage.MsgTypeEnum.MSG_TYPE_COMMON_VALUE) - framerateRange.max), MAX_FPS_DIFF_THRESHOLD, 1, 3);
            }
        });
    }

    public static Size getClosestSupportedSize(List<Size> list, final int i, final int i2) {
        return (Size) Collections.min(list, new ClosestComparator<Size>() { // from class: com.momo.rtcbase.CameraEnumerationAndroid.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super();
            }
    ...
    public static class CaptureFormat {
        ...
        public static int frameSize(int i, int i2, int i3) {
            ...
            qq3.a("Don't know how to calculate the frame size of non-NV21 image formats.");
            return 0;
        }
