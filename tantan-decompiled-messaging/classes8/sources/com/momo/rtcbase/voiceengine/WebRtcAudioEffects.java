...
public class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f261ns;
    ...
    public static boolean canUseAcousticEchoCanceler() {
        ...
        Logging.m468d(TAG, "canUseAcousticEchoCanceler: " + z);
        return z;
    }
    ...
    public static boolean canUseNoiseSuppressor() {
        ...
        Logging.m468d(TAG, "canUseNoiseSuppressor: " + z);
        return z;
    }
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (zContains) {
            Logging.m472w(TAG, str + " is blacklisted for HW AEC usage!");
        }
        return zContains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (zContains) {
            Logging.m472w(TAG, str + " is blacklisted for HW NS usage!");
        }
        return zContains;
    }
    ...
    public void enable(int i) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            this.f261ns = noiseSuppressorCreate;
            ...
            sb2.append(z);
            sb2.append(", is now: ");
            sb2.append(this.f261ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f261ns;
    ...
    public boolean setNS(boolean z) {
        ...
        if (this.f261ns == null || z == this.shouldEnableNs) {
