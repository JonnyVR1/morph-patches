...
public class EglRenderer implements VideoSink {
    ...
    public static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) throws Exception {
            try {
                ...
                Logging.m470e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
    ...
    public static /* synthetic */ void m458a(EglRenderer eglRenderer, EglBase.Context context, int[] iArr) {
        if (context == null) {
    ...
    public static /* synthetic */ void m459b(EglRenderer eglRenderer) {
    ...
    public static /* synthetic */ void m461d(EglRenderer eglRenderer, Runnable runnable) {
    ...
    public static /* synthetic */ void m463f(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f, boolean z) {
        if (glDrawer == null) {
    ...
    public static /* synthetic */ void m464g(EglRenderer eglRenderer, CountDownLatch countDownLatch, FrameListener frameListener) {
    ...
    public static /* synthetic */ void m465h(EglRenderer eglRenderer, Looper looper) {
        eglRenderer.logD("Quitting render thread.");
        looper.quit();
    }

    /* JADX INFO: renamed from: i */
    public static /* synthetic */ void m466i(EglRenderer eglRenderer, CountDownLatch countDownLatch) {
        eglRenderer.getClass();
    ...
    private void logD(String str) {
        Logging.m468d(TAG, this.name + str);
    }
    ...
    private void logW(String str) {
        Logging.m472w(TAG, this.name + str);
    }
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: l.sre
            ...
            public final void run() {
                EglRenderer.m463f(this.f4172a, glDrawer, frameListener, f, z);
            }
        });
    }
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                handler.postAtFrontOfQueue(new Runnable() { // from class: l.pre
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f3795a.clearSurfaceOnRenderThread(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: l.bse
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m458a(this.f2321a, context, iArr);
                    }
                });
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        this.renderThreadHandler.post(new Runnable() { // from class: l.vre
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f4990a.renderFrameOnRenderThread();
                            }
                        });
                    } catch (Throwable th) {
                        throw th;
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.gre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m466i(this.f2792a, countDownLatch);
                    }
                });
                ...
                this.renderThreadHandler.post(new Runnable() { // from class: l.jre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m465h(this.f3020a, looper);
                    }
                });
            ...
            try {
                ...
                if (handler == null) {
                    ...
                    this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.dre
                        @Override // java.lang.Runnable
                        public final void run() {
                            EglRenderer.m461d(this.f2586a, runnable);
                        }
                    });
                }
            } catch (Throwable th) {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: l.mre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m464g(this.f3323a, countDownLatch, frameListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
