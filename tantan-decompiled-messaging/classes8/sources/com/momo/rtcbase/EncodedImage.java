...
public class EncodedImage {
    ...
    public enum FrameType {
        ...
        public static FrameType fromNativeIndex(int i) {
            ...
            k250.a("Unknown native frame type: ", i);
            return null;
        }
    ...
    public static class Builder {
        ...
        /* JADX INFO: renamed from: qp */
        private Integer f243qp;
        private int rotation;

        public EncodedImage createEncodedImage() {
            return new EncodedImage(this.buffer, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.completeFrame, this.f243qp);
        }
