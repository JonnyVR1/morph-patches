    ...
    public static class CameraStatistics {
        ...
        public CameraStatistics(SurfaceTextureHelper surfaceTextureHelper, CameraEventsHandler cameraEventsHandler) {
            Runnable runnable = new Runnable() { // from class: com.momo.rtcbase.CameraVideoCapturer.CameraStatistics.1
                ...
                public void run() {
                    Logging.m468d(CameraStatistics.TAG, "Camera fps: " + Math.round((CameraStatistics.this.frameCount * 1000.0f) / 2000.0f) + "");
                    ...
                    if (i == 0) {
                        ...
                        if (CameraStatistics.this.freezePeriodCount * CameraStatistics.CAMERA_OBSERVER_PERIOD_MS >= CameraStatistics.CAMERA_FREEZE_REPORT_TIMOUT_MS && CameraStatistics.this.eventsHandler != null) {
                            Logging.m469e(CameraStatistics.TAG, "Camera freezed.");
            ...
            if (surfaceTextureHelper == null) {
                ig3.a("SurfaceTextureHelper is null");
                throw null;
            }
