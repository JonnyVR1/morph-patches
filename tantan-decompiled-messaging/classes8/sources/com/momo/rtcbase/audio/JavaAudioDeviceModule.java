...
public class JavaAudioDeviceModule implements AudioDeviceModule {
    ...
    public static class Builder {
        ...
        public AudioDeviceModule createAudioDeviceModule() {
            Logging.m468d(JavaAudioDeviceModule.TAG, "createAudioDeviceModule");
            if (this.useHardwareNoiseSuppressor) {
                Logging.m468d(JavaAudioDeviceModule.TAG, "HW NS will be used.");
            } else {
                if (JavaAudioDeviceModule.isBuiltInNoiseSuppressorSupported()) {
                    Logging.m468d(JavaAudioDeviceModule.TAG, "Overriding default behavior; now using WebRTC NS!");
                }
                Logging.m468d(JavaAudioDeviceModule.TAG, "HW NS will not be used.");
            }
            if (this.useHardwareAcousticEchoCanceler) {
                Logging.m468d(JavaAudioDeviceModule.TAG, "HW AEC will be used.");
            } else {
                if (JavaAudioDeviceModule.isBuiltInAcousticEchoCancelerSupported()) {
                    Logging.m468d(JavaAudioDeviceModule.TAG, "Overriding default behavior; now using WebRTC AEC!");
                }
                Logging.m468d(JavaAudioDeviceModule.TAG, "HW AEC will not be used.");
            }
        ...
        public Builder setSampleRate(int i) {
            Logging.m468d(JavaAudioDeviceModule.TAG, "Sample rate overridden to: " + i);
            this.sampleRate = i;
            return this;
        }
        ...
        public Builder setUseHardwareAcousticEchoCanceler(boolean z) {
            if (z && !JavaAudioDeviceModule.isBuiltInAcousticEchoCancelerSupported()) {
                Logging.m469e(JavaAudioDeviceModule.TAG, "HW AEC not supported");
                z = false;
            }
        ...
        public Builder setUseHardwareNoiseSuppressor(boolean z) {
            if (z && !JavaAudioDeviceModule.isBuiltInNoiseSuppressorSupported()) {
                Logging.m469e(JavaAudioDeviceModule.TAG, "HW NS not supported");
                z = false;
            }
    ...
    public void setMicrophoneMute(boolean z) {
        Logging.m468d(TAG, "setMicrophoneMute: " + z);
        this.audioInput.setMicrophoneMute(z);
    }

    @Override // com.momo.rtcbase.audio.AudioDeviceModule
    public void setSpeakerMute(boolean z) {
        Logging.m468d(TAG, "setSpeakerMute: " + z);
