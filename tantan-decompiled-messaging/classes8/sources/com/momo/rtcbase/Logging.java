...
public class Logging {
    ...
    public static /* synthetic */ class C00501 {
    ...
    public static void m468d(String str, String str2) {
    ...
    public static void m470e(String str, String str2, Throwable th) {
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        if (str == null || str2 == null) {
            ig3.a("Logging tag or message may not be null.");
            return;
        }
        if (loggable != null) {
        ...
        int i = C00501.$SwitchMap$com$momo$rtcbase$Logging$Severity[severity.ordinal()];
        if (i == 1) {
            level = Level.SEVERE;
        } else if (i != 2) {
    ...
    public static void m471v(String str, String str2) {
        log(Severity.LS_VERBOSE, str, str2);
    }

    /* JADX INFO: renamed from: w */
    public static void m473w(String str, String str2, Throwable th) {
    ...
    /* JADX INFO: renamed from: e */
    public static void m469e(String str, String str2) {
        log(Severity.LS_ERROR, str, str2);
    }

    /* JADX INFO: renamed from: w */
    public static void m472w(String str, String str2) {
