...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private CameraCharacteristics getCameraCharacteristics(String str) {
        try {
            ...
            Logging.m469e(TAG, "Camera access exception: " + e);
            return null;
        }
    }
    ...
    public static int getFpsUnitFactor(Range<Integer>[] rangeArr) {
        ...
        return LongLinkMessage.MsgTypeEnum.MSG_TYPE_COMMON_VALUE;
    }
    ...
    public static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (map) {
            try {
                ...
                Logging.m468d(TAG, "Get supported formats for camera index " + str + "");
                ...
                try {
                    ...
                    for (Size size : supportedSizes) {
                        ...
                        int iRound = outputMinFrameDuration == 0 ? iMax : ((int) Math.round(NANO_SECONDS_PER_SECOND / outputMinFrameDuration)) * LongLinkMessage.MsgTypeEnum.MSG_TYPE_COMMON_VALUE;
                        arrayList.add(new CameraEnumerationAndroid.CaptureFormat(size.width, size.height, 0, iRound));
                        Logging.m468d(TAG, "Format: " + size.width + "x" + size.height + "@" + iRound);
                    }
                    cachedSupportedFormats.put(str, arrayList);
                    Logging.m468d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                    return arrayList;
                } catch (Exception e) {
                    Logging.m469e(TAG, "getCameraCharacteristics(): " + e);
