...
class Camera2Session implements CameraSession {
    ...
    public static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.m468d(Camera2Session.TAG, "Capture failed: " + captureFailure);
        }
    }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onClosed(CameraDevice cameraDevice) {
            ...
            Logging.m468d(Camera2Session.TAG, "Camera device closed.");
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m468d(Camera2Session.TAG, "Camera opened.");
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public static /* synthetic */ void m456a(CaptureSessionCallback captureSessionCallback, VideoFrame videoFrame) {
            Camera2Session.this.checkIsOnCameraThread();
            if (Camera2Session.this.state != SessionState.RUNNING) {
                Logging.m468d(Camera2Session.TAG, "Texture frame captured but camera is no longer running.");
                return;
            }
        ...
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    Logging.m468d(Camera2Session.TAG, "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m468d(Camera2Session.TAG, "Auto-focus is not available.");
        }
        ...
        private void chooseStabilizationMode(CaptureRequest.Builder builder) {
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        Logging.m468d(Camera2Session.TAG, "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i2 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i2 == 1) {
                    ...
                    Logging.m468d(Camera2Session.TAG, "Using video stabilization.");
                    return;
                }
            }
            Logging.m468d(Camera2Session.TAG, "Stabilization not available.");
        }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m468d(Camera2Session.TAG, "Camera capture session configured.");
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: com.momo.rtcbase.d
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        Camera2Session.CaptureSessionCallback.m456a(this.f258a, videoFrame);
                    }
                });
                Logging.m468d(Camera2Session.TAG, "Camera device successfully started.");
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i, int i2, int i3) {
        Logging.m468d(TAG, "Create new camera2 session on camera " + str);
    ...
    private void findCaptureFormat() {
        ...
        Logging.m468d(TAG, "Available preview sizes: " + supportedSizes);
        ...
        Logging.m468d(TAG, "Using capture format: " + this.captureFormat);
    }
    ...
    private void openCamera() {
        checkIsOnCameraThread();
        Logging.m468d(TAG, "Opening camera " + this.cameraId);
    ...
    public void stop() {
        Logging.m468d(TAG, "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
