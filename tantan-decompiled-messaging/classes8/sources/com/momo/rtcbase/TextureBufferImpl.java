...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i, int i2, int i3, int i4) {
        ...
        retain();
        return new TextureBufferImpl(i, i2, i3, i4, this.type, this.f248id, matrix2, this.toI420Handler, this.yuvConverter, new Runnable() { // from class: l.bki0
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: l.zji0
            ...
            public final Object call() {
                TextureBufferImpl textureBufferImpl = this.f5516a;
