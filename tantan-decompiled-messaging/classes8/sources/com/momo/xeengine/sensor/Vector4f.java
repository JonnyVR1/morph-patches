...
public class Vector4f {
    ...
    public Vector4f(Vector3f vector3f, float f) {
        ...
        this.points = fArr;
        fArr[0] = vector3f.m573x();
        this.points[1] = vector3f.m575y();
        this.points[2] = vector3f.m577z();
        this.points[3] = f;
    }

    public void add(Vector3f vector3f, float f) {
        float[] fArr = this.points;
        fArr[0] = fArr[0] + vector3f.m573x();
        float[] fArr2 = this.points;
        fArr2[1] = fArr2[1] + vector3f.m575y();
        float[] fArr3 = this.points;
        fArr3[2] = fArr3[2] + vector3f.m577z();
    ...
    /* JADX INFO: renamed from: w */
    public void m580w(float f) {
        this.points[3] = f;
    }

    /* JADX INFO: renamed from: x */
    public void m582x(float f) {
        this.points[0] = f;
    }

    /* JADX INFO: renamed from: y */
    public void m584y(float f) {
        this.points[1] = f;
    }

    /* JADX INFO: renamed from: z */
    public void m586z(float f) {
        this.points[2] = f;
    }
