...
public final class XInputActivity extends Activity implements TextWatcher, View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(a6c0.f1836a);
        getWindow().addFlags(67108864);
        View viewFindViewById = findViewById(o4c0.f3494a);
        this.editText = (EditText) findViewById(o4c0.f3496c);
        this.submitBtn = (Button) findViewById(o4c0.f3495b);
