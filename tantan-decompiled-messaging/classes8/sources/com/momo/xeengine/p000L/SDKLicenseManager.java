...
class SDKLicenseManager {
    ...
    public class LicenseRequestTask implements Runnable {
        ...
        public void run() throws Throwable {
            ...
            try {
                ...
                jSONObject.put("appId", SDKLicenseManager.this.appID);
        ...
        if (MODULE_ENABLE) {
            executorServiceNewSingleThreadExecutor.execute(new Runnable() { // from class: com.momo.xeengine.L.a
                ...
                public final void run() {
                    this.f265a.loadLicenseFromStorage();
                }
            });
        }
    }
    ...
    public void updateLicense() {
        ...
        if (this.saveTime + RENEW_THRESHOLD_MILLIS <= jCurrentTimeMillis || jCurrentTimeMillis < this.saveTime) {
