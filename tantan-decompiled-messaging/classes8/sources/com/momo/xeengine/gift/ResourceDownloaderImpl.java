...
final class ResourceDownloaderImpl implements IResourceDownloader {
    ...
    public static /* synthetic */ void m536a(ResourceDownloaderImpl resourceDownloaderImpl, String str, File file, IResourceDownloader.Callback callback) {
        ...
        if (!file.exists()) {
            this.executorService.execute(new Runnable() { // from class: com.momo.xeengine.gift.u
                ...
                public final void run() {
                    ResourceDownloaderImpl.m536a(this.f338a, str, file, callback);
                }
            });
            return;
        }
