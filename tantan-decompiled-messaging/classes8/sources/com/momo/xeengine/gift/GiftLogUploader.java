...
class GiftLogUploader {
    ...
    public static /* synthetic */ void m514a(GiftLogUploader giftLogUploader, List list) {
    ...
    public static /* synthetic */ void m515b(GiftLogUploader giftLogUploader) {
    ...
    private JSONObject buildRequestBody(List<GiftLogEvent> list) throws JSONException {
        ...
        jSONObject.put("packageName", XEDevice.getPackageName());
        jSONObject.put("platform", "android");
        jSONObject.put("osVersion", Build.VERSION.RELEASE);
        jSONObject.put("sdkVersion", XEnginePreferences.VERSION);
        jSONObject.put("deviceId", deviceID);
        jSONObject.put("appVersion", XEDevice.getAppVersionName(XEnginePreferences.getContext()));
    ...
    public void addEvent(GiftLogEvent giftLogEvent) {
        ...
        try {
            if (!TextUtils.isEmpty(XEnginePreferences.getAppId()) && !TextUtils.isEmpty(XEnginePreferences.getAppKey())) {
                if (GiftLogEvent.EVENT_ID_CHANGE_SOFTWARE.equals(giftLogEvent.getEventId())) {
                    synchronized (this.lock) {
                        this.eventQueue.add(giftLogEvent);
                    }
                    return;
                }
                if (this.forceUpload || GiftLogEvent.EVENT_ID_PLAY_FAILED.equals(giftLogEvent.getEventId())) {
                    synchronized (this.lock) {
                        this.eventQueue.add(giftLogEvent);
                    }
                    uploadAllEvents();
                        ...
                        if (this.eventQueue.isEmpty() && !this.hasTimer) {
                            ...
                            this.mainHandler.postDelayed(new Runnable() { // from class: com.momo.xeengine.gift.a
                                ...
                                public final void run() {
                                    GiftLogUploader.m515b(this.f288a);
                                }
        ...
        synchronized (this.lock) {
            try {
                ...
                this.executorService.execute(new Runnable() { // from class: com.momo.xeengine.gift.b
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftLogUploader.m514a(this.f289a, arrayList);
                    }
                });
            } catch (Throwable th) {
                throw th;
