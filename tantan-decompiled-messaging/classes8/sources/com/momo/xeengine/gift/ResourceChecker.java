...
public final class ResourceChecker {
    ...
    public static /* synthetic */ void m531a(ResourceDownloadCompletion resourceDownloadCompletion, boolean z) {
    ...
    public static /* synthetic */ void m532b(String str, ResourceDownloadCompletion resourceDownloadCompletion, boolean z, String str2) {
        boolean z2;
    ...
    public static /* synthetic */ void m533c(ResourceChecker resourceChecker, List list, String str, int[] iArr, int i, final ResourceDownloadCompletion resourceDownloadCompletion, boolean z) {
                ...
                if (i2 == i) {
                    ...
                    resourceChecker.mainHandler.post(new Runnable() { // from class: com.momo.xeengine.gift.q
                        ...
                        public final void run() {
                            ResourceChecker.m531a(resourceDownloadCompletion, zIsEmpty);
                        }
                    });
                }
            } catch (Throwable th2) {
        ...
        if (downloader == null) {
            ...
            downloader.downloadResourceWithURL(str, new IResourceDownloader.Callback() { // from class: com.momo.xeengine.gift.p
                ...
                public final void onComplete(boolean z, String str2) {
                    ResourceChecker.m532b(str, resourceDownloadCompletion, z, str2);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m535e(final ResourceChecker resourceChecker, final String str, final List list, final int[] iArr, final int i, final ResourceDownloadCompletion resourceDownloadCompletion) {
        resourceChecker.getClass();
        resourceChecker.downloadResourceAtURL(str, new ResourceDownloadCompletion() { // from class: com.momo.xeengine.gift.t
            ...
            public final void onComplete(boolean z) {
                ResourceChecker.m533c(this.f332a, list, str, iArr, i, resourceDownloadCompletion, z);
            }
        });
    }
    ...
    public void downloadResources(List<String> list, final ResourceDownloadCompletion resourceDownloadCompletion) {
        ...
        for (final String str : list) {
            this.executorService.submit(new Runnable() { // from class: com.momo.xeengine.gift.s
                @Override // java.lang.Runnable
                public final void run() {
                    ResourceChecker.m535e(this.f326a, str, arrayList, iArr, size, resourceDownloadCompletion);
                }
            });
        }
    }
