...
class GiftLogEvent {
    ...
    public static class EventEx {
        ...
        public JSONObject toJsonObject() {
            ...
            try {
                if (!TextUtils.isEmpty(this.f287id)) {
                    jSONObject2.put("id", this.f287id);
                }
                ...
                if (TextUtils.isEmpty(this.result)) {
                    ...
                    try {
                        jSONObject2.put("result", new JSONObject(this.result));
    ...
    public static GiftLogEvent createEvent(GiftEntity giftEntity, String str, int i, String str2) {
        ...
        if (giftEntity != null) {
            eventEx = new EventEx();
            eventEx.f287id = giftEntity.getId();
    ...
    public static GiftLogEvent createPlayFailedEvent(GiftEntity giftEntity, int i, String str) {
        return new GiftLogEvent(EVENT_ID_PLAY_FAILED, i, str, createEventEx(giftEntity));
    }
    ...
    public static GiftLogEvent createPlaySuccessEvent(GiftEntity giftEntity, String str) {
        ...
        return new GiftLogEvent(EVENT_ID_PLAY_SUCCESS, 0, giftEntity.getId(), eventEx);
    }
