...
public final class GiftPlayer implements IGiftPlayer {
    ...
    private final GameDelegate gameDelegate = new C01021();
    private final XEGameViewCallback gameViewCallback = new C01032();
    ...
    public class C01021 implements GameDelegate {
        public C01021() {
        }

        /* JADX INFO: renamed from: a */
        public static /* synthetic */ void m520a(C01021 c01021, String str) {
            GiftPlayer.this.giftView.stop();
            GiftPlayer.this.callPlayFinished(str);
        }

        /* JADX INFO: renamed from: b */
        public static /* synthetic */ void m521b(C01021 c01021) {
        ...
        public static /* synthetic */ void m522c(C01021 c01021, String str, GiftPlayerEventListener giftPlayerEventListener) {
            c01021.getClass();
            giftPlayerEventListener.onReceiveEvent(GiftPlayer.this, new GiftPlayerEvent(GiftPlayerEvent.EventType.Goto, str));
        }

        /* JADX INFO: renamed from: d */
        public static /* synthetic */ void m523d(C01021 c01021, int i, String str) {
            c01021.getClass();
        ...
        public static /* synthetic */ void m524e(C01021 c01021, GiftProgress giftProgress) {
            if (GiftPlayer.this.progressListener == null || GiftPlayer.this.giftPlayData == null) {
                return;
            }
            VideoGiftProgressListener videoGiftProgressListener = GiftPlayer.this.progressListener;
        ...
        public static /* synthetic */ void m525f(C01021 c01021, String str) {
            String string;
            ...
            int i = XEGiftErrorCode.ERROR_CODE_UNKNOWN;
            try {
        ...
        public static /* synthetic */ void m526g(C01021 c01021, String str) {
            ...
            try {
                ...
                if (jSONArrayOptJSONArray != null) {
                    for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
                        ...
                        GiftPlayer.this.giftView.addValidTouchArea(new RectF((float) jSONObject.optDouble("left", 0.0d), (float) jSONObject.optDouble("top", 0.0d), (float) jSONObject.optDouble("right", 0.0d), (float) jSONObject.optDouble("bottom", 0.0d)));
                    }
                }
        ...
        public static /* synthetic */ void m527h(C01021 c01021, String str) {
            GiftPlayer.this.virtualGiftView.stop();
            GiftPlayer.this.callPlayFinished(str);
        }

        /* JADX INFO: renamed from: i */
        public static /* synthetic */ void m528i(C01021 c01021) {
            if (GiftPlayer.this.progressListener == null || GiftPlayer.this.giftPlayData == null) {
                return;
            }
            VideoGiftProgressListener videoGiftProgressListener = GiftPlayer.this.progressListener;
        ...
        public void onGameError(final String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.k
                ...
                public final void run() {
                    GiftPlayer.C01021.m525f(this.f312a, str);
                }
            });
        }
        ...
        public void onGameFinished(final String str) {
            ...
            if (z) {
                giftPlayer.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.g
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftPlayer.C01021.m527h(this.f306a, str);
                    }
                });
            } else {
                giftPlayer.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.h
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftPlayer.C01021.m520a(this.f308a, str);
                    }
                });
            }
        }
        ...
        public String onGotoEvent(final String str) {
            ...
            if (giftPlayerEventListener != null && !TextUtils.isEmpty(str)) {
                GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.m
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftPlayer.C01021.m522c(this.f316a, str, giftPlayerEventListener);
                    }
                });
            }
            return null;
        ...
        public void onReceivedEvent(String str) {
            ...
            try {
                ...
                if (iOptInt == GiftPlayerEvent.EventType.Downgrade.getValue()) {
                    GiftLogUploader.getInstance().addEvent(GiftLogEvent.createEvent(giftEntity, GiftLogEvent.EVENT_ID_CHANGE_SOFTWARE, 0, strOptString));
                }
                if (GiftPlayer.this.eventListener != null) {
                    GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.f
                        @Override // java.lang.Runnable
                        public final void run() {
                            GiftPlayer.C01021.m523d(this.f303a, iOptInt, strOptString);
                        }
                    });
                }
            } catch (JSONException unused) {
        ...
        public String onVideoProgress(String str) {
            ...
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.l
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C01021.m524e(this.f314a, giftProgressFromJson);
                }
            });
            return null;
        }
        ...
        public String onVideoStart(String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.j
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C01021.m528i(this.f311a);
                }
            });
            return null;
        }
        ...
        public String onVideoStop(String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.i
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C01021.m521b(this.f310a);
                }
            });
            return null;
        }
        ...
        public String setValidTouchAreas(final String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.e
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C01021.m526g(this.f301a, str);
                }
            });
            return null;
        }
    ...
    public class C01032 implements XEGameViewCallback {
        public C01032() {
        }
    ...
    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m516a(GiftPlayer giftPlayer, Set set, Map map, boolean z, GiftPlayData giftPlayData, boolean z2) {
    ...
    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m517b(GiftPlayer giftPlayer, GiftPlayerListener giftPlayerListener, GiftPlayData giftPlayData, int i, String str) {
        giftPlayer.getClass();
        giftPlayerListener.onGiftPlayFailed(giftPlayer, giftPlayData.getGiftEntity(), i, str);
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m518c(String str, JSONObject jSONObject, String str2, ScriptBridge scriptBridge, boolean z) {
        if (z) {
            try {
    ...
    public void callDelegatePlayFailed(final int i, final String str) {
        ...
        if (i != 110) {
            ...
            GiftLogUploader.getInstance().addEvent(GiftLogEvent.createEvent(giftPlayData.getGiftEntity(), GiftLogEvent.EVENT_ID_ENGINE_START_TIMEOUT, 0, "timeout"));
        }
        ...
        if (giftPlayerListener != null) {
            this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.c
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.m517b(this.f291a, giftPlayerListener, giftPlayData, i, str);
                }
            });
        }
    }
        ...
        if (!hashSet.isEmpty()) {
            this.resourceChecker.downloadResources(new ArrayList(hashSet), new ResourceChecker.ResourceDownloadCompletion() { // from class: com.momo.xeengine.gift.d
                ...
                public final void onComplete(boolean z2) {
                    GiftPlayer.m516a(this.f296a, hashSet, map, z, giftPlayData, z2);
                }
            });
        } else if (z) {
    ...
    private void playEngineGift() {
        ...
        Runnable runnable = new Runnable() { // from class: l.buj
            @Override // java.lang.Runnable
            public final void run() {
                this.f2348a.onEngineStartTimeout();
            }
        };
        ...
        if (new File(GiftUtils.getResourcePathWithURL(str2)).exists()) {
            ...
            this.resourceChecker.downloadResources(arrayList, new ResourceChecker.ResourceDownloadCompletion() { // from class: l.auj
                ...
                public final void onComplete(boolean z) {
                    GiftPlayer.m518c(str2, jSONObject, str, scriptBridge, z);
                }
            });
        }
    }
