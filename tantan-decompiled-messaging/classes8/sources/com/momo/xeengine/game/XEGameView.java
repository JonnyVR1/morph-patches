...
public class XEGameView extends FrameLayout {
    ...
    public class C00933 implements IXEngineSOLoader.LoaderCallback {
        public C00933() {
        }
    ...
    public final class MyRender implements IXRender {
        ...
        public static /* synthetic */ void m507a(MyRender myRender, String str) {
        ...
        public boolean onGLDrawFrame(EGL10 egl10) {
            ...
            if (zRender && XEGameView.this.preferredFramesPerSecond != XEGameView.FRAME_NO_LIMIT && gameEngine.getRenderMode() == GameEngine.RenderMode.Auto) {
                ...
                long j = LongLinkMessage.MsgTypeEnum.MSG_TYPE_COMMON_VALUE / XEGameView.this.preferredFramesPerSecond;
        ...
        public void onGLEnvCreatedFailed(final String str) {
            XEGameView.this.mHandler.post(new Runnable() { // from class: com.momo.xeengine.game.c
                @Override // java.lang.Runnable
                public final void run() {
                    XEGameView.MyRender.m507a(this.f276a, str);
                }
            });
        }
            ...
            if (gameEngine.getRenderMode() == GameEngine.RenderMode.UserRequest) {
                ...
                XEGameView.this.post(new Runnable() { // from class: com.momo.xeengine.game.b
                    ...
                    public final void run() {
                        ...
                        gameEngine2.getRenderThreadExecutor().execute(new Runnable() { // from class: l.icq0
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public XEGameView(Context context) {
        ...
        this.mLoaderCallback = new C00933();
        this.viewSafeArea = null;
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m504a(XEGameView xEGameView) {
        GameEngine gameEngine;
    ...
    public static /* synthetic */ void m505b(XEGameView xEGameView) {
        GameEngine gameEngine;
        MyRender myRender = xEGameView.mRender;
        if (myRender == null || (gameEngine = myRender.engine) == null) {
            return;
    ...
    private void getNotchParams() {
        ...
        int i;
        int i2;
        if (Build.VERSION.SDK_INT < 28 || (rootWindowInsets = getRootWindowInsets()) == null || (displayCutoutA = h7q0.a(rootWindowInsets)) == null || (listA = hvy0.a(displayCutoutA)) == null || listA.isEmpty()) {
            return;
        }
        ...
        float safeInsetLeft = displayCutoutA.getSafeInsetLeft() <= i3 ? 0.0f : displayCutoutA.getSafeInsetLeft() - i3;
        float safeInsetTop = displayCutoutA.getSafeInsetTop() > i4 ? displayCutoutA.getSafeInsetTop() - i4 : 0.0f;
        SafeArea safeArea = new SafeArea(safeInsetLeft / getWidth(), safeInsetTop / getHeight(), ((width <= i - displayCutoutA.getSafeInsetRight() ? getWidth() : getWidth() - (width - (i - displayCutoutA.getSafeInsetRight()))) - safeInsetLeft) / getWidth(), ((height <= i2 - n7y0.a(displayCutoutA) ? getHeight() : getHeight() - (height - (i2 - n7y0.a(displayCutoutA)))) - safeInsetTop) / getHeight());
        synchronized (this) {
    ...
    public void pause() {
        ...
        XEngineRenderThread xEngineRenderThread = this.mGLThread;
        if (xEngineRenderThread != null) {
            xEngineRenderThread.queueEvent(new Runnable() { // from class: l.hcq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEGameView.m505b(this.f2812a);
                }
            });
        }
    }
    ...
    public void resume() {
        ...
        XEngineRenderThread xEngineRenderThread = this.mGLThread;
        if (xEngineRenderThread != null) {
            xEngineRenderThread.queueEvent(new Runnable() { // from class: l.gcq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEGameView.m504a(this.f2757a);
                }
            });
        }
    }
    ...
    public void setRenderViewType(int i) {
        if (i != TYPE_SURFACE_VIEW && i != TYPE_TEXTURE_VIEW) {
            ig3.a("RenderViewType only support TYPE_SURFACE_VIEW or TYPE_TEXTURE_VIEW");
        } else if (this.glSurfaceView == null && this.glTextureView == null) {
            this.renderViewType = i;
        } else {
            ig3.a("RenderViewType can set before start only");
        }
    }
