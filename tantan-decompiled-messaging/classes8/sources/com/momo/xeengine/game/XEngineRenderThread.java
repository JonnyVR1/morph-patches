...
final class XEngineRenderThread extends Thread {
    ...
    public static /* synthetic */ void m511a(XEngineRenderThread xEngineRenderThread, int i, int i2) {
    ...
    public static /* synthetic */ void m512b(XEngineRenderThread xEngineRenderThread, Object obj, AtomicBoolean atomicBoolean) {
    ...
    public static /* synthetic */ void m513c(XEngineRenderThread xEngineRenderThread, AtomicBoolean atomicBoolean) {
    ...
    public void destroyNativeWindow() {
        ...
        this.mEventQueue.add(new Runnable() { // from class: com.momo.xeengine.game.f
            ...
            public final void run() {
                XEngineRenderThread.m513c(this.f284a, atomicBoolean);
            }
        });
    }
    ...
    public void onSizeChanged(final int i, final int i2) {
        this.mEventQueue.add(new Runnable() { // from class: com.momo.xeengine.game.e
            @Override // java.lang.Runnable
            public final void run() {
                XEngineRenderThread.m511a(this.f281a, i, i2);
            }
        });
    }
    ...
    public void resetNativeWindow(final Object obj) {
        ...
        this.mEventQueue.add(new Runnable() { // from class: com.momo.xeengine.game.d
            @Override // java.lang.Runnable
            public final void run() {
                XEngineRenderThread.m512b(this.f278a, obj, atomicBoolean);
            }
        });
    }
