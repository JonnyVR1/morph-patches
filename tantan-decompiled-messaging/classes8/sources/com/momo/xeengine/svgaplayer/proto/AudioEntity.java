...
public final class AudioEntity extends Message<AudioEntity, Builder> {
    ...
    public static final class Builder extends Message.Builder<AudioEntity, Builder> {
        ...
        public AudioEntity m12130build() {
    ...
    public static final class ProtoAdapter_AudioEntity extends ProtoAdapter<AudioEntity> {
        ...
        public AudioEntity m12131decode(ProtoReader protoReader) throws IOException {
        ...
        public AudioEntity redact(AudioEntity audioEntity) {
            Builder builderM12129newBuilder = audioEntity.m12129newBuilder();
            builderM12129newBuilder.clearUnknownFields();
            return builderM12129newBuilder.m12130build();
        }
    }
    ...
    public Builder m12129newBuilder() {
        Builder builder = new Builder();
