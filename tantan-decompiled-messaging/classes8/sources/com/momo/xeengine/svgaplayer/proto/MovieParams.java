...
public final class MovieParams extends Message<MovieParams, Builder> {
    ...
    public static final class Builder extends Message.Builder<MovieParams, Builder> {
        ...
        public MovieParams m12142build() {
    ...
    public static final class ProtoAdapter_MovieParams extends ProtoAdapter<MovieParams> {
        ...
        public MovieParams m12143decode(ProtoReader protoReader) throws IOException {
        ...
        public MovieParams redact(MovieParams movieParams) {
            Builder builderM12141newBuilder = movieParams.m12141newBuilder();
            builderM12141newBuilder.clearUnknownFields();
            return builderM12141newBuilder.m12142build();
        }
    }
    ...
    public Builder m12141newBuilder() {
        Builder builder = new Builder();
