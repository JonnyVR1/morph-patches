...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u0006J \u0010\u000b\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\u00032\u0006\u0010\u000e\u001a\u00020\u000fH\u0002R\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAPath;", "", "originValue", "", "(Ljava/lang/String;)V", "cachedPath", "Landroid/graphics/Path;", "replacedValue", "buildPath", "", "toPath", "operate", "finalPath", "method", "args", "Ljava/util/StringTokenizer;", "gift_player_release"}, k = 1, mv = {1, 1, 15})
public final class SVGAPath {
    ...
    public SVGAPath(@NotNull String str) {
        str.getClass();
        if (StringsKt.P(str, ",", false, 2, (Object) null)) {
            str = d.F(str, ",", " ", false, 4, (Object) null);
        }
    ...
    private final void operate(Path finalPath, String method, StringTokenizer args) {
        ...
        if (!Intrinsics.d(method, "M")) {
            ...
            if (Intrinsics.d(method, "L")) {
                finalPath.lineTo(f8, f9);
            } else if (Intrinsics.d(method, "l")) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.length() != 0) {
                if (SVGAPathKt.VALID_METHODS.contains(strNextToken)) {
                    if (Intrinsics.d(strNextToken, "Z") || Intrinsics.d(strNextToken, "z")) {
                        operate(path2, strNextToken, new StringTokenizer("", ""));
                    }
                    str = strNextToken;
                } else {
                    operate(path2, str, new StringTokenizer(strNextToken, " "));
                }
            }
        }
