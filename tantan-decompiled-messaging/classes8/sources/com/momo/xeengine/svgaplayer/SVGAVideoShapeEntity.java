...
public final class SVGAVideoShapeEntity {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Type;", "", "(Ljava/lang/String;I)V", "shape", "rect", "ellipse", "keep", "gift_player_release"}, k = 1, mv = {1, 1, 15})
    public enum Type {
        shape,
        rect,
        ellipse,
    ...
    private final void parseArgs(ShapeEntity obj) {
        ...
        if (shapeArgs != null && (str = shapeArgs.f423d) != null) {
            map.put("d", str);
        }
        ...
        if (rectArgs != null) {
            Float f5 = rectArgs.f419x;
            if (f5 == null) {
                f5 = fValueOf;
            }
            map.put("x", f5);
            Float f6 = rectArgs.f420y;
            if (f6 == null) {
                f6 = fValueOf;
            }
            map.put("y", f6);
        ...
        if (shapeStyle != null) {
            ...
            if (lineCap != null) {
                ...
                if (i == 1) {
                    ...
                    styles.setLineCap$gift_player_release("square");
                }
            }
