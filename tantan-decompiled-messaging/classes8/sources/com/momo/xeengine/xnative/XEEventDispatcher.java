...
import com.momo.xeengine.p001cv.bean.XEFaceLiquefy;
import com.momo.xeengine.p001cv.bean.XEFaceMask;
import com.momo.xeengine.p001cv.bean.XEFaceSegmentInfo;
import com.momo.xeengine.p001cv.bean.XEHandInfo;
import com.momo.xeengine.p001cv.bean.XEMutableData;
...
public final class XEEventDispatcher extends XETouchDispatcher implements IXEventDispatcher {
    ...
    public static /* synthetic */ void m607g(XEEventDispatcher xEEventDispatcher, List list) {
    ...
    public static /* synthetic */ void m608h(XEEventDispatcher xEEventDispatcher) {
    ...
    public static /* synthetic */ void m612l(XEEventDispatcher xEEventDispatcher, List list) {
    ...
    public static /* synthetic */ void m615o(XEEventDispatcher xEEventDispatcher) {
        nativeClearMutableData(xEEventDispatcher.pointer);
        nativeUpdateMutableDatas(xEEventDispatcher.pointer);
    }
    ...
    public void dispatchBodyInfo(List<CVBodyInfo> list, boolean z) {
        ...
        if (isRunning()) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (cVBodyInfo != null && !cVBodyInfo.joints.isEmpty()) {
                        ...
                        for (int i2 = 0; i2 < size2; i2++) {
                            ...
                            if (joint != null) {
                                fArr3[i2] = joint.f267x;
                                fArr4[i2] = joint.f268y;
            ...
            this.executor.execute(new Runnable() { // from class: l.rbq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.nativeSetBodys(this.f4061a.pointer, jArr);
                }
            });
        }
    }
    ...
    public void dispatchCartoonFaceInfo(final XECartoonFaceInfo xECartoonFaceInfo) {
        ...
        if (xECartoonFaceInfo != null) {
            executor.execute(new Runnable() { // from class: l.ybq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher xEEventDispatcher = this.f5398a;
            ...
            executor.execute(new Runnable() { // from class: l.zbq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.nativeSetCartoonFaceData(this.f5502a.pointer, null, 0, null, 0, 0, false);
                }
            });
        }
    }
    ...
    public void dispatchFaceInfo(List<XEFaceInfo> list) {
        ...
        if (isRunning()) {
            ...
            if (list2 == null || list2.isEmpty()) {
                ...
                this.executor.execute(new Runnable() { // from class: l.xbq0
                    @Override // java.lang.Runnable
                    public final void run() {
                        XEEventDispatcher.nativeOnFaceEntityDetected(this.f5090a.pointer, null);
                    }
                });
                return;
            }
            ...
            this.executor.execute(new Runnable() { // from class: l.wbq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.nativeOnFaceEntityDetected(this.f5027a.pointer, jArr);
                }
            });
        }
    }
    ...
    public void dispatchHandInfo(final List<XEHandInfo> list) {
        if (isRunning()) {
            if (list == null || (list.isEmpty() && !this.isHandSetNullInfo)) {
                this.executor.execute(new Runnable() { // from class: l.sbq0
                    @Override // java.lang.Runnable
                    public final void run() {
                        XEEventDispatcher.m608h(this.f4129a);
                    }
                });
            } else {
                this.executor.execute(new Runnable() { // from class: l.tbq0
                    @Override // java.lang.Runnable
                    public final void run() {
                        XEEventDispatcher.m612l(this.f4250a, list);
                    }
                });
            }
        }
    ...
    public void dispatchMutableInfo(final List<XEMutableInfo> list) {
        if (list == null || list.size() <= 0) {
            this.executor.execute(new Runnable() { // from class: l.vbq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.m615o(this.f4963a);
                }
            });
        } else {
            this.executor.execute(new Runnable() { // from class: l.ubq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.m607g(this.f4873a, list);
                }
            });
        }
    }
    ...
    public void dispatchObjectInfo(List<CVObjectInfo> list) {
        ...
        if (isRunning()) {
            ...
            this.executor.execute(new Runnable() { // from class: l.acq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.nativeSetObjects(this.f1844a.pointer, jArr);
                }
            });
        }
    }
    ...
    public void dispatchSegmentInfo(final CVSegmentInfo cVSegmentInfo) {
        ...
        if (cVSegmentInfo != null) {
            executor.execute(new Runnable() { // from class: l.bcq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher xEEventDispatcher = this.f2303a;
            ...
            executor.execute(new Runnable() { // from class: l.ccq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEEventDispatcher.nativeSetSegment(this.f2461a.pointer, null, 0, null, 0, 0, false);
                }
            });
        }
    }
