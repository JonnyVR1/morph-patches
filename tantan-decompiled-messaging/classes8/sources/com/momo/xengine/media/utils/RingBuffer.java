...
public class RingBuffer {
    ...
    public int read(byte[] bArr, int i, int i2, boolean z) {
        if (bArr != null && bArr.length != 0 && i2 != 0) {
            ...
            dqi0.a("params error , offset = %s,length = %s,buff.length = %s", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(bArr.length)});
        }
        return 0;
    }
    ...
    public int write(byte[] bArr, int i, int i2) {
        if (bArr != null && bArr.length != 0 && i2 != 0) {
            ...
            dqi0.a("params error , offset = %s,length = %s,data.length = %s", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(bArr.length)});
        }
        return 0;
    }
