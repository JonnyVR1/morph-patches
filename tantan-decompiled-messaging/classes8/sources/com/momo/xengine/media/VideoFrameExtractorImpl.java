...
class VideoFrameExtractorImpl implements IVideoFrameExtractor {
    ...
    public static /* synthetic */ void m622a(VideoFrameExtractorImpl videoFrameExtractorImpl, List list, IVideoFrameExtractor.ExtractorFramesCallback extractorFramesCallback) {
    ...
    public static /* synthetic */ void m623b(VideoFrameExtractorImpl videoFrameExtractorImpl, Size size) {
    ...
    public static /* synthetic */ void m624c(VideoFrameExtractorImpl videoFrameExtractorImpl, IVideoFrameExtractor.ExtractorFrameCallback extractorFrameCallback, long j) {
    ...
    public static /* synthetic */ void m625d(VideoFrameExtractorImpl videoFrameExtractorImpl) {
    ...
    public void extractorFrames(@NotNull final List<Long> list, @NotNull final IVideoFrameExtractor.ExtractorFramesCallback extractorFramesCallback) {
        this.singleThreadExecutor.execute(new Runnable() { // from class: com.momo.xengine.media.a
            ...
            public final void run() {
                VideoFrameExtractorImpl.m622a(this.f447a, list, extractorFramesCallback);
            }
        });
    }
    ...
    public void getFrameRGBDataAt(final long j, @NotNull final IVideoFrameExtractor.ExtractorFrameCallback extractorFrameCallback) {
        this.singleThreadExecutor.execute(new Runnable() { // from class: com.momo.xengine.media.c
            @Override // java.lang.Runnable
            public final void run() {
                VideoFrameExtractorImpl.m624c(this.f452a, extractorFrameCallback, j);
            }
        });
    }
    ...
    public void release() {
        this.singleThreadExecutor.execute(new Runnable() { // from class: com.momo.xengine.media.d
            @Override // java.lang.Runnable
            public final void run() {
                VideoFrameExtractorImpl.m625d(this.f455a);
            }
        });
    }
    ...
    public void setFrameSize(@NotNull final Size size) {
        this.singleThreadExecutor.execute(new Runnable() { // from class: com.momo.xengine.media.b
            @Override // java.lang.Runnable
            public final void run() {
                VideoFrameExtractorImpl.m623b(this.f450a, size);
            }
        });
    }
}
