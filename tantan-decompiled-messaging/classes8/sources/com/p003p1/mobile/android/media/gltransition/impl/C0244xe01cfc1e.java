...
@DebugMetadata(c = "com.p1.mobile.android.media.gltransition.impl.TransitionEngineImpl$applyUriData$1$invokeSuspend$$inlined$transform$1", f = "TransitionEngineImpl.kt", l = {40}, m = "invokeSuspend", v = 1)
@SourceDebugExtension
public final class C0244xe01cfc1e extends SuspendLambda implements Function2<fri<? super std0>, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1<T> implements fri {
        ...
        public final /* synthetic */ fri<std0> f1305a;

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ TransitionEngineImpl f1306b;
        ...
        @DebugMetadata(c = "com.p1.mobile.android.media.gltransition.impl.TransitionEngineImpl$applyUriData$1$invokeSuspend$$inlined$transform$1$1", f = "TransitionEngineImpl.kt", l = {223}, m = "emit", v = 1)
        @SourceDebugExtension
        public static final class C08221 extends ContinuationImpl {
            int I$0;
            Object L$0;
            Object L$1;
            Object L$2;
        ...
        public AnonymousClass1(fri friVar, TransitionEngineImpl transitionEngineImpl) {
            this.f1306b = transitionEngineImpl;
            this.f1305a = friVar;
        }
        ...
        @Nullable
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) throws NoSuchAlgorithmException, FileNotFoundException {
            C08221 c08221;
            ...
            if (i2 == 0) {
                ResultKt.b(obj);
                fri<std0> friVar = this.f1305a;
                Uri uri = (Uri) t;
                std0 std0VarCreateScene = this.f1306b.createScene(uri);
                c08221.L$0 = SpillingKt.a(t);
                c08221.L$1 = SpillingKt.a(c08221);
                c08221.L$2 = SpillingKt.a(uri);
                c08221.L$3 = SpillingKt.a(friVar);
                c08221.I$0 = 0;
                c08221.label = 1;
                if (friVar.emit(std0VarCreateScene, c08221) == objE) {
                    return objE;
                }
            } else {
                if (i2 != 1) {
    ...
    public C0244xe01cfc1e(eri eriVar, Continuation continuation, TransitionEngineImpl transitionEngineImpl) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        C0244xe01cfc1e c0244xe01cfc1e = new C0244xe01cfc1e(this.$this_transform, continuation, this.this$0);
        c0244xe01cfc1e.L$0 = obj;
        return c0244xe01cfc1e;
    }
