...
public class AudioPlayer extends BroadcastReceiver implements SensorEventListener, Runnable {
    ...
    public AudioPlayer(Context context) {
        ...
        a<State> aVarB = a.b();
        this.state = aVarB;
        aVarB.onNext(State.stopped);
        this.farValue = STANDARD_FAR_VALUE;
        this.speakerOn = 0;
        ...
        if (defaultSensor != null) {
            ...
            if (txd.m11180c() && this.farValue > STANDARD_FAR_VALUE) {
                this.farValue = STANDARD_FAR_VALUE;
            }
        }
    ...
    private boolean isStarted() {
        State state = (State) this.state.e();
        return state == State.preparing || state == State.playing;
    }
    ...
    public /* synthetic */ boolean lambda$playAndSeekTo$2(String str, MediaPlayer mediaPlayer, int i, int i2) {
        CrashHelper.c(new NullPointerException("audio except what = " + i + " extra = " + i2 + " uri = " + str));
        if (NullChecker.a(this.errCallBack)) {
    ...
    private void onFinished() {
        ...
        aVar.onNext(state);
        C0235a.m1002a().m1005d(state, this.currentUri);
    }
