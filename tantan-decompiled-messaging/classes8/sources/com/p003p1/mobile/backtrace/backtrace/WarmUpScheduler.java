...
public class WarmUpScheduler implements Handler.Callback {
    ...
    public static /* synthetic */ class C02942 {
        ...
        static {
            ...
            try {
                f1619xbb790616[TaskType.CleanUp.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1619xbb790616[TaskType.RequestConsuming.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1619xbb790616[TaskType.DiskUsage.ordinal()] = 4;
            ...
            try {
                f1620x466a044[WeChatBacktrace.WarmUpTiming.WhileCharging.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1620x466a044[WeChatBacktrace.WarmUpTiming.WhileScreenOff.ordinal()] = 3;
    ...
    public static final class IdleReceiver extends BroadcastReceiver {
        ...
        private synchronized void triggerIdle(boolean z, boolean z2) {
            try {
                MatrixLog.m1458i(WarmUpScheduler.TAG, "Idle status changed: interactive = %s, charging = %s", Boolean.valueOf(z), Boolean.valueOf(z2));
                ...
                if (z3 && this.mCancellationSignal == null) {
                    ...
                    while (it.hasNext()) {
                        int i = C02942.f1619xbb790616[it.next().ordinal()];
                        if (i != 1) {
                            if (i == 2) {
                                ...
                                MatrixLog.m1458i(WarmUpScheduler.TAG, "System idle, trigger clean up in %s seconds.", 3L);
                            } else if (i == 3) {
                                ...
                                MatrixLog.m1458i(WarmUpScheduler.TAG, "System idle, trigger consume requested qut in %s seconds.", Long.valueOf(this.mWarmUpDelay / 1000));
                            } else if (i == 4) {
                                ...
                                MatrixLog.m1458i(WarmUpScheduler.TAG, "System idle, trigger disk usage in %s seconds.", 3L);
                            }
                            ...
                            MatrixLog.m1458i(WarmUpScheduler.TAG, "System idle, trigger warm up in %s seconds.", Long.valueOf(this.mWarmUpDelay / 1000));
                        }
                    }
                    ...
                    MatrixLog.m1458i(WarmUpScheduler.TAG, "Exit idle state, task cancelled.", new Object[0]);
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        public synchronized void refreshIdleStatus(Context context) {
            ...
            try {
                ...
                boolean z = false;
                if (intentL != null && ((intExtra = intentL.getIntExtra("status", -1)) == 2 || intExtra == 5)) {
                    z = true;
                }
    ...
    private void arrangeTaskDirectly(TaskType taskType) {
        int i = C02942.f1619xbb790616[taskType.ordinal()];
        if (i == 1) {
            MatrixLog.m1458i(TAG, "Schedule warm-up in %ss", Long.valueOf(this.mWarmUpDelay / 1000));
            Handler handler = this.mHandler;
            handler.sendMessageDelayed(Message.obtain(handler, 1, new CancellationSignal()), this.mWarmUpDelay);
        } else if (i == 2) {
            MatrixLog.m1458i(TAG, "Schedule clean-up in %ss", Long.valueOf(this.mWarmUpDelay / 1000));
            ...
            MatrixLog.m1458i(TAG, "Schedule request consuming in %ss", Long.valueOf(this.mWarmUpDelay / 1000));
    ...
    private synchronized void arrangeTaskToIdleReceiver(Context context, TaskType taskType) {
        ...
        MatrixLog.m1458i(TAG, "Register idle receiver.", new Object[0]);
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("android.intent.action.SCREEN_ON");
        intentFilter.addAction("android.intent.action.SCREEN_OFF");
        intentFilter.addAction("android.intent.action.ACTION_POWER_CONNECTED");
        intentFilter.addAction("android.intent.action.ACTION_POWER_DISCONNECTED");
        ii5.l(context, this.mIdleReceiver, intentFilter);
    ...
    private synchronized void finishTaskToIdleReceiver(Context context, TaskType taskType) {
        ...
        if (idleReceiver != null && idleReceiver.finish(taskType) == 0) {
            MatrixLog.m1458i(TAG, "Unregister idle receiver.", new Object[0]);
    ...
    public void scheduleTaskImpl(TaskType taskType) {
        int i = C02942.f1620x466a044[this.mTiming.ordinal()];
        if (i == 1) {
