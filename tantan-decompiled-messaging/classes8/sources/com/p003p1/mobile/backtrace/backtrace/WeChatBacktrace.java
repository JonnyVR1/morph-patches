...
public class WeChatBacktrace {
    ...
    public static /* synthetic */ class C02992 {
        ...
        static {
            ...
            try {
                f1622xf4ed677d[Mode.Quicken.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1622xf4ed677d[Mode.Dwarf.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1622xf4ed677d[Mode.FpUntilQuickenWarmedUp.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1622xf4ed677d[Mode.DwarfUntilQuickenWarmedUp.ordinal()] = 5;
    ...
    public enum Mode {
        ...
        public String toString() {
            int i = C02992.f1622xf4ed677d[ordinal()];
            if (i == 1) {
    ...
    public void configure(Configuration configuration) throws Throwable {
        if (runningInIsolateProcess(configuration)) {
            MatrixLog.m1458i(TAG, "Isolate process does not need any configuration.", new Object[0]);
            return;
        }
        ...
        MatrixLog.m1458i(TAG, configuration.toString(), new Object[0]);
        ...
        if (mode3 == mode4 || mode3 == Mode.FpUntilQuickenWarmedUp || mode3 == Mode.DwarfUntilQuickenWarmedUp || configuration.mQuickenAlwaysOn) {
            ...
            MatrixLog.m1458i(TAG, "Set saving path: %s", strValidateSavingPath);
            ...
            MatrixLog.m1458i(TAG, "Has warmed up: %s", Boolean.valueOf(zHasWarmedUp));
        ...
        if (configuration.mIsWarmUpProcess) {
            ...
            if (configuration.mCoolDownIfApkUpdated && fileWarmUpMarkedFile.exists()) {
                ...
                if (fileContent == null) {
                    ...
                    MatrixLog.m1458i(TAG, "Apk updated, remove warmed-up file.", new Object[0]);
                    configuration.mCoolDown = true;
                }
            }
    ...
    public static void loadLibrary(LibraryLoader libraryLoader) {
        ...
        if (libraryLoader == null) {
            ...
            MatrixLog.m1458i(TAG, "Using custom library loader: %s.", libraryLoader);
