...
import com.p003p1.mobile.backtrace.xlog.XLogNative;
...
public class WarmUpService extends Service {
    ...
    public static final class RecyclerCallback implements Handler.Callback {
        ...
        public boolean handleMessage(Message message) {
            if (message.what == 1) {
                MatrixLog.m1458i(WarmUpService.TAG, "Suicide.", new Object[0]);
    ...
    public static final class RemoteInvokerImpl implements RemoteInvoker, RemoteConnection {
        ...
        ServiceConnection mConnection = new ServiceConnection() { // from class: com.p1.mobile.backtrace.backtrace.WarmUpService.RemoteInvokerImpl.1
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ...
                MatrixLog.m1458i(RemoteInvokerImpl.TAG, "This remote invoker(%s) connected.", this);
            }
            ...
            public void onServiceDisconnected(ComponentName componentName) {
                ...
                MatrixLog.m1458i(RemoteInvokerImpl.TAG, "This remote invoker(%s) disconnected.", this);
        ...
        private void checkThread() {
            ...
            upk0.a("Should not call this from main thread!");
        }
        ...
        public boolean connect(Context context, Bundle bundle) {
            ...
            MatrixLog.m1458i(TAG, "Start connecting to remote. (%s)", Integer.valueOf(hashCode()));
            ...
            try {
                synchronized (this.mBound) {
                    try {
                        ...
                        if (!zArr[0]) {
                            zArr.wait(WarmUpService.INTERVAL_OF_CHECK);
                        }
                    } catch (Throwable th2) {
                        throw th2;
                    }
        ...
        public void disconnect(Context context) {
            ...
            MatrixLog.m1458i(TAG, "Start disconnecting to remote. (%s)", Integer.valueOf(hashCode()));
            synchronized (this.mHandlerThread) {
                try {
                    HandlerThread handlerThread = this.mHandlerThread[0];
                    if (handlerThread != null) {
    ...
    public synchronized Bundle call(int i, Bundle bundle) {
        ...
        try {
            ...
            if (bundle == null) {
                MatrixLog.m1458i(TAG, "Args is null.", new Object[0]);
                scheduleSuicide(false);
                return bundle2;
            }
            String string = bundle.getString(ARGS_WARM_UP_SAVING_PATH, null);
            MatrixLog.m1458i(TAG, "Invoke from client with savingPath: %s.", string);
            if (isNullOrNil(string)) {
                MatrixLog.m1458i(TAG, "Saving path is empty.", new Object[0]);
                scheduleSuicide(false);
                return bundle2;
            }
            ...
            if (i == 100) {
                ...
                if (isNullOrNil(string2)) {
                    MatrixLog.m1458i(TAG, "Warm-up so path is empty.", new Object[0]);
                    scheduleSuicide(false);
                    return bundle2;
                }
                int i3 = bundle.getInt(ARGS_WARM_UP_ELF_START_OFFSET, 0);
                MatrixLog.m1458i(TAG, "Warm up so path %s offset %s.", string2, Integer.valueOf(i3));
                if (WarmUpUtility.UnfinishedManagement.checkAndMark(this, string2, i3)) {
                    ...
                    if (!WeChatBacktraceNative.testLoadQut(string2, i3)) {
                        MatrixLog.m1460w(TAG, "Warm up elf %s:%s success, but test load qut failed!", string2, Integer.valueOf(i3));
                ...
                MatrixLog.m1460w(TAG, "Unknown cmd: %s", Integer.valueOf(i));
            }
            scheduleSuicide(false);
            return bundle2;
        } catch (Throwable th) {
    ...
    private static synchronized void loadLibrary(Intent intent) {
        ...
        MatrixLog.m1458i(TAG, "Init called.", new Object[0]);
        ...
        MatrixLog.m1458i(TAG, "Enable logger: %s", Boolean.valueOf(booleanExtra));
        MatrixLog.m1458i(TAG, "Path of XLog: %s", stringExtra);
    ...
    private void removeScheduledSuicide() {
        MatrixLog.m1458i(TAG, "Remove scheduled suicide", new Object[0]);
        synchronized (sRecyclerLock) {
    ...
    private static void scheduleSuicide(boolean z) {
        MatrixLog.m1458i(TAG, "Schedule suicide", new Object[0]);
        synchronized (sRecyclerLock) {
            try {
                if (z || sWorkingCall.decrementAndGet() == 0) {
                    sRecyclerHandler.sendEmptyMessageDelayed(1, INTERVAL_OF_CHECK);
                }
            } catch (Throwable th) {
                throw th;
            }
