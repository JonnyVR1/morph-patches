...
import com.p003p1.mobile.backtrace.MatrixLog;
import java.io.File;
...
class WarmUpDelegate {
    ...
    public static final class LocalWarmUpInvoker implements WarmUpInvoker {
        ...
        @Override // com.p003p1.mobile.backtrace.backtrace.WarmUpInvoker
    ...
    public static final class RemoteWarmUpInvoker implements WarmUpInvoker, WarmUpService.RemoteConnection {
        ...
        public boolean warmUp(String str, int i) {
            ...
            MatrixLog.m1458i(WarmUpDelegate.TAG, "Warm-up %s:%s - retCode %s", str, Integer.valueOf(i), Integer.valueOf(i2));
            return z;
        }
    }
                    ...
                    synchronized (this) {
                        try {
                            ...
                            if (thread == null || !thread.isAlive()) {
                                ...
                                this.mBlockedChecker.sendEmptyMessageDelayed(1, BLOCKED_CHECK_INTERVAL);
                            }
                        } catch (Throwable th) {
                            throw th;
                        }
            ...
            while (true) {
                if (runnable != null) {
                    try {
                        ...
                        MatrixLog.m1458i(WarmUpDelegate.TAG, "Before '%s' task execution..", strPoll);
                        runnable.run();
                        MatrixLog.m1458i(WarmUpDelegate.TAG, "After '%s' task execution..", strPoll);
    ...
    public static final class WarmedUpReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            MatrixLog.m1458i(WarmUpDelegate.TAG, "Warm-up received.", new Object[0]);
    ...
    public void broadcastWarmedUp(Context context) {
        ...
        MatrixLog.m1458i(TAG, "Broadcast warmed up message to other processes.", new Object[0]);
    ...
    public boolean warmUpBlocked(String str, int i) {
        ...
        boolean z = !zCheck;
        if (!zCheck) {
            MatrixLog.m1460w(TAG, "Elf file %s:%s has blocked and will not do warm-up.", str, Integer.valueOf(i));
        }
        return z;
    }
    ...
    public void cleaningUp(final CancellationSignal cancellationSignal) {
        this.mThreadTaskExecutor.arrangeTask(new Runnable() { // from class: com.p1.mobile.backtrace.backtrace.WarmUpDelegate.2
            ...
            public void run() {
                ...
                MatrixLog.m1458i(WarmUpDelegate.TAG, "Going to clean up saving path(%s)..", file.getAbsoluteFile());
                if (!file.isDirectory()) {
                ...
                try {
                        ...
                        public boolean accept(File file2) {
                            try {
                                ...
                                if (!name.contains("_malformed_") && !name.contains("_temp_")) {
                                    ...
                                    MatrixLog.m1458i(WarmUpDelegate.TAG, "File(%s) last access time %s", absolutePath, Long.valueOf(jMax));
                                    if (System.currentTimeMillis() - jMax > 5184000000L) {
                                        file2.delete();
                                        MatrixLog.m1458i(WarmUpDelegate.TAG, "Delete long time no access file(%s)", absolutePath);
                                        ...
                                        if (pair == null) {
                                            ...
                                            if (System.currentTimeMillis() - ((Long) pair.second).longValue() >= 259200000) {
                                                ...
                                                MatrixLog.m1458i(WarmUpDelegate.TAG, "Delete file(%s) cause %s is newer(%s vs %s).", ((File) pair.first).getName(), name, pair.second, Long.valueOf(jMax));
                                            }
                                            map.put(strSubstring, new Pair(file2, Long.valueOf(jMax)));
                                        } else if (System.currentTimeMillis() - jMax >= 259200000) {
                                            file2.delete();
                                            MatrixLog.m1458i(WarmUpDelegate.TAG, "Delete file(%s) cause %s is newer(%s vs %s).", name, ((File) pair.first).getName(), Long.valueOf(jMax), pair.second);
                                        }
                                    } else if (jMax - System.currentTimeMillis() >= 2592000000L) {
                                        file2.delete();
                                        MatrixLog.m1458i(WarmUpDelegate.TAG, "Delete future file(%s)", absolutePath);
                                    }
                                } else if (System.currentTimeMillis() - file2.lastModified() >= 259200000) {
                                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Delete malformed and temp file %s", absolutePath);
                                    file2.delete();
                                }
                            } catch (Throwable th) {
                    ...
                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Clean up saving path(%s) cancelled.", file.getAbsoluteFile());
                    return;
                } catch (Throwable th) {
                    MatrixLog.printErrStackTrace(WarmUpDelegate.TAG, th, "", new Object[0]);
                }
                ...
                WarmUpDelegate.this.mWarmUpScheduler.taskFinished(WarmUpScheduler.TaskType.CleanUp);
                MatrixLog.m1458i(WarmUpDelegate.TAG, "Clean up saving path(%s) done.", file.getAbsoluteFile());
                WarmUpReporter warmUpReporter = WarmUpDelegate.sReporter;
                if (warmUpReporter != null) {
        ...
        this.mThreadTaskExecutor.arrangeTask(new Runnable() { // from class: com.p1.mobile.backtrace.backtrace.WarmUpDelegate.4
            ...
            public void run() {
                ...
                try {
                    ...
                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Compute disk usage, file count(%s), disk usage(%s)", Long.valueOf(jArr[0]), Long.valueOf(jArr[1]));
                    WarmUpReporter warmUpReporter = WarmUpDelegate.sReporter;
                    if (warmUpReporter != null) {
    ...
    public void consumingRequestedQut(final CancellationSignal cancellationSignal) {
        this.mThreadTaskExecutor.arrangeTask(new Runnable() { // from class: com.p1.mobile.backtrace.backtrace.WarmUpDelegate.3
            ...
            public void run() {
                ...
                int iIntValue;
                boolean zWarmUp;
                MatrixLog.m1458i(WarmUpDelegate.TAG, "Going to consume requested QUT.", new Object[0]);
                ...
                if (warmUpInvokerAcquireWarmUpInvoker == null) {
                    ...
                    MatrixLog.m1460w(WarmUpDelegate.TAG, "Failed to acquire warm-up invoker.", new Object[0]);
                    return;
                }
                try {
                    for (String str : strArrConsumeRequestedQut) {
                        ...
                        MatrixLog.m1458i(WarmUpDelegate.TAG, "Consumed requested QUT -> %s, ret = %s.", str, Boolean.valueOf(zWarmUp));
                        CancellationSignal cancellationSignal2 = cancellationSignal;
                        if (cancellationSignal2 != null && cancellationSignal2.isCanceled()) {
                            MatrixLog.m1458i(WarmUpDelegate.TAG, "Consume requested QUT canceled.", new Object[0]);
                            break;
                        }
                    }
                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Consume requested QUT done.", new Object[0]);
                } finally {
    ...
    public synchronized void registerWarmedUpReceiver(WeChatBacktrace.Configuration configuration, WeChatBacktrace.Mode mode) {
        ...
        if (this.mWarmedUpReceiver == null) {
            ...
            MatrixLog.m1458i(TAG, "Register warm-up receiver.", new Object[0]);
    ...
    public void warmingUp(final CancellationSignal cancellationSignal) {
        this.mThreadTaskExecutor.arrangeTask(new Runnable() { // from class: com.p1.mobile.backtrace.backtrace.WarmUpDelegate.1
            @Override // java.lang.Runnable
            public void run() {
                MatrixLog.m1458i(WarmUpDelegate.TAG, "Going to warm up.", new Object[0]);
                ...
                try {
                    if (!new File(WarmUpUtility.validateSavingPath(WarmUpDelegate.this.mConfiguration)).isDirectory()) {
                        MatrixLog.m1460w(WarmUpDelegate.TAG, "Saving path is not a directory.", new Object[0]);
                    ...
                    while (it.hasNext()) {
                        WarmUpUtility.iterateTargetDirectory(new File(it.next()), cancellationSignal, new FileFilter() { // from class: com.p1.mobile.backtrace.backtrace.WarmUpDelegate.1.1
                            ...
                            public boolean accept(File file) {
                                ...
                                if (file.exists() && !WarmUpDelegate.this.warmUpBlocked(absolutePath, 0) && (absolutePath.endsWith(".so") || absolutePath.endsWith(".odex") || absolutePath.endsWith(".oat") || absolutePath.endsWith(".dex"))) {
                                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Warming up so %s", absolutePath);
                    ...
                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Warm-up done.", new Object[0]);
                } catch (OperationCanceledException unused) {
                    if (0 != 0) {
                        WarmUpDelegate.this.releaseWarmUpInvoker(null);
                    }
                    MatrixLog.m1458i(WarmUpDelegate.TAG, "Warm-up cancelled.", new Object[0]);
                } catch (Throwable th) {
                    try {
                        MatrixLog.printErrStackTrace(WarmUpDelegate.TAG, th, "", new Object[0]);
                        if (0 != 0) {
