package com.p003p1.mobile.longlink.msg.voicegift;
...
public final class VoiceNewCampaign {
    ...
    public static /* synthetic */ class C04661 {
        ...
        static final /* synthetic */ int[] f1699xa1df5c61;
        ...
        static {
            ...
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f1699xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface VoiceLiveCampaignInfoOrBuilder extends o6z {
        String getData();
    ...
    public interface VoiceLiveContentUpdateNoticeOrBuilder extends o6z {
    ...
    public static final class VoiceLiveCampaignInfo extends GeneratedMessageLite<VoiceLiveCampaignInfo, Builder> implements VoiceLiveCampaignInfoOrBuilder {
        ...
        private static volatile i860<VoiceLiveCampaignInfo> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.b<VoiceLiveCampaignInfo, Builder> implements VoiceLiveCampaignInfoOrBuilder {
            private Builder() {
            ...
            public Builder clearData() {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).clearData();
                return this;
            }

            public Builder clearId() {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).clearId();
                return this;
            }

            public Builder clearPosition() {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).clearPosition();
                return this;
            }

            public Builder clearSubscribeType() {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).clearSubscribeType();
                return this;
            }

            public Builder clearType() {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).clearType();
                return this;
            }

            public Builder clearUpdateType() {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).clearUpdateType();
                return this;
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public String getData() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getData();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public ByteString getDataBytes() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getDataBytes();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public String getId() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getId();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public ByteString getIdBytes() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getIdBytes();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public long getPosition() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getPosition();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public String getSubscribeType() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getSubscribeType();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public ByteString getSubscribeTypeBytes() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getSubscribeTypeBytes();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public VoiceLiveCampaignType getType() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getType();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public int getTypeValue() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getTypeValue();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public String getUpdateType() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getUpdateType();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignInfoOrBuilder
            public ByteString getUpdateTypeBytes() {
                return ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).getUpdateTypeBytes();
            }

            public Builder setData(String str) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setData(str);
                return this;
            }

            public Builder setDataBytes(ByteString byteString) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setDataBytes(byteString);
                return this;
            }

            public Builder setId(String str) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setId(str);
                return this;
            }

            public Builder setIdBytes(ByteString byteString) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setIdBytes(byteString);
                return this;
            }

            public Builder setPosition(long j) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setPosition(j);
                return this;
            }

            public Builder setSubscribeType(String str) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setSubscribeType(str);
                return this;
            }

            public Builder setSubscribeTypeBytes(ByteString byteString) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setSubscribeTypeBytes(byteString);
                return this;
            }

            public Builder setType(VoiceLiveCampaignType voiceLiveCampaignType) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setType(voiceLiveCampaignType);
                return this;
            }

            public Builder setTypeValue(int i) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setTypeValue(i);
                return this;
            }

            public Builder setUpdateType(String str) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setUpdateType(str);
                return this;
            }

            public Builder setUpdateTypeBytes(ByteString byteString) {
                copyOnWrite();
                ((VoiceLiveCampaignInfo) ((GeneratedMessageLite.b) this).instance).setUpdateTypeBytes(byteString);
                return this;
            }
        }
        ...
        public static Builder newBuilder(VoiceLiveCampaignInfo voiceLiveCampaignInfo) {
            return (Builder) ((Builder) DEFAULT_INSTANCE.toBuilder()).mergeFrom(voiceLiveCampaignInfo);
        }
        ...
        public static i860<VoiceLiveCampaignInfo> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C04661.f1699xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.id_ = hVar.f(!this.id_.isEmpty(), this.id_, !voiceLiveCampaignInfo.id_.isEmpty(), voiceLiveCampaignInfo.id_);
                    long j = this.position_;
                    boolean z3 = j != 0;
                    long j2 = voiceLiveCampaignInfo.position_;
                    this.position_ = hVar.i(z3, j, j2 != 0, j2);
                    this.subscribeType_ = hVar.f(!this.subscribeType_.isEmpty(), this.subscribeType_, !voiceLiveCampaignInfo.subscribeType_.isEmpty(), voiceLiveCampaignInfo.subscribeType_);
                    this.updateType_ = hVar.f(!this.updateType_.isEmpty(), this.updateType_, !voiceLiveCampaignInfo.updateType_.isEmpty(), voiceLiveCampaignInfo.updateType_);
                    this.data_ = hVar.f(!this.data_.isEmpty(), this.data_, !voiceLiveCampaignInfo.data_.isEmpty(), voiceLiveCampaignInfo.data_);
        ...
        public int getSerializedSize() {
            ...
            int iM = this.type_ != VoiceLiveCampaignType.List.getNumber() ? CodedOutputStream.m(1, this.type_) : 0;
            if (!this.id_.isEmpty()) {
        ...
        public static VoiceLiveCampaignInfo parseDelimitedFrom(InputStream inputStream, h hVar) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static VoiceLiveCampaignInfo parseFrom(ByteString byteString, h hVar) throws InvalidProtocolBufferException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, hVar);
        }
        ...
        public static VoiceLiveCampaignInfo parseFrom(byte[] bArr, h hVar) throws InvalidProtocolBufferException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, hVar);
        }
        ...
        public static VoiceLiveCampaignInfo parseFrom(InputStream inputStream, h hVar) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static VoiceLiveCampaignInfo parseFrom(e eVar) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar);
        }
        ...
        public static VoiceLiveCampaignInfo parseFrom(e eVar, h hVar) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar, hVar);
        }
    }

    public enum VoiceLiveCampaignType implements l.c {
        List(0),
        Entrance(1),
        UNRECOGNIZED(-1);
        ...
        private static final l.d<VoiceLiveCampaignType> internalValueMap = new l.d<VoiceLiveCampaignType>() { // from class: com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignType.1
        ...
        public static l.d<VoiceLiveCampaignType> internalGetValueMap() {
    ...
    public static final class VoiceLiveContentUpdateNotice extends GeneratedMessageLite<VoiceLiveContentUpdateNotice, Builder> implements VoiceLiveContentUpdateNoticeOrBuilder {
        ...
        private static volatile i860<VoiceLiveContentUpdateNotice> PARSER = null;
        ...
        private l.h<VoiceLiveCampaignInfo> liveCampaigns_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addLiveCampaigns(VoiceLiveCampaignInfo.Builder builder) {
            ensureLiveCampaignsIsMutable();
            this.liveCampaigns_.add((VoiceLiveCampaignInfo) builder.build());
        }
        ...
        public static Builder newBuilder(VoiceLiveContentUpdateNotice voiceLiveContentUpdateNotice) {
            return (Builder) ((Builder) DEFAULT_INSTANCE.toBuilder()).mergeFrom(voiceLiveContentUpdateNotice);
        }
        ...
        public static i860<VoiceLiveContentUpdateNotice> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public void setLiveCampaigns(int i, VoiceLiveCampaignInfo.Builder builder) {
            ensureLiveCampaignsIsMutable();
            this.liveCampaigns_.set(i, (VoiceLiveCampaignInfo) builder.build());
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C04661.f1699xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = gVar.f(!this.roomId_.isEmpty(), this.roomId_, !voiceLiveContentUpdateNotice.roomId_.isEmpty(), voiceLiveContentUpdateNotice.roomId_);
                    this.liveCampaigns_ = gVar.g(this.liveCampaigns_, voiceLiveContentUpdateNotice.liveCampaigns_);
                        ...
                        try {
                            ...
                            if (iM != 0) {
                                if (iM == 8) {
                                    ...
                                    this.liveCampaigns_.add(eVar.w(VoiceLiveCampaignInfo.parser(), hVar));
                                } else if (!eVar.R(iM)) {
                                }
                            }
                            z = true;
        ...
        public VoiceLiveCampaignInfo getLiveCampaigns(int i) {
            return (VoiceLiveCampaignInfo) this.liveCampaigns_.get(i);
        }
        ...
        public VoiceLiveCampaignInfoOrBuilder getLiveCampaignsOrBuilder(int i) {
            return (VoiceLiveCampaignInfoOrBuilder) this.liveCampaigns_.get(i);
        }
        ...
        public int getSerializedSize() {
            ...
            int iM = this.action_ != VoiceLongLinkUpdateAction.ActionUnknow.getNumber() ? CodedOutputStream.m(1, this.action_) : 0;
        ...
        public static VoiceLiveContentUpdateNotice parseDelimitedFrom(InputStream inputStream, h hVar) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static VoiceLiveContentUpdateNotice parseFrom(ByteString byteString, h hVar) throws InvalidProtocolBufferException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, hVar);
        }

        public static final class Builder extends GeneratedMessageLite.b<VoiceLiveContentUpdateNotice, Builder> implements VoiceLiveContentUpdateNoticeOrBuilder {
            private Builder() {
            ...
            public Builder addAllLiveCampaigns(Iterable<? extends VoiceLiveCampaignInfo> iterable) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).addAllLiveCampaigns(iterable);
                return this;
            }

            public Builder addLiveCampaigns(VoiceLiveCampaignInfo voiceLiveCampaignInfo) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).addLiveCampaigns(voiceLiveCampaignInfo);
                return this;
            }

            public Builder clearAction() {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).clearAction();
                return this;
            }

            public Builder clearLiveCampaigns() {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).clearLiveCampaigns();
                return this;
            }

            public Builder clearPosition() {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).clearPosition();
                return this;
            }

            public Builder clearRoomId() {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).clearRoomId();
                return this;
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public VoiceLongLinkUpdateAction getAction() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getAction();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public int getActionValue() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getActionValue();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public VoiceLiveCampaignInfo getLiveCampaigns(int i) {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getLiveCampaigns(i);
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public int getLiveCampaignsCount() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getLiveCampaignsCount();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public List<VoiceLiveCampaignInfo> getLiveCampaignsList() {
                return Collections.unmodifiableList(((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getLiveCampaignsList());
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public VoiceLongLinkUpdatePosition getPosition() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getPosition();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public int getPositionValue() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getPositionValue();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public String getRoomId() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getRoomId();
            }

            @Override // com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveContentUpdateNoticeOrBuilder
            public ByteString getRoomIdBytes() {
                return ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).getRoomIdBytes();
            }

            public Builder removeLiveCampaigns(int i) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).removeLiveCampaigns(i);
                return this;
            }

            public Builder setAction(VoiceLongLinkUpdateAction voiceLongLinkUpdateAction) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setAction(voiceLongLinkUpdateAction);
                return this;
            }

            public Builder setActionValue(int i) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setActionValue(i);
                return this;
            }

            public Builder setLiveCampaigns(int i, VoiceLiveCampaignInfo voiceLiveCampaignInfo) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setLiveCampaigns(i, voiceLiveCampaignInfo);
                return this;
            }

            public Builder setPosition(VoiceLongLinkUpdatePosition voiceLongLinkUpdatePosition) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setPosition(voiceLongLinkUpdatePosition);
                return this;
            }

            public Builder setPositionValue(int i) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setPositionValue(i);
                return this;
            }

            public Builder setRoomId(String str) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setRoomId(str);
                return this;
            }

            public Builder setRoomIdBytes(ByteString byteString) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setRoomIdBytes(byteString);
                return this;
            }

            public Builder addLiveCampaigns(int i, VoiceLiveCampaignInfo voiceLiveCampaignInfo) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).addLiveCampaigns(i, voiceLiveCampaignInfo);
                return this;
            }

            public Builder setLiveCampaigns(int i, VoiceLiveCampaignInfo.Builder builder) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).setLiveCampaigns(i, builder);
                return this;
            }

            public Builder addLiveCampaigns(VoiceLiveCampaignInfo.Builder builder) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).addLiveCampaigns(builder);
                return this;
            }

            public Builder addLiveCampaigns(int i, VoiceLiveCampaignInfo.Builder builder) {
                copyOnWrite();
                ((VoiceLiveContentUpdateNotice) ((GeneratedMessageLite.b) this).instance).addLiveCampaigns(i, builder);
                return this;
            }
        }
        ...
        public static VoiceLiveContentUpdateNotice parseFrom(byte[] bArr, h hVar) throws InvalidProtocolBufferException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, hVar);
        }
        ...
        public static VoiceLiveContentUpdateNotice parseFrom(InputStream inputStream, h hVar) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static VoiceLiveContentUpdateNotice parseFrom(e eVar) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar);
        }
        ...
        public static VoiceLiveContentUpdateNotice parseFrom(e eVar, h hVar) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar, hVar);
        }
        ...
        public void addLiveCampaigns(int i, VoiceLiveCampaignInfo.Builder builder) {
            ensureLiveCampaignsIsMutable();
            this.liveCampaigns_.add(i, (VoiceLiveCampaignInfo) builder.build());
        }
    }

    public enum VoiceLongLinkUpdateAction implements l.c {
        ActionUnknow(0),
        ReRequest(1),
        Refresh(2),
        Complete(3),
        ...
        private static final l.d<VoiceLongLinkUpdateAction> internalValueMap = new l.d<VoiceLongLinkUpdateAction>() { // from class: com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLongLinkUpdateAction.1
        ...
        public static l.d<VoiceLongLinkUpdateAction> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum VoiceLongLinkUpdatePosition implements l.c {
        PositionUnknow(0),
        CampaignEntrance(1),
        GiftList(2),
        ...
        private static final l.d<VoiceLongLinkUpdatePosition> internalValueMap = new l.d<VoiceLongLinkUpdatePosition>() { // from class: com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLongLinkUpdatePosition.1
        ...
        public static l.d<VoiceLongLinkUpdatePosition> internalGetValueMap() {
            return internalValueMap;
        }
