package com.p003p1.mobile.longlink.msg.enterroomeffect;
...
import com.p003p1.mobile.longlink.msg.gift.LongLinkGiftMessage;
...
public final class LongLinkEnterRoomMessage {
    ...
    public static /* synthetic */ class C03201 {
        ...
        static final /* synthetic */ int[] f1638xa1df5c61;
        ...
        static {
            ...
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f1638xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public enum EnterRoomEffectGradientDirection implements l.c {
        unknow(0),
        fromUpToDown(1),
        fromLeftToRight(2),
        ...
        private static final l.d<EnterRoomEffectGradientDirection> internalValueMap = new l.d<EnterRoomEffectGradientDirection>() { // from class: com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.EnterRoomEffectGradientDirection.1
        ...
        public static l.d<EnterRoomEffectGradientDirection> internalGetValueMap() {
    ...
    public static final class Hierarchy extends GeneratedMessageLite<Hierarchy, Builder> implements HierarchyOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.b<Hierarchy, Builder> implements HierarchyOrBuilder {
            private Builder() {
            ...
            public Builder clearGrade() {
                copyOnWrite();
                ((Hierarchy) ((GeneratedMessageLite.b) this).instance).clearGrade();
                return this;
            }

            public Builder clearIcon() {
                copyOnWrite();
                ((Hierarchy) ((GeneratedMessageLite.b) this).instance).clearIcon();
                return this;
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.HierarchyOrBuilder
            public long getGrade() {
                return ((Hierarchy) ((GeneratedMessageLite.b) this).instance).getGrade();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.HierarchyOrBuilder
            public String getIcon() {
                return ((Hierarchy) ((GeneratedMessageLite.b) this).instance).getIcon();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.HierarchyOrBuilder
            public ByteString getIconBytes() {
                return ((Hierarchy) ((GeneratedMessageLite.b) this).instance).getIconBytes();
            }

            public Builder setGrade(long j) {
                copyOnWrite();
                ((Hierarchy) ((GeneratedMessageLite.b) this).instance).setGrade(j);
                return this;
            }

            public Builder setIcon(String str) {
                copyOnWrite();
                ((Hierarchy) ((GeneratedMessageLite.b) this).instance).setIcon(str);
                return this;
            }

            public Builder setIconBytes(ByteString byteString) {
                copyOnWrite();
                ((Hierarchy) ((GeneratedMessageLite.b) this).instance).setIconBytes(byteString);
                return this;
            }
        }
        ...
        public static Builder newBuilder(Hierarchy hierarchy) {
            return (Builder) ((Builder) DEFAULT_INSTANCE.toBuilder()).mergeFrom(hierarchy);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C03201.f1638xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.icon_ = hVar.f(!this.icon_.isEmpty(), this.icon_, !hierarchy.icon_.isEmpty(), hierarchy.icon_);
        ...
        public int getSerializedSize() {
            ...
            if (!this.icon_.isEmpty()) {
                iV += CodedOutputStream.K(2, getIcon());
            }
        ...
        public static Hierarchy parseDelimitedFrom(InputStream inputStream, h hVar) throws IOException {
            return (Hierarchy) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static Hierarchy parseFrom(ByteString byteString, h hVar) throws InvalidProtocolBufferException {
            return (Hierarchy) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, hVar);
        }
        ...
        public static Hierarchy parseFrom(byte[] bArr, h hVar) throws InvalidProtocolBufferException {
            return (Hierarchy) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, hVar);
        }
        ...
        public static Hierarchy parseFrom(InputStream inputStream, h hVar) throws IOException {
            return (Hierarchy) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static Hierarchy parseFrom(e eVar) throws IOException {
            return (Hierarchy) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar);
        }
        ...
        public static Hierarchy parseFrom(e eVar, h hVar) throws IOException {
            return (Hierarchy) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar, hVar);
        }
    }
    ...
    public static final class Hierarchys extends GeneratedMessageLite<Hierarchys, Builder> implements HierarchysOrBuilder {
        ...
        public void mergeWealthHierarchy(Hierarchy hierarchy) {
            ...
            if (hierarchy2 == null || hierarchy2 == Hierarchy.getDefaultInstance()) {
                ...
                this.wealthHierarchy_ = (Hierarchy) ((Hierarchy.Builder) Hierarchy.newBuilder(this.wealthHierarchy_).mergeFrom(hierarchy)).buildPartial();
            }
        }

        public static Builder newBuilder(Hierarchys hierarchys) {
            return (Builder) ((Builder) DEFAULT_INSTANCE.toBuilder()).mergeFrom(hierarchys);
        }
        ...
        public void setWealthHierarchy(Hierarchy.Builder builder) {
            this.wealthHierarchy_ = (Hierarchy) builder.build();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C03201.f1638xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 4:
                    return new Builder();
                case 5:
                    this.wealthHierarchy_ = ((GeneratedMessageLite.h) obj).o(this.wealthHierarchy_, ((Hierarchys) obj2).wealthHierarchy_);
                    GeneratedMessageLite.g gVar = GeneratedMessageLite.g.INSTANCE;
                    return this;
                case 6:
                    e eVar = (e) obj;
                        ...
                        try {
                            ...
                            if (iM != 0) {
                                if (iM == 10) {
                                    ...
                                    Hierarchy.Builder builder = hierarchy != null ? (Hierarchy.Builder) hierarchy.toBuilder() : null;
                                    Hierarchy hierarchyW = eVar.w(Hierarchy.parser(), hVar);
                                    this.wealthHierarchy_ = hierarchyW;
                                    if (builder != null) {
                                        builder.mergeFrom(hierarchyW);
                                        this.wealthHierarchy_ = (Hierarchy) builder.buildPartial();
                                    }
                                } else if (!eVar.R(iM)) {
                                }
                            }
        ...
        public int getSerializedSize() {
            ...
            int iC = this.wealthHierarchy_ != null ? CodedOutputStream.C(1, getWealthHierarchy()) : 0;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.wealthHierarchy_ != null) {
                codedOutputStream.w0(1, getWealthHierarchy());
            }
        }

        public static Hierarchys parseDelimitedFrom(InputStream inputStream, h hVar) throws IOException {
            return (Hierarchys) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static Hierarchys parseFrom(ByteString byteString, h hVar) throws InvalidProtocolBufferException {
            return (Hierarchys) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, hVar);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.b<Hierarchys, Builder> implements HierarchysOrBuilder {
            private Builder() {
            ...
            public Builder clearWealthHierarchy() {
                copyOnWrite();
                ((Hierarchys) ((GeneratedMessageLite.b) this).instance).clearWealthHierarchy();
                return this;
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.HierarchysOrBuilder
            public Hierarchy getWealthHierarchy() {
                return ((Hierarchys) ((GeneratedMessageLite.b) this).instance).getWealthHierarchy();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.HierarchysOrBuilder
            public boolean hasWealthHierarchy() {
                return ((Hierarchys) ((GeneratedMessageLite.b) this).instance).hasWealthHierarchy();
            }

            public Builder mergeWealthHierarchy(Hierarchy hierarchy) {
                copyOnWrite();
                ((Hierarchys) ((GeneratedMessageLite.b) this).instance).mergeWealthHierarchy(hierarchy);
                return this;
            }

            public Builder setWealthHierarchy(Hierarchy hierarchy) {
                copyOnWrite();
                ((Hierarchys) ((GeneratedMessageLite.b) this).instance).setWealthHierarchy(hierarchy);
                return this;
            }

            public Builder setWealthHierarchy(Hierarchy.Builder builder) {
                copyOnWrite();
                ((Hierarchys) ((GeneratedMessageLite.b) this).instance).setWealthHierarchy(builder);
                return this;
            }
        }
        ...
        public static Hierarchys parseFrom(byte[] bArr, h hVar) throws InvalidProtocolBufferException {
            return (Hierarchys) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, hVar);
        }
        ...
        public static Hierarchys parseFrom(InputStream inputStream, h hVar) throws IOException {
            return (Hierarchys) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static Hierarchys parseFrom(e eVar) throws IOException {
            return (Hierarchys) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar);
        }
        ...
        public static Hierarchys parseFrom(e eVar, h hVar) throws IOException {
            return (Hierarchys) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar, hVar);
        }
    }
    ...
    public enum PlaceType implements l.c {
        ...
        private static final l.d<PlaceType> internalValueMap = new l.d<PlaceType>() { // from class: com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.PlaceType.1
    ...
    public static final class UserEnterRoomEffect extends GeneratedMessageLite<UserEnterRoomEffect, Builder> implements UserEnterRoomEffectOrBuilder {
        ...
        private l.h<String> avatarGradients_ = GeneratedMessageLite.emptyProtobufList();
        private l.h<String> backgroundGradients_ = GeneratedMessageLite.emptyProtobufList();
        ...
        private l.h<LongLinkGiftMessage.DynamicEffectExtend> dynamicEffectExtends_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addDynamicEffectExtends(LongLinkGiftMessage.DynamicEffectExtend.Builder builder) {
            ensureDynamicEffectExtendsIsMutable();
            this.dynamicEffectExtends_.add((LongLinkGiftMessage.DynamicEffectExtend) builder.build());
        }
        ...
        private void ensureBackgroundGradientsIsMutable() {
            if (this.backgroundGradients_.q()) {
                return;
            }
        ...
        public void mergeHierarchys(Hierarchys hierarchys) {
            ...
            if (hierarchys2 == null || hierarchys2 == Hierarchys.getDefaultInstance()) {
                ...
                this.hierarchys_ = (Hierarchys) ((Hierarchys.Builder) Hierarchys.newBuilder(this.hierarchys_).mergeFrom(hierarchys)).buildPartial();
            }
        }

        public static Builder newBuilder(UserEnterRoomEffect userEnterRoomEffect) {
            return (Builder) ((Builder) DEFAULT_INSTANCE.toBuilder()).mergeFrom(userEnterRoomEffect);
        }
        ...
        public void setDynamicEffectExtends(int i, LongLinkGiftMessage.DynamicEffectExtend.Builder builder) {
            ensureDynamicEffectExtendsIsMutable();
            this.dynamicEffectExtends_.set(i, (LongLinkGiftMessage.DynamicEffectExtend) builder.build());
        }
        ...
        public void setHierarchys(Hierarchys.Builder builder) {
            this.hierarchys_ = (Hierarchys) builder.build();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C03201.f1638xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    this.avatarGradients_.n();
                    this.backgroundGradients_.n();
                ...
                case 5:
                    ...
                    this.userId_ = gVar.f(!this.userId_.isEmpty(), this.userId_, !userEnterRoomEffect.userId_.isEmpty(), userEnterRoomEffect.userId_);
                    this.roomId_ = gVar.f(!this.roomId_.isEmpty(), this.roomId_, !userEnterRoomEffect.roomId_.isEmpty(), userEnterRoomEffect.roomId_);
                    this.hierarchys_ = gVar.o(this.hierarchys_, userEnterRoomEffect.hierarchys_);
                    this.userName_ = gVar.f(!this.userName_.isEmpty(), this.userName_, !userEnterRoomEffect.userName_.isEmpty(), userEnterRoomEffect.userName_);
                    this.userImage_ = gVar.f(!this.userImage_.isEmpty(), this.userImage_, !userEnterRoomEffect.userImage_.isEmpty(), userEnterRoomEffect.userImage_);
                    this.userNameColor_ = gVar.f(!this.userNameColor_.isEmpty(), this.userNameColor_, !userEnterRoomEffect.userNameColor_.isEmpty(), userEnterRoomEffect.userNameColor_);
                    this.text_ = gVar.f(!this.text_.isEmpty(), this.text_, !userEnterRoomEffect.text_.isEmpty(), userEnterRoomEffect.text_);
                    this.textColor_ = gVar.f(!this.textColor_.isEmpty(), this.textColor_, !userEnterRoomEffect.textColor_.isEmpty(), userEnterRoomEffect.textColor_);
                    this.backgroundUrl_ = gVar.f(!this.backgroundUrl_.isEmpty(), this.backgroundUrl_, !userEnterRoomEffect.backgroundUrl_.isEmpty(), userEnterRoomEffect.backgroundUrl_);
                    this.floatingUrl_ = gVar.f(!this.floatingUrl_.isEmpty(), this.floatingUrl_, !userEnterRoomEffect.floatingUrl_.isEmpty(), userEnterRoomEffect.floatingUrl_);
                    this.resourceId_ = gVar.f(!this.resourceId_.isEmpty(), this.resourceId_, !userEnterRoomEffect.resourceId_.isEmpty(), userEnterRoomEffect.resourceId_);
                    long j = this.showDuration_;
                    boolean z2 = j != 0;
                    long j2 = userEnterRoomEffect.showDuration_;
                    this.showDuration_ = gVar.i(z2, j, j2 != 0, j2);
                    boolean z3 = this.isWealthHierarchy_;
                    boolean z4 = userEnterRoomEffect.isWealthHierarchy_;
                    this.isWealthHierarchy_ = gVar.d(z3, z3, z4, z4);
                    int i = this.avatarGradientDirection_;
                    boolean z5 = i != 0;
                    int i2 = userEnterRoomEffect.avatarGradientDirection_;
                    this.avatarGradientDirection_ = gVar.e(z5, i, i2 != 0, i2);
                    this.avatarGradients_ = gVar.g(this.avatarGradients_, userEnterRoomEffect.avatarGradients_);
                    int i3 = this.backgroundGradientDirection_;
                    boolean z6 = i3 != 0;
                    int i4 = userEnterRoomEffect.backgroundGradientDirection_;
                    this.backgroundGradientDirection_ = gVar.e(z6, i3, i4 != 0, i4);
                    this.backgroundGradients_ = gVar.g(this.backgroundGradients_, userEnterRoomEffect.backgroundGradients_);
                    this.effectId_ = gVar.f(!this.effectId_.isEmpty(), this.effectId_, !userEnterRoomEffect.effectId_.isEmpty(), userEnterRoomEffect.effectId_);
                    this.internalText_ = gVar.f(!this.internalText_.isEmpty(), this.internalText_, !userEnterRoomEffect.internalText_.isEmpty(), userEnterRoomEffect.internalText_);
                    long j3 = this.expireTime_;
                    boolean z7 = j3 != 0;
                    long j4 = userEnterRoomEffect.expireTime_;
                    this.expireTime_ = gVar.i(z7, j3, j4 != 0, j4);
                    long j5 = this.backgroundUrlEndMargin_;
                    boolean z8 = j5 != 0;
                    long j6 = userEnterRoomEffect.backgroundUrlEndMargin_;
                    this.backgroundUrlEndMargin_ = gVar.i(z8, j5, j6 != 0, j6);
                    int i5 = this.placeType_;
                    boolean z9 = i5 != 0;
                    int i6 = userEnterRoomEffect.placeType_;
                    this.placeType_ = gVar.e(z9, i5, i6 != 0, i6);
                    this.fixedBackgroundUrl_ = gVar.f(!this.fixedBackgroundUrl_.isEmpty(), this.fixedBackgroundUrl_, !userEnterRoomEffect.fixedBackgroundUrl_.isEmpty(), userEnterRoomEffect.fixedBackgroundUrl_);
                    long j7 = this.animationSizeType_;
                    boolean z10 = j7 != 0;
                    long j8 = userEnterRoomEffect.animationSizeType_;
                    this.animationSizeType_ = gVar.i(z10, j7, j8 != 0, j8);
                    long j9 = this.enterVersion_;
                    boolean z11 = j9 != 0;
                    long j10 = userEnterRoomEffect.enterVersion_;
                    this.enterVersion_ = gVar.i(z11, j9, j10 != 0, j10);
                    this.videoEffectExtras_ = gVar.g(this.videoEffectExtras_, userEnterRoomEffect.videoEffectExtras_);
                    this.newFloatingUrl_ = gVar.f(!this.newFloatingUrl_.isEmpty(), this.newFloatingUrl_, !userEnterRoomEffect.newFloatingUrl_.isEmpty(), userEnterRoomEffect.newFloatingUrl_);
                    this.newResourceId_ = gVar.f(!this.newResourceId_.isEmpty(), this.newResourceId_, !userEnterRoomEffect.newResourceId_.isEmpty(), userEnterRoomEffect.newResourceId_);
                    this.dynamicEffectExtends_ = gVar.g(this.dynamicEffectExtends_, userEnterRoomEffect.dynamicEffectExtends_);
                    this.userNameGradientColors_ = gVar.g(this.userNameGradientColors_, userEnterRoomEffect.userNameGradientColors_);
                        ...
                        try {
                            ...
                            switch (iM) {
                                ...
                                case 26:
                                    ...
                                    Hierarchys.Builder builder = hierarchys != null ? (Hierarchys.Builder) hierarchys.toBuilder() : null;
                                    Hierarchys hierarchysW = eVar.w(Hierarchys.parser(), hVar);
                                    this.hierarchys_ = hierarchysW;
                                    if (builder != null) {
                                        builder.mergeFrom(hierarchysW);
                                        this.hierarchys_ = (Hierarchys) builder.buildPartial();
                                    } else {
                                        continue;
                                    }
                                    break;
                                ...
                                case 74:
                                    ...
                                    continue;
                                case 82:
                                    this.floatingUrl_ = eVar.L();
                                    continue;
                                case 90:
                                    this.resourceId_ = eVar.L();
                                    continue;
                                case 96:
                                    this.showDuration_ = eVar.v();
                                    continue;
                                case 104:
                                    this.isWealthHierarchy_ = eVar.m();
                                    continue;
                                case 112:
                                    this.avatarGradientDirection_ = eVar.p();
                                    continue;
                                case 122:
                                    String strL = eVar.L();
                                    if (!this.avatarGradients_.q()) {
                                    ...
                                    this.avatarGradients_.add(strL);
                                    continue;
                                case 128:
                                    this.backgroundGradientDirection_ = eVar.p();
                                    continue;
                                case 138:
                                    String strL2 = eVar.L();
                                    if (!this.backgroundGradients_.q()) {
                                    ...
                                    this.backgroundGradients_.add(strL2);
                                    continue;
                                case 146:
                                    this.effectId_ = eVar.L();
                                    continue;
                                case 154:
                                    this.internalText_ = eVar.L();
                                    continue;
                                case MSG_TYPE_LIVE_GIFT_RECEIVED_VALUE:
                                    this.expireTime_ = eVar.v();
                                    continue;
                                case 168:
                                    this.backgroundUrlEndMargin_ = eVar.v();
                                    continue;
                                case 176:
                                    this.placeType_ = eVar.p();
                                    continue;
                                case 186:
                                    this.fixedBackgroundUrl_ = eVar.L();
                                    continue;
                                case 192:
                                    this.animationSizeType_ = eVar.v();
                                    continue;
                                case 200:
                                    this.enterVersion_ = eVar.v();
                                    continue;
                                case 210:
                                    if (!this.videoEffectExtras_.q()) {
                                        this.videoEffectExtras_ = GeneratedMessageLite.mutableCopy(this.videoEffectExtras_);
                                    ...
                                    continue;
                                case 218:
                                    this.newFloatingUrl_ = eVar.L();
                                    continue;
                                case 226:
                                    this.newResourceId_ = eVar.L();
                                    continue;
                                case 234:
                                    if (!this.dynamicEffectExtends_.q()) {
                                        this.dynamicEffectExtends_ = GeneratedMessageLite.mutableCopy(this.dynamicEffectExtends_);
                                    }
                                    this.dynamicEffectExtends_.add(eVar.w(LongLinkGiftMessage.DynamicEffectExtend.parser(), hVar));
                                    continue;
                                case 242:
                                    String strL3 = eVar.L();
                                    if (!this.userNameGradientColors_.q()) {
                                    ...
                                    this.userNameGradientColors_.add(strL3);
                                    continue;
                                default:
                                    if (!eVar.R(iM)) {
                                        break;
        ...
        public ByteString getAvatarGradientsBytes(int i) {
            return ByteString.copyFromUtf8((String) this.avatarGradients_.get(i));
        }
        ...
        public ByteString getBackgroundGradientsBytes(int i) {
            return ByteString.copyFromUtf8((String) this.backgroundGradients_.get(i));
        }
        ...
        public LongLinkGiftMessage.DynamicEffectExtend getDynamicEffectExtends(int i) {
            return (LongLinkGiftMessage.DynamicEffectExtend) this.dynamicEffectExtends_.get(i);
        }
        ...
        public LongLinkGiftMessage.DynamicEffectExtendOrBuilder getDynamicEffectExtendsOrBuilder(int i) {
            return (LongLinkGiftMessage.DynamicEffectExtendOrBuilder) this.dynamicEffectExtends_.get(i);
        }
        ...
        public int getSerializedSize() {
            ...
            if (this.hierarchys_ != null) {
                iK += CodedOutputStream.C(3, getHierarchys());
            }
            if (!this.userName_.isEmpty()) {
                iK += CodedOutputStream.K(4, getUserName());
            }
            if (!this.userImage_.isEmpty()) {
                iK += CodedOutputStream.K(5, getUserImage());
            }
            if (!this.userNameColor_.isEmpty()) {
                iK += CodedOutputStream.K(6, getUserNameColor());
            }
            if (!this.text_.isEmpty()) {
                iK += CodedOutputStream.K(7, getText());
            }
            if (!this.textColor_.isEmpty()) {
                iK += CodedOutputStream.K(8, getTextColor());
            }
            if (!this.backgroundUrl_.isEmpty()) {
                iK += CodedOutputStream.K(9, getBackgroundUrl());
            }
            if (!this.floatingUrl_.isEmpty()) {
                iK += CodedOutputStream.K(10, getFloatingUrl());
            }
            if (!this.resourceId_.isEmpty()) {
                iK += CodedOutputStream.K(11, getResourceId());
            }
            long j = this.showDuration_;
            if (j != 0) {
                iK += CodedOutputStream.v(12, j);
            }
            ...
            if (this.avatarGradientDirection_ != EnterRoomEffectGradientDirection.unknow.getNumber()) {
                iK += CodedOutputStream.m(14, this.avatarGradientDirection_);
            }
            int iL = 0;
            for (int i2 = 0; i2 < this.avatarGradients_.size(); i2++) {
                iL += CodedOutputStream.L((String) this.avatarGradients_.get(i2));
            }
            int size = iK + iL + getAvatarGradientsList().size();
            if (this.backgroundGradientDirection_ != EnterRoomEffectGradientDirection.unknow.getNumber()) {
                size += CodedOutputStream.m(16, this.backgroundGradientDirection_);
            }
            int iL2 = 0;
            for (int i3 = 0; i3 < this.backgroundGradients_.size(); i3++) {
                iL2 += CodedOutputStream.L((String) this.backgroundGradients_.get(i3));
            }
            int size2 = size + iL2 + (getBackgroundGradientsList().size() * 2);
            if (!this.effectId_.isEmpty()) {
                size2 += CodedOutputStream.K(18, getEffectId());
            }
            if (!this.internalText_.isEmpty()) {
                size2 += CodedOutputStream.K(19, getInternalText());
            }
            long j2 = this.expireTime_;
            if (j2 != 0) {
                size2 += CodedOutputStream.v(20, j2);
            }
            long j3 = this.backgroundUrlEndMargin_;
            if (j3 != 0) {
                size2 += CodedOutputStream.v(21, j3);
            }
            if (this.placeType_ != PlaceType.videoRoom.getNumber()) {
                size2 += CodedOutputStream.m(22, this.placeType_);
            }
            if (!this.fixedBackgroundUrl_.isEmpty()) {
                size2 += CodedOutputStream.K(23, getFixedBackgroundUrl());
            }
            long j4 = this.animationSizeType_;
            if (j4 != 0) {
                size2 += CodedOutputStream.v(24, j4);
            }
            long j5 = this.enterVersion_;
            if (j5 != 0) {
                size2 += CodedOutputStream.v(25, j5);
            }
            for (int i4 = 0; i4 < this.videoEffectExtras_.size(); i4++) {
                size2 += CodedOutputStream.C(26, (q) this.videoEffectExtras_.get(i4));
            }
            if (!this.newFloatingUrl_.isEmpty()) {
                size2 += CodedOutputStream.K(27, getNewFloatingUrl());
            }
            if (!this.newResourceId_.isEmpty()) {
                size2 += CodedOutputStream.K(28, getNewResourceId());
            }
            for (int i5 = 0; i5 < this.dynamicEffectExtends_.size(); i5++) {
                size2 += CodedOutputStream.C(29, (q) this.dynamicEffectExtends_.get(i5));
            }
            int iL3 = 0;
            for (int i6 = 0; i6 < this.userNameGradientColors_.size(); i6++) {
                iL3 += CodedOutputStream.L((String) this.userNameGradientColors_.get(i6));
            }
            int size3 = size2 + iL3 + (getUserNameGradientColorsList().size() * 2);
            ((GeneratedMessageLite) this).memoizedSerializedSize = size3;
            return size3;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.hierarchys_ != null) {
                codedOutputStream.w0(3, getHierarchys());
            }
            if (!this.userName_.isEmpty()) {
                codedOutputStream.D0(4, getUserName());
            }
            if (!this.userImage_.isEmpty()) {
                codedOutputStream.D0(5, getUserImage());
            }
            if (!this.userNameColor_.isEmpty()) {
                codedOutputStream.D0(6, getUserNameColor());
            }
            if (!this.text_.isEmpty()) {
                codedOutputStream.D0(7, getText());
            }
            if (!this.textColor_.isEmpty()) {
                codedOutputStream.D0(8, getTextColor());
            }
            if (!this.backgroundUrl_.isEmpty()) {
                codedOutputStream.D0(9, getBackgroundUrl());
            }
            if (!this.floatingUrl_.isEmpty()) {
                codedOutputStream.D0(10, getFloatingUrl());
            }
            if (!this.resourceId_.isEmpty()) {
                codedOutputStream.D0(11, getResourceId());
            }
            long j = this.showDuration_;
            if (j != 0) {
            ...
            if (this.avatarGradientDirection_ != EnterRoomEffectGradientDirection.unknow.getNumber()) {
                codedOutputStream.i0(14, this.avatarGradientDirection_);
            }
            for (int i = 0; i < this.avatarGradients_.size(); i++) {
                codedOutputStream.D0(15, (String) this.avatarGradients_.get(i));
            }
            if (this.backgroundGradientDirection_ != EnterRoomEffectGradientDirection.unknow.getNumber()) {
                codedOutputStream.i0(16, this.backgroundGradientDirection_);
            }
            for (int i2 = 0; i2 < this.backgroundGradients_.size(); i2++) {
                codedOutputStream.D0(17, (String) this.backgroundGradients_.get(i2));
            }
            if (!this.effectId_.isEmpty()) {
                codedOutputStream.D0(18, getEffectId());
            }
            if (!this.internalText_.isEmpty()) {
                codedOutputStream.D0(19, getInternalText());
            }
            long j2 = this.expireTime_;
            if (j2 != 0) {
            ...
            if (this.placeType_ != PlaceType.videoRoom.getNumber()) {
                codedOutputStream.i0(22, this.placeType_);
            }
            if (!this.fixedBackgroundUrl_.isEmpty()) {
                codedOutputStream.D0(23, getFixedBackgroundUrl());
            }
            long j4 = this.animationSizeType_;
            if (j4 != 0) {
            ...
            long j5 = this.enterVersion_;
            if (j5 != 0) {
                codedOutputStream.u0(25, j5);
            }
            for (int i3 = 0; i3 < this.videoEffectExtras_.size(); i3++) {
                codedOutputStream.w0(26, (q) this.videoEffectExtras_.get(i3));
            }
            if (!this.newFloatingUrl_.isEmpty()) {
                codedOutputStream.D0(27, getNewFloatingUrl());
            }
            if (!this.newResourceId_.isEmpty()) {
                codedOutputStream.D0(28, getNewResourceId());
            }
            for (int i4 = 0; i4 < this.dynamicEffectExtends_.size(); i4++) {
                codedOutputStream.w0(29, (q) this.dynamicEffectExtends_.get(i4));
            }
            for (int i5 = 0; i5 < this.userNameGradientColors_.size(); i5++) {
                codedOutputStream.D0(30, (String) this.userNameGradientColors_.get(i5));
            }
        }

        public static UserEnterRoomEffect parseDelimitedFrom(InputStream inputStream, h hVar) throws IOException {
            return (UserEnterRoomEffect) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static UserEnterRoomEffect parseFrom(ByteString byteString, h hVar) throws InvalidProtocolBufferException {
            return (UserEnterRoomEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, hVar);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.b<UserEnterRoomEffect, Builder> implements UserEnterRoomEffectOrBuilder {
            private Builder() {
            ...
            public Builder addAllAvatarGradients(Iterable<String> iterable) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAllAvatarGradients(iterable);
                return this;
            }

            public Builder addAllBackgroundGradients(Iterable<String> iterable) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAllBackgroundGradients(iterable);
                return this;
            }

            public Builder addAllDynamicEffectExtends(Iterable<? extends LongLinkGiftMessage.DynamicEffectExtend> iterable) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAllDynamicEffectExtends(iterable);
                return this;
            }

            public Builder addAllUserNameGradientColors(Iterable<String> iterable) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAllUserNameGradientColors(iterable);
                return this;
            }

            public Builder addAllVideoEffectExtras(Iterable<? extends VideoEffectExtra> iterable) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAllVideoEffectExtras(iterable);
                return this;
            }

            public Builder addAvatarGradients(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAvatarGradients(str);
                return this;
            }

            public Builder addAvatarGradientsBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addAvatarGradientsBytes(byteString);
                return this;
            }

            public Builder addBackgroundGradients(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addBackgroundGradients(str);
                return this;
            }

            public Builder addBackgroundGradientsBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addBackgroundGradientsBytes(byteString);
                return this;
            }

            public Builder addDynamicEffectExtends(LongLinkGiftMessage.DynamicEffectExtend dynamicEffectExtend) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addDynamicEffectExtends(dynamicEffectExtend);
                return this;
            }

            public Builder addUserNameGradientColors(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addUserNameGradientColors(str);
                return this;
            }

            public Builder addUserNameGradientColorsBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addUserNameGradientColorsBytes(byteString);
                return this;
            }

            public Builder addVideoEffectExtras(VideoEffectExtra videoEffectExtra) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addVideoEffectExtras(videoEffectExtra);
                return this;
            }

            public Builder clearAnimationSizeType() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearAnimationSizeType();
                return this;
            }

            public Builder clearAvatarGradientDirection() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearAvatarGradientDirection();
                return this;
            }

            public Builder clearAvatarGradients() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearAvatarGradients();
                return this;
            }

            public Builder clearBackgroundGradientDirection() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearBackgroundGradientDirection();
                return this;
            }

            public Builder clearBackgroundGradients() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearBackgroundGradients();
                return this;
            }

            public Builder clearBackgroundUrl() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearBackgroundUrl();
                return this;
            }

            public Builder clearBackgroundUrlEndMargin() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearBackgroundUrlEndMargin();
                return this;
            }

            public Builder clearDynamicEffectExtends() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearDynamicEffectExtends();
                return this;
            }

            public Builder clearEffectId() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearEffectId();
                return this;
            }

            public Builder clearEnterVersion() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearEnterVersion();
                return this;
            }

            public Builder clearExpireTime() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearExpireTime();
                return this;
            }

            public Builder clearFixedBackgroundUrl() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearFixedBackgroundUrl();
                return this;
            }

            public Builder clearFloatingUrl() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearFloatingUrl();
                return this;
            }

            public Builder clearHierarchys() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearHierarchys();
                return this;
            }

            public Builder clearInternalText() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearInternalText();
                return this;
            }

            public Builder clearIsWealthHierarchy() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearIsWealthHierarchy();
                return this;
            }

            public Builder clearNewFloatingUrl() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearNewFloatingUrl();
                return this;
            }

            public Builder clearNewResourceId() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearNewResourceId();
                return this;
            }

            public Builder clearPlaceType() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearPlaceType();
                return this;
            }

            public Builder clearResourceId() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearResourceId();
                return this;
            }

            public Builder clearRoomId() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearRoomId();
                return this;
            }

            public Builder clearShowDuration() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearShowDuration();
                return this;
            }

            public Builder clearText() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearText();
                return this;
            }

            public Builder clearTextColor() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearTextColor();
                return this;
            }

            public Builder clearUserId() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearUserId();
                return this;
            }

            public Builder clearUserImage() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearUserImage();
                return this;
            }

            public Builder clearUserName() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearUserName();
                return this;
            }

            public Builder clearUserNameColor() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearUserNameColor();
                return this;
            }

            public Builder clearUserNameGradientColors() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearUserNameGradientColors();
                return this;
            }

            public Builder clearVideoEffectExtras() {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).clearVideoEffectExtras();
                return this;
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public long getAnimationSizeType() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAnimationSizeType();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public EnterRoomEffectGradientDirection getAvatarGradientDirection() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAvatarGradientDirection();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getAvatarGradientDirectionValue() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAvatarGradientDirectionValue();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getAvatarGradients(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAvatarGradients(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getAvatarGradientsBytes(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAvatarGradientsBytes(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getAvatarGradientsCount() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAvatarGradientsCount();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public List<String> getAvatarGradientsList() {
                return Collections.unmodifiableList(((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getAvatarGradientsList());
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public EnterRoomEffectGradientDirection getBackgroundGradientDirection() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundGradientDirection();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getBackgroundGradientDirectionValue() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundGradientDirectionValue();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getBackgroundGradients(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundGradients(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getBackgroundGradientsBytes(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundGradientsBytes(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getBackgroundGradientsCount() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundGradientsCount();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public List<String> getBackgroundGradientsList() {
                return Collections.unmodifiableList(((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundGradientsList());
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getBackgroundUrl() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundUrl();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getBackgroundUrlBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundUrlBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public long getBackgroundUrlEndMargin() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getBackgroundUrlEndMargin();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public LongLinkGiftMessage.DynamicEffectExtend getDynamicEffectExtends(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getDynamicEffectExtends(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getDynamicEffectExtendsCount() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getDynamicEffectExtendsCount();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public List<LongLinkGiftMessage.DynamicEffectExtend> getDynamicEffectExtendsList() {
                return Collections.unmodifiableList(((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getDynamicEffectExtendsList());
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getEffectId() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getEffectId();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getEffectIdBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getEffectIdBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public long getEnterVersion() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getEnterVersion();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public long getExpireTime() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getExpireTime();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getFixedBackgroundUrl() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getFixedBackgroundUrl();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getFixedBackgroundUrlBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getFixedBackgroundUrlBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getFloatingUrl() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getFloatingUrl();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getFloatingUrlBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getFloatingUrlBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public Hierarchys getHierarchys() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getHierarchys();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getInternalText() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getInternalText();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getInternalTextBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getInternalTextBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public boolean getIsWealthHierarchy() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getIsWealthHierarchy();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getNewFloatingUrl() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getNewFloatingUrl();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getNewFloatingUrlBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getNewFloatingUrlBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getNewResourceId() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getNewResourceId();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getNewResourceIdBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getNewResourceIdBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public PlaceType getPlaceType() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getPlaceType();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getPlaceTypeValue() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getPlaceTypeValue();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getResourceId() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getResourceId();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getResourceIdBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getResourceIdBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getRoomId() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getRoomId();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getRoomIdBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getRoomIdBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public long getShowDuration() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getShowDuration();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getText() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getText();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getTextBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getTextBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getTextColor() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getTextColor();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getTextColorBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getTextColorBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getUserId() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserId();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getUserIdBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserIdBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getUserImage() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserImage();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getUserImageBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserImageBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getUserName() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserName();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getUserNameBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getUserNameColor() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameColor();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getUserNameColorBytes() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameColorBytes();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public String getUserNameGradientColors(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameGradientColors(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public ByteString getUserNameGradientColorsBytes(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameGradientColorsBytes(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getUserNameGradientColorsCount() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameGradientColorsCount();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public List<String> getUserNameGradientColorsList() {
                return Collections.unmodifiableList(((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getUserNameGradientColorsList());
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public VideoEffectExtra getVideoEffectExtras(int i) {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getVideoEffectExtras(i);
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public int getVideoEffectExtrasCount() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getVideoEffectExtrasCount();
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public List<VideoEffectExtra> getVideoEffectExtrasList() {
                return Collections.unmodifiableList(((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).getVideoEffectExtrasList());
            }

            @Override // com.p1.mobile.longlink.msg.enterroomeffect.LongLinkEnterRoomMessage.UserEnterRoomEffectOrBuilder
            public boolean hasHierarchys() {
                return ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).hasHierarchys();
            }

            public Builder mergeHierarchys(Hierarchys hierarchys) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).mergeHierarchys(hierarchys);
                return this;
            }

            public Builder removeDynamicEffectExtends(int i) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).removeDynamicEffectExtends(i);
                return this;
            }

            public Builder removeVideoEffectExtras(int i) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).removeVideoEffectExtras(i);
                return this;
            }

            public Builder setAnimationSizeType(long j) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setAnimationSizeType(j);
                return this;
            }

            public Builder setAvatarGradientDirection(EnterRoomEffectGradientDirection enterRoomEffectGradientDirection) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setAvatarGradientDirection(enterRoomEffectGradientDirection);
                return this;
            }

            public Builder setAvatarGradientDirectionValue(int i) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setAvatarGradientDirectionValue(i);
                return this;
            }

            public Builder setAvatarGradients(int i, String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setAvatarGradients(i, str);
                return this;
            }

            public Builder setBackgroundGradientDirection(EnterRoomEffectGradientDirection enterRoomEffectGradientDirection) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setBackgroundGradientDirection(enterRoomEffectGradientDirection);
                return this;
            }

            public Builder setBackgroundGradientDirectionValue(int i) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setBackgroundGradientDirectionValue(i);
                return this;
            }

            public Builder setBackgroundGradients(int i, String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setBackgroundGradients(i, str);
                return this;
            }

            public Builder setBackgroundUrl(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setBackgroundUrl(str);
                return this;
            }

            public Builder setBackgroundUrlBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setBackgroundUrlBytes(byteString);
                return this;
            }

            public Builder setBackgroundUrlEndMargin(long j) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setBackgroundUrlEndMargin(j);
                return this;
            }

            public Builder setDynamicEffectExtends(int i, LongLinkGiftMessage.DynamicEffectExtend dynamicEffectExtend) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setDynamicEffectExtends(i, dynamicEffectExtend);
                return this;
            }

            public Builder setEffectId(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setEffectId(str);
                return this;
            }

            public Builder setEffectIdBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setEffectIdBytes(byteString);
                return this;
            }

            public Builder setEnterVersion(long j) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setEnterVersion(j);
                return this;
            }

            public Builder setExpireTime(long j) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setExpireTime(j);
                return this;
            }

            public Builder setFixedBackgroundUrl(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setFixedBackgroundUrl(str);
                return this;
            }

            public Builder setFixedBackgroundUrlBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setFixedBackgroundUrlBytes(byteString);
                return this;
            }

            public Builder setFloatingUrl(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setFloatingUrl(str);
                return this;
            }

            public Builder setFloatingUrlBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setFloatingUrlBytes(byteString);
                return this;
            }

            public Builder setHierarchys(Hierarchys hierarchys) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setHierarchys(hierarchys);
                return this;
            }

            public Builder setInternalText(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setInternalText(str);
                return this;
            }

            public Builder setInternalTextBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setInternalTextBytes(byteString);
                return this;
            }

            public Builder setIsWealthHierarchy(boolean z) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setIsWealthHierarchy(z);
                return this;
            }

            public Builder setNewFloatingUrl(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setNewFloatingUrl(str);
                return this;
            }

            public Builder setNewFloatingUrlBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setNewFloatingUrlBytes(byteString);
                return this;
            }

            public Builder setNewResourceId(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setNewResourceId(str);
                return this;
            }

            public Builder setNewResourceIdBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setNewResourceIdBytes(byteString);
                return this;
            }

            public Builder setPlaceType(PlaceType placeType) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setPlaceType(placeType);
                return this;
            }

            public Builder setPlaceTypeValue(int i) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setPlaceTypeValue(i);
                return this;
            }

            public Builder setResourceId(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setResourceId(str);
                return this;
            }

            public Builder setResourceIdBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setResourceIdBytes(byteString);
                return this;
            }

            public Builder setRoomId(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setRoomId(str);
                return this;
            }

            public Builder setRoomIdBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setRoomIdBytes(byteString);
                return this;
            }

            public Builder setShowDuration(long j) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setShowDuration(j);
                return this;
            }

            public Builder setText(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setText(str);
                return this;
            }

            public Builder setTextBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setTextBytes(byteString);
                return this;
            }

            public Builder setTextColor(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setTextColor(str);
                return this;
            }

            public Builder setTextColorBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setTextColorBytes(byteString);
                return this;
            }

            public Builder setUserId(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserId(str);
                return this;
            }

            public Builder setUserIdBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserIdBytes(byteString);
                return this;
            }

            public Builder setUserImage(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserImage(str);
                return this;
            }

            public Builder setUserImageBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserImageBytes(byteString);
                return this;
            }

            public Builder setUserName(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserName(str);
                return this;
            }

            public Builder setUserNameBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserNameBytes(byteString);
                return this;
            }

            public Builder setUserNameColor(String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserNameColor(str);
                return this;
            }

            public Builder setUserNameColorBytes(ByteString byteString) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserNameColorBytes(byteString);
                return this;
            }

            public Builder setUserNameGradientColors(int i, String str) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setUserNameGradientColors(i, str);
                return this;
            }

            public Builder setVideoEffectExtras(int i, VideoEffectExtra videoEffectExtra) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setVideoEffectExtras(i, videoEffectExtra);
                return this;
            }

            public Builder addDynamicEffectExtends(int i, LongLinkGiftMessage.DynamicEffectExtend dynamicEffectExtend) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addDynamicEffectExtends(i, dynamicEffectExtend);
                return this;
            }

            public Builder addVideoEffectExtras(int i, VideoEffectExtra videoEffectExtra) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addVideoEffectExtras(i, videoEffectExtra);
                return this;
            }

            public Builder setDynamicEffectExtends(int i, LongLinkGiftMessage.DynamicEffectExtend.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setDynamicEffectExtends(i, builder);
                return this;
            }

            public Builder setHierarchys(Hierarchys.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setHierarchys(builder);
                return this;
            }

            public Builder setVideoEffectExtras(int i, VideoEffectExtra.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).setVideoEffectExtras(i, builder);
                return this;
            }

            public Builder addDynamicEffectExtends(LongLinkGiftMessage.DynamicEffectExtend.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addDynamicEffectExtends(builder);
                return this;
            }

            public Builder addVideoEffectExtras(VideoEffectExtra.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addVideoEffectExtras(builder);
                return this;
            }

            public Builder addDynamicEffectExtends(int i, LongLinkGiftMessage.DynamicEffectExtend.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addDynamicEffectExtends(i, builder);
                return this;
            }

            public Builder addVideoEffectExtras(int i, VideoEffectExtra.Builder builder) {
                copyOnWrite();
                ((UserEnterRoomEffect) ((GeneratedMessageLite.b) this).instance).addVideoEffectExtras(i, builder);
                return this;
            }
        }
        ...
        public static UserEnterRoomEffect parseFrom(byte[] bArr, h hVar) throws InvalidProtocolBufferException {
            return (UserEnterRoomEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, hVar);
        }
        ...
        public static UserEnterRoomEffect parseFrom(InputStream inputStream, h hVar) throws IOException {
            return (UserEnterRoomEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, hVar);
        }

        public static UserEnterRoomEffect parseFrom(e eVar) throws IOException {
            return (UserEnterRoomEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar);
        }
        ...
        public static UserEnterRoomEffect parseFrom(e eVar, h hVar) throws IOException {
            return (UserEnterRoomEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, eVar, hVar);
        }
        ...
        public void addDynamicEffectExtends(int i, LongLinkGiftMessage.DynamicEffectExtend.Builder builder) {
            ensureDynamicEffectExtendsIsMutable();
            this.dynamicEffectExtends_.add(i, (LongLinkGiftMessage.DynamicEffectExtend) builder.build());
        }
