package com.momocv.faceattributes;
...
public class FaceGender {
    ...
    static {
        if (OsUtils.isWindows()) {
            ...
            System.loadLibrary("mmcv_api_facegender");
            return;
        }
    ...
    private static native boolean nativeProcessFrame(long j, MMFrame mMFrame, FaceGenderParams faceGenderParams, FaceGenderInfo faceGenderInfo);
    ...
    public synchronized boolean ProcessFrame(MMFrame mMFrame, FaceGenderParams faceGenderParams, FaceGenderInfo faceGenderInfo) {
        long j = this.mOBJPtr;
        if (j == 0 || !this.inited) {
            return false;
        }
        return nativeProcessFrame(j, mMFrame, faceGenderParams, faceGenderInfo);
    }
