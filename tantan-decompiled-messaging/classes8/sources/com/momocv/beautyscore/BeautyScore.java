...
public class BeautyScore {
    ...
    static {
        if (OsUtils.isWindows()) {
            ...
            System.loadLibrary("mmcv_api_beautyscore");
            return;
        }
    ...
    private static native boolean nativeProcessFrame(long j, MMFrame mMFrame, BeautyScoreParams beautyScoreParams, BeautyScoreInfo beautyScoreInfo);
    ...
    public synchronized boolean ProcessFrame(MMFrame mMFrame, BeautyScoreParams beautyScoreParams, BeautyScoreInfo beautyScoreInfo) {
        long j = this.mOBJPtr;
        if (j == 0 || !this.inited) {
            return false;
        }
        return nativeProcessFrame(j, mMFrame, beautyScoreParams, beautyScoreInfo);
    }
