...
class fakeSurface implements SurfaceTexture.OnFrameAvailableListener {
        ...
        try {
            ...
            if (this.mScreenSurface == null) {
                ...
                if (this.mScreenWidth[0] != 0 && this.mScreenHight[0] != 0) {
                    int i = C12511.$SwitchMap$tv$danmaku$ijk$media$player$fakeSurface$RenderMode[this.mRenderMode.ordinal()];
                    if (i == 1) {
            ...
            setup();
            Log.e(TAG, "activiteSurface_l: mRenderMode: " + this.mRenderMode + "， width: " + this.mFrameW + "," + this.mFrameH + ", " + this.mScreenWidth[0] + ", " + this.mScreenHight[0]);
        } catch (IllegalArgumentException unused) {
            n8c.a(TAG, "activiteSurface_l eglSetup exception");
            this.mNeedRending = false;
            setLastErr(-1);
        }
    }
    ...
    private void checkEglError(String str) {
        while (true) {
            ...
            n8c.c(TAG, str + ": EGL error: 0x" + Integer.toHexString(iEglGetError));
            setLastErr(-1);
        }
    }
    ...
    private void drawImageNormal() {
        ...
        try {
            ...
            if (this.mScreenWidth[0] != 0 && this.mScreenHight[0] != 0) {
                n8c.a(TAG, "updateRec mEGLSurface width = " + this.mScreenWidth[0] + ";mEGLSurface hight =" + this.mScreenHight[0]);
            ...
            n8c.a(TAG, " mSurfaceTexture.updateTexImage exception ");
        }
    }
    ...
    private void eglSetup(Object obj) {
        ...
        if (obj != null) {
            ...
            this.mEGL.eglQuerySurface(this.mEGLDisplay, this.mEGLSurface, 12375, this.mScreenWidth);
            n8c.a(TAG, "mEGLSurface width = " + this.mScreenWidth[0] + ";mEGLSurface hight =" + this.mScreenHight[0]);
        } else {
    ...
    private void setup() {
        ...
        if (this.mTextureRender == null) {
            ...
            n8c.a(TAG, "textureID=" + this.mTextureRender.getTextureId());
            try {
