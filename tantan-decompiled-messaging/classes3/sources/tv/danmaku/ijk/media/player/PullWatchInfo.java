    ...
    public void setPullDebugInfoParms(long j, long j2, long j3, int i, int i2, int i3, int i4, int i5, String str, String str2) {
        if (this.currentTimeMs == -1) {
            ...
            if (jElapsedRealtime != 0) {
                ...
                long j4 = (j - this.pre_AudioSize) * 8;
                long j5 = jElapsedRealtime * IjkMediaMeta.AV_CH_SIDE_RIGHT;
                this.audioBitRate = j4 / j5;
                this.videoBitRate = ((j2 - this.pre_VideoSize) * 8) / j5;
                n8c.a(TAG, "fps " + (j3 - this.pre_VideoOutputFrames) + "   " + this.fps);
                n8c.a(TAG, "audioBitRate " + (j - this.pre_AudioSize) + "   " + this.audioBitRate);
                n8c.a(TAG, "videoBitRate " + (j2 - this.pre_VideoSize) + "   " + this.videoBitRate);
            }
        }
