...
public class v03 extends xj10 {
    ...
    private HashMap<String, String> f8145d;
    ...
    public v03() {
        ...
        this.f8145d.put("Color", getColorFragmentShader());
        this.f8145d.put("ColorBurn", getColorBurnFragmentShader());
        this.f8145d.put("ColorDodge", getColorDodgeFragmentShader());
        this.f8145d.put("Darken", getDarkenFragmentShader());
        this.f8145d.put("Difference", getDifferenceFragmentShader());
        this.f8145d.put("Divide", getDivideFragmentShader());
        this.f8145d.put("Exclusion", getExclusionFragmentShader());
        this.f8145d.put("HardLight", getHardLightFragmentShader());
        this.f8145d.put("Hue", getHueFragmentShader());
        this.f8145d.put("Lighten", getLightenFragmentShader());
        this.f8145d.put("LinearBurn", getLinearBurnFragmentShader());
        this.f8145d.put("Luminosity", getLuminosityFragmentShader());
        this.f8145d.put("Mask", getMaskFragmentShader());
        this.f8145d.put("Multiply", getMultiplyFragmentShader());
        this.f8145d.put("Normal", getNormalFragmentShader());
        this.f8145d.put("Overlay", getOverlayFragmentShader());
        this.f8145d.put("Saturation", getSaturationFragmentShader());
        this.f8145d.put("Screen", getScreenFragmentShader());
        this.f8145d.put("SoftLight", getSoftLightFragmentShader());
        this.f8145d.put("SourceOver", getSourceoverFragmentShader());
        this.f8145d.put("Subtract", getSubtractFragmentShader());
    }

    /* JADX INFO: renamed from: Q1 */
    public void m8268Q1(String str) {
    ...
    public String getFragmentShader() {
        String str = !TextUtils.isEmpty(this.f8146e) ? this.f8145d.get(this.f8146e) : null;
    ...
    public void newTextureReady(int i, mcj mcjVar, boolean z) {
        ...
        if (this.f8143b == 0 || this.f8144c) {
            Bitmap bitmap = this.f8142a;
            if (bitmap != null) {
                this.f8143b = lgm.m6021a(bitmap);
            } else {
                this.f8143b = lgm.m6021a(lgm.m6023c(this.f8147f));
            }
            this.f8144c = false;
        }
        super.newTextureReady(this.f8143b, this, z);
