...
public class ybc0 extends bt2 {
    ...
    public void initShaderHandles() {
        ...
        this.f9041a = GLES20.glGetUniformLocation(this.programHandle, "iTime");
    }

    @Override // p003l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f9041a, this.f9042b);
    }

    @Override // p003l.uff0, p003l.AbstractC0341i4, p003l.q7m
    public void setTimeStamp(long j) {
        super.setTimeStamp(j);
        this.f9042b = j / 1200.0f;
    }
}
