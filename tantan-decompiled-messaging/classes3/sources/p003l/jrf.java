...
public class jrf extends lr2 {
    ...
    private float f4712g = 1.0f;

    /* JADX INFO: renamed from: i */
    private float f4713i = 1.0f;

    /* JADX INFO: renamed from: j */
    private float f4714j = 1.0f;

    /* JADX INFO: renamed from: Q1 */
    public void m5416Q1(float f) {
        this.f4713i = f;
    }

    /* JADX INFO: renamed from: R1 */
    public void m5417R1(float f) {
        this.f4714j = f;
    }

    /* JADX INFO: renamed from: S1 */
    public void m5418S1(float f) {
        this.f4712g = f;
    }
    ...
    public void initShaderHandles() {
        ...
        this.f4709d = GLES20.glGetUniformLocation(this.programHandle, "thickDistort");
        this.f4710e = GLES20.glGetUniformLocation(this.programHandle, "fineDistort");
        this.f4711f = GLES20.glGetUniformLocation(this.programHandle, "rollSpeed");
    }

    @Override // p003l.lr2, p003l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f4709d, this.f4712g);
        GLES20.glUniform1f(this.f4710e, this.f4713i);
        GLES20.glUniform1f(this.f4711f, this.f4714j);
    }
}
