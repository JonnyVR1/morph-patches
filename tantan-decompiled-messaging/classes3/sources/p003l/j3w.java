...
public class j3w extends xj10 implements e3w {
    ...
    public j3w(Context context, int i) {
        super(2);
        this.intensity = 1.0f;
        this.assetRes = false;
    ...
    public void newTextureReady(int i, mcj mcjVar, boolean z) {
        ...
        if (this.lookup_texture == 0) {
            ...
            this.lookup_texture = lgm.m6021a(this.lookupBitmap);
        }
    ...
    public j3w(Context context, String str) {
        super(2);
        this.intensity = 1.0f;
        this.assetRes = false;
        this.filePath = str;
