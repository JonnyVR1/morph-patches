...
public class y220 extends mcj {
    ...
    public ByteBuffer f8891a = null;

    /* JADX INFO: renamed from: b */
    public ByteBuffer f8892b = null;

    /* JADX INFO: renamed from: c */
    protected Object f8893c = new Object();

    /* JADX INFO: renamed from: d */
    protected boolean f8894d = true;
    ...
    public void destroy() {
        ...
        try {
            GLES20.glDeleteTextures(1, this.f8895e, 0);
    ...
    public void flipPosition(int i) {
        ...
        float[] fArrM8878S1 = m8878S1(i);
        float f = fArrM8878S1[0];
        float f2 = fArrM8878S1[1];
        float f3 = fArrM8878S1[2];
        float f4 = fArrM8878S1[3];
    ...
    public void passShaderValues() {
        ...
        synchronized (this.f8893c) {
            ByteBuffer byteBuffer = this.f8891a;
            if (byteBuffer != null && this.f8892b != null) {
                byteBuffer.position(0);
                this.f8892b.position(0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, this.f8895e[0]);
                GLES20.glTexImage2D(3553, 0, 6409, m8880U1(), m8879T1(), 0, 6409, 5121, this.f8891a);
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.f8895e[1]);
                GLES20.glTexImage2D(3553, 0, 6410, m8877R1(), m8876Q1(), 0, 6410, 5121, this.f8892b);
                this.f8894d = true;
