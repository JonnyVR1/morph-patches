...
public class gzw {
    ...
    public static String m4903a(User user) {
        String str;
        String strM;
        String str2;
        String str3;
        ...
        if (vwb.J(list)) {
            ...
            if (TextUtils.isEmpty(str) || TextUtils.equals(str, CoreModule.b.getString(R.string.l2))) {
                str = "xx";
            }
        }
        ...
        if (vwb.J(list3) && vwb.J(list2)) {
            ...
            strM = CoreModule.P().a().m(list2, list3);
            if (TextUtils.isEmpty(strM) || TextUtils.equals(strM, CoreModule.b.getString(R.string.l2))) {
                strM = "xx";
            }
        }
        String strM4904b = m4904b(user);
        String strM4905c = m4905c(user);
        ...
        if (profile == null || (extensions = profile.extensions) == null || (profileExtensionBasic = extensions.basic) == null || vwb.J(profileExtensionBasic.qualification)) {
            str2 = "xx";
        } else {
            str2 = (String) user.profile.extensions.basic.qualification.get(0);
            if (!m4906d(str2)) {
                str2 = "xx";
            }
        }
        ...
        if (iNextInt == 0) {
            ...
            if (!TextUtils.equals(strM, "xx")) {
                sb.append("年收入");
                sb.append(strM);
                sb.append("、");
            }
            if (!TextUtils.equals(strM4904b, "xx")) {
                sb.append("做");
                sb.append(strM4904b);
                sb.append("工作，");
            }
            if (!TextUtils.equals(strM4905c, "xx")) {
                sb.append(strM4905c);
                sb.append("、");
            }
    ...
    public static String m4904b(User user) {
        Profile profile = user.profile;
    ...
    public static String m4905c(User user) {
        return !TEnum.equals(user.profile.zodiac, ProfileZodiac.get("unknown_")) ? i0g0.j0(user.profile.zodiac) : "xx";
    }

    /* JADX INFO: renamed from: d */
    public static boolean m4906d(String str) {
        return (TextUtils.isEmpty(str) || TextUtils.equals(str, CoreModule.b.getString(R.string.l2)) || TextUtils.equals(str, "不限") || TextUtils.equals(str, "暂无")) ? false : true;
    }
}
