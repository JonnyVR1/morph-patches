...
public class pcj extends mcj implements jcj {
    ...
    public void initShaderHandles() {
        ...
        this.f6363d = GLES20.glGetUniformLocation(this.programHandle, "imageWidthFactor");
        this.f6364e = GLES20.glGetUniformLocation(this.programHandle, "imageHeightFactor");
    }
    ...
    public void newTextureReady(int i, mcj mcjVar, boolean z) {
        ...
        this.texture_in = i;
        this.f6361b = mcjVar.getWidth();
        this.f6362c = mcjVar.getHeight();
    ...
    public void passShaderValues() {
        ...
        GLES20.glUniform1f(this.f6364e, 1.0f / this.f6361b);
        GLES20.glUniform1f(this.f6363d, 1.0f / this.f6362c);
