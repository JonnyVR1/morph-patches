...
public final class dgy extends dg2 {
    ...
    public void m3578B() {
        super.B();
        h0("p_buzz_memoji_connecting");
    }

    @NotNull
    /* JADX INFO: renamed from: I */
    public String m3579I() {
    ...
    public void m3581f0() {
        super.f0();
        h0("p_intl_buzz_memoji_waiting");
    }

    /* JADX INFO: renamed from: j0 */
    public void m3582j0(@NotNull j760<String, Object> pair, boolean bundle) {
        int i;
        pair.getClass();
        super.j0(pair, bundle);
        j8w.a aVar = j8w.Companion;
        LoveBuzzData loveBuzzDataV0 = aVar.a().v0();
        if (loveBuzzDataV0 == null || (i = loveBuzzDataV0.remainingMemojiBuzz) == L()) {
            return;
        }
        loveBuzzDataV0.remainingMemojiBuzz = a.b(i - 1, 0);
    ...
    public void m3584r() {
        ...
        Y().getHierarchy().E((Drawable) null);
        Y().getHierarchy().H((RoundingParams) null);
    ...
    public void m3585v() {
        super.v();
        h0("p_intl_buzz_memoji_paired");
        p9w.INSTANCE.o("memojiBuzz");
    }
}
