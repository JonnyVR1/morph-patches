...
public class c300 extends AbstractC0341i4 {
    ...
    public void initShaderHandles() {
        ...
        this.f2574a = GLES20.glGetUniformLocation(this.programHandle, "number");
    }

    @Override // p003l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f2574a, this.f2575b);
    }

    @Override // p003l.AbstractC0341i4
    public void setFilterOptions(FilterOptions filterOptions) {
        super.setFilterOptions(filterOptions);
        this.f2575b = filterOptions.getType();
    }
}
