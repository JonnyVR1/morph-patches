...
public class bjf0 implements bfm {
    ...
    public Bitmap mo2943a(Context context, Uri uri) throws Exception {
        ...
        upk0.m8197a("Skia image region decoder returned null bitmap - image format may not be supported");
        return null;
    }
}
