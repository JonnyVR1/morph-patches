...
public class prf extends lr2 {
    ...
    public void initShaderHandles() {
        ...
        this.f6492d = GLES20.glGetUniformLocation(this.programHandle, "lightColors");
        this.f6493e = GLES20.glGetUniformLocation(this.programHandle, "darkColors");
    }

    @Override // p003l.lr2, p003l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1fv(this.f6492d, 12, this.f6494f, 0);
        GLES20.glUniform1fv(this.f6493e, 12, this.f6495g, 0);
    }
}
