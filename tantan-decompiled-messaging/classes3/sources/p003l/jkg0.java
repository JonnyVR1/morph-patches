...
public abstract class jkg0 {
    ...
    public static n8g0 m5353b(String str, String str2) throws Throwable {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            m5354c(fileInputStream2);
                            m5354c(channel2);
                            m5354c(fileOutputStream);
                            m5354c(channel);
                            return n8g0Var;
                        } catch (IOException e) {
                            e = e;
    ...
    public static void m5354c(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
    ...
    public static void m5355d(File file) {
