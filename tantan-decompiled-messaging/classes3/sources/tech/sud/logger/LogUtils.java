...
public final class LogUtils {
    ...
    public static final int f11153A = 7;

    /* JADX INFO: renamed from: D */
    public static final int f11154D = 3;

    /* JADX INFO: renamed from: E */
    public static final int f11155E = 6;

    /* JADX INFO: renamed from: I */
    public static final int f11156I = 4;
    public static boolean Sudint = false;
    public static SimpleDateFormat Sudnew = null;

    /* JADX INFO: renamed from: V */
    public static final int f11157V = 2;

    /* JADX INFO: renamed from: W */
    public static final int f11158W = 5;
    ...
    public static void Suddo(String str, String str2, boolean z) throws BadPaddingException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        if (Sudfor.Sudelse) {
            if (z) {
                ...
                String strA = sdg0.a(bArr);
                SharedPreferences.Editor editorEdit = idg0.a().a.edit();
                editorEdit.putString("key_aes_key_prefix_" + str, strA);
                editorEdit.commit();
                PublicKey publicKeyGeneratePublic = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(sdg0.b("")));
                if (encoded.length == 0) {
                    bArrDoFinal = null;
                } else {
                ...
                String str3 = sdg0.a(bArrDoFinal) + LINE_SEP;
                Sudfor.getClass();
                UtilsBridge.writeFileFromString(str, str3, true);
            }
            str2 = smg0.a(str, str2) + LINE_SEP;
        }
        Sudfor.getClass();
    ...
    /* JADX INFO: renamed from: a */
    public static void m10042a(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(7, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: d */
    public static void m10043d(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(3, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: e */
    public static void m10044e(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(6, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: i */
    public static void m10045i(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(4, "", objArr);
    }
            ...
            if (i2 >= 2 || i2 >= 2) {
                ...
                if (!sudcase2.Sudint || i3 == 16 || i2 < 2) {
                    ...
                    if (i5 <= 0) {
                        ...
                        if (i9 != length2) {
                            Log.println(i2, str3, " " + LINE_SEP + string3.substring(i9, length2));
                            Sudfor.getClass();
                        }
                    }
                }
    ...
    /* JADX INFO: renamed from: v */
    public static void m10046v(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(2, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: w */
    public static void m10047w(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(5, "", objArr);
    }
