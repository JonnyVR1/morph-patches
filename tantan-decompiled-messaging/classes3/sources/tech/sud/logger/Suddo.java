...
public final class Suddo implements Runnable {
    ...
    public final void run() {
        ...
        int i2;
        int i3 = this.Suddo;
        String str2 = this.Sudif.Suddo;
        String str3 = this.Sudif.Sudfor + this.Sudfor;
        long j = this.Sudint;
        String str4 = this.Sudnew;
        int i4 = LogUtils.f11157V;
        Date date = new Date();
        ...
        while (true) {
            ...
            if (!"".equals(strConcat)) {
                ...
                if (file.isFile()) {
                    ...
                    i = i3;
                    str = str2;
                    if (sudcase2.Sudgoto <= IjkMediaMeta.AV_CH_SIDE_RIGHT || file.length() <= sudcase2.Sudgoto) {
                        break;
                        break;
                    }
                } else {
        ...
        try {
            ...
            if (timeZone != null) {
                ...
                int iAbs = Math.abs((rawOffset / 60000) % 60);
            ...
            try {
                LogUtils.Suddo(strConcat, str5.substring(11) + str9 + LogUtils.Suddo[i - 2] + "/" + str + str10 + str3 + LogUtils.LINE_SEP, false);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } catch (Exception e2) {
