    ...
    public static class PropertyCondition extends AbstractCondition {
        ...
        private static Object checkValueForType(Property property, Object obj) {
            ...
            if (cls == Date.class) {
                ...
                C0255e7.m3799a("Illegal date value: expected java.util.Date or Long for value ", obj);
                return null;
            }
            if (cls == Boolean.TYPE || cls == Boolean.class) {
                ...
                if (obj instanceof Number) {
                    ...
                    if (iIntValue != 0 && iIntValue != 1) {
                        C0255e7.m3799a("Illegal boolean value: numbers must be 0 or 1, but was ", obj);
                        return null;
                    }
                    ...
                    C0255e7.m3799a("Illegal boolean value: Strings must be \"TRUE\" or \"FALSE\" (case insensitive), but was ", obj);
                    return null;
                }
            }
            return obj;
        ...
        @Override // org.greenrobot.greendao.query.WhereCondition
        public void appendTo(StringBuilder sb, String str) {
            SqlUtils.appendProperty(sb, str, this.property).append(this.f9585op);
        }
