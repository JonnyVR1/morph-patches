...
public abstract class AbstractDao<T, K> {
    ...
    protected final Database f9579db;
    ...
    public AbstractDao(DaoConfig daoConfig, AbstractDaoSession abstractDaoSession) {
        ...
        Database database = daoConfig.f9583db;
        this.f9579db = database;
    ...
    private long executeInsert(T t, DatabaseStatement databaseStatement, boolean z) {
        ...
        if (this.f9579db.isDbLockedByCurrentThread()) {
    ...
    public List<String> arrayFiled(Property property, Property[] propertyArr, String[] strArr) {
        Cursor cursorRawQuery = this.f9579db.rawQuery(this.statements.b(new Property[]{property}, propertyArr), strArr);
    ...
    public void deleteAll() {
        this.f9579db.execSQL("DELETE FROM '" + this.config.tablename + "'");
        IdentityScope<K, T> identityScope = this.identityScope;
        if (identityScope != null) {
            identityScope.clear();
        }
    ...
    public <T extends vhf0> List<T> listSimple(Property[] propertyArr, Class<T> cls) {
        ArrayList arrayList = new ArrayList();
        Cursor cursorRawQuery = this.f9579db.rawQuery(this.statements.c(propertyArr), null);
        while (cursorRawQuery.moveToNext()) {
            try {
                try {
                    vhf0 vhf0Var = (vhf0) cls.newInstance();
                    vhf0Var.a(cursorRawQuery, propertyArr);
    ...
    public T load(K k) {
        ...
        if (QueryBuilder.LOG_SQL) {
            DaoLog.m9556d("GreenDao Built SQL for query: " + selectByKey);
            DaoLog.m9556d("GreenDao Built Values for query: " + Arrays.asList(strArr));
        }
        return loadUniqueAndCloseCursor(this.f9579db.rawQuery(selectByKey, strArr));
    }

    public List<T> loadAll() {
        return loadAllAndCloseCursor(this.f9579db.rawQuery(this.statements.getSelectAll(), null));
    }
        ...
        if (cursor instanceof CrossProcessCursor) {
            ...
            if (window != null) {
                if (window.getNumRows() == count) {
                    ...
                    DaoLog.m9556d("Window vs. result size: " + window.getNumRows() + "/" + count);
                }
            }
    ...
    public T loadByRowId(long j) {
        return loadUniqueAndCloseCursor(this.f9579db.rawQuery(this.statements.getSelectByRowId(), new String[]{Long.toString(j)}));
    }
    ...
    public List<T> queryRaw(String str, String... strArr) {
        return loadAllAndCloseCursor(this.f9579db.rawQuery(this.statements.getSelectAll() + str, strArr));
    }
    ...
    public void refresh(T t) {
        ...
        Cursor cursorRawQuery = this.f9579db.rawQuery(this.statements.getSelectByKey(), new String[]{keyVerified.toString()});
        try {
    ...
    public void updateInTx(Iterable<T> iterable) {
        ...
        try {
            ...
            try {
                ...
                DaoLog.m9565w("Could not end transaction (rethrowing initial exception)", e2);
                throw e;
            }
        } catch (Throwable th2) {
            this.f9579db.endTransaction();
    ...
    public void updateKeyAfterInsertAndAttach(T t, long j, boolean z) {
        if (j != -1) {
            ...
            DaoLog.m9564w("Could not insert row (executeInsert returned -1)");
        }
    }
    ...
    public void updateIn(Property[] propertyArr, Object[] objArr, Property[] propertyArr2, Object[] objArr2, Property property, Object[] objArr3) {
        assertSinglePk();
        d7.b(this.f9579db, this.statements, this.isStandardSQLite, propertyArr, objArr, propertyArr2, objArr2, property, objArr3);
        detachAll();
    }
    ...
    public void update(Property[] propertyArr, Object[] objArr, Property[] propertyArr2, Object[] objArr2) {
        assertSinglePk();
        d7.a(this.f9579db, this.statements, this.isStandardSQLite, propertyArr, objArr, propertyArr2, objArr2);
        detachAll();
    }
