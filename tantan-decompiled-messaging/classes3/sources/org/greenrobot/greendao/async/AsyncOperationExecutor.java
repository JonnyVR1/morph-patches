...
class AsyncOperationExecutor implements Runnable, Handler.Callback {
    ...
    public static /* synthetic */ class C08681 {
        ...
        static final /* synthetic */ int[] f9582x3b8ffa8;
        ...
        static {
            ...
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.DeleteInTxIterable.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.DeleteInTxArray.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.Insert.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.InsertInTxIterable.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.InsertInTxArray.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.InsertOrReplace.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.InsertOrReplaceInTxIterable.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.InsertOrReplaceInTxArray.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.Update.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.UpdateInTxIterable.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.UpdateInTxArray.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.TransactionRunnable.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.TransactionCallable.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.QueryList.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.QueryUnique.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.DeleteByKey.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.DeleteAll.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.Load.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.LoadAll.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.Count.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f9582x3b8ffa8[AsyncOperation.OperationType.Refresh.ordinal()] = 22;
    ...
    private void executeOperation(AsyncOperation asyncOperation) {
        ...
        try {
            switch (C08681.f9582x3b8ffa8[asyncOperation.type.ordinal()]) {
                case 1:
            ...
            try {
                try {
                    if (i < arrayList.size()) {
                        ...
                        DaoLog.m9560i("Reverted merged transaction because one of the operations failed. Executing operations one by one instead...");
                    ...
                    DaoLog.m9561i("Async transaction could not be ended, success so far was: " + z, e);
                }
                z = false;
                if (z2) {
                    size = arrayList.size();
                ...
                try {
                    ...
                    DaoLog.m9561i("Async transaction could not be ended, success so far was: false", e2);
                }
                throw th;
            }
        }
        ...
        while (true) {
            try {
                try {
                    ...
                    DaoLog.m9565w(Thread.currentThread().getName() + " was interruppted", e);
                    this.executorRunning = false;
                    return;
                }
            } catch (Throwable th) {
