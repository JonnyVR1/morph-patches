...
public class X9FieldID extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private ASN1ObjectIdentifier f9953id;
    private ASN1Primitive parameters;

    public X9FieldID(int i, int i2, int i3, int i4) {
        this.f9953id = X9ObjectIdentifiers.characteristic_two_field;
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
        aSN1EncodableVector.add(new ASN1Integer(i));
        if (i3 == 0) {
            if (i4 != 0) {
                ig3.a("inconsistent k values");
                throw null;
            }
    ...
    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
        aSN1EncodableVector.add(this.f9953id);
    ...
    public X9FieldID(BigInteger bigInteger) {
        this.f9953id = X9ObjectIdentifiers.prime_field;
        this.parameters = new ASN1Integer(bigInteger);
    }

    private X9FieldID(ASN1Sequence aSN1Sequence) {
        this.f9953id = ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(0));
