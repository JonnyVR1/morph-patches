...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        if (objectAt instanceof X9ECPoint) {
            this.f9947g = (X9ECPoint) objectAt;
        } else {
            this.f9947g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
        this.f9949n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        this.seed = x9Curve.getSeed();
        if (aSN1Sequence.size() == 6) {
            this.f9948h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f9947g);
        aSN1EncodableVector.add(new ASN1Integer(this.f9949n));
        BigInteger bigInteger = this.f9948h;
        if (bigInteger != null) {
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        this.curve = eCCurve;
        this.f9947g = x9ECPoint;
        this.f9949n = bigInteger;
        this.f9948h = bigInteger2;
        this.seed = bArr;
        ...
        ig3.a("'curve' is of an unsupported type");
        throw null;
    }
}
