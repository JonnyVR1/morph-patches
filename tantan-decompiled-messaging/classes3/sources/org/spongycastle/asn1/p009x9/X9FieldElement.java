...
public class X9FieldElement extends ASN1Object {
    ...
    protected ECFieldElement f9952f;
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f9952f.toBigInteger(), converter.getByteLength(this.f9952f)));
    }

    public X9FieldElement(BigInteger bigInteger, ASN1OctetString aSN1OctetString) {
        this(new ECFieldElement.C1074Fp(bigInteger, new BigInteger(1, aSN1OctetString.getOctets())));
    }

    public X9FieldElement(ECFieldElement eCFieldElement) {
        this.f9952f = eCFieldElement;
    }
}
