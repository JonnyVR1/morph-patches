...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String {
    ...
    public ASN1BitString(byte[] bArr, int i) {
        if (bArr == null) {
            jfd0.a("data cannot be null");
            throw null;
        }
        if (bArr.length == 0 && i != 0) {
            ig3.a("zero length data with non-zero pad bits");
            throw null;
        }
        if (i > 7 || i < 0) {
            ig3.a("pad bits cannot be greater than 7 or less than 0");
            throw null;
        }
    ...
    public byte[] getOctets() {
        ...
        qkq0.a("attempt to get non-octet aligned data from BIT STRING");
        return null;
    }
    ...
    public String getString() {
        ...
        try {
            ...
            C0591v1.m8269a("Internal error encoding BitString: ", e.getMessage(), e);
            return null;
        }
    }
