...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f9884iv;

    public IDEACBCPar(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.f9884iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        } else {
            this.f9884iv = null;
        }
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f9884iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f9884iv = new DEROctetString(bArr);
    }
}
