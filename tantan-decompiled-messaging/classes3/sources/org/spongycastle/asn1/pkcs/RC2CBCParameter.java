...
public class RC2CBCParameter extends ASN1Object {
    ...
    ASN1OctetString f9893iv;
    ASN1Integer version;

    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.version = null;
            this.f9893iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        } else {
            this.version = (ASN1Integer) aSN1Sequence.getObjectAt(0);
            this.f9893iv = (ASN1OctetString) aSN1Sequence.getObjectAt(1);
        }
    }
