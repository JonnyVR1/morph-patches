    ...
    private static byte[] toBytes(Vector vector) {
        ...
        for (int i = 0; i != vector.size(); i++) {
            try {
                ...
                C0637x1.m8688a("exception converting octets ", e);
                return null;
            } catch (ClassCastException unused) {
                ig3.a(vector.elementAt(i).getClass().getName().concat(" found in input should only contain DEROctetString"));
                return null;
            }
        }
