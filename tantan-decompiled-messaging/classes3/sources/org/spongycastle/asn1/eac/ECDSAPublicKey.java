...
public class ECDSAPublicKey extends PublicKeyDataObject {
    ...
    private static final int f9875A = 2;

    /* JADX INFO: renamed from: B */
    private static final int f9876B = 4;

    /* JADX INFO: renamed from: F */
    private static final int f9877F = 64;

    /* JADX INFO: renamed from: G */
    private static final int f9878G = 8;

    /* JADX INFO: renamed from: P */
    private static final int f9879P = 1;

    /* JADX INFO: renamed from: R */
    private static final int f9880R = 16;

    /* JADX INFO: renamed from: Y */
    private static final int f9881Y = 32;
    ...
    public ECDSAPublicKey(ASN1Sequence aSN1Sequence) throws IllegalArgumentException {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (!(objNextElement instanceof ASN1TaggedObject)) {
                ig3.a("Unknown Object Identifier!");
                throw null;
            }
        ...
        ig3.a("All options must be either present or absent!");
        throw null;
    }
    ...
    private void setBasePointG(ASN1OctetString aSN1OctetString) throws IllegalArgumentException {
        int i = this.options;
        if ((i & 8) != 0) {
            ig3.a("Base Point G already set");
        } else {
            this.options = i | 8;
    ...
    private void setFirstCoefA(BigInteger bigInteger) throws IllegalArgumentException {
        int i = this.options;
        if ((i & 2) != 0) {
            ig3.a("First Coef A already set");
        } else {
            this.options = i | 2;
    ...
    private void setOrderOfBasePointR(BigInteger bigInteger) throws IllegalArgumentException {
        int i = this.options;
        if ((i & 16) != 0) {
            ig3.a("Order of base point R already set");
        } else {
            this.options = i | 16;
    ...
    private void setPrimeModulusP(BigInteger bigInteger) {
        int i = this.options;
        if ((i & 1) != 0) {
            ig3.a("Prime Modulus P already set");
        } else {
            this.options = i | 1;
    ...
    private void setPublicPointY(ASN1OctetString aSN1OctetString) throws IllegalArgumentException {
        int i = this.options;
        if ((i & 32) != 0) {
            ig3.a("Public Point Y already set");
        } else {
            this.options = i | 32;
    ...
    private void setSecondCoefB(BigInteger bigInteger) throws IllegalArgumentException {
        int i = this.options;
        if ((i & 4) != 0) {
            ig3.a("Second Coef B already set");
        } else {
            this.options = i | 4;
