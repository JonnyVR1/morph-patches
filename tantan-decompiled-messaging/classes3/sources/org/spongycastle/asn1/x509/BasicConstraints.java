...
public class BasicConstraints extends ASN1Object {
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        this.f9921cA = ASN1Boolean.getInstance(false);
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f9921cA;
    ...
    public BasicConstraints(boolean z) {
        ...
        this.pathLenConstraint = null;
        if (z) {
            this.f9921cA = ASN1Boolean.getInstance(true);
        } else {
            this.f9921cA = null;
        }
        this.pathLenConstraint = null;
