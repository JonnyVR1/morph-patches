...
public final class Strings {
    ...
    public static String fromUTF8ByteArray(byte[] bArr) {
        ...
        while (i < bArr.length) {
            byte b2 = bArr[i];
            if ((b2 & 240) == 240) {
                int i6 = (((((b2 & 3) << 18) | ((bArr[i + 1] & 63) << 12)) | ((bArr[i + 2] & 63) << 6)) | (bArr[i + 3] & 63)) - PKIFailureInfo.notAuthorized;
                ...
                c = (char) (((b2 & 15) << 12) | ((bArr[i + 1] & 63) << 6) | (bArr[i + 2] & 63));
                i += 3;
    ...
    public static void toUTF8ByteArray(char[] cArr, OutputStream outputStream) throws IOException {
        ...
        while (i < cArr.length) {
            ...
            if (c < 128) {
                ...
                i++;
                if (i >= cArr.length) {
                    qkq0.a("invalid UTF-16 codepoint");
                    return;
                }
                char c2 = cArr[i];
                if (c > 56319) {
    ...
    public static byte[] toUTF8ByteArray(char[] cArr) {
        ...
        try {
            ...
            qkq0.a("cannot encode string to byte array!");
            return null;
        }
    }
