...
public class SecT571Field {
    ...
    private static final long f10489RM = -1190112520884487202L;
    ...
    public static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        while (i > 0) {
            int i3 = i2 + 18;
            long[] jArr5 = jArr4;
            Nat.shiftUpBit64(9, jArr5, i3 >>> 1, 0L, jArr5, i3);
            jArr4 = jArr5;
            reduce5(jArr4, i3);
        ...
        long[] jArr6 = new long[CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA];
        Nat.shiftUpBits64(CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA, jArr4, 0, 4, 0L, jArr6, 0);
        for (int i4 = 56; i4 >= 0; i4 -= 8) {
            for (int i5 = 1; i5 < 9; i5 += 2) {
                int i6 = (int) (jArr[i5] >>> i4);
                addBothTo(jArr4, (i6 & 15) * 9, jArr6, ((i6 >>> 4) & 15) * 9, jArr3, i5 - 1);
            }
        ...
        for (int i7 = 56; i7 >= 0; i7 -= 8) {
            for (int i8 = 0; i8 < 9; i8 += 2) {
                ...
                addBothTo(jArr4, (i9 & 15) * 9, jArr6, ((i9 >>> 4) & 15) * 9, jArr3, i8);
            }
            if (i7 > 0) {
    ...
    public static void invert(long[] jArr, long[] jArr2) {
        ...
        multiply(jArrCreate64, jArrCreate65, jArrCreate64);
        squareN(jArrCreate64, CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA256, jArrCreate65);
        multiply(jArrCreate64, jArrCreate65, jArrCreate64);
        squareN(jArrCreate65, CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA256, jArrCreate65);
        multiply(jArrCreate64, jArrCreate65, jArrCreate64);
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            jArrCreate65[i2] = (jUnshuffle >>> 32) | ((-4294967296L) & jUnshuffle2);
        }
