...
public class SecP224R1FieldElement extends ECFieldElement {
    ...
    public static final BigInteger f10459Q = SecP224R1Curve.f10455q;

    /* JADX INFO: renamed from: x */
    protected int[] f10460x;

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f10459Q) >= 0) {
            ig3.a("x value invalid for SecP224R1FieldElement");
            throw null;
        }
        this.f10460x = SecP224R1Field.fromBigInteger(bigInteger);
    }

    /* JADX INFO: renamed from: RM */
    private static void m9680RM(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int[] iArr6, int[] iArr7) {
    ...
    private static void m9681RP(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            while (true) {
                i2--;
                if (i2 >= 0) {
                    m9682RS(iArr2, iArr3, iArr4, iArr5);
                }
            }
            m9680RM(iArr, iArrCreate, iArrCreate2, iArr2, iArr3, iArr4, iArr5);
        }
    }

    /* JADX INFO: renamed from: RS */
    private static void m9682RS(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        m9681RP(iArr, iArrCreate, iArrCreate2, iArrCreate3, iArr3);
        ...
        for (int i = 1; i < 96; i++) {
            ...
            m9682RS(iArrCreate, iArrCreate2, iArrCreate3, iArr3);
            if (Nat224.isZero(iArrCreate)) {
                Mod.invert(SecP224R1Field.f10457P, iArrCreate5, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.add(this.f10460x, ((SecP224R1FieldElement) eCFieldElement).f10460x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.addOne(this.f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        Mod.invert(SecP224R1Field.f10457P, ((SecP224R1FieldElement) eCFieldElement).f10460x, iArrCreate);
        SecP224R1Field.multiply(iArrCreate, this.f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224R1FieldElement) {
            return Nat224.m9687eq(this.f10460x, ((SecP224R1FieldElement) obj).f10460x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f10459Q.bitLength();
    }

    public int hashCode() {
        return Arrays.hashCode(this.f10460x, 0, 7) ^ f10459Q.hashCode();
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat224.create();
        Mod.invert(SecP224R1Field.f10457P, this.f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f10460x);
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f10460x);
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.multiply(this.f10460x, ((SecP224R1FieldElement) eCFieldElement).f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.negate(this.f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f10460x;
        if (Nat224.isZero(iArr) || Nat224.isOne(iArr)) {
            return this;
        }
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.negate(iArr, iArrCreate);
        int[] iArrRandom = Mod.random(SecP224R1Field.f10457P);
        int[] iArrCreate2 = Nat224.create();
        if (!isSquare(iArr)) {
            return null;
        }
        ...
        if (Nat224.m9687eq(iArr, iArrRandom)) {
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.square(this.f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.subtract(this.f10460x, ((SecP224R1FieldElement) eCFieldElement).f10460x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f10460x, 0) == 1;
    }

    @Override // org.spongycastle.math.p012ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f10460x);
    }

    public SecP224R1FieldElement() {
        this.f10460x = Nat224.create();
    }
