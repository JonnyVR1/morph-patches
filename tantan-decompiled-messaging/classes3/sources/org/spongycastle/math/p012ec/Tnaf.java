...
class Tnaf {
    ...
    public static byte getMu(ECCurve.AbstractF2m abstractF2m) {
        ...
        ig3.a("No Koblitz curve (ABC), TNAF multiplication not possible");
        return (byte) 0;
    }
    ...
    public static int getShiftsForCofactor(BigInteger bigInteger) {
        ...
        ig3.a("h (Cofactor) must be 2 or 4");
        return 0;
    }

    public static BigInteger[] getSi(ECCurve.AbstractF2m abstractF2m) {
        if (!abstractF2m.isKoblitz()) {
            ig3.a("si is defined for Koblitz curves only");
            return null;
        }
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger bigInteger = zTauElement.f10413u;
        BigInteger bigIntegerMultiply = bigInteger.multiply(bigInteger);
        BigInteger bigIntegerMultiply2 = zTauElement.f10413u.multiply(zTauElement.f10414v);
        BigInteger bigInteger2 = zTauElement.f10414v;
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f10413u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(zTauElementRound.f10414v)), bigIntegerArr[1].multiply(zTauElementRound.f10413u).subtract(bigIntegerArr[0].multiply(zTauElementRound.f10414v)));
    }
    ...
    */
    public static org.spongycastle.math.p012ec.ZTauElement round(org.spongycastle.math.p012ec.SimpleBigDecimal r8, org.spongycastle.math.p012ec.SimpleBigDecimal r9, byte r10) {
        /*
            int r0 = r8.getScale()
            int r1 = r9.getScale()
            r2 = 0
        ...
        L56:
            java.math.BigInteger r9 = org.spongycastle.math.p012ec.ECConstants.ONE
            int r6 = r4.compareTo(r9)
            r7 = 0
            if (r6 < 0) goto L68
            java.math.BigInteger r6 = org.spongycastle.math.p012ec.Tnaf.MINUS_ONE
            int r6 = r5.compareTo(r6)
            if (r6 >= 0) goto L74
            goto L70
        L68:
            java.math.BigInteger r1 = org.spongycastle.math.p012ec.ECConstants.TWO
        ...
        L84:
            ...
            goto L8f
        L86:
            java.math.BigInteger r9 = org.spongycastle.math.p012ec.Tnaf.MINUS_TWO
        ...
        La7:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p012ec.Tnaf.round(org.spongycastle.math.ec.SimpleBigDecimal, org.spongycastle.math.ec.SimpleBigDecimal, byte):org.spongycastle.math.ec.ZTauElement");
    }
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerClearBit = zTauElement.f10413u;
        BigInteger bigInteger = zTauElement.f10414v;
        int i = 0;
        int i2 = 0;
        while (true) {
            BigInteger bigInteger2 = ECConstants.ZERO;
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger bigIntegerAdd = zTauElement.f10413u;
        BigInteger bigIntegerAdd2 = zTauElement.f10414v;
        int i = 0;
        while (true) {
            ...
            if (bigIntegerAdd.testBit(0)) {
                ...
                if (z) {
                    bigIntegerAdd = bigIntegerAdd.subtract(zTauElementArr[bIntValue].f10413u);
                    bigIntegerAdd2 = bigIntegerAdd2.subtract(zTauElementArr[bIntValue].f10414v);
                } else {
                    bigIntegerAdd = bigIntegerAdd.add(zTauElementArr[bIntValue].f10413u);
                    bigIntegerAdd2 = bigIntegerAdd2.add(zTauElementArr[bIntValue].f10414v);
                }
            } else {
                bArr[i] = 0;
            }
