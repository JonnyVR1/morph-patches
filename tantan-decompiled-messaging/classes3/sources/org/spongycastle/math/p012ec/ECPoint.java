...
public abstract class ECPoint {
    ...
    protected ECFieldElement f10410x;

    /* JADX INFO: renamed from: y */
    protected ECFieldElement f10411y;

    /* JADX INFO: renamed from: zs */
    protected ECFieldElement[] f10412zs;
    ...
    public ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f10410x = eCFieldElement;
        this.f10411y = eCFieldElement2;
        this.f10412zs = eCFieldElementArr;
    }
    ...
    public static ECFieldElement[] getInitialZCoords(ECCurve eCCurve) {
        ...
        if (coordinateSystem != 1 && coordinateSystem != 2) {
            ...
            if (coordinateSystem != 6) {
                ig3.a("unknown coordinate system");
                return null;
            }
        }
    ...
    public void checkNormalized() {
        ...
        qkq0.a("point not in normal form");
    }
    ...
    public boolean isInfinity() {
        if (this.f10410x == null || this.f10411y == null) {
            return true;
        }
        ECFieldElement[] eCFieldElementArr = this.f10412zs;
    ...
    public boolean isNormalized() {
        ...
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f10412zs[0].isOne();
    }
    ...
    public ECPoint normalize(ECFieldElement eCFieldElement) {
        ...
        if (curveCoordinateSystem != 1) {
            ...
            if (curveCoordinateSystem != 6) {
                qkq0.a("not a projective coordinate system");
                return null;
            }
        }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f10412zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f10412zs[i]);
        }
        stringBuffer.append(')');
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement4 = this.f10412zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            boolean zIsZero = eCFieldElement.isZero();
            ECFieldElement eCFieldElement5 = this.f10411y;
            if (zIsZero) {
        ...
        public AbstractF2m tau() {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f10411y.square(), new ECFieldElement[]{this.f10412zs[0].square()}, this.withCompression);
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f10411y.square(), this.withCompression);
        }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i), this.f10411y.squarePow(i), new ECFieldElement[]{this.f10412zs[0].squarePow(i)}, this.withCompression);
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i), this.f10411y.squarePow(i), this.withCompression);
        }
    ...
    public static class C1075Fp extends AbstractFp {
        public C1075Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply2 = this.f10410x;
            ECFieldElement eCFieldElementMultiply3 = this.f10411y;
            ECFieldElement eCFieldElementMultiply4 = eCPoint.f10410x;
            ECFieldElement eCFieldElementMultiply5 = eCPoint.f10411y;
            if (coordinateSystem == 0) {
                ...
                return new C1075Fp(curve, eCFieldElementSubtract4, eCFieldElementDivide.multiply(eCFieldElementMultiply2.subtract(eCFieldElementSubtract4)).subtract(eCFieldElementMultiply3), this.withCompression);
            }
            char c = 0;
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply6 = this.f10412zs[0];
                ECFieldElement eCFieldElement = eCPoint.f10412zs[0];
                ...
                return new C1075Fp(curve, eCFieldElementSubtract6.multiply(eCFieldElementSubtract7), eCFieldElementMultiply8.subtract(eCFieldElementSubtract7).multiplyMinusProduct(eCFieldElementSubtract5, eCFieldElementMultiply3, eCFieldElementMultiply7), new ECFieldElement[]{eCFieldElementMultiply7.multiply(eCFieldElementMultiply6)}, this.withCompression);
            }
            ...
            ECFieldElement eCFieldElement3 = this.f10412zs[0];
            ECFieldElement eCFieldElement4 = eCPoint.f10412zs[0];
            ...
            return new C1075Fp(curve, eCFieldElementSubtract, eCFieldElementMultiplyMinusProduct, eCFieldElementArr, this.withCompression);
        }
        ...
        public ECPoint detach() {
            return new C1075Fp(null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        public ECPoint negate() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement = this.f10410x;
            return coordinateSystem != 0 ? new C1075Fp(curve, eCFieldElement, this.f10411y.negate(), this.f10412zs, this.withCompression) : new C1075Fp(curve, eCFieldElement, this.f10411y.negate(), this.withCompression);
        }
        ...
        public ECPoint threeTimes() {
            if (!isInfinity()) {
                ECFieldElement eCFieldElement = this.f10411y;
                if (!eCFieldElement.isZero()) {
                    ...
                    ECFieldElement eCFieldElement2 = this.f10410x;
                    ...
                    return new C1075Fp(curve, eCFieldElementAdd2, eCFieldElement2.subtract(eCFieldElementAdd2).multiply(eCFieldElementSubtract2).subtract(eCFieldElement), this.withCompression);
                }
            }
            return this;
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f10411y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement a = curve.getA();
            ECFieldElement eCFieldElementMultiply = this.f10410x;
            ECFieldElement[] eCFieldElementArr = this.f10412zs;
            int i2 = 0;
            ...
            if (coordinateSystem == 0) {
                ...
                return new C1075Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementSquare2), eCFieldElement.multiply(eCFieldElementSquare2.multiply(eCFieldElementInvert)), this.withCompression);
            }
            if (coordinateSystem == 1) {
                return new C1075Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementFromBigInteger), eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger.multiply(eCFieldElementFromBigInteger.square())}, this.withCompression);
            }
            if (coordinateSystem == 2) {
                return new C1075Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger}, this.withCompression);
            }
            if (coordinateSystem == 4) {
                return new C1075Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a}, this.withCompression);
            }
            qkq0.a("unsupported coordinate system");
            return eCPoint3;
        }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                return new C1075Fp(curve, eCFieldElementSubtract2, eCFieldElementDivide.multiply(eCFieldElement2.subtract(eCFieldElementSubtract2)).subtract(eCFieldElement), this.withCompression);
            }
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement3 = this.f10412zs[0];
                ...
                return new C1075Fp(curve, eCFieldElementMultiply2, eCFieldElementFour2.subtract(eCFieldElementSubtract3).multiply(eCFieldElementAdd).subtract(two(eCFieldElementTwo2.square())), new ECFieldElement[]{two(zIsOne ? two(eCFieldElementTwo2) : eCFieldElementTwo.square()).multiply(eCFieldElementMultiply)}, this.withCompression);
            }
            if (coordinateSystem != 2) {
                if (coordinateSystem == 4) {
            ...
            return new C1075Fp(curve, eCFieldElementSubtract4, eCFieldElementSubtract5, new ECFieldElement[]{eCFieldElementTwo3}, this.withCompression);
        }

        public C1075Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f10410x;
            ECFieldElement eCFieldElement2 = this.f10411y;
            ECFieldElement eCFieldElement3 = this.f10412zs[0];
            ...
            return new C1075Fp(getCurve(), eCFieldElementSubtract, eCFieldElementSubtract2, new ECFieldElement[]{eCFieldElementTwo, eCFieldElementTwo4}, this.withCompression);
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f10410x;
            ECFieldElement eCFieldElement3 = eCPoint.f10410x;
            ECFieldElement eCFieldElement4 = eCPoint.f10411y;
            ...
            return new C1075Fp(curve, eCFieldElementAdd, eCFieldElement2.subtract(eCFieldElementAdd).multiply(eCFieldElementSubtract4).subtract(eCFieldElement), this.withCompression);
        }
        ...
        public C1075Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            this(eCCurve, eCFieldElement, eCFieldElement2, false);
        }

        public C1075Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
            this.withCompression = z;
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        public F2m(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z) {
            ...
            if (eCFieldElement != null) {
                ECFieldElement.F2m.checkFieldElements(this.f10410x, this.f10411y);
                if (eCCurve != null) {
                    ECFieldElement.F2m.checkFieldElements(this.f10410x, this.curve.getA());
                }
            }
            this.withCompression = z;
        }
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f10410x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement3 = this.f10411y;
                ECFieldElement eCFieldElement4 = eCPoint.f10411y;
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement5 = this.f10411y;
                ECFieldElement eCFieldElementMultiply5 = this.f10412zs[0];
                ECFieldElement eCFieldElement6 = eCPoint.f10411y;
                ECFieldElement eCFieldElement7 = eCPoint.f10412zs[0];
            ...
            ECFieldElement eCFieldElement8 = this.f10411y;
            ECFieldElement eCFieldElement9 = this.f10412zs[0];
            ECFieldElement eCFieldElement10 = eCPoint.f10411y;
            ECFieldElement eCFieldElement11 = eCPoint.f10412zs[0];
        ...
        public ECPoint negate() {
            if (!isInfinity()) {
                ...
                if (!eCFieldElement.isZero()) {
                    int curveCoordinateSystem = getCurveCoordinateSystem();
                    if (curveCoordinateSystem == 0) {
                        return new F2m(this.curve, eCFieldElement, this.f10411y.add(eCFieldElement), this.withCompression);
                    }
                    if (curveCoordinateSystem == 1) {
                        return new F2m(this.curve, eCFieldElement, this.f10411y.add(eCFieldElement), new ECFieldElement[]{this.f10412zs[0]}, this.withCompression);
                    }
                    if (curveCoordinateSystem == 5) {
                        return new F2m(this.curve, eCFieldElement, this.f10411y.addOne(), this.withCompression);
                    }
                    if (curveCoordinateSystem != 6) {
                        qkq0.a("unsupported coordinate system");
                        return null;
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f10411y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f10411y;
                ECFieldElement eCFieldElement = this.f10412zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f10410x;
            ECFieldElement eCFieldElement3 = eCPoint.f10412zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f10411y;
            ECFieldElement eCFieldElement5 = this.f10412zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f10411y;
            ECFieldElement eCFieldElementSquare = eCFieldElement.square();
