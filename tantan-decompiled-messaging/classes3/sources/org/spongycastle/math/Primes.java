...
public abstract class Primes {
    ...
    private static void checkCandidate(BigInteger bigInteger, String str) {
        if (bigInteger == null || bigInteger.signum() < 1 || bigInteger.bitLength() < 2) {
            qtc0.a("'", str, "' must be non-null and >= 2");
        }
    }
    ...
    public static MROutput enhancedMRProbablePrimeTest(BigInteger bigInteger, SecureRandom secureRandom, int i) {
        ...
        if (secureRandom == null) {
            ig3.a("'random' cannot be null");
            return null;
        }
        if (i < 1) {
            ig3.a("'iterations' must be > 0");
            return null;
        }
    ...
    public static STOutput generateSTRandomPrime(Digest digest, int i, byte[] bArr) {
        if (digest == null) {
            ig3.a("'hash' cannot be null");
            return null;
        }
        if (i < 2) {
            ig3.a("'length' must be >= 2");
            return null;
        }
        if (bArr != null && bArr.length != 0) {
            return implSTRandomPrime(digest, i, Arrays.clone(bArr));
        }
        ig3.a("'inputSeed' cannot be null or empty");
        return null;
    }
                    ...
                    if (iIntValue4 % 71 != 0 && iIntValue4 % 73 != 0 && iIntValue4 % 79 != 0 && iIntValue4 % 83 != 0) {
                        ...
                        if (iIntValue5 % 89 != 0 && iIntValue5 % 97 != 0 && iIntValue5 % 101 != 0 && iIntValue5 % 103 != 0) {
                            ...
                            if (iIntValue6 % 107 != 0 && iIntValue6 % 109 != 0 && iIntValue6 % 113 != 0 && iIntValue6 % CertificateBody.profileType != 0) {
                                ...
                                if (iIntValue7 % 131 != 0 && iIntValue7 % CipherSuite.TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA != 0 && iIntValue7 % CipherSuite.TLS_PSK_WITH_3DES_EDE_CBC_SHA != 0 && iIntValue7 % CipherSuite.TLS_RSA_PSK_WITH_AES_256_CBC_SHA != 0) {
                                    int iIntValue8 = bigInteger.mod(BigInteger.valueOf(645328247L)).intValue();
                                    if (iIntValue8 % CipherSuite.TLS_DH_DSS_WITH_SEED_CBC_SHA != 0 && iIntValue8 % CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384 != 0 && iIntValue8 % CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 != 0 && iIntValue8 % CipherSuite.TLS_DH_anon_WITH_AES_256_GCM_SHA384 != 0) {
    ...
    private static STOutput implSTRandomPrime(Digest digest, int i, byte[] bArr) {
        ...
        if (i < 33) {
            ...
            qkq0.a("Too many iterations in Shawe-Taylor Random_Prime Routine");
            return null;
        }
    ...
    public static boolean isMRProbablePrimeToBase(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        if (bigInteger2.compareTo(bigInteger.subtract(bigInteger3)) >= 0) {
            ig3.a("'base' must be < ('candidate' - 1)");
            return false;
        }
        if (bigInteger.bitLength() == 2) {
            return true;
