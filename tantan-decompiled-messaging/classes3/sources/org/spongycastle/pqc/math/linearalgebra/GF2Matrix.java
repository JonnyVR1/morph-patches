...
public class GF2Matrix extends Matrix {
    ...
    public GF2Matrix(byte[] bArr) {
        if (bArr.length < 9) {
            lwm.a("given array is not an encoded matrix over GF(2)");
            throw null;
        }
    ...
    public Matrix computeInverse() {
        ...
        if (i != this.numColumns) {
            lwm.a("Matrix is not invertible.");
            return null;
        }
    ...
    public Matrix rightMultiply(Matrix matrix) {
        ...
        if (!(matrix instanceof GF2Matrix)) {
            lwm.a("matrix is not defined over GF(2)");
            return null;
        }
    ...
    public GF2Matrix(int i, int[][] iArr) {
        ...
        lwm.a("Int array does not match given number of columns.");
        throw null;
    }
    ...
    public GF2Matrix(int i, char c, SecureRandom secureRandom) {
        if (i <= 0) {
            lwm.a("Size of matrix is non-positive.");
            throw null;
        }
        if (c == 'I') {
            assignUnitMatrix(i);
