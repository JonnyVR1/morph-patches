...
public abstract class GF2nField {
    ...
    public final GF2nElement convert(GF2nElement gF2nElement, GF2nField gF2nField) throws RuntimeException {
        ...
        if (this.mDegree != gF2nField.mDegree) {
            upk0.m8197a("GF2nField.convert: B1 has a different degree and thus cannot be coverted to!");
            return null;
        }
        ...
        if (!(gF2nField instanceof GF2nONBField)) {
            upk0.m8197a("GF2nField.convert: B1 must be an instance of GF2nPolynomialField or GF2nONBField!");
            return null;
        }
    ...
    public final GF2Polynomial[] invertMatrix(GF2Polynomial[] gF2PolynomialArr) {
        ...
        while (true) {
            ...
            if (i6 >= this.mDegree) {
                upk0.m8197a("GF2nField.invertMatrix: Matrix cannot be inverted!");
                return null;
            }
            if (i != i6) {
