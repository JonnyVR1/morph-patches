...
public class PolynomialGF2mSmallM {
    ...
    public PolynomialGF2mSmallM(GF2mField gF2mField, byte[] bArr) {
        ...
        if (bArr.length % i2 != 0) {
            ig3.a(" Error: byte array is not encoded polynomial over given finite field GF2m");
            throw null;
        }
    ...
    public void multThisWithElement(int i) {
        if (!this.field.isElementOfThisField(i)) {
            lwm.a("Not an element of the finite field this polynomial is defined over.");
        } else {
