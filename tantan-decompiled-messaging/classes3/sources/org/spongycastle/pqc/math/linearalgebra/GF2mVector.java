...
public class GF2mVector extends Vector {
    ...
    public GF2mVector(GF2mField gF2mField, byte[] bArr) {
        ...
        if (bArr.length % i2 != 0) {
            ig3.a("Byte array is not an encoded vector over the given finite field.");
            throw null;
        }
    ...
    public Vector multiply(Permutation permutation) {
        ...
        int i = this.length;
        if (i != vector.length) {
            lwm.a("permutation size and vector size mismatch");
            return null;
        }
        int[] iArr = new int[i];
    ...
    public GF2mVector(GF2mField gF2mField, int[] iArr) {
        ...
        for (int length = iArr.length - 1; length >= 0; length--) {
            if (!gF2mField.isElementOfThisField(iArr[length])) {
                lwm.a("Element array is not specified over the given finite field.");
                throw null;
            }
        }
