...
public class IntegerPolynomial implements Polynomial {
    ...
    public Resultant resultant() {
        ...
        while (true) {
            ...
            BigInteger bigIntegerMod = bigInteger2.multiply(bigIntEuclideanCalculate.f10632x.multiply(bigIntegerNextPrime)).add(modularResultantResultant.res.multiply(bigIntEuclideanCalculate.f10633y.multiply(bigInteger))).mod(bigIntegerMultiply);
