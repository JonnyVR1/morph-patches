...
public class McEliecePublicKey extends ASN1Object {
    ...
    private McEliecePublicKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f10507n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f10508t = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f10507n));
        aSN1EncodableVector.add(new ASN1Integer(this.f10508t));
