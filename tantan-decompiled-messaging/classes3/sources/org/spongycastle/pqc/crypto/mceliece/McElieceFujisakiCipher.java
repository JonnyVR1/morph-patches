...
public class McElieceFujisakiCipher implements MessageEncryptor {
    ...
    private SecureRandom f10540sr;

    /* JADX INFO: renamed from: t */
    private int f10541t;

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        SecureRandom secureRandom = this.f10540sr;
        if (secureRandom == null) {
            secureRandom = new SecureRandom();
        }
        this.f10540sr = secureRandom;
        this.messDigest = mcElieceCCA2PublicKeyParameters.getParameters().getDigest();
        this.f10539n = mcElieceCCA2PublicKeyParameters.getN();
        this.f10538k = mcElieceCCA2PublicKeyParameters.getK();
        this.f10541t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f10540sr = new SecureRandom();
            ...
            this.f10540sr = parametersWithRandom.getRandom();
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f10539n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f10541t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    @Override // org.spongycastle.pqc.crypto.MessageEncryptor
    public byte[] messageDecrypt(byte[] bArr) throws Exception {
        int i = (this.f10539n + 7) >> 3;
        int length = bArr.length - i;
        byte[][] bArrSplit = ByteUtils.split(bArr, i);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f10539n, bArr2));
        ...
        if (Conversions.encode(this.f10539n, this.f10541t, bArr5).equals(gF2Vector)) {
            return bArr4;
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) throws Exception {
        GF2Vector gF2Vector = new GF2Vector(this.f10538k, this.f10540sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f10539n, this.f10541t, bArr2)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
