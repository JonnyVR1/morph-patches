...
public class McEliecePointchevalDigestCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (z && asymmetricKeyParameter.isPrivate()) {
            ig3.a("Encrypting Requires Public Key.");
        } else if (!z && !asymmetricKeyParameter.isPrivate()) {
            ig3.a("Decrypting Requires Private Key.");
        } else {
            reset();
    ...
    public byte[] messageDecrypt(byte[] bArr) {
        if (this.forEncrypting) {
            qkq0.a("McEliecePointchevalDigestCipher not initialised for decrypting.");
            return null;
        }
        try {
    ...
    public byte[] messageEncrypt() {
        if (!this.forEncrypting) {
            qkq0.a("McEliecePointchevalDigestCipher not initialised for encrypting.");
            return null;
        }
