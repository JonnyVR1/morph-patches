...
public class McElieceCCA2KeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        GF2mField gF2mField = new GF2mField(this.f10529m, this.fieldPoly);
        PolynomialGF2mSmallM polynomialGF2mSmallM = new PolynomialGF2mSmallM(gF2mField, this.f10531t, 'I', this.random);
        ...
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new McElieceCCA2PublicKeyParameters(OID, this.f10530n, this.f10531t, gF2Matrix, this.mcElieceCCA2Params.getParameters()), (AsymmetricKeyParameter) new McElieceCCA2PrivateKeyParameters(OID, this.f10530n, gF2Matrix.getNumRows(), gF2mField, polynomialGF2mSmallM, permutation, gF2MatrixCreateCanonicalCheckMatrix, squareRootMatrix, this.mcElieceCCA2Params.getParameters()));
    }
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f10529m = this.mcElieceCCA2Params.getParameters().getM();
        this.f10530n = this.mcElieceCCA2Params.getParameters().getN();
        this.f10531t = this.mcElieceCCA2Params.getParameters().getT();
