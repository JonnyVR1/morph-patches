...
public class ComputeInField {
        ...
        while (i < this.f10621A.length - 1) {
            ...
            while (true) {
                ...
                if (i3 < sArr2.length) {
                    ...
                    if (sInvElem == 0) {
                        upk0.m8197a("Matrix not invertible! We have to choose another one!");
                        return;
                    }
                    for (int i4 = i; i4 < length; i4++) {
                        short sMultElem = GF2Field.multElem(s, GF2Field.multElem(this.f10621A[i][i4], sInvElem));
                        short[] sArr3 = this.f10621A[i3];
    ...
    private void substitute() throws RuntimeException {
        ...
        if (sInvElem == 0) {
            upk0.m8197a("The equation system is not solvable");
            return;
        }
        short[] sArr3 = this.f10622x;
        short[][] sArr4 = this.f10621A;
        sArr3[sArr4.length - 1] = GF2Field.multElem(sArr4[sArr4.length - 1][sArr4.length], sInvElem);
        for (int length = this.f10621A.length - 2; length >= 0; length--) {
            short[][] sArr5 = this.f10621A;
            ...
            while (true) {
                ...
                if (length2 <= length) {
                    ...
                    sAddElem = GF2Field.addElem(sAddElem, GF2Field.multElem(sArr[length][length2], this.f10622x[length2]));
                }
            }
            short sInvElem2 = GF2Field.invElem(sArr[length][length]);
            if (sInvElem2 == 0) {
                upk0.m8197a("Not solvable equation system");
                return;
            }
            this.f10622x[length] = GF2Field.multElem(sAddElem, sInvElem2);
        }
    }

    public short[][] addSquareMatrix(short[][] sArr, short[][] sArr2) {
        if (sArr.length != sArr2.length || sArr[0].length != sArr2[0].length) {
            upk0.m8197a("Addition is not possible!");
            return null;
        }
    ...
    public short[] addVect(short[] sArr, short[] sArr2) {
        if (sArr.length != sArr2.length) {
            upk0.m8197a("Multiplication is not possible!");
            return null;
        }
    ...
    public short[][] inverse(short[][] sArr) {
        ...
        try {
            int i = 0;
            this.f10621A = (short[][]) Array.newInstance((Class<?>) cls, sArr.length, sArr.length * 2);
            if (sArr.length != sArr[0].length) {
                throw new RuntimeException("The matrix is not invertible. Please choose another one!");
            }
            for (int i2 = 0; i2 < sArr.length; i2++) {
                for (int i3 = 0; i3 < sArr.length; i3++) {
                    this.f10621A[i2][i3] = sArr[i2][i3];
                }
                int length = sArr.length;
                while (true) {
    ...
    public short[][] multiplyMatrix(short[][] sArr, short[][] sArr2) throws RuntimeException {
        ...
        this.f10621A = (short[][]) Array.newInstance((Class<?>) Short.TYPE, sArr.length, sArr2[0].length);
        for (int i = 0; i < sArr.length; i++) {
            for (int i2 = 0; i2 < sArr2.length; i2++) {
    ...
    public short[] solveEquation(short[][] sArr, short[] sArr2) {
        try {
            ...
            this.f10621A = (short[][]) Array.newInstance((Class<?>) Short.TYPE, sArr.length, sArr.length + 1);
            this.f10622x = new short[sArr.length];
            for (int i = 0; i < sArr.length; i++) {
                for (int i2 = 0; i2 < sArr[0].length; i2++) {
                    this.f10621A[i][i2] = sArr[i][i2];
                }
            }
