...
public class RainbowSigner implements MessageSigner {
    ...
    private ComputeInField f10619cf = new ComputeInField();
    RainbowKeyParameters key;
    private SecureRandom random;
    int signableDocumentLength;

    /* JADX INFO: renamed from: x */
    private short[] f10620x;

    private short[] initSign(Layer[] layerArr, short[] sArr) {
        short[] sArr2 = new short[sArr.length];
        short[] sArrMultiplyMatrix = this.f10619cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA1(), this.f10619cf.addVect(((RainbowPrivateKeyParameters) this.key).getB1(), sArr));
        for (int i = 0; i < layerArr[0].getVi(); i++) {
            this.f10620x[i] = (short) this.random.nextInt();
            short[] sArr3 = this.f10620x;
    ...
    */
    public byte[] generateSignature(byte[] r14) {
        ...
        L3e:
            ...
            goto L3e
        L4f:
            org.spongycastle.pqc.crypto.rainbow.util.ComputeInField r9 = r13.f10619cf     // Catch: java.lang.Exception -> L24
            r10 = r0[r6]     // Catch: java.lang.Exception -> L24
            short[] r11 = r13.f10620x     // Catch: java.lang.Exception -> L24
        ...
        L60:
            ...
            if (r9 >= r10) goto L73
            short[] r10 = r13.f10620x     // Catch: java.lang.Exception -> L24
        ...
        L7e:
            org.spongycastle.pqc.crypto.rainbow.util.ComputeInField r4 = r13.f10619cf     // Catch: java.lang.Exception -> L24
            ...
            short[] r7 = r13.f10620x     // Catch: java.lang.Exception -> L24
            short[] r4 = r4.addVect(r6, r7)     // Catch: java.lang.Exception -> L24
            org.spongycastle.pqc.crypto.rainbow.util.ComputeInField r6 = r13.f10619cf     // Catch: java.lang.Exception -> L24
