...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public ISO9796d2Signer(AsymmetricBlockCipher asymmetricBlockCipher, Digest digest, boolean z) {
        ...
        if (trailer != null) {
            ...
            kg3.a("no valid trailer for digest: ", digest.getAlgorithmName());
            throw null;
        }
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (i == 188) {
            this.mBuf = new byte[(bArr.length - digest.getDigestSize()) - 2];
        } else {
            this.mBuf = new byte[(bArr.length - digest.getDigestSize()) - 3];
        }
        reset();
    }
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (((bArrProcessBlock[0] & 192) ^ 64) != 0) {
            dql.m3633a("malformed signature");
            return;
        }
        ...
        if (((bArrProcessBlock[bArrProcessBlock.length - 1] & 255) ^ 188) == 0) {
            ...
            if (trailer == null) {
                ig3.a("unrecognised hash in signature");
                return;
            } else if (i2 != trailer.intValue()) {
                f3c.a("signer initialised with wrong digest for trailer ", i2);
                return;
            }
        }
        int i3 = 0;
        ...
        if (length <= 0) {
            dql.m3633a("malformed block");
            return;
        }
        if ((bArrProcessBlock[0] & HttpTokens.SPACE) == 0) {
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (bArr2 == null) {
            ...
            if (!Arrays.areEqual(bArr2, bArr)) {
                qkq0.a("updateWithRecoveredMessage called on different signature");
                return false;
            }
