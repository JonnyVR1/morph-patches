...
public class VMPCMac implements Mac {
    ...
    private byte f10276x1;

    /* JADX INFO: renamed from: x2 */
    private byte f10277x2;

    /* JADX INFO: renamed from: x3 */
    private byte f10278x3;

    /* JADX INFO: renamed from: x4 */
    private byte f10279x4;

    /* JADX INFO: renamed from: n */
    private byte f10274n = 0;

    /* JADX INFO: renamed from: P */
    private byte[] f10271P = null;

    /* JADX INFO: renamed from: s */
    private byte f10275s = 0;

    private void initKey(byte[] bArr, byte[] bArr2) {
        this.f10275s = (byte) 0;
        this.f10271P = new byte[256];
        for (int i = 0; i < 256; i++) {
            this.f10271P[i] = (byte) i;
        }
        for (int i2 = 0; i2 < 768; i2++) {
            byte[] bArr3 = this.f10271P;
            byte b = this.f10275s;
            int i3 = i2 & 255;
            byte b2 = bArr3[i3];
        ...
        for (int i4 = 0; i4 < 768; i4++) {
            byte[] bArr4 = this.f10271P;
            byte b4 = this.f10275s;
            int i5 = i4 & 255;
            byte b5 = bArr4[i5];
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, DataLengthException {
        for (int i2 = 1; i2 < 25; i2++) {
            byte[] bArr2 = this.f10271P;
            byte b = this.f10275s;
            byte b2 = this.f10274n;
            byte b3 = bArr2[(b + bArr2[b2 & 255]) & 255];
            this.f10275s = b3;
            byte b4 = this.f10279x4;
            byte b5 = this.f10278x3;
            byte b6 = bArr2[(b4 + b5 + i2) & 255];
            this.f10279x4 = b6;
            byte b7 = this.f10277x2;
            byte b8 = bArr2[(b5 + b7 + i2) & 255];
            this.f10278x3 = b8;
            byte b9 = this.f10276x1;
            byte b10 = bArr2[(b7 + b9 + i2) & 255];
            this.f10277x2 = b10;
            byte b11 = bArr2[(b9 + b3 + i2) & 255];
            this.f10276x1 = b11;
            byte[] bArr3 = this.f10272T;
            byte b12 = this.f10273g;
            ...
            this.f10273g = (byte) ((b12 + 4) & 31);
            byte b13 = bArr2[b2 & 255];
            bArr2[b2 & 255] = bArr2[b3 & 255];
            bArr2[b3 & 255] = b13;
            this.f10274n = (byte) ((b2 + 1) & 255);
        }
        for (int i3 = 0; i3 < 768; i3++) {
            byte[] bArr4 = this.f10271P;
            byte b14 = this.f10275s;
            int i4 = i3 & 255;
            byte b15 = bArr4[i4];
            byte b16 = bArr4[(b14 + b15 + this.f10272T[i3 & 31]) & 255];
            this.f10275s = b16;
        ...
        for (int i5 = 0; i5 < 20; i5++) {
            byte[] bArr6 = this.f10271P;
            int i6 = i5 & 255;
            byte b17 = bArr6[(this.f10275s + bArr6[i6]) & 255];
            this.f10275s = b17;
    ...
    public void init(CipherParameters cipherParameters) throws IllegalArgumentException {
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ig3.a("VMPC-MAC Init parameters must include an IV");
            return;
        }
        ParametersWithIV parametersWithIV = (ParametersWithIV) cipherParameters;
        KeyParameter keyParameter = (KeyParameter) parametersWithIV.getParameters();
        if (!(parametersWithIV.getParameters() instanceof KeyParameter)) {
            ig3.a("VMPC-MAC Init parameters must include a key");
            return;
        }
        byte[] iv = parametersWithIV.getIV();
        this.workingIV = iv;
        if (iv == null || iv.length < 1 || iv.length > 768) {
            ig3.a("VMPC-MAC requires 1 to 768 bytes of IV");
        } else {
    ...
    public void reset() {
        ...
        this.f10274n = (byte) 0;
        this.f10279x4 = (byte) 0;
        this.f10278x3 = (byte) 0;
        this.f10277x2 = (byte) 0;
        this.f10276x1 = (byte) 0;
        this.f10273g = (byte) 0;
        this.f10272T = new byte[32];
        for (int i = 0; i < 32; i++) {
            this.f10272T[i] = 0;
        }
    }
    ...
    public void update(byte b) throws IllegalStateException {
        byte[] bArr = this.f10271P;
        byte b2 = this.f10275s;
        byte b3 = this.f10274n;
        byte b4 = bArr[(b2 + bArr[b3 & 255]) & 255];
        this.f10275s = b4;
        byte b5 = (byte) (b ^ bArr[(bArr[bArr[b4 & 255] & 255] + 1) & 255]);
        byte b6 = this.f10279x4;
        byte b7 = this.f10278x3;
        byte b8 = bArr[(b6 + b7) & 255];
        this.f10279x4 = b8;
        byte b9 = this.f10277x2;
        byte b10 = bArr[(b7 + b9) & 255];
        this.f10278x3 = b10;
        byte b11 = this.f10276x1;
        byte b12 = bArr[(b9 + b11) & 255];
        this.f10277x2 = b12;
        byte b13 = bArr[(b11 + b4 + b5) & 255];
        this.f10276x1 = b13;
        byte[] bArr2 = this.f10272T;
        byte b14 = this.f10273g;
        ...
        this.f10273g = (byte) ((b14 + 4) & 31);
        byte b15 = bArr[b3 & 255];
        bArr[b3 & 255] = bArr[b4 & 255];
        bArr[b4 & 255] = b15;
        this.f10274n = (byte) ((b3 + 1) & 255);
    }
