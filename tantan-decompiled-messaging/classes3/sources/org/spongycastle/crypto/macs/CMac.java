...
public class CMac implements Mac {
    ...
    public CMac(BlockCipher blockCipher, int i) {
        if (i % 8 != 0) {
            ig3.a("MAC size must be multiple of 8");
            throw null;
        }
        if (i > blockCipher.getBlockSize() * 8) {
            bub.m3170a("MAC size must be less or equal to ", blockCipher.getBlockSize() * 8);
            throw null;
        }
    ...
    private static byte[] lookupPoly(int i) {
        ...
        switch (i2) {
            ...
            case PKIFailureInfo.wrongIntegrity /* 2048 */:
                ...
                break;
            default:
                k250.m5546a("Unknown block size for CMAC: ", i2);
                return null;
        }
    ...
    public void validate(CipherParameters cipherParameters) {
        ...
        ig3.a("CMac mode only permits key to be set.");
    }
