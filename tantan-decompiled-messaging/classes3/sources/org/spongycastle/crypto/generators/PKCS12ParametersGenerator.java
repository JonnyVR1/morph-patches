...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (!(digest instanceof ExtendedDigest)) {
            all.a("Digest ", digest.getAlgorithmName(), " unsupported");
            throw null;
        }
        this.f10239u = digest.getDigestSize();
        this.f10240v = ((ExtendedDigest) digest).getByteLength();
    }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        ...
        int i12 = this.f10240v;
        byte[] bArr10 = new byte[i12];
        int i13 = this.f10239u;
