...
public final class WhirlpoolDigest implements ExtendedDigest, Memoable {
    ...
    private long[] f10110_K;

    /* JADX INFO: renamed from: _L */
    private long[] f10111_L;
    ...
    public WhirlpoolDigest() {
        ...
        obj.f10110_K = new long[8];
        obj.f10111_L = new long[8];
        ...
        while (i < 256) {
            ...
            f10102C0[i] = whirlpoolDigest.packIntoLong(i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4);
            f10103C1[i] = packIntoLong(i4, i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial);
            f10104C2[i] = packIntoLong(iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3);
            f10105C3[i] = packIntoLong(i3, iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3);
            f10106C4[i] = packIntoLong(iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2, i2);
            f10107C5[i] = packIntoLong(i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2, i2, iMaskWithReductionPolynomial2);
            f10108C6[i] = packIntoLong(iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2, i2);
            WhirlpoolDigest whirlpoolDigest2 = this;
            f10109C7[i] = whirlpoolDigest2.packIntoLong(i2, iMaskWithReductionPolynomial2, i2, iMaskWithReductionPolynomial3, i3, iMaskWithReductionPolynomial, i4, i2);
            i++;
        ...
        for (int i5 = 1; i5 <= 10; i5++) {
            int i6 = (i5 - 1) * 8;
            whirlpoolDigest._rc[i5] = (((((((f10102C0[i6] & (-72057594037927936L)) ^ (f10103C1[i6 + 1] & 71776119061217280L)) ^ (f10104C2[i6 + 2] & 280375465082880L)) ^ (f10105C3[i6 + 3] & 1095216660480L)) ^ (f10106C4[i6 + 4] & 4278190080L)) ^ (f10107C5[i6 + 5] & 16711680)) ^ (f10108C6[i6 + 6] & 65280)) ^ (f10109C7[i6 + 7] & 255);
        }
    }
    ...
    public void processBlock() {
        ...
        for (int i2 = 1; i2 <= 10; i2++) {
            ...
            while (true) {
                ...
                jArr[i3] = 0;
                long[] jArr5 = f10102C0;
                long[] jArr6 = this.f10110_K;
                long j3 = jArr5[((int) (jArr6[i3 & 7] >>> 56)) & 255];
                jArr[i3] = j3;
                long j4 = f10103C1[((int) (jArr6[(i3 - 1) & 7] >>> 48)) & 255] ^ j3;
                jArr[i3] = j4;
                long j5 = j4 ^ f10104C2[((int) (jArr6[(i3 - 2) & 7] >>> 40)) & 255];
                jArr[i3] = j5;
                long j6 = j5 ^ f10105C3[((int) (jArr6[(i3 - 3) & 7] >>> 32)) & 255];
                jArr[i3] = j6;
                long j7 = j6 ^ f10106C4[((int) (jArr6[(i3 - 4) & 7] >>> 24)) & 255];
                jArr[i3] = j7;
                long j8 = j7 ^ f10107C5[((int) (jArr6[(i3 - 5) & 7] >>> 16)) & 255];
                jArr[i3] = j8;
                long j9 = j8 ^ f10108C6[((int) (jArr6[(i3 - 6) & 7] >>> 8)) & 255];
                jArr[i3] = j9;
                jArr[i3] = j9 ^ f10109C7[((int) jArr6[(i3 - 7) & 7]) & 255];
                i3++;
            }
            long[] jArr7 = this.f10110_K;
            System.arraycopy(jArr, 0, jArr7, 0, jArr7.length);
            long[] jArr8 = this.f10110_K;
            jArr8[0] = jArr8[0] ^ this._rc[i2];
            int i4 = 0;
            while (true) {
                jArr2 = this.f10111_L;
                if (i4 < 8) {
                    long j10 = this.f10110_K[i4];
                    jArr2[i4] = j10;
                    long[] jArr9 = f10102C0;
                    long[] jArr10 = this._state;
                    long j11 = j10 ^ jArr9[((int) (jArr10[i4 & 7] >>> 56)) & 255];
                    jArr2[i4] = j11;
                    long j12 = j11 ^ f10103C1[((int) (jArr10[(i4 - 1) & 7] >>> 48)) & 255];
                    jArr2[i4] = j12;
                    long j13 = j12 ^ f10104C2[((int) (jArr10[(i4 - 2) & 7] >>> 40)) & 255];
                    jArr2[i4] = j13;
                    long j14 = j13 ^ f10105C3[((int) (jArr10[(i4 - 3) & 7] >>> 32)) & 255];
                    jArr2[i4] = j14;
                    long j15 = j14 ^ f10106C4[((int) (jArr10[(i4 - 4) & 7] >>> 24)) & 255];
                    jArr2[i4] = j15;
                    long j16 = j15 ^ f10107C5[((int) (jArr10[(i4 - 5) & 7] >>> 16)) & 255];
                    jArr2[i4] = j16;
                    long j17 = j16 ^ f10108C6[((int) (jArr10[(i4 - 6) & 7] >>> 8)) & 255];
                    jArr2[i4] = j17;
                    jArr2[i4] = j17 ^ f10109C7[((int) jArr10[(i4 - 7) & 7]) & 255];
                    i4++;
                }
            }
    ...
    public void reset(Memoable memoable) {
        ...
        long[] jArr5 = whirlpoolDigest.f10110_K;
        long[] jArr6 = this.f10110_K;
        System.arraycopy(jArr5, 0, jArr6, 0, jArr6.length);
        long[] jArr7 = whirlpoolDigest.f10111_L;
        long[] jArr8 = this.f10111_L;
    ...
    public void reset() {
        ...
        Arrays.fill(this.f10110_K, 0L);
        Arrays.fill(this.f10111_L, 0L);
    ...
    public WhirlpoolDigest(WhirlpoolDigest whirlpoolDigest) {
        ...
        this.f10110_K = new long[8];
        this.f10111_L = new long[8];
