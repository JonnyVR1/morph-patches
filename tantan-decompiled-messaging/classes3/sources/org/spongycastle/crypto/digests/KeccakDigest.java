...
public class KeccakDigest implements ExtendedDigest {
    ...
    private void init(int i) {
        ...
        if (i == 384) {
            ...
            ig3.a("bitLength must be one of 128, 224, 256, 288, 384, or 512.");
        }
    }

    private void initSponge(int i, int i2) {
        if (i + i2 != 1600) {
            qkq0.a("rate + capacity != 1600");
            return;
        }
        if (i <= 0 || i >= 1600 || i % 64 != 0) {
            qkq0.a("invalid rate value");
            return;
        }
        this.rate = i;
    ...
    private void m9606pi(long[] jArr) {
    ...
    private void theta(long[] jArr) {
        for (int i = 0; i < 5; i++) {
            this.f10004C[i] = 0;
            for (int i2 = 0; i2 < 5; i2++) {
                long[] jArr2 = this.f10004C;
                jArr2[i] = jArr2[i] ^ jArr[(i2 * 5) + i];
            }
        }
        int i3 = 0;
        while (i3 < 5) {
            long[] jArr3 = this.f10004C;
            int i4 = i3 + 1;
            long j = jArr3[i4 % 5];
    ...
    public void absorb(byte[] bArr, int i, long j) {
        if (this.bitsInQueue % 8 != 0) {
            qkq0.a("attempt to absorb with odd length queue.");
            return;
        }
        if (this.squeezing) {
            qkq0.a("attempt to absorb while squeezing.");
            return;
        }
        long j2 = 0;
        while (j2 < j) {
    ...
    public void squeeze(byte[] bArr, int i, long j) {
        ...
        long j2 = 0;
        if (j % 8 != 0) {
            qkq0.a("outputLength not a multiple of 8");
            return;
        }
        while (j2 < j) {
