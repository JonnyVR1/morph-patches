...
public class SHA512Digest extends LongDigest {
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        Pack.longToBigEndian(this.f10012H7, bArr, i + 48);
        Pack.longToBigEndian(this.f10013H8, bArr, i + 56);
        reset();
        return 64;
    }
    ...
    public void reset() {
        super.reset();
        this.f10006H1 = 7640891576956012808L;
        this.f10007H2 = -4942790177534073029L;
        this.f10008H3 = 4354685564936845355L;
        this.f10009H4 = -6534734903238641935L;
        this.f10010H5 = 5840696475078001361L;
        this.f10011H6 = -7276294671716946913L;
        this.f10012H7 = 2270897969802886507L;
        this.f10013H8 = 6620516959819538809L;
    }
