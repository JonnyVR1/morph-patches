...
public class AESEngine implements BlockCipher {
    ...
    private static int FFmulX(int i) {
        return (((i & f10118m1) >>> 7) * 27) ^ ((f10119m2 & i) << 1);
    }
    ...
    private void decryptBlock(int[][] iArr) {
        ...
        int i3 = i ^ iArr2[0];
        int i4 = 1;
        int i5 = this.f10124C1 ^ iArr2[1];
        char c2 = 2;
        int i6 = this.f10125C2 ^ iArr2[2];
        int i7 = i2 - 1;
        int iShift = iArr2[3] ^ this.f10126C3;
        while (i7 > i4) {
            int[] iArr3 = Tinv0;
        ...
        int[] iArr5 = iArr[c5];
        this.f10123C0 = i12 ^ iArr5[c5];
        this.f10124C1 = ((((bArr[iShift10 & 255] & 255) ^ ((bArr[(iShift9 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift12 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift11 >> 24) & 255] << 24)) ^ iArr5[i11];
        this.f10125C2 = ((((bArr[iShift11 & 255] & 255) ^ ((bArr[(iShift10 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift9 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift12 >> 24) & 255] << 24)) ^ iArr5[c6];
        this.f10126C3 = ((((bArr[iShift12 & 255] & 255) ^ ((bArr[(iShift11 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift10 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift9 >> 24) & 255] << 24)) ^ iArr5[3];
    }
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        int i2 = i ^ iArr2[0];
        int i3 = 1;
        int i4 = this.f10124C1 ^ iArr2[1];
        char c2 = 2;
        int i5 = this.f10125C2 ^ iArr2[2];
        int iShift = iArr2[3] ^ this.f10126C3;
        int i6 = 1;
        ...
        int[] iArr5 = iArr[i6 + 1];
        this.f10123C0 = i11 ^ iArr5[c5];
        this.f10124C1 = ((((bArr[iShift10 & 255] & 255) ^ ((bArr[(iShift11 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift12 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift9 >> 24) & 255] << 24)) ^ iArr5[i10];
        this.f10125C2 = ((((bArr[iShift11 & 255] & 255) ^ ((bArr[(iShift12 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift9 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift10 >> 24) & 255] << 24)) ^ iArr5[c6];
        this.f10126C3 = ((((bArr[iShift12 & 255] & 255) ^ ((bArr[(iShift9 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift10 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift11 >> 24) & 255] << 24)) ^ iArr5[3];
    }
    ...
    private void packBlock(byte[] bArr, int i) {
        int i2 = this.f10123C0;
        bArr[i] = (byte) i2;
        bArr[i + 1] = (byte) (i2 >> 8);
        bArr[i + 2] = (byte) (i2 >> 16);
        bArr[i + 3] = (byte) (i2 >> 24);
        int i3 = this.f10124C1;
        bArr[i + 4] = (byte) i3;
        bArr[i + 5] = (byte) (i3 >> 8);
        bArr[i + 6] = (byte) (i3 >> 16);
        bArr[i + 7] = (byte) (i3 >> 24);
        int i4 = this.f10125C2;
        bArr[i + 8] = (byte) i4;
        bArr[i + 9] = (byte) (i4 >> 8);
        bArr[i + 10] = (byte) (i4 >> 16);
        bArr[i + 11] = (byte) (i4 >> 24);
        int i5 = this.f10126C3;
        bArr[i + 12] = (byte) i5;
        bArr[i + 13] = (byte) (i5 >> 8);
    ...
    private void unpackBlock(byte[] bArr, int i) {
        ...
        this.f10125C2 = i10;
        this.f10125C2 = i10 | (bArr[i + 11] << 24);
        ...
        this.f10126C3 = i13;
        this.f10126C3 = (bArr[i + 15] << 24) | i13;
    }
