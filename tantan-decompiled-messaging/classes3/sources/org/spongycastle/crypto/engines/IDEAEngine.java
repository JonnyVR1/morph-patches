...
public class IDEAEngine implements BlockCipher {
    ...
    private void ideaFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i3 < 8) {
            ...
            int i8 = (i5 + iArr[i7 + 1]) & MASK;
            int i9 = (i4 + iArr[i7 + 2]) & MASK;
            int iMul2 = mul(iBytesToWord4, iArr[i7 + 3]);
            int i10 = i7 + 5;
            int iMul3 = mul(i9 ^ iMul, iArr[i7 + 4]);
            i7 += 6;
            int iMul4 = mul(((i8 ^ iMul2) + iMul3) & MASK, iArr[i10]);
            int i11 = MASK & (iMul3 + iMul4);
            i6 = iMul ^ iMul4;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (cipherParameters instanceof KeyParameter) {
            ...
            ig3.a("invalid parameter passed to IDEA init - ".concat(cipherParameters.getClass().getName()));
        }
    }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (iArr == null) {
            qkq0.a("IDEA engine not initialised");
            return 0;
        }
        if (i + 8 > bArr.length) {
