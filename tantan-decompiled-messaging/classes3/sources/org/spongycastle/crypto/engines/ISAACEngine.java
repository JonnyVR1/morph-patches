...
public class ISAACEngine implements StreamCipher {
    ...
    private void isaac() {
        ...
        for (int i3 = 0; i3 < 256; i3++) {
            ...
            if (i5 == 0) {
                int i6 = this.f10182a;
                this.f10182a = i6 ^ (i6 << 13);
            } else if (i5 == 1) {
                int i7 = this.f10182a;
                this.f10182a = i7 ^ (i7 >>> 6);
            } else if (i5 == 2) {
                int i8 = this.f10182a;
                this.f10182a = i8 ^ (i8 << 2);
            } else if (i5 == 3) {
                int i9 = this.f10182a;
                this.f10182a = i9 ^ (i9 >>> 16);
            }
            int i10 = this.f10182a + iArr[(i3 + 128) & 255];
            this.f10182a = i10;
            int i11 = iArr[(i4 >>> 2) & 255] + i10 + this.f10183b;
            iArr[i3] = i11;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (cipherParameters instanceof KeyParameter) {
            ...
            ig3.a("invalid parameter passed to ISAAC init - ".concat(cipherParameters.getClass().getName()));
        }
    }
