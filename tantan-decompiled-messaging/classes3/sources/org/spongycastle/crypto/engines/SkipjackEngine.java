...
public class SkipjackEngine implements BlockCipher {
    ...
    private int m9672g(int i, int i2) {
        int i3 = (i2 >> 8) & 255;
        int i4 = i2 & 255;
        short[] sArr = ftable;
    ...
    private int m9673h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            int i9 = 0;
            while (i9 < 8) {
                int iM9673h = m9673h(i7, i4);
                int i10 = (i5 ^ iM9673h) ^ (i7 + 1);
                i7--;
                i9++;
                int i11 = i6;
                i6 = i3;
    ...
    public int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int i3 = (bArr[i] << 8) + (bArr[i + 1] & 255);
        int iM9672g = (bArr[i + 2] << 8) + (bArr[i + 3] & 255);
        ...
        for (int i7 = 0; i7 < 2; i7++) {
            ...
            while (i10 < 8) {
                int i11 = i6 + 1;
                int i12 = (iM9672g ^ i3) ^ i11;
                i10++;
                iM9672g = m9672g(i6, i3);
                i3 = i5;
                i5 = i4;
                i4 = i12;
                i6 = i11;
        ...
        bArr2[i2] = (byte) (i3 >> 8);
        bArr2[i2 + 1] = (byte) i3;
        bArr2[i2 + 2] = (byte) (iM9672g >> 8);
        bArr2[i2 + 3] = (byte) iM9672g;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            ig3.a("invalid parameter passed to SKIPJACK init - ".concat(cipherParameters.getClass().getName()));
            return;
        }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (this.key1 == null) {
            qkq0.a("SKIPJACK engine not initialised");
            return 0;
        }
        if (i + 8 > bArr.length) {
