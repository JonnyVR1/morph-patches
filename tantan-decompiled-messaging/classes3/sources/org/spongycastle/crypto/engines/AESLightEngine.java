...
public class AESLightEngine implements BlockCipher {
    ...
    private static int FFmulX(int i) {
        return (((i & f10141m1) >>> 7) * 27) ^ ((f10142m2 & i) << 1);
    }
    ...
    private void decryptBlock(int[][] iArr) {
        ...
        int[] iArr2 = iArr[i2];
        int i3 = i ^ iArr2[0];
        int i4 = this.f10147C1 ^ iArr2[1];
        int i5 = this.f10148C2 ^ iArr2[2];
        int i6 = i2 - 1;
        int iInv_mcol = iArr2[3] ^ this.f10149C3;
        while (i6 > 1) {
            byte[] bArr = f10140Si;
        ...
        int[] iArr3 = iArr[0];
        this.f10146C0 = i9 ^ iArr3[0];
        this.f10147C1 = ((((bArr2[iInv_mcol10 & 255] & 255) ^ ((bArr2[(iInv_mcol9 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iInv_mcol12 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iInv_mcol11 >> 24) & 255] << 24)) ^ iArr3[1];
        this.f10148C2 = ((((bArr2[iInv_mcol11 & 255] & 255) ^ ((bArr2[(iInv_mcol10 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iInv_mcol9 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iInv_mcol12 >> 24) & 255] << 24)) ^ iArr3[2];
        this.f10149C3 = ((((bArr2[iInv_mcol12 & 255] & 255) ^ ((bArr2[(iInv_mcol11 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iInv_mcol10 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iInv_mcol9 >> 24) & 255] << 24)) ^ iArr3[3];
    }
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        int[] iArr2 = iArr[0];
        int i2 = i ^ iArr2[0];
        int i3 = this.f10147C1 ^ iArr2[1];
        int i4 = this.f10148C2 ^ iArr2[2];
        int iMcol = iArr2[3] ^ this.f10149C3;
        int i5 = 1;
        ...
        int[] iArr3 = iArr[i5 + 1];
        this.f10146C0 = iArr3[0] ^ i8;
        this.f10147C1 = ((((bArr2[iMcol10 & 255] & 255) ^ ((bArr2[(iMcol11 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iMcol12 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iMcol9 >> 24) & 255] << 24)) ^ iArr3[1];
        this.f10148C2 = ((((bArr2[iMcol11 & 255] & 255) ^ ((bArr2[(iMcol12 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iMcol9 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iMcol10 >> 24) & 255] << 24)) ^ iArr3[2];
        this.f10149C3 = ((((bArr2[iMcol12 & 255] & 255) ^ ((bArr2[(iMcol9 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iMcol10 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iMcol11 >> 24) & 255] << 24)) ^ iArr3[3];
    }
    ...
    private int[][] generateWorkingKey(byte[] bArr, boolean z) {
        ...
        if (length < 16 || length > 32 || (length & 7) != 0) {
            ig3.a("Key length not 128/192/256 bits.");
            return null;
        }
        int i2 = length >> 2;
        this.ROUNDS = i2 + 6;
    ...
    private void packBlock(byte[] bArr, int i) {
        ...
        bArr[i + 6] = (byte) (i3 >> 16);
        bArr[i + 7] = (byte) (i3 >> 24);
        int i4 = this.f10148C2;
        bArr[i + 8] = (byte) i4;
        bArr[i + 9] = (byte) (i4 >> 8);
        bArr[i + 10] = (byte) (i4 >> 16);
        bArr[i + 11] = (byte) (i4 >> 24);
        int i5 = this.f10149C3;
        bArr[i + 12] = (byte) i5;
        bArr[i + 13] = (byte) (i5 >> 8);
    ...
    private void unpackBlock(byte[] bArr, int i) {
        ...
        this.f10148C2 = i10;
        this.f10148C2 = i10 | (bArr[i + 11] << 24);
        ...
        this.f10149C3 = i13;
        this.f10149C3 = (bArr[i + 15] << 24) | i13;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            ig3.a("invalid parameter passed to AES init - ".concat(cipherParameters.getClass().getName()));
        } else {
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (this.WorkingKey == null) {
            qkq0.a("AES engine not initialised");
            return 0;
        }
        if (i + 16 > bArr.length) {
