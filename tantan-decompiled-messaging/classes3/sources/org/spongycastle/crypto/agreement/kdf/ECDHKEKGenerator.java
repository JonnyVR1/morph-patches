...
public class ECDHKEKGenerator implements DigestDerivationFunction {
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        try {
            this.kdf.init(new KDFParameters(this.f9966z, new DERSequence(aSN1EncodableVector).getEncoded(ASN1Encoding.DER)));
            return this.kdf.generateBytes(bArr, i, i2);
        } catch (IOException e) {
            kg3.a("unable to initialise kdf: ", e.getMessage());
            return 0;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        this.f9966z = dHKDFParameters.getZ();
    }
}
