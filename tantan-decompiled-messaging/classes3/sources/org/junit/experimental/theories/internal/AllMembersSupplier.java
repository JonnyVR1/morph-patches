...
public class AllMembersSupplier extends ParameterSupplier {
    ...
    public static class MethodParameterValue extends PotentialAssignment {
        ...
        public Object getValue() throws PotentialAssignment.CouldNotGenerateValueException {
            try {
                ...
                upk0.m8197a("unexpected: getMethods returned an inaccessible method");
                return null;
            } catch (IllegalArgumentException unused2) {
                upk0.m8197a("unexpected: argument length is checked");
                return null;
            } catch (Throwable th) {
    ...
    private Object getStaticFieldValue(Field field) {
        try {
            ...
            upk0.m8197a("unexpected: getFields returned an inaccessible field");
            return null;
        } catch (IllegalArgumentException unused2) {
            upk0.m8197a("unexpected: field from getClass doesn't exist on object");
            return null;
        }
    }
