...
public abstract class DBUnitOperations extends ArrayList<AbstractC0941Op> {
    ...
    public void execute() throws Throwable {
        ...
        try {
            ...
            try {
                ...
                Iterator<AbstractC0941Op> it = iterator();
                while (it.hasNext()) {
    ...
    public static class ClasspathOp extends AbstractC0941Op {
        public ClasspathOp(String str) {
            super(str);
        }

        @Override // org.seamless.util.dbunit.DBUnitOperations.AbstractC0941Op
    ...
    public class FileOp extends AbstractC0941Op {
    ...
    public static abstract class AbstractC0941Op {
        ReplacementDataSet dataSet;
        DatabaseOperation operation;

        public AbstractC0941Op(String str, String str2, DatabaseOperation databaseOperation) {
            try {
        ...
        public AbstractC0941Op(String str, String str2) {
            this(str, str2, DatabaseOperation.CLEAN_INSERT);
        }

        public AbstractC0941Op(String str) {
