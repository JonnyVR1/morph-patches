...
public class DateRange implements Serializable {
    ...
    public static int getDaysInMonth(Date date) {
        ...
        return new int[]{31, year % 4 == 0 && (year % 100 != 0 || year % HttpStatus.BAD_REQUEST_400 == 0) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}[month];
    }
    ...
    public Date getOneDayBeforeStart() {
        ...
        qkq0.a("Can't get day before start date because start date is null");
        return null;
    }
