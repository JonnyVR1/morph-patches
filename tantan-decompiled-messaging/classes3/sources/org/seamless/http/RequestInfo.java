...
public class RequestInfo {
    ...
    public static void dumpRequestHeaders(long j, String str, HttpServletRequest httpServletRequest) {
        ...
        if (headerNames != null) {
            while (headerNames.hasMoreElements()) {
                ...
                log.info(String.format("%s: %s", str2, httpServletRequest.getHeader(str2)));
            }
        }
        log.info("----------------------------------------");
    }
    ...
    public static boolean isJRiverRequest(HttpServletRequest httpServletRequest) {
        return isJRiverRequest(httpServletRequest.getHeader(HttpHeaders.USER_AGENT));
    }

    public static boolean isPS3Request(HttpServletRequest httpServletRequest) {
        return isPS3Request(httpServletRequest.getHeader(HttpHeaders.USER_AGENT), httpServletRequest.getHeader("X-AV-Client-Info"));
    }

    public static boolean isXbox360Request(HttpServletRequest httpServletRequest) {
        return isXbox360Request(httpServletRequest.getHeader(HttpHeaders.USER_AGENT), httpServletRequest.getHeader(HttpHeaders.SERVER));
    }
