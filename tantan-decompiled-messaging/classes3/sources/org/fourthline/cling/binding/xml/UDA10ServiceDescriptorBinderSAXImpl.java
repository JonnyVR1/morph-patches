...
public class UDA10ServiceDescriptorBinderSAXImpl extends UDA10ServiceDescriptorBinderImpl {
    ...
    public static /* synthetic */ class C07751 {
        ...
        static final /* synthetic */ int[] f9532x632136c5;
        ...
        static {
            ...
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.direction.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.relatedStateVariable.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.retval.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.dataType.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.defaultValue.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.allowedValue.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.minimum.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.maximum.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9532x632136c5[Descriptor.Service.ELEMENT.step.ordinal()] = 10;
    ...
    public static class ActionArgumentHandler extends ServiceDescriptorHandler<MutableActionArgument> {
        ...
        public static final Descriptor.Service.ELEMENT f9533EL = Descriptor.Service.ELEMENT.argument;
        ...
        public void endElement(Descriptor.Service.ELEMENT element) throws SAXException {
            int i = C07751.f9532x632136c5[element.ordinal()];
            if (i == 1) {
    ...
    public static class ActionArgumentListHandler extends ServiceDescriptorHandler<List<MutableActionArgument>> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9534EL = Descriptor.Service.ELEMENT.argumentList;
    ...
    public static class ActionHandler extends ServiceDescriptorHandler<MutableAction> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9535EL = Descriptor.Service.ELEMENT.action;
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void endElement(Descriptor.Service.ELEMENT element) throws SAXException {
            if (C07751.f9532x632136c5[element.ordinal()] != 1) {
                return;
            }
            getInstance().name = getCharacters();
        }
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public boolean isLastElement(Descriptor.Service.ELEMENT element) {
            return element.equals(f9535EL);
        }

        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void startElement(Descriptor.Service.ELEMENT element, Attributes attributes) throws SAXException {
            if (element.equals(ActionArgumentListHandler.f9534EL)) {
    ...
    public static class ActionListHandler extends ServiceDescriptorHandler<List<MutableAction>> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9536EL = Descriptor.Service.ELEMENT.actionList;
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public boolean isLastElement(Descriptor.Service.ELEMENT element) {
            return element.equals(f9536EL);
        }

        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void startElement(Descriptor.Service.ELEMENT element, Attributes attributes) throws SAXException {
            if (element.equals(ActionHandler.f9535EL)) {
    ...
    public static class AllowedValueListHandler extends ServiceDescriptorHandler<List<String>> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9537EL = Descriptor.Service.ELEMENT.allowedValueList;
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void endElement(Descriptor.Service.ELEMENT element) throws SAXException {
            if (C07751.f9532x632136c5[element.ordinal()] != 7) {
                return;
            }
    ...
    public static class AllowedValueRangeHandler extends ServiceDescriptorHandler<MutableAllowedValueRange> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9538EL = Descriptor.Service.ELEMENT.allowedValueRange;
        ...
        public void endElement(Descriptor.Service.ELEMENT element) throws SAXException {
            try {
                switch (C07751.f9532x632136c5[element.ordinal()]) {
                    case 8:
    ...
    public static class RootHandler extends ServiceDescriptorHandler<MutableService> {
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void startElement(Descriptor.Service.ELEMENT element, Attributes attributes) throws SAXException {
            if (element.equals(ActionListHandler.f9536EL)) {
                ArrayList arrayList = new ArrayList();
                getInstance().actions = arrayList;
                new ActionListHandler(arrayList, this);
            }
            if (element.equals(StateVariableListHandler.f9540EL)) {
    ...
    public static class StateVariableHandler extends ServiceDescriptorHandler<MutableStateVariable> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9539EL = Descriptor.Service.ELEMENT.stateVariable;
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public boolean isLastElement(Descriptor.Service.ELEMENT element) {
            return element.equals(f9539EL);
        }

        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void startElement(Descriptor.Service.ELEMENT element, Attributes attributes) throws SAXException {
            if (element.equals(AllowedValueListHandler.f9537EL)) {
                ArrayList arrayList = new ArrayList();
                getInstance().allowedValues = arrayList;
                new AllowedValueListHandler(arrayList, this);
            }
            if (element.equals(AllowedValueRangeHandler.f9538EL)) {
    ...
    public static class StateVariableListHandler extends ServiceDescriptorHandler<List<MutableStateVariable>> {
        ...
        /* JADX INFO: renamed from: EL */
        public static final Descriptor.Service.ELEMENT f9540EL = Descriptor.Service.ELEMENT.serviceStateTable;
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public boolean isLastElement(Descriptor.Service.ELEMENT element) {
            return element.equals(f9540EL);
        }

        @Override // org.fourthline.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl.ServiceDescriptorHandler
        public void startElement(Descriptor.Service.ELEMENT element, Attributes attributes) throws SAXException {
            if (element.equals(StateVariableHandler.f9539EL)) {
    ...
    public <S extends Service> S describe(S s, String str) throws ValidationException, DescriptorBindingException {
        ...
        try {
            ...
            pfj0.m6855a("Could not parse service descriptor: ", e2);
            return null;
        }
    }
