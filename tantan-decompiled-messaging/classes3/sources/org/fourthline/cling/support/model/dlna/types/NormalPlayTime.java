...
public class NormalPlayTime {
    ...
    public static /* synthetic */ class C08351 {
        ...
        static final /* synthetic */ int[] f9577x61cef210;
    ...
    public NormalPlayTime(long j, long j2, long j3, long j4) throws InvalidValueException {
        if (j < 0) {
            tn40.m7824a("Invalid parameter hours: ", j);
            throw null;
        }
        if (j2 < 0 || j2 > 59) {
            tn40.m7824a("Invalid parameter minutes: ", j);
            throw null;
        }
        if (j3 < 0 || j3 > 59) {
            tn40.m7824a("Invalid parameter seconds: ", j);
            throw null;
        }
        if (j4 < 0 || j4 > 999) {
            tn40.m7824a("Invalid parameter milliseconds: ", j4);
            throw null;
        }
    ...
    public static NormalPlayTime valueOf(String str) throws InvalidValueException {
        ...
        f0c.m3956a("Can't parse NormalPlayTime: ", str);
        return null;
    }
    ...
    public String getString(Format format) {
        ...
        long j2 = j / 1000;
        long j3 = j % 1000;
        if (C08351.f9577x61cef210[format.ordinal()] != 1) {
            return String.format(Locale.ROOT, "%d.%03d", Long.valueOf(j2), Long.valueOf(j3));
        }
        long j4 = this.milliseconds;
        long seconds = (j4 / 1000) - TimeUnit.MINUTES.toSeconds(j4 / 60000);
        long j5 = this.milliseconds;
        return String.format(Locale.ROOT, "%d:%02d:%02d.%03d", Long.valueOf(j5 / 3600000), Long.valueOf((j5 / 60000) - TimeUnit.HOURS.toMinutes(j5 / 3600000)), Long.valueOf(seconds), Long.valueOf(j3));
    }
    ...
    public void setMilliseconds(long j) {
        if (j >= 0) {
            ...
            tn40.m7824a("Invalid parameter milliseconds: ", j);
        }
    }
