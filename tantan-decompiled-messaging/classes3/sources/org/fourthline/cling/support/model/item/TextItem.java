...
public class TextItem extends Item {
    ...
    public Person[] getContributors() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C0831DC.CONTRIBUTOR.class);
        return (Person[]) propertyValues.toArray(new Person[propertyValues.size()]);
    }

    public String getDate() {
        return (String) getFirstPropertyValue(DIDLObject.Property.C0831DC.DATE.class);
    }

    public String getDescription() {
        return (String) getFirstPropertyValue(DIDLObject.Property.C0831DC.DESCRIPTION.class);
    }
    ...
    public Person getFirstContributor() {
        return (Person) getFirstPropertyValue(DIDLObject.Property.C0831DC.CONTRIBUTOR.class);
    }

    public Person getFirstPublisher() {
        return (Person) getFirstPropertyValue(DIDLObject.Property.C0831DC.PUBLISHER.class);
    }

    public URI getFirstRelation() {
        return (URI) getFirstPropertyValue(DIDLObject.Property.C0831DC.RELATION.class);
    }

    public String getFirstRights() {
        return (String) getFirstPropertyValue(DIDLObject.Property.C0831DC.RIGHTS.class);
    }

    public String getLanguage() {
        return (String) getFirstPropertyValue(DIDLObject.Property.C0831DC.LANGUAGE.class);
    }
    ...
    public Person[] getPublishers() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C0831DC.PUBLISHER.class);
        return (Person[]) propertyValues.toArray(new Person[propertyValues.size()]);
    }
    ...
    public URI[] getRelations() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C0831DC.RELATION.class);
        return (URI[]) propertyValues.toArray(new URI[propertyValues.size()]);
    }

    public String[] getRights() {
        List propertyValues = getPropertyValues(DIDLObject.Property.C0831DC.RIGHTS.class);
    ...
    public TextItem setContributors(Person[] personArr) {
        removeProperties(DIDLObject.Property.C0831DC.CONTRIBUTOR.class);
        for (Person person : personArr) {
            addProperty(new DIDLObject.Property.C0831DC.CONTRIBUTOR(person));
        }
        return this;
    }

    public TextItem setDate(String str) {
        replaceFirstProperty(new DIDLObject.Property.C0831DC.DATE(str));
        return this;
    }

    public TextItem setDescription(String str) {
        replaceFirstProperty(new DIDLObject.Property.C0831DC.DESCRIPTION(str));
        return this;
    }

    public TextItem setLanguage(String str) {
        replaceFirstProperty(new DIDLObject.Property.C0831DC.LANGUAGE(str));
        return this;
    }
    ...
    public TextItem setPublishers(Person[] personArr) {
        removeProperties(DIDLObject.Property.C0831DC.PUBLISHER.class);
        for (Person person : personArr) {
            addProperty(new DIDLObject.Property.C0831DC.PUBLISHER(person));
        }
        return this;
    }
    ...
    public TextItem setRelations(URI[] uriArr) {
        removeProperties(DIDLObject.Property.C0831DC.RELATION.class);
        for (URI uri : uriArr) {
            addProperty(new DIDLObject.Property.C0831DC.RELATION(uri));
        }
        return this;
    }

    public TextItem setRights(String[] strArr) {
        removeProperties(DIDLObject.Property.C0831DC.RIGHTS.class);
        for (String str : strArr) {
            addProperty(new DIDLObject.Property.C0831DC.RIGHTS(str));
        }
        return this;
    }
