...
public enum AVTransportErrorCode {
    TRANSITION_NOT_AVAILABLE(IMediaPlayer.MEDIA_INFO_BUFFERING_START, "The immediate transition from current to desired state not supported"),
    NO_CONTENTS(IMediaPlayer.MEDIA_INFO_BUFFERING_END, "The media does not contain any contents that can be played"),
