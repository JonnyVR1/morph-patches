...
public class DIDLParser extends SAXParser {
    ...
    public abstract class DIDLObjectHandler<I extends DIDLObject> extends SAXParser.Handler<I> {
        ...
        public void endElement(String str, String str2, String str3) throws SAXException {
            super.endElement(str, str2, str3);
            if (DIDLObject.Property.C0831DC.NAMESPACE.URI.equals(str)) {
                ...
                if ("description".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C0831DC.DESCRIPTION(getCharacters()));
                    return;
                }
                if ("publisher".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C0831DC.PUBLISHER(new Person(getCharacters())));
                    return;
                }
                if ("contributor".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C0831DC.CONTRIBUTOR(new Person(getCharacters())));
                    return;
                }
                if ("date".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C0831DC.DATE(getCharacters()));
                    return;
                }
                if ("language".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C0831DC.LANGUAGE(getCharacters()));
                    return;
                } else if ("rights".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C0831DC.RIGHTS(getCharacters()));
                    return;
                } else {
                    if ("relation".equals(str2)) {
                        getInstance().addProperty(new DIDLObject.Property.C0831DC.RELATION(URI.create(getCharacters())));
                        return;
                    }
                    return;
                }
    ...
    public DescMeta createDescMeta(Attributes attributes) {
        ...
        if (attributes.getValue(IjkMediaMeta.IJKM_KEY_TYPE) != null) {
            descMeta.setType(attributes.getValue(IjkMediaMeta.IJKM_KEY_TYPE));
        }
    ...
    public void generateContainer(Container container, Document document, Element element, boolean z) {
        ...
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:title", title, DIDLObject.Property.C0831DC.NAMESPACE.URI);
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:creator", container.getCreator(), DIDLObject.Property.C0831DC.NAMESPACE.URI);
        ...
        appendProperties(document, elementAppendNewElement, container, "dc", DIDLObject.Property.C0831DC.NAMESPACE.class, DIDLObject.Property.C0831DC.NAMESPACE.URI);
        if (z) {
    ...
    public void generateDescMetadata(DescMeta descMeta, Document document, Element element) {
        if (descMeta.getId() == null) {
            ibe.a("Missing id of description metadata: ", descMeta);
            return;
        }
        if (descMeta.getNameSpace() == null) {
            ibe.a("Missing namespace of description metadata: ", descMeta);
            return;
        }
        ...
        if (descMeta.getType() != null) {
            elementAppendNewElement.setAttribute(IjkMediaMeta.IJKM_KEY_TYPE, descMeta.getType());
        }
    ...
    public void generateItem(Item item, Document document, Element element) {
        ...
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:title", title, DIDLObject.Property.C0831DC.NAMESPACE.URI);
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:creator", item.getCreator(), DIDLObject.Property.C0831DC.NAMESPACE.URI);
        ...
        appendProperties(document, elementAppendNewElement, item, "dc", DIDLObject.Property.C0831DC.NAMESPACE.class, DIDLObject.Property.C0831DC.NAMESPACE.URI);
    ...
    public void generateResource(Res res, Document document, Element element) {
        if (res.getValue() == null) {
            ibe.a("Missing resource URI value", res);
            return;
        }
        if (res.getProtocolInfo() == null) {
            ibe.a("Missing resource protocol info: ", res);
            return;
        }
    ...
    public void generateRoot(DIDLContent dIDLContent, Document document, boolean z) {
        ...
        elementCreateElementNS.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:dc", DIDLObject.Property.C0831DC.NAMESPACE.URI);
    ...
    public DIDLContent parseResource(String str) throws Exception {
        ...
        try {
            ...
            return parse(C0944IO.readLines(resourceAsStream));
        } finally {
