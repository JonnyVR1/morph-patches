...
public class UnixCrypt {
    ...
    private static final byte[] f9522IP = {HttpTokens.COLON, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4, 62, 54, 46, 38, 30, 22, 14, 6, 64, 56, 48, 40, HttpTokens.SPACE, 24, Tnaf.POW_2_WIDTH, 8, 57, 49, 41, 33, 25, 17, 9, 1, HttpTokens.SEMI_COLON, 51, 43, 35, 27, 19, 11, 3, 61, 53, 45, 37, 29, 21, HttpTokens.CARRIAGE_RETURN, 5, 63, 55, 47, 39, 31, 23, 15, 7};
    ...
    private static final byte[] CIFP = {1, 2, 3, 4, 17, 18, 19, 20, 5, 6, 7, 8, 21, 22, 23, 24, 9, 10, 11, 12, 25, 26, 27, 28, HttpTokens.CARRIAGE_RETURN, 14, 15, Tnaf.POW_2_WIDTH, 29, 30, 31, HttpTokens.SPACE, 33, 34, 35, 36, 49, 50, 51, 52, 37, 38, 39, 40, 53, 54, 55, 56, 41, 42, 43, 44, 57, HttpTokens.COLON, HttpTokens.SEMI_COLON, 60, 45, 46, 47, 48, 61, 62, 63, 64};
    ...
    static {
        ...
        for (int i13 = 0; i13 < 8; i13++) {
            int i14 = 0;
            while (i14 < 8) {
                int i15 = i14 < 2 ? 0 : f9522IP[ExpandTr[((i13 * 6) + i14) - 2] - 1];
                if (i15 > 32) {
                    i15 -= 32;
                } else if (i15 > 0) {
                    i15--;
        ...
        while (i21 < 8) {
            int i22 = 0;
            while (i22 < i) {
                byte b5 = f9523S[i21][((i22 & 1) << 5) | (((i22 >> 1) & 1) << 3) | (((i22 >> 2) & 1) << 2) | (((i22 >> 3) & 1) << 1) | ((i22 >> 4) & 1) | (((i22 >> 5) & 1) << 4)];
