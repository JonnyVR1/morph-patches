...
public class JarResource extends URLResource {
    ...
    public void copyTo(File file) throws Throwable {
        ...
        if (exists()) {
            ...
            if (iIndexOf < 0) {
                rhg0.a("Not a valid jar url: ".concat(strTrim));
                return;
            }
                ...
                if (!z) {
                    ...
                    if (!nextJarEntry.isDirectory()) {
                        ...
                        try {
                            ...
                            try {
                                C0746IO.copy(jarInputStream, fileOutputStream2);
                                C0746IO.close(fileOutputStream2);
                                ...
                                C0746IO.close(fileOutputStream);
                                throw th;
                            }
                        } catch (Throwable th2) {
                            th = th2;
        ...
        if (!this._urlString.endsWith("!/")) {
            return new FilterInputStream(super.getInputStream()) { // from class: org.eclipse.jetty.util.resource.JarResource.1
                ...
                public void close() throws IOException {
                    ((FilterInputStream) this).in = C0746IO.getClosedStream();
                }
            };
        }
