...
public class ArrayQueue<E> extends AbstractList<E> implements Queue<E> {
    ...
    private E m9555at(int i) {
        return (E) this._elements[i];
    }

    private E dequeue() {
        E eM9555at = m9555at(this._nextE);
    ...
    public E getUnsafe(int i) {
        return m9555at((this._nextE + i) % this._elements.length);
    }
