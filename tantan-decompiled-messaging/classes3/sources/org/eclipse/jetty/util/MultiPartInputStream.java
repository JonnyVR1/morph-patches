...
public class MultiPartInputStream {
    public static final dm10 __DEFAULT_MULTIPART_CONFIG = new dm10(System.getProperty("java.io.tmpdir"));
    protected dm10 _config;
    ...
    public MultiPartInputStream(InputStream inputStream, String str, dm10 dm10Var, File file) {
        this._in = new BufferedInputStream(inputStream);
        this._contentType = str;
        this._config = dm10Var;
        this._contextTmpDir = file;
        if (file == null) {
            this._contextTmpDir = new File(System.getProperty("java.io.tmpdir"));
        }
        if (this._config == null) {
            this._config = new dm10(this._contextTmpDir.getAbsolutePath());
        }
    }
    ...
    public void deleteParts() throws MultiException {
        Collection<l860> parsedParts = getParsedParts();
        MultiException multiException = new MultiException();
        Iterator<l860> it = parsedParts.iterator();
        while (it.hasNext()) {
            try {
    ...
    public Collection<l860> getParsedParts() {
    ...
    public l860 getPart(String str) throws ServletException, IOException {
        parse();
        return (l860) this._parts.getValue(str, 0);
    }
    ...
    public void parse() throws ServletException, IOException {
        ...
        if (this._config.b() == null || "".equals(this._config.b())) {
            this._tmpDir = this._contextTmpDir;
        } else {
            File file = new File(this._config.b());
            if (file.isAbsolute()) {
                this._tmpDir = file;
            } else {
                this._tmpDir = new File(this._contextTmpDir, this._config.b());
            }
        }
        ...
        String str4 = line == null ? null : new String(line, StringUtil.__UTF8);
        if (str4 == null || !str4.equals(string)) {
            rhg0.a("Missing initial multi part boundary");
            return;
        }
        boolean z3 = false;
        long length = 0;
        ...
        loop0: while (!z3) {
            ...
            while (true) {
                ...
                if (this._config.d() > 0 && length > this._config.d()) {
                    throw new IllegalStateException("Request exceeds maxRequestSize (" + this._config.d() + ")");
                }
                String str8 = new String(line2, StringUtil.__UTF8);
            ...
            if (str5 == null) {
                rhg0.a("Missing content-disposition");
                return;
            }
            QuotedStringTokenizer quotedStringTokenizer = new QuotedStringTokenizer(str5, ";");
            boolean z6 = false;
                ...
                if ("base64".equalsIgnoreCase(str6)) {
                    ...
                    this._in = new FilterInputStream(this._in) { // from class: org.eclipse.jetty.util.MultiPartInputStream.1
                        ...
                        public int read() throws IOException {
                            ...
                            rhg0.a("Unexpected end to quoted-printable byte");
                            return 0;
                        }
                    };
                }
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (i5 != -1) {
                            try {
                                j++;
                                if (this._config.d() > 0 && j > this._config.d()) {
                                    throw new IllegalStateException("Request exceeds maxRequestSize (" + this._config.d() + ")");
                                }
                                int i6 = 13;
                                if (i5 != 13) {
    ...
    public class MultiPart implements l860 {
        ...
        public void write(byte[] bArr, int i, int i2) throws IOException {
            if (MultiPartInputStream.this._config.c() > 0 && this._size + ((long) i2) > MultiPartInputStream.this._config.c()) {
                r2j.a("Multipart Mime part ", this._name, " exceeds max filesize");
                return;
            }
            if (MultiPartInputStream.this._config.a() > 0 && this._size + ((long) i2) > MultiPartInputStream.this._config.a() && this._file == null) {
                createFile();
            }
        ...
        public void write(int i) throws IOException {
            if (MultiPartInputStream.this._config.c() > 0 && this._size + 1 > MultiPartInputStream.this._config.c()) {
                r2j.a("Multipart Mime part ", this._name, " exceeds max filesize");
                return;
            }
            if (MultiPartInputStream.this._config.a() > 0 && this._size + 1 > MultiPartInputStream.this._config.a() && this._file == null) {
                createFile();
            }
            this._out.write(i);
            this._size++;
