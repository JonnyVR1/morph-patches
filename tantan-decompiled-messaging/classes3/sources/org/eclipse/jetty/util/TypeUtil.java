...
public class TypeUtil {
    ...
    public static int f9519CR = 13;

    /* JADX INFO: renamed from: LF */
    public static int f9520LF = 10;
    ...
    public static byte convertHexDigit(byte b) {
        ...
        kg3.a("!hex:", Integer.toHexString(b & 255));
        return (byte) 0;
    }
    ...
    public static byte[] readLine(InputStream inputStream) throws IOException {
        ...
        if (i == f9519CR && inputStream.available() >= 1 && inputStream.markSupported()) {
            inputStream.mark(1);
            if (inputStream.read() != f9520LF) {
                inputStream.reset();
            }
        }
