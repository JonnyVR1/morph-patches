...
public class GzipHandler extends HandlerWrapper {
    ...
    public void handle(String str, Request request, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        if (header == null || header.indexOf(HttpHeaderValues.GZIP) < 0 || httpServletResponse.containsHeader(HttpHeaders.CONTENT_ENCODING) || HttpMethods.HEAD.equalsIgnoreCase(httpServletRequest.getMethod())) {
