...
public class ServletContextHandler extends ContextHandler {
    ...
    public ake0.a dynamicHolderAdded(ServletHolder servletHolder) {
    ...
    public Set<String> setServletSecurity(ake0.a aVar, ike0 ike0Var) {
        Collection mappings = aVar.getMappings();
        if (mappings != null) {
            Iterator it = mappings.iterator();
            while (it.hasNext()) {
                Iterator<ConstraintMapping> it2 = ConstraintSecurityHandler.createConstraintsWithMappingsForPath(aVar.getName(), (String) it.next(), ike0Var).iterator();
                while (it2.hasNext()) {
    ...
    public class Context extends ContextHandler.Context {
        ...
        public yji.a addFilter(String str, Class<? extends jii> cls) throws Throwable {
        ...
        @Override // org.eclipse.jetty.server.handler.ContextHandler.Context
        public ake0.a addServlet(String str, Class<? extends tje0> cls) throws Throwable {
            if (!ServletContextHandler.this.isStarting()) {
                ohg0.a();
                return null;
            }
        ...
        @Override // org.eclipse.jetty.server.handler.ContextHandler.Context
        public yji.a addFilter(String str, String str2) throws Throwable {
            if (!ServletContextHandler.this.isStarted()) {
                if (this._enabled) {
                    ServletHandler servletHandler = ServletContextHandler.this.getServletHandler();
                    FilterHolder filter = servletHandler.getFilter(str);
        ...
        @Override // org.eclipse.jetty.server.handler.ContextHandler.Context
        public ake0.a addServlet(String str, String str2) throws Throwable {
            if (ServletContextHandler.this.isStarting()) {
                if (this._enabled) {
                    ServletHandler servletHandler = ServletContextHandler.this.getServletHandler();
                    ServletHolder servlet = servletHandler.getServlet(str);
        ...
        @Override // org.eclipse.jetty.server.handler.ContextHandler.Context
        public yji.a addFilter(String str, jii jiiVar) throws Throwable {
            if (!ServletContextHandler.this.isStarted()) {
                if (this._enabled) {
                    ServletHandler servletHandler = ServletContextHandler.this.getServletHandler();
                    FilterHolder filter = servletHandler.getFilter(str);
        ...
        @Override // org.eclipse.jetty.server.handler.ContextHandler.Context
        public ake0.a addServlet(String str, tje0 tje0Var) throws Throwable {
            if (ServletContextHandler.this.isStarting()) {
                if (this._enabled) {
                    ServletHandler servletHandler = ServletContextHandler.this.getServletHandler();
                    ServletHolder servlet = servletHandler.getServlet(str);
