...
import org.eclipse.jetty.p004io.WriterOutputStream;
...
public class DefaultServlet extends HttpServlet implements ResourceFactory {
        ...
        try {
            try {
                if (!z3) {
                    ...
                    headers = httpServletRequest.getHeaders(HttpHeaders.RANGE);
                            ...
                            if (resource5 != null || !resource5.exists()) {
                                ...
                                if (!zEndsWith || (strAddPaths.length() == 1 && httpServletRequest.getAttribute("org.eclipse.jetty.server.nullPathInfo") != null)) {
                                    ...
                                    synchronized (requestURL) {
                                        try {
                                            int iLastIndexOf = requestURL.lastIndexOf(";");
                                            if (iLastIndexOf < 0) {
                                                requestURL.append('/');
                                            } else {
                                    ...
                                    if (welcomeFile != null) {
                                        ...
                                        if (this._redirectWelcome) {
                                            ...
                                            ytc0 requestDispatcher = httpServletRequest.getRequestDispatcher(welcomeFile);
    ...
    public String getInitParameter(String str) {
        ...
        return initParameter == null ? super/*javax.servlet.GenericServlet*/.getInitParameter(str) : initParameter;
    }
    ...
    public void init() throws UnavailableException {
        vje0 servletContext = getServletContext();
        ...
        if (!zIsAliases && !FileResource.getCheckAliases()) {
            qkq0.a("Alias checking disabled");
            return;
        }
        if (zIsAliases) {
    ...
    public ContextHandler initContextHandler(vje0 vje0Var) {
        if (ContextHandler.getCurrentContext() != null) {
            return ContextHandler.getCurrentContext().getContextHandler();
        }
        if (vje0Var instanceof ContextHandler.Context) {
            return ((ContextHandler.Context) vje0Var).getContextHandler();
        }
        StringBuilder sb = new StringBuilder("The servletContext ");
        sb.append(vje0Var);
        String name = vje0Var.getClass().getName();
    ...
    public void sendData(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, boolean z, Resource resource, HttpContent httpContent, Enumeration enumeration) throws IOException {
        ...
        zje0 zje0Var = writerOutputStream;
        if (enumeration == null || !enumeration.hasMoreElements() || contentLength < 0) {
            if (z) {
                resource.writeTo(zje0Var, 0L, contentLength);
                return;
            }
            if (httpContent == null || zIsWritten || !(zje0Var instanceof HttpOutput)) {
                ...
                if (indirectBuffer != null) {
                    indirectBuffer.writeTo(zje0Var);
                    return;
                } else {
                    resource.writeTo(zje0Var, 0L, contentLength);
                    return;
            ...
            if (httpServletResponse instanceof Response) {
                ...
                ((AbstractHttpConnection.Output) zje0Var).sendContent(httpContent);
                return;
            }
            ...
            if (directBuffer != null) {
                ...
                ((AbstractHttpConnection.Output) zje0Var).sendContent(directBuffer);
                return;
            } else {
                writeHeaders(httpServletResponse, httpContent, contentLength);
                resource.writeTo(zje0Var, 0L, contentLength);
        ...
        if (listSatisfiableRanges.size() == 1) {
            ...
            resource.writeTo(zje0Var, inclusiveByteRange.getFirst(contentLength), size);
            return;
        }
        writeHeaders(httpServletResponse, httpContent, -1L);
        String string = httpContent.getContentType().toString();
        MultiPartOutputStream multiPartOutputStream2 = new MultiPartOutputStream(zje0Var);
        httpServletResponse.setStatus(HttpStatus.PARTIAL_CONTENT_206);
        ...
        while (i3 < listSatisfiableRanges.size()) {
            ...
            if (inputStream != null) {
                ...
                C0746IO.copy(inputStream, multiPartOutputStream2, size2);
                j = first + size2;
    ...
    public void sendDirectory(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Resource resource, String str) throws IOException {
        ...
        if (listHTML == null) {
            httpServletResponse.sendError(HttpStatus.FORBIDDEN_403, "No directory");
            return;
        }
    ...
    public void writeHeaders(HttpServletResponse httpServletResponse, HttpContent httpContent, long j) throws IOException {
        ...
        if (!(httpServletResponse instanceof Response)) {
            ...
            if (jLastModified >= 0) {
                httpServletResponse.setDateHeader(HttpHeaders.LAST_MODIFIED, jLastModified);
            }
            if (j != -1) {
                if (j < 2147483647L) {
    ...
    public void writeOptionHeaders(HttpServletResponse httpServletResponse) throws IOException {
        ...
        if (byteArrayBuffer != null) {
            httpServletResponse.setHeader(HttpHeaders.CACHE_CONTROL, byteArrayBuffer.toString());
        }
    }
