...
import org.eclipse.jetty.p004io.BufferDateCache;
...
public class HttpFields {
    ...
    public static class DateGenerator {
        ...
        private final GregorianCalendar f9512gc;

        private DateGenerator() {
            this.buf = new StringBuilder(32);
            this.f9512gc = new GregorianCalendar(HttpFields.__GMT);
        }

        public void formatCookieDate(StringBuilder sb, long j) {
            this.f9512gc.setTimeInMillis(j);
            int i = this.f9512gc.get(7);
            int i2 = this.f9512gc.get(5);
            int i3 = this.f9512gc.get(2);
            int i4 = this.f9512gc.get(1) % 10000;
        ...
        public String formatDate(long j) {
            ...
            int i2 = this.f9512gc.get(5);
            int i3 = this.f9512gc.get(2);
            int i4 = this.f9512gc.get(1);
            int i5 = this.f9512gc.get(11);
            int i6 = this.f9512gc.get(12);
            int i7 = this.f9512gc.get(13);
    ...
    static {
        ...
        __cacheSize = Integer.getInteger("org.eclipse.jetty.http.HttpFields.CACHE", ijkMediaStreamer.MEDIA_RECORDER_TRACK_INFO_LIST_END).intValue();
    ...
    public long getDateField(String str) {
        ...
        ig3.a("Cannot convert date: ".concat(strValueParameters));
        return 0L;
    }
    ...
    public Enumeration<String> getValues(String str) {
        ...
        return field == null ? Collections.enumeration(Collections.EMPTY_LIST) : new Enumeration<String>(field) { // from class: org.eclipse.jetty.http.HttpFields.4
            ...
            @Override // java.util.Enumeration
            public boolean hasMoreElements() {
                return this.f9510f != null;
            }

            @Override // java.util.Enumeration
            public String nextElement() throws NoSuchElementException {
                Field field2 = this.f9510f;
                if (field2 != null) {
                    this.f9510f = field2._next;
    ...
    public Enumeration<String> getValues(Buffer buffer) {
        ...
        return new Enumeration<String>(field) { // from class: org.eclipse.jetty.http.HttpFields.5
            ...
            @Override // java.util.Enumeration
            public String nextElement() throws NoSuchElementException {
                Field field2 = this.f9511f;
                if (field2 != null) {
                    this.f9511f = field2._next;
                    return field2.getValue();
                }
                lmr.a();
                return null;
