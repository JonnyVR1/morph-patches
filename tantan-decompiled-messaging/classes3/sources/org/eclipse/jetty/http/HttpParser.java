...
import org.eclipse.jetty.p004io.bio.StreamEndPoint;
                                    ...
                                    if (b4 != 9 && b4 != 32 && b4 != 58) {
                                        if (this._cached != null || this._tok0.length() > 0 || this._tok1.length() > 0 || this._multiLineValue != null) {
                                            ...
                                            if (ordinal < 0) {
                                                ...
                                                if (ordinal2 == -1) {
                                                    for (String str : byteArrayBuffer.toString().split(",")) {
                                        ...
                                        int i14 = j4 > 2147483647L ? Integer.MAX_VALUE : (int) j4;
                                        if (i14 == -2) {
                                            this._state = 3;
                                            this._handler.headerComplete();
                                        } else if (i14 == -1) {
