...
public class MimeTypes {
    ...
    public static String getCharsetFromContentType(Buffer buffer) {
                ...
                switch (c) {
                    ...
                    case '\n':
                        if ((!z && (59 == bPeek || 32 == bPeek)) || (z && 34 == bPeek)) {
                            return CACHE.lookup(buffer.peek(i, index - i)).toString(StringUtil.__UTF8);
                        }
                        break;
                        break;
                    default:
        ...
        return c == '\n' ? CACHE.lookup(buffer.peek(i, index - i)).toString(StringUtil.__UTF8) : (String) __encodings.get(buffer);
    }
