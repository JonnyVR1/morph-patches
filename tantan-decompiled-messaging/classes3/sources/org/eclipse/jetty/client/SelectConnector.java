...
import org.eclipse.jetty.p004io.nio.SslConnection;
...
class SelectConnector extends AggregateLifeCycle implements HttpClient.Connector, Dumpable {
    ...
    public class Manager extends SelectorManager {
        ...
        public void connectionFailed(SocketChannel socketChannel, Throwable th, Object obj) throws InterruptedException, IOException {
