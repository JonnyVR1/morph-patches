...
public abstract class SecurityHandler extends HandlerWrapper implements Authenticator.AuthConfiguration {
    ...
    public static /* synthetic */ class C07124 {
    ...
    public boolean checkSecurity(Request request) {
        int i = C07124.$SwitchMap$javax$servlet$DispatcherType[request.getDispatcherType().ordinal()];
        if (i == 1 || i == 2) {
            return true;
        }
    ...
    public void doStart() throws Exception {
        ...
        if (currentContext != null) {
            ...
            currentContext.getContextHandler().addEventListener(new wkl() { // from class: org.eclipse.jetty.security.SecurityHandler.1
        ...
        if (this._loginService != null) {
            ...
            if (identityService == null) {
                ...
                rkq0.a("LoginService has different IdentityService to ", this);
                return;
            }
        }
        ...
        if (authenticator2 != null) {
            ...
            qkq0.a("No ServerAuthentication");
            return;
        }
        super.doStart();
    }
    ...
    public void handle(String str, Request request, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Throwable {
        ...
        if (!checkUserDataPermissions(str, request, response, objPrepareConstraintInfo)) {
            ...
            httpServletResponse3.sendError(HttpStatus.FORBIDDEN_403);
                ...
                try {
                    if (authentication instanceof Authentication.ResponseSent) {
                                ...
                                try {
                                    ...
                                    if (authenticator != null) {
                                        try {
                                            ...
                                            httpServletResponse2.sendError(HttpStatus.INTERNAL_SERVER_ERROR_500, e.getMessage());
                        ...
                        if (zIsAuthMandatory && !checkWebResourcePermissions(str, request, response, objPrepareConstraintInfo, user.getUserIdentity())) {
                            httpServletResponse2.sendError(HttpStatus.FORBIDDEN_403, "!role");
                            request.setHandled(true);
