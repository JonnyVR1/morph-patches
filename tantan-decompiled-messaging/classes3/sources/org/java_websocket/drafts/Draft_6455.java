...
public class Draft_6455 extends Draft {
    ...
    private ByteBuffer createByteBufferFromFramedata(Framedata framedata) {
        ...
        if (i == 1) {
            ...
            if (i != 8) {
                upk0.m8197a("Size representation not supported/specified");
                return null;
            }
    ...
    private byte fromOpcode(Framedata.Opcode opcode) {
        ...
        C0637x1.m8688a("Don't know how to handle ", opcode);
        return (byte) 0;
    }
    ...
    public ClientHandshakeBuilder postProcessHandshakeRequestAsClient(ClientHandshakeBuilder clientHandshakeBuilder) {
        ...
        clientHandshakeBuilder.put(HttpHeaders.CONNECTION, "Upgrade");
