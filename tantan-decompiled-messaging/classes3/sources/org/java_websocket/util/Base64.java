...
public class Base64 {
    ...
    public static int decode4to3(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        int i5;
        if (bArr == null) {
            ig3.a("Source array was null.");
            return 0;
        }
        if (bArr2 == null) {
            ig3.a("Destination array was null.");
            return 0;
        }
    ...
    public static byte[] encodeBytesToBytes(byte[] bArr, int i, int i2, int i3) throws Throwable {
        ...
        if (bArr2 == null) {
            ig3.a("Cannot serialize a null array.");
            return null;
        }
        if (i < 0) {
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void flushBase64() throws IOException {
            ...
            if (i > 0) {
                if (!this.encode) {
                    ...
                    ((FilterOutputStream) this).out.write(Base64.encode3to4(this.f9586b4, this.buffer, i, this.options));
                    this.position = 0;
                }
            }
        }
        ...
        public void write(int i) throws IOException {
            ...
            if (this.encode) {
                ...
                if (i3 >= i4) {
                    ((FilterOutputStream) this).out.write(Base64.encode3to4(this.f9586b4, bArr, i4, this.options));
            ...
            bArr2[i6] = (byte) i;
            if (i7 >= this.bufferLength) {
                ((FilterOutputStream) this).out.write(this.f9586b4, 0, Base64.decode4to3(bArr2, 0, this.f9586b4, 0, this.options));
                this.position = 0;
            }
        }
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) throws IOException {
        ...
        ig3.a("Cannot decode null source array.");
        return null;
    }
