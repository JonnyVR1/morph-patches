...
public class CombinableMatcher<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    public static final class CombinableEitherMatcher<X> {
        ...
        public CombinableMatcher<X> m9581or(Matcher<? super X> matcher) {
            return new CombinableMatcher(this.first).m9580or(matcher);
        }
    }
    ...
    /* JADX INFO: renamed from: or */
    public CombinableMatcher<T> m9580or(Matcher<? super T> matcher) {
