...
public class TantanException {
    ...
    public static class ServerException extends ApiExcep.Server {
        ...
        public ServerException(exc0 exc0Var, int i, Meta meta) {
            super(exc0Var);
            this.code = i;
            this.meta = meta;
        }
    ...
    public static class Client {
        ...
        public static class CoreService extends ApiExcep.Client.BadRequest {
            ...
            public CoreService(exc0 exc0Var, Meta meta) {
                String str = meta.message;
                super(exc0Var, str == null ? "no message" : str);
                this.code = meta.code;
        ...
        public static class AccountService extends ApiExcep.Client.BadRequest {
            ...
            /* JADX WARN: Illegal instructions before constructor call */
            public AccountService(exc0 exc0Var, AccountErrorResponse accountErrorResponse) {
        ...
        public static class TantanForbidden extends ApiExcep.Client.Forbidden {
            ...
            public TantanForbidden(exc0 exc0Var, Meta meta) {
                super(exc0Var);
            ...
            public TantanForbidden(exc0 exc0Var) {
                super(exc0Var);
                this.hasHandle = false;
            }
        }
