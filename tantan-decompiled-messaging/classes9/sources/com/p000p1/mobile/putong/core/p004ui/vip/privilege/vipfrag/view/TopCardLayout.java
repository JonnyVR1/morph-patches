package com.p000p1.mobile.putong.core.p004ui.vip.privilege.vipfrag.view;
...
public final class TopCardLayout extends LinearLayout {
    ...
    public static final int f7610g = t100.m;
    ...
    public static final int f7613j;

    /* JADX INFO: renamed from: k */
    public static final int f7614k;
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\t\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0005\u001a\u00020\u00048\u0006X\u0086D¢\u0006\f\n\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\bR\u001a\u0010\t\u001a\u00020\u00048\u0006X\u0086D¢\u0006\f\n\u0004\b\t\u0010\u0006\u001a\u0004\b\n\u0010\bR\u0017\u0010\u000b\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u000b\u0010\u0006\u001a\u0004\b\f\u0010\b¨\u0006\r"}, d2 = {"Lcom/p1/mobile/putong/core/ui/vip/privilege/vipfrag/view/TopCardLayout$a;", "", "<init>", "()V", "", "itemSideMargin", "I", "c", "()I", "itemMargin", "a", "itemNewPadding", "b", "b_core_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public final int m10938a() {
            return TopCardLayout.f7611h;
        }

        /* JADX INFO: renamed from: b */
        public final int m10939b() {
            return TopCardLayout.f7614k;
        }

        /* JADX INFO: renamed from: c */
        public final int m10940c() {
            return TopCardLayout.f7610g;
        }
    ...
    @Metadata(d1 = {"\u0000\u001f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J'\u0010\b\u001a\u00020\u00072\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\n\u001a\u00020\u00072\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u0017\u0010\r\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\r\u0010\u000b¨\u0006\u000e"}, d2 = {"com/p1/mobile/putong/core/ui/vip/privilege/vipfrag/view/TopCardLayout$b", "Landroidx/viewpager/widget/ViewPager$j;", "", "position", "", "positionOffset", "positionOffsetPixels", "", "onPageScrolled", "(IFI)V", "onPageSelected", "(I)V", "state", "onPageScrollStateChanged", "b_core_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class C0449b implements ViewPager.j {

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ VSegmentBar f7622b;

        /* JADX INFO: renamed from: c */
        public final /* synthetic */ BounceBackViewPager f7623c;

        public C0449b(VSegmentBar vSegmentBar, BounceBackViewPager bounceBackViewPager) {
            this.f7622b = vSegmentBar;
            this.f7623c = bounceBackViewPager;
        }

        public void onPageScrollStateChanged(int state) {
            if (state == 0) {
                VSegmentBar vSegmentBar = this.f7622b;
                vSegmentBar.selectTab(vSegmentBar.getTabAt(this.f7623c.getCurrentItem()));
            }
        }
        ...
        public void onPageSelected(int position) {
            ...
            if (bottomContentInterface != null) {
                bottomContentInterface.mo13455a(position);
            }
            TopCardLayout.this.m10937h(position);
        }
    }
    ...
    public TopCardLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m10934a(layoutInflaterA, this);
        setOrientation(1);
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m10934a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewB = mti0.b(this, inflater, parent);
        viewB.getClass();
        return viewB;
    }

    /* JADX INFO: renamed from: f */
    public final void m10935f(@NotNull ArrayList<PurchaseType> purchaseTypes) {
        View view;
        purchaseTypes.getClass();
        getTopcardAdapter().m19016s(purchaseTypes);
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (tabAt != null && (view = tabAt.view) != null) {
                xdl0.D0(bhl0.f8907b, new View[]{view});
            }
        }
    }

    /* JADX INFO: renamed from: g */
    public final void m10936g(@NotNull PutongFrag frag, @NotNull VSegmentBar _tab_layout) {
        frag.getClass();
        _tab_layout.getClass();
        setFrag(frag);
        setTabLayout(_tab_layout);
        setTopcardAdapter(new lti0(frag));
        float pageWidth = (((getTopcardAdapter().getPageWidth(0) * xdl0.y0()) - (f7610g + f7611h)) * 13.0f) / 32.0f;
        ...
        bounceBackViewPager.setPageMargin(-f7612i);
        bounceBackViewPager.setOffscreenPageLimit(3);
        bounceBackViewPager.setAdapter(getTopcardAdapter());
        bounceBackViewPager.d(new C0449b(_tab_layout, bounceBackViewPager));
        get_indicator().c(get_viewpager(), get_viewpager().getCurrentItem());
        m10937h(get_viewpager().getCurrentItem());
    }
    ...
    /* JADX INFO: renamed from: h */
    public final void m10937h(int position) {
        int color;
        int color2 = Color.parseColor("#15000000");
        if (ahl0.m11842t0(PurchaseType.TYPE_YOUTH_VIP, position)) {
            color = Color.parseColor("#BCE46A");
        } else if (ahl0.m11842t0(PurchaseType.TYPE_FEMALE_VIP, position)) {
            color = Color.parseColor("#F482CE");
        } else if (ahl0.m11842t0(PurchaseType.TYPE_GET_VIP, position)) {
            color = Color.parseColor("#E9B48E");
        } else if (ahl0.m11842t0(PurchaseType.TYPE_GET_PRIVILEGE_PACKAGE, position)) {
            color = Color.parseColor("#FF9B38");
        } else if (ahl0.m11842t0(PurchaseType.TYPE_O_DIAMOND, position)) {
            if (g6a.m15592o()) {
        ...
        } else if (ahl0.m11842t0(PurchaseType.TYPE_O_PLATINUM, position)) {
            color = Color.parseColor("#656F7B");
        } else if (ahl0.m11842t0(PurchaseType.TYPE_SUPREME_PARTNER, position)) {
