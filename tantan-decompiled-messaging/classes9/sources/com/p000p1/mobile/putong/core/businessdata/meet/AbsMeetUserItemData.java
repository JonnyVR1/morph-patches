...
public abstract class AbsMeetUserItemData extends AbsMeetListData {
    ...
    public boolean isLocalLikersUser() {
        return TEnum.equals(this.item.type, FeedType.get("localLikersUser"));
    }

    public boolean isLowSeeSingleUser() {
        return TEnum.equals(this.item.type, FeedType.get("lowSeeUser"));
    }
    ...
    public boolean isMomentBeLikeUser() {
        return TEnum.equals(this.item.type, FeedType.get("momentBeLikeUser"));
    }

    public boolean isMomentLikeUser() {
        return TEnum.equals(this.item.type, FeedType.get("momentLikeUser"));
    }

    public boolean isPicksUser() {
        return TEnum.equals(this.item.type, FeedType.get("pickUser")) || TEnum.equals(this.item.type, FeedType.get("pickMoment"));
    }

    public boolean isSeePortraitUser() {
        return TEnum.equals(this.item.type, FeedType.get("seePortraitUser"));
    }
