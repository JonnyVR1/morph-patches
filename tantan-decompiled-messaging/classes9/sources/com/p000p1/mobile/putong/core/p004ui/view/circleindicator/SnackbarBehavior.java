...
public class SnackbarBehavior extends CoordinatorLayout.c<BaseCircleIndicator> {
    ...
    public final float m9653a(CoordinatorLayout coordinatorLayout, BaseCircleIndicator baseCircleIndicator) {
        List dependencies = coordinatorLayout.getDependencies(baseCircleIndicator);
    ...
    public boolean onDependentViewChanged(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BaseCircleIndicator baseCircleIndicator, @NonNull View view) {
        baseCircleIndicator.setTranslationY(m9653a(coordinatorLayout, baseCircleIndicator));
        return true;
    }
