...
@DebugMetadata(c = "com.p1.mobile.putong.core.ui.superlikeopt.upgrade.SuperLikeComboAnimView$doReceiveAnim$1$1", f = "SuperLikeComboAnimView.kt", l = {198}, m = "invokeSuspend", v = 1)
final class SuperLikeComboAnimView$doReceiveAnim$1$1 extends SuspendLambda implements Function2<ppb, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.p1.mobile.putong.core.ui.superlikeopt.upgrade.SuperLikeComboAnimView$doReceiveAnim$1$1$1", f = "SuperLikeComboAnimView.kt", l = {192, 193}, m = "invokeSuspend", v = 1)
    public static final class C03411 extends SuspendLambda implements Function2<fri<? super Integer>, Continuation<? super Unit>, Object> {
        ...
        public C03411(int i, boolean z, int i2, Continuation<? super C03411> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03411 c03411 = new C03411(this.$received, this.$isFemale, this.$frameDuration, continuation);
            c03411.L$0 = obj;
            return c03411;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:30:0x00a8, code lost:
            ...
            if (kotlinx.coroutines.DelayKt.b(r7, r9) == r1) goto L31;
         */
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r10) {
            ...
            Lad:
                ...
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p000p1.mobile.putong.core.p004ui.superlikeopt.upgrade.SuperLikeComboAnimView$doReceiveAnim$1$1.C03411.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    @DebugMetadata(c = "com.p1.mobile.putong.core.ui.superlikeopt.upgrade.SuperLikeComboAnimView$doReceiveAnim$1$1$2", f = "SuperLikeComboAnimView.kt", l = {}, m = "invokeSuspend", v = 1)
    public static final class C03422 extends SuspendLambda implements Function2<Integer, Continuation<? super Unit>, Object> {
        /* synthetic */ int I$0;
        int label;
        final /* synthetic */ SuperLikeComboAnimView this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C03422(SuperLikeComboAnimView superLikeComboAnimView, Continuation<? super C03422> continuation) {
            super(2, continuation);
            this.this$0 = superLikeComboAnimView;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03422 c03422 = new C03422(this.this$0, continuation);
            c03422.I$0 = ((Number) obj).intValue();
            return c03422;
        }
    ...
    @DebugMetadata(c = "com.p1.mobile.putong.core.ui.superlikeopt.upgrade.SuperLikeComboAnimView$doReceiveAnim$1$1$3", f = "SuperLikeComboAnimView.kt", l = {}, m = "invokeSuspend", v = 1)
    public static final class C03433 extends SuspendLambda implements Function3<fri<? super Integer>, Throwable, Continuation<? super Unit>, Object> {
        int label;

        public C03433(Continuation<? super C03433> continuation) {
            super(3, continuation);
        }

        public final Object invoke(fri<? super Integer> friVar, Throwable th, Continuation<? super Unit> continuation) {
            return new C03433(continuation).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final class C0344a<T> implements fri {
        public static final C0344a<T> INSTANCE = new C0344a<>();

        /* JADX INFO: renamed from: a */
        public final Object m9193a(int i, Continuation<? super Unit> continuation) {
            return Unit.INSTANCE;
        }

        public /* bridge */ /* synthetic */ Object emit(Object obj, Continuation continuation) {
            return m9193a(((Number) obj).intValue(), continuation);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            eri eriVarF = jri.f(jri.E(jri.w(new C03411(this.$received, this.$isFemale, 17, null)), new C03422(this.this$0, null)), new C03433(null));
            fri friVar = C0344a.INSTANCE;
            this.I$0 = 17;
            this.label = 1;
            if (eriVarF.collect(friVar, this) == objE) {
                return objE;
            }
        } else {
            if (i != 1) {
