...
public abstract class AbstractC0397a extends eb2 {
    ...
    public final FrameLayout m9979p(@NotNull ViewGroup container, int position) {
        container.getClass();
        FrameLayout frameLayout = new FrameLayout(this.context);
        if (position == 0) {
            IntlTopCardLayout.Companion companion = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion.m9978b(), 0, companion.m9977a(), 0);
        } else if (position == getCount() - 1) {
            IntlTopCardLayout.Companion companion2 = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion2.m9977a(), 0, companion2.m9978b(), 0);
        } else {
            IntlTopCardLayout.Companion companion3 = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion3.m9977a(), 0, companion3.m9977a(), 0);
        }
        container.addView(frameLayout, new ViewGroup.LayoutParams(-1, -2));
        return mo9981r(frameLayout, position);
    }

    @NotNull
    /* JADX INFO: renamed from: r */
    public abstract FrameLayout mo9981r(@NotNull FrameLayout container, int position);
}
