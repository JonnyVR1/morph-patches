...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b3\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\r\u001a\u00020\f2\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\fH\u0014¢\u0006\u0004\b\u000f\u0010\u0010J\r\u0010\u0011\u001a\u00020\f¢\u0006\u0004\b\u0011\u0010\u0010J\u0015\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0012\u001a\u00020\u0006¢\u0006\u0004\b\u0013\u0010\u0014R\"\u0010\u0019\u001a\u00020\n8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\r\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u000eR\"\u0010 \u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0013\u0010\u001b\u001a\u0004\b\u001c\u0010\u001d\"\u0004\b\u001e\u0010\u001fR\"\u0010'\u001a\u00020!8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0011\u0010\"\u001a\u0004\b#\u0010$\"\u0004\b%\u0010&R\"\u0010+\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b(\u0010\u001b\u001a\u0004\b)\u0010\u001d\"\u0004\b*\u0010\u001fR\"\u0010/\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b,\u0010\u001b\u001a\u0004\b-\u0010\u001d\"\u0004\b.\u0010\u001fR\"\u00103\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b0\u0010\u001b\u001a\u0004\b1\u0010\u001d\"\u0004\b2\u0010\u001fR\"\u00107\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b4\u0010\u001b\u001a\u0004\b5\u0010\u001d\"\u0004\b6\u0010\u001fR\"\u0010;\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b8\u0010\u001b\u001a\u0004\b9\u0010\u001d\"\u0004\b:\u0010\u001fR\"\u0010?\u001a\u00020!8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b<\u0010\"\u001a\u0004\b=\u0010$\"\u0004\b>\u0010&R\"\u0010C\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b@\u0010\u001b\u001a\u0004\bA\u0010\u001d\"\u0004\bB\u0010\u001fR\"\u0010G\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\bD\u0010\u001b\u001a\u0004\bE\u0010\u001d\"\u0004\bF\u0010\u001fR\"\u0010K\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\bH\u0010\u001b\u001a\u0004\bI\u0010\u001d\"\u0004\bJ\u0010\u001fR\"\u0010O\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\bL\u0010\u001b\u001a\u0004\bM\u0010\u001d\"\u0004\bN\u0010\u001fR\"\u0010S\u001a\u00020\u001a8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\bP\u0010\u001b\u001a\u0004\bQ\u0010\u001d\"\u0004\bR\u0010\u001f¨\u0006T"}, d2 = {"Lcom/p1/mobile/putong/core/ui/superlikeopt/upgrade/ComboNumView;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Landroid/view/View;", "view", "", "a", "(Landroid/view/View;)V", "onFinishInflate", "()V", "c", "num", "b", "(I)V", "Landroid/view/View;", "get_white_bg", "()Landroid/view/View;", "set_white_bg", "_white_bg", "Landroid/widget/ImageView;", "Landroid/widget/ImageView;", "get_nums", "()Landroid/widget/ImageView;", "set_nums", "(Landroid/widget/ImageView;)V", "_nums", "Landroid/widget/LinearLayout;", "Landroid/widget/LinearLayout;", "get_digits_bg", "()Landroid/widget/LinearLayout;", "set_digits_bg", "(Landroid/widget/LinearLayout;)V", "_digits_bg", "d", "get_digits_bg_thousands_bg", "set_digits_bg_thousands_bg", "_digits_bg_thousands_bg", "e", "get_digits_bg_hundreds_bg", "set_digits_bg_hundreds_bg", "_digits_bg_hundreds_bg", "f", "get_digits_bg_tens_bg", "set_digits_bg_tens_bg", "_digits_bg_tens_bg", "g", "get_digits_bg_ones_bg", "set_digits_bg_ones_bg", "_digits_bg_ones_bg", "h", "get_digits_bg_plus_bg", "set_digits_bg_plus_bg", "_digits_bg_plus_bg", "i", "get_digits", "set_digits", "_digits", "j", "get_digits_thousands", "set_digits_thousands", "_digits_thousands", "k", "get_digits_hundreds", "set_digits_hundreds", "_digits_hundreds", "l", "get_digits_tens", "set_digits_tens", "_digits_tens", "m", "get_digits_ones", "set_digits_ones", "_digits_ones", "n", "get_digits_plus", "set_digits_plus", "_digits_plus", "member_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class ComboNumView extends FrameLayout {
    ...
    public final void m9162a(View view) {
        pe5.a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m9163b(int num) {
        C0346a.Companion companion = C0346a.INSTANCE;
        if (num <= companion.m9211a().size()) {
            xdl0.M(get_nums(), true);
            xdl0.M(get_digits_bg(), false);
            xdl0.M(get_digits(), false);
            Integer num2 = companion.m9211a().get(Integer.valueOf(num));
            if (num2 != null) {
                get_nums().setImageResource(num2.intValue());
            }
            get_white_bg().getLayoutParams().width = t100.o;
            return;
        }
        xdl0.M(get_nums(), false);
        xdl0.M(get_digits_bg(), true);
        xdl0.M(get_digits(), true);
        ...
        if (num > 0) {
            ...
            xdl0.M(get_digits_ones(), true);
            xdl0.M(get_digits_bg_ones_bg(), true);
            xdl0.V(get_digits_ones(), 0);
            xdl0.V(get_digits_bg_ones_bg(), 0);
            C0346a.Companion companion2 = C0346a.INSTANCE;
            Integer num3 = companion2.m9213c().get(Integer.valueOf(iIntValue));
            if (num3 != null) {
                get_digits_ones().setImageResource(num3.intValue());
            }
            Integer num4 = companion2.m9212b().get(Integer.valueOf(iIntValue));
            if (num4 != null) {
                get_digits_bg_ones_bg().setImageResource(num4.intValue());
            }
            if (!(num / 10 > 0)) {
                xdl0.M(get_digits_tens(), false);
                xdl0.M(get_digits_bg_tens_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = t100.d(47.0f);
            int iIntValue2 = ((Number) arrayList.get(1)).intValue();
            xdl0.M(get_digits_tens(), true);
            xdl0.M(get_digits_bg_tens_bg(), true);
            xdl0.V(get_digits_tens(), 0);
            xdl0.V(get_digits_bg_tens_bg(), 0);
            xdl0.V(get_digits_ones(), t100.d(-13.0f));
            xdl0.V(get_digits_bg_ones_bg(), t100.d(-13.0f));
            Integer num5 = companion2.m9213c().get(Integer.valueOf(iIntValue2));
            if (num5 != null) {
                get_digits_tens().setImageResource(num5.intValue());
            }
            Integer num6 = companion2.m9212b().get(Integer.valueOf(iIntValue2));
            if (num6 != null) {
                get_digits_bg_tens_bg().setImageResource(num6.intValue());
            }
            if (!(num / 100 > 0)) {
                xdl0.M(get_digits_hundreds(), false);
                xdl0.M(get_digits_bg_hundreds_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = t100.d(74.0f);
            int iIntValue3 = ((Number) arrayList.get(2)).intValue();
            xdl0.M(get_digits_hundreds(), true);
            xdl0.M(get_digits_bg_hundreds_bg(), true);
            xdl0.V(get_digits_hundreds(), 0);
            xdl0.V(get_digits_bg_hundreds_bg(), 0);
            xdl0.V(get_digits_tens(), t100.d(-13.0f));
            xdl0.V(get_digits_bg_tens_bg(), t100.d(-13.0f));
            Integer num7 = companion2.m9213c().get(Integer.valueOf(iIntValue3));
            if (num7 != null) {
                get_digits_hundreds().setImageResource(num7.intValue());
            }
            Integer num8 = companion2.m9212b().get(Integer.valueOf(iIntValue3));
            if (num8 != null) {
                get_digits_bg_hundreds_bg().setImageResource(num8.intValue());
            }
            if (!(num / AccountMakeUpMenuView.MakeupCategory.TYPE_MAKEUP_BEAUTYAUTO > 0)) {
                xdl0.M(get_digits_thousands(), false);
                xdl0.M(get_digits_bg_thousands_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = t100.d(101.0f);
            int iIntValue4 = ((Number) arrayList.get(3)).intValue();
            xdl0.M(get_digits_thousands(), true);
            xdl0.M(get_digits_bg_thousands_bg(), true);
            xdl0.V(get_digits_thousands(), 0);
            xdl0.V(get_digits_bg_thousands_bg(), 0);
            xdl0.V(get_digits_hundreds(), t100.d(-13.0f));
            xdl0.V(get_digits_bg_hundreds_bg(), t100.d(-13.0f));
            Integer num9 = companion2.m9213c().get(Integer.valueOf(iIntValue4));
            if (num9 != null) {
                get_digits_thousands().setImageResource(num9.intValue());
            }
            Integer num10 = companion2.m9212b().get(Integer.valueOf(iIntValue4));
            if (num10 != null) {
                get_digits_bg_thousands_bg().setImageResource(num10.intValue());
            }
            if (!(num / 10000 > 0)) {
                xdl0.M(get_digits_plus(), false);
                xdl0.M(get_digits_bg_plus_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = t100.d(128.0f);
            xdl0.M(get_digits_plus(), true);
            xdl0.M(get_digits_bg_plus_bg(), true);
            get_digits_plus().setImageResource(b3c0.G2);
            get_digits_bg_thousands_bg().setImageResource(b3c0.F2);
        }
    }

    /* JADX INFO: renamed from: c */
    public final void m9164c() {
        Integer num = C0346a.INSTANCE.m9211a().get(1);
        if (num != null) {
        ...
        Iterator it = ViewGroupKt.b(get_digits_bg()).iterator();
        while (it.hasNext()) {
            xdl0.M((View) it.next(), false);
        }
        Iterator it2 = ViewGroupKt.b(get_digits()).iterator();
        while (it2.hasNext()) {
            xdl0.M((View) it2.next(), false);
        }
    }
    ...
    public final ImageView get_digits_bg_hundreds_bg() {
        ...
        Intrinsics.r("_digits_bg_hundreds_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_ones_bg() {
        ...
        Intrinsics.r("_digits_bg_ones_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_plus_bg() {
        ...
        Intrinsics.r("_digits_bg_plus_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_tens_bg() {
        ...
        Intrinsics.r("_digits_bg_tens_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_thousands_bg() {
        ...
        Intrinsics.r("_digits_bg_thousands_bg");
        return null;
    }
    ...
    public final ImageView get_digits_thousands() {
        ...
        Intrinsics.r("_digits_thousands");
        return null;
    }
