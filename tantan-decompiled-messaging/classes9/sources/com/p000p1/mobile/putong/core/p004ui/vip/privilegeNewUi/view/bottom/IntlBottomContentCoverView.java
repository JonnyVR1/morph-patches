...
public final class IntlBottomContentCoverView extends FrameLayout {
    ...
    public IntlBottomContentCoverView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m11178a(layoutInflaterA, this);
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m11178a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewB = b3n.b(this, inflater, parent);
        viewB.getClass();
        return viewB;
    }

    /* JADX INFO: renamed from: b */
    public final void m11179b(float alpha) {
