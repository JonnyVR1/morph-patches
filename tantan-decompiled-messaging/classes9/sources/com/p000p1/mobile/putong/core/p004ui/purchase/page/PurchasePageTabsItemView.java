...
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\t\u0018\u00002\u00020\u00012\u00020\u0002B\u001d\b\u0007\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\n\u001a\u00020\tH\u0014¢\u0006\u0004\b\n\u0010\u000bJ%\u0010\u0012\u001a\u00020\t2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\u0011\u001a\u00020\u0010¢\u0006\u0004\b\u0012\u0010\u0013J\u0015\u0010\u0015\u001a\u00020\t2\u0006\u0010\u0014\u001a\u00020\u000e¢\u0006\u0004\b\u0015\u0010\u0016J\r\u0010\u0017\u001a\u00020\u0002¢\u0006\u0004\b\u0017\u0010\u0018J\u0017\u0010\u0019\u001a\u00020\t2\u0006\u0010\u000f\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u0019\u0010\u0016J\u0017\u0010\u001c\u001a\u00020\t2\u0006\u0010\u001b\u001a\u00020\u001aH\u0002¢\u0006\u0004\b\u001c\u0010\u001dJ\u0017\u0010\u001e\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u000eH\u0002¢\u0006\u0004\b\u001e\u0010\u001fR\"\u0010&\u001a\u00020 8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0019\u0010!\u001a\u0004\b\"\u0010#\"\u0004\b$\u0010%R\u0016\u0010\u000f\u001a\u00020\u000e8\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u001c\u0010'R\u0016\u0010\u0011\u001a\u00020\u00108\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0012\u0010(¨\u0006)"}, d2 = {"Lcom/p1/mobile/putong/core/ui/purchase/page/PurchasePageTabsItemView;", "Landroid/widget/FrameLayout;", "Lcom/p1/mobile/putong/core/ui/purchase/page/PurchasePageTabsContainerView$a;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", "onFinishInflate", "()V", "", "position", "Lcom/p1/mobile/putong/core/data/PurchaseType;", "purchaseType", "", "multiTabs", "c", "(ILcom/p1/mobile/putong/core/data/PurchaseType;Z)V", "currentPurchaseType", "d", "(Lcom/p1/mobile/putong/core/data/PurchaseType;)V", "getTabSelectChangeListeners", "()Lcom/p1/mobile/putong/core/ui/purchase/page/PurchasePageTabsContainerView$a;", "a", "Landroid/view/View;", "view", "b", "(Landroid/view/View;)V", "e", "(Lcom/p1/mobile/putong/core/data/PurchaseType;)I", "Lv/VText;", "Lv/VText;", "get_title", "()Lv/VText;", "set_title", "(Lv/VText;)V", "_title", "Lcom/p1/mobile/putong/core/data/PurchaseType;", "Z", "pay_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class PurchasePageTabsItemView extends FrameLayout implements PurchasePageTabsContainerView.InterfaceC0220a {
    ...
    @Override // com.p000p1.mobile.putong.core.p004ui.purchase.page.PurchasePageTabsContainerView.InterfaceC0220a
    /* JADX INFO: renamed from: a */
    public void mo7508a(@NotNull PurchaseType purchaseType) {
        purchaseType.getClass();
        m7511d(purchaseType);
    }

    /* JADX INFO: renamed from: b */
    public final void m7509b(View view) {
        w5b0.a(this, view);
    }

    /* JADX INFO: renamed from: c */
    public final void m7510c(int position, @NotNull PurchaseType purchaseType, boolean multiTabs) {
        String str;
        purchaseType.getClass();
        ...
        vText.setText(str);
        get_title().setTextColor(m7512e(purchaseType));
        if (multiTabs) {
            ...
            if (position == 0) {
                ...
                layoutParams2.rightMargin = t100.o;
            } else {
                layoutParams2.gravity = 8388611;
                layoutParams2.leftMargin = t100.o;
            }
    ...
    public final void m7511d(@NotNull PurchaseType currentPurchaseType) {
        int i;
        ...
        if (purchaseType == currentPurchaseType) {
            ...
            if (sab0.x(purchaseType2)) {
                ...
                if (sab0.g(purchaseType3)) {
                    i = d3c0.n7;
                } else if (sab0.i(currentPurchaseType)) {
                    i = d3c0.o7;
                } else {
                    i = sab0.q(currentPurchaseType) ? d3c0.p7 : d3c0.q7;
                }
            }
            if (this.multiTabs) {
        ...
        get_title().setTextColor(m7512e(currentPurchaseType));
    }

    /* JADX INFO: renamed from: e */
    public final int m7512e(PurchaseType currentPurchaseType) {
        if (!this.multiTabs) {
            return sab0.i(currentPurchaseType) ? Color.parseColor("#CCFFDEA2") : getResources().getColor(b1c0.g);
        }
        PurchaseType purchaseType = this.purchaseType;
        if (purchaseType == null) {
            Intrinsics.r("purchaseType");
        ...
        if (currentPurchaseType != purchaseType) {
            return getResources().getColor(b1c0.k);
        }
        if (sab0.i(currentPurchaseType)) {
            return Color.parseColor("#CCFFDEA2");
        }
        return sab0.q(currentPurchaseType) ? getResources().getColor(b1c0.U) : Color.parseColor("#D3804B");
    }

    @NotNull
    public final PurchasePageTabsContainerView.InterfaceC0220a getTabSelectChangeListeners() {
        return this;
    }
