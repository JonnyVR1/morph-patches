...
public class ImFlowView extends ViewGroup {
    ...
    public ImFlowView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f6545c = t100.d(8.0f);
        this.f6546d = t100.d(8.0f);
        this.f6547e = t100.d(8.0f);
        this.f6548f = false;
        this.f6549g = -1;
        this.f6550h = false;
        this.f6543a = context;
        this.f6544b = attributeSet;
    }

    /* JADX INFO: renamed from: b */
    public final /* synthetic */ void m9541b(List list, View view) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.f6550h) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                if (i5 < childAt.getMeasuredWidth() + paddingLeft + getPaddingRight()) {
                    ...
                    paddingTop = paddingTop + this.f6546d + iMax;
                    iMax = 0;
                }
                measuredWidth = childAt.getMeasuredWidth() + paddingLeft;
                childAt.layout(paddingLeft, paddingTop, childAt.getMeasuredWidth() + paddingLeft, childAt.getMeasuredHeight() + paddingTop);
                paddingLeft = paddingLeft + childAt.getMeasuredWidth() + this.f6547e;
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (i5 < childAt2.getMeasuredWidth() + paddingLeft + getPaddingRight()) {
                i7++;
                paddingLeft = getPaddingLeft();
                if (this.f6550h && i7 < arrayList.size()) {
                    paddingLeft += ((Integer) arrayList.get(i7)).intValue();
                }
                paddingTop = paddingTop + this.f6546d + iMax2;
                iMax2 = 0;
            }
            if (this.f6550h && i8 == 0) {
                paddingLeft += ((Integer) arrayList.get(i7)).intValue();
            ...
            paddingLeft = paddingLeft + childAt2.getMeasuredWidth() + this.f6547e;
    ...
    public void setOnChildClick(InterfaceC0364a interfaceC0364a) {
    }
    ...
    public void setTags(final List<View> list) {
        ...
        for (View view : list) {
            addView(view);
            if (this.f6548f) {
                xdl0.E0(view, new View.OnClickListener() { // from class: l.pdm
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        this.f18693a.m9541b(list, view2);
                    }
                });
            }
        }
