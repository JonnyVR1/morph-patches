...
public final class IntlPersonalDetailsAct extends PutongAct {
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J!\u0010\t\u001a\u00020\b2\b\u0010\u0005\u001a\u0004\u0018\u00010\u00042\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lcom/p1/mobile/putong/core/ui/settings/IntlPersonalDetailsAct$a;", "", "<init>", "()V", "Landroid/content/Context;", "context", "", "from", "Landroid/content/Intent;", "a", "(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;", "b_core_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public final Intent m8369a(@Nullable Context context, @Nullable String from) {
    ...
    public void initDataOnCreate() {
        ...
        intlPersonalDetailsPresenter.C(htoVar);
    }
    ...
    public void initSubscription() {
        ...
        intlPersonalDetailsPresenter.m9037a0();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 532) {
            ...
            intlPersonalDetailsPresenter.m9034F0(user);
        }
    ...
    public void preCreateView(@Nullable Bundle sis) {
        ...
        intlPersonalDetailsPresenter.m9042t0(getIntent().getStringExtra("from"));
    }
}
