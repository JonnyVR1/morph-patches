...
public final class TabLayoutScrollBehavior extends CoordinatorLayout.c<View> {
    ...
    public static int f7601b = t100.i;
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\"\u0010\u0005\u001a\u00020\u00048\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lcom/p1/mobile/putong/core/ui/vip/privilege/vipfrag/behavior/TabLayoutScrollBehavior$a;", "", "<init>", "()V", "", "alphaShowMargin", "I", "a", "()I", "setAlphaShowMargin", "(I)V", "b_core_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public final int m10924a() {
            return TabLayoutScrollBehavior.f7601b;
        }
    ...
    /* JADX INFO: renamed from: b */
    public final void m10923b(@Nullable View view) {
    ...
    public boolean onDependentViewChanged(@NotNull CoordinatorLayout parent, @NotNull View child, @NotNull View dependency) {
        ...
        if (height <= child.getHeight() + f7601b) {
            xdl0.M(child, true);
            child.setAlpha(1.0f);
        ...
        } else if (height <= (child.getHeight() * 2) + f7601b) {
            xdl0.M(child, true);
            float height2 = (((height - child.getHeight()) - f7601b) * 1.0f) / child.getHeight();
