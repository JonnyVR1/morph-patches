...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\r\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u001d\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u000f\u0010\t\u001a\u00020\bH\u0014¢\u0006\u0004\b\t\u0010\nJ\u001d\u0010\u000f\u001a\u00020\b2\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u000e\u001a\u00020\r¢\u0006\u0004\b\u000f\u0010\u0010J\u0017\u0010\u0013\u001a\u00020\b2\u0006\u0010\u0012\u001a\u00020\u0011H\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u001f\u0010\u0016\u001a\u00020\u00152\u0006\u0010\f\u001a\u00020\u000b2\u0006\u0010\u000e\u001a\u00020\rH\u0002¢\u0006\u0004\b\u0016\u0010\u0017R\"\u0010\u001e\u001a\u00020\u00188\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0013\u0010\u0019\u001a\u0004\b\u001a\u0010\u001b\"\u0004\b\u001c\u0010\u001dR\"\u0010%\u001a\u00020\u001f8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0016\u0010 \u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$¨\u0006&"}, d2 = {"Lcom/p1/mobile/putong/core/ui/purchase/page/PurchaseExclusivePrivilegeItemView;", "Landroid/widget/LinearLayout;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", "onFinishInflate", "()V", "Lcom/p1/mobile/putong/core/data/PurchaseType;", "purchaseType", "Lcom/p1/mobile/putong/core/data/Privilege;", "privilege", "c", "(Lcom/p1/mobile/putong/core/data/PurchaseType;Lcom/p1/mobile/putong/core/data/Privilege;)V", "Landroid/view/View;", "view", "a", "(Landroid/view/View;)V", "", "b", "(Lcom/p1/mobile/putong/core/data/PurchaseType;Lcom/p1/mobile/putong/core/data/Privilege;)Ljava/lang/CharSequence;", "Lv/VIcon;", "Lv/VIcon;", "get_icon", "()Lv/VIcon;", "set_icon", "(Lv/VIcon;)V", "_icon", "Lv/VText;", "Lv/VText;", "get_privilege", "()Lv/VText;", "set_privilege", "(Lv/VText;)V", "_privilege", "pay_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class PurchaseExclusivePrivilegeItemView extends LinearLayout {
    ...
    public static final /* synthetic */ class C0216a {
    ...
    /* JADX INFO: renamed from: a */
    public final void m7471a(View view) {
        d3b0.a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final CharSequence m7472b(PurchaseType purchaseType, Privilege privilege) {
        switch (C0216a.f4679a[privilege.ordinal()]) {
            case 1:
                return "无限右滑";
            case 2:
                ...
                String string = CoreModule.f1533b.getString(R.string.g1);
                string.getClass();
                return string;
            case CameraSticker.STATE_COMPLETE /* 3 */:
                return CoreModule.m1854P().m11706a().m5370Vf() ? "反悔特权" : "滑错反悔";
            ...
            case 6:
                return "解密谁喜欢我";
            case 7:
                return sab0.i(purchaseType) ? "无限次在线闪聊" : "闪聊配对";
            case 8:
                return sab0.i(purchaseType) ? "全程优先推荐" : "每月3次优先推荐";
            case 9:
                return "解锁我喜欢过的人";
            case 10:
                return "语音闪聊";
            ...
            case 18:
                return "每天5条\"资料留言\"";
            case 19:
                return sab0.i(purchaseType) ? "全程动态超级曝光" : String.format("每月%s次动态超级曝光", Integer.valueOf(CoreModule.m1853N().h8()));
            case 20:
                return "一键配对";
            case 21:
                return "我的访客";
            ...
            case 34:
                return "任意修改定位";
            case 35:
                return String.format("每天%s次免费找搭子特权", Integer.valueOf(CoreModule.f1534c.f3587Q1.f4106R.m6692I()));
            case 36:
                return String.format("每天%s次额外免费盲盒", Integer.valueOf(CoreModule.f1534c.f3587Q1.f4106R.m6691H()));
            case 37:
                return "每天1个超级喜欢";
            case 38:
                return "查看消息是否已读";
    ...
    public final void m7473c(@NotNull PurchaseType purchaseType, @NotNull Privilege privilege) {
        purchaseType.getClass();
        privilege.getClass();
        if (sab0.i(purchaseType)) {
            get_icon().setImageResource(d3c0.a7);
            get_privilege().setTextColor(Color.parseColor("#CCFFDEA2"));
        } else {
            get_icon().setImageResource(d3c0.Z6);
            get_privilege().setTextColor(getResources().getColor(b1c0.g));
        }
        get_privilege().setText(m7472b(purchaseType, privilege));
    }
