...
public class CameraCategory extends ValueObject implements Cloneable, Serializable {
    ...
    public String type;
    public static ProtobufAdapter<CameraCategory> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraCategory>() { // from class: com.p1.mobile.putong.account.data.CameraCategory.1
        {
        ...
        public CameraCategory m28899parse(nb5 nb5Var) throws IOException {
            CameraCategory cameraCategory = new CameraCategory();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (cameraCategory.f331id == null) {
                        cameraCategory.f331id = "";
                    }
                ...
                if (iU == 10) {
                    cameraCategory.f331id = nb5Var.s();
                } else if (iU == 18) {
    ...
    public static JsonAdapter<CameraCategory> JSON_ADAPTER = new ObjectJsonAdapter<CameraCategory>() { // from class: com.p1.mobile.putong.account.data.CameraCategory.2
        public Class getDataClass() {
            return CameraCategory.class;
        }

        /* JADX INFO: renamed from: newInstance, reason: merged with bridge method [inline-methods] */
        public CameraCategory m28900newInstance() {
        ...
        public boolean parseField(CameraCategory cameraCategory, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    cameraCategory.f331id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public CameraCategory m28898clone() {
        CameraCategory cameraCategory = new CameraCategory();
        cameraCategory.f331id = this.f331id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f331id, cameraCategory.f331id) && ValueObject.util_equals(this.name, cameraCategory.name) && ValueObject.util_equals(this.category, cameraCategory.category) && ValueObject.util_equals(this.type, cameraCategory.type) && this.cameraUpdateTime == cameraCategory.cameraUpdateTime && ValueObject.util_equals(this.status, cameraCategory.status);
    }
