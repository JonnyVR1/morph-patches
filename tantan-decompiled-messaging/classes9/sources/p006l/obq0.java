...
public final class obq0 extends AbstractC1073o5 {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!sab0.q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "wechat")) {
            return false;
        }
        if (NullChecker.a(section.b()) && section.m() && section.b().s().semiAnnual()) {
            return true;
        }
        return NullChecker.a(section.d()) && section.d().s().semiAnnual();
    }
}
