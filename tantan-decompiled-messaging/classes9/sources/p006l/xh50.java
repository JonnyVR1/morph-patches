...
public final class xh50 extends AbstractC1073o5 {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        ...
        return (companion.m24456a(getPurchaseType()) || sab0.o(getPurchaseType()) || sab0.i(getPurchaseType()) || sab0.e(getPurchaseType()) || TEnum.equals(currentPayMethod, "wechat") || companion.m24458c(getPurchaseType()) || sab0.g(getPurchaseType()) || sab0.x(getPurchaseType()) || sab0.p(getPurchaseType()) || sab0.j(getPurchaseType()) || !NullChecker.a(section) || !NullChecker.a(section.d()) || !section.d().H() || !section.d().s().monthly()) ? false : true;
    }
}
