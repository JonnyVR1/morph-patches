...
public final class jd0 implements hml {
    ...
    public CharSequence mo16164a(@NotNull fd0 requestData) {
        ...
        if (requestData.getVipFrag() && g6a.m15592o()) {
            CharSequence charSequenceA = we60.A(requestData.getMerchandise(), Color.parseColor("#735131"));
            charSequenceA.getClass();
            return charSequenceA;
        }
        if (requestData.getPurchasePageType()) {
            CharSequence charSequenceB = we60.B(requestData.getMerchandise());
            charSequenceB.getClass();
            return charSequenceB;
        }
        if (requestData.getPrivilegeStyle()) {
            CharSequence charSequenceA2 = we60.A(requestData.getMerchandise(), we60.Q(true));
            charSequenceA2.getClass();
            return charSequenceA2;
        }
        CharSequence charSequenceA3 = we60.A(requestData.getMerchandise(), we60.Q(false));
        charSequenceA3.getClass();
        return charSequenceA3;
    }
    ...
    public boolean mo16165b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.i(this.purchaseType) && requestData.getMerchandise().autoRenewable();
    }
}
