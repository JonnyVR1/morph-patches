...
public final class uw40 extends AbstractC1073o5 {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        return sab0.i(getPurchaseType()) && g6a.m15591n() && NullChecker.a(section) && NullChecker.a(section.b()) && section.b().H() && section.b().s().quarterly() && section.b().E();
    }
}
