...
public final class xh60 extends AbstractC1297t4 {
    ...
    public void mo16653b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        response.m12700n(p2b0.h().k(aVarM24436g.s()));
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        request.getClass();
        return sab0.w(this.purchaseType) && request.getPurchaseSection().m() && rxa0.x(request.getPurchaseSection().b().s());
    }
}
