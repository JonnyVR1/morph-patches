...
public final class lee0 extends AbstractC1073o5 {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!sab0.q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "alipay")) {
            return false;
        }
        if (NullChecker.a(section.b()) && section.m() && section.b().s().quarterly()) {
            return true;
        }
