...
public class o090 extends AbstractC0495a5 {
    ...
    public o090(@NotNull PrivilegeEntranceView.a aVar) {
        super(aVar);
        aVar.getClass();
    }

    /* JADX INFO: renamed from: q */
    public static Boolean m20282q(Merchandise merchandise) {
        merchandise.getClass();
        return Boolean.valueOf(merchandise.monthly() && merchandise.autoRenewable());
    }

    /* JADX INFO: renamed from: t */
    private final String m20284t() {
    ...
    private final void m20285u() {
        getPrivilegeEntranceInfo().b().setMaximumFractionDigits(2);
        this.merchandise = (Merchandise) vwb.r(CoreModule.f1534c.f3643j0.m2507D5(ProductCategory.get("tttVip")), new w9j() { // from class: l.n090
            public final Object call(Object obj) {
                return o090.m20282q((Merchandise) obj);
            }
        });
    }

    /* JADX INFO: renamed from: v */
    public static final void m20286v(o090 o090Var, View view) {
        zvf0.r(o090Var.mo11695h(), o090Var.m11751f());
        if (sj20.m23814a().m23819f()) {
            String strM5276Ie = CoreModule.m1854P().m11706a().m5276Ie();
            strM5276Ie.getClass();
            o090Var.m11756o(strM5276Ie);
        } else {
            o090Var.getPrivilegeEntranceInfo().a().startActivity(CoreModule.m1854P().m11706a().m5489nk(o090Var.getPrivilegeEntranceInfo().a(), "p_privilege,navigation_banner", CoreModule.m1854P().m11706a().m5358Tn()));
        }
    }

    /* JADX INFO: renamed from: w */
    public static final void m20287w(o090 o090Var, View view) {
        zvf0.u("e_purchase_banner", "p_navigation_view", new j760[]{vwb.Y("privileges_guide_type", "oDiamond")});
        zvf0.r(o090Var.mo15552s(), o090Var.m11751f());
        String strM5252F0 = CoreModule.m1854P().m11706a().m5252F0();
        strM5252F0.getClass();
        o090Var.m11756o(strM5252F0);
    }
    ...
    public void mo11697m() {
        ...
        if (privilegeEntranceDefaultView != null) {
            ...
            String strM20284t = m20284t();
            if (TextUtils.isEmpty(strM20284t)) {
                ...
                strString.getClass();
                vText.setText(String.format(strString, Arrays.copyOf(new Object[]{strM20284t}, 1)));
            }
            xdl0.E0(privilegeEntranceDefaultView, new View.OnClickListener() { // from class: l.l090
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    o090.m20286v(this.f16128a, view);
                }
            });
        }
        ...
        if (privilegeEntranceODiamondSingleView != null) {
            ...
            xdl0.E0(privilegeEntranceODiamondSingleView, new View.OnClickListener() { // from class: l.m090
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    o090.m20287w(this.f16735a, view);
                }
            });
