...
public final class hi0 extends AbstractC1073o5 {
    ...
    public static Boolean m16217d(d dVar) {
        return Boolean.valueOf(NullChecker.a(dVar.b()) && dVar.b().s().quarterly() && (rxa0.w(dVar.b().s()) || rxa0.v("svip", dVar.b().s())));
    }
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!sab0.q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "alipay") || vwb.m(m20327b(), new w9j() { // from class: l.gi0
            public final Object call(Object obj) {
                return hi0.m16217d((d) obj);
            }
        })) {
            return false;
        }
        if (section.m() && NullChecker.a(section.b()) && section.b().s().quarterly()) {
            return true;
        }
        return NullChecker.a(section.d()) && section.d().s().quarterly();
    }
}
