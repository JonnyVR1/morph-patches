...
public final class ji0 extends AbstractC1073o5 {
    ...
    public static Boolean m17454d(d dVar) {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!sab0.q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "alipay") || vwb.m(m20327b(), new w9j() { // from class: l.ii0
            public final Object call(Object obj) {
                return ji0.m17454d((d) obj);
            }
        })) {
            return false;
        }
