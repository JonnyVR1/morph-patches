...
public final class oh60 extends AbstractC1297t4 {
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        request.getClass();
        return sab0.m(this.purchaseType) && request.getPurchaseSection().m() && rxa0.u(request.getPurchaseSection().b().s());
    }
}
