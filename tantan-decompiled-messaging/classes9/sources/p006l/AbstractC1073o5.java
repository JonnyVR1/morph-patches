...
public abstract class AbstractC1073o5 {
    ...
    public AbstractC1073o5(@NotNull PurchaseType purchaseType, @NotNull List<? extends d> list) {
    ...
    public abstract boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod);

    @NotNull
    /* JADX INFO: renamed from: b */
    public final List<d> m20327b() {
