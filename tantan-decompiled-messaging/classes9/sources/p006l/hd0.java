...
public final class hd0 implements hml {
    ...
    public CharSequence mo16164a(@NotNull fd0 requestData) {
        ...
        if (sab0.i(this.purchaseType) && requestData.getVipFrag() && g6a.m15592o()) {
            CharSequence charSequenceN = we60.n(this.purchaseType, requestData.getPrivilegeStyle(), Color.parseColor("#735131"));
            charSequenceN.getClass();
            return charSequenceN;
        }
        boolean purchasePageType = requestData.getPurchasePageType();
        PurchaseType purchaseType = this.purchaseType;
        if (purchasePageType) {
            CharSequence charSequenceE = we60.E(purchaseType, requestData.getPrivilegeStyle());
            charSequenceE.getClass();
            return charSequenceE;
        }
        CharSequence charSequenceM = we60.m(purchaseType, requestData.getPrivilegeStyle());
