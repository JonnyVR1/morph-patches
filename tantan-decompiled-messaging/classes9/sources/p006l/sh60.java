...
public final class sh60 extends AbstractC1297t4 {
    ...
    public void mo16653b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        if (TextUtils.equals(getFrom(), "purchasePage")) {
            response.m12697k("1元秒杀");
        } else {
            response.m12700n("1元秒杀");
        }
    }
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        ...
        return TEnum.equals(aVarM24436g.f(), "svip") && aVarM24436g.s().autoRenewable() && aVarM24436g.s().monthly() && rxa0.k(aVarM24436g.s());
    }
}
