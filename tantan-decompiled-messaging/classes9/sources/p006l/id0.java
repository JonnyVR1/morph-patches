...
public final class id0 implements hml {
    ...
    public CharSequence mo16164a(@NotNull fd0 requestData) {
        ...
        CharSequence charSequenceO = we60.o(requestData.getPrivilegeStyle());
        charSequenceO.getClass();
    ...
    public boolean mo16165b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.g(this.purchaseType) && requestData.getMerchandise().autoRenewable();
    }
}
