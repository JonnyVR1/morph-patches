...
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u0000 \u001d2\u00020\u0001:\u0001\u0007B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\n\u001a\u00020\tH\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\f\u001a\u00020\tH\u0016¢\u0006\u0004\b\f\u0010\u000bJ\u000f\u0010\u000e\u001a\u00020\rH\u0016¢\u0006\u0004\b\u000e\u0010\u000fJ\u000f\u0010\u0010\u001a\u00020\rH\u0016¢\u0006\u0004\b\u0010\u0010\u000fR\u0018\u0010\u0014\u001a\u0004\u0018\u00010\u00118\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u0018\u0010\u0018\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u0018\u0010\u001c\u001a\u0004\u0018\u00010\u00198\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001a\u0010\u001b¨\u0006\u001e"}, d2 = {"Ll/s390;", "Ll/a5;", "Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntranceView$a;", "privilegeEntranceInfo", "<init>", "(Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntranceView$a;)V", "", "a", "()Z", "", "b", "()V", "m", "", "s", "()Ljava/lang/String;", "h", "Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntranceSingleTextWithIconBgView;", "d", "Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntranceSingleTextWithIconBgView;", "_top_view", "Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntrancePromotionBottomView;", "e", "Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntrancePromotionBottomView;", "_bottom_view", "Lcom/p1/mobile/putong/core/data/Merchandise;", "f", "Lcom/p1/mobile/putong/core/data/Merchandise;", "merchandise", "Companion", "pay_intlGmsRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
public final class s390 extends AbstractC0495a5 {
    ...
    public s390(@NotNull PrivilegeEntranceView.a aVar) {
        super(aVar);
        aVar.getClass();
    }

    /* JADX INFO: renamed from: t */
    public static final void m23488t(s390 s390Var, View view) {
        zvf0.r(s390Var.mo11695h(), s390Var.m11751f());
        String strM5384Y3 = CoreModule.m1854P().m11706a().m5384Y3();
        strM5384Y3.getClass();
        s390Var.m11756o(strM5384Y3);
    }

    /* JADX INFO: renamed from: u */
    public static final void m23489u(s390 s390Var, PrivilegeEntrancePromotionBottomView privilegeEntrancePromotionBottomView, View view) {
        zvf0.r(s390Var.m23491s(), s390Var.m11751f());
        ...
        int iM5526sk = CoreModule.m1854P().m11706a().m5526sk(strM5276Ie);
        Merchandise merchandise = s390Var.merchandise;
        List list = merchandise != null ? merchandise.localCoupons : null;
        if (list == null || list.isEmpty()) {
            return;
        }
        Merchandise merchandise2 = s390Var.merchandise;
        Coupon coupon = (Coupon) vwb.r(merchandise2 != null ? merchandise2.localCoupons : null, new w9j() { // from class: l.r390
            public final Object call(Object obj) {
                return s390.m23490v((Coupon) obj);
            }
        });
        if (coupon != null) {
            CoreModule.m1854P().m11706a().m5346Sn(privilegeEntrancePromotionBottomView.getContext(), "p_privilege,navigation_banner", iM5526sk, true, ((DbObject) coupon).id);
        } else {
            strM5276Ie.getClass();
            s390Var.m11756o(strM5276Ie);
        }
    }

    /* JADX INFO: renamed from: v */
    public static final Boolean m23490v(Coupon coupon) {
        coupon.getClass();
        return Boolean.valueOf(coupon.isBelongPromotion("lowPriceCustomerSVIP") && rxa0.r(((DbObject) coupon).id));
    }
    ...
    public boolean mo11693a() {
        if (!g6a.m15597t() && zb90.i() && xma.m27379e4() && NullChecker.a(CoreModule.f1534c.f3643j0.m2507D5(ProductCategory.get("svip")))) {
            for (Merchandise merchandise : CoreModule.f1534c.f3643j0.m2507D5(ProductCategory.get("svip"))) {
                if (merchandise.monthType() && rxa0.l(merchandise, "lowPriceCustomerSVIP")) {
    ...
    public void mo11697m() {
        ...
        if (privilegeEntranceSingleTextWithIconBgView != null) {
            ...
            xdl0.E0(privilegeEntranceSingleTextWithIconBgView, new View.OnClickListener() { // from class: l.p390
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    s390.m23488t(this.f18579a, view);
                }
            });
        }
        ...
        if (privilegeEntrancePromotionBottomView != null) {
            ...
            xdl0.E0(privilegeEntrancePromotionBottomView.get_goto_buy(), new View.OnClickListener() { // from class: l.q390
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    s390.m23489u(this.f19552a, privilegeEntrancePromotionBottomView, view);
                }
            });
