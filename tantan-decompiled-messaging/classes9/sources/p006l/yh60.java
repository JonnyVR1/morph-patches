...
public final class yh60 extends AbstractC1297t4 {
    ...
    public void mo16653b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        if (TextUtils.equals(getFrom(), "purchasePage")) {
            response.m12697k(aVarM24436g.u() + "元秒杀");
            return;
        }
        response.m12700n(aVarM24436g.u() + "元秒杀");
    }
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        request.getClass();
        m24436g(request.getPurchaseSection());
        return false;
    }
}
