...
public class C0907jy extends i0g0 {
    /* JADX INFO: renamed from: n0 */
    public static String m17844n0(double d) {
        return new SimpleDateFormat("yyyy-MM-dd", Locale.US).format(new Date((long) d));
    }

    /* JADX INFO: renamed from: o0 */
    public static String m17845o0(String str) {
    ...
    public static String m17846p0(String str) {
        if (str.length() <= 4) {
            return str;
        }
