...
public final class kh60 extends AbstractC1297t4 {
    ...
    public void mo16653b(@NotNull ai60 request, @NotNull bi60 response) {
        request.getClass();
        response.getClass();
        response.m12700n("限时优惠");
        if (request.getPurchaseSection().m()) {
            return;
        }
        d.a aVarM24436g = m24436g(request.getPurchaseSection());
        response.m12699m(true);
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        response.m12702p(String.format("%s%s元获取", Arrays.copyOf(new Object[]{aVarM24436g.h(), n6a.r0(aVarM24436g.l())}, 2)));
    }
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        request.getClass();
        return sab0.e(this.purchaseType) || sab0.c(this.purchaseType);
    }
}
