...
public final class ei0 extends AbstractC1073o5 {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (CoreModule.m1854P().m11706a().m5461j3() && TEnum.equals(currentPayMethod, "alipay") && CoreModule.f1534c.f3580O0.m2014u3(getPurchaseType()) && NullChecker.a(section.b()) && section.m()) {
        ...
        if (TEnum.equals(currentPayMethod, "jingdong") && (sab0.w(getPurchaseType()) || sab0.q(getPurchaseType()))) {
            if (!NullChecker.a(section.d())) {
                return true;
            }
            section.w(false);
        ...
        if (agreementState == AgreementComponent.AgreementState.checked && NullChecker.a(section.b())) {
            section.w(true);
        }
        return false;
    }
