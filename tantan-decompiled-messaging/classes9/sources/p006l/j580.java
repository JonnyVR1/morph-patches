...
public final class j580 extends AbstractC1073o5 {
    ...
    public boolean mo14551a(@NotNull d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        return p2b0.h().z() && sab0.o(getPurchaseType()) && NullChecker.a(section) && NullChecker.a(section.b()) && section.b().s().yearly();
    }
}
