...
public final /* data */ class ai60 {
    ...
    public /* synthetic */ ai60(d dVar, PayMethod payMethod, double d, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(dVar, payMethod, (i & 4) != 0 ? 0.0d : d, (i & 8) != 0 ? true : z);
    }
    ...
    public final d getPurchaseSection() {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.d(this.purchaseSection, ai60Var.purchaseSection) && Intrinsics.d(this.payMethod, ai60Var.payMethod) && Double.compare(this.refundAmount, ai60Var.refundAmount) == 0 && this.showSticker == ai60Var.showSticker;
    }
    ...
    public ai60(@NotNull d dVar, @NotNull PayMethod payMethod, double d, boolean z) {
        dVar.getClass();
        payMethod.getClass();
        this.purchaseSection = dVar;
