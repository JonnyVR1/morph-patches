...
public final class rd0 implements hml {
    ...
    public CharSequence mo16164a(@NotNull fd0 requestData) {
        ...
        CharSequence charSequenceM = we60.M(requestData.getPrivilegeStyle());
    ...
    public boolean mo16165b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.x(this.purchaseType) && requestData.getMerchandise().autoRenewable();
    }
}
