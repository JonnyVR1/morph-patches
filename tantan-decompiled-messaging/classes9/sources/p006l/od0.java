...
public final class od0 implements hml {
    ...
    public CharSequence mo16164a(@NotNull fd0 requestData) {
        ...
        if (requestData.getPrivilegeStyle()) {
            CharSequence charSequenceA = we60.A(requestData.getMerchandise(), we60.Q(true));
            charSequenceA.getClass();
            return charSequenceA;
        }
        CharSequence charSequenceA2 = we60.A(requestData.getMerchandise(), we60.Q(false));
    ...
    public boolean mo16165b(@NotNull fd0 requestData) {
        requestData.getClass();
        return (sab0.p(this.purchaseType) || sab0.j(this.purchaseType)) && requestData.getMerchandise().autoRenewable();
    }
}
