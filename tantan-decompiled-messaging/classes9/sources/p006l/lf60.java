...
public final class lf60 implements pzl {
    ...
    public boolean mo14019a(@NotNull ef60 paymentHandlerData, @NotNull AbstractC1040n5 paymentComponent) {
        ...
        if ((!sab0.w(this.purchaseType) && !sab0.q(this.purchaseType)) || !TextUtils.equals(this.from, wek0.a) || !paymentHandlerData.getCurrentPurchaseSection().m() || !rxa0.v(this.purchaseType.productCategory().toString(), paymentHandlerData.getCurrentPurchaseSection().b().s())) {
            return false;
        }
        km80.h0(this.act, (e30) null, zl80.g().d(true), "p_promotion,callback_privilege_button", (Object) null);
        return true;
    }
}
