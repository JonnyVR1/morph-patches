...
public final class vh60 extends AbstractC1297t4 {
    ...
    public void mo16653b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        if (sab0.i(this.purchaseType)) {
            ...
            String str = getNumberFormat().format(aVarM24436g.I() ? aVarM24436g.s().getFirstCouponPrice() : aVarM24436g.s().defaultStockKeepUnit.prices.price);
            str.getClass();
            StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
            strString = String.format("%1$s%2$s %3$s", Arrays.copyOf(new Object[]{aVarM24436g.h(), str, this.act.string(R.string.y8)}, 3));
        } else {
            strString = this.act.string(R.string.y8);
            strString.getClass();
        }
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        request.getClass();
        return (sab0.q(this.purchaseType) || sab0.i(this.purchaseType)) && e.x(getFrom());
    }
}
