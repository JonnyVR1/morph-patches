...
public final class rh60 extends AbstractC1297t4 {
    ...
    public void mo16653b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        response.m12701o(response.getSticker());
        response.m12700n((aVarM24436g.s().quarterly() || aVarM24436g.s().semiAnnual()) ? dsa.m14206n(aVarM24436g) : p2b0.h().k(aVarM24436g.s()));
        if (TextUtils.equals(getFrom(), wek0.a)) {
            response.m12701o(null);
        }
    ...
    public boolean mo16654e(@NotNull ai60 request) {
        request.getClass();
        if (sab0.q(this.purchaseType) && request.getPurchaseSection().m() && !xma.m27355L3()) {
            return rxa0.w(request.getPurchaseSection().b().s()) || rxa0.s(request.getPurchaseSection().b().s());
        }
        return false;
    }
}
