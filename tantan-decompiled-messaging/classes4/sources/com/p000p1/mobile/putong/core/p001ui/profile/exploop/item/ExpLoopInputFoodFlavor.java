...
public class ExpLoopInputFoodFlavor extends ExpLoopInputType {
    ...
    public boolean hasInfoExist(User user, LoopFragmentFactory.LoopCreateEntryType loopCreateEntryType) {
        return NullChecker.a(user.profile) && NullChecker.a(user.profile.extensions) && NullChecker.a(user.profile.extensions.interest) && !vwb.J(user.profile.extensions.interest.taste);
    }

    @Override // com.p000p1.mobile.putong.core.p001ui.profile.exploop.item.ExpLoopInputType
    public void saveUserInfo(User user) {
        super.saveUserInfo(user);
        ArrayList arrayListN = vwb.n(getData().getSelectType().list, new w9j() { // from class: l.def
            public final Object call(Object obj) {
                return Boolean.valueOf(((ExpProfileLoopSelectTypeData.ItemData) obj).boolValue);
            }
        });
        user.profile.extensions.interest.taste = vwb.Q(arrayListN, new w9j() { // from class: l.eef
            public final Object call(Object obj) {
