...
public class ExpLoopInputGameTogether extends ExpLoopInputType {
    ...
    private static ArrayList<ExpProfileLoopSelectTypeData.ItemData> getGameTogetherRenderList(User user) {
        ...
        ArrayList arrayListF0 = vwb.f0(new ExpProfileLoopSelectTypeData.ItemData[]{new ExpProfileLoopSelectTypeData.ItemData("组队"), new ExpProfileLoopSelectTypeData.ItemData("cpdd"), new ExpProfileLoopSelectTypeData.ItemData("求大佬"), new ExpProfileLoopSelectTypeData.ItemData("找战队"), new ExpProfileLoopSelectTypeData.ItemData("其他")});
        vwb.z(arrayListF0, new e30() { // from class: l.mef
    ...
    public void saveUserInfo(User user) {
        ...
        ArrayList arrayListN = vwb.n(getData().getSelectType().list, new w9j() { // from class: l.kef
            public final Object call(Object obj) {
                return Boolean.valueOf(((ExpProfileLoopSelectTypeData.ItemData) obj).boolValue);
            }
        });
        user.profile.extensions.game.together = vwb.Q(arrayListN, new w9j() { // from class: l.lef
            public final Object call(Object obj) {
