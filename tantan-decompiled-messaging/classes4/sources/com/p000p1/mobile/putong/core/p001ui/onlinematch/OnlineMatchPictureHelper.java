...
public class OnlineMatchPictureHelper {
    ...
    public static volatile OnlineMatchPictureHelper f445c;

    /* JADX INFO: renamed from: a */
    public final Map<String, String> f446a = new MaxSizeHashMap(38);
    ...
    /* JADX INFO: renamed from: b */
    public static OnlineMatchPictureHelper m626b() {
        if (f445c == null) {
            synchronized (OnlineMatchPictureHelper.class) {
                try {
                    if (f445c == null) {
                        f445c = new OnlineMatchPictureHelper();
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    /* JADX INFO: renamed from: a */
    public ArrayList<String> m627a() {
        ArrayList<String> arrayList = new ArrayList<>();
        if (CoreModule.H().userId() == null) {
            return arrayList;
        }
        ...
        if (NullChecker.a(userP9)) {
            ...
            arrayList.addAll((TEnum.equals(lookingFor, "unknown_") || TEnum.equals(lookingFor, "both")) ? userP9.isFemale() ^ true : TEnum.equals(lookingFor, "female") ? m628c() : m629d());
        }
        this.f447b = (this.f447b + 1) % 2;
        return arrayList;
    }

    /* JADX INFO: renamed from: c */
    public final ArrayList<String> m628c() {
        ArrayList<String> arrayList = new ArrayList<>();
        if (this.f447b == 0) {
    ...
    public final ArrayList<String> m629d() {
        ArrayList<String> arrayList = new ArrayList<>();
        if (this.f447b == 0) {
