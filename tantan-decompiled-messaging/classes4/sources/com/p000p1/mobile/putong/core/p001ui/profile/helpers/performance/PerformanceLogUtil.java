...
public class PerformanceLogUtil {
    ...
    private PerformanceLogUtil() {
        ...
        this.preFix += "R_";
        Act.globalLifecycle().subscribe(mkd0.G(new e30() { // from class: l.fj60
            public final void call(Object obj) {
                this.f10421a.lambda$new$3((HashMap) obj);
            }
        }));
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ boolean m1921c(ProfileLogEntity profileLogEntity, LogEntity logEntity) {
    ...
    public static /* synthetic */ void m1922d(ProfileLogEntity.ProfileLogName profileLogName, long j, LogEntity.LogType logType, int i, int i2, String str) {
        ...
        LogEntity logEntity = (LogEntity) find(performanceLogUtilInstance.logs, new FindCall() { // from class: com.p1.mobile.putong.core.ui.profile.helpers.performance.a
            ...
            public final boolean isFind(Object obj) {
                return PerformanceLogUtil.m1921c(profileLogEntity, (LogEntity) obj);
            }
        });
        if (logEntity != null) {
    ...
    private File getLogDir() {
        return new File(rhi.v(), logDirName);
    }
    ...
    private static void logPerformance(final int i, final ProfileLogEntity.ProfileLogName profileLogName, final LogEntity.LogType logType, final String str) {
        ...
        instance().singleThreadExecutor.execute(new Runnable() { // from class: l.ej60
            @Override // java.lang.Runnable
            public final void run() {
                PerformanceLogUtil.m1922d(profileLogName, jCurrentTimeMillis, logType, i2, i, str);
            }
        });
    }
