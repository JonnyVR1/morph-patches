...
public class LiveVirtualVoiceSpyDialogViewBindings<T extends q0m> extends LinearLayout implements s7m<T> {
    ...
    public SpyDialogView f4201b;

    /* JADX INFO: renamed from: c */
    public VDraweeView f4202c;
    ...
    public void m5496f(ViewGroup viewGroup) {
        this.f4201b = (SpyDialogView) viewGroup;
    ...
    public void m5497i1(T t) {
        this.f4200a = t;
    }

    public View inflateView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        View viewInflate = layoutInflater.inflate(t6c0.f19905k7, viewGroup, false);
        m5496f((ViewGroup) viewInflate);
        return viewInflate;
    }
