...
public final class PacketCountdownView extends ConstraintLayout {
    ...
    public final VText get_countdownText() {
        ...
        Intrinsics.r("_countdownText");
        return null;
    }

    /* JADX INFO: renamed from: h0 */
    public final void m7484h0(View view) {
        t460.m22789a(this, view);
    }

    /* JADX INFO: renamed from: i0 */
    public final void m7485i0(@NotNull BLivePacketSystemCommentStatus info) {
        info.getClass();
        this.bagStatus = info;
        get_countdownText().setText(info.getCountdownText());
        get_circleCountdown().m7483d(info.getCurrentCountdownProgress());
    }

    @SuppressLint({"SetTextI18n"})
    /* JADX INFO: renamed from: j0 */
    public final void m7486j0() {
        get_circleCountdown().m7482c();
    ...
    public final void m7487k0(int countdown, float progress) {
        get_countdownText().setText(countdown + "s");
        get_circleCountdown().m7483d(progress);
    }
