...
public class mx70 extends bk2<LongLinkLiveMessage.PkMute, LivePkMessage> {
    ...
    public boolean mo9246q(LongLinkLiveMessage.PkMute pkMute, String str) {
        return true;
    }

    @Override // p002l.bk2
    /* JADX INFO: renamed from: C, reason: merged with bridge method [inline-methods] */
    public LivePkMessage mo9251z(String str, LongLinkLiveMessage.PkMute pkMute) {
        return new LivePkMessage(pkMute.getPkId(), "pk_mute").setPkMuteInfo(pkMute);
    }

    @Override // p002l.vp2
    /* JADX INFO: renamed from: b */
    public Class<LongLinkLiveMessage.PkMute> mo9244b() {
