...
public final class p83 {
    ...
    public static void m20122a(e30 e30Var, View view) {
        e30Var.call(0);
    }

    @Nullable
    /* JADX INFO: renamed from: b */
    public final View m20123b(@NotNull Act act, @NotNull ViewGroup root) {
        act.getClass();
        root.getClass();
        View viewInflate = LayoutInflater.from(act).inflate(m6c0.l, root, false);
    ...
    public final void m20124c(@NotNull Act act) {
        act.getClass();
        m20125d();
    }

    /* JADX INFO: renamed from: d */
    public final void m20125d() {
        VText vText = this._feature_name_text;
        if (vText != null) {
            vText.setText(this.act.getString(IntlCountryCodeController.v() ? R.string.C4 : R.string.o));
        }
        VText vText2 = this._promotional_text;
        if (vText2 != null) {
            vText2.setText(this.act.getString(R.string.n));
        }
    ...
    public final void m20126e(@NotNull final e30<Integer> dismiss) {
        dismiss.getClass();
        xdl0.E0(this._image_close, new View.OnClickListener() { // from class: l.o83
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                p83.m20122a(dismiss, view);
            }
        });
    }
}
