...
public class zif extends hh90 {
    ...
    public ProfileButton mo12175e(ProfileButton.ProfileButtonType profileButtonType) {
        if (profileButtonType == ProfileButton.ProfileButtonType.Recovery) {
            return new ProfileButton(profileButtonType, this.f12033b.m2923a()).m2927b(this.f23442e);
        }
        return null;
    }
    ...
    public View mo12176g() {
        return LayoutInflater.from(this.f12034c).inflate(f6c0.G9, (ViewGroup) null);
    }
    ...
    public void mo12177h(View view) {
        super.mo12177h(view);
        this.f23442e = (TextView) view.findViewById(u4c0.nb);
    }
