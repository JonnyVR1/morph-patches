...
public class x8f extends hh90 {
    ...
    public ProfileButton mo12175e(ProfileButton.ProfileButtonType profileButtonType) {
        if (profileButtonType == ProfileButton.ProfileButtonType.CityGreet) {
            return new ProfileButton(profileButtonType, this.f12033b.m2923a()).m2927b(this.f22166e);
        }
        return null;
    }
    ...
    public View mo12176g() {
        return LayoutInflater.from(this.f12034c).inflate(f6c0.E9, (ViewGroup) null);
    }

    @Override // p002l.hh90
    /* JADX INFO: renamed from: h */
    public void mo12177h(View view) {
        this.f22166e = (TextView) view.findViewById(u4c0.r1);
    }
