...
public class jtf extends AbstractC0675m4 {
    ...
    public boolean mo11106d(BLiveEffect bLiveEffect) {
        if (bLiveEffect == null || !this.f15228a.mo21928i(bLiveEffect.id, bLiveEffect.hdType, bLiveEffect.zip) || !m16223h(bLiveEffect)) {
            return false;
        }
    ...
    public boolean mo11107f(String str, boolean z, h7e h7eVar, bwc0 bwc0Var) {
        ...
        if (this.f15228a.mo21928i(bLiveEffectM17694c.id, bLiveEffectM17694c.hdType, bLiveEffectM17694c.zip) && m16223h(bLiveEffectM17694c)) {
    ...
    public final boolean m16223h(BLiveEffect bLiveEffect) {
        return new File(this.f15228a.m27091p(bLiveEffect.id, bLiveEffect.hdType, bLiveEffect.zip) + "/params.txt").exists();
    }
}
