...
public final class dwo0 extends bk2<VoiceUpdateUserMaskProto.UserMaskUpdate, VoiceUpdateUserMaskProto.UserMaskUpdate> {
    ...
    public boolean mo9246q(@Nullable VoiceUpdateUserMaskProto.UserMaskUpdate message, @Nullable String userId) {
        return true;
    }
    ...
    public VoiceUpdateUserMaskProto.UserMaskUpdate mo9251z(@Nullable String msgId, @NotNull VoiceUpdateUserMaskProto.UserMaskUpdate message) {
        message.getClass();
        return message;
    }
    ...
    public Class<VoiceUpdateUserMaskProto.UserMaskUpdate> mo9244b() {
