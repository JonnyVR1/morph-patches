...
public class b1k extends bk2<LongLinkGiftMessage.LiveRankings, LongLinkGiftMessage.LiveRanking> {
    ...
    public boolean mo9246q(LongLinkGiftMessage.LiveRankings liveRankings, String str) {
        ...
        return (vwb.J(liveRankings.getRankingsList()) || (liveRanking = (LongLinkGiftMessage.LiveRanking) liveRankings.getRankingsList().get(0)) == null || !m24095r(liveRanking.getRoomId(), "no_care", "no_care")) ? false : true;
    }
