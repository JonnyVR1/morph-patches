...
public final class C22409c {
    /* JADX INFO: renamed from: a */
    public static String m221621a(Context context) {
        if (context == null) {
            return "";
        }
        try {
            ...
            int iRound = Math.round((intentM136342l.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1) * 100) / intentM136342l.getIntExtra(BigEyeFilter.UNIFORM_SCALE, -1));
    ...
    public static String m221628b(Context context) {
    ...
    /* JADX INFO: renamed from: a */
    public static void m221624a(Activity activity, String str) {
        if (activity == null) {
            return;
        }
        str.getClass();
    ...
    /* JADX INFO: renamed from: a */
    public static void m221625a(Activity activity, boolean z) {
        if (activity == null) {
            return;
        }
        if (z) {
    ...
    /* JADX INFO: renamed from: a */
    public static void m221623a(Activity activity, int i, int i2) {
    }

    /* JADX INFO: renamed from: a */
    public static boolean m221627a(Context context, String str) {
        if (context == null) {
            return false;
        }
    ...
    /* JADX INFO: renamed from: a */
    public static void m221622a(Activity activity, float f) {
    ...
    /* JADX INFO: renamed from: a */
    public static float m221620a(Activity activity) {
        float f = 0.0f;
        if (activity == null) {
            return 0.0f;
        }
    ...
    /* JADX INFO: renamed from: a */
    public static void m221626a(Context context, int i) {
        if (context == null) {
            return;
        }
