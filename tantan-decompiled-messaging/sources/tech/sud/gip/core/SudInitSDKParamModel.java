...
public class SudInitSDKParamModel {
    ...
    public boolean check() {
        if (this.context == null) {
            SudLogger.m221567e(_TAG, "Please check context invalid");
            LogUtils.file(FILE_TAG, "Please check context invalid");
            return false;
        }
        String str = this.appId;
        if (str == null || str.isEmpty()) {
            SudLogger.m221567e(_TAG, "Please check appId invalid");
        ...
        SudLogger.m221567e(_TAG, "Please check appKey invalid");
