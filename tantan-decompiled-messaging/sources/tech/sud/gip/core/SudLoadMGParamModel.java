...
public class SudLoadMGParamModel {
    ...
    public boolean check() {
        if (this.activity == null) {
            SudLogger.m221567e(_TAG, "Please check activity invalid");
            LogUtils.file(FILE_TAG, "Please check activity invalid");
            return false;
        }
        String str = this.userId;
        if (str == null || str.isEmpty()) {
            SudLogger.m221567e(_TAG, "Please check userId invalid");
            LogUtils.file(FILE_TAG, "Please check userId invalid");
            return false;
        }
        String str2 = this.roomId;
        if (str2 == null || str2.isEmpty()) {
            SudLogger.m221567e(_TAG, "Please check roomId invalid");
            LogUtils.file(FILE_TAG, "Please check roomId invalid");
            return false;
        }
        String str3 = this.code;
        if (str3 == null || str3.isEmpty()) {
            SudLogger.m221567e(_TAG, "Please check code invalid");
            LogUtils.file(FILE_TAG, "Please check code invalid");
            return false;
        }
        if (this.mgId <= 0) {
            SudLogger.m221567e(_TAG, "Please check mgId invalid");
            LogUtils.file(FILE_TAG, "Please check mgId invalid");
            return false;
        }
        String str4 = this.language;
        if (str4 == null || str4.isEmpty()) {
            SudLogger.m221573w(_TAG, "Please check language is null or empty");
        ...
        if (i != 0) {
            if (i != 1) {
                ...
                SudLogger.m221567e(_TAG, str5);
                LogUtils.file(FILE_TAG, str5);
                return false;
            }
            String str6 = this.authorizationSecret;
            if (str6 == null || str6.isEmpty()) {
                SudLogger.m221567e(_TAG, "Please check authorizationSecret invalid, loadMgMode=1");
