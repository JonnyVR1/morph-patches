...
public class Utils {
    ...
    private static Object getActivityThreadInActivityThreadStaticField() {
        try {
            ...
            SudLogger.m221567e(_TAG, "getActivityThreadInActivityThreadStaticField: " + e.getMessage());
            return null;
        }
    }
    ...
    private static Object getActivityThreadInActivityThreadStaticMethod() {
        try {
            ...
            SudLogger.m221567e(_TAG, "getActivityThreadInActivityThreadStaticMethod: " + e.getMessage());
            return null;
        }
    }
    ...
    public static Application getApp() {
        ...
        if (sApp == null) {
            jfd0.m141176a("reflect failed.");
            return null;
        }
        SudLogger.m221565d(_TAG, UtilsBridge.getCurrentProcessName() + " reflect app success.");
        return sApp;
    }
    ...
    public static void init(Application application) {
        if (application == null) {
            SudLogger.m221565d(_TAG, "app is null.");
            return;
        }
