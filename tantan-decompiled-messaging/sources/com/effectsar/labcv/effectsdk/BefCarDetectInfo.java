...
public class BefCarDetectInfo {
    ...
    public static class BefBrandInfo {
        int brandId;
        int[] brandOcr;
        private String[] ocrTable = {"", "0", "1", "2", "3", "4", "5", Constants.VIA_SHARE_TYPE_INFO, "7", Constants.VIA_SHARE_TYPE_PUBLISHVIDEO, Constants.VIA_SHARE_TYPE_MINI_PROGRAM, "A", "B", b2s.C_ZONE, "D", "E", "F", "G", "H", "J", "K", "L", "M", "N", "P", "Q", "R", j6f.LATITUDE_SOUTH, j6f.GPS_DIRECTION_TRUE, "U", j6f.GPS_MEASUREMENT_INTERRUPTED, "W", "X", "Y", "Z", "云", "京", "冀", "吉", "宁", "川", "新", "晋", "桂", "沪", "津", "浙", "渝", "湘", "琼", "甘", "皖", "粤", "苏", "蒙", "藏", "豫", "贵", "赣", "辽", "鄂", "闽", "陕", "青", "鲁", "黑"};
