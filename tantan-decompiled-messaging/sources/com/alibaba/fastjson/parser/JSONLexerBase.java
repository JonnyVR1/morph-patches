...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
                                    ...
                                    switch (next2) {
                                        ...
                                        default:
                                            switch (next2) {
                                                ...
                                                default:
                                                    this.f3873ch = next2;
                                                    riq.m179531a("unclosed single-quote string");
                                                    return;
                                            }
                                            break;
                                    }
    ...
    public float floatValue() {
        ...
        riq.m179531a("float overflow : ".concat(strNumberString));
        return 0.0f;
    }
                ...
                switch (c) {
                    ...
                    case '\'':
                        if (isEnabled(Feature.AllowSingleQuotes)) {
                            ...
                            riq.m179531a("Feature.AllowSingleQuotes is false");
                            return;
                        }
                    case '(':
                        next();
    ...
    public final void scanFalse() {
        if (this.f3873ch != 'f') {
            riq.m179531a("error parse false");
            return;
        }
        next();
        if (this.f3873ch != 'a') {
    ...
    public final void scanNullOrNew(boolean z) {
        if (this.f3873ch != 'n') {
            riq.m179531a("error parse null or new");
            return;
        }
        next();
        char c = this.f3873ch;
        if (c != 'u') {
            ...
            if (c2 == ' ' || c2 == ',' || c2 == '}' || c2 == ']' || c2 == '\n' || c2 == '\r' || c2 == '\t' || c2 == 26 || c2 == '\f' || c2 == '\b') {
                ...
                riq.m179531a("scan new error");
                return;
            }
        }
        next();
        if (this.f3873ch != 'l') {
            riq.m179531a("error parse null");
            return;
        }
        next();
        if (this.f3873ch != 'l') {
