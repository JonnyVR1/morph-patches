...
public class ASMSerializerFactory implements Opcodes {
    ...
    private void _if_write_null(MethodVisitor methodVisitor, FieldInfo fieldInfo, Context context) {
        ...
        int iM4802of = annotation != null ? SerializerFeature.m4802of(annotation.serialzeFeatures()) : 0;
        JSONType jSONType = context.beanInfo.jsonType;
        if (jSONType != null) {
            iM4802of |= SerializerFeature.m4802of(jSONType.serialzeFeatures());
        }
        if (cls == String.class) {
            ...
            if (!Collection.class.isAssignableFrom(cls)) {
                ...
                methodVisitor.visitVarInsn(25, context.var("out"));
                methodVisitor.visitLdcInsn(Integer.valueOf(iM4802of));
    ...
    public JavaBeanSerializer createJavaBeanSerializer(SerializeBeanInfo serializeBeanInfo) throws Exception {
        ...
        if (cls2.isPrimitive()) {
            riq.m179531a("unsupportd class ".concat(cls2.getName()));
            return null;
        }
