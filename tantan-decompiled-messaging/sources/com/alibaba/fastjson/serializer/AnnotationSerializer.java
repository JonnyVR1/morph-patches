        ...
        if (interfaces.length == 1 && interfaces[0].isAnnotation()) {
            ...
            if (sun_AnnotationType == null && !sun_AnnotationType_error) {
                try {
                    ...
                    piq.m169752a("not support Type Annotation.", th);
                    return;
                }
            }
            if (sun_AnnotationType == null) {
                riq.m179531a("not support Type Annotation.");
                return;
            }
            if (sun_AnnotationType_getInstance == null && !sun_AnnotationType_error) {
                try {
                    ...
                    sun_AnnotationType_error = true;
                    piq.m169752a("not support Type Annotation.", th2);
                    return;
                }
            }
            if (sun_AnnotationType_members == null && !sun_AnnotationType_error) {
                try {
                    ...
                    sun_AnnotationType_error = true;
                    piq.m169752a("not support Type Annotation.", th3);
                    return;
                }
            }
            if (sun_AnnotationType_getInstance == null || sun_AnnotationType_error) {
            ...
            try {
                try {
                    ...
                    sun_AnnotationType_error = true;
                    piq.m169752a("not support Type Annotation.", th4);
                }
            } catch (Throwable th5) {
                sun_AnnotationType_error = true;
                piq.m169752a("not support Type Annotation.", th5);
            }
        }
    }
}
