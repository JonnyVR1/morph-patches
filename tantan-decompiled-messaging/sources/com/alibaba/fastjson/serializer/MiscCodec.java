...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private static String toString(Node node) {
        try {
            ...
            piq.m169752a("xml node to string error", e);
            return null;
        }
    }
            ...
            if (str != null && str.length() != 0) {
                ...
                if (type == URL.class) {
                    try {
                        ...
                        piq.m169752a("create url error", e);
                        return null;
                    }
                }
                ...
                if (type != InetAddress.class && type != Inet4Address.class && type != Inet6Address.class) {
                    if (type == File.class) {
                        ...
                        riq.m179531a("file relative path not support.");
                        return null;
                    }
                    ...
                    if (name.equals("java.nio.file.Path")) {
                        try {
                            ...
                            piq.m169752a("Path deserialize erorr", e2);
                            return null;
                        } catch (NoSuchMethodException unused) {
                            method_paths_get_error = true;
                        } catch (InvocationTargetException e3) {
                            piq.m169752a("Path deserialize erorr", e3);
                            return null;
                        }
                    }
                    riq.m179531a("MiscCodec not support ".concat(name));
                    return null;
                }
                try {
                    return (T) InetAddress.getByName(str);
                } catch (UnknownHostException e4) {
                    piq.m169752a("deserialize inet adress error", e4);
                }
            }
            return null;
        }
            ...
            if (obj instanceof File) {
                ...
                if (obj.getClass().getName().equals("net.sf.json.JSONNull")) {
                    ...
                    if (!(obj instanceof Node)) {
                        siq.m184351a("not support class : ", cls);
                        return;
                    }
