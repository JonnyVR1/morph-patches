...
public class JSONPath implements JSONAware {
    ...
    public static /* synthetic */ class C08321 {
    ...
    public static class DoubleOpSegement implements Filter {
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            switch (C08321.$SwitchMap$com$alibaba$fastjson$JSONPath$Operator[this.f3852op.ordinal()]) {
                case 1:
    ...
    public static class IntOpSegement implements Filter {
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            if (propertyValue instanceof BigDecimal) {
                ...
                switch (C08321.$SwitchMap$com$alibaba$fastjson$JSONPath$Operator[this.f3853op.ordinal()]) {
                    case 1:
                        return iCompareTo == 0;
                    case 2:
                        return iCompareTo != 0;
    ...
    public static class JSONPathParser {
        ...
        public String readName() {
            ...
            if (c != '\\' && !Character.isJavaIdentifierStart(c)) {
                tiq.m189205a("illeal jsonpath syntax. ", this.path);
                return null;
            }
            StringBuilder sb = new StringBuilder();
            while (!isEOF()) {
            ...
            while (!isEOF()) {
                ...
                if (c2 != '$') {
                    if (c2 != '.' && c2 != '/') {
                        ...
                        tiq.m189205a("not support jsonpath : ", this.path);
                        return null;
                    }
                    next();
                    if (c2 == '.' && this.f3854ch == '.') {
                    ...
                    if (i3 == 12) {
                        ...
                        if (z2) {
                            ...
                            if (iSeekObjectToField2 == 3) {
                                ...
                                if (this.deep) {
                                    qq3.m175877a(jSONLexerBase.info());
                                    return;
                                }
                                jSONLexerBase.skipObject(false);
                            }
                        ...
                        switch (i3) {
                            ...
                            default:
                                ...
                                if (jSONLexerBase.token() == 16) {
                                    xiq.m209674a("illegal json : ", jSONLexerBase.info());
                                    return;
                                }
                                jSONLexerBase.nextToken();
                                break;
        ...
        public boolean apply(JSONPath jSONPath, Object obj, Object obj2, Object obj3) {
            ...
            if ((objEval instanceof Integer) || (objEval instanceof Long) || (objEval instanceof Short) || (objEval instanceof Byte)) {
                ...
                if ((propertyValue instanceof Integer) || (propertyValue instanceof Long) || (propertyValue instanceof Short) || (propertyValue instanceof Byte)) {
                    ...
                    switch (C08321.$SwitchMap$com$alibaba$fastjson$JSONPath$Operator[this.f3863op.ordinal()]) {
                        case 1:
    ...
    /* JADX INFO: renamed from: eq */
    public static boolean m4800eq(Object obj, Object obj2) {
        if (obj == obj2) {
            return true;
        }
    ...
    public void arrayAdd(Object obj, Object... objArr) {
        ...
        if (objEval == null) {
            tiq.m189205a("value not found in path ", this.path);
            return;
        }
        ...
        if (!cls.isArray()) {
            siq.m184351a("unsupported array put operation. ", cls);
            return;
        }
    ...
    public boolean containsValue(Object obj, Object obj2) {
        ...
        if (!(objEval instanceof Iterable)) {
            return m4800eq(objEval, obj2);
        }
        Iterator it = ((Iterable) objEval).iterator();
        while (it.hasNext()) {
            if (m4800eq(it.next(), obj2)) {
                return true;
            }
        }
        return false;
    ...
    public void deepGetPropertyValues(Object obj, List<Object> list) {
        ...
        if (javaBeanSerializer != null) {
            try {
                ...
                viq.m198602a("jsonpath error, path ", this.path, e);
                return;
            }
    ...
    public Set<?> evalKeySet(Object obj) {
        ...
        try {
            ...
            viq.m198602a("evalKeySet error : ", this.path, e);
            return null;
        }
    }
    ...
    public int evalSize(Object obj) {
        ...
        try {
            ...
            viq.m198602a("evalSize error : ", this.path, e);
            return 0;
        }
    }
