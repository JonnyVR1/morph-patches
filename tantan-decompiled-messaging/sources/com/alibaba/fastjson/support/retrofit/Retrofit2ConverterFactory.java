...
public class Retrofit2ConverterFactory extends Converter.Factory {
    ...
    public final class ResponseBodyConverter<T> implements Converter<gxc0, T> {
        private Type type;
    ...
    public static Retrofit2ConverterFactory create(FastJsonConfig fastJsonConfig) {
        ...
        jfd0.m141176a("fastJsonConfig == null");
        return null;
    }
    ...
    public Converter<Object, utc0> requestBodyConverter(Type type, Annotation[] annotationArr, Annotation[] annotationArr2, Retrofit retrofit) {
        return new RequestBodyConverter();
    }

    public Converter<gxc0, Object> responseBodyConverter(Type type, Annotation[] annotationArr, Retrofit retrofit) {
