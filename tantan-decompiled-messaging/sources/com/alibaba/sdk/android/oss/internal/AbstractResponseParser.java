...
public abstract class AbstractResponseParser<T extends OSSResult> implements ResponseParser {
    private CaseInsensitiveHashMap<String, String> parseResponseHeader(exc0 exc0Var) {
        ...
        for (int i = 0; i < oxkVarM118595F.m166559k(); i++) {
            caseInsensitiveHashMap.put(oxkVarM118595F.m166556f(i), oxkVarM118595F.m166561m(i));
        }
