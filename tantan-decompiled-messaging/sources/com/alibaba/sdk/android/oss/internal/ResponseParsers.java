...
public final class ResponseParsers {
    ...
    public static final class CompleteMultipartUploadResponseParser extends AbstractResponseParser<CompleteMultipartUploadResult> {
        ...
        public CompleteMultipartUploadResult parseData(ResponseMessage responseMessage, CompleteMultipartUploadResult completeMultipartUploadResult) throws Exception {
            ...
            String strString = responseMessage.getResponse().m118606k().string();
    ...
    public static Exception parseResponseErrorXML(ResponseMessage responseMessage, boolean z) {
        ...
        String strM118611u = responseMessage.getResponse().m118611u(OSSHeaders.OSS_HEADER_REQUEST_ID);
        String strM118611u2 = responseMessage.getResponse().m118611u(OSSHeaders.OSS_HEADER_EC);
        String strM118611u3 = responseMessage.getResponse().m118611u("Date");
        String strNextText3 = null;
        if (z) {
            str4 = strM118611u2;
            str3 = null;
                ...
                while (eventType != 1) {
                    if (eventType == 2) {
                        if ("Code".equals(xmlPullParserNewPullParser.getName())) {
                            ...
                            strM118611u = xmlPullParserNewPullParser.nextText();
                            ...
                            strM118611u2 = xmlPullParserNewPullParser.nextText();
        ...
        ServiceException serviceException = new ServiceException(statusCode, str5, strNextText3, strM118611u, strNextText, str2, str4);
        ...
        if (!TextUtils.isEmpty(strM118611u3)) {
            serviceException.setDate(strM118611u3);
        }
