...
public class OSSClient implements OSS {
    ...
    public static class Builder {
        private ClientConfiguration clientConfiguration = ClientConfiguration.getDefaultConf();
        ...
        public OSS build() {
            OSSUtils.assertNotNull(this.context, "Endpoint haven't been set!");
            OSSUtils.assertNotNull(this.endpoint, "Endpoint haven't been set!");
            OSSUtils.assertNotNull(this.credentialProvider, "CredentialProvider haven't been set!");
            if (this.clientConfiguration.getSignVersion().equals(SignVersion.V4)) {
                OSSUtils.assertNotNull(this.region, "Region haven't been set!");
            }
            OSSClient oSSClient = new OSSClient(this.context, this.endpoint, this.credentialProvider, this.clientConfiguration);
        ...
        public Builder cloudBoxId(String str) {
            this.cloudBoxId = str;
            return this;
        }
        ...
        public Builder credentialsProvider(OSSCredentialProvider oSSCredentialProvider) {
    ...
    @Override // com.alibaba.sdk.android.oss.OSS
    public DeleteObjectTaggingResult deleteObjectTagging(DeleteObjectTaggingRequest deleteObjectTaggingRequest) throws ServiceException, ClientException {
    ...
    @Override // com.alibaba.sdk.android.oss.OSS
    public GetObjectMetaResult getObjectMeta(GetObjectMetaRequest getObjectMetaRequest) throws ServiceException, ClientException {
        return this.mOss.getObjectMeta(getObjectMetaRequest);
    }

    @Override // com.alibaba.sdk.android.oss.OSS
    public GetObjectTaggingResult getObjectTagging(GetObjectTaggingRequest getObjectTaggingRequest) throws ServiceException, ClientException {
    ...
    @Override // com.alibaba.sdk.android.oss.OSS
    public PutObjectTaggingResult putObjectTagging(PutObjectTaggingRequest putObjectTaggingRequest) throws ServiceException, ClientException {
