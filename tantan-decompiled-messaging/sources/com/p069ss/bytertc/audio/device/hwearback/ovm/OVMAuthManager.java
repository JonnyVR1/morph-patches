...
import com.p069ss.bytertc.audio.device.hwearback.ovm.OVMAuthManager;
...
public class OVMAuthManager extends Handler {
    ...
    private OVMAuthManager() {
        ...
        this.notifyResultRunnable = new Runnable() { // from class: l.b050
            ...
            public final void run() {
                OVMAuthManager.m80828a(this.f72409a);
            }
        };
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m80828a(OVMAuthManager oVMAuthManager) {
        ArrayList arrayList;
    ...
    public void handleMessage(@NonNull Message message) {
        ...
        synchronized (this) {
            try {
                ...
                if (data == null) {
                    RXLogging.m5688e(TAG, "handleMessage get bundle is null");
                } else {
    ...
    public void startAuth(Context context, String str) {
        if (ManufacturerChecker.getManufacturerType() != ManufacturerChecker.Type.OP) {
            RXLogging.m5688e(TAG, "no need to auth");
        ...
        try {
            ...
            RXLogging.m5690i(TAG, "url is not exist, do not need auth ");
            this.mAuthResultCode = -3;
            notifyResult();
        } catch (RuntimeException e) {
            RXLogging.m5688e(TAG, "auth error " + e.toString());
