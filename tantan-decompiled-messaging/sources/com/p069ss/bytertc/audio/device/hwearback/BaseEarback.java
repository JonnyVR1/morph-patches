...
public abstract class BaseEarback implements IHardWareEarback {
    ...
    private void changeState(EarbackState earbackState) {
        RXLogging.m5690i(TAG, "changeState: " + this.state + " -> " + earbackState);
    ...
    public synchronized int close() {
        RXLogging.m5690i(TAG, "close() with state: " + this.state);
    ...
    public synchronized int init() {
        try {
            RXLogging.m5690i(TAG, "init() with state: " + this.state);
    ...
    public synchronized int open() {
        RXLogging.m5690i(TAG, "open() with state: " + this.state);
    ...
    public synchronized int release() {
        RXLogging.m5690i(TAG, "release() with state: " + this.state);
        EarbackState earbackState = this.state;
