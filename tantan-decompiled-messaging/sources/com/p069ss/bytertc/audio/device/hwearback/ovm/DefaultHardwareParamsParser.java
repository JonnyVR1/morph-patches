...
public class DefaultHardwareParamsParser implements IHardwareParamsParser {
    ...
    @Override // com.p069ss.bytertc.audio.device.hwearback.ovm.IHardwareParamsParser
                ...
                try {
                    ...
                    for (int i3 = 0; i3 < jSONArray2.length(); i3++) {
                        ...
                        if (string7.contains("|")) {
                            ...
                            } else if (ManufacturerChecker.getManufacturerType() == ManufacturerChecker.Type.OP && Constants.VIA_SHARE_TYPE_PUBLISHVIDEO.equals(string7)) {
                                record.flags = -1;
                            } else {
