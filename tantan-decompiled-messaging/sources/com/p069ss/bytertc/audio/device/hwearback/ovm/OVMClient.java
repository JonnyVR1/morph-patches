...
import com.p069ss.bytertc.audio.device.hwearback.ovm.OVMClient;
import p149l.ii5;
...
public class OVMClient {
    ...
    private OVMAuthManager.AuthCallback mRestartAuthCallback = new OVMAuthManager.AuthCallback() { // from class: com.ss.bytertc.audio.device.hwearback.ovm.OVMClient.2
        ...
        public void onResult(int i) {
            ...
            RXLogging.m5690i(OVMClient.TAG, "onRestartListener result: " + i);
            ...
            if (OVMClient.this.mStorage.isKTVDeviceOpen && i == 1001 && (oVMKaraokeMediaHelperLockMediaHelper = OVMClient.this.lockMediaHelper()) != null) {
                RXLogging.m5690i(OVMClient.TAG, "openKTVDevice duration restart.");
    ...
    private BroadcastReceiver headsetPlugReceiver = new BroadcastReceiver() { // from class: com.ss.bytertc.audio.device.hwearback.ovm.OVMClient.3
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action == null) {
                RXLogging.m5688e(OVMClient.TAG, "action is null");
                return;
            }
            RXLogging.m5690i(OVMClient.TAG, "onReceive: " + intent);
            Bundle extras = intent.getExtras();
            if (extras != null) {
                for (String str : extras.keySet()) {
                    RXLogging.m5690i(OVMClient.TAG, str + ": " + extras.get(str));
                }
            }
            if (action.equals("android.intent.action.HEADSET_PLUG")) {
                ...
                if (!z2) {
                    RXLogging.m5690i(OVMClient.TAG, "headset plug not changed, ignore");
                    return;
                }
                if (z) {
                    RXLogging.m5690i(OVMClient.TAG, "need restart media helper");
                ...
                RXLogging.m5690i(OVMClient.TAG, "closeKTVDevice and feedback with unplug headset");
    ...
    public static /* synthetic */ class C133464 {
        ...
        static {
            ...
            try {
                f55579x4837e59[ManufacturerChecker.Type.VO.ordinal()] = 2;
    ...
    public static /* synthetic */ void m80829a(OVMClient oVMClient) {
        oVMClient.getClass();
        RXLogging.m5690i(TAG, "restart media helper");
        if (!oVMClient.isSupported() || !oVMClient.mStorage.isKTVDeviceOpen) {
            RXLogging.m5688e(TAG, "restart with error, return: " + oVMClient.isSupported() + ", " + oVMClient.mStorage.isKTVDeviceOpen);
            return;
        }
        int i = C133464.f55579x4837e59[ManufacturerChecker.getManufacturerType().ordinal()];
        if (i == 1) {
        ...
        RXLogging.m5690i(TAG, "closeKTVDevice duration restart.");
        oVMKaraokeMediaHelperLockMediaHelper.openKTVDevice();
        oVMClient.restoreParams(oVMKaraokeMediaHelperLockMediaHelper);
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m80830b(OVMClient oVMClient) {
        OVMKaraokeMediaHelper oVMKaraokeMediaHelperLockMediaHelper = oVMClient.lockMediaHelper();
        if (oVMKaraokeMediaHelperLockMediaHelper == null || !oVMClient.mStorage.isKTVDeviceOpen) {
            return;
        }
        RXLogging.m5690i(TAG, "openKTVDevice duration restore params.");
        oVMClient.restoreParams(oVMKaraokeMediaHelperLockMediaHelper);
    }
    ...
    private void initClient(Context context) {
        RXLogging.m5690i(TAG, "initClient");
        boolean z = false;
    ...
    private void initMediaHelper(OVMAuthManager.AuthCallback authCallback) {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5689e(TAG, "init media helper error", th);
        }
    }
    ...
    private void registerHeadsetPlugEvent() {
        if (this.mIsSupport && this.mContext != null && needRegisterHeadsetPlug()) {
            RXLogging.m5690i(TAG, "registerHeadsetPlug");
            try {
                IntentFilter intentFilter = new IntentFilter();
                intentFilter.addAction("android.intent.action.HEADSET_PLUG");
                boolean z = true;
                if (ii5.m136342l(this.mContext, this.headsetPlugReceiver, intentFilter).getIntExtra("state", -99) != 1) {
                    z = false;
                }
                this.mIsHeadsetConnected = z;
            } catch (Throwable th) {
                RXLogging.m5689e(TAG, "registerReceiver error", th);
            }
        }
    }
    ...
    private void restoreParams(OVMKaraokeMediaHelper oVMKaraokeMediaHelper) {
        RXLogging.m5690i(TAG, "restore params: " + this.mStorage.toString());
    ...
    private void unRegisterHeadsetPlugEvent() {
        ...
        RXLogging.m5690i(TAG, "unregisterHeadsetPlug");
        try {
            this.mContext.unregisterReceiver(this.headsetPlugReceiver);
        } catch (Throwable th) {
            RXLogging.m5689e(TAG, "unregisterReceiver error", th);
        }
    }

    public synchronized void closeKTVDevice() {
        RXLogging.m5690i(TAG, "closeKTVDevice");
    ...
    public synchronized void openKTVDevice() {
        RXLogging.m5690i(TAG, "openKTVDevice");
        this.mStorage.isKTVDeviceOpen = true;
        OVMKaraokeMediaHelper oVMKaraokeMediaHelperLockMediaHelper = lockMediaHelper();
        if (oVMKaraokeMediaHelperLockMediaHelper != null) {
            oVMKaraokeMediaHelperLockMediaHelper.openKTVDevice();
    ...
    public void release() {
        ...
        if (this.mNeedDestroyWhenRelease) {
            synchronized (OVMClient.class) {
                try {
                    RXLogging.m5690i(TAG, "clear sClient");
                    if (sClient == this) {
                        sClient = null;
                    }
                } catch (Throwable th) {
    ...
    public synchronized void resetKTVParamsAndUpdate() {
        RXLogging.m5690i(TAG, "resetKTVParamsAndUpdate");
        this.mStorage.reset();
    ...
    public void setEqualizerType(int i) {
        RXLogging.m5690i(TAG, "setEqualizerType: " + i);
    ...
    public void setListenRecordSame(int i) {
        RXLogging.m5690i(TAG, "setListenRecordSame: " + i);
    ...
    public void setMicVolParam(int i) {
        RXLogging.m5690i(TAG, "setMicVolParam: " + i);
    ...
    public void setMixerSoundType(int i) {
        RXLogging.m5690i(TAG, "setMixerSoundType: " + i);
    ...
    public void setPlayFeedbackParam(int i) {
        RXLogging.m5690i(TAG, "setPlayFeedbackParam: " + i);
