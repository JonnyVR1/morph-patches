...
public class AudioRouteDeviceManager extends BroadcastReceiver {
            ...
            for (AudioDeviceInfo audioDeviceInfo : audioDeviceInfoArr) {
                if (!audioDeviceInfo.isSource()) {
                    ...
                    if (type == 7 && AudioRouteDeviceManager.this.mCallback != null) {
                        ...
                        RXLogging.m5692w(AudioRouteDeviceManager.TAG, "AudioRouteDeviceManager: addedDevices: " + type + ", name: " + string);
                        ...
                        RXLogging.m5692w(AudioRouteDeviceManager.TAG, "AudioRouteDeviceManager: addedDevices: " + type + ", name: " + string2);
                        synchronized (AudioRouteDeviceManager.this.bluetoothLock) {
                            try {
                                if (AudioRouteDeviceManager.this.mBluetoothDevice == null) {
        ...
        public void onAudioDevicesRemoved(AudioDeviceInfo[] audioDeviceInfoArr) {
            for (AudioDeviceInfo audioDeviceInfo : audioDeviceInfoArr) {
                if (!audioDeviceInfo.isSource()) {
                    int type = audioDeviceInfo.getType();
                    if (type == 7 && AudioRouteDeviceManager.this.mCallback != null) {
                        RXLogging.m5692w(AudioRouteDeviceManager.TAG, "AudioRouteDeviceManager: removedDevices: " + type + ", name: " + ((Object) audioDeviceInfo.getProductName()));
                        String attrsString = "";
                        synchronized (AudioRouteDeviceManager.this.bluetoothLock) {
                            try {
                                if (AudioRouteDeviceManager.this.mBluetoothDevice != null) {
                                    ...
                                    if (!AudioRouteDeviceManager.this.mBluetoothDevice.getBluetoothConnected(1) && !AudioRouteDeviceManager.this.mBluetoothDevice.getBluetoothConnected(2)) {
                                        RXLogging.m5692w(AudioRouteDeviceManager.TAG, "AudioRouteDeviceManager: destroy mBluetoothDevice due to headset & a2dp disconncected");
    ...
    public void bluetoothScoConnectionCheck() {
        ...
        if (context == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoConnectionCheck failed. Context is null.");
            return;
        }
        AudioManager audioManager = (AudioManager) context.getSystemService("audio");
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoConnectionCheck failed. AudioManager is null.");
            return;
        }
        if (this.mBluetoothScoConnectCheckTimes >= 3) {
            ...
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoConnectionCheck timeout, time: " + this.mBluetoothScoConnectCheckTimes);
        ...
        if (audioManager.isBluetoothScoOn()) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoConnectionCheck success.");
            this.mBluetoothScoConnectCheckTimes = -1;
            this.mHandler.removeCallbacks(new vc1(this));
            return;
        }
        this.mBluetoothScoConnectCheckTimes++;
        RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoConnectionCheck failed. retry again, time: " + this.mBluetoothScoConnectCheckTimes);
    ...
    public void bluetoothScoDisconnectionForNormalMode() {
        Context context = AudioRouteUtil.getContext();
        if (context == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoDisconnectionForNormalMode failed. Context is null.");
            return;
        }
        AudioManager audioManager = (AudioManager) context.getSystemService("audio");
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoDisconnectionForNormalMode failed. AudioManager is null.");
            return;
        }
        int mode = audioManager.getMode();
        boolean zIsBluetoothScoOn = audioManager.isBluetoothScoOn();
        RXLogging.m5688e(TAG, "AudioRouteDeviceManager: bluetoothScoDisconnectionForNormalMode mode(" + mode + "), bluetoothScoOn(" + zIsBluetoothScoOn + ")");
        if (mode == 0) {
    ...
    private boolean checkPermission() {
        ...
        if (i2 >= 23) {
            ...
            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: mUseAudioDeviceCallback: " + this.mUseAudioDeviceCallback);
        }
        if (i >= 31 && i2 >= 31) {
            if (context.checkCallingOrSelfPermission("android.permission.BLUETOOTH_CONNECT") != 0) {
                ...
                RXLogging.m5688e(TAG, sb.toString());
                return false;
            }
            ...
            RXLogging.m5692w(TAG, sb2.toString());
            return true;
        }
        if (context.checkCallingOrSelfPermission("android.permission.BLUETOOTH") == 0) {
            ...
            RXLogging.m5692w(TAG, sb3.toString());
            return true;
        }
    ...
    private boolean hasValidBtDeviceMajor(int i, final String[] strArr) {
        ...
        if (i == 1) {
            try {
                this.mBluetoothAdapter.getProfileProxy(context, new BluetoothProfile.ServiceListener() { // from class: com.ss.bytertc.audio.device.router.AudioRouteDeviceManager.1
                    ...
                    public void onServiceConnected(int i2, BluetoothProfile bluetoothProfile) {
                        ...
                        try {
                            ...
                            RXLogging.m5689e(AudioRouteDeviceManager.TAG, "AudioRouteDeviceManager: BluetoothProfile getConnectedDevices failed.", th);
                        }
                        synchronized (obj) {
                            obj.notify();
                        }
                ...
                RXLogging.m5689e(TAG, "AudioRouteDeviceManager: hasValidBtDeviceMajor failed.", th);
            }
        }
        return zArr[0];
    }
    ...
    private boolean headsetPlugActionIsFromUsbHeadset(Intent intent) {
        ...
        RXLogging.m5692w(TAG, "ACTION_HEADSET_PLUG info, address: " + stringExtra + ", portName: " + stringExtra2 + ", connected: " + intent.getIntExtra("state", -99) + ", hasMic: " + intent.getIntExtra("microphone", -99));
        ...
        RXLogging.m5688e(TAG, "AudioRouteDeviceManager: received ACTION_HEADSET_PLUG, may be is a usb device");
        return true;
    }
    ...
    private void initBluetooth() {
        ...
        if (checkPermission()) {
            ...
            try {
                boolean z4 = 2 == ii5.m136334d(defaultAdapter, 1) && hasValidBtDeviceMajor(1, strArr);
                try {
                    z3 = z4;
                    z2 = 2 == ii5.m136334d(this.mBluetoothAdapter, 2);
                } catch (Throwable th) {
                    z = z4;
                    th = th;
                    RXLogging.m5689e(TAG, "AudioRouteDeviceManager: getProfileConnectionState failed.", th);
                    z2 = false;
                    z3 = z;
                }
            } catch (Throwable th2) {
    ...
    private void initHandler() {
        ...
        if (looperMyLooper == null && (looperMyLooper = Looper.getMainLooper()) == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: initHandler failed");
            return;
        }
        Handler handler = new Handler(looperMyLooper);
        this.mHandler = handler;
        handler.removeCallbacks(new vc1(this));
        RXLogging.m5688e(TAG, "AudioRouteDeviceManager: initHandler success");
    }

    private boolean initHeadset() {
        Intent intentM136342l;
        Context context = AudioRouteUtil.getContext();
        return (context == null || (intentM136342l = ii5.m136342l(context, this, new IntentFilter(ACTION_HEADSET_PLUG))) == null || headsetPlugActionIsFromUsbHeadset(intentM136342l) || 1 != intentM136342l.getIntExtra("state", -99)) ? false : true;
    }
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (hasAudioForUsbDevice(usbDevice)) {
                    ...
                    RXLogging.m5688e(TAG, "AudioRouteDeviceManager: initUsbHeadset finished.");
                    return true;
                }
            }
        } catch (Throwable th) {
            RXLogging.m5689e(TAG, "AudioRouteDeviceManager: initUsbHeadset failed.", th);
        }
        return false;
    }
    ...
    public boolean isBtDeviceMajorValid(Context context, int i, BluetoothDevice bluetoothDevice, String[] strArr) {
        ...
        if (i2 < 31 || i3 < 31 ? context.checkCallingOrSelfPermission("android.permission.BLUETOOTH") == 0 : context.checkCallingOrSelfPermission("android.permission.BLUETOOTH_CONNECT") == 0) {
            try {
                ...
                RXLogging.m5689e(TAG, "AudioRouteDeviceManager: isBtDeviceMajorValid failed.", th);
            }
        }
        return true;
    }
    ...
    private int registerReceiver() {
        ...
        if (this.registered) {
            RXLogging.m5690i(TAG, "registerReceiver registered");
            return 0;
        }
        this.registered = true;
        ii5.m136342l(context, this, this.mIntentFilter);
        if (this.mUseAudioDeviceCallback) {
            AudioManager audioManager = (AudioManager) context.getSystemService("audio");
            if (audioManager == null) {
                return -2;
        ...
        RXLogging.m5692w(TAG, "AudioRouteDeviceManager: registerReceiver SkipBluetooth:" + this.mUseAudioDeviceCallback);
        return 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void restartBluetoothScoAsynTask() {
        RXLogging.m5692w(TAG, "restartBluetoothScoAsynTask enter.");
        if (this.mBluetoothDevice == null) {
            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: restartBluetoothScoAsynTask skip, no bluetooth device now.");
            return;
        }
        if (bluetoothScoIsStarting()) {
            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: restartBluetoothScoAsynTask skip. sco is starting.");
            return;
        }
        Context context = AudioRouteUtil.getContext();
        if (context == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: restartBluetoothScoAsynTask failed. Context is null.");
            return;
        }
        AudioManager audioManager = (AudioManager) context.getSystemService("audio");
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: restartBluetoothScoAsynTask failed. AudioManager is null.");
        } else {
            startSystemBluetoothSco(audioManager);
            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: restartBluetoothScoAsynTask has start bluetooth.");
        }
    }
    ...
    private void startSystemBluetoothSco(AudioManager audioManager) {
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: startSystemBluetoothSco skipped, audioManager is null");
            return;
        }
        try {
            ...
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: startSystemBluetoothSco failed, Exception: " + e.toString());
        }
    }

    private void stopSystemBluetoothSco(AudioManager audioManager) {
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: stopSystemBluetoothSco skipped, audioManager is null");
            return;
        }
        try {
            ...
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: stopSystemBluetoothSco failed, Exception: " + e.toString());
        }
    }
    ...
    private int unregisterReceiver() {
        ...
        RXLogging.m5692w(TAG, "AudioRouteDeviceManager: unregisterReceiver SkipBluetooth:" + this.mUseAudioDeviceCallback);
        return 0;
    }
    ...
    public String getSessionInfo() {
        ...
        boolean z = true;
        boolean z2 = false;
        boolean z3 = e16.m114373a(context, "android.permission.RECORD_AUDIO") == 0;
        int i = context.getApplicationInfo().targetSdkVersion;
        if (30 <= i && i < 34) {
            if (e16.m114373a(context, "android.permission.FOREGROUND_SERVICE") != 0) {
                z = false;
            }
            z2 = z;
        } else if (34 <= i) {
            if (e16.m114373a(context, "android.permission.FOREGROUND_SERVICE") != 0 || e16.m114373a(context, "android.permission.FOREGROUND_SERVICE_MICROPHONE") != 0) {
                z = false;
            }
            z2 = z;
        }
        try {
            ...
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: ".concat(str));
            return str;
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: action is null");
            return;
        }
        String attrsString = "";
        int i = 16;
            ...
            if (action.equals(ACTION_BT_HEADSET_CONNECTION_STATE_CHANGED)) {
                ...
                if (intExtra2 != 0) {
                    if (intExtra2 == 1) {
                        ...
                        if (intExtra2 == 2) {
                            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_HEADSET_CONNECTION_STATE_CHANGED:STATE_CONNECTED:" + bluetoothDevice);
                            String[] strArr = {""};
                            ...
                            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_HEADSET_CONNECTION_STATE_CHANGED, unknown state: " + intExtra2);
                        }
                        z7 = false;
                    }
                    z8 = z7;
                } else {
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_HEADSET_CONNECTION_STATE_CHANGED:STATE_DISCONNECTED:" + bluetoothDevice);
                    synchronized (this.bluetoothLock) {
                        try {
                            MyBluetoothDevice myBluetoothDevice = this.mBluetoothDevice;
                            if (myBluetoothDevice != null) {
                                ...
                                if (!this.mBluetoothDevice.getBluetoothConnected(1) && !this.mBluetoothDevice.getBluetoothConnected(2)) {
                                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: destroy mBluetoothDevice due to headset & a2dp disconncected" + bluetoothDevice);
                                    this.mBluetoothDevice = null;
                                }
                            }
                        } catch (Throwable th2) {
                ...
                if (intExtra3 == 0) {
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_A2DP_CONNECTION_STATE_CHANGED:STATE_DISCONNECTED:" + bluetoothDevice2);
                    synchronized (this.bluetoothLock) {
                        try {
                            MyBluetoothDevice myBluetoothDevice2 = this.mBluetoothDevice;
                            if (myBluetoothDevice2 != null) {
                                ...
                                attrsString = this.mBluetoothDevice.getAttrsString();
                                if (!this.mBluetoothDevice.getBluetoothConnected(1) && !this.mBluetoothDevice.getBluetoothConnected(2)) {
                                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: destroy mBluetoothDevice due to headset & a2dp disconncected" + bluetoothDevice2);
                                    this.mBluetoothDevice = null;
                                }
                            }
                        } catch (Throwable th3) {
                    ...
                    if (intExtra3 != 3) {
                        RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_A2DP_CONNECTION_STATE_CHANGED, unknown state: " + intExtra3);
                    }
                    z5 = false;
                    z6 = false;
                } else {
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_A2DP_CONNECTION_STATE_CHANGED:STATE_CONNECTED:" + bluetoothDevice2);
                    String[] strArr2 = {""};
                    synchronized (this.bluetoothLock) {
                ...
                if (intExtra != 0) {
                    if (intExtra != 1) {
                        ...
                        RXLogging.m5692w(TAG, "AudioRouteDeviceManager: SCO_AUDIO_STATE_CONNECTED");
                        synchronized (this.bluetoothLock) {
                            try {
                    ...
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: SCO_AUDIO_STATE_DISCONNECTED");
                    synchronized (this.bluetoothLock) {
                        try {
                ...
                if (action.equals(ACTION_USB_DEVICE_ATTACHED)) {
                    ...
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_USB_DEVICE_ATTACHED:" + usbDevice);
                    if (hasAudioForUsbDevice(usbDevice)) {
                        this.mUsbHeadsetDevice = usbDevice;
                        z4 = true;
                    } else {
                    ...
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_USB_DEVICE_DETACHED:" + usbDevice2);
                    ...
                    RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_HEADSET_PLUG:".concat(z10 ? "connected" : "disconnected"));
                    if (z10) {
        ...
        if (intExtra == 10) {
            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_STATE_CHANGED:STATE_OFF:" + this.mBluetoothDevice);
            ...
            synchronized (this.bluetoothLock) {
                try {
                    if (this.mBluetoothDevice != null) {
                        RXLogging.m5692w(TAG, "AudioRouteDeviceManager: destroy mBluetoothDevice due to bluetooth adapter is closed: " + bluetoothDevice3);
                        this.mBluetoothDevice = null;
                    }
                } catch (Throwable th7) {
                    throw th7;
        ...
        if (intExtra == 12) {
            RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ACTION_BT_STATE_CHANGED:STATE_ON:" + bluetoothDevice3);
        }
        i = 8;
        z = false;
        z2 = false;
    ...
    public int release() {
        ...
        if (unregisterReceiver() != 0) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: unregisterReceiver failed.");
            i = -1;
        } else {
            i = 0;
        }
    ...
    public void restartBluetoothSco() {
        Handler handler;
        RXLogging.m5692w(TAG, "restartBluetoothSco enter.");
        if (this.mBluetoothDevice == null) {
            RXLogging.m5692w(TAG, "restartBluetoothSco skip, no bluetooth device now.");
            this.mHandler.removeCallbacks(new Runnable() { // from class: l.uc1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f175781a.restartBluetoothScoAsynTask();
                }
            });
            return;
        }
        Context context = AudioRouteUtil.getContext();
        if (context == null) {
            RXLogging.m5688e(TAG, "restartBluetoothSco failed. Context is null.");
            return;
        }
        AudioManager audioManager = (AudioManager) context.getSystemService("audio");
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "restartBluetoothSco failed. AudioManager is null.");
            return;
        }
        if (3 != audioManager.getMode()) {
            RXLogging.m5688e(TAG, "restartBluetoothSco failed. Not in communication mode.");
            return;
        }
        if (bluetoothScoIsStarting()) {
            RXLogging.m5692w(TAG, "restartBluetoothSco skip. sco is starting.");
            return;
        }
        int i = this.mBluetoothScoRestartTimes + 1;
        this.mBluetoothScoRestartTimes = i;
        if (i <= 3) {
            RXLogging.m5692w(TAG, "restartBluetoothScoAsynTask, restart time: " + this.mBluetoothScoRestartTimes);
        ...
        RXLogging.m5692w(TAG, "restartBluetoothSco leave.");
    }

    public int setAudioRoute(@RoutingDeviceType int i, boolean z) {
        Context context = AudioRouteUtil.getContext();
        if (context == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: setAudioRoute failed. Context is null.");
            return -1;
        }
        AudioManager audioManager = (AudioManager) context.getSystemService("audio");
        if (audioManager == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: setAudioRoute failed. AudioManager is null.");
            return -2;
        }
        if (this.mCallback == null) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: setAudioRoute failed. mCallback is null.");
            return -6;
        }
        int mode = audioManager.getMode();
        int i2 = z ? 0 : 3;
        if (i2 != mode) {
            RXLogging.m5688e(TAG, "AudioRouteDeviceManager: isMediaMode:" + z + ", cacheMode:" + i2 + ", systemMode: " + mode + " not matched with system!!!");
            audioManager.setMode(i2);
            mode = audioManager.getMode();
        }
        boolean zIsSpeakerphoneOn = audioManager.isSpeakerphoneOn();
        boolean zIsBluetoothScoOn = audioManager.isBluetoothScoOn();
        RXLogging.m5688e(TAG, "AudioRouteDeviceManager: setAudioRoute, deviceType: " + routingDeviceType2Text(i) + ", cacheMode:" + i2 + ", systemMode: " + mode + ", speakerPhoneOn: " + zIsSpeakerphoneOn + ", bluetoothScoOn: " + zIsBluetoothScoOn);
        if (mode != 3) {
            if (mode != 0) {
                RXLogging.m5688e(TAG, "AudioRouteDeviceManager: mode(" + mode + ") is not support to setAudioRoute");
                return -4;
            }
            if (zIsBluetoothScoOn || this.mScoHasStarted) {
                RXLogging.m5692w(TAG, "AudioRouteDeviceManager: MODE_NORMAL,but BluetoothScoOn is true, force to close sco.");
                stopSystemBluetoothSco(audioManager);
            }
            Handler handler = this.mHandler;
            if (handler != null) {
                ...
                this.mHandler.postDelayed(new Runnable() { // from class: l.wc1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f185636a.bluetoothScoDisconnectionForNormalMode();
                    }
                }, 6000L);
            }
            if (i == 2) {
        ...
        if (i == 8) {
            ...
            if (!zIsBluetoothScoOn && !zBluetoothScoIsStarting) {
                RXLogging.m5692w(TAG, "AudioRouteDeviceManager: ready to start sco");
            ...
            if (i == 2) {
                ...
                if (i != 1 && i != 4 && i != 32) {
                    if (i == 16) {
                        RXLogging.m5688e(TAG, "AudioRouteDeviceManager: Error: setAudioRoute to a2dp in communication mode");
                        return -7;
                    }
                    RXLogging.m5688e(TAG, "AudioRouteDeviceManager: setAudioRoute failed. deviceType(" + routingDeviceType2Text(i) + ") invalid.");
                    return -3;
                }
                if (zIsSpeakerphoneOn) {
                    audioManager.setSpeakerphoneOn(false);
    ...
    public void setUseAudioDeviceCallback(boolean z, IAudioRouteCallback iAudioRouteCallback) {
        ...
        this.mCallback = iAudioRouteCallback;
        RXLogging.m5692w(TAG, "AudioRouteDeviceManager: setUseAudioDeviceCallback:" + z);
    }
