package com.p069ss.bytertc.audio.device.webrtc.observer;
...
public class MicMuteChangedObserver {
    ...
    private void registerReceiver() {
        ...
        ii5.m136342l(applicationContext, micMuteBroadCastReceiver, new IntentFilter("android.media.action.MICROPHONE_MUTE_CHANGED"));
    }
