...
public class WebRtcAudioRecord {
    ...
    public class AudioRecordThread extends Thread {
        ...
        public void run() {
            ...
            RXLogging.m5690i(WebRtcAudioRecord.TAG, "AudioRecordThread" + WebRtcAudioUtils.getThreadInfo());
            if (WebRtcAudioRecord.this.audioRecord == null || WebRtcAudioRecord.this.audioRecord.getRecordingState() != 3) {
                ...
                RXLogging.m5688e(WebRtcAudioRecord.TAG, string);
            ...
            while (true) {
                ...
                if (!z) {
                    try {
                        ...
                        RXLogging.m5688e(WebRtcAudioRecord.TAG, "AudioRecord.stop failed: " + e.getMessage());
                        return;
                    }
                }
                try {
                    ...
                    RXLogging.m5688e(WebRtcAudioRecord.TAG, "audioRecord.read failed: " + e2.getMessage());
                    this.keepAlive = false;
                    i = -1;
                }
                if (i == WebRtcAudioRecord.this.byteBuffer.capacity()) {
                    ...
                    RXLogging.m5688e(WebRtcAudioRecord.TAG, str);
        ...
        public void stopThread() {
            synchronized (this) {
                RXLogging.m5690i(WebRtcAudioRecord.TAG, "stopThread");
                this.keepAlive = false;
            }
        }
    }
    ...
    private boolean enableBuiltInAEC(boolean z) {
        RXLogging.m5690i(TAG, "enableBuiltInAEC(" + z + ')');
        WebRtcAudioEffects webRtcAudioEffects = this.effects;
        if (webRtcAudioEffects != null) {
            return webRtcAudioEffects.setAEC(z);
        }
        RXLogging.m5688e(TAG, "Built-in AEC is not supported on this platform");
        return false;
    }

    private boolean enableBuiltInNS(boolean z) {
        RXLogging.m5690i(TAG, "enableBuiltInNS(" + z + ')');
        WebRtcAudioEffects webRtcAudioEffects = this.effects;
        if (webRtcAudioEffects != null) {
            return webRtcAudioEffects.setNS(z);
        }
        RXLogging.m5688e(TAG, "Built-in NS is not supported on this platform");
        return false;
    }
    ...
    private int initRecording(int i, int i2, int i3, boolean z, int i4) {
        ...
        RXLogging.m5690i(TAG, "byteBuffer.capacity: " + this.byteBuffer.capacity());
        ...
        RXLogging.m5690i(TAG, "AudioRecord.getMinBufferSize: " + minBufferSize);
        int iMax = Math.max(minBufferSize, this.byteBuffer.capacity() * 2);
        RXLogging.m5690i(TAG, "bufferSizeInBytes: " + iMax);
        try {
            synchronized (this) {
                try {
    ...
    private void logMainParameters() {
        RXLogging.m5692w(TAG, "AudioRecord: session ID: " + this.audioRecord.getAudioSessionId() + ", channels: " + this.audioRecord.getChannelCount() + ", sample rate: " + this.audioRecord.getSampleRate() + ", source:" + this.audioRecord.getAudioSource());
    }

    private void logMainParametersExtended() {
        RXLogging.m5692w(TAG, "AudioRecord: buffer size in frames: " + this.audioRecord.getBufferSizeInFrames());
    }
    ...
    public void reportWebRtcAudioRecordError(String str) {
        RXLogging.m5688e(TAG, "Run-time recording error: " + str);
    ...
    private void reportWebRtcAudioRecordInitError(String str) {
        RXLogging.m5688e(TAG, "Init recording error: " + str);
        WebRtcAudioUtils.logAudioState(TAG);
        WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback = errorCallback;
        if (webRtcAudioRecordErrorCallback != null) {
    ...
    private void reportWebRtcAudioRecordStartError(AudioRecordStartErrorCode audioRecordStartErrorCode, String str) {
        RXLogging.m5688e(TAG, "Start recording error: " + audioRecordStartErrorCode + ". " + str);
        WebRtcAudioUtils.logAudioState(TAG);
        WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback = errorCallback;
        if (webRtcAudioRecordErrorCallback != null) {
    ...
    public static void setErrorCallback(WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback) {
        RXLogging.m5690i(TAG, "Set error callback");
        errorCallback = webRtcAudioRecordErrorCallback;
    }

    public static void setMicrophoneMute(boolean z) {
        RXLogging.m5692w(TAG, "setMicrophoneMute(" + z + ")");
        microphoneMute = z;
    }
    ...
    private int startRecording() {
        ...
        RXLogging.m5690i(TAG, "StartRecording:");
        AudioRecord audioRecord = this.audioRecord;
        if (audioRecord == null) {
            RXLogging.m5688e(TAG, "null audio record object");
    ...
    private boolean stopRecording() {
        ...
        releaseAudioResources();
        RXLogging.m5690i(TAG, "stopRecording release done.");
        return true;
    }
}
