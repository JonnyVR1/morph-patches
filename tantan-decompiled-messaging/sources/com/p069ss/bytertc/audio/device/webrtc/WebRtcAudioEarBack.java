...
import com.p069ss.bytertc.audio.device.hwearback.HardwareEarbackPackageChecker;
import com.p069ss.bytertc.audio.device.hwearback.HnEarback;
import com.p069ss.bytertc.audio.device.hwearback.HwEarback;
import com.p069ss.bytertc.audio.device.hwearback.IHardWareEarback;
import com.p069ss.bytertc.audio.device.hwearback.VivoEarback;
import com.p069ss.bytertc.audio.device.hwearback.XMEarback;
...
public class WebRtcAudioEarBack {
    ...
    public void ByteAudioEarBackEffect(int i) {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5689e("WebRtcAudioEarBack", "HW hardware earmonitor set effect is not support", th);
        }
    }
    ...
    public int ByteAudioEarBackEnable(boolean z) {
        ...
        try {
            ...
            try {
                ...
                i = iOpen;
                th.printStackTrace();
                RXLogging.m5689e("WebRtcAudioEarBack", "HW hardware earmonitor enable earback is not support", th);
                return i;
            }
        } catch (Throwable th2) {
            th = th2;
    ...
    public void ByteAudioEarBackEqualizer(int i) {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5689e("WebRtcAudioEarBack", "HW hardware earmonitor set eq is not support", th);
        }
    }
    ...
    public int ByteAudioEarBackGetLatency() {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5689e("WebRtcAudioEarBack", "HW hardware earmonitor get latency is not support", th);
            return -1;
        }
    }
    ...
    public int ByteAudioEarBackSetVolume(int i) {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5689e("WebRtcAudioEarBack", "HW hardware earmonitor set volume is not support", th);
            return -1;
        }
    }
    ...
    public boolean ByteAudioEarBackSupport() {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5689e("WebRtcAudioEarBack", "HW hardware earmonitor get earback is not support", th);
            return false;
        }
    }
