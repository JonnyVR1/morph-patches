...
import com.p069ss.bytertc.base.media.RXNativeFunctions;
import com.p069ss.bytertc.base.media.SurfaceTextureHelper;
import com.p069ss.bytertc.base.media.VideoCapturer;
import com.p069ss.bytertc.base.media.screen.ScreenCapturerAndroid;
...
public class RXVideoCaptureAndroid {
    ...
    private CapturerObserver localCapturerObserver = new CapturerObserver() { // from class: com.ss.bytertc.base.media.camera.RXVideoCaptureAndroid.1
        ...
        public void onCapturerError(String str) {
            RXLogging.m5688e(RXVideoCaptureAndroid.TAG, "onCapturerError: " + str);
        ...
        public void onCapturerFormatSelected(int i, int i2, int i3, int i4, int i5) {
            RXLogging.m5692w(RXVideoCaptureAndroid.TAG, "onCapturerFormatSelected...");
        ...
        public void onCapturerStarted(boolean z) {
            if (!z) {
                ...
                RXLogging.m5692w(RXVideoCaptureAndroid.TAG, "onCapturerStarted...");
        ...
        public void onCapturerStopped() {
            RXLogging.m5692w(RXVideoCaptureAndroid.TAG, "onCapturerStopped...");
    ...
    public RXVideoCaptureAndroid(boolean z, long j, EglBase.Context context) {
        ...
        RXLogging.m5692w(TAG, "RXVideoCaptureAndroid Created, CaptureScreen=" + z);
        ...
        try {
            if (z) {
                return new ScreenCapturerAndroid(intent, new MediaProjection.Callback() { // from class: com.ss.bytertc.base.media.camera.RXVideoCaptureAndroid.3
                    ...
                    public void onStop() {
                        RXLogging.m5688e(RXVideoCaptureAndroid.TAG, "User revoked permission to capture the screen.");
                    }
                });
            }
            boolean z2 = true;
            ...
            if (deviceNames.length > i && i >= 0 && (cameraVideoCapturerCreateCapturer = camera1Enumerator.createCapturer(deviceNames[i], this.mCameraEventsHandler)) != null) {
                RXLogging.m5690i(TAG, "createVideoCapturer, deviceUniqueId: " + i);
                return cameraVideoCapturerCreateCapturer;
            }
            RXLogging.m5692w(TAG, "enumerator camera but cannot find a match one, use default. deviceUniqueId: " + i + ", deviceNames: " + deviceNames.length);
            if (deviceNames.length > 0) {
                ...
                RXLogging.m5688e(TAG, "VideoCapturer first camera create null, name:" + str);
            } else {
                RXLogging.m5688e(TAG, "num of camera in device is zero");
            }
            RXLogging.m5688e(TAG, "cannot init VideoCapture: ");
            return null;
        } catch (IllegalArgumentException e) {
            RXLogging.m5688e(TAG, "Create VideoCapture fail : " + e.getMessage());
            return null;
        }
    }
    ...
    public static int[] getCameraSensorOrientations() {
        ...
        if (numberOfCameras <= 0) {
            RXLogging.m5692w(TAG, "getNumberOfCameras failed on count " + numberOfCameras);
            return null;
        }
        ...
        for (int i = 0; i < numberOfCameras; i++) {
            try {
                ...
                RXLogging.m5692w(TAG, "getCameraInfo failed on index " + i + ',' + e.getMessage());
                return null;
            }
        }
        return iArr;
    ...
    private void startVideoCapture(int i, int i2, int i3) {
        RXLogging.m5692w(TAG, String.format("startVideoCapture: width: %d, height: &d, fps: &d", Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)));
        ...
        if (videoCapturer != null) {
            try {
                ...
                RXLogging.m5688e(TAG, "VideoCapture startCapture fail : " + e.getMessage());
            }
        }
    }
    ...
    public void startCapture(int i, int i2, int i3, int i4, Intent intent, boolean z, int i5) {
        RXLogging.m5692w(TAG, "startCapture...");
        this.mWidth = i;
        this.mHeight = i2;
        this.mCaptureScreenIntent = intent;
        this.mCaptureBufferType = i4;
        if (e16.m114373a(ContextUtils.getApplicationContext(), "android.permission.CAMERA") != 0) {
        ...
        if (this.mVideoCapturer == null) {
            RXLogging.m5688e(TAG, "mVideoCapturer is null...");
        }
    ...
    public void stopCapture() {
        RXLogging.m5692w(TAG, "stopCapture...");
        VideoCapturer videoCapturer = this.mVideoCapturer;
        if (videoCapturer != null && this.mIsVideoCaptureInited && this.mIsVideoCaptureWorking) {
            try {
