    ...
    public static class CameraStatistics {
        ...
        public CameraStatistics(SurfaceTextureHelper surfaceTextureHelper, CameraEventsHandler cameraEventsHandler) {
            Runnable runnable = new Runnable() { // from class: com.ss.bytertc.base.media.camera.CameraVideoCapturer.CameraStatistics.1
                ...
                public void run() {
                    RXLogging.m5690i(CameraStatistics.TAG, "Camera fps: " + Math.round((CameraStatistics.this.frameCount * 1000.0f) / 2000.0f) + ".");
                    ...
                    if (i == 0) {
                        ...
                        if (CameraStatistics.this.freezePeriodCount * 2000 >= 4000 && CameraStatistics.this.eventsHandler != null) {
                            RXLogging.m5688e(CameraStatistics.TAG, "Camera freezed.");
            ...
            if (surfaceTextureHelper == null) {
                ig3.m135964a("SurfaceTextureHelper is null");
                throw null;
            }
