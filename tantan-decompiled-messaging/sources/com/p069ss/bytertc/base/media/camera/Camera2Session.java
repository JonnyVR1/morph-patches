...
class Camera2Session implements CameraSession {
    ...
    public static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            RXLogging.m5690i(Camera2Session.TAG, "Capture failed: " + captureFailure);
        }
    }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onClosed(CameraDevice cameraDevice) {
            ...
            RXLogging.m5690i(Camera2Session.TAG, "Camera device closed.");
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            RXLogging.m5690i(Camera2Session.TAG, "Camera opened.");
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public static /* synthetic */ void m80859a(CaptureSessionCallback captureSessionCallback, VideoFrame videoFrame) {
            Camera2Session.this.checkIsOnCameraThread();
            if (Camera2Session.this.state != SessionState.RUNNING) {
                RXLogging.m5690i(Camera2Session.TAG, "Texture frame captured but camera is no longer running.");
                return;
            }
        ...
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    RXLogging.m5690i(Camera2Session.TAG, "Using continuous video auto-focus.");
                    return;
                }
            }
            RXLogging.m5690i(Camera2Session.TAG, "Auto-focus is not available.");
        }
        ...
        private void chooseStabilizationMode(CaptureRequest.Builder builder) {
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        RXLogging.m5690i(Camera2Session.TAG, "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i2 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i2 == 1) {
                    ...
                    RXLogging.m5690i(Camera2Session.TAG, "Using video stabilization.");
                    return;
                }
            }
            RXLogging.m5690i(Camera2Session.TAG, "Stabilization not available.");
        }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            RXLogging.m5690i(Camera2Session.TAG, "Camera capture session configured.");
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: com.ss.bytertc.base.media.camera.d
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        Camera2Session.CaptureSessionCallback.m80859a(this.f55588a, videoFrame);
                    }
                });
                RXLogging.m5690i(Camera2Session.TAG, "Camera device successfully started.");
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i, int i2, int i3) {
        RXLogging.m5690i(TAG, "Create new camera2 session on camera " + str);
    ...
    private void findCaptureFormat() {
        ...
        RXLogging.m5690i(TAG, "Available preview sizes: " + supportedSizes);
        RXLogging.m5690i(TAG, "Available fps ranges: " + listConvertFramerates);
        ...
        RXLogging.m5690i(TAG, "Using capture format: " + this.captureFormat);
    }
    ...
    public int getFrameOrientation() {
        ...
        return (this.cameraOrientation + deviceUIOrientation) % 360;
    }

    private void openCamera() {
        checkIsOnCameraThread();
        RXLogging.m5690i(TAG, "Opening camera " + this.cameraId);
    ...
    public void reportError(String str) {
        checkIsOnCameraThread();
        RXLogging.m5688e(TAG, "Error: " + str);
    ...
    public void stopInternal() {
        RXLogging.m5690i(TAG, "Stop internal");
        checkIsOnCameraThread();
        ...
        RXLogging.m5690i(TAG, "Stop done");
    }
    ...
    @Override // com.p069ss.bytertc.base.media.camera.CameraSession
    public void stop() {
        RXLogging.m5690i(TAG, "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
        ...
        if (sessionState != sessionState2) {
            ...
            stopInternal();
            camera2StopTimeMsHistogram.addSample((int) ((System.nanoTime() - jNanoTime) / 1000000));
        }
    }
