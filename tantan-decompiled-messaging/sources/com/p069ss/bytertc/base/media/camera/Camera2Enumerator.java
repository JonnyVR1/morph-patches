...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private CameraCharacteristics getCameraCharacteristics(String str) {
        try {
            ...
            RXLogging.m5688e(TAG, "Camera access exception: " + e);
            return null;
        }
    }
    ...
    public static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (map) {
            try {
                ...
                RXLogging.m5690i(TAG, "Get supported formats for camera index " + str + ".");
                ...
                try {
                    ...
                    for (Size size : supportedSizes) {
                        ...
                        RXLogging.m5690i(TAG, "Format: " + size.width + BaseSei.f13930X + size.height + "@" + iRound);
                    }
                    cachedSupportedFormats.put(str, arrayList);
                    RXLogging.m5690i(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                    return arrayList;
                } catch (Exception e) {
                    RXLogging.m5688e(TAG, "getCameraCharacteristics(): " + e);
