...
public class VideoFrameDrawer {
    ...
    public static /* synthetic */ class C133571 {

        /* JADX INFO: renamed from: $SwitchMap$com$bytedance$realx$video$VideoFrame$TextureBuffer$Type */
        static final /* synthetic */ int[] f55581xef2a35a6;

        static {
            int[] iArr = new int[VideoFrame.TextureBuffer.Type.values().length];
            f55581xef2a35a6 = iArr;
            try {
                iArr[VideoFrame.TextureBuffer.Type.OES.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f55581xef2a35a6[VideoFrame.TextureBuffer.Type.RGB.ordinal()] = 2;
    ...
    public static void drawTexture(RendererCommon.GlDrawer glDrawer, VideoFrame.TextureBuffer textureBuffer, Matrix matrix, int i, int i2, int i3, int i4, int i5, int i6, FilterType filterType, int i7, int i8) {
        ...
        int i9 = C133571.f55581xef2a35a6[textureBuffer.getType().ordinal()];
        if (i9 == 1) {
    ...
    public static class YuvUploader {
        ...
        public /* synthetic */ YuvUploader(C133571 c133571) {
            this();
        }
    }
