...
public class EglRenderer implements VideoSink {
    ...
    public static /* synthetic */ class C133533 {
    ...
    public static /* synthetic */ void m80835a(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f, boolean z) {
        if (glDrawer == null) {
    ...
    public static /* synthetic */ void m80836b(EglRenderer eglRenderer, CountDownLatch countDownLatch, FrameListener frameListener) {
    ...
    public static /* synthetic */ void m80838d(EglRenderer eglRenderer, Runnable runnable) {
    ...
    public static /* synthetic */ void m80839e(EglRenderer eglRenderer, EglBase.Context context, int[] iArr) {
        if (context == null) {
    ...
    public static /* synthetic */ void m80840f(EglRenderer eglRenderer, CountDownLatch countDownLatch) {
    ...
    public static /* synthetic */ void m80842h(EglRenderer eglRenderer, Looper looper) {
    ...
    public void renderFrameOnRenderThread() {
        ...
        synchronized (this.frameLock) {
            try {
                ...
                int i3 = C133533.$SwitchMap$com$bytedance$realx$video$RendererCommon$ScalingType[this.renderModel.ordinal()];
                if (i3 != 1) {
                    if (i3 == 2) {
                        iSurfaceWidth = 0;
                        iSurfaceHeight = 0;
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, @Nullable final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: l.zre
            ...
            public final void run() {
                EglRenderer.m80835a(this.f204499a, glDrawer, frameListener, f, z);
            }
        });
    }
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                handler.postAtFrontOfQueue(new Runnable() { // from class: l.kre
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f124344a.clearSurfaceOnRenderThread(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: l.wre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m80839e(this.f187789a, context, iArr);
                    }
                });
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        this.renderThreadHandler.post(new Runnable() { // from class: l.nre
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f140184a.renderFrameOnRenderThread();
                            }
                        });
                    } catch (Throwable th) {
                        throw th;
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.qre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m80840f(this.f155983a, countDownLatch);
                    }
                });
                ...
                this.renderThreadHandler.post(new Runnable() { // from class: l.tre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m80842h(this.f171811a, looper);
                    }
                });
            ...
            try {
                ...
                if (handler == null) {
                    ...
                    this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.hre
                        @Override // java.lang.Runnable
                        public final void run() {
                            EglRenderer.m80838d(this.f109204a, runnable);
                        }
                    });
                }
            } catch (Throwable th) {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: l.ere
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m80836b(this.f92907a, countDownLatch, frameListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
