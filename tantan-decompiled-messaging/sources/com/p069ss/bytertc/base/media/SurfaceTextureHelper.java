...
public class SurfaceTextureHelper {
        ...
        try {
            ...
            setOnFrameAvailableListener(surfaceTexture, new SurfaceTexture.OnFrameAvailableListener() { // from class: l.j2h0
                ...
                public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                    SurfaceTextureHelper.m80851f(this.f115928a, surfaceTexture2);
                }
            }, handler);
    ...
    public static /* synthetic */ void m80847b(SurfaceTextureHelper surfaceTextureHelper) {
    ...
    public static /* synthetic */ void m80848c(SurfaceTextureHelper surfaceTextureHelper, int i, int i2) {
    ...
    public static /* synthetic */ void m80850e(SurfaceTextureHelper surfaceTextureHelper) {
    ...
    public static /* synthetic */ void m80851f(SurfaceTextureHelper surfaceTextureHelper, SurfaceTexture surfaceTexture) {
        surfaceTextureHelper.hasPendingTexture = true;
        surfaceTextureHelper.tryDeliverTextureFrame();
    }

    /* JADX INFO: renamed from: g */
    public static /* synthetic */ void m80852g(SurfaceTextureHelper surfaceTextureHelper) {
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: l.x1h0
            ...
            public final void run() {
                SurfaceTextureHelper.m80850e(this.f189073a);
            }
        });
    }
    ...
    public void tryDeliverTextureFrame() {
        ...
        if (this.capture2DTexture) {
            ...
            textureBufferImpl = new TextureBufferImpl(this.textureWidth, this.textureHeight, VideoFrame.TextureBuffer.Type.RGB, this.twoDTextureId, RendererCommon.convertMatrixToAndroidGraphicsMatrix(fArr), this.handler, this.yuvConverter, new Runnable() { // from class: l.a2h0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f67261a.returnTextureFrame();
                }
            });
        } else {
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: l.d2h0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.m80847b(this.f83386a);
            }
        });
    }
    ...
    public void setTextureSize(final int i, final int i2) {
        if (i <= 0) {
            ...
            this.handler.post(new Runnable() { // from class: l.g2h0
                @Override // java.lang.Runnable
                public final void run() {
                    SurfaceTextureHelper.m80848c(this.f100263a, i, i2);
                }
            });
        }
    }
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: l.p2h0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.m80852g(this.f146859a);
            }
        });
    }
