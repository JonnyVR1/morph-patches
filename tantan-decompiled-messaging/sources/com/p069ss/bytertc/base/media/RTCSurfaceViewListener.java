...
import com.p069ss.bytertc.base.media.RTCSurfaceViewListener;
...
public class RTCSurfaceViewListener implements SurfaceHolder.Callback {
    ...
    public RTCSurfaceViewListener(SurfaceView surfaceView, final long j, final String str) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: l.cbc0
            ...
            public final void run() {
                RTCSurfaceViewListener.m80844a(this.f80128a, surface2, j, str);
            }
        });
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m80844a(RTCSurfaceViewListener rTCSurfaceViewListener, Surface surface, long j, String str) {
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        ...
        RXLogging.m5690i("RTCSurfaceViewListener", "surfaceCreated key:" + this.key);
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        if (this.nativeSurfaceHelperHandle != 0) {
            RXLogging.m5690i("RTCSurfaceViewListener", "surfaceDestroyed key:" + this.key);
