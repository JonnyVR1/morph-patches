...
import com.p069ss.bytertc.engine.NativeKTVManagerFunctions;
import com.p069ss.bytertc.engine.handler.KTVManagerEventHandler;
import com.p069ss.bytertc.engine.utils.LogUtil;
import com.p069ss.bytertc.ktv.data.DownloadLyricType;
import com.p069ss.bytertc.ktv.data.MusicFilterType;
...
public class KTVManagerImpl extends IKTVManager {
        ...
        for (MusicFilterType musicFilterType : musicFilterTypeArr) {
            if (iValue == MusicFilterType.NONE.value()) {
                if (BuildConfig.DEBUG) {
                    ig3.m135964a("types contains 'MUSIC_FILTER_TYPE_NONE' and other");
                    return 0;
                }
                LogUtil.m80901e(TAG, "types contains 'MUSIC_FILTER_TYPE_NONE' and other");
                return -1;
            }
    ...
    @Override // com.p069ss.bytertc.ktv.IKTVManager
    public void cancelDownload(int i) {
        this.mJniReadLock.lock();
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, downloadLyric failed.");
            }
    ...
    public void clearCache() {
        ...
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, clearCache failed.");
            }
    ...
    public int downloadMidi(@NonNull String str) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, downloadMidi failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int downloadMusic(@NonNull String str) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, downloadMusic failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public void getHotMusic(@NonNull List<String> list, @NonNull MusicFilterType[] musicFilterTypeArr) {
        ...
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, getHotMusic failed.");
            } else {
    ...
    public IKTVPlayer getKTVPlayer() {
        ...
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, getKTVPlayer failed.");
            }
            KTVPlayerImpl kTVPlayerImpl = this.mKTVPlayer;
            if (kTVPlayerImpl == null) {
                long jNativeGetKTVPlayer = NativeKTVManagerFunctions.nativeGetKTVPlayer(this.mNativeKTVManager);
                if (jNativeGetKTVPlayer == 0) {
                    LogUtil.m80901e(TAG, "native nativeKTVPlayer is invalid, getKTVPlayer failed.");
                    return null;
                }
    ...
    public void getMusicDetail(@NonNull String str) {
        ...
        try {
            long j = this.mNativeKTVManager;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, getMusicDetail failed.");
            } else {
    ...
    public void getMusicList(int i, int i2, @NonNull MusicFilterType[] musicFilterTypeArr) {
        ...
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, getMusicList failed.");
            } else {
                int iCalculateMusicFilterValue = calculateMusicFilterValue(musicFilterTypeArr);
                if (iCalculateMusicFilterValue != -1) {
    ...
    public void searchMusic(@NonNull String str, int i, int i2, @NonNull MusicFilterType[] musicFilterTypeArr) {
        ...
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, searchMusic failed.");
            } else {
                int iCalculateMusicFilterValue = calculateMusicFilterValue(musicFilterTypeArr);
                if (iCalculateMusicFilterValue != -1) {
    ...
    public void setKTVManagerEventHandler(IKTVManagerEventHandler iKTVManagerEventHandler) {
        ...
        try {
            if (this.mNativeKTVManager == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, setKTVManagerEventHandler failed.");
            } else {
    ...
    public void setMaxCacheSize(int i) {
        ...
        try {
            long j = this.mNativeKTVManager;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native KTVManagerImpl is invalid, setMaxCacheSize failed.");
            } else {
