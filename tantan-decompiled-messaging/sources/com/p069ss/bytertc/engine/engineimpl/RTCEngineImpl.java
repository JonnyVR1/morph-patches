package com.p069ss.bytertc.engine.engineimpl;
...
import com.p069ss.bytertc.engine.AudioEffectPlayer;
import com.p069ss.bytertc.engine.GameRoomConfig;
import com.p069ss.bytertc.engine.GameRoomImpl;
import com.p069ss.bytertc.engine.IAudioFrameObserver;
import com.p069ss.bytertc.engine.IAudioFrameProcessor;
import com.p069ss.bytertc.engine.IGameRoom;
import com.p069ss.bytertc.engine.IMetadataObserver;
import com.p069ss.bytertc.engine.IRTCAudioDeviceManager;
import com.p069ss.bytertc.engine.IRTCAudioDeviceManagerEx;
import com.p069ss.bytertc.engine.IRemoteEncodedAudioFrameObserver;
import com.p069ss.bytertc.engine.IWTNStream;
import com.p069ss.bytertc.engine.InternalCloudProxyInfo;
import com.p069ss.bytertc.engine.InternalDestInfo;
import com.p069ss.bytertc.engine.InternalLocalProxyConfiguration;
import com.p069ss.bytertc.engine.InternalMediaTypeEnhancementConfig;
import com.p069ss.bytertc.engine.InternalVideoCaptureConfig;
import com.p069ss.bytertc.engine.InternalVideoEncoderConfig;
import com.p069ss.bytertc.engine.InternalVideoSourceConfig;
import com.p069ss.bytertc.engine.NativeRTCVideoFunctions;
import com.p069ss.bytertc.engine.NativeRTCVideoFunctionsEx;
import com.p069ss.bytertc.engine.NetworkTimeInfo;
import com.p069ss.bytertc.engine.RTCAudioDeviceManager;
...
import com.p069ss.bytertc.engine.RTSRoom;
import com.p069ss.bytertc.engine.RTSRoomImpl;
import com.p069ss.bytertc.engine.RemoteVideoRenderConfig;
import com.p069ss.bytertc.engine.RtcMediaPlayer;
import com.p069ss.bytertc.engine.SingScoringManager;
import com.p069ss.bytertc.engine.VideoCanvas;
import com.p069ss.bytertc.engine.VideoDeviceManager;
import com.p069ss.bytertc.engine.VideoEncoderConfig;
import com.p069ss.bytertc.engine.WTNStream;
import com.p069ss.bytertc.engine.adapter.VideoSinkAdapter;
import com.p069ss.bytertc.engine.adapter.VideoSinkTask;
...
import com.p069ss.bytertc.engine.data.AlphaLayout;
import com.p069ss.bytertc.engine.data.AudioAlignmentMode;
import com.p069ss.bytertc.engine.data.AudioContentTypeConfig;
import com.p069ss.bytertc.engine.data.AudioEncodeConfig;
...
import com.p069ss.bytertc.engine.data.AudioRecordingConfig;
import com.p069ss.bytertc.engine.data.AudioRenderType;
import com.p069ss.bytertc.engine.data.AudioRoute;
import com.p069ss.bytertc.engine.data.AudioSourceType;
...
import com.p069ss.bytertc.engine.data.EchoTestConfig;
import com.p069ss.bytertc.engine.data.EffectBeautyMode;
import com.p069ss.bytertc.engine.data.EngineConfig;
import com.p069ss.bytertc.engine.data.MirrorType;
import com.p069ss.bytertc.engine.data.RTCLogConfig;
import com.p069ss.bytertc.engine.data.RecordingConfig;
import com.p069ss.bytertc.engine.data.RemoteMirrorType;
...
import com.p069ss.bytertc.engine.data.ScreenMediaType;
import com.p069ss.bytertc.engine.data.StreamIndex;
import com.p069ss.bytertc.engine.data.StreamPriority;
...
import com.p069ss.bytertc.engine.data.VideoOrientation;
import com.p069ss.bytertc.engine.data.VideoPixelFormat;
import com.p069ss.bytertc.engine.data.VideoRotation;
import com.p069ss.bytertc.engine.data.VideoRotationMode;
import com.p069ss.bytertc.engine.data.VideoSimulcastMode;
import com.p069ss.bytertc.engine.data.VideoSourceType;
import com.p069ss.bytertc.engine.data.VideoSuperResolutionMode;
import com.p069ss.bytertc.engine.data.ZoomConfigType;
import com.p069ss.bytertc.engine.data.ZoomDirectionType;
import com.p069ss.bytertc.engine.engineimpl.RTCEngineImpl;
import com.p069ss.bytertc.engine.handler.IExternalVideoEncoderEventHandler;
...
import com.p069ss.bytertc.engine.handler.RTCAudioDeviceEventHandler;
import com.p069ss.bytertc.engine.handler.RTCEncryptHandler;
import com.p069ss.bytertc.engine.handler.RTCExternalVideoEncoderEventHandler;
import com.p069ss.bytertc.engine.handler.RTCLocalEncodedVideoFrameObserver;
import com.p069ss.bytertc.engine.handler.RTCRemoteEncodedVideoFrameObserver;
import com.p069ss.bytertc.engine.handler.RTCVideoEventHandler;
import com.p069ss.bytertc.engine.handler.RTCVideoProcessor;
import com.p069ss.bytertc.engine.live.ChorusCacheSyncConfig;
import com.p069ss.bytertc.engine.live.ChorusCacheSyncObserver;
import com.p069ss.bytertc.engine.live.ClientMixedStreamConfig;
import com.p069ss.bytertc.engine.live.IChorusCacheSyncObserver;
import com.p069ss.bytertc.engine.live.IClientMixedStreamObserver;
...
import com.p069ss.bytertc.engine.live.PushMixedStreamToCDNObserver;
import com.p069ss.bytertc.engine.live.PushSingleStreamParam;
import com.p069ss.bytertc.engine.loader.RTCNativeLibraryListenerImpl;
import com.p069ss.bytertc.engine.loader.RTCNativeLibraryLoader;
import com.p069ss.bytertc.engine.loader.RTCNativeLibraryLoaderInfo;
import com.p069ss.bytertc.engine.loader.RTCNativeLibraryLoaderListener;
import com.p069ss.bytertc.engine.mediaio.ILocalEncodedVideoFrameObserver;
import com.p069ss.bytertc.engine.mediaio.IRemoteEncodedVideoFrameObserver;
import com.p069ss.bytertc.engine.mediaio.RTCEncodedVideoFrame;
import com.p069ss.bytertc.engine.type.AnsMode;
...
import com.p069ss.bytertc.engine.type.LocalProxyConfiguration;
import com.p069ss.bytertc.engine.type.MediaTypeEnhancementConfig;
import com.p069ss.bytertc.engine.type.MessageConfig;
import com.p069ss.bytertc.engine.type.ProblemFeedbackInfo;
import com.p069ss.bytertc.engine.type.ProblemFeedbackOption;
import com.p069ss.bytertc.engine.type.PublishFallbackOption;
import com.p069ss.bytertc.engine.type.RecordingType;
import com.p069ss.bytertc.engine.type.RemoteUserPriority;
import com.p069ss.bytertc.engine.type.SubscribeFallbackOptions;
import com.p069ss.bytertc.engine.type.TorchState;
import com.p069ss.bytertc.engine.type.VoiceChangerType;
import com.p069ss.bytertc.engine.type.VoiceEqualizationConfig;
import com.p069ss.bytertc.engine.type.VoiceReverbConfig;
import com.p069ss.bytertc.engine.type.VoiceReverbType;
import com.p069ss.bytertc.engine.utils.AppMonitor;
import com.p069ss.bytertc.engine.utils.AudioFrame;
import com.p069ss.bytertc.engine.utils.EncodedAudioFrameData;
import com.p069ss.bytertc.engine.utils.LogRecover;
import com.p069ss.bytertc.engine.utils.LogUtil;
import com.p069ss.bytertc.engine.video.AmazingEffect;
import com.p069ss.bytertc.engine.video.ByteWatermark;
import com.p069ss.bytertc.engine.video.IAmazingEffect;
import com.p069ss.bytertc.engine.video.ISnapshotResultCallback;
import com.p069ss.bytertc.engine.video.IVideoDeviceManager;
import com.p069ss.bytertc.engine.video.IVideoEffect;
import com.p069ss.bytertc.engine.video.IVideoProcessor;
import com.p069ss.bytertc.engine.video.IVideoSink;
import com.p069ss.bytertc.engine.video.LocalVideoSinkConfig;
import com.p069ss.bytertc.engine.video.RTCVideoEffect;
import com.p069ss.bytertc.engine.video.RTCWatermarkConfig;
import com.p069ss.bytertc.engine.video.RemoteVideoSinkConfig;
import com.p069ss.bytertc.engine.video.VideoCaptureConfig;
import com.p069ss.bytertc.engine.video.VideoDecoderConfig;
import com.p069ss.bytertc.engine.video.VideoPreprocessorConfig;
import com.p069ss.bytertc.ktv.IKTVManager;
import com.p069ss.bytertc.ktv.KTVManagerImpl;
...
public class RTCEngineImpl extends RTCEngineEx {
    ...
    public RTCEngineImpl(EngineConfig engineConfig, IRTCEngineEventHandler iRTCEngineEventHandler, IRTCEngineEventHandlerEx iRTCEngineEventHandlerEx, boolean z, boolean z2) throws IllegalStateException {
        ...
        this.mLoggerSink = new LogUtil.ILoggerSink() { // from class: l.uac0
            ...
            public final void onLoggerMessage(LogUtil.LogLevel logLevel, String str2, Throwable th) {
                RTCEngineImpl.m80887e(this.f175594a, logLevel, str2, th);
            }
        };
        this.appStateCallback = new AppMonitor.Callback() { // from class: l.vac0
            @Override // com.ss.bytertc.engine.utils.AppMonitor.Callback
            public final void callback(int i) {
                RTCEngineImpl.m80886d(this.f180728a, i);
            }
        };
        ...
        LogUtil.m80900d(TAG, "create RtcEngineImpl with appId: " + str2);
        if (obj != null && !(obj instanceof EGLContext)) {
            ig3.m135964a("eglContext is not an instance of android.opengl.EGLContext");
            throw null;
        }
        if (!mLibraryLoaded) {
            ...
            try {
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!((Boolean) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: l.wac0
                            @Override // java.util.concurrent.Callable
                            public final Object call() {
                                return RTCEngineImpl.m80885c(this.f185453a);
                            }
                        })).booleanValue()) {
                        ...
                        try {
                            ...
                            try {
                                try {
                                    ...
                                    LogUtil.m80901e(TAG, "error in recording create engine elpase. " + e.getMessage());
                                }
                            } catch (IllegalStateException e2) {
                                e = e2;
                                str = str2;
                                LogUtil.m80901e(TAG, "create native engine error, native engine is invalid.");
                                doDestroyOnCreate();
    ...
    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m80883a(RTCEngineImpl rTCEngineImpl) {
    ...
    public static /* synthetic */ void m80884b(RTCEngineImpl rTCEngineImpl) {
        EglBase eglBase = rTCEngineImpl.mRootEglBase;
        if (eglBase != null) {
            eglBase.release();
            rTCEngineImpl.mRootEglBase = null;
    ...
    public static /* synthetic */ Boolean m80885c(RTCEngineImpl rTCEngineImpl) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "init egl context falied");
            return Boolean.FALSE;
        }
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ void m80886d(RTCEngineImpl rTCEngineImpl, int i) {
        rTCEngineImpl.mJniReadLock.lock();
        try {
            if (rTCEngineImpl.engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetAppState failed.");
            } else {
    ...
    private void doDestroyOnCreate() {
        ...
        if (handler != null) {
            ThreadUtils.invokeAtFrontUninterruptibly(handler, new Runnable() { // from class: l.tac0
                @Override // java.lang.Runnable
                public final void run() {
                    RTCEngineImpl.m80884b(this.f169107a);
                }
            });
        }
    ...
    public static /* synthetic */ void m80887e(RTCEngineImpl rTCEngineImpl, LogUtil.LogLevel logLevel, String str, Throwable th) {
    ...
    public static /* synthetic */ void m80888f(RTCEngineImpl rTCEngineImpl) {
    ...
    private static boolean loadNativeLib(String str, String str2) {
        LogUtil.m80903i(TAG, "Loading library: " + str2);
        ...
        try {
            ...
            LogUtil.m80903i(TAG, "loadNativeLib: Success Load " + str2);
            return true;
        } catch (NullPointerException e) {
            LogUtil.m80902e(TAG, "loadNativeLib: Failed to load native library: " + str2, e);
            return false;
        } catch (SecurityException e2) {
            LogUtil.m80902e(TAG, "loadNativeLib: Failed to load native library: " + str2, e2);
            return false;
        } catch (Exception e3) {
            LogUtil.m80902e(TAG, "loadNativeLib: Failed to load native library: " + str2, e3);
            return false;
        } catch (UnsatisfiedLinkError e4) {
            LogUtil.m80902e(TAG, "loadNativeLib: Failed to load native library: " + str2, e4);
            return false;
        }
    }
    ...
    @Override // com.p069ss.bytertc.engine.RTCEngine
    public int clearVideoWatermark(StreamIndex streamIndex) {
        int iValue;
        this.mJniReadLock.lock();
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, clearVideoWatermark failed.");
    ...
    public IGameRoom createGameRoom(String str, GameRoomConfig gameRoomConfig) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, createGameRoom failed.");
            } else {
                if (str == null) {
                    str = "";
                }
                ...
                LogUtil.m80901e(TAG, "createRoom failed, native room is invalid");
            }
            return null;
        } finally {
            this.mJniReadLock.unlock();
    ...
    public RTCRoom createRTCRoom(String str) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, createRoom failed.");
            } else {
                if (str == null) {
                    str = "";
                }
    ...
    @Override // com.p069ss.bytertc.engine.RTCEngineEx
    ...
    public int disableAlphaChannelVideoEncode(StreamIndex streamIndex) {
        int iValue;
        LogUtil.m80900d(TAG, "disableAlphaChannelVideoEncode");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, disableAlphaChannelVideoEncode failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int disableAudioFrameCallback(AudioFrameCallbackMethod audioFrameCallbackMethod) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, disableAudioFrameCallback failed.");
    ...
    public int disableAudioProcessor(AudioProcessorMethod audioProcessorMethod) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, disableAudioProcessor failed.");
    ...
    public void doDestroy(boolean z) {
        LogUtil.m80900d(TAG, "destroy RtcEngineImpl.");
        this.mJniWriteLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, no need to destroy now.");
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: l.xac0
                @Override // java.lang.Runnable
                public final void run() {
                    RTCEngineImpl.m80888f(this.f191726a);
                }
            });
            AppMonitor.get(this.mContext).unRegister(this.appStateCallback).release(this.mContext);
            this.mRtcVideoPreprocessor.dispose();
            this.mRtcVideoPreprocessor = null;
            ThreadUtils.invokeAtFrontUninterruptibly(this.mEglHandler, new Runnable() { // from class: l.yac0
                @Override // java.lang.Runnable
                public final void run() {
                    RTCEngineImpl.m80883a(this.f197183a);
                }
            });
            HandlerThread handlerThread = this.mEglThread;
            if (handlerThread != null) {
    ...
    public int enableAlphaChannelVideoEncode(StreamIndex streamIndex, AlphaLayout alphaLayout) {
        int iValue;
        LogUtil.m80900d(TAG, "enableAlphaChannelVideoEncode");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAlphaChannelVideoEncode failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int enableAudioAEDReport(int i) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAudioAEDReport failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public void enableAudioDecoding(boolean z) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAudioDecoding failed.");
            } else {
    ...
    public void enableAudioEncoding(boolean z) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAudioEncoding failed.");
            } else {
    ...
    public int enableAudioFrameCallback(AudioFrameCallbackMethod audioFrameCallbackMethod, AudioFormat audioFormat) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAudioFrameCallback failed.");
    ...
    public int enableAudioProcessor(AudioProcessorMethod audioProcessorMethod, AudioFormat audioFormat) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAudioProcessor failed.");
    ...
    public int enableAudioPropertiesReport(AudioPropertiesConfig audioPropertiesConfig) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, EnableAudioPropertiesReport failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int enableAudioVADReport(int i) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableAudioVADReport failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int enableEffectBeauty(boolean z) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, enableEffectBeauty failed.");
            return 1000;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int enableExternalSoundCard(boolean z) {
        ...
        LogUtil.m80900d(TAG, "enableExternalSoundCard");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableExternalSoundCard failed.");
    ...
    public int enableLocalVoiceReverb(boolean z) {
        ...
        LogUtil.m80900d(TAG, "enableLocalVoiceReverb...enable: " + z);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, enableLocalVoiceReverb failed.");
    ...
    public int enablePlaybackDucking(boolean z) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, EnablePlaybackDucking failed.");
    ...
    public int enableVocalInstrumentBalance(boolean z) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, EnableVocalInstrumentBalance failed.");
    ...
    public int feedback(List<ProblemFeedbackOption> list, ProblemFeedbackInfo problemFeedbackInfo) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetRuntimeParameters failed.");
    ...
    public IAmazingEffect getAmazingEffectInterface() {
        LogUtil.m80900d(TAG, "getAmazingEffectInterface");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid()) {
                AmazingEffect amazingEffect = this.mAmazingEffect;
                if (amazingEffect == null) {
                    ...
                    if (jNativeGetAmazingEffectInterface == 0) {
                        LogUtil.m80901e(TAG, "getAmazingEffectInterface failed");
                    } else {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, getAmazingEffectInterface");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public IRTCAudioDeviceManager getAudioDeviceManager() {
        LogUtil.m80900d(TAG, "getAudioDeviceManager");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, getAudioDeviceManager failed.");
                return null;
            }
            ...
            if (jNativeGetAudioDeviceManager == 0 || jNativeGetAudioDeviceManager == -1) {
                LogUtil.m80901e(TAG, "getAudioDeviceManager failed");
    ...
    public IAudioEffectPlayer getAudioEffectPlayer() {
        ...
        try {
            if (!engineInvalid()) {
                ...
                if (audioEffectPlayer == null) {
                    ...
                    if (jNativeGetAudioEffectPlayer == 0) {
                        LogUtil.m80901e(TAG, "getAudioEffectPlayer failed");
                    } else {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, getAudioEffectPlayer");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public AudioRoute getAudioRoute() {
        LogUtil.m80900d(TAG, "getAudioRoute");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid()) {
                return AudioRoute.fromId(NativeRTCVideoFunctions.nativeGetAudioRoute(this.mNativeEngine));
            }
            LogUtil.m80901e(TAG, "native engine is invalid, getAudioRoute failed.");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public float getCameraZoomMaxRatio() {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, PushScreenAudioFrame failed.");
            return -1.0f;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public IKTVManager getKTVManager() {
        ...
        try {
            ...
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, getKTVManger failed.");
            } else {
                synchronized (RTCEngineImpl.class) {
                    ...
                    if (jNativeGetKTVManager == 0) {
                        LogUtil.m80901e(TAG, "getKTVManger failed");
                    } else {
    ...
    public IMediaPlayer getMediaPlayer(int i) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, getMediaPlayer");
            } else {
                ...
                LogUtil.m80901e(TAG, "getMediaPlayer failed");
            }
            return null;
        } finally {
            this.mJniReadLock.unlock();
    ...
    public long getNativeHandle() {
        ...
        LogUtil.m80901e(TAG, "native engine is invalid, getNativeHandle failed.");
        return -1L;
    }
    ...
    public NetworkTimeInfo getNetworkTimeInfo() {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, getNetworkTimeInfo");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int getPeerOnlineStatus(String str) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, sendBinaryMessage failed.");
    ...
    public ISingScoringManager getSingScoringManager() {
        ...
        try {
            if (!engineInvalid()) {
                ...
                if (singScoringManager == null) {
                    ...
                    if (jNativeGetSingScoringManager == 0) {
                        LogUtil.m80901e(TAG, "getSingScoringManager failed");
                    } else {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, getSingScoringManager");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public IVideoDeviceManager getVideoDeviceManager() {
        LogUtil.m80900d(TAG, "getVideoDeviceManager");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid()) {
                ...
                if (videoDeviceManager == null) {
                    ...
                    if (jNativeGetVideoDeviceManager == 0) {
                        LogUtil.m80901e(TAG, "getVideoDeviceManager failed");
                    } else {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, getVideoDeviceManager");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public IVideoEffect getVideoEffectInterface() {
        LogUtil.m80900d(TAG, "getVideoEffectInterface");
            ...
            if (engineInvalid()) {
                ...
                synchronized (RTCEngineImpl.class) {
                    ...
                    if (jNativeGetWTNStream == 0) {
                        LogUtil.m80901e(TAG, "getWTNStream failed");
                    } else {
    ...
    public int muteAudioCapture(StreamIndex streamIndex, boolean z) {
        ...
        LogUtil.m80900d(TAG, "muteAudioCapture");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, muteAudioCapture failed.");
    ...
    public int pullExternalAudioFrame(AudioFrame audioFrame) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, pullExternalAudioFrame failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int pushClientMixedStreamExternalVideoFrame(String str, VideoFrameData videoFrameData) {
        int iValue;
        LogUtil.m80900d(TAG, "pushExternalVideoFrame");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "pushClientMixedStreamExternalVideoFrame: native engine is invalid, pushExternalVideoFrame failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (videoFrameData == null) {
                LogUtil.m80903i(TAG, "pushClientMixedStreamExternalVideoFrame: videoFrame is null, drop frame.");
    ...
    public int pushExternalAudioFrame(AudioFrame audioFrame) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, pushExternalAudioFrame failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int pushExternalEncodedAudioFrame(EncodedAudioFrameData encodedAudioFrameData) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, pushExternalEncodedAudioFrame failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int pushExternalEncodedVideoFrame(StreamIndex streamIndex, int i, RTCEncodedVideoFrame rTCEncodedVideoFrame) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, PushExternalEncodedVideoFrame failed.");
    ...
    public int pushExternalVideoFrame(StreamIndex streamIndex, VideoFrameData videoFrameData) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "pushExternalVideoFrame: native engine is invalid, pushExternalVideoFrame failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (videoFrameData == null) {
                LogUtil.m80903i(TAG, "pushExternalVideoFrame: videoFrame is null, drop frame.");
                iValue = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else {
                ReturnStatus returnStatus = ReturnStatus.RETURN_STATUS_SUCCESS;
    ...
    public int pushReferenceAudioPCMData(AudioFrame audioFrame) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, pushReferenceAudioPCMData failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int pushScreenVideoFrame(VideoFrameData videoFrameData) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "pushScreenVideoFrame: native engine is invalid, pushExternalVideoFrame failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (videoFrameData == null) {
                LogUtil.m80903i(TAG, "pushScreenVideoFrame: videoFrame is null, drop frame.");
                iValue = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else {
    ...
    public int registerAudioFrameObserver(IAudioFrameObserver iAudioFrameObserver) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, registerAudioFrameObserver failed.");
    ...
    public int registerAudioProcessor(IAudioFrameProcessor iAudioFrameProcessor) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, registerAudioProcessor failed.");
    ...
    public int registerLocalVideoProcessor(IVideoProcessor iVideoProcessor, VideoPreprocessorConfig videoPreprocessorConfig) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, registerLocalVideoProcessor failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public void registerRemoteEncodedAudioFrameObserver(IRemoteEncodedAudioFrameObserver iRemoteEncodedAudioFrameObserver) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, registerRemoteEncodedAudioFrameObserver failed.");
            } else {
    ...
    public int registerRemoteEncodedVideoFrameObserver(IRemoteEncodedVideoFrameObserver iRemoteEncodedVideoFrameObserver) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, RegisterRemoteEncodedVideoFrameObserver failed.");
    ...
    public int requestRemoteVideoKeyFrame(RemoteStreamKey remoteStreamKey) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, RequestRemoteVideoKeyFrame failed.");
    ...
    public int sendPublicStreamSEIMessage(StreamIndex streamIndex, int i, byte[] bArr, int i2, SEICountPerFrame sEICountPerFrame) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, sendPublicStreamSEIMessage failed.");
    ...
    public int sendSEIMessage(StreamIndex streamIndex, byte[] bArr, int i, SEICountPerFrame sEICountPerFrame) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, registerMetadataObserver failed.");
    ...
    public int sendStreamSyncInfo(byte[] bArr, StreamSyncInfoConfig streamSyncInfoConfig) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, SendStreamSyncInfo failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public long sendUserBinaryMessageOutsideRoom(String str, byte[] bArr, MessageConfig messageConfig) {
        ...
        try {
            if (!engineInvalid()) {
                if (str == null) {
                    LogUtil.m80901e(TAG, "sendUserBinaryMessageOutsideRoom: uid is null send failed");
                    iValue = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
                } else {
    ...
    public long sendUserMessageOutsideRoom(String str, String str2, MessageConfig messageConfig) {
        ...
        try {
            if (!engineInvalid()) {
                if (str == null) {
                    LogUtil.m80901e(TAG, "sendUserMessageOutsideRoom: uid is null send failed");
                    iValue = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
                } else {
    ...
    public int setAnsMode(AnsMode ansMode) {
        ...
        LogUtil.m80900d(TAG, "setAnsMode:" + ansMode);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setAnsMode failed.");
                iNativeSetAnsMode = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (ansMode == null) {
                LogUtil.m80901e(TAG, "ansMode is invalid, setAnsMode failed.");
    ...
    public int setAudioAlignmentProperty(RemoteStreamKey remoteStreamKey, AudioAlignmentMode audioAlignmentMode) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setAudioAlignmentProperty failed.");
                iNativeSetAudioAlignmentProperty = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (remoteStreamKey == null) {
                LogUtil.m80901e(TAG, "setAudioAlignmentProperty: streamKey is null");
    ...
    public int setAudioContentType(StreamIndex streamIndex, AudioContentTypeConfig audioContentTypeConfig) {
        ...
        LogUtil.m80900d(TAG, "SetAudioContentType");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetAudioContentType failed.");
    ...
    public int setAudioEncodeConfig(StreamIndex streamIndex, AudioEncodeConfig audioEncodeConfig) {
        ...
        LogUtil.m80900d(TAG, "SetAudioEncodeConfig");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetAudioEncodeConfig failed.");
    ...
    public int setAudioProfile(AudioProfileType audioProfileType) {
        ...
        LogUtil.m80900d(TAG, "setAudioProfile:" + audioProfileType);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setAudioProfile failed.");
                iNativeSetAudioProfile = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (audioProfileType == null) {
                LogUtil.m80901e(TAG, "audioProfile is invalid, setAudioProfile failed.");
    ...
    public int setAudioRenderType(AudioRenderType audioRenderType) {
        ...
        LogUtil.m80900d(TAG, "SetAudioRenderType");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetAudioRenderType failed.");
    ...
    public int setAudioRoute(AudioRoute audioRoute) {
        ...
        LogUtil.m80900d(TAG, "setAudioRoute: " + audioRoute.value());
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setAudioRoute failed.");
    ...
    public int setAudioScenario(AudioScenarioType audioScenarioType) {
        ...
        LogUtil.m80900d(TAG, "setAudioScenario...audioScenario: " + audioScenarioType);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setAudioScenario failed.");
    ...
    public int setAudioSourceType(AudioSourceType audioSourceType) {
        ...
        LogUtil.m80900d(TAG, "SetAudioSourceType");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetAudioSourceType failed.");
    ...
    public int setAudioSourceVolume(StreamIndex streamIndex, int i) {
        LogUtil.m80900d(TAG, "setSourceVolume");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctionsEx.nativeSetAudioSourceVolume(this.mNativeEngine, streamIndex.value(), i);
            }
            LogUtil.m80901e(TAG, "native engine is invalid, setSourceVolume failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setBeautyIntensity(EffectBeautyMode effectBeautyMode, float f) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, setBeautyIntensity failed.");
            return 1000;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setBusinessId(String str) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setBusinessId failed.");
    ...
    public int setCaptureVolume(int i) {
        LogUtil.m80900d(TAG, "setCaptureVolume");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctionsEx.nativeSetCaptureVolume(this.mNativeEngine, i);
            }
            LogUtil.m80901e(TAG, "native engine is invalid, setCaptureVolume failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setCellularEnhancement(MediaTypeEnhancementConfig mediaTypeEnhancementConfig) {
        LogUtil.m80900d(TAG, "setCellularEnhancement");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, setCellularEnhancement failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setClientMixedStreamObserver(IClientMixedStreamObserver iClientMixedStreamObserver) {
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "setClientMixedStreamObserver...");
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setClientMixedStreamObserver failed.");
                return -1;
            }
            LogUtil.m80900d(TAG, "setClientMixedStreamObserver...");
    ...
    public int setCustomizeEncryptHandler(RTCEncryptHandler rTCEncryptHandler) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setCustomizeEncryptHandler failed.");
    ...
    public int setDefaultAudioRoute(AudioRoute audioRoute) {
        ...
        LogUtil.m80900d(TAG, "setDefaultAudioRoute: " + audioRoute.value());
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setDefaultAudioRoute failed.");
    ...
    public int setDummyCaptureImagePath(String str) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, setDummyCaptureImagePath failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int setEarMonitorMode(EarMonitorMode earMonitorMode) {
        ...
        LogUtil.m80900d(TAG, "setEarMonitorMode");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setEarMonitorMode failed.");
    ...
    public int setEarMonitorVolume(int i) {
        ...
        LogUtil.m80900d(TAG, "setEarMonitorVolume");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setEarMonitorVolume failed.");
    ...
    public int setEncryptInfo(int i, String str) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setEncryptInfo failed.");
    ...
    public int setExternalVideoEncoderEventHandler(IExternalVideoEncoderEventHandler iExternalVideoEncoderEventHandler) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setExternalVideoEncoderEventHandler failed.");
    ...
    public int setLocalProxy(List<LocalProxyConfiguration> list) {
        LogUtil.m80900d(TAG, "setLocalProxy");
        this.mJniReadLock.lock();
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, setLocalProxy failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setLocalSimulcastMode(VideoSimulcastMode videoSimulcastMode, VideoEncoderConfig[] videoEncoderConfigArr) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoEncoderConfig failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    ...
    public int setLocalVideoCanvas(StreamIndex streamIndex, VideoCanvas videoCanvas) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalVideoCanvas failed.");
    ...
    public int setLocalVideoMirrorType(MirrorType mirrorType) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalVideoMirrorType failed.");
    ...
    public int setLocalVideoSink(StreamIndex streamIndex, IVideoSink iVideoSink, LocalVideoSinkConfig localVideoSinkConfig) {
        ...
        try {
            if (streamIndex == null) {
                LogUtil.m80901e(TAG, "EventType: setLocalVideoSink, streamIndex is null");
                iNativesetLocalVideoSink = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalVideoSink failed.");
    ...
    public int setLocalVoiceEqualization(VoiceEqualizationConfig voiceEqualizationConfig) {
        ...
        LogUtil.m80900d(TAG, "setLocalVoiceEqualization...frequency : " + voiceEqualizationConfig.frequency + ", gain: " + voiceEqualizationConfig.gain);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalVoiceEqualization failed.");
    ...
    public int setLocalVoicePitch(int i) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalVoicePitch failed.");
    ...
    public int setLocalVoiceReverbParam(VoiceReverbConfig voiceReverbConfig) {
        ...
        LogUtil.m80900d(TAG, "setLocalVoiceReverbParam...roomSize: " + voiceReverbConfig.roomSize + ", decayTime: " + voiceReverbConfig.decayTime + ", damping:" + voiceReverbConfig.damping + ", wetGain:" + voiceReverbConfig.wetGain + ", dryGain:" + voiceReverbConfig.dryGain + ", preDelay:" + voiceReverbConfig.preDelay);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalVoiceReverbParam failed.");
    ...
    public int setPlaybackVolume(int i) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setPlaybackVolume failed.");
    ...
    public int setPublishFallbackOption(PublishFallbackOption publishFallbackOption) {
        ...
        LogUtil.m80900d(TAG, "setPublishFallbackOption: option: " + publishFallbackOption);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setPublishFallbackOption failed.");
    ...
    public int setRemoteAudioPlaybackVolume(RemoteStreamKey remoteStreamKey, int i) {
        ...
        LogUtil.m80900d(TAG, "setRemoteAudioPlaybackVolume");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                if (remoteStreamKey.getRoomId() == null) {
                    LogUtil.m80901e(TAG, "setRemoteAudioPlaybackVolume: roomId is null adjust failed");
                    iNativeSetRemoteAudioPlaybackVolume = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
                } else if (remoteStreamKey.getUserId() == null) {
                    LogUtil.m80901e(TAG, "setRemoteAudioPlaybackVolume: uid is null adjust failed");
                    iNativeSetRemoteAudioPlaybackVolume = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
                } else {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, setRemoteAudioPlaybackVolume failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setRemoteUserPriority(@NonNull String str, @NonNull String str2, RemoteUserPriority remoteUserPriority) {
        ...
        LogUtil.m80900d(TAG, "setRemoteUserPriority: uid: " + str2 + ", priority: " + remoteUserPriority);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setRemoteUserPriority failed.");
                iNativeSetRemoteUserPriority = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (str2 == null) {
                LogUtil.m80901e(TAG, "setRemoteUserPriority: uid is null set failed");
        ...
        if (remoteStreamKey != null) {
            try {
                if (remoteStreamKey.hasNullProperty()) {
                    LogUtil.m80903i(TAG, "EventType: setupRemoteVideo stream_key has null property");
                    iNativeSetRemoteVideoCanvas = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
                } else if (engineInvalid()) {
                    LogUtil.m80901e(TAG, "native engine is invalid, setRemoteVideoCanvas failed.");
    ...
    public int setRemoteVideoSink(RemoteStreamKey remoteStreamKey, IVideoSink iVideoSink, RemoteVideoSinkConfig remoteVideoSinkConfig) {
        ...
        try {
            if (remoteStreamKey == null) {
                LogUtil.m80901e(TAG, "EventType: setupRemoteRenderInternal, streamKey is null");
                iNativesetRemoteVideoSink = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else if (remoteStreamKey.getStreamIndex() == null) {
                LogUtil.m80901e(TAG, "EventType: setupRemoteRenderInternal, streamIndex is null");
                iNativesetRemoteVideoSink = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setRemoteVideoSink failed.");
    ...
    public int setRemoteVideoSuperResolution(RemoteStreamKey remoteStreamKey, VideoSuperResolutionMode videoSuperResolutionMode) {
        ...
        LogUtil.m80900d(TAG, "setRemoteVideoSuperResolution: " + remoteStreamKey.toString() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + videoSuperResolutionMode.toString());
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setRemoteVideoSuperResolution failed.");
    ...
    public int setRtcVideoEventHandler(IRTCEngineEventHandler iRTCEngineEventHandler) {
        LogUtil.m80900d(TAG, "setRtcEngineEventHandler");
        this.mRtcEngineHandler = iRTCEngineEventHandler;
        return 0;
    }
    ...
    public int setRtcVideoEventHandlerEx(IRTCEngineEventHandlerEx iRTCEngineEventHandlerEx) {
        LogUtil.m80900d(TAG, "setRtcEngineEventHandlerEx");
        this.mRtcEngineHandlerEx = iRTCEngineEventHandlerEx;
        return 0;
    }
    ...
    public int setScreenAudioSourceType(AudioSourceType audioSourceType) {
        ...
        LogUtil.m80900d(TAG, "SetScreenAudioSourceType");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetScreenAudioSourceType failed.");
    ...
    public int setScreenAudioStreamIndex(StreamIndex streamIndex) {
        ...
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "SetScreenAudioStreamIndex");
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetScreenAudioStreamIndex failed.");
    ...
    public int setScreenCaptureVolume(int i) {
        LogUtil.m80900d(TAG, "setScreenCaptureVolume");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctionsEx.nativeSetScreenCaptureVolume(this.mNativeEngine, i);
            }
            LogUtil.m80901e(TAG, "native engine is invalid, setScreenCaptureVolume failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setScreenVideoEncoderConfig(VideoEncoderConfig videoEncoderConfig) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setScreenVideoEncoderConfig failed.");
    ...
    public int setSubscribeFallbackOption(SubscribeFallbackOptions subscribeFallbackOptions) {
        ...
        LogUtil.m80900d(TAG, "setRemoteSubscribeFallbackOption: option: " + subscribeFallbackOptions);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setRemoteSubscribeFallbackOption failed.");
    ...
    public int setVideoCaptureConfig(VideoCaptureConfig videoCaptureConfig) {
        ...
        try {
            if (videoCaptureConfig == null) {
                LogUtil.m80901e(TAG, "native engine is invalid or videoCaptureConfig is null, setVideoCaptureConfig failed.");
                ...
                LogUtil.m80900d(TAG, "setVideoCaptureConfig: " + videoCaptureConfig.toString());
    ...
    public int setVideoCaptureRotation(VideoRotation videoRotation) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoCaptureRotation failed.");
    ...
    public int setVideoDecoderConfig(RemoteStreamKey remoteStreamKey, VideoDecoderConfig videoDecoderConfig) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, SetVideoDecoderConfig failed.");
    ...
    public int setVideoDenoiser(VideoDenoiseMode videoDenoiseMode) {
        ...
        LogUtil.m80900d(TAG, "setVideoDenoiser: " + videoDenoiseMode.toString());
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoDenoiser failed.");
    ...
    public int setVideoDigitalZoomConfig(ZoomConfigType zoomConfigType, float f) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoDigitalZoomConfig failed.");
    ...
    public int setVideoDigitalZoomControl(ZoomDirectionType zoomDirectionType) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoDigitalZoomControl failed.");
    ...
    public int setVideoEncoderConfig(StreamIndex streamIndex, List<VideoEncoderConfig> list) {
        ...
        if (engineInvalid()) {
            LogUtil.m80901e(TAG, "native engine is invalid, setVideoResolutions failed.");
            ...
            for (VideoEncoderConfig videoEncoderConfig : list) {
                if (streamIndex != StreamIndex.STREAM_INDEX_MAIN || videoEncoderConfig.isValid()) {
                    ...
                    LogUtil.m80901e(TAG, "setVideoResolutions with illegal params");
    ...
    public int setVideoOrientation(VideoOrientation videoOrientation) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoOrientation failed.");
    ...
    public int setVideoRotationMode(VideoRotationMode videoRotationMode) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoRotationMode failed.");
    ...
    public int setVideoSource(StreamIndex streamIndex, InternalVideoSourceConfig internalVideoSourceConfig) {
        LogUtil.m80900d(TAG, "setVideoSource");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, setVideoSource failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setVideoSourceType(StreamIndex streamIndex, VideoSourceType videoSourceType) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVideoInputType failed.");
    ...
    public int setVideoWatermark(StreamIndex streamIndex, String str, RTCWatermarkConfig rTCWatermarkConfig) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, muteAudioPlayback failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
                ByteWatermark byteWatermark = rTCWatermarkConfig.positionInLandscapeMode;
                if (byteWatermark != null) {
                    float f9 = byteWatermark.f55641x;
                    float f10 = byteWatermark.f55642y;
                ...
                if (byteWatermark2 != null) {
                    float f12 = byteWatermark2.f55641x;
                    float f13 = byteWatermark2.f55642y;
    ...
    public int setVoiceChangerType(VoiceChangerType voiceChangerType) {
        ...
        LogUtil.m80900d(TAG, "setVoiceChangerType...voiceChanger: " + voiceChangerType);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVoiceChangerType failed.");
    ...
    public int setVoiceReverbType(VoiceReverbType voiceReverbType) {
        ...
        LogUtil.m80900d(TAG, "setVoiceReverbType...voiceReverb: " + voiceReverbType);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setVoiceReverbType failed.");
    ...
    public int startAudioCapture() {
        ...
        LogUtil.m80900d(TAG, "startAudioCapture");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startAudioCapture failed.");
    ...
    public int startAudioRecording(AudioRecordingConfig audioRecordingConfig) {
        ...
        LogUtil.m80900d(TAG, "startAudioRecording");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startFileRecording failed.");
    ...
    public int startChorusCacheSync(ChorusCacheSyncConfig chorusCacheSyncConfig, IChorusCacheSyncObserver iChorusCacheSyncObserver) {
        ...
        LogUtil.m80900d(TAG, "startChorusCacheSync...");
        if (chorusCacheSyncConfig == null) {
            LogUtil.m80900d(TAG, "startChorusCacheSync...chorusConfig is null, no effect, please check.");
            iNativeStartChorusCacheSync = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
        } else if (engineInvalid()) {
            LogUtil.m80901e(TAG, "native engine is invalid, startChorusCacheSync failed.");
    ...
    public int startClientMixedStream(String str, MixedStreamConfig mixedStreamConfig, ClientMixedStreamConfig clientMixedStreamConfig) {
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "startClientMixedStream...");
            if (mixedStreamConfig == null || clientMixedStreamConfig == null) {
                LogUtil.m80900d(TAG, "startClientMixedStream...liveTranscode is null, no effect, please check.");
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startClientMixedStream failed.");
            } else {
    ...
    public int startCloudProxy(List<CloudProxyInfo> list) {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, startCloudProxy failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else if (list == null) {
                iValue = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else {
    ...
    public int startEchoTest(EchoTestConfig echoTestConfig, int i) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startEchoTest failed.");
                iNativeStartEchoTest = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
                LogUtil.m80900d(TAG, "startEchoTest");
    ...
    public int startFileRecording(StreamIndex streamIndex, RecordingConfig recordingConfig, RecordingType recordingType) {
        ...
        LogUtil.m80900d(TAG, "startFileRecording");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startFileRecording failed.");
    ...
    public int startHardwareEchoDetection(String str) {
        LogUtil.m80900d(TAG, "startHardwareEchoDetection");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctions.nativeStartHardwareEchoDetection(this.mNativeEngine, str);
            }
            LogUtil.m80901e(TAG, "native engine is invalid, startHardwareEchoDetection failed.");
            return -2;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int startNetworkDetection(boolean z, int i, boolean z2, int i2) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, sendCustomMessage failed.");
    ...
    public int startPushMixedStream(String str, MixedStreamPushTargetConfig mixedStreamPushTargetConfig, MixedStreamConfig mixedStreamConfig) {
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "startPushMixedStream...");
            if (mixedStreamConfig == null) {
                LogUtil.m80900d(TAG, "startPushMixedStream...liveTranscode is null, no effect, please check.");
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startPushMixedStream failed.");
            } else {
                this.mEnableTranscode = true;
                if (mixedStreamConfig.getTranscodeMessage() != null) {
                    LogUtil.m80900d(TAG, "startPushMixedStream...");
    ...
    public int startPushSingleStream(String str, PushSingleStreamParam pushSingleStreamParam) {
        ...
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "startPushSingleStream...");
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startPushSingleStream failed.");
    ...
    public int startScreenCapture(ScreenMediaType screenMediaType, Intent intent) {
        ...
        LogUtil.m80900d(TAG, "StartScreenAudioCapture");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, StopScreenAudioCapture failed.");
    ...
    public int startVideoCapture(StreamIndex streamIndex, String str) {
        LogUtil.m80900d(TAG, "startVideoCapture");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctionsEx.nativeStartVideoCapture(this.mNativeEngine, streamIndex.value(), str);
            }
            LogUtil.m80901e(TAG, "native engine is invalid, startVideoCapture failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int startVideoDigitalZoomControl(ZoomDirectionType zoomDirectionType) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, startVideoDigitalZoomControl failed.");
    ...
    public int stopAudioCapture() {
        ...
        LogUtil.m80900d(TAG, "stopAudioCapture");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopAudioCapture failed.");
    ...
    public int stopChorusCacheSync() {
        ...
        LogUtil.m80900d(TAG, "stopChorusCacheSync...");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopChorusCacheSync failed.");
    ...
    public int stopClientMixedStream(String str) {
        ...
        LogUtil.m80900d(TAG, "stopClientMixedStream...");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopClientMixedStream failed.");
    ...
    public int stopCloudProxy() {
        ...
        try {
            if (engineInvalid() || this.mState == State.DESTORY) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopCloudProxy failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int stopEchoTest() {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopEchoTest failed.");
                iNativeStopEchoTest = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
                LogUtil.m80900d(TAG, "stopEchoTest");
    ...
    public int stopFileRecording(StreamIndex streamIndex) {
        ...
        LogUtil.m80900d(TAG, "stopFileRecording");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopFileRecording failed.");
    ...
    public int stopHardwareEchoDetection() {
        LogUtil.m80900d(TAG, "stopHardwareEchoDetection");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctions.nativeStopHardwareEchoDetection(this.mNativeEngine);
            }
            LogUtil.m80901e(TAG, "native engine is invalid, stopHardwareEchoDetection failed.");
            return -2;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int stopPushMixedStream(String str, MixedStreamPushTargetType mixedStreamPushTargetType) {
        ...
        LogUtil.m80900d(TAG, "stopPushMixedStream...");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopPushMixedStream failed.");
    ...
    public int stopPushSingleStream(String str) {
        ...
        LogUtil.m80900d(TAG, "stopPushSingleStream...");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopPushSingleStream failed.");
    ...
    public int stopScreenCapture() {
        ...
        LogUtil.m80900d(TAG, "StopScreenCapture");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, StopScreenAudioCapture failed.");
    ...
    public int stopVideoCapture(StreamIndex streamIndex) {
        LogUtil.m80900d(TAG, "stopVideoCapture");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
                return NativeRTCVideoFunctionsEx.nativeStopVideoCapture(this.mNativeEngine, streamIndex.value());
            }
            LogUtil.m80901e(TAG, "native engine is invalid, stopVideoCapture failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int stopVideoDigitalZoomControl() {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, stopVideoDigitalZoomControl failed.");
    ...
    public int switchCamera(CameraId cameraId) {
        ...
        LogUtil.m80900d(TAG, BLiveButtonType.switchCamera);
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, switchCamera failed.");
    ...
    public long takeLocalSnapshot(StreamIndex streamIndex, ISnapshotResultCallback iSnapshotResultCallback) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, takeLocalSnapshot failed.");
    ...
    public long takeRemoteSnapshot(RemoteStreamKey remoteStreamKey, ISnapshotResultCallback iSnapshotResultCallback) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, takeRemoteSnapshot failed.");
    ...
    public int updateClientMixedStream(String str, MixedStreamConfig mixedStreamConfig, ClientMixedStreamConfig clientMixedStreamConfig) {
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "updateClientMixedStream...");
            if (mixedStreamConfig == null || clientMixedStreamConfig == null) {
                LogUtil.m80900d(TAG, "updateClientMixedStream...mLiveTranscoding is null, no effect, please check.");
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, updateClientMixedStream failed.");
    ...
    public int updateLocalVideoCanvas(StreamIndex streamIndex, int i, int i2) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, updateLocalVideoCanvas failed.");
    ...
    public int updatePushMixedStream(String str, MixedStreamPushTargetConfig mixedStreamPushTargetConfig, MixedStreamConfig mixedStreamConfig) {
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "updatePushMixedStream...");
            if (mixedStreamConfig == null) {
                LogUtil.m80900d(TAG, "updatePushMixedStream...mLiveTranscoding is null, no effect, please check.");
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, updatePushMixedStream failed.");
            } else if (mixedStreamConfig.getTranscodeMessage() != null) {
                LogUtil.m80900d(TAG, "updatePushMixedStream...");
    ...
    public int updateRemoteStreamVideoCanvas(RemoteStreamKey remoteStreamKey, RemoteVideoRenderConfig remoteVideoRenderConfig) {
        ...
        try {
            if (remoteStreamKey == null) {
                LogUtil.m80901e(TAG, "EventType: updateRemoteStreamVideoCanvas, streamKey is null");
                iNativeUpdateRemoteVideoCanvas = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else if (remoteStreamKey.hasNullProperty()) {
                LogUtil.m80901e(TAG, "EventType: updateRemoteStreamVideoCanvas, hasNullProperty");
                iNativeUpdateRemoteVideoCanvas = ReturnStatus.RETURN_STATUS_PARAMETER_ERR.value();
            } else if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, updateRemoteStreamVideoCanvas failed.");
    ...
    public int updateScreenCapture(ScreenMediaType screenMediaType) {
        ...
        LogUtil.m80900d(TAG, "UpdateScreenCapture");
        this.mJniReadLock.lock();
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, StopScreenAudioCapture failed.");
    ...
    public int setVideoCaptureConfig(StreamIndex streamIndex, VideoCaptureConfig videoCaptureConfig) {
        LogUtil.m80900d(TAG, "setVideoCaptureConfig");
        this.mJniReadLock.lock();
        try {
            if (!engineInvalid() && this.mState != State.DESTORY) {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, setVideoCaptureConfig failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setLocalSimulcastMode(VideoSimulcastMode videoSimulcastMode) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "native engine is invalid, setLocalSimulcastMode failed.");
