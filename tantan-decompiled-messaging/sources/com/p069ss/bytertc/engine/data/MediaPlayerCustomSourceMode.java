...
public enum MediaPlayerCustomSourceMode {
    ...
    public String toString() {
        int i = C134251.f55614x20c90010[ordinal()];
        if (i != 1) {
            return i != 2 ? "" : "PULL";
        }
        return "PUSH";
