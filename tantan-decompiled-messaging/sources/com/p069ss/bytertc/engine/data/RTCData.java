...
import com.p069ss.bytertc.engine.video.VideoEncoderConfiguration;
...
public class RTCData {
    ...
    public void setVideoStreamDescriptions(VideoStreamDescription[] videoStreamDescriptionArr) {
        LogUtil.m80903i(TAG, "setVideoStreamDescriptions: " + Arrays.toString(videoStreamDescriptionArr));
