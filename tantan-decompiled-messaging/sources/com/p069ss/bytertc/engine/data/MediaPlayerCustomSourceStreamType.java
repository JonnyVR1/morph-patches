...
public enum MediaPlayerCustomSourceStreamType {
    ...
    public String toString() {
        int i = C134271.f55616xed7a1387[ordinal()];
        if (i != 1) {
            return i != 2 ? "" : "ENCODED";
        }
        return "RAW";
