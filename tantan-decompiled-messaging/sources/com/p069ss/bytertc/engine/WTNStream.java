...
public class WTNStream implements IWTNStream {
    ...
    @Override // com.p069ss.bytertc.engine.IWTNStream
    public int setWTNRemoteAudioPlaybackVolume(String str, int i) {
        ...
        try {
            if (this.mNativeWTNStream == 0) {
                LogUtil.m80901e(TAG, "native engine is invalid, setWTNRemoteAudioPlaybackVolume failed.");
                iNativeSetWTNRemoteAudioPlaybackVolume = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
                LogUtil.m80900d(TAG, "setWTNRemoteAudioPlaybackVolume...public stream id: " + str + ", volume: " + i);
    ...
    public int setWTNRemoteVideoCanvas(String str, VideoCanvas videoCanvas) {
        ...
        try {
            if (this.mNativeWTNStream == 0) {
                LogUtil.m80901e(TAG, "native engine is invalid, setWTNRemoteVideoCanvas failed.");
                iNativeSetWTNRemoteVideoCanvas = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
                LogUtil.m80900d(TAG, "setWTNRemoteVideoCanvas...public stream id: " + str);
    ...
    public int setWTNRemoteVideoSink(String str, IVideoSink iVideoSink, RemoteVideoSinkConfig remoteVideoSinkConfig) {
        ...
        try {
            if (this.mNativeWTNStream == 0) {
                LogUtil.m80901e(TAG, "native engine is invalid, setWTNRemoteVideoSink failed.");
                iNativeSetWTNRemoteVideoSink = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
                LogUtil.m80900d(TAG, "setWTNRemoteVideoSink...public stream id: " + str);
    ...
    public int setWTNStreamEventHandler(IWTNStreamEventHandler iWTNStreamEventHandler) {
        ...
        try {
            if (this.mNativeWTNStream == 0) {
                LogUtil.m80901e(TAG, "native WTNStream is invalid, setWTNStreamEventHandler failed.");
                return -1;
            }
    ...
    public int subscribeWTNAudioStream(String str, boolean z) {
        ...
        try {
            if (this.mNativeWTNStream == 0) {
                LogUtil.m80901e(TAG, "native WTNStream is invalid, subscribeWTNAudioStream failed.");
                return -1;
            }
            LogUtil.m80900d(TAG, "subscribeWTNAudioStream...public stream id: " + str + ", subscribe: " + z);
    ...
    public int subscribeWTNVideoStream(String str, boolean z) {
        ...
        try {
            if (this.mNativeWTNStream == 0) {
                LogUtil.m80901e(TAG, "native WTNStream is invalid, subscribeWTNVideoStream failed.");
                return -1;
            }
            LogUtil.m80900d(TAG, "subscribeWTNVideoStream...public stream id: " + str + ", subscribe: " + z);
