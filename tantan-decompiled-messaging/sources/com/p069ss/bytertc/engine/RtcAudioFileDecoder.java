...
class RtcAudioFileDecoder {
    ...
    private HttpURLConnection f55612oc;
    private int mSampleRate = 0;
    private int mChannels = 0;

    @CalledByNative
    public RtcAudioFileDecoder() {
        RXLogging.m5688e(TAG, "AudioMix RtcAudioFileDecoder");
    }
    ...
    private boolean isAvailableOnlineURL(String str) {
        ...
        try {
            ...
            this.f55612oc = httpURLConnection;
            httpURLConnection.setUseCaches(false);
            this.f55612oc.setConnectTimeout(TXLiteAVCode.WARNING_START_CAPTURE_IGNORED);
            RXLogging.m5688e(TAG, "connect done....");
            int responseCode = this.f55612oc.getResponseCode();
            if (200 == responseCode) {
                z = true;
            } else {
            ...
            InputStream inputStream = this.f55612oc.getInputStream();
            if (inputStream != null) {
                inputStream.close();
            }
            return z;
            ...
            HttpURLConnection httpURLConnection2 = this.f55612oc;
    ...
    public void disConnectURL() {
        ...
        HttpURLConnection httpURLConnection = this.f55612oc;
