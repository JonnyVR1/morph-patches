...
public class Constants {
    ...
    public static final int CHANNEL_PROFIEL_MEETING = 16;
    public static final int CHANNEL_PROFIEL_VR_CHAT = 13;
    public static final int CHANNEL_PROFILE_CALL = 19;
    public static final int CHANNEL_PROFILE_CHAT = 5;
    public static final int CHANNEL_PROFILE_CHAT_ROOM = 6;
    public static final int CHANNEL_PROFILE_CHORUS = 12;
    public static final int CHANNEL_PROFILE_CLASSROOM = 18;
    public static final int CHANNEL_PROFILE_CLOUD_GAME = 3;
    public static final int CHANNEL_PROFILE_COMMUNICATION = 0;
    public static final int CHANNEL_PROFILE_CO_HOST = 9;
    public static final int CHANNEL_PROFILE_GAME = 2;
    public static final int CHANNEL_PROFILE_GAME_HD = 8;
    public static final int CHANNEL_PROFILE_GAME_STREAMING = 14;
    public static final int CHANNEL_PROFILE_INTERACTIVE_PODCAST = 10;
    public static final int CHANNEL_PROFILE_KTV = 11;
    public static final int CHANNEL_PROFILE_LAN_LIVE_STREAMING = 15;
    public static final int CHANNEL_PROFILE_LIVE = 20;
    public static final int CHANNEL_PROFILE_LIVE_BROADCASTING = 1;
    public static final int CHANNEL_PROFILE_LOW_LARENCY = 4;
    public static final int CHANNEL_PROFILE_LW_TOGETHER = 7;
    public static final int CHANNEL_PROFILE_MEETING_ROOM = 17;
