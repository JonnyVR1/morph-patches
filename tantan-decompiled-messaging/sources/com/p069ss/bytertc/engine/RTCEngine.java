...
import com.p069ss.bytertc.engine.utils.EngineConfigCheck;
import com.p069ss.bytertc.engine.utils.LogUtil;
import com.p069ss.bytertc.engine.utils.RTCEglContextChecker;
...
public abstract class RTCEngine {
    ...
    public static synchronized RTCEngine createRTCEngine(EngineConfig engineConfig, IRTCEngineEventHandler iRTCEngineEventHandler) {
        ...
        if (EngineConfigCheck.checkValid(engineConfig) != 0) {
            LogUtil.m80901e(TAG, "createRTCEngine: engine config is invalid, error code is " + EngineConfigCheck.checkValid(engineConfig));
            return null;
        }
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "error in obtain create engine time. " + e.getMessage());
        }
        if (!RTCEngineImpl.initializeNativeLibs(engineConfig.nativeLoadPath)) {
            LogUtil.m80901e(TAG, "createRTCEngine: fail to load native library");
            return null;
        }
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "createRTCEngine: throw exception " + e2.getMessage());
            return null;
        }
    }
    ...
    public static void setRtcNativeLibraryLoader(RTCNativeLibraryLoader rTCNativeLibraryLoader) {
        LogUtil.m80903i(TAG, "set rtc native library loader" + rTCNativeLibraryLoader);
