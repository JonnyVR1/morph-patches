...
public class InternalVideoEncoderConfig {
    ...
    public static /* synthetic */ class C133991 {
        ...
        static final /* synthetic */ int[] f55607x813d4dec;

        /* JADX INFO: renamed from: $SwitchMap$com$ss$bytertc$engine$VideoEncoderConfig$VideoCodecType */
        static final /* synthetic */ int[] f55608x7fb11380;

        static {
            int[] iArr = new int[VideoEncoderConfig.EncoderPreference.values().length];
            f55607x813d4dec = iArr;
            try {
                iArr[VideoEncoderConfig.EncoderPreference.DISABLED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f55607x813d4dec[VideoEncoderConfig.EncoderPreference.MAINTAIN_FRAMERATE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f55607x813d4dec[VideoEncoderConfig.EncoderPreference.MAINTAIN_QUALITY.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f55607x813d4dec[VideoEncoderConfig.EncoderPreference.AUTO.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            int[] iArr2 = new int[VideoEncoderConfig.VideoCodecType.values().length];
            f55608x7fb11380 = iArr2;
            try {
                iArr2[VideoEncoderConfig.VideoCodecType.CODEC_TYPE_AUTO.ordinal()] = 1;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f55608x7fb11380[VideoEncoderConfig.VideoCodecType.CODEC_TYPE_H264.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f55608x7fb11380[VideoEncoderConfig.VideoCodecType.CODEC_TYPE_BYTEVC1.ordinal()] = 3;
    ...
    private InternalVideoEncoderPreference ConvertEnumValue(VideoEncoderConfig.EncoderPreference encoderPreference) {
        ...
        int i = C133991.f55607x813d4dec[encoderPreference.ordinal()];
        if (i == 1) {
    ...
    private InternalVideoCodecType ConvertEnumValue(VideoEncoderConfig.VideoCodecType videoCodecType) {
        ...
        int i = C133991.f55608x7fb11380[videoCodecType.ordinal()];
        if (i == 1) {
    ...
    private InternalVideoCodecMode ConvertEnumValue(VideoEncoderConfig.CodecMode codecMode) {
        ...
        int i = C133991.$SwitchMap$com$ss$bytertc$engine$VideoEncoderConfig$CodecMode[codecMode.ordinal()];
        if (i == 1) {
