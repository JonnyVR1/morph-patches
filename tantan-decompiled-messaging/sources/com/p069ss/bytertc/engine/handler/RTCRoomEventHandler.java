...
import com.p069ss.bytertc.engine.InternalNetworkQualityInfo;
...
import com.p069ss.bytertc.engine.type.RoomEvent;
import com.p069ss.bytertc.engine.type.RoomEventInfo;
import com.p069ss.bytertc.engine.type.RoomState;
import com.p069ss.bytertc.engine.type.RoomStateChangeReason;
import com.p069ss.bytertc.engine.type.SetRoomExtraInfoResult;
...
import com.p069ss.bytertc.engine.type.UserVisibilityChangeError;
...
public class RTCRoomEventHandler {
    ...
    public void onAVSyncStateChange(AVSyncState aVSyncState) {
        LogUtil.m80900d(TAG, "onAVSyncStateChange: " + aVSyncState);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onAVSyncStateChange callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioPublishStateChanged(String str, String str2, PublishState publishState, PublishStateChangeReason publishStateChangeReason) {
        LogUtil.m80900d(TAG, "onAudioPublishStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onAudioPublishStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioStreamBanned(String str, boolean z) {
        ...
        try {
            ...
            LogUtil.m80900d(TAG, "onAudioStreamBanned callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioSubscribeStateChanged(String str, String str2, SubscribeState subscribeState, SubscribeStateChangeReason subscribeStateChangeReason) {
        LogUtil.m80900d(TAG, "onAudioSubscribeStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onAudioSubscribeStateChanged callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onForwardStreamEvent(ForwardStreamEventInfo[] forwardStreamEventInfoArr) {
        LogUtil.m80900d(TAG, "onForwardStreamEvent");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onForwardStreamEvent callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onForwardStreamStateChanged(ForwardStreamStateInfo[] forwardStreamStateInfoArr) {
        LogUtil.m80900d(TAG, "OnForwardStreamStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onForwardStreamStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLocalStreamStats(InternalLocalStreamStats internalLocalStreamStats) {
        LogUtil.m80900d(TAG, "onLocalStreamStats...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onNetworkQuality(InternalNetworkQualityInfo internalNetworkQualityInfo, InternalNetworkQualityInfo[] internalNetworkQualityInfoArr) {
        ...
        LogUtil.m80900d(TAG, "Local onNetworkQuality, uid: " + internalNetworkQualityInfo.uid + ", info: " + internalNetworkQualityInfo.toString());
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            if (rtcRoomHandler != null) {
                ...
                for (int i = 0; i < internalNetworkQualityInfoArr.length; i++) {
                    LogUtil.m80900d(TAG, "Remote onNetworkQuality, uid: " + internalNetworkQualityInfoArr[i].uid + ", info: " + internalNetworkQualityInfoArr[i].toString());
            ...
            LogUtil.m80900d(TAG, "onNetworkQuality callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onPublishPrivilegeTokenWillExpire() {
        LogUtil.m80900d(TAG, "onPublishPrivilegeTokenWillExpire");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onPublishPrivilegeTokenWillExpire callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onRemoteStreamStats(InternalRemoteStreamStats internalRemoteStreamStats) {
        LogUtil.m80900d(TAG, "onRemoteStreamStats...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onRoomEvent(String str, String str2, int i, InternalRoomEventInfo internalRoomEventInfo) {
        LogUtil.m80900d(TAG, "onRoomEvent...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onRtcStats callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onRoomExtraInfoUpdate(String str, String str2, String str3, long j) {
        LogUtil.m80900d(TAG, "onRoomExtraInfoUpdate , key:" + str + ",value:" + str2);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80901e(TAG, "onRoomExtraInfoUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRoomStateChangedWithReason(String str, String str2, int i, int i2) {
        LogUtil.m80900d(TAG, "onRoomStateChangedWithReason...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onRoomStats(InternalRTCStats internalRTCStats) {
        LogUtil.m80900d(TAG, "onRtcStats...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onRoomWarning(int i) {
        LogUtil.m80900d(TAG, "onRoomWarning, warnNum: " + i);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onRoomWarning callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onScreenAudioPublishStateChanged(String str, String str2, PublishState publishState, PublishStateChangeReason publishStateChangeReason) {
        LogUtil.m80900d(TAG, "onScreenAudioPublishStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onScreenAudioPublishStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onScreenAudioSubscribeStateChanged(String str, String str2, SubscribeState subscribeState, SubscribeStateChangeReason subscribeStateChangeReason) {
        LogUtil.m80900d(TAG, "onScreenAudioSubscribeStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onScreenAudioSubscribeStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onScreenVideoPublishStateChanged(String str, String str2, PublishState publishState, PublishStateChangeReason publishStateChangeReason) {
        LogUtil.m80900d(TAG, "onScreenVideoPublishStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onScreenVideoPublishStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onScreenVideoSubscribeStateChanged(String str, String str2, SubscribeState subscribeState, SubscribeStateChangeReason subscribeStateChangeReason) {
        LogUtil.m80900d(TAG, "onScreenVideoSubscribeStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onScreenVideoSubscribeStateChanged callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onSetRoomExtraInfoResult(long j, int i) {
        LogUtil.m80900d(TAG, "onSetRoomExtraInfoResult,result:" + i);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onSetRoomExtraInfoResult callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onStreamAdd(RTCStream rTCStream) {
        LogUtil.m80900d(TAG, "onStreamAdd...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onStreamAdd callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onStreamRemove(RTCStream rTCStream, int i) {
        LogUtil.m80900d(TAG, "onStreamRemove...uid: " + rTCStream.userId);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onStreamRemove callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onStreamStateChanged(String str, String str2, int i, String str3) {
        LogUtil.m80900d(TAG, "onStreamStateChanged...");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onSubscribePrivilegeTokenWillExpire() {
        LogUtil.m80900d(TAG, "onSubscribePrivilegeTokenWillExpire");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onSubscribePrivilegeTokenWillExpire callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onSubtitleMessageReceived(SubtitleMessage[] subtitleMessageArr) {
        LogUtil.m80900d(TAG, "onSubtitleMessageReceived, subtitles length: " + subtitleMessageArr.length);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onSubtitleMessageReceived callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onSubtitleStateChanged(int i, int i2, String str) {
        LogUtil.m80900d(TAG, "onSubtitleStateChanged, state: " + i + ", errorCode: " + i2 + ", errorMessage: " + str);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onSubtitleStateChanged callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onTokenWillExpire() {
        LogUtil.m80900d(TAG, "onTokenWillExpire");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onTokenWillExpire callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserPublishScreen(String str, int i) {
        LogUtil.m80900d(TAG, "onUserPublishScreen... uid: " + str + ", type: " + i);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onUserPublishScreen callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onUserPublishScreenAudio(String str, String str2, boolean z) {
        LogUtil.m80900d(TAG, "onUserPublishScreenAudio");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onUserPublishScreenAudio callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onUserPublishScreenVideo(String str, String str2, boolean z) {
        LogUtil.m80900d(TAG, "onUserPublishScreenVideo");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onUserPublishScreenVideo callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onUserPublishStream(String str, int i) {
        LogUtil.m80900d(TAG, "onUserPublishStream... uid: " + str + ", type: " + i);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onUserPublishStreamAudio(String str, String str2, boolean z) {
        LogUtil.m80900d(TAG, "onUserPublishStreamAudio");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onUserPublishStreamAudio callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onUserPublishStreamVideo(String str, String str2, boolean z) {
        LogUtil.m80900d(TAG, "onUserPublishStreamVideo");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onUserPublishStreamVideo callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onUserUnpublishScreen(String str, int i, int i2) {
        LogUtil.m80900d(TAG, "onUserUnPublishScreen... uid: " + str + ", type: " + i + ", reasen:" + i2);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onUserUnPublishScreen callback catch exception.\n" + e.getMessage());
        }
    }

    @CalledByNative
    public void onUserUnpublishStream(String str, int i, int i2) {
        LogUtil.m80900d(TAG, "onUserUnPublishStream... uid: " + str + ", type: " + i + ", reasen:" + i2);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
    ...
    public void onUserVisibilityChanged(boolean z, UserVisibilityChangeError userVisibilityChangeError) {
        LogUtil.m80900d(TAG, "onUserVisibilityChanged, currentUserVisibility:" + z + ", errorCode:" + userVisibilityChangeError);
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80901e(TAG, "onUserVisibilityChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoPublishStateChanged(String str, String str2, PublishState publishState, PublishStateChangeReason publishStateChangeReason) {
        LogUtil.m80900d(TAG, "onVideoPublishStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onVideoPublishStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoStreamBanned(String str, boolean z) {
        ...
        try {
            ...
            LogUtil.m80900d(TAG, "onVideoStreamBanned callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoSubscribeStateChanged(String str, String str2, SubscribeState subscribeState, SubscribeStateChangeReason subscribeStateChangeReason) {
        LogUtil.m80900d(TAG, "onVideoSubscribeStateChanged");
        try {
            RTCRoomImpl rTCRoomImpl = this.mRtcRoom;
            if (rTCRoomImpl != null) {
            ...
            LogUtil.m80900d(TAG, "onVideoSubscribeStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
}
