...
import com.p069ss.bytertc.engine.handler.RTCRoomEventHandlerEx;
...
public class RTCRoomImpl extends RTCRoomEx {
    ...
    public static String getCloudRenderingInfo(String str, String str2) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "getCloudRenderingInfo catch exception , e : " + e.getMessage());
            return null;
        }
    }
    ...
    @Override // com.p069ss.bytertc.engine.RTCRoom, com.p069ss.bytertc.engine.RTSRoom
    public void destroy() {
    ...
    @Override // com.p069ss.bytertc.engine.RTCRoom
    public int enableSubscribeLocalStream(boolean z) {
        int iNativeEnableSubscribeLocalStream;
        LogUtil.m80900d(TAG, "enableSubscribeLocalStream: " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, EnableSubscribeLocalStream failed.");
    ...
    public String getCallId() {
        ...
        LogUtil.m80900d(TAG, "getCallId");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, getCallId failed.");
                strNativeGetCallId = "";
            } else {
    ...
    public IPanoramicVideo getPanoramicVideo() {
        LogUtil.m80900d(TAG, "getPanoramicVideo...");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j != 0) {
                ...
                if (nativePanoramicVideo == null) {
                    ...
                    if (jNativeGetPanoramicVideo == 0) {
                        LogUtil.m80901e(TAG, "getPanoramicVideo failed");
                    } else {
            ...
            LogUtil.m80901e(TAG, "native rtcroom is invalid, getPanoramicVideo failed.");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public String getRoomId() {
        ...
        LogUtil.m80900d(TAG, "getRoomId");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, getRoomId failed.");
                strNativeGetRoomId = "";
            } else {
    ...
    public ISpatialAudio getSpatialAudio() {
        LogUtil.m80900d(TAG, "getSpatialAudio...");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j != 0) {
                ...
                if (nativeSpatialAudio == null) {
                    ...
                    if (jNativeGetSpatialAudio == 0) {
                        LogUtil.m80901e(TAG, "getSpatialAudio failed");
                    } else {
            ...
            LogUtil.m80901e(TAG, "native rtcroom is invalid, getSpatialAudio failed.");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int pauseAllSubscribedStreamAudio() {
        ...
        LogUtil.m80900d(TAG, "pauseAllSubscribedStreamAudio...");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, pauseAllSubscribedStreamAudio failed.");
    ...
    public int pauseAllSubscribedStreamVideo() {
        ...
        LogUtil.m80900d(TAG, "pauseAllSubscribedStreamVideo...");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, pauseAllSubscribedStreamVideo failed.");
    ...
    public int pauseForwardStreamToAllRooms() {
        ...
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, pauseForwardStreamToAllRooms failed.");
    ...
    public int publishScreenAudio(boolean z) {
        ...
        LogUtil.m80900d(TAG, "publishScreenAudio");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid,publishScreenAudio failed.\"");
    ...
    public int publishScreenVideo(boolean z) {
        ...
        LogUtil.m80900d(TAG, "publishScreenVideo");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid,publishScreenVideo failed.\"");
    ...
    @Override // com.p069ss.bytertc.engine.RTCRoomEx
    public int publishStream(StreamIndex streamIndex, MediaStreamType mediaStreamType) {
        int iNativePublishStreamEx;
        LogUtil.m80900d(TAG, "publishStream: " + streamIndex);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, publishStream failed.\"");
    ...
    public int publishStreamAudio(boolean z) {
        ...
        LogUtil.m80900d(TAG, "publishStreamAudio");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid,publishStreamAudio failed.\"");
    ...
    public int publishStreamVideo(boolean z) {
        ...
        LogUtil.m80900d(TAG, "publishStreamVideo");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid,publishStreamVideo failed.\"");
    ...
    public int resumeAllSubscribedStreamAudio() {
        ...
        LogUtil.m80900d(TAG, "resumeAllSubscribedStreamAudio...");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, resumeAllSubscribedStreamAudio failed.");
    ...
    public int resumeAllSubscribedStreamVideo() {
        ...
        LogUtil.m80900d(TAG, "resumeAllSubscribedStreamVideo...");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, resumeAllSubscribedStreamVideo failed.");
    ...
    public int resumeForwardStreamToAllRooms() {
        ...
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, resumeForwardStreamToAllRooms failed.");
    ...
    public int setAudioSelectionConfig(AudioSelectionPriority audioSelectionPriority) {
        ...
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, setAudioSelectionConfig failed.");
    ...
    public int setMultiDeviceAVSync(String str) {
        ...
        LogUtil.m80900d(TAG, "setMultiDeviceAVSync ");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, setMultiDeviceAVSync failed.");
    ...
    public int setRemoteRoomAudioPlaybackVolume(int i) {
        ...
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, setRemoteRoomAudioPlaybackVolume failed.");
    ...
    public int setRemoteSimulcastStreamType(String str, SimulcastStreamType simulcastStreamType) {
        int iValue;
        LogUtil.m80900d(TAG, "setRemoteSimulcastStreamType");
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0 || simulcastStreamType == null) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid,setRemoteSimulcastStreamType  failed.\"");
    ...
    public int setRemoteVideoConfig(String str, StreamIndex streamIndex, RemoteVideoConfig remoteVideoConfig) {
        ...
        LogUtil.m80900d(TAG, "setRemoteVideoConfig: userId: " + str + ", streamIndex: " + streamIndex);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, setRemoteVideoConfig failed.\"");
    ...
    public long setRoomExtraInfo(String str, String str2) {
        ...
        try {
            LogUtil.m80900d(TAG, "setRoomExtraInfo,key : " + str + ", value" + str2);
            long j = this.mNativeRtcRoom;
            if (j != 0) {
                return NativeRTCRoomFunctions.nativeSetRoomExtraInfo(j, str, str2);
            }
            LogUtil.m80901e(TAG, "native rtcroom is invalid, setRoomExtraInfo failed.");
            return -1L;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setUserVisibility(boolean z) {
        ...
        LogUtil.m80900d(TAG, "setUserVisibility. enable : " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native engine is invalid, setUserVisibility failed.");
    ...
    public int startForwardStreamToRooms(List<ForwardStreamInfo> list) {
        ...
        try {
            if (this.mNativeRtcRoom == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, startForwardStreamToRooms failed.");
    ...
    public int startSubtitle(SubtitleConfig subtitleConfig) {
        ...
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "startSubtitle");
            long j = this.mNativeRtcRoom;
            if (j == 0 || subtitleConfig == null) {
                LogUtil.m80901e(TAG, "native rtcroom or config is invalid, startSubtitle failed.");
                iValue = ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
            } else {
    ...
    public int stopForwardStreamToRooms() {
        ...
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, stopForwardStreamToRooms failed.");
    ...
    public int stopSubtitle() {
        ...
        this.mJniReadLock.lock();
        try {
            LogUtil.m80900d(TAG, "stopSubtitle");
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, stopSubtitle failed.");
    ...
    public int subscribeAllStreamsAudio(boolean z) {
        ...
        LogUtil.m80900d(TAG, "subscribeStream, subscribe:" + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native engine is invalid, subscribeAllStreamsAudio failed.");
    ...
    public int subscribeAllStreamsVideo(boolean z) {
        ...
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native engine is invalid, subscribeAllStreamsVideo failed.");
    ...
    public int subscribeScreenAudio(String str, boolean z) {
        ...
        LogUtil.m80900d(TAG, "subscribeScreenAudio: userId: " + str + ", subscribe: " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, subscribeScreenAudio failed.\"");
    ...
    public int subscribeScreenVideo(String str, boolean z) {
        ...
        LogUtil.m80900d(TAG, "subscribeScreenVideo: userId: " + str + ", subscribe: " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, subscribeScreenVideo failed.\"");
    ...
    public int subscribeStream(String str, StreamIndex streamIndex, MediaStreamType mediaStreamType) {
        ...
        LogUtil.m80900d(TAG, "subscribeStream: userId: " + str + ", streamIndex: " + streamIndex);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, subscribeStream failed.\"");
    ...
    public int subscribeStreamAudio(String str, boolean z) {
        ...
        LogUtil.m80900d(TAG, "subscribeStreamAudio: userId: " + str + ", subscribe: " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, subscribeStreamAudio failed.\"");
    ...
    public int subscribeStreamVideo(String str, boolean z) {
        ...
        LogUtil.m80900d(TAG, "subscribeStreamVideo: userId: " + str + ", subscribe: " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, subscribeStreamVideo failed.\"");
    ...
    public int unpublishStream(StreamIndex streamIndex, MediaStreamType mediaStreamType) {
        ...
        LogUtil.m80900d(TAG, "unpublishStream: " + streamIndex);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, unpublishStream failed.\"");
    ...
    public int unsubscribeStream(String str, StreamIndex streamIndex, MediaStreamType mediaStreamType) {
        ...
        LogUtil.m80900d(TAG, "unsubscribeStream: userId: " + str + ", streamIndex: " + streamIndex);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeRtcRoom;
            if (j == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, unsubscribeStream failed.\"");
    ...
    public int updateForwardStreamToRooms(List<ForwardStreamInfo> list) {
        ...
        try {
            if (this.mNativeRtcRoom == 0) {
                LogUtil.m80901e(TAG, "native rtcroom is invalid, updateForwardStreamToRooms failed.");
