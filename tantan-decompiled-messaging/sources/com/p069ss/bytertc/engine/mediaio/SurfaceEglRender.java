...
import com.p069ss.bytertc.base.media.SurfaceEglRenderer;
...
public class SurfaceEglRender extends SurfaceEglRenderer {
    ...
    public static /* synthetic */ void m80890i(SurfaceEglRender surfaceEglRender, SurfaceView surfaceView) {
    ...
    public void bind(final SurfaceView surfaceView) {
        if (!this.mHasInitAtomic.get()) {
            ...
            runOnUIThread(new Runnable() { // from class: l.s1h0
                @Override // java.lang.Runnable
                public final void run() {
                    SurfaceEglRender.m80890i(this.f161897a, surfaceView);
                }
            });
        }
    }

    @Override // com.p069ss.bytertc.base.media.SurfaceEglRenderer, com.p069ss.bytertc.base.media.EglRenderer
    public void init(EglBase.Context context, int[] iArr, RendererCommon.GlDrawer glDrawer) {
        ThreadUtils.checkIsOnMainThread();
        if (!this.mHasInitAtomic.compareAndSet(false, true)) {
            qkq0.m175383a("SurfaceEglRender has already init!!!!!!");
        } else {
    ...
    @Override // com.p069ss.bytertc.base.media.SurfaceEglRenderer, com.p069ss.bytertc.base.media.EglRenderer, com.p069ss.bytertc.base.media.VideoSink
    ...
    @Override // com.p069ss.bytertc.base.media.SurfaceEglRenderer, android.view.SurfaceHolder.Callback
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        super.surfaceChanged(surfaceHolder, i, i2, i3);
        LogUtil.m80900d(TAG, "surfaceChanged");
    }

    @Override // com.p069ss.bytertc.base.media.SurfaceEglRenderer, android.view.SurfaceHolder.Callback
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        super.surfaceCreated(surfaceHolder);
        LogUtil.m80900d(TAG, "surfaceCreated");
        synchronized (this.mSurfaceLifecycleCallbackLock) {
            try {
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        LogUtil.m80900d(TAG, "surfaceDestroyed");
        synchronized (this.mSurfaceLifecycleCallbackLock) {
            try {
                VideoFrameRender.SurfaceLifecycleCallback surfaceLifecycleCallback = this.mSurfaceLifecycleCallback;
                if (surfaceLifecycleCallback != null) {
