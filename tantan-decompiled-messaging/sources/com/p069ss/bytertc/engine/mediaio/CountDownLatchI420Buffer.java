...
public class CountDownLatchI420Buffer implements VideoFrame.I420Buffer {
    ...
    private CountDownLatchI420Buffer(int i, int i2, ByteBuffer byteBuffer, int i3, ByteBuffer byteBuffer2, int i4, ByteBuffer byteBuffer3, int i5, final Runnable runnable) {
        ...
        this.buffer = JavaI420Buffer.wrap(i, i2, byteBuffer, i3, byteBuffer2, i4, byteBuffer3, i5, new Runnable() { // from class: l.bqb
            @Override // java.lang.Runnable
            public final void run() {
                CountDownLatchI420Buffer.m80889a(this.f76765a, runnable);
            }
        });
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m80889a(CountDownLatchI420Buffer countDownLatchI420Buffer, Runnable runnable) {
