...
public class InternalRemoteAudioStats {
    ...
    public InternalRemoteAudioStats(float f, int i, int i2, int i3, long j, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, double d) {
        ...
        this.jitter = i17;
        this.decodeFrameRate = d;
    }

    @CalledByNative
    private static InternalRemoteAudioStats create(float f, int i, int i2, int i3, long j, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, double d) {
        return new InternalRemoteAudioStats(f, i, i2, i3, j, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16, i17, d);
    }
