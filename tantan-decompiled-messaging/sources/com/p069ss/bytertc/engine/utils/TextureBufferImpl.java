...
import com.p069ss.bytertc.engine.video.ITextureBuffer;
import java.io.File;
...
public class TextureBufferImpl implements VideoFrame.TextureBuffer, EglContextCarrier, ITextureBuffer {
    ...
    public VideoFrame.Buffer copyData() {
        ...
        this.textureHelper.drawTexture(i, this.f55640id, iDequeueTexture);
        return new TextureBufferImpl(this.width, this.height, this.type, this.f55640id, this.transformMatrix, this.textureHelper, new Runnable() { // from class: com.ss.bytertc.engine.utils.TextureBufferImpl.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    public VideoFrame.Buffer cropAndScale(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        return new TextureBufferImpl(i5, i6, this.type, this.f55640id, matrix2, this.textureHelper, new Runnable() { // from class: com.ss.bytertc.engine.utils.TextureBufferImpl.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    public VideoFrame.Buffer cropAndScaleWithFilter(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        Matrix matrix2 = new Matrix(this.transformMatrix);
        matrix2.preConcat(matrix);
        return new TextureBufferImpl(i5, i6, this.type, this.f55640id, matrix2, this.textureHelper, new Runnable() { // from class: com.ss.bytertc.engine.utils.TextureBufferImpl.4
            @Override // java.lang.Runnable
            public void run() {
                TextureBufferImpl.this.release();
            }
    ...
    @Override // com.p069ss.bytertc.engine.utils.EglContextCarrier
    ...
    public void saveMyBitmap(String str, byte[] bArr, int i, int i2) {
        ...
        LogUtil.m80903i("texturebuffer", "saveMyBitmap");
    ...
    public VideoFrame.Buffer scaleAndFill(int i, int i2, int i3, int i4) {
        ...
        return new TextureBufferImpl(i, i2, this.type, this.f55640id, matrix, this.textureHelper, new Runnable() { // from class: com.ss.bytertc.engine.utils.TextureBufferImpl.5
            @Override // java.lang.Runnable
            public void run() {
                TextureBufferImpl.this.release();
            }
