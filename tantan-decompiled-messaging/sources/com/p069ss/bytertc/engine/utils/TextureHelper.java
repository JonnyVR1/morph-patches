...
import com.p069ss.bytertc.engine.utils.TextureHelper;
...
public class TextureHelper {
    ...
    private TextureHelper(Object obj, Handler handler, int i, int i2) {
        if (handler.getLooper().getThread() != Thread.currentThread()) {
            qkq0.m175383a("TextureHelper must be created on the handler thread");
            throw null;
        }
        this.mWidth = i;
        this.mHeight = i2;
        ...
        if (obj instanceof EGLContext) {
            ...
            if (!(obj instanceof EglBase.Context)) {
                ibe.m135253a("unknown shareContext:", obj);
                throw null;
            }
    ...
    public static /* synthetic */ TextureHelper m80906a(android.opengl.EGLContext eGLContext, Handler handler, int i, int i2, String str) {
        try {
            return new TextureHelper(eGLContext, handler, i, i2);
        } catch (RuntimeException e) {
            LogUtil.m80902e(TAG, str + " create failure", e);
            return null;
        }
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ TextureHelper m80907b(EglBase.Context context, Handler handler, int i, int i2, String str) {
        try {
    ...
    public static TextureHelper create(final String str, final EGLContext eGLContext, final int i, final int i2) {
        ...
        return (TextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: l.kki0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureHelper.m80910e(eGLContext, handler, i, i2, str);
            }
        });
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ void m80909d(TextureHelper textureHelper) {
    ...
    public static /* synthetic */ TextureHelper m80910e(EGLContext eGLContext, Handler handler, int i, int i2, String str) {
        try {
            return new TextureHelper(eGLContext, handler, i, i2);
        } catch (RuntimeException e) {
            LogUtil.m80902e(TAG, str + " create failure", e);
    ...
    public static /* synthetic */ Integer m80911f(TextureHelper textureHelper, int i, int i2, int i3) {
    ...
    public static /* synthetic */ void m80912g(TextureHelper textureHelper, int i) {
    ...
    private int generateTexture(final int i, final int i2, final int i3) {
        ...
        return ((Integer) ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Callable() { // from class: l.nki0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureHelper.m80911f(this.f139429a, i, i2, i3);
            }
        })).intValue();
    }

    /* JADX INFO: renamed from: h */
    public static /* synthetic */ void m80913h(TextureHelper textureHelper, int[] iArr) {
    ...
    public int dequeueTexture() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: l.rki0
            @Override // java.lang.Runnable
            public final void run() {
                TextureHelper.m80913h(this.f159844a, iArr);
            }
        });
        return iArr[0];
    }
    ...
    public synchronized void dispose() {
        LogUtil.m80900d(TAG, "dispose()");
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: l.lki0
            @Override // java.lang.Runnable
            public final void run() {
                TextureHelper.m80909d(this.f128537a);
            }
        });
    }
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: com.ss.bytertc.engine.utils.TextureHelper.1
            ...
            public void run() {
                ...
                if (i4 == 10) {
                    ...
                    LogUtil.m80901e(TextureHelper.TAG, "draw texture type error");
                } else {
    ...
    public void queueTexture(final int i) {
        this.mHandler.post(new Runnable() { // from class: l.qki0
            @Override // java.lang.Runnable
            public final void run() {
                TextureHelper.m80912g(this.f155130a, i);
            }
        });
    }
    ...
    public void releaseTextureID(final int i) {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: l.mki0
            @Override // java.lang.Runnable
            public final void run() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: com.ss.bytertc.engine.utils.TextureHelper.2
            ...
            public void run() {
                if (TextureHelper.this.mTextureDrawer == null || TextureHelper.this.mYuvUploader == null) {
                    qkq0.m175383a("mTextureDrawer and mYuvUploader can not null.");
                    return;
                }
                GlUtil.checkNoGLES2Error("TextureHelper construct");
                GLES20.glBindFramebuffer(36160, TextureHelper.this.mFrameBufferId);
    ...
    public static TextureHelper create(final String str, final android.opengl.EGLContext eGLContext, final int i, final int i2) {
        ...
        handlerThread.start();
        final Handler handler = new Handler(handlerThread.getLooper());
        return (TextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: l.pki0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureHelper.m80906a(eGLContext, handler, i, i2, str);
            }
        });
    }
    ...
    public static TextureHelper create(final String str, final EglBase.Context context, final int i, final int i2) {
        ...
        handlerThread.start();
        final Handler handler = new Handler(handlerThread.getLooper());
        return (TextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: l.oki0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureHelper.m80907b(context, handler, i, i2, str);
            }
        });
    }
}
