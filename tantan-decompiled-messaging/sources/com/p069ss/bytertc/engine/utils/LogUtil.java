...
public class LogUtil {
    ...
    public static void m80900d(String str, String str2) {
    ...
    public static void m80901e(String str, String str2) {
    ...
    public static void m80903i(String str, String str2) {
    ...
    public static void setLoggerSink(ILoggerSink iLoggerSink) {
        if (iLoggerSink != null) {
            ...
            f31.m119248a(sLoggerSink, getLoggerSink(), null);
        }
    }

    /* JADX INFO: renamed from: w */
    public static void m80904w(String str, String str2) {
    ...
    /* JADX INFO: renamed from: e */
    public static void m80902e(String str, String str2, Throwable th) {
        LogLevel logLevel = LogLevel.LOG_LEVEL_ERROR;
        if (logLevel.compareTo(sLogLevel) >= 0) {
    ...
    /* JADX INFO: renamed from: w */
    public static void m80905w(String str, String str2, Throwable th) {
        LogLevel logLevel = LogLevel.LOG_LEVEL_WARNING;
        if (logLevel.compareTo(sLogLevel) >= 0) {
            notifyLoggerSinks(logLevel, String.format("[%s:%s]:%s", LOG_TAG, str, String.format("[msg:%s]", str2)), th);
        }
