...
import com.p069ss.bytertc.engine.utils.GLHepler;
...
public class GLHepler {
    ...
    public static /* synthetic */ void m80899a(GLHepler gLHepler, int i, int i2, int i3, int i4) {
        gLHepler.getClass();
        long jCurrentTimeMillis = System.currentTimeMillis();
        gLHepler.threadChecker.checkIsOnValidThread();
        if (gLHepler.released) {
            qkq0.m175383a("YuvConverter.convert called on released object");
            return;
        }
        if (!gLHepler.mBInit) {
        ...
        LogUtil.m80903i("opnngl ToTexture2D", "usetime:" + (System.currentTimeMillis() - jCurrentTimeMillis));
    }
        ...
        return (GLHepler) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<GLHepler>() { // from class: com.ss.bytertc.engine.utils.GLHepler.1
            ...
            public GLHepler call() {
                try {
                    ...
                    LogUtil.m80902e("TextureHelper", str + " create failure", e);
                    return null;
                }
            }
        });
    ...
    public void deliverToTexture2D(final int i, final int i2, final int i3, final int i4, float[] fArr) {
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: l.tbj
            @Override // java.lang.Runnable
            public final void run() {
                GLHepler.m80899a(this.f169260a, i4, i3, i, i2);
            }
        });
    }
