...
import com.p069ss.bytertc.engine.InternalExpressDetectConfig;
import com.p069ss.bytertc.engine.NativeRTCVideoFunctions;
import com.p069ss.bytertc.engine.data.VirtualBackgroundSource;
...
public class RTCVideoEffect extends IVideoEffect {
    ...
    public RTCVideoEffect(long j) {
        ...
        LogUtil.m80903i(TAG, "create rtc video effect");
    }
    ...
    @Override // com.p069ss.bytertc.engine.video.IVideoEffect
    ...
    public int applyStickerEffect(String str) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, applyStickerEffect failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public void destroy() {
        LogUtil.m80903i(TAG, "dispose rtc video effect");
    ...
    public int disableFaceDetection() {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "invalid, registerFaceDetectionObserver failed.");
                return ErrorCode.ERROR_CODE_KICKED_OUT;
            }
    ...
    public int disableVideoEffect() {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, disableVideoEffect failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int disableVirtualBackground() {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, disableVirtualBackground failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int enableVideoEffect() {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, enableVideoEffect failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int enableVirtualBackground(String str, VirtualBackgroundSource virtualBackgroundSource) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, enableVirtualBackground failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public long getVideoEffectHandle() {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "native engine is invalid, getVideoEffectHandle failed.");
            return -1006L;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int initCVResource(String str, String str2) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, initCVResource failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setColorFilter(String str) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, setColorFilter failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setColorFilterIntensity(float f) {
        ...
        try {
            ...
            LogUtil.m80901e(TAG, "invalid, setColorFilterIntensity failed.");
            return ErrorCode.ERROR_CODE_KICKED_OUT;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int setEffectNodes(List<String> list) {
        ...
        try {
            ...
            if (list == null) {
                LogUtil.m80904w(TAG, "effect_nodes is null, setting empty effect nodes.");
                list = new ArrayList<>();
            }
            String[] strArr = new String[list.size()];
            list.toArray(strArr);
    ...
    public int setVideoEffectExpressionDetect(VideoEffectExpressionConfig videoEffectExpressionConfig) {
        ...
        try {
            if (engineInvalid()) {
                LogUtil.m80901e(TAG, "invalid, setVideoEffectExpressionDetect failed.");
                return ErrorCode.ERROR_CODE_KICKED_OUT;
            }
