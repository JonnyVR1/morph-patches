...
public class TEFrameRateRange implements Parcelable {
    public static final Parcelable.Creator<TEFrameRateRange> CREATOR = new C13320a();
    public int fpsUnitFactor;
    public int max;
    public int min;

    /* JADX INFO: renamed from: com.ss.android.ttvecamera.TEFrameRateRange$a */
    public static class C13320a implements Parcelable.Creator<TEFrameRateRange> {
    ...
    public static int m80535a(List<int[]> list) {
    ...
    public String toString() {
        return "[" + (this.min / this.fpsUnitFactor) + ", " + (this.max / this.fpsUnitFactor) + Constants.AES_SUFFIX;
    }
