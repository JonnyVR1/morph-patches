...
public class NetworkTypeUtils {
        ...
        try {
            ...
            if (declaredMethod == null || declaredMethod2 == null) {
                ...
                try {
                    ...
                    RXLogging.m5690i(TAG, "BPEA not exist");
                }
            }
    ...
    public static String getNetworkAccessType(NetworkType networkType) {
        try {
            switch (C11171.$SwitchMap$com$bytedance$realx$base$NetworkTypeUtils$NetworkType[networkType.ordinal()]) {
                case 1:
                    return "wifi";
                case 2:
    ...
    public static NetworkType getNetworkType(Context context, Intent intent) {
        ...
        try {
            ...
            if ((activeNetworkInfo == null || !activeNetworkInfo.isAvailable()) && activeNetworkInfo == null && intent != null && ((activeNetworkInfo = isNetWorkConnected(context, intent)) == null || !activeNetworkInfo.isAvailable())) {
                RXLogging.m5690i(TAG, "-----------info is null");
            ...
            if (e16.m114373a(context, "android.permission.READ_PHONE_STATE") == 0) {
    ...
    public static NetworkInfo isNetWorkConnected(Context context, Intent intent) {
        ...
        if ("android.net.conn.CONNECTIVITY_CHANGE".equals(intent.getAction()) && (networkInfo = (NetworkInfo) intent.getParcelableExtra("networkInfo")) != null) {
            if (NetworkInfo.State.CONNECTED == networkInfo.getState() && networkInfo.isAvailable()) {
                ...
                RXLogging.m5690i(TAG, "-------networkInfo wifi or mobile is connected");
                return networkInfo;
            }
            RXLogging.m5690i(TAG, "------networkInfo is discconnected");
        }
        return null;
    }
    ...
    public static void registerReceiver(Context context, BroadcastReceiver broadcastReceiver) {
        ...
        ii5.m136342l(context.getApplicationContext(), broadcastReceiver, intentFilter);
    }
