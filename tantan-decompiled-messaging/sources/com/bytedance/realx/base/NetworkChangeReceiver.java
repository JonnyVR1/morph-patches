...
public class NetworkChangeReceiver extends BroadcastReceiver {
    ...
    public class NetworkTypeThread extends Thread {
        ...
        public void stopThread() {
            synchronized (NetworkChangeReceiver.threadLock) {
                RXLogging.m5690i(NetworkChangeReceiver.TAG, "stopThread");
    ...
    public NetworkChangeReceiver(long j) {
        RXLogging.m5690i(TAG, "init, nativeNetworkReceiver: " + j);
    ...
    public void getNetworkTypeInternal() {
        ...
        RXLogging.m5690i(TAG, "GetNetworkType, networkType： " + networkType);
    ...
    private int getType(NetworkTypeUtils.NetworkType networkType) {
        switch (C11161.$SwitchMap$com$bytedance$realx$base$NetworkTypeUtils$NetworkType[networkType.ordinal()]) {
            case 1:
                return 1;
            case 2:
                return 2;
    ...
    public void onReceive(Context context, Intent intent) {
        RXLogging.m5690i(TAG, "onReceive, action: " + intent.getAction());
