...
public class RXPowerMonitorAndroid {
    ...
    static {
        ...
        batteryStatus = ii5.m136342l(context, mBroadcastReceiver, intentFilter);
    ...
    public static int getBatterySaveStatus() {
        try {
            ...
            if (str.equalsIgnoreCase(ThirdPushManager.VENDOR_TYPE_XIAOMI) && powerManager != null && mBatterySaveMode == -1) {
                ...
                ii5.m136342l(context, batterySaverReceiver, new IntentFilter("miui.intent.action.POWER_SAVE_MODE_CHANGED"));
                ...
                ii5.m136342l(context, batterySaverReceiver, new IntentFilter("android.os.action.POWER_SAVE_MODE_CHANGED"));
