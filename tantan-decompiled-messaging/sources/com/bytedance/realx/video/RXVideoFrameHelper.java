...
public class RXVideoFrameHelper implements RXVideoFrameHelperInterface {
    ...
    RefObject refCounted = new RefObject(new Runnable() { // from class: l.qbc0
        @Override // java.lang.Runnable
        public final void run() {
            RXVideoFrameHelper.m5708a(this.f153640a);
        }
    });
    ...
    public static /* synthetic */ void m5708a(RXVideoFrameHelper rXVideoFrameHelper) {
