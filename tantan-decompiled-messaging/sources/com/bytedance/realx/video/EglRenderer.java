...
public class EglRenderer implements VideoSink {
    ...
    public static /* synthetic */ class C11333 {
    ...
    public static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) throws Exception {
            try {
                ...
                RXLogging.m5689e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
    ...
    public static /* synthetic */ void m5697b(EglRenderer eglRenderer, Runnable runnable) {
    ...
    public static /* synthetic */ void m5699d(EglRenderer eglRenderer, EglBase.Context context, int[] iArr) {
        if (context == null) {
    ...
    public static /* synthetic */ void m5700e(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f, boolean z) {
        if (glDrawer == null) {
    ...
    public static /* synthetic */ void m5701f(EglRenderer eglRenderer, CountDownLatch countDownLatch) {
    ...
    public static /* synthetic */ void m5702g(EglRenderer eglRenderer, CountDownLatch countDownLatch, FrameListener frameListener) {
    ...
    public static /* synthetic */ void m5703h(EglRenderer eglRenderer, Looper looper) {
    ...
    private void logW(String str) {
        RXLogging.m5692w(TAG, this.name + str);
    }
    ...
    public void renderFrameOnRenderThread() {
        ...
        synchronized (this.frameLock) {
            try {
                ...
                int i3 = C11333.$SwitchMap$com$bytedance$realx$video$RendererCommon$ScalingType[this.renderModel.ordinal()];
                if (i3 != 1) {
                    if (i3 == 2) {
                        iSurfaceWidth = 0;
                        iSurfaceHeight = 0;
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, @Nullable final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: l.lre
            @Override // java.lang.Runnable
            public final void run() {
                EglRenderer.m5700e(this.f129688a, glDrawer, frameListener, f, z);
            }
        });
    }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            try {
                ...
                handler.postAtFrontOfQueue(new Runnable() { // from class: l.fre
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f98921a.clearSurfaceOnRenderThread(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public void init(@Nullable final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            try {
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: l.ire
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5699d(this.f114622a, context, iArr);
                    }
                });
            ...
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        this.renderThreadHandler.post(new Runnable() { // from class: l.xre
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f194113a.renderFrameOnRenderThread();
                            }
                        });
                    } catch (Throwable th) {
                        throw th;
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.rre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5701f(this.f160740a, countDownLatch);
                    }
                });
                final Looper looper = this.renderThreadHandler.getLooper();
                this.renderThreadHandler.post(new Runnable() { // from class: l.ure
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5703h(this.f177827a, looper);
                    }
                });
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                if (handler == null) {
                    ...
                    this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.ore
                        @Override // java.lang.Runnable
                        public final void run() {
                            EglRenderer.m5697b(this.f145265a, runnable);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: l.ase
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5702g(this.f71412a, countDownLatch, frameListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
