...
class EglBase10 implements EglBase {
    ...
    private EGLContext createEglContext(@Nullable Context context, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
        ...
        o5d0.m162778a("Failed to create EGL context: 0x", Integer.toHexString(this.egl.eglGetError()));
        return null;
    }

    private void createSurfaceInternal(Object obj) {
        if (!(obj instanceof SurfaceHolder) && !(obj instanceof SurfaceTexture)) {
            qkq0.m175383a("Input must be either a SurfaceHolder or SurfaceTexture");
            return;
        }
        checkIsNotReleased();
        ...
        o5d0.m162778a("Failed to create window surface: 0x", Integer.toHexString(this.egl.eglGetError()));
    }
    ...
    private void eglDetachCurrent() {
        ...
        o5d0.m162778a("eglDetachCurrent failed: 0x", Integer.toHexString(this.egl.eglGetError()));
    }
    ...
    private void eglMakeCurrent() {
        ...
        o5d0.m162778a("eglMakeCurrent failed: 0x", Integer.toHexString(this.egl.eglGetError()));
    }
    ...
    private EGLConfig getEglConfig(EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!this.egl.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            o5d0.m162778a("eglChooseConfig failed: 0x", Integer.toHexString(this.egl.eglGetError()));
            return null;
        }
        if (iArr2[0] <= 0) {
    ...
    private EGLDisplay getEglDisplay() {
        ...
        if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            o5d0.m162778a("Unable to get EGL10 display: 0x", Integer.toHexString(egl10.eglGetError()));
            return null;
        }
        if (egl10.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
            return eGLDisplayEglGetDisplay;
        }
        o5d0.m162778a("Unable to initialize EGL10: 0x", Integer.toHexString(this.egl.eglGetError()));
        return null;
    }
    ...
    public void createPbufferSurface(int i, int i2) {
        ...
        bre.m103538a("Failed to create pixel buffer surface with size ", i, BaseSei.f13930X, i2, ": 0x", Integer.toHexString(this.egl.eglGetError()));
    }
