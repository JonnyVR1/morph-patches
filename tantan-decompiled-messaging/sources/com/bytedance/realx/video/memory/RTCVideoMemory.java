...
public abstract class RTCVideoMemory implements RefCounted {
    ...
    RefObject refCounted = new RefObject(new Runnable() { // from class: l.dbc0
        @Override // java.lang.Runnable
        public final void run() {
            RTCVideoMemory.m5726a(this.f85308a);
        }
    });

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m5726a(RTCVideoMemory rTCVideoMemory) {
