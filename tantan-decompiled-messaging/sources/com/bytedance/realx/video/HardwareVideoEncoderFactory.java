...
public class HardwareVideoEncoderFactory {
    ...
    private static int getKeyFrameIntervalSec(RXVideoCodecStandard rXVideoCodecStandard) {
        int i = C11401.$SwitchMap$com$bytedance$realx$video$RXVideoCodecStandard[rXVideoCodecStandard.ordinal()];
        if (i == 1 || i == 2) {
            return 720;
        }
        if (i == 3 || i == 4) {
        ...
        qhg0.m174539a("Unsupported VideoCodecType ", rXVideoCodecStandard);
        return 0;
    }
    ...
    public static boolean isBitrateModeSupported(MediaCodecInfo mediaCodecInfo, RXVideoCodecStandard rXVideoCodecStandard, int i) {
        ...
        if (capabilitiesForType == null) {
            RXLogging.m5688e(TAG, "get capability return null.");
            return false;
        }
        ...
        RXLogging.m5688e(TAG, "get EncoderCapabilities return null.");
        return false;
    }
    ...
    private static boolean isSoftwareOnly(MediaCodecInfo mediaCodecInfo) {
        try {
            ...
            RXLogging.m5689e(TAG, "check encoder softonly error.", e);
            return false;
        }
    }
