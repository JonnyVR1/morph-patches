...
public class MediaCodecAACDecoder {
    ...
    public MediaCodecAACDecoder() {
        RXLogging.m5688e(TAG, "MediaCodecAAC Decoder Created");
    }
    ...
    public void closeDecoder() {
        try {
            ...
            e.printStackTrace();
            RXLogging.m5688e(TAG, "close AAC decoder failed");
        }
    }
    ...
    public boolean configAndStartDecoder() {
        try {
            ...
            e.printStackTrace();
            closeDecoder();
            RXLogging.m5688e(TAG, "Config and Start Decoder Error");
            return false;
        }
    }
    ...
    public boolean decodeProcess(byte[] bArr) {
        try {
            ...
            e.printStackTrace();
            RXLogging.m5688e(TAG, "AAC Decoder Decode failed");
            return false;
        }
    }
    ...
    public boolean openEncoder() {
        try {
            ...
            e.printStackTrace();
            this.mAACDecoder = null;
            RXLogging.m5688e(TAG, "Open AAC Decoder failed");
            return false;
        }
    }
