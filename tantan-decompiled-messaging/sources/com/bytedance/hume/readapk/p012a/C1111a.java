package com.bytedance.hume.readapk.p012a;
...
public class C1111a {
    ...
    static final byte[] f4720a = {108, 116, 108, 111, 118, 101, 122, 104};
    ...
    /* JADX INFO: renamed from: a */
    public static String m5677a(File file) throws Throwable {
            ...
            try {
                ...
                try {
                    ...
                    if (m5679a(bArr2)) {
                        ...
                        int iM5678a = m5678a(randomAccessFile);
                        if (iM5678a > 0) {
                            randomAccessFile.seek(j - ((long) iM5678a));
                            byte[] bArr3 = new byte[iM5678a];
    ...
    /* JADX INFO: renamed from: a */
    private static short m5678a(DataInput dataInput) throws IOException {
    ...
    /* JADX INFO: renamed from: a */
    private static boolean m5679a(byte[] bArr) {
        if (bArr.length != f4720a.length) {
            return false;
        }
        int i = 0;
        while (true) {
