...
public class GpuBenmarkUtils {
    ...
    public class RunnableC13921 implements Runnable {
        ...
        public void run() {
            GpuBenmarkUtils.this.f5735i = 0;
            while (GpuBenmarkUtils.this.f5735i < 3) {
                    ...
                    public void run() {
                        ...
                        GpuBenmarkUtils.this.gpuBenmark.setGpuBenmarkListener(new GpuBenmarkListener() { // from class: com.core.glcore.util.GpuBenmarkUtils.1.1.1
                            ...
                            public void getGpuBenmark(double d) {
                                ...
                                if (GpuBenmarkUtils.this.f5735i == 2) {
    ...
    public static /* synthetic */ int access$008(GpuBenmarkUtils gpuBenmarkUtils) {
        int i = gpuBenmarkUtils.f5735i;
        gpuBenmarkUtils.f5735i = i + 1;
        return i;
    }
    ...
    private void updata() {
        new Thread(new RunnableC13921(), "live-media-GpuBenmarkUtils").start();
    }
