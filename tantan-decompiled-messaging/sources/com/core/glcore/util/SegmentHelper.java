...
public class SegmentHelper {
    ...
    private static void bodyRelease() {
        ...
        segmentCount = 0;
        MDLog.m7395i(TAG, "SegmentHelper release !!!");
    }
    ...
    public static SegmentationInfo process(vjw vjwVar, mkw mkwVar, boolean z, pjw pjwVar) {
        int i = mCutType;
        if (i == 0) {
            return processBody(vjwVar, mkwVar, z, pjwVar);
        }
        if (i == 1) {
            return processFace(vjwVar, mkwVar, z, pjwVar);
        }
        return null;
    }
    ...
    public static SegmentationInfo processBody(vjw vjwVar, mkw mkwVar, boolean z, pjw pjwVar) {
        byte[] bArr;
        String str;
        StringBuilder sb;
        if (modelPath == null) {
            byte[] bArr2 = info.mask_;
            if (bArr2 == null || bArr2.length != vjwVar.m198692e() * vjwVar.m198690c()) {
                info.mask_ = new byte[vjwVar.m198692e() * vjwVar.m198690c()];
            ...
            try {
                ...
                try {
                    ...
                    if (!(z ? segmentation.LoadModelSync(modelBuff) : segmentation.LoadModel(modelBuff))) {
                        MDLog.m7391e(TAG, "The Segment mode lode failed !!!");
                    }
                    try {
                    ...
                    try {
                        ...
                        if (modelBuff != null) {
                            ...
                            segmentation.ProcessFrame(vjwVar.m198689b(), (SegmentationParams) mkwVar.m155081c(), info);
                        }
                        ...
                        if (fileInputStream != null) {
                            try {
                                ...
                                MDLog.m7391e(TAG, "The Segment mode lode failed !!!" + e3.toString());
                            }
                        }
                        throw th2;
                    }
        ...
        if (modelBuff != null) {
            ...
            bArr = info.mask_;
            if (bArr != null || bArr.length != vjwVar.m198692e() * vjwVar.m198690c()) {
                info.mask_ = new byte[vjwVar.m198692e() * vjwVar.m198690c()];
                Arrays.fill(info.mask_, (byte) -1);
            }
            counter.set(segmentCount);
    ...
    public static SegmentationInfo processFace(vjw vjwVar, mkw mkwVar, boolean z, pjw pjwVar) {
        return null;
    }

    public static SegmentationInfo processInfo(vjw vjwVar, mkw mkwVar) {
        return process(vjwVar, mkwVar, false, null);
    }
    ...
    public static void setCutFaceModelPath(String str) {
        MDLog.m7395i(TAG, "cutFaceModelPath:" + str);
        cutFaceModelPath = str;
    }

    public static void setCutType(int i) {
        if (i != 0 && 1 != i) {
            MDLog.m7391e(TAG, "invalid type : " + i);
            return;
        }
        MDLog.m7395i(TAG, "type:" + i);
        mCutType = i;
    }

    public static void setDistanceForDiscardFrame(int i) {
        discardFrameDistance = i;
        MDLog.m7395i(TAG, "discardFrameDistance: " + discardFrameDistance);
    }
    ...
    public static void setModelPath(String str) {
        MDLog.m7395i(TAG, "modelPath:" + str);
        modelPath = str;
    }
    ...
    public static void setSegmentCount(int i) {
        ...
        if (i2 == 0) {
            segmentCount = i;
            MDLog.m7395i(TAG, "segmentCount:" + segmentCount);
            return;
        }
        if (i2 == 1) {
            faceSegmentCount = i;
            MDLog.m7395i(TAG, "faceSegmentCount:" + faceSegmentCount);
        }
    }
    ...
    public static SegmentationInfo processInfo(vjw vjwVar, mkw mkwVar, boolean z) {
        return process(vjwVar, mkwVar, z, null);
    }

    public static byte[] process(vjw vjwVar, mkw mkwVar, pjw pjwVar) {
        return process(vjwVar, mkwVar, false, pjwVar).mask_;
    }

    public static byte[] process(vjw vjwVar, mkw mkwVar, boolean z) {
        return process(vjwVar, mkwVar, z, null).mask_;
    }

    public static byte[] process(vjw vjwVar, mkw mkwVar) {
        return process(vjwVar, mkwVar, false, null).mask_;
    }
}
