...
public abstract class CommonJSModule extends Module {
    ...
    public CommonJSModule(QuickJS quickJS) {
        ...
        registerJavaMethod(new JavaCallback() { // from class: l.uj5
            @Override // com.quickjs.JavaCallback
            public final Object invoke(JSObject jSObject, JSArray jSArray) {
                return CommonJSModule.m80339i(this.f176736a, jSObject, jSArray);
            }
        }, "require");
    }
    ...
    public static /* synthetic */ Object m80339i(CommonJSModule commonJSModule, JSObject jSObject, JSArray jSArray) {
        String string;
    ...
    public JSObject executeModule(String str) {
        ...
        upk0.m194883a("'moduleName' script is null");
        return null;
    }
