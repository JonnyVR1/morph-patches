...
public class QuickJS implements Closeable {
    ...
    public static /* synthetic */ void m80372b(QuickJS quickJS) {
        if (quickJS.released) {
            return;
        }
    ...
    public static QuickJS createRuntimeWithEventQueue() {
        ...
        handlerThread.start();
        new Handler(handlerThread.getLooper()).post(new Runnable() { // from class: l.myb0
            @Override // java.lang.Runnable
            public final void run() {
                QuickJS.m80373d(objArr, handlerThread);
            }
        });
        synchronized (objArr) {
            try {
    ...
    public static /* synthetic */ void m80373d(Object[] objArr, HandlerThread handlerThread) {
    ...
    public void close() {
        postEventQueue(new Runnable() { // from class: l.lyb0
            @Override // java.lang.Runnable
            public final void run() {
                QuickJS.m80372b(this.f130558a);
            }
        });
    }
