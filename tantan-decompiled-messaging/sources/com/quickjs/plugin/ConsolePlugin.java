...
public class ConsolePlugin extends Plugin {
    ...
    public static /* synthetic */ void m80374a(ConsolePlugin consolePlugin, JSObject jSObject, JSArray jSArray) {
    ...
    public void setup(JSContext jSContext) {
        jSContext.addJavascriptInterface(this, "console").registerJavaMethod(new JavaVoidCallback() { // from class: l.tw5
            @Override // com.quickjs.JavaVoidCallback
            public final void invoke(JSObject jSObject, JSArray jSArray) {
                ConsolePlugin.m80374a(this.f172360a, jSObject, jSArray);
            }
        }, "assert");
    }
