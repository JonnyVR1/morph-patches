...
public class SetTimeoutPlugin extends Plugin {
    ...
    public static /* synthetic */ void m80375a(JSFunction jSFunction, JSContext jSContext) {
    ...
    public static /* synthetic */ void m80376b(long j, final JSFunction jSFunction, final JSContext jSContext) {
        try {
            Thread.sleep(j);
        ...
        jSFunction.getQuickJS().postEventQueue(new Runnable() { // from class: l.sme0
            ...
            public final void run() {
                SetTimeoutPlugin.m80375a(jSFunction, jSContext);
            }
        });
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m80377c(final JSContext jSContext, JSObject jSObject, JSArray jSArray) {
        ...
        new Thread(new Runnable() { // from class: l.rme0
            @Override // java.lang.Runnable
            public final void run() {
                SetTimeoutPlugin.m80376b(j, jSFunction, jSContext);
            }
        }).start();
    }
    ...
    public void setup(final JSContext jSContext) {
        jSContext.registerJavaMethod(new JavaVoidCallback() { // from class: l.tme0
            ...
            public final void invoke(JSObject jSObject, JSArray jSArray) {
                SetTimeoutPlugin.m80377c(jSContext, jSObject, jSArray);
            }
        }, "setTimeout");
    }
}
