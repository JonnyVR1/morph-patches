...
public class AndroidProcess implements Parcelable {
    public static final Parcelable.Creator<AndroidProcess> CREATOR = new C3993a();
    public final String name;
    public final int pid;

    /* JADX INFO: renamed from: com.jaredrummler.android.processes.models.AndroidProcess$a */
    public static class C3993a implements Parcelable.Creator<AndroidProcess> {
    ...
    public static String m19590b(int i) throws IOException {
        String strTrim;
        try {
    ...
    public Cgroup m19591a() throws IOException {
        return Cgroup.get(this.pid);
    }

    /* JADX INFO: renamed from: c */
    public Stat m19592c() throws IOException {
        return Stat.get(this.pid);
    }

    /* JADX INFO: renamed from: d */
    public Status m19593d() throws IOException {
