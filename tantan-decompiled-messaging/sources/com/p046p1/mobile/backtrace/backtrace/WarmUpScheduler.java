...
public class WarmUpScheduler implements Handler.Callback {
    ...
    public static /* synthetic */ class C43822 {

        /* JADX INFO: renamed from: $SwitchMap$com$p1$mobile$backtrace$backtrace$WarmUpScheduler$TaskType */
        static final /* synthetic */ int[] f15920xbb790616;

        /* JADX INFO: renamed from: $SwitchMap$com$p1$mobile$backtrace$backtrace$WeChatBacktrace$WarmUpTiming */
        static final /* synthetic */ int[] f15921x466a044;

        static {
            int[] iArr = new int[TaskType.values().length];
            f15920xbb790616 = iArr;
            try {
                iArr[TaskType.WarmUp.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15920xbb790616[TaskType.CleanUp.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15920xbb790616[TaskType.RequestConsuming.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15920xbb790616[TaskType.DiskUsage.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            int[] iArr2 = new int[WeChatBacktrace.WarmUpTiming.values().length];
            f15921x466a044 = iArr2;
            try {
                iArr2[WeChatBacktrace.WarmUpTiming.PostStartup.ordinal()] = 1;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15921x466a044[WeChatBacktrace.WarmUpTiming.WhileCharging.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15921x466a044[WeChatBacktrace.WarmUpTiming.WhileScreenOff.ordinal()] = 3;
    ...
    public static final class IdleReceiver extends BroadcastReceiver {
        ...
        private synchronized void triggerIdle(boolean z, boolean z2) {
            try {
                MatrixLog.m21186i(WarmUpScheduler.TAG, "Idle status changed: interactive = %s, charging = %s", Boolean.valueOf(z), Boolean.valueOf(z2));
                ...
                if (z3 && this.mCancellationSignal == null) {
                    ...
                    while (it.hasNext()) {
                        int i = C43822.f15920xbb790616[it.next().ordinal()];
                        if (i != 1) {
                            if (i == 2) {
                                ...
                                MatrixLog.m21186i(WarmUpScheduler.TAG, "System idle, trigger clean up in %s seconds.", 3L);
                            } else if (i == 3) {
                                ...
                                MatrixLog.m21186i(WarmUpScheduler.TAG, "System idle, trigger consume requested qut in %s seconds.", Long.valueOf(this.mWarmUpDelay / 1000));
                            } else if (i == 4) {
                                ...
                                MatrixLog.m21186i(WarmUpScheduler.TAG, "System idle, trigger disk usage in %s seconds.", 3L);
                            }
                            ...
                            MatrixLog.m21186i(WarmUpScheduler.TAG, "System idle, trigger warm up in %s seconds.", Long.valueOf(this.mWarmUpDelay / 1000));
                        }
                    }
                    ...
                    MatrixLog.m21186i(WarmUpScheduler.TAG, "Exit idle state, task cancelled.", new Object[0]);
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        public synchronized void refreshIdleStatus(Context context) {
            ...
            try {
                ...
                boolean z = false;
                if (intentM136342l != null && ((intExtra = intentM136342l.getIntExtra(NotificationCompat.CATEGORY_STATUS, -1)) == 2 || intExtra == 5)) {
                    z = true;
                }
    ...
    private void arrangeTaskDirectly(TaskType taskType) {
        int i = C43822.f15920xbb790616[taskType.ordinal()];
        if (i == 1) {
            MatrixLog.m21186i(TAG, "Schedule warm-up in %ss", Long.valueOf(this.mWarmUpDelay / 1000));
            Handler handler = this.mHandler;
            handler.sendMessageDelayed(Message.obtain(handler, 1, new CancellationSignal()), this.mWarmUpDelay);
        } else if (i == 2) {
            MatrixLog.m21186i(TAG, "Schedule clean-up in %ss", Long.valueOf(this.mWarmUpDelay / 1000));
            ...
            MatrixLog.m21186i(TAG, "Schedule request consuming in %ss", Long.valueOf(this.mWarmUpDelay / 1000));
    ...
    private synchronized void arrangeTaskToIdleReceiver(Context context, TaskType taskType) {
        ...
        MatrixLog.m21186i(TAG, "Register idle receiver.", new Object[0]);
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("android.intent.action.SCREEN_ON");
        intentFilter.addAction("android.intent.action.SCREEN_OFF");
        intentFilter.addAction("android.intent.action.ACTION_POWER_CONNECTED");
        intentFilter.addAction("android.intent.action.ACTION_POWER_DISCONNECTED");
        ii5.m136342l(context, this.mIdleReceiver, intentFilter);
    ...
    private synchronized void finishTaskToIdleReceiver(Context context, TaskType taskType) {
        ...
        if (idleReceiver != null && idleReceiver.finish(taskType) == 0) {
            MatrixLog.m21186i(TAG, "Unregister idle receiver.", new Object[0]);
    ...
    public void scheduleTaskImpl(TaskType taskType) {
        int i = C43822.f15921x466a044[this.mTiming.ordinal()];
        if (i == 1) {
