...
public class AudioPlayer extends BroadcastReceiver implements SensorEventListener, Runnable {
    ...
    public AudioPlayer(Context context) {
        ...
        C22392a<State> c22392aM221512b = C22392a.m221512b();
        this.state = c22392aM221512b;
        c22392aM221512b.onNext(State.stopped);
        this.farValue = 5.0f;
        this.speakerOn = 0;
        ...
        if (defaultSensor != null) {
            ...
            if (txd.m190950c() && this.farValue > 5.0f) {
                this.farValue = 5.0f;
            }
        }
    ...
    private boolean isStarted() {
        State stateM221515e = this.state.m221515e();
        return stateM221515e == State.preparing || stateM221515e == State.playing;
    }
    ...
    public /* synthetic */ boolean lambda$playAndSeekTo$2(String str, MediaPlayer mediaPlayer, int i, int i2) {
        CrashHelper.m81296c(new NullPointerException("audio except what = " + i + " extra = " + i2 + " uri = " + str));
        if (NullChecker.m81303a(this.errCallBack)) {
    ...
    private void onFinished() {
        C22392a<State> c22392a = this.state;
        State state = State.finished;
        c22392a.onNext(state);
        C4323a.m20731a().m20734d(state, this.currentUri);
    }
    ...
    private void playAndSeekTo(final String str, final int i) {
        ...
        try {
            ...
            this.mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: l.mb1
                @Override // android.media.MediaPlayer.OnPreparedListener
                public final void onPrepared(MediaPlayer mediaPlayer2) {
                    this.f132979a.lambda$playAndSeekTo$0(i, mediaPlayer2);
                }
            });
            this.mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { // from class: l.nb1
                @Override // android.media.MediaPlayer.OnCompletionListener
                public final void onCompletion(MediaPlayer mediaPlayer2) {
                    this.f137996a.lambda$playAndSeekTo$1(mediaPlayer2);
                }
            });
            this.mediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() { // from class: l.ob1
                @Override // android.media.MediaPlayer.OnErrorListener
                public final boolean onError(MediaPlayer mediaPlayer2, int i2, int i3) {
                    return this.f142876a.lambda$playAndSeekTo$2(str, mediaPlayer2, i2, i3);
                }
            });
            if (txd.m190949b()) {
                e51.m114745J(this);
                e51.m114743H(this.context, this, 300L);
            } else {
