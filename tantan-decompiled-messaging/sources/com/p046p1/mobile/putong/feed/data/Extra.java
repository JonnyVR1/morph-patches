...
public class Extra extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Extra> PROTOBUF_ADAPTER = new MessageNanoAdapter<Extra>() { // from class: com.p1.mobile.putong.feed.data.Extra.1
        ...
        public int computeAndCacheSize(Extra extra) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, extra.bindPhone);
            MomentMedia momentMedia = extra.momentMedia;
            if (momentMedia != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(2, momentMedia, MomentMedia.PROTOBUF_ADAPTER);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(3, extra.liveShowFollowButton) + CodedOutputByteBufferNano.m17220b(4, extra.feedShowAccostButton);
            String str = extra.feedDefaultPage;
            if (str != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(5, str);
            }
            String str2 = extra.topicH5RedirectURL;
            if (str2 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(6, str2);
            }
            int iM17220b3 = iM17220b2 + CodedOutputByteBufferNano.m17220b(7, extra.showPopWindow);
            ShowAudit showAudit = extra.showAudit;
            if (showAudit != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(8, showAudit, ShowAudit.PROTOBUF_ADAPTER);
            }
            int iM17220b4 = iM17220b3 + CodedOutputByteBufferNano.m17220b(9, extra.defaultSyncMoment);
            List<StateEmotion> list = extra.stateEmotion;
            if (list != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(10, list, StateEmotion.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            StateGuide stateGuide = extra.stateGuide;
            if (stateGuide != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(11, stateGuide, StateGuide.PROTOBUF_ADAPTER);
            }
            String str3 = extra.defaultTab;
            if (str3 != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17233o(12, str3);
            }
            int iM17220b5 = iM17220b4 + CodedOutputByteBufferNano.m17220b(13, extra.activityShowReadButton);
            ExplorePostBubble explorePostBubble = extra.explorePostBubble;
            if (explorePostBubble != null) {
                iM17220b5 += CodedOutputByteBufferNano.m17230l(14, explorePostBubble, ExplorePostBubble.PROTOBUF_ADAPTER);
            }
            StateWindow stateWindow = extra.stateWindow;
            if (stateWindow != null) {
                iM17220b5 += CodedOutputByteBufferNano.m17230l(15, stateWindow, StateWindow.PROTOBUF_ADAPTER);
            }
            MomentExposeConfig momentExposeConfig = extra.momentExposeConfig;
            if (momentExposeConfig != null) {
                iM17220b5 += CodedOutputByteBufferNano.m17230l(16, momentExposeConfig, MomentExposeConfig.PROTOBUF_ADAPTER);
            }
            extra.cachedSize = iM17220b5;
            return iM17220b5;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Extra parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        extra.bindPhone = nb5Var.m158738g();
                        continue;
                    case 18:
                        extra.momentMedia = (MomentMedia) nb5Var.m158743l(MomentMedia.PROTOBUF_ADAPTER);
                        continue;
                    case 24:
                        extra.liveShowFollowButton = nb5Var.m158738g();
                        continue;
                    case 32:
                        extra.feedShowAccostButton = nb5Var.m158738g();
                        continue;
                    case 42:
                        extra.feedDefaultPage = nb5Var.m158750s();
                        continue;
                    case 50:
                        extra.topicH5RedirectURL = nb5Var.m158750s();
                        continue;
                    case 56:
                        extra.showPopWindow = nb5Var.m158738g();
                        continue;
                    case 66:
                        extra.showAudit = (ShowAudit) nb5Var.m158743l(ShowAudit.PROTOBUF_ADAPTER);
                        continue;
                    case 72:
                        extra.defaultSyncMoment = nb5Var.m158738g();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        extra.stateEmotion = (List) nb5Var.m158743l(StateEmotion.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        extra.stateGuide = (StateGuide) nb5Var.m158743l(StateGuide.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        extra.defaultTab = nb5Var.m158750s();
                        continue;
                    case 104:
                        extra.activityShowReadButton = nb5Var.m158738g();
                        continue;
                    case 114:
                        extra.explorePostBubble = (ExplorePostBubble) nb5Var.m158743l(ExplorePostBubble.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        extra.stateWindow = (StateWindow) nb5Var.m158743l(StateWindow.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        extra.momentExposeConfig = (MomentExposeConfig) nb5Var.m158743l(MomentExposeConfig.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (extra.momentMedia == null) {
                            extra.momentMedia = MomentMedia.new_();
        ...
        public void serialize(Extra extra, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, extra.bindPhone);
            MomentMedia momentMedia = extra.momentMedia;
            if (momentMedia != null) {
                codedOutputByteBufferNano.m17254K(2, momentMedia, MomentMedia.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(3, extra.liveShowFollowButton);
            codedOutputByteBufferNano.m17244A(4, extra.feedShowAccostButton);
            String str = extra.feedDefaultPage;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17244A(7, extra.showPopWindow);
            ShowAudit showAudit = extra.showAudit;
            if (showAudit != null) {
                codedOutputByteBufferNano.m17254K(8, showAudit, ShowAudit.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(9, extra.defaultSyncMoment);
            List<StateEmotion> list = extra.stateEmotion;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(10, list, StateEmotion.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            StateGuide stateGuide = extra.stateGuide;
            if (stateGuide != null) {
                codedOutputByteBufferNano.m17254K(11, stateGuide, StateGuide.PROTOBUF_ADAPTER);
            }
            String str3 = extra.defaultTab;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(12, str3);
            }
            codedOutputByteBufferNano.m17244A(13, extra.activityShowReadButton);
            ExplorePostBubble explorePostBubble = extra.explorePostBubble;
            if (explorePostBubble != null) {
                codedOutputByteBufferNano.m17254K(14, explorePostBubble, ExplorePostBubble.PROTOBUF_ADAPTER);
            }
            StateWindow stateWindow = extra.stateWindow;
            if (stateWindow != null) {
                codedOutputByteBufferNano.m17254K(15, stateWindow, StateWindow.PROTOBUF_ADAPTER);
            }
            MomentExposeConfig momentExposeConfig = extra.momentExposeConfig;
            if (momentExposeConfig != null) {
                codedOutputByteBufferNano.m17254K(16, momentExposeConfig, MomentExposeConfig.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Extra mo223809clone() {
        ...
        if (showAudit != null) {
            extra.showAudit = showAudit.mo223809clone();
        }
        ...
        if (stateGuide != null) {
            extra.stateGuide = stateGuide.mo223809clone();
        }
        ...
        if (explorePostBubble != null) {
            extra.explorePostBubble = explorePostBubble.mo223809clone();
        }
        StateWindow stateWindow = this.stateWindow;
        if (stateWindow != null) {
            extra.stateWindow = stateWindow.mo223809clone();
        }
        MomentExposeConfig momentExposeConfig = this.momentExposeConfig;
        if (momentExposeConfig != null) {
            extra.momentExposeConfig = momentExposeConfig.mo223809clone();
        }
        return extra;
    }
