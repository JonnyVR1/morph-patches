...
public class BubbleText extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BubbleText> PROTOBUF_ADAPTER = new MessageNanoAdapter<BubbleText>() { // from class: com.p1.mobile.putong.feed.data.BubbleText.1
        ...
        public int computeAndCacheSize(BubbleText bubbleText) {
            ...
            bubbleText.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BubbleText parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    bubbleText.city = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    bubbleText.posted = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    bubbleText.noKankan = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (bubbleText.city == null) {
                            bubbleText.city = "";
                    ...
                    bubbleText.picture = nb5Var.m158750s();
                }
            }
            return bubbleText;
        }
    ...
    public BubbleText mo223809clone() {
        BubbleText bubbleText = new BubbleText();
