...
import com.p046p1.mobile.putong.feed.data.ButtonInfo;
import com.p046p1.mobile.putong.feed.data.UserSimpleInfo;
...
public class PostBasePopWindow extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PostBasePopWindow> PROTOBUF_ADAPTER = new MessageNanoAdapter<PostBasePopWindow>() { // from class: com.p1.mobile.putong.feed.data.PostBasePopWindow.1
        ...
        public int computeAndCacheSize(PostBasePopWindow postBasePopWindow) {
            ...
            int iM17230l = basicInfoComponent != null ? CodedOutputByteBufferNano.m17230l(1, basicInfoComponent, BasicInfoComponent.PROTOBUF_ADAPTER) : 0;
            IllustrationComponent illustrationComponent = postBasePopWindow.illustration;
            if (illustrationComponent != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, illustrationComponent, IllustrationComponent.PROTOBUF_ADAPTER);
            }
            List<UserSimpleInfo> list = postBasePopWindow.users;
            if (list != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, list, UserSimpleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (inputBoxComponent != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(6, inputBoxComponent, InputBoxComponent.PROTOBUF_ADAPTER);
            }
            LocationComponent locationComponent = postBasePopWindow.locations;
            if (locationComponent != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(7, locationComponent, LocationComponent.PROTOBUF_ADAPTER);
            }
            List<ButtonInfo> list2 = postBasePopWindow.buttons;
            if (list2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(8, list2, ButtonInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            CloseWindowComponent closeWindowComponent = postBasePopWindow.close;
            if (closeWindowComponent != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(9, closeWindowComponent, CloseWindowComponent.PROTOBUF_ADAPTER);
            }
            OccasionComponent occasionComponent = postBasePopWindow.occasion;
            if (occasionComponent != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(10, occasionComponent, OccasionComponent.PROTOBUF_ADAPTER);
            }
            postBasePopWindow.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PostBasePopWindow parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        postBasePopWindow.basic = (BasicInfoComponent) nb5Var.m158743l(BasicInfoComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 18:
                        postBasePopWindow.illustration = (IllustrationComponent) nb5Var.m158743l(IllustrationComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        postBasePopWindow.users = (List) nb5Var.m158743l(UserSimpleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        postBasePopWindow.title = nb5Var.m158750s();
                        continue;
                    case 42:
                        postBasePopWindow.mainBody = nb5Var.m158750s();
                        continue;
                    case 50:
                        postBasePopWindow.inputBox = (InputBoxComponent) nb5Var.m158743l(InputBoxComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        postBasePopWindow.locations = (LocationComponent) nb5Var.m158743l(LocationComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        postBasePopWindow.buttons = (List) nb5Var.m158743l(ButtonInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        postBasePopWindow.close = (CloseWindowComponent) nb5Var.m158743l(CloseWindowComponent.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        postBasePopWindow.occasion = (OccasionComponent) nb5Var.m158743l(OccasionComponent.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (postBasePopWindow.basic == null) {
                            postBasePopWindow.basic = BasicInfoComponent.new_();
        ...
        public void serialize(PostBasePopWindow postBasePopWindow, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (basicInfoComponent != null) {
                codedOutputByteBufferNano.m17254K(1, basicInfoComponent, BasicInfoComponent.PROTOBUF_ADAPTER);
            }
            IllustrationComponent illustrationComponent = postBasePopWindow.illustration;
            if (illustrationComponent != null) {
                codedOutputByteBufferNano.m17254K(2, illustrationComponent, IllustrationComponent.PROTOBUF_ADAPTER);
            }
            List<UserSimpleInfo> list = postBasePopWindow.users;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, UserSimpleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = postBasePopWindow.title;
            if (str != null) {
            ...
            InputBoxComponent inputBoxComponent = postBasePopWindow.inputBox;
            if (inputBoxComponent != null) {
                codedOutputByteBufferNano.m17254K(6, inputBoxComponent, InputBoxComponent.PROTOBUF_ADAPTER);
            }
            LocationComponent locationComponent = postBasePopWindow.locations;
            if (locationComponent != null) {
                codedOutputByteBufferNano.m17254K(7, locationComponent, LocationComponent.PROTOBUF_ADAPTER);
            }
            List<ButtonInfo> list2 = postBasePopWindow.buttons;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(8, list2, ButtonInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            CloseWindowComponent closeWindowComponent = postBasePopWindow.close;
            if (closeWindowComponent != null) {
                codedOutputByteBufferNano.m17254K(9, closeWindowComponent, CloseWindowComponent.PROTOBUF_ADAPTER);
            }
            OccasionComponent occasionComponent = postBasePopWindow.occasion;
            if (occasionComponent != null) {
                codedOutputByteBufferNano.m17254K(10, occasionComponent, OccasionComponent.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public PostBasePopWindow mo223809clone() {
        PostBasePopWindow postBasePopWindow = new PostBasePopWindow();
        BasicInfoComponent basicInfoComponent = this.basic;
        if (basicInfoComponent != null) {
            postBasePopWindow.basic = basicInfoComponent.mo223809clone();
        }
        IllustrationComponent illustrationComponent = this.illustration;
        if (illustrationComponent != null) {
            postBasePopWindow.illustration = illustrationComponent.mo223809clone();
        }
        ...
        if (list != null) {
            postBasePopWindow.users = ValueObject.util_map(list, new w9j() { // from class: l.hd80
                ...
                public final Object call(Object obj) {
                    return ((UserSimpleInfo) obj).mo223809clone();
                }
            });
        }
        ...
        if (inputBoxComponent != null) {
            postBasePopWindow.inputBox = inputBoxComponent.mo223809clone();
        }
        LocationComponent locationComponent = this.locations;
        if (locationComponent != null) {
            postBasePopWindow.locations = locationComponent.mo223809clone();
        }
        ...
        if (list2 != null) {
            postBasePopWindow.buttons = ValueObject.util_map(list2, new w9j() { // from class: l.id80
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((ButtonInfo) obj).mo223809clone();
                }
            });
        }
        CloseWindowComponent closeWindowComponent = this.close;
        if (closeWindowComponent != null) {
            postBasePopWindow.close = closeWindowComponent.mo223809clone();
        }
        OccasionComponent occasionComponent = this.occasion;
        if (occasionComponent != null) {
            postBasePopWindow.occasion = occasionComponent.mo223809clone();
        }
        return postBasePopWindow;
    }
