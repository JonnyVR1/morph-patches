...
import com.p046p1.mobile.putong.feed.data.MomentTag;
import com.p046p1.mobile.putong.feed.data.TwoColTags;
...
public class MomentExtra extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentExtra> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentExtra>() { // from class: com.p1.mobile.putong.feed.data.MomentExtra.1
        ...
        public int computeAndCacheSize(MomentExtra momentExtra) {
            ...
            if (list2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, list2, TwoColTags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        ...
        public MomentExtra parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    ...
                    momentExtra.twoColTags = (List) nb5Var.m158743l(TwoColTags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return momentExtra;
        }
        ...
        public void serialize(MomentExtra momentExtra, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<TwoColTags> list2 = momentExtra.twoColTags;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(3, list2, TwoColTags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public MomentExtra mo223809clone() {
        ...
        if (list2 != null) {
            momentExtra.twoColTags = ValueObject.util_map(list2, new w9j() { // from class: l.ff00
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((TwoColTags) obj).mo223809clone();
                }
            });
        }
        return momentExtra;
