...
public class LiveGroupBannerItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveGroupBannerItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveGroupBannerItem>() { // from class: com.p1.mobile.putong.feed.data.LiveGroupBannerItem.1
        ...
        public int computeAndCacheSize(LiveGroupBannerItem liveGroupBannerItem) {
            String str = liveGroupBannerItem.f39226id;
            ...
            liveGroupBannerItem.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveGroupBannerItem parse(nb5 nb5Var) throws IOException {
            LiveGroupBannerItem liveGroupBannerItem = new LiveGroupBannerItem();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (liveGroupBannerItem.f39226id == null) {
                        liveGroupBannerItem.f39226id = "";
                    }
                ...
                if (iM158752u == 10) {
                    liveGroupBannerItem.f39226id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    liveGroupBannerItem.link = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (liveGroupBannerItem.f39226id == null) {
                            liveGroupBannerItem.f39226id = "";
                    ...
                    liveGroupBannerItem.cover = nb5Var.m158750s();
                }
            }
            return liveGroupBannerItem;
        }
    ...
    public static JsonAdapter<LiveGroupBannerItem> JSON_ADAPTER = new ObjectJsonAdapter<LiveGroupBannerItem>() { // from class: com.p1.mobile.putong.feed.data.LiveGroupBannerItem.2
        ...
        public boolean parseField(LiveGroupBannerItem liveGroupBannerItem, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    liveGroupBannerItem.f39226id = jsonParser.getValueAsString();
                    return false;
                case "link":
    ...
    public LiveGroupBannerItem mo223809clone() {
        LiveGroupBannerItem liveGroupBannerItem = new LiveGroupBannerItem();
        liveGroupBannerItem.f39226id = this.f39226id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39226id, liveGroupBannerItem.f39226id) && ValueObject.util_equals(this.link, liveGroupBannerItem.link) && ValueObject.util_equals(this.cover, liveGroupBannerItem.cover);
    }
