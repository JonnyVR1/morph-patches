...
public class CameraSticker extends ValueObject implements Cloneable, Serializable {
        ...
        public CameraSticker parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (cameraSticker.f39219id == null) {
                            cameraSticker.f39219id = "";
                        }
                        ...
                        break;
                    case 410:
                        cameraSticker.f39219id = nb5Var.m158750s();
                        continue;
                    case 418:
        ...
        public boolean parseField(CameraSticker cameraSticker, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "updateTime":
                    ...
                    return true;
                case "id":
                    cameraSticker.f39219id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public CameraSticker mo223809clone() {
        CameraSticker cameraSticker = new CameraSticker();
        cameraSticker.f39219id = this.f39219id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39219id, cameraSticker.f39219id) && ValueObject.util_equals(this.name, cameraSticker.name) && ValueObject.util_equals(this.icon, cameraSticker.icon) && ValueObject.util_equals(this.resource, cameraSticker.resource) && ValueObject.util_equals(this.resourceMD5, cameraSticker.resourceMD5) && ValueObject.util_equals(this.minVersion, cameraSticker.minVersion) && this.index == cameraSticker.index && this.createdTime == cameraSticker.createdTime && this.updateTime == cameraSticker.updateTime && ValueObject.util_equals(this.category, cameraSticker.category) && ValueObject.util_equals(this.extra, cameraSticker.extra);
    }
    ...
    public CameraSticker subtract(CameraSticker cameraSticker) {
        ...
        if (!ValueObject.util_equals(this.f39219id, cameraSticker.f39219id)) {
            cameraSticker2.f39219id = this.f39219id;
        }
