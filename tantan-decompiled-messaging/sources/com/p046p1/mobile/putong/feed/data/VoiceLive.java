...
import com.p046p1.mobile.putong.data.VoiceLiveExtension;
...
public class VoiceLive extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VoiceLive> PROTOBUF_ADAPTER = new MessageNanoAdapter<VoiceLive>() { // from class: com.p1.mobile.putong.feed.data.VoiceLive.1
        ...
        public int computeAndCacheSize(VoiceLive voiceLive) {
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(5, voiceLive.rewardPoint) + CodedOutputByteBufferNano.m17222d(6, voiceLive.memberCount) + CodedOutputByteBufferNano.m17222d(7, voiceLive.startTime);
            LiveState liveState = voiceLive.state;
            if (liveState != null) {
                iM17222d += CodedOutputByteBufferNano.m17226h(8, liveState.ordinal());
            }
            String str2 = voiceLive.type;
            if (str2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(9, str2);
            }
            List<LiveBasicLabel> list = voiceLive.basicLabels;
            if (list != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(10, list, LiveBasicLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<LiveSpecialLabel> list2 = voiceLive.specialLabels;
            if (list2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(11, list2, LiveSpecialLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17222d2 = iM17222d + CodedOutputByteBufferNano.m17222d(12, voiceLive.endTime);
            StreamCdnInfo streamCdnInfo = voiceLive.streamCdnInfo;
            if (streamCdnInfo != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17230l(13, streamCdnInfo, StreamCdnInfo.PROTOBUF_ADAPTER);
            }
            String str3 = voiceLive.callback;
            if (str3 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(14, str3);
            }
            String str4 = voiceLive.feedStyle;
            if (str4 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(15, str4);
            }
            String str5 = voiceLive.momentText;
            if (str5 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(16, str5);
            }
            List<String> list3 = voiceLive.messages;
            if (list3 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17230l(17, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            UserVoiceLiveCallInfo userVoiceLiveCallInfo = voiceLive.callInfo;
            if (userVoiceLiveCallInfo != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17230l(18, userVoiceLiveCallInfo, UserVoiceLiveCallInfo.PROTOBUF_ADAPTER);
            }
            int iM17222d3 = iM17222d2 + CodedOutputByteBufferNano.m17222d(19, voiceLive.rewarderCount) + CodedOutputByteBufferNano.m17222d(20, voiceLive.messageCount);
            VoiceLiveExtension voiceLiveExtension = voiceLive.extension;
            if (voiceLiveExtension != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(21, voiceLiveExtension, VoiceLiveExtension.PROTOBUF_ADAPTER);
            }
            LiveState liveState2 = voiceLive.state;
            if (liveState2 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(22, liveState2, LiveState.PROTOBUF_ADAPTER);
            }
            voiceLive.cachedSize = iM17222d3;
            return iM17222d3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VoiceLive parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        voiceLive.f39250id = nb5Var.m158750s();
                        continue;
                    case 18:
                        voiceLive.room = (Owner) nb5Var.m158743l(Owner.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        voiceLive.anchor = (Owner) nb5Var.m158743l(Owner.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        voiceLive.streamUrl = (StreamUrl) nb5Var.m158743l(StreamUrl.PROTOBUF_ADAPTER);
                        continue;
                    case 41:
                        voiceLive.rewardPoint = nb5Var.m158739h();
                        continue;
                    case 49:
                        voiceLive.memberCount = nb5Var.m158739h();
                        continue;
                    case 57:
                        voiceLive.startTime = nb5Var.m158739h();
                        continue;
                    case 64:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 74:
                        voiceLive.type = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        voiceLive.basicLabels = (List) nb5Var.m158743l(LiveBasicLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        voiceLive.specialLabels = (List) nb5Var.m158743l(LiveSpecialLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.APPLICATION_TEMPLATE /* 97 */:
                        voiceLive.endTime = nb5Var.m158739h();
                        continue;
                    case 106:
                        voiceLive.streamCdnInfo = (StreamCdnInfo) nb5Var.m158743l(StreamCdnInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        voiceLive.callback = nb5Var.m158750s();
                        continue;
                    case 122:
                        voiceLive.feedStyle = nb5Var.m158750s();
                        continue;
                    case 130:
                        voiceLive.momentText = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        voiceLive.messages = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        voiceLive.callInfo = (UserVoiceLiveCallInfo) nb5Var.m158743l(UserVoiceLiveCallInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 153:
                        voiceLive.rewarderCount = nb5Var.m158739h();
                        continue;
                    case 161:
                        voiceLive.messageCount = nb5Var.m158739h();
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        voiceLive.extension = (VoiceLiveExtension) nb5Var.m158743l(VoiceLiveExtension.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        voiceLive.state = (LiveState) nb5Var.m158743l(LiveState.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (voiceLive.state == null && numValueOf != null) {
                            voiceLive.state = (LiveState) LiveState.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(VoiceLive voiceLive, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(5, voiceLive.rewardPoint);
            codedOutputByteBufferNano.m17246C(6, voiceLive.memberCount);
            codedOutputByteBufferNano.m17246C(7, voiceLive.startTime);
            LiveState liveState = voiceLive.state;
            if (liveState != null) {
                codedOutputByteBufferNano.m17250G(8, liveState.ordinal());
            }
            String str2 = voiceLive.type;
            if (str2 != null) {
            ...
            List<LiveBasicLabel> list = voiceLive.basicLabels;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(10, list, LiveBasicLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<LiveSpecialLabel> list2 = voiceLive.specialLabels;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(11, list2, LiveSpecialLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17246C(12, voiceLive.endTime);
            StreamCdnInfo streamCdnInfo = voiceLive.streamCdnInfo;
            if (streamCdnInfo != null) {
                codedOutputByteBufferNano.m17254K(13, streamCdnInfo, StreamCdnInfo.PROTOBUF_ADAPTER);
            }
            String str3 = voiceLive.callback;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(14, str3);
            }
            String str4 = voiceLive.feedStyle;
            if (str4 != null) {
            ...
            String str5 = voiceLive.momentText;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(16, str5);
            }
            List<String> list3 = voiceLive.messages;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(17, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            UserVoiceLiveCallInfo userVoiceLiveCallInfo = voiceLive.callInfo;
            if (userVoiceLiveCallInfo != null) {
                codedOutputByteBufferNano.m17254K(18, userVoiceLiveCallInfo, UserVoiceLiveCallInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(19, voiceLive.rewarderCount);
            codedOutputByteBufferNano.m17246C(20, voiceLive.messageCount);
            VoiceLiveExtension voiceLiveExtension = voiceLive.extension;
            if (voiceLiveExtension != null) {
                codedOutputByteBufferNano.m17254K(21, voiceLiveExtension, VoiceLiveExtension.PROTOBUF_ADAPTER);
            }
            LiveState liveState2 = voiceLive.state;
            if (liveState2 != null) {
                codedOutputByteBufferNano.m17254K(22, liveState2, LiveState.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(VoiceLive voiceLive, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 11:
                    ...
                    return true;
                case 12:
                    voiceLive.f39250id = jsonParser.getValueAsString();
                    return false;
                case 13:
    ...
    public static /* synthetic */ String m60914c(String str) {
        return str;
    }
    ...
    public VoiceLive mo223809clone() {
        VoiceLive voiceLive = new VoiceLive();
        voiceLive.f39250id = this.f39250id;
        Owner owner = this.room;
        if (owner != null) {
            voiceLive.room = owner.mo223809clone();
        }
        Owner owner2 = this.anchor;
        if (owner2 != null) {
            voiceLive.anchor = owner2.mo223809clone();
        }
        StreamUrl streamUrl = this.streamUrl;
        if (streamUrl != null) {
            voiceLive.streamUrl = streamUrl.mo223809clone();
        }
        ...
        if (streamCdnInfo != null) {
            voiceLive.streamCdnInfo = streamCdnInfo.mo223809clone();
        }
        ...
        if (list3 != null) {
            voiceLive.messages = ValueObject.util_map(list3, new w9j() { // from class: l.ujn0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return VoiceLive.m60914c((String) obj);
                }
            });
        }
        UserVoiceLiveCallInfo userVoiceLiveCallInfo = this.callInfo;
        if (userVoiceLiveCallInfo != null) {
            voiceLive.callInfo = userVoiceLiveCallInfo.mo223809clone();
        }
        ...
        if (voiceLiveExtension != null) {
            voiceLive.extension = voiceLiveExtension.mo223809clone();
        }
        return voiceLive;
    }
