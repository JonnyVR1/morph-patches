...
public class Group extends DbObject<Group> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Group> PROTOBUF_ADAPTER = new MessageNanoAdapter<Group>() { // from class: com.p1.mobile.putong.feed.data.Group.1
        ...
        public int computeAndCacheSize(Group group) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, group._id);
            String str = group.f56011id;
            if (str != null) {
            ...
            if (str8 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(57, str8);
            }
            List<String> list = group.backgroundColors;
            if (list != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(58, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17226h = iM17228j + CodedOutputByteBufferNano.m17226h(59, group.userCounter) + CodedOutputByteBufferNano.m17226h(60, group.unReadMomentCounter) + CodedOutputByteBufferNano.m17220b(61, group.joined);
            String str9 = group.status;
            if (str9 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(62, str9);
            }
            GroupType groupType = group.groupType;
            if (groupType != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(63, groupType, GroupType.PROTOBUF_ADAPTER);
            }
            int iM17222d = iM17226h + CodedOutputByteBufferNano.m17222d(64, group.createdTime);
            List<String> list2 = group.userIds;
            if (list2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(65, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<TopicMomentIdBox> list3 = group.topics;
            if (list3 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(66, list3, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<TopicMomentIdBox> list4 = group.hotTopics;
            if (list4 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(67, list4, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str10 = group.owner;
            if (str10 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(68, str10);
            }
            group.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Group parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        group._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        group.f56011id = nb5Var.m158750s();
                        continue;
                    case 410:
                        group.name = nb5Var.m158750s();
                        continue;
                    case 418:
                        group.description = nb5Var.m158750s();
                        continue;
                    case 426:
                        group.preViewContent = nb5Var.m158750s();
                        continue;
                    case 434:
                        group.memberRole = nb5Var.m158750s();
                        continue;
                    case 442:
                        group.state = nb5Var.m158750s();
                        continue;
                    case 450:
                        group.icon = nb5Var.m158750s();
                        continue;
                    case 458:
                        group.headIcon = nb5Var.m158750s();
                        continue;
                    case 466:
                        group.backgroundColors = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 472:
                        group.userCounter = nb5Var.m158741j();
                        continue;
                    case 480:
                        group.unReadMomentCounter = nb5Var.m158741j();
                        continue;
                    case 488:
                        group.joined = nb5Var.m158738g();
                        continue;
                    case 498:
                        group.status = nb5Var.m158750s();
                        continue;
                    case 506:
                        group.groupType = (GroupType) nb5Var.m158743l(GroupType.PROTOBUF_ADAPTER);
                        continue;
                    case 513:
                        group.createdTime = nb5Var.m158739h();
                        continue;
                    case 522:
                        group.userIds = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 530:
                        group.topics = (List) nb5Var.m158743l(TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 538:
                        group.hotTopics = (List) nb5Var.m158743l(TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 546:
                        group.owner = nb5Var.m158750s();
                        continue;
                    default:
                        if (group.name == null) {
                            group.name = "";
        ...
        public void serialize(Group group, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, group._id);
            String str = group.f56011id;
            if (str != null) {
            ...
            String str8 = group.headIcon;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(57, str8);
            }
            List<String> list = group.backgroundColors;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(58, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(59, group.userCounter);
            codedOutputByteBufferNano.m17250G(60, group.unReadMomentCounter);
            codedOutputByteBufferNano.m17244A(61, group.joined);
            String str9 = group.status;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(62, str9);
            }
            GroupType groupType = group.groupType;
            if (groupType != null) {
                codedOutputByteBufferNano.m17254K(63, groupType, GroupType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(64, group.createdTime);
            List<String> list2 = group.userIds;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(65, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<TopicMomentIdBox> list3 = group.topics;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(66, list3, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<TopicMomentIdBox> list4 = group.hotTopics;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(67, list4, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str10 = group.owner;
            if (str10 != null) {
                codedOutputByteBufferNano.m17261R(68, str10);
            }
        }
    };
        ...
        public boolean parseField(Group group, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 11:
                    ...
                    return true;
                case 12:
                    group.f56011id = jsonParser.getValueAsString();
                    return false;
                case 13:
    ...
    public static /* synthetic */ String m60843a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m60845c(String str) {
        return str;
    }
    ...
    public Group mo223809clone() {
        Group group = new Group();
        group._id = this._id;
        group.f56011id = this.f56011id;
        ...
        if (list != null) {
            group.backgroundColors = ValueObject.util_map(list, new w9j() { // from class: l.cbk
                ...
                public final Object call(Object obj) {
                    return Group.m60845c((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            group.userIds = ValueObject.util_map(list2, new w9j() { // from class: l.dbk
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Group.m60843a((String) obj);
                }
            });
        }
