...
public class Meet extends ValueObject<Meet> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Meet> PROTOBUF_ADAPTER = new MessageNanoAdapter<Meet>() { // from class: com.p1.mobile.putong.feed.data.Meet.1
        ...
        public int computeAndCacheSize(Meet meet) {
            ...
            meet.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Meet parse(nb5 nb5Var) throws IOException {
            Meet meet = new Meet();
            while (true) {
                ...
                if (iM158752u == 10) {
                    meet.type = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    meet.f39229id = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (meet.type == null) {
                            meet.type = "";
        ...
        public boolean parseField(Meet meet, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "userId":
                    ...
                    return true;
                case "id":
                    meet.f39229id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public Meet mo223809clone() {
        Meet meet = new Meet();
        meet.type = this.type;
        meet.f39229id = this.f39229id;
    ...
    public boolean equals(Object obj) {
        ...
        Meet meet = (Meet) obj;
        return ValueObject.util_equals(this.type, meet.type) && ValueObject.util_equals(this.f39229id, meet.f39229id) && ValueObject.util_equals(this.userId, meet.userId);
    }
