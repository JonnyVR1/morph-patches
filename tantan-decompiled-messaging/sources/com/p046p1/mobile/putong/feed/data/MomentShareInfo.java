...
public class MomentShareInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentShareInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentShareInfo>() { // from class: com.p1.mobile.putong.feed.data.MomentShareInfo.1
        ...
        public int computeAndCacheSize(MomentShareInfo momentShareInfo) {
            ...
            momentShareInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentShareInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    momentShareInfo.title = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    momentShareInfo.description = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    momentShareInfo.url = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    momentShareInfo.landingPage = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    momentShareInfo.name = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    momentShareInfo.shareFrom = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (momentShareInfo.title == null) {
                            momentShareInfo.title = "";
                    ...
                    momentShareInfo.testId = nb5Var.m158750s();
                }
            }
            return momentShareInfo;
        }
    ...
    public MomentShareInfo mo223809clone() {
        MomentShareInfo momentShareInfo = new MomentShareInfo();
