...
import com.p046p1.mobile.putong.feed.data.TextHightLight;
...
public class TextComponent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TextComponent> PROTOBUF_ADAPTER = new MessageNanoAdapter<TextComponent>() { // from class: com.p1.mobile.putong.feed.data.TextComponent.1
        ...
        public int computeAndCacheSize(TextComponent textComponent) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, textComponent.frontSize);
            String str2 = textComponent.frontColor;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(3, str2);
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(4, textComponent.maxLines);
            List<TextHightLight> list = textComponent.highLight;
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(5, list, TextHightLight.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            textComponent.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TextComponent parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    textComponent.content = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    textComponent.frontSize = nb5Var.m158741j();
                } else if (iM158752u == 26) {
                    textComponent.frontColor = nb5Var.m158750s();
                } else if (iM158752u == 32) {
                    textComponent.maxLines = nb5Var.m158741j();
                } else {
                    if (iM158752u != 42) {
                        if (textComponent.content == null) {
                            textComponent.content = "";
                    ...
                    textComponent.highLight = (List) nb5Var.m158743l(TextHightLight.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return textComponent;
        }
        ...
        public void serialize(TextComponent textComponent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, textComponent.frontSize);
            String str2 = textComponent.frontColor;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(3, str2);
            }
            codedOutputByteBufferNano.m17250G(4, textComponent.maxLines);
            List<TextHightLight> list = textComponent.highLight;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(5, list, TextHightLight.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public TextComponent mo223809clone() {
        TextComponent textComponent = new TextComponent();
        ...
        if (list != null) {
            textComponent.highLight = ValueObject.util_map(list, new w9j() { // from class: l.mii0
                ...
                public final Object call(Object obj) {
                    return ((TextHightLight) obj).mo223809clone();
                }
            });
        }
        return textComponent;
