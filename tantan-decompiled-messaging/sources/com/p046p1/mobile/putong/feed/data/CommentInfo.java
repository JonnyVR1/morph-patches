...
public class CommentInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CommentInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<CommentInfo>() { // from class: com.p1.mobile.putong.feed.data.CommentInfo.1
        ...
        public int computeAndCacheSize(CommentInfo commentInfo) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, commentInfo.likes) + CodedOutputByteBufferNano.m17220b(2, commentInfo.liked);
            ...
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(6, commentInfo.isBottom);
            String str3 = commentInfo.replyMessageId;
            if (str3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(7, str3);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(8, commentInfo.replyMessageAnonymous);
            CommentStatus commentStatus = commentInfo.status;
            if (commentStatus != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(9, commentStatus, CommentStatus.PROTOBUF_ADAPTER);
            }
            commentInfo.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CommentInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    commentInfo.likes = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    commentInfo.liked = nb5Var.m158738g();
                } else if (iM158752u == 26) {
                    commentInfo.parentMessageId = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    commentInfo.subMessageIds = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 42) {
                    commentInfo.moreSubMessages = nb5Var.m158750s();
                } else if (iM158752u == 48) {
                    commentInfo.isBottom = nb5Var.m158738g();
                } else if (iM158752u == 58) {
                    commentInfo.replyMessageId = nb5Var.m158750s();
                } else if (iM158752u == 64) {
                    commentInfo.replyMessageAnonymous = nb5Var.m158738g();
                } else {
                    if (iM158752u != 74) {
                        if (commentInfo.parentMessageId == null) {
                            commentInfo.parentMessageId = "";
                    ...
                    commentInfo.status = (CommentStatus) nb5Var.m158743l(CommentStatus.PROTOBUF_ADAPTER);
                }
            }
            return commentInfo;
        }
        ...
        public void serialize(CommentInfo commentInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, commentInfo.likes);
            codedOutputByteBufferNano.m17244A(2, commentInfo.liked);
            String str = commentInfo.parentMessageId;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17244A(6, commentInfo.isBottom);
            String str3 = commentInfo.replyMessageId;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(7, str3);
            }
            codedOutputByteBufferNano.m17244A(8, commentInfo.replyMessageAnonymous);
            CommentStatus commentStatus = commentInfo.status;
            if (commentStatus != null) {
                codedOutputByteBufferNano.m17254K(9, commentStatus, CommentStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m60784a(String str) {
        return str;
    }
    ...
    public CommentInfo mo223809clone() {
        CommentInfo commentInfo = new CommentInfo();
        ...
        if (list != null) {
            commentInfo.subMessageIds = ValueObject.util_map(list, new w9j() { // from class: l.eh5
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return CommentInfo.m60784a((String) obj);
                }
            });
        }
