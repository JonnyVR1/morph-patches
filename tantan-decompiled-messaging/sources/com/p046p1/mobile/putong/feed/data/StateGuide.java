...
public class StateGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StateGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<StateGuide>() { // from class: com.p1.mobile.putong.feed.data.StateGuide.1
        ...
        public int computeAndCacheSize(StateGuide stateGuide) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, stateGuide.swipeMomentCount) + CodedOutputByteBufferNano.m17226h(3, stateGuide.unClickCount) + CodedOutputByteBufferNano.m17226h(4, stateGuide.guideShowInterval);
            String str2 = stateGuide.gender;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(5, str2);
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(6, stateGuide.defaultEmotionIndex);
            List<Configs> list = stateGuide.configs;
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(7, list, Configs.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            stateGuide.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StateGuide parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    stateGuide.title = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    stateGuide.swipeMomentCount = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    stateGuide.unClickCount = nb5Var.m158741j();
                } else if (iM158752u == 32) {
                    stateGuide.guideShowInterval = nb5Var.m158741j();
                } else if (iM158752u == 42) {
                    stateGuide.gender = nb5Var.m158750s();
                } else if (iM158752u == 48) {
                    stateGuide.defaultEmotionIndex = nb5Var.m158741j();
                } else {
                    if (iM158752u != 58) {
                        if (stateGuide.title == null) {
                            stateGuide.title = "";
                    ...
                    stateGuide.configs = (List) nb5Var.m158743l(Configs.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return stateGuide;
        }
        ...
        public void serialize(StateGuide stateGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, stateGuide.swipeMomentCount);
            codedOutputByteBufferNano.m17250G(3, stateGuide.unClickCount);
            codedOutputByteBufferNano.m17250G(4, stateGuide.guideShowInterval);
            String str2 = stateGuide.gender;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(5, str2);
            }
            codedOutputByteBufferNano.m17250G(6, stateGuide.defaultEmotionIndex);
            List<Configs> list = stateGuide.configs;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(7, list, Configs.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public StateGuide mo223809clone() {
        StateGuide stateGuide = new StateGuide();
        ...
        if (list != null) {
            stateGuide.configs = ValueObject.util_map(list, new w9j() { // from class: l.jvf0
                ...
                public final Object call(Object obj) {
                    return ((Configs) obj).mo223809clone();
                }
            });
        }
        return stateGuide;
