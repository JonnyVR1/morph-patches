...
import com.p046p1.mobile.putong.feed.data.PersonAlbumBgInfoMedia;
...
public class PersonAlbumBgInfoMedia extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PersonAlbumBgInfoMedia> PROTOBUF_ADAPTER = new MessageNanoAdapter<PersonAlbumBgInfoMedia>() { // from class: com.p1.mobile.putong.feed.data.PersonAlbumBgInfoMedia.1
        ...
        public int computeAndCacheSize(PersonAlbumBgInfoMedia personAlbumBgInfoMedia) {
            String str = personAlbumBgInfoMedia.f39238id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            String str2 = personAlbumBgInfoMedia.name;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(2, str2);
            }
            int iM17224f = iM17233o + CodedOutputByteBufferNano.m17224f(3, personAlbumBgInfoMedia.duration);
            String str3 = personAlbumBgInfoMedia.mediaType;
            if (str3 != null) {
                iM17224f += CodedOutputByteBufferNano.m17233o(4, str3);
            }
            Dimension dimension = personAlbumBgInfoMedia.size;
            if (dimension != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(5, dimension, Dimension.PROTOBUF_ADAPTER);
            }
            List<PersonAlbumBgInfoMedia> list = personAlbumBgInfoMedia.attachments;
            if (list != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(6, list, PersonAlbumBgInfoMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = personAlbumBgInfoMedia.url;
            if (str4 != null) {
                iM17224f += CodedOutputByteBufferNano.m17233o(7, str4);
            }
            AudioMedia audioMedia = personAlbumBgInfoMedia.audio;
            if (audioMedia != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(8, audioMedia, AudioMedia.PROTOBUF_ADAPTER);
            }
            GifMedia gifMedia = personAlbumBgInfoMedia.gif;
            if (gifMedia != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(9, gifMedia, GifMedia.PROTOBUF_ADAPTER);
            }
            Music music = personAlbumBgInfoMedia.music;
            if (music != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(10, music, Music.PROTOBUF_ADAPTER);
            }
            AIPosition aIPosition = personAlbumBgInfoMedia.aiPosition;
            if (aIPosition != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(11, aIPosition, AIPosition.PROTOBUF_ADAPTER);
            }
            ...
            if (gaussianBlurParameters != null) {
                iM17224f += CodedOutputByteBufferNano.m17230l(12, gaussianBlurParameters, GaussianBlurParameters.PROTOBUF_ADAPTER);
            }
            String str5 = personAlbumBgInfoMedia.status;
            if (str5 != null) {
                iM17224f += CodedOutputByteBufferNano.m17233o(13, str5);
            }
            personAlbumBgInfoMedia.cachedSize = iM17224f;
            return iM17224f;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PersonAlbumBgInfoMedia parse(nb5 nb5Var) throws IOException {
            PersonAlbumBgInfoMedia personAlbumBgInfoMedia = new PersonAlbumBgInfoMedia();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (personAlbumBgInfoMedia.f39238id == null) {
                            personAlbumBgInfoMedia.f39238id = "";
                        }
                        ...
                        break;
                    case 10:
                        personAlbumBgInfoMedia.f39238id = nb5Var.m158750s();
                        continue;
                    case 18:
                        personAlbumBgInfoMedia.name = nb5Var.m158750s();
                        continue;
                    case 29:
                        personAlbumBgInfoMedia.duration = nb5Var.m158740i();
                        continue;
                    case 34:
                        personAlbumBgInfoMedia.mediaType = nb5Var.m158750s();
                        continue;
                    case 42:
                        personAlbumBgInfoMedia.size = (Dimension) nb5Var.m158743l(Dimension.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        personAlbumBgInfoMedia.attachments = (List) nb5Var.m158743l(PersonAlbumBgInfoMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        personAlbumBgInfoMedia.url = nb5Var.m158750s();
                        continue;
                    case 66:
                        personAlbumBgInfoMedia.audio = (AudioMedia) nb5Var.m158743l(AudioMedia.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        personAlbumBgInfoMedia.gif = (GifMedia) nb5Var.m158743l(GifMedia.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        personAlbumBgInfoMedia.music = (Music) nb5Var.m158743l(Music.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        personAlbumBgInfoMedia.aiPosition = (AIPosition) nb5Var.m158743l(AIPosition.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        personAlbumBgInfoMedia.gaussianBlurParameters = (GaussianBlurParameters) nb5Var.m158743l(GaussianBlurParameters.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        personAlbumBgInfoMedia.status = nb5Var.m158750s();
                        continue;
                    default:
                        if (personAlbumBgInfoMedia.f39238id == null) {
                            personAlbumBgInfoMedia.f39238id = "";
        ...
        public void serialize(PersonAlbumBgInfoMedia personAlbumBgInfoMedia, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17248E(3, personAlbumBgInfoMedia.duration);
            String str3 = personAlbumBgInfoMedia.mediaType;
            if (str3 != null) {
            ...
            Dimension dimension = personAlbumBgInfoMedia.size;
            if (dimension != null) {
                codedOutputByteBufferNano.m17254K(5, dimension, Dimension.PROTOBUF_ADAPTER);
            }
            List<PersonAlbumBgInfoMedia> list = personAlbumBgInfoMedia.attachments;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(6, list, PersonAlbumBgInfoMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = personAlbumBgInfoMedia.url;
            if (str4 != null) {
            ...
            AudioMedia audioMedia = personAlbumBgInfoMedia.audio;
            if (audioMedia != null) {
                codedOutputByteBufferNano.m17254K(8, audioMedia, AudioMedia.PROTOBUF_ADAPTER);
            }
            GifMedia gifMedia = personAlbumBgInfoMedia.gif;
            if (gifMedia != null) {
                codedOutputByteBufferNano.m17254K(9, gifMedia, GifMedia.PROTOBUF_ADAPTER);
            }
            Music music = personAlbumBgInfoMedia.music;
            if (music != null) {
                codedOutputByteBufferNano.m17254K(10, music, Music.PROTOBUF_ADAPTER);
            }
            AIPosition aIPosition = personAlbumBgInfoMedia.aiPosition;
            if (aIPosition != null) {
                codedOutputByteBufferNano.m17254K(11, aIPosition, AIPosition.PROTOBUF_ADAPTER);
            }
            GaussianBlurParameters gaussianBlurParameters = personAlbumBgInfoMedia.gaussianBlurParameters;
            if (gaussianBlurParameters != null) {
                codedOutputByteBufferNano.m17254K(12, gaussianBlurParameters, GaussianBlurParameters.PROTOBUF_ADAPTER);
            }
            String str5 = personAlbumBgInfoMedia.status;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(13, str5);
            }
        }
    };
        ...
        public boolean parseField(PersonAlbumBgInfoMedia personAlbumBgInfoMedia, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "gaussianBlurParameters":
                    ...
                    return true;
                case "id":
                    personAlbumBgInfoMedia.f39238id = jsonParser.getValueAsString();
                    return false;
                case "gif":
    ...
    public PersonAlbumBgInfoMedia mo223809clone() {
        PersonAlbumBgInfoMedia personAlbumBgInfoMedia = new PersonAlbumBgInfoMedia();
        personAlbumBgInfoMedia.f39238id = this.f39238id;
        ...
        if (dimension != null) {
            personAlbumBgInfoMedia.size = dimension.mo223809clone();
        }
        ...
        if (list != null) {
            personAlbumBgInfoMedia.attachments = ValueObject.util_map(list, new w9j() { // from class: l.jk60
                ...
                public final Object call(Object obj) {
                    return ((PersonAlbumBgInfoMedia) obj).mo223809clone();
                }
            });
        }
        ...
        if (audioMedia != null) {
            personAlbumBgInfoMedia.audio = audioMedia.mo223809clone();
        }
        GifMedia gifMedia = this.gif;
        if (gifMedia != null) {
            personAlbumBgInfoMedia.gif = gifMedia.mo223809clone();
        }
        Music music = this.music;
        if (music != null) {
            personAlbumBgInfoMedia.music = music.mo223809clone();
        }
        AIPosition aIPosition = this.aiPosition;
        if (aIPosition != null) {
            personAlbumBgInfoMedia.aiPosition = aIPosition.mo223809clone();
        }
        GaussianBlurParameters gaussianBlurParameters = this.gaussianBlurParameters;
        if (gaussianBlurParameters != null) {
            personAlbumBgInfoMedia.gaussianBlurParameters = gaussianBlurParameters.mo223809clone();
        }
