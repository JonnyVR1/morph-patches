...
public class MomentMessage extends CopyObject<MomentMessage> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentMessage> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentMessage>() { // from class: com.p1.mobile.putong.feed.data.MomentMessage.1
        ...
        public int computeAndCacheSize(MomentMessage momentMessage) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, momentMessage._id);
            String str = momentMessage.f56008id;
            if (str != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17228j2 = iM17228j + CodedOutputByteBufferNano.m17228j(51, momentMessage.localCreatedTime) + CodedOutputByteBufferNano.m17226h(52, momentMessage.localCreatedSession) + CodedOutputByteBufferNano.m17220b(53, momentMessage.localInMoment) + CodedOutputByteBufferNano.m17220b(54, momentMessage.localInConversation) + CodedOutputByteBufferNano.m17222d(55, momentMessage.createdTime);
            ...
            if (str3 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(57, str3);
            }
            List<Media> list = momentMessage.media;
            if (list != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(58, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (str5 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(60, str5);
            }
            String str6 = momentMessage.owner;
            if (str6 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(61, str6);
            }
            String str7 = momentMessage.value;
            if (str7 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(62, str7);
            }
            Boolean bool = momentMessage.recalled;
            if (bool != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17220b(63, bool.booleanValue());
            }
            MomentMessageType momentMessageType = momentMessage.messageType;
            if (momentMessageType != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17226h(64, momentMessageType.ordinal());
            }
            MomentMessageSetting momentMessageSetting = momentMessage.settings;
            if (momentMessageSetting != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(65, momentMessageSetting, MomentMessageSetting.PROTOBUF_ADAPTER);
            }
            MomentMessageType momentMessageType2 = momentMessage.messageType;
            if (momentMessageType2 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(66, momentMessageType2, MomentMessageType.PROTOBUF_ADAPTER);
            }
            CommentStatus commentStatus = momentMessage.status;
            if (commentStatus != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(67, commentStatus, CommentStatus.PROTOBUF_ADAPTER);
            }
            Accessory accessory = momentMessage.accessory;
            if (accessory != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(68, accessory, Accessory.PROTOBUF_ADAPTER);
            }
            momentMessage.cachedSize = iM17228j2;
            return iM17228j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentMessage parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        momentMessage._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        momentMessage.f56008id = nb5Var.m158750s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        momentMessage.localCreatedTime = nb5Var.m158742k();
                        continue;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        momentMessage.localCreatedSession = nb5Var.m158741j();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        momentMessage.localInMoment = nb5Var.m158738g();
                        continue;
                    case 432:
                        momentMessage.localInConversation = nb5Var.m158738g();
                        continue;
                    case 441:
                        momentMessage.createdTime = nb5Var.m158739h();
                        continue;
                    case 450:
                        momentMessage.cid = nb5Var.m158750s();
                        continue;
                    case 458:
                        momentMessage.likeOfMoment = nb5Var.m158750s();
                        continue;
                    case 466:
                        momentMessage.media = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 474:
                        momentMessage.sticker = nb5Var.m158750s();
                        continue;
                    case 482:
                        momentMessage.moment = nb5Var.m158750s();
                        continue;
                    case 490:
                        momentMessage.owner = nb5Var.m158750s();
                        continue;
                    case 498:
                        momentMessage.value = nb5Var.m158750s();
                        continue;
                    case HttpStatus.GATEWAY_TIMEOUT_504 /* 504 */:
                        momentMessage.recalled = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 512:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 522:
                        momentMessage.settings = (MomentMessageSetting) nb5Var.m158743l(MomentMessageSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 530:
                        momentMessage.messageType = (MomentMessageType) nb5Var.m158743l(MomentMessageType.PROTOBUF_ADAPTER);
                        continue;
                    case 538:
                        momentMessage.status = (CommentStatus) nb5Var.m158743l(CommentStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 546:
                        momentMessage.accessory = (Accessory) nb5Var.m158743l(Accessory.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (momentMessage.messageType == null && numValueOf != null) {
                            momentMessage.messageType = (MomentMessageType) MomentMessageType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(MomentMessage momentMessage, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, momentMessage._id);
            String str = momentMessage.f56008id;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17252I(51, momentMessage.localCreatedTime);
            codedOutputByteBufferNano.m17250G(52, momentMessage.localCreatedSession);
            codedOutputByteBufferNano.m17244A(53, momentMessage.localInMoment);
            codedOutputByteBufferNano.m17244A(54, momentMessage.localInConversation);
            codedOutputByteBufferNano.m17246C(55, momentMessage.createdTime);
            String str2 = momentMessage.cid;
            if (str2 != null) {
            ...
            String str3 = momentMessage.likeOfMoment;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(57, str3);
            }
            List<Media> list = momentMessage.media;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(58, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = momentMessage.sticker;
            if (str4 != null) {
            ...
            String str5 = momentMessage.moment;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(60, str5);
            }
            String str6 = momentMessage.owner;
            if (str6 != null) {
                codedOutputByteBufferNano.m17261R(61, str6);
            }
            String str7 = momentMessage.value;
            if (str7 != null) {
                codedOutputByteBufferNano.m17261R(62, str7);
            }
            Boolean bool = momentMessage.recalled;
            if (bool != null) {
                codedOutputByteBufferNano.m17244A(63, bool.booleanValue());
            }
            MomentMessageType momentMessageType = momentMessage.messageType;
            if (momentMessageType != null) {
                codedOutputByteBufferNano.m17250G(64, momentMessageType.ordinal());
            }
            MomentMessageSetting momentMessageSetting = momentMessage.settings;
            if (momentMessageSetting != null) {
                codedOutputByteBufferNano.m17254K(65, momentMessageSetting, MomentMessageSetting.PROTOBUF_ADAPTER);
            }
            MomentMessageType momentMessageType2 = momentMessage.messageType;
            if (momentMessageType2 != null) {
                codedOutputByteBufferNano.m17254K(66, momentMessageType2, MomentMessageType.PROTOBUF_ADAPTER);
            }
            CommentStatus commentStatus = momentMessage.status;
            if (commentStatus != null) {
                codedOutputByteBufferNano.m17254K(67, commentStatus, CommentStatus.PROTOBUF_ADAPTER);
            }
            Accessory accessory = momentMessage.accessory;
            if (accessory != null) {
                codedOutputByteBufferNano.m17254K(68, accessory, Accessory.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(MomentMessage momentMessage, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 15:
                    ...
                    return true;
                case 16:
                    momentMessage.f56008id = jsonParser.getValueAsString();
                    return false;
                case 17:
    ...
    public static /* synthetic */ String m60868a(String str) {
        return str;
    }
    ...
    public MomentMessage beforeApiSerialize() {
        MomentMessage momentMessageMo223809clone = mo223809clone();
        momentMessageMo223809clone.reverseParseComplete();
        return momentMessageMo223809clone;
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public MomentMessage mo223809clone() {
        MomentMessage momentMessage = new MomentMessage();
        momentMessage._id = this._id;
        momentMessage.f56008id = this.f56008id;
        ...
        if (momentMessageReference != null) {
            momentMessage.api_only_reference = momentMessageReference.mo223809clone();
        }
        momentMessage.moment = this.moment;
        CommentInfo commentInfo = this.commentInfo;
        if (commentInfo != null) {
            momentMessage.commentInfo = commentInfo.mo223809clone();
        }
        ...
        if (list2 != null) {
            momentMessage.subCommentIds = ValueObject.util_map(list2, new w9j() { // from class: l.mg00
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return MomentMessage.m60868a((String) obj);
                }
            });
        }
        ...
        if (momentMessageSetting != null) {
            momentMessage.settings = momentMessageSetting.mo223809clone();
        }
        ...
        if (accessory != null) {
            momentMessage.accessory = accessory.mo223809clone();
        }
        return momentMessage;
    }
    ...
    public void onApiParseComplete() {
        ...
        if (momentMessageReference != null) {
            if (!"message".equals(momentMessageReference.type) && "moment".equals(this.api_only_reference.type)) {
                ...
                if (zEquals) {
                    this.likeOfMoment = momentMessageReference2.f39233id;
                } else {
                    this.moment = momentMessageReference2.f39233id;
                }
            }
    ...
    public void putParsedField(String str) {
        if ("v2".equals(xh5.m208774v(this.requestUrl))) {
    ...
    public void reverseParseComplete() {
        ...
        if (this.moment != null) {
            ...
            momentMessageReference.f39233id = this.moment;
    ...
    public boolean shouldMergeData() {
        return "v2".equals(xh5.m208774v(this.requestUrl));
    }
