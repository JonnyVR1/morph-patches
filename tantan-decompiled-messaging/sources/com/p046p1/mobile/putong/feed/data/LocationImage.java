...
import com.p046p1.mobile.putong.feed.data.LocationImage;
...
public class LocationImage extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LocationImage> PROTOBUF_ADAPTER = new MessageNanoAdapter<LocationImage>() { // from class: com.p1.mobile.putong.feed.data.LocationImage.1
        ...
        public int computeAndCacheSize(LocationImage locationImage) {
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, list, ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            locationImage.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LocationImage parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    locationImage.address = nb5Var.m158750s();
                } else {
                    if (iM158752u != 18) {
                        if (locationImage.address == null) {
                            locationImage.address = "";
                    ...
                    locationImage.coordinates = (List) nb5Var.m158743l(ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return locationImage;
        }
    ...
    public static /* synthetic */ Double m60856a(Double d) {
        return d;
    }
    ...
    public LocationImage mo223809clone() {
        LocationImage locationImage = new LocationImage();
        ...
        if (list != null) {
            locationImage.coordinates = ValueObject.util_map(list, new w9j() { // from class: l.qvv
                ...
                public final Object call(Object obj) {
                    return LocationImage.m60856a((Double) obj);
                }
            });
        }
        return locationImage;
