...
public class FeedUserLiveLabel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FeedUserLiveLabel> PROTOBUF_ADAPTER = new MessageNanoAdapter<FeedUserLiveLabel>() { // from class: com.p1.mobile.putong.feed.data.FeedUserLiveLabel.1
        ...
        public int computeAndCacheSize(FeedUserLiveLabel feedUserLiveLabel) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(7, feedUserLiveLabel.ongoingCall);
            ...
            if (liveMultiCallInfo != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(11, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
            feedUserLiveLabel.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FeedUserLiveLabel parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        feedUserLiveLabel.mainTitle = nb5Var.m158750s();
                        continue;
                    case 18:
                        feedUserLiveLabel.subTitle = nb5Var.m158750s();
                        continue;
                    case 26:
                        feedUserLiveLabel.iconTitle = nb5Var.m158750s();
                        continue;
                    case 34:
                        feedUserLiveLabel.userId = nb5Var.m158750s();
                        continue;
                    case 42:
                        feedUserLiveLabel.buttonTitle = nb5Var.m158750s();
                        continue;
                    case 50:
                        feedUserLiveLabel.liveId = nb5Var.m158750s();
                        continue;
                    case 56:
                        feedUserLiveLabel.ongoingCall = nb5Var.m158738g();
                        continue;
                    case 66:
                        feedUserLiveLabel.liveState = nb5Var.m158750s();
                        continue;
                    case 74:
                        feedUserLiveLabel.anchorId = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        feedUserLiveLabel.voiceRoomTopicId = nb5Var.m158750s();
                        continue;
                    case 90:
                        feedUserLiveLabel.multiCallInfo = (LiveMultiCallInfo) nb5Var.m158743l(LiveMultiCallInfo.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (feedUserLiveLabel.mainTitle == null) {
                            feedUserLiveLabel.mainTitle = "";
        ...
        public void serialize(FeedUserLiveLabel feedUserLiveLabel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(7, feedUserLiveLabel.ongoingCall);
            String str7 = feedUserLiveLabel.liveState;
            if (str7 != null) {
            ...
            LiveMultiCallInfo liveMultiCallInfo = feedUserLiveLabel.multiCallInfo;
            if (liveMultiCallInfo != null) {
                codedOutputByteBufferNano.m17254K(11, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FeedUserLiveLabel mo223809clone() {
        FeedUserLiveLabel feedUserLiveLabel = new FeedUserLiveLabel();
        ...
        if (liveMultiCallInfo != null) {
            feedUserLiveLabel.multiCallInfo = liveMultiCallInfo.mo223809clone();
        }
        return feedUserLiveLabel;
    }
