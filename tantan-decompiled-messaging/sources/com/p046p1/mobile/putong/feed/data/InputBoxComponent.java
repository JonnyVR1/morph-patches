...
public class InputBoxComponent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<InputBoxComponent> PROTOBUF_ADAPTER = new MessageNanoAdapter<InputBoxComponent>() { // from class: com.p1.mobile.putong.feed.data.InputBoxComponent.1
        ...
        public int computeAndCacheSize(InputBoxComponent inputBoxComponent) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(3, inputBoxComponent.editEnable) + CodedOutputByteBufferNano.m17226h(4, inputBoxComponent.maxLines) + CodedOutputByteBufferNano.m17226h(5, inputBoxComponent.maxWordCount);
            inputBoxComponent.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public InputBoxComponent parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    inputBoxComponent.defaultContent = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    inputBoxComponent.hintContent = nb5Var.m158750s();
                } else if (iM158752u == 24) {
                    inputBoxComponent.editEnable = nb5Var.m158738g();
                } else if (iM158752u == 32) {
                    inputBoxComponent.maxLines = nb5Var.m158741j();
                } else {
                    if (iM158752u != 40) {
                        if (inputBoxComponent.defaultContent == null) {
                            inputBoxComponent.defaultContent = "";
                    ...
                    inputBoxComponent.maxWordCount = nb5Var.m158741j();
                }
            }
            return inputBoxComponent;
        }
        ...
        public void serialize(InputBoxComponent inputBoxComponent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(3, inputBoxComponent.editEnable);
            codedOutputByteBufferNano.m17250G(4, inputBoxComponent.maxLines);
            codedOutputByteBufferNano.m17250G(5, inputBoxComponent.maxWordCount);
        }
    };
    ...
    public InputBoxComponent mo223809clone() {
        InputBoxComponent inputBoxComponent = new InputBoxComponent();
