...
public class FeedRestrictLayout extends LinearLayout {
    ...
    public FeedRestrictLayout(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f39938a = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, m9c0.f132706O);
        this.f39938a = typedArrayObtainStyledAttributes.getDimensionPixelSize(m9c0.f132707P, 0);
