...
public class Photo implements Parcelable {
    public static final Parcelable.Creator<Photo> CREATOR = new C11161a();
    ...
    public class C11161a implements Parcelable.Creator<Photo> {
    ...
    public String toString() {
        return "Photo[ id:" + this.f39481id + "  path:" + this.path + "  isOriginal:" + this.isOriginal + "  size:" + this.size + "   tempPath:" + this.tempPath + "   isCheck:" + this.isCheck + "   mimeType:" + this.mimeType + "] isLong longThumbPath";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeLong(this.f39481id);
