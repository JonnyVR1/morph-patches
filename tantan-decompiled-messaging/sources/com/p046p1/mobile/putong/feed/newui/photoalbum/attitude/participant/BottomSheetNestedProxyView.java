...
public class BottomSheetNestedProxyView extends FrameLayout implements r920 {

    /* JADX INFO: renamed from: a */
    public RecyclerView f41431a;
    ...
    public boolean canScrollVertically(int i) {
        RecyclerView recyclerView = this.f41431a;
