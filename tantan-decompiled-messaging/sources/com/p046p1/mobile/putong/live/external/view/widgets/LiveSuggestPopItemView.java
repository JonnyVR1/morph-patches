...
public final class LiveSuggestPopItemView extends ConstraintLayout {
    ...
    public static void m70917h0(LiveSuggestPopItemView liveSuggestPopItemView, View view) {
    ...
    public final TextView get_number() {
        ...
        Intrinsics.m87502r("_number");
        return null;
    }

    /* JADX INFO: renamed from: i0 */
    public final void m70918i0(View view) {
        kau.m145181a(this, view);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m70919j0(boolean isCheck) {
        get_check().setImageResource(isCheck ? h3c0.f105660d : h3c0.f105657c);
    }

    /* JADX INFO: renamed from: k0 */
    public final void m70920k0(@NotNull BLiveAnchors data, boolean isCheck) {
        data.getClass();
        hxs.m133406s("context_square", get_image(), data.avatar.url);
        get_name().setText(data.userName);
        get_number().setText(data.followerCount + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + ((Object) s9s.f163227a.getText(R$string.f44931v)));
        get_check().setImageResource(isCheck ? h3c0.f105660d : h3c0.f105657c);
        xdl0.m208329E0(this, new View.OnClickListener() { // from class: l.jau
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LiveSuggestPopItemView.m70917h0(this.f117120a, view);
            }
        });
    }
