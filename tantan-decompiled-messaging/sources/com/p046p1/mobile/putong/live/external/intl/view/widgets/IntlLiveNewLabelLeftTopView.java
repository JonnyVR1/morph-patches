...
public final class IntlLiveNewLabelLeftTopView extends ConstraintLayout {
    ...
    public final void m70337h0(BLiveCoverLabel data) {
        removeAllViews();
        ...
        this.drawableA = gradientDrawableM213886k;
        VLinear vLinear5 = this.linearLayoutA;
        if (vLinear5 != null) {
            vLinear5.setBackground(gradientDrawableM213886k);
        }
        ...
        if (length > 0) {
            if (vText4 != null) {
                vText4.setTextColor(kvc0.m147358g(data.fontColor));
            }
        } else if (vText4 != null) {
        ...
        str3.getClass();
        if (str3.length() > 0) {
            c0220a.setMarginStart(xdl0.m208407w(3.0f));
        }
        VLinear vLinear7 = this.linearLayoutA;
        if (vLinear7 != null) {
            vLinear7.addView(this.textViewA, c0220a);
        }
        ...
        if (str4.length() > 0) {
            ...
            if (str5.length() > 0) {
                ...
                addView(this.imageViewABackground, new ConstraintLayout.C0220a(0, 0));
                C0222a c0222a = new C0222a();
                c0222a.m1148c(this);
                VLinear vLinear8 = this.linearLayoutA;
                vLinear8.getClass();
                c0222a.m1162r(vLinear8.getId(), 10.0f);
                VDraweeView vDraweeView2 = this.imageViewABackground;
                vDraweeView2.getClass();
                c0222a.m1162r(vDraweeView2.getId(), 6.0f);
                ...
                vLinear9.getClass();
                c0222a.m1150e(id, 6, vLinear9.getId(), 6);
                ...
                vLinear10.getClass();
                c0222a.m1150e(id2, 3, vLinear10.getId(), 3);
                ...
                vLinear11.getClass();
                c0222a.m1150e(id3, 4, vLinear11.getId(), 4);
                ...
                vLinear12.getClass();
                c0222a.m1150e(id4, 7, vLinear12.getId(), 7);
                c0222a.m1146a(this);
                return;
            }
        }
        ...
        if (str6.length() > 0) {
            ...
            addView(this.imageViewABackground, new ConstraintLayout.C0220a(-2, t100.f167266o));
            C0222a c0222a2 = new C0222a();
            c0222a2.m1148c(this);
            VLinear vLinear13 = this.linearLayoutA;
            vLinear13.getClass();
            c0222a2.m1162r(vLinear13.getId(), 10.0f);
            VDraweeView vDraweeView9 = this.imageViewABackground;
            vDraweeView9.getClass();
            c0222a2.m1162r(vDraweeView9.getId(), 6.0f);
            ...
            c0222a2.m1150e(id5, 7, vDraweeView10.getId(), 7);
            c0222a2.m1146a(this);
        }
    }

    /* JADX INFO: renamed from: i0 */
    public final void m70338i0(BLiveCoverLabel data) {
        ...
        vLinear.getClass();
        c0222a.m1151f(id, 7, vLinear.getId(), 7, xdl0.m208407w(6.5f));
        c0222a.m1146a(this);
        ...
        if (str.length() > 0) {
            ...
            if (str2.length() == 0) {
                ...
                if (length > 0) {
                    if (vText3 != null) {
                        vText3.setTextColor(kvc0.m147358g(data.fontColor));
                    }
                } else if (vText3 != null) {
                ...
                if (vText5 != null) {
                    int i = t100.f167260i;
                    int i2 = t100.f167255d;
                    vText5.setPadding(i, i2, t100.f167258g, i2);
                }
                dun dunVar = dun.INSTANCE;
                GradientDrawable gradientDrawableM213886k = yb2.m213886k(dunVar.m113740c(data.background, 0), dunVar.m113740c(data.background, 1), 6, dunVar.m113741d(data.linearGradient));
                this.drawableB = gradientDrawableM213886k;
                VText vText6 = this.textViewB;
                if (vText6 != null) {
                    vText6.setBackground(gradientDrawableM213886k);
                }
        ...
        if (str4.length() > 0) {
            ...
            if (str5.length() > 0) {
                ...
                addView(this.imageViewBBackground, new ConstraintLayout.C0220a(-2, t100.f167266o));
                ...
                if (length2 > 0) {
                    if (vText13 != null) {
                        vText13.setTextColor(kvc0.m147358g(data.fontColor));
                    }
                ...
                if (vText15 != null) {
                    ...
                    vText15.setPadding(i3, i4, t100.f167258g, i4);
                }
                addView(this.textViewB);
                ...
                space5.getClass();
                c0222a3.m1151f(id10, 6, space5.getId(), 7, 0);
                c0222a3.m1146a(this);
                return;
            }
        }
        ...
        vDraweeView10.getClass();
        c0222a4.m1162r(vDraweeView10.getId(), 3.0f);
        ...
        space6.getClass();
        c0222a4.m1150e(id11, 6, space6.getId(), 7);
        c0222a4.m1146a(this);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m70339j0(BLiveCoverLabel data) {
        removeAllViews();
        VDraweeView vDraweeView = new VDraweeView(getContext());
        this.imageViewC = vDraweeView;
        vDraweeView.setAspectRatio(data.bgImageW / data.bgImageH);
        addView(this.imageViewC, new LinearLayout.LayoutParams(-2, t100.f167266o));
    }
    ...
    public final void setAPlateData(@NotNull BLiveCoverLabel data) {
        ...
        if (vDraweeView != null) {
            hxs.m133406s("context_square", vDraweeView, data.icon);
        }
        VDraweeView vDraweeView2 = this.imageViewABackground;
        if (vDraweeView2 != null) {
            hxs.m133406s("context_square", vDraweeView2, data.bgImage);
        }
    }
    ...
    public final void setBPlateData(@NotNull BLiveCoverLabel data) {
        data.getClass();
        m70338i0(data);
        hxs.m133406s("context_square", this.imageViewBBackground, data.bgImage);
    ...
    public final void setCPlateData(@NotNull BLiveCoverLabel data) {
        data.getClass();
        m70339j0(data);
        hxs.m133406s("context_square", this.imageViewC, data.bgImage);
    }
}
