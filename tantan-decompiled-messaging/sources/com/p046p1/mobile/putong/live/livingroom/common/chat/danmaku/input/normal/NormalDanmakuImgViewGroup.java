...
public final class NormalDanmakuImgViewGroup extends RectangleLayout {
    ...
    public NormalDanmakuImgViewGroup(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        context.getClass();
        this.selfHeight = xdl0.m208407w(44.0f);
    ...
    public void onLayout(boolean changed, int left1, int top1, int right1, int bottom1) {
        ...
        int iM208407w2;
        float f4 = 12.0f;
        int iM208407w3 = xdl0.m208407w(12.0f);
        float f5 = 10.0f;
        int iM208407w4 = xdl0.m208407w(10.0f);
        Rect rect = null;
        float f6 = 17.0f;
        if (!this.isAnimMode) {
            ...
            while (i < childCount) {
                ...
                if (childAt instanceof NormalDanmakuListShadowItem) {
                    ...
                    if (z) {
                        ...
                        normalDanmakuListDivideItem.layout(iM208407w3, xdl0.m208407w(17.0f), normalDanmakuListDivideItem.getMeasuredWidth() + iM208407w3, xdl0.m208407w(17.0f) + normalDanmakuListDivideItem.getMeasuredHeight());
                        ...
                        normalDanmakuListFixItem.layout(iM208407w3, iM208407w4, normalDanmakuListFixItem.getMeasuredWidth() + iM208407w3, normalDanmakuListFixItem.getMeasuredHeight() + iM208407w4);
                    } else {
                        if (this.remainWidth > 0) {
                            int measuredWidth = childAt.getMeasuredWidth() + iM208407w3;
                            int i2 = this.tranX;
                            if (measuredWidth - i2 > this.divideLeft) {
                                childAt.layout(iM208407w3 - i2, iM208407w4, (iM208407w3 - i2) + childAt.getMeasuredWidth(), childAt.getMeasuredHeight() + iM208407w4);
                                if (((childAt.getMeasuredWidth() + iM208407w3) - this.tranX) - this.divideLeft < childAt.getMeasuredWidth()) {
                                    this.clipRect.set(childAt.getMeasuredWidth() - (childAt.getMeasuredWidth() + ((iM208407w3 - this.tranX) - this.divideLeft)), 0, childAt.getMeasuredWidth(), childAt.getMeasuredHeight());
                                    childAt.setClipBounds(this.clipRect);
                                } else {
                                    childAt.setClipBounds(null);
                                }
                            } else {
                                childAt.layout(-xdl0.m208407w(500.0f), iM208407w4, (-xdl0.m208407w(500.0f)) + childAt.getMeasuredWidth(), childAt.getMeasuredHeight() + iM208407w4);
                            }
                        } else {
                            childAt.layout(iM208407w3, iM208407w4, childAt.getMeasuredWidth() + iM208407w3, childAt.getMeasuredHeight() + iM208407w4);
                        }
                        iM208407w3 += childAt.getMeasuredWidth();
                        if (!(childAt instanceof NormalDanmakuListFixItem) || (childAt instanceof NormalDanmakuListItem)) {
                            int i3 = i + 1;
                            iM208407w = ((i3 < getChildCount() || !(getChildAt(i3) instanceof NormalDanmakuListDivideItem)) && i != getChildCount() + (-1)) ? xdl0.m208407w(10.0f) : xdl0.m208407w(12.0f);
                        } else if (z) {
                            iM208407w = xdl0.m208407w(12.0f);
                        }
                        iM208407w3 += iM208407w;
                    }
                    iM208407w3 += childAt.getMeasuredWidth();
        ...
        while (i6 < childCount2) {
            ...
            if (childAt2 instanceof NormalDanmakuListShadowItem) {
                ...
                if (z2) {
                    ...
                    f = f4;
                    normalDanmakuListDivideItem2.layout(iM208407w3, xdl0.m208407w(f6), normalDanmakuListDivideItem2.getMeasuredWidth() + iM208407w3, xdl0.m208407w(f6) + normalDanmakuListDivideItem2.getMeasuredHeight());
                    ...
                    if (i9 - f7 >= 0.0f) {
                        ...
                        float f9 = 1.0f - f8;
                        f3 = f6;
                        childAt2.layout(iM208407w3, (int) (iM208407w4 + (this.editHeight * f9)), childAt2.getMeasuredWidth() + iM208407w3, (int) (iM208407w4 + childAt2.getMeasuredHeight() + (this.editHeight * f9)));
                        if (f8 >= 0.5d) {
                        ...
                        f3 = f6;
                        childAt2.layout(iM208407w3, (int) (iM208407w4 + this.editHeight), childAt2.getMeasuredWidth() + iM208407w3, (int) (childAt2.getMeasuredHeight() + iM208407w4 + this.editHeight));
                    }
                }
                iM208407w3 += childAt2.getMeasuredWidth();
                if ((childAt2 instanceof NormalDanmakuListFixItem) || (childAt2 instanceof NormalDanmakuListItem)) {
                    int i10 = i6 + 1;
                    iM208407w2 = (i10 >= getChildCount() || !(getChildAt(i10) instanceof NormalDanmakuListDivideItem)) ? xdl0.m208407w(f2) : xdl0.m208407w(f);
                } else if (z2) {
                    this.fixRight = iM208407w3;
                    iM208407w2 = xdl0.m208407w(f);
                }
                iM208407w3 += iM208407w2;
            }
            i6++;
            f4 = f;
            f5 = f2;
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int iM208407w = xdl0.m208407w(12.0f);
        ...
        while (i < childCount) {
            ...
            if (!(childAt instanceof NormalDanmakuListShadowItem)) {
                iM208407w += childAt.getMeasuredWidth();
                if ((childAt instanceof NormalDanmakuListFixItem) || (childAt instanceof NormalDanmakuListItem)) {
                    int i3 = i + 1;
                    int iM208407w2 = ((i3 >= normalDanmakuImgViewGroup.getChildCount() || !(normalDanmakuImgViewGroup.getChildAt(i3) instanceof NormalDanmakuListDivideItem)) && i != normalDanmakuImgViewGroup.getChildCount() + (-1)) ? xdl0.m208407w(10.0f) : xdl0.m208407w(12.0f);
                    iM208407w += iM208407w2;
                } else if (childAt instanceof NormalDanmakuListDivideItem) {
                    iM208407w += xdl0.m208407w(12.0f);
                    normalDanmakuImgViewGroup.divideLeft = iM208407w;
                }
            }
            i++;
        ...
        normalDanmakuImgViewGroup2.remainWidth = iM208407w - size;
