...
import com.p046p1.mobile.putong.live.base.data.BLiveSharedVoiceLiveInfo;
...
public class LiveMessage {
    ...
    public static LiveMessage create(BLiveTemplate bLiveTemplate, String str) {
        ...
        if (bLiveTemplate != null) {
            ...
            if (i == 2) {
                if (!TextUtils.isEmpty(bLiveTemplate.f44456h5)) {
                    liveMessage.h5Url = bLiveTemplate.f44456h5;
    ...
    public boolean isUserOwnMessage() {
        ...
        if (TextUtils.equals(liveUserInfo.userId, ypv.f199493a.m199309D0())) {
            return true;
        }
        return w220.m201015b() && TextUtils.equals(this.liveUserInfo.userId, w220.m201014a());
    }
    ...
    public LiveMessage setSpan(SpannableStringBuilder spannableStringBuilder) {
        this.spanList = vwb.m200324f0(spannableStringBuilder);
        return this;
    }
