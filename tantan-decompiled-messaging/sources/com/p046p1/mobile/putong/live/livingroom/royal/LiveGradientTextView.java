package com.p046p1.mobile.putong.live.livingroom.royal;
...
public class LiveGradientTextView extends VText {
    ...
    public final Shader m76324l() {
        ...
        int[] iArr = this.f51810i;
        if (iArr == null || iArr.length < 2) {
            return new LinearGradient(f2, 0.0f, f, 0.0f, rfd0.f159138a, rfd0.f159139b, Shader.TileMode.CLAMP);
        }
        int length = iArr.length;
        if (length == 2) {
            int[] iArr2 = this.f51810i;
        ...
        return new LinearGradient(f2, 0.0f, f, 0.0f, this.f51810i, fArr, Shader.TileMode.CLAMP);
    }

    /* JADX INFO: renamed from: o */
    public final boolean m76325o() {
        int[] iArr;
        return (TextUtils.isEmpty(getText()) || (iArr = this.f51810i) == null || iArr.length < 2) ? false : true;
    }
    ...
    public void setUserGradientColors(@Nullable int[] iArr) {
        ...
        if (Arrays.equals(this.f51810i, iArr2)) {
            return;
        }
        this.f51810i = iArr2;
        invalidate();
