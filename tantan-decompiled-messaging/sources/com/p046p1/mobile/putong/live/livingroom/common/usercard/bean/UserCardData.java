package com.p046p1.mobile.putong.live.livingroom.common.usercard.bean;
...
public class UserCardData {
    ...
    public static class Builder {
        ...
        public UserCardData build() {
            if (TextUtils.isEmpty(this.userId) || "0".equals(this.userId)) {
                CrashHelper.m81296c(new Exception("UserCardData userId is null"));
            }
    ...
    public UserCardData(Builder builder) {
        ...
        this.f49394to = builder.f49395to;
