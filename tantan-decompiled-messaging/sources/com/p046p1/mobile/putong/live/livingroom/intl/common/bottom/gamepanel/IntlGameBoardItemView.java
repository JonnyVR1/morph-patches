...
public final class IntlGameBoardItemView extends ConstraintLayout {
    ...
    public final View get_redDot() {
        ...
        Intrinsics.m87502r("_redDot");
        return null;
    }

    /* JADX INFO: renamed from: h0 */
    public final void m75234h0(View view) {
        qgn.m174443a(this, view);
    }

    /* JADX INFO: renamed from: i0 */
    public final void m75235i0(@NotNull BLiveGamePanelButtons data) {
        data.getClass();
        get_redDot().setVisibility(data.enableRedDot ? 0 : 8);
        get_gameName().setText(data.name);
        hxs.m133406s("context_single_room", get_gameIcon(), data.icon);
    }
