...
public final class LiveGenderMedalView extends VLinear {
    ...
    public final void m74888P(View view) {
        hes.m130688a(this, view);
    }

    /* JADX INFO: renamed from: Q */
    public final void m74889Q(@NotNull String gender, int age, boolean isFromRoomBoard) {
        gender.getClass();
        boolean zEquals = TextUtils.equals(gender, "male");
        get_gender().setBackgroundResource(zEquals ? i3c0.f110996ea : i3c0.f110984da);
        get_age().setText(String.valueOf(age));
        setBackgroundResource(zEquals ? i3c0.f111237z : i3c0.f110686E0);
        if (isFromRoomBoard) {
            return;
        }
        xdl0.m208344M(get_root(), !ypv.m215672k().m195802b7());
    }
