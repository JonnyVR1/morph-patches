package com.p046p1.mobile.putong.live.livingroom.increment.gift.consumealert;
...
public final class ConsumeAlertDialog extends ConstraintLayout {
    ...
    public static void m73491h0(ConsumeAlertDialog consumeAlertDialog, DialogInterface dialogInterface) {
        if (consumeAlertDialog.get_alert_check_box().isChecked()) {
            ((bgv) ypv.m215673l(fld0.f98151f)).m101742v(mqi0.m155949t());
        }
    }

    /* JADX INFO: renamed from: i0 */
    public static void m73492i0(DialogC12611a dialogC12611a, View view) {
    ...
    public final VCheckBox get_alert_check_box() {
        ...
        Intrinsics.m87502r("_alert_check_box");
        return null;
    }
    ...
    public final VText get_alert_check_box_text() {
        ...
        Intrinsics.m87502r("_alert_check_box_text");
        return null;
    }
    ...
    public final VImage get_alert_icon() {
        ...
        Intrinsics.m87502r("_alert_icon");
        return null;
    }
    ...
    public final View get_alert_root() {
        ...
        Intrinsics.m87502r("_alert_root");
        return null;
    }
    ...
    public final VText get_alert_sub_title() {
        ...
        Intrinsics.m87502r("_alert_sub_title");
        return null;
    }
    ...
    public final TextView get_alert_title() {
        ...
        Intrinsics.m87502r("_alert_title");
        return null;
    }
    ...
    public final void m73493j0(View view) {
        jz5.m143887a(this, view);
    }

    /* JADX INFO: renamed from: k0 */
    public final void m73494k0(@NotNull final DialogC12611a dialog) {
        dialog.getClass();
        xdl0.m208329E0(get_confirm_button(), new View.OnClickListener() { // from class: l.hz5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ConsumeAlertDialog.m73492i0(dialog, view);
            }
        });
        dialog.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: l.iz5
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
                ConsumeAlertDialog.m73491h0(this.f115530a, dialogInterface);
            }
        });
    }
