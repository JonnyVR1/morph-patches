...
public class LiveDialogEnum {
    ...
    public static final LiveDialogEnum GIFT_SHOW_EXPIRATION_DIALOG = new C126101("GIFT_SHOW_EXPIRATION_DIALOG", 24);
    ...
    public final enum C126101 extends LiveDialogEnum {
        private C126101(String str, int i) {
            super(str, i);
        }

        @Override // com.p046p1.mobile.putong.live.livingroom.archi.dialogcenter.LiveDialogEnum
