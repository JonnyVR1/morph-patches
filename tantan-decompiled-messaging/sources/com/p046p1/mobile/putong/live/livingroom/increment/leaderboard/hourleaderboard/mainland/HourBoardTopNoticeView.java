...
public final class HourBoardTopNoticeView extends ConstraintLayout {
    ...
    public final VMarqueeText get_marqueeText() {
        ...
        Intrinsics.m87502r("_marqueeText");
        return null;
    }
    ...
    public final VImage get_right_icon() {
        ...
        Intrinsics.m87502r("_right_icon");
        return null;
    }
    ...
    public final void m74885h0(View view) {
        thl.m188922a(this, view);
    }

    /* JADX INFO: renamed from: i0 */
    public final boolean m74886i0(@Nullable BLiveHourLeaderBoard leaderBoard) {
        if (leaderBoard != null) {
    ...
    public final boolean m74887j0(@NotNull List<BLiveCurrentHourNotices> noticesList) {
        noticesList.getClass();
        if (vwb.m200296J(noticesList)) {
            xdl0.m208344M(this, false);
            return false;
        }
        xdl0.m208344M(this, true);
