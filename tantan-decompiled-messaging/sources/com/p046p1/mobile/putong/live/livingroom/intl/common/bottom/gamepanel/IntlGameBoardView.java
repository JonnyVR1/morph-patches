...
public final class IntlGameBoardView extends ConstraintLayout {
    ...
    public static void m75236h0(IntlGameBoardView intlGameBoardView) {
        xdl0.m208325C0(intlGameBoardView.get_svga(), intlGameBoardView.get_gameList().getHeight());
    }

    /* JADX INFO: renamed from: i0 */
    public static void m75237i0(DialogC12611a dialogC12611a, View view) {
    ...
    public final LoopViewPagerIndicator get_banner_indicator() {
        ...
        Intrinsics.m87502r("_banner_indicator");
        return null;
    }
    ...
    public final LoopViewPager get_banner_page() {
        ...
        Intrinsics.m87502r("_banner_page");
        return null;
    }
    ...
    public final IntlGameBoardBannerView get_game_banner() {
        ...
        Intrinsics.m87502r("_game_banner");
        return null;
    }
    ...
    public final View get_guide_line() {
        ...
        Intrinsics.m87502r("_guide_line");
        return null;
    }
    ...
    public final VText get_tvGameList() {
        ...
        Intrinsics.m87502r("_tvGameList");
        return null;
    }

    /* JADX INFO: renamed from: j0 */
    public final void m75238j0(View view) {
        ihn.m136266a(this, view);
    }

    /* JADX INFO: renamed from: k0 */
    public final void m75239k0(@NotNull List<? extends hgn> banners, @NotNull Function1<? super hgn, Unit> onBannerClick) {
        banners.getClass();
        onBannerClick.getClass();
        get_game_banner().m75230f(banners, onBannerClick);
    }

    /* JADX INFO: renamed from: l0 */
    public final void m75240l0() {
        get_game_banner().m75233l();
        get_svga().m68505o();
    }

    /* JADX INFO: renamed from: m0 */
    public final void m75241m0(@NotNull List<pgn> items, @NotNull final DialogC12611a dialog) {
        items.getClass();
        dialog.getClass();
        if (items.size() > 12) {
            xdl0.m208325C0(get_gameList(), t100.m186890d(280.0f));
        } else {
        ...
        get_gameList().post(new Runnable() { // from class: l.ghn
            ...
            public final void run() {
                IntlGameBoardView.m75236h0(this.f102671a);
            }
        });
        get_gameList().scrollToPosition(0);
        this.adatper.m67355J().clear();
        this.adatper.m67371Z(items);
        if (!i7n.m134916b()) {
            get_svga().m68500j("https://auto.tancdn.com/v1/raw/dd64c66a-551e-4a3e-8bde-1fac501b9a9411.pdf", -1);
        }
        xdl0.m208329E0(get_backView(), new View.OnClickListener() { // from class: l.hhn
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IntlGameBoardView.m75237i0(dialog, view);
            }
        });
    }
