package com.p046p1.mobile.putong.live.livingroom.voice.membermanager.requestsettlein;
...
public final class MemberRequestSettleInView extends ConstraintLayout {
    ...
    public static final class Companion {
        ...
        public final MemberRequestSettleInView m78659a(@NotNull LayoutInflater inflater) {
            inflater.getClass();
            View viewInflate = inflater.inflate(t6c0.f168203U3, (ViewGroup) null, false);
    ...
    public static final MemberRequestSettleInView m78653i0(@NotNull LayoutInflater layoutInflater) {
        return INSTANCE.m78659a(layoutInflater);
    }
    ...
    public final void m78654h0(View view) {
        xdy.m208480a(this, view);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m78655j0(@NotNull way memberAdapter) {
    ...
    public final void m78656k0(@NotNull way memberAdapter) {
        memberAdapter.getClass();
        m78655j0(memberAdapter);
    }

    /* JADX INFO: renamed from: l0 */
    public final void m78657l0(int position, @NotNull List<? extends BLiveVoiceSettle> newData) {
        newData.getClass();
        xdl0.m208344M(get_empty(), newData.size() <= 1);
        xdl0.m208344M(get_recyclerView(), newData.size() > 1);
        if (get_recyclerView().getAdapter() != null) {
            RecyclerView.Adapter adapter = get_recyclerView().getAdapter();
            adapter.getClass();
            ((way) adapter).m202479H(position, newData);
        }
    }

    /* JADX INFO: renamed from: m0 */
    public final void m78658m0(boolean empty) {
        xdl0.m208344M(get_empty(), empty);
        xdl0.m208344M(get_recyclerView(), !empty);
    }
