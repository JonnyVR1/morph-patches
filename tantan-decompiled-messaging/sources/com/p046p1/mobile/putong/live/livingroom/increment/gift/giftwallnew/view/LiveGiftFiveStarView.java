...
public final class LiveGiftFiveStarView extends ConstraintLayout {
    ...
    public LiveGiftFiveStarView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        context.getClass();
        this.selectRes = kvc0.m147353b(i3c0.f111168t2);
        this.fiveStarSvga = "https://fe-static.tancdn.com/v1/raw/0b380f38-5985-421f-8da0-40cb706c571c12.svga";
        ArrayList<ImageView> arrayListM200324f0 = vwb.m200324f0(new ImageView[0]);
        arrayListM200324f0.getClass();
        this.starList = arrayListM200324f0;
    }
    ...
    public final SVGAnimationView get_five_star_svga() {
        ...
        Intrinsics.m87502r("_five_star_svga");
        return null;
    }
    ...
    public final ImageView get_star_5() {
        ...
        Intrinsics.m87502r("_star_5");
        return null;
    }

    /* JADX INFO: renamed from: h0 */
    public final void m73666h0(View view) {
        hhs.m131148a(this, view);
    }

    /* JADX INFO: renamed from: i0 */
    public final View m73667i0(int i) {
    ...
    public final void m73668j0(int starCount) {
        if (starCount < 0 || starCount >= 5) {
            if (starCount == 5) {
                for (int i = 1; i < 6; i++) {
                    xdl0.m208344M(m73667i0(i), false);
                }
                xdl0.m208344M(get_five_star_svga(), true);
        ...
        xdl0.m208344M(get_five_star_svga(), false);
        for (int i2 = 1; i2 < 6; i2++) {
            xdl0.m208344M(m73667i0(i2), true);
            if (i2 <= starCount) {
                m73667i0(i2).setBackground(this.selectRes);
            } else if (this.unSelectRes == null) {
                xdl0.m208344M(m73667i0(i2), false);
            } else {
                m73667i0(i2).setBackground(this.unSelectRes);
            }
        }
    }

    /* JADX INFO: renamed from: k0 */
    public final void m73669k0(int starCount) {
        int i = 0;
        for (Object obj : this.starList) {
            ...
            ((ViewGroup.MarginLayoutParams) c0220a).width = t100.m186890d(22.0f);
            ((ViewGroup.MarginLayoutParams) c0220a).height = t100.m186890d(22.0f);
            if (i != this.starList.size() - 1) {
                ((ViewGroup.MarginLayoutParams) c0220a).rightMargin = t100.m186890d(4.0f);
            }
            i = i2;
        }
        ViewGroup.LayoutParams layoutParams2 = get_five_star_svga().getLayoutParams();
        layoutParams2.width = t100.m186890d(135.0f);
        layoutParams2.height = t100.f167271t;
        this.selectRes = kvc0.m147353b(i3c0.f111156s2);
        this.unSelectRes = kvc0.m147353b(i3c0.f111038i4);
    ...
    public void onFinishInflate() {
        ...
        m73666h0(this);
        ArrayList<ImageView> arrayListM200324f0 = vwb.m200324f0(get_star_1(), get_star_2(), get_star_3(), get_star_4(), get_star_5());
        arrayListM200324f0.getClass();
        this.starList = arrayListM200324f0;
    }
