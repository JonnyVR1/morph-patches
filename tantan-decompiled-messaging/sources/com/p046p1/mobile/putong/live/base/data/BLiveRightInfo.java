...
public class BLiveRightInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveRightInfo mo223809clone() {
        BLiveRightInfo bLiveRightInfo = new BLiveRightInfo();
        List<BLiveRightItem> list = this.single;
        if (list != null) {
            bLiveRightInfo.single = ValueObject.util_map(list, new w9j() { // from class: l.z42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveRightItem) obj).mo223809clone();
                }
            });
        }
        List<BLiveRightItem> list2 = this.multiple;
        if (list2 != null) {
            bLiveRightInfo.multiple = ValueObject.util_map(list2, new w9j() { // from class: l.a52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveRightItem) obj).mo223809clone();
                }
    ...
    public void setDisplayParam(@Nullable a3d0 a3d0Var) {
        this.displayParam = a3d0Var;
    }
