...
public class BLiveVoiceFanBaseDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceFanBaseDetail mo223809clone() {
        BLiveVoiceFanBaseDetail bLiveVoiceFanBaseDetail = new BLiveVoiceFanBaseDetail();
        ...
        if (list != null) {
            bLiveVoiceFanBaseDetail.tasks = ValueObject.util_map(list, new w9j() { // from class: l.p82
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceFanBaseTask) obj).mo223809clone();
                }
            });
        }
        List<BLiveVoiceFanBaseRight> list2 = this.rights;
        if (list2 != null) {
            bLiveVoiceFanBaseDetail.rights = ValueObject.util_map(list2, new w9j() { // from class: l.q82
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceFanBaseRight) obj).mo223809clone();
                }
            });
        }
