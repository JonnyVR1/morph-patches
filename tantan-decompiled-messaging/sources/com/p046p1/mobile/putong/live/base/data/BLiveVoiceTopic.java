...
public class BLiveVoiceTopic extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVoiceTopic> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceTopic>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceTopic.1
        ...
        public boolean parseField(BLiveVoiceTopic bLiveVoiceTopic, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "titles":
                    ...
                    return true;
                case "id":
                    bLiveVoiceTopic.f44514id = jsonParser.getValueAsString();
                    return false;
                case "icon":
        ...
        public void serializeFields(BLiveVoiceTopic bLiveVoiceTopic, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoiceTopic.f44514id;
            if (str != null) {
    ...
    public static /* synthetic */ String m68446a(String str) {
        return str;
    }
    ...
    public BLiveVoiceTopic mo223809clone() {
        BLiveVoiceTopic bLiveVoiceTopic = new BLiveVoiceTopic();
        bLiveVoiceTopic.f44514id = this.f44514id;
        bLiveVoiceTopic.name = this.name;
        bLiveVoiceTopic.type = this.type;
        bLiveVoiceTopic.icon = this.icon;
        List<String> list = this.titles;
        if (list != null) {
            bLiveVoiceTopic.titles = ValueObject.util_map(list, new w9j() { // from class: l.x92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceTopic.m68446a((String) obj);
                }
            });
        }
        return bLiveVoiceTopic;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44514id, bLiveVoiceTopic.f44514id) && ValueObject.util_equals(this.name, bLiveVoiceTopic.name) && ValueObject.util_equals(this.type, bLiveVoiceTopic.type) && ValueObject.util_equals(this.icon, bLiveVoiceTopic.icon) && ValueObject.util_equals(this.titles, bLiveVoiceTopic.titles);
    }
