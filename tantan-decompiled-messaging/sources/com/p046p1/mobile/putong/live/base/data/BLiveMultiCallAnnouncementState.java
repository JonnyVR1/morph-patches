...
public class BLiveMultiCallAnnouncementState extends TEnum {
    ...
    public class C11841a extends TEnumJsonAdapter<BLiveMultiCallAnnouncementState> {
    ...
    public class C11842b extends TEnumProtobufAdapter<BLiveMultiCallAnnouncementState> {
    ...
    static {
        C11841a c11841a = new C11841a();
        JSON_ADAPTER = c11841a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11842b();
        c11841a.addExtJsonValue("unknown_", -1);
        supportEnum.add("default");
        supportEnum.add("approved");
        supportEnum.add("pending");
        supportEnum.add("canceled");
        supportEnum.add("rejected");
        _BLiveMultiCallAnnouncementState = Collections.synchronizedMap(new e01());
    }
