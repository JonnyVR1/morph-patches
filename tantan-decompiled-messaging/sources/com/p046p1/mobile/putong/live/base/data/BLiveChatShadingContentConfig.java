...
public class BLiveChatShadingContentConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67745a(String str) {
        return str;
    }
    ...
    public BLiveChatShadingContentConfig mo223809clone() {
        BLiveChatShadingContentConfig bLiveChatShadingContentConfig = new BLiveChatShadingContentConfig();
        bLiveChatShadingContentConfig.gradientDirection = this.gradientDirection;
        List<String> list = this.colors;
        if (list != null) {
            bLiveChatShadingContentConfig.colors = ValueObject.util_map(list, new w9j() { // from class: l.ks1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveChatShadingContentConfig.m67745a((String) obj);
                }
            });
        }
