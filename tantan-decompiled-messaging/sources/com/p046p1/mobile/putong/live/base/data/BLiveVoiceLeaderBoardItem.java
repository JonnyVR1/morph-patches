...
public class BLiveVoiceLeaderBoardItem extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceLeaderBoardItem mo223809clone() {
        BLiveVoiceLeaderBoardItem bLiveVoiceLeaderBoardItem = new BLiveVoiceLeaderBoardItem();
        ...
        if (bLiveUserMask != null) {
            bLiveVoiceLeaderBoardItem.anchorMask = bLiveUserMask.mo223809clone();
        }
        ...
        if (list != null) {
            bLiveVoiceLeaderBoardItem.honoredguestList = ValueObject.util_map(list, new w9j() { // from class: l.z82
                @Override // p149l.w9j
        ...
        if (bLiveUserMask2 != null) {
            bLiveVoiceLeaderBoardItem.userMask = bLiveUserMask2.mo223809clone();
        }
