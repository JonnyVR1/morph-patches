...
public class BLiveTraceServerLocation extends TEnum {
    ...
    public static final String f44461PK = "PK";
    ...
    public class C12154a extends TEnumJsonAdapter<BLiveTraceServerLocation> {
    ...
    public class C12155b extends TEnumProtobufAdapter<BLiveTraceServerLocation> {
    ...
    static {
        C12154a c12154a = new C12154a();
        JSON_ADAPTER = c12154a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12155b();
        c12154a.addExtJsonValue("unknown_", -1);
        c12154a.addExtJsonValue("common", 0);
        c12154a.addExtJsonValue(giftbar, 1);
        c12154a.addExtJsonValue(quickgift, 2);
        c12154a.addExtJsonValue(giftguide, 3);
        c12154a.addExtJsonValue("card", 4);
        c12154a.addExtJsonValue(main, 5);
        c12154a.addExtJsonValue(drawer, 6);
        c12154a.addExtJsonValue(f44461PK, 7);
        c12154a.addExtJsonValue("sweetCp", 8);
        ...
        supportEnum.add(f44461PK);
        supportEnum.add("sweetCp");
        supportEnum.add("giftWall");
        supportEnum.add(ktvQuickGift);
        _BLiveTraceServerLocation = Collections.synchronizedMap(new e01());
    }
