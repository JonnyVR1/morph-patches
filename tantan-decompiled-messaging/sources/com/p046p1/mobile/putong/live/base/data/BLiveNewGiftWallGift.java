...
public class BLiveNewGiftWallGift extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveNewGiftWallGift> JSON_ADAPTER = new ObjectJsonAdapter<BLiveNewGiftWallGift>() { // from class: com.p1.mobile.putong.live.base.data.BLiveNewGiftWallGift.1
        ...
        public boolean parseField(BLiveNewGiftWallGift bLiveNewGiftWallGift, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "namedUserId":
                    ...
                    return true;
                case "id":
                    bLiveNewGiftWallGift.f44411id = jsonParser.getValueAsString();
                    return false;
                case "icon":
        ...
        public void serializeFields(BLiveNewGiftWallGift bLiveNewGiftWallGift, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveNewGiftWallGift.f44411id;
            if (str != null) {
    ...
    public static /* synthetic */ String m68085a(String str) {
        return str;
    }
    ...
    public BLiveNewGiftWallGift mo223809clone() {
        BLiveNewGiftWallGift bLiveNewGiftWallGift = new BLiveNewGiftWallGift();
        bLiveNewGiftWallGift.f44411id = this.f44411id;
        ...
        if (list != null) {
            bLiveNewGiftWallGift.contributorUserIds = ValueObject.util_map(list, new w9j() { // from class: l.k32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveNewGiftWallGift.m68085a((String) obj);
                }
            });
        }
        List<BLiveNewGiftWallSkin> list2 = this.skins;
        if (list2 != null) {
            bLiveNewGiftWallGift.skins = ValueObject.util_map(list2, new w9j() { // from class: l.l32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallSkin) obj).mo223809clone();
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44411id, bLiveNewGiftWallGift.f44411id) && ValueObject.util_equals(this.icon, bLiveNewGiftWallGift.icon) && ValueObject.util_equals(this.source, bLiveNewGiftWallGift.source) && ValueObject.util_equals(this.categoryId, bLiveNewGiftWallGift.categoryId) && ValueObject.util_equals(this.namedUserId, bLiveNewGiftWallGift.namedUserId) && this.grade == bLiveNewGiftWallGift.grade && ValueObject.util_equals(this.contributorUserIds, bLiveNewGiftWallGift.contributorUserIds) && ValueObject.util_equals(this.skins, bLiveNewGiftWallGift.skins) && ValueObject.util_equals(this.name, bLiveNewGiftWallGift.name) && ValueObject.util_equals(this.originalId, bLiveNewGiftWallGift.originalId) && this.isSkin == bLiveNewGiftWallGift.isSkin;
    }
