...
public class BLiveSendLiveGiftReq extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveSendLiveGiftReq mo223809clone() {
        BLiveSendLiveGiftReq bLiveSendLiveGiftReq = new BLiveSendLiveGiftReq();
        ...
        if (list != null) {
            bLiveSendLiveGiftReq.giftInfo = ValueObject.util_map(list, new w9j() { // from class: l.g52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveGiftInfo) obj).mo223809clone();
                }
            });
        }
        BLiveGiftExtraInfo bLiveGiftExtraInfo = this.extraInfo;
        if (bLiveGiftExtraInfo != null) {
            bLiveSendLiveGiftReq.extraInfo = bLiveGiftExtraInfo.mo223809clone();
        }
