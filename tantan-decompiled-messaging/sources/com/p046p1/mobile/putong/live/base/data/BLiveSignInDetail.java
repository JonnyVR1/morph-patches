...
public class BLiveSignInDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveSignInDetail mo223809clone() {
        BLiveSignInDetail bLiveSignInDetail = new BLiveSignInDetail();
        ...
        if (list != null) {
            bLiveSignInDetail.unFinishedTasks = ValueObject.util_map(list, new w9j() { // from class: l.v52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSignInTask) obj).mo223809clone();
                }
            });
        }
        List<BLiveSignInTask> list2 = this.unReceivedTasks;
        if (list2 != null) {
            bLiveSignInDetail.unReceivedTasks = ValueObject.util_map(list2, new w9j() { // from class: l.w52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSignInTask) obj).mo223809clone();
                }
        ...
        if (bLiveSignInCycleTask != null) {
            bLiveSignInDetail.cyclicTasks = bLiveSignInCycleTask.mo223809clone();
        }
        return bLiveSignInDetail;
    }
