...
public class BLiveTemplateItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68268a(String str) {
        return str;
    }
    ...
    public BLiveTemplateItem mo223809clone() {
        BLiveTemplateItem bLiveTemplateItem = new BLiveTemplateItem();
        ...
        if (list != null) {
            bLiveTemplateItem.gradientColors = ValueObject.util_map(list, new w9j() { // from class: l.w62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveTemplateItem.m68268a((String) obj);
                }
            });
        }
        return bLiveTemplateItem;
