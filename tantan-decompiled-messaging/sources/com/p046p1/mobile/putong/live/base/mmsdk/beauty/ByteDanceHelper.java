package com.p046p1.mobile.putong.live.base.mmsdk.beauty;
...
public class ByteDanceHelper {
    ...
    public static Pair<String, String> m68506a(int i) {
        switch (i) {
            case 1:
    ...
    public static Pair<String, String> m68507b(int i, int i2) {
        if (i == 1) {
            return m68506a(i2);
        }
        if (i == 2) {
        ...
        return new Pair<>("MakeupStyle_" + m68509d(i2), null);
    }

    /* JADX INFO: renamed from: c */
    public static Pair<String, String> m68508c(int i) {
        return null;
    }

    /* JADX INFO: renamed from: d */
    public static String m68509d(int i) {
        switch (i) {
            case 1:
                return "QS";
            case 2:
    ...
    public static void m68510e(f4m f4mVar) {
        if (f4mVar != null) {
            f4mVar.removeMakeupStyle("Makeup_ALL", "Filter_ALL");
        }
    }

    /* JADX INFO: renamed from: f */
    public static void m68511f(f4m f4mVar, int i, float f) {
        Pair<String, String> pairM68507b = m68507b(1, i);
        if (pairM68507b == null || f4mVar == null) {
            return;
        }
        if (TextUtils.equals((CharSequence) pairM68507b.second, "whiten")) {
            f *= 0.6f;
        }
        f4mVar.mo68563e0((String) pairM68507b.first, (String) pairM68507b.second, f);
    }

    /* JADX INFO: renamed from: g */
    public static void m68512g(f4m f4mVar, int i, MakeupStyleType makeupStyleType, float f) {
        Pair<String, String> pairM68507b = m68507b(3, i);
        if (pairM68507b == null || f4mVar == null) {
            return;
        }
        if (makeupStyleType == MakeupStyleType.FILTER) {
            f4mVar.updateMakeupStyleValue((String) pairM68507b.first, "Filter_ALL", f);
        } else if (makeupStyleType == MakeupStyleType.MAKEUP) {
            f4mVar.updateMakeupStyleValue((String) pairM68507b.first, "Makeup_ALL", f);
        }
    }
}
