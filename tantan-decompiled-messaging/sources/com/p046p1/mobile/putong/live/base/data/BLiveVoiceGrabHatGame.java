...
public class BLiveVoiceGrabHatGame extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVoiceGrabHatGame> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceGrabHatGame>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceGrabHatGame.1
        ...
        public boolean parseField(BLiveVoiceGrabHatGame bLiveVoiceGrabHatGame, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    bLiveVoiceGrabHatGame.f44500id = jsonParser.getValueAsString();
                    return false;
                case "callHatInfo":
        ...
        public void serializeFields(BLiveVoiceGrabHatGame bLiveVoiceGrabHatGame, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoiceGrabHatGame.f44500id;
            if (str != null) {
    ...
    public BLiveVoiceGrabHatGame mo223809clone() {
        BLiveVoiceGrabHatGame bLiveVoiceGrabHatGame = new BLiveVoiceGrabHatGame();
        bLiveVoiceGrabHatGame.f44500id = this.f44500id;
        ...
        if (list != null) {
            bLiveVoiceGrabHatGame.callHatInfo = ValueObject.util_map(list, new w9j() { // from class: l.x82
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceCallHatInfo) obj).mo223809clone();
                }
            });
        }
        return bLiveVoiceGrabHatGame;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44500id, bLiveVoiceGrabHatGame.f44500id) && ValueObject.util_equals(this.status, bLiveVoiceGrabHatGame.status) && ValueObject.util_equals(this.liveId, bLiveVoiceGrabHatGame.liveId) && ValueObject.util_equals(this.callHatInfo, bLiveVoiceGrabHatGame.callHatInfo);
    }
