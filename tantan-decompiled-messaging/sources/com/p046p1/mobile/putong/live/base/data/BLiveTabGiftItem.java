...
public class BLiveTabGiftItem extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveTabGiftItem mo223809clone() {
        BLiveTabGiftItem bLiveTabGiftItem = new BLiveTabGiftItem();
        bLiveTabGiftItem.tabName = this.tabName;
        List<BLiveGiftItemShort> list = this.tabGiftItems;
        if (list != null) {
            bLiveTabGiftItem.tabGiftItems = ValueObject.util_map(list, new w9j() { // from class: l.p62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveGiftItemShort) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveTabGiftItem.entrances = ValueObject.util_map(list2, new w9j() { // from class: l.q62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveGiftTabEntrance) obj).mo223809clone();
                }
            });
        }
        BLiveTabEntrance bLiveTabEntrance = this.tabEntrance;
        if (bLiveTabEntrance != null) {
            bLiveTabGiftItem.tabEntrance = bLiveTabEntrance.mo223809clone();
        }
        return bLiveTabGiftItem;
    }
