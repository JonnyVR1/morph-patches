...
public class BLiveVoiceRankingType extends TEnum {
    ...
    public class C12360a extends TEnumJsonAdapter<BLiveVoiceRankingType> {
    ...
    public class C12361b extends TEnumProtobufAdapter<BLiveVoiceRankingType> {
    ...
    static {
        C12360a c12360a = new C12360a();
        JSON_ADAPTER = c12360a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12361b();
        c12360a.addExtJsonValue("unknown_", -1);
        supportEnum.add(currentHour);
        supportEnum.add(lastHour);
        _BLiveVoiceRankingType = Collections.synchronizedMap(new e01());
    }
