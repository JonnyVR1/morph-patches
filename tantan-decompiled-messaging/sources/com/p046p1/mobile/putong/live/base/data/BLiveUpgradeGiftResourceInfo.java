...
public class BLiveUpgradeGiftResourceInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveUpgradeGiftResourceInfo mo223809clone() {
        BLiveUpgradeGiftResourceInfo bLiveUpgradeGiftResourceInfo = new BLiveUpgradeGiftResourceInfo();
        ...
        if (list != null) {
            bLiveUpgradeGiftResourceInfo.cardBgUrls = ValueObject.util_map(list, new w9j() { // from class: l.l72
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveUpgradeGiftStatusItem) obj).mo223809clone();
                }
            });
        }
        List<BLiveUpgradeGiftStatusItem> list2 = this.buttonPics;
        if (list2 != null) {
            bLiveUpgradeGiftResourceInfo.buttonPics = ValueObject.util_map(list2, new w9j() { // from class: l.m72
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveUpgradeGiftStatusItem) obj).mo223809clone();
                }
