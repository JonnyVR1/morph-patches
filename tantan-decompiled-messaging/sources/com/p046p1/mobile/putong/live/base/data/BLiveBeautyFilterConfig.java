...
public class BLiveBeautyFilterConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveBeautyFilterConfig mo223809clone() {
        BLiveBeautyFilterConfig bLiveBeautyFilterConfig = new BLiveBeautyFilterConfig();
        ...
        if (list != null) {
            bLiveBeautyFilterConfig.beautyConfig = ValueObject.util_map(list, new w9j() { // from class: l.mr1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveBeautyItem) obj).mo223809clone();
                }
            });
        }
        List<BLiveBeautyItem> list2 = this.makeUpConfig;
        if (list2 != null) {
            bLiveBeautyFilterConfig.makeUpConfig = ValueObject.util_map(list2, new w9j() { // from class: l.nr1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveBeautyItem) obj).mo223809clone();
                }
        ...
        if (list3 != null) {
            bLiveBeautyFilterConfig.filterConfig = ValueObject.util_map(list3, new w9j() { // from class: l.or1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveFilterItem) obj).mo223809clone();
                }
            });
        }
