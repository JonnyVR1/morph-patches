...
public class BLiveDailyPayment extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m67764a(Integer num) {
        return num;
    }
    ...
    public BLiveDailyPayment mo223809clone() {
        BLiveDailyPayment bLiveDailyPayment = new BLiveDailyPayment();
        ...
        if (list != null) {
            bLiveDailyPayment.defaultAmounts = ValueObject.util_map(list, new w9j() { // from class: l.us1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveDailyPayment.m67764a((Integer) obj);
                }
            });
        }
        return bLiveDailyPayment;
