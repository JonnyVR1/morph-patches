...
public class BLiveDynamicEffectExtend extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67926a(String str) {
        return str;
    }
    ...
    public BLiveDynamicEffectExtend mo223809clone() {
        BLiveDynamicEffectExtend bLiveDynamicEffectExtend = new BLiveDynamicEffectExtend();
        bLiveDynamicEffectExtend.key = this.key;
        List<String> list = this.value;
        if (list != null) {
            bLiveDynamicEffectExtend.value = ValueObject.util_map(list, new w9j() { // from class: l.xy1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveDynamicEffectExtend.m67926a((String) obj);
                }
            });
        }
        return bLiveDynamicEffectExtend;
