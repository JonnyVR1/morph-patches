...
public class LiveAvatarNumberView extends FrameLayout {
    ...
    public LiveAvatarNumberView(@NonNull Context context) {
        super(context);
    ...
    public final void m67440b(FrameLayout frameLayout, int i, List<String> list) {
    ...
    public void setImageData(List<String> list) {
        vwb.m200354z(this.list, new e30() { // from class: l.sur
            @Override // p149l.e30
        ...
        for (int i = 4; i > 0; i--) {
            if (i <= this.images.size()) {
                m67440b(this.list.get(i - 1), i, this.images);
            }
        }
        m67441c();
    }
    ...
    public LiveAvatarNumberView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        this.images = new ArrayList();
        this.list = new ArrayList();
    }

    public LiveAvatarNumberView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
