...
public class BLiveRtcToken extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveRtcToken> JSON_ADAPTER = new ObjectJsonAdapter<BLiveRtcToken>() { // from class: com.p1.mobile.putong.live.base.data.BLiveRtcToken.1
        ...
        public boolean parseField(BLiveRtcToken bLiveRtcToken, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userSig":
                    ...
                    return true;
                case "id":
                    bLiveRtcToken.f44433id = jsonParser.getValueAsString();
                    return false;
                case "appId":
        ...
        public void serializeFields(BLiveRtcToken bLiveRtcToken, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveRtcToken.f44433id;
            if (str != null) {
    ...
    public BLiveRtcToken mo223809clone() {
        BLiveRtcToken bLiveRtcToken = new BLiveRtcToken();
        bLiveRtcToken.f44433id = this.f44433id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44433id, bLiveRtcToken.f44433id) && ValueObject.util_equals(this.appId, bLiveRtcToken.appId) && ValueObject.util_equals(this.channel, bLiveRtcToken.channel) && ValueObject.util_equals(this.channelKey, bLiveRtcToken.channelKey) && ValueObject.util_equals(this.rtcProvider, bLiveRtcToken.rtcProvider) && ValueObject.util_equals(this.userSig, bLiveRtcToken.userSig) && this.canMaintain == bLiveRtcToken.canMaintain && ValueObject.util_equals(this.reverbAppKey, bLiveRtcToken.reverbAppKey) && ValueObject.util_equals(this.reverbToken, bLiveRtcToken.reverbToken);
    }
