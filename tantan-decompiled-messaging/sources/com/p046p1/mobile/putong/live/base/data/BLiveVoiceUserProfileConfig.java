...
public class BLiveVoiceUserProfileConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68450a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m68452c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m68453d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m68454e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: l */
    public static /* synthetic */ String m68457l(String str) {
        return str;
    }

    /* JADX INFO: renamed from: m */
    public static /* synthetic */ String m68458m(String str) {
        return str;
    }
    ...
    public BLiveVoiceUserProfileConfig mo223809clone() {
        BLiveVoiceUserProfileConfig bLiveVoiceUserProfileConfig = new BLiveVoiceUserProfileConfig();
        ...
        if (list != null) {
            bLiveVoiceUserProfileConfig.bottomButtons = ValueObject.util_map(list, new w9j() { // from class: l.ba2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileConfig.m68457l((String) obj);
                }
            });
        }
        List<String> list2 = this.middleButtons;
        if (list2 != null) {
            bLiveVoiceUserProfileConfig.middleButtons = ValueObject.util_map(list2, new w9j() { // from class: l.ca2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileConfig.m68453d((String) obj);
                }
            });
        }
        List<String> list3 = this.manageButtons;
        if (list3 != null) {
            bLiveVoiceUserProfileConfig.manageButtons = ValueObject.util_map(list3, new w9j() { // from class: l.da2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileConfig.m68454e((String) obj);
                }
            });
        }
        List<BLiveUserProfileConfigHierarchy> list4 = this.hierarchy;
        if (list4 != null) {
            bLiveVoiceUserProfileConfig.hierarchy = ValueObject.util_map(list4, new w9j() { // from class: l.ea2
                @Override // p149l.w9j
                public final Object call(Object obj) {
        ...
        if (list5 != null) {
            bLiveVoiceUserProfileConfig.banners = ValueObject.util_map(list5, new w9j() { // from class: l.fa2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceUserProfileBanners) obj).mo223809clone();
                }
            });
        }
        ...
        if (list6 != null) {
            bLiveVoiceUserProfileConfig.middleCards = ValueObject.util_map(list6, new w9j() { // from class: l.ga2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceUserProfileMiddleCards) obj).mo223809clone();
                }
            });
        }
        ...
        if (list7 != null) {
            bLiveVoiceUserProfileConfig.giftShowCaseItemIds = ValueObject.util_map(list7, new w9j() { // from class: l.ha2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileConfig.m68452c((String) obj);
                }
            });
        }
        BLiveVirtualVoiceSweetCpCard bLiveVirtualVoiceSweetCpCard = this.sweetCpCard;
        if (bLiveVirtualVoiceSweetCpCard != null) {
            bLiveVoiceUserProfileConfig.sweetCpCard = bLiveVirtualVoiceSweetCpCard.mo223809clone();
        }
        bLiveVoiceUserProfileConfig.identity = this.identity;
        List<String> list8 = this.moreButtons;
        if (list8 != null) {
            bLiveVoiceUserProfileConfig.moreButtons = ValueObject.util_map(list8, new w9j() { // from class: l.ia2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileConfig.m68450a((String) obj);
                }
            });
        }
        ...
        if (bLivePayGuideInfo != null) {
            bLiveVoiceUserProfileConfig.payGuideInfo = bLivePayGuideInfo.mo223809clone();
        }
        BLivePayGuideConfig bLivePayGuideConfig = this.payGuideConfig;
        if (bLivePayGuideConfig != null) {
            bLiveVoiceUserProfileConfig.payGuideConfig = bLivePayGuideConfig.mo223809clone();
        }
        ...
        if (list9 != null) {
            bLiveVoiceUserProfileConfig.specialFriendRelations = ValueObject.util_map(list9, new w9j() { // from class: l.ja2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSpecialFriendRelation) obj).mo223809clone();
                }
            });
        }
        BLiveUserFamilyCard bLiveUserFamilyCard = this.familyCard;
        if (bLiveUserFamilyCard != null) {
            bLiveVoiceUserProfileConfig.familyCard = bLiveUserFamilyCard.mo223809clone();
        }
        bLiveVoiceUserProfileConfig.guildId = this.guildId;
        BLiveBoardGuard bLiveBoardGuard = this.guard;
        if (bLiveBoardGuard != null) {
            bLiveVoiceUserProfileConfig.guard = bLiveBoardGuard.mo223809clone();
        }
        List<String> list10 = this.userNameGradientColors;
        if (list10 != null) {
            bLiveVoiceUserProfileConfig.userNameGradientColors = ValueObject.util_map(list10, new w9j() { // from class: l.ka2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileConfig.m68458m((String) obj);
                }
            });
        }
        return bLiveVoiceUserProfileConfig;
