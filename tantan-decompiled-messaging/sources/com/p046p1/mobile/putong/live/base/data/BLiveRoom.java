...
public class BLiveRoom extends BLiveAbsRoom implements Cloneable, Serializable {
        ...
        public boolean parseField(BLiveRoom bLiveRoom, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "liveStickerIds":
                    ...
                    return true;
                case "id":
                    bLiveRoom.f44324id = jsonParser.getValueAsString();
                    return false;
                case "sign":
    ...
    public static /* synthetic */ String m68200a(String str) {
        return str;
    }
    ...
    public BLiveRoom mo223809clone() {
        BLiveRoom bLiveRoom = new BLiveRoom();
        bLiveRoom.f44324id = this.f44324id;
        BLiveOwner bLiveOwner = this.owner;
        if (bLiveOwner != null) {
            bLiveRoom.owner = bLiveOwner.mo223809clone();
        }
        bLiveRoom.title = this.title;
        BLiveRoomCover bLiveRoomCover = this.cover;
        if (bLiveRoomCover != null) {
            bLiveRoom.cover = bLiveRoomCover.mo223809clone();
        }
        bLiveRoom.type = this.type;
        List<String> list = this.liveStickerIds;
        if (list != null) {
            bLiveRoom.liveStickerIds = ValueObject.util_map(list, new w9j() { // from class: l.b52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveRoom.m68200a((String) obj);
                }
            });
        }
        BLiveCallSwitch bLiveCallSwitch = this.callSwitch;
        if (bLiveCallSwitch != null) {
            bLiveRoom.callSwitch = bLiveCallSwitch.mo223809clone();
        }
