...
public class BLiveJsDialogConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public f30<String, String> callJs;
    ...
    public BLiveJsDialogConfig mo223809clone() {
        BLiveJsDialogConfig bLiveJsDialogConfig = new BLiveJsDialogConfig();
        ...
        if (list != null) {
            bLiveJsDialogConfig.types = ValueObject.util_map(list, new w9j() { // from class: l.t12
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveJsDialogItemType) obj).mo223809clone();
                }
            });
        }
        return bLiveJsDialogConfig;
