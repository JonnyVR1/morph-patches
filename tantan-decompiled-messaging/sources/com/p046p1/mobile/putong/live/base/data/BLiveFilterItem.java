...
public class BLiveFilterItem extends ValueObject implements Cloneable, Serializable {
    ...
    public String type;
    public static ProtobufAdapter<BLiveFilterItem> PROTOBUF_ADAPTER = new C11651a();
    public static JsonAdapter<BLiveFilterItem> JSON_ADAPTER = new ObjectJsonAdapter<BLiveFilterItem>() { // from class: com.p1.mobile.putong.live.base.data.BLiveFilterItem.2
        ...
        public boolean parseField(BLiveFilterItem bLiveFilterItem, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "resource":
                    ...
                    return true;
                case "id":
                    bLiveFilterItem.f44368id = jsonParser.getValueAsString();
                    return false;
                case "icon":
        ...
        public void serializeFields(BLiveFilterItem bLiveFilterItem, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveFilterItem.f44368id;
            if (str != null) {
    ...
    public class C11651a extends MessageNanoAdapter<BLiveFilterItem> {
        public C11651a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveFilterItem bLiveFilterItem) {
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(6, bLiveFilterItem.defaultValue) + CodedOutputByteBufferNano.m17220b(7, bLiveFilterItem.isSuggested);
            bLiveFilterItem.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveFilterItem parse(nb5 nb5Var) throws IOException {
            BLiveFilterItem bLiveFilterItem = new BLiveFilterItem();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (bLiveFilterItem.f44368id == null) {
                        bLiveFilterItem.f44368id = "";
                    }
                ...
                if (iM158752u == 10) {
                    bLiveFilterItem.f44368id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    bLiveFilterItem.name = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    bLiveFilterItem.icon = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    bLiveFilterItem.resource = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    bLiveFilterItem.type = nb5Var.m158750s();
                } else if (iM158752u == 48) {
                    bLiveFilterItem.defaultValue = nb5Var.m158741j();
                } else {
                    if (iM158752u != 56) {
                        if (bLiveFilterItem.f44368id == null) {
                            bLiveFilterItem.f44368id = "";
                    ...
                    bLiveFilterItem.isSuggested = nb5Var.m158738g();
                }
            }
            return bLiveFilterItem;
        }
        ...
        public void serialize(BLiveFilterItem bLiveFilterItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(6, bLiveFilterItem.defaultValue);
            codedOutputByteBufferNano.m17244A(7, bLiveFilterItem.isSuggested);
        }
    }
    ...
    public BLiveFilterItem mo223809clone() {
        BLiveFilterItem bLiveFilterItem = new BLiveFilterItem();
        bLiveFilterItem.f44368id = this.f44368id;
