...
public class BLiveCloseAlertType extends TEnum {
    ...
    public class C11574a extends TEnumJsonAdapter<BLiveCloseAlertType> {
    ...
    public class C11575b extends TEnumProtobufAdapter<BLiveCloseAlertType> {
    ...
    static {
        ...
        JSON_ADAPTER = c11574a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11575b();
        c11574a.addExtJsonValue("unknown_", -1);
        c11574a.addExtJsonValue(withJump, 0);
        c11574a.addExtJsonValue(tipOnly, 1);
        supportEnum.add(withJump);
        supportEnum.add(tipOnly);
        _BLiveCloseAlertType = Collections.synchronizedMap(new e01());
    }
