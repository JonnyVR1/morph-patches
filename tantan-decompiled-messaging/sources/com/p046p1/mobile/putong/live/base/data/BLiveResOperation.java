...
public class BLiveResOperation extends TEnum {
    ...
    public class C12011a extends TEnumJsonAdapter<BLiveResOperation> {
    ...
    public class C12012b extends TEnumProtobufAdapter<BLiveResOperation> {
    ...
    static {
        C12011a c12011a = new C12011a();
        JSON_ADAPTER = c12011a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12012b();
        c12011a.addExtJsonValue("unknown_", -1);
        c12011a.addExtJsonValue(clear, 0);
        c12011a.addExtJsonValue("add", 1);
        supportEnum.add(clear);
        supportEnum.add("add");
        _BLiveResOperation = Collections.synchronizedMap(new e01());
    }
