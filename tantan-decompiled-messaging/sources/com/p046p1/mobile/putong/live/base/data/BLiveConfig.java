...
public class BLiveConfig extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveConfig> JSON_ADAPTER = new ObjectJsonAdapter<BLiveConfig>() { // from class: com.p1.mobile.putong.live.base.data.BLiveConfig.1
        ...
        public boolean parseField(BLiveConfig bLiveConfig, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 32:
                    ...
                    return true;
                case 33:
                    bLiveConfig.f44352pk = BLivePkSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 34:
        ...
        public void serializeFields(BLiveConfig bLiveConfig, JsonGenerator jsonGenerator) throws IOException {
            ...
            if (bLiveConfig.f44352pk != null) {
                jsonGenerator.writeFieldName("pk");
                BLivePkSetting.JSON_ADAPTER.serialize(bLiveConfig.f44352pk, jsonGenerator, true);
            }
    ...
    public BLivePkSetting f44352pk;
    ...
    public static /* synthetic */ Integer m67758a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m67759b(String str) {
        return str;
    }
    ...
    public BLiveConfig mo223809clone() {
        ...
        if (bLiveSmallWindow != null) {
            bLiveConfig.smallWindow = bLiveSmallWindow.mo223809clone();
        }
        BLiveFollowGuide bLiveFollowGuide = this.followGuide;
        if (bLiveFollowGuide != null) {
            bLiveConfig.followGuide = bLiveFollowGuide.mo223809clone();
        }
        List<Integer> list = this.managerRights;
        if (list != null) {
            bLiveConfig.managerRights = ValueObject.util_map(list, new w9j() { // from class: l.os1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveConfig.m67758a((Integer) obj);
                }
            });
        }
        BLiveFollowSetting bLiveFollowSetting = this.followSetting;
        if (bLiveFollowSetting != null) {
            bLiveConfig.followSetting = bLiveFollowSetting.mo223809clone();
        }
        ...
        if (bLiveUserLevelSwitch != null) {
            bLiveConfig.liveHierarchy = bLiveUserLevelSwitch.mo223809clone();
        }
        ...
        if (bLiveTeenMode != null) {
            bLiveConfig.teenMode = bLiveTeenMode.mo223809clone();
        }
        BLiveVideoQuality bLiveVideoQuality = this.videoQuality;
        if (bLiveVideoQuality != null) {
            bLiveConfig.videoQuality = bLiveVideoQuality.mo223809clone();
        }
        ...
        if (bLiveActivitySummaryRegularUnread != null) {
            bLiveConfig.activitySummaryRegularUnread = bLiveActivitySummaryRegularUnread.mo223809clone();
        }
        BLiveScrollGuide bLiveScrollGuide = this.roomSlide;
        if (bLiveScrollGuide != null) {
            bLiveConfig.roomSlide = bLiveScrollGuide.mo223809clone();
        }
        BLiveFollowRateConfigV2 bLiveFollowRateConfigV2 = this.followRateConfigV2;
        if (bLiveFollowRateConfigV2 != null) {
            bLiveConfig.followRateConfigV2 = bLiveFollowRateConfigV2.mo223809clone();
        }
        ...
        if (bLiveStartBtnConfig != null) {
            bLiveConfig.toStartLiveConfig = bLiveStartBtnConfig.mo223809clone();
        }
        ...
        if (bLiveCommonConfig5 != null) {
            bLiveConfig.roomAnnouncement = bLiveCommonConfig5.mo223809clone();
        }
        List<String> list2 = this.inAppPushHideConfig;
        if (list2 != null) {
            bLiveConfig.inAppPushHideConfig = ValueObject.util_map(list2, new w9j() { // from class: l.ps1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveConfig.m67759b((String) obj);
                }
            });
        }
        BLiveBlackListConfig bLiveBlackListConfig = this.blackListConfig;
        if (bLiveBlackListConfig != null) {
            bLiveConfig.blackListConfig = bLiveBlackListConfig.mo223809clone();
        }
    ...
    public void nullCheck() {
        ...
        if (this.f44352pk == null) {
            this.f44352pk = BLivePkSetting.new_();
        }
        if (this.call == null) {
