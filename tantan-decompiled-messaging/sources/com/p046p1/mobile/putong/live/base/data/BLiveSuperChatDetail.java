...
public class BLiveSuperChatDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveSuperChatDetail mo223809clone() {
        BLiveSuperChatDetail bLiveSuperChatDetail = new BLiveSuperChatDetail();
        ...
        if (list != null) {
            bLiveSuperChatDetail.templates = ValueObject.util_map(list, new w9j() { // from class: l.m62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveGuardTopChatTemplateItem) obj).mo223809clone();
                }
            });
        }
        return bLiveSuperChatDetail;
