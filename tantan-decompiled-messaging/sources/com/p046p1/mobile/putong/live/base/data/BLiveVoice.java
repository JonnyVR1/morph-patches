...
public class BLiveVoice extends BLiveAbsData implements Cloneable, Serializable {
    ...
    public static JsonAdapter<BLiveVoice> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoice>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoice.1
        ...
        public boolean parseField(BLiveVoice bLiveVoice, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 15:
                    ...
                    return true;
                case 16:
                    bLiveVoice.f44323id = jsonParser.getValueAsString();
                    return false;
                case 17:
        ...
        public void serializeFields(BLiveVoice bLiveVoice, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoice.f44323id;
            if (str != null) {
    ...
    public BLiveVoice mo223809clone() {
        BLiveVoice bLiveVoice = new BLiveVoice();
        bLiveVoice.f44323id = this.f44323id;
        BLiveOwner bLiveOwner = this.room;
        if (bLiveOwner != null) {
            bLiveVoice.room = bLiveOwner.mo223809clone();
        }
        BLiveOwner bLiveOwner2 = this.anchor;
        if (bLiveOwner2 != null) {
            bLiveVoice.anchor = bLiveOwner2.mo223809clone();
        }
        BLiveRecommendInfo bLiveRecommendInfo = this.recommendInfo;
        if (bLiveRecommendInfo != null) {
            bLiveVoice.recommendInfo = bLiveRecommendInfo.mo223809clone();
        }
        bLiveVoice.state = this.state;
        List<BLiveSuggestLabel> list = this.basicLabels;
        if (list != null) {
            bLiveVoice.basicLabels = ValueObject.util_map(list, new w9j() { // from class: l.w72
                @Override // p149l.w9j
        ...
        if (media != null) {
            bLiveVoice.videoCapture = media.mo223809clone();
        }
        ...
        if (bLiveStreamCdnInfo != null) {
            bLiveVoice.streamCdnInfo = bLiveStreamCdnInfo.mo223809clone();
        }
        BLiveStreamUrl bLiveStreamUrl = this.streamUrl;
        if (bLiveStreamUrl != null) {
            bLiveVoice.streamUrl = bLiveStreamUrl.mo223809clone();
        }
        ...
        if (list2 != null) {
            bLiveVoice.specialLabels = ValueObject.util_map(list2, new w9j() { // from class: l.x72
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSuggestLabel) obj).mo223809clone();
                }
        ...
        if (bLiveVoiceCallInfo != null) {
            bLiveVoice.callInfo = bLiveVoiceCallInfo.mo223809clone();
        }
        ...
        if (voiceLiveExtension != null) {
            bLiveVoice.extension = voiceLiveExtension.mo223809clone();
        }
        List<BLiveCommonViewConfig> list3 = this.tags;
        if (list3 != null) {
            bLiveVoice.tags = ValueObject.util_map(list3, new w9j() { // from class: l.y72
                @Override // p149l.w9j
                public final Object call(Object obj) {
    ...
    public BLiveVoice update(BLiveAbsData bLiveAbsData) {
        ...
        if (bLiveStreamCdnInfo != null) {
            this.streamCdnInfo = bLiveStreamCdnInfo.mo223809clone();
        }
        BLiveStreamUrl bLiveStreamUrl = bLiveAbsData.streamUrl;
        if (bLiveStreamUrl != null) {
            this.streamUrl = bLiveStreamUrl.mo223809clone();
        }
