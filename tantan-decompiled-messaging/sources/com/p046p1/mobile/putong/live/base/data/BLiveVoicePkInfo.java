...
public class BLiveVoicePkInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BLiveVoicePkInfo> PROTOBUF_ADAPTER = new C12346a();
    ...
    public class C12346a extends MessageNanoAdapter<BLiveVoicePkInfo> {
        public C12346a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveVoicePkInfo bLiveVoicePkInfo) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, bLiveVoicePkInfo.enable);
            String str = bLiveVoicePkInfo.pkId;
            if (str != null) {
            ...
            if (str7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(8, str7);
            }
            String str8 = bLiveVoicePkInfo.schema;
            if (str8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(9, str8);
            }
            int iM17228j = iM17220b + CodedOutputByteBufferNano.m17228j(10, bLiveVoicePkInfo.endMill);
            String str9 = bLiveVoicePkInfo.mvpBg;
            if (str9 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(11, str9);
            }
            List<BLiveVoicePkPoint> list = bLiveVoicePkInfo.onCallPoints;
            if (list != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(12, list, BLiveVoicePkPoint.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str10 = bLiveVoicePkInfo.leftBigUrl;
            if (str10 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(13, str10);
            }
            String str11 = bLiveVoicePkInfo.rightBigUrl;
            if (str11 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(14, str11);
            }
            bLiveVoicePkInfo.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveVoicePkInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        bLiveVoicePkInfo.enable = nb5Var.m158738g();
                        continue;
                    case 18:
                        bLiveVoicePkInfo.pkId = nb5Var.m158750s();
                        continue;
                    case 26:
                        bLiveVoicePkInfo.leftUserAvatar = nb5Var.m158750s();
                        continue;
                    case 34:
                        bLiveVoicePkInfo.leftUserId = nb5Var.m158750s();
                        continue;
                    case 42:
                        bLiveVoicePkInfo.rightUserAvatar = nb5Var.m158750s();
                        continue;
                    case 50:
                        bLiveVoicePkInfo.rightUserId = nb5Var.m158750s();
                        continue;
                    case 58:
                        bLiveVoicePkInfo.leftUrl = nb5Var.m158750s();
                        continue;
                    case 66:
                        bLiveVoicePkInfo.rightUrl = nb5Var.m158750s();
                        continue;
                    case 74:
                        bLiveVoicePkInfo.schema = nb5Var.m158750s();
                        continue;
                    case 80:
                        bLiveVoicePkInfo.endMill = nb5Var.m158742k();
                        continue;
                    case 90:
                        bLiveVoicePkInfo.mvpBg = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        bLiveVoicePkInfo.onCallPoints = (List) nb5Var.m158743l(BLiveVoicePkPoint.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 106:
                        bLiveVoicePkInfo.leftBigUrl = nb5Var.m158750s();
                        continue;
                    case 114:
                        bLiveVoicePkInfo.rightBigUrl = nb5Var.m158750s();
                        continue;
                    default:
                        if (bLiveVoicePkInfo.pkId == null) {
                            bLiveVoicePkInfo.pkId = "";
        ...
        public void serialize(BLiveVoicePkInfo bLiveVoicePkInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, bLiveVoicePkInfo.enable);
            String str = bLiveVoicePkInfo.pkId;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17252I(10, bLiveVoicePkInfo.endMill);
            String str9 = bLiveVoicePkInfo.mvpBg;
            if (str9 != null) {
            ...
            List<BLiveVoicePkPoint> list = bLiveVoicePkInfo.onCallPoints;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(12, list, BLiveVoicePkPoint.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str10 = bLiveVoicePkInfo.leftBigUrl;
            if (str10 != null) {
    ...
    public BLiveVoicePkInfo mo223809clone() {
        BLiveVoicePkInfo bLiveVoicePkInfo = new BLiveVoicePkInfo();
        ...
        if (list != null) {
            bLiveVoicePkInfo.onCallPoints = ValueObject.util_map(list, new w9j() { // from class: l.g92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoicePkPoint) obj).mo223809clone();
                }
            });
        }
        return bLiveVoicePkInfo;
