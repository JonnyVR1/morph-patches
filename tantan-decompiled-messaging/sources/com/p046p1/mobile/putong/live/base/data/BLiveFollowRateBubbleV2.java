...
public class BLiveFollowRateBubbleV2 extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67962a(String str) {
        return str;
    }
    ...
    public BLiveFollowRateBubbleV2 mo223809clone() {
        BLiveFollowRateBubbleV2 bLiveFollowRateBubbleV2 = new BLiveFollowRateBubbleV2();
        List<String> list = this.triggerEvents;
        if (list != null) {
            bLiveFollowRateBubbleV2.triggerEvents = ValueObject.util_map(list, new w9j() { // from class: l.yz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveFollowRateBubbleV2.m67962a((String) obj);
                }
            });
        }
        ...
        if (bLiveFollowConditions != null) {
            bLiveFollowRateBubbleV2.conditions = bLiveFollowConditions.mo223809clone();
        }
        return bLiveFollowRateBubbleV2;
    }
