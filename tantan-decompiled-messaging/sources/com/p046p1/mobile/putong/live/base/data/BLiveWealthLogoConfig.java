...
public class BLiveWealthLogoConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68465a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m68466b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m68467c(String str) {
        return str;
    }
    ...
    public BLiveWealthLogoConfig mo223809clone() {
        BLiveWealthLogoConfig bLiveWealthLogoConfig = new BLiveWealthLogoConfig();
        Map<String, String> map = this.swipeIconMap;
        if (map != null) {
            bLiveWealthLogoConfig.swipeIconMap = ValueObject.util_map(map, new w9j() { // from class: l.na2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveWealthLogoConfig.m68465a((String) obj);
                }
            });
        }
        Map<String, String> map2 = this.otherIconMap;
        if (map2 != null) {
            bLiveWealthLogoConfig.otherIconMap = ValueObject.util_map(map2, new w9j() { // from class: l.oa2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveWealthLogoConfig.m68466b((String) obj);
                }
            });
        }
        Map<String, String> map3 = this.tipsMap;
        if (map3 != null) {
            bLiveWealthLogoConfig.tipsMap = ValueObject.util_map(map3, new w9j() { // from class: l.pa2
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveWealthLogoConfig.m68467c((String) obj);
                }
            });
        }
