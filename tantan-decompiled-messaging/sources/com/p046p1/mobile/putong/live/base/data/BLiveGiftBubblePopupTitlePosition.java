...
public class BLiveGiftBubblePopupTitlePosition extends TEnum {
    ...
    public class C11680a extends TEnumJsonAdapter<BLiveGiftBubblePopupTitlePosition> {
    ...
    public class C11681b extends TEnumProtobufAdapter<BLiveGiftBubblePopupTitlePosition> {
    ...
    static {
        C11680a c11680a = new C11680a();
        JSON_ADAPTER = c11680a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11681b();
        c11680a.addExtJsonValue("unknown_", -1);
        c11680a.addExtJsonValue(left, 0);
        c11680a.addExtJsonValue(middle, 1);
        supportEnum.add(left);
        supportEnum.add(middle);
        supportEnum.add("center");
        _BLiveGiftBubblePopupTitlePosition = Collections.synchronizedMap(new e01());
    }
