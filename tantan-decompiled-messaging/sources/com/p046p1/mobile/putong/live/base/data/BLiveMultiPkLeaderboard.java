...
public class BLiveMultiPkLeaderboard extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveMultiPkLeaderboard mo223809clone() {
        BLiveMultiPkLeaderboard bLiveMultiPkLeaderboard = new BLiveMultiPkLeaderboard();
        ...
        if (bLiveMultiPkBoardUser != null) {
            bLiveMultiPkLeaderboard.currentLeaderboard = bLiveMultiPkBoardUser.mo223809clone();
        }
        List<BLiveMultiPkBoardUser> list = this.allLeaderboards;
        if (list != null) {
            bLiveMultiPkLeaderboard.allLeaderboards = ValueObject.util_map(list, new w9j() { // from class: l.a32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveMultiPkBoardUser) obj).mo223809clone();
                }
            });
        }
