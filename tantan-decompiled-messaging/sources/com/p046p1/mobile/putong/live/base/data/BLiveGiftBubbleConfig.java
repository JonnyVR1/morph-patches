...
public class BLiveGiftBubbleConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveGiftBubbleConfig mo223809clone() {
        BLiveGiftBubbleConfig bLiveGiftBubbleConfig = new BLiveGiftBubbleConfig();
        ...
        if (bLiveGiftBubbleRule != null) {
            bLiveGiftBubbleConfig.displayRules = bLiveGiftBubbleRule.mo223809clone();
        }
        ...
        if (bLiveGiftBubblePopupButton != null) {
            bLiveGiftBubbleConfig.button = bLiveGiftBubblePopupButton.mo223809clone();
        }
        BLiveGiftBubblePopupRemind bLiveGiftBubblePopupRemind = this.remind;
        if (bLiveGiftBubblePopupRemind != null) {
            bLiveGiftBubbleConfig.remind = bLiveGiftBubblePopupRemind.mo223809clone();
        }
        ...
        if (bLiveGiftBubbleToast != null) {
            bLiveGiftBubbleConfig.toast = bLiveGiftBubbleToast.mo223809clone();
        }
        ...
        if (bLiveGiftBubbleHeader != null) {
            bLiveGiftBubbleConfig.header = bLiveGiftBubbleHeader.mo223809clone();
        }
        ...
        if (list != null) {
            bLiveGiftBubbleConfig.descriptions = ValueObject.util_map(list, new w9j() { // from class: l.d02
                @Override // p149l.w9j
        ...
        if (list2 != null) {
            bLiveGiftBubbleConfig.window = ValueObject.util_map(list2, new w9j() { // from class: l.e02
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveBottomWindow) obj).mo223809clone();
                }
            });
        }
