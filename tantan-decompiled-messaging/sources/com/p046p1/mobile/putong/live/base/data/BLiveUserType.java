...
public class BLiveUserType extends TEnum {
    ...
    public class C12209a extends TEnumJsonAdapter<BLiveUserType> {
    ...
    public class C12210b extends TEnumProtobufAdapter<BLiveUserType> {
    ...
    static {
        C12209a c12209a = new C12209a();
        JSON_ADAPTER = c12209a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12210b();
        c12209a.addExtJsonValue("unknown_", -1);
        c12209a.addExtJsonValue("anchor", 0);
        c12209a.addExtJsonValue("audience", 1);
        supportEnum.add("anchor");
        supportEnum.add("audience");
        _BLiveUserType = Collections.synchronizedMap(new e01());
    }
