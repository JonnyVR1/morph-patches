...
public final class VoiceShipLinkItemView extends LinearLayout {
    ...
    public final void m67467a(@NotNull rgn0.C19695a itemData, boolean isWhiteTheme) {
        itemData.getClass();
        ...
        if (user != null) {
            ...
            list.getClass();
            if (!list.isEmpty()) {
                hxs.m133407t("context_livingAct", get_avatar(), user.pictures.get(0).url, xdl0.m208407w(47.0f));
            }
        }
        get_ship().setText(itemData.getFeedItem().relationship);
        get_name().setTextColor(isWhiteTheme ? kvc0.m147352a(f1c0.f94067d) : kvc0.m147352a(f1c0.f94069f));
        get_ship().setTextColor(isWhiteTheme ? kvc0.m147352a(f1c0.f94067d) : kvc0.m147352a(f1c0.f94069f));
    }
    ...
    public void onFinishInflate() {
        ...
        View viewFindViewById = findViewById(d5c0.f84485j);
        viewFindViewById.getClass();
        set_avatar((VDraweeView) viewFindViewById);
        View viewFindViewById2 = findViewById(d5c0.f84507q0);
        viewFindViewById2.getClass();
        set_name((VText) viewFindViewById2);
        View viewFindViewById3 = findViewById(d5c0.f84421H0);
