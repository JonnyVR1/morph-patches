...
public class BLiveNewGiftWallDetailInfoItem extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveNewGiftWallDetailInfoItem mo223809clone() {
        BLiveNewGiftWallDetailInfoItem bLiveNewGiftWallDetailInfoItem = new BLiveNewGiftWallDetailInfoItem();
        ...
        if (bLiveNewGiftWallHierarchy != null) {
            bLiveNewGiftWallDetailInfoItem.hierarchy = bLiveNewGiftWallHierarchy.mo223809clone();
        }
        List<BLiveNewGiftWallProgress> list = this.progresses;
        if (list != null) {
            bLiveNewGiftWallDetailInfoItem.progresses = ValueObject.util_map(list, new w9j() { // from class: l.f32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallProgress) obj).mo223809clone();
                }
            });
        }
        List<BLiveNewGiftWallTab> list2 = this.tabs;
        if (list2 != null) {
            bLiveNewGiftWallDetailInfoItem.tabs = ValueObject.util_map(list2, new w9j() { // from class: l.g32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallTab) obj).mo223809clone();
                }
            });
        }
        List<BLiveNewGiftWallUser> list3 = this.users;
        if (list3 != null) {
            bLiveNewGiftWallDetailInfoItem.users = ValueObject.util_map(list3, new w9j() { // from class: l.h32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallUser) obj).mo223809clone();
                }
            });
        }
        List<BLiveNewGiftWallCategory> list4 = this.categories;
        if (list4 != null) {
            bLiveNewGiftWallDetailInfoItem.categories = ValueObject.util_map(list4, new w9j() { // from class: l.i32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallCategory) obj).mo223809clone();
                }
            });
        }
        List<BLiveNewGiftWallGift> list5 = this.gifts;
        if (list5 != null) {
            bLiveNewGiftWallDetailInfoItem.gifts = ValueObject.util_map(list5, new w9j() { // from class: l.j32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallGift) obj).mo223809clone();
                }
            });
        }
