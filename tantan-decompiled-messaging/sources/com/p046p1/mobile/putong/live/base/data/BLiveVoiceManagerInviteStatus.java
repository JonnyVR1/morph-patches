...
public class BLiveVoiceManagerInviteStatus extends TEnum {
    ...
    public class C12331a extends TEnumJsonAdapter<BLiveVoiceManagerInviteStatus> {
    ...
    public class C12332b extends TEnumProtobufAdapter<BLiveVoiceManagerInviteStatus> {
    ...
    static {
        C12331a c12331a = new C12331a();
        JSON_ADAPTER = c12331a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12332b();
        c12331a.addExtJsonValue("unknown_", -1);
        c12331a.addExtJsonValue("default", 0);
        c12331a.addExtJsonValue(inviting, 1);
        supportEnum.add("default");
        supportEnum.add(inviting);
        _BLiveVoiceManagerInviteStatus = Collections.synchronizedMap(new e01());
    }
