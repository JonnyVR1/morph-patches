...
public class BLiveAuctionUserInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67683a(String str) {
        return str;
    }
    ...
    public BLiveAuctionUserInfo mo223809clone() {
        BLiveAuctionUserInfo bLiveAuctionUserInfo = new BLiveAuctionUserInfo();
        ...
        if (bLiveVoiceMedalWallItemHeaderUrl != null) {
            bLiveAuctionUserInfo.avatarFrame = bLiveVoiceMedalWallItemHeaderUrl.mo223809clone();
        }
        ...
        if (list != null) {
            bLiveAuctionUserInfo.profilePictures = ValueObject.util_map(list, new w9j() { // from class: l.kr1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveAuctionUserInfo.m67683a((String) obj);
                }
            });
        }
