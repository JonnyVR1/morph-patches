...
public class BLiveNewGiftWallGiftList extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveNewGiftWallGiftList mo223809clone() {
        BLiveNewGiftWallGiftList bLiveNewGiftWallGiftList = new BLiveNewGiftWallGiftList();
        List<BLiveNewGiftWallGift> list = this.gifts;
        if (list != null) {
            bLiveNewGiftWallGiftList.gifts = ValueObject.util_map(list, new w9j() { // from class: l.m32
                @Override // p149l.w9j
        ...
        if (bLiveNewGiftWallCategory != null) {
            bLiveNewGiftWallGiftList.category = bLiveNewGiftWallCategory.mo223809clone();
        }
        BLiveNewGiftWallTab bLiveNewGiftWallTab = this.tab;
        if (bLiveNewGiftWallTab != null) {
            bLiveNewGiftWallGiftList.tab = bLiveNewGiftWallTab.mo223809clone();
        }
        List<BLiveNewGiftWallUser> list2 = this.users;
        if (list2 != null) {
            bLiveNewGiftWallGiftList.users = ValueObject.util_map(list2, new w9j() { // from class: l.n32
                @Override // p149l.w9j
                public final Object call(Object obj) {
