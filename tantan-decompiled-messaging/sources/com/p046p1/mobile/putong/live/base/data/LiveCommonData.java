...
public class LiveCommonData extends BaseData implements Cloneable, Serializable {
    ...
    public LiveCommonData mo223809clone() {
        LiveCommonData liveCommonData = new LiveCommonData();
        BLiveCoin bLiveCoin = this.coins;
        if (bLiveCoin != null) {
            liveCommonData.coins = bLiveCoin.mo223809clone();
        }
        List<BLiveSchema> list = this.liveSchemas;
        if (list != null) {
            liveCommonData.liveSchemas = ValueObject.util_map(list, new w9j() { // from class: l.s4s
                @Override // p149l.w9j
        ...
        if (list2 != null) {
            liveCommonData.profileLiveRooms = ValueObject.util_map(list2, new w9j() { // from class: l.t4s
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveRoomInProfile) obj).mo223809clone();
                }
            });
        }
        List<BLiveVoiceRoomInProfile> list3 = this.profileVoiceRooms;
        if (list3 != null) {
            liveCommonData.profileVoiceRooms = ValueObject.util_map(list3, new w9j() { // from class: l.u4s
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceRoomInProfile) obj).mo223809clone();
                }
            });
        }
        return liveCommonData;
