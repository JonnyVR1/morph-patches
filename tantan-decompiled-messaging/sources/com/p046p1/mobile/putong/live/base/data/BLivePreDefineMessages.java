...
public class BLivePreDefineMessages extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m68168a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m68169b(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ Integer m68170c(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ Integer m68171d(Integer num) {
        return num;
    }
    ...
    public BLivePreDefineMessages mo223809clone() {
        BLivePreDefineMessages bLivePreDefineMessages = new BLivePreDefineMessages();
        List<Integer> list = this.anchor;
        if (list != null) {
            bLivePreDefineMessages.anchor = ValueObject.util_map(list, new w9j() { // from class: l.n42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLivePreDefineMessages.m68169b((Integer) obj);
                }
            });
        }
        List<Integer> list2 = this.audience;
        if (list2 != null) {
            bLivePreDefineMessages.audience = ValueObject.util_map(list2, new w9j() { // from class: l.o42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLivePreDefineMessages.m68168a((Integer) obj);
                }
            });
        }
        List<Integer> list3 = this.voiceAudience;
        if (list3 != null) {
            bLivePreDefineMessages.voiceAudience = ValueObject.util_map(list3, new w9j() { // from class: l.p42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLivePreDefineMessages.m68170c((Integer) obj);
                }
            });
        }
        List<Integer> list4 = this.voiceAnchor;
        if (list4 != null) {
            bLivePreDefineMessages.voiceAnchor = ValueObject.util_map(list4, new w9j() { // from class: l.q42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLivePreDefineMessages.m68171d((Integer) obj);
                }
            });
        }
        return bLivePreDefineMessages;
