...
public class BLiveVoiceChatTopic extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68357a(String str) {
        return str;
    }
    ...
    public BLiveVoiceChatTopic mo223809clone() {
        BLiveVoiceChatTopic bLiveVoiceChatTopic = new BLiveVoiceChatTopic();
        bLiveVoiceChatTopic.roomId = this.roomId;
        List<String> list = this.topics;
        if (list != null) {
            bLiveVoiceChatTopic.topics = ValueObject.util_map(list, new w9j() { // from class: l.i82
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceChatTopic.m68357a((String) obj);
                }
            });
        }
