...
import com.p046p1.mobile.putong.live.base.data.BLiveDanmakuItemStyle;
...
public class BLiveDanmakuItemStyle extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67767a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m67768b(String str) {
        return str;
    }
    ...
    public BLiveDanmakuItemStyle mo223809clone() {
        BLiveDanmakuItemStyle bLiveDanmakuItemStyle = new BLiveDanmakuItemStyle();
        List<String> list = this.backgroundColors;
        if (list != null) {
            bLiveDanmakuItemStyle.backgroundColors = ValueObject.util_map(list, new w9j() { // from class: l.xs1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveDanmakuItemStyle.m67767a((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveDanmakuItemStyle.borderColors = ValueObject.util_map(list2, new w9j() { // from class: l.ys1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveDanmakuItemStyle.m67768b((String) obj);
                }
            });
        }
        return bLiveDanmakuItemStyle;
