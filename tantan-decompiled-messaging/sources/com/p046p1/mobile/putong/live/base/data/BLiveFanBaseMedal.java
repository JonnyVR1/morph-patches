...
public class BLiveFanBaseMedal extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveFanBaseMedal> JSON_ADAPTER = new ObjectJsonAdapter<BLiveFanBaseMedal>() { // from class: com.p1.mobile.putong.live.base.data.BLiveFanBaseMedal.1
        ...
        public boolean parseField(BLiveFanBaseMedal bLiveFanBaseMedal, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "fanbaseId":
                    ...
                    return true;
                case "id":
                    bLiveFanBaseMedal.f44365id = jsonParser.getValueAsString();
                    return false;
                case "fanbaseGrade":
        ...
        public void serializeFields(BLiveFanBaseMedal bLiveFanBaseMedal, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveFanBaseMedal.f44365id;
            if (str != null) {
    ...
    public BLiveFanBaseMedal mo223809clone() {
        BLiveFanBaseMedal bLiveFanBaseMedal = new BLiveFanBaseMedal();
        bLiveFanBaseMedal.f44365id = this.f44365id;
        ...
        if (list != null) {
            bLiveFanBaseMedal.colorTemplates = ValueObject.util_map(list, new w9j() { // from class: l.qz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveMedalColorTemplate) obj).mo223809clone();
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44365id, bLiveFanBaseMedal.f44365id) && ValueObject.util_equals(this.liveId, bLiveFanBaseMedal.liveId) && this.expireTime == bLiveFanBaseMedal.expireTime && this.fanbaseGrade == bLiveFanBaseMedal.fanbaseGrade && this.grade == bLiveFanBaseMedal.grade && ValueObject.util_equals(this.colorTemplates, bLiveFanBaseMedal.colorTemplates) && ValueObject.util_equals(this.fanbaseId, bLiveFanBaseMedal.fanbaseId) && ValueObject.util_equals(this.userId, bLiveFanBaseMedal.userId);
    }
