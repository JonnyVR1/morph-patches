...
public class BLiveUserCardButtonColorConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68303a(String str) {
        return str;
    }
    ...
    public BLiveUserCardButtonColorConfig mo223809clone() {
        BLiveUserCardButtonColorConfig bLiveUserCardButtonColorConfig = new BLiveUserCardButtonColorConfig();
        bLiveUserCardButtonColorConfig.gradientDirection = this.gradientDirection;
        List<String> list = this.colors;
        if (list != null) {
            bLiveUserCardButtonColorConfig.colors = ValueObject.util_map(list, new w9j() { // from class: l.n72
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveUserCardButtonColorConfig.m68303a((String) obj);
                }
            });
        }
