...
public class BLiveVoiceAuctionStage extends TEnum {
    ...
    public class C12247a extends TEnumJsonAdapter<BLiveVoiceAuctionStage> {
    ...
    public class C12248b extends TEnumProtobufAdapter<BLiveVoiceAuctionStage> {
    ...
    static {
        C12247a c12247a = new C12247a();
        JSON_ADAPTER = c12247a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12248b();
        c12247a.addExtJsonValue("unknown_", -1);
        supportEnum.add("created");
        supportEnum.add("preparing");
        supportEnum.add("playing");
        supportEnum.add(announcing);
        supportEnum.add("ended");
        _BLiveVoiceAuctionStage = Collections.synchronizedMap(new e01());
    }
