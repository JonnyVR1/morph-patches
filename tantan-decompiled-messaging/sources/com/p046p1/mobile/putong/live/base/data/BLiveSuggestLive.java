...
public class BLiveSuggestLive extends ValueObject implements Cloneable, Serializable {
        ...
        public boolean parseField(BLiveSuggestLive bLiveSuggestLive, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    bLiveSuggestLive.f44450id = jsonParser.getValueAsString();
                    return false;
                case 11:
    ...
    public static /* synthetic */ String m68255b(String str) {
        return str;
    }
    ...
    public static BLiveSuggestLive convertFrom(BLiveAbsData bLiveAbsData, BLiveAbsRoom bLiveAbsRoom, User user) {
        ...
        bLiveSuggestLiveNew_.f44450id = bLiveAbsData.f44323id;
        ...
        bLiveSuggestLiveRoomNew_.f44452id = bLiveAbsData.room.f44419id;
        ...
        bLiveSuggestLiveAnchorNew_.f44451id = bLiveAbsData.anchor.f44419id;
    ...
    public BLiveSuggestLive mo223809clone() {
        BLiveSuggestLive bLiveSuggestLive = new BLiveSuggestLive();
        bLiveSuggestLive.f44450id = this.f44450id;
        BLiveSuggestLiveRoom bLiveSuggestLiveRoom = this.room;
        if (bLiveSuggestLiveRoom != null) {
            bLiveSuggestLive.room = bLiveSuggestLiveRoom.mo223809clone();
        }
        BLiveSuggestLiveAnchor bLiveSuggestLiveAnchor = this.anchor;
        if (bLiveSuggestLiveAnchor != null) {
            bLiveSuggestLive.anchor = bLiveSuggestLiveAnchor.mo223809clone();
        }
        ...
        if (bLiveStreamCdnInfo != null) {
            bLiveSuggestLive.streamCdnInfo = bLiveStreamCdnInfo.mo223809clone();
        }
        BLiveRecommendInfo bLiveRecommendInfo = this.recommendInfo;
        if (bLiveRecommendInfo != null) {
            bLiveSuggestLive.recommendInfo = bLiveRecommendInfo.mo223809clone();
        }
        ...
        if (bLiveSuggestLabel != null) {
            bLiveSuggestLive.specialLabel = bLiveSuggestLabel.mo223809clone();
        }
        BLiveSuggestLabel bLiveSuggestLabel2 = this.basicLabel;
        if (bLiveSuggestLabel2 != null) {
            bLiveSuggestLive.basicLabel = bLiveSuggestLabel2.mo223809clone();
        }
        ...
        if (bLiveMultiCallInfo != null) {
            bLiveSuggestLive.multiCallInfo = bLiveMultiCallInfo.mo223809clone();
        }
        BLiveMultiCallExtend bLiveMultiCallExtend = this.multiCallExtend;
        if (bLiveMultiCallExtend != null) {
            bLiveSuggestLive.multiCallExtend = bLiveMultiCallExtend.mo223809clone();
        }
        List<String> list = this.redPacketIds;
        if (list != null) {
            bLiveSuggestLive.redPacketIds = ValueObject.util_map(list, new w9j() { // from class: l.i62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveSuggestLive.m68255b((String) obj);
                }
            });
        }
        BLiveMultiCallExtend bLiveMultiCallExtend2 = this.guildCallExtend;
        if (bLiveMultiCallExtend2 != null) {
            bLiveSuggestLive.guildCallExtend = bLiveMultiCallExtend2.mo223809clone();
        }
        List<BLiveCoverLabel> list2 = this.coverLabels;
        if (list2 != null) {
            bLiveSuggestLive.coverLabels = ValueObject.util_map(list2, new w9j() { // from class: l.j62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveCoverLabel) obj).mo223809clone();
                }
            });
        }
        ...
        if (bLiveRtcInfo != null) {
            bLiveSuggestLive.rtcInfo = bLiveRtcInfo.mo223809clone();
        }
        List<BLiveCoverLabel> list3 = this.coverLabelsV2;
        if (list3 != null) {
            bLiveSuggestLive.coverLabelsV2 = ValueObject.util_map(list3, new w9j() { // from class: l.k62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveCoverLabel) obj).mo223809clone();
                }
        ...
        if (list4 != null) {
            bLiveSuggestLive.chatMessages = ValueObject.util_map(list4, new w9j() { // from class: l.l62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveChatMsg) obj).mo223809clone();
                }
            });
        }
        ...
        if (bLiveIntlLiveFrame != null) {
            bLiveSuggestLive.intlFrame = bLiveIntlLiveFrame.mo223809clone();
        }
    ...
    public BLive expendToFullLive() {
        ...
        bLiveOwnerNew_.f44419id = this.room.f44452id;
        BLiveOwner bLiveOwnerNew_2 = BLiveOwner.new_();
        bLiveNew_.anchor = bLiveOwnerNew_2;
        bLiveOwnerNew_2.f44419id = this.anchor.f44451id;
