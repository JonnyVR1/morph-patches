...
public class BLiveVoiceRoomProfile extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceRoomProfile mo223809clone() {
        BLiveVoiceRoomProfile bLiveVoiceRoomProfile = new BLiveVoiceRoomProfile();
        ...
        if (list != null) {
            bLiveVoiceRoomProfile.settleMembers = ValueObject.util_map(list, new w9j() { // from class: l.t92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceVirtualRoomSettleUser) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveVoiceRoomProfile.heatDesc = ValueObject.util_map(list2, new w9j() { // from class: l.u92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceVirtualRoomHeatDesc) obj).mo223809clone();
                }
            });
        }
        ...
        if (bLiveVoiceRoomClass != null) {
            bLiveVoiceRoomProfile.roomClass = bLiveVoiceRoomClass.mo223809clone();
        }
        ...
        if (list3 != null) {
            bLiveVoiceRoomProfile.roomAttributes = ValueObject.util_map(list3, new w9j() { // from class: l.v92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceVirtualRoomAttributes) obj).mo223809clone();
                }
            });
        }
