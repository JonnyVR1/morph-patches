...
public class AuctionState extends TEnum {
    ...
    public class C11443a extends TEnumJsonAdapter<AuctionState> {
    ...
    public class C11444b extends TEnumProtobufAdapter<AuctionState> {
    ...
    static {
        ...
        JSON_ADAPTER = c11443a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11444b();
        c11443a.addExtJsonValue("unknown_", -1);
        ...
        _AuctionState = Collections.synchronizedMap(new e01());
    }
