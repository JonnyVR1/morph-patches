package com.p046p1.mobile.putong.live.base.arch.card.cardmodel.doublecard;
...
public class LiveDoublePanelCardView extends FrameLayout {
    ...
    public static int m67437a(List<String> list, int i) {
    ...
    public void m67438b(q9t q9tVar) {
        ...
        this.bgView.setBackground(yb2.m213885j(m67437a(q9tVar.background, 0), m67437a(q9tVar.background, 1), 10));
    }
