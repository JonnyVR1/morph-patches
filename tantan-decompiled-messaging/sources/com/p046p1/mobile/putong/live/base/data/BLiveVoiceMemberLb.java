...
public class BLiveVoiceMemberLb extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BLiveVoiceMemberLb> PROTOBUF_ADAPTER = new C12338a();
    ...
    public class C12338a extends MessageNanoAdapter<BLiveVoiceMemberLb> {
        public C12338a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveVoiceMemberLb bLiveVoiceMemberLb) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, bLiveVoiceMemberLb.rank);
            String str = bLiveVoiceMemberLb.userId;
            if (str != null) {
            ...
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(5, bLiveVoiceMemberLb.hierarchyGrade) + CodedOutputByteBufferNano.m17226h(6, bLiveVoiceMemberLb.medalGrade);
            String str4 = bLiveVoiceMemberLb.medalColor;
            if (str4 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(7, str4);
            }
            String str5 = bLiveVoiceMemberLb.medalName;
            if (str5 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(8, str5);
            }
            String str6 = bLiveVoiceMemberLb.gender;
            if (str6 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(9, str6);
            }
            int iM17228j = iM17226h2 + CodedOutputByteBufferNano.m17228j(10, bLiveVoiceMemberLb.score);
            bLiveVoiceMemberLb.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveVoiceMemberLb parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        bLiveVoiceMemberLb.rank = nb5Var.m158741j();
                        continue;
                    case 18:
                        bLiveVoiceMemberLb.userId = nb5Var.m158750s();
                        continue;
                    case 26:
                        bLiveVoiceMemberLb.userName = nb5Var.m158750s();
                        continue;
                    case 34:
                        bLiveVoiceMemberLb.userAvatar = nb5Var.m158750s();
                        continue;
                    case 40:
                        bLiveVoiceMemberLb.hierarchyGrade = nb5Var.m158741j();
                        continue;
                    case 48:
                        bLiveVoiceMemberLb.medalGrade = nb5Var.m158741j();
                        continue;
                    case 58:
                        bLiveVoiceMemberLb.medalColor = nb5Var.m158750s();
                        continue;
                    case 66:
                        bLiveVoiceMemberLb.medalName = nb5Var.m158750s();
                        continue;
                    case 74:
                        bLiveVoiceMemberLb.gender = nb5Var.m158750s();
                        continue;
                    case 80:
                        bLiveVoiceMemberLb.score = nb5Var.m158742k();
                        continue;
                    default:
                        if (bLiveVoiceMemberLb.userId == null) {
                            bLiveVoiceMemberLb.userId = "";
        ...
        public void serialize(BLiveVoiceMemberLb bLiveVoiceMemberLb, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, bLiveVoiceMemberLb.rank);
            String str = bLiveVoiceMemberLb.userId;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17250G(5, bLiveVoiceMemberLb.hierarchyGrade);
            codedOutputByteBufferNano.m17250G(6, bLiveVoiceMemberLb.medalGrade);
            String str4 = bLiveVoiceMemberLb.medalColor;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17252I(10, bLiveVoiceMemberLb.score);
        }
    }
    ...
    public BLiveVoiceMemberLb mo223809clone() {
        BLiveVoiceMemberLb bLiveVoiceMemberLb = new BLiveVoiceMemberLb();
