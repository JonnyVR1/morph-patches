...
public class BLiveVerificationStatus extends TEnum {
    ...
    public class C12215a extends TEnumJsonAdapter<BLiveVerificationStatus> {
    ...
    public class C12216b extends TEnumProtobufAdapter<BLiveVerificationStatus> {
    ...
    static {
        C12215a c12215a = new C12215a();
        JSON_ADAPTER = c12215a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12216b();
        c12215a.addExtJsonValue("unknown_", -1);
        c12215a.addExtJsonValue("verified", 0);
        c12215a.addExtJsonValue("pending", 1);
        c12215a.addExtJsonValue("rejected", 2);
        supportEnum.add("verified");
        supportEnum.add("pending");
        supportEnum.add("rejected");
        _BLiveVerificationStatus = Collections.synchronizedMap(new e01());
    }
