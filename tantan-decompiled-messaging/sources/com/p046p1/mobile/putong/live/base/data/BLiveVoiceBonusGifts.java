...
public class BLiveVoiceBonusGifts extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceBonusGifts mo223809clone() {
        BLiveVoiceBonusGifts bLiveVoiceBonusGifts = new BLiveVoiceBonusGifts();
        ...
        if (list != null) {
            bLiveVoiceBonusGifts.giftItems = ValueObject.util_map(list, new w9j() { // from class: l.c82
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceBonusGiftItem) obj).mo223809clone();
                }
            });
        }
        return bLiveVoiceBonusGifts;
