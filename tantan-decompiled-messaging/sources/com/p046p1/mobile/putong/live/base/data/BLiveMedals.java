...
public class BLiveMedals extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveMedals mo223809clone() {
        BLiveMedals bLiveMedals = new BLiveMedals();
        bLiveMedals.version = this.version;
        List<BLiveMedal> list = this.medals;
        if (list != null) {
            bLiveMedals.medals = ValueObject.util_map(list, new w9j() { // from class: l.h22
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveMedal) obj).mo223809clone();
                }
            });
        }
        List<BLiveFanBaseMedal> list2 = this.fanbaseMedals;
        if (list2 != null) {
            bLiveMedals.fanbaseMedals = ValueObject.util_map(list2, new w9j() { // from class: l.i22
                @Override // p149l.w9j
                public final Object call(Object obj) {
