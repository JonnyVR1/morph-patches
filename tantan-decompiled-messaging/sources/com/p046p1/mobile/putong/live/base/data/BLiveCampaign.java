...
public class BLiveCampaign extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveCampaign> JSON_ADAPTER = new ObjectJsonAdapter<BLiveCampaign>() { // from class: com.p1.mobile.putong.live.base.data.BLiveCampaign.1
        ...
        public boolean parseField(BLiveCampaign bLiveCampaign, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    bLiveCampaign.f44348id = jsonParser.getValueAsString();
                    return false;
                case 11:
        ...
        public void serializeFields(BLiveCampaign bLiveCampaign, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveCampaign.f44348id;
            if (str != null) {
    ...
    public static /* synthetic */ Long m67734a(Long l2) {
        return l2;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Double m67735b(Double d) {
        return d;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ Integer m67736c(Integer num) {
        return num;
    }
    ...
    public BLiveCampaign mo223809clone() {
        BLiveCampaign bLiveCampaign = new BLiveCampaign();
        bLiveCampaign.f44348id = this.f44348id;
        ...
        if (list != null) {
            bLiveCampaign.entranceSize = ValueObject.util_map(list, new w9j() { // from class: l.fs1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveCampaign.m67736c((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveCampaign.detailInset = ValueObject.util_map(list2, new w9j() { // from class: l.gs1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveCampaign.m67735b((Double) obj);
                }
            });
        }
        List<Long> list3 = this.validPeriod;
        if (list3 != null) {
            bLiveCampaign.validPeriod = ValueObject.util_map(list3, new w9j() { // from class: l.hs1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveCampaign.m67734a((Long) obj);
                }
            });
        }
        ...
        if (bLivePopUpRules != null) {
            bLiveCampaign.popUpRules = bLivePopUpRules.mo223809clone();
        }
