...
public class BLiveFirstChargeStatus extends TEnum {
    ...
    public class C11654a extends TEnumJsonAdapter<BLiveFirstChargeStatus> {
    ...
    public class C11655b extends TEnumProtobufAdapter<BLiveFirstChargeStatus> {
    ...
    static {
        C11654a c11654a = new C11654a();
        JSON_ADAPTER = c11654a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11655b();
        c11654a.addExtJsonValue("unknown_", -1);
        c11654a.addExtJsonValue("pending", 0);
        c11654a.addExtJsonValue("success", 1);
        c11654a.addExtJsonValue("completed", 2);
        supportEnum.add("pending");
        supportEnum.add("success");
        supportEnum.add("completed");
        _BLiveFirstChargeStatus = Collections.synchronizedMap(new e01());
    }
