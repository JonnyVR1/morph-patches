...
public class BLivePkPointList extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68156a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m68157b(String str) {
        return str;
    }
    ...
    public BLivePkPointList mo223809clone() {
        BLivePkPointList bLivePkPointList = new BLivePkPointList();
        List<String> list = this.userId;
        if (list != null) {
            bLivePkPointList.userId = ValueObject.util_map(list, new w9j() { // from class: l.h42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLivePkPointList.m68156a((String) obj);
                }
            });
        }
        List<String> list2 = this.point;
        if (list2 != null) {
            bLivePkPointList.point = ValueObject.util_map(list2, new w9j() { // from class: l.i42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLivePkPointList.m68157b((String) obj);
                }
            });
        }
        return bLivePkPointList;
