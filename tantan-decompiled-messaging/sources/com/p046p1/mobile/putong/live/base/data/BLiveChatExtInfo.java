...
public class BLiveChatExtInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveChatExtInfo mo223809clone() {
        BLiveChatExtInfo bLiveChatExtInfo = new BLiveChatExtInfo();
        ...
        if (bLiveUserMask != null) {
            bLiveChatExtInfo.userMask = bLiveUserMask.mo223809clone();
        }
        ...
        if (list != null) {
            bLiveChatExtInfo.atUserInfos = ValueObject.util_map(list, new w9j() { // from class: l.is1
                @Override // p149l.w9j
