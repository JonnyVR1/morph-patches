...
public class BLivePkInvite extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLivePkInvite> JSON_ADAPTER = new ObjectJsonAdapter<BLivePkInvite>() { // from class: com.p1.mobile.putong.live.base.data.BLivePkInvite.1
        ...
        public boolean parseField(BLivePkInvite bLivePkInvite, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userInfo":
                    ...
                    return true;
                case "id":
                    bLivePkInvite.f44425id = jsonParser.getValueAsString();
                    return false;
                case "to":
                    bLivePkInvite.f44426to = Converter.USER_ID.parse(jsonParser, str2);
                    return true;
                case "live":
        ...
        public void serializeFields(BLivePkInvite bLivePkInvite, JsonGenerator jsonGenerator) throws IOException {
            String str = bLivePkInvite.f44425id;
            if (str != null) {
            ...
            if (bLivePkInvite.f44426to != null) {
                jsonGenerator.writeFieldName("to");
                Converter.USER_ID.serialize(bLivePkInvite.f44426to, jsonGenerator, true);
            }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44425id, bLivePkInvite.f44425id) && this.isOnceMore == bLivePkInvite.isOnceMore && ValueObject.util_equals(this.owner, bLivePkInvite.owner) && ValueObject.util_equals(this.f44426to, bLivePkInvite.f44426to) && ValueObject.util_equals(this.source, bLivePkInvite.source) && ValueObject.util_equals(this.state, bLivePkInvite.state) && ValueObject.util_equals(this.createTime, bLivePkInvite.createTime) && ValueObject.util_equals(this.userInfo, bLivePkInvite.userInfo) && ValueObject.util_equals(this.live, bLivePkInvite.live);
    }
    ...
    public void nullCheck() {
        if (this.f44425id == null) {
            this.f44425id = "";
        }
        if (this.owner == null) {
            this.owner = "";
        }
        if (this.f44426to == null) {
            this.f44426to = "";
        }
        if (this.source == null) {
