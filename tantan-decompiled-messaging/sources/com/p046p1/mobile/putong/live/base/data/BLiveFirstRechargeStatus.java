...
import com.p046p1.mobile.putong.live.base.data.BLiveFirstRechargePopupBonus;
...
public class BLiveFirstRechargeStatus extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveFirstRechargeStatus mo223809clone() {
        BLiveFirstRechargeStatus bLiveFirstRechargeStatus = new BLiveFirstRechargeStatus();
        ...
        if (list != null) {
            bLiveFirstRechargeStatus.bonus = ValueObject.util_map(list, new w9j() { // from class: l.xz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveFirstRechargePopupBonus) obj).mo223809clone();
                }
            });
        }
