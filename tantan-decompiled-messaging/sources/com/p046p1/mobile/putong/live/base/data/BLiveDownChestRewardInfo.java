...
public class BLiveDownChestRewardInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveDownChestRewardInfo mo223809clone() {
        BLiveDownChestRewardInfo bLiveDownChestRewardInfo = new BLiveDownChestRewardInfo();
        List<BLiveCommonViewConfig> list = this.contents;
        if (list != null) {
            bLiveDownChestRewardInfo.contents = ValueObject.util_map(list, new w9j() { // from class: l.uy1
                @Override // p149l.w9j
        ...
        if (list2 != null) {
            bLiveDownChestRewardInfo.rewards = ValueObject.util_map(list2, new w9j() { // from class: l.vy1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveDownBoxRewards) obj).mo223809clone();
                }
            });
        }
        BLiveCommonViewConfig bLiveCommonViewConfig = this.jump;
        if (bLiveCommonViewConfig != null) {
            bLiveDownChestRewardInfo.jump = bLiveCommonViewConfig.mo223809clone();
        }
        return bLiveDownChestRewardInfo;
    }
