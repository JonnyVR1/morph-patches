...
public class BLiveEntranceList extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67939b(String str) {
        return str;
    }
    ...
    public BLiveEntranceList mo223809clone() {
        BLiveEntranceList bLiveEntranceList = new BLiveEntranceList();
        List<String> list = this.keyList;
        if (list != null) {
            bLiveEntranceList.keyList = ValueObject.util_map(list, new w9j() { // from class: l.jz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveEntranceList.m67939b((String) obj);
                }
            });
        }
        List<BLiveEntrance> list2 = this.entrances;
        if (list2 != null) {
            bLiveEntranceList.entrances = ValueObject.util_map(list2, new w9j() { // from class: l.kz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveEntrance) obj).mo223809clone();
                }
            });
        }
        return bLiveEntranceList;
