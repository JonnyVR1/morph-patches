...
public class BLiveCoverLabel extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67761a(String str) {
        return str;
    }
    ...
    public BLiveCoverLabel mo223809clone() {
        BLiveCoverLabel bLiveCoverLabel = new BLiveCoverLabel();
        ...
        if (list != null) {
            bLiveCoverLabel.background = ValueObject.util_map(list, new w9j() { // from class: l.rs1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveCoverLabel.m67761a((String) obj);
                }
            });
        }
