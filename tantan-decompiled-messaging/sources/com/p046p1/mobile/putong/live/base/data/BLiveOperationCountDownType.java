...
public class BLiveOperationCountDownType extends TEnum {
    ...
    public class C11902a extends TEnumJsonAdapter<BLiveOperationCountDownType> {
    ...
    public class C11903b extends TEnumProtobufAdapter<BLiveOperationCountDownType> {
    ...
    static {
        C11902a c11902a = new C11902a();
        JSON_ADAPTER = c11902a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11903b();
        c11902a.addExtJsonValue("unknown_", -1);
        c11902a.addExtJsonValue("brightToDark", 0);
        c11902a.addExtJsonValue("darkToBright", 1);
        supportEnum.add("brightToDark");
        supportEnum.add("darkToBright");
        _BLiveOperationCountDownType = Collections.synchronizedMap(new e01());
    }
