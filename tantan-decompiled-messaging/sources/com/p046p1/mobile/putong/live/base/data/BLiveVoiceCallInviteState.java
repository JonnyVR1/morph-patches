...
public class BLiveVoiceCallInviteState extends TEnum {
    ...
    public class C12259a extends TEnumJsonAdapter<BLiveVoiceCallInviteState> {
    ...
    public class C12260b extends TEnumProtobufAdapter<BLiveVoiceCallInviteState> {
    ...
    static {
        C12259a c12259a = new C12259a();
        JSON_ADAPTER = c12259a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12260b();
        c12259a.addExtJsonValue("unknown_", -1);
        c12259a.addExtJsonValue("not-invited", 0);
        c12259a.addExtJsonValue("invited", 1);
        c12259a.addExtJsonValue("accepted", 2);
        c12259a.addExtJsonValue("ended", 3);
        ...
        _BLiveVoiceCallInviteState = Collections.synchronizedMap(new e01());
    }
