...
public class BLiveTraceServerBiz extends TEnum {
    ...
    public static final String f44460cp = "cp";
    ...
    public class C12151a extends TEnumJsonAdapter<BLiveTraceServerBiz> {
    ...
    public class C12152b extends TEnumProtobufAdapter<BLiveTraceServerBiz> {
    ...
    static {
        C12151a c12151a = new C12151a();
        JSON_ADAPTER = c12151a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12152b();
        c12151a.addExtJsonValue("unknown_", -1);
        c12151a.addExtJsonValue("fans", 0);
        c12151a.addExtJsonValue(guard, 1);
        c12151a.addExtJsonValue(giftcombination, 2);
        c12151a.addExtJsonValue(sweetaccompany, 3);
        c12151a.addExtJsonValue(firstblood, 4);
        c12151a.addExtJsonValue(firstscreen, 5);
        c12151a.addExtJsonValue(withyoutravel, 6);
        c12151a.addExtJsonValue(interactivepk, 7);
        c12151a.addExtJsonValue(Grabheadlines, 8);
        c12151a.addExtJsonValue(bulletstorm, 9);
        c12151a.addExtJsonValue(firstrecharge, 10);
        ...
        _BLiveTraceServerBiz = Collections.synchronizedMap(new e01());
    }
