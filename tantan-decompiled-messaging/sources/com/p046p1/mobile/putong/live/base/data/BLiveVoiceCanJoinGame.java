...
public class BLiveVoiceCanJoinGame extends ValueObject implements Cloneable, Serializable {
    ...
    public String msg;
    public static ProtobufAdapter<BLiveVoiceCanJoinGame> PROTOBUF_ADAPTER = new C12265a();
    ...
    public class C12265a extends MessageNanoAdapter<BLiveVoiceCanJoinGame> {
        public C12265a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveVoiceCanJoinGame bLiveVoiceCanJoinGame) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, bLiveVoiceCanJoinGame.can);
            String str = bLiveVoiceCanJoinGame.msg;
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(2, str);
            }
            bLiveVoiceCanJoinGame.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveVoiceCanJoinGame parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    bLiveVoiceCanJoinGame.can = nb5Var.m158738g();
                } else {
                    if (iM158752u != 18) {
                        if (bLiveVoiceCanJoinGame.msg != null) {
                            break;
                    ...
                    bLiveVoiceCanJoinGame.msg = nb5Var.m158750s();
                }
            }
            return bLiveVoiceCanJoinGame;
        }
        ...
        public void serialize(BLiveVoiceCanJoinGame bLiveVoiceCanJoinGame, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, bLiveVoiceCanJoinGame.can);
            String str = bLiveVoiceCanJoinGame.msg;
            if (str != null) {
    ...
    public BLiveVoiceCanJoinGame mo223809clone() {
        BLiveVoiceCanJoinGame bLiveVoiceCanJoinGame = new BLiveVoiceCanJoinGame();
