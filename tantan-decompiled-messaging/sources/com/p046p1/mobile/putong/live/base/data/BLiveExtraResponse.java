...
public class BLiveExtraResponse extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveExtraResponse mo223809clone() {
        BLiveExtraResponse bLiveExtraResponse = new BLiveExtraResponse();
        Meta meta = this.meta;
        if (meta != null) {
            bLiveExtraResponse.meta = meta.mo223809clone();
        }
        BLiveExtraData bLiveExtraData = this.data;
        if (bLiveExtraData != null) {
            bLiveExtraResponse.data = bLiveExtraData.mo223809clone();
        }
        Pagination pagination = this.pagination;
        if (pagination != null) {
            bLiveExtraResponse.pagination = pagination.mo223809clone();
        }
        return bLiveExtraResponse;
    }
