...
public class BLiveFrame extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveFrame> JSON_ADAPTER = new ObjectJsonAdapter<BLiveFrame>() { // from class: com.p1.mobile.putong.live.base.data.BLiveFrame.1
        ...
        public boolean parseField(BLiveFrame bLiveFrame, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "frameSvgUrl":
                    ...
                    return true;
                case "id":
                    bLiveFrame.f44371id = jsonParser.getValueAsString();
                    return false;
                case "frameName":
        ...
        public void serializeFields(BLiveFrame bLiveFrame, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveFrame.f44371id;
            if (str != null) {
    ...
    public BLiveFrame mo223809clone() {
        BLiveFrame bLiveFrame = new BLiveFrame();
        bLiveFrame.f44371id = this.f44371id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44371id, bLiveFrame.f44371id) && ValueObject.util_equals(this.frameName, bLiveFrame.frameName) && ValueObject.util_equals(this.framePicUrl, bLiveFrame.framePicUrl) && this.frameGrade == bLiveFrame.frameGrade && ValueObject.util_equals(this.liveType, bLiveFrame.liveType) && ValueObject.util_equals(this.region, bLiveFrame.region) && ValueObject.util_equals(this.frameSvgUrl, bLiveFrame.frameSvgUrl);
    }
