...
public class BLiveGivenGiftBrief extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveGivenGiftBrief> JSON_ADAPTER = new ObjectJsonAdapter<BLiveGivenGiftBrief>() { // from class: com.p1.mobile.putong.live.base.data.BLiveGivenGiftBrief.1
        ...
        public boolean parseField(BLiveGivenGiftBrief bLiveGivenGiftBrief, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 20:
                    ...
                    return true;
                case 21:
                    bLiveGivenGiftBrief.f44385id = jsonParser.getValueAsInt();
                    return false;
                case 22:
        ...
        public void serializeFields(BLiveGivenGiftBrief bLiveGivenGiftBrief, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", bLiveGivenGiftBrief.f44385id);
    ...
    public static /* synthetic */ Integer m68000b(Integer num) {
        return num;
    }
    ...
    public BLiveGivenGiftBrief mo223809clone() {
        BLiveGivenGiftBrief bLiveGivenGiftBrief = new BLiveGivenGiftBrief();
        bLiveGivenGiftBrief.f44385id = this.f44385id;
        ...
        if (bLiveGiftInteractRules != null) {
            bLiveGivenGiftBrief.interactRules = bLiveGiftInteractRules.mo223809clone();
        }
        ...
        if (list != null) {
            bLiveGivenGiftBrief.videoEffectExtras = ValueObject.util_map(list, new w9j() { // from class: l.a12
                @Override // p149l.w9j
        ...
        if (bLiveGiftSetInfo != null) {
            bLiveGivenGiftBrief.giftSetInfo = bLiveGiftSetInfo.mo223809clone();
        }
        ...
        if (list2 != null) {
            bLiveGivenGiftBrief.gearPercentInfo = ValueObject.util_map(list2, new w9j() { // from class: l.b12
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveGivenGiftBrief.m68000b((Integer) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            bLiveGivenGiftBrief.discounts = ValueObject.util_map(list3, new w9j() { // from class: l.c12
                @Override // p149l.w9j
                public final Object call(Object obj) {
        ...
        if (bLiveGivenGiftBriefTray != null) {
            bLiveGivenGiftBrief.tray = bLiveGivenGiftBriefTray.mo223809clone();
        }
        BLiveIntlFlyMicEffectConfig bLiveIntlFlyMicEffectConfig = this.flyMicInfo;
        if (bLiveIntlFlyMicEffectConfig != null) {
            bLiveGivenGiftBrief.flyMicInfo = bLiveIntlFlyMicEffectConfig.mo223809clone();
        }
    ...
    public int hashCode() {
        ...
        int i2 = ((((i * 41) + this.f44385id) * 41) + this.num) * 41;
    ...
    public boolean isGuildCall() {
        return "extra_type_guild_live".equals(this.briefType) && NullChecker.m81303a(this.guildCall);
    }
    ...
    public boolean isMultiCall() {
        return "extra_type_multi_call".equals(this.briefType) && NullChecker.m81303a(this.multiCall);
    }
