...
public class BLiveBossGift extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BLiveBossGift> PROTOBUF_ADAPTER = new C11513a();
    ...
    public class C11513a extends MessageNanoAdapter<BLiveBossGift> {
        public C11513a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveBossGift bLiveBossGift) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, bLiveBossGift.popularityValue);
            String str = bLiveBossGift.userId;
            if (str != null) {
            ...
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(8, bLiveBossGift.giftNum);
            String str7 = bLiveBossGift.giftUrl;
            if (str7 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(9, str7);
            }
            int iM17228j = iM17226h2 + CodedOutputByteBufferNano.m17228j(10, bLiveBossGift.createdTime);
            bLiveBossGift.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveBossGift parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        bLiveBossGift.popularityValue = nb5Var.m158741j();
                        continue;
                    case 18:
                        bLiveBossGift.userId = nb5Var.m158750s();
                        continue;
                    case 26:
                        bLiveBossGift.userName = nb5Var.m158750s();
                        continue;
                    case 34:
                        bLiveBossGift.userAvatar = nb5Var.m158750s();
                        continue;
                    case 42:
                        bLiveBossGift.otherUserId = nb5Var.m158750s();
                        continue;
                    case 50:
                        bLiveBossGift.otherUserName = nb5Var.m158750s();
                        continue;
                    case 58:
                        bLiveBossGift.giftName = nb5Var.m158750s();
                        continue;
                    case 64:
                        bLiveBossGift.giftNum = nb5Var.m158741j();
                        continue;
                    case 74:
                        bLiveBossGift.giftUrl = nb5Var.m158750s();
                        continue;
                    case 80:
                        bLiveBossGift.createdTime = nb5Var.m158742k();
                        continue;
                    default:
                        if (bLiveBossGift.userId == null) {
                            bLiveBossGift.userId = "";
        ...
        public void serialize(BLiveBossGift bLiveBossGift, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, bLiveBossGift.popularityValue);
            String str = bLiveBossGift.userId;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17250G(8, bLiveBossGift.giftNum);
            String str7 = bLiveBossGift.giftUrl;
            if (str7 != null) {
                codedOutputByteBufferNano.m17261R(9, str7);
            }
            codedOutputByteBufferNano.m17252I(10, bLiveBossGift.createdTime);
        }
    }
    ...
    public BLiveBossGift mo223809clone() {
        BLiveBossGift bLiveBossGift = new BLiveBossGift();
