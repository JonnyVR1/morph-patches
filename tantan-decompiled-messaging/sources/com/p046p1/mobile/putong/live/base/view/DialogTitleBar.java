...
public final class DialogTitleBar extends FrameLayout {
    ...
    private final AppCompatImageView getLeftView() {
        if (this.leftView == null) {
            ...
            layoutParams.leftMargin = t100.f167264m;
    ...
    public final void m68710a(View.OnClickListener listener) {
    }

    /* JADX INFO: renamed from: b */
    public final void m68711b(Context context) {
    }

    /* JADX INFO: renamed from: c */
    public final void m68712c(AppCompatImageView view, int type) {
        if (type == 1) {
            m68710a(this.backListener);
            view.setImageResource(g3c0.f100384F);
            xdl0.m208329E0(view, this.backListener);
            return;
        }
        if (type == 2) {
            m68710a(this.faqListener);
            view.setImageResource(g3c0.f100385G);
            xdl0.m208329E0(view, this.faqListener);
        } else if (type == 3) {
            m68710a(this.faqListener);
            view.setImageResource(g3c0.f100439r);
            xdl0.m208329E0(view, this.faqListener);
        } else {
            if (type != 4) {
                return;
            ...
            m68710a(this.backListener);
            view.setImageResource(g3c0.f100436p0);
            xdl0.m208329E0(view, this.backListener);
        }
    }

    /* JADX INFO: renamed from: d */
    public final void m68713d(int textRes, boolean whiteColor) {
        m68714e(getContext().getString(textRes), whiteColor);
    }

    /* JADX INFO: renamed from: e */
    public final void m68714e(@Nullable String text, boolean whiteColor) {
    ...
    public final void m68715f(@Nullable String text, int titleColor) {
        getTitleView().setText(text);
        getTitleView().setTextColor(kvc0.m147352a(titleColor));
    }
    ...
    public final void setDivider(boolean visible) {
        if (this.divider == null) {
            ...
            this.divider = view;
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, t100.f167254c);
        ...
        xdl0.m208344M(this.divider, visible);
        boolean z = this.isWhiteText;
    ...
    public final void setLeftView(int type) {
        m68712c(getLeftView(), type);
    }

    public final void setRightView(int type) {
        m68712c(getRightView(), type);
    }
