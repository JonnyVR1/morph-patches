...
public class BLiveHourLeaderBoardBattle extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveHourLeaderBoardBattle mo223809clone() {
        BLiveHourLeaderBoardBattle bLiveHourLeaderBoardBattle = new BLiveHourLeaderBoardBattle();
        ...
        if (list != null) {
            bLiveHourLeaderBoardBattle.missions = ValueObject.util_map(list, new w9j() { // from class: l.k12
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveHourLeaderBoardBattleGiftItem) obj).mo223809clone();
                }
            });
        }
        return bLiveHourLeaderBoardBattle;
