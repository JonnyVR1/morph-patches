...
public class BLiveMultiCall extends ValueObject implements Cloneable, Serializable {
        ...
        public boolean parseField(BLiveMultiCall bLiveMultiCall, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 12:
                    ...
                    return true;
                case 13:
                    bLiveMultiCall.f44400id = jsonParser.getValueAsString();
                    return false;
                case 14:
    ...
    public static /* synthetic */ String m68068a(String str) {
        return str;
    }
    ...
    public BLiveMultiCall mo223809clone() {
        BLiveMultiCall bLiveMultiCall = new BLiveMultiCall();
        bLiveMultiCall.f44400id = this.f44400id;
        ...
        if (list != null) {
            bLiveMultiCall.mutedByUserIds = ValueObject.util_map(list, new w9j() { // from class: l.w22
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveMultiCall.m68068a((String) obj);
                }
            });
        }
