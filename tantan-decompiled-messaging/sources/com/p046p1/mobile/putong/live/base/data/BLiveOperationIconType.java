...
public class BLiveOperationIconType extends TEnum {
    ...
    public class C11906a extends TEnumJsonAdapter<BLiveOperationIconType> {
    ...
    public class C11907b extends TEnumProtobufAdapter<BLiveOperationIconType> {
    ...
    static {
        C11906a c11906a = new C11906a();
        JSON_ADAPTER = c11906a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11907b();
        c11906a.addExtJsonValue("unknown_", -1);
        c11906a.addExtJsonValue("none", 0);
        c11906a.addExtJsonValue("countdown", 1);
        supportEnum.add("none");
        supportEnum.add("countdown");
        _BLiveOperationIconType = Collections.synchronizedMap(new e01());
    }
