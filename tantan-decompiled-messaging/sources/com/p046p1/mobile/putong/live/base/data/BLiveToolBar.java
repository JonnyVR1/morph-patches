...
import com.p046p1.mobile.putong.live.base.data.BLiveToolBar;
...
public class BLiveToolBar extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68269a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m68270b(String str) {
        return str;
    }
    ...
    public BLiveToolBar mo223809clone() {
        BLiveToolBar bLiveToolBar = new BLiveToolBar();
        List<String> list = this.audienceButtonOrder;
        if (list != null) {
            bLiveToolBar.audienceButtonOrder = ValueObject.util_map(list, new w9j() { // from class: l.x62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveToolBar.m68269a((String) obj);
                }
            });
        }
        List<String> list2 = this.anchorButtonOrder;
        if (list2 != null) {
            bLiveToolBar.anchorButtonOrder = ValueObject.util_map(list2, new w9j() { // from class: l.y62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveToolBar.m68270b((String) obj);
                }
            });
        }
        return bLiveToolBar;
