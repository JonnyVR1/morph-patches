...
public class BLiveGiftBubblePopupButtonJumpType extends TEnum {
    ...
    public class C11677a extends TEnumJsonAdapter<BLiveGiftBubblePopupButtonJumpType> {
    ...
    public class C11678b extends TEnumProtobufAdapter<BLiveGiftBubblePopupButtonJumpType> {
    ...
    static {
        C11677a c11677a = new C11677a();
        JSON_ADAPTER = c11677a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11678b();
        c11677a.addExtJsonValue("unknown_", -1);
        c11677a.addExtJsonValue("url", 0);
        c11677a.addExtJsonValue("schema", 1);
        supportEnum.add("url");
        supportEnum.add("schema");
        _BLiveGiftBubblePopupButtonJumpType = Collections.synchronizedMap(new e01());
    }
