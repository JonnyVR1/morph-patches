...
public class BLiveVoiceRoomInProfile extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68437a(String str) {
        return str;
    }
    ...
    public BLiveVoiceRoomInProfile mo223809clone() {
        BLiveVoiceRoomInProfile bLiveVoiceRoomInProfile = new BLiveVoiceRoomInProfile();
        ...
        if (list != null) {
            bLiveVoiceRoomInProfile.userAvatars = ValueObject.util_map(list, new w9j() { // from class: l.r92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveVoiceRoomInProfile.m68437a((String) obj);
                }
            });
        }
