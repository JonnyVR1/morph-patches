...
public class BLiveNiceNumberList extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68094a(String str) {
        return str;
    }
    ...
    public BLiveNiceNumberList mo223809clone() {
        BLiveNiceNumberList bLiveNiceNumberList = new BLiveNiceNumberList();
        List<String> list = this.numbers;
        if (list != null) {
            bLiveNiceNumberList.numbers = ValueObject.util_map(list, new w9j() { // from class: l.t32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveNiceNumberList.m68094a((String) obj);
                }
            });
        }
        return bLiveNiceNumberList;
