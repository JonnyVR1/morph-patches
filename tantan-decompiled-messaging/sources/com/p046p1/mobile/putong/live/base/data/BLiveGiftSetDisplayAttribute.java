...
public class BLiveGiftSetDisplayAttribute extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveGiftSetDisplayAttribute mo223809clone() {
        BLiveGiftSetDisplayAttribute bLiveGiftSetDisplayAttribute = new BLiveGiftSetDisplayAttribute();
        ...
        if (bLiveGiftSetDisplayAttributeItem != null) {
            bLiveGiftSetDisplayAttribute.tickerDisplayAttribute = bLiveGiftSetDisplayAttributeItem.mo223809clone();
        }
        ...
        if (bLiveGiftSetDisplayAttributeItem2 != null) {
            bLiveGiftSetDisplayAttribute.giftSetDescDisplayAttribute = bLiveGiftSetDisplayAttributeItem2.mo223809clone();
        }
        ...
        if (bLiveGiftSetDisplayAttributeItem3 != null) {
            bLiveGiftSetDisplayAttribute.giftDisplayAttribute = bLiveGiftSetDisplayAttributeItem3.mo223809clone();
        }
        ...
        if (bLiveGiftSetDisplayAttributeItem4 != null) {
            bLiveGiftSetDisplayAttribute.resourceDisplayAttribute = bLiveGiftSetDisplayAttributeItem4.mo223809clone();
        }
        ...
        if (bLiveGiftSetDisplayAttributeItem5 != null) {
            bLiveGiftSetDisplayAttribute.questionMarkDisplayAttribute = bLiveGiftSetDisplayAttributeItem5.mo223809clone();
        }
        return bLiveGiftSetDisplayAttribute;
    }
