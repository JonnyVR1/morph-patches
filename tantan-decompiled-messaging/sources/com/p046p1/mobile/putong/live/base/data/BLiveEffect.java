...
public class BLiveEffect extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveEffect> JSON_ADAPTER = new ObjectJsonAdapter<BLiveEffect>() { // from class: com.p1.mobile.putong.live.base.data.BLiveEffect.1
        ...
        public boolean parseField(BLiveEffect bLiveEffect, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "priority":
                    ...
                    return true;
                case "id":
                    bLiveEffect.f44359id = jsonParser.getValueAsString();
                    return false;
                case "md5":
        ...
        public void serializeFields(BLiveEffect bLiveEffect, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveEffect.f44359id;
            if (str != null) {
    ...
    public static /* synthetic */ String m67927a(String str) {
        return str;
    }
    ...
    public BLiveEffect mo223809clone() {
        BLiveEffect bLiveEffect = new BLiveEffect();
        bLiveEffect.f44359id = this.f44359id;
        ...
        if (list != null) {
            bLiveEffect.loadTypes = ValueObject.util_map(list, new w9j() { // from class: l.yy1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveEffect.m67927a((String) obj);
                }
            });
        }
        return bLiveEffect;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44359id, bLiveEffect.f44359id) && ValueObject.util_equals(this.zip, bLiveEffect.zip) && ValueObject.util_equals(this.md5, bLiveEffect.md5) && ValueObject.util_equals(this.type, bLiveEffect.type) && ValueObject.util_equals(this.hdType, bLiveEffect.hdType) && ValueObject.util_equals(this.priority, bLiveEffect.priority) && this.download == bLiveEffect.download && this.downloadType == bLiveEffect.downloadType && ValueObject.util_equals(this.loadTypes, bLiveEffect.loadTypes);
    }
