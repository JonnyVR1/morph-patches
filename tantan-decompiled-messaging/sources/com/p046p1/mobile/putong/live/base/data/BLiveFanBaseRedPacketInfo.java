...
public class BLiveFanBaseRedPacketInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveFanBaseRedPacketInfo mo223809clone() {
        BLiveFanBaseRedPacketInfo bLiveFanBaseRedPacketInfo = new BLiveFanBaseRedPacketInfo();
        ...
        if (bLiveFanBaseGift != null) {
            bLiveFanBaseRedPacketInfo.grabbedGiftContent = bLiveFanBaseGift.mo223809clone();
        }
        List<BLiveFanBaseGetRedPacketUser> list = this.histories;
        if (list != null) {
            bLiveFanBaseRedPacketInfo.histories = ValueObject.util_map(list, new w9j() { // from class: l.rz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveFanBaseGetRedPacketUser) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveFanBaseRedPacketInfo.giftContent = ValueObject.util_map(list2, new w9j() { // from class: l.sz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveFanBaseGift) obj).mo223809clone();
                }
            });
        }
