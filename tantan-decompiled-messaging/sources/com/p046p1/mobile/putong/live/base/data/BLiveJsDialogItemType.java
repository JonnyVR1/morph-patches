...
public class BLiveJsDialogItemType extends ValueObject implements Cloneable, Serializable {
    ...
    public f30<String, String> actionListener;
    ...
    public static /* synthetic */ String m68037a(String str) {
        return str;
    }
    ...
    public BLiveJsDialogItemType mo223809clone() {
        BLiveJsDialogItemType bLiveJsDialogItemType = new BLiveJsDialogItemType();
        ...
        if (list != null) {
            bLiveJsDialogItemType.btnBgColors = ValueObject.util_map(list, new w9j() { // from class: l.u12
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveJsDialogItemType.m68037a((String) obj);
                }
            });
        }
