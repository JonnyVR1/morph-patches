...
public class BLiveSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68216c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m68219f(String str) {
        return str;
    }
    ...
    public BLiveSettings mo223809clone() {
        BLiveSettings bLiveSettings = new BLiveSettings();
        BLiveConfig bLiveConfig = this.liveConfig;
        if (bLiveConfig != null) {
            bLiveSettings.liveConfig = bLiveConfig.mo223809clone();
        }
        List<BLiveTemplate> list = this.templates;
        if (list != null) {
            bLiveSettings.templates = ValueObject.util_map(list, new w9j() { // from class: l.j52
                @Override // p149l.w9j
        ...
        if (bLivePreDefineMessages != null) {
            bLiveSettings.predefineMessages = bLivePreDefineMessages.mo223809clone();
        }
        List<String> list2 = this.sensitiveWords;
        if (list2 != null) {
            bLiveSettings.sensitiveWords = ValueObject.util_map(list2, new w9j() { // from class: l.k52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveSettings.m68216c((String) obj);
                }
            });
        }
        List<BLiveLabel> list3 = this.liveLabels;
        if (list3 != null) {
            bLiveSettings.liveLabels = ValueObject.util_map(list3, new w9j() { // from class: l.l52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveLabel) obj).mo223809clone();
                }
            });
        }
        List<BLiveSquareTab> list4 = this.liveSquareTabs;
        if (list4 != null) {
            bLiveSettings.liveSquareTabs = ValueObject.util_map(list4, new w9j() { // from class: l.m52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSquareTab) obj).mo223809clone();
                }
            });
        }
        BLiveCommonConfig bLiveCommonConfig = this.chatTips;
        if (bLiveCommonConfig != null) {
            bLiveSettings.chatTips = bLiveCommonConfig.mo223809clone();
        }
        List<BLiveSquareTab> list5 = this.liveSquareExtTabs;
        if (list5 != null) {
            bLiveSettings.liveSquareExtTabs = ValueObject.util_map(list5, new w9j() { // from class: l.n52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSquareTab) obj).mo223809clone();
                }
        ...
        if (bLiveIntlLiveTemplatesCdnData != null) {
            bLiveSettings.intlLiveTemplatesMetadata = bLiveIntlLiveTemplatesCdnData.mo223809clone();
        }
        BLiveIntlLiveConfig bLiveIntlLiveConfig = this.intlLiveConfig;
        if (bLiveIntlLiveConfig != null) {
            bLiveSettings.intlLiveConfig = bLiveIntlLiveConfig.mo223809clone();
        }
        BLiveVideoChatConfig bLiveVideoChatConfig = this.videoChatConfig;
        if (bLiveVideoChatConfig != null) {
            bLiveSettings.videoChatConfig = bLiveVideoChatConfig.mo223809clone();
        }
        ...
        if (liveConfig != null) {
            bLiveSettings.tttLiveConfig = liveConfig.mo223809clone();
        }
        return bLiveSettings;
    }
