...
public class BLiveMagicList extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68047a(String str) {
        return str;
    }
    ...
    public BLiveMagicList mo223809clone() {
        BLiveMagicList bLiveMagicList = new BLiveMagicList();
        ...
        if (list != null) {
            bLiveMagicList.dynamicEffect = ValueObject.util_map(list, new w9j() { // from class: l.b22
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveDynamicEffect) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveMagicList.filterLiveMode = ValueObject.util_map(list2, new w9j() { // from class: l.c22
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveMagicList.m68047a((String) obj);
                }
            });
        }
        return bLiveMagicList;
