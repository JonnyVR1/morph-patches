...
public class BLiveUserDressUp extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveUserDressUp> JSON_ADAPTER = new ObjectJsonAdapter<BLiveUserDressUp>() { // from class: com.p1.mobile.putong.live.base.data.BLiveUserDressUp.1
        ...
        public boolean parseField(BLiveUserDressUp bLiveUserDressUp, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "jumpInfo":
                    ...
                    return true;
                case "id":
                    bLiveUserDressUp.f44470id = jsonParser.getValueAsString();
                    return false;
                case "desc":
        ...
        public void serializeFields(BLiveUserDressUp bLiveUserDressUp, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveUserDressUp.f44470id;
            if (str != null) {
    ...
    public BLiveUserDressUp mo223809clone() {
        BLiveUserDressUp bLiveUserDressUp = new BLiveUserDressUp();
        bLiveUserDressUp.f44470id = this.f44470id;
        ...
        if (bLiveJumpInfo != null) {
            bLiveUserDressUp.jumpInfo = bLiveJumpInfo.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44470id, bLiveUserDressUp.f44470id) && ValueObject.util_equals(this.imageUrl, bLiveUserDressUp.imageUrl) && ValueObject.util_equals(this.name, bLiveUserDressUp.name) && ValueObject.util_equals(this.type, bLiveUserDressUp.type) && ValueObject.util_equals(this.desc, bLiveUserDressUp.desc) && ValueObject.util_equals(this.jumpInfo, bLiveUserDressUp.jumpInfo) && ValueObject.util_equals(this.placeType, bLiveUserDressUp.placeType);
    }
