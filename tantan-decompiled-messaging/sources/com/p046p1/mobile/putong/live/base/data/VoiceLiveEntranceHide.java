...
public class VoiceLiveEntranceHide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VoiceLiveEntranceHide> PROTOBUF_ADAPTER = new C12448a();
    ...
    public class C12448a extends MessageNanoAdapter<VoiceLiveEntranceHide> {
        public C12448a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(VoiceLiveEntranceHide voiceLiveEntranceHide) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, voiceLiveEntranceHide.bottomRecreation) + CodedOutputByteBufferNano.m17220b(2, voiceLiveEntranceHide.messageListRecommend) + CodedOutputByteBufferNano.m17220b(3, voiceLiveEntranceHide.messageListRightBottom) + CodedOutputByteBufferNano.m17220b(4, voiceLiveEntranceHide.messageListChatDynamic) + CodedOutputByteBufferNano.m17220b(5, voiceLiveEntranceHide.messageFriendHead) + CodedOutputByteBufferNano.m17220b(6, voiceLiveEntranceHide.messageChatShare) + CodedOutputByteBufferNano.m17220b(7, voiceLiveEntranceHide.messageHelperMessage) + CodedOutputByteBufferNano.m17220b(8, voiceLiveEntranceHide.push) + CodedOutputByteBufferNano.m17220b(9, voiceLiveEntranceHide.slideCard);
            voiceLiveEntranceHide.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public VoiceLiveEntranceHide parse(nb5 nb5Var) throws IOException {
            VoiceLiveEntranceHide voiceLiveEntranceHide = new VoiceLiveEntranceHide();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    voiceLiveEntranceHide.bottomRecreation = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    voiceLiveEntranceHide.messageListRecommend = nb5Var.m158738g();
                } else if (iM158752u == 24) {
                    voiceLiveEntranceHide.messageListRightBottom = nb5Var.m158738g();
                } else if (iM158752u == 32) {
                    voiceLiveEntranceHide.messageListChatDynamic = nb5Var.m158738g();
                } else if (iM158752u == 40) {
                    voiceLiveEntranceHide.messageFriendHead = nb5Var.m158738g();
                } else if (iM158752u == 48) {
                    voiceLiveEntranceHide.messageChatShare = nb5Var.m158738g();
                } else if (iM158752u == 56) {
                    voiceLiveEntranceHide.messageHelperMessage = nb5Var.m158738g();
                } else if (iM158752u == 64) {
                    voiceLiveEntranceHide.push = nb5Var.m158738g();
                } else {
                    if (iM158752u != 72) {
                        return voiceLiveEntranceHide;
                    }
                    voiceLiveEntranceHide.slideCard = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(VoiceLiveEntranceHide voiceLiveEntranceHide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, voiceLiveEntranceHide.bottomRecreation);
            codedOutputByteBufferNano.m17244A(2, voiceLiveEntranceHide.messageListRecommend);
            codedOutputByteBufferNano.m17244A(3, voiceLiveEntranceHide.messageListRightBottom);
            codedOutputByteBufferNano.m17244A(4, voiceLiveEntranceHide.messageListChatDynamic);
            codedOutputByteBufferNano.m17244A(5, voiceLiveEntranceHide.messageFriendHead);
            codedOutputByteBufferNano.m17244A(6, voiceLiveEntranceHide.messageChatShare);
            codedOutputByteBufferNano.m17244A(7, voiceLiveEntranceHide.messageHelperMessage);
            codedOutputByteBufferNano.m17244A(8, voiceLiveEntranceHide.push);
            codedOutputByteBufferNano.m17244A(9, voiceLiveEntranceHide.slideCard);
        }
    }
    ...
    public VoiceLiveEntranceHide mo223809clone() {
        VoiceLiveEntranceHide voiceLiveEntranceHide = new VoiceLiveEntranceHide();
