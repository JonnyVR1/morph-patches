...
public class BLiveDynamicEffect extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m67925a(Integer num) {
        return num;
    }
    ...
    public BLiveDynamicEffect mo223809clone() {
        BLiveDynamicEffect bLiveDynamicEffect = new BLiveDynamicEffect();
        ...
        if (list != null) {
            bLiveDynamicEffect.region = ValueObject.util_map(list, new w9j() { // from class: l.wy1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveDynamicEffect.m67925a((Integer) obj);
                }
            });
        }
        return bLiveDynamicEffect;
