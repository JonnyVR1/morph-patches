...
public class BLiveSignInAchievementMedals extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68225a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m68226b(Integer num) {
        return num;
    }
    ...
    public BLiveSignInAchievementMedals mo223809clone() {
        BLiveSignInAchievementMedals bLiveSignInAchievementMedals = new BLiveSignInAchievementMedals();
        List<BLiveSignInMedal> list = this.medals;
        if (list != null) {
            bLiveSignInAchievementMedals.medals = ValueObject.util_map(list, new w9j() { // from class: l.r52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSignInMedal) obj).mo223809clone();
                }
            });
        }
        List<Integer> list2 = this.progress;
        if (list2 != null) {
            bLiveSignInAchievementMedals.progress = ValueObject.util_map(list2, new w9j() { // from class: l.s52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveSignInAchievementMedals.m68226b((Integer) obj);
                }
            });
        }
        List<String> list3 = this.explainContents;
        if (list3 != null) {
            bLiveSignInAchievementMedals.explainContents = ValueObject.util_map(list3, new w9j() { // from class: l.t52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveSignInAchievementMedals.m68225a((String) obj);
                }
            });
        }
        return bLiveSignInAchievementMedals;
