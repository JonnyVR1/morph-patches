...
public class BLiveNewGiftSkinTab extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68079a(String str) {
        return str;
    }
    ...
    public BLiveNewGiftSkinTab mo223809clone() {
        BLiveNewGiftSkinTab bLiveNewGiftSkinTab = new BLiveNewGiftSkinTab();
        bLiveNewGiftSkinTab.name = this.name;
        List<String> list = this.skinIds;
        if (list != null) {
            bLiveNewGiftSkinTab.skinIds = ValueObject.util_map(list, new w9j() { // from class: l.e32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveNewGiftSkinTab.m68079a((String) obj);
                }
            });
        }
        return bLiveNewGiftSkinTab;
