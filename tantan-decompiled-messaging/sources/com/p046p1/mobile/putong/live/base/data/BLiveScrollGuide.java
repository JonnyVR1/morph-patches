...
import com.p046p1.mobile.putong.live.base.data.BLiveScrollGuide;
...
public class BLiveScrollGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m68207a(Integer num) {
        return num;
    }
    ...
    public BLiveScrollGuide mo223809clone() {
        BLiveScrollGuide bLiveScrollGuide = new BLiveScrollGuide();
        bLiveScrollGuide.animationInterval = this.animationInterval;
        List<Integer> list = this.intervalDays;
        if (list != null) {
            bLiveScrollGuide.intervalDays = ValueObject.util_map(list, new w9j() { // from class: l.f52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveScrollGuide.m68207a((Integer) obj);
                }
            });
        }
