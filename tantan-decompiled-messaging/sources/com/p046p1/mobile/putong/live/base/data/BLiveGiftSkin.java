...
public class BLiveGiftSkin extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveGiftSkin> JSON_ADAPTER = new ObjectJsonAdapter<BLiveGiftSkin>() { // from class: com.p1.mobile.putong.live.base.data.BLiveGiftSkin.1
        ...
        public boolean parseField(BLiveGiftSkin bLiveGiftSkin, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "cornerBg":
                    ...
                    return true;
                case "bg":
                    bLiveGiftSkin.f44383bg = BLiveGiftSkinBg.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "id":
                    bLiveGiftSkin.f44384id = jsonParser.getValueAsString();
                    return false;
                case "top":
        ...
        public void serializeFields(BLiveGiftSkin bLiveGiftSkin, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveGiftSkin.f44384id;
            if (str != null) {
            ...
            if (bLiveGiftSkin.f44383bg != null) {
                jsonGenerator.writeFieldName(Constants.KEY_BG);
                BLiveGiftSkinBg.JSON_ADAPTER.serialize(bLiveGiftSkin.f44383bg, jsonGenerator, true);
            }
    ...
    public BLiveGiftSkinBg f44383bg;
    ...
    public static /* synthetic */ Integer m67994a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m67995b(Integer num) {
        return num;
    }
    ...
    public BLiveGiftSkin mo223809clone() {
        BLiveGiftSkin bLiveGiftSkin = new BLiveGiftSkin();
        bLiveGiftSkin.f44384id = this.f44384id;
        BLiveGiftSkinTop bLiveGiftSkinTop = this.top;
        if (bLiveGiftSkinTop != null) {
            bLiveGiftSkin.top = bLiveGiftSkinTop.mo223809clone();
        }
        BLiveGiftSkinBg bLiveGiftSkinBg = this.f44383bg;
        if (bLiveGiftSkinBg != null) {
            bLiveGiftSkin.f44383bg = bLiveGiftSkinBg.mo223809clone();
        }
        BLiveGiftSkinBg bLiveGiftSkinBg2 = this.interlayer;
        if (bLiveGiftSkinBg2 != null) {
            bLiveGiftSkin.interlayer = bLiveGiftSkinBg2.mo223809clone();
        }
        BLiveGiftSkinBg bLiveGiftSkinBg3 = this.cornerBg;
        if (bLiveGiftSkinBg3 != null) {
            bLiveGiftSkin.cornerBg = bLiveGiftSkinBg3.mo223809clone();
        }
        List<Integer> list = this.bindTabId;
        if (list != null) {
            bLiveGiftSkin.bindTabId = ValueObject.util_map(list, new w9j() { // from class: l.v02
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveGiftSkin.m67994a((Integer) obj);
                }
            });
        }
        List<Integer> list2 = this.bindGiftId;
        if (list2 != null) {
            bLiveGiftSkin.bindGiftId = ValueObject.util_map(list2, new w9j() { // from class: l.w02
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveGiftSkin.m67995b((Integer) obj);
                }
            });
        }
        return bLiveGiftSkin;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44384id, bLiveGiftSkin.f44384id) && ValueObject.util_equals(this.top, bLiveGiftSkin.top) && ValueObject.util_equals(this.f44383bg, bLiveGiftSkin.f44383bg) && ValueObject.util_equals(this.interlayer, bLiveGiftSkin.interlayer) && ValueObject.util_equals(this.cornerBg, bLiveGiftSkin.cornerBg) && ValueObject.util_equals(this.bindTabId, bLiveGiftSkin.bindTabId) && ValueObject.util_equals(this.bindGiftId, bLiveGiftSkin.bindGiftId);
    }
    ...
    public void nullCheck() {
        if (this.f44384id == null) {
            this.f44384id = "";
        }
        if (this.top == null) {
            this.top = BLiveGiftSkinTop.new_();
        }
        if (this.f44383bg == null) {
            this.f44383bg = BLiveGiftSkinBg.new_();
        }
