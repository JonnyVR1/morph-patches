...
public class BLiveOperationActionAfterClick extends TEnum {
    ...
    public class C11892a extends TEnumJsonAdapter<BLiveOperationActionAfterClick> {
    ...
    public class C11893b extends TEnumProtobufAdapter<BLiveOperationActionAfterClick> {
    ...
    static {
        ...
        JSON_ADAPTER = c11892a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11893b();
        c11892a.addExtJsonValue("unknown_", -1);
        c11892a.addExtJsonValue("jumpToScheme", 0);
        c11892a.addExtJsonValue("h5Drawer", 1);
        supportEnum.add("jumpToScheme");
        supportEnum.add("h5Drawer");
        _BLiveOperationActionAfterClick = Collections.synchronizedMap(new e01());
    }
