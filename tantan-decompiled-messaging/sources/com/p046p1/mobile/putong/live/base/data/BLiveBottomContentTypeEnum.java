...
public class BLiveBottomContentTypeEnum extends TEnum {
    ...
    public class C11519a extends TEnumJsonAdapter<BLiveBottomContentTypeEnum> {
    ...
    public class C11520b extends TEnumProtobufAdapter<BLiveBottomContentTypeEnum> {
    ...
    static {
        ...
        JSON_ADAPTER = c11519a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11520b();
        c11519a.addExtJsonValue("unknown_", -1);
        supportEnum.add("text");
        supportEnum.add("picture");
        supportEnum.add("countdown");
        _BLiveBottomContentTypeEnum = Collections.synchronizedMap(new e01());
    }
