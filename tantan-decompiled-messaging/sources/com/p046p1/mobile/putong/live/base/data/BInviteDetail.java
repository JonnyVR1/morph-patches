...
public class BInviteDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public String title;
    public static ProtobufAdapter<BInviteDetail> PROTOBUF_ADAPTER = new C11451a();
    ...
    public class C11451a extends MessageNanoAdapter<BInviteDetail> {
        public C11451a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BInviteDetail bInviteDetail) {
            ...
            bInviteDetail.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BInviteDetail parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    bInviteDetail.title = nb5Var.m158750s();
                } else {
                    if (iM158752u != 18) {
                        if (bInviteDetail.title == null) {
                            bInviteDetail.title = "";
                    ...
                    bInviteDetail.subTitle = nb5Var.m158750s();
                }
            }
            return bInviteDetail;
        }
    ...
    public BInviteDetail mo223809clone() {
        BInviteDetail bInviteDetail = new BInviteDetail();
