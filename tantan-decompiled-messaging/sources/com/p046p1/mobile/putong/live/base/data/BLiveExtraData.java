...
public class BLiveExtraData extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveExtraData mo223809clone() {
        BLiveExtraData bLiveExtraData = new BLiveExtraData();
        BLiveNewGiftWallDetailInfoItem bLiveNewGiftWallDetailInfoItem = this.giftWallV2;
        if (bLiveNewGiftWallDetailInfoItem != null) {
            bLiveExtraData.giftWallV2 = bLiveNewGiftWallDetailInfoItem.mo223809clone();
        }
        BLiveShootGameInfo bLiveShootGameInfo = this.shootGameUserInfo;
        if (bLiveShootGameInfo != null) {
            bLiveExtraData.shootGameUserInfo = bLiveShootGameInfo.mo223809clone();
        }
        BLiveShootGameTask bLiveShootGameTask = this.shootGameTask;
        if (bLiveShootGameTask != null) {
            bLiveExtraData.shootGameTask = bLiveShootGameTask.mo223809clone();
        }
        BLiveUndercoverGame bLiveUndercoverGame = this.undercoverGame;
        if (bLiveUndercoverGame != null) {
            bLiveExtraData.undercoverGame = bLiveUndercoverGame.mo223809clone();
        }
        BLiveUnJailAnchorInfo bLiveUnJailAnchorInfo = this.anchorInfo;
        if (bLiveUnJailAnchorInfo != null) {
            bLiveExtraData.anchorInfo = bLiveUnJailAnchorInfo.mo223809clone();
        }
        BLiveWealthLogoInfo bLiveWealthLogoInfo = this.wealthLogo;
        if (bLiveWealthLogoInfo != null) {
            bLiveExtraData.wealthLogo = bLiveWealthLogoInfo.mo223809clone();
        }
        BLiveMatchRelationshipInfo bLiveMatchRelationshipInfo = this.confessionRelationship;
        if (bLiveMatchRelationshipInfo != null) {
            bLiveExtraData.confessionRelationship = bLiveMatchRelationshipInfo.mo223809clone();
        }
        List<BLiveSendLiveMultiGiftResultItem> list = this.batchGivenGiftRes;
        if (list != null) {
            bLiveExtraData.batchGivenGiftRes = ValueObject.util_map(list, new w9j() { // from class: l.lz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSendLiveMultiGiftResultItem) obj).mo223809clone();
                }
            });
        }
        List<BLiveBlackListItem> list2 = this.blackList;
        if (list2 != null) {
            bLiveExtraData.blackList = ValueObject.util_map(list2, new w9j() { // from class: l.mz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveBlackListItem) obj).mo223809clone();
                }
            });
        }
        List<BLiveVoiceVirtualRoomSettleItem> list3 = this.voiceSettles;
        if (list3 != null) {
            bLiveExtraData.voiceSettles = ValueObject.util_map(list3, new w9j() { // from class: l.nz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveVoiceVirtualRoomSettleItem) obj).mo223809clone();
                }
            });
        }
        BLiveVoiceRoomProfile bLiveVoiceRoomProfile = this.voiceRoomProfile;
        if (bLiveVoiceRoomProfile != null) {
            bLiveExtraData.voiceRoomProfile = bLiveVoiceRoomProfile.mo223809clone();
        }
        BLiveCoin bLiveCoin = this.coins;
        if (bLiveCoin != null) {
            bLiveExtraData.coins = bLiveCoin.mo223809clone();
        }
        List<BLiveSchema> list4 = this.liveSchemas;
        if (list4 != null) {
            bLiveExtraData.liveSchemas = ValueObject.util_map(list4, new w9j() { // from class: l.oz1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSchema) obj).mo223809clone();
                }
            });
        }
        BLiveCoin bLiveCoin2 = this.diamond;
        if (bLiveCoin2 != null) {
            bLiveExtraData.diamond = bLiveCoin2.mo223809clone();
        }
        return bLiveExtraData;
    }
