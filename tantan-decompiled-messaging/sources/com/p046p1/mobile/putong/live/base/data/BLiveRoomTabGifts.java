...
public class BLiveRoomTabGifts extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveRoomTabGifts mo223809clone() {
        BLiveRoomTabGifts bLiveRoomTabGifts = new BLiveRoomTabGifts();
        ...
        if (list != null) {
            bLiveRoomTabGifts.giftTabs = ValueObject.util_map(list, new w9j() { // from class: l.c52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveTabGiftItem) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveRoomTabGifts.bagpackTabs = ValueObject.util_map(list2, new w9j() { // from class: l.d52
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveTabGiftItem) obj).mo223809clone();
                }
        ...
        if (bLivePacketSystemCommentStatus != null) {
            bLiveRoomTabGifts.bagSystemCommentStatus = bLivePacketSystemCommentStatus.mo223809clone();
        }
        return bLiveRoomTabGifts;
    }
