...
public class BLiveVoiceUserProfileMiddleCardType extends TEnum {
    ...
    public class C12406a extends TEnumJsonAdapter<BLiveVoiceUserProfileMiddleCardType> {
    ...
    public class C12407b extends TEnumProtobufAdapter<BLiveVoiceUserProfileMiddleCardType> {
    ...
    static {
        C12406a c12406a = new C12406a();
        JSON_ADAPTER = c12406a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12407b();
        c12406a.addExtJsonValue("unknown_", -1);
        ...
        _BLiveVoiceUserProfileMiddleCardType = Collections.synchronizedMap(new e01());
    }
