...
public class BLiveVoiceLiveConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceLiveConfig mo223809clone() {
        BLiveVoiceLiveConfig bLiveVoiceLiveConfig = new BLiveVoiceLiveConfig();
        ...
        if (bLiveVoiceFeedStyle != null) {
            bLiveVoiceLiveConfig.feedStyle = bLiveVoiceFeedStyle.mo223809clone();
        }
        ...
        if (list != null) {
            bLiveVoiceLiveConfig.operateMenu = ValueObject.util_map(list, new w9j() { // from class: l.b92
                @Override // p149l.w9j
        ...
        if (list2 != null) {
            bLiveVoiceLiveConfig.audienceOperateMenu = ValueObject.util_map(list2, new w9j() { // from class: l.c92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveCommonViewConfig) obj).mo223809clone();
                }
        ...
        if (bLiveVoiceCreateRoomNotify != null) {
            bLiveVoiceLiveConfig.ownerCreateRoomNotify = bLiveVoiceCreateRoomNotify.mo223809clone();
        }
        ...
        if (bLiveVoiceSparkReportConfig != null) {
            bLiveVoiceLiveConfig.voiceLiveSparkletReportConfig = bLiveVoiceSparkReportConfig.mo223809clone();
        }
        BLiveVoiceQuickGiftConfig bLiveVoiceQuickGiftConfig = this.quickGiftConfig;
        if (bLiveVoiceQuickGiftConfig != null) {
            bLiveVoiceLiveConfig.quickGiftConfig = bLiveVoiceQuickGiftConfig.mo223809clone();
        }
        ...
        if (bLiveVoiceRecordConfig != null) {
            bLiveVoiceLiveConfig.voiceRecordConfig = bLiveVoiceRecordConfig.mo223809clone();
        }
        ...
        if (bLiveVoiceRankingBoard != null) {
            bLiveVoiceLiveConfig.voiceLeaderboard = bLiveVoiceRankingBoard.mo223809clone();
        }
        BLiveVoiceRoomPopRefresh bLiveVoiceRoomPopRefresh = this.roomPopRefresh;
        if (bLiveVoiceRoomPopRefresh != null) {
            bLiveVoiceLiveConfig.roomPopRefresh = bLiveVoiceRoomPopRefresh.mo223809clone();
        }
        BLiveVoiceSweetCpConfig bLiveVoiceSweetCpConfig = this.voiceCpConfig;
        if (bLiveVoiceSweetCpConfig != null) {
            bLiveVoiceLiveConfig.voiceCpConfig = bLiveVoiceSweetCpConfig.mo223809clone();
        }
        ...
        if (bLiveVoiceNewOperationConfig != null) {
            bLiveVoiceLiveConfig.intlVoiceBannerConfig = bLiveVoiceNewOperationConfig.mo223809clone();
        }
        BLiveVoiceGiftWallConfig bLiveVoiceGiftWallConfig = this.voiceGiftWallConfig;
        if (bLiveVoiceGiftWallConfig != null) {
            bLiveVoiceLiveConfig.voiceGiftWallConfig = bLiveVoiceGiftWallConfig.mo223809clone();
        }
        ...
        if (bLiveVoiceSmallWindow != null) {
            bLiveVoiceLiveConfig.smallWindow = bLiveVoiceSmallWindow.mo223809clone();
        }
        BLiveVoiceShareConfig bLiveVoiceShareConfig = this.shareConfig;
        if (bLiveVoiceShareConfig != null) {
            bLiveVoiceLiveConfig.shareConfig = bLiveVoiceShareConfig.mo223809clone();
        }
        ...
        if (bLiveIntlShareCongfig != null) {
            bLiveVoiceLiveConfig.intlShareConfig = bLiveIntlShareCongfig.mo223809clone();
        }
        ...
        if (bLiveVoiceSingTogetherConfig != null) {
            bLiveVoiceLiveConfig.intlVoiceSingGameConfig = bLiveVoiceSingTogetherConfig.mo223809clone();
        }
        ...
        if (list3 != null) {
            bLiveVoiceLiveConfig.intlFlyMicEffectConfig = ValueObject.util_map(list3, new w9j() { // from class: l.d92
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveIntlFlyMicEffectConfig) obj).mo223809clone();
                }
            });
        }
        ...
        if (bLiveVoiceCpConfig != null) {
            bLiveVoiceLiveConfig.intlVoiceCpConfig = bLiveVoiceCpConfig.mo223809clone();
        }
