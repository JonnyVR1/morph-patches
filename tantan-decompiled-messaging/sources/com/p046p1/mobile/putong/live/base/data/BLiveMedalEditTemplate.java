...
public class BLiveMedalEditTemplate extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveMedalEditTemplate mo223809clone() {
        BLiveMedalEditTemplate bLiveMedalEditTemplate = new BLiveMedalEditTemplate();
        List<BLiveMedalColor> list = this.colors;
        if (list != null) {
            bLiveMedalEditTemplate.colors = ValueObject.util_map(list, new w9j() { // from class: l.f22
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveMedalColor) obj).mo223809clone();
                }
            });
        }
        List<BLiveMedalIcon> list2 = this.icons;
        if (list2 != null) {
            bLiveMedalEditTemplate.icons = ValueObject.util_map(list2, new w9j() { // from class: l.g22
                @Override // p149l.w9j
                public final Object call(Object obj) {
