...
public class BLivePKCardShowListWithBoth extends ValueObject implements Cloneable, Serializable {
    ...
    public BLivePKCardShowListWithBoth mo223809clone() {
        BLivePKCardShowListWithBoth bLivePKCardShowListWithBoth = new BLivePKCardShowListWithBoth();
        List<BLivePKCardItem> list = this.BLiveUserItemCards;
        if (list != null) {
            bLivePKCardShowListWithBoth.BLiveUserItemCards = ValueObject.util_map(list, new w9j() { // from class: l.x32
                @Override // p149l.w9j
        ...
        if (list2 != null) {
            bLivePKCardShowListWithBoth.BLiveOtherUserItemCardsList = ValueObject.util_map(list2, new w9j() { // from class: l.y32
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLivePKCardItem) obj).mo223809clone();
                }
