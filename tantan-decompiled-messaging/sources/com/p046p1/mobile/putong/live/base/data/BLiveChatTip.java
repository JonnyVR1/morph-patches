...
public class BLiveChatTip extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m67746a(String str) {
        return str;
    }
    ...
    public BLiveChatTip mo223809clone() {
        BLiveChatTip bLiveChatTip = new BLiveChatTip();
        bLiveChatTip.title = this.title;
        bLiveChatTip.isDefault = this.isDefault;
        List<String> list = this.tips;
        if (list != null) {
            bLiveChatTip.tips = ValueObject.util_map(list, new w9j() { // from class: l.ls1
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return BLiveChatTip.m67746a((String) obj);
                }
            });
        }
        return bLiveChatTip;
