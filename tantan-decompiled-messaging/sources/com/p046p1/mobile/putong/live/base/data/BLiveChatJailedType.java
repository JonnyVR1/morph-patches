...
public class BLiveChatJailedType extends TEnum {
    ...
    public class C11558a extends TEnumJsonAdapter<BLiveChatJailedType> {
    ...
    public class C11559b extends TEnumProtobufAdapter<BLiveChatJailedType> {
    ...
    static {
        ...
        JSON_ADAPTER = c11558a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11559b();
        c11558a.addExtJsonValue("unknown_", -1);
        c11558a.addExtJsonValue(All, 0);
        c11558a.addExtJsonValue(FollowerAndManager, 1);
        c11558a.addExtJsonValue(Manager, 2);
        c11558a.addExtJsonValue(None, 3);
        supportEnum.add(All);
        supportEnum.add(FollowerAndManager);
        supportEnum.add(Manager);
        supportEnum.add(None);
        _BLiveChatJailedType = Collections.synchronizedMap(new e01());
    }
