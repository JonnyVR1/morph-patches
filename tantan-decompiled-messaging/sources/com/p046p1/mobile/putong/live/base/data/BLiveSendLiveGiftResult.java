...
public class BLiveSendLiveGiftResult extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveSendLiveGiftResult mo223809clone() {
        BLiveSendLiveGiftResult bLiveSendLiveGiftResult = new BLiveSendLiveGiftResult();
        ...
        if (bLiveGivenGiftBrief != null) {
            bLiveSendLiveGiftResult.givenGiftBrief = bLiveGivenGiftBrief.mo223809clone();
        }
        BLiveUserMask bLiveUserMask = this.mask;
        if (bLiveUserMask != null) {
            bLiveSendLiveGiftResult.mask = bLiveUserMask.mo223809clone();
        }
        ...
        if (bLiveGiftMultiCall != null) {
            bLiveSendLiveGiftResult.multiCall = bLiveGiftMultiCall.mo223809clone();
        }
        BLiveGiftMultiCall bLiveGiftMultiCall2 = this.guildCall;
        if (bLiveGiftMultiCall2 != null) {
            bLiveSendLiveGiftResult.guildCall = bLiveGiftMultiCall2.mo223809clone();
        }
        ...
        if (bLivePacketSystemCommentStatus != null) {
            bLiveSendLiveGiftResult.bagSystemCommentStatus = bLivePacketSystemCommentStatus.mo223809clone();
        }
        BLiveUserMask bLiveUserMask2 = this.receiveMask;
        if (bLiveUserMask2 != null) {
            bLiveSendLiveGiftResult.receiveMask = bLiveUserMask2.mo223809clone();
        }
        ...
        if (bLiveGiftExtraVideoChat != null) {
            bLiveSendLiveGiftResult.videoChat = bLiveGiftExtraVideoChat.mo223809clone();
        }
        ...
        if (bLiveUserMask3 != null) {
            bLiveSendLiveGiftResult.previewMask = bLiveUserMask3.mo223809clone();
        }
        BLiveUserMask bLiveUserMask4 = this.senderShowMask;
        if (bLiveUserMask4 != null) {
            bLiveSendLiveGiftResult.senderShowMask = bLiveUserMask4.mo223809clone();
        }
        BLiveUserMask bLiveUserMask5 = this.receiverShowMask;
        if (bLiveUserMask5 != null) {
            bLiveSendLiveGiftResult.receiverShowMask = bLiveUserMask5.mo223809clone();
        }
        return bLiveSendLiveGiftResult;
    }
