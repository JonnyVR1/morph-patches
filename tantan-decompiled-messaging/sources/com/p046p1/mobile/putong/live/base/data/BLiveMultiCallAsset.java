...
public class BLiveMultiCallAsset extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveMultiCallAsset> JSON_ADAPTER = new ObjectJsonAdapter<BLiveMultiCallAsset>() { // from class: com.p1.mobile.putong.live.base.data.BLiveMultiCallAsset.1
        ...
        public boolean parseField(BLiveMultiCallAsset bLiveMultiCallAsset, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "freeCall":
                    ...
                    return true;
                case "id":
                    bLiveMultiCallAsset.f44402id = jsonParser.getValueAsString();
                    return false;
                case "type":
        ...
        public void serializeFields(BLiveMultiCallAsset bLiveMultiCallAsset, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveMultiCallAsset.f44402id;
            if (str != null) {
    ...
    public BLiveMultiCallAsset mo223809clone() {
        BLiveMultiCallAsset bLiveMultiCallAsset = new BLiveMultiCallAsset();
        bLiveMultiCallAsset.f44402id = this.f44402id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44402id, bLiveMultiCallAsset.f44402id) && ValueObject.util_equals(this.type, bLiveMultiCallAsset.type) && this.freeCall == bLiveMultiCallAsset.freeCall && this.rejectInvite == bLiveMultiCallAsset.rejectInvite && this.multiCallSwitch == bLiveMultiCallAsset.multiCallSwitch && ValueObject.util_equals(this.multiCallOrder, bLiveMultiCallAsset.multiCallOrder) && this.canSwitchMaxCallNum == bLiveMultiCallAsset.canSwitchMaxCallNum && this.maxCallNum == bLiveMultiCallAsset.maxCallNum;
    }
