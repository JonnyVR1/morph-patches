...
public class BLiveVoiceStarRedPacket extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVoiceStarRedPacket> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceStarRedPacket>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceStarRedPacket.1
        ...
        public boolean parseField(BLiveVoiceStarRedPacket bLiveVoiceStarRedPacket, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "roomId":
                    ...
                    return true;
                case "id":
                    bLiveVoiceStarRedPacket.f44511id = jsonParser.getValueAsBoolean();
                    return false;
                case "state":
        ...
        public void serializeFields(BLiveVoiceStarRedPacket bLiveVoiceStarRedPacket, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeBooleanField("id", bLiveVoiceStarRedPacket.f44511id);
    ...
    public BLiveVoiceStarRedPacket mo223809clone() {
        BLiveVoiceStarRedPacket bLiveVoiceStarRedPacket = new BLiveVoiceStarRedPacket();
        bLiveVoiceStarRedPacket.f44511id = this.f44511id;
    ...
    public boolean equals(Object obj) {
        ...
        return this.f44511id == bLiveVoiceStarRedPacket.f44511id && ValueObject.util_equals(this.roomId, bLiveVoiceStarRedPacket.roomId) && ValueObject.util_equals(this.token, bLiveVoiceStarRedPacket.token) && ValueObject.util_equals(this.currentTime, bLiveVoiceStarRedPacket.currentTime) && ValueObject.util_equals(this.startTime, bLiveVoiceStarRedPacket.startTime) && ValueObject.util_equals(this.state, bLiveVoiceStarRedPacket.state);
    }
    ...
    public int hashCode() {
        ...
        int i2 = ((i * 41) + (this.f44511id ? 1231 : 1237)) * 41;
