...
public class BLiveSuperGodDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveSuperGodDetail mo223809clone() {
        BLiveSuperGodDetail bLiveSuperGodDetail = new BLiveSuperGodDetail();
        ...
        if (list != null) {
            bLiveSuperGodDetail.rewards = ValueObject.util_map(list, new w9j() { // from class: l.n62
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLiveSuperGodReward) obj).mo223809clone();
                }
            });
        }
        return bLiveSuperGodDetail;
