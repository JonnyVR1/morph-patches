...
public class BLivePk extends ValueObject implements Cloneable, Serializable {
        ...
        public boolean parseField(BLivePk bLivePk, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 6:
                    ...
                    return true;
                case 7:
                    bLivePk.f44421id = jsonParser.getValueAsString();
                    return false;
                case 8:
    ...
    public BLivePk mo223809clone() {
        BLivePk bLivePk = new BLivePk();
        bLivePk.f44421id = this.f44421id;
        ...
        if (list != null) {
            bLivePk.players = ValueObject.util_map(list, new w9j() { // from class: l.a42
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((BLivePkOwner) obj).mo223809clone();
                }
            });
        }
        BLivePkSituation bLivePkSituation = this.situation;
        if (bLivePkSituation != null) {
            bLivePk.situation = bLivePkSituation.mo223809clone();
        }
        ...
        if (bLivePkScoreViewConfig != null) {
            bLivePk.pkScoreViewConfig = bLivePkScoreViewConfig.mo223809clone();
        }
        ...
        if (bLivePKBufferInfo != null) {
            bLivePk.pkPlayingBuffInfo = bLivePKBufferInfo.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f44421id, bLivePk.f44421id) && ValueObject.util_equals(this.category, bLivePk.category) && ValueObject.util_equals(this.channel, bLivePk.channel) && ValueObject.util_equals(this.channelKey, bLivePk.channelKey) && ValueObject.util_equals(this.otherChannel, bLivePk.otherChannel) && ValueObject.util_equals(this.appid, bLivePk.appid) && ValueObject.util_equals(this.players, bLivePk.players) && ValueObject.util_equals(this.situation, bLivePk.situation) && ValueObject.util_equals(this.owner, bLivePk.owner) && ValueObject.util_equals(this.state, bLivePk.state) && ValueObject.util_equals(this.createdTime, bLivePk.createdTime) && this.isOnceMore == bLivePk.isOnceMore && ValueObject.util_equals(this.mvpUserId, bLivePk.mvpUserId) && this.showWinTimesTag == bLivePk.showWinTimesTag && ValueObject.util_equals(this.categoryV2, bLivePk.categoryV2) && ValueObject.util_equals(this.bountyId, bLivePk.bountyId) && ValueObject.util_equals(this.pkScoreViewConfig, bLivePk.pkScoreViewConfig) && ValueObject.util_equals(this.pkBackgroundUrl, bLivePk.pkBackgroundUrl) && ValueObject.util_equals(this.pkBackgroundSvgaUrl, bLivePk.pkBackgroundSvgaUrl) && ValueObject.util_equals(this.pkPlayingBuffInfo, bLivePk.pkPlayingBuffInfo) && ValueObject.util_equals(this.peerChannelKey, bLivePk.peerChannelKey);
    }
