package com.p046p1.mobile.putong.newui.camera.momosdk;
...
public class MusicContent implements Parcelable, Serializable {
    public static final Parcelable.Creator<MusicContent> CREATOR = new C13064a();
    ...
    public class C13064a implements Parcelable.Creator<MusicContent> {
    ...
    public MusicContent(Parcel parcel) {
        ...
        this.updatetime = 0L;
        this.f53979id = parcel.readString();
    ...
    public void setData(MusicContent musicContent) {
        this.f53979id = musicContent.f53979id;
    ...
    public String toString() {
        return "MusicContent{id='" + this.f53979id + "', size=" + this.size + ", type=" + this.type + ", name='" + this.name + "', uri='" + this.uri + "', path='" + this.path + "', length=" + this.length + ", album='" + this.album + "', artist='" + this.artist + "', startMillTime=" + this.startMillTime + ", endMillTime=" + this.endMillTime + ", musicType=" + this.musicType + ", source=" + this.source + '}';
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f53979id);
    ...
    public void setData(JSONObject jSONObject) {
        if (jSONObject != null) {
            this.f53979id = jSONObject.optString("music_id", null);
