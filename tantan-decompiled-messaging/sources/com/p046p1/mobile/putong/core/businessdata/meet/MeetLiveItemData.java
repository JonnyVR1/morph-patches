...
public class MeetLiveItemData extends AbsMeetUserItemData {
    ...
    public boolean isAnonymous() {
        return this.item.anonymous && NullChecker.m81303a(this.user) && !vwb.m200296J(this.user.profile.extensions.live.voiceImgUrl);
    }
    ...
    @Override // com.p046p1.mobile.putong.core.businessdata.meet.AbsMeetUserItemData
