...
public final class PicksTimesPurchaseSectionView extends AnimBorderSectionView {
    ...
    public void mo54324a(boolean select, boolean autoRenew, @Nullable C8765d.a detail) {
        get_count().setText(String.valueOf(detail != null ? Integer.valueOf(detail.m53605w()) : null));
        get_top_price().setText(detail != null ? detail.m53608z() : null);
        get_bottom_price().setText(detail != null ? detail.m53577e() : null);
        if (select) {
            get_border().setBackgroundResource(d3c0.f83675N5);
            ...
            get_bottom_bg().setBackgroundResource(d3c0.f83689O5);
        } else {
            get_border().setBackgroundResource(d3c0.f83715Q3);
    ...
    public final void m54386c(View view) {
        lg70.m149752a(this, view);
    }
    ...
    public List<View> getAnimBackgroundList() {
        ArrayList arrayListM200324f0 = vwb.m200324f0(get_border(), get_bottom_bg());
