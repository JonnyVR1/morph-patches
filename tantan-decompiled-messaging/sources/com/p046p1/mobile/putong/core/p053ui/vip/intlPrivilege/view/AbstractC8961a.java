...
public abstract class AbstractC8961a extends eb2 {
    ...
    public final FrameLayout mo39043p(@NotNull ViewGroup container, int position) {
        ...
        if (position == 0) {
            ...
            frameLayout.setPadding(companion.m56537b(), 0, companion.m56536a(), 0);
        } else if (position == getCount() - 1) {
            IntlTopCardLayout.Companion companion2 = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion2.m56536a(), 0, companion2.m56537b(), 0);
        } else {
            IntlTopCardLayout.Companion companion3 = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion3.m56536a(), 0, companion3.m56536a(), 0);
        }
        container.addView(frameLayout, new ViewGroup.LayoutParams(-1, -2));
        return mo56539r(frameLayout, position);
    }

    @NotNull
    /* JADX INFO: renamed from: r */
    public abstract FrameLayout mo56539r(@NotNull FrameLayout container, int position);
}
