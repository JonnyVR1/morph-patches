...
public final class ZebraProgress extends FrameLayout {
    ...
    public ZebraProgress(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m47272a(context, attributeSet);
    }

    /* JADX INFO: renamed from: a */
    public final void m47272a(Context context, AttributeSet attrs) {
        View viewInflate = o7r.m163037a(context).inflate(h6c0.f106038o, this);
        viewInflate.getClass();
        this.mProgressIv = (ProgressBgView) viewInflate.findViewById(v4c0.f179900g);
        this.mBotIv = (ImageView) viewInflate.findViewById(v4c0.f179899f);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, f9c0.f96477f);
        typedArrayObtainStyledAttributes.getClass();
        this.progressRadius = (int) typedArrayObtainStyledAttributes.getDimension(f9c0.f96480i, vtd.m199996a(context, 10.0f));
        int color = typedArrayObtainStyledAttributes.getColor(f9c0.f96478g, Color.parseColor("#d9d9d9"));
        int integer = typedArrayObtainStyledAttributes.getInteger(f9c0.f96479h, 100);
    ...
    public boolean m47273b() {
        ProgressBgView progressBgView = this.mProgressIv;
        if (progressBgView != null) {
            return progressBgView.m47269b();
        }
        return false;
    }

    /* JADX INFO: renamed from: c */
    public void m47274c(int res, int type) {
        ProgressBgView progressBgView = this.mProgressIv;
        if (type == 0) {
            if (progressBgView != null) {
    ...
    public void setProgress(int progress) {
        ...
        if (width == 0) {
            width = xdl0.m208412y0() - t100.f167276y;
        }
        ProgressBgView progressBgView = this.mProgressIv;
