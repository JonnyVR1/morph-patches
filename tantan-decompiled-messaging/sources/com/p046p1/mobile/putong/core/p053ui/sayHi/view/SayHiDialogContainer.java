package com.p046p1.mobile.putong.core.p053ui.sayHi.view;
...
public final class SayHiDialogContainer extends FrameLayout {
    ...
    @Metadata(m87231d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0005\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, m87232d2 = {"com/p1/mobile/putong/core/ui/sayHi/view/SayHiDialogContainer$a", "Lcom/tantan/library/svga/AnimListener;", "", "onFinished", "()V", "onStart", "message_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8840a extends AnimListener {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ d30 f35755a;

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ SayHiDialogContainer f35756b;

        public C8840a(d30 d30Var, SayHiDialogContainer sayHiDialogContainer) {
            this.f35755a = d30Var;
            this.f35756b = sayHiDialogContainer;
        }
        ...
        @Override // com.tantan.library.svga.AnimListener
        public void onStart() {
            this.f35756b.get_say_hi_anim_rl().setVisibility(0);
            this.f35756b.get_dialog_rl().setVisibility(8);
        }
    }

    /* JADX INFO: renamed from: com.p1.mobile.putong.core.ui.sayHi.view.SayHiDialogContainer$b */
    @Metadata(m87231d1 = {"\u0000'\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\r\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J1\u0010\t\u001a\u00020\b2\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\t\u0010\nJ1\u0010\f\u001a\u00020\b2\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u000b\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\f\u0010\nJ\u0019\u0010\u000e\u001a\u00020\b2\b\u0010\u0003\u001a\u0004\u0018\u00010\rH\u0016¢\u0006\u0004\b\u000e\u0010\u000f¨\u0006\u0010"}, m87232d2 = {"com/p1/mobile/putong/core/ui/sayHi/view/SayHiDialogContainer$b", "Landroid/text/TextWatcher;", "", BLiveStormDanmakuGiftResourceType.f44446s, "", "start", "count", OMSSwipeMoment.after, "", "beforeTextChanged", "(Ljava/lang/CharSequence;III)V", OMSSwipeMoment.before, "onTextChanged", "Landroid/text/Editable;", "afterTextChanged", "(Landroid/text/Editable;)V", "message_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8841b implements TextWatcher {
        public C8841b() {
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable s) {
            SayHiDialogContainer.this.m54939u(s != null ? s.toString() : null);
        }
    ...
    /* JADX INFO: renamed from: a */
    public static void m54917a(Ref.IntRef intRef, SayHiDialogContainer sayHiDialogContainer, SVGADynamicEntity sVGADynamicEntity, Boolean bool) {
        int i = intRef.element + 1;
        intRef.element = i;
        if (i == 2) {
            sayHiDialogContainer.m54933B(sVGADynamicEntity);
        }
    }

    /* JADX INFO: renamed from: b */
    public static void m54918b(SayHiDialogContainer sayHiDialogContainer, User user) {
        user.getClass();
        sayHiDialogContainer.m54932A(user);
    }

    /* JADX INFO: renamed from: c */
    public static void m54919c(SayHiDialogContainer sayHiDialogContainer) {
        SayHiDialogContainer sayHiDialogContainer2 = sayHiDialogContainer.get_root_view();
        if (sayHiDialogContainer2 != null) {
            sayHiDialogContainer.m54936r(sayHiDialogContainer2);
        }
    }

    /* JADX INFO: renamed from: d */
    public static void m54920d(e30 e30Var, SayHiDialogContainer sayHiDialogContainer, View view) {
        Editable text = sayHiDialogContainer.get_input_content_input_edit().getText();
        e30Var.call(text != null ? text.toString() : null);
    }

    /* JADX INFO: renamed from: e */
    public static void m54921e(d30 d30Var, View view) {
        d30Var.call();
    }

    /* JADX INFO: renamed from: f */
    public static void m54922f(View view) {
        view.setTranslationY(-svq.m186103c(25));
    }

    /* JADX INFO: renamed from: g */
    public static void m54923g(SayHiDialogContainer sayHiDialogContainer, View view) {
        String str = sayHiDialogContainer.curItemValueTwo;
        if (str == null) {
            Intrinsics.m87502r("curItemValueTwo");
            str = null;
        }
        sayHiDialogContainer.m54938t(str);
    }
    ...
    public static Boolean m54924h(Function1 function1, Object obj) {
        return (Boolean) function1.invoke(obj);
    }

    /* JADX INFO: renamed from: i */
    public static void m54925i(Ref.IntRef intRef, SayHiDialogContainer sayHiDialogContainer, SVGADynamicEntity sVGADynamicEntity, Boolean bool) {
        int i = intRef.element + 1;
        intRef.element = i;
        if (i == 2) {
            sayHiDialogContainer.m54933B(sVGADynamicEntity);
    ...
    public static void m54926j(d30 d30Var, Throwable th) {
        d30Var.call();
    }

    /* JADX INFO: renamed from: k */
    public static void m54927k(SayHiDialogContainer sayHiDialogContainer) {
    ...
    public static void m54928l(SayHiDialogContainer sayHiDialogContainer, View view) {
        String str = sayHiDialogContainer.curItemValueThree;
        if (str == null) {
            Intrinsics.m87502r("curItemValueThree");
            str = null;
        }
        sayHiDialogContainer.m54938t(str);
    }
    ...
    public static void m54929m(SayHiDialogContainer sayHiDialogContainer, View view) {
        String str = sayHiDialogContainer.curItemValueOne;
        if (str == null) {
            Intrinsics.m87502r("curItemValueOne");
            str = null;
        }
        sayHiDialogContainer.m54938t(str);
    }
    ...
    public static Boolean m54930n(User user) {
        return Boolean.valueOf(NullChecker.m81303a(user));
    }

    /* JADX INFO: renamed from: A */
    public final void m54932A(User user) {
        this.otherUser = user;
        get_title().setText("对" + m54935q(user.name) + "的抢先告白");
        get_sub_title().setText("无需配对，直接向对方表达你的心意！");
        get_input_content_input_edit().setHint("对" + (user.isFemale() ? "她" : "他") + "说点什么...");
        m54942x(user);
        m54943y();
        get_input_content_input_edit().addTextChangedListener(new C8841b());
    }

    /* JADX INFO: renamed from: B */
    public final void m54933B(SVGADynamicEntity entity) {
        Act act = this.act;
        if (act == null) {
    ...
    public final FrameLayout get_input_content() {
        ...
        Intrinsics.m87502r("_input_content");
        return null;
    }
    ...
    public final VEditText get_input_content_input_edit() {
        ...
        Intrinsics.m87502r("_input_content_input_edit");
        return null;
    }
    ...
    public final VText get_input_content_send() {
        ...
        Intrinsics.m87502r("_input_content_send");
        return null;
    }
    ...
    public final VLinear get_item_value_one() {
        ...
        Intrinsics.m87502r("_item_value_one");
        return null;
    }
    ...
    public final VImage get_item_value_one_ic() {
        ...
        Intrinsics.m87502r("_item_value_one_ic");
        return null;
    }
    ...
    public final VText get_item_value_one_txt() {
        ...
        Intrinsics.m87502r("_item_value_one_txt");
        return null;
    }
    ...
    public final VLinear get_item_value_three() {
        ...
        Intrinsics.m87502r("_item_value_three");
        return null;
    }
    ...
    public final VImage get_item_value_three_ic() {
        ...
        Intrinsics.m87502r("_item_value_three_ic");
        return null;
    }
    ...
    public final VText get_item_value_three_txt() {
        ...
        Intrinsics.m87502r("_item_value_three_txt");
        return null;
    }
    ...
    public final VLinear get_item_value_two() {
        ...
        Intrinsics.m87502r("_item_value_two");
        return null;
    }
    ...
    public final VImage get_item_value_two_ic() {
        ...
        Intrinsics.m87502r("_item_value_two_ic");
        return null;
    }
    ...
    public final VText get_item_value_two_txt() {
        ...
        Intrinsics.m87502r("_item_value_two_txt");
        return null;
    }
    ...
    public final VImage get_right_close() {
        ...
        Intrinsics.m87502r("_right_close");
        return null;
    }
    ...
    public final SVGAnimationView get_say_hi_anim() {
        ...
        Intrinsics.m87502r("_say_hi_anim");
        return null;
    }
    ...
    public final RelativeLayout get_say_hi_anim_rl() {
        ...
        Intrinsics.m87502r("_say_hi_anim_rl");
        return null;
    }
    ...
    public final void m54934o(View view) {
        isd0.m137981a(this, view);
    }
    ...
    public void onFinishInflate() {
        ...
        get_dialog_rl().post(new Runnable() { // from class: l.urd0
            ...
            public final void run() {
                SayHiDialogContainer.m54927k(this.f177826a);
            }
        });
        m54937s();
    }
    ...
    public final String m54935q(String name) {
        if (name == null) {
    ...
    public final void m54936r(final View targetView) {
        Rect rect = new Rect();
        ...
        if (iHeight < iMax + WebRtcAudioTrack.AudioTrackErrorCode.AUDIO_TRACK_INIT_MINBUFFER_ERROR) {
            targetView.post(new Runnable() { // from class: l.asd0
                @Override // java.lang.Runnable
                public final void run() {
                    SayHiDialogContainer.m54922f(targetView);
                }
            });
        } else {
    ...
    public final void m54937s() {
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: l.zrd0
            ...
            public final void onGlobalLayout() {
                SayHiDialogContainer.m54919c(this.f204498a);
            }
        });
    }
    ...
    public final void m54938t(String itemValue) {
    ...
    public final void m54939u(String curValue) {
        ...
        if (Intrinsics.m87488d(curValue, str)) {
            VLinear vLinear = this.curSelectedValueContainer;
            if (vLinear != null) {
                vLinear.setBackgroundResource(c3c0.f78717c6);
            }
            VImage vImage = this.curSelectedValueIc;
            if (vImage != null) {
                vImage.setImageResource(c3c0.f78726d6);
            }
            ...
            get_item_value_one().setBackgroundResource(c3c0.f78699a6);
            get_item_value_one_ic().setImageResource(c3c0.f78708b6);
            ...
            if (Intrinsics.m87488d(curValue, str2)) {
                VLinear vLinear2 = this.curSelectedValueContainer;
                if (vLinear2 != null) {
                    vLinear2.setBackgroundResource(c3c0.f78717c6);
                }
                VImage vImage2 = this.curSelectedValueIc;
                if (vImage2 != null) {
                    vImage2.setImageResource(c3c0.f78726d6);
                }
                ...
                get_item_value_two().setBackgroundResource(c3c0.f78699a6);
                get_item_value_two_ic().setImageResource(c3c0.f78708b6);
                ...
                boolean zM87488d = Intrinsics.m87488d(curValue, str3);
                VLinear vLinear3 = this.curSelectedValueContainer;
                if (zM87488d) {
                    if (vLinear3 != null) {
                        vLinear3.setBackgroundResource(c3c0.f78717c6);
                    }
                    VImage vImage3 = this.curSelectedValueIc;
                    if (vImage3 != null) {
                        vImage3.setImageResource(c3c0.f78726d6);
                    }
                    ...
                    get_item_value_three().setBackgroundResource(c3c0.f78699a6);
                    get_item_value_three_ic().setImageResource(c3c0.f78708b6);
                    ...
                    if (vImage4 != null) {
                        vImage4.setImageResource(c3c0.f78726d6);
                    }
    ...
    public final void m54940v(@NotNull Act act, @NotNull d30 complete) {
        act.getClass();
        complete.getClass();
        ...
        User user2 = null;
        if (user == null) {
            Intrinsics.m87502r("otherUser");
            user = null;
        }
        String str = user.m60124fp().profileSmall().formatted();
        str.getClass();
        s5h0Var.m182350f(act, sVGADynamicEntity, str, "head01", 80, 106, (64 & 64) != 0 ? null : null);
        String str2 = CoreModule.f17545c.f19639e0.m169527p9().m60124fp().profileMiddle().formatted();
        str2.getClass();
        s5h0Var.m182350f(act, sVGADynamicEntity, str2, "head02", 80, 106, (64 & 64) != 0 ? null : null);
        ...
        textPaint2.setTextSize(t100.m186892f(13));
        ...
        sVGADynamicEntity.setDynamicText("你对" + m54935q(user3.name) + "抢先告白", textPaint, "text01");
        ...
        SVGALoader.with(act).from("https://auto.tancdn.com/v1/raw/002d7a0b-0a91-4601-9e4d-0a2fb1328c5d14.pdf").repeatCount(1).dynamic(sVGADynamicEntity).animListener(new C8840a(complete, this)).autoPlay(true).into(get_say_hi_anim());
    }

    /* JADX INFO: renamed from: w */
    public final void m54941w(@NotNull Act act, @NotNull C8360d.a greetBuilder, @NotNull final d30 close, @NotNull final e30<String> send) {
        act.getClass();
        ...
        get_right_close().setOnClickListener(new View.OnClickListener() { // from class: l.bsd0
            ...
            public final void onClick(View view) {
                SayHiDialogContainer.m54921e(close, view);
            }
        });
        get_input_content_send().setOnClickListener(new View.OnClickListener() { // from class: l.csd0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SayHiDialogContainer.m54920d(send, this, view);
            }
        });
        get_input_content().setBackgroundDrawable(new zre0(t100.m186890d(10.0f), t100.m186890d(10.0f), 0.0f, 0.0f, act.getResources().getColor(a1c0.f67167u), -1));
        C22306c c22306cDuringCreated = act.duringCreated(CoreModule.f17545c.f19639e0.m169410Ka(greetBuilder.m45910g()));
        final Function1 function1 = new Function1() { // from class: l.dsd0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SayHiDialogContainer.m54930n((User) obj);
            }
        };
        c22306cDuringCreated.filter(new w9j() { // from class: l.esd0
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return SayHiDialogContainer.m54924h(function1, obj);
            }
        }).take(1).subscribe(mkd0.m154956H(new e30() { // from class: l.fsd0
            @Override // p149l.e30
            public final void call(Object obj) {
                SayHiDialogContainer.m54918b(this.f99060a, (User) obj);
            }
        }, new e30() { // from class: l.gsd0
            @Override // p149l.e30
            public final void call(Object obj) {
                SayHiDialogContainer.m54926j(close, (Throwable) obj);
            }
        }));
    }

    /* JADX INFO: renamed from: x */
    public final void m54942x(User user) {
        Act act;
        ...
        String str = user.m60124fp().profileMiddle().formatted();
        str.getClass();
        s5h0Var.m182350f(act2, sVGADynamicEntity, str, "head01", 80, 106, new e30() { // from class: l.xrd0
            @Override // p149l.e30
            public final void call(Object obj) {
                SayHiDialogContainer.m54925i(intRef, this, sVGADynamicEntity, (Boolean) obj);
            }
        });
        Act act3 = this.act;
        if (act3 == null) {
        ...
        String str2 = CoreModule.f17545c.f19639e0.m169527p9().m60124fp().profileMiddle().formatted();
        str2.getClass();
        s5h0Var.m182350f(act, sVGADynamicEntity, str2, "head02", 80, 106, new e30() { // from class: l.yrd0
            @Override // p149l.e30
            public final void call(Object obj) {
                SayHiDialogContainer.m54917a(intRef, this, sVGADynamicEntity, (Boolean) obj);
            }
        });
    }

    /* JADX INFO: renamed from: y */
    public final void m54943y() {
        ...
        get_item_value_one().setOnClickListener(new View.OnClickListener() { // from class: l.hsd0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SayHiDialogContainer.m54929m(this.f109313a, view);
            }
        });
        ...
        get_item_value_two().setOnClickListener(new View.OnClickListener() { // from class: l.vrd0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SayHiDialogContainer.m54923g(this.f182716a, view);
            }
        });
        ...
        get_item_value_three().setOnClickListener(new View.OnClickListener() { // from class: l.wrd0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SayHiDialogContainer.m54928l(this.f187788a, view);
            }
        });
        m54944z();
    }
    ...
    public final void m54944z() {
        get_item_value_one().setBackgroundResource(c3c0.f78717c6);
        get_item_value_one_ic().setImageResource(c3c0.f78726d6);
        get_item_value_one_txt().setTextColor(Color.parseColor("#CCD05CD3"));
        get_item_value_two().setBackgroundResource(c3c0.f78717c6);
        get_item_value_two_ic().setImageResource(c3c0.f78726d6);
        get_item_value_two_txt().setTextColor(Color.parseColor("#CCD05CD3"));
        get_item_value_three().setBackgroundResource(c3c0.f78717c6);
        get_item_value_three_ic().setImageResource(c3c0.f78726d6);
