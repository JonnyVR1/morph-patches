package com.p046p1.mobile.putong.core.p053ui.vip.privilege.vipfrag.behavior;
...
import com.p046p1.mobile.putong.core.p053ui.vip.privilege.vipfrag.behavior.RecycleViewYBehavior;
...
public final class RecycleViewYBehavior extends CoordinatorLayout.AbstractC0226c<View> {
    ...
    public RecycleViewYBehavior(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        context.getClass();
        this.MaxHeight = t100.f167236K * 1.0f;
    }

    /* JADX INFO: renamed from: b */
    public static final void m57434b(View view, ValueAnimator valueAnimator) {
    ...
    public void onNestedPreScroll(@NotNull CoordinatorLayout coordinatorLayout, @NotNull View child, @NotNull View target, int dx, int dy, @NotNull int[] consumed, int type) {
        ...
        if (!z || (((valueAnimator = this.valueAnimator) != null && valueAnimator.isRunning()) || type != 0)) {
            if (z && type == 1) {
                ...
                RecyclerView.AbstractC0577o layoutManager2 = recyclerView.getLayoutManager();
                layoutManager2.getClass();
                int iFindLastVisibleItemPosition = ((LinearLayoutManager) layoutManager2).findLastVisibleItemPosition();
                RecyclerView.AbstractC0577o layoutManager3 = recyclerView.getLayoutManager();
                ...
                if (iFindLastVisibleItemPosition == (adapter != null ? adapter.getItemCount() : 0) - 1 && !target.canScrollVertically(1)) {
                    gbl0.m125164I0(target, 1);
                    return;
                } else {
                    if (iFindFirstCompletelyVisibleItemPosition != 0 || (topCardLayout = this.viewPager) == null) {
                        return;
                    }
                    if (Intrinsics.m87487c(topCardLayout != null ? Float.valueOf(topCardLayout.getTranslationY()) : null, 0.0f)) {
                        gbl0.m125164I0(target, 1);
                        return;
                    }
                    return;
        ...
        if (this.viewPager == null) {
            Iterator<View> it = ViewGroupKt.m1329b(coordinatorLayout).iterator();
            do {
                if (!it.hasNext()) {
                    next = null;
                    break;
        ...
        RecyclerView.AbstractC0577o layoutManager4 = recyclerView2.getLayoutManager();
        ...
        if (Intrinsics.m87487c(topCardLayout2 != null ? Float.valueOf(topCardLayout2.getTranslationY()) : null, 0.0f)) {
            float f = dy;
                    ...
                    if (valueAnimatorOfFloat != null) {
                        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.fjc0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                RecycleViewYBehavior.m57434b(target, valueAnimator2);
                            }
                        });
