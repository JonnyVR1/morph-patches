...
public final class PurchasePrivilegeSVGAContainerView extends LinearLayout {
    ...
    @Metadata(m87231d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m87232d2 = {"com/p1/mobile/putong/core/ui/purchase/page/PurchasePrivilegeSVGAContainerView$a", "Lcom/tantan/library/svga/AnimListener;", "", "onFinished", "()V", "pay_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8787a extends AnimListener {
    ...
    @Metadata(m87231d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m87232d2 = {"com/p1/mobile/putong/core/ui/purchase/page/PurchasePrivilegeSVGAContainerView$b", "Lcom/tantan/library/svga/AnimListener;", "", "onFinished", "()V", "pay_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8788b extends AnimListener {
        @Override // com.tantan.library.svga.AnimListener
        public void onFinished() {
            super.onFinished();
        }
    ...
    public final void m54192a(View view) {
        c8b0.m105777a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m54193b(@NotNull PurchaseType type, @Nullable Privilege privilege) {
        type.getClass();
        this.hasInitedSvga = true;
        Context context = getContext();
        context.getClass();
        SVGALoader.with(context).from("https://fe-static.tancdn.com/v1/raw/84570b50-d8bb-472f-b054-29051c568dec14.svga").autoPlay(true).repeatCount(1).animListener(new C8787a()).into(get_svga());
    }

    /* JADX INFO: renamed from: c */
    public final void m54194c(@NotNull PurchaseType type, @Nullable Privilege privilege) {
        type.getClass();
        this.hasInitedSvga = true;
        String str = zz6.m221004u0() ? "https://fe-static.tancdn.com/v1/raw/8aebaed7-dff9-4bc9-9693-f2eb3509473214.svga" : "https://fe-static.tancdn.com/v1/raw/fc24b12c-e55f-404c-8da2-a7916aacc4a814.svga";
        Context context = getContext();
        context.getClass();
        SVGALoader.with(context).from(str).autoPlay(true).repeatCount(1).animListener(new C8788b()).into(get_svga());
    }
