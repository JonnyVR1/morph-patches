...
public class C8689c implements InterfaceC8687a {
    /* JADX INFO: renamed from: l */
    public static /* synthetic */ void m51810l(AvatarCard avatarCard, VListCell vListCell, VListCell.C22545a c22545a, int i) {
    ...
    public static /* synthetic */ void m51811m(AvatarCard avatarCard, VListCell vListCell, VListCell.C22545a c22545a, int i) {
        avatarCard.f33047d.m105113b();
        if ("从相册选择".equals(c22545a.f209159a)) {
            avatarCard.m51767c0(AvatarCard.ClickAction.CHOOSE_PICTURE);
        } else if ("选择一段视频".equals(c22545a.f209159a)) {
    ...
    public boolean mo51802c(final AvatarCard avatarCard, int i) {
        ...
        c40 c40VarM105153F = new c40.C16057b(avatarCard.getContext()).m105156I(App.f15369e.getString(R$string.f27815a)).m105168U(new View.OnClickListener() { // from class: l.dmd
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                avatarCard.f33047d.m105113b();
            }
        }).m105164Q(arrayList).m105169V(new c40.InterfaceC16059d() { // from class: l.emd
            @Override // p149l.c40.InterfaceC16059d
            /* JADX INFO: renamed from: a */
            public final void mo41896a(VListCell vListCell, VListCell.C22545a c22545a, int i2) {
                C8689c.m51810l(avatarCard, vListCell, c22545a, i2);
            }
        }).m105153F();
    ...
    public boolean mo51803d(final AvatarCard avatarCard, int i) {
        ...
        if (lqa.m150976n()) {
            CoreModule.m29935P().m94651a().mo33351Kc((Act) avatarCard.getContext(), i, new d30() { // from class: l.fmd
                @Override // p149l.d30
        ...
        c40 c40VarM105153F = new c40.C16057b(avatarCard.getContext()).m105156I(App.f15369e.getString(R$string.f27815a)).m105168U(new View.OnClickListener() { // from class: l.gmd
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                avatarCard.f33047d.m105113b();
            }
        }).m105164Q(vwb.m200324f0("从相册选择", "选择一段视频")).m105169V(new c40.InterfaceC16059d() { // from class: l.hmd
            @Override // p149l.c40.InterfaceC16059d
            /* JADX INFO: renamed from: a */
            public final void mo41896a(VListCell vListCell, VListCell.C22545a c22545a, int i2) {
                C8689c.m51811m(avatarCard, vListCell, c22545a, i2);
            }
        }).m105153F();
        avatarCard.f33047d = c40VarM105153F;
        c40VarM105153F.m105117f();
