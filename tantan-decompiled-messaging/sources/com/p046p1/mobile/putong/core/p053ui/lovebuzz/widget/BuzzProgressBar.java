...
public final class BuzzProgressBar extends FrameLayout {
    ...
    public BuzzProgressBar(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m47165b(layoutInflaterFrom, this);
        get_buzz_progress().setOutlineProvider(new mkp(t100.f167262k));
        get_buzz_progress().setClipToOutline(true);
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ void m47163d(BuzzProgressBar buzzProgressBar, String str, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            z = true;
        }
        buzzProgressBar.m47166c(str, i, z);
    }

    /* JADX INFO: renamed from: f */
    public static final void m47164f(BuzzProgressBar buzzProgressBar, boolean z, String str, ValueAnimator valueAnimator) {
        ...
        if (z) {
            m47163d(buzzProgressBar, str, iIntValue, false, 4, null);
        }
    }

    @NotNull
    /* JADX INFO: renamed from: b */
    public final View m47165b(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM108050b = cp3.m108050b(this, inflater, parent);
        viewM108050b.getClass();
        return viewM108050b;
    }

    @SuppressLint({"SetTextI18n"})
    /* JADX INFO: renamed from: c */
    public final void m47166c(String headStr, int lastTime, boolean mediaBuzz) {
        if (!mediaBuzz) {
    ...
    public final void m47167e(@NotNull String type, @Nullable final String headStr) {
        type.getClass();
        boolean zM87488d = Intrinsics.m87488d(type, "textBuzz");
        final boolean z = !zM87488d;
        int iM153303h = !zM87488d ? (m6w.INSTANCE.m153303h(type) * 1000) + 900 : 10900;
        get_buzz_progress().setMax(iM153303h);
        m47168g();
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(iM153303h, 0);
        ...
        if (valueAnimatorOfInt != null) {
            valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.bp3
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    BuzzProgressBar.m47164f(this.f76599a, z, headStr, valueAnimator);
                }
            });
            ...
            valueAnimatorOfInt.setDuration(iM153303h);
            valueAnimatorOfInt.setInterpolator(new LinearInterpolator());
            valueAnimatorOfInt.start();
        }
        m47166c(headStr, iM153303h, z);
    }

    /* JADX INFO: renamed from: g */
    public final void m47168g() {
    ...
    public final ProgressBar get_buzz_progress() {
        ...
        Intrinsics.m87502r("_buzz_progress");
        return null;
    }
    ...
    public final VText get_progress_content() {
        ...
        Intrinsics.m87502r("_progress_content");
        return null;
    }
