...
public class PrivilegeItemPicUtils {
    ...
    public static HashMap<Privilege, j760<String, String>> f37784a = new HashMap() { // from class: com.p1.mobile.putong.core.ui.vip.privilege.dlg.PrivilegeItemPicUtils.1
        {
    ...
    public static HashMap<Privilege, j760<String, String>> f37785b = new HashMap() { // from class: com.p1.mobile.putong.core.ui.vip.privilege.dlg.PrivilegeItemPicUtils.2
        {
    ...
    public static List<Privilege> f37786c = new ArrayList<Privilege>() { // from class: com.p1.mobile.putong.core.ui.vip.privilege.dlg.PrivilegeItemPicUtils.3
        {
    ...
    /* JADX INFO: renamed from: a */
    public static String m57403a(Privilege privilege) {
        j760<String, String> j760Var = "en".equals(Locale.getDefault().getLanguage()) ? f37785b.get(privilege) : null;
        if (!NullChecker.m81303a(j760Var)) {
            j760Var = f37784a.get(privilege);
        }
        if (NullChecker.m81304b(j760Var)) {
            return f37786c.contains(privilege) ? CoreModule.f17545c.f19639e0.m169520na().isFemale() ^ true : zz6.m221004u0() ? j760Var.f116564a : j760Var.f116565b;
        }
        return null;
    }
}
