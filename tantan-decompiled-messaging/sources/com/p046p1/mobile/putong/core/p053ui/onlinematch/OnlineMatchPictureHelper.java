...
public class OnlineMatchPictureHelper {
    ...
    public static volatile OnlineMatchPictureHelper f32623c;

    /* JADX INFO: renamed from: a */
    public final Map<String, String> f32624a = new MaxSizeHashMap(38);
    ...
    /* JADX INFO: renamed from: b */
    public static OnlineMatchPictureHelper m50195b() {
        if (f32623c == null) {
            synchronized (OnlineMatchPictureHelper.class) {
                try {
                    if (f32623c == null) {
                        f32623c = new OnlineMatchPictureHelper();
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    /* JADX INFO: renamed from: a */
    public ArrayList<String> m50196a() {
        ArrayList<String> arrayList = new ArrayList<>();
        if (CoreModule.m29931H().userId() == null) {
            return arrayList;
        }
        ...
        if (NullChecker.m81303a(userM169527p9)) {
            ...
            arrayList.addAll((TEnum.equals(lookingFor, "unknown_") || TEnum.equals(lookingFor, "both")) ? userM169527p9.isFemale() ^ true : TEnum.equals(lookingFor, "female") ? m50197c() : m50198d());
        }
        this.f32625b = (this.f32625b + 1) % 2;
        return arrayList;
    }

    /* JADX INFO: renamed from: c */
    public final ArrayList<String> m50197c() {
        ArrayList<String> arrayList = new ArrayList<>();
        if (this.f32625b == 0) {
    ...
    public final ArrayList<String> m50198d() {
        ArrayList<String> arrayList = new ArrayList<>();
        if (this.f32625b == 0) {
