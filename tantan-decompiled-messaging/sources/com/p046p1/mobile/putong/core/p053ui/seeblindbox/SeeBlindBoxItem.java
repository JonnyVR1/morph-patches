package com.p046p1.mobile.putong.core.p053ui.seeblindbox;
...
public final class SeeBlindBoxItem extends FrameLayout {
    ...
    @Metadata(m87231d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m87232d2 = {"com/p1/mobile/putong/core/ui/seeblindbox/SeeBlindBoxItem$a", "Lcom/tantanapp/media/ttmediaeffect/anim/AnimListener;", "", "onFinished", "()V", "b_core_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8843a extends AnimListener {
    ...
    public final void m54948a(View view) {
        a8e0.m95343a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m54949b() {
        get_anim().setVisibility(8);
    }

    /* JADX INFO: renamed from: c */
    public final void m54950c(@NotNull Act act, @Nullable SwipeDirection swipeDirection, @NotNull User user) {
        act.getClass();
        user.getClass();
        qib0.f154691G.m102314D(get_image(), "https://fe-static.tancdn.com/v1/images/eyJpZCI6IlBTSkVKQVBTTExUNlVQUlZXT1JBUERSUVNMMkRJNDE0IiwidyI6NDgzLCJoIjo2MzAsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjo5MDM1MzMzNTMyMzk1MzQ1Nzg4fQ.webp");
        qib0.f154691G.m102331L0(get_image(), user.picture(0).profileMiddle().formatted());
        ...
        get_tag().setBackgroundResource(swipeDirection == SwipeDirection.LEFT ? x2c0.f189357Gb : x2c0.f189388Hb);
        m54951d(true);
        m54952e(swipeDirection != null);
        if (swipeDirection != null) {
            z7e0.INSTANCE.m217462g(act, swipeDirection, user);
        }
    }

    /* JADX INFO: renamed from: d */
    public final void m54951d(boolean isShow) {
        xdl0.m208345M0(get_info_container(), isShow);
    }

    /* JADX INFO: renamed from: e */
    public final void m54952e(boolean isShow) {
        xdl0.m208345M0(get_tag(), isShow);
    }

    /* JADX INFO: renamed from: f */
    public final void m54953f(@NotNull String url) {
        url.getClass();
        get_anim().setVisibility(0);
        get_anim().loadAnimWithListener(url, -1, new C8843a(), true);
    }

    /* JADX INFO: renamed from: g */
    public final void m54954g() {
    ...
    public final ConstraintLayout get_info_container() {
        ...
        Intrinsics.m87502r("_info_container");
        return null;
    }
    ...
    public final VText get_info_container_age() {
        ...
        Intrinsics.m87502r("_info_container_age");
        return null;
    }
    ...
    public final VText get_info_container_name() {
        ...
        Intrinsics.m87502r("_info_container_name");
        return null;
    }
