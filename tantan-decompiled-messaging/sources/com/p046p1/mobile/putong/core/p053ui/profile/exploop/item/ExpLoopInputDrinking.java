...
public class ExpLoopInputDrinking extends ExpLoopInputType {
    ...
    public static /* synthetic */ void m51403a(String str, ArrayList arrayList, FriendPurposeHelper.DrinkType drinkType) {
    ...
    public void fillInputContentData(User user, ExpProfileEditLoopBaseFrag expProfileEditLoopBaseFrag) {
        final String str = (NullChecker.m81303a(user.profile.extensions) && NullChecker.m81303a(user.profile.extensions.physical) && !vwb.m200296J(user.profile.extensions.physical.drink)) ? user.profile.extensions.physical.drink.get(0) : "";
        final ArrayList arrayList = new ArrayList();
        vwb.m200287A(FriendPurposeHelper.DrinkType.values(), new e30() { // from class: l.aef
            @Override // p149l.e30
            public final void call(Object obj) {
                ExpLoopInputDrinking.m51403a(str, arrayList, (FriendPurposeHelper.DrinkType) obj);
            }
        });
    ...
    public boolean hasInfoExist(User user, LoopFragmentFactory.LoopCreateEntryType loopCreateEntryType) {
        return (!NullChecker.m81303a(user.profile.extensions.physical) || vwb.m200296J(user.profile.extensions.physical.drink) || TextUtils.isEmpty(user.profile.extensions.physical.drink.get(0))) ? false : true;
    }

    @Override // com.p046p1.mobile.putong.core.p053ui.profile.exploop.item.ExpLoopInputType
    public void saveUserInfo(User user) {
        super.saveUserInfo(user);
        ExpProfileLoopSelectTypeData.ItemData itemData = (ExpProfileLoopSelectTypeData.ItemData) vwb.m200346r(getData().getSelectType().list, new w9j() { // from class: l.zdf
            @Override // p149l.w9j
