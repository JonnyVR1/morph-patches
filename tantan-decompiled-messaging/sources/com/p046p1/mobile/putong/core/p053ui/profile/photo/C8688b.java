...
public class C8688b implements InterfaceC8687a {
    /* JADX INFO: renamed from: j */
    public static /* synthetic */ void m51805j(AvatarCard avatarCard, VListCell vListCell, VListCell.C22545a c22545a, int i) {
    ...
    public boolean mo51802c(final AvatarCard avatarCard, int i) {
        ...
        c40 c40VarM105153F = new c40.C16057b(avatarCard.getContext()).m105156I(App.f15369e.getString(R$string.f27815a)).m105168U(new View.OnClickListener() { // from class: l.k7c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                avatarCard.f33047d.m105113b();
            }
        }).m105164Q(arrayList).m105169V(new c40.InterfaceC16059d() { // from class: l.l7c
            @Override // p149l.c40.InterfaceC16059d
            /* JADX INFO: renamed from: a */
            public final void mo41896a(VListCell vListCell, VListCell.C22545a c22545a, int i2) {
                C8688b.m51805j(avatarCard, vListCell, c22545a, i2);
            }
        }).m105153F();
    ...
    public boolean mo51803d(final AvatarCard avatarCard, int i) {
        ...
        CoreModule.m29935P().m94651a().mo33351Kc((Act) avatarCard.getContext(), i, new d30() { // from class: l.m7c
            @Override // p149l.d30
