package com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.bean;

import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.address.MarryLoopHometownFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.authentication.MarryEditAvatarAuthenticationFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.birthday.MarryEditProfileBirthdayFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.height.MarryEditProfileHeightFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.house.MarryEditProfileHouseFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.input.MarryEditProfileInputFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.interval.MarryEditProfileIntervalFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.life.MarryLoopLifeMomentFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.mate.MarryEditProfileMateFrag;
import com.p046p1.mobile.putong.core.p053ui.marry.profile.loop.multiple.MarryEditProfileMultipleFrag;
