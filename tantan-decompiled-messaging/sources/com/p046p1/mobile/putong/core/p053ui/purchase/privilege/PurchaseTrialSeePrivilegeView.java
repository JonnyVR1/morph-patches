...
public final class PurchaseTrialSeePrivilegeView extends LinearLayout {
    ...
    public final void m54294a(View view) {
        qab0.m173717a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final String m54295b(long seconds) {
        if (seconds >= 3600) {
    ...
    public final void m54296c() {
        long jM34751E = CoreModule.f17545c.f19598Q1.f20117R.m34751E();
        get_promotion_title().setText("试用版-解密谁喜欢我");
        get_promotion_tip().setText("限时配对" + m54295b(jM34751E) + "试用");
        get_privilege_1().setText("与近期新喜欢我的用户限时配对");
        get_privilege_2().setText("限时配对将于试用开始" + m54295b(jM34751E) + "后失效");
        long jM34752F = CoreModule.f17545c.f19598Q1.f20117R.m34752F();
        get_privilege_3().setText("失效配对在" + m54295b(jM34752F) + "内解锁SVIP可恢复");
    }
    ...
    public final TextView get_privilege_1() {
        ...
        Intrinsics.m87502r("_privilege_1");
        return null;
    }
    ...
    public final TextView get_privilege_2() {
        ...
        Intrinsics.m87502r("_privilege_2");
        return null;
    }
    ...
    public final TextView get_privilege_3() {
        ...
        Intrinsics.m87502r("_privilege_3");
        return null;
    }
