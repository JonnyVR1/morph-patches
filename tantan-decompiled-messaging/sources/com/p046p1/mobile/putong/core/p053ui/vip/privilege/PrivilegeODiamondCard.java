...
public final class PrivilegeODiamondCard extends PrivilegeBaseCard {
    ...
    @Metadata(m87231d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0005\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, m87232d2 = {"com/p1/mobile/putong/core/ui/vip/privilege/PrivilegeODiamondCard$a", "Lcom/tantan/library/svga/AnimListener;", "", "onFinished", "()V", "onStart", "b_core_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8983a extends AnimListener {
        public C8983a() {
        }

        /* JADX INFO: renamed from: a */
        public static void m56888a(PrivilegeODiamondCard privilegeODiamondCard) {
            privilegeODiamondCard.m56887t0();
        }
            ...
            if (PrivilegeODiamondCard.this.backgroundShimmerRunnable == null) {
                ...
                privilegeODiamondCard.backgroundShimmerRunnable = new Runnable() { // from class: l.e690
                    ...
                    public final void run() {
                        PrivilegeODiamondCard.C8983a.m56888a(privilegeODiamondCard);
                    }
                };
            }
            e51.m114745J(PrivilegeODiamondCard.this.backgroundShimmerRunnable);
            e51.m114743H(PrivilegeODiamondCard.this.getContext(), PrivilegeODiamondCard.this.backgroundShimmerRunnable, 6000L);
        }
    ...
    @Metadata(m87231d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0005\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, m87232d2 = {"com/p1/mobile/putong/core/ui/vip/privilege/PrivilegeODiamondCard$b", "Lcom/tantan/library/svga/AnimListener;", "", "onFinished", "()V", "onStart", "b_core_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8984b extends AnimListener {
        @Override // com.tantan.library.svga.AnimListener
        public void onFinished() {
        }
    ...
    private final void m56882q0() {
        eb2 eb2Var = this.adapter;
        if (eb2Var != null) {
            eb2Var.m115452n(this.frag, CoreModule.f17545c.f19555C0.m210111u3(SummarizedPrivilegesId.get("oDiamond"))).distinctUntilChanged().subscribe(mkd0.m154955G(new e30() { // from class: l.d690
                @Override // p149l.e30
                public final void call(Object obj) {
                    PrivilegeODiamondCard.m56883r0(this.f84608a, (UserPrivilege) obj);
                }
            }));
        }
    }
    ...
    public static final void m56883r0(PrivilegeODiamondCard privilegeODiamondCard, UserPrivilege userPrivilege) {
        privilegeODiamondCard.get_subtitle().setText(qgl0.m174441d(userPrivilege));
    }
    ...
    public final SVGAnimationView get_background_svga() {
        ...
        Intrinsics.m87502r("_background_svga");
        return null;
    }
    ...
    public void mo56836h0(@Nullable eb2 adapter, @Nullable PutongFrag frag, @Nullable PurchaseType purchaseType) {
    ...
    public final void m56884l0(View view) {
        g690.m124552a(this, view);
    }
    ...
    public final void m56885p0() {
        Context context = getContext();
        context.getClass();
        SVGALoader.with(context).autoPlay(false).repeatCount(1).from("https://auto.tancdn.com/v1/raw/e67bb529-dc9f-4c96-b818-6b61c83d7b3714.pdf").animListener(new C8983a()).into(get_background_svga());
        mep0.m154302d1(get_background_svga(), t100.f167260i);
        Context context2 = getContext();
        context2.getClass();
        SVGALoader.with(context2).autoPlay(false).repeatCount(1).from("https://auto.tancdn.com/v1/raw/a56911cc-64a7-47b5-8de8-6f47d921a9c014.pdf").animListener(new C8984b()).into(get_icon());
    }

    /* JADX INFO: renamed from: s0 */
    public final void m56886s0() {
        ...
        get_subtitle().setText(qgl0.m174441d(CoreModule.f17545c.f19555C0.m210113w4(SummarizedPrivilegesId.get("oDiamond"))));
    }
