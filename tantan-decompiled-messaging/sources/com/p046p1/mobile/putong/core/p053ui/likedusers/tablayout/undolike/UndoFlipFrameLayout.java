...
public final class UndoFlipFrameLayout extends FrameLayout {
    ...
    @Metadata(m87231d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0007\u0010\u0006¨\u0006\b"}, m87232d2 = {"com/p1/mobile/putong/core/ui/likedusers/tablayout/undolike/UndoFlipFrameLayout$b", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "onAnimationStart", "(Landroid/animation/Animator;)V", "onAnimationEnd", "member_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8409b extends AnimatorListenerAdapter {

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ List<View> f30063b;

        public C8409b(List<View> list) {
            this.f30063b = list;
        }
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            Iterator<View> it = this.f30063b.iterator();
            while (it.hasNext()) {
    ...
    public static final void m46862n(UndoFlipFrameLayout undoFlipFrameLayout, List list, ValueAnimator valueAnimator) {
    ...
    public static final void m46863p(UndoFlipFrameLayout undoFlipFrameLayout, ValueAnimator valueAnimator) {
        valueAnimator.getClass();
    ...
    public final Animator m46867k() {
        ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat((Property<?, Float>) View.TRANSLATION_X, 0.0f, (t100.f167243R + xdl0.m208412y0()) - this.toX), PropertyValuesHolder.ofFloat((Property<?, Float>) View.ROTATION, 0.0f, 14.0f));
    ...
    public final Animator m46868l() {
        Animator animatorM46869m = m46869m();
        Animator animatorM46870o = m46870o();
        m46864h();
        AnimatorSet animatorSet = new AnimatorSet();
        this.flipAnimatorSet = animatorSet;
        animatorSet.playTogether(animatorM46869m, animatorM46870o);
        ...
        if (valueAnimatorOfPropertyValuesHolder != null) {
            valueAnimatorOfPropertyValuesHolder.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.wnj0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    UndoFlipFrameLayout.m46862n(this.f187312a, arrayList, valueAnimator);
                }
            });
            valueAnimatorOfPropertyValuesHolder.addListener(new C8409b(arrayList));
    ...
    public final Animator m46870o() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.vnj0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                UndoFlipFrameLayout.m46863p(this.f182255a, valueAnimator);
            }
        });
    ...
    public final void m46871q(float fromLocationX, float fromLocationY) {
        int[] iArr = new int[2];
