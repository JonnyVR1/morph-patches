...
public final class PurchasePrivilegeUndoView extends FrameLayout {
    ...
    public final void m54199a(View view) {
        f8b0.m119873a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m54200b() {
        get_icon().setImageResource(d3c0.f84145v9);
        xdl0.m208344M(get_certain(), false);
        xdl0.m208344M(get_uncertain(), true);
        xdl0.m208360X(get_uncertain(), t100.f167260i);
        get_uncertain().setImageResource(zz6.m221004u0() ? d3c0.f83528Cc : d3c0.f83500Ac);
    }
