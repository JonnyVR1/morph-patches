...
public final class BottomContentCoverView extends FrameLayout {
    ...
    public BottomContentCoverView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m57456a(layoutInflaterM163037a, this);
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m57456a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM110640b = db3.m110640b(this, inflater, parent);
        viewM110640b.getClass();
        return viewM110640b;
    }

    /* JADX INFO: renamed from: b */
    public final void m57457b(float alpha) {
