...
import com.p046p1.mobile.putong.core.p053ui.purchase.intlpage.IntlPremiumDiscountPlanCardFrame;
...
public final class IntlPremiumDiscountPlanCardFrame extends FrameLayout {
    ...
    public IntlPremiumDiscountPlanCardFrame(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.strokeWidthPx = t100.m186890d(1.0f);
        this.glowStrokeWidthPx = t100.m186890d(2.5f);
        this.cornerRadiusPx = t100.m186890d(16.0f);
        this.glowPathBaseOutsetPx = t100.m186890d(2.0f);
        this.baseFillColor = LazyKt__LazyJVMKt.m87228a(LazyThreadSafetyMode.NONE, new Function0() { // from class: l.mto
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Integer.valueOf(IntlPremiumDiscountPlanCardFrame.m53730a());
            }
        });
    ...
    public static int m53730a() {
        return App.f15369e.getColor(b1c0.f72519I);
    }

    /* JADX INFO: renamed from: e */
    public static final void m53732e(IntlPremiumDiscountPlanCardFrame intlPremiumDiscountPlanCardFrame, ValueAnimator valueAnimator) {
    ...
    public final void m53733c(Canvas canvas, Path fillPath) {
        ...
        if (valueAnimator == null || !valueAnimator.isRunning()) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.lto
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                    IntlPremiumDiscountPlanCardFrame.m53732e(this.f129984a, valueAnimator3);
                }
            });
    ...
    public void onDraw(@NotNull Canvas canvas) {
        ...
        float f4 = 0.6f * f2;
        int iM87601g = C15167a.m87601g((int) ((0.4f + f4) * 255.0f), 0, 255);
        float density = getDensity() * ((6.0f * f2) + 4.0f);
        float density2 = getDensity() * f2 * 3.0f;
        int iM87601g2 = C15167a.m87601g((int) (f4 * 255.0f), 0, 255);
        ...
        this.glowDiffusePaint.setColor(Color.argb(iM87601g2, 216, CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256, CipherSuite.TLS_DHE_PSK_WITH_RC4_128_SHA));
        ...
        this.crispBorderPaint.setColor(Color.argb(iM87601g, 216, CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256, CipherSuite.TLS_DHE_PSK_WITH_RC4_128_SHA));
