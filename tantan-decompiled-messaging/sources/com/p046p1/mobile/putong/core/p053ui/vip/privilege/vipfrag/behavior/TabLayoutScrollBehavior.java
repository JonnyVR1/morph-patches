...
public final class TabLayoutScrollBehavior extends CoordinatorLayout.AbstractC0226c<View> {
    ...
    public static int f37820b = t100.f167260i;
    ...
    @Metadata(m87231d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\"\u0010\u0005\u001a\u00020\u00048\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\n¨\u0006\u000b"}, m87232d2 = {"Lcom/p1/mobile/putong/core/ui/vip/privilege/vipfrag/behavior/TabLayoutScrollBehavior$a;", "", "<init>", "()V", "", "alphaShowMargin", "I", "a", "()I", "setAlphaShowMargin", "(I)V", "b_core_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class Companion {
        ...
        public final int m57437a() {
            return TabLayoutScrollBehavior.f37820b;
        }
    ...
    /* JADX INFO: renamed from: b */
    public final void m57436b(@Nullable View view) {
    ...
    public boolean onDependentViewChanged(@NotNull CoordinatorLayout parent, @NotNull View child, @NotNull View dependency) {
        ...
        if (height <= child.getHeight() + f37820b) {
            xdl0.m208344M(child, true);
            child.setAlpha(1.0f);
            View view = this.oppositeAlphaTargetView;
            if (view != null) {
                view.setAlpha(0.0f);
            }
        } else if (height <= (child.getHeight() * 2) + f37820b) {
            xdl0.m208344M(child, true);
            float height2 = (((height - child.getHeight()) - f37820b) * 1.0f) / child.getHeight();
