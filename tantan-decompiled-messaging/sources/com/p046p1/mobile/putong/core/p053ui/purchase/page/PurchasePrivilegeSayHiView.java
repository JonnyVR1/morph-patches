...
public final class PurchasePrivilegeSayHiView extends FrameLayout {
    ...
    public final void m54195a(View view) {
        d8b0.m110321a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m54196b() {
        if (zz6.m221004u0()) {
            get_bg().setImageResource(d3c0.f84044o6);
        } else {
            get_bg().setImageResource(d3c0.f84030n6);
        }
        get_avatar().setImageUrl(CoreModule.f17545c.f19639e0.m169527p9().m60124fp().url);
    }
