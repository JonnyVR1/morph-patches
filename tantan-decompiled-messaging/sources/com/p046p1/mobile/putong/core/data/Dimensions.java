...
public class Dimensions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Dimensions> PROTOBUF_ADAPTER = new MessageNanoAdapter<Dimensions>() { // from class: com.p1.mobile.putong.core.data.Dimensions.1
        ...
        public int computeAndCacheSize(Dimensions dimensions) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, dimensions.value);
            dimensions.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Dimensions parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    dimensions.key = nb5Var.m158750s();
                } else {
                    if (iM158752u != 16) {
                        if (dimensions.key != null) {
                            break;
                    ...
                    dimensions.value = nb5Var.m158741j();
                }
            }
            return dimensions;
        }
        ...
        public void serialize(Dimensions dimensions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, dimensions.value);
        }
    };
    ...
    public Dimensions mo223809clone() {
        Dimensions dimensions = new Dimensions();
