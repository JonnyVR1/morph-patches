...
public class SignPaymentParam extends PaymentParam implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SignPaymentParam> PROTOBUF_ADAPTER = new MessageNanoAdapter<SignPaymentParam>() { // from class: com.p1.mobile.putong.core.data.SignPaymentParam.1
        ...
        public int computeAndCacheSize(SignPaymentParam signPaymentParam) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(4, signPaymentParam.useAutoDeduct) + CodedOutputByteBufferNano.m17220b(5, signPaymentParam.signAndPay);
            ...
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(51, signPaymentParam.addHuaZhi);
            String str6 = signPaymentParam.contractId;
            if (str6 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(52, str6);
            }
            int iM17220b3 = iM17220b2 + CodedOutputByteBufferNano.m17220b(53, signPaymentParam.delayCharge) + CodedOutputByteBufferNano.m17220b(54, signPaymentParam.reSignAfterFail);
            signPaymentParam.cachedSize = iM17220b3;
            return iM17220b3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SignPaymentParam parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        signPaymentParam.itemId = nb5Var.m158750s();
                        continue;
                    case 18:
                        signPaymentParam.receipt = nb5Var.m158750s();
                        continue;
                    case 26:
                        signPaymentParam.url = nb5Var.m158750s();
                        continue;
                    case 32:
                        signPaymentParam.useAutoDeduct = nb5Var.m158738g();
                        continue;
                    case 40:
                        signPaymentParam.signAndPay = nb5Var.m158738g();
                        continue;
                    case 50:
                        signPaymentParam.tracker = nb5Var.m158750s();
                        continue;
                    case 58:
                        signPaymentParam.ext = (PaymentParamExtra) nb5Var.m158743l(PaymentParamExtra.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        signPaymentParam.couponId = nb5Var.m158750s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        signPaymentParam.addHuaZhi = nb5Var.m158738g();
                        continue;
                    case 418:
                        signPaymentParam.contractId = nb5Var.m158750s();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        signPaymentParam.delayCharge = nb5Var.m158738g();
                        continue;
                    case 432:
                        signPaymentParam.reSignAfterFail = nb5Var.m158738g();
                        continue;
                    default:
                        if (signPaymentParam.itemId == null) {
                            signPaymentParam.itemId = "";
        ...
        public void serialize(SignPaymentParam signPaymentParam, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(4, signPaymentParam.useAutoDeduct);
            codedOutputByteBufferNano.m17244A(5, signPaymentParam.signAndPay);
            String str4 = signPaymentParam.tracker;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17244A(51, signPaymentParam.addHuaZhi);
            String str6 = signPaymentParam.contractId;
            if (str6 != null) {
                codedOutputByteBufferNano.m17261R(52, str6);
            }
            codedOutputByteBufferNano.m17244A(53, signPaymentParam.delayCharge);
            codedOutputByteBufferNano.m17244A(54, signPaymentParam.reSignAfterFail);
        }
    };
    ...
    public SignPaymentParam mo223809clone() {
        SignPaymentParam signPaymentParam = new SignPaymentParam();
        ...
        if (paymentParamExtra != null) {
            signPaymentParam.ext = paymentParamExtra.mo223809clone();
        }
