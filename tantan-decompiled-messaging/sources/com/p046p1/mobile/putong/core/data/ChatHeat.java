...
public class ChatHeat extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatHeat> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatHeat>() { // from class: com.p1.mobile.putong.core.data.ChatHeat.1
        ...
        public int computeAndCacheSize(ChatHeat chatHeat) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, chatHeat._id);
            String str = chatHeat.f56011id;
            if (str != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17222d = iM17228j + CodedOutputByteBufferNano.m17222d(51, chatHeat.degree) + CodedOutputByteBufferNano.m17220b(52, chatHeat.levelUp) + CodedOutputByteBufferNano.m17220b(53, chatHeat.specialRemind) + CodedOutputByteBufferNano.m17222d(54, chatHeat.exclusiveChatInviteTime) + CodedOutputByteBufferNano.m17222d(55, chatHeat.exclusiveChatInviteExpireTime) + CodedOutputByteBufferNano.m17222d(56, chatHeat.exclusiveChatStartTime) + CodedOutputByteBufferNano.m17222d(57, chatHeat.exclusiveChatEndTime) + CodedOutputByteBufferNano.m17220b(58, chatHeat.showLevelDown) + CodedOutputByteBufferNano.m17222d(59, chatHeat.tempDownDegree);
            chatHeat.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatHeat parse(nb5 nb5Var) throws IOException {
            ChatHeat chatHeat = new ChatHeat();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 8:
                        chatHeat._id = nb5Var.m158742k();
                        break;
                    case 18:
                        chatHeat.f56011id = nb5Var.m158750s();
                        break;
                    case 409:
                        chatHeat.degree = nb5Var.m158739h();
                        break;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        chatHeat.levelUp = nb5Var.m158738g();
                        break;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        chatHeat.specialRemind = nb5Var.m158738g();
                        break;
                    case 433:
                        chatHeat.exclusiveChatInviteTime = nb5Var.m158739h();
                        break;
                    case 441:
                        chatHeat.exclusiveChatInviteExpireTime = nb5Var.m158739h();
                        break;
                    case 449:
                        chatHeat.exclusiveChatStartTime = nb5Var.m158739h();
                        break;
                    case 457:
                        chatHeat.exclusiveChatEndTime = nb5Var.m158739h();
                        break;
                    case 464:
                        chatHeat.showLevelDown = nb5Var.m158738g();
                        break;
                    case 473:
                        chatHeat.tempDownDegree = nb5Var.m158739h();
                        break;
                    default:
                        return chatHeat;
                }
        ...
        public void serialize(ChatHeat chatHeat, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, chatHeat._id);
            String str = chatHeat.f56011id;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17246C(51, chatHeat.degree);
            codedOutputByteBufferNano.m17244A(52, chatHeat.levelUp);
            codedOutputByteBufferNano.m17244A(53, chatHeat.specialRemind);
            codedOutputByteBufferNano.m17246C(54, chatHeat.exclusiveChatInviteTime);
            codedOutputByteBufferNano.m17246C(55, chatHeat.exclusiveChatInviteExpireTime);
            codedOutputByteBufferNano.m17246C(56, chatHeat.exclusiveChatStartTime);
            codedOutputByteBufferNano.m17246C(57, chatHeat.exclusiveChatEndTime);
            codedOutputByteBufferNano.m17244A(58, chatHeat.showLevelDown);
            codedOutputByteBufferNano.m17246C(59, chatHeat.tempDownDegree);
        }
    };
        ...
        public boolean parseField(ChatHeat chatHeat, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "exclusiveChatInviteTime":
                    ...
                    return true;
                case "id":
                    chatHeat.f56011id = jsonParser.getValueAsString();
                    return false;
                case "levelUp":
    ...
    public static final StringColumn<ChatHeat> f20367ID = new StringColumn<ChatHeat>("id_c") { // from class: com.p1.mobile.putong.core.data.ChatHeat.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ChatHeat chatHeat) {
            return chatHeat.f56011id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ChatHeat chatHeat, String str) {
            chatHeat.f56011id = str;
        }
    };
    ...
    public static mrf0<ChatHeat> DB_ADAPTER = new mrf0<ChatHeat>() { // from class: com.p1.mobile.putong.core.data.ChatHeat.14
        ...
        public ChatHeat read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i2 = i + 1;
                chatHeat.f56011id = cursor.isNull(i2) ? null : cursor.getString(i2);
        ...
        public void write(ChatHeat chatHeat, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", chatHeat.f56011id);
    ...
    public ChatHeat mo223809clone() {
        ChatHeat chatHeat = new ChatHeat();
        chatHeat._id = this._id;
        chatHeat.f56011id = this.f56011id;
