...
public class IntlCampingSummaryData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlCampingSummaryData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlCampingSummaryData>() { // from class: com.p1.mobile.putong.core.data.IntlCampingSummaryData.1
        ...
        public int computeAndCacheSize(IntlCampingSummaryData intlCampingSummaryData) {
            ...
            intlCampingSummaryData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlCampingSummaryData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        intlCampingSummaryData.heading_url = nb5Var.m158750s();
                        continue;
                    case 18:
                        intlCampingSummaryData.logo_url = nb5Var.m158750s();
                        continue;
                    case 26:
                        intlCampingSummaryData.bg_url = nb5Var.m158750s();
                        continue;
                    case 34:
                        intlCampingSummaryData.desc = nb5Var.m158750s();
                        continue;
                    case 42:
                        intlCampingSummaryData.desc_font_color = nb5Var.m158750s();
                        continue;
                    case 50:
                        intlCampingSummaryData.btn_bg_color = nb5Var.m158750s();
                        continue;
                    case 58:
                        intlCampingSummaryData.btn_font_color = nb5Var.m158750s();
                        continue;
                    case 66:
                        intlCampingSummaryData.start_btn_desc = nb5Var.m158750s();
                        continue;
                    case 74:
                        intlCampingSummaryData.success_btn_desc = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        intlCampingSummaryData.question_bg_url = nb5Var.m158750s();
                        continue;
                    default:
                        if (intlCampingSummaryData.heading_url == null) {
                            intlCampingSummaryData.heading_url = "";
    ...
    public IntlCampingSummaryData mo223809clone() {
        IntlCampingSummaryData intlCampingSummaryData = new IntlCampingSummaryData();
