...
public class SpecialCard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpecialCard> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpecialCard>() { // from class: com.p1.mobile.putong.core.data.SpecialCard.1
        ...
        public int computeAndCacheSize(SpecialCard specialCard) {
            ...
            int iM17226h = specialCardGender != null ? CodedOutputByteBufferNano.m17226h(1, specialCardGender.ordinal()) : 0;
            DeviceType deviceType = specialCard.device_OS;
            if (deviceType != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(2, deviceType.ordinal());
            }
            ...
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(4, specialCard.actived_duration);
            List<Double> list2 = specialCard.interval_day;
            if (list2 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(5, list2, ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17226h3 = iM17226h2 + CodedOutputByteBufferNano.m17226h(6, specialCard.interval_hour_cycle_mode) + CodedOutputByteBufferNano.m17226h(7, specialCard.swipe_wright_time) + CodedOutputByteBufferNano.m17226h(8, specialCard.num_limited_left) + CodedOutputByteBufferNano.m17226h(9, specialCard.version);
            SpecialCardGender specialCardGender2 = specialCard.gender;
            if (specialCardGender2 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17230l(10, specialCardGender2, SpecialCardGender.PROTOBUF_ADAPTER);
            }
            DeviceType deviceType2 = specialCard.device_OS;
            if (deviceType2 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17230l(11, deviceType2, DeviceType.PROTOBUF_ADAPTER);
            }
            specialCard.cachedSize = iM17226h3;
            return iM17226h3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SpecialCard parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    ...
                    case 16:
                        ...
                        continue;
                    case 26:
                        specialCard.signup_country = (List) nb5Var.m158743l(ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 32:
                        specialCard.actived_duration = nb5Var.m158741j();
                        continue;
                    case 42:
                        specialCard.interval_day = (List) nb5Var.m158743l(ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 48:
                        specialCard.interval_hour_cycle_mode = nb5Var.m158741j();
                        continue;
                    case 56:
                        specialCard.swipe_wright_time = nb5Var.m158741j();
                        continue;
                    case 64:
                        specialCard.num_limited_left = nb5Var.m158741j();
                        continue;
                    case 72:
                        specialCard.version = nb5Var.m158741j();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        specialCard.gender = (SpecialCardGender) nb5Var.m158743l(SpecialCardGender.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        specialCard.device_OS = (DeviceType) nb5Var.m158743l(DeviceType.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (specialCard.gender == null && numValueOf != null) {
                            specialCard.gender = (SpecialCardGender) SpecialCardGender.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(SpecialCard specialCard, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (specialCardGender != null) {
                codedOutputByteBufferNano.m17250G(1, specialCardGender.ordinal());
            }
            DeviceType deviceType = specialCard.device_OS;
            if (deviceType != null) {
                codedOutputByteBufferNano.m17250G(2, deviceType.ordinal());
            }
            List<Integer> list = specialCard.signup_country;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(4, specialCard.actived_duration);
            List<Double> list2 = specialCard.interval_day;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(5, list2, ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(6, specialCard.interval_hour_cycle_mode);
            codedOutputByteBufferNano.m17250G(7, specialCard.swipe_wright_time);
            codedOutputByteBufferNano.m17250G(8, specialCard.num_limited_left);
            codedOutputByteBufferNano.m17250G(9, specialCard.version);
            SpecialCardGender specialCardGender2 = specialCard.gender;
            if (specialCardGender2 != null) {
                codedOutputByteBufferNano.m17254K(10, specialCardGender2, SpecialCardGender.PROTOBUF_ADAPTER);
            }
            DeviceType deviceType2 = specialCard.device_OS;
            if (deviceType2 != null) {
                codedOutputByteBufferNano.m17254K(11, deviceType2, DeviceType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ Double m35847a(Double d) {
        return d;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m35848b(Integer num) {
        return num;
    }
    ...
    public SpecialCard mo223809clone() {
        SpecialCard specialCard = new SpecialCard();
        ...
        if (list != null) {
            specialCard.signup_country = ValueObject.util_map(list, new w9j() { // from class: l.dnf0
                ...
                public final Object call(Object obj) {
                    return SpecialCard.m35848b((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            specialCard.interval_day = ValueObject.util_map(list2, new w9j() { // from class: l.enf0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return SpecialCard.m35847a((Double) obj);
                }
            });
        }
