...
public class BuzzUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BuzzUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<BuzzUser>() { // from class: com.p1.mobile.putong.core.data.BuzzUser.1
        ...
        public int computeAndCacheSize(BuzzUser buzzUser) {
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(6, buzzUser.age) + CodedOutputByteBufferNano.m17220b(7, buzzUser.isBlur);
            buzzUser.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BuzzUser parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    buzzUser.userId = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    buzzUser.buzzToken = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    buzzUser.gender = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    buzzUser.avatar = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    buzzUser.name = nb5Var.m158750s();
                } else if (iM158752u == 48) {
                    buzzUser.age = nb5Var.m158741j();
                } else {
                    if (iM158752u != 56) {
                        if (buzzUser.userId == null) {
                            buzzUser.userId = "";
                    ...
                    buzzUser.isBlur = nb5Var.m158738g();
                }
            }
            return buzzUser;
        }
        ...
        public void serialize(BuzzUser buzzUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(6, buzzUser.age);
            codedOutputByteBufferNano.m17244A(7, buzzUser.isBlur);
        }
    };
