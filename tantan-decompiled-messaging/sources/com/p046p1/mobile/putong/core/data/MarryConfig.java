...
public class MarryConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MarryConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<MarryConfig>() { // from class: com.p1.mobile.putong.core.data.MarryConfig.1
        ...
        public int computeAndCacheSize(MarryConfig marryConfig) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, marryConfig.enable);
            ...
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(9, marryConfig.enable_pay_wall);
            marryConfig.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MarryConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    marryConfig.enable = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    marryConfig.card_border_color = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    marryConfig.card_head_bg = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    marryConfig.card_label_bg_color = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    marryConfig.profile_head_bg_android = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    marryConfig.profile_head_state_color = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    marryConfig.profile_head_bg_ios = nb5Var.m158750s();
                } else if (iM158752u == 66) {
                    marryConfig.pre_profile_head_bg = nb5Var.m158750s();
                } else {
                    if (iM158752u != 72) {
                        if (marryConfig.card_border_color == null) {
                            marryConfig.card_border_color = "";
                    ...
                    marryConfig.enable_pay_wall = nb5Var.m158738g();
                }
            }
            return marryConfig;
        }
        ...
        public void serialize(MarryConfig marryConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, marryConfig.enable);
            String str = marryConfig.card_border_color;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17244A(9, marryConfig.enable_pay_wall);
        }
    };
    ...
    public MarryConfig mo223809clone() {
        MarryConfig marryConfig = new MarryConfig();
