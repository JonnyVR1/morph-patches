...
public class MsgIcebreakConfigV2 extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MsgIcebreakConfigV2> PROTOBUF_ADAPTER = new MessageNanoAdapter<MsgIcebreakConfigV2>() { // from class: com.p1.mobile.putong.core.data.MsgIcebreakConfigV2.1
        ...
        public int computeAndCacheSize(MsgIcebreakConfigV2 msgIcebreakConfigV2) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, msgIcebreakConfigV2.iceBreakLastMessageTimeLimit) + CodedOutputByteBufferNano.m17226h(2, msgIcebreakConfigV2.iceBreakLastMessageShowCountLimit) + CodedOutputByteBufferNano.m17226h(3, msgIcebreakConfigV2.associateShowCountLimit) + CodedOutputByteBufferNano.m17220b(4, msgIcebreakConfigV2.enable);
            msgIcebreakConfigV2.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MsgIcebreakConfigV2 parse(nb5 nb5Var) throws IOException {
            MsgIcebreakConfigV2 msgIcebreakConfigV2 = new MsgIcebreakConfigV2();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    msgIcebreakConfigV2.iceBreakLastMessageTimeLimit = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    msgIcebreakConfigV2.iceBreakLastMessageShowCountLimit = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    msgIcebreakConfigV2.associateShowCountLimit = nb5Var.m158741j();
                } else {
                    if (iM158752u != 32) {
                        return msgIcebreakConfigV2;
                    }
                    msgIcebreakConfigV2.enable = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(MsgIcebreakConfigV2 msgIcebreakConfigV2, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, msgIcebreakConfigV2.iceBreakLastMessageTimeLimit);
            codedOutputByteBufferNano.m17250G(2, msgIcebreakConfigV2.iceBreakLastMessageShowCountLimit);
            codedOutputByteBufferNano.m17250G(3, msgIcebreakConfigV2.associateShowCountLimit);
            codedOutputByteBufferNano.m17244A(4, msgIcebreakConfigV2.enable);
        }
    };
    ...
    public MsgIcebreakConfigV2 mo223809clone() {
        MsgIcebreakConfigV2 msgIcebreakConfigV2 = new MsgIcebreakConfigV2();
