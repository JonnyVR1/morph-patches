...
import com.p046p1.mobile.putong.core.data.CreativeData;
import com.p046p1.mobile.putong.core.data.PaymentPlatform;
...
public class CreativeData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CreativeData> PROTOBUF_ADAPTER = new MessageNanoAdapter<CreativeData>() { // from class: com.p1.mobile.putong.core.data.CreativeData.1
        ...
        public int computeAndCacheSize(CreativeData creativeData) {
            ...
            int iM17228j = l2 != null ? CodedOutputByteBufferNano.m17228j(1, l2.longValue()) : 0;
            Long l3 = creativeData.endTime;
            if (l3 != null) {
                iM17228j += CodedOutputByteBufferNano.m17228j(2, l3.longValue());
            }
            ProductCategory productCategory = creativeData.productType;
            if (productCategory != null) {
                iM17228j += CodedOutputByteBufferNano.m17226h(3, productCategory.ordinal());
            }
            ...
            if (list != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(5, PaymentPlatform.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Double d = creativeData.normalPrice;
            if (d != null) {
                iM17228j += CodedOutputByteBufferNano.m17222d(6, d.doubleValue());
            }
            Double d2 = creativeData.discountPrice;
            if (d2 != null) {
                iM17228j += CodedOutputByteBufferNano.m17222d(7, d2.doubleValue());
            }
            int iM17220b = iM17228j + CodedOutputByteBufferNano.m17220b(8, creativeData.popUpWindow) + CodedOutputByteBufferNano.m17220b(9, creativeData.autoRenewable);
            String str2 = creativeData.currencyCode;
            if (str2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(10, str2);
            }
            String str3 = creativeData.textTitle;
            if (str3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(11, str3);
            }
            List<String> list2 = creativeData.textContent;
            if (list2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(12, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = creativeData.terms;
            if (str4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(13, str4);
            }
            List<String> list3 = creativeData.clause;
            if (list3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(14, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = creativeData.buttonText;
            if (str5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(15, str5);
            }
            List<String> list4 = creativeData.buttonTexts;
            if (list4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(16, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<Media> list5 = creativeData.backgroundPicture;
            if (list5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(17, list5, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Media> list6 = creativeData.iconPicture;
            if (list6 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(18, list6, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Media> list7 = creativeData.positionPicture;
            if (list7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(19, list7, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(20, creativeData.displayPrice);
            String str6 = creativeData.currency;
            if (str6 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(21, str6);
            }
            String str7 = creativeData.skuID;
            if (str7 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(22, str7);
            }
            String str8 = creativeData.itemID;
            if (str8 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(23, str8);
            }
            ProductCategory productCategory2 = creativeData.productType;
            if (productCategory2 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(24, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            List<PaymentPlatform> list8 = creativeData.payPlatform;
            if (list8 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(25, list8, PaymentPlatform.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            creativeData.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CreativeData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        creativeData.startTime = Long.valueOf(nb5Var.m158742k());
                        continue;
                    case 16:
                        creativeData.endTime = Long.valueOf(nb5Var.m158742k());
                        continue;
                    case 24:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 34:
                        creativeData.promotionName = nb5Var.m158750s();
                        continue;
                    case 42:
                        list = (List) nb5Var.m158743l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 49:
                        creativeData.normalPrice = Double.valueOf(nb5Var.m158739h());
                        continue;
                    case 57:
                        creativeData.discountPrice = Double.valueOf(nb5Var.m158739h());
                        continue;
                    case 64:
                        creativeData.popUpWindow = nb5Var.m158738g();
                        continue;
                    case 72:
                        creativeData.autoRenewable = nb5Var.m158738g();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        creativeData.currencyCode = nb5Var.m158750s();
                        continue;
                    case 90:
                        creativeData.textTitle = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        creativeData.textContent = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 106:
                        creativeData.terms = nb5Var.m158750s();
                        continue;
                    case 114:
                        creativeData.clause = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 122:
                        creativeData.buttonText = nb5Var.m158750s();
                        continue;
                    case 130:
                        creativeData.buttonTexts = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        creativeData.backgroundPicture = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        creativeData.iconPicture = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 154:
                        creativeData.positionPicture = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 160:
                        creativeData.displayPrice = nb5Var.m158738g();
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        creativeData.currency = nb5Var.m158750s();
                        continue;
                    case 178:
                        creativeData.skuID = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        creativeData.itemID = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        creativeData.productType = (ProductCategory) nb5Var.m158743l(ProductCategory.PROTOBUF_ADAPTER);
                        continue;
                    case 202:
                        creativeData.payPlatform = (List) nb5Var.m158743l(PaymentPlatform.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (creativeData.productType == null && numValueOf != null) {
                            creativeData.productType = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(CreativeData creativeData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            Long l2 = creativeData.startTime;
            if (l2 != null) {
                codedOutputByteBufferNano.m17252I(1, l2.longValue());
            }
            Long l3 = creativeData.endTime;
            if (l3 != null) {
                codedOutputByteBufferNano.m17252I(2, l3.longValue());
            }
            ProductCategory productCategory = creativeData.productType;
            if (productCategory != null) {
                codedOutputByteBufferNano.m17250G(3, productCategory.ordinal());
            }
            String str = creativeData.promotionName;
            if (str != null) {
            ...
            List<PaymentPlatform> list = creativeData.payPlatform;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(5, PaymentPlatform.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Double d = creativeData.normalPrice;
            if (d != null) {
                codedOutputByteBufferNano.m17246C(6, d.doubleValue());
            }
            Double d2 = creativeData.discountPrice;
            if (d2 != null) {
                codedOutputByteBufferNano.m17246C(7, d2.doubleValue());
            }
            codedOutputByteBufferNano.m17244A(8, creativeData.popUpWindow);
            codedOutputByteBufferNano.m17244A(9, creativeData.autoRenewable);
            String str2 = creativeData.currencyCode;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(10, str2);
            }
            String str3 = creativeData.textTitle;
            if (str3 != null) {
            ...
            String str4 = creativeData.terms;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(13, str4);
            }
            List<String> list3 = creativeData.clause;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(14, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = creativeData.buttonText;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(15, str5);
            }
            List<String> list4 = creativeData.buttonTexts;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(16, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<Media> list5 = creativeData.backgroundPicture;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(17, list5, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Media> list6 = creativeData.iconPicture;
            if (list6 != null) {
                codedOutputByteBufferNano.m17254K(18, list6, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Media> list7 = creativeData.positionPicture;
            if (list7 != null) {
                codedOutputByteBufferNano.m17254K(19, list7, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17244A(20, creativeData.displayPrice);
            String str6 = creativeData.currency;
            if (str6 != null) {
                codedOutputByteBufferNano.m17261R(21, str6);
            }
            String str7 = creativeData.skuID;
            if (str7 != null) {
                codedOutputByteBufferNano.m17261R(22, str7);
            }
            String str8 = creativeData.itemID;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(23, str8);
            }
            ProductCategory productCategory2 = creativeData.productType;
            if (productCategory2 != null) {
                codedOutputByteBufferNano.m17254K(24, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            List<PaymentPlatform> list8 = creativeData.payPlatform;
            if (list8 != null) {
                codedOutputByteBufferNano.m17254K(25, list8, PaymentPlatform.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m35493b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ PaymentPlatform m35494c(PaymentPlatform paymentPlatform) {
        return paymentPlatform;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m35496e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m35498k(String str) {
        return str;
    }
    ...
    public CreativeData mo223809clone() {
        CreativeData creativeData = new CreativeData();
        ...
        if (list != null) {
            creativeData.payPlatform = ValueObject.util_map(list, new w9j() { // from class: l.ptb
                ...
                public final Object call(Object obj) {
                    return CreativeData.m35494c((PaymentPlatform) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            creativeData.textContent = ValueObject.util_map(list2, new w9j() { // from class: l.qtb
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return CreativeData.m35493b((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            creativeData.clause = ValueObject.util_map(list3, new w9j() { // from class: l.rtb
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return CreativeData.m35496e((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            creativeData.buttonTexts = ValueObject.util_map(list4, new w9j() { // from class: l.stb
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return CreativeData.m35498k((String) obj);
                }
            });
        }
