...
public class CoreLiveRoomInProfile extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreLiveRoomInProfile> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreLiveRoomInProfile>() { // from class: com.p1.mobile.putong.core.data.CoreLiveRoomInProfile.1
        ...
        public int computeAndCacheSize(CoreLiveRoomInProfile coreLiveRoomInProfile) {
            ...
            if (coreLiveMultiCallInfo != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(10, coreLiveMultiCallInfo, CoreLiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
            coreLiveRoomInProfile.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreLiveRoomInProfile parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        coreLiveRoomInProfile.liveId = nb5Var.m158750s();
                        continue;
                    case 18:
                        coreLiveRoomInProfile.title = nb5Var.m158750s();
                        continue;
                    case 26:
                        coreLiveRoomInProfile.subTitle = nb5Var.m158750s();
                        continue;
                    case 34:
                        coreLiveRoomInProfile.anchorId = nb5Var.m158750s();
                        continue;
                    case 42:
                        coreLiveRoomInProfile.roomId = nb5Var.m158750s();
                        continue;
                    case 50:
                        coreLiveRoomInProfile.liveType = nb5Var.m158750s();
                        continue;
                    case 58:
                        coreLiveRoomInProfile.background = nb5Var.m158750s();
                        continue;
                    case 66:
                        coreLiveRoomInProfile.anchorAvatar = nb5Var.m158750s();
                        continue;
                    case 74:
                        coreLiveRoomInProfile.status = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        coreLiveRoomInProfile.multiCallInfo = (CoreLiveMultiCallInfo) nb5Var.m158743l(CoreLiveMultiCallInfo.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (coreLiveRoomInProfile.liveId == null) {
                            coreLiveRoomInProfile.liveId = "";
        ...
        public void serialize(CoreLiveRoomInProfile coreLiveRoomInProfile, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CoreLiveMultiCallInfo coreLiveMultiCallInfo = coreLiveRoomInProfile.multiCallInfo;
            if (coreLiveMultiCallInfo != null) {
                codedOutputByteBufferNano.m17254K(10, coreLiveMultiCallInfo, CoreLiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public CoreLiveRoomInProfile mo223809clone() {
        CoreLiveRoomInProfile coreLiveRoomInProfile = new CoreLiveRoomInProfile();
        ...
        if (coreLiveMultiCallInfo != null) {
            coreLiveRoomInProfile.multiCallInfo = coreLiveMultiCallInfo.mo223809clone();
        }
        return coreLiveRoomInProfile;
    }
