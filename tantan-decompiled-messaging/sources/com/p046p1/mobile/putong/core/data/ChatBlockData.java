...
public class ChatBlockData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatBlockData> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatBlockData>() { // from class: com.p1.mobile.putong.core.data.ChatBlockData.1
        ...
        public int computeAndCacheSize(ChatBlockData chatBlockData) {
            ...
            int iM17226h = chatBlockStatus != null ? CodedOutputByteBufferNano.m17226h(1, chatBlockStatus.ordinal()) : 0;
            ChatBlockStatus chatBlockStatus2 = chatBlockData.status;
            if (chatBlockStatus2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(2, chatBlockStatus2, ChatBlockStatus.PROTOBUF_ADAPTER);
            }
            chatBlockData.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatBlockData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    ...
                    chatBlockData.status = (ChatBlockStatus) nb5Var.m158743l(ChatBlockStatus.PROTOBUF_ADAPTER);
                }
            }
            return chatBlockData;
        }
        ...
        public void serialize(ChatBlockData chatBlockData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (chatBlockStatus != null) {
                codedOutputByteBufferNano.m17250G(1, chatBlockStatus.ordinal());
            }
            ChatBlockStatus chatBlockStatus2 = chatBlockData.status;
            if (chatBlockStatus2 != null) {
                codedOutputByteBufferNano.m17254K(2, chatBlockStatus2, ChatBlockStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ChatBlockData mo223809clone() {
        ChatBlockData chatBlockData = new ChatBlockData();
