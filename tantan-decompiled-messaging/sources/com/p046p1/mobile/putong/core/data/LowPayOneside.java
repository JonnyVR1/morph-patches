...
public class LowPayOneside extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LowPayOneside> PROTOBUF_ADAPTER = new MessageNanoAdapter<LowPayOneside>() { // from class: com.p1.mobile.putong.core.data.LowPayOneside.1
        ...
        public int computeAndCacheSize(LowPayOneside lowPayOneside) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, lowPayOneside.isActor) + CodedOutputByteBufferNano.m17220b(2, lowPayOneside.reddot);
            lowPayOneside.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LowPayOneside parse(nb5 nb5Var) throws IOException {
            LowPayOneside lowPayOneside = new LowPayOneside();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    lowPayOneside.isActor = nb5Var.m158738g();
                } else {
                    if (iM158752u != 16) {
                        return lowPayOneside;
                    }
                    lowPayOneside.reddot = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(LowPayOneside lowPayOneside, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, lowPayOneside.isActor);
            codedOutputByteBufferNano.m17244A(2, lowPayOneside.reddot);
        }
    };
    ...
    public LowPayOneside mo223809clone() {
        LowPayOneside lowPayOneside = new LowPayOneside();
