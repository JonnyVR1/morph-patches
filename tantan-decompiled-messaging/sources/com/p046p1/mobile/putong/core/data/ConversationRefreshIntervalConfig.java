...
public class ConversationRefreshIntervalConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConversationRefreshIntervalConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConversationRefreshIntervalConfig>() { // from class: com.p1.mobile.putong.core.data.ConversationRefreshIntervalConfig.1
        ...
        public int computeAndCacheSize(ConversationRefreshIntervalConfig conversationRefreshIntervalConfig) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, conversationRefreshIntervalConfig.conversationRefreshObsInterval) + CodedOutputByteBufferNano.m17226h(2, conversationRefreshIntervalConfig.conversationListRefreshInterval) + CodedOutputByteBufferNano.m17220b(3, conversationRefreshIntervalConfig.monitorEnable);
            conversationRefreshIntervalConfig.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConversationRefreshIntervalConfig parse(nb5 nb5Var) throws IOException {
            ConversationRefreshIntervalConfig conversationRefreshIntervalConfig = new ConversationRefreshIntervalConfig();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    conversationRefreshIntervalConfig.conversationRefreshObsInterval = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    conversationRefreshIntervalConfig.conversationListRefreshInterval = nb5Var.m158741j();
                } else {
                    if (iM158752u != 24) {
                        return conversationRefreshIntervalConfig;
                    }
                    conversationRefreshIntervalConfig.monitorEnable = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(ConversationRefreshIntervalConfig conversationRefreshIntervalConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, conversationRefreshIntervalConfig.conversationRefreshObsInterval);
            codedOutputByteBufferNano.m17250G(2, conversationRefreshIntervalConfig.conversationListRefreshInterval);
            codedOutputByteBufferNano.m17244A(3, conversationRefreshIntervalConfig.monitorEnable);
        }
    };
    ...
    public ConversationRefreshIntervalConfig mo223809clone() {
        ConversationRefreshIntervalConfig conversationRefreshIntervalConfig = new ConversationRefreshIntervalConfig();
