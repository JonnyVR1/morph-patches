...
public class EvaluationShareTimes extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<EvaluationShareTimes> PROTOBUF_ADAPTER = new MessageNanoAdapter<EvaluationShareTimes>() { // from class: com.p1.mobile.putong.core.data.EvaluationShareTimes.1
        ...
        public int computeAndCacheSize(EvaluationShareTimes evaluationShareTimes) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, evaluationShareTimes.usedTimes) + CodedOutputByteBufferNano.m17228j(2, evaluationShareTimes.leftTimes);
            evaluationShareTimes.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public EvaluationShareTimes parse(nb5 nb5Var) throws IOException {
            EvaluationShareTimes evaluationShareTimes = new EvaluationShareTimes();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    evaluationShareTimes.usedTimes = nb5Var.m158742k();
                } else {
                    if (iM158752u != 16) {
                        return evaluationShareTimes;
                    }
                    evaluationShareTimes.leftTimes = nb5Var.m158742k();
                }
            }
        }
        ...
        public void serialize(EvaluationShareTimes evaluationShareTimes, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, evaluationShareTimes.usedTimes);
            codedOutputByteBufferNano.m17252I(2, evaluationShareTimes.leftTimes);
        }
    };
    ...
    public EvaluationShareTimes mo223809clone() {
        EvaluationShareTimes evaluationShareTimes = new EvaluationShareTimes();
