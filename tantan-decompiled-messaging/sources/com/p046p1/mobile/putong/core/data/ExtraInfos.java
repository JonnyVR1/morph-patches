...
public class ExtraInfos extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ExtraInfos> PROTOBUF_ADAPTER = new MessageNanoAdapter<ExtraInfos>() { // from class: com.p1.mobile.putong.core.data.ExtraInfos.1
        ...
        public int computeAndCacheSize(ExtraInfos extraInfos) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, extraInfos.trialLikedCount);
            ...
            extraInfos.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ExtraInfos parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    extraInfos.trialLikedCount = nb5Var.m158741j();
                } else {
                    if (iM158752u != 18) {
                        if (extraInfos.trialLikedAvatars != null) {
                            break;
                    ...
                    extraInfos.trialLikedAvatars = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return extraInfos;
        }
        ...
        public void serialize(ExtraInfos extraInfos, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, extraInfos.trialLikedCount);
            List<String> list = extraInfos.trialLikedAvatars;
            if (list != null) {
    ...
    public static /* synthetic */ String m35518a(String str) {
        return str;
    }
    ...
    public ExtraInfos mo223809clone() {
        ExtraInfos extraInfos = new ExtraInfos();
        ...
        if (list != null) {
            extraInfos.trialLikedAvatars = ValueObject.util_map(list, new w9j() { // from class: l.pqf
                ...
                public final Object call(Object obj) {
                    return ExtraInfos.m35518a((String) obj);
                }
            });
        }
        return extraInfos;
