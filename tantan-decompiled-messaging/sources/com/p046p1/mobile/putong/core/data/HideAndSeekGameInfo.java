...
public class HideAndSeekGameInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<HideAndSeekGameInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<HideAndSeekGameInfo>() { // from class: com.p1.mobile.putong.core.data.HideAndSeekGameInfo.1
        ...
        public int computeAndCacheSize(HideAndSeekGameInfo hideAndSeekGameInfo) {
            ...
            if (gameIdentity != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, gameIdentity, GameIdentity.PROTOBUF_ADAPTER);
            }
            ...
            if (gameStage != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, gameStage, GameStage.PROTOBUF_ADAPTER);
            }
            GamePlayerState gamePlayerState = hideAndSeekGameInfo.gamePlayerState;
            if (gamePlayerState != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(8, gamePlayerState, GamePlayerState.PROTOBUF_ADAPTER);
            }
            List<String> list = hideAndSeekGameInfo.gamePlayerIcons;
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(9, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            hideAndSeekGameInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public HideAndSeekGameInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    hideAndSeekGameInfo.gameIcon = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    hideAndSeekGameInfo.gameIdentity = (GameIdentity) nb5Var.m158743l(GameIdentity.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    hideAndSeekGameInfo.gameTitle = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    hideAndSeekGameInfo.gameDesc = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    hideAndSeekGameInfo.gameTime = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    hideAndSeekGameInfo.gameAddress = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    hideAndSeekGameInfo.gameStage = (GameStage) nb5Var.m158743l(GameStage.PROTOBUF_ADAPTER);
                } else if (iM158752u == 66) {
                    hideAndSeekGameInfo.gamePlayerState = (GamePlayerState) nb5Var.m158743l(GamePlayerState.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 74) {
                        if (hideAndSeekGameInfo.gameIcon == null) {
                            hideAndSeekGameInfo.gameIcon = "";
                    ...
                    hideAndSeekGameInfo.gamePlayerIcons = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return hideAndSeekGameInfo;
        }
        ...
        public void serialize(HideAndSeekGameInfo hideAndSeekGameInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            GameIdentity gameIdentity = hideAndSeekGameInfo.gameIdentity;
            if (gameIdentity != null) {
                codedOutputByteBufferNano.m17254K(2, gameIdentity, GameIdentity.PROTOBUF_ADAPTER);
            }
            String str2 = hideAndSeekGameInfo.gameTitle;
            if (str2 != null) {
            ...
            GameStage gameStage = hideAndSeekGameInfo.gameStage;
            if (gameStage != null) {
                codedOutputByteBufferNano.m17254K(7, gameStage, GameStage.PROTOBUF_ADAPTER);
            }
            GamePlayerState gamePlayerState = hideAndSeekGameInfo.gamePlayerState;
            if (gamePlayerState != null) {
                codedOutputByteBufferNano.m17254K(8, gamePlayerState, GamePlayerState.PROTOBUF_ADAPTER);
            }
            List<String> list = hideAndSeekGameInfo.gamePlayerIcons;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(9, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m35577a(String str) {
        return str;
    }
    ...
    public HideAndSeekGameInfo mo223809clone() {
        HideAndSeekGameInfo hideAndSeekGameInfo = new HideAndSeekGameInfo();
        ...
        if (list != null) {
            hideAndSeekGameInfo.gamePlayerIcons = ValueObject.util_map(list, new w9j() { // from class: l.wzk
                ...
                public final Object call(Object obj) {
                    return HideAndSeekGameInfo.m35577a((String) obj);
                }
            });
        }
        return hideAndSeekGameInfo;
