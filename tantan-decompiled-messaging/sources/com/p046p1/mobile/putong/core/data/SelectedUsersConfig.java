...
public class SelectedUsersConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SelectedUsersConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<SelectedUsersConfig>() { // from class: com.p1.mobile.putong.core.data.SelectedUsersConfig.1
        ...
        public int computeAndCacheSize(SelectedUsersConfig selectedUsersConfig) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, selectedUsersConfig.leftSlidingTriggersCardInsertion) + CodedOutputByteBufferNano.m17226h(2, selectedUsersConfig.picksZoneEntranceRefreshFreqControl) + CodedOutputByteBufferNano.m17220b(3, selectedUsersConfig.enabled);
            selectedUsersConfig.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SelectedUsersConfig parse(nb5 nb5Var) throws IOException {
            SelectedUsersConfig selectedUsersConfig = new SelectedUsersConfig();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    selectedUsersConfig.leftSlidingTriggersCardInsertion = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    selectedUsersConfig.picksZoneEntranceRefreshFreqControl = nb5Var.m158741j();
                } else {
                    if (iM158752u != 24) {
                        return selectedUsersConfig;
                    }
                    selectedUsersConfig.enabled = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(SelectedUsersConfig selectedUsersConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, selectedUsersConfig.leftSlidingTriggersCardInsertion);
            codedOutputByteBufferNano.m17250G(2, selectedUsersConfig.picksZoneEntranceRefreshFreqControl);
            codedOutputByteBufferNano.m17244A(3, selectedUsersConfig.enabled);
        }
    };
    ...
    public SelectedUsersConfig mo223809clone() {
        SelectedUsersConfig selectedUsersConfig = new SelectedUsersConfig();
