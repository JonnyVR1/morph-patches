...
public class IntlTabMePayGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlTabMePayGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlTabMePayGuide>() { // from class: com.p1.mobile.putong.core.data.IntlTabMePayGuide.1
        ...
        public int computeAndCacheSize(IntlTabMePayGuide intlTabMePayGuide) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, intlTabMePayGuide.showBanner);
            ...
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(4, intlTabMePayGuide.isUpgraded);
            IntlTabMePayGuideText intlTabMePayGuideText = intlTabMePayGuide.text;
            if (intlTabMePayGuideText != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(5, intlTabMePayGuideText, IntlTabMePayGuideText.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17220b2 + CodedOutputByteBufferNano.m17226h(6, intlTabMePayGuide.contractIntervalDays);
            intlTabMePayGuide.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlTabMePayGuide parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    intlTabMePayGuide.showBanner = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    intlTabMePayGuide.bannerType = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    intlTabMePayGuide.membershipType = nb5Var.m158750s();
                } else if (iM158752u == 32) {
                    intlTabMePayGuide.isUpgraded = nb5Var.m158738g();
                } else if (iM158752u == 42) {
                    intlTabMePayGuide.text = (IntlTabMePayGuideText) nb5Var.m158743l(IntlTabMePayGuideText.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 48) {
                        if (intlTabMePayGuide.bannerType == null) {
                            intlTabMePayGuide.bannerType = "";
                    ...
                    intlTabMePayGuide.contractIntervalDays = nb5Var.m158741j();
                }
            }
            return intlTabMePayGuide;
        }
        ...
        public void serialize(IntlTabMePayGuide intlTabMePayGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, intlTabMePayGuide.showBanner);
            String str = intlTabMePayGuide.bannerType;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17244A(4, intlTabMePayGuide.isUpgraded);
            IntlTabMePayGuideText intlTabMePayGuideText = intlTabMePayGuide.text;
            if (intlTabMePayGuideText != null) {
                codedOutputByteBufferNano.m17254K(5, intlTabMePayGuideText, IntlTabMePayGuideText.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(6, intlTabMePayGuide.contractIntervalDays);
        }
    };
    ...
    public IntlTabMePayGuide mo223809clone() {
        IntlTabMePayGuide intlTabMePayGuide = new IntlTabMePayGuide();
        ...
        if (intlTabMePayGuideText != null) {
            intlTabMePayGuide.text = intlTabMePayGuideText.mo223809clone();
        }
