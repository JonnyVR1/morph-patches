...
public class TextCardData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TextCardData> PROTOBUF_ADAPTER = new MessageNanoAdapter<TextCardData>() { // from class: com.p1.mobile.putong.core.data.TextCardData.1
        ...
        public int computeAndCacheSize(TextCardData textCardData) {
            ...
            textCardData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TextCardData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    textCardData.userID = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    textCardData.secretKey = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    textCardData.stage = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    textCardData.biz = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    textCardData.fitReason = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    textCardData.zodiacFitPercent = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (textCardData.userID == null) {
                            textCardData.userID = "";
                    ...
                    textCardData.friendPurpose = nb5Var.m158750s();
                }
            }
            return textCardData;
        }
    ...
    public TextCardData mo223809clone() {
        TextCardData textCardData = new TextCardData();
