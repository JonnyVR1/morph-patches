...
public class CardModel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CardModel> PROTOBUF_ADAPTER = new MessageNanoAdapter<CardModel>() { // from class: com.p1.mobile.putong.core.data.CardModel.1
        ...
        public int computeAndCacheSize(CardModel cardModel) {
            ...
            if (borderModel != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, borderModel, BorderModel.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(3, cardModel.cardType);
            CardExtraData cardExtraData = cardModel.extraData;
            if (cardExtraData != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, cardExtraData, CardExtraData.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(5, cardModel.momentLikedYou) + CodedOutputByteBufferNano.m17220b(6, cardModel.boostLikeYou) + CodedOutputByteBufferNano.m17220b(7, cardModel.newUser);
            String str2 = cardModel.payCardStyle;
            if (str2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(8, str2);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(9, cardModel.meetAgain) + CodedOutputByteBufferNano.m17226h(10, cardModel.friendSenseExamLikeCnt) + CodedOutputByteBufferNano.m17220b(11, cardModel.selectionUser);
            List<String> list = cardModel.dynamicLabels;
            if (list != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(12, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            cardModel.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CardModel parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        cardModel.userId = nb5Var.m158750s();
                        continue;
                    case 18:
                        cardModel.borderModel = (BorderModel) nb5Var.m158743l(BorderModel.PROTOBUF_ADAPTER);
                        continue;
                    case 24:
                        cardModel.cardType = nb5Var.m158741j();
                        continue;
                    case 34:
                        cardModel.extraData = (CardExtraData) nb5Var.m158743l(CardExtraData.PROTOBUF_ADAPTER);
                        continue;
                    case 40:
                        cardModel.momentLikedYou = nb5Var.m158738g();
                        continue;
                    case 48:
                        cardModel.boostLikeYou = nb5Var.m158738g();
                        continue;
                    case 56:
                        cardModel.newUser = nb5Var.m158738g();
                        continue;
                    case 66:
                        cardModel.payCardStyle = nb5Var.m158750s();
                        continue;
                    case 72:
                        cardModel.meetAgain = nb5Var.m158738g();
                        continue;
                    case 80:
                        cardModel.friendSenseExamLikeCnt = nb5Var.m158741j();
                        continue;
                    case 88:
                        cardModel.selectionUser = nb5Var.m158738g();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        cardModel.dynamicLabels = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (cardModel.userId == null) {
                            cardModel.userId = "";
        ...
        public void serialize(CardModel cardModel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BorderModel borderModel = cardModel.borderModel;
            if (borderModel != null) {
                codedOutputByteBufferNano.m17254K(2, borderModel, BorderModel.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(3, cardModel.cardType);
            CardExtraData cardExtraData = cardModel.extraData;
            if (cardExtraData != null) {
                codedOutputByteBufferNano.m17254K(4, cardExtraData, CardExtraData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(5, cardModel.momentLikedYou);
            codedOutputByteBufferNano.m17244A(6, cardModel.boostLikeYou);
            codedOutputByteBufferNano.m17244A(7, cardModel.newUser);
            String str2 = cardModel.payCardStyle;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(8, str2);
            }
            codedOutputByteBufferNano.m17244A(9, cardModel.meetAgain);
            codedOutputByteBufferNano.m17250G(10, cardModel.friendSenseExamLikeCnt);
            codedOutputByteBufferNano.m17244A(11, cardModel.selectionUser);
            List<String> list = cardModel.dynamicLabels;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(12, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m35232a(String str) {
        return str;
    }
        ...
        if (list != null) {
            cardModel.dynamicLabels = ValueObject.util_map(list, new w9j() { // from class: l.bl4
                ...
                public final Object call(Object obj) {
                    return CardModel.m35232a((String) obj);
                }
            });
        }
        return cardModel;
