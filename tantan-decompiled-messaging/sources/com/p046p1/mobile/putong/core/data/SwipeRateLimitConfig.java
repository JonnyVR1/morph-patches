...
public class SwipeRateLimitConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SwipeRateLimitConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<SwipeRateLimitConfig>() { // from class: com.p1.mobile.putong.core.data.SwipeRateLimitConfig.1
        ...
        public int computeAndCacheSize(SwipeRateLimitConfig swipeRateLimitConfig) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, swipeRateLimitConfig.enable) + CodedOutputByteBufferNano.m17226h(2, swipeRateLimitConfig.countPerSecond) + CodedOutputByteBufferNano.m17220b(3, swipeRateLimitConfig.vip) + CodedOutputByteBufferNano.m17220b(4, swipeRateLimitConfig.svip) + CodedOutputByteBufferNano.m17220b(5, swipeRateLimitConfig.dimaond) + CodedOutputByteBufferNano.m17226h(6, swipeRateLimitConfig.anchorGrade) + CodedOutputByteBufferNano.m17226h(7, swipeRateLimitConfig.locaInterval);
            swipeRateLimitConfig.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SwipeRateLimitConfig parse(nb5 nb5Var) throws IOException {
            SwipeRateLimitConfig swipeRateLimitConfig = new SwipeRateLimitConfig();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    swipeRateLimitConfig.enable = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    swipeRateLimitConfig.countPerSecond = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    swipeRateLimitConfig.vip = nb5Var.m158738g();
                } else if (iM158752u == 32) {
                    swipeRateLimitConfig.svip = nb5Var.m158738g();
                } else if (iM158752u == 40) {
                    swipeRateLimitConfig.dimaond = nb5Var.m158738g();
                } else if (iM158752u == 48) {
                    swipeRateLimitConfig.anchorGrade = nb5Var.m158741j();
                } else {
                    if (iM158752u != 56) {
                        return swipeRateLimitConfig;
                    }
                    swipeRateLimitConfig.locaInterval = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(SwipeRateLimitConfig swipeRateLimitConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, swipeRateLimitConfig.enable);
            codedOutputByteBufferNano.m17250G(2, swipeRateLimitConfig.countPerSecond);
            codedOutputByteBufferNano.m17244A(3, swipeRateLimitConfig.vip);
            codedOutputByteBufferNano.m17244A(4, swipeRateLimitConfig.svip);
            codedOutputByteBufferNano.m17244A(5, swipeRateLimitConfig.dimaond);
            codedOutputByteBufferNano.m17250G(6, swipeRateLimitConfig.anchorGrade);
            codedOutputByteBufferNano.m17250G(7, swipeRateLimitConfig.locaInterval);
        }
    };
    ...
    public SwipeRateLimitConfig mo223809clone() {
        SwipeRateLimitConfig swipeRateLimitConfig = new SwipeRateLimitConfig();
