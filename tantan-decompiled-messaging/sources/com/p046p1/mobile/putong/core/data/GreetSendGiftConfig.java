...
public class GreetSendGiftConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GreetSendGiftConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<GreetSendGiftConfig>() { // from class: com.p1.mobile.putong.core.data.GreetSendGiftConfig.1
        ...
        public int computeAndCacheSize(GreetSendGiftConfig greetSendGiftConfig) {
            ...
            greetSendGiftConfig.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GreetSendGiftConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        greetSendGiftConfig.maleTitle = nb5Var.m158750s();
                        continue;
                    case 18:
                        greetSendGiftConfig.femaleTitle = nb5Var.m158750s();
                        continue;
                    case 26:
                        greetSendGiftConfig.maleSubTitle = nb5Var.m158750s();
                        continue;
                    case 34:
                        greetSendGiftConfig.femaleSubTitle = nb5Var.m158750s();
                        continue;
                    case 42:
                        greetSendGiftConfig.maleSendTipsByMoment = nb5Var.m158750s();
                        continue;
                    case 50:
                        greetSendGiftConfig.femaleSendTipsByMoment = nb5Var.m158750s();
                        continue;
                    case 58:
                        greetSendGiftConfig.maleSendTips = nb5Var.m158750s();
                        continue;
                    case 66:
                        greetSendGiftConfig.maleRefusedGiftTips = nb5Var.m158750s();
                        continue;
                    case 74:
                        greetSendGiftConfig.femaleSendTips = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        greetSendGiftConfig.femaleRefusedGiftTips = nb5Var.m158750s();
                        continue;
                    default:
                        if (greetSendGiftConfig.maleTitle == null) {
                            greetSendGiftConfig.maleTitle = "";
    ...
    public GreetSendGiftConfig mo223809clone() {
        GreetSendGiftConfig greetSendGiftConfig = new GreetSendGiftConfig();
