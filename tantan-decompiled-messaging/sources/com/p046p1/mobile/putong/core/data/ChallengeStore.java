...
public class ChallengeStore extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChallengeStore> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChallengeStore>() { // from class: com.p1.mobile.putong.core.data.ChallengeStore.1
        ...
        public int computeAndCacheSize(ChallengeStore challengeStore) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, challengeStore.switchStatus) + CodedOutputByteBufferNano.m17228j(2, challengeStore.lastInsertTime);
            challengeStore.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChallengeStore parse(nb5 nb5Var) throws IOException {
            ChallengeStore challengeStore = new ChallengeStore();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    challengeStore.switchStatus = nb5Var.m158738g();
                } else {
                    if (iM158752u != 16) {
                        return challengeStore;
                    }
                    challengeStore.lastInsertTime = nb5Var.m158742k();
                }
            }
        }
        ...
        public void serialize(ChallengeStore challengeStore, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, challengeStore.switchStatus);
            codedOutputByteBufferNano.m17252I(2, challengeStore.lastInsertTime);
        }
    };
    ...
    public ChallengeStore mo223809clone() {
        ChallengeStore challengeStore = new ChallengeStore();
