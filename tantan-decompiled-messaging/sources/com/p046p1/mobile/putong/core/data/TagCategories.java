...
public class TagCategories extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TagCategories> PROTOBUF_ADAPTER = new MessageNanoAdapter<TagCategories>() { // from class: com.p1.mobile.putong.core.data.TagCategories.1
        ...
        public int computeAndCacheSize(TagCategories tagCategories) {
            ...
            tagCategories.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TagCategories parse(nb5 nb5Var) throws IOException {
            TagCategories tagCategories = new TagCategories();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (tagCategories.f20514id == null) {
                        tagCategories.f20514id = "";
                    }
                ...
                if (iM158752u == 10) {
                    tagCategories.f20514id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    tagCategories.name = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    tagCategories.iconSelected = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    tagCategories.icon = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    tagCategories.iconWhite = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    tagCategories.categoryBackground = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    tagCategories.categoryIcon = nb5Var.m158750s();
                } else {
                    if (iM158752u != 66) {
                        if (tagCategories.f20514id == null) {
                            tagCategories.f20514id = "";
                    ...
                    tagCategories.categoryTextColor = nb5Var.m158750s();
                }
            }
            return tagCategories;
        }
        ...
        public boolean parseField(TagCategories tagCategories, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "categoryTextColor":
                    ...
                    return true;
                case "id":
                    tagCategories.f20514id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public TagCategories mo223809clone() {
        TagCategories tagCategories = new TagCategories();
        tagCategories.f20514id = this.f20514id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20514id, tagCategories.f20514id) && ValueObject.util_equals(this.name, tagCategories.name) && ValueObject.util_equals(this.iconSelected, tagCategories.iconSelected) && ValueObject.util_equals(this.icon, tagCategories.icon) && ValueObject.util_equals(this.iconWhite, tagCategories.iconWhite) && ValueObject.util_equals(this.categoryBackground, tagCategories.categoryBackground) && ValueObject.util_equals(this.categoryIcon, tagCategories.categoryIcon) && ValueObject.util_equals(this.categoryTextColor, tagCategories.categoryTextColor);
    }
