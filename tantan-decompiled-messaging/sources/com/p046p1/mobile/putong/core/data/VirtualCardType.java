...
public enum VirtualCardType {
    ...
    OnlineMatchBroadcastPeiLiaoCard("OnlineMatchBroadcastPeiLiaoCard"),
    ...
    SayHiADCard("SayHiADCard"),
    ExpandedNewUserRightGuide("ExpandedNewUserRightGuide"),
    BarLoverGuideCard("BarLoverGuideCard"),
    IceBreakQuestionOfflineCard("IceBreakQuestionOfflineCard"),
    FemaleVipGuideCard("FemaleVipGuideCard"),
    FemaleVerificationGuideCard("FemaleVerificationGuideCard"),
    NewUserSeeMyself("NewUserSeeMyself"),
    QuestionOfNotVerify("QuestionOfNotVerify");


    /* JADX INFO: renamed from: id */
    private String f20530id;

    VirtualCardType(String str) {
        this.f20530id = str;
    }
