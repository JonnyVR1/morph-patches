...
public class LetterMultilingual extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LetterMultilingual> PROTOBUF_ADAPTER = new MessageNanoAdapter<LetterMultilingual>() { // from class: com.p1.mobile.putong.core.data.LetterMultilingual.1
        ...
        public int computeAndCacheSize(LetterMultilingual letterMultilingual) {
            ...
            int iM17230l = letterLibrary != null ? CodedOutputByteBufferNano.m17230l(1, letterLibrary, LetterLibrary.PROTOBUF_ADAPTER) : 0;
            LetterLibrary letterLibrary2 = letterMultilingual.zhTW;
            if (letterLibrary2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, letterLibrary2, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary3 = letterMultilingual.enUS;
            if (letterLibrary3 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, letterLibrary3, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary4 = letterMultilingual.jaJP;
            if (letterLibrary4 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, letterLibrary4, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary5 = letterMultilingual.koKR;
            if (letterLibrary5 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, letterLibrary5, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary6 = letterMultilingual.idID;
            if (letterLibrary6 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(6, letterLibrary6, LetterLibrary.PROTOBUF_ADAPTER);
            }
            letterMultilingual.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LetterMultilingual parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    letterMultilingual.zhCN = (LetterLibrary) nb5Var.m158743l(LetterLibrary.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    letterMultilingual.zhTW = (LetterLibrary) nb5Var.m158743l(LetterLibrary.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    letterMultilingual.enUS = (LetterLibrary) nb5Var.m158743l(LetterLibrary.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    letterMultilingual.jaJP = (LetterLibrary) nb5Var.m158743l(LetterLibrary.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    letterMultilingual.koKR = (LetterLibrary) nb5Var.m158743l(LetterLibrary.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 50) {
                        if (letterMultilingual.zhCN == null) {
                            letterMultilingual.zhCN = LetterLibrary.new_();
                    ...
                    letterMultilingual.idID = (LetterLibrary) nb5Var.m158743l(LetterLibrary.PROTOBUF_ADAPTER);
                }
            }
            return letterMultilingual;
        }
        ...
        public void serialize(LetterMultilingual letterMultilingual, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (letterLibrary != null) {
                codedOutputByteBufferNano.m17254K(1, letterLibrary, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary2 = letterMultilingual.zhTW;
            if (letterLibrary2 != null) {
                codedOutputByteBufferNano.m17254K(2, letterLibrary2, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary3 = letterMultilingual.enUS;
            if (letterLibrary3 != null) {
                codedOutputByteBufferNano.m17254K(3, letterLibrary3, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary4 = letterMultilingual.jaJP;
            if (letterLibrary4 != null) {
                codedOutputByteBufferNano.m17254K(4, letterLibrary4, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary5 = letterMultilingual.koKR;
            if (letterLibrary5 != null) {
                codedOutputByteBufferNano.m17254K(5, letterLibrary5, LetterLibrary.PROTOBUF_ADAPTER);
            }
            LetterLibrary letterLibrary6 = letterMultilingual.idID;
            if (letterLibrary6 != null) {
                codedOutputByteBufferNano.m17254K(6, letterLibrary6, LetterLibrary.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LetterMultilingual mo223809clone() {
        LetterMultilingual letterMultilingual = new LetterMultilingual();
        LetterLibrary letterLibrary = this.zhCN;
        if (letterLibrary != null) {
            letterMultilingual.zhCN = letterLibrary.mo223809clone();
        }
        LetterLibrary letterLibrary2 = this.zhTW;
        if (letterLibrary2 != null) {
            letterMultilingual.zhTW = letterLibrary2.mo223809clone();
        }
        LetterLibrary letterLibrary3 = this.enUS;
        if (letterLibrary3 != null) {
            letterMultilingual.enUS = letterLibrary3.mo223809clone();
        }
        LetterLibrary letterLibrary4 = this.jaJP;
        if (letterLibrary4 != null) {
            letterMultilingual.jaJP = letterLibrary4.mo223809clone();
        }
        LetterLibrary letterLibrary5 = this.koKR;
        if (letterLibrary5 != null) {
            letterMultilingual.koKR = letterLibrary5.mo223809clone();
        }
        LetterLibrary letterLibrary6 = this.idID;
        if (letterLibrary6 != null) {
            letterMultilingual.idID = letterLibrary6.mo223809clone();
        }
        return letterMultilingual;
    }
