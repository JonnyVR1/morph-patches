...
public class MessageExtData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageExtData> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageExtData>() { // from class: com.p1.mobile.putong.core.data.MessageExtData.1
        ...
        public int computeAndCacheSize(MessageExtData messageExtData) {
            ...
            if (messageTips != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, messageTips, MessageTips.PROTOBUF_ADAPTER);
            }
            MessageSource messageSource = messageExtData.source;
            if (messageSource != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, messageSource, MessageSource.PROTOBUF_ADAPTER);
            }
            ChatTips chatTips = messageExtData.chatTips;
            if (chatTips != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, chatTips, ChatTips.PROTOBUF_ADAPTER);
            }
            ...
            messageExtData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageExtData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    messageExtData.extra = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    messageExtData.greetingTips = (MessageTips) nb5Var.m158743l(MessageTips.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    messageExtData.source = (MessageSource) nb5Var.m158743l(MessageSource.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    messageExtData.chatTips = (ChatTips) nb5Var.m158743l(ChatTips.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    messageExtData.extra2 = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    messageExtData.msgSource = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (messageExtData.extra == null) {
                            messageExtData.extra = "";
                    ...
                    messageExtData.recallText = nb5Var.m158750s();
                }
            }
            return messageExtData;
        }
        ...
        public void serialize(MessageExtData messageExtData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            MessageTips messageTips = messageExtData.greetingTips;
            if (messageTips != null) {
                codedOutputByteBufferNano.m17254K(2, messageTips, MessageTips.PROTOBUF_ADAPTER);
            }
            MessageSource messageSource = messageExtData.source;
            if (messageSource != null) {
                codedOutputByteBufferNano.m17254K(3, messageSource, MessageSource.PROTOBUF_ADAPTER);
            }
            ChatTips chatTips = messageExtData.chatTips;
            if (chatTips != null) {
                codedOutputByteBufferNano.m17254K(4, chatTips, ChatTips.PROTOBUF_ADAPTER);
            }
            String str2 = messageExtData.extra2;
            if (str2 != null) {
    ...
    public MessageExtData mo223809clone() {
        MessageExtData messageExtData = new MessageExtData();
        messageExtData.extra = this.extra;
        MessageTips messageTips = this.greetingTips;
        if (messageTips != null) {
            messageExtData.greetingTips = messageTips.mo223809clone();
        }
        MessageSource messageSource = this.source;
        if (messageSource != null) {
            messageExtData.source = messageSource.mo223809clone();
        }
        ChatTips chatTips = this.chatTips;
        if (chatTips != null) {
            messageExtData.chatTips = chatTips.mo223809clone();
        }
