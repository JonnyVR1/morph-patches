...
public class StickerPackage extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StickerPackage> PROTOBUF_ADAPTER = new MessageNanoAdapter<StickerPackage>() { // from class: com.p1.mobile.putong.core.data.StickerPackage.1
        ...
        public int computeAndCacheSize(StickerPackage stickerPackage) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, stickerPackage.activated);
            List<Picture> list = stickerPackage.pictures;
            if (list != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(2, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = stickerPackage.f20506id;
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(3, str);
            }
            List<String> list2 = stickerPackage.stickers;
            if (list2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(4, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            stickerPackage.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StickerPackage parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    ...
                    if (stickerPackage.f20506id == null) {
                        stickerPackage.f20506id = "";
                    }
                ...
                if (iM158752u == 8) {
                    stickerPackage.activated = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    stickerPackage.pictures = (List) nb5Var.m158743l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 26) {
                    stickerPackage.f20506id = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (stickerPackage.pictures == null) {
                            stickerPackage.pictures = new ArrayList();
                    ...
                    stickerPackage.stickers = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return stickerPackage;
        }
        ...
        public void serialize(StickerPackage stickerPackage, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, stickerPackage.activated);
            List<Picture> list = stickerPackage.pictures;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(2, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = stickerPackage.f20506id;
            if (str != null) {
        ...
        public boolean parseField(StickerPackage stickerPackage, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "pictures":
                    ...
                    return true;
                case "id":
                    stickerPackage.f20506id = jsonParser.getValueAsString();
                    return false;
                case "activated":
    ...
    public static /* synthetic */ String m35862a(String str) {
        return str;
    }
    ...
    public StickerPackage mo223809clone() {
        StickerPackage stickerPackage = new StickerPackage();
    ...
    public boolean equals(Object obj) {
        ...
        return this.activated == stickerPackage.activated && ValueObject.util_equals(this.pictures, stickerPackage.pictures) && ValueObject.util_equals(this.f20506id, stickerPackage.f20506id) && ValueObject.util_equals(this.stickers, stickerPackage.stickers);
    }
