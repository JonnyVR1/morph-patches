...
public class ChatHelperConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatHelperConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatHelperConfig>() { // from class: com.p1.mobile.putong.core.data.ChatHelperConfig.1
        ...
        public int computeAndCacheSize(ChatHelperConfig chatHelperConfig) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, chatHelperConfig.female_chat_assistant_enable) + CodedOutputByteBufferNano.m17226h(2, chatHelperConfig.female_chat_assistant_profile_dlg_close_max);
            chatHelperConfig.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatHelperConfig parse(nb5 nb5Var) throws IOException {
            ChatHelperConfig chatHelperConfig = new ChatHelperConfig();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    chatHelperConfig.female_chat_assistant_enable = nb5Var.m158738g();
                } else {
                    if (iM158752u != 16) {
                        return chatHelperConfig;
                    }
                    chatHelperConfig.female_chat_assistant_profile_dlg_close_max = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(ChatHelperConfig chatHelperConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, chatHelperConfig.female_chat_assistant_enable);
            codedOutputByteBufferNano.m17250G(2, chatHelperConfig.female_chat_assistant_profile_dlg_close_max);
        }
    };
    ...
    public ChatHelperConfig mo223809clone() {
        ChatHelperConfig chatHelperConfig = new ChatHelperConfig();
