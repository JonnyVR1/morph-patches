...
import com.p046p1.mobile.putong.core.data.AvatarsDetail;
...
public class AvatarLikes extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AvatarLikes> PROTOBUF_ADAPTER = new MessageNanoAdapter<AvatarLikes>() { // from class: com.p1.mobile.putong.core.data.AvatarLikes.1
        ...
        public int computeAndCacheSize(AvatarLikes avatarLikes) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17222d(2, avatarLikes.createdTime);
            List<AvatarsDetail> list = avatarLikes.avatars;
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, list, AvatarsDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = avatarLikes.fakeOtherState;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(4, str2);
            }
            avatarLikes.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AvatarLikes parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    avatarLikes.userId = nb5Var.m158750s();
                } else if (iM158752u == 17) {
                    avatarLikes.createdTime = nb5Var.m158739h();
                } else if (iM158752u == 26) {
                    avatarLikes.avatars = (List) nb5Var.m158743l(AvatarsDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 34) {
                        if (avatarLikes.userId == null) {
                            avatarLikes.userId = "";
                    ...
                    avatarLikes.fakeOtherState = nb5Var.m158750s();
                }
            }
            return avatarLikes;
        }
        ...
        public void serialize(AvatarLikes avatarLikes, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(2, avatarLikes.createdTime);
            List<AvatarsDetail> list = avatarLikes.avatars;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, AvatarsDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = avatarLikes.fakeOtherState;
            if (str2 != null) {
    ...
    public AvatarLikes mo223809clone() {
        AvatarLikes avatarLikes = new AvatarLikes();
        ...
        if (list != null) {
            avatarLikes.avatars = ValueObject.util_map(list, new w9j() { // from class: l.gm1
                ...
                public final Object call(Object obj) {
                    return ((AvatarsDetail) obj).mo223809clone();
                }
            });
        }
