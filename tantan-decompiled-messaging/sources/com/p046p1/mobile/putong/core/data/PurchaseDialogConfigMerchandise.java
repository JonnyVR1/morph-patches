...
public class PurchaseDialogConfigMerchandise extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PurchaseDialogConfigMerchandise> PROTOBUF_ADAPTER = new MessageNanoAdapter<PurchaseDialogConfigMerchandise>() { // from class: com.p1.mobile.putong.core.data.PurchaseDialogConfigMerchandise.1
        ...
        public int computeAndCacheSize(PurchaseDialogConfigMerchandise purchaseDialogConfigMerchandise) {
            ...
            int iM17226h = productCategory != null ? CodedOutputByteBufferNano.m17226h(1, productCategory.ordinal()) : 0;
            ...
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(3, purchaseDialogConfigMerchandise.defaultQuantity);
            ProductCategory productCategory2 = purchaseDialogConfigMerchandise.category;
            if (productCategory2 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(4, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            List<String> list2 = purchaseDialogConfigMerchandise.orderUnit;
            if (list2 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(5, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str = purchaseDialogConfigMerchandise.defaultUnit;
            if (str != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(6, str);
            }
            purchaseDialogConfigMerchandise.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PurchaseDialogConfigMerchandise parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    ...
                    purchaseDialogConfigMerchandise.order = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 24) {
                    purchaseDialogConfigMerchandise.defaultQuantity = nb5Var.m158741j();
                } else if (iM158752u == 34) {
                    purchaseDialogConfigMerchandise.category = (ProductCategory) nb5Var.m158743l(ProductCategory.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    purchaseDialogConfigMerchandise.orderUnit = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 50) {
                        if (purchaseDialogConfigMerchandise.category == null && numValueOf != null) {
                            purchaseDialogConfigMerchandise.category = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    purchaseDialogConfigMerchandise.defaultUnit = nb5Var.m158750s();
                }
            }
            return purchaseDialogConfigMerchandise;
        }
        ...
        public void serialize(PurchaseDialogConfigMerchandise purchaseDialogConfigMerchandise, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (productCategory != null) {
                codedOutputByteBufferNano.m17250G(1, productCategory.ordinal());
            }
            List<String> list = purchaseDialogConfigMerchandise.order;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(2, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(3, purchaseDialogConfigMerchandise.defaultQuantity);
            ProductCategory productCategory2 = purchaseDialogConfigMerchandise.category;
            if (productCategory2 != null) {
                codedOutputByteBufferNano.m17254K(4, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            List<String> list2 = purchaseDialogConfigMerchandise.orderUnit;
            if (list2 != null) {
    ...
    public static /* synthetic */ String m35777a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m35778b(String str) {
        return str;
    }
    ...
    public PurchaseDialogConfigMerchandise mo223809clone() {
        PurchaseDialogConfigMerchandise purchaseDialogConfigMerchandise = new PurchaseDialogConfigMerchandise();
        ...
        if (list != null) {
            purchaseDialogConfigMerchandise.order = ValueObject.util_map(list, new w9j() { // from class: l.q2b0
                ...
                public final Object call(Object obj) {
                    return PurchaseDialogConfigMerchandise.m35777a((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            purchaseDialogConfigMerchandise.orderUnit = ValueObject.util_map(list2, new w9j() { // from class: l.r2b0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return PurchaseDialogConfigMerchandise.m35778b((String) obj);
                }
            });
        }
