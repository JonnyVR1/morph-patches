...
public class BreakIce extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BreakIce> PROTOBUF_ADAPTER = new MessageNanoAdapter<BreakIce>() { // from class: com.p1.mobile.putong.core.data.BreakIce.1
        ...
        public int computeAndCacheSize(BreakIce breakIce) {
            ...
            breakIce.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BreakIce parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    breakIce.content = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    breakIce.tipId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    breakIce.kind = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (breakIce.content == null) {
                            breakIce.content = "";
                    ...
                    breakIce.response_uuid = nb5Var.m158750s();
                }
            }
            return breakIce;
        }
