...
public class QuestionsSecond extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuestionsSecond> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuestionsSecond>() { // from class: com.p1.mobile.putong.core.data.QuestionsSecond.1
        ...
        public int computeAndCacheSize(QuestionsSecond questionsSecond) {
            String str = questionsSecond.f20482id;
            ...
            if (contentSecond != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, contentSecond, ContentSecond.PROTOBUF_ADAPTER);
            }
            questionsSecond.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuestionsSecond parse(nb5 nb5Var) throws IOException {
            QuestionsSecond questionsSecond = new QuestionsSecond();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (questionsSecond.f20482id == null) {
                        questionsSecond.f20482id = "";
                    }
                ...
                if (iM158752u == 10) {
                    questionsSecond.f20482id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    questionsSecond.index = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    questionsSecond.type = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    questionsSecond.title = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (questionsSecond.f20482id == null) {
                            questionsSecond.f20482id = "";
                    ...
                    questionsSecond.content = (ContentSecond) nb5Var.m158743l(ContentSecond.PROTOBUF_ADAPTER);
                }
            }
            return questionsSecond;
        }
        ...
        public void serialize(QuestionsSecond questionsSecond, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ContentSecond contentSecond = questionsSecond.content;
            if (contentSecond != null) {
                codedOutputByteBufferNano.m17254K(5, contentSecond, ContentSecond.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<QuestionsSecond> JSON_ADAPTER = new ObjectJsonAdapter<QuestionsSecond>() { // from class: com.p1.mobile.putong.core.data.QuestionsSecond.2
        ...
        public boolean parseField(QuestionsSecond questionsSecond, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    questionsSecond.f20482id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public QuestionsSecond mo223809clone() {
        QuestionsSecond questionsSecond = new QuestionsSecond();
        questionsSecond.f20482id = this.f20482id;
        ...
        if (contentSecond != null) {
            questionsSecond.content = contentSecond.mo223809clone();
        }
        return questionsSecond;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20482id, questionsSecond.f20482id) && ValueObject.util_equals(this.index, questionsSecond.index) && ValueObject.util_equals(this.type, questionsSecond.type) && ValueObject.util_equals(this.title, questionsSecond.title) && ValueObject.util_equals(this.content, questionsSecond.content);
    }
