...
public class PrologueMessageAdditional extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PrologueMessageAdditional> PROTOBUF_ADAPTER = new MessageNanoAdapter<PrologueMessageAdditional>() { // from class: com.p1.mobile.putong.core.data.PrologueMessageAdditional.1
        ...
        public int computeAndCacheSize(PrologueMessageAdditional prologueMessageAdditional) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, prologueMessageAdditional.enableEdit);
            String str = prologueMessageAdditional.receiverTip;
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(3, prologueMessageAdditional.autoSend);
            String str2 = prologueMessageAdditional.category;
            if (str2 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(4, str2);
            }
            prologueMessageAdditional.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PrologueMessageAdditional parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    prologueMessageAdditional.enableEdit = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    prologueMessageAdditional.receiverTip = nb5Var.m158750s();
                } else if (iM158752u == 24) {
                    prologueMessageAdditional.autoSend = nb5Var.m158738g();
                } else {
                    if (iM158752u != 34) {
                        if (prologueMessageAdditional.receiverTip == null) {
                            prologueMessageAdditional.receiverTip = "";
                    ...
                    prologueMessageAdditional.category = nb5Var.m158750s();
                }
            }
            return prologueMessageAdditional;
        }
        ...
        public void serialize(PrologueMessageAdditional prologueMessageAdditional, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, prologueMessageAdditional.enableEdit);
            String str = prologueMessageAdditional.receiverTip;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17244A(3, prologueMessageAdditional.autoSend);
            String str2 = prologueMessageAdditional.category;
            if (str2 != null) {
    ...
    public PrologueMessageAdditional mo223809clone() {
        PrologueMessageAdditional prologueMessageAdditional = new PrologueMessageAdditional();
