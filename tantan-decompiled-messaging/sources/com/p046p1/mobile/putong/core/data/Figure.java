...
public class Figure extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Figure> PROTOBUF_ADAPTER = new MessageNanoAdapter<Figure>() { // from class: com.p1.mobile.putong.core.data.Figure.1
        ...
        public int computeAndCacheSize(Figure figure) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, figure.total);
            FigureMessage figureMessage = figure.message;
            if (figureMessage != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(2, figureMessage, FigureMessage.PROTOBUF_ADAPTER);
            }
            FigureMessageType figureMessageType = figure.type;
            if (figureMessageType != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(3, figureMessageType.ordinal());
            }
            ...
            if (figureMessageType2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(6, figureMessageType2, FigureMessageType.PROTOBUF_ADAPTER);
            }
            figure.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Figure parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    figure.total = nb5Var.m158741j();
                } else if (iM158752u == 18) {
                    figure.message = (FigureMessage) nb5Var.m158743l(FigureMessage.PROTOBUF_ADAPTER);
                } else if (iM158752u == 24) {
                    numValueOf = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 34) {
                    figure.value = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    figure.name = nb5Var.m158750s();
                } else {
                    if (iM158752u != 50) {
                        if (figure.type == null && numValueOf != null) {
                            figure.type = (FigureMessageType) FigureMessageType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    figure.type = (FigureMessageType) nb5Var.m158743l(FigureMessageType.PROTOBUF_ADAPTER);
                }
            }
            return figure;
        }
        ...
        public void serialize(Figure figure, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, figure.total);
            FigureMessage figureMessage = figure.message;
            if (figureMessage != null) {
                codedOutputByteBufferNano.m17254K(2, figureMessage, FigureMessage.PROTOBUF_ADAPTER);
            }
            FigureMessageType figureMessageType = figure.type;
            if (figureMessageType != null) {
                codedOutputByteBufferNano.m17250G(3, figureMessageType.ordinal());
            }
            String str = figure.value;
            if (str != null) {
            ...
            FigureMessageType figureMessageType2 = figure.type;
            if (figureMessageType2 != null) {
                codedOutputByteBufferNano.m17254K(6, figureMessageType2, FigureMessageType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Figure mo223809clone() {
        Figure figure = new Figure();
        figure.total = this.total;
        FigureMessage figureMessage = this.message;
        if (figureMessage != null) {
            figure.message = figureMessage.mo223809clone();
        }
