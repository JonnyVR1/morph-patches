...
public class ConvAdditionalMatchInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConvAdditionalMatchInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConvAdditionalMatchInfo>() { // from class: com.p1.mobile.putong.core.data.ConvAdditionalMatchInfo.1
        ...
        public int computeAndCacheSize(ConvAdditionalMatchInfo convAdditionalMatchInfo) {
            int iM17222d = CodedOutputByteBufferNano.m17222d(1, convAdditionalMatchInfo.likeTime) + CodedOutputByteBufferNano.m17222d(2, convAdditionalMatchInfo.likedByTime);
            ...
            int iM17222d2 = iM17222d + CodedOutputByteBufferNano.m17222d(6, convAdditionalMatchInfo.matchTime);
            String str4 = convAdditionalMatchInfo.sourceUserID;
            if (str4 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(7, str4);
            }
            int iM17222d3 = iM17222d2 + CodedOutputByteBufferNano.m17222d(8, convAdditionalMatchInfo.verifyInviteTime);
            String str5 = convAdditionalMatchInfo.verifyInviteOwner;
            if (str5 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17233o(9, str5);
            }
            String str6 = convAdditionalMatchInfo.sourceEn;
            if (str6 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17233o(10, str6);
            }
            convAdditionalMatchInfo.cachedSize = iM17222d3;
            return iM17222d3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConvAdditionalMatchInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 9:
                        convAdditionalMatchInfo.likeTime = nb5Var.m158739h();
                        continue;
                    case 17:
                        convAdditionalMatchInfo.likedByTime = nb5Var.m158739h();
                        continue;
                    case 26:
                        convAdditionalMatchInfo.source = nb5Var.m158750s();
                        continue;
                    case 34:
                        convAdditionalMatchInfo.state = nb5Var.m158750s();
                        continue;
                    case 42:
                        convAdditionalMatchInfo.otherState = nb5Var.m158750s();
                        continue;
                    case 49:
                        convAdditionalMatchInfo.matchTime = nb5Var.m158739h();
                        continue;
                    case 58:
                        convAdditionalMatchInfo.sourceUserID = nb5Var.m158750s();
                        continue;
                    case 65:
                        convAdditionalMatchInfo.verifyInviteTime = nb5Var.m158739h();
                        continue;
                    case 74:
                        convAdditionalMatchInfo.verifyInviteOwner = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        convAdditionalMatchInfo.sourceEn = nb5Var.m158750s();
                        continue;
                    default:
                        if (convAdditionalMatchInfo.source == null) {
                            convAdditionalMatchInfo.source = "";
        ...
        public void serialize(ConvAdditionalMatchInfo convAdditionalMatchInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17246C(1, convAdditionalMatchInfo.likeTime);
            codedOutputByteBufferNano.m17246C(2, convAdditionalMatchInfo.likedByTime);
            String str = convAdditionalMatchInfo.source;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17246C(6, convAdditionalMatchInfo.matchTime);
            String str4 = convAdditionalMatchInfo.sourceUserID;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(7, str4);
            }
            codedOutputByteBufferNano.m17246C(8, convAdditionalMatchInfo.verifyInviteTime);
            String str5 = convAdditionalMatchInfo.verifyInviteOwner;
            if (str5 != null) {
    ...
    public ConvAdditionalMatchInfo mo223809clone() {
        ConvAdditionalMatchInfo convAdditionalMatchInfo = new ConvAdditionalMatchInfo();
