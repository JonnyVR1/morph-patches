...
public class MyMeetEntryV3 extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MyMeetEntryV3> PROTOBUF_ADAPTER = new MessageNanoAdapter<MyMeetEntryV3>() { // from class: com.p1.mobile.putong.core.data.MyMeetEntryV3.1
        ...
        public int computeAndCacheSize(MyMeetEntryV3 myMeetEntryV3) {
            ...
            int iM17230l = myMeetEntryConversation != null ? CodedOutputByteBufferNano.m17230l(1, myMeetEntryConversation, MyMeetEntryConversation.PROTOBUF_ADAPTER) : 0;
            MyMeetEntryFeed myMeetEntryFeed = myMeetEntryV3.feed;
            if (myMeetEntryFeed != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, myMeetEntryFeed, MyMeetEntryFeed.PROTOBUF_ADAPTER);
            }
            MyMeetSeeReminder myMeetSeeReminder = myMeetEntryV3.seeReminder;
            if (myMeetSeeReminder != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, myMeetSeeReminder, MyMeetSeeReminder.PROTOBUF_ADAPTER);
            }
            ODiamondFeed oDiamondFeed = myMeetEntryV3.oDiamondFeed;
            if (oDiamondFeed != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, oDiamondFeed, ODiamondFeed.PROTOBUF_ADAPTER);
            }
            MyMeetEntryNearby myMeetEntryNearby = myMeetEntryV3.nearby;
            if (myMeetEntryNearby != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, myMeetEntryNearby, MyMeetEntryNearby.PROTOBUF_ADAPTER);
            }
            myMeetEntryV3.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MyMeetEntryV3 parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    myMeetEntryV3.conversation = (MyMeetEntryConversation) nb5Var.m158743l(MyMeetEntryConversation.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    myMeetEntryV3.feed = (MyMeetEntryFeed) nb5Var.m158743l(MyMeetEntryFeed.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    myMeetEntryV3.seeReminder = (MyMeetSeeReminder) nb5Var.m158743l(MyMeetSeeReminder.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    myMeetEntryV3.oDiamondFeed = (ODiamondFeed) nb5Var.m158743l(ODiamondFeed.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 42) {
                        if (myMeetEntryV3.conversation == null) {
                            myMeetEntryV3.conversation = MyMeetEntryConversation.new_();
                    ...
                    myMeetEntryV3.nearby = (MyMeetEntryNearby) nb5Var.m158743l(MyMeetEntryNearby.PROTOBUF_ADAPTER);
                }
            }
            return myMeetEntryV3;
        }
        ...
        public void serialize(MyMeetEntryV3 myMeetEntryV3, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (myMeetEntryConversation != null) {
                codedOutputByteBufferNano.m17254K(1, myMeetEntryConversation, MyMeetEntryConversation.PROTOBUF_ADAPTER);
            }
            MyMeetEntryFeed myMeetEntryFeed = myMeetEntryV3.feed;
            if (myMeetEntryFeed != null) {
                codedOutputByteBufferNano.m17254K(2, myMeetEntryFeed, MyMeetEntryFeed.PROTOBUF_ADAPTER);
            }
            MyMeetSeeReminder myMeetSeeReminder = myMeetEntryV3.seeReminder;
            if (myMeetSeeReminder != null) {
                codedOutputByteBufferNano.m17254K(3, myMeetSeeReminder, MyMeetSeeReminder.PROTOBUF_ADAPTER);
            }
            ODiamondFeed oDiamondFeed = myMeetEntryV3.oDiamondFeed;
            if (oDiamondFeed != null) {
                codedOutputByteBufferNano.m17254K(4, oDiamondFeed, ODiamondFeed.PROTOBUF_ADAPTER);
            }
            MyMeetEntryNearby myMeetEntryNearby = myMeetEntryV3.nearby;
            if (myMeetEntryNearby != null) {
                codedOutputByteBufferNano.m17254K(5, myMeetEntryNearby, MyMeetEntryNearby.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public MyMeetEntryV3 mo223809clone() {
        MyMeetEntryV3 myMeetEntryV3 = new MyMeetEntryV3();
        MyMeetEntryConversation myMeetEntryConversation = this.conversation;
        if (myMeetEntryConversation != null) {
            myMeetEntryV3.conversation = myMeetEntryConversation.mo223809clone();
        }
        MyMeetEntryFeed myMeetEntryFeed = this.feed;
        if (myMeetEntryFeed != null) {
            myMeetEntryV3.feed = myMeetEntryFeed.mo223809clone();
        }
        MyMeetSeeReminder myMeetSeeReminder = this.seeReminder;
        if (myMeetSeeReminder != null) {
            myMeetEntryV3.seeReminder = myMeetSeeReminder.mo223809clone();
        }
        ODiamondFeed oDiamondFeed = this.oDiamondFeed;
        if (oDiamondFeed != null) {
            myMeetEntryV3.oDiamondFeed = oDiamondFeed.mo223809clone();
        }
        MyMeetEntryNearby myMeetEntryNearby = this.nearby;
        if (myMeetEntryNearby != null) {
            myMeetEntryV3.nearby = myMeetEntryNearby.mo223809clone();
        }
        return myMeetEntryV3;
    }
