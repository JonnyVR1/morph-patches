...
public class QuickChatCardInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuickChatCardInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuickChatCardInfo>() { // from class: com.p1.mobile.putong.core.data.QuickChatCardInfo.1
        ...
        public int computeAndCacheSize(QuickChatCardInfo quickChatCardInfo) {
            ...
            if (quickChatType != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, quickChatType, QuickChatType.PROTOBUF_ADAPTER);
            }
            ...
            quickChatCardInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuickChatCardInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    quickChatCardInfo.userID = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    quickChatCardInfo.secretKey = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    quickChatCardInfo.rsState = (RelationshipStatus) nb5Var.m158743l(RelationshipStatus.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    quickChatCardInfo.biz = (QuickChatType) nb5Var.m158743l(QuickChatType.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    quickChatCardInfo.stage = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    quickChatCardInfo.fitReason = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    quickChatCardInfo.friendPurpose = nb5Var.m158750s();
                } else {
                    if (iM158752u != 66) {
                        if (quickChatCardInfo.userID == null) {
                            quickChatCardInfo.userID = "";
                    ...
                    quickChatCardInfo.zodiacFitPercent = nb5Var.m158750s();
                }
            }
            return quickChatCardInfo;
        }
        ...
        public void serialize(QuickChatCardInfo quickChatCardInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            QuickChatType quickChatType = quickChatCardInfo.biz;
            if (quickChatType != null) {
                codedOutputByteBufferNano.m17254K(4, quickChatType, QuickChatType.PROTOBUF_ADAPTER);
            }
            String str3 = quickChatCardInfo.stage;
            if (str3 != null) {
    ...
    public QuickChatCardInfo mo223809clone() {
        QuickChatCardInfo quickChatCardInfo = new QuickChatCardInfo();
