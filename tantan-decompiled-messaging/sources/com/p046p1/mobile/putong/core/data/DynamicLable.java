...
public class DynamicLable extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DynamicLable> PROTOBUF_ADAPTER = new MessageNanoAdapter<DynamicLable>() { // from class: com.p1.mobile.putong.core.data.DynamicLable.1
        ...
        public int computeAndCacheSize(DynamicLable dynamicLable) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(4, dynamicLable.textBold);
            ...
            if (labelBackground != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(6, labelBackground, LabelBackground.PROTOBUF_ADAPTER);
            }
            LabelIconStyle labelIconStyle = dynamicLable.iconStyle;
            if (labelIconStyle != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(7, labelIconStyle, LabelIconStyle.PROTOBUF_ADAPTER);
            }
            LabelStatistics labelStatistics = dynamicLable.statistics;
            if (labelStatistics != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(8, labelStatistics, LabelStatistics.PROTOBUF_ADAPTER);
            }
            LabelshowTips labelshowTips = dynamicLable.showTips;
            if (labelshowTips != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(9, labelshowTips, LabelshowTips.PROTOBUF_ADAPTER);
            }
            dynamicLable.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DynamicLable parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    dynamicLable.label = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    dynamicLable.type = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    dynamicLable.textColor = nb5Var.m158750s();
                } else if (iM158752u == 32) {
                    dynamicLable.textBold = nb5Var.m158738g();
                } else if (iM158752u == 42) {
                    dynamicLable.deeplink = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    dynamicLable.background = (LabelBackground) nb5Var.m158743l(LabelBackground.PROTOBUF_ADAPTER);
                } else if (iM158752u == 58) {
                    dynamicLable.iconStyle = (LabelIconStyle) nb5Var.m158743l(LabelIconStyle.PROTOBUF_ADAPTER);
                } else if (iM158752u == 66) {
                    dynamicLable.statistics = (LabelStatistics) nb5Var.m158743l(LabelStatistics.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 74) {
                        if (dynamicLable.label == null) {
                            dynamicLable.label = "";
                    ...
                    dynamicLable.showTips = (LabelshowTips) nb5Var.m158743l(LabelshowTips.PROTOBUF_ADAPTER);
                }
            }
            return dynamicLable;
        }
        ...
        public void serialize(DynamicLable dynamicLable, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(4, dynamicLable.textBold);
            String str4 = dynamicLable.deeplink;
            if (str4 != null) {
            ...
            LabelBackground labelBackground = dynamicLable.background;
            if (labelBackground != null) {
                codedOutputByteBufferNano.m17254K(6, labelBackground, LabelBackground.PROTOBUF_ADAPTER);
            }
            LabelIconStyle labelIconStyle = dynamicLable.iconStyle;
            if (labelIconStyle != null) {
                codedOutputByteBufferNano.m17254K(7, labelIconStyle, LabelIconStyle.PROTOBUF_ADAPTER);
            }
            LabelStatistics labelStatistics = dynamicLable.statistics;
            if (labelStatistics != null) {
                codedOutputByteBufferNano.m17254K(8, labelStatistics, LabelStatistics.PROTOBUF_ADAPTER);
            }
            LabelshowTips labelshowTips = dynamicLable.showTips;
            if (labelshowTips != null) {
                codedOutputByteBufferNano.m17254K(9, labelshowTips, LabelshowTips.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<DynamicLable> JSON_ADAPTER = new ObjectJsonAdapter<DynamicLable>() { // from class: com.p1.mobile.putong.core.data.DynamicLable.2
        ...
        public DynamicLable newInstance() {
        ...
        public boolean parseField(DynamicLable dynamicLable, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "iconStyle":
                    dynamicLable.iconStyle = LabelIconStyle.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "background":
                    dynamicLable.background = LabelBackground.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "textColor":
                ...
                case "textBold":
                    ...
                    return true;
                case "showTips":
                    dynamicLable.showTips = LabelshowTips.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "statistics":
                    dynamicLable.statistics = LabelStatistics.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "type":
        ...
        public void serializeFields(DynamicLable dynamicLable, JsonGenerator jsonGenerator) throws IOException {
            String str = dynamicLable.label;
            if (str != null) {
                jsonGenerator.writeStringField(Constants.ScionAnalytics.PARAM_LABEL, str);
            }
            String str2 = dynamicLable.type;
            if (str2 != null) {
    ...
    public DynamicLable mo223809clone() {
        DynamicLable dynamicLable = new DynamicLable();
        ...
        if (labelBackground != null) {
            dynamicLable.background = labelBackground.mo223809clone();
        }
        LabelIconStyle labelIconStyle = this.iconStyle;
        if (labelIconStyle != null) {
            dynamicLable.iconStyle = labelIconStyle.mo223809clone();
        }
        LabelStatistics labelStatistics = this.statistics;
        if (labelStatistics != null) {
            dynamicLable.statistics = labelStatistics.mo223809clone();
        }
        LabelshowTips labelshowTips = this.showTips;
        if (labelshowTips != null) {
            dynamicLable.showTips = labelshowTips.mo223809clone();
        }
        return dynamicLable;
    }
