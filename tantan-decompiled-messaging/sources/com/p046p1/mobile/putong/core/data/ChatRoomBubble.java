...
public class ChatRoomBubble extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatRoomBubble> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatRoomBubble>() { // from class: com.p1.mobile.putong.core.data.ChatRoomBubble.1
        ...
        public int computeAndCacheSize(ChatRoomBubble chatRoomBubble) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, chatRoomBubble.chatUserNum);
            ...
            chatRoomBubble.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatRoomBubble parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    chatRoomBubble.theme = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    chatRoomBubble.chatUserNum = nb5Var.m158741j();
                } else if (iM158752u == 26) {
                    chatRoomBubble.avatars = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 34) {
                    chatRoomBubble.roomID = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (chatRoomBubble.roomID == null) {
                            chatRoomBubble.roomID = "";
                    ...
                    chatRoomBubble.liveID = nb5Var.m158750s();
                }
            }
            return chatRoomBubble;
        }
        ...
        public void serialize(ChatRoomBubble chatRoomBubble, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, chatRoomBubble.chatUserNum);
            List<String> list = chatRoomBubble.avatars;
            if (list != null) {
    ...
    public static /* synthetic */ String m35275a(String str) {
        return str;
    }
    ...
    public ChatRoomBubble mo223809clone() {
        ChatRoomBubble chatRoomBubble = new ChatRoomBubble();
        ...
        if (list != null) {
            chatRoomBubble.avatars = ValueObject.util_map(list, new w9j() { // from class: l.z15
                ...
                public final Object call(Object obj) {
                    return ChatRoomBubble.m35275a((String) obj);
                }
            });
        }
        return chatRoomBubble;
