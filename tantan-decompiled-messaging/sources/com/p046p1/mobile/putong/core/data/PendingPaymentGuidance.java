...
public class PendingPaymentGuidance extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PendingPaymentGuidance> PROTOBUF_ADAPTER = new MessageNanoAdapter<PendingPaymentGuidance>() { // from class: com.p1.mobile.putong.core.data.PendingPaymentGuidance.1
        ...
        public int computeAndCacheSize(PendingPaymentGuidance pendingPaymentGuidance) {
            ...
            int iM17228j = iM17233o + CodedOutputByteBufferNano.m17228j(5, pendingPaymentGuidance.remainingTime);
            ...
            if (str7 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(8, str7);
            }
            String str8 = pendingPaymentGuidance.guideType;
            if (str8 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(9, str8);
            }
            int iM17228j2 = iM17228j + CodedOutputByteBufferNano.m17228j(10, pendingPaymentGuidance.endTime);
            pendingPaymentGuidance.cachedSize = iM17228j2;
            return iM17228j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PendingPaymentGuidance parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        pendingPaymentGuidance.platform = nb5Var.m158750s();
                        continue;
                    case 18:
                        pendingPaymentGuidance.method = nb5Var.m158750s();
                        continue;
                    case 26:
                        pendingPaymentGuidance.productType = nb5Var.m158750s();
                        continue;
                    case 34:
                        pendingPaymentGuidance.paymentFailMsg = nb5Var.m158750s();
                        continue;
                    case 40:
                        pendingPaymentGuidance.remainingTime = nb5Var.m158742k();
                        continue;
                    case 50:
                        pendingPaymentGuidance.itemId = nb5Var.m158750s();
                        continue;
                    case 58:
                        pendingPaymentGuidance.discountToken = nb5Var.m158750s();
                        continue;
                    case 66:
                        pendingPaymentGuidance.identifier = nb5Var.m158750s();
                        continue;
                    case 74:
                        pendingPaymentGuidance.guideType = nb5Var.m158750s();
                        continue;
                    case 80:
                        pendingPaymentGuidance.endTime = nb5Var.m158742k();
                        continue;
                    default:
                        if (pendingPaymentGuidance.platform == null) {
                            pendingPaymentGuidance.platform = "";
        ...
        public void serialize(PendingPaymentGuidance pendingPaymentGuidance, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(5, pendingPaymentGuidance.remainingTime);
            String str5 = pendingPaymentGuidance.itemId;
            if (str5 != null) {
            ...
            codedOutputByteBufferNano.m17252I(10, pendingPaymentGuidance.endTime);
        }
    };
    ...
    public PendingPaymentGuidance mo223809clone() {
        PendingPaymentGuidance pendingPaymentGuidance = new PendingPaymentGuidance();
