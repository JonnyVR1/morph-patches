...
public class SwipeVerifiedConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SwipeVerifiedConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<SwipeVerifiedConfig>() { // from class: com.p1.mobile.putong.core.data.SwipeVerifiedConfig.1
        ...
        public int computeAndCacheSize(SwipeVerifiedConfig swipeVerifiedConfig) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, swipeVerifiedConfig.enable) + CodedOutputByteBufferNano.m17226h(2, swipeVerifiedConfig.verified_user_additional_like_count) + CodedOutputByteBufferNano.m17226h(3, swipeVerifiedConfig.maximum_verify_guide_times);
            swipeVerifiedConfig.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SwipeVerifiedConfig parse(nb5 nb5Var) throws IOException {
            SwipeVerifiedConfig swipeVerifiedConfig = new SwipeVerifiedConfig();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    swipeVerifiedConfig.enable = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    swipeVerifiedConfig.verified_user_additional_like_count = nb5Var.m158741j();
                } else {
                    if (iM158752u != 24) {
                        return swipeVerifiedConfig;
                    }
                    swipeVerifiedConfig.maximum_verify_guide_times = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(SwipeVerifiedConfig swipeVerifiedConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, swipeVerifiedConfig.enable);
            codedOutputByteBufferNano.m17250G(2, swipeVerifiedConfig.verified_user_additional_like_count);
            codedOutputByteBufferNano.m17250G(3, swipeVerifiedConfig.maximum_verify_guide_times);
        }
    };
    ...
    public SwipeVerifiedConfig mo223809clone() {
        SwipeVerifiedConfig swipeVerifiedConfig = new SwipeVerifiedConfig();
