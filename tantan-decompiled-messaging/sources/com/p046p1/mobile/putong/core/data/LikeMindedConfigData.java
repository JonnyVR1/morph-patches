...
public class LikeMindedConfigData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikeMindedConfigData> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikeMindedConfigData>() { // from class: com.p1.mobile.putong.core.data.LikeMindedConfigData.1
        ...
        public int computeAndCacheSize(LikeMindedConfigData likeMindedConfigData) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, likeMindedConfigData.enable);
            Map<String, LikeMindedMccConfigData> map = likeMindedConfigData.mcc;
            if (map != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(2, map, LikeMindedMccConfigData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            Map<String, LikeMindedItemData> map2 = likeMindedConfigData.same;
            if (map2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(3, map2, LikeMindedItemData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            likeMindedConfigData.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LikeMindedConfigData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    likeMindedConfigData.enable = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    likeMindedConfigData.mcc = (Map) nb5Var.m158743l(LikeMindedMccConfigData.PROTOBUF_ADAPTER.MAP_ADAPTER());
                } else {
                    if (iM158752u != 26) {
                        if (likeMindedConfigData.mcc == null) {
                            likeMindedConfigData.mcc = Collections.EMPTY_MAP;
                    ...
                    likeMindedConfigData.same = (Map) nb5Var.m158743l(LikeMindedItemData.PROTOBUF_ADAPTER.MAP_ADAPTER());
                }
            }
            return likeMindedConfigData;
        }
        ...
        public void serialize(LikeMindedConfigData likeMindedConfigData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, likeMindedConfigData.enable);
            Map<String, LikeMindedMccConfigData> map = likeMindedConfigData.mcc;
            if (map != null) {
                codedOutputByteBufferNano.m17254K(2, map, LikeMindedMccConfigData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            Map<String, LikeMindedItemData> map2 = likeMindedConfigData.same;
            if (map2 != null) {
                codedOutputByteBufferNano.m17254K(3, map2, LikeMindedItemData.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
        }
    };
    ...
    public LikeMindedConfigData mo223809clone() {
        LikeMindedConfigData likeMindedConfigData = new LikeMindedConfigData();
        ...
        if (map != null) {
            likeMindedConfigData.mcc = ValueObject.util_map(map, new w9j() { // from class: l.edr
                ...
                public final Object call(Object obj) {
                    return ((LikeMindedMccConfigData) obj).mo223809clone();
                }
            });
        }
        ...
        if (map2 != null) {
            likeMindedConfigData.same = ValueObject.util_map(map2, new w9j() { // from class: l.fdr
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((LikeMindedItemData) obj).mo223809clone();
                }
            });
        }
        return likeMindedConfigData;
