...
public class PrivilegeTopChat extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PrivilegeTopChat> PROTOBUF_ADAPTER = new MessageNanoAdapter<PrivilegeTopChat>() { // from class: com.p1.mobile.putong.core.data.PrivilegeTopChat.1
        ...
        public int computeAndCacheSize(PrivilegeTopChat privilegeTopChat) {
            ...
            int iM17230l = conversation != null ? CodedOutputByteBufferNano.m17230l(1, conversation, Conversation.PROTOBUF_ADAPTER) : 0;
            User user = privilegeTopChat.user;
            if (user != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, user, User.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17230l + CodedOutputByteBufferNano.m17220b(3, privilegeTopChat.isClicked);
            privilegeTopChat.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PrivilegeTopChat parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    privilegeTopChat.conversation = (Conversation) nb5Var.m158743l(Conversation.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    privilegeTopChat.user = (User) nb5Var.m158743l(User.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 24) {
                        if (privilegeTopChat.conversation == null) {
                            privilegeTopChat.conversation = Conversation.new_();
                    ...
                    privilegeTopChat.isClicked = nb5Var.m158738g();
                }
            }
            return privilegeTopChat;
        }
        ...
        public void serialize(PrivilegeTopChat privilegeTopChat, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (conversation != null) {
                codedOutputByteBufferNano.m17254K(1, conversation, Conversation.PROTOBUF_ADAPTER);
            }
            User user = privilegeTopChat.user;
            if (user != null) {
                codedOutputByteBufferNano.m17254K(2, user, User.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(3, privilegeTopChat.isClicked);
        }
    };
    ...
    public PrivilegeTopChat mo223809clone() {
        PrivilegeTopChat privilegeTopChat = new PrivilegeTopChat();
        Conversation conversation = this.conversation;
        if (conversation != null) {
            privilegeTopChat.conversation = conversation.mo223809clone();
        }
        User user = this.user;
        if (user != null) {
            privilegeTopChat.user = user.mo223809clone();
        }
