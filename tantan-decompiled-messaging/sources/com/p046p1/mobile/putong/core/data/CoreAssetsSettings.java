...
import com.p046p1.mobile.putong.core.data.ProfileBasicTag;
import com.p046p1.mobile.putong.core.data.ProfileUpgradeInterest;
...
public class CoreAssetsSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreAssetsSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreAssetsSettings>() { // from class: com.p1.mobile.putong.core.data.CoreAssetsSettings.1
        ...
        public int computeAndCacheSize(CoreAssetsSettings coreAssetsSettings) {
            ...
            int iM17230l = (list != null ? CodedOutputByteBufferNano.m17230l(1, list, InactivateReason.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0) + CodedOutputByteBufferNano.m17220b(2, coreAssetsSettings.closeAct2GoodAll);
            PromptLimit promptLimit = coreAssetsSettings.prompt;
            if (promptLimit != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, promptLimit, PromptLimit.PROTOBUF_ADAPTER);
            }
            int iM17228j = iM17230l + CodedOutputByteBufferNano.m17228j(4, coreAssetsSettings.counterPollingSeconds);
            MissMatch missMatch = coreAssetsSettings.missMatch;
            if (missMatch != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(5, missMatch, MissMatch.PROTOBUF_ADAPTER);
            }
            SpecialCard specialCard = coreAssetsSettings.specialCard;
            if (specialCard != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(6, specialCard, SpecialCard.PROTOBUF_ADAPTER);
            }
            ChatEffect chatEffect = coreAssetsSettings.chatEffect;
            if (chatEffect != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(7, chatEffect, ChatEffect.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17228j + CodedOutputByteBufferNano.m17220b(8, coreAssetsSettings.forcePhoneBind) + CodedOutputByteBufferNano.m17222d(9, coreAssetsSettings.forcePhoneBindTime);
            ThirdPartySticker thirdPartySticker = coreAssetsSettings.thirdPartySticker;
            if (thirdPartySticker != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(10, thirdPartySticker, ThirdPartySticker.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17220b + CodedOutputByteBufferNano.m17226h(11, coreAssetsSettings.enableVoiceCall);
            LetterMultilingual letterMultilingual = coreAssetsSettings.letterContent;
            if (letterMultilingual != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(12, letterMultilingual, LetterMultilingual.PROTOBUF_ADAPTER);
            }
            ShowLiveForIntlAdUser showLiveForIntlAdUser = coreAssetsSettings.showLiveForIntlAdUser;
            if (showLiveForIntlAdUser != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(13, showLiveForIntlAdUser, ShowLiveForIntlAdUser.PROTOBUF_ADAPTER);
            }
            IntlChatRequest intlChatRequest = coreAssetsSettings.intlChatRequest;
            if (intlChatRequest != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(14, intlChatRequest, IntlChatRequest.PROTOBUF_ADAPTER);
            }
            GraduateActivity graduateActivity = coreAssetsSettings.graduateActivity;
            if (graduateActivity != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(15, graduateActivity, GraduateActivity.PROTOBUF_ADAPTER);
            }
            int iM17220b2 = iM17226h + CodedOutputByteBufferNano.m17220b(16, coreAssetsSettings.autoReadConversation);
            List<RateAlertSetting> list2 = coreAssetsSettings.rateAlertSetting;
            if (list2 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(17, list2, RateAlertSetting.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UserBanAppealSwitch userBanAppealSwitch = coreAssetsSettings.userBanAppealSwitch;
            if (userBanAppealSwitch != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17226h(18, userBanAppealSwitch.ordinal());
            }
            AppUpdateVersionData appUpdateVersionData = coreAssetsSettings.appUpdateVersionData;
            if (appUpdateVersionData != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(19, appUpdateVersionData, AppUpdateVersionData.PROTOBUF_ADAPTER);
            }
            ...
            if (schoolVerificationAgeRange != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(20, schoolVerificationAgeRange, SchoolVerificationAgeRange.PROTOBUF_ADAPTER);
            }
            KeepConnection keepConnection = coreAssetsSettings.keepConnection;
            if (keepConnection != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(21, keepConnection, KeepConnection.PROTOBUF_ADAPTER);
            }
            UserScrapeReporting userScrapeReporting = coreAssetsSettings.userScrapeReporting;
            if (userScrapeReporting != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(22, userScrapeReporting, UserScrapeReporting.PROTOBUF_ADAPTER);
            }
            LowPriceFirstMonth lowPriceFirstMonth = coreAssetsSettings.lowPriceFirstMonth;
            if (lowPriceFirstMonth != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(23, lowPriceFirstMonth, LowPriceFirstMonth.PROTOBUF_ADAPTER);
            }
            SeeMatchThenPay seeMatchThenPay = coreAssetsSettings.seeMatchThenPay;
            if (seeMatchThenPay != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(24, seeMatchThenPay, SeeMatchThenPay.PROTOBUF_ADAPTER);
            }
            int iM17220b3 = iM17220b2 + CodedOutputByteBufferNano.m17220b(25, coreAssetsSettings.autoPayEnable) + CodedOutputByteBufferNano.m17226h(26, coreAssetsSettings.seeSwipeCountInOneSession);
            List<ProfileBasicTag> list3 = coreAssetsSettings.profileBasicHobbyTags;
            if (list3 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(27, list3, ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ProfileBasicTag> list4 = coreAssetsSettings.profileBasicRecentTags;
            if (list4 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(28, list4, ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ProfileBasicTag> list5 = coreAssetsSettings.profileBasicTogetherTags;
            if (list5 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(29, list5, ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            AnonymityImg anonymityImg = coreAssetsSettings.anonymityImg;
            if (anonymityImg != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(30, anonymityImg, AnonymityImg.PROTOBUF_ADAPTER);
            }
            int iM17220b4 = iM17220b3 + CodedOutputByteBufferNano.m17220b(31, coreAssetsSettings.chatGuideExp);
            LetterMultilingual letterMultilingual2 = coreAssetsSettings.intlLetterContent;
            if (letterMultilingual2 != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(32, letterMultilingual2, LetterMultilingual.PROTOBUF_ADAPTER);
            }
            AutoRenewalBenefit autoRenewalBenefit = coreAssetsSettings.autoRenewalBenefit;
            if (autoRenewalBenefit != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(33, autoRenewalBenefit, AutoRenewalBenefit.PROTOBUF_ADAPTER);
            }
            ...
            if (profileUpgradeInputOrder != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(34, profileUpgradeInputOrder, ProfileUpgradeInputOrder.PROTOBUF_ADAPTER);
            }
            ProfileUpgradeGuideText profileUpgradeGuideText = coreAssetsSettings.guideText;
            if (profileUpgradeGuideText != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(35, profileUpgradeGuideText, ProfileUpgradeGuideText.PROTOBUF_ADAPTER);
            }
            List<ProfileUpgradeInterest> list6 = coreAssetsSettings.profileUpgradeInterest;
            if (list6 != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(36, list6, ProfileUpgradeInterest.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17226h2 = iM17220b4 + CodedOutputByteBufferNano.m17226h(37, coreAssetsSettings.chatOnlineDuration);
            UserBanAppealSwitch userBanAppealSwitch2 = coreAssetsSettings.userBanAppealSwitch;
            if (userBanAppealSwitch2 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(38, userBanAppealSwitch2, UserBanAppealSwitch.PROTOBUF_ADAPTER);
            }
            coreAssetsSettings.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreAssetsSettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        coreAssetsSettings.inactivateReason = (List) nb5Var.m158743l(InactivateReason.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 16:
                        coreAssetsSettings.closeAct2GoodAll = nb5Var.m158738g();
                        continue;
                    case 26:
                        coreAssetsSettings.prompt = (PromptLimit) nb5Var.m158743l(PromptLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 32:
                        coreAssetsSettings.counterPollingSeconds = nb5Var.m158742k();
                        continue;
                    case 42:
                        coreAssetsSettings.missMatch = (MissMatch) nb5Var.m158743l(MissMatch.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        coreAssetsSettings.specialCard = (SpecialCard) nb5Var.m158743l(SpecialCard.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        coreAssetsSettings.chatEffect = (ChatEffect) nb5Var.m158743l(ChatEffect.PROTOBUF_ADAPTER);
                        continue;
                    case 64:
                        coreAssetsSettings.forcePhoneBind = nb5Var.m158738g();
                        continue;
                    case EACTags.CARDHOLDER_PUBLIC_KEY_TEMPLATE /* 73 */:
                        coreAssetsSettings.forcePhoneBindTime = nb5Var.m158739h();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        coreAssetsSettings.thirdPartySticker = (ThirdPartySticker) nb5Var.m158743l(ThirdPartySticker.PROTOBUF_ADAPTER);
                        continue;
                    case 88:
                        coreAssetsSettings.enableVoiceCall = nb5Var.m158741j();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        coreAssetsSettings.letterContent = (LetterMultilingual) nb5Var.m158743l(LetterMultilingual.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        coreAssetsSettings.showLiveForIntlAdUser = (ShowLiveForIntlAdUser) nb5Var.m158743l(ShowLiveForIntlAdUser.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        coreAssetsSettings.intlChatRequest = (IntlChatRequest) nb5Var.m158743l(IntlChatRequest.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        coreAssetsSettings.graduateActivity = (GraduateActivity) nb5Var.m158743l(GraduateActivity.PROTOBUF_ADAPTER);
                        continue;
                    case 128:
                        coreAssetsSettings.autoReadConversation = nb5Var.m158738g();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        coreAssetsSettings.rateAlertSetting = (List) nb5Var.m158743l(RateAlertSetting.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 144:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 154:
                        coreAssetsSettings.appUpdateVersionData = (AppUpdateVersionData) nb5Var.m158743l(AppUpdateVersionData.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        coreAssetsSettings.schoolVerificationAgeRange = (SchoolVerificationAgeRange) nb5Var.m158743l(SchoolVerificationAgeRange.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        coreAssetsSettings.keepConnection = (KeepConnection) nb5Var.m158743l(KeepConnection.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        coreAssetsSettings.userScrapeReporting = (UserScrapeReporting) nb5Var.m158743l(UserScrapeReporting.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        coreAssetsSettings.lowPriceFirstMonth = (LowPriceFirstMonth) nb5Var.m158743l(LowPriceFirstMonth.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        coreAssetsSettings.seeMatchThenPay = (SeeMatchThenPay) nb5Var.m158743l(SeeMatchThenPay.PROTOBUF_ADAPTER);
                        continue;
                    case 200:
                        coreAssetsSettings.autoPayEnable = nb5Var.m158738g();
                        continue;
                    case 208:
                        coreAssetsSettings.seeSwipeCountInOneSession = nb5Var.m158741j();
                        continue;
                    case 218:
                        coreAssetsSettings.profileBasicHobbyTags = (List) nb5Var.m158743l(ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 226:
                        coreAssetsSettings.profileBasicRecentTags = (List) nb5Var.m158743l(ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 234:
                        coreAssetsSettings.profileBasicTogetherTags = (List) nb5Var.m158743l(ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 242:
                        coreAssetsSettings.anonymityImg = (AnonymityImg) nb5Var.m158743l(AnonymityImg.PROTOBUF_ADAPTER);
                        continue;
                    case 248:
                        coreAssetsSettings.chatGuideExp = nb5Var.m158738g();
                        continue;
                    case 258:
                        coreAssetsSettings.intlLetterContent = (LetterMultilingual) nb5Var.m158743l(LetterMultilingual.PROTOBUF_ADAPTER);
                        continue;
                    case 266:
                        coreAssetsSettings.autoRenewalBenefit = (AutoRenewalBenefit) nb5Var.m158743l(AutoRenewalBenefit.PROTOBUF_ADAPTER);
                        continue;
                    case 274:
                        coreAssetsSettings.profileUpgradeInputOrder = (ProfileUpgradeInputOrder) nb5Var.m158743l(ProfileUpgradeInputOrder.PROTOBUF_ADAPTER);
                        continue;
                    case 282:
                        coreAssetsSettings.guideText = (ProfileUpgradeGuideText) nb5Var.m158743l(ProfileUpgradeGuideText.PROTOBUF_ADAPTER);
                        continue;
                    case 290:
                        coreAssetsSettings.profileUpgradeInterest = (List) nb5Var.m158743l(ProfileUpgradeInterest.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 296:
                        coreAssetsSettings.chatOnlineDuration = nb5Var.m158741j();
                        continue;
                    case 306:
                        coreAssetsSettings.userBanAppealSwitch = (UserBanAppealSwitch) nb5Var.m158743l(UserBanAppealSwitch.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (coreAssetsSettings.userBanAppealSwitch == null && numValueOf != null) {
                            coreAssetsSettings.userBanAppealSwitch = (UserBanAppealSwitch) UserBanAppealSwitch.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(CoreAssetsSettings coreAssetsSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<InactivateReason> list = coreAssetsSettings.inactivateReason;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(1, list, InactivateReason.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17244A(2, coreAssetsSettings.closeAct2GoodAll);
            PromptLimit promptLimit = coreAssetsSettings.prompt;
            if (promptLimit != null) {
                codedOutputByteBufferNano.m17254K(3, promptLimit, PromptLimit.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17252I(4, coreAssetsSettings.counterPollingSeconds);
            MissMatch missMatch = coreAssetsSettings.missMatch;
            if (missMatch != null) {
                codedOutputByteBufferNano.m17254K(5, missMatch, MissMatch.PROTOBUF_ADAPTER);
            }
            SpecialCard specialCard = coreAssetsSettings.specialCard;
            if (specialCard != null) {
                codedOutputByteBufferNano.m17254K(6, specialCard, SpecialCard.PROTOBUF_ADAPTER);
            }
            ChatEffect chatEffect = coreAssetsSettings.chatEffect;
            if (chatEffect != null) {
                codedOutputByteBufferNano.m17254K(7, chatEffect, ChatEffect.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(8, coreAssetsSettings.forcePhoneBind);
            codedOutputByteBufferNano.m17246C(9, coreAssetsSettings.forcePhoneBindTime);
            ThirdPartySticker thirdPartySticker = coreAssetsSettings.thirdPartySticker;
            if (thirdPartySticker != null) {
                codedOutputByteBufferNano.m17254K(10, thirdPartySticker, ThirdPartySticker.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(11, coreAssetsSettings.enableVoiceCall);
            LetterMultilingual letterMultilingual = coreAssetsSettings.letterContent;
            if (letterMultilingual != null) {
                codedOutputByteBufferNano.m17254K(12, letterMultilingual, LetterMultilingual.PROTOBUF_ADAPTER);
            }
            ShowLiveForIntlAdUser showLiveForIntlAdUser = coreAssetsSettings.showLiveForIntlAdUser;
            if (showLiveForIntlAdUser != null) {
                codedOutputByteBufferNano.m17254K(13, showLiveForIntlAdUser, ShowLiveForIntlAdUser.PROTOBUF_ADAPTER);
            }
            IntlChatRequest intlChatRequest = coreAssetsSettings.intlChatRequest;
            if (intlChatRequest != null) {
                codedOutputByteBufferNano.m17254K(14, intlChatRequest, IntlChatRequest.PROTOBUF_ADAPTER);
            }
            GraduateActivity graduateActivity = coreAssetsSettings.graduateActivity;
            if (graduateActivity != null) {
                codedOutputByteBufferNano.m17254K(15, graduateActivity, GraduateActivity.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(16, coreAssetsSettings.autoReadConversation);
            List<RateAlertSetting> list2 = coreAssetsSettings.rateAlertSetting;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(17, list2, RateAlertSetting.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UserBanAppealSwitch userBanAppealSwitch = coreAssetsSettings.userBanAppealSwitch;
            if (userBanAppealSwitch != null) {
                codedOutputByteBufferNano.m17250G(18, userBanAppealSwitch.ordinal());
            }
            AppUpdateVersionData appUpdateVersionData = coreAssetsSettings.appUpdateVersionData;
            if (appUpdateVersionData != null) {
                codedOutputByteBufferNano.m17254K(19, appUpdateVersionData, AppUpdateVersionData.PROTOBUF_ADAPTER);
            }
            SchoolVerificationAgeRange schoolVerificationAgeRange = coreAssetsSettings.schoolVerificationAgeRange;
            if (schoolVerificationAgeRange != null) {
                codedOutputByteBufferNano.m17254K(20, schoolVerificationAgeRange, SchoolVerificationAgeRange.PROTOBUF_ADAPTER);
            }
            KeepConnection keepConnection = coreAssetsSettings.keepConnection;
            if (keepConnection != null) {
                codedOutputByteBufferNano.m17254K(21, keepConnection, KeepConnection.PROTOBUF_ADAPTER);
            }
            UserScrapeReporting userScrapeReporting = coreAssetsSettings.userScrapeReporting;
            if (userScrapeReporting != null) {
                codedOutputByteBufferNano.m17254K(22, userScrapeReporting, UserScrapeReporting.PROTOBUF_ADAPTER);
            }
            LowPriceFirstMonth lowPriceFirstMonth = coreAssetsSettings.lowPriceFirstMonth;
            if (lowPriceFirstMonth != null) {
                codedOutputByteBufferNano.m17254K(23, lowPriceFirstMonth, LowPriceFirstMonth.PROTOBUF_ADAPTER);
            }
            SeeMatchThenPay seeMatchThenPay = coreAssetsSettings.seeMatchThenPay;
            if (seeMatchThenPay != null) {
                codedOutputByteBufferNano.m17254K(24, seeMatchThenPay, SeeMatchThenPay.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(25, coreAssetsSettings.autoPayEnable);
            codedOutputByteBufferNano.m17250G(26, coreAssetsSettings.seeSwipeCountInOneSession);
            List<ProfileBasicTag> list3 = coreAssetsSettings.profileBasicHobbyTags;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(27, list3, ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ProfileBasicTag> list4 = coreAssetsSettings.profileBasicRecentTags;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(28, list4, ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ProfileBasicTag> list5 = coreAssetsSettings.profileBasicTogetherTags;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(29, list5, ProfileBasicTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            AnonymityImg anonymityImg = coreAssetsSettings.anonymityImg;
            if (anonymityImg != null) {
                codedOutputByteBufferNano.m17254K(30, anonymityImg, AnonymityImg.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(31, coreAssetsSettings.chatGuideExp);
            LetterMultilingual letterMultilingual2 = coreAssetsSettings.intlLetterContent;
            if (letterMultilingual2 != null) {
                codedOutputByteBufferNano.m17254K(32, letterMultilingual2, LetterMultilingual.PROTOBUF_ADAPTER);
            }
            AutoRenewalBenefit autoRenewalBenefit = coreAssetsSettings.autoRenewalBenefit;
            if (autoRenewalBenefit != null) {
                codedOutputByteBufferNano.m17254K(33, autoRenewalBenefit, AutoRenewalBenefit.PROTOBUF_ADAPTER);
            }
            ProfileUpgradeInputOrder profileUpgradeInputOrder = coreAssetsSettings.profileUpgradeInputOrder;
            if (profileUpgradeInputOrder != null) {
                codedOutputByteBufferNano.m17254K(34, profileUpgradeInputOrder, ProfileUpgradeInputOrder.PROTOBUF_ADAPTER);
            }
            ProfileUpgradeGuideText profileUpgradeGuideText = coreAssetsSettings.guideText;
            if (profileUpgradeGuideText != null) {
                codedOutputByteBufferNano.m17254K(35, profileUpgradeGuideText, ProfileUpgradeGuideText.PROTOBUF_ADAPTER);
            }
            List<ProfileUpgradeInterest> list6 = coreAssetsSettings.profileUpgradeInterest;
            if (list6 != null) {
                codedOutputByteBufferNano.m17254K(36, list6, ProfileUpgradeInterest.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(37, coreAssetsSettings.chatOnlineDuration);
            UserBanAppealSwitch userBanAppealSwitch2 = coreAssetsSettings.userBanAppealSwitch;
            if (userBanAppealSwitch2 != null) {
                codedOutputByteBufferNano.m17254K(38, userBanAppealSwitch2, UserBanAppealSwitch.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public CoreAssetsSettings mo223809clone() {
        CoreAssetsSettings coreAssetsSettings = new CoreAssetsSettings();
        ...
        if (list != null) {
            coreAssetsSettings.inactivateReason = ValueObject.util_map(list, new w9j() { // from class: l.ex6
                ...
                public final Object call(Object obj) {
                    return ((InactivateReason) obj).mo223809clone();
                }
            });
        }
        ...
        if (promptLimit != null) {
            coreAssetsSettings.prompt = promptLimit.mo223809clone();
        }
        coreAssetsSettings.counterPollingSeconds = this.counterPollingSeconds;
        MissMatch missMatch = this.missMatch;
        if (missMatch != null) {
            coreAssetsSettings.missMatch = missMatch.mo223809clone();
        }
        SpecialCard specialCard = this.specialCard;
        if (specialCard != null) {
            coreAssetsSettings.specialCard = specialCard.mo223809clone();
        }
        ChatEffect chatEffect = this.chatEffect;
        if (chatEffect != null) {
            coreAssetsSettings.chatEffect = chatEffect.mo223809clone();
        }
        ...
        if (thirdPartySticker != null) {
            coreAssetsSettings.thirdPartySticker = thirdPartySticker.mo223809clone();
        }
        coreAssetsSettings.enableVoiceCall = this.enableVoiceCall;
        LetterMultilingual letterMultilingual = this.letterContent;
        if (letterMultilingual != null) {
            coreAssetsSettings.letterContent = letterMultilingual.mo223809clone();
        }
        ShowLiveForIntlAdUser showLiveForIntlAdUser = this.showLiveForIntlAdUser;
        if (showLiveForIntlAdUser != null) {
            coreAssetsSettings.showLiveForIntlAdUser = showLiveForIntlAdUser.mo223809clone();
        }
        IntlChatRequest intlChatRequest = this.intlChatRequest;
        if (intlChatRequest != null) {
            coreAssetsSettings.intlChatRequest = intlChatRequest.mo223809clone();
        }
        GraduateActivity graduateActivity = this.graduateActivity;
        if (graduateActivity != null) {
            coreAssetsSettings.graduateActivity = graduateActivity.mo223809clone();
        }
        ...
        if (list2 != null) {
            coreAssetsSettings.rateAlertSetting = ValueObject.util_map(list2, new w9j() { // from class: l.fx6
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((RateAlertSetting) obj).mo223809clone();
                }
            });
        }
        ...
        if (appUpdateVersionData != null) {
            coreAssetsSettings.appUpdateVersionData = appUpdateVersionData.mo223809clone();
        }
        SchoolVerificationAgeRange schoolVerificationAgeRange = this.schoolVerificationAgeRange;
        if (schoolVerificationAgeRange != null) {
            coreAssetsSettings.schoolVerificationAgeRange = schoolVerificationAgeRange.mo223809clone();
        }
        KeepConnection keepConnection = this.keepConnection;
        if (keepConnection != null) {
            coreAssetsSettings.keepConnection = keepConnection.mo223809clone();
        }
        UserScrapeReporting userScrapeReporting = this.userScrapeReporting;
        if (userScrapeReporting != null) {
            coreAssetsSettings.userScrapeReporting = userScrapeReporting.mo223809clone();
        }
        LowPriceFirstMonth lowPriceFirstMonth = this.lowPriceFirstMonth;
        if (lowPriceFirstMonth != null) {
            coreAssetsSettings.lowPriceFirstMonth = lowPriceFirstMonth.mo223809clone();
        }
        SeeMatchThenPay seeMatchThenPay = this.seeMatchThenPay;
        if (seeMatchThenPay != null) {
            coreAssetsSettings.seeMatchThenPay = seeMatchThenPay.mo223809clone();
        }
        ...
        if (list3 != null) {
            coreAssetsSettings.profileBasicHobbyTags = ValueObject.util_map(list3, new w9j() { // from class: l.gx6
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((ProfileBasicTag) obj).mo223809clone();
                }
            });
        }
        ...
        if (anonymityImg != null) {
            coreAssetsSettings.anonymityImg = anonymityImg.mo223809clone();
        }
        coreAssetsSettings.chatGuideExp = this.chatGuideExp;
        LetterMultilingual letterMultilingual2 = this.intlLetterContent;
        if (letterMultilingual2 != null) {
            coreAssetsSettings.intlLetterContent = letterMultilingual2.mo223809clone();
        }
        AutoRenewalBenefit autoRenewalBenefit = this.autoRenewalBenefit;
        if (autoRenewalBenefit != null) {
            coreAssetsSettings.autoRenewalBenefit = autoRenewalBenefit.mo223809clone();
        }
        ProfileUpgradeInputOrder profileUpgradeInputOrder = this.profileUpgradeInputOrder;
        if (profileUpgradeInputOrder != null) {
            coreAssetsSettings.profileUpgradeInputOrder = profileUpgradeInputOrder.mo223809clone();
        }
        ProfileUpgradeGuideText profileUpgradeGuideText = this.guideText;
        if (profileUpgradeGuideText != null) {
            coreAssetsSettings.guideText = profileUpgradeGuideText.mo223809clone();
        }
        ...
        if (list6 != null) {
            coreAssetsSettings.profileUpgradeInterest = ValueObject.util_map(list6, new w9j() { // from class: l.jx6
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((ProfileUpgradeInterest) obj).mo223809clone();
                }
            });
        }
