...
public class SpotLightLiveInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpotLightLiveInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpotLightLiveInfo>() { // from class: com.p1.mobile.putong.core.data.SpotLightLiveInfo.1
        ...
        public int computeAndCacheSize(SpotLightLiveInfo spotLightLiveInfo) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, spotLightLiveInfo.liveType) + CodedOutputByteBufferNano.m17226h(3, spotLightLiveInfo.state);
            ...
            String str5 = spotLightLiveInfo.f20501id;
            if (str5 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(7, str5);
            }
            spotLightLiveInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SpotLightLiveInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    ...
                    if (spotLightLiveInfo.f20501id == null) {
                        spotLightLiveInfo.f20501id = "";
                    }
                ...
                if (iM158752u == 10) {
                    spotLightLiveInfo.anchorId = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    spotLightLiveInfo.liveType = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    spotLightLiveInfo.state = nb5Var.m158741j();
                } else if (iM158752u == 34) {
                    spotLightLiveInfo.mainTitle = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    spotLightLiveInfo.subTitle = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    spotLightLiveInfo.roomId = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (spotLightLiveInfo.roomId == null) {
                            spotLightLiveInfo.roomId = "";
                    ...
                    spotLightLiveInfo.f20501id = nb5Var.m158750s();
                }
            }
            return spotLightLiveInfo;
        }
        ...
        public void serialize(SpotLightLiveInfo spotLightLiveInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, spotLightLiveInfo.liveType);
            codedOutputByteBufferNano.m17250G(3, spotLightLiveInfo.state);
            String str2 = spotLightLiveInfo.mainTitle;
            if (str2 != null) {
    ...
    public static JsonAdapter<SpotLightLiveInfo> JSON_ADAPTER = new ObjectJsonAdapter<SpotLightLiveInfo>() { // from class: com.p1.mobile.putong.core.data.SpotLightLiveInfo.2
        ...
        public boolean parseField(SpotLightLiveInfo spotLightLiveInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "mainTitle":
                    ...
                    return true;
                case "id":
                    spotLightLiveInfo.f20501id = jsonParser.getValueAsString();
                    return false;
                case "state":
        ...
        public void serializeFields(SpotLightLiveInfo spotLightLiveInfo, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str2 = spotLightLiveInfo.f20501id;
            if (str2 != null) {
    ...
    public SpotLightLiveInfo mo223809clone() {
        SpotLightLiveInfo spotLightLiveInfo = new SpotLightLiveInfo();
        spotLightLiveInfo.roomId = this.roomId;
        spotLightLiveInfo.f20501id = this.f20501id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.roomId, spotLightLiveInfo.roomId) && ValueObject.util_equals(this.f20501id, spotLightLiveInfo.f20501id) && ValueObject.util_equals(this.anchorId, spotLightLiveInfo.anchorId) && this.liveType == spotLightLiveInfo.liveType && this.state == spotLightLiveInfo.state && ValueObject.util_equals(this.mainTitle, spotLightLiveInfo.mainTitle) && ValueObject.util_equals(this.subTitle, spotLightLiveInfo.subTitle);
    }
