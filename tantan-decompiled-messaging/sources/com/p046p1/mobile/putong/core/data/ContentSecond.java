...
public class ContentSecond extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ContentSecond> PROTOBUF_ADAPTER = new MessageNanoAdapter<ContentSecond>() { // from class: com.p1.mobile.putong.core.data.ContentSecond.1
        ...
        public int computeAndCacheSize(ContentSecond contentSecond) {
            ...
            int iM17230l = selectionSecond != null ? CodedOutputByteBufferNano.m17230l(1, selectionSecond, SelectionSecond.PROTOBUF_ADAPTER) : 0;
            FillBlankSecond fillBlankSecond = contentSecond.fillBlank;
            if (fillBlankSecond != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, fillBlankSecond, FillBlankSecond.PROTOBUF_ADAPTER);
            }
            contentSecond.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ContentSecond parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    contentSecond.selection = (SelectionSecond) nb5Var.m158743l(SelectionSecond.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (contentSecond.selection == null) {
                            contentSecond.selection = SelectionSecond.new_();
                    ...
                    contentSecond.fillBlank = (FillBlankSecond) nb5Var.m158743l(FillBlankSecond.PROTOBUF_ADAPTER);
                }
            }
            return contentSecond;
        }
        ...
        public void serialize(ContentSecond contentSecond, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (selectionSecond != null) {
                codedOutputByteBufferNano.m17254K(1, selectionSecond, SelectionSecond.PROTOBUF_ADAPTER);
            }
            FillBlankSecond fillBlankSecond = contentSecond.fillBlank;
            if (fillBlankSecond != null) {
                codedOutputByteBufferNano.m17254K(2, fillBlankSecond, FillBlankSecond.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ContentSecond mo223809clone() {
        ContentSecond contentSecond = new ContentSecond();
        SelectionSecond selectionSecond = this.selection;
        if (selectionSecond != null) {
            contentSecond.selection = selectionSecond.mo223809clone();
        }
        FillBlankSecond fillBlankSecond = this.fillBlank;
        if (fillBlankSecond != null) {
            contentSecond.fillBlank = fillBlankSecond.mo223809clone();
        }
        return contentSecond;
    }
