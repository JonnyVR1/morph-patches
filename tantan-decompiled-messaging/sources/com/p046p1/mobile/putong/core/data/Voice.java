...
public class Voice extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Voice> PROTOBUF_ADAPTER = new MessageNanoAdapter<Voice>() { // from class: com.p1.mobile.putong.core.data.Voice.1
        ...
        public int computeAndCacheSize(Voice voice) {
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, list, VoiceLiveTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Room room = voice.room;
            if (room != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, room, Room.PROTOBUF_ADAPTER);
            }
            voice.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Voice parse(nb5 nb5Var) throws IOException {
            Voice voice = new Voice();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (voice.f20531id == null) {
                        voice.f20531id = "";
                    }
                ...
                if (iM158752u == 10) {
                    voice.f20531id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    voice.userId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    voice.voiceRoomId = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    voice.liveAttributeTags = (List) nb5Var.m158743l(VoiceLiveTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 42) {
                        if (voice.f20531id == null) {
                            voice.f20531id = "";
                    ...
                    voice.room = (Room) nb5Var.m158743l(Room.PROTOBUF_ADAPTER);
                }
            }
            return voice;
        }
        ...
        public void serialize(Voice voice, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<VoiceLiveTag> list = voice.liveAttributeTags;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(4, list, VoiceLiveTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Room room = voice.room;
            if (room != null) {
                codedOutputByteBufferNano.m17254K(5, room, Room.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Voice voice, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "voiceRoomId":
                    ...
                    return true;
                case "id":
                    voice.f20531id = jsonParser.getValueAsString();
                    return false;
                case "room":
    ...
    public Voice mo223809clone() {
        Voice voice = new Voice();
        voice.f20531id = this.f20531id;
        ...
        if (list != null) {
            voice.liveAttributeTags = ValueObject.util_map(list, new w9j() { // from class: l.xam0
                ...
                public final Object call(Object obj) {
                    return ((VoiceLiveTag) obj).mo223809clone();
                }
            });
        }
        Room room = this.room;
        if (room != null) {
            voice.room = room.mo223809clone();
        }
        return voice;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20531id, voice.f20531id) && ValueObject.util_equals(this.userId, voice.userId) && ValueObject.util_equals(this.voiceRoomId, voice.voiceRoomId) && ValueObject.util_equals(this.liveAttributeTags, voice.liveAttributeTags) && ValueObject.util_equals(this.room, voice.room);
    }
