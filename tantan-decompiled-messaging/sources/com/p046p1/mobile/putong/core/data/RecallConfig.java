...
public class RecallConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RecallConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<RecallConfig>() { // from class: com.p1.mobile.putong.core.data.RecallConfig.1
        ...
        public int computeAndCacheSize(RecallConfig recallConfig) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, recallConfig.minutes) + CodedOutputByteBufferNano.m17220b(2, recallConfig.enable);
            recallConfig.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RecallConfig parse(nb5 nb5Var) throws IOException {
            RecallConfig recallConfig = new RecallConfig();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    recallConfig.minutes = nb5Var.m158741j();
                } else {
                    if (iM158752u != 16) {
                        return recallConfig;
                    }
                    recallConfig.enable = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(RecallConfig recallConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, recallConfig.minutes);
            codedOutputByteBufferNano.m17244A(2, recallConfig.enable);
        }
    };
    ...
    public RecallConfig mo223809clone() {
        RecallConfig recallConfig = new RecallConfig();
