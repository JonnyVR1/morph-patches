...
public class AuditPictureTag extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AuditPictureTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<AuditPictureTag>() { // from class: com.p1.mobile.putong.core.data.AuditPictureTag.1
        ...
        public int computeAndCacheSize(AuditPictureTag auditPictureTag) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, auditPictureTag.f20347id);
            ...
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(7, auditPictureTag.count);
            auditPictureTag.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AuditPictureTag parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    auditPictureTag.f20347id = nb5Var.m158741j();
                } else if (iM158752u == 18) {
                    auditPictureTag.name = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    auditPictureTag.categories = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 34) {
                    auditPictureTag.icon = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    auditPictureTag.operation = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    auditPictureTag.status = nb5Var.m158750s();
                } else {
                    if (iM158752u != 56) {
                        if (auditPictureTag.name == null) {
                            auditPictureTag.name = "";
                    ...
                    auditPictureTag.count = nb5Var.m158741j();
                }
            }
            return auditPictureTag;
        }
        ...
        public void serialize(AuditPictureTag auditPictureTag, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, auditPictureTag.f20347id);
            String str = auditPictureTag.name;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17250G(7, auditPictureTag.count);
        }
    };
    public static JsonAdapter<AuditPictureTag> JSON_ADAPTER = new ObjectJsonAdapter<AuditPictureTag>() { // from class: com.p1.mobile.putong.core.data.AuditPictureTag.2
        ...
        public boolean parseField(AuditPictureTag auditPictureTag, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "status":
                    ...
                    return true;
                case "id":
                    auditPictureTag.f20347id = jsonParser.getValueAsInt();
                    return false;
                case "icon":
        ...
        public void serializeFields(AuditPictureTag auditPictureTag, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", auditPictureTag.f20347id);
            String str = auditPictureTag.name;
            if (str != null) {
    ...
    public static /* synthetic */ String m35218a(String str) {
        return str;
    }
    ...
    public AuditPictureTag mo223809clone() {
        AuditPictureTag auditPictureTag = new AuditPictureTag();
        auditPictureTag.f20347id = this.f20347id;
        ...
        if (list != null) {
            auditPictureTag.categories = ValueObject.util_map(list, new w9j() { // from class: l.nd1
                ...
                public final Object call(Object obj) {
                    return AuditPictureTag.m35218a((String) obj);
                }
            });
        }
