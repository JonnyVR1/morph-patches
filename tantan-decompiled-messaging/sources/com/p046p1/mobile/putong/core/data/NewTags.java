...
public class NewTags extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NewTags> PROTOBUF_ADAPTER = new MessageNanoAdapter<NewTags>() { // from class: com.p1.mobile.putong.core.data.NewTags.1
        ...
        public int computeAndCacheSize(NewTags newTags) {
            ...
            int iM17228j = iM17233o + CodedOutputByteBufferNano.m17228j(7, newTags.localTagUserCounts) + CodedOutputByteBufferNano.m17220b(8, newTags.localIsCommonLabel);
            List<TagCategories> list2 = newTags.localTagCategories;
            if (list2 != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(9, list2, TagCategories.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str6 = newTags.localShowName;
            if (str6 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(10, str6);
            }
            String str7 = newTags.gender;
            if (str7 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(11, str7);
            }
            int iM17220b = iM17228j + CodedOutputByteBufferNano.m17220b(12, newTags.isPictureTag) + CodedOutputByteBufferNano.m17226h(13, newTags.index) + CodedOutputByteBufferNano.m17226h(14, newTags.loadIcon);
            String str8 = newTags.nameColor;
            if (str8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(15, str8);
            }
            String str9 = newTags.bgColor;
            if (str9 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(16, str9);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(17, newTags.localShowCreditScore);
            String str10 = newTags.localCreditScore;
            if (str10 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(18, str10);
            }
            newTags.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NewTags parse(nb5 nb5Var) throws IOException {
            NewTags newTags = new NewTags();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (newTags.f20457id == null) {
                            newTags.f20457id = "";
                        }
                        ...
                        break;
                    case 10:
                        newTags.f20457id = nb5Var.m158750s();
                        continue;
                    case 18:
                        newTags.name = nb5Var.m158750s();
                        continue;
                    case 26:
                        newTags.categories = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        newTags.icon = nb5Var.m158750s();
                        continue;
                    case 42:
                        newTags.operation = nb5Var.m158750s();
                        continue;
                    case 50:
                        newTags.status = nb5Var.m158750s();
                        continue;
                    case 56:
                        newTags.localTagUserCounts = nb5Var.m158742k();
                        continue;
                    case 64:
                        newTags.localIsCommonLabel = nb5Var.m158738g();
                        continue;
                    case 74:
                        newTags.localTagCategories = (List) nb5Var.m158743l(TagCategories.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        newTags.localShowName = nb5Var.m158750s();
                        continue;
                    case 90:
                        newTags.gender = nb5Var.m158750s();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        newTags.isPictureTag = nb5Var.m158738g();
                        continue;
                    case 104:
                        newTags.index = nb5Var.m158741j();
                        continue;
                    case 112:
                        newTags.loadIcon = nb5Var.m158741j();
                        continue;
                    case 122:
                        newTags.nameColor = nb5Var.m158750s();
                        continue;
                    case 130:
                        newTags.bgColor = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA /* 136 */:
                        newTags.localShowCreditScore = nb5Var.m158738g();
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        newTags.localCreditScore = nb5Var.m158750s();
                        continue;
                    default:
                        if (newTags.f20457id == null) {
                            newTags.f20457id = "";
        ...
        public void serialize(NewTags newTags, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(7, newTags.localTagUserCounts);
            codedOutputByteBufferNano.m17244A(8, newTags.localIsCommonLabel);
            List<TagCategories> list2 = newTags.localTagCategories;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(9, list2, TagCategories.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str6 = newTags.localShowName;
            if (str6 != null) {
            ...
            codedOutputByteBufferNano.m17244A(12, newTags.isPictureTag);
            codedOutputByteBufferNano.m17250G(13, newTags.index);
            codedOutputByteBufferNano.m17250G(14, newTags.loadIcon);
            String str8 = newTags.nameColor;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(15, str8);
            }
            String str9 = newTags.bgColor;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(16, str9);
            }
            codedOutputByteBufferNano.m17244A(17, newTags.localShowCreditScore);
            String str10 = newTags.localCreditScore;
            if (str10 != null) {
                codedOutputByteBufferNano.m17261R(18, str10);
            }
        }
    };
        ...
        public boolean parseField(NewTags newTags, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 4:
                    ...
                    return true;
                case 5:
                    newTags.f20457id = jsonParser.getValueAsString();
                    return false;
                case 6:
    ...
    public static /* synthetic */ String m35720b(String str) {
        return str;
    }
    ...
    public NewTags mo223809clone() {
        NewTags newTags = new NewTags();
        newTags.f20457id = this.f20457id;
        ...
        if (list != null) {
            newTags.categories = ValueObject.util_map(list, new w9j() { // from class: l.ha40
                ...
                public final Object call(Object obj) {
                    return NewTags.m35720b((String) obj);
                }
            });
        }
