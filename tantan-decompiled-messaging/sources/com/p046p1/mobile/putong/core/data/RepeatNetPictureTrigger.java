...
public class RepeatNetPictureTrigger extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RepeatNetPictureTrigger> PROTOBUF_ADAPTER = new MessageNanoAdapter<RepeatNetPictureTrigger>() { // from class: com.p1.mobile.putong.core.data.RepeatNetPictureTrigger.1
        ...
        public int computeAndCacheSize(RepeatNetPictureTrigger repeatNetPictureTrigger) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, repeatNetPictureTrigger.repeatPictureFrequency) + CodedOutputByteBufferNano.m17226h(2, repeatNetPictureTrigger.netPictureFrequency) + CodedOutputByteBufferNano.m17226h(3, repeatNetPictureTrigger.totalFrequency) + CodedOutputByteBufferNano.m17226h(4, repeatNetPictureTrigger.netPictureSwipeLimit) + CodedOutputByteBufferNano.m17226h(5, repeatNetPictureTrigger.cardFeedBackViewLimit) + CodedOutputByteBufferNano.m17220b(6, repeatNetPictureTrigger.showFeedbackInDefaultCard) + CodedOutputByteBufferNano.m17226h(7, repeatNetPictureTrigger.aiPictureFrequency);
            repeatNetPictureTrigger.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RepeatNetPictureTrigger parse(nb5 nb5Var) throws IOException {
            RepeatNetPictureTrigger repeatNetPictureTrigger = new RepeatNetPictureTrigger();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    repeatNetPictureTrigger.repeatPictureFrequency = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    repeatNetPictureTrigger.netPictureFrequency = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    repeatNetPictureTrigger.totalFrequency = nb5Var.m158741j();
                } else if (iM158752u == 32) {
                    repeatNetPictureTrigger.netPictureSwipeLimit = nb5Var.m158741j();
                } else if (iM158752u == 40) {
                    repeatNetPictureTrigger.cardFeedBackViewLimit = nb5Var.m158741j();
                } else if (iM158752u == 48) {
                    repeatNetPictureTrigger.showFeedbackInDefaultCard = nb5Var.m158738g();
                } else {
                    if (iM158752u != 56) {
                        return repeatNetPictureTrigger;
                    }
                    repeatNetPictureTrigger.aiPictureFrequency = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(RepeatNetPictureTrigger repeatNetPictureTrigger, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, repeatNetPictureTrigger.repeatPictureFrequency);
            codedOutputByteBufferNano.m17250G(2, repeatNetPictureTrigger.netPictureFrequency);
            codedOutputByteBufferNano.m17250G(3, repeatNetPictureTrigger.totalFrequency);
            codedOutputByteBufferNano.m17250G(4, repeatNetPictureTrigger.netPictureSwipeLimit);
            codedOutputByteBufferNano.m17250G(5, repeatNetPictureTrigger.cardFeedBackViewLimit);
            codedOutputByteBufferNano.m17244A(6, repeatNetPictureTrigger.showFeedbackInDefaultCard);
            codedOutputByteBufferNano.m17250G(7, repeatNetPictureTrigger.aiPictureFrequency);
        }
    };
    ...
    public RepeatNetPictureTrigger mo223809clone() {
        RepeatNetPictureTrigger repeatNetPictureTrigger = new RepeatNetPictureTrigger();
