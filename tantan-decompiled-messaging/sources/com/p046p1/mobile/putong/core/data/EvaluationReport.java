...
public class EvaluationReport extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<EvaluationReport> PROTOBUF_ADAPTER = new MessageNanoAdapter<EvaluationReport>() { // from class: com.p1.mobile.putong.core.data.EvaluationReport.1
        ...
        public int computeAndCacheSize(EvaluationReport evaluationReport) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, evaluationReport.f20389id) + CodedOutputByteBufferNano.m17228j(2, evaluationReport.evaluationId) + CodedOutputByteBufferNano.m17220b(3, evaluationReport.completed) + CodedOutputByteBufferNano.m17228j(4, evaluationReport.type);
            ...
            if (str2 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(6, str2);
            }
            String str3 = evaluationReport.pictureUrl;
            if (str3 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(7, str3);
            }
            ...
            int iM17226h = iM17228j + CodedOutputByteBufferNano.m17226h(10, evaluationReport.coinPrice) + CodedOutputByteBufferNano.m17226h(11, evaluationReport.scaleType) + CodedOutputByteBufferNano.m17228j(12, evaluationReport.reportTime);
            evaluationReport.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public EvaluationReport parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        evaluationReport.f20389id = nb5Var.m158742k();
                        continue;
                    case 16:
                        evaluationReport.evaluationId = nb5Var.m158742k();
                        continue;
                    case 24:
                        evaluationReport.completed = nb5Var.m158738g();
                        continue;
                    case 32:
                        evaluationReport.type = nb5Var.m158742k();
                        continue;
                    case 42:
                        evaluationReport.name = nb5Var.m158750s();
                        continue;
                    case 50:
                        evaluationReport.description = nb5Var.m158750s();
                        continue;
                    case 58:
                        evaluationReport.pictureUrl = nb5Var.m158750s();
                        continue;
                    case 66:
                        evaluationReport.reportUrl = nb5Var.m158750s();
                        continue;
                    case 74:
                        evaluationReport.detailUrl = nb5Var.m158750s();
                        continue;
                    case 80:
                        evaluationReport.coinPrice = nb5Var.m158741j();
                        continue;
                    case 88:
                        evaluationReport.scaleType = nb5Var.m158741j();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        evaluationReport.reportTime = nb5Var.m158742k();
                        continue;
                    default:
                        if (evaluationReport.name == null) {
                            evaluationReport.name = "";
        ...
        public void serialize(EvaluationReport evaluationReport, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, evaluationReport.f20389id);
            codedOutputByteBufferNano.m17252I(2, evaluationReport.evaluationId);
            codedOutputByteBufferNano.m17244A(3, evaluationReport.completed);
            codedOutputByteBufferNano.m17252I(4, evaluationReport.type);
            String str = evaluationReport.name;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17250G(10, evaluationReport.coinPrice);
            codedOutputByteBufferNano.m17250G(11, evaluationReport.scaleType);
            codedOutputByteBufferNano.m17252I(12, evaluationReport.reportTime);
        }
    };
    public static JsonAdapter<EvaluationReport> JSON_ADAPTER = new ObjectJsonAdapter<EvaluationReport>() { // from class: com.p1.mobile.putong.core.data.EvaluationReport.2
        ...
        public boolean parseField(EvaluationReport evaluationReport, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "reportUrl":
                    ...
                    return true;
                case "id":
                    evaluationReport.f20389id = jsonParser.getValueAsLong();
                    return false;
                case "name":
        ...
        public void serializeFields(EvaluationReport evaluationReport, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", evaluationReport.f20389id);
    ...
    public EvaluationReport mo223809clone() {
        EvaluationReport evaluationReport = new EvaluationReport();
        evaluationReport.f20389id = this.f20389id;
    ...
    public boolean equals(Object obj) {
        ...
        return this.f20389id == evaluationReport.f20389id && this.evaluationId == evaluationReport.evaluationId && this.completed == evaluationReport.completed && this.type == evaluationReport.type && ValueObject.util_equals(this.name, evaluationReport.name) && ValueObject.util_equals(this.description, evaluationReport.description) && ValueObject.util_equals(this.pictureUrl, evaluationReport.pictureUrl) && ValueObject.util_equals(this.reportUrl, evaluationReport.reportUrl) && ValueObject.util_equals(this.detailUrl, evaluationReport.detailUrl) && this.coinPrice == evaluationReport.coinPrice && this.scaleType == evaluationReport.scaleType && this.reportTime == evaluationReport.reportTime;
    }
