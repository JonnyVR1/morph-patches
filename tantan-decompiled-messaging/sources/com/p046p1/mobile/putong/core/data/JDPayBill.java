...
public class JDPayBill extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<JDPayBill> PROTOBUF_ADAPTER = new MessageNanoAdapter<JDPayBill>() { // from class: com.p1.mobile.putong.core.data.JDPayBill.1
        ...
        public int computeAndCacheSize(JDPayBill jDPayBill) {
            ...
            jDPayBill.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public JDPayBill parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    jDPayBill.appId = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    jDPayBill.sign = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    jDPayBill.merchant = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    jDPayBill.orderId = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    jDPayBill.jingdongMD5 = nb5Var.m158750s();
                } else {
                    if (iM158752u != 50) {
                        if (jDPayBill.appId == null) {
                            jDPayBill.appId = "";
                    ...
                    jDPayBill.signData = nb5Var.m158750s();
                }
            }
            return jDPayBill;
        }
    ...
    public JDPayBill mo223809clone() {
        JDPayBill jDPayBill = new JDPayBill();
