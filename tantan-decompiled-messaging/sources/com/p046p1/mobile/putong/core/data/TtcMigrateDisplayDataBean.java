...
public class TtcMigrateDisplayDataBean extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TtcMigrateDisplayDataBean> PROTOBUF_ADAPTER = new MessageNanoAdapter<TtcMigrateDisplayDataBean>() { // from class: com.p1.mobile.putong.core.data.TtcMigrateDisplayDataBean.1
        ...
        public int computeAndCacheSize(TtcMigrateDisplayDataBean ttcMigrateDisplayDataBean) {
            ...
            int iM17230l = ttcMigrateDisplayData != null ? CodedOutputByteBufferNano.m17230l(1, ttcMigrateDisplayData, TtcMigrateDisplayData.PROTOBUF_ADAPTER) : 0;
            Meta meta = ttcMigrateDisplayDataBean.meta;
            if (meta != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, meta, Meta.PROTOBUF_ADAPTER);
            }
            ttcMigrateDisplayDataBean.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TtcMigrateDisplayDataBean parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    ttcMigrateDisplayDataBean.data = (TtcMigrateDisplayData) nb5Var.m158743l(TtcMigrateDisplayData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (ttcMigrateDisplayDataBean.meta == null) {
                            ttcMigrateDisplayDataBean.meta = Meta.new_();
                    ...
                    ttcMigrateDisplayDataBean.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                }
            }
            return ttcMigrateDisplayDataBean;
        }
        ...
        public void serialize(TtcMigrateDisplayDataBean ttcMigrateDisplayDataBean, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (ttcMigrateDisplayData != null) {
                codedOutputByteBufferNano.m17254K(1, ttcMigrateDisplayData, TtcMigrateDisplayData.PROTOBUF_ADAPTER);
            }
            Meta meta = ttcMigrateDisplayDataBean.meta;
            if (meta != null) {
                codedOutputByteBufferNano.m17254K(2, meta, Meta.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public TtcMigrateDisplayDataBean mo223809clone() {
        TtcMigrateDisplayDataBean ttcMigrateDisplayDataBean = new TtcMigrateDisplayDataBean();
        Meta meta = this.meta;
        if (meta != null) {
            ttcMigrateDisplayDataBean.meta = meta.mo223809clone();
        }
        TtcMigrateDisplayData ttcMigrateDisplayData = this.data;
        if (ttcMigrateDisplayData != null) {
            ttcMigrateDisplayDataBean.data = ttcMigrateDisplayData.mo223809clone();
        }
        return ttcMigrateDisplayDataBean;
    }
