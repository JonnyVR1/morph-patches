...
public class VerifyPremiumIsolationConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerifyPremiumIsolationConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerifyPremiumIsolationConfig>() { // from class: com.p1.mobile.putong.core.data.VerifyPremiumIsolationConfig.1
        ...
        public int computeAndCacheSize(VerifyPremiumIsolationConfig verifyPremiumIsolationConfig) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, verifyPremiumIsolationConfig.restrict_non_verified_received_likes) + CodedOutputByteBufferNano.m17226h(2, verifyPremiumIsolationConfig.non_verified_received_likes_limit) + CodedOutputByteBufferNano.m17220b(3, verifyPremiumIsolationConfig.restrict_non_verified_matches_backend) + CodedOutputByteBufferNano.m17220b(4, verifyPremiumIsolationConfig.restrict_non_verified_matches) + CodedOutputByteBufferNano.m17226h(5, verifyPremiumIsolationConfig.non_verified_matches_limit);
            ...
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(7, str);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(8, verifyPremiumIsolationConfig.restrict_non_verified_common);
            verifyPremiumIsolationConfig.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerifyPremiumIsolationConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    verifyPremiumIsolationConfig.restrict_non_verified_received_likes = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    verifyPremiumIsolationConfig.non_verified_received_likes_limit = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    verifyPremiumIsolationConfig.restrict_non_verified_matches_backend = nb5Var.m158738g();
                } else if (iM158752u == 32) {
                    verifyPremiumIsolationConfig.restrict_non_verified_matches = nb5Var.m158738g();
                } else if (iM158752u == 40) {
                    verifyPremiumIsolationConfig.non_verified_matches_limit = nb5Var.m158741j();
                } else if (iM158752u == 50) {
                    verifyPremiumIsolationConfig.restrict_banner_texts = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 58) {
                    verifyPremiumIsolationConfig.restrict_banner_button = nb5Var.m158750s();
                } else {
                    if (iM158752u != 64) {
                        if (verifyPremiumIsolationConfig.restrict_banner_texts == null) {
                            verifyPremiumIsolationConfig.restrict_banner_texts = new ArrayList();
                    ...
                    verifyPremiumIsolationConfig.restrict_non_verified_common = nb5Var.m158738g();
                }
            }
            return verifyPremiumIsolationConfig;
        }
        ...
        public void serialize(VerifyPremiumIsolationConfig verifyPremiumIsolationConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, verifyPremiumIsolationConfig.restrict_non_verified_received_likes);
            codedOutputByteBufferNano.m17250G(2, verifyPremiumIsolationConfig.non_verified_received_likes_limit);
            codedOutputByteBufferNano.m17244A(3, verifyPremiumIsolationConfig.restrict_non_verified_matches_backend);
            codedOutputByteBufferNano.m17244A(4, verifyPremiumIsolationConfig.restrict_non_verified_matches);
            codedOutputByteBufferNano.m17250G(5, verifyPremiumIsolationConfig.non_verified_matches_limit);
            List<String> list = verifyPremiumIsolationConfig.restrict_banner_texts;
            if (list != null) {
            ...
            codedOutputByteBufferNano.m17244A(8, verifyPremiumIsolationConfig.restrict_non_verified_common);
        }
    };
    ...
    public static /* synthetic */ String m35901a(String str) {
        return str;
    }
    ...
    public VerifyPremiumIsolationConfig mo223809clone() {
        VerifyPremiumIsolationConfig verifyPremiumIsolationConfig = new VerifyPremiumIsolationConfig();
        ...
        if (list != null) {
            verifyPremiumIsolationConfig.restrict_banner_texts = ValueObject.util_map(list, new w9j() { // from class: l.g0l0
                ...
                public final Object call(Object obj) {
                    return VerifyPremiumIsolationConfig.m35901a((String) obj);
                }
            });
        }
