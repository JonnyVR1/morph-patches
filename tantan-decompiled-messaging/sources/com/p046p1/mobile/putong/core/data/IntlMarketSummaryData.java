...
public class IntlMarketSummaryData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlMarketSummaryData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlMarketSummaryData>() { // from class: com.p1.mobile.putong.core.data.IntlMarketSummaryData.1
        ...
        public int computeAndCacheSize(IntlMarketSummaryData intlMarketSummaryData) {
            ...
            if (str13 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(13, str13);
            }
            String str14 = intlMarketSummaryData.selected_circle_color;
            if (str14 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(14, str14);
            }
            String str15 = intlMarketSummaryData.unselected_circle_color;
            if (str15 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(15, str15);
            }
            ...
            if (intlMarketTransitSummaryData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(16, intlMarketTransitSummaryData, IntlMarketTransitSummaryData.PROTOBUF_ADAPTER);
            }
            intlMarketSummaryData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlMarketSummaryData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        intlMarketSummaryData.bg_color = nb5Var.m158750s();
                        continue;
                    case 18:
                        intlMarketSummaryData.bg_url = nb5Var.m158750s();
                        continue;
                    case 26:
                        intlMarketSummaryData.main_title = nb5Var.m158750s();
                        continue;
                    case 34:
                        intlMarketSummaryData.main_title_font_color = nb5Var.m158750s();
                        continue;
                    case 42:
                        intlMarketSummaryData.sub_title = nb5Var.m158750s();
                        continue;
                    case 50:
                        intlMarketSummaryData.sub_title_font_color = nb5Var.m158750s();
                        continue;
                    case 58:
                        intlMarketSummaryData.confirm_btn_color = nb5Var.m158750s();
                        continue;
                    case 66:
                        intlMarketSummaryData.confirm_btn_desc = nb5Var.m158750s();
                        continue;
                    case 74:
                        intlMarketSummaryData.confirm_btn_font_color = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        intlMarketSummaryData.confirm_btn_bg_url = nb5Var.m158750s();
                        continue;
                    case 90:
                        intlMarketSummaryData.logo_url = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        intlMarketSummaryData.sub_confirm_button_desc = nb5Var.m158750s();
                        continue;
                    case 106:
                        intlMarketSummaryData.sub_confirm_button_font_color = nb5Var.m158750s();
                        continue;
                    case 114:
                        intlMarketSummaryData.selected_circle_color = nb5Var.m158750s();
                        continue;
                    case 122:
                        intlMarketSummaryData.unselected_circle_color = nb5Var.m158750s();
                        continue;
                    case 130:
                        intlMarketSummaryData.transit_summary = (IntlMarketTransitSummaryData) nb5Var.m158743l(IntlMarketTransitSummaryData.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (intlMarketSummaryData.bg_color == null) {
                            intlMarketSummaryData.bg_color = "";
        ...
        public void serialize(IntlMarketSummaryData intlMarketSummaryData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            String str13 = intlMarketSummaryData.sub_confirm_button_font_color;
            if (str13 != null) {
                codedOutputByteBufferNano.m17261R(13, str13);
            }
            String str14 = intlMarketSummaryData.selected_circle_color;
            if (str14 != null) {
                codedOutputByteBufferNano.m17261R(14, str14);
            }
            String str15 = intlMarketSummaryData.unselected_circle_color;
            if (str15 != null) {
                codedOutputByteBufferNano.m17261R(15, str15);
            }
            IntlMarketTransitSummaryData intlMarketTransitSummaryData = intlMarketSummaryData.transit_summary;
            if (intlMarketTransitSummaryData != null) {
                codedOutputByteBufferNano.m17254K(16, intlMarketTransitSummaryData, IntlMarketTransitSummaryData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public IntlMarketSummaryData mo223809clone() {
        IntlMarketSummaryData intlMarketSummaryData = new IntlMarketSummaryData();
        ...
        if (intlMarketTransitSummaryData != null) {
            intlMarketSummaryData.transit_summary = intlMarketTransitSummaryData.mo223809clone();
        }
        return intlMarketSummaryData;
    }
