...
public class ReSwipeConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ReSwipeConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<ReSwipeConfig>() { // from class: com.p1.mobile.putong.core.data.ReSwipeConfig.1
        ...
        public int computeAndCacheSize(ReSwipeConfig reSwipeConfig) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, reSwipeConfig.maxLabelCount) + CodedOutputByteBufferNano.m17226h(2, reSwipeConfig.showHours) + CodedOutputByteBufferNano.m17220b(3, reSwipeConfig.enable);
            String str = reSwipeConfig.expType;
            if (str != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(4, str);
            }
            reSwipeConfig.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ReSwipeConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    reSwipeConfig.maxLabelCount = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    reSwipeConfig.showHours = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    reSwipeConfig.enable = nb5Var.m158738g();
                } else {
                    if (iM158752u != 34) {
                        if (reSwipeConfig.expType != null) {
                            break;
                    ...
                    reSwipeConfig.expType = nb5Var.m158750s();
                }
            }
            return reSwipeConfig;
        }
        ...
        public void serialize(ReSwipeConfig reSwipeConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, reSwipeConfig.maxLabelCount);
            codedOutputByteBufferNano.m17250G(2, reSwipeConfig.showHours);
            codedOutputByteBufferNano.m17244A(3, reSwipeConfig.enable);
            String str = reSwipeConfig.expType;
            if (str != null) {
    ...
    public ReSwipeConfig mo223809clone() {
        ReSwipeConfig reSwipeConfig = new ReSwipeConfig();
