...
public class VisitorFilterSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VisitorFilterSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<VisitorFilterSettings>() { // from class: com.p1.mobile.putong.core.data.VisitorFilterSettings.1
        ...
        public int computeAndCacheSize(VisitorFilterSettings visitorFilterSettings) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, visitorFilterSettings.distance) + CodedOutputByteBufferNano.m17226h(2, visitorFilterSettings.minAge) + CodedOutputByteBufferNano.m17226h(3, visitorFilterSettings.maxAge);
            VisitorFilterType visitorFilterType = visitorFilterSettings.filter;
            if (visitorFilterType != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, visitorFilterType, VisitorFilterType.PROTOBUF_ADAPTER);
            }
            VisitorSortType visitorSortType = visitorFilterSettings.sort;
            if (visitorSortType != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(5, visitorSortType, VisitorSortType.PROTOBUF_ADAPTER);
            }
            visitorFilterSettings.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VisitorFilterSettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    visitorFilterSettings.distance = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    visitorFilterSettings.minAge = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    visitorFilterSettings.maxAge = nb5Var.m158741j();
                } else if (iM158752u == 34) {
                    visitorFilterSettings.filter = (VisitorFilterType) nb5Var.m158743l(VisitorFilterType.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 42) {
                        if (visitorFilterSettings.filter == null) {
                            visitorFilterSettings.filter = (VisitorFilterType) VisitorFilterType.JSON_ADAPTER.defaultEnum();
                    ...
                    visitorFilterSettings.sort = (VisitorSortType) nb5Var.m158743l(VisitorSortType.PROTOBUF_ADAPTER);
                }
            }
            return visitorFilterSettings;
        }
        ...
        public void serialize(VisitorFilterSettings visitorFilterSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, visitorFilterSettings.distance);
            codedOutputByteBufferNano.m17250G(2, visitorFilterSettings.minAge);
            codedOutputByteBufferNano.m17250G(3, visitorFilterSettings.maxAge);
            VisitorFilterType visitorFilterType = visitorFilterSettings.filter;
            if (visitorFilterType != null) {
                codedOutputByteBufferNano.m17254K(4, visitorFilterType, VisitorFilterType.PROTOBUF_ADAPTER);
            }
            VisitorSortType visitorSortType = visitorFilterSettings.sort;
            if (visitorSortType != null) {
                codedOutputByteBufferNano.m17254K(5, visitorSortType, VisitorSortType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public VisitorFilterSettings mo223809clone() {
        VisitorFilterSettings visitorFilterSettings = new VisitorFilterSettings();
