...
public class AssetsTbh extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AssetsTbh> PROTOBUF_ADAPTER = new MessageNanoAdapter<AssetsTbh>() { // from class: com.p1.mobile.putong.core.data.AssetsTbh.1
        ...
        public int computeAndCacheSize(AssetsTbh assetsTbh) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, assetsTbh.frequency) + CodedOutputByteBufferNano.m17226h(2, assetsTbh.afterSwipes) + CodedOutputByteBufferNano.m17226h(3, assetsTbh.maxIgnoreTimes);
            assetsTbh.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AssetsTbh parse(nb5 nb5Var) throws IOException {
            AssetsTbh assetsTbh = new AssetsTbh();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    assetsTbh.frequency = nb5Var.m158742k();
                } else if (iM158752u == 16) {
                    assetsTbh.afterSwipes = nb5Var.m158741j();
                } else {
                    if (iM158752u != 24) {
                        return assetsTbh;
                    }
                    assetsTbh.maxIgnoreTimes = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(AssetsTbh assetsTbh, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, assetsTbh.frequency);
            codedOutputByteBufferNano.m17250G(2, assetsTbh.afterSwipes);
            codedOutputByteBufferNano.m17250G(3, assetsTbh.maxIgnoreTimes);
        }
    };
    ...
    public AssetsTbh mo223809clone() {
        AssetsTbh assetsTbh = new AssetsTbh();
