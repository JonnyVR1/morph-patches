...
public class QuickChatBubble extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuickChatBubble> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuickChatBubble>() { // from class: com.p1.mobile.putong.core.data.QuickChatBubble.1
        ...
        public int computeAndCacheSize(QuickChatBubble quickChatBubble) {
            ...
            if (relationshipStatus != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, relationshipStatus, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            quickChatBubble.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuickChatBubble parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    quickChatBubble.biz = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    quickChatBubble.stage = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    quickChatBubble.type = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (quickChatBubble.biz == null) {
                            quickChatBubble.biz = "";
                    ...
                    quickChatBubble.rsStateReceiverToSender = (RelationshipStatus) nb5Var.m158743l(RelationshipStatus.PROTOBUF_ADAPTER);
                }
            }
            return quickChatBubble;
        }
    ...
    public QuickChatBubble mo223809clone() {
        QuickChatBubble quickChatBubble = new QuickChatBubble();
