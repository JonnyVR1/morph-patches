...
public class GroupCreationLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GroupCreationLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<GroupCreationLimit>() { // from class: com.p1.mobile.putong.core.data.GroupCreationLimit.1
        ...
        public int computeAndCacheSize(GroupCreationLimit groupCreationLimit) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, groupCreationLimit.groupRemaining) + CodedOutputByteBufferNano.m17226h(3, groupCreationLimit.memberLimit);
            groupCreationLimit.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GroupCreationLimit parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    groupCreationLimit.value = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    groupCreationLimit.groupRemaining = nb5Var.m158741j();
                } else {
                    if (iM158752u != 24) {
                        if (groupCreationLimit.value != null) {
                            break;
                    ...
                    groupCreationLimit.memberLimit = nb5Var.m158741j();
                }
            }
            return groupCreationLimit;
        }
        ...
        public void serialize(GroupCreationLimit groupCreationLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, groupCreationLimit.groupRemaining);
            codedOutputByteBufferNano.m17250G(3, groupCreationLimit.memberLimit);
        }
    };
    ...
    public GroupCreationLimit mo223809clone() {
        GroupCreationLimit groupCreationLimit = new GroupCreationLimit();
