...
public class Bubbles extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Bubbles> PROTOBUF_ADAPTER = new MessageNanoAdapter<Bubbles>() { // from class: com.p1.mobile.putong.core.data.Bubbles.1
        ...
        public int computeAndCacheSize(Bubbles bubbles) {
            Ref ref = bubbles.ref;
            int iM17230l = ref != null ? CodedOutputByteBufferNano.m17230l(1, ref, Ref.PROTOBUF_ADAPTER) : 0;
            String str = bubbles.type;
            if (str != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(2, str);
            }
            String str2 = bubbles.f20356id;
            if (str2 != null) {
            ...
            if (str6 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(7, str6);
            }
            QuickChatBubble quickChatBubble = bubbles.quickChat;
            if (quickChatBubble != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(8, quickChatBubble, QuickChatBubble.PROTOBUF_ADAPTER);
            }
            ChatRoomBubble chatRoomBubble = bubbles.chatRoom;
            if (chatRoomBubble != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(9, chatRoomBubble, ChatRoomBubble.PROTOBUF_ADAPTER);
            }
            bubbles.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Bubbles parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    bubbles.ref = (Ref) nb5Var.m158743l(Ref.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    bubbles.type = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    bubbles.f20356id = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    bubbles.tracker = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    bubbles.userID = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    bubbles.content = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    bubbles.photoURL = nb5Var.m158750s();
                } else if (iM158752u == 66) {
                    bubbles.quickChat = (QuickChatBubble) nb5Var.m158743l(QuickChatBubble.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 74) {
                        if (bubbles.type == null) {
                            bubbles.type = "";
                    ...
                    bubbles.chatRoom = (ChatRoomBubble) nb5Var.m158743l(ChatRoomBubble.PROTOBUF_ADAPTER);
                }
            }
            return bubbles;
        }
        ...
        public void serialize(Bubbles bubbles, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            Ref ref = bubbles.ref;
            if (ref != null) {
                codedOutputByteBufferNano.m17254K(1, ref, Ref.PROTOBUF_ADAPTER);
            }
            String str = bubbles.type;
            if (str != null) {
            ...
            QuickChatBubble quickChatBubble = bubbles.quickChat;
            if (quickChatBubble != null) {
                codedOutputByteBufferNano.m17254K(8, quickChatBubble, QuickChatBubble.PROTOBUF_ADAPTER);
            }
            ChatRoomBubble chatRoomBubble = bubbles.chatRoom;
            if (chatRoomBubble != null) {
                codedOutputByteBufferNano.m17254K(9, chatRoomBubble, ChatRoomBubble.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Bubbles bubbles, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userID":
                    ...
                    return true;
                case "id":
                    bubbles.f20356id = jsonParser.getValueAsString();
                    return false;
                case "ref":
    ...
    public Bubbles mo223809clone() {
        Bubbles bubbles = new Bubbles();
        bubbles.type = this.type;
        Ref ref = this.ref;
        if (ref != null) {
            bubbles.ref = ref.mo223809clone();
        }
        bubbles.f20356id = this.f20356id;
        ...
        if (quickChatBubble != null) {
            bubbles.quickChat = quickChatBubble.mo223809clone();
        }
        ChatRoomBubble chatRoomBubble = this.chatRoom;
        if (chatRoomBubble != null) {
            bubbles.chatRoom = chatRoomBubble.mo223809clone();
        }
        return bubbles;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.type, bubbles.type) && ValueObject.util_equals(this.ref, bubbles.ref) && ValueObject.util_equals(this.f20356id, bubbles.f20356id) && ValueObject.util_equals(this.tracker, bubbles.tracker) && ValueObject.util_equals(this.userID, bubbles.userID) && ValueObject.util_equals(this.photoURL, bubbles.photoURL) && ValueObject.util_equals(this.content, bubbles.content) && ValueObject.util_equals(this.quickChat, bubbles.quickChat) && ValueObject.util_equals(this.chatRoom, bubbles.chatRoom);
    }
