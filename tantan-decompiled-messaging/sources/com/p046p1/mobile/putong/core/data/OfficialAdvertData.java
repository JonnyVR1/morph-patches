...
public class OfficialAdvertData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OfficialAdvertData> PROTOBUF_ADAPTER = new MessageNanoAdapter<OfficialAdvertData>() { // from class: com.p1.mobile.putong.core.data.OfficialAdvertData.1
        ...
        public int computeAndCacheSize(OfficialAdvertData officialAdvertData) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, officialAdvertData.advertType);
            ...
            officialAdvertData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OfficialAdvertData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    officialAdvertData.advertId = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    officialAdvertData.advertType = nb5Var.m158741j();
                } else if (iM158752u == 26) {
                    officialAdvertData.advertLogo = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    officialAdvertData.titleText = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    officialAdvertData.desc = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    officialAdvertData.advertPic = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    officialAdvertData.buttonText = nb5Var.m158750s();
                } else {
                    if (iM158752u != 66) {
                        if (officialAdvertData.advertId == null) {
                            officialAdvertData.advertId = "";
                    ...
                    officialAdvertData.buttonUrl = nb5Var.m158750s();
                }
            }
            return officialAdvertData;
        }
        ...
        public void serialize(OfficialAdvertData officialAdvertData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, officialAdvertData.advertType);
            String str2 = officialAdvertData.advertLogo;
            if (str2 != null) {
    ...
    public OfficialAdvertData mo223809clone() {
        OfficialAdvertData officialAdvertData = new OfficialAdvertData();
