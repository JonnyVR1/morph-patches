...
public class NativeConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NativeConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<NativeConfig>() { // from class: com.p1.mobile.putong.core.data.NativeConfig.1
        ...
        public int computeAndCacheSize(NativeConfig nativeConfig) {
            ...
            nativeConfig.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NativeConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    nativeConfig.platform = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    nativeConfig.payType = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    nativeConfig.redirectType = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    nativeConfig.currencyCode = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    nativeConfig.btnDesc = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    nativeConfig.btnBgColor = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    nativeConfig.defaultQueryType = nb5Var.m158750s();
                } else {
                    if (iM158752u != 66) {
                        if (nativeConfig.platform == null) {
                            nativeConfig.platform = "";
                    ...
                    nativeConfig.btnTextColor = nb5Var.m158750s();
                }
            }
            return nativeConfig;
        }
    ...
    public NativeConfig mo223809clone() {
        NativeConfig nativeConfig = new NativeConfig();
