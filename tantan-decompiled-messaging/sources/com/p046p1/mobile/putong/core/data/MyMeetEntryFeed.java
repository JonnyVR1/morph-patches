...
public class MyMeetEntryFeed extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MyMeetEntryFeed> PROTOBUF_ADAPTER = new MessageNanoAdapter<MyMeetEntryFeed>() { // from class: com.p1.mobile.putong.core.data.MyMeetEntryFeed.1
        ...
        public int computeAndCacheSize(MyMeetEntryFeed myMeetEntryFeed) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, myMeetEntryFeed.newCount);
            ...
            if (feedType != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(3, feedType, FeedType.PROTOBUF_ADAPTER);
            }
            String str = myMeetEntryFeed.momentText;
            if (str != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(4, str);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(5, myMeetEntryFeed.highPopSeeCount);
            String str2 = myMeetEntryFeed.subText;
            if (str2 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(6, str2);
            }
            String str3 = myMeetEntryFeed.publishTime;
            if (str3 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(7, str3);
            }
            String str4 = myMeetEntryFeed.sortId;
            if (str4 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(8, str4);
            }
            String str5 = myMeetEntryFeed.f20452id;
            if (str5 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(9, str5);
            }
            LiveType liveType = myMeetEntryFeed.liveType;
            if (liveType != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(10, liveType, LiveType.PROTOBUF_ADAPTER);
            }
            MeetRelation meetRelation = myMeetEntryFeed.relation;
            if (meetRelation != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(11, meetRelation, MeetRelation.PROTOBUF_ADAPTER);
            }
            int iM17228j = iM17226h2 + CodedOutputByteBufferNano.m17228j(12, myMeetEntryFeed.publishTimestamp);
            myMeetEntryFeed.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MyMeetEntryFeed parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        if (myMeetEntryFeed.f20452id == null) {
                            myMeetEntryFeed.f20452id = "";
                        }
                        ...
                        break;
                    case 8:
                        myMeetEntryFeed.newCount = nb5Var.m158741j();
                        continue;
                    case 18:
                        myMeetEntryFeed.userIds = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 26:
                        myMeetEntryFeed.feedType = (FeedType) nb5Var.m158743l(FeedType.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        myMeetEntryFeed.momentText = nb5Var.m158750s();
                        continue;
                    case 40:
                        myMeetEntryFeed.highPopSeeCount = nb5Var.m158741j();
                        continue;
                    case 50:
                        myMeetEntryFeed.subText = nb5Var.m158750s();
                        continue;
                    case 58:
                        myMeetEntryFeed.publishTime = nb5Var.m158750s();
                        continue;
                    case 66:
                        myMeetEntryFeed.sortId = nb5Var.m158750s();
                        continue;
                    case 74:
                        myMeetEntryFeed.f20452id = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        myMeetEntryFeed.liveType = (LiveType) nb5Var.m158743l(LiveType.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        myMeetEntryFeed.relation = (MeetRelation) nb5Var.m158743l(MeetRelation.PROTOBUF_ADAPTER);
                        continue;
                    case Opcodes.IADD /* 96 */:
                        myMeetEntryFeed.publishTimestamp = nb5Var.m158742k();
                        continue;
                    default:
                        if (myMeetEntryFeed.userIds == null) {
                            myMeetEntryFeed.userIds = new ArrayList();
        ...
        public void serialize(MyMeetEntryFeed myMeetEntryFeed, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, myMeetEntryFeed.newCount);
            List<String> list = myMeetEntryFeed.userIds;
            if (list != null) {
            ...
            FeedType feedType = myMeetEntryFeed.feedType;
            if (feedType != null) {
                codedOutputByteBufferNano.m17254K(3, feedType, FeedType.PROTOBUF_ADAPTER);
            }
            String str = myMeetEntryFeed.momentText;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(4, str);
            }
            codedOutputByteBufferNano.m17250G(5, myMeetEntryFeed.highPopSeeCount);
            String str2 = myMeetEntryFeed.subText;
            if (str2 != null) {
            ...
            LiveType liveType = myMeetEntryFeed.liveType;
            if (liveType != null) {
                codedOutputByteBufferNano.m17254K(10, liveType, LiveType.PROTOBUF_ADAPTER);
            }
            MeetRelation meetRelation = myMeetEntryFeed.relation;
            if (meetRelation != null) {
                codedOutputByteBufferNano.m17254K(11, meetRelation, MeetRelation.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17252I(12, myMeetEntryFeed.publishTimestamp);
        }
    };
        ...
        public boolean parseField(MyMeetEntryFeed myMeetEntryFeed, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userIds":
                    ...
                    return true;
                case "id":
                    myMeetEntryFeed.f20452id = jsonParser.getValueAsString();
                    return false;
                case "momentText":
    ...
    public static /* synthetic */ String m35704a(String str) {
        return str;
    }
    ...
    public MyMeetEntryFeed mo223809clone() {
        MyMeetEntryFeed myMeetEntryFeed = new MyMeetEntryFeed();
        ...
        if (list != null) {
            myMeetEntryFeed.userIds = ValueObject.util_map(list, new w9j() { // from class: l.yu10
                ...
                public final Object call(Object obj) {
                    return MyMeetEntryFeed.m35704a((String) obj);
                }
            });
        }
        ...
        myMeetEntryFeed.f20452id = this.f20452id;
        MeetRelation meetRelation = this.relation;
        if (meetRelation != null) {
            myMeetEntryFeed.relation = meetRelation.mo223809clone();
        }
