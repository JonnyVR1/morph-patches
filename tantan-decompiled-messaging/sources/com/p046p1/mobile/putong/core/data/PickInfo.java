...
public class PickInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PickInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<PickInfo>() { // from class: com.p1.mobile.putong.core.data.PickInfo.1
        ...
        public int computeAndCacheSize(PickInfo pickInfo) {
            ...
            int iM17230l = picksTagType != null ? CodedOutputByteBufferNano.m17230l(1, picksTagType, PicksTagType.PROTOBUF_ADAPTER) : 0;
            String str = pickInfo.picksTracker;
            if (str != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(2, str);
            }
            pickInfo.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PickInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    pickInfo.picksTagType = (PicksTagType) nb5Var.m158743l(PicksTagType.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (pickInfo.picksTagType == null) {
                            pickInfo.picksTagType = (PicksTagType) PicksTagType.JSON_ADAPTER.defaultEnum();
                    ...
                    pickInfo.picksTracker = nb5Var.m158750s();
                }
            }
            return pickInfo;
        }
        ...
        public void serialize(PickInfo pickInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (picksTagType != null) {
                codedOutputByteBufferNano.m17254K(1, picksTagType, PicksTagType.PROTOBUF_ADAPTER);
            }
            String str = pickInfo.picksTracker;
            if (str != null) {
