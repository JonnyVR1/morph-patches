...
public class ActionInsertPosition extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ActionInsertPosition> PROTOBUF_ADAPTER = new MessageNanoAdapter<ActionInsertPosition>() { // from class: com.p1.mobile.putong.core.data.ActionInsertPosition.1
        ...
        public int computeAndCacheSize(ActionInsertPosition actionInsertPosition) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, actionInsertPosition.position);
            CardExtraInfo cardExtraInfo = actionInsertPosition.cardExtraInfo;
            if (cardExtraInfo != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, cardExtraInfo, CardExtraInfo.PROTOBUF_ADAPTER);
            }
            CardStyle cardStyle = actionInsertPosition.cardStyle;
            if (cardStyle != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, cardStyle, CardStyle.PROTOBUF_ADAPTER);
            }
            CardStyle cardStyle2 = actionInsertPosition.likedMe;
            if (cardStyle2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, cardStyle2, CardStyle.PROTOBUF_ADAPTER);
            }
            CityCData cityCData = actionInsertPosition.cityCData;
            if (cityCData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, cityCData, CityCData.PROTOBUF_ADAPTER);
            }
            actionInsertPosition.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ActionInsertPosition parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    actionInsertPosition.userId = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    actionInsertPosition.position = nb5Var.m158741j();
                } else if (iM158752u == 26) {
                    actionInsertPosition.cardExtraInfo = (CardExtraInfo) nb5Var.m158743l(CardExtraInfo.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    actionInsertPosition.cardStyle = (CardStyle) nb5Var.m158743l(CardStyle.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    actionInsertPosition.likedMe = (CardStyle) nb5Var.m158743l(CardStyle.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 50) {
                        if (actionInsertPosition.userId == null) {
                            actionInsertPosition.userId = "";
                    ...
                    actionInsertPosition.cityCData = (CityCData) nb5Var.m158743l(CityCData.PROTOBUF_ADAPTER);
                }
            }
            return actionInsertPosition;
        }
        ...
        public void serialize(ActionInsertPosition actionInsertPosition, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, actionInsertPosition.position);
            CardExtraInfo cardExtraInfo = actionInsertPosition.cardExtraInfo;
            if (cardExtraInfo != null) {
                codedOutputByteBufferNano.m17254K(3, cardExtraInfo, CardExtraInfo.PROTOBUF_ADAPTER);
            }
            CardStyle cardStyle = actionInsertPosition.cardStyle;
            if (cardStyle != null) {
                codedOutputByteBufferNano.m17254K(4, cardStyle, CardStyle.PROTOBUF_ADAPTER);
            }
            CardStyle cardStyle2 = actionInsertPosition.likedMe;
            if (cardStyle2 != null) {
                codedOutputByteBufferNano.m17254K(5, cardStyle2, CardStyle.PROTOBUF_ADAPTER);
            }
            CityCData cityCData = actionInsertPosition.cityCData;
            if (cityCData != null) {
                codedOutputByteBufferNano.m17254K(6, cityCData, CityCData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ActionInsertPosition mo223809clone() {
        ActionInsertPosition actionInsertPosition = new ActionInsertPosition();
        ...
        if (cardExtraInfo != null) {
            actionInsertPosition.cardExtraInfo = cardExtraInfo.mo223809clone();
        }
        CardStyle cardStyle = this.cardStyle;
        if (cardStyle != null) {
            actionInsertPosition.cardStyle = cardStyle.mo223809clone();
        }
        CardStyle cardStyle2 = this.likedMe;
        if (cardStyle2 != null) {
            actionInsertPosition.likedMe = cardStyle2.mo223809clone();
        }
        CityCData cityCData = this.cityCData;
        if (cityCData != null) {
            actionInsertPosition.cityCData = cityCData.mo223809clone();
        }
        return actionInsertPosition;
    }
