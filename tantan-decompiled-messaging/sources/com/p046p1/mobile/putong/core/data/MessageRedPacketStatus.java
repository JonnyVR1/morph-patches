...
public class MessageRedPacketStatus extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageRedPacketStatus> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageRedPacketStatus>() { // from class: com.p1.mobile.putong.core.data.MessageRedPacketStatus.1
        ...
        public int computeAndCacheSize(MessageRedPacketStatus messageRedPacketStatus) {
            ...
            int iM17228j = iM17233o + CodedOutputByteBufferNano.m17228j(4, messageRedPacketStatus.expireTime);
            String str4 = messageRedPacketStatus.localRedPacketStatus;
            if (str4 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(5, str4);
            }
            int iM17220b = iM17228j + CodedOutputByteBufferNano.m17220b(6, messageRedPacketStatus.localIsRedPacketOpen);
            messageRedPacketStatus.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageRedPacketStatus parse(nb5 nb5Var) throws IOException {
            MessageRedPacketStatus messageRedPacketStatus = new MessageRedPacketStatus();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 10) {
                    messageRedPacketStatus.redPacketTitle = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    messageRedPacketStatus.redPacketId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    messageRedPacketStatus.redPacketSplitType = nb5Var.m158750s();
                } else if (iM158752u == 32) {
                    messageRedPacketStatus.expireTime = nb5Var.m158742k();
                } else if (iM158752u == 42) {
                    messageRedPacketStatus.localRedPacketStatus = nb5Var.m158750s();
                } else {
                    if (iM158752u != 48) {
                        return messageRedPacketStatus;
                    }
                    messageRedPacketStatus.localIsRedPacketOpen = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(MessageRedPacketStatus messageRedPacketStatus, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(4, messageRedPacketStatus.expireTime);
            String str4 = messageRedPacketStatus.localRedPacketStatus;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(5, str4);
            }
            codedOutputByteBufferNano.m17244A(6, messageRedPacketStatus.localIsRedPacketOpen);
        }
    };
    ...
    public MessageRedPacketStatus mo223809clone() {
        MessageRedPacketStatus messageRedPacketStatus = new MessageRedPacketStatus();
