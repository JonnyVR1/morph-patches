...
public class Merchandise extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Merchandise> PROTOBUF_ADAPTER = new MessageNanoAdapter<Merchandise>() { // from class: com.p1.mobile.putong.core.data.Merchandise.1
        ...
        public int computeAndCacheSize(Merchandise merchandise) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, merchandise._id);
            String str = merchandise.f56011id;
            if (str != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(2, str);
            }
            ProductCategory productCategory = merchandise.category;
            if (productCategory != null) {
                iM17228j += CodedOutputByteBufferNano.m17226h(51, productCategory.ordinal());
            }
            int iM17226h = iM17228j + CodedOutputByteBufferNano.m17226h(52, merchandise.quantity);
            ProductType productType = merchandise.productType;
            if (productType != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(53, productType.ordinal());
            }
            StockKeepUnit stockKeepUnit = merchandise.defaultStockKeepUnit;
            if (stockKeepUnit != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(54, stockKeepUnit, StockKeepUnit.PROTOBUF_ADAPTER);
            }
            ProductCategory productCategory2 = merchandise.category;
            if (productCategory2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(55, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            ProductType productType2 = merchandise.productType;
            if (productType2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(56, productType2, ProductType.PROTOBUF_ADAPTER);
            }
            List<Coupon> list = merchandise.localCoupons;
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(57, list, Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MerchandiseDurationDesc merchandiseDurationDesc = merchandise.duration;
            if (merchandiseDurationDesc != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(58, merchandiseDurationDesc, MerchandiseDurationDesc.PROTOBUF_ADAPTER);
            }
            MerchandiseExtra merchandiseExtra = merchandise.extra;
            if (merchandiseExtra != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(59, merchandiseExtra, MerchandiseExtra.PROTOBUF_ADAPTER);
            }
            merchandise.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Merchandise parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        merchandise._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        merchandise.f56011id = nb5Var.m158750s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        merchandise.quantity = nb5Var.m158741j();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        numValueOf2 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 434:
                        merchandise.defaultStockKeepUnit = (StockKeepUnit) nb5Var.m158743l(StockKeepUnit.PROTOBUF_ADAPTER);
                        continue;
                    case 442:
                        merchandise.category = (ProductCategory) nb5Var.m158743l(ProductCategory.PROTOBUF_ADAPTER);
                        continue;
                    case 450:
                        merchandise.productType = (ProductType) nb5Var.m158743l(ProductType.PROTOBUF_ADAPTER);
                        continue;
                    case 458:
                        merchandise.localCoupons = (List) nb5Var.m158743l(Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 466:
                        merchandise.duration = (MerchandiseDurationDesc) nb5Var.m158743l(MerchandiseDurationDesc.PROTOBUF_ADAPTER);
                        continue;
                    case 474:
                        merchandise.extra = (MerchandiseExtra) nb5Var.m158743l(MerchandiseExtra.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (merchandise.category == null && numValueOf != null) {
                            merchandise.category = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Merchandise merchandise, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, merchandise._id);
            String str = merchandise.f56011id;
            if (str != null) {
            ...
            ProductCategory productCategory = merchandise.category;
            if (productCategory != null) {
                codedOutputByteBufferNano.m17250G(51, productCategory.ordinal());
            }
            codedOutputByteBufferNano.m17250G(52, merchandise.quantity);
            ProductType productType = merchandise.productType;
            if (productType != null) {
                codedOutputByteBufferNano.m17250G(53, productType.ordinal());
            }
            StockKeepUnit stockKeepUnit = merchandise.defaultStockKeepUnit;
            if (stockKeepUnit != null) {
                codedOutputByteBufferNano.m17254K(54, stockKeepUnit, StockKeepUnit.PROTOBUF_ADAPTER);
            }
            ProductCategory productCategory2 = merchandise.category;
            if (productCategory2 != null) {
                codedOutputByteBufferNano.m17254K(55, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            ProductType productType2 = merchandise.productType;
            if (productType2 != null) {
                codedOutputByteBufferNano.m17254K(56, productType2, ProductType.PROTOBUF_ADAPTER);
            }
            List<Coupon> list = merchandise.localCoupons;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(57, list, Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MerchandiseDurationDesc merchandiseDurationDesc = merchandise.duration;
            if (merchandiseDurationDesc != null) {
                codedOutputByteBufferNano.m17254K(58, merchandiseDurationDesc, MerchandiseDurationDesc.PROTOBUF_ADAPTER);
            }
            MerchandiseExtra merchandiseExtra = merchandise.extra;
            if (merchandiseExtra != null) {
                codedOutputByteBufferNano.m17254K(59, merchandiseExtra, MerchandiseExtra.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Merchandise merchandise, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "localCoupons":
                    ...
                    return true;
                case "id":
                    merchandise.f56011id = jsonParser.getValueAsString();
                    return false;
                case "category":
    ...
    public static final StringColumn<Merchandise> f20440ID = new StringColumn<Merchandise>("id_c") { // from class: com.p1.mobile.putong.core.data.Merchandise.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Merchandise merchandise) {
            return merchandise.f56011id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Merchandise merchandise, String str) {
            merchandise.f56011id = str;
        }
    };
    ...
    public static final StringColumn<Merchandise> DEFAULTSTOCKKEEPUNIT_ID = new StringColumn<Merchandise>("defaultStockKeepUnit_id_c") { // from class: com.p1.mobile.putong.core.data.Merchandise.8
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Merchandise merchandise) {
            return merchandise.defaultStockKeepUnit.f20507id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Merchandise merchandise, String str) {
            merchandise.defaultStockKeepUnit.f20507id = str;
        }
    };
    ...
    public static mrf0<Merchandise> DB_ADAPTER = new mrf0<Merchandise>() { // from class: com.p1.mobile.putong.core.data.Merchandise.27
        ...
        public Merchandise read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i5 = i + 1;
                String string3 = null;
                merchandise.f56011id = cursor.isNull(i5) ? null : cursor.getString(i5);
                int i6 = i + 2;
                ...
                try {
                    ...
                    int i8 = i + 5;
                    merchandise.defaultStockKeepUnit.f20507id = cursor.isNull(i8) ? null : cursor.getString(i8);
                    int i9 = i + 6;
        ...
        public void write(Merchandise merchandise, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", merchandise.f56011id);
                ProductCategory productCategory = merchandise.category;
                ...
                DbObject.cvPut(contentValues, "defaultStockKeepUnit_id_c", merchandise.defaultStockKeepUnit.f20507id);
    ...
    public Merchandise mo223809clone() {
        Merchandise merchandise = new Merchandise();
        merchandise._id = this._id;
        merchandise.f56011id = this.f56011id;
        ...
        if (stockKeepUnit != null) {
            merchandise.defaultStockKeepUnit = stockKeepUnit.mo223809clone();
        }
        ...
        if (merchandiseDurationDesc != null) {
            merchandise.duration = merchandiseDurationDesc.mo223809clone();
        }
        MerchandiseExtra merchandiseExtra = this.extra;
        if (merchandiseExtra != null) {
            merchandise.extra = merchandiseExtra.mo223809clone();
        }
        return merchandise;
    }
    ...
    public boolean daily() {
        if (this.quantity != 1 || !NullChecker.m81303a(this.duration)) {
            return false;
        }
        MerchandiseDurationDesc merchandiseDurationDesc = this.duration;
    ...
    public Coupon getCouponForPromotion(String str) {
        ...
        return vwb.m200296J(arrayList) ? Coupon.new_() : (Coupon) arrayList.get(0);
    }
    ...
    public Coupon getCouponWithId(String str) {
        for (Coupon coupon : this.localCoupons) {
            if (TextUtils.equals(str, coupon.f56011id)) {
                return coupon;
            }
        }
        return null;
    ...
    public double getFirstCouponPrice() {
        if (vwb.m200296J(this.localCoupons)) {
    ...
    public boolean isBelongCouponId(String str) {
        ...
        while (it.hasNext()) {
            if (TextUtils.equals(str, it.next().f56011id)) {
                return true;
            }
        }
        return false;
