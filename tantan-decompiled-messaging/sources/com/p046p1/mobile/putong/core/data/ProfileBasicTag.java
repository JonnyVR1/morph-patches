...
import com.p046p1.mobile.putong.core.data.ProfileBasicTagItem;
...
public class ProfileBasicTag extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ProfileBasicTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<ProfileBasicTag>() { // from class: com.p1.mobile.putong.core.data.ProfileBasicTag.1
        ...
        public int computeAndCacheSize(ProfileBasicTag profileBasicTag) {
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, list, ProfileBasicTagItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            profileBasicTag.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ProfileBasicTag parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    profileBasicTag.groupName = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    profileBasicTag.action = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (profileBasicTag.groupName == null) {
                            profileBasicTag.groupName = "";
                    ...
                    profileBasicTag.items = (List) nb5Var.m158743l(ProfileBasicTagItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return profileBasicTag;
        }
        ...
        public void serialize(ProfileBasicTag profileBasicTag, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<ProfileBasicTagItem> list = profileBasicTag.items;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, ProfileBasicTagItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public ProfileBasicTag mo223809clone() {
        ProfileBasicTag profileBasicTag = new ProfileBasicTag();
        ...
        if (list != null) {
            profileBasicTag.items = ValueObject.util_map(list, new w9j() { // from class: l.bh90
                ...
                public final Object call(Object obj) {
                    return ((ProfileBasicTagItem) obj).mo223809clone();
                }
            });
        }
        return profileBasicTag;
