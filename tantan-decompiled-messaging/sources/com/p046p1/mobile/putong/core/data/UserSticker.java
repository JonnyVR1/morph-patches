...
public class UserSticker extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserSticker> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserSticker>() { // from class: com.p1.mobile.putong.core.data.UserSticker.1
        ...
        public int computeAndCacheSize(UserSticker userSticker) {
            String str = userSticker.f20526id;
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(3, userSticker.updatedTime);
            userSticker.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserSticker parse(nb5 nb5Var) throws IOException {
            UserSticker userSticker = new UserSticker();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (userSticker.f20526id == null) {
                        userSticker.f20526id = "";
                    }
                ...
                if (iM158752u == 10) {
                    userSticker.f20526id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    userSticker.favoriteStickers = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 25) {
                        if (userSticker.f20526id == null) {
                            userSticker.f20526id = "";
                    ...
                    userSticker.updatedTime = nb5Var.m158739h();
                }
            }
            return userSticker;
        }
        ...
        public void serialize(UserSticker userSticker, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(3, userSticker.updatedTime);
        }
    };
        ...
        public boolean parseField(UserSticker userSticker, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "updatedTime":
                    ...
                    return true;
                case "id":
                    userSticker.f20526id = jsonParser.getValueAsString();
                    return false;
                default:
                    return false;
            }
    ...
    public static /* synthetic */ String m35894a(String str) {
        return str;
    }
    ...
    public UserSticker mo223809clone() {
        UserSticker userSticker = new UserSticker();
        userSticker.f20526id = this.f20526id;
        ...
        if (list != null) {
            userSticker.favoriteStickers = ValueObject.util_map(list, new w9j() { // from class: l.g9k0
                ...
                public final Object call(Object obj) {
                    return UserSticker.m35894a((String) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20526id, userSticker.f20526id) && ValueObject.util_equals(this.favoriteStickers, userSticker.favoriteStickers) && this.updatedTime == userSticker.updatedTime;
    }
