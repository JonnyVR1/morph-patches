...
public class CoreGiftInfo extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreGiftInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreGiftInfo>() { // from class: com.p1.mobile.putong.core.data.CoreGiftInfo.1
        ...
        public int computeAndCacheSize(CoreGiftInfo coreGiftInfo) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, coreGiftInfo._id);
            String str = coreGiftInfo.f56011id;
            if (str != null) {
            ...
            int iM17222d = iM17228j + CodedOutputByteBufferNano.m17222d(53, coreGiftInfo.unitCoinPrice) + CodedOutputByteBufferNano.m17226h(54, coreGiftInfo.unitLikes) + CodedOutputByteBufferNano.m17220b(55, coreGiftInfo.dynamicGift);
            String str4 = coreGiftInfo.dynamicURL;
            if (str4 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(56, str4);
            }
            String str5 = coreGiftInfo.dynamicMD5;
            if (str5 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(57, str5);
            }
            int iM17226h = iM17222d + CodedOutputByteBufferNano.m17226h(58, coreGiftInfo.quota);
            GiftInfoExtra giftInfoExtra = coreGiftInfo.extra;
            if (giftInfoExtra != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(59, giftInfoExtra, GiftInfoExtra.PROTOBUF_ADAPTER);
            }
            coreGiftInfo.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreGiftInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        coreGiftInfo._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        coreGiftInfo.f56011id = nb5Var.m158750s();
                        continue;
                    case 410:
                        coreGiftInfo.name = nb5Var.m158750s();
                        continue;
                    case 418:
                        coreGiftInfo.url = nb5Var.m158750s();
                        continue;
                    case 425:
                        coreGiftInfo.unitCoinPrice = nb5Var.m158739h();
                        continue;
                    case 432:
                        coreGiftInfo.unitLikes = nb5Var.m158741j();
                        continue;
                    case 440:
                        coreGiftInfo.dynamicGift = nb5Var.m158738g();
                        continue;
                    case 450:
                        coreGiftInfo.dynamicURL = nb5Var.m158750s();
                        continue;
                    case 458:
                        coreGiftInfo.dynamicMD5 = nb5Var.m158750s();
                        continue;
                    case 464:
                        coreGiftInfo.quota = nb5Var.m158741j();
                        continue;
                    case 474:
                        coreGiftInfo.extra = (GiftInfoExtra) nb5Var.m158743l(GiftInfoExtra.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (coreGiftInfo.name == null) {
                            coreGiftInfo.name = "";
        ...
        public void serialize(CoreGiftInfo coreGiftInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, coreGiftInfo._id);
            String str = coreGiftInfo.f56011id;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17246C(53, coreGiftInfo.unitCoinPrice);
            codedOutputByteBufferNano.m17250G(54, coreGiftInfo.unitLikes);
            codedOutputByteBufferNano.m17244A(55, coreGiftInfo.dynamicGift);
            String str4 = coreGiftInfo.dynamicURL;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17250G(58, coreGiftInfo.quota);
            GiftInfoExtra giftInfoExtra = coreGiftInfo.extra;
            if (giftInfoExtra != null) {
                codedOutputByteBufferNano.m17254K(59, giftInfoExtra, GiftInfoExtra.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(CoreGiftInfo coreGiftInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "dynamicGift":
                    ...
                    return true;
                case "id":
                    coreGiftInfo.f56011id = jsonParser.getValueAsString();
                    return false;
                case "url":
    ...
    public static final StringColumn<CoreGiftInfo> f20377ID = new StringColumn<CoreGiftInfo>("id_c") { // from class: com.p1.mobile.putong.core.data.CoreGiftInfo.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(CoreGiftInfo coreGiftInfo) {
            return coreGiftInfo.f56011id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(CoreGiftInfo coreGiftInfo, String str) {
            coreGiftInfo.f56011id = str;
        }
    };
    ...
    public static mrf0<CoreGiftInfo> DB_ADAPTER = new mrf0<CoreGiftInfo>() { // from class: com.p1.mobile.putong.core.data.CoreGiftInfo.18
        ...
        public String CREATE_TABLE(orh0 orh0Var) {
            return "CREATE TABLE IF NOT EXISTS " + orh0Var.f145283d + " (_id INTEGER PRIMARY KEY,id_c TEXT,name_c TEXT,url_c TEXT,unitCoinPrice_c REAL,unitLikes_c INTEGER,dynamicGift_c INTEGER,dynamicURL_c TEXT,dynamicMD5_c TEXT,quota_c INTEGER,extra_messageTips_c TEXT,extra_noQuotaToast_c TEXT,extra_shopGuide_c TEXT,extra_blessingText_c TEXT,extra_grayURL_c TEXT)";
        }
        ...
        public CoreGiftInfo read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i2 = i + 1;
                String string = null;
                coreGiftInfo.f56011id = cursor.isNull(i2) ? null : cursor.getString(i2);
                int i3 = i + 2;
        ...
        public void write(CoreGiftInfo coreGiftInfo, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", coreGiftInfo.f56011id);
    ...
    public CoreGiftInfo mo223809clone() {
        CoreGiftInfo coreGiftInfo = new CoreGiftInfo();
        coreGiftInfo._id = this._id;
        coreGiftInfo.f56011id = this.f56011id;
        ...
        if (giftInfoExtra != null) {
            coreGiftInfo.extra = giftInfoExtra.mo223809clone();
        }
