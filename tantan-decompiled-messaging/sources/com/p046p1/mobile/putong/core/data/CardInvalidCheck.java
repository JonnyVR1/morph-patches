...
public class CardInvalidCheck extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CardInvalidCheck> PROTOBUF_ADAPTER = new MessageNanoAdapter<CardInvalidCheck>() { // from class: com.p1.mobile.putong.core.data.CardInvalidCheck.1
        ...
        public int computeAndCacheSize(CardInvalidCheck cardInvalidCheck) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, cardInvalidCheck.checkCard) + CodedOutputByteBufferNano.m17226h(2, cardInvalidCheck.checkInterval);
            cardInvalidCheck.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CardInvalidCheck parse(nb5 nb5Var) throws IOException {
            CardInvalidCheck cardInvalidCheck = new CardInvalidCheck();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    cardInvalidCheck.checkCard = nb5Var.m158738g();
                } else {
                    if (iM158752u != 16) {
                        return cardInvalidCheck;
                    }
                    cardInvalidCheck.checkInterval = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(CardInvalidCheck cardInvalidCheck, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, cardInvalidCheck.checkCard);
            codedOutputByteBufferNano.m17250G(2, cardInvalidCheck.checkInterval);
        }
    };
    ...
    public CardInvalidCheck mo223809clone() {
        CardInvalidCheck cardInvalidCheck = new CardInvalidCheck();
