...
public class H5MerchandiseData extends BaseData implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<H5MerchandiseData> PROTOBUF_ADAPTER = new MessageNanoAdapter<H5MerchandiseData>() { // from class: com.p1.mobile.putong.core.data.H5MerchandiseData.1
        ...
        public int computeAndCacheSize(H5MerchandiseData h5MerchandiseData) {
            ...
            int iM17230l = list != null ? CodedOutputByteBufferNano.m17230l(1, list, H5Merchandise.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            List<H5PaymentChannels> list2 = h5MerchandiseData.paymentChannels;
            if (list2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, list2, H5PaymentChannels.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            h5MerchandiseData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public H5MerchandiseData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    h5MerchandiseData.merchandises = (List) nb5Var.m158743l(H5Merchandise.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 18) {
                        if (h5MerchandiseData.merchandises == null) {
                            h5MerchandiseData.merchandises = new ArrayList();
                    ...
                    h5MerchandiseData.paymentChannels = (List) nb5Var.m158743l(H5PaymentChannels.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return h5MerchandiseData;
        }
        ...
        public void serialize(H5MerchandiseData h5MerchandiseData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<H5Merchandise> list = h5MerchandiseData.merchandises;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(1, list, H5Merchandise.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<H5PaymentChannels> list2 = h5MerchandiseData.paymentChannels;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(2, list2, H5PaymentChannels.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public H5MerchandiseData mo223809clone() {
        H5MerchandiseData h5MerchandiseData = new H5MerchandiseData();
        ...
        if (list != null) {
            h5MerchandiseData.merchandises = ValueObject.util_map(list, new w9j() { // from class: l.fuk
                ...
                public final Object call(Object obj) {
                    return ((H5Merchandise) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            h5MerchandiseData.paymentChannels = ValueObject.util_map(list2, new w9j() { // from class: l.guk
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((H5PaymentChannels) obj).mo223809clone();
                }
            });
        }
        return h5MerchandiseData;
