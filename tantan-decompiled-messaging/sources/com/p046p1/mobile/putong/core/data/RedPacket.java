...
public class RedPacket extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RedPacket> PROTOBUF_ADAPTER = new MessageNanoAdapter<RedPacket>() { // from class: com.p1.mobile.putong.core.data.RedPacket.1
        ...
        public int computeAndCacheSize(RedPacket redPacket) {
            String str = redPacket.f20489id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            RedPacketOwner redPacketOwner = redPacket.owner;
            if (redPacketOwner != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, redPacketOwner, RedPacketOwner.PROTOBUF_ADAPTER);
            }
            RedPacketInfo redPacketInfo = redPacket.showInfo;
            if (redPacketInfo != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, redPacketInfo, RedPacketInfo.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(4, redPacket.quantity) + CodedOutputByteBufferNano.m17226h(5, redPacket.assignQuantity);
            ...
            int iM17228j = iM17226h + CodedOutputByteBufferNano.m17228j(9, redPacket.payExpireTime) + CodedOutputByteBufferNano.m17228j(10, redPacket.expireTime) + CodedOutputByteBufferNano.m17228j(11, redPacket.createTime);
            List<ReceiveRecords> list = redPacket.receiveRecords;
            if (list != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(12, list, ReceiveRecords.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            RedPacketMyInfo redPacketMyInfo = redPacket.myInfo;
            if (redPacketMyInfo != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(13, redPacketMyInfo, RedPacketMyInfo.PROTOBUF_ADAPTER);
            }
            String str5 = redPacket.paySign;
            if (str5 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(14, str5);
            }
            String str6 = redPacket.status;
            if (str6 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(15, str6);
            }
            redPacket.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RedPacket parse(nb5 nb5Var) throws IOException {
            RedPacket redPacket = new RedPacket();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (redPacket.f20489id == null) {
                            redPacket.f20489id = "";
                        }
                        ...
                        break;
                    case 10:
                        redPacket.f20489id = nb5Var.m158750s();
                        continue;
                    case 18:
                        redPacket.owner = (RedPacketOwner) nb5Var.m158743l(RedPacketOwner.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        redPacket.showInfo = (RedPacketInfo) nb5Var.m158743l(RedPacketInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 32:
                        redPacket.quantity = nb5Var.m158741j();
                        continue;
                    case 40:
                        redPacket.assignQuantity = nb5Var.m158741j();
                        continue;
                    case 50:
                        redPacket.totalAmount = nb5Var.m158750s();
                        continue;
                    case 58:
                        redPacket.assignAmount = nb5Var.m158750s();
                        continue;
                    case 66:
                        redPacket.splitType = nb5Var.m158750s();
                        continue;
                    case 72:
                        redPacket.payExpireTime = nb5Var.m158742k();
                        continue;
                    case 80:
                        redPacket.expireTime = nb5Var.m158742k();
                        continue;
                    case 88:
                        redPacket.createTime = nb5Var.m158742k();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        redPacket.receiveRecords = (List) nb5Var.m158743l(ReceiveRecords.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 106:
                        redPacket.myInfo = (RedPacketMyInfo) nb5Var.m158743l(RedPacketMyInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        redPacket.paySign = nb5Var.m158750s();
                        continue;
                    case 122:
                        redPacket.status = nb5Var.m158750s();
                        continue;
                    default:
                        if (redPacket.f20489id == null) {
                            redPacket.f20489id = "";
        ...
        public void serialize(RedPacket redPacket, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            RedPacketOwner redPacketOwner = redPacket.owner;
            if (redPacketOwner != null) {
                codedOutputByteBufferNano.m17254K(2, redPacketOwner, RedPacketOwner.PROTOBUF_ADAPTER);
            }
            RedPacketInfo redPacketInfo = redPacket.showInfo;
            if (redPacketInfo != null) {
                codedOutputByteBufferNano.m17254K(3, redPacketInfo, RedPacketInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(4, redPacket.quantity);
            codedOutputByteBufferNano.m17250G(5, redPacket.assignQuantity);
            String str2 = redPacket.totalAmount;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17252I(9, redPacket.payExpireTime);
            codedOutputByteBufferNano.m17252I(10, redPacket.expireTime);
            codedOutputByteBufferNano.m17252I(11, redPacket.createTime);
            List<ReceiveRecords> list = redPacket.receiveRecords;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(12, list, ReceiveRecords.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            RedPacketMyInfo redPacketMyInfo = redPacket.myInfo;
            if (redPacketMyInfo != null) {
                codedOutputByteBufferNano.m17254K(13, redPacketMyInfo, RedPacketMyInfo.PROTOBUF_ADAPTER);
            }
            String str5 = redPacket.paySign;
            if (str5 != null) {
        ...
        public boolean parseField(RedPacket redPacket, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    redPacket.f20489id = jsonParser.getValueAsString();
                    return false;
                case 11:
    ...
    public RedPacket mo223809clone() {
        RedPacket redPacket = new RedPacket();
        redPacket.f20489id = this.f20489id;
        RedPacketOwner redPacketOwner = this.owner;
        if (redPacketOwner != null) {
            redPacket.owner = redPacketOwner.mo223809clone();
        }
        RedPacketInfo redPacketInfo = this.showInfo;
        if (redPacketInfo != null) {
            redPacket.showInfo = redPacketInfo.mo223809clone();
        }
        ...
        if (list != null) {
            redPacket.receiveRecords = ValueObject.util_map(list, new w9j() { // from class: l.ikc0
                ...
                public final Object call(Object obj) {
                    return ((ReceiveRecords) obj).mo223809clone();
                }
            });
        }
        RedPacketMyInfo redPacketMyInfo = this.myInfo;
        if (redPacketMyInfo != null) {
            redPacket.myInfo = redPacketMyInfo.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20489id, redPacket.f20489id) && ValueObject.util_equals(this.owner, redPacket.owner) && ValueObject.util_equals(this.showInfo, redPacket.showInfo) && this.quantity == redPacket.quantity && this.assignQuantity == redPacket.assignQuantity && ValueObject.util_equals(this.totalAmount, redPacket.totalAmount) && ValueObject.util_equals(this.assignAmount, redPacket.assignAmount) && ValueObject.util_equals(this.splitType, redPacket.splitType) && this.payExpireTime == redPacket.payExpireTime && this.expireTime == redPacket.expireTime && this.createTime == redPacket.createTime && ValueObject.util_equals(this.receiveRecords, redPacket.receiveRecords) && ValueObject.util_equals(this.myInfo, redPacket.myInfo) && ValueObject.util_equals(this.paySign, redPacket.paySign) && ValueObject.util_equals(this.status, redPacket.status);
    }
