...
public class TalkUnitData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TalkUnitData> PROTOBUF_ADAPTER = new MessageNanoAdapter<TalkUnitData>() { // from class: com.p1.mobile.putong.core.data.TalkUnitData.1
        ...
        public int computeAndCacheSize(TalkUnitData talkUnitData) {
            String str = talkUnitData.f20519id;
            ...
            if (user != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, user, User.PROTOBUF_ADAPTER);
            }
            talkUnitData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TalkUnitData parse(nb5 nb5Var) throws IOException {
            TalkUnitData talkUnitData = new TalkUnitData();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (talkUnitData.f20519id == null) {
                        talkUnitData.f20519id = "";
                    }
                ...
                if (iM158752u == 10) {
                    talkUnitData.f20519id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    talkUnitData.userId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    talkUnitData.value = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    talkUnitData.question = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (talkUnitData.f20519id == null) {
                            talkUnitData.f20519id = "";
                    ...
                    talkUnitData.user = (User) nb5Var.m158743l(User.PROTOBUF_ADAPTER);
                }
            }
            return talkUnitData;
        }
        ...
        public void serialize(TalkUnitData talkUnitData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            User user = talkUnitData.user;
            if (user != null) {
                codedOutputByteBufferNano.m17254K(5, user, User.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(TalkUnitData talkUnitData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userId":
                    ...
                    return true;
                case "id":
                    talkUnitData.f20519id = jsonParser.getValueAsString();
                    return false;
                case "user":
    ...
    public TalkUnitData mo223809clone() {
        TalkUnitData talkUnitData = new TalkUnitData();
        talkUnitData.f20519id = this.f20519id;
        talkUnitData.userId = this.userId;
        talkUnitData.value = this.value;
        talkUnitData.question = this.question;
        User user = this.user;
        if (user != null) {
            talkUnitData.user = user.mo223809clone();
        }
        return talkUnitData;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20519id, talkUnitData.f20519id) && ValueObject.util_equals(this.userId, talkUnitData.userId) && ValueObject.util_equals(this.value, talkUnitData.value) && ValueObject.util_equals(this.question, talkUnitData.question) && ValueObject.util_equals(this.user, talkUnitData.user);
    }
