...
public class Coupon extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Coupon> PROTOBUF_ADAPTER = new MessageNanoAdapter<Coupon>() { // from class: com.p1.mobile.putong.core.data.Coupon.1
        ...
        public int computeAndCacheSize(Coupon coupon) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, coupon._id);
            String str = coupon.f56011id;
            if (str != null) {
            ...
            if (list != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(52, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = coupon.couponType;
            if (str3 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(53, str3);
            }
            int iM17220b = iM17228j + CodedOutputByteBufferNano.m17220b(54, coupon.ignoreBeginTime) + CodedOutputByteBufferNano.m17220b(55, coupon.ignoreEndTime) + CodedOutputByteBufferNano.m17222d(56, coupon.beginTime) + CodedOutputByteBufferNano.m17222d(57, coupon.endTime);
            Condition condition = coupon.condition;
            if (condition != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(58, condition, Condition.PROTOBUF_ADAPTER);
            }
            Benefit benefit = coupon.benefit;
            if (benefit != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(59, benefit, Benefit.PROTOBUF_ADAPTER);
            }
            String str4 = coupon.userCouponID;
            if (str4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(60, str4);
            }
            String str5 = coupon.couponID;
            if (str5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(61, str5);
            }
            List<String> list2 = coupon.localApplyPromotions;
            if (list2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(62, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            coupon.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Coupon parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        coupon._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        coupon.f56011id = nb5Var.m158750s();
                        continue;
                    case 410:
                        coupon.name = nb5Var.m158750s();
                        continue;
                    case 418:
                        coupon.tags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 426:
                        coupon.couponType = nb5Var.m158750s();
                        continue;
                    case 432:
                        coupon.ignoreBeginTime = nb5Var.m158738g();
                        continue;
                    case 440:
                        coupon.ignoreEndTime = nb5Var.m158738g();
                        continue;
                    case 449:
                        coupon.beginTime = nb5Var.m158739h();
                        continue;
                    case 457:
                        coupon.endTime = nb5Var.m158739h();
                        continue;
                    case 466:
                        coupon.condition = (Condition) nb5Var.m158743l(Condition.PROTOBUF_ADAPTER);
                        continue;
                    case 474:
                        coupon.benefit = (Benefit) nb5Var.m158743l(Benefit.PROTOBUF_ADAPTER);
                        continue;
                    case 482:
                        coupon.userCouponID = nb5Var.m158750s();
                        continue;
                    case 490:
                        coupon.couponID = nb5Var.m158750s();
                        continue;
                    case 498:
                        coupon.localApplyPromotions = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (coupon.name == null) {
                            coupon.name = "";
        ...
        public void serialize(Coupon coupon, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, coupon._id);
            String str = coupon.f56011id;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17244A(54, coupon.ignoreBeginTime);
            codedOutputByteBufferNano.m17244A(55, coupon.ignoreEndTime);
            codedOutputByteBufferNano.m17246C(56, coupon.beginTime);
            codedOutputByteBufferNano.m17246C(57, coupon.endTime);
            Condition condition = coupon.condition;
            if (condition != null) {
                codedOutputByteBufferNano.m17254K(58, condition, Condition.PROTOBUF_ADAPTER);
            }
            Benefit benefit = coupon.benefit;
            if (benefit != null) {
                codedOutputByteBufferNano.m17254K(59, benefit, Benefit.PROTOBUF_ADAPTER);
            }
            String str4 = coupon.userCouponID;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(60, str4);
            }
            String str5 = coupon.couponID;
            if (str5 != null) {
            ...
            List<String> list2 = coupon.localApplyPromotions;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(62, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
        ...
        public boolean parseField(Coupon coupon, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    coupon.f56011id = jsonParser.getValueAsString();
                    return false;
                case 9:
    ...
    public static final StringColumn<Coupon> f20380ID = new StringColumn<Coupon>("id_c") { // from class: com.p1.mobile.putong.core.data.Coupon.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Coupon coupon) {
            return coupon.f56011id;
        }
    ...
    public static final StringColumn<Coupon> f20379x6fa1f90c = new StringColumn<Coupon>("benefit_localBenefit_trialBenefit_afterTrialDiscount_discountType_c") { // from class: com.p1.mobile.putong.core.data.Coupon.20
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Coupon coupon) {
    ...
    public static mrf0<Coupon> DB_ADAPTER = new mrf0<Coupon>() { // from class: com.p1.mobile.putong.core.data.Coupon.33
        ...
        public Coupon read(Cursor cursor, int i) {
            ...
            try {
                ...
                coupon.f56011id = cursor.isNull(i2) ? null : cursor.getString(i2);
                int i3 = i + 2;
        ...
        public void write(Coupon coupon, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", coupon.f56011id);
    ...
    public static /* synthetic */ String m35489a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m35490b(String str) {
        return str;
    }
    ...
    public Coupon mo223809clone() {
        Coupon coupon = new Coupon();
        coupon._id = this._id;
        coupon.f56011id = this.f56011id;
        ...
        if (list != null) {
            coupon.tags = ValueObject.util_map(list, new w9j() { // from class: l.arb
                ...
                public final Object call(Object obj) {
                    return Coupon.m35489a((String) obj);
                }
            });
        }
        ...
        if (condition != null) {
            coupon.condition = condition.mo223809clone();
        }
        Benefit benefit = this.benefit;
        if (benefit != null) {
            coupon.benefit = benefit.mo223809clone();
        }
        ...
        if (list2 != null) {
            coupon.localApplyPromotions = ValueObject.util_map(list2, new w9j() { // from class: l.brb
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Coupon.m35490b((String) obj);
                }
            });
        }
        return coupon;
