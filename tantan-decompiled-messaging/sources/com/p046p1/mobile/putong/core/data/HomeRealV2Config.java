...
public class HomeRealV2Config extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<HomeRealV2Config> PROTOBUF_ADAPTER = new MessageNanoAdapter<HomeRealV2Config>() { // from class: com.p1.mobile.putong.core.data.HomeRealV2Config.1
        ...
        public int computeAndCacheSize(HomeRealV2Config homeRealV2Config) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, homeRealV2Config.momentEnable) + CodedOutputByteBufferNano.m17220b(2, homeRealV2Config.marriageEnable) + CodedOutputByteBufferNano.m17220b(3, homeRealV2Config.outLikeNewUIEnable);
            homeRealV2Config.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public HomeRealV2Config parse(nb5 nb5Var) throws IOException {
            HomeRealV2Config homeRealV2Config = new HomeRealV2Config();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    homeRealV2Config.momentEnable = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    homeRealV2Config.marriageEnable = nb5Var.m158738g();
                } else {
                    if (iM158752u != 24) {
                        return homeRealV2Config;
                    }
                    homeRealV2Config.outLikeNewUIEnable = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(HomeRealV2Config homeRealV2Config, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, homeRealV2Config.momentEnable);
            codedOutputByteBufferNano.m17244A(2, homeRealV2Config.marriageEnable);
            codedOutputByteBufferNano.m17244A(3, homeRealV2Config.outLikeNewUIEnable);
        }
    };
    ...
    public HomeRealV2Config mo223809clone() {
        HomeRealV2Config homeRealV2Config = new HomeRealV2Config();
