...
public class MessageView extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageView> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageView>() { // from class: com.p1.mobile.putong.core.data.MessageView.1
        ...
        public int computeAndCacheSize(MessageView messageView) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(5, messageView.isTextOnly);
            ...
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(8, messageView.ignoreHeightLimit) + CodedOutputByteBufferNano.m17226h(9, messageView.uiStyle);
            messageView.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageView parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    messageView.image = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    messageView.text = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    messageView.imageSize = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    messageView.button = nb5Var.m158750s();
                } else if (iM158752u == 40) {
                    messageView.isTextOnly = nb5Var.m158738g();
                } else if (iM158752u == 50) {
                    messageView.cancelText = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    messageView.image2 = nb5Var.m158750s();
                } else if (iM158752u == 64) {
                    messageView.ignoreHeightLimit = nb5Var.m158738g();
                } else {
                    if (iM158752u != 72) {
                        if (messageView.image == null) {
                            messageView.image = "";
                    ...
                    messageView.uiStyle = nb5Var.m158741j();
                }
            }
            return messageView;
        }
        ...
        public void serialize(MessageView messageView, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(5, messageView.isTextOnly);
            String str5 = messageView.cancelText;
            if (str5 != null) {
            ...
            codedOutputByteBufferNano.m17244A(8, messageView.ignoreHeightLimit);
            codedOutputByteBufferNano.m17250G(9, messageView.uiStyle);
        }
    };
    ...
    public MessageView mo223809clone() {
        MessageView messageView = new MessageView();
