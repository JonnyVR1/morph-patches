...
public class BarLoverplaces extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BarLoverplaces> PROTOBUF_ADAPTER = new MessageNanoAdapter<BarLoverplaces>() { // from class: com.p1.mobile.putong.core.data.BarLoverplaces.1
        ...
        public int computeAndCacheSize(BarLoverplaces barLoverplaces) {
            String str = barLoverplaces.f20354id;
            ...
            if (barLoverplacesType != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, barLoverplacesType, BarLoverplacesType.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(5, barLoverplaces.showRank);
            barLoverplaces.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BarLoverplaces parse(nb5 nb5Var) throws IOException {
            BarLoverplaces barLoverplaces = new BarLoverplaces();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (barLoverplaces.f20354id == null) {
                        barLoverplaces.f20354id = "";
                    }
                ...
                if (iM158752u == 10) {
                    barLoverplaces.f20354id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    barLoverplaces.name = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    barLoverplaces.address = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    barLoverplaces.type = (BarLoverplacesType) nb5Var.m158743l(BarLoverplacesType.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 40) {
                        if (barLoverplaces.f20354id == null) {
                            barLoverplaces.f20354id = "";
                    ...
                    barLoverplaces.showRank = nb5Var.m158738g();
                }
            }
            return barLoverplaces;
        }
        ...
        public void serialize(BarLoverplaces barLoverplaces, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BarLoverplacesType barLoverplacesType = barLoverplaces.type;
            if (barLoverplacesType != null) {
                codedOutputByteBufferNano.m17254K(4, barLoverplacesType, BarLoverplacesType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(5, barLoverplaces.showRank);
        }
    };
        ...
        public boolean parseField(BarLoverplaces barLoverplaces, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "showRank":
                    ...
                    return true;
                case "id":
                    barLoverplaces.f20354id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public BarLoverplaces mo223809clone() {
        BarLoverplaces barLoverplaces = new BarLoverplaces();
        barLoverplaces.f20354id = this.f20354id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20354id, barLoverplaces.f20354id) && ValueObject.util_equals(this.name, barLoverplaces.name) && ValueObject.util_equals(this.address, barLoverplaces.address) && ValueObject.util_equals(this.type, barLoverplaces.type) && this.showRank == barLoverplaces.showRank;
    }
