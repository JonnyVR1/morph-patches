...
public class SalvagePopUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SalvagePopUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<SalvagePopUser>() { // from class: com.p1.mobile.putong.core.data.SalvagePopUser.1
        ...
        public int computeAndCacheSize(SalvagePopUser salvagePopUser) {
            ...
            if (salvagePopUserType != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, salvagePopUserType, SalvagePopUserType.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17230l + CodedOutputByteBufferNano.m17226h(3, salvagePopUser.superLikeCountBy);
            salvagePopUser.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SalvagePopUser parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    salvagePopUser.user = (User) nb5Var.m158743l(User.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    salvagePopUser.salvagePopUserType = (SalvagePopUserType) nb5Var.m158743l(SalvagePopUserType.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 24) {
                        if (salvagePopUser.user == null) {
                            salvagePopUser.user = User.new_();
                    ...
                    salvagePopUser.superLikeCountBy = nb5Var.m158741j();
                }
            }
            return salvagePopUser;
        }
        ...
        public void serialize(SalvagePopUser salvagePopUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            SalvagePopUserType salvagePopUserType = salvagePopUser.salvagePopUserType;
            if (salvagePopUserType != null) {
                codedOutputByteBufferNano.m17254K(2, salvagePopUserType, SalvagePopUserType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(3, salvagePopUser.superLikeCountBy);
        }
    };
    ...
    public SalvagePopUser mo223809clone() {
        SalvagePopUser salvagePopUser = new SalvagePopUser();
        User user = this.user;
        if (user != null) {
            salvagePopUser.user = user.mo223809clone();
        }
