...
public class Active extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Active> PROTOBUF_ADAPTER = new MessageNanoAdapter<Active>() { // from class: com.p1.mobile.putong.core.data.Active.1
        ...
        public int computeAndCacheSize(Active active) {
            ...
            active.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Active parse(nb5 nb5Var) throws IOException {
            Active active = new Active();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (active.f20341id == null) {
                        active.f20341id = "";
                    }
                ...
                if (iM158752u == 10) {
                    active.f20341id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    active.cardBackgroundUrl = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    active.cardTitle = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    active.cardDesc = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    active.cardLogo = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    active.cardBtnTitle = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    active.cardBtnSubTitle = nb5Var.m158750s();
                } else if (iM158752u == 66) {
                    active.cardLandPageUrl = nb5Var.m158750s();
                } else {
                    if (iM158752u != 74) {
                        if (active.f20341id == null) {
                            active.f20341id = "";
        ...
        public boolean parseField(Active active, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "cardLogo":
                    ...
                    return true;
                case "id":
                    active.f20341id = jsonParser.getValueAsString();
                    return false;
                case "skuId":
    ...
    public Active mo223809clone() {
        Active active = new Active();
        active.f20341id = this.f20341id;
