...
public class HideAndSeekGameRole extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<HideAndSeekGameRole> PROTOBUF_ADAPTER = new MessageNanoAdapter<HideAndSeekGameRole>() { // from class: com.p1.mobile.putong.core.data.HideAndSeekGameRole.1
        ...
        public int computeAndCacheSize(HideAndSeekGameRole hideAndSeekGameRole) {
            ...
            int iM17230l = (gameRole != null ? CodedOutputByteBufferNano.m17230l(1, gameRole, GameRole.PROTOBUF_ADAPTER) : 0) + CodedOutputByteBufferNano.m17228j(2, hideAndSeekGameRole.endTime) + CodedOutputByteBufferNano.m17226h(3, hideAndSeekGameRole.mouseCount) + CodedOutputByteBufferNano.m17226h(4, hideAndSeekGameRole.allCount);
            GameStage gameStage = hideAndSeekGameRole.gameStage;
            if (gameStage != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, gameStage, GameStage.PROTOBUF_ADAPTER);
            }
            hideAndSeekGameRole.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public HideAndSeekGameRole parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    hideAndSeekGameRole.roleType = (GameRole) nb5Var.m158743l(GameRole.PROTOBUF_ADAPTER);
                } else if (iM158752u == 16) {
                    hideAndSeekGameRole.endTime = nb5Var.m158742k();
                } else if (iM158752u == 24) {
                    hideAndSeekGameRole.mouseCount = nb5Var.m158741j();
                } else if (iM158752u == 32) {
                    hideAndSeekGameRole.allCount = nb5Var.m158741j();
                } else {
                    if (iM158752u != 42) {
                        if (hideAndSeekGameRole.roleType == null) {
                            hideAndSeekGameRole.roleType = (GameRole) GameRole.JSON_ADAPTER.defaultEnum();
                    ...
                    hideAndSeekGameRole.gameStage = (GameStage) nb5Var.m158743l(GameStage.PROTOBUF_ADAPTER);
                }
            }
            return hideAndSeekGameRole;
        }
        ...
        public void serialize(HideAndSeekGameRole hideAndSeekGameRole, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            GameRole gameRole = hideAndSeekGameRole.roleType;
            if (gameRole != null) {
                codedOutputByteBufferNano.m17254K(1, gameRole, GameRole.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17252I(2, hideAndSeekGameRole.endTime);
            codedOutputByteBufferNano.m17250G(3, hideAndSeekGameRole.mouseCount);
            codedOutputByteBufferNano.m17250G(4, hideAndSeekGameRole.allCount);
            GameStage gameStage = hideAndSeekGameRole.gameStage;
            if (gameStage != null) {
                codedOutputByteBufferNano.m17254K(5, gameStage, GameStage.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public HideAndSeekGameRole mo223809clone() {
        HideAndSeekGameRole hideAndSeekGameRole = new HideAndSeekGameRole();
