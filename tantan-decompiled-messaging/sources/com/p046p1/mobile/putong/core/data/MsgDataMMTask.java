...
public class MsgDataMMTask extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MsgDataMMTask> PROTOBUF_ADAPTER = new MessageNanoAdapter<MsgDataMMTask>() { // from class: com.p1.mobile.putong.core.data.MsgDataMMTask.1
        ...
        public int computeAndCacheSize(MsgDataMMTask msgDataMMTask) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, msgDataMMTask.mmCnt) + CodedOutputByteBufferNano.m17226h(2, msgDataMMTask.level);
            ...
            msgDataMMTask.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MsgDataMMTask parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    msgDataMMTask.mmCnt = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    msgDataMMTask.level = nb5Var.m158741j();
                } else {
                    if (iM158752u != 26) {
                        if (msgDataMMTask.taskNames != null) {
                            break;
                    ...
                    msgDataMMTask.taskNames = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return msgDataMMTask;
        }
        ...
        public void serialize(MsgDataMMTask msgDataMMTask, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, msgDataMMTask.mmCnt);
            codedOutputByteBufferNano.m17250G(2, msgDataMMTask.level);
            List<String> list = msgDataMMTask.taskNames;
            if (list != null) {
    ...
    public static /* synthetic */ String m35703a(String str) {
        return str;
    }
    ...
    public MsgDataMMTask mo223809clone() {
        MsgDataMMTask msgDataMMTask = new MsgDataMMTask();
        ...
        if (list != null) {
            msgDataMMTask.taskNames = ValueObject.util_map(list, new w9j() { // from class: l.cz00
                ...
                public final Object call(Object obj) {
                    return MsgDataMMTask.m35703a((String) obj);
                }
            });
        }
        return msgDataMMTask;
