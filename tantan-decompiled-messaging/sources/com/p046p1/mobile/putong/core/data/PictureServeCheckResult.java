...
public class PictureServeCheckResult extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PictureServeCheckResult> PROTOBUF_ADAPTER = new MessageNanoAdapter<PictureServeCheckResult>() { // from class: com.p1.mobile.putong.core.data.PictureServeCheckResult.1
        ...
        public int computeAndCacheSize(PictureServeCheckResult pictureServeCheckResult) {
            ...
            int iM17230l = photoLowModelData != null ? CodedOutputByteBufferNano.m17230l(1, photoLowModelData, PhotoLowModelData.PROTOBUF_ADAPTER) : 0;
            PhotoLowModelData photoLowModelData2 = pictureServeCheckResult.repeatPictureResult;
            if (photoLowModelData2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, photoLowModelData2, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
            PhotoLowModelData photoLowModelData3 = pictureServeCheckResult.netPictureResult;
            if (photoLowModelData3 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, photoLowModelData3, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
            PhotoLowModelData photoLowModelData4 = pictureServeCheckResult.lowPhotoResult;
            if (photoLowModelData4 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, photoLowModelData4, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
            pictureServeCheckResult.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PictureServeCheckResult parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    pictureServeCheckResult.notVerificationResultData = (PhotoLowModelData) nb5Var.m158743l(PhotoLowModelData.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    pictureServeCheckResult.repeatPictureResult = (PhotoLowModelData) nb5Var.m158743l(PhotoLowModelData.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    pictureServeCheckResult.netPictureResult = (PhotoLowModelData) nb5Var.m158743l(PhotoLowModelData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 34) {
                        if (pictureServeCheckResult.notVerificationResultData == null) {
                            pictureServeCheckResult.notVerificationResultData = PhotoLowModelData.new_();
                    ...
                    pictureServeCheckResult.lowPhotoResult = (PhotoLowModelData) nb5Var.m158743l(PhotoLowModelData.PROTOBUF_ADAPTER);
                }
            }
            return pictureServeCheckResult;
        }
        ...
        public void serialize(PictureServeCheckResult pictureServeCheckResult, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (photoLowModelData != null) {
                codedOutputByteBufferNano.m17254K(1, photoLowModelData, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
            PhotoLowModelData photoLowModelData2 = pictureServeCheckResult.repeatPictureResult;
            if (photoLowModelData2 != null) {
                codedOutputByteBufferNano.m17254K(2, photoLowModelData2, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
            PhotoLowModelData photoLowModelData3 = pictureServeCheckResult.netPictureResult;
            if (photoLowModelData3 != null) {
                codedOutputByteBufferNano.m17254K(3, photoLowModelData3, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
            PhotoLowModelData photoLowModelData4 = pictureServeCheckResult.lowPhotoResult;
            if (photoLowModelData4 != null) {
                codedOutputByteBufferNano.m17254K(4, photoLowModelData4, PhotoLowModelData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public PictureServeCheckResult mo223809clone() {
        PictureServeCheckResult pictureServeCheckResult = new PictureServeCheckResult();
        PhotoLowModelData photoLowModelData = this.notVerificationResultData;
        if (photoLowModelData != null) {
            pictureServeCheckResult.notVerificationResultData = photoLowModelData.mo223809clone();
        }
        PhotoLowModelData photoLowModelData2 = this.repeatPictureResult;
        if (photoLowModelData2 != null) {
            pictureServeCheckResult.repeatPictureResult = photoLowModelData2.mo223809clone();
        }
        PhotoLowModelData photoLowModelData3 = this.netPictureResult;
        if (photoLowModelData3 != null) {
            pictureServeCheckResult.netPictureResult = photoLowModelData3.mo223809clone();
        }
        PhotoLowModelData photoLowModelData4 = this.lowPhotoResult;
        if (photoLowModelData4 != null) {
            pictureServeCheckResult.lowPhotoResult = photoLowModelData4.mo223809clone();
        }
        return pictureServeCheckResult;
    }
