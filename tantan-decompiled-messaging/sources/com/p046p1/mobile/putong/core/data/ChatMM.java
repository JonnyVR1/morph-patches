...
import com.p046p1.mobile.putong.core.data.ChatMMDetail;
...
public class ChatMM extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatMM> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatMM>() { // from class: com.p1.mobile.putong.core.data.ChatMM.1
        ...
        public int computeAndCacheSize(ChatMM chatMM) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, chatMM.mmCnt) + CodedOutputByteBufferNano.m17226h(2, chatMM.level) + CodedOutputByteBufferNano.m17220b(3, chatMM.taskGuide) + CodedOutputByteBufferNano.m17220b(4, chatMM.sparkSwitch) + CodedOutputByteBufferNano.m17220b(5, chatMM.partnerSwitch) + CodedOutputByteBufferNano.m17220b(6, chatMM.pinChatSuggested) + CodedOutputByteBufferNano.m17222d(7, chatMM.expireTime) + CodedOutputByteBufferNano.m17222d(8, chatMM.matchTime);
            List<ChatMMDetail> list = chatMM.details;
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(9, list, ChatMMDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            chatMM.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatMM parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    chatMM.mmCnt = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    chatMM.level = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    chatMM.taskGuide = nb5Var.m158738g();
                } else if (iM158752u == 32) {
                    chatMM.sparkSwitch = nb5Var.m158738g();
                } else if (iM158752u == 40) {
                    chatMM.partnerSwitch = nb5Var.m158738g();
                } else if (iM158752u == 48) {
                    chatMM.pinChatSuggested = nb5Var.m158738g();
                } else if (iM158752u == 57) {
                    chatMM.expireTime = nb5Var.m158739h();
                } else if (iM158752u == 65) {
                    chatMM.matchTime = nb5Var.m158739h();
                } else {
                    if (iM158752u != 74) {
                        if (chatMM.details != null) {
                            break;
                    ...
                    chatMM.details = (List) nb5Var.m158743l(ChatMMDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return chatMM;
        }
        ...
        public void serialize(ChatMM chatMM, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, chatMM.mmCnt);
            codedOutputByteBufferNano.m17250G(2, chatMM.level);
            codedOutputByteBufferNano.m17244A(3, chatMM.taskGuide);
            codedOutputByteBufferNano.m17244A(4, chatMM.sparkSwitch);
            codedOutputByteBufferNano.m17244A(5, chatMM.partnerSwitch);
            codedOutputByteBufferNano.m17244A(6, chatMM.pinChatSuggested);
            codedOutputByteBufferNano.m17246C(7, chatMM.expireTime);
            codedOutputByteBufferNano.m17246C(8, chatMM.matchTime);
            List<ChatMMDetail> list = chatMM.details;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(9, list, ChatMMDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
        ...
        if (list != null) {
            chatMM.details = ValueObject.util_map(list, new w9j() { // from class: l.px4
                ...
                public final Object call(Object obj) {
                    return ((ChatMMDetail) obj).mo223809clone();
                }
            });
        }
        return chatMM;
