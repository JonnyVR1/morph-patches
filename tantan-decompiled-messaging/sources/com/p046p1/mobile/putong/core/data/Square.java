...
public class Square extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Square> PROTOBUF_ADAPTER = new MessageNanoAdapter<Square>() { // from class: com.p1.mobile.putong.core.data.Square.1
        ...
        public int computeAndCacheSize(Square square) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, square.userStatePublishRemain);
            String str = square.userStateID;
            if (str != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(2, str);
            }
            square.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Square parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    square.userStatePublishRemain = nb5Var.m158741j();
                } else {
                    if (iM158752u != 18) {
                        if (square.userStateID != null) {
                            break;
                    ...
                    square.userStateID = nb5Var.m158750s();
                }
            }
            return square;
        }
        ...
        public void serialize(Square square, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, square.userStatePublishRemain);
            String str = square.userStateID;
            if (str != null) {
