...
public class IntlNightClubConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlNightClubConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlNightClubConfig>() { // from class: com.p1.mobile.putong.core.data.IntlNightClubConfig.1
        ...
        public int computeAndCacheSize(IntlNightClubConfig intlNightClubConfig) {
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(3, intlNightClubConfig.latitude) + CodedOutputByteBufferNano.m17222d(4, intlNightClubConfig.longitude) + CodedOutputByteBufferNano.m17228j(5, intlNightClubConfig.startTimeStamp) + CodedOutputByteBufferNano.m17228j(6, intlNightClubConfig.endTimeStamp) + CodedOutputByteBufferNano.m17220b(7, intlNightClubConfig.enable) + CodedOutputByteBufferNano.m17226h(8, intlNightClubConfig.radiusMeter) + CodedOutputByteBufferNano.m17226h(9, intlNightClubConfig.swipePopNum) + CodedOutputByteBufferNano.m17226h(10, intlNightClubConfig.roundNum);
            intlNightClubConfig.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlNightClubConfig parse(nb5 nb5Var) throws IOException {
            IntlNightClubConfig intlNightClubConfig = new IntlNightClubConfig();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (intlNightClubConfig.f20427id == null) {
                            intlNightClubConfig.f20427id = "";
                        }
                        ...
                        break;
                    case 10:
                        intlNightClubConfig.f20427id = nb5Var.m158750s();
                        continue;
                    case 18:
                        intlNightClubConfig.address = nb5Var.m158750s();
                        continue;
                    case 25:
                        intlNightClubConfig.latitude = nb5Var.m158739h();
                        continue;
                    case 33:
                        intlNightClubConfig.longitude = nb5Var.m158739h();
                        continue;
                    case 40:
                        intlNightClubConfig.startTimeStamp = nb5Var.m158742k();
                        continue;
                    case 48:
                        intlNightClubConfig.endTimeStamp = nb5Var.m158742k();
                        continue;
                    case 56:
                        intlNightClubConfig.enable = nb5Var.m158738g();
                        continue;
                    case 64:
                        intlNightClubConfig.radiusMeter = nb5Var.m158741j();
                        continue;
                    case 72:
                        intlNightClubConfig.swipePopNum = nb5Var.m158741j();
                        continue;
                    case 80:
                        intlNightClubConfig.roundNum = nb5Var.m158741j();
                        continue;
                    default:
                        if (intlNightClubConfig.f20427id == null) {
                            intlNightClubConfig.f20427id = "";
        ...
        public void serialize(IntlNightClubConfig intlNightClubConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(3, intlNightClubConfig.latitude);
            codedOutputByteBufferNano.m17246C(4, intlNightClubConfig.longitude);
            codedOutputByteBufferNano.m17252I(5, intlNightClubConfig.startTimeStamp);
            codedOutputByteBufferNano.m17252I(6, intlNightClubConfig.endTimeStamp);
            codedOutputByteBufferNano.m17244A(7, intlNightClubConfig.enable);
            codedOutputByteBufferNano.m17250G(8, intlNightClubConfig.radiusMeter);
            codedOutputByteBufferNano.m17250G(9, intlNightClubConfig.swipePopNum);
            codedOutputByteBufferNano.m17250G(10, intlNightClubConfig.roundNum);
        }
    };
        ...
        public boolean parseField(IntlNightClubConfig intlNightClubConfig, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "roundNum":
                    ...
                    return true;
                case "id":
                    intlNightClubConfig.f20427id = jsonParser.getValueAsString();
                    return false;
                case "longitude":
    ...
    public IntlNightClubConfig mo223809clone() {
        IntlNightClubConfig intlNightClubConfig = new IntlNightClubConfig();
        intlNightClubConfig.f20427id = this.f20427id;
