...
public class IdealInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IdealInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<IdealInfo>() { // from class: com.p1.mobile.putong.core.data.IdealInfo.1
        ...
        public int computeAndCacheSize(IdealInfo idealInfo) {
            String str = idealInfo.f20421id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            List<IdealTag> list = idealInfo.fitIdeals;
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, list, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IdealTag> list2 = idealInfo.fitIdealDetails;
            if (list2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, list2, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (list4 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, list4, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IdealTag> list5 = idealInfo.targetFitIdeals;
            if (list5 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, list5, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IdealProfile> list6 = idealInfo.idealProfiles;
            if (list6 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, list6, IdealProfile.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<UserTagData> list7 = idealInfo.profileTags;
            if (list7 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(8, list7, UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<UserTagData> list8 = idealInfo.highlightProfileTags;
            if (list8 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(9, list8, UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            idealInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IdealInfo parse(nb5 nb5Var) throws IOException {
            IdealInfo idealInfo = new IdealInfo();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (idealInfo.f20421id == null) {
                        idealInfo.f20421id = "";
                    }
                ...
                if (iM158752u == 10) {
                    idealInfo.f20421id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    idealInfo.fitIdeals = (List) nb5Var.m158743l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 26) {
                    idealInfo.fitIdealDetails = (List) nb5Var.m158743l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 34) {
                    idealInfo.highlightProfiles = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 42) {
                    idealInfo.highlightIdeals = (List) nb5Var.m158743l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 50) {
                    idealInfo.targetFitIdeals = (List) nb5Var.m158743l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 58) {
                    idealInfo.idealProfiles = (List) nb5Var.m158743l(IdealProfile.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 66) {
                    idealInfo.profileTags = (List) nb5Var.m158743l(UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 74) {
                        if (idealInfo.f20421id == null) {
                            idealInfo.f20421id = "";
                    ...
                    idealInfo.highlightProfileTags = (List) nb5Var.m158743l(UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return idealInfo;
        }
        ...
        public void serialize(IdealInfo idealInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<IdealTag> list = idealInfo.fitIdeals;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(2, list, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IdealTag> list2 = idealInfo.fitIdealDetails;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(3, list2, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list3 = idealInfo.highlightProfiles;
            if (list3 != null) {
            ...
            List<IdealTag> list4 = idealInfo.highlightIdeals;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(5, list4, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IdealTag> list5 = idealInfo.targetFitIdeals;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(6, list5, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IdealProfile> list6 = idealInfo.idealProfiles;
            if (list6 != null) {
                codedOutputByteBufferNano.m17254K(7, list6, IdealProfile.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<UserTagData> list7 = idealInfo.profileTags;
            if (list7 != null) {
                codedOutputByteBufferNano.m17254K(8, list7, UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<UserTagData> list8 = idealInfo.highlightProfileTags;
            if (list8 != null) {
                codedOutputByteBufferNano.m17254K(9, list8, UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
        ...
        public boolean parseField(IdealInfo idealInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "targetFitIdeals":
                    ...
                    return true;
                case "id":
                    idealInfo.f20421id = jsonParser.getValueAsString();
                    return false;
    ...
    public static /* synthetic */ String m35599c(String str) {
        return str;
    }
    ...
    public IdealInfo mo223809clone() {
        IdealInfo idealInfo = new IdealInfo();
        idealInfo.f20421id = this.f20421id;
        ...
        if (list3 != null) {
            idealInfo.highlightProfiles = ValueObject.util_map(list3, new w9j() { // from class: l.rbm
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return IdealInfo.m35599c((String) obj);
                }
            });
        }
        ...
        if (list6 != null) {
            idealInfo.idealProfiles = ValueObject.util_map(list6, new w9j() { // from class: l.ubm
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((IdealProfile) obj).mo223809clone();
                }
            });
        }
