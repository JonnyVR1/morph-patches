...
public class MyMeetFeedItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MyMeetFeedItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<MyMeetFeedItem>() { // from class: com.p1.mobile.putong.core.data.MyMeetFeedItem.1
        ...
        public int computeAndCacheSize(MyMeetFeedItem myMeetFeedItem) {
            ...
            if (feedType != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, feedType, FeedType.PROTOBUF_ADAPTER);
            }
            MeetRelation meetRelation = myMeetFeedItem.relation;
            if (meetRelation != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, meetRelation, MeetRelation.PROTOBUF_ADAPTER);
            }
            OverHeatingStatus overHeatingStatus = myMeetFeedItem.overheating;
            if (overHeatingStatus != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(6, overHeatingStatus, OverHeatingStatus.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17230l + CodedOutputByteBufferNano.m17226h(7, myMeetFeedItem.seeCount) + CodedOutputByteBufferNano.m17226h(8, myMeetFeedItem.lowPopSeeCount);
            PickInfo pickInfo = myMeetFeedItem.pick;
            if (pickInfo != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(9, pickInfo, PickInfo.PROTOBUF_ADAPTER);
            }
            String str3 = myMeetFeedItem.f20453id;
            if (str3 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(10, str3);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(11, myMeetFeedItem.readStatus) + CodedOutputByteBufferNano.m17220b(12, myMeetFeedItem.online) + CodedOutputByteBufferNano.m17220b(13, myMeetFeedItem.passBy);
            String str4 = myMeetFeedItem.momentMediaType;
            if (str4 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(14, str4);
            }
            myMeetFeedItem.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MyMeetFeedItem parse(nb5 nb5Var) throws IOException {
            MyMeetFeedItem myMeetFeedItem = new MyMeetFeedItem();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (myMeetFeedItem.f20453id == null) {
                            myMeetFeedItem.f20453id = "";
                        }
                        ...
                        break;
                    case 10:
                        myMeetFeedItem.userIds = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        myMeetFeedItem.sortId = nb5Var.m158750s();
                        continue;
                    case 26:
                        myMeetFeedItem.momentId = nb5Var.m158750s();
                        continue;
                    case 34:
                        myMeetFeedItem.type = (FeedType) nb5Var.m158743l(FeedType.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        myMeetFeedItem.relation = (MeetRelation) nb5Var.m158743l(MeetRelation.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        myMeetFeedItem.overheating = (OverHeatingStatus) nb5Var.m158743l(OverHeatingStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 56:
                        myMeetFeedItem.seeCount = nb5Var.m158741j();
                        continue;
                    case 64:
                        myMeetFeedItem.lowPopSeeCount = nb5Var.m158741j();
                        continue;
                    case 74:
                        myMeetFeedItem.pick = (PickInfo) nb5Var.m158743l(PickInfo.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        myMeetFeedItem.f20453id = nb5Var.m158750s();
                        continue;
                    case 88:
                        myMeetFeedItem.readStatus = nb5Var.m158741j();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        myMeetFeedItem.online = nb5Var.m158738g();
                        continue;
                    case 104:
                        myMeetFeedItem.passBy = nb5Var.m158738g();
                        continue;
                    case 114:
                        myMeetFeedItem.momentMediaType = nb5Var.m158750s();
                        continue;
                    default:
                        if (myMeetFeedItem.f20453id == null) {
                            myMeetFeedItem.f20453id = "";
        ...
        public void serialize(MyMeetFeedItem myMeetFeedItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            FeedType feedType = myMeetFeedItem.type;
            if (feedType != null) {
                codedOutputByteBufferNano.m17254K(4, feedType, FeedType.PROTOBUF_ADAPTER);
            }
            MeetRelation meetRelation = myMeetFeedItem.relation;
            if (meetRelation != null) {
            ...
            OverHeatingStatus overHeatingStatus = myMeetFeedItem.overheating;
            if (overHeatingStatus != null) {
                codedOutputByteBufferNano.m17254K(6, overHeatingStatus, OverHeatingStatus.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(7, myMeetFeedItem.seeCount);
            codedOutputByteBufferNano.m17250G(8, myMeetFeedItem.lowPopSeeCount);
            PickInfo pickInfo = myMeetFeedItem.pick;
            if (pickInfo != null) {
                codedOutputByteBufferNano.m17254K(9, pickInfo, PickInfo.PROTOBUF_ADAPTER);
            }
            String str3 = myMeetFeedItem.f20453id;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(10, str3);
            }
            codedOutputByteBufferNano.m17250G(11, myMeetFeedItem.readStatus);
            codedOutputByteBufferNano.m17244A(12, myMeetFeedItem.online);
            codedOutputByteBufferNano.m17244A(13, myMeetFeedItem.passBy);
            String str4 = myMeetFeedItem.momentMediaType;
            if (str4 != null) {
    ...
    public static JsonAdapter<MyMeetFeedItem> JSON_ADAPTER = new ObjectJsonAdapter<MyMeetFeedItem>() { // from class: com.p1.mobile.putong.core.data.MyMeetFeedItem.2
        ...
        public boolean parseField(MyMeetFeedItem myMeetFeedItem, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    myMeetFeedItem.f20453id = jsonParser.getValueAsString();
                    return false;
                case 9:
        ...
        public void serializeFields(MyMeetFeedItem myMeetFeedItem, JsonGenerator jsonGenerator) throws IOException {
            String str = myMeetFeedItem.f20453id;
            if (str != null) {
    ...
    public static /* synthetic */ String m35709a(String str) {
        return str;
    }
    ...
    public MyMeetFeedItem mo223809clone() {
        MyMeetFeedItem myMeetFeedItem = new MyMeetFeedItem();
        myMeetFeedItem.f20453id = this.f20453id;
        List<String> list = this.userIds;
        if (list != null) {
            myMeetFeedItem.userIds = ValueObject.util_map(list, new w9j() { // from class: l.dv10
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return MyMeetFeedItem.m35709a((String) obj);
                }
            });
        }
