...
public class FreeTrialInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FreeTrialInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<FreeTrialInfo>() { // from class: com.p1.mobile.putong.core.data.FreeTrialInfo.1
        ...
        public int computeAndCacheSize(FreeTrialInfo freeTrialInfo) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, freeTrialInfo.popLevel) + CodedOutputByteBufferNano.m17220b(2, freeTrialInfo.allowTrial);
            Map<String, FreeTrialConfig> map = freeTrialInfo.config;
            if (map != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(3, map, FreeTrialConfig.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            List<FreeTrialRecords> list = freeTrialInfo.records;
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, list, FreeTrialRecords.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            freeTrialInfo.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FreeTrialInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    freeTrialInfo.popLevel = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    freeTrialInfo.allowTrial = nb5Var.m158738g();
                } else if (iM158752u == 26) {
                    freeTrialInfo.config = (Map) nb5Var.m158743l(FreeTrialConfig.PROTOBUF_ADAPTER.MAP_ADAPTER());
                } else {
                    if (iM158752u != 34) {
                        if (freeTrialInfo.config == null) {
                            freeTrialInfo.config = Collections.EMPTY_MAP;
                    ...
                    freeTrialInfo.records = (List) nb5Var.m158743l(FreeTrialRecords.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return freeTrialInfo;
        }
        ...
        public void serialize(FreeTrialInfo freeTrialInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, freeTrialInfo.popLevel);
            codedOutputByteBufferNano.m17244A(2, freeTrialInfo.allowTrial);
            Map<String, FreeTrialConfig> map = freeTrialInfo.config;
            if (map != null) {
                codedOutputByteBufferNano.m17254K(3, map, FreeTrialConfig.PROTOBUF_ADAPTER.MAP_ADAPTER());
            }
            List<FreeTrialRecords> list = freeTrialInfo.records;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(4, list, FreeTrialRecords.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public FreeTrialInfo mo223809clone() {
        FreeTrialInfo freeTrialInfo = new FreeTrialInfo();
        ...
        if (map != null) {
            freeTrialInfo.config = ValueObject.util_map(map, new w9j() { // from class: l.h6j
                ...
                public final Object call(Object obj) {
                    return ((FreeTrialConfig) obj).mo223809clone();
                }
            });
        }
        ...
        if (list != null) {
            freeTrialInfo.records = ValueObject.util_map(list, new w9j() { // from class: l.i6j
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((FreeTrialRecords) obj).mo223809clone();
                }
            });
        }
        return freeTrialInfo;
