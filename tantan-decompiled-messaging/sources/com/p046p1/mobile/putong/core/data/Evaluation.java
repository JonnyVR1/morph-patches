...
public class Evaluation extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Evaluation> PROTOBUF_ADAPTER = new MessageNanoAdapter<Evaluation>() { // from class: com.p1.mobile.putong.core.data.Evaluation.1
        ...
        public int computeAndCacheSize(Evaluation evaluation) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, evaluation.f20388id) + CodedOutputByteBufferNano.m17228j(2, evaluation.type);
            ...
            if (str2 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(4, str2);
            }
            String str3 = evaluation.pictureUrl;
            if (str3 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(5, str3);
            }
            int iM17226h = iM17228j + CodedOutputByteBufferNano.m17226h(6, evaluation.coinPrice) + CodedOutputByteBufferNano.m17228j(7, evaluation.soldNum) + CodedOutputByteBufferNano.m17228j(8, evaluation.status) + CodedOutputByteBufferNano.m17226h(9, evaluation.scaleType);
            String str4 = evaluation.detailUrl;
            if (str4 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(10, str4);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(11, evaluation.coinOriginalPrice);
            String str5 = evaluation.activityType;
            if (str5 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(12, str5);
            }
            String str6 = evaluation.topicSource;
            if (str6 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(13, str6);
            }
            evaluation.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Evaluation parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        evaluation.f20388id = nb5Var.m158742k();
                        continue;
                    case 16:
                        evaluation.type = nb5Var.m158742k();
                        continue;
                    case 26:
                        evaluation.name = nb5Var.m158750s();
                        continue;
                    case 34:
                        evaluation.description = nb5Var.m158750s();
                        continue;
                    case 42:
                        evaluation.pictureUrl = nb5Var.m158750s();
                        continue;
                    case 48:
                        evaluation.coinPrice = nb5Var.m158741j();
                        continue;
                    case 56:
                        evaluation.soldNum = nb5Var.m158742k();
                        continue;
                    case 64:
                        evaluation.status = nb5Var.m158742k();
                        continue;
                    case 72:
                        evaluation.scaleType = nb5Var.m158741j();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        evaluation.detailUrl = nb5Var.m158750s();
                        continue;
                    case 88:
                        evaluation.coinOriginalPrice = nb5Var.m158741j();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        evaluation.activityType = nb5Var.m158750s();
                        continue;
                    case 106:
                        evaluation.topicSource = nb5Var.m158750s();
                        continue;
                    default:
                        if (evaluation.name == null) {
                            evaluation.name = "";
        ...
        public void serialize(Evaluation evaluation, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, evaluation.f20388id);
            codedOutputByteBufferNano.m17252I(2, evaluation.type);
            String str = evaluation.name;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17250G(6, evaluation.coinPrice);
            codedOutputByteBufferNano.m17252I(7, evaluation.soldNum);
            codedOutputByteBufferNano.m17252I(8, evaluation.status);
            codedOutputByteBufferNano.m17250G(9, evaluation.scaleType);
            String str4 = evaluation.detailUrl;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(10, str4);
            }
            codedOutputByteBufferNano.m17250G(11, evaluation.coinOriginalPrice);
            String str5 = evaluation.activityType;
            if (str5 != null) {
    ...
    public static JsonAdapter<Evaluation> JSON_ADAPTER = new ObjectJsonAdapter<Evaluation>() { // from class: com.p1.mobile.putong.core.data.Evaluation.2
        ...
        public boolean parseField(Evaluation evaluation, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "topicSource":
                    ...
                    return true;
                case "id":
                    evaluation.f20388id = jsonParser.getValueAsLong();
                    return false;
                case "name":
        ...
        public void serializeFields(Evaluation evaluation, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", evaluation.f20388id);
    ...
    public Evaluation mo223809clone() {
        Evaluation evaluation = new Evaluation();
        evaluation.f20388id = this.f20388id;
