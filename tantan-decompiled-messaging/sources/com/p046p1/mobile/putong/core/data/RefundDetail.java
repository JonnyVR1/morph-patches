...
public class RefundDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RefundDetail> PROTOBUF_ADAPTER = new MessageNanoAdapter<RefundDetail>() { // from class: com.p1.mobile.putong.core.data.RefundDetail.1
        ...
        public int computeAndCacheSize(RefundDetail refundDetail) {
            String str = refundDetail.f20491id;
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17222d(2, refundDetail.totalRefundAmount);
            refundDetail.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RefundDetail parse(nb5 nb5Var) throws IOException {
            RefundDetail refundDetail = new RefundDetail();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (refundDetail.f20491id != null) {
                        break;
                    }
                    refundDetail.f20491id = "";
                    break;
                }
                if (iM158752u == 10) {
                    refundDetail.f20491id = nb5Var.m158750s();
                } else {
                    if (iM158752u != 17) {
                        if (refundDetail.f20491id != null) {
                            break;
                    ...
                    refundDetail.totalRefundAmount = nb5Var.m158739h();
                }
            }
            return refundDetail;
        }
        ...
        public void serialize(RefundDetail refundDetail, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(2, refundDetail.totalRefundAmount);
        }
    };
    public static JsonAdapter<RefundDetail> JSON_ADAPTER = new ObjectJsonAdapter<RefundDetail>() { // from class: com.p1.mobile.putong.core.data.RefundDetail.2
        ...
        public boolean parseField(RefundDetail refundDetail, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            str.getClass();
            if (str.equals("id")) {
                refundDetail.f20491id = jsonParser.getValueAsString();
                return false;
            }
    ...
    public RefundDetail mo223809clone() {
        RefundDetail refundDetail = new RefundDetail();
        refundDetail.f20491id = this.f20491id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20491id, refundDetail.f20491id) && this.totalRefundAmount == refundDetail.totalRefundAmount;
    }
