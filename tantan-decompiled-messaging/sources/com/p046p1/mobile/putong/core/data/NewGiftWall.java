...
public class NewGiftWall extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NewGiftWall> PROTOBUF_ADAPTER = new MessageNanoAdapter<NewGiftWall>() { // from class: com.p1.mobile.putong.core.data.NewGiftWall.1
        ...
        public int computeAndCacheSize(NewGiftWall newGiftWall) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, newGiftWall.count);
            CoreGiftInfo coreGiftInfo = newGiftWall.giftInfo;
            if (coreGiftInfo != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(2, coreGiftInfo, CoreGiftInfo.PROTOBUF_ADAPTER);
            }
            String str = newGiftWall.f20454id;
            if (str != null) {
            ...
            newGiftWall.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NewGiftWall parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    ...
                    if (newGiftWall.f20454id == null) {
                        newGiftWall.f20454id = "";
                    }
                ...
                if (iM158752u == 8) {
                    newGiftWall.count = nb5Var.m158741j();
                } else if (iM158752u == 18) {
                    newGiftWall.giftInfo = (CoreGiftInfo) nb5Var.m158743l(CoreGiftInfo.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    newGiftWall.f20454id = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    newGiftWall.totalPrice = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (newGiftWall.giftInfo == null) {
                            newGiftWall.giftInfo = CoreGiftInfo.new_();
                    ...
                    newGiftWall.unitPrice = nb5Var.m158750s();
                }
            }
            return newGiftWall;
        }
        ...
        public void serialize(NewGiftWall newGiftWall, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, newGiftWall.count);
            CoreGiftInfo coreGiftInfo = newGiftWall.giftInfo;
            if (coreGiftInfo != null) {
                codedOutputByteBufferNano.m17254K(2, coreGiftInfo, CoreGiftInfo.PROTOBUF_ADAPTER);
            }
            String str = newGiftWall.f20454id;
            if (str != null) {
        ...
        public boolean parseField(NewGiftWall newGiftWall, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "unitPrice":
                    ...
                    return true;
                case "id":
                    newGiftWall.f20454id = jsonParser.getValueAsString();
                    return false;
                case "count":
    ...
    public NewGiftWall mo223809clone() {
        NewGiftWall newGiftWall = new NewGiftWall();
        newGiftWall.count = this.count;
        CoreGiftInfo coreGiftInfo = this.giftInfo;
        if (coreGiftInfo != null) {
            newGiftWall.giftInfo = coreGiftInfo.mo223809clone();
        }
        newGiftWall.f20454id = this.f20454id;
    ...
    public boolean equals(Object obj) {
        ...
        return this.count == newGiftWall.count && ValueObject.util_equals(this.giftInfo, newGiftWall.giftInfo) && ValueObject.util_equals(this.f20454id, newGiftWall.f20454id) && ValueObject.util_equals(this.totalPrice, newGiftWall.totalPrice) && ValueObject.util_equals(this.unitPrice, newGiftWall.unitPrice);
    }
