...
public class PurchaseDialogConfigTrigger extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PurchaseDialogConfigTrigger> PROTOBUF_ADAPTER = new MessageNanoAdapter<PurchaseDialogConfigTrigger>() { // from class: com.p1.mobile.putong.core.data.PurchaseDialogConfigTrigger.1
        ...
        public int computeAndCacheSize(PurchaseDialogConfigTrigger purchaseDialogConfigTrigger) {
            ...
            if (purchaseDialogConfigTriggerShowType != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(2, purchaseDialogConfigTriggerShowType.ordinal());
            }
            ProductCategory productCategory = purchaseDialogConfigTrigger.defaultCategory;
            if (productCategory != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(3, productCategory.ordinal());
            }
            ...
            if (purchaseDialogConfigTriggerShowType2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, purchaseDialogConfigTriggerShowType2, PurchaseDialogConfigTriggerShowType.PROTOBUF_ADAPTER);
            }
            ProductCategory productCategory2 = purchaseDialogConfigTrigger.defaultCategory;
            if (productCategory2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            purchaseDialogConfigTrigger.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PurchaseDialogConfigTrigger parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    if (purchaseDialogConfigTrigger.showType == null && numValueOf != null) {
                        purchaseDialogConfigTrigger.showType = (PurchaseDialogConfigTriggerShowType) PurchaseDialogConfigTriggerShowType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    }
                    if (purchaseDialogConfigTrigger.defaultCategory == null && numValueOf2 != null) {
                        purchaseDialogConfigTrigger.defaultCategory = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf2.intValue());
                    }
                ...
                if (iM158752u == 10) {
                    purchaseDialogConfigTrigger.membership = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    numValueOf = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 24) {
                    numValueOf2 = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 34) {
                    purchaseDialogConfigTrigger.showType = (PurchaseDialogConfigTriggerShowType) nb5Var.m158743l(PurchaseDialogConfigTriggerShowType.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 42) {
                        if (purchaseDialogConfigTrigger.showType == null && numValueOf != null) {
                            purchaseDialogConfigTrigger.showType = (PurchaseDialogConfigTriggerShowType) PurchaseDialogConfigTriggerShowType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    purchaseDialogConfigTrigger.defaultCategory = (ProductCategory) nb5Var.m158743l(ProductCategory.PROTOBUF_ADAPTER);
                }
            }
            return purchaseDialogConfigTrigger;
        }
        ...
        public void serialize(PurchaseDialogConfigTrigger purchaseDialogConfigTrigger, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            PurchaseDialogConfigTriggerShowType purchaseDialogConfigTriggerShowType = purchaseDialogConfigTrigger.showType;
            if (purchaseDialogConfigTriggerShowType != null) {
                codedOutputByteBufferNano.m17250G(2, purchaseDialogConfigTriggerShowType.ordinal());
            }
            ProductCategory productCategory = purchaseDialogConfigTrigger.defaultCategory;
            if (productCategory != null) {
            ...
            PurchaseDialogConfigTriggerShowType purchaseDialogConfigTriggerShowType2 = purchaseDialogConfigTrigger.showType;
            if (purchaseDialogConfigTriggerShowType2 != null) {
                codedOutputByteBufferNano.m17254K(4, purchaseDialogConfigTriggerShowType2, PurchaseDialogConfigTriggerShowType.PROTOBUF_ADAPTER);
            }
            ProductCategory productCategory2 = purchaseDialogConfigTrigger.defaultCategory;
            if (productCategory2 != null) {
                codedOutputByteBufferNano.m17254K(5, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<PurchaseDialogConfigTrigger> JSON_ADAPTER = new ObjectJsonAdapter<PurchaseDialogConfigTrigger>() { // from class: com.p1.mobile.putong.core.data.PurchaseDialogConfigTrigger.2
        ...
        public PurchaseDialogConfigTrigger newInstance() {
        ...
        public boolean parseField(PurchaseDialogConfigTrigger purchaseDialogConfigTrigger, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "membership":
                    ...
                    return true;
                case "showType":
                    purchaseDialogConfigTrigger.showType = PurchaseDialogConfigTriggerShowType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "defaultCategory":
                    purchaseDialogConfigTrigger.defaultCategory = ProductCategory.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                default:
                    return false;
            }
    ...
    public PurchaseDialogConfigTrigger mo223809clone() {
        PurchaseDialogConfigTrigger purchaseDialogConfigTrigger = new PurchaseDialogConfigTrigger();
