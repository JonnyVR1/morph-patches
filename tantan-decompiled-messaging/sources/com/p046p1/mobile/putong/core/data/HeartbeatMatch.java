...
public class HeartbeatMatch extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<HeartbeatMatch> PROTOBUF_ADAPTER = new MessageNanoAdapter<HeartbeatMatch>() { // from class: com.p1.mobile.putong.core.data.HeartbeatMatch.1
        ...
        public int computeAndCacheSize(HeartbeatMatch heartbeatMatch) {
            int iM17222d = CodedOutputByteBufferNano.m17222d(1, heartbeatMatch.expireTime) + CodedOutputByteBufferNano.m17220b(2, heartbeatMatch.isPassive) + CodedOutputByteBufferNano.m17222d(3, heartbeatMatch.acceptTime);
            String str = heartbeatMatch.source;
            if (str != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(4, str);
            }
            int iM17220b = iM17222d + CodedOutputByteBufferNano.m17220b(5, heartbeatMatch.lock);
            String str2 = heartbeatMatch.tracker;
            if (str2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(6, str2);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(7, heartbeatMatch.guideFakeToGood) + CodedOutputByteBufferNano.m17226h(8, heartbeatMatch.matchType);
            String str3 = heartbeatMatch.greetText;
            if (str3 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(9, str3);
            }
            String str4 = heartbeatMatch.greetEmoji;
            if (str4 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(10, str4);
            }
            heartbeatMatch.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public HeartbeatMatch parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 9:
                        heartbeatMatch.expireTime = nb5Var.m158739h();
                        continue;
                    case 16:
                        heartbeatMatch.isPassive = nb5Var.m158738g();
                        continue;
                    case 25:
                        heartbeatMatch.acceptTime = nb5Var.m158739h();
                        continue;
                    case 34:
                        heartbeatMatch.source = nb5Var.m158750s();
                        continue;
                    case 40:
                        heartbeatMatch.lock = nb5Var.m158738g();
                        continue;
                    case 50:
                        heartbeatMatch.tracker = nb5Var.m158750s();
                        continue;
                    case 56:
                        heartbeatMatch.guideFakeToGood = nb5Var.m158738g();
                        continue;
                    case 64:
                        heartbeatMatch.matchType = nb5Var.m158741j();
                        continue;
                    case 74:
                        heartbeatMatch.greetText = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        heartbeatMatch.greetEmoji = nb5Var.m158750s();
                        continue;
                    default:
                        if (heartbeatMatch.source == null) {
                            heartbeatMatch.source = "";
        ...
        public void serialize(HeartbeatMatch heartbeatMatch, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17246C(1, heartbeatMatch.expireTime);
            codedOutputByteBufferNano.m17244A(2, heartbeatMatch.isPassive);
            codedOutputByteBufferNano.m17246C(3, heartbeatMatch.acceptTime);
            String str = heartbeatMatch.source;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(4, str);
            }
            codedOutputByteBufferNano.m17244A(5, heartbeatMatch.lock);
            String str2 = heartbeatMatch.tracker;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(6, str2);
            }
            codedOutputByteBufferNano.m17244A(7, heartbeatMatch.guideFakeToGood);
            codedOutputByteBufferNano.m17250G(8, heartbeatMatch.matchType);
            String str3 = heartbeatMatch.greetText;
            if (str3 != null) {
    ...
    public HeartbeatMatch mo223809clone() {
        HeartbeatMatch heartbeatMatch = new HeartbeatMatch();
