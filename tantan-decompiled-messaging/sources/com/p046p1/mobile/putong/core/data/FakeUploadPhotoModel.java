...
public class FakeUploadPhotoModel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FakeUploadPhotoModel> PROTOBUF_ADAPTER = new MessageNanoAdapter<FakeUploadPhotoModel>() { // from class: com.p1.mobile.putong.core.data.FakeUploadPhotoModel.1
        ...
        public int computeAndCacheSize(FakeUploadPhotoModel fakeUploadPhotoModel) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, fakeUploadPhotoModel.enable) + CodedOutputByteBufferNano.m17226h(2, fakeUploadPhotoModel.new_female_swipe_count) + CodedOutputByteBufferNano.m17226h(3, fakeUploadPhotoModel.new_female_right_swipe_count) + CodedOutputByteBufferNano.m17226h(4, fakeUploadPhotoModel.new_male_swipe_count) + CodedOutputByteBufferNano.m17226h(5, fakeUploadPhotoModel.new_male_right_swipe_count) + CodedOutputByteBufferNano.m17226h(6, fakeUploadPhotoModel.female_swipe_count) + CodedOutputByteBufferNano.m17226h(7, fakeUploadPhotoModel.female_right_swipe_count) + CodedOutputByteBufferNano.m17226h(8, fakeUploadPhotoModel.male_swipe_count) + CodedOutputByteBufferNano.m17226h(9, fakeUploadPhotoModel.male_right_swipe_count) + CodedOutputByteBufferNano.m17226h(10, fakeUploadPhotoModel.new_profile_count) + CodedOutputByteBufferNano.m17226h(11, fakeUploadPhotoModel.male_profile_count) + CodedOutputByteBufferNano.m17226h(12, fakeUploadPhotoModel.female_profile_count);
            fakeUploadPhotoModel.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FakeUploadPhotoModel parse(nb5 nb5Var) throws IOException {
            FakeUploadPhotoModel fakeUploadPhotoModel = new FakeUploadPhotoModel();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 8:
                        fakeUploadPhotoModel.enable = nb5Var.m158738g();
                        break;
                    case 16:
                        fakeUploadPhotoModel.new_female_swipe_count = nb5Var.m158741j();
                        break;
                    case 24:
                        fakeUploadPhotoModel.new_female_right_swipe_count = nb5Var.m158741j();
                        break;
                    case 32:
                        fakeUploadPhotoModel.new_male_swipe_count = nb5Var.m158741j();
                        break;
                    case 40:
                        fakeUploadPhotoModel.new_male_right_swipe_count = nb5Var.m158741j();
                        break;
                    case 48:
                        fakeUploadPhotoModel.female_swipe_count = nb5Var.m158741j();
                        break;
                    case 56:
                        fakeUploadPhotoModel.female_right_swipe_count = nb5Var.m158741j();
                        break;
                    case 64:
                        fakeUploadPhotoModel.male_swipe_count = nb5Var.m158741j();
                        break;
                    case 72:
                        fakeUploadPhotoModel.male_right_swipe_count = nb5Var.m158741j();
                        break;
                    case 80:
                        fakeUploadPhotoModel.new_profile_count = nb5Var.m158741j();
                        break;
                    case 88:
                        fakeUploadPhotoModel.male_profile_count = nb5Var.m158741j();
                        break;
                    case Opcodes.IADD /* 96 */:
                        fakeUploadPhotoModel.female_profile_count = nb5Var.m158741j();
                        break;
                    default:
        ...
        public void serialize(FakeUploadPhotoModel fakeUploadPhotoModel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, fakeUploadPhotoModel.enable);
            codedOutputByteBufferNano.m17250G(2, fakeUploadPhotoModel.new_female_swipe_count);
            codedOutputByteBufferNano.m17250G(3, fakeUploadPhotoModel.new_female_right_swipe_count);
            codedOutputByteBufferNano.m17250G(4, fakeUploadPhotoModel.new_male_swipe_count);
            codedOutputByteBufferNano.m17250G(5, fakeUploadPhotoModel.new_male_right_swipe_count);
            codedOutputByteBufferNano.m17250G(6, fakeUploadPhotoModel.female_swipe_count);
            codedOutputByteBufferNano.m17250G(7, fakeUploadPhotoModel.female_right_swipe_count);
            codedOutputByteBufferNano.m17250G(8, fakeUploadPhotoModel.male_swipe_count);
            codedOutputByteBufferNano.m17250G(9, fakeUploadPhotoModel.male_right_swipe_count);
            codedOutputByteBufferNano.m17250G(10, fakeUploadPhotoModel.new_profile_count);
            codedOutputByteBufferNano.m17250G(11, fakeUploadPhotoModel.male_profile_count);
            codedOutputByteBufferNano.m17250G(12, fakeUploadPhotoModel.female_profile_count);
        }
    };
    ...
    public FakeUploadPhotoModel mo223809clone() {
        FakeUploadPhotoModel fakeUploadPhotoModel = new FakeUploadPhotoModel();
