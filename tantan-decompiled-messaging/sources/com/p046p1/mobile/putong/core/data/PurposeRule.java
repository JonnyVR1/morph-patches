...
public class PurposeRule extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PurposeRule> PROTOBUF_ADAPTER = new MessageNanoAdapter<PurposeRule>() { // from class: com.p1.mobile.putong.core.data.PurposeRule.1
        ...
        public int computeAndCacheSize(PurposeRule purposeRule) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, purposeRule.cardShowPurpose) + CodedOutputByteBufferNano.m17226h(2, purposeRule.picNum);
            List<PurposeItemData> list = purposeRule.purposeRule;
            if (list != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(3, list, PurposeItemData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            purposeRule.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PurposeRule parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    purposeRule.cardShowPurpose = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    purposeRule.picNum = nb5Var.m158741j();
                } else {
                    if (iM158752u != 26) {
                        if (purposeRule.purposeRule != null) {
                            break;
                    ...
                    purposeRule.purposeRule = (List) nb5Var.m158743l(PurposeItemData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return purposeRule;
        }
        ...
        public void serialize(PurposeRule purposeRule, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, purposeRule.cardShowPurpose);
            codedOutputByteBufferNano.m17250G(2, purposeRule.picNum);
            List<PurposeItemData> list = purposeRule.purposeRule;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, PurposeItemData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public PurposeRule mo223809clone() {
        PurposeRule purposeRule = new PurposeRule();
        ...
        if (list != null) {
            purposeRule.purposeRule = ValueObject.util_map(list, new w9j() { // from class: l.vcb0
                ...
                public final Object call(Object obj) {
                    return ((PurposeItemData) obj).mo223809clone();
                }
            });
        }
        return purposeRule;
