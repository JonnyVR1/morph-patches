...
public class ProfileGuideInputHint extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ProfileGuideInputHint> PROTOBUF_ADAPTER = new MessageNanoAdapter<ProfileGuideInputHint>() { // from class: com.p1.mobile.putong.core.data.ProfileGuideInputHint.1
        ...
        public int computeAndCacheSize(ProfileGuideInputHint profileGuideInputHint) {
            ...
            profileGuideInputHint.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ProfileGuideInputHint parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    profileGuideInputHint.school = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    profileGuideInputHint.major = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    profileGuideInputHint.company = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    profileGuideInputHint.recent = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    profileGuideInputHint.together = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    profileGuideInputHint.hobby = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (profileGuideInputHint.school == null) {
                            profileGuideInputHint.school = "";
                    ...
                    profileGuideInputHint.description = nb5Var.m158750s();
                }
            }
            return profileGuideInputHint;
        }
    ...
    public ProfileGuideInputHint mo223809clone() {
        ProfileGuideInputHint profileGuideInputHint = new ProfileGuideInputHint();
