...
public class MarriageGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MarriageGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<MarriageGuide>() { // from class: com.p1.mobile.putong.core.data.MarriageGuide.1
        ...
        public int computeAndCacheSize(MarriageGuide marriageGuide) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, marriageGuide.qualityCondition) + CodedOutputByteBufferNano.m17220b(2, marriageGuide.momentCondition);
            List<DynamicLable> list = marriageGuide.dynamicLables;
            if (list != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(3, list, DynamicLable.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            marriageGuide.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MarriageGuide parse(nb5 nb5Var) throws IOException {
            MarriageGuide marriageGuide = new MarriageGuide();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    marriageGuide.qualityCondition = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    marriageGuide.momentCondition = nb5Var.m158738g();
                } else {
                    if (iM158752u != 26) {
                        return marriageGuide;
                    }
                    marriageGuide.dynamicLables = (List) nb5Var.m158743l(DynamicLable.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
        }
        ...
        public void serialize(MarriageGuide marriageGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, marriageGuide.qualityCondition);
            codedOutputByteBufferNano.m17244A(2, marriageGuide.momentCondition);
            List<DynamicLable> list = marriageGuide.dynamicLables;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, DynamicLable.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public MarriageGuide mo223809clone() {
        MarriageGuide marriageGuide = new MarriageGuide();
