...
public class IntlMarketTransitSummaryData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlMarketTransitSummaryData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlMarketTransitSummaryData>() { // from class: com.p1.mobile.putong.core.data.IntlMarketTransitSummaryData.1
        ...
        public int computeAndCacheSize(IntlMarketTransitSummaryData intlMarketTransitSummaryData) {
            ...
            intlMarketTransitSummaryData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlMarketTransitSummaryData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    intlMarketTransitSummaryData.bg_color = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    intlMarketTransitSummaryData.main_title = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    intlMarketTransitSummaryData.main_title_font_color = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    intlMarketTransitSummaryData.count_down_font_color = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    intlMarketTransitSummaryData.passed_progress_bar_color = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    intlMarketTransitSummaryData.remain_progress_bar_color = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    intlMarketTransitSummaryData.bottom_font_color = nb5Var.m158750s();
                } else {
                    if (iM158752u != 66) {
                        if (intlMarketTransitSummaryData.bg_color == null) {
                            intlMarketTransitSummaryData.bg_color = "";
                    ...
                    intlMarketTransitSummaryData.bg_url = nb5Var.m158750s();
                }
            }
            return intlMarketTransitSummaryData;
        }
    ...
    public IntlMarketTransitSummaryData mo223809clone() {
        IntlMarketTransitSummaryData intlMarketTransitSummaryData = new IntlMarketTransitSummaryData();
