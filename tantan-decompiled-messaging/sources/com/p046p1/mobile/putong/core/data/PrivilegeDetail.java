...
public class PrivilegeDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PrivilegeDetail> PROTOBUF_ADAPTER = new MessageNanoAdapter<PrivilegeDetail>() { // from class: com.p1.mobile.putong.core.data.PrivilegeDetail.1
        ...
        public int computeAndCacheSize(PrivilegeDetail privilegeDetail) {
            ...
            int iM17228j = iM17233o + CodedOutputByteBufferNano.m17228j(3, privilegeDetail.duration) + CodedOutputByteBufferNano.m17228j(4, privilegeDetail.expireAt) + CodedOutputByteBufferNano.m17228j(5, privilegeDetail.count) + CodedOutputByteBufferNano.m17228j(6, privilegeDetail.remaining);
            privilegeDetail.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PrivilegeDetail parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    privilegeDetail.channel = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    privilegeDetail.privilegeType = nb5Var.m158750s();
                } else if (iM158752u == 24) {
                    privilegeDetail.duration = nb5Var.m158742k();
                } else if (iM158752u == 32) {
                    privilegeDetail.expireAt = nb5Var.m158742k();
                } else if (iM158752u == 40) {
                    privilegeDetail.count = nb5Var.m158742k();
                } else {
                    if (iM158752u != 48) {
                        if (privilegeDetail.channel == null) {
                            privilegeDetail.channel = "";
                    ...
                    privilegeDetail.remaining = nb5Var.m158742k();
                }
            }
            return privilegeDetail;
        }
        ...
        public void serialize(PrivilegeDetail privilegeDetail, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(3, privilegeDetail.duration);
            codedOutputByteBufferNano.m17252I(4, privilegeDetail.expireAt);
            codedOutputByteBufferNano.m17252I(5, privilegeDetail.count);
            codedOutputByteBufferNano.m17252I(6, privilegeDetail.remaining);
        }
    };
    ...
    public PrivilegeDetail mo223809clone() {
        PrivilegeDetail privilegeDetail = new PrivilegeDetail();
