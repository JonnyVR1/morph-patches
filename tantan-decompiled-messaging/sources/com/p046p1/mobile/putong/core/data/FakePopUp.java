...
public class FakePopUp extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FakePopUp> PROTOBUF_ADAPTER = new MessageNanoAdapter<FakePopUp>() { // from class: com.p1.mobile.putong.core.data.FakePopUp.1
        ...
        public int computeAndCacheSize(FakePopUp fakePopUp) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17220b(2, fakePopUp.showFakeGuide);
            fakePopUp.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FakePopUp parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    fakePopUp.userId = nb5Var.m158750s();
                } else {
                    if (iM158752u != 16) {
                        if (fakePopUp.userId != null) {
                            break;
                    ...
                    fakePopUp.showFakeGuide = nb5Var.m158738g();
                }
            }
            return fakePopUp;
        }
        ...
        public void serialize(FakePopUp fakePopUp, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(2, fakePopUp.showFakeGuide);
        }
    };
    ...
    public FakePopUp mo223809clone() {
        FakePopUp fakePopUp = new FakePopUp();
