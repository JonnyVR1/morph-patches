...
public class InstantMatchUserInfo extends IntlBaseVisitorInfo implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<InstantMatchUserInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<InstantMatchUserInfo>() { // from class: com.p1.mobile.putong.core.data.InstantMatchUserInfo.1
        ...
        public int computeAndCacheSize(InstantMatchUserInfo instantMatchUserInfo) {
            ...
            instantMatchUserInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public InstantMatchUserInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    instantMatchUserInfo.userID = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    instantMatchUserInfo.title = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (instantMatchUserInfo.userID == null) {
                            instantMatchUserInfo.userID = "";
                    ...
                    instantMatchUserInfo.describe = nb5Var.m158750s();
                }
            }
            return instantMatchUserInfo;
        }
    ...
    @Override // com.p046p1.mobile.putong.core.data.IntlBaseVisitorInfo, com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public InstantMatchUserInfo mo223809clone() {
        InstantMatchUserInfo instantMatchUserInfo = new InstantMatchUserInfo();
    ...
    @Override // com.p046p1.mobile.putong.core.data.IntlBaseVisitorInfo
    ...
    @Override // com.p046p1.mobile.putong.core.data.IntlBaseVisitorInfo, com.tantanapp.common.data.ValueObject
