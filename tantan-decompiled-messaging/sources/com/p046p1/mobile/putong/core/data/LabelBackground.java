...
public class LabelBackground extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LabelBackground> PROTOBUF_ADAPTER = new MessageNanoAdapter<LabelBackground>() { // from class: com.p1.mobile.putong.core.data.LabelBackground.1
        ...
        public int computeAndCacheSize(LabelBackground labelBackground) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, labelBackground.imageBackgroundWidth) + CodedOutputByteBufferNano.m17226h(3, labelBackground.imageBackgroundHeight);
            LabelBgStyle labelBgStyle = labelBackground.bgStyle;
            if (labelBgStyle != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, labelBgStyle, LabelBgStyle.PROTOBUF_ADAPTER);
            }
            labelBackground.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LabelBackground parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    labelBackground.imageBackground = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    labelBackground.imageBackgroundWidth = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    labelBackground.imageBackgroundHeight = nb5Var.m158741j();
                } else {
                    if (iM158752u != 34) {
                        if (labelBackground.imageBackground == null) {
                            labelBackground.imageBackground = "";
                    ...
                    labelBackground.bgStyle = (LabelBgStyle) nb5Var.m158743l(LabelBgStyle.PROTOBUF_ADAPTER);
                }
            }
            return labelBackground;
        }
        ...
        public void serialize(LabelBackground labelBackground, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, labelBackground.imageBackgroundWidth);
            codedOutputByteBufferNano.m17250G(3, labelBackground.imageBackgroundHeight);
            LabelBgStyle labelBgStyle = labelBackground.bgStyle;
            if (labelBgStyle != null) {
                codedOutputByteBufferNano.m17254K(4, labelBgStyle, LabelBgStyle.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LabelBackground mo223809clone() {
        LabelBackground labelBackground = new LabelBackground();
        ...
        if (labelBgStyle != null) {
            labelBackground.bgStyle = labelBgStyle.mo223809clone();
        }
        return labelBackground;
    }
