...
public class DynamicSchemaMsgData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DynamicSchemaMsgData> PROTOBUF_ADAPTER = new MessageNanoAdapter<DynamicSchemaMsgData>() { // from class: com.p1.mobile.putong.core.data.DynamicSchemaMsgData.1
        ...
        public int computeAndCacheSize(DynamicSchemaMsgData dynamicSchemaMsgData) {
            ...
            int iM17230l = messageView != null ? CodedOutputByteBufferNano.m17230l(1, messageView, MessageView.PROTOBUF_ADAPTER) : 0;
            ...
            if (map != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(7, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            String str6 = dynamicSchemaMsgData.action;
            if (str6 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(8, str6);
            }
            String str7 = dynamicSchemaMsgData.source;
            if (str7 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(9, str7);
            }
            String str8 = dynamicSchemaMsgData.event;
            if (str8 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(10, str8);
            }
            String str9 = dynamicSchemaMsgData.eId;
            if (str9 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(11, str9);
            }
            String str10 = dynamicSchemaMsgData.kId;
            if (str10 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(12, str10);
            }
            String str11 = dynamicSchemaMsgData.type;
            if (str11 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(13, str11);
            }
            dynamicSchemaMsgData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DynamicSchemaMsgData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        dynamicSchemaMsgData.view = (MessageView) nb5Var.m158743l(MessageView.PROTOBUF_ADAPTER);
                        continue;
                    case 18:
                        dynamicSchemaMsgData.extra = nb5Var.m158750s();
                        continue;
                    case 26:
                        dynamicSchemaMsgData.schema = nb5Var.m158750s();
                        continue;
                    case 34:
                        dynamicSchemaMsgData.failRemind = nb5Var.m158750s();
                        continue;
                    case 42:
                        dynamicSchemaMsgData.cancelSchema = nb5Var.m158750s();
                        continue;
                    case 50:
                        dynamicSchemaMsgData.cancelRemind = nb5Var.m158750s();
                        continue;
                    case 58:
                        dynamicSchemaMsgData.eventExtra = (Map) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
                        continue;
                    case 66:
                        dynamicSchemaMsgData.action = nb5Var.m158750s();
                        continue;
                    case 74:
                        dynamicSchemaMsgData.source = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        dynamicSchemaMsgData.event = nb5Var.m158750s();
                        continue;
                    case 90:
                        dynamicSchemaMsgData.eId = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        dynamicSchemaMsgData.kId = nb5Var.m158750s();
                        continue;
                    case 106:
                        dynamicSchemaMsgData.type = nb5Var.m158750s();
                        continue;
                    default:
                        if (dynamicSchemaMsgData.source == null) {
                            dynamicSchemaMsgData.source = "";
        ...
        public void serialize(DynamicSchemaMsgData dynamicSchemaMsgData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            MessageView messageView = dynamicSchemaMsgData.view;
            if (messageView != null) {
                codedOutputByteBufferNano.m17254K(1, messageView, MessageView.PROTOBUF_ADAPTER);
            }
            String str = dynamicSchemaMsgData.extra;
            if (str != null) {
            ...
            Map<String, String> map = dynamicSchemaMsgData.eventExtra;
            if (map != null) {
                codedOutputByteBufferNano.m17254K(7, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            String str6 = dynamicSchemaMsgData.action;
            if (str6 != null) {
    ...
    public static /* synthetic */ String m35508a(String str) {
        return str;
    }
    ...
    public DynamicSchemaMsgData mo223809clone() {
        DynamicSchemaMsgData dynamicSchemaMsgData = new DynamicSchemaMsgData();
        MessageView messageView = this.view;
        if (messageView != null) {
            dynamicSchemaMsgData.view = messageView.mo223809clone();
        }
        ...
        if (map != null) {
            dynamicSchemaMsgData.eventExtra = ValueObject.util_map(map, new w9j() { // from class: l.zhe
                ...
                public final Object call(Object obj) {
                    return DynamicSchemaMsgData.m35508a((String) obj);
                }
            });
        }
