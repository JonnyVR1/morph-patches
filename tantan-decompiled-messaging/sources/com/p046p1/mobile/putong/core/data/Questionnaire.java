...
public class Questionnaire extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Questionnaire> PROTOBUF_ADAPTER = new MessageNanoAdapter<Questionnaire>() { // from class: com.p1.mobile.putong.core.data.Questionnaire.1
        ...
        public int computeAndCacheSize(Questionnaire questionnaire) {
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, list, QuestionnaireOptions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            questionnaire.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Questionnaire parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    questionnaire.title = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    questionnaire.description = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (questionnaire.title == null) {
                            questionnaire.title = "";
                    ...
                    questionnaire.options = (List) nb5Var.m158743l(QuestionnaireOptions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return questionnaire;
        }
        ...
        public void serialize(Questionnaire questionnaire, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<QuestionnaireOptions> list = questionnaire.options;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, QuestionnaireOptions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public Questionnaire mo223809clone() {
        Questionnaire questionnaire = new Questionnaire();
        ...
        if (list != null) {
            questionnaire.options = ValueObject.util_map(list, new w9j() { // from class: l.rob0
                ...
                public final Object call(Object obj) {
                    return ((QuestionnaireOptions) obj).mo223809clone();
                }
            });
        }
        return questionnaire;
