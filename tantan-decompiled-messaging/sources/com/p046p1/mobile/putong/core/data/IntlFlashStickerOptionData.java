...
public class IntlFlashStickerOptionData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlFlashStickerOptionData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlFlashStickerOptionData>() { // from class: com.p1.mobile.putong.core.data.IntlFlashStickerOptionData.1
        ...
        public int computeAndCacheSize(IntlFlashStickerOptionData intlFlashStickerOptionData) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, intlFlashStickerOptionData.type) + CodedOutputByteBufferNano.m17220b(2, intlFlashStickerOptionData.active) + CodedOutputByteBufferNano.m17228j(3, intlFlashStickerOptionData.remain) + CodedOutputByteBufferNano.m17228j(4, intlFlashStickerOptionData.duration);
            ...
            if (intlFlashStickerDialogSummaryData != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(5, intlFlashStickerDialogSummaryData, IntlFlashStickerDialogSummaryData.PROTOBUF_ADAPTER);
            }
            ...
            if (intlMarketStickerOptionsData != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(6, intlMarketStickerOptionsData, IntlMarketStickerOptionsData.PROTOBUF_ADAPTER);
            }
            intlFlashStickerOptionData.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlFlashStickerOptionData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    intlFlashStickerOptionData.type = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    intlFlashStickerOptionData.active = nb5Var.m158738g();
                } else if (iM158752u == 24) {
                    intlFlashStickerOptionData.remain = nb5Var.m158742k();
                } else if (iM158752u == 32) {
                    intlFlashStickerOptionData.duration = nb5Var.m158742k();
                } else if (iM158752u == 42) {
                    intlFlashStickerOptionData.dialog_ui = (IntlFlashStickerDialogSummaryData) nb5Var.m158743l(IntlFlashStickerDialogSummaryData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 50) {
                        if (intlFlashStickerOptionData.dialog_ui == null) {
                            intlFlashStickerOptionData.dialog_ui = IntlFlashStickerDialogSummaryData.new_();
                    ...
                    intlFlashStickerOptionData.option_data = (IntlMarketStickerOptionsData) nb5Var.m158743l(IntlMarketStickerOptionsData.PROTOBUF_ADAPTER);
                }
            }
            return intlFlashStickerOptionData;
        }
        ...
        public void serialize(IntlFlashStickerOptionData intlFlashStickerOptionData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, intlFlashStickerOptionData.type);
            codedOutputByteBufferNano.m17244A(2, intlFlashStickerOptionData.active);
            codedOutputByteBufferNano.m17252I(3, intlFlashStickerOptionData.remain);
            codedOutputByteBufferNano.m17252I(4, intlFlashStickerOptionData.duration);
            IntlFlashStickerDialogSummaryData intlFlashStickerDialogSummaryData = intlFlashStickerOptionData.dialog_ui;
            if (intlFlashStickerDialogSummaryData != null) {
                codedOutputByteBufferNano.m17254K(5, intlFlashStickerDialogSummaryData, IntlFlashStickerDialogSummaryData.PROTOBUF_ADAPTER);
            }
            IntlMarketStickerOptionsData intlMarketStickerOptionsData = intlFlashStickerOptionData.option_data;
            if (intlMarketStickerOptionsData != null) {
                codedOutputByteBufferNano.m17254K(6, intlMarketStickerOptionsData, IntlMarketStickerOptionsData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public IntlFlashStickerOptionData mo223809clone() {
        IntlFlashStickerOptionData intlFlashStickerOptionData = new IntlFlashStickerOptionData();
        ...
        if (intlFlashStickerDialogSummaryData != null) {
            intlFlashStickerOptionData.dialog_ui = intlFlashStickerDialogSummaryData.mo223809clone();
        }
        IntlMarketStickerOptionsData intlMarketStickerOptionsData = this.option_data;
        if (intlMarketStickerOptionsData != null) {
            intlFlashStickerOptionData.option_data = intlMarketStickerOptionsData.mo223809clone();
        }
        return intlFlashStickerOptionData;
    }
