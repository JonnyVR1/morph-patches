...
public class Questions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Questions> PROTOBUF_ADAPTER = new MessageNanoAdapter<Questions>() { // from class: com.p1.mobile.putong.core.data.Questions.1
        ...
        public int computeAndCacheSize(Questions questions) {
            ...
            if (content != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, content, Content.PROTOBUF_ADAPTER);
            }
            questions.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Questions parse(nb5 nb5Var) throws IOException {
            Questions questions = new Questions();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (questions.f20481id == null) {
                        questions.f20481id = "";
                    }
                ...
                if (iM158752u == 10) {
                    questions.f20481id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    questions.index = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    questions.type = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    questions.title = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (questions.f20481id == null) {
                            questions.f20481id = "";
                    ...
                    questions.content = (Content) nb5Var.m158743l(Content.PROTOBUF_ADAPTER);
                }
            }
            return questions;
        }
        ...
        public void serialize(Questions questions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Content content = questions.content;
            if (content != null) {
                codedOutputByteBufferNano.m17254K(5, content, Content.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Questions> JSON_ADAPTER = new ObjectJsonAdapter<Questions>() { // from class: com.p1.mobile.putong.core.data.Questions.2
        ...
        public boolean parseField(Questions questions, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    questions.f20481id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public Questions mo223809clone() {
        Questions questions = new Questions();
        questions.f20481id = this.f20481id;
        questions.index = this.index;
        questions.type = this.type;
        questions.title = this.title;
        Content content = this.content;
        if (content != null) {
            questions.content = content.mo223809clone();
        }
        return questions;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20481id, questions.f20481id) && ValueObject.util_equals(this.index, questions.index) && ValueObject.util_equals(this.type, questions.type) && ValueObject.util_equals(this.title, questions.title) && ValueObject.util_equals(this.content, questions.content);
    }
