...
public class IapAffiliatePromotionDisplaySlot extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IapAffiliatePromotionDisplaySlot> PROTOBUF_ADAPTER = new MessageNanoAdapter<IapAffiliatePromotionDisplaySlot>() { // from class: com.p1.mobile.putong.core.data.IapAffiliatePromotionDisplaySlot.1
        ...
        public int computeAndCacheSize(IapAffiliatePromotionDisplaySlot iapAffiliatePromotionDisplaySlot) {
            ...
            iapAffiliatePromotionDisplaySlot.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IapAffiliatePromotionDisplaySlot parse(nb5 nb5Var) throws IOException {
            IapAffiliatePromotionDisplaySlot iapAffiliatePromotionDisplaySlot = new IapAffiliatePromotionDisplaySlot();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 10:
                        iapAffiliatePromotionDisplaySlot.mainTitle = nb5Var.m158750s();
                        break;
                    case 18:
                        iapAffiliatePromotionDisplaySlot.subtitle = nb5Var.m158750s();
                        break;
                    case 26:
                        iapAffiliatePromotionDisplaySlot.theme = nb5Var.m158750s();
                        break;
                    case 34:
                        iapAffiliatePromotionDisplaySlot.buttonText = nb5Var.m158750s();
                        break;
                    case 42:
                        iapAffiliatePromotionDisplaySlot.imgUrl = nb5Var.m158750s();
                        break;
                    case 50:
                        iapAffiliatePromotionDisplaySlot.seePoolHasUserSubtitle = nb5Var.m158750s();
                        break;
                    case 58:
                        iapAffiliatePromotionDisplaySlot.seePoolNoUserSubtitle = nb5Var.m158750s();
                        break;
                    case 66:
                        iapAffiliatePromotionDisplaySlot.countdownTopText = nb5Var.m158750s();
                        break;
                    case 74:
                        iapAffiliatePromotionDisplaySlot.interceptToast = nb5Var.m158750s();
                        break;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        iapAffiliatePromotionDisplaySlot.skuTitle = nb5Var.m158750s();
                        break;
                    case 90:
                        iapAffiliatePromotionDisplaySlot.titleLine1 = nb5Var.m158750s();
                        break;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        iapAffiliatePromotionDisplaySlot.titleLine2 = nb5Var.m158750s();
                        break;
                    case 106:
                        iapAffiliatePromotionDisplaySlot.seePoolHasUserMainTitle = nb5Var.m158750s();
                        break;
                    case 114:
                        iapAffiliatePromotionDisplaySlot.seePoolNoUserMainTitle = nb5Var.m158750s();
                        break;
                    case 122:
                        iapAffiliatePromotionDisplaySlot.digitBackground = nb5Var.m158750s();
                        break;
                    default:
    ...
    public IapAffiliatePromotionDisplaySlot mo223809clone() {
        IapAffiliatePromotionDisplaySlot iapAffiliatePromotionDisplaySlot = new IapAffiliatePromotionDisplaySlot();
