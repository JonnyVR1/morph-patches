...
public class TalkTemplate extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TalkTemplate> PROTOBUF_ADAPTER = new MessageNanoAdapter<TalkTemplate>() { // from class: com.p1.mobile.putong.core.data.TalkTemplate.1
        ...
        public int computeAndCacheSize(TalkTemplate talkTemplate) {
            String str = talkTemplate.f20518id;
            ...
            talkTemplate.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TalkTemplate parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    ...
                    if (talkTemplate.f20518id == null) {
                        talkTemplate.f20518id = "";
                    }
                ...
                if (iM158752u == 10) {
                    talkTemplate.f20518id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    talkTemplate.value = nb5Var.m158750s();
                    ...
                    talkTemplate.gender = (Gender) nb5Var.m158743l(Gender.PROTOBUF_ADAPTER);
                }
            }
            return talkTemplate;
        }
        ...
        public boolean parseField(TalkTemplate talkTemplate, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "gender":
                    ...
                    return true;
                case "id":
                    talkTemplate.f20518id = jsonParser.getValueAsString();
                    return false;
                case "value":
    ...
    public TalkTemplate mo223809clone() {
        TalkTemplate talkTemplate = new TalkTemplate();
        talkTemplate.f20518id = this.f20518id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20518id, talkTemplate.f20518id) && ValueObject.util_equals(this.value, talkTemplate.value) && ValueObject.util_equals(this.gender, talkTemplate.gender);
    }
