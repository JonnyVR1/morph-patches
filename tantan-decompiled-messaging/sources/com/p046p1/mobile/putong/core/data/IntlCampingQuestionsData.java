...
public class IntlCampingQuestionsData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlCampingQuestionsData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlCampingQuestionsData>() { // from class: com.p1.mobile.putong.core.data.IntlCampingQuestionsData.1
        ...
        public int computeAndCacheSize(IntlCampingQuestionsData intlCampingQuestionsData) {
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, list, IntlCampingQuestionOptionsData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            intlCampingQuestionsData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlCampingQuestionsData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    intlCampingQuestionsData.heading = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    intlCampingQuestionsData.heading_font_color = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    intlCampingQuestionsData.bg_url = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    intlCampingQuestionsData.opt_bg_url = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    intlCampingQuestionsData.opt_focus_bg_url = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    intlCampingQuestionsData.opt_focus_logo_url = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    intlCampingQuestionsData.options = (List) nb5Var.m158743l(IntlCampingQuestionOptionsData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 66) {
                    intlCampingQuestionsData.opt_focus_font_color = nb5Var.m158750s();
                } else {
                    if (iM158752u != 74) {
                        if (intlCampingQuestionsData.heading == null) {
                            intlCampingQuestionsData.heading = "";
                    ...
                    intlCampingQuestionsData.opt_font_color = nb5Var.m158750s();
                }
            }
            return intlCampingQuestionsData;
        }
        ...
        public void serialize(IntlCampingQuestionsData intlCampingQuestionsData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<IntlCampingQuestionOptionsData> list = intlCampingQuestionsData.options;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(7, list, IntlCampingQuestionOptionsData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = intlCampingQuestionsData.opt_focus_font_color;
            if (str7 != null) {
    ...
    public IntlCampingQuestionsData mo223809clone() {
        IntlCampingQuestionsData intlCampingQuestionsData = new IntlCampingQuestionsData();
        ...
        if (list != null) {
            intlCampingQuestionsData.options = ValueObject.util_map(list, new w9j() { // from class: l.y3n
                ...
                public final Object call(Object obj) {
                    return ((IntlCampingQuestionOptionsData) obj).mo223809clone();
                }
            });
        }
        return intlCampingQuestionsData;
