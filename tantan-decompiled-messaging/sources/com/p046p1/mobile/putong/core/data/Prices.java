...
public class Prices extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Prices> PROTOBUF_ADAPTER = new MessageNanoAdapter<Prices>() { // from class: com.p1.mobile.putong.core.data.Prices.1
        ...
        public int computeAndCacheSize(Prices prices) {
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(3, prices.price) + CodedOutputByteBufferNano.m17222d(4, prices.unitPrice) + CodedOutputByteBufferNano.m17222d(5, prices.originalPrice) + CodedOutputByteBufferNano.m17222d(6, prices.originalUnitPrice) + CodedOutputByteBufferNano.m17222d(7, prices.noneRenewalPrice) + CodedOutputByteBufferNano.m17222d(8, prices.noneRenewalUnitPrice);
            prices.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Prices parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    prices.currencyCode = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    prices.currencySymbol = nb5Var.m158750s();
                } else if (iM158752u == 25) {
                    prices.price = nb5Var.m158739h();
                } else if (iM158752u == 33) {
                    prices.unitPrice = nb5Var.m158739h();
                } else if (iM158752u == 41) {
                    prices.originalPrice = nb5Var.m158739h();
                } else if (iM158752u == 49) {
                    prices.originalUnitPrice = nb5Var.m158739h();
                } else if (iM158752u == 57) {
                    prices.noneRenewalPrice = nb5Var.m158739h();
                } else {
                    if (iM158752u != 65) {
                        if (prices.currencyCode == null) {
                            prices.currencyCode = "";
                    ...
                    prices.noneRenewalUnitPrice = nb5Var.m158739h();
                }
            }
            return prices;
        }
        ...
        public void serialize(Prices prices, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(3, prices.price);
            codedOutputByteBufferNano.m17246C(4, prices.unitPrice);
            codedOutputByteBufferNano.m17246C(5, prices.originalPrice);
            codedOutputByteBufferNano.m17246C(6, prices.originalUnitPrice);
            codedOutputByteBufferNano.m17246C(7, prices.noneRenewalPrice);
            codedOutputByteBufferNano.m17246C(8, prices.noneRenewalUnitPrice);
        }
    };
