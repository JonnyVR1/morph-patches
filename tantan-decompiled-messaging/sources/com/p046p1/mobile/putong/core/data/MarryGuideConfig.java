...
public class MarryGuideConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MarryGuideConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<MarryGuideConfig>() { // from class: com.p1.mobile.putong.core.data.MarryGuideConfig.1
        ...
        public int computeAndCacheSize(MarryGuideConfig marryGuideConfig) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, marryGuideConfig.continuous_left) + CodedOutputByteBufferNano.m17226h(2, marryGuideConfig.continuous_no_match);
            ...
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(5, marryGuideConfig.totoal_guide_limit) + CodedOutputByteBufferNano.m17226h(6, marryGuideConfig.guide_timeinterval) + CodedOutputByteBufferNano.m17220b(7, marryGuideConfig.scroll_pay_wall);
            marryGuideConfig.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MarryGuideConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    marryGuideConfig.continuous_left = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    marryGuideConfig.continuous_no_match = nb5Var.m158741j();
                } else if (iM158752u == 26) {
                    marryGuideConfig.female_action = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    marryGuideConfig.male_action = nb5Var.m158750s();
                } else if (iM158752u == 40) {
                    marryGuideConfig.totoal_guide_limit = nb5Var.m158741j();
                } else if (iM158752u == 48) {
                    marryGuideConfig.guide_timeinterval = nb5Var.m158741j();
                } else {
                    if (iM158752u != 56) {
                        if (marryGuideConfig.female_action == null) {
                            marryGuideConfig.female_action = "";
                    ...
                    marryGuideConfig.scroll_pay_wall = nb5Var.m158738g();
                }
            }
            return marryGuideConfig;
        }
        ...
        public void serialize(MarryGuideConfig marryGuideConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, marryGuideConfig.continuous_left);
            codedOutputByteBufferNano.m17250G(2, marryGuideConfig.continuous_no_match);
            String str = marryGuideConfig.female_action;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17250G(5, marryGuideConfig.totoal_guide_limit);
            codedOutputByteBufferNano.m17250G(6, marryGuideConfig.guide_timeinterval);
            codedOutputByteBufferNano.m17244A(7, marryGuideConfig.scroll_pay_wall);
        }
    };
    ...
    public MarryGuideConfig mo223809clone() {
        MarryGuideConfig marryGuideConfig = new MarryGuideConfig();
