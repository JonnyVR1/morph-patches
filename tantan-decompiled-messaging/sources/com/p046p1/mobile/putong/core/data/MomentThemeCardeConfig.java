...
public class MomentThemeCardeConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentThemeCardeConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentThemeCardeConfig>() { // from class: com.p1.mobile.putong.core.data.MomentThemeCardeConfig.1
        ...
        public int computeAndCacheSize(MomentThemeCardeConfig momentThemeCardeConfig) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, momentThemeCardeConfig.enabled);
            String str = momentThemeCardeConfig.tabTitle;
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(3, momentThemeCardeConfig.enableGreeting);
            ...
            momentThemeCardeConfig.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentThemeCardeConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    momentThemeCardeConfig.enabled = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    momentThemeCardeConfig.tabTitle = nb5Var.m158750s();
                } else if (iM158752u == 24) {
                    momentThemeCardeConfig.enableGreeting = nb5Var.m158738g();
                } else if (iM158752u == 34) {
                    momentThemeCardeConfig.subtitleFormat = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (momentThemeCardeConfig.tabTitle == null) {
                            momentThemeCardeConfig.tabTitle = "";
                    ...
                    momentThemeCardeConfig.tabId = nb5Var.m158750s();
                }
            }
            return momentThemeCardeConfig;
        }
        ...
        public void serialize(MomentThemeCardeConfig momentThemeCardeConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, momentThemeCardeConfig.enabled);
            String str = momentThemeCardeConfig.tabTitle;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17244A(3, momentThemeCardeConfig.enableGreeting);
            String str2 = momentThemeCardeConfig.subtitleFormat;
            if (str2 != null) {
    ...
    public MomentThemeCardeConfig mo223809clone() {
        MomentThemeCardeConfig momentThemeCardeConfig = new MomentThemeCardeConfig();
