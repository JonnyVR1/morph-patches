...
public class SeePortrait extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SeePortrait> PROTOBUF_ADAPTER = new MessageNanoAdapter<SeePortrait>() { // from class: com.p1.mobile.putong.core.data.SeePortrait.1
        ...
        public int computeAndCacheSize(SeePortrait seePortrait) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, seePortrait.reachedMaxNum);
            List<Portrait> list = seePortrait.portraits;
            if (list != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(2, list, Portrait.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(3, seePortrait.reachedDailyMaxNum);
            seePortrait.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SeePortrait parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    seePortrait.reachedMaxNum = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    seePortrait.portraits = (List) nb5Var.m158743l(Portrait.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 24) {
                        if (seePortrait.portraits != null) {
                            break;
                    ...
                    seePortrait.reachedDailyMaxNum = nb5Var.m158738g();
                }
            }
            return seePortrait;
        }
        ...
        public void serialize(SeePortrait seePortrait, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, seePortrait.reachedMaxNum);
            List<Portrait> list = seePortrait.portraits;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(2, list, Portrait.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17244A(3, seePortrait.reachedDailyMaxNum);
        }
    };
    ...
    public SeePortrait mo223809clone() {
        SeePortrait seePortrait = new SeePortrait();
        ...
        if (list != null) {
            seePortrait.portraits = ValueObject.util_map(list, new w9j() { // from class: l.xae0
                ...
                public final Object call(Object obj) {
                    return ((Portrait) obj).mo223809clone();
                }
            });
        }
