...
public class QuickChatOneside extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuickChatOneside> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuickChatOneside>() { // from class: com.p1.mobile.putong.core.data.QuickChatOneside.1
        ...
        public int computeAndCacheSize(QuickChatOneside quickChatOneside) {
            ...
            if (quickChatBiz != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, quickChatBiz, QuickChatBiz.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(4, quickChatOneside.isCommonMatch);
            quickChatOneside.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuickChatOneside parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    quickChatOneside.stage = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    quickChatOneside.tracker = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    quickChatOneside.biz = (QuickChatBiz) nb5Var.m158743l(QuickChatBiz.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 32) {
                        if (quickChatOneside.stage == null) {
                            quickChatOneside.stage = "";
                    ...
                    quickChatOneside.isCommonMatch = nb5Var.m158738g();
                }
            }
            return quickChatOneside;
        }
        ...
        public void serialize(QuickChatOneside quickChatOneside, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            QuickChatBiz quickChatBiz = quickChatOneside.biz;
            if (quickChatBiz != null) {
                codedOutputByteBufferNano.m17254K(3, quickChatBiz, QuickChatBiz.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(4, quickChatOneside.isCommonMatch);
        }
    };
    ...
    public QuickChatOneside mo223809clone() {
        QuickChatOneside quickChatOneside = new QuickChatOneside();
