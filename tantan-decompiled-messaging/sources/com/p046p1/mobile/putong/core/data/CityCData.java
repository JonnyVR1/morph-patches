...
public class CityCData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CityCData> PROTOBUF_ADAPTER = new MessageNanoAdapter<CityCData>() { // from class: com.p1.mobile.putong.core.data.CityCData.1
        ...
        public int computeAndCacheSize(CityCData cityCData) {
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(8, cityCData.cost);
            ...
            if (str9 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(10, str9);
            }
            String str10 = cityCData.profileTag;
            if (str10 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(11, str10);
            }
            String str11 = cityCData.extra;
            if (str11 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(12, str11);
            }
            int iM17222d = iM17226h + CodedOutputByteBufferNano.m17222d(13, cityCData.updatedTimeexpireAt) + CodedOutputByteBufferNano.m17226h(14, cityCData.viewCount) + CodedOutputByteBufferNano.m17226h(15, cityCData.recievedLikeCount) + CodedOutputByteBufferNano.m17222d(16, cityCData.expireAt);
            String str12 = cityCData.cityName;
            if (str12 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(17, str12);
            }
            cityCData.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CityCData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        cityCData.userId = nb5Var.m158750s();
                        continue;
                    case 18:
                        cityCData.cardId = nb5Var.m158750s();
                        continue;
                    case 26:
                        cityCData.titleLocation = nb5Var.m158750s();
                        continue;
                    case 34:
                        cityCData.titleTag = nb5Var.m158750s();
                        continue;
                    case 42:
                        cityCData.cardTitle = nb5Var.m158750s();
                        continue;
                    case 50:
                        cityCData.cardTag = nb5Var.m158750s();
                        continue;
                    case 58:
                        cityCData.cardText = nb5Var.m158750s();
                        continue;
                    case 64:
                        cityCData.cost = nb5Var.m158741j();
                        continue;
                    case 74:
                        cityCData.costText = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        cityCData.costType = nb5Var.m158750s();
                        continue;
                    case 90:
                        cityCData.profileTag = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        cityCData.extra = nb5Var.m158750s();
                        continue;
                    case 105:
                        cityCData.updatedTimeexpireAt = nb5Var.m158739h();
                        continue;
                    case 112:
                        cityCData.viewCount = nb5Var.m158741j();
                        continue;
                    case 120:
                        cityCData.recievedLikeCount = nb5Var.m158741j();
                        continue;
                    case MMConstants.ERR_WATERMARK_READ /* 129 */:
                        cityCData.expireAt = nb5Var.m158739h();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        cityCData.cityName = nb5Var.m158750s();
                        continue;
                    default:
                        if (cityCData.userId == null) {
                            cityCData.userId = "";
        ...
        public void serialize(CityCData cityCData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(8, cityCData.cost);
            String str8 = cityCData.costText;
            if (str8 != null) {
            ...
            String str10 = cityCData.profileTag;
            if (str10 != null) {
                codedOutputByteBufferNano.m17261R(11, str10);
            }
            String str11 = cityCData.extra;
            if (str11 != null) {
                codedOutputByteBufferNano.m17261R(12, str11);
            }
            codedOutputByteBufferNano.m17246C(13, cityCData.updatedTimeexpireAt);
            codedOutputByteBufferNano.m17250G(14, cityCData.viewCount);
            codedOutputByteBufferNano.m17250G(15, cityCData.recievedLikeCount);
            codedOutputByteBufferNano.m17246C(16, cityCData.expireAt);
            String str12 = cityCData.cityName;
            if (str12 != null) {
    ...
    public CityCData mo223809clone() {
        CityCData cityCData = new CityCData();
