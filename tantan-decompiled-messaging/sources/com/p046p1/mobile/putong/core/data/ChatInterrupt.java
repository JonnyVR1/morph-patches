...
public class ChatInterrupt extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatInterrupt> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatInterrupt>() { // from class: com.p1.mobile.putong.core.data.ChatInterrupt.1
        ...
        public int computeAndCacheSize(ChatInterrupt chatInterrupt) {
            ...
            int iM17226h = chatInterruptStage != null ? CodedOutputByteBufferNano.m17226h(1, chatInterruptStage.ordinal()) : 0;
            ChatInterruptStage chatInterruptStage2 = chatInterrupt.stage;
            if (chatInterruptStage2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(2, chatInterruptStage2, ChatInterruptStage.PROTOBUF_ADAPTER);
            }
            chatInterrupt.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatInterrupt parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    ...
                    chatInterrupt.stage = (ChatInterruptStage) nb5Var.m158743l(ChatInterruptStage.PROTOBUF_ADAPTER);
                }
            }
            return chatInterrupt;
        }
        ...
        public void serialize(ChatInterrupt chatInterrupt, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (chatInterruptStage != null) {
                codedOutputByteBufferNano.m17250G(1, chatInterruptStage.ordinal());
            }
            ChatInterruptStage chatInterruptStage2 = chatInterrupt.stage;
            if (chatInterruptStage2 != null) {
                codedOutputByteBufferNano.m17254K(2, chatInterruptStage2, ChatInterruptStage.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ChatInterrupt mo223809clone() {
        ChatInterrupt chatInterrupt = new ChatInterrupt();
