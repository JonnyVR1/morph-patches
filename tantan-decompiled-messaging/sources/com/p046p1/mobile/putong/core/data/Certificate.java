...
public class Certificate extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Certificate> PROTOBUF_ADAPTER = new MessageNanoAdapter<Certificate>() { // from class: com.p1.mobile.putong.core.data.Certificate.1
        ...
        public int computeAndCacheSize(Certificate certificate) {
            String str = certificate.f20358id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            CertificateType certificateType = certificate.type;
            if (certificateType != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(2, certificateType.ordinal());
            }
            CertificateType certificateType2 = certificate.type;
            if (certificateType2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, certificateType2, CertificateType.PROTOBUF_ADAPTER);
            }
            certificate.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Certificate parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    ...
                    if (certificate.f20358id == null) {
                        certificate.f20358id = "";
                    }
                ...
                if (iM158752u == 10) {
                    certificate.f20358id = nb5Var.m158750s();
                    ...
                    certificate.type = (CertificateType) nb5Var.m158743l(CertificateType.PROTOBUF_ADAPTER);
                }
            }
            return certificate;
        }
        ...
        public void serialize(Certificate certificate, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CertificateType certificateType = certificate.type;
            if (certificateType != null) {
                codedOutputByteBufferNano.m17250G(2, certificateType.ordinal());
            }
            CertificateType certificateType2 = certificate.type;
            if (certificateType2 != null) {
                codedOutputByteBufferNano.m17254K(3, certificateType2, CertificateType.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Certificate> JSON_ADAPTER = new ObjectJsonAdapter<Certificate>() { // from class: com.p1.mobile.putong.core.data.Certificate.2
        ...
        public boolean parseField(Certificate certificate, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            str.getClass();
            if (str.equals("id")) {
                certificate.f20358id = jsonParser.getValueAsString();
                return false;
            }
            if (!str.equals("type")) {
                return false;
    ...
    public Certificate mo223809clone() {
        Certificate certificate = new Certificate();
        certificate.f20358id = this.f20358id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20358id, certificate.f20358id) && ValueObject.util_equals(this.type, certificate.type);
    }
