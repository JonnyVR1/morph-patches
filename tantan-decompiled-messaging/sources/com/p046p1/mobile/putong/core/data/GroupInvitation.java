...
public class GroupInvitation extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GroupInvitation> PROTOBUF_ADAPTER = new MessageNanoAdapter<GroupInvitation>() { // from class: com.p1.mobile.putong.core.data.GroupInvitation.1
        ...
        public int computeAndCacheSize(GroupInvitation groupInvitation) {
            ...
            if (button != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, button, Button.PROTOBUF_ADAPTER);
            }
            Target target = groupInvitation.target;
            if (target != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, target, Target.PROTOBUF_ADAPTER);
            }
            groupInvitation.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GroupInvitation parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    groupInvitation.title = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    groupInvitation.subTitle = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    groupInvitation.button = (Button) nb5Var.m158743l(Button.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 34) {
                        if (groupInvitation.title == null) {
                            groupInvitation.title = "";
                    ...
                    groupInvitation.target = (Target) nb5Var.m158743l(Target.PROTOBUF_ADAPTER);
                }
            }
            return groupInvitation;
        }
        ...
        public void serialize(GroupInvitation groupInvitation, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Button button = groupInvitation.button;
            if (button != null) {
                codedOutputByteBufferNano.m17254K(3, button, Button.PROTOBUF_ADAPTER);
            }
            Target target = groupInvitation.target;
            if (target != null) {
                codedOutputByteBufferNano.m17254K(4, target, Target.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public GroupInvitation mo223809clone() {
        GroupInvitation groupInvitation = new GroupInvitation();
        groupInvitation.title = this.title;
        groupInvitation.subTitle = this.subTitle;
        Button button = this.button;
        if (button != null) {
            groupInvitation.button = button.mo223809clone();
        }
        Target target = this.target;
        if (target != null) {
            groupInvitation.target = target.mo223809clone();
        }
        return groupInvitation;
    }
