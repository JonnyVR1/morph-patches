...
public class LikeMindedItemLanguagesData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikeMindedItemLanguagesData> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikeMindedItemLanguagesData>() { // from class: com.p1.mobile.putong.core.data.LikeMindedItemLanguagesData.1
        ...
        public int computeAndCacheSize(LikeMindedItemLanguagesData likeMindedItemLanguagesData) {
            ...
            int iM17230l = likeMindedItemSwipeData != null ? CodedOutputByteBufferNano.m17230l(1, likeMindedItemSwipeData, LikeMindedItemSwipeData.PROTOBUF_ADAPTER) : 0;
            LikeMindedItemStatusData likeMindedItemStatusData = likeMindedItemLanguagesData.status;
            if (likeMindedItemStatusData != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, likeMindedItemStatusData, LikeMindedItemStatusData.PROTOBUF_ADAPTER);
            }
            likeMindedItemLanguagesData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LikeMindedItemLanguagesData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    likeMindedItemLanguagesData.swipe = (LikeMindedItemSwipeData) nb5Var.m158743l(LikeMindedItemSwipeData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (likeMindedItemLanguagesData.swipe == null) {
                            likeMindedItemLanguagesData.swipe = LikeMindedItemSwipeData.new_();
                    ...
                    likeMindedItemLanguagesData.status = (LikeMindedItemStatusData) nb5Var.m158743l(LikeMindedItemStatusData.PROTOBUF_ADAPTER);
                }
            }
            return likeMindedItemLanguagesData;
        }
        ...
        public void serialize(LikeMindedItemLanguagesData likeMindedItemLanguagesData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (likeMindedItemSwipeData != null) {
                codedOutputByteBufferNano.m17254K(1, likeMindedItemSwipeData, LikeMindedItemSwipeData.PROTOBUF_ADAPTER);
            }
            LikeMindedItemStatusData likeMindedItemStatusData = likeMindedItemLanguagesData.status;
            if (likeMindedItemStatusData != null) {
                codedOutputByteBufferNano.m17254K(2, likeMindedItemStatusData, LikeMindedItemStatusData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LikeMindedItemLanguagesData mo223809clone() {
        LikeMindedItemLanguagesData likeMindedItemLanguagesData = new LikeMindedItemLanguagesData();
        LikeMindedItemSwipeData likeMindedItemSwipeData = this.swipe;
        if (likeMindedItemSwipeData != null) {
            likeMindedItemLanguagesData.swipe = likeMindedItemSwipeData.mo223809clone();
        }
        LikeMindedItemStatusData likeMindedItemStatusData = this.status;
        if (likeMindedItemStatusData != null) {
            likeMindedItemLanguagesData.status = likeMindedItemStatusData.mo223809clone();
        }
        return likeMindedItemLanguagesData;
    }
