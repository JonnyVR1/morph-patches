...
public class HeartbeatPushInfo {
    ...
    public boolean isActiveMsg() {
        return NullChecker.m81303a(this.pushMessage) && !TextUtils.isEmpty(this.pushMessage.triggeredUserId) && TextUtils.equals(this.pushMessage.triggeredUserId, CoreModule.m29931H().userId());
    }
