...
public class TribeSubsetContent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TribeSubsetContent> PROTOBUF_ADAPTER = new MessageNanoAdapter<TribeSubsetContent>() { // from class: com.p1.mobile.putong.core.data.TribeSubsetContent.1
        ...
        public int computeAndCacheSize(TribeSubsetContent tribeSubsetContent) {
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(6, tribeSubsetContent.totalCount) + CodedOutputByteBufferNano.m17226h(7, tribeSubsetContent.currentLikeMe);
            ...
            tribeSubsetContent.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TribeSubsetContent parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        tribeSubsetContent.title = nb5Var.m158750s();
                        continue;
                    case 18:
                        tribeSubsetContent.subType = nb5Var.m158750s();
                        continue;
                    case 26:
                        tribeSubsetContent.icon = nb5Var.m158750s();
                        continue;
                    case 34:
                        tribeSubsetContent.coverUrl = nb5Var.m158750s();
                        continue;
                    case 42:
                        tribeSubsetContent.profilePhoto = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 48:
                        tribeSubsetContent.totalCount = nb5Var.m158741j();
                        continue;
                    case 56:
                        tribeSubsetContent.currentLikeMe = nb5Var.m158741j();
                        continue;
                    case 66:
                        tribeSubsetContent.innerBackgroundUrl = nb5Var.m158750s();
                        continue;
                    case 74:
                        tribeSubsetContent.jumpUrl = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        tribeSubsetContent.action = nb5Var.m158750s();
                        continue;
                    default:
                        if (tribeSubsetContent.title == null) {
                            tribeSubsetContent.title = "";
        ...
        public void serialize(TribeSubsetContent tribeSubsetContent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(6, tribeSubsetContent.totalCount);
            codedOutputByteBufferNano.m17250G(7, tribeSubsetContent.currentLikeMe);
            String str5 = tribeSubsetContent.innerBackgroundUrl;
            if (str5 != null) {
    ...
    public static /* synthetic */ String m35881a(String str) {
        return str;
    }
    ...
    public TribeSubsetContent mo223809clone() {
        TribeSubsetContent tribeSubsetContent = new TribeSubsetContent();
        ...
        if (list != null) {
            tribeSubsetContent.profilePhoto = ValueObject.util_map(list, new w9j() { // from class: l.kaj0
                ...
                public final Object call(Object obj) {
                    return TribeSubsetContent.m35881a((String) obj);
                }
            });
        }
