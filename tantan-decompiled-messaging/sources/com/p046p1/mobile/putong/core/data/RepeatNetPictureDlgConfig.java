...
public class RepeatNetPictureDlgConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RepeatNetPictureDlgConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<RepeatNetPictureDlgConfig>() { // from class: com.p1.mobile.putong.core.data.RepeatNetPictureDlgConfig.1
        ...
        public int computeAndCacheSize(RepeatNetPictureDlgConfig repeatNetPictureDlgConfig) {
            ...
            int iM17230l = repeatNetPictureDlgContent != null ? CodedOutputByteBufferNano.m17230l(1, repeatNetPictureDlgContent, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER) : 0;
            ...
            if (repeatNetPictureDlgContent2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, repeatNetPictureDlgContent2, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            ...
            if (repeatNetPictureDlgContent3 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, repeatNetPictureDlgContent3, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureTrigger repeatNetPictureTrigger = repeatNetPictureDlgConfig.trigger;
            if (repeatNetPictureTrigger != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, repeatNetPictureTrigger, RepeatNetPictureTrigger.PROTOBUF_ADAPTER);
            }
            ...
            if (repeatNetPictureDlgContent4 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, repeatNetPictureDlgContent4, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17230l + CodedOutputByteBufferNano.m17220b(6, repeatNetPictureDlgConfig.enable);
            repeatNetPictureDlgConfig.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RepeatNetPictureDlgConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    repeatNetPictureDlgConfig.repeatPictureDlg = (RepeatNetPictureDlgContent) nb5Var.m158743l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    repeatNetPictureDlgConfig.netPictureDlg = (RepeatNetPictureDlgContent) nb5Var.m158743l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    repeatNetPictureDlgConfig.swipeLimitDlg = (RepeatNetPictureDlgContent) nb5Var.m158743l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    repeatNetPictureDlgConfig.trigger = (RepeatNetPictureTrigger) nb5Var.m158743l(RepeatNetPictureTrigger.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    repeatNetPictureDlgConfig.aiPictureDlg = (RepeatNetPictureDlgContent) nb5Var.m158743l(RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 48) {
                        if (repeatNetPictureDlgConfig.repeatPictureDlg == null) {
                            repeatNetPictureDlgConfig.repeatPictureDlg = RepeatNetPictureDlgContent.new_();
                    ...
                    repeatNetPictureDlgConfig.enable = nb5Var.m158738g();
                }
            }
            return repeatNetPictureDlgConfig;
        }
        ...
        public void serialize(RepeatNetPictureDlgConfig repeatNetPictureDlgConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (repeatNetPictureDlgContent != null) {
                codedOutputByteBufferNano.m17254K(1, repeatNetPictureDlgContent, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureDlgContent repeatNetPictureDlgContent2 = repeatNetPictureDlgConfig.netPictureDlg;
            if (repeatNetPictureDlgContent2 != null) {
                codedOutputByteBufferNano.m17254K(2, repeatNetPictureDlgContent2, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureDlgContent repeatNetPictureDlgContent3 = repeatNetPictureDlgConfig.swipeLimitDlg;
            if (repeatNetPictureDlgContent3 != null) {
                codedOutputByteBufferNano.m17254K(3, repeatNetPictureDlgContent3, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureTrigger repeatNetPictureTrigger = repeatNetPictureDlgConfig.trigger;
            if (repeatNetPictureTrigger != null) {
                codedOutputByteBufferNano.m17254K(4, repeatNetPictureTrigger, RepeatNetPictureTrigger.PROTOBUF_ADAPTER);
            }
            RepeatNetPictureDlgContent repeatNetPictureDlgContent4 = repeatNetPictureDlgConfig.aiPictureDlg;
            if (repeatNetPictureDlgContent4 != null) {
                codedOutputByteBufferNano.m17254K(5, repeatNetPictureDlgContent4, RepeatNetPictureDlgContent.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(6, repeatNetPictureDlgConfig.enable);
        }
    };
    ...
    public RepeatNetPictureDlgConfig mo223809clone() {
        RepeatNetPictureDlgConfig repeatNetPictureDlgConfig = new RepeatNetPictureDlgConfig();
        RepeatNetPictureDlgContent repeatNetPictureDlgContent = this.repeatPictureDlg;
        if (repeatNetPictureDlgContent != null) {
            repeatNetPictureDlgConfig.repeatPictureDlg = repeatNetPictureDlgContent.mo223809clone();
        }
        RepeatNetPictureDlgContent repeatNetPictureDlgContent2 = this.netPictureDlg;
        if (repeatNetPictureDlgContent2 != null) {
            repeatNetPictureDlgConfig.netPictureDlg = repeatNetPictureDlgContent2.mo223809clone();
        }
        RepeatNetPictureDlgContent repeatNetPictureDlgContent3 = this.swipeLimitDlg;
        if (repeatNetPictureDlgContent3 != null) {
            repeatNetPictureDlgConfig.swipeLimitDlg = repeatNetPictureDlgContent3.mo223809clone();
        }
        RepeatNetPictureTrigger repeatNetPictureTrigger = this.trigger;
        if (repeatNetPictureTrigger != null) {
            repeatNetPictureDlgConfig.trigger = repeatNetPictureTrigger.mo223809clone();
        }
        RepeatNetPictureDlgContent repeatNetPictureDlgContent4 = this.aiPictureDlg;
        if (repeatNetPictureDlgContent4 != null) {
            repeatNetPictureDlgConfig.aiPictureDlg = repeatNetPictureDlgContent4.mo223809clone();
        }
