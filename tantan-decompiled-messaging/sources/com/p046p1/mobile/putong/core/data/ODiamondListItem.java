...
public class ODiamondListItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ODiamondListItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<ODiamondListItem>() { // from class: com.p1.mobile.putong.core.data.ODiamondListItem.1
        ...
        public int computeAndCacheSize(ODiamondListItem oDiamondListItem) {
            ...
            int iM17230l = list != null ? CodedOutputByteBufferNano.m17230l(1, list, ODiamondListFeed.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            oDiamondListItem.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ODiamondListItem parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                oDiamondListItem.feeds = (List) nb5Var.m158743l(ODiamondListFeed.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return oDiamondListItem;
        }
        ...
        public void serialize(ODiamondListItem oDiamondListItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<ODiamondListFeed> list = oDiamondListItem.feeds;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(1, list, ODiamondListFeed.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public ODiamondListItem mo223809clone() {
        ODiamondListItem oDiamondListItem = new ODiamondListItem();
        ...
        if (list != null) {
            oDiamondListItem.feeds = ValueObject.util_map(list, new w9j() { // from class: l.gw40
                ...
                public final Object call(Object obj) {
                    return ((ODiamondListFeed) obj).mo223809clone();
                }
            });
        }
        return oDiamondListItem;
