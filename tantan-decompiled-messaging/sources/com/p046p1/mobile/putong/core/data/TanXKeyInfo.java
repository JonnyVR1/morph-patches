...
import com.p046p1.mobile.putong.core.data.TanXKeyInfo;
...
public class TanXKeyInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TanXKeyInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<TanXKeyInfo>() { // from class: com.p1.mobile.putong.core.data.TanXKeyInfo.1
        ...
        public int computeAndCacheSize(TanXKeyInfo tanXKeyInfo) {
            ...
            tanXKeyInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TanXKeyInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    tanXKeyInfo.iconType = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    tanXKeyInfo.type = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (tanXKeyInfo.iconType == null) {
                            tanXKeyInfo.iconType = "";
                    ...
                    tanXKeyInfo.contents = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return tanXKeyInfo;
        }
    ...
    public static /* synthetic */ String m35870a(String str) {
        return str;
    }
    ...
    public TanXKeyInfo mo223809clone() {
        TanXKeyInfo tanXKeyInfo = new TanXKeyInfo();
        ...
        if (list != null) {
            tanXKeyInfo.contents = ValueObject.util_map(list, new w9j() { // from class: l.a1i0
                ...
                public final Object call(Object obj) {
                    return TanXKeyInfo.m35870a((String) obj);
                }
            });
        }
        return tanXKeyInfo;
