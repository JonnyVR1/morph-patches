...
public class RewardsCardBean extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RewardsCardBean> PROTOBUF_ADAPTER = new MessageNanoAdapter<RewardsCardBean>() { // from class: com.p1.mobile.putong.core.data.RewardsCardBean.1
        ...
        public int computeAndCacheSize(RewardsCardBean rewardsCardBean) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, rewardsCardBean.number);
            Gender gender = rewardsCardBean.gender;
            if (gender != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(2, gender, Gender.PROTOBUF_ADAPTER);
            }
            rewardsCardBean.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RewardsCardBean parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    rewardsCardBean.number = nb5Var.m158741j();
                } else {
                    if (iM158752u != 18) {
                        if (rewardsCardBean.gender != null) {
                            break;
                    ...
                    rewardsCardBean.gender = (Gender) nb5Var.m158743l(Gender.PROTOBUF_ADAPTER);
                }
            }
            return rewardsCardBean;
        }
        ...
        public void serialize(RewardsCardBean rewardsCardBean, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, rewardsCardBean.number);
            Gender gender = rewardsCardBean.gender;
            if (gender != null) {
                codedOutputByteBufferNano.m17254K(2, gender, Gender.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public RewardsCardBean mo223809clone() {
        RewardsCardBean rewardsCardBean = new RewardsCardBean();
