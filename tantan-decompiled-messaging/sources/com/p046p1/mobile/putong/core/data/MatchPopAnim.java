...
public class MatchPopAnim extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MatchPopAnim> PROTOBUF_ADAPTER = new MessageNanoAdapter<MatchPopAnim>() { // from class: com.p1.mobile.putong.core.data.MatchPopAnim.1
        ...
        public int computeAndCacheSize(MatchPopAnim matchPopAnim) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, matchPopAnim.popEnter) + CodedOutputByteBufferNano.m17226h(2, matchPopAnim.popOut) + CodedOutputByteBufferNano.m17226h(3, matchPopAnim.speed) + CodedOutputByteBufferNano.m17226h(4, matchPopAnim.avatarDelay) + CodedOutputByteBufferNano.m17226h(5, matchPopAnim.avatarX) + CodedOutputByteBufferNano.m17226h(6, matchPopAnim.avatarAlpha) + CodedOutputByteBufferNano.m17226h(7, matchPopAnim.delaySpeed) + CodedOutputByteBufferNano.m17226h(8, matchPopAnim.avatarTransX) + CodedOutputByteBufferNano.m17226h(9, matchPopAnim.avatarRepeatTransX);
            matchPopAnim.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MatchPopAnim parse(nb5 nb5Var) throws IOException {
            MatchPopAnim matchPopAnim = new MatchPopAnim();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    matchPopAnim.popEnter = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    matchPopAnim.popOut = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    matchPopAnim.speed = nb5Var.m158741j();
                } else if (iM158752u == 32) {
                    matchPopAnim.avatarDelay = nb5Var.m158741j();
                } else if (iM158752u == 40) {
                    matchPopAnim.avatarX = nb5Var.m158741j();
                } else if (iM158752u == 48) {
                    matchPopAnim.avatarAlpha = nb5Var.m158741j();
                } else if (iM158752u == 56) {
                    matchPopAnim.delaySpeed = nb5Var.m158741j();
                } else if (iM158752u == 64) {
                    matchPopAnim.avatarTransX = nb5Var.m158741j();
                } else {
                    if (iM158752u != 72) {
                        return matchPopAnim;
                    }
                    matchPopAnim.avatarRepeatTransX = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(MatchPopAnim matchPopAnim, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, matchPopAnim.popEnter);
            codedOutputByteBufferNano.m17250G(2, matchPopAnim.popOut);
            codedOutputByteBufferNano.m17250G(3, matchPopAnim.speed);
            codedOutputByteBufferNano.m17250G(4, matchPopAnim.avatarDelay);
            codedOutputByteBufferNano.m17250G(5, matchPopAnim.avatarX);
            codedOutputByteBufferNano.m17250G(6, matchPopAnim.avatarAlpha);
            codedOutputByteBufferNano.m17250G(7, matchPopAnim.delaySpeed);
            codedOutputByteBufferNano.m17250G(8, matchPopAnim.avatarTransX);
            codedOutputByteBufferNano.m17250G(9, matchPopAnim.avatarRepeatTransX);
        }
    };
    ...
    public MatchPopAnim mo223809clone() {
        MatchPopAnim matchPopAnim = new MatchPopAnim();
