...
public class ChatGiftInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatGiftInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatGiftInfo>() { // from class: com.p1.mobile.putong.core.data.ChatGiftInfo.1
        ...
        public int computeAndCacheSize(ChatGiftInfo chatGiftInfo) {
            String str = chatGiftInfo.f20361id;
            ...
            chatGiftInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatGiftInfo parse(nb5 nb5Var) throws IOException {
            ChatGiftInfo chatGiftInfo = new ChatGiftInfo();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (chatGiftInfo.f20361id == null) {
                        chatGiftInfo.f20361id = "";
                    }
                ...
                if (iM158752u == 10) {
                    chatGiftInfo.f20361id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    chatGiftInfo.momentID = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (chatGiftInfo.f20361id == null) {
                            chatGiftInfo.f20361id = "";
                    ...
                    chatGiftInfo.extra = nb5Var.m158750s();
                }
            }
            return chatGiftInfo;
        }
        ...
        public boolean parseField(ChatGiftInfo chatGiftInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "momentID":
                    ...
                    return true;
                case "id":
                    chatGiftInfo.f20361id = jsonParser.getValueAsString();
                    return false;
                case "extra":
    ...
    public ChatGiftInfo mo223809clone() {
        ChatGiftInfo chatGiftInfo = new ChatGiftInfo();
        chatGiftInfo.f20361id = this.f20361id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20361id, chatGiftInfo.f20361id) && ValueObject.util_equals(this.momentID, chatGiftInfo.momentID) && ValueObject.util_equals(this.extra, chatGiftInfo.extra);
    }
