...
public class BarLoverCitys extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BarLoverCitys> PROTOBUF_ADAPTER = new MessageNanoAdapter<BarLoverCitys>() { // from class: com.p1.mobile.putong.core.data.BarLoverCitys.1
        ...
        public int computeAndCacheSize(BarLoverCitys barLoverCitys) {
            String str = barLoverCitys.f20352id;
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(5, barLoverCitys.f20353in);
            barLoverCitys.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BarLoverCitys parse(nb5 nb5Var) throws IOException {
            BarLoverCitys barLoverCitys = new BarLoverCitys();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (barLoverCitys.f20352id == null) {
                        barLoverCitys.f20352id = "";
                    }
                ...
                if (iM158752u == 10) {
                    barLoverCitys.f20352id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    barLoverCitys.name = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    barLoverCitys.key = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    barLoverCitys.icon = nb5Var.m158750s();
                } else {
                    if (iM158752u != 40) {
                        if (barLoverCitys.f20352id == null) {
                            barLoverCitys.f20352id = "";
                    ...
                    barLoverCitys.f20353in = nb5Var.m158738g();
                }
            }
            return barLoverCitys;
        }
        ...
        public void serialize(BarLoverCitys barLoverCitys, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(5, barLoverCitys.f20353in);
        }
    };
    public static JsonAdapter<BarLoverCitys> JSON_ADAPTER = new ObjectJsonAdapter<BarLoverCitys>() { // from class: com.p1.mobile.putong.core.data.BarLoverCitys.2
        ...
        public boolean parseField(BarLoverCitys barLoverCitys, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    barLoverCitys.f20352id = jsonParser.getValueAsString();
                    return false;
                case "in":
                    barLoverCitys.f20353in = jsonParser.getValueAsBoolean();
                    return true;
                case "key":
        ...
        public void serializeFields(BarLoverCitys barLoverCitys, JsonGenerator jsonGenerator) throws IOException {
            ...
            jsonGenerator.writeBooleanField("in", barLoverCitys.f20353in);
        }
    ...
    public BarLoverCitys mo223809clone() {
        BarLoverCitys barLoverCitys = new BarLoverCitys();
        barLoverCitys.f20352id = this.f20352id;
        barLoverCitys.name = this.name;
        barLoverCitys.key = this.key;
        barLoverCitys.icon = this.icon;
        barLoverCitys.f20353in = this.f20353in;
        return barLoverCitys;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20352id, barLoverCitys.f20352id) && ValueObject.util_equals(this.name, barLoverCitys.name) && ValueObject.util_equals(this.key, barLoverCitys.key) && ValueObject.util_equals(this.icon, barLoverCitys.icon) && this.f20353in == barLoverCitys.f20353in;
    }
    ...
    public int hashCode() {
        ...
        int iHashCode4 = ((iHashCode3 + (str4 != null ? str4.hashCode() : 0)) * 41) + (this.f20353in ? 1231 : 1237);
