...
public class StateQuestion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StateQuestion> PROTOBUF_ADAPTER = new MessageNanoAdapter<StateQuestion>() { // from class: com.p1.mobile.putong.core.data.StateQuestion.1
        ...
        public int computeAndCacheSize(StateQuestion stateQuestion) {
            ...
            String str2 = stateQuestion.f20503id;
            if (str2 != null) {
        ...
        public StateQuestion parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    ...
                    if (stateQuestion.f20503id != null) {
                        break;
                    }
                    stateQuestion.f20503id = "";
                    break;
                }
                if (iM158752u == 10) {
                    ...
                    stateQuestion.f20503id = nb5Var.m158750s();
                }
            }
            return stateQuestion;
        }
        ...
        public boolean parseField(StateQuestion stateQuestion, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "stateOptions":
                    ...
                    return true;
                case "id":
                    stateQuestion.f20503id = jsonParser.getValueAsString();
                    return false;
                default:
                    return false;
            }
    ...
    public StateQuestion mo223809clone() {
        ...
        stateQuestion.f20503id = this.f20503id;
        return stateQuestion;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.question, stateQuestion.question) && ValueObject.util_equals(this.stateOptions, stateQuestion.stateOptions) && ValueObject.util_equals(this.f20503id, stateQuestion.f20503id);
    }
