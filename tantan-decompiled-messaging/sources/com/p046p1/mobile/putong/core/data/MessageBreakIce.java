...
public class MessageBreakIce extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageBreakIce> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageBreakIce>() { // from class: com.p1.mobile.putong.core.data.MessageBreakIce.1
        ...
        public int computeAndCacheSize(MessageBreakIce messageBreakIce) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, messageBreakIce.enable) + CodedOutputByteBufferNano.m17220b(2, messageBreakIce.exchangeAnswerEnable);
            messageBreakIce.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageBreakIce parse(nb5 nb5Var) throws IOException {
            MessageBreakIce messageBreakIce = new MessageBreakIce();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    messageBreakIce.enable = nb5Var.m158738g();
                } else {
                    if (iM158752u != 16) {
                        return messageBreakIce;
                    }
                    messageBreakIce.exchangeAnswerEnable = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(MessageBreakIce messageBreakIce, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, messageBreakIce.enable);
            codedOutputByteBufferNano.m17244A(2, messageBreakIce.exchangeAnswerEnable);
        }
    };
    ...
    public MessageBreakIce mo223809clone() {
        MessageBreakIce messageBreakIce = new MessageBreakIce();
