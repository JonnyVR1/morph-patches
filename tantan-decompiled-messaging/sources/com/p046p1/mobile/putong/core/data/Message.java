...
import com.p046p1.mobile.putong.feed.data.Accessory;
...
public class Message extends DbObject<Message> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Message> PROTOBUF_ADAPTER = new MessageNanoAdapter<Message>() { // from class: com.p1.mobile.putong.core.data.Message.1
        ...
        public int computeAndCacheSize(Message message) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, message._id);
            String str = message.f56011id;
            if (str != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17228j2 = iM17228j + CodedOutputByteBufferNano.m17228j(51, message.localCreatedTime) + CodedOutputByteBufferNano.m17226h(52, message.localCreatedSession) + CodedOutputByteBufferNano.m17220b(53, message.localInMoment) + CodedOutputByteBufferNano.m17220b(54, message.localInConversation) + CodedOutputByteBufferNano.m17222d(55, message.createdTime);
            String str2 = message.cid;
            if (str2 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(56, str2);
            }
            List<Media> list = message.media;
            if (list != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(57, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = message.sticker;
            if (str3 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(58, str3);
            }
            String str4 = message.question;
            if (str4 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(59, str4);
            }
            MessageSentFrom messageSentFrom = message.sentFrom;
            if (messageSentFrom != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17226h(60, messageSentFrom.ordinal());
            }
            String str5 = message.moment;
            if (str5 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(61, str5);
            }
            String str6 = message.answerOfMessage;
            if (str6 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(62, str6);
            }
            String str7 = message.owner;
            if (str7 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(63, str7);
            }
            MessageLocation messageLocation = message.location;
            if (messageLocation != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(64, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            Boolean bool = message.recalled;
            if (bool != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17220b(65, bool.booleanValue());
            }
            String str8 = message.value;
            if (str8 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(66, str8);
            }
            NotificationStatus notificationStatus = message.localNotificationStatus;
            if (notificationStatus != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17226h(67, notificationStatus.ordinal());
            }
            String str9 = message.likeOfMoment;
            if (str9 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(68, str9);
            }
            String str10 = message.localAnimationKey;
            if (str10 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(69, str10);
            }
            MessageAccessory messageAccessory = message.api_only_accessory;
            if (messageAccessory != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(70, messageAccessory, MessageAccessory.PROTOBUF_ADAPTER);
            }
            List<GiftRecord> list2 = message.giftRecords;
            if (list2 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(71, list2, GiftRecord.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            CallRecord callRecord = message.call;
            if (callRecord != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(72, callRecord, CallRecord.PROTOBUF_ADAPTER);
            }
            String str11 = message.localCallType;
            if (str11 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(73, str11);
            }
            int iM17226h = iM17228j2 + CodedOutputByteBufferNano.m17226h(74, message.localCallStatus);
            CallHandledStatus callHandledStatus = message.localCallHandledStatus;
            if (callHandledStatus != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(75, callHandledStatus.ordinal());
            }
            List<PrivateQuestion> list3 = message.localPrivateQuestions;
            if (list3 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(76, list3, PrivateQuestion.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Letter letter = message.letter;
            if (letter != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(77, letter, Letter.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(78, message.chatTyping) + CodedOutputByteBufferNano.m17226h(79, message.localFailType);
            String str12 = message.recalledReason;
            if (str12 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(80, str12);
            }
            String str13 = message.recalledHint;
            if (str13 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(81, str13);
            }
            MessageType messageType = message.msgType;
            if (messageType != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(82, messageType.ordinal());
            }
            MessageType messageType2 = message.messageType;
            if (messageType2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(83, messageType2.ordinal());
            }
            MessageAdditionalData messageAdditionalData = message.additionalData;
            if (messageAdditionalData != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(84, messageAdditionalData, MessageAdditionalData.PROTOBUF_ADAPTER);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(85, message.localSafetyReminder) + CodedOutputByteBufferNano.m17220b(86, message.localSensitiveWordReminder);
            String str14 = message.msgData;
            if (str14 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(87, str14);
            }
            List<LocalBusinessType> list4 = message.localBusinessTypes;
            if (list4 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(88, LocalBusinessType.covertToOldEnumList(list4), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageSetting messageSetting = message.settings;
            if (messageSetting != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(89, messageSetting, MessageSetting.PROTOBUF_ADAPTER);
            }
            MessageChannel messageChannel = message.channel;
            if (messageChannel != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17226h(90, messageChannel.ordinal());
            }
            List<String> list5 = message.notifiedUsers;
            if (list5 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(91, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            MessageStatus messageStatus = message.status;
            if (messageStatus != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17226h(92, messageStatus.ordinal());
            }
            String str15 = message.referenceMsgId;
            if (str15 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(93, str15);
            }
            String str16 = message.hostId;
            if (str16 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(94, str16);
            }
            String str17 = message.localRedPacketType;
            if (str17 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(95, str17);
            }
            AudioText audioText = message.localAudioText;
            if (audioText != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(96, audioText, AudioText.PROTOBUF_ADAPTER);
            }
            String str18 = message.localGreetingId;
            if (str18 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(97, str18);
            }
            int iM17220b3 = iM17220b2 + CodedOutputByteBufferNano.m17220b(98, message.read) + CodedOutputByteBufferNano.m17220b(99, message.needRead);
            MessageExtData messageExtData = message.extData;
            if (messageExtData != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(100, messageExtData, MessageExtData.PROTOBUF_ADAPTER);
            }
            String str19 = message.fromConvType;
            if (str19 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17233o(101, str19);
            }
            String str20 = message.localExtraInfo;
            if (str20 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17233o(102, str20);
            }
            MessageSentFrom messageSentFrom2 = message.sentFrom;
            if (messageSentFrom2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(103, messageSentFrom2, MessageSentFrom.PROTOBUF_ADAPTER);
            }
            NotificationStatus notificationStatus2 = message.localNotificationStatus;
            if (notificationStatus2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(104, notificationStatus2, NotificationStatus.PROTOBUF_ADAPTER);
            }
            CallHandledStatus callHandledStatus2 = message.localCallHandledStatus;
            if (callHandledStatus2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(105, callHandledStatus2, CallHandledStatus.PROTOBUF_ADAPTER);
            }
            MessageType messageType3 = message.msgType;
            if (messageType3 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(106, messageType3, MessageType.PROTOBUF_ADAPTER);
            }
            MessageType messageType4 = message.messageType;
            if (messageType4 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(107, messageType4, MessageType.PROTOBUF_ADAPTER);
            }
            List<LocalBusinessType> list6 = message.localBusinessTypes;
            if (list6 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(108, list6, LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageChannel messageChannel2 = message.channel;
            if (messageChannel2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(109, messageChannel2, MessageChannel.PROTOBUF_ADAPTER);
            }
            MessageStatus messageStatus2 = message.status;
            if (messageStatus2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(110, messageStatus2, MessageStatus.PROTOBUF_ADAPTER);
            }
            String str21 = message.incTempInfo;
            if (str21 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17233o(111, str21);
            }
            List<String> list7 = message.riskTags;
            if (list7 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(112, list7, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17226h2 = iM17220b3 + CodedOutputByteBufferNano.m17226h(113, message.localMyVisitorCount) + CodedOutputByteBufferNano.m17220b(114, message.localMyVisitorHidden);
            message.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Message parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        message._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        message.f56011id = nb5Var.m158750s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        message.localCreatedTime = nb5Var.m158742k();
                        continue;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        message.localCreatedSession = nb5Var.m158741j();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        message.localInMoment = nb5Var.m158738g();
                        continue;
                    case 432:
                        message.localInConversation = nb5Var.m158738g();
                        continue;
                    case 441:
                        message.createdTime = nb5Var.m158739h();
                        continue;
                    case 450:
                        message.cid = nb5Var.m158750s();
                        continue;
                    case 458:
                        message.media = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 466:
                        message.sticker = nb5Var.m158750s();
                        continue;
                    case 474:
                        message.question = nb5Var.m158750s();
                        continue;
                    case 480:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 490:
                        message.moment = nb5Var.m158750s();
                        continue;
                    case 498:
                        message.answerOfMessage = nb5Var.m158750s();
                        continue;
                    case 506:
                        message.owner = nb5Var.m158750s();
                        continue;
                    case 514:
                        message.location = (MessageLocation) nb5Var.m158743l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 520:
                        message.recalled = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 530:
                        message.value = nb5Var.m158750s();
                        continue;
                    case 536:
                        numValueOf2 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 546:
                        message.likeOfMoment = nb5Var.m158750s();
                        continue;
                    case 554:
                        message.localAnimationKey = nb5Var.m158750s();
                        continue;
                    case 562:
                        message.api_only_accessory = (MessageAccessory) nb5Var.m158743l(MessageAccessory.PROTOBUF_ADAPTER);
                        continue;
                    case 570:
                        message.giftRecords = (List) nb5Var.m158743l(GiftRecord.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED_BASELINE /* 578 */:
                        message.call = (CallRecord) nb5Var.m158743l(CallRecord.PROTOBUF_ADAPTER);
                        continue;
                    case 586:
                        message.localCallType = nb5Var.m158750s();
                        continue;
                    case 592:
                        message.localCallStatus = nb5Var.m158741j();
                        continue;
                    case 600:
                        numValueOf3 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 610:
                        message.localPrivateQuestions = (List) nb5Var.m158743l(PrivateQuestion.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 618:
                        message.letter = (Letter) nb5Var.m158743l(Letter.PROTOBUF_ADAPTER);
                        continue;
                    case 624:
                        message.chatTyping = nb5Var.m158738g();
                        continue;
                    case 632:
                        message.localFailType = nb5Var.m158741j();
                        continue;
                    case 642:
                        message.recalledReason = nb5Var.m158750s();
                        continue;
                    case 650:
                        message.recalledHint = nb5Var.m158750s();
                        continue;
                    case 656:
                    ...
                    case 664:
                        ...
                        continue;
                    case 674:
                        message.additionalData = (MessageAdditionalData) nb5Var.m158743l(MessageAdditionalData.PROTOBUF_ADAPTER);
                        continue;
                    case 680:
                        message.localSafetyReminder = nb5Var.m158738g();
                        continue;
                    case 688:
                        message.localSensitiveWordReminder = nb5Var.m158738g();
                        continue;
                    case 698:
                        message.msgData = nb5Var.m158750s();
                        continue;
                    case 706:
                    ...
                    case Constants.AUDIO_MIXING_STATE_FAILED /* 714 */:
                        message.settings = (MessageSetting) nb5Var.m158743l(MessageSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 720:
                        numValueOf6 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 730:
                        message.notifiedUsers = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 736:
                        numValueOf7 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 746:
                        message.referenceMsgId = nb5Var.m158750s();
                        continue;
                    case DetectDelayStopHelper.TYPE_DETECT_AR_GIFT /* 754 */:
                        message.hostId = nb5Var.m158750s();
                        continue;
                    case 762:
                        message.localRedPacketType = nb5Var.m158750s();
                        continue;
                    case 770:
                        message.localAudioText = (AudioText) nb5Var.m158743l(AudioText.PROTOBUF_ADAPTER);
                        continue;
                    case 778:
                        message.localGreetingId = nb5Var.m158750s();
                        continue;
                    case 784:
                        message.read = nb5Var.m158738g();
                        continue;
                    case 792:
                        message.needRead = nb5Var.m158738g();
                        continue;
                    case 802:
                        message.extData = (MessageExtData) nb5Var.m158743l(MessageExtData.PROTOBUF_ADAPTER);
                        continue;
                    case Constants.RHYTHM_PLAYER_STATE_IDLE /* 810 */:
                        message.fromConvType = nb5Var.m158750s();
                        continue;
                    case 818:
                        message.localExtraInfo = nb5Var.m158750s();
                        continue;
                    case 826:
                        message.sentFrom = (MessageSentFrom) nb5Var.m158743l(MessageSentFrom.PROTOBUF_ADAPTER);
                        continue;
                    case 834:
                        message.localNotificationStatus = (NotificationStatus) nb5Var.m158743l(NotificationStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 842:
                        message.localCallHandledStatus = (CallHandledStatus) nb5Var.m158743l(CallHandledStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 850:
                        message.msgType = (MessageType) nb5Var.m158743l(MessageType.PROTOBUF_ADAPTER);
                        continue;
                    case 858:
                        message.messageType = (MessageType) nb5Var.m158743l(MessageType.PROTOBUF_ADAPTER);
                        continue;
                    case 866:
                        message.localBusinessTypes = (List) nb5Var.m158743l(LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 874:
                        message.channel = (MessageChannel) nb5Var.m158743l(MessageChannel.PROTOBUF_ADAPTER);
                        continue;
                    case 882:
                        message.status = (MessageStatus) nb5Var.m158743l(MessageStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 890:
                        message.incTempInfo = nb5Var.m158750s();
                        continue;
                    case 898:
                        message.riskTags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case IMediaPlayer.MEDIA_INFO_ML_DROP_STOP /* 904 */:
                        message.localMyVisitorCount = nb5Var.m158741j();
                        continue;
                    case 912:
                        message.localMyVisitorHidden = nb5Var.m158738g();
                        continue;
                    default:
                        if (message.sentFrom == null && numValueOf != null) {
                            message.sentFrom = (MessageSentFrom) MessageSentFrom.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Message message, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, message._id);
            String str = message.f56011id;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17252I(51, message.localCreatedTime);
            codedOutputByteBufferNano.m17250G(52, message.localCreatedSession);
            codedOutputByteBufferNano.m17244A(53, message.localInMoment);
            codedOutputByteBufferNano.m17244A(54, message.localInConversation);
            codedOutputByteBufferNano.m17246C(55, message.createdTime);
            String str2 = message.cid;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(56, str2);
            }
            List<Media> list = message.media;
            if (list != null) {
            ...
            String str3 = message.sticker;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(58, str3);
            }
            String str4 = message.question;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(59, str4);
            }
            MessageSentFrom messageSentFrom = message.sentFrom;
            if (messageSentFrom != null) {
                codedOutputByteBufferNano.m17250G(60, messageSentFrom.ordinal());
            }
            String str5 = message.moment;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(61, str5);
            }
            String str6 = message.answerOfMessage;
            if (str6 != null) {
            ...
            MessageLocation messageLocation = message.location;
            if (messageLocation != null) {
                codedOutputByteBufferNano.m17254K(64, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            Boolean bool = message.recalled;
            if (bool != null) {
                codedOutputByteBufferNano.m17244A(65, bool.booleanValue());
            }
            String str8 = message.value;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(66, str8);
            }
            NotificationStatus notificationStatus = message.localNotificationStatus;
            if (notificationStatus != null) {
                codedOutputByteBufferNano.m17250G(67, notificationStatus.ordinal());
            }
            String str9 = message.likeOfMoment;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(68, str9);
            }
            String str10 = message.localAnimationKey;
            if (str10 != null) {
                codedOutputByteBufferNano.m17261R(69, str10);
            }
            MessageAccessory messageAccessory = message.api_only_accessory;
            if (messageAccessory != null) {
                codedOutputByteBufferNano.m17254K(70, messageAccessory, MessageAccessory.PROTOBUF_ADAPTER);
            }
            List<GiftRecord> list2 = message.giftRecords;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(71, list2, GiftRecord.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            CallRecord callRecord = message.call;
            if (callRecord != null) {
                codedOutputByteBufferNano.m17254K(72, callRecord, CallRecord.PROTOBUF_ADAPTER);
            }
            String str11 = message.localCallType;
            if (str11 != null) {
                codedOutputByteBufferNano.m17261R(73, str11);
            }
            codedOutputByteBufferNano.m17250G(74, message.localCallStatus);
            CallHandledStatus callHandledStatus = message.localCallHandledStatus;
            if (callHandledStatus != null) {
                codedOutputByteBufferNano.m17250G(75, callHandledStatus.ordinal());
            }
            List<PrivateQuestion> list3 = message.localPrivateQuestions;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(76, list3, PrivateQuestion.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Letter letter = message.letter;
            if (letter != null) {
                codedOutputByteBufferNano.m17254K(77, letter, Letter.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(78, message.chatTyping);
            codedOutputByteBufferNano.m17250G(79, message.localFailType);
            String str12 = message.recalledReason;
            if (str12 != null) {
                codedOutputByteBufferNano.m17261R(80, str12);
            }
            String str13 = message.recalledHint;
            if (str13 != null) {
                codedOutputByteBufferNano.m17261R(81, str13);
            }
            MessageType messageType = message.msgType;
            if (messageType != null) {
                codedOutputByteBufferNano.m17250G(82, messageType.ordinal());
            }
            MessageType messageType2 = message.messageType;
            if (messageType2 != null) {
                codedOutputByteBufferNano.m17250G(83, messageType2.ordinal());
            }
            MessageAdditionalData messageAdditionalData = message.additionalData;
            if (messageAdditionalData != null) {
                codedOutputByteBufferNano.m17254K(84, messageAdditionalData, MessageAdditionalData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(85, message.localSafetyReminder);
            codedOutputByteBufferNano.m17244A(86, message.localSensitiveWordReminder);
            String str14 = message.msgData;
            if (str14 != null) {
                codedOutputByteBufferNano.m17261R(87, str14);
            }
            List<LocalBusinessType> list4 = message.localBusinessTypes;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(88, LocalBusinessType.covertToOldEnumList(list4), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageSetting messageSetting = message.settings;
            if (messageSetting != null) {
                codedOutputByteBufferNano.m17254K(89, messageSetting, MessageSetting.PROTOBUF_ADAPTER);
            }
            MessageChannel messageChannel = message.channel;
            if (messageChannel != null) {
                codedOutputByteBufferNano.m17250G(90, messageChannel.ordinal());
            }
            List<String> list5 = message.notifiedUsers;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(91, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            MessageStatus messageStatus = message.status;
            if (messageStatus != null) {
                codedOutputByteBufferNano.m17250G(92, messageStatus.ordinal());
            }
            String str15 = message.referenceMsgId;
            if (str15 != null) {
                codedOutputByteBufferNano.m17261R(93, str15);
            }
            String str16 = message.hostId;
            if (str16 != null) {
                codedOutputByteBufferNano.m17261R(94, str16);
            }
            String str17 = message.localRedPacketType;
            if (str17 != null) {
                codedOutputByteBufferNano.m17261R(95, str17);
            }
            AudioText audioText = message.localAudioText;
            if (audioText != null) {
                codedOutputByteBufferNano.m17254K(96, audioText, AudioText.PROTOBUF_ADAPTER);
            }
            String str18 = message.localGreetingId;
            if (str18 != null) {
                codedOutputByteBufferNano.m17261R(97, str18);
            }
            codedOutputByteBufferNano.m17244A(98, message.read);
            codedOutputByteBufferNano.m17244A(99, message.needRead);
            MessageExtData messageExtData = message.extData;
            if (messageExtData != null) {
                codedOutputByteBufferNano.m17254K(100, messageExtData, MessageExtData.PROTOBUF_ADAPTER);
            }
            String str19 = message.fromConvType;
            if (str19 != null) {
                codedOutputByteBufferNano.m17261R(101, str19);
            }
            String str20 = message.localExtraInfo;
            if (str20 != null) {
                codedOutputByteBufferNano.m17261R(102, str20);
            }
            MessageSentFrom messageSentFrom2 = message.sentFrom;
            if (messageSentFrom2 != null) {
                codedOutputByteBufferNano.m17254K(103, messageSentFrom2, MessageSentFrom.PROTOBUF_ADAPTER);
            }
            NotificationStatus notificationStatus2 = message.localNotificationStatus;
            if (notificationStatus2 != null) {
                codedOutputByteBufferNano.m17254K(104, notificationStatus2, NotificationStatus.PROTOBUF_ADAPTER);
            }
            CallHandledStatus callHandledStatus2 = message.localCallHandledStatus;
            if (callHandledStatus2 != null) {
                codedOutputByteBufferNano.m17254K(105, callHandledStatus2, CallHandledStatus.PROTOBUF_ADAPTER);
            }
            MessageType messageType3 = message.msgType;
            if (messageType3 != null) {
                codedOutputByteBufferNano.m17254K(106, messageType3, MessageType.PROTOBUF_ADAPTER);
            }
            MessageType messageType4 = message.messageType;
            if (messageType4 != null) {
                codedOutputByteBufferNano.m17254K(107, messageType4, MessageType.PROTOBUF_ADAPTER);
            }
            List<LocalBusinessType> list6 = message.localBusinessTypes;
            if (list6 != null) {
                codedOutputByteBufferNano.m17254K(108, list6, LocalBusinessType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageChannel messageChannel2 = message.channel;
            if (messageChannel2 != null) {
                codedOutputByteBufferNano.m17254K(109, messageChannel2, MessageChannel.PROTOBUF_ADAPTER);
            }
            MessageStatus messageStatus2 = message.status;
            if (messageStatus2 != null) {
                codedOutputByteBufferNano.m17254K(110, messageStatus2, MessageStatus.PROTOBUF_ADAPTER);
            }
            String str21 = message.incTempInfo;
            if (str21 != null) {
                codedOutputByteBufferNano.m17261R(111, str21);
            }
            List<String> list7 = message.riskTags;
            if (list7 != null) {
                codedOutputByteBufferNano.m17254K(112, list7, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(113, message.localMyVisitorCount);
            codedOutputByteBufferNano.m17244A(114, message.localMyVisitorHidden);
        }
    };
        ...
        public boolean parseField(Message message, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 23:
                    ...
                    return true;
                case 24:
                    message.f56011id = jsonParser.getValueAsString();
                    return false;
                case 25:
    ...
    public static final StringColumn<Message> f20441ID = new StringColumn<Message>("id_c") { // from class: com.p1.mobile.putong.core.data.Message.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Message message) {
            return message.f56011id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Message message, String str) {
            message.f56011id = str;
        }
    };
        ...
        DB_ADAPTER = new mrf0<Message>() { // from class: com.p1.mobile.putong.core.data.Message.61
            ...
            public Message read(Cursor cursor, int i) {
                ...
                try {
                    ...
                    int i9 = i + 1;
                    message.f56011id = cursor.isNull(i9) ? null : cursor.getString(i9);
            ...
            public void write(Message message, ContentValues contentValues) {
                try {
                    DbObject.cvPut(contentValues, "id_c", message.f56011id);
    ...
    public static /* synthetic */ LocalBusinessType m35669a(LocalBusinessType localBusinessType) {
        return localBusinessType;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m35673e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m35674f(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m35675k(String str) {
        return str;
    }
    ...
    public Message beforeApiSerialize() {
        Message messageMo223809clone = mo223809clone();
        messageMo223809clone.reverseParseComplete();
        return messageMo223809clone;
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public Message mo223809clone() {
        Message message = new Message();
        message._id = this._id;
        message.f56011id = this.f56011id;
        ...
        if (messageReference != null) {
            message.api_only_reference = messageReference.mo223809clone();
        }
        ...
        if (messageLocation != null) {
            message.location = messageLocation.mo223809clone();
        }
        ...
        if (messageAccessory != null) {
            message.api_only_accessory = messageAccessory.mo223809clone();
        }
        ...
        if (callRecord != null) {
            message.call = callRecord.mo223809clone();
        }
        ...
        if (letter != null) {
            message.letter = letter.mo223809clone();
        }
        ...
        if (messageAdditionalData != null) {
            message.additionalData = messageAdditionalData.mo223809clone();
        }
        CommentInfo commentInfo = this.commentInfo;
        if (commentInfo != null) {
            message.commentInfo = commentInfo.mo223809clone();
        }
        ...
        if (list4 != null) {
            message.subCommentIds = ValueObject.util_map(list4, new w9j() { // from class: l.zjy
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Message.m35675k((String) obj);
                }
            });
        }
        ...
        if (list5 != null) {
            message.localBusinessTypes = ValueObject.util_map(list5, new w9j() { // from class: l.aky
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Message.m35669a((LocalBusinessType) obj);
                }
            });
        }
        MessageSetting messageSetting = this.settings;
        if (messageSetting != null) {
            message.settings = messageSetting.mo223809clone();
        }
        ...
        if (list6 != null) {
            message.notifiedUsers = ValueObject.util_map(list6, new w9j() { // from class: l.bky
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Message.m35674f((String) obj);
                }
            });
        }
        ...
        if (audioText != null) {
            message.localAudioText = audioText.mo223809clone();
        }
        ...
        if (messageExtData != null) {
            message.extData = messageExtData.mo223809clone();
        }
        ...
        if (list7 != null) {
            message.riskTags = ValueObject.util_map(list7, new w9j() { // from class: l.cky
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Message.m35673e((String) obj);
                }
            });
        }
    ...
    public AiChatMessageExtraInfo getAiChatMessageExtraInfo() {
        ...
        if (NullChecker.m81303a(this.aiChatMessageExtraInfo) && TextUtils.equals(this.msgDataOld, this.msgData)) {
    ...
    public boolean isCaller() {
        return this.additionalData == null ? isMe() : TextUtils.equals(qib0.f154714c0.userId(), this.additionalData.caller);
    }
    ...
    public boolean isMe() {
        return qib0.f154714c0.userId().equals(this.owner);
    }
    ...
    public void onApiParseComplete() {
        if (!TEnum.equals(this.channel, "group")) {
            this.cid = this.owner.equals(qib0.f154714c0.userId()) ? this.api_only_otherUser : this.owner;
        }
        ...
        if (messageReference != null) {
            ...
            if (zEquals) {
                this.answerOfMessage = messageReference2.f20447id;
            } else {
                ...
                if (zEquals2) {
                    ...
                    if (zEquals3) {
                        this.likeOfMoment = messageReference4.f20447id;
                    } else {
                        this.moment = messageReference4.f20447id;
                    }
                } else if (TextUtils.equals("topic", messageReference3.type) && NullChecker.m81303a(this.api_only_reference.topic)) {
                    this.incTempInfo = this.api_only_reference.topic.toJson();
                } else {
                    this.referenceMsgId = this.api_only_reference.f20447id;
                }
            }
        ...
        if (messageAccessory != null) {
            ...
            if (zEquals4) {
                this.question = messageAccessory2.f20442id;
            } else if (messageAccessory2.type.equals("sticker")) {
                this.sticker = this.api_only_accessory.f20442id;
            }
        }
        List<Media> list = this.media;
    ...
    public void reverseParseComplete() {
        if (TextUtils.isEmpty(this.api_only_otherUser) && !TEnum.equals(this.channel, "group")) {
            ...
            this.api_only_otherUser = (str == null || !str.equals(qib0.f154714c0.userId())) ? qib0.f154714c0.userId() : this.cid;
        }
        if (this.answerOfMessage != null) {
            MessageReference messageReference = new MessageReference();
            this.api_only_reference = messageReference;
            messageReference.f20447id = this.answerOfMessage;
        ...
        if (this.moment != null) {
            ...
            messageReference2.f20447id = this.moment;
        ...
        if (this.sticker != null) {
            ...
            messageAccessory.f20442id = this.sticker;
        }
        ...
        messageReferenceNew_.f20447id = this.referenceMsgId;
