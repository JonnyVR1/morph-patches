...
import com.p046p1.mobile.putong.core.data.RankingBoard;
...
public class RankingBoard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RankingBoard> PROTOBUF_ADAPTER = new MessageNanoAdapter<RankingBoard>() { // from class: com.p1.mobile.putong.core.data.RankingBoard.1
        ...
        public int computeAndCacheSize(RankingBoard rankingBoard) {
            String str = rankingBoard.f20485id;
            ...
            if (list2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, list2, RankingTopic.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        ...
        public RankingBoard parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    if (rankingBoard.f20485id == null) {
                        rankingBoard.f20485id = "";
                    }
                ...
                if (iM158752u == 10) {
                    rankingBoard.f20485id = nb5Var.m158750s();
                    ...
                    rankingBoard.topics = (List) nb5Var.m158743l(RankingTopic.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return rankingBoard;
        }
        ...
        public void serialize(RankingBoard rankingBoard, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<RankingTopic> list2 = rankingBoard.topics;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(4, list2, RankingTopic.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
        ...
        public boolean parseField(RankingBoard rankingBoard, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "topics":
                    ...
                    return true;
                case "id":
                    rankingBoard.f20485id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public static /* synthetic */ String m35804b(String str) {
        return str;
    }
    ...
    public RankingBoard mo223809clone() {
        RankingBoard rankingBoard = new RankingBoard();
        rankingBoard.f20485id = this.f20485id;
        ...
        if (list != null) {
            rankingBoard.topicIds = ValueObject.util_map(list, new w9j() { // from class: l.jcc0
                ...
                public final Object call(Object obj) {
                    return RankingBoard.m35804b((String) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f20485id, rankingBoard.f20485id) && ValueObject.util_equals(this.name, rankingBoard.name) && ValueObject.util_equals(this.topicIds, rankingBoard.topicIds) && ValueObject.util_equals(this.topics, rankingBoard.topics);
    }
