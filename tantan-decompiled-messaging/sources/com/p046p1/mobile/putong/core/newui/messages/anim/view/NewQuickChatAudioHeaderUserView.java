...
public final class NewQuickChatAudioHeaderUserView extends QuickChatAudioBaseHeaderUserView {
    ...
    public NewQuickChatAudioHeaderUserView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m41999n0(layoutInflaterM163037a, this);
        this.broadcastTextTimerValue = -1L;
    }

    /* JADX INFO: renamed from: k0 */
    public static void m41995k0(f30 f30Var, boolean z, View view) {
        f30Var.call(Boolean.valueOf(z), "");
    }

    /* JADX INFO: renamed from: l0 */
    public static void m41996l0(e30 e30Var, boolean z, View view) {
        e30Var.call(Boolean.valueOf(z));
    }

    /* JADX INFO: renamed from: m0 */
    public static void m41997m0(f30 f30Var, boolean z, View view) {
        f30Var.call(Boolean.valueOf(z), "");
    }
    ...
    public void mo41998j0(@Nullable Act act, @Nullable OnlineMatchPushUser onlineMatchPushUser, final boolean isMatch, @Nullable OnlineMatchMatchUser matchUser, @NotNull final f30<Boolean, String> click, @NotNull final e30<Boolean> close) {
        ...
        setOnClickListener(new View.OnClickListener() { // from class: l.j840
            ...
            public final void onClick(View view) {
                NewQuickChatAudioHeaderUserView.m41997m0(click, isMatch, view);
            }
        });
        get_gotochat().setOnClickListener(new View.OnClickListener() { // from class: l.k840
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NewQuickChatAudioHeaderUserView.m41995k0(click, isMatch, view);
            }
        });
        get_close().setOnClickListener(new View.OnClickListener() { // from class: l.l840
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NewQuickChatAudioHeaderUserView.m41996l0(close, isMatch, view);
            }
        });
    }
    ...
    public final View m41999n0(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM153450b = m840.m153450b(this, inflater, parent);
        viewM153450b.getClass();
        return viewM153450b;
    }
