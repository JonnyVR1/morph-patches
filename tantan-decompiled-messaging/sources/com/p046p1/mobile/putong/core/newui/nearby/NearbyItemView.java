...
public final class NearbyItemView extends FrameLayout {
    ...
    public static void m42710a(d30 d30Var, View view) {
        if (d30Var != null) {
            d30Var.call();
        }
    }
    ...
    public final void m42711b(View view) {
        e820.m115237a(this, view);
    }

    @NotNull
    /* JADX INFO: renamed from: c */
    public final Act m42712c() {
    ...
    public final String m42713d(int distance) {
        String strValueOf;
        String str = "km";
        if (distance >= 10000) {
            strValueOf = "10+";
    ...
    public final void m42714e(@NotNull User user, boolean hasPrivilege) {
        user.getClass();
    ...
    public final void m42716g(User user) {
        if (this.shouldBlur) {
            get_blur_desc().setText(m42713d(user.location.distance));
            xdl0.m208344M(get_user_info(), false);
            xdl0.m208344M(get_blur_desc(), true);
        } else {
            get_user_name().setText(user.name);
            get_user_distance().setText(m42713d(user.location.distance));
    ...
    public final void setPairingClickAction(@Nullable final d30 action) {
        xdl0.m208342L(get_pairing(), new View.OnClickListener() { // from class: l.d820
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NearbyItemView.m42710a(action, view);
            }
        });
    }
