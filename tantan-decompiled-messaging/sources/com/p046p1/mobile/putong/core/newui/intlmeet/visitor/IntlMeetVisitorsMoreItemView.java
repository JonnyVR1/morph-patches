...
import com.p046p1.mobile.putong.core.newui.intlmeet.visitor.IntlMeetVisitorsMoreItemView;
...
public final class IntlMeetVisitorsMoreItemView extends LinearLayout {
    ...
    public static void m39518a(IntlMeetVisitorsMoreItemView intlMeetVisitorsMoreItemView, View view) {
        CoreModule.m29935P().m94651a().mo33492eh(intlMeetVisitorsMoreItemView.m39520c());
    }

    /* JADX INFO: renamed from: b */
    public final void m39519b(View view) {
        cko.m107420a(this, view);
    }

    @Nullable
    /* JADX INFO: renamed from: c */
    public final Act m39520c() {
    ...
    public void onFinishInflate() {
        ...
        m39519b(this);
        xdl0.m208329E0(this, new View.OnClickListener() { // from class: l.bko
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IntlMeetVisitorsMoreItemView.m39518a(this.f76063a, view);
            }
        });
    }
