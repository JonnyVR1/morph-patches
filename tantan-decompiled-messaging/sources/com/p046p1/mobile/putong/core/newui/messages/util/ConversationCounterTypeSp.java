package com.p046p1.mobile.putong.core.newui.messages.util;
...
public enum ConversationCounterTypeSp {
    ...
    private void init() {
        if (this.f25955sp == null) {
            if (this.ignoreAccount) {
                this.f25955sp = new uqd0(this.spKey, this.defValue);
            } else {
                this.f25955sp = new uqd0(this.spKey + CoreModule.m29931H().userId(), this.defValue);
            }
        }
        if (this.jsonObject == null) {
            try {
                this.jsonObject = new JSONObject(this.f25955sp.get());
    ...
    public void clear() {
        if (NullChecker.m81303a(this.f25955sp)) {
            this.f25955sp.clear();
        }
        reset();
    }
    ...
    public void set(String str, int i) {
        ...
        try {
            ...
            this.f25955sp.put(this.jsonObject.toString());
        } catch (JSONException unused) {
        }
    }
