...
public class LinearLayoutFixedLayout extends FrameLayout {
    ...
    public LinearLayoutFixedLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, e9c0.f89976M0);
            this.f24546a = typedArrayObtainStyledAttributes.getDimension(e9c0.f89979N0, 0.0f);
