...
public final class SupremeCountDownView extends LinearLayout {
    ...
    public final void m43596a(View view) {
        lzg0.m152349a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m43597b(long time) {
        List<String> listM155940k = mqi0.m155940k(time);
        if (listM155940k.size() == 1) {
            get_rl_content_tv_hour().setText("0");
            get_rl_content_tv_minute().setText("0");
            get_rl_content_tv_second().setText("1");
        } else {
            get_rl_content_tv_hour().setText(listM155940k.get(0));
            get_rl_content_tv_minute().setText(listM155940k.get(1));
            get_rl_content_tv_second().setText(listM155940k.get(2));
        }
    }
    ...
    public final RelativeLayout get_rl_content() {
        ...
        Intrinsics.m87502r("_rl_content");
        return null;
    }
    ...
    public final TextView get_rl_content_title() {
        ...
        Intrinsics.m87502r("_rl_content_title");
        return null;
    }
    ...
    public final TextView get_rl_content_tv_hour() {
        ...
        Intrinsics.m87502r("_rl_content_tv_hour");
        return null;
    }
    ...
    public final TextView get_rl_content_tv_minute() {
        ...
        Intrinsics.m87502r("_rl_content_tv_minute");
        return null;
    }
    ...
    public final TextView get_rl_content_tv_second() {
        ...
        Intrinsics.m87502r("_rl_content_tv_second");
        return null;
    }
