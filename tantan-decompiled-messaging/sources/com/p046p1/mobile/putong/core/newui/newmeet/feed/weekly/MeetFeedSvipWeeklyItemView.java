package com.p046p1.mobile.putong.core.newui.newmeet.feed.weekly;
...
public final class MeetFeedSvipWeeklyItemView extends LinearLayout {
    ...
    public static void m42954a(MeetFeedSvipWeeklyItemView meetFeedSvipWeeklyItemView, View view) {
        meetFeedSvipWeeklyItemView.m42961h();
    }

    /* JADX INFO: renamed from: b */
    public static void m42955b(MeetFeedSvipWeeklyItemView meetFeedSvipWeeklyItemView, View view) {
        zvf0.m220396r("e_svip_report_rebuy", "p_meet");
        Act act = meetFeedSvipWeeklyItemView.getPresenter().act();
        if (act != null) {
            CoreModule.m29935P().m94651a().mo33565pr(act, "p_meet,e_svip_report_rebuy,click", Privilege.see_who_likes_me);
        }
    }

    /* JADX INFO: renamed from: c */
    public static void m42956c(MeetFeedSvipWeeklyItemView meetFeedSvipWeeklyItemView, View view) {
        zvf0.m220396r("e_svip_report_upgrade", "p_meet");
        Act act = meetFeedSvipWeeklyItemView.getPresenter().act();
        if (act != null) {
            CoreModule.m29935P().m94656g().mo35021Og(act, "p_meet,e_svip_report_upgrade,click", null, null, null, Privilege.oDiamondVisitor);
        }
    }

    /* JADX INFO: renamed from: d */
    public final void m42957d(View view) {
        p1y.m167119a(this, view);
    }

    /* JADX INFO: renamed from: e */
    public final void m42958e() {
        ...
        xdl0.m208344M(get_weekly_content_container(), false);
        get_header_arrow_ic().setImageResource(b3c0.f73128p5);
    }
    ...
    public final void m42959f() {
        ...
        this.curArrowState = i2;
        xdl0.m208344M(get_weekly_content_container(), true);
        get_header_arrow_ic().setImageResource(b3c0.f73136q5);
        m42963j();
    }

    /* JADX INFO: renamed from: g */
    public final void m42960g(Act act) {
        if (act != null) {
            ...
            list.getClass();
            l1yVar.m148214j(act, list, get_weekly_content_root());
        }
    }
    ...
    public final MeetFeedSvipWeeklyItemData getWeeklyItemData() {
        ...
        Intrinsics.m87502r("weeklyItemData");
        return null;
    }
    ...
    public final ImageView get_header_arrow_ic() {
        ...
        Intrinsics.m87502r("_header_arrow_ic");
        return null;
    }
    ...
    public final RelativeLayout get_header_container() {
        ...
        Intrinsics.m87502r("_header_container");
        return null;
    }
    ...
    public final ImageView get_header_privilege_ic() {
        ...
        Intrinsics.m87502r("_header_privilege_ic");
        return null;
    }
    ...
    public final VText get_header_subtitle() {
        ...
        Intrinsics.m87502r("_header_subtitle");
        return null;
    }
    ...
    public final VText get_header_title() {
        ...
        Intrinsics.m87502r("_header_title");
        return null;
    }
    ...
    public final VText get_odiamond_buy_btn() {
        ...
        Intrinsics.m87502r("_odiamond_buy_btn");
        return null;
    }
    ...
    public final VText get_svip_renew_btn() {
        ...
        Intrinsics.m87502r("_svip_renew_btn");
        return null;
    }
    ...
    public final VLinear get_weekly_content_container() {
        ...
        Intrinsics.m87502r("_weekly_content_container");
        return null;
    }
    ...
    public final VLinear get_weekly_content_root() {
        ...
        Intrinsics.m87502r("_weekly_content_root");
        return null;
    }

    /* JADX INFO: renamed from: h */
    public final void m42961h() {
        String str;
        int i = this.curArrowState;
        ...
        zvf0.m220399u("e_svip_weekly_report", "p_meet", vwb.m200311Y("action", str));
    }

    /* JADX INFO: renamed from: i */
    public final void m42962i(@NotNull MeetFeedSvipWeeklyItemData weeklyItemData, @NotNull NewMeetFragPresenter presenter) {
        weeklyItemData.getClass();
        presenter.getClass();
        if (this.weeklyItemData != null && !Intrinsics.m87488d(getWeeklyItemData(), weeklyItemData)) {
            this.hasInitedWeeklyItem = false;
        }
        setWeeklyItemData(weeklyItemData);
        setPresenter(presenter);
        if (!this.hasInitedWeeklyItem) {
            m42960g(getPresenter().act());
        }
        if (this.curArrowState == this.ARROW_STATE_TYPE_UN_INITIALIZED) {
            if (Intrinsics.m87488d("svip_weekly_report", presenter.getFrom())) {
                m42959f();
            } else {
                m42958e();
            }
        ...
        xdl0.m208329E0(get_header_arrow_ic(), new View.OnClickListener() { // from class: l.m1y
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetFeedSvipWeeklyItemView.m42954a(this.f130862a, view);
            }
        });
        xdl0.m208329E0(get_svip_renew_btn(), new View.OnClickListener() { // from class: l.n1y
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetFeedSvipWeeklyItemView.m42955b(this.f136735a, view);
            }
        });
        xdl0.m208329E0(get_odiamond_buy_btn(), new View.OnClickListener() { // from class: l.o1y
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetFeedSvipWeeklyItemView.m42956c(this.f141488a, view);
            }
        });
    }

    /* JADX INFO: renamed from: j */
    public final void m42963j() {
        ...
        zvf0.m220403y("e_svip_report_module", "p_meet", map);
    }

    /* JADX INFO: renamed from: k */
    public final void m42964k() {
        String str;
        ...
        zvf0.m220368A("e_svip_weekly_report", "p_meet", vwb.m200311Y("action", str));
