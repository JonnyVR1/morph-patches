...
public final class SmartScrollBar extends View {
    ...
    public InterfaceC8190a orientationHandler;
    ...
    @Metadata(m87231d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001f\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, m87232d2 = {"com/p1/mobile/putong/core/newui/myinterestpeople/SmartScrollBar$b", "Landroid/view/ViewOutlineProvider;", "Landroid/view/View;", OMSTemplateModeType.view, "Landroid/graphics/Outline;", "outline", "", "getOutline", "(Landroid/view/View;Landroid/graphics/Outline;)V", "b_core_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C8189b extends ViewOutlineProvider {
        public C8189b() {
        }
    ...
    public SmartScrollBar(@Nullable Context context, @Nullable AttributeSet attributeSet) {
        ...
        m42650b(attributeSet);
    }

    /* JADX INFO: renamed from: b */
    public final void m42650b(AttributeSet attrs) {
        float dimension;
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, e9c0.f90017b0);
        typedArrayObtainStyledAttributes.getClass();
        this.backgroundCorner = (int) typedArrayObtainStyledAttributes.getDimension(e9c0.f90020c0, 0.0f);
        this.sliderCorner = (int) typedArrayObtainStyledAttributes.getDimension(e9c0.f90041j0, 0.0f);
        this.sliderColor = typedArrayObtainStyledAttributes.getColor(e9c0.f90038i0, -1);
        this.cantScrollState = typedArrayObtainStyledAttributes.getInt(e9c0.f90026e0, 0);
        this.canScrollState = typedArrayObtainStyledAttributes.getInt(e9c0.f90023d0, 0);
        this.dismissTime = typedArrayObtainStyledAttributes.getInt(e9c0.f90029f0, 1000);
        int i = typedArrayObtainStyledAttributes.getInt(e9c0.f90035h0, 1);
        this.orientation = i;
        this.orientationHandler = InterfaceC8190a.INSTANCE.m42653a(i);
        this.sliderStyle = typedArrayObtainStyledAttributes.getInt(e9c0.f90047l0, 0);
        try {
            dimension = typedArrayObtainStyledAttributes.getFraction(e9c0.f90044k0, 1, 1, 0.0f);
        } catch (Exception unused) {
            dimension = typedArrayObtainStyledAttributes.getDimension(e9c0.f90044k0, 0.0f);
        }
        this.sliderLength = dimension;
        this.enableDrag = typedArrayObtainStyledAttributes.getBoolean(e9c0.f90032g0, false);
        this.paint.setColor(this.sliderColor);
        typedArrayObtainStyledAttributes.recycle();
    }

    /* JADX INFO: renamed from: c */
    public final void m42651c() {
        setAlpha(1.0f);
    ...
    public void onDraw(@NotNull Canvas canvas) {
        InterfaceC8190a interfaceC8190a;
        RectF rectFMo42652a;
        InterfaceC8190a interfaceC8190a2;
        canvas.getClass();
        super.onDraw(canvas);
        if (this.sliderStyle != 1 || this.sliderLength == 0.0f) {
            InterfaceC8190a interfaceC8190a3 = this.orientationHandler;
            if (interfaceC8190a3 == null) {
                Intrinsics.m87502r("orientationHandler");
                interfaceC8190a = null;
            } else {
                interfaceC8190a = interfaceC8190a3;
            }
            rectFMo42652a = interfaceC8190a.mo42652a(this.maxLength, this.currentLength, getWidth(), getHeight(), this.bindView);
        } else {
            InterfaceC8190a interfaceC8190a4 = this.orientationHandler;
            if (interfaceC8190a4 == null) {
                Intrinsics.m87502r("orientationHandler");
                interfaceC8190a2 = null;
            } else {
                interfaceC8190a2 = interfaceC8190a4;
            }
            rectFMo42652a = interfaceC8190a2.mo42652a(this.maxLength, this.currentLength, getWidth(), getHeight(), this.bindView);
        }
        int i = this.sliderCorner;
        canvas.drawRoundRect(rectFMo42652a, i, i, this.paint);
        Region region = this.sliderRegion;
        Rect rect = new Rect();
        rectFMo42652a.roundOut(rect);
        region.set(rect);
        m42651c();
    }
