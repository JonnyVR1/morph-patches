...
public class GroupSuggestLayout extends ViewGroup {
    ...
    public List<List<View>> f21575a;

    /* JADX INFO: renamed from: b */
    public List<Integer> f21576b;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (measuredWidth + i5 + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin > width) {
                this.f21576b.add(Integer.valueOf(iMax));
                this.f21575a.add(arrayList);
        ...
        for (int i8 = 0; i8 < size; i8++) {
            List<View> list = this.f21575a.get(i8);
            int iIntValue = this.f21576b.get(i8).intValue();
