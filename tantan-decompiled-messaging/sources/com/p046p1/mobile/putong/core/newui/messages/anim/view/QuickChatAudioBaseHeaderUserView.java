...
public class QuickChatAudioBaseHeaderUserView extends ConstraintLayout {
    ...
    public void mo41998j0(@Nullable Act act, @Nullable OnlineMatchPushUser onlineMatchPushUser, boolean isMatch, @Nullable OnlineMatchMatchUser matchUser, @NotNull f30<Boolean, String> click, @NotNull e30<Boolean> close) {
        click.getClass();
        close.getClass();
    }
