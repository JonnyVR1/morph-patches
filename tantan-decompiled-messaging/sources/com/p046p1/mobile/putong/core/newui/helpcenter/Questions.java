...
public class Questions {
    ...
    public static List<Question> f21589a;

    public static class ImageContent extends AbstractC7854b implements Serializable {
        ...
        @Override // com.p046p1.mobile.putong.core.newui.helpcenter.Questions.AbstractC7854b
    ...
    public static class Question implements Serializable {
        private final List<AbstractC7854b> contents;

        /* JADX INFO: renamed from: id */
        private final String f21590id;
        private final int titleResId;

        public Question(String str, int i, List<AbstractC7854b> list) {
            this.f21590id = str;
            this.titleResId = i;
            this.contents = list;
        }

        public List<AbstractC7854b> getContents() {
        ...
        public CharSequence getTitle() {
            return CoreModule.f17544b.getText(this.titleResId);
        }
    }

    public static class TextContent extends AbstractC7854b implements Serializable {
        final int textResId;
        ...
        @Override // com.p046p1.mobile.putong.core.newui.helpcenter.Questions.AbstractC7854b
        public CharSequence getContent() {
            return CoreModule.f17544b.getText(this.textResId);
        }
    }

    /* JADX INFO: renamed from: com.p1.mobile.putong.core.newui.helpcenter.Questions$a */
    public static /* synthetic */ class C7853a {
        ...
        static {
            ...
            try {
                f21591a[IntlCountryCodeController.ModelRegion.EA.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f21591a[IntlCountryCodeController.ModelRegion.SEA.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f21591a[IntlCountryCodeController.ModelRegion.SA.ordinal()] = 4;
    ...
    public static abstract class AbstractC7854b {
        public static final int TYPE_IMAGE = 1;
        public static final int TYPE_TEXT = 0;
        public static final int TYPE_TITLE = 2;
        final int type;

        public AbstractC7854b(int i) {
            this.type = i;
        }

        public static AbstractC7854b image(String str) {
            return new ImageContent(str);
        }

        public static AbstractC7854b text(int i) {
            return new TextContent(0, i);
        }

        public static AbstractC7854b title(int i) {
    ...
    static {
        int i = R$string.f18816p7;
        Question question = new Question("how_to_use_tantan", i, vwb.m200324f0(AbstractC7854b.title(i), AbstractC7854b.text(R$string.f18846q7), AbstractC7854b.image("https://auto.tancdn.com/v1/images/eyJpZCI6IlFJQ0NKUVpXNEdRRFk2RFEzWlhSM0haU0MzN0NBTTA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjo2NTY1NTE3Mzc4NTg2NDg2OTk3LCJhYiI6MH0.png?format=max_720xX"), AbstractC7854b.text(R$string.f18876r7), AbstractC7854b.image("https://auto.tancdn.com/v1/images/eyJpZCI6IkdEV0JNVDdZN0dRTFMyRzIySTdKQTNTTTVYMzQ0WTA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjoyOTc0Mzc2MTY2NjEyOTk2OTUzLCJhYiI6MH0.png?format=max_720xX"), AbstractC7854b.text(R$string.f18906s7), AbstractC7854b.image("https://auto.tancdn.com/v1/images/eyJpZCI6IlYyVEE2N0tZVUlNM0ZaVFROMkNQWllGQTRNQVg3SDA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjo4NzI1NDg4Mzc5NTMzNjc3NDA1LCJhYiI6MH0.png?format=max_720xX"), AbstractC7854b.text(R$string.f18936t7)));
        int i2 = R$string.f18508f7;
        Question question2 = new Question("edit_profile", i2, vwb.m200324f0(AbstractC7854b.title(i2), AbstractC7854b.text(R$string.f18539g7)));
        int i3 = R$string.f19026w7;
        Question question3 = new Question("not_enough_swipe", i3, vwb.m200324f0(AbstractC7854b.title(i3), AbstractC7854b.image("https://auto.tancdn.com/v1/images/eyJpZCI6IjRWRkVQUlZWTDJPSjJOREpJS00yMjdSRkVXNUhRVzA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjozOTE0MjEwOTEyNjI3Mjc4NjgzLCJhYiI6MH0.png?format=max_720xX"), AbstractC7854b.text(R$string.f19056x7), AbstractC7854b.text(R$string.f19086y7)));
        int i4 = R$string.f18570h7;
        Question question4 = new Question("get_more_likes", i4, vwb.m200324f0(AbstractC7854b.title(i4), AbstractC7854b.text(R$string.f18601i7), AbstractC7854b.text(R$string.f18630j7)));
        int i5 = R$string.f18661k7;
        Question question5 = new Question("get_more_matches", i5, vwb.m200324f0(AbstractC7854b.title(i5), AbstractC7854b.text(R$string.f18692l7), AbstractC7854b.image("https://auto.tancdn.com/v1/images/eyJpZCI6IjdISUxLWjNCVjVZT0VSQllTNlJOUDdBSzVGT1ZVSTA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjo5MDQ3ODIyMjI5MzMyMzQzNTQsImFiIjowfQ.png?format=max_720xX"), AbstractC7854b.text(R$string.f18723m7), AbstractC7854b.text(R$string.f18754n7), AbstractC7854b.text(R$string.f18785o7)));
        int i6 = R$string.f18416c7;
        Question question6 = new Question("break_the_ice", i6, vwb.m200324f0(AbstractC7854b.title(i6), AbstractC7854b.text(R$string.f18447d7), AbstractC7854b.text(R$string.f18477e7)));
        int i7 = R$string.f18323Z6;
        Question question7 = new Question("harassment", i7, vwb.m200324f0(AbstractC7854b.title(i7), AbstractC7854b.image("https://auto.tancdn.com/v1/images/eyJpZCI6IkZOSjZaUU80NDNHVFNaWTY2TkdJR0lYWUFXRFlLWjA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjozNDg1MDM4NTk1NTgyNDIxMDI4LCJhYiI6MH0.png?format=max_720xX"), AbstractC7854b.text(R$string.f18354a7), AbstractC7854b.text(R$string.f18385b7)));
        int i8 = R$string.f18966u7;
        f21589a = vwb.m200324f0(question, question2, question3, question4, question5, question6, question7, new Question("missing_new_messages", i8, vwb.m200324f0(AbstractC7854b.title(i8), AbstractC7854b.text(R$string.f18996v7))));
    }

    /* JADX INFO: renamed from: a */
    public static List<Question> m36631a() {
        return f21589a;
    }
    ...
    public static String m36632b(String str, Gender gender) {
        if (str == null) {
            return null;
        }
        ...
        int i = C7853a.f21591a[IntlCountryCodeController.m28107c().ordinal()];
        if (i == 1) {
            switch (str) {
                case "https://auto.tancdn.com/v1/images/eyJpZCI6IlYyVEE2N0tZVUlNM0ZaVFROMkNQWllGQTRNQVg3SDA0IiwidyI6ODcyLCJoIjo2NzIsImQiOjAsIm10IjoiaW1hZ2UvanBlZyIsImRoIjo4NzI1NDg4Mzc5NTMzNjc3NDA1LCJhYiI6MH0.png?format=max_720xX":
            ...
            switch (str) {
                ...
                default:
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.p046p1.mobile.putong.core.newui.helpcenter.Questions.m36632b(java.lang.String, com.p1.mobile.putong.data.Gender):java.lang.String");
                }
            }
