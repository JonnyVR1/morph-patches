...
@Metadata(m87231d1 = {"\u0000n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\f\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\u000b\u001a\u00020\nH\u0014¢\u0006\u0004\b\u000b\u0010\fJ\u001f\u0010\u000f\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\u00062\u0006\u0010\u000e\u001a\u00020\u0006H\u0014¢\u0006\u0004\b\u000f\u0010\u0010J\r\u0010\u0012\u001a\u00020\u0011¢\u0006\u0004\b\u0012\u0010\u0013J/\u0010\u001c\u001a\u00020\n2\u0006\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0017\u001a\u00020\u00162\u0006\u0010\u0019\u001a\u00020\u00182\u0006\u0010\u001b\u001a\u00020\u001aH\u0007¢\u0006\u0004\b\u001c\u0010\u001dJ\u0017\u0010 \u001a\u00020\n2\u0006\u0010\u001f\u001a\u00020\u001eH\u0002¢\u0006\u0004\b \u0010!R\"\u0010)\u001a\u00020\"8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b#\u0010$\u001a\u0004\b%\u0010&\"\u0004\b'\u0010(R\"\u00101\u001a\u00020*8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b+\u0010,\u001a\u0004\b-\u0010.\"\u0004\b/\u00100R\"\u00108\u001a\u0002028\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b \u00103\u001a\u0004\b4\u00105\"\u0004\b6\u00107R\"\u0010;\u001a\u00020*8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0012\u0010,\u001a\u0004\b9\u0010.\"\u0004\b:\u00100R\"\u0010>\u001a\u00020*8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u001c\u0010,\u001a\u0004\b<\u0010.\"\u0004\b=\u00100R\"\u0010F\u001a\u00020?8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b@\u0010A\u001a\u0004\bB\u0010C\"\u0004\bD\u0010E¨\u0006G"}, m87232d2 = {"Lcom/p1/mobile/putong/core/newui/customized/result/PrivateCustomResultListItemView;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", "onFinishInflate", "()V", "widthMeasureSpec", "heightMeasureSpec", "onMeasure", "(II)V", "Lcom/p1/mobile/android/app/Act;", Constants.INAPP_DATA_TAG, "()Lcom/p1/mobile/android/app/Act;", "Ll/mma$a;", "data", "", "hasPrivateCustomPrivilege", "", "pageId", "Ll/xr80;", "presenter", "e", "(Ll/mma$a;ZLjava/lang/String;Ll/xr80;)V", "Landroid/view/View;", OMSTemplateModeType.view, "c", "(Landroid/view/View;)V", "Lv/VDraweeView;", "a", "Lv/VDraweeView;", "get_image", "()Lv/VDraweeView;", "set_image", "(Lv/VDraweeView;)V", "_image", "Landroid/widget/TextView;", "b", "Landroid/widget/TextView;", "get_tag", "()Landroid/widget/TextView;", "set_tag", "(Landroid/widget/TextView;)V", "_tag", "Lv/VLinear_FillerMeasure;", "Lv/VLinear_FillerMeasure;", "get_user_info", "()Lv/VLinear_FillerMeasure;", "set_user_info", "(Lv/VLinear_FillerMeasure;)V", "_user_info", "get_user_name", "set_user_name", "_user_name", "get_user_age", "set_user_age", "_user_age", "Lv/VImage;", "f", "Lv/VImage;", "get_like_image", "()Lv/VImage;", "set_like_image", "(Lv/VImage;)V", "_like_image", "member_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
public final class PrivateCustomResultListItemView extends FrameLayout {
    ...
    public static void m36214b(boolean z, String str, mma.C18499a c18499a, final PrivateCustomResultListItemView privateCustomResultListItemView, xr80 xr80Var, View view) {
        if (!z) {
            xr80.m210646D0(xr80Var, null, 1, null);
        } else {
            zvf0.m220399u("e_odiamond_sayhi", str, vwb.m200311Y("other_user_id", c18499a.f134594a.f56011id));
            CoreModule.m29935P().m94651a().mo33305Dl(privateCustomResultListItemView.m36217d(), c18499a.f134594a, "p_personalized,odiamond_sayhi", new d30() { // from class: l.fr80
                @Override // p149l.d30
                public final void call() {
                    PrivateCustomResultListItemView.m36215f(this.f98898a);
                }
            });
        }
    }
    ...
    public static final void m36215f(PrivateCustomResultListItemView privateCustomResultListItemView) {
        xdl0.m208344M(privateCustomResultListItemView.get_like_image(), false);
    }

    /* JADX INFO: renamed from: c */
    public final void m36216c(View view) {
        gr80.m127677a(this, view);
    }

    @NotNull
    /* JADX INFO: renamed from: d */
    public final Act m36217d() {
    ...
    public final void m36218e(@NotNull final mma.C18499a data, final boolean hasPrivateCustomPrivilege, @NotNull final String pageId, @NotNull final xr80 presenter) {
        data.getClass();
        pageId.getClass();
        presenter.getClass();
        if (hasPrivateCustomPrivilege) {
            qib0.f154691G.m102335N0(get_image(), data.f134594a.m60124fp().profile480().formatted(), false);
        } else {
            qib0.f154691G.m102336O(get_image(), data.f134594a.m60124fp().profileBig().formatted(), 4, 30);
        }
        if (CoreModule.m29932K().mo30819sg(data.f134594a.f56011id) || User.isMatched(data.f134594a)) {
            xdl0.m208344M(get_like_image(), false);
        } else {
            xdl0.m208344M(get_like_image(), true);
        }
        xdl0.m208329E0(get_like_image(), new View.OnClickListener() { // from class: l.er80
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PrivateCustomResultListItemView.m36214b(hasPrivateCustomPrivilege, pageId, data, this, presenter, view);
            }
        });
        if (vwb.m200296J(data.f134595b)) {
            get_tag().setVisibility(8);
        } else {
            get_tag().setVisibility(0);
            if (data.f134595b.size() == 1) {
                get_tag().setText(data.f134595b.get(0));
            } else {
                get_tag().setText("满足" + data.f134595b.size() + "个定制");
            }
        }
        get_user_name().setText(data.f134594a.name);
        Integer num = data.f134594a.age;
        num.getClass();
    ...
    public final VImage get_like_image() {
        ...
        Intrinsics.m87502r("_like_image");
        return null;
    }
