...
public final class PrivateCustomResultUserHeaderView extends LinearLayout {
    ...
    public static void m36252a(xr80 xr80Var, View view) {
        if (xma.m210046I3()) {
            return;
        }
    ...
    public final void m36253b(View view) {
        hs80.m132779a(this, view);
    }

    /* JADX INFO: renamed from: c */
    public final void m36254c(@NotNull final xr80 presenter, boolean isEmpty, boolean hasIdealTypesSelected) {
        presenter.getClass();
        xdl0.m208329E0(get_custom_layout(), new View.OnClickListener() { // from class: l.gs80
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PrivateCustomResultUserHeaderView.m36252a(presenter, view);
            }
        });
        if (!isEmpty) {
    ...
    public final void m36255d(TextView textView, int[] colors) {
    ...
    public void onFinishInflate() {
        ...
        m36253b(this);
        m36255d(get_custom_layout_rl_content_title(), new int[]{Color.parseColor("#D1AE68"), Color.parseColor("#FFF7E2"), Color.parseColor("#E2B761")});
        m36255d(get_custom_layout_rl_content_subtitle(), new int[]{Color.parseColor("#B3C5AD7D"), Color.parseColor("#B3F9ECCA"), Color.parseColor("#B3C5AD7D")});
    }
