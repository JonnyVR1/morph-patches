...
public class CoreBuzzHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) ksm.m147096d().m147098a("/buzz_module/module").navigation();
        ((CoreBuzzHolder) obj).buzzModule = module;
        if (module != null) {
            return;
        }
        tqq0.m190155a("The field 'buzzModule' is null, in class '", CoreBuzzHolder.class.getName(), "!");
    }
}
