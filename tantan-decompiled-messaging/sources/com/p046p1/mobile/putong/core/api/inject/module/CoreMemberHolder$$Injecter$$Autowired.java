...
public class CoreMemberHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) ksm.m147096d().m147098a("/member_module/module").navigation();
        ((CoreMemberHolder) obj).memberModule = module;
        if (module != null) {
            return;
        }
        tqq0.m190155a("The field 'memberModule' is null, in class '", CoreMemberHolder.class.getName(), "!");
    }
}
