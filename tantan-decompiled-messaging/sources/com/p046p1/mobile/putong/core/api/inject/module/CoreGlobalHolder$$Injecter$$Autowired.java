...
public class CoreGlobalHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) ksm.m147096d().m147098a("/core_module/module").navigation();
        ((CoreGlobalHolder) obj).globalModule = module;
        if (module != null) {
            return;
        }
        tqq0.m190155a("The field 'globalModule' is null, in class '", CoreGlobalHolder.class.getName(), "!");
    }
}
