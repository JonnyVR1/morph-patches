...
public class AccountTestFactor extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AccountTestFactor> PROTOBUF_ADAPTER = new MessageNanoAdapter<AccountTestFactor>() { // from class: com.p1.mobile.putong.account.data.AccountTestFactor.1
        ...
        public int computeAndCacheSize(AccountTestFactor accountTestFactor) {
            ...
            if (gender != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(2, gender.ordinal());
            }
            ...
            if (gender2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(11, gender2, Gender.PROTOBUF_ADAPTER);
            }
            accountTestFactor.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AccountTestFactor parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        accountTestFactor.name = nb5Var.m158750s();
                        continue;
                    case 16:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 26:
                        accountTestFactor.birthdate = nb5Var.m158750s();
                        continue;
                    case 34:
                        accountTestFactor.password = nb5Var.m158750s();
                        continue;
                    case 42:
                        accountTestFactor.countryCode = nb5Var.m158750s();
                        continue;
                    case 50:
                        accountTestFactor.mobileNumber = nb5Var.m158750s();
                        continue;
                    case 58:
                        accountTestFactor.thirdpartyId = nb5Var.m158750s();
                        continue;
                    case 66:
                        accountTestFactor.thirdpartyType = nb5Var.m158750s();
                        continue;
                    case 74:
                        accountTestFactor.step = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        accountTestFactor.channel = nb5Var.m158750s();
                        continue;
                    case 90:
                        accountTestFactor.gender = (Gender) nb5Var.m158743l(Gender.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (accountTestFactor.gender == null && numValueOf != null) {
                            accountTestFactor.gender = (Gender) Gender.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(AccountTestFactor accountTestFactor, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Gender gender = accountTestFactor.gender;
            if (gender != null) {
                codedOutputByteBufferNano.m17250G(2, gender.ordinal());
            }
            String str2 = accountTestFactor.birthdate;
            if (str2 != null) {
            ...
            Gender gender2 = accountTestFactor.gender;
            if (gender2 != null) {
                codedOutputByteBufferNano.m17254K(11, gender2, Gender.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public AccountTestFactor mo223809clone() {
        AccountTestFactor accountTestFactor = new AccountTestFactor();
