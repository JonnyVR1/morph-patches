...
public class CameraCategory extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CameraCategory> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraCategory>() { // from class: com.p1.mobile.putong.account.data.CameraCategory.1
        ...
        public CameraCategory parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 0) {
                    if (cameraCategory.f16342id == null) {
                        cameraCategory.f16342id = "";
                    }
                ...
                if (iM158752u == 10) {
                    cameraCategory.f16342id = nb5Var.m158750s();
        ...
        public boolean parseField(CameraCategory cameraCategory, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    cameraCategory.f16342id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public CameraCategory mo223809clone() {
        CameraCategory cameraCategory = new CameraCategory();
        cameraCategory.f16342id = this.f16342id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f16342id, cameraCategory.f16342id) && ValueObject.util_equals(this.name, cameraCategory.name) && ValueObject.util_equals(this.category, cameraCategory.category) && ValueObject.util_equals(this.type, cameraCategory.type) && this.cameraUpdateTime == cameraCategory.cameraUpdateTime && ValueObject.util_equals(this.status, cameraCategory.status);
    }
