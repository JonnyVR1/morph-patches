...
public class CaptchaChars extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CaptchaChars> PROTOBUF_ADAPTER = new MessageNanoAdapter<CaptchaChars>() { // from class: com.p1.mobile.putong.account.data.CaptchaChars.1
        ...
        public int computeAndCacheSize(CaptchaChars captchaChars) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, captchaChars.height) + CodedOutputByteBufferNano.m17226h(2, captchaChars.width);
            ...
            captchaChars.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CaptchaChars parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    captchaChars.height = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    captchaChars.width = nb5Var.m158741j();
                } else if (iM158752u == 26) {
                    captchaChars.type = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (captchaChars.type == null) {
                            captchaChars.type = "";
                    ...
                    captchaChars.content = nb5Var.m158750s();
                }
            }
            return captchaChars;
        }
        ...
        public void serialize(CaptchaChars captchaChars, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, captchaChars.height);
            codedOutputByteBufferNano.m17250G(2, captchaChars.width);
            String str = captchaChars.type;
            if (str != null) {
    ...
    public CaptchaChars mo223809clone() {
        CaptchaChars captchaChars = new CaptchaChars();
