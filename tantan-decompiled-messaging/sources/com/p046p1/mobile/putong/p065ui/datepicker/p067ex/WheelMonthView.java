...
public final class WheelMonthView extends WheelView {
    ...
    public WheelMonthView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, d9c0.f84984B0);
            typedArrayObtainStyledAttributes.getClass();
            int i2 = typedArrayObtainStyledAttributes.getInt(d9c0.f84989D0, 1);
            int i3 = typedArrayObtainStyledAttributes.getInt(d9c0.f85111z1, -1);
            int i4 = typedArrayObtainStyledAttributes.getInt(d9c0.f84987C0, -1);
    ...
    public static /* synthetic */ void m79553U0(WheelMonthView wheelMonthView, int i, boolean z, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            z = false;
        }
        if ((i3 & 4) != 0) {
        ...
        wheelMonthView.m79555T0(i, z, i2);
    }

    /* JADX INFO: renamed from: X0 */
    public static /* synthetic */ void m79554X0(WheelMonthView wheelMonthView, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 1;
        }
        wheelMonthView.m79556V0(i, i2);
    }
    ...
    public final void m79555T0(int month, boolean isSmoothScroll, int smoothDuration) {
        m79458K0(WheelView.m79434e0(this, Integer.valueOf(month), false, 2, null), isSmoothScroll, smoothDuration);
    }

    @JvmOverloads
    /* JADX INFO: renamed from: V0 */
    public final void m79556V0(int minMonth, int maxMonth) {
        m79453H0(WheelView.m79434e0(this, Integer.valueOf(minMonth), false, 2, null), WheelView.m79434e0(this, Integer.valueOf(maxMonth), false, 2, null));
    }

    @JvmOverloads
    /* JADX INFO: renamed from: W0 */
    public final void m79557W0(int minMonth, int maxMonth, @NotNull WheelView.OverRangeMode overRangeMode) {
        overRangeMode.getClass();
        m79455I0(WheelView.m79434e0(this, Integer.valueOf(minMonth), false, 2, null), WheelView.m79434e0(this, Integer.valueOf(maxMonth), false, 2, null), overRangeMode);
    }

    /* JADX INFO: renamed from: Y0 */
    public final void m79558Y0() {
    ...
    public final void setSelectedMonth(int i) {
        m79553U0(this, i, false, 0, 6, null);
    }

    @JvmOverloads
    public final void setSelectedMonthRange(int i) {
        m79554X0(this, 0, i, 1, null);
    }
