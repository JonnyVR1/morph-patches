package com.p046p1.mobile.putong.p065ui.sign;
...
public final class TencentSignActivity extends PutongAct {
    ...
    @Nullable
    public C13137b webChromeClient;
    ...
    @Metadata(m87231d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\t\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J%\u0010\n\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006¢\u0006\u0004\b\n\u0010\u000bR\u0014\u0010\r\u001a\u00020\f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u0014\u0010\u000f\u001a\u00020\f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u000f\u0010\u000eR\u0014\u0010\u0010\u001a\u00020\f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0010\u0010\u000eR\u0014\u0010\u0011\u001a\u00020\f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0011\u0010\u000eR\u0014\u0010\u0012\u001a\u00020\f8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0012\u0010\u000eR\u0014\u0010\u0013\u001a\u00020\u00068\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0013\u0010\u0014¨\u0006\u0015"}, m87232d2 = {"Lcom/p1/mobile/putong/ui/sign/TencentSignActivity$a;", "", "<init>", "()V", "Landroid/content/Context;", "context", "", "url", "title", "Landroid/content/Intent;", "a", "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;", "", "PERMISSION_QUEST_TRTC_CAMERA_VERIFY", "I", "PERMISSION_QUEST_OLD_CAMERA_VERIFY", "REQUEST_PERMISSION_STORAGE", "FILE_CHOOSER_RESULT_CODE", "RECORD_VIDEO_REQUEST_CODE", "EXTRA_TITLE", "Ljava/lang/String;", "putong-common_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class Companion {
        ...
        public final Intent m80039a(@NotNull Context context, @NotNull String url, @NotNull String title) {
            context.getClass();
            url.getClass();
            title.getClass();
    ...
    public final class C13137b extends WebChromeClient {
        ...
        public C13137b(TencentSignActivity tencentSignActivity) {
            this.activity = tencentSignActivity;
        }

        private final void openFileInput(Context context) {
            TencentSignActivity tencentSignActivity;
            if (e16.m114373a(context, "android.permission.READ_EXTERNAL_STORAGE") != 0) {
                TencentSignActivity tencentSignActivity2 = this.activity;
                if (tencentSignActivity2 != null) {
                    b50.m100287u(tencentSignActivity2, new String[]{"android.permission.READ_EXTERNAL_STORAGE"}, 0);
                    return;
                }
                return;
            }
        ...
        public final boolean enterOldModeFaceVerify() {
            return yep0.m214375a().m214379e(this.webView, TencentSignActivity.this.m80031d2(), this.activity, this.fileChooserParams);
        }
        ...
        public void onPermissionRequest(@NotNull PermissionRequest request) {
            ...
            if (tencentSignActivity != null) {
                tencentSignActivity.m80036l2(true);
            }
        }
        ...
        public boolean onShowFileChooser(@NotNull WebView webView, @NotNull ValueCallback<Uri[]> filePathCallback, @NotNull WebChromeClient.FileChooserParams fileChooserParams) {
            ...
            TencentSignActivity.this.m80037m2(filePathCallback);
            ...
            for (String str : acceptTypes) {
                str.getClass();
                if (StringsKt.m93412P(str, "video", false, 2, null)) {
                    z = true;
                }
            }
            if (z) {
                TencentSignActivity.this.m80036l2(false);
                return true;
            }
    ...
    public static final class C13138c extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            Uri url;
            return TencentSignActivity.this.m80035k2(view, (request == null || (url = request.getUrl()) == null) ? null : url.toString());
        }
    }

    /* JADX INFO: renamed from: V1 */
    public static void m80023V1(TencentSignActivity tencentSignActivity, C4319c c4319c) {
        ...
        if (Intrinsics.m87488d(c4319c, C4319c.f15549j)) {
        ...
        if (Intrinsics.m87488d(c4319c, C4319c.f15552m)) {
            try {
    ...
    public static void m80024X1(TencentSignActivity tencentSignActivity, DialogInterface dialogInterface, int i) {
        AlertDialog alertDialog;
        AlertDialog alertDialog2 = tencentSignActivity.dialog;
        if (alertDialog2 != null && alertDialog2.isShowing() && (alertDialog = tencentSignActivity.dialog) != null) {
            alertDialog.dismiss();
    ...
    public static void m80025Y1(TencentSignActivity tencentSignActivity, int i, DialogInterface dialogInterface, int i2) {
        AlertDialog alertDialog;
        AlertDialog alertDialog2 = tencentSignActivity.dialog;
        if (alertDialog2 != null && alertDialog2.isShowing() && (alertDialog = tencentSignActivity.dialog) != null) {
            alertDialog.dismiss();
        ...
        tencentSignActivity.dialog = null;
        tencentSignActivity.m80030c2(i);
    }

    @SuppressLint({"SetJavaScriptEnabled"})
    /* JADX INFO: renamed from: e2 */
    private final void m80028e2() {
        yep0.m214375a().m214380f(this.mWebView, this);
        WebView webView = this.mWebView;
        if (webView != null) {
            webView.setWebViewClient(new C13138c());
        }
        C13137b c13137b = new C13137b(this);
        this.webChromeClient = c13137b;
        WebView webView2 = this.mWebView;
        if (webView2 != null) {
            webView2.setWebChromeClient(c13137b);
        }
    }

    /* JADX INFO: renamed from: b2 */
    public final int m80029b2(String permission) {
        return e16.m114373a(this, permission);
    }

    /* JADX INFO: renamed from: c2 */
    public final void m80030c2(int requestCode) {
    ...
    public final ValueCallback<Uri[]> m80031d2() {
        return this.uploadMessageAboveL;
    }

    @TargetApi(21)
    /* JADX INFO: renamed from: g2 */
    public final void m80032g2(int requestCode, int resultCode, Intent intent) {
        Uri[] uriArr;
    ...
    public void initSubscription() {
        ...
        lifecycle().subscribe(mkd0.m154955G(new e30() { // from class: l.ghi0
            @Override // p149l.e30
            public final void call(Object obj) {
                TencentSignActivity.m80023V1(this.f102661a, (C4319c) obj);
            }
        }));
    }

    /* JADX INFO: renamed from: k2 */
    public final boolean m80035k2(WebView view, String url) {
        if (url == null) {
            return false;
        }
        ...
        uri.getClass();
        uri.getScheme();
        if (StringsKt.m93412P(url, "m.tantanapp.com", false, 2, null) || StringsKt.m93412P(url, "m.staging2.p1staff.com", false, 2, null)) {
            Intent intentM80164Z1 = WebViewAct.m80164Z1(this, getTitle().toString(), url);
            d2i0.m109768R(intentM80164Z1, url);
            startActivity(intentM80164Z1);
            m66873d2();
            return true;
        }
        if (!Intrinsics.m87488d(uri.getScheme(), "http") && !Intrinsics.m87488d(uri.getScheme(), "https")) {
            return false;
        }
        if (view != null) {
            view.loadUrl(url);
    ...
    public final void m80036l2(boolean trtc) {
        if (m80029b2("android.permission.CAMERA") != 0) {
            if (trtc) {
                b50.m100287u(this, new String[]{"android.permission.CAMERA"}, 12);
                return;
            } else {
                b50.m100287u(this, new String[]{"android.permission.CAMERA"}, 11);
                return;
            }
        }
        C13137b c13137b = this.webChromeClient;
        if (trtc) {
            if (c13137b != null) {
                c13137b.enterTrtcFaceVerify();
            }
        } else if (c13137b != null) {
            c13137b.enterOldModeFaceVerify();
        }
    }

    /* JADX INFO: renamed from: m2 */
    public final void m80037m2(@Nullable ValueCallback<Uri[]> valueCallback) {
        this.uploadMessageAboveL = valueCallback;
    }

    /* JADX INFO: renamed from: n2 */
    public final void m80038n2(final int requestCode) {
        this.dialog = new AlertDialog.Builder(this).setTitle("权限申请提示").setMessage("请前往设置->应用->权限中打开相关权限，否则功能无法正常运行！").setPositiveButton("确定", new DialogInterface.OnClickListener() { // from class: l.hhi0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                TencentSignActivity.m80025Y1(this.f107722a, requestCode, dialogInterface, i);
            }
        }).setNegativeButton("取消", new DialogInterface.OnClickListener() { // from class: l.ihi0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                TencentSignActivity.m80024X1(this.f113257a, dialogInterface, i);
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 17) {
            yep0.m214375a().m214377c(requestCode, resultCode, data);
            return;
        }
        if (requestCode == 2002) {
        ...
        if (this.uploadMessageAboveL != null) {
            m80032g2(requestCode, resultCode, data);
            return;
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NotNull String[] permissions, @NotNull int[] grantResults) {
        ...
        if (grantResults[0] != 0) {
            ...
            C13137b c13137b2 = this.webChromeClient;
            if (c13137b2 != null) {
                c13137b2.enterTrtcFaceVerify();
            }
        }
    }
    ...
    public void preCreateView(@Nullable Bundle savedInstanceState) {
        ...
        setStatusBarColorResId(v0c0.f179109p);
