...
public class Answer extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Answer> PROTOBUF_ADAPTER = new MessageNanoAdapter<Answer>() { // from class: com.p1.mobile.putong.data.Answer.1
        ...
        public int computeAndCacheSize(Answer answer) {
            ...
            String str3 = answer.f38721id;
            if (str3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(3, str3);
            }
            OfficialAccountAction officialAccountAction = answer.action;
            if (officialAccountAction != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, officialAccountAction, OfficialAccountAction.PROTOBUF_ADAPTER);
            }
            answer.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Answer parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    answer.value = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    answer.question = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    answer.f38721id = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (answer.value == null) {
                            answer.value = "";
                    ...
                    answer.action = (OfficialAccountAction) nb5Var.m158743l(OfficialAccountAction.PROTOBUF_ADAPTER);
                }
            }
            return answer;
        }
        ...
        public boolean parseField(Answer answer, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "question":
                    ...
                    return true;
                case "id":
                    answer.f38721id = jsonParser.getValueAsString();
                    return false;
                case "value":
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.value, answer.value) && ValueObject.util_equals(this.question, answer.question) && ValueObject.util_equals(this.f38721id, answer.f38721id) && ValueObject.util_equals(this.action, answer.action);
    }
