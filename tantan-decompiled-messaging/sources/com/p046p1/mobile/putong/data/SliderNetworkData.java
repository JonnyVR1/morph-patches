...
public class SliderNetworkData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SliderNetworkData> PROTOBUF_ADAPTER = new MessageNanoAdapter<SliderNetworkData>() { // from class: com.p1.mobile.putong.data.SliderNetworkData.1
        ...
        public int computeAndCacheSize(SliderNetworkData sliderNetworkData) {
            ...
            if (sliderData != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, sliderData, SliderData.PROTOBUF_ADAPTER);
            }
            sliderNetworkData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SliderNetworkData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    sliderNetworkData.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (sliderNetworkData.meta == null) {
                            sliderNetworkData.meta = Meta.new_();
                    ...
                    sliderNetworkData.data = (SliderData) nb5Var.m158743l(SliderData.PROTOBUF_ADAPTER);
                }
            }
            return sliderNetworkData;
        }
        ...
        public void serialize(SliderNetworkData sliderNetworkData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            SliderData sliderData = sliderNetworkData.data;
            if (sliderData != null) {
                codedOutputByteBufferNano.m17254K(2, sliderData, SliderData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public SliderNetworkData mo223809clone() {
        SliderNetworkData sliderNetworkData = new SliderNetworkData();
        Meta meta = this.meta;
        if (meta != null) {
            sliderNetworkData.meta = meta.mo223809clone();
        }
        SliderData sliderData = this.data;
        if (sliderData != null) {
            sliderNetworkData.data = sliderData.mo223809clone();
        }
        return sliderNetworkData;
    }
