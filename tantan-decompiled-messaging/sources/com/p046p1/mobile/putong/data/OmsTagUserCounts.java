...
public class OmsTagUserCounts extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OmsTagUserCounts> PROTOBUF_ADAPTER = new MessageNanoAdapter<OmsTagUserCounts>() { // from class: com.p1.mobile.putong.data.OmsTagUserCounts.1
        ...
        public int computeAndCacheSize(OmsTagUserCounts omsTagUserCounts) {
            String str = omsTagUserCounts.f38802id;
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17228j(2, omsTagUserCounts.count);
            omsTagUserCounts.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OmsTagUserCounts parse(nb5 nb5Var) throws IOException {
            OmsTagUserCounts omsTagUserCounts = new OmsTagUserCounts();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (omsTagUserCounts.f38802id != null) {
                        break;
                    }
                    omsTagUserCounts.f38802id = "";
                    break;
                }
                if (iM158752u == 10) {
                    omsTagUserCounts.f38802id = nb5Var.m158750s();
                } else {
                    if (iM158752u != 16) {
                        if (omsTagUserCounts.f38802id != null) {
                            break;
                    ...
                    omsTagUserCounts.count = nb5Var.m158742k();
                }
            }
            return omsTagUserCounts;
        }
        ...
        public void serialize(OmsTagUserCounts omsTagUserCounts, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(2, omsTagUserCounts.count);
        }
    };
    public static JsonAdapter<OmsTagUserCounts> JSON_ADAPTER = new ObjectJsonAdapter<OmsTagUserCounts>() { // from class: com.p1.mobile.putong.data.OmsTagUserCounts.2
        ...
        public boolean parseField(OmsTagUserCounts omsTagUserCounts, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            str.getClass();
            if (str.equals("id")) {
                omsTagUserCounts.f38802id = jsonParser.getValueAsString();
                return false;
            }
            if (!str.equals("count")) {
                return false;
    ...
    public OmsTagUserCounts mo223809clone() {
        OmsTagUserCounts omsTagUserCounts = new OmsTagUserCounts();
        omsTagUserCounts.f38802id = this.f38802id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38802id, omsTagUserCounts.f38802id) && this.count == omsTagUserCounts.count;
    }
