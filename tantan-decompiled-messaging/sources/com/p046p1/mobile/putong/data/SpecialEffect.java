...
public class SpecialEffect extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpecialEffect> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpecialEffect>() { // from class: com.p1.mobile.putong.data.SpecialEffect.1
        ...
        public int computeAndCacheSize(SpecialEffect specialEffect) {
            ...
            int iM17228j = iM17233o + CodedOutputByteBufferNano.m17228j(3, specialEffect.expireTime);
            ...
            specialEffect.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SpecialEffect parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    specialEffect.type = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    specialEffect.content = nb5Var.m158750s();
                } else if (iM158752u == 24) {
                    specialEffect.expireTime = nb5Var.m158742k();
                } else if (iM158752u == 34) {
                    specialEffect.deepLink = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (specialEffect.type == null) {
                            specialEffect.type = "";
                    ...
                    specialEffect.style = nb5Var.m158750s();
                }
            }
            return specialEffect;
        }
        ...
        public void serialize(SpecialEffect specialEffect, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(3, specialEffect.expireTime);
            String str3 = specialEffect.deepLink;
            if (str3 != null) {
    ...
    public SpecialEffect mo223809clone() {
        SpecialEffect specialEffect = new SpecialEffect();
