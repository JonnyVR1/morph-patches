...
public class SlideCardsAndReward extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SlideCardsAndReward> PROTOBUF_ADAPTER = new MessageNanoAdapter<SlideCardsAndReward>() { // from class: com.p1.mobile.putong.data.SlideCardsAndReward.1
        ...
        public int computeAndCacheSize(SlideCardsAndReward slideCardsAndReward) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, slideCardsAndReward.slideTheCard) + CodedOutputByteBufferNano.m17226h(2, slideCardsAndReward.rewards);
            slideCardsAndReward.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SlideCardsAndReward parse(nb5 nb5Var) throws IOException {
            SlideCardsAndReward slideCardsAndReward = new SlideCardsAndReward();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    slideCardsAndReward.slideTheCard = nb5Var.m158741j();
                } else {
                    if (iM158752u != 16) {
                        return slideCardsAndReward;
                    }
                    slideCardsAndReward.rewards = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(SlideCardsAndReward slideCardsAndReward, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, slideCardsAndReward.slideTheCard);
            codedOutputByteBufferNano.m17250G(2, slideCardsAndReward.rewards);
        }
    };
    ...
    public SlideCardsAndReward mo223809clone() {
        SlideCardsAndReward slideCardsAndReward = new SlideCardsAndReward();
