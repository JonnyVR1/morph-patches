...
public class Extensions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Extensions> PROTOBUF_ADAPTER = new MessageNanoAdapter<Extensions>() { // from class: com.p1.mobile.putong.data.Extensions.1
        ...
        public int computeAndCacheSize(Extensions extensions) {
            ...
            int iM17230l = physical != null ? CodedOutputByteBufferNano.m17230l(1, physical, Physical.PROTOBUF_ADAPTER) : 0;
            Business business = extensions.business;
            if (business != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, business, Business.PROTOBUF_ADAPTER);
            }
            Interest interest = extensions.interest;
            if (interest != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, interest, Interest.PROTOBUF_ADAPTER);
            }
            ProfileExtensionBasic profileExtensionBasic = extensions.basic;
            if (profileExtensionBasic != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, profileExtensionBasic, ProfileExtensionBasic.PROTOBUF_ADAPTER);
            }
            Anonymity anonymity = extensions.anonymity;
            if (anonymity != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, anonymity, Anonymity.PROTOBUF_ADAPTER);
            }
            HeadFrame headFrame = extensions.headFrame;
            if (headFrame != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(6, headFrame, HeadFrame.PROTOBUF_ADAPTER);
            }
            FriendStatus friendStatus = extensions.friendStatus;
            if (friendStatus != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(7, friendStatus, FriendStatus.PROTOBUF_ADAPTER);
            }
            MomentSwitch momentSwitch = extensions.momentSwitch;
            if (momentSwitch != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(8, momentSwitch, MomentSwitch.PROTOBUF_ADAPTER);
            }
            UserWealth userWealth = extensions.wealth;
            if (userWealth != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(9, userWealth, UserWealth.PROTOBUF_ADAPTER);
            }
            ProfileCompletion profileCompletion = extensions.profileCompletion;
            if (profileCompletion != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(10, profileCompletion, ProfileCompletion.PROTOBUF_ADAPTER);
            }
            VoiceSignature voiceSignature = extensions.voiceSignature;
            if (voiceSignature != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(11, voiceSignature, VoiceSignature.PROTOBUF_ADAPTER);
            }
            VirtualVoiceLive virtualVoiceLive = extensions.live;
            if (virtualVoiceLive != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(12, virtualVoiceLive, VirtualVoiceLive.PROTOBUF_ADAPTER);
            }
            ProfileMate profileMate = extensions.mate;
            if (profileMate != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(13, profileMate, ProfileMate.PROTOBUF_ADAPTER);
            }
            PetInfo petInfo = extensions.pet;
            if (petInfo != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(14, petInfo, PetInfo.PROTOBUF_ADAPTER);
            }
            TailFrame tailFrame = extensions.tailFrame;
            if (tailFrame != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(15, tailFrame, TailFrame.PROTOBUF_ADAPTER);
            }
            VoiceAvatarFrame voiceAvatarFrame = extensions.voiceAvatarFrame;
            if (voiceAvatarFrame != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(16, voiceAvatarFrame, VoiceAvatarFrame.PROTOBUF_ADAPTER);
            }
            ProfileExtensionMarriage profileExtensionMarriage = extensions.marriage;
            if (profileExtensionMarriage != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(17, profileExtensionMarriage, ProfileExtensionMarriage.PROTOBUF_ADAPTER);
            }
            ExtensionGame extensionGame = extensions.game;
            if (extensionGame != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(18, extensionGame, ExtensionGame.PROTOBUF_ADAPTER);
            }
            extensions.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Extensions parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        extensions.physical = (Physical) nb5Var.m158743l(Physical.PROTOBUF_ADAPTER);
                        continue;
                    case 18:
                        extensions.business = (Business) nb5Var.m158743l(Business.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        extensions.interest = (Interest) nb5Var.m158743l(Interest.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        extensions.basic = (ProfileExtensionBasic) nb5Var.m158743l(ProfileExtensionBasic.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        extensions.anonymity = (Anonymity) nb5Var.m158743l(Anonymity.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        extensions.headFrame = (HeadFrame) nb5Var.m158743l(HeadFrame.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        extensions.friendStatus = (FriendStatus) nb5Var.m158743l(FriendStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        extensions.momentSwitch = (MomentSwitch) nb5Var.m158743l(MomentSwitch.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        extensions.wealth = (UserWealth) nb5Var.m158743l(UserWealth.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        extensions.profileCompletion = (ProfileCompletion) nb5Var.m158743l(ProfileCompletion.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        extensions.voiceSignature = (VoiceSignature) nb5Var.m158743l(VoiceSignature.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        extensions.live = (VirtualVoiceLive) nb5Var.m158743l(VirtualVoiceLive.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        extensions.mate = (ProfileMate) nb5Var.m158743l(ProfileMate.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        extensions.pet = (PetInfo) nb5Var.m158743l(PetInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        extensions.tailFrame = (TailFrame) nb5Var.m158743l(TailFrame.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        extensions.voiceAvatarFrame = (VoiceAvatarFrame) nb5Var.m158743l(VoiceAvatarFrame.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        extensions.marriage = (ProfileExtensionMarriage) nb5Var.m158743l(ProfileExtensionMarriage.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        extensions.game = (ExtensionGame) nb5Var.m158743l(ExtensionGame.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (extensions.physical == null) {
                            extensions.physical = Physical.new_();
        ...
        public void serialize(Extensions extensions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            Physical physical = extensions.physical;
            if (physical != null) {
                codedOutputByteBufferNano.m17254K(1, physical, Physical.PROTOBUF_ADAPTER);
            }
            Business business = extensions.business;
            if (business != null) {
                codedOutputByteBufferNano.m17254K(2, business, Business.PROTOBUF_ADAPTER);
            }
            Interest interest = extensions.interest;
            if (interest != null) {
                codedOutputByteBufferNano.m17254K(3, interest, Interest.PROTOBUF_ADAPTER);
            }
            ProfileExtensionBasic profileExtensionBasic = extensions.basic;
            if (profileExtensionBasic != null) {
                codedOutputByteBufferNano.m17254K(4, profileExtensionBasic, ProfileExtensionBasic.PROTOBUF_ADAPTER);
            }
            Anonymity anonymity = extensions.anonymity;
            if (anonymity != null) {
                codedOutputByteBufferNano.m17254K(5, anonymity, Anonymity.PROTOBUF_ADAPTER);
            }
            HeadFrame headFrame = extensions.headFrame;
            if (headFrame != null) {
                codedOutputByteBufferNano.m17254K(6, headFrame, HeadFrame.PROTOBUF_ADAPTER);
            }
            FriendStatus friendStatus = extensions.friendStatus;
            if (friendStatus != null) {
                codedOutputByteBufferNano.m17254K(7, friendStatus, FriendStatus.PROTOBUF_ADAPTER);
            }
            MomentSwitch momentSwitch = extensions.momentSwitch;
            if (momentSwitch != null) {
                codedOutputByteBufferNano.m17254K(8, momentSwitch, MomentSwitch.PROTOBUF_ADAPTER);
            }
            UserWealth userWealth = extensions.wealth;
            if (userWealth != null) {
                codedOutputByteBufferNano.m17254K(9, userWealth, UserWealth.PROTOBUF_ADAPTER);
            }
            ProfileCompletion profileCompletion = extensions.profileCompletion;
            if (profileCompletion != null) {
                codedOutputByteBufferNano.m17254K(10, profileCompletion, ProfileCompletion.PROTOBUF_ADAPTER);
            }
            VoiceSignature voiceSignature = extensions.voiceSignature;
            if (voiceSignature != null) {
                codedOutputByteBufferNano.m17254K(11, voiceSignature, VoiceSignature.PROTOBUF_ADAPTER);
            }
            VirtualVoiceLive virtualVoiceLive = extensions.live;
            if (virtualVoiceLive != null) {
                codedOutputByteBufferNano.m17254K(12, virtualVoiceLive, VirtualVoiceLive.PROTOBUF_ADAPTER);
            }
            ProfileMate profileMate = extensions.mate;
            if (profileMate != null) {
                codedOutputByteBufferNano.m17254K(13, profileMate, ProfileMate.PROTOBUF_ADAPTER);
            }
            PetInfo petInfo = extensions.pet;
            if (petInfo != null) {
                codedOutputByteBufferNano.m17254K(14, petInfo, PetInfo.PROTOBUF_ADAPTER);
            }
            TailFrame tailFrame = extensions.tailFrame;
            if (tailFrame != null) {
                codedOutputByteBufferNano.m17254K(15, tailFrame, TailFrame.PROTOBUF_ADAPTER);
            }
            VoiceAvatarFrame voiceAvatarFrame = extensions.voiceAvatarFrame;
            if (voiceAvatarFrame != null) {
                codedOutputByteBufferNano.m17254K(16, voiceAvatarFrame, VoiceAvatarFrame.PROTOBUF_ADAPTER);
            }
            ProfileExtensionMarriage profileExtensionMarriage = extensions.marriage;
            if (profileExtensionMarriage != null) {
                codedOutputByteBufferNano.m17254K(17, profileExtensionMarriage, ProfileExtensionMarriage.PROTOBUF_ADAPTER);
            }
            ExtensionGame extensionGame = extensions.game;
            if (extensionGame != null) {
                codedOutputByteBufferNano.m17254K(18, extensionGame, ExtensionGame.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Extensions mo223809clone() {
        Extensions extensions = new Extensions();
        Physical physical = this.physical;
        if (physical != null) {
            extensions.physical = physical.mo223809clone();
        }
        Business business = this.business;
        if (business != null) {
            extensions.business = business.mo223809clone();
        }
        Interest interest = this.interest;
        if (interest != null) {
            extensions.interest = interest.mo223809clone();
        }
        ProfileExtensionBasic profileExtensionBasic = this.basic;
        if (profileExtensionBasic != null) {
            extensions.basic = profileExtensionBasic.mo223809clone();
        }
        Anonymity anonymity = this.anonymity;
        if (anonymity != null) {
            extensions.anonymity = anonymity.mo223809clone();
        }
        HeadFrame headFrame = this.headFrame;
        if (headFrame != null) {
            extensions.headFrame = headFrame.mo223809clone();
        }
        FriendStatus friendStatus = this.friendStatus;
        if (friendStatus != null) {
            extensions.friendStatus = friendStatus.mo223809clone();
        }
        MomentSwitch momentSwitch = this.momentSwitch;
        if (momentSwitch != null) {
            extensions.momentSwitch = momentSwitch.mo223809clone();
        }
        UserWealth userWealth = this.wealth;
        if (userWealth != null) {
            extensions.wealth = userWealth.mo223809clone();
        }
        ProfileCompletion profileCompletion = this.profileCompletion;
        if (profileCompletion != null) {
            extensions.profileCompletion = profileCompletion.mo223809clone();
        }
        VoiceSignature voiceSignature = this.voiceSignature;
        if (voiceSignature != null) {
            extensions.voiceSignature = voiceSignature.mo223809clone();
        }
        VirtualVoiceLive virtualVoiceLive = this.live;
        if (virtualVoiceLive != null) {
            extensions.live = virtualVoiceLive.mo223809clone();
        }
        ProfileMate profileMate = this.mate;
        if (profileMate != null) {
            extensions.mate = profileMate.mo223809clone();
        }
        PetInfo petInfo = this.pet;
        if (petInfo != null) {
            extensions.pet = petInfo.mo223809clone();
        }
        TailFrame tailFrame = this.tailFrame;
        if (tailFrame != null) {
            extensions.tailFrame = tailFrame.mo223809clone();
        }
        VoiceAvatarFrame voiceAvatarFrame = this.voiceAvatarFrame;
        if (voiceAvatarFrame != null) {
            extensions.voiceAvatarFrame = voiceAvatarFrame.mo223809clone();
        }
        ProfileExtensionMarriage profileExtensionMarriage = this.marriage;
        if (profileExtensionMarriage != null) {
            extensions.marriage = profileExtensionMarriage.mo223809clone();
        }
        ExtensionGame extensionGame = this.game;
        if (extensionGame != null) {
            extensions.game = extensionGame.mo223809clone();
        }
        return extensions;
    }
