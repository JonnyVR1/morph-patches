...
public class VoiceLiveGame extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VoiceLiveGame> PROTOBUF_ADAPTER = new MessageNanoAdapter<VoiceLiveGame>() { // from class: com.p1.mobile.putong.data.VoiceLiveGame.1
        ...
        public int computeAndCacheSize(VoiceLiveGame voiceLiveGame) {
            String str = voiceLiveGame.f38836id;
            ...
            if (voiceLiveGameCurrentChoice != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(11, voiceLiveGameCurrentChoice, VoiceLiveGameCurrentChoice.PROTOBUF_ADAPTER);
            }
            voiceLiveGame.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VoiceLiveGame parse(nb5 nb5Var) throws IOException {
            VoiceLiveGame voiceLiveGame = new VoiceLiveGame();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (voiceLiveGame.f38836id == null) {
                            voiceLiveGame.f38836id = "";
                        }
                        ...
                        break;
                    case 10:
                        voiceLiveGame.f38836id = nb5Var.m158750s();
                        continue;
                    case 18:
                        voiceLiveGame.type = nb5Var.m158750s();
                        continue;
                    case 26:
                        voiceLiveGame.state = nb5Var.m158750s();
                        continue;
                    case 34:
                        voiceLiveGame.categoryId = nb5Var.m158750s();
                        continue;
                    case 42:
                        voiceLiveGame.categoryName = nb5Var.m158750s();
                        continue;
                    case 50:
                        voiceLiveGame.templateId = nb5Var.m158750s();
                        continue;
                    case 58:
                        voiceLiveGame.templateTitle = nb5Var.m158750s();
                        continue;
                    case 66:
                        voiceLiveGame.voiceLiveId = nb5Var.m158750s();
                        continue;
                    case 74:
                        voiceLiveGame.createdTime = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        voiceLiveGame.endTime = nb5Var.m158750s();
                        continue;
                    case 90:
                        voiceLiveGame.currentChoice = (VoiceLiveGameCurrentChoice) nb5Var.m158743l(VoiceLiveGameCurrentChoice.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (voiceLiveGame.f38836id == null) {
                            voiceLiveGame.f38836id = "";
        ...
        public void serialize(VoiceLiveGame voiceLiveGame, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            VoiceLiveGameCurrentChoice voiceLiveGameCurrentChoice = voiceLiveGame.currentChoice;
            if (voiceLiveGameCurrentChoice != null) {
                codedOutputByteBufferNano.m17254K(11, voiceLiveGameCurrentChoice, VoiceLiveGameCurrentChoice.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(VoiceLiveGame voiceLiveGame, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "templateTitle":
                    ...
                    return true;
                case "id":
                    voiceLiveGame.f38836id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public VoiceLiveGame mo223809clone() {
        VoiceLiveGame voiceLiveGame = new VoiceLiveGame();
        voiceLiveGame.f38836id = this.f38836id;
        ...
        if (voiceLiveGameCurrentChoice != null) {
            voiceLiveGame.currentChoice = voiceLiveGameCurrentChoice.mo223809clone();
        }
        return voiceLiveGame;
    }
