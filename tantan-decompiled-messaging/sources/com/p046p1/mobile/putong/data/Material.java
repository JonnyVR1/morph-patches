    ...
    public static ProtobufAdapter<Material> PROTOBUF_ADAPTER = new MessageNanoAdapter<Material>() { // from class: com.p1.mobile.putong.data.Material.1
        ...
        public int computeAndCacheSize(Material material) {
            ...
            if (bannerPicture != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, bannerPicture, BannerPicture.PROTOBUF_ADAPTER);
            }
            String str2 = material.deeplink;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(3, str2);
            }
            material.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Material parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    material.resourceID = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    material.picture = (BannerPicture) nb5Var.m158743l(BannerPicture.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 26) {
                        if (material.resourceID == null) {
                            material.resourceID = "";
                    ...
                    material.deeplink = nb5Var.m158750s();
                }
            }
            return material;
        }
        ...
        public void serialize(Material material, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BannerPicture bannerPicture = material.picture;
            if (bannerPicture != null) {
                codedOutputByteBufferNano.m17254K(2, bannerPicture, BannerPicture.PROTOBUF_ADAPTER);
            }
            String str2 = material.deeplink;
            if (str2 != null) {
