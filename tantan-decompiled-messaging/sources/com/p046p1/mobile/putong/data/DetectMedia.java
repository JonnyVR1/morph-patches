...
public class DetectMedia extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DetectMedia> PROTOBUF_ADAPTER = new MessageNanoAdapter<DetectMedia>() { // from class: com.p1.mobile.putong.data.DetectMedia.1
        ...
        public int computeAndCacheSize(DetectMedia detectMedia) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, detectMedia.index);
            String str2 = detectMedia.type;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(3, str2);
            }
            detectMedia.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DetectMedia parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    detectMedia.url = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    detectMedia.index = nb5Var.m158741j();
                } else {
                    if (iM158752u != 26) {
                        if (detectMedia.url == null) {
                            detectMedia.url = "";
                    ...
                    detectMedia.type = nb5Var.m158750s();
                }
            }
            return detectMedia;
        }
        ...
        public void serialize(DetectMedia detectMedia, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, detectMedia.index);
            String str2 = detectMedia.type;
            if (str2 != null) {
    ...
    public DetectMedia mo223809clone() {
        DetectMedia detectMedia = new DetectMedia();
