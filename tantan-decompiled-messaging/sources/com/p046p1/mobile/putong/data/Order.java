...
public class Order extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Order> PROTOBUF_ADAPTER = new MessageNanoAdapter<Order>() { // from class: com.p1.mobile.putong.data.Order.1
        ...
        public int computeAndCacheSize(Order order) {
            ...
            if (payMethod != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(3, payMethod.ordinal());
            }
            BundleStatus bundleStatus = order.orderStatus;
            if (bundleStatus != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(4, bundleStatus.ordinal());
            }
            ...
            if (bundleStatus2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(7, bundleStatus2.ordinal());
            }
            ...
            if (gPAffiliateTransaction != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(9, gPAffiliateTransaction, GPAffiliateTransaction.PROTOBUF_ADAPTER);
            }
            ...
            if (payMethod2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(11, payMethod2, PayMethod.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus3 = order.orderStatus;
            if (bundleStatus3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(12, bundleStatus3, BundleStatus.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus4 = order.contractStatus;
            if (bundleStatus4 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(13, bundleStatus4, BundleStatus.PROTOBUF_ADAPTER);
            }
            order.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Order parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        order.orderId = nb5Var.m158750s();
                        continue;
                    case 18:
                        order.itemId = nb5Var.m158750s();
                        continue;
                    case 24:
                    ...
                    case 32:
                        ...
                        continue;
                    case 42:
                        order.paymentRequest = nb5Var.m158750s();
                        continue;
                    case 50:
                        order.contractId = nb5Var.m158750s();
                        continue;
                    case 56:
                        numValueOf3 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 66:
                        order.signRequest = nb5Var.m158750s();
                        continue;
                    case 74:
                        order.affiliateTransaction = (GPAffiliateTransaction) nb5Var.m158743l(GPAffiliateTransaction.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        order.signAndPayRequest = nb5Var.m158750s();
                        continue;
                    case 90:
                        order.payMethod = (PayMethod) nb5Var.m158743l(PayMethod.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        order.orderStatus = (BundleStatus) nb5Var.m158743l(BundleStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        order.contractStatus = (BundleStatus) nb5Var.m158743l(BundleStatus.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (order.payMethod == null && numValueOf != null) {
                            order.payMethod = (PayMethod) PayMethod.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Order order, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            PayMethod payMethod = order.payMethod;
            if (payMethod != null) {
                codedOutputByteBufferNano.m17250G(3, payMethod.ordinal());
            }
            BundleStatus bundleStatus = order.orderStatus;
            if (bundleStatus != null) {
                codedOutputByteBufferNano.m17250G(4, bundleStatus.ordinal());
            }
            String str3 = order.paymentRequest;
            if (str3 != null) {
            ...
            BundleStatus bundleStatus2 = order.contractStatus;
            if (bundleStatus2 != null) {
                codedOutputByteBufferNano.m17250G(7, bundleStatus2.ordinal());
            }
            String str5 = order.signRequest;
            if (str5 != null) {
            ...
            GPAffiliateTransaction gPAffiliateTransaction = order.affiliateTransaction;
            if (gPAffiliateTransaction != null) {
                codedOutputByteBufferNano.m17254K(9, gPAffiliateTransaction, GPAffiliateTransaction.PROTOBUF_ADAPTER);
            }
            String str6 = order.signAndPayRequest;
            if (str6 != null) {
            ...
            PayMethod payMethod2 = order.payMethod;
            if (payMethod2 != null) {
                codedOutputByteBufferNano.m17254K(11, payMethod2, PayMethod.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus3 = order.orderStatus;
            if (bundleStatus3 != null) {
                codedOutputByteBufferNano.m17254K(12, bundleStatus3, BundleStatus.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus4 = order.contractStatus;
            if (bundleStatus4 != null) {
                codedOutputByteBufferNano.m17254K(13, bundleStatus4, BundleStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Order mo223809clone() {
        ...
        if (gPAffiliateTransaction != null) {
            order.affiliateTransaction = gPAffiliateTransaction.mo223809clone();
        }
