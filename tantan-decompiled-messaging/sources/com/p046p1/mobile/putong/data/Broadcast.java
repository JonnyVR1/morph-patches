...
public class Broadcast extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Broadcast> PROTOBUF_ADAPTER = new MessageNanoAdapter<Broadcast>() { // from class: com.p1.mobile.putong.data.Broadcast.1
        ...
        public int computeAndCacheSize(Broadcast broadcast) {
            String str = broadcast.f38729id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            BroadcastType broadcastType = broadcast.type;
            if (broadcastType != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(2, broadcastType.ordinal());
            }
            BroadcastStatus broadcastStatus = broadcast.status;
            if (broadcastStatus != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(3, broadcastStatus.ordinal());
            }
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(4, broadcast.active) + CodedOutputByteBufferNano.m17222d(5, broadcast.expiresTime) + CodedOutputByteBufferNano.m17228j(6, broadcast.duration);
            ...
            int iM17222d = iM17220b + CodedOutputByteBufferNano.m17222d(9, broadcast.checkStartTime);
            BroadcastType broadcastType2 = broadcast.type;
            if (broadcastType2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(10, broadcastType2, BroadcastType.PROTOBUF_ADAPTER);
            }
            BroadcastStatus broadcastStatus2 = broadcast.status;
            if (broadcastStatus2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(11, broadcastStatus2, BroadcastStatus.PROTOBUF_ADAPTER);
            }
            broadcast.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Broadcast parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        broadcast.f38729id = nb5Var.m158750s();
                        continue;
                    case 16:
                    ...
                    case 24:
                        ...
                        continue;
                    case 32:
                        broadcast.active = nb5Var.m158738g();
                        continue;
                    case 41:
                        broadcast.expiresTime = nb5Var.m158739h();
                        continue;
                    case 48:
                        broadcast.duration = nb5Var.m158742k();
                        continue;
                    case 58:
                        broadcast.contentID = nb5Var.m158750s();
                        continue;
                    case 66:
                        broadcast.customContent = nb5Var.m158750s();
                        continue;
                    case EACTags.CARDHOLDER_PUBLIC_KEY_TEMPLATE /* 73 */:
                        broadcast.checkStartTime = nb5Var.m158739h();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        broadcast.type = (BroadcastType) nb5Var.m158743l(BroadcastType.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        broadcast.status = (BroadcastStatus) nb5Var.m158743l(BroadcastStatus.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (broadcast.type == null && numValueOf != null) {
                            broadcast.type = (BroadcastType) BroadcastType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Broadcast broadcast, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BroadcastType broadcastType = broadcast.type;
            if (broadcastType != null) {
                codedOutputByteBufferNano.m17250G(2, broadcastType.ordinal());
            }
            BroadcastStatus broadcastStatus = broadcast.status;
            if (broadcastStatus != null) {
                codedOutputByteBufferNano.m17250G(3, broadcastStatus.ordinal());
            }
            codedOutputByteBufferNano.m17244A(4, broadcast.active);
            codedOutputByteBufferNano.m17246C(5, broadcast.expiresTime);
            codedOutputByteBufferNano.m17252I(6, broadcast.duration);
            String str2 = broadcast.contentID;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17246C(9, broadcast.checkStartTime);
            BroadcastType broadcastType2 = broadcast.type;
            if (broadcastType2 != null) {
                codedOutputByteBufferNano.m17254K(10, broadcastType2, BroadcastType.PROTOBUF_ADAPTER);
            }
            BroadcastStatus broadcastStatus2 = broadcast.status;
            if (broadcastStatus2 != null) {
                codedOutputByteBufferNano.m17254K(11, broadcastStatus2, BroadcastStatus.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Broadcast broadcast, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "expiresTime":
                    ...
                    return true;
                case "id":
                    broadcast.f38729id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public Broadcast mo223809clone() {
        Broadcast broadcast = new Broadcast();
        broadcast.f38729id = this.f38729id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38729id, broadcast.f38729id) && ValueObject.util_equals(this.type, broadcast.type) && ValueObject.util_equals(this.status, broadcast.status) && this.active == broadcast.active && this.expiresTime == broadcast.expiresTime && this.duration == broadcast.duration && ValueObject.util_equals(this.contentID, broadcast.contentID) && ValueObject.util_equals(this.customContent, broadcast.customContent) && this.checkStartTime == broadcast.checkStartTime;
    }
    ...
    public boolean isInUse() {
        return this.expiresTime > ((double) qib0.f154693H.guessedCurrentServerTime());
    }
