    ...
    public static ProtobufAdapter<LiveMultiCallInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveMultiCallInfo>() { // from class: com.p1.mobile.putong.data.LiveMultiCallInfo.1
        ...
        public LiveMultiCallInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    liveMultiCallInfo.onGoingMultiCallId = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    liveMultiCallInfo.onGoing = nb5Var.m158738g();
                } else if (iM158752u == 26) {
                    liveMultiCallInfo.role = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    liveMultiCallInfo.onGoingMultiCallOwnerRoomId = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (liveMultiCallInfo.onGoingMultiCallId == null) {
                            liveMultiCallInfo.onGoingMultiCallId = "";
                    ...
                    liveMultiCallInfo.onGoingMultiCallRole = nb5Var.m158750s();
                }
            }
            return liveMultiCallInfo;
        }
