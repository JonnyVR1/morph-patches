...
public class IdealTag extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IdealTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<IdealTag>() { // from class: com.p1.mobile.putong.data.IdealTag.1
        ...
        public int computeAndCacheSize(IdealTag idealTag) {
            ...
            idealTag.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IdealTag parse(nb5 nb5Var) throws IOException {
            IdealTag idealTag = new IdealTag();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (idealTag.f38760id == null) {
                        idealTag.f38760id = "";
                    }
                ...
                if (iM158752u == 10) {
                    idealTag.f38760id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    idealTag.name = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (idealTag.f38760id == null) {
                            idealTag.f38760id = "";
                    ...
                    idealTag.fitIdealDetails = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return idealTag;
        }
    ...
    public static JsonAdapter<IdealTag> JSON_ADAPTER = new ObjectJsonAdapter<IdealTag>() { // from class: com.p1.mobile.putong.data.IdealTag.2
        ...
        public boolean parseField(IdealTag idealTag, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    idealTag.f38760id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public static /* synthetic */ String m59804a(String str) {
        return str;
    }
    ...
    public IdealTag mo223809clone() {
        IdealTag idealTag = new IdealTag();
        idealTag.f38760id = this.f38760id;
        ...
        if (list != null) {
            idealTag.fitIdealDetails = ValueObject.util_map(list, new w9j() { // from class: l.zbm
                ...
                public final Object call(Object obj) {
                    return IdealTag.m59804a((String) obj);
                }
            });
        }
        return idealTag;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38760id, idealTag.f38760id) && ValueObject.util_equals(this.name, idealTag.name) && ValueObject.util_equals(this.fitIdealDetails, idealTag.fitIdealDetails);
    }
