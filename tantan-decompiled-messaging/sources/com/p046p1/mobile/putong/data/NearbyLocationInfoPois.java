...
public class NearbyLocationInfoPois extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NearbyLocationInfoPois> PROTOBUF_ADAPTER = new MessageNanoAdapter<NearbyLocationInfoPois>() { // from class: com.p1.mobile.putong.data.NearbyLocationInfoPois.1
        ...
        public int computeAndCacheSize(NearbyLocationInfoPois nearbyLocationInfoPois) {
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(7, nearbyLocationInfoPois.lng) + CodedOutputByteBufferNano.m17222d(8, nearbyLocationInfoPois.lat) + CodedOutputByteBufferNano.m17226h(9, nearbyLocationInfoPois.distance);
            String str7 = nearbyLocationInfoPois.direction;
            if (str7 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(10, str7);
            }
            String str8 = nearbyLocationInfoPois.tag;
            if (str8 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(11, str8);
            }
            nearbyLocationInfoPois.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NearbyLocationInfoPois parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        nearbyLocationInfoPois.name = nb5Var.m158750s();
                        continue;
                    case 18:
                        nearbyLocationInfoPois.address = nb5Var.m158750s();
                        continue;
                    case 26:
                        nearbyLocationInfoPois.country = nb5Var.m158750s();
                        continue;
                    case 34:
                        nearbyLocationInfoPois.city = nb5Var.m158750s();
                        continue;
                    case 42:
                        nearbyLocationInfoPois.province = nb5Var.m158750s();
                        continue;
                    case 50:
                        nearbyLocationInfoPois.area = nb5Var.m158750s();
                        continue;
                    case 57:
                        nearbyLocationInfoPois.lng = nb5Var.m158739h();
                        continue;
                    case 65:
                        nearbyLocationInfoPois.lat = nb5Var.m158739h();
                        continue;
                    case 72:
                        nearbyLocationInfoPois.distance = nb5Var.m158741j();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        nearbyLocationInfoPois.direction = nb5Var.m158750s();
                        continue;
                    case 90:
                        nearbyLocationInfoPois.tag = nb5Var.m158750s();
                        continue;
                    default:
                        if (nearbyLocationInfoPois.name == null) {
                            nearbyLocationInfoPois.name = "";
        ...
        public void serialize(NearbyLocationInfoPois nearbyLocationInfoPois, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(7, nearbyLocationInfoPois.lng);
            codedOutputByteBufferNano.m17246C(8, nearbyLocationInfoPois.lat);
            codedOutputByteBufferNano.m17250G(9, nearbyLocationInfoPois.distance);
            String str7 = nearbyLocationInfoPois.direction;
            if (str7 != null) {
    ...
    public NearbyLocationInfoPois mo223809clone() {
        NearbyLocationInfoPois nearbyLocationInfoPois = new NearbyLocationInfoPois();
