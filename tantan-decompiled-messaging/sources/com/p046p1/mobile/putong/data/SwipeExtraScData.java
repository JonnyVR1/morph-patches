...
public class SwipeExtraScData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SwipeExtraScData> PROTOBUF_ADAPTER = new MessageNanoAdapter<SwipeExtraScData>() { // from class: com.p1.mobile.putong.data.SwipeExtraScData.1
        ...
        public int computeAndCacheSize(SwipeExtraScData swipeExtraScData) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, swipeExtraScData.picUploads) + CodedOutputByteBufferNano.m17226h(2, swipeExtraScData.picNum);
            String str = swipeExtraScData.picUrl;
            if (str != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(3, str);
            }
            swipeExtraScData.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SwipeExtraScData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    swipeExtraScData.picUploads = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    swipeExtraScData.picNum = nb5Var.m158741j();
                } else {
                    if (iM158752u != 26) {
                        if (swipeExtraScData.picUrl != null) {
                            break;
                    ...
                    swipeExtraScData.picUrl = nb5Var.m158750s();
                }
            }
            return swipeExtraScData;
        }
        ...
        public void serialize(SwipeExtraScData swipeExtraScData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, swipeExtraScData.picUploads);
            codedOutputByteBufferNano.m17250G(2, swipeExtraScData.picNum);
            String str = swipeExtraScData.picUrl;
            if (str != null) {
    ...
    public SwipeExtraScData mo223809clone() {
        SwipeExtraScData swipeExtraScData = new SwipeExtraScData();
