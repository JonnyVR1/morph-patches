...
public class VerifyData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerifyData> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerifyData>() { // from class: com.p1.mobile.putong.data.VerifyData.1
        ...
        public int computeAndCacheSize(VerifyData verifyData) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, verifyData.countryCode);
            String str = verifyData.mobileNumber;
            if (str != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(3, verifyData.code);
            ...
            if (verifyReason != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17226h(5, verifyReason.ordinal());
            }
            int iM17226h3 = iM17226h2 + CodedOutputByteBufferNano.m17226h(6, verifyData.codeLength);
            Device device = verifyData.device;
            if (device != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17230l(7, device, Device.PROTOBUF_ADAPTER);
            }
            String str3 = verifyData.clientId;
            if (str3 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17233o(8, str3);
            }
            String str4 = verifyData.category;
            if (str4 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17233o(9, str4);
            }
            String str5 = verifyData.captchaToken;
            if (str5 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17233o(10, str5);
            }
            String str6 = verifyData.captchaValue;
            if (str6 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17233o(11, str6);
            }
            VerifyReason verifyReason2 = verifyData.action;
            if (verifyReason2 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17230l(12, verifyReason2, VerifyReason.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17226h3 + CodedOutputByteBufferNano.m17220b(13, verifyData.forceLogin);
            Captcha captcha = verifyData.captcha;
            if (captcha != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(14, captcha, Captcha.PROTOBUF_ADAPTER);
            }
            ...
            if (str8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(16, str8);
            }
            String str9 = verifyData.verifyType;
            if (str9 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(17, str9);
            }
            verifyData.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerifyData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        verifyData.countryCode = nb5Var.m158741j();
                        continue;
                    case 18:
                        verifyData.mobileNumber = nb5Var.m158750s();
                        continue;
                    case 24:
                        verifyData.code = nb5Var.m158741j();
                        continue;
                    case 34:
                        verifyData.language = nb5Var.m158750s();
                        continue;
                    case 40:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 48:
                        verifyData.codeLength = nb5Var.m158741j();
                        continue;
                    case 58:
                        verifyData.device = (Device) nb5Var.m158743l(Device.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        verifyData.clientId = nb5Var.m158750s();
                        continue;
                    case 74:
                        verifyData.category = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        verifyData.captchaToken = nb5Var.m158750s();
                        continue;
                    case 90:
                        verifyData.captchaValue = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        verifyData.action = (VerifyReason) nb5Var.m158743l(VerifyReason.PROTOBUF_ADAPTER);
                        continue;
                    case 104:
                        verifyData.forceLogin = nb5Var.m158738g();
                        continue;
                    case 114:
                        verifyData.captcha = (Captcha) nb5Var.m158743l(Captcha.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        verifyData.ttt_signin_token = nb5Var.m158750s();
                        continue;
                    case 130:
                        verifyData.email = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        verifyData.verifyType = nb5Var.m158750s();
                        continue;
                    default:
                        if (verifyData.action == null && numValueOf != null) {
                            verifyData.action = (VerifyReason) VerifyReason.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(VerifyData verifyData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, verifyData.countryCode);
            String str = verifyData.mobileNumber;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17250G(3, verifyData.code);
            String str2 = verifyData.language;
            if (str2 != null) {
            ...
            VerifyReason verifyReason = verifyData.action;
            if (verifyReason != null) {
                codedOutputByteBufferNano.m17250G(5, verifyReason.ordinal());
            }
            codedOutputByteBufferNano.m17250G(6, verifyData.codeLength);
            Device device = verifyData.device;
            if (device != null) {
                codedOutputByteBufferNano.m17254K(7, device, Device.PROTOBUF_ADAPTER);
            }
            String str3 = verifyData.clientId;
            if (str3 != null) {
            ...
            VerifyReason verifyReason2 = verifyData.action;
            if (verifyReason2 != null) {
                codedOutputByteBufferNano.m17254K(12, verifyReason2, VerifyReason.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(13, verifyData.forceLogin);
            Captcha captcha = verifyData.captcha;
            if (captcha != null) {
                codedOutputByteBufferNano.m17254K(14, captcha, Captcha.PROTOBUF_ADAPTER);
            }
            String str7 = verifyData.ttt_signin_token;
            if (str7 != null) {
            ...
            String str8 = verifyData.email;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(16, str8);
            }
            String str9 = verifyData.verifyType;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(17, str9);
            }
        }
    };
    ...
    public VerifyData mo223809clone() {
        VerifyData verifyData = new VerifyData();
        ...
        if (device != null) {
            verifyData.device = device.mo223809clone();
        }
        ...
        if (captcha != null) {
            verifyData.captcha = captcha.mo223809clone();
        }
