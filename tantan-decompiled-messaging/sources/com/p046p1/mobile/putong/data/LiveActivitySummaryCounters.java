...
public class LiveActivitySummaryCounters extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveActivitySummaryCounters> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveActivitySummaryCounters>() { // from class: com.p1.mobile.putong.data.LiveActivitySummaryCounters.1
        ...
        public int computeAndCacheSize(LiveActivitySummaryCounters liveActivitySummaryCounters) {
            ...
            int iM17230l = squareSummary != null ? CodedOutputByteBufferNano.m17230l(1, squareSummary, SquareSummary.PROTOBUF_ADAPTER) : 0;
            SquareDetail squareDetail = liveActivitySummaryCounters.squareDetail;
            if (squareDetail != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, squareDetail, SquareDetail.PROTOBUF_ADAPTER);
            }
            liveActivitySummaryCounters.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveActivitySummaryCounters parse(nb5 nb5Var) throws IOException {
            LiveActivitySummaryCounters liveActivitySummaryCounters = new LiveActivitySummaryCounters();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 10) {
                    liveActivitySummaryCounters.squareSummary = (SquareSummary) nb5Var.m158743l(SquareSummary.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        return liveActivitySummaryCounters;
                    }
                    liveActivitySummaryCounters.squareDetail = (SquareDetail) nb5Var.m158743l(SquareDetail.PROTOBUF_ADAPTER);
                }
            }
        }
        ...
        public void serialize(LiveActivitySummaryCounters liveActivitySummaryCounters, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (squareSummary != null) {
                codedOutputByteBufferNano.m17254K(1, squareSummary, SquareSummary.PROTOBUF_ADAPTER);
            }
            SquareDetail squareDetail = liveActivitySummaryCounters.squareDetail;
            if (squareDetail != null) {
                codedOutputByteBufferNano.m17254K(2, squareDetail, SquareDetail.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LiveActivitySummaryCounters mo223809clone() {
        LiveActivitySummaryCounters liveActivitySummaryCounters = new LiveActivitySummaryCounters();
        SquareSummary squareSummary = this.squareSummary;
        if (squareSummary != null) {
            liveActivitySummaryCounters.squareSummary = squareSummary.mo223809clone();
        }
        SquareDetail squareDetail = this.squareDetail;
        if (squareDetail != null) {
            liveActivitySummaryCounters.squareDetail = squareDetail.mo223809clone();
        }
        return liveActivitySummaryCounters;
    }
