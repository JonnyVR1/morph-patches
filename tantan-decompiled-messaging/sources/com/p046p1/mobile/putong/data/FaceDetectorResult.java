...
public class FaceDetectorResult extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FaceDetectorResult> PROTOBUF_ADAPTER = new MessageNanoAdapter<FaceDetectorResult>() { // from class: com.p1.mobile.putong.data.FaceDetectorResult.1
        ...
        public int computeAndCacheSize(FaceDetectorResult faceDetectorResult) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, faceDetectorResult.code) + CodedOutputByteBufferNano.m17228j(2, faceDetectorResult.score);
            String str = faceDetectorResult.message;
            if (str != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(3, str);
            }
            int iM17228j2 = iM17228j + CodedOutputByteBufferNano.m17228j(4, faceDetectorResult.errorIndex);
            String str2 = faceDetectorResult.reason;
            if (str2 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(5, str2);
            }
            faceDetectorResult.cachedSize = iM17228j2;
            return iM17228j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FaceDetectorResult parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    faceDetectorResult.code = nb5Var.m158742k();
                } else if (iM158752u == 16) {
                    faceDetectorResult.score = nb5Var.m158742k();
                } else if (iM158752u == 26) {
                    faceDetectorResult.message = nb5Var.m158750s();
                } else if (iM158752u == 32) {
                    faceDetectorResult.errorIndex = nb5Var.m158742k();
                } else {
                    if (iM158752u != 42) {
                        if (faceDetectorResult.message == null) {
                            faceDetectorResult.message = "";
                    ...
                    faceDetectorResult.reason = nb5Var.m158750s();
                }
            }
            return faceDetectorResult;
        }
        ...
        public void serialize(FaceDetectorResult faceDetectorResult, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, faceDetectorResult.code);
            codedOutputByteBufferNano.m17252I(2, faceDetectorResult.score);
            String str = faceDetectorResult.message;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(3, str);
            }
            codedOutputByteBufferNano.m17252I(4, faceDetectorResult.errorIndex);
            String str2 = faceDetectorResult.reason;
            if (str2 != null) {
    ...
    public FaceDetectorResult mo223809clone() {
        FaceDetectorResult faceDetectorResult = new FaceDetectorResult();
