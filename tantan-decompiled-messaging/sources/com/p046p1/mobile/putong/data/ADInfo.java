...
public class ADInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ADInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<ADInfo>() { // from class: com.p1.mobile.putong.data.ADInfo.1
        ...
        public int computeAndCacheSize(ADInfo aDInfo) {
            ...
            int iM17230l = oMSADTrackingInfo != null ? CodedOutputByteBufferNano.m17230l(1, oMSADTrackingInfo, OMSADTrackingInfo.PROTOBUF_ADAPTER) : 0;
            OMSADLink oMSADLink = aDInfo.link;
            if (oMSADLink != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, oMSADLink, OMSADLink.PROTOBUF_ADAPTER);
            }
            aDInfo.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ADInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    aDInfo.trackingURLs = (OMSADTrackingInfo) nb5Var.m158743l(OMSADTrackingInfo.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (aDInfo.trackingURLs == null) {
                            aDInfo.trackingURLs = OMSADTrackingInfo.new_();
                    ...
                    aDInfo.link = (OMSADLink) nb5Var.m158743l(OMSADLink.PROTOBUF_ADAPTER);
                }
            }
            return aDInfo;
        }
        ...
        public void serialize(ADInfo aDInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (oMSADTrackingInfo != null) {
                codedOutputByteBufferNano.m17254K(1, oMSADTrackingInfo, OMSADTrackingInfo.PROTOBUF_ADAPTER);
            }
            OMSADLink oMSADLink = aDInfo.link;
            if (oMSADLink != null) {
                codedOutputByteBufferNano.m17254K(2, oMSADLink, OMSADLink.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ADInfo mo223809clone() {
        ADInfo aDInfo = new ADInfo();
        OMSADTrackingInfo oMSADTrackingInfo = this.trackingURLs;
        if (oMSADTrackingInfo != null) {
            aDInfo.trackingURLs = oMSADTrackingInfo.mo223809clone();
        }
        OMSADLink oMSADLink = this.link;
        if (oMSADLink != null) {
            aDInfo.link = oMSADLink.mo223809clone();
        }
        return aDInfo;
    }
