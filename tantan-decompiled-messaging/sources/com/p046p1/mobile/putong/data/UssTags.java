...
public class UssTags extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UssTags> PROTOBUF_ADAPTER = new MessageNanoAdapter<UssTags>() { // from class: com.p1.mobile.putong.data.UssTags.1
        ...
        public int computeAndCacheSize(UssTags ussTags) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, ussTags.onlineStatus) + CodedOutputByteBufferNano.m17226h(2, ussTags.selected) + CodedOutputByteBufferNano.m17220b(3, ussTags.newUser);
            ...
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(6, ussTags.repeatedUser);
            String str3 = ussTags.title;
            if (str3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(7, str3);
            }
            ...
            if (str5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(9, str5);
            }
            String str6 = ussTags.eventInfo;
            if (str6 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(10, str6);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(11, ussTags.showAboutMeOnCard) + CodedOutputByteBufferNano.m17220b(12, ussTags.onlyShowAboutMeInside) + CodedOutputByteBufferNano.m17220b(13, ussTags.profileShowFollowButton);
            ussTags.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UssTags parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        ussTags.onlineStatus = nb5Var.m158741j();
                        continue;
                    case 16:
                        ussTags.selected = nb5Var.m158741j();
                        continue;
                    case 24:
                        ussTags.newUser = nb5Var.m158738g();
                        continue;
                    case 34:
                        ussTags.cardStyle = nb5Var.m158750s();
                        continue;
                    case 42:
                        ussTags.avatarIdentifier = nb5Var.m158750s();
                        continue;
                    case 48:
                        ussTags.repeatedUser = nb5Var.m158738g();
                        continue;
                    case 58:
                        ussTags.title = nb5Var.m158750s();
                        continue;
                    case 66:
                        ussTags.subTitle = nb5Var.m158750s();
                        continue;
                    case 74:
                        ussTags.debugInfo = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        ussTags.eventInfo = nb5Var.m158750s();
                        continue;
                    case 88:
                        ussTags.showAboutMeOnCard = nb5Var.m158738g();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        ussTags.onlyShowAboutMeInside = nb5Var.m158738g();
                        continue;
                    case 104:
                        ussTags.profileShowFollowButton = nb5Var.m158738g();
                        continue;
                    default:
                        if (ussTags.cardStyle == null) {
                            ussTags.cardStyle = "";
        ...
        public void serialize(UssTags ussTags, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, ussTags.onlineStatus);
            codedOutputByteBufferNano.m17250G(2, ussTags.selected);
            codedOutputByteBufferNano.m17244A(3, ussTags.newUser);
            String str = ussTags.cardStyle;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17244A(6, ussTags.repeatedUser);
            String str3 = ussTags.title;
            if (str3 != null) {
            ...
            codedOutputByteBufferNano.m17244A(11, ussTags.showAboutMeOnCard);
            codedOutputByteBufferNano.m17244A(12, ussTags.onlyShowAboutMeInside);
            codedOutputByteBufferNano.m17244A(13, ussTags.profileShowFollowButton);
        }
    };
