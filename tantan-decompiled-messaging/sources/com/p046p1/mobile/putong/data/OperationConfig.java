...
public class OperationConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OperationConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<OperationConfig>() { // from class: com.p1.mobile.putong.data.OperationConfig.1
        ...
        public int computeAndCacheSize(OperationConfig operationConfig) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, operationConfig.clickType);
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(8, operationConfig.slideValue);
            String str7 = operationConfig.shakeSound;
            if (str7 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(9, str7);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(10, operationConfig.shakeValue);
            String str8 = operationConfig.shakeContent;
            if (str8 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(11, str8);
            }
            String str9 = operationConfig.shakeContentSecond;
            if (str9 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(12, str9);
            }
            operationConfig.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OperationConfig parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        operationConfig.skipContent = nb5Var.m158750s();
                        continue;
                    case 16:
                        operationConfig.clickType = nb5Var.m158741j();
                        continue;
                    case 26:
                        operationConfig.buttonStyle = nb5Var.m158750s();
                        continue;
                    case 34:
                        operationConfig.buttonContent = nb5Var.m158750s();
                        continue;
                    case 42:
                        operationConfig.slideImg = nb5Var.m158750s();
                        continue;
                    case 50:
                        operationConfig.slideContent = nb5Var.m158750s();
                        continue;
                    case 58:
                        operationConfig.slideContentSecond = nb5Var.m158750s();
                        continue;
                    case 64:
                        operationConfig.slideValue = nb5Var.m158741j();
                        continue;
                    case 74:
                        operationConfig.shakeSound = nb5Var.m158750s();
                        continue;
                    case 80:
                        operationConfig.shakeValue = nb5Var.m158741j();
                        continue;
                    case 90:
                        operationConfig.shakeContent = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        operationConfig.shakeContentSecond = nb5Var.m158750s();
                        continue;
                    default:
                        if (operationConfig.skipContent == null) {
                            operationConfig.skipContent = "";
        ...
        public void serialize(OperationConfig operationConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, operationConfig.clickType);
            String str2 = operationConfig.buttonStyle;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17250G(8, operationConfig.slideValue);
            String str7 = operationConfig.shakeSound;
            if (str7 != null) {
                codedOutputByteBufferNano.m17261R(9, str7);
            }
            codedOutputByteBufferNano.m17250G(10, operationConfig.shakeValue);
            String str8 = operationConfig.shakeContent;
            if (str8 != null) {
    ...
    public static JsonAdapter<OperationConfig> JSON_ADAPTER = new ObjectJsonAdapter<OperationConfig>() { // from class: com.p1.mobile.putong.data.OperationConfig.2
        ...
        public OperationConfig newInstance() {
    ...
    public OperationConfig mo223809clone() {
        OperationConfig operationConfig = new OperationConfig();
