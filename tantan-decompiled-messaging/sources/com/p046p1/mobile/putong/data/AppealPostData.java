...
public class AppealPostData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AppealPostData> PROTOBUF_ADAPTER = new MessageNanoAdapter<AppealPostData>() { // from class: com.p1.mobile.putong.data.AppealPostData.1
        ...
        public int computeAndCacheSize(AppealPostData appealPostData) {
            ...
            if (faceidLiveData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, faceidLiveData, FaceidLiveData.PROTOBUF_ADAPTER);
            }
            String str2 = appealPostData.reason;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(3, str2);
            }
            String str3 = appealPostData.f38722ip;
            if (str3 != null) {
            ...
            if (idCard != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, idCard, IdCard.PROTOBUF_ADAPTER);
            }
            PhoneNumber phoneNumber = appealPostData.smsPhone;
            if (phoneNumber != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, phoneNumber, PhoneNumber.PROTOBUF_ADAPTER);
            }
            AppealMaterial appealMaterial = appealPostData.material;
            if (appealMaterial != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(8, appealMaterial, AppealMaterial.PROTOBUF_ADAPTER);
            }
            String str5 = appealPostData.appeal_type;
            if (str5 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(9, str5);
            }
            String str6 = appealPostData.ticketId;
            if (str6 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(10, str6);
            }
            appealPostData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AppealPostData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        if (appealPostData.f38722ip == null) {
                            appealPostData.f38722ip = "";
                        }
                        ...
                        break;
                    case 10:
                        appealPostData.provider = nb5Var.m158750s();
                        continue;
                    case 18:
                        appealPostData.providerData = (FaceidLiveData) nb5Var.m158743l(FaceidLiveData.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        appealPostData.reason = nb5Var.m158750s();
                        continue;
                    case 34:
                        appealPostData.f38722ip = nb5Var.m158750s();
                        continue;
                    case 42:
                        appealPostData.verificationMethod = nb5Var.m158750s();
                        continue;
                    case 50:
                        appealPostData.idCard = (IdCard) nb5Var.m158743l(IdCard.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        appealPostData.smsPhone = (PhoneNumber) nb5Var.m158743l(PhoneNumber.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        appealPostData.material = (AppealMaterial) nb5Var.m158743l(AppealMaterial.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        appealPostData.appeal_type = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        appealPostData.ticketId = nb5Var.m158750s();
                        continue;
                    default:
                        if (appealPostData.provider == null) {
                            appealPostData.provider = "";
        ...
        public void serialize(AppealPostData appealPostData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            FaceidLiveData faceidLiveData = appealPostData.providerData;
            if (faceidLiveData != null) {
                codedOutputByteBufferNano.m17254K(2, faceidLiveData, FaceidLiveData.PROTOBUF_ADAPTER);
            }
            String str2 = appealPostData.reason;
            if (str2 != null) {
            ...
            IdCard idCard = appealPostData.idCard;
            if (idCard != null) {
                codedOutputByteBufferNano.m17254K(6, idCard, IdCard.PROTOBUF_ADAPTER);
            }
            PhoneNumber phoneNumber = appealPostData.smsPhone;
            if (phoneNumber != null) {
                codedOutputByteBufferNano.m17254K(7, phoneNumber, PhoneNumber.PROTOBUF_ADAPTER);
            }
            AppealMaterial appealMaterial = appealPostData.material;
            if (appealMaterial != null) {
                codedOutputByteBufferNano.m17254K(8, appealMaterial, AppealMaterial.PROTOBUF_ADAPTER);
            }
            String str5 = appealPostData.appeal_type;
            if (str5 != null) {
        ...
        public boolean parseField(AppealPostData appealPostData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "smsPhone":
                    ...
                    return true;
                case "ip":
                    appealPostData.f38722ip = jsonParser.getValueAsString();
                    return true;
                case "material":
    ...
    public AppealPostData mo223809clone() {
        AppealPostData appealPostData = new AppealPostData();
        appealPostData.provider = this.provider;
        FaceidLiveData faceidLiveData = this.providerData;
        if (faceidLiveData != null) {
            appealPostData.providerData = faceidLiveData.mo223809clone();
        }
        appealPostData.reason = this.reason;
        appealPostData.f38722ip = this.f38722ip;
        appealPostData.verificationMethod = this.verificationMethod;
        IdCard idCard = this.idCard;
        if (idCard != null) {
            appealPostData.idCard = idCard.mo223809clone();
        }
        PhoneNumber phoneNumber = this.smsPhone;
        if (phoneNumber != null) {
            appealPostData.smsPhone = phoneNumber.mo223809clone();
        }
        AppealMaterial appealMaterial = this.material;
        if (appealMaterial != null) {
            appealPostData.material = appealMaterial.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.provider, appealPostData.provider) && ValueObject.util_equals(this.providerData, appealPostData.providerData) && ValueObject.util_equals(this.reason, appealPostData.reason) && ValueObject.util_equals(this.f38722ip, appealPostData.f38722ip) && ValueObject.util_equals(this.verificationMethod, appealPostData.verificationMethod) && ValueObject.util_equals(this.idCard, appealPostData.idCard) && ValueObject.util_equals(this.smsPhone, appealPostData.smsPhone) && ValueObject.util_equals(this.material, appealPostData.material) && ValueObject.util_equals(this.appeal_type, appealPostData.appeal_type) && ValueObject.util_equals(this.ticketId, appealPostData.ticketId);
    }
