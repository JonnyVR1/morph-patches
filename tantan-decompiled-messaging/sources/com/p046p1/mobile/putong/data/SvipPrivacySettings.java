...
public class SvipPrivacySettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SvipPrivacySettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<SvipPrivacySettings>() { // from class: com.p1.mobile.putong.data.SvipPrivacySettings.1
        ...
        public int computeAndCacheSize(SvipPrivacySettings svipPrivacySettings) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, svipPrivacySettings.frozenTime) + CodedOutputByteBufferNano.m17220b(2, svipPrivacySettings.hideAge) + CodedOutputByteBufferNano.m17220b(3, svipPrivacySettings.hideLocation) + CodedOutputByteBufferNano.m17220b(4, svipPrivacySettings.hideIcon);
            svipPrivacySettings.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SvipPrivacySettings parse(nb5 nb5Var) throws IOException {
            SvipPrivacySettings svipPrivacySettings = new SvipPrivacySettings();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    svipPrivacySettings.frozenTime = nb5Var.m158742k();
                } else if (iM158752u == 16) {
                    svipPrivacySettings.hideAge = nb5Var.m158738g();
                } else if (iM158752u == 24) {
                    svipPrivacySettings.hideLocation = nb5Var.m158738g();
                } else {
                    if (iM158752u != 32) {
                        return svipPrivacySettings;
                    }
                    svipPrivacySettings.hideIcon = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(SvipPrivacySettings svipPrivacySettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, svipPrivacySettings.frozenTime);
            codedOutputByteBufferNano.m17244A(2, svipPrivacySettings.hideAge);
            codedOutputByteBufferNano.m17244A(3, svipPrivacySettings.hideLocation);
            codedOutputByteBufferNano.m17244A(4, svipPrivacySettings.hideIcon);
        }
    };
    ...
    public SvipPrivacySettings mo223809clone() {
        SvipPrivacySettings svipPrivacySettings = new SvipPrivacySettings();
