...
public class UserFakeSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserFakeSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserFakeSettings>() { // from class: com.p1.mobile.putong.data.UserFakeSettings.1
        ...
        public int computeAndCacheSize(UserFakeSettings userFakeSettings) {
            ...
            if (bool2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(3, bool2.booleanValue());
            }
            Boolean bool3 = userFakeSettings.weeklyReportPush;
            if (bool3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(4, bool3.booleanValue());
            }
            NotificationNoDisturb notificationNoDisturb = userFakeSettings.noDisturb;
            if (notificationNoDisturb != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(5, notificationNoDisturb, NotificationNoDisturb.PROTOBUF_ADAPTER);
            }
            Boolean bool4 = userFakeSettings.syncMoment;
            if (bool4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(6, bool4.booleanValue());
            }
            ...
            if (settingsIntent != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(9, settingsIntent.ordinal());
            }
            SettingsIntent settingsIntent2 = userFakeSettings.intent;
            if (settingsIntent2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(10, settingsIntent2, SettingsIntent.PROTOBUF_ADAPTER);
            }
            userFakeSettings.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserFakeSettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userFakeSettings.momentPush = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 18:
                        userFakeSettings.sound = nb5Var.m158750s();
                        continue;
                    case 24:
                        userFakeSettings.dailyReportPush = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 32:
                        userFakeSettings.weeklyReportPush = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 42:
                        userFakeSettings.noDisturb = (NotificationNoDisturb) nb5Var.m158743l(NotificationNoDisturb.PROTOBUF_ADAPTER);
                        continue;
                    case 48:
                        userFakeSettings.syncMoment = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 58:
                        userFakeSettings.locationName = nb5Var.m158750s();
                        continue;
                    case 66:
                        userFakeSettings.locationAddress = nb5Var.m158750s();
                        continue;
                    case 72:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        userFakeSettings.intent = (SettingsIntent) nb5Var.m158743l(SettingsIntent.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (userFakeSettings.intent == null && numValueOf != null) {
                            userFakeSettings.intent = (SettingsIntent) SettingsIntent.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(UserFakeSettings userFakeSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            NotificationNoDisturb notificationNoDisturb = userFakeSettings.noDisturb;
            if (notificationNoDisturb != null) {
                codedOutputByteBufferNano.m17254K(5, notificationNoDisturb, NotificationNoDisturb.PROTOBUF_ADAPTER);
            }
            Boolean bool4 = userFakeSettings.syncMoment;
            if (bool4 != null) {
                codedOutputByteBufferNano.m17244A(6, bool4.booleanValue());
            }
            String str2 = userFakeSettings.locationName;
            if (str2 != null) {
            ...
            SettingsIntent settingsIntent = userFakeSettings.intent;
            if (settingsIntent != null) {
                codedOutputByteBufferNano.m17250G(9, settingsIntent.ordinal());
            }
            SettingsIntent settingsIntent2 = userFakeSettings.intent;
            if (settingsIntent2 != null) {
                codedOutputByteBufferNano.m17254K(10, settingsIntent2, SettingsIntent.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public UserFakeSettings mo223809clone() {
        UserFakeSettings userFakeSettings = new UserFakeSettings();
        ...
        if (notificationNoDisturb != null) {
            userFakeSettings.noDisturb = notificationNoDisturb.mo223809clone();
        }
