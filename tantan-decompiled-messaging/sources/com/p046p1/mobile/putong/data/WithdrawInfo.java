...
public class WithdrawInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<WithdrawInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<WithdrawInfo>() { // from class: com.p1.mobile.putong.data.WithdrawInfo.1
        ...
        public int computeAndCacheSize(WithdrawInfo withdrawInfo) {
            ...
            int iM17230l = withdrawInfoIncome != null ? CodedOutputByteBufferNano.m17230l(1, withdrawInfoIncome, WithdrawInfoIncome.PROTOBUF_ADAPTER) : 0;
            withdrawInfo.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public WithdrawInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                withdrawInfo.income = (WithdrawInfoIncome) nb5Var.m158743l(WithdrawInfoIncome.PROTOBUF_ADAPTER);
            }
            return withdrawInfo;
        }
        ...
        public void serialize(WithdrawInfo withdrawInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (withdrawInfoIncome != null) {
                codedOutputByteBufferNano.m17254K(1, withdrawInfoIncome, WithdrawInfoIncome.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public WithdrawInfo mo223809clone() {
        WithdrawInfo withdrawInfo = new WithdrawInfo();
        WithdrawInfoIncome withdrawInfoIncome = this.income;
        if (withdrawInfoIncome != null) {
            withdrawInfo.income = withdrawInfoIncome.mo223809clone();
        }
        return withdrawInfo;
    }
