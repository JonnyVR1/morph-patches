...
public class VerifyDataV2 extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerifyDataV2> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerifyDataV2>() { // from class: com.p1.mobile.putong.data.VerifyDataV2.1
        ...
        public int computeAndCacheSize(VerifyDataV2 verifyDataV2) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, verifyDataV2.countryCode);
            String str = verifyDataV2.mobileNumber;
            if (str != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(2, str);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(3, verifyDataV2.code);
            ...
            int iM17226h3 = iM17226h2 + CodedOutputByteBufferNano.m17226h(6, verifyDataV2.codeLength);
            ...
            if (verifyReason2 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17230l(11, verifyReason2, VerifyReason.PROTOBUF_ADAPTER);
            }
            String str6 = verifyDataV2.email;
            if (str6 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17233o(12, str6);
            }
            String str7 = verifyDataV2.ttt_signin_token;
            if (str7 != null) {
                iM17226h3 += CodedOutputByteBufferNano.m17233o(13, str7);
            }
            verifyDataV2.cachedSize = iM17226h3;
            return iM17226h3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerifyDataV2 parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        verifyDataV2.countryCode = nb5Var.m158741j();
                        continue;
                    case 18:
                        verifyDataV2.mobileNumber = nb5Var.m158750s();
                        continue;
                    case 24:
                        verifyDataV2.code = nb5Var.m158741j();
                        continue;
                    case 34:
                        verifyDataV2.language = nb5Var.m158750s();
                        continue;
                    case 40:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 48:
                        verifyDataV2.codeLength = nb5Var.m158741j();
                        continue;
                    case 58:
                        verifyDataV2.device = (Device) nb5Var.m158743l(Device.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        verifyDataV2.clientId = nb5Var.m158750s();
                        continue;
                    case 74:
                        verifyDataV2.category = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        verifyDataV2.userId = nb5Var.m158750s();
                        continue;
                    case 90:
                        verifyDataV2.action = (VerifyReason) nb5Var.m158743l(VerifyReason.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        verifyDataV2.email = nb5Var.m158750s();
                        continue;
                    case 106:
                        verifyDataV2.ttt_signin_token = nb5Var.m158750s();
                        continue;
                    default:
                        if (verifyDataV2.action == null && numValueOf != null) {
                            verifyDataV2.action = (VerifyReason) VerifyReason.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(VerifyDataV2 verifyDataV2, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, verifyDataV2.countryCode);
            String str = verifyDataV2.mobileNumber;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(2, str);
            }
            codedOutputByteBufferNano.m17250G(3, verifyDataV2.code);
            String str2 = verifyDataV2.language;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17250G(6, verifyDataV2.codeLength);
            Device device = verifyDataV2.device;
            if (device != null) {
            ...
            VerifyReason verifyReason2 = verifyDataV2.action;
            if (verifyReason2 != null) {
                codedOutputByteBufferNano.m17254K(11, verifyReason2, VerifyReason.PROTOBUF_ADAPTER);
            }
            String str6 = verifyDataV2.email;
            if (str6 != null) {
    ...
    public static VerifyDataV2 v1ConvertV2(VerifyData verifyData) {
        ...
        verifyDataV2New_.userId = qib0.f154714c0.userId();
    ...
    public VerifyDataV2 mo223809clone() {
        VerifyDataV2 verifyDataV2 = new VerifyDataV2();
        ...
        if (device != null) {
            verifyDataV2.device = device.mo223809clone();
        }
