...
public class NewOmsLoadStrategy extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NewOmsLoadStrategy> PROTOBUF_ADAPTER = new MessageNanoAdapter<NewOmsLoadStrategy>() { // from class: com.p1.mobile.putong.data.NewOmsLoadStrategy.1
        ...
        public int computeAndCacheSize(NewOmsLoadStrategy newOmsLoadStrategy) {
            ...
            int iM17226h = (loadStrategy != null ? CodedOutputByteBufferNano.m17226h(1, loadStrategy.ordinal()) : 0) + CodedOutputByteBufferNano.m17228j(2, newOmsLoadStrategy.pullSec) + CodedOutputByteBufferNano.m17228j(3, newOmsLoadStrategy.hotIntervalSec);
            LoadStrategy loadStrategy2 = newOmsLoadStrategy.strategy;
            if (loadStrategy2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, loadStrategy2, LoadStrategy.PROTOBUF_ADAPTER);
            }
            int iM17228j = iM17226h + CodedOutputByteBufferNano.m17228j(5, newOmsLoadStrategy.waitMilSecAfterRequest);
            Boolean bool = newOmsLoadStrategy.pushBoost;
            if (bool != null) {
                iM17228j += CodedOutputByteBufferNano.m17220b(6, bool.booleanValue());
            }
            int iM17228j2 = iM17228j + CodedOutputByteBufferNano.m17228j(7, newOmsLoadStrategy.timerIntervalSec) + CodedOutputByteBufferNano.m17228j(8, newOmsLoadStrategy.adUpdateMode);
            newOmsLoadStrategy.cachedSize = iM17228j2;
            return iM17228j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NewOmsLoadStrategy parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    ...
                    newOmsLoadStrategy.pullSec = nb5Var.m158742k();
                } else if (iM158752u == 24) {
                    newOmsLoadStrategy.hotIntervalSec = nb5Var.m158742k();
                } else if (iM158752u == 34) {
                    newOmsLoadStrategy.strategy = (LoadStrategy) nb5Var.m158743l(LoadStrategy.PROTOBUF_ADAPTER);
                } else if (iM158752u == 40) {
                    newOmsLoadStrategy.waitMilSecAfterRequest = nb5Var.m158742k();
                } else if (iM158752u == 48) {
                    newOmsLoadStrategy.pushBoost = Boolean.valueOf(nb5Var.m158738g());
                } else if (iM158752u == 56) {
                    newOmsLoadStrategy.timerIntervalSec = nb5Var.m158742k();
                } else {
                    if (iM158752u != 64) {
                        if (newOmsLoadStrategy.strategy == null && numValueOf != null) {
                            newOmsLoadStrategy.strategy = (LoadStrategy) LoadStrategy.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    newOmsLoadStrategy.adUpdateMode = nb5Var.m158742k();
                }
            }
            return newOmsLoadStrategy;
        }
        ...
        public void serialize(NewOmsLoadStrategy newOmsLoadStrategy, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(2, newOmsLoadStrategy.pullSec);
            codedOutputByteBufferNano.m17252I(3, newOmsLoadStrategy.hotIntervalSec);
            LoadStrategy loadStrategy2 = newOmsLoadStrategy.strategy;
            if (loadStrategy2 != null) {
                codedOutputByteBufferNano.m17254K(4, loadStrategy2, LoadStrategy.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17252I(5, newOmsLoadStrategy.waitMilSecAfterRequest);
            Boolean bool = newOmsLoadStrategy.pushBoost;
            if (bool != null) {
                codedOutputByteBufferNano.m17244A(6, bool.booleanValue());
            }
            codedOutputByteBufferNano.m17252I(7, newOmsLoadStrategy.timerIntervalSec);
            codedOutputByteBufferNano.m17252I(8, newOmsLoadStrategy.adUpdateMode);
        }
    };
    ...
    public NewOmsLoadStrategy mo223809clone() {
        NewOmsLoadStrategy newOmsLoadStrategy = new NewOmsLoadStrategy();
