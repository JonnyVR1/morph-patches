...
public class MomentFeedPushArgs extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentFeedPushArgs> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentFeedPushArgs>() { // from class: com.p1.mobile.putong.data.MomentFeedPushArgs.1
        ...
        public int computeAndCacheSize(MomentFeedPushArgs momentFeedPushArgs) {
            ...
            if (map != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            momentFeedPushArgs.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentFeedPushArgs parse(nb5 nb5Var) throws IOException {
            MomentFeedPushArgs momentFeedPushArgs = new MomentFeedPushArgs();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 10) {
                    momentFeedPushArgs.path = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    momentFeedPushArgs.uid = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    momentFeedPushArgs.mid = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        return momentFeedPushArgs;
                    }
                    momentFeedPushArgs.schemeParamMap = (Map) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
                }
            }
        }
        ...
        public void serialize(MomentFeedPushArgs momentFeedPushArgs, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Map<String, String> map = momentFeedPushArgs.schemeParamMap;
            if (map != null) {
                codedOutputByteBufferNano.m17254K(4, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m59859a(String str) {
        return str;
    }
    ...
    public MomentFeedPushArgs mo223809clone() {
        MomentFeedPushArgs momentFeedPushArgs = new MomentFeedPushArgs();
        ...
        if (map != null) {
            momentFeedPushArgs.schemeParamMap = ValueObject.util_map(map, new w9j() { // from class: l.gf00
                ...
                public final Object call(Object obj) {
                    return MomentFeedPushArgs.m59859a((String) obj);
                }
            });
        }
        return momentFeedPushArgs;
