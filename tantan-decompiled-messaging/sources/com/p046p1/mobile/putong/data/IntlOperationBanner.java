...
public class IntlOperationBanner extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlOperationBanner> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlOperationBanner>() { // from class: com.p1.mobile.putong.data.IntlOperationBanner.1
        ...
        public int computeAndCacheSize(IntlOperationBanner intlOperationBanner) {
            String str = intlOperationBanner.f38763id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            UrlParentData urlParentData = intlOperationBanner.banner;
            if (urlParentData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, urlParentData, UrlParentData.PROTOBUF_ADAPTER);
            }
            UrlParentData urlParentData2 = intlOperationBanner.icon;
            if (urlParentData2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, urlParentData2, UrlParentData.PROTOBUF_ADAPTER);
            }
            String str2 = intlOperationBanner.jumpUrl;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(4, str2);
            }
            intlOperationBanner.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlOperationBanner parse(nb5 nb5Var) throws IOException {
            IntlOperationBanner intlOperationBanner = new IntlOperationBanner();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (intlOperationBanner.f38763id == null) {
                        intlOperationBanner.f38763id = "";
                    }
                ...
                if (iM158752u == 10) {
                    intlOperationBanner.f38763id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    intlOperationBanner.banner = (UrlParentData) nb5Var.m158743l(UrlParentData.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    intlOperationBanner.icon = (UrlParentData) nb5Var.m158743l(UrlParentData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 34) {
                        if (intlOperationBanner.f38763id == null) {
                            intlOperationBanner.f38763id = "";
                    ...
                    intlOperationBanner.jumpUrl = nb5Var.m158750s();
                }
            }
            return intlOperationBanner;
        }
        ...
        public void serialize(IntlOperationBanner intlOperationBanner, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            UrlParentData urlParentData = intlOperationBanner.banner;
            if (urlParentData != null) {
                codedOutputByteBufferNano.m17254K(2, urlParentData, UrlParentData.PROTOBUF_ADAPTER);
            }
            UrlParentData urlParentData2 = intlOperationBanner.icon;
            if (urlParentData2 != null) {
                codedOutputByteBufferNano.m17254K(3, urlParentData2, UrlParentData.PROTOBUF_ADAPTER);
            }
            String str2 = intlOperationBanner.jumpUrl;
            if (str2 != null) {
        ...
        public boolean parseField(IntlOperationBanner intlOperationBanner, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "jumpUrl":
                    ...
                    return true;
                case "id":
                    intlOperationBanner.f38763id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public IntlOperationBanner mo223809clone() {
        IntlOperationBanner intlOperationBanner = new IntlOperationBanner();
        intlOperationBanner.f38763id = this.f38763id;
        UrlParentData urlParentData = this.banner;
        if (urlParentData != null) {
            intlOperationBanner.banner = urlParentData.mo223809clone();
        }
        UrlParentData urlParentData2 = this.icon;
        if (urlParentData2 != null) {
            intlOperationBanner.icon = urlParentData2.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38763id, intlOperationBanner.f38763id) && ValueObject.util_equals(this.banner, intlOperationBanner.banner) && ValueObject.util_equals(this.icon, intlOperationBanner.icon) && ValueObject.util_equals(this.jumpUrl, intlOperationBanner.jumpUrl);
    }
