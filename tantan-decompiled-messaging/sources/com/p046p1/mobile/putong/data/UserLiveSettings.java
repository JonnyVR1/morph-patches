...
public class UserLiveSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserLiveSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserLiveSettings>() { // from class: com.p1.mobile.putong.data.UserLiveSettings.1
        ...
        public int computeAndCacheSize(UserLiveSettings userLiveSettings) {
            ...
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(5, str);
            }
            Boolean bool5 = userLiveSettings.voiceWindowEnable;
            if (bool5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(6, bool5.booleanValue());
            }
            ...
            if (bool6 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(8, bool6.booleanValue());
            }
            Boolean bool7 = userLiveSettings.hideVoiceOnCall;
            if (bool7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(9, bool7.booleanValue());
            }
            int iM17226h = iM17220b + CodedOutputByteBufferNano.m17226h(10, userLiveSettings.wealthGrade);
            Boolean bool8 = userLiveSettings.hideMomentsWealthTag;
            if (bool8 != null) {
                iM17226h += CodedOutputByteBufferNano.m17220b(11, bool8.booleanValue());
            }
            Boolean bool9 = userLiveSettings.hideProfileWealthTag;
            if (bool9 != null) {
                iM17226h += CodedOutputByteBufferNano.m17220b(12, bool9.booleanValue());
            }
            Boolean bool10 = userLiveSettings.hideSwipeWealthTag;
            if (bool10 != null) {
                iM17226h += CodedOutputByteBufferNano.m17220b(13, bool10.booleanValue());
            }
            Boolean bool11 = userLiveSettings.isDiamondVIP;
            if (bool11 != null) {
                iM17226h += CodedOutputByteBufferNano.m17220b(14, bool11.booleanValue());
            }
            Boolean bool12 = userLiveSettings.hideDiamondTag;
            if (bool12 != null) {
                iM17226h += CodedOutputByteBufferNano.m17220b(15, bool12.booleanValue());
            }
            String str3 = userLiveSettings.pureModeGroup;
            if (str3 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(16, str3);
            }
            String str4 = userLiveSettings.showVoiceStatus;
            if (str4 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(17, str4);
            }
            String str5 = userLiveSettings.voiceNotification;
            if (str5 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(18, str5);
            }
            userLiveSettings.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserLiveSettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userLiveSettings.closeEnterRoomMsg = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 16:
                        userLiveSettings.closeSmallWindow = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 24:
                        userLiveSettings.teenModeEnable = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 32:
                        userLiveSettings.intlAdUser = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 42:
                        userLiveSettings.regionTag = nb5Var.m158750s();
                        continue;
                    case 48:
                        userLiveSettings.voiceWindowEnable = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 58:
                        userLiveSettings.fakeId = nb5Var.m158750s();
                        continue;
                    case 64:
                        userLiveSettings.hideStoppedRoom = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 72:
                        userLiveSettings.hideVoiceOnCall = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 80:
                        userLiveSettings.wealthGrade = nb5Var.m158741j();
                        continue;
                    case 88:
                        userLiveSettings.hideMomentsWealthTag = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case Opcodes.IADD /* 96 */:
                        userLiveSettings.hideProfileWealthTag = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 104:
                        userLiveSettings.hideSwipeWealthTag = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 112:
                        userLiveSettings.isDiamondVIP = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 120:
                        userLiveSettings.hideDiamondTag = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 130:
                        userLiveSettings.pureModeGroup = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        userLiveSettings.showVoiceStatus = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        userLiveSettings.voiceNotification = nb5Var.m158750s();
                        continue;
                    default:
                        if (userLiveSettings.closeEnterRoomMsg == null) {
                            userLiveSettings.closeEnterRoomMsg = Boolean.FALSE;
        ...
        public void serialize(UserLiveSettings userLiveSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(10, userLiveSettings.wealthGrade);
            Boolean bool8 = userLiveSettings.hideMomentsWealthTag;
            if (bool8 != null) {
                codedOutputByteBufferNano.m17244A(11, bool8.booleanValue());
            }
            Boolean bool9 = userLiveSettings.hideProfileWealthTag;
            if (bool9 != null) {
                codedOutputByteBufferNano.m17244A(12, bool9.booleanValue());
            }
            Boolean bool10 = userLiveSettings.hideSwipeWealthTag;
            if (bool10 != null) {
                codedOutputByteBufferNano.m17244A(13, bool10.booleanValue());
            }
            Boolean bool11 = userLiveSettings.isDiamondVIP;
            if (bool11 != null) {
                codedOutputByteBufferNano.m17244A(14, bool11.booleanValue());
            }
            Boolean bool12 = userLiveSettings.hideDiamondTag;
            if (bool12 != null) {
                codedOutputByteBufferNano.m17244A(15, bool12.booleanValue());
            }
            String str3 = userLiveSettings.pureModeGroup;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(16, str3);
            }
            String str4 = userLiveSettings.showVoiceStatus;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(17, str4);
            }
            String str5 = userLiveSettings.voiceNotification;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(18, str5);
            }
        }
    };
    ...
    public UserLiveSettings mo223809clone() {
        UserLiveSettings userLiveSettings = new UserLiveSettings();
