...
public abstract class Media extends ValueObject implements Cloneable, Serializable {
    public static ProtobufAdapter<Media> PROTOBUF_ADAPTER = new ProtobufAdapter<Media>() { // from class: com.p1.mobile.putong.data.Media.1
        ...
        public int computeAndCacheSize(Media media) {
            if (media instanceof Picture) {
                return CodedOutputByteBufferNano.m17230l(1, (Picture) media, Picture.PROTOBUF_ADAPTER);
            }
            if (media instanceof Audio) {
                return CodedOutputByteBufferNano.m17230l(3, (Audio) media, Audio.PROTOBUF_ADAPTER);
            }
            if (media instanceof Video) {
                return CodedOutputByteBufferNano.m17230l(2, (Video) media, Video.PROTOBUF_ADAPTER);
            }
            return 0;
        }
        ...
        public int getSize(Media media) {
            if (media instanceof Picture) {
                return CodedOutputByteBufferNano.m17241w(1, (Picture) media, Picture.PROTOBUF_ADAPTER);
            }
            if (media instanceof Audio) {
                return CodedOutputByteBufferNano.m17241w(3, (Audio) media, Audio.PROTOBUF_ADAPTER);
            }
            if (media instanceof Video) {
                return CodedOutputByteBufferNano.m17241w(2, (Video) media, Video.PROTOBUF_ADAPTER);
            }
            return 0;
        }
        ...
        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Media parse(nb5 nb5Var) throws IOException {
            int iM158752u = nb5Var.m158752u();
            if (iM158752u == 10) {
                return (Media) nb5Var.m158743l(Picture.PROTOBUF_ADAPTER);
            }
            if (iM158752u == 18) {
                return (Media) nb5Var.m158743l(Video.PROTOBUF_ADAPTER);
            }
            if (iM158752u != 26) {
                return null;
            }
            return (Media) nb5Var.m158743l(Audio.PROTOBUF_ADAPTER);
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public void serialize(Media media, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            if (media instanceof Picture) {
                codedOutputByteBufferNano.m17254K(1, (Picture) media, Picture.PROTOBUF_ADAPTER);
            } else if (media instanceof Audio) {
                codedOutputByteBufferNano.m17254K(3, (Audio) media, Audio.PROTOBUF_ADAPTER);
            } else if (media instanceof Video) {
                codedOutputByteBufferNano.m17254K(2, (Video) media, Video.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static String URL_TO_CACHEKEY(String str) {
        return k9j.m145078J(str);
    }

    private void add(ArrayList<j760<String, String>> arrayList, String str, String str2) {
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        arrayList.add(new j760<>(str, str2));
    }
    ...
    public static boolean isValidCloudMediaURL(URL url) {
        try {
            return (mu5.f135739g.contains(url.getHost()) || TANTAN_CDN_URL.contains(url.getHost())) && url.getPath().substring(1).split("/").length >= 3;
        } catch (Exception unused) {
            return false;
        }
    }
    ...
    public static void setFocusPoint(Media media, float[] fArr) {
        ...
        if (media instanceof Picture) {
            ...
            int i = aIPosition.f38717x;
            int i2 = aIPosition.f38718y;
            if (i == 0) {
                fArr[0] = 0.0f;
            } else if (i == 1) {
                fArr[0] = 0.5f;
    ...
    public void buildMediaLogParmas(ArrayList<j760<String, String>> arrayList) {
    ...
    public abstract Media mo223809clone();
