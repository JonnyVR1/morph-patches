...
public class BannerFrequency extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BannerFrequency> PROTOBUF_ADAPTER = new MessageNanoAdapter<BannerFrequency>() { // from class: com.p1.mobile.putong.data.BannerFrequency.1
        ...
        public int computeAndCacheSize(BannerFrequency bannerFrequency) {
            ...
            int iM17226h = (bannerFrequencyType != null ? CodedOutputByteBufferNano.m17226h(1, bannerFrequencyType.ordinal()) : 0) + CodedOutputByteBufferNano.m17226h(2, bannerFrequency.count);
            BannerFrequencyType bannerFrequencyType2 = bannerFrequency.type;
            if (bannerFrequencyType2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(3, bannerFrequencyType2, BannerFrequencyType.PROTOBUF_ADAPTER);
            }
            bannerFrequency.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BannerFrequency parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    ...
                    bannerFrequency.count = nb5Var.m158741j();
                } else {
                    if (iM158752u != 26) {
                        if (bannerFrequency.type == null && numValueOf != null) {
                            bannerFrequency.type = (BannerFrequencyType) BannerFrequencyType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    bannerFrequency.type = (BannerFrequencyType) nb5Var.m158743l(BannerFrequencyType.PROTOBUF_ADAPTER);
                }
            }
            return bannerFrequency;
        }
        ...
        public void serialize(BannerFrequency bannerFrequency, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (bannerFrequencyType != null) {
                codedOutputByteBufferNano.m17250G(1, bannerFrequencyType.ordinal());
            }
            codedOutputByteBufferNano.m17250G(2, bannerFrequency.count);
            BannerFrequencyType bannerFrequencyType2 = bannerFrequency.type;
            if (bannerFrequencyType2 != null) {
                codedOutputByteBufferNano.m17254K(3, bannerFrequencyType2, BannerFrequencyType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public BannerFrequency mo223809clone() {
        BannerFrequency bannerFrequency = new BannerFrequency();
