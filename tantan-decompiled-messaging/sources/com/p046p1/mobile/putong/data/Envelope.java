...
public class Envelope extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Envelope> PROTOBUF_ADAPTER = new MessageNanoAdapter<Envelope>() { // from class: com.p1.mobile.putong.data.Envelope.1
        ...
        public int computeAndCacheSize(Envelope envelope) {
            ...
            if (counter != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, counter, Counter.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17230l + CodedOutputByteBufferNano.m17226h(3, envelope.localOptions);
            Data data = envelope.data;
            if (data != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, data, Data.PROTOBUF_ADAPTER);
            }
            Pagination pagination = envelope.pagination;
            if (pagination != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(5, pagination, Pagination.PROTOBUF_ADAPTER);
            }
            envelope.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Envelope parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    envelope.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    envelope.counters = (Counter) nb5Var.m158743l(Counter.PROTOBUF_ADAPTER);
                } else if (iM158752u == 24) {
                    envelope.localOptions = nb5Var.m158741j();
                } else if (iM158752u == 34) {
                    envelope.data = (Data) nb5Var.m158743l(Data.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 42) {
                        if (envelope.meta == null) {
                            envelope.meta = Meta.new_();
                    ...
                    envelope.pagination = (Pagination) nb5Var.m158743l(Pagination.PROTOBUF_ADAPTER);
                }
            }
            return envelope;
        }
        ...
        public void serialize(Envelope envelope, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Counter counter = envelope.counters;
            if (counter != null) {
                codedOutputByteBufferNano.m17254K(2, counter, Counter.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(3, envelope.localOptions);
            Data data = envelope.data;
            if (data != null) {
                codedOutputByteBufferNano.m17254K(4, data, Data.PROTOBUF_ADAPTER);
            }
            Pagination pagination = envelope.pagination;
            if (pagination != null) {
                codedOutputByteBufferNano.m17254K(5, pagination, Pagination.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public void addAll(Envelope envelope) {
        if (vwb.m200296J(envelope.dataList)) {
            return;
        }
    ...
    public Envelope mo223809clone() {
        Envelope envelope = new Envelope();
        Meta meta = this.meta;
        if (meta != null) {
            envelope.meta = meta.mo223809clone();
        }
        Counter counter = this.counters;
        if (counter != null) {
            envelope.counters = counter.mo223809clone();
        }
        envelope.localOptions = this.localOptions;
        Data data = this.data;
        if (data != null) {
            envelope.data = data.mo223809clone();
        }
        Pagination pagination = this.pagination;
        if (pagination != null) {
            envelope.pagination = pagination.mo223809clone();
        }
        return envelope;
    }
    ...
    public void onApiParseComplete() {
        ...
        ArrayList<pp2> arrayListM180390d = rpq.m180387b().m180390d();
        if (arrayListM180390d != null && arrayListM180390d.size() > 0) {
            Iterator<pp2> it2 = arrayListM180390d.iterator();
            while (it2.hasNext()) {
                it2.next().mo104456b(this);
            }
        }
