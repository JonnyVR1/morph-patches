...
public class UserPictureTags extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserPictureTags> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserPictureTags>() { // from class: com.p1.mobile.putong.data.UserPictureTags.1
        ...
        public int computeAndCacheSize(UserPictureTags userPictureTags) {
            String str = userPictureTags.f38832id;
            ...
            userPictureTags.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserPictureTags parse(nb5 nb5Var) throws IOException {
            UserPictureTags userPictureTags = new UserPictureTags();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (userPictureTags.f38832id == null) {
                        userPictureTags.f38832id = "";
                    }
                ...
                if (iM158752u == 10) {
                    userPictureTags.f38832id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    userPictureTags.name = nb5Var.m158750s();
                } else {
                    if (iM158752u != 26) {
                        if (userPictureTags.f38832id == null) {
                            userPictureTags.f38832id = "";
                    ...
                    userPictureTags.categories = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return userPictureTags;
        }
    ...
    public static JsonAdapter<UserPictureTags> JSON_ADAPTER = new ObjectJsonAdapter<UserPictureTags>() { // from class: com.p1.mobile.putong.data.UserPictureTags.2
        ...
        public boolean parseField(UserPictureTags userPictureTags, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    userPictureTags.f38832id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public static /* synthetic */ String m60133a(String str) {
        return str;
    }
    ...
    public UserPictureTags mo223809clone() {
        UserPictureTags userPictureTags = new UserPictureTags();
        userPictureTags.f38832id = this.f38832id;
        ...
        if (list != null) {
            userPictureTags.categories = ValueObject.util_map(list, new w9j() { // from class: l.i7k0
                ...
                public final Object call(Object obj) {
                    return UserPictureTags.m60133a((String) obj);
                }
            });
        }
        return userPictureTags;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38832id, userPictureTags.f38832id) && ValueObject.util_equals(this.name, userPictureTags.name) && ValueObject.util_equals(this.categories, userPictureTags.categories);
    }
