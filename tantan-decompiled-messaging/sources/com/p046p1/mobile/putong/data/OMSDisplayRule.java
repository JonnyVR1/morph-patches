...
import com.p046p1.mobile.putong.data.OMSDisplayRule;
...
public class OMSDisplayRule extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSDisplayRule> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSDisplayRule>() { // from class: com.p1.mobile.putong.data.OMSDisplayRule.1
        ...
        public int computeAndCacheSize(OMSDisplayRule oMSDisplayRule) {
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(3, oMSDisplayRule.count) + CodedOutputByteBufferNano.m17226h(4, oMSDisplayRule.sessionCount) + CodedOutputByteBufferNano.m17226h(5, oMSDisplayRule.priority) + CodedOutputByteBufferNano.m17226h(6, oMSDisplayRule.timePerDay) + CodedOutputByteBufferNano.m17226h(7, oMSDisplayRule.timePerWeek);
            List<Long> list2 = oMSDisplayRule.timeRange;
            if (list2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(8, list2, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(9, oMSDisplayRule.dayOffset) + CodedOutputByteBufferNano.m17220b(10, oMSDisplayRule.userDimension);
            oMSDisplayRule.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSDisplayRule parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        oMSDisplayRule.resourceID = nb5Var.m158750s();
                        continue;
                    case 18:
                        oMSDisplayRule.frequency = (List) nb5Var.m158743l(ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 24:
                        oMSDisplayRule.count = nb5Var.m158741j();
                        continue;
                    case 32:
                        oMSDisplayRule.sessionCount = nb5Var.m158741j();
                        continue;
                    case 40:
                        oMSDisplayRule.priority = nb5Var.m158741j();
                        continue;
                    case 48:
                        oMSDisplayRule.timePerDay = nb5Var.m158741j();
                        continue;
                    case 56:
                        oMSDisplayRule.timePerWeek = nb5Var.m158741j();
                        continue;
                    case 66:
                        oMSDisplayRule.timeRange = (List) nb5Var.m158743l(ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 72:
                        oMSDisplayRule.dayOffset = nb5Var.m158741j();
                        continue;
                    case 80:
                        oMSDisplayRule.userDimension = nb5Var.m158738g();
                        continue;
                    default:
                        if (oMSDisplayRule.resourceID == null) {
                            oMSDisplayRule.resourceID = "";
        ...
        public void serialize(OMSDisplayRule oMSDisplayRule, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(3, oMSDisplayRule.count);
            codedOutputByteBufferNano.m17250G(4, oMSDisplayRule.sessionCount);
            codedOutputByteBufferNano.m17250G(5, oMSDisplayRule.priority);
            codedOutputByteBufferNano.m17250G(6, oMSDisplayRule.timePerDay);
            codedOutputByteBufferNano.m17250G(7, oMSDisplayRule.timePerWeek);
            List<Long> list2 = oMSDisplayRule.timeRange;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(8, list2, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17250G(9, oMSDisplayRule.dayOffset);
            codedOutputByteBufferNano.m17244A(10, oMSDisplayRule.userDimension);
        }
    };
    ...
    public static /* synthetic */ Integer m59908a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Long m59909b(Long l2) {
        return l2;
    }
    ...
    public OMSDisplayRule mo223809clone() {
        OMSDisplayRule oMSDisplayRule = new OMSDisplayRule();
        ...
        if (list != null) {
            oMSDisplayRule.frequency = ValueObject.util_map(list, new w9j() { // from class: l.wy40
                ...
                public final Object call(Object obj) {
                    return OMSDisplayRule.m59908a((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            oMSDisplayRule.timeRange = ValueObject.util_map(list2, new w9j() { // from class: l.xy40
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OMSDisplayRule.m59909b((Long) obj);
                }
            });
        }
