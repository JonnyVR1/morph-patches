...
import com.p046p1.mobile.putong.core.data.Decoration;
...
public class SettingGroups extends ValueObject<SettingGroups> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SettingGroups> PROTOBUF_ADAPTER = new MessageNanoAdapter<SettingGroups>() { // from class: com.p1.mobile.putong.data.SettingGroups.1
        ...
        public int computeAndCacheSize(SettingGroups settingGroups) {
            ...
            if (userBoostSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, userBoostSettings, UserBoostSettings.PROTOBUF_ADAPTER);
            }
            UserLiveSettings userLiveSettings = settingGroups.live;
            if (userLiveSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, userLiveSettings, UserLiveSettings.PROTOBUF_ADAPTER);
            }
            UserPrivacySettings userPrivacySettings = settingGroups.privacy;
            if (userPrivacySettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, userPrivacySettings, UserPrivacySettings.PROTOBUF_ADAPTER);
            }
            UserPushSettings userPushSettings = settingGroups.push;
            if (userPushSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, userPushSettings, UserPushSettings.PROTOBUF_ADAPTER);
            }
            UserSearchSettings userSearchSettings = settingGroups.search;
            if (userSearchSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, userSearchSettings, UserSearchSettings.PROTOBUF_ADAPTER);
            }
            UserSubscriptionSettings userSubscriptionSettings = settingGroups.subscription;
            if (userSubscriptionSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, userSubscriptionSettings, UserSubscriptionSettings.PROTOBUF_ADAPTER);
            }
            UserFakeSettings userFakeSettings = settingGroups.fake;
            if (userFakeSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(8, userFakeSettings, UserFakeSettings.PROTOBUF_ADAPTER);
            }
            UserSVIPSettings userSVIPSettings = settingGroups.svip;
            if (userSVIPSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(9, userSVIPSettings, UserSVIPSettings.PROTOBUF_ADAPTER);
            }
            SvipPrivacySettings svipPrivacySettings = settingGroups.svipPrivacy;
            if (svipPrivacySettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(10, svipPrivacySettings, SvipPrivacySettings.PROTOBUF_ADAPTER);
            }
            SeeSettings seeSettings = settingGroups.see;
            if (seeSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(11, seeSettings, SeeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = settingGroups.diamondVIP;
            if (diamondVIPPrivilegeSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(12, diamondVIPPrivilegeSettings, DiamondVIPPrivilegeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivateMatch diamondVIPPrivateMatch = settingGroups.diamondVIPPrivateMatch;
            if (diamondVIPPrivateMatch != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(13, diamondVIPPrivateMatch, DiamondVIPPrivateMatch.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting = settingGroups.soulchat;
            if (chatSetting != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(14, chatSetting, ChatSetting.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting2 = settingGroups.quickchatchat;
            if (chatSetting2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(15, chatSetting2, ChatSetting.PROTOBUF_ADAPTER);
            }
            SoulMatchGroup soulMatchGroup = settingGroups.soulmate;
            if (soulMatchGroup != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(16, soulMatchGroup, SoulMatchGroup.PROTOBUF_ADAPTER);
            }
            ShareSetting shareSetting = settingGroups.share;
            if (shareSetting != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(17, shareSetting, ShareSetting.PROTOBUF_ADAPTER);
            }
            DecorationSettings decorationSettings = settingGroups.decoration;
            if (decorationSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(18, decorationSettings, DecorationSettings.PROTOBUF_ADAPTER);
            }
            ComDiamond comDiamond = settingGroups.comDiamond;
            if (comDiamond != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(19, comDiamond, ComDiamond.PROTOBUF_ADAPTER);
            }
            CharacterEvaluate characterEvaluate = settingGroups.characterEvaluate;
            if (characterEvaluate != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(20, characterEvaluate, CharacterEvaluate.PROTOBUF_ADAPTER);
            }
            Pet pet = settingGroups.pet;
            if (pet != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(21, pet, Pet.PROTOBUF_ADAPTER);
            }
            MomentLevel momentLevel = settingGroups.momentLevel;
            if (momentLevel != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(22, momentLevel, MomentLevel.PROTOBUF_ADAPTER);
            }
            VipSearchSettings vipSearchSettings = settingGroups.vipSearch;
            if (vipSearchSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(23, vipSearchSettings, VipSearchSettings.PROTOBUF_ADAPTER);
            }
            UserMomentSettings userMomentSettings = settingGroups.moment;
            if (userMomentSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(24, userMomentSettings, UserMomentSettings.PROTOBUF_ADAPTER);
            }
            SettingGroupsProfile settingGroupsProfile = settingGroups.profile;
            if (settingGroupsProfile != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(25, settingGroupsProfile, SettingGroupsProfile.PROTOBUF_ADAPTER);
            }
            PlatinumSettings platinumSettings = settingGroups.pvip;
            if (platinumSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(26, platinumSettings, PlatinumSettings.PROTOBUF_ADAPTER);
            }
            MarrySettings marrySettings = settingGroups.marriage;
            if (marrySettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(27, marrySettings, MarrySettings.PROTOBUF_ADAPTER);
            }
            CityC cityC = settingGroups.cityC;
            if (cityC != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(28, cityC, CityC.PROTOBUF_ADAPTER);
            }
            SpVip spVip = settingGroups.spvip;
            if (spVip != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(29, spVip, SpVip.PROTOBUF_ADAPTER);
            }
            GrowthSettings growthSettings = settingGroups.growth;
            if (growthSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(30, growthSettings, GrowthSettings.PROTOBUF_ADAPTER);
            }
            FemaleVip femaleVip = settingGroups.fvip;
            if (femaleVip != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(31, femaleVip, FemaleVip.PROTOBUF_ADAPTER);
            }
            SvipSearch svipSearch = settingGroups.svipSearch;
            if (svipSearch != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(32, svipSearch, SvipSearch.PROTOBUF_ADAPTER);
            }
            NotificationSetting notificationSetting = settingGroups.noPush;
            if (notificationSetting != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(33, notificationSetting, NotificationSetting.PROTOBUF_ADAPTER);
            }
            UserUpVipSettings userUpVipSettings = settingGroups.upvip;
            if (userUpVipSettings != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(34, userUpVipSettings, UserUpVipSettings.PROTOBUF_ADAPTER);
            }
            AdsMaterialRouter adsMaterialRouter = settingGroups.adsMaterialRouter;
            if (adsMaterialRouter != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(35, adsMaterialRouter, AdsMaterialRouter.PROTOBUF_ADAPTER);
            }
            IntlMoreGender intlMoreGender = settingGroups.gender;
            if (intlMoreGender != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(36, intlMoreGender, IntlMoreGender.PROTOBUF_ADAPTER);
            }
            TribeSetting tribeSetting = settingGroups.tttribe;
            if (tribeSetting != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(37, tribeSetting, TribeSetting.PROTOBUF_ADAPTER);
            }
            settingGroups.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SettingGroups parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        settingGroups.type = nb5Var.m158750s();
                        continue;
                    case 18:
                        settingGroups.boost = (UserBoostSettings) nb5Var.m158743l(UserBoostSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        settingGroups.live = (UserLiveSettings) nb5Var.m158743l(UserLiveSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        settingGroups.privacy = (UserPrivacySettings) nb5Var.m158743l(UserPrivacySettings.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        settingGroups.push = (UserPushSettings) nb5Var.m158743l(UserPushSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        settingGroups.search = (UserSearchSettings) nb5Var.m158743l(UserSearchSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        settingGroups.subscription = (UserSubscriptionSettings) nb5Var.m158743l(UserSubscriptionSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        settingGroups.fake = (UserFakeSettings) nb5Var.m158743l(UserFakeSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        settingGroups.svip = (UserSVIPSettings) nb5Var.m158743l(UserSVIPSettings.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        settingGroups.svipPrivacy = (SvipPrivacySettings) nb5Var.m158743l(SvipPrivacySettings.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        settingGroups.see = (SeeSettings) nb5Var.m158743l(SeeSettings.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        settingGroups.diamondVIP = (DiamondVIPPrivilegeSettings) nb5Var.m158743l(DiamondVIPPrivilegeSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        settingGroups.diamondVIPPrivateMatch = (DiamondVIPPrivateMatch) nb5Var.m158743l(DiamondVIPPrivateMatch.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        settingGroups.soulchat = (ChatSetting) nb5Var.m158743l(ChatSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        settingGroups.quickchatchat = (ChatSetting) nb5Var.m158743l(ChatSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        settingGroups.soulmate = (SoulMatchGroup) nb5Var.m158743l(SoulMatchGroup.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        settingGroups.share = (ShareSetting) nb5Var.m158743l(ShareSetting.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        settingGroups.decoration = (DecorationSettings) nb5Var.m158743l(DecorationSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        settingGroups.comDiamond = (ComDiamond) nb5Var.m158743l(ComDiamond.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        settingGroups.characterEvaluate = (CharacterEvaluate) nb5Var.m158743l(CharacterEvaluate.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        settingGroups.pet = (Pet) nb5Var.m158743l(Pet.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        settingGroups.momentLevel = (MomentLevel) nb5Var.m158743l(MomentLevel.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        settingGroups.vipSearch = (VipSearchSettings) nb5Var.m158743l(VipSearchSettings.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        settingGroups.moment = (UserMomentSettings) nb5Var.m158743l(UserMomentSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 202:
                        settingGroups.profile = (SettingGroupsProfile) nb5Var.m158743l(SettingGroupsProfile.PROTOBUF_ADAPTER);
                        continue;
                    case 210:
                        settingGroups.pvip = (PlatinumSettings) nb5Var.m158743l(PlatinumSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 218:
                        settingGroups.marriage = (MarrySettings) nb5Var.m158743l(MarrySettings.PROTOBUF_ADAPTER);
                        continue;
                    case 226:
                        settingGroups.cityC = (CityC) nb5Var.m158743l(CityC.PROTOBUF_ADAPTER);
                        continue;
                    case 234:
                        settingGroups.spvip = (SpVip) nb5Var.m158743l(SpVip.PROTOBUF_ADAPTER);
                        continue;
                    case 242:
                        settingGroups.growth = (GrowthSettings) nb5Var.m158743l(GrowthSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 250:
                        settingGroups.fvip = (FemaleVip) nb5Var.m158743l(FemaleVip.PROTOBUF_ADAPTER);
                        continue;
                    case 258:
                        settingGroups.svipSearch = (SvipSearch) nb5Var.m158743l(SvipSearch.PROTOBUF_ADAPTER);
                        continue;
                    case 266:
                        settingGroups.noPush = (NotificationSetting) nb5Var.m158743l(NotificationSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 274:
                        settingGroups.upvip = (UserUpVipSettings) nb5Var.m158743l(UserUpVipSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 282:
                        settingGroups.adsMaterialRouter = (AdsMaterialRouter) nb5Var.m158743l(AdsMaterialRouter.PROTOBUF_ADAPTER);
                        continue;
                    case 290:
                        settingGroups.gender = (IntlMoreGender) nb5Var.m158743l(IntlMoreGender.PROTOBUF_ADAPTER);
                        continue;
                    case 298:
                        settingGroups.tttribe = (TribeSetting) nb5Var.m158743l(TribeSetting.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (settingGroups.boost == null) {
                            settingGroups.boost = UserBoostSettings.new_();
        ...
        public void serialize(SettingGroups settingGroups, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            UserBoostSettings userBoostSettings = settingGroups.boost;
            if (userBoostSettings != null) {
                codedOutputByteBufferNano.m17254K(2, userBoostSettings, UserBoostSettings.PROTOBUF_ADAPTER);
            }
            UserLiveSettings userLiveSettings = settingGroups.live;
            if (userLiveSettings != null) {
                codedOutputByteBufferNano.m17254K(3, userLiveSettings, UserLiveSettings.PROTOBUF_ADAPTER);
            }
            UserPrivacySettings userPrivacySettings = settingGroups.privacy;
            if (userPrivacySettings != null) {
                codedOutputByteBufferNano.m17254K(4, userPrivacySettings, UserPrivacySettings.PROTOBUF_ADAPTER);
            }
            UserPushSettings userPushSettings = settingGroups.push;
            if (userPushSettings != null) {
                codedOutputByteBufferNano.m17254K(5, userPushSettings, UserPushSettings.PROTOBUF_ADAPTER);
            }
            UserSearchSettings userSearchSettings = settingGroups.search;
            if (userSearchSettings != null) {
                codedOutputByteBufferNano.m17254K(6, userSearchSettings, UserSearchSettings.PROTOBUF_ADAPTER);
            }
            UserSubscriptionSettings userSubscriptionSettings = settingGroups.subscription;
            if (userSubscriptionSettings != null) {
                codedOutputByteBufferNano.m17254K(7, userSubscriptionSettings, UserSubscriptionSettings.PROTOBUF_ADAPTER);
            }
            UserFakeSettings userFakeSettings = settingGroups.fake;
            if (userFakeSettings != null) {
                codedOutputByteBufferNano.m17254K(8, userFakeSettings, UserFakeSettings.PROTOBUF_ADAPTER);
            }
            UserSVIPSettings userSVIPSettings = settingGroups.svip;
            if (userSVIPSettings != null) {
                codedOutputByteBufferNano.m17254K(9, userSVIPSettings, UserSVIPSettings.PROTOBUF_ADAPTER);
            }
            SvipPrivacySettings svipPrivacySettings = settingGroups.svipPrivacy;
            if (svipPrivacySettings != null) {
                codedOutputByteBufferNano.m17254K(10, svipPrivacySettings, SvipPrivacySettings.PROTOBUF_ADAPTER);
            }
            SeeSettings seeSettings = settingGroups.see;
            if (seeSettings != null) {
                codedOutputByteBufferNano.m17254K(11, seeSettings, SeeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = settingGroups.diamondVIP;
            if (diamondVIPPrivilegeSettings != null) {
                codedOutputByteBufferNano.m17254K(12, diamondVIPPrivilegeSettings, DiamondVIPPrivilegeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivateMatch diamondVIPPrivateMatch = settingGroups.diamondVIPPrivateMatch;
            if (diamondVIPPrivateMatch != null) {
                codedOutputByteBufferNano.m17254K(13, diamondVIPPrivateMatch, DiamondVIPPrivateMatch.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting = settingGroups.soulchat;
            if (chatSetting != null) {
                codedOutputByteBufferNano.m17254K(14, chatSetting, ChatSetting.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting2 = settingGroups.quickchatchat;
            if (chatSetting2 != null) {
                codedOutputByteBufferNano.m17254K(15, chatSetting2, ChatSetting.PROTOBUF_ADAPTER);
            }
            SoulMatchGroup soulMatchGroup = settingGroups.soulmate;
            if (soulMatchGroup != null) {
                codedOutputByteBufferNano.m17254K(16, soulMatchGroup, SoulMatchGroup.PROTOBUF_ADAPTER);
            }
            ShareSetting shareSetting = settingGroups.share;
            if (shareSetting != null) {
                codedOutputByteBufferNano.m17254K(17, shareSetting, ShareSetting.PROTOBUF_ADAPTER);
            }
            DecorationSettings decorationSettings = settingGroups.decoration;
            if (decorationSettings != null) {
                codedOutputByteBufferNano.m17254K(18, decorationSettings, DecorationSettings.PROTOBUF_ADAPTER);
            }
            ComDiamond comDiamond = settingGroups.comDiamond;
            if (comDiamond != null) {
                codedOutputByteBufferNano.m17254K(19, comDiamond, ComDiamond.PROTOBUF_ADAPTER);
            }
            CharacterEvaluate characterEvaluate = settingGroups.characterEvaluate;
            if (characterEvaluate != null) {
                codedOutputByteBufferNano.m17254K(20, characterEvaluate, CharacterEvaluate.PROTOBUF_ADAPTER);
            }
            Pet pet = settingGroups.pet;
            if (pet != null) {
                codedOutputByteBufferNano.m17254K(21, pet, Pet.PROTOBUF_ADAPTER);
            }
            MomentLevel momentLevel = settingGroups.momentLevel;
            if (momentLevel != null) {
                codedOutputByteBufferNano.m17254K(22, momentLevel, MomentLevel.PROTOBUF_ADAPTER);
            }
            VipSearchSettings vipSearchSettings = settingGroups.vipSearch;
            if (vipSearchSettings != null) {
                codedOutputByteBufferNano.m17254K(23, vipSearchSettings, VipSearchSettings.PROTOBUF_ADAPTER);
            }
            UserMomentSettings userMomentSettings = settingGroups.moment;
            if (userMomentSettings != null) {
                codedOutputByteBufferNano.m17254K(24, userMomentSettings, UserMomentSettings.PROTOBUF_ADAPTER);
            }
            SettingGroupsProfile settingGroupsProfile = settingGroups.profile;
            if (settingGroupsProfile != null) {
                codedOutputByteBufferNano.m17254K(25, settingGroupsProfile, SettingGroupsProfile.PROTOBUF_ADAPTER);
            }
            PlatinumSettings platinumSettings = settingGroups.pvip;
            if (platinumSettings != null) {
                codedOutputByteBufferNano.m17254K(26, platinumSettings, PlatinumSettings.PROTOBUF_ADAPTER);
            }
            MarrySettings marrySettings = settingGroups.marriage;
            if (marrySettings != null) {
                codedOutputByteBufferNano.m17254K(27, marrySettings, MarrySettings.PROTOBUF_ADAPTER);
            }
            CityC cityC = settingGroups.cityC;
            if (cityC != null) {
                codedOutputByteBufferNano.m17254K(28, cityC, CityC.PROTOBUF_ADAPTER);
            }
            SpVip spVip = settingGroups.spvip;
            if (spVip != null) {
                codedOutputByteBufferNano.m17254K(29, spVip, SpVip.PROTOBUF_ADAPTER);
            }
            GrowthSettings growthSettings = settingGroups.growth;
            if (growthSettings != null) {
                codedOutputByteBufferNano.m17254K(30, growthSettings, GrowthSettings.PROTOBUF_ADAPTER);
            }
            FemaleVip femaleVip = settingGroups.fvip;
            if (femaleVip != null) {
                codedOutputByteBufferNano.m17254K(31, femaleVip, FemaleVip.PROTOBUF_ADAPTER);
            }
            SvipSearch svipSearch = settingGroups.svipSearch;
            if (svipSearch != null) {
                codedOutputByteBufferNano.m17254K(32, svipSearch, SvipSearch.PROTOBUF_ADAPTER);
            }
            NotificationSetting notificationSetting = settingGroups.noPush;
            if (notificationSetting != null) {
                codedOutputByteBufferNano.m17254K(33, notificationSetting, NotificationSetting.PROTOBUF_ADAPTER);
            }
            UserUpVipSettings userUpVipSettings = settingGroups.upvip;
            if (userUpVipSettings != null) {
                codedOutputByteBufferNano.m17254K(34, userUpVipSettings, UserUpVipSettings.PROTOBUF_ADAPTER);
            }
            AdsMaterialRouter adsMaterialRouter = settingGroups.adsMaterialRouter;
            if (adsMaterialRouter != null) {
                codedOutputByteBufferNano.m17254K(35, adsMaterialRouter, AdsMaterialRouter.PROTOBUF_ADAPTER);
            }
            IntlMoreGender intlMoreGender = settingGroups.gender;
            if (intlMoreGender != null) {
                codedOutputByteBufferNano.m17254K(36, intlMoreGender, IntlMoreGender.PROTOBUF_ADAPTER);
            }
            TribeSetting tribeSetting = settingGroups.tttribe;
            if (tribeSetting != null) {
                codedOutputByteBufferNano.m17254K(37, tribeSetting, TribeSetting.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public SettingGroups mo223809clone() {
        SettingGroups settingGroups = new SettingGroups();
        settingGroups.type = this.type;
        UserBoostSettings userBoostSettings = this.boost;
        if (userBoostSettings != null) {
            settingGroups.boost = userBoostSettings.mo223809clone();
        }
        UserLiveSettings userLiveSettings = this.live;
        if (userLiveSettings != null) {
            settingGroups.live = userLiveSettings.mo223809clone();
        }
        UserPrivacySettings userPrivacySettings = this.privacy;
        if (userPrivacySettings != null) {
            settingGroups.privacy = userPrivacySettings.mo223809clone();
        }
        UserPushSettings userPushSettings = this.push;
        if (userPushSettings != null) {
            settingGroups.push = userPushSettings.mo223809clone();
        }
        UserSearchSettings userSearchSettings = this.search;
        if (userSearchSettings != null) {
            settingGroups.search = userSearchSettings.mo223809clone();
        }
        UserSubscriptionSettings userSubscriptionSettings = this.subscription;
        if (userSubscriptionSettings != null) {
            settingGroups.subscription = userSubscriptionSettings.mo223809clone();
        }
        UserFakeSettings userFakeSettings = this.fake;
        if (userFakeSettings != null) {
            settingGroups.fake = userFakeSettings.mo223809clone();
        }
        UserSVIPSettings userSVIPSettings = this.svip;
        if (userSVIPSettings != null) {
            settingGroups.svip = userSVIPSettings.mo223809clone();
        }
        SvipPrivacySettings svipPrivacySettings = this.svipPrivacy;
        if (svipPrivacySettings != null) {
            settingGroups.svipPrivacy = svipPrivacySettings.mo223809clone();
        }
        SeeSettings seeSettings = this.see;
        if (seeSettings != null) {
            settingGroups.see = seeSettings.mo223809clone();
        }
        DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = this.diamondVIP;
        if (diamondVIPPrivilegeSettings != null) {
            settingGroups.diamondVIP = diamondVIPPrivilegeSettings.mo223809clone();
        }
        DiamondVIPPrivateMatch diamondVIPPrivateMatch = this.diamondVIPPrivateMatch;
        if (diamondVIPPrivateMatch != null) {
            settingGroups.diamondVIPPrivateMatch = diamondVIPPrivateMatch.mo223809clone();
        }
        ChatSetting chatSetting = this.soulchat;
        if (chatSetting != null) {
            settingGroups.soulchat = chatSetting.mo223809clone();
        }
        ChatSetting chatSetting2 = this.quickchatchat;
        if (chatSetting2 != null) {
            settingGroups.quickchatchat = chatSetting2.mo223809clone();
        }
        SoulMatchGroup soulMatchGroup = this.soulmate;
        if (soulMatchGroup != null) {
            settingGroups.soulmate = soulMatchGroup.mo223809clone();
        }
        ShareSetting shareSetting = this.share;
        if (shareSetting != null) {
            settingGroups.share = shareSetting.mo223809clone();
        }
        DecorationSettings decorationSettings = this.decoration;
        if (decorationSettings != null) {
            settingGroups.decoration = decorationSettings.mo223809clone();
        }
        ComDiamond comDiamond = this.comDiamond;
        if (comDiamond != null) {
            settingGroups.comDiamond = comDiamond.mo223809clone();
        }
        CharacterEvaluate characterEvaluate = this.characterEvaluate;
        if (characterEvaluate != null) {
            settingGroups.characterEvaluate = characterEvaluate.mo223809clone();
        }
        Pet pet = this.pet;
        if (pet != null) {
            settingGroups.pet = pet.mo223809clone();
        }
        MomentLevel momentLevel = this.momentLevel;
        if (momentLevel != null) {
            settingGroups.momentLevel = momentLevel.mo223809clone();
        }
        VipSearchSettings vipSearchSettings = this.vipSearch;
        if (vipSearchSettings != null) {
            settingGroups.vipSearch = vipSearchSettings.mo223809clone();
        }
        UserMomentSettings userMomentSettings = this.moment;
        if (userMomentSettings != null) {
            settingGroups.moment = userMomentSettings.mo223809clone();
        }
        SettingGroupsProfile settingGroupsProfile = this.profile;
        if (settingGroupsProfile != null) {
            settingGroups.profile = settingGroupsProfile.mo223809clone();
        }
        PlatinumSettings platinumSettings = this.pvip;
        if (platinumSettings != null) {
            settingGroups.pvip = platinumSettings.mo223809clone();
        }
        MarrySettings marrySettings = this.marriage;
        if (marrySettings != null) {
            settingGroups.marriage = marrySettings.mo223809clone();
        }
        CityC cityC = this.cityC;
        if (cityC != null) {
            settingGroups.cityC = cityC.mo223809clone();
        }
        SpVip spVip = this.spvip;
        if (spVip != null) {
            settingGroups.spvip = spVip.mo223809clone();
        }
        GrowthSettings growthSettings = this.growth;
        if (growthSettings != null) {
            settingGroups.growth = growthSettings.mo223809clone();
        }
        FemaleVip femaleVip = this.fvip;
        if (femaleVip != null) {
            settingGroups.fvip = femaleVip.mo223809clone();
        }
        SvipSearch svipSearch = this.svipSearch;
        if (svipSearch != null) {
            settingGroups.svipSearch = svipSearch.mo223809clone();
        }
        NotificationSetting notificationSetting = this.noPush;
        if (notificationSetting != null) {
            settingGroups.noPush = notificationSetting.mo223809clone();
        }
        AdsMaterialRouter adsMaterialRouter = this.adsMaterialRouter;
        if (adsMaterialRouter != null) {
            settingGroups.adsMaterialRouter = adsMaterialRouter.mo223809clone();
        }
        UserUpVipSettings userUpVipSettings = this.upvip;
        if (userUpVipSettings != null) {
            settingGroups.upvip = userUpVipSettings.mo223809clone();
        }
        IntlMoreGender intlMoreGender = this.gender;
        if (intlMoreGender != null) {
            settingGroups.gender = intlMoreGender.mo223809clone();
        }
        TribeSetting tribeSetting = this.tttribe;
        if (tribeSetting != null) {
            settingGroups.tttribe = tribeSetting.mo223809clone();
        }
        return settingGroups;
    }
    ...
    public boolean hasIntlMoreGenderSetting() {
        if (this.gender.lookingForGenders.size() <= 0) {
            return (NullChecker.m81303a(this.gender.newGender) && !this.gender.newGender.isUnknownType()) || !TextUtils.isEmpty(this.gender.subGender);
        }
        return true;
    }
