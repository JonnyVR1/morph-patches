...
public class WebOfflineData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<WebOfflineData> PROTOBUF_ADAPTER = new MessageNanoAdapter<WebOfflineData>() { // from class: com.p1.mobile.putong.data.WebOfflineData.1
        ...
        public int computeAndCacheSize(WebOfflineData webOfflineData) {
            ...
            int iM17230l = list != null ? CodedOutputByteBufferNano.m17230l(1, list, WebPageOfflineConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            Map<String, String> map = webOfflineData.zips;
            if (map != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            webOfflineData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public WebOfflineData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    webOfflineData.pages = (List) nb5Var.m158743l(WebPageOfflineConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 18) {
                        if (webOfflineData.pages == null) {
                            webOfflineData.pages = new ArrayList();
                    ...
                    webOfflineData.zips = (Map) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
                }
            }
            return webOfflineData;
        }
        ...
        public void serialize(WebOfflineData webOfflineData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<WebPageOfflineConfig> list = webOfflineData.pages;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(1, list, WebPageOfflineConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Map<String, String> map = webOfflineData.zips;
            if (map != null) {
    ...
    public static /* synthetic */ String m60172a(String str) {
        return str;
    }
    ...
    public WebOfflineData mo223809clone() {
        WebOfflineData webOfflineData = new WebOfflineData();
        ...
        if (list != null) {
            webOfflineData.pages = ValueObject.util_map(list, new w9j() { // from class: l.dip0
                ...
                public final Object call(Object obj) {
                    return ((WebPageOfflineConfig) obj).mo223809clone();
                }
            });
        }
        ...
        if (map != null) {
            webOfflineData.zips = ValueObject.util_map(map, new w9j() { // from class: l.eip0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return WebOfflineData.m60172a((String) obj);
                }
            });
        }
        return webOfflineData;
