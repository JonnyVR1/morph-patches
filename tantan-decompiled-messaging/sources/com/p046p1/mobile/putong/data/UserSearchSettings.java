...
public class UserSearchSettings extends ValueObject<UserSearchSettings> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserSearchSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserSearchSettings>() { // from class: com.p1.mobile.putong.data.UserSearchSettings.1
        ...
        public int computeAndCacheSize(UserSearchSettings userSearchSettings) {
            ...
            if (bool2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(2, bool2.booleanValue());
            }
            LookingFor lookingFor = userSearchSettings.lookingForGender;
            if (lookingFor != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(3, lookingFor.ordinal());
            }
            Integer num = userSearchSettings.maxAge;
            if (num != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(4, num.intValue());
            }
            Integer num2 = userSearchSettings.minAge;
            if (num2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(5, num2.intValue());
            }
            Integer num3 = userSearchSettings.ageAllowedMinimum;
            if (num3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(6, num3.intValue());
            }
            Integer num4 = userSearchSettings.ageAllowedMaximum;
            if (num4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(7, num4.intValue());
            }
            List<SearchPriority> list = userSearchSettings.priorities;
            if (list != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(8, SearchPriority.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Integer num5 = userSearchSettings.radius;
            if (num5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(9, num5.intValue());
            }
            Integer num6 = userSearchSettings.radiusAllowedMinimum;
            if (num6 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(10, num6.intValue());
            }
            Integer num7 = userSearchSettings.radiusAllowedMaximum;
            if (num7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(11, num7.intValue());
            }
            Double d = userSearchSettings.roamingLatitude;
            if (d != null) {
                iM17220b += CodedOutputByteBufferNano.m17222d(12, d.doubleValue());
            }
            Double d2 = userSearchSettings.roamingLongitude;
            if (d2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17222d(13, d2.doubleValue());
            }
            Boolean bool3 = userSearchSettings.smartAvatar;
            if (bool3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(14, bool3.booleanValue());
            }
            Boolean bool4 = userSearchSettings.allowSmartAvatarOpen;
            if (bool4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(15, bool4.booleanValue());
            }
            Integer num8 = userSearchSettings.invisibleRadius;
            if (num8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(16, num8.intValue());
            }
            List<Purpose> list2 = userSearchSettings.purpose;
            if (list2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(17, Purpose.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LookingFor lookingFor2 = userSearchSettings.lookingForGender;
            if (lookingFor2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(18, lookingFor2, LookingFor.PROTOBUF_ADAPTER);
            }
            List<SearchPriority> list3 = userSearchSettings.priorities;
            if (list3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(19, list3, SearchPriority.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Purpose> list4 = userSearchSettings.purpose;
            if (list4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(20, list4, Purpose.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list5 = userSearchSettings.friendPurpose;
            if (list5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(21, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            userSearchSettings.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserSearchSettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userSearchSettings.autoAdjustRadius = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 16:
                        userSearchSettings.intelligentAvatar = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 24:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 32:
                        userSearchSettings.maxAge = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 40:
                        userSearchSettings.minAge = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 48:
                        userSearchSettings.ageAllowedMinimum = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 56:
                        userSearchSettings.ageAllowedMaximum = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 66:
                        list = (List) nb5Var.m158743l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 72:
                        userSearchSettings.radius = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 80:
                        userSearchSettings.radiusAllowedMinimum = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 88:
                        userSearchSettings.radiusAllowedMaximum = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case EACTags.APPLICATION_TEMPLATE /* 97 */:
                        userSearchSettings.roamingLatitude = Double.valueOf(nb5Var.m158739h());
                        continue;
                    case 105:
                        userSearchSettings.roamingLongitude = Double.valueOf(nb5Var.m158739h());
                        continue;
                    case 112:
                        userSearchSettings.smartAvatar = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 120:
                        userSearchSettings.allowSmartAvatarOpen = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 128:
                        userSearchSettings.invisibleRadius = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        list2 = (List) nb5Var.m158743l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        userSearchSettings.lookingForGender = (LookingFor) nb5Var.m158743l(LookingFor.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        userSearchSettings.priorities = (List) nb5Var.m158743l(SearchPriority.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 162:
                        userSearchSettings.purpose = (List) nb5Var.m158743l(Purpose.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        userSearchSettings.friendPurpose = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (userSearchSettings.lookingForGender == null && numValueOf != null) {
                            userSearchSettings.lookingForGender = (LookingFor) LookingFor.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(UserSearchSettings userSearchSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Boolean bool2 = userSearchSettings.intelligentAvatar;
            if (bool2 != null) {
                codedOutputByteBufferNano.m17244A(2, bool2.booleanValue());
            }
            LookingFor lookingFor = userSearchSettings.lookingForGender;
            if (lookingFor != null) {
                codedOutputByteBufferNano.m17250G(3, lookingFor.ordinal());
            }
            Integer num = userSearchSettings.maxAge;
            if (num != null) {
                codedOutputByteBufferNano.m17250G(4, num.intValue());
            }
            Integer num2 = userSearchSettings.minAge;
            if (num2 != null) {
                codedOutputByteBufferNano.m17250G(5, num2.intValue());
            }
            Integer num3 = userSearchSettings.ageAllowedMinimum;
            if (num3 != null) {
                codedOutputByteBufferNano.m17250G(6, num3.intValue());
            }
            Integer num4 = userSearchSettings.ageAllowedMaximum;
            if (num4 != null) {
                codedOutputByteBufferNano.m17250G(7, num4.intValue());
            }
            List<SearchPriority> list = userSearchSettings.priorities;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(8, SearchPriority.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Integer num5 = userSearchSettings.radius;
            if (num5 != null) {
                codedOutputByteBufferNano.m17250G(9, num5.intValue());
            }
            Integer num6 = userSearchSettings.radiusAllowedMinimum;
            if (num6 != null) {
                codedOutputByteBufferNano.m17250G(10, num6.intValue());
            }
            Integer num7 = userSearchSettings.radiusAllowedMaximum;
            if (num7 != null) {
                codedOutputByteBufferNano.m17250G(11, num7.intValue());
            }
            Double d = userSearchSettings.roamingLatitude;
            if (d != null) {
                codedOutputByteBufferNano.m17246C(12, d.doubleValue());
            }
            Double d2 = userSearchSettings.roamingLongitude;
            if (d2 != null) {
                codedOutputByteBufferNano.m17246C(13, d2.doubleValue());
            }
            Boolean bool3 = userSearchSettings.smartAvatar;
            if (bool3 != null) {
                codedOutputByteBufferNano.m17244A(14, bool3.booleanValue());
            }
            Boolean bool4 = userSearchSettings.allowSmartAvatarOpen;
            if (bool4 != null) {
                codedOutputByteBufferNano.m17244A(15, bool4.booleanValue());
            }
            Integer num8 = userSearchSettings.invisibleRadius;
            if (num8 != null) {
                codedOutputByteBufferNano.m17250G(16, num8.intValue());
            }
            List<Purpose> list2 = userSearchSettings.purpose;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(17, Purpose.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LookingFor lookingFor2 = userSearchSettings.lookingForGender;
            if (lookingFor2 != null) {
                codedOutputByteBufferNano.m17254K(18, lookingFor2, LookingFor.PROTOBUF_ADAPTER);
            }
            List<SearchPriority> list3 = userSearchSettings.priorities;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(19, list3, SearchPriority.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Purpose> list4 = userSearchSettings.purpose;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(20, list4, Purpose.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list5 = userSearchSettings.friendPurpose;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(21, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m60134a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ SearchPriority m60135b(SearchPriority searchPriority) {
        return searchPriority;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ Purpose m60136c(Purpose purpose) {
        return purpose;
    }
    ...
    public UserSearchSettings mo223809clone() {
        UserSearchSettings userSearchSettings = new UserSearchSettings();
        ...
        if (list != null) {
            userSearchSettings.priorities = ValueObject.util_map(list, new w9j() { // from class: l.b9k0
                ...
                public final Object call(Object obj) {
                    return UserSearchSettings.m60135b((SearchPriority) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            userSearchSettings.purpose = ValueObject.util_map(list2, new w9j() { // from class: l.c9k0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return UserSearchSettings.m60136c((Purpose) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            userSearchSettings.friendPurpose = ValueObject.util_map(list3, new w9j() { // from class: l.d9k0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return UserSearchSettings.m60134a((String) obj);
                }
            });
        }
        return userSearchSettings;
