...
public class MembershipType extends TEnum {
    ...
    static {
        TEnumJsonAdapter<MembershipType> tEnumJsonAdapter = new TEnumJsonAdapter<MembershipType>() { // from class: com.p1.mobile.putong.data.MembershipType.1
        ...
        PROTOBUF_ADAPTER = new TEnumProtobufAdapter<MembershipType>() { // from class: com.p1.mobile.putong.data.MembershipType.2
