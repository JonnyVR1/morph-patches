...
import com.p046p1.mobile.putong.data.NavigationView;
...
public class NavigationView extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NavigationView> PROTOBUF_ADAPTER = new MessageNanoAdapter<NavigationView>() { // from class: com.p1.mobile.putong.data.NavigationView.1
        ...
        public int computeAndCacheSize(NavigationView navigationView) {
            String str = navigationView.f38782id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            NavigationViewPicture navigationViewPicture = navigationView.picture;
            if (navigationViewPicture != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, navigationViewPicture, NavigationViewPicture.PROTOBUF_ADAPTER);
            }
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, list, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            navigationView.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NavigationView parse(nb5 nb5Var) throws IOException {
            NavigationView navigationView = new NavigationView();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (navigationView.f38782id == null) {
                        navigationView.f38782id = "";
                    }
                ...
                if (iM158752u == 10) {
                    navigationView.f38782id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    navigationView.picture = (NavigationViewPicture) nb5Var.m158743l(NavigationViewPicture.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    navigationView.title = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    navigationView.subtitle = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    navigationView.deeplink = nb5Var.m158750s();
                } else {
                    if (iM158752u != 50) {
                        if (navigationView.f38782id == null) {
                            navigationView.f38782id = "";
                    ...
                    navigationView.timeRange = (List) nb5Var.m158743l(ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return navigationView;
        }
        ...
        public void serialize(NavigationView navigationView, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            NavigationViewPicture navigationViewPicture = navigationView.picture;
            if (navigationViewPicture != null) {
                codedOutputByteBufferNano.m17254K(2, navigationViewPicture, NavigationViewPicture.PROTOBUF_ADAPTER);
            }
            String str2 = navigationView.title;
            if (str2 != null) {
            ...
            List<Long> list = navigationView.timeRange;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(6, list, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
        ...
        public boolean parseField(NavigationView navigationView, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "picture":
                    ...
                    return true;
                case "id":
                    navigationView.f38782id = jsonParser.getValueAsString();
                    return false;
                case "timeRange":
    ...
    public static /* synthetic */ Long m59866a(Long l2) {
        return l2;
    }
    ...
    public NavigationView mo223809clone() {
        NavigationView navigationView = new NavigationView();
        navigationView.f38782id = this.f38782id;
        NavigationViewPicture navigationViewPicture = this.picture;
        if (navigationViewPicture != null) {
            navigationView.picture = navigationViewPicture.mo223809clone();
        }
        ...
        if (list != null) {
            navigationView.timeRange = ValueObject.util_map(list, new w9j() { // from class: l.e720
                ...
                public final Object call(Object obj) {
                    return NavigationView.m59866a((Long) obj);
                }
            });
        }
        return navigationView;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38782id, navigationView.f38782id) && ValueObject.util_equals(this.picture, navigationView.picture) && ValueObject.util_equals(this.title, navigationView.title) && ValueObject.util_equals(this.subtitle, navigationView.subtitle) && ValueObject.util_equals(this.deeplink, navigationView.deeplink) && ValueObject.util_equals(this.timeRange, navigationView.timeRange);
    }
