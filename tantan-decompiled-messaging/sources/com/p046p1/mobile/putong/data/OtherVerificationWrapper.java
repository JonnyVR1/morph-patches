...
public class OtherVerificationWrapper extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OtherVerificationWrapper> PROTOBUF_ADAPTER = new MessageNanoAdapter<OtherVerificationWrapper>() { // from class: com.p1.mobile.putong.data.OtherVerificationWrapper.1
        ...
        public int computeAndCacheSize(OtherVerificationWrapper otherVerificationWrapper) {
            ...
            int iM17230l = verificationResult != null ? CodedOutputByteBufferNano.m17230l(1, verificationResult, VerificationResult.PROTOBUF_ADAPTER) : 0;
            VerificationResult verificationResult2 = otherVerificationWrapper.otherDVIPCompany;
            if (verificationResult2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, verificationResult2, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult3 = otherVerificationWrapper.otherDVIPJob;
            if (verificationResult3 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, verificationResult3, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult4 = otherVerificationWrapper.otherDVIPSalary;
            if (verificationResult4 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, verificationResult4, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult5 = otherVerificationWrapper.otherDVIPMembership;
            if (verificationResult5 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, verificationResult5, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult6 = otherVerificationWrapper.otherCTDID;
            if (verificationResult6 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(6, verificationResult6, VerificationResult.PROTOBUF_ADAPTER);
            }
            otherVerificationWrapper.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OtherVerificationWrapper parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    otherVerificationWrapper.otherDVIPSchool = (VerificationResult) nb5Var.m158743l(VerificationResult.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    otherVerificationWrapper.otherDVIPCompany = (VerificationResult) nb5Var.m158743l(VerificationResult.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    otherVerificationWrapper.otherDVIPJob = (VerificationResult) nb5Var.m158743l(VerificationResult.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    otherVerificationWrapper.otherDVIPSalary = (VerificationResult) nb5Var.m158743l(VerificationResult.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    otherVerificationWrapper.otherDVIPMembership = (VerificationResult) nb5Var.m158743l(VerificationResult.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 50) {
                        if (otherVerificationWrapper.otherDVIPSchool == null) {
                            otherVerificationWrapper.otherDVIPSchool = VerificationResult.new_();
                    ...
                    otherVerificationWrapper.otherCTDID = (VerificationResult) nb5Var.m158743l(VerificationResult.PROTOBUF_ADAPTER);
                }
            }
            return otherVerificationWrapper;
        }
        ...
        public void serialize(OtherVerificationWrapper otherVerificationWrapper, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (verificationResult != null) {
                codedOutputByteBufferNano.m17254K(1, verificationResult, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult2 = otherVerificationWrapper.otherDVIPCompany;
            if (verificationResult2 != null) {
                codedOutputByteBufferNano.m17254K(2, verificationResult2, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult3 = otherVerificationWrapper.otherDVIPJob;
            if (verificationResult3 != null) {
                codedOutputByteBufferNano.m17254K(3, verificationResult3, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult4 = otherVerificationWrapper.otherDVIPSalary;
            if (verificationResult4 != null) {
                codedOutputByteBufferNano.m17254K(4, verificationResult4, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult5 = otherVerificationWrapper.otherDVIPMembership;
            if (verificationResult5 != null) {
                codedOutputByteBufferNano.m17254K(5, verificationResult5, VerificationResult.PROTOBUF_ADAPTER);
            }
            VerificationResult verificationResult6 = otherVerificationWrapper.otherCTDID;
            if (verificationResult6 != null) {
                codedOutputByteBufferNano.m17254K(6, verificationResult6, VerificationResult.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public OtherVerificationWrapper mo223809clone() {
        OtherVerificationWrapper otherVerificationWrapper = new OtherVerificationWrapper();
        VerificationResult verificationResult = this.otherDVIPSchool;
        if (verificationResult != null) {
            otherVerificationWrapper.otherDVIPSchool = verificationResult.mo223809clone();
        }
        VerificationResult verificationResult2 = this.otherDVIPCompany;
        if (verificationResult2 != null) {
            otherVerificationWrapper.otherDVIPCompany = verificationResult2.mo223809clone();
        }
        VerificationResult verificationResult3 = this.otherDVIPJob;
        if (verificationResult3 != null) {
            otherVerificationWrapper.otherDVIPJob = verificationResult3.mo223809clone();
        }
        VerificationResult verificationResult4 = this.otherDVIPSalary;
        if (verificationResult4 != null) {
            otherVerificationWrapper.otherDVIPSalary = verificationResult4.mo223809clone();
        }
        VerificationResult verificationResult5 = this.otherDVIPMembership;
        if (verificationResult5 != null) {
            otherVerificationWrapper.otherDVIPMembership = verificationResult5.mo223809clone();
        }
        VerificationResult verificationResult6 = this.otherCTDID;
        if (verificationResult6 != null) {
            otherVerificationWrapper.otherCTDID = verificationResult6.mo223809clone();
        }
        return otherVerificationWrapper;
    }
