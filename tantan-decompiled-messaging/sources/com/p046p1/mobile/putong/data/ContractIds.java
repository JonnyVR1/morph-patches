...
public class ContractIds extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ContractIds> PROTOBUF_ADAPTER = new MessageNanoAdapter<ContractIds>() { // from class: com.p1.mobile.putong.data.ContractIds.1
        ...
        public int computeAndCacheSize(ContractIds contractIds) {
            ...
            contractIds.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ContractIds parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                contractIds.ids = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            return contractIds;
        }
    ...
    public static /* synthetic */ String m59723a(String str) {
        return str;
    }
    ...
    public ContractIds mo223809clone() {
        ContractIds contractIds = new ContractIds();
        ...
        if (list != null) {
            contractIds.ids = ValueObject.util_map(list, new w9j() { // from class: l.t16
                ...
                public final Object call(Object obj) {
                    return ContractIds.m59723a((String) obj);
                }
            });
        }
        return contractIds;
