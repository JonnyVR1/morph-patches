...
import com.p046p1.mobile.putong.data.LiveSquareSummary;
...
public class LiveSquareSummary extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveSquareSummary> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveSquareSummary>() { // from class: com.p1.mobile.putong.data.LiveSquareSummary.1
        ...
        public int computeAndCacheSize(LiveSquareSummary liveSquareSummary) {
            String str = liveSquareSummary.f38775id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            String str2 = liveSquareSummary.description;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(2, str2);
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(3, liveSquareSummary.defaultTabId);
            ...
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(9, liveSquareSummary.isJumpToActivitySquareSummaries);
            liveSquareSummary.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveSquareSummary parse(nb5 nb5Var) throws IOException {
            LiveSquareSummary liveSquareSummary = new LiveSquareSummary();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (liveSquareSummary.f38775id == null) {
                        liveSquareSummary.f38775id = "";
                    }
                ...
                if (iM158752u == 10) {
                    liveSquareSummary.f38775id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    liveSquareSummary.description = nb5Var.m158750s();
                } else if (iM158752u == 24) {
                    liveSquareSummary.defaultTabId = nb5Var.m158741j();
                } else if (iM158752u == 34) {
                    liveSquareSummary.liveIds = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 42) {
                    liveSquareSummary.type = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    liveSquareSummary.extTabId = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    liveSquareSummary.subDescription = nb5Var.m158750s();
                } else if (iM158752u == 66) {
                    liveSquareSummary.style = nb5Var.m158750s();
                } else {
                    if (iM158752u != 72) {
                        if (liveSquareSummary.f38775id == null) {
                            liveSquareSummary.f38775id = "";
                    ...
                    liveSquareSummary.isJumpToActivitySquareSummaries = nb5Var.m158738g();
                }
            }
            return liveSquareSummary;
        }
        ...
        public void serialize(LiveSquareSummary liveSquareSummary, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(3, liveSquareSummary.defaultTabId);
            List<String> list = liveSquareSummary.liveIds;
            if (list != null) {
            ...
            codedOutputByteBufferNano.m17244A(9, liveSquareSummary.isJumpToActivitySquareSummaries);
        }
    };
        ...
        public boolean parseField(LiveSquareSummary liveSquareSummary, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "defaultTabId":
                    ...
                    return true;
                case "id":
                    liveSquareSummary.f38775id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public static /* synthetic */ String m59840a(String str) {
        return str;
    }
    ...
    public LiveSquareSummary mo223809clone() {
        LiveSquareSummary liveSquareSummary = new LiveSquareSummary();
        liveSquareSummary.f38775id = this.f38775id;
        ...
        if (list != null) {
            liveSquareSummary.liveIds = ValueObject.util_map(list, new w9j() { // from class: l.p3u
                ...
                public final Object call(Object obj) {
                    return LiveSquareSummary.m59840a((String) obj);
                }
            });
        }
