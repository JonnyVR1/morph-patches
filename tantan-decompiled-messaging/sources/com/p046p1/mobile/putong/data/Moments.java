...
public class Moments extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Moments> PROTOBUF_ADAPTER = new MessageNanoAdapter<Moments>() { // from class: com.p1.mobile.putong.data.Moments.1
        ...
        public int computeAndCacheSize(Moments moments) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, moments.hidePublicMoments);
            MomentCounter momentCounter = moments.counters;
            if (momentCounter != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(2, momentCounter, MomentCounter.PROTOBUF_ADAPTER);
            }
            moments.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Moments parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    moments.hidePublicMoments = nb5Var.m158738g();
                } else {
                    if (iM158752u != 18) {
                        if (moments.counters != null) {
                            break;
                    ...
                    moments.counters = (MomentCounter) nb5Var.m158743l(MomentCounter.PROTOBUF_ADAPTER);
                }
            }
            return moments;
        }
        ...
        public void serialize(Moments moments, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, moments.hidePublicMoments);
            MomentCounter momentCounter = moments.counters;
            if (momentCounter != null) {
                codedOutputByteBufferNano.m17254K(2, momentCounter, MomentCounter.PROTOBUF_ADAPTER);
            }
        }
    };
