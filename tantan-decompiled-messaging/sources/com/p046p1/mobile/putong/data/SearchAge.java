...
public class SearchAge extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SearchAge> PROTOBUF_ADAPTER = new MessageNanoAdapter<SearchAge>() { // from class: com.p1.mobile.putong.data.SearchAge.1
        ...
        public int computeAndCacheSize(SearchAge searchAge) {
            ...
            if (num2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(2, num2.intValue());
            }
            Integer num3 = searchAge.minimum;
            if (num3 != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(3, num3.intValue());
            }
            Integer num4 = searchAge.maximum;
            if (num4 != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(4, num4.intValue());
            }
            searchAge.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SearchAge parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    searchAge.allowedMinimum = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 16) {
                    searchAge.allowedMaximum = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 24) {
                    searchAge.minimum = Integer.valueOf(nb5Var.m158741j());
                } else {
                    if (iM158752u != 32) {
                        if (searchAge.allowedMinimum == null) {
                            searchAge.allowedMinimum = 0;
                    ...
                    searchAge.maximum = Integer.valueOf(nb5Var.m158741j());
                }
            }
            return searchAge;
        }
        ...
        public void serialize(SearchAge searchAge, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Integer num2 = searchAge.allowedMaximum;
            if (num2 != null) {
                codedOutputByteBufferNano.m17250G(2, num2.intValue());
            }
            Integer num3 = searchAge.minimum;
            if (num3 != null) {
                codedOutputByteBufferNano.m17250G(3, num3.intValue());
            }
            Integer num4 = searchAge.maximum;
            if (num4 != null) {
                codedOutputByteBufferNano.m17250G(4, num4.intValue());
            }
        }
    };
    ...
    public SearchAge mo223809clone() {
        SearchAge searchAge = new SearchAge();
