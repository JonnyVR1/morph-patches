...
public class Contract extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Contract> PROTOBUF_ADAPTER = new MessageNanoAdapter<Contract>() { // from class: com.p1.mobile.putong.data.Contract.1
        ...
        public int computeAndCacheSize(Contract contract) {
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(6, contract.signTime);
            ContractProductType contractProductType = contract.productType;
            if (contractProductType != null) {
                iM17222d += CodedOutputByteBufferNano.m17226h(7, contractProductType.ordinal());
            }
            int iM17226h = iM17222d + CodedOutputByteBufferNano.m17226h(8, contract.signVersion) + CodedOutputByteBufferNano.m17222d(9, contract.nextDeductTime);
            ...
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(11, list, Promotions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ContractProductType contractProductType2 = contract.productType;
            if (contractProductType2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(12, contractProductType2, ContractProductType.PROTOBUF_ADAPTER);
            }
            contract.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Contract parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        contract.f38735id = nb5Var.m158750s();
                        continue;
                    case 18:
                        contract.platform = nb5Var.m158750s();
                        continue;
                    case 26:
                        contract.contractStatus = nb5Var.m158750s();
                        continue;
                    case 34:
                        contract.itemId = nb5Var.m158750s();
                        continue;
                    case 42:
                        contract.itemName = nb5Var.m158750s();
                        continue;
                    case 49:
                        contract.signTime = nb5Var.m158739h();
                        continue;
                    case 56:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 64:
                        contract.signVersion = nb5Var.m158741j();
                        continue;
                    case EACTags.CARDHOLDER_PUBLIC_KEY_TEMPLATE /* 73 */:
                        contract.nextDeductTime = nb5Var.m158739h();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        contract.nextDuductMoney = nb5Var.m158750s();
                        continue;
                    case 90:
                        contract.promotions = (List) nb5Var.m158743l(Promotions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        contract.productType = (ContractProductType) nb5Var.m158743l(ContractProductType.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (contract.productType == null && numValueOf != null) {
                            contract.productType = (ContractProductType) ContractProductType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Contract contract, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(6, contract.signTime);
            ContractProductType contractProductType = contract.productType;
            if (contractProductType != null) {
                codedOutputByteBufferNano.m17250G(7, contractProductType.ordinal());
            }
            codedOutputByteBufferNano.m17250G(8, contract.signVersion);
            codedOutputByteBufferNano.m17246C(9, contract.nextDeductTime);
            String str6 = contract.nextDuductMoney;
            if (str6 != null) {
            ...
            List<Promotions> list = contract.promotions;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(11, list, Promotions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ContractProductType contractProductType2 = contract.productType;
            if (contractProductType2 != null) {
                codedOutputByteBufferNano.m17254K(12, contractProductType2, ContractProductType.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Contract contract, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "nextDuductMoney":
                    ...
                    return true;
                case "id":
                    contract.f38735id = jsonParser.getValueAsString();
                    return false;
                case "nextDeductTime":
    ...
    public Contract mo223809clone() {
        Contract contract = new Contract();
        contract.f38735id = this.f38735id;
        ...
        if (list != null) {
            contract.promotions = ValueObject.util_map(list, new w9j() { // from class: l.r16
                ...
                public final Object call(Object obj) {
                    return ((Promotions) obj).mo223809clone();
                }
            });
        }
        return contract;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38735id, contract.f38735id) && ValueObject.util_equals(this.platform, contract.platform) && ValueObject.util_equals(this.contractStatus, contract.contractStatus) && ValueObject.util_equals(this.itemId, contract.itemId) && ValueObject.util_equals(this.itemName, contract.itemName) && this.signTime == contract.signTime && ValueObject.util_equals(this.productType, contract.productType) && this.signVersion == contract.signVersion && this.nextDeductTime == contract.nextDeductTime && ValueObject.util_equals(this.nextDuductMoney, contract.nextDuductMoney) && ValueObject.util_equals(this.promotions, contract.promotions);
    }
