...
public class FacebookData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FacebookData> PROTOBUF_ADAPTER = new MessageNanoAdapter<FacebookData>() { // from class: com.p1.mobile.putong.data.FacebookData.1
        ...
        public int computeAndCacheSize(FacebookData facebookData) {
            ...
            int iM17230l = facebookUserInfo != null ? CodedOutputByteBufferNano.m17230l(1, facebookUserInfo, FacebookUserInfo.PROTOBUF_ADAPTER) : 0;
            facebookData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FacebookData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                facebookData.user = (FacebookUserInfo) nb5Var.m158743l(FacebookUserInfo.PROTOBUF_ADAPTER);
            }
            return facebookData;
        }
        ...
        public void serialize(FacebookData facebookData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (facebookUserInfo != null) {
                codedOutputByteBufferNano.m17254K(1, facebookUserInfo, FacebookUserInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FacebookData mo223809clone() {
        FacebookData facebookData = new FacebookData();
        FacebookUserInfo facebookUserInfo = this.user;
        if (facebookUserInfo != null) {
            facebookData.user = facebookUserInfo.mo223809clone();
        }
        return facebookData;
    }
