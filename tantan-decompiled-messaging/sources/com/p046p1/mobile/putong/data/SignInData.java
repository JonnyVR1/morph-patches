...
public class SignInData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SignInData> PROTOBUF_ADAPTER = new MessageNanoAdapter<SignInData>() { // from class: com.p1.mobile.putong.data.SignInData.1
        ...
        public int computeAndCacheSize(SignInData signInData) {
            ...
            if (num != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(4, num.intValue());
            }
            Device device = signInData.device;
            if (device != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(5, device, Device.PROTOBUF_ADAPTER);
            }
            ...
            if (signInGrantType2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(12, signInGrantType2, SignInGrantType.PROTOBUF_ADAPTER);
            }
            ...
            signInData.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SignInData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    ...
                    case 8:
                        ...
                        continue;
                    case 18:
                        signInData.username = nb5Var.m158750s();
                        continue;
                    case 26:
                        signInData.password = nb5Var.m158750s();
                        continue;
                    case 32:
                        signInData.code = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 42:
                        signInData.device = (Device) nb5Var.m158743l(Device.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        signInData.thirdPartyId = nb5Var.m158750s();
                        continue;
                    case 58:
                        signInData.thirdPartyToken = nb5Var.m158750s();
                        continue;
                    case 66:
                        signInData.scope = nb5Var.m158750s();
                        continue;
                    case 74:
                        signInData.operator = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        signInData.captchaToken = nb5Var.m158750s();
                        continue;
                    case 90:
                        signInData.captchaValue = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        signInData.grantType = (SignInGrantType) nb5Var.m158743l(SignInGrantType.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        signInData.thirdPartyAccessCode = nb5Var.m158750s();
                        continue;
                    case 114:
                        signInData.ttcToken = nb5Var.m158750s();
                        continue;
                    case 122:
                        signInData.thirdEmail = nb5Var.m158750s();
                        continue;
                    case 130:
                        signInData.verifyType = nb5Var.m158750s();
                        continue;
                    default:
                        if (signInData.grantType == null && numValueOf != null) {
                            signInData.grantType = (SignInGrantType) SignInGrantType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(SignInData signInData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Device device = signInData.device;
            if (device != null) {
                codedOutputByteBufferNano.m17254K(5, device, Device.PROTOBUF_ADAPTER);
            }
            String str3 = signInData.thirdPartyId;
            if (str3 != null) {
            ...
            SignInGrantType signInGrantType2 = signInData.grantType;
            if (signInGrantType2 != null) {
                codedOutputByteBufferNano.m17254K(12, signInGrantType2, SignInGrantType.PROTOBUF_ADAPTER);
            }
            String str9 = signInData.thirdPartyAccessCode;
            if (str9 != null) {
    ...
    public SignInData mo223809clone() {
        SignInData signInData = new SignInData();
        ...
        if (device != null) {
            signInData.device = device.mo223809clone();
        }
