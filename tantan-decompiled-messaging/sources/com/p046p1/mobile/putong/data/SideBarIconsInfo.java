...
public class SideBarIconsInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SideBarIconsInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<SideBarIconsInfo>() { // from class: com.p1.mobile.putong.data.SideBarIconsInfo.1
        ...
        public int computeAndCacheSize(SideBarIconsInfo sideBarIconsInfo) {
            ...
            int iM17230l = navigationViewPicture != null ? CodedOutputByteBufferNano.m17230l(1, navigationViewPicture, NavigationViewPicture.PROTOBUF_ADAPTER) : 0;
            ...
            if (list != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(5, list, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = sideBarIconsInfo.slideshowSec;
            if (str4 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(6, str4);
            }
            String str5 = sideBarIconsInfo.f38814id;
            if (str5 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(7, str5);
            }
            int iM17220b = iM17230l + CodedOutputByteBufferNano.m17220b(8, sideBarIconsInfo.redDotSwitch);
            sideBarIconsInfo.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SideBarIconsInfo parse(nb5 nb5Var) throws IOException {
            SideBarIconsInfo sideBarIconsInfo = new SideBarIconsInfo();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (sideBarIconsInfo.f38814id == null) {
                        sideBarIconsInfo.f38814id = "";
                    }
                ...
                if (iM158752u == 10) {
                    sideBarIconsInfo.picture = (NavigationViewPicture) nb5Var.m158743l(NavigationViewPicture.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    sideBarIconsInfo.title = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    sideBarIconsInfo.subtitle = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    sideBarIconsInfo.deeplink = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    sideBarIconsInfo.timeRange = (List) nb5Var.m158743l(ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 50) {
                    sideBarIconsInfo.slideshowSec = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    sideBarIconsInfo.f38814id = nb5Var.m158750s();
                } else {
                    if (iM158752u != 64) {
                        if (sideBarIconsInfo.f38814id == null) {
                            sideBarIconsInfo.f38814id = "";
                    ...
                    sideBarIconsInfo.redDotSwitch = nb5Var.m158738g();
                }
            }
            return sideBarIconsInfo;
        }
        ...
        public void serialize(SideBarIconsInfo sideBarIconsInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (navigationViewPicture != null) {
                codedOutputByteBufferNano.m17254K(1, navigationViewPicture, NavigationViewPicture.PROTOBUF_ADAPTER);
            }
            String str = sideBarIconsInfo.title;
            if (str != null) {
            ...
            List<Long> list = sideBarIconsInfo.timeRange;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(5, list, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = sideBarIconsInfo.slideshowSec;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17244A(8, sideBarIconsInfo.redDotSwitch);
        }
    };
    public static JsonAdapter<SideBarIconsInfo> JSON_ADAPTER = new ObjectJsonAdapter<SideBarIconsInfo>() { // from class: com.p1.mobile.putong.data.SideBarIconsInfo.2
        ...
        public boolean parseField(SideBarIconsInfo sideBarIconsInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "picture":
                    ...
                    return true;
                case "id":
                    sideBarIconsInfo.f38814id = jsonParser.getValueAsString();
                    return false;
                case "timeRange":
        ...
        public void serializeFields(SideBarIconsInfo sideBarIconsInfo, JsonGenerator jsonGenerator) throws IOException {
            String str = sideBarIconsInfo.f38814id;
            if (str != null) {
    ...
    public static /* synthetic */ Long m60087a(Long l2) {
        return l2;
    }
    ...
    public SideBarIconsInfo mo223809clone() {
        SideBarIconsInfo sideBarIconsInfo = new SideBarIconsInfo();
        sideBarIconsInfo.f38814id = this.f38814id;
        NavigationViewPicture navigationViewPicture = this.picture;
        if (navigationViewPicture != null) {
            sideBarIconsInfo.picture = navigationViewPicture.mo223809clone();
        }
        ...
        if (list != null) {
            sideBarIconsInfo.timeRange = ValueObject.util_map(list, new w9j() { // from class: l.a1f0
                ...
                public final Object call(Object obj) {
                    return SideBarIconsInfo.m60087a((Long) obj);
                }
            });
        }
