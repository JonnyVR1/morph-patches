...
public class OrderData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OrderData> PROTOBUF_ADAPTER = new MessageNanoAdapter<OrderData>() { // from class: com.p1.mobile.putong.data.OrderData.1
        ...
        public int computeAndCacheSize(OrderData orderData) {
            ...
            if (order != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, order, Order.PROTOBUF_ADAPTER);
            }
            orderData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OrderData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    orderData.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (orderData.meta == null) {
                            orderData.meta = Meta.new_();
                    ...
                    orderData.data = (Order) nb5Var.m158743l(Order.PROTOBUF_ADAPTER);
                }
            }
            return orderData;
        }
        ...
        public void serialize(OrderData orderData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Order order = orderData.data;
            if (order != null) {
                codedOutputByteBufferNano.m17254K(2, order, Order.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public OrderData mo223809clone() {
        OrderData orderData = new OrderData();
        Meta meta = this.meta;
        if (meta != null) {
            orderData.meta = meta.mo223809clone();
        }
        Order order = this.data;
        if (order != null) {
            orderData.data = order.mo223809clone();
        }
        return orderData;
    }
