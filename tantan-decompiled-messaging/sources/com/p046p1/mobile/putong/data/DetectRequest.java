...
public class DetectRequest extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DetectRequest> PROTOBUF_ADAPTER = new MessageNanoAdapter<DetectRequest>() { // from class: com.p1.mobile.putong.data.DetectRequest.1
        ...
        public int computeAndCacheSize(DetectRequest detectRequest) {
            ...
            int iM17230l = detectCategoryType != null ? CodedOutputByteBufferNano.m17230l(1, detectCategoryType, DetectCategoryType.PROTOBUF_ADAPTER) : 0;
            List<DetectText> list = detectRequest.text;
            if (list != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, list, DetectText.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<DetectMedia> list2 = detectRequest.media;
            if (list2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, list2, DetectMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            detectRequest.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DetectRequest parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    detectRequest.category = (DetectCategoryType) nb5Var.m158743l(DetectCategoryType.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    detectRequest.text = (List) nb5Var.m158743l(DetectText.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 26) {
                        if (detectRequest.category == null) {
                            detectRequest.category = (DetectCategoryType) DetectCategoryType.JSON_ADAPTER.defaultEnum();
                    ...
                    detectRequest.media = (List) nb5Var.m158743l(DetectMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return detectRequest;
        }
        ...
        public void serialize(DetectRequest detectRequest, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (detectCategoryType != null) {
                codedOutputByteBufferNano.m17254K(1, detectCategoryType, DetectCategoryType.PROTOBUF_ADAPTER);
            }
            List<DetectText> list = detectRequest.text;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(2, list, DetectText.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<DetectMedia> list2 = detectRequest.media;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(3, list2, DetectMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public DetectRequest mo223809clone() {
        DetectRequest detectRequest = new DetectRequest();
