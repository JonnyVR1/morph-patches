...
public class UserLiveState extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserLiveState> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserLiveState>() { // from class: com.p1.mobile.putong.data.UserLiveState.1
        ...
        public int computeAndCacheSize(UserLiveState userLiveState) {
            ...
            int iM17226h = liveState != null ? CodedOutputByteBufferNano.m17226h(1, liveState.ordinal()) : 0;
            ...
            if (userLiveCallInfo != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(3, userLiveCallInfo, UserLiveCallInfo.PROTOBUF_ADAPTER);
            }
            UserLiveLabel userLiveLabel = userLiveState.liveLabel;
            if (userLiveLabel != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, userLiveLabel, UserLiveLabel.PROTOBUF_ADAPTER);
            }
            ...
            if (liveState2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(6, liveState2, LiveState.PROTOBUF_ADAPTER);
            }
            LiveMultiCallInfo liveMultiCallInfo = userLiveState.multiCallInfo;
            if (liveMultiCallInfo != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(7, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
            userLiveState.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserLiveState parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    ...
                    userLiveState.liveId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    userLiveState.callInfo = (UserLiveCallInfo) nb5Var.m158743l(UserLiveCallInfo.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    userLiveState.liveLabel = (UserLiveLabel) nb5Var.m158743l(UserLiveLabel.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    userLiveState.cityId = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    userLiveState.state = (LiveState) nb5Var.m158743l(LiveState.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 58) {
                        if (userLiveState.state == null && numValueOf != null) {
                            userLiveState.state = (LiveState) LiveState.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    userLiveState.multiCallInfo = (LiveMultiCallInfo) nb5Var.m158743l(LiveMultiCallInfo.PROTOBUF_ADAPTER);
                }
            }
            return userLiveState;
        }
        ...
        public void serialize(UserLiveState userLiveState, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            LiveState liveState = userLiveState.state;
            if (liveState != null) {
                codedOutputByteBufferNano.m17250G(1, liveState.ordinal());
            }
            String str = userLiveState.liveId;
            if (str != null) {
            ...
            UserLiveCallInfo userLiveCallInfo = userLiveState.callInfo;
            if (userLiveCallInfo != null) {
                codedOutputByteBufferNano.m17254K(3, userLiveCallInfo, UserLiveCallInfo.PROTOBUF_ADAPTER);
            }
            UserLiveLabel userLiveLabel = userLiveState.liveLabel;
            if (userLiveLabel != null) {
                codedOutputByteBufferNano.m17254K(4, userLiveLabel, UserLiveLabel.PROTOBUF_ADAPTER);
            }
            String str2 = userLiveState.cityId;
            if (str2 != null) {
            ...
            LiveState liveState2 = userLiveState.state;
            if (liveState2 != null) {
                codedOutputByteBufferNano.m17254K(6, liveState2, LiveState.PROTOBUF_ADAPTER);
            }
            LiveMultiCallInfo liveMultiCallInfo = userLiveState.multiCallInfo;
            if (liveMultiCallInfo != null) {
                codedOutputByteBufferNano.m17254K(7, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
        }
    };
