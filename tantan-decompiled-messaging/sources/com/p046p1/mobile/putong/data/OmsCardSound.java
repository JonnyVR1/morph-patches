...
import com.p046p1.mobile.putong.data.OmsCardSound;
...
public class OmsCardSound extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OmsCardSound> PROTOBUF_ADAPTER = new MessageNanoAdapter<OmsCardSound>() { // from class: com.p1.mobile.putong.data.OmsCardSound.1
        ...
        public int computeAndCacheSize(OmsCardSound omsCardSound) {
            ...
            omsCardSound.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OmsCardSound parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    omsCardSound.pictures = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 18) {
                    omsCardSound.color = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    omsCardSound.topLeftTags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 34) {
                    omsCardSound.icons = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 42) {
                    omsCardSound.title = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    omsCardSound.description = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (omsCardSound.pictures == null) {
                            omsCardSound.pictures = new ArrayList();
                    ...
                    omsCardSound.button = (Action) nb5Var.m158743l(Action.PROTOBUF_ADAPTER);
                }
            }
            return omsCardSound;
        }
    ...
    public static /* synthetic */ String m59959a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m59960b(String str) {
        return str;
    }
    ...
    public OmsCardSound mo223809clone() {
        OmsCardSound omsCardSound = new OmsCardSound();
        ...
        if (list2 != null) {
            omsCardSound.topLeftTags = ValueObject.util_map(list2, new w9j() { // from class: l.ma50
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OmsCardSound.m59960b((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            omsCardSound.icons = ValueObject.util_map(list3, new w9j() { // from class: l.na50
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OmsCardSound.m59959a((String) obj);
                }
            });
        }
        ...
        if (action != null) {
            omsCardSound.button = action.mo223809clone();
        }
        return omsCardSound;
    }
