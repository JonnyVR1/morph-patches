...
import com.p046p1.mobile.putong.data.LiveBasicLabel;
import com.p046p1.mobile.putong.data.LiveSpecialLabel;
...
public class Live extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Live> PROTOBUF_ADAPTER = new MessageNanoAdapter<Live>() { // from class: com.p1.mobile.putong.data.Live.1
        ...
        public int computeAndCacheSize(Live live) {
            ...
            if (owner2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, owner2, Owner.PROTOBUF_ADAPTER);
            }
            StreamUrl streamUrl = live.streamUrl;
            if (streamUrl != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, streamUrl, StreamUrl.PROTOBUF_ADAPTER);
            }
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(5, live.rewardPoint) + CodedOutputByteBufferNano.m17222d(6, live.memberCount);
            Media media = live.snapshot;
            if (media != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(7, media, Media.PROTOBUF_ADAPTER);
            }
            int iM17222d2 = iM17222d + CodedOutputByteBufferNano.m17222d(8, live.startTime);
            LiveState liveState = live.state;
            if (liveState != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17226h(9, liveState.ordinal());
            }
            String str2 = live.type;
            if (str2 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(10, str2);
            }
            List<LiveBasicLabel> list = live.basicLabels;
            if (list != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17230l(11, list, LiveBasicLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<LiveSpecialLabel> list2 = live.specialLabels;
            if (list2 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17230l(12, list2, LiveSpecialLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17222d3 = iM17222d2 + CodedOutputByteBufferNano.m17222d(13, live.endTime) + CodedOutputByteBufferNano.m17228j(14, live.messageCount) + CodedOutputByteBufferNano.m17222d(15, live.rewarderCount);
            StreamCdnInfo streamCdnInfo = live.streamCdnInfo;
            if (streamCdnInfo != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(16, streamCdnInfo, StreamCdnInfo.PROTOBUF_ADAPTER);
            }
            RecommendInfo recommendInfo = live.recommendInfo;
            if (recommendInfo != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(17, recommendInfo, RecommendInfo.PROTOBUF_ADAPTER);
            }
            String str3 = live.source;
            if (str3 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17233o(18, str3);
            }
            Media media2 = live.videoCapture;
            if (media2 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(19, media2, Media.PROTOBUF_ADAPTER);
            }
            List<String> list3 = live.redPacketIds;
            if (list3 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(20, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = live.callback;
            if (str4 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17233o(21, str4);
            }
            int iM17220b = iM17222d3 + CodedOutputByteBufferNano.m17220b(22, live.whetherToBlur);
            Media media3 = live.coverPicUrl;
            if (media3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(23, media3, Media.PROTOBUF_ADAPTER);
            }
            LiveState liveState2 = live.state;
            if (liveState2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(24, liveState2, LiveState.PROTOBUF_ADAPTER);
            }
            live.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Live parse(nb5 nb5Var) throws IOException {
            Live live = new Live();
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        live.f38767id = nb5Var.m158750s();
                        continue;
                    case 18:
                        live.room = (Owner) nb5Var.m158743l(Owner.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        live.anchor = (Owner) nb5Var.m158743l(Owner.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        live.streamUrl = (StreamUrl) nb5Var.m158743l(StreamUrl.PROTOBUF_ADAPTER);
                        continue;
                    case 41:
                        live.rewardPoint = nb5Var.m158739h();
                        continue;
                    case 49:
                        live.memberCount = nb5Var.m158739h();
                        continue;
                    case 58:
                        live.snapshot = (Media) nb5Var.m158743l(Media.PROTOBUF_ADAPTER);
                        continue;
                    case 65:
                        live.startTime = nb5Var.m158739h();
                        continue;
                    case 72:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        live.type = nb5Var.m158750s();
                        continue;
                    case 90:
                        live.basicLabels = (List) nb5Var.m158743l(LiveBasicLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        live.specialLabels = (List) nb5Var.m158743l(LiveSpecialLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 105:
                        live.endTime = nb5Var.m158739h();
                        continue;
                    case 112:
                        live.messageCount = nb5Var.m158742k();
                        continue;
                    case 121:
                        live.rewarderCount = nb5Var.m158739h();
                        continue;
                    case 130:
                        live.streamCdnInfo = (StreamCdnInfo) nb5Var.m158743l(StreamCdnInfo.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        live.recommendInfo = (RecommendInfo) nb5Var.m158743l(RecommendInfo.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        live.source = nb5Var.m158750s();
                        continue;
                    case 154:
                        live.videoCapture = (Media) nb5Var.m158743l(Media.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        live.redPacketIds = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        live.callback = nb5Var.m158750s();
                        continue;
                    case 176:
                        live.whetherToBlur = nb5Var.m158738g();
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        live.coverPicUrl = (Media) nb5Var.m158743l(Media.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        live.state = (LiveState) nb5Var.m158743l(LiveState.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (live.state == null && numValueOf != null) {
                            live.state = (LiveState) LiveState.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Live live, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Owner owner2 = live.anchor;
            if (owner2 != null) {
                codedOutputByteBufferNano.m17254K(3, owner2, Owner.PROTOBUF_ADAPTER);
            }
            StreamUrl streamUrl = live.streamUrl;
            if (streamUrl != null) {
                codedOutputByteBufferNano.m17254K(4, streamUrl, StreamUrl.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(5, live.rewardPoint);
            codedOutputByteBufferNano.m17246C(6, live.memberCount);
            Media media = live.snapshot;
            if (media != null) {
                codedOutputByteBufferNano.m17254K(7, media, Media.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(8, live.startTime);
            LiveState liveState = live.state;
            if (liveState != null) {
                codedOutputByteBufferNano.m17250G(9, liveState.ordinal());
            }
            String str2 = live.type;
            if (str2 != null) {
            ...
            List<LiveBasicLabel> list = live.basicLabels;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(11, list, LiveBasicLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<LiveSpecialLabel> list2 = live.specialLabels;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(12, list2, LiveSpecialLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17246C(13, live.endTime);
            codedOutputByteBufferNano.m17252I(14, live.messageCount);
            codedOutputByteBufferNano.m17246C(15, live.rewarderCount);
            StreamCdnInfo streamCdnInfo = live.streamCdnInfo;
            if (streamCdnInfo != null) {
                codedOutputByteBufferNano.m17254K(16, streamCdnInfo, StreamCdnInfo.PROTOBUF_ADAPTER);
            }
            RecommendInfo recommendInfo = live.recommendInfo;
            if (recommendInfo != null) {
                codedOutputByteBufferNano.m17254K(17, recommendInfo, RecommendInfo.PROTOBUF_ADAPTER);
            }
            String str3 = live.source;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(18, str3);
            }
            Media media2 = live.videoCapture;
            if (media2 != null) {
                codedOutputByteBufferNano.m17254K(19, media2, Media.PROTOBUF_ADAPTER);
            }
            List<String> list3 = live.redPacketIds;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(20, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = live.callback;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(21, str4);
            }
            codedOutputByteBufferNano.m17244A(22, live.whetherToBlur);
            Media media3 = live.coverPicUrl;
            if (media3 != null) {
                codedOutputByteBufferNano.m17254K(23, media3, Media.PROTOBUF_ADAPTER);
            }
            LiveState liveState2 = live.state;
            if (liveState2 != null) {
                codedOutputByteBufferNano.m17254K(24, liveState2, LiveState.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Live live, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 11:
                    ...
                    return true;
                case 12:
                    live.f38767id = jsonParser.getValueAsString();
                    return false;
                case 13:
    ...
    public static /* synthetic */ String m59827b(String str) {
        return str;
    }
    ...
    public Live mo223809clone() {
        Live live = new Live();
        live.f38767id = this.f38767id;
        Owner owner = this.room;
        if (owner != null) {
            live.room = owner.mo223809clone();
        }
        Owner owner2 = this.anchor;
        if (owner2 != null) {
            live.anchor = owner2.mo223809clone();
        }
        StreamUrl streamUrl = this.streamUrl;
        if (streamUrl != null) {
            live.streamUrl = streamUrl.mo223809clone();
        }
        live.rewardPoint = this.rewardPoint;
        live.memberCount = this.memberCount;
        Media media = this.snapshot;
        if (media != null) {
            live.snapshot = media.mo223809clone();
        }
        ...
        if (list != null) {
            live.basicLabels = ValueObject.util_map(list, new w9j() { // from class: l.ior
                ...
                public final Object call(Object obj) {
                    return ((LiveBasicLabel) obj).mo223809clone();
                }
            });
        }
        ...
        if (list2 != null) {
            live.specialLabels = ValueObject.util_map(list2, new w9j() { // from class: l.jor
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((LiveSpecialLabel) obj).mo223809clone();
                }
            });
        }
        ...
        if (streamCdnInfo != null) {
            live.streamCdnInfo = streamCdnInfo.mo223809clone();
        }
        RecommendInfo recommendInfo = this.recommendInfo;
        if (recommendInfo != null) {
            live.recommendInfo = recommendInfo.mo223809clone();
        }
        live.source = this.source;
        Media media2 = this.videoCapture;
        if (media2 != null) {
            live.videoCapture = media2.mo223809clone();
        }
        ...
        if (list3 != null) {
            live.redPacketIds = ValueObject.util_map(list3, new w9j() { // from class: l.kor
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Live.m59827b((String) obj);
                }
            });
        }
        ...
        if (media3 != null) {
            live.coverPicUrl = media3.mo223809clone();
        }
        return live;
    }
