...
public class OmsCardLiterature extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OmsCardLiterature> PROTOBUF_ADAPTER = new MessageNanoAdapter<OmsCardLiterature>() { // from class: com.p1.mobile.putong.data.OmsCardLiterature.1
        ...
        public int computeAndCacheSize(OmsCardLiterature omsCardLiterature) {
            ...
            if (list4 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(10, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<Action> list5 = omsCardLiterature.buttons;
            if (list5 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(11, list5, Action.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = omsCardLiterature.literatureID;
            if (str7 != null) {
                iM17230l += CodedOutputByteBufferNano.m17233o(12, str7);
            }
            omsCardLiterature.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OmsCardLiterature parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        omsCardLiterature.pictures = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        omsCardLiterature.color = nb5Var.m158750s();
                        continue;
                    case 26:
                        omsCardLiterature.topLeftTags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        omsCardLiterature.icons = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        omsCardLiterature.title = nb5Var.m158750s();
                        continue;
                    case 50:
                        omsCardLiterature.guidance = nb5Var.m158750s();
                        continue;
                    case 58:
                        omsCardLiterature.introduction = nb5Var.m158750s();
                        continue;
                    case 66:
                        omsCardLiterature.name = nb5Var.m158750s();
                        continue;
                    case 74:
                        omsCardLiterature.type = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        omsCardLiterature.author = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        omsCardLiterature.buttons = (List) nb5Var.m158743l(Action.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        omsCardLiterature.literatureID = nb5Var.m158750s();
                        continue;
                    default:
                        if (omsCardLiterature.pictures == null) {
                            omsCardLiterature.pictures = new ArrayList();
        ...
        public void serialize(OmsCardLiterature omsCardLiterature, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<String> list4 = omsCardLiterature.author;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(10, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<Action> list5 = omsCardLiterature.buttons;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(11, list5, Action.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = omsCardLiterature.literatureID;
            if (str7 != null) {
    ...
    public static /* synthetic */ String m59954a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m59956c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m59958e(String str) {
        return str;
    }
    ...
    public OmsCardLiterature mo223809clone() {
        OmsCardLiterature omsCardLiterature = new OmsCardLiterature();
        ...
        if (list2 != null) {
            omsCardLiterature.topLeftTags = ValueObject.util_map(list2, new w9j() { // from class: l.ha50
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OmsCardLiterature.m59958e((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            omsCardLiterature.icons = ValueObject.util_map(list3, new w9j() { // from class: l.ia50
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OmsCardLiterature.m59956c((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            omsCardLiterature.author = ValueObject.util_map(list4, new w9j() { // from class: l.ja50
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OmsCardLiterature.m59954a((String) obj);
                }
            });
        }
        ...
        if (list5 != null) {
            omsCardLiterature.buttons = ValueObject.util_map(list5, new w9j() { // from class: l.ka50
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((Action) obj).mo223809clone();
                }
            });
        }
