...
public class SwipeExcites extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SwipeExcites> PROTOBUF_ADAPTER = new MessageNanoAdapter<SwipeExcites>() { // from class: com.p1.mobile.putong.data.SwipeExcites.1
        ...
        public int computeAndCacheSize(SwipeExcites swipeExcites) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, swipeExcites.taskSwitch);
            SwipeConfig swipeConfig = swipeExcites.swipeConfig;
            if (swipeConfig != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(2, swipeConfig, SwipeConfig.PROTOBUF_ADAPTER);
            }
            String str = swipeExcites.deepLink;
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(3, str);
            }
            swipeExcites.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SwipeExcites parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    swipeExcites.taskSwitch = nb5Var.m158738g();
                } else if (iM158752u == 18) {
                    swipeExcites.swipeConfig = (SwipeConfig) nb5Var.m158743l(SwipeConfig.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 26) {
                        if (swipeExcites.swipeConfig == null) {
                            swipeExcites.swipeConfig = SwipeConfig.new_();
                    ...
                    swipeExcites.deepLink = nb5Var.m158750s();
                }
            }
            return swipeExcites;
        }
        ...
        public void serialize(SwipeExcites swipeExcites, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, swipeExcites.taskSwitch);
            SwipeConfig swipeConfig = swipeExcites.swipeConfig;
            if (swipeConfig != null) {
                codedOutputByteBufferNano.m17254K(2, swipeConfig, SwipeConfig.PROTOBUF_ADAPTER);
            }
            String str = swipeExcites.deepLink;
            if (str != null) {
    ...
    public SwipeExcites mo223809clone() {
        SwipeExcites swipeExcites = new SwipeExcites();
        swipeExcites.taskSwitch = this.taskSwitch;
        SwipeConfig swipeConfig = this.swipeConfig;
        if (swipeConfig != null) {
            swipeExcites.swipeConfig = swipeConfig.mo223809clone();
        }
