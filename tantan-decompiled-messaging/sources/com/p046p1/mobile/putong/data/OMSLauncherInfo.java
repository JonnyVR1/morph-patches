...
import com.p046p1.mobile.putong.core.data.Creative;
...
public class OMSLauncherInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSLauncherInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSLauncherInfo>() { // from class: com.p1.mobile.putong.data.OMSLauncherInfo.1
        ...
        public int computeAndCacheSize(OMSLauncherInfo oMSLauncherInfo) {
            String str = oMSLauncherInfo.f38790id;
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17226h(2, oMSLauncherInfo.version);
            OmsMerCuryData omsMerCuryData = oMSLauncherInfo.viewMercury;
            if (omsMerCuryData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, omsMerCuryData, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OmsMerCuryData omsMerCuryData2 = oMSLauncherInfo.skipMercury;
            if (omsMerCuryData2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, omsMerCuryData2, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OmsMerCuryData omsMerCuryData3 = oMSLauncherInfo.clickMercury;
            if (omsMerCuryData3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, omsMerCuryData3, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OmsMerCuryData omsMerCuryData4 = oMSLauncherInfo.behaviorMercury;
            if (omsMerCuryData4 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, omsMerCuryData4, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(7, oMSLauncherInfo.duration);
            OMSDisplayRule oMSDisplayRule = oMSLauncherInfo.constraint;
            if (oMSDisplayRule != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(8, oMSDisplayRule, OMSDisplayRule.PROTOBUF_ADAPTER);
            }
            ...
            if (str3 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(10, str3);
            }
            ADInfo aDInfo = oMSLauncherInfo.f38789ad;
            if (aDInfo != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(11, aDInfo, ADInfo.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(12, oMSLauncherInfo.cacheEnable);
            List<String> list = oMSLauncherInfo.scenes;
            if (list != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(13, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = oMSLauncherInfo.type;
            if (str4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(14, str4);
            }
            CreativeOms creativeOms = oMSLauncherInfo.creative;
            if (creativeOms != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(15, creativeOms, CreativeOms.PROTOBUF_ADAPTER);
            }
            OperationConfig operationConfig = oMSLauncherInfo.operationConfig;
            if (operationConfig != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(16, operationConfig, OperationConfig.PROTOBUF_ADAPTER);
            }
            int iM17226h2 = iM17220b + CodedOutputByteBufferNano.m17226h(17, oMSLauncherInfo.budgetType) + CodedOutputByteBufferNano.m17220b(18, oMSLauncherInfo.ifBeRealtime);
            String str5 = oMSLauncherInfo.dspId;
            if (str5 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(19, str5);
            }
            int iM17228j = iM17226h2 + CodedOutputByteBufferNano.m17228j(20, oMSLauncherInfo.issueTimestamp) + CodedOutputByteBufferNano.m17226h(21, oMSLauncherInfo.price);
            oMSLauncherInfo.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSLauncherInfo parse(nb5 nb5Var) throws IOException {
            OMSLauncherInfo oMSLauncherInfo = new OMSLauncherInfo();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (oMSLauncherInfo.f38790id == null) {
                            oMSLauncherInfo.f38790id = "";
                        }
                        ...
                        break;
                    case 10:
                        oMSLauncherInfo.f38790id = nb5Var.m158750s();
                        continue;
                    case 16:
                        oMSLauncherInfo.version = nb5Var.m158741j();
                        continue;
                    case 26:
                        oMSLauncherInfo.viewMercury = (OmsMerCuryData) nb5Var.m158743l(OmsMerCuryData.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        oMSLauncherInfo.skipMercury = (OmsMerCuryData) nb5Var.m158743l(OmsMerCuryData.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        oMSLauncherInfo.clickMercury = (OmsMerCuryData) nb5Var.m158743l(OmsMerCuryData.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        oMSLauncherInfo.behaviorMercury = (OmsMerCuryData) nb5Var.m158743l(OmsMerCuryData.PROTOBUF_ADAPTER);
                        continue;
                    case 56:
                        oMSLauncherInfo.duration = nb5Var.m158741j();
                        continue;
                    case 66:
                        oMSLauncherInfo.constraint = (OMSDisplayRule) nb5Var.m158743l(OMSDisplayRule.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        oMSLauncherInfo.url = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        oMSLauncherInfo.href = nb5Var.m158750s();
                        continue;
                    case 90:
                        oMSLauncherInfo.f38789ad = (ADInfo) nb5Var.m158743l(ADInfo.PROTOBUF_ADAPTER);
                        continue;
                    case Opcodes.IADD /* 96 */:
                        oMSLauncherInfo.cacheEnable = nb5Var.m158738g();
                        continue;
                    case 106:
                        oMSLauncherInfo.scenes = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 114:
                        oMSLauncherInfo.type = nb5Var.m158750s();
                        continue;
                    case 122:
                        oMSLauncherInfo.creative = (CreativeOms) nb5Var.m158743l(CreativeOms.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        oMSLauncherInfo.operationConfig = (OperationConfig) nb5Var.m158743l(OperationConfig.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA /* 136 */:
                        oMSLauncherInfo.budgetType = nb5Var.m158741j();
                        continue;
                    case 144:
                        oMSLauncherInfo.ifBeRealtime = nb5Var.m158738g();
                        continue;
                    case 154:
                        oMSLauncherInfo.dspId = nb5Var.m158750s();
                        continue;
                    case 160:
                        oMSLauncherInfo.issueTimestamp = nb5Var.m158742k();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256 /* 168 */:
                        oMSLauncherInfo.price = nb5Var.m158741j();
                        continue;
                    default:
                        if (oMSLauncherInfo.f38790id == null) {
                            oMSLauncherInfo.f38790id = "";
        ...
        public void serialize(OMSLauncherInfo oMSLauncherInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(2, oMSLauncherInfo.version);
            OmsMerCuryData omsMerCuryData = oMSLauncherInfo.viewMercury;
            if (omsMerCuryData != null) {
                codedOutputByteBufferNano.m17254K(3, omsMerCuryData, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OmsMerCuryData omsMerCuryData2 = oMSLauncherInfo.skipMercury;
            if (omsMerCuryData2 != null) {
                codedOutputByteBufferNano.m17254K(4, omsMerCuryData2, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OmsMerCuryData omsMerCuryData3 = oMSLauncherInfo.clickMercury;
            if (omsMerCuryData3 != null) {
                codedOutputByteBufferNano.m17254K(5, omsMerCuryData3, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OmsMerCuryData omsMerCuryData4 = oMSLauncherInfo.behaviorMercury;
            if (omsMerCuryData4 != null) {
                codedOutputByteBufferNano.m17254K(6, omsMerCuryData4, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(7, oMSLauncherInfo.duration);
            OMSDisplayRule oMSDisplayRule = oMSLauncherInfo.constraint;
            if (oMSDisplayRule != null) {
                codedOutputByteBufferNano.m17254K(8, oMSDisplayRule, OMSDisplayRule.PROTOBUF_ADAPTER);
            }
            String str2 = oMSLauncherInfo.url;
            if (str2 != null) {
            ...
            ADInfo aDInfo = oMSLauncherInfo.f38789ad;
            if (aDInfo != null) {
                codedOutputByteBufferNano.m17254K(11, aDInfo, ADInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(12, oMSLauncherInfo.cacheEnable);
            List<String> list = oMSLauncherInfo.scenes;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(13, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = oMSLauncherInfo.type;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(14, str4);
            }
            CreativeOms creativeOms = oMSLauncherInfo.creative;
            if (creativeOms != null) {
                codedOutputByteBufferNano.m17254K(15, creativeOms, CreativeOms.PROTOBUF_ADAPTER);
            }
            OperationConfig operationConfig = oMSLauncherInfo.operationConfig;
            if (operationConfig != null) {
                codedOutputByteBufferNano.m17254K(16, operationConfig, OperationConfig.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(17, oMSLauncherInfo.budgetType);
            codedOutputByteBufferNano.m17244A(18, oMSLauncherInfo.ifBeRealtime);
            String str5 = oMSLauncherInfo.dspId;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(19, str5);
            }
            codedOutputByteBufferNano.m17252I(20, oMSLauncherInfo.issueTimestamp);
            codedOutputByteBufferNano.m17250G(21, oMSLauncherInfo.price);
        }
    };
    public static JsonAdapter<OMSLauncherInfo> JSON_ADAPTER = new ObjectJsonAdapter<OMSLauncherInfo>() { // from class: com.p1.mobile.putong.data.OMSLauncherInfo.2
        ...
        public boolean parseField(OMSLauncherInfo oMSLauncherInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 5:
                    ...
                    return true;
                case 6:
                    oMSLauncherInfo.f38789ad = ADInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 7:
                    oMSLauncherInfo.f38790id = jsonParser.getValueAsString();
                    return false;
                case 8:
        ...
        public void serializeFields(OMSLauncherInfo oMSLauncherInfo, JsonGenerator jsonGenerator) throws IOException {
            ...
            if (oMSLauncherInfo.f38789ad != null) {
                jsonGenerator.writeFieldName("ad");
                ADInfo.JSON_ADAPTER.serialize(oMSLauncherInfo.f38789ad, jsonGenerator, true);
            }
    ...
    public static /* synthetic */ String m59919a(String str) {
        return str;
    }
    ...
    public OMSLauncherInfo mo223809clone() {
        OMSLauncherInfo oMSLauncherInfo = new OMSLauncherInfo();
        oMSLauncherInfo.f38790id = this.f38790id;
        oMSLauncherInfo.version = this.version;
        OmsMerCuryData omsMerCuryData = this.viewMercury;
        if (omsMerCuryData != null) {
            oMSLauncherInfo.viewMercury = omsMerCuryData.mo223809clone();
        }
        OmsMerCuryData omsMerCuryData2 = this.skipMercury;
        if (omsMerCuryData2 != null) {
            oMSLauncherInfo.skipMercury = omsMerCuryData2.mo223809clone();
        }
        OmsMerCuryData omsMerCuryData3 = this.clickMercury;
        if (omsMerCuryData3 != null) {
            oMSLauncherInfo.clickMercury = omsMerCuryData3.mo223809clone();
        }
        OmsMerCuryData omsMerCuryData4 = this.behaviorMercury;
        if (omsMerCuryData4 != null) {
            oMSLauncherInfo.behaviorMercury = omsMerCuryData4.mo223809clone();
        }
        oMSLauncherInfo.duration = this.duration;
        OMSDisplayRule oMSDisplayRule = this.constraint;
        if (oMSDisplayRule != null) {
            oMSLauncherInfo.constraint = oMSDisplayRule.mo223809clone();
        }
        oMSLauncherInfo.url = this.url;
        oMSLauncherInfo.href = this.href;
        ADInfo aDInfo = this.f38789ad;
        if (aDInfo != null) {
            oMSLauncherInfo.f38789ad = aDInfo.mo223809clone();
        }
        ...
        if (list != null) {
            oMSLauncherInfo.scenes = ValueObject.util_map(list, new w9j() { // from class: l.ez40
                ...
                public final Object call(Object obj) {
                    return OMSLauncherInfo.m59919a((String) obj);
                }
            });
        }
        ...
        if (creativeOms != null) {
            oMSLauncherInfo.creative = creativeOms.mo223809clone();
        }
        OperationConfig operationConfig = this.operationConfig;
        if (operationConfig != null) {
            oMSLauncherInfo.operationConfig = operationConfig.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38790id, oMSLauncherInfo.f38790id) && this.version == oMSLauncherInfo.version && ValueObject.util_equals(this.viewMercury, oMSLauncherInfo.viewMercury) && ValueObject.util_equals(this.skipMercury, oMSLauncherInfo.skipMercury) && ValueObject.util_equals(this.clickMercury, oMSLauncherInfo.clickMercury) && ValueObject.util_equals(this.behaviorMercury, oMSLauncherInfo.behaviorMercury) && this.duration == oMSLauncherInfo.duration && ValueObject.util_equals(this.constraint, oMSLauncherInfo.constraint) && ValueObject.util_equals(this.url, oMSLauncherInfo.url) && ValueObject.util_equals(this.href, oMSLauncherInfo.href) && ValueObject.util_equals(this.f38789ad, oMSLauncherInfo.f38789ad) && this.cacheEnable == oMSLauncherInfo.cacheEnable && ValueObject.util_equals(this.scenes, oMSLauncherInfo.scenes) && ValueObject.util_equals(this.type, oMSLauncherInfo.type) && ValueObject.util_equals(this.creative, oMSLauncherInfo.creative) && ValueObject.util_equals(this.operationConfig, oMSLauncherInfo.operationConfig) && this.budgetType == oMSLauncherInfo.budgetType && this.ifBeRealtime == oMSLauncherInfo.ifBeRealtime && ValueObject.util_equals(this.dspId, oMSLauncherInfo.dspId) && this.issueTimestamp == oMSLauncherInfo.issueTimestamp && this.price == oMSLauncherInfo.price;
    }
