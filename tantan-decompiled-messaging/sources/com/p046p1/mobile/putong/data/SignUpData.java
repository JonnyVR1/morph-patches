...
public class SignUpData implements Serializable {
    ...
    public boolean f38816b1;

    /* JADX INFO: renamed from: b2 */
    public boolean f38817b2;

    /* JADX INFO: renamed from: b3 */
    public boolean f38818b3;

    /* JADX INFO: renamed from: b4 */
    public boolean f38819b4;
    ...
    public boolean f38820bb = true;
    public boolean profileShowGender = false;

    public static String getNonNullPhoneNumber() {
        return TextUtils.isEmpty(qib0.f154714c0.getSignUpData().phoneNumber) ? "" : qib0.f154714c0.getSignUpData().phoneNumber;
    }
}
