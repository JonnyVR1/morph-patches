...
public class AppealMaterial extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AppealMaterial> PROTOBUF_ADAPTER = new MessageNanoAdapter<AppealMaterial>() { // from class: com.p1.mobile.putong.data.AppealMaterial.1
        ...
        public int computeAndCacheSize(AppealMaterial appealMaterial) {
            ...
            appealMaterial.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AppealMaterial parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    appealMaterial.text = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    appealMaterial.pictures = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 26) {
                        if (appealMaterial.text == null) {
                            appealMaterial.text = "";
                    ...
                    appealMaterial.contact = nb5Var.m158750s();
                }
            }
            return appealMaterial;
        }
    ...
    public static /* synthetic */ String m59670a(String str) {
        return str;
    }
    ...
    public AppealMaterial mo223809clone() {
        AppealMaterial appealMaterial = new AppealMaterial();
        ...
        if (list != null) {
            appealMaterial.pictures = ValueObject.util_map(list, new w9j() { // from class: l.dy0
                ...
                public final Object call(Object obj) {
                    return AppealMaterial.m59670a((String) obj);
                }
            });
        }
