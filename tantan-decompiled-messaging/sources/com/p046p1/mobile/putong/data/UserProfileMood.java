...
public class UserProfileMood extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserProfileMood> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserProfileMood>() { // from class: com.p1.mobile.putong.data.UserProfileMood.1
        ...
        public int computeAndCacheSize(UserProfileMood userProfileMood) {
            ...
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(3, userProfileMood.createdTime) + CodedOutputByteBufferNano.m17222d(4, userProfileMood.expireTime);
            userProfileMood.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserProfileMood parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    userProfileMood.content = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    userProfileMood.moodId = nb5Var.m158750s();
                } else if (iM158752u == 25) {
                    userProfileMood.createdTime = nb5Var.m158739h();
                } else {
                    if (iM158752u != 33) {
                        if (userProfileMood.content == null) {
                            userProfileMood.content = "";
                    ...
                    userProfileMood.expireTime = nb5Var.m158739h();
                }
            }
            return userProfileMood;
        }
        ...
        public void serialize(UserProfileMood userProfileMood, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17246C(3, userProfileMood.createdTime);
            codedOutputByteBufferNano.m17246C(4, userProfileMood.expireTime);
        }
    };
    ...
    public UserProfileMood mo223809clone() {
        UserProfileMood userProfileMood = new UserProfileMood();
