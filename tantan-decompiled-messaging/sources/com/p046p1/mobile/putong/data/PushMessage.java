...
public class PushMessage extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PushMessage> PROTOBUF_ADAPTER = new MessageNanoAdapter<PushMessage>() { // from class: com.p1.mobile.putong.data.PushMessage.1
        ...
        public int computeAndCacheSize(PushMessage pushMessage) {
            ...
            if (charSequence != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(3, charSequence.toString());
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(4, pushMessage.counter);
            String str3 = pushMessage.intent;
            if (str3 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(5, str3);
            }
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(6, pushMessage.silentAggregation) + CodedOutputByteBufferNano.m17226h(7, pushMessage.priority) + CodedOutputByteBufferNano.m17226h(8, pushMessage.stackId) + CodedOutputByteBufferNano.m17220b(9, pushMessage.silent);
            ...
            if (pushMessageContent != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(11, pushMessageContent, PushMessageContent.PROTOBUF_ADAPTER);
            }
            int iM17222d = iM17220b + CodedOutputByteBufferNano.m17222d(12, pushMessage.createdTime);
            String str5 = pushMessage.gid;
            if (str5 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(13, str5);
            }
            PushMessageCustom pushMessageCustom = pushMessage.messageCustom;
            if (pushMessageCustom != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(14, pushMessageCustom, PushMessageCustom.PROTOBUF_ADAPTER);
            }
            String str6 = pushMessage.reqId;
            if (str6 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(15, str6);
            }
            ...
            if (str8 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(17, str8);
            }
            int iM17226h2 = iM17222d + CodedOutputByteBufferNano.m17226h(18, pushMessage.longLinkMessageType) + CodedOutputByteBufferNano.m17220b(19, pushMessage.isShow);
            String str9 = pushMessage.pushChannel;
            if (str9 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(20, str9);
            }
            Map<String, String> map = pushMessage.messageCustomMap;
            if (map != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17230l(21, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            pushMessage.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PushMessage parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        pushMessage.ticker = nb5Var.m158750s();
                        continue;
                    case 18:
                        pushMessage.title = nb5Var.m158750s();
                        continue;
                    case 26:
                        pushMessage.value = nb5Var.m158750s();
                        continue;
                    case 32:
                        pushMessage.counter = nb5Var.m158741j();
                        continue;
                    case 42:
                        pushMessage.intent = nb5Var.m158750s();
                        continue;
                    case 48:
                        pushMessage.silentAggregation = nb5Var.m158738g();
                        continue;
                    case 56:
                        pushMessage.priority = nb5Var.m158741j();
                        continue;
                    case 64:
                        pushMessage.stackId = nb5Var.m158741j();
                        continue;
                    case 72:
                        pushMessage.silent = nb5Var.m158738g();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        pushMessage.primaryPicture = nb5Var.m158750s();
                        continue;
                    case 90:
                        pushMessage.content = (PushMessageContent) nb5Var.m158743l(PushMessageContent.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.APPLICATION_TEMPLATE /* 97 */:
                        pushMessage.createdTime = nb5Var.m158739h();
                        continue;
                    case 106:
                        pushMessage.gid = nb5Var.m158750s();
                        continue;
                    case 114:
                        pushMessage.messageCustom = (PushMessageCustom) nb5Var.m158743l(PushMessageCustom.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        pushMessage.reqId = nb5Var.m158750s();
                        continue;
                    case 130:
                        pushMessage.link = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        pushMessage.pushName = nb5Var.m158750s();
                        continue;
                    case 144:
                        pushMessage.longLinkMessageType = nb5Var.m158741j();
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA /* 152 */:
                        pushMessage.isShow = nb5Var.m158738g();
                        continue;
                    case 162:
                        pushMessage.pushChannel = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        pushMessage.messageCustomMap = (Map) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
                        continue;
                    default:
                        if (pushMessage.ticker == null) {
                            pushMessage.ticker = "";
        ...
        public void serialize(PushMessage pushMessage, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CharSequence charSequence = pushMessage.value;
            if (charSequence != null) {
                codedOutputByteBufferNano.m17261R(3, charSequence.toString());
            }
            codedOutputByteBufferNano.m17250G(4, pushMessage.counter);
            String str3 = pushMessage.intent;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(5, str3);
            }
            codedOutputByteBufferNano.m17244A(6, pushMessage.silentAggregation);
            codedOutputByteBufferNano.m17250G(7, pushMessage.priority);
            codedOutputByteBufferNano.m17250G(8, pushMessage.stackId);
            codedOutputByteBufferNano.m17244A(9, pushMessage.silent);
            String str4 = pushMessage.primaryPicture;
            if (str4 != null) {
            ...
            PushMessageContent pushMessageContent = pushMessage.content;
            if (pushMessageContent != null) {
                codedOutputByteBufferNano.m17254K(11, pushMessageContent, PushMessageContent.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(12, pushMessage.createdTime);
            String str5 = pushMessage.gid;
            if (str5 != null) {
            ...
            PushMessageCustom pushMessageCustom = pushMessage.messageCustom;
            if (pushMessageCustom != null) {
                codedOutputByteBufferNano.m17254K(14, pushMessageCustom, PushMessageCustom.PROTOBUF_ADAPTER);
            }
            String str6 = pushMessage.reqId;
            if (str6 != null) {
            ...
            codedOutputByteBufferNano.m17250G(18, pushMessage.longLinkMessageType);
            codedOutputByteBufferNano.m17244A(19, pushMessage.isShow);
            String str9 = pushMessage.pushChannel;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(20, str9);
            }
            Map<String, String> map = pushMessage.messageCustomMap;
            if (map != null) {
                codedOutputByteBufferNano.m17254K(21, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m60054a(String str) {
        return str;
    }
    ...
    public PushMessage mo223809clone() {
        PushMessage pushMessage = new PushMessage();
        ...
        if (map != null) {
            pushMessage.messageCustomMap = ValueObject.util_map(map, new w9j() { // from class: l.leb0
                ...
                public final Object call(Object obj) {
                    return PushMessage.m60054a((String) obj);
                }
            });
        }
        return pushMessage;
