...
public class IntlMoreGender extends ValueObject<IntlMoreGender> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlMoreGender> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlMoreGender>() { // from class: com.p1.mobile.putong.data.IntlMoreGender.1
        ...
        public int computeAndCacheSize(IntlMoreGender intlMoreGender) {
            ...
            int iM17230l = intlGender != null ? CodedOutputByteBufferNano.m17230l(1, intlGender, IntlGender.PROTOBUF_ADAPTER) : 0;
            ...
            if (list != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, list, LookingFor.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool = intlMoreGender.notShowCis;
            if (bool != null) {
                iM17230l += CodedOutputByteBufferNano.m17220b(4, bool.booleanValue());
            }
            Boolean bool2 = intlMoreGender.showOnProfile;
            if (bool2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17220b(5, bool2.booleanValue());
            }
            Boolean bool3 = intlMoreGender.canUpdate;
            if (bool3 != null) {
                iM17230l += CodedOutputByteBufferNano.m17220b(6, bool3.booleanValue());
            }
            intlMoreGender.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlMoreGender parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    intlMoreGender.newGender = (IntlGender) nb5Var.m158743l(IntlGender.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    intlMoreGender.subGender = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    intlMoreGender.lookingForGenders = (List) nb5Var.m158743l(LookingFor.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 32) {
                    intlMoreGender.notShowCis = Boolean.valueOf(nb5Var.m158738g());
                } else if (iM158752u == 40) {
                    intlMoreGender.showOnProfile = Boolean.valueOf(nb5Var.m158738g());
                } else {
                    if (iM158752u != 48) {
                        if (intlMoreGender.lookingForGenders == null) {
                            intlMoreGender.lookingForGenders = new ArrayList();
                    ...
                    intlMoreGender.canUpdate = Boolean.valueOf(nb5Var.m158738g());
                }
            }
            return intlMoreGender;
        }
        ...
        public void serialize(IntlMoreGender intlMoreGender, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            IntlGender intlGender = intlMoreGender.newGender;
            if (intlGender != null) {
                codedOutputByteBufferNano.m17254K(1, intlGender, IntlGender.PROTOBUF_ADAPTER);
            }
            String str = intlMoreGender.subGender;
            if (str != null) {
            ...
            List<LookingFor> list = intlMoreGender.lookingForGenders;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(3, list, LookingFor.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool = intlMoreGender.notShowCis;
            if (bool != null) {
                codedOutputByteBufferNano.m17244A(4, bool.booleanValue());
            }
            Boolean bool2 = intlMoreGender.showOnProfile;
            if (bool2 != null) {
                codedOutputByteBufferNano.m17244A(5, bool2.booleanValue());
            }
            Boolean bool3 = intlMoreGender.canUpdate;
            if (bool3 != null) {
                codedOutputByteBufferNano.m17244A(6, bool3.booleanValue());
            }
        }
    };
    ...
    public static /* synthetic */ LookingFor m59809a(LookingFor lookingFor) {
        return lookingFor;
    }
    ...
    public IntlMoreGender mo223809clone() {
        IntlMoreGender intlMoreGender = new IntlMoreGender();
        ...
        if (list != null) {
            intlMoreGender.lookingForGenders = ValueObject.util_map(list, new w9j() { // from class: l.sko
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return IntlMoreGender.m59809a((LookingFor) obj);
                }
            });
        }
