...
public class GPResult extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GPResult> PROTOBUF_ADAPTER = new MessageNanoAdapter<GPResult>() { // from class: com.p1.mobile.putong.data.GPResult.1
        ...
        public int computeAndCacheSize(GPResult gPResult) {
            ...
            if (googlePlayOrdersData != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, googlePlayOrdersData, GooglePlayOrdersData.PROTOBUF_ADAPTER);
            }
            gPResult.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GPResult parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    gPResult.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 18) {
                        if (gPResult.meta == null) {
                            gPResult.meta = Meta.new_();
                    ...
                    gPResult.data = (GooglePlayOrdersData) nb5Var.m158743l(GooglePlayOrdersData.PROTOBUF_ADAPTER);
                }
            }
            return gPResult;
        }
        ...
        public void serialize(GPResult gPResult, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            GooglePlayOrdersData googlePlayOrdersData = gPResult.data;
            if (googlePlayOrdersData != null) {
                codedOutputByteBufferNano.m17254K(2, googlePlayOrdersData, GooglePlayOrdersData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public GPResult mo223809clone() {
        GPResult gPResult = new GPResult();
        Meta meta = this.meta;
        if (meta != null) {
            gPResult.meta = meta.mo223809clone();
        }
        GooglePlayOrdersData googlePlayOrdersData = this.data;
        if (googlePlayOrdersData != null) {
            gPResult.data = googlePlayOrdersData.mo223809clone();
        }
        return gPResult;
    }
