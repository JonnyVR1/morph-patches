...
public class LivePushLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LivePushLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<LivePushLimit>() { // from class: com.p1.mobile.putong.data.LivePushLimit.1
        ...
        public int computeAndCacheSize(LivePushLimit livePushLimit) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, livePushLimit.remaining) + CodedOutputByteBufferNano.m17222d(2, livePushLimit.availableTime);
            livePushLimit.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LivePushLimit parse(nb5 nb5Var) throws IOException {
            LivePushLimit livePushLimit = new LivePushLimit();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    livePushLimit.remaining = nb5Var.m158741j();
                } else {
                    if (iM158752u != 17) {
                        return livePushLimit;
                    }
                    livePushLimit.availableTime = nb5Var.m158739h();
                }
            }
        }
        ...
        public void serialize(LivePushLimit livePushLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, livePushLimit.remaining);
            codedOutputByteBufferNano.m17246C(2, livePushLimit.availableTime);
        }
    };
    ...
    public LivePushLimit mo223809clone() {
        LivePushLimit livePushLimit = new LivePushLimit();
