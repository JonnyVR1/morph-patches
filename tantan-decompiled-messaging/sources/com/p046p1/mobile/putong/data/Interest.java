...
public class Interest extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Interest> PROTOBUF_ADAPTER = new MessageNanoAdapter<Interest>() { // from class: com.p1.mobile.putong.data.Interest.1
        ...
        public int computeAndCacheSize(Interest interest) {
            ...
            interest.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Interest parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    interest.emoji = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 18) {
                    interest.tags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 26) {
                        if (interest.emoji == null) {
                            interest.emoji = new ArrayList();
                    ...
                    interest.taste = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return interest;
        }
    ...
    public static /* synthetic */ String m59805a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m59806b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m59807c(String str) {
        return str;
    }
    ...
    public Interest mo223809clone() {
        ...
        if (list != null) {
            interest.emoji = ValueObject.util_map(list, new w9j() { // from class: l.cxm
                ...
                public final Object call(Object obj) {
                    return Interest.m59806b((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            interest.tags = ValueObject.util_map(list2, new w9j() { // from class: l.dxm
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Interest.m59807c((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            interest.taste = ValueObject.util_map(list3, new w9j() { // from class: l.exm
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Interest.m59805a((String) obj);
                }
            });
        }
        return interest;
