...
import com.p046p1.mobile.putong.data.PrivateAnswer;
...
public class User extends DbObject<User> implements Cloneable, Serializable {
    ...
    public static final int f38826ME = 4;
    ...
    private static Pattern f38827np;
    ...
    public static ProtobufAdapter<User> PROTOBUF_ADAPTER = new MessageNanoAdapter<User>() { // from class: com.p1.mobile.putong.data.User.1
        ...
        public int computeAndCacheSize(User user) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, user._id);
            ...
            if (location != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(52, location, Location.PROTOBUF_ADAPTER);
            }
            ...
            if (num != null) {
                iM17228j += CodedOutputByteBufferNano.m17226h(54, num.intValue());
            }
            List<Media> list = user.pictures;
            if (list != null) {
                iM17228j += CodedOutputByteBufferNano.m17230l(55, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17222d = iM17228j + CodedOutputByteBufferNano.m17222d(56, user.createdTime);
            Profile profile = user.profile;
            if (profile != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(57, profile, Profile.PROTOBUF_ADAPTER);
            }
            List<UserStatus> list2 = user.status;
            if (list2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(58, UserStatus.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Settings settings = user.settings;
            if (settings != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(59, settings, Settings.PROTOBUF_ADAPTER);
            }
            Gender gender = user.gender;
            if (gender != null) {
                iM17222d += CodedOutputByteBufferNano.m17226h(60, gender.ordinal());
            }
            Relationship relationship = user.localRelationship;
            if (relationship != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(61, relationship, Relationship.PROTOBUF_ADAPTER);
            }
            Membership membership = user.membership;
            if (membership != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(62, membership, Membership.PROTOBUF_ADAPTER);
            }
            UserSource userSource = user.source;
            if (userSource != null) {
                iM17222d += CodedOutputByteBufferNano.m17226h(63, userSource.ordinal());
            }
            String str4 = user.realName;
            if (str4 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(64, str4);
            }
            Followship followship = user.localFollowship;
            if (followship != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(65, followship, Followship.PROTOBUF_ADAPTER);
            }
            List<Membership> list3 = user.memberships;
            if (list3 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(66, list3, Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = user.nameRemark;
            if (str5 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(67, str5);
            }
            UserState userState = user.state;
            if (userState != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(68, userState, UserState.PROTOBUF_ADAPTER);
            }
            PicVerification picVerification = user.verifications;
            if (picVerification != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(69, picVerification, PicVerification.PROTOBUF_ADAPTER);
            }
            List<String> list4 = user.abGroups;
            if (list4 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(70, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<PrivateAnswer> list5 = user.privateAnswers;
            if (list5 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(71, list5, PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Membership membership2 = user.peepership;
            if (membership2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(72, membership2, Membership.PROTOBUF_ADAPTER);
            }
            int iM17228j2 = iM17222d + CodedOutputByteBufferNano.m17228j(73, user.picksExpiredTimestamp) + CodedOutputByteBufferNano.m17220b(74, user.picksSwipable);
            String str6 = user.picksTag;
            if (str6 != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17233o(75, str6);
            }
            UserCreditData userCreditData = user.credit;
            if (userCreditData != null) {
                iM17228j2 += CodedOutputByteBufferNano.m17230l(76, userCreditData, UserCreditData.PROTOBUF_ADAPTER);
            }
            int iM17222d2 = iM17228j2 + CodedOutputByteBufferNano.m17222d(77, user.goPlaceTimestamp) + CodedOutputByteBufferNano.m17220b(78, user.isLord) + CodedOutputByteBufferNano.m17222d(79, user.privateAnswersUpdatedTime);
            String str7 = user.sendLetter;
            if (str7 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(80, str7);
            }
            int iM17228j3 = iM17222d2 + CodedOutputByteBufferNano.m17228j(81, user.sendLetterTimestamp);
            String str8 = user.receivedLetter;
            if (str8 != null) {
                iM17228j3 += CodedOutputByteBufferNano.m17233o(82, str8);
            }
            int iM17228j4 = iM17228j3 + CodedOutputByteBufferNano.m17228j(83, user.receivedLetterTimestamp) + CodedOutputByteBufferNano.m17226h(84, user.popLevel);
            AudioSignature audioSignature = user.voice;
            if (audioSignature != null) {
                iM17228j4 += CodedOutputByteBufferNano.m17230l(85, audioSignature, AudioSignature.PROTOBUF_ADAPTER);
            }
            int iM17220b = iM17228j4 + CodedOutputByteBufferNano.m17220b(86, user.datingMode);
            UssTags ussTags = user.ussTags;
            if (ussTags != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(87, ussTags, UssTags.PROTOBUF_ADAPTER);
            }
            UserAbroad userAbroad = user.abroad;
            if (userAbroad != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(88, userAbroad, UserAbroad.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem = user.fakeStatus;
            if (statusesItem != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(89, statusesItem, StatusesItem.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem2 = user.nameStatus;
            if (statusesItem2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(90, statusesItem2, StatusesItem.PROTOBUF_ADAPTER);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(91, user.displayAudit);
            VisitPlace visitPlace = user.visitPlace;
            if (visitPlace != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(92, visitPlace, VisitPlace.PROTOBUF_ADAPTER);
            }
            String str9 = user.publicId;
            if (str9 != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17233o(93, str9);
            }
            UserSoulSettings userSoulSettings = user.soulSettings;
            if (userSoulSettings != null) {
                iM17220b2 += CodedOutputByteBufferNano.m17230l(94, userSoulSettings, UserSoulSettings.PROTOBUF_ADAPTER);
            }
            int iM17226h = iM17220b2 + CodedOutputByteBufferNano.m17226h(95, user.richListPosition);
            String str10 = user.richListTracker;
            if (str10 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(96, str10);
            }
            int iM17222d3 = iM17226h + CodedOutputByteBufferNano.m17222d(97, user.diamondVIPExpiresTime);
            String str11 = user.aiTag;
            if (str11 != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17233o(98, str11);
            }
            FriendCommentInfo friendCommentInfo = user.friendCommentInfo;
            if (friendCommentInfo != null) {
                iM17222d3 += CodedOutputByteBufferNano.m17230l(99, friendCommentInfo, FriendCommentInfo.PROTOBUF_ADAPTER);
            }
            int iM17226h2 = iM17222d3 + CodedOutputByteBufferNano.m17226h(100, user.minRichListPosition);
            String str12 = user.ussTracker;
            if (str12 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(101, str12);
            }
            int iM17228j5 = iM17226h2 + CodedOutputByteBufferNano.m17228j(102, user.localLatestReceivedMessageTime);
            LiveUserLevel liveUserLevel = user.hierarchy;
            if (liveUserLevel != null) {
                iM17228j5 += CodedOutputByteBufferNano.m17230l(103, liveUserLevel, LiveUserLevel.PROTOBUF_ADAPTER);
            }
            SoulShip soulShip = user.localSoulShip;
            if (soulShip != null) {
                iM17228j5 += CodedOutputByteBufferNano.m17230l(104, soulShip, SoulShip.PROTOBUF_ADAPTER);
            }
            int iM17222d4 = iM17228j5 + CodedOutputByteBufferNano.m17222d(105, user.signupTime);
            BanStatus banStatus = user.banStatus;
            if (banStatus != null) {
                iM17222d4 += CodedOutputByteBufferNano.m17230l(106, banStatus, BanStatus.PROTOBUF_ADAPTER);
            }
            List<String> list6 = user.localDiamondPrivateMatchTags;
            if (list6 != null) {
                iM17222d4 += CodedOutputByteBufferNano.m17230l(107, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            AnonymousLikeInfo anonymousLikeInfo = user.anonymousLike;
            if (anonymousLikeInfo != null) {
                iM17222d4 += CodedOutputByteBufferNano.m17230l(108, anonymousLikeInfo, AnonymousLikeInfo.PROTOBUF_ADAPTER);
            }
            int iM17220b3 = iM17222d4 + CodedOutputByteBufferNano.m17220b(109, user.inactivated);
            List<UserStatus> list7 = user.status;
            if (list7 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(110, list7, UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Gender gender2 = user.gender;
            if (gender2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(111, gender2, Gender.PROTOBUF_ADAPTER);
            }
            UserSource userSource2 = user.source;
            if (userSource2 != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(112, userSource2, UserSource.PROTOBUF_ADAPTER);
            }
            ActivityUser activityUser = user.activityUser;
            if (activityUser != null) {
                iM17220b3 += CodedOutputByteBufferNano.m17230l(113, activityUser, ActivityUser.PROTOBUF_ADAPTER);
            }
            int iM17220b4 = iM17220b3 + CodedOutputByteBufferNano.m17220b(114, user.matePlanUser) + CodedOutputByteBufferNano.m17220b(115, user.matePlanAdUser);
            String str13 = user.regionTag;
            if (str13 != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17233o(116, str13);
            }
            List<String> list8 = user.localLikeIdentifiers;
            if (list8 != null) {
                iM17220b4 += CodedOutputByteBufferNano.m17230l(117, list8, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17220b5 = iM17220b4 + CodedOutputByteBufferNano.m17220b(118, user.deleted);
            SpecialEffect specialEffect = user.specialEffect;
            if (specialEffect != null) {
                iM17220b5 += CodedOutputByteBufferNano.m17230l(119, specialEffect, SpecialEffect.PROTOBUF_ADAPTER);
            }
            UserActivityInfo userActivityInfo = user.userActivityInfo;
            if (userActivityInfo != null) {
                iM17220b5 += CodedOutputByteBufferNano.m17230l(120, userActivityInfo, UserActivityInfo.PROTOBUF_ADAPTER);
            }
            user.cachedSize = iM17220b5;
            return iM17220b5;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public User parse(nb5 nb5Var) throws IOException {
            User user = new User();
            List list = null;
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        user._id = nb5Var.m158742k();
                        continue;
                    case 18:
                        user.f56011id = nb5Var.m158750s();
                        continue;
                    case 410:
                        user.name = nb5Var.m158750s();
                        continue;
                    case 418:
                        user.location = (Location) nb5Var.m158743l(Location.PROTOBUF_ADAPTER);
                        continue;
                    case 426:
                        user.description = nb5Var.m158750s();
                        continue;
                    case 432:
                        user.age = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 442:
                        user.pictures = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 449:
                        user.createdTime = nb5Var.m158739h();
                        continue;
                    case 458:
                        user.profile = (Profile) nb5Var.m158743l(Profile.PROTOBUF_ADAPTER);
                        continue;
                    case 466:
                        list = (List) nb5Var.m158743l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 474:
                        user.settings = (Settings) nb5Var.m158743l(Settings.PROTOBUF_ADAPTER);
                        continue;
                    case 480:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 490:
                        user.localRelationship = (Relationship) nb5Var.m158743l(Relationship.PROTOBUF_ADAPTER);
                        continue;
                    case 498:
                        user.membership = (Membership) nb5Var.m158743l(Membership.PROTOBUF_ADAPTER);
                        continue;
                    case HttpStatus.GATEWAY_TIMEOUT_504 /* 504 */:
                        numValueOf2 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 514:
                        user.realName = nb5Var.m158750s();
                        continue;
                    case 522:
                        user.localFollowship = (Followship) nb5Var.m158743l(Followship.PROTOBUF_ADAPTER);
                        continue;
                    case 530:
                        user.memberships = (List) nb5Var.m158743l(Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 538:
                        user.nameRemark = nb5Var.m158750s();
                        continue;
                    case 546:
                        user.state = (UserState) nb5Var.m158743l(UserState.PROTOBUF_ADAPTER);
                        continue;
                    case 554:
                        user.verifications = (PicVerification) nb5Var.m158743l(PicVerification.PROTOBUF_ADAPTER);
                        continue;
                    case 562:
                        user.abGroups = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 570:
                        user.privateAnswers = (List) nb5Var.m158743l(PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED_BASELINE /* 578 */:
                        user.peepership = (Membership) nb5Var.m158743l(Membership.PROTOBUF_ADAPTER);
                        continue;
                    case 584:
                        user.picksExpiredTimestamp = nb5Var.m158742k();
                        continue;
                    case 592:
                        user.picksSwipable = nb5Var.m158738g();
                        continue;
                    case 602:
                        user.picksTag = nb5Var.m158750s();
                        continue;
                    case 610:
                        user.credit = (UserCreditData) nb5Var.m158743l(UserCreditData.PROTOBUF_ADAPTER);
                        continue;
                    case 617:
                        user.goPlaceTimestamp = nb5Var.m158739h();
                        continue;
                    case 624:
                        user.isLord = nb5Var.m158738g();
                        continue;
                    case 633:
                        user.privateAnswersUpdatedTime = nb5Var.m158739h();
                        continue;
                    case 642:
                        user.sendLetter = nb5Var.m158750s();
                        continue;
                    case 648:
                        user.sendLetterTimestamp = nb5Var.m158742k();
                        continue;
                    case 658:
                        user.receivedLetter = nb5Var.m158750s();
                        continue;
                    case 664:
                        user.receivedLetterTimestamp = nb5Var.m158742k();
                        continue;
                    case 672:
                        user.popLevel = nb5Var.m158741j();
                        continue;
                    case DetectDelayStopHelper.TYPE_DETECT_RIG /* 682 */:
                        user.voice = (AudioSignature) nb5Var.m158743l(AudioSignature.PROTOBUF_ADAPTER);
                        continue;
                    case 688:
                        user.datingMode = nb5Var.m158738g();
                        continue;
                    case 698:
                        user.ussTags = (UssTags) nb5Var.m158743l(UssTags.PROTOBUF_ADAPTER);
                        continue;
                    case 706:
                        user.abroad = (UserAbroad) nb5Var.m158743l(UserAbroad.PROTOBUF_ADAPTER);
                        continue;
                    case Constants.AUDIO_MIXING_STATE_FAILED /* 714 */:
                        user.fakeStatus = (StatusesItem) nb5Var.m158743l(StatusesItem.PROTOBUF_ADAPTER);
                        continue;
                    case 722:
                        user.nameStatus = (StatusesItem) nb5Var.m158743l(StatusesItem.PROTOBUF_ADAPTER);
                        continue;
                    case 728:
                        user.displayAudit = nb5Var.m158738g();
                        continue;
                    case 738:
                        user.visitPlace = (VisitPlace) nb5Var.m158743l(VisitPlace.PROTOBUF_ADAPTER);
                        continue;
                    case 746:
                        user.publicId = nb5Var.m158750s();
                        continue;
                    case DetectDelayStopHelper.TYPE_DETECT_AR_GIFT /* 754 */:
                        user.soulSettings = (UserSoulSettings) nb5Var.m158743l(UserSoulSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 760:
                        user.richListPosition = nb5Var.m158741j();
                        continue;
                    case 770:
                        user.richListTracker = nb5Var.m158750s();
                        continue;
                    case 777:
                        user.diamondVIPExpiresTime = nb5Var.m158739h();
                        continue;
                    case PutongAct.REQUEST_CODE_PICKER /* 786 */:
                        user.aiTag = nb5Var.m158750s();
                        continue;
                    case 794:
                        user.friendCommentInfo = (FriendCommentInfo) nb5Var.m158743l(FriendCommentInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 800:
                        user.minRichListPosition = nb5Var.m158741j();
                        continue;
                    case Constants.RHYTHM_PLAYER_STATE_IDLE /* 810 */:
                        user.ussTracker = nb5Var.m158750s();
                        continue;
                    case 816:
                        user.localLatestReceivedMessageTime = nb5Var.m158742k();
                        continue;
                    case 826:
                        user.hierarchy = (LiveUserLevel) nb5Var.m158743l(LiveUserLevel.PROTOBUF_ADAPTER);
                        continue;
                    case 834:
                        user.localSoulShip = (SoulShip) nb5Var.m158743l(SoulShip.PROTOBUF_ADAPTER);
                        continue;
                    case 841:
                        user.signupTime = nb5Var.m158739h();
                        continue;
                    case 850:
                        user.banStatus = (BanStatus) nb5Var.m158743l(BanStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 858:
                        user.localDiamondPrivateMatchTags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 866:
                        user.anonymousLike = (AnonymousLikeInfo) nb5Var.m158743l(AnonymousLikeInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 872:
                        user.inactivated = nb5Var.m158738g();
                        continue;
                    case 882:
                        user.status = (List) nb5Var.m158743l(UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 890:
                        user.gender = (Gender) nb5Var.m158743l(Gender.PROTOBUF_ADAPTER);
                        continue;
                    case 898:
                        user.source = (UserSource) nb5Var.m158743l(UserSource.PROTOBUF_ADAPTER);
                        continue;
                    case IMediaPlayer.MEDIA_INFO_V_DELAY /* 906 */:
                        user.activityUser = (ActivityUser) nb5Var.m158743l(ActivityUser.PROTOBUF_ADAPTER);
                        continue;
                    case 912:
                        user.matePlanUser = nb5Var.m158738g();
                        continue;
                    case 920:
                        user.matePlanAdUser = nb5Var.m158738g();
                        continue;
                    case 930:
                        user.regionTag = nb5Var.m158750s();
                        continue;
                    case 938:
                        user.localLikeIdentifiers = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 944:
                        user.deleted = nb5Var.m158738g();
                        continue;
                    case 954:
                        user.specialEffect = (SpecialEffect) nb5Var.m158743l(SpecialEffect.PROTOBUF_ADAPTER);
                        continue;
                    case 962:
                        user.userActivityInfo = (UserActivityInfo) nb5Var.m158743l(UserActivityInfo.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (user.status == null && list != null) {
                            user.status = UserStatus.oldEnumCovertList(list);
        ...
        public void serialize(User user, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, user._id);
            String str = user.f56011id;
            if (str != null) {
            ...
            Location location = user.location;
            if (location != null) {
                codedOutputByteBufferNano.m17254K(52, location, Location.PROTOBUF_ADAPTER);
            }
            String str3 = user.description;
            if (str3 != null) {
            ...
            Integer num = user.age;
            if (num != null) {
                codedOutputByteBufferNano.m17250G(54, num.intValue());
            }
            List<Media> list = user.pictures;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(55, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17246C(56, user.createdTime);
            Profile profile = user.profile;
            if (profile != null) {
                codedOutputByteBufferNano.m17254K(57, profile, Profile.PROTOBUF_ADAPTER);
            }
            List<UserStatus> list2 = user.status;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(58, UserStatus.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Settings settings = user.settings;
            if (settings != null) {
                codedOutputByteBufferNano.m17254K(59, settings, Settings.PROTOBUF_ADAPTER);
            }
            Gender gender = user.gender;
            if (gender != null) {
                codedOutputByteBufferNano.m17250G(60, gender.ordinal());
            }
            Relationship relationship = user.localRelationship;
            if (relationship != null) {
                codedOutputByteBufferNano.m17254K(61, relationship, Relationship.PROTOBUF_ADAPTER);
            }
            Membership membership = user.membership;
            if (membership != null) {
                codedOutputByteBufferNano.m17254K(62, membership, Membership.PROTOBUF_ADAPTER);
            }
            UserSource userSource = user.source;
            if (userSource != null) {
                codedOutputByteBufferNano.m17250G(63, userSource.ordinal());
            }
            String str4 = user.realName;
            if (str4 != null) {
                codedOutputByteBufferNano.m17261R(64, str4);
            }
            Followship followship = user.localFollowship;
            if (followship != null) {
                codedOutputByteBufferNano.m17254K(65, followship, Followship.PROTOBUF_ADAPTER);
            }
            List<Membership> list3 = user.memberships;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(66, list3, Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = user.nameRemark;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(67, str5);
            }
            UserState userState = user.state;
            if (userState != null) {
                codedOutputByteBufferNano.m17254K(68, userState, UserState.PROTOBUF_ADAPTER);
            }
            PicVerification picVerification = user.verifications;
            if (picVerification != null) {
                codedOutputByteBufferNano.m17254K(69, picVerification, PicVerification.PROTOBUF_ADAPTER);
            }
            List<String> list4 = user.abGroups;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(70, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<PrivateAnswer> list5 = user.privateAnswers;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(71, list5, PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Membership membership2 = user.peepership;
            if (membership2 != null) {
                codedOutputByteBufferNano.m17254K(72, membership2, Membership.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17252I(73, user.picksExpiredTimestamp);
            codedOutputByteBufferNano.m17244A(74, user.picksSwipable);
            String str6 = user.picksTag;
            if (str6 != null) {
                codedOutputByteBufferNano.m17261R(75, str6);
            }
            UserCreditData userCreditData = user.credit;
            if (userCreditData != null) {
                codedOutputByteBufferNano.m17254K(76, userCreditData, UserCreditData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(77, user.goPlaceTimestamp);
            codedOutputByteBufferNano.m17244A(78, user.isLord);
            codedOutputByteBufferNano.m17246C(79, user.privateAnswersUpdatedTime);
            String str7 = user.sendLetter;
            if (str7 != null) {
                codedOutputByteBufferNano.m17261R(80, str7);
            }
            codedOutputByteBufferNano.m17252I(81, user.sendLetterTimestamp);
            String str8 = user.receivedLetter;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(82, str8);
            }
            codedOutputByteBufferNano.m17252I(83, user.receivedLetterTimestamp);
            codedOutputByteBufferNano.m17250G(84, user.popLevel);
            AudioSignature audioSignature = user.voice;
            if (audioSignature != null) {
                codedOutputByteBufferNano.m17254K(85, audioSignature, AudioSignature.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(86, user.datingMode);
            UssTags ussTags = user.ussTags;
            if (ussTags != null) {
                codedOutputByteBufferNano.m17254K(87, ussTags, UssTags.PROTOBUF_ADAPTER);
            }
            UserAbroad userAbroad = user.abroad;
            if (userAbroad != null) {
                codedOutputByteBufferNano.m17254K(88, userAbroad, UserAbroad.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem = user.fakeStatus;
            if (statusesItem != null) {
                codedOutputByteBufferNano.m17254K(89, statusesItem, StatusesItem.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem2 = user.nameStatus;
            if (statusesItem2 != null) {
                codedOutputByteBufferNano.m17254K(90, statusesItem2, StatusesItem.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(91, user.displayAudit);
            VisitPlace visitPlace = user.visitPlace;
            if (visitPlace != null) {
                codedOutputByteBufferNano.m17254K(92, visitPlace, VisitPlace.PROTOBUF_ADAPTER);
            }
            String str9 = user.publicId;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(93, str9);
            }
            UserSoulSettings userSoulSettings = user.soulSettings;
            if (userSoulSettings != null) {
                codedOutputByteBufferNano.m17254K(94, userSoulSettings, UserSoulSettings.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(95, user.richListPosition);
            String str10 = user.richListTracker;
            if (str10 != null) {
                codedOutputByteBufferNano.m17261R(96, str10);
            }
            codedOutputByteBufferNano.m17246C(97, user.diamondVIPExpiresTime);
            String str11 = user.aiTag;
            if (str11 != null) {
                codedOutputByteBufferNano.m17261R(98, str11);
            }
            FriendCommentInfo friendCommentInfo = user.friendCommentInfo;
            if (friendCommentInfo != null) {
                codedOutputByteBufferNano.m17254K(99, friendCommentInfo, FriendCommentInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(100, user.minRichListPosition);
            String str12 = user.ussTracker;
            if (str12 != null) {
                codedOutputByteBufferNano.m17261R(101, str12);
            }
            codedOutputByteBufferNano.m17252I(102, user.localLatestReceivedMessageTime);
            LiveUserLevel liveUserLevel = user.hierarchy;
            if (liveUserLevel != null) {
                codedOutputByteBufferNano.m17254K(103, liveUserLevel, LiveUserLevel.PROTOBUF_ADAPTER);
            }
            SoulShip soulShip = user.localSoulShip;
            if (soulShip != null) {
                codedOutputByteBufferNano.m17254K(104, soulShip, SoulShip.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17246C(105, user.signupTime);
            BanStatus banStatus = user.banStatus;
            if (banStatus != null) {
                codedOutputByteBufferNano.m17254K(106, banStatus, BanStatus.PROTOBUF_ADAPTER);
            }
            List<String> list6 = user.localDiamondPrivateMatchTags;
            if (list6 != null) {
                codedOutputByteBufferNano.m17254K(107, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            AnonymousLikeInfo anonymousLikeInfo = user.anonymousLike;
            if (anonymousLikeInfo != null) {
                codedOutputByteBufferNano.m17254K(108, anonymousLikeInfo, AnonymousLikeInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(109, user.inactivated);
            List<UserStatus> list7 = user.status;
            if (list7 != null) {
                codedOutputByteBufferNano.m17254K(110, list7, UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Gender gender2 = user.gender;
            if (gender2 != null) {
                codedOutputByteBufferNano.m17254K(111, gender2, Gender.PROTOBUF_ADAPTER);
            }
            UserSource userSource2 = user.source;
            if (userSource2 != null) {
                codedOutputByteBufferNano.m17254K(112, userSource2, UserSource.PROTOBUF_ADAPTER);
            }
            ActivityUser activityUser = user.activityUser;
            if (activityUser != null) {
                codedOutputByteBufferNano.m17254K(113, activityUser, ActivityUser.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17244A(114, user.matePlanUser);
            codedOutputByteBufferNano.m17244A(115, user.matePlanAdUser);
            String str13 = user.regionTag;
            if (str13 != null) {
                codedOutputByteBufferNano.m17261R(116, str13);
            }
            List<String> list8 = user.localLikeIdentifiers;
            if (list8 != null) {
                codedOutputByteBufferNano.m17254K(117, list8, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17244A(118, user.deleted);
            SpecialEffect specialEffect = user.specialEffect;
            if (specialEffect != null) {
                codedOutputByteBufferNano.m17254K(119, specialEffect, SpecialEffect.PROTOBUF_ADAPTER);
            }
            UserActivityInfo userActivityInfo = user.userActivityInfo;
            if (userActivityInfo != null) {
                codedOutputByteBufferNano.m17254K(120, userActivityInfo, UserActivityInfo.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(User user, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 29:
                    ...
                    return true;
                case 30:
                    user.f56011id = jsonParser.getValueAsString();
                    return false;
                case 31:
    ...
    public static final StringColumn<User> f38825ID = new StringColumn<User>("id_c") { // from class: com.p1.mobile.putong.data.User.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(User user) {
            return user.f56011id;
        }
    ...
    public static final Column<User, List<String>> PROFILE_EXTENSIONS_ANONYMITY_ID = new Column<User, List<String>>("profile_extensions_anonymity_id_c") { // from class: com.p1.mobile.putong.data.User.119
        @Override // com.tantanapp.common.data.orm.Column
        public List<String> get(User user) {
            return user.profile.extensions.anonymity.f38720id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(User user, List<String> list) {
            user.profile.extensions.anonymity.f38720id = list;
        }
    };
    ...
    public static mrf0<User> DB_ADAPTER = new mrf0<User>() { // from class: com.p1.mobile.putong.data.User.191
        ...
        public User read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i9 = i + 1;
                user.f56011id = cursor.isNull(i9) ? null : cursor.getString(i9);
                int i10 = i + 2;
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    int i85 = i + 119;
                                                    user.profile.extensions.anonymity.f38720id = cursor.isNull(i85) ? null : ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i85));
                                                    int i86 = i + 120;
        ...
        public void write(User user, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", user.f56011id);
                ...
                DbObject.cvPut(contentValues, "profile_extensions_anonymity_id_c", user.profile.extensions.anonymity.f38720id == null ? null : ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().serialize(user.profile.extensions.anonymity.f38720id));
    ...
    public class DefaultRiskAuditUser implements Serializable {
        ...
        public DefaultRiskAuditUser() {
            ...
            try {
                JSONObject jSONObject = new JSONObject(RemoteConfig.m79298x().m79302F("default_user_info"));
    ...
    public static final Pattern NAME_PATTERN() {
        if (f38827np == null) {
            synchronized (User.class) {
                try {
                    if (f38827np == null) {
                        f38827np = Pattern.compile("^[\\p{L}-.\\040]{1,50}$");
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public static /* synthetic */ String m60113b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ StepSignupStage m60114c(StepSignupStage stepSignupStage) {
    ...
    private boolean checkRelationshipStatus() {
        ...
        CrashHelper.m81296c(new NullPointerException("------------localRelationship.status==null------------"));
        return false;
    }
    ...
    private void initAvatarFrame() {
        if (NullChecker.m81303a(this.userAvatarFrame)) {
            return;
        }
        if (!NullChecker.m81303a(this.profile.extensions) || !NullChecker.m81303a(this.profile.extensions.business) || vwb.m200296J(this.profile.extensions.business.avatarID) || vwb.m200296J(this.profile.extensions.business.avatarClose) || vwb.m200296J(this.profile.extensions.business.avatarExpireTime)) {
        ...
        String strM99639x = qib0.f154727p0.m99639x(this.profile.extensions.business.avatarID.get(0));
        UserAvatarFrame userAvatarFrame = this.userAvatarFrame;
        userAvatarFrame.url = strM99639x;
    ...
    private void initLiveAvatarFrame() {
        if (NullChecker.m81303a(this.liveUserAvatarFrame)) {
            return;
        }
        if (!NullChecker.m81303a(this.profile.extensions) || !NullChecker.m81303a(this.profile.extensions.voiceAvatarFrame) || vwb.m200296J(this.profile.extensions.voiceAvatarFrame.f38835id) || vwb.m200296J(this.profile.extensions.voiceAvatarFrame.expiredTime)) {
        ...
        liveUserAvatarFrameNew_.f38777id = this.profile.extensions.voiceAvatarFrame.f38835id.get(0);
        LiveRight liveRightM99640y = qib0.f154727p0.m99640y(this.liveUserAvatarFrame.f38777id);
        if (NullChecker.m81303a(liveRightM99640y)) {
            this.liveUserAvatarFrame.url = liveRightM99640y.getUrl();
        }
        LiveUserAvatarFrame liveUserAvatarFrame = this.liveUserAvatarFrame;
        liveUserAvatarFrame.liveRight = liveRightM99640y;
        try {
    ...
    public static /* synthetic */ UserStatus m60118k(UserStatus userStatus) {
        return userStatus;
    }

    /* JADX INFO: renamed from: n */
    public static /* synthetic */ String m60121n(String str) {
        return str;
    }
    ...
    public static /* synthetic */ String m60122o(String str) {
        return str;
    }

    public boolean boosted() {
        if (this.f56011id.equals(qib0.f154714c0.userId()) || isTeamAccount() || this.localRelationship == null || !checkRelationshipStatus()) {
            return false;
        }
    ...
    public User mo223809clone() {
        User user = new User();
        user._id = this._id;
        user.f56011id = this.f56011id;
        user.name = this.name;
        Location location = this.location;
        if (location != null) {
            user.location = location.mo223809clone();
        }
        ...
        if (profile != null) {
            user.profile = profile.mo223809clone();
        }
        ...
        if (list2 != null) {
            user.status = ValueObject.util_map(list2, new w9j() { // from class: l.exj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return User.m60118k((UserStatus) obj);
                }
            });
        }
        Settings settings = this.settings;
        if (settings != null) {
            user.settings = settings.mo223809clone();
        }
        user.gender = this.gender;
        Relationship relationship = this.localRelationship;
        if (relationship != null) {
            user.localRelationship = relationship.mo223809clone();
        }
        Membership membership = this.membership;
        if (membership != null) {
            user.membership = membership.mo223809clone();
        }
        user.source = this.source;
        user.realName = this.realName;
        Followship followship = this.localFollowship;
        if (followship != null) {
            user.localFollowship = followship.mo223809clone();
        }
        ...
        if (list3 != null) {
            user.memberships = ValueObject.util_map(list3, new w9j() { // from class: l.fxj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((Membership) obj).mo223809clone();
                }
            });
        }
        ...
        if (userState != null) {
            user.state = userState.mo223809clone();
        }
        PicVerification picVerification = this.verifications;
        if (picVerification != null) {
            user.verifications = picVerification.mo223809clone();
        }
        ...
        if (list4 != null) {
            user.abGroups = ValueObject.util_map(list4, new w9j() { // from class: l.gxj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return User.m60121n((String) obj);
                }
            });
        }
        ...
        if (list5 != null) {
            user.privateAnswers = ValueObject.util_map(list5, new w9j() { // from class: l.hxj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((PrivateAnswer) obj).mo223809clone();
                }
            });
        }
        Membership membership2 = this.peepership;
        if (membership2 != null) {
            user.peepership = membership2.mo223809clone();
        }
        ...
        if (userCreditData != null) {
            user.credit = userCreditData.mo223809clone();
        }
        ...
        if (userMedalWrapper != null) {
            user.medal = userMedalWrapper.mo223809clone();
        }
        VisitPlace visitPlace = this.visitPlace;
        if (visitPlace != null) {
            user.visitPlace = visitPlace.mo223809clone();
        }
        user.signupStage = this.signupStage;
        user.publicId = this.publicId;
        Broadcast broadcast = this.broadcast;
        if (broadcast != null) {
            user.broadcast = broadcast.mo223809clone();
        }
        UserSoulSettings userSoulSettings = this.soulSettings;
        if (userSoulSettings != null) {
            user.soulSettings = userSoulSettings.mo223809clone();
        }
        ...
        if (richListUsers != null) {
            user.localRichListUsers = richListUsers.mo223809clone();
        }
        ...
        if (liveRevenueCampaignVip != null) {
            user.liveRevenueCampaignVip = liveRevenueCampaignVip.mo223809clone();
        }
        ...
        if (friendCommentInfo != null) {
            user.friendCommentInfo = friendCommentInfo.mo223809clone();
        }
        TotalRewardPoint totalRewardPoint = this.totalRewardPoint;
        if (totalRewardPoint != null) {
            user.totalRewardPoint = totalRewardPoint.mo223809clone();
        }
        ...
        if (list6 != null) {
            user.localDiamondPrivateMatchTags = ValueObject.util_map(list6, new w9j() { // from class: l.ixj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return User.m60122o((String) obj);
                }
            });
        }
        AnonymousLikeInfo anonymousLikeInfo = this.anonymousLike;
        if (anonymousLikeInfo != null) {
            user.anonymousLike = anonymousLikeInfo.mo223809clone();
        }
        ...
        if (list7 != null) {
            user.finishedStages = ValueObject.util_map(list7, new w9j() { // from class: l.jxj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return User.m60114c((StepSignupStage) obj);
                }
            });
        }
        ...
        if (activityUser != null) {
            user.activityUser = activityUser.mo223809clone();
        }
        ...
        if (list8 != null) {
            user.localLikeIdentifiers = ValueObject.util_map(list8, new w9j() { // from class: l.zwj0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return User.m60113b((String) obj);
                }
            });
        }
    ...
    public String getAiPictureStatus() {
        return NullChecker.m81303a(this.settings) ? this.settings.getAiPictureEnable() : "none";
    }
    ...
    public String getAnonymousUrl() {
        return !vwb.m200296J(this.profile.extensions.live.voiceImgUrl) ? this.profile.extensions.live.voiceImgUrl.get(0) : "";
    }
    ...
    public String getCurrentPureMode() {
        ...
        Settings settings = this.settings;
        return (settings == null || vwb.m200296J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userLiveSettings = settingGroup.live) == null) ? "" : userLiveSettings.pureModeGroup;
    }
    ...
    public int getFriendCommentCount() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        if (friendCommentInfo == null || vwb.m200296J(friendCommentInfo.friendsComments)) {
            return 0;
        }
    ...
    public int getFriendHistoryCommentCount() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        if (friendCommentInfo == null || vwb.m200296J(friendCommentInfo.friendsCommentsHistory)) {
            return 0;
        }
    ...
    public String getHometown() {
        if (!NullChecker.m81303a(this.profile) || !NullChecker.m81303a(this.profile.extensions) || !NullChecker.m81303a(this.profile.extensions.basic)) {
            return "";
        }
        if (!vwb.m200296J(this.profile.extensions.basic.city) && !TextUtils.isEmpty(this.profile.extensions.basic.city.get(0))) {
            return this.profile.extensions.basic.city.get(0);
        }
        if (vwb.m200296J(this.profile.extensions.basic.province) || TextUtils.isEmpty(this.profile.extensions.basic.province.get(0))) {
            return !vwb.m200296J(this.profile.extensions.basic.country) ? this.profile.extensions.basic.country.get(0) : "";
        }
    ...
    public List<String> getIdealList() {
        if (!NullChecker.m81303a(this.profile) || !NullChecker.m81303a(this.profile.extensions) || !NullChecker.m81303a(this.profile.extensions.basic) || vwb.m200296J(this.profile.extensions.basic.ideal)) {
            return null;
        }
    ...
    public List<String> getMarryLifeMoment() {
        if (NullChecker.m81303a(this.profile) && NullChecker.m81303a(this.profile.extensions) && NullChecker.m81303a(this.profile.extensions.marriage) && !vwb.m200296J(this.profile.extensions.marriage.lifeMoment)) {
    ...
    public long getMembershipExpireTime(final MembershipType membershipType) {
        ArrayList arrayListM200339n = vwb.m200339n(this.memberships, new w9j() { // from class: l.bxj0
            @Override // p149l.w9j
            public final Object call(Object obj) {
    ...
    public String getQualificationText() {
        if (!NullChecker.m81303a(this.profile) || !NullChecker.m81303a(this.profile.extensions) || !NullChecker.m81303a(this.profile.extensions.basic) || vwb.m200296J(this.profile.extensions.basic.qualification)) {
            return "";
        }
    ...
    public int getSupremePartnerUserCode() {
        if (NullChecker.m81303a(this.settings)) {
    ...
    public String getUserHeight() {
        if (!NullChecker.m81303a(this.profile) || !NullChecker.m81303a(this.profile.extensions) || !NullChecker.m81303a(this.profile.extensions.physical) || vwb.m200296J(this.profile.extensions.physical.height)) {
            return "";
        }
        List<String> list = this.profile.extensions.physical.height;
        return (vwb.m200296J(list) || TextUtils.isEmpty(list.get(0))) ? "" : list.get(0);
    }
    ...
    public String getUserInfoForMarryStatus() {
        ...
        Settings settings = this.settings;
        return (settings == null || vwb.m200296J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (marrySettings = settingGroup.marriage) == null || TextUtils.isEmpty(marrySettings.profileAudit)) ? "" : settingGroup.marriage.profileAudit;
    }

    public uqd0 getUserName() {
        return new uqd0("UserName" + this.f56011id, "");
    }

    public uqd0 getUserPicture() {
        return new uqd0("UserPicture" + this.f56011id, "");
    }
    ...
    public long getVipExpireTime() {
        return vwb.m200339n(this.memberships, new w9j() { // from class: l.ywj0
            @Override // p149l.w9j
            public final Object call(Object obj) {
    ...
    public long getVipToExpireTimeInMill() {
        return getVipExpireTime() - qib0.f154693H.guessedCurrentServerTime();
    }
    ...
    public boolean hasAuditedMarray() {
        ...
        MarrySettings marrySettings;
        Settings settings = this.settings;
        if (settings == null || vwb.m200296J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (marrySettings = settingGroup.marriage) == null) {
            return false;
        }
    ...
    public boolean hasFriendComment() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        return (friendCommentInfo == null || vwb.m200296J(friendCommentInfo.friendsComments)) ? false : true;
    }

    public boolean hasHistoryFriendComment() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        return (friendCommentInfo == null || vwb.m200296J(friendCommentInfo.friendsCommentsHistory)) ? false : true;
    }

    public boolean hasIdealInfo() {
        return NullChecker.m81303a(this.profile) && NullChecker.m81303a(this.profile.extensions) && NullChecker.m81303a(this.profile.extensions.basic) && !vwb.m200296J(this.profile.extensions.basic.ideal);
    }
    ...
    public boolean hasPic() {
        return (vwb.m200296J(this.pictures) || TextUtils.isEmpty(this.pictures.get(0).url)) ? false : true;
    }
    ...
    public boolean hideBlackDiamondTag() {
        ...
        UserLiveSettings userLiveSettings;
        Settings settings = this.settings;
        if (settings == null || vwb.m200296J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userLiveSettings = settingGroup.live) == null) {
            return false;
        }
    ...
    public boolean isChatJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.chat)) {
            return false;
        }
        JailedGroupChat jailedGroupChat = this.state.jailedBusiness.chat;
        return jailedGroupChat.active && jailedGroupChat.expireTime > ((double) mqi0.m155944o());
    }
    ...
    public boolean isFakeUser() {
        return !vwb.m200296J(this.status) && this.status.contains(UserStatus.get("hidden")) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_UNREAL));
    }
    ...
    public boolean isGreetingJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.greeting)) {
            return false;
        }
    ...
    public boolean isHideActiveFromSVip() {
        ...
        if (NullChecker.m81303a(this.settings) && !vwb.m200296J(this.settings.settingGroups)) {
            SettingGroups settingGroup = this.settings.getSettingGroup();
            if (NullChecker.m81303a(settingGroup) && (svipPrivacySettings = settingGroup.svipPrivacy) != null && svipPrivacySettings.frozenTime != 0) {
                return true;
            }
        }
        return false;
    ...
    public boolean isHideAgeForTeamAccount() {
        return TextUtils.equals(ID_VERIVICATION_ASSISTANT, this.f56011id);
    }
    ...
    public boolean isHideIconFromSVip() {
        SvipPrivacySettings svipPrivacySettings;
        if (isMe() || !NullChecker.m81303a(this.settings) || vwb.m200296J(this.settings.settingGroups)) {
            return false;
        }
        SettingGroups settingGroup = this.settings.getSettingGroup();
        if (!NullChecker.m81303a(settingGroup) || (svipPrivacySettings = settingGroup.svipPrivacy) == null) {
    ...
    public boolean isHideIconFromSVipWithMe() {
        if (NullChecker.m81303a(this.settings) && !vwb.m200296J(this.settings.settingGroups)) {
            SettingGroups settingGroup = this.settings.getSettingGroup();
            if (NullChecker.m81303a(settingGroup) && NullChecker.m81303a(settingGroup.svipPrivacy)) {
    ...
    public boolean isIntlFaceless() {
        if (NullChecker.m81303a(this.status)) {
    ...
    public boolean isLiveJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.live)) {
            return false;
        }
    ...
    public boolean isLoveBuzz() {
        if (isMe() || isTeamAccount() || !NullChecker.m81303a(this.localRelationship)) {
            return false;
        }
    ...
    public boolean isMe() {
        return TextUtils.equals(this.f56011id, qib0.f154714c0.userId());
    }

    public boolean isMembership(MembershipType membershipType) {
        return getMembershipExpireTime(membershipType) - qib0.f154693H.guessedCurrentServerTime() > 0;
    }
    ...
    public boolean isMomentCommentJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.momentComment)) {
            return false;
        }
    ...
    public boolean isMomentJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.moment)) {
            return false;
        }
    ...
    public boolean isNewHere() {
        if (newHereDay < 0) {
            try {
                String strM79302F = RemoteConfig.m79298x().m79302F("ttt_new_here_days");
                if (TextUtils.isEmpty(strM79302F)) {
                    newHereDay = 7;
                } else {
                    newHereDay = new JSONObject(strM79302F).optInt("register_days");
                }
            } catch (Exception unused) {
                newHereDay = 7;
            }
        }
        return this.createdTime > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && newHereDay > 0 && ((double) mqi0.m155944o()) - this.createdTime <= ((double) (newHereDay * 86400000));
    }
    ...
    public boolean isNewUserIn24H() {
        return !mqi0.m155952w((long) this.createdTime, 24);
    }
    ...
    public boolean isOnCityTop() {
        return NullChecker.m81303a(this.settings) && this.settings.isCityTop();
    }
    ...
    public boolean isProfileJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.changeProfile)) {
            return false;
        }
    ...
    public boolean isRiskAuditAvatar() {
        return NullChecker.m81303a(this.status) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_AVATAR_IN_AUDIT));
    }

    public boolean isRiskAuditName() {
        return NullChecker.m81303a(this.status) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_NAME_IN_AUDIT));
    }
    ...
    public boolean isSVIP() {
        ...
        Settings settings = this.settings;
        if (settings == null || vwb.m200296J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userSVIPSettings = settingGroup.svip) == null) {
            return false;
        }
    ...
    public boolean isStudentVerified() {
        boolean z = NullChecker.m81303a(this.settings) && NullChecker.m81303a(this.settings.verification) && NullChecker.m81303a(this.settings.verification.studies) && TEnum.equals(this.settings.verification.studies.status, "verified");
    ...
    public boolean isSupremePartnerOpenMystery() {
        return NullChecker.m81303a(this.settings) && this.settings.isSupremePartner() && this.settings.isSupremePartnerOpenMystery();
    }

    public boolean isSwipeJailed() {
        if (!NullChecker.m81303a(this.state) || !NullChecker.m81303a(this.state.jailedBusiness) || !NullChecker.m81303a(this.state.jailedBusiness.swipe)) {
            return false;
        }
    ...
    public boolean isUltraPremium() {
        ...
        Settings settings = this.settings;
        if (settings == null || vwb.m200296J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userUpVipSettings = settingGroup.upvip) == null) {
            return false;
        }
    ...
    public boolean isYoungRisk() {
        return NullChecker.m81303a(this.status) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_MANDATORY_IDENTITY_VERIFICATION_UNDERAGE));
    }

    public boolean jailedBusinessChatHadReason() {
        return (NullChecker.m81303a(this.state) && NullChecker.m81303a(this.state.jailedBusiness) && NullChecker.m81303a(this.state.jailedBusiness.chat) && TextUtils.equals(this.state.jailedBusiness.chat.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessMomentCommentHadReason() {
        return (NullChecker.m81303a(this.state) && NullChecker.m81303a(this.state.jailedBusiness) && NullChecker.m81303a(this.state.jailedBusiness.momentComment) && TextUtils.equals(this.state.jailedBusiness.momentComment.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessMomentHadReason() {
        return (NullChecker.m81303a(this.state) && NullChecker.m81303a(this.state.jailedBusiness) && NullChecker.m81303a(this.state.jailedBusiness.moment) && TextUtils.equals(this.state.jailedBusiness.moment.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessProfileHadReason() {
        return (NullChecker.m81303a(this.state) && NullChecker.m81303a(this.state.jailedBusiness) && NullChecker.m81303a(this.state.jailedBusiness.changeProfile) && TextUtils.equals(this.state.jailedBusiness.changeProfile.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessSwipeHadReason() {
        return (NullChecker.m81303a(this.state) && NullChecker.m81303a(this.state.jailedBusiness) && NullChecker.m81303a(this.state.jailedBusiness.swipe) && TextUtils.equals(this.state.jailedBusiness.swipe.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean lessThanFifteenPrivateAnswer() {
        return vwb.m200339n(this.privateAnswers, new w9j() { // from class: l.axj0
            @Override // p149l.w9j
            public final Object call(Object obj) {
    ...
    public boolean lessThanFivePrivateAnswer() {
        return vwb.m200339n(this.privateAnswers, new w9j() { // from class: l.cxj0
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return Boolean.valueOf(!TextUtils.isEmpty(((PrivateAnswer) obj).selection));
            }
    ...
    public boolean letter() {
        if (this.f56011id.equals(qib0.f154714c0.userId()) || isTeamAccount()) {
            return false;
        }
    ...
    public String letterString() {
        if (letter()) {
            return (NullChecker.m81303a(this.localRelationship) && NullChecker.m81303a(this.localRelationship.relationshipExtensions)) ? this.localRelationship.relationshipExtensions.otherLetter : this.sendLetter;
        }
        return null;
    }
    ...
    public boolean likedMe() {
        Relationship relationship;
        if (this.f56011id.equals(qib0.f154714c0.userId()) || isTeamAccount() || (relationship = this.localRelationship) == null) {
            return false;
        }
    ...
    public void onApiParseComplete() {
        ...
        if (isRiskAudit()) {
            ...
            if (isRiskAuditAvatar()) {
                ...
                this.pictures.get(0).url = TextUtils.isEmpty(gl5.f103296d.get()) ? getDefaultRiskAuditUser().userPicture : gl5.f103296d.get();
            }
        }
    }
    ...
    public int parseRelationStatus() {
        if (isTeamAccount(this.f56011id)) {
            return 3;
        }
        if (isMe()) {
            return 4;
        }
        if (NullChecker.m81303a(this.localRelationship) && TEnum.equals(this.localRelationship.state, "matched")) {
            return 0;
        }
        if (NullChecker.m81303a(this.localFollowship) && NullChecker.m81303a(this.localFollowship.maskState) && (TEnum.equals(this.localFollowship.maskState, FollowshipStatus.followed) || TEnum.equals(this.localFollowship.maskState, FollowshipStatus.following) || TEnum.equals(this.localFollowship.maskState, "matched"))) {
            return 1;
        }
        if (NullChecker.m81303a(this.localFollowship) && NullChecker.m81303a(this.localFollowship.state)) {
    ...
    public int receiveSuperLikeNum() {
        if (NullChecker.m81303a(this.localRelationship) && NullChecker.m81303a(this.localRelationship.relationshipExtensions)) {
            try {
    ...
    public String relativeTimeForTrack() {
        ...
        long jGuessedCurrentServerTime = (qib0.f154693H.guessedCurrentServerTime() - lastActiveTimeMillis) / 1000;
    ...
    public User riskAuditUser(User user) {
        ...
        User userMo223809clone = mo223809clone();
        if (isRiskAuditAvatar()) {
            userMo223809clone.pictures.get(0).url = user.pictures.get(0).url;
        }
        if (isRiskAuditName()) {
            userMo223809clone.name = user.name;
        }
    ...
    public void showPicVerificationIcon(View view, VImage vImage) {
        qib0.f154713b0.f139231b.showUserVerificationLogo(vImage.getContext(), this, vImage);
        if (jjb0.m141784b()) {
            xdl0.m208344M(view, xdl0.m208349O0(vImage));
        } else {
            xdl0.m208344M(view, isPicVerificationVerified());
        }
    }
    ...
    public boolean unilateralBlock() {
        ...
        boolean zM141787e = jjb0.m141787e();
        Relationship relationship = this.localRelationship;
        if (zM141787e) {
    ...
    public boolean isTeamAccount() {
        return this.status.contains(UserStatus.get("teamaccount")) || isTeamAccount(this.f56011id);
    }
}
