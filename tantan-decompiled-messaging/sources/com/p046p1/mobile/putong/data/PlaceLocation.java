...
public class PlaceLocation extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PlaceLocation> PROTOBUF_ADAPTER = new MessageNanoAdapter<PlaceLocation>() { // from class: com.p1.mobile.putong.data.PlaceLocation.1
        ...
        public int computeAndCacheSize(PlaceLocation placeLocation) {
            int iM17222d = CodedOutputByteBufferNano.m17222d(1, placeLocation.lat) + CodedOutputByteBufferNano.m17222d(2, placeLocation.lng);
            placeLocation.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PlaceLocation parse(nb5 nb5Var) throws IOException {
            PlaceLocation placeLocation = new PlaceLocation();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 9) {
                    placeLocation.lat = nb5Var.m158739h();
                } else {
                    if (iM158752u != 17) {
                        return placeLocation;
                    }
                    placeLocation.lng = nb5Var.m158739h();
                }
            }
        }
        ...
        public void serialize(PlaceLocation placeLocation, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17246C(1, placeLocation.lat);
            codedOutputByteBufferNano.m17246C(2, placeLocation.lng);
        }
    };
    ...
    public PlaceLocation mo223809clone() {
        PlaceLocation placeLocation = new PlaceLocation();
