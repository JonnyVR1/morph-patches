...
public class FollowshipCounter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FollowshipCounter> PROTOBUF_ADAPTER = new MessageNanoAdapter<FollowshipCounter>() { // from class: com.p1.mobile.putong.data.FollowshipCounter.1
        ...
        public int computeAndCacheSize(FollowshipCounter followshipCounter) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, followshipCounter.followings) + CodedOutputByteBufferNano.m17226h(2, followshipCounter.followers);
            followshipCounter.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FollowshipCounter parse(nb5 nb5Var) throws IOException {
            FollowshipCounter followshipCounter = new FollowshipCounter();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    followshipCounter.followings = nb5Var.m158741j();
                } else {
                    if (iM158752u != 16) {
                        return followshipCounter;
                    }
                    followshipCounter.followers = nb5Var.m158741j();
                }
            }
        }
        ...
        public void serialize(FollowshipCounter followshipCounter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, followshipCounter.followings);
            codedOutputByteBufferNano.m17250G(2, followshipCounter.followers);
        }
    };
    ...
    public FollowshipCounter mo223809clone() {
        FollowshipCounter followshipCounter = new FollowshipCounter();
