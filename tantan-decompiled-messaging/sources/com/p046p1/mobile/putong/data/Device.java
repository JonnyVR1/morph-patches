...
public class Device extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Device> PROTOBUF_ADAPTER = new MessageNanoAdapter<Device>() { // from class: com.p1.mobile.putong.data.Device.1
        ...
        public int computeAndCacheSize(Device device) {
            String str = device.f38738id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            DevicePush devicePush = device.pushNotifications;
            if (devicePush != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(2, devicePush, DevicePush.PROTOBUF_ADAPTER);
            }
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, list, DeviceIdentifier.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (deviceOs != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, deviceOs, DeviceOs.PROTOBUF_ADAPTER);
            }
            String str5 = device.name;
            if (str5 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(8, str5);
            }
            ...
            if (list2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(11, list2, DevicePush.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str8 = device.appUIVersion;
            if (str8 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(12, str8);
            }
            String str9 = device.brand;
            if (str9 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(13, str9);
            }
            String str10 = device.oneid;
            if (str10 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(14, str10);
            }
            Map<String, String> map = device.pluginVersion;
            if (map != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(15, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(16, device.created_time);
            String str11 = device.bundleId;
            if (str11 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(17, str11);
            }
            device.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Device parse(nb5 nb5Var) throws IOException {
            Device device = new Device();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (device.f38738id == null) {
                            device.f38738id = "";
                        }
                        ...
                        break;
                    case 10:
                        device.f38738id = nb5Var.m158750s();
                        continue;
                    case 18:
                        device.pushNotifications = (DevicePush) nb5Var.m158743l(DevicePush.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        device.identifier = nb5Var.m158750s();
                        continue;
                    case 34:
                        device.identifiers = (List) nb5Var.m158743l(DeviceIdentifier.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        device.appVersion = nb5Var.m158750s();
                        continue;
                    case 50:
                        device.appBuild = nb5Var.m158750s();
                        continue;
                    case 58:
                        device.operatingSystem = (DeviceOs) nb5Var.m158743l(DeviceOs.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        device.name = nb5Var.m158750s();
                        continue;
                    case 74:
                        device.language = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        device.locale = nb5Var.m158750s();
                        continue;
                    case 90:
                        device.devicePushNotifications = (List) nb5Var.m158743l(DevicePush.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        device.appUIVersion = nb5Var.m158750s();
                        continue;
                    case 106:
                        device.brand = nb5Var.m158750s();
                        continue;
                    case 114:
                        device.oneid = nb5Var.m158750s();
                        continue;
                    case 122:
                        device.pluginVersion = (Map) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
                        continue;
                    case MMConstants.ERR_WATERMARK_READ /* 129 */:
                        device.created_time = nb5Var.m158739h();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        device.bundleId = nb5Var.m158750s();
                        continue;
                    default:
                        if (device.f38738id == null) {
                            device.f38738id = "";
        ...
        public void serialize(Device device, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            DevicePush devicePush = device.pushNotifications;
            if (devicePush != null) {
                codedOutputByteBufferNano.m17254K(2, devicePush, DevicePush.PROTOBUF_ADAPTER);
            }
            String str2 = device.identifier;
            if (str2 != null) {
            ...
            List<DeviceIdentifier> list = device.identifiers;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(4, list, DeviceIdentifier.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = device.appVersion;
            if (str3 != null) {
            ...
            DeviceOs deviceOs = device.operatingSystem;
            if (deviceOs != null) {
                codedOutputByteBufferNano.m17254K(7, deviceOs, DeviceOs.PROTOBUF_ADAPTER);
            }
            String str5 = device.name;
            if (str5 != null) {
            ...
            List<DevicePush> list2 = device.devicePushNotifications;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(11, list2, DevicePush.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str8 = device.appUIVersion;
            if (str8 != null) {
            ...
            codedOutputByteBufferNano.m17246C(16, device.created_time);
            String str11 = device.bundleId;
            if (str11 != null) {
                codedOutputByteBufferNano.m17261R(17, str11);
            }
        }
    };
        ...
        public boolean parseField(Device device, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    device.f38738id = jsonParser.getValueAsString();
                    return false;
                case 9:
    ...
    public static /* synthetic */ String m59744a(String str) {
        return str;
    }
    ...
    public Device mo223809clone() {
        Device device = new Device();
        device.f38738id = this.f38738id;
        DevicePush devicePush = this.pushNotifications;
        if (devicePush != null) {
            device.pushNotifications = devicePush.mo223809clone();
        }
        ...
        if (list != null) {
            device.identifiers = ValueObject.util_map(list, new w9j() { // from class: l.qxd
                ...
                public final Object call(Object obj) {
                    return ((DeviceIdentifier) obj).mo223809clone();
                }
            });
        }
        ...
        if (deviceOs != null) {
            device.operatingSystem = deviceOs.mo223809clone();
        }
        ...
        if (list2 != null) {
            device.devicePushNotifications = ValueObject.util_map(list2, new w9j() { // from class: l.rxd
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((DevicePush) obj).mo223809clone();
                }
            });
        }
        ...
        if (map != null) {
            device.pluginVersion = ValueObject.util_map(map, new w9j() { // from class: l.sxd
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Device.m59744a((String) obj);
                }
            });
        }
    ...
    public Device subtract(Device device) {
        ...
        if (!ValueObject.util_equals(this.f38738id, device.f38738id)) {
            device2.f38738id = this.f38738id;
        }
