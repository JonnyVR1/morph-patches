...
public class LiveBubbleConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveBubbleConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveBubbleConfig>() { // from class: com.p1.mobile.putong.data.LiveBubbleConfig.1
        ...
        public int computeAndCacheSize(LiveBubbleConfig liveBubbleConfig) {
            String str = liveBubbleConfig.f38770id;
            ...
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(7, liveBubbleConfig.bubbleShowAfterWatch) + CodedOutputByteBufferNano.m17226h(8, liveBubbleConfig.bubbleDisappear) + CodedOutputByteBufferNano.m17226h(9, liveBubbleConfig.bubbleEveryDayShowMaxCount) + CodedOutputByteBufferNano.m17226h(10, liveBubbleConfig.bubbleUserShowMaxCount) + CodedOutputByteBufferNano.m17220b(11, liveBubbleConfig.needCheckHasEnterSquare) + CodedOutputByteBufferNano.m17220b(12, liveBubbleConfig.needCheckHasEnterLive) + CodedOutputByteBufferNano.m17228j(13, liveBubbleConfig.bubbleTimeInterval);
            String str6 = liveBubbleConfig.subType;
            if (str6 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(14, str6);
            }
            int iM17226h2 = iM17226h + CodedOutputByteBufferNano.m17226h(15, liveBubbleConfig.bubbleShowNotMatchedTimes) + CodedOutputByteBufferNano.m17226h(16, liveBubbleConfig.bubbleShowDisappearDays);
            liveBubbleConfig.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveBubbleConfig parse(nb5 nb5Var) throws IOException {
            LiveBubbleConfig liveBubbleConfig = new LiveBubbleConfig();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (liveBubbleConfig.f38770id == null) {
                            liveBubbleConfig.f38770id = "";
                        }
                        ...
                        break;
                    case 10:
                        liveBubbleConfig.f38770id = nb5Var.m158750s();
                        continue;
                    case 18:
                        liveBubbleConfig.type = nb5Var.m158750s();
                        continue;
                    case 26:
                        liveBubbleConfig.bubbleTextList = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        liveBubbleConfig.bubbleTextColor = nb5Var.m158750s();
                        continue;
                    case 42:
                        liveBubbleConfig.bubbleStartColor = nb5Var.m158750s();
                        continue;
                    case 50:
                        liveBubbleConfig.bubbleEndColor = nb5Var.m158750s();
                        continue;
                    case 56:
                        liveBubbleConfig.bubbleShowAfterWatch = nb5Var.m158741j();
                        continue;
                    case 64:
                        liveBubbleConfig.bubbleDisappear = nb5Var.m158741j();
                        continue;
                    case 72:
                        liveBubbleConfig.bubbleEveryDayShowMaxCount = nb5Var.m158741j();
                        continue;
                    case 80:
                        liveBubbleConfig.bubbleUserShowMaxCount = nb5Var.m158741j();
                        continue;
                    case 88:
                        liveBubbleConfig.needCheckHasEnterSquare = nb5Var.m158738g();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        liveBubbleConfig.needCheckHasEnterLive = nb5Var.m158738g();
                        continue;
                    case 104:
                        liveBubbleConfig.bubbleTimeInterval = nb5Var.m158742k();
                        continue;
                    case 114:
                        liveBubbleConfig.subType = nb5Var.m158750s();
                        continue;
                    case 120:
                        liveBubbleConfig.bubbleShowNotMatchedTimes = nb5Var.m158741j();
                        continue;
                    case 128:
                        liveBubbleConfig.bubbleShowDisappearDays = nb5Var.m158741j();
                        continue;
                    default:
                        if (liveBubbleConfig.f38770id == null) {
                            liveBubbleConfig.f38770id = "";
        ...
        public void serialize(LiveBubbleConfig liveBubbleConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17250G(7, liveBubbleConfig.bubbleShowAfterWatch);
            codedOutputByteBufferNano.m17250G(8, liveBubbleConfig.bubbleDisappear);
            codedOutputByteBufferNano.m17250G(9, liveBubbleConfig.bubbleEveryDayShowMaxCount);
            codedOutputByteBufferNano.m17250G(10, liveBubbleConfig.bubbleUserShowMaxCount);
            codedOutputByteBufferNano.m17244A(11, liveBubbleConfig.needCheckHasEnterSquare);
            codedOutputByteBufferNano.m17244A(12, liveBubbleConfig.needCheckHasEnterLive);
            codedOutputByteBufferNano.m17252I(13, liveBubbleConfig.bubbleTimeInterval);
            String str6 = liveBubbleConfig.subType;
            if (str6 != null) {
                codedOutputByteBufferNano.m17261R(14, str6);
            }
            codedOutputByteBufferNano.m17250G(15, liveBubbleConfig.bubbleShowNotMatchedTimes);
            codedOutputByteBufferNano.m17250G(16, liveBubbleConfig.bubbleShowDisappearDays);
        }
    };
        ...
        public boolean parseField(LiveBubbleConfig liveBubbleConfig, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 6:
                    ...
                    return true;
                case 7:
                    liveBubbleConfig.f38770id = jsonParser.getValueAsString();
                    return false;
                case 8:
    ...
    public static /* synthetic */ String m59831a(String str) {
        return str;
    }
    ...
    public LiveBubbleConfig mo223809clone() {
        LiveBubbleConfig liveBubbleConfig = new LiveBubbleConfig();
        liveBubbleConfig.f38770id = this.f38770id;
        ...
        if (list != null) {
            liveBubbleConfig.bubbleTextList = ValueObject.util_map(list, new w9j() { // from class: l.czr
                ...
                public final Object call(Object obj) {
                    return LiveBubbleConfig.m59831a((String) obj);
                }
            });
        }
