...
public class IntlOperationEnvelope extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlOperationEnvelope> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlOperationEnvelope>() { // from class: com.p1.mobile.putong.data.IntlOperationEnvelope.1
        ...
        public int computeAndCacheSize(IntlOperationEnvelope intlOperationEnvelope) {
            ...
            if (intlOperationData != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, intlOperationData, IntlOperationData.PROTOBUF_ADAPTER);
            }
            IntlOperationCounters intlOperationCounters = intlOperationEnvelope.counters;
            if (intlOperationCounters != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, intlOperationCounters, IntlOperationCounters.PROTOBUF_ADAPTER);
            }
            intlOperationEnvelope.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlOperationEnvelope parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    intlOperationEnvelope.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    intlOperationEnvelope.data = (IntlOperationData) nb5Var.m158743l(IntlOperationData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 26) {
                        if (intlOperationEnvelope.meta == null) {
                            intlOperationEnvelope.meta = Meta.new_();
                    ...
                    intlOperationEnvelope.counters = (IntlOperationCounters) nb5Var.m158743l(IntlOperationCounters.PROTOBUF_ADAPTER);
                }
            }
            return intlOperationEnvelope;
        }
        ...
        public void serialize(IntlOperationEnvelope intlOperationEnvelope, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            IntlOperationData intlOperationData = intlOperationEnvelope.data;
            if (intlOperationData != null) {
                codedOutputByteBufferNano.m17254K(2, intlOperationData, IntlOperationData.PROTOBUF_ADAPTER);
            }
            IntlOperationCounters intlOperationCounters = intlOperationEnvelope.counters;
            if (intlOperationCounters != null) {
                codedOutputByteBufferNano.m17254K(3, intlOperationCounters, IntlOperationCounters.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public IntlOperationEnvelope mo223809clone() {
        IntlOperationEnvelope intlOperationEnvelope = new IntlOperationEnvelope();
        Meta meta = this.meta;
        if (meta != null) {
            intlOperationEnvelope.meta = meta.mo223809clone();
        }
        IntlOperationData intlOperationData = this.data;
        if (intlOperationData != null) {
            intlOperationEnvelope.data = intlOperationData.mo223809clone();
        }
        IntlOperationCounters intlOperationCounters = this.counters;
        if (intlOperationCounters != null) {
            intlOperationEnvelope.counters = intlOperationCounters.mo223809clone();
        }
        return intlOperationEnvelope;
    }
