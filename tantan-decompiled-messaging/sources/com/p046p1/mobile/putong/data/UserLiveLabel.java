...
public class UserLiveLabel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserLiveLabel> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserLiveLabel>() { // from class: com.p1.mobile.putong.data.UserLiveLabel.1
        ...
        public int computeAndCacheSize(UserLiveLabel userLiveLabel) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(7, userLiveLabel.ongoingCall);
            ...
            if (str9 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(10, str9);
            }
            String str10 = userLiveLabel.groupId;
            if (str10 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(11, str10);
            }
            LiveMultiCallInfoInLabel liveMultiCallInfoInLabel = userLiveLabel.multiCallInfo;
            if (liveMultiCallInfoInLabel != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(12, liveMultiCallInfoInLabel, LiveMultiCallInfoInLabel.PROTOBUF_ADAPTER);
            }
            String str11 = userLiveLabel.schema;
            if (str11 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(13, str11);
            }
            userLiveLabel.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserLiveLabel parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        userLiveLabel.mainTitle = nb5Var.m158750s();
                        continue;
                    case 18:
                        userLiveLabel.subTitle = nb5Var.m158750s();
                        continue;
                    case 26:
                        userLiveLabel.iconTitle = nb5Var.m158750s();
                        continue;
                    case 34:
                        userLiveLabel.userId = nb5Var.m158750s();
                        continue;
                    case 42:
                        userLiveLabel.buttonTitle = nb5Var.m158750s();
                        continue;
                    case 50:
                        userLiveLabel.liveId = nb5Var.m158750s();
                        continue;
                    case 56:
                        userLiveLabel.ongoingCall = nb5Var.m158738g();
                        continue;
                    case 66:
                        userLiveLabel.liveState = nb5Var.m158750s();
                        continue;
                    case 74:
                        userLiveLabel.anchorId = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        userLiveLabel.voiceRoomTopicId = nb5Var.m158750s();
                        continue;
                    case 90:
                        userLiveLabel.groupId = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        userLiveLabel.multiCallInfo = (LiveMultiCallInfoInLabel) nb5Var.m158743l(LiveMultiCallInfoInLabel.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        userLiveLabel.schema = nb5Var.m158750s();
                        continue;
                    default:
                        if (userLiveLabel.mainTitle == null) {
                            userLiveLabel.mainTitle = "";
        ...
        public void serialize(UserLiveLabel userLiveLabel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(7, userLiveLabel.ongoingCall);
            String str7 = userLiveLabel.liveState;
            if (str7 != null) {
            ...
            LiveMultiCallInfoInLabel liveMultiCallInfoInLabel = userLiveLabel.multiCallInfo;
            if (liveMultiCallInfoInLabel != null) {
                codedOutputByteBufferNano.m17254K(12, liveMultiCallInfoInLabel, LiveMultiCallInfoInLabel.PROTOBUF_ADAPTER);
            }
            String str11 = userLiveLabel.schema;
            if (str11 != null) {
    ...
    public UserLiveLabel mo223809clone() {
        UserLiveLabel userLiveLabel = new UserLiveLabel();
        ...
        if (liveMultiCallInfoInLabel != null) {
            userLiveLabel.multiCallInfo = liveMultiCallInfoInLabel.mo223809clone();
        }
