...
public class TencentToken extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TencentToken> PROTOBUF_ADAPTER = new MessageNanoAdapter<TencentToken>() { // from class: com.p1.mobile.putong.data.TencentToken.1
        ...
        public int computeAndCacheSize(TencentToken tencentToken) {
            ...
            tencentToken.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TencentToken parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    tencentToken.faceId = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    tencentToken.agreementNo = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    tencentToken.appId = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    tencentToken.nonce = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    tencentToken.userId = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    tencentToken.sign = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    tencentToken.verifyMode = nb5Var.m158750s();
                } else {
                    if (iM158752u != 66) {
                        if (tencentToken.faceId == null) {
                            tencentToken.faceId = "";
                    ...
                    tencentToken.keyLicence = nb5Var.m158750s();
                }
            }
            return tencentToken;
        }
    ...
    public TencentToken mo223809clone() {
        TencentToken tencentToken = new TencentToken();
