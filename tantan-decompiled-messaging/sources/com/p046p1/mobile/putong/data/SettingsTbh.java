...
public class SettingsTbh extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SettingsTbh> PROTOBUF_ADAPTER = new MessageNanoAdapter<SettingsTbh>() { // from class: com.p1.mobile.putong.data.SettingsTbh.1
        ...
        public int computeAndCacheSize(SettingsTbh settingsTbh) {
            ...
            int iM17230l = settingsStudies != null ? CodedOutputByteBufferNano.m17230l(1, settingsStudies, SettingsStudies.PROTOBUF_ADAPTER) : 0;
            settingsTbh.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SettingsTbh parse(nb5 nb5Var) throws IOException {
            SettingsTbh settingsTbh = new SettingsTbh();
            while (nb5Var.m158752u() == 10) {
                settingsTbh.studies = (SettingsStudies) nb5Var.m158743l(SettingsStudies.PROTOBUF_ADAPTER);
            }
            return settingsTbh;
        }
        ...
        public void serialize(SettingsTbh settingsTbh, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (settingsStudies != null) {
                codedOutputByteBufferNano.m17254K(1, settingsStudies, SettingsStudies.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public SettingsTbh mo223809clone() {
        SettingsTbh settingsTbh = new SettingsTbh();
        SettingsStudies settingsStudies = this.studies;
        if (settingsStudies != null) {
            settingsTbh.studies = settingsStudies.mo223809clone();
        }
        return settingsTbh;
    }
