...
public class Relationship extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Relationship> PROTOBUF_ADAPTER = new MessageNanoAdapter<Relationship>() { // from class: com.p1.mobile.putong.data.Relationship.1
        ...
        public int computeAndCacheSize(Relationship relationship) {
            ...
            int iM17226h = relationshipStatus != null ? CodedOutputByteBufferNano.m17226h(1, relationshipStatus.ordinal()) : 0;
            List<MatchFrom> list = relationship.status;
            if (list != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(2, MatchFrom.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17222d = iM17226h + CodedOutputByteBufferNano.m17222d(3, relationship.createdTime);
            String str = relationship.f38806id;
            if (str != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(4, str);
            }
            List<String> list2 = relationship.scenarios;
            if (list2 != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(5, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17222d2 = iM17222d + CodedOutputByteBufferNano.m17222d(6, relationship.updateTime);
            String str2 = relationship.otherState;
            if (str2 != null) {
                iM17222d2 += CodedOutputByteBufferNano.m17233o(7, str2);
            }
            int iM17220b = iM17222d2 + CodedOutputByteBufferNano.m17220b(8, relationship.needUndoPrompt);
            String str3 = relationship.message;
            if (str3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(9, str3);
            }
            String str4 = relationship.otherMessage;
            if (str4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(10, str4);
            }
            ConversationStatus conversationStatus = relationship.conversationStatus;
            if (conversationStatus != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(11, conversationStatus.ordinal());
            }
            List<MatchFrom> list3 = relationship.tags;
            if (list3 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(12, MatchFrom.covertToOldEnumList(list3), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MatchFrom> list4 = relationship.otherTags;
            if (list4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(13, MatchFrom.covertToOldEnumList(list4), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = relationship.richListTracker;
            if (str5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(14, str5);
            }
            MatchFrom matchFrom = relationship.localStatus;
            if (matchFrom != null) {
                iM17220b += CodedOutputByteBufferNano.m17226h(15, matchFrom.ordinal());
            }
            List<String> list5 = relationship.topics;
            if (list5 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(16, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            RelationshipExtensions relationshipExtensions = relationship.relationshipExtensions;
            if (relationshipExtensions != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(17, relationshipExtensions, RelationshipExtensions.PROTOBUF_ADAPTER);
            }
            String str6 = relationship.scene;
            if (str6 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(18, str6);
            }
            String str7 = relationship.kankanId;
            if (str7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(19, str7);
            }
            String str8 = relationship.otherKankanId;
            if (str8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(20, str8);
            }
            String str9 = relationship.convType;
            if (str9 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(21, str9);
            }
            RelationshipStatus relationshipStatus2 = relationship.state;
            if (relationshipStatus2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(22, relationshipStatus2, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            List<MatchFrom> list6 = relationship.status;
            if (list6 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(23, list6, MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ConversationStatus conversationStatus2 = relationship.conversationStatus;
            if (conversationStatus2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(24, conversationStatus2, ConversationStatus.PROTOBUF_ADAPTER);
            }
            List<MatchFrom> list7 = relationship.tags;
            if (list7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(25, list7, MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MatchFrom> list8 = relationship.otherTags;
            if (list8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(26, list8, MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MatchFrom matchFrom2 = relationship.localStatus;
            if (matchFrom2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(27, matchFrom2, MatchFrom.PROTOBUF_ADAPTER);
            }
            DclExtensions dclExtensions = relationship.dclExtensions;
            if (dclExtensions != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(28, dclExtensions, DclExtensions.PROTOBUF_ADAPTER);
            }
            int iM17226h2 = iM17220b + CodedOutputByteBufferNano.m17226h(29, relationship.likeProfileId);
            String str10 = relationship.diamondSign;
            if (str10 != null) {
                iM17226h2 += CodedOutputByteBufferNano.m17233o(30, str10);
            }
            relationship.cachedSize = iM17226h2;
            return iM17226h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Relationship parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        if (relationship.f38806id == null) {
                            relationship.f38806id = "";
                        }
                    ...
                    case 18:
                        ...
                        continue;
                    case 25:
                        relationship.createdTime = nb5Var.m158739h();
                        continue;
                    case 34:
                        relationship.f38806id = nb5Var.m158750s();
                        continue;
                    case 42:
                        relationship.scenarios = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 49:
                        relationship.updateTime = nb5Var.m158739h();
                        continue;
                    case 58:
                        relationship.otherState = nb5Var.m158750s();
                        continue;
                    case 64:
                        relationship.needUndoPrompt = nb5Var.m158738g();
                        continue;
                    case 74:
                        relationship.message = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        relationship.otherMessage = nb5Var.m158750s();
                        continue;
                    case 88:
                    ...
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        ...
                        continue;
                    case 106:
                        list3 = (List) nb5Var.m158743l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 114:
                        relationship.richListTracker = nb5Var.m158750s();
                        continue;
                    case 120:
                        numValueOf3 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 130:
                        relationship.topics = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        relationship.relationshipExtensions = (RelationshipExtensions) nb5Var.m158743l(RelationshipExtensions.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        relationship.scene = nb5Var.m158750s();
                        continue;
                    case 154:
                        relationship.kankanId = nb5Var.m158750s();
                        continue;
                    case 162:
                        relationship.otherKankanId = nb5Var.m158750s();
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        relationship.convType = nb5Var.m158750s();
                        continue;
                    case 178:
                        relationship.state = (RelationshipStatus) nb5Var.m158743l(RelationshipStatus.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        relationship.status = (List) nb5Var.m158743l(MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        relationship.conversationStatus = (ConversationStatus) nb5Var.m158743l(ConversationStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 202:
                        relationship.tags = (List) nb5Var.m158743l(MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 210:
                        relationship.otherTags = (List) nb5Var.m158743l(MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 218:
                        relationship.localStatus = (MatchFrom) nb5Var.m158743l(MatchFrom.PROTOBUF_ADAPTER);
                        continue;
                    case 226:
                        relationship.dclExtensions = (DclExtensions) nb5Var.m158743l(DclExtensions.PROTOBUF_ADAPTER);
                        continue;
                    case 232:
                        relationship.likeProfileId = nb5Var.m158741j();
                        continue;
                    case 242:
                        relationship.diamondSign = nb5Var.m158750s();
                        continue;
                    default:
                        if (relationship.state == null && numValueOf != null) {
                            relationship.state = (RelationshipStatus) RelationshipStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Relationship relationship, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (relationshipStatus != null) {
                codedOutputByteBufferNano.m17250G(1, relationshipStatus.ordinal());
            }
            List<MatchFrom> list = relationship.status;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(2, MatchFrom.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17246C(3, relationship.createdTime);
            String str = relationship.f38806id;
            if (str != null) {
            ...
            List<String> list2 = relationship.scenarios;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(5, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17246C(6, relationship.updateTime);
            String str2 = relationship.otherState;
            if (str2 != null) {
                codedOutputByteBufferNano.m17261R(7, str2);
            }
            codedOutputByteBufferNano.m17244A(8, relationship.needUndoPrompt);
            String str3 = relationship.message;
            if (str3 != null) {
            ...
            ConversationStatus conversationStatus = relationship.conversationStatus;
            if (conversationStatus != null) {
                codedOutputByteBufferNano.m17250G(11, conversationStatus.ordinal());
            }
            List<MatchFrom> list3 = relationship.tags;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(12, MatchFrom.covertToOldEnumList(list3), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MatchFrom> list4 = relationship.otherTags;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(13, MatchFrom.covertToOldEnumList(list4), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = relationship.richListTracker;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(14, str5);
            }
            MatchFrom matchFrom = relationship.localStatus;
            if (matchFrom != null) {
                codedOutputByteBufferNano.m17250G(15, matchFrom.ordinal());
            }
            List<String> list5 = relationship.topics;
            if (list5 != null) {
                codedOutputByteBufferNano.m17254K(16, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            RelationshipExtensions relationshipExtensions = relationship.relationshipExtensions;
            if (relationshipExtensions != null) {
                codedOutputByteBufferNano.m17254K(17, relationshipExtensions, RelationshipExtensions.PROTOBUF_ADAPTER);
            }
            String str6 = relationship.scene;
            if (str6 != null) {
                codedOutputByteBufferNano.m17261R(18, str6);
            }
            String str7 = relationship.kankanId;
            if (str7 != null) {
                codedOutputByteBufferNano.m17261R(19, str7);
            }
            String str8 = relationship.otherKankanId;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(20, str8);
            }
            String str9 = relationship.convType;
            if (str9 != null) {
                codedOutputByteBufferNano.m17261R(21, str9);
            }
            RelationshipStatus relationshipStatus2 = relationship.state;
            if (relationshipStatus2 != null) {
                codedOutputByteBufferNano.m17254K(22, relationshipStatus2, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            List<MatchFrom> list6 = relationship.status;
            if (list6 != null) {
                codedOutputByteBufferNano.m17254K(23, list6, MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ConversationStatus conversationStatus2 = relationship.conversationStatus;
            if (conversationStatus2 != null) {
                codedOutputByteBufferNano.m17254K(24, conversationStatus2, ConversationStatus.PROTOBUF_ADAPTER);
            }
            List<MatchFrom> list7 = relationship.tags;
            if (list7 != null) {
                codedOutputByteBufferNano.m17254K(25, list7, MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MatchFrom> list8 = relationship.otherTags;
            if (list8 != null) {
                codedOutputByteBufferNano.m17254K(26, list8, MatchFrom.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MatchFrom matchFrom2 = relationship.localStatus;
            if (matchFrom2 != null) {
                codedOutputByteBufferNano.m17254K(27, matchFrom2, MatchFrom.PROTOBUF_ADAPTER);
            }
            DclExtensions dclExtensions = relationship.dclExtensions;
            if (dclExtensions != null) {
                codedOutputByteBufferNano.m17254K(28, dclExtensions, DclExtensions.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17250G(29, relationship.likeProfileId);
            String str10 = relationship.diamondSign;
            if (str10 != null) {
                codedOutputByteBufferNano.m17261R(30, str10);
            }
        }
    };
        ...
        public boolean parseField(Relationship relationship, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 18:
                    ...
                    return true;
                case 19:
                    relationship.f38806id = jsonParser.getValueAsString();
                    return false;
                case 20:
    ...
    public static /* synthetic */ MatchFrom m60063a(MatchFrom matchFrom) {
        return matchFrom;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ MatchFrom m60064b(MatchFrom matchFrom) {
        return matchFrom;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m60065c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m60066d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ MatchFrom m60067e(MatchFrom matchFrom) {
        return matchFrom;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ MatchFrom m60068f(MatchFrom matchFrom) {
        return matchFrom;
    }
    ...
    public Relationship mo223809clone() {
        Relationship relationship = new Relationship();
        ...
        if (relationshipExtendLetter != null) {
            relationship.extend = relationshipExtendLetter.mo223809clone();
        }
        ...
        if (list3 != null) {
            relationship.otherStatus = ValueObject.util_map(list3, new w9j() { // from class: l.noc0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Relationship.m60067e((MatchFrom) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            relationship.tags = ValueObject.util_map(list4, new w9j() { // from class: l.ooc0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Relationship.m60068f((MatchFrom) obj);
                }
            });
        }
        ...
        if (list5 != null) {
            relationship.otherTags = ValueObject.util_map(list5, new w9j() { // from class: l.poc0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Relationship.m60064b((MatchFrom) obj);
                }
            });
        }
        ...
        if (list6 != null) {
            relationship.topics = ValueObject.util_map(list6, new w9j() { // from class: l.qoc0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Relationship.m60066d((String) obj);
                }
            });
        }
        RelationshipExtensions relationshipExtensions = this.relationshipExtensions;
        if (relationshipExtensions != null) {
            relationship.relationshipExtensions = relationshipExtensions.mo223809clone();
        }
