...
public class UserPrivacySettings extends ValueObject<UserPrivacySettings> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserPrivacySettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserPrivacySettings>() { // from class: com.p1.mobile.putong.data.UserPrivacySettings.1
        ...
        public int computeAndCacheSize(UserPrivacySettings userPrivacySettings) {
            ...
            if (str != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(12, str);
            }
            Boolean bool12 = userPrivacySettings.verifiedUserMsg;
            if (bool12 != null) {
                iM17220b += CodedOutputByteBufferNano.m17220b(13, bool12.booleanValue());
            }
            userPrivacySettings.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserPrivacySettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userPrivacySettings.hideActivityTime = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 16:
                        userPrivacySettings.hideContacts = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 24:
                        userPrivacySettings.hideMutualContacts = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 32:
                        userPrivacySettings.hidePublicMoments = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 40:
                        userPrivacySettings.hideSchool = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 48:
                        userPrivacySettings.hideVIP = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 56:
                        userPrivacySettings.personalizeSuggest = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 64:
                        userPrivacySettings.heartbeatDisable = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 72:
                        userPrivacySettings.adsSuggest = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 80:
                        userPrivacySettings.onlineReminder = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case 88:
                        userPrivacySettings.unrepliedReminder = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        userPrivacySettings.aiPictureEnable = nb5Var.m158750s();
                        continue;
                    case 104:
                        userPrivacySettings.verifiedUserMsg = Boolean.valueOf(nb5Var.m158738g());
                        continue;
                    default:
                        if (userPrivacySettings.hideActivityTime == null) {
                            userPrivacySettings.hideActivityTime = Boolean.FALSE;
        ...
        public void serialize(UserPrivacySettings userPrivacySettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            String str = userPrivacySettings.aiPictureEnable;
            if (str != null) {
                codedOutputByteBufferNano.m17261R(12, str);
            }
            Boolean bool12 = userPrivacySettings.verifiedUserMsg;
            if (bool12 != null) {
                codedOutputByteBufferNano.m17244A(13, bool12.booleanValue());
            }
        }
    };
    public static JsonAdapter<UserPrivacySettings> JSON_ADAPTER = new ObjectJsonAdapter<UserPrivacySettings>() { // from class: com.p1.mobile.putong.data.UserPrivacySettings.2
        ...
        public UserPrivacySettings newInstance() {
    ...
    public UserPrivacySettings mo223809clone() {
        UserPrivacySettings userPrivacySettings = new UserPrivacySettings();
