...
public class IdentificationInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IdentificationInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<IdentificationInfo>() { // from class: com.p1.mobile.putong.data.IdentificationInfo.1
        ...
        public int computeAndCacheSize(IdentificationInfo identificationInfo) {
            ...
            identificationInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IdentificationInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    identificationInfo.name = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    identificationInfo.identificationID = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    identificationInfo.identificationType = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        if (identificationInfo.name == null) {
                            identificationInfo.name = "";
                    ...
                    identificationInfo.zhiMaCertificationResult = nb5Var.m158750s();
                }
            }
            return identificationInfo;
        }
    ...
    public IdentificationInfo mo223809clone() {
        IdentificationInfo identificationInfo = new IdentificationInfo();
