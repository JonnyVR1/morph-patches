...
public class DialogShowInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DialogShowInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<DialogShowInfo>() { // from class: com.p1.mobile.putong.data.DialogShowInfo.1
        ...
        public int computeAndCacheSize(DialogShowInfo dialogShowInfo) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17228j(2, dialogShowInfo.lastShowTime) + CodedOutputByteBufferNano.m17226h(3, dialogShowInfo.totalShownCount) + CodedOutputByteBufferNano.m17226h(4, dialogShowInfo.countByDay) + CodedOutputByteBufferNano.m17220b(5, dialogShowInfo.noRemind) + CodedOutputByteBufferNano.m17226h(6, dialogShowInfo.countByWeek);
            String str2 = dialogShowInfo.version;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(7, str2);
            }
            dialogShowInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DialogShowInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    dialogShowInfo.resourceId = nb5Var.m158750s();
                } else if (iM158752u == 16) {
                    dialogShowInfo.lastShowTime = nb5Var.m158742k();
                } else if (iM158752u == 24) {
                    dialogShowInfo.totalShownCount = nb5Var.m158741j();
                } else if (iM158752u == 32) {
                    dialogShowInfo.countByDay = nb5Var.m158741j();
                } else if (iM158752u == 40) {
                    dialogShowInfo.noRemind = nb5Var.m158738g();
                } else if (iM158752u == 48) {
                    dialogShowInfo.countByWeek = nb5Var.m158741j();
                } else {
                    if (iM158752u != 58) {
                        if (dialogShowInfo.resourceId == null) {
                            dialogShowInfo.resourceId = "";
                    ...
                    dialogShowInfo.version = nb5Var.m158750s();
                }
            }
            return dialogShowInfo;
        }
        ...
        public void serialize(DialogShowInfo dialogShowInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(2, dialogShowInfo.lastShowTime);
            codedOutputByteBufferNano.m17250G(3, dialogShowInfo.totalShownCount);
            codedOutputByteBufferNano.m17250G(4, dialogShowInfo.countByDay);
            codedOutputByteBufferNano.m17244A(5, dialogShowInfo.noRemind);
            codedOutputByteBufferNano.m17250G(6, dialogShowInfo.countByWeek);
            String str2 = dialogShowInfo.version;
            if (str2 != null) {
    ...
    public DialogShowInfo mo223809clone() {
        DialogShowInfo dialogShowInfo = new DialogShowInfo();
