...
public class CuttingData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CuttingData> PROTOBUF_ADAPTER = new MessageNanoAdapter<CuttingData>() { // from class: com.p1.mobile.putong.data.CuttingData.1
        ...
        public int computeAndCacheSize(CuttingData cuttingData) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, cuttingData.start) + CodedOutputByteBufferNano.m17228j(2, cuttingData.end);
            cuttingData.cachedSize = iM17228j;
            return iM17228j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CuttingData parse(nb5 nb5Var) throws IOException {
            CuttingData cuttingData = new CuttingData();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    cuttingData.start = nb5Var.m158742k();
                } else {
                    if (iM158752u != 16) {
                        return cuttingData;
                    }
                    cuttingData.end = nb5Var.m158742k();
                }
            }
        }
        ...
        public void serialize(CuttingData cuttingData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, cuttingData.start);
            codedOutputByteBufferNano.m17252I(2, cuttingData.end);
        }
    };
    ...
    public CuttingData mo223809clone() {
        CuttingData cuttingData = new CuttingData();
