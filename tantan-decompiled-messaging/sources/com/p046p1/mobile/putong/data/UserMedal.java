...
public class UserMedal extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserMedal> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserMedal>() { // from class: com.p1.mobile.putong.data.UserMedal.1
        ...
        public int computeAndCacheSize(UserMedal userMedal) {
            String str = userMedal.f38831id;
            int iM17233o = str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0;
            String str2 = userMedal.liveID;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(2, str2);
            }
            int iM17228j = iM17233o + CodedOutputByteBufferNano.m17228j(3, userMedal.expireTime) + CodedOutputByteBufferNano.m17226h(4, userMedal.fanbaseGrade);
            String str3 = userMedal.familyText;
            if (str3 != null) {
                iM17228j += CodedOutputByteBufferNano.m17233o(5, str3);
            }
            int iM17226h = iM17228j + CodedOutputByteBufferNano.m17226h(6, userMedal.familyGrade) + CodedOutputByteBufferNano.m17226h(7, userMedal.voiceFanbaseGrade);
            ...
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(10, userMedal.familyLight);
            userMedal.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserMedal parse(nb5 nb5Var) throws IOException {
            UserMedal userMedal = new UserMedal();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (userMedal.f38831id == null) {
                            userMedal.f38831id = "";
                        }
                        ...
                        break;
                    case 10:
                        userMedal.f38831id = nb5Var.m158750s();
                        continue;
                    case 18:
                        userMedal.liveID = nb5Var.m158750s();
                        continue;
                    case 24:
                        userMedal.expireTime = nb5Var.m158742k();
                        continue;
                    case 32:
                        userMedal.fanbaseGrade = nb5Var.m158741j();
                        continue;
                    case 42:
                        userMedal.familyText = nb5Var.m158750s();
                        continue;
                    case 48:
                        userMedal.familyGrade = nb5Var.m158741j();
                        continue;
                    case 56:
                        userMedal.voiceFanbaseGrade = nb5Var.m158741j();
                        continue;
                    case 66:
                        userMedal.voiceFanbaseColor = nb5Var.m158750s();
                        continue;
                    case 74:
                        userMedal.voiceFanbaseText = nb5Var.m158750s();
                        continue;
                    case 80:
                        userMedal.familyLight = nb5Var.m158738g();
                        continue;
                    default:
                        if (userMedal.f38831id == null) {
                            userMedal.f38831id = "";
        ...
        public void serialize(UserMedal userMedal, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(3, userMedal.expireTime);
            codedOutputByteBufferNano.m17250G(4, userMedal.fanbaseGrade);
            String str3 = userMedal.familyText;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(5, str3);
            }
            codedOutputByteBufferNano.m17250G(6, userMedal.familyGrade);
            codedOutputByteBufferNano.m17250G(7, userMedal.voiceFanbaseGrade);
            String str4 = userMedal.voiceFanbaseColor;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17244A(10, userMedal.familyLight);
        }
    };
        ...
        public boolean parseField(UserMedal userMedal, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "expireTime":
                    ...
                    return true;
                case "id":
                    userMedal.f38831id = jsonParser.getValueAsString();
                    return false;
                case "fanbaseGrade":
    ...
    public UserMedal mo223809clone() {
        UserMedal userMedal = new UserMedal();
        userMedal.f38831id = this.f38831id;
