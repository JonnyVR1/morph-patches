...
public class LiveFansClubLevel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveFansClubLevel> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveFansClubLevel>() { // from class: com.p1.mobile.putong.data.LiveFansClubLevel.1
        ...
        public int computeAndCacheSize(LiveFansClubLevel liveFansClubLevel) {
            ...
            int iM17233o = (str != null ? CodedOutputByteBufferNano.m17233o(1, str) : 0) + CodedOutputByteBufferNano.m17228j(2, liveFansClubLevel.grade) + CodedOutputByteBufferNano.m17228j(3, liveFansClubLevel.memberCount) + CodedOutputByteBufferNano.m17228j(4, liveFansClubLevel.wealth) + CodedOutputByteBufferNano.m17228j(5, liveFansClubLevel.gap) + CodedOutputByteBufferNano.m17228j(6, liveFansClubLevel.updatedTime);
            String str2 = liveFansClubLevel.iconUrl;
            if (str2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(7, str2);
            }
            String str3 = liveFansClubLevel.shadingFrontUrl;
            if (str3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(8, str3);
            }
            String str4 = liveFansClubLevel.shadingBackUrl;
            if (str4 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(9, str4);
            }
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(10, liveFansClubLevel.wealthRatio);
            String str5 = liveFansClubLevel.textColor;
            if (str5 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(11, str5);
            }
            String str6 = liveFansClubLevel.userType;
            if (str6 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(12, str6);
            }
            liveFansClubLevel.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveFansClubLevel parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        liveFansClubLevel.title = nb5Var.m158750s();
                        continue;
                    case 16:
                        liveFansClubLevel.grade = nb5Var.m158742k();
                        continue;
                    case 24:
                        liveFansClubLevel.memberCount = nb5Var.m158742k();
                        continue;
                    case 32:
                        liveFansClubLevel.wealth = nb5Var.m158742k();
                        continue;
                    case 40:
                        liveFansClubLevel.gap = nb5Var.m158742k();
                        continue;
                    case 48:
                        liveFansClubLevel.updatedTime = nb5Var.m158742k();
                        continue;
                    case 58:
                        liveFansClubLevel.iconUrl = nb5Var.m158750s();
                        continue;
                    case 66:
                        liveFansClubLevel.shadingFrontUrl = nb5Var.m158750s();
                        continue;
                    case 74:
                        liveFansClubLevel.shadingBackUrl = nb5Var.m158750s();
                        continue;
                    case EACTags.FILE_REFERENCE /* 81 */:
                        liveFansClubLevel.wealthRatio = nb5Var.m158739h();
                        continue;
                    case 90:
                        liveFansClubLevel.textColor = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        liveFansClubLevel.userType = nb5Var.m158750s();
                        continue;
                    default:
                        if (liveFansClubLevel.title == null) {
                            liveFansClubLevel.title = "";
        ...
        public void serialize(LiveFansClubLevel liveFansClubLevel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17252I(2, liveFansClubLevel.grade);
            codedOutputByteBufferNano.m17252I(3, liveFansClubLevel.memberCount);
            codedOutputByteBufferNano.m17252I(4, liveFansClubLevel.wealth);
            codedOutputByteBufferNano.m17252I(5, liveFansClubLevel.gap);
            codedOutputByteBufferNano.m17252I(6, liveFansClubLevel.updatedTime);
            String str2 = liveFansClubLevel.iconUrl;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17246C(10, liveFansClubLevel.wealthRatio);
            String str5 = liveFansClubLevel.textColor;
            if (str5 != null) {
    ...
    public LiveFansClubLevel mo223809clone() {
        LiveFansClubLevel liveFansClubLevel = new LiveFansClubLevel();
