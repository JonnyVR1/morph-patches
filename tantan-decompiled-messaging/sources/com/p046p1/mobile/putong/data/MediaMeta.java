...
public class MediaMeta extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MediaMeta> PROTOBUF_ADAPTER = new MessageNanoAdapter<MediaMeta>() { // from class: com.p1.mobile.putong.data.MediaMeta.1
        ...
        public int computeAndCacheSize(MediaMeta mediaMeta) {
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(54, mediaMeta.hasAudio);
            ...
            if (str7 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(58, str7);
            }
            String str8 = mediaMeta.filter;
            if (str8 != null) {
                iM17220b += CodedOutputByteBufferNano.m17233o(59, str8);
            }
            int iM17220b2 = iM17220b + CodedOutputByteBufferNano.m17220b(60, mediaMeta.isSameMusic);
            mediaMeta.cachedSize = iM17220b2;
            return iM17220b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MediaMeta parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 410:
                        mediaMeta.type = nb5Var.m158750s();
                        continue;
                    case 418:
                        mediaMeta.source = nb5Var.m158750s();
                        continue;
                    case 426:
                        mediaMeta.musicReference = nb5Var.m158750s();
                        continue;
                    case 432:
                        mediaMeta.hasAudio = nb5Var.m158738g();
                        continue;
                    case 442:
                        mediaMeta.musicId = nb5Var.m158750s();
                        continue;
                    case 450:
                        mediaMeta.proportion = nb5Var.m158750s();
                        continue;
                    case 458:
                        mediaMeta.camera = nb5Var.m158750s();
                        continue;
                    case 466:
                        mediaMeta.sticker = nb5Var.m158750s();
                        continue;
                    case 474:
                        mediaMeta.filter = nb5Var.m158750s();
                        continue;
                    case 480:
                        mediaMeta.isSameMusic = nb5Var.m158738g();
                        continue;
                    default:
                        if (mediaMeta.type == null) {
                            mediaMeta.type = "";
        ...
        public void serialize(MediaMeta mediaMeta, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(54, mediaMeta.hasAudio);
            String str4 = mediaMeta.musicId;
            if (str4 != null) {
            ...
            String str8 = mediaMeta.filter;
            if (str8 != null) {
                codedOutputByteBufferNano.m17261R(59, str8);
            }
            codedOutputByteBufferNano.m17244A(60, mediaMeta.isSameMusic);
        }
    };
    ...
    public MediaMeta mo223809clone() {
        MediaMeta mediaMeta = new MediaMeta();
