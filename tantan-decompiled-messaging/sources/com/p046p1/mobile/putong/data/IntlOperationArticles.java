...
public class IntlOperationArticles extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlOperationArticles> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlOperationArticles>() { // from class: com.p1.mobile.putong.data.IntlOperationArticles.1
        ...
        public int computeAndCacheSize(IntlOperationArticles intlOperationArticles) {
            String str = intlOperationArticles.f38762id;
            ...
            if (urlParentData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(3, urlParentData, UrlParentData.PROTOBUF_ADAPTER);
            }
            String str3 = intlOperationArticles.jumpUrl;
            if (str3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(4, str3);
            }
            intlOperationArticles.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlOperationArticles parse(nb5 nb5Var) throws IOException {
            IntlOperationArticles intlOperationArticles = new IntlOperationArticles();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 0) {
                    if (intlOperationArticles.f38762id == null) {
                        intlOperationArticles.f38762id = "";
                    }
                ...
                if (iM158752u == 10) {
                    intlOperationArticles.f38762id = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    intlOperationArticles.title = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    intlOperationArticles.cover = (UrlParentData) nb5Var.m158743l(UrlParentData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 34) {
                        if (intlOperationArticles.f38762id == null) {
                            intlOperationArticles.f38762id = "";
                    ...
                    intlOperationArticles.jumpUrl = nb5Var.m158750s();
                }
            }
            return intlOperationArticles;
        }
        ...
        public void serialize(IntlOperationArticles intlOperationArticles, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            UrlParentData urlParentData = intlOperationArticles.cover;
            if (urlParentData != null) {
                codedOutputByteBufferNano.m17254K(3, urlParentData, UrlParentData.PROTOBUF_ADAPTER);
            }
            String str3 = intlOperationArticles.jumpUrl;
            if (str3 != null) {
        ...
        public boolean parseField(IntlOperationArticles intlOperationArticles, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "jumpUrl":
                    ...
                    return true;
                case "id":
                    intlOperationArticles.f38762id = jsonParser.getValueAsString();
                    return false;
                case "cover":
    ...
    public IntlOperationArticles mo223809clone() {
        IntlOperationArticles intlOperationArticles = new IntlOperationArticles();
        intlOperationArticles.f38762id = this.f38762id;
        intlOperationArticles.title = this.title;
        UrlParentData urlParentData = this.cover;
        if (urlParentData != null) {
            intlOperationArticles.cover = urlParentData.mo223809clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f38762id, intlOperationArticles.f38762id) && ValueObject.util_equals(this.title, intlOperationArticles.title) && ValueObject.util_equals(this.cover, intlOperationArticles.cover) && ValueObject.util_equals(this.jumpUrl, intlOperationArticles.jumpUrl);
    }
