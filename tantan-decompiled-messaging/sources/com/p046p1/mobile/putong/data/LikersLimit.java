...
public class LikersLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikersLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikersLimit>() { // from class: com.p1.mobile.putong.data.LikersLimit.1
        ...
        public int computeAndCacheSize(LikersLimit likersLimit) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, likersLimit.remaining) + CodedOutputByteBufferNano.m17226h(2, likersLimit.total) + CodedOutputByteBufferNano.m17226h(3, likersLimit.reset) + CodedOutputByteBufferNano.m17222d(4, likersLimit.expiresTime);
            likersLimit.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LikersLimit parse(nb5 nb5Var) throws IOException {
            LikersLimit likersLimit = new LikersLimit();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    likersLimit.remaining = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    likersLimit.total = nb5Var.m158741j();
                } else if (iM158752u == 24) {
                    likersLimit.reset = nb5Var.m158741j();
                } else {
                    if (iM158752u != 33) {
                        return likersLimit;
                    }
                    likersLimit.expiresTime = nb5Var.m158739h();
                }
            }
        }
        ...
        public void serialize(LikersLimit likersLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, likersLimit.remaining);
            codedOutputByteBufferNano.m17250G(2, likersLimit.total);
            codedOutputByteBufferNano.m17250G(3, likersLimit.reset);
            codedOutputByteBufferNano.m17246C(4, likersLimit.expiresTime);
        }
    };
    ...
    public LikersLimit mo223809clone() {
        LikersLimit likersLimit = new LikersLimit();
