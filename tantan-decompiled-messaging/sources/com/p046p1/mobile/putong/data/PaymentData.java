...
public class PaymentData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PaymentData> PROTOBUF_ADAPTER = new MessageNanoAdapter<PaymentData>() { // from class: com.p1.mobile.putong.data.PaymentData.1
        ...
        public int computeAndCacheSize(PaymentData paymentData) {
            ...
            if (list3 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, list3, AllowPayments.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            paymentData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PaymentData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    paymentData.payments = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 18) {
                    paymentData.blackPayments = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM158752u != 26) {
                        if (paymentData.payments == null) {
                            paymentData.payments = new ArrayList();
                    ...
                    paymentData.allowPayments = (List) nb5Var.m158743l(AllowPayments.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return paymentData;
        }
        ...
        public void serialize(PaymentData paymentData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<AllowPayments> list3 = paymentData.allowPayments;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(3, list3, AllowPayments.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    private boolean checkCoPayOnline(final String str) {
        return !vwb.m200337m(this.allowPayments, new w9j() { // from class: l.je60
            @Override // p149l.w9j
            public final Object call(Object obj) {
                AllowPayments allowPayments = (AllowPayments) obj;
                return Boolean.valueOf(allowPayments.payments.contains(str) && qib0.f154717f0 == allowPayments.signup_country);
            }
        });
    }

    private boolean checkCodaOnline(final String str) {
        return vwb.m200337m(this.allowPayments, new w9j() { // from class: l.ie60
            @Override // p149l.w9j
            public final Object call(Object obj) {
    ...
    private boolean checkPCOnline(final String str) {
        return vwb.m200337m(this.allowPayments, new w9j() { // from class: l.ke60
            @Override // p149l.w9j
            public final Object call(Object obj) {
                AllowPayments allowPayments = (AllowPayments) obj;
                return Boolean.valueOf(allowPayments.payments.contains(str) && qib0.f154717f0 == allowPayments.signup_country);
    ...
    public static /* synthetic */ String m59979d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m59981f(String str) {
        return str;
    }
    ...
    public PaymentData mo223809clone() {
        PaymentData paymentData = new PaymentData();
        ...
        if (list != null) {
            paymentData.payments = ValueObject.util_map(list, new w9j() { // from class: l.fe60
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return PaymentData.m59981f((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            paymentData.blackPayments = ValueObject.util_map(list2, new w9j() { // from class: l.ge60
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return PaymentData.m59979d((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            paymentData.allowPayments = ValueObject.util_map(list3, new w9j() { // from class: l.he60
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return ((AllowPayments) obj).mo223809clone();
                }
            });
        }
        return paymentData;
    ...
    public boolean isCanUse(String str, String str2) {
        ...
        if (TextUtils.equals(str, FROM_TEAM)) {
            return str2.equals(getCOutName()) || !((Boolean) xaj0Var.f191753c).booleanValue();
        }
        if (TextUtils.equals(str, FROM_RESULT)) {
            return true;
        }
        if (str2.equals(getPCName()) && TextUtils.equals(str, "wallet")) {
            return !((Boolean) xaj0Var.f191753c).booleanValue() && ((Boolean) xaj0Var.f191752b).booleanValue();
        }
        return ((Boolean) xaj0Var.f191752b).booleanValue();
    }
