...
public class H5OutData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<H5OutData> PROTOBUF_ADAPTER = new MessageNanoAdapter<H5OutData>() { // from class: com.p1.mobile.putong.data.H5OutData.1
        ...
        public int computeAndCacheSize(H5OutData h5OutData) {
            ...
            h5OutData.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public H5OutData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    h5OutData.schemeVersion = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    h5OutData.deviceId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    h5OutData.token = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    h5OutData.browserVersion = nb5Var.m158750s();
                } else if (iM158752u == 42) {
                    h5OutData.versionCode = nb5Var.m158750s();
                } else if (iM158752u == 50) {
                    h5OutData.platform = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    h5OutData.language = nb5Var.m158750s();
                } else if (iM158752u == 66) {
                    h5OutData.userId = nb5Var.m158750s();
                } else {
                    if (iM158752u != 74) {
                        if (h5OutData.schemeVersion == null) {
                            h5OutData.schemeVersion = "";
                    ...
                    h5OutData.oneId = nb5Var.m158750s();
                }
            }
            return h5OutData;
        }
    ...
    public static JsonAdapter<H5OutData> JSON_ADAPTER = new ObjectJsonAdapter<H5OutData>() { // from class: com.p1.mobile.putong.data.H5OutData.2
        ...
        public void serializeFields(H5OutData h5OutData, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str2 = h5OutData.deviceId;
            if (str2 != null) {
                jsonGenerator.writeStringField(Constants.DEVICE_ID_TAG, str2);
            }
            String str3 = h5OutData.token;
            if (str3 != null) {
            ...
            String str7 = h5OutData.language;
            if (str7 != null) {
                jsonGenerator.writeStringField(IjkMediaMeta.IJKM_KEY_LANGUAGE, str7);
            }
            String str8 = h5OutData.userId;
            if (str8 != null) {
    ...
    public H5OutData mo223809clone() {
        H5OutData h5OutData = new H5OutData();
