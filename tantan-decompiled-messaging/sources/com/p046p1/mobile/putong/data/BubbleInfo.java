...
public class BubbleInfo extends ValueObject<BubbleInfo> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BubbleInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<BubbleInfo>() { // from class: com.p1.mobile.putong.data.BubbleInfo.1
        ...
        public int computeAndCacheSize(BubbleInfo bubbleInfo) {
            String str = bubbleInfo.f38730id;
            ...
            if (textTheme != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, textTheme, TextTheme.PROTOBUF_ADAPTER);
            }
            Emotion emotion = bubbleInfo.emotion;
            if (emotion != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, emotion, Emotion.PROTOBUF_ADAPTER);
            }
            MessageLocation messageLocation = bubbleInfo.location;
            if (messageLocation != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            String str3 = bubbleInfo.status;
            if (str3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17233o(7, str3);
            }
            int iM17222d = iM17233o + CodedOutputByteBufferNano.m17222d(8, bubbleInfo.createdTime) + CodedOutputByteBufferNano.m17220b(9, bubbleInfo.haveLiked);
            List<Media> list = bubbleInfo.media;
            if (list != null) {
                iM17222d += CodedOutputByteBufferNano.m17230l(10, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = bubbleInfo.biz;
            if (str4 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(11, str4);
            }
            String str5 = bubbleInfo.userId;
            if (str5 != null) {
                iM17222d += CodedOutputByteBufferNano.m17233o(12, str5);
            }
            bubbleInfo.cachedSize = iM17222d;
            return iM17222d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BubbleInfo parse(nb5 nb5Var) throws IOException {
            BubbleInfo bubbleInfo = new BubbleInfo();
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        if (bubbleInfo.f38730id == null) {
                            bubbleInfo.f38730id = "";
                        }
                        ...
                        break;
                    case 10:
                        bubbleInfo.f38730id = nb5Var.m158750s();
                        continue;
                    case 18:
                        bubbleInfo.owner = (Owner) nb5Var.m158743l(Owner.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        bubbleInfo.value = nb5Var.m158750s();
                        continue;
                    case 34:
                        bubbleInfo.textTheme = (TextTheme) nb5Var.m158743l(TextTheme.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        bubbleInfo.emotion = (Emotion) nb5Var.m158743l(Emotion.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        bubbleInfo.location = (MessageLocation) nb5Var.m158743l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        bubbleInfo.status = nb5Var.m158750s();
                        continue;
                    case 65:
                        bubbleInfo.createdTime = nb5Var.m158739h();
                        continue;
                    case 72:
                        bubbleInfo.haveLiked = nb5Var.m158738g();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        bubbleInfo.media = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        bubbleInfo.biz = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        bubbleInfo.userId = nb5Var.m158750s();
                        continue;
                    default:
                        if (bubbleInfo.f38730id == null) {
                            bubbleInfo.f38730id = "";
        ...
        public void serialize(BubbleInfo bubbleInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            TextTheme textTheme = bubbleInfo.textTheme;
            if (textTheme != null) {
                codedOutputByteBufferNano.m17254K(4, textTheme, TextTheme.PROTOBUF_ADAPTER);
            }
            Emotion emotion = bubbleInfo.emotion;
            if (emotion != null) {
                codedOutputByteBufferNano.m17254K(5, emotion, Emotion.PROTOBUF_ADAPTER);
            }
            MessageLocation messageLocation = bubbleInfo.location;
            if (messageLocation != null) {
                codedOutputByteBufferNano.m17254K(6, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            String str3 = bubbleInfo.status;
            if (str3 != null) {
                codedOutputByteBufferNano.m17261R(7, str3);
            }
            codedOutputByteBufferNano.m17246C(8, bubbleInfo.createdTime);
            codedOutputByteBufferNano.m17244A(9, bubbleInfo.haveLiked);
            List<Media> list = bubbleInfo.media;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(10, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = bubbleInfo.biz;
            if (str4 != null) {
            ...
            String str5 = bubbleInfo.userId;
            if (str5 != null) {
                codedOutputByteBufferNano.m17261R(12, str5);
            }
        }
    };
        ...
        public boolean parseField(BubbleInfo bubbleInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "createdTime":
                    ...
                    return true;
                case "id":
                    bubbleInfo.f38730id = jsonParser.getValueAsString();
                    return false;
                case "biz":
    ...
    public boolean checkStateTimeIsValid() {
        return (this.createdTime + 8.64E7d) - ((double) mqi0.m155944o()) > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public BubbleInfo mo223809clone() {
        BubbleInfo bubbleInfo = new BubbleInfo();
        bubbleInfo.f38730id = this.f38730id;
        Owner owner = this.owner;
        if (owner != null) {
            bubbleInfo.owner = owner.mo223809clone();
        }
        bubbleInfo.value = this.value;
        TextTheme textTheme = this.textTheme;
        if (textTheme != null) {
            bubbleInfo.textTheme = textTheme.mo223809clone();
        }
        Emotion emotion = this.emotion;
        if (emotion != null) {
            bubbleInfo.emotion = emotion.mo223809clone();
        }
        MessageLocation messageLocation = this.location;
        if (messageLocation != null) {
            bubbleInfo.location = messageLocation.mo223809clone();
        }
    ...
    public void mergeData(BubbleInfo bubbleInfo) {
        ...
        if (!isFieldParsed("id")) {
            this.f38730id = bubbleInfo.f38730id;
        }
