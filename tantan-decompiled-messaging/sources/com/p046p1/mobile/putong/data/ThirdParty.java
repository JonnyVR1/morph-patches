...
public class ThirdParty extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ThirdParty> PROTOBUF_ADAPTER = new MessageNanoAdapter<ThirdParty>() { // from class: com.p1.mobile.putong.data.ThirdParty.1
        ...
        public int computeAndCacheSize(ThirdParty thirdParty) {
            int iM17220b = CodedOutputByteBufferNano.m17220b(1, thirdParty.facebook) + CodedOutputByteBufferNano.m17220b(2, thirdParty.wechat) + CodedOutputByteBufferNano.m17220b(3, thirdParty.google) + CodedOutputByteBufferNano.m17220b(4, thirdParty.apple);
            thirdParty.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ThirdParty parse(nb5 nb5Var) throws IOException {
            ThirdParty thirdParty = new ThirdParty();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 8) {
                    thirdParty.facebook = nb5Var.m158738g();
                } else if (iM158752u == 16) {
                    thirdParty.wechat = nb5Var.m158738g();
                } else if (iM158752u == 24) {
                    thirdParty.google = nb5Var.m158738g();
                } else {
                    if (iM158752u != 32) {
                        return thirdParty;
                    }
                    thirdParty.apple = nb5Var.m158738g();
                }
            }
        }
        ...
        public void serialize(ThirdParty thirdParty, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17244A(1, thirdParty.facebook);
            codedOutputByteBufferNano.m17244A(2, thirdParty.wechat);
            codedOutputByteBufferNano.m17244A(3, thirdParty.google);
            codedOutputByteBufferNano.m17244A(4, thirdParty.apple);
        }
    };
    ...
    public ThirdParty mo223809clone() {
        ThirdParty thirdParty = new ThirdParty();
