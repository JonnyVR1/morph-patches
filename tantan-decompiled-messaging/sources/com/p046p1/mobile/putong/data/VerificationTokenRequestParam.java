...
public class VerificationTokenRequestParam extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerificationTokenRequestParam> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerificationTokenRequestParam>() { // from class: com.p1.mobile.putong.data.VerificationTokenRequestParam.1
        ...
        public int computeAndCacheSize(VerificationTokenRequestParam verificationTokenRequestParam) {
            ...
            if (verificationTokenIdentity != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, verificationTokenIdentity, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            ...
            if (verificationTokenIdentity2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, verificationTokenIdentity2, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            ...
            int iM17220b = iM17233o + CodedOutputByteBufferNano.m17220b(8, verificationTokenRequestParam.enableVolcEnginePro) + CodedOutputByteBufferNano.m17220b(9, verificationTokenRequestParam.newProcess);
            verificationTokenRequestParam.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerificationTokenRequestParam parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    verificationTokenRequestParam.appId = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    verificationTokenRequestParam.productId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    verificationTokenRequestParam.verifyType = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    verificationTokenRequestParam.identity = (VerificationTokenIdentity) nb5Var.m158743l(VerificationTokenIdentity.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    verificationTokenRequestParam.picture = (VerificationTokenIdentity) nb5Var.m158743l(VerificationTokenIdentity.PROTOBUF_ADAPTER);
                } else if (iM158752u == 50) {
                    verificationTokenRequestParam.region = nb5Var.m158750s();
                } else if (iM158752u == 58) {
                    verificationTokenRequestParam.retrieveId = nb5Var.m158750s();
                } else if (iM158752u == 64) {
                    verificationTokenRequestParam.enableVolcEnginePro = nb5Var.m158738g();
                } else {
                    if (iM158752u != 72) {
                        if (verificationTokenRequestParam.appId == null) {
                            verificationTokenRequestParam.appId = "";
                    ...
                    verificationTokenRequestParam.newProcess = nb5Var.m158738g();
                }
            }
            return verificationTokenRequestParam;
        }
        ...
        public void serialize(VerificationTokenRequestParam verificationTokenRequestParam, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            VerificationTokenIdentity verificationTokenIdentity = verificationTokenRequestParam.identity;
            if (verificationTokenIdentity != null) {
                codedOutputByteBufferNano.m17254K(4, verificationTokenIdentity, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            VerificationTokenIdentity verificationTokenIdentity2 = verificationTokenRequestParam.picture;
            if (verificationTokenIdentity2 != null) {
                codedOutputByteBufferNano.m17254K(5, verificationTokenIdentity2, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            String str4 = verificationTokenRequestParam.region;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17244A(8, verificationTokenRequestParam.enableVolcEnginePro);
            codedOutputByteBufferNano.m17244A(9, verificationTokenRequestParam.newProcess);
        }
    };
    ...
    public static final class VerificationTokenRequestParamBuilder {
        ...
        public VerificationTokenRequestParamBuilder useAccountBackTemplate(String str, boolean z, String str2, String str3, String str4) {
            ...
            verificationTokenIdentityNew_.providerAppId = TTFacertificationClient.m60202q();
    ...
    public VerificationTokenRequestParam mo223809clone() {
        VerificationTokenRequestParam verificationTokenRequestParam = new VerificationTokenRequestParam();
        verificationTokenRequestParam.appId = this.appId;
        verificationTokenRequestParam.productId = this.productId;
        ...
        VerificationTokenIdentity verificationTokenIdentity = this.identity;
        if (verificationTokenIdentity != null) {
            verificationTokenRequestParam.identity = verificationTokenIdentity.mo223809clone();
        }
        VerificationTokenIdentity verificationTokenIdentity2 = this.picture;
        if (verificationTokenIdentity2 != null) {
            verificationTokenRequestParam.picture = verificationTokenIdentity2.mo223809clone();
        }
