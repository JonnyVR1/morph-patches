...
public class CustomEnvelope extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CustomEnvelope> PROTOBUF_ADAPTER = new MessageNanoAdapter<CustomEnvelope>() { // from class: com.p1.mobile.putong.data.CustomEnvelope.1
        ...
        public int computeAndCacheSize(CustomEnvelope customEnvelope) {
            ...
            if (customData != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, customData, CustomData.PROTOBUF_ADAPTER);
            }
            Pagination pagination = customEnvelope.pagination;
            if (pagination != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(4, pagination, Pagination.PROTOBUF_ADAPTER);
            }
            customEnvelope.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CustomEnvelope parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    customEnvelope.meta = (Meta) nb5Var.m158743l(Meta.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    customEnvelope.counters = (Counter) nb5Var.m158743l(Counter.PROTOBUF_ADAPTER);
                } else if (iM158752u == 26) {
                    customEnvelope.data = (CustomData) nb5Var.m158743l(CustomData.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 34) {
                        if (customEnvelope.meta == null) {
                            customEnvelope.meta = Meta.new_();
                    ...
                    customEnvelope.pagination = (Pagination) nb5Var.m158743l(Pagination.PROTOBUF_ADAPTER);
                }
            }
            return customEnvelope;
        }
        ...
        public void serialize(CustomEnvelope customEnvelope, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CustomData customData = customEnvelope.data;
            if (customData != null) {
                codedOutputByteBufferNano.m17254K(3, customData, CustomData.PROTOBUF_ADAPTER);
            }
            Pagination pagination = customEnvelope.pagination;
            if (pagination != null) {
                codedOutputByteBufferNano.m17254K(4, pagination, Pagination.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public CustomEnvelope mo223809clone() {
        CustomEnvelope customEnvelope = new CustomEnvelope();
        Meta meta = this.meta;
        if (meta != null) {
            customEnvelope.meta = meta.mo223809clone();
        }
        Counter counter = this.counters;
        if (counter != null) {
            customEnvelope.counters = counter.mo223809clone();
        }
        CustomData customData = this.data;
        if (customData != null) {
            customEnvelope.data = customData.mo223809clone();
        }
        Pagination pagination = this.pagination;
        if (pagination != null) {
            customEnvelope.pagination = pagination.mo223809clone();
        }
        return customEnvelope;
    }
