...
import com.p046p1.mobile.putong.data.GPOrder;
...
public class GPData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GPData> PROTOBUF_ADAPTER = new MessageNanoAdapter<GPData>() { // from class: com.p1.mobile.putong.data.GPData.1
        ...
        public int computeAndCacheSize(GPData gPData) {
            ...
            int iM17230l = list != null ? CodedOutputByteBufferNano.m17230l(1, list, GPOrder.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            gPData.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GPData parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                gPData.googlePlayOrders = (List) nb5Var.m158743l(GPOrder.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return gPData;
        }
        ...
        public void serialize(GPData gPData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<GPOrder> list = gPData.googlePlayOrders;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(1, list, GPOrder.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
        ...
        if (list != null) {
            gPData.googlePlayOrders = ValueObject.util_map(list, new w9j() { // from class: l.wdj
                ...
                public final Object call(Object obj) {
                    return ((GPOrder) obj).mo223809clone();
                }
            });
        }
        return gPData;
