...
public class StudentVerification extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StudentVerification> PROTOBUF_ADAPTER = new MessageNanoAdapter<StudentVerification>() { // from class: com.p1.mobile.putong.data.StudentVerification.1
        ...
        public int computeAndCacheSize(StudentVerification studentVerification) {
            ...
            if (studentVerificationStatus != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(5, studentVerificationStatus.ordinal());
            }
            List<StudentVerRejectedReason> list2 = studentVerification.rejectionReasons;
            if (list2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, StudentVerRejectedReason.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool = studentVerification.hideSchoolName;
            if (bool != null) {
                iM17233o += CodedOutputByteBufferNano.m17220b(7, bool.booleanValue());
            }
            StudentVerificationStatus studentVerificationStatus2 = studentVerification.status;
            if (studentVerificationStatus2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(8, studentVerificationStatus2, StudentVerificationStatus.PROTOBUF_ADAPTER);
            }
            List<StudentVerRejectedReason> list3 = studentVerification.rejectionReasons;
            if (list3 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(9, list3, StudentVerRejectedReason.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            studentVerification.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StudentVerification parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    studentVerification.school = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    studentVerification.pictures = (List) nb5Var.m158743l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 26) {
                    studentVerification.startTime = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    studentVerification.endTime = nb5Var.m158750s();
                } else if (iM158752u == 40) {
                    numValueOf = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 50) {
                    list = (List) nb5Var.m158743l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 56) {
                    studentVerification.hideSchoolName = Boolean.valueOf(nb5Var.m158738g());
                } else if (iM158752u == 66) {
                    studentVerification.status = (StudentVerificationStatus) nb5Var.m158743l(StudentVerificationStatus.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 74) {
                        if (studentVerification.status == null && numValueOf != null) {
                            studentVerification.status = (StudentVerificationStatus) StudentVerificationStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    studentVerification.rejectionReasons = (List) nb5Var.m158743l(StudentVerRejectedReason.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return studentVerification;
        }
        ...
        public void serialize(StudentVerification studentVerification, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            StudentVerificationStatus studentVerificationStatus = studentVerification.status;
            if (studentVerificationStatus != null) {
                codedOutputByteBufferNano.m17250G(5, studentVerificationStatus.ordinal());
            }
            List<StudentVerRejectedReason> list2 = studentVerification.rejectionReasons;
            if (list2 != null) {
                codedOutputByteBufferNano.m17254K(6, StudentVerRejectedReason.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool = studentVerification.hideSchoolName;
            if (bool != null) {
            ...
            StudentVerificationStatus studentVerificationStatus2 = studentVerification.status;
            if (studentVerificationStatus2 != null) {
                codedOutputByteBufferNano.m17254K(8, studentVerificationStatus2, StudentVerificationStatus.PROTOBUF_ADAPTER);
            }
            List<StudentVerRejectedReason> list3 = studentVerification.rejectionReasons;
            if (list3 != null) {
                codedOutputByteBufferNano.m17254K(9, list3, StudentVerRejectedReason.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ StudentVerRejectedReason m60096a(StudentVerRejectedReason studentVerRejectedReason) {
    ...
    public StudentVerification mo223809clone() {
        StudentVerification studentVerification = new StudentVerification();
        ...
        if (list2 != null) {
            studentVerification.rejectionReasons = ValueObject.util_map(list2, new w9j() { // from class: l.g2g0
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return StudentVerification.m60096a((StudentVerRejectedReason) obj);
                }
            });
        }
