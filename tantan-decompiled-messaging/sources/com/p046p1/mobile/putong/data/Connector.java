...
public class Connector extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Connector> PROTOBUF_ADAPTER = new MessageNanoAdapter<Connector>() { // from class: com.p1.mobile.putong.data.Connector.1
        ...
        public int computeAndCacheSize(Connector connector) {
            ...
            if (connectorConfig != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, connectorConfig, ConnectorConfig.PROTOBUF_ADAPTER);
            }
            ...
            if (list4 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(7, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            connector.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Connector parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    connector.addr = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    connector.addr_list = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 26) {
                    connector.wss_addr_list = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 34) {
                    connector.tcp_addr_list = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM158752u == 42) {
                    connector.config = (ConnectorConfig) nb5Var.m158743l(ConnectorConfig.PROTOBUF_ADAPTER);
                } else if (iM158752u == 50) {
                    connector.client_ip = nb5Var.m158750s();
                } else {
                    if (iM158752u != 58) {
                        if (connector.addr == null) {
                            connector.addr = "";
                    ...
                    connector.text_room_tcp_addr_list = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return connector;
        }
        ...
        public void serialize(Connector connector, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ConnectorConfig connectorConfig = connector.config;
            if (connectorConfig != null) {
                codedOutputByteBufferNano.m17254K(5, connectorConfig, ConnectorConfig.PROTOBUF_ADAPTER);
            }
            String str2 = connector.client_ip;
            if (str2 != null) {
            ...
            List<String> list4 = connector.text_room_tcp_addr_list;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(7, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m59716a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m59717b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m59718c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m59719d(String str) {
        return str;
    }
    ...
    public Connector mo223809clone() {
        Connector connector = new Connector();
        ...
        if (list != null) {
            connector.addr_list = ValueObject.util_map(list, new w9j() { // from class: l.lw5
                ...
                public final Object call(Object obj) {
                    return Connector.m59719d((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            connector.wss_addr_list = ValueObject.util_map(list2, new w9j() { // from class: l.mw5
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Connector.m59718c((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            connector.tcp_addr_list = ValueObject.util_map(list3, new w9j() { // from class: l.nw5
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Connector.m59717b((String) obj);
                }
            });
        }
        ConnectorConfig connectorConfig = this.config;
        if (connectorConfig != null) {
            connector.config = connectorConfig.mo223809clone();
        }
        ...
        if (list4 != null) {
            connector.text_room_tcp_addr_list = ValueObject.util_map(list4, new w9j() { // from class: l.ow5
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Connector.m59716a((String) obj);
                }
            });
        }
        return connector;
