...
public class FacebookUserInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FacebookUserInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<FacebookUserInfo>() { // from class: com.p1.mobile.putong.data.FacebookUserInfo.1
        ...
        public int computeAndCacheSize(FacebookUserInfo facebookUserInfo) {
            ...
            if (facebookPicture != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(4, facebookPicture, FacebookPicture.PROTOBUF_ADAPTER);
            }
            FacebookInfoIdWithName facebookInfoIdWithName = facebookUserInfo.hometown;
            if (facebookInfoIdWithName != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, facebookInfoIdWithName, FacebookInfoIdWithName.PROTOBUF_ADAPTER);
            }
            FacebookInfoIdWithName facebookInfoIdWithName2 = facebookUserInfo.location;
            if (facebookInfoIdWithName2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(6, facebookInfoIdWithName2, FacebookInfoIdWithName.PROTOBUF_ADAPTER);
            }
            facebookUserInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FacebookUserInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    facebookUserInfo.name = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    facebookUserInfo.birthdate = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    facebookUserInfo.gender = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    facebookUserInfo.picture = (FacebookPicture) nb5Var.m158743l(FacebookPicture.PROTOBUF_ADAPTER);
                } else if (iM158752u == 42) {
                    facebookUserInfo.hometown = (FacebookInfoIdWithName) nb5Var.m158743l(FacebookInfoIdWithName.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 50) {
                        if (facebookUserInfo.name == null) {
                            facebookUserInfo.name = "";
                    ...
                    facebookUserInfo.location = (FacebookInfoIdWithName) nb5Var.m158743l(FacebookInfoIdWithName.PROTOBUF_ADAPTER);
                }
            }
            return facebookUserInfo;
        }
        ...
        public void serialize(FacebookUserInfo facebookUserInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            FacebookPicture facebookPicture = facebookUserInfo.picture;
            if (facebookPicture != null) {
                codedOutputByteBufferNano.m17254K(4, facebookPicture, FacebookPicture.PROTOBUF_ADAPTER);
            }
            FacebookInfoIdWithName facebookInfoIdWithName = facebookUserInfo.hometown;
            if (facebookInfoIdWithName != null) {
                codedOutputByteBufferNano.m17254K(5, facebookInfoIdWithName, FacebookInfoIdWithName.PROTOBUF_ADAPTER);
            }
            FacebookInfoIdWithName facebookInfoIdWithName2 = facebookUserInfo.location;
            if (facebookInfoIdWithName2 != null) {
                codedOutputByteBufferNano.m17254K(6, facebookInfoIdWithName2, FacebookInfoIdWithName.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FacebookUserInfo mo223809clone() {
        FacebookUserInfo facebookUserInfo = new FacebookUserInfo();
        ...
        if (facebookPicture != null) {
            facebookUserInfo.picture = facebookPicture.mo223809clone();
        }
        FacebookInfoIdWithName facebookInfoIdWithName = this.hometown;
        if (facebookInfoIdWithName != null) {
            facebookUserInfo.hometown = facebookInfoIdWithName.mo223809clone();
        }
        FacebookInfoIdWithName facebookInfoIdWithName2 = this.location;
        if (facebookInfoIdWithName2 != null) {
            facebookUserInfo.location = facebookInfoIdWithName2.mo223809clone();
        }
        return facebookUserInfo;
    }
