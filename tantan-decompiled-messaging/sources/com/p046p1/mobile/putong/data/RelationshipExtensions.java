...
public class RelationshipExtensions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RelationshipExtensions> PROTOBUF_ADAPTER = new MessageNanoAdapter<RelationshipExtensions>() { // from class: com.p1.mobile.putong.data.RelationshipExtensions.1
        ...
        public int computeAndCacheSize(RelationshipExtensions relationshipExtensions) {
            ...
            if (superlikeReason != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(4, superlikeReason.ordinal());
            }
            int iM17226h = iM17233o + CodedOutputByteBufferNano.m17226h(5, relationshipExtensions.soulScore);
            SuperlikeReason superlikeReason2 = relationshipExtensions.superlikeReason;
            if (superlikeReason2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(6, superlikeReason2, SuperlikeReason.PROTOBUF_ADAPTER);
            }
            ...
            if (str7 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(10, str7);
            }
            String str8 = relationshipExtensions.sendSuperLikedNum;
            if (str8 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(11, str8);
            }
            String str9 = relationshipExtensions.recvSuperLikedNum;
            if (str9 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(12, str9);
            }
            String str10 = relationshipExtensions.momentId;
            if (str10 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(13, str10);
            }
            String str11 = relationshipExtensions.otherMomentId;
            if (str11 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(14, str11);
            }
            RelationshipStatus relationshipStatus = relationshipExtensions.relationType;
            if (relationshipStatus != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(15, relationshipStatus, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            RelationshipStatus relationshipStatus2 = relationshipExtensions.otherRelationType;
            if (relationshipStatus2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(16, relationshipStatus2, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            String str12 = relationshipExtensions.roomID;
            if (str12 != null) {
                iM17226h += CodedOutputByteBufferNano.m17233o(17, str12);
            }
            relationshipExtensions.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RelationshipExtensions parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        relationshipExtensions.letter = nb5Var.m158750s();
                        continue;
                    case 18:
                        relationshipExtensions.otherLetter = nb5Var.m158750s();
                        continue;
                    case 26:
                        relationshipExtensions.superlikeNum = nb5Var.m158750s();
                        continue;
                    case 32:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 40:
                        relationshipExtensions.soulScore = nb5Var.m158741j();
                        continue;
                    case 50:
                        relationshipExtensions.superlikeReason = (SuperlikeReason) nb5Var.m158743l(SuperlikeReason.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        relationshipExtensions.otherLiteratureCommentId = nb5Var.m158750s();
                        continue;
                    case 66:
                        relationshipExtensions.literatureCommentId = nb5Var.m158750s();
                        continue;
                    case 74:
                        relationshipExtensions.literatureId = nb5Var.m158750s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        relationshipExtensions.business_type = nb5Var.m158750s();
                        continue;
                    case 90:
                        relationshipExtensions.sendSuperLikedNum = nb5Var.m158750s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        relationshipExtensions.recvSuperLikedNum = nb5Var.m158750s();
                        continue;
                    case 106:
                        relationshipExtensions.momentId = nb5Var.m158750s();
                        continue;
                    case 114:
                        relationshipExtensions.otherMomentId = nb5Var.m158750s();
                        continue;
                    case 122:
                        relationshipExtensions.relationType = (RelationshipStatus) nb5Var.m158743l(RelationshipStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        relationshipExtensions.otherRelationType = (RelationshipStatus) nb5Var.m158743l(RelationshipStatus.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        relationshipExtensions.roomID = nb5Var.m158750s();
                        continue;
                    default:
                        if (relationshipExtensions.superlikeReason == null && numValueOf != null) {
                            relationshipExtensions.superlikeReason = (SuperlikeReason) SuperlikeReason.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(RelationshipExtensions relationshipExtensions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            SuperlikeReason superlikeReason = relationshipExtensions.superlikeReason;
            if (superlikeReason != null) {
                codedOutputByteBufferNano.m17250G(4, superlikeReason.ordinal());
            }
            codedOutputByteBufferNano.m17250G(5, relationshipExtensions.soulScore);
            SuperlikeReason superlikeReason2 = relationshipExtensions.superlikeReason;
            if (superlikeReason2 != null) {
                codedOutputByteBufferNano.m17254K(6, superlikeReason2, SuperlikeReason.PROTOBUF_ADAPTER);
            }
            String str4 = relationshipExtensions.otherLiteratureCommentId;
            if (str4 != null) {
            ...
            RelationshipStatus relationshipStatus = relationshipExtensions.relationType;
            if (relationshipStatus != null) {
                codedOutputByteBufferNano.m17254K(15, relationshipStatus, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            RelationshipStatus relationshipStatus2 = relationshipExtensions.otherRelationType;
            if (relationshipStatus2 != null) {
                codedOutputByteBufferNano.m17254K(16, relationshipStatus2, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            String str12 = relationshipExtensions.roomID;
            if (str12 != null) {
                codedOutputByteBufferNano.m17261R(17, str12);
            }
        }
    };
    ...
    public RelationshipExtensions mo223809clone() {
        RelationshipExtensions relationshipExtensions = new RelationshipExtensions();
