...
public class UserState extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserState> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserState>() { // from class: com.p1.mobile.putong.data.UserState.1
        ...
        public int computeAndCacheSize(UserState userState) {
            ...
            int iM17230l = userStateContent != null ? CodedOutputByteBufferNano.m17230l(1, userStateContent, UserStateContent.PROTOBUF_ADAPTER) : 0;
            UserStateContent userStateContent2 = userState.restricted;
            if (userStateContent2 != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(2, userStateContent2, UserStateContent.PROTOBUF_ADAPTER);
            }
            JailedBusiness jailedBusiness = userState.jailedBusiness;
            if (jailedBusiness != null) {
                iM17230l += CodedOutputByteBufferNano.m17230l(3, jailedBusiness, JailedBusiness.PROTOBUF_ADAPTER);
            }
            userState.cachedSize = iM17230l;
            return iM17230l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserState parse(nb5 nb5Var) throws IOException {
            UserState userState = new UserState();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 10) {
                    userState.jailed = (UserStateContent) nb5Var.m158743l(UserStateContent.PROTOBUF_ADAPTER);
                } else if (iM158752u == 18) {
                    userState.restricted = (UserStateContent) nb5Var.m158743l(UserStateContent.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 26) {
                        return userState;
                    }
                    userState.jailedBusiness = (JailedBusiness) nb5Var.m158743l(JailedBusiness.PROTOBUF_ADAPTER);
                }
            }
        }
        ...
        public void serialize(UserState userState, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (userStateContent != null) {
                codedOutputByteBufferNano.m17254K(1, userStateContent, UserStateContent.PROTOBUF_ADAPTER);
            }
            UserStateContent userStateContent2 = userState.restricted;
            if (userStateContent2 != null) {
                codedOutputByteBufferNano.m17254K(2, userStateContent2, UserStateContent.PROTOBUF_ADAPTER);
            }
            JailedBusiness jailedBusiness = userState.jailedBusiness;
            if (jailedBusiness != null) {
                codedOutputByteBufferNano.m17254K(3, jailedBusiness, JailedBusiness.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public UserState mo223809clone() {
        UserState userState = new UserState();
        UserStateContent userStateContent = this.jailed;
        if (userStateContent != null) {
            userState.jailed = userStateContent.mo223809clone();
        }
        UserStateContent userStateContent2 = this.restricted;
        if (userStateContent2 != null) {
            userState.restricted = userStateContent2.mo223809clone();
        }
        JailedBusiness jailedBusiness = this.jailedBusiness;
        if (jailedBusiness != null) {
            userState.jailedBusiness = jailedBusiness.mo223809clone();
        }
        return userState;
    }
