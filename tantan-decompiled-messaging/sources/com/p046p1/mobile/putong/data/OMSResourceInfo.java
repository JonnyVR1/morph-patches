...
public class OMSResourceInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSResourceInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSResourceInfo>() { // from class: com.p1.mobile.putong.data.OMSResourceInfo.1
        ...
        public int computeAndCacheSize(OMSResourceInfo oMSResourceInfo) {
            ...
            if (oMSResourceType != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(2, oMSResourceType.ordinal());
            }
            ...
            if (list != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, list, OMSResourceContent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (resourceDirection != null) {
                iM17233o += CodedOutputByteBufferNano.m17226h(7, resourceDirection.ordinal());
            }
            OmsMerCuryData omsMerCuryData = oMSResourceInfo.mercury;
            if (omsMerCuryData != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(8, omsMerCuryData, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OMSResourceType oMSResourceType2 = oMSResourceInfo.type;
            if (oMSResourceType2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(9, oMSResourceType2, OMSResourceType.PROTOBUF_ADAPTER);
            }
            ResourceDirection resourceDirection2 = oMSResourceInfo.direction;
            if (resourceDirection2 != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(10, resourceDirection2, ResourceDirection.PROTOBUF_ADAPTER);
            }
            oMSResourceInfo.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSResourceInfo parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        oMSResourceInfo.index = nb5Var.m158750s();
                        continue;
                    case 16:
                        numValueOf = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 26:
                        oMSResourceInfo.url = nb5Var.m158750s();
                        continue;
                    case 34:
                        oMSResourceInfo.src = nb5Var.m158750s();
                        continue;
                    case 42:
                        oMSResourceInfo.content = (List) nb5Var.m158743l(OMSResourceContent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        oMSResourceInfo.colors = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 56:
                        numValueOf2 = Integer.valueOf(nb5Var.m158741j());
                        continue;
                    case 66:
                        oMSResourceInfo.mercury = (OmsMerCuryData) nb5Var.m158743l(OmsMerCuryData.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        oMSResourceInfo.type = (OMSResourceType) nb5Var.m158743l(OMSResourceType.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        oMSResourceInfo.direction = (ResourceDirection) nb5Var.m158743l(ResourceDirection.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (oMSResourceInfo.type == null && numValueOf != null) {
                            oMSResourceInfo.type = (OMSResourceType) OMSResourceType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(OMSResourceInfo oMSResourceInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            OMSResourceType oMSResourceType = oMSResourceInfo.type;
            if (oMSResourceType != null) {
                codedOutputByteBufferNano.m17250G(2, oMSResourceType.ordinal());
            }
            String str2 = oMSResourceInfo.url;
            if (str2 != null) {
            ...
            List<OMSResourceContent> list = oMSResourceInfo.content;
            if (list != null) {
                codedOutputByteBufferNano.m17254K(5, list, OMSResourceContent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list2 = oMSResourceInfo.colors;
            if (list2 != null) {
            ...
            ResourceDirection resourceDirection = oMSResourceInfo.direction;
            if (resourceDirection != null) {
                codedOutputByteBufferNano.m17250G(7, resourceDirection.ordinal());
            }
            OmsMerCuryData omsMerCuryData = oMSResourceInfo.mercury;
            if (omsMerCuryData != null) {
                codedOutputByteBufferNano.m17254K(8, omsMerCuryData, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            OMSResourceType oMSResourceType2 = oMSResourceInfo.type;
            if (oMSResourceType2 != null) {
                codedOutputByteBufferNano.m17254K(9, oMSResourceType2, OMSResourceType.PROTOBUF_ADAPTER);
            }
            ResourceDirection resourceDirection2 = oMSResourceInfo.direction;
            if (resourceDirection2 != null) {
                codedOutputByteBufferNano.m17254K(10, resourceDirection2, ResourceDirection.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m59928b(String str) {
        return str;
    }
    ...
    public OMSResourceInfo mo223809clone() {
        OMSResourceInfo oMSResourceInfo = new OMSResourceInfo();
        ...
        if (list2 != null) {
            oMSResourceInfo.colors = ValueObject.util_map(list2, new w9j() { // from class: l.jz40
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return OMSResourceInfo.m59928b((String) obj);
                }
            });
        }
        ...
        if (omsMerCuryData != null) {
            oMSResourceInfo.mercury = omsMerCuryData.mo223809clone();
        }
        return oMSResourceInfo;
    }
