...
public class DiamondVIPPrivilegeSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DiamondVIPPrivilegeSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<DiamondVIPPrivilegeSettings>() { // from class: com.p1.mobile.putong.data.DiamondVIPPrivilegeSettings.1
        ...
        public int computeAndCacheSize(DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings) {
            int iM17228j = CodedOutputByteBufferNano.m17228j(1, diamondVIPPrivilegeSettings.expiredTime) + CodedOutputByteBufferNano.m17228j(2, diamondVIPPrivilegeSettings.trialExpiredTime);
            DiamondVIPBoostType diamondVIPBoostType = diamondVIPPrivilegeSettings.boostMode;
            if (diamondVIPBoostType != null) {
                iM17228j += CodedOutputByteBufferNano.m17226h(3, diamondVIPBoostType.ordinal());
            }
            int iM17220b = iM17228j + CodedOutputByteBufferNano.m17220b(4, diamondVIPPrivilegeSettings.mysterySwipe) + CodedOutputByteBufferNano.m17220b(5, diamondVIPPrivilegeSettings.showQualityIdentity);
            DiamondVIPBoostType diamondVIPBoostType2 = diamondVIPPrivilegeSettings.boostMode;
            if (diamondVIPBoostType2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(6, diamondVIPBoostType2, DiamondVIPBoostType.PROTOBUF_ADAPTER);
            }
            diamondVIPPrivilegeSettings.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DiamondVIPPrivilegeSettings parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    diamondVIPPrivilegeSettings.expiredTime = nb5Var.m158742k();
                } else if (iM158752u == 16) {
                    diamondVIPPrivilegeSettings.trialExpiredTime = nb5Var.m158742k();
                } else if (iM158752u == 24) {
                    numValueOf = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 32) {
                    diamondVIPPrivilegeSettings.mysterySwipe = nb5Var.m158738g();
                } else if (iM158752u == 40) {
                    diamondVIPPrivilegeSettings.showQualityIdentity = nb5Var.m158738g();
                } else {
                    if (iM158752u != 50) {
                        if (diamondVIPPrivilegeSettings.boostMode == null && numValueOf != null) {
                            diamondVIPPrivilegeSettings.boostMode = (DiamondVIPBoostType) DiamondVIPBoostType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    diamondVIPPrivilegeSettings.boostMode = (DiamondVIPBoostType) nb5Var.m158743l(DiamondVIPBoostType.PROTOBUF_ADAPTER);
                }
            }
            return diamondVIPPrivilegeSettings;
        }
        ...
        public void serialize(DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17252I(1, diamondVIPPrivilegeSettings.expiredTime);
            codedOutputByteBufferNano.m17252I(2, diamondVIPPrivilegeSettings.trialExpiredTime);
            DiamondVIPBoostType diamondVIPBoostType = diamondVIPPrivilegeSettings.boostMode;
            if (diamondVIPBoostType != null) {
                codedOutputByteBufferNano.m17250G(3, diamondVIPBoostType.ordinal());
            }
            codedOutputByteBufferNano.m17244A(4, diamondVIPPrivilegeSettings.mysterySwipe);
            codedOutputByteBufferNano.m17244A(5, diamondVIPPrivilegeSettings.showQualityIdentity);
            DiamondVIPBoostType diamondVIPBoostType2 = diamondVIPPrivilegeSettings.boostMode;
            if (diamondVIPBoostType2 != null) {
                codedOutputByteBufferNano.m17254K(6, diamondVIPBoostType2, DiamondVIPBoostType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public DiamondVIPPrivilegeSettings mo223809clone() {
        DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = new DiamondVIPPrivilegeSettings();
