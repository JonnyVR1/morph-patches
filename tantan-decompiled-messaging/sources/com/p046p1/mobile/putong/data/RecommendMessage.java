...
public class RecommendMessage extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RecommendMessage> PROTOBUF_ADAPTER = new MessageNanoAdapter<RecommendMessage>() { // from class: com.p1.mobile.putong.data.RecommendMessage.1
        ...
        public int computeAndCacheSize(RecommendMessage recommendMessage) {
            ...
            if (commonGiftInfo != null) {
                iM17233o += CodedOutputByteBufferNano.m17230l(5, commonGiftInfo, CommonGiftInfo.PROTOBUF_ADAPTER);
            }
            recommendMessage.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RecommendMessage parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 10) {
                    recommendMessage.userId = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    recommendMessage.otherUserId = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    recommendMessage.messageType = nb5Var.m158750s();
                } else if (iM158752u == 34) {
                    recommendMessage.messageValue = nb5Var.m158750s();
                } else {
                    if (iM158752u != 42) {
                        if (recommendMessage.userId == null) {
                            recommendMessage.userId = "";
                    ...
                    recommendMessage.giftInfo = (CommonGiftInfo) nb5Var.m158743l(CommonGiftInfo.PROTOBUF_ADAPTER);
                }
            }
            return recommendMessage;
        }
        ...
        public void serialize(RecommendMessage recommendMessage, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CommonGiftInfo commonGiftInfo = recommendMessage.giftInfo;
            if (commonGiftInfo != null) {
                codedOutputByteBufferNano.m17254K(5, commonGiftInfo, CommonGiftInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public RecommendMessage mo223809clone() {
        RecommendMessage recommendMessage = new RecommendMessage();
        ...
        if (commonGiftInfo != null) {
            recommendMessage.giftInfo = commonGiftInfo.mo223809clone();
        }
        return recommendMessage;
    }
