...
public class Banners extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Banners> PROTOBUF_ADAPTER = new MessageNanoAdapter<Banners>() { // from class: com.p1.mobile.putong.data.Banners.1
        ...
        public int computeAndCacheSize(Banners banners) {
            int iM17226h = CodedOutputByteBufferNano.m17226h(1, banners.f38724id);
            BannerLoc bannerLoc = banners.loc;
            if (bannerLoc != null) {
                iM17226h += CodedOutputByteBufferNano.m17226h(2, bannerLoc.ordinal());
            }
            BannerAction bannerAction = banners.action;
            if (bannerAction != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(3, bannerAction, BannerAction.PROTOBUF_ADAPTER);
            }
            BannerContent bannerContent = banners.content;
            if (bannerContent != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(4, bannerContent, BannerContent.PROTOBUF_ADAPTER);
            }
            BannerLoc bannerLoc2 = banners.loc;
            if (bannerLoc2 != null) {
                iM17226h += CodedOutputByteBufferNano.m17230l(5, bannerLoc2, BannerLoc.PROTOBUF_ADAPTER);
            }
            banners.cachedSize = iM17226h;
            return iM17226h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Banners parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM158752u == 8) {
                    banners.f38724id = nb5Var.m158741j();
                } else if (iM158752u == 16) {
                    numValueOf = Integer.valueOf(nb5Var.m158741j());
                } else if (iM158752u == 26) {
                    banners.action = (BannerAction) nb5Var.m158743l(BannerAction.PROTOBUF_ADAPTER);
                } else if (iM158752u == 34) {
                    banners.content = (BannerContent) nb5Var.m158743l(BannerContent.PROTOBUF_ADAPTER);
                } else {
                    if (iM158752u != 42) {
                        if (banners.loc == null && numValueOf != null) {
                            banners.loc = (BannerLoc) BannerLoc.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    banners.loc = (BannerLoc) nb5Var.m158743l(BannerLoc.PROTOBUF_ADAPTER);
                }
            }
            return banners;
        }
        ...
        public void serialize(Banners banners, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17250G(1, banners.f38724id);
            BannerLoc bannerLoc = banners.loc;
            if (bannerLoc != null) {
                codedOutputByteBufferNano.m17250G(2, bannerLoc.ordinal());
            }
            BannerAction bannerAction = banners.action;
            if (bannerAction != null) {
                codedOutputByteBufferNano.m17254K(3, bannerAction, BannerAction.PROTOBUF_ADAPTER);
            }
            BannerContent bannerContent = banners.content;
            if (bannerContent != null) {
                codedOutputByteBufferNano.m17254K(4, bannerContent, BannerContent.PROTOBUF_ADAPTER);
            }
            BannerLoc bannerLoc2 = banners.loc;
            if (bannerLoc2 != null) {
                codedOutputByteBufferNano.m17254K(5, bannerLoc2, BannerLoc.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Banners> JSON_ADAPTER = new ObjectJsonAdapter<Banners>() { // from class: com.p1.mobile.putong.data.Banners.2
        ...
        public boolean parseField(Banners banners, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "action":
                    ...
                    return true;
                case "id":
                    banners.f38724id = jsonParser.getValueAsInt();
                    return false;
                case "loc":
        ...
        public void serializeFields(Banners banners, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", banners.f38724id);
            if (banners.loc != null) {
    ...
    public Banners mo223809clone() {
        Banners banners = new Banners();
        banners.f38724id = this.f38724id;
        banners.loc = this.loc;
        BannerAction bannerAction = this.action;
        if (bannerAction != null) {
            banners.action = bannerAction.mo223809clone();
        }
        BannerContent bannerContent = this.content;
        if (bannerContent != null) {
            banners.content = bannerContent.mo223809clone();
        }
        return banners;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f38724id == banners.f38724id && ValueObject.util_equals(this.loc, banners.loc) && ValueObject.util_equals(this.action, banners.action) && ValueObject.util_equals(this.content, banners.content);
    }
