...
public class Picture extends Media implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Picture> PROTOBUF_ADAPTER = new MessageNanoAdapter<Picture>() { // from class: com.p1.mobile.putong.data.Picture.1
        ...
        public int computeAndCacheSize(Picture picture) {
            ...
            int iM17220b = iM17226h + CodedOutputByteBufferNano.m17220b(9, picture.isPortrait);
            ...
            if (dimension != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(51, dimension, Dimension.PROTOBUF_ADAPTER);
            }
            AIPosition aIPosition = picture.aiPosition;
            if (aIPosition != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(52, aIPosition, AIPosition.PROTOBUF_ADAPTER);
            }
            List<Picture> list4 = picture.attachments;
            if (list4 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(53, list4, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GaussianBlurParameters gaussianBlurParameters = picture.gaussianBlurParameters;
            if (gaussianBlurParameters != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(54, gaussianBlurParameters, GaussianBlurParameters.PROTOBUF_ADAPTER);
            }
            MediaLocalStatus mediaLocalStatus2 = picture.status;
            if (mediaLocalStatus2 != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(55, mediaLocalStatus2, MediaLocalStatus.PROTOBUF_ADAPTER);
            }
            LivePhoto livePhoto = picture.livePhoto;
            if (livePhoto != null) {
                iM17220b += CodedOutputByteBufferNano.m17230l(56, livePhoto, LivePhoto.PROTOBUF_ADAPTER);
            }
            picture.cachedSize = iM17220b;
            return iM17220b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Picture parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.m158752u()) {
                    ...
                    case 8:
                        ...
                        continue;
                    case 18:
                        picture.url = nb5Var.m158750s();
                        continue;
                    case 26:
                        picture.urlKey = nb5Var.m158750s();
                        continue;
                    case 34:
                        picture.name = nb5Var.m158750s();
                        continue;
                    case 42:
                        picture.mediaType = nb5Var.m158750s();
                        continue;
                    case 50:
                        picture.meta = (MediaMeta) nb5Var.m158743l(MediaMeta.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        picture.originUrl = nb5Var.m158750s();
                        continue;
                    case 72:
                        picture.isPortrait = nb5Var.m158738g();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        picture.labels = (List) nb5Var.m158743l(MediaLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        picture.tags = (List) nb5Var.m158743l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        picture.tagIdealInfo = (List) nb5Var.m158743l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 410:
                        picture.size = (Dimension) nb5Var.m158743l(Dimension.PROTOBUF_ADAPTER);
                        continue;
                    case 418:
                        picture.aiPosition = (AIPosition) nb5Var.m158743l(AIPosition.PROTOBUF_ADAPTER);
                        continue;
                    case 426:
                        picture.attachments = (List) nb5Var.m158743l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 434:
                        picture.gaussianBlurParameters = (GaussianBlurParameters) nb5Var.m158743l(GaussianBlurParameters.PROTOBUF_ADAPTER);
                        continue;
                    case 442:
                        picture.status = (MediaLocalStatus) nb5Var.m158743l(MediaLocalStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 450:
                        picture.livePhoto = (LivePhoto) nb5Var.m158743l(LivePhoto.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (picture.status == null && numValueOf != null) {
                            picture.status = (MediaLocalStatus) MediaLocalStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Picture picture, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17244A(9, picture.isPortrait);
            List<MediaLabel> list = picture.labels;
            if (list != null) {
            ...
            AIPosition aIPosition = picture.aiPosition;
            if (aIPosition != null) {
                codedOutputByteBufferNano.m17254K(52, aIPosition, AIPosition.PROTOBUF_ADAPTER);
            }
            List<Picture> list4 = picture.attachments;
            if (list4 != null) {
                codedOutputByteBufferNano.m17254K(53, list4, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GaussianBlurParameters gaussianBlurParameters = picture.gaussianBlurParameters;
            if (gaussianBlurParameters != null) {
                codedOutputByteBufferNano.m17254K(54, gaussianBlurParameters, GaussianBlurParameters.PROTOBUF_ADAPTER);
            }
            MediaLocalStatus mediaLocalStatus2 = picture.status;
            if (mediaLocalStatus2 != null) {
                codedOutputByteBufferNano.m17254K(55, mediaLocalStatus2, MediaLocalStatus.PROTOBUF_ADAPTER);
            }
            LivePhoto livePhoto = picture.livePhoto;
            if (livePhoto != null) {
                codedOutputByteBufferNano.m17254K(56, livePhoto, LivePhoto.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ MediaLabel m59996d(MediaLabel mediaLabel) {
        return mediaLabel;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m59997e(String str) {
        return str;
    }
    ...
    public static boolean userWebpInPicture() {
        return !RemoteConfig.m79298x().m79330s("picture_format_config") && wc40.m202626c();
    }
    ...
    public Picture mo223809clone() {
        ...
        if (mediaMeta != null) {
            picture.meta = mediaMeta.mo223809clone();
        }
        ...
        if (list != null) {
            picture.labels = ValueObject.util_map(list, new w9j() { // from class: l.fh70
                ...
                public final Object call(Object obj) {
                    return Picture.m59996d((MediaLabel) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            picture.tags = ValueObject.util_map(list2, new w9j() { // from class: l.gh70
                @Override // p149l.w9j
                public final Object call(Object obj) {
                    return Picture.m59997e((String) obj);
                }
            });
        }
        ...
        Dimension dimension = this.size;
        if (dimension != null) {
            picture.size = dimension.mo223809clone();
        }
        AIPosition aIPosition = this.aiPosition;
        if (aIPosition != null) {
            picture.aiPosition = aIPosition.mo223809clone();
        }
        ...
        if (gaussianBlurParameters != null) {
            picture.gaussianBlurParameters = gaussianBlurParameters.mo223809clone();
        }
        LivePhoto livePhoto = this.livePhoto;
        if (livePhoto != null) {
            picture.livePhoto = livePhoto.mo223809clone();
        }
        return picture;
    }
    ...
    public boolean isAiFakePic() {
        return !vwb.m200296J(this.labels) && this.labels.contains(MediaLabel.get(MediaLabel.WITH_AUDIT_AI_PICTURE));
    }
    ...
    public boolean isLabelJudge(MediaLabel mediaLabel) {
        return !vwb.m200296J(this.labels) && this.labels.contains(mediaLabel);
    }

    public boolean isLow() {
        return !vwb.m200296J(this.labels) && this.labels.contains(MediaLabel.get(MediaLabel.WITH_LOW));
    }
    ...
    public boolean isVerificationCheckFail() {
        return !vwb.m200296J(this.labels) && this.labels.contains(MediaLabel.get(MediaLabel.NOT_VERIFICATION));
    }
    ...
    public ImageUri momentPictureSmall() {
        return atMostShortDimension(t100.m186890d(74.0f));
    }
    ...
    public ImageUri profileSmall() {
        return squareAtLeast(t100.m186890d(42.0f));
    }
    ...
    public void removeLabel(final MediaLabel mediaLabel) {
        ...
        vwb.m200320d0(list, new w9j() { // from class: l.dh70
            @Override // p149l.w9j
            public final Object call(Object obj) {
    ...
    public void removeLowLabel() {
        ...
        vwb.m200320d0(list, new w9j() { // from class: l.eh70
            @Override // p149l.w9j
            public final Object call(Object obj) {
    ...
    public j760<ImageUri, Point> stickerItemInMessages() {
        int iM186890d = t100.m186890d(App.f15372h ? 128.0f : 144.0f);
        Dimension dimension = this.size;
        int i = dimension.width;
        int i2 = dimension.height;
        if (i > i2) {
            int iMin = Math.min(i, iM186890d);
            Dimension dimension2 = this.size;
            return vwb.m200311Y(aboutWidth(iMin, ".png"), new Point(iMin, (dimension2.height * iMin) / dimension2.width));
        }
        int iMin2 = Math.min(i2, iM186890d);
        Dimension dimension3 = this.size;
        int i3 = (dimension3.width * iMin2) / dimension3.height;
        return vwb.m200311Y(aboutWidth(i3, ".png"), new Point(i3, iMin2));
    }
    ...
    public static final class ImageUri {
        ...
        public boolean checkUrlBeanAvailable() {
            if (this.formatWidth <= 0 || !NullChecker.m81303a(this.orignalDimen)) {
                return false;
            }
        ...
        public String formatted(int i) {
            ...
            if (i2 == 2) {
                return strConcat + "?format=" + i + BaseSei.f13930X + i;
            }
            if (i2 == 1) {
