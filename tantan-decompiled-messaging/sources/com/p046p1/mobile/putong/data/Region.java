...
public class Region extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Region> PROTOBUF_ADAPTER = new MessageNanoAdapter<Region>() { // from class: com.p1.mobile.putong.data.Region.1
        ...
        public int computeAndCacheSize(Region region) {
            ...
            region.cachedSize = iM17233o;
            return iM17233o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Region parse(nb5 nb5Var) throws IOException {
            Region region = new Region();
            while (true) {
                int iM158752u = nb5Var.m158752u();
                if (iM158752u == 10) {
                    region.district = nb5Var.m158750s();
                } else if (iM158752u == 18) {
                    region.city = nb5Var.m158750s();
                } else if (iM158752u == 26) {
                    region.country = nb5Var.m158750s();
                } else {
                    if (iM158752u != 34) {
                        return region;
                    }
                    region.province = nb5Var.m158750s();
                }
            }
        }
