...
public final class LongLinkLiveLeadBoardMsg {
    ...
    public static /* synthetic */ class C44251 {
        ...
        static {
            ...
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15948xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class LeaderboardEffectInfo extends GeneratedMessageLite<LeaderboardEffectInfo, Builder> implements LeaderboardEffectInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LeaderboardEffectInfo, Builder> implements LeaderboardEffectInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C44251.f15948xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.userName_ = interfaceC3386h.mo16997f(!this.userName_.isEmpty(), this.userName_, !leaderboardEffectInfo.userName_.isEmpty(), leaderboardEffectInfo.userName_);
                    this.userPic_ = interfaceC3386h.mo16997f(!this.userPic_.isEmpty(), this.userPic_, !leaderboardEffectInfo.userPic_.isEmpty(), leaderboardEffectInfo.userPic_);
                    this.title_ = interfaceC3386h.mo16997f(!this.title_.isEmpty(), this.title_, !leaderboardEffectInfo.title_.isEmpty(), leaderboardEffectInfo.title_);
                    this.content_ = interfaceC3386h.mo16997f(!this.content_.isEmpty(), this.content_, !leaderboardEffectInfo.content_.isEmpty(), leaderboardEffectInfo.content_);
                    this.svgUrl_ = interfaceC3386h.mo16997f(!this.svgUrl_.isEmpty(), this.svgUrl_, !leaderboardEffectInfo.svgUrl_.isEmpty(), leaderboardEffectInfo.svgUrl_);
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != LeaderboardEffectType.week.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            if (!this.userName_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getUserName());
            }
            if (!this.userPic_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(3, getUserPic());
            }
            if (!this.title_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(4, getTitle());
            }
            if (!this.content_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(5, getContent());
            }
            if (!this.svgUrl_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(6, getSvgUrl());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.userPic_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getUserPic());
            }
            if (!this.title_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getTitle());
            }
            if (!this.content_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getContent());
            }
            if (this.svgUrl_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(6, getSvgUrl());
        }

        public static LeaderboardEffectInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LeaderboardEffectInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LeaderboardEffectInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LeaderboardEffectInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static LeaderboardEffectInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LeaderboardEffectInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LeaderboardEffectInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LeaderboardEffectInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LeaderboardEffectInfo parseFrom(C3407e c3407e) throws IOException {
            return (LeaderboardEffectInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LeaderboardEffectInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LeaderboardEffectInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum LeaderboardEffectType implements C3414l.c {
        week(0),
        second(1),
        love(2),
        UNRECOGNIZED(-1);

        private static final C3414l.d<LeaderboardEffectType> internalValueMap = new C3414l.d<LeaderboardEffectType>() { // from class: com.p1.mobile.longlink.msg.live.leaderboard.LongLinkLiveLeadBoardMsg.LeaderboardEffectType.1
        ...
        public static C3414l.d<LeaderboardEffectType> internalGetValueMap() {
