...
public final class voiceGrabHat {
    ...
    public static /* synthetic */ class C45421 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f15993xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15993xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15993xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class VoiceGrabHat extends GeneratedMessageLite<VoiceGrabHat, Builder> implements VoiceGrabHatOrBuilder {
        ...
        private C3414l.h<CallHatInfo> callHatInfos_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllCallHatInfos(Iterable<? extends CallHatInfo> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.callHatInfos_);
        }
        ...
        private void ensureCallHatInfosIsMutable() {
            if (this.callHatInfos_.mo17085q()) {
                return;
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45421.f15993xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                    return new VoiceGrabHat();
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    this.callHatInfos_.mo17084n();
                    return null;
                case 4:
                    return new Builder();
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !voiceGrabHat.id_.isEmpty(), voiceGrabHat.id_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !voiceGrabHat.liveId_.isEmpty(), voiceGrabHat.liveId_);
                    this.status_ = interfaceC3386h.mo16997f(!this.status_.isEmpty(), this.status_, !voiceGrabHat.status_.isEmpty(), voiceGrabHat.status_);
                    this.callHatInfos_ = interfaceC3386h.mo16998g(this.callHatInfos_, voiceGrabHat.callHatInfos_);
                    long j = this.updatedTime_;
                    boolean z2 = j != 0;
                    long j2 = voiceGrabHat.updatedTime_;
                    this.updatedTime_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    this.toast_ = interfaceC3386h.mo16997f(!this.toast_.isEmpty(), this.toast_, !voiceGrabHat.toast_.isEmpty(), voiceGrabHat.toast_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.callHatInfos_.add((CallHatInfo) c3407e.m17143w(CallHatInfo.parser(), c3410h));
                                } else if (iM17116M == 40) {
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.callHatInfos_.size(); i2++) {
                iM16901K += CodedOutputStream.m16893C(4, this.callHatInfos_.get(i2));
            }
            long j = this.updatedTime_;
            if (j != 0) {
            ...
            if (!this.toast_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getToast());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i = 0; i < this.callHatInfos_.size(); i++) {
                codedOutputStream.mo16974w0(4, this.callHatInfos_.get(i));
            }
            long j = this.updatedTime_;
            if (j != 0) {
            ...
            codedOutputStream.mo16939D0(6, getToast());
        }
        ...
        public static final class CallHatInfo extends GeneratedMessageLite<CallHatInfo, Builder> implements CallHatInfoOrBuilder {
            ...
            public static final class Builder extends GeneratedMessageLite.AbstractC3380b<CallHatInfo, Builder> implements CallHatInfoOrBuilder {
                private Builder() {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (C45421.f15993xa1df5c61[methodToInvoke.ordinal()]) {
                    ...
                    case 5:
                        ...
                        this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !callHatInfo.userId_.isEmpty(), callHatInfo.userId_);
                        long j = this.point_;
                        boolean z2 = j != 0;
                        long j2 = callHatInfo.point_;
                        this.point_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                        this.hatUrl_ = interfaceC3386h.mo16997f(!this.hatUrl_.isEmpty(), this.hatUrl_, !callHatInfo.hatUrl_.isEmpty(), callHatInfo.hatUrl_);
                            ...
                            try {
                                ...
                                if (iM17116M != 0) {
                                    if (iM17116M == 10) {
                                        ...
                                        this.point_ = c3407e.m17142v();
                                    } else if (iM17116M == 26) {
                                        this.hatUrl_ = c3407e.m17115L();
                                    } else if (!c3407e.m17121R(iM17116M)) {
                                    }
                                }
                                z = true;
            ...
            public int getSerializedSize() {
                ...
                if (!this.hatUrl_.isEmpty()) {
                    iM16901K += CodedOutputStream.m16901K(3, getHatUrl());
                }
                this.memoizedSerializedSize = iM16901K;
                return iM16901K;
            }
            ...
            public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
                ...
                codedOutputStream.mo16939D0(3, getHatUrl());
            }

            public static CallHatInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
                return (CallHatInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
            }

            public static CallHatInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
                return (CallHatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
            }
            ...
            public static CallHatInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
                return (CallHatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
            }
            ...
            public static CallHatInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
                return (CallHatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
            }

            public static CallHatInfo parseFrom(C3407e c3407e) throws IOException {
                return (CallHatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
            }
            ...
            public static CallHatInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
                return (CallHatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
            }
        }

        public static VoiceGrabHat parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceGrabHat) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceGrabHat parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceGrabHat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceGrabHat, Builder> implements VoiceGrabHatOrBuilder {
            private Builder() {
        ...
        public static VoiceGrabHat parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceGrabHat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceGrabHat parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceGrabHat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceGrabHat parseFrom(C3407e c3407e) throws IOException {
            return (VoiceGrabHat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceGrabHat parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceGrabHat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public static final class VoiceGrabHatCp extends GeneratedMessageLite<VoiceGrabHatCp, Builder> implements VoiceGrabHatCpOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45421.f15993xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !voiceGrabHatCp.id_.isEmpty(), voiceGrabHatCp.id_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !voiceGrabHatCp.userId_.isEmpty(), voiceGrabHatCp.userId_);
                    this.userMask_ = (userMaskConfig.UserMask) interfaceC3386h.mo17006o(this.userMask_, voiceGrabHatCp.userMask_);
                    this.otherUserId_ = interfaceC3386h.mo16997f(!this.otherUserId_.isEmpty(), this.otherUserId_, !voiceGrabHatCp.otherUserId_.isEmpty(), voiceGrabHatCp.otherUserId_);
                    this.otherUserMask_ = (userMaskConfig.UserMask) interfaceC3386h.mo17006o(this.otherUserMask_, voiceGrabHatCp.otherUserMask_);
                    long j = this.lovePoint_;
                    boolean z2 = j != 0;
                    long j2 = voiceGrabHatCp.lovePoint_;
                    this.lovePoint_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    this.hatUrl_ = interfaceC3386h.mo16997f(!this.hatUrl_.isEmpty(), this.hatUrl_, !voiceGrabHatCp.hatUrl_.isEmpty(), voiceGrabHatCp.hatUrl_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.lovePoint_ = c3407e.m17142v();
                                } else if (iM17116M == 58) {
                                    this.hatUrl_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
        ...
        public int getSerializedSize() {
            ...
            if (this.otherUserMask_ != null) {
                iM16901K += CodedOutputStream.m16893C(5, getOtherUserMask());
            }
            long j = this.lovePoint_;
            if (j != 0) {
            ...
            if (!this.hatUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getHatUrl());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.otherUserMask_ != null) {
                codedOutputStream.mo16974w0(5, getOtherUserMask());
            }
            long j = this.lovePoint_;
            if (j != 0) {
            ...
            codedOutputStream.mo16939D0(7, getHatUrl());
        }

        public static VoiceGrabHatCp parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceGrabHatCp) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceGrabHatCp parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceGrabHatCp) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceGrabHatCp, Builder> implements VoiceGrabHatCpOrBuilder {
            private Builder() {
        ...
        public static VoiceGrabHatCp parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceGrabHatCp) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceGrabHatCp parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceGrabHatCp) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceGrabHatCp parseFrom(C3407e c3407e) throws IOException {
            return (VoiceGrabHatCp) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceGrabHatCp parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceGrabHatCp) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
