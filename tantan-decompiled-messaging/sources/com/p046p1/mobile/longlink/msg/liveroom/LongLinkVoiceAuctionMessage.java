...
public final class LongLinkVoiceAuctionMessage {
    ...
    public static /* synthetic */ class C45171 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f15981xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15981xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15981xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class VoiceLiveAuctionApply extends GeneratedMessageLite<VoiceLiveAuctionApply, Builder> implements VoiceLiveAuctionApplyOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.guestApply_ = (VoiceLiveAuctionGuestApply) interfaceC3386h.mo17006o(this.guestApply_, voiceLiveAuctionApply.guestApply_);
                    this.templateData_ = (Template.TemplateData) interfaceC3386h.mo17006o(this.templateData_, voiceLiveAuctionApply.templateData_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    VoiceLiveAuctionGuestApply voiceLiveAuctionGuestApply2 = (VoiceLiveAuctionGuestApply) c3407e.m17143w(VoiceLiveAuctionGuestApply.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (this.guestApply_ != null) {
                iM16922m += CodedOutputStream.m16893C(2, getGuestApply());
            }
            if (this.templateData_ != null) {
                iM16922m += CodedOutputStream.m16893C(3, getTemplateData());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.guestApply_ != null) {
                codedOutputStream.mo16974w0(2, getGuestApply());
            }
            if (this.templateData_ != null) {
                codedOutputStream.mo16974w0(3, getTemplateData());
            }
        }
        ...
        public enum Type implements C3414l.c {
            ...
            private static final C3414l.d<Type> internalValueMap = new C3414l.d<Type>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkVoiceAuctionMessage.VoiceLiveAuctionApply.Type.1
        ...
        public static VoiceLiveAuctionApply parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionApply) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionApply parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionApply, Builder> implements VoiceLiveAuctionApplyOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveAuctionApply parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionApply parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionApply parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionApply parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveAuctionChange extends GeneratedMessageLite<VoiceLiveAuctionChange, Builder> implements VoiceLiveAuctionChangeOrBuilder {
        ...
        private C3414l.h<VoiceLiveAuctionLeaderboard> leaderboards_ = GeneratedMessageLite.emptyProtobufList();
        private int type_;
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.type_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.leaderboards_ = interfaceC3386h.mo16998g(this.leaderboards_, voiceLiveAuctionChange.leaderboards_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.leaderboards_.add((VoiceLiveAuctionLeaderboard) c3407e.m17143w(VoiceLiveAuctionLeaderboard.parser(), c3410h));
                                } else if (iM17116M == 24) {
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != Type.refreshAuction.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            for (int i2 = 0; i2 < this.leaderboards_.size(); i2++) {
                iM16922m += CodedOutputStream.m16893C(2, this.leaderboards_.get(i2));
            }
            long j = this.currentTime_;
            if (j != 0) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i = 0; i < this.leaderboards_.size(); i++) {
                codedOutputStream.mo16974w0(2, this.leaderboards_.get(i));
            }
            long j = this.currentTime_;
            if (j != 0) {
        ...
        public enum Type implements C3414l.c {
            ...
            private static final C3414l.d<Type> internalValueMap = new C3414l.d<Type>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkVoiceAuctionMessage.VoiceLiveAuctionChange.Type.1
                @Override // com.google.protobuf.C3414l.d
                public Type findValueByNumber(int i) {
                    return Type.forNumber(i);
                }
        ...
        public static VoiceLiveAuctionChange parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionChange) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionChange parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionChange, Builder> implements VoiceLiveAuctionChangeOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveAuctionChange parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionChange parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionChange parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionChange parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public static final class VoiceLiveAuctionCounter extends GeneratedMessageLite<VoiceLiveAuctionCounter, Builder> implements VoiceLiveAuctionCounterOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionCounter, Builder> implements VoiceLiveAuctionCounterOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.applyUnreadCount_ = interfaceC3386h.mo17000i(z4, j3, j4 != 0, j4);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.applyUnreadCount_ = c3407e.m17142v();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.updateType_ != Type.updateApplyUnreadCount.getNumber() ? CodedOutputStream.m16922m(1, this.updateType_) : 0;
            long j = this.currentTime_;
            if (j != 0) {
            ...
            if (j2 != 0) {
                iM16922m += CodedOutputStream.m16931v(3, j2);
            }
            this.memoizedSerializedSize = iM16922m;
            return iM16922m;
        }
        ...
        public enum Type implements C3414l.c {
            ...
            private static final C3414l.d<Type> internalValueMap = new C3414l.d<Type>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkVoiceAuctionMessage.VoiceLiveAuctionCounter.Type.1
                @Override // com.google.protobuf.C3414l.d
                public Type findValueByNumber(int i) {
                    return Type.forNumber(i);
                }
        ...
        public static VoiceLiveAuctionCounter parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionCounter) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionCounter parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionCounter) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceLiveAuctionCounter parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionCounter) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionCounter parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionCounter) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionCounter parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionCounter) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionCounter parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionCounter) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveAuctionGuestApply extends GeneratedMessageLite<VoiceLiveAuctionGuestApply, Builder> implements VoiceLiveAuctionGuestApplyOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionGuestApply, Builder> implements VoiceLiveAuctionGuestApplyOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !voiceLiveAuctionGuestApply.id_.isEmpty(), voiceLiveAuctionGuestApply.id_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !voiceLiveAuctionGuestApply.liveId_.isEmpty(), voiceLiveAuctionGuestApply.liveId_);
                    this.auctionId_ = interfaceC3386h.mo16997f(!this.auctionId_.isEmpty(), this.auctionId_, !voiceLiveAuctionGuestApply.auctionId_.isEmpty(), voiceLiveAuctionGuestApply.auctionId_);
                    this.guestUserId_ = interfaceC3386h.mo16997f(!this.guestUserId_.isEmpty(), this.guestUserId_, !voiceLiveAuctionGuestApply.guestUserId_.isEmpty(), voiceLiveAuctionGuestApply.guestUserId_);
                    this.hostUserId_ = interfaceC3386h.mo16997f(!this.hostUserId_.isEmpty(), this.hostUserId_, !voiceLiveAuctionGuestApply.hostUserId_.isEmpty(), voiceLiveAuctionGuestApply.hostUserId_);
                    int i = this.state_;
                    boolean z2 = i != 0;
                    int i2 = voiceLiveAuctionGuestApply.state_;
                    this.state_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.guestUserId_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
                                    this.hostUserId_ = c3407e.m17115L();
                                } else if (iM17116M == 48) {
        ...
        public int getSerializedSize() {
            ...
            if (!this.auctionId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getAuctionId());
            }
            if (!this.guestUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getGuestUserId());
            }
            if (!this.hostUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getHostUserId());
            }
            if (this.state_ != ApplyState.applied.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(6, this.state_);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.guestUserId_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getGuestUserId());
            }
            if (!this.hostUserId_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getHostUserId());
            }
            if (this.state_ != ApplyState.applied.getNumber()) {
                codedOutputStream.m16960i0(6, this.state_);
            }
        }

        public enum ApplyState implements C3414l.c {
            applied(0),
            rejected(1),
            accepted(2),
            UNRECOGNIZED(-1);
            ...
            private static final C3414l.d<ApplyState> internalValueMap = new C3414l.d<ApplyState>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkVoiceAuctionMessage.VoiceLiveAuctionGuestApply.ApplyState.1
                @Override // com.google.protobuf.C3414l.d
            ...
            public static C3414l.d<ApplyState> internalGetValueMap() {
                return internalValueMap;
            }
        ...
        public static VoiceLiveAuctionGuestApply parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionGuestApply) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionGuestApply parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionGuestApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceLiveAuctionGuestApply parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionGuestApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionGuestApply parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionGuestApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionGuestApply parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionGuestApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionGuestApply parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionGuestApply) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveAuctionInvite extends GeneratedMessageLite<VoiceLiveAuctionInvite, Builder> implements VoiceLiveAuctionInviteOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionInvite, Builder> implements VoiceLiveAuctionInviteOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.type_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.inviteId_ = interfaceC3386h.mo16997f(!this.inviteId_.isEmpty(), this.inviteId_, !voiceLiveAuctionInvite.inviteId_.isEmpty(), voiceLiveAuctionInvite.inviteId_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !voiceLiveAuctionInvite.userId_.isEmpty(), voiceLiveAuctionInvite.userId_);
                    this.message_ = interfaceC3386h.mo16997f(!this.message_.isEmpty(), this.message_, !voiceLiveAuctionInvite.message_.isEmpty(), voiceLiveAuctionInvite.message_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != Type.auctionInvite.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            if (!this.inviteId_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getInviteId());
            }
            if (!this.userId_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(3, getUserId());
            }
            if (!this.message_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(4, getMessage());
            }
            this.memoizedSerializedSize = iM16922m;
            return iM16922m;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.inviteId_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getInviteId());
            }
            if (!this.userId_.isEmpty()) {
            ...
            codedOutputStream.mo16939D0(4, getMessage());
        }
        ...
        public enum Type implements C3414l.c {
            ...
            private static final C3414l.d<Type> internalValueMap = new C3414l.d<Type>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkVoiceAuctionMessage.VoiceLiveAuctionInvite.Type.1
                @Override // com.google.protobuf.C3414l.d
                public Type findValueByNumber(int i) {
                    return Type.forNumber(i);
                }
        ...
        public static VoiceLiveAuctionInvite parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionInvite) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionInvite parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceLiveAuctionInvite parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionInvite parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionInvite parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionInvite parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class OpenAuctionGuestApplyList extends GeneratedMessageLite<OpenAuctionGuestApplyList, Builder> implements OpenAuctionGuestApplyListOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.applyId_ = interfaceC3386h.mo16997f(!this.applyId_.isEmpty(), this.applyId_, true ^ openAuctionGuestApplyList.applyId_.isEmpty(), openAuctionGuestApplyList.applyId_);
                    this.templateData_ = (Template.TemplateData) interfaceC3386h.mo17006o(this.templateData_, openAuctionGuestApplyList.templateData_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.applyId_.isEmpty() ? CodedOutputStream.m16901K(1, getApplyId()) : 0;
            if (this.templateData_ != null) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.applyId_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getApplyId());
            }
            if (this.templateData_ != null) {
        ...
        public static OpenAuctionGuestApplyList parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OpenAuctionGuestApplyList) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OpenAuctionGuestApplyList parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OpenAuctionGuestApplyList) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<OpenAuctionGuestApplyList, Builder> implements OpenAuctionGuestApplyListOrBuilder {
            private Builder() {
        ...
        public static OpenAuctionGuestApplyList parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OpenAuctionGuestApplyList) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static OpenAuctionGuestApplyList parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OpenAuctionGuestApplyList) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OpenAuctionGuestApplyList parseFrom(C3407e c3407e) throws IOException {
            return (OpenAuctionGuestApplyList) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static OpenAuctionGuestApplyList parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (OpenAuctionGuestApplyList) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveAuctionGuestInvite extends GeneratedMessageLite<VoiceLiveAuctionGuestInvite, Builder> implements VoiceLiveAuctionGuestInviteOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !voiceLiveAuctionGuestInvite.id_.isEmpty(), voiceLiveAuctionGuestInvite.id_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !voiceLiveAuctionGuestInvite.liveId_.isEmpty(), voiceLiveAuctionGuestInvite.liveId_);
                    this.auctionId_ = interfaceC3386h.mo16997f(!this.auctionId_.isEmpty(), this.auctionId_, !voiceLiveAuctionGuestInvite.auctionId_.isEmpty(), voiceLiveAuctionGuestInvite.auctionId_);
                    this.hostUserId_ = interfaceC3386h.mo16997f(!this.hostUserId_.isEmpty(), this.hostUserId_, !voiceLiveAuctionGuestInvite.hostUserId_.isEmpty(), voiceLiveAuctionGuestInvite.hostUserId_);
                    this.hostUserProfile_ = (LongLinkLiveMessage.UserProfile) interfaceC3386h.mo17006o(this.hostUserProfile_, voiceLiveAuctionGuestInvite.hostUserProfile_);
                    this.guestUserId_ = interfaceC3386h.mo16997f(!this.guestUserId_.isEmpty(), this.guestUserId_, !voiceLiveAuctionGuestInvite.guestUserId_.isEmpty(), voiceLiveAuctionGuestInvite.guestUserId_);
                    this.guestUserProfile_ = (LongLinkLiveMessage.UserProfile) interfaceC3386h.mo17006o(this.guestUserProfile_, voiceLiveAuctionGuestInvite.guestUserProfile_);
                    ...
                    this.state_ = interfaceC3386h.mo16996e(z3, i3, i4 != 0, i4);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    LongLinkLiveMessage.UserProfile userProfile2 = (LongLinkLiveMessage.UserProfile) c3407e.m17143w(LongLinkLiveMessage.UserProfile.parser(), c3410h);
                                    ...
                                    LongLinkLiveMessage.UserProfile userProfile4 = (LongLinkLiveMessage.UserProfile) c3407e.m17143w(LongLinkLiveMessage.UserProfile.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (!this.hostUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getHostUserId());
            }
            if (this.hostUserProfile_ != null) {
                iM16901K += CodedOutputStream.m16893C(5, getHostUserProfile());
            }
            if (!this.guestUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getGuestUserId());
            }
            if (this.guestUserProfile_ != null) {
                iM16901K += CodedOutputStream.m16893C(7, getGuestUserProfile());
            }
            int i2 = this.showSeconds_;
            if (i2 != 0) {
                iM16901K += CodedOutputStream.m16929t(8, i2);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.hostUserId_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getHostUserId());
            }
            if (this.hostUserProfile_ != null) {
                codedOutputStream.mo16974w0(5, getHostUserProfile());
            }
            if (!this.guestUserId_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getGuestUserId());
            }
            if (this.guestUserProfile_ != null) {
                codedOutputStream.mo16974w0(7, getGuestUserProfile());
            }
            int i = this.showSeconds_;
            if (i != 0) {
                codedOutputStream.mo16970s0(8, i);
            }
            if (this.state_ != LongLinkMultiCallMessage.InviteState.invited.getNumber()) {
        ...
        public static VoiceLiveAuctionGuestInvite parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionGuestInvite) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionGuestInvite parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionGuestInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionGuestInvite, Builder> implements VoiceLiveAuctionGuestInviteOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveAuctionGuestInvite parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionGuestInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionGuestInvite parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionGuestInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionGuestInvite parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionGuestInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionGuestInvite parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionGuestInvite) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveAuctionLeaderboard extends GeneratedMessageLite<VoiceLiveAuctionLeaderboard, Builder> implements VoiceLiveAuctionLeaderboardOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.auctionId_ = interfaceC3386h.mo16997f(!this.auctionId_.isEmpty(), this.auctionId_, !voiceLiveAuctionLeaderboard.auctionId_.isEmpty(), voiceLiveAuctionLeaderboard.auctionId_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !voiceLiveAuctionLeaderboard.userId_.isEmpty(), voiceLiveAuctionLeaderboard.userId_);
                    this.userProfile_ = (LongLinkLiveMessage.UserProfile) interfaceC3386h.mo17006o(this.userProfile_, voiceLiveAuctionLeaderboard.userProfile_);
                    long j3 = this.amount_;
                    boolean z3 = j3 != 0;
                    long j4 = voiceLiveAuctionLeaderboard.amount_;
                    this.amount_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                    this.voiceRoomId_ = interfaceC3386h.mo16997f(!this.voiceRoomId_.isEmpty(), this.voiceRoomId_, !voiceLiveAuctionLeaderboard.voiceRoomId_.isEmpty(), voiceLiveAuctionLeaderboard.voiceRoomId_);
                    this.voiceLiveId_ = interfaceC3386h.mo16997f(!this.voiceLiveId_.isEmpty(), this.voiceLiveId_, !voiceLiveAuctionLeaderboard.voiceLiveId_.isEmpty(), voiceLiveAuctionLeaderboard.voiceLiveId_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.voiceRoomId_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    this.voiceLiveId_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            if (!this.auctionId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(2, getAuctionId());
            }
            if (!this.userId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(3, getUserId());
            }
            if (this.userProfile_ != null) {
                iM16931v += CodedOutputStream.m16893C(4, getUserProfile());
            }
            long j2 = this.amount_;
            if (j2 != 0) {
                iM16931v += CodedOutputStream.m16931v(5, j2);
            }
            if (!this.voiceRoomId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(6, getVoiceRoomId());
            }
            if (!this.voiceLiveId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(7, getVoiceLiveId());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.auctionId_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getAuctionId());
            }
            if (!this.userId_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getUserId());
            }
            if (this.userProfile_ != null) {
                codedOutputStream.mo16974w0(4, getUserProfile());
            }
            long j2 = this.amount_;
            if (j2 != 0) {
            ...
            if (!this.voiceRoomId_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getVoiceRoomId());
            }
            if (this.voiceLiveId_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(7, getVoiceLiveId());
        }

        public static VoiceLiveAuctionLeaderboard parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionLeaderboard) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionLeaderboard parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveAuctionLeaderboard, Builder> implements VoiceLiveAuctionLeaderboardOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveAuctionLeaderboard parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveAuctionLeaderboard parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveAuctionLeaderboard parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveAuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveAuctionLeaderboard parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveAuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveToast extends GeneratedMessageLite<VoiceLiveToast, Builder> implements VoiceLiveToastOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveToast, Builder> implements VoiceLiveToastOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45171.f15981xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.toast_ = ((GeneratedMessageLite.InterfaceC3386h) obj).mo16997f(!this.toast_.isEmpty(), this.toast_, true ^ voiceLiveToast.toast_.isEmpty(), voiceLiveToast.toast_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public static VoiceLiveToast parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveToast) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveToast parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveToast) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceLiveToast parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveToast) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveToast parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveToast) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveToast parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveToast) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveToast parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveToast) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
