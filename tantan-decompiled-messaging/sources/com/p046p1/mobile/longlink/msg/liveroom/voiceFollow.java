...
public final class voiceFollow {
    ...
    public static /* synthetic */ class C45401 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f15992xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15992xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15992xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class VoiceLiveFollowMessage extends GeneratedMessageLite<VoiceLiveFollowMessage, Builder> implements VoiceLiveFollowMessageOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45401.f15992xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.templateData_ = (Template.TemplateData) interfaceC3386h.mo17006o(this.templateData_, voiceLiveFollowMessage.templateData_);
                    int i = this.source_;
                    boolean z2 = i != 0;
                    int i2 = voiceLiveFollowMessage.source_;
                    this.source_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.userMask_ = (userMaskConfig.UserMask) interfaceC3386h.mo17006o(this.userMask_, voiceLiveFollowMessage.userMask_);
                    this.follower_ = (LongLinkLiveMessage.UserInfo) interfaceC3386h.mo17006o(this.follower_, voiceLiveFollowMessage.follower_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    LongLinkLiveMessage.UserInfo userInfo2 = (LongLinkLiveMessage.UserInfo) c3407e.m17143w(LongLinkLiveMessage.UserInfo.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (this.source_ != Source.InRoom.getNumber()) {
                iM16893C += CodedOutputStream.m16922m(2, this.source_);
            }
            if (this.userMask_ != null) {
                iM16893C += CodedOutputStream.m16893C(3, getUserMask());
            }
            if (this.follower_ != null) {
                iM16893C += CodedOutputStream.m16893C(4, getFollower());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.follower_ != null) {
                codedOutputStream.mo16974w0(4, getFollower());
            }
        }

        public enum Source implements C3414l.c {
            InRoom(0),
            OnCall(1),
            SendGift(2),
            OtherFollow(3),
            ...
            private static final C3414l.d<Source> internalValueMap = new C3414l.d<Source>() { // from class: com.p1.mobile.longlink.msg.liveroom.voiceFollow.VoiceLiveFollowMessage.Source.1
            ...
            public static C3414l.d<Source> internalGetValueMap() {
        ...
        public static VoiceLiveFollowMessage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveFollowMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveFollowMessage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveFollowMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveFollowMessage, Builder> implements VoiceLiveFollowMessageOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveFollowMessage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveFollowMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveFollowMessage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveFollowMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveFollowMessage parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveFollowMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveFollowMessage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveFollowMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
