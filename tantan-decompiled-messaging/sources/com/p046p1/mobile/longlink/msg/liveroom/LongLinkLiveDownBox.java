...
public final class LongLinkLiveDownBox {
    ...
    public static /* synthetic */ class C44811 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f15971xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15971xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15971xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public enum AccessChannelJumpType implements C3414l.c {
        url(0),
        schema(1),
        UNRECOGNIZED(-1);

        private static final C3414l.d<AccessChannelJumpType> internalValueMap = new C3414l.d<AccessChannelJumpType>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkLiveDownBox.AccessChannelJumpType.1
        ...
        public static C3414l.d<AccessChannelJumpType> internalGetValueMap() {
    ...
    public enum DynamicType implements C3414l.c {
        fall(0),
        UNRECOGNIZED(-1);

        public static final int fall_VALUE = 0;
        private static final C3414l.d<DynamicType> internalValueMap = new C3414l.d<DynamicType>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkLiveDownBox.DynamicType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<DynamicType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class LiveAccessChannel extends GeneratedMessageLite<LiveAccessChannel, Builder> implements LiveAccessChannelOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveAccessChannel, Builder> implements LiveAccessChannelOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C44811.f15971xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.outerIcon_ = interfaceC3386h.mo16997f(!this.outerIcon_.isEmpty(), this.outerIcon_, !liveAccessChannel.outerIcon_.isEmpty(), liveAccessChannel.outerIcon_);
                    this.innerIcon_ = interfaceC3386h.mo16997f(!this.innerIcon_.isEmpty(), this.innerIcon_, !liveAccessChannel.innerIcon_.isEmpty(), liveAccessChannel.innerIcon_);
                    int i = this.dynamicType_;
                    boolean z2 = i != 0;
                    int i2 = liveAccessChannel.dynamicType_;
                    this.dynamicType_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    int i3 = this.jumpType_;
                    boolean z3 = i3 != 0;
                    int i4 = liveAccessChannel.jumpType_;
                    this.jumpType_ = interfaceC3386h.mo16996e(z3, i3, i4 != 0, i4);
                    this.jumpSchema_ = interfaceC3386h.mo16997f(!this.jumpSchema_.isEmpty(), this.jumpSchema_, !liveAccessChannel.jumpSchema_.isEmpty(), liveAccessChannel.jumpSchema_);
                    this.outerVanishDynamic_ = interfaceC3386h.mo16997f(!this.outerVanishDynamic_.isEmpty(), this.outerVanishDynamic_, !liveAccessChannel.outerVanishDynamic_.isEmpty(), liveAccessChannel.outerVanishDynamic_);
                    this.source_ = interfaceC3386h.mo16997f(!this.source_.isEmpty(), this.source_, !liveAccessChannel.source_.isEmpty(), liveAccessChannel.source_);
                    long j = this.bottomRemainDuration_;
                    boolean z4 = j != 0;
                    long j2 = liveAccessChannel.bottomRemainDuration_;
                    this.bottomRemainDuration_ = interfaceC3386h.mo17000i(z4, j, j2 != 0, j2);
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    this.outerIcon_ = c3407e.m17115L();
                                } else if (iM17116M == 18) {
                                    this.innerIcon_ = c3407e.m17115L();
                                } else if (iM17116M == 24) {
                                    this.dynamicType_ = c3407e.m17136p();
                                } else if (iM17116M == 32) {
                                    this.jumpType_ = c3407e.m17136p();
                                } else if (iM17116M == 42) {
                                    this.jumpSchema_ = c3407e.m17115L();
                                } else if (iM17116M == 50) {
                                    this.outerVanishDynamic_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    this.source_ = c3407e.m17115L();
                                } else if (iM17116M == 64) {
                                    this.bottomRemainDuration_ = c3407e.m17142v();
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.outerIcon_.isEmpty() ? CodedOutputStream.m16901K(1, getOuterIcon()) : 0;
            if (!this.innerIcon_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getInnerIcon());
            }
            if (this.dynamicType_ != DynamicType.fall.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(3, this.dynamicType_);
            }
            if (this.jumpType_ != AccessChannelJumpType.url.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(4, this.jumpType_);
            }
            if (!this.jumpSchema_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getJumpSchema());
            }
            if (!this.outerVanishDynamic_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getOuterVanishDynamic());
            }
            if (!this.source_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getSource());
            }
            long j = this.bottomRemainDuration_;
            if (j != 0) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.outerIcon_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getOuterIcon());
            }
            if (!this.innerIcon_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getInnerIcon());
            }
            if (this.dynamicType_ != DynamicType.fall.getNumber()) {
                codedOutputStream.m16960i0(3, this.dynamicType_);
            }
            if (this.jumpType_ != AccessChannelJumpType.url.getNumber()) {
                codedOutputStream.m16960i0(4, this.jumpType_);
            }
            if (!this.jumpSchema_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getJumpSchema());
            }
            if (!this.outerVanishDynamic_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getOuterVanishDynamic());
            }
            if (!this.source_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getSource());
            }
            long j = this.bottomRemainDuration_;
            if (j != 0) {
        ...
        public static LiveAccessChannel parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveAccessChannel) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveAccessChannel parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveAccessChannel) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static LiveAccessChannel parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveAccessChannel) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveAccessChannel parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveAccessChannel) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveAccessChannel parseFrom(C3407e c3407e) throws IOException {
            return (LiveAccessChannel) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveAccessChannel parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveAccessChannel) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
