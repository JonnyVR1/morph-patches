package com.p046p1.mobile.longlink.msg.voicegift;
...
public final class VoiceNewCampaign {
    ...
    public static /* synthetic */ class C45541 {
        ...
        static {
            ...
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16000xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class VoiceLiveCampaignInfo extends GeneratedMessageLite<VoiceLiveCampaignInfo, Builder> implements VoiceLiveCampaignInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveCampaignInfo, Builder> implements VoiceLiveCampaignInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45541.f16000xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !voiceLiveCampaignInfo.id_.isEmpty(), voiceLiveCampaignInfo.id_);
                    long j = this.position_;
                    boolean z3 = j != 0;
                    long j2 = voiceLiveCampaignInfo.position_;
                    this.position_ = interfaceC3386h.mo17000i(z3, j, j2 != 0, j2);
                    this.subscribeType_ = interfaceC3386h.mo16997f(!this.subscribeType_.isEmpty(), this.subscribeType_, !voiceLiveCampaignInfo.subscribeType_.isEmpty(), voiceLiveCampaignInfo.subscribeType_);
                    this.updateType_ = interfaceC3386h.mo16997f(!this.updateType_.isEmpty(), this.updateType_, !voiceLiveCampaignInfo.updateType_.isEmpty(), voiceLiveCampaignInfo.updateType_);
                    this.data_ = interfaceC3386h.mo16997f(!this.data_.isEmpty(), this.data_, !voiceLiveCampaignInfo.data_.isEmpty(), voiceLiveCampaignInfo.data_);
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != VoiceLiveCampaignType.List.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            if (!this.id_.isEmpty()) {
        ...
        public static VoiceLiveCampaignInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveCampaignInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceLiveCampaignInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveCampaignInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveCampaignInfo parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveCampaignInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveCampaignInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum VoiceLiveCampaignType implements C3414l.c {
        List(0),
        Entrance(1),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<VoiceLiveCampaignType> internalValueMap = new C3414l.d<VoiceLiveCampaignType>() { // from class: com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLiveCampaignType.1
        ...
        public static C3414l.d<VoiceLiveCampaignType> internalGetValueMap() {
    ...
    public static final class VoiceLiveContentUpdateNotice extends GeneratedMessageLite<VoiceLiveContentUpdateNotice, Builder> implements VoiceLiveContentUpdateNoticeOrBuilder {
        ...
        private C3414l.h<VoiceLiveCampaignInfo> liveCampaigns_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45541.f16000xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !voiceLiveContentUpdateNotice.roomId_.isEmpty(), voiceLiveContentUpdateNotice.roomId_);
                    this.liveCampaigns_ = interfaceC3386h.mo16998g(this.liveCampaigns_, voiceLiveContentUpdateNotice.liveCampaigns_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.liveCampaigns_.add((VoiceLiveCampaignInfo) c3407e.m17143w(VoiceLiveCampaignInfo.parser(), c3410h));
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.action_ != VoiceLongLinkUpdateAction.ActionUnknow.getNumber() ? CodedOutputStream.m16922m(1, this.action_) : 0;
        ...
        public static VoiceLiveContentUpdateNotice parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveContentUpdateNotice parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveContentUpdateNotice, Builder> implements VoiceLiveContentUpdateNoticeOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveContentUpdateNotice parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveContentUpdateNotice parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveContentUpdateNotice parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveContentUpdateNotice parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveContentUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public enum VoiceLongLinkUpdateAction implements C3414l.c {
        ActionUnknow(0),
        ReRequest(1),
        Refresh(2),
        Complete(3),
        ...
        private static final C3414l.d<VoiceLongLinkUpdateAction> internalValueMap = new C3414l.d<VoiceLongLinkUpdateAction>() { // from class: com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLongLinkUpdateAction.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<VoiceLongLinkUpdateAction> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum VoiceLongLinkUpdatePosition implements C3414l.c {
        PositionUnknow(0),
        CampaignEntrance(1),
        GiftList(2),
        ...
        private static final C3414l.d<VoiceLongLinkUpdatePosition> internalValueMap = new C3414l.d<VoiceLongLinkUpdatePosition>() { // from class: com.p1.mobile.longlink.msg.voicegift.VoiceNewCampaign.VoiceLongLinkUpdatePosition.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<VoiceLongLinkUpdatePosition> internalGetValueMap() {
            return internalValueMap;
        }
