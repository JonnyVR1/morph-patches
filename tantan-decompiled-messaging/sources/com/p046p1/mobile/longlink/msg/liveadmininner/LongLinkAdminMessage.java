package com.p046p1.mobile.longlink.msg.liveadmininner;
...
public final class LongLinkAdminMessage {
    ...
    public static /* synthetic */ class C44341 {
        ...
        static {
            ...
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15953xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class BgStyle extends GeneratedMessageLite<BgStyle, Builder> implements BgStyleOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44341.f15953xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                    return new BgStyle();
                case 2:
                    return DEFAULT_INSTANCE;
    ...
    public static final class ButtonJumpStyle extends GeneratedMessageLite<ButtonJumpStyle, Builder> implements ButtonJumpStyleOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44341.f15953xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.bgcolor_ = (BgStyle) interfaceC3386h.mo17006o(this.bgcolor_, buttonJumpStyle.bgcolor_);
                    this.textColor_ = interfaceC3386h.mo16997f(!this.textColor_.isEmpty(), this.textColor_, !buttonJumpStyle.textColor_.isEmpty(), buttonJumpStyle.textColor_);
                    this.content_ = interfaceC3386h.mo16997f(!this.content_.isEmpty(), this.content_, !buttonJumpStyle.content_.isEmpty(), buttonJumpStyle.content_);
                    this.icon_ = interfaceC3386h.mo16997f(!this.icon_.isEmpty(), this.icon_, !buttonJumpStyle.icon_.isEmpty(), buttonJumpStyle.icon_);
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, true ^ buttonJumpStyle.url_.isEmpty(), buttonJumpStyle.url_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            int iM16893C = this.bgcolor_ != null ? CodedOutputStream.m16893C(1, getBgcolor()) : 0;
            if (!this.textColor_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(2, getTextColor());
            }
            if (!this.content_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(3, getContent());
            }
            if (!this.icon_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(4, getIcon());
            }
            if (!this.url_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(5, getUrl());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.bgcolor_ != null) {
                codedOutputStream.mo16974w0(1, getBgcolor());
            }
            if (!this.textColor_.isEmpty()) {
        ...
        public static ButtonJumpStyle parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ButtonJumpStyle) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ButtonJumpStyle parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ButtonJumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ButtonJumpStyle, Builder> implements ButtonJumpStyleOrBuilder {
            private Builder() {
        ...
        public static ButtonJumpStyle parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ButtonJumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ButtonJumpStyle parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ButtonJumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ButtonJumpStyle parseFrom(C3407e c3407e) throws IOException {
            return (ButtonJumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ButtonJumpStyle parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ButtonJumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class IconStyle extends GeneratedMessageLite<IconStyle, Builder> implements IconStyleOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<IconStyle, Builder> implements IconStyleOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44341.f15953xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, !iconStyle.url_.isEmpty(), iconStyle.url_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != IconType.iconUrl.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            if (!this.url_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getUrl());
            }
        ...
        public static IconStyle parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (IconStyle) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static IconStyle parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (IconStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static IconStyle parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (IconStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static IconStyle parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (IconStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static IconStyle parseFrom(C3407e c3407e) throws IOException {
            return (IconStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static IconStyle parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (IconStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum IconType implements C3414l.c {
        iconUrl(0),
        userSelf(1),
        UNRECOGNIZED(-1);

        public static final int iconUrl_VALUE = 0;
        private static final C3414l.d<IconType> internalValueMap = new C3414l.d<IconType>() { // from class: com.p1.mobile.longlink.msg.liveadmininner.LongLinkAdminMessage.IconType.1
        ...
        public static C3414l.d<IconType> internalGetValueMap() {
    ...
    public static final class JumpStyle extends GeneratedMessageLite<JumpStyle, Builder> implements JumpStyleOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44341.f15953xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.type_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.schema_ = interfaceC3386h.mo16997f(!this.schema_.isEmpty(), this.schema_, !jumpStyle.schema_.isEmpty(), jumpStyle.schema_);
                    this.button_ = (ButtonJumpStyle) interfaceC3386h.mo17006o(this.button_, jumpStyle.button_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    ButtonJumpStyle buttonJumpStyle2 = (ButtonJumpStyle) c3407e.m17143w(ButtonJumpStyle.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != JumpType.gotoLink.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            if (!this.schema_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getSchema());
            }
            if (this.button_ != null) {
                iM16922m += CodedOutputStream.m16893C(3, getButton());
            }
            this.memoizedSerializedSize = iM16922m;
            return iM16922m;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.schema_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getSchema());
            }
            if (this.button_ != null) {
                codedOutputStream.mo16974w0(3, getButton());
            }
        }

        public static JumpStyle parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (JumpStyle) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static JumpStyle parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (JumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<JumpStyle, Builder> implements JumpStyleOrBuilder {
            private Builder() {
        ...
        public static JumpStyle parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (JumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static JumpStyle parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (JumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static JumpStyle parseFrom(C3407e c3407e) throws IOException {
            return (JumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static JumpStyle parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (JumpStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum JumpType implements C3414l.c {
        gotoLink(0),
        staticButton(1),
        dynamicButton(2),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<JumpType> internalValueMap = new C3414l.d<JumpType>() { // from class: com.p1.mobile.longlink.msg.liveadmininner.LongLinkAdminMessage.JumpType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<JumpType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class UserWithBgColorSocketNotification extends GeneratedMessageLite<UserWithBgColorSocketNotification, Builder> implements UserWithBgColorSocketNotificationOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44341.f15953xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !userWithBgColorSocketNotification.roomId_.isEmpty(), userWithBgColorSocketNotification.roomId_);
                    this.icon_ = (IconStyle) interfaceC3386h.mo17006o(this.icon_, userWithBgColorSocketNotification.icon_);
                    this.bgStyle_ = (BgStyle) interfaceC3386h.mo17006o(this.bgStyle_, userWithBgColorSocketNotification.bgStyle_);
                    this.content_ = interfaceC3386h.mo16997f(!this.content_.isEmpty(), this.content_, !userWithBgColorSocketNotification.content_.isEmpty(), userWithBgColorSocketNotification.content_);
                    this.jump_ = (JumpStyle) interfaceC3386h.mo17006o(this.jump_, userWithBgColorSocketNotification.jump_);
                    long j = this.showTimes_;
                    boolean z2 = j != 0;
                    long j2 = userWithBgColorSocketNotification.showTimes_;
                    this.showTimes_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    long j3 = this.showSeconds_;
                    boolean z3 = j3 != 0;
                    long j4 = userWithBgColorSocketNotification.showSeconds_;
                    this.showSeconds_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                    long j5 = this.rotationInterval_;
                    boolean z4 = j5 != 0;
                    long j6 = userWithBgColorSocketNotification.rotationInterval_;
                    this.rotationInterval_ = interfaceC3386h.mo17000i(z4, j5, j6 != 0, j6);
                    this.type_ = interfaceC3386h.mo16997f(!this.type_.isEmpty(), this.type_, !userWithBgColorSocketNotification.type_.isEmpty(), userWithBgColorSocketNotification.type_);
                    boolean z5 = this.moveUp_;
                    boolean z6 = userWithBgColorSocketNotification.moveUp_;
                    this.moveUp_ = interfaceC3386h.mo16995d(z5, z5, z6, z6);
                    boolean z7 = this.isCountdown_;
                    boolean z8 = userWithBgColorSocketNotification.isCountdown_;
                    this.isCountdown_ = interfaceC3386h.mo16995d(z7, z7, z8, z8);
                    boolean z9 = this.isFixed_;
                    boolean z10 = userWithBgColorSocketNotification.isFixed_;
                    this.isFixed_ = interfaceC3386h.mo16995d(z9, z9, z10, z10);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 18:
                                    ...
                                    IconStyle iconStyle2 = (IconStyle) c3407e.m17143w(IconStyle.parser(), c3410h);
                                ...
                                case 42:
                                    ...
                                    JumpStyle jumpStyle2 = (JumpStyle) c3407e.m17143w(JumpStyle.parser(), c3410h);
                                    ...
                                    break;
                                case 48:
                                    this.showTimes_ = c3407e.m17142v();
                                    continue;
                                case 56:
                                    this.showSeconds_ = c3407e.m17142v();
                                    continue;
                                case 64:
                                    this.rotationInterval_ = c3407e.m17142v();
                                    continue;
                                case 74:
                                    this.type_ = c3407e.m17115L();
                                    continue;
                                case 80:
                                    this.moveUp_ = c3407e.m17133m();
                                    continue;
                                case 88:
                                    this.isCountdown_ = c3407e.m17133m();
                                    continue;
                                case Opcodes.IADD /* 96 */:
                                    this.isFixed_ = c3407e.m17133m();
                                    continue;
                                default:
        ...
        public int getSerializedSize() {
            ...
            if (this.icon_ != null) {
                iM16901K += CodedOutputStream.m16893C(2, getIcon());
            }
            if (this.bgStyle_ != null) {
                iM16901K += CodedOutputStream.m16893C(3, getBgStyle());
            }
            if (!this.content_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getContent());
            }
            if (this.jump_ != null) {
                iM16901K += CodedOutputStream.m16893C(5, getJump());
            }
            long j = this.showTimes_;
            if (j != 0) {
            ...
            if (j3 != 0) {
                iM16901K += CodedOutputStream.m16931v(8, j3);
            }
            ...
            if (z) {
                iM16901K += CodedOutputStream.m16915f(10, z);
            }
            boolean z2 = this.isCountdown_;
            if (z2) {
                iM16901K += CodedOutputStream.m16915f(11, z2);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.icon_ != null) {
                codedOutputStream.mo16974w0(2, getIcon());
            }
            if (this.bgStyle_ != null) {
                codedOutputStream.mo16974w0(3, getBgStyle());
            }
            if (!this.content_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getContent());
            }
            if (this.jump_ != null) {
                codedOutputStream.mo16974w0(5, getJump());
            }
            long j = this.showTimes_;
            if (j != 0) {
            ...
            boolean z = this.moveUp_;
            if (z) {
                codedOutputStream.mo16950a0(10, z);
            }
            boolean z2 = this.isCountdown_;
            if (z2) {
                codedOutputStream.mo16950a0(11, z2);
            }
            boolean z3 = this.isFixed_;
            if (z3) {
        ...
        public static UserWithBgColorSocketNotification parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserWithBgColorSocketNotification) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserWithBgColorSocketNotification parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserWithBgColorSocketNotification) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserWithBgColorSocketNotification, Builder> implements UserWithBgColorSocketNotificationOrBuilder {
            private Builder() {
        ...
        public static UserWithBgColorSocketNotification parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserWithBgColorSocketNotification) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserWithBgColorSocketNotification parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserWithBgColorSocketNotification) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserWithBgColorSocketNotification parseFrom(C3407e c3407e) throws IOException {
            return (UserWithBgColorSocketNotification) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserWithBgColorSocketNotification parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserWithBgColorSocketNotification) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
