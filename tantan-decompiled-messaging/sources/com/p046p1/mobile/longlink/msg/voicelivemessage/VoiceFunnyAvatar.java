...
public final class VoiceFunnyAvatar {
    ...
    public static /* synthetic */ class C45601 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16003xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16003xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16003xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class VoiceLivePhotoSticker extends GeneratedMessageLite<VoiceLivePhotoSticker, Builder> implements VoiceLivePhotoStickerOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45601.f16003xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !voiceLivePhotoSticker.userId_.isEmpty(), voiceLivePhotoSticker.userId_);
                    this.pthotoType_ = interfaceC3386h.mo16997f(!this.pthotoType_.isEmpty(), this.pthotoType_, !voiceLivePhotoSticker.pthotoType_.isEmpty(), voiceLivePhotoSticker.pthotoType_);
                    this.frameConfig_ = (VoiceLiveRankingBoard.PictureConfig) interfaceC3386h.mo17006o(this.frameConfig_, voiceLivePhotoSticker.frameConfig_);
                    long j = this.serverTimeInSeconds_;
                    boolean z2 = j != 0;
                    long j2 = voiceLivePhotoSticker.serverTimeInSeconds_;
                    this.serverTimeInSeconds_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.pthotoType_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
                                    ...
                                    VoiceLiveRankingBoard.PictureConfig pictureConfig2 = (VoiceLiveRankingBoard.PictureConfig) c3407e.m17143w(VoiceLiveRankingBoard.PictureConfig.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (!this.pthotoType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getPthotoType());
            }
            if (this.frameConfig_ != null) {
                iM16901K += CodedOutputStream.m16893C(3, getFrameConfig());
            }
            long j = this.serverTimeInSeconds_;
            if (j != 0) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.pthotoType_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getPthotoType());
            }
            if (this.frameConfig_ != null) {
                codedOutputStream.mo16974w0(3, getFrameConfig());
            }
            long j = this.serverTimeInSeconds_;
            if (j != 0) {
        ...
        public static VoiceLivePhotoSticker parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLivePhotoSticker) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLivePhotoSticker parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLivePhotoSticker) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLivePhotoSticker, Builder> implements VoiceLivePhotoStickerOrBuilder {
            private Builder() {
        ...
        public static VoiceLivePhotoSticker parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLivePhotoSticker) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLivePhotoSticker parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLivePhotoSticker) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLivePhotoSticker parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLivePhotoSticker) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLivePhotoSticker parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLivePhotoSticker) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
