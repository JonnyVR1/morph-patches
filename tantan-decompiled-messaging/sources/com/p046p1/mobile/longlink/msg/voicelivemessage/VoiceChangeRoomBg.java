...
public final class VoiceChangeRoomBg {
    ...
    public static /* synthetic */ class C45591 {
        ...
        static {
            ...
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16002xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class VoiceRoomBgPicUpdateMessage extends GeneratedMessageLite<VoiceRoomBgPicUpdateMessage, Builder> implements VoiceRoomBgPicUpdateMessageOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45591.f16002xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !voiceRoomBgPicUpdateMessage.roomId_.isEmpty(), voiceRoomBgPicUpdateMessage.roomId_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !voiceRoomBgPicUpdateMessage.liveId_.isEmpty(), voiceRoomBgPicUpdateMessage.liveId_);
                    this.anchorId_ = interfaceC3386h.mo16997f(!this.anchorId_.isEmpty(), this.anchorId_, !voiceRoomBgPicUpdateMessage.anchorId_.isEmpty(), voiceRoomBgPicUpdateMessage.anchorId_);
                    this.picId_ = interfaceC3386h.mo16997f(!this.picId_.isEmpty(), this.picId_, !voiceRoomBgPicUpdateMessage.picId_.isEmpty(), voiceRoomBgPicUpdateMessage.picId_);
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, !voiceRoomBgPicUpdateMessage.url_.isEmpty(), voiceRoomBgPicUpdateMessage.url_);
                    this.thumbnailUrl_ = interfaceC3386h.mo16997f(!this.thumbnailUrl_.isEmpty(), this.thumbnailUrl_, !voiceRoomBgPicUpdateMessage.thumbnailUrl_.isEmpty(), voiceRoomBgPicUpdateMessage.thumbnailUrl_);
                    this.picName_ = interfaceC3386h.mo16997f(!this.picName_.isEmpty(), this.picName_, !voiceRoomBgPicUpdateMessage.picName_.isEmpty(), voiceRoomBgPicUpdateMessage.picName_);
                    this.picType_ = interfaceC3386h.mo16997f(!this.picType_.isEmpty(), this.picType_, true ^ voiceRoomBgPicUpdateMessage.picType_.isEmpty(), voiceRoomBgPicUpdateMessage.picType_);
                    this.callPlaceResource_ = (VoiceRoomCallPlaceResource) interfaceC3386h.mo17006o(this.callPlaceResource_, voiceRoomBgPicUpdateMessage.callPlaceResource_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.picId_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
                                    this.url_ = c3407e.m17115L();
                                } else if (iM17116M == 50) {
                                    this.thumbnailUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    this.picName_ = c3407e.m17115L();
                                } else if (iM17116M == 66) {
                                    this.picType_ = c3407e.m17115L();
                                } else if (iM17116M == 74) {
                                    ...
                                    VoiceRoomCallPlaceResource voiceRoomCallPlaceResource2 = (VoiceRoomCallPlaceResource) c3407e.m17143w(VoiceRoomCallPlaceResource.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (!this.picId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getPicId());
            }
            if (!this.url_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getUrl());
            }
            if (!this.thumbnailUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getThumbnailUrl());
            }
            if (!this.picName_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getPicName());
            }
            if (!this.picType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(8, getPicType());
            }
            if (this.callPlaceResource_ != null) {
                iM16901K += CodedOutputStream.m16893C(9, getCallPlaceResource());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.picId_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getPicId());
            }
            if (!this.url_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getUrl());
            }
            if (!this.thumbnailUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getThumbnailUrl());
            }
            if (!this.picName_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getPicName());
            }
            if (!this.picType_.isEmpty()) {
                codedOutputStream.mo16939D0(8, getPicType());
            }
            if (this.callPlaceResource_ != null) {
                codedOutputStream.mo16974w0(9, getCallPlaceResource());
            }
        }

        public static VoiceRoomBgPicUpdateMessage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceRoomBgPicUpdateMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceRoomBgPicUpdateMessage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceRoomBgPicUpdateMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceRoomBgPicUpdateMessage, Builder> implements VoiceRoomBgPicUpdateMessageOrBuilder {
            private Builder() {
        ...
        public static VoiceRoomBgPicUpdateMessage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceRoomBgPicUpdateMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceRoomBgPicUpdateMessage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceRoomBgPicUpdateMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceRoomBgPicUpdateMessage parseFrom(C3407e c3407e) throws IOException {
            return (VoiceRoomBgPicUpdateMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceRoomBgPicUpdateMessage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceRoomBgPicUpdateMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceRoomCallPlaceResource extends GeneratedMessageLite<VoiceRoomCallPlaceResource, Builder> implements VoiceRoomCallPlaceResourceOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceRoomCallPlaceResource, Builder> implements VoiceRoomCallPlaceResourceOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45591.f16002xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.bgUrl_ = interfaceC3386h.mo16997f(!this.bgUrl_.isEmpty(), this.bgUrl_, !voiceRoomCallPlaceResource.bgUrl_.isEmpty(), voiceRoomCallPlaceResource.bgUrl_);
                    this.addUrl_ = interfaceC3386h.mo16997f(!this.addUrl_.isEmpty(), this.addUrl_, !voiceRoomCallPlaceResource.addUrl_.isEmpty(), voiceRoomCallPlaceResource.addUrl_);
                    this.bossUrl_ = interfaceC3386h.mo16997f(!this.bossUrl_.isEmpty(), this.bossUrl_, !voiceRoomCallPlaceResource.bossUrl_.isEmpty(), voiceRoomCallPlaceResource.bossUrl_);
                    this.indexColor_ = interfaceC3386h.mo16997f(!this.indexColor_.isEmpty(), this.indexColor_, true ^ voiceRoomCallPlaceResource.indexColor_.isEmpty(), voiceRoomCallPlaceResource.indexColor_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    this.bgUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 18) {
                                    this.addUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
                                    this.bossUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 34) {
                                    this.indexColor_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.bgUrl_.isEmpty() ? CodedOutputStream.m16901K(1, getBgUrl()) : 0;
            if (!this.addUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getAddUrl());
            }
            if (!this.bossUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getBossUrl());
            }
            if (!this.indexColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getIndexColor());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.bgUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getBgUrl());
            }
            if (!this.addUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getAddUrl());
            }
            if (!this.bossUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getBossUrl());
            }
            if (this.indexColor_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(4, getIndexColor());
        }

        public static VoiceRoomCallPlaceResource parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceRoomCallPlaceResource) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceRoomCallPlaceResource parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceRoomCallPlaceResource) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceRoomCallPlaceResource parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceRoomCallPlaceResource) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceRoomCallPlaceResource parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceRoomCallPlaceResource) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceRoomCallPlaceResource parseFrom(C3407e c3407e) throws IOException {
            return (VoiceRoomCallPlaceResource) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceRoomCallPlaceResource parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceRoomCallPlaceResource) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
