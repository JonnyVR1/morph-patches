...
public final class LongLinkConfession {
    ...
    public static /* synthetic */ class C44471 {
        ...
        static {
            ...
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15958xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class ConfessionGiftReceiveMsg extends GeneratedMessageLite<ConfessionGiftReceiveMsg, Builder> implements ConfessionGiftReceiveMsgOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C44471.f15958xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.user_ = (User) interfaceC3386h.mo17006o(this.user_, confessionGiftReceiveMsg.user_);
                    this.gift_ = (Gift) interfaceC3386h.mo17006o(this.gift_, confessionGiftReceiveMsg.gift_);
                    this.slogan_ = interfaceC3386h.mo16997f(!this.slogan_.isEmpty(), this.slogan_, !confessionGiftReceiveMsg.slogan_.isEmpty(), confessionGiftReceiveMsg.slogan_);
                    this.confessRecordId_ = interfaceC3386h.mo16997f(!this.confessRecordId_.isEmpty(), this.confessRecordId_, !confessionGiftReceiveMsg.confessRecordId_.isEmpty(), confessionGiftReceiveMsg.confessRecordId_);
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !confessionGiftReceiveMsg.roomId_.isEmpty(), confessionGiftReceiveMsg.roomId_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !confessionGiftReceiveMsg.liveId_.isEmpty(), confessionGiftReceiveMsg.liveId_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    Gift gift2 = (Gift) c3407e.m17143w(Gift.parser(), c3410h);
                                    this.gift_ = gift2;
                                    if (builder2 != null) {
                                    ...
                                    this.slogan_ = c3407e.m17115L();
                                } else if (iM17116M == 34) {
                                    this.confessRecordId_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
        ...
        public int getSerializedSize() {
            ...
            int iM16893C = this.user_ != null ? CodedOutputStream.m16893C(1, getUser()) : 0;
            if (this.gift_ != null) {
                iM16893C += CodedOutputStream.m16893C(2, getGift());
            }
            if (!this.slogan_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(3, getSlogan());
            }
            if (!this.confessRecordId_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(4, getConfessRecordId());
            }
            if (!this.roomId_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(5, getRoomId());
            }
            if (!this.liveId_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(6, getLiveId());
            }
            long j = this.showTime_;
            if (j != 0) {
                iM16893C += CodedOutputStream.m16931v(7, j);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.user_ != null) {
                codedOutputStream.mo16974w0(1, getUser());
            }
            if (this.gift_ != null) {
                codedOutputStream.mo16974w0(2, getGift());
            }
            if (!this.slogan_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getSlogan());
            }
            if (!this.confessRecordId_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getConfessRecordId());
            }
            if (!this.roomId_.isEmpty()) {
        ...
        public static ConfessionGiftReceiveMsg parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ConfessionGiftReceiveMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ConfessionGiftReceiveMsg parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ConfessionGiftReceiveMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ConfessionGiftReceiveMsg, Builder> implements ConfessionGiftReceiveMsgOrBuilder {
            private Builder() {
        ...
        public static ConfessionGiftReceiveMsg parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ConfessionGiftReceiveMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ConfessionGiftReceiveMsg parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ConfessionGiftReceiveMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ConfessionGiftReceiveMsg parseFrom(C3407e c3407e) throws IOException {
            return (ConfessionGiftReceiveMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ConfessionGiftReceiveMsg parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ConfessionGiftReceiveMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Gift extends GeneratedMessageLite<Gift, Builder> implements GiftOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Gift, Builder> implements GiftOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44471.f15958xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    GeneratedMessageLite.InterfaceC3386h interfaceC3386h = (GeneratedMessageLite.InterfaceC3386h) obj;
                    Gift gift = (Gift) obj2;
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !gift.id_.isEmpty(), gift.id_);
                    this.icon_ = interfaceC3386h.mo16997f(!this.icon_.isEmpty(), this.icon_, !gift.icon_.isEmpty(), gift.icon_);
                    long j = this.price_;
                    boolean z2 = j != 0;
                    long j2 = gift.price_;
                    this.price_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public static Gift parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Gift) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Gift parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Gift) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Gift parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Gift) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Gift parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Gift) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Gift parseFrom(C3407e c3407e) throws IOException {
            return (Gift) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Gift parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Gift) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class GiftWallGradeFiveNotice extends GeneratedMessageLite<GiftWallGradeFiveNotice, Builder> implements GiftWallGradeFiveNoticeOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<GiftWallGradeFiveNotice, Builder> implements GiftWallGradeFiveNoticeOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44471.f15958xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.userName_ = interfaceC3386h.mo16997f(!this.userName_.isEmpty(), this.userName_, !giftWallGradeFiveNotice.userName_.isEmpty(), giftWallGradeFiveNotice.userName_);
                    this.otherUserName_ = interfaceC3386h.mo16997f(!this.otherUserName_.isEmpty(), this.otherUserName_, !giftWallGradeFiveNotice.otherUserName_.isEmpty(), giftWallGradeFiveNotice.otherUserName_);
                    this.giftName_ = interfaceC3386h.mo16997f(!this.giftName_.isEmpty(), this.giftName_, !giftWallGradeFiveNotice.giftName_.isEmpty(), giftWallGradeFiveNotice.giftName_);
                    this.giftIcon_ = interfaceC3386h.mo16997f(!this.giftIcon_.isEmpty(), this.giftIcon_, !giftWallGradeFiveNotice.giftIcon_.isEmpty(), giftWallGradeFiveNotice.giftIcon_);
                    this.svgaUrl_ = interfaceC3386h.mo16997f(!this.svgaUrl_.isEmpty(), this.svgaUrl_, true ^ giftWallGradeFiveNotice.svgaUrl_.isEmpty(), giftWallGradeFiveNotice.svgaUrl_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            if (!this.otherUserName_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getOtherUserName());
            }
            if (!this.giftName_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getGiftName());
            }
            if (!this.giftIcon_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getGiftIcon());
            }
            if (!this.svgaUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getSvgaUrl());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.otherUserName_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getOtherUserName());
            }
            if (!this.giftName_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getGiftName());
            }
            if (!this.giftIcon_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getGiftIcon());
            }
            if (this.svgaUrl_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(5, getSvgaUrl());
        }

        public static GiftWallGradeFiveNotice parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (GiftWallGradeFiveNotice) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static GiftWallGradeFiveNotice parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (GiftWallGradeFiveNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static GiftWallGradeFiveNotice parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (GiftWallGradeFiveNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static GiftWallGradeFiveNotice parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (GiftWallGradeFiveNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static GiftWallGradeFiveNotice parseFrom(C3407e c3407e) throws IOException {
            return (GiftWallGradeFiveNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static GiftWallGradeFiveNotice parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (GiftWallGradeFiveNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44471.f15958xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    GeneratedMessageLite.InterfaceC3386h interfaceC3386h = (GeneratedMessageLite.InterfaceC3386h) obj;
                    User user = (User) obj2;
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !user.id_.isEmpty(), user.id_);
                    this.name_ = interfaceC3386h.mo16997f(!this.name_.isEmpty(), this.name_, !user.name_.isEmpty(), user.name_);
                    this.imageUrl_ = interfaceC3386h.mo16997f(!this.imageUrl_.isEmpty(), this.imageUrl_, true ^ user.imageUrl_.isEmpty(), user.imageUrl_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
