package com.p046p1.mobile.longlink.msg.liveright;
...
public final class liveRight {
    ...
    public static /* synthetic */ class C44571 {
        ...
        static {
            ...
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15965xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class AcquireUserLiveRightMsg extends GeneratedMessageLite<AcquireUserLiveRightMsg, Builder> implements AcquireUserLiveRightMsgOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.userLiveRight_ = (UserLiveRight) interfaceC3386h.mo17006o(this.userLiveRight_, acquireUserLiveRightMsg.userLiveRight_);
                    long j = this.serverTimeInSeconds_;
                    boolean z3 = j != 0;
                    long j2 = acquireUserLiveRightMsg.serverTimeInSeconds_;
                    this.serverTimeInSeconds_ = interfaceC3386h.mo17000i(z3, j, j2 != 0, j2);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    UserLiveRight userLiveRight2 = (UserLiveRight) c3407e.m17143w(UserLiveRight.parser(), c3410h);
                                    ...
                                    this.serverTimeInSeconds_ = c3407e.m17142v();
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.action_ != AcquireUserLiveRightAction.equip.getNumber() ? CodedOutputStream.m16922m(1, this.action_) : 0;
            if (this.userLiveRight_ != null) {
                iM16922m += CodedOutputStream.m16893C(2, getUserLiveRight());
            }
            long j = this.serverTimeInSeconds_;
            if (j != 0) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.userLiveRight_ != null) {
                codedOutputStream.mo16974w0(2, getUserLiveRight());
            }
            long j = this.serverTimeInSeconds_;
            if (j != 0) {
        ...
        public enum AcquireUserLiveRightAction implements C3414l.c {
            equip(0),
            unequip(1),
            UNRECOGNIZED(-1);

            public static final int equip_VALUE = 0;
            private static final C3414l.d<AcquireUserLiveRightAction> internalValueMap = new C3414l.d<AcquireUserLiveRightAction>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.AcquireUserLiveRightMsg.AcquireUserLiveRightAction.1
            ...
            public static C3414l.d<AcquireUserLiveRightAction> internalGetValueMap() {
        ...
        public static AcquireUserLiveRightMsg parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (AcquireUserLiveRightMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static AcquireUserLiveRightMsg parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (AcquireUserLiveRightMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<AcquireUserLiveRightMsg, Builder> implements AcquireUserLiveRightMsgOrBuilder {
            private Builder() {
        ...
        public static AcquireUserLiveRightMsg parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (AcquireUserLiveRightMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static AcquireUserLiveRightMsg parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (AcquireUserLiveRightMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static AcquireUserLiveRightMsg parseFrom(C3407e c3407e) throws IOException {
            return (AcquireUserLiveRightMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static AcquireUserLiveRightMsg parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (AcquireUserLiveRightMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Attribute extends GeneratedMessageLite<Attribute, Builder> implements AttributeOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.thumbnailUrl_ = interfaceC3386h.mo16997f(!this.thumbnailUrl_.isEmpty(), this.thumbnailUrl_, !attribute.thumbnailUrl_.isEmpty(), attribute.thumbnailUrl_);
                    this.jumpUrl_ = interfaceC3386h.mo16997f(!this.jumpUrl_.isEmpty(), this.jumpUrl_, !attribute.jumpUrl_.isEmpty(), attribute.jumpUrl_);
                    this.restrict_ = (Restrict) interfaceC3386h.mo17006o(this.restrict_, attribute.restrict_);
                    this.resourceUrl_ = interfaceC3386h.mo16997f(!this.resourceUrl_.isEmpty(), this.resourceUrl_, true ^ attribute.resourceUrl_.isEmpty(), attribute.resourceUrl_);
                    this.chatShadingConfig_ = (ChatShadingConfig) interfaceC3386h.mo17006o(this.chatShadingConfig_, attribute.chatShadingConfig_);
                    this.avatarConfig_ = (AvatarConfig) interfaceC3386h.mo17006o(this.avatarConfig_, attribute.avatarConfig_);
                    this.profileConfig_ = (ProfileConfig) interfaceC3386h.mo17006o(this.profileConfig_, attribute.profileConfig_);
                    this.callEffectConfig_ = (CallEffectConfig) interfaceC3386h.mo17006o(this.callEffectConfig_, attribute.callEffectConfig_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 18) {
                                    this.thumbnailUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
                                    ...
                                    Restrict restrict2 = (Restrict) c3407e.m17143w(Restrict.parser(), c3410h);
                                    ...
                                    this.resourceUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 82) {
                                    ...
                                    ChatShadingConfig chatShadingConfig2 = (ChatShadingConfig) c3407e.m17143w(ChatShadingConfig.parser(), c3410h);
                                    ...
                                    ProfileConfig profileConfig2 = (ProfileConfig) c3407e.m17143w(ProfileConfig.parser(), c3410h);
                                    ...
                                    CallEffectConfig callEffectConfig2 = (CallEffectConfig) c3407e.m17143w(CallEffectConfig.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.thumbnailUrl_.isEmpty() ? CodedOutputStream.m16901K(2, getThumbnailUrl()) : 0;
            if (!this.jumpUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getJumpUrl());
            }
            if (this.restrict_ != null) {
                iM16901K += CodedOutputStream.m16893C(4, getRestrict());
            }
            if (!this.resourceUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getResourceUrl());
            }
            if (this.chatShadingConfig_ != null) {
                iM16901K += CodedOutputStream.m16893C(10, getChatShadingConfig());
            }
            if (this.avatarConfig_ != null) {
                iM16901K += CodedOutputStream.m16893C(11, getAvatarConfig());
            }
            if (this.profileConfig_ != null) {
                iM16901K += CodedOutputStream.m16893C(12, getProfileConfig());
            }
            if (this.callEffectConfig_ != null) {
                iM16901K += CodedOutputStream.m16893C(13, getCallEffectConfig());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.thumbnailUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getThumbnailUrl());
            }
            if (!this.jumpUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getJumpUrl());
            }
            if (this.restrict_ != null) {
                codedOutputStream.mo16974w0(4, getRestrict());
            }
            if (!this.resourceUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getResourceUrl());
            }
            if (this.chatShadingConfig_ != null) {
                codedOutputStream.mo16974w0(10, getChatShadingConfig());
            }
            if (this.avatarConfig_ != null) {
                codedOutputStream.mo16974w0(11, getAvatarConfig());
            }
            if (this.profileConfig_ != null) {
                codedOutputStream.mo16974w0(12, getProfileConfig());
            }
            if (this.callEffectConfig_ != null) {
                codedOutputStream.mo16974w0(13, getCallEffectConfig());
            }
        }

        public static Attribute parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Attribute) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Attribute parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Attribute) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Attribute, Builder> implements AttributeOrBuilder {
            private Builder() {
        ...
        public static Attribute parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Attribute) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Attribute parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Attribute) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Attribute parseFrom(C3407e c3407e) throws IOException {
            return (Attribute) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Attribute parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Attribute) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class AvatarConfig extends GeneratedMessageLite<AvatarConfig, Builder> implements AvatarConfigOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.frameConfig_ = (PictureConfig) interfaceC3386h.mo17006o(this.frameConfig_, avatarConfig.frameConfig_);
                    this.avatarUrl_ = interfaceC3386h.mo16997f(!this.avatarUrl_.isEmpty(), this.avatarUrl_, !avatarConfig.avatarUrl_.isEmpty(), avatarConfig.avatarUrl_);
                    this.connectorImage_ = interfaceC3386h.mo16997f(!this.connectorImage_.isEmpty(), this.connectorImage_, true ^ avatarConfig.connectorImage_.isEmpty(), avatarConfig.connectorImage_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.connectorImage_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            if (!this.avatarUrl_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(2, getAvatarUrl());
            }
            if (!this.connectorImage_.isEmpty()) {
                iM16893C += CodedOutputStream.m16901K(3, getConnectorImage());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.mo16939D0(3, getConnectorImage());
        }
    ...
    public enum BizType implements C3414l.c {
        grant(0),
        ...
        private static final C3414l.d<BizType> internalValueMap = new C3414l.d<BizType>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.BizType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<BizType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class CallEffectConfig extends GeneratedMessageLite<CallEffectConfig, Builder> implements CallEffectConfigOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<CallEffectConfig, Builder> implements CallEffectConfigOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.verticalBg_ = interfaceC3386h.mo16997f(!this.verticalBg_.isEmpty(), this.verticalBg_, !callEffectConfig.verticalBg_.isEmpty(), callEffectConfig.verticalBg_);
                    this.horizontalBg_ = interfaceC3386h.mo16997f(!this.horizontalBg_.isEmpty(), this.horizontalBg_, !callEffectConfig.horizontalBg_.isEmpty(), callEffectConfig.horizontalBg_);
                    this.defaultIcon_ = interfaceC3386h.mo16997f(!this.defaultIcon_.isEmpty(), this.defaultIcon_, !callEffectConfig.defaultIcon_.isEmpty(), callEffectConfig.defaultIcon_);
                    this.muteIcon_ = interfaceC3386h.mo16997f(!this.muteIcon_.isEmpty(), this.muteIcon_, !callEffectConfig.muteIcon_.isEmpty(), callEffectConfig.muteIcon_);
                    this.verticalVoicingUrl_ = interfaceC3386h.mo16997f(!this.verticalVoicingUrl_.isEmpty(), this.verticalVoicingUrl_, !callEffectConfig.verticalVoicingUrl_.isEmpty(), callEffectConfig.verticalVoicingUrl_);
                    this.horizontalVoicingUrl_ = interfaceC3386h.mo16997f(!this.horizontalVoicingUrl_.isEmpty(), this.horizontalVoicingUrl_, !callEffectConfig.horizontalVoicingUrl_.isEmpty(), callEffectConfig.horizontalVoicingUrl_);
                    this.circleVoicingUrl_ = interfaceC3386h.mo16997f(!this.circleVoicingUrl_.isEmpty(), this.circleVoicingUrl_, true ^ callEffectConfig.circleVoicingUrl_.isEmpty(), callEffectConfig.circleVoicingUrl_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    this.verticalBg_ = c3407e.m17115L();
                                } else if (iM17116M == 18) {
                                    this.horizontalBg_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
                                    this.defaultIcon_ = c3407e.m17115L();
                                } else if (iM17116M == 34) {
                                    this.muteIcon_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
                                    this.verticalVoicingUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 50) {
                                    this.horizontalVoicingUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    this.circleVoicingUrl_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.verticalBg_.isEmpty() ? CodedOutputStream.m16901K(1, getVerticalBg()) : 0;
            if (!this.horizontalBg_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getHorizontalBg());
            }
            if (!this.defaultIcon_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getDefaultIcon());
            }
            if (!this.muteIcon_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getMuteIcon());
            }
            if (!this.verticalVoicingUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getVerticalVoicingUrl());
            }
            if (!this.horizontalVoicingUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getHorizontalVoicingUrl());
            }
            if (!this.circleVoicingUrl_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getCircleVoicingUrl());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.verticalBg_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getVerticalBg());
            }
            if (!this.horizontalBg_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getHorizontalBg());
            }
            if (!this.defaultIcon_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getDefaultIcon());
            }
            if (!this.muteIcon_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getMuteIcon());
            }
            if (!this.verticalVoicingUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getVerticalVoicingUrl());
            }
            if (!this.horizontalVoicingUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getHorizontalVoicingUrl());
            }
            if (this.circleVoicingUrl_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(7, getCircleVoicingUrl());
        }

        public static CallEffectConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (CallEffectConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static CallEffectConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (CallEffectConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static CallEffectConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (CallEffectConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static CallEffectConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (CallEffectConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static CallEffectConfig parseFrom(C3407e c3407e) throws IOException {
            return (CallEffectConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static CallEffectConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (CallEffectConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class ChatShadingConfig extends GeneratedMessageLite<ChatShadingConfig, Builder> implements ChatShadingConfigOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.borderColorConfig_ = (ColorConfig) interfaceC3386h.mo17006o(this.borderColorConfig_, chatShadingConfig.borderColorConfig_);
                    this.backgroundColorConfig_ = (ColorConfig) interfaceC3386h.mo17006o(this.backgroundColorConfig_, chatShadingConfig.backgroundColorConfig_);
                    this.cornerConfig_ = (CornerConfig) interfaceC3386h.mo17006o(this.cornerConfig_, chatShadingConfig.cornerConfig_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    ColorConfig colorConfig2 = (ColorConfig) c3407e.m17143w(ColorConfig.parser(), c3410h);
                                    ...
                                    ColorConfig colorConfig4 = (ColorConfig) c3407e.m17143w(ColorConfig.parser(), c3410h);
                                    ...
                                    CornerConfig cornerConfig2 = (CornerConfig) c3407e.m17143w(CornerConfig.parser(), c3410h);
        ...
        public static ChatShadingConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ChatShadingConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ChatShadingConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ChatShadingConfig, Builder> implements ChatShadingConfigOrBuilder {
            private Builder() {
        ...
        public static ChatShadingConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ChatShadingConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ChatShadingConfig parseFrom(C3407e c3407e) throws IOException {
            return (ChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ChatShadingConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class ColorConfig extends GeneratedMessageLite<ColorConfig, Builder> implements ColorConfigOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ColorConfig, Builder> implements ColorConfigOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.gradientDirection_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.colors_ = interfaceC3386h.mo16998g(this.colors_, colorConfig.colors_);
                    long j = this.transparency_;
                    boolean z3 = j != 0;
                    long j2 = colorConfig.transparency_;
                    this.transparency_ = interfaceC3386h.mo17000i(z3, j, j2 != 0, j2);
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    this.gradientDirection_ = c3407e.m17136p();
                                } else if (iM17116M == 18) {
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.gradientDirection_ != GradientDirection.unknownDirection.getNumber() ? CodedOutputStream.m16922m(1, this.gradientDirection_) : 0;
            int iM16902L = 0;
            for (int i2 = 0; i2 < this.colors_.size(); i2++) {
                iM16902L += CodedOutputStream.m16902L(this.colors_.get(i2));
            }
            int size = iM16922m + iM16902L + getColorsList().size();
            long j = this.transparency_;
            if (j != 0) {
                size += CodedOutputStream.m16931v(3, j);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.gradientDirection_ != GradientDirection.unknownDirection.getNumber()) {
                codedOutputStream.m16960i0(1, this.gradientDirection_);
            }
        ...
        public static ColorConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ColorConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ColorConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static ColorConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ColorConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ColorConfig parseFrom(C3407e c3407e) throws IOException {
            return (ColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ColorConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class CornerConfig extends GeneratedMessageLite<CornerConfig, Builder> implements CornerConfigOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<CornerConfig, Builder> implements CornerConfigOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.pictureUrl_ = interfaceC3386h.mo16997f(!this.pictureUrl_.isEmpty(), this.pictureUrl_, !cornerConfig.pictureUrl_.isEmpty(), cornerConfig.pictureUrl_);
        ...
        public static CornerConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (CornerConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static CornerConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (CornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static CornerConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (CornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static CornerConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (CornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static CornerConfig parseFrom(C3407e c3407e) throws IOException {
            return (CornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static CornerConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (CornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum CornerPosition implements C3414l.c {
        nonePosition(0),
        rightTop(1),
        rightMiddle(2),
        rightBottom(3),
        ...
        private static final C3414l.d<CornerPosition> internalValueMap = new C3414l.d<CornerPosition>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.CornerPosition.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<CornerPosition> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum FadingType implements C3414l.c {
        never(0),
        relative(1),
        absolute(2),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<FadingType> internalValueMap = new C3414l.d<FadingType>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.FadingType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<FadingType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum GradientDirection implements C3414l.c {
        unknownDirection(0),
        fromUpToDown(1),
        fromLeftToRight(2),
        ...
        private static final C3414l.d<GradientDirection> internalValueMap = new C3414l.d<GradientDirection>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.GradientDirection.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<GradientDirection> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum LiveRightStatus implements C3414l.c {
        unknownStatus(0),
        pending(1),
        delete(3),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<LiveRightStatus> internalValueMap = new C3414l.d<LiveRightStatus>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.LiveRightStatus.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<LiveRightStatus> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum OperationType implements C3414l.c {
        auto(0),
        manual(1),
        UNRECOGNIZED(-1);

        public static final int auto_VALUE = 0;
        private static final C3414l.d<OperationType> internalValueMap = new C3414l.d<OperationType>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.OperationType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<OperationType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class PeriodConfig extends GeneratedMessageLite<PeriodConfig, Builder> implements PeriodConfigOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<PeriodConfig, Builder> implements PeriodConfigOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.fadingType_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    long j = this.fadingValue_;
                    boolean z3 = j != 0;
                    long j2 = periodConfig.fadingValue_;
                    this.fadingValue_ = interfaceC3386h.mo17000i(z3, j, j2 != 0, j2);
                    boolean z4 = this.show_;
                    boolean z5 = periodConfig.show_;
                    this.show_ = interfaceC3386h.mo16995d(z4, z4, z5, z5);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    this.fadingType_ = c3407e.m17136p();
                                } else if (iM17116M == 16) {
                                    this.fadingValue_ = c3407e.m17142v();
                                } else if (iM17116M == 24) {
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.fadingType_ != FadingType.never.getNumber() ? CodedOutputStream.m16922m(1, this.fadingType_) : 0;
            long j = this.fadingValue_;
            if (j != 0) {
            ...
            if (z) {
                iM16922m += CodedOutputStream.m16915f(3, z);
            }
            this.memoizedSerializedSize = iM16922m;
            return iM16922m;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.fadingType_ != FadingType.never.getNumber()) {
                codedOutputStream.m16960i0(1, this.fadingType_);
            }
            long j = this.fadingValue_;
            if (j != 0) {
        ...
        public static PeriodConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (PeriodConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static PeriodConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (PeriodConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static PeriodConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (PeriodConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static PeriodConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (PeriodConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static PeriodConfig parseFrom(C3407e c3407e) throws IOException {
            return (PeriodConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static PeriodConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (PeriodConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public enum PlaceType implements C3414l.c {
        ...
        private static final C3414l.d<PlaceType> internalValueMap = new C3414l.d<PlaceType>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.PlaceType.1
            @Override // com.google.protobuf.C3414l.d
    ...
    public static final class ProfileConfig extends GeneratedMessageLite<ProfileConfig, Builder> implements ProfileConfigOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.backgroundPictureConfig_ = (PictureConfig) interfaceC3386h.mo17006o(this.backgroundPictureConfig_, profileConfig.backgroundPictureConfig_);
                    this.topFrameConfig_ = (PictureConfig) interfaceC3386h.mo17006o(this.topFrameConfig_, profileConfig.topFrameConfig_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    PictureConfig pictureConfig4 = (PictureConfig) c3407e.m17143w(PictureConfig.parser(), c3410h);
        ...
        public static ProfileConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ProfileConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ProfileConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ProfileConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ProfileConfig, Builder> implements ProfileConfigOrBuilder {
            private Builder() {
        ...
        public static ProfileConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ProfileConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ProfileConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ProfileConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ProfileConfig parseFrom(C3407e c3407e) throws IOException {
            return (ProfileConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ProfileConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ProfileConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum ReceiveType implements C3414l.c {
        forReceiver(0),
        forGiver(1),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<ReceiveType> internalValueMap = new C3414l.d<ReceiveType>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.ReceiveType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<ReceiveType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class Restrict extends GeneratedMessageLite<Restrict, Builder> implements RestrictOrBuilder {
        ...
        private int bitField0_;
        private C3414l.g giftIds_ = GeneratedMessageLite.emptyLongList();
        private long grade_;
        private int receiveType_;

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Restrict, Builder> implements RestrictOrBuilder {
            private Builder() {
        ...
        public void addAllGiftIds(Iterable<? extends Long> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.giftIds_);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addGiftIds(long j) {
            ensureGiftIdsIsMutable();
            this.giftIds_.mo17212u(j);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.giftIds_ = interfaceC3386h.mo17008q(this.giftIds_, restrict.giftIds_);
                    int i = this.receiveType_;
                    boolean z3 = i != 0;
                    int i2 = restrict.receiveType_;
                    this.receiveType_ = interfaceC3386h.mo16996e(z3, i, i2 != 0, i2);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.giftIds_.mo17212u(c3407e.m17142v());
                                } else if (iM17116M == 18) {
                                    int iM17132l = c3407e.m17132l(c3407e.m17107C());
                                    if (!this.giftIds_.mo17085q() && c3407e.m17129d() > 0) {
                                        this.giftIds_ = GeneratedMessageLite.mutableCopy(this.giftIds_);
                                    }
                                    ...
                                    this.receiveType_ = c3407e.m17136p();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.giftIds_.size(); i2++) {
                iM16932w += CodedOutputStream.m16932w(this.giftIds_.getLong(i2));
            }
            int size = iM16931v + iM16932w + getGiftIdsList().size();
            if (this.receiveType_ != ReceiveType.forReceiver.getNumber()) {
                size += CodedOutputStream.m16922m(3, this.receiveType_);
            }
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i = 0; i < this.giftIds_.size(); i++) {
                codedOutputStream.m16972u0(2, this.giftIds_.getLong(i));
            }
            if (this.receiveType_ != ReceiveType.forReceiver.getNumber()) {
                codedOutputStream.m16960i0(3, this.receiveType_);
            }
        }

        public static Restrict parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Restrict) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Restrict parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Restrict) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Restrict parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Restrict) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Restrict parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Restrict) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Restrict parseFrom(C3407e c3407e) throws IOException {
            return (Restrict) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Restrict parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Restrict) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum ShowType implements C3414l.c {
        single(0),
        multiple(1),
        UNRECOGNIZED(-1);

        private static final C3414l.d<ShowType> internalValueMap = new C3414l.d<ShowType>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.ShowType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<ShowType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class TopChatUpdateNotice extends GeneratedMessageLite<TopChatUpdateNotice, Builder> implements TopChatUpdateNoticeOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<TopChatUpdateNotice, Builder> implements TopChatUpdateNoticeOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.randomDelaySeconds_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    boolean z3 = false;
        ...
        public static TopChatUpdateNotice parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (TopChatUpdateNotice) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static TopChatUpdateNotice parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (TopChatUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static TopChatUpdateNotice parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (TopChatUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static TopChatUpdateNotice parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (TopChatUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static TopChatUpdateNotice parseFrom(C3407e c3407e) throws IOException {
            return (TopChatUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static TopChatUpdateNotice parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (TopChatUpdateNotice) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public enum Type implements C3414l.c {
        ...
        private static final C3414l.d<Type> internalValueMap = new C3414l.d<Type>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.Type.1
            @Override // com.google.protobuf.C3414l.d
    ...
    public static final class UserLiveRight extends GeneratedMessageLite<UserLiveRight, Builder> implements UserLiveRightOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !userLiveRight.id_.isEmpty(), userLiveRight.id_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !userLiveRight.userId_.isEmpty(), userLiveRight.userId_);
                    this.liveRightId_ = interfaceC3386h.mo16997f(!this.liveRightId_.isEmpty(), this.liveRightId_, !userLiveRight.liveRightId_.isEmpty(), userLiveRight.liveRightId_);
                    int i = this.rightType_;
                    boolean z2 = i != 0;
                    int i2 = userLiveRight.rightType_;
                    this.rightType_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.name_ = interfaceC3386h.mo16997f(!this.name_.isEmpty(), this.name_, !userLiveRight.name_.isEmpty(), userLiveRight.name_);
                    int i3 = this.showType_;
                    boolean z3 = i3 != 0;
                    int i4 = userLiveRight.showType_;
                    this.showType_ = interfaceC3386h.mo16996e(z3, i3, i4 != 0, i4);
                    long j = this.level_;
                    boolean z4 = j != 0;
                    long j2 = userLiveRight.level_;
                    this.level_ = interfaceC3386h.mo17000i(z4, j, j2 != 0, j2);
                    this.attribute_ = (Attribute) interfaceC3386h.mo17006o(this.attribute_, userLiveRight.attribute_);
                    int i5 = this.status_;
                    boolean z5 = i5 != 0;
                    int i6 = userLiveRight.status_;
                    this.status_ = interfaceC3386h.mo16996e(z5, i5, i6 != 0, i6);
                    long j3 = this.createTimeInSeconds_;
                    boolean z6 = j3 != 0;
                    long j4 = userLiveRight.createTimeInSeconds_;
                    this.createTimeInSeconds_ = interfaceC3386h.mo17000i(z6, j3, j4 != 0, j4);
                    long j5 = this.validEndTimeInSeconds_;
                    boolean z7 = j5 != 0;
                    long j6 = userLiveRight.validEndTimeInSeconds_;
                    this.validEndTimeInSeconds_ = interfaceC3386h.mo17000i(z7, j5, j6 != 0, j6);
                    this.fromUserId_ = interfaceC3386h.mo16997f(!this.fromUserId_.isEmpty(), this.fromUserId_, !userLiveRight.fromUserId_.isEmpty(), userLiveRight.fromUserId_);
                    int i7 = this.placeType_;
                    boolean z8 = i7 != 0;
                    int i8 = userLiveRight.placeType_;
                    this.placeType_ = interfaceC3386h.mo16996e(z8, i7, i8 != 0, i8);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 18:
                                    ...
                                    continue;
                                case 26:
                                    this.liveRightId_ = c3407e.m17115L();
                                    continue;
                                case 32:
                                    this.rightType_ = c3407e.m17136p();
                                    continue;
                                case 42:
                                    this.name_ = c3407e.m17115L();
                                    continue;
                                case 48:
                                    this.showType_ = c3407e.m17136p();
                                    continue;
                                case 56:
                                ...
                                case 66:
                                    ...
                                    Attribute attribute2 = (Attribute) c3407e.m17143w(Attribute.parser(), c3410h);
                                ...
                                case 72:
                                    ...
                                    continue;
                                case 80:
                                    this.createTimeInSeconds_ = c3407e.m17142v();
                                    continue;
                                case 88:
                                    this.validEndTimeInSeconds_ = c3407e.m17142v();
                                    continue;
        ...
        public int getSerializedSize() {
            ...
            if (!this.liveRightId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getLiveRightId());
            }
            if (this.rightType_ != Type.emptyType.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(4, this.rightType_);
            }
            if (!this.name_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getName());
            }
            if (this.showType_ != ShowType.single.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(6, this.showType_);
            }
            long j = this.level_;
            if (j != 0) {
            ...
            if (this.attribute_ != null) {
                iM16901K += CodedOutputStream.m16893C(8, getAttribute());
            }
            if (this.status_ != UserLiveRightStatus.deleted.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(9, this.status_);
            }
            long j2 = this.createTimeInSeconds_;
            if (j2 != 0) {
                iM16901K += CodedOutputStream.m16931v(10, j2);
            }
            long j3 = this.validEndTimeInSeconds_;
            if (j3 != 0) {
                iM16901K += CodedOutputStream.m16931v(11, j3);
            }
            if (!this.fromUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(12, getFromUserId());
            }
            if (this.placeType_ != PlaceType.videoRoom.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(13, this.placeType_);
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.liveRightId_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getLiveRightId());
            }
            if (this.rightType_ != Type.emptyType.getNumber()) {
                codedOutputStream.m16960i0(4, this.rightType_);
            }
            if (!this.name_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getName());
            }
            if (this.showType_ != ShowType.single.getNumber()) {
                codedOutputStream.m16960i0(6, this.showType_);
            }
            long j = this.level_;
            if (j != 0) {
            ...
            if (this.attribute_ != null) {
                codedOutputStream.mo16974w0(8, getAttribute());
            }
            if (this.status_ != UserLiveRightStatus.deleted.getNumber()) {
                codedOutputStream.m16960i0(9, this.status_);
            }
            long j2 = this.createTimeInSeconds_;
            if (j2 != 0) {
                codedOutputStream.m16972u0(10, j2);
            }
            long j3 = this.validEndTimeInSeconds_;
            if (j3 != 0) {
            ...
            if (!this.fromUserId_.isEmpty()) {
                codedOutputStream.mo16939D0(12, getFromUserId());
            }
            if (this.placeType_ != PlaceType.videoRoom.getNumber()) {
                codedOutputStream.m16960i0(13, this.placeType_);
            }
        }

        public static UserLiveRight parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveRight) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveRight parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveRight) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserLiveRight, Builder> implements UserLiveRightOrBuilder {
            private Builder() {
        ...
        public static UserLiveRight parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveRight) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserLiveRight parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveRight) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveRight parseFrom(C3407e c3407e) throws IOException {
            return (UserLiveRight) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserLiveRight parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserLiveRight) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class UserLiveRightResources extends GeneratedMessageLite<UserLiveRightResources, Builder> implements UserLiveRightResourcesOrBuilder {
        ...
        private C3414l.h<UserLiveRight> userLiveRights_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllUserLiveRights(Iterable<? extends UserLiveRight> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.userLiveRights_);
        }
        ...
        private void ensureUserLiveRightsIsMutable() {
            if (this.userLiveRights_.mo17085q()) {
                return;
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44571.f15965xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    this.userLiveRights_.mo17084n();
                    return null;
                case 4:
                    return new Builder();
                case 5:
                    this.userLiveRights_ = ((GeneratedMessageLite.InterfaceC3386h) obj).mo16998g(this.userLiveRights_, ((UserLiveRightResources) obj2).userLiveRights_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.userLiveRights_.add((UserLiveRight) c3407e.m17143w(UserLiveRight.parser(), c3410h));
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.userLiveRights_.size(); i2++) {
                iM16893C += CodedOutputStream.m16893C(1, this.userLiveRights_.get(i2));
            }
            this.memoizedSerializedSize = iM16893C;
            return iM16893C;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            for (int i = 0; i < this.userLiveRights_.size(); i++) {
                codedOutputStream.mo16974w0(1, this.userLiveRights_.get(i));
            }
        }

        public static UserLiveRightResources parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveRightResources) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveRightResources parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveRightResources) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserLiveRightResources, Builder> implements UserLiveRightResourcesOrBuilder {
            private Builder() {
        ...
        public static UserLiveRightResources parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveRightResources) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserLiveRightResources parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveRightResources) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveRightResources parseFrom(C3407e c3407e) throws IOException {
            return (UserLiveRightResources) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserLiveRightResources parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserLiveRightResources) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public enum UserLiveRightStatus implements C3414l.c {
        deleted(0),
        created(5),
        activated(10),
        equipped(15),
        ...
        private static final C3414l.d<UserLiveRightStatus> internalValueMap = new C3414l.d<UserLiveRightStatus>() { // from class: com.p1.mobile.longlink.msg.liveright.liveRight.UserLiveRightStatus.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<UserLiveRightStatus> internalGetValueMap() {
            return internalValueMap;
        }
