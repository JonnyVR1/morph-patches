package com.p046p1.mobile.longlink.msg.userMask;
...
public final class userMaskConfig {
    ...
    public static /* synthetic */ class C45491 {
        ...
        static {
            ...
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15998xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class AvatarConfig extends GeneratedMessageLite<AvatarConfig, Builder> implements AvatarConfigOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45491.f15998xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public static final class UserMask extends GeneratedMessageLite<UserMask, Builder> implements UserMaskOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45491.f15998xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.avatar_ = interfaceC3386h.mo16997f(!this.avatar_.isEmpty(), this.avatar_, !userMask.avatar_.isEmpty(), userMask.avatar_);
                    ...
                    this.avatarResourceType_ = interfaceC3386h.mo16997f(!this.avatarResourceType_.isEmpty(), this.avatarResourceType_, true ^ userMask.avatarResourceType_.isEmpty(), userMask.avatarResourceType_);
                    this.userNameGradientColors_ = interfaceC3386h.mo16998g(this.userNameGradientColors_, userMask.userNameGradientColors_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.avatarResourceType_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    String strM17115L = c3407e.m17115L();
                                    if (!this.userNameGradientColors_.mo17085q()) {
                                        this.userNameGradientColors_ = GeneratedMessageLite.mutableCopy(this.userNameGradientColors_);
                                    }
                                    this.userNameGradientColors_.add(strM17115L);
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            if (!this.avatarResourceType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getAvatarResourceType());
            }
            int iM16902L = 0;
            for (int i2 = 0; i2 < this.userNameGradientColors_.size(); i2++) {
                iM16902L += CodedOutputStream.m16902L(this.userNameGradientColors_.get(i2));
            }
            int size = iM16901K + iM16902L + getUserNameGradientColorsList().size();
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.avatarResourceType_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getAvatarResourceType());
            }
            for (int i = 0; i < this.userNameGradientColors_.size(); i++) {
                codedOutputStream.mo16939D0(7, this.userNameGradientColors_.get(i));
            }
        }
