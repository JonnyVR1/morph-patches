package com.p046p1.mobile.longlink.msg.livechat;
...
public final class LongLinkChatMessage {
    ...
    public static /* synthetic */ class C44401 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f15955xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15955xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15955xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public enum Action implements C3414l.c {
        ...
        private static final C3414l.d<Action> internalValueMap = new C3414l.d<Action>() { // from class: com.p1.mobile.longlink.msg.livechat.LongLinkChatMessage.Action.1
    ...
    public static final class AtUserInfo extends GeneratedMessageLite<AtUserInfo, Builder> implements AtUserInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<AtUserInfo, Builder> implements AtUserInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !atUserInfo.userId_.isEmpty(), atUserInfo.userId_);
                    this.userName_ = interfaceC3386h.mo16997f(!this.userName_.isEmpty(), this.userName_, true ^ atUserInfo.userName_.isEmpty(), atUserInfo.userName_);
        ...
        public static AtUserInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (AtUserInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static AtUserInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (AtUserInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static AtUserInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (AtUserInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static AtUserInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (AtUserInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static AtUserInfo parseFrom(C3407e c3407e) throws IOException {
            return (AtUserInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static AtUserInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (AtUserInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class ClientPostMessageRequest extends GeneratedMessageLite<ClientPostMessageRequest, Builder> implements ClientPostMessageRequestOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.anchorId_ = interfaceC3386h.mo16997f(!this.anchorId_.isEmpty(), this.anchorId_, true ^ clientPostMessageRequest.anchorId_.isEmpty(), clientPostMessageRequest.anchorId_);
                    this.msg_ = (LiveChatMessage) interfaceC3386h.mo17006o(this.msg_, clientPostMessageRequest.msg_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    LiveChatMessage liveChatMessage2 = (LiveChatMessage) c3407e.m17143w(LiveChatMessage.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (this.msg_ != null) {
                iM16901K += CodedOutputStream.m16893C(2, getMsg());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.msg_ != null) {
                codedOutputStream.mo16974w0(2, getMsg());
            }
        }

        public static ClientPostMessageRequest parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ClientPostMessageRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ClientPostMessageRequest parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ClientPostMessageRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ClientPostMessageRequest, Builder> implements ClientPostMessageRequestOrBuilder {
            private Builder() {
        ...
        public static ClientPostMessageRequest parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ClientPostMessageRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ClientPostMessageRequest parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ClientPostMessageRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ClientPostMessageRequest parseFrom(C3407e c3407e) throws IOException {
            return (ClientPostMessageRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ClientPostMessageRequest parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ClientPostMessageRequest) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class GiftMessage extends GeneratedMessageLite<GiftMessage, Builder> implements GiftMessageOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<GiftMessage, Builder> implements GiftMessageOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.type_ = interfaceC3386h.mo16997f(!this.type_.isEmpty(), this.type_, !giftMessage.type_.isEmpty(), giftMessage.type_);
                    this.name_ = interfaceC3386h.mo16997f(!this.name_.isEmpty(), this.name_, !giftMessage.name_.isEmpty(), giftMessage.name_);
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, !giftMessage.url_.isEmpty(), giftMessage.url_);
                    this.originId_ = interfaceC3386h.mo16997f(!this.originId_.isEmpty(), this.originId_, !giftMessage.originId_.isEmpty(), giftMessage.originId_);
                    int i = this.count_;
                    boolean z3 = i != 0;
                    int i2 = giftMessage.count_;
                    this.count_ = interfaceC3386h.mo16996e(z3, i, i2 != 0, i2);
                    this.anchorId_ = interfaceC3386h.mo16997f(!this.anchorId_.isEmpty(), this.anchorId_, !giftMessage.anchorId_.isEmpty(), giftMessage.anchorId_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !giftMessage.liveId_.isEmpty(), giftMessage.liveId_);
                    this.version_ = interfaceC3386h.mo16997f(!this.version_.isEmpty(), this.version_, !giftMessage.version_.isEmpty(), giftMessage.version_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.originId_ = c3407e.m17115L();
                                } else if (iM17116M == 48) {
                                    this.count_ = c3407e.m17117N();
                                } else if (iM17116M == 58) {
                                    this.anchorId_ = c3407e.m17115L();
                                } else if (iM17116M == 66) {
        ...
        public int getSerializedSize() {
            ...
            if (!this.type_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(2, getType());
            }
            if (!this.name_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(3, getName());
            }
            if (!this.url_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(4, getUrl());
            }
            if (!this.originId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(5, getOriginId());
            }
            int i2 = this.count_;
            if (i2 != 0) {
                iM16931v += CodedOutputStream.m16904N(6, i2);
            }
            if (!this.anchorId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(7, getAnchorId());
            }
            if (!this.liveId_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(8, getLiveId());
            }
            if (!this.version_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(9, getVersion());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.name_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getName());
            }
            if (!this.url_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getUrl());
            }
            if (!this.originId_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getOriginId());
            }
            int i = this.count_;
            if (i != 0) {
                codedOutputStream.mo16942G0(6, i);
            }
            if (!this.anchorId_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getAnchorId());
            }
            if (!this.liveId_.isEmpty()) {
                codedOutputStream.mo16939D0(8, getLiveId());
            }
            if (this.version_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(9, getVersion());
        }

        public static GiftMessage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (GiftMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static GiftMessage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (GiftMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static GiftMessage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (GiftMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static GiftMessage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (GiftMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static GiftMessage parseFrom(C3407e c3407e) throws IOException {
            return (GiftMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static GiftMessage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (GiftMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class HierarchyMessage extends GeneratedMessageLite<HierarchyMessage, Builder> implements HierarchyMessageOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<HierarchyMessage, Builder> implements HierarchyMessageOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.imageUrl_ = interfaceC3386h.mo16997f(!this.imageUrl_.isEmpty(), this.imageUrl_, !hierarchyMessage.imageUrl_.isEmpty(), hierarchyMessage.imageUrl_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            if (!this.imageUrl_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(2, getImageUrl());
            }
            this.memoizedSerializedSize = iM16931v;
            return iM16931v;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.mo16939D0(2, getImageUrl());
        }

        public static HierarchyMessage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (HierarchyMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static HierarchyMessage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (HierarchyMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static HierarchyMessage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (HierarchyMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static HierarchyMessage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (HierarchyMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static HierarchyMessage parseFrom(C3407e c3407e) throws IOException {
            return (HierarchyMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static HierarchyMessage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (HierarchyMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class LiveBackgroundColorConfig extends GeneratedMessageLite<LiveBackgroundColorConfig, Builder> implements LiveBackgroundColorConfigOrBuilder {
        ...
        private C3414l.h<String> colors_ = GeneratedMessageLite.emptyProtobufList();
        private long gradientDirection_;
        private long transparency_;

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveBackgroundColorConfig, Builder> implements LiveBackgroundColorConfigOrBuilder {
            private Builder() {
        ...
        public void addAllColors(Iterable<String> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.colors_);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.gradientDirection_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    this.colors_ = interfaceC3386h.mo16998g(this.colors_, liveBackgroundColorConfig.colors_);
                    boolean z3 = false;
                    ...
                    this.transparency_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    this.gradientDirection_ = c3407e.m17142v();
                                } else if (iM17116M == 18) {
                                    String strM17115L = c3407e.m17115L();
                                    if (!this.colors_.mo17085q()) {
                                        this.colors_ = GeneratedMessageLite.mutableCopy(this.colors_);
                                    }
                                    this.colors_.add(strM17115L);
                                } else if (iM17116M == 24) {
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.colors_.size(); i2++) {
                iM16902L += CodedOutputStream.m16902L(this.colors_.get(i2));
            }
            int size = iM16931v + iM16902L + getColorsList().size();
            long j2 = this.transparency_;
            if (j2 != 0) {
                size += CodedOutputStream.m16931v(3, j2);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i = 0; i < this.colors_.size(); i++) {
                codedOutputStream.mo16939D0(2, this.colors_.get(i));
            }
            long j2 = this.transparency_;
            if (j2 != 0) {
        ...
        public static LiveBackgroundColorConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveBackgroundColorConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveBackgroundColorConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveBackgroundColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static LiveBackgroundColorConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveBackgroundColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveBackgroundColorConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveBackgroundColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveBackgroundColorConfig parseFrom(C3407e c3407e) throws IOException {
            return (LiveBackgroundColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveBackgroundColorConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveBackgroundColorConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class LiveChatMessage extends GeneratedMessageLite<LiveChatMessage, Builder> implements LiveChatMessageOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !liveChatMessage.roomId_.isEmpty(), liveChatMessage.roomId_);
                    long j = this.seq_;
                    boolean z2 = j != 0;
                    ...
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !liveChatMessage.userId_.isEmpty(), liveChatMessage.userId_);
                    this.username_ = interfaceC3386h.mo16997f(!this.username_.isEmpty(), this.username_, !liveChatMessage.username_.isEmpty(), liveChatMessage.username_);
                    this.value_ = interfaceC3386h.mo16997f(!this.value_.isEmpty(), this.value_, !liveChatMessage.value_.isEmpty(), liveChatMessage.value_);
                    int i3 = this.action_;
                    boolean z4 = i3 != 0;
                    int i4 = liveChatMessage.action_;
                    this.action_ = interfaceC3386h.mo16996e(z4, i3, i4 != 0, i4);
                    this.gift_ = (GiftMessage) interfaceC3386h.mo17006o(this.gift_, liveChatMessage.gift_);
                    this.h5_ = interfaceC3386h.mo16997f(!this.h5_.isEmpty(), this.h5_, !liveChatMessage.h5_.isEmpty(), liveChatMessage.h5_);
                    this.template_ = (Template.TemplateData) interfaceC3386h.mo17006o(this.template_, liveChatMessage.template_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !liveChatMessage.liveId_.isEmpty(), liveChatMessage.liveId_);
                    this.medal_ = (MedalMessage) interfaceC3386h.mo17006o(this.medal_, liveChatMessage.medal_);
                    long j3 = this.createdTime_;
                    boolean z5 = j3 != 0;
                    long j4 = liveChatMessage.createdTime_;
                    this.createdTime_ = interfaceC3386h.mo17000i(z5, j3, j4 != 0, j4);
                    this.hierarchy_ = (HierarchyMessage) interfaceC3386h.mo17006o(this.hierarchy_, liveChatMessage.hierarchy_);
                    this.liveRevenueCampaignVip_ = (LiveRevenueCampaignVip) interfaceC3386h.mo17006o(this.liveRevenueCampaignVip_, liveChatMessage.liveRevenueCampaignVip_);
                    int i5 = this.roomType_;
                    boolean z6 = i5 != 0;
                    int i6 = liveChatMessage.roomType_;
                    this.roomType_ = interfaceC3386h.mo16996e(z6, i5, i6 != 0, i6);
                    this.extInfo_ = (LiveChatMessageExtInfo) interfaceC3386h.mo17006o(this.extInfo_, liveChatMessage.extInfo_);
                    this.chatShadingConfig_ = (LiveChatShadingConfig) interfaceC3386h.mo17006o(this.chatShadingConfig_, liveChatMessage.chatShadingConfig_);
                    this.fakeId_ = interfaceC3386h.mo16997f(!this.fakeId_.isEmpty(), this.fakeId_, !liveChatMessage.fakeId_.isEmpty(), liveChatMessage.fakeId_);
                    this.msgId_ = interfaceC3386h.mo16997f(!this.msgId_.isEmpty(), this.msgId_, !liveChatMessage.msgId_.isEmpty(), liveChatMessage.msgId_);
                    this.fakeName_ = interfaceC3386h.mo16997f(!this.fakeName_.isEmpty(), this.fakeName_, !liveChatMessage.fakeName_.isEmpty(), liveChatMessage.fakeName_);
                    this.anchorId_ = interfaceC3386h.mo16997f(!this.anchorId_.isEmpty(), this.anchorId_, !liveChatMessage.anchorId_.isEmpty(), liveChatMessage.anchorId_);
                    this.giftTargetUserId_ = interfaceC3386h.mo16997f(!this.giftTargetUserId_.isEmpty(), this.giftTargetUserId_, !liveChatMessage.giftTargetUserId_.isEmpty(), liveChatMessage.giftTargetUserId_);
                    this.sharedVoiceLiveInfo_ = (SharedVoiceLiveInfo) interfaceC3386h.mo17006o(this.sharedVoiceLiveInfo_, liveChatMessage.sharedVoiceLiveInfo_);
                    this.liveMode_ = interfaceC3386h.mo16997f(!this.liveMode_.isEmpty(), this.liveMode_, !liveChatMessage.liveMode_.isEmpty(), liveChatMessage.liveMode_);
                    this.templateType_ = interfaceC3386h.mo16997f(!this.templateType_.isEmpty(), this.templateType_, !liveChatMessage.templateType_.isEmpty(), liveChatMessage.templateType_);
                    long j5 = this.preSeq_;
                    boolean z7 = j5 != 0;
                    long j6 = liveChatMessage.preSeq_;
                    this.preSeq_ = interfaceC3386h.mo17000i(z7, j5, j6 != 0, j6);
                    long j7 = this.preTimestamp_;
                    boolean z8 = j7 != 0;
                    long j8 = liveChatMessage.preTimestamp_;
                    this.preTimestamp_ = interfaceC3386h.mo17000i(z8, j7, j8 != 0, j8);
                    this.userIdentity_ = interfaceC3386h.mo16997f(!this.userIdentity_.isEmpty(), this.userIdentity_, !liveChatMessage.userIdentity_.isEmpty(), liveChatMessage.userIdentity_);
                    this.source_ = interfaceC3386h.mo16997f(!this.source_.isEmpty(), this.source_, !liveChatMessage.source_.isEmpty(), liveChatMessage.source_);
                    this.starlightHierarchy_ = (HierarchyMessage) interfaceC3386h.mo17006o(this.starlightHierarchy_, liveChatMessage.starlightHierarchy_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 66:
                                    ...
                                    GiftMessage giftMessage2 = (GiftMessage) c3407e.m17143w(GiftMessage.parser(), c3410h);
                                ...
                                case EACTags.FCP_TEMPLATE /* 98 */:
                                    ...
                                    MedalMessage medalMessage2 = (MedalMessage) c3407e.m17143w(MedalMessage.parser(), c3410h);
                                    ...
                                    break;
                                case 104:
                                    this.createdTime_ = c3407e.m17142v();
                                    continue;
                                case 114:
                                    ...
                                    HierarchyMessage hierarchyMessage2 = (HierarchyMessage) c3407e.m17143w(HierarchyMessage.parser(), c3410h);
                                ...
                                case 122:
                                    ...
                                    LiveRevenueCampaignVip liveRevenueCampaignVip2 = (LiveRevenueCampaignVip) c3407e.m17143w(LiveRevenueCampaignVip.parser(), c3410h);
                                ...
                                case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                                    ...
                                    LiveChatMessageExtInfo liveChatMessageExtInfo2 = (LiveChatMessageExtInfo) c3407e.m17143w(LiveChatMessageExtInfo.parser(), c3410h);
                                ...
                                case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                                    ...
                                    LiveChatShadingConfig liveChatShadingConfig2 = (LiveChatShadingConfig) c3407e.m17143w(LiveChatShadingConfig.parser(), c3410h);
                                ...
                                case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                                    this.fakeName_ = c3407e.m17115L();
                                    continue;
                                case 178:
                                    this.anchorId_ = c3407e.m17115L();
                                    continue;
                                case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                                    this.giftTargetUserId_ = c3407e.m17115L();
                                    continue;
                                case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                                    ...
                                    SharedVoiceLiveInfo sharedVoiceLiveInfo2 = (SharedVoiceLiveInfo) c3407e.m17143w(SharedVoiceLiveInfo.parser(), c3410h);
                                ...
                                case 202:
                                    ...
                                    continue;
                                case 210:
                                    this.templateType_ = c3407e.m17115L();
                                    continue;
                                case 216:
                                    this.preSeq_ = c3407e.m17118O();
                                    continue;
                                case 224:
                                    this.preTimestamp_ = c3407e.m17142v();
                                    continue;
                                case 234:
                                    this.userIdentity_ = c3407e.m17115L();
                                    continue;
                                case 258:
                                ...
                                case 266:
                                    ...
                                    HierarchyMessage hierarchyMessage4 = (HierarchyMessage) c3407e.m17143w(HierarchyMessage.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (!this.value_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getValue());
            }
            if (this.action_ != Action.DEFAULT.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(7, this.action_);
            }
            if (this.gift_ != null) {
                iM16901K += CodedOutputStream.m16893C(8, getGift());
            }
            if (!this.h5_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(9, getH5());
            }
            if (this.template_ != null) {
                iM16901K += CodedOutputStream.m16893C(10, getTemplate());
            }
            if (!this.liveId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(11, getLiveId());
            }
            if (this.medal_ != null) {
                iM16901K += CodedOutputStream.m16893C(12, getMedal());
            }
            ...
            if (this.hierarchy_ != null) {
                iM16901K += CodedOutputStream.m16893C(14, getHierarchy());
            }
            if (this.liveRevenueCampaignVip_ != null) {
                iM16901K += CodedOutputStream.m16893C(15, getLiveRevenueCampaignVip());
            }
            if (this.roomType_ != RoomType.video.getNumber()) {
                iM16901K += CodedOutputStream.m16922m(16, this.roomType_);
            }
            if (this.extInfo_ != null) {
                iM16901K += CodedOutputStream.m16893C(17, getExtInfo());
            }
            if (this.chatShadingConfig_ != null) {
                iM16901K += CodedOutputStream.m16893C(18, getChatShadingConfig());
            }
            if (!this.fakeId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(19, getFakeId());
            }
            if (!this.msgId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(20, getMsgId());
            }
            if (!this.fakeName_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(21, getFakeName());
            }
            if (!this.anchorId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(22, getAnchorId());
            }
            if (!this.giftTargetUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(23, getGiftTargetUserId());
            }
            if (this.sharedVoiceLiveInfo_ != null) {
                iM16901K += CodedOutputStream.m16893C(24, getSharedVoiceLiveInfo());
            }
            if (!this.liveMode_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(25, getLiveMode());
            }
            if (!this.templateType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(26, getTemplateType());
            }
            long j3 = this.preSeq_;
            if (j3 != 0) {
                iM16901K += CodedOutputStream.m16906P(27, j3);
            }
            long j4 = this.preTimestamp_;
            if (j4 != 0) {
                iM16901K += CodedOutputStream.m16931v(28, j4);
            }
            if (!this.userIdentity_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(29, getUserIdentity());
            }
            if (!this.source_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(32, getSource());
            }
            if (this.starlightHierarchy_ != null) {
                iM16901K += CodedOutputStream.m16893C(33, getStarlightHierarchy());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.value_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getValue());
            }
            if (this.action_ != Action.DEFAULT.getNumber()) {
                codedOutputStream.m16960i0(7, this.action_);
            }
            if (this.gift_ != null) {
                codedOutputStream.mo16974w0(8, getGift());
            }
            if (!this.h5_.isEmpty()) {
                codedOutputStream.mo16939D0(9, getH5());
            }
            if (this.template_ != null) {
                codedOutputStream.mo16974w0(10, getTemplate());
            }
            if (!this.liveId_.isEmpty()) {
                codedOutputStream.mo16939D0(11, getLiveId());
            }
            if (this.medal_ != null) {
                codedOutputStream.mo16974w0(12, getMedal());
            }
            long j2 = this.createdTime_;
            if (j2 != 0) {
            ...
            if (this.hierarchy_ != null) {
                codedOutputStream.mo16974w0(14, getHierarchy());
            }
            if (this.liveRevenueCampaignVip_ != null) {
                codedOutputStream.mo16974w0(15, getLiveRevenueCampaignVip());
            }
            if (this.roomType_ != RoomType.video.getNumber()) {
                codedOutputStream.m16960i0(16, this.roomType_);
            }
            if (this.extInfo_ != null) {
                codedOutputStream.mo16974w0(17, getExtInfo());
            }
            if (this.chatShadingConfig_ != null) {
                codedOutputStream.mo16974w0(18, getChatShadingConfig());
            }
            if (!this.fakeId_.isEmpty()) {
                codedOutputStream.mo16939D0(19, getFakeId());
            }
            if (!this.msgId_.isEmpty()) {
                codedOutputStream.mo16939D0(20, getMsgId());
            }
            if (!this.fakeName_.isEmpty()) {
                codedOutputStream.mo16939D0(21, getFakeName());
            }
            if (!this.anchorId_.isEmpty()) {
                codedOutputStream.mo16939D0(22, getAnchorId());
            }
            if (!this.giftTargetUserId_.isEmpty()) {
                codedOutputStream.mo16939D0(23, getGiftTargetUserId());
            }
            if (this.sharedVoiceLiveInfo_ != null) {
                codedOutputStream.mo16974w0(24, getSharedVoiceLiveInfo());
            }
            if (!this.liveMode_.isEmpty()) {
                codedOutputStream.mo16939D0(25, getLiveMode());
            }
            if (!this.templateType_.isEmpty()) {
                codedOutputStream.mo16939D0(26, getTemplateType());
            }
            long j3 = this.preSeq_;
            if (j3 != 0) {
                codedOutputStream.mo16944I0(27, j3);
            }
            long j4 = this.preTimestamp_;
            if (j4 != 0) {
                codedOutputStream.m16972u0(28, j4);
            }
            if (!this.userIdentity_.isEmpty()) {
                codedOutputStream.mo16939D0(29, getUserIdentity());
            }
            if (!this.source_.isEmpty()) {
                codedOutputStream.mo16939D0(32, getSource());
            }
            if (this.starlightHierarchy_ != null) {
                codedOutputStream.mo16974w0(33, getStarlightHierarchy());
            }
        }

        public static LiveChatMessage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveChatMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveChatMessage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveChatMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveChatMessage, Builder> implements LiveChatMessageOrBuilder {
            private Builder() {
        ...
        public static LiveChatMessage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveChatMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveChatMessage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveChatMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveChatMessage parseFrom(C3407e c3407e) throws IOException {
            return (LiveChatMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveChatMessage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveChatMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class LiveChatMessageExtInfo extends GeneratedMessageLite<LiveChatMessageExtInfo, Builder> implements LiveChatMessageExtInfoOrBuilder {
        ...
        private C3414l.h<AtUserInfo> atUserInfos_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllAtUserInfos(Iterable<? extends AtUserInfo> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.atUserInfos_);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.imageUrl_ = interfaceC3386h.mo16997f(!this.imageUrl_.isEmpty(), this.imageUrl_, !liveChatMessageExtInfo.imageUrl_.isEmpty(), liveChatMessageExtInfo.imageUrl_);
                    this.senderCityID_ = interfaceC3386h.mo16997f(!this.senderCityID_.isEmpty(), this.senderCityID_, !liveChatMessageExtInfo.senderCityID_.isEmpty(), liveChatMessageExtInfo.senderCityID_);
                    this.mask_ = (Mask) interfaceC3386h.mo17006o(this.mask_, liveChatMessageExtInfo.mask_);
                    boolean z = this.maskMode_;
                    boolean z2 = liveChatMessageExtInfo.maskMode_;
                    this.maskMode_ = interfaceC3386h.mo16995d(z, z, z2, z2);
                    this.userMask_ = (userMaskConfig.UserMask) interfaceC3386h.mo17006o(this.userMask_, liveChatMessageExtInfo.userMask_);
                    boolean z3 = this.groupControl_;
                    boolean z4 = liveChatMessageExtInfo.groupControl_;
                    this.groupControl_ = interfaceC3386h.mo16995d(z3, z3, z4, z4);
                    this.groupType_ = interfaceC3386h.mo16997f(!this.groupType_.isEmpty(), this.groupType_, !liveChatMessageExtInfo.groupType_.isEmpty(), liveChatMessageExtInfo.groupType_);
                    this.atUserInfos_ = interfaceC3386h.mo16998g(this.atUserInfos_, liveChatMessageExtInfo.atUserInfos_);
                    this.sharedVoiceRoomID_ = interfaceC3386h.mo16997f(!this.sharedVoiceRoomID_.isEmpty(), this.sharedVoiceRoomID_, !liveChatMessageExtInfo.sharedVoiceRoomID_.isEmpty(), liveChatMessageExtInfo.sharedVoiceRoomID_);
                    this.traceInfo_ = interfaceC3386h.mo16997f(!this.traceInfo_.isEmpty(), this.traceInfo_, true ^ liveChatMessageExtInfo.traceInfo_.isEmpty(), liveChatMessageExtInfo.traceInfo_);
                    boolean z5 = this.colorfulMode_;
                    boolean z6 = liveChatMessageExtInfo.colorfulMode_;
                    this.colorfulMode_ = interfaceC3386h.mo16995d(z5, z5, z6, z6);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 10:
                                    ...
                                    continue;
                                case 18:
                                    this.senderCityID_ = c3407e.m17115L();
                                    continue;
                                case 26:
                                ...
                                case 50:
                                    ...
                                    break;
                                case 56:
                                    this.groupControl_ = c3407e.m17133m();
                                    continue;
                                case 66:
                                    this.groupType_ = c3407e.m17115L();
                                    continue;
                                case 74:
                                    if (!this.atUserInfos_.mo17085q()) {
                                        this.atUserInfos_ = GeneratedMessageLite.mutableCopy(this.atUserInfos_);
                                    }
                                    this.atUserInfos_.add((AtUserInfo) c3407e.m17143w(AtUserInfo.parser(), c3410h));
                                    continue;
                                case EACTags.COMMAND_TO_PERFORM /* 82 */:
                                    this.sharedVoiceRoomID_ = c3407e.m17115L();
                                    continue;
                                case 90:
                                    this.traceInfo_ = c3407e.m17115L();
                                    continue;
                                case Opcodes.IADD /* 96 */:
                                    this.colorfulMode_ = c3407e.m17133m();
                                    continue;
                                default:
                                    if (!c3407e.m17121R(iM17116M)) {
                                        break;
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.imageUrl_.isEmpty() ? CodedOutputStream.m16901K(1, getImageUrl()) : 0;
            if (!this.senderCityID_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getSenderCityID());
            }
            if (this.mask_ != null) {
            ...
            if (this.userMask_ != null) {
                iM16901K += CodedOutputStream.m16893C(6, getUserMask());
            }
            ...
            if (!this.groupType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(8, getGroupType());
            }
            for (int i2 = 0; i2 < this.atUserInfos_.size(); i2++) {
                iM16901K += CodedOutputStream.m16893C(9, this.atUserInfos_.get(i2));
            }
            if (!this.sharedVoiceRoomID_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(10, getSharedVoiceRoomID());
            }
            if (!this.traceInfo_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(11, getTraceInfo());
            }
            boolean z3 = this.colorfulMode_;
            if (z3) {
                iM16901K += CodedOutputStream.m16915f(12, z3);
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.imageUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getImageUrl());
            }
            if (!this.senderCityID_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getSenderCityID());
            }
            if (this.mask_ != null) {
            ...
            if (this.userMask_ != null) {
                codedOutputStream.mo16974w0(6, getUserMask());
            }
            boolean z2 = this.groupControl_;
            if (z2) {
            ...
            if (!this.groupType_.isEmpty()) {
                codedOutputStream.mo16939D0(8, getGroupType());
            }
            for (int i = 0; i < this.atUserInfos_.size(); i++) {
                codedOutputStream.mo16974w0(9, this.atUserInfos_.get(i));
            }
            if (!this.sharedVoiceRoomID_.isEmpty()) {
                codedOutputStream.mo16939D0(10, getSharedVoiceRoomID());
            }
            if (!this.traceInfo_.isEmpty()) {
                codedOutputStream.mo16939D0(11, getTraceInfo());
            }
            boolean z3 = this.colorfulMode_;
            if (z3) {
                codedOutputStream.mo16950a0(12, z3);
            }
        }

        public static LiveChatMessageExtInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveChatMessageExtInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveChatMessageExtInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveChatMessageExtInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveChatMessageExtInfo, Builder> implements LiveChatMessageExtInfoOrBuilder {
            private Builder() {
        ...
        public static LiveChatMessageExtInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveChatMessageExtInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveChatMessageExtInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveChatMessageExtInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveChatMessageExtInfo parseFrom(C3407e c3407e) throws IOException {
            return (LiveChatMessageExtInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveChatMessageExtInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveChatMessageExtInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public enum LiveChatMessageType implements C3414l.c {
        TEXT(0),
        GIFT(1),
        BULLETCOMMENT(2),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<LiveChatMessageType> internalValueMap = new C3414l.d<LiveChatMessageType>() { // from class: com.p1.mobile.longlink.msg.livechat.LongLinkChatMessage.LiveChatMessageType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<LiveChatMessageType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class LiveChatShadingConfig extends GeneratedMessageLite<LiveChatShadingConfig, Builder> implements LiveChatShadingConfigOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.borderColorConfig_ = (LiveBackgroundColorConfig) interfaceC3386h.mo17006o(this.borderColorConfig_, liveChatShadingConfig.borderColorConfig_);
                    this.backgroundColorConfig_ = (LiveBackgroundColorConfig) interfaceC3386h.mo17006o(this.backgroundColorConfig_, liveChatShadingConfig.backgroundColorConfig_);
                    this.cornerConfig_ = (LiveCornerConfig) interfaceC3386h.mo17006o(this.cornerConfig_, liveChatShadingConfig.cornerConfig_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    LiveBackgroundColorConfig liveBackgroundColorConfig2 = (LiveBackgroundColorConfig) c3407e.m17143w(LiveBackgroundColorConfig.parser(), c3410h);
                                    ...
                                    LiveBackgroundColorConfig liveBackgroundColorConfig4 = (LiveBackgroundColorConfig) c3407e.m17143w(LiveBackgroundColorConfig.parser(), c3410h);
                                    ...
                                    LiveCornerConfig liveCornerConfig2 = (LiveCornerConfig) c3407e.m17143w(LiveCornerConfig.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            int iM16893C = this.borderColorConfig_ != null ? CodedOutputStream.m16893C(1, getBorderColorConfig()) : 0;
            if (this.backgroundColorConfig_ != null) {
                iM16893C += CodedOutputStream.m16893C(2, getBackgroundColorConfig());
            }
            if (this.cornerConfig_ != null) {
                iM16893C += CodedOutputStream.m16893C(3, getCornerConfig());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.borderColorConfig_ != null) {
                codedOutputStream.mo16974w0(1, getBorderColorConfig());
            }
            if (this.backgroundColorConfig_ != null) {
                codedOutputStream.mo16974w0(2, getBackgroundColorConfig());
            }
            if (this.cornerConfig_ != null) {
                codedOutputStream.mo16974w0(3, getCornerConfig());
            }
        }

        public static LiveChatShadingConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveChatShadingConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveChatShadingConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveChatShadingConfig, Builder> implements LiveChatShadingConfigOrBuilder {
            private Builder() {
        ...
        public static LiveChatShadingConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveChatShadingConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveChatShadingConfig parseFrom(C3407e c3407e) throws IOException {
            return (LiveChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveChatShadingConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveChatShadingConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class LiveCornerConfig extends GeneratedMessageLite<LiveCornerConfig, Builder> implements LiveCornerConfigOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveCornerConfig, Builder> implements LiveCornerConfigOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.pictureUrl_ = interfaceC3386h.mo16997f(!this.pictureUrl_.isEmpty(), this.pictureUrl_, !liveCornerConfig.pictureUrl_.isEmpty(), liveCornerConfig.pictureUrl_);
        ...
        public static LiveCornerConfig parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveCornerConfig) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveCornerConfig parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveCornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static LiveCornerConfig parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveCornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveCornerConfig parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveCornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveCornerConfig parseFrom(C3407e c3407e) throws IOException {
            return (LiveCornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveCornerConfig parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveCornerConfig) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class LiveRevenueCampaignVip extends GeneratedMessageLite<LiveRevenueCampaignVip, Builder> implements LiveRevenueCampaignVipOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<LiveRevenueCampaignVip, Builder> implements LiveRevenueCampaignVipOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.isVip_ = ((GeneratedMessageLite.InterfaceC3386h) obj).mo16995d(z, z, z2, z2);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public static LiveRevenueCampaignVip parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveRevenueCampaignVip) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveRevenueCampaignVip parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveRevenueCampaignVip) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static LiveRevenueCampaignVip parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (LiveRevenueCampaignVip) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static LiveRevenueCampaignVip parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (LiveRevenueCampaignVip) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static LiveRevenueCampaignVip parseFrom(C3407e c3407e) throws IOException {
            return (LiveRevenueCampaignVip) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static LiveRevenueCampaignVip parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (LiveRevenueCampaignVip) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Medal extends GeneratedMessageLite<Medal, Builder> implements MedalOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Medal, Builder> implements MedalOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !medal.id_.isEmpty(), medal.id_);
                    long j = this.fanbaseGrade_;
                    boolean z2 = j != 0;
                    long j2 = medal.fanbaseGrade_;
                    this.fanbaseGrade_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    long j3 = this.familyGrade_;
                    boolean z3 = j3 != 0;
                    long j4 = medal.familyGrade_;
                    this.familyGrade_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                    this.familyText_ = interfaceC3386h.mo16997f(!this.familyText_.isEmpty(), this.familyText_, !medal.familyText_.isEmpty(), medal.familyText_);
                    long j5 = this.voiceFanbaseGrade_;
                    boolean z4 = j5 != 0;
                    long j6 = medal.voiceFanbaseGrade_;
                    this.voiceFanbaseGrade_ = interfaceC3386h.mo17000i(z4, j5, j6 != 0, j6);
                    this.voiceFanbaseColor_ = interfaceC3386h.mo16997f(!this.voiceFanbaseColor_.isEmpty(), this.voiceFanbaseColor_, !medal.voiceFanbaseColor_.isEmpty(), medal.voiceFanbaseColor_);
                    this.voiceFanbaseText_ = interfaceC3386h.mo16997f(!this.voiceFanbaseText_.isEmpty(), this.voiceFanbaseText_, !medal.voiceFanbaseText_.isEmpty(), medal.voiceFanbaseText_);
                    boolean z5 = this.familyLight_;
                    boolean z6 = medal.familyLight_;
                    this.familyLight_ = interfaceC3386h.mo16995d(z5, z5, z6, z6);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.fanbaseGrade_ = c3407e.m17142v();
                                } else if (iM17116M == 24) {
                                    this.familyGrade_ = c3407e.m17142v();
                                } else if (iM17116M == 34) {
                                    this.familyText_ = c3407e.m17115L();
                                } else if (iM17116M == 40) {
                                    this.voiceFanbaseGrade_ = c3407e.m17142v();
                                } else if (iM17116M == 50) {
                                    this.voiceFanbaseColor_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    this.voiceFanbaseText_ = c3407e.m17115L();
                                } else if (iM17116M == 64) {
                                    this.familyLight_ = c3407e.m17133m();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            if (!this.familyText_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getFamilyText());
            }
            long j3 = this.voiceFanbaseGrade_;
            if (j3 != 0) {
                iM16901K += CodedOutputStream.m16931v(5, j3);
            }
            if (!this.voiceFanbaseColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getVoiceFanbaseColor());
            }
            if (!this.voiceFanbaseText_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getVoiceFanbaseText());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.familyText_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getFamilyText());
            }
            long j3 = this.voiceFanbaseGrade_;
            if (j3 != 0) {
            ...
            if (!this.voiceFanbaseColor_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getVoiceFanbaseColor());
            }
            if (!this.voiceFanbaseText_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getVoiceFanbaseText());
            }
            boolean z = this.familyLight_;
            if (z) {
        ...
        public static Medal parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Medal) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Medal parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Medal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Medal parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Medal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Medal parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Medal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Medal parseFrom(C3407e c3407e) throws IOException {
            return (Medal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Medal parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Medal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class MedalMessage extends GeneratedMessageLite<MedalMessage, Builder> implements MedalMessageOrBuilder {
        ...
        private int bitField0_;
        private C3414l.h<String> ids_ = GeneratedMessageLite.emptyProtobufList();
        private String version_ = "";
        private C3414l.h<Medal> singleRoomMedals_ = GeneratedMessageLite.emptyProtobufList();
        private C3414l.h<Medal> multiRoomMedals_ = GeneratedMessageLite.emptyProtobufList();
        ...
        private void ensureMultiRoomMedalsIsMutable() {
            if (this.multiRoomMedals_.mo17085q()) {
                return;
            }
        ...
        private void ensureSingleRoomMedalsIsMutable() {
            if (this.singleRoomMedals_.mo17085q()) {
                return;
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 3:
                    this.ids_.mo17084n();
                    this.singleRoomMedals_.mo17084n();
                    this.multiRoomMedals_.mo17084n();
                    return null;
                case 4:
                    return new Builder();
                case 5:
                    ...
                    this.ids_ = interfaceC3386h.mo16998g(this.ids_, medalMessage.ids_);
                    this.version_ = interfaceC3386h.mo16997f(!this.version_.isEmpty(), this.version_, true ^ medalMessage.version_.isEmpty(), medalMessage.version_);
                    this.singleRoomMedals_ = interfaceC3386h.mo16998g(this.singleRoomMedals_, medalMessage.singleRoomMedals_);
                    this.multiRoomMedals_ = interfaceC3386h.mo16998g(this.multiRoomMedals_, medalMessage.multiRoomMedals_);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.singleRoomMedals_.add((Medal) c3407e.m17143w(Medal.parser(), c3410h));
                                } else if (iM17116M == 34) {
                                    if (!this.multiRoomMedals_.mo17085q()) {
                                        this.multiRoomMedals_ = GeneratedMessageLite.mutableCopy(this.multiRoomMedals_);
                                    }
                                    this.multiRoomMedals_.add((Medal) c3407e.m17143w(Medal.parser(), c3410h));
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.ids_.size(); i2++) {
                iM16902L += CodedOutputStream.m16902L(this.ids_.get(i2));
            }
            int size = iM16902L + getIdsList().size();
            if (!this.version_.isEmpty()) {
                size += CodedOutputStream.m16901K(2, getVersion());
            }
            for (int i3 = 0; i3 < this.singleRoomMedals_.size(); i3++) {
                size += CodedOutputStream.m16893C(3, this.singleRoomMedals_.get(i3));
            }
            for (int i4 = 0; i4 < this.multiRoomMedals_.size(); i4++) {
                size += CodedOutputStream.m16893C(4, this.multiRoomMedals_.get(i4));
            }
            this.memoizedSerializedSize = size;
            return size;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            for (int i = 0; i < this.ids_.size(); i++) {
                codedOutputStream.mo16939D0(1, this.ids_.get(i));
            }
            if (!this.version_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getVersion());
            }
            for (int i2 = 0; i2 < this.singleRoomMedals_.size(); i2++) {
                codedOutputStream.mo16974w0(3, this.singleRoomMedals_.get(i2));
            }
            for (int i3 = 0; i3 < this.multiRoomMedals_.size(); i3++) {
                codedOutputStream.mo16974w0(4, this.multiRoomMedals_.get(i3));
            }
        }

        public static MedalMessage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (MedalMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static MedalMessage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (MedalMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<MedalMessage, Builder> implements MedalMessageOrBuilder {
            private Builder() {
        ...
        public static MedalMessage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (MedalMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static MedalMessage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (MedalMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static MedalMessage parseFrom(C3407e c3407e) throws IOException {
            return (MedalMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static MedalMessage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (MedalMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public static final class PostMessageAck extends GeneratedMessageLite<PostMessageAck, Builder> implements PostMessageAckOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.codeMessage_ = interfaceC3386h.mo16997f(!this.codeMessage_.isEmpty(), this.codeMessage_, !postMessageAck.codeMessage_.isEmpty(), postMessageAck.codeMessage_);
                    this.message_ = (LiveChatMessage) interfaceC3386h.mo17006o(this.message_, postMessageAck.message_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.codeMessage_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.code_ != PostMessageCode.POST_CODE_PLACEHOLDER.getNumber() ? CodedOutputStream.m16922m(1, this.code_) : 0;
            if (!this.codeMessage_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getCodeMessage());
            }
            if (this.message_ != null) {
                iM16922m += CodedOutputStream.m16893C(3, getMessage());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.codeMessage_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getCodeMessage());
            }
            if (this.message_ != null) {
                codedOutputStream.mo16974w0(3, getMessage());
            }
        }

        public static PostMessageAck parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (PostMessageAck) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static PostMessageAck parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (PostMessageAck) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<PostMessageAck, Builder> implements PostMessageAckOrBuilder {
            private Builder() {
        ...
        public static PostMessageAck parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (PostMessageAck) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static PostMessageAck parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (PostMessageAck) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static PostMessageAck parseFrom(C3407e c3407e) throws IOException {
            return (PostMessageAck) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static PostMessageAck parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (PostMessageAck) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum PostMessageCode implements C3414l.c {
        ...
        private static final C3414l.d<PostMessageCode> internalValueMap = new C3414l.d<PostMessageCode>() { // from class: com.p1.mobile.longlink.msg.livechat.LongLinkChatMessage.PostMessageCode.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<PostMessageCode> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum PredefineMessageType implements C3414l.c {
        PLACEHOLDER(0),
        OPENLIVE_NOTICE(1),
        ENTERROOM_NOTICE(2),
        UNRECOGNIZED(-1);
        ...
        private static final C3414l.d<PredefineMessageType> internalValueMap = new C3414l.d<PredefineMessageType>() { // from class: com.p1.mobile.longlink.msg.livechat.LongLinkChatMessage.PredefineMessageType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<PredefineMessageType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public enum RoomType implements C3414l.c {
        video(0),
        voice(1),
        text(2),
        guild(3),
        ...
        private static final C3414l.d<RoomType> internalValueMap = new C3414l.d<RoomType>() { // from class: com.p1.mobile.longlink.msg.livechat.LongLinkChatMessage.RoomType.1
            @Override // com.google.protobuf.C3414l.d
        ...
        public static C3414l.d<RoomType> internalGetValueMap() {
            return internalValueMap;
        }
    ...
    public static final class SharedVoiceLiveInfo extends GeneratedMessageLite<SharedVoiceLiveInfo, Builder> implements SharedVoiceLiveInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<SharedVoiceLiveInfo, Builder> implements SharedVoiceLiveInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !sharedVoiceLiveInfo.roomId_.isEmpty(), sharedVoiceLiveInfo.roomId_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !sharedVoiceLiveInfo.liveId_.isEmpty(), sharedVoiceLiveInfo.liveId_);
                    this.description_ = interfaceC3386h.mo16997f(!this.description_.isEmpty(), this.description_, !sharedVoiceLiveInfo.description_.isEmpty(), sharedVoiceLiveInfo.description_);
                    int i = this.audienceCount_;
                    boolean z2 = i != 0;
                    int i2 = sharedVoiceLiveInfo.audienceCount_;
                    this.audienceCount_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    int i3 = this.voiceCallCount_;
                    boolean z3 = i3 != 0;
                    int i4 = sharedVoiceLiveInfo.voiceCallCount_;
                    this.voiceCallCount_ = interfaceC3386h.mo16996e(z3, i3, i4 != 0, i4);
                    this.anchorId_ = interfaceC3386h.mo16997f(!this.anchorId_.isEmpty(), this.anchorId_, !sharedVoiceLiveInfo.anchorId_.isEmpty(), sharedVoiceLiveInfo.anchorId_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.description_ = c3407e.m17115L();
                                } else if (iM17116M == 32) {
                                    this.audienceCount_ = c3407e.m17141u();
                                } else if (iM17116M == 40) {
                                    this.voiceCallCount_ = c3407e.m17141u();
                                } else if (iM17116M == 50) {
                                    this.anchorId_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
        ...
        public int getSerializedSize() {
            ...
            if (!this.description_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getDescription());
            }
            ...
            int i3 = this.voiceCallCount_;
            if (i3 != 0) {
                iM16901K += CodedOutputStream.m16929t(5, i3);
            }
            if (!this.anchorId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getAnchorId());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.description_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getDescription());
            }
            int i = this.audienceCount_;
            if (i != 0) {
            ...
            if (i2 != 0) {
                codedOutputStream.mo16970s0(5, i2);
            }
            if (this.anchorId_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(6, getAnchorId());
        }

        public static SharedVoiceLiveInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (SharedVoiceLiveInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static SharedVoiceLiveInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (SharedVoiceLiveInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static SharedVoiceLiveInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (SharedVoiceLiveInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static SharedVoiceLiveInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (SharedVoiceLiveInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static SharedVoiceLiveInfo parseFrom(C3407e c3407e) throws IOException {
            return (SharedVoiceLiveInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static SharedVoiceLiveInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (SharedVoiceLiveInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class UserMedal extends GeneratedMessageLite<UserMedal, Builder> implements UserMedalOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserMedal, Builder> implements UserMedalOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.ids_ = interfaceC3386h.mo16998g(this.ids_, userMedal.ids_);
                    this.version_ = interfaceC3386h.mo16997f(!this.version_.isEmpty(), this.version_, true ^ userMedal.version_.isEmpty(), userMedal.version_);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
        ...
        public static UserMedal parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserMedal) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserMedal parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserMedal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static UserMedal parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserMedal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserMedal parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserMedal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserMedal parseFrom(C3407e c3407e) throws IOException {
            return (UserMedal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserMedal parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserMedal) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class VoiceLiveMaskModeFollowApplyInfo extends GeneratedMessageLite<VoiceLiveMaskModeFollowApplyInfo, Builder> implements VoiceLiveMaskModeFollowApplyInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<VoiceLiveMaskModeFollowApplyInfo, Builder> implements VoiceLiveMaskModeFollowApplyInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44401.f15955xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !voiceLiveMaskModeFollowApplyInfo.roomId_.isEmpty(), voiceLiveMaskModeFollowApplyInfo.roomId_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !voiceLiveMaskModeFollowApplyInfo.liveId_.isEmpty(), voiceLiveMaskModeFollowApplyInfo.liveId_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !voiceLiveMaskModeFollowApplyInfo.userId_.isEmpty(), voiceLiveMaskModeFollowApplyInfo.userId_);
                    this.otherUserId_ = interfaceC3386h.mo16997f(!this.otherUserId_.isEmpty(), this.otherUserId_, true ^ voiceLiveMaskModeFollowApplyInfo.otherUserId_.isEmpty(), voiceLiveMaskModeFollowApplyInfo.otherUserId_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            if (!this.otherUserId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getOtherUserId());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.mo16939D0(4, getOtherUserId());
        }

        public static VoiceLiveMaskModeFollowApplyInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveMaskModeFollowApplyInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveMaskModeFollowApplyInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveMaskModeFollowApplyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static VoiceLiveMaskModeFollowApplyInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (VoiceLiveMaskModeFollowApplyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static VoiceLiveMaskModeFollowApplyInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (VoiceLiveMaskModeFollowApplyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static VoiceLiveMaskModeFollowApplyInfo parseFrom(C3407e c3407e) throws IOException {
            return (VoiceLiveMaskModeFollowApplyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static VoiceLiveMaskModeFollowApplyInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (VoiceLiveMaskModeFollowApplyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
