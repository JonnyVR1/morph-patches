package com.p046p1.mobile.longlink.msg.project;
...
public final class LongLinkOmsDialogInfo {
    ...
    public static /* synthetic */ class C45461 {
        ...
        static {
            ...
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15996xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class Constraint extends GeneratedMessageLite<Constraint, Builder> implements ConstraintOrBuilder {
        ...
        private C3414l.f frequency_ = GeneratedMessageLite.emptyIntList();
        private C3414l.g timeRange_ = GeneratedMessageLite.emptyLongList();

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Constraint, Builder> implements ConstraintOrBuilder {
            private Builder() {
        ...
        public void addAllFrequency(Iterable<? extends Integer> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.frequency_);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addAllTimeRange(Iterable<? extends Long> iterable) {
            ensureTimeRangeIsMutable();
            AbstractC3403a.addAll(iterable, this.timeRange_);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addFrequency(int i) {
            ensureFrequencyIsMutable();
            this.frequency_.mo17200T(i);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addTimeRange(long j) {
            ensureTimeRangeIsMutable();
            this.timeRange_.mo17212u(j);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                    return new Constraint();
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    this.frequency_.mo17084n();
                    this.timeRange_.mo17084n();
                    return null;
                case 4:
                    return new Builder();
                case 5:
                    ...
                    this.count_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    int i3 = this.sessionCount_;
                    boolean z3 = i3 != 0;
                    int i4 = constraint.sessionCount_;
                    this.sessionCount_ = interfaceC3386h.mo16996e(z3, i3, i4 != 0, i4);
                    this.frequency_ = interfaceC3386h.mo17005n(this.frequency_, constraint.frequency_);
                    this.timeRange_ = interfaceC3386h.mo17008q(this.timeRange_, constraint.timeRange_);
                    int i5 = this.timePerDay_;
                    boolean z4 = i5 != 0;
                    int i6 = constraint.timePerDay_;
                    this.timePerDay_ = interfaceC3386h.mo16996e(z4, i5, i6 != 0, i6);
                    int i7 = this.priority_;
                    boolean z5 = i7 != 0;
                    int i8 = constraint.priority_;
                    this.priority_ = interfaceC3386h.mo16996e(z5, i7, i8 != 0, i8);
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    this.count_ = c3407e.m17141u();
                                } else if (iM17116M == 16) {
                                    this.sessionCount_ = c3407e.m17141u();
                                } else if (iM17116M == 24) {
                                    if (!this.frequency_.mo17085q()) {
                                        this.frequency_ = GeneratedMessageLite.mutableCopy(this.frequency_);
                                    }
                                    this.frequency_.mo17200T(c3407e.m17141u());
                                } else if (iM17116M == 26) {
                                    int iM17132l = c3407e.m17132l(c3407e.m17107C());
                                    if (!this.frequency_.mo17085q() && c3407e.m17129d() > 0) {
                                        this.frequency_ = GeneratedMessageLite.mutableCopy(this.frequency_);
                                    }
                                    ...
                                    this.timeRange_.mo17212u(c3407e.m17142v());
                                } else if (iM17116M == 34) {
                                    int iM17132l2 = c3407e.m17132l(c3407e.m17107C());
                                    if (!this.timeRange_.mo17085q() && c3407e.m17129d() > 0) {
                                        this.timeRange_ = GeneratedMessageLite.mutableCopy(this.timeRange_);
                                    }
                                    while (c3407e.m17129d() > 0) {
                                        this.timeRange_.mo17212u(c3407e.m17142v());
                                    ...
                                    this.timePerDay_ = c3407e.m17141u();
                                } else if (iM17116M == 48) {
        ...
        public int getSerializedSize() {
            ...
            int i3 = this.sessionCount_;
            if (i3 != 0) {
                iM16929t += CodedOutputStream.m16929t(2, i3);
            }
            int iM16930u = 0;
            for (int i4 = 0; i4 < this.frequency_.size(); i4++) {
                iM16930u += CodedOutputStream.m16930u(this.frequency_.getInt(i4));
            }
            int size = iM16929t + iM16930u + getFrequencyList().size();
            int iM16932w = 0;
            for (int i5 = 0; i5 < this.timeRange_.size(); i5++) {
                iM16932w += CodedOutputStream.m16932w(this.timeRange_.getLong(i5));
            }
            int size2 = size + iM16932w + getTimeRangeList().size();
            int i6 = this.timePerDay_;
            if (i6 != 0) {
                size2 += CodedOutputStream.m16929t(5, i6);
            }
            int i7 = this.priority_;
            if (i7 != 0) {
                size2 += CodedOutputStream.m16929t(6, i7);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (i2 != 0) {
                codedOutputStream.mo16970s0(2, i2);
            }
            for (int i3 = 0; i3 < this.frequency_.size(); i3++) {
                codedOutputStream.mo16970s0(3, this.frequency_.getInt(i3));
            }
            for (int i4 = 0; i4 < this.timeRange_.size(); i4++) {
                codedOutputStream.m16972u0(4, this.timeRange_.getLong(i4));
            }
            int i5 = this.timePerDay_;
            if (i5 != 0) {
                codedOutputStream.mo16970s0(5, i5);
            }
            int i6 = this.priority_;
            if (i6 != 0) {
                codedOutputStream.mo16970s0(6, i6);
            }
        }

        public static Constraint parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Constraint) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Constraint parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Constraint) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Constraint parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Constraint) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Constraint parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Constraint) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Constraint parseFrom(C3407e c3407e) throws IOException {
            return (Constraint) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Constraint parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Constraint) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Content extends GeneratedMessageLite<Content, Builder> implements ContentOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.template_ = (Resource) interfaceC3386h.mo17006o(this.template_, content.template_);
                    this.web_ = (Web) interfaceC3386h.mo17006o(this.web_, content.web_);
                    ByteString byteString = this.morph_;
                    ByteString byteString2 = ByteString.EMPTY;
                    boolean z2 = byteString != byteString2;
                    ByteString byteString3 = content.morph_;
                    this.morph_ = interfaceC3386h.mo16999h(z2, byteString, byteString3 != byteString2, byteString3);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    Web web2 = (Web) c3407e.m17143w(Web.parser(), c3410h);
                                    this.web_ = web2;
                                    if (builder2 != null) {
        ...
        public int getSerializedSize() {
            ...
            if (this.web_ != null) {
                iM16893C += CodedOutputStream.m16893C(2, getWeb());
            }
            if (!this.morph_.isEmpty()) {
                iM16893C += CodedOutputStream.m16918i(3, this.morph_);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.web_ != null) {
                codedOutputStream.mo16974w0(2, getWeb());
            }
            if (this.morph_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16956e0(3, this.morph_);
        }

        public static Content parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Content) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Content parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Content) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Content, Builder> implements ContentOrBuilder {
            private Builder() {
        ...
        public static Content parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Content) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Content parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Content) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Content parseFrom(C3407e c3407e) throws IOException {
            return (Content) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Content parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Content) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Dialog extends GeneratedMessageLite<Dialog, Builder> implements DialogOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !dialog.id_.isEmpty(), dialog.id_);
                    this.identifier_ = interfaceC3386h.mo16997f(!this.identifier_.isEmpty(), this.identifier_, !dialog.identifier_.isEmpty(), dialog.identifier_);
                    int i = this.version_;
                    boolean z2 = i != 0;
                    ...
                    this.remote_ = interfaceC3386h.mo16995d(z3, z3, z4, z4);
                    boolean z5 = this.cancelAble_;
                    boolean z6 = dialog.cancelAble_;
                    this.cancelAble_ = interfaceC3386h.mo16995d(z5, z5, z6, z6);
                    boolean z7 = this.blockCard_;
                    boolean z8 = dialog.blockCard_;
                    this.blockCard_ = interfaceC3386h.mo16995d(z7, z7, z8, z8);
                    this.constraint_ = (Constraint) interfaceC3386h.mo17006o(this.constraint_, dialog.constraint_);
                    this.position_ = (Position) interfaceC3386h.mo17006o(this.position_, dialog.position_);
                    this.mercury_ = (Mercury) interfaceC3386h.mo17006o(this.mercury_, dialog.mercury_);
                    this.contentType_ = interfaceC3386h.mo16997f(!this.contentType_.isEmpty(), this.contentType_, !dialog.contentType_.isEmpty(), dialog.contentType_);
                    this.content_ = (Content) interfaceC3386h.mo17006o(this.content_, dialog.content_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 10:
                                    ...
                                    continue;
                                case 18:
                                    this.identifier_ = c3407e.m17115L();
                                    continue;
                                case 24:
                                    this.version_ = c3407e.m17141u();
                                    continue;
                                case 32:
                                    this.remote_ = c3407e.m17133m();
                                    continue;
                                case 40:
                                    this.cancelAble_ = c3407e.m17133m();
                                    continue;
                                case 48:
                                    this.blockCard_ = c3407e.m17133m();
                                    continue;
                                case 58:
                                    Constraint constraint = this.constraint_;
                                    Constraint.Builder builder = constraint != null ? constraint.toBuilder() : null;
                                    Constraint constraint2 = (Constraint) c3407e.m17143w(Constraint.parser(), c3410h);
                                ...
                                case 66:
                                    ...
                                    Position position2 = (Position) c3407e.m17143w(Position.parser(), c3410h);
                                ...
                                case 74:
                                    ...
                                    Mercury mercury2 = (Mercury) c3407e.m17143w(Mercury.parser(), c3410h);
                                ...
                                case EACTags.COMMAND_TO_PERFORM /* 82 */:
                                    this.contentType_ = c3407e.m17115L();
                                    continue;
                                case 90:
                                    Content content = this.content_;
                                    Content.Builder builder4 = content != null ? content.toBuilder() : null;
                                    Content content2 = (Content) c3407e.m17143w(Content.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (!this.identifier_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getIdentifier());
            }
            ...
            if (z2) {
                iM16901K += CodedOutputStream.m16915f(5, z2);
            }
            boolean z3 = this.blockCard_;
            if (z3) {
                iM16901K += CodedOutputStream.m16915f(6, z3);
            }
            if (this.constraint_ != null) {
                iM16901K += CodedOutputStream.m16893C(7, getConstraint());
            }
            if (this.position_ != null) {
                iM16901K += CodedOutputStream.m16893C(8, getPosition());
            }
            if (this.mercury_ != null) {
                iM16901K += CodedOutputStream.m16893C(9, getMercury());
            }
            if (!this.contentType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(10, getContentType());
            }
            if (this.content_ != null) {
                iM16901K += CodedOutputStream.m16893C(11, getContent());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.identifier_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getIdentifier());
            }
            int i = this.version_;
            if (i != 0) {
            ...
            boolean z2 = this.cancelAble_;
            if (z2) {
                codedOutputStream.mo16950a0(5, z2);
            }
            boolean z3 = this.blockCard_;
            if (z3) {
                codedOutputStream.mo16950a0(6, z3);
            }
            if (this.constraint_ != null) {
                codedOutputStream.mo16974w0(7, getConstraint());
            }
            if (this.position_ != null) {
                codedOutputStream.mo16974w0(8, getPosition());
            }
            if (this.mercury_ != null) {
                codedOutputStream.mo16974w0(9, getMercury());
            }
            if (!this.contentType_.isEmpty()) {
                codedOutputStream.mo16939D0(10, getContentType());
            }
            if (this.content_ != null) {
                codedOutputStream.mo16974w0(11, getContent());
            }
        }

        public static Dialog parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Dialog) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Dialog parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Dialog) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Dialog, Builder> implements DialogOrBuilder {
            private Builder() {
        ...
        public static Dialog parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Dialog) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Dialog parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Dialog) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Dialog parseFrom(C3407e c3407e) throws IOException {
            return (Dialog) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Dialog parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Dialog) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Dialogs extends GeneratedMessageLite<Dialogs, Builder> implements DialogsOrBuilder {
        ...
        private C3414l.h<Dialog> dialogs_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllDialogs(Iterable<? extends Dialog> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.dialogs_);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    this.dialogs_.mo17084n();
                    return null;
                case 4:
                    return new Builder();
                case 5:
                    this.dialogs_ = ((GeneratedMessageLite.InterfaceC3386h) obj).mo16998g(this.dialogs_, ((Dialogs) obj2).dialogs_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.dialogs_.add((Dialog) c3407e.m17143w(Dialog.parser(), c3410h));
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.dialogs_.size(); i2++) {
                iM16893C += CodedOutputStream.m16893C(1, this.dialogs_.get(i2));
            }
            this.memoizedSerializedSize = iM16893C;
            return iM16893C;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            for (int i = 0; i < this.dialogs_.size(); i++) {
                codedOutputStream.mo16974w0(1, this.dialogs_.get(i));
            }
        }

        public static Dialogs parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Dialogs) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Dialogs parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Dialogs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Dialogs, Builder> implements DialogsOrBuilder {
            private Builder() {
        ...
        public static Dialogs parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Dialogs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Dialogs parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Dialogs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Dialogs parseFrom(C3407e c3407e) throws IOException {
            return (Dialogs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Dialogs parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Dialogs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public static final class Layout extends GeneratedMessageLite<Layout, Builder> implements LayoutOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Layout, Builder> implements LayoutOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.type_ = interfaceC3386h.mo16997f(!this.type_.isEmpty(), this.type_, !layout.type_.isEmpty(), layout.type_);
                    double d = this.value_;
                    boolean z2 = d != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
                    double d2 = layout.value_;
                    this.value_ = interfaceC3386h.mo17001j(z2, d, d2 != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, d2);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            if (d != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                iM16901K += CodedOutputStream.m16920k(2, d);
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            double d = this.value_;
            if (d != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                codedOutputStream.m16958g0(2, d);
            }
        }

        public static Layout parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Layout) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Layout parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Layout) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Layout parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Layout) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Layout parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Layout) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Layout parseFrom(C3407e c3407e) throws IOException {
            return (Layout) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Layout parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Layout) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Mercury extends GeneratedMessageLite<Mercury, Builder> implements MercuryOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Mercury, Builder> implements MercuryOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !mercury.id_.isEmpty(), mercury.id_);
                    this.type_ = interfaceC3386h.mo16997f(!this.type_.isEmpty(), this.type_, true ^ mercury.type_.isEmpty(), mercury.type_);
                    this.server_ = interfaceC3386h.mo17003l(this.server_, mercury.internalGetServer());
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    ServerDefaultEntryHolder.defaultEntry.m17280e(this.server_, c3407e, c3410h);
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (Map.Entry<String, String> entry : internalGetServer().entrySet()) {
                iM16901K += ServerDefaultEntryHolder.defaultEntry.m17279a(3, entry.getKey(), entry.getValue());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (Map.Entry<String, String> entry : internalGetServer().entrySet()) {
                ServerDefaultEntryHolder.defaultEntry.m17281f(codedOutputStream, 3, entry.getKey(), entry.getValue());
            }
        }

        public static Mercury parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Mercury) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Mercury parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Mercury) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Mercury parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Mercury) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Mercury parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Mercury) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Mercury parseFrom(C3407e c3407e) throws IOException {
            return (Mercury) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Mercury parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Mercury) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class NodeContent extends GeneratedMessageLite<NodeContent, Builder> implements NodeContentOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<NodeContent, Builder> implements NodeContentOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.value_ = interfaceC3386h.mo16997f(!this.value_.isEmpty(), this.value_, !nodeContent.value_.isEmpty(), nodeContent.value_);
                    this.color_ = interfaceC3386h.mo16997f(!this.color_.isEmpty(), this.color_, !nodeContent.color_.isEmpty(), nodeContent.color_);
                    int i = this.size_;
                    boolean z2 = i != 0;
                    int i2 = nodeContent.size_;
                    this.size_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.font_ = interfaceC3386h.mo16997f(!this.font_.isEmpty(), this.font_, !nodeContent.font_.isEmpty(), nodeContent.font_);
                    this.backgroundColor_ = interfaceC3386h.mo16997f(!this.backgroundColor_.isEmpty(), this.backgroundColor_, !nodeContent.backgroundColor_.isEmpty(), nodeContent.backgroundColor_);
                    boolean z3 = this.strikethrough_;
                    boolean z4 = nodeContent.strikethrough_;
                    this.strikethrough_ = interfaceC3386h.mo16995d(z3, z3, z4, z4);
                    boolean z5 = this.underline_;
                    boolean z6 = nodeContent.underline_;
                    this.underline_ = interfaceC3386h.mo16995d(z5, z5, z6, z6);
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, !nodeContent.url_.isEmpty(), nodeContent.url_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.size_ = c3407e.m17141u();
                                } else if (iM17116M == 34) {
                                    this.font_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
                                    this.backgroundColor_ = c3407e.m17115L();
                                } else if (iM17116M == 48) {
                                    this.strikethrough_ = c3407e.m17133m();
                                } else if (iM17116M == 56) {
                                    this.underline_ = c3407e.m17133m();
                                } else if (iM17116M == 66) {
        ...
        public int getSerializedSize() {
            ...
            if (!this.font_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getFont());
            }
            if (!this.backgroundColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getBackgroundColor());
            }
            boolean z = this.strikethrough_;
            if (z) {
                iM16901K += CodedOutputStream.m16915f(6, z);
            }
            ...
            if (!this.url_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(8, getUrl());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.font_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getFont());
            }
            if (!this.backgroundColor_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getBackgroundColor());
            }
            boolean z = this.strikethrough_;
            if (z) {
            ...
            codedOutputStream.mo16939D0(8, getUrl());
        }

        public static NodeContent parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (NodeContent) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static NodeContent parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (NodeContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static NodeContent parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (NodeContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static NodeContent parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (NodeContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static NodeContent parseFrom(C3407e c3407e) throws IOException {
            return (NodeContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static NodeContent parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (NodeContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Position extends GeneratedMessageLite<Position, Builder> implements PositionOrBuilder {
        ...
        private int bitField0_;
        private String id_ = "";
        private C3414l.h<String> contain_ = GeneratedMessageLite.emptyProtobufList();
        private C3414l.h<String> exclude_ = GeneratedMessageLite.emptyProtobufList();

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Position, Builder> implements PositionOrBuilder {
            private Builder() {
        ...
        public void addAllContain(Iterable<String> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.contain_);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void addAllExclude(Iterable<String> iterable) {
            ensureExcludeIsMutable();
            AbstractC3403a.addAll(iterable, this.exclude_);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    this.contain_.mo17084n();
                    this.exclude_.mo17084n();
                    return null;
                case 4:
                    return new Builder();
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, true ^ position.id_.isEmpty(), position.id_);
                    this.contain_ = interfaceC3386h.mo16998g(this.contain_, position.contain_);
                    this.exclude_ = interfaceC3386h.mo16998g(this.exclude_, position.exclude_);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.contain_.add(strM17115L);
                                } else if (iM17116M == 26) {
                                    String strM17115L2 = c3407e.m17115L();
                                    if (!this.exclude_.mo17085q()) {
                                        this.exclude_ = GeneratedMessageLite.mutableCopy(this.exclude_);
                                    }
                                    this.exclude_.add(strM17115L2);
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.contain_.size(); i2++) {
                iM16902L += CodedOutputStream.m16902L(this.contain_.get(i2));
            }
            int size = iM16901K + iM16902L + getContainList().size();
            int iM16902L2 = 0;
            for (int i3 = 0; i3 < this.exclude_.size(); i3++) {
                iM16902L2 += CodedOutputStream.m16902L(this.exclude_.get(i3));
            }
            int size2 = size + iM16902L2 + getExcludeList().size();
            this.memoizedSerializedSize = size2;
            return size2;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i = 0; i < this.contain_.size(); i++) {
                codedOutputStream.mo16939D0(2, this.contain_.get(i));
            }
            for (int i2 = 0; i2 < this.exclude_.size(); i2++) {
                codedOutputStream.mo16939D0(3, this.exclude_.get(i2));
            }
        }

        public static Position parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Position) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Position parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Position) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static Position parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Position) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Position parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Position) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Position parseFrom(C3407e c3407e) throws IOException {
            return (Position) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Position parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Position) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class Resource extends GeneratedMessageLite<Resource, Builder> implements ResourceOrBuilder {
        ...
        private C3414l.h<ResourcePage> pages_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllPages(Iterable<? extends ResourcePage> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.pages_);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !resource.id_.isEmpty(), resource.id_);
                    this.templateID_ = interfaceC3386h.mo16997f(!this.templateID_.isEmpty(), this.templateID_, true ^ resource.templateID_.isEmpty(), resource.templateID_);
                    this.pages_ = interfaceC3386h.mo16998g(this.pages_, resource.pages_);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.templateID_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
                                    if (!this.pages_.mo17085q()) {
                                        this.pages_ = GeneratedMessageLite.mutableCopy(this.pages_);
                                    }
                                    this.pages_.add((ResourcePage) c3407e.m17143w(ResourcePage.parser(), c3410h));
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            if (!this.templateID_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getTemplateID());
            }
            for (int i2 = 0; i2 < this.pages_.size(); i2++) {
                iM16901K += CodedOutputStream.m16893C(3, this.pages_.get(i2));
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.templateID_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getTemplateID());
            }
            for (int i = 0; i < this.pages_.size(); i++) {
                codedOutputStream.mo16974w0(3, this.pages_.get(i));
            }
        }
    ...
    public static final class ResourceNode extends GeneratedMessageLite<ResourceNode, Builder> implements ResourceNodeOrBuilder {
        ...
        private C3414l.h<NodeContent> contents_ = GeneratedMessageLite.emptyProtobufList();
        private String src_ = "";
        private String url_ = "";
        private String type_ = "";
        ...
        public void addAllContents(Iterable<? extends NodeContent> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.contents_);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.index_ = interfaceC3386h.mo16997f(!this.index_.isEmpty(), this.index_, !resourceNode.index_.isEmpty(), resourceNode.index_);
                    this.contents_ = interfaceC3386h.mo16998g(this.contents_, resourceNode.contents_);
                    this.src_ = interfaceC3386h.mo16997f(!this.src_.isEmpty(), this.src_, !resourceNode.src_.isEmpty(), resourceNode.src_);
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, !resourceNode.url_.isEmpty(), resourceNode.url_);
                    this.type_ = interfaceC3386h.mo16997f(!this.type_.isEmpty(), this.type_, !resourceNode.type_.isEmpty(), resourceNode.type_);
                    this.direction_ = interfaceC3386h.mo16997f(!this.direction_.isEmpty(), this.direction_, true ^ resourceNode.direction_.isEmpty(), resourceNode.direction_);
                    this.colors_ = interfaceC3386h.mo16998g(this.colors_, resourceNode.colors_);
                    this.mercury_ = (Mercury) interfaceC3386h.mo17006o(this.mercury_, resourceNode.mercury_);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    this.index_ = c3407e.m17115L();
                                } else if (iM17116M == 18) {
                                    if (!this.contents_.mo17085q()) {
                                        this.contents_ = GeneratedMessageLite.mutableCopy(this.contents_);
                                    }
                                    this.contents_.add((NodeContent) c3407e.m17143w(NodeContent.parser(), c3410h));
                                } else if (iM17116M == 26) {
                                    this.src_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
                                    this.url_ = c3407e.m17115L();
                                } else if (iM17116M == 50) {
                                    this.type_ = c3407e.m17115L();
                                } else if (iM17116M == 58) {
                                    this.direction_ = c3407e.m17115L();
                                } else if (iM17116M == 66) {
                                    String strM17115L = c3407e.m17115L();
                                    if (!this.colors_.mo17085q()) {
                                        this.colors_ = GeneratedMessageLite.mutableCopy(this.colors_);
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.index_.isEmpty() ? CodedOutputStream.m16901K(1, getIndex()) : 0;
            for (int i2 = 0; i2 < this.contents_.size(); i2++) {
                iM16901K += CodedOutputStream.m16893C(2, this.contents_.get(i2));
            }
            if (!this.src_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getSrc());
            }
            if (!this.url_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getUrl());
            }
            if (!this.type_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getType());
            }
            if (!this.direction_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getDirection());
            }
            int iM16902L = 0;
            for (int i3 = 0; i3 < this.colors_.size(); i3++) {
                iM16902L += CodedOutputStream.m16902L(this.colors_.get(i3));
            }
            int size = iM16901K + iM16902L + getColorsList().size();
            if (this.mercury_ != null) {
                size += CodedOutputStream.m16893C(9, getMercury());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.index_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getIndex());
            }
            for (int i = 0; i < this.contents_.size(); i++) {
                codedOutputStream.mo16974w0(2, this.contents_.get(i));
            }
            if (!this.src_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getSrc());
            }
            if (!this.url_.isEmpty()) {
            ...
            if (!this.direction_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getDirection());
            }
            for (int i2 = 0; i2 < this.colors_.size(); i2++) {
                codedOutputStream.mo16939D0(8, this.colors_.get(i2));
            }
            if (this.mercury_ != null) {
                codedOutputStream.mo16974w0(9, getMercury());
            }
        ...
        public static ResourceNode parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ResourceNode) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ResourceNode parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ResourceNode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ResourceNode, Builder> implements ResourceNodeOrBuilder {
            private Builder() {
        ...
        public static ResourceNode parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ResourceNode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ResourceNode parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ResourceNode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ResourceNode parseFrom(C3407e c3407e) throws IOException {
            return (ResourceNode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ResourceNode parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ResourceNode) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public static final class ResourcePage extends GeneratedMessageLite<ResourcePage, Builder> implements ResourcePageOrBuilder {
        ...
        private int bitField0_;
        private int index_;
        private C3414l.h<ResourceNode> nodes_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.index_ = interfaceC3386h.mo16996e(z2, i, i2 != 0, i2);
                    this.nodes_ = interfaceC3386h.mo16998g(this.nodes_, resourcePage.nodes_);
                    if (interfaceC3386h == GeneratedMessageLite.C3385g.INSTANCE) {
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    this.index_ = c3407e.m17141u();
                                } else if (iM17116M == 18) {
                                    if (!this.nodes_.mo17085q()) {
                                        this.nodes_ = GeneratedMessageLite.mutableCopy(this.nodes_);
                                    }
                                    this.nodes_.add((ResourceNode) c3407e.m17143w(ResourceNode.parser(), c3410h));
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i3 = 0; i3 < this.nodes_.size(); i3++) {
                iM16929t += CodedOutputStream.m16893C(2, this.nodes_.get(i3));
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i2 = 0; i2 < this.nodes_.size(); i2++) {
                codedOutputStream.mo16974w0(2, this.nodes_.get(i2));
            }
        }

        public static ResourcePage parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ResourcePage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ResourcePage parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ResourcePage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<ResourcePage, Builder> implements ResourcePageOrBuilder {
            private Builder() {
        ...
        public static ResourcePage parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (ResourcePage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static ResourcePage parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (ResourcePage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static ResourcePage parseFrom(C3407e c3407e) throws IOException {
            return (ResourcePage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static ResourcePage parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (ResourcePage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    ...
    public static final class Web extends GeneratedMessageLite<Web, Builder> implements WebOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45461.f15996xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    GeneratedMessageLite.InterfaceC3386h interfaceC3386h = (GeneratedMessageLite.InterfaceC3386h) obj;
                    Web web = (Web) obj2;
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, true ^ web.url_.isEmpty(), web.url_);
                    this.width_ = (Layout) interfaceC3386h.mo17006o(this.width_, web.width_);
                    this.height_ = (Layout) interfaceC3386h.mo17006o(this.height_, web.height_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    Layout layout2 = (Layout) c3407e.m17143w(Layout.parser(), c3410h);
                                    this.width_ = layout2;
                                    if (builder != null) {
                                    ...
                                    Layout layout4 = (Layout) c3407e.m17143w(Layout.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (this.width_ != null) {
                iM16901K += CodedOutputStream.m16893C(2, getWidth());
            }
            if (this.height_ != null) {
                iM16901K += CodedOutputStream.m16893C(3, getHeight());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.width_ != null) {
                codedOutputStream.mo16974w0(2, getWidth());
            }
            if (this.height_ != null) {
                codedOutputStream.mo16974w0(3, getHeight());
            }
        }

        public static Web parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Web) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Web parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Web) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<Web, Builder> implements WebOrBuilder {
            private Builder() {
        ...
        public static Web parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (Web) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static Web parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (Web) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static Web parseFrom(C3407e c3407e) throws IOException {
            return (Web) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static Web parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (Web) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
