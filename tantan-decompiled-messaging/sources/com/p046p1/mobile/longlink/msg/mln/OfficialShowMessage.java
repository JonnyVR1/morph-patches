package com.p046p1.mobile.longlink.msg.mln;
...
public final class OfficialShowMessage {
    ...
    public static /* synthetic */ class C45441 {
        ...
        static {
            ...
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15995xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class OfficialShowUpdateStatus extends GeneratedMessageLite<OfficialShowUpdateStatus, Builder> implements OfficialShowUpdateStatusOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<OfficialShowUpdateStatus, Builder> implements OfficialShowUpdateStatusOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45441.f15995xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.currentAnchorId_ = interfaceC3386h.mo16997f(!this.currentAnchorId_.isEmpty(), this.currentAnchorId_, !officialShowUpdateStatus.currentAnchorId_.isEmpty(), officialShowUpdateStatus.currentAnchorId_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.currentAnchorId_ = c3407e.m17115L();
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.action_ != ActionType.unknown.getNumber() ? CodedOutputStream.m16922m(1, this.action_) : 0;
            if (!this.currentAnchorId_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getCurrentAnchorId());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.mo16939D0(2, getCurrentAnchorId());
        }
        ...
        public enum ActionType implements C3414l.c {
            ...
            private static final C3414l.d<ActionType> internalValueMap = new C3414l.d<ActionType>() { // from class: com.p1.mobile.longlink.msg.mln.OfficialShowMessage.OfficialShowUpdateStatus.ActionType.1
        ...
        public static OfficialShowUpdateStatus parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OfficialShowUpdateStatus) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OfficialShowUpdateStatus parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OfficialShowUpdateStatus) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static OfficialShowUpdateStatus parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OfficialShowUpdateStatus) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static OfficialShowUpdateStatus parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OfficialShowUpdateStatus) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OfficialShowUpdateStatus parseFrom(C3407e c3407e) throws IOException {
            return (OfficialShowUpdateStatus) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static OfficialShowUpdateStatus parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (OfficialShowUpdateStatus) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class OfficialShowJump extends GeneratedMessageLite<OfficialShowJump, Builder> implements OfficialShowJumpOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<OfficialShowJump, Builder> implements OfficialShowJumpOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45441.f15995xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.officialShowLiveId_ = interfaceC3386h.mo16997f(!this.officialShowLiveId_.isEmpty(), this.officialShowLiveId_, !officialShowJump.officialShowLiveId_.isEmpty(), officialShowJump.officialShowLiveId_);
                    this.officialShowRoomId_ = interfaceC3386h.mo16997f(!this.officialShowRoomId_.isEmpty(), this.officialShowRoomId_, true ^ officialShowJump.officialShowRoomId_.isEmpty(), officialShowJump.officialShowRoomId_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    this.officialShowLiveId_ = c3407e.m17115L();
                                } else if (iM17116M == 18) {
                                    this.officialShowRoomId_ = c3407e.m17115L();
                                } else if (!c3407e.m17121R(iM17116M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.officialShowLiveId_.isEmpty() ? CodedOutputStream.m16901K(1, getOfficialShowLiveId()) : 0;
            if (!this.officialShowRoomId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getOfficialShowRoomId());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.officialShowLiveId_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getOfficialShowLiveId());
            }
            if (this.officialShowRoomId_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(2, getOfficialShowRoomId());
        }

        public static OfficialShowJump parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OfficialShowJump) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OfficialShowJump parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OfficialShowJump) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static OfficialShowJump parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OfficialShowJump) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static OfficialShowJump parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OfficialShowJump) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OfficialShowJump parseFrom(C3407e c3407e) throws IOException {
            return (OfficialShowJump) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static OfficialShowJump parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (OfficialShowJump) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
