package com.p046p1.mobile.longlink.msg.liveoperationplace;
...
public final class LongLinkLiveTurboCard {
    ...
    public static /* synthetic */ class C44541 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f15962xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15962xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15962xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class OperationPlace extends GeneratedMessageLite<OperationPlace, Builder> implements OperationPlaceOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44541.f15962xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.icon_ = interfaceC3386h.mo16997f(!this.icon_.isEmpty(), this.icon_, !operationPlace.icon_.isEmpty(), operationPlace.icon_);
                    this.clickAction_ = interfaceC3386h.mo16997f(!this.clickAction_.isEmpty(), this.clickAction_, !operationPlace.clickAction_.isEmpty(), operationPlace.clickAction_);
                    this.url_ = interfaceC3386h.mo16997f(!this.url_.isEmpty(), this.url_, !operationPlace.url_.isEmpty(), operationPlace.url_);
                    this.id_ = interfaceC3386h.mo16997f(!this.id_.isEmpty(), this.id_, !operationPlace.id_.isEmpty(), operationPlace.id_);
                    this.type_ = interfaceC3386h.mo16997f(!this.type_.isEmpty(), this.type_, true ^ operationPlace.type_.isEmpty(), operationPlace.type_);
                    this.turboCardInfo_ = (TurboCardInfo) interfaceC3386h.mo17006o(this.turboCardInfo_, operationPlace.turboCardInfo_);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.clickAction_ = c3407e.m17115L();
                                } else if (iM17116M == 26) {
                                    ...
                                    TurboCardInfo turboCardInfo2 = (TurboCardInfo) c3407e.m17143w(TurboCardInfo.parser(), c3410h);
        ...
        public int getSerializedSize() {
            ...
            if (!this.clickAction_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getClickAction());
            }
            if (!this.url_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getUrl());
            }
            if (!this.id_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getId());
            }
            if (!this.type_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getType());
            }
            if (this.turboCardInfo_ != null) {
                iM16901K += CodedOutputStream.m16893C(6, getTurboCardInfo());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.clickAction_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getClickAction());
            }
            if (!this.url_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getUrl());
            }
            if (!this.id_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getId());
            }
            if (!this.type_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getType());
            }
            if (this.turboCardInfo_ != null) {
                codedOutputStream.mo16974w0(6, getTurboCardInfo());
            }
        }

        public static OperationPlace parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OperationPlace) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OperationPlace parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OperationPlace) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<OperationPlace, Builder> implements OperationPlaceOrBuilder {
            private Builder() {
        ...
        public static OperationPlace parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (OperationPlace) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static OperationPlace parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (OperationPlace) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static OperationPlace parseFrom(C3407e c3407e) throws IOException {
            return (OperationPlace) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static OperationPlace parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (OperationPlace) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class TurboCardEventMsg extends GeneratedMessageLite<TurboCardEventMsg, Builder> implements TurboCardEventMsgOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<TurboCardEventMsg, Builder> implements TurboCardEventMsgOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44541.f15962xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.text_ = interfaceC3386h.mo16997f(!this.text_.isEmpty(), this.text_, !turboCardEventMsg.text_.isEmpty(), turboCardEventMsg.text_);
                    long j = this.roomId_;
                    boolean z2 = j != 0;
                    long j2 = turboCardEventMsg.roomId_;
                    this.roomId_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    this.icon_ = interfaceC3386h.mo16997f(!this.icon_.isEmpty(), this.icon_, !turboCardEventMsg.icon_.isEmpty(), turboCardEventMsg.icon_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            if (!this.icon_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getIcon());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.mo16939D0(3, getIcon());
        }

        public static TurboCardEventMsg parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (TurboCardEventMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static TurboCardEventMsg parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (TurboCardEventMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static TurboCardEventMsg parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (TurboCardEventMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static TurboCardEventMsg parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (TurboCardEventMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static TurboCardEventMsg parseFrom(C3407e c3407e) throws IOException {
            return (TurboCardEventMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static TurboCardEventMsg parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (TurboCardEventMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class TurboCardInfo extends GeneratedMessageLite<TurboCardInfo, Builder> implements TurboCardInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<TurboCardInfo, Builder> implements TurboCardInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44541.f15962xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.action_ = interfaceC3386h.mo16997f(!this.action_.isEmpty(), this.action_, !turboCardInfo.action_.isEmpty(), turboCardInfo.action_);
                    long j = this.prepareTimeStart_;
                    boolean z2 = j != 0;
                    long j2 = turboCardInfo.prepareTimeStart_;
                    this.prepareTimeStart_ = interfaceC3386h.mo17000i(z2, j, j2 != 0, j2);
                    long j3 = this.prepareTimeEnd_;
                    boolean z3 = j3 != 0;
                    long j4 = turboCardInfo.prepareTimeEnd_;
                    this.prepareTimeEnd_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                    long j5 = this.exposureTimeStart_;
                    boolean z4 = j5 != 0;
                    long j6 = turboCardInfo.exposureTimeStart_;
                    this.exposureTimeStart_ = interfaceC3386h.mo17000i(z4, j5, j6 != 0, j6);
                    long j7 = this.exposureTimeEnd_;
                    boolean z5 = j7 != 0;
                    long j8 = turboCardInfo.exposureTimeEnd_;
                    this.exposureTimeEnd_ = interfaceC3386h.mo17000i(z5, j7, j8 != 0, j8);
                    this.userType_ = interfaceC3386h.mo16997f(!this.userType_.isEmpty(), this.userType_, !turboCardInfo.userType_.isEmpty(), turboCardInfo.userType_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !turboCardInfo.userId_.isEmpty(), turboCardInfo.userId_);
                    this.userName_ = interfaceC3386h.mo16997f(!this.userName_.isEmpty(), this.userName_, !turboCardInfo.userName_.isEmpty(), turboCardInfo.userName_);
                    long j9 = this.userHierarchy_;
                    boolean z6 = j9 != 0;
                    long j10 = turboCardInfo.userHierarchy_;
                    this.userHierarchy_ = interfaceC3386h.mo17000i(z6, j9, j10 != 0, j10);
                    this.userMedal_ = interfaceC3386h.mo16997f(!this.userMedal_.isEmpty(), this.userMedal_, !turboCardInfo.userMedal_.isEmpty(), turboCardInfo.userMedal_);
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !turboCardInfo.roomId_.isEmpty(), turboCardInfo.roomId_);
                    this.text_ = interfaceC3386h.mo16997f(!this.text_.isEmpty(), this.text_, !turboCardInfo.text_.isEmpty(), turboCardInfo.text_);
                    this.msgType_ = interfaceC3386h.mo16997f(!this.msgType_.isEmpty(), this.msgType_, !turboCardInfo.msgType_.isEmpty(), turboCardInfo.msgType_);
                    this.cardType_ = interfaceC3386h.mo16997f(!this.cardType_.isEmpty(), this.cardType_, !turboCardInfo.cardType_.isEmpty(), turboCardInfo.cardType_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 10:
                                    ...
                                    continue;
                                case 16:
                                    this.prepareTimeStart_ = c3407e.m17142v();
                                    continue;
                                case 24:
                                    this.prepareTimeEnd_ = c3407e.m17142v();
                                    continue;
                                case 32:
                                    this.exposureTimeStart_ = c3407e.m17142v();
                                    continue;
                                case 40:
                                    this.exposureTimeEnd_ = c3407e.m17142v();
                                    continue;
                                case 50:
                                    this.userType_ = c3407e.m17115L();
                                    continue;
                                case 58:
                                ...
                                case EACTags.COMMAND_TO_PERFORM /* 82 */:
                                    this.userMedal_ = c3407e.m17115L();
                                    continue;
                                case 90:
                                ...
                                case EACTags.FCP_TEMPLATE /* 98 */:
                                    ...
                                    continue;
                                case 106:
                                    this.msgType_ = c3407e.m17115L();
                                    continue;
                                case 114:
                                    this.cardType_ = c3407e.m17115L();
                                    continue;
                                default:
        ...
        public int getSerializedSize() {
            ...
            int iM16901K = !this.action_.isEmpty() ? CodedOutputStream.m16901K(1, getAction()) : 0;
            long j = this.prepareTimeStart_;
            if (j != 0) {
                iM16901K += CodedOutputStream.m16931v(2, j);
            }
            ...
            if (j3 != 0) {
                iM16901K += CodedOutputStream.m16931v(4, j3);
            }
            long j4 = this.exposureTimeEnd_;
            if (j4 != 0) {
                iM16901K += CodedOutputStream.m16931v(5, j4);
            }
            if (!this.userType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getUserType());
            }
            if (!this.userId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getUserId());
            }
            if (!this.userName_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(8, getUserName());
            }
            long j5 = this.userHierarchy_;
            if (j5 != 0) {
                iM16901K += CodedOutputStream.m16931v(9, j5);
            }
            if (!this.userMedal_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(10, getUserMedal());
            }
            if (!this.roomId_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(11, getRoomId());
            }
            if (!this.text_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(12, getText());
            }
            if (!this.msgType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(13, getMsgType());
            }
            if (!this.cardType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(14, getCardType());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.action_.isEmpty()) {
                codedOutputStream.mo16939D0(1, getAction());
            }
            long j = this.prepareTimeStart_;
            if (j != 0) {
                codedOutputStream.m16972u0(2, j);
            ...
            long j3 = this.exposureTimeStart_;
            if (j3 != 0) {
                codedOutputStream.m16972u0(4, j3);
            }
            long j4 = this.exposureTimeEnd_;
            if (j4 != 0) {
                codedOutputStream.m16972u0(5, j4);
            }
            if (!this.userType_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getUserType());
            }
            if (!this.userId_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getUserId());
            }
            if (!this.userName_.isEmpty()) {
                codedOutputStream.mo16939D0(8, getUserName());
            }
            long j5 = this.userHierarchy_;
            if (j5 != 0) {
            ...
            if (!this.userMedal_.isEmpty()) {
                codedOutputStream.mo16939D0(10, getUserMedal());
            }
            if (!this.roomId_.isEmpty()) {
                codedOutputStream.mo16939D0(11, getRoomId());
            }
            if (!this.text_.isEmpty()) {
                codedOutputStream.mo16939D0(12, getText());
            }
            if (!this.msgType_.isEmpty()) {
                codedOutputStream.mo16939D0(13, getMsgType());
            }
            if (this.cardType_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16939D0(14, getCardType());
        }

        public static TurboCardInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (TurboCardInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static TurboCardInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (TurboCardInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static TurboCardInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (TurboCardInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static TurboCardInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (TurboCardInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static TurboCardInfo parseFrom(C3407e c3407e) throws IOException {
            return (TurboCardInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static TurboCardInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (TurboCardInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
