package com.p046p1.mobile.longlink.msg.livehierarchy;
...
public final class LongLinkLiveUserLevel {
    ...
    public static /* synthetic */ class C44501 {
        ...
        static {
            ...
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15960xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class RoomTopEffect extends GeneratedMessageLite<RoomTopEffect, Builder> implements RoomTopEffectOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<RoomTopEffect, Builder> implements RoomTopEffectOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C44501.f15960xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.svgUrl_ = interfaceC3386h.mo16997f(!this.svgUrl_.isEmpty(), this.svgUrl_, !roomTopEffect.svgUrl_.isEmpty(), roomTopEffect.svgUrl_);
                    this.tag_ = interfaceC3386h.mo16997f(!this.tag_.isEmpty(), this.tag_, !roomTopEffect.tag_.isEmpty(), roomTopEffect.tag_);
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !roomTopEffect.userId_.isEmpty(), roomTopEffect.userId_);
                    this.userName_ = interfaceC3386h.mo16997f(!this.userName_.isEmpty(), this.userName_, !roomTopEffect.userName_.isEmpty(), roomTopEffect.userName_);
                    this.userImageUrl_ = interfaceC3386h.mo16997f(!this.userImageUrl_.isEmpty(), this.userImageUrl_, !roomTopEffect.userImageUrl_.isEmpty(), roomTopEffect.userImageUrl_);
                    long j = this.grade_;
                    boolean z3 = j != 0;
                    long j2 = roomTopEffect.grade_;
                    this.grade_ = interfaceC3386h.mo17000i(z3, j, j2 != 0, j2);
                    long j3 = this.superGrade_;
                    boolean z4 = j3 != 0;
                    long j4 = roomTopEffect.superGrade_;
                    this.superGrade_ = interfaceC3386h.mo17000i(z4, j3, j4 != 0, j4);
                    boolean z5 = false;
                    ...
                    this.duration_ = interfaceC3386h.mo17000i(z5, j5, j6 != 0, j6);
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 8) {
                                    ...
                                    this.userImageUrl_ = c3407e.m17115L();
                                } else if (iM17116M == 56) {
                                    this.grade_ = c3407e.m17142v();
                                } else if (iM17116M == 64) {
                                    this.superGrade_ = c3407e.m17142v();
                                } else if (iM17116M == 72) {
        ...
        public int getSerializedSize() {
            ...
            int iM16922m = this.type_ != RoomTopEffectType.userWealthGradeUp.getNumber() ? CodedOutputStream.m16922m(1, this.type_) : 0;
            if (!this.svgUrl_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(2, getSvgUrl());
            }
            if (!this.tag_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(3, getTag());
            }
            if (!this.userId_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(4, getUserId());
            }
            if (!this.userName_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(5, getUserName());
            }
            if (!this.userImageUrl_.isEmpty()) {
                iM16922m += CodedOutputStream.m16901K(6, getUserImageUrl());
            }
            long j = this.grade_;
            if (j != 0) {
                iM16922m += CodedOutputStream.m16931v(7, j);
            }
            long j2 = this.superGrade_;
            if (j2 != 0) {
                iM16922m += CodedOutputStream.m16931v(8, j2);
            }
            long j3 = this.duration_;
            if (j3 != 0) {
                iM16922m += CodedOutputStream.m16931v(9, j3);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.svgUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(2, getSvgUrl());
            }
            if (!this.tag_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getTag());
            }
            if (!this.userId_.isEmpty()) {
            ...
            if (!this.userImageUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getUserImageUrl());
            }
            long j = this.grade_;
            if (j != 0) {
        ...
        public static RoomTopEffect parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (RoomTopEffect) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static RoomTopEffect parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (RoomTopEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static RoomTopEffect parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (RoomTopEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static RoomTopEffect parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (RoomTopEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static RoomTopEffect parseFrom(C3407e c3407e) throws IOException {
            return (RoomTopEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static RoomTopEffect parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (RoomTopEffect) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }

    public enum RoomTopEffectType implements C3414l.c {
        userWealthGradeUp(0),
        UNRECOGNIZED(-1);

        private static final C3414l.d<RoomTopEffectType> internalValueMap = new C3414l.d<RoomTopEffectType>() { // from class: com.p1.mobile.longlink.msg.livehierarchy.LongLinkLiveUserLevel.RoomTopEffectType.1
        ...
        public static C3414l.d<RoomTopEffectType> internalGetValueMap() {
    ...
    public static final class UserHierarchyGrade extends GeneratedMessageLite<UserHierarchyGrade, Builder> implements UserHierarchyGradeOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserHierarchyGrade, Builder> implements UserHierarchyGradeOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44501.f15960xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !userHierarchyGrade.userId_.isEmpty(), userHierarchyGrade.userId_);
                    this.userName_ = interfaceC3386h.mo16997f(!this.userName_.isEmpty(), this.userName_, !userHierarchyGrade.userName_.isEmpty(), userHierarchyGrade.userName_);
                    this.userImageUrl_ = interfaceC3386h.mo16997f(!this.userImageUrl_.isEmpty(), this.userImageUrl_, !userHierarchyGrade.userImageUrl_.isEmpty(), userHierarchyGrade.userImageUrl_);
                    long j3 = this.grade_;
                    boolean z3 = j3 != 0;
                    long j4 = userHierarchyGrade.grade_;
                    this.grade_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                    boolean z4 = false;
                    ...
                    this.superGrade_ = interfaceC3386h.mo17000i(z4, j5, j6 != 0, j6);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
        ...
        public int getSerializedSize() {
            ...
            if (!this.userId_.isEmpty()) {
                iM16906P += CodedOutputStream.m16901K(2, getUserId());
            }
            if (!this.userName_.isEmpty()) {
                iM16906P += CodedOutputStream.m16901K(3, getUserName());
            }
            if (!this.userImageUrl_.isEmpty()) {
                iM16906P += CodedOutputStream.m16901K(4, getUserImageUrl());
            }
            long j2 = this.grade_;
            if (j2 != 0) {
                iM16906P += CodedOutputStream.m16931v(5, j2);
            }
            long j3 = this.superGrade_;
            if (j3 != 0) {
                iM16906P += CodedOutputStream.m16931v(6, j3);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.userName_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getUserName());
            }
            if (!this.userImageUrl_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getUserImageUrl());
            }
            long j2 = this.grade_;
            if (j2 != 0) {
        ...
        public static UserHierarchyGrade parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserHierarchyGrade) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserHierarchyGrade parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserHierarchyGrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static UserHierarchyGrade parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserHierarchyGrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserHierarchyGrade parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserHierarchyGrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserHierarchyGrade parseFrom(C3407e c3407e) throws IOException {
            return (UserHierarchyGrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserHierarchyGrade parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserHierarchyGrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class UserLiveHierarchyProgressChange extends GeneratedMessageLite<UserLiveHierarchyProgressChange, Builder> implements UserLiveHierarchyProgressChangeOrBuilder {
        ...
        private C3414l.h<String> progressTexts_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllProgressTexts(Iterable<String> iterable) {
            ...
            AbstractC3403a.addAll(iterable, this.progressTexts_);
        }
        ...
        private void ensureProgressTextsIsMutable() {
            if (this.progressTexts_.mo17085q()) {
                return;
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C44501.f15960xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.wealth_ = interfaceC3386h.mo17000i(z3, j3, j4 != 0, j4);
                    ...
                    this.wealthRatio_ = interfaceC3386h.mo17001j(z4, d, d2 != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, d2);
                    this.progressText_ = interfaceC3386h.mo16997f(!this.progressText_.isEmpty(), this.progressText_, !userLiveHierarchyProgressChange.progressText_.isEmpty(), userLiveHierarchyProgressChange.progressText_);
                    this.jumpText_ = interfaceC3386h.mo16997f(!this.jumpText_.isEmpty(), this.jumpText_, !userLiveHierarchyProgressChange.jumpText_.isEmpty(), userLiveHierarchyProgressChange.jumpText_);
                    this.jumpSchema_ = interfaceC3386h.mo16997f(!this.jumpSchema_.isEmpty(), this.jumpSchema_, !userLiveHierarchyProgressChange.jumpSchema_.isEmpty(), userLiveHierarchyProgressChange.jumpSchema_);
                    long j5 = this.preGrade_;
                    boolean z5 = j5 != 0;
                    long j6 = userLiveHierarchyProgressChange.preGrade_;
                    this.preGrade_ = interfaceC3386h.mo17000i(z5, j5, j6 != 0, j6);
                    long j7 = this.preWealth_;
                    boolean z6 = j7 != 0;
                    long j8 = userLiveHierarchyProgressChange.preWealth_;
                    this.preWealth_ = interfaceC3386h.mo17000i(z6, j7, j8 != 0, j8);
                    long j9 = this.serverTs_;
                    boolean z7 = j9 != 0;
                    long j10 = userLiveHierarchyProgressChange.serverTs_;
                    this.serverTs_ = interfaceC3386h.mo17000i(z7, j9, j10 != 0, j10);
                    boolean z8 = false;
                    ...
                    this.superGrade_ = interfaceC3386h.mo17000i(z8, j11, j12 != 0, j12);
                    this.style_ = (UserLiveHierarchyProgressStyle) interfaceC3386h.mo17006o(this.style_, userLiveHierarchyProgressChange.style_);
                    this.progressTexts_ = interfaceC3386h.mo16998g(this.progressTexts_, userLiveHierarchyProgressChange.progressTexts_);
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 8:
                                    ...
                                    continue;
                                case 16:
                                    this.wealth_ = c3407e.m17142v();
                                    continue;
                                case 25:
                                    this.wealthRatio_ = c3407e.m17135o();
                                    continue;
                                case 34:
                                    this.progressText_ = c3407e.m17115L();
                                    continue;
                                case 42:
                                    this.jumpText_ = c3407e.m17115L();
                                    continue;
                                case 50:
                                    this.jumpSchema_ = c3407e.m17115L();
                                    continue;
                                case 56:
                                    this.preGrade_ = c3407e.m17142v();
                                    continue;
                                case 64:
                                    this.preWealth_ = c3407e.m17142v();
                                    continue;
                                case 72:
                                    this.serverTs_ = c3407e.m17142v();
                                    continue;
                                case 80:
                                    this.superGrade_ = c3407e.m17142v();
                                    continue;
                                case 90:
                                    ...
                                    UserLiveHierarchyProgressStyle userLiveHierarchyProgressStyle2 = (UserLiveHierarchyProgressStyle) c3407e.m17143w(UserLiveHierarchyProgressStyle.parser(), c3410h);
                                ...
                                case EACTags.FCP_TEMPLATE /* 98 */:
                                    ...
                                    this.progressTexts_.add(strM17115L);
                                    continue;
                                default:
        ...
        public int getSerializedSize() {
            ...
            if (d != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                iM16931v += CodedOutputStream.m16920k(3, d);
            }
            if (!this.progressText_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(4, getProgressText());
            }
            if (!this.jumpText_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(5, getJumpText());
            }
            if (!this.jumpSchema_.isEmpty()) {
                iM16931v += CodedOutputStream.m16901K(6, getJumpSchema());
            }
            long j3 = this.preGrade_;
            if (j3 != 0) {
                iM16931v += CodedOutputStream.m16931v(7, j3);
            }
            long j4 = this.preWealth_;
            if (j4 != 0) {
                iM16931v += CodedOutputStream.m16931v(8, j4);
            }
            long j5 = this.serverTs_;
            if (j5 != 0) {
                iM16931v += CodedOutputStream.m16931v(9, j5);
            }
            long j6 = this.superGrade_;
            if (j6 != 0) {
                iM16931v += CodedOutputStream.m16931v(10, j6);
            }
            if (this.style_ != null) {
                iM16931v += CodedOutputStream.m16893C(11, getStyle());
            }
            int iM16902L = 0;
            for (int i2 = 0; i2 < this.progressTexts_.size(); i2++) {
                iM16902L += CodedOutputStream.m16902L(this.progressTexts_.get(i2));
            }
            int size = iM16931v + iM16902L + getProgressTextsList().size();
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            double d = this.wealthRatio_;
            if (d != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                codedOutputStream.m16958g0(3, d);
            }
            if (!this.progressText_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getProgressText());
            }
            if (!this.jumpText_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getJumpText());
            }
            if (!this.jumpSchema_.isEmpty()) {
            ...
            long j5 = this.serverTs_;
            if (j5 != 0) {
                codedOutputStream.m16972u0(9, j5);
            }
            long j6 = this.superGrade_;
            if (j6 != 0) {
                codedOutputStream.m16972u0(10, j6);
            }
            if (this.style_ != null) {
                codedOutputStream.mo16974w0(11, getStyle());
            }
            for (int i = 0; i < this.progressTexts_.size(); i++) {
                codedOutputStream.mo16939D0(12, this.progressTexts_.get(i));
            }
        }

        public static UserLiveHierarchyProgressChange parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveHierarchyProgressChange) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveHierarchyProgressChange parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveHierarchyProgressChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserLiveHierarchyProgressChange, Builder> implements UserLiveHierarchyProgressChangeOrBuilder {
            private Builder() {
        ...
        public static UserLiveHierarchyProgressChange parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveHierarchyProgressChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserLiveHierarchyProgressChange parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveHierarchyProgressChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveHierarchyProgressChange parseFrom(C3407e c3407e) throws IOException {
            return (UserLiveHierarchyProgressChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserLiveHierarchyProgressChange parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserLiveHierarchyProgressChange) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class UserLiveHierarchyProgressStyle extends GeneratedMessageLite<UserLiveHierarchyProgressStyle, Builder> implements UserLiveHierarchyProgressStyleOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<UserLiveHierarchyProgressStyle, Builder> implements UserLiveHierarchyProgressStyleOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44501.f15960xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.startColor_ = interfaceC3386h.mo16997f(!this.startColor_.isEmpty(), this.startColor_, !userLiveHierarchyProgressStyle.startColor_.isEmpty(), userLiveHierarchyProgressStyle.startColor_);
                    this.endColor_ = interfaceC3386h.mo16997f(!this.endColor_.isEmpty(), this.endColor_, !userLiveHierarchyProgressStyle.endColor_.isEmpty(), userLiveHierarchyProgressStyle.endColor_);
                    this.bgStartColor_ = interfaceC3386h.mo16997f(!this.bgStartColor_.isEmpty(), this.bgStartColor_, !userLiveHierarchyProgressStyle.bgStartColor_.isEmpty(), userLiveHierarchyProgressStyle.bgStartColor_);
                    this.bgEndColor_ = interfaceC3386h.mo16997f(!this.bgEndColor_.isEmpty(), this.bgEndColor_, !userLiveHierarchyProgressStyle.bgEndColor_.isEmpty(), userLiveHierarchyProgressStyle.bgEndColor_);
                    this.textColor_ = interfaceC3386h.mo16997f(!this.textColor_.isEmpty(), this.textColor_, true ^ userLiveHierarchyProgressStyle.textColor_.isEmpty(), userLiveHierarchyProgressStyle.textColor_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.bgStartColor_ = c3407e.m17115L();
                                } else if (iM17116M == 34) {
                                    this.bgEndColor_ = c3407e.m17115L();
                                } else if (iM17116M == 42) {
        ...
        public int getSerializedSize() {
            ...
            if (!this.bgStartColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(3, getBgStartColor());
            }
            if (!this.bgEndColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getBgEndColor());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.bgStartColor_.isEmpty()) {
                codedOutputStream.mo16939D0(3, getBgStartColor());
            }
            if (!this.bgEndColor_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getBgEndColor());
            }
            if (this.textColor_.isEmpty()) {
                return;
            }
        ...
        public static UserLiveHierarchyProgressStyle parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveHierarchyProgressStyle) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveHierarchyProgressStyle parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveHierarchyProgressStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static UserLiveHierarchyProgressStyle parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (UserLiveHierarchyProgressStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static UserLiveHierarchyProgressStyle parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (UserLiveHierarchyProgressStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static UserLiveHierarchyProgressStyle parseFrom(C3407e c3407e) throws IOException {
            return (UserLiveHierarchyProgressStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static UserLiveHierarchyProgressStyle parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (UserLiveHierarchyProgressStyle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
