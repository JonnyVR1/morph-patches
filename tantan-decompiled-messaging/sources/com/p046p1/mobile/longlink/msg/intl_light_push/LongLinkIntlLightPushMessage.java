package com.p046p1.mobile.longlink.msg.intl_light_push;
...
public final class LongLinkIntlLightPushMessage {
    ...
    public static /* synthetic */ class C44201 {
        ...
        static {
            ...
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f15943xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class IntlLightPushInfo extends GeneratedMessageLite<IntlLightPushInfo, Builder> implements IntlLightPushInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<IntlLightPushInfo, Builder> implements IntlLightPushInfoOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C44201.f15943xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3386h.mo16997f(!this.roomId_.isEmpty(), this.roomId_, !intlLightPushInfo.roomId_.isEmpty(), intlLightPushInfo.roomId_);
                    this.liveId_ = interfaceC3386h.mo16997f(!this.liveId_.isEmpty(), this.liveId_, !intlLightPushInfo.liveId_.isEmpty(), intlLightPushInfo.liveId_);
                    this.anchorId_ = interfaceC3386h.mo16997f(!this.anchorId_.isEmpty(), this.anchorId_, !intlLightPushInfo.anchorId_.isEmpty(), intlLightPushInfo.anchorId_);
                    this.region_ = interfaceC3386h.mo16997f(!this.region_.isEmpty(), this.region_, !intlLightPushInfo.region_.isEmpty(), intlLightPushInfo.region_);
                    this.icon_ = interfaceC3386h.mo16997f(!this.icon_.isEmpty(), this.icon_, !intlLightPushInfo.icon_.isEmpty(), intlLightPushInfo.icon_);
                    this.iconSchema_ = interfaceC3386h.mo16997f(!this.iconSchema_.isEmpty(), this.iconSchema_, !intlLightPushInfo.iconSchema_.isEmpty(), intlLightPushInfo.iconSchema_);
                    this.textFirst_ = interfaceC3386h.mo16997f(!this.textFirst_.isEmpty(), this.textFirst_, !intlLightPushInfo.textFirst_.isEmpty(), intlLightPushInfo.textFirst_);
                    this.textSchema_ = interfaceC3386h.mo16997f(!this.textSchema_.isEmpty(), this.textSchema_, !intlLightPushInfo.textSchema_.isEmpty(), intlLightPushInfo.textSchema_);
                    this.textSecond_ = interfaceC3386h.mo16997f(!this.textSecond_.isEmpty(), this.textSecond_, !intlLightPushInfo.textSecond_.isEmpty(), intlLightPushInfo.textSecond_);
                    this.textFirstColor_ = interfaceC3386h.mo16997f(!this.textFirstColor_.isEmpty(), this.textFirstColor_, !intlLightPushInfo.textFirstColor_.isEmpty(), intlLightPushInfo.textFirstColor_);
                    this.textSecondColor_ = interfaceC3386h.mo16997f(!this.textSecondColor_.isEmpty(), this.textSecondColor_, !intlLightPushInfo.textSecondColor_.isEmpty(), intlLightPushInfo.textSecondColor_);
                    this.backgroundStartColor_ = interfaceC3386h.mo16997f(!this.backgroundStartColor_.isEmpty(), this.backgroundStartColor_, !intlLightPushInfo.backgroundStartColor_.isEmpty(), intlLightPushInfo.backgroundStartColor_);
                    this.backgroundEndColor_ = interfaceC3386h.mo16997f(!this.backgroundEndColor_.isEmpty(), this.backgroundEndColor_, !intlLightPushInfo.backgroundEndColor_.isEmpty(), intlLightPushInfo.backgroundEndColor_);
                    boolean z2 = this.closeAuto_;
                    boolean z3 = intlLightPushInfo.closeAuto_;
                    this.closeAuto_ = interfaceC3386h.mo16995d(z2, z2, z3, z3);
                    long j = this.closeTimeOutMs_;
                    boolean z4 = j != 0;
                    long j2 = intlLightPushInfo.closeTimeOutMs_;
                    this.closeTimeOutMs_ = interfaceC3386h.mo17000i(z4, j, j2 != 0, j2);
                    boolean z5 = this.svga_;
                    boolean z6 = intlLightPushInfo.svga_;
                    this.svga_ = interfaceC3386h.mo16995d(z5, z5, z6, z6);
                        ...
                        try {
                            ...
                            switch (iM17116M) {
                                ...
                                case 26:
                                    ...
                                    continue;
                                case 34:
                                    this.region_ = c3407e.m17115L();
                                    continue;
                                case 42:
                                    this.icon_ = c3407e.m17115L();
                                    continue;
                                case 50:
                                    this.iconSchema_ = c3407e.m17115L();
                                    continue;
                                case 58:
                                    this.textFirst_ = c3407e.m17115L();
                                    continue;
                                case 66:
                                    this.textSchema_ = c3407e.m17115L();
                                    continue;
                                case 74:
                                    this.textSecond_ = c3407e.m17115L();
                                    continue;
                                case EACTags.COMMAND_TO_PERFORM /* 82 */:
                                    this.textFirstColor_ = c3407e.m17115L();
                                    continue;
                                case 90:
                                    this.textSecondColor_ = c3407e.m17115L();
                                    continue;
                                case EACTags.FCP_TEMPLATE /* 98 */:
                                    this.backgroundStartColor_ = c3407e.m17115L();
                                    continue;
                                case 106:
                                    this.backgroundEndColor_ = c3407e.m17115L();
                                    continue;
                                case 112:
                                    this.closeAuto_ = c3407e.m17133m();
                                    continue;
                                case 120:
                                    this.closeTimeOutMs_ = c3407e.m17142v();
                                    continue;
                                case 128:
                                    this.svga_ = c3407e.m17133m();
                                    continue;
                                default:
        ...
        public int getSerializedSize() {
            ...
            if (!this.region_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(4, getRegion());
            }
            if (!this.icon_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(5, getIcon());
            }
            if (!this.iconSchema_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(6, getIconSchema());
            }
            if (!this.textFirst_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(7, getTextFirst());
            }
            if (!this.textSchema_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(8, getTextSchema());
            }
            if (!this.textSecond_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(9, getTextSecond());
            }
            if (!this.textFirstColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(10, getTextFirstColor());
            }
            if (!this.textSecondColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(11, getTextSecondColor());
            }
            if (!this.backgroundStartColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(12, getBackgroundStartColor());
            }
            if (!this.backgroundEndColor_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(13, getBackgroundEndColor());
            }
            boolean z = this.closeAuto_;
            if (z) {
                iM16901K += CodedOutputStream.m16915f(14, z);
            }
            long j = this.closeTimeOutMs_;
            if (j != 0) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.region_.isEmpty()) {
                codedOutputStream.mo16939D0(4, getRegion());
            }
            if (!this.icon_.isEmpty()) {
                codedOutputStream.mo16939D0(5, getIcon());
            }
            if (!this.iconSchema_.isEmpty()) {
                codedOutputStream.mo16939D0(6, getIconSchema());
            }
            if (!this.textFirst_.isEmpty()) {
                codedOutputStream.mo16939D0(7, getTextFirst());
            }
            if (!this.textSchema_.isEmpty()) {
                codedOutputStream.mo16939D0(8, getTextSchema());
            }
            if (!this.textSecond_.isEmpty()) {
                codedOutputStream.mo16939D0(9, getTextSecond());
            }
            if (!this.textFirstColor_.isEmpty()) {
                codedOutputStream.mo16939D0(10, getTextFirstColor());
            }
            if (!this.textSecondColor_.isEmpty()) {
                codedOutputStream.mo16939D0(11, getTextSecondColor());
            }
            if (!this.backgroundStartColor_.isEmpty()) {
                codedOutputStream.mo16939D0(12, getBackgroundStartColor());
            }
            if (!this.backgroundEndColor_.isEmpty()) {
                codedOutputStream.mo16939D0(13, getBackgroundEndColor());
            }
            boolean z = this.closeAuto_;
            if (z) {
                codedOutputStream.mo16950a0(14, z);
            }
            long j = this.closeTimeOutMs_;
            if (j != 0) {
        ...
        public static IntlLightPushInfo parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (IntlLightPushInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static IntlLightPushInfo parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (IntlLightPushInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static IntlLightPushInfo parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (IntlLightPushInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static IntlLightPushInfo parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (IntlLightPushInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static IntlLightPushInfo parseFrom(C3407e c3407e) throws IOException {
            return (IntlLightPushInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static IntlLightPushInfo parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (IntlLightPushInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class RefreshGiftTabBalanceMsg extends GeneratedMessageLite<RefreshGiftTabBalanceMsg, Builder> implements RefreshGiftTabBalanceMsgOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<RefreshGiftTabBalanceMsg, Builder> implements RefreshGiftTabBalanceMsgOrBuilder {
            private Builder() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C44201.f15943xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.userId_ = interfaceC3386h.mo16997f(!this.userId_.isEmpty(), this.userId_, !refreshGiftTabBalanceMsg.userId_.isEmpty(), refreshGiftTabBalanceMsg.userId_);
                    this.priceType_ = interfaceC3386h.mo16997f(!this.priceType_.isEmpty(), this.priceType_, true ^ refreshGiftTabBalanceMsg.priceType_.isEmpty(), refreshGiftTabBalanceMsg.priceType_);
                    GeneratedMessageLite.C3385g c3385g = GeneratedMessageLite.C3385g.INSTANCE;
                    return this;
                case 6:
                    C3407e c3407e = (C3407e) obj;
                        ...
                        try {
                            ...
                            if (iM17116M != 0) {
                                if (iM17116M == 10) {
                                    ...
                                    this.priceType_ = c3407e.m17115L();
        ...
        public int getSerializedSize() {
            ...
            if (!this.priceType_.isEmpty()) {
                iM16901K += CodedOutputStream.m16901K(2, getPriceType());
            }
            this.memoizedSerializedSize = iM16901K;
            return iM16901K;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            codedOutputStream.mo16939D0(2, getPriceType());
        }

        public static RefreshGiftTabBalanceMsg parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (RefreshGiftTabBalanceMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static RefreshGiftTabBalanceMsg parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (RefreshGiftTabBalanceMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static RefreshGiftTabBalanceMsg parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (RefreshGiftTabBalanceMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static RefreshGiftTabBalanceMsg parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (RefreshGiftTabBalanceMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static RefreshGiftTabBalanceMsg parseFrom(C3407e c3407e) throws IOException {
            return (RefreshGiftTabBalanceMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static RefreshGiftTabBalanceMsg parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (RefreshGiftTabBalanceMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
    ...
    public static final class RefreshVoiceOperationMsg extends GeneratedMessageLite<RefreshVoiceOperationMsg, Builder> implements RefreshVoiceOperationMsgOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3380b<RefreshVoiceOperationMsg, Builder> implements RefreshVoiceOperationMsgOrBuilder {
            private Builder() {
        ...
        public static RefreshVoiceOperationMsg parseDelimitedFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (RefreshVoiceOperationMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static RefreshVoiceOperationMsg parseFrom(ByteString byteString, C3410h c3410h) throws InvalidProtocolBufferException {
            return (RefreshVoiceOperationMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3410h);
        }
        ...
        public static RefreshVoiceOperationMsg parseFrom(byte[] bArr, C3410h c3410h) throws InvalidProtocolBufferException {
            return (RefreshVoiceOperationMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3410h);
        }
        ...
        public static RefreshVoiceOperationMsg parseFrom(InputStream inputStream, C3410h c3410h) throws IOException {
            return (RefreshVoiceOperationMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3410h);
        }

        public static RefreshVoiceOperationMsg parseFrom(C3407e c3407e) throws IOException {
            return (RefreshVoiceOperationMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e);
        }
        ...
        public static RefreshVoiceOperationMsg parseFrom(C3407e c3407e, C3410h c3410h) throws IOException {
            return (RefreshVoiceOperationMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3407e, c3410h);
        }
    }
}
