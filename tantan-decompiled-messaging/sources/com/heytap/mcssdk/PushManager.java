...
import com.heytap.mcssdk.p034a.C3455a;
import com.heytap.mcssdk.p034a.C3456b;
import com.heytap.mcssdk.p034a.C3459e;
import com.heytap.mcssdk.p034a.InterfaceC3458d;
import com.heytap.mcssdk.p035b.C3461a;
import com.heytap.mcssdk.p035b.C3462b;
import com.heytap.mcssdk.p035b.C3464d;
...
public class PushManager implements InterfaceC3460b {
    ...
    private List<InterfaceC3458d> mParsers;
    private List<InterfaceC3463c> mProcessors;
    ...
    private PushManager() {
        ...
        addParser(new C3455a());
        addParser(new C3459e());
        addParser(new C3456b());
        addProcessor(new C3461a());
        addProcessor(new C3464d());
        addProcessor(new C3462b());
    }

    private synchronized void addParser(InterfaceC3458d interfaceC3458d) {
        if (interfaceC3458d != null) {
            this.mParsers.add(interfaceC3458d);
        }
    }

    private synchronized void addProcessor(InterfaceC3463c interfaceC3463c) {
        if (interfaceC3463c != null) {
            this.mProcessors.add(interfaceC3463c);
        }
    }
    ...
    private void checkContext() {
        ...
        ig3.m135964a("please call the register first!");
    }
    ...
    private void checkRegisterID() {
        ...
        ig3.m135964a("please call the register until get the registerID!");
    }

    public static PushManager getInstance() {
        return C3467e.f11824a;
    }
    ...
    public static void statisticMessage(Context context, AppMessage appMessage, String str) {
        try {
            ...
            LogUtil.m17468e("statisticMessage--Exception" + e.getMessage());
        }
    }

    public void bindMcsService(int i) {
        Intent intent = getIntent(i, "", null);
        this.mContext.bindService(intent, new ServiceConnectionC3466d(this, intent), 1);
    }

    @Override // com.heytap.mcssdk.InterfaceC3465c
    ...
    public List<InterfaceC3458d> getParsers() {
        return this.mParsers;
    }

    public List<InterfaceC3463c> getProcessors() {
    ...
    @Override // com.heytap.mcssdk.InterfaceC3460b
    ...
    public /* synthetic */ PushManager(ServiceConnectionC3466d serviceConnectionC3466d) {
        this();
    }
