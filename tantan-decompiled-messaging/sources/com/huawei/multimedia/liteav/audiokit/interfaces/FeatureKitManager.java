...
public class FeatureKitManager {
        ...
        synchronized (BIND_SERVICE_LOCK) {
            try {
                ...
                try {
                    ...
                    TXCLog.m82968e(TAG, "bindService, SecurityException, %s", e.getMessage());
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public <T extends AudioFeaturesKit> T createFeatureKit(int i, Context context) {
        TXCLog.m82970i(TAG, "createFeatureKit, type = %d", Integer.valueOf(i));
        if (context == null) {
            return null;
        }
        if (i != 1) {
            TXCLog.m82969i(TAG, "createFeatureKit, type error");
            return null;
        }
    ...
    public boolean isAudioKitSupport(Context context) {
        ...
        try {
            ...
            TXCLog.m82969i(TAG, "packageInfo is null");
            return false;
        } catch (PackageManager.NameNotFoundException unused) {
            TXCLog.m82966e(TAG, "isAudioKitSupport ,NameNotFoundException");
            return false;
        }
    }

    public void onCallBack(int i) {
        TXCLog.m82970i(TAG, "onCallBack, result = %d", Integer.valueOf(i));
    ...
    public void unbindService(Context context, ServiceConnection serviceConnection) {
        TXCLog.m82969i(TAG, "unbindService");
