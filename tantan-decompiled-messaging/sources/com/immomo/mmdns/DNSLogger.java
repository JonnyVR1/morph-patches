...
class DNSLogger {
    ...
    public class ParseLog implements Jsonable {
        ...
        public JSONObject toJson() throws Exception {
            ...
            jSONObject.put(IjkMediaPlayer.OnNativeInvokeListener.ARG_IP, this.f12946ip);
    ...
    public class RateLog implements Jsonable {
        ...
        public JSONObject toJson() throws Exception {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("host", this.host);
            jSONObject.put(IjkMediaPlayer.OnNativeInvokeListener.ARG_IP, this.f12947ip);
    ...
    public class RequestLog implements Jsonable {
        ...
        public JSONObject toJson() throws Exception {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("dn", this.f12948dn);
