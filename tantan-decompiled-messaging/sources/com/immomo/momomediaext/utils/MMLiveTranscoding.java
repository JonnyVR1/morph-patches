...
public class MMLiveTranscoding implements Serializable {
    ...
    public static class MMLiveHasMember implements Serializable {
        ...
        public float f13957w;

        /* JADX INFO: renamed from: x */
        public float f13958x;

        /* JADX INFO: renamed from: y */
        public float f13959y;
    ...
    public static class MMLiveLinkMember implements Serializable {
        ...
        /* JADX INFO: renamed from: w */
        public float f13962w;

        /* JADX INFO: renamed from: x */
        public float f13963x;

        /* JADX INFO: renamed from: y */
        public float f13964y;
    ...
    public MMLiveTranscoding(String str) throws Exception {
        ...
        this.f13955ts = jSONObject.optLong(Constants.f57189TS);
        ...
        if (jSONArrayOptJSONArray2 != null) {
            ...
            while (i < jSONArrayOptJSONArray2.length()) {
                ...
                mMLiveLinkMember.volume = (float) jSONArrayOptJSONArray2.optJSONObject(i).optDouble(BaseSei.f13928VO);
                mMLiveLinkMember.muteFlag = jSONArrayOptJSONArray2.optJSONObject(i).optInt(BaseSei.f13926MU);
                mMLiveLinkMember.offlineFlag = jSONArrayOptJSONArray2.optJSONObject(i).optInt(BaseSei.f13927OL);
                mMLiveLinkMember.userid = jSONArrayOptJSONArray2.optJSONObject(i).optString("id");
                mMLiveLinkMember.f13962w = (float) jSONArrayOptJSONArray2.optJSONObject(i).optDouble("w");
                mMLiveLinkMember.f13961h = (float) jSONArrayOptJSONArray2.optJSONObject(i).optDouble("h");
                mMLiveLinkMember.f13963x = (float) jSONArrayOptJSONArray2.optJSONObject(i).optDouble(BaseSei.f13930X);
                mMLiveLinkMember.f13964y = (float) jSONArrayOptJSONArray2.optJSONObject(i).optDouble(BaseSei.f13931Y);
                mMLiveLinkMember.f13965z = jSONArrayOptJSONArray2.optJSONObject(i).optInt(BaseSei.f13932Z);
        ...
        if (jSONObject2.optJSONObject(BaseSei.INFO) != null && (jSONObjectOptJSONObject = jSONObject2.optJSONObject(BaseSei.INFO)) != null) {
            ...
            if (jSONArrayOptJSONArray3 != null) {
                for (int i2 = 0; i2 < jSONArrayOptJSONArray3.length(); i2++) {
                    ...
                    mMLiveLinkMember2.volume = (float) jSONArrayOptJSONArray3.optJSONObject(i2).optDouble(BaseSei.f13928VO);
                    mMLiveLinkMember2.muteFlag = jSONArrayOptJSONArray3.optJSONObject(i2).optInt(BaseSei.f13926MU);
                    mMLiveLinkMember2.offlineFlag = jSONArrayOptJSONArray3.optJSONObject(i2).optInt(BaseSei.f13927OL);
                    mMLiveLinkMember2.userid = jSONArrayOptJSONArray3.optJSONObject(i2).optString("id");
                    mMLiveLinkMember2.f13962w = (float) jSONArrayOptJSONArray3.optJSONObject(i2).optDouble("w");
                    mMLiveLinkMember2.f13961h = (float) jSONArrayOptJSONArray3.optJSONObject(i2).optDouble("h");
                    mMLiveLinkMember2.f13963x = (float) jSONArrayOptJSONArray3.optJSONObject(i2).optDouble(BaseSei.f13930X);
                    mMLiveLinkMember2.f13964y = (float) jSONArrayOptJSONArray3.optJSONObject(i2).optDouble(BaseSei.f13931Y);
                    mMLiveLinkMember2.f13965z = jSONArrayOptJSONArray3.optJSONObject(i2).optInt(BaseSei.f13932Z);
        ...
        for (int i3 = 0; i3 < jSONArrayOptJSONArray.length(); i3++) {
            ...
            mMLiveLinkMember3.volume = (float) jSONArrayOptJSONArray.optJSONObject(i3).optDouble(BaseSei.f13928VO);
            mMLiveLinkMember3.muteFlag = jSONArrayOptJSONArray.optJSONObject(i3).optInt(BaseSei.f13926MU);
            mMLiveLinkMember3.offlineFlag = jSONArrayOptJSONArray.optJSONObject(i3).optInt(BaseSei.f13927OL);
            mMLiveLinkMember3.userid = jSONArrayOptJSONArray.optJSONObject(i3).optString("id");
            mMLiveLinkMember3.f13962w = (float) jSONArrayOptJSONArray.optJSONObject(i3).optDouble("w");
            mMLiveLinkMember3.f13961h = (float) jSONArrayOptJSONArray.optJSONObject(i3).optDouble("h");
            mMLiveLinkMember3.f13963x = (float) jSONArrayOptJSONArray.optJSONObject(i3).optDouble(BaseSei.f13930X);
            mMLiveLinkMember3.f13964y = (float) jSONArrayOptJSONArray.optJSONObject(i3).optDouble(BaseSei.f13931Y);
            mMLiveLinkMember3.f13965z = jSONArrayOptJSONArray.optJSONObject(i3).optInt(BaseSei.f13932Z);
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.confMembers.size(); i++) {
            ...
            seiBean.setX(mMLiveLinkMember.f13963x);
            seiBean.setY(mMLiveLinkMember.f13964y);
            seiBean.setW(mMLiveLinkMember.f13962w);
            seiBean.setH(mMLiveLinkMember.f13961h);
            seiBean.setZ(mMLiveLinkMember.f13965z);
        ...
        for (int i2 = 0; i2 < this.infoMembers.size(); i2++) {
            ...
            seiBean2.setX(mMLiveLinkMember2.f13963x);
            seiBean2.setY(mMLiveLinkMember2.f13964y);
            seiBean2.setW(mMLiveLinkMember2.f13962w);
            seiBean2.setH(mMLiveLinkMember2.f13961h);
            seiBean2.setZ(mMLiveLinkMember2.f13965z);
        ...
        for (int i3 = 0; i3 < this.hasMembers.size(); i3++) {
            ...
            seiBean3.setX(mMLiveLinkMember3.f13963x);
            seiBean3.setY(mMLiveLinkMember3.f13964y);
            seiBean3.setW(mMLiveLinkMember3.f13962w);
            seiBean3.setH(mMLiveLinkMember3.f13961h);
            seiBean3.setZ(mMLiveLinkMember3.f13965z);
