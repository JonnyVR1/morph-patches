...
public class HttpHeaders implements Serializable {
    ...
    private static z4m mUserAgentGetter = null;
    ...
    public static String getUserAgent() {
        ...
        String string = null;
        try {
            string = nll.m160065a().getString(((Integer) Class.forName("com.android.internal.R$string").getDeclaredField("web_user_agent").get(null)).intValue());
    ...
    public static void setUserAgentGetter(z4m z4mVar) {
    }
