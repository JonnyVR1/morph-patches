...
public class LongTypeAdapter extends SafeErrorHandleTypeAdapter<Long> {
    ...
    public static /* synthetic */ class C3818a {
        ...
        static {
            ...
            try {
                f13125a[JsonToken.STRING.ordinal()] = 2;
    ...
    public Long read2(JsonReader jsonReader) throws IOException {
        ...
        int i = C3818a.f13125a[jsonTokenPeek.ordinal()];
        if (i == 1) {
            try {
        ...
        if (i != 2) {
            mo18623b(jsonReader, TypeToken.get(Long.class), jsonReader.getPath(), jsonTokenPeek);
