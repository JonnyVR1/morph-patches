...
@Metadata(m87231d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u000e\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u000f\u0010\b\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\n\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u0017\u0010\u000f\u001a\u00020\u000e2\b\u0010\r\u001a\u0004\u0018\u00010\f¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0011\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\u0011\u0010\tR\u0018\u0010\u0015\u001a\u0004\u0018\u00010\u00128\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0013\u0010\u0014R\u0018\u0010\u0019\u001a\u0004\u0018\u00010\u00168\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0016\u0010\u001c\u001a\u00020\u00078\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u001a\u0010\u001bR\"\u0010!\u001a\u00020\u00078\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u001d\u0010\u001b\u001a\u0004\b\u001e\u0010\t\"\u0004\b\u001f\u0010 R\u001b\u0010#\u001a\u00020\u00028BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0011\u0010\"\u001a\u0004\b\u001d\u0010\u000b¨\u0006$"}, m87232d2 = {"Lcom/immomo/molive/debuger/performance/tracer/memory/MemTracer;", "Ll/mr2;", "Ll/r7y;", "Ll/vh2;", "memConfig", "<init>", "(Ll/vh2;)V", "", "j", "()Z", "k", "()Ll/r7y;", "Landroid/content/Context;", "context", "", BLiveStormDanmakuGiftResourceType.f44444l, "(Landroid/content/Context;)V", RXScreenCaptureService.KEY_INDEX, "Landroid/app/ActivityManager;", "e", "Landroid/app/ActivityManager;", "mActivityManager", "Landroid/app/ActivityManager$MemoryInfo;", "f", "Landroid/app/ActivityManager$MemoryInfo;", "totalMemInfo", "g", "Z", "memTotalTracerEnable", "h", "getMemTracerEnable", "setMemTracerEnable", "(Z)V", "memTracerEnable", "Lkotlin/Lazy;", "currentMem", "apm-tracer_release"}, m87233k = 1, m87234mv = {1, 4, 0})
public final class MemTracer extends mr2<r7y> {
    ...
    public MemTracer(@NotNull vh2 vh2Var) {
        super(vh2Var);
        vh2Var.getClass();
        this.memTotalTracerEnable = true;
        this.memTracerEnable = true;
        this.currentMem = LazyKt__LazyJVMKt.m87229b(new Function0<r7y>() { // from class: com.immomo.molive.debuger.performance.tracer.memory.MemTracer$currentMem$2
            @Override // kotlin.jvm.functions.Function0
            @NotNull
            public final r7y invoke() {
                return new r7y(0, 0, 0, 6, null);
            }
        });
    }

    /* JADX INFO: renamed from: h */
    private final r7y m18594h() {
        return (r7y) this.currentMem.getValue();
    }

    /* JADX INFO: renamed from: j */
    private final boolean m18595j() {
    ...
    public r7y mo18567c() {
        ...
        try {
            ...
            if (totalPss >= 0) {
                m18594h().m178229e((int) (totalPss / 1024.0f));
            }
            ...
            if (memoryInfo3 != null) {
                if (memoryInfo3.totalMem <= 0 || memoryInfo3.availMem <= 0) {
                    ...
                    m18594h().m178230f((int) (memoryInfo3.availMem / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED));
                    m18594h().m178231g((int) (memoryInfo3.totalMem / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED));
                }
            }
    ...
    public final void m18598l(@Nullable Context context) {
        if (context == null) {
            this.memTracerEnable = false;
            return;
        }
        ...
        if (systemService == null) {
            ox50.m166495a("null cannot be cast to non-null type android.app.ActivityManager");
        } else {
