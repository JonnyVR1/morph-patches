...
public final class ShapeEntity extends Message<ShapeEntity, Builder> {
    ...
    public static final class ShapeArgs extends Message<ShapeArgs, Builder> {
        ...
        public static final class Builder extends Message.Builder<ShapeArgs, Builder> {
            ...
            public ShapeArgs build() {
                return new ShapeArgs(this.f14075d, super.buildUnknownFields());
            }

            /* JADX INFO: renamed from: d */
            public Builder m19470d(String str) {
                this.f14075d = str;
                return this;
            }
        }
            ...
            public ShapeArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag != 1) {
                        ...
                        builder.m19470d(ProtoAdapter.STRING.decode(protoReader));
                    }
                }
            }
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(shapeArgs.unknownFields()) && Internal.equals(this.f14074d, shapeArgs.f14074d);
        }
    ...
    public static final class ShapeStyle extends Message<ShapeStyle, Builder> {
        ...
        public static final class RGBAColor extends Message<RGBAColor, Builder> {
            ...
            public static final class Builder extends Message.Builder<RGBAColor, Builder> {
                ...
                /* JADX INFO: renamed from: a */
                public Builder m19471a(Float f) {
                    this.f14080a = f;
                    return this;
                }

                /* JADX INFO: renamed from: b */
                public Builder m19472b(Float f) {
                    this.f14081b = f;
                    return this;
                }
                ...
                public RGBAColor build() {
                    return new RGBAColor(this.f14083r, this.f14082g, this.f14081b, this.f14080a, super.buildUnknownFields());
                }

                /* JADX INFO: renamed from: g */
                public Builder m19473g(Float f) {
                    this.f14082g = f;
                    return this;
                }

                /* JADX INFO: renamed from: r */
                public Builder m19474r(Float f) {
                    this.f14083r = f;
                    return this;
                }
            }
            ...
            public static final class ProtoAdapter_RGBAColor extends ProtoAdapter<RGBAColor> {
                ...
                public RGBAColor decode(ProtoReader protoReader) throws IOException {
                    ...
                    while (true) {
                        ...
                        if (iNextTag == 1) {
                            builder.m19474r(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag == 2) {
                            builder.m19473g(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag == 3) {
                            builder.m19472b(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag != 4) {
                            FieldEncoding fieldEncodingPeekFieldEncoding = protoReader.peekFieldEncoding();
                            builder.addUnknownField(iNextTag, fieldEncodingPeekFieldEncoding, fieldEncodingPeekFieldEncoding.rawProtoAdapter().decode(protoReader));
                        } else {
                            builder.m19471a(ProtoAdapter.FLOAT.decode(protoReader));
                        }
                    }
                }
            ...
            public boolean equals(Object obj) {
                ...
                return unknownFields().equals(rGBAColor.unknownFields()) && Internal.equals(this.f14079r, rGBAColor.f14079r) && Internal.equals(this.f14078g, rGBAColor.f14078g) && Internal.equals(this.f14077b, rGBAColor.f14077b) && Internal.equals(this.f14076a, rGBAColor.f14076a);
            }
            ...
            public Builder newBuilder() {
                Builder builder = new Builder();
                builder.f14083r = this.f14079r;
                builder.f14082g = this.f14078g;
                builder.f14081b = this.f14077b;
                builder.f14080a = this.f14076a;
                builder.addUnknownFields(unknownFields());
                return builder;
            }
    ...
    public static final class EllipseArgs extends Message<EllipseArgs, Builder> {
        ...
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 1)
        public final Float f14066x;

        /* JADX INFO: renamed from: y */
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 2)
        public final Float f14067y;
        ...
        public static final class Builder extends Message.Builder<EllipseArgs, Builder> {
            ...
            public EllipseArgs build() {
                return new EllipseArgs(this.f14068x, this.f14069y, this.radiusX, this.radiusY, super.buildUnknownFields());
            }
            ...
            /* JADX INFO: renamed from: x */
            public Builder m19466x(Float f) {
                this.f14068x = f;
                return this;
            }

            /* JADX INFO: renamed from: y */
            public Builder m19467y(Float f) {
                this.f14069y = f;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_EllipseArgs extends ProtoAdapter<EllipseArgs> {
            ...
            public EllipseArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == 1) {
                        builder.m19466x(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 2) {
                        builder.m19467y(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 3) {
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(ellipseArgs.unknownFields()) && Internal.equals(this.f14066x, ellipseArgs.f14066x) && Internal.equals(this.f14067y, ellipseArgs.f14067y) && Internal.equals(this.radiusX, ellipseArgs.radiusX) && Internal.equals(this.radiusY, ellipseArgs.radiusY);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = unknownFields().hashCode() * 37;
            Float f = this.f14066x;
            int iHashCode2 = (iHashCode + (f != null ? f.hashCode() : 0)) * 37;
            Float f2 = this.f14067y;
            int iHashCode3 = (iHashCode2 + (f2 != null ? f2.hashCode() : 0)) * 37;
        ...
        public Builder newBuilder() {
            Builder builder = new Builder();
            builder.f14068x = this.f14066x;
            builder.f14069y = this.f14067y;
    ...
    public static final class RectArgs extends Message<RectArgs, Builder> {
        ...
        public static final class Builder extends Message.Builder<RectArgs, Builder> {
            ...
            /* JADX INFO: renamed from: x */
            public Float f14072x;

            /* JADX INFO: renamed from: y */
            public Float f14073y;

            @Override // com.squareup.wire.Message.Builder
            public RectArgs build() {
                return new RectArgs(this.f14072x, this.f14073y, this.width, this.height, this.cornerRadius, super.buildUnknownFields());
            }
            ...
            /* JADX INFO: renamed from: x */
            public Builder m19468x(Float f) {
                this.f14072x = f;
                return this;
            }

            /* JADX INFO: renamed from: y */
            public Builder m19469y(Float f) {
                this.f14073y = f;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_RectArgs extends ProtoAdapter<RectArgs> {
            ...
            public RectArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == 1) {
                        builder.m19468x(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 2) {
                        builder.m19469y(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 3) {
            ...
            public void encode(ProtoWriter protoWriter, RectArgs rectArgs) throws IOException {
                Float f = rectArgs.f14070x;
                if (f != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 1, f);
                }
                Float f2 = rectArgs.f14071y;
                if (f2 != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 2, f2);
                }
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(rectArgs.unknownFields()) && Internal.equals(this.f14070x, rectArgs.f14070x) && Internal.equals(this.f14071y, rectArgs.f14071y) && Internal.equals(this.width, rectArgs.width) && Internal.equals(this.height, rectArgs.height) && Internal.equals(this.cornerRadius, rectArgs.cornerRadius);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = unknownFields().hashCode() * 37;
            Float f = this.f14070x;
            int iHashCode2 = (iHashCode + (f != null ? f.hashCode() : 0)) * 37;
            Float f2 = this.f14071y;
            int iHashCode3 = (iHashCode2 + (f2 != null ? f2.hashCode() : 0)) * 37;
            Float f3 = this.width;
            int iHashCode4 = (iHashCode3 + (f3 != null ? f3.hashCode() : 0)) * 37;
        ...
        public Builder newBuilder() {
            Builder builder = new Builder();
            builder.f14072x = this.f14070x;
            builder.f14073y = this.f14071y;
