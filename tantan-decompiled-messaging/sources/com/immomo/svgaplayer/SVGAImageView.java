...
public class SVGAImageView extends ImageView implements SVGAParser.ParseCompletion {
    ...
    @Metadata(m87230bv = {1, 0, 2}, m87231d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, m87232d2 = {"Lcom/immomo/svgaplayer/SVGAImageView$FillMode;", "", "(Ljava/lang/String;I)V", "Backward", "Forward", "svgalibrary_release"}, m87233k = 1, m87234mv = {1, 1, 10})
    ...
    private final void loadAttrs(AttributeSet attrs) {
        ...
        context.getClass();
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attrs, C3966R.styleable.SVGAImageView, 0, 0);
        setLoops(typedArrayObtainStyledAttributes.getInt(C3966R.styleable.SVGAImageView_loopCount, 0));
        this.addCache = typedArrayObtainStyledAttributes.getBoolean(C3966R.styleable.SVGAImageView_addCache, true);
        this.clearsAfterStop = typedArrayObtainStyledAttributes.getBoolean(C3966R.styleable.SVGAImageView_clearsAfterStop, true);
        this.mStartFrame = typedArrayObtainStyledAttributes.getInt(C3966R.styleable.SVGAImageView_startFrame, 0);
        this.mEndFrame = typedArrayObtainStyledAttributes.getInt(C3966R.styleable.SVGAImageView_endFrame, 0);
        this.antiAlias = typedArrayObtainStyledAttributes.getBoolean(C3966R.styleable.SVGAImageView_antiAlias, true);
        this.autoPlay = typedArrayObtainStyledAttributes.getBoolean(C3966R.styleable.SVGAImageView_autoPlay, true);
        String string = typedArrayObtainStyledAttributes.getString(C3966R.styleable.SVGAImageView_fillMode);
        if (string != null) {
            if (Intrinsics.m87488d(string, "0")) {
                this.fillMode = FillMode.Backward;
            } else if (Intrinsics.m87488d(string, "1")) {
                this.fillMode = FillMode.Forward;
            }
        }
        String string2 = typedArrayObtainStyledAttributes.getString(C3966R.styleable.SVGAImageView_source);
        if (string2 != null) {
            Context context2 = getContext();
            context2.getClass();
            SVGAParser sVGAParser = new SVGAParser(context2);
            if (C15386d.m93483J(string2, "http://", false, 2, null) || C15386d.m93483J(string2, "https://", false, 2, null)) {
    ...
    public static /* bridge */ /* synthetic */ void startAnimation$default(SVGAImageView sVGAImageView, SVGARange sVGARange, boolean z, int i, Object obj) {
        if (obj != null) {
            qq3.m175877a("Super calls with default arguments not supported in this target, function: startAnimation");
            return;
        }
        if ((i & 2) != 0) {
            z = false;
    ...
    public final SVGAAnimListenerAdapter getCallBack() {
        ...
        if (sVGACallback instanceof SVGAAnimListenerAdapter) {
            ...
            ox50.m166495a("null cannot be cast to non-null type com.immomo.svgaplayer.SVGAAnimListenerAdapter");
        }
        return null;
    }
                ...
                valueAnimator3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.immomo.svgaplayer.SVGAImageView$startAnimation$$inlined$let$lambda$1
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator4) {
                        ...
                        if (animatedValue == null) {
                            ox50.m166495a("null cannot be cast to non-null type kotlin.Int");
                            return;
                        }
