...
public abstract class MediaCodecBase {
    ...
    public int initCodec(boolean z) {
        try {
            ...
            Log4Cam.m18379e(TAG, "Configure AudioEncode Error : " + e.toString());
    ...
    public int processFrame(ByteBuffer byteBuffer, long j) {
        ...
        if (iDequeueOutputBuffer >= 0) {
            ...
            if ((bufferInfo.flags & 4) != 0) {
                Log4Cam.m18379e(TAG, "AudioEnoce END_OF_STREAM");
        ...
        if (iDequeueOutputBuffer == -3) {
            ...
            Log4Cam.m18379e(TAG, "AudioEnoce output buffers have changed.");
            return 0;
        }
        if (iDequeueOutputBuffer != -2) {
            Log4Cam.m18379e(TAG, "AudioEnoce Error : dequeueOutputBuffer returned " + iDequeueOutputBuffer);
            return -2;
        }
        ...
        Log4Cam.m18379e(TAG, "AudioEnoce output format has changed to " + outputFormat);
        return 0;
    }
