        ...
        this.mRecordRunable = new Runnable() { // from class: com.immomo.mediabase.AudioRecordEx.1
            ...
            public void run() {
                ...
                if (AudioRecordEx.this.mAudioRecord != null) {
                    while (AudioRecordEx.this.mAudioRecord.getState() == 0 && this.f12945i < 5) {
                        try {
                            Thread.sleep(100L);
                            this.f12945i++;
                    ...
                    try {
                        ...
                        this.f12945i = 0;
                        while (AudioRecordEx.this.mAudioRecord.getRecordingState() != 3 && this.f12945i < 10) {
                            try {
                                Thread.sleep(100L);
                                this.f12945i++;
                                AudioRecordEx.this.mAudioRecord.startRecording();
