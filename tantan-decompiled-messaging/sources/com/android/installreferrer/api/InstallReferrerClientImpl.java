...
class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public final class ServiceConnectionC0912b implements ServiceConnection {

        /* JADX INFO: renamed from: a */
        private final InstallReferrerStateListener f4139a;

        private ServiceConnectionC0912b(InstallReferrerStateListener installReferrerStateListener) {
            if (installReferrerStateListener != null) {
                this.f4139a = installReferrerStateListener;
            } else {
                upk0.m194883a("Please specify a listener to know when setup is done.");
                throw null;
            }
        }
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            InstallReferrerClientImpl.this.f4137c = asl.AbstractBinderC15708a.m98597P2(iBinder);
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        if (!isReady()) {
            qkq0.m175383a("Service not connected. Please start a connection before using the service.");
            return null;
        }
        Bundle bundle = new Bundle();
        bundle.putString("package_name", this.f4136b.getPackageName());
        try {
            return new ReferrerDetails(this.f4137c.mo98596Z0(bundle));
    ...
    public void startConnection(InstallReferrerStateListener installReferrerStateListener) {
        ...
        if (!"com.android.vending".equals(str) || str2 == null || !m5078c()) {
        ...
        ServiceConnectionC0912b serviceConnectionC0912b = new ServiceConnectionC0912b(installReferrerStateListener);
        this.f4138d = serviceConnectionC0912b;
        try {
            if (this.f4136b.bindService(intent2, serviceConnectionC0912b, 1)) {
