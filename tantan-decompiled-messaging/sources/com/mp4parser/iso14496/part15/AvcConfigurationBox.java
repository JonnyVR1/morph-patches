...
public final class AvcConfigurationBox extends AbstractBox {
    ...
    public int getAvcLevelIndication() {
        ...
        return this.avcDecoderConfigurationRecord.f119034d;
    }

    public int getAvcProfileIndication() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_1, this, this));
        return this.avcDecoderConfigurationRecord.f119032b;
    }

    public int getBitDepthChromaMinus8() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_18, this, this));
        return this.avcDecoderConfigurationRecord.f119041k;
    }

    public int getBitDepthLumaMinus8() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_16, this, this));
        return this.avcDecoderConfigurationRecord.f119040j;
    }

    public int getChromaFormat() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_14, this, this));
        return this.avcDecoderConfigurationRecord.f119039i;
    }

    public int getConfigurationVersion() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_0, this, this));
        return this.avcDecoderConfigurationRecord.f119031a;
    }

    @Override // com.googlecode.mp4parser.AbstractBox
    public void getContent(ByteBuffer byteBuffer) {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_25, this, this, byteBuffer));
    ...
    public List<byte[]> getPictureParameterSets() {
        ...
        return Collections.unmodifiableList(this.avcDecoderConfigurationRecord.f119037g);
    }

    public int getProfileCompatibility() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_2, this, this));
        return this.avcDecoderConfigurationRecord.f119033c;
    }
    ...
    public List<byte[]> getSequenceParameterSetExts() {
        ...
        return this.avcDecoderConfigurationRecord.f119042l;
    }

    public List<byte[]> getSequenceParameterSets() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_5, this, this));
        return Collections.unmodifiableList(this.avcDecoderConfigurationRecord.f119036f);
    }
    ...
    public boolean hasExts() {
        ...
        return this.avcDecoderConfigurationRecord.f119038h;
    }
    ...
    public void setAvcLevelIndication(int i) {
        ...
        this.avcDecoderConfigurationRecord.f119034d = i;
    }
    ...
    public void setAvcProfileIndication(int i) {
        ...
        this.avcDecoderConfigurationRecord.f119032b = i;
    }
    ...
    public void setBitDepthChromaMinus8(int i) {
        ...
        this.avcDecoderConfigurationRecord.f119041k = i;
    }
    ...
    public void setConfigurationVersion(int i) {
        ...
        this.avcDecoderConfigurationRecord.f119031a = i;
    }

    public void setHasExts(boolean z) {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_23, this, this, Conversions.booleanObject(z)));
        this.avcDecoderConfigurationRecord.f119038h = z;
    }
    ...
    public void setLengthSizeMinusOne(int i) {
        ...
        this.avcDecoderConfigurationRecord.f119035e = i;
    }

    public void setPictureParameterSets(List<byte[]> list) {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_13, this, this, list));
        this.avcDecoderConfigurationRecord.f119037g = list;
    }
    ...
    public void setProfileCompatibility(int i) {
        ...
        this.avcDecoderConfigurationRecord.f119033c = i;
    }

    public void setSequenceParameterSetExts(List<byte[]> list) {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_21, this, this, list));
        this.avcDecoderConfigurationRecord.f119042l = list;
    }

    public void setSequenceParameterSets(List<byte[]> list) {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_12, this, this, list));
        this.avcDecoderConfigurationRecord.f119036f = list;
    }

    public String toString() {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_29, this, this));
