...
public class TierBitRateBox extends AbstractBox {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        this.baseBitRate = yyp.m216558k(byteBuffer);
        this.maxBitRate = yyp.m216558k(byteBuffer);
        this.avgBitRate = yyp.m216558k(byteBuffer);
        this.tierBaseBitRate = yyp.m216558k(byteBuffer);
        this.tierMaxBitRate = yyp.m216558k(byteBuffer);
        this.tierAvgBitRate = yyp.m216558k(byteBuffer);
    }
    ...
    public void getContent(ByteBuffer byteBuffer) {
        bzp.m104635g(byteBuffer, this.baseBitRate);
        bzp.m104635g(byteBuffer, this.maxBitRate);
        bzp.m104635g(byteBuffer, this.avgBitRate);
        bzp.m104635g(byteBuffer, this.tierBaseBitRate);
        bzp.m104635g(byteBuffer, this.tierMaxBitRate);
        bzp.m104635g(byteBuffer, this.tierAvgBitRate);
    }
