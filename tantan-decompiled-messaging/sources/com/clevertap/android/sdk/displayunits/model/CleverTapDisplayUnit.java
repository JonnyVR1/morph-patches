...
public class CleverTapDisplayUnit implements Parcelable {
    public static final Parcelable.Creator<CleverTapDisplayUnit> CREATOR = new C1182a();
    ...
    public class C1182a implements Parcelable.Creator<CleverTapDisplayUnit> {
    ...
    private CleverTapDisplayUnit(Parcel parcel) {
        try {
            ...
            this.error = str;
            Logger.m5866d(Constants.FEATURE_DISPLAY_UNIT, str);
        }
    }

    @NonNull
    /* JADX INFO: renamed from: d */
    public static CleverTapDisplayUnit m5999d(JSONObject jSONObject) {
        try {
            ...
            if (jSONArray != null) {
                for (int i = 0; i < jSONArray.length(); i++) {
                    CleverTapDisplayUnitContent cleverTapDisplayUnitContentM6005b = CleverTapDisplayUnitContent.m6005b(jSONArray.getJSONObject(i));
                    if (TextUtils.isEmpty(cleverTapDisplayUnitContentM6005b.m6006a())) {
                        arrayList.add(cleverTapDisplayUnitContentM6005b);
                    }
                }
            }
            ...
            Logger.m5866d(Constants.FEATURE_DISPLAY_UNIT, "Unable to init CleverTapDisplayUnit with JSON - " + e.getLocalizedMessage());
    ...
    public HashMap<String, String> m6001b(JSONObject jSONObject) {
        if (jSONObject != null) {
            try {
                ...
                Logger.m5866d(Constants.FEATURE_DISPLAY_UNIT, "Error in getting Key Value Pairs " + e.getLocalizedMessage());
            }
        }
        return null;
    }
    ...
    public String toString() {
        try {
            ...
            Logger.m5866d(Constants.FEATURE_DISPLAY_UNIT, "Exception in toString:" + e);
    ...
    private CleverTapDisplayUnit(JSONObject jSONObject, String str, CTDisplayUnitType cTDisplayUnitType, String str2, ArrayList<CleverTapDisplayUnitContent> arrayList, JSONObject jSONObject2, String str3) {
        ...
        this.bgColor = str2;
        this.contents = arrayList;
        this.customExtras = m6001b(jSONObject2);
        this.error = str3;
    }

    public /* synthetic */ CleverTapDisplayUnit(Parcel parcel, C1182a c1182a) {
        this(parcel);
    }
}
