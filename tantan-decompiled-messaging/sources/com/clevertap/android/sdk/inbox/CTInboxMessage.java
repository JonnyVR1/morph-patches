...
public class CTInboxMessage implements Parcelable {
    public static final Parcelable.Creator<CTInboxMessage> CREATOR = new C1280a();
    ...
    public class C1280a implements Parcelable.Creator<CTInboxMessage> {
    ...
    public CTInboxMessage(JSONObject jSONObject) {
        ...
        try {
            ...
            if (jSONObject2 != null) {
                ...
                if (jSONArray2 != null) {
                    for (int i2 = 0; i2 < jSONArray2.length(); i2++) {
                        this.inboxMessageContents.add(new CTInboxMessageContent().m6713u(jSONArray2.getJSONObject(i2)));
                    }
                }
            ...
            Logger.m5873v("Unable to init CTInboxMessage with JSON - " + e.getLocalizedMessage());
        }
    }
    ...
    public ArrayList<gv3> m6680b() {
        ArrayList<gv3> arrayList = new ArrayList<>();
        for (CTInboxMessageContent cTInboxMessageContent : m6682d()) {
            arrayList.add(new gv3(cTInboxMessageContent.m6706n(), cTInboxMessageContent.m6707o()));
        }
        return arrayList;
    }
    ...
    public ArrayList<CTInboxMessageContent> m6682d() {
    ...
    public String m6683e() {
        return this.messageId;
    }

    /* JADX INFO: renamed from: f */
    public String m6684f() {
        return this.orientation;
    }

    /* JADX INFO: renamed from: g */
    public List<String> m6685g() {
        return this.tags;
    }

    /* JADX INFO: renamed from: h */
    public CTInboxMessageType m6686h() {
        return this.type;
    }

    /* JADX INFO: renamed from: i */
    public JSONObject m6687i() {
        JSONObject jSONObject = this.wzrkParams;
        return jSONObject == null ? new JSONObject() : jSONObject;
    }

    /* JADX INFO: renamed from: k */
    public boolean m6688k() {
        return this.isRead;
    }

    /* JADX INFO: renamed from: l */
    public void m6689l(boolean z) {
        this.isRead = z;
    }
    ...
    public /* synthetic */ CTInboxMessage(Parcel parcel, C1280a c1280a) {
        this(parcel);
    }
    ...
    private CTInboxMessage(Parcel parcel) {
        ...
        try {
            ...
            Logger.m5873v("Unable to parse CTInboxMessage from parcel - " + e.getLocalizedMessage());
        }
    }
}
