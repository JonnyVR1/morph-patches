...
public class CleverTapInstanceConfig implements Parcelable {
    public static final Parcelable.Creator<CleverTapInstanceConfig> CREATOR = new C1165a();
    ...
    @NonNull
    private final ArrayList<ggb0> pushTypes;
    ...
    public class C1165a implements Parcelable.Creator<CleverTapInstanceConfig> {
    ...
    private CleverTapInstanceConfig(String str) throws Throwable {
        this.pushTypes = PushNotificationUtil.m6930b();
        ...
        try {
            ...
            if (jSONObject.has(KEY_IDENTITY_TYPES)) {
                this.identityKeys = (String[]) mv3.m156468g(jSONObject.getJSONArray(KEY_IDENTITY_TYPES));
            }
            ...
            if (jSONObject.has(KEY_PUSH_TYPES)) {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ggb0 ggb0VarM125955a = ggb0.m125955a(jSONArray.getJSONObject(i));
                    if (ggb0VarM125955a != null) {
                        addPushType(ggb0VarM125955a);
                    }
                }
            }
            this.encryptionInTransit = jSONObject.optString(KEY_ENCRYPTION_IN_TRANSIT, "0");
        } catch (Throwable th) {
            Logger.m5876v("Error constructing CleverTapInstanceConfig from JSON: " + str + ": ", th.getCause());
            throw th;
        }
    }
    ...
    private void buildPushProvidersFromManifest(ManifestInfo manifestInfo) {
        ...
        String[] strArrSplit2;
        try {
            String strM5894q = manifestInfo.m5894q();
            if (strM5894q != null && (strArrSplit2 = strM5894q.split(Constants.SEPARATOR_COMMA)) != null && strArrSplit2.length == 4) {
                addPushType(new ggb0(strArrSplit2[0].trim(), strArrSplit2[1].trim(), strArrSplit2[2].trim(), strArrSplit2[3].trim()));
            }
            String strM5895r = manifestInfo.m5895r();
            if (strM5895r == null || (strArrSplit = strM5895r.split(Constants.SEPARATOR_COMMA)) == null || strArrSplit.length != 4) {
                return;
            }
            addPushType(new ggb0(strArrSplit[0].trim(), strArrSplit[1].trim(), strArrSplit[2].trim(), strArrSplit[3].trim()));
        } catch (Exception unused) {
            Logger.m5873v("There was some problem in loading push providers from manifest");
        }
    }
    ...
    public static CleverTapInstanceConfig createInstance(@NonNull Context context, @NonNull String str, @NonNull String str2, @Nullable String str3) {
        ...
        Logger.m5869i("CleverTap accountId and accountToken cannot be null");
        return null;
    }
    ...
    public static CleverTapInstanceConfig getDefaultInstance(Context context) {
        ...
        if (strM5880c != null && strM5882e != null) {
            return createInstanceWithManifest(manifestInfo, strM5880c, strM5882e, manifestInfo.m5881d(), true);
        }
        Logger.m5869i("Account ID or Account token is missing from AndroidManifest.xml, unable to create default CleverTapInstanceConfig");
        return null;
    }
    ...
    private JSONArray getPushTypesArray() {
        ...
        for (ggb0 ggb0Var : getPushTypes()) {
            if (ggb0Var != ceb0.f80450a) {
                jSONArray.put(ggb0Var.m125960f());
            }
        }
        return jSONArray;
    }

    public void addPushType(@NonNull ggb0 ggb0Var) {
        if (this.pushTypes.contains(ggb0Var)) {
            return;
        }
        this.pushTypes.add(ggb0Var);
    }
    ...
    @NonNull
    public ArrayList<ggb0> getPushTypes() {
    ...
    public boolean isEncryptionInTransitEnabled() {
        try {
            ...
            Logger.m5873v("Invalid value passed in manifest for encryption in transit");
            return false;
        }
    }
    ...
    public String toJSONString() {
        ...
        try {
            ...
            Logger.m5876v("Unable to convert config to JSON : ", th.getCause());
            return null;
        }
    }
    ...
    public CleverTapInstanceConfig(CleverTapInstanceConfig cleverTapInstanceConfig) {
        ...
        Iterator<ggb0> it = cleverTapInstanceConfig.pushTypes.iterator();
        while (it.hasNext()) {
            addPushType(it.next());
        }
    ...
    private CleverTapInstanceConfig(ManifestInfo manifestInfo, String str, String str2, String str3, boolean z) {
        ...
        this.useGoogleAdId = manifestInfo.m5900x();
        this.disableAppLaunchedEvent = manifestInfo.m5896s();
        this.sslPinning = manifestInfo.m5898u();
        this.backgroundSync = manifestInfo.m5897t();
        this.fcmSenderId = manifestInfo.m5887j();
        this.packageName = manifestInfo.m5890m();
        this.enableCustomCleverTapId = manifestInfo.m5899w();
        this.beta = manifestInfo.m5879b();
        if (this.isDefaultInstance) {
            this.encryptionLevel = manifestInfo.m5885h();
            this.identityKeys = manifestInfo.m5891n();
        ...
        String strM5884g = manifestInfo.m5884g();
        this.encryptionInTransit = strM5884g == null ? "0" : strM5884g;
    }

    public /* synthetic */ CleverTapInstanceConfig(Parcel parcel, C1165a c1165a) {
        this(parcel);
    }
    ...
    private CleverTapInstanceConfig(Parcel parcel) {
        ...
        try {
            ...
            Logger.m5873v("Error in loading push providers from parcel, using firebase");
        }
    }
}
