...
@Metadata(m87231d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, m87232d2 = {"Ll/ppb;", "Lkotlin/Pair;", "", "", "<anonymous>", "(Ll/ppb;)Lkotlin/Pair;"}, m87233k = 3, m87234mv = {2, 0, 0})
@DebugMetadata(m87373c = "com.clevertap.android.sdk.inapp.images.preload.FilePreloaderCoroutine$preloadAssets$job$1$1$deferred$1", m87374f = "FilePreloaderCoroutine.kt", m87375l = {}, m87376m = "invokeSuspend")
@SourceDebugExtension
public final class FilePreloaderCoroutine$preloadAssets$job$1$1$deferred$1 extends SuspendLambda implements Function2<ppb, Continuation<? super Pair<? extends String, ? extends Boolean>>, Object> {
    ...
    public final Object invoke2(ppb ppbVar, Continuation<? super Pair<String, Boolean>> continuation) {
        return ((FilePreloaderCoroutine$preloadAssets$job$1$1$deferred$1) create(ppbVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        this.$results.put(this.$meta.getFirst(), Boxing.m87370a(booleanRef.element));
        return TuplesKt.m87240a(this.$meta.getFirst(), Boxing.m87370a(booleanRef.element));
    }

    @Override // kotlin.jvm.functions.Function2
    public /* bridge */ /* synthetic */ Object invoke(ppb ppbVar, Continuation<? super Pair<? extends String, ? extends Boolean>> continuation) {
        return invoke2(ppbVar, (Continuation<? super Pair<String, Boolean>>) continuation);
    }
}
