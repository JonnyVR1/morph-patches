...
public final class CTInAppNotificationButton implements Parcelable {
    ...
    @JvmField
    @NotNull
    public static final Parcelable.Creator<CTInAppNotificationButton> CREATOR = new C1203a();

    /* JADX INFO: renamed from: com.clevertap.android.sdk.inapp.CTInAppNotificationButton$a */
    @Metadata(m87231d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u001f\u0010\n\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\t2\u0006\u0010\b\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m87232d2 = {"com/clevertap/android/sdk/inapp/CTInAppNotificationButton$a", "Landroid/os/Parcelable$Creator;", "Lcom/clevertap/android/sdk/inapp/CTInAppNotificationButton;", "Landroid/os/Parcel;", "parcel", "a", "(Landroid/os/Parcel;)Lcom/clevertap/android/sdk/inapp/CTInAppNotificationButton;", "", "size", "", "b", "(I)[Lcom/clevertap/android/sdk/inapp/CTInAppNotificationButton;", "clevertap-core_release"}, m87233k = 1, m87234mv = {2, 0, 0}, m87236xi = 48)
    public static final class C1203a implements Parcelable.Creator<CTInAppNotificationButton> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.m87488d(CTInAppNotificationButton.class, other != null ? other.getClass() : null)) {
            return false;
        }
        other.getClass();
        CTInAppNotificationButton cTInAppNotificationButton = (CTInAppNotificationButton) other;
        return Intrinsics.m87488d(this.backgroundColor, cTInAppNotificationButton.backgroundColor) && Intrinsics.m87488d(this.borderColor, cTInAppNotificationButton.borderColor) && Intrinsics.m87488d(this.borderRadius, cTInAppNotificationButton.borderRadius) && Intrinsics.m87488d(this.text, cTInAppNotificationButton.text) && Intrinsics.m87488d(this.textColor, cTInAppNotificationButton.textColor) && Intrinsics.m87488d(this.action, cTInAppNotificationButton.action);
    }
    ...
    public CTInAppNotificationButton(@NotNull JSONObject jSONObject) {
        ...
        this.action = CTInAppAction.INSTANCE.m6131b(jSONObject.optJSONObject(Constants.KEY_ACTIONS));
    }
