...
public class CTPushNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            CleverTapAPI.m5759S(context, extras);
            ...
            Logger.m5865d("CTPushNotificationReceiver: handled notification: " + extras.toString());
        } catch (Throwable th) {
            Logger.m5876v("CTPushNotificationReceiver: error handling notification", th);
        }
    }
}
