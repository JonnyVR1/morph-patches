...
public class CTNotificationIntentService extends IntentService {
    ...
    private q30 mActionButtonClickHandler;
    ...
    private void handleActionButtonClick(Bundle bundle) {
        ...
        try {
            ...
            if (!this.mActionButtonClickHandler.mo6927c(applicationContext, bundle, i) && Build.VERSION.SDK_INT < 31) {
                if (string != null) {
                ...
                if (launchIntentForPackage == null) {
                    Logger.m5873v("CTNotificationService: create launch intent.");
                    return;
                }
                launchIntentForPackage.setFlags(872415232);
                CleverTapAPI.m5759S(applicationContext, bundle);
            ...
            Logger.m5873v("CTNotificationService: unable to process action button click:  " + th.getLocalizedMessage());
        }
    }
    ...
    public void onHandleIntent(Intent intent) {
        ...
        ar40 ar40VarM5756P = CleverTapAPI.m5756P();
        if (!PushNotificationHandler.isForPushTemplates(extras) || ar40VarM5756P == null) {
            this.mActionButtonClickHandler = (q30) PushNotificationHandler.m6923d();
        } else {
            this.mActionButtonClickHandler = (q30) ar40VarM5756P;
        }
        if (TYPE_BUTTON_CLICK.equals(extras.getString(Constants.KEY_CT_TYPE))) {
            Logger.m5873v("CTNotificationIntentService handling com.clevertap.ACTION_BUTTON_CLICK");
            handleActionButtonClick(extras);
        } else {
            Logger.m5873v("CTNotificationIntentService: unhandled intent " + intent.getAction());
        }
    }
}
