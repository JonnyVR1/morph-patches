...
public final /* data */ class ProjectLibrary {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.m87488d(ProjectLibrary.class, other != null ? other.getClass() : null)) {
            return false;
        }
        other.getClass();
        ProjectLibrary projectLibrary = (ProjectLibrary) other;
        return Intrinsics.m87488d(this.name, projectLibrary.name) && Intrinsics.m87488d(this.md5, projectLibrary.md5) && Intrinsics.m87488d(this.size, projectLibrary.size) && Intrinsics.m87488d(this.abi, projectLibrary.abi);
    }
