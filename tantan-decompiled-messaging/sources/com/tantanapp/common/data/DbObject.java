...
public abstract class DbObject<D extends ValueObject> extends ValueObject<D> implements Cloneable {
    ...
    public static final StringColumn f56009ID = new StringColumn<DbObject>("id_c") { // from class: com.tantanapp.common.data.DbObject.1
        @Override // com.tantanapp.common.data.orm.Column
        public String get(DbObject dbObject) {
            return dbObject.f56011id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(DbObject dbObject, String str) {
            dbObject.f56011id = str;
        }
    };
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f56011id, dbObject.f56011id) && this._id == dbObject._id;
    }
