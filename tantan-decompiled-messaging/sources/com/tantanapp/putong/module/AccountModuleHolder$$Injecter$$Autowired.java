...
public class AccountModuleHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) ksm.m147096d().m147098a("/account_module/module").navigation();
        ((AccountModuleHolder) obj).module = module;
        if (module != null) {
            return;
        }
        tqq0.m190155a("The field 'module' is null, in class '", AccountModuleHolder.class.getName(), "!");
    }
}
