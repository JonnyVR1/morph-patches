...
public class LiveModuleHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) ksm.m147096d().m147098a("/live_module/module").navigation();
        ((LiveModuleHolder) obj).module = module;
        if (module != null) {
            return;
        }
        tqq0.m190155a("The field 'module' is null, in class '", LiveModuleHolder.class.getName(), "!");
    }
}
