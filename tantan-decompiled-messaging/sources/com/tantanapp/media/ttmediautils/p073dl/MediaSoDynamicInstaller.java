package com.tantanapp.media.ttmediautils.p073dl;
...
import com.tantanapp.media.ttmediautils.p073dl.MediaSoDynamicInstaller;
...
public class MediaSoDynamicInstaller {
    ...
    public static /* synthetic */ void m81390a(MediaSoDynamicInstaller mediaSoDynamicInstaller, DownloadTask downloadTask, Integer num) {
        mediaSoDynamicInstaller.getClass();
        mediaSoDynamicInstaller.onDownloading(num.intValue());
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m81391b(MediaSoDynamicInstaller mediaSoDynamicInstaller, DownloadTask downloadTask) {
        mediaSoDynamicInstaller.getClass();
        mediaSoDynamicInstaller.onFailure(2001, new RuntimeException("downloadAndInstall zip canceled"));
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m81392c(MediaSoDynamicInstaller mediaSoDynamicInstaller, File file, DownloadTask downloadTask, File file2) {
    ...
    public static /* synthetic */ void m81393d(MediaSoDynamicInstaller mediaSoDynamicInstaller, DownloadTask downloadTask, Throwable th) {
        mediaSoDynamicInstaller.getClass();
    ...
    private void downloadAndInstall(final File file) {
        try {
            ...
            DownloadManager.getInstance().download(new DownloadTask(this.mSDKUrl, new File(file.getAbsolutePath() + ".temp"), true).onSuccess(new Action2() { // from class: l.ywx
                @Override // com.tantanapp.media.ttmediautils.download.Action2
                public final void call(Object obj, Object obj2) {
                    MediaSoDynamicInstaller.m81392c(this.f200556a, file, (DownloadTask) obj, (File) obj2);
                }
            }).onLoading(new Action2() { // from class: l.zwx
                @Override // com.tantanapp.media.ttmediautils.download.Action2
                public final void call(Object obj, Object obj2) {
                    MediaSoDynamicInstaller.m81390a(this.f205329a, (DownloadTask) obj, (Integer) obj2);
                }
            }).onFail(new Action2() { // from class: l.axx
                @Override // com.tantanapp.media.ttmediautils.download.Action2
                public final void call(Object obj, Object obj2) {
                    MediaSoDynamicInstaller.m81393d(this.f72241a, (DownloadTask) obj, (Throwable) obj2);
                }
            }).onCancel(new Action1() { // from class: l.bxx
                @Override // com.tantanapp.media.ttmediautils.download.Action1
                public final void call(Object obj) {
                    MediaSoDynamicInstaller.m81391b(this.f77836a, (DownloadTask) obj);
                }
            }));
        } catch (Exception e) {
            onFailure(1001, e);
    ...
    private void unzip(@NonNull Entity entity) {
        if (entity.needUnzip) {
            ...
            try {
                ...
                SharePatchFileUtil.safeDeleteFile(entity.zipFile);
                o5d0.m162778a("unzip fail:", e.getMessage());
            }
        }
    }
