...
public class DownloadManager {
    ...
    public static /* synthetic */ void m81394a(Action1 action1, DownloadTask downloadTask, File file) {
        if (action1 != null) {
            action1.call(file);
        }
    }
    ...
    public static /* synthetic */ void m81395b(Action1 action1, DownloadTask downloadTask, Throwable th) {
        if (action1 != null) {
            action1.call(th);
        }
    }
    ...
    public DownloadTask downloadApk(String str, String str2, final Action1<File> action1, final Action1<Throwable> action2) {
        DownloadTask downloadTaskOnFail = new DownloadTask(str, str2).setBufferSize(16384).setUpdateInterval(500).onSuccess(new Action2() { // from class: l.d8e
            @Override // com.tantanapp.media.ttmediautils.download.Action2
            public final void call(Object obj, Object obj2) {
                DownloadManager.m81394a(action1, (DownloadTask) obj, (File) obj2);
            }
        }).onFail(new Action2() { // from class: l.f8e
            @Override // com.tantanapp.media.ttmediautils.download.Action2
            public final void call(Object obj, Object obj2) {
                DownloadManager.m81395b(action2, (DownloadTask) obj, (Throwable) obj2);
            }
        });
