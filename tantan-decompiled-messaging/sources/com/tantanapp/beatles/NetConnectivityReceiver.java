...
public class NetConnectivityReceiver extends BroadcastReceiver {
    ...
    private static List<InterfaceC13539a> sCallBacks = new ArrayList();
    ...
    public interface InterfaceC13539a {
        /* JADX INFO: renamed from: a */
        void mo81047a(boolean z);
    }
    ...
    public static void registerCallBack(InterfaceC13539a interfaceC13539a) {
        if (sNetConnected) {
            interfaceC13539a.mo81047a(true);
        }
        sCallBacks.add(interfaceC13539a);
    }

    public static void registerConnectivityReceiver(Context context) {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("android.net.conn.CONNECTIVITY_CHANGE");
        ii5.m136342l(context, instance, intentFilter);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Iterator<InterfaceC13539a> it = sCallBacks.iterator();
        while (it.hasNext()) {
            it.next().mo81047a(sNetConnected);
        }
    }
}
