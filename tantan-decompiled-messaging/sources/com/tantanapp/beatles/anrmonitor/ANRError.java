...
class ANRError extends Error {
    ...
    public class C13540a implements Comparator<Thread> {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ Thread f55836a;

        public C13540a(Thread thread) {
            this.f55836a = thread;
        }
    ...
    public static ANRError New(long j, String str, boolean z) {
        ...
        TreeMap treeMap = new TreeMap(new C13540a(thread));
        ...
        C13540a c13540a = null;
        ErrorInfo._Thread _thread = null;
        for (Map.Entry entry2 : treeMap.entrySet()) {
            _thread = new ErrorInfo._Thread(new ErrorInfo(getThreadTitle((Thread) entry2.getKey()), (StackTraceElement[]) entry2.getValue(), c13540a), _thread, c13540a);
        }
    ...
    public static class ErrorInfo implements Serializable {
        ...
        public /* synthetic */ ErrorInfo(String str, StackTraceElement[] stackTraceElementArr, C13540a c13540a) {
        ...
        public class _Thread extends Throwable {
            ...
            public /* synthetic */ _Thread(ErrorInfo errorInfo, _Thread _thread, C13540a c13540a) {
                this(_thread);
            }
        }
    }
