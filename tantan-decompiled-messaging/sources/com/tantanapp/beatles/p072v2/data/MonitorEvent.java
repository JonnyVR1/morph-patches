...
public class MonitorEvent {
    ...
    private transient List<g4f> eventProcessors;
    ...
    private OperatingSystem f56006os;
    ...
    public void addProcessor(g4f g4fVar) {
        this.eventProcessors.add(g4fVar);
    }

    public void addProcessors(List<g4f> list) {
    ...
    public List<g4f> getEventProcessors() {
    ...
    public MonitorEvent() {
        this(new EventId(), j7c.m140086e(System.currentTimeMillis()));
    }
