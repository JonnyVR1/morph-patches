...
public class Injecter$$Group$$core_module implements IRouteGroup {
    @Override // com.tantanapp.android.injecter.facade.template.IRouteGroup
    public void loadInto(Map<String, RouteMeta> map) {
        map.put("/core_module/module", RouteMeta.build(RouteType.PROVIDER, CoreBusinessModule.class, "/core_module/module", "core_module", null, -1, Integer.MIN_VALUE));
    }
}
