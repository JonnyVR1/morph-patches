...
import com.p046p1.mobile.putong.core.buzz.module.CoreBuzzProviderImpl;
...
public class Injecter$$Group$$core_buzz implements IRouteGroup {
    @Override // com.tantanapp.android.injecter.facade.template.IRouteGroup
    public void loadInto(Map<String, RouteMeta> map) {
        map.put("/core_buzz/service", RouteMeta.build(RouteType.PROVIDER, CoreBuzzProviderImpl.class, "/core_buzz/service", "core_buzz", null, -1, Integer.MIN_VALUE));
    }
}
