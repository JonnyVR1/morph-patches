...
public class Injecter$$Group$$feed_module implements IRouteGroup {
    @Override // com.tantanapp.android.injecter.facade.template.IRouteGroup
    public void loadInto(Map<String, RouteMeta> map) {
        map.put("/feed_module/module", RouteMeta.build(RouteType.PROVIDER, FeedModule.class, "/feed_module/module", "feed_module", null, -1, Integer.MIN_VALUE));
    }
}
