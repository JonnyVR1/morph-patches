...
public class Injecter$$Group$$base_module implements IRouteGroup {
    @Override // com.tantanapp.android.injecter.facade.template.IRouteGroup
    public void loadInto(Map<String, RouteMeta> map) {
        map.put("/base_module/module", RouteMeta.build(RouteType.PROVIDER, CoreModule.class, "/base_module/module", "base_module", null, -1, Integer.MIN_VALUE));
    }
}
