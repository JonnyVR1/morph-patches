...
import com.p046p1.mobile.putong.core.card.module.CoreCardServiceImpl;
...
public class Injecter$$Group$$card_service implements IRouteGroup {
    @Override // com.tantanapp.android.injecter.facade.template.IRouteGroup
    public void loadInto(Map<String, RouteMeta> map) {
        map.put("/card_service/service", RouteMeta.build(RouteType.PROVIDER, CoreCardServiceImpl.class, "/card_service/service", "card_service", null, -1, Integer.MIN_VALUE));
    }
}
