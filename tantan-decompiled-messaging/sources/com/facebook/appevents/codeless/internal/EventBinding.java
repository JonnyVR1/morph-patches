...
public final class EventBinding {
    ...
    @NotNull
    public final List<t760> parameters;
    ...
    @Metadata(m87231d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, m87232d2 = {"Lcom/facebook/appevents/codeless/internal/EventBinding$ActionType;", "", "(Ljava/lang/String;I)V", "CLICK", "SELECTED", "TEXT_CHANGED", "facebook-core_release"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
    ...
    @Metadata(m87231d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, m87232d2 = {"Lcom/facebook/appevents/codeless/internal/EventBinding$MappingMethod;", "", "(Ljava/lang/String;I)V", "MANUAL", "INFERENCE", "facebook-core_release"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
    ...
    public static final class Companion {
        ...
        public final EventBinding m7707a(@NotNull JSONObject mapping) throws JSONException, IllegalArgumentException {
            mapping.getClass();
            ...
            if (jSONArrayOptJSONArray != null) {
                ...
                for (int i2 = 0; i2 < length2; i2++) {
                    ...
                    arrayList2.add(new t760(jSONObject2));
                }
            }
        ...
        public final List<EventBinding> m7708b(@Nullable JSONArray array) {
            ArrayList arrayList = new ArrayList();
            if (array != null) {
                try {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        jSONObject.getClass();
                        arrayList.add(m7707a(jSONObject));
                    }
    ...
    public EventBinding(@NotNull String str, @NotNull MappingMethod mappingMethod, @NotNull ActionType actionType, @NotNull String str2, @NotNull List<PathComponent> list, @NotNull List<t760> list2, @NotNull String str3, @NotNull String str4, @NotNull String str5) {
        str.getClass();
    ...
    public final List<t760> m7705c() {
        List<t760> listUnmodifiableList = Collections.unmodifiableList(this.parameters);
    ...
    public final List<PathComponent> m7706d() {
