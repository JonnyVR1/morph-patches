...
public final class C1555g {
    ...
    @NotNull
    public static final Set<String> f6004b;

    /* JADX INFO: renamed from: c */
    @NotNull
    public static final Set<String> f6005c;

    /* JADX INFO: renamed from: d */
    @NotNull
    public static final Map<OperationalDataEnum, Pair<Set<String>, Set<String>>> f6006d;
    ...
    public static final class Companion {
        ...
        public /* synthetic */ class C22670a {
        ...
        /* JADX INFO: renamed from: a */
        public final void m7792a(@NotNull OperationalDataEnum typeOfParameter, @NotNull String key, @NotNull String value, @NotNull Bundle customEventsParams, @NotNull C1555g operationalData) {
            typeOfParameter.getClass();
            key.getClass();
            value.getClass();
            customEventsParams.getClass();
            operationalData.getClass();
            int i = C22670a.f6008a[m7795d(typeOfParameter, key).ordinal()];
            if (i == 1) {
                customEventsParams.putCharSequence(key, value);
                return;
            }
            if (i == 2) {
                operationalData.m7788b(typeOfParameter, key, value);
            } else {
                if (i != 3) {
                    return;
                }
        ...
        @NotNull
        /* JADX INFO: renamed from: b */
        public final Pair<Bundle, C1555g> m7793b(@NotNull OperationalDataEnum typeOfParameter, @NotNull String key, @NotNull String value, @Nullable Bundle customEventsParams, @Nullable C1555g operationalData) {
            typeOfParameter.getClass();
            key.getClass();
            value.getClass();
            int i = C22670a.f6008a[m7795d(typeOfParameter, key).ordinal()];
        ...
        @Nullable
        /* JADX INFO: renamed from: c */
        public final Object m7794c(@NotNull OperationalDataEnum typeOfParameter, @NotNull String key, @Nullable Bundle params, @Nullable C1555g operationalData) {
            typeOfParameter.getClass();
            key.getClass();
            Object objM7790d = operationalData != null ? operationalData.m7790d(typeOfParameter, key) : null;
            return objM7790d == null ? params != null ? params.getCharSequence(key) : null : objM7790d;
        }

        @NotNull
        /* JADX INFO: renamed from: d */
        public final ParameterClassification m7795d(@NotNull OperationalDataEnum typeOfParameter, @NotNull String parameter) {
            typeOfParameter.getClass();
            parameter.getClass();
            Pair pair = (Pair) C1555g.f6006d.get(typeOfParameter);
            Set set = pair != null ? (Set) pair.getFirst() : null;
            Pair pair2 = (Pair) C1555g.f6006d.get(typeOfParameter);
    ...
    static {
        ...
        f6005c = of2;
        f6006d = MapsKt.mapOf(TuplesKt.m87240a(OperationalDataEnum.IAPParameters, new Pair(of, of2)));
    }

    /* JADX INFO: renamed from: b */
    public final void m7788b(@NotNull OperationalDataEnum type, @NotNull String key, @NotNull Object value) {
        type.getClass();
        key.getClass();
        value.getClass();
        try {
            AppEvent.INSTANCE.m7640a(key);
        ...
        for (OperationalDataEnum operationalDataEnum : this.operationalData.keySet()) {
            ...
            if (map != null) {
                for (String str : map.keySet()) {
                    ...
                    if (obj != null) {
                        c1555g.m7788b(operationalDataEnum, str, obj);
                    }
                }
            }
        }
    ...
    @Nullable
    /* JADX INFO: renamed from: d */
    public final Object m7790d(@NotNull OperationalDataEnum type, @NotNull String key) {
    ...
    public final JSONObject m7791e() {
