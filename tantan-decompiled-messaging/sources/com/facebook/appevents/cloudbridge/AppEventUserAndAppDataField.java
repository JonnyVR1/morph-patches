...
public enum AppEventUserAndAppDataField {
    ...
    public static final class Companion {
        ...
        public final AppEventUserAndAppDataField m7667a(@NotNull String rawValue) {
            rawValue.getClass();
            for (AppEventUserAndAppDataField appEventUserAndAppDataField : AppEventUserAndAppDataField.values()) {
                if (Intrinsics.m87488d(appEventUserAndAppDataField.getRawValue(), rawValue)) {
