...
public class AppleDiskNumberBox extends AppleDataBox {
    ...
    public void parseData(ByteBuffer byteBuffer) {
        this.f11704a = byteBuffer.getInt();
        this.f11705b = byteBuffer.getShort();
    }
    ...
    public void setB(short s) {
        cvc0.m108851b().m108852c(Factory.makeJP(ajc$tjp_3, this, this, Conversions.shortObject(s)));
        this.f11705b = s;
    }
    ...
    public byte[] writeData() {
        ...
        byteBufferAllocate.putInt(this.f11704a);
        byteBufferAllocate.putShort(this.f11705b);
