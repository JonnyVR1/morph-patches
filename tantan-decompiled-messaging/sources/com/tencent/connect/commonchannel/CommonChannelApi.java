...
public class CommonChannelApi extends BaseApi {
    ...
    public CommonChannelApi(C13812c c13812c, QQToken qQToken) {
        super(c13812c, qQToken);
    }

    /* JADX INFO: renamed from: a */
    private boolean m82160a(Bundle bundle) {
    ...
    public int launchQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (C13802a.m81984a("UniversalApi", iUiListener)) {
            return -6;
        }
        if (!m82160a(bundle)) {
        ...
        m82153a(sb, "exsvr_userinfo", C14396n.m84511k(string));
        m82153a(sb, Constants.PARAM_EXT_DATA, C14396n.m84511k(string));
        m82153a(sb, Constants.PARAM_SRC_ID, String.valueOf(bundle.getInt(Constants.PARAM_SRC_ID, 0)));
        ...
        m82147a(activity, Constants.REQUEST_COMMON_CHANNEL, intent, false);
        return 0;
    }
