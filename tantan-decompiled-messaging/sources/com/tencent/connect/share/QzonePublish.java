...
public class QzonePublish extends BaseApi {
    ...
    public void m82173b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        String str;
        String str2;
        String string;
        String appId;
        ...
        int i;
        String strM84472a;
        SLog.m84309i("openSDK_LOG.QzonePublish", "doPublishToQzone() --start");
            ...
            if (bundle2 != null) {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (TextUtils.isEmpty(bundle2.getString(next))) {
                            ...
                            try {
                                ...
                                e = e;
                                SLog.m84308e("openSDK_LOG.QzonePublish", "publishToQzone()  --error parse extmap", e);
                                appId = this.f57183c.getAppId();
                                openId = this.f57183c.getOpenId();
                                str3 = string;
                                SLog.m84313v("openSDK_LOG.QzonePublish", "openId:" + openId);
                                if (3 != i2) {
                                }
                                if (4 == i2) {
                                    stringBuffer.append("&videoPath=" + Base64.encodeToString(C14396n.m84510j(string4), 2));
                                    strM84472a = C14396n.m84472a(appId, activity, string4, iUiListener);
                                    if (!TextUtils.isEmpty(strM84472a)) {
                                        stringBuffer.append("&videoUri=" + Base64.encodeToString(C14396n.m84510j(strM84472a), 2));
                                    }
                                    stringBuffer.append("&videoDuration=" + Base64.encodeToString(C14396n.m84510j(String.valueOf(i3)), 2));
                                    stringBuffer.append("&videoSize=" + Base64.encodeToString(C14396n.m84510j(String.valueOf(j)), 2));
                                    str4 = Constants.VIA_SHARE_TYPE_PUBLISHVIDEO;
                                }
                                String str5 = str4;
                                if (!TextUtils.isEmpty(str)) {
                                    stringBuffer.append("&description=" + Base64.encodeToString(C14396n.m84510j(str), 2));
                                }
                                if (!TextUtils.isEmpty(appId)) {
                                    stringBuffer.append("&share_id=" + appId);
                                }
                                if (!TextUtils.isEmpty(str2)) {
                                    stringBuffer.append("&app_name=" + Base64.encodeToString(C14396n.m84510j(str2), 2));
                                }
                                if (!C14396n.m84499e(openId)) {
                                ...
                                if (TextUtils.isEmpty(str3)) {
                                    ...
                                    i = 2;
                                    sb.append(Base64.encodeToString(C14396n.m84510j(str3), 2));
                                    stringBuffer.append(sb.toString());
                                }
                                stringBuffer.append("&req_type=" + Base64.encodeToString(C14396n.m84510j(String.valueOf(i2)), i));
                                SLog.m84313v("openSDK_LOG.QzonePublish", "doPublishToQzone, url: " + stringBuffer.toString());
                                ...
                                intent.putExtra(Constants.KEY_PASS_REPORT_VIA_PARAM, C14396n.m84467a(this.f57183c.getOpenId(), Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "3", Constants.VIA_SHARE_TO_QZONE, this.f57183c.getAppId(), str5, "", "", "0", "1", "0"));
                                m82147a(activity, Constants.REQUEST_QZONE_SHARE, intent, false);
                                SLog.m84309i(SLog.TAG, "doPublishToQzone() --end");
                            }
                        }
                        it = it2;
                        string3 = str2;
                    ...
                    if (TextUtils.isEmpty(str3)) {
                        ...
                        i = 2;
                        sb2.append(Base64.encodeToString(C14396n.m84510j(str3), 2));
                    ...
                    intent2.putExtra(Constants.KEY_PASS_REPORT_VIA_PARAM, C14396n.m84467a(this.f57183c.getOpenId(), Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "3", Constants.VIA_SHARE_TO_QZONE, this.f57183c.getAppId(), str6, "", "", "0", "1", "0"));
                    m82147a(activity, Constants.REQUEST_QZONE_SHARE, intent2, false);
                    SLog.m84309i(SLog.TAG, "doPublishToQzone() --end");
                }
                appId = this.f57183c.getAppId();
                openId = this.f57183c.getOpenId();
                ...
                if (3 != i2 && stringArrayList != null) {
                    ...
                    while (i4 < size) {
                        ...
                        String strM84472a2 = C14396n.m84472a(appId, activity, stringArrayList.get(i4), iUiListener);
                        if (!TextUtils.isEmpty(strM84472a2)) {
                            stringBuffer3.append(URLEncoder.encode(strM84472a2));
                        }
                        if (i4 != i5 - 1) {
                    ...
                    stringBuffer.append("&image_url=" + Base64.encodeToString(C14396n.m84510j(stringBuffer2.toString()), 2));
                    if (!TextUtils.isEmpty(stringBuffer3.toString())) {
                        stringBuffer.append("&image_uri=" + Base64.encodeToString(C14396n.m84510j(stringBuffer3.toString()), 2));
                    }
                    str4 = "7";
                }
                if (4 == i2) {
                ...
                if (TextUtils.isEmpty(str3)) {
                    ...
                    i = 2;
                    sb3.append(Base64.encodeToString(C14396n.m84510j(str3), 2));
                ...
                intent3.putExtra(Constants.KEY_PASS_REPORT_VIA_PARAM, C14396n.m84467a(this.f57183c.getOpenId(), Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "3", Constants.VIA_SHARE_TO_QZONE, this.f57183c.getAppId(), str7, "", "", "0", "1", "0"));
                m82147a(activity, Constants.REQUEST_QZONE_SHARE, intent3, false);
                SLog.m84309i(SLog.TAG, "doPublishToQzone() --end");
            }
            str = string2;
            str2 = string3;
        ...
        if (TextUtils.isEmpty(str3)) {
            ...
            i = 2;
            sb4.append(Base64.encodeToString(C14396n.m84510j(str3), 2));
        ...
        intent4.putExtra(Constants.KEY_PASS_REPORT_VIA_PARAM, C14396n.m84467a(this.f57183c.getOpenId(), Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "3", Constants.VIA_SHARE_TO_QZONE, this.f57183c.getAppId(), str8, "", "", "0", "1", "0"));
        m82147a(activity, Constants.REQUEST_QZONE_SHARE, intent4, false);
        SLog.m84309i(SLog.TAG, "doPublishToQzone() --end");
    }

    public void publishToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        SLog.m84309i("openSDK_LOG.QzonePublish", "publishToQzone() -- start");
        if (C13802a.m81984a("openSDK_LOG.QzonePublish", iUiListener)) {
            return;
        }
        if (bundle == null) {
            iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_NULL_ERROR, null));
            SLog.m84307e("openSDK_LOG.QzonePublish", "-->publishToQzone, params is null");
        ...
        if (!C14396n.m84501f(activity)) {
            iUiListener.onError(new UiError(-15, Constants.MSG_PARAM_VERSION_TOO_LOW, null));
            SLog.m84307e("openSDK_LOG.QzonePublish", "-->publishToQzone, this is not support below qq 5.9.5");
            C14363e.m84265a().m84266a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f57183c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publicToQzone, this is not support below qq 5.9.5");
        ...
        if (i2 == 3) {
            ...
            if (stringArrayList != null && stringArrayList.size() > 0) {
                while (i < stringArrayList.size()) {
                    if (!C14396n.m84509i(stringArrayList.get(i))) {
            ...
            m82173b(activity, bundle, iUiListener);
            SLog.m84309i("openSDK_LOG.QzonePublish", "publishToQzone() --end");
            return;
        }
        if (i2 != 4) {
            iUiListener.onError(new UiError(-5, Constants.MSG_SHARE_TYPE_ERROR, null));
            SLog.m84307e("openSDK_LOG.QzonePublish", "publishToQzone() error--end请选择支持的分享类型");
            C14363e.m84265a().m84266a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f57183c.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publishToQzone() 请选择支持的分享类型");
            return;
        }
        final String string = bundle.getString(PUBLISH_TO_QZONE_VIDEO_PATH);
        if (!C14396n.m84509i(string)) {
            SLog.m84307e("openSDK_LOG.QzonePublish", "publishToQzone() video url invalid");
        ...
        mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: com.tencent.connect.share.QzonePublish.1
            ...
            public void onPrepared(MediaPlayer mediaPlayer2) {
                ...
                QzonePublish.this.m82173b(activity, bundle, iUiListener);
                SLog.m84309i("openSDK_LOG.QzonePublish", "publishToQzone() --end");
            }
        });
        mediaPlayer.setOnErrorListener(new MediaPlayer.OnErrorListener() { // from class: com.tencent.connect.share.QzonePublish.2
            ...
            public boolean onError(MediaPlayer mediaPlayer2, int i3, int i4) {
                SLog.m84307e("openSDK_LOG.QzonePublish", "publishToQzone() mediaplayer onError()");
                iUiListener.onError(new UiError(-5, Constants.MSG_PUBLISH_VIDEO_ERROR, null));
                return false;
            }
        });
        try {
            ...
            SLog.m84307e("openSDK_LOG.QzonePublish", "publishToQzone() exception(s) occurred when preparing mediaplayer");
            iUiListener.onError(new UiError(-5, Constants.MSG_PUBLISH_VIDEO_ERROR, null));
        }
    }
}
