...
public class TraeMediaPlayer implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    ...
    private void volumeDo() {
        ...
        try {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "TraeMediaPlay volumeDo currV:" + streamVolume + " maxV:" + streamMaxVolume + " currRV:" + streamVolume2 + " maxRV:" + streamMaxVolume2 + " setV:" + i);
            }
            int i2 = i + 1;
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "set stream volume failed." + e.getMessage());
            }
        }
    }
    ...
    private void volumeUndo() {
        ...
        try {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "TraeMediaPlay volumeUndo _prevVolume:" + this._prevVolume);
            }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        ...
        if (this._loop) {
            if (QLog.isColorLevel()) {
                QLog.m84588d("TRAE", 2, "loop play,continue...");
                return;
            }
            return;
        }
        try {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "stop play failed." + e.getMessage());
            }
        }
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        try {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "release MediaPlayer failed." + e.getMessage());
            }
        }
        this.mMediaPlay = null;
        OnCompletionListener onCompletionListener = this.mCallback;
    ...
    public boolean playRing(int i, int i2, Uri uri, String str, boolean z, int i3, boolean z2, boolean z3, int i4) {
        ...
        if (QLog.isColorLevel()) {
            ...
            sb.append(" cst:");
            sb.append(i4);
            QLog.m84590e("TRAE", 2, sb.toString());
        }
        boolean z4 = false;
        if (!z && i3 <= 0) {
            if (QLog.isColorLevel()) {
                ...
                sb2.append(i3);
                QLog.m84590e("TRAE", 2, sb2.toString());
            }
            return false;
        }
        try {
                ...
                try {
                    ...
                    if (mediaPlayer != null) {
                        try {
                            ...
                            r4 = str2;
                            if (QLog.isColorLevel()) {
                                QLog.m84588d("TRAE", 2, "TraeMediaPlay | IOException: " + e.getLocalizedMessage() + str2 + e.getMessage());
                                r4 = str2;
                            }
                            try {
                                this.mMediaPlay.release();
                            ...
                            r4 = str3;
                            if (QLog.isColorLevel()) {
                                QLog.m84588d("TRAE", 2, "TraeMediaPlay | IllegalArgumentException: " + e.getLocalizedMessage() + str3 + e.getMessage());
                                r4 = str3;
                            }
                            this.mMediaPlay.release();
                            this.mMediaPlay = null;
                            ...
                            r4 = str4;
                            if (QLog.isColorLevel()) {
                                QLog.m84588d("TRAE", 2, "TraeMediaPlay | IllegalStateException: " + e.getLocalizedMessage() + str4 + e.getMessage());
                                r4 = str4;
                            }
                            this.mMediaPlay.release();
                            this.mMediaPlay = null;
                            ...
                            if (QLog.isColorLevel()) {
                                ...
                                QLog.m84588d("TRAE", 2, sb3.toString());
                                r4 = str5;
                            }
                            this.mMediaPlay.release();
                            this.mMediaPlay = null;
                            ...
                            r4 = r3;
                            if (QLog.isColorLevel()) {
                                QLog.m84588d("TRAE", 2, "TraeMediaPlay | Except: " + e.getLocalizedMessage() + r3 + e.getMessage());
                                r4 = r3;
                            }
                            this.mMediaPlay.release();
                            this.mMediaPlay = null;
                    ...
                    if (i == 0) {
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.m84590e("TRAE", 2, "TraeMediaPlay | uri:" + uri);
                        }
                        this.mMediaPlay.setDataSource(this._context, uri);
                    } else if (i != 2) {
                        if (QLog.isColorLevel()) {
                            QLog.m84590e("TRAE", 2, "TraeMediaPlay | err datasource:" + i);
                        }
                        this.mMediaPlay.release();
                        this.mMediaPlay = null;
                    } else {
                        if (QLog.isColorLevel()) {
                            QLog.m84590e("TRAE", 2, "TraeMediaPlay | FilePath:" + str);
                        }
                        ...
                        TimerTask timerTask = new TimerTask() { // from class: com.tencent.rtmp.sharp.jni.TraeMediaPlayer.1
                            ...
                            public void run() {
                                if (TraeMediaPlayer.this.mMediaPlay != null) {
                                    if (QLog.isColorLevel()) {
                                        QLog.m84590e("TRAE", 2, "TraeMediaPlay | play timeout");
                                    }
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.m84590e("TRAE", 2, "TraeMediaPlay | DurationMS:" + this.mMediaPlay.getDuration() + " loop:" + z);
                    }
                    return true;
                } catch (Exception e7) {
                    e = e7;
    ...
    public void stopRing() {
        if (QLog.isColorLevel()) {
            QLog.m84588d("TRAE", 2, "TraeMediaPlay stopRing ");
        }
        MediaPlayer mediaPlayer = this.mMediaPlay;
        if (mediaPlayer == null) {
            return;
