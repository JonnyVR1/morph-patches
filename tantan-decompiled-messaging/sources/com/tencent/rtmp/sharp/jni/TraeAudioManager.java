...
public class TraeAudioManager extends BroadcastReceiver {
    ...
    public class BluetoohHeadsetCheck extends BluetoohHeadsetCheckInterface implements BluetoothProfile.ServiceListener {
        ...
        public void _addAction(IntentFilter intentFilter) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + interfaceDesc() + " _addAction");
            }
        ...
        public void _onReceive(Context context, Intent intent) {
            if ("android.bluetooth.adapter.action.CONNECTION_STATE_CHANGED".equals(intent.getAction())) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "BT ACTION_CONNECTION_STATE_CHANGED|   EXTRA_CONNECTION_STATE " + getBTAdapterConnectionState(intExtra));
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "    EXTRA_PREVIOUS_CONNECTION_STATE " + getBTAdapterConnectionState(intExtra2));
                }
                if (QLog.isColorLevel()) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "   dev:" + bluetoothDevice.getName() + " connected,start sco...");
                }
            ...
            if (!"android.media.ACTION_SCO_AUDIO_STATE_UPDATED".equals(intent.getAction())) {
                if ("android.bluetooth.a2dp.profile.action.CONNECTION_STATE_CHANGED".equals(intent.getAction())) {
                    ...
                    int iM136334d = ii5.m136334d(defaultAdapter, 2);
                    if (iM136334d == 0) {
                        QLog.m84595w("TRAE", 2, "BluetoothA2dp STATE_DISCONNECTED");
                        TraeAudioManager.this.IsBluetoothA2dpExisted = false;
                        return;
                    } else if (iM136334d == 2) {
                        QLog.m84595w("TRAE", 2, "BluetoothA2dp STATE_CONNECTED");
                        TraeAudioManager.this.IsBluetoothA2dpExisted = true;
                        return;
                    } else {
                        QLog.m84595w("TRAE", 2, "BluetoothA2dp" + ii5.m136334d(defaultAdapter, 2));
                        return;
                    }
                }
                return;
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "BT ACTION_SCO_AUDIO_STATE_UPDATED|   EXTRA_CONNECTION_STATE  dev:" + bluetoothDevice2);
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "   EXTRA_SCO_AUDIO_STATE " + getSCOAudioStateExtraString(intExtra3));
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "   EXTRA_SCO_AUDIO_PREVIOUS_STATE " + getSCOAudioStateExtraString(intExtra4));
            }
        }
        ...
        public boolean init(Context context, DeviceConfigManager deviceConfigManager) {
            ...
            if (context == null || deviceConfigManager == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " err ctx==null||_devCfg==null");
                }
                return false;
            }
            this._ctx = context;
            ...
            if (defaultAdapter == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " err getDefaultAdapter fail!");
                }
                return false;
            }
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BluetoohHeadsetCheck: getProfileProxy HEADSET fail!");
                }
                this._profileLock.unlock();
                return false;
            } catch (Throwable th) {
            ...
            if (i == 1) {
                ...
                try {
                    ...
                    if (bluetoothProfile2 != null && bluetoothProfile2 != bluetoothProfile) {
                        if (QLog.isColorLevel()) {
                            QLog.m84595w("TRAE", 2, "BluetoohHeadsetCheck: HEADSET Connected proxy:" + bluetoothProfile + " _profile:" + this._profile);
                        }
                    ...
                    if (connectedDevices != null && this._profile != null) {
                        if (QLog.isColorLevel()) {
                            QLog.m84595w("TRAE", 2, "TRAEBluetoohProxy: HEADSET Connected devs:" + connectedDevices.size() + " _profile:" + this._profile);
                        }
                        for (int i2 = 0; i2 < connectedDevices.size(); i2++) {
                            ...
                            try {
                                ...
                                if (QLog.isColorLevel()) {
                                    QLog.m84590e("TRAE", 2, "get bluetooth connection state failed." + e.getMessage());
                                }
                            }
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m84595w("TRAE", 2, "   " + i2 + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + bluetoothDevice.getName() + " ConnectionState:" + connectionState);
                            }
                        }
                    }
                    this._profileLock.unlock();
        ...
        public void onServiceDisconnected(int i) {
            ...
            if (i == 1) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "TRAEBluetoohProxy: HEADSET Disconnected");
                }
                if (isConnected()) {
        ...
        public void release() {
            ...
            try {
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.m84595w("TRAE", 2, " closeProfileProxy:e:" + e.getMessage());
                    }
                }
                this._profileLock.unlock();
                AudioDeviceInterface.LogTraceExit();
    ...
    public class BluetoohHeadsetCheckFor2x extends BluetoohHeadsetCheckInterface {
        ...
        public void _onReceive(Context context, Intent intent) {
            if (ACTION_BLUETOOTHHEADSET_AUDIO_STATE_CHANGED.equals(intent.getAction())) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "++ AUDIO_STATE_CHANGED|  STATE " + intExtra);
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "       PREVIOUS_STATE " + intExtra2);
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "       AUDIO_STATE " + intExtra3);
                }
                if (intExtra3 == 2) {
                    this._devCfg.setVisible(TraeAudioManager.DEVICE_BLUETOOTHHEADSET, true);
                    return;
            ...
            if (ACTION_BLUETOOTHHEADSET_STATE_CHANGED.equals(intent.getAction())) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "++ STATE_CHANGED|  STATE " + intExtra4);
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "       PREVIOUS_STATE " + intExtra5);
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "       AUDIO_STATE " + intExtra6);
                }
                if (intExtra6 == 2) {
                    this._devCfg.setVisible(TraeAudioManager.DEVICE_BLUETOOTHHEADSET, true);
                } else if (intExtra6 == 0) {
        ...
        public boolean init(Context context, DeviceConfigManager deviceConfigManager) {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset class not found");
                }
            }
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset.ServiceListener class not found:" + e);
                }
            }
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset method getCurrentHeadset NoSuchMethodException");
                }
            }
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset getConstructor IllegalAccessException");
                }
            } catch (IllegalArgumentException unused4) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset getConstructor IllegalArgumentException");
                }
            } catch (InstantiationException unused5) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset getConstructor InstantiationException");
                }
            } catch (NoSuchMethodException unused6) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset getConstructor NoSuchMethodException");
                }
            } catch (InvocationTargetException unused7) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread BluetoothHeadset getConstructor InvocationTargetException");
                }
            }
        ...
        public boolean isConnected() {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "BTLooperThread BluetoothHeadset method getCurrentHeadset IllegalAccessException");
                }
            } catch (IllegalArgumentException unused2) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "BTLooperThread BluetoothHeadset method getCurrentHeadset IllegalArgumentException");
                }
            } catch (InvocationTargetException unused3) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "BTLooperThread BluetoothHeadset method getCurrentHeadset InvocationTargetException");
                }
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "BTLooperThread BluetoothHeadset method getCurrentHeadset res:".concat(objInvoke != null ? " Y" : "N"));
            }
        ...
        public void release() {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "BTLooperThread _uninitHeadsetfor2x method close NoSuchMethodException");
                }
                declaredMethod = null;
            }
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "close bluetooth headset failed." + e.getMessage());
                }
            }
            this.BluetoothHeadsetClass = null;
            this.ListenerClass = null;
    ...
    public abstract class BluetoohHeadsetCheckInterface {
        ...
        public void onReceive(Context context, Intent intent, DeviceConfigManager deviceConfigManager) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "BT ACTION_STATE_CHANGED|   EXTRA_STATE " + getBTActionStateChangedExtraString(intExtra));
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "BT ACTION_STATE_CHANGED|   EXTRA_PREVIOUS_STATE " + getBTActionStateChangedExtraString(intExtra2));
            }
            if (intExtra == 10) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "    BT off");
                }
                deviceConfigManager.setVisible(TraeAudioManager.DEVICE_BLUETOOTHHEADSET, false);
            } else if (intExtra == 12 && QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "BT OFF-->ON,Visiable it...");
            }
        }
    ...
    public class TraeAudioManagerLooper extends Thread {
        ...
        public TraeAudioManagerLooper(TraeAudioManager traeAudioManager) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "TraeAudioManagerLooper start...");
            }
            start();
            synchronized (zArr) {
                if (!zArr[0]) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "  start used:" + (SystemClock.elapsedRealtime() - jElapsedRealtime) + "ms");
            }
        }
        ...
        public int InternalGetStreamType(HashMap<String, Object> map) {
            ...
            if (traeAudioManager._am == null) {
                ...
                QLog.m84590e("TRAE", 2, " InternalStopRing am==null!!");
                return -1;
            }
        ...
        public int InternalStartRing(HashMap<String, Object> map) {
            ...
            if (traeAudioManager._am == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " InternalStartRing am==null!!");
                }
                return -1;
            }
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "  dataSource:" + iIntValue);
                }
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, " _ringUserdata:" + this._ringUserdata + " DurationMS:" + this._ringPlayer.getDuration());
                }
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " startRing err params");
                }
                return -1;
            }
        }
        ...
        public int InternalVoicecallPostprocess(HashMap<String, Object> map) {
            ...
            if (traeAudioManager._am == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " InternalVoicecallPostprocess am==null!!");
                }
                return -1;
            }
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, " not ACTIVE_VOICECALL!!");
            }
        ...
        public int InternalVoicecallPreprocess(HashMap<String, Object> map) {
            ...
            if (traeAudioManager._am == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " InternalVoicecallPreprocess am==null!!");
                }
                return -1;
            }
            if (traeAudioManager._activeMode == 1) {
            ...
            if (num == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " params.get(PARAM_MODEPOLICY)==null!!");
                }
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "  _modePolicy:" + TraeAudioManager.this._modePolicy);
            }
            Integer num2 = (Integer) map.get(TraeAudioManager.PARAM_STREAMTYPE);
            if (num2 == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " params.get(PARAM_STREAMTYPE)==null!!");
                }
        ...
        public void _init() {
            ...
            try {
                ...
                ii5.m136342l(TraeAudioManager.this._context, this._parent, intentFilter);
            } catch (Exception unused) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "======7");
                }
            }
            AudioDeviceInterface.LogTraceExit();
        }
        ...
        public void _post_stopService() {
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "stop service failed." + e.getMessage());
                }
            }
        }
        ...
        public void _uninit() {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "uninit failed." + e.getMessage());
                }
            }
            AudioDeviceInterface.LogTraceExit();
        }
        ...
        public int interruptRing() {
            ...
            if (traeAudioManager._am == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " interruptRing am==null!!");
                }
                return -1;
            }
            if (traeAudioManager._activeMode != 2) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " not ACTIVE_RING!!");
                }
                return -1;
            }
        ...
        public void quit() {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "  quit used:" + (SystemClock.elapsedRealtime() - jElapsedRealtime) + "ms");
            }
            ...
            this.mMsgHandler = new Handler() { // from class: com.tencent.rtmp.sharp.jni.TraeAudioManager.TraeAudioManagerLooper.2
                ...
                public void handleMessage(Message message) {
                    ...
                    if (!traeAudioManagerLooper._enabled) {
                        if (QLog.isColorLevel()) {
                            QLog.m84595w("TRAE", 2, "******* disabled ,skip msg******");
                        }
                    ...
                    switch (i) {
                        ...
                        case TraeAudioManagerLooper.MESSAGE_CONNECT_HIGHEST_PRIORITY_DEVICE /* 32789 */:
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m84595w("TRAE", 2, "MESSAGE_AUTO_DEVICELIST_UPDATE  connectedDev:" + connectedDevice + " highestDev" + availabledHighestPriorityDevice);
                            }
                        ...
                        case TraeAudioManagerLooper.MESSAGE_AUTO_DEVICELIST_PLUGIN_UPDATE /* 32786 */:
                            ...
                            if (TraeAudioManager.this.InternalConnectDevice(str, null, false) != 0) {
                                if (QLog.isColorLevel()) {
                                    QLog.m84595w("TRAE", 2, " plugin dev:" + str + " sessionConnectedDev:" + TraeAudioManager.this.sessionConnectedDev + " connected fail,auto switch!");
                                }
                                TraeAudioManager traeAudioManager2 = TraeAudioManager.this;
                        ...
                        case TraeAudioManagerLooper.MESSAGE_AUTO_DEVICELIST_PLUGOUT_UPDATE /* 32787 */:
                            ...
                            if (traeAudioManager3.InternalConnectDevice(traeAudioManager3.sessionConnectedDev, null, false) != 0) {
                                ...
                                if (QLog.isColorLevel()) {
                                    QLog.m84595w("TRAE", 2, " plugout dev:" + str2 + " sessionConnectedDev:" + TraeAudioManager.this.sessionConnectedDev + " connected fail,auto switch!");
                                }
                                TraeAudioManager traeAudioManager4 = TraeAudioManager.this;
                        ...
                        case TraeAudioManagerLooper.MESSAGE_VOICECALL_AUIDOPARAM_CHANGED /* 32788 */:
                            ...
                            if (num != null) {
                                ...
                                QLog.m84590e("TRAE", 2, " MESSAGE_VOICECALL_AUIDOPARAM_CHANGED params.get(PARAM_STREAMTYPE)==null!!");
                            }
                            break;
        ...
        public void startService(HashMap<String, Object> map) {
            ...
            QLog.m84595w("TRAE", 2, "   startService:" + str);
                ...
                if (this._ringPlayer == null) {
                    this._ringPlayer = new TraeMediaPlayer(TraeAudioManager.this._context, new TraeMediaPlayer.OnCompletionListener() { // from class: com.tencent.rtmp.sharp.jni.TraeAudioManager.TraeAudioManagerLooper.1
                        ...
                        public void onCompletion() {
                            if (QLog.isColorLevel()) {
                                QLog.m84595w("TRAE", 2, "_ringPlayer onCompletion _activeMode:" + TraeAudioManager.this._activeMode + " _preRingMode:" + TraeAudioManagerLooper.this._preRingMode);
                            }
        ...
        public void stopService() {
            ...
            if (this._enabled) {
                ...
                if (TraeAudioManager.this._switchThread != null) {
                    if (QLog.isColorLevel()) {
                        QLog.m84595w("TRAE", 2, "_switchThread:" + TraeAudioManager.this._switchThread.getDeviceName());
                    }
                ...
                if (traeAudioManager._am != null && traeAudioManager._context != null) {
                    try {
                        ...
                        if (isNeedForceVolumeType()) {
                            QLog.m84595w("TRAE", 2, "NeedForceVolumeType: AudioManager.STREAM_MUSIC");
                            TraeAudioManager.forceVolumeControlStream(TraeAudioManager.this._am, 3);
                        }
                    } catch (Exception e) {
                        if (QLog.isColorLevel()) {
                            QLog.m84590e("TRAE", 2, "set mode failed." + e.getMessage());
                        }
                    }
                }
                _post_stopService();
    ...
    public class bluetoothHeadsetSwitchThread extends switchThread {
        ...
        public void _run() {
            if (TraeAudioManager.IsMusicScene || !TraeAudioManager.IsUpdateSceneFlag) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "connect bluetoothHeadset: do nothing, IsMusicScene:" + TraeAudioManager.IsMusicScene + " ,IsUpdateSceneFlag:" + TraeAudioManager.IsUpdateSceneFlag);
                }
                updateStatus();
                return;
            }
            if (!TraeAudioManager.enableDeviceSwitchFlag) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "connect bluetoothHeadset: disableDeviceSwitchFlag");
                    return;
                }
                return;
            }
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "bluetoothHeadsetSwitchThread sco fail,remove btheadset");
            }
    ...
    public class earphoneSwitchThread extends switchThread {
        ...
        public void _run() {
            ...
            if (!TraeAudioManager.IsUpdateSceneFlag) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "connect earphone: do nothing");
                }
            } else {
                if (!TraeAudioManager.enableDeviceSwitchFlag) {
                    if (QLog.isColorLevel()) {
                        QLog.m84595w("TRAE", 2, "connect earphone: disableDeviceSwitchFlag");
                        return;
                    }
                    return;
                }
    ...
    public class headsetSwitchThread extends switchThread {
        ...
        public void _run() {
            ...
            if (TraeAudioManager.IsMusicScene || !TraeAudioManager.IsUpdateSceneFlag) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "connect headset: do nothing");
                }
            } else {
                if (!TraeAudioManager.enableDeviceSwitchFlag) {
                    if (QLog.isColorLevel()) {
                        QLog.m84595w("TRAE", 2, "connect headset: disableDeviceSwitchFlag");
                        return;
                    }
                    return;
                }
    ...
    public class speakerSwitchThread extends switchThread {
        ...
        public void _run() {
            ...
            if (TraeAudioManager.IsMusicScene || !TraeAudioManager.IsUpdateSceneFlag) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "connect speakerPhone: do nothing");
                    return;
                }
                return;
            }
            if (!TraeAudioManager.enableDeviceSwitchFlag) {
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "connect speakerPhone: disableDeviceSwitchFlag");
                    return;
                }
                return;
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " _run:" + getDeviceName() + " _running:" + this._running);
            }
            int i = 0;
            while (this._running) {
                if (!TraeAudioManager.this._am.isSpeakerphoneOn()) {
    ...
    public abstract class switchThread extends Thread {
        ...
        public switchThread() {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " ++switchThread:" + getDeviceName());
            }
        }
        ...
        public void processDeviceConnectRes(int i) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " sessonID:" + l2);
            }
            if (l2 == null || l2.longValue() == Long.MIN_VALUE) {
                TraeAudioManager.this.InternalNotifyDeviceListUpdate();
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "processDeviceConnectRes sid null,don't send res");
                    return;
                }
                return;
            }
        ...
        public void quit() {
            ...
            this._running = false;
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " quit:" + getDeviceName() + " _running:" + this._running);
            }
            interrupt();
            _quit();
    ...
    public static boolean IsEabiLowVersion() {
        ...
        try {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "IsEabiVersion CPU_ABI:" + str + " CPU_ABI2:" + str2);
            }
    ...
    public static int SetSpeakerForTest(Context context, boolean z) {
        ...
        if (traeAudioManager != null) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "TraeAudioManager|static SetSpeakerForTest|null == _ginstance");
            }
    ...
    public static void forceVolumeControlStream(AudioManager audioManager, int i) {
        if (Build.MANUFACTURER.equals(ThirdPushManager.VENDOR_TYPE_FCM)) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "forceVolumeControlStream, Google phone nothing to do");
                return;
            }
            return;
        }
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "forceVolumeControlStream  streamType:" + i + " res:" + objInvokeMethod);
        }
    }
    ...
    public static int getAudioSource(int i) {
        if (!IsMusicScene) {
            if (!IsEabiLowVersion()) {
                if (i < 0) {
                    if (QLog.isColorLevel()) {
                        QLog.m84595w("TRAE", 2, "[Config] getAudioSource _audioSourcePolicy:" + i + " source:7");
                    }
                    return 7;
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "[Config] getAudioSource _audioSourcePolicy:" + i + " source:" + i);
                }
                return i;
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "[Config] armeabi low Version, getAudioSource _audioSourcePolicy:" + i + " source:0");
            }
        }
        return 0;
    }
    ...
    public static int getAudioStreamType(int i) {
        if (!IsMusicScene) {
            if (!IsEabiLowVersion()) {
                int i2 = i >= 0 ? i : 0;
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "[Config] getAudioStreamType audioStreamTypePolicy:" + i + " streamType:" + i2);
                }
                return i2;
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "[Config] armeabi low Version, getAudioStreamType audioStreamTypePolicy:" + i + " streamType:3");
            }
        }
        return 3;
    }
    ...
    public static int getCallAudioMode(int i) {
        if (!IsMusicScene) {
            if (!IsEabiLowVersion()) {
                if (i >= 0) {
                    if (QLog.isColorLevel()) {
                        QLog.m84595w("TRAE", 2, "[Config] getCallAudioMode modePolicy:" + i + " mode:" + i);
                    }
                    return i;
                }
                if (QLog.isColorLevel()) {
                    QLog.m84595w("TRAE", 2, "[Config] getCallAudioMode _modePolicy:" + i + " mode:3facturer:" + Build.MANUFACTURER + " model:" + Build.MODEL);
                }
                return 3;
            }
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "[Config] armeabi low Version, getCallAudioMode modePolicy:" + i + " mode:0");
            }
        }
        return 0;
    }
    ...
    public static int getForceUse(int i) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "getForceUse  usage:" + i + " config:" + num + " ->" + getForceConfigName(num.intValue()));
        }
        return num.intValue();
    }
    ...
    public static Object invokeMethod(Object obj, String str, Object[] objArr, Class[] clsArr) {
        try {
            ...
            QLog.m84595w("TRAE", 2, "invokeMethod Exception:" + e.getMessage());
            return null;
        }
    }
    ...
    public static Object invokeStaticMethod(String str, String str2, Object[] objArr, Class[] clsArr) {
        try {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "ClassNotFound:" + str);
            }
            return null;
        } catch (IllegalAccessException unused2) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "IllegalAccess:" + str2);
            }
            return null;
        } catch (IllegalArgumentException unused3) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "IllegalArgument:" + str2);
            }
            return null;
        } catch (NoSuchMethodException unused4) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "NoSuchMethod:" + str2);
            }
            return null;
        } catch (InvocationTargetException unused5) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "InvocationTarget:" + str2);
            }
            return null;
        } catch (Exception e) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "invokeStaticMethod Exception:" + e.getMessage());
            }
            return null;
        }
    }
    ...
    public static void setForceUse(int i, int i2) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "setForceUse  usage:" + i + " config:" + i2 + " ->" + getForceConfigName(i2) + " res:" + objInvokeStaticMethod);
        }
    }
    ...
    public static void setParameters(String str) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "setParameters  :" + str);
        }
    ...
    public BluetoohHeadsetCheckInterface CreateBluetoothCheck(Context context, DeviceConfigManager deviceConfigManager) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "CreateBluetoothCheck:" + bluetoohHeadsetCheck.interfaceDesc() + " skip android4.3:N");
        }
        return bluetoohHeadsetCheck;
    }
    ...
    public int InternalConnectDevice(String str, HashMap<String, Object> map, boolean z) {
        ...
        if (IsMusicScene && str.equals(DEVICE_EARPHONE)) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "MusicScene, Connect device:" + str + " failed");
            }
            return -1;
        }
        if (!IsEarPhoneSupported && str.equals(DEVICE_EARPHONE)) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "IsEarPhoneSupported = false, Connect device:" + str + " failed");
            }
            return -1;
        }
        ...
        if (!checkDevName(str) || !this._deviceConfigManager.getVisible(str)) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, " checkDevName fail");
            }
            return -1;
        }
        if (!InternalIsDeviceChangeable()) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, " InternalIsDeviceChangeable fail");
            }
            return -1;
        }
        if (this._switchThread != null) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "_switchThread:" + this._switchThread.getDeviceName());
            }
    ...
    public int InternalSessionConnectDevice(HashMap<String, Object> map) {
        ...
        if (IsMusicScene) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "MusicScene: InternalSessionConnectDevice failed");
            }
            return -1;
        }
        ...
        if (!IsEarPhoneSupported && str.equals(DEVICE_EARPHONE)) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "InternalSessionConnectDevice IsEarPhoneSupported = false, Connect device:" + str + " failed");
            }
            return -1;
        }
        ...
        if (!str.equals(this._deviceConfigManager.getConnectedDevice())) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " --connecting...");
            }
        ...
        if (QLog.isColorLevel()) {
            QLog.m84590e("TRAE", 2, " --has connected!");
        }
    ...
    public void InternalSetMode(int i) {
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "SetMode entry:" + i);
        }
        AudioManager audioManager = this._am;
        if (audioManager == null) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "setMode:" + i + " fail am=null");
                return;
            }
            return;
        }
    ...
    public int InternalSetSpeaker(Context context, boolean z) {
        if (context == null) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "Could not InternalSetSpeaker - no context");
            }
            return -1;
        }
        ...
        if (audioManager == null) {
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "Could not InternalSetSpeaker - no audio manager");
            }
            return -1;
        }
        if (QLog.isColorLevel()) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "InternalSetSpeaker exit:" + z + " res:" + i + " mode:" + audioManager.getMode());
        }
        return i;
    }
    ...
    public int InternalSetSpeakerSpe(AudioManager audioManager, boolean z) {
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "InternalSetSpeakerSpe fac:" + Build.MANUFACTURER + " model:" + Build.MODEL + " st:" + this._streamType + " media_force_use:" + getForceUse(1));
        }
        if (z) {
            InternalSetMode(0);
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "InternalSetSpeakerSpe exit:" + z + " res:" + i + " mode:" + audioManager.getMode());
        }
        return i;
    }
    ...
    public void _updateEarphoneVisable() {
        if (this._deviceConfigManager.getVisible(DEVICE_WIREDHEADSET)) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " detected headset plugin,so disable earphone");
            }
            this._deviceConfigManager.setVisible(DEVICE_EARPHONE, false);
        } else {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " detected headset plugout,so enable earphone");
            }
    ...
    public void checkAutoDeviceListUpdate() {
        if (this._deviceConfigManager.getVisiableUpdateFlag()) {
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "checkAutoDeviceListUpdate got update!");
            }
    ...
    public void checkDevicePlug(String str, boolean z) {
        if (this._deviceConfigManager.getVisiableUpdateFlag()) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " ---No switch,plugout:" + str + " connectedDev:" + connectedDevice);
            }
            internalSendMessage(TraeAudioManagerLooper.MESSAGE_AUTO_DEVICELIST_UPDATE, new HashMap<>());
        }
    }
    ...
    public void onHeadsetPlug(Context context, Intent intent) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "onHeadsetPlug:: ".concat(strConcat2));
        }
        this._deviceConfigManager.setVisible(DEVICE_WIREDHEADSET, 1 == intExtra);
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "onHeadsetPlug exit");
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent == null || context == null) {
            if (QLog.isColorLevel()) {
                QLog.m84588d("TRAE", 2, "onReceive intent or context is null!");
                return;
            }
            return;
        }
        try {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "TraeAudioManager|onReceive::Action:" + intent.getAction());
            }
            DeviceConfigManager deviceConfigManager = this._deviceConfigManager;
            if (deviceConfigManager == null) {
                if (QLog.isColorLevel()) {
                    QLog.m84588d("TRAE", 2, "_deviceConfigManager null!");
                    return;
                }
                return;
            }
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "   OPERATION:" + stringExtra);
            }
            ...
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "deal with receiver failed." + e.getMessage());
            }
        }
    }
    ...
    public void printDevices() {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "   ConnectedDevice:" + this._deviceConfigManager.getConnectedDevice());
        }
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "   ConnectingDevice:" + this._deviceConfigManager.getConnectingDevice());
        }
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "   prevConnectedDevice:" + this._deviceConfigManager.getPrevConnectedDevice());
        }
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "   AHPDevice:" + this._deviceConfigManager.getAvailabledHighestPriorityDevice());
        }
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "   deviceNamber:" + deviceNumber);
        }
        int i = 0;
        while (true) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "      " + i + " devName:" + deviceName + " Visible:" + this._deviceConfigManager.getVisible(deviceName) + " Priority:" + this._deviceConfigManager.getPriority(deviceName));
            }
            i++;
        }
        String[] strArr = (String[]) deviceConfigManager.getAvailableDeviceList().toArray(new String[0]);
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, "   AvailableNamber:" + strArr.length);
        }
        for (int i2 = 0; i2 < strArr.length; i2++) {
            String str = strArr[i2];
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "      " + i2 + " devName:" + str + " Visible:" + this._deviceConfigManager.getVisible(str) + " Priority:" + this._deviceConfigManager.getPriority(str));
            }
        }
        AudioDeviceInterface.LogTraceExit();
    }
    ...
    public int sendResBroadcast(final Intent intent, HashMap<String, Object> map, final int i) {
        ...
        if (QLog.isColorLevel()) {
            QLog.m84595w("TRAE", 2, " sessonID:" + l2 + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + ((String) map.get(PARAM_OPERATION)));
        }
        if (l2 == null || l2.longValue() == Long.MIN_VALUE) {
            InternalNotifyDeviceListUpdate();
            if (QLog.isColorLevel()) {
                QLog.m84590e("TRAE", 2, "sendResBroadcast sid null,don't send res");
            }
            return -1;
        }
    ...
    public void updateDeviceStatus() {
        ...
        for (int i = 0; i < deviceNumber; i++) {
            ...
            if (visible && QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, "pollUpdateDevice dev:" + deviceName + " Visible:" + this._deviceConfigManager.getVisible(deviceName));
            }
        }
    ...
    public class DeviceConfigManager {
        ...
        public boolean _addConfig(String str, int i) {
            ...
            if (!deviceConfig.init(str, i)) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, " err dev init!");
                }
                return false;
            }
            if (this.deviceConfigs.containsKey(str)) {
                if (QLog.isColorLevel()) {
                    QLog.m84590e("TRAE", 2, "err dev exist!");
                }
                return false;
            }
            ...
            if (QLog.isColorLevel()) {
                QLog.m84595w("TRAE", 2, " n" + getDeviceNumber() + " 0:" + getDeviceName(0));
            }
            AudioDeviceInterface.LogTraceExit();
            return true;
        }
