...
import com.tencent.liteav.InterfaceC14114k;
...
public class TXCloudVideoView extends FrameLayout implements View.OnTouchListener {
    ...
    private InterfaceC14114k mCapture;
    ...
    private float mTop;
    private RunnableC14423a mTouchFocusRunnable;
    ...
    public TXCloudVideoView(Context context, AttributeSet attributeSet) {
        ...
        this.mScaleGestureListener = new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.tencent.rtmp.ui.TXCloudVideoView.2
            ...
            public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
                float f;
                int iMo83356e = TXCloudVideoView.this.mCapture != null ? TXCloudVideoView.this.mCapture.mo83356e() : 0;
                if (iMo83356e > 0) {
                    float scaleFactor = scaleGestureDetector.getScaleFactor();
                    if (scaleFactor > 1.0f) {
                        scaleFactor = ((0.2f / iMo83356e) * (iMo83356e - TXCloudVideoView.this.mCurrentScale)) + 1.0f;
                        f = 1.1f;
                        if (scaleFactor <= 1.1f) {
                            scaleFactor = f;
                        }
                    } else if (scaleFactor < 1.0f) {
                        scaleFactor = 1.0f - ((0.2f / iMo83356e) * TXCloudVideoView.this.mCurrentScale);
                        f = 0.9f;
                        if (scaleFactor >= 0.9f) {
                            scaleFactor = f;
                        }
                    ...
                    if (scaleFactor > 1.0f) {
                        if (iMo83356e < TXCloudVideoView.this.mCurrentScale) {
                            iMo83356e = TXCloudVideoView.this.mCurrentScale;
                        }
                    } else if (scaleFactor < 1.0f && iMo83356e > TXCloudVideoView.this.mCurrentScale) {
                        iMo83356e = TXCloudVideoView.this.mCurrentScale;
                    }
                    TXCloudVideoView.this.mCurrentScale = iMo83356e;
                    if (TXCloudVideoView.this.mCapture != null) {
                        TXCloudVideoView.this.mCapture.mo83345a(TXCloudVideoView.this.mCurrentScale);
                    }
                }
                return false;
            }
        ...
        this.mTouchFocusRunnable = new RunnableC14423a();
    ...
    private void updateDbMargin() {
        ...
        if (tXDashBoard != null) {
            tXDashBoard.m84603a((int) this.mLeft, (int) this.mTop, (int) this.mRight, (int) this.mBottom);
        }
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (motionEvent.getPointerCount() == 1 && motionEvent.getAction() == 0) {
            this.mTouchFocusRunnable.m84598a(view);
            this.mTouchFocusRunnable.m84597a(motionEvent);
    ...
    public void setDashBoardStatusInfo(CharSequence charSequence) {
        TXDashBoard tXDashBoard = this.mDashBoard;
        if (tXDashBoard != null) {
            tXDashBoard.m84606a(charSequence);
        }
    }
    ...
    public void setLogMargin(float f, float f2, float f3, float f4) {
        ...
        TXDashBoard tXDashBoard = this.mDashBoard;
        if (tXDashBoard != null) {
            tXDashBoard.m84603a((int) f, (int) f3, (int) f2, (int) f4);
        }
    }
    ...
    public void setLogMarginRatio(final float f, final float f2, final float f3, final float f4) {
        ...
        postDelayed(new Runnable() { // from class: com.tencent.rtmp.ui.TXCloudVideoView.1
            ...
            public void run() {
                ...
                if (tXDashBoard != null) {
                    tXDashBoard.m84603a((int) tXCloudVideoView5.mLeft, (int) TXCloudVideoView.this.mTop, (int) TXCloudVideoView.this.mRight, (int) TXCloudVideoView.this.mBottom);
                }
            }
        }, 100L);
    }
    ...
    public void setLogText(Bundle bundle, Bundle bundle2, int i) {
        TXDashBoard tXDashBoard = this.mDashBoard;
        if (tXDashBoard != null) {
            tXDashBoard.m84605a(bundle, bundle2, i);
        }
    }
    ...
    public void start(boolean z, boolean z2, InterfaceC14114k interfaceC14114k) {
        this.mFocus = z;
        this.mZoom = z2;
        if (z || z2) {
            setOnTouchListener(this);
            this.mCapture = interfaceC14114k;
        }
        TXCGLSurfaceView tXCGLSurfaceView = this.mGLSurfaceView;
        if (tXCGLSurfaceView != null) {
    ...
    public class RunnableC14423a implements Runnable {

        /* JADX INFO: renamed from: b */
        private View f60439b;

        /* JADX INFO: renamed from: c */
        private MotionEvent f60440c;

        private RunnableC14423a() {
        }

        /* JADX INFO: renamed from: a */
        public void m84598a(View view) {
            this.f60439b = view;
        }
        ...
        public void run() {
            if (TXCloudVideoView.this.mCapture != null && TXCloudVideoView.this.mFocus) {
                TXCloudVideoView.this.mCapture.mo83335a(this.f60440c.getX() / this.f60439b.getWidth(), this.f60440c.getY() / this.f60439b.getHeight());
            }
            if (TXCloudVideoView.this.mFocus) {
                TXCloudVideoView.this.onTouchFocus((int) this.f60440c.getX(), (int) this.f60440c.getY());
            }
        }

        /* JADX INFO: renamed from: a */
        public void m84597a(MotionEvent motionEvent) {
            this.f60440c = motionEvent;
        }
    }
