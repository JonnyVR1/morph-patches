...
public class LogWriter {
    ...
    /* JADX INFO: renamed from: a */
    public final void m84634a() throws Exception {
        String property;
        YtLogger.m84637d("LogWriter", "init()");
        File file = new File(this.f60554d);
        if (!file.exists()) {
            file.mkdir();
        }
        if (this.f60553c == null) {
            try {
            ...
            this.f60553c = property;
            if (property == null) {
                this.f60553c = this.f60551a;
            }
        }
        YtLogger.m84637d("LogWriter", "logFileName: " + this.f60553c);
        File file2 = new File(this.f60553c);
        try {
            this.f60552b = new PrintWriter((Writer) new FileWriter(file2, false), true);
    ...
    public void close() {
        logWriter = null;
        PrintWriter printWriter = this.f60552b;
        if (printWriter != null) {
            printWriter.close();
        }
    }
    ...
    public synchronized void log(Exception exc) {
        this.f60552b.println(new Date() + ": ");
        exc.printStackTrace(this.f60552b);
    }
    ...
    public synchronized void log(String str) {
        this.f60552b.println(new Date() + ": " + str);
    }
