...
public final class YtLogger {
    ...
    public static void m84637d(String str, Object obj) {
    ...
    public static void m84638e(String str, String str2, Throwable th) {
    ...
    public static void m84639i(String str, String str2) {
    ...
    public static void m84640o(String str, Object obj) {
        int i = currentLogLevel;
        if (i == -1000 || i == 4) {
    ...
    public static void setNeedLogFile(boolean z, String str, String str2) {
        if (TextUtils.isEmpty(localLogPath)) {
            needLogFile = false;
            m84642w("YTLog", "file saved must put path", null);
            return;
        }
        needLogFile = z;
        if (z) {
    ...
    public static void m84641v(String str, Object obj) {
    ...
    public static void m84642w(String str, String str2, Throwable th) {
        int i = currentLogLevel;
        if (i >= 1 || i == -1000) {
