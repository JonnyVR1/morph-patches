...
public class YtVideoEncoder {
    ...
    public static int getMediaCodecInfo() {
        try {
            ...
            YtLogger.m84640o(TAG, "codecInfoName:" + codecInfo.getName() + " colorFormat:" + Arrays.toString(capabilitiesForType.colorFormats));
            ...
            YtLogger.m84638e(TAG, "get color format type error", e);
            return -1;
        }
    }
        ...
        synchronized (this.mediaMuxerSync) {
            try {
                if (this.videoEncoder != null) {
                    String str = TAG;
                    YtLogger.m84637d(str, "reset media codec");
                    this.videoEncoder.reset();
                    YtLogger.m84637d(str, "stop media codec");
                    this.videoEncoder.stop();
                    YtLogger.m84637d(str, "Release media codec");
                    this.videoEncoder.release();
                    this.videoEncoder = null;
                    YtLogger.m84637d(str, "RELEASE Video CODEC");
                }
                if (this.mediaMuxer != null) {
                    String str2 = TAG;
                    YtLogger.m84637d(str2, "Stop media muxer");
                    this.mediaMuxer.stop();
                    YtLogger.m84637d(str2, "Release media muxer");
                    this.mediaMuxer.release();
                    this.mediaMuxer = null;
                    this.isMediaMuxerStarted = false;
                    YtLogger.m84637d(str2, "RELEASE MUXER");
                }
        ...
        synchronized (this.mediaMuxerSync) {
            if (this.isMediaMuxerStarted) {
                ...
                try {
                    ...
                    YtLogger.m84638e(TAG, "media muxer stop failed:", e);
                }
                this.mediaMuxer.release();
                this.mediaMuxer = null;
                this.isMediaMuxerStarted = false;
                try {
                    ...
                    YtLogger.m84638e(TAG, "Unable to get path for ", e2);
                    return;
                }
            }
            ...
            if (i >= 1) {
                YtLogger.m84637d(TAG, "Media muxer is starting...");
    ...
    public void abortEncoding() {
        ...
        if (this.mOutputFile != null) {
            YtLogger.m84637d(TAG, "Clean up record file");
            this.mOutputFile.delete();
            this.mOutputFile = null;
        }
        if (this.videoEncoder == null || this.mediaMuxer == null) {
            YtLogger.m84639i(TAG, "Failed to abort encoding since it never started");
            return;
        }
        YtLogger.m84639i(TAG, "Aborting encoding");
        release();
    ...
    public void clearCache() {
        ...
        if (this.isEncodingStarted) {
            try {
                ...
                YtLogger.m84638e(TAG, "restart:stop video error", e);
            }
        }
        if (this.mediaMuxer != null) {
            this.mediaMuxer = null;
    ...
    public void encode(int i) throws Exception {
        ...
        if (!this.isEncodingStarted) {
            whq0.m203241a("encode not started");
            return;
        }
        YtLogger.m84637d(TAG, "Encoder started");
        ...
        if (yTImageDataPoll == null) {
            ...
            try {
                ...
                YtLogger.m84638e(TAG, "Queueing frame", e);
            }
            yTImageDataPoll = this.videoEncodeQueue.poll();
        }
        if (yTImageDataPoll == null) {
            YtLogger.m84638e(TAG, "encode data is Null!!: ", null);
            return;
        }
        ...
        if (iDequeueOutputBuffer == -1) {
            YtLogger.m84638e(TAG, "No output from encoder available", null);
            return;
        }
        ...
        if (iDequeueOutputBuffer < 0) {
            YtLogger.m84638e(TAG, "unexpected result from encoder.dequeueOutputBuffer: " + iDequeueOutputBuffer, null);
            return;
        }
        if (bufferInfo.size != 0) {
            ByteBuffer outputBuffer = getOutputBuffer(iDequeueOutputBuffer);
            if (outputBuffer == null) {
                YtLogger.m84638e(TAG, "encoderOutputBuffer " + iDequeueOutputBuffer + " was null", null);
                return;
            }
            outputBuffer.position(bufferInfo.offset);
            outputBuffer.limit(bufferInfo.offset + bufferInfo.size);
            YtLogger.m84637d(TAG, "media muxer write video data outputindex " + this.videoGenerateIndex);
    ...
    public String getSupportCodecJSONStr() {
        ...
        try {
            ...
            YtLogger.m84638e(TAG, "video encode make json error:", e);
        }
    ...
    public void queueFrame(YTImageData yTImageData) {
        ...
        YtLogger.m84637d(TAG, "Queueing frame");
    ...
    public void startEncoding(int i, int i2, File file, int i3, int i4, int i5, int i6) throws IOException {
        ...
        String str = TAG;
        YtLogger.m84640o(str, "found codec: " + codecInfo.getName() + "|colorFormat:" + colorFormat + "|width=" + i + "|height=" + i2 + "|videoRotation=" + i6);
        ...
        YtLogger.m84639i(str, "Initialization complete. Starting encoder...");
    ...
    public void stopEncoding() {
        ...
        YtLogger.m84639i(TAG, "Stopping encoding");
        this.mNoMoreFrames = true;
        synchronized (this.mFrameSync) {
            try {
                CountDownLatch countDownLatch = this.mNewFrameLatch;
