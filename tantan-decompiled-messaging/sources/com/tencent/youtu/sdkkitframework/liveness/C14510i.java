...
public class C14510i extends HashMap<String, Object> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ Exception f60799a;

    public C14510i(NetLivenessReqResultState netLivenessReqResultState, Exception exc) {
        this.f60799a = exc;
