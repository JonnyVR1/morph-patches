...
public class C14506e implements YtSDKKitFramework.IYtSDKKitNetResponseParser {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ YtLivenessNetProtoHelper.GetLiveTypeReqData f60793a;

    /* JADX INFO: renamed from: b */
    public final /* synthetic */ NetFetchState f60794b;
    ...
    public class a extends HashMap<String, Object> {
        ...
        public a(C14506e c14506e, String str) {
            this.f60795a = str;
    ...
    public C14506e(NetFetchState netFetchState, YtLivenessNetProtoHelper.GetLiveTypeReqData getLiveTypeReqData) {
        this.f60794b = netFetchState;
        this.f60793a = getLiveTypeReqData;
    }
    ...
    public void onNetworkResponseEvent(HashMap<String, String> map, Exception exc) {
        ...
        ?? r3;
        ?? r15 = "&";
        YtLogger.m84637d("NetFetchState", "response : " + map.get("response"));
        try {
            JSONObject jSONObject = new JSONObject(map.get("response"));
            YtLogger.m84640o("NetFetchState", "online actionData: " + jSONObject);
            if ((jSONObject.has(StateEvent.Name.ERROR_CODE) ? jSONObject.getInt(StateEvent.Name.ERROR_CODE) : jSONObject.has("errorcode") ? jSONObject.getInt("errorcode") : -1) == 0) {
                ...
                this.f60794b.stateData.put("color_data", string);
                this.f60794b.stateData.put("action_data", string2);
                NetFetchState netFetchState = this.f60794b;
                if (netFetchState.f60664f) {
                    netFetchState.stateData.put("action_data", netFetchState.f60662d);
                }
                try {
                    if (jSONObject.has("select_data")) {
                        if (jSONObject.getJSONObject("select_data").has(Constants.KEY_CONFIG)) {
                            ...
                            NetFetchState netFetchState2 = this.f60794b;
                            netFetchState2.stateData.put("control_config", netFetchState2.m84661a(strReplaceAll));
                        ...
                        if (jSONObject.getJSONObject("select_data").has("reflect_param")) {
                            this.f60794b.stateData.put("extra_config", jSONObject.getJSONObject("select_data").getString("reflect_param"));
                        }
                        if (jSONObject.getJSONObject("select_data").has("change_point_num")) {
                            this.f60794b.stateData.put("cp_num", jSONObject.getJSONObject("select_data").getString("change_point_num"));
                        }
                    } else {
                        r15 = 1;
                        YtLogger.m84638e("NetFetchState", "select_data not found or select_data.config not found", null);
                    }
                    if (jSONObject.has("video_config")) {
                        ...
                        if (jSONObject2.has("video_bitrate")) {
                            this.f60794b.stateData.put("video_bitrate", Integer.valueOf(jSONObject2.getInt("video_bitrate")));
                        }
                        if (jSONObject2.has("video_framerate")) {
                            this.f60794b.stateData.put("video_framerate", Integer.valueOf(jSONObject2.getInt("video_framerate")));
                        }
                        if (jSONObject2.has("video_iframeinterval")) {
                            this.f60794b.stateData.put("video_iframeinterval", Integer.valueOf(jSONObject2.getInt("video_iframeinterval")));
                        }
                    }
                    ...
                    YtLivenessNetProtoHelper.GetLiveTypeReqData getLiveTypeReqData = this.f60793a;
                    this.f60794b.stateData.put("sd_data", new YtLivenessNetProtoHelper.LiveStyleRequester.SeleceData(getLiveTypeReqData.baseInfo.lux, getLiveTypeReqData.colorNum, getLiveTypeReqData.reflectConfig, strMakeVersion, getLiveTypeReqData.controlConfig).toString());
                    this.f60794b.moveToNextState();
                    r3 = 0;
                } catch (JSONException e) {
                    e = e;
                    r13 = r15;
                    YtLogger.m84638e("NetFetchState", "parse response json other object failed:", e);
                    r14 = r13;
                    r3 = r14;
                }
            } else {
        ...
        if (r3 != 0) {
            YtLogger.m84638e("NetFetchState", "parse response failed", null);
