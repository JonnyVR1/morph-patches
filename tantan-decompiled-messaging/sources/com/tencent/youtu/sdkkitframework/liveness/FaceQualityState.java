...
public class FaceQualityState extends YtFSMBaseState {
    ...
    public static int f60641q = 10;

    /* JADX INFO: renamed from: a */
    public YtSDKKitCommon.StateNameHelper.StateClassName f60642a;

    /* JADX INFO: renamed from: k */
    public boolean f60652k;
    ...
    public float f60643b = 25.0f;

    /* JADX INFO: renamed from: c */
    public float f60644c = 25.0f;

    /* JADX INFO: renamed from: d */
    public float f60645d = 25.0f;

    /* JADX INFO: renamed from: e */
    public float f60646e = 0.6f;

    /* JADX INFO: renamed from: f */
    public float f60647f = 0.1f;

    /* JADX INFO: renamed from: g */
    public float f60648g = 0.95f;

    /* JADX INFO: renamed from: h */
    public float f60649h = 0.25f;

    /* JADX INFO: renamed from: i */
    public float f60650i = 0.25f;

    /* JADX INFO: renamed from: j */
    public float f60651j = 0.25f;

    /* JADX INFO: renamed from: n */
    public int f60655n = 99;

    /* JADX INFO: renamed from: o */
    public int f60656o = 90;

    /* JADX INFO: renamed from: p */
    public boolean f60657p = false;

    /* JADX INFO: renamed from: com.tencent.youtu.sdkkitframework.liveness.FaceQualityState$a */
    public class C14483a extends HashMap<String, Object> {
        public C14483a(FaceQualityState faceQualityState) {
    ...
    public static class C14484b {

        /* JADX INFO: renamed from: a */
        public byte[] f60658a;

        public C14484b(byte[] bArr, int i, int i2) {
            this.f60658a = bArr;
        }
    }

    /* JADX INFO: renamed from: a */
    public final boolean m84658a(YTFaceTracker.TrackedFace trackedFace) {
        ...
        boolean z = fSqrt2 > this.f60649h && fSqrt4 > this.f60650i;
        if (!z) {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("quality_type", "eye_close");
                jSONObject.put("quality_score", fSqrt2 + Constants.SEPARATOR_COMMA + fSqrt4);
                jSONObject.put("quality_thr", this.f60649h + Constants.SEPARATOR_COMMA + this.f60650i);
            } catch (JSONException e) {
                YtLogger.m84638e("FaceQualityState", "make log json error", e);
            }
            YtLogger.m84640o("FaceQualityState", jSONObject.toString());
        }
        return z;
    }

    /* JADX INFO: renamed from: b */
    public final boolean m84660b(YTFaceTracker.TrackedFace trackedFace) {
        float[] fArr = trackedFace.faceShape;
        float fAbs = Math.abs(((fArr[129] + fArr[109]) / 2.0f) - ((fArr[119] + fArr[97]) / 2.0f)) / Math.abs(fArr[90] - fArr[102]);
        boolean z = fAbs < this.f60651j;
        if (!z) {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("quality_type", "mouth_cLose");
                jSONObject.put("quality_score", fAbs);
                jSONObject.put("quality_thr", this.f60651j);
            } catch (JSONException e) {
                YtLogger.m84638e("FaceQualityState", "make log json error", e);
            }
            YtLogger.m84640o("FaceQualityState", jSONObject.toString());
    ...
    public void enterFirst() {
        YtLogger.m84640o("FaceQualityState", makeStateInfo("FaceQualityState", 1));
        ...
        for (String str2 : str.split("&")) {
            ...
            if (strArrSplit.length > 1 && strArrSplit[0].equals("quality_close_mouth_threshold")) {
                this.f60651j = Float.parseFloat(strArrSplit[1]);
            }
    ...
    public void loadStateWith(String str, JSONObject jSONObject, YtSdkConfig ytSdkConfig) {
        ...
        this.f60642a = YtSDKKitCommon.StateNameHelper.StateClassName.SILENT_STATE;
        this.f60654m = 0;
    }
    ...
    public void moveToNextState() {
        ...
        if (this.f60642a != YtSDKKitCommon.StateNameHelper.StateClassName.SILENT_STATE) {
            YtFSM.getInstance().transitNow(YtSDKKitCommon.StateNameHelper.classNameOfState(this.f60642a));
        } else if (YtFSM.getInstance().transitNextRound(YtSDKKitCommon.StateNameHelper.classNameOfState(this.f60642a)) == -1) {
            sendFSMTransitError(YtSDKKitCommon.StateNameHelper.classNameOfState(this.f60642a));
        }
    }
    ...
    public void update(YTImageData yTImageData, long j) {
        ...
        if (this.f60657p && this.isPause.get()) {
            YtFSM.getInstance().sendFSMEvent(new C14483a(this));
            try {
                Thread.sleep(30L);
                return;
            } catch (InterruptedException e) {
                YtLogger.m84638e("FaceQualityState", "Thread sleep error", e);
                return;
            }
        }
        YtSDKKitCommon.StateNameHelper.StateClassName stateClassName = this.f60642a;
        ...
        if (this.f60652k && this.f60653l) {
            ...
            if (iIntValue2 != 0) {
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, C14516o.m84686b(iIntValue2));
                moveToNextState();
                return;
            }
            if (!C14516o.m84683a(trackedFace, this.f60643b, this.f60644c, this.f60645d)) {
                YtLogger.m84640o("FaceQualityState", "correctionFace  angle not pass, threshold y:" + this.f60643b + "|p=" + this.f60644c + "|r=" + this.f60645d);
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, StringCode.FL_POSE_INCORRECT);
                moveToNextState();
                return;
            }
            ...
            float f2 = iMax;
            float f3 = this.f60647f * f2;
            float f4 = f2 * this.f60648g;
            float f5 = iHeight;
            if (f5 < f3) {
                JSONObject jSONObject = new JSONObject();
                try {
                    ...
                    YtLogger.m84638e("FaceQualityState", "make log json error", e2);
                }
                YtLogger.m84640o("FaceQualityState", jSONObject.toString());
                c = 1;
            } else if (f5 > f4) {
                ...
                try {
                    ...
                    YtLogger.m84638e("FaceQualityState", "make log json error", e3);
                }
                YtLogger.m84640o("FaceQualityState", jSONObject2.toString());
                c = 2;
            } else {
                c = 0;
            }
            if (c == 1) {
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, StringCode.FL_POSE_CLOSER);
                moveToNextState();
                return;
            }
            if (c == 2) {
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, StringCode.FL_POSE_FARER);
                moveToNextState();
                return;
            }
            if (!m84660b(trackedFace)) {
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, StringCode.FL_CLOSE_MOUTH);
                moveToNextState();
                return;
            }
            if (!m84658a(trackedFace)) {
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, StringCode.FL_POSE_OPEN_EYE);
                moveToNextState();
                return;
            }
            boolean zM84659a = m84659a(trackedFace, yTImageData.width, yTImageData.height);
            if (this.f60653l && !zM84659a) {
                this.f60654m = 0;
                m84657a(StateEvent.ActionValue.STAGE_NOTPASS, StringCode.FL_POSE_CLOSER);
                moveToNextState();
                return;
            }
            int i = this.f60654m + 1;
            this.f60654m = i;
            if (i < f60641q) {
                m84657a(StateEvent.ActionValue.STAGE_PASS, StringCode.FL_POSE_KEEP);
                moveToNextState();
                return;
            }
            int iHeight2 = trackedFace.faceRect.height();
            int iWidth = trackedFace.faceRect.width();
            float f6 = yTImageData.height * this.f60646e;
            byte[] bArrBgr2JPEG = yTImageData.bgr2JPEG(this.f60656o);
            float f7 = iHeight2;
            if (f7 < f6) {
                ...
                float f10 = f8 / f9;
                float f11 = f7 / f9;
                float f12 = this.f60646e;
                if (f11 < f12) {
                    float f13 = this.f60647f;
                    if (f13 < f12) {
                ...
                bitmapCreateScaledBitmap.compress(Bitmap.CompressFormat.JPEG, this.f60656o, byteArrayOutputStream);
                bArrBgr2JPEG = byteArrayOutputStream.toByteArray();
                try {
                    byteArrayOutputStream.close();
                } catch (IOException e4) {
                    YtLogger.m84638e("FaceQualityState", "LocalFaceBestImage close IO error", e4);
                }
            ...
            map.put(StateEvent.Name.BEST_FACE_IMAGE, new C14484b(bArrBgr2JPEG, yTImageData.width, yTImageData.height));
        ...
        if (iOrdinal == 2 || iOrdinal == 3) {
            this.f60642a = YtSDKKitCommon.StateNameHelper.StateClassName.ACTION_STATE;
        } else if (iOrdinal == 4) {
            this.f60642a = YtSDKKitCommon.StateNameHelper.StateClassName.REFLECT_STATE;
        } else if (iOrdinal == 5) {
            this.f60642a = YtSDKKitCommon.StateNameHelper.StateClassName.ACTION_STATE;
        }
        this.f60654m = 0;
    ...
    public void updateSDKSetting(JSONObject jSONObject) {
        ...
        try {
            if (jSONObject.has("quality_close_eye_left_threshold")) {
                this.f60649h = (float) jSONObject.getDouble("quality_close_eye_left_threshold");
            }
            if (jSONObject.has("quality_close_eye_right_threshold")) {
                this.f60650i = (float) jSONObject.getDouble("quality_close_eye_right_threshold");
            }
            if (jSONObject.has("quality_close_mouth_threshold")) {
                this.f60651j = (float) jSONObject.getDouble("quality_close_mouth_threshold");
            }
            if (jSONObject.has("quality_face_min_height_threshold")) {
                this.f60646e = (float) jSONObject.getDouble("quality_face_min_height_threshold");
            }
            if (jSONObject.has("quality_face_max_height_threshold")) {
                this.f60648g = (float) jSONObject.getDouble("quality_face_max_height_threshold");
            }
            if (jSONObject.has("secondary_yaw_threshold")) {
                this.f60643b = (float) jSONObject.getDouble("secondary_yaw_threshold");
            }
            if (jSONObject.has("secondary_pitch_threshold")) {
                this.f60644c = (float) jSONObject.getDouble("secondary_pitch_threshold");
            }
            if (jSONObject.has("secondary_roll_threshold")) {
                this.f60645d = (float) jSONObject.getDouble("secondary_roll_threshold");
            }
            if (jSONObject.has("need_face_quality")) {
                this.f60652k = jSONObject.getBoolean("need_face_quality");
            }
            if (jSONObject.has("need_local_face_best_image")) {
                this.f60653l = jSONObject.getBoolean("need_local_face_best_image");
            }
            if (jSONObject.has("local_face_best_image_quality")) {
                this.f60656o = jSONObject.getInt("local_face_best_image_quality");
            }
            if (jSONObject.has("continuous_quality_num_threshold")) {
                f60641q = jSONObject.getInt("continuous_quality_num_threshold");
            }
            if (jSONObject.has("quality_face_real_min_height_threshold")) {
                this.f60647f = (float) jSONObject.getDouble("quality_face_real_min_height_threshold");
            }
            if (jSONObject.has("need_close_timeout")) {
                this.f60657p = jSONObject.getBoolean("need_close_timeout");
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    /* JADX INFO: renamed from: a */
    public final boolean m84659a(YTFaceTracker.TrackedFace trackedFace, float f, float f2) {
        float f3;
        int iHeight = trackedFace.faceRect.height();
        int iWidth = trackedFace.faceRect.width();
        float f4 = this.f60646e;
        float f5 = iHeight;
        boolean z = true;
        if (f5 < f2 * f4) {
            float f6 = f / f2;
    ...
    /* JADX INFO: renamed from: a */
    public final void m84657a(String str, String str2) {
        HashMap<String, Object> map = new HashMap<>();
