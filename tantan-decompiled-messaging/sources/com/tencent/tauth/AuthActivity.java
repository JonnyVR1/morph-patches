...
public class AuthActivity extends Activity {
    ...
    private static int f60455a;

    /* JADX INFO: renamed from: b */
    private Map<String, ActionHandler> f60456b = new HashMap();
    ...
    /* JADX INFO: renamed from: a */
    private void m84611a(Uri uri) {
        SLog.m84309i("openSDK_LOG.AuthActivity", "-->handleActionUri--start");
        if (uri != null && uri.toString() != null) {
            String string = "";
            if (!uri.toString().equals("")) {
                String string2 = uri.toString();
                Bundle bundleM84464a = C14396n.m84464a(string2.substring(string2.indexOf("#") + 1));
                if (bundleM84464a == null) {
                    SLog.m84315w("openSDK_LOG.AuthActivity", "-->handleActionUri, bundle is null");
                    finish();
                    return;
                }
                String string3 = bundleM84464a.getString("action");
                SLog.m84309i("openSDK_LOG.AuthActivity", "-->handleActionUri, action: " + string3);
                if (string3 == null) {
                    finish();
                    return;
                }
                if (string3.equals("shareToQQ") || string3.equals("shareToQzone") || string3.equals("sendToMyComputer") || string3.equals("shareToTroopBar")) {
                    if (string3.equals("shareToQzone") && C14394l.m84434a((Context) this, "com.tencent.mobileqq") != null && C14394l.m84445c(this, "5.2.0") < 0) {
                        int i = f60455a + 1;
                        f60455a = i;
                        if (i == 2) {
                            f60455a = 0;
                    ...
                    SLog.m84309i("openSDK_LOG.AuthActivity", "-->handleActionUri, most share action, start assistactivity");
                    Intent intent = new Intent(this, (Class<?>) AssistActivity.class);
                    intent.putExtras(bundleM84464a);
                ...
                if (string3.equals("addToQQFavorites")) {
                    ...
                    intent2.putExtras(bundleM84464a);
                ...
                if (string3.equals(ACTION_SHARE_PRIZE)) {
                    ...
                    try {
                        string = C14396n.m84495d(bundleM84464a.getString("response")).getString("activityid");
                    } catch (Exception e) {
                        SLog.m84308e("openSDK_LOG.AuthActivity", "sharePrize parseJson has exception.", e);
                    }
                ...
                if (string3.equals("sdkSetAvatar")) {
                    ...
                    intent3.putExtras(bundleM84464a);
                ...
                if ("sdkSetDynamicAvatar".equals(string3)) {
                    ...
                    intent4.putExtras(bundleM84464a);
                ...
                if (string3.equals("sdkSetEmotion")) {
                    ...
                    intent5.putExtras(bundleM84464a);
                ...
                if (string3.equals("bindGroup")) {
                    SLog.m84309i("openSDK_LOG.AuthActivity", "-->handleActionUri--bind group callback.");
                    ...
                    intent6.putExtras(bundleM84464a);
                ...
                if (string3.equals("joinGroup")) {
                    SLog.m84309i("openSDK_LOG.AuthActivity", "-->handleActionUri--join group callback. ");
                    ...
                    intent7.putExtras(bundleM84464a);
                ...
                if (!"guildOpen".equals(string3)) {
                    ActionHandler actionHandler = this.f60456b.get(string3);
                    if (actionHandler != null) {
                        actionHandler.handleAction(this, bundleM84464a);
                        return;
                    } else {
                        finish();
                        return;
                ...
                intent8.putExtras(bundleM84464a);
        ...
        SLog.m84315w("openSDK_LOG.AuthActivity", "-->handleActionUri, uri invalid");
        finish();
    }
    ...
    public void finish() {
        try {
            ...
            SLog.m84308e("openSDK_LOG.AuthActivity", "activity finish exception: ", e);
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getIntent() == null) {
            SLog.m84315w("openSDK_LOG.AuthActivity", "-->onCreate, getIntent() return null");
            finish();
            return;
        }
        try {
            ...
            SLog.m84308e("openSDK_LOG.AuthActivity", "onCreate exception: ", e);
            data = null;
        }
        SLog.m84313v("openSDK_LOG.AuthActivity", "-->onCreate, uri: " + data);
        m84610a();
        try {
            m84611a(data);
        } catch (Exception e2) {
            SLog.m84308e("openSDK_LOG.AuthActivity", "onCreate exception: ", e2);
            finish();
        }
    }

    /* JADX INFO: renamed from: a */
    private void m84610a() {
        this.f60456b.put("action_common_channel", new ActionHandler() { // from class: com.tencent.tauth.AuthActivity.1
            @Override // com.tencent.tauth.AuthActivity.ActionHandler
            public void handleAction(Activity activity, Bundle bundle) {
                SLog.m84309i("openSDK_LOG.AuthActivity", "-->handleActionUri--common channel. ");
