...
public class C14349a {
    /* JADX INFO: renamed from: a */
    public static void m84210a(Window window) {
        if (window == null) {
            return;
        }
    ...
    /* JADX INFO: renamed from: a */
    public static void m84209a(final Dialog dialog, Handler handler) {
        ...
        handler.postDelayed(new Runnable() { // from class: com.tencent.open.a.1
            ...
            public void run() {
                try {
                    ...
                    SLog.m84308e("openSDK_LOG.DialogUtils", "dismiss dialog exception", e);
                }
            }
        }, 100L);
    }
