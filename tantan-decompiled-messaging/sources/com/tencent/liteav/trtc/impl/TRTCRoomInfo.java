...
public class TRTCRoomInfo {
    ...
    public C14110g.a bigEncSize = new C14110g.a();
    public C14110g.a smallEncSize = new C14110g.a();
    ...
    public static class RenderInfo implements SurfaceHolder.Callback {
        ...
        public void stop() {
            try {
                ...
                TXCLog.m82967e(TRTCRoomInfo.TAG, "remove callback failed.", e);
            }
        }

        @Override // android.view.SurfaceHolder.Callback
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            TXCLog.m82969i("RenderInfo", "trtc_api startRemoteView surfaceChanged " + surfaceHolder.getSurface() + " width " + i2 + ", height " + i3 + ", " + this.tinyID + ", " + this.render);
            TXCRenderAndDec tXCRenderAndDec = this.render;
            TextureViewSurfaceTextureListenerC14185e videoRender = tXCRenderAndDec != null ? tXCRenderAndDec.getVideoRender() : null;
            if (videoRender != null) {
                videoRender.m83925c(i2, i3);
            }
        }

        @Override // android.view.SurfaceHolder.Callback
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            TXCLog.m82969i("RenderInfo", "trtc_api startRemoteView surfaceCreated " + surfaceHolder.getSurface() + ", " + this.tinyID + ", " + this.render);
            if (surfaceHolder.getSurface().isValid()) {
                TXCRenderAndDec tXCRenderAndDec = this.render;
                TextureViewSurfaceTextureListenerC14185e videoRender = tXCRenderAndDec != null ? tXCRenderAndDec.getVideoRender() : null;
                if (videoRender != null) {
                    videoRender.m83915a(surfaceHolder.getSurface());
                }
            }
        }
        ...
        public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
            TXCLog.m82969i("RenderInfo", "trtc_api startRemoteView surfaceDestroyed " + surfaceHolder.getSurface() + ", " + this.tinyID + ", " + this.render);
            TXCRenderAndDec tXCRenderAndDec = this.render;
            TextureViewSurfaceTextureListenerC14185e videoRender = tXCRenderAndDec != null ? tXCRenderAndDec.getVideoRender() : null;
            if (videoRender != null) {
                videoRender.m83915a((Surface) null);
            }
        }
    }
    ...
    public byte[] getToken(Context context) {
        try {
            ...
            TXCLog.m82967e(TAG, "get token failed.", e);
        }
        return this.token;
    }
    ...
    public void setToken(Context context, byte[] bArr) {
        ...
        try {
            ...
            TXCLog.m82967e(TAG, "set token failed.", e);
        }
    }
