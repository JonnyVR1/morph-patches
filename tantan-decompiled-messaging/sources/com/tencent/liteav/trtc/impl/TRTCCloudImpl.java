...
import com.tencent.liteav.audio.InterfaceC13982c;
...
import com.tencent.liteav.audio.InterfaceC13986g;
...
public class TRTCCloudImpl extends TRTCCloud implements SurfaceHolder.Callback, TXCRenderAndDec.InterfaceC13964b, InterfaceC13982c, InterfaceC13983d, InterfaceC13984e, InterfaceC13985f, InterfaceC13986g, InterfaceC14007b, C14107d.a, InterfaceC14155o, C14189a.a {
    ...
    private InterfaceC14006a mCallback;
    protected C14107d mCaptureAndEnc;
    private long mCaptureFrameCount;
    private int mCodecType;
    protected C14110g mConfig;
    ...
    private HandlerC14051e mMainHandler;
    ...
    protected HandlerC14051e mSDKHandler;
    ...
    public class RunnableC1422824 implements Runnable {
        final /* synthetic */ TRTCCloudListener.TRTCSnapshotListener val$listener;
        final /* synthetic */ int val$streamType;
        final /* synthetic */ String val$userId;

        public RunnableC1422824(String str, TRTCCloudListener.TRTCSnapshotListener tRTCSnapshotListener, int i) {
            this.val$userId = str;
        ...
        public void run() {
            ...
            if (str == null) {
                ...
                TRTCCloudImpl.this.mCaptureAndEnc.m83476a(new InterfaceC14022o() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.24.1
                    ...
                    public void onTakePhotoComplete(final Bitmap bitmap) {
                        TRTCCloudImpl.this.runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.24.1.1
                            @Override // java.lang.Runnable
                            public void run() {
                                TRTCCloudListener.TRTCSnapshotListener tRTCSnapshotListener = RunnableC1422824.this.val$listener;
            ...
            if (videoRender != null) {
                videoRender.m83918a(new InterfaceC14022o() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.24.2
                    @Override // com.tencent.liteav.basic.p088c.InterfaceC14022o
                    public void onTakePhotoComplete(final Bitmap bitmap) {
    ...
    public static class DisplayOrientationDetector extends OrientationEventListener {
        ...
        public void onOrientationChanged(int i) {
            if (i == -1) {
                TXCLog.m82969i("DisplayOrientationDetector", "rotation-change invalid " + i);
                return;
            }
            int i2 = 1;
            if (i > 45) {
            ...
            if (this.mCurOrientation != i2) {
                ...
                TXCLog.m82964d("DisplayOrientationDetector", sb.toString());
            }
        }
    }
    ...
    public static class StatusTask implements Runnable {
        ...
        public void run() {
            ...
            int iM83053e = C14052f.m83053e(tRTCCloudImpl.mContext);
            int[] iArrM83043a = C14052f.m83043a();
            int iM83044b = C14052f.m83044b() * 1024;
            TXCStatus.m82995a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomErrorUnsupportSamplerate, Integer.valueOf(iM83053e));
            TXCStatus.m82995a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomErrorUpVideoAuthFailed, Integer.valueOf(iArrM83043a[0] / 10));
            TXCStatus.m82995a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomErrorDisconnect, Integer.valueOf(iArrM83043a[1] / 10));
            TXCStatus.m82995a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomErrorOpenCameraFailed, Integer.valueOf(iM83044b));
            if (C14052f.m83039a(tRTCCloudImpl.mContext)) {
                TXCStatus.m82995a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomErrorOpenMicFailed, (Object) 1);
                i = 1;
            } else {
                TXCStatus.m82995a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomErrorOpenMicFailed, (Object) 0);
                i = 0;
            }
            if (tRTCCloudImpl.mNetType != iM83053e) {
                if (tRTCCloudImpl.mNetType >= 0 && iM83053e > 0) {
                    tRTCCloudImpl.nativeReenterRoom(tRTCCloudImpl.mNativeRtcContext, 100);
                }
                TXCEventRecorderProxy.m82980a("18446744073709551615", 1003, iM83053e == 0 ? 0L : iM83053e, -1L, "", 0);
                Monitor.m82978a(2, String.format("network switch from:%d to %d", Integer.valueOf(tRTCCloudImpl.mNetType), Integer.valueOf(iM83053e)) + " self:" + tRTCCloudImpl.hashCode(), "1:wifi/2:4G/3:3G/4:2G/5:Cable", 0);
                tRTCCloudImpl.mNetType = iM83053e;
                TXCKeyPointReportProxy.m82984a(40039, iM83053e, 0);
            }
            if (tRTCCloudImpl.mBackground != i) {
                TXCEventRecorderProxy.m82980a("18446744073709551615", 2001, i, -1L, "", 0);
                tRTCCloudImpl.mBackground = i;
                if (i == 0) {
                    Monitor.m82978a(1, "onAppDidBecomeActive self:" + tRTCCloudImpl.hashCode(), "", 0);
                } else {
                    Monitor.m82978a(1, "onAppEnterBackground self:" + tRTCCloudImpl.hashCode(), "", 0);
                }
                TXCKeyPointReportProxy.m82990c(50001, i);
            }
            TXCKeyPointReportProxy.m82983a(iArrM83043a[0] / 10, iArrM83043a[1] / 10);
            TXCKeyPointReportProxy.m82981a();
    ...
    public TRTCCloudImpl(Context context) {
        ...
        this.mFramework = 1;
        this.mCallback = new InterfaceC14006a() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.1
            @Override // com.tencent.liteav.basic.p087b.InterfaceC14006a
            public void onError(String str, int i, String str2, String str3) {
                TXCLog.m82966e(TRTCCloudImpl.TAG, "onError => id:" + str + " code:" + i + " msg:" + str2 + " params:" + str3);
                ...
                Monitor.m82977a(3, i, str2, str3, 0, 0);
            }

            @Override // com.tencent.liteav.basic.p087b.InterfaceC14006a
            public void onEvent(String str, int i, String str2, String str3) {
                TXCLog.m82969i(TRTCCloudImpl.TAG, "onEvent => id:" + str + " code:" + i + " msg:" + str2 + " params:" + str3);
                if (TRTCCloudImpl.this.mTRTCListener != null) {
                    Bundle bundle = new Bundle();
                    bundle.putString("EVT_USERID", str);
                    bundle.putInt("EVT_ID", i);
                ...
                Monitor.m82977a(2, i, str2, str3, 0, 0);
            }
        };
        ...
        TXCLog.m82970i(TAG, "audio config from shared preference: %s", tRTCAudioServerConfigLoadFromSharedPreferences);
        ...
        C14107d c14107d = new C14107d(context);
        this.mCaptureAndEnc = c14107d;
        c14107d.m83506i(2);
        this.mCaptureAndEnc.m83478a(this.mConfig);
        this.mCaptureAndEnc.m83503h(true);
        this.mCaptureAndEnc.m83499f(true);
        this.mCaptureAndEnc.m83475a((InterfaceC14007b) this);
        this.mCaptureAndEnc.m83477a((C14107d.a) this);
        this.mCaptureAndEnc.setID("18446744073709551615");
        this.mCaptureAndEnc.m83502g(true);
        TXCKeyPointReportProxy.m82985a(this.mContext);
    ...
    public void addRemoteStatistics(TXCRenderAndDec tXCRenderAndDec, TRTCRoomInfo.UserInfo userInfo, TRTCStatistics tRTCStatistics, ArrayList<TRTCCloudDef.TRTCQuality> arrayList) {
        ...
        tRTCStatistics.downLoss = TXCStatus.m82999c(String.valueOf(userInfo.tinyID), 16002);
    ...
    private void applyRenderConfig(TXCRenderAndDec tXCRenderAndDec) {
        C14111h c14111h = new C14111h();
        c14111h.f59341h = false;
        if (this.mAppScene == 1) {
            c14111h.f59341h = true;
        }
        int iM82999c = TXCStatus.m82999c("18446744073709551615", FirebaseError.ERROR_NETWORK_REQUEST_FAILED);
        if (iM82999c == 0) {
            iM82999c = 600;
        }
        c14111h.f59337d = iM82999c;
        c14111h.f59351r = this.mRoomInfo.decProperties;
        applyRenderPlayStrategy(tXCRenderAndDec, c14111h);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void applyRenderPlayStrategy(TXCRenderAndDec tXCRenderAndDec, C14111h c14111h) {
        c14111h.f59340g = true;
        int i = this.mCurrentRole;
        if (i == 20) {
            c14111h.f59334a = C14003a.f58042a;
            c14111h.f59336c = C14003a.f58043b;
            c14111h.f59335b = C14003a.f58044c;
        } else if (i == 21) {
            c14111h.f59334a = C14003a.f58045d;
            c14111h.f59336c = C14003a.f58046e;
            c14111h.f59335b = C14003a.f58047f;
        }
    ...
    public void checkRTCState() {
        ...
        tRTCStatistics.appCpu = iArrM83043a[0] / 10;
        tRTCStatistics.systemCpu = iArrM83043a[1] / 10;
        tRTCStatistics.rtt = TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningNetBusy);
        tRTCStatistics.sendBytes = TXCStatus.m82991a("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningVideoEncodeFailed);
        tRTCStatistics.receiveBytes = TXCStatus.m82991a("18446744073709551615", 16004);
        tRTCStatistics.upLoss = TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningHWAcceFailed);
        ...
        tRTCQuality.quality = TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningAudioEncodeFailed);
    ...
    public void checkRenderRotation(int i) {
        ...
        if (i6 != 1 ? !(i6 != 2 || !c14110g.f59317m || !z) : !(c14110g.f59317m || !z)) {
            i3 += 180;
        }
        TXCLog.m82964d(TAG, String.format("vrotation rotation-change %d-%d-%d ======= renderRotation %d-%d", Integer.valueOf(i), Integer.valueOf(this.mConfig.f59316l), Integer.valueOf(displayRotation), Integer.valueOf(i3), Integer.valueOf(this.mRoomInfo.localRenderRotation)) + " self:" + hashCode());
        this.mCaptureAndEnc.m83501g((this.mRoomInfo.localRenderRotation + i3) % 360);
    }
    ...
    public void checkVideoEncRotation(int i) {
        ...
        C14110g c14110g = this.mConfig;
        int i3 = 0;
        if (c14110g.f59316l != 1) {
            boolean z = c14110g.f59298S;
            i2 = (!(z && c14110g.f59317m) && (z || c14110g.f59317m)) ? 270 : 90;
        } else {
            i2 = 0;
        }
        if (i == 0) {
        ...
        TXCLog.m82964d(TAG, String.format("vrotation rotation-change %d-%d ======= encRotation %d", Integer.valueOf(i), Integer.valueOf(this.mConfig.f59316l), Integer.valueOf(i3)) + " self:" + hashCode());
        this.mCurrentOrientation = i;
        this.mCaptureAndEnc.m83469a(i3);
    }
    ...
    public void collectCustomCaptureFps() {
        if (this.mVideoSourceType == VideoSourceType.CUSTOM) {
            ...
            if (j >= 1000) {
                ...
                TXCStatus.m82994a("18446744073709551615", 1001, 2, Double.valueOf(d));
            }
        }
    }
    ...
    public TXCRenderAndDec createRender(long j, int i) {
        ...
        tXCRenderAndDec.setVideoRender(new C14181a());
    ...
    public static void destroySharedInstance() {
        synchronized (TRTCCloudImpl.class) {
            try {
                if (sInstance != null) {
                    TXCLog.m82969i(TAG, "trtc_api destroy instance self:" + sInstance.hashCode());
                    sInstance.destroy();
                    sInstance = null;
                }
            } catch (Throwable th) {
    ...
    private CharSequence getDownloadStreamInfo(TXCRenderAndDec tXCRenderAndDec, TRTCRoomInfo.UserInfo userInfo) {
        ...
        long jM82992a = TXCStatus.m82992a(strValueOf, FirebaseError.ERROR_REQUIRES_RECENT_LOGIN, streamType);
        int iM83000c = TXCStatus.m83000c(strValueOf, ErrorCode.EDIT_PREVIEW_FAILED, streamType);
        if (streamType == 3) {
            str = j6f.LATITUDE_SOUTH;
        ...
        sb.append(String.format("REMOTE: [%s]%s RTT:%dms\n", userInfo.userID, str, Integer.valueOf(TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningNetBusy))));
        Locale locale = Locale.CHINA;
        sb.append(String.format(locale, "RECV:%dkbps LOSS:%d-%d-%d%%|%d-%d-%d%%|%d%%\n", Integer.valueOf(TXCStatus.m83000c(strValueOf, 17001, streamType) + TXCStatus.m82999c(strValueOf, 18001)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_TOO_MANY_REQUESTS, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_USER_DISABLED, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_USER_NOT_FOUND, streamType)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18013)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18007)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18014)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 16002))));
        sb.append(String.format(locale, "BIT:%d|%dkbps RES:%dx%d FPS:%d-%d\n", Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_CUSTOM_TOKEN_MISMATCH, streamType)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18002)), Integer.valueOf(iM83000c >> 16), Integer.valueOf(iM83000c & j6f.COLOR_SPACE_UNCALIBRATED), Integer.valueOf((int) TXCStatus.m83002d(strValueOf, 6002, streamType)), Integer.valueOf((int) TXCStatus.m83002d(strValueOf, 17003, streamType))));
        sb.append(String.format(locale, "FEC:%d-%d-%d%%|%d-%d-%d%%    ARQ:%d-%d|%d-%d\n", Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_EMAIL_ALREADY_IN_USE, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_USER_DISABLED, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_OPERATION_NOT_ALLOWED, streamType)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18009)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18007)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18008)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_WRONG_PASSWORD, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_INVALID_EMAIL, streamType)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18012)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18010))));
        sb.append(String.format(locale, "CPU:%d%%|%d%%  RPS:%d  LFR:%d  DERR:%d\n", Integer.valueOf(iArrM83043a[0] / 10), Integer.valueOf(iArrM83043a[1] / 10), Integer.valueOf(TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_ACCOUNT_EXISTS_WITH_DIFFERENT_CREDENTIAL, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, 17013, streamType)), Long.valueOf(jM82992a)));
        sb.append(String.format(locale, "Jitter: %d,%d|%d,%d|%d  p2pDelay: %d  ADROP: %d\n", Integer.valueOf(TXCStatus.m82999c(strValueOf, 2007)), Integer.valueOf(TXCStatus.m83000c(strValueOf, 6010, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, 6011, streamType)), Integer.valueOf(TXCStatus.m83000c(strValueOf, 6012, streamType)), Integer.valueOf(TXCStatus.m82999c(strValueOf, TXLiteAVCode.EVT_HW_DECODER_START_SUCC)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18042)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18015))));
        sb.append(String.format(locale, "QUALITY: %d   LEN: %d\n", Integer.valueOf(TXCStatus.m82999c(strValueOf, 18023)), Integer.valueOf(TXCStatus.m82999c(strValueOf, 18016))));
        String string = sb.toString();
        SpannableString spannableString = new SpannableString(string);
        int iLastIndexOf = string.lastIndexOf("DECERR:");
        if (-1 != iLastIndexOf && jM82992a > 0) {
    ...
    private TRTCStatistics.TRTCLocalStatistics getLocalStatistics(int i) {
        int iM83000c = TXCStatus.m83000c("18446744073709551615", 4003, i);
        TRTCStatistics.TRTCLocalStatistics tRTCLocalStatistics = new TRTCStatistics.TRTCLocalStatistics();
        tRTCLocalStatistics.width = iM83000c >> 16;
        tRTCLocalStatistics.height = iM83000c & j6f.COLOR_SPACE_UNCALIBRATED;
        tRTCLocalStatistics.frameRate = (int) (TXCStatus.m83002d("18446744073709551615", 4001, i) + 0.5d);
        tRTCLocalStatistics.videoBitrate = TXCStatus.m83000c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomEventOpenCameraSucc, i);
        tRTCLocalStatistics.audioSampleRate = TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_LOCAL_VIDEO_STAT);
        tRTCLocalStatistics.audioBitrate = TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_FIRST_REMOTE_VIDEO_FRAME);
        tRTCLocalStatistics.streamType = translateStreamType(i);
        return tRTCLocalStatistics;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public EnumC14004b getPixelFormat(int i) {
        if (i == 1) {
            return EnumC14004b.I420;
        }
        if (i == 2) {
            return EnumC14004b.TEXTURE_2D;
        }
        if (i != 3) {
            return i != 4 ? EnumC14004b.UNKNOWN : EnumC14004b.NV21;
        }
        return EnumC14004b.TEXTURE_EXTERNAL_OES;
    }
    ...
    private TRTCStatistics.TRTCRemoteStatistics getRemoteStatistics(TXCRenderAndDec tXCRenderAndDec, TRTCRoomInfo.UserInfo userInfo) {
        ...
        int streamType = tXCRenderAndDec.getStreamType();
        int iM83000c = TXCStatus.m83000c(strValueOf, ErrorCode.EDIT_PREVIEW_FAILED, streamType);
        int iM83000c2 = TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_USER_NOT_FOUND, streamType);
        int iM82999c = TXCStatus.m82999c(strValueOf, 18047);
        ...
        tRTCRemoteStatistics.videoPacketLoss = iM83000c2;
        tRTCRemoteStatistics.audioPacketLoss = iM82999c;
        if (iM82999c > iM83000c2) {
            iM83000c2 = iM82999c;
        }
        tRTCRemoteStatistics.finalLoss = iM83000c2;
        tRTCRemoteStatistics.width = iM83000c >> 16;
        tRTCRemoteStatistics.height = 65535 & iM83000c;
        tRTCRemoteStatistics.frameRate = (int) (TXCStatus.m83002d(strValueOf, 6002, streamType) + 0.5d);
        tRTCRemoteStatistics.videoBitrate = TXCStatus.m83000c(strValueOf, FirebaseError.ERROR_CUSTOM_TOKEN_MISMATCH, streamType);
        tRTCRemoteStatistics.audioSampleRate = TXCStatus.m82999c(strValueOf, 18003);
        tRTCRemoteStatistics.audioBitrate = TXCStatus.m82999c(strValueOf, 18002);
        tRTCRemoteStatistics.jitterBufferDelay = TXCStatus.m82999c(strValueOf, 2007);
        tRTCRemoteStatistics.point2PointDelay = TXCStatus.m82999c(strValueOf, 18042);
        tRTCRemoteStatistics.streamType = translateStreamType(streamType);
        tRTCRemoteStatistics.audioTotalBlockTime = TXCStatus.m82999c(strValueOf, 18031);
        int iM82999c2 = TXCStatus.m82999c(strValueOf, 18030);
        tRTCRemoteStatistics.audioBlockRate = iM82999c2 > 0 ? (int) (((((double) tRTCRemoteStatistics.audioTotalBlockTime) * 100.0d) / ((double) iM82999c2)) + 0.9d) : 0;
        tRTCRemoteStatistics.videoTotalBlockTime = TXCStatus.m83000c(strValueOf, PlaybackException.ERROR_CODE_DRM_SYSTEM_ERROR, streamType);
        int iM83000c3 = TXCStatus.m83000c(strValueOf, 6020, streamType);
        tRTCRemoteStatistics.videoBlockRate = iM83000c3 > 0 ? (int) (((((double) tRTCRemoteStatistics.videoTotalBlockTime) * 100.0d) / ((double) iM83000c3)) + 0.9d) : 0;
        return tRTCRemoteStatistics;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public C14110g.a getSizeByResolution(int i, int i2) {
        int i3 = 176;
        int i4 = 192;
        switch (i) {
            case 1:
        ...
        try {
            for (StackTraceElement stackTraceElement : Thread.currentThread().getStackTrace()) {
                ...
                if (className.contains("TUIKitImpl")) {
                    TXCLog.m82969i(TAG, "identifyTRTCFrameworkType callName:" + className);
                    this.mFramework = 6;
                    return;
                }
            ...
            TXCLog.m82966e(TAG, "identifyTRTCFrameworkType catch exception:" + e.getCause());
        }
    }

    private void init(Context context, HandlerC14051e handlerC14051e) {
        ...
        C14110g c14110g = new C14110g();
        this.mConfig = c14110g;
        c14110g.f59315k = EnumC14005c.RESOLUTION_TYPE_640_360;
        c14110g.f59303X = 90;
        c14110g.f59314j = 0;
        c14110g.f59295P = true;
        c14110g.f59312h = 15;
        c14110g.f59290K = false;
        c14110g.f59299T = false;
        c14110g.f59300U = false;
        c14110g.f59305a = 368;
        c14110g.f59306b = 640;
        c14110g.f59307c = DetectDelayStopHelper.TYPE_DETECT_PICKNOISE;
        c14110g.f59309e = 0;
        c14110g.f59302W = false;
        TRTCRoomInfo tRTCRoomInfo = new TRTCRoomInfo();
        this.mRoomInfo = tRTCRoomInfo;
        C14110g.a aVar = tRTCRoomInfo.bigEncSize;
        aVar.f59332a = 368;
        aVar.f59333b = 640;
        this.mMainHandler = new HandlerC14051e(context.getMainLooper());
        this.mListenerHandler = new Handler(context.getMainLooper());
        if (handlerC14051e != null) {
            this.mSDKHandler = handlerC14051e;
        } else {
            HandlerThread handlerThread = new HandlerThread("TRTCCloudApi");
            handlerThread.start();
            this.mSDKHandler = new HandlerC14051e(handlerThread.getLooper());
        }
        ...
        this.mTargetRole = 20;
        this.mRecvMode = 1;
        this.mLatestParamsOfBigEncoder.putInt(KEY_CONFIG_GOP, this.mConfig.f59313i);
        this.mLatestParamsOfSmallEncoder.putInt(KEY_CONFIG_GOP, this.mConfig.f59313i);
        identifyTRTCFrameworkType();
        this.mVideoServerConfig = TRTCVideoServerConfig.loadFromSharedPreferences(context);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public TextureViewSurfaceTextureListenerC14185e internalGetRemoteUserRender(String str, int i) {
        TRTCRoomInfo.UserInfo user = this.mRoomInfo.getUser(str);
        if (user == null) {
            TXCLog.m82966e(TAG, "user no exist");
            return null;
        }
        TXCRenderAndDec tXCRenderAndDec = (i == 2 ? user.subRender : user.mainRender).render;
        if (tXCRenderAndDec == null) {
            TXCLog.m82966e(TAG, "render no exist");
            return null;
        }
        TextureViewSurfaceTextureListenerC14185e videoRender = tXCRenderAndDec.getVideoRender();
        if (videoRender != null) {
            return videoRender;
        }
    ...
    private void onChangeRole(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.162
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("onChangeRole err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
            }
        });
    }
    ...
    private void onConnectionLost() {
        ...
        Monitor.m82978a(1, "onConnectionLost self:" + hashCode(), "", 0);
    ...
    private void onConnectionRecovery() {
        ...
        Monitor.m82978a(1, "onConnectionRecovery self:" + hashCode(), "", 0);
    ...
    private void onDisConnectOtherRoom(final int i, final String str) {
        ...
        Monitor.m82978a(1, String.format("onDisConnectOtherRoom err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + hashCode(), "", 0);
    ...
    public void onExitRoom(int i, String str) {
        ...
        Monitor.m82978a(1, String.format("onExitRoom err:%d msg:%s", Integer.valueOf(i), str) + " self:" + hashCode(), "", 0);
    ...
    private void onRecvAudioServerConfig(TRTCAudioServerConfig tRTCAudioServerConfig) {
        TXCLog.m82970i(TAG, "on receive audio config: [%s]", tRTCAudioServerConfig);
    ...
    private void onRecvCustomCmdMsg(final String str, long j, final int i, final int i2, final String str2, final boolean z, final int i3, long j2) {
        ...
        if (jCurrentTimeMillis - this.mLastLogCustomCmdMsgTs > 10000) {
            TXCLog.m82969i(TAG, "onRecvMsg. tinyId=" + j + ", streamId = " + i + ", msg = " + str2 + ", recvTime = " + j2 + ", recvCustomMsgCountInPeriod = " + this.mRecvCustomCmdMsgCountInPeriod + " self:" + hashCode());
            ...
            public void run() {
                ...
                if (tRTCCloudListener != null) {
                    try {
                        ...
                        TXCLog.m82967e(TRTCCloudImpl.TAG, "onRecvCustomCmdMsg failed.", e);
                    }
                    if (!z || (i4 = i3) <= 0) {
                        return;
                    }
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.155
            ...
            public void run() {
                ...
                try {
                    ...
                    TXCLog.m82967e(TRTCCloudImpl.TAG, "get user info failed.", e);
                }
                ...
                if ((TRTCRoomInfo.hasMainVideo(user.streamState) || TRTCRoomInfo.hasSmallVideo(user.streamState)) && !TRTCRoomInfo.isMuteMainVideo(user.streamState)) {
                    TRTCCloudImpl.this.runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.155.1
                        ...
                        public void run() {
                            TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                            TXCLog.m82969i(TRTCCloudImpl.TAG, "notify onUserVideoAvailable:" + j + " [true] by IDR. self:" + TRTCCloudImpl.this.hashCode());
                            if (tRTCCloudListener != null) {
            ...
            public void run() {
                ...
                if (tRTCCloudListener != null) {
                    try {
                        ...
                        if (userIdByTinyId == null) {
                            TXCLog.m82969i(TRTCCloudImpl.TAG, "onRecvSEIMsg Error, user id is null for tinyId=" + j + " self:" + TRTCCloudImpl.this.hashCode());
                            return;
                        }
                        long jCurrentTimeMillis = System.currentTimeMillis();
                        TRTCCloudImpl.access$8108(TRTCCloudImpl.this);
                        if (jCurrentTimeMillis - TRTCCloudImpl.this.mLastLogSEIMsgTs > 10000) {
                            TXCLog.m82969i(TRTCCloudImpl.TAG, "onRecvSEIMsg. userId=" + userIdByTinyId + ", message = " + new String(bArr) + ", recvSEIMsgCountInPeriod = " + TRTCCloudImpl.this.mRecvSEIMsgCountInPeriod + " self:" + TRTCCloudImpl.this.hashCode());
                        ...
                        TXCLog.m82967e(TRTCCloudImpl.TAG, "onRecvSEIMsg failed.", e);
                    }
                }
            }
        });
                ...
                public void run() {
                    TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.137.1
                        ...
                        public void accept(String str2, TRTCRoomInfo.UserInfo userInfo) {
                            ...
                            TXCKeyPointReportProxy.m82987a(String.valueOf(userInfo.tinyID), 40038, 0L, i2);
                        }
                    });
                }
            });
        ...
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.152
            ...
            public void run() {
                ...
                if (tRTCCloudListener != null) {
                    ...
                    tRTCSpeedTestResult.f60465ip = str;
                    int i4 = i;
    ...
    private void onStartPublishing(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.156
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("onStartPublishing err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                if (tRTCCloudListener != null) {
    ...
    private void onStopPublishing(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.157
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("onStopPublishing err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                if (tRTCCloudListener != null) {
    ...
    private void onStreamPublished(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.158
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("onStreamPublished err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                if (tRTCCloudListener != null) {
    ...
    private void onStreamUnpublished(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.159
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("onStreamUnpublished err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                if (tRTCCloudListener != null) {
    ...
    private void onSwitchRoom(final int i, final String str) {
        ...
        Monitor.m82978a(1, String.format("onSwitchRoom err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + hashCode(), "", 0);
    ...
    private void onTranscodingUpdated(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.160
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("onTranscodingUpdated err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                if (tRTCCloudListener != null) {
    ...
    private void onTryToReconnect() {
        ...
        Monitor.m82978a(1, "onTryToReconnect self:" + hashCode(), "", 0);
    ...
    public void runOnMainThreadAndWaitDone(Runnable runnable) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            this.mMainHandler.m83029a(runnable);
        } else {
            runnable.run();
        }
    }
    ...
    public void setQoSParams() {
        ...
        TXCLog.m82969i("", "setQoSParams:" + audioEncoderConfig.sampleRate + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + audioEncoderConfig.channels + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + audioEncoderConfig.minBitrate + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + audioEncoderConfig.maxBitrate);
    ...
    public void setVideoEncoderParamEx(JSONObject jSONObject) throws JSONException {
        ...
        if (iOptInt != -1) {
            ...
            if (iOptInt == 0 && (jSONObjectOptJSONObject = jSONObject.optJSONObject("softwareCodecParams")) != null) {
                this.mConfig.f59295P = jSONObjectOptJSONObject.optInt("enableRealTime") != 0;
                this.mConfig.f59318n = jSONObjectOptJSONObject.optInt("profile");
            }
        }
        ...
        if (iOptInt8 == 0) {
            ...
            tRTCCloudImpl = this;
            tRTCCloudImpl.updateBigStreamEncoder(i3 <= i4, i3, i4, iOptInt4, iOptInt5, this.mConfig.f59320p, iOptInt6);
            iOptInt4 = iOptInt4;
            iOptInt5 = iOptInt5;
            tRTCCloudImpl.mCaptureAndEnc.m83512m(iOptInt7);
        } else {
            tRTCCloudImpl = this;
            if (iOptInt8 == 1) {
        ...
        tRTCCloudImpl.apiLog("vsize setVideoEncoderParamEx->width:" + tRTCCloudImpl.mRoomInfo.bigEncSize.f59332a + ", height:" + tRTCCloudImpl.mRoomInfo.bigEncSize.f59333b + ", fps:" + iOptInt4 + ", bitrate:" + iOptInt5 + ", stream:" + iOptInt8);
    ...
    public void setVideoEncoderParamInternal(TRTCCloudDef.TRTCVideoEncParam tRTCVideoEncParam) {
        ...
        C14110g.a sizeByResolution = getSizeByResolution(tRTCVideoEncParam.videoResolution, tRTCVideoEncParam.videoResolutionMode);
        updateBigStreamEncoder(tRTCVideoEncParam.videoResolutionMode == 1, sizeByResolution.f59332a, sizeByResolution.f59333b, tRTCVideoEncParam.videoFps, tRTCVideoEncParam.videoBitrate, tRTCVideoEncParam.enableAdjustRes, tRTCVideoEncParam.minVideoBitrate);
        apiLog("vsize setVideoEncoderParam->width:" + this.mRoomInfo.bigEncSize.f59332a + ", height:" + this.mRoomInfo.bigEncSize.f59333b + ", fps:" + tRTCVideoEncParam.videoFps + ", bitrate:" + tRTCVideoEncParam.videoBitrate + ", mode:" + tRTCVideoEncParam.videoResolutionMode + " minVideoBitrate:" + tRTCVideoEncParam.minVideoBitrate);
        StringBuilder sb = new StringBuilder();
        sb.append(String.format("setVideoEncoderParam width:%d, height:%d, fps:%d, bitrate:%d, mode:%d, minBitrate:%d", Integer.valueOf(this.mRoomInfo.bigEncSize.f59332a), Integer.valueOf(this.mRoomInfo.bigEncSize.f59333b), Integer.valueOf(tRTCVideoEncParam.videoFps), Integer.valueOf(tRTCVideoEncParam.videoBitrate), Integer.valueOf(tRTCVideoEncParam.videoResolutionMode), Integer.valueOf(tRTCVideoEncParam.minVideoBitrate)));
        sb.append(" self:");
        sb.append(hashCode());
        Monitor.m82978a(1, sb.toString(), "", 0);
        updateOrientation();
        C14110g.a aVar = this.mRoomInfo.bigEncSize;
        TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMEAR_GET_STATUS_FAILED, (long) aVar.f59332a, (long) aVar.f59333b, "", 2);
        TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMERA_SWITCH_FAILED, (long) tRTCVideoEncParam.videoFps, -1L, "", 2);
        TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMERA_TAKE_PHOTO_FAILED, (long) tRTCVideoEncParam.videoBitrate, -1L, "", 2);
    }
    ...
    public void showFloatingWindow(View view) {
        ...
        if (!Settings.canDrawOverlays(view.getContext())) {
            TXCLog.m82966e(TAG, "can't show floating window for no drawing overlay permission");
            return;
        }
    ...
    public void stopLocalAudioInternal() {
        ...
        Monitor.m82978a(1, "stopLocalAudio self:" + hashCode(), "", 0);
        TXCEventRecorderProxy.m82980a("18446744073709551615", 3001, 2L, -1L, "", 0);
        this.mIsAudioCapturing = false;
        TXCAudioEngine.getInstance().stopLocalAudio();
        if (!this.mEnableCustomAudioCapture) {
            enableAudioStream(false);
        }
        TXCKeyPointReportProxy.m82984a(40050, 0, 1);
        TXCLog.m82970i(TAG, "(%d)stopLocalAudioInternal end", Integer.valueOf(hashCode()));
    }
    ...
    public void updateBigStreamEncoder(boolean z, int i, int i2, int i3, int i4, boolean z2, int i5) {
        if (i > 0 && i2 > 0) {
            ...
            this.mConfig.f59315k = EnumC14005c.RESOLUTION_TYPE_INVALID;
        }
        if (i3 > 0) {
            if (i3 > 30) {
                apiLog("setVideoEncoderParam fps > 30, limit fps to 30");
                this.mConfig.f59312h = 30;
            } else {
                this.mConfig.f59312h = i3;
            }
        }
        if (i4 > 0) {
            this.mConfig.f59307c = i4;
        }
        if (i5 >= 0) {
            this.mConfig.f59309e = i5;
        }
        VideoSourceType videoSourceType = this.mVideoSourceType;
        VideoSourceType videoSourceType2 = VideoSourceType.SCREEN;
        C14110g c14110g3 = this.mConfig;
        if (videoSourceType == videoSourceType2) {
            c14110g3.f59313i = 3;
            c14110g3.f59320p = false;
        ...
        C14110g.a aVar2 = this.mRoomInfo.bigEncSize;
        int i6 = aVar2.f59332a;
        int i7 = aVar2.f59333b;
        C14110g c14110g4 = this.mConfig;
        setVideoEncConfig(2, i6, i7, c14110g4.f59312h, c14110g4.f59307c, c14110g4.f59320p, c14110g4.f59309e);
        if (this.mCodecType == 2) {
            C14110g c14110g5 = this.mConfig;
            if (c14110g5.f59305a * c14110g5.f59306b >= 518400) {
                c14110g5.f59314j = 1;
            }
        }
        this.mCaptureAndEnc.m83495e(this.mConfig.f59312h);
        this.mCaptureAndEnc.m83478a(this.mConfig);
    }
    ...
    private void updateEncType() {
        ...
        if (i == 0 || i == 1) {
            this.mConfig.f59314j = i;
        } else if (this.mAppScene == 1) {
            this.mConfig.f59314j = 1;
        }
    }
    ...
    public void updateSmallStreamEncoder(int i, int i2, int i3, int i4, int i5) {
        if (i > 0 && i2 > 0) {
            C14110g.a aVar = this.mRoomInfo.smallEncSize;
            aVar.f59332a = i;
            aVar.f59333b = i2;
        }
        if (i3 > 0) {
        ...
        int i7 = i6;
        C14107d c14107d = this.mCaptureAndEnc;
        boolean z = this.mEnableSmallStream;
        C14110g.a aVar2 = this.mRoomInfo.smallEncSize;
        int i8 = aVar2.f59332a;
        int i9 = aVar2.f59333b;
        TRTCCloudDef.TRTCVideoEncParam tRTCVideoEncParam2 = this.mSmallEncParam;
        c14107d.m83467a(z, i8, i9, tRTCVideoEncParam2.videoFps, tRTCVideoEncParam2.videoBitrate, i7);
        C14110g.a aVar3 = this.mRoomInfo.smallEncSize;
        int i10 = aVar3.f59332a;
        int i11 = aVar3.f59333b;
        TRTCCloudDef.TRTCVideoEncParam tRTCVideoEncParam3 = this.mSmallEncParam;
        setVideoEncConfig(3, i10, i11, tRTCVideoEncParam3.videoFps, tRTCVideoEncParam3.videoBitrate, this.mConfig.f59320p, tRTCVideoEncParam3.minVideoBitrate);
    }
    ...
    public void ConnectOtherRoom(final String str) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.8
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("ConnectOtherRoom param:%s", str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
    ...
    public void DisconnectOtherRoom() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.9
            ...
            public void run() {
                ...
                Monitor.m82978a(1, "DisconnectOtherRoom self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
    ...
    public void apiLog(String str) {
        TXCLog.m82969i(TAG, "(" + hashCode() + ")trtc_api " + str);
    }
    ...
    public void checkDashBoard() {
        ...
        if (this.mDebugType != 0 && (tXCloudVideoView = this.mRoomInfo.localView) != null) {
            ...
            TXCLog.m82969i(TAG, "[STATUS]" + uploadStreamInfo.toString().replace(SignParameters.NEW_LINE, "") + " self:" + hashCode());
    ...
    public void checkRemoteDashBoard(final TXCloudVideoView tXCloudVideoView, TXCRenderAndDec tXCRenderAndDec, TRTCRoomInfo.UserInfo userInfo) {
        ...
        TXCLog.m82969i(TAG, "[STATUS]" + downloadStreamInfo.toString().replace(SignParameters.NEW_LINE, "") + " self:" + hashCode());
    ...
    public void checkUserState(final String str, long j, int i, int i2) {
        ...
        if ((TRTCRoomInfo.hasAudio(i2) && !TRTCRoomInfo.isMuteAudio(i2)) != z) {
            ...
            Monitor.m82978a(2, String.format("onUserAudioAvailable userID:%s, bAvailable:%b", str, Boolean.valueOf(z)) + " self:" + hashCode(), "", 0);
        }
        ...
        if (z3 && (this.mRoomInfo.hasRecvFirstIFrame(j) || z4)) {
            ...
            Monitor.m82978a(2, String.format("onUserVideoAvailable userID:%s, bAvailable:%b", str, Boolean.valueOf(z2)) + " self:" + hashCode(), "", 0);
        }
        ...
        if ((TRTCRoomInfo.hasSubVideo(i2) && !TRTCRoomInfo.isMuteSubVideo(i2)) != z5) {
            ...
            Monitor.m82978a(2, String.format("onUserSubStreamAvailable userID:%s, bAvailable:%b", str, Boolean.valueOf(z5)) + " self:" + hashCode(), "", 0);
        }
    }
    ...
    public void destroy() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.2
            ...
            public void run() {
                ...
                C13980a.m82665a().m82666a(TRTCCloudImpl.this.hashCode());
            }
        });
    }
    ...
    public void enableAudioEarMonitoring(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.59
            @Override // java.lang.Runnable
            public void run() {
                Monitor.m82978a(1, String.format("enableAudioEarMonitoring enable:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
    ...
    public void enableCustomAudioCapture(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.86
            ...
            public void run() {
                ...
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
                if (z4) {
                    tRTCCloudImpl.mConfig.f59297R |= 1;
                    ...
                    tRTCCloudImpl.mConfig.f59297R &= -2;
                }
                TRTCCloudImpl tRTCCloudImpl2 = TRTCCloudImpl.this;
                tRTCCloudImpl2.mCaptureAndEnc.m83478a(tRTCCloudImpl2.mConfig);
                TRTCCloudImpl.this.apiLog("enableCustomAudioCapture " + z);
                Monitor.m82978a(1, String.format("enableCustomAudioCapture:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                ...
                if (z) {
                    ...
                    TXCEventRecorderProxy.m82980a("18446744073709551615", 3003, 11L, -1L, "", 0);
                } else {
                    TXCAudioEngine.getInstance().stopLocalAudio();
                }
                TXCKeyPointReportProxy.m82984a(40050, z ? 1 : 0, 1);
            }
        });
    }
            ...
            public void run() {
                ...
                if (z || TRTCCloudImpl.this.mVideoSourceType == VideoSourceType.CUSTOM) {
                    ...
                    if (z2) {
                        ...
                        tRTCCloudImpl.mConfig.f59297R &= -3;
                        synchronized (this) {
                            try {
                    ...
                    TRTCCloudImpl tRTCCloudImpl3 = TRTCCloudImpl.this;
                    tRTCCloudImpl3.mCaptureAndEnc.m83478a(tRTCCloudImpl3.mConfig);
                    TRTCCloudImpl.this.mEnableCustomVideoCapture = z;
                    TRTCCloudImpl.this.apiLog("enableCustomVideoCapture " + z);
                    Monitor.m82978a(1, String.format("enableCustomVideoCapture:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                    boolean z3 = z;
                    ...
                    TXCKeyPointReportProxy.m82984a(40046, z ? 1 : 0, 2);
                }
            }
        });
    }
    ...
    public int enableEncSmallVideoStream(final boolean z, final TRTCCloudDef.TRTCVideoEncParam tRTCVideoEncParam) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.42
            ...
            public void run() {
                ...
                TRTCCloudImpl tRTCCloudImpl2 = TRTCCloudImpl.this;
                C14110g c14110g = tRTCCloudImpl2.mConfig;
                boolean z2 = c14110g.f59320p;
                int i2 = c14110g.f59313i;
                ...
                TRTCCloudImpl tRTCCloudImpl4 = TRTCCloudImpl.this;
                C14107d c14107d = tRTCCloudImpl4.mCaptureAndEnc;
                boolean z4 = tRTCCloudImpl4.mEnableSmallStream;
                TRTCCloudImpl tRTCCloudImpl5 = TRTCCloudImpl.this;
                C14110g.a aVar = tRTCCloudImpl5.mRoomInfo.smallEncSize;
                c14107d.m83467a(z4, aVar.f59332a, aVar.f59333b, tRTCCloudImpl5.mSmallEncParam.videoFps, TRTCCloudImpl.this.mSmallEncParam.videoBitrate, i);
                boolean z5 = TRTCCloudImpl.this.mEnableSmallStream;
                TRTCCloudImpl tRTCCloudImpl6 = TRTCCloudImpl.this;
                if (!z5) {
                    tRTCCloudImpl6.setVideoEncoderConfiguration(3, 0, 0, 0, 0, 0, tRTCCloudImpl6.mConfig.f59320p, 0);
                    TRTCCloudImpl.this.removeUpStreamType(3);
                } else {
                    C14110g.a aVar2 = tRTCCloudImpl6.mRoomInfo.smallEncSize;
                    tRTCCloudImpl6.setVideoEncConfig(3, aVar2.f59332a, aVar2.f59333b, tRTCCloudImpl6.mSmallEncParam.videoFps, TRTCCloudImpl.this.mSmallEncParam.videoBitrate, z3, TRTCCloudImpl.this.mSmallEncParam.minVideoBitrate);
    ...
    public boolean enableTorch(boolean z) {
        ...
        return this.mCaptureAndEnc.m83493d(z);
    }

    public void enableVideoStream(boolean z) {
        if (!z) {
            if (!this.mCaptureAndEnc.m83504h()) {
    ...
    public void enterRoom(TRTCCloudDef.TRTCParams tRTCParams, final int i) {
        ...
        TXCKeyPointReportProxy.m82982a(30001);
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.5
            ...
            public void run() {
                ...
                TRTCCloudImpl.this.apiLog("========================================================================================================");
                TRTCCloudImpl.this.apiLog(String.format("============= SDK Version:%s Device Name:%s System Version:%s =============", TXCCommonUtil.getSDKVersionStr(), C14052f.m83049c(), C14052f.m83051d()));
                TRTCCloudImpl.this.apiLog("========================================================================================================");
                TRTCCloudImpl.this.apiLog("========================================================================================================");
                TRTCCloudImpl tRTCCloudImpl4 = TRTCCloudImpl.this;
                ...
                if (i6 == 0) {
                    ...
                    if (i6 == 1) {
                        ...
                        TXCLog.m82973w(TRTCCloudImpl.TAG, "enter room scene:%u error! default to VideoCall! " + i + " self:" + TRTCCloudImpl.this.hashCode());
                        i6 = 0;
                    } else {
                        str8 = "VoiceChatRoom";
                        i6 = 1;
                ...
                Monitor.m82978a(1, str7, String.format("bussInfo:%s, appScene:%s, role:%s, streamid:%s", str2, str8, i3 == 20 ? "Anchor" : "Audience", tRTCParams2.streamId), 0);
                ...
                TXCStatus.m82995a("18446744073709551615", 10003, C14052f.m83049c());
                TRTCCloudImpl tRTCCloudImpl5 = TRTCCloudImpl.this;
                ...
                tRTCCloudImpl7.mCaptureAndEnc.m83478a(tRTCCloudImpl7.mConfig);
                if (i == 0 && TRTCCloudImpl.this.mCodecType == 2) {
                    z = true;
                }
                boolean z2 = z;
                TRTCCloudImpl.this.mCaptureAndEnc.m83499f(z);
                ...
                C14110g.a aVar = tRTCCloudImpl9.mRoomInfo.bigEncSize;
                int i10 = aVar.f59332a;
                int i11 = aVar.f59333b;
                C14110g c14110g = tRTCCloudImpl9.mConfig;
                tRTCCloudImpl9.setVideoEncConfig(2, i10, i11, c14110g.f59312h, c14110g.f59307c, c14110g.f59320p, c14110g.f59309e);
                boolean z3 = TRTCCloudImpl.this.mEnableSmallStream;
                TRTCCloudImpl tRTCCloudImpl10 = TRTCCloudImpl.this;
                if (z3) {
                    C14110g.a aVar2 = tRTCCloudImpl10.mRoomInfo.smallEncSize;
                    int i12 = aVar2.f59332a;
                    int i13 = aVar2.f59333b;
                    ...
                    tRTCCloudImpl10.setVideoEncConfig(3, i12, i13, i14, i15, tRTCCloudImpl11.mConfig.f59320p, tRTCCloudImpl11.mSmallEncParam.minVideoBitrate);
                } else {
                    tRTCCloudImpl10.setVideoEncoderConfiguration(3, 0, 0, 0, 0, 0, tRTCCloudImpl10.mConfig.f59320p, 0);
                }
                TRTCCloudImpl tRTCCloudImpl12 = TRTCCloudImpl.this;
                C14107d c14107d = tRTCCloudImpl12.mCaptureAndEnc;
                boolean z4 = tRTCCloudImpl12.mEnableSmallStream;
                TRTCCloudImpl tRTCCloudImpl13 = TRTCCloudImpl.this;
                C14110g.a aVar3 = tRTCCloudImpl13.mRoomInfo.smallEncSize;
                c14107d.m83467a(z4, aVar3.f59332a, aVar3.f59333b, tRTCCloudImpl13.mSmallEncParam.videoFps, TRTCCloudImpl.this.mSmallEncParam.videoBitrate, TRTCCloudImpl.this.mConfig.f59313i);
                String strM83051d = C14052f.m83051d();
                String strM83049c = C14052f.m83049c();
                TRTCCloudImpl.this.nativeSetDataReportDeviceInfo(strM83049c, strM83051d, tRTCParams2.sdkAppId);
                TXCKeyPointReportProxy.C14039a c14039a = new TXCKeyPointReportProxy.C14039a();
                c14039a.f58449d = i;
                c14039a.f58450e = strM83049c;
                c14039a.f58451f = strM83051d;
                Context context = TRTCCloudImpl.this.mContext;
                c14039a.f58453h = context != null ? context.getPackageName() : "";
                c14039a.f58447b = tRTCParams2.sdkAppId;
                c14039a.f58452g = TXCCommonUtil.getSDKVersionStr();
                c14039a.f58448c = TRTCCloudImpl.this.mFramework;
                TXCKeyPointReportProxy.m82986a(c14039a);
                ...
                tRTCCloudImpl18.enableNetworkBlackStream(tRTCCloudImpl18.mCaptureAndEnc.m83504h());
                ...
                tRTCCloudImpl19.nativeEnterRoom(tRTCCloudImpl19.mNativeRtcContext, j, str14, str10, str12, i3, 255, z2 ? 1 : 0, i, tRTCCloudImpl19.mPerformanceMode, C14052f.m83049c(), C14052f.m83051d(), TRTCCloudImpl.this.mRecvMode, str16, str18);
                ...
                TRTCCloudImpl.this.mCaptureAndEnc.m83491d();
                ...
                C14110g c14110g2 = tRTCCloudImpl22.mConfig;
                TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMEAR_GET_STATUS_FAILED, c14110g2.f59305a, c14110g2.f59306b, "", 2);
                TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMERA_SWITCH_FAILED, TRTCCloudImpl.this.mConfig.f59312h, -1L, "", 2);
                TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMERA_TAKE_PHOTO_FAILED, TRTCCloudImpl.this.mConfig.f59307c, -1L, "", 2);
            }
        });
    }
    ...
    public void exitRoomInternal(boolean z, String str) {
        ...
        this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.7
            ...
            public void accept(String str3, TRTCRoomInfo.UserInfo userInfo) {
                ...
                C13980a.m82665a().m82667a(String.valueOf(userInfo.tinyID), TRTCCloudImpl.this.hashCode());
                TXCRenderAndDec tXCRenderAndDec = userInfo.mainRender.render;
                if (tXCRenderAndDec != null) {
        ...
        stopBGM();
        TXCKeyPointReportProxy.m82982a(31004);
        stopLocalPreview();
        stopScreenCapture();
        TXCKeyPointReportProxy.m82989b(31004, 0);
        C14110g c14110g = this.mConfig;
        c14110g.f59280A = null;
        c14110g.f59282C = 10;
        ...
        this.mEnableSoftANS = false;
        this.mEnableSoftAGC = false;
        this.mCaptureAndEnc.m83482a(false);
        ...
        this.mCaptureAndEnc.m83479a((InterfaceC14155o) null, 0);
        stopAudioRecording();
        TXCSoundEffectPlayer.getInstance().clearCache();
        Monitor.m82976a();
        TXCLog.m82970i(TAG, "(%d) exitRoomInternal end", Integer.valueOf(hashCode()));
    }
    ...
    public void finalize() throws Throwable {
        ...
        try {
            destroy();
            HandlerC14051e handlerC14051e = this.mSDKHandler;
            if (handlerC14051e != null) {
                handlerC14051e.getLooper().quit();
            }
    ...
    public TXBeautyManager getBeautyManager() {
        if (this.mCaptureAndEnc == null) {
            this.mCaptureAndEnc = new C14107d(this.mContext);
        }
        return this.mCaptureAndEnc.m83483b();
    }
    ...
    public int getNetworkQuality(int i, int i2) {
        if (!C14052f.m83052d(this.mContext)) {
            return 6;
        }
        if (i2 > 50 || i > 500) {
            return 5;
    ...
    public CharSequence getUploadStreamInfo() {
        int[] iArrM83043a = C14052f.m83043a();
        int iM83000c = TXCStatus.m83000c("18446744073709551615", 4003, 2);
        String strM82996b = TXCStatus.m82996b("18446744073709551615", 10001);
        StringBuilder sb = new StringBuilder();
        sb.append(String.format("LOCAL: [%s] RTT:%dms\n", this.mRoomInfo.getUserId(), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningNetBusy))));
        Locale locale = Locale.CHINA;
        sb.append(String.format(locale, "SEND:% 5dkbps LOSS:%d-%d-%d-%d|%d-%d-%d-%d|%d%%\n", Integer.valueOf(TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningReconnect)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomEventStartPlayAudioFrame, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomEventVideoPlayLag, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 13013, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 13010, 2)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_QUERY_RECORDING_SERVICE_STATUS)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_STREAM_MESSAGE_ERROR)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_VIDEO_SIZE_CHANGED)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_CONNECTION_INTERRUPTED)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomWarningHWAcceFailed))));
        sb.append(String.format(locale, "BIT:%d|%d|%dkbps RES:%dx%d FPS:%d-%d\n", Integer.valueOf(TXCStatus.m83000c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomEventOpenCameraSucc, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", TXILiveRoomDefine.TXILiveRoomEventOpenCameraSucc, 3)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_FIRST_REMOTE_VIDEO_FRAME)), Integer.valueOf(iM83000c >> 16), Integer.valueOf(iM83000c & j6f.COLOR_SPACE_UNCALIBRATED), Integer.valueOf((int) TXCStatus.m83002d("18446744073709551615", 4001, 2)), Integer.valueOf((int) TXCStatus.m83002d("18446744073709551615", 13014, 2))));
        sb.append(String.format(locale, "FEC:%d%%|%d%%  ARQ:%d|%dkbps  RPS:%d\n", Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 13004, 2)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", 14006)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 13008, 2)), Integer.valueOf(TXCStatus.m82999c("18446744073709551615", RtcEngineEvent.EvtType.EVT_CONNECTION_LOST)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 13007, 2))));
        sb.append(String.format(locale, "CPU:%d%%|%d%%    QOS:%s|%dkbps|%d-%d\n", Integer.valueOf(iArrM83043a[0] / 10), Integer.valueOf(iArrM83043a[1] / 10), getQosValue(TXCStatus.m83000c("18446744073709551615", 15009, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 15002, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 15010, 2)), Integer.valueOf(TXCStatus.m83000c("18446744073709551615", 15005, 2))));
        sb.append(String.format(locale, "SVR:%s", strM82996b));
        return sb.toString();
    }

    @Override // com.tencent.trtc.TRTCCloud
    public boolean isCameraAutoFocusFaceModeSupported() {
        return this.mCaptureAndEnc.m83515o();
    }

    @Override // com.tencent.trtc.TRTCCloud
    public boolean isCameraFocusPositionInPreviewSupported() {
        return this.mCaptureAndEnc.m83514n();
    }

    @Override // com.tencent.trtc.TRTCCloud
    public boolean isCameraTorchSupported() {
        return this.mCaptureAndEnc.m83513m();
    }

    @Override // com.tencent.trtc.TRTCCloud
    public boolean isCameraZoomSupported() {
        return this.mCaptureAndEnc.m83511l();
    }
    ...
    public void muteAllRemoteAudio(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.56
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("muteAllRemoteAudio mute:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                ...
                tRTCRoomInfo.forEachUser(new TRTCRoomInfo.UserAction() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.56.1
                    ...
                    public void accept(String str, TRTCRoomInfo.UserInfo userInfo) {
                        ...
                        RunnableC1426356 runnableC1426356 = RunnableC1426356.this;
                        if (z) {
                            TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
    ...
    public void muteAllRemoteVideoStreams(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.33
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("muteAllRemoteVideoStreams mute:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCRoomInfo tRTCRoomInfo = TRTCCloudImpl.this.mRoomInfo;
                ...
                tRTCRoomInfo.forEachUser(new TRTCRoomInfo.UserAction() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.33.1
                    ...
                    public void accept(String str, TRTCRoomInfo.UserInfo userInfo) {
                        TRTCRoomInfo.RenderInfo renderInfo = userInfo.mainRender;
                        RunnableC1423833 runnableC1423833 = RunnableC1423833.this;
                        ...
                        RunnableC1423833 runnableC1423834 = RunnableC1423833.this;
                        if (z) {
                            TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
    ...
    public void muteLocalAudio(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.53
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("muteLocalAudio mute:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
                tRTCCloudImpl.muteLocalAudio(z, tRTCCloudImpl);
                if (z) {
                    TXCEventRecorderProxy.m82980a("18446744073709551615", 3001, 1L, -1L, "", 0);
                } else {
                    TXCEventRecorderProxy.m82980a("18446744073709551615", 3001, 3L, -1L, "", 0);
                }
            }
        });
    }
    ...
    public void muteLocalVideo(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.29
            @Override // java.lang.Runnable
            public void run() {
                TRTCCloudImpl.this.apiLog("muteLocalVideo " + z + ", " + TRTCCloudImpl.this.mConfig.f59280A);
                Monitor.m82978a(1, String.format("muteLocalVideo mute:%b", Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.CAMERA_SELECT_COLORFORMAT_FAILED, z ? 1L : 0L, -1L, "", 2);
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
    ...
    public void muteRemoteAudio(final String str, final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.55
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("muteRemoteAudio userId:%s mute:%b", str, Boolean.valueOf(z)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                if (user.tinyID == 0) {
                    return;
                }
    ...
    public void muteRemoteVideoStream(final String str, final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.32
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format(sb.toString(), str, Boolean.valueOf(z)), "", 0);
                if (user.tinyID == 0) {
                    return;
                }
                ...
                if (!z2) {
                    ...
                    TXCEventRecorderProxy.m82980a(String.valueOf(user.tinyID), 4014, 0L, -1L, "", 0);
                } else {
                    ...
                    TXCEventRecorderProxy.m82980a(String.valueOf(user.tinyID), 4014, 1L, -1L, "", 0);
                }
            }
        });
    }
    ...
    public void onAVMemberEnter(final long j, final String str, final int i, final int i2) {
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.138
            ...
            public void run() {
                ...
                C13980a.m82665a().m82668a(strValueOf, true, TRTCCloudImpl.this.hashCode());
                ...
                if (tXCloudVideoView != null) {
                    ...
                    TXCKeyPointReportProxy.m82987a(String.valueOf(user.tinyID), TantanException.Client.AccountService.VERIFY_CURRENT_PASSWORD, 0L, user.streamType);
                ...
                if (tXCloudVideoView2 != null) {
                    ...
                    Monitor.m82978a(1, String.format("startRemoteSubStreamView userID:%s", str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                    ...
                    TXCKeyPointReportProxy.m82987a(String.valueOf(user.tinyID), TantanException.Client.AccountService.VERIFY_CURRENT_PASSWORD, 0L, 7);
                ...
                if (z2) {
                    TRTCCloudImpl.this.runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.138.2
                        ...
                        public void run() {
                            ...
                            Monitor.m82978a(2, String.format("onUserAudioAvailable userID:%s, bAvailable:%b", str, Boolean.valueOf(z2)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                        }
                    });
                    TRTCCloudImpl tRTCCloudImpl10 = TRTCCloudImpl.this;
                ...
                if (z3 && TRTCCloudImpl.this.mRoomInfo.hasRecvFirstIFrame(j)) {
                    TRTCCloudImpl.this.runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.138.3
                        @Override // java.lang.Runnable
                        public void run() {
                            TXCLog.m82969i(TRTCCloudImpl.TAG, "notify onUserVideoAvailable:" + j + " [" + z3 + "] by bit state. self:" + TRTCCloudImpl.this.hashCode());
                            TRTCCloudListener tRTCCloudListener2 = tRTCCloudListener;
                            if (tRTCCloudListener2 != null) {
                                tRTCCloudListener2.onUserVideoAvailable(str, z3);
                            }
                            Monitor.m82978a(2, String.format("onUserVideoAvailable userID:%s, bAvailable:%b", str, Boolean.valueOf(z3)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                        }
                    });
                    TRTCCloudImpl tRTCCloudImpl11 = TRTCCloudImpl.this;
                ...
                if (z4) {
                    TRTCCloudImpl.this.runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.138.4
                        ...
                        public void run() {
                            ...
                            Monitor.m82978a(2, String.format("onUserSubStreamAvailable userID:%s, bAvailable:%b", str, Boolean.valueOf(z4)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                        }
                    });
                    TRTCCloudImpl tRTCCloudImpl12 = TRTCCloudImpl.this;
    ...
    public void onAVMemberExit(final long j, final String str, int i, final int i2) {
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.139
            ...
            public void run() {
                ...
                C13980a.m82665a().m82667a(String.valueOf(j), TRTCCloudImpl.this.hashCode());
                    ...
                    public void run() {
                        ...
                        if (tRTCCloudListener != null) {
                            if (TRTCRoomInfo.hasAudio(i2) && !TRTCRoomInfo.isMuteAudio(i2)) {
                                ...
                                Monitor.m82978a(2, String.format("onUserAudioAvailable userID:%s, bAvailable:%b", str, bool) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                            }
                            if ((TRTCRoomInfo.hasMainVideo(i2) || TRTCRoomInfo.hasSmallVideo(i2)) && !TRTCRoomInfo.isMuteMainVideo(i2)) {
                                ...
                                Monitor.m82978a(2, String.format("onUserVideoAvailable userID:%s, bAvailable:%b", str, bool2) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                            }
                            if (TRTCRoomInfo.hasSubVideo(i2) && !TRTCRoomInfo.isMuteSubVideo(i2)) {
                                ...
                                Monitor.m82978a(2, String.format("onUserSubStreamAvailable userID:%s, bAvailable:%b", str, bool3) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                            }
                ...
                public void run() {
                    ...
                    if (tRTCAudioFrameListener != null) {
                        ...
                        try {
                            ...
                            TXCLog.m82966e(TRTCCloudImpl.TAG, "onPlayAudioFrame failed." + e.getMessage());
                        }
                    }
                }
            });
    ...
    @Override // com.tencent.liteav.C14107d.a
    ...
    public void onCancelTranscoding(final int i, final String str) {
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.161
            @Override // java.lang.Runnable
            public void run() {
                Monitor.m82978a(1, String.format("onCancelTranscoding err:%d, msg:%s", Integer.valueOf(i), str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TRTCCloudListener tRTCCloudListener = TRTCCloudImpl.this.mTRTCListener;
                if (tRTCCloudListener != null) {
                    tRTCCloudListener.onSetMixTranscodingConfig(i, str);
                }
    ...
    @Override // com.tencent.liteav.audio.InterfaceC13982c
    ...
    public void onEnterRoom(final int i, final String str) {
        ...
        Monitor.m82978a(1, String.format("onEnterRoom err:%d msg:%s", Integer.valueOf(i), str) + " self:" + hashCode(), "", 0);
        if (i == 0) {
            TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.EDIT_PREVIEW_FAILED, 1L, -1L, "", 0);
        } else {
            TXCEventRecorderProxy.m82980a("18446744073709551615", ErrorCode.EDIT_PREVIEW_FAILED, 0L, -1L, "", 0);
        }
                ...
                if (i2 != 0) {
                    ...
                    switch (i3) {
                        ...
                        case TXLiteAVCode.ERR_ENTER_ROOM_PARAM_NULL /* -3316 */:
                            TXCKeyPointReportProxy.m82988b(i3);
                            break;
                    }
                }
        ...
        runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.129
            @Override // java.lang.Runnable
            public void run() {
                TXCKeyPointReportProxy.m82989b(30001, i);
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
                TRTCCloudListener tRTCCloudListener = tRTCCloudImpl.mTRTCListener;
    ...
    public void onIdrFpsChanged(TRTCCloudImpl tRTCCloudImpl, final int i) {
        if (isPublishingInCloud(tRTCCloudImpl, 2)) {
            runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.145
                @Override // java.lang.Runnable
                public void run() {
                    TRTCCloudImpl.this.mCaptureAndEnc.m83489c(i);
                }
            });
        }
    }
    ...
    @Override // com.tencent.liteav.audio.InterfaceC13986g
    ...
    public void onRecordError(int i, String str) {
        ...
        bundle.putLong("EVT_TIME", TXCTimeUtil.getTimeTick());
        TXCLog.m82966e(TAG, "onRecordError code = " + i + ":" + str + " self:" + hashCode());
        if (i == -1) {
    ...
    @Override // com.tencent.liteav.screencapture.C14189a.a
    ...
    public void onVideoQosChanged(TRTCCloudImpl tRTCCloudImpl, final int i, final int i2, final int i3, final int i4, final int i5, final int i6, final int i7) {
        if (isPublishingInCloud(tRTCCloudImpl, i)) {
            runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.144
                @Override // java.lang.Runnable
                public void run() {
                    TRTCCloudImpl.this.mCaptureAndEnc.m83471a(i, i2, i3, i4, i5, i6, i7);
                    if (i == 2) {
                        int i8 = i2;
                        int i9 = i3;
                        int i10 = i8 > i9 ? 0 : 1;
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.27
            ...
            public void run() {
                if (TRTCCloudImpl.this.mVideoSourceType == VideoSourceType.SCREEN) {
                    ...
                    Monitor.m82978a(1, "pause screen capture self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                    TRTCCloudImpl.this.mCaptureAndEnc.m83497f();
                }
            }
        });
    }
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.28
            ...
            public void run() {
                if (TRTCCloudImpl.this.mVideoSourceType == VideoSourceType.SCREEN) {
                    ...
                    Monitor.m82978a(1, "resume screen capture self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                    TRTCCloudImpl.this.mCaptureAndEnc.m83500g();
                }
            }
        });
    }
    ...
    public void runOnSDKThreadAndWaitDone(Runnable runnable, long j) {
        if (this.mSDKHandler != null) {
            if (Looper.myLooper() != this.mSDKHandler.getLooper()) {
                this.mSDKHandler.m83030a(runnable, j);
            } else {
                runnable.run();
            }
        }
    ...
    public void sendCustomAudioData(TRTCCloudDef.TRTCAudioFrame tRTCAudioFrame) {
        ...
        final C14041a c14041a = new C14041a();
        byte[] bArr = tRTCAudioFrame.data;
        byte[] bArr2 = new byte[bArr.length];
        c14041a.f58459f = bArr2;
        System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
        c14041a.f58454a = tRTCAudioFrame.sampleRate;
        c14041a.f58455b = tRTCAudioFrame.channel;
        c14041a.f58456c = 16;
        long j = tRTCAudioFrame.timestamp;
        if (0 == j) {
            c14041a.f58458e = TXCTimeUtil.generatePtsMS();
        } else {
            c14041a.f58458e = j;
        }
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.87
            ...
            public void run() {
                if (TRTCCloudImpl.this.mEnableCustomAudioCapture) {
                    TXCAudioEngine.getInstance().sendCustomPCMData(c14041a);
                } else {
    ...
    public boolean sendCustomCmdMsg(final int i, byte[] bArr, final boolean z, final boolean z2) {
        ...
        try {
            ...
            TXCLog.m82967e(TAG, "invalid message data", e);
            str = null;
        }
        ...
        if (jCurrentTimeMillis - this.mLastSendMsgTimeMs < 1000) {
            ...
            if (i3 >= 30 || (i2 = this.mSendMsgSize) >= 8192) {
                TXCLog.m82966e(TAG, "send msg too more self:" + hashCode());
            } else {
    ...
    public void setFocusPosition(final int i, final int i2) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.68
            @Override // java.lang.Runnable
            public void run() {
                TRTCCloudImpl.this.mCaptureAndEnc.m83485b(i, i2);
            }
        });
    }
            ...
            runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.84
                ...
                public void run() {
                    ...
                    if (tRTCVideoRenderListener2 == null) {
                        tRTCCloudImpl.mCaptureAndEnc.m83479a((InterfaceC14155o) null, i3);
                    } else {
                        tRTCCloudImpl.mCaptureAndEnc.m83479a(tRTCCloudImpl, i3);
                    }
                }
            });
            return 0;
    ...
    public void setLocalViewFillMode(final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.36
            ...
            public void run() {
                ...
                TRTCCloudImpl.this.mCaptureAndEnc.m83498f(i);
            }
        });
    }
    ...
    public void setLocalViewMirror(final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.44
            ...
            public void run() {
                ...
                TRTCCloudImpl.this.mCaptureAndEnc.m83484b(i);
    ...
    public void setLocalViewRotation(final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.38
            ...
            public void run() {
                ...
                tRTCCloudImpl.mCaptureAndEnc.m83501g(i2 * 90);
                TRTCCloudImpl.this.updateOrientation();
            }
        });
    }
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.116
            ...
            public void run() {
                ...
                if (tRTCTranscodingConfig == null) {
                    Monitor.m82978a(1, "cancelLiveMixTranscoding self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                }
    ...
    public void setPerformanceMode(JSONObject jSONObject) throws JSONException {
        ...
        if (!jSONObject.has("mode")) {
            ...
            this.mCaptureAndEnc.m83483b().enableSharpnessEnhancement(false);
        }
    }
    ...
    public void setRemoteSurface(final String str, final int i, final Surface surface) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.50
            ...
            public void run() {
                ...
                TextureViewSurfaceTextureListenerC14185e textureViewSurfaceTextureListenerC14185eInternalGetRemoteUserRender = TRTCCloudImpl.this.internalGetRemoteUserRender(str, i);
                if (textureViewSurfaceTextureListenerC14185eInternalGetRemoteUserRender != null) {
                    textureViewSurfaceTextureListenerC14185eInternalGetRemoteUserRender.m83915a(surface);
                }
            }
        });
    }
    ...
    public void setRemoteSurfaceSize(final String str, final int i, final int i2, final int i3) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.51
            ...
            public void run() {
                ...
                TextureViewSurfaceTextureListenerC14185e textureViewSurfaceTextureListenerC14185eInternalGetRemoteUserRender = TRTCCloudImpl.this.internalGetRemoteUserRender(str, i);
                if (textureViewSurfaceTextureListenerC14185eInternalGetRemoteUserRender != null) {
                    textureViewSurfaceTextureListenerC14185eInternalGetRemoteUserRender.m83925c(i2, i3);
                }
            }
        });
    }
                    ...
                    TRTCCloudImpl.this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.85.1
                        ...
                        public void accept(String str2, TRTCRoomInfo.UserInfo userInfo) {
                            if (str2.equalsIgnoreCase(str)) {
                                RunnableC1429585 runnableC1429585 = RunnableC1429585.this;
                                ...
                                RunnableC1429585 runnableC1429586 = RunnableC1429585.this;
    ...
    public void setRenderView(final String str, final TRTCRoomInfo.RenderInfo renderInfo, final TXCloudVideoView tXCloudVideoView, final TRTCCloud.TRTCViewMargin tRTCViewMargin) {
        ...
        final TextureViewSurfaceTextureListenerC14185e videoRender = renderInfo.render.getVideoRender();
        if (tXCloudVideoView == null) {
            videoRender.mo83862c((Object) null);
        } else {
            runOnMainThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.166
                ...
                public void run() {
                    ...
                    if (surfaceView == null) {
                        ...
                        videoRender.m83916a(textureView);
                        return;
                    }
                    ...
                    if (zIsValid) {
                        ...
                        videoRender.m83915a(holder.getSurface());
                        videoRender.m83925c(surfaceView.getWidth(), surfaceView.getHeight());
                    } else {
    ...
    public void setReverbType(final int i) {
        ...
        TXCLog.m82966e(TAG, "reverbType not support :" + i);
    }
    ...
    public void setSystemVolumeType(final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.58
            @Override // java.lang.Runnable
            public void run() {
                Monitor.m82978a(1, String.format("setSystemVolumeType type:%d,  auto(0),media(1),VOIP(2)", Integer.valueOf(i)) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                int i2 = i;
                if (i2 == 0 || 1 == i2 || 2 == i2) {
                    TXCAudioEngine.getInstance();
    ...
    public void setVideoEncoderMirror(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.45
            ...
            public void run() {
                ...
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
                C14110g c14110g = tRTCCloudImpl.mConfig;
                boolean z2 = z;
                c14110g.f59298S = z2;
                tRTCCloudImpl.mCaptureAndEnc.m83496e(z2);
                TRTCCloudImpl.this.updateOrientation();
            }
        });
    }
    ...
    public void setVideoEncoderRotation(final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.40
            ...
            public void run() {
                ...
                if (TRTCCloudImpl.this.mSensorMode == 0) {
                    TRTCCloudImpl.this.mCaptureAndEnc.m83469a(i * 90);
                }
            }
        });
    }
    ...
    public void setVideoMuteImage(final Bitmap bitmap, final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.30
            ...
            public void run() {
                ...
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
                C14110g c14110g = tRTCCloudImpl.mConfig;
                c14110g.f59280A = bitmap;
                c14110g.f59282C = i2;
                c14110g.f59281B = -1;
                tRTCCloudImpl.mCaptureAndEnc.m83478a(c14110g);
            }
        });
    }
    ...
    public boolean setVoiceChangerType(final int i) {
        ...
        TXCLog.m82966e(TAG, "voiceChangerType not support :" + i);
        return false;
    }
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.81
            ...
            public void run() {
                ...
                if (i != 2) {
                    ...
                    float f6 = f3;
                    c14110g.f59289J = f6;
                    tRTCCloudImpl.mCaptureAndEnc.m83472a(bitmap2, f4, f5, f6);
                }
            }
        });
    }
    ...
    public void setZoom(final int i) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.67
            ...
            public void run() {
                ...
                TRTCCloudImpl.this.mCaptureAndEnc.m83505h(i);
            }
        });
    }
    ...
    public void snapshotVideo(String str, int i, TRTCCloudListener.TRTCSnapshotListener tRTCSnapshotListener) {
        ...
        runOnSDKThread(new RunnableC1422824(str, tRTCSnapshotListener, i));
    }
    ...
    public int startAudioRecording(TRTCCloudDef.TRTCAudioRecordingParams tRTCAudioRecordingParams) {
        ...
        TXCAudioEngine.getInstance().setAudioDumpingListener(new TXCAudioEngineJNI.InterfaceC13991a() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.65
            @Override // com.tencent.liteav.audio.impl.TXCAudioEngineJNI.InterfaceC13991a
    ...
    public void startCollectStatus() {
        HandlerC14051e handlerC14051e = this.mSDKHandler;
        if (handlerC14051e != null) {
            handlerC14051e.postDelayed(this.mStatusNotifyTask, 1000L);
        }
    }
    ...
    public void startLocalAudio() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.47
            ...
            public void run() {
                ...
                Monitor.m82978a(1, "startLocalAudio self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TXCEventRecorderProxy.m82980a("18446744073709551615", 3001, 0L, -1L, "", 0);
                ...
                TXCKeyPointReportProxy.m82984a(40050, 1, 1);
            }
        });
    }
    ...
    public void startLocalPreview(final boolean z, final TXCloudVideoView tXCloudVideoView) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.15
            ...
            public void run() {
                ...
                c14110g.f59302W = i == 0;
                c14110g.f59300U = i == 1;
                tRTCCloudImpl2.mCaptureAndEnc.m83478a(c14110g);
                TXCKeyPointReportProxy.m82984a(40046, 1, 2);
                ...
                if (surfaceView != null) {
                    if (z2 || TRTCCloudImpl.this.mVideoSourceType != videoSourceType2) {
                        ...
                        TRTCCloudImpl.this.mCaptureAndEnc.m83481a((TXCloudVideoView) null);
                    }
                    ...
                    TRTCCloudImpl.this.mVideoSourceType = VideoSourceType.CAMERA;
                    TRTCCloudImpl.this.mCaptureAndEnc.m83481a(tXCloudVideoView);
                }
                final Surface[] surfaceArr = new Surface[1];
                final C14050d c14050d = new C14050d();
                TRTCCloudImpl.this.runOnMainThreadAndWaitDone(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.15.2
                    ...
                    public void run() {
                        ...
                        if (surfaceView2 != null) {
                            ...
                            boolean zIsValid = holder.getSurface().isValid();
                            RunnableC1421315 runnableC1421315 = RunnableC1421315.this;
                            if (zIsValid) {
                ...
                if (surface != null) {
                    TRTCCloudImpl.this.mCaptureAndEnc.m83474a(surface);
                    TRTCCloudImpl.this.mCaptureAndEnc.m83470a(c14050d.f58502a, c14050d.f58503b);
                }
            }
        });
    }
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.17
            ...
            public void run() {
                ...
                if (user == null) {
                    ...
                    TRTCCloudImpl.this.mRoomInfo.addUserInfo(str, userInfoCreateUserInfo);
                    Monitor.m82978a(1, String.format("Remote-startRemoteView userID:%s (save view before user enter)", str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                    return;
                }
                TXCloudVideoView tXCloudVideoView2 = tXCloudVideoView;
                ...
                TXCEventRecorderProxy.m82980a(String.valueOf(user.tinyID), 4015, 1L, -1L, "", 0);
            }
        });
    }
    ...
    public void startScreenCapture(final TRTCCloudDef.TRTCVideoEncParam tRTCVideoEncParam, final TRTCCloudDef.TRTCScreenShareParams tRTCScreenShareParams) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.25
            ...
            public void run() {
                ...
                TRTCCloudImpl.this.apiLog(str);
                Monitor.m82978a(1, str, "", 0);
                TRTCCloudImpl.this.mCaptureAndEnc.m83469a(0);
                TRTCCloudImpl tRTCCloudImpl4 = TRTCCloudImpl.this;
                C14110g c14110g = tRTCCloudImpl4.mConfig;
                int i = c14110g.f59316l;
                if (i == 1 || i == 3) {
                    tRTCCloudImpl4.updateBigStreamEncoder(true, c14110g.f59305a, c14110g.f59306b, c14110g.f59312h, c14110g.f59307c, c14110g.f59320p, c14110g.f59309e);
                } else {
                    tRTCCloudImpl4.updateBigStreamEncoder(false, c14110g.f59306b, c14110g.f59305a, c14110g.f59312h, c14110g.f59307c, c14110g.f59320p, c14110g.f59309e);
                }
                TRTCCloudImpl tRTCCloudImpl5 = TRTCCloudImpl.this;
                C14110g.a sizeByResolution = tRTCCloudImpl5.getSizeByResolution(tRTCCloudImpl5.mSmallEncParam.videoResolution, TRTCCloudImpl.this.mSmallEncParam.videoResolutionMode);
                TRTCCloudImpl tRTCCloudImpl6 = TRTCCloudImpl.this;
                tRTCCloudImpl6.updateSmallStreamEncoder(sizeByResolution.f59332a, sizeByResolution.f59333b, tRTCCloudImpl6.mSmallEncParam.videoFps, TRTCCloudImpl.this.mSmallEncParam.videoBitrate, TRTCCloudImpl.this.mSmallEncParam.minVideoBitrate);
                TRTCCloudImpl tRTCCloudImpl7 = TRTCCloudImpl.this;
                tRTCCloudImpl7.mRoomInfo.localView = null;
                tRTCCloudImpl7.enableVideoStream(true);
                TXCKeyPointReportProxy.m82984a(40046, 1, 7);
                TRTCCloudImpl tRTCCloudImpl8 = TRTCCloudImpl.this;
                tRTCCloudImpl8.mCaptureAndEnc.m83480a((C14189a.a) tRTCCloudImpl8);
                TRTCCloudImpl.this.runOnMainThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.25.2
                    @Override // java.lang.Runnable
                    public void run() {
                        RunnableC1422925 runnableC1422925 = RunnableC1422925.this;
    ...
    public void startSpeedTest(final int i, final String str, final String str2) {
        ...
        TXCLog.m82966e(TAG, "startSpeedTest failed with invalid params. userId = " + str + ", userSig = " + str2 + " self:" + hashCode());
    }
    ...
    public void stopAllRemoteView() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.23
            ...
            public void run() {
                ...
                Monitor.m82978a(1, "stopAllRemoteView self:" + TRTCCloudImpl.this.hashCode(), "", 0);
    ...
    public void stopCollectStatus() {
        HandlerC14051e handlerC14051e = this.mSDKHandler;
        if (handlerC14051e != null) {
            handlerC14051e.removeCallbacks(this.mStatusNotifyTask);
        }
    }
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.16
            ...
            public void run() {
                ...
                if (TRTCCloudImpl.this.mVideoSourceType == VideoSourceType.CAMERA) {
                    ...
                    TRTCCloudImpl.this.mCaptureAndEnc.m83490c(true);
                }
                ...
                TXCKeyPointReportProxy.m82984a(40046, 0, 2);
            }
        });
    }
    ...
    public void stopRemoteRender(TRTCRoomInfo.UserInfo userInfo) {
        ...
        apiLog(String.format("stopRemoteRender userID:%s tinyID:%d streamType:%d", userInfo.userID, Long.valueOf(userInfo.tinyID), Integer.valueOf(userInfo.streamType)));
        C13980a.m82665a().m82667a(String.valueOf(userInfo.tinyID), hashCode());
        TRTCRoomInfo.RenderInfo renderInfo = userInfo.mainRender;
        ...
        if (tXCRenderAndDec != null) {
            ...
            if (tXCloudVideoView == null && userInfo.mainRender.render.getVideoRender() != null) {
                userInfo.mainRender.render.getVideoRender().mo83865e();
            }
        }
        TXCRenderAndDec tXCRenderAndDec2 = userInfo.subRender.render;
        if (tXCRenderAndDec2 != null) {
            ...
            if (tXCloudVideoView2 == null && userInfo.subRender.render.getVideoRender() != null) {
                userInfo.subRender.render.getVideoRender().mo83865e();
            }
        }
    ...
    public void stopRemoteSubStreamView(final String str) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.20
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("stopRemoteSubStreamView userID:%s", str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
    ...
    public void stopRemoteView(final String str) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.18
            ...
            public void run() {
                ...
                Monitor.m82978a(1, String.format("stopRemoteView userID:%s", str) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                TXCEventRecorderProxy.m82980a(String.valueOf(user.tinyID), 4015, 0L, -1L, "", 0);
    ...
    public void stopScreenCapture() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.26
            ...
            public void run() {
                ...
                TRTCCloudImpl.this.mCaptureAndEnc.m83510k();
                TRTCCloudImpl tRTCCloudImpl2 = TRTCCloudImpl.this;
                tRTCCloudImpl2.mRoomInfo.localView = null;
                tRTCCloudImpl2.enableVideoStream(false);
                TXCKeyPointReportProxy.m82984a(40046, 0, 7);
                TRTCCloudImpl tRTCCloudImpl3 = TRTCCloudImpl.this;
                tRTCCloudImpl3.mConfig.f59312h = tRTCCloudImpl3.mLatestParamsOfBigEncoder.getInt(TRTCCloudImpl.KEY_CONFIG_FPS, TRTCCloudImpl.this.mConfig.f59312h);
                TRTCCloudImpl tRTCCloudImpl4 = TRTCCloudImpl.this;
                tRTCCloudImpl4.mConfig.f59313i = tRTCCloudImpl4.mLatestParamsOfBigEncoder.getInt(TRTCCloudImpl.KEY_CONFIG_GOP, TRTCCloudImpl.this.mConfig.f59313i);
                TRTCCloudImpl tRTCCloudImpl5 = TRTCCloudImpl.this;
                tRTCCloudImpl5.mConfig.f59320p = tRTCCloudImpl5.mLatestParamsOfBigEncoder.getBoolean(TRTCCloudImpl.KEY_CONFIG_ADJUST_RESOLUTION, TRTCCloudImpl.this.mConfig.f59320p);
                ...
                TXCLog.m82969i(TRTCCloudImpl.TAG, String.format(Locale.ENGLISH, "restore big encoder's fps: %d, gop: %d, small encoder's fps: %d", Integer.valueOf(TRTCCloudImpl.this.mConfig.f59312h), Integer.valueOf(TRTCCloudImpl.this.mConfig.f59313i), Integer.valueOf(TRTCCloudImpl.this.mSmallEncParam.videoFps)));
            }
        });
    }
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        ...
        this.mCaptureAndEnc.m83470a(i2, i3);
    }
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        if (surfaceHolder.getSurface().isValid()) {
            ...
            this.mCaptureAndEnc.m83474a(surfaceHolder.getSurface());
        }
    }
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        this.mCaptureAndEnc.m83474a((Surface) null);
    }
    ...
    public void switchCamera() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.66
            ...
            public void run() {
                TRTCCloudImpl tRTCCloudImpl = TRTCCloudImpl.this;
                C14110g c14110g = tRTCCloudImpl.mConfig;
                c14110g.f59317m = !c14110g.f59317m;
                tRTCCloudImpl.mCaptureAndEnc.m83508j();
                TRTCCloudImpl.this.apiLog("switchCamera " + TRTCCloudImpl.this.mConfig.f59317m);
                TRTCCloudImpl.this.updateOrientation();
            }
        });
    }
    ...
    public void updateAppScene(int i) {
        ...
        C14110g c14110g = this.mConfig;
        if (c14110g.f59305a * c14110g.f59306b >= 518400) {
            this.mAppScene = 1;
        }
        updateEncType();
        apiLog(String.format("update appScene[%d] for video enc[%d] source scene[%d]", Integer.valueOf(this.mAppScene), Integer.valueOf(this.mConfig.f59314j), Integer.valueOf(i)));
    }
            ...
            public void run() {
                ...
                if (z2) {
                    if (tRTCCloudImpl2 == tRTCCloudImpl3) {
                        ...
                        tRTCCloudImpl4.enableNetworkBlackStream(tRTCCloudImpl4.mCaptureAndEnc.m83504h());
                        TRTCCloudImpl tRTCCloudImpl5 = TRTCCloudImpl.this;
                        if (tRTCCloudImpl5.mConfig.f59280A != null) {
                            tRTCCloudImpl5.mCaptureAndEnc.m83497f();
                            return;
                        } else {
                ...
                if (tRTCCloudImpl2 != tRTCCloudImpl3) {
                    ...
                    TRTCCloudImpl tRTCCloudImpl6 = TRTCCloudImpl.this;
                    tRTCCloudImpl6.enableNetworkBlackStream(tRTCCloudImpl6.mCaptureAndEnc.m83504h());
                    TRTCCloudImpl tRTCCloudImpl7 = TRTCCloudImpl.this;
                    ...
                    int i2 = aVar.f59333b;
                    C14110g c14110g = tRTCCloudImpl9.mConfig;
                    tRTCCloudImpl9.setVideoEncConfig(2, i, i2, c14110g.f59312h, c14110g.f59307c, c14110g.f59320p, c14110g.f59309e);
                    boolean z3 = TRTCCloudImpl.this.mEnableSmallStream;
                    TRTCCloudImpl tRTCCloudImpl10 = TRTCCloudImpl.this;
                    if (z3) {
                        C14110g.a aVar2 = tRTCCloudImpl10.mRoomInfo.smallEncSize;
                        int i3 = aVar2.f59332a;
                        int i4 = aVar2.f59333b;
                        int i5 = tRTCCloudImpl10.mSmallEncParam.videoFps;
                        int i6 = TRTCCloudImpl.this.mSmallEncParam.videoBitrate;
                        TRTCCloudImpl tRTCCloudImpl11 = TRTCCloudImpl.this;
                        tRTCCloudImpl10.setVideoEncConfig(3, i3, i4, i5, i6, tRTCCloudImpl11.mConfig.f59320p, tRTCCloudImpl11.mSmallEncParam.minVideoBitrate);
                    } else {
                        tRTCCloudImpl10.setVideoEncoderConfiguration(3, 0, 0, 0, 0, 0, tRTCCloudImpl10.mConfig.f59320p, 0);
                    }
                    TRTCCloudImpl.this.enableVideoStream(true);
                ...
                tRTCCloudImpl12.enableNetworkBlackStream(tRTCCloudImpl12.mCaptureAndEnc.m83504h());
                TRTCCloudImpl.this.muteUpstream(2, z);
                TRTCCloudImpl.this.mCaptureAndEnc.m83509j(2);
                if (TRTCCloudImpl.this.mEnableSmallStream) {
                    TRTCCloudImpl.this.mCaptureAndEnc.m83509j(3);
                }
            }
        });
    }
    ...
    public void runOnSDKThread(Runnable runnable, int i) {
        HandlerC14051e handlerC14051e = this.mSDKHandler;
        if (handlerC14051e != null) {
            handlerC14051e.postDelayed(runnable, i);
        }
    }
                ...
                TRTCCloudImpl.this.runOnListenerThread(new Runnable() { // from class: com.tencent.liteav.trtc.impl.TRTCCloudImpl.170.2
                    ...
                    public void run() {
                        ...
                        if (i3 == 1003) {
                            ...
                            Monitor.m82978a(1, "onCameraDidReady self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                            return;
                        }
                        if (i3 == 2027) {
                            tRTCCloudListener.onMicDidReady();
                            Monitor.m82978a(1, "onMicDidReady self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                            return;
                        }
                        if (i3 < 0) {
                            tRTCCloudListener.onError(i3, bundle.getString(TXLiveConstants.EVT_DESCRIPTION, ""), bundle);
                            Monitor.m82978a(3, String.format("onError event:%d, msg:%s", Integer.valueOf(i), bundle) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                            TXCKeyPointReportProxy.m82988b(i);
                            return;
                        }
                        ...
                        if (i != 2105) {
                            Monitor.m82978a(1, String.format("onWarning event:%d, msg:%s", Integer.valueOf(i), bundle) + " self:" + TRTCCloudImpl.this.hashCode(), "", 0);
                        }
                        int i4 = i;
                        if (i4 == 1103 || i4 == 1109 || i4 == 2106 || i4 == 2109 || i4 == 2101 || i4 == 2102) {
                            TXCKeyPointReportProxy.m82988b(i4);
                        }
                    }
                });
            }
    ...
    public TRTCCloudImpl(Context context, HandlerC14051e handlerC14051e) {
        this.reverbTypes = new TXAudioEffectManager.TXVoiceReverbType[]{TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_0, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_1, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_2, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_3, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_4, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_5, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_6, TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_7};
        this.voiceChangerTypes = new TXAudioEffectManager.TXVoiceChangerType[]{TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_0, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_1, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_2, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_3, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_4, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_5, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_6, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_7, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_8, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_9, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_10, TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_11};
        this.mNativeLock = new Object();
        this.mAudioFrameListener = null;
