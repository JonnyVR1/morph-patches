...
public class TXCYuvTextureRender {
    ...
    private void reloadFrameBuffer() {
        if (this.mNeedReLoadFrameBuffer) {
            String str = TAG;
            TXCLog.m82969i(str, "reloadFrameBuffer. size = " + this.mWidth + "*" + this.mHeight);
            destroyFrameBuffer();
            int[] iArr = new int[1];
            int[] iArr2 = new int[1];
            ...
            TXCLog.m82964d(str, "frameBuffer id = " + this.mFrameBufferID + ", texture id = " + this.mFrameBufferTextureID);
    ...
    public int checkError() {
        ...
        f3c.m119257a("gl error=", iGlGetError);
        return 0;
    }
    ...
    public void drawFrame(TXSVideoFrame tXSVideoFrame) {
        ...
        if (4 == i) {
            ...
            if (i != this.mRawDataFrameType) {
                ...
                TXCLog.m82969i(TAG, " frame type " + i + " matrix_test fullRange");
            }
        } else {
            ...
            if (i != this.mRawDataFrameType) {
                this.mRawDataFrameType = i;
                TXCLog.m82969i(TAG, " frame type " + i + " matrix_test videoRange");
            }
        }
    ...
    public int drawToTexture(TXSVideoFrame tXSVideoFrame) {
        ...
        int i = this.mFrameBufferID;
        if (i == INVALID_TEXTURE_ID) {
            TXCLog.m82973w(TAG, "invalid frame buffer id");
