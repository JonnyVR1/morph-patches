...
public class TXCStreamUploader extends C14040a implements InterfaceC14146b {
    ...
    private C14133a mRtmpProxyParam = new C14133a();
    ...
    public class C14133a {
        ...
        public String f59462h;

        /* JADX INFO: renamed from: i */
        public boolean f59463i;

        /* JADX INFO: renamed from: j */
        public String f59464j;
    ...
    public class C14134b {
        ...
        public C14134b(String str, boolean z) {
            this.f59466a = str;
            this.f59467b = z;
        }
    }
    ...
    public TXCStreamUploader(Context context, C14152h c14152h) {
        ...
        if (c14152h == null) {
            ...
            c14152h.f59565e = 3;
            c14152h.f59567g = 40;
            c14152h.f59568h = 1000;
            c14152h.f59569i = true;
        }
        this.mParam = c14152h;
        this.mThreadLock = new Object();
        C14147c c14147c = new C14147c();
        this.mIntelligentRoute = c14147c;
        c14147c.f59494a = this;
        this.mUploaderInstance = 0L;
        this.mRetryCount = 0;
        this.mCurrentRecordIdx = 0;
        this.mIpList = null;
        ...
        this.mLastNetworkType = 0;
        this.mHandlerThread = null;
        this.mUploadQualityReport = new C14154j(context);
        C14153i.m83735a().m83740a(context);
    }
    ...
    private boolean getNextRtmpProxyIP() {
        C14133a c14133a = this.mRtmpProxyParam;
        c14133a.f59460f = 234L;
        c14133a.f59461g = 80L;
        ...
        this.mRtmpProxyParam.f59462h = str2;
    ...
    private C14134b getRtmpRealConnectInfo() {
        int i;
        if (!this.mEnableNearestIP) {
            return new C14134b(this.mRtmpUrl, false);
        }
        ArrayList<C14136a> arrayList = this.mIpList;
        if (arrayList == null) {
            return new C14134b(this.mRtmpUrl, false);
        }
        ...
        C14136a c14136a = this.mIpList.get(i);
        String[] strArrSplit = this.mRtmpUrl.split("://");
        if (strArrSplit.length < 2) {
            return new C14134b(this.mRtmpUrl, false);
        }
        String[] strArrSplit2 = strArrSplit[1].split("/");
        if (c14136a.f59469a.split(":").length <= 1 || c14136a.f59469a.startsWith("[")) {
            strArrSplit2[0] = c14136a.f59469a + ":" + c14136a.f59470b;
        } else {
            strArrSplit2[0] = "[" + c14136a.f59469a + "]:" + c14136a.f59470b;
        }
        ...
        return new C14134b(strArrSplit[0] + "://" + sb.toString(), c14136a.f59471c);
    }
    ...
    public void internalReconnect(boolean z) {
        if (this.mIsPushing) {
            if (this.mRtmpProxyEnable) {
                if (this.mLastNetworkType != C14052f.m83053e(this.mContext)) {
                    TXCLog.m82966e(TAG, "reconnect network switch from " + this.mLastNetworkType + " to " + C14052f.m83053e(this.mContext));
                    this.mLastNetworkType = C14052f.m83053e(this.mContext);
                    this.mRetryCount = 0;
                    Monitor.m82978a(2, "WebrtcRoom: need enter again by user", "", 0);
                    sendNotifyEvent(1021, String.format("Network type has changed. Need to re-enter the room", new Object[0]));
                    return;
                }
                int i = this.mRetryCount;
                if (i >= this.mParam.f59565e) {
                    if (!getNextRtmpProxyIP()) {
                        TXCEventRecorderProxy.m82980a(this.mRtmpUrl, 91002, -1L, -1L, "connect rtmp-proxy server failed(try all addresses)", 0);
                        sendNotifyEvent(TXLiteAVCode.ERR_RTMP_PUSH_NET_ALLADDRESS_FAIL);
                        return;
                    } else {
                        this.mRetryCount = 0;
                        Monitor.m82978a(2, String.format("Network: reconnecting to upload server with quic.[addr:%s][retryCount:%d][retryLimit:%d]", this.mRtmpProxyParam.f59462h, 0, Integer.valueOf(this.mParam.f59565e)), "", 0);
                ...
                int i2 = i + 1;
                this.mRetryCount = i2;
                Monitor.m82978a(2, String.format("Network: reconnecting to upload server with quic.[addr:%s][retryCount:%d][retryLimit:%d]", this.mRtmpProxyParam.f59462h, Integer.valueOf(i2), Integer.valueOf(this.mParam.f59565e)), "", 0);
                TXCEventRecorderProxy.m82980a(this.mRtmpUrl, 91003, -1L, -1L, "reconnect rtmp-proxy server(econnect retry count:" + this.mRetryCount + " retry limit:" + this.mParam.f59565e + ")", 0);
                sendNotifyEvent(1102);
                startPushTask(this.mRtmpUrl, this.mQuicChannel, 0);
                return;
            }
            this.mUploadQualityReport.m83757c();
            if (this.mEnableNearestIP && this.mLastNetworkType != C14052f.m83053e(this.mContext)) {
                TXCLog.m82966e(TAG, "reconnect network switch from " + this.mLastNetworkType + " to " + C14052f.m83053e(this.mContext));
                this.mLastNetworkType = C14052f.m83053e(this.mContext);
                this.mIntelligentRoute.m83701a(this.mRtmpUrl, this.mChannelType);
                this.mRetryCount = 0;
                return;
            }
            ...
            if (z2 && !nextRecordIdx(true)) {
                TXCLog.m82966e(TAG, "reconnect: try all addresses failed");
                TXCEventRecorderProxy.m82980a(this.mRtmpUrl, 91002, -1L, -1L, "connect upload server failed(try all addresses failed)", 0);
            }
            C14134b rtmpRealConnectInfo = getRtmpRealConnectInfo();
            String addressFromUrl = getAddressFromUrl(rtmpRealConnectInfo.f59466a);
            ...
            TXCLog.m82966e(TAG, sb.toString());
            if (this.mQuicChannel) {
                TXCLog.m82966e(TAG, "reconnect last channel type is Q Channel，ignore retry limit");
                Monitor.m82978a(2, String.format("Network: reconnecting to upload server with quic.[addr:%s]", addressFromUrl), "", 0);
                startPushTask(rtmpRealConnectInfo.f59466a, rtmpRealConnectInfo.f59467b, 0);
                sendNotifyEvent(1102);
                return;
            }
            TXCLog.m82966e(TAG, "reconnect retry count:" + this.mRetryCount + " retry limit:" + this.mParam.f59565e);
            int i3 = this.mRetryCount;
            if (i3 >= this.mParam.f59565e) {
                TXCLog.m82966e(TAG, "reconnect: try all times failed");
                TXCEventRecorderProxy.m82980a(this.mRtmpUrl, 91002, -1L, -1L, "connect upload server failed(try all times failed)", 0);
                sendNotifyEvent(TXLiteAVCode.ERR_RTMP_PUSH_NET_ALLADDRESS_FAIL);
                return;
            }
            int i4 = i3 + 1;
            this.mRetryCount = i4;
            Monitor.m82978a(2, String.format("Network: reconnecting to upload server with tcp.[addr:%s][retryCount:%d][retryLimit:%d]", addressFromUrl, Integer.valueOf(i4), Integer.valueOf(this.mParam.f59565e)), "", 0);
            TXCEventRecorderProxy.m82980a(this.mRtmpUrl, 91003, -1L, -1L, "reconnect upload server:(retry count:" + this.mRetryCount + " retry limit:" + this.mParam.f59565e + ")", 0);
            startPushTask(rtmpRealConnectInfo.f59466a, rtmpRealConnectInfo.f59467b, 0);
            sendNotifyEvent(1102);
        }
    }
    ...
    private boolean nextRecordIdx(boolean z) {
        ...
        if (arrayList != null && arrayList.size() != 0) {
            if (z) {
                this.mIpList.get(this.mCurrentRecordIdx).f59473e++;
            }
    ...
    private void onRtmpProxyUserListPushed(RtmpProxyUserInfo[] rtmpProxyUserInfoArr) {
        if (rtmpProxyUserInfoArr != null && this.mIsPushing && this.mRtmpProxyEnable && this.mRtmpProxyParam != null) {
            try {
                ...
                TXCLog.m82967e(TAG, "build json object failed.", e);
            }
        }
    }
    ...
    private void parseProxyInfo(String str) {
        ...
        this.mRtmpProxyParam.f59463i = isQCloudStreamUrl(str);
        HashMap paramsFromUrl = getParamsFromUrl(str);
        if (paramsFromUrl == null) {
            return;
        }
        if (paramsFromUrl.containsKey("sdkappid")) {
            this.mRtmpProxyParam.f59455a = Long.valueOf((String) paramsFromUrl.get("sdkappid")).longValue();
        }
        if (paramsFromUrl.containsKey("roomid") && paramsFromUrl.containsKey(UserId.TYPE) && paramsFromUrl.containsKey("roomsig")) {
            this.mRtmpProxyParam.f59458d = Long.valueOf((String) paramsFromUrl.get("roomid")).longValue();
            this.mRtmpProxyParam.f59457c = (String) paramsFromUrl.get(UserId.TYPE);
            if (paramsFromUrl.containsKey("bizbuf")) {
                try {
                    this.mRtmpProxyParam.f59464j = URLDecoder.decode((String) paramsFromUrl.get("bizbuf"), "UTF-8");
                } catch (Exception e) {
                    TXCLog.m82967e(TAG, "decode bizbuf failed.", e);
                }
            }
            try {
                JSONObject jSONObject = new JSONObject(URLDecoder.decode((String) paramsFromUrl.get("roomsig"), "UTF-8"));
                this.mRtmpProxyParam.f59456b = 0L;
                if (jSONObject.has("Key")) {
                    this.mRtmpProxyParam.f59459e = jSONObject.optString("Key");
                    ...
                    if (jSONObjectOptJSONObject == null || (jSONObjectOptJSONObject.has("Ip") && jSONObjectOptJSONObject.has("Port") && jSONObjectOptJSONObject.has("Type"))) {
                        ...
                        if (!this.mRtmpProxyParam.f59463i) {
                            this.mRtmpUrl = str;
                            ...
                            this.mRtmpUrl = str.substring(0, str.indexOf("?")) + "/webrtc/" + (this.mRtmpProxyParam.f59455a + "_" + this.mRtmpProxyParam.f59458d + "_" + this.mRtmpProxyParam.f59457c) + "?real_rtmp_ip=" + jSONObjectOptJSONObject.optString("Ip") + "&real_rtmp_port=" + jSONObjectOptJSONObject.optLong("Port") + "&tinyid=" + this.mRtmpProxyParam.f59456b + "&srctinyid=0";
                            getNextRtmpProxyIP();
                        }
                ...
                TXCLog.m82967e(TAG, "parse proxy info failed.", e2);
            }
        }
    }
    ...
    public void reportNetStatus() {
        ...
        if (uploadStats != null) {
            ...
            this.mUploadQualityReport.m83750a(uploadStats.videoDropCount, uploadStats.audioDropCount);
            this.mUploadQualityReport.m83756b(uploadStats.videoCacheLen, uploadStats.audioCacheLen);
        } else {
    ...
    public void rtmpProxySendHeartBeat() {
        ...
        long j = iArrM83043a[0] / 10;
        long j2 = iArrM83043a[1] / 10;
        long jM82999c = TXCStatus.m82999c(getID(), 7004);
        long jM82999c2 = TXCStatus.m82999c(getID(), 7003);
        long jM82999c3 = TXCStatus.m82999c(getID(), 1001);
        long jM82999c4 = TXCStatus.m82999c(getID(), 4001);
        long jM82999c5 = TXCStatus.m82999c(getID(), 7006);
        long jM82999c6 = TXCStatus.m82999c(getID(), 7005);
        long jM82999c7 = TXCStatus.m82999c(getID(), 7008);
        long jM82999c8 = TXCStatus.m82999c(getID(), 7007);
        synchronized (this.mRtmpProxyLock) {
            nativeRtmpProxySendHeartBeat(this.mRtmpProxyInstance, j, j2, jM82999c, jM82999c2, jM82999c3, jM82999c4, jM82999c5, jM82999c6, jM82999c7, jM82999c8);
        }
    }
    ...
    public void startPushTask(final String str, final boolean z, int i) {
        TXCLog.m82969i(TAG, "start push task");
        boolean z2 = this.mQuicChannel;
        if (z2 != z && z2) {
            Monitor.m82978a(2, String.format("Network: switch push channel from quic to tcp.[retryCount:%d][retryLimit:%d]", Integer.valueOf(this.mRetryCount), Integer.valueOf(this.mParam.f59565e)), "", 0);
        }
        if (z) {
        ...
        Thread thread = new Thread("RTMPUpload") { // from class: com.tencent.liteav.network.TXCStreamUploader.2
            ...
            public void run() {
                ...
                TXCStreamUploader.this.mUploadQualityReport.m83755b();
                TXCStreamUploader.this.mUploadQualityReport.m83753a(TXCStreamUploader.this.mParam.f59570j);
                TXCStreamUploader.this.mUploadQualityReport.m83752a(TXCStreamUploader.this.mRtmpUrl);
                TXCStreamUploader.this.mUploadQualityReport.m83754a(z, TXCStreamUploader.this.getAddressFromUrl(str));
                synchronized (TXCStreamUploader.this.mThreadLock) {
                    try {
                        TXCStreamUploader.this.mQuicChannel = z;
                        int i4 = TXCStreamUploader.this.mParam.f59570j ? TXCStreamUploader.this.mQuicChannel ? 3 : 2 : 1;
                        ...
                        if (z3) {
                            if (tXCStreamUploader.mAudioMuted) {
                                TXCStreamUploader.this.mParam.f59571k = false;
                            }
                        ...
                        tXCStreamUploader2.mUploaderInstance = tXCStreamUploader2.nativeInitUploader(tXCStreamUploader2.mRtmpUrl, str, z, TXCStreamUploader.this.mParam.f59564d, TXCStreamUploader.this.mParam.f59563c, TXCStreamUploader.this.mParam.f59561a, TXCStreamUploader.this.mParam.f59562b, TXCStreamUploader.this.mParam.f59567g, 16, i4, TXCStreamUploader.this.mParam.f59571k, TXCStreamUploader.this.mParam.f59572l, TXCStreamUploader.this.mMetaData);
                        if (TXCStreamUploader.this.mUploaderInstance != 0) {
                            TXCStreamUploader tXCStreamUploader3 = TXCStreamUploader.this;
                            tXCStreamUploader3.nativeSetVideoDropParams(tXCStreamUploader3.mUploaderInstance, TXCStreamUploader.this.mParam.f59569i, TXCStreamUploader.this.mParam.f59567g, TXCStreamUploader.this.mParam.f59568h);
                            boolean z4 = false;
                ...
                if (TXCStreamUploader.this.mRtmpProxyEnable) {
                    synchronized (TXCStreamUploader.this.mRtmpProxyLock) {
                        ...
                        tXCStreamUploader5.mRtmpProxyInstance = tXCStreamUploader5.nativeInitRtmpProxyInstance(tXCStreamUploader5.mRtmpProxyParam.f59455a, TXCStreamUploader.this.mRtmpProxyParam.f59456b, TXCStreamUploader.this.mRtmpProxyParam.f59457c, TXCStreamUploader.this.mRtmpProxyParam.f59458d, TXCStreamUploader.this.mRtmpProxyParam.f59459e, TXCStreamUploader.this.mRtmpProxyParam.f59460f, TXCStreamUploader.this.mRtmpProxyParam.f59461g, TXCStreamUploader.this.mRtmpProxyParam.f59462h, TXCStreamUploader.this.mRtmpProxyParam.f59463i, TXCStreamUploader.this.mRtmpProxyParam.f59464j);
                    }
    ...
    private void stopPushTask() {
        TXCLog.m82969i(TAG, "stop push task");
        synchronized (this.mThreadLock) {
    ...
    private void tryResetRetryCount() {
        if (this.mConnectSuccessTimeStamps != 0) {
            ...
            C14152h c14152h = this.mParam;
            if (timeTick > c14152h.f59565e * (c14152h.f59566f + 13) * 1000) {
                this.mRetryCount = 0;
                this.mConnectSuccessTimeStamps = 0L;
                TXCLog.m82969i(TAG, "reset retry count");
            }
        }
    }
    ...
    @Override // com.tencent.liteav.network.InterfaceC14146b
    public void onFetchDone(int i, ArrayList<C14136a> arrayList) {
        int size;
        String str;
        if (this.mIsPushing) {
            if (arrayList != null) {
                TXCLog.m82966e(TAG, "onFetchDone: code = " + i + " ip count = " + arrayList.size());
                if (i == 0) {
            ...
            if (size > 0) {
                String str2 = "";
                int i2 = 0;
                for (C14136a c14136a : this.mIpList) {
                    if (c14136a != null && c14136a.f59471c && (str = c14136a.f59469a) != null && str.length() > 0) {
                        i2++;
                    }
                    if (c14136a != null) {
                        str2 = str2 + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + getConfusionIP(c14136a.f59469a) + ":" + c14136a.f59470b;
                    }
                }
            ...
            C14134b rtmpRealConnectInfo = getRtmpRealConnectInfo();
            postReconnectMsg(rtmpRealConnectInfo.f59466a, rtmpRealConnectInfo.f59467b, 0);
        }
    }
    ...
    public void setDropEanble(boolean z) {
        TXCLog.m82969i(TAG, "drop enable ".concat(z ? "yes" : "no"));
        synchronized (this.mThreadLock) {
    ...
    public void setSendStrategy(boolean z, boolean z2) {
        int i;
        ArrayList<C14136a> arrayList;
        C14152h c14152h = this.mParam;
        c14152h.f59570j = z;
        c14152h.f59571k = z2;
        this.mUploadQualityReport.m83753a(z);
        int i2 = 1;
        if (z) {
            i = this.mQuicChannel ? 3 : 2;
        } else {
    ...
    public String start(String str, boolean z, int i) {
        ...
        this.mUploadQualityReport.m83749a();
        ...
        sb.append(i);
        TXCLog.m82969i(TAG, sb.toString());
        if (C14052f.m83053e(this.mContext) == 0) {
        ...
        if (this.mRtmpProxyEnable) {
            ...
            startPushTask(this.mRtmpUrl, this.mQuicChannel, 0);
        } else if (!this.mEnableNearestIP || this.mLastNetworkType == C14052f.m83053e(this.mContext)) {
            startPushTask(this.mRtmpUrl, this.mQuicChannel, 0);
        } else {
            TXCLog.m82969i(TAG, "fetching nearest ip list");
            this.mLastNetworkType = C14052f.m83053e(this.mContext);
            this.mIntelligentRoute.m83701a(str, i);
        }
    ...
    private void sendNotifyEvent(int i, String str) {
        ...
        if (i != 1002) {
            if (i == 1101) {
                this.mUploadQualityReport.m83758d();
            }
        } else {
            UploadStats uploadStats = getUploadStats();
            if (uploadStats != null) {
                this.mUploadQualityReport.m83751a(uploadStats.dnsparseTimeCost, uploadStats.connectTimeCost, uploadStats.handshakeTimeCost);
            }
        }
    }
}
