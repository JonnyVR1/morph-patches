...
public class TXCDRApi {
        ...
        try {
            ...
            if (activeNetworkInfo.getType() == 0) {
                ...
                try {
                    ...
                    TXCLog.m82967e(TAG, "TXCDRApi: get network type fail, exception occurred.", e);
                }
            }
            return i;
        } catch (Exception e2) {
            TXCLog.m82967e(TAG, "getActiveNetworkInfo exception:", e2);
            return 255;
        }
    }
    ...
    private static String getPackageName(Context context) {
        try {
            ...
            TXCLog.m82967e(TAG, "get package name failed.", e);
            return "";
        }
    }
    ...
    public static String getSimulateIDFA(Context context) {
        ...
        if (externalFilesDir == null) {
            TXCLog.m82966e(TAG, "getSimulateIDFA sdcardDir is null");
            return g_simulate_idfa;
        }
        ...
        try {
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    e = e;
                    TXCLog.m82966e(TAG, "read UUID from file failed! reason: " + e.getMessage());
                }
            } else {
                str = null;
            }
        ...
        if (string == null || string.length() == 0) {
            ...
            String strM83050c = C14052f.m83050c(context);
            int i = 5;
            while (i >= 0) {
            ...
            sb.append(strConcat);
            sb.append(string2Md5(strM83050c + UUID.randomUUID().toString()));
            string = sb.toString();
        }
        g_simulate_idfa = string;
        TXCLog.m82969i(TAG, "UUID:" + g_simulate_idfa);
        if (str == null || !str.equals(string)) {
            try {
                ...
                TXCLog.m82966e(TAG, "write UUID to file failed! reason: " + e3.getMessage());
            }
        }
    ...
    public static void initCrashReport(Context context) {
        ...
        try {
            ...
            TXCLog.m82967e(TAG, "init crash report failed.", e);
        }
    }
    ...
    public static String string2Md5(String str) {
        ...
        try {
            ...
            TXCLog.m82967e(TAG, "string2Md5 failed.", e);
    ...
    public static void txSetAppVersion(String str) {
        if (str != null) {
            nativeSetCommonValue(C14026a.f58390k, str);
        }
    }

    public static void txSetCommonInfo() {
        if (mDevType != null) {
            nativeSetCommonValue(C14026a.f58385f, mDevType);
        }
        if (mNetType != null) {
            nativeSetCommonValue(C14026a.f58386g, mNetType);
        }
        if (mDevId != null) {
            nativeSetCommonValue(C14026a.f58387h, mDevId);
        }
        if (mDevUUID != null) {
            nativeSetCommonValue(C14026a.f58388i, mDevUUID);
        }
        if (mAppName != null) {
            nativeSetCommonValue(C14026a.f58389j, mAppName);
        }
        if (mSysVersion != null) {
            nativeSetCommonValue(C14026a.f58391l, mSysVersion);
        }
    }
