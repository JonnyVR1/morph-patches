...
public class TXCKeyPointReportProxy {
    ...
    /* JADX INFO: renamed from: a */
    public static void m82985a(Context context) {
        ...
        if (!file.exists()) {
            try {
                if (!file.mkdirs()) {
                    TXCLog.m82966e("TXCKeyPointReportProxy", "can not create sso file path");
                    return;
                }
            } catch (Exception e) {
                TXCLog.m82966e("TXCKeyPointReportProxy", "create sso file exception:" + e.toString());
            }
        }
        nativeInit(str);
    }
    ...
    /* JADX INFO: renamed from: b */
    public static void m82989b(int i, int i2) {
        nativeTagKeyPointEnd(i, i2);
    }

    /* JADX INFO: renamed from: c */
    public static void m82990c(int i, int i2) {
    ...
    /* JADX INFO: renamed from: b */
    public static void m82988b(int i) {
        nativeSetErrorCode(i);
    }

    /* JADX INFO: renamed from: a */
    public static void m82981a() {
        nativeSendCacheReport();
    }

    /* JADX INFO: renamed from: a */
    public static void m82986a(C14039a c14039a) {
        nativeSetDeviceInfo(c14039a.f58446a, c14039a.f58447b, c14039a.f58448c, c14039a.f58449d, c14039a.f58450e, c14039a.f58451f, c14039a.f58452g, c14039a.f58453h);
    }

    /* JADX INFO: renamed from: a */
    public static void m82983a(int i, int i2) {
        nativeSetCpu(i, i2);
    }

    /* JADX INFO: renamed from: a */
    public static void m82982a(int i) {
        nativeTagKeyPointStart(i);
    }

    /* JADX INFO: renamed from: a */
    public static void m82987a(String str, int i, long j, int i2) {
        nativesetRemoteQuality(str, i, j, i2);
    }

    /* JADX INFO: renamed from: a */
    public static void m82984a(int i, int i2, int i3) {
