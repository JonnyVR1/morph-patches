...
public class TXILiveRoomDefine {
    ...
    public static class TXILiveRoomLocalMixUser {
        ...
        public String toString() {
            return "TXILiveRoomLocalMixUser{userId=" + this.userId + ", x=" + this.f57590x + ", y=" + this.f57591y + ", width=" + this.width + ", height=" + this.height + '}';
        }
    }
    ...
    public static class TXILiveRoomMixUser {
        ...
        public TXILiveRoomMixUser(TXILiveRoomMixUser tXILiveRoomMixUser) {
            if (tXILiveRoomMixUser != null) {
                ...
                this.f57592x = tXILiveRoomMixUser.f57592x;
                this.f57593y = tXILiveRoomMixUser.f57593y;
        ...
        public String toString() {
            return "TXILiveRoomMixUser{userId='" + this.userId + "', x=" + this.f57592x + ", y=" + this.f57593y + ", width=" + this.width + ", height=" + this.height + ", zOrder=" + this.zOrder + ", isMuteAudio=" + this.isMuteAudio + '}';
        }
