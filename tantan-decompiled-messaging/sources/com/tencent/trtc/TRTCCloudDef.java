...
public class TRTCCloudDef {
    ...
    public static class TRTCSpeedTestResult {
        ...
        public String f60465ip;
        public int quality;
        public int rtt;
        public float upLostRate;

        public String toString() {
            return String.format("ip: %s, quality: %d, upLostRate: %.2f%%, downLostRate: %.2f%%, rtt: %d", this.f60465ip, Integer.valueOf(this.quality), Float.valueOf(this.upLostRate * 100.0f), Float.valueOf(this.downLostRate * 100.0f), Integer.valueOf(this.rtt));
        }
    }
    ...
    public static class TRTCMixUser {
        ...
        public TRTCMixUser(TRTCMixUser tRTCMixUser) {
            ...
            this.f60463x = tRTCMixUser.f60463x;
            this.f60464y = tRTCMixUser.f60464y;
        ...
        public String toString() {
            return "userId=" + this.userId + ", roomId=" + this.roomId + ", x=" + this.f60463x + ", y=" + this.f60464y + ", width=" + this.width + ", height=" + this.height + ", zOrder=" + this.zOrder + ", streamType=" + this.streamType + ", pureAudio=" + this.pureAudio + ", inputType=" + this.inputType;
        }
