...
public abstract class TRTCCloud {
    private static C14425a mTXLogListener;
    ...
    public static void setLogListener(TRTCCloudListener.TRTCLogListener tRTCLogListener) {
        C14425a c14425a = mTXLogListener;
        if (c14425a != null) {
            c14425a.m84616a(null);
        }
        if (tRTCLogListener != null) {
            C14425a c14425a2 = new C14425a();
            mTXLogListener = c14425a2;
            c14425a2.m84616a(tRTCLogListener);
        } else {
            mTXLogListener = null;
        }
    ...
    public static class C14425a implements TXCLog.InterfaceC14038a {

        /* JADX INFO: renamed from: a */
        private TRTCCloudListener.TRTCLogListener f60462a = null;

        @Override // com.tencent.liteav.basic.log.TXCLog.InterfaceC14038a
        /* JADX INFO: renamed from: a */
        public void mo82975a(int i, String str, String str2) {
            TRTCCloudListener.TRTCLogListener tRTCLogListener = this.f60462a;
            if (tRTCLogListener != null) {
        ...
        /* JADX INFO: renamed from: a */
        public void m84616a(TRTCCloudListener.TRTCLogListener tRTCLogListener) {
            this.f60462a = tRTCLogListener;
        }
    }
}
