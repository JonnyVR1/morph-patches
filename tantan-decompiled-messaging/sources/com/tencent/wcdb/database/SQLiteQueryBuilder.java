...
public class SQLiteQueryBuilder {
    ...
    public Cursor query(SQLiteDatabase sQLiteDatabase, String[] strArr, String str, String[] strArr2, String str2, String str3, String str4, String str5, CancellationSignal cancellationSignal) {
        ...
        if (!this.mStrict || str == null || str.length() <= 0) {
            ...
            cancellationSignal2 = cancellationSignal;
            validateQuerySql(sQLiteDatabase, buildQuery(strArr, "(" + str + ")", str2, str3, str4, str5), cancellationSignal2);
        }
        String strBuildQuery = buildQuery(strArr, str, str2, str3, str4, str5);
        Log.m84617d(TAG, "Performing query: " + strBuildQuery);
        return sQLiteDatabase.rawQueryWithFactory(this.mFactory, strBuildQuery, strArr2, SQLiteDatabase.findEditTable(this.mTables), cancellationSignal2);
    }
