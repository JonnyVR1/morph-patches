...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (strPathOldToNew != null && strPathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m84175e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + strPathOldToNew + ", ex = " + e.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m84175e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m84176i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m84175e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            int iLastIndexOf = str.lastIndexOf(46);
            if (iLastIndexOf != -1) {
                return "com.tencent.mm.opensdk.modelmsg".concat(str.substring(iLastIndexOf));
            }
            Log.m84175e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = ".concat(str));
            return str;
        }
    ...
    public boolean checkArgs() {
        ...
        } else if (getType() == 76 && C14340b.m84183b(this.title)) {
            str = "checkArgs fail, Type = Music Video, but title == null";
        } else if (C14340b.m84182a(getType()) && ((bArr2 = this.thumbData) == null || bArr2.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (C14340b.m84182a(getType()) || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m84175e(TAG, "setThumbImage exception:" + e.getMessage());
        }
    }
