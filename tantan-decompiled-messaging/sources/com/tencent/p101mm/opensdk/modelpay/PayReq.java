package com.tencent.p101mm.opensdk.modelpay;
...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C14332a.m84159a(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C14332a.m84157a(bundle, "_wxapi_payoptions_callback_flags", -1);
        }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C14332a.m84159a(bundle, "_wxapi_payreq_appid");
        this.partnerId = C14332a.m84159a(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C14332a.m84159a(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C14332a.m84159a(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C14332a.m84159a(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C14332a.m84159a(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C14332a.m84159a(bundle, "_wxapi_payreq_sign");
        this.extData = C14332a.m84159a(bundle, "_wxapi_payreq_extdata");
        this.signType = C14332a.m84159a(bundle, "_wxapi_payreq_sign_type");
