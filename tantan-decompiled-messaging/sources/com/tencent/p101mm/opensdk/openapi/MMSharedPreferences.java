...
import com.tencent.p101mm.opensdk.utils.C14339a;
...
class MMSharedPreferences implements SharedPreferences {
    ...
    private final ContentResolver f60120cr;
    ...
    public static class REditor implements SharedPreferences.Editor {
        ...
        /* JADX INFO: renamed from: cr */
        private ContentResolver f60121cr;
        private Map<String, Object> values = new HashMap();
        private Set<String> remove = new HashSet();
        private boolean clear = false;

        public REditor(ContentResolver contentResolver) {
            this.f60121cr = contentResolver;
        }
        ...
        public boolean commit() {
            ...
            if (this.clear) {
                this.f60121cr.delete(C14339a.f60122a, null, null);
                this.clear = false;
            }
            Iterator<String> it = this.remove.iterator();
            while (it.hasNext()) {
                this.f60121cr.delete(C14339a.f60122a, "key = ?", new String[]{it.next()});
            }
            ...
            while (true) {
                ...
                if (value == null) {
                    ...
                    if (i == 0) {
                        ...
                        this.f60121cr.update(C14339a.f60122a, contentValues, "key = ?", new String[]{next.getKey()});
                    }
                }
                Log.m84175e("MicroMsg.SDK.PluginProvider.Resolver", str);
                i = 0;
                if (i == 0) {
                    contentValues.put("type", Integer.valueOf(i));
                    contentValues.put("value", value.toString());
    ...
    public MMSharedPreferences(Context context) {
        this.f60120cr = context.getContentResolver();
    }

    private Object getValue(String str) {
        try {
            Cursor cursorQuery = this.f60120cr.query(C14339a.f60122a, this.columns, "key = ?", new String[]{str}, null);
            if (cursorQuery == null) {
                return null;
            }
            Object objM84158a = cursorQuery.moveToFirst() ? C14332a.m84158a(cursorQuery.getInt(cursorQuery.getColumnIndex("type")), cursorQuery.getString(cursorQuery.getColumnIndex("value"))) : null;
            cursorQuery.close();
            return objM84158a;
        } catch (Exception e) {
            Log.m84175e(TAG, "getValue exception:" + e.getMessage());
            return null;
        }
    }
    ...
    public SharedPreferences.Editor edit() {
        if (this.editor == null) {
            this.editor = new REditor(this.f60120cr);
        }
        return this.editor;
    }
    ...
    public Map<String, ?> getAll() {
        try {
            Cursor cursorQuery = this.f60120cr.query(C14339a.f60122a, this.columns, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
            ...
            while (cursorQuery.moveToNext()) {
                this.values.put(cursorQuery.getString(columnIndex), C14332a.m84158a(cursorQuery.getInt(columnIndex2), cursorQuery.getString(columnIndex3)));
            }
            cursorQuery.close();
            return this.values;
        } catch (Exception e) {
            Log.m84175e(TAG, "getAll exception:" + e.getMessage());
            return this.values;
        }
    }
