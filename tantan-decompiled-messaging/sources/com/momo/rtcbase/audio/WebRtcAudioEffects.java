...
class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f14554ns;
    ...
    public void enable(int i) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            this.f14554ns = noiseSuppressorCreate;
            ...
            if (this.f14554ns.setEnabled(z) != 0) {
            ...
            sb2.append(z);
            sb2.append(", is now: ");
            sb2.append(this.f14554ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f14554ns;
    ...
    public boolean setNS(boolean z) {
        ...
        if (this.f14554ns == null || z == this.shouldEnableNs) {
