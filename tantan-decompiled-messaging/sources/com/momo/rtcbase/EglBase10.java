...
class EglBase10 implements EglBase {
    ...
    public void createSurface(Surface surface) {
        createSurfaceInternal(new SurfaceHolder(surface) { // from class: com.momo.rtcbase.EglBase10.1FakeSurfaceHolder
    ...
    @Override // com.momo.rtcbase.EglBase
    public android.opengl.EGLContext getSharedConect() {
        return null;
    }
