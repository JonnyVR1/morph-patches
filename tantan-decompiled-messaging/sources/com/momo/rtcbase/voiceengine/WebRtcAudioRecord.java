...
public class WebRtcAudioRecord {
        ...
        public void run() {
            ...
            while (this.keepAlive) {
                ...
                if (WebRtcAudioRecord.this.audioRecord == null) {
                    Logging.m20198e(WebRtcAudioRecord.TAG, "AudioRecord creat failed:");
                    break;
                }
    ...
    public WebRtcAudioRecord(long j) {
        Logging.m20197d(TAG, "WebRtcAudioRecord Created:" + WebRtcAudioUtils.getThreadInfo());
    ...
    private boolean enableBuiltInAEC(boolean z) {
        ...
        Logging.m20198e(TAG, "Built-in AEC is not supported on this platform");
        return false;
    }
    ...
    private boolean enableBuiltInNS(boolean z) {
        ...
        Logging.m20198e(TAG, "Built-in NS is not supported on this platform");
        return false;
    }
    ...
    public static synchronized void setAudioSource(int i) {
        Logging.m20201w(TAG, "Audio source is changed from: " + audioSource + " to " + i);
        audioSource = i;
    }
