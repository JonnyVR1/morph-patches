...
public class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f14562ns;
    ...
    public static boolean canUseAcousticEchoCanceler() {
        ...
        Logging.m20197d(TAG, "canUseAcousticEchoCanceler: " + z);
        return z;
    }
    ...
    public static boolean canUseNoiseSuppressor() {
        ...
        Logging.m20197d(TAG, "canUseNoiseSuppressor: " + z);
        return z;
    }
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (zContains) {
            Logging.m20201w(TAG, str + " is blacklisted for HW AEC usage!");
        }
        return zContains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (zContains) {
            Logging.m20201w(TAG, str + " is blacklisted for HW NS usage!");
        }
        return zContains;
    }
    ...
    public void enable(int i) {
        Logging.m20197d(TAG, "enable(audioSession=" + i + ")");
        boolean z = false;
        assertTrue(this.aec == null);
        assertTrue(this.f14562ns == null);
        if (isAcousticEchoCancelerSupported()) {
            ...
            if (acousticEchoCancelerCreate != null) {
                ...
                if (this.aec.setEnabled(z2) != 0) {
                    Logging.m20198e(TAG, "Failed to set the AcousticEchoCanceler state");
                }
                ...
                Logging.m20198e(TAG, "Failed to create the AcousticEchoCanceler instance");
            }
        }
        if (isNoiseSuppressorSupported()) {
            NoiseSuppressor noiseSuppressorCreate = NoiseSuppressor.create(i);
            this.f14562ns = noiseSuppressorCreate;
            if (noiseSuppressorCreate == null) {
                Logging.m20198e(TAG, "Failed to create the NoiseSuppressor instance");
                return;
            }
            ...
            if (this.f14562ns.setEnabled(z) != 0) {
                Logging.m20198e(TAG, "Failed to set the NoiseSuppressor state");
            }
            ...
            sb2.append(z);
            sb2.append(", is now: ");
            sb2.append(this.f14562ns.getEnabled() ? "enabled" : "disabled");
            Logging.m20197d(TAG, sb2.toString());
        }
    }
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f14562ns;
    ...
    public boolean setAEC(boolean z) {
        Logging.m20197d(TAG, "setAEC(" + z + ")");
        if (!canUseAcousticEchoCanceler()) {
            Logging.m20201w(TAG, "Platform AEC is not supported");
        ...
        Logging.m20198e(TAG, "Platform AEC state can't be modified while recording");
        return false;
    }

    public boolean setNS(boolean z) {
        Logging.m20197d(TAG, "setNS(" + z + ")");
        if (!canUseNoiseSuppressor()) {
            Logging.m20201w(TAG, "Platform NS is not supported");
            this.shouldEnableNs = false;
            return false;
        }
        if (this.f14562ns == null || z == this.shouldEnableNs) {
            this.shouldEnableNs = z;
            return true;
        }
        Logging.m20198e(TAG, "Platform NS state can't be modified while recording");
        return false;
    }
}
