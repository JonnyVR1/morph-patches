...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    public static /* synthetic */ void m20214a(SurfaceViewRenderer surfaceViewRenderer, int i, int i2) {
    ...
    private void logD(String str) {
        Logging.m20197d(TAG, this.resourceName + ": " + str);
    }
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: l.u2h0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceViewRenderer.m20214a(this.f173486a, i4, i);
            }
        });
    }
    ...
    public void surfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        this.eglRenderer.releaseEglSurface(new t1h0(countDownLatch));
