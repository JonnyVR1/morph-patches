...
public class PeerConnectionFactory {
    ...
    public static class Builder {
        ...
        public Builder setAudioDecoderFactoryFactory(AudioDecoderFactoryFactory audioDecoderFactoryFactory) {
            ...
            ig3.m135964a("PeerConnectionFactory.Builder does not accept a null AudioDecoderFactoryFactory.");
            return null;
        }
        ...
        public Builder setAudioEncoderFactoryFactory(AudioEncoderFactoryFactory audioEncoderFactoryFactory) {
            ...
            ig3.m135964a("PeerConnectionFactory.Builder does not accept a null AudioEncoderFactoryFactory.");
            return null;
        }
        ...
        public Builder setAudioProcessingFactory(AudioProcessingFactory audioProcessingFactory) {
            ...
            jfd0.m141176a("PeerConnectionFactory builder does not accept a null AudioProcessingFactory.");
            return null;
        }
    ...
    private PeerConnectionFactory(Options options, AudioDeviceModule audioDeviceModule, AudioEncoderFactoryFactory audioEncoderFactoryFactory, AudioDecoderFactoryFactory audioDecoderFactoryFactory, VideoEncoderFactory videoEncoderFactory, VideoDecoderFactory videoDecoderFactory, AudioProcessingFactory audioProcessingFactory, FecControllerFactoryFactoryInterface fecControllerFactoryFactoryInterface, MediaTransportFactoryFactory mediaTransportFactoryFactory) {
        ...
        upk0.m194883a("Failed to initialize PeerConnectionFactory!");
        throw null;
    }
    ...
    private void checkInitializeHasBeenCalled() {
        if (!NativeLibrary.isLoaded() || ContextUtils.getApplicationContext() == null) {
            qkq0.m175383a("PeerConnectionFactory.initialize was not called before creating a PeerConnectionFactory.");
        }
    }
    ...
    private void checkPeerConnectionFactoryExists() {
        ...
        qkq0.m175383a("PeerConnectionFactory has been disposed.");
    }
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        if (loggable != null) {
            ...
            Logging.m20197d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void onNetworkThreadReady() {
        ...
        Logging.m20197d(TAG, "onNetworkThreadReady");
    }

    @CalledByNative
    private static void onSignalingThreadReady() {
        signalingThread = Thread.currentThread();
        Logging.m20197d(TAG, "onSignalingThreadReady");
    }

    @CalledByNative
    private static void onWorkerThreadReady() {
        workerThread = Thread.currentThread();
        Logging.m20197d(TAG, "onWorkerThreadReady");
    }
    ...
    private static void printStackTrace(Thread thread, String str) {
        if (thread != null) {
            ...
            if (stackTrace.length > 0) {
                Logging.m20201w(TAG, str + " stacks trace:");
                for (StackTraceElement stackTraceElement : stackTrace) {
                    Logging.m20201w(TAG, stackTraceElement.toString());
                }
            }
        }
    }
