...
public class NetworkMonitor {
    ...
    private static void assertIsTrue(boolean z) {
        ...
        y9g0.m213537a("Expected to be true");
    }
    ...
    private void startMonitoring(Context context, long j) {
        Logging.m20197d(TAG, "Start monitoring with native observer " + j);
        if (context == null) {
    ...
    private void stopMonitoring(long j) {
        Logging.m20197d(TAG, "Stop monitoring with native observer " + j);
        stopMonitoring();
        synchronized (this.nativeNetworkObservers) {
