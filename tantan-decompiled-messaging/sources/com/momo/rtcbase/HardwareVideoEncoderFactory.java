...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public HardwareVideoEncoderFactory(EglBase.Context context, boolean z, boolean z2, Predicate<MediaCodecInfo> predicate) {
        ...
        if (context instanceof EglBase14.Context) {
            ...
            Logging.m20201w(TAG, "No shared EglBase.Context.  Encoders will not use texture mode.");
    ...
    private MediaCodecInfo findCodecForType(VideoCodecType videoCodecType) {
        ...
        while (true) {
            ...
            if (codecInfoAt != null && codecInfoAt.isEncoder()) {
                Logging.m20198e("HardwareVideoEncoderFactory->", codecInfoAt.getName());
    ...
    private int getKeyFrameIntervalSec(VideoCodecType videoCodecType) {
        int i = C41371.$SwitchMap$com$momo$rtcbase$VideoCodecType[videoCodecType.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
        ...
        qhg0.m174539a("Unsupported VideoCodecType ", videoCodecType);
        return 0;
    }
    ...
    private boolean isHardwareSupportedInCurrentSdk(MediaCodecInfo mediaCodecInfo, VideoCodecType videoCodecType) {
        if (C41371.$SwitchMap$com$momo$rtcbase$VideoCodecType[videoCodecType.ordinal()] != 1) {
            return false;
        }
