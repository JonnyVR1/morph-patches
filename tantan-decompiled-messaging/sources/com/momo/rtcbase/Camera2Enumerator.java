...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private CameraCharacteristics getCameraCharacteristics(String str) {
        try {
            ...
            Logging.m20198e(TAG, "Camera access exception: " + e);
            return null;
        }
    }
    ...
    public static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (map) {
            try {
                ...
                Logging.m20197d(TAG, "Get supported formats for camera index " + str + "");
                ...
                try {
                    ...
                    for (Size size : supportedSizes) {
                        ...
                        Logging.m20197d(TAG, "Format: " + size.width + BaseSei.f13930X + size.height + "@" + iRound);
                    }
                    cachedSupportedFormats.put(str, arrayList);
                    Logging.m20197d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                    return arrayList;
                } catch (Exception e) {
                    Logging.m20198e(TAG, "getCameraCharacteristics(): " + e);
