...
class HardwareVideoEncoder implements VideoEncoder {
    ...
    private VideoCodecStatus encodeByteBuffer(VideoFrame videoFrame, VideoFrame.Buffer buffer, int i) {
        ...
        try {
            ...
            if (iDequeueInputBuffer == -1) {
                Logging.m20197d(TAG, "Dropped frame, no input buffers available");
            ...
            try {
                ...
                try {
                    ...
                    Logging.m20199e(TAG, "queueInputBuffer failed", e);
                    return VideoCodecStatus.NO_OUTPUT;
                }
            } catch (IllegalStateException e2) {
                Logging.m20199e(TAG, "getInputBuffers failed", e2);
                return VideoCodecStatus.NO_OUTPUT;
            }
        } catch (IllegalStateException e3) {
            Logging.m20199e(TAG, "dequeueInputBuffer failed", e3);
            return VideoCodecStatus.NO_OUTPUT;
        }
    }
    ...
    private VideoCodecStatus encodeTextureBuffer(VideoFrame videoFrame) {
        ...
        try {
            ...
            Logging.m20199e(TAG, "encodeTexture failed", e);
            releaseResource();
            return VideoCodecStatus.NO_OUTPUT;
        } catch (Exception e2) {
            Logging.m20199e(TAG, "encodeTexture failed", e2);
            releaseResource();
            return VideoCodecStatus.NO_OUTPUT;
        }
    }
    ...
    private VideoCodecStatus initEncodeInternal() {
        ...
        try {
            ...
            Logging.m20198e(TAG, "resetCodec initEncodeInternal startBitrate " + this.startBitrate);
                ...
                if (this.codecType == VideoCodecType.H264) {
                    ...
                    if (iHashCode != 1537948542) {
                        if (iHashCode == 1595523974 && str.equals("640c1f")) {
                            ...
                            Logging.m20201w(TAG, "Unknown profile level id: ".concat(str));
                        }
            ...
            Logging.m20198e(TAG, "Cannot create media encoder " + this.codecName);
            releaseResource();
            return VideoCodecStatus.OK;
        }
    }
    ...
    public void releaseCodecOnOutputThread() {
        ...
        Logging.m20197d(TAG, "Releasing MediaCodec on output thread");
        try {
            this.codec.stop();
        } catch (Exception e) {
            Logging.m20199e(TAG, "Media encoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m20199e(TAG, "Media encoder release failed", e2);
            this.shutdownException = e2;
        }
        this.configBuffer = null;
        Logging.m20197d(TAG, "Release on output thread done");
    }
    ...
    private void requestKeyFrame(long j) {
        ...
        try {
            ...
            Logging.m20199e(TAG, "requestKeyFrame failed", e);
        }
    }
    ...
    private VideoCodecStatus resetCodec(int i, int i2, boolean z) {
        ...
        Logging.m20198e(TAG, "resetCodec begin frame =" + this.bitrateAdjuster.getCodecConfigFramerate() + "biterate=" + this.bitrateAdjuster.getAdjustedBitrateBps() + ";resetCodecInterval =" + this.resetCodecInterval + ";viideoModem=" + this.bitrateMode);
        this.resetCodecPreTime = System.currentTimeMillis();
    ...
    public void deliverEncodedImage() {
        ...
        try {
            ...
            if ((bufferInfo.flags & 2) != 0) {
                ...
                if (z) {
                    Logging.m20198e(TAG, "Sync frame generated");
                }
                if (z && this.codecType == VideoCodecType.H264) {
                    Logging.m20197d(TAG, "Prepending config frame of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
            ...
            Logging.m20199e(TAG, "deliverOutput failed", e);
        }
    }
            ...
            try {
                ...
                if ((this.resetCodecInterval > 0 && this.adjustedBitrate != this.bitrateAdjuster.getAdjustedBitrateBps()) || this.isNeedUpdateShareContext) {
                    if (resetCodec(width, height, z) != VideoCodecStatus.OK) {
                        Logging.m20198e(TAG, "resetCodec fail");
                    } else {
                        this.adjustedBitrate = this.bitrateAdjuster.getAdjustedBitrateBps();
                        this.isNeedUpdateShareContext = false;
                    }
                ...
                if (this.outputBuilders.size() > 2) {
                    Logging.m20198e(TAG, "Dropped frame, encoder queue full");
                    return videoCodecStatus;
                }
                boolean z2 = false;
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        ...
        if (i2 == 0 || (i = settings.maxFramerate) == 0) {
            ...
            int i3 = i2 != 0 ? i2 * 1000 : PlaybackException.CUSTOM_ERROR_CODE_BASE;
        ...
        Logging.m20197d(TAG, "initEncode: " + this.width + " x " + this.height + ". @ " + settings.startBitrate + "kbps. Fps: " + settings.maxFramerate + " Use surface mode: " + this.useSurfaceMode);
        synchronized (this.codecSync) {
            videoCodecStatusInitEncodeInternal = initEncodeInternal();
        }
        return videoCodecStatusInitEncodeInternal;
    ...
    public VideoCodecStatus release() {
        this.encodeThreadChecker.checkIsOnValidThread();
        Logging.m20198e(TAG, "HardwareVideoEncoder release");
        synchronized (this.codecSync) {
            try {
                this.isNeedUpdateShareContext = true;
                if (this.outputThread == null) {
                    ...
                    if (!ThreadUtils.joinUninterruptibly(this.outputThread, Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS)) {
                        ...
                        Logging.m20199e(TAG, "Media encoder release exception", this.shutdownException);
    ...
    public VideoCodecStatus releaseResource() {
        Logging.m20198e(TAG, "HardwareVideoEncoder releaseResource");
        this.running = false;
        Thread thread = this.outputThread;
        if (thread != null && !ThreadUtils.joinUninterruptibly(thread, Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS)) {
            Logging.m20198e(TAG, "Media encoder release timeout");
        }
    ...
    public void updateSharedContext(EglBase.Context context) {
        ...
        if (this.sharedContext != context2 || this.textureEglBase == null) {
            Logging.m20197d(TAG, "need release codec");
            this.isNeedUpdateShareContext = true;
        }
