...
public class VideoFrameDrawer {
    ...
    /* JADX INFO: renamed from: com.momo.rtcbase.VideoFrameDrawer$1 */
    public static /* synthetic */ class C41631 {
        static final /* synthetic */ int[] $SwitchMap$com$momo$rtcbase$VideoFrame$TextureBuffer$Type;

        static {
            int[] iArr = new int[VideoFrame.TextureBuffer.Type.values().length];
            $SwitchMap$com$momo$rtcbase$VideoFrame$TextureBuffer$Type = iArr;
            try {
                iArr[VideoFrame.TextureBuffer.Type.OES.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$momo$rtcbase$VideoFrame$TextureBuffer$Type[VideoFrame.TextureBuffer.Type.RGB.ordinal()] = 2;
    ...
    public static void drawTexture(RendererCommon.GlDrawer glDrawer, VideoFrame.TextureBuffer textureBuffer, Matrix matrix, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        int i7 = C41631.$SwitchMap$com$momo$rtcbase$VideoFrame$TextureBuffer$Type[textureBuffer.getType().ordinal()];
        if (i7 == 1) {
            ...
            upk0.m194883a("Unknown texture type.");
        }
    }
    ...
    public static class YuvUploader {
        ...
        public /* synthetic */ YuvUploader(C41631 c41631) {
            this();
        }
    }
