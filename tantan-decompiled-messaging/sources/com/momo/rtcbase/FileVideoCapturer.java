...
public class FileVideoCapturer implements VideoCapturer {
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i == -1) {
                    ibe.m135253a("Found end of file before end of header for file: ", str);
                    throw null;
                }
                if (i == 10) {
                    ...
                    Logging.m20197d(TAG, "Color space: " + strSubstring);
                    if (!strSubstring.equals("420") && !strSubstring.equals("420mpeg2")) {
                        ig3.m135964a("Does not support any other color space than I420 or I420mpeg2");
                        throw null;
                    }
                    if (i2 % 2 == 1 || i3 % 2 == 1) {
                        ig3.m135964a("Does not support odd width or height");
                        throw null;
                    }
                    this.frameWidth = i2;
                    this.frameHeight = i3;
                    Logging.m20197d(TAG, "frame dim: (" + i2 + ", " + i3 + ")");
                    return;
                }
                sb.append((char) i);
            }
        ...
        public void close() {
            try {
                ...
                Logging.m20199e(TAG, "Problem closing file", e);
            }
        }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m20197d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
