...
public class EglRenderer implements VideoSink {
    ...
    public static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) throws Exception {
            try {
                ...
                Logging.m20199e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
    ...
    public static /* synthetic */ void m20187a(EglRenderer eglRenderer, EglBase.Context context, int[] iArr) {
        if (context == null) {
    ...
    public static /* synthetic */ void m20188b(EglRenderer eglRenderer) {
    ...
    public static /* synthetic */ void m20190d(EglRenderer eglRenderer, Runnable runnable) {
    ...
    public static /* synthetic */ void m20192f(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f, boolean z) {
        if (glDrawer == null) {
    ...
    public static /* synthetic */ void m20193g(EglRenderer eglRenderer, CountDownLatch countDownLatch, FrameListener frameListener) {
    ...
    public static /* synthetic */ void m20194h(EglRenderer eglRenderer, Looper looper) {
        eglRenderer.logD("Quitting render thread.");
        looper.quit();
    }

    /* JADX INFO: renamed from: i */
    public static /* synthetic */ void m20195i(EglRenderer eglRenderer, CountDownLatch countDownLatch) {
        eglRenderer.getClass();
    ...
    private void logW(String str) {
        Logging.m20201w(TAG, this.name + str);
    }
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: l.sre
            @Override // java.lang.Runnable
            public final void run() {
                EglRenderer.m20192f(this.f166083a, glDrawer, frameListener, f, z);
            }
        });
    }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            try {
                ...
                handler.postAtFrontOfQueue(new Runnable() { // from class: l.pre
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f150871a.clearSurfaceOnRenderThread(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public void init(final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            try {
                ...
                handlerThread.start();
                HandlerWithExceptionCallback handlerWithExceptionCallback = new HandlerWithExceptionCallback(handlerThread.getLooper(), new Runnable() { // from class: l.yre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m20188b(this.f199666a);
                    }
                });
                this.renderThreadHandler = handlerWithExceptionCallback;
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: l.bse
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m20187a(this.f77060a, context, iArr);
                    }
                });
            ...
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        videoFrame.retain();
                        this.renderThreadHandler.post(new Runnable() { // from class: l.vre
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f182717a.renderFrameOnRenderThread();
                            }
                        });
                    } catch (Throwable th) {
                        throw th;
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.gre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m20195i(this.f104050a, countDownLatch);
                    }
                });
                final Looper looper = this.renderThreadHandler.getLooper();
                this.renderThreadHandler.post(new Runnable() { // from class: l.jre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m20194h(this.f119393a, looper);
                    }
                });
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                if (handler == null) {
                    ...
                    this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.dre
                        @Override // java.lang.Runnable
                        public final void run() {
                            EglRenderer.m20190d(this.f87607a, runnable);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: l.mre
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m20193g(this.f135357a, countDownLatch, frameListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
