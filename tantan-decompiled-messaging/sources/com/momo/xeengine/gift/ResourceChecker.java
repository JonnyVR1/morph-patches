...
public final class ResourceChecker {
    ...
    public static /* synthetic */ void m20260a(ResourceDownloadCompletion resourceDownloadCompletion, boolean z) {
    ...
    public static /* synthetic */ void m20261b(String str, ResourceDownloadCompletion resourceDownloadCompletion, boolean z, String str2) {
        boolean z2;
    ...
    public static /* synthetic */ void m20262c(ResourceChecker resourceChecker, List list, String str, int[] iArr, int i, final ResourceDownloadCompletion resourceDownloadCompletion, boolean z) {
                ...
                if (i2 == i) {
                    ...
                    resourceChecker.mainHandler.post(new Runnable() { // from class: com.momo.xeengine.gift.q
                        ...
                        public final void run() {
                            ResourceChecker.m20260a(resourceDownloadCompletion, zIsEmpty);
                        }
                    });
                }
            } catch (Throwable th2) {
        ...
        if (downloader == null) {
            ...
            downloader.downloadResourceWithURL(str, new IResourceDownloader.Callback() { // from class: com.momo.xeengine.gift.p
                ...
                public final void onComplete(boolean z, String str2) {
                    ResourceChecker.m20261b(str, resourceDownloadCompletion, z, str2);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m20264e(final ResourceChecker resourceChecker, final String str, final List list, final int[] iArr, final int i, final ResourceDownloadCompletion resourceDownloadCompletion) {
        resourceChecker.getClass();
        resourceChecker.downloadResourceAtURL(str, new ResourceDownloadCompletion() { // from class: com.momo.xeengine.gift.t
            ...
            public final void onComplete(boolean z) {
                ResourceChecker.m20262c(this.f14633a, list, str, iArr, i, resourceDownloadCompletion, z);
            }
        });
    }
    ...
    public void downloadResources(List<String> list, final ResourceDownloadCompletion resourceDownloadCompletion) {
        ...
        for (final String str : list) {
            this.executorService.submit(new Runnable() { // from class: com.momo.xeengine.gift.s
                @Override // java.lang.Runnable
                public final void run() {
                    ResourceChecker.m20264e(this.f14627a, str, arrayList, iArr, size, resourceDownloadCompletion);
                }
            });
        }
    }
