...
final class ResourceDownloaderImpl implements IResourceDownloader {
    ...
    public static /* synthetic */ void m20265a(ResourceDownloaderImpl resourceDownloaderImpl, String str, File file, IResourceDownloader.Callback callback) {
        ...
        if (!file.exists()) {
            this.executorService.execute(new Runnable() { // from class: com.momo.xeengine.gift.u
                ...
                public final void run() {
                    ResourceDownloaderImpl.m20265a(this.f14639a, str, file, callback);
                }
            });
            return;
        }
