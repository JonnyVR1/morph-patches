...
public final class InsertTextBean extends BaseInsertBean {
    ...
    public InsertTextBean(@NotNull String str, @NotNull String str2, float f, int i, boolean z, int i2, int i3) {
        ...
        this.text = "";
        this.richText = "";
        this.textColor = SafeKit.parseColor("#ffffff");
        setKey(str);
        this.text = str2;
        this.textSize = f;
        this.textColor = i;
    ...
    public final TextUtils.TruncateAt m223814getEllipsize() {
