...
public final class ShapeEntity extends Message<ShapeEntity, Builder> {
    ...
    public ShapeEntity(ShapeType shapeType, ShapeStyle shapeStyle, Transform transform, ShapeArgs shapeArgs, RectArgs rectArgs, EllipseArgs ellipseArgs, ByteString byteString) {
        ...
        if (Internal.countNonNull(shapeArgs, rectArgs, ellipseArgs) > 1) {
            ig3.m135964a("at most one of shape, rect, ellipse may be non-null");
            throw null;
        }
        this.type = shapeType;
        this.styles = shapeStyle;
    ...
    public static final class ShapeArgs extends Message<ShapeArgs, Builder> {
        ...
        public static final class Builder extends Message.Builder<ShapeArgs, Builder> {
            ...
            public ShapeArgs build() {
                return new ShapeArgs(this.f14725d, super.buildUnknownFields());
            }

            /* JADX INFO: renamed from: d */
            public Builder m20322d(String str) {
                this.f14725d = str;
                return this;
            }
        }
            ...
            public ShapeArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag != 1) {
                        ...
                        builder.m20322d(ProtoAdapter.STRING.decode(protoReader));
                    }
                }
            }
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(shapeArgs.unknownFields()) && Internal.equals(this.f14724d, shapeArgs.f14724d);
        }
    ...
    public static final class ShapeStyle extends Message<ShapeStyle, Builder> {
        ...
        public static final class RGBAColor extends Message<RGBAColor, Builder> {
            ...
            public static final class Builder extends Message.Builder<RGBAColor, Builder> {
                ...
                /* JADX INFO: renamed from: a */
                public Builder m20323a(Float f) {
                    this.f14730a = f;
                    return this;
                }

                /* JADX INFO: renamed from: b */
                public Builder m20324b(Float f) {
                    this.f14731b = f;
                    return this;
                }
                ...
                public RGBAColor build() {
                    return new RGBAColor(this.f14733r, this.f14732g, this.f14731b, this.f14730a, super.buildUnknownFields());
                }

                /* JADX INFO: renamed from: g */
                public Builder m20325g(Float f) {
                    this.f14732g = f;
                    return this;
                }

                /* JADX INFO: renamed from: r */
                public Builder m20326r(Float f) {
                    this.f14733r = f;
                    return this;
                }
            }
            ...
            public static final class ProtoAdapter_RGBAColor extends ProtoAdapter<RGBAColor> {
                ...
                public RGBAColor decode(ProtoReader protoReader) throws IOException {
                    ...
                    while (true) {
                        ...
                        if (iNextTag == 1) {
                            builder.m20326r(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag == 2) {
                            builder.m20325g(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag == 3) {
                            builder.m20324b(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag != 4) {
                            FieldEncoding fieldEncodingPeekFieldEncoding = protoReader.peekFieldEncoding();
                            builder.addUnknownField(iNextTag, fieldEncodingPeekFieldEncoding, fieldEncodingPeekFieldEncoding.rawProtoAdapter().decode(protoReader));
                        } else {
                            builder.m20323a(ProtoAdapter.FLOAT.decode(protoReader));
                        }
                    }
                }
            ...
            public boolean equals(Object obj) {
                ...
                return unknownFields().equals(rGBAColor.unknownFields()) && Internal.equals(this.f14729r, rGBAColor.f14729r) && Internal.equals(this.f14728g, rGBAColor.f14728g) && Internal.equals(this.f14727b, rGBAColor.f14727b) && Internal.equals(this.f14726a, rGBAColor.f14726a);
            }
            ...
            public Builder newBuilder() {
                Builder builder = new Builder();
                builder.f14733r = this.f14729r;
                builder.f14732g = this.f14728g;
                builder.f14731b = this.f14727b;
                builder.f14730a = this.f14726a;
                builder.addUnknownFields(unknownFields());
                return builder;
            }
    ...
    public static final class EllipseArgs extends Message<EllipseArgs, Builder> {
        ...
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 1)
        public final Float f14716x;

        /* JADX INFO: renamed from: y */
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 2)
        public final Float f14717y;
        ...
        public static final class Builder extends Message.Builder<EllipseArgs, Builder> {
            ...
            /* JADX INFO: renamed from: x */
            public Float f14718x;

            /* JADX INFO: renamed from: y */
            public Float f14719y;

            @Override // com.squareup.wire.Message.Builder
            public EllipseArgs build() {
                return new EllipseArgs(this.f14718x, this.f14719y, this.radiusX, this.radiusY, super.buildUnknownFields());
            }
            ...
            /* JADX INFO: renamed from: x */
            public Builder m20318x(Float f) {
                this.f14718x = f;
                return this;
            }

            /* JADX INFO: renamed from: y */
            public Builder m20319y(Float f) {
                this.f14719y = f;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_EllipseArgs extends ProtoAdapter<EllipseArgs> {
            ...
            public EllipseArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == 1) {
                        builder.m20318x(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 2) {
                        builder.m20319y(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 3) {
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(ellipseArgs.unknownFields()) && Internal.equals(this.f14716x, ellipseArgs.f14716x) && Internal.equals(this.f14717y, ellipseArgs.f14717y) && Internal.equals(this.radiusX, ellipseArgs.radiusX) && Internal.equals(this.radiusY, ellipseArgs.radiusY);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = unknownFields().hashCode() * 37;
            Float f = this.f14716x;
            int iHashCode2 = (iHashCode + (f != null ? f.hashCode() : 0)) * 37;
            Float f2 = this.f14717y;
            int iHashCode3 = (iHashCode2 + (f2 != null ? f2.hashCode() : 0)) * 37;
        ...
        public Builder newBuilder() {
            Builder builder = new Builder();
            builder.f14718x = this.f14716x;
            builder.f14719y = this.f14717y;
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            if (this.f14716x != null) {
                sb.append(", x=");
                sb.append(this.f14716x);
            }
            if (this.f14717y != null) {
                sb.append(", y=");
                sb.append(this.f14717y);
            }
    ...
    public static final class RectArgs extends Message<RectArgs, Builder> {
        ...
        public static final class Builder extends Message.Builder<RectArgs, Builder> {
            ...
            public RectArgs build() {
                return new RectArgs(this.f14722x, this.f14723y, this.width, this.height, this.cornerRadius, super.buildUnknownFields());
            }
            ...
            /* JADX INFO: renamed from: x */
            public Builder m20320x(Float f) {
                this.f14722x = f;
                return this;
            }

            /* JADX INFO: renamed from: y */
            public Builder m20321y(Float f) {
                this.f14723y = f;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_RectArgs extends ProtoAdapter<RectArgs> {
            ...
            public RectArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == 1) {
                        builder.m20320x(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 2) {
                        builder.m20321y(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 3) {
            ...
            public void encode(ProtoWriter protoWriter, RectArgs rectArgs) throws IOException {
                Float f = rectArgs.f14720x;
                if (f != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 1, f);
                }
                Float f2 = rectArgs.f14721y;
                if (f2 != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 2, f2);
                }
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(rectArgs.unknownFields()) && Internal.equals(this.f14720x, rectArgs.f14720x) && Internal.equals(this.f14721y, rectArgs.f14721y) && Internal.equals(this.width, rectArgs.width) && Internal.equals(this.height, rectArgs.height) && Internal.equals(this.cornerRadius, rectArgs.cornerRadius);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = unknownFields().hashCode() * 37;
            Float f = this.f14720x;
            int iHashCode2 = (iHashCode + (f != null ? f.hashCode() : 0)) * 37;
            Float f2 = this.f14721y;
            int iHashCode3 = (iHashCode2 + (f2 != null ? f2.hashCode() : 0)) * 37;
            Float f3 = this.width;
            int iHashCode4 = (iHashCode3 + (f3 != null ? f3.hashCode() : 0)) * 37;
        ...
        public Builder newBuilder() {
            Builder builder = new Builder();
            builder.f14722x = this.f14720x;
            builder.f14723y = this.f14721y;
        ...
        public String toString() {
            ...
            if (this.f14720x != null) {
                sb.append(", x=");
                sb.append(this.f14720x);
            }
            if (this.f14721y != null) {
                sb.append(", y=");
                sb.append(this.f14721y);
            }
            if (this.width != null) {
                sb.append(", width=");
