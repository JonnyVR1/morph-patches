...
public final class Transform extends Message<Transform, Builder> {
    ...
    public final Float f14738tx;

    /* JADX INFO: renamed from: ty */
    @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 6)
    public final Float f14739ty;
    ...
    public static final class Builder extends Message.Builder<Transform, Builder> {
        ...
        /* JADX INFO: renamed from: tx */
        public Float f14744tx;

        /* JADX INFO: renamed from: ty */
        public Float f14745ty;

        /* JADX INFO: renamed from: a */
        public Builder m20327a(Float f) {
            this.f14740a = f;
            return this;
        }

        /* JADX INFO: renamed from: b */
        public Builder m20328b(Float f) {
            this.f14741b = f;
            return this;
        }
        ...
        public Transform build() {
            return new Transform(this.f14740a, this.f14741b, this.f14742c, this.f14743d, this.f14744tx, this.f14745ty, super.buildUnknownFields());
        }

        /* JADX INFO: renamed from: c */
        public Builder m20329c(Float f) {
            this.f14742c = f;
            return this;
        }

        /* JADX INFO: renamed from: d */
        public Builder m20330d(Float f) {
            this.f14743d = f;
            return this;
        }

        /* JADX INFO: renamed from: tx */
        public Builder m20331tx(Float f) {
            this.f14744tx = f;
            return this;
        }

        /* JADX INFO: renamed from: ty */
        public Builder m20332ty(Float f) {
            this.f14745ty = f;
            return this;
        }
    }
    ...
    public static final class ProtoAdapter_Transform extends ProtoAdapter<Transform> {
        ...
        public Transform decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    case 1:
                        builder.m20327a(ProtoAdapter.FLOAT.decode(protoReader));
                        break;
                    case 2:
                        builder.m20328b(ProtoAdapter.FLOAT.decode(protoReader));
                        break;
                    case 3:
                        builder.m20329c(ProtoAdapter.FLOAT.decode(protoReader));
                        break;
                    case 4:
                        builder.m20330d(ProtoAdapter.FLOAT.decode(protoReader));
                        break;
                    case 5:
                        builder.m20331tx(ProtoAdapter.FLOAT.decode(protoReader));
                        break;
                    case 6:
                        builder.m20332ty(ProtoAdapter.FLOAT.decode(protoReader));
                        break;
                    default:
    ...
    public boolean equals(Object obj) {
        ...
        return unknownFields().equals(transform.unknownFields()) && Internal.equals(this.f14734a, transform.f14734a) && Internal.equals(this.f14735b, transform.f14735b) && Internal.equals(this.f14736c, transform.f14736c) && Internal.equals(this.f14737d, transform.f14737d) && Internal.equals(this.f14738tx, transform.f14738tx) && Internal.equals(this.f14739ty, transform.f14739ty);
    }
    ...
    public Builder newBuilder() {
        Builder builder = new Builder();
        builder.f14740a = this.f14734a;
        builder.f14741b = this.f14735b;
        builder.f14742c = this.f14736c;
        builder.f14743d = this.f14737d;
        builder.f14744tx = this.f14738tx;
        builder.f14745ty = this.f14739ty;
    ...
    public String toString() {
        ...
        if (this.f14738tx != null) {
            sb.append(", tx=");
            sb.append(this.f14738tx);
        }
        if (this.f14739ty != null) {
            sb.append(", ty=");
            sb.append(this.f14739ty);
        }
