...
public final class Layout extends Message<Layout, Builder> {
    ...
    public final Float f14712x;

    /* JADX INFO: renamed from: y */
    @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 2)
    public final Float f14713y;
    ...
    public static final class Builder extends Message.Builder<Layout, Builder> {
        ...
        public Layout build() {
            return new Layout(this.f14714x, this.f14715y, this.width, this.height, super.buildUnknownFields());
        }
        ...
        /* JADX INFO: renamed from: x */
        public Builder m20316x(Float f) {
            this.f14714x = f;
            return this;
        }

        /* JADX INFO: renamed from: y */
        public Builder m20317y(Float f) {
            this.f14715y = f;
            return this;
        }
    }
    ...
    public static final class ProtoAdapter_Layout extends ProtoAdapter<Layout> {
        ...
        public Layout decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag == 1) {
                    builder.m20316x(ProtoAdapter.FLOAT.decode(protoReader));
                } else if (iNextTag == 2) {
                    builder.m20317y(ProtoAdapter.FLOAT.decode(protoReader));
                } else if (iNextTag == 3) {
        ...
        @Override // com.squareup.wire.ProtoAdapter
        public Layout redact(Layout layout) throws EOFException {
    ...
    public boolean equals(Object obj) {
        ...
        return unknownFields().equals(layout.unknownFields()) && Internal.equals(this.f14712x, layout.f14712x) && Internal.equals(this.f14713y, layout.f14713y) && Internal.equals(this.width, layout.width) && Internal.equals(this.height, layout.height);
    }
    ...
    public Builder newBuilder() {
        Builder builder = new Builder();
        builder.f14714x = this.f14712x;
        builder.f14715y = this.f14713y;
    ...
    public String toString() {
        ...
        if (this.f14712x != null) {
            sb.append(", x=");
            sb.append(this.f14712x);
        }
        if (this.f14713y != null) {
            sb.append(", y=");
            sb.append(this.f14713y);
        }
        if (this.width != null) {
            sb.append(", width=");
