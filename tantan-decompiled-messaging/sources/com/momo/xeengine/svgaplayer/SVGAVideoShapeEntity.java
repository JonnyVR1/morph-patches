...
public final class SVGAVideoShapeEntity {
    ...
    @Metadata(m87230bv = {1, 0, 3}, m87231d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m87232d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Type;", "", "(Ljava/lang/String;I)V", "shape", "rect", "ellipse", "keep", "gift_player_release"}, m87233k = 1, m87234mv = {1, 1, 15})
    public enum Type {
        shape,
        rect,
        ellipse,
    ...
    private final void parseArgs(ShapeEntity obj) {
        ...
        if (rectArgs != null) {
            Float f5 = rectArgs.f14720x;
            if (f5 == null) {
                f5 = fValueOf;
            }
            map.put(BaseSei.f13930X, f5);
            Float f6 = rectArgs.f14721y;
            if (f6 == null) {
                f6 = fValueOf;
            }
