...
public class XETouchDispatcher extends XETouchDispatcherNative implements ITouchEventHandler {
    ...
    public static /* synthetic */ void m20345a(XETouchDispatcher xETouchDispatcher, int i, int[] iArr, float[] fArr, float[] fArr2) {
    ...
    public static /* synthetic */ void m20346b(XETouchDispatcher xETouchDispatcher, int i, int[] iArr, float[] fArr, float[] fArr2) {
        long j = xETouchDispatcher.eventDispatcherIns;
        if (j != 0) {
    ...
    public static /* synthetic */ void m20347c(XETouchDispatcher xETouchDispatcher, int i, int[] iArr, float[] fArr, float[] fArr2) {
        long j = xETouchDispatcher.eventDispatcherIns;
        if (j != 0) {
    ...
    public void handleTouchEvent(MotionEvent motionEvent, float f, float f2) {
        ...
        if (actionMasked != 0) {
                ...
                if (actionMasked == 2) {
                    this.executor.execute(new Runnable() { // from class: l.rcq0
                        ...
                        public final void run() {
                            XETouchDispatcher.m20346b(this.f158807a, pointerCount, iArr, fArr, fArr2);
                        }
                    });
                    return;
            ...
            this.executor.execute(new Runnable() { // from class: l.qcq0
                @Override // java.lang.Runnable
                public final void run() {
                    XETouchDispatcher.m20345a(this.f153787a, pointerCount, iArr, fArr, fArr2);
                }
            });
            return;
        }
        this.executor.execute(new Runnable() { // from class: l.pcq0
            @Override // java.lang.Runnable
            public final void run() {
                XETouchDispatcher.m20347c(this.f148211a, pointerCount, iArr, fArr, fArr2);
            }
        });
    }
