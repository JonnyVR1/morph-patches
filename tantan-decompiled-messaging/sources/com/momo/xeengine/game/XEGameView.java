...
public class XEGameView extends FrameLayout {
    ...
    public class C41813 implements IXEngineSOLoader.LoaderCallback {
        public C41813() {
        }
    ...
    public final class MyRender implements IXRender {
        ...
        public static /* synthetic */ void m20236a(MyRender myRender, String str) {
        ...
        public void onGLEnvCreatedFailed(final String str) {
            XEGameView.this.mHandler.post(new Runnable() { // from class: com.momo.xeengine.game.c
                @Override // java.lang.Runnable
                public final void run() {
                    XEGameView.MyRender.m20236a(this.f14577a, str);
                }
            });
        }
    ...
    public XEGameView(Context context) {
        ...
        this.mLoaderCallback = new C41813();
        this.viewSafeArea = null;
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m20233a(XEGameView xEGameView) {
        GameEngine gameEngine;
    ...
    public static /* synthetic */ void m20234b(XEGameView xEGameView) {
        GameEngine gameEngine;
        MyRender myRender = xEGameView.mRender;
        if (myRender == null || (gameEngine = myRender.engine) == null) {
            return;
    ...
    public void pause() {
        ...
        if (xEngineRenderThread != null) {
            xEngineRenderThread.queueEvent(new Runnable() { // from class: l.hcq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEGameView.m20234b(this.f107094a);
                }
            });
        }
    }
    ...
    public void resume() {
        ...
        if (xEngineRenderThread != null) {
            xEngineRenderThread.queueEvent(new Runnable() { // from class: l.gcq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEGameView.m20233a(this.f102047a);
                }
            });
        }
    }
    ...
    public void setPreferredFramesPerSecond(int i) {
        if (i >= 0) {
            ...
            ig3.m135964a("preferredFramesPerSecond must >= 0");
        }
    }

    public void setRenderScale(float f) {
        if (f <= 0.0f) {
            ig3.m135964a("renderScale must >= 0");
            return;
        }
        this.renderScale = f;
    ...
    public void setRenderViewType(int i) {
        if (i != TYPE_SURFACE_VIEW && i != TYPE_TEXTURE_VIEW) {
            ig3.m135964a("RenderViewType only support TYPE_SURFACE_VIEW or TYPE_TEXTURE_VIEW");
        } else if (this.glSurfaceView == null && this.glTextureView == null) {
            this.renderViewType = i;
        } else {
            ig3.m135964a("RenderViewType can set before start only");
        }
    }
