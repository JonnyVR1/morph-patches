...
final class XEngineRenderThread extends Thread {
    ...
    public static /* synthetic */ void m20240a(XEngineRenderThread xEngineRenderThread, int i, int i2) {
    ...
    public static /* synthetic */ void m20241b(XEngineRenderThread xEngineRenderThread, Object obj, AtomicBoolean atomicBoolean) {
    ...
    public static /* synthetic */ void m20242c(XEngineRenderThread xEngineRenderThread, AtomicBoolean atomicBoolean) {
    ...
    public void destroyNativeWindow() {
        ...
        this.mEventQueue.add(new Runnable() { // from class: com.momo.xeengine.game.f
            ...
            public final void run() {
                XEngineRenderThread.m20242c(this.f14585a, atomicBoolean);
            }
        });
    }
    ...
    public void onSizeChanged(final int i, final int i2) {
        this.mEventQueue.add(new Runnable() { // from class: com.momo.xeengine.game.e
            @Override // java.lang.Runnable
            public final void run() {
                XEngineRenderThread.m20240a(this.f14582a, i, i2);
            }
        });
    }
    ...
    public void resetNativeWindow(final Object obj) {
        ...
        this.mEventQueue.add(new Runnable() { // from class: com.momo.xeengine.game.d
            @Override // java.lang.Runnable
            public final void run() {
                XEngineRenderThread.m20241b(this.f14579a, obj, atomicBoolean);
            }
        });
    }
