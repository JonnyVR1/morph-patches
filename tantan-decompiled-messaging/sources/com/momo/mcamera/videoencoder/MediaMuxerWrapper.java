...
public class MediaMuxerWrapper {
    ...
    public void addEncoder(MediaEncoder mediaEncoder) {
        MDLog.m7395i(MDLogTag.MEDIA_MUXER_TAG, "MediaMuxerWrapper addEncoder");
        if (!(mediaEncoder instanceof MediaVideoEncoder)) {
            ig3.m135964a("unsupported encoder");
        } else if (this.mVideoEncoder != null) {
            ig3.m135964a("Video encoder already added.");
        } else {
    ...
    public void prepare(ProcessSurface processSurface, MediaFormat mediaFormat) throws IOException {
        MDLog.m7395i(MDLogTag.MEDIA_MUXER_TAG, "MediaMuxerWrapper prepare");
    ...
    public void prepareAudio(ProcessSurface processSurface, MediaFormat mediaFormat) throws IOException {
        MDLog.m7395i(MDLogTag.MEDIA_MUXER_TAG, "MediaMuxerWrapper prepareAudio");
    ...
    public void prepareVideo(ProcessSurface processSurface, MediaFormat mediaFormat) throws IOException {
        MDLog.m7395i(MDLogTag.MEDIA_MUXER_TAG, "MediaMuxerWrapper prepareVideo");
        MediaEncoder mediaEncoder = this.mVideoEncoder;
        if (mediaEncoder != null) {
            mediaEncoder.prepare(processSurface, mediaFormat);
        }
    ...
    public void startRecording() {
        MDLog.m7395i(MDLogTag.MEDIA_MUXER_TAG, "MediaMuxerWrapper startRecording");
        MediaEncoder mediaEncoder = this.mVideoEncoder;
        if (mediaEncoder != null) {
    ...
    public void stopRecording() {
        MDLog.m7395i(MDLogTag.MEDIA_MUXER_TAG, "MediaMuxerWrapper stopRecording");
        MediaEncoder mediaEncoder = this.mVideoEncoder;
        if (mediaEncoder != null) {
