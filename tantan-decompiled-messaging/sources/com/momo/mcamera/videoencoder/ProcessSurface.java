...
public class ProcessSurface {
            ...
            do {
                ...
                synchronized (ProcessSurface.this.mFrameSyncObject) {
                    ...
                    if (ProcessSurface.this.mFrameAvailable) {
                        ...
                        int i = this.f14259i;
                        if (i > 3) {
                            this.f14260t = (int) (((long) this.f14260t) + (jNanoTime - this.oldnow));
                            this.count++;
                        }
                        if (i > 20) {
                            long j = ((long) this.f14260t) / this.count;
                            if (j > 0) {
    ...
    public void addMediaCodecSurface_l(Surface surface) {
        synchronized (this.mActiviteSyncObject) {
            if (surface != null) {
                try {
                    this.mCodecSurfaceManager = new v1h0(surface, 2, this.mEGLContext, null);
                } catch (Throwable th) {
                    throw th;
                }
            }
    ...
    public void drawImage() {
        ...
        if (this.mCodecSurfaceManager != null) {
            ...
            if (!this.mDropFrame && !this.shouldDrop.get()) {
                this.mCodecSurfaceManager.m196639c();
                this.mTextureRender.drawScreenFrame();
                this.mCodecSurfaceManager.m196641e();
            }
    ...
    public void removeMediaCodecSurface_l() {
        synchronized (this.mActiviteSyncObject) {
            try {
                v1h0 v1h0Var = this.mCodecSurfaceManager;
                if (v1h0Var != null) {
                    v1h0Var.m196640d();
    ...
    public void selectFilter_l() {
        ...
        if (processRender != null && (ts2Var = this.mFilterWrap) != null) {
            processRender.selectFilter(ts2Var);
        }
        this.mNeedSetFilter = false;
    }
    ...
    private void setup() {
        if (this.mTextureRender == null) {
            ProcessRender processRender = new ProcessRender(new cn40(), this, this.mProcessParam);
    ...
    public synchronized void addFilterToDestory(ts2 ts2Var) {
        synchronized (this.mActiviteSyncObject) {
            try {
                ProcessRender processRender = this.mTextureRender;
                if (processRender != null) {
                    processRender.addFilterToDestory(ts2Var);
                }
    ...
    public synchronized void selectFilter(Context context, ts2 ts2Var) {
        switchFilterTo(context, ts2Var);
    }
    ...
    public void switchFilterTo(Context context, ts2 ts2Var) {
        synchronized (this.mActiviteSyncObject) {
            try {
                try {
                    this.mFilterWrap = ts2Var;
