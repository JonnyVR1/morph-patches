...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    public static final int selectColorFormat(MediaCodecInfo mediaCodecInfo, String str) {
        try {
            ...
            if (i == 0) {
                MDLog.m7395i(MDLogTag.MEDIA_ENCODER_TAG, "MediaVideoEncoder couldn't find a good color format for " + mediaCodecInfo.getName() + " / " + str);
            }
            return i;
        } catch (Throwable th) {
            Thread.currentThread().setPriority(5);
    ...
    public void prepare(ProcessSurface processSurface, MediaFormat mediaFormat) throws IOException {
        ...
        if (mediaEncoderListener != null) {
            try {
                ...
                MDLog.m7396i(MDLogTag.MEDIA_ENCODER_TAG, "MediaVideoEncoder prepare:", e);
            }
        }
    }
