...
public class MultiStickerCutFaceMaskFilter extends MultiStickerMaskFilter {
    ...
    @Override // com.momo.mcamera.mask.MultiStickerMaskFilter, p149l.mcj
    public void drawSub() {
        boolean z;
        Iterator<float[]> it;
                ...
                try {
                    ...
                    if (list == null || list.size() <= 0 || !stickerItem3.isDraw) {
                        ...
                        if (stickerItem3 instanceof StickerETC1Item) {
                            ...
                            vjw mmcvImage = stickerItem3.getMmcvImage(this.context);
    ...
    @Override // com.momo.mcamera.mask.MultiStickerMaskFilter, p149l.ccj
    ...
    public void setMMCVInfo(pjw pjwVar) {
        ...
        if (this.mCutFaceItem != null && pjwVar.m169950n() > 0) {
            float[] fArrM220018l = pjwVar.m169946j(0).m220018l();
            this.mRadius = (((float) PointHelper.getmDistancePoint(new PointF(fArrM220018l[18], fArrM220018l[86]), new PointF(fArrM220018l[10], fArrM220018l[78]))) * 1.1f) / 2.0f;
            this.mPointF = new PointF(fArrM220018l[29], fArrM220018l[97]);
        }
        for (int iM169950n = pjwVar.m169950n() - 1; iM169950n >= 0; iM169950n--) {
            float fM220015f = pjwVar.m169946j(iM169950n).m220015f();
            ...
            updateFaceInfo(pjwVar, fM220015f, pjwVar.m169946j(iM169950n).m220018l(), true);
        }
    }
