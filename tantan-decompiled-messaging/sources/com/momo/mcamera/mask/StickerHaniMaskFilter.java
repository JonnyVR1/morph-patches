...
public class StickerHaniMaskFilter extends FaceDetectFilter implements q7m {
    ...
    private vjw decodeOneFrameByImage(String str) {
    ...
    public void drawSub() {
        ...
        PointF pointF = new PointF(faceDetectParam2.f14243cX, faceDetectParam2.f14244cY);
    ...
    public void newTextureReady(int i, mcj mcjVar, boolean z) {
        ...
        if (!stickerHaniMaskFilter.lockTexture || stickerHaniMaskFilter.texture_in <= 0 || stickerHaniMaskFilter.mvpMatrix == null) {
            if (stickerHaniMaskFilter.mvpMatrix != null) {
                vjw vjwVarDecodeOneFrameByImage = stickerHaniMaskFilter.decodeOneFrameByImage(stickerHaniMaskFilter.sticker.getImagePathByIndex(stickerHaniMaskFilter.context, stickerHaniMaskFilter.stickerIndex));
                if (vjwVarDecodeOneFrameByImage != null) {
                    stickerHaniMaskFilter.curMMCVImage = vjwVarDecodeOneFrameByImage;
                    z2 = true;
                } else {
                    z2 = false;
                }
                vjw vjwVar = stickerHaniMaskFilter.curMMCVImage;
                if (vjwVar == null || vjwVar == null || vjwVar.m198688a().length <= 0) {
                    if (stickerHaniMaskFilter.curMMCVImage != null) {
                        stickerHaniMaskFilter.curMMCVImage = null;
                    }
                    if (vjwVarDecodeOneFrameByImage != null || stickerHaniMaskFilter.imageDelegateProvider == null) {
                    ...
                    vjw vjwVar2 = stickerHaniMaskFilter.curMMCVImage;
                    if (i3 == 0) {
                        stickerHaniMaskFilter.texture_in = TextureHelper.bitmapToTexture(vjwVar2);
                    } else {
                        stickerHaniMaskFilter.texture_in = TextureHelper.loadDataToTexture(i3, vjwVar2);
                    }
                }
            } else {
        ...
        stickerHaniMaskFilter.setWidth(mcjVar.getWidth());
        stickerHaniMaskFilter.setHeight(mcjVar.getHeight());
    ...
    public void setDetectParam(FaceDetectFilter.FaceDetectParam faceDetectParam) {
        synchronized (getLockObject()) {
            ...
            faceDetectParam2.f14243cX = pointF.x;
            faceDetectParam2.f14244cY = pointF.y;
