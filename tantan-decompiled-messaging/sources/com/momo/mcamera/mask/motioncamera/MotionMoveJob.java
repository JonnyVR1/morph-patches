...
public class MotionMoveJob extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void onAnimationCancel(Animator animator) {
        ...
        MDLog.m7389d(MotionCameraFilterAdapter.MotionFilterTAG, "onAnimationCancel.");
    ...
    public void onAnimationEnd(Animator animator) {
        ...
        MDLog.m7389d(MotionCameraFilterAdapter.MotionFilterTAG, "onAnimationEnd.");
        removeAnimAllListener();
    }
    ...
    public void onAnimationStart(Animator animator) {
        ...
        MDLog.m7389d(MotionCameraFilterAdapter.MotionFilterTAG, "onAnimationStart.");
    }
    ...
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        MDLog.m7389d(MotionCameraFilterAdapter.MotionFilterTAG, "onAnimationUpdate 四个值都更新完，可以做一次绘制. rectF=" + this.dstRectF.toShortString());
    ...
    public void start(float f, RectF rectF, RectF rectF2) {
        ...
        MDLog.m7389d(MotionCameraFilterAdapter.MotionFilterTAG, "MotionMoveJob start, duration=" + f2 + ", rect=" + rectF.toShortString() + ", dstRect=" + rectF2.toShortString());
