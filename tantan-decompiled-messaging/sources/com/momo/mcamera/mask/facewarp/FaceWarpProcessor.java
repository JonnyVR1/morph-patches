...
public class FaceWarpProcessor {
    ...
    private BeautyWarpParams buildParams(pjw pjwVar, SingleFaceInfo[] singleFaceInfoArr) {
        ...
        pjwVar.m169936B(beautyWarpParams);
    ...
    private synchronized void processSingleWarpPoint(pjw pjwVar, SingleFaceInfo[] singleFaceInfoArr, FaceAttribute[] faceAttributeArr) {
        float[] fArr;
        float[] fArr2;
        try {
            BeautyWarpParams beautyWarpParamsBuildParams = buildParams(pjwVar, singleFaceInfoArr);
            int i = this.warpType;
            if (i == 103 || i == 104) {
            ...
            if (ftf.m123031a().m123032b(beautyWarpParamsBuildParams, this.warpInfo)) {
                ...
                if (fArr3 != null || beautyWarpInfo2.all_dst_warp_points_ != null || (fArr = beautyWarpInfo2.src_warp_points_) == null || (fArr2 = beautyWarpInfo2.dst_warp_points_) == null) {
                    pjwVar.f149910q = fArr3;
                    pjwVar.f149911r = beautyWarpInfo2.all_dst_warp_points_;
                } else {
                    int[] iArr = {1, fArr.length};
                    Class cls = Float.TYPE;
                    pjwVar.f149910q = (float[][]) Array.newInstance((Class<?>) cls, iArr);
                    float[][] fArr4 = (float[][]) Array.newInstance((Class<?>) cls, 1, fArr2.length);
                    pjwVar.f149911r = fArr4;
                    pjwVar.f149910q[0] = fArr;
                    fArr4[0] = fArr2;
                }
                pjwVar.f149917x = this.warpInfo.liquefy_info;
    ...
    public void loadWrapConfig(String str) {
        ftf.m123031a().m123033c(str);
    }

    public void process(pjw pjwVar) {
        if (pjwVar == null || pjwVar.m169950n() <= 0) {
            return;
        }
        XCameraWarpLevelParams[] xCameraWarpLevelParamsArr = this.xCameraWarpParams;
        if (xCameraWarpLevelParamsArr == null || xCameraWarpLevelParamsArr.length < pjwVar.m169950n()) {
            this.xCameraWarpParams = new XCameraWarpLevelParams[pjwVar.m169950n()];
            this.warpLevel1Array = new float[pjwVar.m169950n()];
            this.warpLevel2Array = new float[pjwVar.m169950n()];
        }
        SingleFaceInfo[] singleFaceInfoArr = pjwVar.m169955s().facesinfo_;
        FaceAttribute[] faceAttributeArr = pjwVar.m169955s().faces_attributes_;
        if (this.warpType == 10) {
            SingleFaceInfo[] singleFaceInfoArr2 = {pjwVar.m169955s().facesinfo_[0]};
            FaceAttribute[] faceAttributeArr2 = {pjwVar.m169955s().faces_attributes_[0]};
        ...
        processSingleWarpPoint(pjwVar, singleFaceInfoArr, faceAttributeArr);
    }

    public void release() {
        ftf.m123031a().m123034d();
