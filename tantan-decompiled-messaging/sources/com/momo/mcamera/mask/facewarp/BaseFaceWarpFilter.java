...
public abstract class BaseFaceWarpFilter extends ts2 implements etf, IFaceWarp {
    protected pjw mmcvInfo;
    private FloatBuffer texCoordBuffer;
    private FloatBuffer vertexBuffer;
    private rbj warpFrameBuffer;
    ...
    private void drawMultiFace() {
        float[] fArr;
        float[] fArr2;
        int iM169950n = this.mmcvInfo.m169950n();
        VideoInfo videoInfoM169955s = this.mmcvInfo.m169955s();
        int i = 0;
        for (int i2 = 0; i2 < iM169950n; i2++) {
            SingleFaceInfo singleFaceInfo = videoInfoM169955s.facesinfo_[i2];
            FaceAttribute faceAttribute = videoInfoM169955s.faces_attributes_[i2];
            ...
            if (warpPointProcessSingleWarpPoint != null && (fArr = warpPointProcessSingleWarpPoint.srcPoints) != null && (fArr2 = warpPointProcessSingleWarpPoint.dstPoints) != null && fArr.length > 0 && fArr2.length > 0) {
                ...
                copyToFrameBuffer(this.warpFrameBuffer.m178610i()[0]);
                i++;
                clearPoints();
    ...
    private void drawSingleFace() {
        float[] fArr;
        float[] fArr2;
        SingleFaceInfo singleFaceInfo = this.mmcvInfo.m169955s().facesinfo_[0];
        FaceAttribute faceAttribute = this.mmcvInfo.m169955s().faces_attributes_[0];
        WarpPoint warpPointProcessSingleWarpPoint = processSingleWarpPoint(singleFaceInfo);
        if (warpPointProcessSingleWarpPoint == null || (fArr = warpPointProcessSingleWarpPoint.srcPoints) == null || (fArr2 = warpPointProcessSingleWarpPoint.dstPoints) == null || fArr.length <= 0 || fArr2.length <= 0) {
            this.isWarpFailed = true;
            super.drawSub();
    ...
    private void drawWarpFrame(int i, WarpPoint warpPoint) {
        rbj rbjVar = this.warpFrameBuffer;
        if (rbjVar == null || rbjVar.m178609h() == null || this.warpFrameBuffer.m178608g() != getWidth() || this.warpFrameBuffer.m178607f() != getHeight()) {
        ...
        GLES20.glBindFramebuffer(36160, this.warpFrameBuffer.m178609h()[0]);
    ...
    public abstract BeautyWarpParams buildParams(pjw pjwVar, SingleFaceInfo singleFaceInfo);
    ...
    public WarpPoint processSingleWarpPoint(SingleFaceInfo singleFaceInfo) {
        if (ftf.m123031a().m123032b(buildParams(this.mmcvInfo, singleFaceInfo), this.warpInfo)) {
            WarpPoint warpPoint = this.warpPoint;
            BeautyWarpInfo beautyWarpInfo = this.warpInfo;
