...
public class ByteDanceSegmentHelper {
    ...
    private static boolean checkLicense() {
        if (!TextUtils.isEmpty(modelPath) && !TextUtils.isEmpty(licensePath)) {
            ...
            if (portraitMatting.init(ev0.m118233a(), modelPath, EffectsSDKEffectConstants.PortraitMatting.BEF_PORTAITMATTING_SMALL_MODEL, licensePath) == 0) {
                return true;
            }
        }
        return false;
    ...
    public static PortraitMatting.MattingMask process(byte[] bArr, int i, int i2, int i3, boolean z) {
        ...
        if (z) {
            YUVUtils.YUV2RGBA(bArr, byteBufferAllocateDirect.array(), value, i2, i, i6, i7, EffectsSDKEffectConstants.Rotation.CLOCKWISE_ROTATE_270.f5853id, true);
        } else {
            YUVUtils.YUV2RGBA(bArr, byteBufferAllocateDirect.array(), value, i2, i, i6, i7, EffectsSDKEffectConstants.Rotation.CLOCKWISE_ROTATE_90.f5853id, false);
        }
        if (i3 == 90) {
