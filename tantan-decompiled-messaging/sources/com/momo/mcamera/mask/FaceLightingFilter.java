...
public class FaceLightingFilter extends FaceDetectFilter {
    ...
    public String getFragmentShader() {
        int i = C40281.f14245xcb10be36[this.version.ordinal()];
        if (i != 1) {
    ...
    public void setMMCVInfo(pjw pjwVar) {
        ...
        if (iArrM220029w == null || iArrM220029w.length < 6) {
            int[] iArr = this.skinDefaultRGB;
            iArr[0] = 128;
            iArr[1] = 128;
            iArr[2] = 128;
        ...
        iArr2[0] = iArrM220029w[6];
        iArr2[1] = iArrM220029w[7];
        iArr2[2] = iArrM220029w[8];
    }
