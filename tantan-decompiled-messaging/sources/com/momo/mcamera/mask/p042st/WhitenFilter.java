package com.momo.mcamera.mask.p042st;

import android.content.Context;

/* JADX INFO: loaded from: classes7.dex */
public class WhitenFilter extends RuddyFilter {
    public WhitenFilter(Context context) {
        super(context);
    }

    @Override // com.momo.mcamera.mask.p042st.RuddyFilter, p149l.ccj
