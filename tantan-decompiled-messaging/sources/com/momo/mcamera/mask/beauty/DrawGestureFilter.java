...
public class DrawGestureFilter extends DrawBodyWarpSrcFilter {
    @Override // com.momo.mcamera.mask.beauty.body.DrawBodyWarpSrcFilter, p149l.mcj
    public void drawSub() {
        super.drawSub();
    ...
    public void updateFaceInfo(pjw pjwVar) {
        ...
        for (int i = 0; i < iM169950n; i++) {
            ObjectDetectInfo objectDetectInfo = pjwVar.f149889G;
            if (objectDetectInfo != null && (mMBoxArr = objectDetectInfo.detect_results_) != null && mMBoxArr.length >= 1) {
                ...
                fArr[0] = mMBox.f14764x_;
                fArr[1] = mMBox.f14765y_;
                fArr[2] = mMBox.width_;
