...
public class LightningEngineFilter extends FaceDetectFilter {
    ...
    private void get3DRenderImage() {
        ...
        byteBufferAllocate.position(0);
        this.isCapture = false;
        C3804c.m18444d(2, new Runnable() { // from class: com.momo.mcamera.mask.LightningEngineFilter.1
            @Override // java.lang.Runnable
            public void run() {
                Rect rect2 = LightningEngineFilter.this.mCaptureRect;
                LightningEngineFilter lightningEngineFilter = LightningEngineFilter.this;
                Bitmap bitmapCreateBitmap = rect2 != null ? Bitmap.createBitmap(lightningEngineFilter.cropWidth, LightningEngineFilter.this.cropHeight, Bitmap.Config.ARGB_8888) : Bitmap.createBitmap(((ccj) lightningEngineFilter).width, ((ccj) LightningEngineFilter.this).height, Bitmap.Config.ARGB_8888);
                ...
                if (LightningEngineFilter.this.mCapture3DImageListener != null) {
                    ...
                    Rect rect3 = LightningEngineFilter.this.mCaptureRect;
                    LightningEngineFilter lightningEngineFilter2 = LightningEngineFilter.this;
                    LightningEngineFilter.this.mCapture3DImageListener.get3DRenderImage(rect3 != null ? Bitmap.createBitmap(bitmapCreateBitmap, 0, 0, lightningEngineFilter2.cropWidth, LightningEngineFilter.this.cropHeight, matrix, true) : Bitmap.createBitmap(bitmapCreateBitmap, 0, 0, ((ccj) lightningEngineFilter2).width, ((ccj) LightningEngineFilter.this).height, matrix, true));
                }
            }
        });
    }
    ...
    public void setMMCVInfo(pjw pjwVar, int i, boolean z) {
        ...
        if (lightningEngineHelper != null) {
            ...
            if (pjwVar.f149884B) {
                boolean zIntercept = this.cartoonMutex.intercept();
                LightningEngineHelper lightningEngineHelper2 = this.engineHelper;
                if (zIntercept) {
                    lightningEngineHelper2.setBodyWarpInfo(null);
                } else {
                    lightningEngineHelper2.setBodyWarpInfo(pjwVar);
                }
            }
            boolean zDoProcess = this.cartoonMutex.doProcess();
            CartoonProcess cartoonProcess = this.cartoonProcess;
            if (zDoProcess) {
                this.engineHelper.setCartoonFaceInfo(pjwVar, cartoonProcess.process(pjwVar, i, z));
            } else {
                cartoonProcess.delayRelease();
                this.engineHelper.setCartoonFaceInfo(pjwVar, null);
            }
            CartoonfaceInfo cartoonfaceInfo = pjwVar.f149890H;
            if (cartoonfaceInfo != null) {
                this.engineHelper.setCryingFaceInfo(cartoonfaceInfo, pjwVar.f149894a);
            }
            StylizefaceInfo stylizefaceInfo = pjwVar.f149891I;
            if (stylizefaceInfo != null) {
                this.engineHelper.setStylizeFaceInfo(stylizefaceInfo, pjwVar.f149894a);
            }
            if (!"default".equals(pjwVar.f149893K)) {
                this.engineHelper.setQRCodeInfo(pjwVar.f149893K);
            }
            ArDetectInfo arDetectInfo = pjwVar.f149892J;
            if (arDetectInfo != null) {
                this.engineHelper.setARGift(arDetectInfo);
            }
        }
        ILightningRender iLightningRender = this.lightningRender;
        if (iLightningRender != null && iLightningRender.getEventDispatcher() != null) {
