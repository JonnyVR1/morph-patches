    ...
    public synchronized void setMMCVInfo(pjw pjwVar) {
        try {
            if (this.objectDetector != null && this.objectDetectOpened.get()) {
                this.objectDetector.setMMCVInfo(pjwVar);
            }
            if (this.gestureDetector != null && this.gestureDetectOpened.get()) {
                this.gestureDetector.setMMCVInfo(pjwVar);
            }
            if (this.expressDetector != null && this.expressDetectOpened.get()) {
                this.expressDetector.setMMCVInfo(pjwVar);
            }
            if (this.pickNoiseOpen) {
                HandDetectLandmarkPostInfo handDetectLandmarkPostInfoProcess = this.pickNoseDetector.process(pjwVar);
