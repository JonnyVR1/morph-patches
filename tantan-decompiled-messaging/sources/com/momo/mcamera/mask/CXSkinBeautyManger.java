...
public class CXSkinBeautyManger {
    ...
    public static /* synthetic */ class C40251 {
    ...
    public BaseSkinComposeFilter getSkinBeautyFilter() {
        int i = C40251.$SwitchMap$com$momo$mcamera$mask$VersionType$CXSkinVersion[this.mCXSkinVersion.ordinal()];
        if (i == 1) {
