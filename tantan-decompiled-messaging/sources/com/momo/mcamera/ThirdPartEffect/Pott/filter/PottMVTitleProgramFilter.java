...
public class PottMVTitleProgramFilter extends PottMVFilter {
    ...
    private void initAllProgram() {
        ...
        int i = 0;
        this.stickerItemGeomeAttrInfo = new StickerItemGeomeAttrInfo(this.model.getStickers().get(0), g16.f100119a);
    ...
    @Override // com.momo.mcamera.ThirdPartEffect.Pott.filter.PottMVFilter, p149l.mcj, p149l.ccj
    public void destroy() {
        super.destroy();
        this.model = null;
    ...
    @Override // com.momo.mcamera.ThirdPartEffect.Pott.filter.PottMVFilter, p149l.mcj
    ...
    public void onDrawPrograms() {
        ...
        if (this.nomralForCountry.getFrameTexture() != null && this.nomralForCountry.getAlphaValue() > 0.0f) {
            ...
            rbj rbjVar = new rbj(frameWidth2, frameHeight2);
            rbjVar.m178603b(frameWidth2, frameHeight2);
            ...
            GLES20.glBindFramebuffer(36160, rbjVar.m178609h()[0]);
            ...
            this.nomralForCountry.updateInputeTexture(new int[]{rbjVar.m178610i()[0]});
            drawTexture(this.normal, this.nomralForCountry);
        }
        super.onDrawPrograms();
    }

    @Override // com.momo.mcamera.ThirdPartEffect.Pott.filter.PottMVFilter, p149l.q7m
