...
public class FullscreenStickerRenderProgram extends n23 {
    Context context;
    int inputexture = 0;
    ...
    public void passShaderValues(int[] iArr) {
        vjw mmcvImage = this.stickerItem.getMmcvImage(this.context);
        this.geometryAttrInfo.updateBitmapInfo(mmcvImage.m198692e(), mmcvImage.m198690c());
