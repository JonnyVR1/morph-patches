...
public class PottMVTitleProgramGroup extends EsTemplateProgramGroup {
    ...
    public void drawGroup() {
        ...
        if (stickerSlidingGeomAttrInfoArr == null || this.nomralForCountry == null) {
            MDLog.m7391e(MDLogTag.FILTER_TAG, "Parse Config failed !!!");
            super.drawGroup();
            return;
        }
        ...
        if (this.countryBuffer == null) {
            this.countryBuffer = new rbj(i, i2);
            int[] iArr = new int[1];
            GLES20.glGetIntegerv(36006, iArr, 0);
            this.countryBuffer.m178603b(i, i2);
            this.nomralForCountry.updateInputeTexture(new int[]{this.countryBuffer.m178610i()[0]});
        ...
        if (this.nomralForCountry.getFrameTexture() != null && this.nomralForCountry.getAlphaValue() > 0.0f) {
            ...
            char c2 = c;
            int[] iArr4 = iArr3;
            GLES20.glBindFramebuffer(36160, this.countryBuffer.m178609h()[0]);
    ...
    public boolean onParseLayers(LottieConfig lottieConfig, Layers layers, AssetValue assetValue) {
        ...
        if (layerName.equalsIgnoreCase("head")) {
            ...
            if (layerName.equalsIgnoreCase("numbers")) {
                ...
                MaskModel mask = MaskStore.getInstance().getMask(ev0.m118233a(), this.baseFolder + "/" + assetValue.getFolderPath());
                ...
                addRunerTask(this.normal, new StickerItemGeomeAttrInfo(this.stickerMaskmodel.getStickers().get(0), g16.f100119a));
            }
        }
        return true;
    }
