    ...
    public boolean onParseLayers(LottieConfig lottieConfig, Layers layers, AssetValue assetValue) {
        ...
        if (layerName.equalsIgnoreCase("userhead")) {
            ...
            if (zEqualsIgnoreCase) {
                MaskModel mask = MaskStore.getInstance().getMask(ev0.m118233a(), str + "/" + assetValue.getFolderPath());
                ...
                lottieMMFrameGeomeAttrInfo = new StickerItemGeomeAttrInfo(mask.getStickers().get(0), g16.f100119a);
            } else {
