...
public class Timepoint implements Parcelable, Comparable<Timepoint> {
    public static final Parcelable.Creator<Timepoint> CREATOR = new C14689a();
    private int hour;
    private int minute;
    private int second;
    ...
    public class C14689a implements Parcelable.Creator<Timepoint> {
    ...
    public boolean equals(Object obj) {
        try {
            ...
            return timepoint.m85237b() == this.hour && timepoint.m85238f() == this.minute && timepoint.m85239g() == this.second;
    ...
    public boolean m85240h() {
        return this.hour < 12;
    }

    /* JADX INFO: renamed from: i */
    public boolean m85241i() {
        int i = this.hour;
        return i >= 12 && i < 24;
    }
