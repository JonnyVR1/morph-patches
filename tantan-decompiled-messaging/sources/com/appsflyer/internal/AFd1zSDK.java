...
public final class AFd1zSDK implements AFc1eSDK {
    ...
    public final void getRevenue() {
        ...
        if (getCurrencyIso4217Code() && (context = this.getCurrencyIso4217Code.getCurrencyIso4217Code) != null) {
            ...
            try {
                C1577c c1577c = C1577c.INSTANCE;
                C1577c.class.getMethod("sdkInitialize", Context.class).invoke(null, context);
                String str = sw0.f166604g;
                Method method = sw0.class.getMethod("fetchDeferredAppLinkData", Context.class, String.class, sw0.InterfaceC20042b.class);
                Object objNewProxyInstance = Proxy.newProxyInstance(sw0.InterfaceC20042b.class.getClassLoader(), new Class[]{sw0.InterfaceC20042b.class}, new InvocationHandler() { // from class: com.appsflyer.internal.AFa1rSDK.3
