...
public final class AFf1iSDK extends AFf1wSDK<Map<String, Object>> {
    ...
    private static Map<String, Object> m5234u_(Uri uri) {
    ...
    public final AFe1dSDK getMonetizationNetwork() throws Exception {
        ...
        if (!AFAdRevenueData(this.component2.toString())) {
            AFb1tSDK.getMonetizationNetwork().m5203h_(this.component1, this.component4, this.component2, null);
        ...
        String str = null;
        while (i < 5) {
            Map<String, Object> mapM5234u_ = m5234u_(Uri.parse(string));
            String str2 = (String) mapM5234u_.get(ShareConstants.RES_PATH);
            Integer num2 = (Integer) mapM5234u_.get(NotificationCompat.CATEGORY_STATUS);
            String str3 = (String) mapM5234u_.get("error");
        ...
        AFb1tSDK.getMonetizationNetwork().m5203h_(this.component1, this.component4, string != null ? Uri.parse(string) : this.component2, this.component2);
        this.component3 = map;
        return AFe1dSDK.SUCCESS;
    }
