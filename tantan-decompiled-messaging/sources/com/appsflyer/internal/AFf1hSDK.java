...
public final class AFf1hSDK extends AFf1oSDK<AFc1jSDK> {
    ...
    public AFf1hSDK(@NotNull AFc1qSDK aFc1qSDK, @NotNull AFd1fSDK aFd1fSDK) {
        ...
        this.copydefault = aFd1mSDKMo5219e;
    ...
    public final AFe1rSDK<AFc1jSDK> AFAdRevenueData(@NotNull String str) {
        ...
        for (AFj1zSDK aFj1zSDK : list) {
            if (aFj1zSDK.component3 == AFj1zSDK.AFa1zSDK.FINISHED) {
                ...
                if (str2 != null) {
                    ...
                    mapMapOf = MapsKt.mapOf(TuplesKt.m87240a("source", (String) obj3), TuplesKt.m87240a("value", str2));
                } else {
                    mapMapOf = null;
                }
            } else {
        ...
        if (strComponent4 != null && !StringsKt.m93438e0(strComponent4)) {
            strComponent4 = "-".concat(String.valueOf(StringsKt.m93433Z0(strComponent4).toString()));
        }
        if (strComponent4 == null) {
            strComponent4 = "";
        }
        String string = StringsKt.m93433Z0(strComponent4).toString();
        ...
        String string2 = AFj1mSDK.m5258L_(builderAppendPath, str3, str4).appendQueryParameter(Constants.JumpUrlConstants.URL_KEY_SDK_VERSION, AFb1tSDK.getRevenue).build().toString();
        string2.getClass();
    ...
    private static Map<String, String> getMediationNetwork(AFb1ySDK aFb1ySDK) {
        ...
        if (bool == null || !bool.booleanValue()) {
            return MapsKt.mapOf(TuplesKt.m87240a("type", "unhashed"), TuplesKt.m87240a("value", str));
        }
        return null;
    }
    ...
    public static final void AFAdRevenueData(AFj1zSDK aFj1zSDK, AFf1hSDK aFf1hSDK, Observable observable, Object obj) {
        ...
        if (observable != null) {
            ...
            jfd0.m141176a("null cannot be cast to non-null type com.appsflyer.internal.referrer.Referrer");
        }
    }
