...
public abstract class AFc1cSDK<T> {
    ...
    public final boolean getRevenue() {
        try {
            ...
            return providerInfoResolveContentProvider != null && Arrays.asList(this.getCurrencyIso4217Code).contains(AFb1vSDK.m5206e_(this.getMediationNetwork.getPackageManager(), ((PackageItemInfo) providerInfoResolveContentProvider).packageName));
