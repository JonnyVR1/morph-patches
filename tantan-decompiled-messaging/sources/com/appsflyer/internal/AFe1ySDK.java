...
public final class AFe1ySDK {
    ...
    public static final Pair<Integer, Integer> AFAdRevenueData(@NotNull String str) {
        ...
        if (matchResultMatchEntire != null) {
            ...
            if (getMonetizationNetwork(intOrNull, intOrNull2, intOrNull3, intOrNull4, intOrNull5, intOrNull6)) {
                ...
                num.getClass();
                return TuplesKt.m87240a(numValueOf, Integer.valueOf(iIntValue4 + num.intValue()));
            }
        }
        return null;
    }
    ...
    public static final Pair<Integer, Integer> getRevenue(@NotNull String str) {
        ...
        if (matchResultMatchEntire != null) {
            ...
            MatchGroup matchGroup2 = matchResultMatchEntire.mo93363b().get(3);
            Integer intOrNull2 = (matchGroup2 == null || (value2 = matchGroup2.getValue()) == null) ? null : StringsKt.toIntOrNull(value2);
            MatchGroup matchGroup3 = matchResultMatchEntire.mo93363b().get(4);
            Integer intOrNull3 = (matchGroup3 == null || (value = matchGroup3.getValue()) == null) ? null : StringsKt.toIntOrNull(value);
            if (intOrNull != null) {
                return TuplesKt.m87240a(Integer.valueOf(intOrNull.intValue() * PlaybackException.CUSTOM_ERROR_CODE_BASE), Integer.valueOf(((intOrNull.intValue() + 1) * PlaybackException.CUSTOM_ERROR_CODE_BASE) - 1));
            }
            if (intOrNull2 != null && intOrNull3 != null) {
                return TuplesKt.m87240a(Integer.valueOf((intOrNull2.intValue() * PlaybackException.CUSTOM_ERROR_CODE_BASE) + (intOrNull3.intValue() * 1000)), Integer.valueOf(((intOrNull2.intValue() * PlaybackException.CUSTOM_ERROR_CODE_BASE) + ((intOrNull3.intValue() + 1) * 1000)) - 1));
            }
        }
        return null;
    }
