...
public final class AFe1aSDK {
    ...
    public class RunnableC09532 implements Runnable {
        public RunnableC09532() {
        }
            ...
            synchronized (AFe1aSDK.this.component1) {
                try {
                    ...
                    if (!AFe1aSDK.this.component1.isEmpty()) {
                        ...
                        aFe1aSDK2.getMonetizationNetwork.submit(aFe1aSDK2.new RunnableC09532());
                    }
                    try {
                        AFLogger.INSTANCE.m5240d(AFg1cSDK.QUEUE, "starting task execution: ".concat(String.valueOf(aFf1wSDKPollFirst)));
                        ...
                        AFLogger.INSTANCE.m5240d(AFg1cSDK.QUEUE, "task was interrupted: ".concat(String.valueOf(aFf1wSDKPollFirst)));
    ...
    public class RunnableC09555 implements Runnable {
        private /* synthetic */ AFf1wSDK getMonetizationNetwork;

        public RunnableC09555(AFf1wSDK aFf1wSDK) {
        ...
        public final void run() {
            ...
            synchronized (AFe1aSDK.this.component1) {
                try {
                    ...
                    if (!AFe1aSDK.this.component1.contains(this.getMonetizationNetwork) && !AFe1aSDK.this.component2.contains(this.getMonetizationNetwork)) {
                        ...
                        if (zAFAdRevenueData) {
                            ...
                            if (zAdd) {
                                ...
                                aFLogger2.m5240d(aFg1cSDK2, sb2.toString());
                        ...
                        if (zAdd) {
                            ...
                            aFLogger3.m5240d(aFg1cSDK3, sb3.toString());
                        }
                        if (!zAdd) {
                            ...
                            aFLogger4.m5247w(aFg1cSDK4, sb4.toString());
                            return;
                        }
                        ...
                        aFLogger5.m5240d(aFg1cSDK5, sb5.toString());
                        for (AFe1eSDK aFe1eSDK : AFe1aSDK.this.getCurrencyIso4217Code) {
                        }
                        AFe1aSDK aFe1aSDK4 = AFe1aSDK.this;
                        aFe1aSDK4.getMonetizationNetwork.submit(aFe1aSDK4.new RunnableC09532());
                        AFe1aSDK aFe1aSDK5 = AFe1aSDK.this;
                    ...
                    aFLogger6.m5240d(aFg1cSDK6, sb6.toString());
                } catch (Throwable th2) {
                    throw th2;
                }
            }
    ...
    public static /* synthetic */ void getRevenue(AFe1aSDK aFe1aSDK) {
        synchronized (aFe1aSDK.component1) {
            try {
                ...
                if (z) {
                    aFe1aSDK.getMonetizationNetwork.submit(aFe1aSDK.new RunnableC09532());
                }
            } catch (Throwable th) {
                throw th;
            }
