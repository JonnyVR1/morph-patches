...
public final class AFi1qSDK extends AFi1wSDK {
    ...
    public final boolean AFAdRevenueData() {
        try {
            ...
            for (NetworkInterface networkInterface : list) {
                if (networkInterface.isUp() && Intrinsics.m87488d(networkInterface.getName(), "tun0")) {
                    return true;
                }
            }
            return false;
    ...
    public final String getMediationNetwork() {
        ...
        if (connectivityManager != null) {
            if (AFi1wSDK.m5257w_(connectivityManager.getNetworkInfo(1))) {
                return "WIFI";
            }
            if (AFi1wSDK.m5257w_(connectivityManager.getNetworkInfo(0))) {
                return "MOBILE";
            }
