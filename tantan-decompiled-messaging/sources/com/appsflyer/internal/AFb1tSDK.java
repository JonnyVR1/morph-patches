...
public final class AFb1tSDK extends AppsFlyerLib {
    ...
    public static /* synthetic */ class C09414 {
    ...
    public AFb1tSDK() {
        ...
        getCurrencyIso4217Code().mo5221v().getMonetizationNetwork();
        getCurrencyIso4217Code().mo5221v().getMediationNetwork();
            ...
            case 10:
                ...
                if (i11 % 2 != 0) {
                    ...
                    if (purchaseHandlerAreAllFieldsValid.getMonetizationNetwork(map, purchaseValidationCallback, strArr)) {
                        ...
                        aFe1aSDK.AFAdRevenueData.execute(aFe1aSDK.new RunnableC09555(aFf1vSDK));
                    ...
                    if (purchaseHandlerAreAllFieldsValid.getMonetizationNetwork(map, purchaseValidationCallback, SchemeKey.subscriptions)) {
                        ...
                        aFe1aSDK2.AFAdRevenueData.execute(aFe1aSDK2.new RunnableC09555(aFf1vSDK2));
                        AFKeystoreWrapper = (values + 31) % 128;
                    }
                }
                return null;
    ...
    */
    private static /* synthetic */ java.lang.Object AFInAppEventParameterName(java.lang.Object[] r6) {
        /*
            r0 = 0
            r6 = r6[r0]
            android.content.Context r6 = (android.content.Context) r6
            int r1 = com.appsflyer.internal.AFb1tSDK.values
            int r1 = r1 + 57
            int r1 = r1 % 128
            com.appsflyer.internal.AFb1tSDK.AFKeystoreWrapper = r1
            r1 = 0
            android.content.pm.PackageManager r2 = r6.getPackageManager()     // Catch: java.lang.Throwable -> L4d
            java.lang.String r3 = r6.getPackageName()     // Catch: java.lang.Throwable -> L4d
            android.content.pm.PackageInfo r2 = r2.getPackageInfo(r3, r0)     // Catch: java.lang.Throwable -> L4d
            android.content.pm.ApplicationInfo r2 = r2.applicationInfo     // Catch: java.lang.Throwable -> L4d
            int r2 = r2.flags     // Catch: java.lang.Throwable -> L4d
            ...
            r5 = 1
            if (r2 < r3) goto L85
            int r2 = com.appsflyer.internal.AFb1tSDK.AFKeystoreWrapper
            int r2 = r2 + 35
            int r3 = r2 % 128
            com.appsflyer.internal.AFb1tSDK.values = r3
            int r2 = r2 % 2
            java.lang.String r3 = "appsflyer_data_extraction_rules"
            if (r2 != 0) goto L4f
            android.content.res.Resources r2 = r6.getResources()     // Catch: java.lang.Throwable -> L4d
            java.lang.String r6 = r6.getPackageName()     // Catch: java.lang.Throwable -> L4d
            int r6 = r2.getIdentifier(r3, r4, r6)     // Catch: java.lang.Throwable -> L4d
            r2 = 60
            int r2 = r2 / r0
            if (r6 == 0) goto L7b
            goto L5d
        ...
        L4f:
            ...
            if (r6 == 0) goto L7b
        L5d:
            int r6 = com.appsflyer.internal.AFb1tSDK.values
            int r6 = r6 + 123
            int r2 = r6 % 128
            com.appsflyer.internal.AFb1tSDK.AFKeystoreWrapper = r2
            int r6 = r6 % 2
            java.lang.String r2 = "appsflyer_data_extraction_rules.xml detected, using AppsFlyer data extraction rules for AppsFlyer SDK data"
            if (r6 == 0) goto L73
            com.appsflyer.AFLogger r6 = com.appsflyer.AFLogger.INSTANCE     // Catch: java.lang.Throwable -> L4d
            com.appsflyer.internal.AFg1cSDK r3 = com.appsflyer.internal.AFg1cSDK.GENERAL     // Catch: java.lang.Throwable -> L4d
            r6.mo5184i(r3, r2, r0)     // Catch: java.lang.Throwable -> L4d
            return r1
        L73:
            com.appsflyer.AFLogger r6 = com.appsflyer.AFLogger.INSTANCE     // Catch: java.lang.Throwable -> L4d
            com.appsflyer.internal.AFg1cSDK r0 = com.appsflyer.internal.AFg1cSDK.GENERAL     // Catch: java.lang.Throwable -> L4d
            r6.mo5184i(r0, r2, r5)     // Catch: java.lang.Throwable -> L4d
            return r1
        L7b:
            com.appsflyer.AFLogger r6 = com.appsflyer.AFLogger.INSTANCE     // Catch: java.lang.Throwable -> L4d
            com.appsflyer.internal.AFg1cSDK r0 = com.appsflyer.internal.AFg1cSDK.GENERAL     // Catch: java.lang.Throwable -> L4d
            java.lang.String r2 = "'allowBackup' is set to true; appsflyer_data_extraction_rules.xml is NOT detected.\nAppsFlyer shared preferences should be excluded from auto backup by adding: <exclude domain=\"sharedpref\" path=\"appsflyer-data\"/> to the Application's <data-extraction-rules> both in <device-transfer> and <cloud-backup>.\nIf Appsflyer's Purchase Connector is in use then you also must add to <device-transfer> and <cloud-backup> the following excludes: <exclude domain=\"sharedpref\" path=\"appsflyer-purchase-data\"/> AND <exclude domain=\"database\" path=\"afpurchases.db\"/>"
            r6.mo5186w(r0, r2, r5)     // Catch: java.lang.Throwable -> L4d
            return r1
        L85:
            android.content.res.Resources r0 = r6.getResources()     // Catch: java.lang.Throwable -> L4d
            java.lang.String r2 = "appsflyer_backup_rules"
            java.lang.String r6 = r6.getPackageName()     // Catch: java.lang.Throwable -> L4d
            int r6 = r0.getIdentifier(r2, r4, r6)     // Catch: java.lang.Throwable -> L4d
            if (r6 == 0) goto L9f
            com.appsflyer.AFLogger r6 = com.appsflyer.AFLogger.INSTANCE     // Catch: java.lang.Throwable -> L4d
            com.appsflyer.internal.AFg1cSDK r0 = com.appsflyer.internal.AFg1cSDK.GENERAL     // Catch: java.lang.Throwable -> L4d
            java.lang.String r2 = "appsflyer_backup_rules.xml detected, using AppsFlyer defined backup rules for AppsFlyer SDK data"
            r6.mo5184i(r0, r2, r5)     // Catch: java.lang.Throwable -> L4d
            return r1
        L9f:
            com.appsflyer.AFLogger r6 = com.appsflyer.AFLogger.INSTANCE     // Catch: java.lang.Throwable -> L4d
            com.appsflyer.internal.AFg1cSDK r0 = com.appsflyer.internal.AFg1cSDK.GENERAL     // Catch: java.lang.Throwable -> L4d
            java.lang.String r2 = "'allowBackup' is set to true; appsflyer_backup_rules.xml is NOT detected.\nAppsFlyer shared preferences should be excluded from auto backup by adding: <exclude domain=\"sharedpref\" path=\"appsflyer-data\"/> to the Application's <full-backup-content> rules.\nIf Appsflyer's Purchase Connector is in use then you also must add the following to your rules: <exclude domain=\"sharedpref\" path=\"appsflyer-purchase-data\"/> AND <exclude domain=\"database\" path=\"afpurchases.db\"/>"
            r6.mo5186w(r0, r2, r5)     // Catch: java.lang.Throwable -> L4d
        La8:
            return r1
        La9:
            ...
            java.lang.String r3 = "Exception while checking BackupRules: "
            r0.m5241e(r2, r3, r6)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.AFb1tSDK.AFInAppEventParameterName(java.lang.Object[]):java.lang.Object");
    }

    /* JADX INFO: renamed from: a */
    private static void m5193a(int[] iArr, int i, Object[] objArr) {
        int i2;
    ...
    private static /* synthetic */ Object component2(Object[] objArr) {
        ...
        if (aFb1tSDK.getCurrencyIso4217Code().mo5220i().getCurrencyIso4217Code()) {
            return null;
        }
        ...
        if (aFb1tSDK.copy == null) {
            Application applicationM5207f_ = AFb1vSDK.m5207f_(context);
            if (applicationM5207f_ == null) {
            ...
            aFb1tSDK.copy = applicationM5207f_;
        }
        ...
        aFLogger.m5245i(aFg1cSDK, String.format("Starting AppsFlyer: (v%s.%s)", "6.15.0", str2));
        ...
        aFb1tSDK.getCurrencyIso4217Code().mo5218d().getRevenue();
        aFb1tSDK.copydefault.mo5220i().getCurrencyIso4217Code(context, new AFd1wSDK.AFa1zSDK() { // from class: com.appsflyer.internal.AFb1tSDK.5
            ...
            public final void getMediationNetwork(@NonNull AFh1sSDK aFh1sSDK) {
                ...
                AFh1mSDK aFh1mSDK = new AFh1mSDK();
                if (aFh1sSDK != null) {
                    AFb1tSDK.this.getCurrencyIso4217Code().unregisterClient().m5211p_(AFc1kSDK.getCurrencyIso4217Code(aFh1mSDK), aFh1sSDK.getRevenue, currencyIso4217Code.valueOf().getCurrencyIso4217Code);
                }
            ...
            public final void getMonetizationNetwork() {
                ...
                if (aFb1bSDKCopydefault.component2()) {
                    ...
                    if (context2 != null && !AppsFlyerLib.getInstance().isStopped()) {
                        aFb1bSDKCopydefault.mo5187m_(context2.getPackageName(), context2.getPackageManager());
                    }
                ...
                AFb1tSDK.this.getCurrencyIso4217Code().mo5222w().getCurrencyIso4217Code();
            }
        });
        return null;
    }
    ...
    private static /* synthetic */ Object copydefault(Object[] objArr) {
        ...
        aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09555(new AFf1lSDK(aFb1tSDK.copydefault, AppsFlyerProperties.getInstance(), aFPurchaseDetails, map, appsFlyerInAppPurchaseValidationCallback)));
    ...
    private static /* synthetic */ Object equals(Object[] objArr) {
        ...
        if (currencyIso4217Code.copydefault().getCurrencyIso4217Code()) {
            currencyIso4217Code.mo5221v().getMonetizationNetwork();
            return null;
        }
        currencyIso4217Code.mo5221v().getCurrencyIso4217Code();
        return null;
    }
    ...
    private void getRevenue(AFa1mSDK aFa1mSDK) {
        ...
        if (str != null) {
            ...
            if (str.length() != 0) {
                ...
                AFc1rSDK aFc1rSDK = new AFc1rSDK(getCurrencyIso4217Code(), aFa1mSDK.getMonetizationNetwork(mediationNetwork).getMediationNetwork(mapAFAdRevenueData).getMonetizationNetwork(revenue2), getCurrencyIso4217Code().mo5218d().AFAdRevenueData());
                if (zAFAdRevenueData) {
                    ...
                    if (getCurrencyIso4217Code().mo5218d().getMonetizationNetwork()) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static /* synthetic */ java.lang.Object hashCode(java.lang.Object[] r6) {
        /*
            r0 = 0
            r1 = r6[r0]
            ...
            int r3 = com.appsflyer.internal.AFb1tSDK.values
            int r3 = r3 + 77
            int r4 = r3 % 128
            ...
            r4 = 0
            if (r3 == 0) goto L25
            boolean r3 = com.appsflyer.internal.AFc1tSDK.getRevenue(r6)
            r5 = 25
            int r5 = r5 / r0
            if (r3 != 0) goto L4d
            goto L2b
        L25:
            boolean r0 = com.appsflyer.internal.AFc1tSDK.getRevenue(r6)
            if (r0 != 0) goto L4d
        L2b:
            if (r1 == 0) goto L3e
        ...
        L3e:
            java.lang.String r0 = ""
        L40:
            com.appsflyer.internal.AFe1iSDK r1 = new com.appsflyer.internal.AFe1iSDK
            java.lang.String r6 = r6.trim()
            r1.<init>(r0, r6)
            com.appsflyer.internal.AFe1fSDK.getMonetizationNetwork(r1)
            return r4
        L4d:
            java.lang.String r6 = "hostname was empty or null - call for setHost is skipped"
    ...
    public static synchronized SharedPreferences m5199i_(Context context) {
    ...
    public /* synthetic */ void m5200j_(Context context, Intent intent) {
        Uri data;
        ...
        aFc1sSDKUnregisterClient.m5211p_(AFc1kSDK.getRevenue(aFc1sSDKUnregisterClient.areAllFieldsValid.mo5222w()), intent, context);
    }

    /* JADX INFO: renamed from: k_ */
    public static /* synthetic */ Application m5201k_(AFb1tSDK aFb1tSDK) {
    ...
    public final void enableFacebookDeferredApplinks(boolean z) {
        ...
        getCurrencyIso4217Code().mo5218d().AFAdRevenueData(z);
    ...
    public final void m5202g_(Context context, Intent intent) {
    ...
    public final void m5203h_(Context context, AFc1kSDK aFc1kSDK, Uri uri, @Nullable Uri uri2) {
        ...
        AFb1vSDK.m5205d_(context, map2, uri);
        ...
        AFe1aSDK aFe1aSDKCopy = getCurrencyIso4217Code().copy();
        aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09555(aFf1cSDK));
    }
    ...
    public final AppsFlyerLib init(@NonNull String str, AppsFlyerConversionListener appsFlyerConversionListener, @NonNull Context context) {
        ...
        if (context != null) {
            ...
            AFe1aSDK aFe1aSDKCopy = getCurrencyIso4217Code().copy();
            aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09555(new AFf1mSDK(getCurrencyIso4217Code())));
                ...
                if (listQueryIntentContentProviders != null && !listQueryIntentContentProviders.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (providerInfo != null) {
                            ...
                            AFLogger.INSTANCE.m5247w(AFg1cSDK.PREINSTALL, "com.appsflyer.referrer.INSTALL_PROVIDER Action is set for non ContentProvider component");
                        }
                    }
            ...
            if (aFi1mSDKAfInfoLog != null) {
                ...
                if (aFi1mSDKAfInfoLog.getCurrencyIso4217Code()) {
                    ...
                    aFe1aSDKCopy2.AFAdRevenueData.execute(aFe1aSDKCopy2.new RunnableC09555(new AFf1kSDK(aFi1mSDKAfInfoLog)));
            ...
            AFLogger.INSTANCE.m5247w(AFg1cSDK.REFERRER, "context is null, Google Install Referrer will be not initialized");
    ...
    public final void logAdRevenue(@NonNull AFAdRevenueData aFAdRevenueData, @Nullable Map<String, Object> map) {
        ...
        if (!aFAdRevenueData.areAllFieldsValid()) {
            values = (AFKeystoreWrapper + 107) % 128;
            AFLogger.INSTANCE.m5247w(AFg1cSDK.AD_REVENUE, "Invalid ad revenue parameters provided");
            return;
        }
        if (getCurrencyIso4217Code().AFKeystoreWrapper().getMonetizationNetwork()) {
            int i = AFKeystoreWrapper + 115;
            values = i % 128;
            if (i % 2 == 0) {
                AFLogger.INSTANCE.m5247w(AFg1cSDK.AD_REVENUE, "SDK is stopped");
                throw null;
            }
            AFLogger.INSTANCE.m5247w(AFg1cSDK.AD_REVENUE, "SDK is stopped");
            values = (AFKeystoreWrapper + 31) % 128;
    ...
    public final void logEvent(@NonNull Context context, String str, Map<String, Object> map, AppsFlyerRequestListener appsFlyerRequestListener) {
        ...
        if (map2 != null && map2.containsKey(AFInAppEventParameterName.TOUCH_OBJ)) {
            ...
            if (obj instanceof MotionEvent) {
                ...
                map4.put(BaseSei.f13930X, Float.valueOf(motionEvent.getX()));
                map4.put(BaseSei.f13931Y, Float.valueOf(motionEvent.getY()));
                map3.put("loc", map4);
                ...
                AFLogger.INSTANCE.mo5186w(AFg1cSDK.PREDICT, "Parsing failed due to invalid input in 'af_touch_obj'.", true);
            }
    ...
    public final void onPause(Context context) {
        AFKeystoreWrapper = (values + 15) % 128;
        getCurrencyIso4217Code().mo5220i().AFAdRevenueData();
        int i = values + 23;
        AFKeystoreWrapper = i % 128;
        if (i % 2 != 0) {
            throw null;
    ...
    public final void performOnAppAttribution(@NonNull Context context, @NonNull URI uri) {
        ...
        if (uri != null) {
            ...
            if (!uri.toString().isEmpty()) {
                if (context != null) {
                    getCurrencyIso4217Code(context);
                    getCurrencyIso4217Code().unregisterClient().m5212q_(context, AFc1kSDK.getRevenue(getCurrencyIso4217Code().mo5222w()), Uri.parse(uri.toString()));
                    return;
                }
                AFc1sSDK aFc1sSDKUnregisterClient = getCurrencyIso4217Code().unregisterClient();
    ...
    public final void performOnDeepLinking(@NonNull final Intent intent, @NonNull Context context) {
        ...
        if (intent != null) {
            ...
            getCurrencyIso4217Code().AFAdRevenueData().execute(new Runnable() { // from class: com.appsflyer.internal.f
                @Override // java.lang.Runnable
                public final void run() {
                    this.f4276a.m5200j_(applicationContext, intent);
                }
            });
            return;
        }
    ...
    public final void sendInAppPurchaseData(Context context, Map<String, Object> map, PurchaseHandler.PurchaseValidationCallback purchaseValidationCallback) {
        ...
        if (i % 2 == 0) {
            ...
            if (purchaseHandlerAreAllFieldsValid.getMonetizationNetwork(map, purchaseValidationCallback, strArr)) {
                ...
                AFe1aSDK aFe1aSDK = purchaseHandlerAreAllFieldsValid.AFAdRevenueData;
                aFe1aSDK.AFAdRevenueData.execute(aFe1aSDK.new RunnableC09555(aFf1pSDK));
            }
        } else {
            getCurrencyIso4217Code(context);
            purchaseHandlerAreAllFieldsValid = getCurrencyIso4217Code().areAllFieldsValid();
            if (purchaseHandlerAreAllFieldsValid.getMonetizationNetwork(map, purchaseValidationCallback, "purchases")) {
                ...
                AFe1aSDK aFe1aSDK2 = purchaseHandlerAreAllFieldsValid.AFAdRevenueData;
                aFe1aSDK2.AFAdRevenueData.execute(aFe1aSDK2.new RunnableC09555(aFf1pSDK2));
            }
        }
    ...
    public final void sendPushNotificationData(@Nullable Activity activity) {
        ...
        AFd1mSDK aFd1mSDKMo5219e = getCurrencyIso4217Code().mo5219e();
        String monetizationNetwork = getMonetizationNetwork(activity);
        aFd1mSDKMo5219e.AFAdRevenueData = monetizationNetwork;
        if (monetizationNetwork != null) {
            AFKeystoreWrapper = (values + 97) % 128;
            long jCurrentTimeMillis = System.currentTimeMillis();
            if (this.component3 == null) {
                ...
                try {
                    ...
                    for (Long l2 : this.component3.keySet()) {
                        try {
                            JSONObject jSONObject = new JSONObject(aFd1mSDKMo5219e.AFAdRevenueData);
                            ...
                            try {
                                if (jSONObject.opt("pid").equals(jSONObject2.opt("pid")) && jSONObject.opt("c").equals(jSONObject2.opt("c"))) {
                                    ...
                                    aFd1mSDKMo5219e.AFAdRevenueData = null;
                                    return;
                                }
                                ...
                                this.component3.put(Long.valueOf(j), aFd1mSDKMo5219e.AFAdRevenueData);
                                start(activity);
                            }
                        } catch (Throwable th2) {
                            th = th2;
    ...
    public final void setAndroidIdData(String str) {
        ...
        getCurrencyIso4217Code().mo5219e().getRevenue = str;
        int i = values + 29;
        AFKeystoreWrapper = i % 128;
        if (i % 2 != 0) {
            throw null;
    ...
    public final void setConsentData(@NonNull AppsFlyerConsent appsFlyerConsent) {
        ...
        getCurrencyIso4217Code().mo5219e().component2 = appsFlyerConsent;
        int i = values + 11;
        AFKeystoreWrapper = i % 128;
        if (i % 2 != 0) {
            throw null;
    ...
    public final void setDisableAdvertisingIdentifiers(boolean z) {
        ...
        currencyIso4217Code.mo5219e().component3 = z;
        if (z) {
            values = (AFKeystoreWrapper + 67) % 128;
            currencyIso4217Code.mo5219e().component4 = null;
        } else {
    ...
    public final void setLogLevel(@NonNull AFLogger.LogLevel logLevel) {
        ...
        if (z) {
            getCurrencyIso4217Code().mo5221v().component1();
        } else {
            getCurrencyIso4217Code().mo5221v().getMediationNetwork();
        }
    }
    ...
    public final void setPartnerData(@NonNull String str, Map<String, Object> map) {
        String strConcat;
        AFd1mSDK aFd1mSDKMo5219e = getCurrencyIso4217Code().mo5219e();
        if (aFd1mSDKMo5219e.getMediationNetwork == null) {
            aFd1mSDKMo5219e.getMediationNetwork = new AFc1bSDK();
        }
        AFc1bSDK aFc1bSDK = aFd1mSDKMo5219e.getMediationNetwork;
        if (str != null) {
            int i = AFKeystoreWrapper + 69;
            values = i % 128;
            if (i % 2 == 0) {
    ...
    public final void setPhoneNumber(String str) {
        ...
        getCurrencyIso4217Code().mo5219e().getCurrencyIso4217Code = AFb1iSDK.getCurrencyIso4217Code(str);
    ...
    public final void setSharingFilterForPartners(String... strArr) {
        getCurrencyIso4217Code().mo5219e().getMonetizationNetwork = new AFd1uSDK(strArr);
        int i = values + 101;
        AFKeystoreWrapper = i % 128;
        if (i % 2 != 0) {
            throw null;
    ...
    public final void setUserEmails(AppsFlyerProperties.EmailsCryptType emailsCryptType, String... strArr) {
        ...
        for (String str2 : strArr) {
            ...
            if (C09414.getMonetizationNetwork[emailsCryptType.ordinal()] != 2) {
    ...
    public final void updateServerUninstallToken(Context context, String str) {
        ...
        if (str == null || str.trim().isEmpty()) {
            AFLogger.INSTANCE.m5247w(AFg1cSDK.UNINSTALL, "Firebase Token is either empty or null and was not registered.");
            return;
        }
        AFLogger.INSTANCE.m5245i(AFg1cSDK.UNINSTALL, "Firebase Refreshed Token = ".concat(str));
    ...
    public class AFa1vSDK implements AFe1eSDK {
        ...
        public final void getMonetizationNetwork(AFf1wSDK<?> aFf1wSDK, AFe1dSDK aFe1dSDK) {
            ...
            if (!(aFf1wSDK instanceof AFf1gSDK)) {
                ...
                aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09555(aFg1gSDK));
                return;
            }
            ...
            if (z && getMediationNetwork()) {
                ...
                if (aFf1dSDK.getMediationNetwork == AFe1dSDK.SUCCESS || aFf1dSDK.getRevenue == 1) {
                    ...
                    aFe1aSDKCopy2.AFAdRevenueData.execute(aFe1aSDKCopy2.new RunnableC09555(aFg1dSDK));
                }
            }
            if (aFe1dSDK == AFe1dSDK.SUCCESS) {
                ...
                if (!(aFf1wSDK instanceof AFf1bSDK) && (aFg1jSDKAFAdRevenueData = new AFg1lSDK(AFb1tSDK.m5201k_(AFb1tSDK.this)).AFAdRevenueData()) != null && aFg1jSDKAFAdRevenueData.getRevenue()) {
                    String str = aFg1jSDKAFAdRevenueData.AFAdRevenueData;
                    AFLogger.INSTANCE.m5240d(AFg1cSDK.UNINSTALL, "Resending Uninstall token to AF servers: ".concat(String.valueOf(str)));
                    AFg1lSDK.AFAdRevenueData(str);
                }
    ...
    private static void areAllFieldsValid() {
        ...
        AFKeystoreWrapper = i % 128;
        if (i % 2 == 0) {
            AFLogger.INSTANCE.m5247w(AFg1cSDK.SDK_LIFECYCLE, "ERROR: AppsFlyer SDK is not initialized! You must provide AppsFlyer Dev-Key either in the 'init' API method (should be called on Application's onCreate),or in the start() API (should be called on Activity's onCreate).");
        } else {
            AFLogger.INSTANCE.m5247w(AFg1cSDK.SDK_LIFECYCLE, "ERROR: AppsFlyer SDK is not initialized! You must provide AppsFlyer Dev-Key either in the 'init' API method (should be called on Application's onCreate),or in the start() API (should be called on Activity's onCreate).");
            throw null;
        }
    ...
    private static void component1(String str) {
        ...
        aFLogger.m5247w(aFg1cSDK, sb.toString());
    ...
    private void component4() {
        ...
        AFd1fSDK currencyIso4217Code = getCurrencyIso4217Code();
        AFe1aSDK aFe1aSDKCopy = currencyIso4217Code.copy();
        aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09555(new AFf1qSDK(currencyIso4217Code)));
    }
    ...
    private void getMonetizationNetwork(Map<String, Object> map) {
        ...
        try {
            if (AFc1tSDK.getCurrencyIso4217Code(getCurrencyIso4217Code().mo5219e().getRevenue) && map.remove("android_id") != null) {
    ...
    public /* synthetic */ void getCurrencyIso4217Code(boolean z) {
        ...
        if (z) {
            ...
            AFKeystoreWrapper = i2 % 128;
            if (i2 % 2 == 0) {
                getCurrencyIso4217Code().mo5221v().getRevenue();
                return;
            } else {
                getCurrencyIso4217Code().mo5221v().getRevenue();
                throw null;
        ...
        getCurrencyIso4217Code().mo5221v().AFAdRevenueData();
        ...
        if (activity != null) {
            ...
            if (intent != null) {
                try {
                    ...
                    AFLogger.INSTANCE.m5247w(AFg1cSDK.ENGAGEMENT, "Push Notification received af payload = ".concat(String.valueOf(string)));
                    extras.remove("af");
                    activity.setIntent(intent.putExtras(extras));
                    AFKeystoreWrapper = (values + 9) % 128;
                    return string;
                } catch (Throwable th) {
                    AFLogger.INSTANCE.m5241e(AFg1cSDK.ENGAGEMENT, th.getMessage(), th);
                }
            }
        }
        return string;
        ...
        try {
            if (i % 2 == 0) {
                ...
                try {
                    ...
                    AFLogger.INSTANCE.m5241e(AFg1cSDK.GENERAL, "WARNING:  Google Play Services is unavailable. ", e);
                    return false;
                }
            }
    ...
    public final Map<String, Object> AFAdRevenueData(AFa1mSDK aFa1mSDK) {
        ...
        m5193a(new int[]{-2029743005, -1810686557, 2054987161, 1533781460, -918385603, 1220443193}, ImageFormat.getBitsPerPixel(0) + 13, objArr);
    ...
    private static /* synthetic */ Object AFAdRevenueData(Object[] objArr) {
        ...
        try {
            ...
            if (!listAsList.contains("android.permission.INTERNET")) {
                AFLogger.INSTANCE.m5247w(AFg1cSDK.GENERAL, "Permission android.permission.INTERNET is missing in the AndroidManifest.xml");
            }
            if (!listAsList.contains("android.permission.ACCESS_NETWORK_STATE")) {
                AFKeystoreWrapper = (values + 101) % 128;
                AFLogger.INSTANCE.m5247w(AFg1cSDK.GENERAL, "Permission android.permission.ACCESS_NETWORK_STATE is missing in the AndroidManifest.xml");
            }
            if (Build.VERSION.SDK_INT > 32) {
                ...
                if (!listAsList.contains("com.google.android.gms.permission.AD_ID")) {
                    AFLogger.INSTANCE.m5247w(AFg1cSDK.GENERAL, "Permission com.google.android.gms.permission.AD_ID is missing in the AndroidManifest.xml");
                    AFKeystoreWrapper = (values + 43) % 128;
                }
            }
            return null;
        } catch (Exception e) {
            AFLogger.INSTANCE.m5241e(AFg1cSDK.GENERAL, "Exception while validation permissions. ", e);
            return null;
        }
    }
