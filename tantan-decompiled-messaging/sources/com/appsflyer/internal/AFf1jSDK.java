...
public final class AFf1jSDK extends AFf1wSDK<Unit> {
    ...
    public final AFe1dSDK getMonetizationNetwork() {
        MeasurementManager measurementManagerM149749a;
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = AFe1dSDK.FAILURE;
        CountDownLatch countDownLatch = new CountDownLatch(1);
        try {
            Context context = this.component1.getCurrencyIso4217Code;
            if (context != null && (measurementManagerM149749a = lfx.m149749a(context.getSystemService(kfx.m145877a()))) != null) {
                new AFj1mSDK(this.component3, null, 2, null);
                Uri.Builder builderBuildUpon = Uri.parse(AFj1mSDK.getCurrencyIso4217Code()).buildUpon();
                Pair pairM87240a = TuplesKt.m87240a("event_name", this.areAllFieldsValid);
                Pair pairM87240a2 = TuplesKt.m87240a(Constants.JumpUrlConstants.URL_KEY_APPID, this.component3.AFAdRevenueData.getCurrencyIso4217Code.getPackageName());
                Context context2 = this.component3.AFAdRevenueData.getCurrencyIso4217Code;
                Map mapMutableMapOf = MapsKt.mutableMapOf(pairM87240a, pairM87240a2, TuplesKt.m87240a("app_version", AFb1vSDK.getMonetizationNetwork(context2, context2.getPackageName())), TuplesKt.m87240a(Constants.JumpUrlConstants.URL_KEY_SDK_VERSION, AFd1pSDK.getRevenue()), TuplesKt.m87240a("api_version", AFd1pSDK.getCurrencyIso4217Code()), TuplesKt.m87240a("timestamp", String.valueOf(this.component4.getRevenue())), TuplesKt.m87240a("request_id", AFd1pSDK.AFAdRevenueData()));
                ...
                uriBuild.getClass();
                measurementManagerM149749a.registerTrigger(uriBuild, AFd1qSDK.getRevenue(), dz50.m114111a(new AFa1tSDK(objectRef, countDownLatch, this)));
            }
    ...
    public static void getMonetizationNetwork(Throwable th) {
        ...
        aFLogger.mo5183e(aFg1cSDK, sb.toString(), th, false, false, false, true);
    }
}
