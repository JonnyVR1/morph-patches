            ...
            try {
                ...
                if (currencyIso4217Code != null && (fileArrListFiles = currencyIso4217Code.listFiles()) != null) {
                    ...
                    for (File file2 : arrayList) {
                        file2.getClass();
                        arrayList2.add(Boolean.valueOf(bii.m102042r(file2)));
                    }
                }
            ...
            try {
                ...
                if (currencyIso4217Code != null) {
                    if (strArr.length == 0) {
                        ...
                        zM102042r = bii.m102042r(currencyIso4217Code);
                    } else {
        ...
        synchronized (this) {
            ...
            if (file != null) {
                try {
                    ...
                    sb2.append(th);
                    sb2.append('\n');
                    sb2.append(CollectionsKt.joinToString$default(AFe1xSDK.getMediationNetwork(th), SignParameters.NEW_LINE, null, null, 0, null, AFe1xSDK.C09584.AFAdRevenueData, 30, null));
                    AFd1gSDK aFd1gSDK = new AFd1gSDK(string, AFe1ySDK.getRevenue(sb2.toString(), "SHA-256"), h5f.m129396b(th), 0, 8, null);
                    String str3 = aFd1gSDK.getRevenue;
                    File file2 = new File(file, str3);
                    if (file2.exists() && (mediationNetwork = AFd1gSDK.Companion.getMediationNetwork(zhi.m218807j(file2, null, 1, null))) != null) {
                    ...
                    zhi.m218809l(file2, sb3.toString(), null, 2, null);
                    str2 = str3;
                } catch (Exception e) {
                    AFLogger aFLogger = AFLogger.INSTANCE;
                    AFg1cSDK aFg1cSDK = AFg1cSDK.EXCEPTION_MANAGER;
                        ...
                        try {
                            ...
                            if (fileArrListFiles2 != null) {
                                ...
                                for (File file2 : fileArrListFiles2) {
                                    ...
                                    file2.getClass();
                                    AFd1gSDK mediationNetwork = AFd1gSDK.Companion.getMediationNetwork(zhi.m218807j(file2, null, 1, null));
