...
public final class AFi1aSDK extends AFi1hSDK {
    ...
    private final boolean AFAdRevenueData(Context context) {
        ...
        String strW0 = revenue != null ? StringsKt.m93456w0(revenue, "fb") : null;
        ...
        if (strW0 == null) {
            ...
            strW0 = strAFAdRevenueData != null ? StringsKt.m93456w0(strAFAdRevenueData, "fb") : null;
            if (strW0 == null || strW0.length() == 0) {
            ...
            if (strW0 == null) {
                ...
                strW0 = revenue2 != null ? StringsKt.m93456w0(revenue2, "fb") : null;
                if (strW0 == null || strW0.length() == 0) {
    ...
    public static final void getCurrencyIso4217Code(AFi1aSDK aFi1aSDK, Context context) {
        ...
        aFi1aSDK.addObserver(new AFj1zSDK.C09794());
                        ...
                        try {
                            if (cursorQuery.moveToFirst()) {
                                ...
                                if (string != null) {
                                    ...
                                    if (numValueOf != null) {
                                        aFi1aSDK.getMediationNetwork.put("meta_custom", MapsKt.mutableMapOf(TuplesKt.m87240a("is_ct", Integer.valueOf(numValueOf.intValue()))));
                                    }
