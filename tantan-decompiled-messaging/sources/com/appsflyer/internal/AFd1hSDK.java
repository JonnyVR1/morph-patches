...
public abstract class AFd1hSDK {
    ...
    private final boolean getMonetizationNetwork(HttpURLConnection httpURLConnection, long j) throws IOException {
        ...
        if (inputStream != null) {
            ...
            strJoinToString$default = CollectionsKt.joinToString$default(TextStreamsKt.m87424f(bufferedReader), null, null, null, 0, null, null, 63, null);
