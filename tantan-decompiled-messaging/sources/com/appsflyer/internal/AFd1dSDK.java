...
public final class AFd1dSDK implements AFd1bSDK {
    ...
    public AFd1dSDK(@NotNull AFd1fSDK aFd1fSDK) {
        ...
        this.getMonetizationNetwork = LazyKt__LazyJVMKt.m87229b(new Function0<AFg1wSDK>() { // from class: com.appsflyer.internal.AFd1dSDK.1
            {
                super(0);
            }
        ...
        this.getMediationNetwork = LazyKt__LazyJVMKt.m87229b(new Function0<AFd1pSDK>() { // from class: com.appsflyer.internal.AFd1dSDK.3
            {
                super(0);
            }
        ...
        this.AFAdRevenueData = LazyKt__LazyJVMKt.m87229b(new Function0<AFd1rSDK>() { // from class: com.appsflyer.internal.AFd1dSDK.5
            {
                super(0);
            }
        ...
        this.getRevenue = LazyKt__LazyJVMKt.m87229b(new Function0<AFg1rSDK>() { // from class: com.appsflyer.internal.AFd1dSDK.10
            {
                super(0);
            }
        ...
        this.component3 = LazyKt__LazyJVMKt.m87229b(new Function0<ExecutorService>() { // from class: com.appsflyer.internal.AFd1dSDK.4
            {
                super(0);
            }
        ...
        this.areAllFieldsValid = LazyKt__LazyJVMKt.m87229b(new Function0<AFd1jSDK>() { // from class: com.appsflyer.internal.AFd1dSDK.2
            {
                super(0);
            }
        ...
        this.component4 = LazyKt__LazyJVMKt.m87229b(new Function0<AFd1eSDK>() { // from class: com.appsflyer.internal.AFd1dSDK.6
            {
                super(0);
            }
    ...
    private static /* synthetic */ Object AFAdRevenueData(Object[] objArr) {
        ...
        m5214a("\ue4bc뵣\u0efb\ue4de\uf4b6괿鷔熤쉄", 1 - Color.red(0), objArr2);
        Pair pairM87240a = TuplesKt.m87240a(((String) objArr2[0]).intern(), Build.BRAND);
        Pair pairM87240a2 = TuplesKt.m87240a("model", Build.MODEL);
        Pair pairM87240a3 = TuplesKt.m87240a(Constants.JumpUrlConstants.URL_KEY_APPID, aFd1dSDK.getRevenue().AFAdRevenueData.getCurrencyIso4217Code.getPackageName());
        Pair pairM87240a4 = TuplesKt.m87240a("p_ex", new AFb1aSDK().AFAdRevenueData());
        Pair pairM87240a5 = TuplesKt.m87240a("api", String.valueOf(Build.VERSION.SDK_INT));
        Pair pairM87240a6 = TuplesKt.m87240a("sdk", aFd1dSDK.component2);
        AFd1pSDK revenue = aFd1dSDK.getRevenue();
        Map mapMapOf = MapsKt.mapOf(pairM87240a, pairM87240a2, pairM87240a3, pairM87240a4, pairM87240a5, pairM87240a6, TuplesKt.m87240a(Oauth2AccessToken.KEY_UID, AFb1lSDK.AFAdRevenueData(revenue.AFAdRevenueData, revenue.getRevenue)), TuplesKt.m87240a("exc_config", aFh1fSDK.getCurrencyIso4217Code()));
        int i = equals + 15;
        hashCode = i % 128;
        if (i % 2 == 0) {
            return mapMapOf;
    ...
    private static void m5214a(String str, int i, Object[] objArr) {
    ...
    private static /* synthetic */ Object getCurrencyIso4217Code(Object[] objArr) {
        ...
        bytes.getClass();
        aFd1dSDK.component1().AFAdRevenueData(bytes, MapsKt.mapOf(TuplesKt.m87240a("Authorization", AFb1iSDK.getMediationNetwork(str, str2))), 2000);
        int i = equals + 75;
        hashCode = i % 128;
        if (i % 2 == 0) {
            return null;
    ...
    private static Map<String, Object> getMonetizationNetwork(Map<String, ? extends Object> map, List<AFd1gSDK> list) {
        ...
        Map<String, Object> mapMapOf = MapsKt.mapOf(TuplesKt.m87240a("deviceInfo", map), TuplesKt.m87240a("excs", AFe1vSDK.getMonetizationNetwork(list)));
