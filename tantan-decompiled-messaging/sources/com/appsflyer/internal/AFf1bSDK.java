...
public final class AFf1bSDK extends AFf1gSDK {
    ...
    private static void m5231a(char c, String str, int i, String str2, String str3, Object[] objArr) {
        char[] charArray;
        char[] charArray2;
        int i2 = $10 + 83;
        $11 = i2 % 128;
        ...
        while (true) {
            ...
            char c3 = (char) ((i6 + c2) % j6f.COLOR_SPACE_UNCALIBRATED);
            aFj1eSDK.getMonetizationNetwork = c3;
            cArr4[i5] = (char) (((cArr3[i5] * 32718) + c2) / j6f.COLOR_SPACE_UNCALIBRATED);
            cArr3[i5] = c3;
    ...
    public final void getRevenue(AFa1mSDK aFa1mSDK) {
        ...
        if (context == null) {
            qkq0.m175383a("Context is not provided, can't send register request");
            return;
        }
        if (monetizationNetwork.AFAdRevenueData()) {
            AFLogger.afInfoLog("CustomerUserId not set, Tracking is disabled", true);
            qkq0.m175383a("CustomerUserId not set, register is not sent");
            return;
        }
        ...
        try {
            ...
            m5231a((char) ((KeyEvent.getMaxKeyCode() >> 16) + 48847), "䮩늀\uebe7⑵\ue6f2", 705339418 - View.MeasureSpec.makeMeasureSpec(0, 0), "\u0000\u0000\u0000\u0000", "\u1aedઠ켪傾", objArr);
        ...
        AFb1ySDK aFb1ySDKM5191b_ = AFb1rSDK.m5191b_(context.getContentResolver());
        if (aFb1ySDKM5191b_ != null) {
            aFa1mSDK.getMonetizationNetwork("amazon_aid", aFb1ySDKM5191b_.AFAdRevenueData);
            aFa1mSDK.getMonetizationNetwork("amazon_aid_limit", String.valueOf(aFb1ySDKM5191b_.getMediationNetwork));
        }
