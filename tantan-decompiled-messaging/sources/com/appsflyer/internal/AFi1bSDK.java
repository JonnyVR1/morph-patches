...
public final class AFi1bSDK extends AFj1zSDK {
    ...
    public static ContentProviderClient m5249C_(Context context, Uri uri) {
        try {
            return context.getContentResolver().acquireUnstableContentProviderClient(uri);
        } catch (SecurityException e) {
            AFLogger.INSTANCE.m5244e(AFg1cSDK.PREINSTALL, "Failed to acquire unstable content providerClient due to SecurityException", e, false, true, false);
            return null;
        } catch (Throwable th) {
            AFLogger.INSTANCE.m5244e(AFg1cSDK.PREINSTALL, "Failed to acquire unstable content providerClient due to unexpected throwable", th, false, true, false);
            return null;
        }
    }
    ...
    public final void getMonetizationNetwork(final Context context) {
        this.getCurrencyIso4217Code.AFAdRevenueData().execute(new Runnable() { // from class: com.appsflyer.internal.AFi1bSDK.2
            ...
            public final void run() {
                ...
                aFi1bSDK.addObserver(new AFj1zSDK.C09794());
                StringBuilder sb = new StringBuilder(CommonUtility.PREFIX_URI);
                sb.append(AFi1bSDK.this.AFAdRevenueData.authority);
                sb.append("/transaction_id");
                Uri uri = Uri.parse(sb.toString());
                ContentProviderClient contentProviderClientM5249C_ = AFi1bSDK.m5249C_(context, uri);
                try {
                    if (contentProviderClientM5249C_ != null) {
                        StringBuilder sb2 = new StringBuilder("app_id=");
                        sb2.append(context.getPackageName());
                        cursorQuery = contentProviderClientM5249C_.query(uri, null, sb2.toString(), null, null);
                    } else {
                        cursorQuery = null;
                    }
                } catch (RemoteException e) {
                    AFLogger.INSTANCE.m5244e(AFg1cSDK.PREINSTALL, "Failed to query unstable content providerClient", e, false, true, false);
                    cursorQuery = null;
                } catch (DeadObjectException e2) {
                    AFLogger.INSTANCE.m5244e(AFg1cSDK.PREINSTALL, "Failed to acquire unstable content providerClient", e2, false, true, false);
                    cursorQuery = null;
                } catch (Throwable th) {
                    AFLogger.INSTANCE.m5244e(AFg1cSDK.PREINSTALL, "Error to get data from providerClient ", th, false, true, false);
                    cursorQuery = null;
                } finally {
                    contentProviderClientM5249C_.close();
                }
                if (cursorQuery != null) {
                    int columnIndex = cursorQuery.getColumnIndex(FirebaseAnalytics.Param.TRANSACTION_ID);
                    if (columnIndex == -1) {
                        AFLogger.INSTANCE.m5247w(AFg1cSDK.PREINSTALL, "Wrong column name");
                    ...
                    AFLogger.INSTANCE.m5247w(AFg1cSDK.PREINSTALL, "ContentProvider query failed, got null Cursor");
