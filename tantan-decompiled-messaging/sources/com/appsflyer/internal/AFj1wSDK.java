...
public final class AFj1wSDK extends AFi1iSDK {
    ...
    public final void getMonetizationNetwork(Context context) {
        AFc1cSDK<Map<String, Object>> aFc1cSDK = new AFc1cSDK<Map<String, Object>>(context, this.AFAdRevenueData, "com.sec.android.app.samsungapps.referrer", "FBA3AF4E7757D9016E953FB3EE4671CA2BD9AF725F9A53D52ED4A38EAAA08901") { // from class: com.appsflyer.internal.AFj1wSDK.3
            ...
            private static void m5272D_(String str, Map<String, Object> map, Cursor cursor) {
            ...
            private static void m5273E_(String str, Map<String, Object> map, Cursor cursor) {
                String string;
                int columnIndex = cursor.getColumnIndex(str);
                    ...
                    try {
                        ...
                        if (cursorQuery != null) {
                            ...
                            if (zMoveToFirst) {
                                ...
                                m5273E_("referrer", AFj1wSDK.this.getMediationNetwork, cursorQuery);
                                m5272D_("click_ts", AFj1wSDK.this.getMediationNetwork, cursorQuery);
                                m5272D_("install_begin_ts", AFj1wSDK.this.getMediationNetwork, cursorQuery);
                                m5272D_("install_end_ts", AFj1wSDK.this.getMediationNetwork, cursorQuery);
                                m5273E_("organic_keywords", AFj1wSDK.this.getMediationNetwork, cursorQuery);
                                m5273E_("attr_type", AFj1wSDK.this.getMediationNetwork, cursorQuery);
                                ...
                                m5272D_("click_server_ts", map, cursorQuery);
                                m5272D_("install_begin_server_ts", map, cursorQuery);
                                m5273E_("install_version", map, cursorQuery);
                                if (!map.isEmpty()) {
