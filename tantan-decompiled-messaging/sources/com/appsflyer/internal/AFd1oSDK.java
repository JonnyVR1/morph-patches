...
public final class AFd1oSDK extends HashMap<String, Object> {
    ...
    private String AFAdRevenueData() {
        try {
            ...
            m5224a("䁷\ue88dᆳ몕\ue38bಊ떝\ude8eފ낒\ud999ʹ", Drawable.resolveOpacity(0, 0) + 43261, objArr);
            String string2 = map.get(((String) objArr[0]).intern()).toString();
            Map<String, Object> map2 = this.AFAdRevenueData;
            Object[] objArr2 = new Object[1];
            m5224a("䁴⨑钝缧\ue9a6", 27253 - (ViewConfiguration.getMaximumFlingVelocity() >> 16), objArr2);
            String string3 = map2.get(((String) objArr2[0]).intern()).toString();
            if (string3 == null) {
                areAllFieldsValid = (component3 + 77) % 128;
                Object[] objArr3 = new Object[1];
                m5224a("䁘ゼꆃዻ菐琮\ue506嘑", 28901 - (CdmaCellLocation.convertQuartSecToDecDegrees(0) > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 1 : (CdmaCellLocation.convertQuartSecToDecDegrees(0) == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 0 : -1)), objArr3);
            ...
            m5224a("䁽\uf79c⾮", 47087 - (ViewConfiguration.getKeyRepeatTimeout() >> 16), objArr4);
            sbAFAdRevenueData.insert(0, ((String) objArr4[0]).intern());
            return sbAFAdRevenueData.toString();
        } catch (Exception e) {
            Object[] objArr5 = new Object[1];
            m5225b("헩⃨\uf147\uef2e搼肤䈵ꥼ\udb0e陉諑발歈\uf770븂僓헩⃨㽞唟嬤情쳉襥衕᛫\udc8c֘\uf350撞埙멠\uf350撞\udb0e陉ﱙ츺碐蒿", (AudioTrack.getMaxVolume() > 0.0f ? 1 : (AudioTrack.getMaxVolume() == 0.0f ? 0 : -1)) + 39, objArr5);
            AFLogger.afErrorLogForExcManagerOnly(((String) objArr5[0]).intern(), e);
            StringBuilder sb2 = new StringBuilder();
            Object[] objArr6 = new Object[1];
            m5224a("䁰\uf0c6ℝ剩芷㌇搐钦엻癁ꚙ\ud7ff࠻뢟\ue9d1ᨧ䭡ﯷⰏ嵐趤㺳潋龔탷ſ놛\ue2d4ጾ䑳\uf488├噎蚤㟱桕领짪稿ꪏ\udb84౯", 45233 - Color.argb(0, 0, 0, 0), objArr6);
            sb2.append(((String) objArr6[0]).intern());
            sb2.append(e);
            AFLogger.afRDLog(sb2.toString());
            Object[] objArr7 = new Object[1];
            m5225b("\uf350撞ْ퐶밼ᾯ툵씌", 7 - Color.green(0), objArr7);
    ...
    private static void m5225b(String str, int i, Object[] objArr) {
        char[] charArray;
        int i2 = $11 + 71;
        $10 = i2 % 128;
        if (i2 % 2 != 0) {
    ...
    private String getMonetizationNetwork() {
        ...
        try {
            Map<String, Object> map = this.AFAdRevenueData;
            Object[] objArr = new Object[1];
            m5224a("䁷\ue88dᆳ몕\ue38bಊ떝\ude8eފ낒\ud999ʹ", Color.green(0) + 43261, objArr);
            String string2 = map.get(((String) objArr[0]).intern()).toString();
            Map<String, Object> map2 = this.AFAdRevenueData;
            Object[] objArr2 = new Object[1];
            m5224a("䁰솠䏚엸䜞줁䭍쵺亀킢勈퓇嘃\ud831婁", TextUtils.indexOf("", "") + 33247, objArr2);
            String string3 = map2.get(((String) objArr2[0]).intern()).toString();
            Object[] objArr3 = new Object[1];
            m5225b("洃\uf1efퟲ\ue38e칷薪", 6 - Color.alpha(0), objArr3);
            String strIntern = ((String) objArr3[0]).intern();
            Object[] objArr4 = new Object[1];
            m5224a("䀻\ue4b5ৗ깋퍸", Color.blue(0) + 42193, objArr4);
            ...
            Object[] objArr5 = new Object[1];
            m5225b("\uf28eﰾ̖ᨹ降ॣ崡ᄘ씖\ue3ceﳇ\uf446絠⺞肨礏ృᗧ\uf28eﰾ\ue640䋽魟郟礎瑿ﱾ䋬鋢㪆唯䙺웾\ue62f崡ᄘ씖\ue3ce", 38 - (ViewConfiguration.getMaximumDrawingCacheSize() >> 24), objArr5);
            AFLogger.afErrorLogForExcManagerOnly(((String) objArr5[0]).intern(), e);
            StringBuilder sb2 = new StringBuilder();
            Object[] objArr6 = new Object[1];
            m5225b("諑발歈\uf770븂僓헩⃨㽞唟嬤情쳉襥衕᛫\udc8c֘\uf350撞埙멠佱䲯\uffdf섨虱ꨆﱙ츺碐蒿▯ᯬ䍡ႝ끝祪礎瑿꙰ؗ⡉ᱜ", (Process.myTid() >> 22) + 44, objArr6);
            sb2.append(((String) objArr6[0]).intern());
            sb2.append(e);
            AFLogger.afRDLog(sb2.toString());
            StringBuilder sb3 = new StringBuilder("");
            Object[] objArr7 = new Object[1];
            m5225b("匡\uf577㙬㭿뢩㲁\uf28c\uf5be影\ue348꼤哏䪈ᶈ脒\uf439暮\uf370", KeyEvent.keyCodeFromString("") + 18, objArr7);
        ...
        try {
            ...
            m5224a("䁷ᣵ\uf168䧃≍諭匼⯣萗岍㗠蹼曤㽋鞎瀴좥ꄿ禕툎ꭼΩ\udc4a듼ൺ\ue587븁᚛\uef23䞰⃓淚凷⩵苫嬔㎆", KeyEvent.normalizeMetaState(0) + 22669, objArr8);
            Intent intentM136342l = ii5.m136342l(context, null, new IntentFilter(((String) objArr8[0]).intern()));
            int intExtra = -2700;
            if (intentM136342l != null) {
                Object[] objArr9 = new Object[1];
                m5224a("䁢霈\uee8d옗ᶟ甃䲕ꐿ﮻팷⪽", 55163 - View.MeasureSpec.getMode(0), objArr9);
                intExtra = intentM136342l.getIntExtra(((String) objArr9[0]).intern(), -2700);
            }
            String str = this.getMonetizationNetwork.getApplicationInfo().nativeLibraryDir;
            if (str != null) {
                Object[] objArr10 = new Object[1];
                m5225b("佩㈿薘䉟", (TypedValue.complexToFraction(0, 0.0f, 0.0f) > 0.0f ? 1 : (TypedValue.complexToFraction(0, 0.0f, 0.0f) == 0.0f ? 0 : -1)) + 3, objArr10);
            ...
            m5225b("쌔㸶䲶僗糸갵", Color.green(0) + 6, objArr11);
            int size = ((SensorManager) context2.getSystemService(((String) objArr11[0]).intern())).getSensorList(-1).size();
            StringBuilder sb4 = new StringBuilder();
            Object[] objArr12 = new Object[1];
            m5225b("槗퓋", 1 - View.resolveSizeAndState(0, 0, 0), objArr12);
            sb4.append(((String) objArr12[0]).intern());
            sb4.append(intExtra);
            Object[] objArr13 = new Object[1];
            m5225b("፮奠", (ViewConfiguration.getScrollBarSize() >> 8) + 2, objArr13);
            sb4.append(((String) objArr13[0]).intern());
            sb4.append(i);
            Object[] objArr14 = new Object[1];
            m5225b("뮎㑚", 2 - (ViewConfiguration.getFadingEdgeLength() >> 16), objArr14);
            sb4.append(((String) objArr14[0]).intern());
            sb4.append(size);
            Object[] objArr15 = new Object[1];
            m5225b("䒨ꝓ", 2 - View.resolveSizeAndState(0, 0, 0), objArr15);
            ...
            m5224a("䁱\ueae6ᕈ뿿\uea70ᒩ뼉\uea69ᓋ뽎\ue9e4ᐔ뺘\ue9f5ᑟ뻟", 43669 - View.MeasureSpec.getMode(0), objArr16);
            AFLogger.afErrorLogForExcManagerOnly(((String) objArr16[0]).intern(), e2);
            StringBuilder sb7 = new StringBuilder();
            Object[] objArr17 = new Object[1];
            m5225b("諑발歈\uf770븂僓헩⃨㽞唟嬤情쳉襥衕᛫\udc8c֘\uf350撞埙멠佱䲯\uffdf섨虱ꨆﱙ츺碐蒿▯ᯬ䍡ႝ끝祪礎瑿꙰ؗ⡉ᱜ", ExpandableListView.getPackedPositionChild(0L) + 45, objArr17);
            ...
            m5225b("ﮝ쫤呖襳\uf786앜\u181b保䎴㛄雮썂⠳酣砙\ue5bd", 17 - (ViewConfiguration.getGlobalActionKeyTimeout() > 0L ? 1 : (ViewConfiguration.getGlobalActionKeyTimeout() == 0L ? 0 : -1)), objArr18);
