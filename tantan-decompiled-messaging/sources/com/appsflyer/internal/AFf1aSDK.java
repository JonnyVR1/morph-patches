...
public final class AFf1aSDK extends AFf1wSDK<AFg1zSDK> {
    ...
    private AFg1zSDK component1() throws InterruptedException, InterruptedIOException {
        ...
        if (str4 == null || str4.trim().length() == 0) {
            AFLogger.INSTANCE.m5247w(AFg1cSDK.REMOTE_CONTROL, "Dev key is not set, SDK is not started.");
        } else {
            if (str3 == null) {
                AFLogger.INSTANCE.m5247w(AFg1cSDK.REMOTE_CONTROL, "Can't create CDN token, domain or version is not provided.");
            } else {
            ...
            if (mediationNetwork == null) {
                AFLogger.INSTANCE.m5246v(AFg1cSDK.REMOTE_CONTROL, "can't create CDN token, skipping fetch config");
                return AFg1zSDK.FAILURE;
            }
            try {
                if (this.equals.getMediationNetwork()) {
                    AFLogger.INSTANCE.m5240d(AFg1cSDK.REMOTE_CONTROL, "active config is valid, skipping fetch");
                    return AFg1zSDK.USE_CACHED;
                }
                aFLogger = AFLogger.INSTANCE;
                aFg1cSDK = AFg1cSDK.REMOTE_CONTROL;
                aFLogger.m5245i(aFg1cSDK, "Cached config is expired, updating...");
                ...
                if (str != null && str.trim().length() != 0) {
                    ...
                    if (monetizationNetwork.AFAdRevenueData()) {
                        ...
                        aFLogger.m5247w(aFg1cSDK, "fetched config is not valid (MITM?) refuse to use it.");
                        return AFg1zSDK.FAILURE;
                    }
                    ...
                    sb2.append(" seconds");
                    aFLogger.m5246v(aFg1cSDK, sb2.toString());
                    ...
                    try {
                        try {
                            ...
                            sb3.append(" seconds");
                            aFLogger.m5240d(aFg1cSDK, sb3.toString());
                            ...
                            aFLogger2.m5244e(aFg1cSDK2, sb4.toString(), iOException, true, false, false);
                            ...
                            aFLogger3.m5244e(aFg1cSDK3, sb5.toString(), th2, true, false, false);
                ...
                aFLogger.m5247w(aFg1cSDK, "Dev key is not set, SDK is not started.");
                return AFg1zSDK.FAILURE;
        ...
        if (revenue.isSuccessful()) {
            ...
            aFLogger.m5247w(aFg1cSDK, sb6.toString());
            return AFg1zSDK.FAILURE;
        }
        body = revenue.getBody();
        currencyIso4217Code = revenue.getCurrencyIso4217Code("x-amz-meta-af-auth-v1");
        ...
        if (str != null) {
            ...
            sb7.append(" seconds");
            aFLogger.m5246v(aFg1cSDK, sb7.toString());
            ...
            sb8.append(" seconds");
            aFLogger.m5240d(aFg1cSDK, sb8.toString());
            getMonetizationNetwork(str2, jCurrentTimeMillis, monetizationNetwork.AFAdRevenueData, currencyIso4217Code2, revenue);
            return AFg1zSDK.SUCCESS;
        }
        aFLogger.m5247w(aFg1cSDK, "Dev key is not set, SDK is not started.");
    ...
    public final AFe1dSDK getMonetizationNetwork() throws Exception {
        try {
            ...
            e = e;
            AFLogger.INSTANCE.m5244e(AFg1cSDK.REMOTE_CONTROL, "RC update config failed", e, false, false, false);
