...
/* JADX INFO: renamed from: com.xiaomi.push.ei */
/* JADX INFO: loaded from: classes2.dex */
public enum EnumC14733ei {
    TCP_CONN_FAIL(1),
    TCP_CONN_TIME(2),
    PING_RTT(3),
    CHANNEL_CON_FAIL(4),
    ...
    CHANNEL_STATS_COUNTER(TXRecordCommon.AUDIO_SAMPLERATE_8000),
    ...
    GSLB_ERR(10999),
    CONN_SUCCESS(ijkStreamerUtil.FFS_PROP_INT64_CREAT_TIME),
    ...
    /* JADX INFO: renamed from: a */
    public static EnumC14733ei m85527a(int i) {
        if (i == 30501) {
            return BIND_TIMEOUT;
        }
        if (i == 30502) {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    case 10999:
                        return GSLB_ERR;
                    case ijkStreamerUtil.FFS_PROP_INT64_CREAT_TIME /* 20000 */:
                        return CONN_SUCCESS;
                    case 20199:
