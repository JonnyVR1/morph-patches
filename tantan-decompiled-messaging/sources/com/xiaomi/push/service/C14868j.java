...
public class C14868j {
    /* JADX INFO: renamed from: a */
    public static ComponentName m86671a(Context context, Intent intent) {
        if (intent == null) {
            return null;
        }
        try {
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m86672a(Context context, ComponentName componentName) {
        try {
