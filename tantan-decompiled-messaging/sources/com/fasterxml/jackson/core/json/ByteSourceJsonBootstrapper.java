...
import com.fasterxml.jackson.core.p029io.MergedStream;
import com.fasterxml.jackson.core.p029io.UTF32Reader;
...
public final class ByteSourceJsonBootstrapper {
    ...
    public Reader constructReader() throws IOException {
        ...
        if (iBits != 8 && iBits != 16) {
            ...
            upk0.m194883a(XEGiftErrorCode.ERROR_MSG_INTERNAL_ERROR);
            return null;
        }
