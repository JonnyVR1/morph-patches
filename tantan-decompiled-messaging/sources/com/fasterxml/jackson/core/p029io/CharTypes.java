...
public final class CharTypes {
    ...
    private static final byte[] f6871HB;

    /* JADX INFO: renamed from: HC */
    private static final char[] f6872HC;
    ...
    static {
        ...
        f6871HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f6871HB[i2] = (byte) f6872HC[i2];
        }
    ...
    public static byte[] copyHexBytes() {
        return (byte[]) f6871HB.clone();
    }

    public static char[] copyHexChars() {
        return (char[]) f6872HC.clone();
    }
