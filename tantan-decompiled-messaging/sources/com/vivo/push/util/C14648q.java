...
public final class C14648q {
    ...
    public static InsideNotificationItem m85023a(String str) {
        InsideNotificationItem insideNotificationItem = new InsideNotificationItem();
        try {
            if (TextUtils.isEmpty(str)) {
                C14647p.m85008a("MessageConvertUtil", "notify msg pack to obj is null");
                return null;
            }
            ...
            if (jSONArray.length() > 11) {
                insideNotificationItem.setParams(C14644m.m84993a(new JSONObject(jSONArray.getString(11))));
            }
            ...
            C14647p.m85009a("MessageConvertUtil", "notify msg pack to obj error", e);
            return insideNotificationItem;
        }
    }

    /* JADX INFO: renamed from: b */
    public static String m85025b(InsideNotificationItem insideNotificationItem) {
    ...
    /* JADX INFO: renamed from: a */
    public static UPSNotificationMessage m85024a(InsideNotificationItem insideNotificationItem) {
