...
import com.vivo.push.util.C14644m;
    ...
    private void packToObj(String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                C14647p.m85008a(TAG, "unvarnishedMsg pack to obj is null");
                return;
            }
            ...
            this.mParams = C14644m.m84993a(new JSONObject(jSONArray.getString(3)));
        } catch (JSONException e) {
            e.printStackTrace();
            C14647p.m85009a(TAG, "unvarnishedMsg pack to obj error", e);
        }
    }
