...
public class SubscribeAppInfo {
    ...
    public boolean equals(Object obj) {
        ...
        String str2 = subscribeAppInfo.mName;
        if (str == null) {
            if (str2 != null) {
                return false;
            }
    ...
    public String toString() {
        return "SubscribeAppInfo [mName=" + this.mName + ", mTargetStatus=" + this.mTargetStatus + ", mActualStatus=" + this.mActualStatus + Constants.AES_SUFFIX;
    }
}
