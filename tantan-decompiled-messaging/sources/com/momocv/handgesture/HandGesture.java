...
public class HandGesture {
    ...
    private static native boolean nativeProcessFrame(long j, MMFrame mMFrame, HandGestureParams handGestureParams, HandGestureInfo handGestureInfo);
    ...
    public synchronized boolean ProcessFrame(MMFrame mMFrame, HandGestureParams handGestureParams, HandGestureInfo handGestureInfo) {
        long j = this.mOBJPtr;
        if (j == 0 || !this.inited) {
            return false;
        }
        return nativeProcessFrame(j, mMFrame, handGestureParams, handGestureInfo);
    }
