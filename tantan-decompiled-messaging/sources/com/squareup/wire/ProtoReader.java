...
public final class ProtoReader {
    ...
    private void skipGroup(int i) throws IOException {
        while (this.pos < this.limit && !this.source.exhausted()) {
            ...
            if (i3 == 0) {
                ...
                aza0.m99642a("Unexpected end group");
                return;
            } else if (i3 != 5) {
                bza0.m104561a("Unexpected field encoding: ", i3);
                return;
            } else {
                this.state = 5;
                readFixed32();
    ...
    public long beginMessage() throws IOException {
        if (this.state != 2) {
            qkq0.m175383a("Unexpected call to beginMessage()");
            return 0L;
        }
        int i = this.recursionDepth + 1;
        this.recursionDepth = i;
        if (i > 65) {
            rhg0.m179353a("Wire recursion limit exceeded");
            return 0L;
        }
    ...
    public void endMessage(long j) throws IOException {
        if (this.state != 6) {
            qkq0.m175383a("Unexpected call to endMessage()");
            return;
        }
        int i = this.recursionDepth - 1;
        this.recursionDepth = i;
        if (i < 0 || this.pushedLimit != -1) {
            qkq0.m175383a("No corresponding call to beginMessage()");
            return;
        }
    ...
    public int nextTag() throws IOException {
        ...
        if (i != 6) {
            qkq0.m175383a("Unexpected call to nextTag()");
            return 0;
        }
        while (this.pos < this.limit && !this.source.exhausted()) {
            int iInternalReadVarint32 = internalReadVarint32();
            ...
            if (i3 == 2) {
                ...
                if (iInternalReadVarint33 < 0) {
                    bza0.m104561a("Negative length: ", iInternalReadVarint33);
                    return 0;
                }
    ...
    public long readVarint64() throws IOException {
        ...
        aza0.m99642a("WireInput encountered a malformed varint");
        return 0L;
    }
    ...
    public void skip() throws IOException {
        ...
        if (i == 2) {
            ...
            qkq0.m175383a("Unexpected call to skip()");
        }
    }
}
