...
public final class Internal {
    ...
    public static void checkElementsNotNull(Map<?, ?> map) {
        if (map == null) {
            jfd0.m141176a("map == null");
            return;
        }
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            if (entry.getKey() == null) {
                jfd0.m141176a("map.containsKey(null)");
                return;
    ...
    public static <K, V> Map<K, V> immutableCopyOf(String str, Map<K, V> map) {
        ...
        if (linkedHashMap.containsKey(null)) {
            ock0.m163533a(str, ".containsKey(null)");
            return null;
        }
        if (!linkedHashMap.containsValue(null)) {
            return Collections.unmodifiableMap(linkedHashMap);
        }
        ock0.m163533a(str, ".containsValue(null)");
        return null;
    }
    ...
    public static <T> List<T> immutableCopyOf(String str, List<T> list) {
        if (list != null) {
            ...
            ock0.m163533a(str, ".contains(null)");
            return null;
        }
        jxm.m143817a(str, " == null");
        return null;
