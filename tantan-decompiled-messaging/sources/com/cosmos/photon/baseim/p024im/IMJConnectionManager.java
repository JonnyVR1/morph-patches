...
public class IMJConnectionManager implements IConnectionManager {
    ...
    @Override // com.cosmos.photon.baseim.p024im.IConnectionManager
    ...
    @Override // com.cosmos.photon.baseim.p024im.IConnectionManager
    public void release() {
        MDLog.m7395i(TAG, "connectionManagerNative release");
    ...
    public void startIMJ() {
        MDLog.m7395i(TAG, "connectionManagerNative startIMJ");
        this.isStarted = true;
    ...
    @Override // com.cosmos.photon.baseim.p024im.IConnectionManager
    public void stopIMJ() {
        MDLog.m7395i(TAG, "connectionManagerNative stopIMJ");
        this.isStarted = false;
