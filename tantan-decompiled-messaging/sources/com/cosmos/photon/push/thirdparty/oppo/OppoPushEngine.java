...
public class OppoPushEngine implements IPushEngine {
    ...
    public static boolean isSupport(Context context) {
        ...
        if (!zIsSupportPush) {
            PushLogger.m7402e("OppoPush not support");
        }
    ...
    public void register() {
        try {
            ...
            PushLogger.m7404i("oppopush register " + string2 + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + string);
            ...
            PushLogger.m7404i("OPush register 失败:" + e.getMessage());
        }
    }
    ...
    public void unregister() {
        ...
        try {
            ...
            PushLogger.m7404i("OPush unregister 失败:" + e.getMessage());
