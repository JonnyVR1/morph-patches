package com.cosmos.photon.push.thirdparty.p025mi;
...
public class MiMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage miPushMessage) {
        ...
        PushLogger.m7404i("MiPush onNotificationMessageArrived: " + miPushMessage);
    ...
    public void onReceiveRegisterResult(Context context, MiPushCommandMessage miPushCommandMessage) {
        ...
        if ("register".equals(command)) {
            ...
            PushLogger.m7404i("Xiaomi register result:" + miPushCommandMessage.getResultCode());
            if (miPushCommandMessage.getResultCode() == 0) {
                if (zEqualsIgnoreCase) {
                    MiPushEngine.pushBridge.onPushRegisterResult(10, 1001, str);
                }
                PushLogger.m7404i("MiPush ID from Xiaomi:" + str);
            } else {
