...
public class MoNotify implements Serializable {
    ...
    public static MoNotify fromJson(String str) {
        try {
            ...
            moNotify.f5810id = jSONObject.optString("id");
    ...
    public String toJson() {
        ...
        try {
            jSONObject.put("id", this.f5810id);
    ...
    public String toString() {
        return "MoNotify{id='" + this.f5810id + "', toPkg='" + this.toPkg + "', type='" + this.type + "', title='" + this.title + "', desc='" + this.desc + "', action='" + this.action + "', actionType=" + this.actionType + ", icon='" + this.icon + "', sound=" + this.sound + ", soundType='" + this.soundType + "', vibrate=" + this.vibrate + ", light=" + this.light + '}';
    }

    public static MoNotify create(NotifyV2 notifyV2) {
        MoNotify moNotify = new MoNotify();
        moNotify.f5810id = notifyV2.getId();
