...
import com.immomo.push.p040pb.Disconnect;
import com.immomo.push.p040pb.PbPacketBody;
import com.immomo.push.p040pb.SAuthRet;
...
public class PushImManager implements ConnectStateChangeListener, Handler.Callback, NetUtil.NetChangeReceiver {
    ...
    private boolean isNetAccessible() {
        MDLog.m7396i(LogTag.f5808IM, "isNetAccessible : %s (%b, %d)", (this.isNetAvailable || this.connectRetryCount <= 3) ? "Available" : "Unavailable", Boolean.valueOf(this.isNetAvailable), Integer.valueOf(this.connectRetryCount));
    ...
    public void processAp(String str) {
        ...
        if (strArrSplit.length == 2) {
            ...
            try {
                ...
                MDLog.printErrStackTrace(LogTag.f5808IM, e);
            }
        }
    }
    ...
    public void addPshLtBlackList(String str) {
        ...
        MDLog.m7390d(LogTag.f5808IM, "addPshLtBlackList %s", str);
            ...
            if (i == 2) {
                ...
                this.pushClient.registerPacketReceiver(BodyType.SAUTH_RET.getNumber(), new PacketReceiver() { // from class: com.cosmos.photon.push.PushImManager.2
                    ...
                    public void onReceivePacket(byte[] bArr) {
                        ...
                        MDLog.m7395i(LogTag.f5808IM, "onReceivePacket");
                        try {
                    ...
                    public void processAuthResult(SAuthRet sAuthRet) {
                        ...
                        if (ec == 0) {
                            MDLog.m7395i(LogTag.f5808IM, "auth success");
                            ...
                            MDLog.m7395i(LogTag.f5808IM, "auth redirect");
                            ...
                            MDLog.m7395i(LogTag.f5808IM, "auth failed");
                            PushImManager.this.forbiddenAutoConnect = true;
                            PushImManager.this.pushClient.stopSync();
                            PushImManager.this.pushClient.stopKeepAlive();
    ...
    public void onConnectStateChanged(int i) {
        try {
            ...
            if (!isNetAccessible()) {
                MDLog.m7395i(LogTag.f5808IM, "network unavailable, pause reconnect");
                this.pausedNetAvailable = true;
                return;
            }
            this.autoRetryLevelStep[this.currentRetryLevel].currentRetryCount++;
            MDLog.m7392e(LogTag.f5808IM, "Auto Connect retry %d times at level_%d ", Integer.valueOf(this.autoRetryLevelStep[this.currentRetryLevel].currentRetryCount), Integer.valueOf(this.currentRetryLevel));
            if (this.autoRetryLevelStep[this.currentRetryLevel].currentRetryCount >= this.autoRetryLevelStep[this.currentRetryLevel].maxRetryCount) {
                if (this.currentRetryLevel < 5) {
                    ...
                    MDLog.m7392e(LogTag.f5808IM, "Auto Connect retry level increase to %d", Integer.valueOf(this.currentRetryLevel));
                } else {
                    MDLog.m7391e(LogTag.f5808IM, "Auto Connect at highest level");
                }
            }
            int i2 = this.autoRetryLevelStep[this.currentRetryLevel].waitTime;
            MDLog.m7396i(LogTag.f5808IM, "reconnect delay %d seconds", Integer.valueOf(i2));
            if (this.handler.hasMessages(1)) {
                MDLog.m7391e(LogTag.f5808IM, "already has connect message,no need to repeat send another");
            } else {
                this.handler.sendEmptyMessageDelayed(1, i2 * 1000);
            }
        } catch (Throwable th) {
            MDLog.printErrStackTrace(LogTag.f5808IM, th);
        }
    }
    ...
    public void onNetworkChanged() {
        ...
        if (!this.isNetAvailable) {
            MDLog.m7391e(LogTag.f5808IM, "onNetworkChanged unavailable");
            return;
        }
        MDLog.m7395i(LogTag.f5808IM, "onNetworkChanged available");
        if (!this.pausedNetAvailable || this.forbiddenAutoConnect) {
            return;
        }
        this.pausedNetAvailable = false;
        MDLog.m7395i(LogTag.f5808IM, "reconnect when network restored");
        this.handler.sendEmptyMessage(1);
    }
    ...
    public void removePshLtBlackList(String str) {
        if (str != null) {
            MDLog.m7390d(LogTag.f5808IM, "removePshLtBlackList %s", str);
    ...
    public void sendSyncRequest(String str) {
        ...
        MDLog.m7390d(LogTag.f5808IM, "sendSyncRequest %s", str);
