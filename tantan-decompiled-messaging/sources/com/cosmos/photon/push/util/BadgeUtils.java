...
public class BadgeUtils {
    ...
    public static int getMiuiVersion() throws Throwable {
        ...
        try {
            ...
            MDLog.m7391e(LogTag.NOTIFY, "get miui version code error, version : ".concat(systemProperty));
            return -1;
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        MDLog.m7392e(LogTag.NOTIFY, "Exception while closing InputStream", e);
                        return line;
                    }
                } catch (IOException e2) {
                    e = e2;
                    MDLog.m7392e(LogTag.NOTIFY, "Unable to read sysprop " + str, e);
                    if (bufferedReader != null) {
                        try {
                            bufferedReader.close();
                        } catch (IOException e3) {
                            MDLog.m7392e(LogTag.NOTIFY, "Exception while closing InputStream", e3);
                        }
                    }
                    return null;
                }
                ...
                if (bufferedReader3 != null) {
                    try {
                        ...
                        MDLog.m7392e(LogTag.NOTIFY, "Exception while closing InputStream", e4);
                    }
                }
                throw th;
            }
