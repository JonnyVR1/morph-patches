...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    @NonNull
    public static final Parcelable.Creator<CloudMessage> CREATOR = new xzq0();
    ...
    @KeepForSdk
    public CloudMessage(@NonNull @SafeParcelable.Param(m12464id = 1) Intent intent) {
        this.zza = intent;
    }

    @NonNull
    /* JADX INFO: renamed from: F */
    public Intent m12448F() {
        return this.zza;
    }

    @Nullable
    /* JADX INFO: renamed from: H */
    public final Integer m12449H() {
