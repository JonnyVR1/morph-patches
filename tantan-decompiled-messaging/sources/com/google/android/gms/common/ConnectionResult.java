...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m12463id = 2)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getResolution", m12463id = 3)
    private final PendingIntent zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m12463id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m12464id = 1) int i, @SafeParcelable.Param(m12464id = 2) int i2, @Nullable @SafeParcelable.Param(m12464id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m12464id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
