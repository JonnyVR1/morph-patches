...
public class GooglePlayServicesUtilLight {
    ...
    /* JADX WARN: Code duplicated, block: B:52:0x00ce A[RETURN, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:53:0x00d0  */
    /* JADX WARN: Code duplicated, block: B:61:0x00ec A[RETURN, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:62:0x00ee A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:65:0x00d4 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    @KeepForSdk
    @Deprecated
    public static int isGooglePlayServicesAvailable(@NonNull Context context, int i) {
        ...
        try {
            context.getResources().getString(C2083R.string.common_google_play_services_unknown_issue);
