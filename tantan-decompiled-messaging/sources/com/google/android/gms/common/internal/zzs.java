...
final class zzs extends GmsClientSupervisor {
    ...
    public zzs(Context context, Looper looper, @Nullable Executor executor) {
        ...
        this.zzd = new bkx0(looper, zzrVar);
        this.zzf = ConnectionTracker.getInstance();
        this.zzg = com.clevertap.android.sdk.Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS;
        this.zzh = com.clevertap.android.sdk.Constants.INBOX_V2_THROTTLE_WINDOW_MS;
        this.zzi = executor;
    }
    ...
    public final void zzj(Looper looper) {
        synchronized (this.zzb) {
            this.zzd = new bkx0(looper, this.zze);
        }
    }
}
