...
public final class zac {
    private static final hgf0 zaa = new hgf0();
    ...
    public static String zab(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(R$string.f9789d);
        }
        if (i != 2) {
            return i != 3 ? resources.getString(R.string.ok) : resources.getString(R$string.f9786a);
        }
        return resources.getString(R$string.f9795j);
    }
    ...
    public static String zac(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(R$string.f9790e, strZaa);
        }
        if (i == 2) {
            return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(R$string.f9799n) : resources.getString(R$string.f9796k, strZaa);
        }
        if (i == 3) {
            return resources.getString(R$string.f9787b, strZaa);
        }
        if (i == 5) {
        ...
        if (i == 9) {
            return resources.getString(R$string.f9794i, strZaa);
        }
        if (i == 20) {
        ...
        switch (i) {
            ...
            case 18:
                return resources.getString(R$string.f9798m, strZaa);
            default:
                return resources.getString(C2083R.string.common_google_play_services_unknown_issue, strZaa);
        }
    }
    ...
    public static String zae(Context context, int i) {
        ...
        return strZah == null ? context.getResources().getString(R$string.f9793h) : strZah;
    }
    ...
    public static String zaf(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(R$string.f9791f);
            case 2:
                return resources.getString(R$string.f9797l);
            case 3:
                return resources.getString(R$string.f9788c);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zag(Context context, String str, String str2) {
        ...
        if (strZah == null) {
            strZah = resources.getString(C2083R.string.common_google_play_services_unknown_issue);
        }
    ...
    private static String zah(Context context, String str) {
        hgf0 hgf0Var = zaa;
        synchronized (hgf0Var) {
            try {
                Locale localeM118324b = qv5.m176692a(context.getResources().getConfiguration()).m118324b(0);
                if (!localeM118324b.equals(zab)) {
                    hgf0Var.clear();
                    zab = localeM118324b;
                }
                String str2 = (String) hgf0Var.get(str);
                if (str2 != null) {
                    return str2;
                }
