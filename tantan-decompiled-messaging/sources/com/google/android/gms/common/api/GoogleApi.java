...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    private final Task zae(int i, @NonNull TaskApiCall taskApiCall) {
        ...
        this.zaa.zav(this, i, taskApiCall, sei0Var, this.zaj);
    ...
    public ClientSettings.Builder createClientSettingsBuilder() {
        ...
        Set<Scope> setM12409j0 = (!(apiOptions3 instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) apiOptions3).getGoogleSignInAccount()) == null) ? Collections.EMPTY_SET : googleSignInAccount.m12409j0();
        builder.zaa(setM12409j0);
