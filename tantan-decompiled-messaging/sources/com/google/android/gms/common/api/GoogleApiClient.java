    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                e01Var.put(api2, Boolean.valueOf(z2));
                ...
                e01Var2.put(api2.zab(), clientBuildClient);
            ...
            if (api != null) {
                if (z) {
                    r2j.m177608a("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder");
                    return null;
                }
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, e01Var, this.zaq, this.zar, e01Var2, this.zal, zabe.zad(e01Var2.values(), true), arrayList);
        ...
        public final ClientSettings zaa() {
            v3f0 v3f0Var = v3f0.f179786j;
            Map map = this.zaj;
            Api api = dyq0.f88422g;
            if (map.containsKey(api)) {
                v3f0Var = (v3f0) this.zaj.get(api);
            }
            return new ClientSettings(this.zaa, this.zab, this.zah, this.zad, this.zae, this.zaf, this.zag, v3f0Var, false);
        }
