...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", m12463id = 1)
    private final int zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", m12463id = 2)
    private final String zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m12463id = 3)
    private final PendingIntent zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getConnectionResult", m12463id = 4)
    ...
    public Status(@SafeParcelable.Param(m12464id = 1) int i, @Nullable @SafeParcelable.Param(m12464id = 2) String str, @Nullable @SafeParcelable.Param(m12464id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m12464id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = str;
    ...
    public void startResolutionForResult(@NonNull g60<IntentSenderRequest> g60Var) {
        if (hasResolution()) {
            PendingIntent pendingIntent = this.zzd;
            Preconditions.checkNotNull(pendingIntent);
            g60Var.m124547b(new IntentSenderRequest.C0054b(pendingIntent.getIntentSender()).m226a());
        }
    }
