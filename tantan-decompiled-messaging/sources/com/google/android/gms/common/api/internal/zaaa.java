...
final class zaaa implements zaca {
    ...
    private zaaa(Context context, zabe zabeVar, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map map, Map map2, ClientSettings clientSettings, Api.AbstractClientBuilder abstractClientBuilder, @Nullable Api.Client client, ArrayList arrayList, ArrayList arrayList2, Map map3, Map map4) {
        ...
        while (it.hasNext()) {
            e01Var.put((Api.AnyClientKey) it.next(), this.zad);
        }
        Iterator it2 = map.keySet().iterator();
        while (it2.hasNext()) {
            e01Var.put((Api.AnyClientKey) it2.next(), this.zae);
        }
        this.zaf = Collections.unmodifiableMap(e01Var);
    }
    ...
    public static zaaa zag(Context context, zabe zabeVar, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map map, ClientSettings clientSettings, Map map2, Api.AbstractClientBuilder abstractClientBuilder, ArrayList arrayList) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (client2.requiresSignIn()) {
                e01Var.put((Api.AnyClientKey) entry.getKey(), client2);
            } else {
                e01Var2.put((Api.AnyClientKey) entry.getKey(), client2);
            }
        }
        Preconditions.checkState(!e01Var.isEmpty(), "CompositeGoogleApiClient should not be used without any APIs that require sign-in.");
        e01 e01Var3 = new e01();
        e01 e01Var4 = new e01();
        for (Api api : map2.keySet()) {
            Api.AnyClientKey anyClientKeyZab = api.zab();
            if (e01Var.containsKey(anyClientKeyZab)) {
                e01Var3.put(api, (Boolean) map2.get(api));
            } else {
                if (!e01Var2.containsKey(anyClientKeyZab)) {
                    qkq0.m175383a("Each API in the isOptionalMap must have a corresponding client in the clients map.");
                    return null;
                }
                e01Var4.put(api, (Boolean) map2.get(api));
            }
        }
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (e01Var3.containsKey(zatVar.zaa)) {
                arrayList2.add(zatVar);
            } else {
                if (!e01Var4.containsKey(zatVar.zaa)) {
                    qkq0.m175383a("Each ClientCallbacks must have a corresponding API in the isOptionalMap");
                    return null;
                }
                arrayList3.add(zatVar);
            }
        }
        return new zaaa(context, zabeVar, lock, looper, googleApiAvailabilityLight, e01Var, e01Var2, clientSettings, abstractClientBuilder, client, arrayList2, arrayList3, e01Var3, e01Var4);
    }
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), client.getSignInIntent(), czq0.f83105a | 134217728);
    }
    ...
    public final void zau() {
        ...
        try {
            ...
            if (zZax) {
                new hzq0(this.zac).post(new zav(this));
            } else {
                zaB();
            }
        } finally {
