...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    private final void zal(int i) {
        ...
        if (num == null) {
            ...
            rad0.m178492a("Cannot use sign-in mode: ", zag(i), ". Mode was already set to ", zag(this.zaw.intValue()));
            return;
        }
        if (this.zal != null) {
            return;
        ...
        if (iIntValue != 1) {
            ...
            qkq0.m175383a("SIGN_IN_MODE_REQUIRED cannot be used on a GoogleApiClient that does not contain any authenticated APIs. Use connect() instead.");
            return;
        } else if (zProvidesSignIn) {
            qkq0.m175383a("Cannot use SIGN_IN_MODE_REQUIRED with GOOGLE_SIGN_IN_API. Use connect(SIGN_IN_MODE_OPTIONAL) instead.");
            return;
        }
    ...
    public final void stopAutoManage(@NonNull FragmentActivity fragmentActivity) {
        ...
        if (this.zam >= 0) {
            ...
            qkq0.m175383a("Called stopAutoManage but automatic lifecycle management is not enabled.");
        }
    }
