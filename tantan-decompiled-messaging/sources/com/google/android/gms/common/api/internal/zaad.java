...
public final class zaad {
    ...
    private final void zah(boolean z, Status status) {
        ...
        for (Map.Entry entry2 : map2.entrySet()) {
            if (z || ((Boolean) entry2.getValue()).booleanValue()) {
                ((sei0) entry2.getKey()).m183660d(new ApiException(status));
            }
        }
    }
    ...
    public final void zad(sei0 sei0Var, boolean z) {
        this.zab.put(sei0Var, Boolean.valueOf(z));
        sei0Var.m183657a().addOnCompleteListener(new zaac(this, sei0Var));
    }
