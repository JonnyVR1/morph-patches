...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, v8c0.f180462a, 0, 0);
        try {
            this.zaa = typedArrayObtainStyledAttributes.getInt(v8c0.f180463b, 0);
            this.zab = typedArrayObtainStyledAttributes.getInt(v8c0.f180464c, 2);
