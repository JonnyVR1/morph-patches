...
public class ModuleInstallResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", getter = "getShouldUnregisterListener", m12463id = 2)
    private final boolean zab;

    @SafeParcelable.Constructor
    public ModuleInstallResponse(@SafeParcelable.Param(m12464id = 1) int i, @SafeParcelable.Param(m12464id = 2) boolean z) {
        this.zaa = i;
        this.zab = z;
    }
