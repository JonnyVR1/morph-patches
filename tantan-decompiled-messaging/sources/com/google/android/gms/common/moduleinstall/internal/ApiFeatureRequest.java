...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getApiFeatures", m12463id = 1)
    private final List zab;

    @SafeParcelable.Field(getter = "getIsUrgent", m12463id = 2)
    private final boolean zac;

    @Nullable
    @SafeParcelable.Field(getter = "getFeatureRequestSessionId", m12463id = 3)
    private final String zad;

    @Nullable
    @SafeParcelable.Field(getter = "getCallingPackage", m12463id = 4)
    private final String zae;

    @SafeParcelable.Constructor
    public ApiFeatureRequest(@NonNull @SafeParcelable.Param(m12464id = 1) List list, @SafeParcelable.Param(m12464id = 2) boolean z, @Nullable @SafeParcelable.Param(m12464id = 3) String str, @Nullable @SafeParcelable.Param(m12464id = 4) String str2) {
