...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUrl", m12463id = 2)
    private final Uri zab;

    @SafeParcelable.Field(getter = "getWidth", m12463id = 3)
    private final int zac;

    @SafeParcelable.Field(getter = "getHeight", m12463id = 4)
    ...
    public WebImage(@NonNull Uri uri, int i, int i2) throws IllegalArgumentException {
        this(1, uri, i, i2);
        if (uri == null) {
            ig3.m135964a("url cannot be null");
            throw null;
        }
        if (i < 0 || i2 < 0) {
            ig3.m135964a("width and height must not be negative");
            throw null;
        }
    }

    @SafeParcelable.Constructor
    public WebImage(@SafeParcelable.Param(m12464id = 1) int i, @SafeParcelable.Param(m12464id = 2) Uri uri, @SafeParcelable.Param(m12464id = 3) int i2, @SafeParcelable.Param(m12464id = 4) int i3) {
        this.zaa = i;
        this.zab = uri;
        this.zac = i2;
        this.zad = i3;
