...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", m12463id = 1)
    private final List zza;

    @Nullable
    @SafeParcelable.Field(getter = "getExtras", m12463id = 2)
    private Bundle zzb;

    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m12464id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@NonNull @SafeParcelable.Param(m12464id = 1) List list, @Nullable @SafeParcelable.Param(m12464id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
