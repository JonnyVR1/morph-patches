...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", m12463id = 1)
    private final Status zza;

    @Nullable
    @SafeParcelable.Field(getter = "getLocationSettingsStates", m12463id = 2)
    private final LocationSettingsStates zzb;

    @SafeParcelable.Constructor
    public LocationSettingsResult(@NonNull @SafeParcelable.Param(m12464id = 1) Status status, @Nullable @SafeParcelable.Param(m12464id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
