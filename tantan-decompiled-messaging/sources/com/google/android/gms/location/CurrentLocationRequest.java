...
public final class CurrentLocationRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "Granularity.GRANULARITY_PERMISSION_LEVEL", getter = "getGranularity", m12463id = 2)
    private final int zzb;

    @SafeParcelable.Field(defaultValueUnchecked = "Priority.PRIORITY_BALANCED_POWER_ACCURACY", getter = "getPriority", m12463id = 3)
    private final int zzc;

    @SafeParcelable.Field(defaultValueUnchecked = "Long.MAX_VALUE", getter = "getDurationMillis", m12463id = 4)
    private final long zzd;

    @SafeParcelable.Field(defaultValue = "false", getter = "isBypass", m12463id = 5)
    private final boolean zze;

    @SafeParcelable.Field(defaultValueUnchecked = "ThrottleBehavior.THROTTLE_BACKGROUND", getter = "getThrottleBehavior", m12463id = 7)
    private final int zzf;

    @Nullable
    @SafeParcelable.Field(getter = "getModuleId", m12463id = 8)
    private final String zzg;

    @SafeParcelable.Field(defaultValueUnchecked = "new android.os.WorkSource()", getter = "getWorkSource", m12463id = 6)
    private final WorkSource zzh;

    @Nullable
    @SafeParcelable.Field(getter = "getImpersonation", m12463id = 9)
    private final com.google.android.gms.internal.location.zzd zzi;

    @SafeParcelable.Constructor
    public CurrentLocationRequest(@SafeParcelable.Param(m12464id = 1) long j, @SafeParcelable.Param(m12464id = 2) int i, @SafeParcelable.Param(m12464id = 3) int i2, @SafeParcelable.Param(m12464id = 4) long j2, @SafeParcelable.Param(m12464id = 5) boolean z, @SafeParcelable.Param(m12464id = 7) int i3, @Nullable @SafeParcelable.Param(m12464id = 8) String str, @SafeParcelable.Param(m12464id = 6) WorkSource workSource, @Nullable @SafeParcelable.Param(m12464id = 9) com.google.android.gms.internal.location.zzd zzdVar) {
        boolean z2 = true;
