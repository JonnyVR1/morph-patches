...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationResult.DEFAULT_LOCATIONS", getter = "getLocations", m12463id = 1)
    ...
    public LocationResult(@SafeParcelable.Param(m12464id = 1) List list) {
        this.zzb = list;
    }
