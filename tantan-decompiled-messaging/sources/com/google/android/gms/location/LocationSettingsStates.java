...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "isGpsUsable", m12463id = 1)
    private final boolean zza;

    @SafeParcelable.Field(getter = "isNetworkLocationUsable", m12463id = 2)
    private final boolean zzb;

    @SafeParcelable.Field(getter = "isBleUsable", m12463id = 3)
    private final boolean zzc;

    @SafeParcelable.Field(getter = "isGpsPresent", m12463id = 4)
    private final boolean zzd;

    @SafeParcelable.Field(getter = "isNetworkLocationPresent", m12463id = 5)
    private final boolean zze;

    @SafeParcelable.Field(getter = "isBlePresent", m12463id = 6)
    private final boolean zzf;

    @SafeParcelable.Constructor
    public LocationSettingsStates(@SafeParcelable.Param(m12464id = 1) boolean z, @SafeParcelable.Param(m12464id = 2) boolean z2, @SafeParcelable.Param(m12464id = 3) boolean z3, @SafeParcelable.Param(m12464id = 4) boolean z4, @SafeParcelable.Param(m12464id = 5) boolean z5, @SafeParcelable.Param(m12464id = 6) boolean z6) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = z3;
        this.zzd = z4;
