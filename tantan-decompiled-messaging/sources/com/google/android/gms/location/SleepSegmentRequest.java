...
public class SleepSegmentRequest extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getUserPreferredSleepWindow", m12463id = 1)
    private final List zza;

    @SafeParcelable.Field(defaultValue = "0", getter = "getRequestedDataType", m12463id = 2)
    private final int zzb;

    @ShowFirstParty
    @SafeParcelable.Constructor
    public SleepSegmentRequest(@Nullable @SafeParcelable.Param(m12464id = 1) List list, @SafeParcelable.Param(m12464id = 2) int i) {
        this.zza = list;
        this.zzb = i;
    }
