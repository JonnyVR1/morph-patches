...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(m12464id = 1) List list, @SafeParcelable.Param(m12464id = 2) long j, @SafeParcelable.Param(m12464id = 3) long j2, @SafeParcelable.Param(m12464id = 4) int i, @Nullable @SafeParcelable.Param(m12464id = 5) Bundle bundle) {
