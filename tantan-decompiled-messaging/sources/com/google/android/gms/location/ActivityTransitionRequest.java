...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityTransitions", m12463id = 1)
    private final List zza;

    @Nullable
    @SafeParcelable.Field(getter = "getTag", m12463id = 2)
    private final String zzb;

    @SafeParcelable.Field(getter = "getClients", m12463id = 3)
    private final List zzc;

    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getContextAttributionTag", m12463id = 4)
    private String zzd;

    @SafeParcelable.Constructor
    public ActivityTransitionRequest(@NonNull @SafeParcelable.Param(m12464id = 1) List list, @Nullable @SafeParcelable.Param(m12464id = 2) String str, @Nullable @SafeParcelable.Param(m12464id = 3) List list2, @Nullable @SafeParcelable.Param(m12464id = 4) String str2) {
    ...
    public String toString() {
        return "ActivityTransitionRequest [mTransitions=" + String.valueOf(this.zza) + ", mTag='" + this.zzb + "', mClients=" + String.valueOf(this.zzc) + ", mAttributionTag=" + this.zzd + Constants.AES_SUFFIX;
    }
