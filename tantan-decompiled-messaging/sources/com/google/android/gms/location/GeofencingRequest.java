...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getParcelableGeofences", m12463id = 1)
    private final List zza;

    @InitialTrigger
    @SafeParcelable.Field(getter = "getInitialTrigger", m12463id = 2)
    private final int zzb;

    @SafeParcelable.Field(defaultValue = "", getter = "getTag", m12463id = 3)
    private final String zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getContextAttributionTag", m12463id = 4)
    ...
    public GeofencingRequest(@SafeParcelable.Param(m12464id = 1) List list, @SafeParcelable.Param(m12464id = 2) @InitialTrigger int i, @SafeParcelable.Param(m12464id = 3) String str, @Nullable @SafeParcelable.Param(m12464id = 4) String str2) {
        this.zza = list;
        this.zzb = i;
        this.zzc = str;
        this.zzd = str2;
