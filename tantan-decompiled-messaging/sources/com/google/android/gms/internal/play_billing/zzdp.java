...
final class zzdp extends zzcr {
    ...
    public static zzdp zzg(int i, Object[] objArr, C2374b c2374b) {
        boolean z;
        int i2;
        char c;
        ?? r3;
        ...
        m5s0.m153143b(i4, objArrCopyOf.length >> 1, FirebaseAnalytics.Param.INDEX);
        ...
        if (i4 != 1) {
            ...
            if (iZzh <= 128) {
                ...
                while (i7 < i4) {
                    ...
                    vrs0.m199752b(obj3, obj4);
                    int iM129457a = h5t0.m129457a(obj3.hashCode());
                    while (true) {
                        int i11 = iM129457a & i6;
                        z2 = z5;
                        i3 = i5;
                        ...
                        if (obj3.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                            ...
                            tgt0 tgt0Var5 = new tgt0(obj3, obj4, obj5);
                ...
                if (iZzh <= 32768) {
                    ...
                    for (int i15 = 0; i15 < i4; i15++) {
                        ...
                        vrs0.m199752b(obj6, obj7);
                        int iM129457a2 = h5t0.m129457a(obj6.hashCode());
                        while (true) {
                            int i18 = iM129457a2 & i6;
                            ...
                            if (obj6.equals(objArrCopyOf[c4])) {
                                ...
                                tgt0 tgt0Var6 = new tgt0(obj6, obj7, obj8);
                    ...
                    if (i14 == i4) {
                        ...
                        r5 = new Object[]{sArr, Integer.valueOf(i14), tgt0Var4};
                        z4 = z;
                    }
                } else {
                    ...
                    while (i20 < i4) {
                        ...
                        vrs0.m199752b(obj9, obj10);
                        int iM129457a3 = h5t0.m129457a(obj9.hashCode());
                        while (true) {
                            int i24 = iM129457a3 & i6;
                            int i25 = iArr[i24];
                            if (i25 == -1) {
                                iArr[i24] = i22;
                                if (i21 < i20) {
                            ...
                            if (obj9.equals(objArrCopyOf[i25])) {
                                ...
                                tgt0 tgt0Var7 = new tgt0(obj9, obj10, obj11);
            ...
            if (z3) {
                objArr2 = (Object[]) r3;
                tgt0Var = (tgt0) objArr2[c];
                if (c2374b != null) {
                    throw tgt0Var.m188825a();
                }
                c2374b.f10309c = tgt0Var;
        ...
        if (obj == null) {
            ...
            if (i == 1) {
                ...
                if (obj4 == null) {
                    ...
                    int iM129457a2 = h5t0.m129457a(obj.hashCode());
                    while (true) {
                        int i4 = iM129457a2 & length2;
                        char c = (char) sArr[i4];
                        if (c == 65535) {
                            break;
                        }
                    ...
                    int iM129457a3 = h5t0.m129457a(obj.hashCode());
                    while (true) {
                        int i5 = iM129457a3 & length3;
                        int i6 = iArr[i5];
                        if (i6 == -1) {
                            break;
                        }
