...
final class zzaq extends zzai {
    ...
    public static zzaq zzg(int i, Object[] objArr, C2370a c2370a) {
        int iHighestOneBit;
        boolean z;
        int i2;
        char c;
        ...
        gny0.m127204b(i4, objArrCopyOf.length >> 1, FirebaseAnalytics.Param.INDEX);
        char c3 = 2;
        ...
        if (i4 != 1) {
            ...
            if (iHighestOneBit <= 128) {
                ...
                while (i7 < i4) {
                    ...
                    dsy0.m113500a(obj3, obj4);
                    int iM156607a = mvy0.m156607a(obj3.hashCode());
                    while (true) {
                        int i11 = iM156607a & i6;
                        z2 = z5;
                        i3 = i5;
                        ...
                        if (obj3.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                            ...
                            car0 car0Var5 = new car0(obj3, obj4, obj5);
                ...
                if (iHighestOneBit <= 32768) {
                    ...
                    for (int i15 = 0; i15 < i4; i15++) {
                        ...
                        dsy0.m113500a(obj6, obj7);
                        int iM156607a2 = mvy0.m156607a(obj6.hashCode());
                        while (true) {
                            int i18 = iM156607a2 & i6;
                            ...
                            if (obj6.equals(objArrCopyOf[c4])) {
                                ...
                                car0 car0Var6 = new car0(obj6, obj7, obj8);
                    ...
                    if (i14 == i4) {
                        ...
                        r5 = new Object[]{sArr, Integer.valueOf(i14), car0Var4};
                        z4 = z;
                    }
                } else {
                    ...
                    while (i20 < i4) {
                        ...
                        dsy0.m113500a(obj9, obj10);
                        int iM156607a3 = mvy0.m156607a(obj9.hashCode());
                        while (true) {
                            int i24 = iM156607a3 & i6;
                            int i25 = iArr[i24];
                            if (i25 == -1) {
                                iArr[i24] = i22;
                                if (i21 < i20) {
                            ...
                            if (obj9.equals(objArrCopyOf[i25])) {
                                ...
                                car0 car0Var7 = new car0(obj9, obj10, obj11);
            ...
            if (z3) {
                objArr2 = (Object[]) r3;
                car0Var = (car0) objArr2[c];
                if (c2370a != null) {
                    throw car0Var.m105934a();
                }
                c2370a.f10303c = car0Var;
        ...
        if (obj == null) {
            ...
            if (i == 1) {
                ...
                if (obj4 == null) {
                    ...
                    int iM156607a = mvy0.m156607a(obj.hashCode());
                    while (true) {
                        int i2 = iM156607a & length;
                        int i3 = bArr[i2] & 255;
                        if (i3 == 255) {
                            break;
                        }
                    ...
                    int iM156607a2 = mvy0.m156607a(obj.hashCode());
                    while (true) {
                        int i4 = iM156607a2 & length2;
                        char c = (char) sArr[i4];
                        if (c == 65535) {
                            break;
                        }
                    ...
                    int iM156607a3 = mvy0.m156607a(obj.hashCode());
                    while (true) {
                        int i5 = iM156607a3 & length3;
                        int i6 = iArr[i5];
                        if (i6 == -1) {
                            break;
                        }
