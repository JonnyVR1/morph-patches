...
public final class zzagk extends zzagr {
    public static final Parcelable.Creator<zzagk> CREATOR = new jar0();
    public final String zza;
    public final String zzb;
    public final String zzc;

    public zzagk(Parcel parcel) {
        super(CommentFrame.f7929ID);
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && zzagk.class == obj.getClass()) {
            ...
            if (ggw0.m126064f(this.zzb, zzagkVar.zzb) && ggw0.m126064f(this.zza, zzagkVar.zza) && ggw0.m126064f(this.zzc, zzagkVar.zzc)) {
                return true;
            }
        }
        return false;
