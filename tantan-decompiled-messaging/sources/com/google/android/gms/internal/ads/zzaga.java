...
public final class zzaga implements zzbx {
    public static final Parcelable.Creator<zzaga> CREATOR = new t9r0();
    ...
    public final void mo13538Z(uns0 uns0Var) {
        String str = this.zzc;
        if (str != null) {
            uns0Var.m194511H(str);
        }
        String str2 = this.zzb;
        if (str2 != null) {
            uns0Var.m194504A(str2);
        }
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && zzaga.class == obj.getClass()) {
            ...
            if (this.zza == zzagaVar.zza && ggw0.m126064f(this.zzb, zzagaVar.zzb) && ggw0.m126064f(this.zzc, zzagaVar.zzc) && ggw0.m126064f(this.zzd, zzagaVar.zzd) && this.zze == zzagaVar.zze && this.zzf == zzagaVar.zzf) {
                return true;
            }
        }
        return false;
