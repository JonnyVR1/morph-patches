...
public final class zzagx extends zzagr {
    public static final Parcelable.Creator<zzagx> CREATOR = new rar0();
    public final String zza;
    public final byte[] zzb;

    public zzagx(Parcel parcel) {
        super(PrivFrame.f7934ID);
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && zzagx.class == obj.getClass()) {
            ...
            if (ggw0.m126064f(this.zza, zzagxVar.zza) && Arrays.equals(this.zzb, zzagxVar.zzb)) {
                return true;
            }
        }
        return false;
