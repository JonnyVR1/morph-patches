...
public final class zzbze extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzbze> CREATOR = new kvs0();
    ...
    public zzbze(@SafeParcelable.Param(m12464id = 1) Bundle bundle, @SafeParcelable.Param(m12464id = 2) zzcei zzceiVar, @SafeParcelable.Param(m12464id = 3) ApplicationInfo applicationInfo, @SafeParcelable.Param(m12464id = 4) String str, @SafeParcelable.Param(m12464id = 5) List list, @Nullable @SafeParcelable.Param(m12464id = 6) PackageInfo packageInfo, @SafeParcelable.Param(m12464id = 7) String str2, @SafeParcelable.Param(m12464id = 9) String str3, @SafeParcelable.Param(m12464id = 10) zzfjc zzfjcVar, @SafeParcelable.Param(m12464id = 11) String str4, @SafeParcelable.Param(m12464id = 12) boolean z, @SafeParcelable.Param(m12464id = 13) boolean z2) {
        this.zza = bundle;
        this.zzb = zzceiVar;
        this.zzd = str;
