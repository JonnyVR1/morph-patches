...
public final class zzboq extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzboq> CREATOR = new eis0();
    ...
    public zzboq(@SafeParcelable.Param(m12464id = 1) String str, @SafeParcelable.Param(m12464id = 2) String[] strArr, @SafeParcelable.Param(m12464id = 3) String[] strArr2) {
        this.zza = str;
        this.zzb = strArr;
        this.zzc = strArr2;
    }
