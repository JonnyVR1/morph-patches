...
public final class zzcag extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzcag> CREATOR = new zxs0();
    ...
    public zzcag(@SafeParcelable.Param(m12464id = 2) String str, @SafeParcelable.Param(m12464id = 3) int i) {
        this.zza = str;
        this.zzb = i;
    }
    ...
    public static zzcag m13556g(JSONArray jSONArray) throws JSONException {
