...
public final class zzbbb extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzbbb> CREATOR = new m2s0();
    ...
    public zzbbb(@Nullable @SafeParcelable.Param(m12464id = 2) String str, @SafeParcelable.Param(m12464id = 3) long j, @SafeParcelable.Param(m12464id = 4) String str2, @SafeParcelable.Param(m12464id = 5) String str3, @SafeParcelable.Param(m12464id = 6) String str4, @SafeParcelable.Param(m12464id = 7) Bundle bundle, @SafeParcelable.Param(m12464id = 8) boolean z, @SafeParcelable.Param(m12464id = 9) long j2, @SafeParcelable.Param(m12464id = 10) String str5, @SafeParcelable.Param(m12464id = 11) int i) {
        this.zza = str;
        this.zzb = j;
    ...
    public static zzbbb m13546g(Uri uri) {
        try {
            ...
            if (pathSegments.size() != 2) {
                x2t0.m206869g("Expected 2 path parts for namespace and id, found :" + pathSegments.size());
                return null;
            }
            ...
            e = e;
            x2t0.m206870h("Unable to parse Uri into cache offering.", e);
            return null;
