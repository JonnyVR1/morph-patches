...
public final class zzbpp extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzbpp> CREATOR = new jjs0();
    ...
    public zzbpp(@SafeParcelable.Param(m12464id = 1000) int i, @SafeParcelable.Param(m12464id = 1) int i2, @SafeParcelable.Param(m12464id = 2) String str, @SafeParcelable.Param(m12464id = 3) int i3) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = str;
        this.zzd = i3;
