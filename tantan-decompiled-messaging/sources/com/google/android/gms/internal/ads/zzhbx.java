...
final class zzhbx extends zzgyl {
    ...
    public static zzgyl zzC(zzgyl zzgylVar, zzgyl zzgylVar2) {
        ...
        return iZzd >= zzc(Math.max(zzgylVar.zzf(), zzgylVar2.zzf()) + 1) ? new zzhbx(zzgylVar, zzgylVar2) : C2270v5.m13381a(new C2270v5(null), zzgylVar, zzgylVar2);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        mbx0 mbx0Var = null;
        C2278w5 c2278w5 = new C2278w5(this, mbx0Var);
        zzgyg zzgygVarM13434a = c2278w5.next();
        C2278w5 c2278w6 = new C2278w5(zzgylVar, mbx0Var);
        zzgyg zzgygVarM13434a2 = c2278w6.next();
        int i = 0;
        int i2 = 0;
        int i3 = 0;
        while (true) {
            int iZzd = zzgygVarM13434a.zzd() - i;
            int iZzd2 = zzgygVarM13434a2.zzd() - i2;
            int iMin = Math.min(iZzd, iZzd2);
            if (!(i == 0 ? zzgygVarM13434a.zzg(zzgygVarM13434a2, i2, iMin) : zzgygVarM13434a2.zzg(zzgygVarM13434a, i, iMin))) {
                return false;
            }
            i3 += iMin;
            int i4 = this.zzc;
            ...
            if (iMin == iZzd) {
                zzgygVarM13434a = c2278w5.next();
                i = 0;
            } else {
                i += iMin;
            }
            if (iMin == iZzd2) {
                zzgygVarM13434a = zzgygVarM13434a;
                zzgygVarM13434a2 = c2278w6.next();
                i2 = 0;
            } else {
                zzgygVarM13434a = zzgygVarM13434a;
                i2 += iMin;
    ...
    public final q7x0 zzl() {
        ...
        Object[] objArr = 0;
        C2278w5 c2278w5 = new C2278w5(this, null);
        while (c2278w5.hasNext()) {
            arrayList.add(c2278w5.next().zzn());
        }
        int i = q7x0.f153092d;
        int i2 = 0;
        int iRemaining = 0;
        ...
        return i2 == 2 ? new C2182k5(arrayList, iRemaining, true, objArr == true ? 1 : 0) : q7x0.m173314g(new bax0(arrayList), 4096);
    }
    ...
    public final void zzo(d7x0 d7x0Var) throws IOException {
        this.zzd.zzo(d7x0Var);
        this.zze.zzo(d7x0Var);
    }
