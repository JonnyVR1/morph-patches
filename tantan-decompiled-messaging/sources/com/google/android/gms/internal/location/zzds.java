...
public abstract class zzds extends zzdp implements List, RandomAccess {
    private static final cmu0 zza = new bgu0(zzdt.zza, 0);
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i = 0; i < size; i++) {
                if (!v9u0.m197600a(get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !v9u0.m197600a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    public final cmu0 listIterator(int i) {
        cbu0.m106028b(i, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new bgu0(this, i);
    }
}
