...
public abstract class zzu extends zzq implements List, RandomAccess {
    private static final dar0 zza = new ely0(zzy.zza, 0);
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i = 0; i < size; i++) {
                if (!ohw0.m164485a(get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !ohw0.m164485a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    public final dar0 listIterator(int i) {
        dux0.m113750b(i, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new ely0(this, i);
    }
}
