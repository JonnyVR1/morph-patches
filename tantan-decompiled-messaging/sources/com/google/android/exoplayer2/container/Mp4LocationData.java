...
public final class Mp4LocationData implements Metadata.Entry {
    public static final Parcelable.Creator<Mp4LocationData> CREATOR = new C1836a();
    public final float latitude;
    public final float longitude;

    /* JADX INFO: renamed from: com.google.android.exoplayer2.container.Mp4LocationData$a */
    public class C1836a implements Parcelable.Creator<Mp4LocationData> {
        @Override // android.os.Parcelable.Creator
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public Mp4LocationData createFromParcel(Parcel parcel) {
            return new Mp4LocationData(parcel, (C1836a) null);
        }
    ...
    public Mp4LocationData(@FloatRange(from = -90.0d, to = 90.0d) float f, @FloatRange(from = -180.0d, to = 180.0d) float f2) {
        p11.m167008b(f >= -90.0f && f <= 90.0f && f2 >= -180.0f && f2 <= 180.0f, "Invalid latitude or longitude");
        this.latitude = f;
        this.longitude = f2;
    }
    ...
    public int hashCode() {
        return ((527 + Floats.m16411c(this.latitude)) * 31) + Floats.m16411c(this.longitude);
    }
    ...
    public /* synthetic */ Mp4LocationData(Parcel parcel, C1836a c1836a) {
        this(parcel);
    }
