...
@Deprecated
public class PlaybackException extends Exception implements InterfaceC1863e {
    ...
    private static final String FIELD_INT_ERROR_CODE = vck0.m197903z0(0);
    private static final String FIELD_LONG_TIMESTAMP_MS = vck0.m197903z0(1);
    private static final String FIELD_STRING_MESSAGE = vck0.m197903z0(2);
    private static final String FIELD_STRING_CAUSE_CLASS_NAME = vck0.m197903z0(3);
    private static final String FIELD_STRING_CAUSE_MESSAGE = vck0.m197903z0(4);
    public static final InterfaceC1863e.a<PlaybackException> CREATOR = new InterfaceC1863e.a() { // from class: l.y580
    ...
    public boolean errorInfoEquals(@Nullable PlaybackException playbackException) {
        ...
        if (playbackException != null && getClass() == playbackException.getClass()) {
            ...
            } else if (!vck0.m197845c(cause.getMessage(), cause2.getMessage()) || !vck0.m197845c(cause.getClass(), cause2.getClass())) {
                return false;
            }
            if (this.errorCode == playbackException.errorCode && vck0.m197845c(getMessage(), playbackException.getMessage()) && this.timestampMs == playbackException.timestampMs) {
                return true;
            }
        }
        return false;
    ...
    public PlaybackException(@Nullable String str, @Nullable Throwable th, int i) {
        this(str, th, i, p95.f147671a.elapsedRealtime());
    }
