...
public final class SmtaMetadataEntry implements Metadata.Entry {
    public static final Parcelable.Creator<SmtaMetadataEntry> CREATOR = new C1911a();
    public final float captureFrameRate;
    public final int svcTemporalLayerCount;

    /* JADX INFO: renamed from: com.google.android.exoplayer2.metadata.mp4.SmtaMetadataEntry$a */
    public class C1911a implements Parcelable.Creator<SmtaMetadataEntry> {
        @Override // android.os.Parcelable.Creator
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public SmtaMetadataEntry createFromParcel(Parcel parcel) {
            return new SmtaMetadataEntry(parcel, (C1911a) null);
        }
    ...
    public int hashCode() {
        return ((527 + Floats.m16411c(this.captureFrameRate)) * 31) + this.svcTemporalLayerCount;
    }
    ...
    public /* synthetic */ SmtaMetadataEntry(Parcel parcel, C1911a c1911a) {
        this(parcel);
    }
}
