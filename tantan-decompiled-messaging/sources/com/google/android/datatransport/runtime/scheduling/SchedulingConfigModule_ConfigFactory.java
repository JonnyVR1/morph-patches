...
public final class SchedulingConfigModule_ConfigFactory implements Factory<SchedulerConfig> {
    ...
    public SchedulingConfigModule_ConfigFactory(eza0<Clock> eza0Var) {
        this.clockProvider = eza0Var;
    }
    ...
    public static SchedulingConfigModule_ConfigFactory create(eza0<Clock> eza0Var) {
        return new SchedulingConfigModule_ConfigFactory(eza0Var);
    }
