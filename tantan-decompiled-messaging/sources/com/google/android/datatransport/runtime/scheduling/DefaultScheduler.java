...
public class DefaultScheduler implements Scheduler {
    ...
    public static /* synthetic */ Object m9304a(DefaultScheduler defaultScheduler, TransportContext transportContext, EventInternal eventInternal) {
    ...
    public static /* synthetic */ void m9305b(final DefaultScheduler defaultScheduler, final TransportContext transportContext, TransportScheduleCallback transportScheduleCallback, EventInternal eventInternal) {
        ...
        try {
            ...
            if (transportBackend == null) {
                ...
                defaultScheduler.guard.runCriticalSection(new SynchronizationGuard.CriticalSection() { // from class: l.nqd
                    @Override // com.google.android.datatransport.runtime.synchronization.SynchronizationGuard.CriticalSection
                    public final Object execute() {
                        return DefaultScheduler.m9304a(this.f140055a, transportContext, eventInternalDecorate);
                    }
                });
    ...
    public void schedule(final TransportContext transportContext, final EventInternal eventInternal, final TransportScheduleCallback transportScheduleCallback) {
        this.executor.execute(new Runnable() { // from class: l.mqd
            @Override // java.lang.Runnable
            public final void run() {
                DefaultScheduler.m9305b(this.f135210a, transportContext, transportScheduleCallback, eventInternal);
            }
        });
    }
}
