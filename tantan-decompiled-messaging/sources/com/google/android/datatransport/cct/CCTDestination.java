...
public final class CCTDestination implements EncodedDestination {
    ...
    static {
        ...
        SUPPORTED_ENCODINGS = Collections.unmodifiableSet(new HashSet(Arrays.asList(Encoding.m9292of("proto"), Encoding.m9292of("json"))));
    ...
    public static CCTDestination fromByteArray(@NonNull byte[] bArr) {
        ...
        if (!str.startsWith(EXTRAS_VERSION_MARKER)) {
            ig3.m135964a("Version marker missing from extras");
            return null;
        }
        String[] strArrSplit = str.substring(2).split(Pattern.quote(EXTRAS_DELIMITER), 2);
        if (strArrSplit.length != 2) {
            ig3.m135964a("Extra is not a valid encoded LegacyFlgDestination");
            return null;
        }
        String str2 = strArrSplit[0];
        if (str2.isEmpty()) {
            ig3.m135964a("Missing endpoint in CCTDestination extras");
            return null;
        }
