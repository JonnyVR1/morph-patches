...
public class AutocompleteSupportFragment extends Fragment {
    private final kt10 zza;
    private final kt10 zzb;
    private zzks zzc;
    ...
    public AutocompleteSupportFragment() {
        super(C2462R.layout.places_autocomplete_fragment);
        this.zza = new kt10();
        this.zzb = new kt10();
    ...
    private final void zzf(View view) {
        view.setVisibility(true != TextUtils.isEmpty((CharSequence) this.zza.m2980f()) ? 0 : 8);
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (bundle != null) {
            try {
                ...
                if (this.zza.m2980f() == 0) {
                    this.zza.mo2987m(zzktVar.zzm());
                }
                if (this.zzb.m2980f() == 0) {
                    this.zzb.mo2987m(zzktVar.zzl());
                }
    ...
    public void onViewCreated(@RecentlyNonNull View view, @Nullable Bundle bundle) {
        final View viewFindViewById = view.findViewById(C2462R.id.places_autocomplete_search_button);
        final View viewFindViewById2 = view.findViewById(C2462R.id.places_autocomplete_clear_button);
        final EditText editText = (EditText) view.findViewById(C2462R.id.places_autocomplete_search_input);
        editText.setHint(zzkw.zzc(requireContext(), C2462R.string.places_autocomplete_search_hint));
        ...
        this.zza.m2983i(getViewLifecycleOwner(), new n250() { // from class: com.google.android.libraries.places.widget.zzh
            @Override // p149l.n250
            public final void onChanged(Object obj) {
                this.zza.zzc(editText, viewFindViewById2, (CharSequence) obj);
            }
        });
        this.zzb.m2983i(getViewLifecycleOwner(), new n250() { // from class: com.google.android.libraries.places.widget.zzi
            @Override // p149l.n250
            public final void onChanged(Object obj) {
    ...
    public AutocompleteSupportFragment setHint(@Nullable CharSequence charSequence) {
        try {
            if (charSequence != null) {
                ...
                this.zzb.mo2987m(charSequence);
                return this;
            }
            String string = getString(C2462R.string.places_autocomplete_search_hint);
            this.zzc.zzb(string);
            this.zzb.mo2987m(string);
            return this;
        } catch (Error | RuntimeException e) {
            zzkd.zzb(e);
            throw e;
