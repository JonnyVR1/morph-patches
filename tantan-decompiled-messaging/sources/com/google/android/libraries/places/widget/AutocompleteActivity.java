...
import com.google.android.libraries.places.widget.internal.p031ui.AutocompleteImplFragment;
...
public class AutocompleteActivity extends AppCompatActivity implements PlaceSelectionListener {
    ...
    public AutocompleteActivity() {
        super(C2462R.layout.places_autocomplete_activity);
        this.zzc = false;
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        try {
            ...
            if (iOrdinal == 0) {
                this.zza = C2462R.layout.places_autocomplete_impl_fragment_fullscreen;
                this.zzb = C2462R.style.PlacesAutocompleteFullscreen;
            } else if (iOrdinal == 1) {
                this.zza = C2462R.layout.places_autocomplete_impl_fragment_overlay;
                this.zzb = C2462R.style.PlacesAutocompleteOverlay;
            }
            getSupportFragmentManager().m2581q1(new com.google.android.libraries.places.widget.internal.p031ui.zzh(this.zza, this, zzktVar));
            setTheme(this.zzb);
            super.onCreate(bundle);
            final AutocompleteImplFragment autocompleteImplFragment = (AutocompleteImplFragment) getSupportFragmentManager().m2554h0(C2462R.id.places_autocomplete_content);
