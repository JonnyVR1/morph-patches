...
public final class zzt extends RecyclerView.AbstractC0566d0 {
    ...
    public zzt(final zzd zzdVar, View view) {
        super(view);
        this.zza = (TextView) view.findViewById(C2462R.id.places_autocomplete_prediction_primary_text);
        this.zzb = (TextView) view.findViewById(C2462R.id.places_autocomplete_prediction_secondary_text);
    ...
    public final void zza(AutocompletePrediction autocompletePrediction, boolean z) {
        ...
        this.zzd = z;
        this.zza.setText(autocompletePrediction.getPrimaryText(new ForegroundColorSpan(e16.m114375c(this.itemView.getContext(), C2462R.color.places_autocomplete_prediction_primary_text_highlight))));
