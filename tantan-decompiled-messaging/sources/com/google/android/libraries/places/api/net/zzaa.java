...
final class zzaa extends SearchByTextRequest {
    ...
    public /* synthetic */ zzaa(hf4 hf4Var, String str, LocationBias locationBias, LocationRestriction locationRestriction, Integer num, Double d, boolean z, List list, List list2, SearchByTextRequest.RankPreference rankPreference, String str2, boolean z2, String str3, zzz zzzVar) {
        this.zza = hf4Var;
        this.zzb = str;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof SearchByTextRequest) {
            ...
            hf4 hf4Var = this.zza;
            if (hf4Var != null ? hf4Var.equals(searchByTextRequest.getCancellationToken()) : searchByTextRequest.getCancellationToken() == null) {
    ...
    public final int hashCode() {
        hf4 hf4Var = this.zza;
        int iHashCode = hf4Var == null ? 0 : hf4Var.hashCode();
        String str = this.zzb;
