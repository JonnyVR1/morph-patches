...
final class zzo extends FindAutocompletePredictionsRequest {
    ...
    @Nullable
    private final hf4 zzk;

    public /* synthetic */ zzo(String str, LocationBias locationBias, LocationRestriction locationRestriction, LatLng latLng, List list, AutocompleteSessionToken autocompleteSessionToken, TypeFilter typeFilter, List list2, Integer num, String str2, hf4 hf4Var, zzn zznVar) {
        this.zza = str;
    ...
    public final int hashCode() {
        ...
        hf4 hf4Var = this.zzk;
        return iHashCode8 ^ (hf4Var != null ? hf4Var.hashCode() : 0);
    }
