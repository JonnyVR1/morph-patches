...
public final class zziu implements zzev {
    ...
    public static final /* synthetic */ FetchPlaceResponse zzi(Task task) throws Exception {
        zzhy zzhyVar = (zzhy) task.mo15373l();
    ...
    public static final /* synthetic */ FindCurrentPlaceResponse zzj(Task task) throws Exception {
        zzig zzigVar = (zzig) task.mo15373l();
    ...
    public final Task zza(FetchPhotoRequest fetchPhotoRequest, int i) {
        ...
        if (maxWidth == null && maxHeight == null) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Must include max width or max height in request.")));
        }
        if (maxWidth != null && maxWidth.intValue() <= 0) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, String.format("Max Width must not be < 1, but was: %d.", maxWidth))));
        }
        if (maxHeight != null && maxHeight.intValue() <= 0) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, String.format("Max Height must not be < 1, but was: %d.", maxHeight))));
        }
        ...
        Task taskMo15369h = zzfgVar.zzb(zzhrVar, new zzhs()).mo15369h(new n16() { // from class: com.google.android.libraries.places.internal.zzim
            @Override // p149l.n16
            public final Object then(Task task) {
                return FetchPhotoResponse.newInstance(((zzhu) task.mo15373l()).zza);
            }
        });
        final int i2 = 1;
        return taskMo15369h.mo15369h(new n16(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzin
    ...
    public final Task zzb(FetchPlaceRequest fetchPlaceRequest, final int i) {
        if (TextUtils.isEmpty(fetchPlaceRequest.getPlaceId())) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Place ID must not be empty.")));
        }
        ...
        final long jZza = zzdvVar.zza();
        return zzfaVar.zza(zzhxVar, zzhy.class).mo15369h(new n16() { // from class: com.google.android.libraries.places.internal.zzis
            @Override // p149l.n16
            public final Object then(Task task) {
                return zziu.zzi(task);
            }
        }).mo15369h(new n16() { // from class: com.google.android.libraries.places.internal.zzit
            @Override // p149l.n16
            public final Object then(Task task) {
    ...
    public final Task zzc(FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, final int i) {
        ...
        zzfa zzfaVar = this.zzb;
        final long jZza = zzdvVar.zza();
        return zzfaVar.zza(zzibVar, zzic.class).mo15369h(new n16() { // from class: com.google.android.libraries.places.internal.zzio
            @Override // p149l.n16
            public final Object then(Task task) {
                return zzid.zza((zzic) task.mo15373l());
            }
        }).mo15369h(new n16() { // from class: com.google.android.libraries.places.internal.zzip
            @Override // p149l.n16
            public final Object then(Task task) {
    ...
    public final Task zzd(FindCurrentPlaceRequest findCurrentPlaceRequest, Location location, zznx zznxVar, int i) {
        ...
        zzfa zzfaVar = this.zzb;
        final long jZza = zzdvVar.zza();
        Task taskMo15369h = zzfaVar.zza(zzifVar, zzig.class).mo15369h(new n16() { // from class: com.google.android.libraries.places.internal.zziq
            @Override // p149l.n16
            public final Object then(Task task) {
        ...
        final int i2 = 1;
        return taskMo15369h.mo15369h(new n16(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzir
            public final /* synthetic */ long zzb;
    ...
    public final /* synthetic */ FetchPhotoResponse zze(long j, int i, Task task) throws Exception {
        this.zzd.zzb(task, j, this.zze.zza(), 1);
        return (FetchPhotoResponse) task.mo15373l();
    }

    public final /* synthetic */ FetchPlaceResponse zzf(long j, int i, Task task) throws Exception {
        this.zzd.zzl(task, j, this.zze.zza(), 2, i);
        return (FetchPlaceResponse) task.mo15373l();
    }

    public final /* synthetic */ FindAutocompletePredictionsResponse zzg(long j, int i, Task task) throws Exception {
        this.zzd.zzn(task, j, this.zze.zza(), 2, i);
        return (FindAutocompletePredictionsResponse) task.mo15373l();
    }

    public final /* synthetic */ FindCurrentPlaceResponse zzh(long j, int i, Task task) throws Exception {
