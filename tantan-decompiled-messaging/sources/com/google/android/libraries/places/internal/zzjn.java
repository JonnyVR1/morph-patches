...
final class zzjn implements zzjq {
    ...
    public final PlacesClient zza() {
        ...
        yuc0 yuc0VarM198088a = vdp0.m198088a(applicationContext);
        zzaxx.zza(yuc0VarM198088a);
        zzfa zzfaVarZza = zzfb.zza(yuc0VarM198088a, new zzij());
        Context applicationContext2 = this.zzb.getApplicationContext();
        zzaxx.zza(applicationContext2);
        yuc0 yuc0VarM198088a2 = vdp0.m198088a(applicationContext2);
        zzaxx.zza(yuc0VarM198088a2);
        zzfg zzfgVarZza = zzfh.zza(yuc0VarM198088a2);
