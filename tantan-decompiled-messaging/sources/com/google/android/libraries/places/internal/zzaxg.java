...
public final class zzaxg {
    ...
    public static String zza(zzawl zzawlVar) {
        ...
        if (jZze < -62135596800L || jZze > 253402300799L || iZzc < 0 || iZzc >= 1000000000) {
            dqi0.m113073a("Timestamp is not valid. See proto definition for valid values. Seconds (%s) must be in range [-62,135,596,800, +253,402,300,799]. Nanos (%s) must be in range [0, +999,999,999].", new Object[]{Long.valueOf(jZze), Integer.valueOf(iZzc)});
            return null;
        }
