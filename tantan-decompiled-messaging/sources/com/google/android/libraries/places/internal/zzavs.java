...
interface zzavs {
    ...
    @Deprecated
    void zzC(List list, zzavt zzavtVar, zzatf zzatfVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzavt zzavtVar, zzatf zzatfVar) throws IOException;
    ...
    zzask zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzavt zzavtVar, zzatf zzatfVar) throws IOException;

    void zzu(Object obj, zzavt zzavtVar, zzatf zzatfVar) throws IOException;
