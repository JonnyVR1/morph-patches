        ...
        try {
            ...
            if (map.isEmpty()) {
                ...
                for (Map.Entry entry : map.entrySet()) {
                    ...
                    boolean zContainsKey = this.zzj.containsKey(key);
                    Map map2 = this.zzj;
                    if (zContainsKey) {
                        zzbvi zzbviVar2 = (zzbvi) map2.get(key);
                        if (zzbviVar2.zzm()) {
                            arrayList2.add(zzbviVar2);
                        }
                    } else {
                        map2.put(key, (zzbvi) entry.getValue());
                    }
                }
                ...
                for (Map.Entry entry2 : map.entrySet()) {
                    ...
                    } while (!zzbvjVar.equals(new zzbvj(zzazsVar)));
                    ...
                    zzaybVarZza.zzb(zzbbm.zzd, Boolean.TRUE);
