...
public class zzbwf implements Serializable, Comparable {
    ...
    public String toString() {
        ...
        if (i5 != -1) {
            ...
            String strM93479F = C15386d.m93479F(C15386d.m93479F(C15386d.m93479F(strZzf.substring(0, i5), "\\", "\\\\", false, 4, null), SignParameters.NEW_LINE, "\\n", false, 4, null), "\r", "\\r", false, 4, null);
            if (i5 >= strZzf.length()) {
                return "[text=" + strM93479F + Constants.AES_SUFFIX;
            }
            return "[size=" + zzbwfVar.zzc.length + " text=" + strM93479F + "…]";
        }
        ...
        if (length3 < 64) {
            pac0.m168085a("endIndex > length(", length3, ")");
            return null;
        }
        if (length3 != 64) {
