...
final class zzbtw {
    ...
    public static /* bridge */ /* synthetic */ zzbwf zzc(zzbwf zzbwfVar) throws IOException {
        ...
        for (int i = 0; i < iZzc; i++) {
            ...
            if (bZza >= 65 && bZza <= 90) {
                rhg0.m179353a("PROTOCOL_ERROR response malformed: mixed case name: ".concat(zzbwfVar.zzf()));
                return null;
            }
        }
        return zzbwfVar;
