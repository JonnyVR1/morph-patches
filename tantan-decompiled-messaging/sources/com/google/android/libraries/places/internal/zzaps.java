...
public final class zzaps extends zzatu implements zzavg {
    ...
    public final zzaov zzg() {
        zzaov zzaovVar;
        int i = this.zzD;
        zzaov zzaovVar2 = zzaov.BUSINESS_STATUS_UNSPECIFIED;
        if (i == 0) {
            zzaovVar = zzaov.BUSINESS_STATUS_UNSPECIFIED;
        } else if (i == 1) {
            zzaovVar = zzaov.OPERATIONAL;
        } else if (i == 2) {
            zzaovVar = zzaov.CLOSED_TEMPORARILY;
        } else if (i != 3) {
            zzaovVar = i != 4 ? null : zzaov.FUTURE_OPENING;
        } else {
            zzaovVar = zzaov.CLOSED_PERMANENTLY;
        }
        return zzaovVar == null ? zzaov.UNRECOGNIZED : zzaovVar;
    }
    ...
    public final zzaqb zzm() {
        zzaqb zzaqbVar;
        int i = this.zzE;
        zzaqb zzaqbVar2 = zzaqb.PRICE_LEVEL_UNSPECIFIED;
        if (i == 0) {
            zzaqbVar = zzaqb.PRICE_LEVEL_UNSPECIFIED;
        } else if (i == 1) {
            zzaqbVar = zzaqb.PRICE_LEVEL_FREE;
        } else if (i == 2) {
            zzaqbVar = zzaqb.PRICE_LEVEL_INEXPENSIVE;
        } else if (i == 3) {
            zzaqbVar = zzaqb.PRICE_LEVEL_MODERATE;
        } else if (i != 4) {
            zzaqbVar = i != 5 ? null : zzaqb.PRICE_LEVEL_VERY_EXPENSIVE;
        } else {
            zzaqbVar = zzaqb.PRICE_LEVEL_EXPENSIVE;
        }
        return zzaqbVar == null ? zzaqb.UNRECOGNIZED : zzaqbVar;
    }
