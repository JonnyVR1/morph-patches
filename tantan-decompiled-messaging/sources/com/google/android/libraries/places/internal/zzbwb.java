...
public final class zzbwb implements Cloneable, ByteChannel, zzbwd, zzbwc {
    ...
    public final zzbwb zzt(@NotNull String str, int i, int i2) {
        str.getClass();
        if (i2 < 0) {
            pac0.m168085a("endIndex < beginIndex: ", i2, " < 0");
            return null;
        }
        if (i2 > str.length()) {
    ...
    public final zzbwb zzu(int i) {
        ...
        if (i > 1114111) {
            ig3.m135964a("Unexpected code point: 0x".concat(String.valueOf(zzbvv.zza(i))));
            return null;
        }
