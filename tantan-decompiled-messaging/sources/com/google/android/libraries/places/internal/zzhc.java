...
public final class zzhc {
    ...
    public final /* synthetic */ Task zza(zzamn zzamnVar) throws Exception {
        ...
        sei0Var.m183659c(FindAutocompletePredictionsResponse.newInstance(arrayList));
        return sei0Var.m183657a();
    }

    public final /* synthetic */ Task zzb(zzaps zzapsVar) throws Exception {
        sei0 sei0Var = new sei0();
        sei0Var.m183659c(FetchPlaceResponse.newInstance(this.zzk.zza(zzapsVar)));
        return sei0Var.m183657a();
    }
    ...
    public final /* synthetic */ Task zzc(zzarr zzarrVar) throws Exception {
        ...
        sei0Var.m183659c(SearchByTextResponse.newInstance(arrayList));
        return sei0Var.m183657a();
    }
    ...
    public final /* synthetic */ Task zzd(zzarc zzarcVar) throws Exception {
        ...
        sei0Var.m183659c(SearchNearbyResponse.newInstance(arrayList));
        return sei0Var.m183657a();
    }
    ...
    public final Task zze(FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, int i) {
        ...
        if (regionCode != null && regionCode.isEmpty()) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Region code must not be an empty string.")));
        }
        String query = findAutocompletePredictionsRequest.getQuery();
        if (query == null) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Query must not be null.")));
        }
        if (TextUtils.isEmpty(query.trim())) {
            return tfi0.m188734f(FindAutocompletePredictionsResponse.newInstance(zznx.zzl()));
        }
        ...
        hf4 cancellationToken = findAutocompletePredictionsRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.mo130732b(new sg50() { // from class: com.google.android.libraries.places.internal.zzgn
                @Override // p149l.sg50
        ...
        return zzed.zza(zzakaVarZza).mo15379r(new r5g0() { // from class: com.google.android.libraries.places.internal.zzgt
            @Override // p149l.r5g0
            public final Task then(Object obj) {
                return this.zza.zza((zzamn) obj);
            }
        }).mo15371j(new n16(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzgu
    ...
    public final Task zzf(FetchResolvedPhotoUriRequest fetchResolvedPhotoUriRequest, int i) {
        ...
        hf4 cancellationToken = fetchResolvedPhotoUriRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.mo130732b(new sg50() { // from class: com.google.android.libraries.places.internal.zzgq
                @Override // p149l.sg50
                public final void onCanceled() {
                    zzakaVarZza.cancel(true);
                }
        ...
        return zzed.zza(zzakaVarZza).mo15379r(new r5g0() { // from class: com.google.android.libraries.places.internal.zzgr
            @Override // p149l.r5g0
            public final Task then(Object obj) {
                sei0 sei0Var = new sei0();
                sei0Var.m183659c(FetchResolvedPhotoUriResponse.newInstance(Uri.parse(((zzaoj) obj).zzd())));
                return sei0Var.m183657a();
            }
        }).mo15371j(new n16(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzgs
            public final /* synthetic */ long zzb;
    ...
    public final Task zzg(FetchPlaceRequest fetchPlaceRequest, int i) {
        if (fetchPlaceRequest.getPlaceId().isEmpty()) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Place id must not be an empty string.")));
        }
        List<Place.Field> placeFields = fetchPlaceRequest.getPlaceFields();
        if (placeFields.isEmpty()) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Place fields must not be empty.")));
        }
        ...
        hf4 cancellationToken = fetchPlaceRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.mo130732b(new sg50() { // from class: com.google.android.libraries.places.internal.zzgv
                @Override // p149l.sg50
                public final void onCanceled() {
                    zzakaVarZza.cancel(true);
                }
        ...
        return zzed.zza(zzakaVarZza).mo15379r(new r5g0() { // from class: com.google.android.libraries.places.internal.zzgw
            @Override // p149l.r5g0
            public final Task then(Object obj) {
                return this.zza.zzb((zzaps) obj);
            }
        }).mo15371j(new n16(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzgx
            public final /* synthetic */ long zzb;
    ...
    public final Task zzm(final SearchByTextRequest searchByTextRequest, int i) {
        ...
        if (searchByTextRequest.getTextQuery().isEmpty()) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Text query must not be an empty string.")));
        }
        String includedType = searchByTextRequest.getIncludedType();
        if (includedType != null && includedType.isEmpty()) {
            return tfi0.m188733e(new ApiException(new Status(PlacesStatusCodes.INVALID_REQUEST, "Included type must not be an empty string.")));
        }
        ...
        hf4 cancellationToken = searchByTextRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.mo130732b(new sg50() { // from class: com.google.android.libraries.places.internal.zzhb
                @Override // p149l.sg50
                public final void onCanceled() {
                    zzakaVarZza.cancel(true);
                }
        ...
        final int i3 = 1;
        return zzed.zza(zzakaVarZza).mo15379r(new r5g0() { // from class: com.google.android.libraries.places.internal.zzgo
            @Override // p149l.r5g0
            public final Task then(Object obj) {
                return this.zza.zzc((zzarr) obj);
            }
        }).mo15371j(new n16(searchByTextRequest, jZza, i3) { // from class: com.google.android.libraries.places.internal.zzgp
    ...
    public final Task zzn(final SearchNearbyRequest searchNearbyRequest, int i) {
        ...
        hf4 cancellationToken = searchNearbyRequest.getCancellationToken();
        if (cancellationToken != null) {
            cancellationToken.mo130732b(new sg50() { // from class: com.google.android.libraries.places.internal.zzgy
                @Override // p149l.sg50
                public final void onCanceled() {
                    zzakaVarZza.cancel(true);
                }
        ...
        final int i3 = 1;
        return zzed.zza(zzakaVarZza).mo15379r(new r5g0() { // from class: com.google.android.libraries.places.internal.zzgz
            @Override // p149l.r5g0
            public final Task then(Object obj) {
                return this.zza.zzd((zzarc) obj);
            }
        }).mo15371j(new n16(searchNearbyRequest, jZza, i3) { // from class: com.google.android.libraries.places.internal.zzha
