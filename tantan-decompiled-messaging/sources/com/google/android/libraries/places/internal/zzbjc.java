...
final class zzbjc implements zzbbx {
    ...
    public final /* bridge */ /* synthetic */ Object zza(String str) {
        ...
        dqi0.m113073a("Invalid timeout unit: %s", new Object[]{Character.valueOf(cCharAt)});
        return null;
    }
    ...
    public final /* bridge */ /* synthetic */ String zzb(Object obj) {
        Long l2 = (Long) obj;
        if (l2.longValue() < 0) {
            ig3.m135964a("Timeout too small");
            return null;
        }
        ...
        if (l2.longValue() < 100000000000000000L) {
            return (l2.longValue() / 1000000000) + j6f.LATITUDE_SOUTH;
        }
