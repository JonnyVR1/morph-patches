...
import androidx.recyclerview.widget.C0614t;
...
public class NavigationMenuPresenter implements InterfaceC0091g {
    private static final String STATE_ADAPTER = "android:menu:adapter";
    private static final String STATE_HEADER = "android:menu:header";
    private static final String STATE_HIERARCHY = "android:menu:list";
    NavigationMenuAdapter adapter;
    private InterfaceC0091g.a callback;
    boolean hasCustomItemIconSize;
    LinearLayout headerLayout;
    ColorStateList iconTintList;

    /* JADX INFO: renamed from: id */
    private int f10584id;
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public int getItemViewType(int i) {
            ...
            upk0.m194883a("Unknown item type.");
            return 0;
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
            ...
            gbl0.m125207m0(navigationMenuItemView, drawable != null ? drawable.getConstantState().newDrawable() : null);
    ...
    public class NavigationMenuViewAccessibilityDelegate extends C0614t {
        public NavigationMenuViewAccessibilityDelegate(RecyclerView recyclerView) {
            super(recyclerView);
        }

        @Override // androidx.recyclerview.widget.C0614t, p149l.C17974kb
        public void onInitializeAccessibilityNodeInfo(View view, @NonNull C17055gc c17055gc) {
            ...
            c17055gc.m125431q0(C17055gc.e.m125461a(NavigationMenuPresenter.this.adapter.getRowCount(), 0, false));
        }
    }

    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
            super(layoutInflater.inflate(C2466R.layout.design_navigation_item, viewGroup, false));
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C2466R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C2466R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }

    public static abstract class ViewHolder extends RecyclerView.AbstractC0566d0 {
    ...
    public void dispatchApplyWindowInsets(@NonNull y6q0 y6q0Var) {
        int iM213185l = y6q0Var.m213185l();
        if (this.paddingTopDefault != iM213185l) {
            this.paddingTopDefault = iM213185l;
            updateTopPadding();
        }
        NavigationMenuView navigationMenuView = this.menuView;
        navigationMenuView.setPadding(0, navigationMenuView.getPaddingTop(), 0, y6q0Var.m213182i());
        gbl0.m125190e(this.headerLayout, y6q0Var);
    }
    ...
    public InterfaceC0092h getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C2466R.layout.design_navigation_menu, viewGroup, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C2466R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    public void initForMenu(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C2466R.dimen.design_navigation_separator_vertical_padding);
    }
    ...
    public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
        InterfaceC0091g.a aVar = this.callback;
        if (aVar != null) {
