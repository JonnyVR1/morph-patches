...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets() {
        ...
        int iM191981b = u6k.m191981b(this.collapsedTextGravity, this.isRtl ? 1 : 0);
        int i = iM191981b & 112;
        if (i == 48) {
        ...
        int iM191981b2 = u6k.m191981b(this.expandedTextGravity, this.isRtl ? 1 : 0);
        int i3 = iM191981b2 & 112;
        if (i3 == 48) {
    ...
    private boolean calculateIsRtl(@NonNull CharSequence charSequence) {
        return (gbl0.m125228x(this.view) == 1 ? oii0.f144128d : oii0.f144127c).isRtl(charSequence, 0, charSequence.length());
    }
    ...
    public void setExpansionFraction(float f) {
        float fM145806a = kex.m145806a(f, 0.0f, 1.0f);
        if (fM145806a != this.expandedFraction) {
            this.expandedFraction = fM145806a;
            calculateCurrentOffsets();
        }
    }
