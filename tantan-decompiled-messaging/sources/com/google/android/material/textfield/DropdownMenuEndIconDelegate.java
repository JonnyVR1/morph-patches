...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(@NonNull TextInputLayout textInputLayout) {
        ...
        this.accessibilityDelegate = new TextInputLayout.AccessibilityDelegate(this.textInputLayout) { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.2
            @Override // com.google.android.material.textfield.TextInputLayout.AccessibilityDelegate, p149l.C17974kb
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull C17055gc c17055gc) {
                ...
                c17055gc.m125427o0(Spinner.class.getName());
                if (c17055gc.m125399X()) {
                    c17055gc.m125358A0(null);
                }
            }
    ...
    public void addRippleEffect(@NonNull AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C2466R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnFilledLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
        ...
        if (IS_LOLLIPOP) {
            gbl0.m125207m0(autoCompleteTextView, new RippleDrawable(new ColorStateList(iArr, iArr2), materialShapeDrawable, materialShapeDrawable));
            return;
        }
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        materialShapeDrawable2.setFillColor(new ColorStateList(iArr, iArr2));
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{materialShapeDrawable, materialShapeDrawable2});
        int iM125149B = gbl0.m125149B(autoCompleteTextView);
        int paddingTop = autoCompleteTextView.getPaddingTop();
        int iM125147A = gbl0.m125147A(autoCompleteTextView);
        int paddingBottom = autoCompleteTextView.getPaddingBottom();
        gbl0.m125207m0(autoCompleteTextView, layerDrawable);
        gbl0.m125233z0(autoCompleteTextView, iM125149B, paddingTop, iM125147A, paddingBottom);
    }
    ...
    private void addRippleEffectOnOutlinedLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C2466R.attr.colorSurface);
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
    ...
    public AutoCompleteTextView castAutoCompleteTextViewOrThrow(EditText editText) {
        ...
        upk0.m194883a("EditText needs to be an AutoCompleteTextView if an Exposed Dropdown Menu is being used.");
        return null;
    }
    ...
    public void initialize() {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C2466R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C2466R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C2466R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(nu0.m161424b(this.context, IS_LOLLIPOP ? C2466R.drawable.mtrl_dropdown_arrow : C2466R.drawable.mtrl_ic_arrow_drop_down));
        TextInputLayout textInputLayout = this.textInputLayout;
        textInputLayout.setEndIconContentDescription(textInputLayout.getResources().getText(C2466R.string.exposed_dropdown_menu_content_description));
        ...
        initAnimators();
        gbl0.m125221t0(this.endIconView, 2);
