...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C2466R.dimen.design_textinput_caption_translate_y);
    }
    ...
    private boolean shouldAnimateCaptionView(@Nullable TextView textView, @Nullable CharSequence charSequence) {
        if (gbl0.m125171P(this.textInputView) && this.textInputView.isEnabled()) {
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            gbl0.m125233z0(this.indicatorArea, gbl0.m125149B(this.textInputView.getEditText()), 0, gbl0.m125147A(this.textInputView.getEditText()), 0);
        }
    }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C2466R.id.textinput_error);
            ...
            gbl0.m125205l0(this.errorView, 1);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C2466R.id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
                this.helperTextView.setTypeface(typeface);
            }
            this.helperTextView.setVisibility(4);
            gbl0.m125205l0(this.helperTextView, 1);
