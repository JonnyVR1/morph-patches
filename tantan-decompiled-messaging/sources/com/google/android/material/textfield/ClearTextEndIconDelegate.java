...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public ClearTextEndIconDelegate(@NonNull TextInputLayout textInputLayout) {
        ...
        this.clearTextEndIconTextWatcher = new TextWatcher() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate.1
            ...
            public void afterTextChanged(@NonNull Editable editable) {
                boolean zHasText = ClearTextEndIconDelegate.hasText(editable);
                ClearTextEndIconDelegate clearTextEndIconDelegate = ClearTextEndIconDelegate.this;
                if (!zHasText) {
                    clearTextEndIconDelegate.iconInAnim.cancel();
                    ClearTextEndIconDelegate.this.iconOutAnim.start();
                } else {
                    if (clearTextEndIconDelegate.textInputLayout.isEndIconVisible()) {
                        return;
                    }
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(nu0.m161424b(this.context, C2466R.drawable.mtrl_ic_cancel));
        TextInputLayout textInputLayout = this.textInputLayout;
        textInputLayout.setEndIconContentDescription(textInputLayout.getResources().getText(C2466R.string.clear_text_end_icon_content_description));
