...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C2466R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(viewGroupFindSuitableParent.getContext()) ? C2466R.layout.mtrl_layout_snackbar_include : C2466R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
    ...
    public Snackbar setBackgroundTint(@ColorInt int i) {
        ...
        if (background != null) {
            kbe.m145280n(background.mutate(), i);
        }
        return this;
    }
    ...
    public Snackbar setBackgroundTintList(ColorStateList colorStateList) {
        kbe.m145281o(this.view.getBackground().mutate(), colorStateList);
        return this;
    }
