...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.InterfaceC0225b {
    ...
    private static final int DEF_STYLE_RES = C2466R.style.Widget_MaterialComponents_BottomAppBar;
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2466R.styleable.BottomAppBar, i, i2, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C2466R.styleable.BottomAppBar_backgroundTint);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.BottomAppBar_elevation, 0);
        float dimensionPixelOffset = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2466R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2466R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2466R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = typedArrayObtainStyledAttributes.getInt(C2466R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = typedArrayObtainStyledAttributes.getInt(C2466R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.hideOnScroll = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.BottomAppBar_hideOnScroll, false);
        typedArrayObtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C2466R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        ...
        kbe.m145281o(materialShapeDrawable, colorStateList);
        ...
        ViewUtils.doOnApplyWindowInsets(this, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            ...
            public y6q0 onApplyWindowInsets(View view, @NonNull y6q0 y6q0Var, @NonNull ViewUtils.RelativePadding relativePadding) {
                BottomAppBar.this.bottomInset = y6q0Var.m213182i();
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode == i || !gbl0.m125171P(this)) {
            return;
        }
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i, boolean z) {
        boolean z2 = gbl0.m125228x(this) == 1;
        int measuredWidth = z2 ? getMeasuredWidth() : 0;
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            View childAt = getChildAt(i2);
            if ((childAt.getLayoutParams() instanceof Toolbar.C0159e) && (((Toolbar.C0159e) childAt.getLayoutParams()).f110601a & 8388615) == 8388611) {
    ...
    public void setBackgroundTint(@Nullable ColorStateList colorStateList) {
        kbe.m145281o(this.materialShapeDrawable, colorStateList);
    }
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
            ...
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        ((ViewGroup.MarginLayoutParams) c0229f).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C2466R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - iHeight) / 2));
                    }
                }
            };
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, int i) {
            ...
            if (viewFindDependentView != null && !gbl0.m125171P(viewFindDependentView)) {
                CoordinatorLayout.C0229f c0229f = (CoordinatorLayout.C0229f) viewFindDependentView.getLayoutParams();
                c0229f.f1376d = 49;
                this.originalBottomMargin = ((ViewGroup.MarginLayoutParams) c0229f).bottomMargin;
                if (viewFindDependentView instanceof FloatingActionButton) {
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.bottomAppBarStyle);
    }
