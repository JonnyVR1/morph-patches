...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(@NonNull Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C2466R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C2466R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C2466R.attr.colorSurface, 0);
        this.displayDensity = context.getResources().getDisplayMetrics().density;
    }

    private boolean isThemeSurfaceColor(@ColorInt int i) {
        return ge5.m125678o(i, 255) == this.colorSurface;
    }
    ...
    public int compositeOverlay(@ColorInt int i, float f) {
        ...
        return ge5.m125678o(MaterialColors.layer(ge5.m125678o(i, 255), this.elevationOverlayColor, fCalculateOverlayAlphaFraction), Color.alpha(i));
    }
