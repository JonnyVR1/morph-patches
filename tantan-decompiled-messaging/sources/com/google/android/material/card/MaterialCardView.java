...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int[] DRAGGED_STATE_SET = {C2466R.attr.state_dragged};
    private static final int DEF_STYLE_RES = C2466R.style.Widget_MaterialComponents_CardView;
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C2466R.styleable.MaterialCardView, i, i2, new int[0]);
    ...
    public void setCheckedIconResource(@DrawableRes int i) {
        this.cardViewHelper.setCheckedIcon(nu0.m161424b(getContext(), i));
    }
    ...
    public void setRippleColorResource(@ColorRes int i) {
        this.cardViewHelper.setRippleColor(nu0.m161423a(getContext(), i));
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.materialCardViewStyle);
    }
