...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    public DateFormatTextWatcher(String str, DateFormat dateFormat, @NonNull TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C2466R.string.mtrl_picker_out_of_range);
    }
    ...
    public void onTextChanged(@NonNull CharSequence charSequence, int i, int i2, int i3) {
        ...
        try {
            ...
            String string = this.textInputLayout.getContext().getString(C2466R.string.mtrl_picker_invalid_format);
            String str = String.format(this.textInputLayout.getContext().getString(C2466R.string.mtrl_picker_invalid_format_use), this.formatHint);
            String str2 = String.format(this.textInputLayout.getContext().getString(C2466R.string.mtrl_picker_invalid_format_example), this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())));
