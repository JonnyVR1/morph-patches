...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    @StyleRes
    private static final int DEF_STYLE_RES = C2466R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(getContext(), C2466R.attr.colorSurface, getClass().getCanonicalName());
