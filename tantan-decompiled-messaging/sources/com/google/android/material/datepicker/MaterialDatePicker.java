...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, nu0.m161424b(context, C2466R.drawable.ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], nu0.m161424b(context, C2466R.drawable.ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelSize = resources.getDimensionPixelSize(C2466R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C2466R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return dimensionPixelSize + dimensionPixelSize2 + (resources.getDimensionPixelSize(C2466R.dimen.mtrl_calendar_day_height) * i) + ((i - 1) * resources.getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(@NonNull Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_content_padding);
        int i = Month.today().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C2466R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    private void initHeaderToggle(Context context) {
        ...
        gbl0.m125201j0(this.headerToggleButton, null);
    ...
    public static boolean isFullscreen(@NonNull Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C2466R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{R.attr.windowFullscreen});
    ...
    public void startPickerFragment() {
        ...
        abstractC0427kM2567m.m2811s(C2466R.id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C2466R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void updateToggleContentDescription(@NonNull CheckableImageButton checkableImageButton) {
        this.headerToggleButton.setContentDescription(this.headerToggleButton.isChecked() ? checkableImageButton.getContext().getString(C2466R.string.mtrl_picker_toggle_to_calendar_input_mode) : checkableImageButton.getContext().getString(C2466R.string.mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int iResolveOrThrow = MaterialAttributes.resolveOrThrow(context, C2466R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C2466R.attr.materialCalendarStyle, C2466R.style.Widget_MaterialComponents_MaterialCalendar);
        this.background = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(context);
        this.background.setFillColor(ColorStateList.valueOf(iResolveOrThrow));
        this.background.setElevation(gbl0.m125220t(dialog.getWindow().getDecorView()));
        return dialog;
    }
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C2466R.layout.mtrl_picker_fullscreen : C2466R.layout.mtrl_picker_dialog, viewGroup);
        Context context = viewInflate.getContext();
        if (this.fullscreen) {
            viewInflate.findViewById(C2466R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View viewFindViewById = viewInflate.findViewById(C2466R.id.mtrl_calendar_main_pane);
            View viewFindViewById2 = viewInflate.findViewById(C2466R.id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) viewInflate.findViewById(C2466R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        gbl0.m125205l0(textView, 1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C2466R.id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) viewInflate.findViewById(C2466R.id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) viewInflate.findViewById(C2466R.id.confirm_button);
        ...
        Button button2 = (Button) viewInflate.findViewById(C2466R.id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C2466R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public static final class Builder<S> {
        ...
        @NonNull
        public static Builder<j760<Long, Long>> dateRangePicker() {
