...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public class ChipTouchHelper extends wnf {
        ...
        public void onPopulateNodeForHost(@NonNull C17055gc c17055gc) {
            c17055gc.m125423m0(Chip.this.isCheckable());
            c17055gc.m125429p0(Chip.this.isClickable());
            if (Chip.this.isCheckable() || Chip.this.isClickable()) {
                c17055gc.m125427o0(Chip.this.isCheckable() ? Chip.COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : Chip.BUTTON_ACCESSIBILITY_CLASS_NAME);
            } else {
                c17055gc.m125427o0(Chip.GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME);
            }
            c17055gc.m125390Q0(Chip.this.getText());
        }

        @Override // p149l.wnf
        public void onPopulateNodeForVirtualView(int i, @NonNull C17055gc c17055gc) {
            if (i != 1) {
                c17055gc.m125434s0("");
                c17055gc.m125417j0(Chip.EMPTY_BOUNDS);
                return;
            }
            CharSequence closeIconContentDescription = Chip.this.getCloseIconContentDescription();
            if (closeIconContentDescription != null) {
                c17055gc.m125434s0(closeIconContentDescription);
            } else {
                CharSequence text = Chip.this.getText();
                c17055gc.m125434s0(Chip.this.getContext().getString(C2466R.string.mtrl_chip_close_icon_content_description, TextUtils.isEmpty(text) ? "" : text).trim());
            }
            c17055gc.m125417j0(Chip.this.getCloseIconTouchBoundsInt());
            c17055gc.m125403b(C17055gc.a.f101954i);
            c17055gc.m125440v0(Chip.this.isEnabled());
        }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C2466R.style.Widget_MaterialComponents_Chip_Action);
        initMinTouchTarget(context, attributeSet, i);
        setChipDrawable(chipDrawableCreateFromAttributes);
        chipDrawableCreateFromAttributes.setElevation(gbl0.m125220t(this));
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2466R.styleable.Chip, i, C2466R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C2466R.styleable.Chip_shapeAppearance);
        typedArrayObtainStyledAttributes.recycle();
        ChipTouchHelper chipTouchHelper = new ChipTouchHelper(this);
        this.touchHelper = chipTouchHelper;
        gbl0.m125201j0(this, chipTouchHelper);
        if (!zHasValue) {
            initOutlineProvider();
        }
        ...
        this.lastLayoutDirection = gbl0.m125228x(this);
    }
    ...
    private boolean handleAccessibilityExit(@NonNull MotionEvent motionEvent) {
        ...
        try {
            Field declaredField = wnf.class.getDeclaredField("mHoveredVirtualViewId");
            declaredField.setAccessible(true);
            if (((Integer) declaredField.get(this.touchHelper)).intValue() == Integer.MIN_VALUE) {
                return false;
            }
            Method declaredMethod = wnf.class.getDeclaredMethod("updateHoveredVirtualView", Integer.TYPE);
    ...
    private void initMinTouchTarget(Context context, @Nullable AttributeSet attributeSet, int i) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2466R.styleable.Chip, i, C2466R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        this.ensureMinTouchTargetSize = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(typedArrayObtainStyledAttributes.getDimension(C2466R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    private void updateBackgroundDrawable() {
        ...
        gbl0.m125207m0(this, getBackgroundDrawable());
    ...
    private void updateFrameworkRippleBackground() {
        ...
        gbl0.m125207m0(this, this.ripple);
    }
    ...
    private void updatePaddingInternal() {
        ...
        gbl0.m125233z0(this, (int) (this.chipDrawable.getChipStartPadding() + this.chipDrawable.getTextStartPadding() + this.chipDrawable.calculateChipIconWidth()), getPaddingTop(), (int) (chipDrawable.getChipEndPadding() + this.chipDrawable.getTextEndPadding() + this.chipDrawable.calculateCloseIconWidth()), getPaddingBottom());
    }
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        attributeSet.getAttributeValue(NAMESPACE_ANDROID, OMSResourceType.background);
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableLeft") != null) {
            qq3.m175877a("Please set left drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableStart") != null) {
            qq3.m175877a("Please set start drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableEnd") != null) {
            qq3.m175877a("Please set end drawable using R.attr#closeIcon.");
            return;
        }
        ...
        if (attributeSet.getAttributeBooleanValue(NAMESPACE_ANDROID, "singleLine", true) && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "lines", 1) == 1 && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "minLines", 1) == 1 && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "maxLines", 1) == 1) {
            ...
            qq3.m175877a("Chip does not support multi-line text");
        }
    }
    ...
    public void setEllipsize(TextUtils.TruncateAt truncateAt) {
        ...
        if (truncateAt == TextUtils.TruncateAt.MARQUEE) {
            qq3.m175877a("Text within a chip are not allowed to scroll.");
            return;
        }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(@Nullable Drawable drawable, @Nullable Drawable drawable2, @Nullable Drawable drawable3, @Nullable Drawable drawable4) {
        if (drawable != null) {
            ...
            qq3.m175877a("Please set right drawable using R.attr#closeIcon.");
        }
    }

    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.chipStyle);
    }
