...
public class ExtendableSavedState extends AbsSavedState {
    ...
    @NonNull
    public final hgf0<String, Bundle> extendableStates;
    ...
    private ExtendableSavedState(@NonNull Parcel parcel, ClassLoader classLoader) {
        ...
        this.extendableStates = new hgf0<>(i);
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            strArr[i2] = this.extendableStates.m130823i(i2);
            bundleArr[i2] = this.extendableStates.m130827m(i2);
        }
    ...
    public ExtendableSavedState(Parcelable parcelable) {
        super(parcelable);
        this.extendableStates = new hgf0<>();
    }
}
