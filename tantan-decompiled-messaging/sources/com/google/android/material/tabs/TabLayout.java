...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final hb80<Tab> tabPool = new lb80(16);
    ...
    private final hb80<TabView> tabViewPool;
    ...
    public class AdapterChangeListener implements ViewPager.InterfaceC0715i {
        ...
        public void onAdapterChanged(@NonNull ViewPager viewPager, @Nullable w660 w660Var, @Nullable w660 w660Var2) {
            ...
            if (tabLayout.viewPager == viewPager) {
                tabLayout.setPagerAdapter(w660Var2, this.autoRefresh);
            }
        }
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            if (i3 >= 0 && this.indicatorRight > i3) {
                ...
                Drawable drawableM145284r = kbe.m145284r(drawable2);
                drawableM145284r.setBounds(this.indicatorLeft, height, this.indicatorRight, intrinsicHeight);
                Paint paint = this.selectedIndicatorPaint;
                if (paint != null) {
                    kbe.m145280n(drawableM145284r, paint.getColor());
                }
                drawableM145284r.draw(canvas);
            }
            super.draw(canvas);
        }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.InterfaceC0716j {
    ...
    public final class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            gbl0.m125233z0(this, TabLayout.this.tabPaddingStart, TabLayout.this.tabPaddingTop, TabLayout.this.tabPaddingEnd, TabLayout.this.tabPaddingBottom);
            setGravity(17);
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C2466R.layout.design_layout_tab_icon, viewGroup, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C2466R.layout.design_layout_tab_text, viewGroup, false);
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (i != 0) {
                ...
                this.baseBackgroundDrawable = drawableM161424b;
        ...
        private void updateTextAndIcon(@Nullable TextView textView, @Nullable ImageView imageView) {
            Tab tab = this.tab;
            Drawable drawableMutate = (tab == null || tab.getIcon() == null) ? null : kbe.m145284r(this.tab.getIcon()).mutate();
            Tab tab2 = this.tab;
            ...
            Tab tab3 = this.tab;
            dti0.m113570a(this, zIsEmpty ? tab3 != null ? tab3.contentDesc : null : null);
        }
        ...
        public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent accessibilityEvent) {
            ...
            accessibilityEvent.setClassName(i30.AbstractC17467c.class.getName());
        }
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setClassName(i30.AbstractC17467c.class.getName());
            BadgeDrawable badgeDrawable = this.badgeDrawable;
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (this.textView != null) {
                ...
                int iM154810d = mji0.m154810d(this.textView);
        ...
        public final void update() {
            ...
            if (customView != null) {
                ...
                if (textView2 != null) {
                    this.defaultMaxLines = mji0.m154810d(textView2);
                }
            ...
            if (this.customView == null) {
                ...
                if (tab != null && tab.getIcon() != null) {
                    drawableMutate = kbe.m145284r(tab.getIcon()).mutate();
                }
                if (drawableMutate != null) {
                    kbe.m145281o(drawableMutate, TabLayout.this.tabIconTint);
                ...
                if (this.textView == null) {
                    ...
                    this.defaultMaxLines = mji0.m154810d(this.textView);
                }
                mji0.m154821o(this.textView, TabLayout.this.tabTextAppearance);
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.tabViewPool = new jb80(12);
        setHorizontalScrollBarEnabled(false);
        SlidingTabIndicator slidingTabIndicator = new SlidingTabIndicator(context);
        this.slidingTabIndicator = slidingTabIndicator;
        super.addView(slidingTabIndicator, 0, new FrameLayout.LayoutParams(-2, -1));
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2466R.styleable.TabLayout, i, C2466R.style.Widget_Design_TabLayout, C2466R.styleable.TabLayout_tabTextAppearance);
        ...
        slidingTabIndicator.setSelectedIndicatorHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabIndicatorHeight, -1));
        slidingTabIndicator.setSelectedIndicatorColor(typedArrayObtainStyledAttributes.getColor(C2466R.styleable.TabLayout_tabIndicatorColor, 0));
        setSelectedTabIndicator(MaterialResources.getDrawable(context, typedArrayObtainStyledAttributes, C2466R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(typedArrayObtainStyledAttributes.getInt(C2466R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabPaddingStart, dimensionPixelSize);
        this.tabPaddingTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C2466R.styleable.TabLayout_tabTextAppearance, C2466R.style.TextAppearance_Design_Tab);
        this.tabTextAppearance = resourceId;
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(resourceId, aac0.f68401V2);
        try {
            this.tabTextSize = typedArrayObtainStyledAttributes2.getDimensionPixelSize(aac0.f68405W2, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes2, aac0.f68417Z2);
            typedArrayObtainStyledAttributes2.recycle();
            if (typedArrayObtainStyledAttributes.hasValue(C2466R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2466R.styleable.TabLayout_tabTextColor);
            }
            if (typedArrayObtainStyledAttributes.hasValue(C2466R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), typedArrayObtainStyledAttributes.getColor(C2466R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2466R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C2466R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2466R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = typedArrayObtainStyledAttributes.getInt(C2466R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.requestedTabMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = typedArrayObtainStyledAttributes.getResourceId(C2466R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.TabLayout_tabContentStart, 0);
            this.mode = typedArrayObtainStyledAttributes.getInt(C2466R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = typedArrayObtainStyledAttributes.getInt(C2466R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.TabLayout_tabUnboundedRipple, false);
            typedArrayObtainStyledAttributes.recycle();
            Resources resources = getResources();
            this.tabTextMultiLineSize = resources.getDimensionPixelSize(C2466R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = resources.getDimensionPixelSize(C2466R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            typedArrayObtainStyledAttributes2.recycle();
            throw th;
    ...
    private void animateToTab(int i) {
        ...
        if (getWindowToken() == null || !gbl0.m125171P(this) || this.slidingTabIndicator.childrenNeedLayout()) {
    ...
    private void applyModeAndGravity() {
        int i = this.mode;
        gbl0.m125233z0(this.slidingTabIndicator, (i == 0 || i == 2) ? Math.max(0, this.contentInsetStart - this.tabPaddingStart) : 0, 0, 0, 0);
        int i2 = this.mode;
        if (i2 == 0) {
    ...
    private TabView createTabView(@NonNull Tab tab) {
        hb80<TabView> hb80Var = this.tabViewPool;
    ...
    private void setupWithViewPager(@Nullable ViewPager viewPager, boolean z, boolean z2) {
        ...
        if (viewPager2 != null) {
            ...
            if (tabLayoutOnPageChangeListener != null) {
                viewPager2.m4175P(tabLayoutOnPageChangeListener);
            }
            AdapterChangeListener adapterChangeListener = this.adapterChangeListener;
            if (adapterChangeListener != null) {
                this.viewPager.m4174O(adapterChangeListener);
            }
        }
        ...
        if (viewPager != null) {
            ...
            viewPager.m4185d(this.pageChangeListener);
            ...
            viewPager.m4184c(this.adapterChangeListener);
    ...
    public void populateFromPagerAdapter() {
        int currentItem;
        removeAllTabs();
        w660 w660Var = this.pagerAdapter;
        if (w660Var != null) {
    ...
    public void removeTab(@NonNull Tab tab) {
        if (tab.parent == this) {
            ...
            ig3.m135964a("Tab does not belong to this TabLayout.");
        }
    }
    ...
    public void setPagerAdapter(@Nullable w660 w660Var, boolean z) {
        DataSetObserver dataSetObserver;
        w660 w660Var2 = this.pagerAdapter;
        if (w660Var2 != null && (dataSetObserver = this.pagerAdapterObserver) != null) {
            w660Var2.unregisterDataSetObserver(dataSetObserver);
        }
        this.pagerAdapter = w660Var;
        if (z && w660Var != null) {
            if (this.pagerAdapterObserver == null) {
                this.pagerAdapterObserver = new PagerAdapterObserver();
            }
            w660Var.registerDataSetObserver(this.pagerAdapterObserver);
        }
    ...
    public void setSelectedTabIndicatorGravity(int i) {
        if (this.tabIndicatorGravity != i) {
            ...
            gbl0.m125183a0(this.slidingTabIndicator);
        }
    }
    ...
    public static class Tab {
        ...
        public Tab setIcon(@DrawableRes int i) {
            TabLayout tabLayout = this.parent;
            if (tabLayout != null) {
                return setIcon(nu0.m161424b(tabLayout.getContext(), i));
            }
            ig3.m135964a("Tab not attached to a TabLayout");
            return null;
        }
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.tabStyle);
    }
