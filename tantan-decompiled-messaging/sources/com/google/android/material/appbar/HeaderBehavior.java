...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public class FlingRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (!zComputeScrollOffset) {
                ...
                gbl0.m125185b0(this.layout, this);
            }
        }
    }
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v2, int i, int i2, float f) {
        ...
        gbl0.m125185b0(v2, flingRunnable);
        return true;
    }
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v2, int i, int i2, int i3) {
        ...
        if (i2 == 0 || topAndBottomOffset < i2 || topAndBottomOffset > i3 || topAndBottomOffset == (iM145807b = kex.m145807b(i, i2, i3))) {
            return 0;
        }
        setTopAndBottomOffset(iM145807b);
        return topAndBottomOffset - iM145807b;
    }
