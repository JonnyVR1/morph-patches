...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    private void updateImportantForAccessibility(@NonNull View view, boolean z) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                boolean z2 = (childAt.getLayoutParams() instanceof CoordinatorLayout.C0229f) && (((CoordinatorLayout.C0229f) childAt.getLayoutParams()).m1181f() instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z2) {
    ...
    public FabTransformationBehavior.FabTransformationSpec onCreateMotionSpec(Context context, boolean z) {
        int i = z ? C2466R.animator.mtrl_fab_transformation_sheet_expand_spec : C2466R.animator.mtrl_fab_transformation_sheet_collapse_spec;
