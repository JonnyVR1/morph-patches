...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.InterfaceC0225b {
    ...
    private static final int DEF_STYLE_RES = C2466R.style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    static final Property<View, Float> HEIGHT;
    static final Property<View, Float> WIDTH;
    private int animState;

    @NonNull
    private final CoordinatorLayout.AbstractC0226c<ExtendedFloatingActionButton> behavior;
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C2466R.animator.mtrl_extended_fab_change_size_motion_spec;
        }
    ...
    public class HideStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C2466R.animator.mtrl_extended_fab_hide_motion_spec;
        }
    ...
    public class ShowStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C2466R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C2466R.styleable.ExtendedFloatingActionButton;
        ...
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2466R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2466R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec motionSpecCreateFromAttribute3 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2466R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec motionSpecCreateFromAttribute4 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2466R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
    ...
    private boolean shouldAnimateVisibilityChange() {
        return gbl0.m125171P(this) && !isInEditMode();
    }
    ...
    public int getCollapsedSize() {
        return (Math.min(gbl0.m125149B(this), gbl0.m125147A(this)) * 2) + getIconSize();
    }
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.AbstractC0226c<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2466R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            CoordinatorLayout.C0229f c0229f = (CoordinatorLayout.C0229f) extendedFloatingActionButton.getLayoutParams();
            int i2 = 0;
            if (extendedFloatingActionButton.getRight() >= coordinatorLayout.getWidth() - ((ViewGroup.MarginLayoutParams) c0229f).rightMargin) {
                i = rect.right;
            } else {
                i = extendedFloatingActionButton.getLeft() <= ((ViewGroup.MarginLayoutParams) c0229f).leftMargin ? -rect.left : 0;
            }
            if (extendedFloatingActionButton.getBottom() >= coordinatorLayout.getHeight() - ((ViewGroup.MarginLayoutParams) c0229f).bottomMargin) {
                i2 = rect.bottom;
            } else if (extendedFloatingActionButton.getTop() <= ((ViewGroup.MarginLayoutParams) c0229f).topMargin) {
                i2 = -rect.top;
            }
            if (i2 != 0) {
                gbl0.m125177V(extendedFloatingActionButton, i2);
            }
            if (i != 0) {
                gbl0.m125176U(extendedFloatingActionButton, i);
            }
        }
        ...
        private boolean shouldUpdateVisibility(@NonNull View view, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((CoordinatorLayout.C0229f) extendedFloatingActionButton.getLayoutParams()).m1180e() == view.getId();
        }
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.extendedFloatingActionButtonStyle);
    }
