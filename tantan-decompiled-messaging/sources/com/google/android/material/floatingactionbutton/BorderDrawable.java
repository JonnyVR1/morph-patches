...
class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, rect.top, 0.0f, rect.bottom, new int[]{ge5.m125673j(this.topOuterStrokeColor, this.currentBorderTintColor), ge5.m125673j(this.topInnerStrokeColor, this.currentBorderTintColor), ge5.m125673j(ge5.m125678o(this.topInnerStrokeColor, 0), this.currentBorderTintColor), ge5.m125673j(ge5.m125678o(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), ge5.m125673j(this.bottomInnerStrokeColor, this.currentBorderTintColor), ge5.m125673j(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, fHeight, 0.5f, 0.5f, 1.0f - fHeight, 1.0f}, Shader.TileMode.CLAMP);
    }
