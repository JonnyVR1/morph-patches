...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        BorderDrawable borderDrawable = new BorderDrawable((ShapeAppearanceModel) tf80.m188658e(this.shapeAppearance));
        borderDrawable.setGradientColors(e16.m114375c(context, C2466R.color.design_fab_stroke_top_outer_color), e16.m114375c(context, C2466R.color.design_fab_stroke_top_inner_color), e16.m114375c(context, C2466R.color.design_fab_stroke_end_inner_color), e16.m114375c(context, C2466R.color.design_fab_stroke_end_outer_color));
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new AlwaysStatefulMaterialShapeDrawable((ShapeAppearanceModel) tf80.m188658e(this.shapeAppearance));
    }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            layerDrawable = new LayerDrawable(new Drawable[]{(Drawable) tf80.m188658e(this.borderDrawable), (Drawable) tf80.m188658e(this.shapeDrawable)});
        } else {
