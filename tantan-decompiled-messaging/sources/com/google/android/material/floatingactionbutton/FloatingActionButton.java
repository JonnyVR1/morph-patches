...
public class FloatingActionButton extends VisibilityAwareImageButton implements ExpandableTransformationWidget, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C2466R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2466R.styleable.FloatingActionButton, i, i2, new int[0]);
        this.backgroundTint = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C2466R.styleable.FloatingActionButton_backgroundTint);
        this.backgroundTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C2466R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.rippleColor = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C2466R.styleable.FloatingActionButton_rippleColor);
        this.size = typedArrayObtainStyledAttributes.getInt(C2466R.styleable.FloatingActionButton_fabSize, -1);
        this.customSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.borderWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = typedArrayObtainStyledAttributes.getDimension(C2466R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = typedArrayObtainStyledAttributes.getDimension(C2466R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float dimension3 = typedArrayObtainStyledAttributes.getDimension(C2466R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.compatPadding = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.FloatingActionButton_useCompatPadding, false);
        int dimensionPixelSize = getResources().getDimensionPixelSize(C2466R.dimen.mtrl_fab_min_touch_target);
        this.maxImageSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.FloatingActionButton_maxImageSize, 0);
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C2466R.styleable.FloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C2466R.styleable.FloatingActionButton_hideMotionSpec);
        ...
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
        typedArrayObtainStyledAttributes.recycle();
        ku0 ku0Var = new ku0(this);
        this.imageHelper = ku0Var;
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            return i != 1 ? resources.getDimensionPixelSize(C2466R.dimen.design_fab_size_normal) : resources.getDimensionPixelSize(C2466R.dimen.design_fab_size_mini);
        }
    ...
    private void onApplySupportImageTint() {
        ...
        drawable.mutate().setColorFilter(iu0.m138316e(colorForState, mode));
    }
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        return (ShapeAppearanceModel) tf80.m188658e(getImpl().getShapeAppearance());
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.expandableWidgetHelper.onRestoreInstanceState((Bundle) tf80.m188658e(extendableSavedState.extendableStates.get(EXPANDABLE_WIDGET_HELPER_KEY)));
    }
    ...
    public void setCustomSize(@Px int i) {
        if (i < 0) {
            ig3.m135964a("Custom size must be non-negative");
    ...
    public static class Behavior extends BaseBehavior<FloatingActionButton> {
        ...
        public /* bridge */ /* synthetic */ void onAttachedToLayoutParams(@NonNull CoordinatorLayout.C0229f c0229f) {
    ...
    public static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.AbstractC0226c<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2466R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        private static boolean isBottomSheet(@NonNull View view) {
            ...
            if (layoutParams instanceof CoordinatorLayout.C0229f) {
                return ((CoordinatorLayout.C0229f) layoutParams).m1181f() instanceof BottomSheetBehavior;
            }
            return false;
        }
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull FloatingActionButton floatingActionButton) {
            ...
            int i2 = 0;
            if (floatingActionButton.getRight() >= coordinatorLayout.getWidth() - ((ViewGroup.MarginLayoutParams) c0229f).rightMargin) {
                i = rect.right;
            } else {
                i = floatingActionButton.getLeft() <= ((ViewGroup.MarginLayoutParams) c0229f).leftMargin ? -rect.left : 0;
            }
            ...
            if (i2 != 0) {
                gbl0.m125177V(floatingActionButton, i2);
            }
            if (i != 0) {
                gbl0.m125176U(floatingActionButton, i);
            }
        }

        private boolean shouldUpdateVisibility(@NonNull View view, @NonNull FloatingActionButton floatingActionButton) {
            return this.autoHideEnabled && ((CoordinatorLayout.C0229f) floatingActionButton.getLayoutParams()).m1180e() == view.getId() && floatingActionButton.getUserSetVisibility() == 0;
        }
        ...
        private boolean updateFabVisibilityForBottomSheet(@NonNull View view, @NonNull FloatingActionButton floatingActionButton) {
            ...
            CoordinatorLayout.C0229f c0229f = (CoordinatorLayout.C0229f) floatingActionButton.getLayoutParams();
            int top = view.getTop();
            int height = (floatingActionButton.getHeight() / 2) + ((ViewGroup.MarginLayoutParams) c0229f).topMargin;
            OnVisibilityChangedListener onVisibilityChangedListener = this.internalAutoHideListener;
            if (top < height) {
                floatingActionButton.hide(onVisibilityChangedListener, false);
                return true;
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.floatingActionButtonStyle);
    }
