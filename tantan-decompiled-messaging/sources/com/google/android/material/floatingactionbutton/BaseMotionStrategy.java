...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(@NonNull MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(BigEyeFilter.UNIFORM_SCALE)) {
            arrayList.add(motionSpec.getAnimator(BigEyeFilter.UNIFORM_SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(BigEyeFilter.UNIFORM_SCALE, this.fab, View.SCALE_X));
        }
    ...
    public final MotionSpec getCurrentMotionSpec() {
        ...
        return (MotionSpec) tf80.m188658e(this.defaultMotionSpec);
    }
