...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C2466R.style.Widget_MaterialComponents_Button;
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2466R.styleable.MaterialButton, i, i2, new int[0]);
        this.iconPadding = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C2466R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), typedArrayObtainStyledAttributes, C2466R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), typedArrayObtainStyledAttributes, C2466R.styleable.MaterialButton_icon);
        this.iconGravity = typedArrayObtainStyledAttributes.getInteger(C2466R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2466R.styleable.MaterialButton_iconSize, 0);
    ...
    private void resetIconDrawable(boolean z) {
        ...
        if (z) {
            mji0.m154816j(this, drawable, null, null, null);
        } else {
            mji0.m154816j(this, null, null, drawable, null);
        }
    }
    ...
    private void updateIcon(boolean z) {
        ...
        if (drawable != null) {
            ...
            kbe.m145281o(drawableMutate, this.iconTint);
            PorterDuff.Mode mode = this.iconTintMode;
            if (mode != null) {
                kbe.m145282p(this.icon, mode);
            }
        ...
        Drawable[] drawableArrM154807a = mji0.m154807a(this);
        Drawable drawable3 = drawableArrM154807a[0];
        Drawable drawable4 = drawableArrM154807a[2];
    ...
    private void updateIconPosition() {
        ...
        int measuredWidth = (((((getMeasuredWidth() - iMin) - gbl0.m125147A(this)) - intrinsicWidth) - this.iconPadding) - gbl0.m125149B(this)) / 2;
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        ...
        qkq0.m175383a("Attempted to get ShapeAppearanceModel from a MaterialButton which has an overwritten background.");
        return null;
    }
    ...
    public void setBackgroundResource(@DrawableRes int i) {
        setBackgroundDrawable(i != 0 ? nu0.m161424b(getContext(), i) : null);
    }
    ...
    public void setIconSize(@Px int i) {
        if (i < 0) {
            ig3.m135964a("iconSize cannot be less than 0");
    ...
    public void setIconTintResource(@ColorRes int i) {
        setIconTint(nu0.m161423a(getContext(), i));
    }
    ...
    public void setRippleColorResource(@ColorRes int i) {
        if (isUsingOriginalBackground()) {
            setRippleColor(nu0.m161423a(getContext(), i));
        }
    }
    ...
    public void setShapeAppearanceModel(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
        if (isUsingOriginalBackground()) {
            ...
            qkq0.m175383a("Attempted to set ShapeAppearanceModel on a MaterialButton which has an overwritten background.");
        }
    }
    ...
    public void setStrokeColorResource(@ColorRes int i) {
        if (isUsingOriginalBackground()) {
            setStrokeColor(nu0.m161423a(getContext(), i));
        }
    }
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.materialButtonStyle);
    }
