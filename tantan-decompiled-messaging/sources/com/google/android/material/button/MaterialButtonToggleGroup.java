...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2466R.styleable.MaterialButtonToggleGroup, i, C2466R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        setSingleSelection(typedArrayObtainStyledAttributes.getBoolean(C2466R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = typedArrayObtainStyledAttributes.getResourceId(C2466R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
            ...
            if (getOrientation() == 0) {
                quw.m176656c(layoutParamsBuildLayoutParams, 0);
                quw.m176657d(layoutParamsBuildLayoutParams, -iMin);
            } else {
    ...
    private void resetChildMargins(int i) {
        ...
        if (getOrientation() == 1) {
            ...
            quw.m176656c(layoutParams, 0);
            quw.m176657d(layoutParams, 0);
    ...
    private void setGeneratedIdIfNeeded(@NonNull MaterialButton materialButton) {
        if (materialButton.getId() == -1) {
            materialButton.setId(gbl0.m125198i());
        }
    }
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2466R.attr.materialButtonToggleGroupStyle);
    }
