...
public class MaterialAlertDialogBuilder extends DialogInterfaceC0074a.a {

    @AttrRes
    private static final int DEF_STYLE_ATTR = C2466R.attr.alertDialogStyle;

    @StyleRes
    private static final int DEF_STYLE_RES = C2466R.style.MaterialAlertDialog_MaterialComponents;

    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C2466R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C2466R.attr.colorSurface, getClass().getCanonicalName());
    ...
    private static Context createMaterialAlertDialogThemedContext(@NonNull Context context) {
        ...
        return materialAlertDialogThemeOverlay == 0 ? contextCreateThemedContext : new m16(contextCreateThemedContext, materialAlertDialogThemeOverlay);
    }
    ...
    @Override // androidx.appcompat.app.DialogInterfaceC0074a.a
    public DialogInterfaceC0074a create() {
        DialogInterfaceC0074a dialogInterfaceC0074aCreate = super.create();
        Window window = dialogInterfaceC0074aCreate.getWindow();
        View decorView = window.getDecorView();
        Drawable drawable = this.background;
        if (drawable instanceof MaterialShapeDrawable) {
            ((MaterialShapeDrawable) drawable).setElevation(gbl0.m125220t(decorView));
        }
        window.setBackgroundDrawable(MaterialDialogs.insetDrawable(this.background, this.backgroundInsets));
        decorView.setOnTouchListener(new InsetDialogOnTouchListener(dialogInterfaceC0074aCreate, this.backgroundInsets));
