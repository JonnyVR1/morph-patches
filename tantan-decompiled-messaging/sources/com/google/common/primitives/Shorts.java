...
public final class Shorts extends wye0 {
    ...
    public enum LexicographicalComparator implements Comparator<short[]> {
        ...
        public int compare(short[] sArr, short[] sArr2) {
            ...
            for (int i = 0; i < iMin; i++) {
                int iM16481c = Shorts.m16481c(sArr[i], sArr2[i]);
                if (iM16481c != 0) {
                    return iM16481c;
                }
            }
    ...
    public static int m16481c(short s, short s2) {
        return s - s2;
    }

    /* JADX INFO: renamed from: d */
    public static int m16482d(short s) {
        return s;
    }

    /* JADX INFO: renamed from: e */
    public static int m16483e(short[] sArr, short s, int i, int i2) {
        while (i < i2) {
            if (sArr[i] == s) {
                return i;
            }
    ...
    public static int m16484f(short[] sArr, short s, int i, int i2) {
    ...
    public static class ShortArrayAsList extends AbstractList<Short> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Short) && Shorts.m16483e(this.array, ((Short) obj).shortValue(), this.start, this.end) != -1;
        }
        ...
        public int hashCode() {
            ...
            for (int i = this.start; i < this.end; i++) {
                iM16482d = (iM16482d * 31) + Shorts.m16482d(this.array[i]);
            }
            return iM16482d;
        }
        ...
        public int indexOf(Object obj) {
            int iM16483e;
            if (!(obj instanceof Short) || (iM16483e = Shorts.m16483e(this.array, ((Short) obj).shortValue(), this.start, this.end)) < 0) {
                return -1;
            }
            return iM16483e - this.start;
        }
        ...
        public int lastIndexOf(Object obj) {
            int iM16484f;
            if (!(obj instanceof Short) || (iM16484f = Shorts.m16484f(this.array, ((Short) obj).shortValue(), this.start, this.end)) < 0) {
                return -1;
            }
            return iM16484f - this.start;
        }
        ...
        public Short set(int i, Short sh) {
            ...
            int i2 = this.start;
            short s = sArr[i2 + i];
            sArr[i2 + i] = ((Short) sf80.m183894p(sh)).shortValue();
