...
abstract class InterruptibleTask<T> extends AtomicReference<Runnable> implements Runnable {
    ...
    public static final class RunnableC3075b implements Runnable {
        public RunnableC3075b() {
        }
    ...
    static {
        DONE = new RunnableC3075b();
        PARKED = new RunnableC3075b();
    }
    ...
    public final void run() {
        ...
        if (compareAndSet(null, threadCurrentThread)) {
            ...
            afterRanInterruptiblySuccess(wu40.m205595a(objRunInterruptibly));
        }
    }
