...
public abstract class HashCode {
    ...
    public static final class BytesHashCode extends HashCode implements Serializable {
        ...
        public BytesHashCode(byte[] bArr) {
            this.bytes = (byte[]) sf80.m183894p(bArr);
        }
        ...
        public int asInt() {
            ...
            sf80.m183902x(bArr.length >= 4, "HashCode#asInt() requires >= 4 bytes (it only has %s bytes).", bArr.length);
        ...
        public long asLong() {
            byte[] bArr = this.bytes;
            sf80.m183902x(bArr.length >= 8, "HashCode#asLong() requires >= 8 bytes (it only has %s bytes).", bArr.length);
            return padToLong();
        }
    ...
    public static final class IntHashCode extends HashCode implements Serializable {
        ...
        @Override // com.google.common.hash.HashCode
        public long padToLong() {
            return UnsignedInts.m16493f(this.hash);
        }
    ...
    public static HashCode fromBytes(byte[] bArr) {
        sf80.m183883e(bArr.length >= 1, "A HashCode must contain at least 1 byte.");
    ...
    public static HashCode fromString(String str) {
        sf80.m183889k(str.length() >= 2, "input string (%s) must have at least 2 characters", str);
        sf80.m183889k(str.length() % 2 == 0, "input string (%s) must have an even number of characters", str);
    ...
    public int writeBytesTo(byte[] bArr, int i, int i2) {
        int iM16467l = Ints.m16467l(i2, bits() / 8);
        sf80.m183899u(i, i + iM16467l, bArr.length);
        writeBytesToImpl(bArr, i, iM16467l);
        return iM16467l;
    }
