...
final class ImmutableMapValues<K, V> extends ImmutableCollection<V> {
    ...
    public class C2788a extends dpj0<V> {

        /* JADX INFO: renamed from: a */
        public final dpj0<Map.Entry<K, V>> f10896a;

        public C2788a() {
            this.f10896a = ImmutableMapValues.this.map.entrySet().iterator();
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f10896a.hasNext();
        }

        @Override // java.util.Iterator
        public V next() {
            return this.f10896a.next().getValue();
        }
    }
    ...
    public boolean contains(Object obj) {
        return obj != null && Iterators.m15877g(iterator(), obj);
    }
