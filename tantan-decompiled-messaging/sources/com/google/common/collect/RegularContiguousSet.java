...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    public class C2909a extends AbstractC15537a8<C> {

        /* JADX INFO: renamed from: b */
        public final C f11086b;

        public C2909a(Comparable comparable) {
            super(comparable);
            this.f11086b = (C) RegularContiguousSet.this.last();
        }

        @Override // p149l.AbstractC15537a8
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public C mo15539a(C c) {
            if (RegularContiguousSet.equalsOrThrow(c, this.f11086b)) {
                return null;
            }
    ...
    public class C2910b extends AbstractC15537a8<C> {

        /* JADX INFO: renamed from: b */
        public final C f11088b;

        public C2910b(Comparable comparable) {
            super(comparable);
            this.f11088b = (C) RegularContiguousSet.this.first();
        }

        @Override // p149l.AbstractC15537a8
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public C mo15539a(C c) {
            if (RegularContiguousSet.equalsOrThrow(c, this.f11088b)) {
                return null;
            }
    ...
    public ContiguousSet<C> intersection(ContiguousSet<C> contiguousSet) {
        sf80.m183894p(contiguousSet);
        sf80.m183882d(this.domain.equals(contiguousSet.domain));
    ...
    public static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public /* synthetic */ SerializedForm(Range range, DiscreteDomain discreteDomain, C2909a c2909a) {
