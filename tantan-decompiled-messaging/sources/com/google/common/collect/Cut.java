...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    public static final class AboveValue<C extends Comparable> extends Cut<C> {
        ...
        public AboveValue(C c) {
            super((Comparable) sf80.m183894p(c));
        }
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i = C2759a.f10854a[boundType.ordinal()];
            if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.google.common.collect.Cut$a */
    public static /* synthetic */ class C2759a {
        ...
        static {
            ...
            try {
                f10854a[BoundType.OPEN.ordinal()] = 2;
    ...
    public int compareTo(Cut<C> cut) {
        ...
        return iCompareOrThrow != 0 ? iCompareOrThrow : Booleans.m16381c(this instanceof AboveValue, cut instanceof AboveValue);
    }
