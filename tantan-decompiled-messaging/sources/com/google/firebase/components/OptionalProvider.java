...
class OptionalProvider<T> implements Provider<T>, Deferred<T> {
    ...
    public static /* synthetic */ Object m16684a() {
        return null;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m16685b(Deferred.DeferredHandler deferredHandler, Deferred.DeferredHandler deferredHandler2, Provider provider) {
        deferredHandler.handle(provider);
        deferredHandler2.handle(provider);
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m16686c(Provider provider) {
    }
    ...
    public static <T> OptionalProvider<T> m16687of(Provider<T> provider) {
    ...
    public void set(Provider<T> provider) {
        ...
        if (this.delegate != EMPTY_PROVIDER) {
            qkq0.m175383a("provide() can be called only once.");
            return;
        }
        synchronized (this) {
            ...
            if (provider != provider4) {
                ...
                this.handler = new Deferred.DeferredHandler() { // from class: com.google.firebase.components.f
                    ...
                    public final void handle(Provider provider5) {
                        OptionalProvider.m16685b(deferredHandler2, deferredHandler, provider5);
                    }
                };
                provider2 = null;
            }
