...
public class ComponentMonitor implements ComponentRegistrarProcessor {
    ...
    public static /* synthetic */ Object m16873a(String str, Component component, ComponentContainer componentContainer) {
        try {
    ...
    public List<Component<?>> processRegistrar(ComponentRegistrar componentRegistrar) {
        ...
        for (final Component<?> componentWithFactory : componentRegistrar.getComponents()) {
            ...
            if (name != null) {
                componentWithFactory = componentWithFactory.withFactory(new ComponentFactory() { // from class: l.or5
                    @Override // com.google.firebase.components.ComponentFactory
                    public final Object create(ComponentContainer componentContainer) {
                        return ComponentMonitor.m16873a(name, componentWithFactory, componentContainer);
                    }
                });
            }
