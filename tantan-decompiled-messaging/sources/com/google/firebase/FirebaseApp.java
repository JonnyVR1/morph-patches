...
public class FirebaseApp {
    ...
    @GuardedBy("LOCK")
    static final Map<String, FirebaseApp> INSTANCES = new e01();
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (f31.m119248a(INSTANCE, null, globalBackgroundStateListener)) {
    ...
    public static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (f31.m119248a(INSTANCE, null, userUnlockReceiver)) {
                    ii5.m136342l(context, userUnlockReceiver, new IntentFilter("android.intent.action.USER_UNLOCKED"));
                }
            }
        }
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(listDiscoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m16676of(context, (Class<Context>) Context.class, (Class<? super Context>[]) new Class[0])).addComponent(Component.m16676of(this, (Class<FirebaseApp>) FirebaseApp.class, (Class<? super FirebaseApp>[]) new Class[0])).addComponent(Component.m16676of(firebaseOptions, (Class<FirebaseOptions>) FirebaseOptions.class, (Class<? super FirebaseOptions>[]) new Class[0])).setProcessor(new ComponentMonitor());
        if (h6k0.m129483a(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m16676of(startupTime, (Class<StartupTime>) StartupTime.class, (Class<? super StartupTime>[]) new Class[0]));
        }
        ComponentRuntime componentRuntimeBuild = processor.build();
        this.componentRuntime = componentRuntimeBuild;
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: l.rli
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return FirebaseApp.m16663b(this.f159965a, context);
            }
        });
        this.defaultHeartBeatController = componentRuntimeBuild.getProvider(DefaultHeartBeatController.class);
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: l.sli
            @Override // com.google.firebase.FirebaseApp.BackgroundStateChangeListener
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.m16662a(this.f165231a, z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    public static /* synthetic */ void m16662a(FirebaseApp firebaseApp, boolean z) {
        if (z) {
    ...
    public static /* synthetic */ DataCollectionConfigStorage m16663b(FirebaseApp firebaseApp, Context context) {
    ...
    public void initializeAllApis() {
        if (!h6k0.m129483a(this.applicationContext)) {
            getName();
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(AuthenticationTokenClaims.JSON_KEY_NAME, this.name).add(Options.TYPE, this.options).toString();
    }
