...
final class LimitedConcurrencyExecutorService extends LimitedConcurrencyExecutor implements ExecutorService, AutoCloseable {
    ...
    public static /* synthetic */ Object m16710d(Runnable runnable, Object obj) {
        runnable.run();
        return obj;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ Object m16711e(Runnable runnable) {
        runnable.run();
        return null;
    }
    ...
    public <T> Future<T> submit(final Runnable runnable, final T t) {
        return submit(new Callable() { // from class: com.google.firebase.concurrent.p
            ...
            public final Object call() {
                return LimitedConcurrencyExecutorService.m16710d(runnable, t);
            }
        });
    }
    ...
    public Future<?> submit(final Runnable runnable) {
        return submit(new Callable() { // from class: com.google.firebase.concurrent.o
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return LimitedConcurrencyExecutorService.m16711e(runnable);
            }
        });
    }
}
