...
public class FirebaseCrashlytics {
    ...
    public static FirebaseCrashlytics getInstance() {
        ...
        jfd0.m141176a("FirebaseCrashlytics component is not present.");
        return null;
    }
    ...
    public static FirebaseCrashlytics init(@NonNull FirebaseApp firebaseApp, @NonNull FirebaseInstallationsApi firebaseInstallationsApi, @NonNull Deferred<CrashlyticsNativeComponent> deferred, @NonNull Deferred<AnalyticsConnector> deferred2, @NonNull Deferred<FirebaseRemoteConfigInterop> deferred3, ExecutorService executorService, ExecutorService executorService2, ExecutorService executorService3) {
        ...
        Logger.getLogger().m16725i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        Logger.getLogger().m16721d("Mapping file ID is: " + mappingFileId);
        for (BuildIdInfo buildIdInfo2 : buildIdInfo) {
            Logger.getLogger().m16721d(String.format("Build id for %s on %s: %s", buildIdInfo2.getLibraryName(), buildIdInfo2.getArch(), buildIdInfo2.getBuildId()));
        }
        try {
            ...
            Logger.getLogger().m16727v("Installer package name is: " + appDataCreate.installerPackageName);
            ...
            settingsControllerCreate.loadSettingsData(crashlyticsWorkers).mo15364c(executorService3, new yd50() { // from class: l.xli
                @Override // p149l.yd50
                public final void onFailure(Exception exc) {
                    Logger.getLogger().m16724e("Error fetching settings.", exc);
                }
            });
            ...
            Logger.getLogger().m16724e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(@NonNull Throwable th) {
        if (th == null) {
            Logger.getLogger().m16729w("A null value was passed to recordException. Ignoring.");
        } else {
