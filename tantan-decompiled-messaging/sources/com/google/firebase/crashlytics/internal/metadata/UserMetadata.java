...
public class UserMetadata {
    ...
    public class SerializeableKeysMap {
        ...
        public static /* synthetic */ void m16762a(SerializeableKeysMap serializeableKeysMap) throws Throwable {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            Runnable runnable = new Runnable() { // from class: com.google.firebase.crashlytics.internal.metadata.a
                ...
                public final void run() throws Throwable {
                    UserMetadata.SerializeableKeysMap.m16762a(this.f11446a);
                }
            };
            if (f31.m119248a(this.queuedSerializer, null, runnable)) {
    ...
    public static /* synthetic */ void m16761c(UserMetadata userMetadata, String str, Map map, List list) throws Throwable {
    ...
    public Map<String, String> getCustomKeys(Map<String, String> map) {
        ...
        if (i > 0) {
            Logger.getLogger().m16729w("Ignored " + i + " keys when adding event specific keys. Maximum allowable: 1024");
        }
    ...
    public void setNewSession(final String str) {
        synchronized (this.sessionIdentifier) {
            ...
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: l.o6k0
                @Override // java.lang.Runnable
                public final void run() throws Throwable {
                    UserMetadata.m16761c(this.f142363a, str, keys, rolloutAssignmentList);
                }
            });
        }
    }
    ...
    public void setUserId(String str) {
        ...
        synchronized (this.userId) {
            try {
                ...
                this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: l.p6k0
                    @Override // java.lang.Runnable
                    public final void run() throws Throwable {
                        this.f147419a.serializeUserDataIfNeeded();
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public boolean updateRolloutsState(List<RolloutAssignment> list) {
        synchronized (this.rolloutsState) {
            try {
                ...
                final List<RolloutAssignment> rolloutAssignmentList = this.rolloutsState.getRolloutAssignmentList();
                this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: l.n6k0
                    @Override // java.lang.Runnable
                    public final void run() throws Throwable {
                        UserMetadata userMetadata = this.f137424a;
