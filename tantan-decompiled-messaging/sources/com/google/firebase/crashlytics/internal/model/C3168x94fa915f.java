...
final class C3168x94fa915f extends CrashlyticsReport.Session.Event.Application.ProcessDetails {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.ProcessDetails.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.ProcessDetails build() {
            ...
            if (this.set$0 == 7 && (str = this.processName) != null) {
                return new C3168x94fa915f(str, this.pid, this.importance, this.defaultProcess);
            }
        ...
        public CrashlyticsReport.Session.Event.Application.ProcessDetails.Builder setProcessName(String str) {
            ...
            jfd0.m141176a("Null processName");
            return null;
        }
    }

    private C3168x94fa915f(String str, int i, int i2, boolean z) {
        this.processName = str;
        this.pid = i;
        this.importance = i2;
        this.defaultProcess = z;
