...
final class C3165x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            if (this.set$0 == 1 && (str = this.name) != null && (str2 = this.code) != null) {
                return new C3165x7c929f5b(str, str2, this.address);
            }
    ...
    private C3165x7c929f5b(String str, String str2, long j) {
        this.name = str;
        this.code = str2;
        this.address = j;
    }
