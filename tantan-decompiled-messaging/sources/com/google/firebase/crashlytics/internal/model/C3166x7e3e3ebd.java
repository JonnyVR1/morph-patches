...
final class C3166x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            if (this.set$0 == 1 && (str = this.name) != null && (list = this.frames) != null) {
                return new C3166x7e3e3ebd(str, this.importance, list);
            }
    ...
    private C3166x7e3e3ebd(String str, int i, List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> list) {
        this.name = str;
        this.importance = i;
        this.frames = list;
    }
