...
public class SettingsController implements SettingsProvider {
    ...
    private final AtomicReference<sei0<Settings>> settingsTask;

    /* JADX INFO: renamed from: com.google.firebase.crashlytics.internal.settings.SettingsController$1 */
    public class C31881 implements r5g0<Void, Void> {
        final /* synthetic */ CrashlyticsWorkers val$crashlyticsWorkers;

        public C31881(CrashlyticsWorkers crashlyticsWorkers) {
        ...
        public Task<Void> then(@Nullable Void r5) throws Exception {
            JSONObject jSONObject = (JSONObject) this.val$crashlyticsWorkers.network.getExecutor().submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.settings.a
                ...
                public final Object call() {
                    SettingsController.C31881 c31881 = this.f11457a;
            ...
            if (jSONObject != null) {
                ...
                ((sei0) SettingsController.this.settingsTask.get()).m183661e(settingsJson);
            }
    ...
    public SettingsController(Context context, SettingsRequest settingsRequest, CurrentTimeProvider currentTimeProvider, SettingsJsonParser settingsJsonParser, CachedSettingsIo cachedSettingsIo, SettingsSpiCall settingsSpiCall, DataCollectionArbiter dataCollectionArbiter) {
        ...
        this.settingsTask = new AtomicReference<>(new sei0());
            ...
            if (!SettingsCacheBehavior.SKIP_CACHE_LOOKUP.equals(settingsCacheBehavior)) {
                ...
                if (cachedSettings != null) {
                    ...
                    if (settingsJson == null) {
                        Logger.getLogger().m16724e("Failed to parse cached settings data.", null);
                        return null;
                    }
                    ...
                    if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && settingsJson.isExpired(currentTimeMillis)) {
                        Logger.getLogger().m16727v("Cached settings have expired.");
                        return null;
                    }
                    try {
                        Logger.getLogger().m16727v("Returning cached settings.");
                        return settingsJson;
                    } catch (Exception e) {
                        e = e;
                        settings = settingsJson;
                        Logger.getLogger().m16724e("Failed to get cached settings", e);
                        return settings;
                    }
                }
                Logger.getLogger().m16721d("No cached settings data found.");
            }
            return null;
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) {
        Logger.getLogger().m16721d(str + jSONObject.toString());
    }
    ...
    public Task<Settings> getSettingsAsync() {
        return this.settingsTask.get().m183657a();
    }
    ...
    public Task<Void> loadSettingsData(SettingsCacheBehavior settingsCacheBehavior, CrashlyticsWorkers crashlyticsWorkers) throws Throwable {
        ...
        if (!buildInstanceIdentifierChanged() && (cachedSettingsData = getCachedSettingsData(settingsCacheBehavior)) != null) {
            ...
            this.settingsTask.get().m183661e(cachedSettingsData);
            return tfi0.m188734f(null);
        }
        ...
        if (cachedSettingsData2 != null) {
            ...
            this.settingsTask.get().m183661e(cachedSettingsData2);
        }
        return this.dataCollectionArbiter.waitForDataCollectionPermission().mo15378q(crashlyticsWorkers.common, new C31881(crashlyticsWorkers));
    }
