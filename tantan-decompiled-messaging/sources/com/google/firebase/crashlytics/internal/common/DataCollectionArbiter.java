...
public class DataCollectionArbiter {
    ...
    sei0<Void> dataCollectionEnabledTask;
    private final sei0<Void> dataCollectionExplicitlyApproved;
    ...
    public DataCollectionArbiter(FirebaseApp firebaseApp) {
        ...
        this.taskLock = obj;
        this.dataCollectionEnabledTask = new sei0<>();
        this.taskResolved = false;
        this.setInManifest = false;
        this.dataCollectionExplicitlyApproved = new sei0<>();
        ...
        synchronized (obj) {
            try {
                if (isAutomaticDataCollectionEnabled()) {
                    this.dataCollectionEnabledTask.m183661e(null);
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().m16721d(String.format("Crashlytics automatic data collection %s by %s.", str2, str));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().m16724e("Could not read data collection permission from manifest", e);
            return null;
        }
    }
    ...
    public void grantDataCollectionPermission(boolean z) {
        if (z) {
            this.dataCollectionExplicitlyApproved.m183661e(null);
        } else {
            qkq0.m175383a("An invalid data collection token was used.");
        }
    }
    ...
    public Task<Void> waitForAutomaticDataCollectionEnabled() {
        Task<Void> taskM183657a;
        synchronized (this.taskLock) {
            taskM183657a = this.dataCollectionEnabledTask.m183657a();
        }
        return taskM183657a;
    }

    public Task<Void> waitForDataCollectionPermission() {
        return CrashlyticsTasks.race(this.dataCollectionExplicitlyApproved.m183657a(), waitForAutomaticDataCollectionEnabled());
    }
}
