...
public class GmsRpc {
    ...
    public static /* synthetic */ String m16824a(GmsRpc gmsRpc, Task task) {
        gmsRpc.getClass();
        return gmsRpc.handleResponse((Bundle) task.mo15374m(IOException.class));
    }
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.mo15368g(new rfx(), new n16() { // from class: com.google.firebase.messaging.h
            @Override // p149l.n16
            public final Object then(Task task2) {
                return GmsRpc.m16824a(this.f11478a, task2);
            }
        });
    }
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        if (bundle == null) {
            rhg0.m179353a("SERVICE_NOT_AVAILABLE");
            return null;
        }
        ...
        if (CMD_RST.equals(string3)) {
            rhg0.m179353a(ERROR_INSTANCE_ID_RESET);
            return null;
        }
        if (string3 != null) {
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        bundle.putString("appid", (String) tfi0.m188729a(this.firebaseInstallations.getId()));
