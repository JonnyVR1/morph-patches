...
final class TopicOperation {
    ...
    private static String normalizeTopicOrThrow(String str, String str2) {
        ...
        dqi0.m113073a("Invalid topic name: %s does not match the allowed format %s.", new Object[]{str, TOPIC_NAME_PATTERN});
        return null;
    }

    public static TopicOperation subscribe(@NonNull String str) {
        return new TopicOperation(j6f.LATITUDE_SOUTH, str);
    }
