...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            if (TextUtils.isEmpty(str)) {
                qhg0.m174539a("Invalid to: ", str);
                throw null;
            }
            bundle.putString(Constants.MessagePayloadKeys.f11465TO, str);
        }
    ...
    public RemoteMessage(@SafeParcelable.Param(m12464id = 2) Bundle bundle) {
        this.bundle = bundle;
    }
    ...
    @Nullable
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f11465TO);
    }
