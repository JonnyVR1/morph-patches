...
final class WakeLockHolder {
    ...
    private static void checkAndInitWakeLock(Context context) {
        if (wakeLock == null) {
            rfp0 rfp0Var = new rfp0(context, 1, "wake:com.google.firebase.iid.WakeLockHolder");
            wakeLock = rfp0Var;
            rfp0Var.m179142d(true);
        }
    }
    ...
    public static void sendWakefulServiceIntent(Context context, WithinAppServiceConnection withinAppServiceConnection, final Intent intent) {
        synchronized (syncObject) {
            try {
                ...
                setAsWakefulIntent(intent, true);
                if (!zIsWakefulIntent) {
                    wakeLock.m179139a(WAKE_LOCK_ACQUIRE_TIMEOUT_MILLIS);
                }
