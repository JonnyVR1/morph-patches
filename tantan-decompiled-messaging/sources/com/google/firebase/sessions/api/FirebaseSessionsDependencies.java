...
public final class FirebaseSessionsDependencies {
    ...
    public static final void addDependency(@NotNull SessionSubscriber.Name subscriberName) {
        ...
        if (subscriberName == SessionSubscriber.Name.PERFORMANCE) {
            ig3.m135964a("Incompatible versions of Firebase Perf and Firebase Sessions.\nA safe combination would be:\n  firebase-sessions:1.1.0\n  firebase-crashlytics:18.5.0\n  firebase-perf:20.5.0\nFor more information contact Firebase Support.");
            return;
        }
        ...
        map.getClass();
        map.put(subscriberName, new Dependency(MutexKt.m94361a(true), null, 2, 0 == true ? 1 : 0));
        Objects.toString(subscriberName);
    }
    ...
    private final Dependency getDependency(SessionSubscriber.Name subscriberName) {
        ...
        xjw.m209754a("Cannot get dependency ", subscriberName, ". Dependencies should be added at class load time.");
        return null;
    }
    ...
    public static final void register(@NotNull SessionSubscriber subscriber) {
        ...
        Objects.toString(sessionSubscriberName);
        ot10.C19030a.m165924a(dependency.getMutex(), null, 1, null);
    }
    ...
    public final java.lang.Object getRegisteredSubscribers$com_google_firebase_firebase_sessions(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super java.util.Map<com.google.firebase.sessions.api.SessionSubscriber.Name, ? extends com.google.firebase.sessions.api.SessionSubscriber>> r10) throws java.lang.Throwable {
        ...
        L18:
            ...
            java.lang.Object r10 = p149l.uwp.m196133e()
            int r1 = r0.label
            r2 = 1
            r3 = 0
            if (r1 == 0) goto L46
        ...
        L67:
            ...
            r0.L$5 = r1
            r0.label = r2
            java.lang.Object r9 = r5.mo94354c(r3, r0)
            if (r9 != r10) goto L9d
            return r10
        L9d:
            r8 = r4
    ...
    public final SessionSubscriber getSubscriber$com_google_firebase_firebase_sessions(@NotNull SessionSubscriber.Name subscriberName) {
        ...
        xjw.m209754a("Subscriber ", subscriberName, " has not been registered.");
        return null;
    }
    ...
    @Metadata(m87231d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\t\b\u0082\b\u0018\u00002\u00020\u0001B\u001b\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\b\u001a\u00020\u0002HÆ\u0003¢\u0006\u0004\b\b\u0010\tJ\u0012\u0010\n\u001a\u0004\u0018\u00010\u0004HÆ\u0003¢\u0006\u0004\b\n\u0010\u000bJ&\u0010\f\u001a\u00020\u00002\b\b\u0002\u0010\u0003\u001a\u00020\u00022\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004HÆ\u0001¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u000f\u001a\u00020\u000eHÖ\u0001¢\u0006\u0004\b\u000f\u0010\u0010J\u0010\u0010\u0012\u001a\u00020\u0011HÖ\u0001¢\u0006\u0004\b\u0012\u0010\u0013J\u001a\u0010\u0016\u001a\u00020\u00152\b\u0010\u0014\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u0016\u0010\u0017R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0018\u001a\u0004\b\u0019\u0010\tR$\u0010\u0005\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0005\u0010\u001a\u001a\u0004\b\u001b\u0010\u000b\"\u0004\b\u001c\u0010\u001d¨\u0006\u001e"}, m87232d2 = {"Lcom/google/firebase/sessions/api/FirebaseSessionsDependencies$Dependency;", "", "Ll/ot10;", "mutex", "Lcom/google/firebase/sessions/api/SessionSubscriber;", "subscriber", "<init>", "(Ll/ot10;Lcom/google/firebase/sessions/api/SessionSubscriber;)V", "component1", "()Ll/ot10;", "component2", "()Lcom/google/firebase/sessions/api/SessionSubscriber;", Constants.COPY_TYPE, "(Ll/ot10;Lcom/google/firebase/sessions/api/SessionSubscriber;)Lcom/google/firebase/sessions/api/FirebaseSessionsDependencies$Dependency;", "", "toString", "()Ljava/lang/String;", "", "hashCode", "()I", "other", "", "equals", "(Ljava/lang/Object;)Z", "Ll/ot10;", "getMutex", "Lcom/google/firebase/sessions/api/SessionSubscriber;", "getSubscriber", "setSubscriber", "(Lcom/google/firebase/sessions/api/SessionSubscriber;)V", "com.google.firebase-firebase-sessions"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
    public static final /* data */ class Dependency {

        @NotNull
        private final ot10 mutex;

        @Nullable
        private SessionSubscriber subscriber;

        public Dependency(@NotNull ot10 ot10Var, @Nullable SessionSubscriber sessionSubscriber) {
            ot10Var.getClass();
            this.mutex = ot10Var;
            this.subscriber = sessionSubscriber;
        }

        public static /* synthetic */ Dependency copy$default(Dependency dependency, ot10 ot10Var, SessionSubscriber sessionSubscriber, int i, Object obj) {
            if ((i & 1) != 0) {
                ot10Var = dependency.mutex;
            }
            if ((i & 2) != 0) {
                sessionSubscriber = dependency.subscriber;
            }
            return dependency.copy(ot10Var, sessionSubscriber);
        }

        @NotNull
        /* JADX INFO: renamed from: component1, reason: from getter */
        public final ot10 getMutex() {
            return this.mutex;
        }
        ...
        @NotNull
        public final Dependency copy(@NotNull ot10 mutex, @Nullable SessionSubscriber subscriber) {
            mutex.getClass();
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return Intrinsics.m87488d(this.mutex, dependency.mutex) && Intrinsics.m87488d(this.subscriber, dependency.subscriber);
        }
        ...
        public /* synthetic */ Dependency(ot10 ot10Var, SessionSubscriber sessionSubscriber, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this(ot10Var, (i & 2) != 0 ? null : sessionSubscriber);
        }
    }
}
