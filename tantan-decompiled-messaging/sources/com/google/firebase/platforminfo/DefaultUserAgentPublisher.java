...
public class DefaultUserAgentPublisher implements UserAgentPublisher {
    ...
    public static /* synthetic */ UserAgentPublisher m16835a(ComponentContainer componentContainer) {
    ...
    public static Component<UserAgentPublisher> component() {
        return Component.builder(UserAgentPublisher.class).add(Dependency.setOf((Class<?>) LibraryVersion.class)).factory(new ComponentFactory() { // from class: l.yrd
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return DefaultUserAgentPublisher.m16835a(componentContainer);
            }
        }).build();
    }
