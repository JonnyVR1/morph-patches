...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public static /* synthetic */ class C32033 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$firebase$installations$remote$InstallationResponse$ResponseCode */
        static final /* synthetic */ int[] f11460xc38d2559;

        /* JADX INFO: renamed from: $SwitchMap$com$google$firebase$installations$remote$TokenResult$ResponseCode */
        static final /* synthetic */ int[] f11461xe5baa01a;

        static {
            int[] iArr = new int[TokenResult.ResponseCode.values().length];
            f11461xe5baa01a = iArr;
            try {
                iArr[TokenResult.ResponseCode.OK.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f11461xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11461xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            int[] iArr2 = new int[InstallationResponse.ResponseCode.values().length];
            f11460xc38d2559 = iArr2;
            try {
                iArr2[InstallationResponse.ResponseCode.OK.ordinal()] = 1;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f11460xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
    ...
    public FirebaseInstallations(final FirebaseApp firebaseApp, @NonNull Provider<HeartBeatController> provider, @NonNull ExecutorService executorService, @NonNull Executor executor) {
        this(executorService, executor, firebaseApp, new FirebaseInstallationServiceClient(firebaseApp.getApplicationContext(), provider), new PersistedInstallation(firebaseApp), Utils.getInstance(), new Lazy(new Provider() { // from class: l.yli
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return FirebaseInstallations.m16798e(firebaseApp);
            }
    ...
    private Task<InstallationTokenResult> addGetAuthTokenListener() {
        ...
        addStateListeners(new GetAuthTokenListener(this.utils, sei0Var));
        return sei0Var.m183657a();
    }

    private Task<String> addGetIdListener() {
        sei0 sei0Var = new sei0();
        addStateListeners(new GetIdListener(sei0Var));
        return sei0Var.m183657a();
    }
    ...
    public final void doRegistrationOrRefresh(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: l.zli
            @Override // java.lang.Runnable
            public final void run() {
                this.f203636a.doNetworkCallIfNecessary(z);
            }
        });
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ IidStore m16798e(FirebaseApp firebaseApp) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(@NonNull PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C32033.f11461xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C32033.f11460xc38d2559[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    public Task<Void> delete() {
        return tfi0.m188731c(this.backgroundExecutor, new Callable() { // from class: l.bmi
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f76285a.deleteFirebaseInstallationId();
            }
        });
    }
    ...
    public Task<String> getId() {
        ...
        if (cacheFid != null) {
            return tfi0.m188734f(cacheFid);
        }
        Task<String> taskAddGetIdListener = addGetIdListener();
        this.backgroundExecutor.execute(new Runnable() { // from class: l.ami
            @Override // java.lang.Runnable
            public final void run() {
                this.f70625a.doRegistrationOrRefresh(false);
            }
        });
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: l.cmi
            @Override // java.lang.Runnable
            public final void run() {
                this.f81570a.doRegistrationOrRefresh(z);
            }
        });
