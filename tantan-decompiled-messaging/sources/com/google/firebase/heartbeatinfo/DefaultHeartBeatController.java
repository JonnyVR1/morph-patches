...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public static /* synthetic */ String m16790a(DefaultHeartBeatController defaultHeartBeatController) {
        String string;
    ...
    public static /* synthetic */ HeartBeatInfoStorage m16791b(Context context, String str) {
        return new HeartBeatInfoStorage(context, str);
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ DefaultHeartBeatController m16792c(Qualified qualified, ComponentContainer componentContainer) {
    ...
    public Task<String> getHeartBeatsHeader() {
        return !h6k0.m129483a(this.applicationContext) ? tfi0.m188734f("") : tfi0.m188731c(this.backgroundExecutor, new Callable() { // from class: l.wnd
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return DefaultHeartBeatController.m16790a(this.f187291a);
            }
        });
    }
    ...
    public Task<Void> registerHeartBeat() {
        ...
        return !h6k0.m129483a(this.applicationContext) ? tfi0.m188734f(null) : tfi0.m188731c(this.backgroundExecutor, new Callable() { // from class: l.ynd
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return DefaultHeartBeatController.m16793d(this.f199154a);
            }
        });
    }
    ...
    private DefaultHeartBeatController(final Context context, final String str, Set<HeartBeatConsumer> set, Provider<UserAgentPublisher> provider, Executor executor) {
        this((Provider<HeartBeatInfoStorage>) new Provider() { // from class: l.vnd
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return DefaultHeartBeatController.m16791b(context, str);
            }
