...
public final class RemoteConfigKt$configUpdates$1$registration$1 implements ConfigUpdateListener {
    ...
    public static void m16863a(ad90 ad90Var, ConfigUpdate configUpdate) {
        ad90Var.getClass();
    ...
    public void onUpdate(@NotNull final ConfigUpdate configUpdate) {
        ...
        firebaseRemoteConfig.schedule(new Runnable() { // from class: l.zpc0
            @Override // java.lang.Runnable
            public final void run() {
                RemoteConfigKt$configUpdates$1$registration$1.m16863a(ad90Var, configUpdate);
            }
        });
    }
}
