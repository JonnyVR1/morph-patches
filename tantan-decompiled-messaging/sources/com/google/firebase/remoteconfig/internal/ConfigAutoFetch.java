...
public class ConfigAutoFetch {
    ...
    public static /* synthetic */ Task m16849a(ConfigAutoFetch configAutoFetch, Task task, Task task2, long j, int i, Task task3) throws JSONException {
        configAutoFetch.getClass();
        if (!task.mo15377p()) {
            return tfi0.m188733e(new FirebaseRemoteConfigClientException("Failed to auto-fetch config update.", task.mo15372k()));
        }
        if (!task2.mo15377p()) {
            return tfi0.m188733e(new FirebaseRemoteConfigClientException("Failed to get activated config for auto-fetch", task2.mo15372k()));
        }
        ConfigFetchHandler.FetchResponse fetchResponse = (ConfigFetchHandler.FetchResponse) task.mo15373l();
        ConfigContainer configContainerBuild = (ConfigContainer) task2.mo15373l();
    ...
    public synchronized Task<Void> fetchLatestConfig(int i, final long j) throws Throwable {
        ...
        try {
            try {
                ...
                return tfi0.m188739k(taskFetchNowWithTypeAndAttemptNumber, task).mo15370i(this.scheduledExecutorService, new n16() { // from class: l.su5
                    @Override // p149l.n16
                    public final Object then(Task task2) {
                        return ConfigAutoFetch.m16849a(this.f166436a, taskFetchNowWithTypeAndAttemptNumber, task, j, i2, task2);
                    }
                });
            } catch (Throwable th) {
                th = th;
