...
public class JsonWriter implements Closeable, Flushable {
    ...
    private void beforeValue() throws IOException {
        ...
        if (iPeek != 6) {
            if (iPeek != 7) {
                ...
                qkq0.m175383a("JSON must have only one top-level value.");
                return;
            }
        }
        replaceTop(7);
    ...
    private JsonWriter close(int i, int i2, char c) throws IOException {
        ...
        if (this.deferredName != null) {
            j850.m140190a("Dangling name: ", this.deferredName);
            return null;
        }
        this.stackSize--;
        if (iPeek == i2) {
    ...
    private int peek() {
        ...
        qkq0.m175383a("JsonWriter is closed.");
        return 0;
    }
    ...
    public JsonWriter value(Number number) throws IOException {
        ...
        if (!this.lenient && (string.equals("-Infinity") || string.equals("Infinity") || string.equals("NaN"))) {
            qhg0.m174539a("Numeric values must be finite, but was ", number);
            return null;
        }
        beforeValue();
    ...
    public JsonWriter value(double d) throws IOException {
        ...
        if (!this.lenient && (Double.isNaN(d) || Double.isInfinite(d))) {
            xpq.m210527a("Numeric values must be finite, but was ", d);
            return null;
        }
        beforeValue();
