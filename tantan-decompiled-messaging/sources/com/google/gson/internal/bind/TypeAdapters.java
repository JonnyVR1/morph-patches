...
public final class TypeAdapters {
    ...
    public static /* synthetic */ class C334934 {
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read2(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = C334934.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                    ...
                    if (i2 != 1) {
                        if (i2 == 2) {
                            ...
                            if (i2 != 3) {
                                udj0.m193143a("Invalid bitset value type: ", jsonTokenPeek);
                                return null;
                            }
                            ...
                            try {
                                ...
                                udj0.m193143a("Error: Expecting: bitset number value (1, 0), Found: ", strNextString);
                                return null;
                            }
                        }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public JsonElement read2(JsonReader jsonReader) throws IOException {
                ...
                switch (C334934.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
            ...
            public void write(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
                ...
                if (!jsonElement.isJsonObject()) {
                    kg3.m145878a("Couldn't write ", jsonElement.getClass());
                    return;
                }
                jsonWriter.beginObject();
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.32
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + Marker.ANY_NON_NULL_MARKER + cls2.getName() + ",adapter=" + typeAdapter + Constants.AES_SUFFIX;
            }
        };
    }
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.33
            ...
            public String toString() {
                return "Factory[typeHierarchy=" + cls.getName() + ",adapter=" + typeAdapter + Constants.AES_SUFFIX;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final TypeAdapter<TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.30
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + ",adapter=" + typeAdapter + Constants.AES_SUFFIX;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.31
            ...
            public String toString() {
                return "Factory[type=" + cls2.getName() + Marker.ANY_NON_NULL_MARKER + cls.getName() + ",adapter=" + typeAdapter + Constants.AES_SUFFIX;
            }
        };
    }
}
