                ...
                while (i < length) {
                    ...
                    if (zExcludeField || zExcludeField2) {
                        ...
                        while (r5 < size) {
                            ...
                            BoundField boundField2 = (BoundField) linkedHashMap.put(str, this.createBoundField(gson, field, str, TypeToken.get(typeResolve), z2, zExcludeField2));
                            if (boundField == null) {
                        ...
                        if (boundField != null) {
                            ...
                            sb.append(type);
                            ljc0.m149958a(sb, " declares multiple JSON fields named ", boundField.name);
                            return null;
                        }
                    }
                    i++;
