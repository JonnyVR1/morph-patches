...
public abstract class UnsafeAllocator {
    public static void assertInstantiable(Class<?> cls) {
        ...
        if (Modifier.isInterface(modifiers)) {
            qq3.m175877a("Interface can't be instantiated! Interface name: ".concat(cls.getName()));
        } else if (Modifier.isAbstract(modifiers)) {
            qq3.m175877a("Abstract class can't be instantiated! Class name: ".concat(cls.getName()));
        }
    }
