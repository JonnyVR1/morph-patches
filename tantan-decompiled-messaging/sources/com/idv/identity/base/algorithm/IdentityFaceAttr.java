...
public class IdentityFaceAttr {
    ...
    DecimalFormat f12054df = new DecimalFormat("#.######");
    ...
    public String toString() {
        return "IdentityFaceAttr{face_ratio=" + this.ratio + ", occlusion=" + this.f12054df.format(this.occlusion) + ", faceRegion=" + this.faceRegion.toString() + ", score=" + this.score + ", rightEyeOpen=" + this.rightEyeOpen + ", leftEyeOpen=" + this.leftEyeOpen + ", faceNum=" + this.faceNum + '}';
    }
