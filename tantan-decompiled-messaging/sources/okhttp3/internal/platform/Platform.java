...
public class Platform {
    ...
    private static final Logger logger = Logger.getLogger(k850.class.getName());
    ...
    public static boolean isConscryptPreferred() {
        if ("conscrypt".equals(tck0.m188017r("okhttp.platform", null))) {
            return true;
        }
    ...
    public wp4 buildCertificateChainCleaner(SSLSocketFactory sSLSocketFactory) {
    ...
    public zaj0 buildTrustRootIndex(X509TrustManager x509TrustManager) {
        return new ct2(x509TrustManager.getAcceptedIssuers());
    }
    ...
    public wp4 buildCertificateChainCleaner(X509TrustManager x509TrustManager) {
        return new rs2(buildTrustRootIndex(x509TrustManager));
    }
}
