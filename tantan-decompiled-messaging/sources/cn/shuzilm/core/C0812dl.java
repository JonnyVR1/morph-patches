...
public class C0812dl {
            ...
            try {
                NsdManager.DiscoveryListener discoveryListener = new NsdManager.DiscoveryListener() { // from class: cn.shuzilm.core.dl.NsdDiscoverySubJson.1
                    ...
                    public void onServiceFound(NsdServiceInfo nsdServiceInfo) {
                        try {
                            ...
                            if (NsdDiscoverySubJson.this.f3804b == 1) {
                                C0812dl.m4767b(serviceName, serviceType);
                            }
                            NsdDiscoverySubJson nsdDiscoverySubJson = NsdDiscoverySubJson.this;
                            if (nsdDiscoverySubJson.f3804b == 2) {
                                C0812dl.m4766b(nsdServiceInfo, serviceName, serviceType, nsdDiscoverySubJson.f3805c);
                            }
                    ...
                    public void onStartDiscoveryFailed(String str, int i) {
                        C0812dl.m4765b(C0812dl.f3774c, this);
                    }
                ...
                C0812dl.f3774c.discoverServices(this.f3803a, 1, discoveryListener);
                if (C0812dl.f3778g == null) {
                    Timer unused = C0812dl.f3778g = new Timer();
                }
                C0812dl.f3778g.schedule(new sd(C0812dl.f3774c, discoveryListener, this.f3804b, this.f3803a, this.f3805c), this.f3804b == 2 ? 600 : 800);
    ...
    class sd extends TimerTask {
        ...
        public void run() {
            ...
            try {
                C0812dl.m4765b(this.f3811b, this.f3810a);
                if (this.f3812c == 2 && (jSONObject = this.f3814e) != null) {
                    int length = jSONObject.toString().length();
                    if (C0812dl.f3776e.toString().length() + length < 4096 && length > 5) {
                        C0812dl.f3776e.put(this.f3813d, this.f3814e);
                    }
                }
                if (C0812dl.f3784m <= 20 && C0812dl.f3775d != null && C0812dl.f3775d.size() > 0 && (str = (String) C0812dl.f3775d.poll()) != null) {
    ...
    /* JADX INFO: renamed from: a */
    private static synchronized void m4758a(String str, int i) {
        new NsdDiscoverySubJson(str, 1).discoverySubType();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: b */
    public static void m4764b(Network network) {
            ...
            if (linkProperties != null && (linkAddresses = linkProperties.getLinkAddresses()) != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (hostAddress != null && hostAddress.contains(":") && !hostAddress.startsWith("fe80")) {
                        DUHelper.m4720c(f3773b, 204, hostAddress);
                        return;
                    }
                }
            }
    ...
    /* JADX INFO: renamed from: c */
    private static void m4771c(final int i) {
                            ...
                            networkCallback2 = new ConnectivityManager.NetworkCallback() { // from class: cn.shuzilm.core.dl.2
                                ...
                                public void onAvailable(Network network) {
                                    try {
                                        ...
                                        String strM4773d = null;
                                        if (network != null) {
                                            C0812dl.m4764b(network);
                                            strM4773d = C0812dl.m4773d(network, DUHelper.m4720c(C0812dl.f3773b, 101, (String) null), 0);
                                        }
                                        String unused = C0812dl.f3791t = strM4773d;
                                        String str = "0";
                                        if (strM4773d == null) {
                                            strM4773d = "0";
                                        }
                                        if (strM4773d.length() <= 64) {
                                            str = strM4773d;
                                        }
                                        if (i == 1) {
                                            DUHelper.m4720c(C0812dl.f3773b, 201, str);
                                        }
                                    } catch (Throwable unused2) {
                                    }
                ...
                if (i != 0) {
                    ...
                    if (f3787p == 0) {
                        new Thread(new Runnable() { // from class: cn.shuzilm.core.dl.4
                            ...
                            public void run() {
                                try {
                                    String strM4768c = C0812dl.m4768c(null, DUHelper.m4720c(C0812dl.f3773b, 101, (String) null), 0);
                                    String str = "0";
                                    if (strM4768c == null) {
                                        strM4768c = "0";
                                    }
                                    if (strM4768c.length() <= 64) {
                                        str = strM4768c;
                                    }
                                    if (i == 1) {
                                        DUHelper.m4720c(C0812dl.f3773b, 203, str);
                                    }
                    ...
                    if (f3787p == 0 && f3790s == 0) {
                        ...
                        networkCallback3 = new ConnectivityManager.NetworkCallback() { // from class: cn.shuzilm.core.dl.3
                            ...
                            public void onAvailable(Network network) {
                                String str;
                                super.onAvailable(network);
                                String strM4768c = null;
                                if (network != null) {
                                    try {
                                        strM4768c = C0812dl.m4768c(network, DUHelper.m4720c(C0812dl.f3773b, 101, (String) null), 0);
                                        String unused3 = C0812dl.f3792u = strM4768c;
                                        str = "0";
                                        if (strM4768c == null) {
                                            strM4768c = "0";
                                        }
                                        ...
                                        if (i == 1) {
                                            DUHelper.m4720c(C0812dl.f3773b, 202, str);
                                        }
                                    } catch (Throwable unused4) {
                                    }
                                } else {
                                    String unused5 = C0812dl.f3792u = strM4768c;
                                    str = "0";
                                    if (strM4768c == null) {
                                        strM4768c = "0";
                                    }
                        ...
                        networkCallback3 = new ConnectivityManager.NetworkCallback() { // from class: cn.shuzilm.core.dl.3
                            ...
                            public void onAvailable(Network network) {
                                ...
                                if (network != null) {
                                    ...
                                    String unused6 = C0812dl.f3792u = strM4768c;
                                    str = "0";
                                    if (strM4768c == null) {
                                        strM4768c = "0";
                                    }
    ...
    /* JADX INFO: renamed from: d */
    public static String m4773d(Network network, String str, int i) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (((HttpURLConnection) uRLConnectionOpenConnection).getResponseCode() == 200) {
                                ...
                                try {
                                    str2 = new String(C0829u.m4798a(inputStream));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: e */
    public static void m4778e(String str) {
        LinkedList linkedList;
        try {
            f3784m = 0;
            f3783l = m4779f("TV^geaVn#TiXe#");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: f */
    public static String m4779f(String str) {
        if (str == null) {
            return null;
        }
    ...
    public static synchronized void m4784ia(Context context) {
        try {
            f3773b = context;
            if (f3786o == 0) {
                f3788q = 0;
    ...
    /* JADX INFO: renamed from: n */
    private static void m4789n() {
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: o */
    public static void m4790o() {
        DUHelper.m4716bm(f3773b, f3776e.toString());
    }

    /* JADX INFO: renamed from: p */
    private static String m4791p() {
    ...
    public static void m4792q() {
        ...
        try {
            String strM4791p = m4791p();
            if ((strM4791p == null || strM4791p != "") && (iM4799b = C0829u.m4799b(f3773b)) != 0) {
                strM4791p = (iM4799b & 255) + "." + ((iM4799b >> 8) & 255) + "." + ((iM4799b >> 16) & 255) + ".";
            }
            if (strM4791p == null || strM4791p == "") {
                return;
            }
            if (strM4791p.lastIndexOf(".") == strM4791p.length() - 1) {
                for (int i = 1; i < iM4788m; i++) {
                    InetAddress.getByName(strM4791p + String.valueOf(i)).isReachable(60);
                }
            }
        } catch (Exception unused2) {
        }
    ...
    public static int m4793r() {
        ...
        try {
            ...
            if (iCheckPermission == 0 && iCheckPermission2 == 0 && iCheckPermission3 == 0) {
                ...
                WifiRttManager wifiRttManagerM142749a = jpq0.m142749a(f3773b.getSystemService("wifirtt"));
                if (!wifiRttManagerM142749a.isAvailable() || !f3773b.getPackageManager().hasSystemFeature("android.hardware.wifi.rtt")) {
                    return -3;
                }
                ...
                qpq0.m175862a();
                RangingRequest.Builder builderM170758a = ppq0.m170758a();
                ...
                for (int i2 = 0; i2 < maxPeers; i2++) {
                    builderM170758a.addAccessPoint(scanResults.get(i2));
                }
                wifiRttManagerM142749a.startRanging(builderM170758a.build(), f3773b.getMainExecutor(), new RangingResultCallback() { // from class: cn.shuzilm.core.dl.1
                    public void onRangingFailure(int i3) {
                        try {
                            long jCurrentTimeMillis = System.currentTimeMillis();
                            C0812dl.f3776e.put("wr", jCurrentTimeMillis + ";err_" + i3 + com.meituan.robust.Constants.PACKNAME_END);
                    ...
                    public void onRangingResults(List list) {
                        ...
                        try {
                            ...
                            for (int i3 = 0; i3 < list.size(); i3++) {
                                RangingResult rangingResultM180396a = rpq0.m180396a(list.get(i3));
                                if (rangingResultM180396a.getStatus() == 0) {
                                    try {
                                        Object objInvoke = rangingResultM180396a.getClass().getMethod(C0812dl.m4779f("\\ZiBVX6YYgZhh"), null).invoke(rangingResultM180396a, null);
                                        if (objInvoke != null) {
                                    ...
                                    sb.append(rangingResultM180396a.getDistanceMm() + Constants.SEPARATOR_COMMA + rangingResultM180396a.getRssi());
                            ...
                            C0812dl.f3776e.put("wr", sb.toString());
                        } catch (Throwable unused2) {
                        }
                    }
                });
    ...
    private static void m4795t() {
        ...
        try {
            if (telephonyManager.getSimState() == 5 && m4794s()) {
                f3789r = 0;
            } else {
                f3789r = 1;
            }
        ...
        int iM4799b = C0829u.m4799b(f3773b);
        if (iM4799b != 0) {
            f3790s = 0;
        } else {
            f3790s = 1;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: b */
    public static synchronized void m4767b(String str, String str2) {
        try {
            if (str2.contains(".")) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: b */
    public static synchronized void m4766b(NsdServiceInfo nsdServiceInfo, String str, String str2, JSONObject jSONObject) {
        if (str != null) {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: b */
    public static synchronized void m4765b(NsdManager nsdManager, NsdManager.DiscoveryListener discoveryListener) {
        try {
    ...
    /* JADX INFO: renamed from: d */
    public static /* synthetic */ int m4772d() {
        int i = f3784m;
        f3784m = i + 1;
        return i;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: d */
    public static synchronized void m4774d(int i) {
        if (C0829u.m4797a(f3773b, "android.permission.CHANGE_NETWORK_STATE")) {
            m4795t();
            m4771c(i);
        }
    }
    ...
    /* JADX INFO: renamed from: d */
    public static void m4775d(Context context, String str, final boolean z) {
        if (f3772a > 0) {
            return;
        }
        try {
                ...
                new Thread(new Runnable() { // from class: cn.shuzilm.core.dl.5
                    ...
                    public synchronized void run() {
                        try {
                            ...
                            int iM4793r = C0812dl.m4793r();
                            if (C0829u.m4796a(C0812dl.f3773b)) {
                                int unused = C0812dl.f3780i = 1;
                                C0812dl.m4778e(C0812dl.m4779f("h#TYch\"hY#TjYe"));
                                C0812dl.m4792q();
                            }
                            if ((System.currentTimeMillis() / 1000) - (C0812dl.f3773b.getPackageManager().getPackageInfo(C0812dl.f3773b.getPackageName(), 0).lastUpdateTime / 1000) < 70000) {
                                C0812dl.m4774d(1);
                            }
                            try {
                                Thread.sleep(2000L);
                            ...
                            if (C0812dl.f3776e.toString().length() > 0) {
                                C0812dl.f3776e.put("wrs", "" + iM4793r);
                            }
                            if (C0812dl.f3776e != null) {
                                C0812dl.f3776e.put(RXScreenCaptureService.KEY_INDEX, C0812dl.f3791t + Constants.SEPARATOR_COMMA + C0812dl.f3792u + com.meituan.robust.Constants.PACKNAME_END);
                            }
                            C0812dl.m4790o();
                        } catch (Throwable unused3) {
                        }
    ...
    /* JADX INFO: renamed from: c */
    public static synchronized String m4768c(Network network, String str, int i) {
        InputStream inputStream;
        String str2;
