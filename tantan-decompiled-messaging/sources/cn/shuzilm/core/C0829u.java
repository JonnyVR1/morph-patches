...
public class C0829u {
    ...
    public static boolean m4796a(Context context) {
        try {
    ...
    public static int m4799b(Context context) {
        try {
