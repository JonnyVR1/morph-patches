...
public class LZ4BlockInputStream extends FilterInputStream {
    ...
    private void refill() throws IOException {
        ...
        while (true) {
            ...
            if (i >= i2) {
                ...
                int i4 = (b & 15) + 10;
                if (i3 != 16 && i3 != 32) {
                    rhg0.m179353a("Stream is corrupted");
                    return;
                }
    ...
    public int available() throws IOException {
        return this.originalLen - this.f205834o;
    }
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (this.f205834o == this.originalLen) {
            refill();
        }
        if (this.finished) {
            return -1;
        }
        int iMin = Math.min(i2, this.originalLen - this.f205834o);
        System.arraycopy(this.buffer, this.f205834o, bArr, i, iMin);
        this.f205834o += iMin;
        return iMin;
    }
    ...
    public long skip(long j) throws IOException {
        ...
        int iMin = (int) Math.min(j, this.originalLen - this.f205834o);
        this.f205834o += iMin;
        return iMin;
    }
    ...
    public LZ4BlockInputStream(InputStream inputStream, LZ4FastDecompressor lZ4FastDecompressor) {
        zcq0.m218076b().m218083g(-1756908916);
        throw null;
    }
