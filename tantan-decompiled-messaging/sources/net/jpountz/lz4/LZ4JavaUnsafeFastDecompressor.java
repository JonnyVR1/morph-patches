...
final class LZ4JavaUnsafeFastDecompressor extends LZ4FastDecompressor {
    ...
    public int decompress(ByteBuffer byteBuffer, int i, ByteBuffer byteBuffer2, int i2, int i3) {
        ...
        if (i3 == 0) {
            ...
            e5r.m114891a("Malformed input at ", i);
            return 0;
        }
        int i6 = i3 + i2;
        int i7 = i;
        ...
        while (true) {
            ...
            if (i11 > i12) {
                ...
                e5r.m114891a("Malformed input at ", i9);
                return 0;
            }
            ...
            int i14 = i11 - shortLE;
            if (i14 < i2) {
                e5r.m114891a("Malformed input at ", i7);
                return 0;
            }
            int i15 = b3 & 15;
            if (i15 == 15) {
    ...
    public int decompress(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        int i8 = i2;
        while (true) {
            byte b3 = UnsafeUtils.readByte(bArr, i7);
            int i9 = i7 + 1;
            int i10 = (b3 & 255) >>> 4;
            if (i10 == 15) {
                while (true) {
                    i5 = i9 + 1;
                    b2 = UnsafeUtils.readByte(bArr, i9);
                    if (b2 != -1) {
                        break;
                    }
                    i10 += 255;
            ...
            int i13 = i9 + i10;
            int shortLE = UnsafeUtils.readShortLE(bArr, i13);
            i7 = i13 + 2;
            int i14 = i11 - shortLE;
            if (i14 < i2) {
                e5r.m114891a("Malformed input at ", i7);
            ...
            if (i15 == 15) {
                while (true) {
                    i4 = i7 + 1;
                    b = UnsafeUtils.readByte(bArr, i7);
                    if (b != -1) {
                        break;
                    }
                    i15 += 255;
