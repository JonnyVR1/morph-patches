...
public class Reflect {
    ...
    public static x9j<Object, Object[], Reflect> callRepeatably(String str, String str2, Object... objArr) throws ReflectException {
        ...
        Reflect reflectM221137on = m221137on(str);
        try {
            try {
                final Method methodExactMethod = reflectM221137on.exactMethod(str2, clsArrTypes);
                accessible(methodExactMethod);
                return new x9j() { // from class: l.gmc0
                    @Override // p149l.x9j
                    public final Object call(Object obj, Object obj2) {
                        return Reflect.m221140on(false, methodExactMethod, obj, (Object[]) obj2);
                    }
                };
            ...
            final Method methodSimilarMethod = reflectM221137on.similarMethod(str2, clsArrTypes);
            accessible(methodSimilarMethod);
            return new x9j() { // from class: l.hmc0
                @Override // p149l.x9j
                public final Object call(Object obj, Object obj2) {
                    return Reflect.m221140on(false, methodSimilarMethod, obj, (Object[]) obj2);
                }
            };
        }
    }
    ...
    public static Reflect m221140on(boolean z, Method method, Object obj, Object... objArr) throws ReflectException {
        if (z) {
            try {
                accessible(method);
            } catch (Exception e) {
        ...
        if (method.getReturnType() != Void.TYPE) {
            return m221136on(method.invoke(obj, objArr));
        }
        method.invoke(obj, objArr);
        return m221136on(obj);
    }
    ...
    public <P> P m221141as(Class<P> cls) {
        ...
        return (P) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: org.joor.Reflect.1
            ...
            public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
                ...
                try {
                    return Reflect.m221136on(Reflect.this.object).call(name, objArr).get();
    ...
    public Reflect call(String str, Object... objArr) throws ReflectException {
        ...
        try {
            try {
                return m221139on(exactMethod(str, clsArrTypes), this.object, objArr);
            } catch (NoSuchMethodException e) {
                throw new ReflectException(e);
            }
        } catch (NoSuchMethodException unused) {
            return m221139on(similarMethod(str, clsArrTypes), this.object, objArr);
        }
    }
    ...
    public Reflect create(Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        try {
            return m221138on(type().getDeclaredConstructor(clsArrTypes), objArr);
        } catch (NoSuchMethodException e) {
            for (Constructor<?> constructor : type().getDeclaredConstructors()) {
                if (match(constructor.getParameterTypes(), clsArrTypes)) {
                    return m221138on(constructor, objArr);
                }
            }
            throw new ReflectException(e);
        }
    ...
    public Reflect field(String str) throws ReflectException {
        try {
            return m221136on(field0(str).get(this.object));
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    }
    ...
    /* JADX INFO: renamed from: on */
    public static Reflect m221135on(Class<?> cls) {
        return new Reflect(cls);
    }

    /* JADX INFO: renamed from: on */
    public static Reflect m221136on(Object obj) {
        return new Reflect(obj);
    }

    /* JADX INFO: renamed from: on */
    private static Reflect m221138on(Constructor<?> constructor, Object... objArr) throws ReflectException {
        try {
            return m221136on(((Constructor) accessible(constructor)).newInstance(objArr));
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    }
    ...
    public static x9j<Object, Object[], Reflect> callRepeatably(Class cls, String str, Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        Reflect reflectM221135on = m221135on((Class<?>) cls);
        try {
            try {
                final Method methodExactMethod = reflectM221135on.exactMethod(str, clsArrTypes);
                accessible(methodExactMethod);
            ...
            final Method methodSimilarMethod = reflectM221135on.similarMethod(str, clsArrTypes);
            accessible(methodSimilarMethod);
    ...
    /* JADX INFO: renamed from: on */
    private static Reflect m221139on(Method method, Object obj, Object... objArr) throws ReflectException {
        return m221140on(true, method, obj, objArr);
    }

    /* JADX INFO: renamed from: on */
    public static Reflect m221137on(String str) throws ReflectException {
        return m221135on(forName(str));
    }

    public static x9j<Object, Object[], Reflect> callRepeatably(Object obj, String str, Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        Reflect reflectM221136on = m221136on(obj);
        try {
            try {
                final Method methodExactMethod = reflectM221136on.exactMethod(str, clsArrTypes);
                accessible(methodExactMethod);
                return new x9j() { // from class: l.emc0
                    @Override // p149l.x9j
                    public final Object call(Object obj2, Object obj3) {
                        return Reflect.m221140on(false, methodExactMethod, obj2, (Object[]) obj3);
                    }
                };
            } catch (NoSuchMethodException e) {
                throw new ReflectException(e);
            ...
            final Method methodSimilarMethod = reflectM221136on.similarMethod(str, clsArrTypes);
            accessible(methodSimilarMethod);
            return new x9j() { // from class: l.fmc0
                @Override // p149l.x9j
                public final Object call(Object obj2, Object obj3) {
                    return Reflect.m221140on(false, methodSimilarMethod, obj2, (Object[]) obj3);
                }
            };
        }
    }
