...
public class Option {
    ...
    public static Option[] fromString(String str) {
        ...
        try {
            for (String str2 : str.split(Constants.PACKNAME_END)) {
                ...
                if (strTrim.contains(":")) {
                    ...
                    if (strArrSplit.length == 2) {
                        ...
                        String[] strArrSplit2 = strArrSplit[1].split(com.clevertap.android.sdk.Constants.SEPARATOR_COMMA);
            ...
            throw new IllegalArgumentException("Can't parse options string: ".concat(str), e);
        }
    }
