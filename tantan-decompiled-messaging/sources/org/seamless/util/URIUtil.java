...
public class URIUtil {
    ...
    public static void assertRelativeURI(String str, URI uri) {
        if (uri.isAbsolute()) {
            ock0.m163533a(str, " URI must be relative, without scheme and authority");
        }
    }

    public static URI createAbsoluteURI(URI uri, URI uri2) throws IllegalArgumentException {
        if (uri == null && !uri2.isAbsolute()) {
            ig3.m135964a("Base URI is null and given URI is not absolute");
            return null;
        }
        if (uri == null && uri2.isAbsolute()) {
            return uri2;
    ...
    public static URL createAbsoluteURL(URL url, URI uri) throws IllegalArgumentException {
        if (url == null && !uri.isAbsolute()) {
            ig3.m135964a("Base URL is null and given URI is not absolute");
            return null;
        }
        if (url == null && uri.isAbsolute()) {
            try {
                ...
                ig3.m135964a("Base URL was null and given URI can't be converted to URL");
                return null;
            }
        }
        try {
