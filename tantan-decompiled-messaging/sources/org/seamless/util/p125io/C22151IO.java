...
public class C22151IO {
    ...
    public static void writeBytes(File file, byte[] bArr) throws IOException {
        if (file == null) {
            ig3.m135964a("File should not be null.");
            return;
        }
        if (!file.exists()) {
        ...
        if (!file.isFile()) {
            qhg0.m174539a("Should not be a directory: ", file);
            return;
        }
        if (!file.canWrite()) {
            qhg0.m174539a("File cannot be written: ", file);
            return;
        }
    ...
    public static String readLines(InputStream inputStream) throws IOException {
        ...
        ig3.m135964a("Inputstream was null");
        return null;
    }
}
