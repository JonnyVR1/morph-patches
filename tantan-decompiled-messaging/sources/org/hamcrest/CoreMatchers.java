...
import org.hamcrest.core.C22081Is;
...
public class CoreMatchers {
    ...
    public static <T> Matcher<T> m221121is(T t) {
        return C22081Is.m221126is(t);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C22081Is.isA(cls);
    }
    ...
    /* JADX INFO: renamed from: is */
    public static <T> Matcher<T> m221122is(Matcher<T> matcher) {
        return C22081Is.m221127is((Matcher) matcher);
    }
    ...
    /* JADX INFO: renamed from: is */
    public static <T> Matcher<T> m221120is(Class<T> cls) {
        return C22081Is.m221125is((Class) cls);
    }
