...
public class MaxCore {
    ...
    private Runner buildRunner(Description description) {
        ...
        if (description.toString().startsWith(MALFORMED_JUNIT_3_TEST_CLASS_PREFIX)) {
            return new JUnit38ClassRunner(new uhi0(getMalformedTestClass(description)));
        }
        ...
        yjw.m215098a("Can't build a runner from description [", description, Constants.AES_SUFFIX);
        return null;
    }
