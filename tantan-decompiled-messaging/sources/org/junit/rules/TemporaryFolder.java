...
public class TemporaryFolder extends ExternalResource {
    ...
    private void validateFolderName(String str) throws IOException {
        ...
        rhg0.m179353a("Folder name cannot consist of multiple path components separated by a file separator. Please use newFolder('MyParentFolder','MyFolder') to create hierarchies of folders");
    }
    ...
    public File getRoot() {
        ...
        qkq0.m175383a("the temporary folder has not yet been created");
        return null;
    }
    ...
    public File newFile(String str) throws IOException {
        ...
        uhg0.m193714a("a file with the name '", str, "' already exists in the test folder");
        return null;
    }
    ...
    public File newFolder(String... strArr) throws IOException {
        ...
        while (i < strArr.length) {
            ...
            if (!file.mkdir() && isLastElementInArray(i, strArr)) {
                uhg0.m193714a("a folder with the name '", str, "' already exists");
                return null;
            }
            i++;
            root = file;
