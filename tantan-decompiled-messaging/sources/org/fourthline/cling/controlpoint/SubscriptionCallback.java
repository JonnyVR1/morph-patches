...
public abstract class SubscriptionCallback implements Runnable {
    ...
    private void establishLocalSubscription(LocalService localService) {
        ...
        try {
            localGENASubscription = new LocalGENASubscription(localService, Integer.valueOf(Api.BaseClientBuilder.API_PRIORITY_OTHER), Collections.EMPTY_LIST) { // from class: org.fourthline.cling.controlpoint.SubscriptionCallback.1
