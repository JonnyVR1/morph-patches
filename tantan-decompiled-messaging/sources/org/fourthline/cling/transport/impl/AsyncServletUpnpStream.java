...
public abstract class AsyncServletUpnpStream extends UpnpStream implements k21 {
    ...
    public HttpServletResponse getResponse() {
        gke0 response = this.asyncContext.getResponse();
        if (response != null) {
            return (HttpServletResponse) response;
        }
        qkq0.m175383a("Couldn't get response from asynchronous context, already timed out");
        return null;
    }
    ...
    public StreamRequestMessage readRequestMessage() throws IOException {
        ...
        try {
            ...
            if (((UpnpRequest) streamRequestMessage.getOperation()).getMethod().equals(UpnpRequest.Method.UNKNOWN)) {
                ibe.m135253a("Method not supported: ", method);
                return null;
            }
            ...
            try {
                ...
                byte[] bytes = C22151IO.readBytes(inputStream);
                if (inputStream != null) {
                    inputStream.close();
                }
                Logger logger2 = log;
            ...
            ptc0.m171306a("Invalid request URI: ", requestURI, e);
            return null;
        }
    }
    ...
    public void writeResponseMessage(StreamResponseMessage streamResponseMessage) throws IOException {
        ...
        if (length > 0) {
            ...
            C22151IO.writeBytes(getResponse().getOutputStream(), bodyBytes);
        }
    }
