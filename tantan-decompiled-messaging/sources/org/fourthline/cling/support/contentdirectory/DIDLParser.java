...
import org.seamless.util.p125io.C22151IO;
...
public class DIDLParser extends SAXParser {
    ...
    public abstract class DIDLObjectHandler<I extends DIDLObject> extends SAXParser.Handler<I> {
        ...
        public void endElement(String str, String str2, String str3) throws SAXException {
            super.endElement(str, str2, str3);
            if (DIDLObject.Property.C22038DC.NAMESPACE.URI.equals(str)) {
                ...
                if ("description".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C22038DC.DESCRIPTION(getCharacters()));
                    return;
                }
                if ("publisher".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C22038DC.PUBLISHER(new Person(getCharacters())));
                    return;
                }
                if ("contributor".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C22038DC.CONTRIBUTOR(new Person(getCharacters())));
                    return;
                }
                if ("date".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C22038DC.DATE(getCharacters()));
                    return;
                }
                if (IjkMediaMeta.IJKM_KEY_LANGUAGE.equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C22038DC.LANGUAGE(getCharacters()));
                    return;
                } else if ("rights".equals(str2)) {
                    getInstance().addProperty(new DIDLObject.Property.C22038DC.RIGHTS(getCharacters()));
                    return;
                } else {
                    if ("relation".equals(str2)) {
                        getInstance().addProperty(new DIDLObject.Property.C22038DC.RELATION(URI.create(getCharacters())));
                        return;
                    }
                    return;
                }
    ...
    public void generateContainer(Container container, Document document, Element element, boolean z) {
        ...
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:title", title, DIDLObject.Property.C22038DC.NAMESPACE.URI);
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:creator", container.getCreator(), DIDLObject.Property.C22038DC.NAMESPACE.URI);
        ...
        appendProperties(document, elementAppendNewElement, container, "dc", DIDLObject.Property.C22038DC.NAMESPACE.class, DIDLObject.Property.C22038DC.NAMESPACE.URI);
        if (z) {
    ...
    public void generateDescMetadata(DescMeta descMeta, Document document, Element element) {
        if (descMeta.getId() == null) {
            ibe.m135253a("Missing id of description metadata: ", descMeta);
            return;
        }
        if (descMeta.getNameSpace() == null) {
            ibe.m135253a("Missing namespace of description metadata: ", descMeta);
            return;
        }
    ...
    public void generateItem(org.fourthline.cling.support.model.item.Item item, Document document, Element element) {
        if (item.getClazz() == null) {
            o5d0.m162778a("Missing 'upnp:class' element for item: ", item.getId());
            return;
        }
        Element elementAppendNewElement = XMLUtil.appendNewElement(document, element, Item.TYPE);
        if (item.getId() == null) {
            c0c.m104728a("Missing id on item: ", item);
            return;
        }
        elementAppendNewElement.setAttribute("id", item.getId());
        if (item.getParentID() == null) {
            c0c.m104728a("Missing parent id on item: ", item);
            return;
        }
        ...
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:title", title, DIDLObject.Property.C22038DC.NAMESPACE.URI);
        XMLUtil.appendNewElementIfNotNull(document, elementAppendNewElement, "dc:creator", item.getCreator(), DIDLObject.Property.C22038DC.NAMESPACE.URI);
        ...
        appendProperties(document, elementAppendNewElement, item, "dc", DIDLObject.Property.C22038DC.NAMESPACE.class, DIDLObject.Property.C22038DC.NAMESPACE.URI);
    ...
    public void generateResource(Res res, Document document, Element element) {
        if (res.getValue() == null) {
            ibe.m135253a("Missing resource URI value", res);
            return;
        }
        if (res.getProtocolInfo() == null) {
            ibe.m135253a("Missing resource protocol info: ", res);
            return;
        }
    ...
    public void generateRoot(DIDLContent dIDLContent, Document document, boolean z) {
        ...
        elementCreateElementNS.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:dc", DIDLObject.Property.C22038DC.NAMESPACE.URI);
    ...
    public DIDLContent parse(String str) throws Exception {
        if (str == null || str.length() == 0) {
            upk0.m194883a("Null or empty XML");
            return null;
        }
    ...
    public DIDLContent parseResource(String str) throws Exception {
        ...
        try {
            ...
            return parse(C22151IO.readLines(resourceAsStream));
        } finally {
