...
public class Res {
    ...
    public int getResolutionX() {
        if (getResolution() == null || getResolution().split(BaseSei.f13930X).length != 2) {
            return 0;
        }
        return Integer.valueOf(getResolution().split(BaseSei.f13930X)[0]).intValue();
    }
    ...
    public int getResolutionY() {
        ...
        return Integer.valueOf(getResolution().split(BaseSei.f13930X)[1]).intValue();
    }
    ...
    public void setResolution(int i, int i2) {
        this.resolution = i + BaseSei.f13930X + i2;
    }
