...
public class NormalPlayTime {
    ...
    public NormalPlayTime(long j, long j2, long j3, long j4) throws InvalidValueException {
        if (j < 0) {
            tn40.m189756a("Invalid parameter hours: ", j);
            throw null;
        }
        if (j2 < 0 || j2 > 59) {
            tn40.m189756a("Invalid parameter minutes: ", j);
            throw null;
        }
        if (j3 < 0 || j3 > 59) {
            tn40.m189756a("Invalid parameter seconds: ", j);
            throw null;
        }
        if (j4 < 0 || j4 > 999) {
            tn40.m189756a("Invalid parameter milliseconds: ", j4);
            throw null;
        }
    ...
    public static NormalPlayTime valueOf(String str) throws InvalidValueException {
        ...
        f0c.m119036a("Can't parse NormalPlayTime: ", str);
        return null;
    }
    ...
    public String getString(Format format) {
        ...
        long j2 = j / 1000;
        long j3 = j % 1000;
        if (C220421.f205952x61cef210[format.ordinal()] != 1) {
    ...
    public void setMilliseconds(long j) {
        if (j >= 0) {
            ...
            tn40.m189756a("Invalid parameter milliseconds: ", j);
        }
    }
