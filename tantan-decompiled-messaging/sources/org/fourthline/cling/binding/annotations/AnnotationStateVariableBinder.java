...
public class AnnotationStateVariableBinder {
    ...
    public Datatype createDatatype() throws LocalServiceBindingException {
        ...
        if (strDatatype.length() == 0) {
            mr0.m156009a("Could not detect datatype of state variable: ", getName());
            return null;
        }
    ...
    public String createDefaultValue(Datatype datatype) throws LocalServiceBindingException {
        if (getAnnotation().defaultValue().length() != 0) {
            try {
                ...
                nr0.m160707a("Default value doesn't match datatype of state variable '", getName(), "': ", e.getMessage());
            }
        }
        return null;
    }
    ...
    public StateVariable createStateVariable() throws LocalServiceBindingException {
        ...
        if (zEquals) {
            ...
            if (allowedValues != null && strCreateDefaultValue != null) {
                ...
                while (true) {
                    if (i2 >= length) {
                        nr0.m160707a("Default value '", strCreateDefaultValue, "' is not in allowed values of: ", getName());
                        return null;
                    }
            ...
            if (strCreateDefaultValue != null && allowedValueRange != null) {
                try {
                    if (!allowedValueRange.isInRange(Long.valueOf(strCreateDefaultValue).longValue())) {
                        nr0.m160707a("Default value '", strCreateDefaultValue, "' is not in allowed range of: ", annotationStateVariableBinder.getName());
                        return null;
                    }
                } catch (Exception unused) {
                    nr0.m160707a("Default value '", strCreateDefaultValue, "' is not numeric (for range checking) of: ", annotationStateVariableBinder.getName());
                    return null;
                }
            }
        } else {
        ...
        if (zSendEvents && annotationStateVariableBinder.getAccessor() == null) {
            mr0.m156009a("State variable sends events but has no accessor for field or getter: ", annotationStateVariableBinder.getName());
            return null;
        }
        if (zSendEvents) {
    ...
    public StateVariableAllowedValueRange getAllowedValueRange(long j, long j2, long j3) throws LocalServiceBindingException {
        ...
        mr0.m156009a("Allowed value range maximum is smaller than minimum: ", getName());
        return null;
    }

    public String[] getAllowedValues(Class cls) throws LocalServiceBindingException {
        if (!cls.isEnum()) {
            lr0.m151108a("Allowed values type is not an Enum: ", cls);
            return null;
        }
