...
public class Icon implements Validatable {
    ...
    public void setDevice(Device device) {
        if (this.device == null) {
            ...
            qkq0.m175383a("Final value has been set already, model is immutable");
        }
    }

    public String toString() {
        return "Icon(" + getWidth() + BaseSei.f13930X + getHeight() + ", MIME: " + getMimeType() + ") " + getUri();
    }
    ...
    public Icon(String str, int i, int i2, int i3, File file) throws IOException {
        this(str, i, i2, i3, file.getName(), C22151IO.readBytes(file));
    }

    public Icon(String str, int i, int i2, int i3, String str2, InputStream inputStream) throws IOException {
        this(str, i, i2, i3, str2, C22151IO.readBytes(inputStream));
    }
