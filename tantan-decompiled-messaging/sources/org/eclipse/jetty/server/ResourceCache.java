...
import org.eclipse.jetty.p123io.View;
import org.eclipse.jetty.p123io.nio.DirectNIOBuffer;
...
public class ResourceCache {
        ...
        public Buffer getDirectBuffer() {
            ...
            if (buffer == null) {
                ...
                if (directBuffer == null) {
                    ...
                    buffer = f31.m119248a(this._directBuffer, null, directBuffer) ? directBuffer : this._directBuffer.get();
                }
            }
            if (buffer == null) {
                return null;
        ...
        public Buffer getIndirectBuffer() {
            ...
            if (buffer == null) {
                ...
                if (indirectBuffer == null) {
                    ...
                    buffer = f31.m119248a(this._indirectBuffer, null, indirectBuffer) ? indirectBuffer : this._indirectBuffer.get();
                }
            }
            if (buffer == null) {
                return null;
    ...
    public Buffer getDirectBuffer(Resource resource) {
        try {
            ...
            LOG.warn("invalid resource: " + String.valueOf(resource) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + length, new Object[0]);
            return null;
        } catch (IOException e) {
            LOG.warn(e);
            return null;
    ...
    public String toString() {
        return "ResourceCache[" + this._parent + Constants.SEPARATOR_COMMA + this._factory + "]@" + hashCode();
    }
