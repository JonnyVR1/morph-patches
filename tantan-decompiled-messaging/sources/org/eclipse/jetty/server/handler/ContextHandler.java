...
public class ContextHandler extends ScopedHandler implements Attributes, Server.Graceful {
    ...
    public void doStart() throws Exception {
        ...
        if (this._contextPath == null) {
            qkq0.m175383a("Null contextPath");
            return;
        }
    ...
    public class Context implements vje0 {
        ...
        public yji.InterfaceC21419a addFilter(String str, Class<? extends jii> cls) {
        ...
        public ake0.InterfaceC15645a addServlet(String str, Class<? extends tje0> cls) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }
        ...
        public synchronized void removeAttribute(String str) {
            ...
            if (attribute != null && ContextHandler.this._contextAttributeListeners != null) {
                ...
                for (int i = 0; i < LazyList.size(ContextHandler.this._contextAttributeListeners); i++) {
                    ((wje0) LazyList.get(ContextHandler.this._contextAttributeListeners, i)).m203416i(servletContextAttributeEvent);
                }
            }
        }
            ...
            try {
                ...
                if (ContextHandler.this._contextAttributeListeners != null) {
                    ...
                    for (int i = 0; i < LazyList.size(ContextHandler.this._contextAttributeListeners); i++) {
                        ...
                        if (attribute == null) {
                            wje0Var.m203414b(servletContextAttributeEvent);
                        } else if (obj == null) {
                            wje0Var.m203416i(servletContextAttributeEvent);
                        } else {
                            wje0Var.m203415f(servletContextAttributeEvent);
                        }
                    }
                }
            } catch (Throwable th) {
        ...
        public yji.InterfaceC21419a addFilter(String str, jii jiiVar) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }

        public ake0.InterfaceC15645a addServlet(String str, tje0 tje0Var) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }
        ...
        public yji.InterfaceC21419a addFilter(String str, String str2) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }

        public ake0.InterfaceC15645a addServlet(String str, String str2) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }
