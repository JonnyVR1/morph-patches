...
public class Request implements HttpServletRequest {
    ...
    public h21 getAsyncContext() {
        ...
        qkq0.m175383a(this._async.getStatusString());
        return null;
    }
    ...
    public l860 getPart(String str) throws ServletException, IOException {
        ...
        if (this._multiPartInputStream == null) {
            ...
            if (dm10Var == null) {
                qkq0.m175383a("No multipart config for servlet");
                return null;
            }
            yje0 inputStream = getInputStream();
            String contentType = getContentType();
    ...
    public rkl getSession(boolean z) {
        ...
        if (sessionManager2 == null) {
            qkq0.m175383a("No SessionManager");
            return null;
        }
    ...
    public void recycle() {
        ...
        if (this._context != null) {
            qkq0.m175383a("Request in context!");
            return;
        }
        if (this._attributes != null) {
    ...
    public void removeAttribute(String str) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (cke0Var != null) {
                cke0Var.m107406e(servletRequestAttributeEvent);
            }
        }
    }
    ...
    public void setAttribute(String str, Object obj) {
        ...
        if (this._requestAttributeListeners != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (cke0Var != null) {
                    if (attribute == null) {
                        cke0Var.m107405d(servletRequestAttributeEvent);
                    } else if (obj == null) {
                        cke0Var.m107406e(servletRequestAttributeEvent);
                    } else {
                        cke0Var.m107407g(servletRequestAttributeEvent);
                    }
                }
            }
        }
