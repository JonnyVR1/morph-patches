...
public abstract class AbstractConnector extends AggregateLifeCycle implements HttpBuffers, Connector, Dumpable {
        ...
        public void run() {
            ...
            synchronized (AbstractConnector.this) {
                try {
                    ...
                    threadCurrentThread.setName(name + " Acceptor" + this._acceptor + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + AbstractConnector.this);
    ...
    public abstract void accept(int i) throws InterruptedException, IOException;
    ...
    public void doStart() throws Exception {
        ...
        synchronized (this) {
            try {
                ...
                while (true) {
                    int length = this._acceptorThreads.length;
                    ThreadPool threadPool2 = this._threadPool;
                    if (i < length) {
                        if (!threadPool2.dispatch(new Acceptor(i))) {
                            throw new IllegalStateException("!accepting");
                        }
                        i++;
                    } else if (threadPool2.isLowOnThreads()) {
