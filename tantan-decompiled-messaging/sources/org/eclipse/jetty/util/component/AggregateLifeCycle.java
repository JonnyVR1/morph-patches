...
public class AggregateLifeCycle extends AbstractLifeCycle implements Destroyable, Dumpable {
    ...
    public class Bean {
        ...
        public String toString() {
            return "{" + this._bean + Constants.SEPARATOR_COMMA + this._managed + "}";
        }
    }
    ...
    public static void dumpObject(Appendable appendable, Object obj) throws IOException {
        try {
            if (obj instanceof LifeCycle) {
                appendable.append(String.valueOf(obj)).append(" - ").append(AbstractLifeCycle.getState((LifeCycle) obj)).append(SignParameters.NEW_LINE);
            } else {
                appendable.append(String.valueOf(obj)).append(SignParameters.NEW_LINE);
            }
        } catch (Throwable th) {
    ...
    public void dumpThis(Appendable appendable) throws IOException {
        appendable.append(String.valueOf(this)).append(" - ").append(getState()).append(SignParameters.NEW_LINE);
    }
