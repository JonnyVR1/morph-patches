...
public class Scanner extends AbstractLifeCycle {
    ...
    public static /* synthetic */ class C219582 {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (!hashSet.contains(key)) {
                    ...
                    if (notificationPut3 != null && ((i2 = C219582.$SwitchMap$org$eclipse$jetty$util$Scanner$Notification[notificationPut3.ordinal()]) == 1 || i2 == 2)) {
                        this._notifications.put(key, Notification.CHANGED);
                    }
                } else if (!map2.get(key).equals(map.get(key)) && (notificationPut2 = this._notifications.put(key, Notification.CHANGED)) != null && C219582.$SwitchMap$org$eclipse$jetty$util$Scanner$Notification[notificationPut2.ordinal()] == 3) {
                    this._notifications.put(key, Notification.ADDED);
                }
            }
            for (String str : map2.keySet()) {
                if (!map.containsKey(str) && (notificationPut = this._notifications.put(str, Notification.REMOVED)) != null && C219582.$SwitchMap$org$eclipse$jetty$util$Scanner$Notification[notificationPut.ordinal()] == 3) {
            ...
            while (it2.hasNext()) {
                ...
                if (map2.containsKey(key2)) {
                    if (map2.get(key2).equals(map.get(key2))) {
                        ...
                        it2.remove();
                        arrayList.add(key2);
                        i = C219582.$SwitchMap$org$eclipse$jetty$util$Scanner$Notification[value.ordinal()];
                        if (i != 1) {
                            reportRemoval(key2);
                        } else if (i != 2) {
                            reportChange(key2);
                    ...
                    it2.remove();
                    arrayList.add(key2);
                    i = C219582.$SwitchMap$org$eclipse$jetty$util$Scanner$Notification[value2.ordinal()];
                    if (i != 1) {
                        reportRemoval(key2);
                    } else if (i != 2) {
                        reportChange(key2);
