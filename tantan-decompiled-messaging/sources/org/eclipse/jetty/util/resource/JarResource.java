...
public class JarResource extends URLResource {
    ...
    public void copyTo(File file) throws Throwable {
        ...
        if (exists()) {
            ...
            if (iIndexOf < 0) {
                rhg0.m179353a("Not a valid jar url: ".concat(strTrim));
                return;
            }
                ...
                if (!z) {
                    ...
                    if (!nextJarEntry.isDirectory()) {
                        ...
                        try {
                            ...
                            try {
                                C21953IO.copy(jarInputStream, fileOutputStream2);
                                C21953IO.close(fileOutputStream2);
        ...
        if (!this._urlString.endsWith("!/")) {
            return new FilterInputStream(super.getInputStream()) { // from class: org.eclipse.jetty.util.resource.JarResource.1
                ...
                public void close() throws IOException {
                    ((FilterInputStream) this).in = C21953IO.getClosedStream();
                }
            };
        }
