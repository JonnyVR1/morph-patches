...
public class MultiPartInputStream {
    ...
    public void parse() throws ServletException, IOException {
        ...
        if (this._config.m112429b() == null || "".equals(this._config.m112429b())) {
            this._tmpDir = this._contextTmpDir;
        } else {
            File file = new File(this._config.m112429b());
            if (file.isAbsolute()) {
                this._tmpDir = file;
            } else {
                this._tmpDir = new File(this._contextTmpDir, this._config.m112429b());
            }
        }
        ...
        if (str4 == null || !str4.equals(string)) {
            rhg0.m179353a("Missing initial multi part boundary");
            return;
        }
        boolean z3 = false;
        long length = 0;
        ...
        loop0: while (!z3) {
            ...
            while (true) {
                ...
                if (this._config.m112431d() > 0 && length > this._config.m112431d()) {
                    throw new IllegalStateException("Request exceeds maxRequestSize (" + this._config.m112431d() + ")");
                }
            ...
            if (str5 == null) {
                rhg0.m179353a("Missing content-disposition");
                return;
            }
                ...
                if ("base64".equalsIgnoreCase(str6)) {
                    ...
                    this._in = new FilterInputStream(this._in) { // from class: org.eclipse.jetty.util.MultiPartInputStream.1
                        ...
                        public int read() throws IOException {
                            ...
                            rhg0.m179353a("Unexpected end to quoted-printable byte");
                            return 0;
                        }
                    };
                }
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (i5 != -1) {
                            try {
                                j++;
                                if (this._config.m112431d() > 0 && j > this._config.m112431d()) {
                                    throw new IllegalStateException("Request exceeds maxRequestSize (" + this._config.m112431d() + ")");
                                }
                                int i6 = 13;
                                if (i5 != 13) {
        ...
        rhg0.m179353a("Incomplete parts");
    }
    ...
    public class MultiPart implements l860 {
        ...
        public void write(byte[] bArr, int i, int i2) throws IOException {
            if (MultiPartInputStream.this._config.m112430c() > 0 && this._size + ((long) i2) > MultiPartInputStream.this._config.m112430c()) {
                r2j.m177608a("Multipart Mime part ", this._name, " exceeds max filesize");
                return;
            }
            if (MultiPartInputStream.this._config.m112428a() > 0 && this._size + ((long) i2) > MultiPartInputStream.this._config.m112428a() && this._file == null) {
                createFile();
            }
        ...
        public void write(int i) throws IOException {
            if (MultiPartInputStream.this._config.m112430c() > 0 && this._size + 1 > MultiPartInputStream.this._config.m112430c()) {
                r2j.m177608a("Multipart Mime part ", this._name, " exceeds max filesize");
                return;
            }
            if (MultiPartInputStream.this._config.m112428a() > 0 && this._size + 1 > MultiPartInputStream.this._config.m112428a() && this._file == null) {
                createFile();
            }
            this._out.write(i);
            this._size++;
