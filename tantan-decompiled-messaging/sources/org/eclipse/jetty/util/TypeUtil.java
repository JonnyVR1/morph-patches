...
public class TypeUtil {
    ...
    public static int f205894CR = 13;

    /* JADX INFO: renamed from: LF */
    public static int f205895LF = 10;
    ...
    public static byte convertHexDigit(byte b) {
        ...
        kg3.m145878a("!hex:", Integer.toHexString(b & 255));
        return (byte) 0;
    }
    ...
    public static byte[] readLine(InputStream inputStream) throws IOException {
        ...
        if (i == f205894CR && inputStream.available() >= 1 && inputStream.markSupported()) {
            inputStream.mark(1);
            if (inputStream.read() != f205895LF) {
                inputStream.reset();
            }
        }
