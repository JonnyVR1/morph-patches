...
public class SslConnection extends AbstractConnection implements AsyncConnection {
    ...
    public static /* synthetic */ class C219131 {
                            ...
                            try {
                                try {
                                    ...
                                    try {
                                        ...
                                        int i2 = C219131.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[this._engine.getHandshakeStatus().ordinal()];
                                        if (i2 == 1) {
    ...
    private synchronized boolean unwrap(Buffer buffer) throws IOException {
        ...
        try {
            ...
            int i = C219131.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultUnwrap.getStatus().ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
    ...
    private synchronized boolean wrap(Buffer buffer) throws IOException {
        ...
        try {
            ...
            int i = C219131.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultWrap.getStatus().ordinal()];
            if (i == 1) {
                throw new IllegalStateException();
            }
            if (i != 2) {
    ...
    @Override // org.eclipse.jetty.p123io.AbstractConnection, org.eclipse.jetty.p123io.Connection
    ...
    public class SslEndPoint implements AsyncEndPoint {
        ...
        @Override // org.eclipse.jetty.p123io.AsyncEndPoint
        ...
        @Override // org.eclipse.jetty.p123io.ConnectedEndPoint
