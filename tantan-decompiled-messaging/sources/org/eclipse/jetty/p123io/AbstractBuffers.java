...
public abstract class AbstractBuffers implements Buffers {
    ...
    public static /* synthetic */ class C219041 {
    ...
    public final boolean isBuffer(Buffer buffer) {
        if (buffer.capacity() == this._bufferSize) {
            int i = C219041.$SwitchMap$org$eclipse$jetty$io$Buffers$Type[this._bufferType.ordinal()];
            if (i != 1) {
                if (i == 2) {
    ...
    public final boolean isHeader(Buffer buffer) {
        if (buffer.capacity() == this._headerSize) {
            int i = C219041.$SwitchMap$org$eclipse$jetty$io$Buffers$Type[this._headerType.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    return buffer instanceof DirectNIOBuffer;
                }
    ...
    public final Buffer newBuffer(int i) {
        int i2 = C219041.$SwitchMap$org$eclipse$jetty$io$Buffers$Type[this._otherType.ordinal()];
        if (i2 == 1) {
