...
public class ThreadLocalBuffers extends AbstractBuffers {
    ...
    @Override // org.eclipse.jetty.p123io.Buffers
    ...
    @Override // org.eclipse.jetty.p123io.AbstractBuffers
    public String toString() {
        return "{{" + getHeaderSize() + Constants.SEPARATOR_COMMA + getBufferSize() + "}}";
    }
