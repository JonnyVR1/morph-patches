...
public abstract class SecurityHandler extends HandlerWrapper implements Authenticator.AuthConfiguration {
    ...
    public static /* synthetic */ class C219194 {
    ...
    public boolean checkSecurity(Request request) {
        int i = C219194.$SwitchMap$javax$servlet$DispatcherType[request.getDispatcherType().ordinal()];
        if (i == 1 || i == 2) {
            return true;
        }
    ...
    public void doStart() throws Exception {
        ...
        if (this._loginService != null) {
            ...
            if (identityService == null) {
                ...
                rkq0.m179764a("LoginService has different IdentityService to ", this);
                return;
            }
        }
        ...
        if (authenticator2 != null) {
            ...
            qkq0.m175383a("No ServerAuthentication");
            return;
        }
        super.doStart();
    }
