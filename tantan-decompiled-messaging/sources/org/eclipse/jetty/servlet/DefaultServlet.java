...
import org.eclipse.jetty.p123io.WriterOutputStream;
...
public class DefaultServlet extends HttpServlet implements ResourceFactory {
    ...
    private boolean getInitBoolean(String str, boolean z) {
        ...
        return initParameter.startsWith(Constants.KEY_T) || initParameter.startsWith(j6f.GPS_DIRECTION_TRUE) || initParameter.startsWith(BaseSei.f13931Y) || initParameter.startsWith("Y") || initParameter.startsWith("1");
    }
            ...
            try {
                if (!z3) {
                    ...
                    if (boolValueOf.booleanValue() && this._gzip && headers == null && !zEndsWith) {
                        httpServletResponse.setHeader(HttpHeaders.VARY, "Accept-Encoding");
    ...
    @Override // javax.servlet.GenericServlet, p149l.uje0
    ...
    public void init() throws UnavailableException {
        ...
        if (!zIsAliases && !FileResource.getCheckAliases()) {
            qkq0.m175383a("Alias checking disabled");
            return;
        }
        if (zIsAliases) {
    ...
    public void sendData(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, boolean z, Resource resource, HttpContent httpContent, Enumeration enumeration) throws IOException {
        ...
        while (i3 < listSatisfiableRanges.size()) {
            ...
            if (inputStream != null) {
                ...
                C21953IO.copy(inputStream, multiPartOutputStream2, size2);
                j = first + size2;
