...
public class ServletHandler extends ScopedHandler {
    ...
    public class CachedChain implements qii {
        ...
        @Override // p149l.qii
        public void doFilter(bke0 bke0Var, gke0 gke0Var) throws ServletException, IOException {
    ...
    /* JADX WARN: Type inference failed for: r10v22, types: [l.bke0] */
    /* JADX WARN: Type inference failed for: r10v26 */
    /* JADX WARN: Type inference failed for: r13v0, types: [java.lang.Object, javax.servlet.http.HttpServletRequest, l.bke0] */
    /* JADX WARN: Type inference failed for: r2v1, types: [org.eclipse.jetty.servlet.ServletHolder] */
    /* JADX WARN: Type inference failed for: r4v0 */
    /* JADX WARN: Type inference failed for: r4v10 */
    /* JADX WARN: Type inference failed for: r4v11 */
    /* JADX WARN: Type inference failed for: r4v2, types: [java.lang.Object, l.qii] */
                    ...
                    try {
                        try {
                            if (r2 != 0) {
                                ...
                                gke0 response = httpServletResponse instanceof ServletResponseHttpWrapper ? ((ServletResponseHttpWrapper) httpServletResponse).getResponse() : httpServletResponse;
                                if (filterChain != 0) {
    ...
    public Set<String> setServletSecurity(ake0.InterfaceC15645a interfaceC15645a, ike0 ike0Var) {
        ServletContextHandler servletContextHandler = this._contextHandler;
        return servletContextHandler != null ? servletContextHandler.setServletSecurity(interfaceC15645a, ike0Var) : Collections.EMPTY_SET;
    }
