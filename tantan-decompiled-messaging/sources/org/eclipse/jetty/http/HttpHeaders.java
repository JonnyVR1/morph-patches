...
public class HttpHeaders extends BufferCache {
    ...
    public static final String f205889TE = "TE";
    ...
    static {
        ...
        ACCEPT_ENCODING_BUFFER = httpHeaders.add("Accept-Encoding", 21);
        ACCEPT_LANGUAGE_BUFFER = httpHeaders.add("Accept-Language", 22);
        CONTENT_LENGTH_BUFFER = httpHeaders.add("Content-Length", 12);
        CONNECTION_BUFFER = httpHeaders.add("Connection", 1);
        CACHE_CONTROL_BUFFER = httpHeaders.add("Cache-Control", 57);
        ...
        CONTENT_ENCODING_BUFFER = httpHeaders.add("Content-Encoding", 10);
        CONTENT_LANGUAGE_BUFFER = httpHeaders.add(CONTENT_LANGUAGE, 11);
        CONTENT_LOCATION_BUFFER = httpHeaders.add(CONTENT_LOCATION, 13);
        CONTENT_MD5_BUFFER = httpHeaders.add("Content-MD5", 14);
        CONTENT_RANGE_BUFFER = httpHeaders.add("Content-Range", 15);
        CONTENT_TYPE_BUFFER = httpHeaders.add("Content-Type", 16);
        EXPIRES_BUFFER = httpHeaders.add("Expires", 17);
        LAST_MODIFIED_BUFFER = httpHeaders.add("Last-Modified", 18);
        ...
        IF_MATCH_BUFFER = httpHeaders.add("If-Match", 28);
        IF_MODIFIED_SINCE_BUFFER = httpHeaders.add("If-Modified-Since", 29);
        IF_NONE_MATCH_BUFFER = httpHeaders.add("If-None-Match", 30);
        IF_RANGE_BUFFER = httpHeaders.add(IF_RANGE, 31);
        IF_UNMODIFIED_SINCE_BUFFER = httpHeaders.add("If-Unmodified-Since", 32);
        ...
        USER_AGENT_BUFFER = httpHeaders.add("User-Agent", 40);
        ...
        SET_COOKIE_BUFFER = httpHeaders.add("Set-Cookie", 53);
        SET_COOKIE2_BUFFER = httpHeaders.add("Set-Cookie2", 54);
