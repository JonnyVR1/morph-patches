...
public class CMPCertificate extends ASN1Object implements ASN1Choice {
    ...
    public CMPCertificate(Certificate certificate) {
        if (certificate.getVersionNumber() == 3) {
            ...
            ig3.m135964a("only version 3 certificates allowed");
            throw null;
        }
    }
    ...
    public static CMPCertificate getInstance(Object obj) {
        ...
        if (obj instanceof byte[]) {
            try {
                ...
                ig3.m135964a("Invalid encoding in CMPCertificate");
                return null;
            }
        }
        ...
        ig3.m135964a("Invalid object: ".concat(obj.getClass().getName()));
        return null;
    }
