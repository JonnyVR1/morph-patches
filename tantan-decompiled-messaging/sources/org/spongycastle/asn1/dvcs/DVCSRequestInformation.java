...
public class DVCSRequestInformation extends ASN1Object {
    ...
    public String toString() {
        ...
        stringBuffer.append("service: " + this.service + SignParameters.NEW_LINE);
        if (this.nonce != null) {
            stringBuffer.append("nonce: " + this.nonce + SignParameters.NEW_LINE);
        }
        if (this.requestTime != null) {
            stringBuffer.append("requestTime: " + this.requestTime + SignParameters.NEW_LINE);
        }
        if (this.requester != null) {
            stringBuffer.append("requester: " + this.requester + SignParameters.NEW_LINE);
        }
        if (this.requestPolicy != null) {
            stringBuffer.append("requestPolicy: " + this.requestPolicy + SignParameters.NEW_LINE);
        }
        if (this.dvcs != null) {
            stringBuffer.append("dvcs: " + this.dvcs + SignParameters.NEW_LINE);
        }
        if (this.dataLocations != null) {
            stringBuffer.append("dataLocations: " + this.dataLocations + SignParameters.NEW_LINE);
        }
