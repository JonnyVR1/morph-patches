...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        c2tnb191v2 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_SHARE_TYPE_INFO);
        c2tnb191v3 = aSN1ObjectIdentifierBranch7.branch("7");
        c2onb191v4 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        c2onb191v5 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        c2pnb208w1 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        c2tnb239v1 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        c2tnb239v2 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        c2tnb239v3 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        c2onb239v4 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        c2onb239v5 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        c2pnb272w1 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_START_WAP);
        c2pnb304w1 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        c2tnb359v1 = aSN1ObjectIdentifierBranch7.branch("18");
        c2pnb368w1 = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_ACT_TYPE_NINETEEN);
        ...
        prime239v3 = aSN1ObjectIdentifierBranch8.branch(Constants.VIA_SHARE_TYPE_INFO);
        ...
        mqvSinglePass_sha1kdf_scheme = aSN1ObjectIdentifier2.branch(Constants.VIA_REPORT_TYPE_START_WAP);
        ...
        dhHybridOneFlow = aSN1ObjectIdentifierBranch9.branch(Constants.VIA_SHARE_TYPE_INFO);
        mqv2 = aSN1ObjectIdentifierBranch9.branch("7");
        mqv1 = aSN1ObjectIdentifierBranch9.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
