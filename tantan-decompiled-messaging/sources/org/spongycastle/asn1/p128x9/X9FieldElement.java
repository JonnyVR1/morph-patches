...
public class X9FieldElement extends ASN1Object {
    ...
    protected ECFieldElement f206327f;
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f206327f.toBigInteger(), converter.getByteLength(this.f206327f)));
    }

    public X9FieldElement(BigInteger bigInteger, ASN1OctetString aSN1OctetString) {
        this(new ECFieldElement.C22281Fp(bigInteger, new BigInteger(1, aSN1OctetString.getOctets())));
    }

    public X9FieldElement(ECFieldElement eCFieldElement) {
        this.f206327f = eCFieldElement;
    }
}
