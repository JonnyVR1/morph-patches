...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        id_sha512_256 = aSN1ObjectIdentifierBranch.branch(Constants.VIA_SHARE_TYPE_INFO);
        id_sha3_224 = aSN1ObjectIdentifierBranch.branch("7");
        id_sha3_256 = aSN1ObjectIdentifierBranch.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        id_sha3_384 = aSN1ObjectIdentifierBranch.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        id_sha3_512 = aSN1ObjectIdentifierBranch.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        id_shake128 = aSN1ObjectIdentifierBranch.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        id_shake256 = aSN1ObjectIdentifierBranch.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        ...
        id_aes128_GCM = aSN1ObjectIdentifierBranch2.branch(Constants.VIA_SHARE_TYPE_INFO);
        id_aes128_CCM = aSN1ObjectIdentifierBranch2.branch("7");
        id_aes192_ECB = aSN1ObjectIdentifierBranch2.branch("21");
        id_aes192_CBC = aSN1ObjectIdentifierBranch2.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        id_aes192_OFB = aSN1ObjectIdentifierBranch2.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        id_aes192_CFB = aSN1ObjectIdentifierBranch2.branch(Constants.VIA_REPORT_TYPE_CHAT_AIO);
        id_aes192_wrap = aSN1ObjectIdentifierBranch2.branch(Constants.VIA_REPORT_TYPE_CHAT_AUDIO);
        id_aes192_GCM = aSN1ObjectIdentifierBranch2.branch(Constants.VIA_REPORT_TYPE_CHAT_VIDEO);
