...
public class PKIArchiveOptions extends ASN1Object implements ASN1Choice {
    ...
    private PKIArchiveOptions(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo == 1) {
            ...
            bub.m103905a("unknown tag number: ", aSN1TaggedObject.getTagNo());
            throw null;
        }
    }
    ...
    public static PKIArchiveOptions getInstance(Object obj) {
        ...
        qhg0.m174539a("unknown object: ", obj);
        return null;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        return aSN1Encodable instanceof ASN1OctetString ? new DERTaggedObject(false, 1, this.value) : new DERTaggedObject(false, 2, this.value);
    }
