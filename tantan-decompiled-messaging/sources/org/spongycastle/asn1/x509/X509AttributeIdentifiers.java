...
public interface X509AttributeIdentifiers {
    ...
    static {
        ...
        id_pe_aaControls = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_INFO);
        id_pe_ac_proxying = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        ...
        id_aca_encAttrs = aSN1ObjectIdentifierBranch.branch(Constants.VIA_SHARE_TYPE_INFO);
