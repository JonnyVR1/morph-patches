...
public class BasicConstraints extends ASN1Object {
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f206296cA;
    ...
    public BasicConstraints(boolean z) {
        ...
        this.pathLenConstraint = null;
        if (z) {
            this.f206296cA = ASN1Boolean.getInstance(true);
        } else {
            this.f206296cA = null;
        }
        this.pathLenConstraint = null;
