...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    public GeneralName(int i, String str) {
        ...
        if (i != 7) {
            k250.m144273a("can't process String for tag: ", i);
            throw null;
        }
        ...
        if (generalNameEncoding != null) {
            ...
            ig3.m135964a("IP Address is invalid");
            throw null;
        }
    }
    ...
    public static GeneralName getInstance(Object obj) {
        ...
        if (obj instanceof ASN1TaggedObject) {
            ...
            switch (tagNo) {
                ...
                case 2:
                    return new GeneralName(tagNo, DERIA5String.getInstance(aSN1TaggedObject, false));
                case 3:
                    k250.m144273a("unknown tag: ", tagNo);
                    return null;
                case 4:
        ...
        try {
            ...
            ig3.m135964a("unable to parse encoded general name");
            return null;
        }
    }
