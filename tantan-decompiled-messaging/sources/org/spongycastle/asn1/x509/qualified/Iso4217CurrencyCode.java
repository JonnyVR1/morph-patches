...
public class Iso4217CurrencyCode extends ASN1Object implements ASN1Choice {
    ...
    public Iso4217CurrencyCode(String str) {
        if (str.length() <= 3) {
            ...
            ig3.m135964a("wrong size in alphabetic code : max size is 3");
            throw null;
        }
    }
    ...
    public static Iso4217CurrencyCode getInstance(Object obj) {
        ...
        ig3.m135964a("unknown object in getInstance");
        return null;
    }
    ...
    public Iso4217CurrencyCode(int i) {
        if (i <= 999 && i >= 1) {
            ...
            ig3.m135964a("wrong size in numeric code : not in (1..999)");
            throw null;
        }
    }
}
