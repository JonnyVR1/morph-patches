...
public class X509Extensions extends ASN1Object {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1Sequence2.size() == 3) {
                ...
                if (aSN1Sequence2.size() != 2) {
                    bub.m103905a("Bad sequence size: ", aSN1Sequence2.size());
                    throw null;
                }
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (true) {
            boolean zHasMoreElements = enumerationElements.hasMoreElements();
            vector2 = this.ordering;
            if (!zHasMoreElements) {
                break;
            } else {
                vector2.addElement(ASN1ObjectIdentifier.getInstance(enumerationElements.nextElement()));
            }
        }
    ...
    public X509Extensions(Vector vector, Vector vector2) {
        ...
        while (true) {
            boolean zHasMoreElements = enumerationElements.hasMoreElements();
            vector3 = this.ordering;
            if (!zHasMoreElements) {
                break;
            } else {
                vector3.addElement(enumerationElements.nextElement());
            }
        }
        Enumeration enumerationElements2 = vector3.elements();
        int i = 0;
        while (enumerationElements2.hasMoreElements()) {
