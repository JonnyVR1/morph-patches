...
public class CVCertificate extends ASN1Object {
    ...
    public static CVCertificate getInstance(Object obj) {
        ...
        if (obj != null) {
            try {
                ...
                C20558v1.m196534a("unable to parse data: ", e.getMessage(), e);
            }
        }
        return null;
    }
    ...
    private void initFrom(ASN1InputStream aSN1InputStream) throws IOException {
        while (true) {
            ...
            if (!(object instanceof DERApplicationSpecific)) {
                rhg0.m179353a("Invalid Input Stream for creating an Iso7816CertificateStructure");
                return;
            }
    ...
    private void setPrivateData(ASN1ApplicationSpecific aSN1ApplicationSpecific) throws IOException {
        ...
        if (aSN1ApplicationSpecific.getApplicationTag() != 33) {
            hjl.m131386a("not a CARDHOLDER_CERTIFICATE :", aSN1ApplicationSpecific.getApplicationTag());
            return;
        }
        ...
        while (true) {
            ...
            if (object == null) {
                ...
                hjl.m131386a("invalid CARDHOLDER_CERTIFICATE :", aSN1ApplicationSpecific.getApplicationTag());
                return;
            } else {
                if (!(object instanceof DERApplicationSpecific)) {
                    rhg0.m179353a("Invalid Object, not an Iso7816CertificateStructure");
                    return;
                }
                ...
                if (applicationTag == 55) {
                    ...
                    hjl.m131386a("Invalid tag, not an Iso7816CertificateStructure :", dERApplicationSpecific.getApplicationTag());
                    return;
                } else {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        try {
            ...
            qkq0.m175383a("unable to convert signature!");
            return null;
        }
    }
