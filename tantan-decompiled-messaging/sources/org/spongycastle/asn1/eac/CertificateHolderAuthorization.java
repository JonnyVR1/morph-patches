...
public class CertificateHolderAuthorization extends ASN1Object {
    ...
    public static final int f206249IS = 0;
    ...
    public static int getFlag(String str) {
        ...
        qhg0.m174539a("Unknown value ", str);
        return 0;
    }
    ...
    private void setPrivateData(ASN1InputStream aSN1InputStream) throws IOException {
        ...
        if (!(object instanceof ASN1ObjectIdentifier)) {
            ig3.m135964a("no Oid in CerticateHolderAuthorization");
            return;
        }
        ...
        if (object2 instanceof DERApplicationSpecific) {
            ...
            ig3.m135964a("No access rights in CerticateHolderAuthorization");
        }
    }
