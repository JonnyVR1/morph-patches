...
public abstract class ASN1Set extends ASN1Primitive implements Iterable<ASN1Encodable> {
    ...
    private byte[] getDEREncoded(ASN1Encodable aSN1Encodable) {
        try {
            ...
            ig3.m135964a("cannot encode object added to SET");
            return null;
        }
    }
    ...
    public static ASN1Set getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z) {
        if (z) {
            ...
            ig3.m135964a("object implicit - explicit expected.");
            return null;
        }
        if (aSN1TaggedObject.isExplicit()) {
        ...
        ig3.m135964a("unknown object in getInstance: ".concat(aSN1TaggedObject.getClass().getName()));
        return null;
    }
        ...
        if (obj != null && !(obj instanceof ASN1Set)) {
            ...
            if (obj instanceof byte[]) {
                try {
                    ...
                    kg3.m145878a("failed to construct set from byte[]: ", e.getMessage());
                    return null;
                }
            }
