...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        netscapeCApolicyURL = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        netscapeSSLServerName = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        netscapeCertComment = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        ...
        cryptlib_algorithm_blowfish_ECB = aSN1ObjectIdentifierBranch.branch(BuildConfig.VERSION_NAME);
