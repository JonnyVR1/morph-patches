...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f206259iv;

    public IDEACBCPar(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.f206259iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        } else {
            this.f206259iv = null;
        }
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f206259iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f206259iv = new DEROctetString(bArr);
    }
}
