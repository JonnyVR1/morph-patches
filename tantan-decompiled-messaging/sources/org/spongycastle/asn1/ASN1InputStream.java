...
public class ASN1InputStream extends FilterInputStream implements BERTags {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        C20783w1.m200910a("unknown tag ", i, " encountered");
                        return null;
                }
        }
    }
    ...
    public static int readLength(InputStream inputStream, int i) throws IOException {
        ...
        int i3 = i2 & 127;
        if (i3 > 4) {
            juq0.m143339a("DER length more than 4 bytes: ", i3);
            return 0;
        }
        int i4 = 0;
        ...
        if (i4 < 0) {
            rhg0.m179353a("corrupted stream - negative length found");
            return 0;
        }
        if (i4 < i) {
            return i4;
        }
        rhg0.m179353a("corrupted stream - out of bounds length found");
        return 0;
    }
    ...
    public static int readTagNumber(InputStream inputStream, int i) throws IOException {
        ...
        int i4 = 0;
        if ((i3 & 127) == 0) {
            rhg0.m179353a("corrupted stream - invalid high tag number found");
            return 0;
        }
        while (i3 >= 0 && (i3 & 128) != 0) {
            i4 = ((i3 & 127) | i4) << 7;
    ...
    public ASN1Primitive buildObject(int i, int i2, int i3) throws IOException {
        ...
        C20783w1.m200910a("unknown tag ", i2, " encountered");
        return null;
    }
    ...
    public ASN1Primitive readObject() throws IOException {
        ...
        if (i <= 0) {
            ...
            rhg0.m179353a("unexpected end-of-contents marker");
            return null;
        }
        ...
        rhg0.m179353a("unknown BER object encountered");
        return null;
    }
