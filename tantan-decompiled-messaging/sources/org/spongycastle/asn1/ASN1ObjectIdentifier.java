...
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    public static ASN1ObjectIdentifier getInstance(Object obj) {
        ...
        try {
            ...
            kg3.m145878a("failed to construct object identifier from byte[]: ", e.getMessage());
            return null;
        }
    }
    ...
    public boolean m221142on(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        String id = getId();
    ...
    public ASN1ObjectIdentifier(String str) {
        if (str != null) {
            if (isValidIdentifier(str)) {
                ...
                qtc0.m176411a("string ", str, " not an OID");
                throw null;
            }
        }
        ig3.m135964a("'identifier' cannot be null");
        throw null;
    }
    ...
    public ASN1ObjectIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        qtc0.m176411a("string ", str, " not a valid OID branch");
        throw null;
    }
}
