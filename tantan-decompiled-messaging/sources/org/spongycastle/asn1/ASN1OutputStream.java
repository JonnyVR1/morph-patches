...
public class ASN1OutputStream {
    ...
    private OutputStream f206233os;
    ...
    public ASN1OutputStream(OutputStream outputStream) {
        this.f206233os = outputStream;
    }

    public void close() throws IOException {
        this.f206233os.close();
    }

    public void flush() throws IOException {
        this.f206233os.flush();
    }

    public ASN1OutputStream getDERSubStream() {
        return new DEROutputStream(this.f206233os);
    }

    public ASN1OutputStream getDLSubStream() {
        return new DLOutputStream(this.f206233os);
    }

    public void write(int i) throws IOException {
        this.f206233os.write(i);
    }
    ...
    public void writeImplicitObject(ASN1Primitive aSN1Primitive) throws IOException {
        if (aSN1Primitive != null) {
            aSN1Primitive.encode(new ImplicitOutputStream(this.f206233os));
        } else {
    ...
    public void writeNull() throws IOException {
        this.f206233os.write(5);
        this.f206233os.write(0);
    }
    ...
    public void write(byte[] bArr) throws IOException {
        this.f206233os.write(bArr);
    }

    public void write(byte[] bArr, int i, int i2) throws IOException {
        this.f206233os.write(bArr, i, i2);
    }
