...
public class BCStyle extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f206278C;

    /* JADX INFO: renamed from: CN */
    public static final ASN1ObjectIdentifier f206279CN;
    public static final ASN1ObjectIdentifier COUNTRY_OF_CITIZENSHIP;
    public static final ASN1ObjectIdentifier COUNTRY_OF_RESIDENCE;
    public static final ASN1ObjectIdentifier DATE_OF_BIRTH;

    /* JADX INFO: renamed from: DC */
    public static final ASN1ObjectIdentifier f206280DC;
    ...
    public static final ASN1ObjectIdentifier f206281E;
    ...
    public static final ASN1ObjectIdentifier f206282L;
    public static final ASN1ObjectIdentifier NAME;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH;

    /* JADX INFO: renamed from: O */
    public static final ASN1ObjectIdentifier f206283O;

    /* JADX INFO: renamed from: OU */
    public static final ASN1ObjectIdentifier f206284OU;
    ...
    public static final ASN1ObjectIdentifier f206285SN;

    /* JADX INFO: renamed from: ST */
    public static final ASN1ObjectIdentifier f206286ST;
    public static final ASN1ObjectIdentifier STREET;
    public static final ASN1ObjectIdentifier SURNAME;

    /* JADX INFO: renamed from: T */
    public static final ASN1ObjectIdentifier f206287T;
    ...
    static {
        ...
        hashtable.put(aSN1ObjectIdentifierIntern, b2s.C_ZONE);
        hashtable.put(aSN1ObjectIdentifierIntern2, BloodType.f38728O);
        hashtable.put(aSN1ObjectIdentifierIntern4, j6f.GPS_DIRECTION_TRUE);
        ...
        hashtable2.put(BLiveStormDanmakuGiftResourceType.f44444l, aSN1ObjectIdentifierIntern8);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        if (aSN1ObjectIdentifier.equals(EmailAddress) || aSN1ObjectIdentifier.equals(f206280DC)) {
            return new DERIA5String(str);
        }
        if (aSN1ObjectIdentifier.equals(DATE_OF_BIRTH)) {
            return new ASN1GeneralizedTime(str);
        }
        return (aSN1ObjectIdentifier.equals(f206278C) || aSN1ObjectIdentifier.equals(f206285SN) || aSN1ObjectIdentifier.equals(DN_QUALIFIER) || aSN1ObjectIdentifier.equals(TELEPHONE_NUMBER)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
