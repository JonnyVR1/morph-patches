...
public class RecipientIdentifier extends ASN1Object implements ASN1Choice {
    ...
    private ASN1Encodable f206236id;

    public RecipientIdentifier(ASN1OctetString aSN1OctetString) {
        this.f206236id = new DERTaggedObject(false, 0, aSN1OctetString);
    }
    ...
    public static RecipientIdentifier getInstance(Object obj) {
        ...
        ig3.m135964a("Illegal object in RecipientIdentifier: ".concat(obj.getClass().getName()));
        return null;
    }

    public ASN1Encodable getId() {
        ASN1Encodable aSN1Encodable = this.f206236id;
    ...
    public boolean isTagged() {
        return this.f206236id instanceof ASN1TaggedObject;
    }

    @Override // org.spongycastle.asn1.ASN1Object, org.spongycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f206236id.toASN1Primitive();
    }

    public RecipientIdentifier(IssuerAndSerialNumber issuerAndSerialNumber) {
        this.f206236id = issuerAndSerialNumber;
    }

    public RecipientIdentifier(ASN1Primitive aSN1Primitive) {
        this.f206236id = aSN1Primitive;
    }
}
