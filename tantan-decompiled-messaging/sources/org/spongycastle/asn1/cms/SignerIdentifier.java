...
public class SignerIdentifier extends ASN1Object implements ASN1Choice {
    ...
    private ASN1Encodable f206237id;

    public SignerIdentifier(ASN1OctetString aSN1OctetString) {
        this.f206237id = new DERTaggedObject(false, 0, aSN1OctetString);
    }
    ...
    public static SignerIdentifier getInstance(Object obj) {
        ...
        ig3.m135964a("Illegal object in SignerIdentifier: ".concat(obj.getClass().getName()));
        return null;
    }

    public ASN1Encodable getId() {
        ASN1Encodable aSN1Encodable = this.f206237id;
    ...
    public boolean isTagged() {
        return this.f206237id instanceof ASN1TaggedObject;
    }

    @Override // org.spongycastle.asn1.ASN1Object, org.spongycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f206237id.toASN1Primitive();
    }

    public SignerIdentifier(IssuerAndSerialNumber issuerAndSerialNumber) {
        this.f206237id = issuerAndSerialNumber;
    }

    public SignerIdentifier(ASN1Primitive aSN1Primitive) {
        this.f206237id = aSN1Primitive;
    }
}
