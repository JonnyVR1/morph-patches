...
public class OriginatorIdentifierOrKey extends ASN1Object implements ASN1Choice {
    ...
    private ASN1Encodable f206235id;
    ...
    public static OriginatorIdentifierOrKey getInstance(Object obj) {
        ...
        ig3.m135964a("Invalid OriginatorIdentifierOrKey: ".concat(obj.getClass().getName()));
        return null;
    }

    public ASN1Encodable getId() {
        return this.f206235id;
    }

    public IssuerAndSerialNumber getIssuerAndSerialNumber() {
        ASN1Encodable aSN1Encodable = this.f206235id;
    ...
    public OriginatorPublicKey getOriginatorKey() {
        ...
        if ((aSN1Encodable instanceof ASN1TaggedObject) && ((ASN1TaggedObject) aSN1Encodable).getTagNo() == 1) {
            return OriginatorPublicKey.getInstance((ASN1TaggedObject) this.f206235id, false);
        }
        return null;
    }
    ...
    public SubjectKeyIdentifier getSubjectKeyIdentifier() {
        ...
        if ((aSN1Encodable instanceof ASN1TaggedObject) && ((ASN1TaggedObject) aSN1Encodable).getTagNo() == 0) {
            return SubjectKeyIdentifier.getInstance((ASN1TaggedObject) this.f206235id, false);
        }
        return null;
    }
    ...
    public static OriginatorIdentifierOrKey getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z) {
        ...
        ig3.m135964a("Can't implicitly tag OriginatorIdentifierOrKey");
        return null;
    }
}
