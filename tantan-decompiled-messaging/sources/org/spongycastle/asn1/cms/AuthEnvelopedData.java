...
public class AuthEnvelopedData extends ASN1Object {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Integer.getValue().intValue() != 0) {
            ig3.m135964a("AuthEnvelopedData version number must be 0");
            throw null;
        }
        ...
        if (aSN1Set2.size() == 0) {
            ig3.m135964a("AuthEnvelopedData requires at least 1 RecipientInfo");
            throw null;
        }
        ...
        if (aSN1Primitive2 instanceof ASN1TaggedObject) {
            ...
            ig3.m135964a("authAttrs must be present with non-data content");
            throw null;
        }
    ...
    public static AuthEnvelopedData getInstance(Object obj) {
        ...
        ig3.m135964a("Invalid AuthEnvelopedData: ".concat(obj.getClass().getName()));
        return null;
    }
