...
public class GF2mField {
    ...
    public GF2mField(byte[] bArr) {
        this.degree = 0;
        if (bArr.length != 4) {
            ig3.m135964a("byte array is not an encoded finite field");
            throw null;
        }
    ...
    public GF2mField(int i, int i2) {
        ...
        if (i == PolynomialRingGF2.degree(i2)) {
            if (PolynomialRingGF2.isIrreducible(i2)) {
                ...
                ig3.m135964a(" Error: given polynomial is reducible");
                throw null;
            }
        }
        ig3.m135964a(" Error: the degree is not correct");
        throw null;
    }
    ...
    public GF2mField(int i) {
        this.degree = 0;
        if (i >= 32) {
            ig3.m135964a(" Error: the degree of field is too large ");
            throw null;
        }
        if (i >= 1) {
            this.degree = i;
            ...
            ig3.m135964a(" Error: the degree of field is non-positive ");
            throw null;
        }
    }
