...
public class GF2Polynomial {
    ...
    private static final int[] bitMask = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1048576, 2097152, 4194304, 8388608, 16777216, 33554432, AudioRoutingController.DEVICE_OUT_USB_HEADSET, 134217728, 268435456, 536870912, 1073741824, Integer.MIN_VALUE, 0};
    private static final int[] reverseRightMask = {0, 1, 3, 7, 15, 31, 63, 127, 255, UnixStat.DEFAULT_LINK_PERM, 1023, 2047, UnixStat.PERM_MASK, 8191, 16383, 32767, j6f.COLOR_SPACE_UNCALIBRATED, 131071, 262143, 524287, 1048575, 2097151, 4194303, 8388607, 16777215, 33554431, 67108863, 134217727, 268435455, 536870911, 1073741823, Api.BaseClientBuilder.API_PRIORITY_OTHER, -1};
    ...
    public GF2Polynomial gcd(GF2Polynomial gF2Polynomial) throws RuntimeException {
        if (isZero() && gF2Polynomial.isZero()) {
            lwm.m151979a("Both operands of gcd equal zero.");
            return null;
        }
        if (isZero()) {
    ...
    public GF2Polynomial(int i, String str) {
        ...
        if (str.equalsIgnoreCase("X")) {
            ...
            qtc0.m176411a("Error: GF2Polynomial was called using ", str, " as value!");
            throw null;
        }
    }
