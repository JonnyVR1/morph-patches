...
public class GF2Vector extends Vector {
    ...
    private int[] f206998v;

    public GF2Vector(int i, int i2, SecureRandom secureRandom) {
        if (i2 > i) {
            lwm.m151979a("The hamming weight is greater than the length of vector.");
            throw null;
        }
        this.length = i;
        this.f206998v = new int[(i + 31) >> 5];
        int[] iArr = new int[i];
    ...
    public Vector add(Vector vector) {
        if (!(vector instanceof GF2Vector)) {
            lwm.m151979a("vector is not defined over GF(2)");
            return null;
        }
        ...
        int[] iArrClone = IntUtils.clone(gF2Vector.f206998v);
        for (int length = iArrClone.length - 1; length >= 0; length--) {
            iArrClone[length] = iArrClone[length] ^ this.f206998v[length];
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f206998v, gF2Vector.f206998v);
    }

    public GF2Vector extractLeftVector(int i) {
        int i2 = this.length;
        if (i > i2) {
            lwm.m151979a("invalid length");
            return null;
        }
        if (i == i2) {
        ...
        int i3 = i >> 5;
        int i4 = i & 31;
        System.arraycopy(this.f206998v, 0, gF2Vector.f206998v, 0, i3);
        if (i4 != 0) {
            gF2Vector.f206998v[i3] = this.f206998v[i3] & ((1 << i4) - 1);
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        int i8 = 0;
        if (i6 == 0) {
            System.arraycopy(this.f206998v, i5, gF2Vector.f206998v, 0, i7);
            return gF2Vector;
        }
        while (true) {
            i2 = i7 - 1;
            iArr = gF2Vector.f206998v;
            if (i8 >= i2) {
                break;
            }
            int[] iArr2 = this.f206998v;
            int i9 = i5 + 1;
            iArr[i8] = (iArr2[i5] >>> i6) | (iArr2[i9] << (32 - i6));
            i8++;
            i5 = i9;
        }
        int[] iArr3 = this.f206998v;
        int i10 = i5 + 1;
        int i11 = iArr3[i5] >>> i6;
        iArr[i2] = i11;
        if (i10 < iArr3.length) {
    ...
    public GF2Vector extractVector(int[] iArr) {
        ...
        if (iArr[length - 1] > this.length) {
            lwm.m151979a("invalid index set");
            return null;
        }
    ...
    public int getBit(int i) {
        ...
        int i2 = i >> 5;
        int i3 = i & 31;
        return (this.f206998v[i2] & (1 << i3)) >>> i3;
    }

    @Override // org.spongycastle.pqc.math.linearalgebra.Vector
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f206998v, (this.length + 7) >> 3);
    }
    ...
    public int[] getVecArray() {
        return this.f206998v;
    }

    @Override // org.spongycastle.pqc.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + this.f206998v.hashCode();
    }

    @Override // org.spongycastle.pqc.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f206998v.length - 1; length >= 0; length--) {
            if (this.f206998v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public GF2mVector toExtensionFieldVector(GF2mField gF2mField) {
        ...
        int i = this.length;
        if (i % degree != 0) {
            lwm.m151979a("conversion is impossible");
            return null;
        }
        int i2 = i / degree;
        int[] iArr = new int[i2];
        ...
        for (int i4 = i2 - 1; i4 >= 0; i4--) {
            for (int degree2 = gF2mField.getDegree() - 1; degree2 >= 0; degree2--) {
                if (((this.f206998v[i3 >>> 5] >>> (i3 & 31)) & 1) == 1) {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f206998v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f206998v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f206998v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f206998v = IntUtils.clone(gF2Vector.f206998v);
    }
