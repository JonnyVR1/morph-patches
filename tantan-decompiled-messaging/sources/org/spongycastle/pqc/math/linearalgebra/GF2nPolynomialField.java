...
public class GF2nPolynomialField extends GF2nField {
    ...
    private int[] f206999pc;
    GF2Polynomial[] squaringMatrix;

    /* JADX INFO: renamed from: tc */
    private int f207000tc;
    ...
    public GF2nPolynomialField(int i, SecureRandom secureRandom, GF2Polynomial gF2Polynomial) throws RuntimeException {
        ...
        this.f206999pc = new int[3];
        if (i < 3) {
            ig3.m135964a("degree must be at least 3");
            throw null;
        }
    ...
    public void computeCOBMatrix(GF2nField gF2nField) {
        ...
        if (i != gF2nField.mDegree) {
            ig3.m135964a("GF2nPolynomialField.computeCOBMatrix: B1 has a different degree and thus cannot be coverted to!");
            return;
        }
    ...
    public int[] getPc() throws RuntimeException {
        ...
        int[] iArr = new int[3];
        System.arraycopy(this.f206999pc, 0, iArr, 0, 3);
        return iArr;
    }
    ...
    public GF2nElement getRandomRoot(GF2Polynomial gF2Polynomial) {
        ...
        return gF2nPolynomial.m221232at(0);
    }
    ...
    public GF2nPolynomialField(int i, SecureRandom secureRandom, boolean z) {
        ...
        ig3.m135964a("k must be at least 3");
        throw null;
    }
