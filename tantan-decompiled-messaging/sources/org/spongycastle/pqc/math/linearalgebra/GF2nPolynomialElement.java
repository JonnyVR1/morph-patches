    ...
    private void reduceThis() {
        ...
        if (zIsTrinomial) {
            try {
                ...
                upk0.m194883a("GF2nPolynomialElement.reduce: the field polynomial is not a trinomial");
                return;
            }
        }
        ...
        try {
            ...
            upk0.m194883a("GF2nPolynomialElement.reduce: the field polynomial is not a pentanomial");
        }
    }
