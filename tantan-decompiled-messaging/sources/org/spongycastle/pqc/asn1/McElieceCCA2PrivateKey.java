...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    private int f206876k;

    /* JADX INFO: renamed from: n */
    private int f206877n;
    private ASN1ObjectIdentifier oid;

    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.oid = (ASN1ObjectIdentifier) aSN1Sequence.getObjectAt(0);
        this.f206877n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f206876k = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public int getK() {
        return this.f206876k;
    }

    public int getN() {
        return this.f206877n;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f206877n));
        aSN1EncodableVector.add(new ASN1Integer(this.f206876k));
