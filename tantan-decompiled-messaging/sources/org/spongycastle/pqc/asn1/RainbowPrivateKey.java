...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private byte[] f206888b1;

    /* JADX INFO: renamed from: b2 */
    private byte[] f206889b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f206888b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f206889b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f206890vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f206890vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f206890vi;
            int i11 = i10 + 1;
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f206888b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f206889b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f206890vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f206888b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f206889b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f206890vi));
        ...
        for (int i3 = 0; i3 < this.layers.length; i3++) {
            ...
            for (byte[][] bArr3 : bArrConvertArray) {
            ...
            for (byte[][] bArr4 : bArrConvertArray2) {
            ...
            for (byte[] bArr5 : bArrConvertArray3) {
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f206888b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f206889b2 = RainbowUtil.convertArray(sArr4);
        this.f206890vi = RainbowUtil.convertIntArray(iArr);
