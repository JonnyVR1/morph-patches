...
public class McEliecePointchevalDigestCipher {
    ...
    public byte[] messageDecrypt(byte[] bArr) {
        if (this.forEncrypting) {
            qkq0.m175383a("McEliecePointchevalDigestCipher not initialised for decrypting.");
            return null;
        }
        try {
    ...
    public byte[] messageEncrypt() {
        if (!this.forEncrypting) {
            qkq0.m175383a("McEliecePointchevalDigestCipher not initialised for encrypting.");
            return null;
        }
