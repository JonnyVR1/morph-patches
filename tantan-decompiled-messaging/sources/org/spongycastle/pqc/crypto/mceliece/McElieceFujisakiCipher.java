...
public class McElieceFujisakiCipher implements MessageEncryptor {
    ...
    private int f206913k;
    McElieceCCA2KeyParameters key;
    private Digest messDigest;

    /* JADX INFO: renamed from: n */
    private int f206914n;

    /* JADX INFO: renamed from: sr */
    private SecureRandom f206915sr;

    /* JADX INFO: renamed from: t */
    private int f206916t;

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        SecureRandom secureRandom = this.f206915sr;
        if (secureRandom == null) {
            secureRandom = new SecureRandom();
        }
        this.f206915sr = secureRandom;
        this.messDigest = mcElieceCCA2PublicKeyParameters.getParameters().getDigest();
        this.f206914n = mcElieceCCA2PublicKeyParameters.getN();
        this.f206913k = mcElieceCCA2PublicKeyParameters.getK();
        this.f206916t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f206915sr = new SecureRandom();
            ...
            this.f206915sr = parametersWithRandom.getRandom();
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f206914n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f206916t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    @Override // org.spongycastle.pqc.crypto.MessageEncryptor
    public byte[] messageDecrypt(byte[] bArr) throws Exception {
        int i = (this.f206914n + 7) >> 3;
        int length = bArr.length - i;
        byte[][] bArrSplit = ByteUtils.split(bArr, i);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f206914n, bArr2));
        ...
        if (Conversions.encode(this.f206914n, this.f206916t, bArr5).equals(gF2Vector)) {
            return bArr4;
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) throws Exception {
        GF2Vector gF2Vector = new GF2Vector(this.f206913k, this.f206915sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f206914n, this.f206916t, bArr2)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
