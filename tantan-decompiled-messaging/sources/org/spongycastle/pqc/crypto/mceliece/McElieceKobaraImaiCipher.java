...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private int f206920k;
    McElieceCCA2KeyParameters key;
    private Digest messDigest;

    /* JADX INFO: renamed from: n */
    private int f206921n;

    /* JADX INFO: renamed from: sr */
    private SecureRandom f206922sr;

    /* JADX INFO: renamed from: t */
    private int f206923t;

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = mcElieceCCA2PublicKeyParameters.getParameters().getDigest();
        this.f206921n = mcElieceCCA2PublicKeyParameters.getN();
        this.f206920k = mcElieceCCA2PublicKeyParameters.getK();
        this.f206923t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f206922sr = new SecureRandom();
            ...
            this.f206922sr = parametersWithRandom.getRandom();
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f206921n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f206920k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f206923t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    @Override // org.spongycastle.pqc.crypto.MessageEncryptor
    public byte[] messageDecrypt(byte[] bArr) throws Exception {
        byte[] bArr2;
        int i = this.f206921n >> 3;
        if (bArr.length < i) {
            whq0.m203241a("Bad Padding: Ciphertext too short.");
            return null;
        }
        int digestSize = this.messDigest.getDigestSize();
        int i2 = this.f206920k >> 3;
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f206921n, bArr));
        ...
        byte[] bArrConcatenate = ByteUtils.concatenate(ByteUtils.concatenate(bArr2, Conversions.decode(this.f206921n, this.f206923t, gF2Vector)), encoded);
    ...
    public byte[] messageEncrypt(byte[] bArr) throws Exception {
        int digestSize = this.messDigest.getDigestSize();
        int i = this.f206920k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f206921n, this.f206923t).bitLength() - 1) >> 3;
        ...
        this.f206922sr.nextBytes(bArr4);
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f206920k, bArr9), Conversions.encode(this.f206921n, this.f206923t, bArr8)).getEncoded();
