...
public class McEliecePointchevalCipher implements MessageEncryptor {
    ...
    private int f206931k;
    McElieceCCA2KeyParameters key;
    private Digest messDigest;

    /* JADX INFO: renamed from: n */
    private int f206932n;

    /* JADX INFO: renamed from: sr */
    private SecureRandom f206933sr;

    /* JADX INFO: renamed from: t */
    private int f206934t;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f206933sr = new SecureRandom();
            ...
            this.f206933sr = parametersWithRandom.getRandom();
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f206932n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f206931k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f206934t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    public void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        SecureRandom secureRandom = this.f206933sr;
        if (secureRandom == null) {
            secureRandom = new SecureRandom();
        }
        this.f206933sr = secureRandom;
        this.messDigest = mcElieceCCA2PublicKeyParameters.getParameters().getDigest();
        this.f206932n = mcElieceCCA2PublicKeyParameters.getN();
        this.f206931k = mcElieceCCA2PublicKeyParameters.getK();
        this.f206934t = mcElieceCCA2PublicKeyParameters.getT();
    }

    @Override // org.spongycastle.pqc.crypto.MessageEncryptor
    public byte[] messageDecrypt(byte[] bArr) throws Exception {
        int i = (this.f206932n + 7) >> 3;
        int length = bArr.length - i;
        byte[][] bArrSplit = ByteUtils.split(bArr, i);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f206932n, bArr2));
        ...
        if (Conversions.encode(this.f206932n, this.f206934t, bArr5).equals(gF2Vector)) {
            return ByteUtils.split(bArr4, length - (this.f206931k >> 3))[0];
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) throws Exception {
        int i = this.f206931k >> 3;
        byte[] bArr2 = new byte[i];
        this.f206933sr.nextBytes(bArr2);
        GF2Vector gF2Vector = new GF2Vector(this.f206931k, this.f206933sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f206932n, this.f206934t, bArr3)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
