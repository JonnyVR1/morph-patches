...
public class McElieceKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private int f206917m;
    private McElieceKeyGenerationParameters mcElieceParams;

    /* JADX INFO: renamed from: n */
    private int f206918n;
    private SecureRandom random;

    /* JADX INFO: renamed from: t */
    private int f206919t;

    private AsymmetricCipherKeyPair genKeyPair() {
        if (!this.initialized) {
            initializeDefault();
        }
        GF2mField gF2mField = new GF2mField(this.f206917m, this.fieldPoly);
        PolynomialGF2mSmallM polynomialGF2mSmallM = new PolynomialGF2mSmallM(gF2mField, this.f206919t, 'I', this.random);
