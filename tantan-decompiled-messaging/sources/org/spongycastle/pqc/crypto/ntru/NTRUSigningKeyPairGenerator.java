...
public class NTRUSigningKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public class FGBasis extends NTRUSigningPrivateKeyParameters.Basis {
        ...
        public IntegerPolynomial f206970F;

        /* JADX INFO: renamed from: G */
        public IntegerPolynomial f206971G;
        ...
        public FGBasis(Polynomial polynomial, Polynomial polynomial2, IntegerPolynomial integerPolynomial, IntegerPolynomial integerPolynomial2, IntegerPolynomial integerPolynomial3, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) {
            ...
            this.f206970F = integerPolynomial2;
            this.f206971G = integerPolynomial3;
        }
        ...
        public boolean isNormOk() {
            ...
            int i = nTRUSigningKeyGenerationParameters.f206969q;
            return ((double) this.f206970F.centeredNormSq(i)) < d && ((double) this.f206971G.centeredNormSq(i)) < d;
        }
    }
    ...
    private FGBasis generateBasis() {
        ...
        int i3 = nTRUSigningKeyGenerationParameters.f206964N;
        int i4 = nTRUSigningKeyGenerationParameters.f206969q;
        int i5 = nTRUSigningKeyGenerationParameters.f206965d;
        int i6 = nTRUSigningKeyGenerationParameters.f206966d1;
        int i7 = nTRUSigningKeyGenerationParameters.f206967d2;
        int i8 = nTRUSigningKeyGenerationParameters.f206968d3;
        ...
        bigIntPolynomial.mult(bigIntEuclideanCalculate.f207007x.multiply(BigInteger.valueOf(i4)));
        BigIntPolynomial bigIntPolynomial2 = (BigIntPolynomial) resultant.rho.clone();
        bigIntPolynomial2.mult(bigIntEuclideanCalculate.f207008y.multiply(BigInteger.valueOf(-i4)));
        int i14 = 0;
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        for (int i2 = this.params.f206963B; i2 >= 0; i2--) {
            Future future = (Future) arrayList.get(i2);
            try {
                arrayList2.add(future.get());
                if (i2 == this.params.f206963B) {
                    nTRUSigningPublicKeyParameters = new NTRUSigningPublicKeyParameters(((NTRUSigningPrivateKeyParameters.Basis) future.get()).f206980h, this.params.getSigningParameters());
                }
            } catch (Exception e) {
                phg0.m168968a(e);
                return null;
    ...
    public AsymmetricCipherKeyPair generateKeyPairSingleThread() {
        ArrayList arrayList = new ArrayList();
        NTRUSigningPublicKeyParameters nTRUSigningPublicKeyParameters = null;
        for (int i = this.params.f206963B; i >= 0; i--) {
            ...
            if (i == 0) {
                nTRUSigningPublicKeyParameters = new NTRUSigningPublicKeyParameters(basisGenerateBoundedBasis.f206980h, this.params.getSigningParameters());
            }
        }
