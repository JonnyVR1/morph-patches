...
public class IndexGenerator {
    ...
    private int f206943N;
    private BitString buf;

    /* JADX INFO: renamed from: c */
    private int f206944c;
    private int hLen;
    ...
    public IndexGenerator(byte[] bArr, NTRUEncryptionParameters nTRUEncryptionParameters) {
        this.seed = bArr;
        this.f206943N = nTRUEncryptionParameters.f206952N;
        this.f206944c = nTRUEncryptionParameters.f206953c;
    ...
    public int nextIndex() {
        ...
        do {
            ...
            leadingAsInt = trailing.getLeadingAsInt(this.f206944c);
            i = this.f206944c;
            i2 = this.f206943N;
