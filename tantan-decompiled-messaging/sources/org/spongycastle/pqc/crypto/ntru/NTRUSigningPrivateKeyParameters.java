...
public class NTRUSigningPrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public NTRUSigningPrivateKeyParameters(InputStream inputStream, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) throws IOException {
        ...
        int i = 0;
        while (i <= nTRUSigningKeyGenerationParameters.f206963B) {
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < this.bases.size(); i++) {
            ...
            if (!basis.f206979f.equals(basis2.f206979f) || !basis.fPrime.equals(basis2.fPrime)) {
                return false;
            }
            if ((i != 0 && !basis.f206980h.equals(basis2.f206980h)) || !basis.params.equals(basis2.params)) {
                return false;
            }
        }
        return true;
    ...
    public static class Basis {
        ...
        public Polynomial f206979f;
        public Polynomial fPrime;

        /* JADX INFO: renamed from: h */
        public IntegerPolynomial f206980h;
        ...
        public Basis(InputStream inputStream, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters, boolean z) throws IOException {
            ...
            int i5 = nTRUSigningKeyGenerationParameters.f206966d1;
            int i6 = nTRUSigningKeyGenerationParameters.f206967d2;
            int i7 = nTRUSigningKeyGenerationParameters.f206968d3;
            ...
            if (nTRUSigningKeyGenerationParameters.polyType == 1) {
                ...
                this.f206979f = productFormPolynomialFromBinary;
            } else {
                i = i3;
                inputStream2 = inputStream;
                IntegerPolynomial integerPolynomialFromBinary3Tight = IntegerPolynomial.fromBinary3Tight(inputStream2, i);
                this.f206979f = z2 ? new SparseTernaryPolynomial(integerPolynomialFromBinary3Tight) : new DenseTernaryPolynomial(integerPolynomialFromBinary3Tight);
            }
            ...
            if (z) {
                this.f206980h = IntegerPolynomial.fromBinary(inputStream3, i2, i4);
            }
        }
        ...
        public void encode(OutputStream outputStream, boolean z) throws IOException {
            int i = this.params.f206969q;
            outputStream.write(getEncoded(this.f206979f));
            ...
            if (z) {
                outputStream.write(this.f206980h.toBinary(i));
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            Polynomial polynomial = this.f206979f;
            Polynomial polynomial2 = basis.f206979f;
            if (polynomial == null) {
                if (polynomial2 != null) {
                    return false;
                }
            ...
            IntegerPolynomial integerPolynomial = this.f206980h;
            IntegerPolynomial integerPolynomial2 = basis.f206980h;
        ...
        public Basis(Polynomial polynomial, Polynomial polynomial2, IntegerPolynomial integerPolynomial, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) {
            this.f206979f = polynomial;
            this.fPrime = polynomial2;
            this.f206980h = integerPolynomial;
            this.params = nTRUSigningKeyGenerationParameters;
        }
    }
}
