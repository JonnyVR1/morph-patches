...
public class NTRUEncryptionPrivateKeyParameters extends NTRUEncryptionKeyParameters {
    ...
    public IntegerPolynomial f206959fp;

    /* JADX INFO: renamed from: h */
    public IntegerPolynomial f206960h;

    /* JADX INFO: renamed from: t */
    public Polynomial f206961t;
    ...
    public NTRUEncryptionPrivateKeyParameters(InputStream inputStream, NTRUEncryptionParameters nTRUEncryptionParameters) throws IOException {
        ...
        int i2 = nTRUEncryptionParameters.f206952N;
        if (i == 1) {
            ...
            this.f206960h = IntegerPolynomial.fromBinary(inputStream, i2, nTRUEncryptionParameters.f206958q);
            this.f206961t = ProductFormPolynomial.fromBinary(inputStream, i2, i3, i4, i5, i6);
        } else {
            this.f206960h = IntegerPolynomial.fromBinary(inputStream, i2, nTRUEncryptionParameters.f206958q);
            IntegerPolynomial integerPolynomialFromBinary3Tight = IntegerPolynomial.fromBinary3Tight(inputStream, nTRUEncryptionParameters.f206952N);
            this.f206961t = nTRUEncryptionParameters.sparse ? new SparseTernaryPolynomial(integerPolynomialFromBinary3Tight) : new DenseTernaryPolynomial(integerPolynomialFromBinary3Tight);
        }
        init();
    }
    ...
    private void init() {
        if (!this.params.fastFp) {
            this.f206959fp = this.f206961t.toIntegerPolynomial().invertF3();
            return;
        }
        IntegerPolynomial integerPolynomial = new IntegerPolynomial(this.params.f206952N);
        this.f206959fp = integerPolynomial;
    ...
    public boolean equals(Object obj) {
        ...
        Polynomial polynomial = this.f206961t;
        Polynomial polynomial2 = nTRUEncryptionPrivateKeyParameters.f206961t;
        if (polynomial == null) {
            if (polynomial2 != null) {
                return false;
            }
        ...
        return this.f206960h.equals(nTRUEncryptionPrivateKeyParameters.f206960h);
    }

    public byte[] getEncoded() {
        byte[] binary = this.f206960h.toBinary(this.params.f206958q);
        Polynomial polynomial = this.f206961t;
    ...
    public int hashCode() {
        ...
        IntegerPolynomial integerPolynomial = this.f206960h;
    ...
    public NTRUEncryptionPrivateKeyParameters(IntegerPolynomial integerPolynomial, Polynomial polynomial, IntegerPolynomial integerPolynomial2, NTRUEncryptionParameters nTRUEncryptionParameters) {
        super(true, nTRUEncryptionParameters);
        this.f206960h = integerPolynomial;
        this.f206961t = polynomial;
        this.f206959fp = integerPolynomial2;
    }
}
