...
public class NTRUSigner {
    ...
    private IntegerPolynomial sign(IntegerPolynomial integerPolynomial, NTRUSigningPrivateKeyParameters nTRUSigningPrivateKeyParameters) {
        ...
        int i = nTRUSigningParameters.f206973N;
        int i2 = nTRUSigningParameters.f206978q;
        ...
        for (int i3 = nTRUSigningParameters.f206972B; i3 >= 1; i3--) {
            Polynomial polynomial = nTRUSigningPrivateKeyParameters.getBasis(i3).f206979f;
            ...
            IntegerPolynomial integerPolynomial3 = (IntegerPolynomial) nTRUSigningPrivateKeyParameters.getBasis(i3).f206980h.clone();
            if (i3 > 1) {
                integerPolynomial3.sub(nTRUSigningPrivateKeyParameters.getBasis(i3 - 1).f206980h);
            } else {
                integerPolynomial3.sub(publicKey.f206981h);
            }
            integerPolynomial = integerPolynomialMult2.mult(integerPolynomial3, i2);
        }
        Polynomial polynomial3 = nTRUSigningPrivateKeyParameters.getBasis(0).f206979f;
    ...
    private byte[] signHash(byte[] bArr, NTRUSigningPrivateKeyParameters nTRUSigningPrivateKeyParameters) {
        ...
        } while (!verify(integerPolynomialCreateMsgRep, integerPolynomialSign, publicKey.f206981h));
        byte[] binary = integerPolynomialSign.toBinary(this.params.f206978q);
    ...
    private boolean verify(IntegerPolynomial integerPolynomial, IntegerPolynomial integerPolynomial2, IntegerPolynomial integerPolynomial3) {
        NTRUSigningParameters nTRUSigningParameters = this.params;
        int i = nTRUSigningParameters.f206978q;
    ...
    private boolean verifyHash(byte[] bArr, byte[] bArr2, NTRUSigningPublicKeyParameters nTRUSigningPublicKeyParameters) {
        ...
        NTRUSigningParameters nTRUSigningParameters = this.params;
        return verify(createMsgRep(bArr, byteBufferWrap.getInt()), IntegerPolynomial.fromBinary(bArr3, nTRUSigningParameters.f206973N, nTRUSigningParameters.f206978q), nTRUSigningPublicKeyParameters.f206981h);
    }

    public IntegerPolynomial createMsgRep(byte[] bArr, int i) {
        NTRUSigningParameters nTRUSigningParameters = this.params;
        int i2 = nTRUSigningParameters.f206973N;
        int iNumberOfLeadingZeros = Integer.numberOfLeadingZeros(nTRUSigningParameters.f206978q);
    ...
    public byte[] generateSignature() {
        ...
        if (digest == null || this.signingKeyPair == null) {
            qkq0.m175383a("Call initSign first!");
            return null;
        }
    ...
    public void update(byte b) {
        ...
        if (digest != null) {
            ...
            qkq0.m175383a("Call initSign or initVerify first!");
        }
    }
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (digest == null || this.verificationKey == null) {
            qkq0.m175383a("Call initVerify first!");
            return false;
        }
