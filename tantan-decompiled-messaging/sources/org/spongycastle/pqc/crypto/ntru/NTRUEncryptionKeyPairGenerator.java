...
public class NTRUEncryptionKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        int i = nTRUEncryptionKeyGenerationParameters.f206945N;
        int i2 = nTRUEncryptionKeyGenerationParameters.f206951q;
        int i3 = nTRUEncryptionKeyGenerationParameters.f206948df;
        ...
        int i7 = nTRUEncryptionKeyGenerationParameters.f206949dg;
