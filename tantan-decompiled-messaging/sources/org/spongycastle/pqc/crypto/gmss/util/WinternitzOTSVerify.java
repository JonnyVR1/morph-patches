...
public class WinternitzOTSVerify {
    ...
    public byte[] Verify(byte[] bArr, byte[] bArr2) {
        ...
        int i3 = digestSize << 3;
        int i4 = this.f206902w;
        int i5 = ((i4 - 1) + i3) / i4;
        boolean z = true;
        int log = getLog((i5 << i4) + 1);
        int i6 = this.f206902w;
        ...
        if (8 % i6 == 0) {
            ...
            while (i11 < digestSize2) {
                while (i2 < i9) {
                    ...
                    bArr7[i11] = (byte) (bArr7[i11] >>> this.f206902w);
                    i13++;
                    i2++;
                    digestSize2 = i15;
                    bArr4 = bArr7;
            ...
            while (i25 < i23) {
                boolean z2 = z;
                long j = 0;
                for (int i29 = 0; i29 < this.f206902w; i29++) {
            ...
            int i34 = digestSize % this.f206902w;
            int i35 = 0;
            long j2 = 0;
            while (i35 < i34) {
            ...
            while (i37 < i36) {
                ...
                int i41 = this.f206902w;
                j2 >>>= i41;
                i28++;
                i37 += i41;
                i36 = i40;
            }
            int i42 = (i5 << this.f206902w) - i27;
            int i43 = 0;
            while (i43 < log) {
