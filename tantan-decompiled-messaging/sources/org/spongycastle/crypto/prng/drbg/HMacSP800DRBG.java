...
public class HMacSP800DRBG implements SP80090DRBG {
    ...
    private byte[] f206757_K;

    /* JADX INFO: renamed from: _V */
    private byte[] f206758_V;
    ...
    public HMacSP800DRBG(Mac mac, int i, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        ...
        this.f206757_K = bArr3;
        byte[] bArr4 = new byte[bArr3.length];
        this.f206758_V = bArr4;
    ...
    private void hmac_DRBG_Update_Func(byte[] bArr, byte b) {
        this._hMac.init(new KeyParameter(this.f206757_K));
        Mac mac = this._hMac;
        byte[] bArr2 = this.f206758_V;
        mac.update(bArr2, 0, bArr2.length);
        this._hMac.update(b);
        if (bArr != null) {
            this._hMac.update(bArr, 0, bArr.length);
        }
        this._hMac.doFinal(this.f206757_K, 0);
        this._hMac.init(new KeyParameter(this.f206757_K));
        Mac mac2 = this._hMac;
        byte[] bArr3 = this.f206758_V;
        mac2.update(bArr3, 0, bArr3.length);
        this._hMac.doFinal(this.f206758_V, 0);
    }
    ...
    public int getBlockSize() {
        return this.f206758_V.length * 8;
    }
