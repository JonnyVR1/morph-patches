...
public final class DERMacData {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = C222761.$SwitchMap$org$spongycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            C222761 c222761 = null;
            if (i == 1 || i == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), c222761);
            }
            if (i == 3 || i == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), c222761);
            }
            qkq0.m175383a("Unknown type encountered in build");
            return null;
        }
    ...
    public /* synthetic */ DERMacData(byte[] bArr, C222761 c222761) {
        this(bArr);
    }
}
