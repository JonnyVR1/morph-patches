...
import org.spongycastle.asn1.p128x9.DHPublicKey;
import org.spongycastle.asn1.p128x9.DomainParameters;
import org.spongycastle.asn1.p128x9.ECNamedCurveTable;
import org.spongycastle.asn1.p128x9.ValidationParams;
...
public class PublicKeyFactory {
    public static AsymmetricKeyParameter createKey(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
        ...
        if (!algorithm.getAlgorithm().equals(X9ObjectIdentifiers.id_ecPublicKey)) {
            upk0.m194883a("algorithm identifier in key not recognised");
            return null;
        }
