...
public class HKDFBytesGenerator implements DerivationFunction {
    ...
    private void expandNext() throws DataLengthException {
        ...
        int i3 = (i / i2) + 1;
        if (i3 >= 256) {
            npk0.m160508a("HKDF cannot generate more than 255 blocks of HashLen size");
            return;
        }
        if (i != 0) {
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        int i5 = this.hashLen;
        if (i4 > i5 * 255) {
            npk0.m160508a("HKDF may only be used for 255 * HashLen bytes of output");
            return 0;
        }
        if (i3 % i5 == 0) {
            expandNext();
    ...
    public void init(DerivationParameters derivationParameters) {
        if (!(derivationParameters instanceof HKDFParameters)) {
            ig3.m135964a("HKDF parameters required for HKDFBytesGenerator");
            return;
        }
