...
public class PKCS5S2ParametersGenerator extends PBEParametersGenerator {
    ...
    private void m221222F(byte[] bArr, int i, byte[] bArr2, byte[] bArr3, int i2) {
        if (i == 0) {
            ig3.m135964a("iteration count must be at least 1.");
            return;
        }
        if (bArr != null) {
    ...
    private byte[] generateDerivedKey(int i) {
        ...
        for (int i5 = 1; i5 <= i3; i5++) {
            ...
            m221222F(this.salt, this.iterationCount, bArr, bArr2, i4);
            i4 += macSize;
        }
        return bArr2;
    }
