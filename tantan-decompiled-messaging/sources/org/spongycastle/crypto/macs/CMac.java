...
public class CMac implements Mac {
    ...
    public CMac(BlockCipher blockCipher, int i) {
        if (i % 8 != 0) {
            ig3.m135964a("MAC size must be multiple of 8");
            throw null;
        }
        if (i > blockCipher.getBlockSize() * 8) {
            bub.m103905a("MAC size must be less or equal to ", blockCipher.getBlockSize() * 8);
            throw null;
        }
    ...
    private static byte[] lookupPoly(int i) {
        ...
        switch (i2) {
            ...
            case 2048:
                ...
                break;
            default:
                k250.m144273a("Unknown block size for CMAC: ", i2);
                return null;
        }
    ...
    public void validate(CipherParameters cipherParameters) {
        ...
        ig3.m135964a("CMac mode only permits key to be set.");
    }
