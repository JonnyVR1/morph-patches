...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private static final byte[] SBOX1 = {112, -126, 44, -20, -77, 39, -64, -27, -28, -123, 87, 53, -22, 12, -82, 65, 35, -17, 107, -109, 69, 25, -91, 33, -19, 14, 79, 78, 29, 101, -110, -67, -122, -72, -81, -113, 124, -21, 31, -50, 62, 48, -36, 95, 94, -59, 11, 26, -90, -31, 57, -54, -43, 71, 93, 61, -39, 1, 90, -42, 81, 86, 108, 77, -117, HttpTokens.CARRIAGE_RETURN, -102, 102, -5, -52, -80, 45, 116, 18, 43, HttpTokens.SPACE, -16, -79, -124, -103, -33, 76, -53, -62, 52, 126, 118, 5, 109, -73, -87, 49, -47, 23, 4, -41, 20, 88, HttpTokens.COLON, 97, -34, 27, 17, 28, 50, 15, -100, 22, 83, 24, -14, 34, -2, 68, -49, -78, -61, -75, 122, -111, 36, 8, -24, -88, 96, -4, 105, 80, -86, -48, -96, 125, -95, -119, 98, -105, 84, 91, 30, -107, -32, -1, 100, -46, Tnaf.POW_2_WIDTH, -60, 0, 72, -93, -9, 117, -37, -118, 3, -26, -38, 9, Utf8.REPLACEMENT_BYTE, -35, -108, -121, 92, -125, 2, -51, 74, -112, 51, 115, 103, -10, -13, -99, 127, -65, -30, 82, -101, -40, 38, -56, 55, -58, HttpTokens.SEMI_COLON, -127, -106, 111, 75, 19, -66, 99, 46, -23, 121, -89, -116, -97, 110, PSSSigner.TRAILER_IMPLICIT, -114, 41, -11, -7, -74, 47, -3, -76, 89, 120, -104, 6, 106, -25, 70, 113, -70, -44, 37, -85, 66, -120, -94, -115, -6, 114, 7, -71, 85, -8, -18, -84, 10, 54, 73, 42, 104, 60, 56, -15, -92, 64, 40, -45, 123, -69, -55, 67, -63, 21, -29, -83, -12, 119, -57, -128, -98};
    private int[] subkey = new int[96];

    /* JADX INFO: renamed from: kw */
    private int[] f206542kw = new int[8];

    /* JADX INFO: renamed from: ke */
    private int[] f206541ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int iSbox5 = ((bArr[(i6 >>> 24) & 255] & 255) << 24) | sbox4(i6 & 255) | (sbox3((i6 >>> 8) & 255) << 8) | (sbox2((i6 >>> 16) & 255) << 16);
    ...
    private int processBlock128(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            iArr4[i3] = iArr4[i3] ^ this.f206542kw[i3];
            i3++;
        }
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            if (i3 >= 4) {
                ...
                camelliaF2(this.state, this.subkey, 28);
                camelliaF2(this.state, this.subkey, 32);
                camelliaFLs(this.state, this.f206541ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (length == 16) {
            ...
            if (length != 32) {
                ig3.m135964a("key sizes are only 16/24/32 bytes.");
                return;
            }
            iArr[0] = bytes2int(bArr, 0);
            iArr[1] = bytes2int(bArr, 4);
        ...
        if (this._keyis128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f206541ke, 4);
                ...
                roldq(15, iArr2, 0, this.f206541ke, 0);
                ...
                roldq(17, iArr2, 0, this.f206542kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f206541ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f206541ke, 4);
            ...
            roldq(17, iArr2, 0, this.f206542kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldq(15, iArr, 0, this.f206541ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f206541ke, 0);
            ...
            roldqo32(51, iArr3, 0, this.f206542kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f206542kw, 0);
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            ig3.m135964a("only simple KeyParameter expected.");
        } else {
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException {
        if (!this.initialized) {
            qkq0.m175383a("Camellia is not initialized");
            return 0;
        }
        if (i + 16 > bArr.length) {
