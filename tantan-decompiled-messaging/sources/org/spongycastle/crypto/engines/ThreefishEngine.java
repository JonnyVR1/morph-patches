...
public class ThreefishEngine implements BlockCipher {
    ...
    private long[] f206590kw;

    /* JADX INFO: renamed from: t */
    private long[] f206591t;
    ...
    public static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        public void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f206592kw;
            long[] jArr4 = this.f206593t;
    ...
    public static abstract class ThreefishCipher {
        ...
        /* JADX INFO: renamed from: kw */
        protected final long[] f206592kw;

        /* JADX INFO: renamed from: t */
        protected final long[] f206593t;
    ...
    public ThreefishEngine(int i) {
        ...
        if (i == 512) {
            ...
            ig3.m135964a("Invalid blocksize - Threefish is defined with block size of 256, 512, or 1024 bits");
            throw null;
        }
    }
    ...
    private void setKey(long[] jArr) {
        if (jArr.length != this.blocksizeWords) {
            pac0.m168085a("Threefish key must be same size as block (", this.blocksizeWords, " words)");
            return;
        }
        long j = C_240;
        int i = 0;
    ...
    private void setTweak(long[] jArr) {
        if (jArr.length != 2) {
            ig3.m135964a("Tweak must be 2 words.");
            return;
        }
        long[] jArr2 = this.f206591t;
        long j = jArr[0];
        jArr2[0] = j;
        long j2 = jArr[1];
        jArr2[1] = j2;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof TweakableBlockCipherParameters) {
            ...
            ig3.m135964a("Invalid parameter passed to Threefish init - ".concat(cipherParameters.getClass().getName()));
            return;
        } else {
        ...
        if (key == null) {
            ...
            if (key.length != this.blocksizeBytes) {
                pac0.m168085a("Threefish key must be same size as block (", this.blocksizeBytes, " bytes)");
                return;
            }
        ...
        if (tweak != null) {
            if (tweak.length != 16) {
                ig3.m135964a("Threefish tweak must be 16 bytes");
                return;
            }
    ...
    public int processBlock(long[] jArr, long[] jArr2) throws IllegalStateException, DataLengthException {
        ...
        qkq0.m175383a("Threefish engine not initialised");
        return 0;
    }
