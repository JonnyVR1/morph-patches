...
public class RC2WrapEngine implements Wrapper {
    ...
    private byte[] f206560iv;
    private CipherParameters param;
    private ParametersWithIV paramPlusIV;

    /* JADX INFO: renamed from: sr */
    private SecureRandom f206561sr;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            this.f206561sr = parametersWithRandom.getRandom();
            cipherParameters = parametersWithRandom.getParameters();
        } else {
            this.f206561sr = new SecureRandom();
        }
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ...
            if (this.forWrapping) {
                ...
                this.f206560iv = bArr;
                this.f206561sr.nextBytes(bArr);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f206560iv);
                return;
            }
            return;
        }
        ...
        this.f206560iv = parametersWithIV.getIV();
        this.param = this.paramPlusIV.getParameters();
        if (!this.forWrapping) {
            ig3.m135964a("You should not supply an IV for unwrapping");
            return;
        }
        byte[] bArr2 = this.f206560iv;
        if (bArr2 == null || bArr2.length != 8) {
            ig3.m135964a("IV is not 8 octets");
        }
    }
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (bArr == null) {
            dql.m113082a("Null pointer as ciphertext");
            return null;
        }
        ...
        this.f206560iv = bArr4;
        int i6 = i2 - 8;
        byte[] bArr5 = new byte[i6];
        System.arraycopy(bArr3, 0, bArr4, 0, 8);
        System.arraycopy(bArr3, 8, bArr5, 0, i6);
        ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f206560iv);
        this.paramPlusIV = parametersWithIV;
        ...
        if (!checkCMSKeyChecksum(bArr7, bArr8)) {
            dql.m113082a("Checksum inside ciphertext is corrupted");
            return null;
        }
        int i9 = bArr7[0];
        if (i8 - ((i9 & 255) + 1) <= 7) {
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (!this.forWrapping) {
            qkq0.m175383a("Not initialized for wrapping");
            return null;
        }
        int i3 = i2 + 1;
        int i4 = i3 % 8;
        ...
        if (i6 > 0) {
            this.f206561sr.nextBytes(bArr3);
        ...
        if (length % this.engine.getBlockSize() != 0) {
            qkq0.m175383a("Not multiple of block length");
            return null;
        }
        ...
        byte[] bArr6 = this.f206560iv;
        int length2 = bArr6.length + length;
        byte[] bArr7 = new byte[length2];
        System.arraycopy(bArr6, 0, bArr7, 0, bArr6.length);
        System.arraycopy(bArr5, 0, bArr7, this.f206560iv.length, length);
