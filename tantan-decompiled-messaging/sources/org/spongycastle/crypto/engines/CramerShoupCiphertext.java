...
public class CramerShoupCiphertext {
    ...
    BigInteger f206544u1;

    /* JADX INFO: renamed from: u2 */
    BigInteger f206545u2;
    ...
    public CramerShoupCiphertext(byte[] bArr) {
        ...
        this.f206544u1 = new BigInteger(Arrays.copyOfRange(bArr, 4, i));
        int i2 = iBigEndianToInt + 8;
        int iBigEndianToInt2 = Pack.bigEndianToInt(bArr, i) + i2;
        this.f206545u2 = new BigInteger(Arrays.copyOfRange(bArr, i2, iBigEndianToInt2));
        int iBigEndianToInt3 = Pack.bigEndianToInt(bArr, iBigEndianToInt2);
        int i3 = iBigEndianToInt2 + 4;
        int i4 = iBigEndianToInt3 + i3;
        this.f206543e = new BigInteger(Arrays.copyOfRange(bArr, i3, i4));
        int iBigEndianToInt4 = Pack.bigEndianToInt(bArr, i4);
        int i5 = i4 + 4;
        this.f206546v = new BigInteger(Arrays.copyOfRange(bArr, i5, iBigEndianToInt4 + i5));
    }

    public BigInteger getE() {
        return this.f206543e;
    }

    public BigInteger getU1() {
        return this.f206544u1;
    }

    public BigInteger getU2() {
        return this.f206545u2;
    }

    public BigInteger getV() {
        return this.f206546v;
    }

    public void setE(BigInteger bigInteger) {
        this.f206543e = bigInteger;
    }

    public void setU1(BigInteger bigInteger) {
        this.f206544u1 = bigInteger;
    }

    public void setU2(BigInteger bigInteger) {
        this.f206545u2 = bigInteger;
    }

    public void setV(BigInteger bigInteger) {
        this.f206546v = bigInteger;
    }

    public byte[] toByteArray() {
        byte[] byteArray = this.f206544u1.toByteArray();
        int length = byteArray.length;
        byte[] byteArray2 = this.f206545u2.toByteArray();
        int length2 = byteArray2.length;
        byte[] byteArray3 = this.f206543e.toByteArray();
        int length3 = byteArray3.length;
        byte[] byteArray4 = this.f206546v.toByteArray();
    ...
    public String toString() {
        ...
        stringBuffer.append("u1: " + this.f206544u1.toString());
        stringBuffer.append("\nu2: " + this.f206545u2.toString());
        stringBuffer.append("\ne: " + this.f206543e.toString());
        stringBuffer.append("\nv: " + this.f206546v.toString());
    ...
    public CramerShoupCiphertext(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
        this.f206544u1 = bigInteger;
        this.f206545u2 = bigInteger2;
        this.f206543e = bigInteger3;
        this.f206546v = bigInteger4;
    }
