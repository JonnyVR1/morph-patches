...
public class HC256Engine implements StreamCipher {
    ...
    private byte[] f206552iv;
    private byte[] key;

    /* JADX INFO: renamed from: p */
    private int[] f206553p = new int[1024];

    /* JADX INFO: renamed from: q */
    private int[] f206554q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        if (bArr.length != 32 && bArr.length != 16) {
            ig3.m135964a("The key must be 128/256 bits long");
            return;
        }
        if (this.f206552iv.length < 16) {
            ig3.m135964a("The IV must be at least 128 bits long");
            return;
        }
        if (bArr.length != 32) {
        ...
        for (int i3 = 0; i3 < 32; i3++) {
            int i4 = (i3 >> 2) + 8;
            iArr[i4] = iArr[i4] | ((this.f206552iv[i3] & 255) << ((i3 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f206553p, 0, 1024);
        System.arraycopy(iArr, 1536, this.f206554q, 0, 1024);
    ...
    private int step() {
        ...
        if (i3 < 1024) {
            ...
            int[] iArr5 = this.f206553p;
            iArr4[i4] = i11 + iRotateRight2 + iArr5[(i9 ^ i10) & 1023];
            int[] iArr6 = this.f206554q;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f206552iv = parametersWithIV.getIV();
            parameters = parametersWithIV.getParameters();
        } else {
            this.f206552iv = new byte[0];
        ...
        ig3.m135964a("Invalid parameter passed to HC256 init - ".concat(cipherParameters.getClass().getName()));
    }
}
