...
public class CamelliaEngine implements BlockCipher {
    ...
    private int[] f206540kw = new int[8];

    /* JADX INFO: renamed from: ke */
    private int[] f206539ke = new int[12];
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        iArr[0] = iArr[0] ^ i12;
        iArr[1] = iArr[1] ^ (i12 ^ rightRotate(i10, 8));
    }
    ...
    private int processBlock128(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            iArr4[i3] = iArr4[i3] ^ this.f206540kw[i3];
            i3++;
        }
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            if (i3 >= 4) {
                ...
                camelliaF2(this.state, this.subkey, 28);
                camelliaF2(this.state, this.subkey, 32);
                camelliaFLs(this.state, this.f206539ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f206539ke, 4);
                ...
                roldq(15, iArr2, 0, this.f206539ke, 0);
                ...
                roldq(17, iArr2, 0, this.f206540kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f206539ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f206539ke, 4);
            ...
            roldq(17, iArr2, 0, this.f206540kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldq(15, iArr, 0, this.f206539ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f206539ke, 0);
            ...
            roldqo32(51, iArr3, 0, this.f206540kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f206540kw, 0);
    }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        if (!this.initialised) {
            qkq0.m175383a("Camellia engine not initialised");
            return 0;
        }
        if (i + 16 > bArr.length) {
