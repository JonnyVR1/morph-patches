...
public class TEAEngine implements BlockCipher {
    ...
    private int f206586_a;

    /* JADX INFO: renamed from: _b */
    private int f206587_b;

    /* JADX INFO: renamed from: _c */
    private int f206588_c;

    /* JADX INFO: renamed from: _d */
    private int f206589_d;
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i4 = 0; i4 != 32; i4++) {
            iBytesToInt2 -= (((iBytesToInt << 4) + this.f206588_c) ^ (iBytesToInt + i3)) ^ ((iBytesToInt >>> 5) + this.f206589_d);
            iBytesToInt -= (((iBytesToInt2 << 4) + this.f206586_a) ^ (iBytesToInt2 + i3)) ^ ((iBytesToInt2 >>> 5) + this.f206587_b);
            i3 += 1640531527;
        }
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i5 = 0; i5 != 32; i5++) {
            i4 -= 1640531527;
            i3 += (((iBytesToInt2 << 4) + this.f206586_a) ^ (iBytesToInt2 + i4)) ^ ((iBytesToInt2 >>> 5) + this.f206587_b);
            iBytesToInt2 += (((i3 << 4) + this.f206588_c) ^ (i3 + i4)) ^ ((i3 >>> 5) + this.f206589_d);
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        this.f206586_a = bytesToInt(bArr, 0);
        this.f206587_b = bytesToInt(bArr, 4);
        this.f206588_c = bytesToInt(bArr, 8);
        this.f206589_d = bytesToInt(bArr, 12);
    }
