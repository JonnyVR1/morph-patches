...
public class Salsa20Engine implements SkippingStreamCipher {
    ...
    protected int[] f206580x;

    public Salsa20Engine(int i) {
        this.index = 0;
        this.engineState = new int[16];
        this.f206580x = new int[16];
        this.keyStream = new byte[64];
        this.initialised = false;
        if (i <= 0 || (i & 1) != 0) {
            ig3.m135964a("'rounds' must be a positive, even number");
            throw null;
        }
        this.rounds = i;
    }
    ...
    public void generateKeyStream(byte[] bArr) {
        salsaCore(this.rounds, this.engineState, this.f206580x);
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof ParametersWithIV)) {
            lhi.m149843a(getAlgorithmName(), " Init parameters must include an IV");
            return;
        }
        ...
        if (parameters == null) {
            if (!this.initialised) {
                kjc0.m146216a(getAlgorithmName(), " KeyParameter can not be null for first initialisation");
                return;
            }
            setKey(null, iv);
        } else {
            if (!(parameters instanceof KeyParameter)) {
                lhi.m149843a(getAlgorithmName(), " Init parameters must contain a KeyParameter (or null for re-init)");
                return;
            }
