...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutput() {
        ...
        int i23 = i16 & i19;
        return ((((((((((((i20 & i23) ^ i22) ^ (i23 & i13)) ^ ((i18 & i19) & i13)) ^ (i13 & i21)) ^ i3) ^ i4) ^ i5) ^ i6) ^ i8) ^ i10) ^ i12) & j6f.COLOR_SPACE_UNCALIBRATED;
    }
    ...
    private int getOutputLFSR() {
        ...
        int i8 = iArr[4];
        int i9 = (i6 >>> 3) | (i8 << 13);
        return (((i8 << 2) | (i6 >>> 14)) ^ ((((i ^ i3) ^ i5) ^ i7) ^ i9)) & j6f.COLOR_SPACE_UNCALIBRATED;
    }
    ...
    private int getOutputNFSR() {
        ...
        int i20 = i15 & i14;
        int i21 = i10 & i8 & i7;
        return (((((((((i17 & i12) & i8) & i3) ^ ((i19 ^ (i20 & i12)) ^ i21)) ^ ((i20 & i11) & i10)) ^ ((i18 & i7) & i5)) ^ (((i18 & i14) & i12) & i11)) ^ ((i21 & i5) & i3)) ^ (((((i14 & i12) & i11) & i10) & i8) & i7)) & j6f.COLOR_SPACE_UNCALIBRATED;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            int i3 = i2 + 1;
            iArr[i] = ((bArr3[i2] & 255) | (bArr3[i3] << 8)) & j6f.COLOR_SPACE_UNCALIBRATED;
            int[] iArr2 = this.lfsr;
            byte[] bArr4 = this.workingIV;
            iArr2[i] = ((bArr4[i2] & 255) | (bArr4[i3] << 8)) & j6f.COLOR_SPACE_UNCALIBRATED;
            i2 += 2;
            i++;
        }
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ig3.m135964a("Grain v1 Init parameters must include an IV");
            return;
        }
        ParametersWithIV parametersWithIV = (ParametersWithIV) cipherParameters;
        byte[] iv = parametersWithIV.getIV();
        if (iv == null || iv.length != 8) {
            ig3.m135964a("Grain v1 requires exactly 8 bytes of IV");
            return;
        }
        if (!(parametersWithIV.getParameters() instanceof KeyParameter)) {
            ig3.m135964a("Grain v1 Init parameters must include a key");
            return;
        }
