...
public class RC4Engine implements StreamCipher {
    ...
    private int f206562x = 0;

    /* JADX INFO: renamed from: y */
    private int f206563y = 0;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            ig3.m135964a("invalid parameter passed to RC4 init - ".concat(cipherParameters.getClass().getName()));
            return;
        }
    ...
    public int processBytes(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            int i5 = (this.f206562x + 1) & 255;
            this.f206562x = i5;
            byte[] bArr3 = this.engineState;
            byte b = bArr3[i5];
            int i6 = (this.f206563y + b) & 255;
            this.f206563y = i6;
            bArr3[i5] = bArr3[i6];
            bArr3[i6] = b;
    ...
    public byte returnByte(byte b) {
        int i = (this.f206562x + 1) & 255;
        this.f206562x = i;
        byte[] bArr = this.engineState;
        byte b2 = bArr[i];
        int i2 = (this.f206563y + b2) & 255;
        this.f206563y = i2;
        bArr[i] = bArr[i2];
        bArr[i2] = b2;
