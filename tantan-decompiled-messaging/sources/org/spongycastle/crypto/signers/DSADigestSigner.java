...
public class DSADigestSigner implements Signer {
    ...
    public byte[] generateSignature() {
        if (!this.forSigning) {
            qkq0.m175383a("DSADigestSigner not initialised for signature generation.");
            return null;
        }
        ...
        try {
            ...
            qkq0.m175383a("unable to encode signature");
            return null;
        }
    }
    ...
    public boolean verifySignature(byte[] bArr) {
        if (this.forSigning) {
            qkq0.m175383a("DSADigestSigner not initialised for verification");
            return false;
        }
