...
public class CCMBlockCipher implements AEADBlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            if (!(cipherParameters instanceof ParametersWithIV)) {
                ig3.m135964a("invalid parameters passed to CCM: ".concat(cipherParameters.getClass().getName()));
                return;
            }
        ...
        if (bArr == null || bArr.length < 7 || bArr.length > 13) {
            ig3.m135964a("nonce must have length from 7 to 13 octets");
        } else {
            reset();
        }
    }
    ...
    public int processPacket(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, InvalidCipherTextException, DataLengthException {
        ...
        if (this.keyParam == null) {
            qkq0.m175383a("CCM cipher unitialized.");
            return 0;
        }
        ...
        int i5 = 15 - length;
        if (i5 < 4 && i2 >= (1 << (i5 * 8))) {
            qkq0.m175383a("CCM packet too large for choice of q.");
            return 0;
        }
        ...
        if (!z) {
            ...
            dql.m113082a("mac check in CCM failed");
            return 0;
        }
        int i14 = i6 + i2;
