...
public class PGPCFBBlockCipher implements BlockCipher {
    ...
    private byte[] f206670FR;
    private byte[] FRE;

    /* JADX INFO: renamed from: IV */
    private byte[] f206671IV;
    ...
    public PGPCFBBlockCipher(BlockCipher blockCipher, boolean z) {
        ...
        this.f206671IV = new byte[blockSize];
        this.f206670FR = new byte[blockSize];
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        this.cipher.processBlock(this.f206670FR, 0, this.FRE, 0);
    ...
    private int decryptBlockWithIV(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i5 != i4) {
            if (i5 >= i4 + 2) {
                ...
                System.arraycopy(this.tmp, 0, this.f206670FR, this.blockSize - 2, 2);
                this.cipher.processBlock(this.f206670FR, 0, this.FRE, 0);
                int i7 = 0;
                while (true) {
                    i3 = this.blockSize;
                ...
                System.arraycopy(bArr3, 2, this.f206670FR, 0, i3 - 2);
            }
            return this.blockSize;
        }
        System.arraycopy(bArr, i, this.tmp, 0, i4);
        byte[] bArr4 = this.f206670FR;
        System.arraycopy(bArr4, 2, bArr4, 0, this.blockSize - 2);
        byte[] bArr5 = this.f206670FR;
        ...
        while (true) {
            ...
            byte[] bArr7 = this.tmp;
            if (i10 >= i12) {
                System.arraycopy(bArr7, 2, this.f206670FR, 0, i11 - 2);
                this.count += 2;
    ...
    private int encryptBlockWithIV(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i6 != 0) {
            if (i6 >= i5 + 2) {
                ...
                System.arraycopy(bArr2, i2, this.f206670FR, 0, i3);
            }
            return this.blockSize;
        }
        ...
        while (true) {
            ...
            bArr2[i2 + i8] = encryptByte(this.f206671IV[i8], i8);
            i8++;
        }
        System.arraycopy(bArr2, i2, this.f206670FR, 0, i4);
        this.cipher.processBlock(this.f206670FR, 0, this.FRE, 0);
        int i9 = this.blockSize;
        bArr2[i2 + i9] = encryptByte(this.f206671IV[i9 - 2], 0);
        int i10 = this.blockSize;
        bArr2[i2 + i10 + 1] = encryptByte(this.f206671IV[i10 - 1], 1);
        System.arraycopy(bArr2, i2 + 2, this.f206670FR, 0, this.blockSize);
        this.cipher.processBlock(this.f206670FR, 0, this.FRE, 0);
        int i11 = 0;
        while (true) {
            int i12 = this.blockSize;
            if (i11 >= i12) {
                System.arraycopy(bArr2, i2 + i12 + 2, this.f206670FR, 0, i12);
                int i13 = this.count;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        byte[] bArr = this.f206671IV;
        if (length < bArr.length) {
            System.arraycopy(iv, 0, bArr, bArr.length - iv.length, iv.length);
            int i = 0;
            while (true) {
                byte[] bArr2 = this.f206671IV;
