...
public class Tables8kGCMMultiplier implements GCMMultiplier {
    ...
    private byte[] f206678H;

    /* JADX INFO: renamed from: M */
    private int[][][] f206679M;

    @Override // org.spongycastle.crypto.modes.gcm.GCMMultiplier
    public void init(byte[] bArr) {
        int[][][] iArr;
        int i = 0;
        if (this.f206679M == null) {
            this.f206679M = (int[][][]) Array.newInstance((Class<?>) Integer.TYPE, 32, 16, 4);
        } else if (Arrays.areEqual(this.f206678H, bArr)) {
            return;
        }
        this.f206678H = Arrays.clone(bArr);
        GCMUtil.asInts(bArr, this.f206679M[1][8]);
        int i2 = 4;
        while (true) {
            iArr = this.f206679M;
            if (i2 < 1) {
