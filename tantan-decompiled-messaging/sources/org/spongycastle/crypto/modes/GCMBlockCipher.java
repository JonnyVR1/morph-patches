...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    private byte[] f206658H;

    /* JADX INFO: renamed from: J0 */
    private byte[] f206659J0;

    /* JADX INFO: renamed from: S */
    private byte[] f206660S;
    private byte[] S_at;
    ...
    public GCMBlockCipher(BlockCipher blockCipher, GCMMultiplier gCMMultiplier) {
        if (blockCipher.getBlockSize() != 16) {
            ig3.m135964a("cipher required with a block size of 16.");
            throw null;
        }
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f206660S, 0, 16);
        }
    }
    ...
    private void reset(boolean z) {
        ...
        this.atLength = 0L;
        this.atLengthPre = 0L;
        this.counter = Arrays.clone(this.f206659J0);
        this.bufOff = 0;
        this.totalLength = 0L;
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (j2 > gCMBlockCipher.atLengthPre) {
            ...
            if (gCMBlockCipher.exp == null) {
                ...
                tables1kGCMExponentiator.init(gCMBlockCipher.f206658H);
            }
            gCMBlockCipher.exp.exponentiateX(j3, bArr3);
            GCMUtil.multiply(gCMBlockCipher.S_at, bArr3);
            GCMUtil.xor(gCMBlockCipher.f206660S, gCMBlockCipher.S_at);
        }
        byte[] bArr4 = new byte[16];
        Pack.longToBigEndian(gCMBlockCipher.atLength * 8, bArr4, 0);
        Pack.longToBigEndian(gCMBlockCipher.totalLength * 8, bArr4, 8);
        gCMBlockCipher.gHASHBlock(gCMBlockCipher.f206660S, bArr4);
        byte[] bArr5 = new byte[16];
        gCMBlockCipher.cipher.processBlock(gCMBlockCipher.f206659J0, 0, bArr5, 0);
        GCMUtil.xor(bArr5, gCMBlockCipher.f206660S);
        ...
        if (gCMBlockCipher.forEncryption) {
            ...
            if (!Arrays.constantTimeAreEqual(gCMBlockCipher.macBlock, bArr7)) {
                dql.m113082a("mac check in GCM failed");
                return 0;
            }
        }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            if (macSize < 32 || macSize > 128 || macSize % 8 != 0) {
                k250.m144273a("Invalid value for MAC size: ", macSize);
                return;
            } else {
            ...
            if (!(cipherParameters instanceof ParametersWithIV)) {
                ig3.m135964a("invalid parameters passed to GCM");
                return;
            }
        ...
        if (bArr == null || bArr.length < 1) {
            ig3.m135964a("IV must be at least 1 byte");
            return;
        }
        if (key != null) {
            ...
            this.multiplier.init(this.f206658H);
            this.exp = null;
        } else if (this.f206658H == null) {
            ig3.m135964a("Key must be specified in initial init");
            return;
        }
        byte[] bArr3 = new byte[16];
        this.f206659J0 = bArr3;
        ...
        if (bArr4.length == 12) {
            ...
            gHASHBlock(this.f206659J0, bArr5);
        }
        this.f206660S = new byte[16];
        this.S_at = new byte[16];
        this.S_atPre = new byte[16];
