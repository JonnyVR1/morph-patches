...
public class OCBBlockCipher implements AEADBlockCipher {
    ...
    public OCBBlockCipher(BlockCipher blockCipher, BlockCipher blockCipher2) {
        if (blockCipher == null) {
            ig3.m135964a("'hashCipher' cannot be null");
            throw null;
        }
        if (blockCipher.getBlockSize() != 16) {
            ig3.m135964a("'hashCipher' must have a block size of 16");
            throw null;
        }
        if (blockCipher2 == null) {
            ig3.m135964a("'mainCipher' cannot be null");
            throw null;
        }
        if (blockCipher2.getBlockSize() != 16) {
            ig3.m135964a("'mainCipher' must have a block size of 16");
            throw null;
        }
        if (!blockCipher.getAlgorithmName().equals(blockCipher2.getAlgorithmName())) {
            ig3.m135964a("'hashCipher' and 'mainCipher' must be the same algorithm");
            throw null;
        }
    ...
    public static byte[] OCB_double(byte[] bArr) {
        ...
        bArr2[15] = (byte) ((CipherSuite.TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA >>> ((1 - iShiftLeft) << 3)) ^ bArr2[15]);
        return bArr2;
    }
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (this.forEncryption) {
            ...
            dql.m113082a("mac check in OCB failed");
            return 0;
        }
        reset(false);
        return i9;
    ...
    public byte[] getLSub(int i) {
        while (true) {
            int size = this.f206666L.size();
            Vector vector = this.f206666L;
            if (i < size) {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            if (!(cipherParameters instanceof ParametersWithIV)) {
                ig3.m135964a("invalid parameters passed to OCB");
                return;
            }
        ...
        if (iv.length > 15) {
            ig3.m135964a("IV must be no more than 15 bytes");
            return;
        }
        if (key != null) {
