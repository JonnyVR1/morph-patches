...
class LongArray implements Cloneable {
    ...
    public LongArray(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0) {
            ig3.m135964a("invalid F2m field value");
            throw null;
        }
        int i = 1;
    ...
    private static long interleave2_n(long j, int i) {
        while (i > 1) {
            i -= 2;
            j = (interleave4_16to64(((int) (j >>> 48)) & j6f.COLOR_SPACE_UNCALIBRATED) << 3) | (interleave4_16to64(((int) (j >>> 16)) & j6f.COLOR_SPACE_UNCALIBRATED) << 1) | interleave4_16to64(((int) j) & j6f.COLOR_SPACE_UNCALIBRATED) | (interleave4_16to64(((int) (j >>> 32)) & j6f.COLOR_SPACE_UNCALIBRATED) << 2);
        }
        if (i <= 0) {
            return j;
        }
