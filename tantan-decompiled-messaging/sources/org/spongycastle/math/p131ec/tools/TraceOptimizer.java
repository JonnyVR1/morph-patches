...
public class TraceOptimizer {
    ...
    private static final SecureRandom f206868R = new SecureRandom();
    ...
    public static void implPrintNonZeroTraceBits(X9ECParameters x9ECParameters) {
        ...
        for (int i2 = 0; i2 < 1000; i2++) {
            BigInteger bigInteger = new BigInteger(fieldSize, f206868R);
            ...
            if (iCalculateTrace != i3) {
                qkq0.m175383a("Optimized-trace sanity check failed");
                return;
            }
        }
    }
    ...
    public static void printNonZeroTraceBits(X9ECParameters x9ECParameters) {
        if (ECAlgorithms.isF2mCurve(x9ECParameters.getCurve())) {
            ...
            ig3.m135964a("Trace only defined over characteristic-2 fields");
        }
    }
}
