...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElement2 = this.f206786y;
        ECFieldElement eCFieldElementSquare = this.f206787zs[0];
        ...
        ECFieldElement eCFieldElement3 = eCFieldElementSquare;
        ECFieldElement eCFieldElementSquare2 = eCFieldElementAdd.square();
        ECFieldElement eCFieldElementMultiply2 = zIsOne ? eCFieldElementAdd : eCFieldElementAdd.multiply(eCFieldElement3);
        ECFieldElement eCFieldElementSquare3 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, eCFieldElementSquare2, eCFieldElementSquare3.add(eCFieldElementAdd).add(eCFieldElement3).multiply(eCFieldElementSquare3).add(eCFieldElementSquare2), new ECFieldElement[]{eCFieldElementMultiply2}, this.withCompression);
    }
