...
public class SecT193R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementAdd.isZero()) {
                return new SecT193R2Point(curve, eCFieldElementAdd, curve.getB().sqrt(), this.withCompression);
            }
            ...
            if (eCFieldElementMultiply7.isZero()) {
                return new SecT193R2Point(curve, eCFieldElementMultiply7, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT193R2Point(curve, eCFieldElementAdd, eCFieldElement, new ECFieldElement[]{eCFieldElementFromBigInteger}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT193R2Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementAdd, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElementMultiplyPlusProduct.isZero()) {
            return new SecT193R2Point(curve, eCFieldElementMultiplyPlusProduct, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT193R2Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, eCFieldElementAddOne, eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3}, this.withCompression);
    }
