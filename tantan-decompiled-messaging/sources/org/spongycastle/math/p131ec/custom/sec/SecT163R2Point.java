...
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        return new SecT163R2Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, eCFieldElementAddOne, eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3}, this.withCompression);
    }
