...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementAddOne.isZero()) {
                return new SecT233R1Point(curve, eCFieldElementAddOne, curve.getB().sqrt(), this.withCompression);
            }
            ...
            if (eCFieldElementMultiply7.isZero()) {
                return new SecT233R1Point(curve, eCFieldElementMultiply7, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT233R1Point(curve, eCFieldElementAddOne, eCFieldElement, new ECFieldElement[]{eCFieldElementFromBigInteger}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementAdd.isZero()) {
            return new SecT233R1Point(curve, eCFieldElementAdd, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT233R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementAdd, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElementMultiplyPlusProduct.isZero()) {
            return new SecT233R1Point(curve, eCFieldElementMultiplyPlusProduct, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT233R1Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, eCFieldElementAddOne, eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3}, this.withCompression);
    }
