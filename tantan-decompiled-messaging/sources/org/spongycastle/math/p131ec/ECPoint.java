...
public abstract class ECPoint {
    ...
    protected ECFieldElement f206785x;

    /* JADX INFO: renamed from: y */
    protected ECFieldElement f206786y;

    /* JADX INFO: renamed from: zs */
    protected ECFieldElement[] f206787zs;
    ...
    public ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f206785x = eCFieldElement;
        this.f206786y = eCFieldElement2;
        this.f206787zs = eCFieldElementArr;
    }
    ...
    public static ECFieldElement[] getInitialZCoords(ECCurve eCCurve) {
        ...
        if (coordinateSystem != 1 && coordinateSystem != 2) {
            ...
            if (coordinateSystem != 6) {
                ig3.m135964a("unknown coordinate system");
                return null;
            }
        }
    ...
    public void checkNormalized() {
        ...
        qkq0.m175383a("point not in normal form");
    }
    ...
    public final ECFieldElement getRawXCoord() {
        return this.f206785x;
    }

    public final ECFieldElement getRawYCoord() {
        return this.f206786y;
    }

    public final ECFieldElement[] getRawZCoords() {
        return this.f206787zs;
    }
    ...
    public ECFieldElement getZCoord(int i) {
        ...
        ECFieldElement[] eCFieldElementArr = this.f206787zs;
    ...
    public boolean isInfinity() {
        if (this.f206785x == null || this.f206786y == null) {
            return true;
        }
        ECFieldElement[] eCFieldElementArr = this.f206787zs;
    ...
    public boolean isNormalized() {
        ...
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f206787zs[0].isOne();
    }
    ...
    public ECPoint normalize(ECFieldElement eCFieldElement) {
        ...
        if (curveCoordinateSystem != 1) {
            ...
            if (curveCoordinateSystem != 6) {
                qkq0.m175383a("not a projective coordinate system");
                return null;
            }
        }
    ...
    public ECPoint timesPow2(int i) {
        if (i < 0) {
            ig3.m135964a("'e' cannot be negative");
            return null;
        }
        while (true) {
            i--;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f206787zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f206787zs[i]);
        }
        stringBuffer.append(')');
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        @Override // org.spongycastle.math.p131ec.ECPoint
        public boolean satisfiesCurveEquation() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElement = this.f206785x;
            ECFieldElement a = curve.getA();
            ECFieldElement b = curve.getB();
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem != 6) {
                ECFieldElement eCFieldElement2 = this.f206786y;
                ...
                if (coordinateSystem != 0) {
                    ...
                    ECFieldElement eCFieldElement3 = this.f206787zs[0];
            ...
            ECFieldElement eCFieldElement4 = this.f206787zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            boolean zIsZero = eCFieldElement.isZero();
            ECFieldElement eCFieldElement5 = this.f206786y;
            if (zIsZero) {
        ...
        public AbstractF2m tau() {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f206786y.square(), new ECFieldElement[]{this.f206787zs[0].square()}, this.withCompression);
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f206786y.square(), this.withCompression);
        }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i), this.f206786y.squarePow(i), new ECFieldElement[]{this.f206787zs[0].squarePow(i)}, this.withCompression);
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i), this.f206786y.squarePow(i), this.withCompression);
        }
    ...
    public static class C22282Fp extends AbstractFp {
        public C22282Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
            if ((eCFieldElement == null) == (eCFieldElement2 == null)) {
                this.withCompression = z;
            } else {
                ig3.m135964a("Exactly one of the field elements is null");
                throw null;
            }
        }
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply2 = this.f206785x;
            ECFieldElement eCFieldElementMultiply3 = this.f206786y;
            ECFieldElement eCFieldElementMultiply4 = eCPoint.f206785x;
            ECFieldElement eCFieldElementMultiply5 = eCPoint.f206786y;
            if (coordinateSystem == 0) {
                ...
                return new C22282Fp(curve, eCFieldElementSubtract4, eCFieldElementDivide.multiply(eCFieldElementMultiply2.subtract(eCFieldElementSubtract4)).subtract(eCFieldElementMultiply3), this.withCompression);
            }
            char c = 0;
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply6 = this.f206787zs[0];
                ECFieldElement eCFieldElement = eCPoint.f206787zs[0];
                ...
                return new C22282Fp(curve, eCFieldElementSubtract6.multiply(eCFieldElementSubtract7), eCFieldElementMultiply8.subtract(eCFieldElementSubtract7).multiplyMinusProduct(eCFieldElementSubtract5, eCFieldElementMultiply3, eCFieldElementMultiply7), new ECFieldElement[]{eCFieldElementMultiply7.multiply(eCFieldElementMultiply6)}, this.withCompression);
            }
            ...
            ECFieldElement eCFieldElement3 = this.f206787zs[0];
            ECFieldElement eCFieldElement4 = eCPoint.f206787zs[0];
            ...
            return new C22282Fp(curve, eCFieldElementSubtract, eCFieldElementMultiplyMinusProduct, eCFieldElementArr, this.withCompression);
        }
        ...
        public ECPoint detach() {
            return new C22282Fp(null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        public ECPoint negate() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement = this.f206785x;
            return coordinateSystem != 0 ? new C22282Fp(curve, eCFieldElement, this.f206786y.negate(), this.f206787zs, this.withCompression) : new C22282Fp(curve, eCFieldElement, this.f206786y.negate(), this.withCompression);
        }
        ...
        public ECPoint threeTimes() {
            if (!isInfinity()) {
                ECFieldElement eCFieldElement = this.f206786y;
                if (!eCFieldElement.isZero()) {
                    ...
                    ECFieldElement eCFieldElement2 = this.f206785x;
                    ...
                    return new C22282Fp(curve, eCFieldElementAdd2, eCFieldElement2.subtract(eCFieldElementAdd2).multiply(eCFieldElementSubtract2).subtract(eCFieldElement), this.withCompression);
                }
            }
            return this;
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f206786y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement a = curve.getA();
            ECFieldElement eCFieldElementMultiply = this.f206785x;
            ECFieldElement[] eCFieldElementArr = this.f206787zs;
            int i2 = 0;
            ...
            if (coordinateSystem == 0) {
                ...
                return new C22282Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementSquare2), eCFieldElement.multiply(eCFieldElementSquare2.multiply(eCFieldElementInvert)), this.withCompression);
            }
            if (coordinateSystem == 1) {
                return new C22282Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementFromBigInteger), eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger.multiply(eCFieldElementFromBigInteger.square())}, this.withCompression);
            }
            if (coordinateSystem == 2) {
                return new C22282Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger}, this.withCompression);
            }
            if (coordinateSystem == 4) {
                return new C22282Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a}, this.withCompression);
            }
            qkq0.m175383a("unsupported coordinate system");
            return eCPoint3;
        }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                return new C22282Fp(curve, eCFieldElementSubtract2, eCFieldElementDivide.multiply(eCFieldElement2.subtract(eCFieldElementSubtract2)).subtract(eCFieldElement), this.withCompression);
            }
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement3 = this.f206787zs[0];
                ...
                return new C22282Fp(curve, eCFieldElementMultiply2, eCFieldElementFour2.subtract(eCFieldElementSubtract3).multiply(eCFieldElementAdd).subtract(two(eCFieldElementTwo2.square())), new ECFieldElement[]{two(zIsOne ? two(eCFieldElementTwo2) : eCFieldElementTwo.square()).multiply(eCFieldElementMultiply)}, this.withCompression);
            }
            if (coordinateSystem != 2) {
                if (coordinateSystem == 4) {
            ...
            return new C22282Fp(curve, eCFieldElementSubtract4, eCFieldElementSubtract5, new ECFieldElement[]{eCFieldElementTwo3}, this.withCompression);
        }

        public C22282Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f206785x;
            ECFieldElement eCFieldElement2 = this.f206786y;
            ECFieldElement eCFieldElement3 = this.f206787zs[0];
            ...
            return new C22282Fp(getCurve(), eCFieldElementSubtract, eCFieldElementSubtract2, new ECFieldElement[]{eCFieldElementTwo, eCFieldElementTwo4}, this.withCompression);
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f206785x;
            ECFieldElement eCFieldElement3 = eCPoint.f206785x;
            ECFieldElement eCFieldElement4 = eCPoint.f206786y;
            ...
            return new C22282Fp(curve, eCFieldElementAdd, eCFieldElement2.subtract(eCFieldElementAdd).multiply(eCFieldElementSubtract4).subtract(eCFieldElement), this.withCompression);
        }
        ...
        public C22282Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            this(eCCurve, eCFieldElement, eCFieldElement2, false);
        }

        public C22282Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
            this.withCompression = z;
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        public F2m(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z) {
            ...
            if (eCFieldElement != null) {
                ECFieldElement.F2m.checkFieldElements(this.f206785x, this.f206786y);
                if (eCCurve != null) {
                    ECFieldElement.F2m.checkFieldElements(this.f206785x, this.curve.getA());
                }
            }
            this.withCompression = z;
        }
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply4 = this.f206785x;
            ECFieldElement eCFieldElement2 = eCPoint.f206785x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement3 = this.f206786y;
                ECFieldElement eCFieldElement4 = eCPoint.f206786y;
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement5 = this.f206786y;
                ECFieldElement eCFieldElementMultiply5 = this.f206787zs[0];
                ECFieldElement eCFieldElement6 = eCPoint.f206786y;
                ECFieldElement eCFieldElement7 = eCPoint.f206787zs[0];
            ...
            ECFieldElement eCFieldElement8 = this.f206786y;
            ECFieldElement eCFieldElement9 = this.f206787zs[0];
            ECFieldElement eCFieldElement10 = eCPoint.f206786y;
            ECFieldElement eCFieldElement11 = eCPoint.f206787zs[0];
        ...
        public ECPoint negate() {
            if (!isInfinity()) {
                ...
                if (!eCFieldElement.isZero()) {
                    int curveCoordinateSystem = getCurveCoordinateSystem();
                    if (curveCoordinateSystem == 0) {
                        return new F2m(this.curve, eCFieldElement, this.f206786y.add(eCFieldElement), this.withCompression);
                    }
                    if (curveCoordinateSystem == 1) {
                        return new F2m(this.curve, eCFieldElement, this.f206786y.add(eCFieldElement), new ECFieldElement[]{this.f206787zs[0]}, this.withCompression);
                    }
                    if (curveCoordinateSystem == 5) {
                        return new F2m(this.curve, eCFieldElement, this.f206786y.addOne(), this.withCompression);
                    }
                    if (curveCoordinateSystem != 6) {
                        qkq0.m175383a("unsupported coordinate system");
                        return null;
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f206786y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f206786y;
                ECFieldElement eCFieldElement = this.f206787zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f206785x;
            ECFieldElement eCFieldElement3 = eCPoint.f206787zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f206786y;
            ECFieldElement eCFieldElement5 = this.f206787zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f206786y;
            ECFieldElement eCFieldElementSquare = eCFieldElement.square();
