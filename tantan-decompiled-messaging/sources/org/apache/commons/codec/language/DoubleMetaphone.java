...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", "B", "H", "F", j6f.GPS_MEASUREMENT_INTERRUPTED, "W", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR};
    private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = {"ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER"};
    private static final String[] L_T_K_S_N_M_B_Z = {"L", j6f.GPS_DIRECTION_TRUE, "K", j6f.LATITUDE_SOUTH, "N", "M", "B", "Z"};
    ...
    private boolean conditionCH1(String str, int i) {
        if (!contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH") && !contains(str, i - 2, 6, "ORCHES", "ARCHIT", "ORCHID")) {
            int i2 = i + 2;
            if (!contains(str, i2, 1, j6f.GPS_DIRECTION_TRUE, j6f.LATITUDE_SOUTH) && ((!contains(str, i - 1, 1, "A", BloodType.f38728O, "U", "E") && i != 0) || (!contains(str, i2, 1, L_R_N_M_B_H_F_V_W_SPACE) && i + 1 != str.length() - 1))) {
                return false;
            }
        }
        return true;
    ...
    private boolean conditionL0(String str, int i) {
        ...
        return (contains(str2, str2.length() - 2, 2, "AS", "OS") || contains(str2, str2.length() - 1, 1, "A", BloodType.f38728O)) && contains(str2, i - 1, 4, "ALLE");
    }
    ...
    private int handleC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        return (!contains(str, i2, 1, b2s.C_ZONE, "K", "Q") || contains(str, i2, 2, "CE", "CI")) ? i2 : i + 2;
    }
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if ((i <= 2 || !contains(str2, i - 3, 1, "B", "H", "D")) && (i <= 3 || !contains(str2, i - 4, 1, "B", "H"))) {
            if (i > 2 && charAt(str2, i - 1) == 'U' && contains(str2, i - 3, 1, b2s.C_ZONE, "G", "L", "R", j6f.GPS_DIRECTION_TRUE)) {
    ...
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i != 0 || contains(str, i, 4, "JOSE")) {
            ...
            if (isVowel(charAt(str, i2)) && !z) {
                ...
                doubleMetaphoneResult.append('J', ' ');
            } else if (!contains(str, i + 1, 1, L_T_K_S_N_M_B_Z) && !contains(str, i2, 1, j6f.LATITUDE_SOUTH, "K", "L")) {
                doubleMetaphoneResult.append('J');
            }
        } else {
    ...
    private int handleS(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i != 0 || !contains(str, i + 1, 1, "M", "N", "L", "W")) {
            ...
            if (!contains(str, i2, 1, "Z")) {
                ...
                return contains(str, i2, 1, j6f.LATITUDE_SOUTH, "Z") ? i + 2 : i2;
            }
        }
        doubleMetaphoneResult.append('S', 'X');
        int i3 = i + 1;
    ...
    private int handleT(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (!contains(str, i, 2, "TH") && !contains(str, i, 3, "TTH")) {
            doubleMetaphoneResult.append('T');
            int i2 = i + 1;
            return contains(str, i2, 1, j6f.GPS_DIRECTION_TRUE, "D") ? i + 2 : i2;
        }
        int i3 = i + 2;
    ...
    private int handleX(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        int i2 = i + 1;
        return contains(str, i2, 1, b2s.C_ZONE, "X") ? i + 2 : i2;
    }
    ...
    private int handleZ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (contains(str, i2, 2, "ZO", "ZI", "ZA") || (z && i > 0 && charAt(str, i - 1) != 'T')) {
            doubleMetaphoneResult.append(j6f.LATITUDE_SOUTH, "TS");
        } else {
            doubleMetaphoneResult.append('S');
        }
