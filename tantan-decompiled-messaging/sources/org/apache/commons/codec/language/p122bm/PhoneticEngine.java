...
public class PhoneticEngine {
    ...
    public static /* synthetic */ class C218472 {
    ...
    public static final class RulesApplication {
        ...
        public RulesApplication invoke() {
            ...
            while (true) {
                ...
                if (next.patternAndContextMatches(this.input, this.f205860i)) {
    ...
    public PhoneticEngine(NameType nameType, RuleType ruleType, boolean z) {
        ...
        if (ruleType == ruleType2) {
            qhg0.m174539a("ruleType must not be ", ruleType2);
            throw null;
        }
    ...
    private PhonemeBuilder applyFinalRules(PhonemeBuilder phonemeBuilder, List<Rule> list) {
        if (list == null) {
            jfd0.m141176a("finalRules can not be null");
            return null;
        }
        if (list.isEmpty()) {
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        int i2 = C218472.$SwitchMap$org$apache$commons$codec$language$bm$NameType[this.nameType.ordinal()];
        if (i2 == 1) {
            ...
            if (i2 != 3) {
                j850.m140190a("Unreachable case: ", this.nameType);
                return null;
            }
            arrayList.addAll(listAsList);
        }
