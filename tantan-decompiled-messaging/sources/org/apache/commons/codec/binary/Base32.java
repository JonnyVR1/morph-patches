...
public class Base32 extends BaseNCodec {
    ...
    public Base32(int i, byte[] bArr, boolean z) {
        ...
        if (i <= 0) {
            ...
            if (bArr == null) {
                ctq0.m108694a("lineLength ", i, " > 0, but lineSeparator is null");
                throw null;
            }
            if (containsAlphabetOrPad(bArr)) {
                qtc0.m176411a("lineSeparator must not contain Base32 characters: [", StringUtils.newStringUtf8(bArr), Constants.AES_SUFFIX);
                throw null;
            }
