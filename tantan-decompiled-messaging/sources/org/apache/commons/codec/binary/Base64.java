...
public class Base64 extends BaseNCodec {
    ...
    public Base64(int i, byte[] bArr, boolean z) {
        ...
        if (bArr == null) {
            ...
            if (containsAlphabetOrPad(bArr)) {
                qtc0.m176411a("lineSeparator must not contain base64 characters: [", StringUtils.newStringUtf8(bArr), Constants.AES_SUFFIX);
                throw null;
            }
            if (i > 0) {
    ...
    public static byte[] encodeInteger(BigInteger bigInteger) {
        ...
        jfd0.m141176a("encodeInteger called with null parameter");
        return null;
    }
