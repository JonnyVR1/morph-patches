...
public class ZipFile implements Closeable {
    ...
    public static /* synthetic */ class C218693 {

        /* JADX INFO: renamed from: $SwitchMap$org$apache$commons$sudcompress$archivers$zip$ZipMethod */
        static final /* synthetic */ int[] f205872x101d57ac;

        static {
            int[] iArr = new int[ZipMethod.values().length];
            f205872x101d57ac = iArr;
            try {
                iArr[ZipMethod.STORED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f205872x101d57ac[ZipMethod.UNSHRINKING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f205872x101d57ac[ZipMethod.IMPLODING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f205872x101d57ac[ZipMethod.DEFLATED.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f205872x101d57ac[ZipMethod.BZIP2.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f205872x101d57ac[ZipMethod.ENHANCED_DEFLATED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f205872x101d57ac[ZipMethod.AES_ENCRYPTED.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f205872x101d57ac[ZipMethod.EXPANDING_LEVEL_1.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f205872x101d57ac[ZipMethod.EXPANDING_LEVEL_2.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f205872x101d57ac[ZipMethod.EXPANDING_LEVEL_3.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f205872x101d57ac[ZipMethod.EXPANDING_LEVEL_4.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f205872x101d57ac[ZipMethod.JPEG.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f205872x101d57ac[ZipMethod.LZMA.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f205872x101d57ac[ZipMethod.PKWARE_IMPLODING.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f205872x101d57ac[ZipMethod.PPMD.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f205872x101d57ac[ZipMethod.TOKENIZATION.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f205872x101d57ac[ZipMethod.UNKNOWN.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f205872x101d57ac[ZipMethod.WAVPACK.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f205872x101d57ac[ZipMethod.XZ.ordinal()] = 19;
    ...
    public static class StoredStatisticsStream extends wqg0 {
    ...
    private Map<ZipArchiveEntry, NameAndComment> populateFromCentralDirectory() throws IOException {
        ...
        p6g0.m167666d(this.archive, this.wordBbuf);
        long value = ZipLong.getValue(this.wordBuf);
        if (value != CFH_SIG && startsWithLocalFileHeader()) {
            rhg0.m179353a("Central directory is empty, can't expand corrupt archive.");
            return null;
        }
        while (value == CFH_SIG) {
    ...
    private void positionAtCentralDirectory32() throws IOException {
        ...
        p6g0.m167666d(this.archive, this.shortBbuf);
    ...
    private void positionAtCentralDirectory64() throws IOException {
        if (this.isSplitZipArchive) {
            ...
            p6g0.m167666d(this.archive, this.dwordBbuf);
    ...
    private void readCentralDirectoryEntry(Map<ZipArchiveEntry, NameAndComment> map) throws IOException {
        this.cfhBbuf.rewind();
        p6g0.m167666d(this.archive, this.cfhBbuf);
        ...
        p6g0.m167666d(this.archive, ByteBuffer.wrap(bArr));
        ...
        p6g0.m167666d(this.archive, ByteBuffer.wrap(bArr2));
        entry.setCentralDirectoryExtra(bArr2);
        setSizesAndOffsetFromZip64Extra(entry);
        byte[] bArr3 = new byte[value4];
        p6g0.m167666d(this.archive, ByteBuffer.wrap(bArr3));
    ...
    public InputStream getInputStream(ZipArchiveEntry zipArchiveEntry) throws UnsupportedZipFeatureException {
        ...
        switch (C218693.f205872x101d57ac[ZipMethod.getMethodByCode(zipArchiveEntry.getMethod()).ordinal()]) {
            case 1:
            ...
            case 5:
                return new lig0(bufferedInputStream);
            case 6:
                return new abg0(bufferedInputStream);
            default:
