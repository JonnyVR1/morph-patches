...
public abstract class StreamCompressor implements Closeable {
    ...
    public static final class OutputStreamCompressor extends StreamCompressor {
        ...
        private final OutputStream f205865os;

        public OutputStreamCompressor(Deflater deflater, OutputStream outputStream) {
            super(deflater);
            this.f205865os = outputStream;
        }

        @Override // org.apache.commons.sudcompress.archivers.zip.StreamCompressor
        public final void writeOut(byte[] bArr, int i, int i2) throws IOException {
            this.f205865os.write(bArr, i, i2);
        }
    }
    ...
    public static final class ScatterGatherBackingStoreCompressor extends StreamCompressor {
        ...
        private final kfg0 f205866bs;

        public ScatterGatherBackingStoreCompressor(Deflater deflater, kfg0 kfg0Var) {
            super(deflater);
            this.f205866bs = kfg0Var;
        }

        @Override // org.apache.commons.sudcompress.archivers.zip.StreamCompressor
        public final void writeOut(byte[] bArr, int i, int i2) throws IOException {
            ((ibg0) this.f205866bs).f112365b.write(bArr, i, i2);
        }
    }
    ...
    public static StreamCompressor create(int i, kfg0 kfg0Var) {
        return new ScatterGatherBackingStoreCompressor(new Deflater(i, true), kfg0Var);
    }
    ...
    public static StreamCompressor create(kfg0 kfg0Var) {
        return create(-1, kfg0Var);
    }
