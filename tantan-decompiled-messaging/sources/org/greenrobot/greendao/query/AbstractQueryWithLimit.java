...
abstract class AbstractQueryWithLimit<T> extends AbstractQuery<T> {
    ...
    public void setLimit(int i) {
        ...
        if (i2 != -1) {
            ...
            qkq0.m175383a("Limit must be set with QueryBuilder before it can be used here");
        }
    }
    ...
    public void setOffset(int i) {
        ...
        if (i2 != -1) {
            ...
            qkq0.m175383a("Offset must be set with QueryBuilder before it can be used here");
        }
    }
    ...
    public AbstractQueryWithLimit<T> setParameter(int i, Object obj) {
        ...
        k250.m144273a("Illegal parameter index: ", i);
        return null;
    }
