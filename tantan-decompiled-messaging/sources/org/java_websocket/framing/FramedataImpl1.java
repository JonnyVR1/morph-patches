...
public abstract class FramedataImpl1 implements Framedata {
    ...
    public static /* synthetic */ class C220851 {
    ...
    public static FramedataImpl1 get(Framedata.Opcode opcode) {
        if (opcode == null) {
            ig3.m135964a("Supplied opcode cannot be null");
            return null;
        }
        switch (C220851.$SwitchMap$org$java_websocket$framing$Framedata$Opcode[opcode.ordinal()]) {
            case 1:
