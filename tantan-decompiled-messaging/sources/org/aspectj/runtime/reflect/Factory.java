...
public final class Factory {
    ...
    static {
        ...
        prims.put(Constants.BOOLEAN, Boolean.TYPE);
        prims.put(Constants.BYTE, Byte.TYPE);
        prims.put(Constants.CHAR, Character.TYPE);
        prims.put(Constants.SHORT, Short.TYPE);
        prims.put(Constants.INT, Integer.TYPE);
        prims.put(Constants.LONG, Long.TYPE);
        prims.put(Constants.FLOAT, Float.TYPE);
        prims.put(Constants.DOUBLE, Double.TYPE);
    ...
    public static JoinPoint.StaticPart makeEncSJP(Member member) {
        ...
        if (member instanceof Method) {
            ...
            if (!(member instanceof Constructor)) {
                ig3.m135964a("member must be either a method or constructor");
                return null;
            }
