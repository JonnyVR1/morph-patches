...
public class AdviceImpl implements Advice {
    ...
    public static /* synthetic */ class C218711 {
    ...
    public String toString() {
        ...
        int i = C218711.$SwitchMap$org$aspectj$lang$reflect$AdviceKind[getKind().ordinal()];
        if (i == 1 || i == 2 || i == 3) {
        ...
        stringBuffer.append(") ");
        int i4 = C218711.$SwitchMap$org$aspectj$lang$reflect$AdviceKind[getKind().ordinal()];
        if (i4 != 2) {
            if (i4 == 3) {
            }
