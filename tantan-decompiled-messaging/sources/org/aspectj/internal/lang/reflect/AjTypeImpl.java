...
public class AjTypeImpl<T> implements AjType<T> {
    ...
    public Advice getAdvice(String str) throws NoSuchAdviceException {
        if (str.equals("")) {
            ig3.m135964a("use getAdvice(AdviceType...) instead for un-named advice");
            return null;
        }
        if (this.advice == null) {
            initAdvice();
            ...
            while (i < length) {
                ...
                if (method.isAnnotationPresent(ajcITD.class) && method.getName().contains("ajc$interFieldInit")) {
                    ...
                    try {
                        ...
                        j850.m140190a("Can't find field get dispatch method for ", method.getName());
                        return null;
                    }
                } else {
                    ajTypeImpl2 = this;
    ...
    public PerClause getPerClause() {
        if (isAspect()) {
            ...
            qkq0.m175383a("Per-clause not recognized: ".concat(strValue));
        }
        return null;
    }
