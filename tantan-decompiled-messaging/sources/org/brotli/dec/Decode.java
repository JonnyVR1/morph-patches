...
final class Decode {
    ...
    private static void copyUncompressedData(State state) {
        BitReader bitReader = state.f205882br;
        ...
        while (i2 < i) {
            ...
            if (symbol == 0) {
                ...
                for (int bits2 = (1 << symbol) + BitReader.readBits(bitReader, symbol); bits2 != 0; bits2--) {
                    if (i2 >= i) {
                        C21876a.m221094a("Corrupted context map");
                        return 0;
                    }
                    bArr[i2] = 0;
                    i2++;
        ...
        if (!z || BitReader.readBits(bitReader, 1) == 0) {
            ...
            if (bits == 7) {
                ...
                if (BitReader.readBits(bitReader, 1) != 0) {
                    C21876a.m221094a("Corrupted reserved bit");
                    return;
                }
                ...
                for (int i = 0; i < bits2; i++) {
                    ...
                    if (bits3 == 0 && i + 1 == bits2 && bits2 > 1) {
                        C21876a.m221094a("Exuberant nibble");
                        return;
                    }
    ...
    public static void decompress(State state) {
        ...
        if (i19 == 0) {
            qkq0.m175383a("Can't decompress until initialized");
            return;
        }
        if (i19 == 11) {
            qkq0.m175383a("Can't decompress after close");
            return;
        }
        BitReader bitReader = state.f205882br;
        int i20 = 1;
            ...
            if (i22 == 10) {
                ...
                if (i22 == 10) {
                    if (state.metaBlockLength < 0) {
                        C21876a.m221094a("Invalid metablock length");
                        return;
                    } else {
                        BitReader.jumpToByteBoundary(bitReader);
                        BitReader.checkHealth(state.f205882br, z);
                        return;
                    }
                }
                return;
                    ...
                    case 2:
                        ...
                        if (state.metaBlockLength <= 0) {
                            ...
                            if (state.trivialLiteralContext) {
                                while (state.f205883j < state.insertLength) {
                                    BitReader.readMoreInput(bitReader);
                                ...
                                while (true) {
                                    c = c2;
                                    if (state.f205883j < state.insertLength) {
                                        BitReader.readMoreInput(bitReader);
                                        if (state.blockLength[0] == 0) {
                                            decodeLiteralBlockSwitch(state);
                                        }
                            ...
                            if (state.runningState != 6) {
                                ...
                                if (i5 <= 0) {
                                    ...
                                    if (iTranslateShortCodes < 0) {
                                        C21876a.m221094a("Negative distance");
                                        return;
                                    }
                                    ...
                                    if (iTranslateShortCodes > state.maxDistance) {
                                        ...
                                        if (state.copyLength > state.metaBlockLength) {
                                            C21876a.m221094a("Invalid backward reference");
                                            return;
                                        }
                                        state.f205883j = 0;
                                        ...
                                        i15 = state.copyLength - state.f205883j;
    ...
    public static void readHuffmanCode(int i, int[] iArr, int i2, BitReader bitReader) {
        ...
        if (bits == 1) {
            ...
            if (z2) {
                ...
                C21876a.m221094a("Can't readHuffmanCode");
            }
        }
        ...
        while (bits < 18 && i16 > 0) {
            ...
            int i20 = i19 & j6f.COLOR_SPACE_UNCALIBRATED;
            iArr4[i17] = i20;
            if (i20 != 0) {
                i16 -= 32 >> i20;
                i15++;
    ...
    private static void readHuffmanCodeLengths(int[] iArr, int i, int[] iArr2, BitReader bitReader) {
        ...
        while (i4 < i && i3 > 0) {
            ...
            int i9 = i8 & j6f.COLOR_SPACE_UNCALIBRATED;
            if (i9 < 16) {
                i4++;
                iArr2[i4] = i9;
                if (i9 != 0) {
                ...
                int i12 = bits - i6;
                if (i4 + i12 > i) {
                    C21876a.m221094a("symbol + repeatDelta > numSymbols");
                    return;
                }
                int i13 = 0;
                while (i13 < i12) {
    ...
    private static int readSymbol(int[] iArr, int i, BitReader bitReader) {
        ...
        int i5 = iArr[i4];
        int i6 = i5 >> 16;
        int i7 = i5 & j6f.COLOR_SPACE_UNCALIBRATED;
        if (i6 <= 8) {
        ...
        return i8 & j6f.COLOR_SPACE_UNCALIBRATED;
    }
