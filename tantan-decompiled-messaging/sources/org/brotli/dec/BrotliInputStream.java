...
public class BrotliInputStream extends InputStream {
    ...
    public BrotliInputStream(InputStream inputStream, int i, byte[] bArr) throws IOException {
        ...
        this.state = state;
        if (i <= 0) {
            k250.m144273a("Bad buffer size:", i);
            throw null;
        }
        if (inputStream == null) {
            ig3.m135964a("source is null");
            throw null;
        }
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        if (i < 0) {
            k250.m144273a("Bad offset: ", i);
            return 0;
        }
        if (i2 < 0) {
            k250.m144273a("Bad length: ", i2);
            return 0;
        }
        int i3 = i + i2;
        if (i3 > bArr.length) {
            yfq0.m214580a("Buffer overflow: ", i3, " > ", bArr.length);
            return 0;
        }
        if (i2 == 0) {
            return 0;
