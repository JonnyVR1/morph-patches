...
public class ijkMediaStreamer {
    ...
    public class CmdHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            n8c.m158485c(ijkMediaStreamer.TAG, "----CmdHandler handleMessage what:" + message.what + ";msg.arg1:" + message.arg1 + ";;msg.arg2:" + message.arg2 + ";mPlayStatus:" + ijkMediaStreamer.this.mPlayStatus);
            int i = message.what;
            if (i == 200) {
            ...
            switch (i) {
                ...
                case 103:
                    break;
                default:
                    n8c.m158485c(ijkMediaStreamer.TAG, "Unknown message type " + message.what);
                    break;
            }
        }
    }
    ...
    public class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaStreamer.this.mIjkWriter == null) {
                n8c.m158485c(ijkMediaStreamer.TAG, "ijkMediaStreamer went away with unhandled events");
                return;
            }
            n8c.m158485c(ijkMediaStreamer.TAG, "ijkMediaStreamer handleMessage what:" + message.what + ";msg.arg1:" + message.arg1 + ";;msg.arg2:" + message.arg2 + ";mPlayStatus:" + ijkMediaStreamer.this.mPlayStatus);
            int i = message.what;
            if (i == 200) {
                if (ijkMediaStreamer.this.mOnInfoListener != null) {
                    ijkMediaStreamer.this.mOnInfoListener.m222830a(this.f208869a, message.arg1, message.arg2);
                    return;
                }
                return;
            }
            if (i == 201) {
                n8c.m158485c(ijkMediaStreamer.TAG, "MEDIA_RECORDER_FRAMERATE_INFO");
                if (ijkMediaStreamer.this.streamProduct != null) {
                    ijkMediaStreamer.this.streamProduct.m222696d(message.arg1, message.arg2 == 1);
                    return;
                }
                return;
            }
            if (i == 300) {
                ...
                if (onErrorListener != null) {
                    onErrorListener.m222829a(this.f208869a, message.arg1, message.arg2);
                }
                IjkStreamerLogHelper ijkStreamerLogHelper3 = ijkMediaStreamer.this.mLogHelper;
                if (ijkStreamerLogHelper3 != null) {
                    ijkStreamerLogHelper3.m222362l();
                    ijkMediaStreamer ijkmediastreamer = ijkMediaStreamer.this;
                    ijkmediastreamer.mLogHelper.m222359i(message.arg2, ijkmediastreamer.mOutpath);
                    return;
                }
                return;
            }
            switch (i) {
                case 100:
                    if (ijkMediaStreamer.this.mOnPreparedListener != null && ijkMediaStreamer.this.mPlayStatus == 0) {
                        ijkMediaStreamer.this.mOnPreparedListener.m222831a(this.f208869a);
                    }
                ...
                case 101:
                    if (ijkMediaStreamer.this.mOnRecordStopedListener != null && ijkMediaStreamer.this.mPlayStatus == 1) {
                        ijkMediaStreamer.this.mOnRecordStopedListener.m222832a(this.f208869a);
                    }
                    ijkMediaStreamer.this.mPlayStatus = 0;
                    return;
                case 102:
                    n8c.m158485c(ijkMediaStreamer.TAG, "MEDIA_RECORDER_EVENT_PUBLISHING");
                    if (ijkMediaStreamer.this.mOnInfoListener != null) {
                        ijkMediaStreamer.this.mOnInfoListener.m222830a(this.f208869a, message.what, message.arg1);
                    }
                    ...
                    if (ijkStreamerLogHelper4 != null) {
                        ijkStreamerLogHelper4.m222358h(ijkmediastreamer2.mOutpath);
                        ijkMediaStreamer.this.mLogHelper.m222361k();
                        return;
                    }
                    return;
                case 103:
                    ...
                    switch (i) {
                        ...
                        case 109:
                            if (ijkMediaStreamer.this.mOnRtcStatusListener != null) {
                                ijkMediaStreamer.this.mOnRtcStatusListener.m222833a(this.f208869a, message.obj);
                            }
                            break;
                        default:
                            n8c.m158485c(ijkMediaStreamer.TAG, "Unknown message type " + message.what);
            ...
            if (message.what == 103 && (ijkStreamerLogHelper2 = ijkMediaStreamer.this.mLogHelper) != null) {
                ijkStreamerLogHelper2.m222356f();
            }
            if (message.what != 105 || (ijkStreamerLogHelper = ijkMediaStreamer.this.mLogHelper) == null) {
                return;
            }
            ijkStreamerLogHelper.m222357g();
        }
    }

    public interface OnCameraSetListener {
        /* JADX INFO: renamed from: a */
        void m222828a(Camera camera);
    }

    public interface OnErrorListener {
        /* JADX INFO: renamed from: a */
        void m222829a(ijkMediaStreamer ijkmediastreamer, int i, int i2);
    }
    ...
    public interface OnInfoListener {
        /* JADX INFO: renamed from: a */
        void m222830a(ijkMediaStreamer ijkmediastreamer, int i, int i2);
    }

    public interface OnPreparedListener {
        /* JADX INFO: renamed from: a */
        void m222831a(ijkMediaStreamer ijkmediastreamer);
    }

    public interface OnRecordStopedListener {
        /* JADX INFO: renamed from: a */
        void m222832a(ijkMediaStreamer ijkmediastreamer);
    }

    public interface OnRtcStatusListener {
        /* JADX INFO: renamed from: a */
        void m222833a(ijkMediaStreamer ijkmediastreamer, Object obj);
    }

    public interface OnSurroundMusicStatusListener {
        /* JADX INFO: renamed from: a */
        void m222834a(ijkMediaStreamer ijkmediastreamer, int i, int i2);
    }

    public interface OnVideoPreviewSizeSetListener {
        /* JADX INFO: renamed from: a */
        void m222835a(int i, int i2);
    }

    public interface OnWiredHeadsetStatusListener {
        /* JADX INFO: renamed from: a */
        void m222836a(ijkMediaStreamer ijkmediastreamer, int i, int i2);
    }
    ...
    public interface aidSwitchResolution {
        /* JADX INFO: renamed from: a */
        void m222838a(int i, int i2);
    }

    public interface onRecordScreenErrorListener {
        /* JADX INFO: renamed from: a */
        void m222839a(ijkMediaStreamer ijkmediastreamer, int i, int i2);
    }

    public interface onRecordSuccessListener {
        /* JADX INFO: renamed from: a */
        void m222840a(ijkMediaStreamer ijkmediastreamer);
    }
    ...
    private void initMediaStreamer(IjkLibLoader ijkLibLoader, int i, int i2, String str) {
        g16.m124054a(this.mContext);
        loadLibrariesOnce(ijkLibLoader);
        s7y.m182539h().m182550n(this.mContext);
        ...
        if (this.mFakeSurface == null) {
            ...
            if (this.mVideoQuality != null) {
                n8c.m158485c(TAG, "----initMediaStreamer call getVideoQuality(): " + this.mVideoQuality.resX + Constants.SEPARATOR_COMMA + this.mVideoQuality.resY);
            }
            ...
            if (videoQuality != null) {
                n8c.m158485c(TAG, "----initMediaStreamer call getVideoQuality(): " + videoQuality.resX + Constants.SEPARATOR_COMMA + videoQuality.resY);
            }
            this.mFakeSurface.m222464Y0(videoQuality);
            this.mFakeSurface.m222457U(null);
            if (this.mFakeSurface.m222488s0() != 0) {
                this.mFakeSurface.m222441B0();
                this.mFakeSurface = null;
                n8c.m158483a(TAG, "mFakeSurface creat error use softdec");
            }
        }
        ...
        if (momoSurface != null) {
            momoSurface.m222452P0(streamProducer2);
        }
        if (this.streamProduct != null && this.mFakeSurface != null) {
            ...
            if (i3 == 0) {
                ...
                this.mIjkWriter = new AgoraWriter(this.mContext, this.mFakeSurface.m222483n0(), this.streamProduct, str, this.mOnlyAudio);
            }
            this.streamProduct.m222726q2(this.mIjkWriter);
        }
        ...
        if (streamProducer3 != null) {
            streamProducer3.m222721o2(this.mVenderID);
        }
    }
    ...
    private static void loadLibrariesOnce(IjkLibLoader ijkLibLoader) {
        synchronized (ijkMediaStreamer.class) {
            if (!mIsLibLoaded) {
                ...
                try {
                    rdc0.m178959a(g16.f100119a, "ijkaudioprocess");
                    mIsLibLoaded = true;
                } catch (Error unused3) {
                    mIsLibLoaded = false;
    ...
    private void release_l() {
        ...
        try {
            ...
            if (ijkStreamerLogHelper != null) {
                ijkStreamerLogHelper.m222362l();
                this.mLogHelper.m222359i(0, this.mOutpath);
        ...
        try {
            ...
            if (sourceBase != null) {
                sourceBase.mo222291q();
                this.mIjkSource = null;
            }
            if (this.mIjkWriter != null) {
                n8c.m158485c(TAG, "MediaStreamer.release _stop");
                this.mIjkWriter.release();
                this.mIjkWriter = null;
            }
            n8c.m158485c(TAG, "MediaStreamer.release _stop end");
            deAttachStreamer();
            StreamProducer streamProducer = this.streamProduct;
            if (streamProducer != null) {
                streamProducer.m222645C1(null);
                this.streamProduct.stopSurroundMusic();
                this.streamProduct.release();
                this.streamProduct = null;
            }
            reset();
            n8c.m158485c(TAG, "MediaStreamer.release mFakeSurface.release");
            MomoSurface momoSurface = this.mFakeSurface;
            if (momoSurface != null) {
                momoSurface.m222441B0();
                this.mFakeSurface = null;
            }
            this.mParent = null;
        } catch (Exception e) {
        ...
        n8c.m158485c(TAG, "MediaStreamer.release end");
        this.mCmdHT = null;
        this.mParent = null;
    ...
    public void selectFilter_l(GPUImageFilterTools.FilterType filterType, int i, int i2) {
        ts2 ts2VarM222863a = GPUImageFilterTools.m222863a(this.mContext, filterType, i);
        if (i2 != 1) {
            SourceBase sourceBase = this.mIjkSource;
            if (sourceBase != null) {
                sourceBase.mo222295t(this.mContext, ts2VarM222863a);
                this.mIjkSource.mo222300x(0);
                return;
            }
            return;
        }
        ijf0 ijf0Var = new ijf0(ts2VarM222863a);
        SourceBase sourceBase2 = this.mIjkSource;
        if (sourceBase2 != null) {
            sourceBase2.mo222295t(this.mContext, ijf0Var);
            this.mIjkSource.mo222300x(1);
        }
    }
    ...
    private void startMonitor() {
        ...
        if (handler != null) {
            ...
            this.mMonitorHandler.postDelayed(new Runnable() { // from class: tv.danmaku.ijk.media.streamer.ijkMediaStreamer.3
                ...
                public void run() {
                    n8c.m158485c(ijkMediaStreamer.TAG, "MonitorTask:too long not data receive notify user");
                    ijkMediaStreamer ijkmediastreamer = ijkMediaStreamer.this;
                    OnErrorListener onErrorListener = ijkmediastreamer.mOnErrorListener;
                    if (onErrorListener != null) {
                        onErrorListener.m222829a(ijkmediastreamer, 300, 12);
                    }
                }
            }, 20000L);
        }
    ...
    public void startRecording_l() {
        try {
            ...
            if (sinkBase != null) {
                n8c.m158485c("zjlfound", "----startRecording_l mIjkWriter:".concat(sinkBase.getClass().getSimpleName()));
        ...
        n8c.m158485c("zjlfound", "startRecording_l");
        this.mPlayStatus = 1;
    }
    ...
    public void stopRecording_l() {
        ...
        n8c.m158485c("zjlfound", "stopRecording_l");
    }

    public void EnableExternalAudio(boolean z) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222693c(z);
        }
    }
    ...
    public void addMRtcAudioHandler(MRtcAudioHandler mRtcAudioHandler) {
        ...
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222719o0(mRtcAudioHandler);
        }
    }
    ...
    public void addMediaCodecSurface(Surface surface) {
        MomoSurface momoSurface = this.mFakeSurface;
        if (momoSurface != null) {
            momoSurface.m222465Z(surface);
        }
    }

    public void addSoftListener(ldq0.InterfaceC18199a interfaceC18199a) {
        MomoSurface momoSurface = this.mFakeSurface;
        if (momoSurface != null) {
            momoSurface.m222469c0(interfaceC18199a);
        }
    }
    ...
    public long aidGetCurrentPosition(long j) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222724q0(j);
        }
        return 0L;
    }
    ...
    public long aidGetDuration(long j) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222727r0(j);
        }
        return 0L;
    }
    ...
    public void attachStreamer(int i) {
        ...
        if (i2 != i) {
            if (i2 == 0 || (this.mIjkWriter instanceof IjkWriter)) {
                ...
                if (i == 1) {
                    this.mAttachedWriter = new AgoraWriter(this.mContext, this.mFakeSurface.m222483n0(), this.streamProduct, this.mOnlyAudio);
                }
                this.streamProduct.m222713l2(this.mAttachedWriter);
            }
        }
    }
    ...
    public void attachToSpecStreamer(int i) {
        n8c.m158485c("zjlfound", "----attachToSpecStreamer:" + i + ",mVenderID=" + this.mVenderID);
        int i2 = this.mVenderID;
        if (i2 != i || i2 == 0) {
            this.mVenderID = i;
            if (this.streamProduct != null) {
                n8c.m158485c(TAG, "----attachToSpecStreamer: call stopRecording()");
                this.streamProduct.m222708i2();
            }
            if (this.mIjkWriter != null) {
                n8c.m158485c(TAG, "----attachToSpecStreamer: call mIjkWriter.stopRecording()");
            ...
            if (i == 1) {
                this.mIjkWriter = new AgoraWriter(this.mContext, this.mFakeSurface.m222483n0(), this.streamProduct, this.mOnlyAudio);
            }
            ...
            this.streamProduct.m222726q2(this.mIjkWriter);
            n8c.m158485c("zjlfound", "----attachToSpecStreamer mIjkWriter:" + this.mIjkWriter + ";type=" + i + "; mIjkWriter" + this.mIjkWriter);
            this.mPlayStatus = 0;
            startMonitor();
        }
    }
    ...
    public void deAttachStreamer() {
        this.streamProduct.m222713l2(null);
        SinkBase sinkBase = this.mAttachedWriter;
        if (sinkBase != null) {
            sinkBase.stop();
    ...
    public void focusOnRect(Rect rect, Camera.AutoFocusCallback autoFocusCallback) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222276b(rect, autoFocusCallback);
        }
    }
    ...
    public long getAudioEncoderSizes() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222640A0();
        }
        return 0L;
    }
    ...
    public long getAudioFrameCache() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222642B0();
        }
        return 0L;
    }
    ...
    public long getAudioFrameCapture() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222644C0();
        }
        return 0L;
    }
    ...
    public long getAudioPacketCache() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222646D0();
        }
        return 0L;
    }
    ...
    public long getFirstAuidoPacketTime() {
        ...
        long jM222648E0 = streamProducer.m222648E0() - this.mIjkWriter.getPropertyLong(ijkStreamerUtil.FFS_PROP_INT64_CREAT_TIME, 0L);
        if (jM222648E0 < 0) {
            return 0L;
        }
        return jM222648E0;
    ...
    public long getFirstVideoPacketTime() {
        ...
        long jM222650F0 = streamProducer.m222650F0() - this.mIjkWriter.getPropertyLong(ijkStreamerUtil.FFS_PROP_INT64_CREAT_TIME, 0L);
        if (jM222650F0 < 0) {
            return 0L;
        }
        return jM222650F0;
    ...
    public float getMasterAudioLevel() {
        ...
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222652G0();
        }
        return 0.5f;
    }
    ...
    public int getMediaStatus() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222656I0();
        }
        return 17;
    }
    ...
    public long getPacketCacheDuration() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222660K0();
        }
        return 0L;
    }
    ...
    public float getSlaveAudioLevel() {
        ...
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222664M0();
        }
        return 0.5f;
    }
    ...
    public long getSurroundMusicDuration() {
        ...
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222665N0();
        }
        return 0L;
    }
    ...
    public long getSurroundMusicPos() {
        ...
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222667O0();
        }
        return 0L;
    }
    ...
    public long getVideoEncoderPackets() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222669P0();
        }
        return 0L;
    }
    ...
    public long getVideoEncoderSize() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222671Q0();
        }
        return 0L;
    }
    ...
    public long getVideoFrameCapture() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222675S0();
        }
        return 0L;
    }
    ...
    public int getVideoFreezeCount() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222677T0();
        }
        return 0;
    }
    ...
    public VideoQuality getVideoQuality() {
        ...
        n8c.m158485c(TAG, "----getVideoQuality: " + this.mVideoQuality.resX + Constants.SEPARATOR_COMMA + this.mVideoQuality.resY);
    ...
    public boolean isRecording() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222662L0();
        }
        return false;
    }
    ...
    public boolean isWiredHeadsetOn() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            return streamProducer.m222684X0();
        }
        return false;
    }
    ...
    public boolean loadGestureModel(String str) {
        return n050.m157240b().m157243d(str);
    }
    ...
    public void muteAllRemoteAudioStream(boolean z) {
        n8c.m158485c(TAG, "muteRemoteAudioStream mute" + z);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222686Y0(z);
        }
        SinkBase sinkBase = this.mIjkWriter;
        if (sinkBase != null) {
    ...
    public void muteLocalAudioStreamEx(boolean z) {
        n8c.m158485c(TAG, "muteLocalAudioStreamEx mute" + z);
        SinkBase sinkBase = this.mIjkWriter;
        if (sinkBase != null) {
    ...
    public void muteRemoteAudioStream(long j, boolean z) {
        n8c.m158485c(TAG, "muteRemoteAudioStream uid" + j + ";mute:" + z);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222694c1(j, z);
        }
        SinkBase sinkBase = this.mIjkWriter;
        if (sinkBase != null) {
    ...
    public void openPublishHelp(Activity activity, long j, String str, int i, int i2, SizeChangedCallback sizeChangedCallback, int i3) {
        n8c.m158485c(TAG, "----openPublishHelp 1:" + i3);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222702f1(activity, this, j, str, i, i2, sizeChangedCallback, i3, null);
        }
    }
    ...
    public void qbuffer(byte[] bArr, int i, long j) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222709j1(bArr, i, j);
        }
    }

    public void release() {
        n8c.m158485c(TAG, "MediaStreamer.release");
    ...
    public void selectCamera(Activity activity, int i) {
        ...
        if (onVideoPreviewSizeSetListener != null) {
            cameraSource.mo222264C(onVideoPreviewSizeSetListener);
        }
        int i2 = this.mVideoResolution;
        if (i2 == 3) {
            this.mIjkSource.mo222262B(720, EffectsSDKEffectConstants.FaceSegmentConfig.BEFF_MOBILE_FACE_REST_MASK);
        } else {
            SourceBase sourceBase2 = this.mIjkSource;
            if (i2 == 5) {
                sourceBase2.mo222262B(528, TXEAudioDef.TXE_OPUS_SAMPLE_NUM);
            } else {
                sourceBase2.mo222262B(480, 640);
            }
        }
        this.mIjkSource.mo222268G(this.mVideoResolution);
        if (this.streamProduct != null && this.mFakeSurface != null) {
            n8c.m158485c(TAG, "set select camere");
            this.mCaptureType = 0;
            this.streamProduct.m222729r2(activity, this.mIjkSource);
            this.mFakeSurface.m222448L0(this.mCaptureType);
            this.mIjkSource.mo222293r(activity, i, this.mFakeSurface);
        }
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.notifyResumeRecording();
            n8c.m158485c(TAG, "----selectCamera 1: notifyResumeRecording end");
        }
    }
    ...
    public void selectCameraSize(int i) {
        ...
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            this.mCameraID = sourceBase.mo222289o() ? 1 : 0;
            iMo222280f = this.mIjkSource.mo222280f();
            this.mIjkSource.mo222291q();
            this.mIjkSource = null;
        } else {
            iMo222280f = 1;
        }
        n8c.m158485c(TAG, "----selectCameraSize:level=" + i + ";cameraID=" + this.mCameraID + "; orient=" + iMo222280f);
        CameraSource cameraSource = new CameraSource(this.mParent, this.streamProduct);
        this.mIjkSource = cameraSource;
        cameraSource.mo222297v(iMo222280f);
        OnVideoPreviewSizeSetListener onVideoPreviewSizeSetListener = this.mPreviewSizeSetListener;
        if (onVideoPreviewSizeSetListener != null) {
            this.mIjkSource.mo222264C(onVideoPreviewSizeSetListener);
        }
        int i2 = this.mVideoResolution;
        if (i2 == 3) {
            this.mIjkSource.mo222262B(720, EffectsSDKEffectConstants.FaceSegmentConfig.BEFF_MOBILE_FACE_REST_MASK);
        ...
        if (this.streamProduct != null) {
            n8c.m158485c(TAG, "set select camere");
            this.mCaptureType = 0;
            this.streamProduct.m222729r2(this.mParent, this.mIjkSource);
            this.mFakeSurface.m222448L0(this.mCaptureType);
            this.mIjkSource.mo222293r(this.mParent, this.mCameraID, this.mFakeSurface);
        }
    }
    ...
    public void selectFaceDetectFilter(Context context, ts2 ts2Var) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222294s(this.mContext, ts2Var);
        }
    }
    ...
    public void setAttachedVideoQuality(VideoQuality videoQuality) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222714m1(videoQuality);
        }
    }
    ...
    public void setAudioEncodingBitRate(int i) {
        if (i <= 0) {
            ig3.m135964a("Audio encoding bit rate is not positive");
            return;
        }
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222720o1(i);
        }
        try {
            SinkBase sinkBase = this.mIjkWriter;
            if (sinkBase != null) {
    ...
    public void setAudioSamplingRate(int i) {
        if (i <= 0) {
            ig3.m135964a("Audio sampling rate is not positive");
            return;
        }
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222722p1(i);
        }
        try {
            SinkBase sinkBase = this.mIjkWriter;
            if (sinkBase != null) {
    ...
    public void setCameraSuccess() {
        ...
        if (onCameraSetListener != null) {
            onCameraSetListener.m222828a(getCurCamera());
        }
    }
    ...
    public void setDoFaceDetect(Boolean bool) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222298w(bool.booleanValue());
        }
    }
    ...
    public void setFaceEyeScale(Float f) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222302z(f.floatValue());
        }
    }
    ...
    public void setFaceThinScale(Float f) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222260A(f.floatValue());
        }
    }
    ...
    public void setOnSurroundMusicStatusListener(OnSurroundMusicStatusListener onSurroundMusicStatusListener) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222645C1(onSurroundMusicStatusListener);
        }
        SinkBase sinkBase = this.mIjkWriter;
        if (sinkBase != null) {
    ...
    public void setOnWiredHeadsetStatusListener(OnWiredHeadsetStatusListener onWiredHeadsetStatusListener) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222647D1(onWiredHeadsetStatusListener);
        }
    }
    ...
    public void setPreviewDisplay(SurfaceHolder surfaceHolder) {
        ...
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222716n0(surfaceHolder);
        }
    }
    ...
    public void setPreviewScale(PointF pointF) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222649E1(pointF);
        }
    }
    ...
    public void setPreviewSizeSetListener(OnVideoPreviewSizeSetListener onVideoPreviewSizeSetListener) {
        ...
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222264C(onVideoPreviewSizeSetListener);
        }
    }
    ...
    public void setPreviewSurfaceTexture(SurfaceTexture surfaceTexture) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222716n0(surfaceTexture);
        }
    }
    ...
    public void setPreviewZoom(float f) {
        ...
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222265D(f);
        }
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222651F1(this.mZoom);
        }
    }
    ...
    public void setRenderFrameRate(int i) {
        n8c.m158485c(TAG, "----setRenderFrameRate:" + i);
        MomoSurface momoSurface = this.mFakeSurface;
        if (momoSurface != null) {
            momoSurface.m222453Q0(i);
        }
    }
    ...
    public void setScreenQuality(VideoQuality videoQuality) {
        MomoSurface momoSurface = this.mFakeSurface;
        if (momoSurface != null) {
            momoSurface.m222455S0(videoQuality);
        }
    }
    ...
    public void setStreamPixFmt(long j) {
        ...
        n8c.m158485c(TAG, "setStreamPixFmt:" + j);
    }

    public void setStreamerCaptureType(int i, int i2) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222266E(i, i2);
        }
    }

    public void setStreamerInOutAndType(int i, String str, String str2) {
        n8c.m158485c(TAG, "setStreamerInOutAndType:type:" + i + ";inpath:" + str + ";;outpath:" + str2);
        this.mInpath = str;
        this.mOutpath = str2;
        this.mFileType = i;
        try {
    ...
    public void setVideoChannelListener(z1l0 z1l0Var) {
        ...
        this.streamProduct.m222668O1(z1l0Var);
        SinkBase sinkBase = this.mIjkWriter;
        if (sinkBase != null) {
    ...
    public void setVideoEncodingBitRate(int i) {
        n8c.m158485c(TAG, "----setVideoEncodingBitRate: Rate=" + i);
        if (i <= 0) {
            i = LiveVideoFeedSmallStyleCardView.DISTANCE_DIFFERENT_CITY;
        }
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222670P1(i);
        }
        try {
            SinkBase sinkBase = this.mIjkWriter;
            if (sinkBase != null) {
    ...
    public void setVideoFrameRate(int i) {
        n8c.m158485c(TAG, "----setVideoFrameRate: videoFrameRate=" + i);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222672Q1(i);
        }
        try {
            SinkBase sinkBase = this.mIjkWriter;
            if (sinkBase != null) {
    ...
    public void setWarpType(Integer num) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222269H(num.intValue());
        }
    }
    ...
    public void startCaptureImage(Activity activity, Bitmap bitmap, int i, int i2, int i3) {
        ...
        n8c.m158485c(TAG, "----set select image: " + this.mFakeSurface + Constants.SEPARATOR_COMMA + this.streamProduct);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer == null || this.mFakeSurface == null || (sourceBase = this.mIjkSource) == null) {
            return;
        }
        this.mCaptureType = 2;
        streamProducer.m222729r2(activity, sourceBase);
        this.mFakeSurface.m222448L0(this.mCaptureType);
        this.streamProduct.m222685X1(activity, bitmap, i, i2, i3, 0);
    }
    ...
    public void startCaptureScreen(Activity activity, int i, int i2, MediaProjection mediaProjection, int i3) {
        ...
        n8c.m158485c(TAG, "----set select screen: " + this.mFakeSurface + Constants.SEPARATOR_COMMA + this.streamProduct);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer == null || this.mFakeSurface == null || (sourceBase = this.mIjkSource) == null) {
            return;
        }
        ...
        streamProducer.m222729r2(activity, sourceBase);
        this.mFakeSurface.m222448L0(this.mCaptureType);
        this.streamProduct.m222687Y1(activity, i, i2, mediaProjection, i3);
    }
    ...
    public void startPlaying() {
        ...
        if (ijkStreamerLogHelper != null) {
            ijkStreamerLogHelper.m222361k();
            ijkmediastreamer.mLogHelper.m222358h(ijkmediastreamer.mOutpath);
        }
    }
    ...
    public void startRecording() {
        int i;
        int i2;
        n8c.m158485c("zjlfound", "----startRecording");
    ...
    public void stopPublishHelp(long j) {
        n8c.m158485c(TAG, "----stopPublishHelp");
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222706h2(j);
        }
    }

    public void stopRecording() {
        n8c.m158485c("zjlfound", "stopRecording");
    ...
    public void switchCamera() {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222271N();
            this.mCameraID = this.mIjkSource.mo222289o() ? 1 : 0;
        }
    }
    ...
    public void switchFilterTo(Activity activity, ts2 ts2Var) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222272O(activity.getApplicationContext(), ts2Var);
        }
    }
    ...
    public void switchVideoResolution(int i, int i2) {
        ...
        if (i == 720 || i2 == 1280) {
            if (this.mVideoResolution != 3) {
                n8c.m158485c(TAG, "----switchVideoResolution: 3w:" + i + ",h:" + i2);
                selectCameraSize(3);
            } else {
                z = false;
            }
            ...
            if (this.mVideoResolution != 5) {
                n8c.m158485c(TAG, "----switchVideoResolution: 5w:" + i + ",h:" + i2);
                selectCameraSize(5);
            } else {
                z = false;
            }
        } else if (this.mVideoResolution != 1) {
            n8c.m158485c(TAG, "----switchVideoResolution: 1w:" + i + ",h:" + i2);
            selectCameraSize(1);
        } else {
            z = false;
        }
        ...
        n8c.m158485c(TAG, "----switchVideoResolution: sizeChanged=" + z);
        this.streamProduct.notifyResumeRecording();
        n8c.m158485c(TAG, "----switchVideoResolution: call notifyResumeRecording end");
    }

    public void unRegisterHeadsetPlugReceiver() {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222711k2();
        }
    }
    ...
    public void updateCaptureImage(Bitmap bitmap, int i, int i2, int i3) {
        ...
        streamProducer.m222715m2(bitmap, i, i2, i3);
    }
    ...
    public void updateVideoVideoQuality(VideoQuality videoQuality) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222723p2(videoQuality);
        }
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222274R(videoQuality);
        }
    }
    ...
    public void SetSubVideoPos(long j, int i, int i2, int i3, int i4, int i5) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222661K1(j, i, i2, i3, i4, i5);
        }
    }
    ...
    public void selectFilter(Context context, ts2 ts2Var) {
        SourceBase sourceBase = this.mIjkSource;
        if (sourceBase != null) {
            sourceBase.mo222295t(this.mContext, ts2Var);
        }
    }
    ...
    public void openPublishHelp(Activity activity, long j, String str) {
        n8c.m158485c(TAG, "----openPublishHelp 6:");
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222703g1(activity, this, j, str, null, 0);
        }
    }

    public void openPublishHelp(Activity activity, long j, String str, SizeChangedCallback sizeChangedCallback) {
        n8c.m158485c(TAG, "----openPublishHelp 5:");
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222703g1(activity, this, j, str, sizeChangedCallback, 0);
        }
    }

    public void openPublishHelp(Activity activity, long j, String str, SizeChangedCallback sizeChangedCallback, int i) {
        n8c.m158485c(TAG, "----openPublishHelp 4:" + i);
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222703g1(activity, this, j, str, sizeChangedCallback, i);
        }
    }

    public void openPublishHelp(Activity activity, long j, String str, int i, int i2) {
        n8c.m158485c(TAG, "----openPublishHelp 3:");
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222702f1(activity, this, j, str, i, i2, null, 0, null);
        }
    }

    public void openPublishHelp(Activity activity, long j, String str, int i, int i2, SizeChangedCallback sizeChangedCallback) {
        n8c.m158485c(TAG, "----openPublishHelp 2:");
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222702f1(activity, this, j, str, i, i2, sizeChangedCallback, 0, null);
        }
    }
    ...
    public void openPublishHelp(Activity activity, long j, Bitmap bitmap) {
        StreamProducer streamProducer = this.streamProduct;
        if (streamProducer != null) {
            streamProducer.m222700e1(activity, j, bitmap);
        }
    }
    ...
    public void attachStreamer(int i, boolean z) {
        ...
        if (i2 != i) {
            if (i2 == 0 || (this.mIjkWriter instanceof IjkWriter)) {
                ...
                if (i == 1) {
                    this.mAttachedWriter = new AgoraWriter(this.mContext, this.mFakeSurface.m222483n0(), this.streamProduct, z);
                }
                this.streamProduct.m222713l2(this.mAttachedWriter);
            }
        }
    ...
    public void startCaptureImage(Activity activity, Bitmap bitmap, int i, int i2, int i3, int i4) {
        ...
        streamProducer.m222729r2(activity, sourceBase);
        this.mFakeSurface.m222448L0(this.mCaptureType);
        this.streamProduct.m222685X1(activity, bitmap, i, i2, i3, i4);
    }
