...
class TextureRender {
    ...
    private int createProgram(String str, String str2) {
        ...
        if (iGlCreateProgram == 0) {
            this.mSurfce.setLastErr(-1);
            n8c.m158483a(TAG, "Could not create program");
        }
        ...
        n8c.m158483a(TAG, "Could not link program: ");
        n8c.m158483a(TAG, GLES20.glGetProgramInfoLog(iGlCreateProgram));
    ...
    private int loadShader(int i, String str) {
        ...
        n8c.m158483a(TAG, "Could not compile shader " + i + ":");
    ...
    public void adjustImageScaling() {
        n8c.m158485c(TAG, "adjustImageScaling mOutputWidth:" + this.mOutputWidth + ";outputHeight:" + this.mOutputHeight + ";mImageWidth:" + this.mImageWidth + ";mImageHeight" + this.mImageHeight + ";mRotation:" + this.mRotation);
        ...
        float[] fArr = CUBE;
        float[] fArrM203672b = wki0.m203672b(this.mRotation, this.mFlipHorizontal, this.mFlipVertical);
        float f3 = (1.0f - (1.0f / fRound)) / 2.0f;
        float f4 = (1.0f - (1.0f / fRound2)) / 2.0f;
        float[] fArr2 = {addDistance(fArrM203672b[0], f3), addDistance(fArrM203672b[1], f4), addDistance(fArrM203672b[2], f3), addDistance(fArrM203672b[3], f4), addDistance(fArrM203672b[4], f3), addDistance(fArrM203672b[5], f4), addDistance(fArrM203672b[6], f3), addDistance(fArrM203672b[7], f4)};
    ...
    public void adjustImageScaling2() {
        float[] fArr = CUBE;
        float[] fArrM203672b = wki0.m203672b(this.mRotation, this.mFlipHorizontal, this.mFlipVertical);
        float[] fArr2 = {addDistance2(fArrM203672b[0], this.cut_l, this.cut_r), addDistance2(fArrM203672b[1], this.cut_t, this.cut_b), addDistance2(fArrM203672b[2], this.cut_l, this.cut_r), addDistance2(fArrM203672b[3], this.cut_t, this.cut_b), addDistance2(fArrM203672b[4], this.cut_l, this.cut_r), addDistance2(fArrM203672b[5], this.cut_t, this.cut_b), addDistance2(fArrM203672b[6], this.cut_l, this.cut_r), addDistance2(fArrM203672b[7], this.cut_t, this.cut_b)};
        this.mTarget_coords.clear();
        this.mTarget_coords.put(fArr).position(0);
        this.mSource_coords.clear();
        this.mSource_coords.put(fArr2).position(0);
    ...
    public void checkGlError(String str) {
        while (true) {
            ...
            n8c.m158483a(TAG, str + ": glError " + iGlGetError);
            this.mSurfce.setLastErr(-1);
        }
    }
    ...
    public void drawFrame(SurfaceTexture surfaceTexture) {
        ...
        if (this.bNeedUpdateRec) {
            ...
            n8c.m158485c(TAG, "@@@@@@@@@@  drawFrame NeedUpdateRec");
        }
    ...
    public void surfaceCreated() {
        ...
        if (iCreateProgram == 0) {
            n8c.m158483a(TAG, "failed creating program");
            this.mSurfce.setLastErr(-1);
            return;
        }
        ...
        if (this.maPositionHandle == -1) {
            n8c.m158483a(TAG, "Could not get attrib location for aPosition");
            this.mSurfce.setLastErr(-1);
            return;
        }
        ...
        if (this.maTextureHandle == -1) {
            n8c.m158483a(TAG, "Could not get attrib location for aTextureCoord");
            this.mSurfce.setLastErr(-1);
        } else {
            genTex();
            n8c.m158485c(TAG, "surfaceCreated: ");
        }
    }
    ...
    public void updateRec(float f, float f2, float f3, float f4) {
        ...
        n8c.m158485c(TAG, "@@@@@@@@@@  updateRec:" + f + ":" + f2 + ":" + f3 + ":" + f4);
    }
