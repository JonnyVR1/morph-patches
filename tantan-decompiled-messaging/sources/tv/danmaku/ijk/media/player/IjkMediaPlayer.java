...
public final class IjkMediaPlayer extends SimpleMediaPlayer {
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        public String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i, int i2) {
            ...
            hjx.m131421d(IjkMediaPlayer.TAG, String.format(Locale.US, "onSelectCodec: mime=%s, profile=%d, level=%d", str, Integer.valueOf(i), Integer.valueOf(i2)));
            ...
            if (ijkMediaCodecInfo2.mRank < IjkMediaCodecInfo.RANK_LAST_CHANCE) {
                hjx.m131421d(IjkMediaPlayer.TAG, String.format(Locale.US, "unaccetable codec: %s", ijkMediaCodecInfo2.mCodecInfo.getName()));
                return null;
            }
            hjx.m131421d(IjkMediaPlayer.TAG, String.format(Locale.US, "selected codec: %s rank=%d", ijkMediaCodecInfo2.mCodecInfo.getName(), Integer.valueOf(ijkMediaCodecInfo2.mRank)));
    ...
    public static class EventHandler extends Handler {
        ...
        private void notifyOnVideoSizeChanged(int i, int i2) {
            ...
            if (ijkMediaPlayer == null || ijkMediaPlayer.mNativeMediaPlayer == 0) {
                hjx.m131421d(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events: notifyOnVideoSizeChanged  [" + this + Constants.AES_SUFFIX);
                return;
            }
            if (ijkMediaPlayer.mVideoHeight != i2 || ijkMediaPlayer.mVideoWidth != i) {
                ijkMediaPlayer.mediaLogs2("notifyOnVideoSizeChanged", ijkMediaPlayer.hashCode() + " sizeChange, " + (ijkMediaPlayer.mHwCodec ? 1 : 0) + ", " + i + BaseSei.f13930X + i2);
            }
            ijkMediaPlayer.mVideoWidth = i;
            ijkMediaPlayer.mVideoHeight = i2;
            hjx.m131418a(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] FFP_MSG_VIDEO_SIZE_CHANGED   w/h " + ijkMediaPlayer.mVideoWidth + " x " + ijkMediaPlayer.mVideoHeight);
            ...
            hjx.m131418a("jzheng", "FFP_MSG_VIDEO_SIZE_CHANGED a " + ((((short) ijkMediaPlayer.mVideoWidth) << 16) | ((short) ijkMediaPlayer.mVideoHeight)) + " w/h " + ijkMediaPlayer.mVideoWidth + " x " + ijkMediaPlayer.mVideoHeight);
        }
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i != 99) {
                        if (i == 100) {
                            hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_ERROR (" + message.arg1 + Constants.SEPARATOR_COMMA + message.arg2 + ")");
                            StringBuilder sb = new StringBuilder();
                            sb.append(ijkMediaPlayer.hashCode());
                            sb.append(" MEDIA_ERROR, ");
                            sb.append(message.arg2);
                            ijkMediaPlayer.mediaLogs2("handleMessage", sb.toString());
                            ijkMediaPlayer.mediaLogsValOfPull.f199114o = (long) message.arg2;
                        ...
                        if (i == 200) {
                            int i2 = message.arg1;
                            if (i2 == 3) {
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_INFO_VIDEO_RENDERING_START");
                                ijkMediaPlayer.mediaLogs2("handleMessage", ijkMediaPlayer.hashCode() + " Video Render Start");
                                ijkMediaPlayer.pullStartV2();
                            } else if (i2 == 701) {
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_INFO_BUFFERING_START ");
                        ...
                        if (i == IjkMediaPlayer.MEDIA_MEIDACODEC_SIZE_CHANGE) {
                            ...
                            ijkMediaPlayer.mediaLogs2("handleMessage", ijkMediaPlayer.hashCode() + " media codec size change: " + message.arg1 + BaseSei.f13930X + message.arg2);
                        ...
                        switch (i) {
                            case 0:
                                break;
                            case 1:
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_PREPARED");
                                ijkMediaPlayer.notifyOnPrepared();
                                ijkMediaPlayer.mediaLogsValOfPull.f199098d = ijkMediaPlayer.getServerIpAddr();
                                ...
                                break;
                            case 2:
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_PLAYBACK_COMPLETE");
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_SEEK_COMPLETE");
                                ijkMediaPlayer.notifyOnSeekComplete();
                                ijkMediaPlayer.mediaLogs2("handleMessage", ijkMediaPlayer.hashCode() + " seek complete");
                                break;
                            case 5:
                                ijkMediaPlayer.mediaLogsValOfPull.f199078M = message.arg1;
                                ijkMediaPlayer.mediaLogsValOfPull.f199079N = message.arg2;
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_SET_VIDEO_SIZE " + message.arg1 + " x " + message.arg2);
                            ...
                            case 6:
                                ...
                                hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] MEDIA_SET_VIDEO_MEDIACODE MediaCodec Error " + message.arg1);
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case 10002:
                                        ...
                                        break;
                                    case 10003:
                                        ijkMediaPlayer.mediaLogsValOfPull.f199097c0 = (message.arg1 >> 16) & j6f.COLOR_SPACE_UNCALIBRATED;
                                        ijkMediaPlayer.mediaLogsValOfPull.f199121v = message.arg1 & j6f.COLOR_SPACE_UNCALIBRATED;
                                        ijkMediaPlayer.mediaLogsValOfPull.f199095b0 = (message.arg2 >> 16) & j6f.COLOR_SPACE_UNCALIBRATED;
                                        ijkMediaPlayer.mediaLogsValOfPull.f199120u = message.arg2 & j6f.COLOR_SPACE_UNCALIBRATED;
                                        ijkMediaPlayer.pullBufferDropV2();
                                        break;
                                    default:
                                        hjx.m131421d(IjkMediaPlayer.TAG, "[" + ijkMediaPlayer.hashCode() + "] Unknown message type:" + message.what);
                                        break;
                                }
                                break;
                        }
            ...
            hjx.m131421d(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events: handleMessage  [" + this + Constants.AES_SUFFIX);
        }
    }
    ...
    public class MediaDateHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 202) {
                hjx.m131419b(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
            } else {
    ...
    public IjkMediaPlayer(Context context, IjkLibLoader ijkLibLoader, eix eixVar) {
        ...
        if (eixVar != null) {
            this.mediaLogsValOfPull.f199089X = eixVar.m116731g();
        }
        this.mediaLogsValOfPull.f199093a0 = String.valueOf(hashCode());
    ...
    private void MediaCfgInit() {
        ...
        if (eixVar == null || TextUtils.isEmpty(eixVar.m116726b())) {
            eyx.m118802c().m118808g("ijkmediaplayer mediaCfg == null, user default appid");
            dix.C16387d c16387dM111948h = dix.m111940d().m111948h("mlive");
            if (this.httpMediaLogsUpload == null) {
                this.httpMediaLogsUpload = new su10("mdefault", "1a738fb015fe0a8476c4e05a314156d2", c16387dM111948h != null ? c16387dM111948h.f86450c : "", "", "", "", dix.m111940d().m111947g("mdefault"), "", this.mediaLogsValOfPull.f199093a0, this.showId);
            }
            gmx gmxVar = this.mediaLogPullV2;
            if (gmxVar != null) {
                gmxVar.m127084w(this.httpMediaLogsUpload);
                return;
            }
            return;
        }
        dix.C16387d c16387dM111948h2 = dix.m111940d().m111948h(this.mediaCfgParams.m116726b());
        if (c16387dM111948h2 != null) {
            ejx ejxVar = c16387dM111948h2.f86452e;
            if (ejxVar != null) {
                this.mediaLogPullV2.m127085x(ejxVar.f91887n);
                this.mediaLogPullV2.m127060A(c16387dM111948h2.f86452e.f91884m);
                this.mediaLogPullV2.m127083v(c16387dM111948h2.f86452e.f91875j);
                ejx ejxVar2 = c16387dM111948h2.f86452e;
                this.mUseOpengl = ejxVar2.f91829Q0;
                int i = ejxVar2.f91833S0;
                this.mNewcheckSei = i;
                this.mNewSizeChange = ejxVar2.f91835T0;
                _setPropertyLong(FFP_PROP_INT64_NEW_CHECK_SEI, i);
                _setPropertyLong(FFP_PROP_INT64_NEW_SIZE_CHANGE, this.mNewSizeChange);
            }
            if (this.mediaCfgParams.m116727c() != 0) {
                this.mediaLogsValOfPull.f199080O = this.mediaCfgParams.m116727c();
            }
            if (this.httpMediaLogsUpload == null) {
                this.httpMediaLogsUpload = new su10(this.mediaCfgParams.m116726b(), c16387dM111948h2.f86449b, c16387dM111948h2.f86450c, this.mediaCfgParams.m116732h(), String.valueOf(this.mediaCfgParams.m116730f()), String.valueOf(this.mediaCfgParams.m116727c()), dix.m111940d().m111947g(this.mediaCfgParams.m116726b()), this.mediaCfgParams.m116734j(), this.mediaLogsValOfPull.f199093a0, this.showId);
            }
            this.httpMediaLogsUpload.m185983e(this.mTag);
            gmx gmxVar2 = this.mediaLogPullV2;
            if (gmxVar2 != null) {
                gmxVar2.m127084w(this.httpMediaLogsUpload);
            }
            if (TextUtils.isEmpty(this.mediaCfgParams.m116732h()) || this.mediaCfgParams.m116727c() == 0) {
                eyx.m118802c().m118808g("mediaCfgParams" + this.mediaCfgParams.toString());
                eyx.m118802c().m118808g("threadInfo:" + mek0.m154243e());
            }
        }
    }
    ...
    public void bufferStartV2() {
        if (this.mediaLogPullV2.m127070g()) {
            this.mediaLogsValOfPull.f199120u = getVideoCachedDuration();
            this.mediaLogsValOfPull.f199121v = getAudioCachedDuration();
            tgf0 tgf0Var = this.simpleInfoFromUpStream;
            if (tgf0Var != null) {
                int iM188810b = tgf0Var.m188810b();
                this.mediaLogsValOfPull.f199116q = iM188810b != -1 ? iM188810b : 2L;
            }
            try {
                if (this.mBufferPerSec != null) {
                    ...
                    this.mediaLogsValOfPull.f199091Z = sb.substring(0, sb.length() - 1);
                } else {
                    this.mediaLogsValOfPull.f199091Z = "";
                }
            } catch (Exception unused) {
            }
            this.mediaLogsValOfPull.f199103f0 = getVideoCodecType();
            this.mediaLogPullV2.m127066a();
        }
    }
    ...
    private long getNetAnchorTime() {
        return fjx.m121638R().m121699U0() ? fjx.m121638R().m121707X() : System.currentTimeMillis() - this.mNetDiffTime;
    }
    ...
    private void initPlayer(IjkLibLoader ijkLibLoader) {
        hjx.m131421d(TAG, "[" + hashCode() + Constants.AES_SUFFIX);
    ...
    private void mediaLogs(String str, String str2) {
        if (this.mediaLogPullV2.m127070g() && this.mediaLogPullV2.m127069f() == 1) {
            this.mediaLogPullV2.m127073j(str, str2);
        }
    }
    ...
    public void mediaLogs2(Object... objArr) {
        if (this.mediaLogPullV2.m127070g() && this.mediaLogPullV2.m127069f() == 1) {
            this.mediaLogPullV2.m127074k(objArr);
        }
    }
    ...
    private static int onControlResolveSegmentCount(Object obj) {
        ...
        hjx.m131420c(TAG, "onControlResolveSegmentCount", new Object[0]);
    ...
    private static int onControlResolveSegmentDuration(Object obj, int i) {
        IjkMediaPlayer ijkMediaPlayer;
        OnControlMessageListener onControlMessageListener;
        hjx.m131420c(TAG, "onControlResolveSegmentDuration %d", Integer.valueOf(i));
        if (obj == null || !(obj instanceof WeakReference) || (ijkMediaPlayer = (IjkMediaPlayer) ((WeakReference) obj).get()) == null || (onControlMessageListener = ijkMediaPlayer.mOnControlMessageListener) == null) {
            return -1;
        }
    ...
    private static String onControlResolveSegmentOfflineMrl(Object obj, int i) {
        IjkMediaPlayer ijkMediaPlayer;
        OnControlMessageListener onControlMessageListener;
        hjx.m131420c(TAG, "onControlResolveSegmentOfflineMrl %d", Integer.valueOf(i));
        if (obj == null || !(obj instanceof WeakReference) || (ijkMediaPlayer = (IjkMediaPlayer) ((WeakReference) obj).get()) == null || (onControlMessageListener = ijkMediaPlayer.mOnControlMessageListener) == null) {
            return null;
        }
    ...
    private static String onControlResolveSegmentUrl(Object obj, int i) {
        IjkMediaPlayer ijkMediaPlayer;
        OnControlMessageListener onControlMessageListener;
        hjx.m131420c(TAG, "onControlResolveSegmentUrl %d", Integer.valueOf(i));
        if (obj == null || !(obj instanceof WeakReference) || (ijkMediaPlayer = (IjkMediaPlayer) ((WeakReference) obj).get()) == null || (onControlMessageListener = ijkMediaPlayer.mOnControlMessageListener) == null) {
            return null;
        }
    ...
    private static void onNotifyJson(Object obj, int i, int i2, Object obj2) {
        ...
        try {
            ...
            long j = jSONObject.has(com.tencent.connect.common.Constants.f57189TS) ? jSONObject.getLong(com.tencent.connect.common.Constants.f57189TS) : 0L;
            if (j != 0) {
            ...
            ijkMediaPlayer.mediaLogsValOfPull.f199076K = ijkMediaPlayer.mDelayTime;
            ijkMediaPlayer._setPropertyLong_(20025, ijkMediaPlayer.mDelayTime);
            Log.e("lqdebug", "mediaplayer json:" + jSONObject.toString());
            hjx.m131418a(TAG, "[" + ijkMediaPlayer.hashCode() + "] onNotifyJson sei   " + jSONObject.toString() + " delay " + ijkMediaPlayer.mDelayTime);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static String onSelectCodec(Object obj, String str, int i, int i2) {
        ...
        if ("ffmpeg/video".equalsIgnoreCase(str)) {
            hjx.m131419b(TAG, "onSelectCodec use ffmpeg codec: " + ijkMediaPlayer.mFakeSurface);
    ...
    private static void postEventFromNative(Object obj, int i, int i2, int i3, Object obj2) {
        ...
        if (eventHandler != null) {
            if (i == 5) {
                ijkMediaPlayer.mEventHandler.sendMessageDelayed(eventHandler.obtainMessage(i, (short) ((i2 >> 16) & j6f.COLOR_SPACE_UNCALIBRATED), (short) (i2 & j6f.COLOR_SPACE_UNCALIBRATED), obj2), i3);
            } else {
    ...
    public void pullBufferCheck() {
        this.mediaLogsValOfPull.f199124y = getVideoOutputFrames();
        ymx ymxVar = this.mediaLogsValOfPull;
        long j = ymxVar.f199124y;
        long j2 = j - ymxVar.f199074I;
        ymxVar.f199074I = j;
        if (this.pullStartAlreadySend && j2 / 5 <= 5) {
            ymxVar.f199075J++;
        }
        hjx.m131418a("buffercheckcount", "pullBufferCheck diff " + j2 + "/" + this.mediaLogsValOfPull.f199075J);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void pullBufferDropV2() {
        if (this.mediaLogPullV2.m127070g()) {
            this.mediaLogsValOfPull.f199099d0 = _getPropertyLong(20041, 0L);
            this.mediaLogPullV2.m127075l();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void pullDetectV2() {
        if (this.mediaLogPullV2.m127070g() && !this.mediaLogPullV2.m127071h()) {
            pullDetect[] pullDetectStatus = getPullDetectStatus();
            StringBuilder sb = new StringBuilder();
            if (pullDetectStatus != null) {
                int i = 0;
                for (int length = pullDetectStatus.length; i < length; length = length) {
                    ...
                    if (j != 0) {
                        sb.append(imx.m137116w(Long.valueOf(j), Integer.valueOf(pulldetect.unixErrno), Integer.valueOf(pulldetect.dnsTime), Long.valueOf(pulldetect.tcpConnectTime), Long.valueOf(pulldetect.httpTime), Integer.valueOf(pulldetect.httpResponseCode), Long.valueOf(pulldetect.firstPacketTime), Float.valueOf(getFirstIFrameTimes()), pulldetect.url, pulldetect.cdnIp, Integer.valueOf(pulldetect.ffmpegErrno), Long.valueOf(this.mediaLogsValOfPull.f199107h0)));
                    }
                    i++;
                }
            }
            this.mediaLogsValOfPull.f199094b = sb.toString();
            this.mediaLogPullV2.m127076m();
        }
    }

    private void pullInitV2() {
        if (this.mediaLogPullV2.m127070g()) {
            this.mediaLogPullV2.m127087z(this.mediaLogsValOfPull);
            this.mediaLogPullV2.m127061B(new gmx.InterfaceC17126b() { // from class: tv.danmaku.ijk.media.player.IjkMediaPlayer.2
                @Override // p149l.gmx.InterfaceC17126b
    ...
    public void pullStartV2() {
        if (this.mediaLogPullV2.m127070g()) {
            this.mediaLogsValOfPull.f199100e = getMetaSystemTime();
            this.mediaLogsValOfPull.f199102f = (long) getConnetTimes();
            this.mediaLogsValOfPull.f199104g = (long) getFirstVPacketTimes();
            this.mediaLogsValOfPull.f199106h = (long) getFirstAPacketTimes();
            this.mediaLogsValOfPull.f199108i = (long) getFirstIFrameTimes();
            this.mediaLogsValOfPull.f199109j = (long) getFirstAFrameTimes();
            this.mediaLogsValOfPull.f199110k = (long) getFirstVRenderTimes();
            this.mediaLogsValOfPull.f199111l = (long) getFirstARenderTimes();
            this.mediaLogsValOfPull.f199112m = getStreamCount();
            this.mediaLogsValOfPull.f199081P = getFirstVideoHasMomoSEI();
            this.mediaLogsValOfPull.f199084S = getPropertyString(20036);
            this.mediaLogsValOfPull.f199085T = getPropertyString(20037);
            this.mediaLogsValOfPull.f199099d0 = _getPropertyLong(20041, 0L);
            this.mediaLogsValOfPull.f199103f0 = getVideoCodecType();
            this.mediaLogsValOfPull.f199105g0 = this.detectStatus;
            tgf0 tgf0Var = this.simpleInfoFromUpStream;
            if (tgf0Var != null) {
                int iM188810b = tgf0Var.m188810b();
                this.mediaLogsValOfPull.f199116q = iM188810b != -1 ? iM188810b : 2L;
            ...
            if (tgf0Var2 != null) {
                String strM188809a = tgf0Var2.m188809a();
                if (strM188809a != null && !TextUtils.isEmpty(strM188809a)) {
                    this.mediaLogsValOfPull.f199098d = strM188809a;
                }
                this.mediaLogsValOfPull.f199086U = this.simpleInfoFromUpStream.m188811c();
            }
            if ((StringUtil.ALL_INTERFACES.equals(this.mediaLogsValOfPull.f199098d) || "127.0.0.1".equals(this.mediaLogsValOfPull.f199098d)) && !TextUtils.isEmpty(this.mCdnip) && Utils.isValidIpAddress(this.mCdnip)) {
                this.mediaLogsValOfPull.f199098d = this.mCdnip;
            }
            pullDetectV2();
            hjx.m131418a("pullJzheng", "isFirstVideoHasMomoSEI = " + this.mediaLogsValOfPull.f199081P);
            hjx.m131418a("pullJzheng", "ipAddrOfCDN = " + this.mediaLogsValOfPull.f199084S);
            hjx.m131418a("pullJzheng", "ipAddrOfClient = " + this.mediaLogsValOfPull.f199085T);
            this.mediaLogPullV2.m127078o();
    ...
    public void pullStopV2() {
        if (this.mediaLogPullV2.m127070g()) {
            ...
            if (tgf0Var != null) {
                int iM188810b = tgf0Var.m188810b();
                ymx ymxVar = this.mediaLogsValOfPull;
                ymxVar.f199116q = iM188810b != -1 ? iM188810b : 2L;
                ymxVar.f199086U = this.simpleInfoFromUpStream.m188811c();
                String strM188809a = this.simpleInfoFromUpStream.m188809a();
                if (strM188809a != null && !TextUtils.isEmpty(strM188809a)) {
                    this.mediaLogsValOfPull.f199098d = strM188809a;
                }
            }
            if ((StringUtil.ALL_INTERFACES.equals(this.mediaLogsValOfPull.f199098d) || "127.0.0.1".equals(this.mediaLogsValOfPull.f199098d)) && !TextUtils.isEmpty(this.mCdnip)) {
                boolean zIsValidIpAddress = Utils.isValidIpAddress(this.mCdnip);
                ymx ymxVar2 = this.mediaLogsValOfPull;
                if (zIsValidIpAddress) {
                    ymxVar2.f199098d = this.mCdnip;
                } else {
                    ymxVar2.f199098d = getServerIpAddr();
                }
            }
            ymx ymxVar3 = this.mediaLogsValOfPull;
            ymxVar3.f199087V = this.pullStartAlreadySend ? 1L : 0L;
            ymxVar3.f199117r = getReadByte();
            if (this.pullStartAlreadySend) {
                ymx ymxVar4 = this.mediaLogsValOfPull;
                if (ymxVar4.f199114o == 1) {
                    ymxVar4.f199114o = 0L;
                }
            }
            if (this.mPullSizePerSec != null) {
                ...
                this.mediaLogsValOfPull.f199090Y = stringBuffer.substring(0, stringBuffer.length() - 1);
            } else {
                this.mediaLogsValOfPull.f199090Y = "";
            }
            this.mediaLogsValOfPull.f199103f0 = getVideoCodecType();
            this.mediaLogsValOfPull.f199105g0 = this.detectStatus;
            this.mediaLogPullV2.m127079p();
            this.pullStartAlreadySend = false;
        }
    }
    ...
    public void pullWatchV2() {
        if (this.mediaLogPullV2.m127070g()) {
            updatePullWatch();
            hjx.m131418a("pullJzheng", "FFP_PROP_INT64_VIDEODONTHASMOMOSEICNT = " + this.mediaLogsValOfPull.f199082Q);
            this.mediaLogPullV2.m127080q();
        }
    }

    private void release_l() {
        hjx.m131421d(TAG, "[" + hashCode() + "] " + this.mFakeSurface + " release_l. ");
        stayAwake(false);
    ...
    private void setCdnType(String str) {
        ...
        eyx.m118802c().m118808g("setCdnType", "setCdnType:" + str);
        try {
    ...
    private void setMediaCodecEnabled_l(boolean z) {
        hjx.m131421d(TAG, "[" + hashCode() + "] " + z + " -->  done: " + this.mMediaCodecSetDone + " surface: " + this.mFakeSurface);
        ...
        if (this.mFakeSurface == null) {
            ...
            if (this.mFakeSurface.getLastErr() != 0) {
                ...
                this.mFakeSurface = null;
                hjx.m131419b(TAG, "mFakeSurface creat error use softdec");
            }
        }
    }
    ...
    private void updatePullWatch() {
        this.mediaLogsValOfPull.f199117r = getReadByte();
        this.mediaLogsValOfPull.f199118s = getVideoReadSize();
        this.mediaLogsValOfPull.f199119t = getAudioReadSize();
        this.mediaLogsValOfPull.f199120u = getVideoCachedDuration();
        this.mediaLogsValOfPull.f199121v = getAudioCachedDuration();
        this.mediaLogsValOfPull.f199122w = getVideoDecodeFrames();
        this.mediaLogsValOfPull.f199123x = getAudioDecoderSize();
        this.mediaLogsValOfPull.f199124y = getVideoOutputFrames();
        this.mediaLogsValOfPull.f199125z = getAudioRenderSize();
        this.mediaLogsValOfPull.f199077L = (long) getAudioSampleRate();
        this.mediaLogsValOfPull.f199082Q = getPropertyLong(20035, 0L);
        this.mediaLogsValOfPull.f199103f0 = getVideoCodecType();
        tgf0 tgf0Var = this.simpleInfoFromUpStream;
        if (tgf0Var != null) {
            int iM188810b = tgf0Var.m188810b();
    ...
    public void applyMediaConfig(ejx ejxVar) {
        ...
        int i4;
        if (ejxVar == null) {
            eyx.m118802c().m118808g("applyMediaConfig", "mediaConfig === " + ejxVar);
            return;
        }
        this.mediaLogPullV2.m127085x(ejxVar.f91887n);
        this.mediaLogPullV2.m127060A(ejxVar.f91884m);
        this.mediaLogPullV2.m127083v(ejxVar.f91875j);
        this.mUseOpengl = ejxVar.f91829Q0;
        this.enableLogBufferAndPullSize = ejxVar.f91815J0;
        this.mBufferLogHz = ejxVar.f91817K0;
        this.mPullSizeLogCount = ejxVar.f91819L0;
        this.mBufferLogCount = ejxVar.f91821M0;
        this.mVideoRenderTHold = ejxVar.f91823N0;
        this.mNewEnableLatency = ejxVar.f91825O0;
        this.mAudioPtsValue = ejxVar.f91827P0;
        this.mMinVideoJumpDuration = ejxVar.f91831R0;
        this.mDecorderRecordPts = ejxVar.f91837U0;
        this.mNewcheckSei = ejxVar.f91833S0;
        this.mNewSizeChange = ejxVar.f91835T0;
        fjx.m121638R().m121786s1(ejxVar.f91809G0 == 1);
        int i5 = ejxVar.f91811H0;
        if (i5 > 0) {
            this.mediaLogPullV2.m127062C(i5);
        }
        int i6 = ejxVar.f91813I0;
        if (i6 > 0) {
            this.mediaLogPullV2.m127082u(i6);
        }
        setPropertyLong(20039, ejxVar.f91823N0);
        setPropertyLong(20040, ejxVar.f91825O0);
        _setPropertyFloat_(10016, ejxVar.f91827P0);
        _setPropertyFloat_(10017, ejxVar.f91831R0);
        _setPropertyLong(20054, ejxVar.f91837U0);
        _setPropertyLong(FFP_PROP_INT64_NEW_CHECK_SEI, ejxVar.f91833S0);
        _setPropertyLong(FFP_PROP_INT64_ENABLE_LATENCY_SECONDS, ejxVar.f91839V0);
        _setPropertyLong(FFP_PROP_INT64_NEW_SIZE_CHANGE, ejxVar.f91835T0);
        int i7 = ejxVar.f91841W0;
        this.mLatencyEnable = i7;
        int i8 = ejxVar.f91843X0;
        this.mLatencyBaseMark = i8;
        int i9 = ejxVar.f91845Y0;
        this.mLatencySpeedupMark = i9;
        int i10 = ejxVar.f91847Z0;
        this.mLatencyDropMark = i10;
        float f = ejxVar.f91850a1;
        this.mLatencySpeedRate = f;
        this.mBufferFirst = ejxVar.f91853b1;
        this.mBufferCurrent = ejxVar.f91856c1;
        this.mBufferNext = ejxVar.f91859d1;
        this.mBufferLast = ejxVar.f91862e1;
        this.mBufferInterval = ejxVar.f91865f1;
        ...
        this.filterOn = ejxVar.f91868g1;
        this.mSaturation = ejxVar.f91871h1;
        this.mDeblurWeight = ejxVar.f91874i1;
        this.mDeblurRadius = ejxVar.f91877j1;
        this.mDeblurThreshold = ejxVar.f91880k1;
        this.mContrast = ejxVar.f91883l1;
        this.mHardDecoderFlagFromMediaConfig = ejxVar.f91807F0 != 0;
        setMediaCodecEnabled(this.mHardDecoderFlagFromMediaConfig);
        this.mediaLogPullV2.m127074k("mediaconfig", "mDecorderRecordPts:" + ejxVar.f91837U0 + ", NewEnableLatency:" + ejxVar.f91825O0 + ",Latency_seconds:" + ejxVar.f91839V0);
        gmx gmxVar = this.mediaLogPullV2;
        StringBuilder sb = new StringBuilder("mUseOpengl:");
        sb.append(this.mUseOpengl);
        gmxVar.m127074k("prepareAsync", sb.toString(), "filterOn:" + this.filterOn + ",checksei:" + ejxVar.f91833S0 + ",sizechange:" + ejxVar.f91835T0);
    }
    ...
    public String getPropertyString(int i) {
        try {
            ...
            eyx.m118802c().m118808g("getPropertyString", Integer.valueOf(i));
            return "";
        }
    }
    ...
    public void getPullWatchInfo(PullWatchInfo pullWatchInfo) {
        ...
        pullWatchInfo.setPullDebugInfoParms(z ? getAudioReadSize() : 0L, z ? getVideoReadSize() : 0L, z ? getVideoOutputFrames() : 0L, z ? (int) getFirstARenderTimes() : 0, z ? (int) getFirstVRenderTimes() : 0, z ? (int) getVideoCachedDuration() : 0, z ? (int) getAudioCachedDuration() : 0, z ? (int) getDelayTime() : 0, s7y.m182539h().m182544b(), z ? getPullDetects() : "not prepared");
    ...
    public void livepullMegerUpload(String str, String str2) {
        this.mediaLogPullV2.m127072i(str, str2);
    }
    ...
    public int mediaConfig(String str) {
        ...
        int i3;
        int i4;
        hjx.m131421d(TAG, "[" + hashCode() + "] [" + str + Constants.AES_SUFFIX);
        if (TextUtils.isEmpty(str)) {
            eyx.m118802c().m118803a("mediaConfig", Constants.KEY_CONFIG, LogLevel.ERROR);
        } else {
            try {
                JSONObject jSONObject = new JSONObject(str);
                int i5 = 3;
                if (jSONObject.has("pull_comm")) {
                    ...
                    if (jSONArrayOptJSONArray != null) {
                        ...
                        setMediaCodecEnabled(this.mHardDecoderFlagFromMediaConfig);
                        if (iOptInt3 > 0) {
                            this.mediaLogPullV2.m127062C(iOptInt3);
                        }
                        if (iOptInt4 > 0) {
                            this.mediaLogPullV2.m127082u(iOptInt4);
                        }
                        fjx.m121638R().m121786s1(iOptInt2 == 1);
                        ...
                        i5 = 3;
                        eyx.m118802c().m118805d("pull_comm", "ijkmediaplayer_mediaConfig");
                    }
                } else {
                    i5 = 3;
                }
                if (jSONObject.has("pull_delay")) {
                    ...
                    eyx.m118802c().m118805d("pull_delay", "ijkmediaplayer_mediaConfig");
                }
                if (jSONObject.has("filter_config")) {
                    ...
                    eyx.m118802c().m118805d("filter_config", "ijkmediaplayer_mediaConfig");
                }
            } catch (Exception e) {
                eyx.m118802c().m118805d("" + e.toString(), "ijkmediaplayer_mediaConfig");
                eyx.m118802c().m118808g("ijkmediaplayer parse mediaconfig:" + e.toString());
            }
        }
        eyx.m118802c().m118808g("ijkmediaplayer", "player hashcode:" + hashCode() + ",setMediaConfig:" + str);
    ...
    public void prepareAsync() throws IllegalStateException {
        try {
            ...
            this.mediaLogPullV2.m127074k("prepareAsync", "mUseOpengl:" + this.mUseOpengl, "filterOn:" + this.filterOn + ",checksei:" + this.mNewcheckSei + ",newsizeChange" + this.mNewSizeChange);
        ...
        ymx ymxVar = this.mediaLogsValOfPull;
        ymxVar.f199096c = this.mDataSource;
        ymxVar.f199107h0 = System.currentTimeMillis();
        pullInitV2();
        this.mediaLogPullV2.m127073j("setRenderType", this.mUseOpengl == 1 ? "OpengL" : "nativeWindow ");
        this.mediaLogPullV2.m127074k("mediaconfig", "mDecorderRecordPts:" + this.mDecorderRecordPts + ", NewEnableLatency:" + this.mNewEnableLatency);
        this.mediaLogPullV2.m127074k("filterParm", "filterOn:" + this.filterOn + ",Saturation:" + this.mSaturation + ", mDeblurWeight" + this.mDeblurWeight + ", mDeblurRadius:" + this.mDeblurRadius + ",mDeblurThreshold:" + this.mDeblurThreshold + ",mContrast:" + this.mContrast);
    }
    ...
    public synchronized void release() {
        try {
            hjx.m131421d(TAG, "[" + hashCode() + "] release.");
            if (this.mFakeSurface != null) {
                mediaLogs2("HWRender", "Stop");
            }
            this.mediaLogPullV2.m127074k("ijkmediaplayer release");
            pullStopV2();
            st0.m185792g().m185808q(st0.f166271g);
            release_l();
    ...
    public void resetInternal() {
        hjx.m131421d(TAG, "[" + hashCode() + "] resetInternal");
        stayAwake(false);
        try {
            _resetInternal();
        } catch (Error e) {
    ...
    public void seekTo(long j) {
        hjx.m131421d(TAG, "[" + hashCode() + "] seekTo " + j);
        try {
            _seekTo(j);
        } catch (Error e) {
            e.printStackTrace();
    ...
    public final void sendJsonData(byte[] bArr, int i, IjkMediaPlayer ijkMediaPlayer) {
        try {
            ...
            hjx.m131418a(TAG, "mJsonDateCallback error.");
        }
    }
    ...
    public void setBusinessType(int i) {
        ...
        this.mediaLogsValOfPull.f199080O = (long) i;
        eix eixVar = this.mediaCfgParams;
        if (eixVar != null) {
            eixVar.m116740p(i);
        }
    ...
    public void setDataSource(String str, String str2) throws IOException {
        hjx.m131418a(TAG, "setDataSource: ipv6Url=" + str + ", ipv4Url=" + str2);
        this.mHasPrepared = false;
        mvj0 mvj0VarM130289g = hb20.m130275f().m130289g(str, str2);
        if (mvj0VarM130289g == null || TextUtils.isEmpty(mvj0VarM130289g.m156529d())) {
            gmx gmxVar = this.mediaLogPullV2;
            if (gmxVar != null) {
                gmxVar.m127073j("setDataSource", "No valid URL available for playback");
                return;
            }
            return;
        }
        this.mCurrentUrlInfo = mvj0VarM130289g;
        this.detectStatus = mvj0VarM130289g.m156527a();
        hjx.m131418a(TAG, "setDataSource: using url=" + mvj0VarM130289g.m156529d() + ", type=" + mvj0VarM130289g.m156528b());
        setDataSource(mvj0VarM130289g.m156529d());
        hb20.m130275f().m130292t(mvj0VarM130289g);
    }
    ...
    public void setDisplay(SurfaceHolder surfaceHolder) {
        ...
        hjx.m131421d(TAG, "[" + hashCode() + "] cost " + jCurrentTimeMillis + " mediacodec: " + this.mUseAndroidMediaCodec + "/" + this.mFakeSurface + "/" + surfaceHolder);
        StringBuilder sb = new StringBuilder("[");
        sb.append(hashCode());
    ...
    public final void setLogRoomInfos(String str, String str2, int i) {
        ...
        if (eixVar != null) {
            eixVar.m116743s(str);
            if (i != 0) {
                this.mediaCfgParams.m116742r(i);
            }
        }
        this.mediaLogPullV2.m127086y(str, str2, i);
    }

    public final void setLogUploadCb(int i, int i2, xgf0 xgf0Var) {
        hjx.m131421d(TAG, "setLogUploadCb " + i + " | " + i2 + " | " + xgf0Var);
        if (i <= 0 || i2 <= 0 || xgf0Var == null) {
            return;
        }
        this.mediaLogPullV2.m127064E(i, i2, xgf0Var);
    }
    ...
    public int setMomoParms(int i, String str) {
        hjx.m131421d("[" + hashCode() + "] configdata", "key " + i + "/" + str);
        if (i != 4104) {
            return 0;
        }
    ...
    public void setPullSrc(String str) {
        this.mediaLogsValOfPull.f199101e0 = str;
    }
    ...
    public void setSurface(Surface surface) {
        int i;
        long jCurrentTimeMillis = System.currentTimeMillis() - this.costOfsetSurfaceMs;
        hjx.m131421d(TAG, "[" + hashCode() + "] cost " + jCurrentTimeMillis + " mediacode:" + this.mUseAndroidMediaCodec + " / " + this.mFakeSurface + " / " + surface);
        if (this.metaTimeMs == 0) {
            this.metaTimeMs = jCurrentTimeMillis;
        }
        try {
    ...
    public void setSurfaceH(Surface surface) {
        long jCurrentTimeMillis = System.currentTimeMillis() - this.costOfsetSurfaceMs;
        hjx.m131421d(TAG, "[" + hashCode() + "] cost " + jCurrentTimeMillis + " / " + surface);
        if (this.metaTimeMs == 0) {
            this.metaTimeMs = jCurrentTimeMillis;
        }
        if (this.mScreenOnWhilePlaying && surface != null) {
            hjx.m131421d(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
        this.mSurface = surface;
    ...
    public void stop() throws IllegalStateException {
        ...
        this.mediaLogPullV2.m127074k("ijkmediaplayer stop");
        pullStopV2();
        stayAwake(false);
        try {
            _stop();
    ...
    public void uploadMediaLogs(String str, String str2) {
        this.mediaLogPullV2.m127065G(str, str2);
    }
    ...
    public void setDataSource(String str) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        ...
        if (TextUtils.isEmpty(str)) {
            eyx.m118802c().m118803a("setDataSource", "dataSource", LogLevel.FATAL);
        }
        ...
        hjx.m131421d(TAG, "[" + hashCode() + "] [" + this.mCdnip + "] " + str);
        try {
    ...
    public IjkMediaPlayer(Context context, eix eixVar) {
        ...
        if (weakReference.get() != null) {
            st0.m185792g().m185807p(this.mContextRef.get(), st0.f166271g);
        }
        try {
