...
public class IjkConfMediaPlayer {
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkConfMediaPlayer == null || ijkConfMediaPlayer.mNativeMediaPlayer == 0) {
                n8c.m158491i(IjkConfMediaPlayer.TAG, "IjkConfMediaPlayer went away with unhandled events");
                return;
            }
            int i = message.what;
            if (i == 0 || i == 1) {
            ...
            if (i != 100) {
                ...
                n8c.m158485c(IjkConfMediaPlayer.TAG, "Unknown message type " + message.what);
                return;
            }
            n8c.m158485c(IjkConfMediaPlayer.TAG, "Error (" + message.arg1 + Constants.SEPARATOR_COMMA + message.arg2 + ")");
            ijkConfMediaPlayer.stayAwake(false);
        }
    }
            ...
            if (!mIsLibLoaded) {
                ...
                try {
                    ...
                    try {
                        ...
                        rdc0.m178959a(g16.f100119a, "ijkconfplayer");
    ...
    public void setDisplay(SurfaceHolder surfaceHolder) {
        ...
        String str = TAG;
        n8c.m158485c(str, "setDisplay" + surfaceHolder);
        try {
            if (surfaceHolder != null) {
            ...
            if (fakesurface != null) {
                ...
                n8c.m158485c(str, "_setVideoSurface" + surfaceHolder);
            }
        } catch (Error e) {
            e.printStackTrace();
        } catch (Exception e2) {
    ...
    public void setMediaCodecEnabled(boolean z) {
        n8c.m158485c(TAG, "setMediaCodecEnabled" + z);
        if (mIsLibLoaded) {
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                n8c.m158491i(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public void setSurfaceH(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            n8c.m158491i(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
        if (mIsLibLoaded) {
            _setVideoSurface(surface, surface);
        }
    ...
    public void setWakeMode(Context context, int i) {
        ...
        PowerManager.WakeLock wakeLockNewWakeLock = ((PowerManager) context.getSystemService("power")).newWakeLock(i | 536870912, IjkConfMediaPlayer.class.getName());
    ...
    public void setDisplay(Surface surface) {
        try {
            ...
            if (fakesurface != null) {
                ...
                n8c.m158485c(TAG, "_setVideoSurface" + surface);
            }
        } catch (Error e) {
            e.printStackTrace();
        } catch (Exception e2) {
