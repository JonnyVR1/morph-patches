    ...
    public void setPullDebugInfoParms(long j, long j2, long j3, int i, int i2, int i3, int i4, int i5, String str, String str2) {
        if (this.currentTimeMs == -1) {
            ...
            if (jElapsedRealtime != 0) {
                ...
                n8c.m158483a(TAG, "fps " + (j3 - this.pre_VideoOutputFrames) + "   " + this.fps);
                n8c.m158483a(TAG, "audioBitRate " + (j - this.pre_AudioSize) + "   " + this.audioBitRate);
                n8c.m158483a(TAG, "videoBitRate " + (j2 - this.pre_VideoSize) + "   " + this.videoBitRate);
            }
        }
