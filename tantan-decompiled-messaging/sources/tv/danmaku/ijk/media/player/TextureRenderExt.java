...
class TextureRenderExt {
    ...
    public void setDeblurEnabled(boolean z) {
        n8c.m158485c(TAG, "setDeblurEnabled:" + this.mDeblurEnabled + "--->" + z);
        this.mDeblurEnabled = z;
    }

    public void setDeblurWeight(float f) {
        n8c.m158485c(TAG, "setDeblurWeight:" + this.mDeblurWeight + "--->" + f);
        this.mDeblurWeight = f;
    }

    public void setSaturation(float f) {
        n8c.m158485c(TAG, "setSaturation:" + this.mSaturation + "--->" + f);
        this.mSaturation = f;
    }
