...
public class eoq {
    ...
    public static Object[] m117497a(JSONArray jSONArray, String str) {
    ...
    public static Object m117498b(JSONObject jSONObject, String str) throws JSONException {
        if (jSONObject == null) {
            return null;
        }
        if ("Integer".equalsIgnoreCase(str)) {
    ...
    public static Object[] m117499c(String str, String str2) {
        Object objM117497a;
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (jSONObject.has("type")) {
                    ...
                    objM117497a = (jSONObject.has("isArray") && jSONObject.getBoolean("isArray")) ? m117497a(jSONObject.getJSONArray("value"), string) : m117498b(jSONObject, string);
                } else {
                    objM117497a = null;
                }
                objArr[i] = objM117497a;
            }
            return objArr;
        } catch (JSONException e) {
            CrashHelper.m81296c(new IllegalArgumentException("key:" + str + "methodParams :" + str2, e));
            return new Object[0];
        }
    }
}
