...
public final class hi0 extends AbstractC18843o5 {
    ...
    public static Boolean m131196d(C8765d c8765d) {
        return Boolean.valueOf(NullChecker.m81303a(c8765d.m53520b()) && c8765d.m53520b().m53601s().quarterly() && (rxa0.m181502w(c8765d.m53520b().m53601s()) || rxa0.m181501v("svip", c8765d.m53520b().m53601s())));
    }
    ...
    public boolean mo116616a(@NotNull C8765d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!sab0.m182899q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "alipay") || vwb.m200337m(m162743b(), new w9j() { // from class: l.gi0
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return hi0.m131196d((C8765d) obj);
            }
        })) {
            return false;
        }
