...
public final class kio {
    ...
    public kio(@NotNull IntlMeetVisitorFrag intlMeetVisitorFrag, @NotNull ijo ijoVar) {
        ...
        this.affiliateCountdownResyncSub = intlMeetVisitorFrag.duringCreated(CoreModule.f17545c.f19696x0.m30210p4()).subscribe(mkd0.m154955G(new e30() { // from class: l.hio
            @Override // p149l.e30
            public final void call(Object obj) {
                kio.m146100b(this.f107950a, (Boolean) obj);
            }
        }));
        this.affiliatePromotionsCacheSub = intlMeetVisitorFrag.duringCreated(CoreModule.f17545c.f19696x0.m30212q4()).subscribe(mkd0.m154955G(new e30() { // from class: l.iio
            @Override // p149l.e30
            public final void call(Object obj) {
                kio.m146101c(this.f113417a, (Boolean) obj);
            }
        }));
    }

    /* JADX INFO: renamed from: a */
    public static void m146099a(kio kioVar, IapAffiliatePromotion iapAffiliatePromotion, View view) {
        Act act = kioVar.frag.act();
        if (act == null) {
            return;
        }
        s1n.m182010f(act, iapAffiliatePromotion, s1n.m182006b(kioVar.tab));
        CoreModule.m29935P().m94656g().mo35089zr(act, kioVar.purchaseFrom);
    }

    /* JADX INFO: renamed from: b */
    public static void m146100b(kio kioVar, Boolean bool) {
        kioVar.m146111m();
    }

    /* JADX INFO: renamed from: c */
    public static void m146101c(kio kioVar, Boolean bool) {
        kioVar.m146111m();
    }

    /* JADX INFO: renamed from: d */
    public final void m146102d(IntlDiscountEntryBannerView b, boolean stopCountdown) {
    ...
    public final void m146103e(IntlDiscountEntryBannerView b) {
    ...
    public final void m146104f(IntlDiscountEntryBannerView b, IapAffiliatePromotionDisplaySlot slot) {
        String string;
    ...
    public final void m146105g(@NotNull FrameLayout container) {
        Context context;
        container.getClass();
        m146108j();
    ...
    public final CharSequence m146106h(IapAffiliatePromotionDisplaySlot slot) {
        String string;
        String string2;
        String string3;
        String str = slot.mainTitle;
    ...
    public final void m146107i() {
        ...
        if (intlDiscountEntryBannerView != null) {
            m146102d(intlDiscountEntryBannerView, true);
        }
        this.banner = null;
    }

    /* JADX INFO: renamed from: j */
    public final void m146108j() {
        IntlDiscountEntryBannerView intlDiscountEntryBannerView = this.banner;
    ...
    public final void m146109k() {
        m146111m();
    }

    /* JADX INFO: renamed from: l */
    public final IntlDiscountEntryTheme m146110l(String raw) {
    ...
    public final void m146111m() {
        ...
        if (this.frag.act() == null) {
            m146102d(intlDiscountEntryBannerView, false);
            return;
        }
        m146103e(intlDiscountEntryBannerView);
        intlDiscountEntryBannerView.setEntryTheme(m146110l(iapAffiliatePromotionDisplaySlotM30175G3.theme));
        ...
        m146104f(intlDiscountEntryBannerView, iapAffiliatePromotionDisplaySlotM30175G3);
        ...
        intlDiscountEntryBannerView.setOnBannerClickListener(new View.OnClickListener() { // from class: l.jio
            ...
            public final void onClick(View view) {
                kio.m146099a(this.f118120a, iapAffiliatePromotionM30170D3, view);
            }
        });
        intlDiscountEntryBannerView.setBannerContentDescription(m146106h(iapAffiliatePromotionDisplaySlotM30175G3));
    }
}
