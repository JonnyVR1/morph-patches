...
class ytq0 extends vmq0 {
    public ytq0(Context context, ykq0 ykq0Var, voq0 voq0Var) {
        super(CrashType.JAVA, context, ykq0Var, voq0Var);
    }
    ...
    public bjq0 mo108890a(int i, bjq0 bjq0Var) {
        ...
        if (i == 0) {
            bjq0VarMo108890a.m102217j("app_count", 1);
            bjq0VarMo108890a.m102217j("magic_tag", "ss_app_log");
            m198981m(bjq0VarMo108890a);
