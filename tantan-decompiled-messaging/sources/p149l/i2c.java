...
public class i2c extends sh2 {
    ...
    public List<LiveMessage> mo134048e(LiveMessage liveMessage, List<LiveMessage> list, j760<Integer, Integer> j760Var) {
        ...
        this.f110546d = false;
        if (liveMessage.isDanmuFoldMessage() && !liveMessage.isUserOwnMessage() && j760Var != null && !vwb.m200296J(list) && !TextUtils.isEmpty(liveMessage.messageContent) && "为主播打call".equals(liveMessage.messageContent)) {
