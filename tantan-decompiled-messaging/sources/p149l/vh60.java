...
public final class vh60 extends AbstractC20103t4 {
    ...
    public vh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo136186b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        if (sab0.m182891i(this.purchaseType)) {
            ...
            String str = getNumberFormat().format(aVarM187136g.m53553I() ? aVarM187136g.m53601s().getFirstCouponPrice() : aVarM187136g.m53601s().defaultStockKeepUnit.prices.price);
            str.getClass();
            StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
            strString = String.format("%1$s%2$s %3$s", Arrays.copyOf(new Object[]{aVarM187136g.m53583h(), str, this.act.string(R$string.f27665y8)}, 3));
        } else {
            strString = this.act.string(R$string.f27665y8);
            strString.getClass();
        }
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        request.getClass();
        return (sab0.m182899q(this.purchaseType) || sab0.m182891i(this.purchaseType)) && C8766e.m53650x(getFrom());
    }
}
