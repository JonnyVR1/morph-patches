...
public final class hd0 implements hml {
    ...
    public CharSequence mo130527a(@NotNull fd0 requestData) {
        ...
        if (sab0.m182891i(this.purchaseType) && requestData.getVipFrag() && g6a.m124566o()) {
            CharSequence charSequenceM202873n = we60.m202873n(this.purchaseType, requestData.getPrivilegeStyle(), Color.parseColor("#735131"));
            charSequenceM202873n.getClass();
            return charSequenceM202873n;
        }
        boolean purchasePageType = requestData.getPurchasePageType();
        PurchaseType purchaseType = this.purchaseType;
        if (purchasePageType) {
            CharSequence charSequenceM202840E = we60.m202840E(purchaseType, requestData.getPrivilegeStyle());
            charSequenceM202840E.getClass();
            return charSequenceM202840E;
        }
        CharSequence charSequenceM202872m = we60.m202872m(purchaseType, requestData.getPrivilegeStyle());
        charSequenceM202872m.getClass();
        return charSequenceM202872m;
    }
