...
public final class md0 implements hml {
    ...
    public CharSequence mo130527a(@NotNull fd0 requestData) {
        ...
        if (purchaseType == purchaseType2) {
            CharSequence charSequenceM202842G = we60.m202842G(purchaseType2, requestData.getPrivilegeStyle());
            charSequenceM202842G.getClass();
            return charSequenceM202842G;
        }
        CharSequence charSequenceM202843H = rxa0.m181495p(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), ProductCategory.get("svipPicksMembership"), MonetizationPromotionsId.lowPriceSVIPPicks) ? we60.m202843H(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), this.purchaseType, requestData.getPrivilegeStyle()) : we60.m202842G(this.purchaseType, requestData.getPrivilegeStyle());
        charSequenceM202843H.getClass();
        return charSequenceM202843H;
    }
    ...
    public boolean mo130528b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.m182895m(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
