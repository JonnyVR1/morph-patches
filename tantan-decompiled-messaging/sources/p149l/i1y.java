...
@Metadata(m87231d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0006\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00050\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0017\u0010\n\u001a\u00020\t2\u0006\u0010\b\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\n\u0010\u000bR$\u0010\u0013\u001a\u0004\u0018\u00010\f8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010\"\u0004\b\u0011\u0010\u0012¨\u0006\u0014"}, m87232d2 = {"Ll/i1y;", "", "<init>", "()V", "Lrx/c;", "Lcom/p1/mobile/putong/core/data/SvipWeeklyReport;", "e", "()Lrx/c;", "svipWeeklyReport", "", Constants.INAPP_DATA_TAG, "(Lcom/p1/mobile/putong/core/data/SvipWeeklyReport;)V", "Lcom/p1/mobile/putong/core/businessdata/meet/MeetFeedSvipWeeklyItemData;", "a", "Lcom/p1/mobile/putong/core/businessdata/meet/MeetFeedSvipWeeklyItemData;", "c", "()Lcom/p1/mobile/putong/core/businessdata/meet/MeetFeedSvipWeeklyItemData;", "setSvipWeeklyItemData", "(Lcom/p1/mobile/putong/core/businessdata/meet/MeetFeedSvipWeeklyItemData;)V", "svipWeeklyItemData", "member_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
...
public final class i1y {
    ...
    public static SvipWeeklyReport m134014a(Function1 function1, Object obj) {
        return (SvipWeeklyReport) function1.invoke(obj);
    }

    /* JADX INFO: renamed from: b */
    public static SvipWeeklyReport m134015b(i1y i1yVar, SvipWeeklyReport svipWeeklyReport) {
        if (svipWeeklyReport == null) {
            return null;
        }
        i1yVar.m134017d(svipWeeklyReport);
    ...
    public final void m134017d(SvipWeeklyReport svipWeeklyReport) {
        ...
        for (SvipWeeklyReportItem svipWeeklyReportItem : list) {
            ...
            if (Intrinsics.m87488d(str, SvipWeeklyReportItem.ITEM_TYPE_VISITOR)) {
                svipWeeklyItem.iconRes = b3c0.f73160t5;
    ...
    public final C22306c<SvipWeeklyReport> m134018e() {
        if (!CoreModule.m29935P().m94656g().mo35055dh() || !xma.m210047L3()) {
            C22306c<SvipWeeklyReport> c22306cJust = C22306c.just(null);
            c22306cJust.getClass();
            return c22306cJust;
        }
        C22306c<SvipWeeklyReport> c22306cM34692I5 = CoreModule.f17545c.f19664m1.m34692I5();
        final Function1 function1 = new Function1() { // from class: l.g1y
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return i1y.m134015b(this.f100229a, (SvipWeeklyReport) obj);
            }
        };
        C22306c map = c22306cM34692I5.map(new w9j() { // from class: l.h1y
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return i1y.m134014a(function1, obj);
            }
        });
        map.getClass();
        return map;
