...
public abstract class zs2 {
    ...
    protected igm geometryAttrInfo = new igm();
    ...
    public void drawFrame(int[] iArr) {
        if (iArr == null) {
            MDLog.m7391e("EsProgram", "Input textures is null, invalid !!");
            return;
        }
        if (!this.initialized) {
            initWithGLContext();
    ...
    public void initWithGLContext() {
        ...
        if (this.vertexShaderHandle == 0) {
            xbj.m207729a(this, ": Could not create vertex shader. Reason: ", strGlGetShaderInfoLog);
            return;
        }
        ...
        if (this.fragmentShaderHandle == 0) {
            xbj.m207729a(this, ": Could not create fragment shader. Reason: ", strGlGetShaderInfoLog);
            return;
        }
    ...
    public void passShaderValues(int[] iArr) {
        igm igmVar = this.geometryAttrInfo;
        if (igmVar != null) {
            FloatBuffer renderVertices = igmVar.getRenderVertices();
