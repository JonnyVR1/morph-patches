...
public class oui extends vp2<LongLinkLiveMessage.LiveTemplateMsg> {
    public oui(und undVar) {
        super(undVar);
    }
    ...
    public LiveMessage mo94401x(String str, LongLinkLiveMessage.LiveTemplateMsg liveTemplateMsg, String str2) {
        ...
        extInfo.followType = "watchTime";
        extInfo.followTrackName = ChannelConstant.Action.AIDL_ACTION_WATCH;
