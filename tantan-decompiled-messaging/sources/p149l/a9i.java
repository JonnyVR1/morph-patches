...
public class a9i extends Act.AbstractC4304w<PutongAct, FeedVideoFlowAct> {

    /* JADX INFO: renamed from: l.a9i$a */
    public class C15548a extends AnimatorListenerAdapter {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ FeedVideoFlowAct f68173a;

        public C15548a(FeedVideoFlowAct feedVideoFlowAct) {
            this.f68173a = feedVideoFlowAct;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            super.onAnimationEnd(animator);
            this.f68173a.m66192e2();
        }
    }

    @Override // com.p046p1.mobile.android.app.Act.AbstractC4304w
    /* JADX INFO: renamed from: i, reason: merged with bridge method [inline-methods] */
    public Animator mo20409c(PutongAct putongAct, FeedVideoFlowAct feedVideoFlowAct) {
        View viewFindViewWithTag;
        C22585a.b bVar;
        FeedVideoViewFlowItemView feedVideoViewFlowItemView = feedVideoFlowAct.m66188a2().m130018l().f158229k;
        if (feedVideoViewFlowItemView == null || (viewFindViewWithTag = feedVideoViewFlowItemView.getViewModel().f42610b.findViewWithTag(0)) == null || (bVar = (C22585a.b) viewFindViewWithTag.findViewById(b5c0.f73596o1)) == null) {
            return null;
        }
        ...
        animatorM103753z.addListener(new C15548a(feedVideoFlowAct));
        return animatorM103753z;
    }

    @Override // com.p046p1.mobile.android.app.Act.AbstractC4304w
    /* JADX INFO: renamed from: j, reason: merged with bridge method [inline-methods] */
    public Animator mo20410d(PutongAct putongAct, FeedVideoFlowAct feedVideoFlowAct) {
        View viewFindViewWithTag;
        C22585a.b bVar;
        FeedVideoViewFlowItemView feedVideoViewFlowItemView = feedVideoFlowAct.m66188a2().m130018l().f158229k;
        if (feedVideoViewFlowItemView == null || (viewFindViewWithTag = feedVideoViewFlowItemView.getViewModel().f42610b.findViewWithTag(0)) == null || (bVar = (C22585a.b) viewFindViewWithTag.findViewById(b5c0.f73596o1)) == null) {
