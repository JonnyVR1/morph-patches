...
public final class nf60 implements pzl {
    ...
    public nf60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str, @Nullable j5b0 j5b0Var) {
        act.getClass();
    ...
    public boolean mo111438a(@NotNull ef60 paymentHandlerData, @NotNull AbstractC18623n5 paymentComponent) {
        ...
        j5b0Var.m54004A(paymentHandlerData, this.purchaseType);
        return false;
    }
}
