...
public class sek0 {
    ...
    public static void m183671a(Activity activity) {
    ...
    public static void m183672b(Activity activity) {
        if (Build.VERSION.SDK_INT >= 30) {
    ...
    public static void m183673c(Activity activity) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    CrashHelper.m81296c(new RuntimeException("convertActivityToTranslucentAfterL NoSuchMethodException , methods=" + ((Object) sb), e));
                } catch (Throwable th) {
                    CrashHelper.m81296c(new RuntimeException("activity getDeclaredMethods error", th));
                }
            }
