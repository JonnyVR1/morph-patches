...
import androidx.biometric.C0182a;
...
public class uek0 {
    ...
    public static boolean m193257a() {
        C0182a c0182aM785f = C0182a.m785f();
        return c0182aM785f != null && c0182aM785f.m791h();
    }

    /* JADX INFO: renamed from: b */
    public static boolean m193258b(@NonNull Context context, String str, int i) {
        if (str == null) {
            return false;
        }
    ...
    public static boolean m193259c(int i) {
        switch (i) {
            case 1:
            case 2:
            case 3:
    ...
    public static boolean m193260d(@NonNull Context context, String str, int i) {
        if (str == null) {
            return false;
        }
        for (String str2 : context.getResources().getStringArray(i)) {
    ...
    public static void m193261e(@NonNull String str, @Nullable FragmentActivity fragmentActivity, @Nullable Bundle bundle, @Nullable Runnable runnable) {
        ...
        if (keyguardManager == null) {
            ...
            deviceCredentialHandlerActivity.m732G0(0);
            return;
        }
        if (bundle != null) {
    ...
    public static void m193262f(@Nullable FragmentActivity fragmentActivity) {
    ...
    public static boolean m193263g(@NonNull Context context, String str) {
        if (Build.VERSION.SDK_INT != 28) {
            return false;
        }
        return m193258b(context, str, e0c0.f88561c);
    }

    /* JADX INFO: renamed from: h */
    public static boolean m193264h(@NonNull Context context, String str, String str2) {
        if (Build.VERSION.SDK_INT != 28) {
            return false;
        }
        return m193260d(context, str, e0c0.f88560b) || m193258b(context, str2, e0c0.f88559a);
    }
}
