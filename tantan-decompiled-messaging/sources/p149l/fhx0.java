...
public final class fhx0 {
    ...
    /* JADX INFO: renamed from: a */
    public static String m121470a(Context context) {
        String str = f97584a;
        if (str != null) {
            return str;
        }
        ...
        if (arrayList.isEmpty()) {
            ...
            f97584a = (String) arrayList.get(0);
                ...
                if (listQueryIntentActivities2 != null && listQueryIntentActivities2.size() != 0) {
                    ...
                    while (true) {
                        ...
                        if (arrayList.contains("com.android.chrome")) {
                            f97584a = "com.android.chrome";
                        } else if (arrayList.contains("com.chrome.beta")) {
                            f97584a = "com.chrome.beta";
                        } else if (arrayList.contains("com.chrome.dev")) {
                            f97584a = "com.chrome.dev";
                        } else if (arrayList.contains("com.google.android.apps.chrome")) {
                            f97584a = "com.google.android.apps.chrome";
                        }
                    }
                } else if (arrayList.contains(str2)) {
                    f97584a = str2;
