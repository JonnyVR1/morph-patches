...
public abstract class vm2 implements IIdentityDelegate {
    ...
    public abstract boolean init(Context context, IdentityAlgConfig identityAlgConfig, qcm qcmVar);

    public abstract void preProcess();

    public abstract boolean processImage(IDFrame iDFrame);

    public abstract void registerIdentityFaceCallback(qcm qcmVar);

    public abstract void release();

    public abstract void removeIdentityFaceCallback(qcm qcmVar);
