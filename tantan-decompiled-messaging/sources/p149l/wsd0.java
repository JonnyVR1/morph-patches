...
public final class wsd0 implements r2m {
    ...
    public FrameLayout.LayoutParams mo177611a(int layoutWidth, int layoutHeight, int videoWidth, int videoHeight, @NotNull FrameLayout.LayoutParams layoutParams) {
        ...
        Pair<Integer, Integer> pairM205478b = m205478b(layoutWidth, layoutHeight, videoWidth, videoHeight);
        int iIntValue = pairM205478b.component1().intValue();
        int iIntValue2 = pairM205478b.component2().intValue();
    ...
    public final Pair<Integer, Integer> m205478b(int layoutWidth, int layoutHeight, int videoWidth, int videoHeight) {
        float f = layoutWidth;
