...
public final class lf60 implements pzl {
    ...
    public lf60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str, @Nullable j5b0 j5b0Var) {
        act.getClass();
    ...
    public boolean mo111438a(@NotNull ef60 paymentHandlerData, @NotNull AbstractC18623n5 paymentComponent) {
        ...
        if ((!sab0.m182905w(this.purchaseType) && !sab0.m182899q(this.purchaseType)) || !TextUtils.equals(this.from, wek0.f185947a) || !paymentHandlerData.getCurrentPurchaseSection().m53531m() || !rxa0.m181501v(this.purchaseType.productCategory().toString(), paymentHandlerData.getCurrentPurchaseSection().m53520b().m53601s())) {
            return false;
        }
        km80.m146459h0(this.act, null, zl80.m219252g().m219257d(true), "p_promotion,callback_privilege_button", null);
        return true;
    }
}
