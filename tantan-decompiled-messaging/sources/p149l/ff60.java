...
public final class ff60 implements pzl {
    ...
    public ff60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str, @Nullable j5b0 j5b0Var) {
        act.getClass();
    ...
    public boolean mo111438a(@NotNull ef60 paymentHandlerData, @NotNull AbstractC18623n5 paymentComponent) {
        ...
        paymentComponent.m157932D(paymentHandlerData.getCurrentPayMethod());
        return true;
    }
}
