...
public final class hhx {
    ...
    public static /* synthetic */ void m131174r(hhx hhxVar, Boolean bool, Integer num, Integer num2, Boolean bool2, int i, Object obj) {
        if ((i & 1) != 0) {
            bool = null;
        }
        if ((i & 2) != 0) {
        ...
        hhxVar.m131191q(bool, num, num2, bool2);
    }
    ...
    public final long m131177c() {
        long j = this.startTime;
        return j == 0 ? j : (j + ((long) (this.totalDuration * 1000))) - mqi0.m155944o();
    }
    ...
    public final void m131188n(boolean z) {
        this.matchAnimPlay = z;
    }

    /* JADX INFO: renamed from: o */
    public final void m131189o(int i) {
        this.progressMax = i;
    }

    /* JADX INFO: renamed from: p */
    public final void m131190p(long j) {
        this.startTime = j;
    }

    /* JADX INFO: renamed from: q */
    public final void m131191q(@Nullable Boolean matched, @Nullable Integer totalDuration, @Nullable Integer remainCount, @Nullable Boolean selfLike) {
        if (remainCount != null) {
    ...
    public final boolean m131192s(@Nullable LoveBuzzPushData data) {
        if (data == null) {
            return false;
        }
        if (!Intrinsics.m87488d(data.buzzIntent, "intl.lovebuzz.invite") && !Intrinsics.m87488d(data.buzzIntent, "intl.lovebuzz.report") && !TextUtils.equals(data.channelToken, this.channelToken)) {
            qa2.INSTANCE.m173682b("MediaBuzzCallData", "want transDataFromPush, but token not equals channelToken " + data.channelToken + " local channelToken " + this.channelToken);
            return false;
        }
