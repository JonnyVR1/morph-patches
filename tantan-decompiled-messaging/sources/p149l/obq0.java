...
public final class obq0 extends AbstractC18843o5 {
    ...
    public boolean mo116616a(@NotNull C8765d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!sab0.m182899q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "wechat")) {
            return false;
        }
        if (NullChecker.m81303a(section.m53520b()) && section.m53531m() && section.m53520b().m53601s().semiAnnual()) {
            return true;
        }
        return NullChecker.m81303a(section.m53522d()) && section.m53522d().m53601s().semiAnnual();
    }
}
