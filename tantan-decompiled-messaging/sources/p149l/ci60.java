...
public final class ci60 implements qzl {
    ...
    public Pair<CharSequence, Boolean> mo107051a(@NotNull PayMethod payMethod, @NotNull C8765d section, boolean newFilterRule) {
        ...
        section.getClass();
        if (!newFilterRule) {
            return TEnum.equals(payMethod, "alipay") ? new Pair<>(CoreModule.m29935P().m94651a().mo33322G8(), Boolean.TRUE) : new Pair<>(CoreModule.m29935P().m94651a().mo33626xb(), Boolean.TRUE);
        }
        ...
        if (TEnum.equals(payMethod, "alipay") && listM167155x.contains(PayMethod.get("alipay"))) {
            return new Pair<>(CoreModule.m29935P().m94651a().mo33322G8(), Boolean.TRUE);
        }
        return (TEnum.equals(payMethod, "wechat") && listM167155x.contains(PayMethod.get("wechat"))) ? new Pair<>(CoreModule.m29935P().m94651a().mo33626xb(), Boolean.TRUE) : new Pair<>("", Boolean.TRUE);
    }
    ...
    public boolean mo107052b(@NotNull PayMethod payMethod) {
        payMethod.getClass();
        if (!CoreModule.m29935P().m94651a().mo33369Mi()) {
            return false;
        }
        if (TEnum.equals(payMethod, "alipay")) {
            return true;
        }
        return TEnum.equals(payMethod, "wechat") && !TextUtils.isEmpty(CoreModule.m29935P().m94651a().mo33626xb());
    }
