...
public abstract class niq0 {
    /* JADX INFO: renamed from: a */
    public static int m159552a(byte b) {
        return (((b >> 4) & 15) * 16) + (b & 15);
    }

    /* JADX INFO: renamed from: b */
    public static Bitmap m159553b(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i3 != 0) {
            ...
            if (length == 0) {
                ...
                if (i7 == 0) {
                    while (i6 < i8) {
                        int i9 = i6 * 3;
                        iArr2[i6] = m159552a(bArr[i9 + 2]) | (m159552a(bArr[i9]) << 16) | (m159552a(bArr[i9 + 1]) << 8) | RoundedDrawable.DEFAULT_BORDER_COLOR;
                        i6++;
                    }
                } else {
                    while (true) {
                        ...
                        int i10 = i6 * 3;
                        iArr2[i6] = m159552a(bArr[i10 + 2]) | (m159552a(bArr[i10]) << 16) | (m159552a(bArr[i10 + 1]) << 8) | RoundedDrawable.DEFAULT_BORDER_COLOR;
                        i6++;
                    }
                    iArr2[i5] = -16777216;
                }
            ...
            ixq0.m138884a("RGBBytes2Bitmap colors length" + iArr.length + "  width:" + i + "  height:" + i2);
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (bvk.f77458b.get(i4).equals(lowerCase)) {
                        break;
                    }
                    i4++;
                }
