...
public class s25 {
    ...
    public static boolean m182056a(Throwable th, int i) {
        return th != null && (th instanceof TantanException.Client.CoreService) && ((TantanException.Client.CoreService) th).code == i;
    }

    /* JADX INFO: renamed from: b */
    public static String m182057b(Throwable th) {
        return th != null ? th.getMessage() : "";
    }

    /* JADX INFO: renamed from: c */
    public static void m182058c(Throwable th) {
        int i;
        if (th == null) {
            return;
        }
        ...
        hfw.m130790a("[voice][call]", "error cause code = " + i + " message = " + str);
    }
}
