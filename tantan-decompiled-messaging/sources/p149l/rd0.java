...
public final class rd0 implements hml {
    ...
    public rd0(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        act.getClass();
    ...
    public CharSequence mo130527a(@NotNull fd0 requestData) {
        ...
        CharSequence charSequenceM202848M = we60.m202848M(requestData.getPrivilegeStyle());
        charSequenceM202848M.getClass();
        return charSequenceM202848M;
    }
    ...
    public boolean mo130528b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.m182906x(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
