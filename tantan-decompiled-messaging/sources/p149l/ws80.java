...
public class ws80 {
    ...
    public static kq2 m205472a(MonetizationPromotionsId monetizationPromotionsId, Merchandise merchandise) {
        ...
        switch (string) {
            ...
            default:
                CrashHelper.m81296c(new Exception("unknow Promotion== " + monetizationPromotionsId));
                return null;
        }
    }
}
