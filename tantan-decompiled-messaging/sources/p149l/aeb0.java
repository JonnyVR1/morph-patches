...
public class aeb0 {
    ...
    public gu2 beautifyScale;

    @SerializedName("beauty_config")
    public ju2 beautyConfig;

    @SerializedName("cam")
    private h84 cam;

    @SerializedName("comm_parms")
    public vf5 commParms;
