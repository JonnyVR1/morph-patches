...
public final class d590 extends AbstractC15528a5 {
    ...
    public d590(@NotNull PrivilegeEntranceView.C8293a c8293a) {
        super(c8293a);
        c8293a.getClass();
    }

    /* JADX INFO: renamed from: q */
    public static Boolean m110040q(Merchandise merchandise) {
        merchandise.getClass();
        return Boolean.valueOf(TEnum.equals(merchandise.category, ProductCategory.get(ProductCategory.tttVip)));
    }

    /* JADX INFO: renamed from: s */
    public static int m110042s(Function2 function2, Object obj, Object obj2) {
        return ((Number) function2.invoke(obj, obj2)).intValue();
    }

    /* JADX INFO: renamed from: t */
    public static int m110043t(Merchandise merchandise, Merchandise merchandise2) {
        merchandise.getClass();
    ...
    private final Merchandise m110044u(List<? extends Merchandise> merchandises) {
        ...
        final Function2 function2 = new Function2() { // from class: l.b590
            ...
            public final Object invoke(Object obj, Object obj2) {
                return Integer.valueOf(d590.m110043t((Merchandise) obj, (Merchandise) obj2));
            }
        };
        Collections.sort(merchandises, new Comparator() { // from class: l.c590
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return d590.m110042s(function2, obj, obj2);
            }
        });
        return merchandises.get(0);
    }
    ...
    public static final void m110045w(d590 d590Var, View view) {
        zvf0.m220396r(d590Var.mo94542h(), d590Var.m94952f());
        if (sj20.m184407a().m184412f()) {
            String strMo33339Ie = CoreModule.m29935P().m94651a().mo33339Ie();
            strMo33339Ie.getClass();
            d590Var.m94957o(strMo33339Ie);
        } else {
            String strMo33447Y3 = CoreModule.m29935P().m94651a().mo33447Y3();
            strMo33447Y3.getClass();
            d590Var.m94957o(strMo33447Y3);
        }
    }

    /* JADX INFO: renamed from: x */
    public static final void m110046x(d590 d590Var, View view) {
        zvf0.m220396r(d590Var.m110047v(), d590Var.m94952f());
    ...
    public boolean mo94540a() {
        Merchandise merchandiseM110044u = m110044u(vwb.m200339n(zl80.m219252g().m219257d(false), new w9j() { // from class: l.y490
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return d590.m110040q((Merchandise) obj);
            }
        }));
        this.lowPriceCallback3VIPMerchandise = merchandiseM110044u;
        return NullChecker.m81303a(merchandiseM110044u);
    }
    ...
    public void mo94544m() {
        ...
        if (privilegeEntranceSingleTextView != null) {
            ...
            xdl0.m208329E0(privilegeEntranceSingleTextView, new View.OnClickListener() { // from class: l.z490
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    d590.m110045w(this.f201447a, view);
                }
            });
        }
        ...
        if (privilegeEntrancePromotionBottomView != null) {
            ...
            xdl0.m208329E0(privilegeEntrancePromotionBottomView.get_goto_buy(), new View.OnClickListener() { // from class: l.a590
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    d590.m110046x(this.f67641a, view);
                }
            });
            Merchandise merchandise3 = this.lowPriceCallback3VIPMerchandise;
            zvf0.m220368A("e_purchase_banner", OMSDialogPositon.p_navigation_view, vwb.m200311Y(BLiveOperationTitleShowType.duration, (merchandise3 != null ? Integer.valueOf(merchandise3.quantity) : null) + "m"), vwb.m200311Y("discount_type", "low_price_recall"), vwb.m200311Y("productType", "vip"));
        }
    }

    @NotNull
    /* JADX INFO: renamed from: v */
    public String m110047v() {
