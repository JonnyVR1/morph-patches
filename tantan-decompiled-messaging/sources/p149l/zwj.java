...
public class zwj extends ir2 {
    ...
    public List<String> mo103901b(BLiveTemplateItem bLiveTemplateItem, Template.TemplateData templateData, crc0 crc0Var) {
        ...
        return (crc0Var == null || (liveChatMessage = crc0Var.f82200d) == null) ? vwb.m200324f0(new String[0]) : vwb.m200324f0(liveChatMessage.getGift().getUrl());
    }
