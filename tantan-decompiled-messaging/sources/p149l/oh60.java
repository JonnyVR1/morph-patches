...
public final class oh60 extends AbstractC20103t4 {
    ...
    public oh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        request.getClass();
        return sab0.m182895m(this.purchaseType) && request.getPurchaseSection().m53531m() && rxa0.m181500u(request.getPurchaseSection().m53520b().m53601s());
    }
}
