...
public class ddj0 {
    ...
    public static <T> Spannable m111020a(Context context, int i, CharSequence... charSequenceArr) {
    ...
    public static boolean m111021b(CharSequence charSequence) {
        return !TextUtils.isEmpty(charSequence);
    }

    /* JADX INFO: renamed from: c */
    public static Spannable m111022c(String str) {
    ...
    public static <T> CharSequence m111023d(List<CharSequence> list, String str) {
        if (list == null) {
            return null;
        }
    ...
    public static String m111024e(String str) {
        return str != null ? Pattern.compile("\r|\n").matcher(str).replaceAll("") : "";
    }

    /* JADX INFO: renamed from: f */
    public static Spannable m111025f(String str, String str2, CharacterStyle characterStyle) {
        SpannableString spannableString = new SpannableString(str);
    ...
    public static String m111026g(long j) {
        long j2 = j / 1000;
        long j3 = j2 / 60;
