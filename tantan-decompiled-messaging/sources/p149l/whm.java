...
public class whm {
    ...
    private static byte[] f186444a;

    @RequiresApi(api = 19)
    /* JADX INFO: renamed from: a */
    public static byte[] m203222a(Image image, int i, byte[] bArr) {
        int i2;
        byte[] bArr2;
        int i3 = i;
        byte[] bArr3 = bArr;
        ...
        if (bArr4 == null || bArr4.length != planes[0].getRowStride()) {
            f186444a = new byte[planes[0].getRowStride()];
        }
        int i7 = 1;
        int i8 = 0;
        int i9 = 0;
        while (i8 < planes.length) {
            ...
            while (i13 < i12) {
                if (pixelStride == 1 && i7 == 1) {
                    ...
                    bArr2 = bArr3;
                    buffer.get(f186444a, 0, i2);
                    for (int i14 = 0; i14 < i11; i14++) {
                        bArr2[i9] = f186444a[i14 * pixelStride];
                        i9 += i7;
                    }
                }
                if (i13 < i12 - 1) {
    ...
    private static boolean m203223b(Image image) {
        int format = image.getFormat();
