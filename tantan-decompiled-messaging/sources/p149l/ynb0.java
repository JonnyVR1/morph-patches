...
public class ynb0 extends jq2<aob0> {
    ...
    public /* synthetic */ void m215402g0(Bundle bundle) {
        ((aob0) this.viewModel).m97881d(this.f199152b, this.f199151a);
    }

    /* JADX INFO: renamed from: h0 */
    public static String m215403h0(String str) {
        if (!IntlCountryCodeController.m28126v() || str == null) {
            return str;
        }
        switch (str) {
    ...
    public void m215404f0() {
        creates(new e30() { // from class: l.xnb0
            @Override // p149l.e30
            public final void call(Object obj) {
                this.f193652a.m215402g0((Bundle) obj);
            }
        });
    }

    /* JADX INFO: renamed from: i0 */
    public void m215405i0(int i, String str) {
        this.f199151a = i;
        this.f199152b = str;
    }

    /* JADX INFO: renamed from: j0 */
    public List<Object> m215406j0() {
        return vwb.m200324f0(FirebaseAnalytics.Param.INDEX, Integer.valueOf(this.f199151a), ag3.f69253b);
    }
