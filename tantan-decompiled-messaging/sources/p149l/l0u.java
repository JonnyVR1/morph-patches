...
@Metadata(m87231d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001d\u0010\t\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\t\u0010\nJ\u001f\u0010\u000b\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\u000b\u0010\nJ\u0017\u0010\u000e\u001a\u00020\r2\u0006\u0010\f\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u000e\u0010\u000f¨\u0006\u0010"}, m87232d2 = {"Ll/l0u;", "", "<init>", "()V", "Lcom/p1/mobile/putong/live/external/internal/live/square/api/LiveSquareTabBean;", "liveSquareTab", "Lcom/tantan/live/home/eventbus/LiveHomeEventBus;", "eventBus", "Lcom/p1/mobile/putong/live/external/square/fragments/LiveVPagerBaseFrag;", Constants.INAPP_DATA_TAG, "(Lcom/p1/mobile/putong/live/external/internal/live/square/api/LiveSquareTabBean;Lcom/tantan/live/home/eventbus/LiveHomeEventBus;)Lcom/p1/mobile/putong/live/external/square/fragments/LiveVPagerBaseFrag;", "c", "tab", "Lcom/p1/mobile/putong/live/base/data/BLiveSquareTab;", "b", "(Lcom/p1/mobile/putong/live/external/internal/live/square/api/LiveSquareTabBean;)Lcom/p1/mobile/putong/live/base/data/BLiveSquareTab;", "external_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
public final class l0u {

    @NotNull
    public static final l0u INSTANCE = new l0u();

    /* JADX INFO: renamed from: a */
    public static LiveHomeEventBus m148118a(LiveHomeEventBus liveHomeEventBus) {
        return liveHomeEventBus;
    }

    /* JADX INFO: renamed from: b */
    public final BLiveSquareTab m148119b(LiveSquareTabBean tab) {
        BLiveSquareTab bLiveSquareTabNew_ = BLiveSquareTab.new_();
        bLiveSquareTabNew_.title = tab.getName();
        bLiveSquareTabNew_.f44441id = tab.getTabId();
    ...
    public final LiveVPagerBaseFrag m148120c(LiveSquareTabBean liveSquareTab, final LiveHomeEventBus eventBus) {
        ...
        if (str != null) {
            switch (str) {
                ...
                case "square-nearby":
                    ...
                    break;
                case "videoChat":
                    liveSquareCommonFeedFrag = LiveVideoChatFrag.m69137m5("source_live_square");
        ...
        arguments.putSerializable(LiveSquareBaseFrag.ARGS_TAB_INFO, m148119b(liveSquareTab));
        liveSquareCommonFeedFrag.setArguments(arguments);
        liveSquareCommonFeedFrag.m70817i5(new v9j() { // from class: l.k0u
            @Override // p149l.v9j, java.util.concurrent.Callable
            public final Object call() {
                return l0u.m148118a(eventBus);
            }
        });
    ...
    public final LiveVPagerBaseFrag m148121d(@NotNull LiveSquareTabBean liveSquareTab, @NotNull LiveHomeEventBus eventBus) {
        liveSquareTab.getClass();
        eventBus.getClass();
        return m148120c(liveSquareTab, eventBus);
    }
}
