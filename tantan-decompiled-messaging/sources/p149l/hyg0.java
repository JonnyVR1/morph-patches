...
public final class hyg0 {
    ...
    public static void m133610a(e30 e30Var, View view) {
        e30Var.call(0);
    }

    @Nullable
    /* JADX INFO: renamed from: b */
    public final View m133611b(@NotNull Act act, @NotNull ViewGroup root) {
        act.getClass();
        root.getClass();
        View viewInflate = LayoutInflater.from(act).inflate(m6c0.f131567b0, root, false);
    ...
    public final void m133612c(@NotNull Act act) {
        act.getClass();
        m133613d();
    }

    /* JADX INFO: renamed from: d */
    public final void m133613d() {
        VText vText = this._feature_name_text;
        if (vText != null) {
            vText.setText(this.act.getString(IntlCountryCodeController.m28126v() ? R$string.f27676z8 : R$string.f27221L9));
        }
        VText vText2 = this._promotional_text;
        if (vText2 != null) {
            vText2.setText(this.act.getString(R$string.f27186I7));
        }
    ...
    public final void m133614e(@NotNull final e30<Integer> dismiss) {
        dismiss.getClass();
        xdl0.m208329E0(this._image_close, new View.OnClickListener() { // from class: l.gyg0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                hyg0.m133610a(dismiss, view);
            }
        });
    }
}
