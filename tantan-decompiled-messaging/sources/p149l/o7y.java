...
public class o7y extends o0n {
    ...
    public final String f142549h = "ca-app-pub-6567608331519569/1764451305";

    /* JADX INFO: renamed from: l.o7y$a */
    public class C18866a implements C22306c.a<Pair<e520, String>> {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ Context f142550a;

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ String f142551b;

        /* JADX INFO: renamed from: l.o7y$a$a */
        public class a extends h70 {

            /* JADX INFO: renamed from: a */
            public final /* synthetic */ z3g0 f142553a;

            public a(z3g0 z3g0Var) {
                this.f142553a = z3g0Var;
            }

            @Override // p149l.h70
            public void onAdClicked() {
                super.onAdClicked();
                zvf0.m220399u("e_intl_meet_avatar_click", "p_intl_meet_view", vwb.m200311Y("avatar_click_from", "visitor_ad"));
            }
            ...
            public void mo29990x(@NonNull irv irvVar) {
                ...
                irvVar.toString();
                this.f142553a.m132487l(new Pair(null, C18866a.this.f142551b));
            }
        }

        public C18866a(Context context, String str) {
            this.f142550a = context;
            this.f142551b = str;
        }
        ...
        public void call(final z3g0<? super Pair<e520, String>> z3g0Var) {
            j70.C17709a c17709a = new j70.C17709a(this.f142550a, this.f142551b);
            final String str = this.f142551b;
            c17709a.m140068b(new e520.InterfaceC16544c() { // from class: l.n7y
    ...
    private View m163070l(Act act, e520 e520Var) {
        if (e520Var == null) {
            return null;
        }
        NativeAdView nativeAdView = (NativeAdView) LayoutInflater.from(act).inflate(f6c0.f96076x3, (ViewGroup) null);
    ...
    private C22306c<Pair<e520, String>> m163071n(Context context, String str) {
        return C22306c.create(new C18866a(context, str));
    }
    ...
    public final /* synthetic */ View m163072m(Act act, Pair pair) {
        if (!NullChecker.m81303a(pair.first)) {
            return null;
        }
        e520 e520Var = (e520) pair.first;
        this.f141343a = e520Var;
        return m163070l(act, e520Var);
    }

    /* JADX INFO: renamed from: o */
    public final C22306c<View> m163073o(final Act act) {
        return act.duringCreated(m163071n(act, "ca-app-pub-6567608331519569/1764451305")).observeOn(jo0.m142408a()).map(new w9j() { // from class: l.m7y
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return this.f132498a.m163072m(act, (Pair) obj);
            }
        });
    }
}
