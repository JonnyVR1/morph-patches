...
@Metadata(m87231d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\b\b\b\u0000\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ'\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\rH\u0017¢\u0006\u0004\b\u0010\u0010\u0011J#\u0010\u0013\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\r0\u00122\u0006\u0010\u000b\u001a\u00020\nH\u0017¢\u0006\u0004\b\u0013\u0010\u0014J!\u0010\u0015\u001a\u0004\u0018\u00010\r2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\nH\u0017¢\u0006\u0004\b\u0015\u0010\u0016R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0017R\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0018R\u0014\u0010\u0007\u001a\u00020\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0019¨\u0006\u001a"}, m87232d2 = {"Ll/n7k0;", "Ll/m7k0;", "Ll/t5c;", "dbHelper", "Ll/nul;", "logger", "Ll/vzb;", "dbEncryptionHandler", "<init>", "(Ll/t5c;Ll/nul;Ll/vzb;)V", "", "accountId", Constants.DEVICE_ID_TAG, "Lorg/json/JSONObject;", "profile", "", "b", "(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)J", "", "c", "(Ljava/lang/String;)Ljava/util/Map;", "a", "(Ljava/lang/String;Ljava/lang/String;)Lorg/json/JSONObject;", "Ll/t5c;", "Ll/nul;", "Ll/vzb;", "clevertap-core_release"}, m87233k = 1, m87234mv = {2, 0, 0}, m87236xi = 48)
public final class n7k0 implements m7k0 {
    ...
    public n7k0(@NotNull t5c t5cVar, @NotNull nul nulVar, @NotNull vzb vzbVar) {
        t5cVar.getClass();
        nulVar.getClass();
        vzbVar.getClass();
    ...
    public JSONObject mo153377a(@NotNull String accountId, @NotNull String deviceId) {
                ...
                try {
                    try {
                        if (cursor2.moveToFirst()) {
                            ...
                            if (columnIndex >= 0) {
                                String strM200737b = this.dbEncryptionHandler.m200737b(cursor2.getString(columnIndex));
                                if (strM200737b != null) {
                                    jSONObject = new JSONObject(strM200737b);
                                } else {
                    ...
                    try {
                        ...
                        CloseableKt.m87404a(cursor, th2);
                        throw th3;
                    }
                }
                jSONObject = null;
    ...
    public long mo153378b(@NotNull String accountId, @NotNull String deviceId, @NotNull JSONObject profile) {
        accountId.getClass();
        deviceId.getClass();
        profile.getClass();
    ...
    public Map<String, JSONObject> mo153379c(@NotNull String accountId) {
        accountId.getClass();
        ...
        try {
            ...
            try {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    String strM200737b = this.dbEncryptionHandler.m200737b(string);
                    if (strM200737b != null) {
                        linkedHashMap.put(string2, new JSONObject(strM200737b));
                    } else {
