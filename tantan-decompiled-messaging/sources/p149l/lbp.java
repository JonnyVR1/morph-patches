...
public class lbp {
    ...
    public final NDayCountedValue f127325a = new NDayCountedValue("live_side_default_open", false);

    /* JADX INFO: renamed from: a */
    public void m149259a() {
        this.f127325a.m76345a();
    }

    /* JADX INFO: renamed from: b */
    public final boolean m149260b() {
        return ypv.m215672k().m195941s7() && LiveWatchCounter.m76330h().m76339n();
    }

    /* JADX INFO: renamed from: c */
    public boolean m149261c(String str) {
        ...
        boolean z = LiveWatchCounter.m76330h().m76337l() >= bLiveEntranceM195616E4.defaultOpen.conditions.continousUnwatchDays;
        int iM76347c = this.f127325a.m76347c();
        int iM76346b = this.f127325a.m76346b(bLiveInRoomSideBarEntranceM195904o5.defaultOpenParas.maxOpenPerNDays.f44420n);
