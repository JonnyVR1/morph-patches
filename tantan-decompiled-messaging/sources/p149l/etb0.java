...
public final /* data */ class etb0 {
    ...
    public etb0(@NotNull User user, @NotNull TextCardData textCardData) {
        user.getClass();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof etb0)) {
            return false;
        }
        etb0 etb0Var = (etb0) other;
        return Intrinsics.m87488d(this.user, etb0Var.user) && Intrinsics.m87488d(this.textCardData, etb0Var.textCardData);
    }
