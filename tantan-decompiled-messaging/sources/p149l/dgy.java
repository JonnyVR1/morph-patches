...
@Metadata(m87231d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0007\u0018\u0000 \u001c2\u00020\u0001:\u0001\u001dB\u001f\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\u0006\u0010\u0006\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\n\u001a\u00020\tH\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\f\u001a\u00020\tH\u0016¢\u0006\u0004\b\f\u0010\u000bJ\u000f\u0010\r\u001a\u00020\tH\u0016¢\u0006\u0004\b\r\u0010\u000bJ\u000f\u0010\u000e\u001a\u00020\tH\u0016¢\u0006\u0004\b\u000e\u0010\u000bJ+\u0010\u0014\u001a\u00020\t2\u0012\u0010\u0011\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00100\u000f2\u0006\u0010\u0013\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0014\u0010\u0015J\u000f\u0010\u0016\u001a\u00020\tH\u0016¢\u0006\u0004\b\u0016\u0010\u000bJ\u000f\u0010\u0018\u001a\u00020\u0017H\u0016¢\u0006\u0004\b\u0018\u0010\u0019J\u000f\u0010\u001a\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u001a\u0010\u001b¨\u0006\u001e"}, m87232d2 = {"Ll/dgy;", "Ll/dg2;", "Lcom/p1/mobile/android/app/Act;", SocialConstants.PARAM_ACT, "", "pageType", "modeType", "<init>", "(Lcom/p1/mobile/android/app/Act;Ljava/lang/String;Ljava/lang/String;)V", "", "r", "()V", "q", ResourceDirection.f38808v, "f0", "Ll/j760;", "", "pair", "", StickerBundle.TYPE, "j0", "(Ll/j760;Z)V", "B", "", "M", "()I", "I", "()Ljava/lang/String;", "Companion", "a", "buzz_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
public final class dgy extends dg2 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public dgy(@NotNull Act act, @NotNull String str, @NotNull String str2) {
        super(act, str, str2);
        act.getClass();
        str.getClass();
        str2.getClass();
    ...
    public void mo111561B() {
        super.mo111561B();
        m111589h0("p_buzz_memoji_connecting");
    }
    ...
    public void mo111587f0() {
        super.mo111587f0();
        m111589h0("p_intl_buzz_memoji_waiting");
    }
    ...
    public void mo111591j0(@NotNull j760<String, Object> pair, boolean bundle) {
        ...
        if (loveBuzzDataM140468v0 == null || (i = loveBuzzDataM140468v0.remainingMemojiBuzz) == getNOT_LIMIT_VALUE()) {
            return;
        }
        loveBuzzDataM140468v0.remainingMemojiBuzz = C15167a.m87596b(i - 1, 0);
    ...
    public void mo111598q() {
        super.mo111598q();
        m111589h0("p_buzz_memoji_searching");
    }
    ...
    public void mo111599r() {
        ...
        m111581Y().getHierarchy().m112050E(null);
        m111581Y().getHierarchy().m112053H(null);
        ViewGroup.LayoutParams layoutParams = m111581Y().getLayoutParams();
        int iM186890d = t100.m186890d(140.0f);
        layoutParams.width = iM186890d;
        layoutParams.height = iM186890d;
        m111581Y().setLayoutParams(layoutParams);
        if (!m111604z("memojiBuzz")) {
            m111589h0("p_buzz_memoji_searching");
            return;
        }
        j8w.Companion companion = j8w.INSTANCE;
    ...
    public void mo111601v() {
        super.mo111601v();
        m111589h0("p_intl_buzz_memoji_paired");
        p9w.INSTANCE.m167946o("memojiBuzz");
    }
}
