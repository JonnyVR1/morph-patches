...
public final class nd0 implements hml {
    ...
    public CharSequence mo130527a(@NotNull fd0 requestData) {
        ...
        if (requestData.getPrivilegeStyle()) {
            CharSequence charSequenceM202838C = we60.m202838C(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), we60.m202853R(true));
            charSequenceM202838C.getClass();
            return charSequenceM202838C;
        }
        CharSequence charSequenceM202838C2 = we60.m202838C(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), we60.m202853R(false));
        charSequenceM202838C2.getClass();
        return charSequenceM202838C2;
    }
    ...
    public boolean mo130528b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.m182897o(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
