...
public class fce {
    ...
    public static ftd0 f96792a = new C16796a();

    /* JADX INFO: renamed from: l.fce$a */
    public class C16796a implements ftd0 {
        @Override // p149l.ftd0
        /* JADX INFO: renamed from: a */
    ...
    /* JADX INFO: renamed from: a */
    public static Drawable m120424a(double d, double d2, double d3, GradientDrawable.Orientation orientation) {
    ...
    public static Drawable m120425b(int i, float f) {
    ...
    public static Drawable m120426c(int i, float[] fArr) {
        PaintDrawable paintDrawable = new PaintDrawable();
