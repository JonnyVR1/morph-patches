...
public final class tmg0 implements InterfaceC22400a.a {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ h8g0 f171152a;

    public tmg0(h8g0 h8g0Var) {
        this.f171152a = h8g0Var;
    }
    ...
    public final void mo95422a(String str) {
        ...
        if (qkg0.f155121a != null) {
            ...
            if (erg0.f92916m) {
                SudLogger.m221573w("WXGame", "触发了：GameViewOnSurfaceCreated");
            }
        }
        icg0 icg0Var = this.f171152a.f106417h;
