...
public final class ofn extends d1q<FrameLayout> {
    ...
    public static void m164104H(ofn ofnVar, View view) {
        ...
        if (imageView.isSelected() || ofnVar.canSelectedMoreAction.invoke().booleanValue()) {
            ...
            mfnVar.m154396d(imageView5.isSelected());
    ...
    public void mo70566u(@NotNull FrameLayout itemView) {
        ...
        xdl0.m208345M0(itemView.findViewById(g5c0.f101095x4), this.shareItemDataIntl.getIsOnline());
        hxs.m133408u("context_single_room", (SimpleDraweeView) itemView.findViewById(g5c0.f101108z), this.shareItemDataIntl.getUserMask().avatar, t100.m186890d(55.0f), t100.m186890d(55.0f));
        ...
        ((TextView) itemView.findViewById(g5c0.f100802S1)).setText(this.shareItemDataIntl.getUserMask().name);
        ...
        xdl0.m208329E0(imageView2, new View.OnClickListener() { // from class: l.nfn
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ofn.m164104H(this.f138805a, view);
            }
        });
    }
