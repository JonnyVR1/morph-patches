...
public class ir4<T> extends ChannelFlow<T> {
    ...
    public ir4(@NotNull Function2<? super ad90<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull CoroutineContext coroutineContext, int i, @NotNull BufferOverflow bufferOverflow) {
        super(coroutineContext, i, bufferOverflow);
        this.block = function2;
    }

    /* JADX INFO: renamed from: l */
    public static /* synthetic */ <T> Object m137820l(ir4<T> ir4Var, ad90<? super T> ad90Var, Continuation<? super Unit> continuation) {
        Object objInvoke = ir4Var.block.invoke(ad90Var, continuation);
    ...
    public Object mo94063f(@NotNull ad90<? super T> ad90Var, @NotNull Continuation<? super Unit> continuation) {
        return m137820l(this, ad90Var, continuation);
    }
