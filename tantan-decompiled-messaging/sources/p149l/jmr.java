...
public class jmr extends ReplacementSpan implements UpdateAppearance {
    ...
    public void draw(@NonNull Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, @NonNull Paint paint) {
        ...
        paint.setColor(-1);
        float f2 = i4;
        paint.setShader(new LinearGradient(f, f2, f + fMeasureText, f2, this.f118700a, this.f118701b, Shader.TileMode.CLAMP));
