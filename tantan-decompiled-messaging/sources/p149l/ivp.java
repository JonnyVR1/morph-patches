...
public final class ivp extends d1q<IntlVoiceLiveManagerInviteItemView> {
    ...
    public void mo70566u(@Nullable IntlVoiceLiveManagerInviteItemView itemView) {
        super.mo70566u(itemView);
        if (itemView != null) {
            itemView.m78265k0(this.itemInfo, this.action);
        }
    }
