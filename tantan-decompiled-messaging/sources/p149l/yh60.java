...
public final class yh60 extends AbstractC20103t4 {
    ...
    public yh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo136186b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        if (TextUtils.equals(getFrom(), "purchasePage")) {
            response.m101981k(aVarM187136g.m53603u() + "元秒杀");
            return;
        }
        response.m101984n(aVarM187136g.m53603u() + "元秒杀");
    }
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        request.getClass();
        m187136g(request.getPurchaseSection());
        return false;
    }
}
