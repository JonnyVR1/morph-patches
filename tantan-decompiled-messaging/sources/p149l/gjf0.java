...
public class gjf0 extends ydk {
    ...
    private ejf0 f103035a;

    /* JADX INFO: renamed from: b */
    private float f103036b = 0.8f;
    ...
    public gjf0() {
        ...
        this.f103035a = new ejf0(0.8f);
        apd0Var.addTarget(wsi0Var);
        apd0Var.addTarget(dcc0Var);
        apd0Var.addTarget(this.f103035a);
        wsi0Var.addTarget(this.f103035a);
        dcc0Var.addTarget(this.f103035a);
        this.f103035a.registerFilterLocation(apd0Var, 0);
        this.f103035a.registerFilterLocation(wsi0Var, 1);
        this.f103035a.registerFilterLocation(dcc0Var, 2);
        this.f103035a.addTarget(this);
        registerInitialFilter(apd0Var);
        registerFilter(wsi0Var);
        registerFilter(dcc0Var);
        registerTerminalFilter(this.f103035a);
    }

    public void setSmoothLevel(float f) {
        synchronized (getLockObject()) {
            this.f103035a.m116840Q1(f);
        }
    }
}
