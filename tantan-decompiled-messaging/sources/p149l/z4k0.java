...
public final /* data */ class z4k0 {
    ...
    public z4k0(@NotNull String str, @NotNull String str2, long j, long j2, int i, @NotNull String str3) {
        str.getClass();
        str2.getClass();
        str3.getClass();
        this.eventName = str;
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof z4k0)) {
            return false;
        }
        z4k0 z4k0Var = (z4k0) other;
        return Intrinsics.m87488d(this.eventName, z4k0Var.eventName) && Intrinsics.m87488d(this.normalizedEventName, z4k0Var.normalizedEventName) && this.firstTs == z4k0Var.firstTs && this.lastTs == z4k0Var.lastTs && this.countOfEvents == z4k0Var.countOfEvents && Intrinsics.m87488d(this.deviceID, z4k0Var.deviceID);
    }
