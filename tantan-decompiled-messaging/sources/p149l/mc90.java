...
public class mc90 {
    ...
    private static volatile String f133087a;
    ...
    /* JADX INFO: renamed from: a */
    public static String m153989a(Context context) {
        ActivityManager activityManager;
        List<ActivityManager.RunningAppProcessInfo> runningAppProcesses;
        ActivityManager.RunningAppProcessInfo runningAppProcessInfo;
        int i;
        if (!TextUtils.isEmpty(f133087a)) {
            return f133087a;
        }
        int iMyPid = Process.myPid();
        if (context != null && iMyPid > 0) {
            if (Build.VERSION.SDK_INT >= 28) {
                f133087a = Application.getProcessName();
                return f133087a;
            }
                    ...
                    if (activityManager != null) {
                        ...
                        if (runningAppProcesses != null) {
                            ...
                            if (runningAppProcessInfo != null && !TextUtils.isEmpty(runningAppProcessInfo.processName)) {
                                f133087a = runningAppProcessInfo.processName;
                                return f133087a;
                            }
                        }
                    }
