...
public final class igm0 extends d1q<LiveVoiceAuctionRelationListItem> {
    ...
    public igm0(@NotNull BLiveAuctionRelationCard bLiveAuctionRelationCard, int i, @NotNull String str) {
    ...
    public void mo70566u(@NotNull LiveVoiceAuctionRelationListItem itemView) {
        itemView.getClass();
        super.mo70566u(itemView);
        itemView.m77867d(this);
        itemView.setOnLongClickListener(this.longClickListener);
    }

    /* JADX INFO: renamed from: L */
    public final void m136079L(@NotNull View.OnLongClickListener onLongClickListener) {
