...
public class sij extends pdj0 {
    ...
    public sij(float f) {
        ...
        this.f164718a = fFloor + (fFloor % 2.0f);
    }

    /* JADX INFO: renamed from: Q1 */
    public static final String m184341Q1(float f, float f2) {
        float f3;
        double d;
    ...
    public static final String m184342R1(float f, float f2) {
        float f3;
    ...
    public String getFragmentShader() {
        float f = this.f164718a;
        return m184341Q1(f, f);
    }

    @Override // p149l.ccj
    public String getVertexShader() {
        float f = this.f164718a;
        return m184342R1(f, f);
    }

    @Override // p149l.pdj0, p149l.ccj
