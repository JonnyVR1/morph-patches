...
public final class x9p extends bqd0<BLiveIntlTemplateData> {
    ...
    public BLiveIntlTemplateData copyed(@Nullable BLiveIntlTemplateData to, @NotNull BLiveIntlTemplateData from) {
        from.getClass();
        BLiveIntlTemplateData bLiveIntlTemplateDataMo223809clone = from.mo223809clone();
        bLiveIntlTemplateDataMo223809clone.getClass();
        return bLiveIntlTemplateDataMo223809clone;
    }
