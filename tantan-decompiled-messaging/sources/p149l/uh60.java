...
public final class uh60 extends AbstractC20103t4 {
    ...
    public uh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
