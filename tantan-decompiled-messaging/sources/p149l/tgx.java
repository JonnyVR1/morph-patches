...
public final class tgx implements nqm {
    ...
    public static void m188829j(Function0 function0, View view) {
        function0.getClass();
        function0.invoke();
    }

    /* JADX INFO: renamed from: l */
    private final void m188831l(boolean isFullScreen) {
        ImageButton imageButton;
        ImageButton imageButton2;
        int i = isFullScreen ? R.drawable.exo_icon_fullscreen_exit : R.drawable.exo_icon_fullscreen_enter;
        PlayerView playerView = this.playerView;
        if (playerView != null && (imageButton2 = (ImageButton) playerView.findViewById(c4c0.f79251u)) != null) {
            imageButton2.setImageResource(i);
        }
        PlayerView playerView2 = this.playerView;
        if (playerView2 == null || (imageButton = (ImageButton) playerView2.findViewById(c4c0.f79253v)) == null) {
            return;
        }
    ...
    public static final void m188832m(tgx tgxVar, ImageButton imageButton, ImageButton imageButton2, View view) {
        tgxVar.getClass();
        imageButton.getClass();
        boolean z = tgxVar.isMuted;
        tgxVar.isMuted = !z;
        ExoPlayer exoPlayer = tgxVar.player;
        if (exoPlayer != null) {
            exoPlayer.setVolume(!z ? 0.0f : 1.0f);
        }
        boolean z2 = tgxVar.isMuted;
    ...
    public void mo160627c(@NotNull final Function0<Unit> onClick) {
        ...
        onClick.getClass();
        PlayerView playerView = this.playerView;
        if (playerView == null || (imageButton = (ImageButton) playerView.findViewById(c4c0.f79235m)) == null) {
            return;
        }
        imageButton.setVisibility(0);
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: l.pgx
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                tgx.m188829j(onClick, view);
            }
        });
    }
    ...
    public void mo160631g() {
        ...
        PlayerView playerView = this.playerView;
        if (playerView == null || (imageButton = (ImageButton) playerView.findViewById(c4c0.f79257x)) == null) {
            return;
        }
        PlayerView playerView2 = this.playerView;
        final ImageButton imageButton2 = playerView2 != null ? (ImageButton) playerView2.findViewById(c4c0.f79255w) : null;
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: l.qgx
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                tgx.m188832m(this.f154388a, imageButton, imageButton2, view);
            }
        };
    ...
    public void mo160632h(@NotNull final Function1<? super Boolean, Unit> onClick) {
        ...
        PlayerView playerView = this.playerView;
        if (playerView != null) {
            playerView.setFullscreenButtonClickListener(new PlayerView.FullscreenButtonClickListener() { // from class: l.rgx
            });
        }
        m188831l(false);
    }
    ...
    public void mo160633i(@NotNull Context context, boolean isTablet) {
        ...
        PlayerView playerViewInflate = LayoutInflater.from(context).inflate(a7c0.f67893b, (ViewGroup) null);
        ...
        playerView.setDefaultArtwork(ywc0.m216334e(context.getResources(), q3c0.f152400a, null));
