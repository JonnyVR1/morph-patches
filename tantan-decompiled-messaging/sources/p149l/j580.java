...
public final class j580 extends AbstractC18843o5 {
    ...
    public boolean mo116616a(@NotNull C8765d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        return p2b0.m167133h().m167157z() && sab0.m182897o(getPurchaseType()) && NullChecker.m81303a(section) && NullChecker.m81303a(section.m53520b()) && section.m53520b().m53601s().yearly();
    }
}
