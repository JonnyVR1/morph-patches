...
@Metadata(m87231d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u0000 \u00112\u00020\u0001:\u0001\u0012B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\n\u001a\u00020\tH\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\r\u001a\u00020\fH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u000f\u0010\bJ\u000f\u0010\u0010\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u0010\u0010\b¨\u0006\u0013"}, m87232d2 = {"Ll/iz80;", "Ll/gy80;", "Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntranceView$a;", "privilegeEntranceInfo", "<init>", "(Lcom/p1/mobile/putong/core/ui/banner/view/PrivilegeEntranceView$a;)V", "", "q", "()Ljava/lang/String;", "", "r", "()Z", "", "m", "()V", "h", ResourceDirection.f38808v, "Companion", "a", "pay_intlGmsRelease"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
public final class iz80 extends gy80 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public iz80(@NotNull PrivilegeEntranceView.C8293a c8293a) {
        super(c8293a);
        c8293a.getClass();
    }

    /* JADX INFO: renamed from: t */
    public static Boolean m139027t(Merchandise merchandise) {
        merchandise.getClass();
        return Boolean.valueOf(TEnum.equals(merchandise.category, ProductCategory.get(ProductCategory.tttVip)));
    }

    /* JADX INFO: renamed from: w */
    public static final void m139029w(iz80 iz80Var) {
        zvf0.m220396r(iz80Var.m139031v(), iz80Var.m94952f());
    }

    /* JADX INFO: renamed from: x */
    public static final void m139030x(iz80 iz80Var, View view) {
        String strMo33447Y3 = CoreModule.m29935P().m94651a().mo33447Y3();
        strMo33447Y3.getClass();
        iz80Var.m94957o(strMo33447Y3);
        zvf0.m220396r(iz80Var.mo94542h(), iz80Var.m94952f());
    ...
    public void mo94544m() {
        ...
        if (privilegeEnhancedPromotionBannerView != null) {
            privilegeEnhancedPromotionBannerView.m44381m(new d30() { // from class: l.fz80
                @Override // p149l.d30
                public final void call() {
                    iz80.m139029w(this.f99939a);
                }
            });
            xdl0.m208329E0(privilegeEnhancedPromotionBannerView.f28510a, new View.OnClickListener() { // from class: l.gz80
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    iz80.m139030x(this.f105113a, view);
                }
            });
        }
    }
    ...
    public boolean mo118902r() {
        vwb.m200339n(zl80.m219252g().m219257d(false), new w9j() { // from class: l.hz80
            @Override // p149l.w9j
            public final Object call(Object obj) {
                return iz80.m139027t((Merchandise) obj);
            }
        });
        return false;
    }
