...
public class zif0 extends AbstractC17477i4 {

    /* JADX INFO: renamed from: a */
    protected float f203322a;

    /* JADX INFO: renamed from: b */
    protected float f203323b;

    /* JADX INFO: renamed from: c */
    private int f203324c;

    /* JADX INFO: renamed from: d */
    private int f203325d;
    ...
    public void handleSizeChange() {
        ...
        this.f203322a = 1.0f / getWidth();
        this.f203323b = 1.0f / getHeight();
    }

    @Override // p149l.ccj
    public void initShaderHandles() {
        super.initShaderHandles();
        this.f203324c = GLES20.glGetUniformLocation(this.programHandle, "u_TexelWidth");
        this.f203325d = GLES20.glGetUniformLocation(this.programHandle, "u_TexelHeight");
    }

    @Override // p149l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f203324c, this.f203322a);
        GLES20.glUniform1f(this.f203325d, this.f203323b);
    }
}
