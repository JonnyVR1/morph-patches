...
public final class uw40 extends AbstractC18843o5 {
    ...
    public boolean mo116616a(@NotNull C8765d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        return sab0.m182891i(getPurchaseType()) && g6a.m124565n() && NullChecker.m81303a(section) && NullChecker.m81303a(section.m53520b()) && section.m53520b().m53552H() && section.m53520b().m53601s().quarterly() && section.m53520b().m53549E();
    }
}
