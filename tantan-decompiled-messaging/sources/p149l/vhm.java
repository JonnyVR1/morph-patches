...
public class vhm {
    ...
    private static byte[] f181515a;

    /* JADX INFO: renamed from: a */
    public static byte[] m198467a(Image image, int i, byte[] bArr) {
        int i2;
        byte[] bArr2;
        int i3 = i;
        byte[] bArr3 = bArr;
        ...
        int i5 = 1;
        if (i3 != 1 && i3 != 2) {
            ig3.m135964a("only support COLOR_FormatI420 and COLOR_FormatNV21");
            return null;
        }
        if (!m198468b(image)) {
            h1k.m129030a("can't convert Image to byte array, format ", image.getFormat());
            return null;
        }
        ...
        if (bArr4 == null || bArr4.length != planes[0].getRowStride()) {
            f181515a = new byte[planes[0].getRowStride()];
        }
        int i7 = 1;
        int i8 = 0;
        int i9 = 0;
        while (i8 < planes.length) {
            ...
            while (i13 < i12) {
                if (pixelStride == 1 && i7 == 1) {
                    ...
                    bArr2 = bArr3;
                    buffer.get(f181515a, 0, i2);
                    for (int i14 = 0; i14 < i11; i14++) {
                        bArr2[i9] = f181515a[i14 * pixelStride];
                        i9 += i7;
                    }
                }
                if (i13 < i12 - 1) {
    ...
    private static boolean m198468b(Image image) {
        int format = image.getFormat();
