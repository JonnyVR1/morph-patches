...
public final class ctn0 extends d1q<VoiceLiveManagerInviteItemView> {
    ...
    public void mo70566u(@Nullable VoiceLiveManagerInviteItemView itemView) {
        ...
        itemView.getClass();
        itemView.m78595k0(this.itemInfo, false, this.action);
    }
