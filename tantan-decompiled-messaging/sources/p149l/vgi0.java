...
public final class vgi0 {
    ...
    public vgi0(@NotNull TempSummary.TempType tempType, int i) {
        tempType.getClass();
        this.type = tempType;
        this.tempValue = i;
    }
    ...
    public final void m198320b(int i) {
        this.tempValue = i;
    }
}
