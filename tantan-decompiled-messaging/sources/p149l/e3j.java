...
public final class e3j {
    ...
    public e3j(@NotNull Fragment fragment) {
        fragment.getClass();
    ...
    public final Activity m114598a() {
    ...
    public final void m114601d(@Nullable Intent intent, int requestCode) {
        Fragment fragment = this.supportFragment;
        if (fragment != null) {
            if (fragment == null) {
                return;
    ...
    public e3j(@NotNull android.app.Fragment fragment) {
        fragment.getClass();
