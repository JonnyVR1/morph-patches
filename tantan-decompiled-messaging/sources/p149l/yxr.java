...
public class yxr extends vp2<LongLinkLiveMessage.Block> {
    public yxr(und undVar) {
        super(undVar);
    }

    /* JADX INFO: renamed from: z */
    private String m216480z(LongLinkLiveMessage.Block block) {
        if (block.getTempdata().getFieldsList().isEmpty()) {
            return ypv.m215672k().m195807c4();
        }
        String fields = block.getTempdata().getFields(0);
        return wxr.INSTANCE.m206024a(w8u.m202218u(!vdt.m198092b(2) ? R$string.f46726Hf : R$string.f47641y0, fields), fields, -1).toString();
    }
    ...
    public LiveControlMessage mo99811w(String str, LongLinkLiveMessage.Block block, String str2) {
        ...
        CrashHelper.m81296c(new IllegalStateException("live boot message send in block msg handler"));
        return new LiveControlMessage(str, "boot").setContent(m216480z(block)).setFrom(LiveControlMessage.FROM_LIVE_ROOM_BLOCK);
    }
