...
public final class fi0 extends AbstractC18843o5 {
    ...
    public boolean mo116616a(@NotNull C8765d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (agreementState == AgreementComponent.AgreementState.hidden && NullChecker.m81303a(section.m53520b()) && section.m53531m()) {
            return true;
        }
        return CoreModule.m29935P().m94651a().mo33524j3() && TEnum.equals(currentPayMethod, "alipay") && CoreModule.f17545c.f19591O0.m30086u3(getPurchaseType()) && NullChecker.m81303a(section.m53520b()) && section.m53531m();
    }
}
