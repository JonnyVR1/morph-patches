...
public final class od0 implements hml {
    ...
    public od0(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        act.getClass();
    ...
    public CharSequence mo130527a(@NotNull fd0 requestData) {
        ...
        if (requestData.getPrivilegeStyle()) {
            CharSequence charSequenceM202836A = we60.m202836A(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), we60.m202852Q(true));
            charSequenceM202836A.getClass();
            return charSequenceM202836A;
        }
        CharSequence charSequenceM202836A2 = we60.m202836A(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), we60.m202852Q(false));
    ...
    public boolean mo130528b(@NotNull fd0 requestData) {
        requestData.getClass();
        return (sab0.m182898p(this.purchaseType) || sab0.m182892j(this.purchaseType)) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
