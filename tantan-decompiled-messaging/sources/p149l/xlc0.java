...
@Metadata(m87231d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010%\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000f\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0005\u0010\u0003J\u0017\u0010\b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\n\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\n\u0010\u0003J\u0019\u0010\u000b\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0007\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\u000b\u0010\tR\u0016\u0010\u000e\u001a\u00020\f8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0005\u0010\rR2\u0010\u0013\u001a\u001e\u0012\u0004\u0012\u00020\u0006\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u00060\u0010j\b\u0012\u0004\u0012\u00020\u0006`\u00110\u000f8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u000b\u0010\u0012¨\u0006\u0014"}, m87232d2 = {"Ll/xlc0;", "", "<init>", "()V", "", "a", "", "eventName", Constants.INAPP_DATA_TAG, "(Ljava/lang/String;)Ljava/lang/String;", "c", "b", "", "Z", "enabled", "", "Ljava/util/HashSet;", "Lkotlin/collections/HashSet;", "Ljava/util/Map;", "redactedEvents", "facebook-core_release"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
...
public final class xlc0 {
    ...
    @NotNull
    public static final xlc0 INSTANCE = new xlc0();
    ...
    public static final void m209868a() {
        if (lsb.m151554d(xlc0.class)) {
            return;
        }
        try {
            INSTANCE.m209871c();
    ...
    public static final String m209869d(@NotNull String eventName) {
        String strM209870b;
        if (lsb.m151554d(xlc0.class)) {
            return null;
        }
        try {
            eventName.getClass();
            return (!enabled || (strM209870b = INSTANCE.m209870b(eventName)) == null) ? eventName : strM209870b;
        } catch (Throwable th) {
            lsb.m151552b(th, xlc0.class);
            return null;
        }
    ...
    public final String m209870b(String eventName) {
    ...
    public final void m209871c() {
        ...
        try {
            ...
            try {
                ...
                JSONArray redactedEvents2 = c1656dM8693r.getRedactedEvents();
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (zHas && zHas2) {
                        ...
                        if (string != null && (hashSetM8848m = C1657e.m8848m(jSONArray)) != null) {
                            redactedEvents.put(string, hashSetM8848m);
                        }
                    }
                }
