...
public final class kh60 extends AbstractC20103t4 {
    ...
    public kh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo136186b(@NotNull ai60 request, @NotNull bi60 response) {
        request.getClass();
        response.getClass();
        response.m101984n("限时优惠");
        if (request.getPurchaseSection().m53531m()) {
            return;
        }
        C8765d.a aVarM187136g = m187136g(request.getPurchaseSection());
        response.m101983m(true);
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        response.m101986p(String.format("%s%s元获取", Arrays.copyOf(new Object[]{aVarM187136g.m53583h(), n6a.m158030r0(aVarM187136g.m53591l())}, 2)));
    }
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        request.getClass();
        return sab0.m182887e(this.purchaseType) || sab0.m182885c(this.purchaseType);
    }
}
