...
public class ybc0 extends bt2 {

    /* JADX INFO: renamed from: a */
    private int f197323a;

    /* JADX INFO: renamed from: b */
    private float f197324b = 0.0f;

    /* JADX INFO: renamed from: c */
    private long f197325c = 100000;
    ...
    public void initShaderHandles() {
        ...
        this.f197323a = GLES20.glGetUniformLocation(this.programHandle, "iTime");
    }

    @Override // p149l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f197323a, this.f197324b);
    }

    @Override // p149l.uff0, p149l.AbstractC17477i4, p149l.q7m
    public void setTimeStamp(long j) {
        super.setTimeStamp(j);
        this.f197324b = j / 1200.0f;
    }
}
