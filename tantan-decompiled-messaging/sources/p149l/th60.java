...
public final class th60 extends AbstractC20103t4 {
    ...
    public th60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        request.getClass();
        return TEnum.equals(request.getPayMethod(), "alipay") && m187135f();
    }
}
