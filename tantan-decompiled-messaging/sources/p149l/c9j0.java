...
@Metadata(m87231d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\f\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \u00192\u00020\u0001:\u0001\nB\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\r\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0003J%\u0010\n\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006¢\u0006\u0004\b\n\u0010\u000bR\u0016\u0010\r\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\n\u0010\fR\u0016\u0010\u000e\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0005\u0010\fR\u0016\u0010\u0010\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u000f\u0010\fR\u0016\u0010\u0012\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0011\u0010\fR\u0016\u0010\u0016\u001a\u00020\u00138\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u0016\u0010\u0018\u001a\u00020\u00138\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0017\u0010\u0015¨\u0006\u001a"}, m87232d2 = {"Ll/c9j0;", "", "<init>", "()V", "", "b", "", "textId", "width", "height", "a", "(III)V", "I", "program", "positionAttr", "c", "texCoordinateAttr", Constants.INAPP_DATA_TAG, "texUniform", "Ljava/nio/FloatBuffer;", "e", "Ljava/nio/FloatBuffer;", "vertexCoordinateBuffer", "f", "textureCoordinateBuffer", "Companion", "android_release"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
public final class c9j0 {
    ...
    public final void m105852a(int textId, int width, int height) {
    ...
    public final void m105853b() {
        ocj ocjVar = ocj.INSTANCE;
        int iM163526c = ocjVar.m163526c("attribute vec4 position;\nattribute vec4 inputTextureCoordinate;\nvarying vec2 textureCoordinate;\nvoid main()\n{\n    gl_Position = position;\n    textureCoordinate = inputTextureCoordinate.xy;\n}", "varying highp vec2 textureCoordinate;\nuniform sampler2D inputImageTexture;\nvoid main()\n{\n     gl_FragColor = texture2D(inputImageTexture, textureCoordinate);\n}");
        this.program = iM163526c;
        if (iM163526c == 0) {
            upk0.m194883a("Unable to create program");
            return;
        }
        this.positionAttr = GLES20.glGetAttribLocation(iM163526c, "position");
        ...
        this.vertexCoordinateBuffer = ocjVar.m163530g(ocj.VERTEX_COORDS);
        this.textureCoordinateBuffer = ocjVar.m163530g(ocj.TEXTURE_NO_ROTATION);
    }
}
