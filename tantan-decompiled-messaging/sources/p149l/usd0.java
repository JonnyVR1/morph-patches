...
public final class usd0 implements r2m {
    ...
    public FrameLayout.LayoutParams mo177611a(int layoutWidth, int layoutHeight, int videoWidth, int videoHeight, @NotNull FrameLayout.LayoutParams layoutParams) {
        ...
        Pair<Integer, Integer> pairM195183b = m195183b(layoutWidth, layoutHeight, videoWidth, videoHeight);
        int iIntValue = pairM195183b.component1().intValue();
        int iIntValue2 = pairM195183b.component2().intValue();
    ...
    public final Pair<Integer, Integer> m195183b(int layoutWidth, int layoutHeight, int videoWidth, int videoHeight) {
        float f = layoutWidth;
