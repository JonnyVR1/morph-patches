...
public final class sh60 extends AbstractC20103t4 {
    ...
    public sh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo136186b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        if (TextUtils.equals(getFrom(), "purchasePage")) {
            response.m101981k("1元秒杀");
        } else {
            response.m101984n("1元秒杀");
        }
    }
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        ...
        return TEnum.equals(aVarM187136g.m53579f(), "svip") && aVarM187136g.m53601s().autoRenewable() && aVarM187136g.m53601s().monthly() && rxa0.m181490k(aVarM187136g.m53601s());
    }
}
