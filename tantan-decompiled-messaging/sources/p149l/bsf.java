...
public class bsf extends lr2 {
    ...
    private float f77084f = 0.2f;

    /* JADX INFO: renamed from: g */
    private float f77085g = 0.15f;
    ...
    public void initShaderHandles() {
        ...
        this.f77082d = GLES20.glGetUniformLocation(this.programHandle, "amount");
        this.f77083e = GLES20.glGetUniformLocation(this.programHandle, "speed");
    }

    @Override // p149l.lr2, p149l.ccj
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f77082d, this.f77084f);
        GLES20.glUniform1f(this.f77083e, this.f77085g);
    }
}
