...
public final /* data */ class a4f {
    ...
    public a4f(@Nullable String str, @NotNull String str2, @NotNull Set<? extends ModificationReason> set) {
        str2.getClass();
        set.getClass();
    ...
    public final Set<ModificationReason> m94915b() {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof a4f)) {
            return false;
        }
        a4f a4fVar = (a4f) other;
        return Intrinsics.m87488d(this.originalName, a4fVar.originalName) && Intrinsics.m87488d(this.cleanedName, a4fVar.cleanedName) && Intrinsics.m87488d(this.modifications, a4fVar.modifications);
    }
