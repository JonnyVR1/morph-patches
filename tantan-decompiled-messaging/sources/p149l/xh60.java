...
public final class xh60 extends AbstractC20103t4 {
    ...
    public xh60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo136186b(@NotNull ai60 request, @NotNull bi60 response) {
        ...
        response.m101984n(p2b0.m167133h().m167142k(aVarM187136g.m53601s()));
    ...
    public boolean mo136187e(@NotNull ai60 request) {
        request.getClass();
        return sab0.m182905w(this.purchaseType) && request.getPurchaseSection().m53531m() && rxa0.m181503x(request.getPurchaseSection().m53520b().m53601s());
    }
}
