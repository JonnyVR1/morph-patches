...
public class q5c {
    ...
    public static List<BLiveAbsData> m172995a(List<BLive> list) {
        return vwb.m200296J(list) ? new ArrayList() : new ArrayList(list);
    }

    /* JADX INFO: renamed from: b */
    public static List<BLiveAbsRoom> m172996b(List<BLiveRoom> list) {
        return vwb.m200296J(list) ? new ArrayList() : new ArrayList(list);
    }
    ...
    public static <T> T m172997c(byte[] bArr) throws Throwable {
    ...
    public static byte[] m172998d(Object obj) throws Throwable {
        ...
        if (byteArray != null) {
            gkh0.m126627j("[live][square]", "bytes length: " + byteArray.length);
        }
        return byteArray;
    }
}
