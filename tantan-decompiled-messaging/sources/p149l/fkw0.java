...
public final class fkw0 {
    ...
    public static long m121943a(double d, RoundingMode roundingMode) {
        double dRint;
        long j;
        long j2;
        boolean z;
        ...
        switch (ekw0.f92036a[roundingMode.ordinal()]) {
            case 1:
                lkw0.m150390b(m121944b(d));
                dRint = d;
            ...
            case 2:
                if (d >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || m121944b(d)) {
                    dRint = d;
                } else {
                    j = (long) d;
                    j2 = -1;
    ...
    public static boolean m121944b(double d) {
        if (!gkw0.m126736a(d)) {
            return false;
        }
        if (d != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            nfw0.m159284f(gkw0.m126736a(d), "not a normal value");
