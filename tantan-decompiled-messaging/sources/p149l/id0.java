...
public final class id0 implements hml {
    ...
    public id0(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        act.getClass();
    ...
    public CharSequence mo130527a(@NotNull fd0 requestData) {
        ...
        CharSequence charSequenceM202874o = we60.m202874o(requestData.getPrivilegeStyle());
        charSequenceM202874o.getClass();
        return charSequenceM202874o;
    }
    ...
    public boolean mo130528b(@NotNull fd0 requestData) {
        requestData.getClass();
        return sab0.m182889g(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
