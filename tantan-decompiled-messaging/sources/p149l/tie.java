...
public final class tie {
    ...
    public final EGLConfig m189176a() {
        int[] iArr = new int[1];
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArrM189178c = m189178c();
        EGL10 egl10 = this.egl;
        if (egl10 == null || !egl10.eglChooseConfig(this.eglDisplay, iArrM189178c, eGLConfigArr, 1, iArr)) {
            return null;
        }
    ...
    public final EGLContext m189177b(EGL10 egl, EGLDisplay eglDisplay, EGLConfig eglConfig) {
    ...
    public final int[] m189178c() {
        return new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12326, 0, 12344};
    }

    /* JADX INFO: renamed from: d */
    public final void m189179d() {
        EGL10 egl10 = this.egl;
        if (egl10 != null) {
    ...
    public final void m189180e(@NotNull SurfaceTexture surfaceTexture) {
        ...
        try {
            ...
            this.eglContext = m189177b(this.egl, this.eglDisplay, this.eglConfig);
            EGLSurface eGLSurface = this.eglSurface;
            if (eGLSurface != null && !Intrinsics.m87488d(eGLSurface, EGL10.EGL_NO_SURFACE)) {
                ...
                if (egl13 != null) {
                    ...
                    c21588z0.m216707b("AnimPlayer.EGLUtil", "make current error:" + Integer.toHexString(egl14 != null ? egl14.eglGetError() : 0));
                    return;
                }
                return;
            }
            C21588z0 c21588z1 = C21588z0.INSTANCE;
            EGL10 egl15 = this.egl;
            c21588z1.m216707b("AnimPlayer.EGLUtil", "error:" + Integer.toHexString(egl15 != null ? egl15.eglGetError() : 0));
        } catch (Throwable th) {
            C21588z0.INSTANCE.m216708c("AnimPlayer.EGLUtil", "error:" + th, th);
        }
    }

    /* JADX INFO: renamed from: f */
    public final void m189181f() {
