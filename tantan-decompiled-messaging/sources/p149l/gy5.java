...
public class gy5 {
    ...
    public static void m128675a(ConstellationInfoView constellationInfoView, View view) {
        constellationInfoView._constrain_layout = (RoundConstraintLayout) ((ViewGroup) view).getChildAt(0);
        constellationInfoView._image = (VDraweeView) view.findViewById(u4c0.f173909L5);
