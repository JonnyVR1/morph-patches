...
public class jtf extends AbstractC18387m4 {
    ...
    public boolean mo107444d(BLiveEffect bLiveEffect) {
        if (bLiveEffect == null || !this.f131211a.mo179248i(bLiveEffect.f44359id, bLiveEffect.hdType, bLiveEffect.zip) || !m143100h(bLiveEffect)) {
            return false;
        }
    ...
    public boolean mo107445f(String str, boolean z, h7e h7eVar, bwc0 bwc0Var) {
        ...
        if (this.f131211a.mo179248i(bLiveEffectM152981c.f44359id, bLiveEffectM152981c.hdType, bLiveEffectM152981c.zip) && m143100h(bLiveEffectM152981c)) {
    ...
    public final boolean m143100h(BLiveEffect bLiveEffect) {
        return new File(this.f131211a.m217259p(bLiveEffect.f44359id, bLiveEffect.hdType, bLiveEffect.zip) + "/params.txt").exists();
    }
}
