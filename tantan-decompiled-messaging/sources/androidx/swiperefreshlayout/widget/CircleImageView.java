...
class CircleImageView extends ImageView {
    ...
    public static class C0689a extends OvalShape {
        ...
        public C0689a(CircleImageView circleImageView, int i) {
            this.f3126c = circleImageView;
            this.f3125b = i;
            m4069a((int) rect().width());
        }

        /* JADX INFO: renamed from: a */
        public final void m4069a(int i) {
            float f = i / 2;
    ...
    public CircleImageView(Context context) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(z9c0.f202284a);
        this.f3123c = typedArrayObtainStyledAttributes.getColor(z9c0.f202285b, -328966);
        typedArrayObtainStyledAttributes.recycle();
        if (m4067a()) {
            shapeDrawable = new ShapeDrawable(new OvalShape());
            gbl0.m125215q0(this, f * 4.0f);
        } else {
            ShapeDrawable shapeDrawable2 = new ShapeDrawable(new C0689a(this, this.f3122b));
        ...
        gbl0.m125207m0(this, shapeDrawable);
    }
    ...
    /* JADX INFO: renamed from: b */
    public void m4068b(Animation.AnimationListener animationListener) {
