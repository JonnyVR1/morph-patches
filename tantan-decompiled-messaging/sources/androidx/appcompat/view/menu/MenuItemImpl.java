...
public final class MenuItemImpl implements zyg0 {
    ...
    private SubMenuC0094j mSubMenu;
    ...
    public class C0080a implements z30.InterfaceC21613b {
        public C0080a() {
        }

        @Override // p149l.z30.InterfaceC21613b
    ...
    private Drawable applyIconTintIfNecessary(Drawable drawable) {
        if (drawable != null && this.mNeedToApplyIconTint && (this.mHasIconTint || this.mHasIconTintMode)) {
            ...
            if (this.mHasIconTint) {
                kbe.m145281o(drawable, this.mIconTintList);
            }
            if (this.mHasIconTintMode) {
                kbe.m145282p(drawable, this.mIconTintMode);
            }
    ...
    public View getActionView() {
        ...
        z30 z30Var = this.mActionProvider;
        if (z30Var == null) {
            return null;
        }
        View viewMo389d = z30Var.mo389d(this);
        this.mActionView = viewMo389d;
        return viewMo389d;
    }
    ...
    public Drawable getIcon() {
        ...
        Drawable drawableM161424b = nu0.m161424b(this.mMenu.getContext(), this.mIconResId);
        this.mIconResId = 0;
        this.mIconDrawable = drawableM161424b;
        return applyIconTintIfNecessary(drawableM161424b);
    }
    ...
    public CharSequence getTitleForItemView(InterfaceC0092h.a aVar) {
    ...
    public boolean hasCollapsibleActionView() {
        z30 z30Var;
        if ((this.mShowAsAction & 8) != 0) {
            if (this.mActionView == null && (z30Var = this.mActionProvider) != null) {
                this.mActionView = z30Var.mo389d(this);
            }
            if (this.mActionView != null) {
                return true;
            }
    ...
    public boolean invoke() {
        ...
        z30 z30Var = this.mActionProvider;
        return z30Var != null && z30Var.mo386e();
    }
    ...
    public boolean isVisible() {
        z30 z30Var = this.mActionProvider;
        if (z30Var == null || !z30Var.mo390g()) {
            return (this.mFlags & 8) == 0;
        }
        return (this.mFlags & 8) == 0 && this.mActionProvider.mo388b();
    }
    ...
    public void setShowAsAction(int i) {
        int i2 = i & 3;
        if (i2 != 0 && i2 != 1 && i2 != 2) {
            ig3.m135964a("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
        } else {
    ...
    public void setSubMenu(SubMenuC0094j subMenuC0094j) {
        this.mSubMenu = subMenuC0094j;
        subMenuC0094j.setHeaderTitle(getTitle());
    }

    @Override // p149l.zyg0
    public zyg0 setSupportActionProvider(z30 z30Var) {
        z30 z30Var2 = this.mActionProvider;
        if (z30Var2 != null) {
            z30Var2.m217003h();
        }
        this.mActionView = null;
        this.mActionProvider = z30Var;
        this.mMenu.onItemsChanged(true);
        z30 z30Var3 = this.mActionProvider;
        if (z30Var3 != null) {
            z30Var3.mo391j(new C0080a());
        }
        return this;
    }
    ...
    public MenuItem setTitle(CharSequence charSequence) {
        this.mTitle = charSequence;
        this.mMenu.onItemsChanged(false);
        SubMenuC0094j subMenuC0094j = this.mSubMenu;
        if (subMenuC0094j != null) {
            subMenuC0094j.setHeaderTitle(charSequence);
        }
        return this;
    }
