...
public final class CancelWorkRunnable$forTag$1 extends Lambda implements Function0<Unit> {
    ...
    public CancelWorkRunnable$forTag$1(s9q0 s9q0Var, String str) {
        super(0);
    ...
    public static void m4620a(WorkDatabase workDatabase, String str, s9q0 s9q0Var) {
        Iterator<String> it = workDatabase.workSpecDao().mo135174f(str).iterator();
        while (it.hasNext()) {
    ...
    public final void invoke2() {
        ...
        workDatabaseM182750u.runInTransaction(new Runnable() { // from class: androidx.work.impl.utils.c
            @Override // java.lang.Runnable
            public final void run() {
                CancelWorkRunnable$forTag$1.m4620a(workDatabaseM182750u, str, s9q0Var);
            }
        });
