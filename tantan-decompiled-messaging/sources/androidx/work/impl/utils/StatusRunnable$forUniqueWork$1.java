...
final class StatusRunnable$forUniqueWork$1 extends Lambda implements Function1<WorkDatabase, List<? extends WorkInfo>> {
    ...
    public final List<WorkInfo> invoke(WorkDatabase workDatabase) {
        ...
        List<WorkInfo> listApply = haq0.f106767z.apply(workDatabase.workSpecDao().mo135176h(this.$name));
        listApply.getClass();
        return listApply;
    }
}
