...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull FragmentManager fragmentManager) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, w9c0.f185336e);
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(w9c0.f185337f) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(w9c0.f185338g);
        typedArrayObtainStyledAttributes.recycle();
        int id = getId();
        Fragment fragmentM2554h0 = fragmentManager.m2554h0(id);
        if (classAttribute != null && fragmentM2554h0 == null) {
            if (id <= 0) {
                xjw.m209754a("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? " with tag ".concat(string) : "");
                throw null;
            }
            Fragment fragmentInstantiate = fragmentManager.m2583r0().instantiate(context.getClassLoader(), classAttribute);
            fragmentInstantiate.onInflate(context, attributeSet, (Bundle) null);
            fragmentManager.m2567m().m2815x(true).m2805d(this, fragmentInstantiate, string).mo2710l();
        }
        fragmentManager.m2527V0(this);
    }

    /* JADX INFO: renamed from: a */
    public final void m2478a(@NonNull View view) {
    ...
    public void addView(@NonNull View view, int i, @Nullable ViewGroup.LayoutParams layoutParams) {
        if (FragmentManager.m2479A0(view) != null) {
            super.addView(view, i, layoutParams);
        } else {
            xjw.m209754a("Views added to a FragmentContainerView must be associated with a Fragment. View ", view, " is not associated with a Fragment.");
        }
    }
    ...
    public FragmentContainerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            if (classAttribute == null) {
                classAttribute = typedArrayObtainStyledAttributes.getString(w9c0.f185337f);
                str = "android:name";
            } else {
