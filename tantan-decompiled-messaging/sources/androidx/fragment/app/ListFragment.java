...
public class ListFragment extends Fragment {
    ...
    public final Runnable f1962A = new RunnableC0410a();

    /* JADX INFO: renamed from: B */
    public final AdapterView.OnItemClickListener f1963B = new C0411b();
    ...
    public class C0411b implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            ListFragment.this.m2660W3((ListView) adapterView, view, i, j);
        }
    }

    /* JADX INFO: renamed from: V3 */
    public final void m2659V3() {
        if (this.f1965D != null) {
            return;
        }
        View view = getView();
        if (view == null) {
            qkq0.m175383a("Content view not yet created");
            return;
        }
        if (view instanceof ListView) {
            ...
            if (!(viewFindViewById instanceof ListView)) {
                if (viewFindViewById == null) {
                    upk0.m194883a("Your content must have a ListView whose id attribute is 'android.R.id.list'");
                    return;
                } else {
                    upk0.m194883a("Content has view with id attribute 'android.R.id.list' that is not a ListView class");
                    return;
                }
            }
    ...
    public void m2660W3(@NonNull ListView listView, @NonNull View view, int i, long j) {
    }

    /* JADX INFO: renamed from: X3 */
    public void m2661X3(@Nullable ListAdapter listAdapter) {
        ...
        if (listView != null) {
            ...
            m2662Y3(true, requireView().getWindowToken() != null);
        }
    }

    /* JADX INFO: renamed from: Y3 */
    public final void m2662Y3(boolean z, boolean z2) {
        m2659V3();
        View view = this.f1968G;
        if (view == null) {
            qkq0.m175383a("Can't be used with a custom content view");
            return;
        }
        if (this.f1971J == z) {
            return;
