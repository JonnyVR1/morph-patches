...
public class C0213d {
    ...
    public C0213d(ConstraintWidget constraintWidget, int i, boolean z) {
    ...
    /* JADX INFO: renamed from: c */
    public static boolean m1073c(ConstraintWidget constraintWidget, int i) {
        if (constraintWidget.m974C() == 8 || constraintWidget.f1045E[i] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            return false;
        }
