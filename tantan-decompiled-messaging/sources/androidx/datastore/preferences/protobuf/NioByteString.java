...
final class NioByteString extends ByteString.LeafByteString {
    ...
    public NioByteString(ByteBuffer byteBuffer) {
        C0350s.m2340b(byteBuffer, "buffer");
    ...
    public boolean isValidUtf8() {
        return Utf8.m1702r(this.buffer);
    }

    @Override // androidx.datastore.preferences.protobuf.ByteString
    public AbstractC0330g newCodedInput() {
        return AbstractC0330g.m2031h(this.buffer, true);
    }
    ...
    public int partialIsValidUtf8(int i, int i2, int i3) {
        return Utf8.m1705u(i, this.buffer, i2, i3 + i2);
    }
    ...
    public void writeTo(jq3 jq3Var) throws IOException {
        jq3Var.mo1608a(this.buffer.slice());
    }

    @Override // androidx.datastore.preferences.protobuf.ByteString
    public void writeToInternal(OutputStream outputStream, int i, int i2) throws IOException {
        if (!this.buffer.hasArray()) {
            gq3.m127513g(slice(i, i2 + i), outputStream);
        } else {
    ...
    public class C0297a extends InputStream {
