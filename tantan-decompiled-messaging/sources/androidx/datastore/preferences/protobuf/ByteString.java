...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final ByteString EMPTY = new LiteralByteString(C0350s.f1739c);
    static final int MAX_READ_FROM_CHUNK_SIZE = 8192;
    static final int MIN_READ_FROM_CHUNK_SIZE = 256;
    private static final int UNSIGNED_BYTE_MASK = 255;
    private static final Comparator<ByteString> UNSIGNED_LEXICOGRAPHICAL_COMPARATOR;
    private static final InterfaceC0278e byteArrayCopier;
    private int hash = 0;
    ...
    public static class C0275b implements Comparator<ByteString> {
    ...
    public static abstract class AbstractC0276c implements InterfaceC0279f {
        @Override // java.util.Iterator
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    ...
    public interface InterfaceC0278e {
        /* JADX INFO: renamed from: a */
        byte[] mo1492a(byte[] bArr, int i, int i2);
    }

    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.ByteString$f */
    public interface InterfaceC0279f extends Iterator<Byte> {
        byte nextByte();
    }

    static {
        C0274a c0274a = null;
        byteArrayCopier = wn0.m204554c() ? new C0282i(c0274a) : new C0277d(c0274a);
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new C0275b();
    }
    ...
    public static ByteString copyFromUtf8(String str) {
        return new LiteralByteString(str.getBytes(C0350s.f1737a));
    }

    public static C0280g newCodedBuilder(int i) {
        return new C0280g(i, null);
    }

    public static C0281h newOutput() {
        return new C0281h(128);
    }
    ...
    public abstract AbstractC0330g newCodedInput();
    ...
    public abstract void writeTo(jq3 jq3Var) throws IOException;

    public abstract void writeToInternal(OutputStream outputStream, int i, int i2) throws IOException;

    public abstract void writeToReverse(jq3 jq3Var) throws IOException;

    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.ByteString$d */
    public static final class C0277d implements InterfaceC0278e {
        public C0277d() {
        }

        @Override // androidx.datastore.preferences.protobuf.ByteString.InterfaceC0278e
        /* JADX INFO: renamed from: a */
        public byte[] mo1492a(byte[] bArr, int i, int i2) {
            return Arrays.copyOfRange(bArr, i, i2 + i);
        }

        public /* synthetic */ C0277d(C0274a c0274a) {
            this();
        }
    }

    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.ByteString$i */
    public static final class C0282i implements InterfaceC0278e {
        public C0282i() {
        }
        ...
        public /* synthetic */ C0282i(C0274a c0274a) {
            this();
        }
    }

    public static C0281h newOutput(int i) {
        return new C0281h(i);
    }
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final boolean isValidUtf8() {
            ...
            return Utf8.m1704t(this.bytes, offsetIntoBytes, size() + offsetIntoBytes);
        }

        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final AbstractC0330g newCodedInput() {
            return AbstractC0330g.m2034k(this.bytes, getOffsetIntoBytes(), size(), true);
        }
        ...
        public final int partialHash(int i, int i2, int i3) {
            return C0350s.m2347i(i, this.bytes, getOffsetIntoBytes() + i2, i3);
        }

        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final int partialIsValidUtf8(int i, int i2, int i3) {
            int offsetIntoBytes = getOffsetIntoBytes() + i2;
            return Utf8.m1706v(i, this.bytes, offsetIntoBytes, i3 + offsetIntoBytes);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.ByteString
        public final void writeTo(jq3 jq3Var) throws IOException {
            jq3Var.mo1578b(this.bytes, getOffsetIntoBytes(), size());
        }
    ...
    public static final class C0280g {
        ...
        public C0280g(int i) {
            byte[] bArr = new byte[i];
            this.f1545b = bArr;
            this.f1544a = CodedOutputStream.m1531h0(bArr);
        }

        /* JADX INFO: renamed from: a */
        public ByteString m1493a() {
            this.f1544a.m1580d();
            return new LiteralByteString(this.f1545b);
        }

        /* JADX INFO: renamed from: b */
        public CodedOutputStream m1494b() {
            return this.f1544a;
        }

        public /* synthetic */ C0280g(int i, C0274a c0274a) {
            this(i);
        }
    }
    ...
    public static final class C0281h extends OutputStream {
        ...
        /* JADX INFO: renamed from: d */
        public final void m1495d(int i) {
    ...
    public static ByteString copyFrom(byte[] bArr, int i, int i2) {
        ...
        return new LiteralByteString(byteArrayCopier.mo1492a(bArr, i, i2));
    }
}
