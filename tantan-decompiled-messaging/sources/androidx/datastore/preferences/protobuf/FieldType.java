...
public final class FieldType {
    ...
    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.FieldType$a */
    public static /* synthetic */ class C0291a {
        ...
        static {
            ...
            try {
                f1567b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1567b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f1566a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1566a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f1565id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C0291a.f1566a[collection.ordinal()];
        if (i4 == 1 || i4 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C0291a.f1567b[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }
    ...
    private static Type getListParameter(Class<?> cls, Type[] typeArr) {
        while (true) {
            ...
            if (cls == List.class) {
                ...
                upk0.m194883a("Unable to identify parameter type for List<T>");
                return null;
            }
                ...
                for (int i2 = 0; i2 < actualTypeArguments.length; i2++) {
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        if (typeArr.length != typeParameters.length) {
                            upk0.m194883a("Type array mismatch");
                            return null;
                        }
                        int i3 = 0;
                        while (true) {
                            if (i3 >= typeParameters.length) {
                                ibe.m135253a("Unable to find replacement for ", type);
                                return null;
                            }
