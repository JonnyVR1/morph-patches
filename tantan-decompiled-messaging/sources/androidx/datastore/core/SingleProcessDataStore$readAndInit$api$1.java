...
@Metadata(m87231d1 = {"\u0000!\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001JF\u0010\t\u001a\u00028\u000021\u0010\b\u001a-\b\u0001\u0012\u0013\u0012\u00118\u0000¢\u0006\f\b\u0003\u0012\b\b\u0004\u0012\u0004\b\b(\u0005\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0006\u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0002H\u0096@ø\u0001\u0000¢\u0006\u0004\b\t\u0010\n\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u000b"}, m87232d2 = {"androidx/datastore/core/SingleProcessDataStore$readAndInit$api$1", "Ll/ism;", "Lkotlin/Function2;", "Lkotlin/ParameterName;", AuthenticationTokenClaims.JSON_KEY_NAME, Constants.KEY_T, "Lkotlin/coroutines/Continuation;", "", "transform", "a", "(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "datastore-core"}, m87233k = 1, m87234mv = {1, 5, 1}, m87236xi = 48)
public final class SingleProcessDataStore$readAndInit$api$1<T> implements ism<T> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ ot10 f1529a;
    ...
    public SingleProcessDataStore$readAndInit$api$1(ot10 ot10Var, Ref.BooleanRef booleanRef, Ref.ObjectRef<T> objectRef, SingleProcessDataStore<T> singleProcessDataStore) {
        this.f1529a = ot10Var;
    ...
    @Nullable
    /* JADX INFO: renamed from: a */
    public Object mo1432a(@NotNull Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) throws Throwable {
        ...
        try {
            if (i2 == 0) {
                ...
                singleProcessDataStore$readAndInit$api$1$updateData$1.L$1 = ot10Var;
                ...
                if (ot10Var.mo94354c(null, singleProcessDataStore$readAndInit$api$1$updateData$1) != objM196133e) {
                }
            ...
            if (i2 != 1) {
                if (i2 != 2) {
                    ...
                    ot10Var2 = (ot10) singleProcessDataStore$readAndInit$api$1$updateData$1.L$0;
                    try {
                        ResultKt.m87239b(obj);
                ...
                objectRef2 = (Ref.ObjectRef) singleProcessDataStore$readAndInit$api$1$updateData$1.L$1;
                ot10Var3 = (ot10) singleProcessDataStore$readAndInit$api$1$updateData$1.L$0;
                try {
                    ResultKt.m87239b(obj);
                    singleProcessDataStore3 = singleProcessDataStore4;
                    if (!Intrinsics.m87488d(obj, objectRef2.element)) {
                        singleProcessDataStore$readAndInit$api$1$updateData$1.L$0 = ot10Var3;
                        ...
                        if (singleProcessDataStore3.m1424z(obj, singleProcessDataStore$readAndInit$api$1$updateData$1) != objM196133e) {
                            t = (T) obj;
                            ot10Var2 = ot10Var3;
                            objectRef2.element = t;
                        }
            ...
            ot10 ot10Var4 = (ot10) singleProcessDataStore$readAndInit$api$1$updateData$1.L$1;
            ...
            singleProcessDataStore$readAndInit$api$1$updateData$1.L$0 = ot10Var;
