...
public final class MultiInstanceInvalidationService extends Service {
    ...
    @NotNull
    private final RemoteCallbackList<InterfaceC0666c> callbackList = new RemoteCallbackListC0654b();

    @NotNull
    private final InterfaceC0667d.a binder = new BinderC0653a();

    /* JADX INFO: renamed from: androidx.room.MultiInstanceInvalidationService$a */
    @Metadata(m87231d1 = {"\u0000-\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J!\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\u000b\u0010\fJ'\u0010\u000f\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\u00062\u000e\u0010\u000e\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00040\rH\u0016¢\u0006\u0004\b\u000f\u0010\u0010¨\u0006\u0011"}, m87232d2 = {"androidx/room/MultiInstanceInvalidationService$a", "Landroidx/room/d$a;", "Landroidx/room/c;", "callback", "", AuthenticationTokenClaims.JSON_KEY_NAME, "", "S6", "(Landroidx/room/c;Ljava/lang/String;)I", "clientId", "", "k8", "(Landroidx/room/c;I)V", "", "tables", "h6", "(I[Ljava/lang/String;)V", "room-runtime_release"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
    public static final class BinderC0653a extends InterfaceC0667d.a {
        public BinderC0653a() {
        }

        @Override // androidx.room.InterfaceC0667d
        /* JADX INFO: renamed from: S6 */
        public int mo3907S6(@NotNull InterfaceC0666c callback, @Nullable String name) {
            callback.getClass();
            int i = 0;
            if (name == null) {
                return 0;
            }
            RemoteCallbackList<InterfaceC0666c> callbackList$room_runtime_release = MultiInstanceInvalidationService.this.getCallbackList$room_runtime_release();
        ...
        public void mo3908h6(int clientId, @NotNull String[] tables) {
            tables.getClass();
            RemoteCallbackList<InterfaceC0666c> callbackList$room_runtime_release = MultiInstanceInvalidationService.this.getCallbackList$room_runtime_release();
            MultiInstanceInvalidationService multiInstanceInvalidationService = MultiInstanceInvalidationService.this;
            synchronized (callbackList$room_runtime_release) {
                try {
                    ...
                    for (int i = 0; i < iBeginBroadcast; i++) {
                        try {
                            ...
                            if (clientId != iIntValue && Intrinsics.m87488d(str, str2)) {
                                try {
                                    ((InterfaceC0666c) multiInstanceInvalidationService.getCallbackList$room_runtime_release().getBroadcastItem(i)).mo3939J0(tables);
        ...
        public void mo3909k8(@NotNull InterfaceC0666c callback, int clientId) {
            callback.getClass();
            RemoteCallbackList<InterfaceC0666c> callbackList$room_runtime_release = MultiInstanceInvalidationService.this.getCallbackList$room_runtime_release();
            MultiInstanceInvalidationService multiInstanceInvalidationService = MultiInstanceInvalidationService.this;
            synchronized (callbackList$room_runtime_release) {
    ...
    @Metadata(m87231d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u001f\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, m87232d2 = {"androidx/room/MultiInstanceInvalidationService$b", "Landroid/os/RemoteCallbackList;", "Landroidx/room/c;", "callback", "", "cookie", "", "a", "(Landroidx/room/c;Ljava/lang/Object;)V", "room-runtime_release"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
    public static final class RemoteCallbackListC0654b extends RemoteCallbackList<InterfaceC0666c> {
        public RemoteCallbackListC0654b() {
        }

        @Override // android.os.RemoteCallbackList
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public void onCallbackDied(@NotNull InterfaceC0666c callback, @NotNull Object cookie) {
            callback.getClass();
            cookie.getClass();
    ...
    @NotNull
    public final RemoteCallbackList<InterfaceC0666c> getCallbackList$room_runtime_release() {
