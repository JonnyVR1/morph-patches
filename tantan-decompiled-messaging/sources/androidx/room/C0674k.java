...
public final class C0674k implements CoroutineContext.Element {
    ...
    @Metadata(m87231d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m87232d2 = {"Landroidx/room/k$a;", "Lkotlin/coroutines/CoroutineContext$Key;", "Landroidx/room/k;", "<init>", "()V", "room-ktx_release"}, m87233k = 1, m87234mv = {1, 8, 0}, m87236xi = 48)
    public static final class Companion implements CoroutineContext.Key<C0674k> {
    ...
    public C0674k(@NotNull ContinuationInterceptor continuationInterceptor) {
    ...
    public final void m4019d() {
        if (this.referenceCount.decrementAndGet() >= 0) {
            return;
        }
        qkq0.m175383a("Transaction was never started or was already released.");
    }
    ...
    @NotNull
    public CoroutineContext.Key<C0674k> getKey() {
        return INSTANCE;
    }
