...
public final class SegmentedByteString extends ByteString {
    ...
    private final Object writeReplace() {
        ...
        ox50.m166495a("null cannot be cast to non-null type java.lang.Object");
        return null;
    }
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        if (beginIndex < 0) {
            pce0.m168340a("beginIndex=", beginIndex, " < 0");
            return null;
        }
        if (endIndex > size()) {
        ...
        if (i < 0) {
            hck0.m130443a("endIndex=", endIndex, " < beginIndex=", beginIndex);
            return null;
        }
    ...
    @Metadata(m87230bv = {1, 0, 2}, m87231d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b¨\u0006\t"}, m87232d2 = {"Lokio/SegmentedByteString$Companion;", "", "()V", "of", "Lokio/ByteString;", "buffer", "Lokio/Buffer;", "byteCount", "", "jvm"}, m87233k = 1, m87234mv = {1, 1, 11})
    public static final class Companion {
        ...
        public final ByteString m221057of(@NotNull Buffer buffer, int byteCount) {
            buffer.getClass();
