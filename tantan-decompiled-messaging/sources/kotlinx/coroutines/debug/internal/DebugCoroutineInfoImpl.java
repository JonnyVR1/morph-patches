...
public final class DebugCoroutineInfoImpl {
    ...
    public final List<StackTraceElement> m94039b() {
        return CollectionsKt.emptyList();
    }

    @Nullable
    /* JADX INFO: renamed from: c */
    public final CoroutineContext m94040c() {
        return this._context.get();
    }

    @Nullable
    /* JADX INFO: renamed from: d */
    public final tsf0 m94041d() {
        return null;
    }

    @NotNull
    /* JADX INFO: renamed from: e */
    public final List<StackTraceElement> m94042e() {
        return m94039b();
    }

    @Nullable
    /* JADX INFO: renamed from: f */
    public final CoroutineStackFrame m94043f() {
    ...
    public final List<StackTraceElement> m94045h() {
        CoroutineStackFrame coroutineStackFrameM94043f = m94043f();
        if (coroutineStackFrameM94043f == null) {
            return CollectionsKt.emptyList();
        }
        ArrayList arrayList = new ArrayList();
        while (coroutineStackFrameM94043f != null) {
            StackTraceElement stackTraceElement = coroutineStackFrameM94043f.getStackTraceElement();
            if (stackTraceElement != null) {
                arrayList.add(stackTraceElement);
            }
            coroutineStackFrameM94043f = coroutineStackFrameM94043f.getCallerFrame();
        }
        return arrayList;
    }
    ...
    public final java.lang.Object m94046i(kotlin.sequences.SequenceScope<? super java.lang.StackTraceElement> r6, kotlin.coroutines.jvm.internal.CoroutineStackFrame r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
        ...
        L44:
            ...
            r0.L$2 = r7
            r0.label = r3
            java.lang.Object r8 = r6.mo93258c(r8, r0)
            if (r8 != r1) goto L59
            return r1
        L59:
            r4 = r7
        ...
        L66:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl.m94046i(kotlin.sequences.SequenceScope, kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlin.coroutines.Continuation):java.lang.Object");
    }

    @NotNull
    public String toString() {
        return "DebugCoroutineInfo(state=" + get_state() + ",context=" + m94040c() + ')';
    }
}
