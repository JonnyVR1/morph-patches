...
final class TasksKt$asDeferredImpl$2 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ jf4 $cancellationTokenSource;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TasksKt$asDeferredImpl$2(jf4 jf4Var) {
        super(1);
        this.$cancellationTokenSource = jf4Var;
    }
    ...
    public final void invoke2(@Nullable Throwable th) {
        this.$cancellationTokenSource.m141172a();
    }
}
