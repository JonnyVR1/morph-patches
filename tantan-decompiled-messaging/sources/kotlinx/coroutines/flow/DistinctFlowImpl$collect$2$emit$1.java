...
@DebugMetadata(m87373c = "kotlinx.coroutines.flow.DistinctFlowImpl$collect$2", m87374f = "Distinct.kt", m87375l = {EACTags.CARDHOLDER_PUBLIC_KEY_TEMPLATE}, m87376m = "emit")
public final class DistinctFlowImpl$collect$2$emit$1 extends ContinuationImpl {
    int label;
    /* synthetic */ Object result;
    final /* synthetic */ DistinctFlowImpl.C154262<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public DistinctFlowImpl$collect$2$emit$1(DistinctFlowImpl.C154262<? super T> c154262, Continuation<? super DistinctFlowImpl$collect$2$emit$1> continuation) {
        super(continuation);
        this.this$0 = c154262;
    }
