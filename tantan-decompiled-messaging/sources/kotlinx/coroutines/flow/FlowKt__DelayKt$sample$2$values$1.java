...
@DebugMetadata(m87373c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m87374f = "Delay.kt", m87375l = {273}, m87376m = "invokeSuspend")
public final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ad90<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public static final class C154321<T> implements fri {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ ad90<Object> f66807a;

        public C154321(ad90<Object> ad90Var) {
            this.f66807a = ad90Var;
        }
        ...
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                ad90<Object> ad90Var = this.f66807a;
                if (t == null) {
                    t = (T) su40.f166433a;
                }
                flowKt__DelayKt$sample$2$values$1$1$emit$1.label = 1;
                if (ad90Var.mo93787E(t, flowKt__DelayKt$sample$2$values$1$1$emit$1) == objM196133e) {
                    return objM196133e;
                }
            } else {
                if (i2 != 1) {
    ...
    public FlowKt__DelayKt$sample$2$values$1(eri<Object> eriVar, Continuation<? super FlowKt__DelayKt$sample$2$values$1> continuation) {
    ...
    public final Object invoke2(@NotNull ad90<Object> ad90Var, @Nullable Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(ad90Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            eri<Object> eriVar = this.$this_sample;
            C154321 c154321 = new C154321(ad90Var);
            this.label = 1;
            if (eriVar.collect(c154321, this) == objM196133e) {
                return objM196133e;
            }
        } else {
            if (i != 1) {
