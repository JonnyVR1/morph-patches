...
@DebugMetadata(m87373c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$dropWhile$1", m87374f = "Deprecated.kt", m87375l = {Primes.SMALL_FACTOR_LIMIT, 212, 213, 217, 218}, m87376m = "invokeSuspend")
final class ChannelsKt__DeprecatedKt$dropWhile$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invoke(@NotNull ad90 ad90Var, @Nullable Continuation continuation) {
        return ((ChannelsKt__DeprecatedKt$dropWhile$1) create(ad90Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX WARN: Code duplicated, block: B:18:0x005f A[PHI: r1 r8 r12
      ...
      0x005f: PHI (r8v1 l.ad90) = (r8v4 l.ad90), (r8v8 l.ad90) binds: [B:21:0x007d, B:17:0x0054] A[DONT_GENERATE, DONT_INLINE]
