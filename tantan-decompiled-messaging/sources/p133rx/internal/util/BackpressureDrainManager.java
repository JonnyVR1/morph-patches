...
public final class BackpressureDrainManager extends AtomicLong implements rc90 {
    ...
    final InterfaceC22357a actual;
    boolean emitting;
    Throwable exception;
    volatile boolean terminated;

    /* JADX INFO: renamed from: rx.internal.util.BackpressureDrainManager$a */
    public interface InterfaceC22357a {
        /* JADX INFO: renamed from: a */
        void mo171541a(Throwable th);
    ...
    public BackpressureDrainManager(InterfaceC22357a interfaceC22357a) {
        this.actual = interfaceC22357a;
    }
    ...
    public void drain() throws Throwable {
        ...
        synchronized (this) {
            try {
                ...
                long j = get();
                try {
                    InterfaceC22357a interfaceC22357a = this.actual;
                    while (true) {
                        int i = 0;
                        while (true) {
                            try {
                                ...
                                if (!z2) {
                                    objPoll = interfaceC22357a.poll();
                                    if (objPoll != null) {
                                        break;
                                    }
                                    if (interfaceC22357a.accept(objPoll)) {
                                        return;
                                    }
                                    j--;
                                    i++;
                                } else if (interfaceC22357a.peek() != null) {
                                    if (j == 0) {
                                        break;
                                    }
                                    objPoll = interfaceC22357a.poll();
                                    ...
                                    interfaceC22357a.mo171541a(this.exception);
                                    return;
                                }
                            } catch (Throwable th) {
                                th = th;
                        ...
                        try {
                            synchronized (this) {
                                try {
                                    z2 = this.terminated;
                                    boolean z3 = interfaceC22357a.peek() != null;
