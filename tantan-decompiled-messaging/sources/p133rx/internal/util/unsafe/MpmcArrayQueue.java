...
public class MpmcArrayQueue<E> extends MpmcArrayQueueConsumerField<E> {
    ...
    @Override // java.util.AbstractCollection, java.util.Collection, p133rx.internal.util.unsafe.MessagePassingQueue
    public boolean isEmpty() {
        return lvConsumerIndex() == lvProducerIndex();
    }

    @Override // java.util.Queue, p133rx.internal.util.unsafe.MessagePassingQueue
