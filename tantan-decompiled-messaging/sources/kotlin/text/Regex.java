...
public final class Regex implements Serializable {
    ...
    @Metadata(m87231d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0017\u0010\n\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m87232d2 = {"Lkotlin/text/Regex$Companion;", "", "<init>", "()V", "", "literal", "c", "(Ljava/lang/String;)Ljava/lang/String;", "", "flags", "b", "(I)I", "kotlin-stdlib"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class Companion {
        ...
        public final int m93375b(int flags) {
            return (flags & 2) != 0 ? flags | 64 : flags;
        }

        @NotNull
        /* JADX INFO: renamed from: c */
        public final String m93376c(@NotNull String literal) {
            literal.getClass();
    ...
    @Metadata(m87231d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u0000 \u000f2\u00060\u0001j\u0002`\u0002:\u0001\u000fB\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0004\b\u0007\u0010\bJ\b\u0010\r\u001a\u00020\u000eH\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\f¨\u0006\u0010"}, m87232d2 = {"Lkotlin/text/Regex$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", "flags", "", "<init>", "(Ljava/lang/String;I)V", "getPattern", "()Ljava/lang/String;", "getFlags", "()I", "readResolve", "", "Companion", "kotlin-stdlib"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    ...
    public static final /* synthetic */ class C153812 extends FunctionReferenceImpl implements Function1<MatchResult, MatchResult> {
        public static final C153812 INSTANCE = new C153812();
    ...
    @Metadata(m87231d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\n"}, m87232d2 = {"<anonymous>", "", "Lkotlin/sequences/SequenceScope;", ""}, m87233k = 3, m87234mv = {2, 2, 0}, m87236xi = 48)
    @DebugMetadata(m87373c = "kotlin.text.Regex$splitToSequence$1", m87374f = "Regex.kt", m87375l = {280, 288, 292}, m87376m = "invokeSuspend", m87377v = 2)
    public static final class C153821 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        public C153821(CharSequence charSequence, int i, Continuation<? super C153821> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C153821 c153821 = Regex.this.new C153821(this.$input, this.$limit, continuation);
            c153821.L$0 = obj;
            return c153821;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C153821) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:29:0x00ae, code lost:
            ...
            if (r0.mo93258c(r4, r10) == r1) goto L35;
         */
        /* JADX WARN: Code restructure failed: missing block: B:34:0x00cc, code lost:
        
            if (r0.mo93258c(r2, r10) == r1) goto L35;
         */
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r11) throws java.lang.Throwable {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.text.Regex.C153821.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public Regex(@NotNull String str, @NotNull Set<? extends RegexOption> set) {
        str.getClass();
        set.getClass();
        Pattern patternCompile = Pattern.compile(str, INSTANCE.m93375b(RegexKt.m93387j(set)));
        patternCompile.getClass();
        this(patternCompile);
    }

    /* JADX INFO: renamed from: a */
    public static MatchResult m93373a(Regex regex, CharSequence charSequence, int i) {
    ...
    public final MatchResult find(@NotNull CharSequence input, int startIndex) {
        ...
        matcher.getClass();
        return RegexKt.m93383f(matcher, startIndex, input);
    }
    ...
    public final Sequence<MatchResult> findAll(@NotNull final CharSequence input, final int startIndex) {
        ...
        if (startIndex >= 0 && startIndex <= input.length()) {
            return SequencesKt__SequencesKt.m93276p(new Function0() { // from class: l.jnc0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return Regex.m93373a(this.f118846a, input, startIndex);
                }
            }, C153812.INSTANCE);
        }
        inc0.m137129a("Start index out of bounds: ", startIndex, ", input length: ", input.length());
        return null;
    }
    ...
    public final MatchResult matchEntire(@NotNull CharSequence input) {
        ...
        Matcher matcher = this.nativePattern.matcher(input);
        matcher.getClass();
        return RegexKt.m93384g(matcher, input);
    }
    ...
    public final String replace(@NotNull CharSequence input, @NotNull Function1<? super MatchResult, ? extends CharSequence> transform) {
        ...
        do {
            sb.append(input, iIntValue, matchResultFind$default.getRange().m87586l().intValue());
            sb.append(transform.invoke(matchResultFind$default));
            iIntValue = matchResultFind$default.getRange().m87585j().intValue() + 1;
    ...
    public final List<String> split(@NotNull CharSequence input, int limit) {
        input.getClass();
        StringsKt__StringsKt.m93392A0(limit);
        Matcher matcher = this.nativePattern.matcher(input);
        if (limit == 1 || !matcher.find()) {
            return CollectionsKt.listOf(input.toString());
        }
        ArrayList arrayList = new ArrayList(limit > 0 ? C15167a.m87599e(limit, 10) : 10);
        int i = limit - 1;
        int iEnd = 0;
        do {
    ...
    public final Sequence<String> splitToSequence(@NotNull CharSequence input, int limit) {
        input.getClass();
        StringsKt__StringsKt.m93392A0(limit);
        return SequencesKt__SequenceBuilderKt.m93262b(new C153821(input, limit, null));
    }
    ...
    public Regex(@NotNull String str, @NotNull RegexOption regexOption) {
        ...
        Pattern patternCompile = Pattern.compile(str, INSTANCE.m93375b(regexOption.getValue()));
        patternCompile.getClass();
        this(patternCompile);
    }
