...
public final class FieldOverridabilityCondition implements ExternalOverridabilityCondition {
    ...
    public ExternalOverridabilityCondition.Result mo89377b(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, @Nullable ClassDescriptor classDescriptor) {
        ...
        if (!Intrinsics.m87488d(propertyDescriptor.getName(), propertyDescriptor2.getName())) {
            return ExternalOverridabilityCondition.Result.UNKNOWN;
        }
        if (JavaDescriptorUtilKt.m89639a(propertyDescriptor) && JavaDescriptorUtilKt.m89639a(propertyDescriptor2)) {
            return ExternalOverridabilityCondition.Result.OVERRIDABLE;
        }
        return (JavaDescriptorUtilKt.m89639a(propertyDescriptor) || JavaDescriptorUtilKt.m89639a(propertyDescriptor2)) ? ExternalOverridabilityCondition.Result.INCOMPATIBLE : ExternalOverridabilityCondition.Result.UNKNOWN;
    }
}
