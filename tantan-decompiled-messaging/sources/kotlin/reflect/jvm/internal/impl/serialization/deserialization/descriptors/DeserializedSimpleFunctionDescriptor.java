...
public final class DeserializedSimpleFunctionDescriptor extends SimpleFunctionDescriptorImpl implements DeserializedCallableMemberDescriptor {
    ...
    @NotNull
    public final ProtoBuf.Function f66141E;

    /* JADX INFO: renamed from: F */
    @NotNull
    public final NameResolver f66142F;

    /* JADX INFO: renamed from: G */
    @NotNull
    public final TypeTable f66143G;

    /* JADX INFO: renamed from: H */
    @NotNull
    public final VersionRequirementTable f66144H;

    /* JADX INFO: renamed from: I */
    @Nullable
    public final DeserializedContainerSource f66145I;
    ...
    public DeserializedSimpleFunctionDescriptor(@NotNull DeclarationDescriptor declarationDescriptor, @Nullable SimpleFunctionDescriptor simpleFunctionDescriptor, @NotNull Annotations annotations, @NotNull Name name, @NotNull CallableMemberDescriptor.Kind kind, @NotNull ProtoBuf.Function function, @NotNull NameResolver nameResolver, @NotNull TypeTable typeTable, @NotNull VersionRequirementTable versionRequirementTable, @Nullable DeserializedContainerSource deserializedContainerSource, @Nullable SourceElement sourceElement) {
        super(declarationDescriptor, simpleFunctionDescriptor, annotations, name, kind, sourceElement == null ? SourceElement.f64063a : sourceElement);
        ...
        this.f66141E = function;
        this.f66142F = nameResolver;
        this.f66143G = typeTable;
        this.f66144H = versionRequirementTable;
        this.f66145I = deserializedContainerSource;
    }
    ...
    public FunctionDescriptorImpl mo88321E0(@NotNull DeclarationDescriptor declarationDescriptor, @Nullable FunctionDescriptor functionDescriptor, @NotNull CallableMemberDescriptor.Kind kind, @Nullable Name name, @NotNull Annotations annotations, @NotNull SourceElement sourceElement) {
        ...
        DeserializedSimpleFunctionDescriptor deserializedSimpleFunctionDescriptor = new DeserializedSimpleFunctionDescriptor(declarationDescriptor, simpleFunctionDescriptor, annotations, name2, kind, mo92286G(), mo92287W(), mo92292w(), m92426j1(), mo92288X(), sourceElement);
        deserializedSimpleFunctionDescriptor.mo88750R0(mo88742J0());
    ...
    public ProtoBuf.Function mo92286G() {
        return this.f66141E;
    }

    @NotNull
    /* JADX INFO: renamed from: j1 */
    public VersionRequirementTable m92426j1() {
        return this.f66144H;
    }
