...
public final class PrimitiveType {
    ...
    private PrimitiveType(String str) {
        ...
        this.typeName = nameM91079i;
        Name nameM91079i2 = Name.m91079i(str + "Array");
        nameM91079i2.getClass();
        this.arrayTypeName = nameM91079i2;
        LazyThreadSafetyMode lazyThreadSafetyMode = LazyThreadSafetyMode.PUBLICATION;
        this.typeFqName$delegate = LazyKt__LazyJVMKt.m87228a(lazyThreadSafetyMode, new pm80(this));
        this.arrayTypeFqName$delegate = LazyKt__LazyJVMKt.m87228a(lazyThreadSafetyMode, new qm80(this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FqName arrayTypeFqName_delegate$lambda$0(PrimitiveType primitiveType) {
        return StandardNames.f63799A.m91047b(primitiveType.arrayTypeName);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FqName typeFqName_delegate$lambda$0(PrimitiveType primitiveType) {
        return StandardNames.f63799A.m91047b(primitiveType.typeName);
    }
