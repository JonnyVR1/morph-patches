...
public final class SamConversionResolverImpl implements SamConversionResolver {
    ...
    @NotNull
    public final Iterable<Object> f65876a;

    /* JADX INFO: renamed from: b */
    @NotNull
    public final CacheWithNullableValues<ClassDescriptor, SimpleType> f65877b;

    public SamConversionResolverImpl(@NotNull StorageManager storageManager, @NotNull Iterable<? extends Object> iterable) {
        storageManager.getClass();
        iterable.getClass();
        this.f65876a = iterable;
        this.f65877b = storageManager.mo92449h();
    }
}
