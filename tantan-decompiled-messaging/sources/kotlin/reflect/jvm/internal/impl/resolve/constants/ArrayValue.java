...
public class ArrayValue extends ConstantValue<List<? extends ConstantValue<?>>> {
    ...
    @NotNull
    public final Function1<ModuleDescriptor, KotlinType> f65846b;
    ...
    public KotlinType mo91908a(@NotNull ModuleDescriptor moduleDescriptor) {
        ...
        KotlinType kotlinTypeInvoke = this.f65846b.invoke(moduleDescriptor);
        if (!KotlinBuiltIns.m88181d0(kotlinTypeInvoke) && !KotlinBuiltIns.m88196r0(kotlinTypeInvoke)) {
            KotlinBuiltIns.m88171E0(kotlinTypeInvoke);
        }
