...
public abstract class AbstractLazyTypeParameterDescriptor extends AbstractTypeParameterDescriptor {
    ...
    public static /* synthetic */ void m88661P(int i) {
    ...
    public String toString() {
        String str = "";
        String str2 = mo88602s() ? "reified " : "";
        if (mo88601h() != Variance.INVARIANT) {
            str = mo88601h() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
        }
