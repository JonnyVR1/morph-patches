...
public abstract class ClassDescriptorBase extends AbstractClassDescriptor {
    ...
    public final DeclarationDescriptor f64121e;

    /* JADX INFO: renamed from: f */
    public final SourceElement f64122f;
    ...
    public ClassDescriptorBase(@NotNull StorageManager storageManager, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull Name name, @NotNull SourceElement sourceElement, boolean z) {
        ...
        this.f64121e = declarationDescriptor;
        this.f64122f = sourceElement;
        this.f64123g = z;
    }

    /* JADX INFO: renamed from: m0 */
    private static /* synthetic */ void m88703m0(int i) {
    ...
    public DeclarationDescriptor mo88299b() {
        DeclarationDescriptor declarationDescriptor = this.f64121e;
        if (declarationDescriptor == null) {
            m88703m0(4);
        }
    ...
    public SourceElement getSource() {
        SourceElement sourceElement = this.f64122f;
        if (sourceElement == null) {
            m88703m0(5);
        }
