...
public abstract class AbstractReceiverParameterDescriptor extends DeclarationDescriptorImpl implements ReceiverParameterDescriptor {
    ...
    private static /* synthetic */ void m88662P(int i) {
        String str;
        int i2;
        switch (i) {
            case 4:
    ...
    public <R, D> R mo88464S(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d) {
        return declarationDescriptorVisitor.mo88469g(this, d);
    }
    ...
    public ReceiverParameterDescriptor mo88453c(@NotNull TypeSubstitutor typeSubstitutor) {
        if (typeSubstitutor == null) {
            m88662P(3);
        }
        if (!typeSubstitutor.m92779l()) {
            KotlinType kotlinTypeM92782q = mo88299b() instanceof ClassDescriptor ? typeSubstitutor.m92782q(getType(), Variance.OUT_VARIANCE) : typeSubstitutor.m92782q(getType(), Variance.INVARIANT);
            if (kotlinTypeM92782q == null) {
                return null;
            }
            if (kotlinTypeM92782q != getType()) {
                return new ReceiverParameterDescriptorImpl(mo88299b(), new TransientReceiver(kotlinTypeM92782q), getAnnotations());
            }
        }
        return this;
    }
