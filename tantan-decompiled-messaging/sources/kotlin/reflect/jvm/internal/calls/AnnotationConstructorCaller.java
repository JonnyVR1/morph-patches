...
public final class AnnotationConstructorCaller implements Caller {
    ...
    @Metadata(m87231d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, m87232d2 = {"Lkotlin/reflect/jvm/internal/calls/AnnotationConstructorCaller$CallMode;", "", "<init>", "(Ljava/lang/String;I)V", "CALL_BY_NAME", "POSITIONAL_CALL", "kotlin-reflection"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    ...
    @Metadata(m87231d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, m87232d2 = {"Lkotlin/reflect/jvm/internal/calls/AnnotationConstructorCaller$Origin;", "", "<init>", "(Ljava/lang/String;I)V", "JAVA", "KOTLIN", "kotlin-reflection"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public enum Origin {
        JAVA,
        KOTLIN;
    ...
    public AnnotationConstructorCaller(@NotNull Class<?> cls, @NotNull List<String> list, @NotNull CallMode callMode, @NotNull Origin origin, @NotNull List<Method> list2) {
        ...
        while (it2.hasNext()) {
            ...
            returnType.getClass();
            Class<?> clsM88997k = ReflectClassUtilKt.m88997k(returnType);
            if (clsM88997k != null) {
                returnType = clsM88997k;
            }
        ...
        if (this.callMode == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && !CollectionsKt.minus(this.parameterNames, "value").isEmpty()) {
            qq3.m175877a("Positional call of a Java annotation constructor is allowed only if there are no parameters or one parameter named \"value\". This restriction exists because Java annotations (in contrast to Kotlin)do not impose any order on their arguments. Use KCallable#callBy instead.");
            throw null;
        }
    }
    ...
    public /* bridge */ /* synthetic */ Member mo88059b() {
        return (Member) m88063f();
    }

    /* JADX INFO: renamed from: c */
    public /* bridge */ void m88060c(@NotNull Object[] objArr) {
        m88061d(objArr);
    }
    ...
    public Object call(@NotNull Object[] args) {
        ...
        while (i < length) {
            Object obj = args[i];
            int i3 = i2 + 1;
            Object objM88080q = (obj == null && this.callMode == CallMode.CALL_BY_NAME) ? this.defaultValues.get(i2) : AnnotationConstructorCallerKt.m88080q(obj, this.erasedParameterTypes.get(i2));
            if (objM88080q == null) {
                AnnotationConstructorCallerKt.m88079p(i2, this.parameterNames.get(i2), this.erasedParameterTypes.get(i2));
                throw new KotlinNothingValueException();
            }
            arrayList.add(objM88080q);
            i++;
            i2 = i3;
        }
        return AnnotationConstructorCallerKt.m88070g(this.jClass, MapsKt.toMap(CollectionsKt.zip(this.parameterNames, arrayList)), this.methods);
    }

    /* JADX INFO: renamed from: d */
    public void m88061d(Object[] objArr) {
        objArr.getClass();
