...
public final class ValueClassAwareCaller<M extends Member> implements Caller<M> {
    ...
    public static final class MultiFieldValueClassPrimaryConstructorCaller implements Caller {
        ...
        public MultiFieldValueClassPrimaryConstructorCaller(@NotNull FunctionDescriptor functionDescriptor, @NotNull KDeclarationContainerImpl kDeclarationContainerImpl, @NotNull String str, @NotNull List<? extends ParameterDescriptor> list) {
            ...
            str.getClass();
            list.getClass();
            Method methodM87835y = kDeclarationContainerImpl.m87835y("constructor-impl", str);
            methodM87835y.getClass();
            this.constructorImpl = methodM87835y;
            Method methodM87835y2 = kDeclarationContainerImpl.m87835y("box-impl", StringsKt.m93458y0(str, j6f.GPS_MEASUREMENT_INTERRUPTED) + ReflectClassUtilKt.m88992f(kDeclarationContainerImpl.mo87465d()));
            methodM87835y2.getClass();
            this.boxMethod = methodM87835y2;
            ...
            while (it.hasNext()) {
                ...
                type.getClass();
                arrayList.add(ValueClassAwareCallerKt.m88123p(TypeSubstitutionKt.m92760a(type), functionDescriptor));
            }
            ...
            for (Object obj : list2) {
                ...
                ClassifierDescriptor classifierDescriptorMo88316e = ((ParameterDescriptor) obj).getType().mo91890G0().mo88316e();
                ...
                if (list3 != null) {
                    ...
                    clsM88054q.getClass();
                    collectionListOf = CollectionsKt.listOf(clsM88054q);
                }
        ...
        public /* bridge */ /* synthetic */ Member mo88059b() {
            return (Member) m88103d();
        }

        /* JADX INFO: renamed from: c */
        public boolean m88102c() {
            return false;
        }
        ...
        public final List<List<Class<?>>> m88104e() {
    ...
    @Metadata(m87231d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u000e\b\u0002\u0018\u00002\u00020\u0001B/\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0014\u0010\u0007\u001a\u0010\u0012\f\u0012\n\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u00050\u0004\u0012\b\u0010\b\u001a\u0004\u0018\u00010\u0006¢\u0006\u0004\b\t\u0010\nR\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\u000b\u0010\rR%\u0010\u0007\u001a\u0010\u0012\f\u0012\n\u0012\u0004\u0012\u00020\u0006\u0018\u00010\u00050\u00048\u0006¢\u0006\f\n\u0004\b\u000e\u0010\u000f\u001a\u0004\b\u0010\u0010\u0011R\u0019\u0010\b\u001a\u0004\u0018\u00010\u00068\u0006¢\u0006\f\n\u0004\b\u0010\u0010\u0012\u001a\u0004\b\u000e\u0010\u0013¨\u0006\u0014"}, m87232d2 = {"Lkotlin/reflect/jvm/internal/calls/ValueClassAwareCaller$a;", "", "Lkotlin/ranges/IntRange;", "argumentRange", "", "", "Ljava/lang/reflect/Method;", "unboxParameters", "box", "<init>", "(Lkotlin/ranges/IntRange;[Ljava/util/List;Ljava/lang/reflect/Method;)V", "a", "Lkotlin/ranges/IntRange;", "()Lkotlin/ranges/IntRange;", "b", "[Ljava/util/List;", "c", "()[Ljava/util/List;", "Ljava/lang/reflect/Method;", "()Ljava/lang/reflect/Method;", "kotlin-reflection"}, m87233k = 1, m87234mv = {2, 2, 0}, m87236xi = 48)
    public static final class C15174a {
        ...
        public C15174a(@NotNull IntRange intRange, @NotNull List<Method>[] listArr, @Nullable Method method) {
            intRange.getClass();
            listArr.getClass();
        ...
        @NotNull
        /* JADX INFO: renamed from: c */
        public final List<Method>[] m88107c() {
    ...
    public ValueClassAwareCaller(@NotNull CallableMemberDescriptor callableMemberDescriptor, @NotNull Caller<? extends M> caller, boolean z) {
        ...
        if (caller instanceof CallerImpl.Method.BoundStatic) {
            ...
            receiverParameterDescriptorMo88446b0 = receiverParameterDescriptorMo88446b0 == null ? callableMemberDescriptor.mo88444Y() : receiverParameterDescriptorMo88446b0;
            KotlinType type = receiverParameterDescriptorMo88446b0 != null ? receiverParameterDescriptorMo88446b0.getType() : null;
            if (type != null && InlineClassesUtilsKt.m91794i(type)) {
                if (z) {
                        ...
                        while (true) {
                            if (it2.hasNext()) {
                                if (((ValueParameterDescriptor) it2.next()).mo88615M()) {
                                    List<Method> listM88121n = ValueClassAwareCallerKt.m88121n(TypeSubstitutionKt.m92760a(type));
                                    listM88121n.getClass();
                                    List<Method> list2 = listM88121n;
                                    arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(list2, 10));
                                    it = list2.iterator();
                                    while (it.hasNext()) {
                                        arrayList.add(((Method) it.next()).invoke(((CallerImpl.Method.BoundStatic) caller).getBoundReceiver(), null));
                                    }
                                    caller = new CallerImpl.Method.BoundStaticMultiFieldValueClass(((CallerImpl.Method) caller).mo88059b(), arrayList.toArray(new Object[0]));
                                }
                            }
                        }
                    }
                } else {
                    List<Method> listM88121n2 = ValueClassAwareCallerKt.m88121n(TypeSubstitutionKt.m92760a(type));
                    listM88121n2.getClass();
                    List<Method> list3 = listM88121n2;
        ...
        Method methodM88118k = ((z3 && ((FunctionDescriptor) callableMemberDescriptor).isSuspend() && (kotlinTypeM91795j = InlineClassesUtilsKt.m91795j(returnType)) != null && KotlinBuiltIns.m88198t0(kotlinTypeM91795j)) || (clsM88127t = ValueClassAwareCallerKt.m88127t(returnType)) == null) ? null : ValueClassAwareCallerKt.m88118k(clsM88127t, callableMemberDescriptor);
        if (InlineClassesUtilsKt.m91786a(callableMemberDescriptor)) {
            c15174a = new C15174a(IntRange.INSTANCE.m87587a(), new List[0], methodM88118k);
        } else {
            int i = -1;
            if ((!(caller instanceof CallerImpl.Method.BoundStatic) || caller.getIsCallByToValueClassMangledMethod()) && !(caller instanceof CallerImpl.Method.BoundStaticMultiFieldValueClass)) {
                ...
                } else if (callableMemberDescriptor.mo88444Y() == null || (caller instanceof BoundCaller)) {
                    i = 0;
                } else {
            ...
            int i2 = caller instanceof CallerImpl.Method.BoundStaticMultiFieldValueClass ? -caller.m88090j() : i;
            List listM88125r = ValueClassAwareCallerKt.m88125r(callableMemberDescriptor, caller.mo88059b(), qrk0.INSTANCE);
            Iterator it3 = listM88125r.iterator();
            int size = 0;
            while (it3.hasNext()) {
                List<Method> listM88121n3 = ValueClassAwareCallerKt.m88121n(TypeSubstitutionKt.m92760a((KotlinType) it3.next()));
                size += listM88121n3 != null ? listM88121n3.size() : 1;
            }
            int i3 = size + i2 + (this.isDefault ? ((size + 31) / 32) + 1 : 0) + ((z3 && ((FunctionDescriptor) callableMemberDescriptor).isSuspend()) ? 1 : 0);
            ValueClassAwareCallerKt.m88114g(this, i3, callableMemberDescriptor, this.isDefault);
            IntRange intRangeM87605k = C15167a.m87605k(Math.max(i, 0), listM88125r.size() + i);
            List[] listArr = new List[i3];
            int i4 = 0;
            while (i4 < i3) {
                listArr[i4] = (i4 > intRangeM87605k.getLast() || intRangeM87605k.getFirst() > i4) ? null : ValueClassAwareCallerKt.m88123p(TypeSubstitutionKt.m92760a((KotlinType) listM88125r.get(i4 - i)), callableMemberDescriptor);
                i4++;
            }
            c15174a = new C15174a(intRangeM87605k, listArr, methodM88118k);
        }
        this.data = c15174a;
        ...
        if (length > 0) {
            listCreateListBuilder.add(C15167a.m87605k(0, length));
        }
        List<Method>[] listArrM88107c = c15174a.m88107c();
        int length2 = listArrM88107c.length;
        int i5 = 0;
        while (i5 < length2) {
            List<Method> list4 = listArrM88107c[i5];
            int size2 = (list4 != null ? list4.size() : 1) + length;
            listCreateListBuilder.add(C15167a.m87605k(length, size2));
            i5++;
            length = size2;
        }
        ...
        if (!(argumentRange instanceof Collection) || !((Collection) argumentRange).isEmpty()) {
            ...
            while (it4.hasNext()) {
                List<Method> list5 = this.data.m88107c()[((IntIterator) it4).nextInt()];
    ...
    /* JADX INFO: renamed from: d */
    public static final boolean m88100d(ClassDescriptor classDescriptor) {
        classDescriptor.getClass();
        return InlineClassesUtilsKt.m91792g(classDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.calls.Caller
    /* JADX INFO: renamed from: a */
    public boolean mo88058a() {
    ...
    public Object call(@NotNull Object[] args) throws IllegalAccessException, InvocationTargetException {
        ...
        List<Method>[] listArrM88107c = this.data.m88107c();
        ...
        if (!argumentRange.isEmpty()) {
            if (this.hasMfvcParameters) {
                ...
                if (first2 <= last) {
                    while (true) {
                        List<Method> list = listArrM88107c[first2];
                        Object obj = args[first2];
                        if (list != null) {
                            List list2 = listCreateListBuilder;
                            for (Method method : list) {
                                if (obj != null) {
                                    objM88044g2 = method.invoke(obj, null);
                                } else {
                                    Class<?> returnType = method.getReturnType();
                                    returnType.getClass();
                                    objM88044g2 = UtilKt.m88044g(returnType);
                                }
                                list2.add(objM88044g2);
                            }
                        } else {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    ...
                    if (i2 > argumentRange.getLast() || first3 > i2) {
                        ...
                        List<Method> list3 = listArrM88107c[i2];
                        Method method2 = list3 != null ? (Method) CollectionsKt.single((List) list3) : null;
                        objM88044g = args[i2];
                        if (method2 != null) {
                            if (objM88044g != null) {
                                objM88044g = method2.invoke(objM88044g, null);
                            } else {
                                Class<?> returnType2 = method2.getReturnType();
                                returnType2.getClass();
                                objM88044g = UtilKt.m88044g(returnType2);
                            }
                        }
                    }
                    objArr[i2] = objM88044g;
                }
                args = objArr;
            }
        }
        Object objCall = this.caller.call(args);
        return (objCall == uwp.m196133e() || box == null || (objInvoke = box.invoke(null, objCall)) == null) ? objCall : objInvoke;
    }

    @NotNull
    /* JADX INFO: renamed from: e */
    public final IntRange m88101e(int index) {
        if (index >= 0) {
