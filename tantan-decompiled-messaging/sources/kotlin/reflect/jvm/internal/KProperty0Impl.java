...
public class KProperty0Impl<V> extends KPropertyImpl<V> implements KProperty0<V> {
    ...
    public static final class Getter<R> extends KPropertyImpl.Getter<R> implements KProperty0.Getter<R> {
        ...
        public KProperty0Impl<R> mo87608g() {
            return this.property;
        }

        @Override // kotlin.jvm.functions.Function0
        public R invoke() {
            return mo87608g().m87920o0();
        }
    }
    ...
    public KProperty0Impl(@NotNull KDeclarationContainerImpl kDeclarationContainerImpl, @NotNull String str, @NotNull String str2, @Nullable Object obj) {
        ...
        this._getter = LazyKt__LazyJVMKt.m87228a(lazyThreadSafetyMode, new gwq(this));
        this.delegateValue = LazyKt__LazyJVMKt.m87228a(lazyThreadSafetyMode, new hwq(this));
    }

    /* JADX INFO: renamed from: k0 */
    public static final Getter m87915k0(KProperty0Impl kProperty0Impl) {
        return new Getter(kProperty0Impl);
    }

    /* JADX INFO: renamed from: n0 */
    public static final Object m87918n0(KProperty0Impl kProperty0Impl) {
        return kProperty0Impl.m87942f0(kProperty0Impl.m87940d0(), null, null);
    }
    ...
    public V m87920o0() {
        return mo87919h0().call(new Object[0]);
    }
