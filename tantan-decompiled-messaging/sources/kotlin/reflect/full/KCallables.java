...
public final class KCallables {
    ...
    public static final <R> Object m87627a(@NotNull KCallable<? extends R> kCallable, @NotNull Object[] objArr, @NotNull Continuation<? super R> continuation) throws Throwable {
        ...
        if (i2 == 0) {
            ResultKt.m87239b(objCall);
            if (!kCallable.isSuspend()) {
                return kCallable.call(Arrays.copyOf(objArr, objArr.length));
            }
            if (!(kCallable instanceof KFunction)) {
                qtc0.m176411a("Cannot callSuspend on a property ", kCallable, ": suspend properties are not supported yet");
                return null;
            }
            ...
            spreadBuilder.m87531b(objArr);
            spreadBuilder.m87530a(kCallables$callSuspend$1);
            objCall = kCallable.call(spreadBuilder.m87533d(new Object[spreadBuilder.m87532c()]));
            if (objCall == uwp.m196133e()) {
                DebugProbesKt.m87383c(kCallables$callSuspend$1);
            }
            if (objCall == objM196133e) {
                return objM196133e;
            }
        } else {
            if (i2 != 1) {
        ...
        return (!Intrinsics.m87488d(kFunction.getReturnType().mo87559i(), Reflection.m87507b(Unit.class)) || kFunction.getReturnType().mo87561k()) ? objCall : Unit.INSTANCE;
    }
    ...
    public static final <R> Object m87628b(@NotNull KCallable<? extends R> kCallable, @NotNull Map<KParameter, ? extends Object> map, @NotNull Continuation<? super R> continuation) throws Throwable {
        ...
        Object objM87727L = kCallables$callSuspendBy$1.result;
        Object objM196133e = uwp.m196133e();
        int i2 = kCallables$callSuspendBy$1.label;
        if (i2 == 0) {
            ResultKt.m87239b(objM87727L);
            if (!kCallable.isSuspend()) {
                return kCallable.callBy(map);
            }
            if (!(kCallable instanceof KFunction)) {
                qtc0.m176411a("Cannot callSuspendBy on a property ", kCallable, ": suspend properties are not supported yet");
                return null;
            }
            KCallableImpl<?> kCallableImplM88039b = UtilKt.m88039b(kCallable);
            if (kCallableImplM88039b == null) {
                zwq.m220685a("This callable does not support a default call: ", kCallable);
                return null;
            }
            kCallables$callSuspendBy$1.L$0 = kCallable;
            kCallables$callSuspendBy$1.L$1 = map;
            kCallables$callSuspendBy$1.L$2 = kCallableImplM88039b;
            kCallables$callSuspendBy$1.label = 1;
            objM87727L = kCallableImplM88039b.m87727L(map, kCallables$callSuspendBy$1);
            if (objM87727L == uwp.m196133e()) {
                DebugProbesKt.m87383c(kCallables$callSuspendBy$1);
            }
            if (objM87727L == objM196133e) {
                return objM196133e;
            }
        } else {
            if (i2 != 1) {
        ...
        KFunction kFunction = (KFunction) kCallable;
        return (!Intrinsics.m87488d(kFunction.getReturnType().mo87559i(), Reflection.m87507b(Unit.class)) || kFunction.getReturnType().mo87561k()) ? objM87727L : Unit.INSTANCE;
    }

    @NotNull
    /* JADX INFO: renamed from: c */
    public static final List<KParameter> m87629c(@NotNull KCallable<?> kCallable) {
        kCallable.getClass();
    ...
    public static final KParameter m87630d(@NotNull KCallable<?> kCallable) {
        kCallable.getClass();
        Object obj = null;
        boolean z = false;
        Object obj2 = null;
    ...
    public static final List<KParameter> m87631e(@NotNull KCallable<?> kCallable) {
        kCallable.getClass();
        List<KParameter> parameters = kCallable.getParameters();
        ArrayList arrayList = new ArrayList();
        for (Object obj : parameters) {
