...
public class CollectionsKt__CollectionsJVMKt {
    ...
    private static final <T> T[] collectionToArray(Collection<?> collection, T[] tArr) {
        collection.getClass();
        tArr.getClass();
        return (T[]) CollectionToArray.m87478b(collection, tArr);
    }

    @NotNull
    public static final <T> Object[] copyToArrayOfAny(@NotNull T[] tArr, boolean z) {
        tArr.getClass();
        if (z && Intrinsics.m87488d(tArr.getClass(), Object[].class)) {
            return tArr;
        }
    ...
    private static final Object[] collectionToArray(Collection<?> collection) {
        collection.getClass();
        return CollectionToArray.m87477a(collection);
    }
