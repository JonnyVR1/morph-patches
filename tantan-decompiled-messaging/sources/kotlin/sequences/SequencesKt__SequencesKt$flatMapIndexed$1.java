...
@DebugMetadata(m87373c = "kotlin.sequences.SequencesKt__SequencesKt$flatMapIndexed$1", m87374f = "Sequences.kt", m87375l = {383}, m87376m = "invokeSuspend", m87377v = 2)
final class SequencesKt__SequencesKt$flatMapIndexed$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<Object>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        while (it.hasNext()) {
            ...
            Object objInvoke = function2.invoke(Boxing.m87371b(i), next);
            Iterator<Object> itInvoke = this.$iterator.invoke(objInvoke);
            this.L$0 = sequenceScope;
            this.L$1 = it;
            this.L$2 = SpillingKt.m87384a(next);
            this.L$3 = SpillingKt.m87384a(objInvoke);
            this.I$0 = i3;
            this.label = 1;
            if (sequenceScope.mo93259d(itInvoke, this) == objM196133e) {
                return objM196133e;
            }
            i = i3;
        }
