...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m87398d(i, i2, i3);
        this.step = i3;
    }
    ...
    public final Iterator<UInt> iterator() {
        return new lgj0(this.first, this.last, this.step, null);
    }
    ...
    public String toString() {
        ...
        if (i2 > 0) {
            ...
            sb.append((Object) UInt.m87268h(i3));
            sb.append("..");
            sb.append((Object) UInt.m87268h(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
