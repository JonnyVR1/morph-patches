...
public final class SQLiteConnection implements gf4.InterfaceC17068a {
    ...
    private void attachCancellationSignal(gf4 gf4Var) {
        if (gf4Var != null) {
            gf4Var.m125877e();
    ...
    @SuppressLint({"Assert"})
    private void detachCancellationSignal(gf4 gf4Var) {
        if (gf4Var != null) {
            int i = this.mCancellationSignalAttachCount - 1;
            this.mCancellationSignalAttachCount = i;
            if (i == 0) {
    ...
    public void execute(String str, Object[] objArr, gf4 gf4Var) {
        if (str == null) {
    ...
    public ParcelFileDescriptor executeForBlobFileDescriptor(String str, Object[] objArr, gf4 gf4Var) {
        if (str == null) {
            ig3.m135964a("sql must not be null.");
            return null;
        }
    ...
    public int executeForChangedRowCount(String str, Object[] objArr, gf4 gf4Var) {
        if (str == null) {
            ig3.m135964a("sql must not be null.");
            return 0;
        }
    ...
    public int executeForCursorWindow(String str, Object[] objArr, CursorWindow cursorWindow, int i, int i2, boolean z, gf4 gf4Var) {
        int i3;
        String str2;
        int i4;
        String str3;
    ...
    public long executeForLastInsertedRowId(String str, Object[] objArr, gf4 gf4Var) {
        if (str == null) {
            ig3.m135964a("sql must not be null.");
            return 0L;
        }
    ...
    public long executeForLong(String str, Object[] objArr, gf4 gf4Var) {
        if (str == null) {
            ig3.m135964a("sql must not be null.");
            return 0L;
        }
    ...
    public String executeForString(String str, Object[] objArr, gf4 gf4Var) {
        if (str == null) {
            ig3.m135964a("sql must not be null.");
            return null;
        }
