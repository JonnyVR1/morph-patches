        ...
        try {
            ...
            if (sQLiteDatabase2 == null) {
                ...
                if (str == null) {
                    ...
                    try {
                        sQLiteDatabaseOpenDatabase = SQLiteDatabase.openDatabase(createConfiguration(this.mContext.getDatabasePath(str).getPath(), 268435456), this.mFactory, this.mErrorHandler);
