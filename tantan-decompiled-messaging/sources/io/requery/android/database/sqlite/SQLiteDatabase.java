...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    public Cursor query(boolean z, String str, String[] strArr, String str2, String[] strArr2, String str3, String str4, String str5, String str6, gf4 gf4Var) {
        return queryWithFactory(null, z, str, strArr, str2, strArr2, str3, str4, str5, str6, gf4Var);
    }

    public Cursor queryWithFactory(CursorFactory cursorFactory, boolean z, String str, String[] strArr, String str2, String[] strArr2, String str3, String str4, String str5, String str6, gf4 gf4Var) {
        acquireReference();
        try {
            return rawQueryWithFactory(cursorFactory, SQLiteQueryBuilder.buildQueryString(z, str, strArr, str2, str3, str4, str5, str6), strArr2, findEditTable(str), gf4Var);
        } finally {
            releaseReference();
        }
    }
    ...
    public Cursor rawQueryWithFactory(CursorFactory cursorFactory, String str, String[] strArr, String str2, gf4 gf4Var) {
        acquireReference();
        try {
            SQLiteDirectCursorDriver sQLiteDirectCursorDriver = new SQLiteDirectCursorDriver(this, str, str2, gf4Var);
    ...
    public Cursor rawQuery(String str, String[] strArr, gf4 gf4Var) {
        return rawQueryWithFactory(null, str, strArr, null, gf4Var);
    }
