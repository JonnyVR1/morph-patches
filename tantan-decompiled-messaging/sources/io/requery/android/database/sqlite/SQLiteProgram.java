...
public abstract class SQLiteProgram extends SQLiteClosable {
    ...
    public SQLiteProgram(SQLiteDatabase sQLiteDatabase, String str, Object[] objArr, gf4 gf4Var) {
        ...
        if (sqlStatementType == 4 || sqlStatementType == 5 || sqlStatementType == 6) {
            ...
            sQLiteDatabase.getThreadSession().prepare(strTrim, sQLiteDatabase.getThreadDefaultConnectionFlags(z), gf4Var, sQLiteStatementInfo);
