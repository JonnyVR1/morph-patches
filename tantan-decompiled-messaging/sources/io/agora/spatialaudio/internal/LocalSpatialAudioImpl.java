...
public class LocalSpatialAudioImpl extends ILocalSpatialAudioEngine {
    ...
    public int setZones(SpatialAudioZone[] spatialAudioZoneArr) {
        ...
        for (SpatialAudioZone spatialAudioZone : spatialAudioZoneArr) {
            if (spatialAudioZone == null || (fArr = spatialAudioZone.position) == null || fArr.length != 3 || (fArr2 = spatialAudioZone.forward) == null || fArr2.length != 3 || (fArr3 = spatialAudioZone.right) == null || fArr3.length != 3 || (fArr4 = spatialAudioZone.f63373up) == null || fArr4.length != 3) {
                return -2;
            }
        }
