...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public static /* synthetic */ class C149811 {
    ...
    private int getKeyFrameIntervalSec(VideoCodecType videoCodecType) {
        int i = C149811.$SwitchMap$io$agora$base$internal$video$VideoCodecType[videoCodecType.ordinal()];
        if (i == 1 || i == 2) {
            return 100;
        }
        if (i == 3 || i == 4) {
        ...
        if (i == 5) {
            Logging.m87209e(TAG, "UNKNOWN is not excepted but h264");
            return 20;
        }
    ...
    private boolean isH264HighProfileSupported(MediaCodecInfo mediaCodecInfo) {
        ...
        if (this.enableH264HighProfile && (z || z2)) {
            try {
                ...
                Logging.m87210e(TAG, "getCapabilitiesForType:", e);
