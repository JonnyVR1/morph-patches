...
public class VideoFrameDrawer {
    ...
    public static /* synthetic */ class C150281 {
    ...
    public static void drawTexture(RendererCommon.GlDrawer glDrawer, VideoFrame.TextureBuffer textureBuffer, int i, Matrix matrix, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        int i10 = C150281.$SwitchMap$io$agora$base$VideoFrame$TextureBuffer$Type[textureBuffer.getType().ordinal()];
        if (i10 == 1) {
    ...
    public static class YuvUploader {
        ...
        public /* synthetic */ YuvUploader(C150281 c150281) {
            this();
        }
    }
