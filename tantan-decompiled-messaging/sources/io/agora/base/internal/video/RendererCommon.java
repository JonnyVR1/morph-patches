...
public class RendererCommon {
    ...
    /* JADX INFO: renamed from: io.agora.base.internal.video.RendererCommon$1 */
    public static /* synthetic */ class C149831 {

        /* JADX INFO: renamed from: $SwitchMap$io$agora$base$internal$video$RendererCommon$ScalingType */
        static final /* synthetic */ int[] f63340x15215812;

        static {
            int[] iArr = new int[ScalingType.values().length];
            f63340x15215812 = iArr;
            try {
                iArr[ScalingType.SCALE_ASPECT_FIT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f63340x15215812[ScalingType.SCALE_ASPECT_FILL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f63340x15215812[ScalingType.SCALE_ASPECT_BALANCED.ordinal()] = 3;
    ...
    private static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i = C149831.f63340x15215812[scalingType.ordinal()];
        if (i == 1) {
            return 1.0f;
        }
        if (i == 2) {
