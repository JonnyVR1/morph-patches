...
public class VideoFrameSenderExImpl {
    ...
    public VideoFrameSenderExImpl() {
        Logging.m87211i(TAG, "constructor() enableTextureCopy:" + this.enableTextureCopy);
    }
    ...
    private VideoFrame.Buffer copyToNewTextureBuffer(VideoFrame.Buffer buffer) {
        ...
        Logging.m87209e(TAG, "Failed to create surfaceTextureHelper in copyToNewTextureBuffer");
        return null;
    }
    ...
    public static EglBase.Context createEglBaseContext(Object obj) {
        ...
        ig3.m135964a("illegal egl context");
        return null;
    }

    @CalledByNative
    private void enableTextureCopy(boolean z) {
        Logging.m87211i(TAG, "enableTextureCopy new:" + z + ", old:" + this.enableTextureCopy);
        ...
        synchronized (this.surfaceTextureHelperLock) {
            try {
                ...
                if (surfaceTextureHelperCreate == null) {
                    Logging.m87209e(TAG, "Failed to create surfaceTextureHelper");
                    return false;
                }
    ...
    private boolean reInitSurfaceTextureHelper(@NonNull EglBase.Context context) {
        Logging.m87211i(TAG, "reInitI420Converter()");
        if (this.surfaceTextureHelper != null) {
            dispose();
        }
        ...
        Logging.m87209e(TAG, "Failed to create surfaceTextureHelper in reInitI420Converter");
        return false;
    }
    ...
    private void setTextureBufferCount(int i) {
        Logging.m87211i(TAG, "setTextureBufferCount bufferCount:" + i);
        ...
        synchronized (this.surfaceTextureHelperLock) {
            ...
            if (handler != null) {
                try {
                    ...
                    Logging.m87209e(TAG, "yuvConverter release failed:" + e.toString());
                }
    ...
    public VideoFrame.Buffer newTextureBuffer(Object obj, int i, int i2, int i3, int i4, long j, float[] fArr) {
        ...
        if (i3 == 10) {
            ...
            if (i3 != 11) {
                ig3.m135964a("illegal pixel format");
                return null;
            }
        ...
        if (fArr.length != 16) {
            ig3.m135964a("unsupported matrix");
            return null;
        }
    ...
    public VideoFrame.Buffer reconstructTextureBuffer(VideoFrame.Buffer buffer) {
        ...
        if ((buffer instanceof IHandlerReplaceable) || (buffer instanceof VideoFrame.TextureBuffer)) {
            ...
            if (iHandlerReplaceable.getToI420Handler() == null || iHandlerReplaceable.getYuvConverter() == null) {
                ...
                Logging.m87209e(TAG, "converter null");
                return null;
            }
        }
        return buffer;
