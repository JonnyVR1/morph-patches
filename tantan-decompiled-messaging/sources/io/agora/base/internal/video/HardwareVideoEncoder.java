...
public class HardwareVideoEncoder implements VideoEncoder {
    ...
    public enum YuvFormat {
        I420 { // from class: io.agora.base.internal.video.HardwareVideoEncoder.YuvFormat.1
            ...
            public void fillBuffer(ByteBuffer byteBuffer, int i, int i2, VideoFrame.Buffer buffer) {
                ...
                if (byteBuffer.capacity() < i6) {
                    yfq0.m214580a("Expected destination buffer capacity to be at least ", i6, " was ", byteBuffer.capacity());
                    return;
                }
        ...
        public static void fillNV12Buffer(ByteBuffer byteBuffer, int i, int i2, VideoFrame.Buffer buffer, boolean z) {
            ...
            if (byteBuffer.capacity() < i5) {
                yfq0.m214580a("Expected destination buffer capacity to be at least ", i5, " was ", byteBuffer.capacity());
                return;
            }
            byteBuffer.position(0);
            ByteBuffer byteBufferSlice = byteBuffer.slice();
        ...
        public static YuvFormat valueOf(int i, boolean z) {
            ...
            k250.m144273a("Unsupported colorFormat: ", i);
            return null;
        }
    ...
    private VideoCodecStatus encodeByteBuffer(final VideoFrame videoFrame, final VideoFrame.Buffer buffer, final int i, final CodecSpecificInfo codecSpecificInfo) {
        ...
        if (!this.running) {
            Logging.m87209e(TAG, "encodeByteBuffer fail, encoder is not initialized!");
            return VideoCodecStatus.ERROR;
        }
        try {
                ...
                public VideoCodecStatus call() throws Exception {
                    ...
                    try {
                        ...
                        if (iDequeueInputBuffer == -1) {
                            ...
                            Logging.m87211i(HardwareVideoEncoder.TAG, "Dropped frame, no input buffers available");
                        ...
                        try {
                            ...
                            try {
                                ...
                                Logging.m87210e(HardwareVideoEncoder.TAG, "queueInputBuffer failed", e);
                            ...
                            Logging.m87210e(HardwareVideoEncoder.TAG, "getInputBuffers failed", e2);
                        ...
                        Logging.m87210e(HardwareVideoEncoder.TAG, "dequeueInputBuffer failed", e3);
    ...
    private VideoCodecStatus encodeTextureBuffer(final VideoFrame videoFrame, final CodecSpecificInfo codecSpecificInfo) {
        ...
        if (!this.running) {
            Logging.m87209e(TAG, "encodeTextureBuffer fail, encoder is not initialized!");
            return VideoCodecStatus.ERROR;
        }
        try {
            VideoCodecStatus videoCodecStatus = (VideoCodecStatus) ThreadUtils.invokeAtFrontUninterruptibly(this.proxyThreadHandler, 2000L, new Callable<VideoCodecStatus>() { // from class: io.agora.base.internal.video.HardwareVideoEncoder.6
                ...
                public VideoCodecStatus call() throws Exception {
                    ...
                    try {
                        ...
                        Logging.m87210e(HardwareVideoEncoder.TAG, "encodeTexture failed", e);
    ...
    private VideoCodecStatus initEncodeInternal() {
        Logging.m87211i(TAG, "initEncodeInternal");
        if (this.outputThread != null) {
            Logging.m87209e(TAG, "initEncodeInternal called while the codec is already running");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        if (this.proxyThreadHandler == null) {
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        ...
        if (bool != null && bool.booleanValue()) {
            Logging.m87209e(TAG, "initEncodeInternal failed, by createByCodecName.");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        ...
        try {
            VideoCodecStatus videoCodecStatus = (VideoCodecStatus) ThreadUtils.invokeAtFrontUninterruptibly(this.proxyThreadHandler, 2000L, new Callable<VideoCodecStatus>() { // from class: io.agora.base.internal.video.HardwareVideoEncoder.1
                ...
                public VideoCodecStatus call() throws Exception {
                    ...
                    try {
                        ...
                        Logging.m87209e(HardwareVideoEncoder.TAG, "Cannot create media encoder " + HardwareVideoEncoder.this.codecName);
                        return VideoCodecStatus.FALLBACK_SOFTWARE;
                    } finally {
            ...
            if (i * i2 > this.maxSupportedHeight * this.maxSupportedWidth || Math.max(i2, i) > Math.max(this.maxSupportedHeight, this.maxSupportedWidth)) {
                Logging.m87213w(TAG, "initEncode: Not supported size " + this.alignedHeight + BaseSei.f13930X + this.alignedWidth);
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
            ...
            if (videoCodecType == VideoCodecType.H264) {
                ...
                if (this.profileLevelId != null) {
                    Logging.m87211i(TAG, "h264_profile:" + this.profileLevelId);
                }
                if (str != null) {
                    Logging.m87211i(TAG, "is-highprofile-supported:".concat(str));
                }
                ...
                if ("640c1f".equals(this.profileLevelId)) {
                    ...
                    Logging.m87213w(TAG, "Unknown profile level id: " + this.profileLevelId);
                }
            ...
            Logging.m87213w(TAG, "Format: " + mediaFormatCreateVideoFormat);
                        ...
                        try {
                            ...
                            if (HardwareVideoEncoder.this.useSurfaceMode) {
                                if (HardwareVideoEncoder.this.sharedContext instanceof EglBase10.Context) {
                                    Logging.m87213w(HardwareVideoEncoder.TAG, "Encoders will use EglBase10");
                                    HardwareVideoEncoder hardwareVideoEncoder = HardwareVideoEncoder.this;
                                    ...
                                    Logging.m87213w(HardwareVideoEncoder.TAG, "Encoders will use EglBase14");
                            ...
                            Logging.m87211i(HardwareVideoEncoder.TAG, "media encoder started");
                            return VideoCodecStatus.OK;
                        } catch (Throwable th) {
                            Logging.m87209e(HardwareVideoEncoder.TAG, "initEncodeInternal failed. " + th.getMessage());
    ...
    private boolean parseAdjustmentRebootScheme() {
        try {
            ...
            Logging.m87211i(TAG, "parse from param, bitrate adjustment rebootScheme: " + z);
            return z;
        } catch (Exception unused) {
            Logging.m87211i(TAG, "fail to convert adjustment rebootScheme.");
            return false;
        }
    }
    ...
    private int parseAdjustmentTypeFromParam() {
        ...
        try {
            ...
            Logging.m87211i(TAG, "parse from param, bitrate adjustment type: ".concat(str));
            return i;
        } catch (Exception unused) {
            Logging.m87211i(TAG, "fail to convert adjustmentType.");
            return -1;
        }
    }
    ...
    private boolean parseAlignmentFromParam() {
        try {
            ...
            Logging.m87211i(TAG, "fail to convert alignment");
            return false;
        }
    }
    ...
    private void parseTimeWaitFromParam() {
        try {
            ...
            Logging.m87211i(TAG, "parse timeWaitFromParam success, value : " + this.forceDequeueTimeWait);
        } catch (Exception unused) {
            Logging.m87211i(TAG, "fail to convert timeAwaitMode");
        }
    }
    ...
    private void readVideoCapabilities() {
        ...
        if (alignmentFromParam) {
            Logging.m87213w(TAG, "parse from param, align size: " + this.widthAlignment + BaseSei.f13930X + this.heightAlignment + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        }
        try {
            codecInfo = this.codec.getCodecInfo(this.codecType.mimeType());
        } catch (Exception unused) {
            Logging.m87209e(TAG, "Cannot get CodecInfo " + this.codecName);
            codecInfo = null;
        }
        ...
        Logging.m87213w(TAG, this.codecType.mimeType() + "  max supported size:" + this.maxSupportedWidth + BaseSei.f13930X + this.maxSupportedHeight + " min supported size:" + this.minSupportedWidth + BaseSei.f13930X + this.minSupportedHeight + " align size: " + this.widthAlignment + BaseSei.f13930X + this.heightAlignment + " bitrate range: " + this.maxSupportedBitrate + " -> " + this.minSupportedBitrate);
    ...
    private VideoCodecStatus releaseInternal() {
        Logging.m87211i(TAG, "releaseInternal");
        if (this.proxyThreadHandler == null) {
            return VideoCodecStatus.ERROR;
        }
        if (!this.running) {
            Logging.m87213w(TAG, "release: encoder is not running.");
            return VideoCodecStatus.NO_OUTPUT;
        }
        if (this.outputThread == null) {
            return VideoCodecStatus.NO_OUTPUT;
        ...
        try {
            VideoCodecStatus videoCodecStatus = (VideoCodecStatus) ThreadUtils.invokeAtFrontUninterruptibly(this.proxyThreadHandler, Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS, new Callable<VideoCodecStatus>() { // from class: io.agora.base.internal.video.HardwareVideoEncoder.5
                ...
                public VideoCodecStatus call() throws Exception {
                    ...
                    try {
                        try {
                            Logging.m87211i(HardwareVideoEncoder.TAG, "stop media encoder...");
                            HardwareVideoEncoder.this.codec.stop();
                            Logging.m87211i(HardwareVideoEncoder.TAG, "release media encoder...");
                            ...
                            HardwareVideoEncoder.this.lock.unlock();
                            Logging.m87211i(HardwareVideoEncoder.TAG, "release media encoder done");
                            return VideoCodecStatus.OK;
                        } catch (Exception e) {
                            Logging.m87210e(HardwareVideoEncoder.TAG, "Media encoder release failed", e);
    ...
    private void requestKeyFrame(final long j) {
        ...
        if (!this.running) {
            Logging.m87209e(TAG, "requestKeyFrame fail, encoder is not initialized!");
            return;
        }
        try {
            ThreadUtils.invokeAtFrontUninterruptibly(this.proxyThreadHandler, 2000L, new Callable<VideoCodecStatus>() { // from class: io.agora.base.internal.video.HardwareVideoEncoder.8
                ...
                public VideoCodecStatus call() throws Exception {
                    try {
                        ...
                        Logging.m87210e(HardwareVideoEncoder.TAG, "requestKeyFrame failed", e);
                        return VideoCodecStatus.ERROR;
                    }
                }
            });
        } catch (Exception e) {
            Logging.m87210e(TAG, "requestKeyFrame failed", e);
        }
    }
    ...
    private VideoCodecStatus resetCodec(int i, int i2, boolean z, boolean z2, EglBase.Context context) {
        ...
        if (context != null) {
            Logging.m87213w(TAG, "resetCodec. contains shared EglBase.Context. Encoders will use texture mode.");
        } else {
            Logging.m87213w(TAG, "resetCodec. No shared EglBase.Context. Encoders will not use texture mode.");
        }
    ...
    private void resolutionAlignmentChecker() {
        if (this.useSurfaceMode) {
            if (!this.forceAlignment) {
                ...
                Logging.m87213w(TAG, "force resolution alignment in surface mode");
            }
        }
        int i = this.width;
        ...
        Logging.m87212v(TAG, "resolutionAlignmentChecker, alignedWidth : " + this.alignedWidth + ", alignedHeight: " + this.alignedHeight);
    }
    ...
    private VideoCodecStatus updateBitrate() {
        if (!this.running) {
            Logging.m87209e(TAG, "update bitrate fail, encoder is not initialized!");
            return VideoCodecStatus.NO_OUTPUT;
        }
        ...
        try {
            ...
            Logging.m87210e(TAG, "updateBitrate failed", e);
    ...
    public VideoCodecStatus attachProxyThread() {
        if (this.proxyThreadHandler == null) {
            Logging.m87211i(TAG, "attach encoder proxyThread");
            try {
                ...
                Logging.m87213w(TAG, "attach encoder proxyThread fail!, " + e.getMessage());
            }
        }
        return VideoCodecStatus.OK;
    }
    ...
    public void deliverEncodedImage() {
        ...
        if (this.forceDequeueTimeWait) {
            ...
            if (!this.running || this.codec == null) {
                Logging.m87209e(TAG, "[HWS] deliverEncodedImage fail, encoder is not initialized! codec " + this.codecName);
                this.lock.unlock();
                return;
            }
            while (this.running && this.outputBuilders.size() == 0) {
                try {
                    ...
                    Logging.m87209e(TAG, "codec = " + this.codecName + " deliverOutput failed " + e);
                }
            }
            this.lock.unlock();
        }
        ...
        try {
            try {
                ...
                if ((bufferInfo.flags & 2) != 0) {
                    Logging.m87211i(TAG, "Config frame generated. Offset: " + bufferInfo.offset + ". Size: " + bufferInfo.size);
                    ...
                    if (z) {
                        Logging.m87211i(TAG, "Sync frame generated");
                    }
                    if (z && ((videoCodecType = this.codecType) == VideoCodecType.H264 || videoCodecType == VideoCodecType.H265)) {
                        Logging.m87211i(TAG, "Prepending config frame of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
                    ...
                    while (!this.encodeTimeStamps.isEmpty() && (timeStampsPoll = this.encodeTimeStamps.poll()) != null && timeStampsPoll.presentationTimeStampUs != bufferInfo.presentationTimeUs) {
                        Logging.m87211i(TAG, "HW encodeTimeStamps. cannot find: " + timeStampsPoll.presentationTimeStampUs + "  presentationTimeUs: " + bufferInfo.presentationTimeUs);
                    }
                    if (timeStampsPoll == null) {
                        Logging.m87209e(TAG, "HW encodeTimeStamps empty. cannot find: " + bufferInfo.presentationTimeUs);
                        iElapsedRealtime = -1;
                    } else {
                        iElapsedRealtime = (int) (SystemClock.elapsedRealtime() - timeStampsPoll.encodecStartTimeMs);
                        if (iElapsedRealtime > 2000) {
                            Logging.m87213w(TAG, "Very high encode time: " + iElapsedRealtime + "ms.");
                            i = 2000;
                        }
                        if (this.running) {
            ...
            Logging.m87209e(TAG, "codec = " + this.codecName + " deliverOutput failed " + e2);
            ...
            Logging.m87209e(TAG, "codec = " + this.codecName + " deliverOutput error " + e3);
            this.shouldFallbackSoftware = true;
        }
    }
    ...
    public VideoCodecStatus detachProxyThread() {
        ...
        if (handler != null) {
            ...
            Logging.m87211i(TAG, "detach encoder proxyThread");
        }
        return VideoCodecStatus.OK;
    }
    ...
    public VideoCodecStatus encode(VideoFrame videoFrame, VideoEncoder.EncodeInfo encodeInfo, CodecSpecificInfo codecSpecificInfo) {
        ...
        if (this.codec == null || this.callback == null || this.proxyThreadHandler == null) {
            ...
            Logging.m87211i(TAG, sb.toString());
            return VideoCodecStatus.UNINITIALIZED;
        }
        if (videoFrame.getBuffer() == null) {
            Logging.m87209e(TAG, "encode() - no input data");
        ...
        if (width != this.width || height != this.height || z3 != this.useSurfaceMode || z4 || this.shouldUseBaseline != zShouldUseBaseline || this.shouldResetCodec) {
            ...
            if (videoCodecStatusResetCodec != VideoCodecStatus.OK) {
                Logging.m87213w(TAG, "Failed to reset the codec: " + videoCodecStatusResetCodec);
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
        }
        if (this.shouldFallbackSoftware) {
            release();
            Logging.m87213w(TAG, "Fallback to software encoder");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        if (this.inputDropCount > 5) {
            release();
            Logging.m87213w(TAG, "Fallback to software, no input buffers available");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        long j = 0;
        if (this.outputBuilders.size() > 5 || mockEncoderQueueFull) {
            Logging.m87209e(TAG, "Dropped frame, encoder queue full");
            ...
            if (jCurrentTimeMillis - this.firstEncoderQueueFullMs > 2000) {
                Logging.m87209e(TAG, "Fallback to software, encoder queue full");
                release();
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
            VideoEncoder.Callback callback = this.callback;
        ...
        if (z || zShouldForceKeyFrame) {
            Logging.m87211i(TAG, "request KeyFrame: " + z + ". shouldForce KeyFrame: " + zShouldForceKeyFrame);
        ...
        if (this.callback != null) {
            if (codecSpecificInfo != null) {
                ...
                Logging.m87213w(TAG, "onEncodeBufferPrepared fail, cannot get opaque.");
            }
    ...
    public VideoCodecStatus flush() {
        ...
        Logging.m87209e(TAG, "[HWS] signalEndOfInputStream " + this.codecName + " useSurfaceMode = " + this.useSurfaceMode);
        if (this.useSurfaceMode) {
        } else {
            try {
                Logging.m87209e(TAG, "[HWS] dequeueInputBuffer for flush");
                int iDequeueInputBuffer = this.codec.dequeueInputBuffer(0L);
                if (iDequeueInputBuffer < 0) {
                    Logging.m87209e(TAG, "[HWS] inputIndex < 0");
                    return VideoCodecStatus.ERROR;
                }
                try {
                    Logging.m87209e(TAG, "[HWS] set end of stream flag");
                    this.codec.queueInputBuffer(iDequeueInputBuffer, 0, 0, 0L, 4);
                } catch (Exception e) {
                    Logging.m87210e(TAG, "[HWS] queueInputBuffer failed", e);
                    return VideoCodecStatus.ERROR;
                }
            } catch (Exception e2) {
                Logging.m87210e(TAG, "[HWS] dequeueInputBuffer failed", e2);
                return VideoCodecStatus.ERROR;
            }
        }
        return VideoCodecStatus.OK;
    ...
    public VideoEncoder.EncoderStyle getEncoderStyle() {
        ...
        Logging.m87211i(TAG, "encoderStyle: " + this.encoderStyle + " cpuName: " + cpuName);
    ...
    public VideoEncoder.VideoHWCodecSpec getVideoHWCodecSpec() {
        ...
        int i2 = 0;
        if (str == null) {
            return new VideoEncoder.VideoHWCodecSpec(this.codecName, this.maxSupportedWidth + BaseSei.f13930X + this.maxSupportedHeight, this.bitrateMode, this.useSurfaceMode ? 1 : 0, 0, this.minSupportedBitrate);
        }
        if ("640c1f".equals(str)) {
            ...
            if (!VideoCodecInfo.H264_CONSTRAINED_MAIN_3_1.equals(this.profileLevelId)) {
                ...
                return new VideoEncoder.VideoHWCodecSpec(this.codecName, this.maxSupportedWidth + BaseSei.f13930X + this.maxSupportedHeight, this.bitrateMode, !this.useSurfaceMode ? 1 : 0, i, this.minSupportedBitrate);
            }
            i2 = 2;
        }
        i = i2;
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        int i;
        if (this.running) {
            Logging.m87213w(TAG, "already initialized!");
            return VideoCodecStatus.OK;
        }
        ...
        if (listAsList.contains(str) && this.keyFrameIntervalSec >= 100) {
            Logging.m87211i(TAG, "Model: " + str + " , need to modify interval. original keyInterval: " + this.keyFrameIntervalSec);
            this.keyFrameIntervalSec = 10;
        }
        Logging.m87213w(TAG, "initEncode: " + this.width + " x " + this.height + ". @ " + settings.startBitrate + "kbps. Fps: " + settings.maxFramerate + " Use surface mode: " + this.useSurfaceMode + " keyFrameIntervalSec: " + this.keyFrameIntervalSec + " bitrateMode: " + this.bitrateMode);
        return initEncodeInternal();
    }
    ...
    public boolean isQcomHardware() {
        Logging.m87213w(TAG, "[qualcom hardware] codecName:" + this.codecName);
        return this.codecName.startsWith("OMX.qcom") || this.codecName.startsWith("c2.qti.");
    }

    @Override // io.agora.base.internal.video.VideoEncoder
    public VideoCodecStatus release() {
        Logging.m87211i(TAG, "release encoder...");
        VideoCodecStatus videoCodecStatusReleaseInternal = releaseInternal();
        if (videoCodecStatusReleaseInternal != VideoCodecStatus.OK) {
            return videoCodecStatusReleaseInternal;
        }
        ...
        this.shouldResetCodec = false;
        this.deliveredVideoFrame = false;
        Logging.m87211i(TAG, "release encoder done");
        return videoCodecStatusReleaseInternal;
    }
    ...
    public VideoCodecStatus resume() {
        ...
        Logging.m87209e(TAG, "[HWS] Resume " + this.codecName + " useSurfaceMode = " + this.useSurfaceMode);
        if (this.useSurfaceMode) {
        } else {
            try {
                this.codec.flush();
            } catch (Throwable th) {
                Logging.m87210e(TAG, "[HWS] flush failed", th);
                return VideoCodecStatus.ERROR;
            }
        }
        return VideoCodecStatus.OK;
    ...
    public VideoCodecStatus setRateAllocation(VideoEncoder.BitrateAllocation bitrateAllocation, int i) {
        ...
        Logging.m87211i(TAG, "setRateAllocation, bitrate:" + bitrateAllocation.getSum() + " ,framerate: " + i + " ,maxFramerate: " + this.maxFramerate + " adjustBitrate: " + sum2);
