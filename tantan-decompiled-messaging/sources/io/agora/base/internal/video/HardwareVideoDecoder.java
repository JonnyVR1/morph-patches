...
class HardwareVideoDecoder implements VideoDecoder, VideoSink {
    ...
    private void deliverByteFrame(int i, MediaCodec.BufferInfo bufferInfo) {
        ...
        if (i6 < ((i2 * i3) * 3) / 2) {
            Logging.m87209e(TAG, "Insufficient output buffer size: " + bufferInfo.size);
            return;
        }
        ...
        try {
            ...
            Logging.m87210e(TAG, "getOutputBuffers failed", e);
            byteBuffer = null;
        }
        ...
        try {
            ...
            Logging.m87210e(TAG, "deliverByteFrame failed", e2);
        } catch (Exception e3) {
            Logging.m87210e(TAG, "deliverByteFrame error", e3);
        }
        ...
        if (timeStampsPoll == null) {
            Logging.m87209e(TAG, "deliverByteFrame cannot find presentationTimeUs.");
            return;
        }
        ...
        if (frameExtraInfoRemove == null) {
            Logging.m87209e(TAG, "HW frameExtraInfo empty. cannot find: " + j);
            hardwareVideoDecoder.fallbackByCodecError = true;
            videoFrame2.release();
            return;
        }
        if (codecSpecificInfoRemove == null) {
            Logging.m87209e(TAG, "HW decodeTimeStamps empty. cannot find: " + j);
        }
        ...
        if (iElapsedRealtime2 > hardwareVideoDecoder.maxDecodeTimeMs) {
            ...
            Logging.m87213w(TAG, "Very high decode time: " + iElapsedRealtime2 + "ms.");
    ...
    private void deliverTextureFrame(int i, MediaCodec.BufferInfo bufferInfo) {
        ...
        if (timeStampsPoll == null) {
            Logging.m87209e(TAG, "deliverTextureFrame cannot find presentationTimeUs.");
            return;
        }
        ...
        synchronized (this.textureMetadataLock) {
            ...
            if (this.dequeuedSurfaceOutputBuffers.size() >= 3) {
                ...
                try {
                    ...
                    Logging.m87210e(TAG, "deliverTextureFrame failed", e);
                }
            }
        }
    }
    ...
    private void deliverToDirectSurface(int i, MediaCodec.BufferInfo bufferInfo) {
        try {
            ...
            Logging.m87210e(TAG, "deliverToDirectSurface failed", e);
        }
    }
    ...
    private VideoCodecStatus initDecodeInternal(VideoDecoder.Settings settings) {
        ...
        String str;
        Logging.m87211i(TAG, "initDecodeInternal");
        if (this.proxyThreadHandler == null) {
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        if (this.outputThread != null) {
            Logging.m87209e(TAG, "initDecodeInternal called while the codec is already running");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        Boolean bool = codecUnavailableMap.get(this.codecName);
        if (bool != null && bool.booleanValue()) {
            Logging.m87209e(TAG, "initDecodeInternal failed, by createByCodecName.");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
        ...
        if (str2 == null || (str = Build.HARDWARE) == null || !str2.startsWith("OMX.hisi.") || !str.startsWith("bigfish")) {
            ...
            Logging.m87211i(TAG, " bigfish isHisiCodec: " + this.isHisiCodec);
        }
        try {
            VideoCodecStatus videoCodecStatus = (VideoCodecStatus) ThreadUtils.invokeAtFrontUninterruptibly(this.proxyThreadHandler, 2000L, new Callable<VideoCodecStatus>() { // from class: io.agora.base.internal.video.HardwareVideoDecoder.1
                ...
                public VideoCodecStatus call() throws Exception {
                    ...
                    try {
                        ...
                        Logging.m87209e(HardwareVideoDecoder.TAG, "Cannot create media decoder " + HardwareVideoDecoder.this.codecName);
                        return VideoCodecStatus.FALLBACK_SOFTWARE;
                    }
                }
            });
            ...
            try {
                VideoCodecStatus videoCodecStatus2 = (VideoCodecStatus) ThreadUtils.invokeAtFrontUninterruptibly(this.proxyThreadHandler, 2000L, new Callable<VideoCodecStatus>() { // from class: io.agora.base.internal.video.HardwareVideoDecoder.2
                    ...
                    public VideoCodecStatus call() throws Exception {
                        try {
                            ...
                            Logging.m87209e(HardwareVideoDecoder.TAG, "initDecode failed" + th.getMessage());
                ...
                Logging.m87211i(TAG, "initDecodeInternal " + this.codecType.mimeType() + " done, format: " + mediaFormatCreateVideoFormat + " transfer: " + this.transfer);
    ...
    private boolean isSupportedLowLatency(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        ...
        try {
            ...
            Logging.m87209e(TAG, "Cannot get LowLatency: " + e.getMessage());
            return false;
        }
    }
    ...
    private void maybeRenderDecodedTextureBuffer() {
        ...
        if (!this.running) {
            Logging.m87211i(TAG, "RenderTexture: Decoder is not running.");
            return;
        }
        DecodedTextureMetadata decodedTextureMetadataPoll = this.dequeuedSurfaceOutputBuffers.poll();
        ...
        try {
            ...
            Logging.m87210e(TAG, "deliverToDirectSurface failed", e2);
        } catch (Exception e3) {
            Logging.m87210e(TAG, "deliverToDirectSurface error", e3);
        }
    }
    ...
    private void parseTextureCopyFromParam() {
        try {
            ...
            Logging.m87211i(TAG, "parse hwdec textureCopy success, value : " + this.textureCopy);
        } catch (Exception unused) {
            Logging.m87211i(TAG, "fail to convert hwdec textureCopy");
        }
    }
    ...
    private void readVideoCapabilities(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        ...
        Logging.m87211i(TAG, this.codecType.mimeType() + "  max supported size:" + iIntValue2 + BaseSei.f13930X + iIntValue4 + " min supported size:" + iIntValue + BaseSei.f13930X + iIntValue3);
    ...
    private void reformat(MediaFormat mediaFormat) {
        ...
        Logging.m87211i(TAG, "Decoder format changed: " + mediaFormat.toString());
        ...
        synchronized (this.dimensionLock) {
            try {
                if (this.hasDecodedFirstFrame && (this.width != integer || this.height != integer2)) {
                    Logging.m87213w(TAG, "Configured size change, " + this.width + "*" + this.height + ". New " + integer + "*" + integer2);
                }
                this.width = integer;
        ...
        if (this.surfaceTextureHelper == null && this.directSurface == null && mediaFormat.containsKey("color-format")) {
            ...
            Logging.m87211i(TAG, "reformat, Color: 0x" + Integer.toHexString(integer3));
        ...
        synchronized (this.dimensionLock) {
            try {
                ...
                Logging.m87211i(TAG, "Frame stride and slice height: " + this.stride + " x " + this.sliceHeight);
    ...
    public void releaseCodecOnOutputThread() {
        this.outputThreadChecker.checkIsOnValidThread();
        Logging.m87211i(TAG, "Releasing MediaCodec on output thread");
        try {
            this.codec.stop();
        } catch (Exception e) {
            Logging.m87210e(TAG, "Media decoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m87210e(TAG, "Media decoder release failed", e2);
            this.shutdownException = e2;
        }
        synchronized (this.textureMetadataLock) {
            this.dequeuedSurfaceOutputBuffers.clear();
        }
        Logging.m87211i(TAG, "Release on output thread done");
    }
    ...
    private VideoCodecStatus releaseInternal() {
        ...
        if (!this.running) {
            Logging.m87211i(TAG, "release: Decoder is not running.");
            return VideoCodecStatus.OK;
        }
        try {
            this.running = false;
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS)) {
                Logging.m87210e(TAG, "Media decoder release timeout", new RuntimeException());
                ...
                Logging.m87210e(TAG, "Media decoder release error", new RuntimeException(this.shutdownException));
    ...
    public VideoCodecStatus attachProxyThread() {
        if (this.proxyThreadHandler == null) {
            Logging.m87211i(TAG, "attach decoder proxyThread");
            try {
                ...
                Logging.m87213w(TAG, "attach decoder proxyThread fail!, " + e.getMessage());
            }
        }
        return VideoCodecStatus.OK;
    }
    ...
    public VideoCodecStatus decode(final EncodedImage encodedImage, VideoDecoder.DecodeInfo decodeInfo, final CodecSpecificInfo codecSpecificInfo, final FrameExtraInfo frameExtraInfo) {
        ...
        if (byteBuffer == null) {
            Logging.m87209e(TAG, "decode() - no input data");
            return VideoCodecStatus.ERR_PARAMETER;
        }
        final int iRemaining = byteBuffer.remaining();
        if (iRemaining == 0) {
            Logging.m87209e(TAG, "decode() - input buffer empty");
            return VideoCodecStatus.ERR_PARAMETER;
        }
        synchronized (this.dimensionLock) {
            i = this.width;
        ...
        if (colorSpace != null && colorSpace.getTransfer().getTransfer() != this.transfer && HdrUtil.is10BitLumaDepth(encodedImage.colorSpace.getTransfer().getTransfer())) {
            Logging.m87209e(TAG, "decode() - transfer change: " + encodedImage.colorSpace.getTransfer().getTransfer() + " should reset codec.");
        ...
        if (this.highLatencyTrigger) {
            Logging.m87209e(TAG, "decode() - codec high delay trigger, should reset codec.");
            this.highLatencyTrigger = false;
        ...
        if ((i3 * i4 > 0 && (i3 != i || i4 != i2)) || this.shouldResetCodec) {
            Logging.m87213w(TAG, "decode() - reinitDecode.");
        ...
        if (this.decodeTimeStamps.size() > 5) {
            ...
            if (jCurrentTimeMillis - this.firstDecoderQueueFullMs > 2000) {
                Logging.m87209e(TAG, "Fallback to software, decoder queue full");
                release();
        ...
        if (this.callback != null) {
            if (codecSpecificInfo != null) {
                ...
                Logging.m87209e(TAG, "onDecodeBufferPrepared fail, cannot get opaque.");
            }
            this.callback.onDecodeBufferPrepared(j);
        }
        if (this.keyFrameRequired) {
            if (encodedImage.frameType != EncodedImage.FrameType.VideoFrameKey) {
                Logging.m87209e(TAG, "decode() - key frame required first");
                return VideoCodecStatus.NO_OUTPUT;
            }
            if (!encodedImage.completeFrame) {
                Logging.m87209e(TAG, "decode() - complete frame required first");
                return VideoCodecStatus.NO_OUTPUT;
            }
        }
        try {
                ...
                public VideoCodecStatus call() throws Exception {
                    ...
                    try {
                        ...
                        if (iDequeueInputBuffer == -1) {
                            ...
                            Logging.m87211i(HardwareVideoDecoder.TAG, "Dropped frame, no input buffers available");
                            return VideoCodecStatus.NO_OUTPUT;
                        }
                        hardwareVideoDecoder.inputDropCount = 0;
                        if (iDequeueInputBuffer < 0) {
                            Logging.m87209e(HardwareVideoDecoder.TAG, "decode() - no HW buffers available; decoder falling behind");
                        ...
                        try {
                            ...
                            if (byteBuffer2.capacity() < iRemaining) {
                                Logging.m87209e(HardwareVideoDecoder.TAG, "decode() - HW buffer too small");
                                return VideoCodecStatus.ERROR;
                            }
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    e = e;
                                    Logging.m87210e(HardwareVideoDecoder.TAG, "queueInputBuffer failed", e);
                            ...
                            Logging.m87210e(HardwareVideoDecoder.TAG, "getInputBuffers failed", e3);
                        ...
                        Logging.m87210e(HardwareVideoDecoder.TAG, "dequeueInputBuffer failed", e4);
    ...
    public void deliverDecodedFrame() {
        ...
        try {
            ...
            if (bufferInfo.presentationTimeUs == 0) {
                Logging.m87211i(TAG, "dequeueOutputBuffer fail, presentationTimeUs is 0.");
            ...
            Logging.m87210e(TAG, "deliverDecodedFrame failed", e);
            ...
            this.fallbackByCodecError = true;
            Logging.m87210e(TAG, "deliverDecodedFrame error", e2);
        }
    }
    ...
    public VideoCodecStatus detachProxyThread() {
        ...
        if (handler != null) {
            ...
            Logging.m87211i(TAG, "detach decoder proxyThread");
        }
        return VideoCodecStatus.OK;
    }
    ...
    public VideoCodecStatus initDecode(VideoDecoder.Settings settings, VideoDecoder.Callback callback) {
        ...
        if (surface != null) {
            ...
            Logging.m87213w(TAG, "initDecodeInternal fail, raw data format not supported!");
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        if (frameExtraInfoRemove == null) {
            Logging.m87209e(TAG, "HW frameExtraInfo empty. cannot find: " + j4);
            this.fallbackByCodecError = true;
            videoFrame.release();
            return;
        }
        if (codecSpecificInfoRemove == null) {
            Logging.m87209e(TAG, "HW decodeTimeStamps empty. cannot find: " + j4);
        }
        ...
        if (iElapsedRealtime > this.maxDecodeTimeMs) {
            ...
            Logging.m87213w(TAG, "Very high decode time: " + iElapsedRealtime + "ms.");
        ...
        if (this.deliveredCount == 0) {
            Logging.m87211i(TAG, "directOes: " + z + ", transfer: " + this.transfer + " is10BitLumaDepth: " + HdrUtil.is10BitLumaDepth(this.transfer) + " textureCopy: " + this.textureCopy);
        }
        ...
        if (textureBufferTextureCopy == null) {
            Logging.m87211i(TAG, "failed to copy texture buffer, drop frame");
            return;
        }
