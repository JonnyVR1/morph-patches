...
public class EglRenderer implements VideoSink {
    ...
    public static class HandlerWithFrameSyncControl extends Handler implements Choreographer.FrameCallback {
        ...
        private void doLut10Frame(byte[] bArr) {
            ...
            if (eglRenderer == null) {
                Logging.m87209e(EglRenderer.TAG, "handleMessage: weak is null");
            } else {
        ...
        public void dispatchMessage(Message message) {
            try {
                ...
                Logging.m87210e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
        ...
        public void doFrame(long j) {
            EglRenderer eglRenderer = this.weakRenderer.get();
            if (eglRenderer == null) {
                Logging.m87209e(EglRenderer.TAG, "doFrame: weak is null");
                return;
            }
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                Logging.m87209e(EglRenderer.TAG, "setRepeatingRequest failed, error message : " + e.getMessage());
            }
        }
            ...
            synchronized (this.queueLock) {
                try {
                    ...
                    if (!this.renderFrames.add(videoFrameInternal)) {
                        Logging.m87209e(EglRenderer.TAG, "offer error ");
                ...
                try {
                    if (EglRenderer.ENABLE_LAST_FRAME && eglRenderer != null) {
                        if (!this.renderFrames.add(new VideoFrameInternal(eglRenderer.lastFrame, j))) {
                            Logging.m87209e(EglRenderer.TAG, "sendLastFrameToRenderThread offer error ");
                        }
                    }
                } catch (Throwable th) {
                    throw th;
    ...
    private void logD(String str) {
        Logging.m87208d(TAG, this.name + str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void logI(String str) {
        Logging.m87211i(TAG, this.name + str);
    }
        ...
        synchronized (this.surfaceLock) {
            try {
                ...
                if (!this.islut10Update && HdrUtil.isNeedHdrSdrTrans(this.transferID)) {
                    Logging.m87211i(TAG, "doLut10Frame getTransfer: " + videoFrame.getColorSpace().getTransfer().getTransfer());
                    ...
                    this.renderThreadHandler.post(new Runnable() { // from class: io.agora.base.internal.video.EglRenderer.4
                        ...
                        public void run() {
                            try {
                                ...
                                Logging.m87210e(EglRenderer.TAG, "Exception on Choreographer start and not use vsync to render", e);
                            }
                        }
                    });
                } else {
