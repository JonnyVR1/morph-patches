...
public class YuvConverter {
    ...
    public static /* synthetic */ class C150353 {
    ...
    private boolean checkMaxTextureSize(int i, int i2) {
        ...
        Logging.m87209e(TAG, "reach max texture size width:" + i + ", height:" + i2 + ", maxTextureSize:" + this.maxTextureSize);
        return true;
    }
    ...
    private void drawTexture(int i, VideoFrame.TextureBuffer.Type type, int i2, int i3, int i4) {
        ...
        int i5 = C150353.$SwitchMap$io$agora$base$VideoFrame$TextureBuffer$Type[type.ordinal()];
        if (i5 == 1) {
        ...
        try {
            if (enableHardwareBuffer) {
                ...
                if (enableConvertPerLog) {
                    ...
                    if (j2 % 100 == 0) {
                        ...
                        sb2.append(" ns");
                        Logging.m87213w(TAG, sb2.toString());
                    }
                } else {
                    z4 = z2;
                }
            ...
            if (z2) {
                ...
                if (enableConvertPerLog) {
                    ...
                    if (j2 % 100 == 0) {
                        ...
                        sb3.append(" ns");
                        Logging.m87213w(TAG, sb3.toString());
                    }
                } else {
                    z4 = z2;
                }
            ...
            if (enableConvertPerLog) {
                ...
                if (j2 % 100 == 0) {
                    ...
                    sb4.append(" ns");
                    Logging.m87213w(TAG, sb4.toString());
                }
            } else {
                z4 = z2;
            }
            ...
            JniCommon.nativeFreeByteBuffer(byteBuffer);
            Logging.m87213w(TAG, "convert error: " + e.getMessage());
            return null;
        }
        z = false;
        glTextureFrameBuffer = this.i420TextureFrameBuffer;
