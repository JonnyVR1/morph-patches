...
public class GlTextureFrameBuffer {
        ...
        if (i != 34842) {
            switch (i) {
                ...
                case 6409:
                    break;
                default:
                    k250.m144273a("Invalid pixel format: ", i);
                    throw null;
            }
        }
        this.pixelFormat = i;
    ...
    public void bindTexture(int i, int i2, int i3, int i4, boolean z) {
        ...
        if (iGlCheckFramebufferStatus == 36053) {
            ...
            f3c.m119257a("Framebuffer not complete, status: ", iGlCheckFramebufferStatus);
        }
    }
    ...
    public void setSize(int i, int i2) {
        ...
        int i4;
        if (i <= 0 || i2 <= 0) {
            ckq0.m107426a("Invalid size: ", i, BaseSei.f13930X, i2);
            return;
        }
