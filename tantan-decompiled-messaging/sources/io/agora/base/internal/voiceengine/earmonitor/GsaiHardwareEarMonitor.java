...
public abstract class GsaiHardwareEarMonitor implements IHardwareEarMonitor {
    ...
    public void destroy() {
        Logging.m87208d(this.TAG, "karaoke kit destroy");
        this.mListener = null;
    ...
    public int enableHardwareEarMonitor(boolean z) {
        Logging.m87208d(this.TAG, ">>enableHardwareEarMonitor " + z);
        ...
        try {
            ...
            Logging.m87210e(this.TAG, "enableHardwareEarMonitor failed ", th);
            return -1;
        }
    }
    ...
    public void initialize() {
        Logging.m87208d(this.TAG, "HnAudioClient initialize");
        if (this.mContext == null) {
            Logging.m87209e(this.TAG, "mContext is null!");
            return;
        }
        if (this.mInitialized) {
            Logging.m87213w(this.TAG, "already initialized, ignore");
            return;
        }
        try {
            ...
            Logging.m87208d(this.TAG, "MediaClient initialize success");
        } catch (Throwable unused) {
            Logging.m87208d(this.TAG, "MediaClient initialize failed");
        }
    }
    ...
    public boolean isHardwareEarMonitorSupported() {
        try {
            ...
            Logging.m87210e(this.TAG, "isHardwareEarMonitorSupported false ", th);
            return false;
        }
    }
    ...
    public int setHardwareEarMonitorVolume(int i) {
        ...
        Logging.m87208d(this.TAG, ">>setHardwareEarMonitorVolume " + i2);
        try {
            ...
            Logging.m87210e(this.TAG, "setHardwareEarMonitorVolume failed ", th);
            return -1;
        }
    }
}
