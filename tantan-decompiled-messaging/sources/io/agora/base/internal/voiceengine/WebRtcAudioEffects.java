...
public class WebRtcAudioEffects {
    ...
    @Nullable
    private NoiseSuppressor f63344ns = null;
    ...
    public static boolean canUseAcousticEchoCanceler() {
        ...
        Logging.m87208d(TAG, "canUseAcousticEchoCanceler: " + z);
        return z;
    }
    ...
    public static boolean canUseAutomaticGainControl() {
        ...
        Logging.m87208d(TAG, "canUseAutomaticGainControl: " + z);
        return z;
    }
    ...
    public static boolean canUseNoiseSuppressor() {
        ...
        Logging.m87208d(TAG, "canUseNoiseSuppressor: " + z);
        return z;
    }
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (zContains) {
            Logging.m87213w(TAG, str + " is blacklisted for HW AEC usage!");
        }
        return zContains;
    }
    ...
    public static boolean isAutomaticGainControlBlacklisted() {
        ...
        if (zContains) {
            Logging.m87213w(TAG, str + " is blacklisted for HW AGC usage!");
        }
        return zContains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (zContains) {
            Logging.m87213w(TAG, str + " is blacklisted for HW NS usage!");
        }
        return zContains;
    }
    ...
    public void enable(int i) {
        Logging.m87208d(TAG, "enable(audioSession=" + i + ")");
        boolean z = false;
        assertTrue(this.aec == null);
        assertTrue(this.f63344ns == null);
        ...
        if (isAcousticEchoCancelerSupported() && this.shouldEnableAec) {
            ...
            if (acousticEchoCancelerCreate != null) {
                ...
                if (this.aec.setEnabled(z2) != 0) {
                    Logging.m87209e(TAG, "Failed to set the AcousticEchoCanceler state");
                }
        ...
        if (isNoiseSuppressorSupported() && this.shouldEnableNs) {
            ...
            if (noiseSuppressorCreate != null) {
                ...
                if (this.f63344ns.setEnabled(z3) != 0) {
                    Logging.m87209e(TAG, "Failed to set the NoiseSuppressor state");
                }
                ...
                sb2.append(z3);
                sb2.append(", is now: ");
                sb2.append(this.f63344ns.getEnabled() ? "enabled" : "disabled");
                Logging.m87208d(TAG, sb2.toString());
            } else {
                Logging.m87209e(TAG, "Failed to create the NoiseSuppressor instance");
            }
        }
        if (isAutomaticGainControlSupported() && this.shouldEnableAgc) {
            ...
            if (automaticGainControlCreate == null) {
                Logging.m87209e(TAG, "Failed to create the AutomaticGainControl instance");
                return;
            }
            ...
            if (this.agc.setEnabled(z) != 0) {
                Logging.m87209e(TAG, "Failed to set the AutomaticGainControl state");
            }
            ...
            Logging.m87208d(TAG, sb3.toString());
        }
    }

    public void release() {
        Logging.m87208d(TAG, "release");
        ...
        NoiseSuppressor noiseSuppressor = this.f63344ns;
    ...
    public boolean setAEC(boolean z) {
        Logging.m87208d(TAG, "setAEC(" + z + ")");
        if (!canUseAcousticEchoCanceler()) {
            Logging.m87213w(TAG, "Platform AEC is not supported");
            this.shouldEnableAec = false;
            return false;
        }
        ...
        Logging.m87209e(TAG, "Platform AEC state can't be modified while recording");
        return false;
    }

    public boolean setAGC(boolean z) {
        Logging.m87208d(TAG, "setAGC(" + z + ")");
        if (!canUseAutomaticGainControl()) {
            Logging.m87213w(TAG, "Platform AGC is not supported");
            this.shouldEnableAgc = false;
            return false;
        }
        ...
        Logging.m87209e(TAG, "Platform AGC state can't be modified while recording");
        return false;
    }

    public boolean setNS(boolean z) {
        Logging.m87208d(TAG, "setNS(" + z + ")");
        if (!canUseNoiseSuppressor()) {
            Logging.m87213w(TAG, "Platform NS is not supported");
            this.shouldEnableNs = false;
            return false;
        }
        if (this.f63344ns == null || z == this.shouldEnableNs) {
            this.shouldEnableNs = z;
            return true;
        }
        Logging.m87209e(TAG, "Platform NS state can't be modified while recording");
        return false;
    }
}
