...
public class AssetsFileReader {
    ...
    public void closeFile() {
        ...
        if (fileChannel != null) {
            try {
                ...
                e.printStackTrace();
                Logging.m87209e(TAG, "AssetsFileReader closeFile Step1 error: " + e.getMessage());
            }
        ...
        if (fileInputStream != null) {
            try {
                ...
                e2.printStackTrace();
                Logging.m87209e(TAG, "AssetsFileReader closeFile Step2 error: " + e2.getMessage());
            }
        ...
        if (assetFileDescriptor != null) {
            try {
                ...
                e3.printStackTrace();
                Logging.m87209e(TAG, "AssetsFileReader closeFile Step3 error: " + e3.getMessage());
            }
            this.afd = null;
        }
    }
    ...
    public long getCurrentPosition() {
        ...
        try {
            ...
            e.printStackTrace();
            Logging.m87209e(TAG, " read error: " + e.getMessage());
            return -2L;
        }
    }
    ...
    public long seek(long j) {
        ...
        try {
            ...
            e.printStackTrace();
            Logging.m87209e(TAG, "AssetsFileReader seek error: " + e.getMessage());
            return -2L;
        }
    }
}
