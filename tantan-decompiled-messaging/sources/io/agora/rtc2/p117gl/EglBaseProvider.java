...
public class EglBaseProvider {
    ...
    private void checkReleased(String str) {
        ...
        yek0.m214351a(RELEASE_MESSAGE_TEMPLATE, new Object[]{str});
    }
    ...
    private EglBase.Context createEglBaseContext(Object obj) {
        ...
        if (!(obj instanceof android.opengl.EGLContext)) {
            Logging.m87209e(TAG, "illegal egl context!");
            return null;
        }
        EglBase14.Context context = new EglBase14.Context((android.opengl.EGLContext) obj);
        Logging.m87211i(TAG, "createRemoteEglContext: " + context.getEglContext());
        return context;
    }
        ...
        synchronized (EglBaseProvider.class) {
            try {
                ...
                if (obj == null) {
                    ...
                    Logging.m87211i(TAG, "replaceRemoteEglContext: " + eglBaseContext + " eglBase Context: " + this.rootEglBase.getEglBaseContext());
                }
                releaseRemoteEglbase();
