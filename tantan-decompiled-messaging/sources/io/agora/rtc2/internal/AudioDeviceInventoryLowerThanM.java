...
public class AudioDeviceInventoryLowerThanM implements AudioRoutingController.AudioDeviceInventory {
    ...
    public AudioDeviceInventoryLowerThanM(Context context) {
        ...
        Logging.m87222i(TAG, "AudioDeviceInventoryLowerThanM ctor!");
    }
    ...
    private int getBtConnectedDevicesSize() {
        ...
        try {
            ...
            while (it.hasNext()) {
                Logging.m87222i(TAG, "connected device name: " + it.next().getName());
            }
        ...
        try {
            this.mBTHeadsetListener = new BluetoothProfile.ServiceListener() { // from class: io.agora.rtc2.internal.AudioDeviceInventoryLowerThanM.1
                ...
                public void onServiceConnected(int i, BluetoothProfile bluetoothProfile) {
                    Logging.m87222i(AudioDeviceInventoryLowerThanM.TAG, "onServiceConnected " + i + " =? headset(1)");
                    if (i == 1) {
                        Logging.m87222i(AudioDeviceInventoryLowerThanM.TAG, "on BT service connected: " + i + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + bluetoothProfile);
                ...
                public void onServiceDisconnected(int i) {
                    Logging.m87222i(AudioDeviceInventoryLowerThanM.TAG, "onServiceDisconnected " + i + " =? headset(1)");
                    if (i == 1) {
                        Logging.m87222i(AudioDeviceInventoryLowerThanM.TAG, "on BT service disconnected: " + i);
            ...
            Logging.m87219e(TAG, "initialize failed: unable to create BluetoothProfile.ServiceListener, err=" + e.getMessage());
        }
    }
    ...
    private void initBtBroadcastReceiver(Context context) {
        ...
        if ((i >= 31 && !hasPermission(context, PERMISSION_BLUETOOTH_CONNECT)) || (i < 31 && !hasPermission(context, "android.permission.BLUETOOTH"))) {
            Logging.m87224w(TAG, "do not support BT monitoring on this device");
            return;
        }
        ...
        try {
            ...
            if (defaultAdapter == null) {
                Logging.m87219e(TAG, "initialize: failed to get bluetooth adapter!!");
                return;
            }
            ...
            ii5.m136342l(context, this.mBTHeadsetReceiver, intentFilter);
            ...
            Logging.m87219e(TAG, "unable to create BluetoothHeadsetBroadcastReceiver, err:" + e.getMessage());
        }
    }
    ...
    private void initHeadsetBroadcastReceiver(Context context) {
        ...
        Intent intentM136342l = ii5.m136342l(context, this.mHeadsetReceiver, intentFilter);
        if (intentM136342l != null && TextUtils.equals(intentM136342l.getAction(), "android.intent.action.HEADSET_PLUG")) {
            processHeadsetIntent(intentM136342l);
        }
        AudioRoutingController.MockedBroadcaseter mockedBroadcaseter = mockedBroadcaster;
        if (mockedBroadcaseter != null) {
    ...
    public void onAudioDeviceChanged(int i, boolean z) {
        StringBuilder sb = new StringBuilder("onAudioDeviceChanged route :");
        sb.append(i);
        sb.append(" status: ");
    ...
    public void processBluetoothIntent(Intent intent) {
        ...
        try {
            if (action.equals("android.bluetooth.headset.profile.action.CONNECTION_STATE_CHANGED")) {
                ...
                Logging.m87216d(TAG, "BT " + (bluetoothDevice != null ? bluetoothDevice.getName() : "null name") + " hfp connect state : " + intExtra2 + ", " + intExtra);
                if (intExtra != 0) {
                    if (intExtra != 2) {
                        Logging.m87222i(TAG, bluetoothDevice + " unknown event, state=" + intExtra);
                        return;
                    }
                    Logging.m87222i(TAG, "Bluetooth device " + bluetoothDevice + " connected");
                    onAudioDeviceChanged(5, true);
                    return;
                }
                Logging.m87222i(TAG, "Bluetooth device " + bluetoothDevice + " disconnected");
                ...
                Logging.m87216d(TAG, "BluetoothAdapter.ACTION_STATE_CHANGED prev " + intent.getIntExtra("android.bluetooth.adapter.extra.PREVIOUS_STATE", -99) + ", " + intExtra3);
                if (intExtra3 != 10) {
                    return;
                }
            }
            ...
            Logging.m87220e(TAG, "BT broadcast receiver onReceive fail ", e);
        }
    }
    ...
    public void dispose() {
        try {
            ...
            Logging.m87220e(TAG, "AudioDeviceInventoryLowerThanM dispose fail: ", e);
        }
    }
    ...
    public void initialize() {
        Context context = this.mContext.get();
        Logging.m87222i(TAG, "AudioDeviceInventoryLowerThanM initialize +");
    ...
    public boolean isDeviceAvaliable(int i) {
        ...
        BluetoothAdapter bluetoothAdapter = this.mBTAdapter;
        if (bluetoothAdapter != null && 2 == ii5.m136334d(bluetoothAdapter, 1)) {
            return true;
        }
        return false;
    }
