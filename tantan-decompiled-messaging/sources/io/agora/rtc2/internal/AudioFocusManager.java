...
public class AudioFocusManager {
    ...
    public class AudioFocusChangeListenerImpl implements AudioManager.OnAudioFocusChangeListener {
        ...
        public void onAudioFocusChange(int i) {
            Logging.m87216d(AudioFocusManager.TAG, "onAudioFocusChange and focusChange: " + i);
            if (i == -3 || i == -2 || i == -1) {
    ...
    private boolean requestAudioFocusOnOreoOrHigher() {
        ...
        if (this.mFocusRequest == null) {
            this.mFocusRequest = ma1.m153628a(3).setAudioAttributes(audioAttributesBuild).setAcceptsDelayedFocusGain(true).setOnAudioFocusChangeListener(this.mAudioFocusChangeListenerImpl, this.mHandler).build();
        }
    ...
    public synchronized boolean abandonAudioFocus() {
        String str = TAG;
        Logging.m87216d(str, "abandonAudioFocus()");
        if (this.mAudioManager == null) {
            Logging.m87224w(str, "abandonAudioFocus failed as audioManager is null");
            return false;
        }
        ...
        Logging.m87216d(str, "abandonAudioFocus successful: " + zAbandonAudioFocusOnOreoOrHigher);
    ...
    public synchronized boolean requestAudioFocus() {
        String str = TAG;
        Logging.m87216d(str, "requestAudioFocus()");
        if (this.mAudioManager == null) {
            Logging.m87224w(str, "requestAudioFocus failed as audioManager is null");
            return false;
        }
        ...
        Logging.m87216d(str, "requestAudioFocus successful: " + zRequestAudioFocusOnOreoOrHigher);
