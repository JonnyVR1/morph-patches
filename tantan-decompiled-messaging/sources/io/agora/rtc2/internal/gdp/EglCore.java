...
public final class EglCore {
    ...
    public EglCore(EGLContext eGLContext, int i) {
        ...
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            qkq0.m175383a("EGL already set up");
            throw null;
        }
        ...
        if (eGLDisplayEglGetDisplay == EGL14.EGL_NO_DISPLAY) {
            qkq0.m175383a("unable to get EGL14 display");
            throw null;
        }
        int[] iArr = new int[2];
        if (!EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1)) {
            this.mEGLDisplay = null;
            qkq0.m175383a("unable to initialize EGL14");
            throw null;
        }
        ...
        if (this.mEGLContext == EGL14.EGL_NO_CONTEXT || mockNonEGLContext) {
            ...
            if (config2 == null) {
                qkq0.m175383a("Unable to find a suitable EGLConfig");
                throw null;
            }
        ...
        Logging.m87216d(TAG, "EGLContext created, client version " + iArr2[0]);
    }
    ...
    public EGLSurface createOffscreenSurface(int i, int i2) {
        ...
        jfd0.m141176a("surface was null");
        return null;
    }
    ...
    public EGLConfig getConfig(int i, int i2) {
        ...
        Logging.m87216d(TAG, "unable to find RGB8888 / " + i2 + " EGLConfig");
        return null;
    }

    public void makeCurrent(EGLSurface eGLSurface) {
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            Logging.m87216d(TAG, "NOTE: makeCurrent w/o display");
        }
        if (EGL14.eglMakeCurrent(this.mEGLDisplay, eGLSurface, eGLSurface, this.mEGLContext)) {
            return;
        }
        qkq0.m175383a("eglMakeCurrent failed");
    }
