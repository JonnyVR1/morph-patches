...
public class GDPAndroid {
    ...
    public static class BackGround implements Runnable {
        ...
        public boolean checkBackgroundSafe() {
            ...
            if (!ThreadUtils.awaitUninterruptibly(this.runDone, 100L)) {
                Logging.m87219e(GDPAndroid.TAG, "checkBackgroundSafe timeout");
            }
            return f63364bg;
        }
        ...
        public void run() {
            ...
            f63364bg = (i == 100 || i == 200) ? false : true;
    ...
    public static class BatteryLevel implements Runnable {
        ...
        public int getBatteryLevelSafe() {
            new Thread(this).start();
            if (!ThreadUtils.awaitUninterruptibly(this.runDone, 100L)) {
                Logging.m87219e(GDPAndroid.TAG, "getBatteryLevelSafe timeout");
            }
            return batt;
        }
    ...
    public static class CPUMaxFreqKHz implements Runnable {
        ...
        public int getCPUMaxFreqKHzSafe() {
            new Thread(this).start();
            if (!ThreadUtils.awaitUninterruptibly(this.runDone, 100L)) {
                Logging.m87219e(GDPAndroid.TAG, "getCPUMaxFreqKHzSafe timeout");
            }
            return freq;
        }
    ...
    public static class CPUTemperature implements Runnable {
        ...
        public int getCpuTemperatureSafe() {
            new Thread(this).start();
            if (!ThreadUtils.awaitUninterruptibly(this.runDone, 100L)) {
                Logging.m87219e(GDPAndroid.TAG, "getCpuTemperatureSafe timeout");
            }
        ...
        public void run() throws Throwable {
            ...
            for (int i = 0; i < GDPAndroid.CPU_TEMP_FILE_PATHS.size(); i++) {
                ...
                sb.append(str);
                Logging.m87216d(GDPAndroid.TAG, sb.toString());
            }
            this.runDone.countDown();
        }
    }
    ...
    public static class NumberOfCpuCores implements Runnable {
        ...
        public int getNumberOfCpuCoresSafe() {
            new Thread(this).start();
            if (!ThreadUtils.awaitUninterruptibly(this.runDone, 100L)) {
                Logging.m87219e(GDPAndroid.TAG, "getNumberOfCpuCoresSafe timeout");
            }
            return cores;
        }
    ...
    public static class TotalMemory implements Runnable {
        ...
        public int getTotalMemorySafe() {
            new Thread(this).start();
            if (!ThreadUtils.awaitUninterruptibly(this.runDone, 100L)) {
                Logging.m87219e(GDPAndroid.TAG, "getTotalMemorySafe timeout");
            }
            return mem;
        }
    ...
    public static int getCPUMaxFreqKHz() {
        ...
        Logging.m87216d(TAG, "max freq:" + unknowCPUMax);
        return unknowCPUMax;
    }
    ...
    public static int getNumberOfCPUCores() {
        ...
        Logging.m87216d(TAG, "cores:" + atomicInteger);
    ...
    public static long getTotalMemory(Context context) {
        ...
        Logging.m87216d(TAG, "total mem:" + memoryInfo.totalMem);
    ...
    */
    public static double readOneLine(java.io.File r6) throws java.lang.Throwable {
        ...
        L13:
            r0 = 0
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L6d java.lang.SecurityException -> L71 java.io.IOException -> L74 java.io.FileNotFoundException -> L78
            r3.<init>(r6)     // Catch: java.lang.Throwable -> L6d java.lang.SecurityException -> L71 java.io.IOException -> L74 java.io.FileNotFoundException -> L78
            java.io.InputStreamReader r6 = new java.io.InputStreamReader     // Catch: java.lang.Throwable -> L5a java.lang.SecurityException -> L60 java.io.IOException -> L63 java.io.FileNotFoundException -> L68
            r6.<init>(r3)     // Catch: java.lang.Throwable -> L5a java.lang.SecurityException -> L60 java.io.IOException -> L63 java.io.FileNotFoundException -> L68
            java.io.BufferedReader r4 = new java.io.BufferedReader     // Catch: java.lang.Throwable -> L48 java.lang.SecurityException -> L4d java.io.IOException -> L4f java.io.FileNotFoundException -> L54
            r4.<init>(r6)     // Catch: java.lang.Throwable -> L48 java.lang.SecurityException -> L4d java.io.IOException -> L4f java.io.FileNotFoundException -> L54
            java.lang.String r0 = r4.readLine()     // Catch: java.lang.Throwable -> L3c java.lang.SecurityException -> L3f java.io.IOException -> L42 java.io.FileNotFoundException -> L45
            double r1 = java.lang.Double.parseDouble(r0)     // Catch: java.lang.Throwable -> L3c java.lang.SecurityException -> L3f java.io.IOException -> L42 java.io.FileNotFoundException -> L45
    ...
    public String getCpuVendor() throws Throwable {
        ...
        try {
            try {
                ...
                try {
                    ...
                    e2 = e3;
                    Logging.m87220e(TAG, "getCpuName failed, no /proc/cpuinfo found in system", e2);
                    if (fileReader != null) {
                    }
                    ...
                    e = e4;
                    Logging.m87220e(TAG, "getCpuName failed,", e);
                    if (fileReader != null) {
                    }
                    return (getSocName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + str + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Build.HARDWARE).trim().toLowerCase();
                }
                ...
                if (reader2 != null) {
                    try {
                        ...
                        Logging.m87220e(TAG, "failed to close proc file", e5);
                    }
                }
                throw th;
            }
        ...
        try {
            ...
            Logging.m87220e(TAG, "failed to close proc file", e8);
        }
        return (getSocName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + str + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Build.HARDWARE).trim().toLowerCase();
    }
