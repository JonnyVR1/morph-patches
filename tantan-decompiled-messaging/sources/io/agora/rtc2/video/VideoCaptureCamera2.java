...
public class VideoCaptureCamera2 extends VideoCaptureCamera {
    ...
    public static class CameraIdListTask implements Runnable {
        ...
        public String[] getCameraIdList() {
            ...
            if (!ThreadUtils.awaitUninterruptibly(this.countDown, 2000L)) {
                Logging.m87209e(VideoCaptureCamera2.TAG, "checkBackgroundSafe timeout");
            }
            return cameraIdList;
        }
                    ...
                    try {
                        try {
                            try {
                                ...
                                Logging.m87209e(VideoCaptureCamera2.TAG, "getNumberOfCameras: getCameraIdList(): " + e.getMessage());
                            }
                        } catch (Exception e2) {
                            Logging.m87209e(VideoCaptureCamera2.TAG, "getNumberOfCameras: getCameraIdList(): " + e2.getMessage());
                        }
                    } catch (SecurityException e3) {
                        Logging.m87209e(VideoCaptureCamera2.TAG, "getNumberOfCameras: getCameraIdList(): " + e3.getMessage());
                    }
                } catch (AssertionError e4) {
                    Logging.m87209e(VideoCaptureCamera2.TAG, "getNumberOfCameras: getCameraIdList(): " + e4.getMessage());
                } catch (IllegalArgumentException e5) {
                    Logging.m87209e(VideoCaptureCamera2.TAG, "getSystemService(Context.CAMERA_SERVICE): " + e5.getMessage());
                }
            } finally {
            ...
            synchronized (VideoCaptureCamera2.this.mImageReaderLock) {
                ...
                try {
                    try {
                        try {
                            ...
                            if (imageAcquireLatestImage == null) {
                                ...
                                if (imageAcquireLatestImage != null) {
                                    try {
                                        ...
                                        Logging.m87209e(VideoCaptureCamera2.TAG, "Image Close():" + e.getMessage());
                                    } catch (IllegalStateException e2) {
                                        Logging.m87209e(VideoCaptureCamera2.TAG, "Image Close():" + e2.getMessage());
                                    }
                                }
                                return;
                            }
                            if (imageAcquireLatestImage.getFormat() != 35 || imageAcquireLatestImage.getPlanes().length != 3) {
                                Logging.m87209e(VideoCaptureCamera2.TAG, "Unexpected image format: " + imageAcquireLatestImage.getFormat() + " or #planes: " + imageAcquireLatestImage.getPlanes().length);
                                throw new IllegalStateException();
                            }
                            if (imageReader.getWidth() != imageAcquireLatestImage.getWidth() || imageReader.getHeight() != imageAcquireLatestImage.getHeight()) {
                                Logging.m87209e(VideoCaptureCamera2.TAG, "ImageReader size (" + imageReader.getWidth() + BaseSei.f13930X + imageReader.getHeight() + ") did not match Image size (" + imageAcquireLatestImage.getWidth() + BaseSei.f13930X + imageAcquireLatestImage.getHeight() + ")");
                                throw new IllegalStateException();
                            }
                            ...
                            try {
                                ...
                                Logging.m87209e(str2, sb2.toString());
                            ...
                            Logging.m87209e(VideoCaptureCamera2.TAG, "acquireLatestImage():" + e5.getMessage());
                            if (0 != 0) {
                                try {
                                    image.close();
                        ...
                        Logging.m87209e(VideoCaptureCamera2.TAG, "acquireLatestImage():" + e8.getMessage());
                        if (0 != 0) {
                            try {
                                image.close();
                    ...
                    try {
                        ...
                        Logging.m87209e(VideoCaptureCamera2.TAG, "Image Close():" + e11.getMessage());
                        throw th;
                    } catch (IllegalStateException e12) {
                        Logging.m87209e(VideoCaptureCamera2.TAG, "Image Close():" + e12.getMessage());
                        throw th;
                    }
                }
            }
    ...
    public class CrPreviewSessionListener extends CameraCaptureSession.StateCallback {
        ...
        public void onClosed(CameraCaptureSession cameraCaptureSession) {
            VideoCaptureCamera2.this.mThreadChecker.checkIsOnValidThread();
            Logging.m87211i(VideoCaptureCamera2.TAG, "CrPreviewSessionListener.onClosed");
        ...
        public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
            VideoCaptureCamera2.this.mThreadChecker.checkIsOnValidThread();
            Logging.m87211i(VideoCaptureCamera2.TAG, "CrPreviewSessionListener.onConfigureFailed");
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            int i3;
            VideoCaptureCamera2.this.mThreadChecker.checkIsOnValidThread();
            Logging.m87211i(VideoCaptureCamera2.TAG, "CrPreviewSessionListener.onConfigured");
            ...
            try {
                ...
                Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest: " + e.getMessage());
                VideoCaptureCamera2.this.onError(102, "Fail to setup capture session");
            } catch (IllegalArgumentException e2) {
                Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest: " + e2.getMessage());
                VideoCaptureCamera2.this.onError(102, "Fail to setup capture session");
            } catch (IllegalStateException e3) {
                Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest: " + e3.getMessage());
                VideoCaptureCamera2.this.onError(102, "Fail to setup capture session");
            } catch (NoClassDefFoundError e4) {
                Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest: " + e4.getMessage());
                VideoCaptureCamera2.this.onError(102, "Fail to setup capture session");
            } catch (SecurityException e5) {
                Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest: " + e5.getMessage());
                VideoCaptureCamera2.this.onError(102, "Fail to setup capture session");
            }
        }
    }
    ...
    public class CrStateListener extends CameraDevice.StateCallback {
        ...
        public void onClosed(CameraDevice cameraDevice) {
            Logging.m87211i(VideoCaptureCamera2.TAG, "cameraDevice closed");
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            VideoCaptureCamera2.this.mThreadChecker.checkIsOnValidThread();
            Logging.m87209e(VideoCaptureCamera2.TAG, "cameraDevice was closed unexpectedly");
            ...
            if (VideoCaptureCamera2.this.mCameraDevice != null) {
                try {
                    ...
                    Logging.m87211i(VideoCaptureCamera2.TAG, "CameraDevice close done!");
                } catch (IllegalStateException e) {
                    Logging.m87210e(VideoCaptureCamera2.TAG, "cameraDevice close error", e);
                }
                VideoCaptureCamera2.this.mCameraDevice = null;
            }
        ...
        public void onError(CameraDevice cameraDevice, int i) {
            VideoCaptureCamera2.this.mThreadChecker.checkIsOnValidThread();
            Logging.m87209e(VideoCaptureCamera2.TAG, "cameraDevice encountered an error, code: " + i);
            int i2 = 4;
            if (VideoCaptureCamera2.this.mCameraState == 4 || VideoCaptureCamera2.this.mCameraState == 3) {
                return;
            }
        ...
        public void onOpened(CameraDevice cameraDevice) {
            VideoCaptureCamera2.this.mThreadChecker.checkIsOnValidThread();
            Logging.m87211i(VideoCaptureCamera2.TAG, "CameraDevice.StateCallback onOpened");
            synchronized (VideoCaptureCamera2.this.mCameraStateLock) {
                if (VideoCaptureCamera2.this.mCameraState == 4) {
                    try {
                        Logging.m87213w(VideoCaptureCamera2.TAG, "cameraDevice state error,  should manual close!");
                        cameraDevice.close();
                    } catch (IllegalStateException e) {
                        Logging.m87210e(VideoCaptureCamera2.TAG, "cameraDevice close error", e);
                    }
    ...
    public class TextureVideoSinkListener implements SurfaceTextureHelper.IVideoCapture {
        ...
        public void onFrame(VideoFrame videoFrame) {
            ...
            if (buffer == null) {
                onFrameDropped(9);
                Logging.m87211i(VideoCaptureCamera2.TAG, "[HWS] TextureVideoSinkListener copy frame error");
                return;
            }
            VideoCaptureCamera2 videoCaptureCamera3 = VideoCaptureCamera2.this;
        ...
        this.mCaptureCallback = new CameraCaptureSession.CaptureCallback() { // from class: io.agora.rtc2.video.VideoCaptureCamera2.1
            ...
            private void notifyCameraFocusAreaChanged(Rect rect, Rect rect2) {
                ...
                if (rectFNormalizedToView == null) {
                    Logging.m87213w(VideoCaptureCamera2.TAG, "Failed to translate coordinate from normalized to view!!");
                    return;
                }
                Rect rect3 = new Rect();
            ...
            private void process(CaptureResult captureResult) {
                ...
                try {
                    ...
                    Logging.m87208d(VideoCaptureCamera2.TAG, "cropRegion = " + rect2);
                    Logging.m87208d(VideoCaptureCamera2.TAG, "capture size wxh = " + VideoCaptureCamera2.this.mCaptureFormat.getWidth() + " x " + VideoCaptureCamera2.this.mCaptureFormat.getHeight());
                    ...
                    Logging.m87209e(VideoCaptureCamera2.TAG, "capture: " + e);
                }
            }
            ...
            private void process(CaptureResult captureResult) {
                ...
                if (4 == num.intValue() || 5 == num.intValue()) {
                    ...
                    try {
                        ...
                        Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest failed, error message : " + e.getMessage());
                    } catch (IllegalArgumentException e2) {
                        Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest failed, error message : " + e2.getMessage());
                    } catch (IllegalStateException e3) {
                        Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest failed, error message : " + e3.getMessage());
                    } catch (NoClassDefFoundError e4) {
                        Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest failed, error message : " + e4.getMessage());
                    } catch (SecurityException e5) {
                        Logging.m87209e(VideoCaptureCamera2.TAG, "setRepeatingRequest failed, error message : " + e5.getMessage());
                    }
                }
            }
    ...
    public void changeCameraStateAndNotify(int i) {
        Logging.m87211i(TAG, "changeCameraStateAndNotify() " + i);
    ...
    private void configureCommonCaptureSettings(CaptureRequest.Builder builder) {
        ...
        if (cameraCharacteristics == null) {
            Logging.m87213w(TAG, "warning cameraCharacteristics is null");
            return;
        }
        ...
        if (i6 > 0) {
            ...
            Logging.m87208d(TAG, String.format(Locale.US, " Color temperature (%d ==> %d)", Integer.valueOf(this.mColorTemperature), Integer.valueOf(closestWhiteBalance)));
        ...
        if (iArr == null || iArr.length <= 0) {
            Logging.m87211i(TAG, "Camera " + this.mCameraId + " does not support white balance");
        } else {
            Logging.m87211i(TAG, "Camera " + this.mCameraId + " supports white balance, " + Arrays.toString(iArr));
        ...
        if (meteringRectangle != null) {
            ...
            Logging.m87211i(TAG, String.format(Locale.US, "Area of interest %s", meteringRectangle.toString()));
            builder.set(CaptureRequest.CONTROL_AF_REGIONS, meteringRectangleArr);
            builder.set(CaptureRequest.CONTROL_AE_REGIONS, meteringRectangleArr);
    ...
    private boolean createBufferPreviewObjectsAndStartPreview() {
        ...
        synchronized (this.mImageReaderLock) {
            ...
            try {
                ...
                Logging.m87210e(TAG, "setOnImageAvailableListener error", e);
            }
        }
    ...
    private int createCaptureRequest() {
        try {
            ...
            Logging.m87210e(TAG, "setRepeatingRequest: ", e);
            return -1;
        } catch (IllegalArgumentException e2) {
            Logging.m87210e(TAG, "setRepeatingRequest: ", e2);
            return -2;
        } catch (IllegalStateException e3) {
            Logging.m87209e(TAG, "capture:" + e3);
            return -4;
        } catch (NoClassDefFoundError unused) {
            return -1;
        } catch (SecurityException e4) {
            Logging.m87210e(TAG, "setRepeatingRequest: ", e4);
            return -3;
        }
    }
    ...
    private boolean createPreviewObjectsAndStartPreview(Surface surface) {
        ...
        try {
            ...
            int i5 = i4 == 0 ? 1 : 3;
            String str = TAG;
            Logging.m87211i(str, "createCaptureRequest templateType: ".concat(i4 == 0 ? "preview" : "record"));
            ...
            if (builderCreateCaptureRequest == null) {
                Logging.m87209e(str, "mPreviewRequestBuilder error");
                return false;
            }
            ...
            if (this.mCameraExtraSurface) {
                synchronized (this.mImageReaderLock) {
                    ...
                    Logging.m87209e(str, "createCaptureSession add extra surface.");
                }
            } else {
            ...
            try {
                ...
                Logging.m87209e(TAG, "createCaptureSession: " + e.getMessage());
                return false;
            } catch (IllegalArgumentException e2) {
                Logging.m87209e(TAG, "createCaptureSession: " + e2.getMessage());
                return false;
            } catch (NoClassDefFoundError e3) {
                Logging.m87209e(TAG, "createCaptureSession: " + e3.getMessage());
                return false;
            } catch (SecurityException e4) {
                Logging.m87209e(TAG, "createCaptureSession: " + e4.getMessage());
                return false;
            }
        } catch (CameraAccessException e5) {
            Logging.m87209e(TAG, "createCaptureRequest: " + e5.getMessage());
            return false;
        } catch (IllegalArgumentException e6) {
            Logging.m87209e(TAG, "createCaptureRequest: " + e6.getMessage());
            return false;
        } catch (SecurityException e7) {
            Logging.m87209e(TAG, "createCaptureRequest: " + e7.getMessage());
            return false;
        }
    }
    ...
    private boolean createTexturePreviewObjectsAndStartPreview() {
        ...
        if (this.mCameraDevice != null && (iSurfaceTextureHelper = this.mSurfaceTextureHelper) != null) {
            try {
                ...
                Logging.m87210e(TAG, "setTextureSize:", e);
            }
        }
        return false;
    }
    ...
    public static boolean getCamera2SupportedAutoFocus(int i) {
        ...
        for (int i2 : iArr) {
            Logging.m87211i(TAG, "Auto-focus mode: " + i2);
        }
        boolean z = isSupported(3, iArr) || isSupported(4, iArr);
        if (!z) {
            Logging.m87211i(TAG, "Auto-focus is not available.");
        }
        return z;
    }
    ...
    public static int getCamera2SupportedFaceDetect(int i) {
        ...
        Logging.m87211i(TAG, "faceDetectSupported: " + z + " ,faceDetectMode: " + i2);
        return i2;
    }
    ...
    public static int getCamera2SupportedLevel(int i) {
        ...
        Logging.m87213w(TAG, "get camera hardware level fail!");
        return 2;
    }
    ...
    public static boolean getCamera2SupportedNoise(int i) {
        ...
        String str = TAG;
        Logging.m87211i(str, "noise_reduction_mode_high_quality supported: " + isSupported(2, iArr));
        boolean zIsSupported = isSupported(1, iArr);
        Logging.m87211i(str, "noise_reduction_mode_fast supported: " + zIsSupported);
        return zIsSupported;
    }
    ...
    private static CameraCharacteristics getCameraCharacteristics(int i) {
        ...
        try {
            ...
            if (i >= cameraIdList.length) {
                Logging.m87211i(TAG, "physical camera Index: " + i);
            }
            ...
            Logging.m87209e(TAG, "getCameraCharacteristics: " + e.getMessage());
            return null;
        } catch (AssertionError e2) {
            Logging.m87209e(TAG, "getCameraCharacteristics: " + e2.getMessage());
            return null;
        } catch (IllegalArgumentException e3) {
            Logging.m87209e(TAG, "getCameraCharacteristics: " + e3.getMessage());
            return null;
        } catch (Exception e4) {
            Logging.m87209e(TAG, "getNumberOfCameras: got exception: " + e4);
            return null;
        }
    }
    ...
    public static String getDeviceId(int i) {
        try {
            ...
            if (i >= cameraIdList.length) {
                Logging.m87209e(TAG, "Invalid camera index: " + i);
            }
            return cameraIdList[i];
        } catch (CameraAccessException e) {
            Logging.m87209e(TAG, "manager.getCameraIdList: " + e);
            return null;
        } catch (Exception e2) {
            Logging.m87209e(TAG, "manager.getCameraIdList: " + e2);
            return null;
        }
    }
    ...
    private static boolean getFocalLengthInfo(CameraCharacteristics cameraCharacteristics, String str, int i, FocalLengthInfo[] focalLengthInfoArr) {
        ...
        if (focalLengthInfoArr[i3] == null) {
            Logging.m87208d(TAG, "getFocalLengthInfo cameraDirection " + ((int) r0) + " index: " + i3 + " id: " + str + " focalLengthType: 0 front: " + ((boolean) r0));
        ...
        if (fArr != null && fArr.length != 0) {
            ...
            sb.append("mm");
            Logging.m87208d(str2, sb.toString());
            if (fMin >= 2.4f && fMin < 3.5f) {
                int i4 = i2 + (r0 == 0 ? 3 : 0) + 1;
                Logging.m87208d(str2, "getFocalLengthInfo cameraDirection " + ((int) r0) + " index: " + i4 + " id: " + str + " focalLengthType: 1 front: " + ((boolean) r0));
                focalLengthInfoArr[i4] = new FocalLengthInfo(r0, i4, Integer.parseInt(str), 1);
                return true;
            }
            if (fMin < 2.4f && fMin > 0.1d) {
                int i5 = i2 + (r0 == 0 ? 3 : 0) + 2;
                Logging.m87208d(str2, "getFocalLengthInfo cameraDirection " + ((int) r0) + " index: " + i5 + " id: " + str + " focalLengthType: 2 front: " + ((boolean) r0));
    ...
    private static List<VideoCaptureFormat> getFormatsFromParemeters(@NonNull CameraCharacteristics cameraCharacteristics, int i) {
        ...
        try {
            ...
            Logging.m87210e(TAG, "Unable to catch device supported video formats: ", e);
            return arrayList;
        }
    }
    ...
    private static float getMaxZoom(CameraCharacteristics cameraCharacteristics) {
        ...
        Logging.m87213w(TAG, "warning get max zoom return null");
        return DEFAULT_VALUE;
    }
    ...
    public static String getName(int i) {
        ...
        CameraCharacteristics cameraCharacteristics = getCameraCharacteristics(indexConvertCameraId(i));
        if (cameraCharacteristics == null) {
            Logging.m87209e(TAG, "getName: " + i + " , failed to getCameraCharacteristics.");
            return null;
        }
        int iIntValue = ((Integer) cameraCharacteristics.get(CameraCharacteristics.LENS_FACING)).intValue();
        if (iIntValue != 0) {
            ...
            if (iIntValue != 1) {
                if (iIntValue != 2) {
                    Logging.m87209e(TAG, "Invalid camera facing value, and fallback to back: " + iIntValue);
                } else {
                    str = "extra";
                }
            }
    ...
    private static String indexConvertCameraId(int i) {
        try {
            String[] cameraIdList = ((CameraManager) ContextUtils.getApplicationContext().getSystemService("camera")).getCameraIdList();
            if (i >= cameraIdList.length) {
                Logging.m87208d(TAG, "physical camera Index: " + i);
            }
            return cameraIdList[i];
        } catch (CameraAccessException e) {
            Logging.m87209e(TAG, "getCameraCharacteristics: " + e.getMessage());
            ...
            Logging.m87209e(TAG, "getCameraCharacteristics: " + e4.getMessage());
            return null;
        }
    }
    ...
    private boolean isSupportedFocusMode(CameraCharacteristics cameraCharacteristics, int i) {
        ...
        for (int i2 : iArr) {
            Logging.m87211i(TAG, "availableFocusModes: " + i2);
            if (i2 == i) {
                return true;
            }
        }
    ...
    public boolean physicalFallback(CameraManager cameraManager, CrStateListener crStateListener) {
        try {
            ...
            String str = TAG;
            Logging.m87208d(str, "allocate physical camera failure, try logical camera.");
            String[] cameraIdList = cameraManager.getCameraIdList();
            if (this.mId >= cameraIdList.length) {
                Logging.m87209e(str, "Invalid camera Id: " + this.mId);
                return false;
            }
            Logging.m87208d(str, "allocate open logicalCamera: " + this.mId + " camera name:" + cameraIdList[this.mId]);
            ...
            Logging.m87209e(TAG, "allocate: manager.openCamera: " + e.getMessage());
            return false;
        } catch (IllegalArgumentException e2) {
            Logging.m87209e(TAG, "allocate: manager.openCamera: " + e2.getMessage());
            return false;
        } catch (SecurityException e3) {
            Logging.m87209e(TAG, "allocate: manager.openCamera: " + e3.getMessage());
            return false;
        }
    }
    ...
    public static List<FocalLengthInfo> queryCameraFocalLengthCapability(boolean z) {
        ...
        try {
            ...
            if (z) {
                Logging.m87213w(TAG, "Skip find physical camera focalLength capability.");
            ...
            if (zQueryPhysicalFocalLengths) {
                Logging.m87208d(TAG, "Physical Camera, FocalLengths available.");
            } else {
                Logging.m87213w(TAG, "Physical Camera, FocalLengths empty!");
            }
            if ((cameraCharacteristics2 == null || !queryZoomFocalLengths(cameraCharacteristics2, "1", focalLengthInfoArr)) ? cameraCharacteristics != null && queryZoomFocalLengths(cameraCharacteristics, "0", focalLengthInfoArr) : true) {
                Logging.m87208d(TAG, "Supports scaling of less than 1.0 magnification, FocalLengths available.");
            } else {
                Logging.m87213w(TAG, "Scaling less than 1.0 magnification is not supported.");
            }
            ArrayList arrayList = new ArrayList();
            for (int i = 0; i < 18; i++) {
    ...
    private static boolean queryPhysicalFocalLengths(CameraManager cameraManager, CameraCharacteristics cameraCharacteristics, String[] strArr, FocalLengthInfo[] focalLengthInfoArr) {
        ...
        if (strArr != null && strArr.length != 0 && cameraCharacteristics != null) {
            ...
            Logging.m87208d(TAG, "physicalCamera Available: " + z);
            if (!z) {
                return false;
            }
    ...
    public static boolean queryZoomFocalLengths(CameraCharacteristics cameraCharacteristics, String str, FocalLengthInfo[] focalLengthInfoArr) {
        ...
        if (focalLengthInfoArr[i] == null) {
            Logging.m87208d(TAG, "Zoom FocalLengthInfo cameraDirection " + ((int) r2) + " index: " + i + " id: " + str + " focalLengthType: 0 front: " + ((boolean) r2));
        ...
        if (!getFocalLengthInfo(cameraCharacteristics, str, 3, focalLengthInfoArr)) {
            int i2 = (r2 == 0 ? 3 : 0) + 13;
            Logging.m87208d(TAG, "Zoom FocalLengthInfo cameraDirection " + ((int) r2) + " index: " + i2 + " id: " + str + " focalLengthType: 1 front: " + ((boolean) r2));
        ...
        synchronized (this.mSwitchLock) {
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null) {
                    if (builder == null) {
                        Logging.m87209e(TAG, "face detect requestBuilder error");
                        return;
                    }
                    if (!this.mFaceDetectSupported) {
                        Logging.m87213w(TAG, "face detect not supported");
                        return;
                    }
                    if (this.mEnableAutoFaceFocus || this.mEnableFaceDetection) {
                        if (i == 0 || this.mIsFaceDetectionStarted) {
                            if (i == 0) {
                                ...
                                Logging.m87211i(TAG, "requestFaceDetection = 0");
                        ...
                        Logging.m87211i(TAG, "requestFaceDetection = " + i);
                        builder.set(CaptureRequest.STATISTICS_FACE_DETECT_MODE, Integer.valueOf(i));
                        return;
                    }
                    return;
                }
                Logging.m87213w(TAG, "face detect not ready");
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public boolean allocate(@NonNull VideoCaptureFormat videoCaptureFormat) {
        float fMin;
        String str = TAG;
        Logging.m87211i(str, String.format(Locale.US, "allocate: requested (%d x %d) @%dfps", Integer.valueOf(videoCaptureFormat.getWidth()), Integer.valueOf(videoCaptureFormat.getHeight()), Integer.valueOf(videoCaptureFormat.getFramerate())));
        synchronized (this.mCameraStateLock) {
            ...
            if (i != 0 && i != 1) {
                ...
                if (cameraCharacteristics == null) {
                    Logging.m87209e(str, "failed to getCameraCharacteristics.");
                    return false;
                }
                List<VideoCaptureFormat> formatsFromParemeters = getFormatsFromParemeters(cameraCharacteristics, IMAGE_FORMAT);
                Logging.m87211i(str, "format list: " + Arrays.toString(formatsFromParemeters.toArray()));
                ...
                if (videoCaptureFormatFindBestMatchedCapability == null) {
                    Logging.m87209e(str, "failed to match capability");
                    return false;
                }
                ...
                Logging.m87211i(str, "fpsRanges: " + Arrays.toString(listAsList.toArray()));
                if (listAsList.isEmpty()) {
                    Logging.m87209e(str, "No supported framerate ranges.");
                    return false;
                }
                ...
                if (framerateRangeFindBestFrameRateRange == null) {
                    Logging.m87209e(TAG, "No matched framerate ranges.");
                    return false;
                }
                float[] fArr = (float[]) cameraCharacteristics.get(CameraCharacteristics.LENS_INFO_AVAILABLE_FOCAL_LENGTHS);
                if (fArr == null || fArr.length <= 0) {
                ...
                Logging.m87211i(TAG, String.format(Locale.US, "allocate: matched (%d x %d) @[%d - %d], %dmm", Integer.valueOf(this.mCaptureFormat.mWidth), Integer.valueOf(this.mCaptureFormat.mHeight), this.mAeFpsRange.getLower(), this.mAeFpsRange.getUpper(), Integer.valueOf((int) (fMin * 10.0f))));
                ...
                Logging.m87211i(TAG, "allocate() face detection: " + this.mFaceDetectMode + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + num + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.mFaceDetectSupported);
                return true;
            }
            Logging.m87209e(str, "allocate() invoked while Camera is busy opening/configuring.");
            return false;
        }
    }
    ...
    public void deallocate() {
        Logging.m87211i(TAG, "deallocate()");
    }
    ...
    public boolean isCameraExposureSupported() {
        ...
        if (range != null && rational != null) {
            ...
            Logging.m87211i(TAG, "isCameraExposureSupported compensation min: " + iIntValue2 + " max: " + iIntValue);
    ...
    public boolean isExposureSupported() {
        ...
        if (iArr != null) {
            for (int i = 0; i < iArr.length; i++) {
                Logging.m87211i(TAG, "isExposureSupported AE mode = " + iArr[i]);
                if (1 == i) {
                    return true;
                }
            }
    ...
    public boolean isFaceDetectSupported() {
        ...
        Logging.m87211i(TAG, "face dedect, numDetectedFaces: " + iIntValue);
        return iIntValue > 0;
    }
    ...
    public void onCameraAvailable(String str) {
        String str2 = TAG;
        Logging.m87211i(str2, "onCameraAvailable " + str + " mCameraId: " + this.mCameraId);
        if (str.equals(this.mCameraId)) {
            synchronized (this.mCameraStateLock) {
                try {
                    ...
                    Logging.m87211i(str2, "onCameraAvailable, Wrong state " + this.mCameraState);
                } catch (Throwable th) {
                    throw th;
                }
            }
        ...
        if (str.equals(this.mCameraId)) {
            synchronized (this.mCameraStateLock) {
                try {
                    ...
                    Logging.m87211i(TAG, "onCameraUnavailable, Wrong state " + this.mCameraState);
                } catch (Throwable th) {
                    throw th;
                }
            }
                        ...
                        for (int i2 : iArr) {
                            if (i2 == i) {
                                if (this.mPreviewSession != null) {
                                    ...
                                    try {
                                        Logging.m87211i(TAG, "setAntiBandingMode = " + i);
                                ...
                                Logging.m87211i(TAG, "AgoraVideo set anti-banding = " + i);
                                return -1;
                            }
                        }
                    }
                    Logging.m87209e(TAG, "not supported anti-banding = " + i);
                    return -1;
                }
                this.mCameraAntiBandingMode = i;
                return 0;
        ...
        synchronized (this.mSwitchLock) {
            try {
                if (this.mEnableAutoFaceFocus == z) {
                    Logging.m87213w(TAG, "face detect no change");
                    return 0;
                }
                ...
                if (this.mPreviewSession != null && this.mCameraThreadHandler != null && (builder = this.mPreviewRequestBuilder) != null) {
                    if (z) {
                        ...
                        if (this.mEnableFaceDetection) {
                            Logging.m87213w(TAG, "face detect did not turn off due to faceDistance on");
                            return 0;
                        }
                        this.mIsFaceDetectionStarted = false;
            ...
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null) {
                    ...
                    if (isSupported(i, (int[]) cameraCharacteristics.get(CameraCharacteristics.EDGE_AVAILABLE_EDGE_MODES)) && this.mPreviewSession != null) {
                        ...
                        try {
                            Logging.m87211i(TAG, "setEdgeEnhanceMode = " + i);
                    ...
                    Logging.m87209e(TAG, "not supported EdgeEnhance Mode = " + i);
                    return -1;
                }
                this.mCamerEdgeEnhanceMode = i;
                return 0;
        ...
        synchronized (this.mSwitchLock) {
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null && this.mRenderView.getWidth() != 0 && this.mRenderView.getHeight() != 0) {
                    ...
                    fArr[1] = f2;
                    String str = TAG;
                    Logging.m87211i(str, "setExposure called camera api2 " + f + BaseSei.f13930X + f2);
                    if (f < 0.0f || f > this.mRenderView.getWidth() || f2 < 0.0f || f2 > this.mRenderView.getHeight()) {
                        Logging.m87209e(str, "set exposure unreasonable inputs");
                        return -1;
                    }
                    ...
                    if (rectFViewToNormalized == null) {
                        Logging.m87211i(str, "setExposure coordinate " + f + " - " + f2 + " out of image bounds!!");
                        return -1;
                    }
            ...
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null) {
                    ...
                    if (range != null && rational != null) {
                        int iIntValue = ((Integer) range.getUpper()).intValue();
                        int iIntValue2 = ((Integer) range.getLower()).intValue();
                        Logging.m87211i(str, "compensation step=" + rational + ", min=" + iIntValue2 + ", max=" + iIntValue);
                        if (i > iIntValue) {
                            i = iIntValue;
                        }
                        if (i >= iIntValue2) {
                ...
                if (this.mPreviewSession != null && this.mCameraThreadHandler != null && (builder = this.mPreviewRequestBuilder) != null) {
                    if (z) {
                        ...
                        if (this.mEnableAutoFaceFocus) {
                            Logging.m87213w(TAG, "face detect did not turn off due to autoFocus on");
                            return 0;
                        }
                        this.mIsFaceDetectionStarted = false;
                        builder.set(CaptureRequest.STATISTICS_FACE_DETECT_MODE, 0);
        ...
        synchronized (this.mSwitchLock) {
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null && this.mRenderView.getWidth() != 0 && this.mRenderView.getHeight() != 0) {
                    ...
                    RectF rectFViewToNormalized = CoordinatesTransform.viewToNormalized(rectF, width, height, i, i2, i3 == 1, (i3 == 1 ? 1 : -1) * getCameraRotation(), this.mRenderMode);
                    if (rectFViewToNormalized == null) {
                        Logging.m87211i(str, "setFocus coordinate " + f + " - " + f2 + " out of image bounds!!");
                        return -1;
                    }
                    float f3 = rectFViewToNormalized.left;
                    float f4 = rectFViewToNormalized.top;
            ...
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null) {
                    ...
                    if (isSupported(i, iArr)) {
                        if (this.mPreviewSession != null) {
                            try {
                                Logging.m87211i(TAG, "setNoiseReductionMode = " + i);
                        ...
                        try {
                            ...
                            Logging.m87211i(TAG, "setNoiseReductionMode = " + i + " ,by fallback.");
                            this.mIsNoiseReducationStarted = true;
        ...
        synchronized (this.mSwitchLock) {
            ...
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null) {
                    ...
                    this.mTorchMode = i;
                    String str = TAG;
                    Logging.m87211i(str, "setTorchMode called camera api2, isOn: " + z);
                    CameraCharacteristics cameraCharacteristics = getCameraCharacteristics(this.mId);
                    if (cameraCharacteristics == null) {
                        Logging.m87213w(str, "warning cameraCharacteristics is null");
                        return -1;
                    }
                    Boolean bool = (Boolean) cameraCharacteristics.get(CameraCharacteristics.FLASH_INFO_AVAILABLE);
                    boolean zBooleanValue = bool == null ? false : bool.booleanValue();
                    Logging.m87213w(str, "setTorchMode isFlashSupported: ".concat(zBooleanValue ? "true" : "false"));
                    if (zBooleanValue) {
                        CaptureRequest.Builder builder = this.mPreviewRequestBuilder;
                        if (z) {
                            builder.set(CaptureRequest.FLASH_MODE, 2);
                        ...
                        Logging.m87213w(str, "flash is not supported");
                    }
                    return -1;
                }
                this.mTorchMode = i;
    ...
    public int setVideoEdgeMode(int i) {
        if (this.mPreviewRequestBuilder == null) {
            Logging.m87211i(TAG, "setVideoEdgeMode mPreviewRequestBuilder return.");
            return -1;
        }
        CameraCharacteristics cameraCharacteristics = getCameraCharacteristics(this.mId);
        if (cameraCharacteristics == null) {
        ...
        if (isSupported(toCamera2EdgeEnhanceMode(i), (int[]) cameraCharacteristics.get(CameraCharacteristics.EDGE_AVAILABLE_EDGE_MODES)) && this.mPreviewSession != null) {
            try {
                Logging.m87211i(TAG, "setVideoEdgeMode = " + i);
                this.mPreviewRequestBuilder.set(CaptureRequest.EDGE_MODE, Integer.valueOf(i));
                this.mPreviewSession.setRepeatingRequest(this.mPreviewRequestBuilder.build(), this.mCaptureCallback, this.mCameraThreadHandler);
                return 0;
            } catch (CameraAccessException e) {
        ...
        Logging.m87209e(TAG, "not supported VideoEdge Mode = " + i);
        return -1;
    }
        ...
        synchronized (this.mSwitchLock) {
            try {
                if (this.mPreviewSession != null && (builder = this.mPreviewRequestBuilder) != null) {
                    ...
                    if (builder == null) {
                        Logging.m87211i(TAG, "setVideoStabilityMode mPreviewRequestBuilder return.");
                        return -1;
                    }
                    ...
                    if (isSupportedStability(camera2VideoStabilityMode, (int[]) cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) && this.mPreviewSession != null) {
                        try {
                            Logging.m87211i(TAG, "setVideoStabilityMode = " + i);
                    ...
                    Logging.m87209e(TAG, "not supported VideoStability Mode = " + i);
                    return -1;
                }
                this.mCameraVideoStabilityMode = i;
                return 0;
        ...
        synchronized (this.mSwitchLock) {
            try {
                if (this.mPreviewSession != null && this.mPreviewRequestBuilder != null) {
                    ...
                    String str = TAG;
                    Logging.m87211i(str, "setCameraZoom api2 called zoomValue =" + f);
                    if (f <= 0.0f) {
                        return -1;
                    }
                    ...
                    if (Math.abs(this.mMaxZoom - 0.5f) < 0.001f) {
                        Logging.m87209e(str, "Camera " + this.mId + " does not support camera zoom");
                        return -1;
                    }
                    if (f < 0.5f || f > this.mMaxZoom || f == this.mLastZoomRatio) {
                        Logging.m87209e(str, "needZoom! ");
                        return -2;
                    }
                    ...
                    Logging.m87211i(str, "setCameraZoom api2 called success!");
                    return 0;
                }
                this.mCameraZoomFactor = f;
                return 0;
                ...
                public Boolean call() throws Exception {
                    try {
                        ...
                        if (VideoCaptureCamera2.this.mPhysicalId != null) {
                            Logging.m87211i(VideoCaptureCamera2.TAG, "allocate openCamera camera name:" + VideoCaptureCamera2.this.mPhysicalId);
                            ...
                            if (VideoCaptureCamera2.this.mId >= cameraIdList.length) {
                                Logging.m87209e(VideoCaptureCamera2.TAG, "Invalid camera Id: " + VideoCaptureCamera2.this.mId);
                                return Boolean.FALSE;
                            }
                            Logging.m87211i(VideoCaptureCamera2.TAG, "allocate openCamera: " + VideoCaptureCamera2.this.mId + " camera name:" + cameraIdList[VideoCaptureCamera2.this.mId]);
                        ...
                        Logging.m87209e(VideoCaptureCamera2.TAG, "allocate: manager.openCamera: " + e.getMessage());
                        if (VideoCaptureCamera2.this.mPhysicalId == null) {
                            return Boolean.FALSE;
                        }
                        ...
                        Logging.m87209e(VideoCaptureCamera2.TAG, "allocate: manager.openCamera: " + e2.getMessage());
                        if (VideoCaptureCamera2.this.mPhysicalId == null) {
                            return Boolean.FALSE;
                        }
                        if (!VideoCaptureCamera2.this.physicalFallback(cameraManager, crStateListener)) {
                        ...
                        Logging.m87209e(VideoCaptureCamera2.TAG, "allocate: manager.openCamera: " + e3.getMessage());
                        if (VideoCaptureCamera2.this.mPhysicalId == null) {
                            return Boolean.FALSE;
                        }
                        if (!VideoCaptureCamera2.this.physicalFallback(cameraManager, crStateListener)) {
    ...
    public void stopCaptureAndBlockUntilStopped() {
        ...
        try {
                    ...
                    synchronized (VideoCaptureCamera2.this.mCameraStateLock) {
                        while (VideoCaptureCamera2.this.mCameraState != 2 && VideoCaptureCamera2.this.mCameraState != 4 && VideoCaptureCamera2.this.mCameraState != 3) {
                            try {
                                ...
                                Logging.m87209e(VideoCaptureCamera2.TAG, "CaptureStartedEvent: " + e.getMessage());
                            }
                        }
                        ...
                        if (VideoCaptureCamera2.this.mCameraState != 4 && VideoCaptureCamera2.this.mCameraState != 3) {
                            try {
                                ...
                                Logging.m87211i(VideoCaptureCamera2.TAG, "releaseCamera done!");
                                ...
                                Logging.m87210e(VideoCaptureCamera2.TAG, "cameraDevice close error", e2);
                            } finally {
            ...
            Logging.m87209e(TAG, "stopCaptureAndBlockUntilStopped fail: " + e.getMessage());
        }
        synchronized (this.mImageReaderLock) {
            ...
            if (imageReader2 != null) {
                try {
                    try {
                        ...
                        Logging.m87209e(TAG, "ImageReader Close():" + e2.getMessage());
                    }
                } catch (IllegalStateException e3) {
                    Logging.m87209e(TAG, "ImageReader Close():" + e3.getMessage());
                }
                ...
                if (imageReader != null) {
                    try {
                        try {
                            ...
                            Logging.m87209e(TAG, "ImageReader Close():" + e4.getMessage());
                        }
                    } catch (IllegalArgumentException e5) {
                        Logging.m87209e(TAG, "ImageReader Close():" + e5.getMessage());
                    }
        ...
        if (this.mSurfaceTextureHelper != null) {
            Logging.m87208d(TAG, "waiting camera device close failed after 2000ms");
        ...
        this.mPerFrameFaceDetectionInfoQueue.clear();
        Logging.m87211i(TAG, "stopCaptureAndBlockUntilStopped done.");
    }
    ...
    private static CameraCharacteristics getCameraCharacteristics(String str) {
        ...
        try {
            ...
            Logging.m87211i(TAG, "physical cameraId: " + str);
            return cameraManager.getCameraCharacteristics(str);
        } catch (CameraAccessException e) {
            Logging.m87209e(TAG, "getCameraCharacteristics: " + e.getMessage());
            return null;
