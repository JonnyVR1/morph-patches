...
public class VLinear_TwoChildBottomMeasureFirst extends LinearLayout {
    ...
    /* JADX INFO: renamed from: a */
    public final boolean m223072a() {
        return this.f209145a;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        getChildAt(0).measure(ffx.m121198a(paddingLeft), ffx.m121198a(paddingTop - measuredHeight));
        if (getLayoutParams().height == -1) {
            measuredHeight = paddingTop - getChildAt(0).getMeasuredHeight();
        }
        if (getChildAt(1).getLayoutParams().width == -1) {
            getChildAt(1).measure(ffx.m121199b(paddingLeft), ffx.m121199b(measuredHeight));
        } else {
            getChildAt(1).measure(ffx.m121198a(paddingLeft), ffx.m121199b(measuredHeight));
        }
