...
public class ayi0 extends C2124a {
    ...
    public String m8624A0() {
        String string = this.f2841e.getString(R$string.f383K0);
        if (this.f2854r) {
            return this.f2841e.getString(R$string.f504d4);
        }
        return (this.f5872E == null || !this.f5872E.m12458n0()) ? string : this.f2841e.getString(R$string.f544j2);
    }
    ...
    public void mo4964o0(CommonEmptyView commonEmptyView) {
        ...
        commonEmptyView.f2282b.setText(m8624A0());
