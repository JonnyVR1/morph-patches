...
public final class cri {
    ...
    public static /* synthetic */ void m9226b(cri criVar, Activity activity, int i, Object obj) {
        if ((i & 1) != 0) {
            activity = null;
        }
        criVar.m9229a(activity);
    }
    ...
    public static final vrl m9227c(@NotNull String tag) {
        tag.getClass();
        return fxs.get(tag);
    }
    ...
    public static final vrl m9228f(@NotNull yaj helper) {
        xaj xajVar;
        helper.getClass();
        if (context == null) {
            jfd0.a("context == null, please call AppHelper.setContext(context) to set context");
            return null;
        }
        ...
        if (helper.enableFx) {
            m9226b(INSTANCE, null, 1, null);
        }
        return xajVar2;
    }

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ void m9229a(Activity activity) {
        if (fxLifecycleCallback != null) {
            return;
        }
        ebj.INSTANCE.m9700d(activity);
        ebj ebjVar = new ebj();
    ...
    public final Application m9230d() {
        return context;
    }

    /* JADX INFO: renamed from: e */
    public final /* synthetic */ Map m9231e() {
        return fxs;
    }

    /* JADX INFO: renamed from: g */
    public final void m9232g() {
        if (fxLifecycleCallback == null && ebj.INSTANCE.m9697a() == null) {
            return;
        }
        Application application = context;
        if (application != null) {
    ...
    public final void m9233h(@Nullable Application application) {
        context = application;
    }

    /* JADX INFO: renamed from: i */
    public final /* synthetic */ void m9234i(String tag, xaj control) {
        tag.getClass();
        control.getClass();
