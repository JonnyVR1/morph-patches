...
import com.p000p1.mobile.putong.feed.data.Extra;
...
public class rs9 extends omg {
    ...
    @JvmField
    @NotNull
    public tpd0 lastDetectedMediaCount = new tpd0("last_detected_media_count_" + FeedModule.m1139F().userId(), 0);
    ...
    @JvmField
    public b<xaj0<Integer, Boolean, List<String>>> unreadRedPoint = b.b();

    /* JADX INFO: renamed from: K, reason: from kotlin metadata */
    @JvmField
    public b<j760<Boolean, Boolean>> refreshIconObs = b.b();

    /* JADX INFO: renamed from: L, reason: from kotlin metadata */
    @JvmField
    public b<String> currentPageId = b.b();

    /* JADX INFO: renamed from: M, reason: from kotlin metadata */
    @JvmField
    public b<Extra> followConfigSub = b.b();

    /* JADX INFO: renamed from: O, reason: from kotlin metadata */
    @JvmField
    public b<roj0> closePostBasePopWindowSub = b.b();

    /* JADX INFO: renamed from: A0 */
    public final void m13955A0(@NotNull Moment moment) {
        moment.getClass();
        m13956B0(Moments.TYPE, buw.m9033a(moment, Moment.JSON_ADAPTER), ((DbObject) moment).id);
    }

    /* JADX INFO: renamed from: B0 */
    public final void m13956B0(@Nullable String category, @Nullable Object data, @Nullable String key) {
    ...
    public final void m13957C0(@NotNull String topicId, @NotNull String voteId) {
        topicId.getClass();
        voteId.getClass();
        ...
        TopicMoment topicMoment = (TopicMoment) m13960v0("momentTopics", topicId, jsonAdapter);
        if ((topicMoment != null ? topicMoment.options : null) != null) {
            ...
            for (VoteOptions voteOptions : list2) {
                if (TextUtils.equals(voteOptions.f714id, voteId)) {
                    voteOptions.haveliked = true;
                    voteOptions.counter++;
                }
            }
            m13956B0("momentTopics", buw.m9033a(topicMoment, TopicMoment.JSON_ADAPTER), topicId);
        }
    }

    /* JADX INFO: renamed from: t0 */
    public final boolean m13958t0(@Nullable String category, @Nullable String key) {
    ...
    public final <T> HashMap<String, T> m13959u0(@Nullable String category) {
    ...
    public final <T> T m13960v0(@Nullable String category, @Nullable String key, @NotNull JsonAdapter<T> adapter) {
        HashMap<String, Object> map;
        Object obj;
        adapter.getClass();
        ...
        return (T) buw.m9034b((Map) obj, adapter);
    }

    @Nullable
    /* JADX INFO: renamed from: w0 */
    public final RawFeed m13961w0(@Nullable String feedId) {
        if (TextUtils.isEmpty(feedId)) {
            return null;
        }
        JsonAdapter<RawFeed> jsonAdapter = RawFeed.JSON_ADAPTER;
        jsonAdapter.getClass();
        return (RawFeed) m13960v0("feeds", feedId, jsonAdapter);
    }

    @Nullable
    /* JADX INFO: renamed from: x0 */
    public final Moment m13962x0(@Nullable String momentId) {
        if (TextUtils.isEmpty(momentId)) {
            return null;
        }
        JsonAdapter<Moment> jsonAdapter = Moment.JSON_ADAPTER;
        jsonAdapter.getClass();
        return (Moment) m13960v0(Moments.TYPE, momentId, jsonAdapter);
    }

    @Nullable
    /* JADX INFO: renamed from: y0 */
    public final Relationship m13963y0(@Nullable String uid) {
        if (TextUtils.isEmpty(uid)) {
            return null;
        }
        JsonAdapter<Relationship> jsonAdapter = Relationship.JSON_ADAPTER;
        jsonAdapter.getClass();
        return (Relationship) m13960v0("relationships", uid, jsonAdapter);
    }

    @Nullable
    /* JADX INFO: renamed from: z0 */
    public final User m13964z0(@Nullable String userId) {
        if (TextUtils.isEmpty(userId)) {
            return null;
        }
        JsonAdapter<User> jsonAdapter = User.JSON_ADAPTER;
        jsonAdapter.getClass();
        User user = (User) m13960v0("users", userId, jsonAdapter);
        userId.getClass();
        Relationship relationshipM13963y0 = m13963y0(userId);
        if ((user != null ? user.localRelationship : null) == null && user != null) {
            user.localRelationship = relationshipM13963y0;
        }
        return user;
    }
}
