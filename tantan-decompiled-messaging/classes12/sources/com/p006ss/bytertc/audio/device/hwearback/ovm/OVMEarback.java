...
import com.p006ss.bytertc.audio.device.hwearback.BaseEarback;
import com.p006ss.bytertc.audio.device.hwearback.SlientPlayer;
...
public class OVMEarback extends BaseEarback {
    ...
    public static /* synthetic */ void m8338a(OVMEarback oVMEarback, int i) {
        oVMEarback.getClass();
    ...
    @Override // com.p006ss.bytertc.audio.device.hwearback.BaseEarback
    ...
    public void onEvent(int i, int i2) {
        if (i == EVENT_KEY_RECORDING_START) {
            this.isRecordingStarted = true;
            updatePlayerState();
        } else if (i == EVENT_KEY_RECORDING_STOP) {
    ...
    public void onInit() {
        this.client.setAuthCallback(new OVMAuthManager.AuthCallback() { // from class: l.e050
            ...
            public final void onResult(int i) {
                OVMEarback.m8338a(this.f7095a, i);
            }
        });
    }
