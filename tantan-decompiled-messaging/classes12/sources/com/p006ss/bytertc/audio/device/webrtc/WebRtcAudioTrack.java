...
public class WebRtcAudioTrack {
    ...
    private int startPlayout() {
        ...
        if (this.audioThread != null) {
            ...
            return AudioTrackErrorCode.AUDIO_TRACK_START_THREAD_NOT_NULL;
        }
        ...
        try {
            ...
            releaseAudioResources();
            return AudioTrackErrorCode.AUDIO_TRACK_START_INVALID_STATE;
            ...
            return AudioTrackErrorCode.AUDIO_TRACK_START_ILLEGAL_STATE;
        }
    }
