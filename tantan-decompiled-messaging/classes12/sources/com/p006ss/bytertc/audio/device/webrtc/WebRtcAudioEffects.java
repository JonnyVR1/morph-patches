...
public class WebRtcAudioEffects {
    ...
    @Nullable
    private NoiseSuppressor f5515ns;
            ...
            try {
                ...
                if (noiseSuppressorCreate != null) {
                    ...
                    try {
                        ...
                        try {
                            if (this.f5515ns.setEnabled(z5) != 0) {
                                RXLogging.e(TAG, "Failed to set the NoiseSuppressor state");
                            }
                            z6 = enabled4;
                            enabled3 = this.f5515ns.getEnabled();
                        } catch (Exception e4) {
                            z4 = enabled4;
                            e = e4;
                            e.printStackTrace();
    ...
    public void release() {
        RXLogging.i(TAG, BuildConfig.BUILD_TYPE);
        try {
            ...
            NoiseSuppressor noiseSuppressor = this.f5515ns;
    ...
    public boolean setNS(boolean z) {
        ...
        if (this.f5515ns == null || z == this.shouldEnableNs) {
