package com.p006ss.bytertc;

/* JADX INFO: loaded from: /tmp/tantan-dex/classes12.dex */
public final class BuildConfig {
    public static final String BUILD_TYPE = "release";
    public static final boolean BYTERTC_TOB = true;
    public static final boolean DEBUG = false;
    public static final boolean ENABLE_BYTEAUDIO_STATIC = true;
    public static final boolean ENABLE_BYTENN = true;
    public static final boolean ENABLE_CVBYTENN = true;
