...
import com.p006ss.bytertc.base.media.screen.ScreenAudioCaptureAndroidManager;
import com.p006ss.bytertc.base.media.screen.ScreenCaptureAndroidManager;
...
public class RXScreenCaptureService extends Service {
    ...
    @RequiresApi(api = AudioRouteDeviceManager.RoutingDeviceType.BLUETOOTH_A2DP)
    private void createNotificationChannel() {
        ...
        if (i >= 26) {
            tp40.a(builder, "notification_id");
        }
        if (i >= 26) {
            sp40.a((NotificationManager) getSystemService("notification"), up40.a("notification_id", "notification_name", 2));
        }
    ...
    public static /* synthetic */ void m8378d(RXScreenCaptureService rXScreenCaptureService) {
    ...
    public static /* synthetic */ void m8380f(RXScreenCaptureService rXScreenCaptureService, int i, int i2, int i3, int i4) {
        rXScreenCaptureService.getClass();
    ...
    public static /* synthetic */ void m8382h(RXScreenCaptureService rXScreenCaptureService) {
    ...
    private void startAudioCapture() {
        ...
        this.mHandler.post(new Runnable() { // from class: l.pbc0
            @Override // java.lang.Runnable
            public final void run() {
                RXScreenCaptureService.m8378d(this.f11780a);
            }
        });
    }
    ...
    private void startCapture(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: l.jbc0
            @Override // java.lang.Runnable
            public final void run() {
                RXScreenCaptureService.m8380f(this.f9304a, intExtra, intExtra2, intExtra3, intExtra4);
            }
        });
    }
    ...
    private void stop() {
        ...
        this.mHandler.post(new Runnable() { // from class: l.mbc0
            @Override // java.lang.Runnable
            public final void run() {
                RXScreenCaptureService.m8382h(this.f10413a);
            }
        });
    }
