...
public class ScreenCapturerAndroid implements VideoCapturer, VideoSink {
        ...
        if (!this.needStartService || Build.VERSION.SDK_INT <= 28) {
            ...
            try {
                if (RXScreenCaptureService.serviceStarted.get()) {
                    ...
                    nck0.a(context, RXScreenCaptureService.getServiceIntent(context, 3, intent));
                }
    ...
    public synchronized void dispose() {
        if (!this.needStartService || Build.VERSION.SDK_INT <= 28) {
            ...
            try {
                if (RXScreenCaptureService.serviceStarted.get()) {
                    Context context = this.mContext;
                    nck0.a(context, RXScreenCaptureService.getServiceIntent(context, 5, intent));
                }
            } catch (ForegroundServiceStartNotAllowedException unused) {
                CapturerObserver capturerObserver = this.capturerObserver;
                if (capturerObserver != null) {
    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        try {
            if (RXScreenCaptureService.serviceStarted.get()) {
                Context context = this.mContext;
                nck0.a(context, RXScreenCaptureService.getServiceIntent(context, 4, intent));
            }
        } catch (ForegroundServiceStartNotAllowedException unused) {
            CapturerObserver capturerObserver = this.capturerObserver;
            if (capturerObserver != null) {
    ...
    public synchronized void startCapture(int i, int i2, int i3, int i4) {
        if (!this.needStartService || Build.VERSION.SDK_INT <= 28) {
            ...
            if (i5 > 0) {
                RXLogging.w(TAG, String.format("[ScreenCapture]  call RXScreenCaptureService.COMMAND_START success, wait times:%d ms", Integer.valueOf((3 - i5) * 50)));
                Context context = this.mContext;
                nck0.a(context, RXScreenCaptureService.getServiceIntent(context, 1, intent));
            } else {
    ...
    public synchronized void stopCapture() {
        if (!this.needStartService || Build.VERSION.SDK_INT <= 28) {
            ...
            try {
                if (RXScreenCaptureService.serviceStarted.get()) {
                    Context context = this.mContext;
                    nck0.a(context, RXScreenCaptureService.getServiceIntent(context, 2, null));
                }
            } catch (ForegroundServiceStartNotAllowedException unused) {
                CapturerObserver capturerObserver = this.capturerObserver;
                if (capturerObserver != null) {
