...
import com.p006ss.bytertc.base.media.Texture2DToWebRTCVideoFrame;
...
public class Texture2DToWebRTCVideoFrame {
    ...
    public static /* synthetic */ void m8360a(Texture2DToWebRTCVideoFrame texture2DToWebRTCVideoFrame) {
        texture2DToWebRTCVideoFrame.yuvConverter.release();
        texture2DToWebRTCVideoFrame.mHandler.getLooper().quit();
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m8362c(Texture2DToWebRTCVideoFrame texture2DToWebRTCVideoFrame) {
        texture2DToWebRTCVideoFrame.yuvConverter.release();
        texture2DToWebRTCVideoFrame.mHandler.getLooper().quit();
    }
    ...
    public void releaseFrame() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: l.yji0
            ...
            public final void run() {
                Texture2DToWebRTCVideoFrame.m8362c(this.f15456a);
            }
        });
    }
    ...
    public void release() {
        if (this.isFrameInUse) {
            ...
            ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: l.wji0
                @Override // java.lang.Runnable
                public final void run() {
                    Texture2DToWebRTCVideoFrame.m8360a(this.f14557a);
                }
            });
        }
    }
