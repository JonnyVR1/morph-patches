...
class Camera1Session implements CameraSession, Camera.FaceDetectionListener {
    ...
    public class C22803 implements Camera.PreviewCallback {
        public C22803() {
        }

        /* JADX INFO: renamed from: a */
        public static /* synthetic */ void m8364a(C22803 c22803, byte[] bArr) {
    ...
    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m8363a(Camera1Session camera1Session, VideoFrame videoFrame) {
        ...
        VideoFrame videoFrame2 = new VideoFrame(CameraSession.createTextureBufferWithModifiedTransformMatrix((TextureBufferImpl) bufferCropAndScale, false, 0), frameOrientation, videoFrame.getTimestampNs(), false);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    sMinFramerate = captureFormatFindClosestCaptureFormat.framerate.min / MakeUpMenuView.MakeupCategory.TYPE_MAKEUP_BEAUTYAUTO;
    ...
    private void listenForBytebufferFrames() {
        this.camera.setPreviewCallbackWithBuffer(new C22803());
    }
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new VideoSink() { // from class: com.ss.bytertc.base.media.camera.a
            ...
            public final void onFrame(VideoFrame videoFrame) {
                Camera1Session.m8363a(this.f5518a, videoFrame);
            }
        });
    }
    ...
    @Override // com.p006ss.bytertc.base.media.camera.CameraSession
