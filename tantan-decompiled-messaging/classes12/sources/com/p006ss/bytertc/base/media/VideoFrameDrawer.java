...
public class VideoFrameDrawer {
    ...
    /* JADX INFO: renamed from: com.ss.bytertc.base.media.VideoFrameDrawer$1 */
    public static /* synthetic */ class C22761 {

        /* JADX INFO: renamed from: $SwitchMap$com$bytedance$realx$video$VideoFrame$TextureBuffer$Type */
        static final /* synthetic */ int[] f5516xef2a35a6;
        ...
        static {
            ...
            try {
                f5516xef2a35a6[VideoFrame.TextureBuffer.Type.RGB.ordinal()] = 2;
    ...
    public static void drawTexture(RendererCommon.GlDrawer glDrawer, VideoFrame.TextureBuffer textureBuffer, Matrix matrix, int i, int i2, int i3, int i4, int i5, int i6, FilterType filterType, int i7, int i8) {
        ...
        int i9 = C22761.f5516xef2a35a6[textureBuffer.getType().ordinal()];
        if (i9 == 1) {
    ...
    public void drawFrame(VideoFrame videoFrame, RendererCommon.GlDrawer glDrawer, @Nullable Matrix matrix, int i, int i2, int i3, int i4) {
        try {
            ...
            FilterType scaleFilter = videoFrame.getBuffer().getScaleFilter();
            int unscaledWidth = videoFrame.getBuffer().getUnscaledWidth();
            int unscaledHeight = videoFrame.getBuffer().getUnscaledHeight();
            this.lastI420Frame = null;
            if (scaleFilter == null || scaleFilter == FilterType.Origin || unscaledWidth == 0 || unscaledHeight == 0) {
                drawTexture(glDrawer, videoFrame.getBuffer(), this.renderMatrix, this.renderWidth, this.renderHeight, i, i2, i3, i4, FilterType.Origin, 0, 0);
            } else {
                drawTexture(glDrawer, videoFrame.getBuffer(), this.renderMatrix, this.renderWidth, this.renderHeight, i, i2, i3, i4, scaleFilter, unscaledWidth, unscaledHeight);
            }
    ...
    public static class YuvUploader {
        ...
        public /* synthetic */ YuvUploader(C22761 c22761) {
            this();
        }
    }
