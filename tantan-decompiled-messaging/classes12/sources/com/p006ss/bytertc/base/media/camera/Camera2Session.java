...
class Camera2Session implements CameraSession {
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public static /* synthetic */ void m8366a(CaptureSessionCallback captureSessionCallback, VideoFrame videoFrame) {
            Camera2Session.this.checkIsOnCameraThread();
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: com.ss.bytertc.base.media.camera.d
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        Camera2Session.CaptureSessionCallback.m8366a(this.f5523a, videoFrame);
                    }
                });
    ...
    private void start() {
        checkIsOnCameraThread();
        RXLogging.i(TAG, KanKanStatus.start);
        try {
