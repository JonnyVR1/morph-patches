...
import com.p000p1.mobile.putong.core.p001ui.likedusers.anchor.LiveHaloAvatar;
...
public final class LiveHaloAvatar extends View {
    ...
    public LiveHaloAvatar(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, h9c0.k);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(h9c0.n, 0);
        this.haloSize = dimensionPixelSize;
        this.avatarSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(h9c0.l, 0);
        int color = typedArrayObtainStyledAttributes.getColor(h9c0.o, -38485);
        this.haloStartColor = color;
        this.haloEndColor = typedArrayObtainStyledAttributes.getColor(h9c0.m, -41238);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(h9c0.p, true);
    ...
    public static final void m485c(LiveHaloAvatar liveHaloAvatar, ValueAnimator valueAnimator, ValueAnimator valueAnimator2) {
    ...
    public final void m486b() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.css
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                LiveHaloAvatar.m485c(this.f6725a, valueAnimator, valueAnimator2);
            }
        });
    }

    /* JADX INFO: renamed from: d */
    public final void m487d(int haloStartColor, int haloEndColor) {
