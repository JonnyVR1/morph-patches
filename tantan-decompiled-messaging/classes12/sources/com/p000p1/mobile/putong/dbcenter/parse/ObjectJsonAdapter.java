...
public abstract class ObjectJsonAdapter<T extends ValueObject> extends JsonAdapter<T> {
    ...
    public abstract T mo17830newInstance();
    ...
    public T parse(JsonParser jsonParser, String str, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
        ...
        ValueObject valueObjectMo17830newInstance = mo17830newInstance();
        String classParseName = valueObjectMo17830newInstance.getClassParseName();
        String str2 = str;
        valueObjectMo17830newInstance.setParsedApiRequest(str2);
        if (jsonParser.getCurrentToken() == null) {
            jsonParser.nextToken();
        }
        if (jsonParser.getCurrentToken() != JsonToken.START_OBJECT) {
        ...
        if (valueObjectMo17830newInstance instanceof Data) {
            valueObject = (T) valueObjectMo17830newInstance;
            JsonParser jsonParser2 = jsonParser;
            ArrayList<ObjectJsonAdapter> arrayListM13944a = rpq.m13943b().m13944a();
            ArrayList<Pair> arrayList3 = new ArrayList();
            ArrayList<BaseData> arrayList4 = new ArrayList<>();
            for (ObjectJsonAdapter objectJsonAdapter : arrayListM13944a) {
                BaseData baseData = (BaseData) objectJsonAdapter.mo17830newInstance();
            ...
            ArrayList<Pair<String, ObjectJsonAdapter>> arrayListM13945c = rpq.m13943b().m13945c(classParseName);
            if (arrayListM13945c == null || arrayListM13945c.size() <= 0) {
                z = false;
                arrayList2 = null;
                map = null;
            } else {
                ...
                z = false;
                for (Pair<String, ObjectJsonAdapter> pair4 : arrayListM13945c) {
                    ValueObject valueObjectMo17830newInstance2 = ((ObjectJsonAdapter) pair4.second).mo17830newInstance();
                    arrayList5.add(valueObjectMo17830newInstance2);
                    map2.put(valueObjectMo17830newInstance2.getClass().getName(), (ObjectJsonAdapter) pair4.second);
                    addExtDataToModuleData(arrayList, (String) pair4.first, valueObjectMo17830newInstance2);
                    z = true;
                }
            ...
            if (z) {
                ...
                while (i < size) {
                    ...
                    if (i < arrayList2.size()) {
                        ValueObject valueObject3 = (ValueObject) arrayList2.get(i);
                        ...
                        valueObject2 = valueObjectMo17830newInstance;
                    } else {
                        ValueObject valueObject4 = valueObjectMo17830newInstance;
                    ...
                    str2 = str;
                    arrayList = arrayList;
                    valueObjectMo17830newInstance = valueObject2;
                }
                valueObject = (T) valueObjectMo17830newInstance;
            } else {
                while (jsonParser.nextToken() != JsonToken.END_OBJECT) {
                    String currentName2 = jsonParser.getCurrentName();
                    valueObjectMo17830newInstance.putParsedField(currentName2);
                    jsonParser.nextToken();
                    parseField(valueObjectMo17830newInstance, currentName2, jsonParser, str, arrayList, dataChecker);
                    jsonParser.skipChildren();
                }
                valueObject = valueObjectMo17830newInstance;
            }
    ...
    public /* bridge */ /* synthetic */ Object m19398parse(JsonParser jsonParser, String str, ArrayList arrayList, DataChecker dataChecker) throws IOException {
