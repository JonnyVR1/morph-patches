package com.p000p1.mobile.putong.feed.newui.camera.momosdk;
...
public class Photo implements Parcelable {
    public static final Parcelable.Creator<Photo> CREATOR = new C2005a();
    ...
    public class C2005a implements Parcelable.Creator<Photo> {
    ...
    public String toString() {
        return "Photo[ id:" + this.f942id + "  path:" + this.path + "  isOriginal:" + this.isOriginal + "  size:" + this.size + "   tempPath:" + this.tempPath + "   isCheck:" + this.isCheck + "   mimeType:" + this.mimeType + "] isLong longThumbPath";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeLong(this.f942id);
