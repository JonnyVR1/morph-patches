...
public class StateEmotion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StateEmotion> PROTOBUF_ADAPTER = new MessageNanoAdapter<StateEmotion>() { // from class: com.p1.mobile.putong.feed.data.StateEmotion.1
        {
        ...
        public StateEmotion m19759parse(nb5 nb5Var) throws IOException {
    ...
    public static JsonAdapter<StateEmotion> JSON_ADAPTER = new ObjectJsonAdapter<StateEmotion>() { // from class: com.p1.mobile.putong.feed.data.StateEmotion.2
    ...
    public StateEmotion m19758clone() {
        StateEmotion stateEmotion = new StateEmotion();
        stateEmotion.categoryName = this.categoryName;
        List<Emotion> list = this.emotions;
        if (list != null) {
            stateEmotion.emotions = ValueObject.util_map(list, new w9j() { // from class: l.evf0
