...
public class GroupIdBox extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GroupIdBox> PROTOBUF_ADAPTER = new MessageNanoAdapter<GroupIdBox>() { // from class: com.p1.mobile.putong.feed.data.GroupIdBox.1
        ...
        public int computeAndCacheSize(GroupIdBox groupIdBox) {
            String str = groupIdBox.f684id;
            int iO = str != null ? CodedOutputByteBufferNano.o(1, str) : 0;
            String str2 = groupIdBox.name;
            if (str2 != null) {
                iO += CodedOutputByteBufferNano.o(2, str2);
            }
            int iB = iO + CodedOutputByteBufferNano.b(3, groupIdBox.lastJoined);
            ((MessageNano) groupIdBox).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public GroupIdBox m19527parse(nb5 nb5Var) throws IOException {
            GroupIdBox groupIdBox = new GroupIdBox();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (groupIdBox.f684id == null) {
                        groupIdBox.f684id = "";
                    }
                ...
                if (iU == 10) {
                    groupIdBox.f684id = nb5Var.s();
                } else if (iU == 18) {
                    groupIdBox.name = nb5Var.s();
                } else {
                    if (iU != 24) {
                        if (groupIdBox.f684id == null) {
                            groupIdBox.f684id = "";
                    ...
                    groupIdBox.lastJoined = nb5Var.g();
                }
            }
            return groupIdBox;
        }
        ...
        public void serialize(GroupIdBox groupIdBox, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(3, groupIdBox.lastJoined);
        }
    };
    public static JsonAdapter<GroupIdBox> JSON_ADAPTER = new ObjectJsonAdapter<GroupIdBox>() { // from class: com.p1.mobile.putong.feed.data.GroupIdBox.2
        ...
        public GroupIdBox mo17830newInstance() {
        ...
        public boolean parseField(GroupIdBox groupIdBox, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "id":
                    groupIdBox.f684id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public GroupIdBox m19526clone() {
        GroupIdBox groupIdBox = new GroupIdBox();
        groupIdBox.f684id = this.f684id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f684id, groupIdBox.f684id) && ValueObject.util_equals(this.name, groupIdBox.name) && this.lastJoined == groupIdBox.lastJoined;
    }
