...
import com.p000p1.mobile.putong.data.DyMomentSource;
...
import com.p000p1.mobile.putong.data.MomentLabels;
...
public class Moment extends DbObject<Moment> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Moment> PROTOBUF_ADAPTER = new MessageNanoAdapter<Moment>() { // from class: com.p1.mobile.putong.feed.data.Moment.1
        ...
        public int computeAndCacheSize(Moment moment) {
            int iJ = CodedOutputByteBufferNano.j(1, ((DbObject) moment)._id);
            String str = ((DbObject) moment).id;
            if (str != null) {
                iJ += CodedOutputByteBufferNano.o(2, str);
            }
            int iH = iJ + CodedOutputByteBufferNano.h(51, moment.localCreatedSession) + CodedOutputByteBufferNano.b(52, moment.localInFeed) + CodedOutputByteBufferNano.b(53, moment.localInUserFeed);
            String str2 = moment.value;
            if (str2 != null) {
                iH += CodedOutputByteBufferNano.o(54, str2);
            }
            int iD = iH + CodedOutputByteBufferNano.d(55, moment.createdTime);
            ...
            if (partialIdList != null) {
                iD += CodedOutputByteBufferNano.l(57, partialIdList, PartialIdList.PROTOBUF_ADAPTER);
            }
            int iB = iD + CodedOutputByteBufferNano.b(58, moment.haveLiked);
            ...
            if (list != null) {
                iB += CodedOutputByteBufferNano.l(60, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = moment.landingPage;
            if (str4 != null) {
                iB += CodedOutputByteBufferNano.o(61, str4);
            }
            PartialIdList partialIdList2 = moment.messages;
            if (partialIdList2 != null) {
                iB += CodedOutputByteBufferNano.l(62, partialIdList2, PartialIdList.PROTOBUF_ADAPTER);
            }
            MomentSettings momentSettings = moment.settings;
            if (momentSettings != null) {
                iB += CodedOutputByteBufferNano.l(63, momentSettings, MomentSettings.PROTOBUF_ADAPTER);
            }
            DyMomentSource dyMomentSource = moment.dynamicType;
            if (dyMomentSource != null) {
                iB += CodedOutputByteBufferNano.h(64, dyMomentSource.ordinal());
            }
            ...
            if (str6 != null) {
                iB += CodedOutputByteBufferNano.o(66, str6);
            }
            MomentType momentType = moment.momentType;
            if (momentType != null) {
                iB += CodedOutputByteBufferNano.h(67, momentType.ordinal());
            }
            List<TopicMomentIdBox> list2 = moment.topics;
            if (list2 != null) {
                iB += CodedOutputByteBufferNano.l(68, list2, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = moment.hyperlink;
            if (str7 != null) {
                iB += CodedOutputByteBufferNano.o(69, str7);
            }
            DyMomentSource dyMomentSource2 = moment.dynamicType;
            if (dyMomentSource2 != null) {
                iB += CodedOutputByteBufferNano.l(70, dyMomentSource2, DyMomentSource.PROTOBUF_ADAPTER);
            }
            MomentType momentType2 = moment.momentType;
            if (momentType2 != null) {
                iB += CodedOutputByteBufferNano.l(71, momentType2, MomentType.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility = moment.userSetVisibility;
            if (userSetVisibility != null) {
                iB += CodedOutputByteBufferNano.l(72, userSetVisibility, UserSetVisibility.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility2 = moment.userSetVisibility;
            if (userSetVisibility2 != null) {
                iB += CodedOutputByteBufferNano.h(73, userSetVisibility2.ordinal());
            }
            MomentSimpleActivity momentSimpleActivity = moment.simpleActivity;
            if (momentSimpleActivity != null) {
                iB += CodedOutputByteBufferNano.l(74, momentSimpleActivity, MomentSimpleActivity.PROTOBUF_ADAPTER);
            }
            MomentAdditionalData momentAdditionalData = moment.additionalData;
            if (momentAdditionalData != null) {
                iB += CodedOutputByteBufferNano.l(75, momentAdditionalData, MomentAdditionalData.PROTOBUF_ADAPTER);
            }
            GroupIdBox groupIdBox = moment.group;
            if (groupIdBox != null) {
                iB += CodedOutputByteBufferNano.l(76, groupIdBox, GroupIdBox.PROTOBUF_ADAPTER);
            }
            String str8 = moment.deeplink;
            if (str8 != null) {
                iB += CodedOutputByteBufferNano.o(77, str8);
            }
            ThirdShareSource thirdShareSource = moment.thirdShareSource;
            if (thirdShareSource != null) {
                iB += CodedOutputByteBufferNano.l(78, thirdShareSource, ThirdShareSource.PROTOBUF_ADAPTER);
            }
            int iH2 = iB + CodedOutputByteBufferNano.h(79, moment.attitudeId);
            Attitudes attitudes = moment.attitudes;
            if (attitudes != null) {
                iH2 += CodedOutputByteBufferNano.l(80, attitudes, Attitudes.PROTOBUF_ADAPTER);
            }
            int iB2 = iH2 + CodedOutputByteBufferNano.b(81, moment.shareMyVote);
            MomentAllowForwardState momentAllowForwardState = moment.allowForward;
            if (momentAllowForwardState != null) {
                iB2 += CodedOutputByteBufferNano.l(82, momentAllowForwardState, MomentAllowForwardState.PROTOBUF_ADAPTER);
            }
            MomentForwards momentForwards = moment.forwards;
            if (momentForwards != null) {
                iB2 += CodedOutputByteBufferNano.l(83, momentForwards, MomentForwards.PROTOBUF_ADAPTER);
            }
            int iB3 = iB2 + CodedOutputByteBufferNano.b(84, moment.isNewUserAIMoment);
            ((MessageNano) moment).cachedSize = iB3;
            return iB3;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Moment m19593parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        ((DbObject) moment)._id = nb5Var.k();
                        continue;
                    case 18:
                        ((DbObject) moment).id = nb5Var.s();
                        continue;
                    case 408:
                        moment.localCreatedSession = nb5Var.j();
                        continue;
                    case 416:
                        moment.localInFeed = nb5Var.g();
                        continue;
                    case 424:
                        moment.localInUserFeed = nb5Var.g();
                        continue;
                    case 434:
                        moment.value = nb5Var.s();
                        continue;
                    case 441:
                        moment.createdTime = nb5Var.h();
                        continue;
                    case 450:
                        moment.owner = nb5Var.s();
                        continue;
                    case 458:
                        moment.likes = (PartialIdList) nb5Var.l(PartialIdList.PROTOBUF_ADAPTER);
                        continue;
                    case 464:
                        moment.haveLiked = nb5Var.g();
                        continue;
                    case 474:
                        moment.location = (MessageLocation) nb5Var.l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 482:
                        moment.media = (List) nb5Var.l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 490:
                        moment.landingPage = nb5Var.s();
                        continue;
                    case 498:
                        moment.messages = (PartialIdList) nb5Var.l(PartialIdList.PROTOBUF_ADAPTER);
                        continue;
                    case 506:
                        moment.settings = (MomentSettings) nb5Var.l(MomentSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 512:
                        numValueOf = Integer.valueOf(nb5Var.j());
                        continue;
                    case 522:
                        moment.musicId = nb5Var.s();
                        continue;
                    case 530:
                        moment.status = nb5Var.s();
                        continue;
                    case 536:
                        numValueOf2 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 546:
                        moment.topics = (List) nb5Var.l(TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 554:
                        moment.hyperlink = nb5Var.s();
                        continue;
                    case 562:
                        moment.dynamicType = (DyMomentSource) nb5Var.l(DyMomentSource.PROTOBUF_ADAPTER);
                        continue;
                    case 570:
                        moment.momentType = (MomentType) nb5Var.l(MomentType.PROTOBUF_ADAPTER);
                        continue;
                    case 578:
                        moment.userSetVisibility = (UserSetVisibility) nb5Var.l(UserSetVisibility.PROTOBUF_ADAPTER);
                        continue;
                    case 584:
                        numValueOf3 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 594:
                        moment.simpleActivity = (MomentSimpleActivity) nb5Var.l(MomentSimpleActivity.PROTOBUF_ADAPTER);
                        continue;
                    case 602:
                        moment.additionalData = (MomentAdditionalData) nb5Var.l(MomentAdditionalData.PROTOBUF_ADAPTER);
                        continue;
                    case 610:
                        moment.group = (GroupIdBox) nb5Var.l(GroupIdBox.PROTOBUF_ADAPTER);
                        continue;
                    case 618:
                        moment.deeplink = nb5Var.s();
                        continue;
                    case 626:
                        moment.thirdShareSource = (ThirdShareSource) nb5Var.l(ThirdShareSource.PROTOBUF_ADAPTER);
                        continue;
                    case 632:
                        moment.attitudeId = nb5Var.j();
                        continue;
                    case 642:
                        moment.attitudes = (Attitudes) nb5Var.l(Attitudes.PROTOBUF_ADAPTER);
                        continue;
                    case 648:
                        moment.shareMyVote = nb5Var.g();
                        continue;
                    case 658:
                        moment.allowForward = (MomentAllowForwardState) nb5Var.l(MomentAllowForwardState.PROTOBUF_ADAPTER);
                        continue;
                    case 666:
                        moment.forwards = (MomentForwards) nb5Var.l(MomentForwards.PROTOBUF_ADAPTER);
                        continue;
                    case 672:
                        moment.isNewUserAIMoment = nb5Var.g();
                        continue;
                    default:
                        if (moment.dynamicType == null && numValueOf != null) {
                            moment.dynamicType = (DyMomentSource) DyMomentSource.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Moment moment, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.I(1, ((DbObject) moment)._id);
            String str = ((DbObject) moment).id;
            if (str != null) {
                codedOutputByteBufferNano.R(2, str);
            }
            codedOutputByteBufferNano.G(51, moment.localCreatedSession);
            codedOutputByteBufferNano.A(52, moment.localInFeed);
            codedOutputByteBufferNano.A(53, moment.localInUserFeed);
            String str2 = moment.value;
            if (str2 != null) {
                codedOutputByteBufferNano.R(54, str2);
            }
            codedOutputByteBufferNano.C(55, moment.createdTime);
            String str3 = moment.owner;
            if (str3 != null) {
            ...
            PartialIdList partialIdList = moment.likes;
            if (partialIdList != null) {
                codedOutputByteBufferNano.K(57, partialIdList, PartialIdList.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(58, moment.haveLiked);
            MessageLocation messageLocation = moment.location;
            if (messageLocation != null) {
            ...
            List<Media> list = moment.media;
            if (list != null) {
                codedOutputByteBufferNano.K(60, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = moment.landingPage;
            if (str4 != null) {
                codedOutputByteBufferNano.R(61, str4);
            }
            PartialIdList partialIdList2 = moment.messages;
            if (partialIdList2 != null) {
                codedOutputByteBufferNano.K(62, partialIdList2, PartialIdList.PROTOBUF_ADAPTER);
            }
            MomentSettings momentSettings = moment.settings;
            if (momentSettings != null) {
                codedOutputByteBufferNano.K(63, momentSettings, MomentSettings.PROTOBUF_ADAPTER);
            }
            DyMomentSource dyMomentSource = moment.dynamicType;
            if (dyMomentSource != null) {
                codedOutputByteBufferNano.G(64, dyMomentSource.ordinal());
            }
            String str5 = moment.musicId;
            if (str5 != null) {
            ...
            String str6 = moment.status;
            if (str6 != null) {
                codedOutputByteBufferNano.R(66, str6);
            }
            MomentType momentType = moment.momentType;
            if (momentType != null) {
                codedOutputByteBufferNano.G(67, momentType.ordinal());
            }
            List<TopicMomentIdBox> list2 = moment.topics;
            if (list2 != null) {
                codedOutputByteBufferNano.K(68, list2, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = moment.hyperlink;
            if (str7 != null) {
                codedOutputByteBufferNano.R(69, str7);
            }
            DyMomentSource dyMomentSource2 = moment.dynamicType;
            if (dyMomentSource2 != null) {
                codedOutputByteBufferNano.K(70, dyMomentSource2, DyMomentSource.PROTOBUF_ADAPTER);
            }
            MomentType momentType2 = moment.momentType;
            if (momentType2 != null) {
                codedOutputByteBufferNano.K(71, momentType2, MomentType.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility = moment.userSetVisibility;
            if (userSetVisibility != null) {
                codedOutputByteBufferNano.K(72, userSetVisibility, UserSetVisibility.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility2 = moment.userSetVisibility;
            if (userSetVisibility2 != null) {
                codedOutputByteBufferNano.G(73, userSetVisibility2.ordinal());
            }
            MomentSimpleActivity momentSimpleActivity = moment.simpleActivity;
            if (momentSimpleActivity != null) {
                codedOutputByteBufferNano.K(74, momentSimpleActivity, MomentSimpleActivity.PROTOBUF_ADAPTER);
            }
            MomentAdditionalData momentAdditionalData = moment.additionalData;
            if (momentAdditionalData != null) {
                codedOutputByteBufferNano.K(75, momentAdditionalData, MomentAdditionalData.PROTOBUF_ADAPTER);
            }
            GroupIdBox groupIdBox = moment.group;
            if (groupIdBox != null) {
                codedOutputByteBufferNano.K(76, groupIdBox, GroupIdBox.PROTOBUF_ADAPTER);
            }
            String str8 = moment.deeplink;
            if (str8 != null) {
                codedOutputByteBufferNano.R(77, str8);
            }
            ThirdShareSource thirdShareSource = moment.thirdShareSource;
            if (thirdShareSource != null) {
                codedOutputByteBufferNano.K(78, thirdShareSource, ThirdShareSource.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(79, moment.attitudeId);
            Attitudes attitudes = moment.attitudes;
            if (attitudes != null) {
                codedOutputByteBufferNano.K(80, attitudes, Attitudes.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(81, moment.shareMyVote);
            MomentAllowForwardState momentAllowForwardState = moment.allowForward;
            if (momentAllowForwardState != null) {
                codedOutputByteBufferNano.K(82, momentAllowForwardState, MomentAllowForwardState.PROTOBUF_ADAPTER);
            }
            MomentForwards momentForwards = moment.forwards;
            if (momentForwards != null) {
                codedOutputByteBufferNano.K(83, momentForwards, MomentForwards.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(84, moment.isNewUserAIMoment);
        }
    };
    public static JsonAdapter<Moment> JSON_ADAPTER = new ObjectJsonAdapter<Moment>() { // from class: com.p1.mobile.putong.feed.data.Moment.2
        ...
        public Moment mo17830newInstance() {
            return new Moment();
        }
        ...
        public boolean parseField(Moment moment, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "commentAtOnce":
                    ...
                    return true;
                case "momentViewer":
                    moment.momentViewer = (MomentViewerBox) MomentViewerBox.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "cameraStickerIds":
                ...
                case "notifyUsers":
                    ...
                    return true;
                case "allowForward":
                    moment.allowForward = (MomentAllowForwardState) MomentAllowForwardState.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "isNewUserAIMoment":
                ...
                case "labels":
                    ...
                    return true;
                case "voiceLive":
                    moment.voiceLive = (VoiceLive) VoiceLive.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "additionalData":
                    moment.additionalData = (MomentAdditionalData) MomentAdditionalData.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "report":
                ...
                case "topics":
                    ...
                    return true;
                case "createdTime":
                    moment.createdTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "simpleActivity":
                    moment.simpleActivity = (MomentSimpleActivity) MomentSimpleActivity.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "messages":
                    moment.messages = (PartialIdList) PartialIdList.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "dynamicType":
                    moment.dynamicType = (DyMomentSource) DyMomentSource.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "attitudes":
                    moment.attitudes = (Attitudes) Attitudes.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "shareMyVote":
                    moment.shareMyVote = jsonParser.getValueAsBoolean();
                    return true;
                case "thirdShareSource":
                    moment.thirdShareSource = (ThirdShareSource) ThirdShareSource.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "userSetVisibility":
                    moment.userSetVisibility = (UserSetVisibility) UserSetVisibility.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "id":
                    ((DbObject) moment).id = jsonParser.getValueAsString();
                    return false;
                case "live":
                    moment.live = (Live) Live.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "group":
                    moment.group = (GroupIdBox) GroupIdBox.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "likes":
                    moment.likes = (PartialIdList) PartialIdList.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "media":
                    moment.media = JsonAdapter.parseArray(jsonParser, Converter.RAW_PICTURE_TO_MEDIA, str2, arrayList, dataChecker);
                    return true;
                case "owner":
                    moment.owner = (String) Converter.USER_ID.parse(jsonParser, str2);
                    return true;
                case "value":
                ...
                case "isVoiceLive":
                    ...
                    return true;
                case "forwards":
                    moment.forwards = (MomentForwards) MomentForwards.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "landingPage":
                ...
                case "deeplink":
                    ...
                    return true;
                case "momentType":
                    moment.momentType = (MomentType) MomentType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "hyperlink":
                ...
                case "musicId":
                    ...
                    return true;
                case "settings":
                    moment.settings = (MomentSettings) MomentSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "multiCallInfo":
                    moment.multiCallInfo = (LiveMultiCallInfo) LiveMultiCallInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "location":
                    moment.location = (MessageLocation) MessageLocation.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
        ...
        public void serializeFields(Moment moment, JsonGenerator jsonGenerator) throws IOException {
            ...
            if (moment.voiceLive != null) {
                jsonGenerator.writeFieldName("voiceLive");
    ...
    public static final LongColumn<Moment> _ID = new LongColumn<Moment>("_id") { // from class: com.p1.mobile.putong.feed.data.Moment.3
        public Long get(Moment moment) {
            return Long.valueOf(((DbObject) moment)._id);
        }

        public void set(Moment moment, Long l2) {
            ((DbObject) moment)._id = l2.longValue();
        }
    };

    /* JADX INFO: renamed from: ID */
    public static final StringColumn<Moment> f691ID = new StringColumn<Moment>("id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.4
        public String get(Moment moment) {
            return ((DbObject) moment).id;
        }

        public void set(Moment moment, String str) {
            ((DbObject) moment).id = str;
        }
    };
    ...
    public static final StringColumn<Moment> SIMPLEACTIVITY_ID = new StringColumn<Moment>("simpleActivity_id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.34
        public String get(Moment moment) {
            return moment.simpleActivity.f696id;
        }

        public void set(Moment moment, String str) {
            moment.simpleActivity.f696id = str;
        }
    };
    ...
    public static final StringColumn<Moment> ADDITIONALDATA_SENDFROM_ID = new StringColumn<Moment>("additionalData_sendFrom_id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.36
        public String get(Moment moment) {
            return moment.additionalData.sendFrom.f695id;
        }

        public void set(Moment moment, String str) {
            moment.additionalData.sendFrom.f695id = str;
        }
    };
    ...
    public static final StringColumn<Moment> GROUP_ID = new StringColumn<Moment>("group_id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.39
        public String get(Moment moment) {
            return moment.group.f684id;
        }

        public void set(Moment moment, String str) {
            moment.group.f684id = str;
        }
    };
    ...
    public static mrf0<Moment> DB_ADAPTER = new mrf0<Moment>() { // from class: com.p1.mobile.putong.feed.data.Moment.59
        ...
        public Moment read(Cursor cursor, int i) {
            ...
            try {
                ...
                ((DbObject) moment)._id = cursor.getLong(i);
                int i7 = i + 1;
                ((DbObject) moment).id = cursor.isNull(i7) ? null : cursor.getString(i7);
                ...
                int i10 = i + 9;
                moment.likes.ids = cursor.isNull(i10) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i10));
                int i11 = i + 10;
                ...
                int i13 = i + 13;
                moment.location = cursor.isNull(i13) ? null : (MessageLocation) MessageLocation.PROTOBUF_ADAPTER.parse(cursor.getBlob(i13));
                int i14 = i + 14;
                moment.media = cursor.isNull(i14) ? null : (List) Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i14));
                int i15 = i + 15;
                moment.landingPage = cursor.isNull(i15) ? null : cursor.getString(i15);
                moment.messages.count = cursor.getInt(i + 16);
                int i16 = i + 17;
                moment.messages.ids = cursor.isNull(i16) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i16));
                int i17 = i + 18;
                ...
                try {
                    ...
                    try {
                        ...
                        int i24 = i + 26;
                        try {
                            moment.topics = cursor.isNull(i24) ? null : (List) TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i24));
                            int i25 = i + 27;
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                int i33 = i + 36;
                                                moment.simpleActivity.f696id = cursor.isNull(i33) ? null : cursor.getString(i33);
                                                int i34 = i + 37;
                                                moment.simpleActivity.name = cursor.isNull(i34) ? null : cursor.getString(i34);
                                                int i35 = i + 38;
                                                moment.additionalData.sendFrom.f695id = cursor.isNull(i35) ? null : cursor.getString(i35);
                                                int i36 = i + 39;
                                                ...
                                                int i38 = i + 41;
                                                moment.group.f684id = cursor.isNull(i38) ? null : cursor.getString(i38);
                                                int i39 = i + 42;
        ...
        public void write(Moment moment, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", ((DbObject) moment).id);
                ...
                DbObject.cvPut(contentValues, "simpleActivity_id_c", moment.simpleActivity.f696id);
                DbObject.cvPut(contentValues, "simpleActivity_name_c", moment.simpleActivity.name);
                DbObject.cvPut(contentValues, "additionalData_sendFrom_id_c", moment.additionalData.sendFrom.f695id);
                ...
                DbObject.cvPut(contentValues, "group_id_c", moment.group.f684id);
    ...
    public bkn0.a voiceLiveApiInfo = null;
    ...
    public static /* synthetic */ String m1789e(String str) {
        return str;
    }
    ...
    public Moment m19592clone() {
        Moment moment = new Moment();
        ((DbObject) moment)._id = ((DbObject) this)._id;
        ((DbObject) moment).id = ((DbObject) this).id;
        ...
        if (partialIdList != null) {
            moment.likes = partialIdList.m18767clone();
        }
        moment.haveLiked = this.haveLiked;
        MessageLocation messageLocation = this.location;
        if (messageLocation != null) {
            moment.location = messageLocation.m18458clone();
        }
        ...
        if (partialIdList2 != null) {
            moment.messages = partialIdList2.m18767clone();
        }
        MomentSettings momentSettings = this.settings;
        if (momentSettings != null) {
            moment.settings = momentSettings.m19644clone();
        }
        ...
        if (list3 != null) {
            moment.labels = ValueObject.util_map(list3, new w9j() { // from class: l.d800
                public final Object call(Object obj) {
                    return ((MomentLabels) obj).m18485clone();
                }
            });
        }
        ...
        if (liveMultiCallInfo != null) {
            moment.multiCallInfo = liveMultiCallInfo.m19559clone();
        }
        MomentSimpleActivity momentSimpleActivity = this.simpleActivity;
        if (momentSimpleActivity != null) {
            moment.simpleActivity = momentSimpleActivity.m19650clone();
        }
        MomentAdditionalData momentAdditionalData = this.additionalData;
        if (momentAdditionalData != null) {
            moment.additionalData = momentAdditionalData.m19598clone();
        }
        GroupIdBox groupIdBox = this.group;
        if (groupIdBox != null) {
            moment.group = groupIdBox.m19526clone();
        }
    ...
    public void createTransValue() {
        super/*com.tantanapp.common.data.ValueObject*/.createTransValue();
    }
    ...
    public int hashCode() {
        ...
        ((ValueObject) this).hashCode = iHashCode34;
        return iHashCode34;
    }

    public boolean isAnonymousGroup() {
        GroupIdBox groupIdBox = this.group;
        if (groupIdBox != null && !TextUtils.isEmpty(groupIdBox.f684id)) {
            Group groupM16739u7 = FeedModule.f316d.m16739u7(this.group.f684id);
            if (NullChecker.a(groupM16739u7)) {
                return groupM16739u7.isGroupAnonymousType();
            }
        }
        return false;
    }
    ...
    public boolean isAnonymousMoment() {
        return (!vwb.J(this.mTopicList) && this.mTopicList.get(0).isTopicAnonymousType()) || TEnum.equals(this.momentType, "anonymous") || isAnonymousGroup();
    }
    ...
    public boolean isOnlyMatchVisiable() {
        return NullChecker.a(this.settings) && TEnum.equals(this.settings.userSetVisibility, "matches");
    }

    public boolean isQATopicMoment() {
        return !vwb.J(this.mTopicList) && this.mTopicList.get(0).isQATopicType();
    }

    public boolean isVoteTopicMoment() {
        return !vwb.J(this.mTopicList) && this.mTopicList.get(0).isTopicVoteType();
    }
    ...
    public void mergeData(Moment moment, String str) {
        ...
        if (!vwb.J(moment.mediaRepeatIndexList)) {
