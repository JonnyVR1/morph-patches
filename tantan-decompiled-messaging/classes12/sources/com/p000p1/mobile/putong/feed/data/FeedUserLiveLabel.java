...
public class FeedUserLiveLabel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FeedUserLiveLabel> PROTOBUF_ADAPTER = new MessageNanoAdapter<FeedUserLiveLabel>() { // from class: com.p1.mobile.putong.feed.data.FeedUserLiveLabel.1
        ...
        public int computeAndCacheSize(FeedUserLiveLabel feedUserLiveLabel) {
            ...
            int iB = iO + CodedOutputByteBufferNano.b(7, feedUserLiveLabel.ongoingCall);
            ...
            if (liveMultiCallInfo != null) {
                iB += CodedOutputByteBufferNano.l(11, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
            ((MessageNano) feedUserLiveLabel).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public FeedUserLiveLabel m19509parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        feedUserLiveLabel.mainTitle = nb5Var.s();
                        continue;
                    case 18:
                        feedUserLiveLabel.subTitle = nb5Var.s();
                        continue;
                    case 26:
                        feedUserLiveLabel.iconTitle = nb5Var.s();
                        continue;
                    case 34:
                        feedUserLiveLabel.userId = nb5Var.s();
                        continue;
                    case 42:
                        feedUserLiveLabel.buttonTitle = nb5Var.s();
                        continue;
                    case 50:
                        feedUserLiveLabel.liveId = nb5Var.s();
                        continue;
                    case 56:
                        feedUserLiveLabel.ongoingCall = nb5Var.g();
                        continue;
                    case 66:
                        feedUserLiveLabel.liveState = nb5Var.s();
                        continue;
                    case 74:
                        feedUserLiveLabel.anchorId = nb5Var.s();
                        continue;
                    case 82:
                        feedUserLiveLabel.voiceRoomTopicId = nb5Var.s();
                        continue;
                    case 90:
                        feedUserLiveLabel.multiCallInfo = (LiveMultiCallInfo) nb5Var.l(LiveMultiCallInfo.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (feedUserLiveLabel.mainTitle == null) {
                            feedUserLiveLabel.mainTitle = "";
        ...
        public void serialize(FeedUserLiveLabel feedUserLiveLabel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(7, feedUserLiveLabel.ongoingCall);
            String str7 = feedUserLiveLabel.liveState;
            if (str7 != null) {
            ...
            LiveMultiCallInfo liveMultiCallInfo = feedUserLiveLabel.multiCallInfo;
            if (liveMultiCallInfo != null) {
                codedOutputByteBufferNano.K(11, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<FeedUserLiveLabel> JSON_ADAPTER = new ObjectJsonAdapter<FeedUserLiveLabel>() { // from class: com.p1.mobile.putong.feed.data.FeedUserLiveLabel.2
        ...
        public FeedUserLiveLabel mo17830newInstance() {
        ...
        public boolean parseField(FeedUserLiveLabel feedUserLiveLabel, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "liveState":
                    ...
                    return true;
                case "multiCallInfo":
                    feedUserLiveLabel.multiCallInfo = (LiveMultiCallInfo) LiveMultiCallInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public FeedUserLiveLabel m19508clone() {
        FeedUserLiveLabel feedUserLiveLabel = new FeedUserLiveLabel();
        ...
        if (liveMultiCallInfo != null) {
            feedUserLiveLabel.multiCallInfo = liveMultiCallInfo.m19559clone();
        }
        return feedUserLiveLabel;
    }
    ...
    public boolean isLiveOpened() {
        return TextUtils.equals(this.liveState, "online") || TextUtils.equals(this.liveState, LiveState.suspended);
    }
