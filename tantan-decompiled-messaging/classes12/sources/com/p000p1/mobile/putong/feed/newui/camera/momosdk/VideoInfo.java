...
public class VideoInfo implements Parcelable {
    public static final Parcelable.Creator<VideoInfo> CREATOR = new C2007a();
    ...
    public class C2007a implements Parcelable.Creator<VideoInfo> {
    ...
    public VideoInfo(Parcel parcel) {
        ...
        this.lowerVideoCompressDuration = 5000L;
        this.upperVideoCompressDuration = 60000L;
        ...
        this.musicContent = parcel.readParcelable(MusicContent.class.getClassLoader());
