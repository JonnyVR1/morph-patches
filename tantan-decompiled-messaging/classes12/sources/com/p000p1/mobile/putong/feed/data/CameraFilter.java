...
public class CameraFilter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CameraFilter> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraFilter>() { // from class: com.p1.mobile.putong.feed.data.CameraFilter.1
        ...
        public int computeAndCacheSize(CameraFilter cameraFilter) {
            String str = cameraFilter.f679id;
        ...
        public CameraFilter m19449parse(nb5 nb5Var) throws IOException {
            CameraFilter cameraFilter = new CameraFilter();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (cameraFilter.f679id == null) {
                        cameraFilter.f679id = "";
                    }
    ...
    public static JsonAdapter<CameraFilter> JSON_ADAPTER = new ObjectJsonAdapter<CameraFilter>() { // from class: com.p1.mobile.putong.feed.data.CameraFilter.2
        ...
        public CameraFilter mo17830newInstance() {
        ...
        public boolean parseField(CameraFilter cameraFilter, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "minVersion":
                    ...
                    return true;
                case "id":
                    cameraFilter.f679id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public CameraFilter m19448clone() {
        CameraFilter cameraFilter = new CameraFilter();
        cameraFilter.f679id = this.f679id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f679id, cameraFilter.f679id) && ValueObject.util_equals(this.name, cameraFilter.name) && ValueObject.util_equals(this.icon, cameraFilter.icon) && ValueObject.util_equals(this.resource, cameraFilter.resource) && ValueObject.util_equals(this.resourceMD5, cameraFilter.resourceMD5) && ValueObject.util_equals(this.minVersion, cameraFilter.minVersion) && this.index == cameraFilter.index;
    }
    ...
    public CameraFilter subtract(CameraFilter cameraFilter) {
        ...
        if (!ValueObject.util_equals(this.f679id, cameraFilter.f679id)) {
            cameraFilter2.f679id = this.f679id;
        }
