...
public class CameraSticker extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CameraSticker> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraSticker>() { // from class: com.p1.mobile.putong.feed.data.CameraSticker.1
        ...
        public CameraSticker m19452parse(nb5 nb5Var) throws IOException {
            CameraSticker cameraSticker = new CameraSticker();
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        if (cameraSticker.f680id == null) {
                            cameraSticker.f680id = "";
                        }
    ...
    public static JsonAdapter<CameraSticker> JSON_ADAPTER = new ObjectJsonAdapter<CameraSticker>() { // from class: com.p1.mobile.putong.feed.data.CameraSticker.2
        ...
        public CameraSticker mo17830newInstance() {
        ...
        public boolean parseField(CameraSticker cameraSticker, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "updateTime":
                    ...
                    return true;
                case "id":
                    cameraSticker.f680id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public CameraSticker m19451clone() {
        CameraSticker cameraSticker = new CameraSticker();
        cameraSticker.f680id = this.f680id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f680id, cameraSticker.f680id) && ValueObject.util_equals(this.name, cameraSticker.name) && ValueObject.util_equals(this.icon, cameraSticker.icon) && ValueObject.util_equals(this.resource, cameraSticker.resource) && ValueObject.util_equals(this.resourceMD5, cameraSticker.resourceMD5) && ValueObject.util_equals(this.minVersion, cameraSticker.minVersion) && this.index == cameraSticker.index && this.createdTime == cameraSticker.createdTime && this.updateTime == cameraSticker.updateTime && ValueObject.util_equals(this.category, cameraSticker.category) && ValueObject.util_equals(this.extra, cameraSticker.extra);
    }
    ...
    public CameraSticker subtract(CameraSticker cameraSticker) {
        ...
        if (!ValueObject.util_equals(this.f680id, cameraSticker.f680id)) {
            cameraSticker2.f680id = this.f680id;
        }
