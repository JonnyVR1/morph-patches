...
public class Configs extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Configs> PROTOBUF_ADAPTER = new MessageNanoAdapter<Configs>() { // from class: com.p1.mobile.putong.feed.data.Configs.1
        ...
        public int computeAndCacheSize(Configs configs) {
            ...
            int iO = (str != null ? CodedOutputByteBufferNano.o(1, str) : 0) + CodedOutputByteBufferNano.h(2, configs.swipeMomentCount) + CodedOutputByteBufferNano.h(3, configs.unClickCount) + CodedOutputByteBufferNano.h(4, configs.guideShowInterval);
            String str2 = configs.gender;
            if (str2 != null) {
                iO += CodedOutputByteBufferNano.o(5, str2);
            }
            int iH = iO + CodedOutputByteBufferNano.h(6, configs.defaultEmotionIndex);
            String str3 = configs.page;
            if (str3 != null) {
                iH += CodedOutputByteBufferNano.o(7, str3);
            }
            ((MessageNano) configs).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Configs m19470parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    configs.title = nb5Var.s();
                } else if (iU == 16) {
                    configs.swipeMomentCount = nb5Var.j();
                } else if (iU == 24) {
                    configs.unClickCount = nb5Var.j();
                } else if (iU == 32) {
                    configs.guideShowInterval = nb5Var.j();
                } else if (iU == 42) {
                    configs.gender = nb5Var.s();
                } else if (iU == 48) {
                    configs.defaultEmotionIndex = nb5Var.j();
                } else {
                    if (iU != 58) {
                        if (configs.title == null) {
                            configs.title = "";
        ...
        public void serialize(Configs configs, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.G(2, configs.swipeMomentCount);
            codedOutputByteBufferNano.G(3, configs.unClickCount);
            codedOutputByteBufferNano.G(4, configs.guideShowInterval);
            String str2 = configs.gender;
            if (str2 != null) {
                codedOutputByteBufferNano.R(5, str2);
            }
            codedOutputByteBufferNano.G(6, configs.defaultEmotionIndex);
            String str3 = configs.page;
            if (str3 != null) {
    ...
    public static JsonAdapter<Configs> JSON_ADAPTER = new ObjectJsonAdapter<Configs>() { // from class: com.p1.mobile.putong.feed.data.Configs.2
        ...
        public Configs mo17830newInstance() {
            return new Configs();
        }
