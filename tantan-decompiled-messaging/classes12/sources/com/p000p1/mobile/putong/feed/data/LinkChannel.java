...
public class LinkChannel extends TEnum {
    ...
    static {
        TEnumJsonAdapter<LinkChannel> tEnumJsonAdapter = new TEnumJsonAdapter<LinkChannel>() { // from class: com.p1.mobile.putong.feed.data.LinkChannel.1
        ...
        PROTOBUF_ADAPTER = new TEnumProtobufAdapter<LinkChannel>() { // from class: com.p1.mobile.putong.feed.data.LinkChannel.2
        ...
        _LinkChannel = Collections.synchronizedMap(new e01());
    }
