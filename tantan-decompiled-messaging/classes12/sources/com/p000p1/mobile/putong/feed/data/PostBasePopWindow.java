...
import com.p000p1.mobile.putong.feed.data.ButtonInfo;
import com.p000p1.mobile.putong.feed.data.UserSimpleInfo;
...
public class PostBasePopWindow extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PostBasePopWindow> PROTOBUF_ADAPTER = new MessageNanoAdapter<PostBasePopWindow>() { // from class: com.p1.mobile.putong.feed.data.PostBasePopWindow.1
        ...
        public int computeAndCacheSize(PostBasePopWindow postBasePopWindow) {
            ...
            int iL = basicInfoComponent != null ? CodedOutputByteBufferNano.l(1, basicInfoComponent, BasicInfoComponent.PROTOBUF_ADAPTER) : 0;
            IllustrationComponent illustrationComponent = postBasePopWindow.illustration;
            if (illustrationComponent != null) {
                iL += CodedOutputByteBufferNano.l(2, illustrationComponent, IllustrationComponent.PROTOBUF_ADAPTER);
            }
            List<UserSimpleInfo> list = postBasePopWindow.users;
            if (list != null) {
                iL += CodedOutputByteBufferNano.l(3, list, UserSimpleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (inputBoxComponent != null) {
                iL += CodedOutputByteBufferNano.l(6, inputBoxComponent, InputBoxComponent.PROTOBUF_ADAPTER);
            }
            LocationComponent locationComponent = postBasePopWindow.locations;
            if (locationComponent != null) {
                iL += CodedOutputByteBufferNano.l(7, locationComponent, LocationComponent.PROTOBUF_ADAPTER);
            }
            List<ButtonInfo> list2 = postBasePopWindow.buttons;
            if (list2 != null) {
                iL += CodedOutputByteBufferNano.l(8, list2, ButtonInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            CloseWindowComponent closeWindowComponent = postBasePopWindow.close;
            if (closeWindowComponent != null) {
                iL += CodedOutputByteBufferNano.l(9, closeWindowComponent, CloseWindowComponent.PROTOBUF_ADAPTER);
            }
            OccasionComponent occasionComponent = postBasePopWindow.occasion;
            if (occasionComponent != null) {
                iL += CodedOutputByteBufferNano.l(10, occasionComponent, OccasionComponent.PROTOBUF_ADAPTER);
            }
            ((MessageNano) postBasePopWindow).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public PostBasePopWindow m19720parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        postBasePopWindow.basic = (BasicInfoComponent) nb5Var.l(BasicInfoComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 18:
                        postBasePopWindow.illustration = (IllustrationComponent) nb5Var.l(IllustrationComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        postBasePopWindow.users = (List) nb5Var.l(UserSimpleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        postBasePopWindow.title = nb5Var.s();
                        continue;
                    case 42:
                        postBasePopWindow.mainBody = nb5Var.s();
                        continue;
                    case 50:
                        postBasePopWindow.inputBox = (InputBoxComponent) nb5Var.l(InputBoxComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        postBasePopWindow.locations = (LocationComponent) nb5Var.l(LocationComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        postBasePopWindow.buttons = (List) nb5Var.l(ButtonInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        postBasePopWindow.close = (CloseWindowComponent) nb5Var.l(CloseWindowComponent.PROTOBUF_ADAPTER);
                        continue;
                    case 82:
                        postBasePopWindow.occasion = (OccasionComponent) nb5Var.l(OccasionComponent.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (postBasePopWindow.basic == null) {
                            postBasePopWindow.basic = BasicInfoComponent.new_();
        ...
        public void serialize(PostBasePopWindow postBasePopWindow, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (basicInfoComponent != null) {
                codedOutputByteBufferNano.K(1, basicInfoComponent, BasicInfoComponent.PROTOBUF_ADAPTER);
            }
            IllustrationComponent illustrationComponent = postBasePopWindow.illustration;
            if (illustrationComponent != null) {
                codedOutputByteBufferNano.K(2, illustrationComponent, IllustrationComponent.PROTOBUF_ADAPTER);
            }
            List<UserSimpleInfo> list = postBasePopWindow.users;
            if (list != null) {
                codedOutputByteBufferNano.K(3, list, UserSimpleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = postBasePopWindow.title;
            if (str != null) {
            ...
            InputBoxComponent inputBoxComponent = postBasePopWindow.inputBox;
            if (inputBoxComponent != null) {
                codedOutputByteBufferNano.K(6, inputBoxComponent, InputBoxComponent.PROTOBUF_ADAPTER);
            }
            LocationComponent locationComponent = postBasePopWindow.locations;
            if (locationComponent != null) {
                codedOutputByteBufferNano.K(7, locationComponent, LocationComponent.PROTOBUF_ADAPTER);
            }
            List<ButtonInfo> list2 = postBasePopWindow.buttons;
            if (list2 != null) {
                codedOutputByteBufferNano.K(8, list2, ButtonInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            CloseWindowComponent closeWindowComponent = postBasePopWindow.close;
            if (closeWindowComponent != null) {
                codedOutputByteBufferNano.K(9, closeWindowComponent, CloseWindowComponent.PROTOBUF_ADAPTER);
            }
            OccasionComponent occasionComponent = postBasePopWindow.occasion;
            if (occasionComponent != null) {
                codedOutputByteBufferNano.K(10, occasionComponent, OccasionComponent.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<PostBasePopWindow> JSON_ADAPTER = new ObjectJsonAdapter<PostBasePopWindow>() { // from class: com.p1.mobile.putong.feed.data.PostBasePopWindow.2
        ...
        public PostBasePopWindow mo17830newInstance() {
        ...
        public boolean parseField(PostBasePopWindow postBasePopWindow, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "locations":
                    postBasePopWindow.locations = (LocationComponent) LocationComponent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "mainBody":
                    postBasePopWindow.mainBody = jsonParser.getValueAsString();
                    return true;
                case "basic":
                    postBasePopWindow.basic = (BasicInfoComponent) BasicInfoComponent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "close":
                    postBasePopWindow.close = (CloseWindowComponent) CloseWindowComponent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "title":
                ...
                case "buttons":
                    ...
                    return true;
                case "inputBox":
                    postBasePopWindow.inputBox = (InputBoxComponent) InputBoxComponent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "occasion":
                    postBasePopWindow.occasion = (OccasionComponent) OccasionComponent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "illustration":
                    postBasePopWindow.illustration = (IllustrationComponent) IllustrationComponent.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public PostBasePopWindow m19719clone() {
        PostBasePopWindow postBasePopWindow = new PostBasePopWindow();
        BasicInfoComponent basicInfoComponent = this.basic;
        if (basicInfoComponent != null) {
            postBasePopWindow.basic = basicInfoComponent.m19427clone();
        }
        IllustrationComponent illustrationComponent = this.illustration;
        if (illustrationComponent != null) {
            postBasePopWindow.illustration = illustrationComponent.m19532clone();
        }
        List<UserSimpleInfo> list = this.users;
        if (list != null) {
            postBasePopWindow.users = ValueObject.util_map(list, new w9j() { // from class: l.hd80
                public final Object call(Object obj) {
                    return ((UserSimpleInfo) obj).m19812clone();
                }
            });
        }
        ...
        if (inputBoxComponent != null) {
            postBasePopWindow.inputBox = inputBoxComponent.m19535clone();
        }
        LocationComponent locationComponent = this.locations;
        if (locationComponent != null) {
            postBasePopWindow.locations = locationComponent.m19571clone();
        }
        List<ButtonInfo> list2 = this.buttons;
        if (list2 != null) {
            postBasePopWindow.buttons = ValueObject.util_map(list2, new w9j() { // from class: l.id80
                public final Object call(Object obj) {
                    return ((ButtonInfo) obj).m19436clone();
                }
            });
        }
        CloseWindowComponent closeWindowComponent = this.close;
        if (closeWindowComponent != null) {
            postBasePopWindow.close = closeWindowComponent.m19460clone();
        }
        OccasionComponent occasionComponent = this.occasion;
        if (occasionComponent != null) {
            postBasePopWindow.occasion = occasionComponent.m19686clone();
        }
        return postBasePopWindow;
    }
