...
public class PoiGuidePopWindow extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PoiGuidePopWindow> PROTOBUF_ADAPTER = new MessageNanoAdapter<PoiGuidePopWindow>() { // from class: com.p1.mobile.putong.feed.data.PoiGuidePopWindow.1
        ...
        public int computeAndCacheSize(PoiGuidePopWindow poiGuidePopWindow) {
            String str = poiGuidePopWindow.f700id;
            ...
            if (poiGuidePopType != null) {
                iO += CodedOutputByteBufferNano.l(5, poiGuidePopType, PoiGuidePopType.PROTOBUF_ADAPTER);
            }
            int iH = iO + CodedOutputByteBufferNano.h(6, poiGuidePopWindow.swipeLimit) + CodedOutputByteBufferNano.b(7, poiGuidePopWindow.firstTimeShow) + CodedOutputByteBufferNano.h(8, poiGuidePopWindow.intervalHours);
            List<PoiEmotionGuide> list = poiGuidePopWindow.emotionGuides;
            if (list != null) {
                iH += CodedOutputByteBufferNano.l(9, list, PoiEmotionGuide.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageLocation messageLocation = poiGuidePopWindow.location;
            if (messageLocation != null) {
                iH += CodedOutputByteBufferNano.l(10, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            String str5 = poiGuidePopWindow.desc;
            if (str5 != null) {
                iH += CodedOutputByteBufferNano.o(11, str5);
            }
            String str6 = poiGuidePopWindow.emotionId;
            if (str6 != null) {
                iH += CodedOutputByteBufferNano.o(12, str6);
            }
            String str7 = poiGuidePopWindow.userPostType;
            if (str7 != null) {
                iH += CodedOutputByteBufferNano.o(13, str7);
            }
            ((MessageNano) poiGuidePopWindow).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public PoiGuidePopWindow m19711parse(nb5 nb5Var) throws IOException {
            PoiGuidePopWindow poiGuidePopWindow = new PoiGuidePopWindow();
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        if (poiGuidePopWindow.f700id == null) {
                            poiGuidePopWindow.f700id = "";
                        }
                        ...
                        break;
                    case 10:
                        poiGuidePopWindow.f700id = nb5Var.s();
                        continue;
                    case 18:
                        poiGuidePopWindow.title = nb5Var.s();
                        continue;
                    case 26:
                        poiGuidePopWindow.subTitle = nb5Var.s();
                        continue;
                    case 34:
                        poiGuidePopWindow.icon = nb5Var.s();
                        continue;
                    case 42:
                        poiGuidePopWindow.type = (PoiGuidePopType) nb5Var.l(PoiGuidePopType.PROTOBUF_ADAPTER);
                        continue;
                    case 48:
                        poiGuidePopWindow.swipeLimit = nb5Var.j();
                        continue;
                    case 56:
                        poiGuidePopWindow.firstTimeShow = nb5Var.g();
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.BLUETOOTH_SCO /* 64 */:
                        poiGuidePopWindow.intervalHours = nb5Var.j();
                        continue;
                    case 74:
                        poiGuidePopWindow.emotionGuides = (List) nb5Var.l(PoiEmotionGuide.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 82:
                        poiGuidePopWindow.location = (MessageLocation) nb5Var.l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        poiGuidePopWindow.desc = nb5Var.s();
                        continue;
                    case 98:
                        poiGuidePopWindow.emotionId = nb5Var.s();
                        continue;
                    case 106:
                        poiGuidePopWindow.userPostType = nb5Var.s();
                        continue;
                    default:
                        if (poiGuidePopWindow.f700id == null) {
                            poiGuidePopWindow.f700id = "";
        ...
        public void serialize(PoiGuidePopWindow poiGuidePopWindow, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            PoiGuidePopType poiGuidePopType = poiGuidePopWindow.type;
            if (poiGuidePopType != null) {
                codedOutputByteBufferNano.K(5, poiGuidePopType, PoiGuidePopType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(6, poiGuidePopWindow.swipeLimit);
            codedOutputByteBufferNano.A(7, poiGuidePopWindow.firstTimeShow);
            codedOutputByteBufferNano.G(8, poiGuidePopWindow.intervalHours);
            List<PoiEmotionGuide> list = poiGuidePopWindow.emotionGuides;
            if (list != null) {
                codedOutputByteBufferNano.K(9, list, PoiEmotionGuide.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageLocation messageLocation = poiGuidePopWindow.location;
            if (messageLocation != null) {
                codedOutputByteBufferNano.K(10, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            String str5 = poiGuidePopWindow.desc;
            if (str5 != null) {
            ...
            String str7 = poiGuidePopWindow.userPostType;
            if (str7 != null) {
                codedOutputByteBufferNano.R(13, str7);
            }
        }
    };
    public static JsonAdapter<PoiGuidePopWindow> JSON_ADAPTER = new ObjectJsonAdapter<PoiGuidePopWindow>() { // from class: com.p1.mobile.putong.feed.data.PoiGuidePopWindow.2
        ...
        public PoiGuidePopWindow mo17830newInstance() {
        ...
        public boolean parseField(PoiGuidePopWindow poiGuidePopWindow, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userPostType":
                    ...
                    return true;
                case "id":
                    poiGuidePopWindow.f700id = jsonParser.getValueAsString();
                    return false;
                case "desc":
                ...
                case "icon":
                    ...
                    return true;
                case "type":
                    poiGuidePopWindow.type = (PoiGuidePopType) PoiGuidePopType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "title":
                ...
                case "swipeLimit":
                    ...
                    return true;
                case "location":
                    poiGuidePopWindow.location = (MessageLocation) MessageLocation.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "emotionId":
        ...
        public void serializeFields(PoiGuidePopWindow poiGuidePopWindow, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str5 = poiGuidePopWindow.desc;
            if (str5 != null) {
                jsonGenerator.writeStringField("desc", str5);
            }
            String str6 = poiGuidePopWindow.emotionId;
            if (str6 != null) {
    ...
    public PoiGuidePopWindow m19710clone() {
        PoiGuidePopWindow poiGuidePopWindow = new PoiGuidePopWindow();
        poiGuidePopWindow.f700id = this.f700id;
        ...
        if (list != null) {
            poiGuidePopWindow.emotionGuides = ValueObject.util_map(list, new w9j() { // from class: l.x980
                public final Object call(Object obj) {
                    return ((PoiEmotionGuide) obj).m19704clone();
                }
            });
        }
        MessageLocation messageLocation = this.location;
        if (messageLocation != null) {
            poiGuidePopWindow.location = messageLocation.m18458clone();
        }
