...
public class PushMessageIntent extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(superLike_received, int_superLike_received);
        tEnumJsonAdapter.addExtJsonValue(superLike_invite, int_superLike_invite);
        tEnumJsonAdapter.addExtJsonValue(user_status_changed, int_user_status_changed);
        tEnumJsonAdapter.addExtJsonValue(user_status_good2fake, int_user_status_good2fake);
        tEnumJsonAdapter.addExtJsonValue(user_verification_reason, int_user_verification_reason);
        tEnumJsonAdapter.addExtJsonValue(friendship_request, int_friendship_request);
        tEnumJsonAdapter.addExtJsonValue(moment_match_post, 16);
        tEnumJsonAdapter.addExtJsonValue(user_membership_changed, int_user_membership_changed);
        tEnumJsonAdapter.addExtJsonValue(followship_single, int_followship_single);
        tEnumJsonAdapter.addExtJsonValue(followship_conversation_list, int_followship_conversation_list);
        tEnumJsonAdapter.addExtJsonValue(user_state_changed, int_user_state_changed);
        tEnumJsonAdapter.addExtJsonValue(user_picture_verification, int_user_picture_verification);
        tEnumJsonAdapter.addExtJsonValue(suggested_liked, int_suggested_liked);
        tEnumJsonAdapter.addExtJsonValue(push_arrival_ab_local_push, int_push_arrival_ab_local_push);
        tEnumJsonAdapter.addExtJsonValue(home_picks, int_home_picks);
        tEnumJsonAdapter.addExtJsonValue(rev_low_price, int_rev_low_price);
        tEnumJsonAdapter.addExtJsonValue(lucky_money_received, int_lucky_money_received);
        tEnumJsonAdapter.addExtJsonValue(lucky_money_taken, int_lucky_money_taken);
        tEnumJsonAdapter.addExtJsonValue(sayHiLiked_received, int_sayHiLiked_received);
        tEnumJsonAdapter.addExtJsonValue(letter_received, int_letter_received);
        tEnumJsonAdapter.addExtJsonValue(growth_follow, int_growth_follow);
        tEnumJsonAdapter.addExtJsonValue(live_living_push, int_live_living_push);
        tEnumJsonAdapter.addExtJsonValue(conversation_single_blocked, 32);
        tEnumJsonAdapter.addExtJsonValue(friend_reminder, int_friend_reminder);
        tEnumJsonAdapter.addExtJsonValue(quickchat_match, int_quickchat_match);
        tEnumJsonAdapter.addExtJsonValue(selectedcard_received, int_selectedcard_received);
        tEnumJsonAdapter.addExtJsonValue(quickchat_broadcast, int_quickchat_broadcast);
        tEnumJsonAdapter.addExtJsonValue(live_square_push, int_live_square_push);
        tEnumJsonAdapter.addExtJsonValue(pcs_broadcast_status, int_pcs_broadcast_status);
        tEnumJsonAdapter.addExtJsonValue(soulship_agree, int_soulship_agree);
        tEnumJsonAdapter.addExtJsonValue(live_anchor_push, int_live_anchor_push);
        tEnumJsonAdapter.addExtJsonValue(shuoshuo_callback, int_shuoshuo_callback);
        tEnumJsonAdapter.addExtJsonValue(xlog_upload, int_xlog_upload);
        tEnumJsonAdapter.addExtJsonValue(promotion_platform_reload, int_promotion_platform_reload);
        tEnumJsonAdapter.addExtJsonValue(user_idcard_verification, int_user_idcard_verification);
        tEnumJsonAdapter.addExtJsonValue(call_voice_single, int_call_voice_single);
        tEnumJsonAdapter.addExtJsonValue(membership_givecoin, int_membership_givecoin);
        tEnumJsonAdapter.addExtJsonValue(chat_conversation_other_read, int_chat_conversation_other_read);
        tEnumJsonAdapter.addExtJsonValue(oms_reload, int_oms_reload);
        tEnumJsonAdapter.addExtJsonValue(call_voiceinviting_single, int_call_voiceinviting_single);
        tEnumJsonAdapter.addExtJsonValue(conversation_notify, int_conversation_notify);
        tEnumJsonAdapter.addExtJsonValue(conversation_single_self_delete, int_conversation_single_self_delete);
        tEnumJsonAdapter.addExtJsonValue(push_pay_landpage, int_push_pay_landpage);
        tEnumJsonAdapter.addExtJsonValue(conversation_group, int_conversation_group);
        tEnumJsonAdapter.addExtJsonValue(conversation_group_update, int_conversation_group_update);
        tEnumJsonAdapter.addExtJsonValue(conversation_single_update_oneside, int_conversation_single_update_oneside);
        tEnumJsonAdapter.addExtJsonValue(see_picks, int_see_picks);
        ...
        _PushMessageIntent = Collections.synchronizedMap(new e01());
    }
