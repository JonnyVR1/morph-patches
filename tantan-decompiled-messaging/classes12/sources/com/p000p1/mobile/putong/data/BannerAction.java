...
public class BannerAction extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BannerAction> PROTOBUF_ADAPTER = new MessageNanoAdapter<BannerAction>() { // from class: com.p1.mobile.putong.data.BannerAction.1
        ...
        public int computeAndCacheSize(BannerAction bannerAction) {
            ...
            int iL = (bannerFrequency != null ? CodedOutputByteBufferNano.l(1, bannerFrequency, BannerFrequency.PROTOBUF_ADAPTER) : 0) + CodedOutputByteBufferNano.h(2, bannerAction.swipe_count);
            BannerRedDot bannerRedDot = bannerAction.red_dot;
            if (bannerRedDot != null) {
                iL += CodedOutputByteBufferNano.h(3, bannerRedDot.ordinal());
            }
            BannerScroll bannerScroll = bannerAction.scroll;
            if (bannerScroll != null) {
                iL += CodedOutputByteBufferNano.l(4, bannerScroll, BannerScroll.PROTOBUF_ADAPTER);
            }
            BannerRedDot bannerRedDot2 = bannerAction.red_dot;
            if (bannerRedDot2 != null) {
                iL += CodedOutputByteBufferNano.l(5, bannerRedDot2, BannerRedDot.PROTOBUF_ADAPTER);
            }
            ((MessageNano) bannerAction).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public BannerAction m17745parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    bannerAction.frequency = (BannerFrequency) nb5Var.l(BannerFrequency.PROTOBUF_ADAPTER);
                } else if (iU == 16) {
                    bannerAction.swipe_count = nb5Var.j();
                } else if (iU == 24) {
                    numValueOf = Integer.valueOf(nb5Var.j());
                } else if (iU == 34) {
                    bannerAction.scroll = (BannerScroll) nb5Var.l(BannerScroll.PROTOBUF_ADAPTER);
                } else {
                    if (iU != 42) {
                        if (bannerAction.red_dot == null && numValueOf != null) {
                            bannerAction.red_dot = (BannerRedDot) BannerRedDot.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    bannerAction.red_dot = (BannerRedDot) nb5Var.l(BannerRedDot.PROTOBUF_ADAPTER);
                }
            }
            return bannerAction;
        }
        ...
        public void serialize(BannerAction bannerAction, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (bannerFrequency != null) {
                codedOutputByteBufferNano.K(1, bannerFrequency, BannerFrequency.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(2, bannerAction.swipe_count);
            BannerRedDot bannerRedDot = bannerAction.red_dot;
            if (bannerRedDot != null) {
                codedOutputByteBufferNano.G(3, bannerRedDot.ordinal());
            }
            BannerScroll bannerScroll = bannerAction.scroll;
            if (bannerScroll != null) {
                codedOutputByteBufferNano.K(4, bannerScroll, BannerScroll.PROTOBUF_ADAPTER);
            }
            BannerRedDot bannerRedDot2 = bannerAction.red_dot;
            if (bannerRedDot2 != null) {
                codedOutputByteBufferNano.K(5, bannerRedDot2, BannerRedDot.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<BannerAction> JSON_ADAPTER = new ObjectJsonAdapter<BannerAction>() { // from class: com.p1.mobile.putong.data.BannerAction.2
        ...
        public BannerAction mo17830newInstance() {
        ...
        public boolean parseField(BannerAction bannerAction, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "scroll":
                    bannerAction.scroll = (BannerScroll) BannerScroll.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "frequency":
                    bannerAction.frequency = (BannerFrequency) BannerFrequency.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "swipe_count":
                    bannerAction.swipe_count = jsonParser.getValueAsInt();
                    return true;
                case "red_dot":
                    bannerAction.red_dot = (BannerRedDot) BannerRedDot.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                default:
                    return false;
            }
