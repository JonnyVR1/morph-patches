...
public class UserStatus extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_CHAT_MESSAGE_SAFETY_REMINDER, int_RISK_TAG_CHAT_MESSAGE_SAFETY_REMINDER);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_CHAT_SENSITIVE_WORD_SAFETY_REMINDER, int_RISK_TAG_CHAT_SENSITIVE_WORD_SAFETY_REMINDER);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_DANGEROUS_USER_SAFETY_REMINDER, int_RISK_TAG_DANGEROUS_USER_SAFETY_REMINDER);
        tEnumJsonAdapter.addExtJsonValue(customer_service_account, int_customer_service_account);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_UNREAL, int_RISK_TAG_UNREAL);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_VIOLATION, int_RISK_TAG_VIOLATION);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_FAKE_GENDER, 16);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_FAKE_YOUNGER_AGE, int_RISK_TAG_FAKE_YOUNGER_AGE);
        tEnumJsonAdapter.addExtJsonValue(RISK_TAG_CHAT_PROFILE_PICTURE_HIDDEN, int_RISK_TAG_CHAT_PROFILE_PICTURE_HIDDEN);
        ...
        _UserStatus = Collections.synchronizedMap(new e01());
    }
