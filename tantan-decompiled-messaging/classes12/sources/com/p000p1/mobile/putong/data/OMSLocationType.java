...
public class OMSLocationType extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(r_below, int_r_below);
        tEnumJsonAdapter.addExtJsonValue(r_align_baseline, int_r_align_baseline);
        tEnumJsonAdapter.addExtJsonValue(r_align_left, int_r_align_left);
        tEnumJsonAdapter.addExtJsonValue(r_align_right, int_r_align_right);
        tEnumJsonAdapter.addExtJsonValue(r_align_top, int_r_align_top);
        tEnumJsonAdapter.addExtJsonValue(r_align_bottom, int_r_align_bottom);
        tEnumJsonAdapter.addExtJsonValue(r_align_parent_left, 16);
        tEnumJsonAdapter.addExtJsonValue(r_align_parent_top, int_r_align_parent_top);
        tEnumJsonAdapter.addExtJsonValue(r_align_parent_right, int_r_align_parent_right);
        tEnumJsonAdapter.addExtJsonValue(r_align_parent_bottom, int_r_align_parent_bottom);
        tEnumJsonAdapter.addExtJsonValue(r_center_in_parent, int_r_center_in_parent);
        tEnumJsonAdapter.addExtJsonValue(r_center_vertical, int_r_center_vertical);
        tEnumJsonAdapter.addExtJsonValue(r_center_horizontal, int_r_center_horizontal);
        tEnumJsonAdapter.addExtJsonValue(r_start_of, int_r_start_of);
        tEnumJsonAdapter.addExtJsonValue(r_end_of, int_r_end_of);
        tEnumJsonAdapter.addExtJsonValue(r_align_start, int_r_align_start);
        tEnumJsonAdapter.addExtJsonValue(r_align_end, int_r_align_end);
        tEnumJsonAdapter.addExtJsonValue(r_align_parent_start, int_r_align_parent_start);
        tEnumJsonAdapter.addExtJsonValue(r_align_parent_end, int_r_align_parent_end);
