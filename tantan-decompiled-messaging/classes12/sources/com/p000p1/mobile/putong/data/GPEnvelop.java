...
public class GPEnvelop extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GPEnvelop> PROTOBUF_ADAPTER = new MessageNanoAdapter<GPEnvelop>() { // from class: com.p1.mobile.putong.data.GPEnvelop.1
        ...
        public int computeAndCacheSize(GPEnvelop gPEnvelop) {
            ...
            if (gPData != null) {
                iL += CodedOutputByteBufferNano.l(2, gPData, GPData.PROTOBUF_ADAPTER);
            }
            ((MessageNano) gPEnvelop).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public GPEnvelop m18148parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    gPEnvelop.meta = (Meta) nb5Var.l(Meta.PROTOBUF_ADAPTER);
                } else {
                    if (iU != 18) {
                        if (gPEnvelop.meta == null) {
                            gPEnvelop.meta = Meta.new_();
                    ...
                    gPEnvelop.data = (GPData) nb5Var.l(GPData.PROTOBUF_ADAPTER);
                }
            }
            return gPEnvelop;
        }
        ...
        public void serialize(GPEnvelop gPEnvelop, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            GPData gPData = gPEnvelop.data;
            if (gPData != null) {
                codedOutputByteBufferNano.K(2, gPData, GPData.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<GPEnvelop> JSON_ADAPTER = new ObjectJsonAdapter<GPEnvelop>() { // from class: com.p1.mobile.putong.data.GPEnvelop.2
        ...
        public GPEnvelop mo17830newInstance() {
        ...
        public boolean parseField(GPEnvelop gPEnvelop, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            if (str.equals(Data.TYPE)) {
                gPEnvelop.data = (GPData) GPData.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                return true;
            }
            if (!str.equals(Meta.TYPE)) {
                return false;
            }
            gPEnvelop.meta = (Meta) Meta.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
            return true;
        }
    ...
    public GPEnvelop m18147clone() {
        GPEnvelop gPEnvelop = new GPEnvelop();
        Meta meta = this.meta;
        if (meta != null) {
            gPEnvelop.meta = meta.m18461clone();
        }
        GPData gPData = this.data;
        if (gPData != null) {
            gPEnvelop.data = gPData.m18144clone();
        }
        return gPEnvelop;
    }
