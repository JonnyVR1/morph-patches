...
public class Emotion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Emotion> PROTOBUF_ADAPTER = new MessageNanoAdapter<Emotion>() { // from class: com.p1.mobile.putong.data.Emotion.1
        ...
        public int computeAndCacheSize(Emotion emotion) {
            ...
            if (list3 != null) {
                iO += CodedOutputByteBufferNano.l(8, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (str8 != null) {
                iO += CodedOutputByteBufferNano.o(11, str8);
            }
            String str9 = emotion.defaultDoc;
            if (str9 != null) {
                iO += CodedOutputByteBufferNano.o(12, str9);
            }
            ((MessageNano) emotion).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Emotion m18019parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        emotion.emoji = nb5Var.s();
                        continue;
                    case 18:
                        emotion.text = nb5Var.s();
                        continue;
                    case 26:
                        emotion.emojiUrl = nb5Var.s();
                        continue;
                    case 34:
                        emotion.f209id = nb5Var.s();
                        continue;
                    case 42:
                        emotion.backgroundColor = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        emotion.iconColor = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        emotion.userId = nb5Var.s();
                        continue;
                    case 66:
                        emotion.userAvatars = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        emotion.topicId = nb5Var.s();
                        continue;
                    case 82:
                        emotion.topicName = nb5Var.s();
                        continue;
                    case 90:
                        emotion.liveId = nb5Var.s();
                        continue;
                    case 98:
                        emotion.defaultDoc = nb5Var.s();
                        continue;
                    default:
                        if (emotion.emoji == null) {
                            emotion.emoji = "";
    ...
    public static JsonAdapter<Emotion> JSON_ADAPTER = new ObjectJsonAdapter<Emotion>() { // from class: com.p1.mobile.putong.data.Emotion.2
        ...
        public Emotion mo17830newInstance() {
            return new Emotion();
        }
        ...
        public boolean parseField(Emotion emotion, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userId":
                    ...
                    return true;
                case "id":
                    emotion.f209id = jsonParser.getValueAsString();
                    return false;
                case "text":
    ...
    public static /* synthetic */ String m675a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m676b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m677c(String str) {
        return str;
    }
    ...
    public Emotion m18018clone() {
        ...
        if (list2 != null) {
            emotion.iconColor = ValueObject.util_map(list2, new w9j() { // from class: l.mye
                public final Object call(Object obj) {
                    return Emotion.m676b((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            emotion.userAvatars = ValueObject.util_map(list3, new w9j() { // from class: l.nye
                public final Object call(Object obj) {
                    return Emotion.m677c((String) obj);
                }
            });
        }
