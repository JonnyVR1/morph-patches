...
import com.p000p1.mobile.putong.data.FriendComment;
import com.p000p1.mobile.putong.data.InterestUserSimple;
...
public class FriendCommentInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FriendCommentInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<FriendCommentInfo>() { // from class: com.p1.mobile.putong.data.FriendCommentInfo.1
        ...
        public int computeAndCacheSize(FriendCommentInfo friendCommentInfo) {
            ...
            int iO = (str != null ? CodedOutputByteBufferNano.o(1, str) : 0) + CodedOutputByteBufferNano.h(2, friendCommentInfo.interestsCount) + CodedOutputByteBufferNano.b(3, friendCommentInfo.alreadyInterested);
            List<FriendComment> list = friendCommentInfo.friendsComments;
            if (list != null) {
                iO += CodedOutputByteBufferNano.l(4, list, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<InterestUserSimple> list2 = friendCommentInfo.interestedUsers;
            if (list2 != null) {
                iO += CodedOutputByteBufferNano.l(5, list2, InterestUserSimple.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iH = iO + CodedOutputByteBufferNano.h(6, friendCommentInfo.commentsCount);
            List<FriendComment> list3 = friendCommentInfo.friendsCommentsHistory;
            if (list3 != null) {
                iH += CodedOutputByteBufferNano.l(7, list3, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UnreadCounter unreadCounter = friendCommentInfo.unreadCounter;
            if (unreadCounter != null) {
                iH += CodedOutputByteBufferNano.l(8, unreadCounter, UnreadCounter.PROTOBUF_ADAPTER);
            }
            ((MessageNano) friendCommentInfo).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public FriendCommentInfo m18124parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    friendCommentInfo.userId = nb5Var.s();
                } else if (iU == 16) {
                    friendCommentInfo.interestsCount = nb5Var.j();
                } else if (iU == 24) {
                    friendCommentInfo.alreadyInterested = nb5Var.g();
                } else if (iU == 34) {
                    friendCommentInfo.friendsComments = (List) nb5Var.l(FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 42) {
                    friendCommentInfo.interestedUsers = (List) nb5Var.l(InterestUserSimple.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 48) {
                    friendCommentInfo.commentsCount = nb5Var.j();
                } else if (iU == 58) {
                    friendCommentInfo.friendsCommentsHistory = (List) nb5Var.l(FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iU != 66) {
                        if (friendCommentInfo.userId == null) {
                            friendCommentInfo.userId = "";
                    ...
                    friendCommentInfo.unreadCounter = (UnreadCounter) nb5Var.l(UnreadCounter.PROTOBUF_ADAPTER);
                }
            }
            return friendCommentInfo;
        }
        ...
        public void serialize(FriendCommentInfo friendCommentInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.G(2, friendCommentInfo.interestsCount);
            codedOutputByteBufferNano.A(3, friendCommentInfo.alreadyInterested);
            List<FriendComment> list = friendCommentInfo.friendsComments;
            if (list != null) {
                codedOutputByteBufferNano.K(4, list, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<InterestUserSimple> list2 = friendCommentInfo.interestedUsers;
            if (list2 != null) {
                codedOutputByteBufferNano.K(5, list2, InterestUserSimple.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.G(6, friendCommentInfo.commentsCount);
            List<FriendComment> list3 = friendCommentInfo.friendsCommentsHistory;
            if (list3 != null) {
                codedOutputByteBufferNano.K(7, list3, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UnreadCounter unreadCounter = friendCommentInfo.unreadCounter;
            if (unreadCounter != null) {
                codedOutputByteBufferNano.K(8, unreadCounter, UnreadCounter.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<FriendCommentInfo> JSON_ADAPTER = new ObjectJsonAdapter<FriendCommentInfo>() { // from class: com.p1.mobile.putong.data.FriendCommentInfo.2
        ...
        public FriendCommentInfo mo17830newInstance() {
        ...
        public boolean parseField(FriendCommentInfo friendCommentInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "friendsComments":
                    ...
                    return true;
                case "unreadCounter":
                    friendCommentInfo.unreadCounter = (UnreadCounter) UnreadCounter.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public FriendCommentInfo m18123clone() {
        FriendCommentInfo friendCommentInfo = new FriendCommentInfo();
        ...
        if (list != null) {
            friendCommentInfo.friendsComments = ValueObject.util_map(list, new w9j() { // from class: l.q6j
                public final Object call(Object obj) {
                    return ((FriendComment) obj).m18120clone();
                }
            });
        }
        ...
        if (list2 != null) {
            friendCommentInfo.interestedUsers = ValueObject.util_map(list2, new w9j() { // from class: l.r6j
                public final Object call(Object obj) {
                    return ((InterestUserSimple) obj).m18225clone();
                }
            });
        }
        ...
        if (unreadCounter != null) {
            friendCommentInfo.unreadCounter = unreadCounter.m19138clone();
        }
        return friendCommentInfo;
    }
