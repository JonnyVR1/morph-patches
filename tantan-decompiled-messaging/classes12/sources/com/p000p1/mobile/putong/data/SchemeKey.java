...
public class SchemeKey extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue("profile", int_profile);
        tEnumJsonAdapter.addExtJsonValue("moment", int_moment);
        tEnumJsonAdapter.addExtJsonValue("vip", int_vip);
        tEnumJsonAdapter.addExtJsonValue(switchaccount, int_switchaccount);
        tEnumJsonAdapter.addExtJsonValue(creditscore, int_creditscore);
        tEnumJsonAdapter.addExtJsonValue("see", int_see);
        tEnumJsonAdapter.addExtJsonValue(vipPurchase, 16);
        tEnumJsonAdapter.addExtJsonValue(seePurchase, int_seePurchase);
        tEnumJsonAdapter.addExtJsonValue(boostPurchase, int_boostPurchase);
        tEnumJsonAdapter.addExtJsonValue(superLikePurchase, int_superLikePurchase);
        tEnumJsonAdapter.addExtJsonValue(liveCover, int_liveCover);
        tEnumJsonAdapter.addExtJsonValue(liveSquare, int_liveSquare);
        tEnumJsonAdapter.addExtJsonValue(verificationcenter, int_verificationcenter);
        tEnumJsonAdapter.addExtJsonValue("liveAnchor", int_liveAnchor);
        tEnumJsonAdapter.addExtJsonValue("likers", int_likers);
        tEnumJsonAdapter.addExtJsonValue("seeLikes", int_seeLikes);
        tEnumJsonAdapter.addExtJsonValue("mytantan", int_mytantan);
        tEnumJsonAdapter.addExtJsonValue("userCard", int_userCard);
        tEnumJsonAdapter.addExtJsonValue(push_call2buysee, int_push_call2buysee);
        tEnumJsonAdapter.addExtJsonValue(push_call2buysee_side_new, int_push_call2buysee_side_new);
        tEnumJsonAdapter.addExtJsonValue(user_voices, int_user_voices);
        tEnumJsonAdapter.addExtJsonValue(local_message, int_local_message);
        tEnumJsonAdapter.addExtJsonValue("chat", 32);
        tEnumJsonAdapter.addExtJsonValue(quickChatPurchase, int_quickChatPurchase);
        tEnumJsonAdapter.addExtJsonValue("freeTrialPromotion", int_freeTrialPromotion);
        tEnumJsonAdapter.addExtJsonValue("introPromotion", int_introPromotion);
        tEnumJsonAdapter.addExtJsonValue(vipPlusSeePurchase, int_vipPlusSeePurchase);
        tEnumJsonAdapter.addExtJsonValue(promotion, int_promotion);
        tEnumJsonAdapter.addExtJsonValue("survey", int_survey);
        tEnumJsonAdapter.addExtJsonValue(svipPurchase, int_svipPurchase);
        tEnumJsonAdapter.addExtJsonValue(helpcenter, int_helpcenter);
        tEnumJsonAdapter.addExtJsonValue("setting_chooselocation", int_setting_chooselocation);
        tEnumJsonAdapter.addExtJsonValue(newMoment, int_newMoment);
        tEnumJsonAdapter.addExtJsonValue(topic_webview, int_topic_webview);
        tEnumJsonAdapter.addExtJsonValue(h5pay, int_h5pay);
        tEnumJsonAdapter.addExtJsonValue(webview_for_coda, int_webview_for_coda);
        tEnumJsonAdapter.addExtJsonValue(oms, int_oms);
        tEnumJsonAdapter.addExtJsonValue(zhimaGoFailure, int_zhimaGoFailure);
        tEnumJsonAdapter.addExtJsonValue(subscriptions, int_subscriptions);
        tEnumJsonAdapter.addExtJsonValue(ban_appeal, int_ban_appeal);
        tEnumJsonAdapter.addExtJsonValue("wallet", int_wallet);
        tEnumJsonAdapter.addExtJsonValue("live", int_live);
        tEnumJsonAdapter.addExtJsonValue("svip", int_svip);
        tEnumJsonAdapter.addExtJsonValue("startVoiceLive", int_startVoiceLive);
        tEnumJsonAdapter.addExtJsonValue("user", int_user);
        tEnumJsonAdapter.addExtJsonValue("friend", int_friend);
        tEnumJsonAdapter.addExtJsonValue(livePrivacy, int_livePrivacy);
        tEnumJsonAdapter.addExtJsonValue(liveRight, int_liveRight);
        tEnumJsonAdapter.addExtJsonValue(topic, int_topic);
        tEnumJsonAdapter.addExtJsonValue(profileEdit, int_profileEdit);
        tEnumJsonAdapter.addExtJsonValue(realpicVerify, int_realpicVerify);
        tEnumJsonAdapter.addExtJsonValue(actualnameVerify, int_actualnameVerify);
        tEnumJsonAdapter.addExtJsonValue(coPay, int_coPay);
        tEnumJsonAdapter.addExtJsonValue(fake2good, int_fake2good);
        tEnumJsonAdapter.addExtJsonValue(newmytantan_call2buysee, 64);
        tEnumJsonAdapter.addExtJsonValue(voiceChatRoom, int_voiceChatRoom);
        tEnumJsonAdapter.addExtJsonValue(liveUserProfile, int_liveUserProfile);
        tEnumJsonAdapter.addExtJsonValue(enterVoiceRoom, int_enterVoiceRoom);
        tEnumJsonAdapter.addExtJsonValue(join_group, int_join_group);
        tEnumJsonAdapter.addExtJsonValue(liveSetting, int_liveSetting);
        tEnumJsonAdapter.addExtJsonValue("group", int_group);
        tEnumJsonAdapter.addExtJsonValue(zendesk, int_zendesk);
        tEnumJsonAdapter.addExtJsonValue(officialChannel, int_officialChannel);
        tEnumJsonAdapter.addExtJsonValue(jumpToVoiceFrame, int_jumpToVoiceFrame);
        ...
        tEnumJsonAdapter.addExtJsonValue(enterSuggestVoiceRoom, int_enterSuggestVoiceRoom);
        tEnumJsonAdapter.addExtJsonValue(omsDialog, int_omsDialog);
        tEnumJsonAdapter.addExtJsonValue("seePicks", int_seePicks);
        tEnumJsonAdapter.addExtJsonValue(soulmate_home, int_soulmate_home);
        tEnumJsonAdapter.addExtJsonValue(soulmate_question, int_soulmate_question);
        ...
        _SchemeKey = Collections.synchronizedMap(new e01());
    }
