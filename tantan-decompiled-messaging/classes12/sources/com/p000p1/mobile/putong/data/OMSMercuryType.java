...
public class OMSMercuryType extends TEnum {
    ...
    public static final String f252mc = "mc";

    /* JADX INFO: renamed from: mv */
    public static final String f253mv = "mv";

    /* JADX INFO: renamed from: pv */
    public static final String f254pv = "pv";
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(f254pv, 0);
        tEnumJsonAdapter.addExtJsonValue(f252mc, 1);
        tEnumJsonAdapter.addExtJsonValue(f253mv, 2);
        supportEnum.add(f254pv);
        supportEnum.add(f252mc);
        supportEnum.add(f253mv);
