...
public class SettingGroups extends ValueObject<SettingGroups> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SettingGroups> PROTOBUF_ADAPTER = new MessageNanoAdapter<SettingGroups>() { // from class: com.p1.mobile.putong.data.SettingGroups.1
        ...
        public int computeAndCacheSize(SettingGroups settingGroups) {
            ...
            if (userBoostSettings != null) {
                iO += CodedOutputByteBufferNano.l(2, userBoostSettings, UserBoostSettings.PROTOBUF_ADAPTER);
            }
            UserLiveSettings userLiveSettings = settingGroups.live;
            if (userLiveSettings != null) {
                iO += CodedOutputByteBufferNano.l(3, userLiveSettings, UserLiveSettings.PROTOBUF_ADAPTER);
            }
            UserPrivacySettings userPrivacySettings = settingGroups.privacy;
            if (userPrivacySettings != null) {
                iO += CodedOutputByteBufferNano.l(4, userPrivacySettings, UserPrivacySettings.PROTOBUF_ADAPTER);
            }
            UserPushSettings userPushSettings = settingGroups.push;
            if (userPushSettings != null) {
                iO += CodedOutputByteBufferNano.l(5, userPushSettings, UserPushSettings.PROTOBUF_ADAPTER);
            }
            UserSearchSettings userSearchSettings = settingGroups.search;
            if (userSearchSettings != null) {
                iO += CodedOutputByteBufferNano.l(6, userSearchSettings, UserSearchSettings.PROTOBUF_ADAPTER);
            }
            UserSubscriptionSettings userSubscriptionSettings = settingGroups.subscription;
            if (userSubscriptionSettings != null) {
                iO += CodedOutputByteBufferNano.l(7, userSubscriptionSettings, UserSubscriptionSettings.PROTOBUF_ADAPTER);
            }
            UserFakeSettings userFakeSettings = settingGroups.fake;
            if (userFakeSettings != null) {
                iO += CodedOutputByteBufferNano.l(8, userFakeSettings, UserFakeSettings.PROTOBUF_ADAPTER);
            }
            UserSVIPSettings userSVIPSettings = settingGroups.svip;
            if (userSVIPSettings != null) {
                iO += CodedOutputByteBufferNano.l(9, userSVIPSettings, UserSVIPSettings.PROTOBUF_ADAPTER);
            }
            SvipPrivacySettings svipPrivacySettings = settingGroups.svipPrivacy;
            if (svipPrivacySettings != null) {
                iO += CodedOutputByteBufferNano.l(10, svipPrivacySettings, SvipPrivacySettings.PROTOBUF_ADAPTER);
            }
            SeeSettings seeSettings = settingGroups.see;
            if (seeSettings != null) {
                iO += CodedOutputByteBufferNano.l(11, seeSettings, SeeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = settingGroups.diamondVIP;
            if (diamondVIPPrivilegeSettings != null) {
                iO += CodedOutputByteBufferNano.l(12, diamondVIPPrivilegeSettings, DiamondVIPPrivilegeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivateMatch diamondVIPPrivateMatch = settingGroups.diamondVIPPrivateMatch;
            if (diamondVIPPrivateMatch != null) {
                iO += CodedOutputByteBufferNano.l(13, diamondVIPPrivateMatch, DiamondVIPPrivateMatch.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting = settingGroups.soulchat;
            if (chatSetting != null) {
                iO += CodedOutputByteBufferNano.l(14, chatSetting, ChatSetting.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting2 = settingGroups.quickchatchat;
            if (chatSetting2 != null) {
                iO += CodedOutputByteBufferNano.l(15, chatSetting2, ChatSetting.PROTOBUF_ADAPTER);
            }
            SoulMatchGroup soulMatchGroup = settingGroups.soulmate;
            if (soulMatchGroup != null) {
                iO += CodedOutputByteBufferNano.l(16, soulMatchGroup, SoulMatchGroup.PROTOBUF_ADAPTER);
            }
            ShareSetting shareSetting = settingGroups.share;
            if (shareSetting != null) {
                iO += CodedOutputByteBufferNano.l(17, shareSetting, ShareSetting.PROTOBUF_ADAPTER);
            }
            DecorationSettings decorationSettings = settingGroups.decoration;
            if (decorationSettings != null) {
                iO += CodedOutputByteBufferNano.l(18, decorationSettings, DecorationSettings.PROTOBUF_ADAPTER);
            }
            ComDiamond comDiamond = settingGroups.comDiamond;
            if (comDiamond != null) {
                iO += CodedOutputByteBufferNano.l(19, comDiamond, ComDiamond.PROTOBUF_ADAPTER);
            }
            CharacterEvaluate characterEvaluate = settingGroups.characterEvaluate;
            if (characterEvaluate != null) {
                iO += CodedOutputByteBufferNano.l(20, characterEvaluate, CharacterEvaluate.PROTOBUF_ADAPTER);
            }
            Pet pet = settingGroups.pet;
            if (pet != null) {
                iO += CodedOutputByteBufferNano.l(21, pet, Pet.PROTOBUF_ADAPTER);
            }
            MomentLevel momentLevel = settingGroups.momentLevel;
            if (momentLevel != null) {
                iO += CodedOutputByteBufferNano.l(22, momentLevel, MomentLevel.PROTOBUF_ADAPTER);
            }
            VipSearchSettings vipSearchSettings = settingGroups.vipSearch;
            if (vipSearchSettings != null) {
                iO += CodedOutputByteBufferNano.l(23, vipSearchSettings, VipSearchSettings.PROTOBUF_ADAPTER);
            }
            UserMomentSettings userMomentSettings = settingGroups.moment;
            if (userMomentSettings != null) {
                iO += CodedOutputByteBufferNano.l(24, userMomentSettings, UserMomentSettings.PROTOBUF_ADAPTER);
            }
            SettingGroupsProfile settingGroupsProfile = settingGroups.profile;
            if (settingGroupsProfile != null) {
                iO += CodedOutputByteBufferNano.l(25, settingGroupsProfile, SettingGroupsProfile.PROTOBUF_ADAPTER);
            }
            PlatinumSettings platinumSettings = settingGroups.pvip;
            if (platinumSettings != null) {
                iO += CodedOutputByteBufferNano.l(26, platinumSettings, PlatinumSettings.PROTOBUF_ADAPTER);
            }
            MarrySettings marrySettings = settingGroups.marriage;
            if (marrySettings != null) {
                iO += CodedOutputByteBufferNano.l(27, marrySettings, MarrySettings.PROTOBUF_ADAPTER);
            }
            CityC cityC = settingGroups.cityC;
            if (cityC != null) {
                iO += CodedOutputByteBufferNano.l(28, cityC, CityC.PROTOBUF_ADAPTER);
            }
            SpVip spVip = settingGroups.spvip;
            if (spVip != null) {
                iO += CodedOutputByteBufferNano.l(29, spVip, SpVip.PROTOBUF_ADAPTER);
            }
            GrowthSettings growthSettings = settingGroups.growth;
            if (growthSettings != null) {
                iO += CodedOutputByteBufferNano.l(30, growthSettings, GrowthSettings.PROTOBUF_ADAPTER);
            }
            FemaleVip femaleVip = settingGroups.fvip;
            if (femaleVip != null) {
                iO += CodedOutputByteBufferNano.l(31, femaleVip, FemaleVip.PROTOBUF_ADAPTER);
            }
            SvipSearch svipSearch = settingGroups.svipSearch;
            if (svipSearch != null) {
                iO += CodedOutputByteBufferNano.l(32, svipSearch, SvipSearch.PROTOBUF_ADAPTER);
            }
            NotificationSetting notificationSetting = settingGroups.noPush;
            if (notificationSetting != null) {
                iO += CodedOutputByteBufferNano.l(33, notificationSetting, NotificationSetting.PROTOBUF_ADAPTER);
            }
            UserUpVipSettings userUpVipSettings = settingGroups.upvip;
            if (userUpVipSettings != null) {
                iO += CodedOutputByteBufferNano.l(34, userUpVipSettings, UserUpVipSettings.PROTOBUF_ADAPTER);
            }
            AdsMaterialRouter adsMaterialRouter = settingGroups.adsMaterialRouter;
            if (adsMaterialRouter != null) {
                iO += CodedOutputByteBufferNano.l(35, adsMaterialRouter, AdsMaterialRouter.PROTOBUF_ADAPTER);
            }
            IntlMoreGender intlMoreGender = settingGroups.gender;
            if (intlMoreGender != null) {
                iO += CodedOutputByteBufferNano.l(36, intlMoreGender, IntlMoreGender.PROTOBUF_ADAPTER);
            }
            TribeSetting tribeSetting = settingGroups.tttribe;
            if (tribeSetting != null) {
                iO += CodedOutputByteBufferNano.l(37, tribeSetting, TribeSetting.PROTOBUF_ADAPTER);
            }
            ((MessageNano) settingGroups).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public SettingGroups m18947parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        settingGroups.type = nb5Var.s();
                        continue;
                    case 18:
                        settingGroups.boost = (UserBoostSettings) nb5Var.l(UserBoostSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        settingGroups.live = (UserLiveSettings) nb5Var.l(UserLiveSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        settingGroups.privacy = (UserPrivacySettings) nb5Var.l(UserPrivacySettings.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        settingGroups.push = (UserPushSettings) nb5Var.l(UserPushSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        settingGroups.search = (UserSearchSettings) nb5Var.l(UserSearchSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        settingGroups.subscription = (UserSubscriptionSettings) nb5Var.l(UserSubscriptionSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        settingGroups.fake = (UserFakeSettings) nb5Var.l(UserFakeSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        settingGroups.svip = (UserSVIPSettings) nb5Var.l(UserSVIPSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 82:
                        settingGroups.svipPrivacy = (SvipPrivacySettings) nb5Var.l(SvipPrivacySettings.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        settingGroups.see = (SeeSettings) nb5Var.l(SeeSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 98:
                        settingGroups.diamondVIP = (DiamondVIPPrivilegeSettings) nb5Var.l(DiamondVIPPrivilegeSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        settingGroups.diamondVIPPrivateMatch = (DiamondVIPPrivateMatch) nb5Var.l(DiamondVIPPrivateMatch.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        settingGroups.soulchat = (ChatSetting) nb5Var.l(ChatSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        settingGroups.quickchatchat = (ChatSetting) nb5Var.l(ChatSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        settingGroups.soulmate = (SoulMatchGroup) nb5Var.l(SoulMatchGroup.PROTOBUF_ADAPTER);
                        continue;
                    case 138:
                        settingGroups.share = (ShareSetting) nb5Var.l(ShareSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 146:
                        settingGroups.decoration = (DecorationSettings) nb5Var.l(DecorationSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        settingGroups.comDiamond = (ComDiamond) nb5Var.l(ComDiamond.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        settingGroups.characterEvaluate = (CharacterEvaluate) nb5Var.l(CharacterEvaluate.PROTOBUF_ADAPTER);
                        continue;
                    case 170:
                        settingGroups.pet = (Pet) nb5Var.l(Pet.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        settingGroups.momentLevel = (MomentLevel) nb5Var.l(MomentLevel.PROTOBUF_ADAPTER);
                        continue;
                    case 186:
                        settingGroups.vipSearch = (VipSearchSettings) nb5Var.l(VipSearchSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 194:
                        settingGroups.moment = (UserMomentSettings) nb5Var.l(UserMomentSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 202:
                        settingGroups.profile = (SettingGroupsProfile) nb5Var.l(SettingGroupsProfile.PROTOBUF_ADAPTER);
                        continue;
                    case 210:
                        settingGroups.pvip = (PlatinumSettings) nb5Var.l(PlatinumSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 218:
                        settingGroups.marriage = (MarrySettings) nb5Var.l(MarrySettings.PROTOBUF_ADAPTER);
                        continue;
                    case 226:
                        settingGroups.cityC = (CityC) nb5Var.l(CityC.PROTOBUF_ADAPTER);
                        continue;
                    case 234:
                        settingGroups.spvip = (SpVip) nb5Var.l(SpVip.PROTOBUF_ADAPTER);
                        continue;
                    case 242:
                        settingGroups.growth = (GrowthSettings) nb5Var.l(GrowthSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 250:
                        settingGroups.fvip = (FemaleVip) nb5Var.l(FemaleVip.PROTOBUF_ADAPTER);
                        continue;
                    case 258:
                        settingGroups.svipSearch = (SvipSearch) nb5Var.l(SvipSearch.PROTOBUF_ADAPTER);
                        continue;
                    case 266:
                        settingGroups.noPush = (NotificationSetting) nb5Var.l(NotificationSetting.PROTOBUF_ADAPTER);
                        continue;
                    case 274:
                        settingGroups.upvip = (UserUpVipSettings) nb5Var.l(UserUpVipSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 282:
                        settingGroups.adsMaterialRouter = (AdsMaterialRouter) nb5Var.l(AdsMaterialRouter.PROTOBUF_ADAPTER);
                        continue;
                    case 290:
                        settingGroups.gender = (IntlMoreGender) nb5Var.l(IntlMoreGender.PROTOBUF_ADAPTER);
                        continue;
                    case 298:
                        settingGroups.tttribe = (TribeSetting) nb5Var.l(TribeSetting.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (settingGroups.boost == null) {
                            settingGroups.boost = UserBoostSettings.new_();
        ...
        public void serialize(SettingGroups settingGroups, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            UserBoostSettings userBoostSettings = settingGroups.boost;
            if (userBoostSettings != null) {
                codedOutputByteBufferNano.K(2, userBoostSettings, UserBoostSettings.PROTOBUF_ADAPTER);
            }
            UserLiveSettings userLiveSettings = settingGroups.live;
            if (userLiveSettings != null) {
                codedOutputByteBufferNano.K(3, userLiveSettings, UserLiveSettings.PROTOBUF_ADAPTER);
            }
            UserPrivacySettings userPrivacySettings = settingGroups.privacy;
            if (userPrivacySettings != null) {
                codedOutputByteBufferNano.K(4, userPrivacySettings, UserPrivacySettings.PROTOBUF_ADAPTER);
            }
            UserPushSettings userPushSettings = settingGroups.push;
            if (userPushSettings != null) {
                codedOutputByteBufferNano.K(5, userPushSettings, UserPushSettings.PROTOBUF_ADAPTER);
            }
            UserSearchSettings userSearchSettings = settingGroups.search;
            if (userSearchSettings != null) {
                codedOutputByteBufferNano.K(6, userSearchSettings, UserSearchSettings.PROTOBUF_ADAPTER);
            }
            UserSubscriptionSettings userSubscriptionSettings = settingGroups.subscription;
            if (userSubscriptionSettings != null) {
                codedOutputByteBufferNano.K(7, userSubscriptionSettings, UserSubscriptionSettings.PROTOBUF_ADAPTER);
            }
            UserFakeSettings userFakeSettings = settingGroups.fake;
            if (userFakeSettings != null) {
                codedOutputByteBufferNano.K(8, userFakeSettings, UserFakeSettings.PROTOBUF_ADAPTER);
            }
            UserSVIPSettings userSVIPSettings = settingGroups.svip;
            if (userSVIPSettings != null) {
                codedOutputByteBufferNano.K(9, userSVIPSettings, UserSVIPSettings.PROTOBUF_ADAPTER);
            }
            SvipPrivacySettings svipPrivacySettings = settingGroups.svipPrivacy;
            if (svipPrivacySettings != null) {
                codedOutputByteBufferNano.K(10, svipPrivacySettings, SvipPrivacySettings.PROTOBUF_ADAPTER);
            }
            SeeSettings seeSettings = settingGroups.see;
            if (seeSettings != null) {
                codedOutputByteBufferNano.K(11, seeSettings, SeeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = settingGroups.diamondVIP;
            if (diamondVIPPrivilegeSettings != null) {
                codedOutputByteBufferNano.K(12, diamondVIPPrivilegeSettings, DiamondVIPPrivilegeSettings.PROTOBUF_ADAPTER);
            }
            DiamondVIPPrivateMatch diamondVIPPrivateMatch = settingGroups.diamondVIPPrivateMatch;
            if (diamondVIPPrivateMatch != null) {
                codedOutputByteBufferNano.K(13, diamondVIPPrivateMatch, DiamondVIPPrivateMatch.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting = settingGroups.soulchat;
            if (chatSetting != null) {
                codedOutputByteBufferNano.K(14, chatSetting, ChatSetting.PROTOBUF_ADAPTER);
            }
            ChatSetting chatSetting2 = settingGroups.quickchatchat;
            if (chatSetting2 != null) {
                codedOutputByteBufferNano.K(15, chatSetting2, ChatSetting.PROTOBUF_ADAPTER);
            }
            SoulMatchGroup soulMatchGroup = settingGroups.soulmate;
            if (soulMatchGroup != null) {
                codedOutputByteBufferNano.K(16, soulMatchGroup, SoulMatchGroup.PROTOBUF_ADAPTER);
            }
            ShareSetting shareSetting = settingGroups.share;
            if (shareSetting != null) {
                codedOutputByteBufferNano.K(17, shareSetting, ShareSetting.PROTOBUF_ADAPTER);
            }
            DecorationSettings decorationSettings = settingGroups.decoration;
            if (decorationSettings != null) {
                codedOutputByteBufferNano.K(18, decorationSettings, DecorationSettings.PROTOBUF_ADAPTER);
            }
            ComDiamond comDiamond = settingGroups.comDiamond;
            if (comDiamond != null) {
                codedOutputByteBufferNano.K(19, comDiamond, ComDiamond.PROTOBUF_ADAPTER);
            }
            CharacterEvaluate characterEvaluate = settingGroups.characterEvaluate;
            if (characterEvaluate != null) {
                codedOutputByteBufferNano.K(20, characterEvaluate, CharacterEvaluate.PROTOBUF_ADAPTER);
            }
            Pet pet = settingGroups.pet;
            if (pet != null) {
                codedOutputByteBufferNano.K(21, pet, Pet.PROTOBUF_ADAPTER);
            }
            MomentLevel momentLevel = settingGroups.momentLevel;
            if (momentLevel != null) {
                codedOutputByteBufferNano.K(22, momentLevel, MomentLevel.PROTOBUF_ADAPTER);
            }
            VipSearchSettings vipSearchSettings = settingGroups.vipSearch;
            if (vipSearchSettings != null) {
                codedOutputByteBufferNano.K(23, vipSearchSettings, VipSearchSettings.PROTOBUF_ADAPTER);
            }
            UserMomentSettings userMomentSettings = settingGroups.moment;
            if (userMomentSettings != null) {
                codedOutputByteBufferNano.K(24, userMomentSettings, UserMomentSettings.PROTOBUF_ADAPTER);
            }
            SettingGroupsProfile settingGroupsProfile = settingGroups.profile;
            if (settingGroupsProfile != null) {
                codedOutputByteBufferNano.K(25, settingGroupsProfile, SettingGroupsProfile.PROTOBUF_ADAPTER);
            }
            PlatinumSettings platinumSettings = settingGroups.pvip;
            if (platinumSettings != null) {
                codedOutputByteBufferNano.K(26, platinumSettings, PlatinumSettings.PROTOBUF_ADAPTER);
            }
            MarrySettings marrySettings = settingGroups.marriage;
            if (marrySettings != null) {
                codedOutputByteBufferNano.K(27, marrySettings, MarrySettings.PROTOBUF_ADAPTER);
            }
            CityC cityC = settingGroups.cityC;
            if (cityC != null) {
                codedOutputByteBufferNano.K(28, cityC, CityC.PROTOBUF_ADAPTER);
            }
            SpVip spVip = settingGroups.spvip;
            if (spVip != null) {
                codedOutputByteBufferNano.K(29, spVip, SpVip.PROTOBUF_ADAPTER);
            }
            GrowthSettings growthSettings = settingGroups.growth;
            if (growthSettings != null) {
                codedOutputByteBufferNano.K(30, growthSettings, GrowthSettings.PROTOBUF_ADAPTER);
            }
            FemaleVip femaleVip = settingGroups.fvip;
            if (femaleVip != null) {
                codedOutputByteBufferNano.K(31, femaleVip, FemaleVip.PROTOBUF_ADAPTER);
            }
            SvipSearch svipSearch = settingGroups.svipSearch;
            if (svipSearch != null) {
                codedOutputByteBufferNano.K(32, svipSearch, SvipSearch.PROTOBUF_ADAPTER);
            }
            NotificationSetting notificationSetting = settingGroups.noPush;
            if (notificationSetting != null) {
                codedOutputByteBufferNano.K(33, notificationSetting, NotificationSetting.PROTOBUF_ADAPTER);
            }
            UserUpVipSettings userUpVipSettings = settingGroups.upvip;
            if (userUpVipSettings != null) {
                codedOutputByteBufferNano.K(34, userUpVipSettings, UserUpVipSettings.PROTOBUF_ADAPTER);
            }
            AdsMaterialRouter adsMaterialRouter = settingGroups.adsMaterialRouter;
            if (adsMaterialRouter != null) {
                codedOutputByteBufferNano.K(35, adsMaterialRouter, AdsMaterialRouter.PROTOBUF_ADAPTER);
            }
            IntlMoreGender intlMoreGender = settingGroups.gender;
            if (intlMoreGender != null) {
                codedOutputByteBufferNano.K(36, intlMoreGender, IntlMoreGender.PROTOBUF_ADAPTER);
            }
            TribeSetting tribeSetting = settingGroups.tttribe;
            if (tribeSetting != null) {
                codedOutputByteBufferNano.K(37, tribeSetting, TribeSetting.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<SettingGroups> JSON_ADAPTER = new ObjectJsonAdapter<SettingGroups>() { // from class: com.p1.mobile.putong.data.SettingGroups.2
        ...
        public SettingGroups mo17830newInstance() {
        ...
        public boolean parseField(SettingGroups settingGroups, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "quickchatchat":
                    settingGroups.quickchatchat = (ChatSetting) ChatSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "vipSearch":
                    settingGroups.vipSearch = (VipSearchSettings) VipSearchSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "gender":
                    settingGroups.gender = (IntlMoreGender) IntlMoreGender.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "growth":
                    settingGroups.growth = (GrowthSettings) GrowthSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "characterEvaluate":
                    settingGroups.characterEvaluate = (CharacterEvaluate) CharacterEvaluate.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "moment":
                    settingGroups.moment = (UserMomentSettings) UserMomentSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "noPush":
                    settingGroups.noPush = (NotificationSetting) NotificationSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "comDiamond":
                    settingGroups.comDiamond = (ComDiamond) ComDiamond.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "tttribe":
                    settingGroups.tttribe = (TribeSetting) TribeSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "search":
                    settingGroups.search = (UserSearchSettings) UserSearchSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "decoration":
                    settingGroups.decoration = (DecorationSettings) DecorationSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "diamondVIP":
                    settingGroups.diamondVIP = (DiamondVIPPrivilegeSettings) DiamondVIPPrivilegeSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "privacy":
                    settingGroups.privacy = (UserPrivacySettings) UserPrivacySettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "profile":
                    settingGroups.profile = (SettingGroupsProfile) SettingGroupsProfile.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "momentLevel":
                    settingGroups.momentLevel = (MomentLevel) MomentLevel.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "pet":
                    settingGroups.pet = (Pet) Pet.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "see":
                    settingGroups.see = (SeeSettings) SeeSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "fake":
                    settingGroups.fake = (UserFakeSettings) UserFakeSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "fvip":
                    settingGroups.fvip = (FemaleVip) FemaleVip.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "live":
                    settingGroups.live = (UserLiveSettings) UserLiveSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "push":
                    settingGroups.push = (UserPushSettings) UserPushSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "pvip":
                    settingGroups.pvip = (PlatinumSettings) PlatinumSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "svip":
                    settingGroups.svip = (UserSVIPSettings) UserSVIPSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "type":
                    settingGroups.type = jsonParser.getValueAsString();
                    return true;
                case "boost":
                    settingGroups.boost = (UserBoostSettings) UserBoostSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "cityC":
                    settingGroups.cityC = (CityC) CityC.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "share":
                    settingGroups.share = (ShareSetting) ShareSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "spvip":
                    settingGroups.spvip = (SpVip) SpVip.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "upvip":
                    settingGroups.upvip = (UserUpVipSettings) UserUpVipSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "marriage":
                    settingGroups.marriage = (MarrySettings) MarrySettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "svipPrivacy":
                    settingGroups.svipPrivacy = (SvipPrivacySettings) SvipPrivacySettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "subscription":
                    settingGroups.subscription = (UserSubscriptionSettings) UserSubscriptionSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "soulchat":
                    settingGroups.soulchat = (ChatSetting) ChatSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "soulmate":
                    settingGroups.soulmate = (SoulMatchGroup) SoulMatchGroup.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "svipSearch":
                    settingGroups.svipSearch = (SvipSearch) SvipSearch.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "adsMaterialRouter":
                    settingGroups.adsMaterialRouter = (AdsMaterialRouter) AdsMaterialRouter.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "diamondVIPPrivateMatch":
                    settingGroups.diamondVIPPrivateMatch = (DiamondVIPPrivateMatch) DiamondVIPPrivateMatch.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
        ...
        public void serializeFields(SettingGroups settingGroups, JsonGenerator jsonGenerator) throws IOException {
            ...
            if (settingGroups.soulmate != null) {
                jsonGenerator.writeFieldName("soulmate");
            ...
            if (settingGroups.decoration != null) {
                jsonGenerator.writeFieldName("decoration");
    ...
    public SettingGroups m18946clone() {
        SettingGroups settingGroups = new SettingGroups();
        settingGroups.type = this.type;
        UserBoostSettings userBoostSettings = this.boost;
        if (userBoostSettings != null) {
            settingGroups.boost = userBoostSettings.m19165clone();
        }
        UserLiveSettings userLiveSettings = this.live;
        if (userLiveSettings != null) {
            settingGroups.live = userLiveSettings.m19186clone();
        }
        UserPrivacySettings userPrivacySettings = this.privacy;
        if (userPrivacySettings != null) {
            settingGroups.privacy = userPrivacySettings.m19204clone();
        }
        UserPushSettings userPushSettings = this.push;
        if (userPushSettings != null) {
            settingGroups.push = userPushSettings.m19210clone();
        }
        UserSearchSettings userSearchSettings = this.search;
        if (userSearchSettings != null) {
            settingGroups.search = userSearchSettings.m19219clone();
        }
        UserSubscriptionSettings userSubscriptionSettings = this.subscription;
        if (userSubscriptionSettings != null) {
            settingGroups.subscription = userSubscriptionSettings.m19234clone();
        }
        UserFakeSettings userFakeSettings = this.fake;
        if (userFakeSettings != null) {
            settingGroups.fake = userFakeSettings.m19174clone();
        }
        UserSVIPSettings userSVIPSettings = this.svip;
        if (userSVIPSettings != null) {
            settingGroups.svip = userSVIPSettings.m19216clone();
        }
        SvipPrivacySettings svipPrivacySettings = this.svipPrivacy;
        if (svipPrivacySettings != null) {
            settingGroups.svipPrivacy = svipPrivacySettings.m19054clone();
        }
        SeeSettings seeSettings = this.see;
        if (seeSettings != null) {
            settingGroups.see = seeSettings.m18940clone();
        }
        DiamondVIPPrivilegeSettings diamondVIPPrivilegeSettings = this.diamondVIP;
        if (diamondVIPPrivilegeSettings != null) {
            settingGroups.diamondVIP = diamondVIPPrivilegeSettings.m17985clone();
        }
        DiamondVIPPrivateMatch diamondVIPPrivateMatch = this.diamondVIPPrivateMatch;
        if (diamondVIPPrivateMatch != null) {
            settingGroups.diamondVIPPrivateMatch = diamondVIPPrivateMatch.m17982clone();
        }
        ChatSetting chatSetting = this.soulchat;
        if (chatSetting != null) {
            settingGroups.soulchat = chatSetting.m17813clone();
        }
        ChatSetting chatSetting2 = this.quickchatchat;
        if (chatSetting2 != null) {
            settingGroups.quickchatchat = chatSetting2.m17813clone();
        }
        SoulMatchGroup soulMatchGroup = this.soulmate;
        if (soulMatchGroup != null) {
            settingGroups.soulmate = soulMatchGroup.m19000clone();
        }
        ShareSetting shareSetting = this.share;
        if (shareSetting != null) {
            settingGroups.share = shareSetting.m18973clone();
        }
        DecorationSettings decorationSettings = this.decoration;
        if (decorationSettings != null) {
            settingGroups.decoration = decorationSettings.m17949clone();
        }
        ComDiamond comDiamond = this.comDiamond;
        if (comDiamond != null) {
            settingGroups.comDiamond = comDiamond.m17819clone();
        }
        CharacterEvaluate characterEvaluate = this.characterEvaluate;
        if (characterEvaluate != null) {
            settingGroups.characterEvaluate = characterEvaluate.m17804clone();
        }
        Pet pet = this.pet;
        if (pet != null) {
            settingGroups.pet = pet.m18788clone();
        }
        MomentLevel momentLevel = this.momentLevel;
        if (momentLevel != null) {
            settingGroups.momentLevel = momentLevel.m18488clone();
        }
        VipSearchSettings vipSearchSettings = this.vipSearch;
        if (vipSearchSettings != null) {
            settingGroups.vipSearch = vipSearchSettings.m19304clone();
        }
        UserMomentSettings userMomentSettings = this.moment;
        if (userMomentSettings != null) {
            settingGroups.moment = userMomentSettings.m19198clone();
        }
        SettingGroupsProfile settingGroupsProfile = this.profile;
        if (settingGroupsProfile != null) {
            settingGroups.profile = settingGroupsProfile.m18949clone();
        }
        PlatinumSettings platinumSettings = this.pvip;
        if (platinumSettings != null) {
            settingGroups.pvip = platinumSettings.m18813clone();
        }
        MarrySettings marrySettings = this.marriage;
        if (marrySettings != null) {
            settingGroups.marriage = marrySettings.m18426clone();
        }
        CityC cityC = this.cityC;
        if (cityC != null) {
            settingGroups.cityC = cityC.m17816clone();
        }
        SpVip spVip = this.spvip;
        if (spVip != null) {
            settingGroups.spvip = spVip.m19006clone();
        }
        GrowthSettings growthSettings = this.growth;
        if (growthSettings != null) {
            settingGroups.growth = growthSettings.m18192clone();
        }
        FemaleVip femaleVip = this.fvip;
        if (femaleVip != null) {
            settingGroups.fvip = femaleVip.m18099clone();
        }
        SvipSearch svipSearch = this.svipSearch;
        if (svipSearch != null) {
            settingGroups.svipSearch = svipSearch.m19057clone();
        }
        NotificationSetting notificationSetting = this.noPush;
        if (notificationSetting != null) {
            settingGroups.noPush = notificationSetting.m18548clone();
        }
        AdsMaterialRouter adsMaterialRouter = this.adsMaterialRouter;
        if (adsMaterialRouter != null) {
            settingGroups.adsMaterialRouter = adsMaterialRouter.m17661clone();
        }
        UserUpVipSettings userUpVipSettings = this.upvip;
        if (userUpVipSettings != null) {
            settingGroups.upvip = userUpVipSettings.m19237clone();
        }
        IntlMoreGender intlMoreGender = this.gender;
        if (intlMoreGender != null) {
            settingGroups.gender = intlMoreGender.m18231clone();
        }
        TribeSetting tribeSetting = this.tttribe;
        if (tribeSetting != null) {
            settingGroups.tttribe = tribeSetting.m19114clone();
        }
        return settingGroups;
    }
    ...
    public boolean hasIntlMoreGenderSetting() {
        if (this.gender.lookingForGenders.size() <= 0) {
            return (NullChecker.a(this.gender.newGender) && !this.gender.newGender.isUnknownType()) || !TextUtils.isEmpty(this.gender.subGender);
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        ((ValueObject) this).hashCode = iHashCode37;
        return iHashCode37;
    }
    ...
    public void mergeData(SettingGroups settingGroups) {
        ...
        if (!isFieldParsed(Purpose.marriage)) {
