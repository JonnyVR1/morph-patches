...
public class MatchScData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MatchScData> PROTOBUF_ADAPTER = new MessageNanoAdapter<MatchScData>() { // from class: com.p1.mobile.putong.data.MatchScData.1
        ...
        public int computeAndCacheSize(MatchScData matchScData) {
            ...
            ((MessageNano) matchScData).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public MatchScData m18430parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    matchScData.receiverUserId = nb5Var.s();
                } else if (iU == 18) {
                    matchScData.createTime = nb5Var.s();
                } else if (iU == 26) {
                    matchScData.actiontype = nb5Var.s();
                } else if (iU == 34) {
                    matchScData.actionname = nb5Var.s();
                } else if (iU == 42) {
                    matchScData.updateRelationshipsModuleId = nb5Var.s();
                } else if (iU == 50) {
                    matchScData.updateRelationshipsSource = nb5Var.s();
                } else {
                    if (iU != 58) {
                        if (matchScData.receiverUserId == null) {
                            matchScData.receiverUserId = "";
    ...
    public static JsonAdapter<MatchScData> JSON_ADAPTER = new ObjectJsonAdapter<MatchScData>() { // from class: com.p1.mobile.putong.data.MatchScData.2
        ...
        public MatchScData mo17830newInstance() {
    ...
    public MatchScData m18429clone() {
        MatchScData matchScData = new MatchScData();
    ...
    public Map<String, Object> toTrackParamMap() {
        ...
        map.put("created_time", TextUtils.isEmpty(this.createTime) ? String.valueOf(mqi0.o() / 1000) : this.createTime);
        return map;
    }
    ...
    public static class MatchBuilder {
        ...
        public MatchScData build() {
            ...
            matchScData.createTime = String.valueOf(mqi0.o() / 1000);
