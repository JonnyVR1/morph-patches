...
public class MatchFrom extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(incomefollow, int_incomefollow);
        tEnumJsonAdapter.addExtJsonValue(outgoinglike, int_outgoinglike);
        tEnumJsonAdapter.addExtJsonValue(outgoingcomment, int_outgoingcomment);
        tEnumJsonAdapter.addExtJsonValue(outgoingfollow, int_outgoingfollow);
        ...
        tEnumJsonAdapter.addExtJsonValue(livechat, int_livechat);
        ...
        tEnumJsonAdapter.addExtJsonValue(specialsuperliked, int_specialsuperliked);
        tEnumJsonAdapter.addExtJsonValue("quickchat", int_quickchat);
        tEnumJsonAdapter.addExtJsonValue(selected, int_selected);
        tEnumJsonAdapter.addExtJsonValue("places", int_places);
        tEnumJsonAdapter.addExtJsonValue("liked", int_liked);
        tEnumJsonAdapter.addExtJsonValue("matched", int_matched);
        tEnumJsonAdapter.addExtJsonValue(missed, int_missed);
        tEnumJsonAdapter.addExtJsonValue(vipseen, int_vipseen);
        tEnumJsonAdapter.addExtJsonValue("myLiked", int_myLiked);
        tEnumJsonAdapter.addExtJsonValue(privateMatch, int_privateMatch);
        tEnumJsonAdapter.addExtJsonValue(diamondGiven, int_diamondGiven);
        tEnumJsonAdapter.addExtJsonValue(diamondReceived, 32);
        tEnumJsonAdapter.addExtJsonValue(diamondMatched, int_diamondMatched);
        tEnumJsonAdapter.addExtJsonValue(soulmatch, int_soulmatch);
        tEnumJsonAdapter.addExtJsonValue(privateMatchGiven, int_privateMatchGiven);
        tEnumJsonAdapter.addExtJsonValue(privateMatchBy, int_privateMatchBy);
        ...
        _MatchFrom = Collections.synchronizedMap(new e01());
    }
