...
public class NavigationIntent extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue("webview", int_webview);
        tEnumJsonAdapter.addExtJsonValue(profile_edit, int_profile_edit);
        tEnumJsonAdapter.addExtJsonValue("seeLikes", int_seeLikes);
        tEnumJsonAdapter.addExtJsonValue(seeSidePush, int_seeSidePush);
        tEnumJsonAdapter.addExtJsonValue(seeSideMsg, int_seeSideMsg);
        tEnumJsonAdapter.addExtJsonValue(seeSideNewPush, int_seeSideNewPush);
        ...
        tEnumJsonAdapter.addExtJsonValue(messageItem, int_messageItem);
        tEnumJsonAdapter.addExtJsonValue(voiceCall, int_voiceCall);
        ...
        tEnumJsonAdapter.addExtJsonValue(fakealert, int_fakealert);
        tEnumJsonAdapter.addExtJsonValue(weekly_cp_2, int_weekly_cp_2);
        tEnumJsonAdapter.addExtJsonValue(partyDetail, int_partyDetail);
        tEnumJsonAdapter.addExtJsonValue(partyHall, int_partyHall);
        tEnumJsonAdapter.addExtJsonValue(welcomeBack, int_welcomeBack);
        tEnumJsonAdapter.addExtJsonValue(quickChatMatch, int_quickChatMatch);
        tEnumJsonAdapter.addExtJsonValue(greetChat, 32);
        tEnumJsonAdapter.addExtJsonValue(voiceChat, int_voiceChat);
        tEnumJsonAdapter.addExtJsonValue(profile_edit_continuous, int_profile_edit_continuous);
        ...
        _NavigationIntent = Collections.synchronizedMap(new e01());
    }
