...
public class Settings extends ValueObject<Settings> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Settings> PROTOBUF_ADAPTER = new MessageNanoAdapter<Settings>() { // from class: com.p1.mobile.putong.data.Settings.1
        ...
        public int computeAndCacheSize(Settings settings) {
            ...
            int iL = phoneNumber != null ? CodedOutputByteBufferNano.l(1, phoneNumber, PhoneNumber.PROTOBUF_ADAPTER) : 0;
            LookingFor lookingFor = settings.lookingFor;
            if (lookingFor != null) {
                iL += CodedOutputByteBufferNano.h(2, lookingFor.ordinal());
            }
            SettingsIntent settingsIntent = settings.intent;
            if (settingsIntent != null) {
                iL += CodedOutputByteBufferNano.h(3, settingsIntent.ordinal());
            }
            Double d = settings.birthdate;
            if (d != null) {
                iL += CodedOutputByteBufferNano.d(4, d.doubleValue());
            }
            SearchRadius searchRadius = settings.searchRadius;
            if (searchRadius != null) {
                iL += CodedOutputByteBufferNano.l(5, searchRadius, SearchRadius.PROTOBUF_ADAPTER);
            }
            SettingsNotifications settingsNotifications = settings.notifications;
            if (settingsNotifications != null) {
                iL += CodedOutputByteBufferNano.l(6, settingsNotifications, SettingsNotifications.PROTOBUF_ADAPTER);
            }
            Boolean bool = settings.hideContacts;
            if (bool != null) {
                iL += CodedOutputByteBufferNano.b(7, bool.booleanValue());
            }
            Boolean bool2 = settings.hideMutualContacts;
            if (bool2 != null) {
                iL += CodedOutputByteBufferNano.b(8, bool2.booleanValue());
            }
            SearchAge searchAge = settings.searchAge;
            if (searchAge != null) {
                iL += CodedOutputByteBufferNano.l(9, searchAge, SearchAge.PROTOBUF_ADAPTER);
            }
            SettingsConversations settingsConversations = settings.conversations;
            if (settingsConversations != null) {
                iL += CodedOutputByteBufferNano.l(10, settingsConversations, SettingsConversations.PROTOBUF_ADAPTER);
            }
            MessageLocation messageLocation = settings.searchLocation;
            if (messageLocation != null) {
                iL += CodedOutputByteBufferNano.l(11, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            SettingsBoost settingsBoost = settings.boost;
            if (settingsBoost != null) {
                iL += CodedOutputByteBufferNano.l(12, settingsBoost, SettingsBoost.PROTOBUF_ADAPTER);
            }
            Verification verification = settings.verification;
            if (verification != null) {
                iL += CodedOutputByteBufferNano.l(13, verification, Verification.PROTOBUF_ADAPTER);
            }
            List<SearchPriority> list = settings.searchPriorities;
            if (list != null) {
                iL += CodedOutputByteBufferNano.l(14, SearchPriority.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            SettingsMoment settingsMoment = settings.moment;
            if (settingsMoment != null) {
                iL += CodedOutputByteBufferNano.l(15, settingsMoment, SettingsMoment.PROTOBUF_ADAPTER);
            }
            Boolean bool3 = settings.autoAdjustSuggestRadius;
            if (bool3 != null) {
                iL += CodedOutputByteBufferNano.b(16, bool3.booleanValue());
            }
            SettingsTbh settingsTbh = settings.tbh;
            if (settingsTbh != null) {
                iL += CodedOutputByteBufferNano.l(17, settingsTbh, SettingsTbh.PROTOBUF_ADAPTER);
            }
            String str = settings.greeting;
            if (str != null) {
                iL += CodedOutputByteBufferNano.o(18, str);
            }
            String str2 = settings.email;
            if (str2 != null) {
                iL += CodedOutputByteBufferNano.o(19, str2);
            }
            PhoneNumber phoneNumber2 = settings.linkedPhoneNumber;
            if (phoneNumber2 != null) {
                iL += CodedOutputByteBufferNano.l(20, phoneNumber2, PhoneNumber.PROTOBUF_ADAPTER);
            }
            List<SettingGroups> list2 = settings.settingGroups;
            if (list2 != null) {
                iL += CodedOutputByteBufferNano.l(21, list2, SettingGroups.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LookingFor lookingFor2 = settings.lookingFor;
            if (lookingFor2 != null) {
                iL += CodedOutputByteBufferNano.l(22, lookingFor2, LookingFor.PROTOBUF_ADAPTER);
            }
            SettingsIntent settingsIntent2 = settings.intent;
            if (settingsIntent2 != null) {
                iL += CodedOutputByteBufferNano.l(23, settingsIntent2, SettingsIntent.PROTOBUF_ADAPTER);
            }
            List<SearchPriority> list3 = settings.searchPriorities;
            if (list3 != null) {
                iL += CodedOutputByteBufferNano.l(24, list3, SearchPriority.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OmsSetting omsSetting = settings.omsSetting;
            if (omsSetting != null) {
                iL += CodedOutputByteBufferNano.l(25, omsSetting, OmsSetting.PROTOBUF_ADAPTER);
            }
            ((MessageNano) settings).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Settings m18953parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        settings.phoneNumber = (PhoneNumber) nb5Var.l(PhoneNumber.PROTOBUF_ADAPTER);
                        continue;
                    ...
                    case 24:
                        ...
                        continue;
                    case 33:
                        settings.birthdate = Double.valueOf(nb5Var.h());
                        continue;
                    case 42:
                        settings.searchRadius = (SearchRadius) nb5Var.l(SearchRadius.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        settings.notifications = (SettingsNotifications) nb5Var.l(SettingsNotifications.PROTOBUF_ADAPTER);
                        continue;
                    case 56:
                        settings.hideContacts = Boolean.valueOf(nb5Var.g());
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.BLUETOOTH_SCO /* 64 */:
                        settings.hideMutualContacts = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 74:
                        settings.searchAge = (SearchAge) nb5Var.l(SearchAge.PROTOBUF_ADAPTER);
                        continue;
                    case 82:
                        settings.conversations = (SettingsConversations) nb5Var.l(SettingsConversations.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        settings.searchLocation = (MessageLocation) nb5Var.l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 98:
                        settings.boost = (SettingsBoost) nb5Var.l(SettingsBoost.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        settings.verification = (Verification) nb5Var.l(Verification.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        list = (List) nb5Var.l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 122:
                        settings.moment = (SettingsMoment) nb5Var.l(SettingsMoment.PROTOBUF_ADAPTER);
                        continue;
                    case 128:
                        settings.autoAdjustSuggestRadius = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 138:
                        settings.tbh = (SettingsTbh) nb5Var.l(SettingsTbh.PROTOBUF_ADAPTER);
                        continue;
                    case 146:
                        settings.greeting = nb5Var.s();
                        continue;
                    case 154:
                        settings.email = nb5Var.s();
                        continue;
                    case 162:
                        settings.linkedPhoneNumber = (PhoneNumber) nb5Var.l(PhoneNumber.PROTOBUF_ADAPTER);
                        continue;
                    case 170:
                        settings.settingGroups = (List) nb5Var.l(SettingGroups.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 178:
                        settings.lookingFor = (LookingFor) nb5Var.l(LookingFor.PROTOBUF_ADAPTER);
                        continue;
                    case 186:
                        settings.intent = (SettingsIntent) nb5Var.l(SettingsIntent.PROTOBUF_ADAPTER);
                        continue;
                    case 194:
                        settings.searchPriorities = (List) nb5Var.l(SearchPriority.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 202:
                        settings.omsSetting = (OmsSetting) nb5Var.l(OmsSetting.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (settings.lookingFor == null && numValueOf != null) {
                            settings.lookingFor = (LookingFor) LookingFor.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Settings settings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            PhoneNumber phoneNumber = settings.phoneNumber;
            if (phoneNumber != null) {
                codedOutputByteBufferNano.K(1, phoneNumber, PhoneNumber.PROTOBUF_ADAPTER);
            }
            LookingFor lookingFor = settings.lookingFor;
            if (lookingFor != null) {
                codedOutputByteBufferNano.G(2, lookingFor.ordinal());
            }
            SettingsIntent settingsIntent = settings.intent;
            if (settingsIntent != null) {
                codedOutputByteBufferNano.G(3, settingsIntent.ordinal());
            }
            Double d = settings.birthdate;
            if (d != null) {
                codedOutputByteBufferNano.C(4, d.doubleValue());
            }
            SearchRadius searchRadius = settings.searchRadius;
            if (searchRadius != null) {
                codedOutputByteBufferNano.K(5, searchRadius, SearchRadius.PROTOBUF_ADAPTER);
            }
            SettingsNotifications settingsNotifications = settings.notifications;
            if (settingsNotifications != null) {
                codedOutputByteBufferNano.K(6, settingsNotifications, SettingsNotifications.PROTOBUF_ADAPTER);
            }
            Boolean bool = settings.hideContacts;
            if (bool != null) {
            ...
            SearchAge searchAge = settings.searchAge;
            if (searchAge != null) {
                codedOutputByteBufferNano.K(9, searchAge, SearchAge.PROTOBUF_ADAPTER);
            }
            SettingsConversations settingsConversations = settings.conversations;
            if (settingsConversations != null) {
                codedOutputByteBufferNano.K(10, settingsConversations, SettingsConversations.PROTOBUF_ADAPTER);
            }
            MessageLocation messageLocation = settings.searchLocation;
            if (messageLocation != null) {
                codedOutputByteBufferNano.K(11, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            SettingsBoost settingsBoost = settings.boost;
            if (settingsBoost != null) {
                codedOutputByteBufferNano.K(12, settingsBoost, SettingsBoost.PROTOBUF_ADAPTER);
            }
            Verification verification = settings.verification;
            if (verification != null) {
                codedOutputByteBufferNano.K(13, verification, Verification.PROTOBUF_ADAPTER);
            }
            List<SearchPriority> list = settings.searchPriorities;
            if (list != null) {
                codedOutputByteBufferNano.K(14, SearchPriority.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            SettingsMoment settingsMoment = settings.moment;
            if (settingsMoment != null) {
                codedOutputByteBufferNano.K(15, settingsMoment, SettingsMoment.PROTOBUF_ADAPTER);
            }
            Boolean bool3 = settings.autoAdjustSuggestRadius;
            if (bool3 != null) {
            ...
            SettingsTbh settingsTbh = settings.tbh;
            if (settingsTbh != null) {
                codedOutputByteBufferNano.K(17, settingsTbh, SettingsTbh.PROTOBUF_ADAPTER);
            }
            String str = settings.greeting;
            if (str != null) {
                codedOutputByteBufferNano.R(18, str);
            }
            String str2 = settings.email;
            if (str2 != null) {
                codedOutputByteBufferNano.R(19, str2);
            }
            PhoneNumber phoneNumber2 = settings.linkedPhoneNumber;
            if (phoneNumber2 != null) {
                codedOutputByteBufferNano.K(20, phoneNumber2, PhoneNumber.PROTOBUF_ADAPTER);
            }
            List<SettingGroups> list2 = settings.settingGroups;
            if (list2 != null) {
                codedOutputByteBufferNano.K(21, list2, SettingGroups.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LookingFor lookingFor2 = settings.lookingFor;
            if (lookingFor2 != null) {
                codedOutputByteBufferNano.K(22, lookingFor2, LookingFor.PROTOBUF_ADAPTER);
            }
            SettingsIntent settingsIntent2 = settings.intent;
            if (settingsIntent2 != null) {
                codedOutputByteBufferNano.K(23, settingsIntent2, SettingsIntent.PROTOBUF_ADAPTER);
            }
            List<SearchPriority> list3 = settings.searchPriorities;
            if (list3 != null) {
                codedOutputByteBufferNano.K(24, list3, SearchPriority.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OmsSetting omsSetting = settings.omsSetting;
            if (omsSetting != null) {
                codedOutputByteBufferNano.K(25, omsSetting, OmsSetting.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Settings> JSON_ADAPTER = new ObjectJsonAdapter<Settings>() { // from class: com.p1.mobile.putong.data.Settings.2
        ...
        public Settings mo17830newInstance() {
            return new Settings();
        }
        ...
        public boolean parseField(Settings settings, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str.hashCode()) {
                ...
                case 93922211:
                    ...
                    break;
                case 96619420:
                    if (str.equals(SignInGrantType.email)) {
                        b = 16;
                    }
                    break;
                case 205422649:
            ...
            switch (b) {
                case 0:
                    settings.omsSetting = (OmsSetting) OmsSetting.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 1:
                    settings.settingGroups = JsonAdapter.parseArray(jsonParser, SettingGroups.JSON_ADAPTER, str2, arrayList, dataChecker);
                    return true;
                case 2:
                    settings.verification = (Verification) Verification.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 3:
                    ...
                    return true;
                case 4:
                    settings.birthdate = (Double) Converter.API_DATE_BOXED.parse(jsonParser, str2);
                    return true;
                case 5:
                    settings.phoneNumber = (PhoneNumber) PhoneNumber.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 6:
                    settings.intent = (SettingsIntent) SettingsIntent.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case 7:
                    settings.searchPriorities = JsonAdapter.parseArray(jsonParser, SearchPriority.JSON_ADAPTER, str2, arrayList, dataChecker);
                    return true;
                case 8:
                    settings.moment = (SettingsMoment) SettingsMoment.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 9:
                    settings.linkedPhoneNumber = (PhoneNumber) PhoneNumber.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 10:
                    settings.searchLocation = (MessageLocation) MessageLocation.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 11:
                ...
                case 12:
                    ...
                    return true;
                case 13:
                    settings.tbh = (SettingsTbh) SettingsTbh.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 14:
                    settings.searchRadius = (SearchRadius) SearchRadius.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 15:
                    settings.boost = (SettingsBoost) SettingsBoost.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case AudioRouteDeviceManager.RoutingDeviceType.BLUETOOTH_A2DP /* 16 */:
                ...
                case 17:
                    ...
                    return true;
                case 18:
                    settings.lookingFor = (LookingFor) LookingFor.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case 19:
                    settings.notifications = (SettingsNotifications) SettingsNotifications.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 20:
                    settings.conversations = (SettingsConversations) SettingsConversations.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 21:
                    settings.searchAge = (SearchAge) SearchAge.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
        ...
        public boolean parseFieldCheck(Settings settings, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) {
            ...
            switch (str) {
                ...
                case "settingGroups":
                case "verification":
                case "autoAdjustSuggestRadius":
                case "birthdate":
                case "phoneNumber":
                case "intent":
                case "searchPriorities":
                case "moment":
                case "linkedPhoneNumber":
                case "searchLocation":
    ...
    public static /* synthetic */ SearchPriority m1002a(SearchPriority searchPriority) {
    ...
    private double getMomentRoamingLatitude() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.vipSearch) && NullChecker.a(settingGroup.vipSearch.momentRoamingLatitude)) {
            return settingGroup.vipSearch.momentRoamingLatitude.doubleValue();
        }
        return 0.0d;
    }
    ...
    private double getMomentRoamingLongitude() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.vipSearch) && NullChecker.a(settingGroup.vipSearch.momentRoamingLongitude)) {
            return settingGroup.vipSearch.momentRoamingLongitude.doubleValue();
        }
        return 0.0d;
    }
    ...
    public Boolean aiPictureEnable() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.aiPictureEnable)) ? Boolean.valueOf(TextUtils.equals(settingGroup.privacy.aiPictureEnable, "true")) : Boolean.FALSE;
    }

    public Boolean autoAdjustSuggestRadius() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search) && NullChecker.a(settingGroup.search.autoAdjustRadius)) ? settingGroup.search.autoAdjustRadius : this.autoAdjustSuggestRadius;
    }
    ...
    public Settings m18952clone() {
        Settings settings = new Settings();
        PhoneNumber phoneNumber = this.phoneNumber;
        if (phoneNumber != null) {
            settings.phoneNumber = phoneNumber.m18794clone();
        }
        ...
        if (searchRadius != null) {
            settings.searchRadius = searchRadius.m18937clone();
        }
        SettingsNotifications settingsNotifications = this.notifications;
        if (settingsNotifications != null) {
            settings.notifications = settingsNotifications.m18964clone();
        }
        ...
        if (searchAge != null) {
            settings.searchAge = searchAge.m18934clone();
        }
        SettingsConversations settingsConversations = this.conversations;
        if (settingsConversations != null) {
            settings.conversations = settingsConversations.m18958clone();
        }
        MessageLocation messageLocation = this.searchLocation;
        if (messageLocation != null) {
            settings.searchLocation = messageLocation.m18458clone();
        }
        SettingsBoost settingsBoost = this.boost;
        if (settingsBoost != null) {
            settings.boost = settingsBoost.m18955clone();
        }
        Verification verification = this.verification;
        if (verification != null) {
            settings.verification = verification.m19255clone();
        }
    ...
    public String getAiPictureEnable() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.aiPictureEnable)) ? settingGroup.privacy.aiPictureEnable : FeedMakeupPageAdapter.MakeupItem.NONE;
    }

    public CityC getCityTopInfo() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.cityC)) {
    ...
    public LookingFor getLookingFor() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search) && NullChecker.a(settingGroup.search.lookingForGender)) ? settingGroup.search.lookingForGender : this.lookingFor;
    }
    ...
    public Boolean getOnlineReminder() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.onlineReminder)) ? settingGroup.privacy.onlineReminder : Boolean.FALSE;
    }

    public Integer getRadiusAllowedMaximum() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.radiusAllowedMaximum : this.searchRadius.allowedMaximum;
    }

    public Integer getRadiusAllowedMinimum() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.radiusAllowedMinimum : this.searchRadius.allowedMinimum;
    }

    public double getRoamingLatitude() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search) && NullChecker.a(settingGroup.search.roamingLatitude)) ? settingGroup.search.roamingLatitude.doubleValue() : this.searchLocation.coordinates.first;
    }

    public double getRoamingLongitude() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search) && NullChecker.a(settingGroup.search.roamingLongitude)) ? settingGroup.search.roamingLongitude.doubleValue() : this.searchLocation.coordinates.second;
    }

    public Integer getSearchAgeAllowedMaximum() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.ageAllowedMaximum : this.searchAge.allowedMaximum;
    }

    public Integer getSearchAgeAllowedMinimum() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.ageAllowedMinimum : this.searchAge.allowedMinimum;
    }

    public List<String> getSearchFriendPurpose() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.friendPurpose : this.purposeList;
    }

    public Integer getSearchInvisibleRadius() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search) && NullChecker.a(settingGroup.search.invisibleRadius)) {
    ...
    public Integer getSearchMaxAge() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.maxAge : this.searchAge.maximum;
    }

    public Integer getSearchMinAge() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.minAge : this.searchAge.minimum;
    }

    public List<SearchPriority> getSearchPriority() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search)) ? settingGroup.search.priorities : this.searchPriorities;
    }

    public Integer getSearchRadius() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.search) && NullChecker.a(settingGroup.search.radius)) ? settingGroup.search.radius : this.searchRadius.value;
    }
    ...
    public int getSupremePartnerUserCode() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.spvip)) {
    ...
    public Boolean hasAiPictureEnableClick() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.aiPictureEnable)) ? Boolean.valueOf(!TextUtils.equals(settingGroup.privacy.aiPictureEnable, FeedMakeupPageAdapter.MakeupItem.NONE)) : Boolean.FALSE;
    }
    ...
    public Boolean heartbeatDisable() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.heartbeatDisable)) ? settingGroup.privacy.heartbeatDisable : Boolean.FALSE;
    }

    public Boolean hideAutoLike() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.moment)) ? settingGroup.moment.autoLike : Boolean.TRUE;
    }

    public Boolean hideContacts() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.hideContacts)) ? settingGroup.privacy.hideContacts : this.hideContacts;
    }

    public Boolean hideMutualContacts() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.hideMutualContacts)) ? settingGroup.privacy.hideMutualContacts : this.hideMutualContacts;
    }

    public Boolean hidePublicMoment() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy)) ? settingGroup.privacy.hidePublicMoments : this.moment.hidePublicMoments;
    }

    public boolean hideSchoolName() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.hideSchool)) {
    ...
    public Boolean hideSchoolNameNoDefaults() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy)) ? settingGroup.privacy.hideSchool : this.verification.studies.hideSchoolName;
    }

    public boolean isCityTop() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return NullChecker.a(settingGroup) && NullChecker.a(settingGroup.cityC) && ((double) mqi0.o()) < settingGroup.cityC.expiredTime;
    }
    ...
    public boolean isPlatinum() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.pvip)) {
    ...
    public Boolean justReceiveVeriUserMsg() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.verifiedUserMsg)) ? settingGroup.privacy.verifiedUserMsg : Boolean.FALSE;
    }
    ...
    public void mergeData(Settings settings) {
        ...
        if (!isFieldParsed(SignInGrantType.email)) {
    ...
    public void nullCheck() {
        ...
        if (this.birthdate == null) {
            this.birthdate = Double.valueOf(0.0d);
        }
    ...
    public boolean personalizeAdsSuggest() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.adsSuggest)) {
    ...
    public Boolean personalizeSuggest() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.personalizeSuggest)) ? settingGroup.privacy.personalizeSuggest : Boolean.TRUE;
    }

    public Boolean previewPushMessage() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.push) && NullChecker.a(settingGroup.push.previewMessage)) ? settingGroup.push.previewMessage : this.notifications.previewPushMessage;
    }
    ...
    public Boolean showMomentLikes() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.push)) ? settingGroup.push.showMomentLikes : Boolean.valueOf(this.conversations.showMomentLikes);
    }
    ...
    public Boolean unrepliedReminder() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        return (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.privacy) && NullChecker.a(settingGroup.privacy.unrepliedReminder)) ? settingGroup.privacy.unrepliedReminder : Boolean.TRUE;
    }

    public boolean userIsODiamond() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.b(settingGroup.comDiamond)) {
    ...
    public Boolean userLivePushTip() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.push)) {
            return settingGroup.push.livePush;
        }
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.livePush;
    }
    ...
    public Boolean userMomentPushTip() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.momentPush;
    }
    ...
    public Boolean userMsgPushTip() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.msgPush;
    }
    ...
    public Boolean userPushAllEnable() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.allPush;
    }
    ...
    public int userPushEndTimeTip() {
        ...
        if (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) {
            return 1;
        }
    ...
    public Boolean userRecommendPushTip() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.recommendPush;
    }

    public Boolean userShareTip() {
        SettingGroups settingGroup = vwb.J(this.settingGroups) ? null : getSettingGroup();
        if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.share)) {
            return Boolean.valueOf(settingGroup.share.userShare);
        }
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).share == null) ? Boolean.FALSE : Boolean.valueOf(this.settingGroups.get(0).share.userShare);
    }
    ...
    public Boolean userSilentSwitchPushTip() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.silentSwitch;
    }
    ...
    public Boolean userVoiceLivePushTip() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).push == null) ? Boolean.FALSE : this.settingGroups.get(0).push.voiceLivePush;
    }
    ...
    public String uservoiceNotification() {
        ...
        return (vwb.J(this.settingGroups) || this.settingGroups.get(0).live == null) ? "" : settingGroup.live.voiceNotification;
    }
}
