...
public class MediaMeta extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MediaMeta> PROTOBUF_ADAPTER = new MessageNanoAdapter<MediaMeta>() { // from class: com.p1.mobile.putong.data.MediaMeta.1
        ...
        public int computeAndCacheSize(MediaMeta mediaMeta) {
            ...
            int iB = iO + CodedOutputByteBufferNano.b(54, mediaMeta.hasAudio);
            ...
            if (str7 != null) {
                iB += CodedOutputByteBufferNano.o(58, str7);
            }
            String str8 = mediaMeta.filter;
            if (str8 != null) {
                iB += CodedOutputByteBufferNano.o(59, str8);
            }
            int iB2 = iB + CodedOutputByteBufferNano.b(60, mediaMeta.isSameMusic);
            ((MessageNano) mediaMeta).cachedSize = iB2;
            return iB2;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public MediaMeta m18444parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 410:
                        mediaMeta.type = nb5Var.s();
                        continue;
                    case 418:
                        mediaMeta.source = nb5Var.s();
                        continue;
                    case 426:
                        mediaMeta.musicReference = nb5Var.s();
                        continue;
                    case 432:
                        mediaMeta.hasAudio = nb5Var.g();
                        continue;
                    case 442:
                        mediaMeta.musicId = nb5Var.s();
                        continue;
                    case 450:
                        mediaMeta.proportion = nb5Var.s();
                        continue;
                    case 458:
                        mediaMeta.camera = nb5Var.s();
                        continue;
                    case 466:
                        mediaMeta.sticker = nb5Var.s();
                        continue;
                    case 474:
                        mediaMeta.filter = nb5Var.s();
                        continue;
                    case 480:
                        mediaMeta.isSameMusic = nb5Var.g();
                        continue;
                    default:
                        if (mediaMeta.type == null) {
                            mediaMeta.type = "";
        ...
        public void serialize(MediaMeta mediaMeta, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(54, mediaMeta.hasAudio);
            String str4 = mediaMeta.musicId;
            if (str4 != null) {
            ...
            String str8 = mediaMeta.filter;
            if (str8 != null) {
                codedOutputByteBufferNano.R(59, str8);
            }
            codedOutputByteBufferNano.A(60, mediaMeta.isSameMusic);
        }
    };
    public static JsonAdapter<MediaMeta> JSON_ADAPTER = new ObjectJsonAdapter<MediaMeta>() { // from class: com.p1.mobile.putong.data.MediaMeta.2
        ...
        public MediaMeta mo17830newInstance() {
