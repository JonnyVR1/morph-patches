...
public class LangModel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LangModel> PROTOBUF_ADAPTER = new MessageNanoAdapter<LangModel>() { // from class: com.p1.mobile.putong.data.LangModel.1
        ...
        public int computeAndCacheSize(LangModel langModel) {
            ...
            ((MessageNano) langModel).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public LangModel m18277parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    langModel.zh_cn = nb5Var.s();
                } else if (iU == 18) {
                    langModel.en_us = nb5Var.s();
                } else if (iU == 26) {
                    langModel.id_id = nb5Var.s();
                } else if (iU == 34) {
                    langModel.zh_tw = nb5Var.s();
                } else if (iU == 42) {
                    langModel.th_th = nb5Var.s();
                } else if (iU == 50) {
                    langModel.ko_kr = nb5Var.s();
                } else {
                    if (iU != 58) {
                        if (langModel.zh_cn == null) {
                            langModel.zh_cn = "";
    ...
    public static JsonAdapter<LangModel> JSON_ADAPTER = new ObjectJsonAdapter<LangModel>() { // from class: com.p1.mobile.putong.data.LangModel.2
        ...
        public LangModel mo17830newInstance() {
    ...
    public String getLocalName() {
        ...
        if (strLanguage.startsWith("zh")) {
            return "zh-Hant".equals(strLanguage) ? this.zh_tw : this.zh_cn;
        }
