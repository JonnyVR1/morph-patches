...
import com.p000p1.mobile.putong.data.VirtualVoiceGroupConversationItemRoom;
...
public class VirtualVoiceGroupConversationItemRoom extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VirtualVoiceGroupConversationItemRoom> PROTOBUF_ADAPTER = new MessageNanoAdapter<VirtualVoiceGroupConversationItemRoom>() { // from class: com.p1.mobile.putong.data.VirtualVoiceGroupConversationItemRoom.1
        ...
        public int computeAndCacheSize(VirtualVoiceGroupConversationItemRoom virtualVoiceGroupConversationItemRoom) {
            ...
            int iH = iO + CodedOutputByteBufferNano.h(5, virtualVoiceGroupConversationItemRoom.memberCount);
            ...
            int iB = iH + CodedOutputByteBufferNano.b(8, virtualVoiceGroupConversationItemRoom.isLiving);
            String str6 = virtualVoiceGroupConversationItemRoom.anchorId;
            if (str6 != null) {
                iB += CodedOutputByteBufferNano.o(9, str6);
            }
            ((MessageNano) virtualVoiceGroupConversationItemRoom).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public VirtualVoiceGroupConversationItemRoom m19320parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    virtualVoiceGroupConversationItemRoom.roomId = nb5Var.s();
                } else if (iU == 18) {
                    virtualVoiceGroupConversationItemRoom.title = nb5Var.s();
                } else if (iU == 26) {
                    virtualVoiceGroupConversationItemRoom.avatars = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 34) {
                    virtualVoiceGroupConversationItemRoom.liveId = nb5Var.s();
                } else if (iU == 40) {
                    virtualVoiceGroupConversationItemRoom.memberCount = nb5Var.j();
                } else if (iU == 50) {
                    virtualVoiceGroupConversationItemRoom.roomStateText = nb5Var.s();
                } else if (iU == 58) {
                    virtualVoiceGroupConversationItemRoom.roomStateTextColor = nb5Var.s();
                } else if (iU == 64) {
                    virtualVoiceGroupConversationItemRoom.isLiving = nb5Var.g();
                } else {
                    if (iU != 74) {
                        if (virtualVoiceGroupConversationItemRoom.roomId == null) {
                            virtualVoiceGroupConversationItemRoom.roomId = "";
                    ...
                    virtualVoiceGroupConversationItemRoom.anchorId = nb5Var.s();
                }
            }
            return virtualVoiceGroupConversationItemRoom;
        }
        ...
        public void serialize(VirtualVoiceGroupConversationItemRoom virtualVoiceGroupConversationItemRoom, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.G(5, virtualVoiceGroupConversationItemRoom.memberCount);
            String str4 = virtualVoiceGroupConversationItemRoom.roomStateText;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.A(8, virtualVoiceGroupConversationItemRoom.isLiving);
            String str6 = virtualVoiceGroupConversationItemRoom.anchorId;
            if (str6 != null) {
    ...
    public static JsonAdapter<VirtualVoiceGroupConversationItemRoom> JSON_ADAPTER = new ObjectJsonAdapter<VirtualVoiceGroupConversationItemRoom>() { // from class: com.p1.mobile.putong.data.VirtualVoiceGroupConversationItemRoom.2
        ...
        public VirtualVoiceGroupConversationItemRoom mo17830newInstance() {
    ...
    public static /* synthetic */ String m1074a(String str) {
        return str;
    }
    ...
    public VirtualVoiceGroupConversationItemRoom m19319clone() {
        VirtualVoiceGroupConversationItemRoom virtualVoiceGroupConversationItemRoom = new VirtualVoiceGroupConversationItemRoom();
        ...
        if (list != null) {
            virtualVoiceGroupConversationItemRoom.avatars = ValueObject.util_map(list, new w9j() { // from class: l.hzl0
                public final Object call(Object obj) {
                    return VirtualVoiceGroupConversationItemRoom.m1074a((String) obj);
                }
            });
        }
