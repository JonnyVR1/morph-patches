...
import com.p000p1.mobile.putong.data.FoulWords;
...
public class FoulWords extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FoulWords> PROTOBUF_ADAPTER = new MessageNanoAdapter<FoulWords>() { // from class: com.p1.mobile.putong.data.FoulWords.1
        ...
        public int computeAndCacheSize(FoulWords foulWords) {
            ...
            ((MessageNano) foulWords).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public FoulWords m18118parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    foulWords.contains = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 18) {
                    foulWords.exact = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 26) {
                    foulWords.spoofing = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 34) {
                    foulWords.badMoodContains = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 42) {
                    foulWords.badMoodExact = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 50) {
                    foulWords.harassRegex = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 58) {
                    foulWords.spoofingNew = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 66) {
                    foulWords.chatSearchContains = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iU != 74) {
                        if (foulWords.contains == null) {
                            foulWords.contains = new ArrayList();
                    ...
                    foulWords.chatSearchExact = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return foulWords;
        }
    ...
    public static JsonAdapter<FoulWords> JSON_ADAPTER = new ObjectJsonAdapter<FoulWords>() { // from class: com.p1.mobile.putong.data.FoulWords.2
        ...
        public FoulWords mo17830newInstance() {
    ...
    public static /* synthetic */ String m696b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m697c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m698d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m699e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m700f(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m701k(String str) {
        return str;
    }

    /* JADX INFO: renamed from: l */
    public static /* synthetic */ String m702l(String str) {
        return str;
    }

    /* JADX INFO: renamed from: m */
    public static /* synthetic */ String m703m(String str) {
        return str;
    }
    ...
    public FoulWords m18117clone() {
        ...
        if (list2 != null) {
            foulWords.exact = ValueObject.util_map(list2, new w9j() { // from class: l.j0j
                public final Object call(Object obj) {
                    return FoulWords.m698d((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            foulWords.spoofing = ValueObject.util_map(list3, new w9j() { // from class: l.k0j
                public final Object call(Object obj) {
                    return FoulWords.m696b((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            foulWords.badMoodContains = ValueObject.util_map(list4, new w9j() { // from class: l.l0j
                public final Object call(Object obj) {
                    return FoulWords.m699e((String) obj);
                }
            });
        }
        ...
        if (list5 != null) {
            foulWords.badMoodExact = ValueObject.util_map(list5, new w9j() { // from class: l.m0j
                public final Object call(Object obj) {
                    return FoulWords.m697c((String) obj);
                }
            });
        }
        ...
        if (list6 != null) {
            foulWords.harassRegex = ValueObject.util_map(list6, new w9j() { // from class: l.n0j
                public final Object call(Object obj) {
                    return FoulWords.m700f((String) obj);
                }
            });
        }
        ...
        if (list7 != null) {
            foulWords.spoofingNew = ValueObject.util_map(list7, new w9j() { // from class: l.o0j
                public final Object call(Object obj) {
                    return FoulWords.m702l((String) obj);
                }
            });
        }
        ...
        if (list8 != null) {
            foulWords.chatSearchContains = ValueObject.util_map(list8, new w9j() { // from class: l.p0j
                public final Object call(Object obj) {
                    return FoulWords.m695a((String) obj);
                }
            });
        }
        ...
        if (list9 != null) {
            foulWords.chatSearchExact = ValueObject.util_map(list9, new w9j() { // from class: l.q0j
                public final Object call(Object obj) {
                    return FoulWords.m703m((String) obj);
                }
            });
        }
        return foulWords;
