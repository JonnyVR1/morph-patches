...
public class CounterSecretCrushLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CounterSecretCrushLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<CounterSecretCrushLimit>() { // from class: com.p1.mobile.putong.data.CounterSecretCrushLimit.1
        ...
        public int computeAndCacheSize(CounterSecretCrushLimit counterSecretCrushLimit) {
            int iH = CodedOutputByteBufferNano.h(1, counterSecretCrushLimit.remaining) + CodedOutputByteBufferNano.h(2, counterSecretCrushLimit.total) + CodedOutputByteBufferNano.h(3, counterSecretCrushLimit.received);
            ((MessageNano) counterSecretCrushLimit).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public CounterSecretCrushLimit m17902parse(nb5 nb5Var) throws IOException {
            CounterSecretCrushLimit counterSecretCrushLimit = new CounterSecretCrushLimit();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 8) {
                    counterSecretCrushLimit.remaining = nb5Var.j();
                } else if (iU == 16) {
                    counterSecretCrushLimit.total = nb5Var.j();
                } else {
                    if (iU != 24) {
                        return counterSecretCrushLimit;
                    }
                    counterSecretCrushLimit.received = nb5Var.j();
                }
            }
        }
        ...
        public void serialize(CounterSecretCrushLimit counterSecretCrushLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.G(1, counterSecretCrushLimit.remaining);
            codedOutputByteBufferNano.G(2, counterSecretCrushLimit.total);
            codedOutputByteBufferNano.G(3, counterSecretCrushLimit.received);
        }
    };
    public static JsonAdapter<CounterSecretCrushLimit> JSON_ADAPTER = new ObjectJsonAdapter<CounterSecretCrushLimit>() { // from class: com.p1.mobile.putong.data.CounterSecretCrushLimit.2
        ...
        public CounterSecretCrushLimit mo17830newInstance() {
    ...
    public CounterSecretCrushLimit m17901clone() {
        CounterSecretCrushLimit counterSecretCrushLimit = new CounterSecretCrushLimit();
