...
public class LiveUserMask extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveUserMask> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveUserMask>() { // from class: com.p1.mobile.putong.data.LiveUserMask.1
        ...
        public int computeAndCacheSize(LiveUserMask liveUserMask) {
            String str = liveUserMask.f239id;
            ...
            int iB = iO + CodedOutputByteBufferNano.b(13, liveUserMask.isFresh);
            LiveAvatarConfig liveAvatarConfig = liveUserMask.avatarConfig;
            if (liveAvatarConfig != null) {
                iB += CodedOutputByteBufferNano.l(14, liveAvatarConfig, LiveAvatarConfig.PROTOBUF_ADAPTER);
            }
            LiveProfileConfig liveProfileConfig = liveUserMask.profileConfig;
            if (liveProfileConfig != null) {
                iB += CodedOutputByteBufferNano.l(15, liveProfileConfig, LiveProfileConfig.PROTOBUF_ADAPTER);
            }
            String str13 = liveUserMask.avatarResourceType;
            if (str13 != null) {
                iB += CodedOutputByteBufferNano.o(16, str13);
            }
            ((MessageNano) liveUserMask).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public LiveUserMask m18409parse(nb5 nb5Var) throws IOException {
            LiveUserMask liveUserMask = new LiveUserMask();
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        if (liveUserMask.f239id == null) {
                            liveUserMask.f239id = "";
                        }
                        ...
                        break;
                    case 10:
                        liveUserMask.f239id = nb5Var.s();
                        continue;
                    case 18:
                        liveUserMask.userId = nb5Var.s();
                        continue;
                    case 26:
                        liveUserMask.fakeId = nb5Var.s();
                        continue;
                    case 34:
                        liveUserMask.originUserId = nb5Var.s();
                        continue;
                    case 42:
                        liveUserMask.type = nb5Var.s();
                        continue;
                    case 50:
                        liveUserMask.fakeType = nb5Var.s();
                        continue;
                    case 58:
                        liveUserMask.name = nb5Var.s();
                        continue;
                    case 66:
                        liveUserMask.avatar = nb5Var.s();
                        continue;
                    case 74:
                        liveUserMask.status = nb5Var.s();
                        continue;
                    case 82:
                        liveUserMask.color = nb5Var.s();
                        continue;
                    case 90:
                        liveUserMask.gender = nb5Var.s();
                        continue;
                    case 98:
                        liveUserMask.icon = nb5Var.s();
                        continue;
                    case 104:
                        liveUserMask.isFresh = nb5Var.g();
                        continue;
                    case 114:
                        liveUserMask.avatarConfig = (LiveAvatarConfig) nb5Var.l(LiveAvatarConfig.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        liveUserMask.profileConfig = (LiveProfileConfig) nb5Var.l(LiveProfileConfig.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        liveUserMask.avatarResourceType = nb5Var.s();
                        continue;
                    default:
                        if (liveUserMask.f239id == null) {
                            liveUserMask.f239id = "";
        ...
        public void serialize(LiveUserMask liveUserMask, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(13, liveUserMask.isFresh);
            LiveAvatarConfig liveAvatarConfig = liveUserMask.avatarConfig;
            if (liveAvatarConfig != null) {
                codedOutputByteBufferNano.K(14, liveAvatarConfig, LiveAvatarConfig.PROTOBUF_ADAPTER);
            }
            LiveProfileConfig liveProfileConfig = liveUserMask.profileConfig;
            if (liveProfileConfig != null) {
                codedOutputByteBufferNano.K(15, liveProfileConfig, LiveProfileConfig.PROTOBUF_ADAPTER);
            }
            String str13 = liveUserMask.avatarResourceType;
            if (str13 != null) {
    ...
    public static JsonAdapter<LiveUserMask> JSON_ADAPTER = new ObjectJsonAdapter<LiveUserMask>() { // from class: com.p1.mobile.putong.data.LiveUserMask.2
        ...
        public LiveUserMask mo17830newInstance() {
        ...
        public boolean parseField(LiveUserMask liveUserMask, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            str.getClass();
            switch (str) {
                case "avatarResourceType":
                    liveUserMask.avatarResourceType = jsonParser.getValueAsString();
                    return true;
                case "profileConfig":
                    liveUserMask.profileConfig = (LiveProfileConfig) LiveProfileConfig.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "avatar":
                    liveUserMask.avatar = jsonParser.getValueAsString();
                    return true;
                case "avatarConfig":
                    liveUserMask.avatarConfig = (LiveAvatarConfig) LiveAvatarConfig.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "fakeId":
                ...
                case "userId":
                    ...
                    return true;
                case "id":
                    liveUserMask.f239id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public LiveUserMask m18408clone() {
        LiveUserMask liveUserMask = new LiveUserMask();
        liveUserMask.f239id = this.f239id;
        ...
        if (liveAvatarConfig != null) {
            liveUserMask.avatarConfig = liveAvatarConfig.m18324clone();
        }
        LiveProfileConfig liveProfileConfig = this.profileConfig;
        if (liveProfileConfig != null) {
            liveUserMask.profileConfig = liveProfileConfig.m18360clone();
        }
