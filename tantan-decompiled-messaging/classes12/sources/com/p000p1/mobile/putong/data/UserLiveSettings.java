...
public class UserLiveSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserLiveSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserLiveSettings>() { // from class: com.p1.mobile.putong.data.UserLiveSettings.1
        ...
        public int computeAndCacheSize(UserLiveSettings userLiveSettings) {
            ...
            if (str != null) {
                iB += CodedOutputByteBufferNano.o(5, str);
            }
            Boolean bool5 = userLiveSettings.voiceWindowEnable;
            if (bool5 != null) {
                iB += CodedOutputByteBufferNano.b(6, bool5.booleanValue());
            }
            ...
            if (bool6 != null) {
                iB += CodedOutputByteBufferNano.b(8, bool6.booleanValue());
            }
            Boolean bool7 = userLiveSettings.hideVoiceOnCall;
            if (bool7 != null) {
                iB += CodedOutputByteBufferNano.b(9, bool7.booleanValue());
            }
            int iH = iB + CodedOutputByteBufferNano.h(10, userLiveSettings.wealthGrade);
            Boolean bool8 = userLiveSettings.hideMomentsWealthTag;
            if (bool8 != null) {
                iH += CodedOutputByteBufferNano.b(11, bool8.booleanValue());
            }
            Boolean bool9 = userLiveSettings.hideProfileWealthTag;
            if (bool9 != null) {
                iH += CodedOutputByteBufferNano.b(12, bool9.booleanValue());
            }
            Boolean bool10 = userLiveSettings.hideSwipeWealthTag;
            if (bool10 != null) {
                iH += CodedOutputByteBufferNano.b(13, bool10.booleanValue());
            }
            Boolean bool11 = userLiveSettings.isDiamondVIP;
            if (bool11 != null) {
                iH += CodedOutputByteBufferNano.b(14, bool11.booleanValue());
            }
            Boolean bool12 = userLiveSettings.hideDiamondTag;
            if (bool12 != null) {
                iH += CodedOutputByteBufferNano.b(15, bool12.booleanValue());
            }
            String str3 = userLiveSettings.pureModeGroup;
            if (str3 != null) {
                iH += CodedOutputByteBufferNano.o(16, str3);
            }
            String str4 = userLiveSettings.showVoiceStatus;
            if (str4 != null) {
                iH += CodedOutputByteBufferNano.o(17, str4);
            }
            String str5 = userLiveSettings.voiceNotification;
            if (str5 != null) {
                iH += CodedOutputByteBufferNano.o(18, str5);
            }
            ((MessageNano) userLiveSettings).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public UserLiveSettings m19187parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userLiveSettings.closeEnterRoomMsg = Boolean.valueOf(nb5Var.g());
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.BLUETOOTH_A2DP /* 16 */:
                        userLiveSettings.closeSmallWindow = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 24:
                        userLiveSettings.teenModeEnable = Boolean.valueOf(nb5Var.g());
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.USB_HEADSET /* 32 */:
                        userLiveSettings.intlAdUser = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 42:
                        userLiveSettings.regionTag = nb5Var.s();
                        continue;
                    case 48:
                        userLiveSettings.voiceWindowEnable = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 58:
                        userLiveSettings.fakeId = nb5Var.s();
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.BLUETOOTH_SCO /* 64 */:
                        userLiveSettings.hideStoppedRoom = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 72:
                        userLiveSettings.hideVoiceOnCall = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 80:
                        userLiveSettings.wealthGrade = nb5Var.j();
                        continue;
                    case 88:
                        userLiveSettings.hideMomentsWealthTag = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 96:
                        userLiveSettings.hideProfileWealthTag = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 104:
                        userLiveSettings.hideSwipeWealthTag = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 112:
                        userLiveSettings.isDiamondVIP = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 120:
                        userLiveSettings.hideDiamondTag = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 130:
                        userLiveSettings.pureModeGroup = nb5Var.s();
                        continue;
                    case 138:
                        userLiveSettings.showVoiceStatus = nb5Var.s();
                        continue;
                    case 146:
                        userLiveSettings.voiceNotification = nb5Var.s();
                        continue;
                    default:
                        if (userLiveSettings.closeEnterRoomMsg == null) {
                            userLiveSettings.closeEnterRoomMsg = Boolean.FALSE;
        ...
        public void serialize(UserLiveSettings userLiveSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.G(10, userLiveSettings.wealthGrade);
            Boolean bool8 = userLiveSettings.hideMomentsWealthTag;
            if (bool8 != null) {
                codedOutputByteBufferNano.A(11, bool8.booleanValue());
            }
            Boolean bool9 = userLiveSettings.hideProfileWealthTag;
            if (bool9 != null) {
                codedOutputByteBufferNano.A(12, bool9.booleanValue());
            }
            Boolean bool10 = userLiveSettings.hideSwipeWealthTag;
            if (bool10 != null) {
                codedOutputByteBufferNano.A(13, bool10.booleanValue());
            }
            Boolean bool11 = userLiveSettings.isDiamondVIP;
            if (bool11 != null) {
                codedOutputByteBufferNano.A(14, bool11.booleanValue());
            }
            Boolean bool12 = userLiveSettings.hideDiamondTag;
            if (bool12 != null) {
                codedOutputByteBufferNano.A(15, bool12.booleanValue());
            }
            String str3 = userLiveSettings.pureModeGroup;
            if (str3 != null) {
                codedOutputByteBufferNano.R(16, str3);
            }
            String str4 = userLiveSettings.showVoiceStatus;
            if (str4 != null) {
                codedOutputByteBufferNano.R(17, str4);
            }
            String str5 = userLiveSettings.voiceNotification;
            if (str5 != null) {
                codedOutputByteBufferNano.R(18, str5);
            }
        }
    };
    public static JsonAdapter<UserLiveSettings> JSON_ADAPTER = new ObjectJsonAdapter<UserLiveSettings>() { // from class: com.p1.mobile.putong.data.UserLiveSettings.2
        ...
        public UserLiveSettings mo17830newInstance() {
        ...
        public boolean parseFieldCheck(UserLiveSettings userLiveSettings, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) {
            ...
            switch (str) {
                case "pureModeGroup":
                case "hideDiamondTag":
                case "hideVoiceOnCall":
                case "fakeId":
                case "intlAdUser":
                case "hideMomentsWealthTag":
                case "hideStoppedRoom":
                case "voiceWindowEnable":
                case "regionTag":
                case "hideProfileWealthTag":
                case "closeEnterRoomMsg":
                case "teenModeEnable":
                case "wealthGrade":
                case "isDiamondVIP":
                case "hideSwipeWealthTag":
                case "closeSmallWindow":
                case "voiceNotification":
                case "showVoiceStatus":
                    return true;
                default:
    ...
    public UserLiveSettings m19186clone() {
        UserLiveSettings userLiveSettings = new UserLiveSettings();
