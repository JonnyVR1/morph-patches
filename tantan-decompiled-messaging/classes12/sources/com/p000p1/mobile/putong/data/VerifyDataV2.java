...
public class VerifyDataV2 extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerifyDataV2> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerifyDataV2>() { // from class: com.p1.mobile.putong.data.VerifyDataV2.1
        ...
        public int computeAndCacheSize(VerifyDataV2 verifyDataV2) {
            int iH = CodedOutputByteBufferNano.h(1, verifyDataV2.countryCode);
            String str = verifyDataV2.mobileNumber;
            if (str != null) {
                iH += CodedOutputByteBufferNano.o(2, str);
            }
            int iH2 = iH + CodedOutputByteBufferNano.h(3, verifyDataV2.code);
            ...
            int iH3 = iH2 + CodedOutputByteBufferNano.h(6, verifyDataV2.codeLength);
            ...
            if (verifyReason2 != null) {
                iH3 += CodedOutputByteBufferNano.l(11, verifyReason2, VerifyReason.PROTOBUF_ADAPTER);
            }
            String str6 = verifyDataV2.email;
            if (str6 != null) {
                iH3 += CodedOutputByteBufferNano.o(12, str6);
            }
            String str7 = verifyDataV2.ttt_signin_token;
            if (str7 != null) {
                iH3 += CodedOutputByteBufferNano.o(13, str7);
            }
            ((MessageNano) verifyDataV2).cachedSize = iH3;
            return iH3;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public VerifyDataV2 m19295parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        verifyDataV2.countryCode = nb5Var.j();
                        continue;
                    case 18:
                        verifyDataV2.mobileNumber = nb5Var.s();
                        continue;
                    case 24:
                        verifyDataV2.code = nb5Var.j();
                        continue;
                    case 34:
                        verifyDataV2.language = nb5Var.s();
                        continue;
                    case 40:
                        numValueOf = Integer.valueOf(nb5Var.j());
                        continue;
                    case 48:
                        verifyDataV2.codeLength = nb5Var.j();
                        continue;
                    case 58:
                        verifyDataV2.device = (Device) nb5Var.l(Device.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        verifyDataV2.clientId = nb5Var.s();
                        continue;
                    case 74:
                        verifyDataV2.category = nb5Var.s();
                        continue;
                    case 82:
                        verifyDataV2.userId = nb5Var.s();
                        continue;
                    case 90:
                        verifyDataV2.action = (VerifyReason) nb5Var.l(VerifyReason.PROTOBUF_ADAPTER);
                        continue;
                    case 98:
                        verifyDataV2.email = nb5Var.s();
                        continue;
                    case 106:
                        verifyDataV2.ttt_signin_token = nb5Var.s();
                        continue;
                    default:
                        if (verifyDataV2.action == null && numValueOf != null) {
                            verifyDataV2.action = (VerifyReason) VerifyReason.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(VerifyDataV2 verifyDataV2, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.G(1, verifyDataV2.countryCode);
            String str = verifyDataV2.mobileNumber;
            if (str != null) {
                codedOutputByteBufferNano.R(2, str);
            }
            codedOutputByteBufferNano.G(3, verifyDataV2.code);
            String str2 = verifyDataV2.language;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.G(6, verifyDataV2.codeLength);
            Device device = verifyDataV2.device;
            if (device != null) {
            ...
            VerifyReason verifyReason2 = verifyDataV2.action;
            if (verifyReason2 != null) {
                codedOutputByteBufferNano.K(11, verifyReason2, VerifyReason.PROTOBUF_ADAPTER);
            }
            String str6 = verifyDataV2.email;
            if (str6 != null) {
    ...
    public static JsonAdapter<VerifyDataV2> JSON_ADAPTER = new ObjectJsonAdapter<VerifyDataV2>() { // from class: com.p1.mobile.putong.data.VerifyDataV2.2
        ...
        public VerifyDataV2 mo17830newInstance() {
        ...
        public boolean parseField(VerifyDataV2 verifyDataV2, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "countryCode":
                    ...
                    return true;
                case "action":
                    verifyDataV2.action = (VerifyReason) VerifyReason.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "device":
                    verifyDataV2.device = (Device) Device.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "codeLength":
        ...
        public void serializeFields(VerifyDataV2 verifyDataV2, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("countryCode", verifyDataV2.countryCode);
            String str = verifyDataV2.mobileNumber;
            if (str != null) {
            ...
            String str6 = verifyDataV2.email;
            if (str6 != null) {
                jsonGenerator.writeStringField(SignInGrantType.email, str6);
            }
            String str7 = verifyDataV2.ttt_signin_token;
            if (str7 != null) {
    ...
    public static VerifyDataV2 v1ConvertV2(VerifyData verifyData) {
        ...
        verifyDataV2New_.userId = qib0.c0.userId();
    ...
    public VerifyDataV2 m19294clone() {
        VerifyDataV2 verifyDataV2 = new VerifyDataV2();
        ...
        if (device != null) {
            verifyDataV2.device = device.m17967clone();
        }
