...
public class Order extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Order> PROTOBUF_ADAPTER = new MessageNanoAdapter<Order>() { // from class: com.p1.mobile.putong.data.Order.1
        ...
        public int computeAndCacheSize(Order order) {
            ...
            if (payMethod != null) {
                iO += CodedOutputByteBufferNano.h(3, payMethod.ordinal());
            }
            BundleStatus bundleStatus = order.orderStatus;
            if (bundleStatus != null) {
                iO += CodedOutputByteBufferNano.h(4, bundleStatus.ordinal());
            }
            ...
            if (bundleStatus2 != null) {
                iO += CodedOutputByteBufferNano.h(7, bundleStatus2.ordinal());
            }
            ...
            if (gPAffiliateTransaction != null) {
                iO += CodedOutputByteBufferNano.l(9, gPAffiliateTransaction, GPAffiliateTransaction.PROTOBUF_ADAPTER);
            }
            ...
            if (payMethod2 != null) {
                iO += CodedOutputByteBufferNano.l(11, payMethod2, PayMethod.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus3 = order.orderStatus;
            if (bundleStatus3 != null) {
                iO += CodedOutputByteBufferNano.l(12, bundleStatus3, BundleStatus.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus4 = order.contractStatus;
            if (bundleStatus4 != null) {
                iO += CodedOutputByteBufferNano.l(13, bundleStatus4, BundleStatus.PROTOBUF_ADAPTER);
            }
            ((MessageNano) order).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Order m18747parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        order.orderId = nb5Var.s();
                        continue;
                    case 18:
                        order.itemId = nb5Var.s();
                        continue;
                    case 24:
                    ...
                    case AudioRouteDeviceManager.RoutingDeviceType.USB_HEADSET /* 32 */:
                        ...
                        continue;
                    case 42:
                        order.paymentRequest = nb5Var.s();
                        continue;
                    case 50:
                        order.contractId = nb5Var.s();
                        continue;
                    case 56:
                        numValueOf3 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 66:
                        order.signRequest = nb5Var.s();
                        continue;
                    case 74:
                        order.affiliateTransaction = (GPAffiliateTransaction) nb5Var.l(GPAffiliateTransaction.PROTOBUF_ADAPTER);
                        continue;
                    case 82:
                        order.signAndPayRequest = nb5Var.s();
                        continue;
                    case 90:
                        order.payMethod = (PayMethod) nb5Var.l(PayMethod.PROTOBUF_ADAPTER);
                        continue;
                    case 98:
                        order.orderStatus = (BundleStatus) nb5Var.l(BundleStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        order.contractStatus = (BundleStatus) nb5Var.l(BundleStatus.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (order.payMethod == null && numValueOf != null) {
                            order.payMethod = (PayMethod) PayMethod.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Order order, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            PayMethod payMethod = order.payMethod;
            if (payMethod != null) {
                codedOutputByteBufferNano.G(3, payMethod.ordinal());
            }
            BundleStatus bundleStatus = order.orderStatus;
            if (bundleStatus != null) {
                codedOutputByteBufferNano.G(4, bundleStatus.ordinal());
            }
            String str3 = order.paymentRequest;
            if (str3 != null) {
            ...
            BundleStatus bundleStatus2 = order.contractStatus;
            if (bundleStatus2 != null) {
                codedOutputByteBufferNano.G(7, bundleStatus2.ordinal());
            }
            String str5 = order.signRequest;
            if (str5 != null) {
            ...
            GPAffiliateTransaction gPAffiliateTransaction = order.affiliateTransaction;
            if (gPAffiliateTransaction != null) {
                codedOutputByteBufferNano.K(9, gPAffiliateTransaction, GPAffiliateTransaction.PROTOBUF_ADAPTER);
            }
            String str6 = order.signAndPayRequest;
            if (str6 != null) {
            ...
            PayMethod payMethod2 = order.payMethod;
            if (payMethod2 != null) {
                codedOutputByteBufferNano.K(11, payMethod2, PayMethod.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus3 = order.orderStatus;
            if (bundleStatus3 != null) {
                codedOutputByteBufferNano.K(12, bundleStatus3, BundleStatus.PROTOBUF_ADAPTER);
            }
            BundleStatus bundleStatus4 = order.contractStatus;
            if (bundleStatus4 != null) {
                codedOutputByteBufferNano.K(13, bundleStatus4, BundleStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Order> JSON_ADAPTER = new ObjectJsonAdapter<Order>() { // from class: com.p1.mobile.putong.data.Order.2
        ...
        public Order mo17830newInstance() {
            return new Order();
        }
        ...
        public boolean parseField(Order order, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "affiliateTransaction":
                    order.affiliateTransaction = (GPAffiliateTransaction) GPAffiliateTransaction.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "orderId":
                ...
                case "itemId":
                    ...
                    return true;
                case "payMethod":
                    order.payMethod = (PayMethod) PayMethod.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "signRequest":
                ...
                case "contractId":
                    ...
                    return true;
                case "contractStatus":
                    order.contractStatus = (BundleStatus) BundleStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "signAndPayRequest":
                    order.signAndPayRequest = jsonParser.getValueAsString();
                    return true;
                case "orderStatus":
                    order.orderStatus = (BundleStatus) BundleStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                default:
                    return false;
            }
    ...
    public Order m18746clone() {
        ...
        if (gPAffiliateTransaction != null) {
            order.affiliateTransaction = gPAffiliateTransaction.m18129clone();
        }
