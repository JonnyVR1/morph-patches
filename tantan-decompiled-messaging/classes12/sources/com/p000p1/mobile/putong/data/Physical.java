...
import com.p000p1.mobile.putong.data.Physical;
...
public class Physical extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Physical> PROTOBUF_ADAPTER = new MessageNanoAdapter<Physical>() { // from class: com.p1.mobile.putong.data.Physical.1
        ...
        public int computeAndCacheSize(Physical physical) {
            ...
            int iL = list != null ? CodedOutputByteBufferNano.l(1, BloodType.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            List<BloodType> list2 = physical.bloodType;
            if (list2 != null) {
                iL += CodedOutputByteBufferNano.l(2, list2, BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            ((MessageNano) physical).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Physical m18798parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    ...
                    physical.bloodType = (List) nb5Var.l(BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 26) {
                    physical.height = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 34) {
                    physical.heightImg = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 42) {
                    physical.weight = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 50) {
                    physical.fitness = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 58) {
                    physical.drink = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iU != 66) {
                        if (physical.bloodType == null && list != null) {
                            physical.bloodType = BloodType.oldEnumCovertList(list);
                    ...
                    physical.smoke = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return physical;
        }
        ...
        public void serialize(Physical physical, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<BloodType> list = physical.bloodType;
            if (list != null) {
                codedOutputByteBufferNano.K(1, BloodType.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<BloodType> list2 = physical.bloodType;
            if (list2 != null) {
                codedOutputByteBufferNano.K(2, list2, BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list3 = physical.height;
            if (list3 != null) {
    ...
    public static JsonAdapter<Physical> JSON_ADAPTER = new ObjectJsonAdapter<Physical>() { // from class: com.p1.mobile.putong.data.Physical.2
        ...
        public Physical mo17830newInstance() {
            return new Physical();
        }
    ...
    public static /* synthetic */ String m904a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m905b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m906c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m907d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ BloodType m908e(BloodType bloodType) {
        return bloodType;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m909f(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m910k(String str) {
        return str;
    }
    ...
    public Physical m18797clone() {
        ...
        if (list2 != null) {
            physical.height = ValueObject.util_map(list2, new w9j() { // from class: l.vb70
                public final Object call(Object obj) {
                    return Physical.m904a((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            physical.heightImg = ValueObject.util_map(list3, new w9j() { // from class: l.wb70
                public final Object call(Object obj) {
                    return Physical.m906c((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            physical.weight = ValueObject.util_map(list4, new w9j() { // from class: l.xb70
                public final Object call(Object obj) {
                    return Physical.m907d((String) obj);
                }
            });
        }
        ...
        if (list5 != null) {
            physical.fitness = ValueObject.util_map(list5, new w9j() { // from class: l.yb70
                public final Object call(Object obj) {
                    return Physical.m909f((String) obj);
                }
            });
        }
        ...
        if (list6 != null) {
            physical.drink = ValueObject.util_map(list6, new w9j() { // from class: l.zb70
                public final Object call(Object obj) {
                    return Physical.m910k((String) obj);
                }
            });
        }
        ...
        if (list7 != null) {
            physical.smoke = ValueObject.util_map(list7, new w9j() { // from class: l.ac70
                public final Object call(Object obj) {
                    return Physical.m905b((String) obj);
                }
            });
        }
        return physical;
