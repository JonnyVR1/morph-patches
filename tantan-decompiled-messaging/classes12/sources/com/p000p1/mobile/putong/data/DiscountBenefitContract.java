...
public class DiscountBenefitContract extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DiscountBenefitContract> PROTOBUF_ADAPTER = new MessageNanoAdapter<DiscountBenefitContract>() { // from class: com.p1.mobile.putong.data.DiscountBenefitContract.1
        ...
        public int computeAndCacheSize(DiscountBenefitContract discountBenefitContract) {
            ...
            int iO = (str != null ? CodedOutputByteBufferNano.o(1, str) : 0) + CodedOutputByteBufferNano.h(2, discountBenefitContract.value);
            ...
            if (privilegesChangeContract != null) {
                iO += CodedOutputByteBufferNano.l(4, privilegesChangeContract, PrivilegesChangeContract.PROTOBUF_ADAPTER);
            }
            int iB = iO + CodedOutputByteBufferNano.b(5, discountBenefitContract.hasPrivilegesChange);
            ((MessageNano) discountBenefitContract).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public DiscountBenefitContract m17992parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    discountBenefitContract.discountType = nb5Var.s();
                } else if (iU == 16) {
                    discountBenefitContract.value = nb5Var.j();
                } else if (iU == 26) {
                    discountBenefitContract.showDiscount = nb5Var.s();
                } else if (iU == 34) {
                    discountBenefitContract.privilegesChange = (PrivilegesChangeContract) nb5Var.l(PrivilegesChangeContract.PROTOBUF_ADAPTER);
                } else {
                    if (iU != 40) {
                        if (discountBenefitContract.discountType == null) {
                            discountBenefitContract.discountType = "";
                    ...
                    discountBenefitContract.hasPrivilegesChange = nb5Var.g();
                }
            }
            return discountBenefitContract;
        }
        ...
        public void serialize(DiscountBenefitContract discountBenefitContract, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.G(2, discountBenefitContract.value);
            String str2 = discountBenefitContract.showDiscount;
            if (str2 != null) {
            ...
            PrivilegesChangeContract privilegesChangeContract = discountBenefitContract.privilegesChange;
            if (privilegesChangeContract != null) {
                codedOutputByteBufferNano.K(4, privilegesChangeContract, PrivilegesChangeContract.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(5, discountBenefitContract.hasPrivilegesChange);
        }
    };
    public static JsonAdapter<DiscountBenefitContract> JSON_ADAPTER = new ObjectJsonAdapter<DiscountBenefitContract>() { // from class: com.p1.mobile.putong.data.DiscountBenefitContract.2
        ...
        public DiscountBenefitContract mo17830newInstance() {
        ...
        public boolean parseField(DiscountBenefitContract discountBenefitContract, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "privilegesChange":
                    discountBenefitContract.privilegesChange = (PrivilegesChangeContract) PrivilegesChangeContract.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
    ...
    public DiscountBenefitContract m17991clone() {
        DiscountBenefitContract discountBenefitContract = new DiscountBenefitContract();
        ...
        if (privilegesChangeContract != null) {
            discountBenefitContract.privilegesChange = privilegesChangeContract.m18831clone();
        }
