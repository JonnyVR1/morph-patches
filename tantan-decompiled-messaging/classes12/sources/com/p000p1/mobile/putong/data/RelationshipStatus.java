...
public class RelationshipStatus extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(superliked, int_superliked);
        tEnumJsonAdapter.addExtJsonValue(lettered, int_lettered);
        ...
        _RelationshipStatus = Collections.synchronizedMap(new e01());
    }
