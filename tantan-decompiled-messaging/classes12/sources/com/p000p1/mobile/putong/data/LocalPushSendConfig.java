...
public class LocalPushSendConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LocalPushSendConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<LocalPushSendConfig>() { // from class: com.p1.mobile.putong.data.LocalPushSendConfig.1
        ...
        public int computeAndCacheSize(LocalPushSendConfig localPushSendConfig) {
            int iJ = CodedOutputByteBufferNano.j(1, localPushSendConfig.update_time) + CodedOutputByteBufferNano.h(2, localPushSendConfig.today_send_size) + CodedOutputByteBufferNano.h(3, localPushSendConfig.today_home_send_size);
            ((MessageNano) localPushSendConfig).cachedSize = iJ;
            return iJ;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public LocalPushSendConfig m18415parse(nb5 nb5Var) throws IOException {
            LocalPushSendConfig localPushSendConfig = new LocalPushSendConfig();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 8) {
                    localPushSendConfig.update_time = nb5Var.k();
                } else if (iU == 16) {
                    localPushSendConfig.today_send_size = nb5Var.j();
                } else {
                    if (iU != 24) {
                        return localPushSendConfig;
                    }
                    localPushSendConfig.today_home_send_size = nb5Var.j();
                }
            }
        }
        ...
        public void serialize(LocalPushSendConfig localPushSendConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.I(1, localPushSendConfig.update_time);
            codedOutputByteBufferNano.G(2, localPushSendConfig.today_send_size);
            codedOutputByteBufferNano.G(3, localPushSendConfig.today_home_send_size);
        }
    };
    public static JsonAdapter<LocalPushSendConfig> JSON_ADAPTER = new ObjectJsonAdapter<LocalPushSendConfig>() { // from class: com.p1.mobile.putong.data.LocalPushSendConfig.2
        ...
        public LocalPushSendConfig mo17830newInstance() {
    ...
    public LocalPushSendConfig m18414clone() {
        LocalPushSendConfig localPushSendConfig = new LocalPushSendConfig();
