...
public class UserFakeSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserFakeSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserFakeSettings>() { // from class: com.p1.mobile.putong.data.UserFakeSettings.1
        ...
        public int computeAndCacheSize(UserFakeSettings userFakeSettings) {
            ...
            if (bool2 != null) {
                iB += CodedOutputByteBufferNano.b(3, bool2.booleanValue());
            }
            Boolean bool3 = userFakeSettings.weeklyReportPush;
            if (bool3 != null) {
                iB += CodedOutputByteBufferNano.b(4, bool3.booleanValue());
            }
            NotificationNoDisturb notificationNoDisturb = userFakeSettings.noDisturb;
            if (notificationNoDisturb != null) {
                iB += CodedOutputByteBufferNano.l(5, notificationNoDisturb, NotificationNoDisturb.PROTOBUF_ADAPTER);
            }
            Boolean bool4 = userFakeSettings.syncMoment;
            if (bool4 != null) {
                iB += CodedOutputByteBufferNano.b(6, bool4.booleanValue());
            }
            ...
            if (settingsIntent != null) {
                iB += CodedOutputByteBufferNano.h(9, settingsIntent.ordinal());
            }
            SettingsIntent settingsIntent2 = userFakeSettings.intent;
            if (settingsIntent2 != null) {
                iB += CodedOutputByteBufferNano.l(10, settingsIntent2, SettingsIntent.PROTOBUF_ADAPTER);
            }
            ((MessageNano) userFakeSettings).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public UserFakeSettings m19175parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userFakeSettings.momentPush = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 18:
                        userFakeSettings.sound = nb5Var.s();
                        continue;
                    case 24:
                        userFakeSettings.dailyReportPush = Boolean.valueOf(nb5Var.g());
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.USB_HEADSET /* 32 */:
                        userFakeSettings.weeklyReportPush = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 42:
                        userFakeSettings.noDisturb = (NotificationNoDisturb) nb5Var.l(NotificationNoDisturb.PROTOBUF_ADAPTER);
                        continue;
                    case 48:
                        userFakeSettings.syncMoment = Boolean.valueOf(nb5Var.g());
                        continue;
                    case 58:
                        userFakeSettings.locationName = nb5Var.s();
                        continue;
                    case 66:
                        userFakeSettings.locationAddress = nb5Var.s();
                        continue;
                    case 72:
                        numValueOf = Integer.valueOf(nb5Var.j());
                        continue;
                    case 82:
                        userFakeSettings.intent = (SettingsIntent) nb5Var.l(SettingsIntent.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (userFakeSettings.intent == null && numValueOf != null) {
                            userFakeSettings.intent = (SettingsIntent) SettingsIntent.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(UserFakeSettings userFakeSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            NotificationNoDisturb notificationNoDisturb = userFakeSettings.noDisturb;
            if (notificationNoDisturb != null) {
                codedOutputByteBufferNano.K(5, notificationNoDisturb, NotificationNoDisturb.PROTOBUF_ADAPTER);
            }
            Boolean bool4 = userFakeSettings.syncMoment;
            if (bool4 != null) {
            ...
            SettingsIntent settingsIntent = userFakeSettings.intent;
            if (settingsIntent != null) {
                codedOutputByteBufferNano.G(9, settingsIntent.ordinal());
            }
            SettingsIntent settingsIntent2 = userFakeSettings.intent;
            if (settingsIntent2 != null) {
                codedOutputByteBufferNano.K(10, settingsIntent2, SettingsIntent.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<UserFakeSettings> JSON_ADAPTER = new ObjectJsonAdapter<UserFakeSettings>() { // from class: com.p1.mobile.putong.data.UserFakeSettings.2
        ...
        public UserFakeSettings mo17830newInstance() {
        ...
        public boolean parseField(UserFakeSettings userFakeSettings, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                case 0:
                    userFakeSettings.noDisturb = (NotificationNoDisturb) NotificationNoDisturb.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case 1:
                ...
                case 2:
                    ...
                    return true;
                case 3:
                    userFakeSettings.intent = (SettingsIntent) SettingsIntent.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case 4:
    ...
    public UserFakeSettings m19174clone() {
        UserFakeSettings userFakeSettings = new UserFakeSettings();
        ...
        if (notificationNoDisturb != null) {
            userFakeSettings.noDisturb = notificationNoDisturb.m18545clone();
        }
