...
import com.p000p1.mobile.putong.data.Membership;
import com.p000p1.mobile.putong.data.PrivateAnswer;
...
public class User extends DbObject<User> implements Cloneable, Serializable {
    ...
    public static final int f287ME = 4;
    ...
    @ProtobufIndex(index = GivenGiftBrief.MIDDLE_GIFT_LEVEL)
    ...
    public static ProtobufAdapter<User> PROTOBUF_ADAPTER = new MessageNanoAdapter<User>() { // from class: com.p1.mobile.putong.data.User.1
        ...
        public int computeAndCacheSize(User user) {
            int iJ = CodedOutputByteBufferNano.j(1, ((DbObject) user)._id);
            ...
            if (location != null) {
                iJ += CodedOutputByteBufferNano.l(52, location, Location.PROTOBUF_ADAPTER);
            }
            ...
            if (num != null) {
                iJ += CodedOutputByteBufferNano.h(54, num.intValue());
            }
            List<Media> list = user.pictures;
            if (list != null) {
                iJ += CodedOutputByteBufferNano.l(55, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iD = iJ + CodedOutputByteBufferNano.d(56, user.createdTime);
            Profile profile = user.profile;
            if (profile != null) {
                iD += CodedOutputByteBufferNano.l(57, profile, Profile.PROTOBUF_ADAPTER);
            }
            List<UserStatus> list2 = user.status;
            if (list2 != null) {
                iD += CodedOutputByteBufferNano.l(58, UserStatus.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Settings settings = user.settings;
            if (settings != null) {
                iD += CodedOutputByteBufferNano.l(59, settings, Settings.PROTOBUF_ADAPTER);
            }
            Gender gender = user.gender;
            if (gender != null) {
                iD += CodedOutputByteBufferNano.h(60, gender.ordinal());
            }
            Relationship relationship = user.localRelationship;
            if (relationship != null) {
                iD += CodedOutputByteBufferNano.l(61, relationship, Relationship.PROTOBUF_ADAPTER);
            }
            Membership membership = user.membership;
            if (membership != null) {
                iD += CodedOutputByteBufferNano.l(62, membership, Membership.PROTOBUF_ADAPTER);
            }
            UserSource userSource = user.source;
            if (userSource != null) {
                iD += CodedOutputByteBufferNano.h(63, userSource.ordinal());
            }
            String str4 = user.realName;
            if (str4 != null) {
                iD += CodedOutputByteBufferNano.o(64, str4);
            }
            Followship followship = user.localFollowship;
            if (followship != null) {
                iD += CodedOutputByteBufferNano.l(65, followship, Followship.PROTOBUF_ADAPTER);
            }
            List<Membership> list3 = user.memberships;
            if (list3 != null) {
                iD += CodedOutputByteBufferNano.l(66, list3, Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = user.nameRemark;
            if (str5 != null) {
                iD += CodedOutputByteBufferNano.o(67, str5);
            }
            UserState userState = user.state;
            if (userState != null) {
                iD += CodedOutputByteBufferNano.l(68, userState, UserState.PROTOBUF_ADAPTER);
            }
            PicVerification picVerification = user.verifications;
            if (picVerification != null) {
                iD += CodedOutputByteBufferNano.l(69, picVerification, PicVerification.PROTOBUF_ADAPTER);
            }
            List<String> list4 = user.abGroups;
            if (list4 != null) {
                iD += CodedOutputByteBufferNano.l(70, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<PrivateAnswer> list5 = user.privateAnswers;
            if (list5 != null) {
                iD += CodedOutputByteBufferNano.l(71, list5, PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Membership membership2 = user.peepership;
            if (membership2 != null) {
                iD += CodedOutputByteBufferNano.l(72, membership2, Membership.PROTOBUF_ADAPTER);
            }
            int iJ2 = iD + CodedOutputByteBufferNano.j(73, user.picksExpiredTimestamp) + CodedOutputByteBufferNano.b(74, user.picksSwipable);
            String str6 = user.picksTag;
            if (str6 != null) {
                iJ2 += CodedOutputByteBufferNano.o(75, str6);
            }
            UserCreditData userCreditData = user.credit;
            if (userCreditData != null) {
                iJ2 += CodedOutputByteBufferNano.l(76, userCreditData, UserCreditData.PROTOBUF_ADAPTER);
            }
            int iD2 = iJ2 + CodedOutputByteBufferNano.d(77, user.goPlaceTimestamp) + CodedOutputByteBufferNano.b(78, user.isLord) + CodedOutputByteBufferNano.d(79, user.privateAnswersUpdatedTime);
            String str7 = user.sendLetter;
            if (str7 != null) {
                iD2 += CodedOutputByteBufferNano.o(80, str7);
            }
            int iJ3 = iD2 + CodedOutputByteBufferNano.j(81, user.sendLetterTimestamp);
            String str8 = user.receivedLetter;
            if (str8 != null) {
                iJ3 += CodedOutputByteBufferNano.o(82, str8);
            }
            int iJ4 = iJ3 + CodedOutputByteBufferNano.j(83, user.receivedLetterTimestamp) + CodedOutputByteBufferNano.h(84, user.popLevel);
            AudioSignature audioSignature = user.voice;
            if (audioSignature != null) {
                iJ4 += CodedOutputByteBufferNano.l(85, audioSignature, AudioSignature.PROTOBUF_ADAPTER);
            }
            int iB = iJ4 + CodedOutputByteBufferNano.b(86, user.datingMode);
            UssTags ussTags = user.ussTags;
            if (ussTags != null) {
                iB += CodedOutputByteBufferNano.l(87, ussTags, UssTags.PROTOBUF_ADAPTER);
            }
            UserAbroad userAbroad = user.abroad;
            if (userAbroad != null) {
                iB += CodedOutputByteBufferNano.l(88, userAbroad, UserAbroad.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem = user.fakeStatus;
            if (statusesItem != null) {
                iB += CodedOutputByteBufferNano.l(89, statusesItem, StatusesItem.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem2 = user.nameStatus;
            if (statusesItem2 != null) {
                iB += CodedOutputByteBufferNano.l(90, statusesItem2, StatusesItem.PROTOBUF_ADAPTER);
            }
            int iB2 = iB + CodedOutputByteBufferNano.b(91, user.displayAudit);
            VisitPlace visitPlace = user.visitPlace;
            if (visitPlace != null) {
                iB2 += CodedOutputByteBufferNano.l(92, visitPlace, VisitPlace.PROTOBUF_ADAPTER);
            }
            String str9 = user.publicId;
            if (str9 != null) {
                iB2 += CodedOutputByteBufferNano.o(93, str9);
            }
            UserSoulSettings userSoulSettings = user.soulSettings;
            if (userSoulSettings != null) {
                iB2 += CodedOutputByteBufferNano.l(94, userSoulSettings, UserSoulSettings.PROTOBUF_ADAPTER);
            }
            int iH = iB2 + CodedOutputByteBufferNano.h(95, user.richListPosition);
            String str10 = user.richListTracker;
            if (str10 != null) {
                iH += CodedOutputByteBufferNano.o(96, str10);
            }
            int iD3 = iH + CodedOutputByteBufferNano.d(97, user.diamondVIPExpiresTime);
            String str11 = user.aiTag;
            if (str11 != null) {
                iD3 += CodedOutputByteBufferNano.o(98, str11);
            }
            FriendCommentInfo friendCommentInfo = user.friendCommentInfo;
            if (friendCommentInfo != null) {
                iD3 += CodedOutputByteBufferNano.l(99, friendCommentInfo, FriendCommentInfo.PROTOBUF_ADAPTER);
            }
            int iH2 = iD3 + CodedOutputByteBufferNano.h(100, user.minRichListPosition);
            String str12 = user.ussTracker;
            if (str12 != null) {
                iH2 += CodedOutputByteBufferNano.o(101, str12);
            }
            int iJ5 = iH2 + CodedOutputByteBufferNano.j(102, user.localLatestReceivedMessageTime);
            LiveUserLevel liveUserLevel = user.hierarchy;
            if (liveUserLevel != null) {
                iJ5 += CodedOutputByteBufferNano.l(103, liveUserLevel, LiveUserLevel.PROTOBUF_ADAPTER);
            }
            SoulShip soulShip = user.localSoulShip;
            if (soulShip != null) {
                iJ5 += CodedOutputByteBufferNano.l(104, soulShip, SoulShip.PROTOBUF_ADAPTER);
            }
            int iD4 = iJ5 + CodedOutputByteBufferNano.d(105, user.signupTime);
            BanStatus banStatus = user.banStatus;
            if (banStatus != null) {
                iD4 += CodedOutputByteBufferNano.l(106, banStatus, BanStatus.PROTOBUF_ADAPTER);
            }
            List<String> list6 = user.localDiamondPrivateMatchTags;
            if (list6 != null) {
                iD4 += CodedOutputByteBufferNano.l(107, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            AnonymousLikeInfo anonymousLikeInfo = user.anonymousLike;
            if (anonymousLikeInfo != null) {
                iD4 += CodedOutputByteBufferNano.l(108, anonymousLikeInfo, AnonymousLikeInfo.PROTOBUF_ADAPTER);
            }
            int iB3 = iD4 + CodedOutputByteBufferNano.b(109, user.inactivated);
            List<UserStatus> list7 = user.status;
            if (list7 != null) {
                iB3 += CodedOutputByteBufferNano.l(110, list7, UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Gender gender2 = user.gender;
            if (gender2 != null) {
                iB3 += CodedOutputByteBufferNano.l(111, gender2, Gender.PROTOBUF_ADAPTER);
            }
            UserSource userSource2 = user.source;
            if (userSource2 != null) {
                iB3 += CodedOutputByteBufferNano.l(112, userSource2, UserSource.PROTOBUF_ADAPTER);
            }
            ActivityUser activityUser = user.activityUser;
            if (activityUser != null) {
                iB3 += CodedOutputByteBufferNano.l(113, activityUser, ActivityUser.PROTOBUF_ADAPTER);
            }
            int iB4 = iB3 + CodedOutputByteBufferNano.b(114, user.matePlanUser) + CodedOutputByteBufferNano.b(115, user.matePlanAdUser);
            String str13 = user.regionTag;
            if (str13 != null) {
                iB4 += CodedOutputByteBufferNano.o(116, str13);
            }
            List<String> list8 = user.localLikeIdentifiers;
            if (list8 != null) {
                iB4 += CodedOutputByteBufferNano.l(117, list8, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iB5 = iB4 + CodedOutputByteBufferNano.b(118, user.deleted);
            SpecialEffect specialEffect = user.specialEffect;
            if (specialEffect != null) {
                iB5 += CodedOutputByteBufferNano.l(119, specialEffect, SpecialEffect.PROTOBUF_ADAPTER);
            }
            UserActivityInfo userActivityInfo = user.userActivityInfo;
            if (userActivityInfo != null) {
                iB5 += CodedOutputByteBufferNano.l(120, userActivityInfo, UserActivityInfo.PROTOBUF_ADAPTER);
            }
            ((MessageNano) user).cachedSize = iB5;
            return iB5;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public User m19151parse(nb5 nb5Var) throws IOException {
            User user = new User();
            List list = null;
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        ((DbObject) user)._id = nb5Var.k();
                        continue;
                    case 18:
                        ((DbObject) user).id = nb5Var.s();
                        continue;
                    case 410:
                        user.name = nb5Var.s();
                        continue;
                    case 418:
                        user.location = (Location) nb5Var.l(Location.PROTOBUF_ADAPTER);
                        continue;
                    case 426:
                        user.description = nb5Var.s();
                        continue;
                    case 432:
                        user.age = Integer.valueOf(nb5Var.j());
                        continue;
                    case 442:
                        user.pictures = (List) nb5Var.l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 449:
                        user.createdTime = nb5Var.h();
                        continue;
                    case 458:
                        user.profile = (Profile) nb5Var.l(Profile.PROTOBUF_ADAPTER);
                        continue;
                    case 466:
                        list = (List) nb5Var.l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 474:
                        user.settings = (Settings) nb5Var.l(Settings.PROTOBUF_ADAPTER);
                        continue;
                    case 480:
                        numValueOf = Integer.valueOf(nb5Var.j());
                        continue;
                    case 490:
                        user.localRelationship = (Relationship) nb5Var.l(Relationship.PROTOBUF_ADAPTER);
                        continue;
                    case 498:
                        user.membership = (Membership) nb5Var.l(Membership.PROTOBUF_ADAPTER);
                        continue;
                    case 504:
                        numValueOf2 = Integer.valueOf(nb5Var.j());
                        continue;
                    case 514:
                        user.realName = nb5Var.s();
                        continue;
                    case 522:
                        user.localFollowship = (Followship) nb5Var.l(Followship.PROTOBUF_ADAPTER);
                        continue;
                    case 530:
                        user.memberships = (List) nb5Var.l(Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 538:
                        user.nameRemark = nb5Var.s();
                        continue;
                    case 546:
                        user.state = (UserState) nb5Var.l(UserState.PROTOBUF_ADAPTER);
                        continue;
                    case 554:
                        user.verifications = (PicVerification) nb5Var.l(PicVerification.PROTOBUF_ADAPTER);
                        continue;
                    case 562:
                        user.abGroups = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 570:
                        user.privateAnswers = (List) nb5Var.l(PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 578:
                        user.peepership = (Membership) nb5Var.l(Membership.PROTOBUF_ADAPTER);
                        continue;
                    case 584:
                        user.picksExpiredTimestamp = nb5Var.k();
                        continue;
                    case 592:
                        user.picksSwipable = nb5Var.g();
                        continue;
                    case 602:
                        user.picksTag = nb5Var.s();
                        continue;
                    case 610:
                        user.credit = (UserCreditData) nb5Var.l(UserCreditData.PROTOBUF_ADAPTER);
                        continue;
                    case 617:
                        user.goPlaceTimestamp = nb5Var.h();
                        continue;
                    case 624:
                        user.isLord = nb5Var.g();
                        continue;
                    case 633:
                        user.privateAnswersUpdatedTime = nb5Var.h();
                        continue;
                    case 642:
                        user.sendLetter = nb5Var.s();
                        continue;
                    case 648:
                        user.sendLetterTimestamp = nb5Var.k();
                        continue;
                    case 658:
                        user.receivedLetter = nb5Var.s();
                        continue;
                    case 664:
                        user.receivedLetterTimestamp = nb5Var.k();
                        continue;
                    case 672:
                        user.popLevel = nb5Var.j();
                        continue;
                    case 682:
                        user.voice = (AudioSignature) nb5Var.l(AudioSignature.PROTOBUF_ADAPTER);
                        continue;
                    case 688:
                        user.datingMode = nb5Var.g();
                        continue;
                    case 698:
                        user.ussTags = (UssTags) nb5Var.l(UssTags.PROTOBUF_ADAPTER);
                        continue;
                    case 706:
                        user.abroad = (UserAbroad) nb5Var.l(UserAbroad.PROTOBUF_ADAPTER);
                        continue;
                    case 714:
                        user.fakeStatus = (StatusesItem) nb5Var.l(StatusesItem.PROTOBUF_ADAPTER);
                        continue;
                    case 722:
                        user.nameStatus = (StatusesItem) nb5Var.l(StatusesItem.PROTOBUF_ADAPTER);
                        continue;
                    case 728:
                        user.displayAudit = nb5Var.g();
                        continue;
                    case 738:
                        user.visitPlace = (VisitPlace) nb5Var.l(VisitPlace.PROTOBUF_ADAPTER);
                        continue;
                    case 746:
                        user.publicId = nb5Var.s();
                        continue;
                    case 754:
                        user.soulSettings = (UserSoulSettings) nb5Var.l(UserSoulSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 760:
                        user.richListPosition = nb5Var.j();
                        continue;
                    case 770:
                        user.richListTracker = nb5Var.s();
                        continue;
                    case 777:
                        user.diamondVIPExpiresTime = nb5Var.h();
                        continue;
                    case 786:
                        user.aiTag = nb5Var.s();
                        continue;
                    case 794:
                        user.friendCommentInfo = (FriendCommentInfo) nb5Var.l(FriendCommentInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 800:
                        user.minRichListPosition = nb5Var.j();
                        continue;
                    case 810:
                        user.ussTracker = nb5Var.s();
                        continue;
                    case 816:
                        user.localLatestReceivedMessageTime = nb5Var.k();
                        continue;
                    case 826:
                        user.hierarchy = (LiveUserLevel) nb5Var.l(LiveUserLevel.PROTOBUF_ADAPTER);
                        continue;
                    case 834:
                        user.localSoulShip = (SoulShip) nb5Var.l(SoulShip.PROTOBUF_ADAPTER);
                        continue;
                    case 841:
                        user.signupTime = nb5Var.h();
                        continue;
                    case 850:
                        user.banStatus = (BanStatus) nb5Var.l(BanStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 858:
                        user.localDiamondPrivateMatchTags = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 866:
                        user.anonymousLike = (AnonymousLikeInfo) nb5Var.l(AnonymousLikeInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 872:
                        user.inactivated = nb5Var.g();
                        continue;
                    case 882:
                        user.status = (List) nb5Var.l(UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 890:
                        user.gender = (Gender) nb5Var.l(Gender.PROTOBUF_ADAPTER);
                        continue;
                    case 898:
                        user.source = (UserSource) nb5Var.l(UserSource.PROTOBUF_ADAPTER);
                        continue;
                    case 906:
                        user.activityUser = (ActivityUser) nb5Var.l(ActivityUser.PROTOBUF_ADAPTER);
                        continue;
                    case 912:
                        user.matePlanUser = nb5Var.g();
                        continue;
                    case 920:
                        user.matePlanAdUser = nb5Var.g();
                        continue;
                    case 930:
                        user.regionTag = nb5Var.s();
                        continue;
                    case 938:
                        user.localLikeIdentifiers = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 944:
                        user.deleted = nb5Var.g();
                        continue;
                    case 954:
                        user.specialEffect = (SpecialEffect) nb5Var.l(SpecialEffect.PROTOBUF_ADAPTER);
                        continue;
                    case 962:
                        user.userActivityInfo = (UserActivityInfo) nb5Var.l(UserActivityInfo.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (user.status == null && list != null) {
                            user.status = UserStatus.oldEnumCovertList(list);
        ...
        public void serialize(User user, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.I(1, ((DbObject) user)._id);
            String str = ((DbObject) user).id;
            if (str != null) {
            ...
            Location location = user.location;
            if (location != null) {
                codedOutputByteBufferNano.K(52, location, Location.PROTOBUF_ADAPTER);
            }
            String str3 = user.description;
            if (str3 != null) {
            ...
            Integer num = user.age;
            if (num != null) {
                codedOutputByteBufferNano.G(54, num.intValue());
            }
            List<Media> list = user.pictures;
            if (list != null) {
                codedOutputByteBufferNano.K(55, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.C(56, user.createdTime);
            Profile profile = user.profile;
            if (profile != null) {
                codedOutputByteBufferNano.K(57, profile, Profile.PROTOBUF_ADAPTER);
            }
            List<UserStatus> list2 = user.status;
            if (list2 != null) {
                codedOutputByteBufferNano.K(58, UserStatus.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Settings settings = user.settings;
            if (settings != null) {
                codedOutputByteBufferNano.K(59, settings, Settings.PROTOBUF_ADAPTER);
            }
            Gender gender = user.gender;
            if (gender != null) {
                codedOutputByteBufferNano.G(60, gender.ordinal());
            }
            Relationship relationship = user.localRelationship;
            if (relationship != null) {
                codedOutputByteBufferNano.K(61, relationship, Relationship.PROTOBUF_ADAPTER);
            }
            Membership membership = user.membership;
            if (membership != null) {
                codedOutputByteBufferNano.K(62, membership, Membership.PROTOBUF_ADAPTER);
            }
            UserSource userSource = user.source;
            if (userSource != null) {
                codedOutputByteBufferNano.G(63, userSource.ordinal());
            }
            String str4 = user.realName;
            if (str4 != null) {
                codedOutputByteBufferNano.R(64, str4);
            }
            Followship followship = user.localFollowship;
            if (followship != null) {
                codedOutputByteBufferNano.K(65, followship, Followship.PROTOBUF_ADAPTER);
            }
            List<Membership> list3 = user.memberships;
            if (list3 != null) {
                codedOutputByteBufferNano.K(66, list3, Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str5 = user.nameRemark;
            if (str5 != null) {
                codedOutputByteBufferNano.R(67, str5);
            }
            UserState userState = user.state;
            if (userState != null) {
                codedOutputByteBufferNano.K(68, userState, UserState.PROTOBUF_ADAPTER);
            }
            PicVerification picVerification = user.verifications;
            if (picVerification != null) {
                codedOutputByteBufferNano.K(69, picVerification, PicVerification.PROTOBUF_ADAPTER);
            }
            List<String> list4 = user.abGroups;
            if (list4 != null) {
                codedOutputByteBufferNano.K(70, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<PrivateAnswer> list5 = user.privateAnswers;
            if (list5 != null) {
                codedOutputByteBufferNano.K(71, list5, PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Membership membership2 = user.peepership;
            if (membership2 != null) {
                codedOutputByteBufferNano.K(72, membership2, Membership.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.I(73, user.picksExpiredTimestamp);
            codedOutputByteBufferNano.A(74, user.picksSwipable);
            String str6 = user.picksTag;
            if (str6 != null) {
                codedOutputByteBufferNano.R(75, str6);
            }
            UserCreditData userCreditData = user.credit;
            if (userCreditData != null) {
                codedOutputByteBufferNano.K(76, userCreditData, UserCreditData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.C(77, user.goPlaceTimestamp);
            codedOutputByteBufferNano.A(78, user.isLord);
            codedOutputByteBufferNano.C(79, user.privateAnswersUpdatedTime);
            String str7 = user.sendLetter;
            if (str7 != null) {
                codedOutputByteBufferNano.R(80, str7);
            }
            codedOutputByteBufferNano.I(81, user.sendLetterTimestamp);
            String str8 = user.receivedLetter;
            if (str8 != null) {
                codedOutputByteBufferNano.R(82, str8);
            }
            codedOutputByteBufferNano.I(83, user.receivedLetterTimestamp);
            codedOutputByteBufferNano.G(84, user.popLevel);
            AudioSignature audioSignature = user.voice;
            if (audioSignature != null) {
                codedOutputByteBufferNano.K(85, audioSignature, AudioSignature.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(86, user.datingMode);
            UssTags ussTags = user.ussTags;
            if (ussTags != null) {
                codedOutputByteBufferNano.K(87, ussTags, UssTags.PROTOBUF_ADAPTER);
            }
            UserAbroad userAbroad = user.abroad;
            if (userAbroad != null) {
                codedOutputByteBufferNano.K(88, userAbroad, UserAbroad.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem = user.fakeStatus;
            if (statusesItem != null) {
                codedOutputByteBufferNano.K(89, statusesItem, StatusesItem.PROTOBUF_ADAPTER);
            }
            StatusesItem statusesItem2 = user.nameStatus;
            if (statusesItem2 != null) {
                codedOutputByteBufferNano.K(90, statusesItem2, StatusesItem.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(91, user.displayAudit);
            VisitPlace visitPlace = user.visitPlace;
            if (visitPlace != null) {
                codedOutputByteBufferNano.K(92, visitPlace, VisitPlace.PROTOBUF_ADAPTER);
            }
            String str9 = user.publicId;
            if (str9 != null) {
                codedOutputByteBufferNano.R(93, str9);
            }
            UserSoulSettings userSoulSettings = user.soulSettings;
            if (userSoulSettings != null) {
                codedOutputByteBufferNano.K(94, userSoulSettings, UserSoulSettings.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(95, user.richListPosition);
            String str10 = user.richListTracker;
            if (str10 != null) {
                codedOutputByteBufferNano.R(96, str10);
            }
            codedOutputByteBufferNano.C(97, user.diamondVIPExpiresTime);
            String str11 = user.aiTag;
            if (str11 != null) {
                codedOutputByteBufferNano.R(98, str11);
            }
            FriendCommentInfo friendCommentInfo = user.friendCommentInfo;
            if (friendCommentInfo != null) {
                codedOutputByteBufferNano.K(99, friendCommentInfo, FriendCommentInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.G(100, user.minRichListPosition);
            String str12 = user.ussTracker;
            if (str12 != null) {
                codedOutputByteBufferNano.R(101, str12);
            }
            codedOutputByteBufferNano.I(102, user.localLatestReceivedMessageTime);
            LiveUserLevel liveUserLevel = user.hierarchy;
            if (liveUserLevel != null) {
                codedOutputByteBufferNano.K(103, liveUserLevel, LiveUserLevel.PROTOBUF_ADAPTER);
            }
            SoulShip soulShip = user.localSoulShip;
            if (soulShip != null) {
                codedOutputByteBufferNano.K(104, soulShip, SoulShip.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.C(105, user.signupTime);
            BanStatus banStatus = user.banStatus;
            if (banStatus != null) {
                codedOutputByteBufferNano.K(106, banStatus, BanStatus.PROTOBUF_ADAPTER);
            }
            List<String> list6 = user.localDiamondPrivateMatchTags;
            if (list6 != null) {
                codedOutputByteBufferNano.K(107, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            AnonymousLikeInfo anonymousLikeInfo = user.anonymousLike;
            if (anonymousLikeInfo != null) {
                codedOutputByteBufferNano.K(108, anonymousLikeInfo, AnonymousLikeInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(109, user.inactivated);
            List<UserStatus> list7 = user.status;
            if (list7 != null) {
                codedOutputByteBufferNano.K(110, list7, UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Gender gender2 = user.gender;
            if (gender2 != null) {
                codedOutputByteBufferNano.K(111, gender2, Gender.PROTOBUF_ADAPTER);
            }
            UserSource userSource2 = user.source;
            if (userSource2 != null) {
                codedOutputByteBufferNano.K(112, userSource2, UserSource.PROTOBUF_ADAPTER);
            }
            ActivityUser activityUser = user.activityUser;
            if (activityUser != null) {
                codedOutputByteBufferNano.K(113, activityUser, ActivityUser.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.A(114, user.matePlanUser);
            codedOutputByteBufferNano.A(115, user.matePlanAdUser);
            String str13 = user.regionTag;
            if (str13 != null) {
                codedOutputByteBufferNano.R(116, str13);
            }
            List<String> list8 = user.localLikeIdentifiers;
            if (list8 != null) {
                codedOutputByteBufferNano.K(117, list8, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.A(118, user.deleted);
            SpecialEffect specialEffect = user.specialEffect;
            if (specialEffect != null) {
                codedOutputByteBufferNano.K(119, specialEffect, SpecialEffect.PROTOBUF_ADAPTER);
            }
            UserActivityInfo userActivityInfo = user.userActivityInfo;
            if (userActivityInfo != null) {
                codedOutputByteBufferNano.K(120, userActivityInfo, UserActivityInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<User> JSON_ADAPTER = new ObjectJsonAdapter<User>() { // from class: com.p1.mobile.putong.data.User.2
        ...
        public User mo17830newInstance() {
            return new User();
        }
        ...
        public boolean parseField(User user, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "description":
                    ...
                    return true;
                case "receivedLetterTimestamp":
                    user.receivedLetterTimestamp = jsonParser.getValueAsLong();
                    return true;
                case "abroad":
                    user.abroad = (UserAbroad) UserAbroad.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "picksTracker":
                    user.picksTracker = jsonParser.getValueAsString();
                    return true;
                case "credit":
                    user.credit = (UserCreditData) UserCreditData.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "membership":
                    user.membership = (Membership) Membership.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "specialEffect":
                    user.specialEffect = (SpecialEffect) SpecialEffect.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "gender":
                    user.gender = (Gender) Gender.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "isLord":
                    user.isLord = jsonParser.getValueAsBoolean();
                    return true;
                case "totalRewardPoint":
                    user.totalRewardPoint = (TotalRewardPoint) TotalRewardPoint.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "privateAnswers":
                    user.privateAnswers = JsonAdapter.parseArray(jsonParser, PrivateAnswer.JSON_ADAPTER, str2, arrayList, dataChecker);
                    return true;
                case "localLatestReceivedMessageTime":
                    user.localLatestReceivedMessageTime = jsonParser.getValueAsLong();
                    return true;
                case "anchorHierarchy":
                    user.anchorHierarchy = (LiveAnchorLevel) LiveAnchorLevel.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "picksSwipable":
                    user.picksSwipable = jsonParser.getValueAsBoolean();
                    return true;
                case "source":
                    user.source = (UserSource) UserSource.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "status":
                ...
                case "realName":
                    ...
                    return true;
                case "localLetterUnRead":
                    user.localLetterUnRead = jsonParser.getValueAsBoolean();
                    return true;
                case "nameStatus":
                    user.nameStatus = (StatusesItem) StatusesItem.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "picksTag":
                ...
                case "pictures":
                    ...
                    return true;
                case "signupTime":
                    user.signupTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "createdTime":
                    user.createdTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "profile":
                    user.profile = (Profile) Profile.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "ussTags":
                    user.ussTags = (UssTags) UssTags.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "soul-settings":
                    user.soulSettings = (UserSoulSettings) UserSoulSettings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "id":
                    ((DbObject) user).id = jsonParser.getValueAsString();
                    return false;
                case "age":
                ...
                case "name":
                    ...
                    return true;
                case "liveRevenueCampaignVip":
                    user.liveRevenueCampaignVip = (LiveRevenueCampaignVip) LiveRevenueCampaignVip.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "richListPosition":
                    user.richListPosition = jsonParser.getValueAsInt();
                    return true;
                case "localSeeReminderType":
                ...
                case "aiTag":
                    ...
                    return true;
                case "ideal":
                    user.ideal = (UserIdealInfo) UserIdealInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "medal":
                    user.medal = (UserMedalWrapper) UserMedalWrapper.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "state":
                    user.state = (UserState) UserState.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "voice":
                    user.voice = (AudioSignature) AudioSignature.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "ussTracker":
                ...
                case "sendLetter":
                    ...
                    return true;
                case "privateAnswersUpdatedTime":
                    user.privateAnswersUpdatedTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "sendLetterTimestamp":
                    user.sendLetterTimestamp = jsonParser.getValueAsLong();
                    return true;
                case "picksExpiredTimestamp":
                ...
                case "inactivated":
                    ...
                    return true;
                case "avatarFrame":
                    user.avatarFrame = (AvatarFrame) AvatarFrame.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "abGroups":
                ...
                case "popLevel":
                    ...
                    return true;
                case "peepership":
                    user.peepership = (Membership) Membership.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "matePlanAdUser":
                    user.matePlanAdUser = jsonParser.getValueAsBoolean();
                    return true;
                case "diamondVIPExpiresTime":
                    user.diamondVIPExpiresTime = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "richListTracker":
                    user.richListTracker = jsonParser.getValueAsString();
                    return true;
                case "liveState":
                    user.liveState = (UserLiveState) UserLiveState.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "anonymousLike":
                    user.anonymousLike = (AnonymousLikeInfo) AnonymousLikeInfo.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "goPlaceTimestamp":
                    user.goPlaceTimestamp = ((Double) Converter.API_TIME.parse(jsonParser, str2)).doubleValue();
                    return true;
                case "verifications":
                    user.verifications = (PicVerification) PicVerification.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "publicId":
                    user.publicId = jsonParser.getValueAsString();
                    return true;
                case "signupStage":
                    user.signupStage = (SignupStage) SignupStage.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "memberships":
                ...
                case "matePlanUser":
                    ...
                    return true;
                case "settings":
                    user.settings = (Settings) Settings.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "voiceLiveState":
                    user.voiceLiveState = (VoiceLiveState) VoiceLiveState.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "deleted":
                ...
                case "displayAudit":
                    ...
                    return true;
                case "activityUser":
                    user.activityUser = (ActivityUser) ActivityUser.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "fakeStatus":
                    user.fakeStatus = (StatusesItem) StatusesItem.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "localLikeIdentifiers":
                ...
                case "finishedStages":
                    ...
                    return true;
                case "fanbaseHierarchy":
                    user.fanbaseHierarchy = (LiveFansClubLevel) LiveFansClubLevel.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "banStatus":
                    user.banStatus = (BanStatus) BanStatus.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "location":
                    user.location = (Location) Location.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "hierarchy":
                    user.hierarchy = (LiveUserLevel) LiveUserLevel.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
    ...
    public static final LongColumn<User> _ID = new LongColumn<User>("_id") { // from class: com.p1.mobile.putong.data.User.3
        public Long get(User user) {
            return Long.valueOf(((DbObject) user)._id);
        }

        public void set(User user, Long l2) {
            ((DbObject) user)._id = l2.longValue();
        }
    };

    /* JADX INFO: renamed from: ID */
    public static final StringColumn<User> f286ID = new StringColumn<User>("id_c") { // from class: com.p1.mobile.putong.data.User.4
        public String get(User user) {
            return ((DbObject) user).id;
        }

        public void set(User user, String str) {
            ((DbObject) user).id = str;
        }
    };
    ...
    public static final Column<User, List<String>> PROFILE_EXTENSIONS_ANONYMITY_ID = new Column<User, List<String>>("profile_extensions_anonymity_id_c") { // from class: com.p1.mobile.putong.data.User.119
        public List<String> get(User user) {
            return user.profile.extensions.anonymity.f181id;
        }

        public void set(User user, List<String> list) {
            user.profile.extensions.anonymity.f181id = list;
        }
    };
    ...
    public static mrf0<User> DB_ADAPTER = new mrf0<User>() { // from class: com.p1.mobile.putong.data.User.191
        ...
        public User read(Cursor cursor, int i) {
            ...
            try {
                ...
                ((DbObject) user)._id = cursor.getLong(i);
                int i9 = i + 1;
                ((DbObject) user).id = cursor.isNull(i9) ? null : cursor.getString(i9);
                int i10 = i + 2;
                ...
                int i14 = i + 8;
                user.location.passby = cursor.isNull(i14) ? null : (Passby) Passby.PROTOBUF_ADAPTER.parse(cursor.getBlob(i14));
                int i15 = i + 9;
                ...
                int i17 = i + 11;
                user.pictures = cursor.isNull(i17) ? null : (List) Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i17));
                ...
                int i22 = i + 17;
                user.profile.tags = cursor.isNull(i22) ? null : (List) Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i22));
                int i23 = i + 18;
                user.profile.job = cursor.isNull(i23) ? null : cursor.getString(i23);
                user.profile.contactLookups.batchSize = cursor.getInt(i + 19);
                int i24 = i + 20;
                user.profile.contactLookups.lookups = cursor.isNull(i24) ? null : (List) Contact.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i24));
                int i25 = i + 21;
                user.profile.contactLookups.next = cursor.isNull(i25) ? null : cursor.getString(i25);
                int i26 = i + 22;
                user.profile.social = cursor.isNull(i26) ? null : (List) Social.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i26));
                int i27 = i + 23;
                user.profile.answers = cursor.isNull(i27) ? null : (List) Answer.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i27));
                int i28 = i + 24;
                ...
                try {
                    ...
                    int i30 = i + 26;
                    list = cursor.isNull(i30) ? null : (List) OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i30));
                    int i31 = i + 27;
                    try {
                        user.settings = cursor.isNull(i31) ? null : (Settings) Settings.PROTOBUF_ADAPTER.parse(cursor.getBlob(i31));
                        int i32 = i + 28;
                        ...
                        try {
                            ...
                            int i38 = i + 36;
                            user.profile.scenarios = cursor.isNull(i38) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i38));
                            int i39 = i + 37;
                            user.profile.receivedLikesRank = cursor.isNull(i39) ? null : cursor.getString(i39);
                            int i40 = i + 38;
                            user.localRelationship = cursor.isNull(i40) ? null : (Relationship) Relationship.PROTOBUF_ADAPTER.parse(cursor.getBlob(i40));
                            int i41 = i + 39;
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    int i45 = i + 55;
                                    user.localFollowship = cursor.isNull(i45) ? null : (Followship) Followship.PROTOBUF_ADAPTER.parse(cursor.getBlob(i45));
                                    user.membership.duration = cursor.getLong(i + 56);
                                    int i46 = i + 57;
                                    user.memberships = cursor.isNull(i46) ? null : (List) Membership.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i46));
                                    int i47 = i + 58;
                                    user.nameRemark = cursor.isNull(i47) ? null : cursor.getString(i47);
                                    int i48 = i + 59;
                                    user.state = cursor.isNull(i48) ? null : (UserState) UserState.PROTOBUF_ADAPTER.parse(cursor.getBlob(i48));
                                    user.verifications.picVerificationResult.verified = cursor.getInt(i + 60) == 1;
                                    int i49 = i + 61;
                                    user.abGroups = cursor.isNull(i49) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i49));
                                    int i50 = i + 62;
                                    user.privateAnswers = cursor.isNull(i50) ? null : (List) PrivateAnswer.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i50));
                                    int i51 = i + 63;
                                    user.peepership = cursor.isNull(i51) ? null : (Membership) Membership.PROTOBUF_ADAPTER.parse(cursor.getBlob(i51));
                                    ...
                                    int i53 = i + 67;
                                    user.credit = cursor.isNull(i53) ? null : (UserCreditData) UserCreditData.PROTOBUF_ADAPTER.parse(cursor.getBlob(i53));
                                    ...
                                    int i56 = i + 76;
                                    user.voice = cursor.isNull(i56) ? null : (AudioSignature) AudioSignature.PROTOBUF_ADAPTER.parse(cursor.getBlob(i56));
                                    user.datingMode = cursor.getInt(i + 77) == 1;
                                    int i57 = i + 78;
                                    user.ussTags = cursor.isNull(i57) ? null : (UssTags) UssTags.PROTOBUF_ADAPTER.parse(cursor.getBlob(i57));
                                    int i58 = i + 79;
                                    i6 = cursor.isNull(i58) ? -1 : cursor.getInt(i58);
                                    int i59 = i + 80;
                                    try {
                                        user.abroad = cursor.isNull(i59) ? null : (UserAbroad) UserAbroad.PROTOBUF_ADAPTER.parse(cursor.getBlob(i59));
                                        int i60 = i + 81;
                                        user.fakeStatus = cursor.isNull(i60) ? null : (StatusesItem) StatusesItem.PROTOBUF_ADAPTER.parse(cursor.getBlob(i60));
                                        int i61 = i + 82;
                                        user.nameStatus = cursor.isNull(i61) ? null : (StatusesItem) StatusesItem.PROTOBUF_ADAPTER.parse(cursor.getBlob(i61));
                                        user.displayAudit = cursor.getInt(i + 83) == 1;
                                        int i62 = i + 84;
                                        user.visitPlace = cursor.isNull(i62) ? null : (VisitPlace) VisitPlace.PROTOBUF_ADAPTER.parse(cursor.getBlob(i62));
                                        int i63 = i + 85;
                                        user.publicId = cursor.isNull(i63) ? null : cursor.getString(i63);
                                        int i64 = i + 86;
                                        user.soulSettings = cursor.isNull(i64) ? null : (UserSoulSettings) UserSoulSettings.PROTOBUF_ADAPTER.parse(cursor.getBlob(i64));
                                        ...
                                        int i67 = i + 91;
                                        user.friendCommentInfo = cursor.isNull(i67) ? null : (FriendCommentInfo) FriendCommentInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i67));
                                        ...
                                        int i69 = i + 95;
                                        user.profile.mood = cursor.isNull(i69) ? null : (UserProfileMood) UserProfileMood.PROTOBUF_ADAPTER.parse(cursor.getBlob(i69));
                                        ...
                                        int i71 = i + 99;
                                        try {
                                            list2 = cursor.isNull(i71) ? null : (List) OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i71));
                                            int i72 = i + 100;
                                            try {
                                                list3 = cursor.isNull(i72) ? null : (List) OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i72));
                                                int i73 = i + 101;
                                                i8 = 0;
                                                try {
                                                    ...
                                                    if (cursor.isNull(i73)) {
                                                        ...
                                                        string = "unknown_";
                                                        try {
                                                            list8 = (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i73));
                                                        } catch (Exception e) {
                                                            e = e;
                                                            i7 = i7;
                                                            i6 = i6;
                                                    ...
                                                    int i76 = i + 102;
                                                    user.profile.moodMoment = cursor.isNull(i76) ? null : (MoodMoment) MoodMoment.PROTOBUF_ADAPTER.parse(cursor.getBlob(i76));
                                                    int i77 = i + 103;
                                                    user.profile.bizAnswers = cursor.isNull(i77) ? null : (BizAnswers) BizAnswers.PROTOBUF_ADAPTER.parse(cursor.getBlob(i77));
                                                    int i78 = i + 104;
                                                    user.profile.extensions.interest.emoji = cursor.isNull(i78) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i78));
                                                    user.verifications.age.verified = cursor.getInt(i + 105) == 1;
                                                    int i79 = i + 106;
                                                    user.profile.extensions.basic.aboutMe = cursor.isNull(i79) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i79));
                                                    user.verifications.anchor.verified = cursor.getInt(i + 107) == 1;
                                                    int i80 = i + 108;
                                                    user.profile.extensions.basic.tickle = cursor.isNull(i80) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i80));
                                                    ...
                                                    int i81 = i + 115;
                                                    user.hierarchy = cursor.isNull(i81) ? null : (LiveUserLevel) LiveUserLevel.PROTOBUF_ADAPTER.parse(cursor.getBlob(i81));
                                                    int i82 = i + 116;
                                                    user.profile.extensions.basic.hobby = cursor.isNull(i82) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i82));
                                                    int i83 = i + 117;
                                                    user.profile.extensions.basic.recent = cursor.isNull(i83) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i83));
                                                    int i84 = i + 118;
                                                    user.profile.extensions.basic.together = cursor.isNull(i84) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i84));
                                                    int i85 = i + 119;
                                                    user.profile.extensions.anonymity.f181id = cursor.isNull(i85) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i85));
                                                    int i86 = i + 120;
                                                    user.profile.extensions.anonymity.identifier = cursor.isNull(i86) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i86));
                                                    int i87 = i + 121;
                                                    user.localSoulShip = cursor.isNull(i87) ? null : (SoulShip) SoulShip.PROTOBUF_ADAPTER.parse(cursor.getBlob(i87));
                                                    user.signupTime = cursor.getDouble(i + 122);
                                                    int i88 = i + 123;
                                                    user.profile.extensions.headFrame.url = cursor.isNull(i88) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i88));
                                                    int i89 = i + 124;
                                                    user.profile.extensions.headFrame.expiredTime = cursor.isNull(i89) ? null : (List) ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i89));
                                                    int i90 = i + 125;
                                                    user.banStatus = cursor.isNull(i90) ? null : (BanStatus) BanStatus.PROTOBUF_ADAPTER.parse(cursor.getBlob(i90));
                                                    user.profile.onlyShowAboutMeInside = cursor.getInt(i + 126) == 1;
                                                    int i91 = i + 127;
                                                    List list13 = cursor.isNull(i91) ? null : (List) OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i91));
                                                    int i92 = i + 128;
                                                    try {
                                                        ...
                                                        if (cursor.isNull(i92)) {
                                                            ...
                                                            list9 = list13;
                                                            try {
                                                                list10 = (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i92));
                                                            } catch (Exception e2) {
                                                                e = e2;
                                                                i7 = i7;
                                                                i6 = i6;
                                                        ...
                                                        int i93 = i + 129;
                                                        user.profile.extensions.friendStatus.labelName = cursor.isNull(i93) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i93));
                                                        int i94 = i + 130;
                                                        user.profile.extensions.friendStatus.endTime = cursor.isNull(i94) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i94));
                                                        int i95 = i + 131;
                                                        List list14 = cursor.isNull(i95) ? null : (List) OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i95));
                                                        int i96 = i + 132;
                                                        try {
                                                            user.localDiamondPrivateMatchTags = cursor.isNull(i96) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i96));
                                                            int i97 = i + 133;
                                                            ...
                                                            if (cursor.isNull(i97)) {
                                                                ...
                                                                list5 = list14;
                                                                try {
                                                                    list11 = (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i97));
                                                                } catch (Exception e3) {
                                                                    e = e3;
                                                                    str = string;
                                                                    string2 = str;
                                                            ...
                                                            int i98 = i + 134;
                                                            user.anonymousLike = cursor.isNull(i98) ? null : (AnonymousLikeInfo) AnonymousLikeInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i98));
                                                            user.inactivated = cursor.getInt(i + 135) == 1;
                                                            int i99 = i + 136;
                                                            user.profile.extensions.basic.country = cursor.isNull(i99) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i99));
                                                            int i100 = i + 137;
                                                            user.profile.extensions.basic.province = cursor.isNull(i100) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i100));
                                                            int i101 = i + 138;
                                                            user.profile.extensions.basic.city = cursor.isNull(i101) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i101));
                                                            int i102 = i + 139;
                                                            string2 = cursor.isNull(i102) ? null : cursor.getString(i102);
                                                            int i103 = i + 140;
                                                            try {
                                                                user.status = cursor.isNull(i103) ? null : (List) UserStatus.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i103));
                                                                int i104 = i + 141;
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                try {
                                                                                    ...
                                                                                    if (cursor.isNull(i109)) {
                                                                                        ...
                                                                                        i7 = i7;
                                                                                        try {
                                                                                            list12 = (List) LocationInvisibleField.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i109));
                                                                                        } catch (Exception e4) {
                                                                                            e = e4;
                                                                                            i6 = i6;
                                                                                            i2 = i2;
                                                                                    ...
                                                                                    int i110 = i + 147;
                                                                                    user.profile.extensions.physical.bloodType = cursor.isNull(i110) ? null : (List) BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i110));
                                                                                    int i111 = i + 148;
                                                                                    user.profile.extensions.basic.friendPurpose = cursor.isNull(i111) ? null : (List) Purpose.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i111));
                                                                                    int i112 = i + 149;
                                                                                    user.profile.extensions.friendStatus.status = cursor.isNull(i112) ? null : (List) FriendState.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i112));
                                                                                    int i113 = i + 150;
                                                                                    user.profile.extensions.momentSwitch.noSyncMoment = cursor.isNull(i113) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i113));
                                                                                    int i114 = i + 151;
                                                                                    user.profile.extensions.wealth = cursor.isNull(i114) ? null : (UserWealth) UserWealth.PROTOBUF_ADAPTER.parse(cursor.getBlob(i114));
                                                                                    int i115 = i + 152;
                                                                                    user.profile.extensions.basic.qualification = cursor.isNull(i115) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i115));
                                                                                    int i116 = i + 153;
                                                                                    user.profile.extensions.physical.height = cursor.isNull(i116) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i116));
                                                                                    int i117 = i + 154;
                                                                                    user.profile.extensions.profileCompletion = cursor.isNull(i117) ? null : (ProfileCompletion) ProfileCompletion.PROTOBUF_ADAPTER.parse(cursor.getBlob(i117));
                                                                                    int i118 = i + 155;
                                                                                    user.profile.extensions.voiceSignature = cursor.isNull(i118) ? null : (VoiceSignature) VoiceSignature.PROTOBUF_ADAPTER.parse(cursor.getBlob(i118));
                                                                                    int i119 = i + 156;
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        int i121 = i + 161;
                                                                                        user.localLikeIdentifiers = cursor.isNull(i121) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i121));
                                                                                        user.deleted = cursor.getInt(i + 162) == 1;
                                                                                        int i122 = i + 163;
                                                                                        user.profile.extensions.interest.tags = cursor.isNull(i122) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i122));
                                                                                        int i123 = i + 164;
                                                                                        user.profile.extensions.live.voiceImgId = cursor.isNull(i123) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i123));
                                                                                        int i124 = i + 165;
                                                                                        user.profile.extensions.live.voiceImgUrl = cursor.isNull(i124) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i124));
                                                                                        int i125 = i + 166;
                                                                                        user.profile.extensions.mate = cursor.isNull(i125) ? null : (ProfileMate) ProfileMate.PROTOBUF_ADAPTER.parse(cursor.getBlob(i125));
                                                                                        int i126 = i + 167;
                                                                                        user.profile.extensions.pet = cursor.isNull(i126) ? null : (PetInfo) PetInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i126));
                                                                                        int i127 = i + 168;
                                                                                        user.profile.extensions.tailFrame.url = cursor.isNull(i127) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i127));
                                                                                        int i128 = i + 169;
                                                                                        user.profile.extensions.tailFrame.expiredTime = cursor.isNull(i128) ? null : (List) ProtobufAdapter.DOUBLE_BOXED_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i128));
                                                                                        int i129 = i + 170;
                                                                                        user.profile.extensions.business.avatarID = cursor.isNull(i129) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i129));
                                                                                        int i130 = i + 171;
                                                                                        user.profile.extensions.business.avatarExpireTime = cursor.isNull(i130) ? null : (List) ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i130));
                                                                                        int i131 = i + 172;
                                                                                        user.profile.extensions.business.avatarClose = cursor.isNull(i131) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i131));
                                                                                        int i132 = i + 173;
                                                                                        user.specialEffect = cursor.isNull(i132) ? null : (SpecialEffect) SpecialEffect.PROTOBUF_ADAPTER.parse(cursor.getBlob(i132));
                                                                                        int i133 = i + 174;
                                                                                        user.profile.extensions.basic.ethnicity = cursor.isNull(i133) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i133));
                                                                                        int i134 = i + 175;
                                                                                        user.profile.extensions.basic.language = cursor.isNull(i134) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i134));
                                                                                        int i135 = i + 176;
                                                                                        user.profile.extensions.voiceAvatarFrame = cursor.isNull(i135) ? null : (VoiceAvatarFrame) VoiceAvatarFrame.PROTOBUF_ADAPTER.parse(cursor.getBlob(i135));
                                                                                        int i136 = i + 177;
                                                                                        user.profile.extensions.physical.heightImg = cursor.isNull(i136) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i136));
                                                                                        int i137 = i + 178;
                                                                                        user.profile.extensions.marriage = cursor.isNull(i137) ? null : (ProfileExtensionMarriage) ProfileExtensionMarriage.PROTOBUF_ADAPTER.parse(cursor.getBlob(i137));
                                                                                        int i138 = i + 179;
                                                                                        user.profile.extensions.basic.address = cursor.isNull(i138) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i138));
                                                                                        int i139 = i + 180;
                                                                                        user.profile.extensions.basic.familyBackground = cursor.isNull(i139) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i139));
                                                                                        int i140 = i + 181;
                                                                                        user.profile.extensions.physical.weight = cursor.isNull(i140) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i140));
                                                                                        ...
                                                                                        int i141 = i + 183;
                                                                                        user.profile.extensions.game = cursor.isNull(i141) ? null : (ExtensionGame) ExtensionGame.PROTOBUF_ADAPTER.parse(cursor.getBlob(i141));
                                                                                        int i142 = i + 184;
                                                                                        user.profile.extensions.basic.facialFeature = cursor.isNull(i142) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i142));
                                                                                        ...
                                                                                        int i144 = i + 187;
                                                                                        user.profile.extensions.physical.fitness = cursor.isNull(i144) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i144));
                                                                                        int i145 = i + 188;
                                                                                        user.profile.extensions.physical.drink = cursor.isNull(i145) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i145));
                                                                                        int i146 = i + 189;
                                                                                        user.profile.extensions.physical.smoke = cursor.isNull(i146) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i146));
                                                                                        int i147 = i + 190;
                                                                                        user.profile.extensions.basic.mbti = cursor.isNull(i147) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i147));
                                                                                        int i148 = i + 191;
                                                                                        user.userActivityInfo = cursor.isNull(i148) ? null : (UserActivityInfo) UserActivityInfo.PROTOBUF_ADAPTER.parse(cursor.getBlob(i148));
                                                                                        int i149 = i + 192;
                                                                                        user.profile.extensions.basic.ideal = cursor.isNull(i149) ? null : (List) IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i149));
                                                                                        int i150 = i + 193;
                                                                                        user.profile.extensions.basic.unideal = cursor.isNull(i150) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i150));
                                                                                        user.profile.moments.counters.totalNormalMoments = cursor.getInt(i + 194);
                                                                                        int i151 = i + 195;
                                                                                        user.profile.extensions.interest.taste = cursor.isNull(i151) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i151));
                                                                                        int i152 = i + 196;
                                                                                        user.location.region.province = cursor.isNull(i152) ? null : cursor.getString(i152);
                                                                                        int i153 = i + 197;
                                                                                        user.profile.extensions.basic.intlFriendPurpose = cursor.isNull(i153) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i153));
                                                                                        int i154 = i + 198;
                                                                                        user.profile.extensions.basic.intlFriendPurposeV2 = cursor.isNull(i154) ? null : (List) ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i154));
                                                                                        this.readIndex = i + 199;
                                                                                        list6 = list;
                                                                                        string2 = str9;
                                                                                        str = string;
                                                                                        list4 = list9;
        ...
        public void write(User user, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", ((DbObject) user).id);
                ...
                DbObject.cvPut(contentValues, "profile_extensions_anonymity_id_c", user.profile.extensions.anonymity.f181id == null ? null : ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().serialize(user.profile.extensions.anonymity.f181id));
    ...
    public class DefaultRiskAuditUser implements Serializable {
        ...
        public DefaultRiskAuditUser() {
            ...
            try {
                JSONObject jSONObject = new JSONObject(RemoteConfig.x().F("default_user_info"));
    ...
    public static final Pattern NAME_PATTERN() {
        if (f288np == null) {
            synchronized (User.class) {
                try {
                    if (f288np == null) {
                        f288np = Pattern.compile("^[\\p{L}-.\\040]{1,50}$");
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public static /* synthetic */ String m1031b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ StepSignupStage m1032c(StepSignupStage stepSignupStage) {
    ...
    private boolean checkRelationshipStatus() {
        ...
        CrashHelper.c(new NullPointerException("------------localRelationship.status==null------------"));
        return false;
    }
    ...
    private void initAvatarFrame() {
        if (NullChecker.a(this.userAvatarFrame)) {
            return;
        }
        if (!NullChecker.a(this.profile.extensions) || !NullChecker.a(this.profile.extensions.business) || vwb.J(this.profile.extensions.business.avatarID) || vwb.J(this.profile.extensions.business.avatarClose) || vwb.J(this.profile.extensions.business.avatarExpireTime)) {
        ...
        String strX = qib0.p0.x(this.profile.extensions.business.avatarID.get(0));
        UserAvatarFrame userAvatarFrame = this.userAvatarFrame;
        userAvatarFrame.url = strX;
    ...
    private void initLiveAvatarFrame() {
        if (NullChecker.a(this.liveUserAvatarFrame)) {
            return;
        }
        if (!NullChecker.a(this.profile.extensions) || !NullChecker.a(this.profile.extensions.voiceAvatarFrame) || vwb.J(this.profile.extensions.voiceAvatarFrame.f296id) || vwb.J(this.profile.extensions.voiceAvatarFrame.expiredTime)) {
        ...
        liveUserAvatarFrameNew_.f238id = this.profile.extensions.voiceAvatarFrame.f296id.get(0);
        LiveRight liveRightY = qib0.p0.y(this.liveUserAvatarFrame.f238id);
        if (NullChecker.a(liveRightY)) {
            this.liveUserAvatarFrame.url = liveRightY.getUrl();
        }
        LiveUserAvatarFrame liveUserAvatarFrame = this.liveUserAvatarFrame;
        liveUserAvatarFrame.liveRight = liveRightY;
        try {
    ...
    public static /* synthetic */ UserStatus m1036k(UserStatus userStatus) {
        return userStatus;
    }

    /* JADX INFO: renamed from: n */
    public static /* synthetic */ String m1039n(String str) {
        return str;
    }
    ...
    public static /* synthetic */ String m1040o(String str) {
        return str;
    }

    public boolean boosted() {
        if (((DbObject) this).id.equals(qib0.c0.userId()) || isTeamAccount() || this.localRelationship == null || !checkRelationshipStatus()) {
            return false;
        }
    ...
    public User m19150clone() {
        User user = new User();
        ((DbObject) user)._id = ((DbObject) this)._id;
        ((DbObject) user).id = ((DbObject) this).id;
        user.name = this.name;
        Location location = this.location;
        if (location != null) {
            user.location = location.m18417clone();
        }
        user.description = this.description;
        user.age = this.age;
        List<Media> list = this.pictures;
        if (list != null) {
            user.pictures = ValueObject.util_map(list, new w9j() { // from class: l.dxj0
        ...
        if (profile != null) {
            user.profile = profile.m18834clone();
        }
        List<UserStatus> list2 = this.status;
        if (list2 != null) {
            user.status = ValueObject.util_map(list2, new w9j() { // from class: l.exj0
                public final Object call(Object obj) {
                    return User.m1036k((UserStatus) obj);
                }
            });
        }
        Settings settings = this.settings;
        if (settings != null) {
            user.settings = settings.m18952clone();
        }
        user.gender = this.gender;
        Relationship relationship = this.localRelationship;
        if (relationship != null) {
            user.localRelationship = relationship.m18892clone();
        }
        Membership membership = this.membership;
        if (membership != null) {
            user.membership = membership.m18446clone();
        }
        user.source = this.source;
        user.realName = this.realName;
        Followship followship = this.localFollowship;
        if (followship != null) {
            user.localFollowship = followship.m18102clone();
        }
        List<Membership> list3 = this.memberships;
        if (list3 != null) {
            user.memberships = ValueObject.util_map(list3, new w9j() { // from class: l.fxj0
                public final Object call(Object obj) {
                    return ((Membership) obj).m18446clone();
                }
            });
        }
        ...
        if (userState != null) {
            user.state = userState.m19228clone();
        }
        PicVerification picVerification = this.verifications;
        if (picVerification != null) {
            user.verifications = picVerification.m18800clone();
        }
        List<String> list4 = this.abGroups;
        if (list4 != null) {
            user.abGroups = ValueObject.util_map(list4, new w9j() { // from class: l.gxj0
                public final Object call(Object obj) {
                    return User.m1039n((String) obj);
                }
            });
        }
        List<PrivateAnswer> list5 = this.privateAnswers;
        if (list5 != null) {
            user.privateAnswers = ValueObject.util_map(list5, new w9j() { // from class: l.hxj0
                public final Object call(Object obj) {
                    return ((PrivateAnswer) obj).m18825clone();
                }
            });
        }
        Membership membership2 = this.peepership;
        if (membership2 != null) {
            user.peepership = membership2.m18446clone();
        }
        ...
        if (userCreditData != null) {
            user.credit = userCreditData.m19171clone();
        }
        ...
        if (userMedalWrapper != null) {
            user.medal = userMedalWrapper.m19195clone();
        }
        VisitPlace visitPlace = this.visitPlace;
        if (visitPlace != null) {
            user.visitPlace = visitPlace.m19325clone();
        }
        user.signupStage = this.signupStage;
        user.publicId = this.publicId;
        Broadcast broadcast = this.broadcast;
        if (broadcast != null) {
            user.broadcast = broadcast.m17780clone();
        }
        UserSoulSettings userSoulSettings = this.soulSettings;
        if (userSoulSettings != null) {
            user.soulSettings = userSoulSettings.m19225clone();
        }
        ...
        if (richListUsers != null) {
            user.localRichListUsers = richListUsers.m18913clone();
        }
        ...
        if (liveRevenueCampaignVip != null) {
            user.liveRevenueCampaignVip = liveRevenueCampaignVip.m18366clone();
        }
        ...
        if (friendCommentInfo != null) {
            user.friendCommentInfo = friendCommentInfo.m18123clone();
        }
        TotalRewardPoint totalRewardPoint = this.totalRewardPoint;
        if (totalRewardPoint != null) {
            user.totalRewardPoint = totalRewardPoint.m19111clone();
        }
        ...
        if (liveAnchorLevel != null) {
            user.anchorHierarchy = liveAnchorLevel.m18321clone();
        }
        LiveFansClubLevel liveFansClubLevel = this.fanbaseHierarchy;
        if (liveFansClubLevel != null) {
            user.fanbaseHierarchy = liveFansClubLevel.m18342clone();
        }
        user.localLatestReceivedMessageTime = this.localLatestReceivedMessageTime;
        AvatarFrame avatarFrame = this.avatarFrame;
        if (avatarFrame != null) {
            user.avatarFrame = avatarFrame.m17729clone();
        }
        LiveUserLevel liveUserLevel = this.hierarchy;
        if (liveUserLevel != null) {
            user.hierarchy = liveUserLevel.m18405clone();
        }
        SoulShip soulShip = this.localSoulShip;
        if (soulShip != null) {
            user.localSoulShip = soulShip.m19003clone();
        }
        user.signupTime = this.signupTime;
        BanStatus banStatus = this.banStatus;
        if (banStatus != null) {
            user.banStatus = banStatus.m17741clone();
        }
        List<String> list6 = this.localDiamondPrivateMatchTags;
        if (list6 != null) {
            user.localDiamondPrivateMatchTags = ValueObject.util_map(list6, new w9j() { // from class: l.ixj0
                public final Object call(Object obj) {
                    return User.m1040o((String) obj);
                }
            });
        }
        AnonymousLikeInfo anonymousLikeInfo = this.anonymousLike;
        if (anonymousLikeInfo != null) {
            user.anonymousLike = anonymousLikeInfo.m17700clone();
        }
        List<StepSignupStage> list7 = this.finishedStages;
        if (list7 != null) {
            user.finishedStages = ValueObject.util_map(list7, new w9j() { // from class: l.jxj0
                public final Object call(Object obj) {
                    return User.m1032c((StepSignupStage) obj);
                }
            });
        }
        ...
        if (activityUser != null) {
            user.activityUser = activityUser.m17625clone();
        }
        ...
        if (list8 != null) {
            user.localLikeIdentifiers = ValueObject.util_map(list8, new w9j() { // from class: l.zwj0
                public final Object call(Object obj) {
                    return User.m1031b((String) obj);
                }
            });
        }
    ...
    public String getAiPictureStatus() {
        return NullChecker.a(this.settings) ? this.settings.getAiPictureEnable() : FeedMakeupPageAdapter.MakeupItem.NONE;
    }
    ...
    public String getAnonymousUrl() {
        return !vwb.J(this.profile.extensions.live.voiceImgUrl) ? this.profile.extensions.live.voiceImgUrl.get(0) : "";
    }
    ...
    public String getCurrentPureMode() {
        ...
        Settings settings = this.settings;
        return (settings == null || vwb.J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userLiveSettings = settingGroup.live) == null) ? "" : userLiveSettings.pureModeGroup;
    }
    ...
    public int getFriendCommentCount() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        if (friendCommentInfo == null || vwb.J(friendCommentInfo.friendsComments)) {
            return 0;
        }
    ...
    public int getFriendHistoryCommentCount() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        if (friendCommentInfo == null || vwb.J(friendCommentInfo.friendsCommentsHistory)) {
            return 0;
        }
    ...
    public String getHometown() {
        if (!NullChecker.a(this.profile) || !NullChecker.a(this.profile.extensions) || !NullChecker.a(this.profile.extensions.basic)) {
            return "";
        }
        if (!vwb.J(this.profile.extensions.basic.city) && !TextUtils.isEmpty(this.profile.extensions.basic.city.get(0))) {
            return this.profile.extensions.basic.city.get(0);
        }
        if (vwb.J(this.profile.extensions.basic.province) || TextUtils.isEmpty(this.profile.extensions.basic.province.get(0))) {
            return !vwb.J(this.profile.extensions.basic.country) ? this.profile.extensions.basic.country.get(0) : "";
        }
    ...
    public List<String> getIdealList() {
        if (!NullChecker.a(this.profile) || !NullChecker.a(this.profile.extensions) || !NullChecker.a(this.profile.extensions.basic) || vwb.J(this.profile.extensions.basic.ideal)) {
            return null;
        }
        ArrayList arrayList = new ArrayList();
        Iterator<IdealTag> it = this.profile.extensions.basic.ideal.iterator();
        while (it.hasNext()) {
            arrayList.add(it.next().f221id);
        }
        return arrayList;
    }
    ...
    public String getMarriageDeclaration() {
        return (NullChecker.a(this.profile) && NullChecker.a(this.profile.extensions) && NullChecker.a(this.profile.extensions.marriage) && !vwb.J(this.profile.extensions.marriage.declaration) && !TextUtils.isEmpty(this.profile.extensions.marriage.declaration.get(0))) ? this.profile.extensions.marriage.declaration.get(0) : "";
    }

    public String getMarriageFamilyBackground() {
        return (NullChecker.a(this.profile) && NullChecker.a(this.profile.extensions) && NullChecker.a(this.profile.extensions.basic) && !vwb.J(this.profile.extensions.basic.familyBackground) && !TextUtils.isEmpty(this.profile.extensions.basic.familyBackground.get(0))) ? this.profile.extensions.basic.familyBackground.get(0) : "";
    }

    public String getMarriageFamilyBridePrice() {
        return (NullChecker.a(this.profile) && NullChecker.a(this.profile.extensions) && NullChecker.a(this.profile.extensions.marriage) && !vwb.J(this.profile.extensions.marriage.bridePrice) && !TextUtils.isEmpty(this.profile.extensions.marriage.bridePrice.get(0))) ? this.profile.extensions.marriage.bridePrice.get(0) : "";
    }

    public String getMarriagePrologue() {
        return (NullChecker.a(this.profile) && NullChecker.a(this.profile.extensions) && NullChecker.a(this.profile.extensions.marriage) && !vwb.J(this.profile.extensions.marriage.prologue) && !TextUtils.isEmpty(this.profile.extensions.marriage.prologue.get(0))) ? this.profile.extensions.marriage.prologue.get(0) : "";
    }

    public List<String> getMarryLifeMoment() {
        if (NullChecker.a(this.profile) && NullChecker.a(this.profile.extensions) && NullChecker.a(this.profile.extensions.marriage) && !vwb.J(this.profile.extensions.marriage.lifeMoment)) {
    ...
    public long getMembershipExpireTime(final MembershipType membershipType) {
        ArrayList arrayListN = vwb.n(this.memberships, new w9j() { // from class: l.bxj0
            public final Object call(Object obj) {
    ...
    public String getQualificationText() {
        if (!NullChecker.a(this.profile) || !NullChecker.a(this.profile.extensions) || !NullChecker.a(this.profile.extensions.basic) || vwb.J(this.profile.extensions.basic.qualification)) {
            return "";
        }
    ...
    public int getSupremePartnerUserCode() {
        if (NullChecker.a(this.settings)) {
    ...
    public String getUserHeight() {
        if (!NullChecker.a(this.profile) || !NullChecker.a(this.profile.extensions) || !NullChecker.a(this.profile.extensions.physical) || vwb.J(this.profile.extensions.physical.height)) {
            return "";
        }
        List<String> list = this.profile.extensions.physical.height;
        return (vwb.J(list) || TextUtils.isEmpty(list.get(0))) ? "" : list.get(0);
    }
    ...
    public String getUserInfoForMarryStatus() {
        ...
        Settings settings = this.settings;
        return (settings == null || vwb.J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (marrySettings = settingGroup.marriage) == null || TextUtils.isEmpty(marrySettings.profileAudit)) ? "" : settingGroup.marriage.profileAudit;
    }

    public uqd0 getUserName() {
        return new uqd0("UserName" + ((DbObject) this).id, "");
    }

    public uqd0 getUserPicture() {
        return new uqd0("UserPicture" + ((DbObject) this).id, "");
    }
    ...
    public long getVipExpireTime() {
        return vwb.n(this.memberships, new w9j() { // from class: l.ywj0
            public final Object call(Object obj) {
    ...
    public long getVipToExpireTimeInMill() {
        return getVipExpireTime() - qib0.H.guessedCurrentServerTime();
    }
    ...
    public boolean hasAuditedMarray() {
        ...
        MarrySettings marrySettings;
        Settings settings = this.settings;
        if (settings == null || vwb.J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (marrySettings = settingGroup.marriage) == null) {
            return false;
        }
    ...
    public boolean hasFriendComment() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        return (friendCommentInfo == null || vwb.J(friendCommentInfo.friendsComments)) ? false : true;
    }

    public boolean hasHistoryFriendComment() {
        FriendCommentInfo friendCommentInfo = this.friendCommentInfo;
        return (friendCommentInfo == null || vwb.J(friendCommentInfo.friendsCommentsHistory)) ? false : true;
    }

    public boolean hasIdealInfo() {
        return NullChecker.a(this.profile) && NullChecker.a(this.profile.extensions) && NullChecker.a(this.profile.extensions.basic) && !vwb.J(this.profile.extensions.basic.ideal);
    }
    ...
    public boolean hasPic() {
        return (vwb.J(this.pictures) || TextUtils.isEmpty(this.pictures.get(0).url)) ? false : true;
    }
    ...
    public int hashCode() {
        ...
        ((ValueObject) this).hashCode = iHashCode64;
        return iHashCode64;
    }
    ...
    public boolean hideBlackDiamondTag() {
        ...
        UserLiveSettings userLiveSettings;
        Settings settings = this.settings;
        if (settings == null || vwb.J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userLiveSettings = settingGroup.live) == null) {
            return false;
        }
    ...
    public boolean isChatJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.chat)) {
            return false;
        }
        JailedGroupChat jailedGroupChat = this.state.jailedBusiness.chat;
        return jailedGroupChat.active && jailedGroupChat.expireTime > ((double) mqi0.o());
    }
    ...
    public boolean isFakeUser() {
        return !vwb.J(this.status) && this.status.contains(UserStatus.get("hidden")) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_UNREAL));
    }
    ...
    public boolean isGreetingJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.greeting)) {
            return false;
        }
    ...
    public boolean isHideActiveFromSVip() {
        ...
        if (NullChecker.a(this.settings) && !vwb.J(this.settings.settingGroups)) {
            SettingGroups settingGroup = this.settings.getSettingGroup();
            if (NullChecker.a(settingGroup) && (svipPrivacySettings = settingGroup.svipPrivacy) != null && svipPrivacySettings.frozenTime != 0) {
                return true;
            }
        }
        return false;
    ...
    public boolean isHideAgeForTeamAccount() {
        return TextUtils.equals(ID_VERIVICATION_ASSISTANT, ((DbObject) this).id);
    }
    ...
    public boolean isHideIconFromSVip() {
        SvipPrivacySettings svipPrivacySettings;
        if (isMe() || !NullChecker.a(this.settings) || vwb.J(this.settings.settingGroups)) {
            return false;
        }
        SettingGroups settingGroup = this.settings.getSettingGroup();
        if (!NullChecker.a(settingGroup) || (svipPrivacySettings = settingGroup.svipPrivacy) == null) {
    ...
    public boolean isHideIconFromSVipWithMe() {
        if (NullChecker.a(this.settings) && !vwb.J(this.settings.settingGroups)) {
            SettingGroups settingGroup = this.settings.getSettingGroup();
            if (NullChecker.a(settingGroup) && NullChecker.a(settingGroup.svipPrivacy)) {
    ...
    public boolean isLiveJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.live)) {
            return false;
        }
    ...
    public boolean isLoveBuzz() {
        if (isMe() || isTeamAccount() || !NullChecker.a(this.localRelationship)) {
            return false;
        }
        return TextUtils.equals(MatchFrom.lovebuzz, this.localRelationship.convType);
    }

    public boolean isMe() {
        return TextUtils.equals(((DbObject) this).id, qib0.c0.userId());
    }

    public boolean isMembership(MembershipType membershipType) {
        return getMembershipExpireTime(membershipType) - qib0.H.guessedCurrentServerTime() > 0;
    }
    ...
    public boolean isMomentCommentJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.momentComment)) {
            return false;
        }
    ...
    public boolean isMomentJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.moment)) {
            return false;
        }
    ...
    public boolean isNewHere() {
        if (newHereDay < 0) {
            try {
                String strF = RemoteConfig.x().F("ttt_new_here_days");
                if (TextUtils.isEmpty(strF)) {
                    newHereDay = 7;
                } else {
                    newHereDay = new JSONObject(strF).optInt("register_days");
                }
            } catch (Exception unused) {
                newHereDay = 7;
            }
        }
        return this.createdTime > 0.0d && newHereDay > 0 && ((double) mqi0.o()) - this.createdTime <= ((double) (newHereDay * 86400000));
    }
    ...
    public boolean isNewUserIn24H() {
        return !mqi0.w((long) this.createdTime, 24);
    }
    ...
    public boolean isOnCityTop() {
        return NullChecker.a(this.settings) && this.settings.isCityTop();
    }
    ...
    public boolean isProfileJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.changeProfile)) {
            return false;
        }
    ...
    public boolean isRiskAuditAvatar() {
        return NullChecker.a(this.status) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_AVATAR_IN_AUDIT));
    }

    public boolean isRiskAuditName() {
        return NullChecker.a(this.status) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_NAME_IN_AUDIT));
    }
    ...
    public boolean isSVIP() {
        ...
        Settings settings = this.settings;
        if (settings == null || vwb.J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userSVIPSettings = settingGroup.svip) == null) {
            return false;
        }
    ...
    public boolean isStudentVerified() {
        boolean z = NullChecker.a(this.settings) && NullChecker.a(this.settings.verification) && NullChecker.a(this.settings.verification.studies) && TEnum.equals(this.settings.verification.studies.status, "verified");
    ...
    public boolean isSupremePartnerOpenMystery() {
        return NullChecker.a(this.settings) && this.settings.isSupremePartner() && this.settings.isSupremePartnerOpenMystery();
    }

    public boolean isSwipeJailed() {
        if (!NullChecker.a(this.state) || !NullChecker.a(this.state.jailedBusiness) || !NullChecker.a(this.state.jailedBusiness.swipe)) {
            return false;
        }
    ...
    public boolean isUltraPremium() {
        ...
        Settings settings = this.settings;
        if (settings == null || vwb.J(settings.settingGroups) || (settingGroup = this.settings.getSettingGroup()) == null || (userUpVipSettings = settingGroup.upvip) == null) {
            return false;
        }
    ...
    public boolean isYoungRisk() {
        return NullChecker.a(this.status) && this.status.contains(UserStatus.get(UserStatus.RISK_TAG_MANDATORY_IDENTITY_VERIFICATION_UNDERAGE));
    }

    public boolean jailedBusinessChatHadReason() {
        return (NullChecker.a(this.state) && NullChecker.a(this.state.jailedBusiness) && NullChecker.a(this.state.jailedBusiness.chat) && TextUtils.equals(this.state.jailedBusiness.chat.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessMomentCommentHadReason() {
        return (NullChecker.a(this.state) && NullChecker.a(this.state.jailedBusiness) && NullChecker.a(this.state.jailedBusiness.momentComment) && TextUtils.equals(this.state.jailedBusiness.momentComment.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessMomentHadReason() {
        return (NullChecker.a(this.state) && NullChecker.a(this.state.jailedBusiness) && NullChecker.a(this.state.jailedBusiness.moment) && TextUtils.equals(this.state.jailedBusiness.moment.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessProfileHadReason() {
        return (NullChecker.a(this.state) && NullChecker.a(this.state.jailedBusiness) && NullChecker.a(this.state.jailedBusiness.changeProfile) && TextUtils.equals(this.state.jailedBusiness.changeProfile.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean jailedBusinessSwipeHadReason() {
        return (NullChecker.a(this.state) && NullChecker.a(this.state.jailedBusiness) && NullChecker.a(this.state.jailedBusiness.swipe) && TextUtils.equals(this.state.jailedBusiness.swipe.reason, this.NO_ASSISTANT_MSG)) ? false : true;
    }

    public boolean lessThanFifteenPrivateAnswer() {
        return vwb.n(this.privateAnswers, new w9j() { // from class: l.axj0
            public final Object call(Object obj) {
    ...
    public boolean lessThanFivePrivateAnswer() {
        return vwb.n(this.privateAnswers, new w9j() { // from class: l.cxj0
            public final Object call(Object obj) {
                return Boolean.valueOf(!TextUtils.isEmpty(((PrivateAnswer) obj).selection));
            }
        }).size() < 5;
    ...
    public boolean letter() {
        if (((DbObject) this).id.equals(qib0.c0.userId()) || isTeamAccount()) {
            return false;
        }
    ...
    public String letterString() {
        if (letter()) {
            return (NullChecker.a(this.localRelationship) && NullChecker.a(this.localRelationship.relationshipExtensions)) ? this.localRelationship.relationshipExtensions.otherLetter : this.sendLetter;
        }
        return null;
    }
    ...
    public boolean likedMe() {
        Relationship relationship;
        if (((DbObject) this).id.equals(qib0.c0.userId()) || isTeamAccount() || (relationship = this.localRelationship) == null) {
            return false;
        }
    ...
    public void onApiParseComplete() {
        ...
        if (isRiskAudit()) {
            uqd0 userName = getUserName();
            uqd0 userPicture = getUserPicture();
            if (isRiskAuditName()) {
            ...
            if (isRiskAuditAvatar()) {
                ...
                this.pictures.get(0).url = TextUtils.isEmpty((CharSequence) gl5.f8475d.get()) ? getDefaultRiskAuditUser().userPicture : (String) gl5.f8475d.get();
            }
        }
    }
    ...
    public int parseRelationStatus() {
        if (isTeamAccount(((DbObject) this).id)) {
            return 3;
        }
        if (isMe()) {
            return 4;
        }
        if (NullChecker.a(this.localRelationship) && TEnum.equals(this.localRelationship.state, "matched")) {
            return 0;
        }
        if (NullChecker.a(this.localFollowship) && NullChecker.a(this.localFollowship.maskState) && (TEnum.equals(this.localFollowship.maskState, FollowshipStatus.followed) || TEnum.equals(this.localFollowship.maskState, FollowshipStatus.following) || TEnum.equals(this.localFollowship.maskState, "matched"))) {
            return 1;
        }
        if (NullChecker.a(this.localFollowship) && NullChecker.a(this.localFollowship.state)) {
    ...
    public int receiveSuperLikeNum() {
        if (NullChecker.a(this.localRelationship) && NullChecker.a(this.localRelationship.relationshipExtensions)) {
            try {
    ...
    public String relativeTimeForTrack() {
        ...
        long jGuessedCurrentServerTime = (qib0.H.guessedCurrentServerTime() - lastActiveTimeMillis) / 1000;
        if (jGuessedCurrentServerTime > 31536000) {
            ...
            if (jGuessedCurrentServerTime <= 604800) {
                if (jGuessedCurrentServerTime > 86400) {
                    ...
                    i = ((int) (jGuessedCurrentServerTime / 3600)) * 3600;
                } else {
    ...
    public User riskAuditUser(User user) {
        ...
        User userM19150clone = m19150clone();
        if (isRiskAuditAvatar()) {
            userM19150clone.pictures.get(0).url = user.pictures.get(0).url;
        }
        if (isRiskAuditName()) {
            userM19150clone.name = user.name;
        }
        return userM19150clone;
    }
    ...
    public void showPicVerificationIcon(View view, VImage vImage) {
        qib0.b0.b.showUserVerificationLogo(vImage.getContext(), this, vImage);
        if (jjb0.b()) {
            xdl0.M(view, xdl0.O0(vImage));
        } else {
            xdl0.M(view, isPicVerificationVerified());
        }
    }
    ...
    public boolean isTeamAccount() {
        return this.status.contains(UserStatus.get(UserStatus.teamaccount)) || isTeamAccount(((DbObject) this).id);
    }
}
