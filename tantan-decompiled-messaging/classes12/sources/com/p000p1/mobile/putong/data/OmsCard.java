...
import com.p000p1.mobile.putong.data.OmsCard;
...
public class OmsCard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OmsCard> PROTOBUF_ADAPTER = new MessageNanoAdapter<OmsCard>() { // from class: com.p1.mobile.putong.data.OmsCard.1
        ...
        public int computeAndCacheSize(OmsCard omsCard) {
            ...
            ((MessageNano) omsCard).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public OmsCard m18705parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    omsCard.pictures = (List) nb5Var.l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 18) {
                    omsCard.color = nb5Var.s();
                } else if (iU == 26) {
                    omsCard.topLeftTags = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 34) {
                    omsCard.icons = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 42) {
                    omsCard.title = nb5Var.s();
                } else if (iU == 50) {
                    omsCard.description = nb5Var.s();
                } else {
                    if (iU != 58) {
                        if (omsCard.pictures == null) {
                            omsCard.pictures = new ArrayList();
                    ...
                    omsCard.action = (Action) nb5Var.l(Action.PROTOBUF_ADAPTER);
                }
            }
            return omsCard;
        }
    ...
    public static JsonAdapter<OmsCard> JSON_ADAPTER = new ObjectJsonAdapter<OmsCard>() { // from class: com.p1.mobile.putong.data.OmsCard.2
        ...
        public OmsCard mo17830newInstance() {
            return new OmsCard();
        }
        ...
        public boolean parseField(OmsCard omsCard, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "description":
                    ...
                    return true;
                case "action":
                    omsCard.action = (Action) Action.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "topLeftTags":
    ...
    public static /* synthetic */ String m869a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m871c(String str) {
        return str;
    }
    ...
    public OmsCard m18704clone() {
        ...
        if (list2 != null) {
            omsCard.topLeftTags = ValueObject.util_map(list2, new w9j() { // from class: l.ea50
                public final Object call(Object obj) {
                    return OmsCard.m871c((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            omsCard.icons = ValueObject.util_map(list3, new w9j() { // from class: l.fa50
                public final Object call(Object obj) {
                    return OmsCard.m869a((String) obj);
                }
            });
        }
        ...
        if (action != null) {
            omsCard.action = action.m17622clone();
        }
        return omsCard;
    }
