...
public class PurchasePaymentParam extends PaymentParam implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PurchasePaymentParam> PROTOBUF_ADAPTER = new MessageNanoAdapter<PurchasePaymentParam>() { // from class: com.p1.mobile.putong.data.PurchasePaymentParam.1
        ...
        public int computeAndCacheSize(PurchasePaymentParam purchasePaymentParam) {
            ...
            int iB = iO + CodedOutputByteBufferNano.b(4, purchasePaymentParam.useAutoDeduct) + CodedOutputByteBufferNano.b(5, purchasePaymentParam.signAndPay);
            ...
            int iB2 = iB + CodedOutputByteBufferNano.b(9, purchasePaymentParam.useJDNew);
            String str6 = purchasePaymentParam.orderId;
            if (str6 != null) {
                iB2 += CodedOutputByteBufferNano.o(51, str6);
            }
            int iH = iB2 + CodedOutputByteBufferNano.h(52, purchasePaymentParam.quantity) + CodedOutputByteBufferNano.b(53, purchasePaymentParam.useHuaBei) + CodedOutputByteBufferNano.b(54, purchasePaymentParam.jsBridge);
            ((MessageNano) purchasePaymentParam).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public PurchasePaymentParam m18857parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        purchasePaymentParam.itemId = nb5Var.s();
                        continue;
                    case 18:
                        purchasePaymentParam.receipt = nb5Var.s();
                        continue;
                    case 26:
                        purchasePaymentParam.url = nb5Var.s();
                        continue;
                    case AudioRouteDeviceManager.RoutingDeviceType.USB_HEADSET /* 32 */:
                        purchasePaymentParam.useAutoDeduct = nb5Var.g();
                        continue;
                    case 40:
                        purchasePaymentParam.signAndPay = nb5Var.g();
                        continue;
                    case 50:
                        purchasePaymentParam.tracker = nb5Var.s();
                        continue;
                    case 58:
                        purchasePaymentParam.ext = (PaymentParamExtra) nb5Var.l(PaymentParamExtra.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        purchasePaymentParam.couponId = nb5Var.s();
                        continue;
                    case 72:
                        purchasePaymentParam.useJDNew = nb5Var.g();
                        continue;
                    case 410:
                        purchasePaymentParam.orderId = nb5Var.s();
                        continue;
                    case 416:
                        purchasePaymentParam.quantity = nb5Var.j();
                        continue;
                    case 424:
                        purchasePaymentParam.useHuaBei = nb5Var.g();
                        continue;
                    case 432:
                        purchasePaymentParam.jsBridge = nb5Var.g();
                        continue;
                    default:
                        if (purchasePaymentParam.itemId == null) {
                            purchasePaymentParam.itemId = "";
        ...
        public void serialize(PurchasePaymentParam purchasePaymentParam, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.A(4, purchasePaymentParam.useAutoDeduct);
            codedOutputByteBufferNano.A(5, purchasePaymentParam.signAndPay);
            String str4 = purchasePaymentParam.tracker;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.A(9, purchasePaymentParam.useJDNew);
            String str6 = purchasePaymentParam.orderId;
            if (str6 != null) {
                codedOutputByteBufferNano.R(51, str6);
            }
            codedOutputByteBufferNano.G(52, purchasePaymentParam.quantity);
            codedOutputByteBufferNano.A(53, purchasePaymentParam.useHuaBei);
            codedOutputByteBufferNano.A(54, purchasePaymentParam.jsBridge);
        }
    };
    public static JsonAdapter<PurchasePaymentParam> JSON_ADAPTER = new ObjectJsonAdapter<PurchasePaymentParam>() { // from class: com.p1.mobile.putong.data.PurchasePaymentParam.2
        ...
        public PurchasePaymentParam mo17830newInstance() {
        ...
        public boolean parseField(PurchasePaymentParam purchasePaymentParam, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "useJDNew":
                    ...
                    return true;
                case "ext":
                    purchasePaymentParam.ext = (PaymentParamExtra) PaymentParamExtra.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "url":
        ...
        public void serializeFields(PurchasePaymentParam purchasePaymentParam, JsonGenerator jsonGenerator) throws IOException {
            ...
            jsonGenerator.writeNumberField("quantity", purchasePaymentParam.quantity);
    ...
    @Override // com.p000p1.mobile.putong.data.PaymentParam
    /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
    public PurchasePaymentParam mo18779clone() {
        PurchasePaymentParam purchasePaymentParam = new PurchasePaymentParam();
        ...
        if (paymentParamExtra != null) {
            purchasePaymentParam.ext = paymentParamExtra.m18782clone();
        }
