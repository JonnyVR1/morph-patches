...
public abstract class Media extends ValueObject implements Cloneable, Serializable {
    public static ProtobufAdapter<Media> PROTOBUF_ADAPTER = new ProtobufAdapter<Media>() { // from class: com.p1.mobile.putong.data.Media.1
        ...
        public int computeAndCacheSize(Media media) {
            if (media instanceof Picture) {
                return CodedOutputByteBufferNano.l(1, (Picture) media, Picture.PROTOBUF_ADAPTER);
            }
            if (media instanceof Audio) {
                return CodedOutputByteBufferNano.l(3, (Audio) media, Audio.PROTOBUF_ADAPTER);
            }
            if (media instanceof Video) {
                return CodedOutputByteBufferNano.l(2, (Video) media, Video.PROTOBUF_ADAPTER);
            }
            return 0;
        }
        ...
        public int getSize(Media media) {
            if (media instanceof Picture) {
                return CodedOutputByteBufferNano.w(1, (Picture) media, Picture.PROTOBUF_ADAPTER);
            }
            if (media instanceof Audio) {
                return CodedOutputByteBufferNano.w(3, (Audio) media, Audio.PROTOBUF_ADAPTER);
            }
            if (media instanceof Video) {
                return CodedOutputByteBufferNano.w(2, (Video) media, Video.PROTOBUF_ADAPTER);
            }
            return 0;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public Media m18441parse(nb5 nb5Var) throws IOException {
            int iU = nb5Var.u();
            if (iU == 10) {
                return (Media) nb5Var.l(Picture.PROTOBUF_ADAPTER);
            }
            if (iU == 18) {
                return (Media) nb5Var.l(Video.PROTOBUF_ADAPTER);
            }
            if (iU != 26) {
                return null;
            }
            return (Media) nb5Var.l(Audio.PROTOBUF_ADAPTER);
        }

        public void serialize(Media media, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            if (media instanceof Picture) {
                codedOutputByteBufferNano.K(1, (Picture) media, Picture.PROTOBUF_ADAPTER);
            } else if (media instanceof Audio) {
                codedOutputByteBufferNano.K(3, (Audio) media, Audio.PROTOBUF_ADAPTER);
            } else if (media instanceof Video) {
                codedOutputByteBufferNano.K(2, (Video) media, Video.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static Media fromUrl(String str) {
        try {
            ...
            if (isValidCloudMediaURL(url)) {
                ...
                int i = jSONObject.getInt(RXScreenCaptureService.KEY_WIDTH);
    ...
    public static boolean isValidCloudMediaURL(URL url) {
        try {
            return (mu5.g.contains(url.getHost()) || TANTAN_CDN_URL.contains(url.getHost())) && url.getPath().substring(1).split("/").length >= 3;
        } catch (Exception unused) {
            return false;
        }
    }
    ...
    public static void setFocusPoint(Media media, float[] fArr) {
        ...
        if (media instanceof Picture) {
            ...
            int i = aIPosition.f178x;
            int i2 = aIPosition.f179y;
            if (i == 0) {
                fArr[0] = 0.0f;
            } else if (i == 1) {
                fArr[0] = 0.5f;
    ...
    public abstract Media mo17714clone();
