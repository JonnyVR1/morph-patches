...
public class OpenSDKInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OpenSDKInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OpenSDKInfo>() { // from class: com.p1.mobile.putong.data.OpenSDKInfo.1
        ...
        public int computeAndCacheSize(OpenSDKInfo openSDKInfo) {
            ...
            if (scopes != null) {
                iO += CodedOutputByteBufferNano.l(2, scopes, Scopes.PROTOBUF_ADAPTER);
            }
            String str2 = openSDKInfo.logo_url;
            if (str2 != null) {
                iO += CodedOutputByteBufferNano.o(3, str2);
            }
            int iH = iO + CodedOutputByteBufferNano.h(4, openSDKInfo.error);
            String str3 = openSDKInfo.message;
            if (str3 != null) {
                iH += CodedOutputByteBufferNano.o(5, str3);
            }
            ((MessageNano) openSDKInfo).cachedSize = iH;
            return iH;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public OpenSDKInfo m18738parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    openSDKInfo.name = nb5Var.s();
                } else if (iU == 18) {
                    openSDKInfo.scopes = (Scopes) nb5Var.l(Scopes.PROTOBUF_ADAPTER);
                } else if (iU == 26) {
                    openSDKInfo.logo_url = nb5Var.s();
                } else if (iU == 32) {
                    openSDKInfo.error = nb5Var.j();
                } else {
                    if (iU != 42) {
                        if (openSDKInfo.name == null) {
                            openSDKInfo.name = "";
        ...
        public void serialize(OpenSDKInfo openSDKInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Scopes scopes = openSDKInfo.scopes;
            if (scopes != null) {
                codedOutputByteBufferNano.K(2, scopes, Scopes.PROTOBUF_ADAPTER);
            }
            String str2 = openSDKInfo.logo_url;
            if (str2 != null) {
                codedOutputByteBufferNano.R(3, str2);
            }
            codedOutputByteBufferNano.G(4, openSDKInfo.error);
            String str3 = openSDKInfo.message;
            if (str3 != null) {
    ...
    public static JsonAdapter<OpenSDKInfo> JSON_ADAPTER = new ObjectJsonAdapter<OpenSDKInfo>() { // from class: com.p1.mobile.putong.data.OpenSDKInfo.2
        ...
        public OpenSDKInfo mo17830newInstance() {
        ...
        public boolean parseField(OpenSDKInfo openSDKInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "scopes":
                    openSDKInfo.scopes = (Scopes) Scopes.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "name":
    ...
    public OpenSDKInfo m18737clone() {
        OpenSDKInfo openSDKInfo = new OpenSDKInfo();
        openSDKInfo.name = this.name;
        Scopes scopes = this.scopes;
        if (scopes != null) {
            openSDKInfo.scopes = scopes.m18931clone();
        }
