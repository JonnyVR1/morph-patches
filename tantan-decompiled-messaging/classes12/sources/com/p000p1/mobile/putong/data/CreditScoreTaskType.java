...
public class CreditScoreTaskType extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(newMessage, int_newMessage);
        tEnumJsonAdapter.addExtJsonValue(charisma, int_charisma);
        tEnumJsonAdapter.addExtJsonValue("report", int_report);
        tEnumJsonAdapter.addExtJsonValue(realPerson, int_realPerson);
        tEnumJsonAdapter.addExtJsonValue(privilege, int_privilege);
