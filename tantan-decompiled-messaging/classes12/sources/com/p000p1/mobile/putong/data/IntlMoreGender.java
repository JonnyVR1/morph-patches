...
import com.p000p1.mobile.putong.data.IntlMoreGender;
...
public class IntlMoreGender extends ValueObject<IntlMoreGender> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlMoreGender> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlMoreGender>() { // from class: com.p1.mobile.putong.data.IntlMoreGender.1
        ...
        public int computeAndCacheSize(IntlMoreGender intlMoreGender) {
            ...
            int iL = intlGender != null ? CodedOutputByteBufferNano.l(1, intlGender, IntlGender.PROTOBUF_ADAPTER) : 0;
            ...
            if (list != null) {
                iL += CodedOutputByteBufferNano.l(3, list, LookingFor.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool = intlMoreGender.notShowCis;
            if (bool != null) {
                iL += CodedOutputByteBufferNano.b(4, bool.booleanValue());
            }
            Boolean bool2 = intlMoreGender.showOnProfile;
            if (bool2 != null) {
                iL += CodedOutputByteBufferNano.b(5, bool2.booleanValue());
            }
            Boolean bool3 = intlMoreGender.canUpdate;
            if (bool3 != null) {
                iL += CodedOutputByteBufferNano.b(6, bool3.booleanValue());
            }
            ((MessageNano) intlMoreGender).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public IntlMoreGender m18232parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    intlMoreGender.newGender = (IntlGender) nb5Var.l(IntlGender.PROTOBUF_ADAPTER);
                } else if (iU == 18) {
                    intlMoreGender.subGender = nb5Var.s();
                } else if (iU == 26) {
                    intlMoreGender.lookingForGenders = (List) nb5Var.l(LookingFor.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 32) {
                    intlMoreGender.notShowCis = Boolean.valueOf(nb5Var.g());
                } else if (iU == 40) {
                    intlMoreGender.showOnProfile = Boolean.valueOf(nb5Var.g());
                } else {
                    if (iU != 48) {
                        if (intlMoreGender.lookingForGenders == null) {
                            intlMoreGender.lookingForGenders = new ArrayList();
                    ...
                    intlMoreGender.canUpdate = Boolean.valueOf(nb5Var.g());
                }
            }
            return intlMoreGender;
        }
        ...
        public void serialize(IntlMoreGender intlMoreGender, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            IntlGender intlGender = intlMoreGender.newGender;
            if (intlGender != null) {
                codedOutputByteBufferNano.K(1, intlGender, IntlGender.PROTOBUF_ADAPTER);
            }
            String str = intlMoreGender.subGender;
            if (str != null) {
            ...
            List<LookingFor> list = intlMoreGender.lookingForGenders;
            if (list != null) {
                codedOutputByteBufferNano.K(3, list, LookingFor.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool = intlMoreGender.notShowCis;
            if (bool != null) {
    ...
    public static JsonAdapter<IntlMoreGender> JSON_ADAPTER = new ObjectJsonAdapter<IntlMoreGender>() { // from class: com.p1.mobile.putong.data.IntlMoreGender.2
        ...
        public IntlMoreGender mo17830newInstance() {
        ...
        public boolean parseField(IntlMoreGender intlMoreGender, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                case 0:
                    intlMoreGender.newGender = (IntlGender) IntlGender.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case 1:
    ...
    public static /* synthetic */ LookingFor m727a(LookingFor lookingFor) {
        return lookingFor;
    }
    ...
    public IntlMoreGender m18231clone() {
        IntlMoreGender intlMoreGender = new IntlMoreGender();
        ...
        if (list != null) {
            intlMoreGender.lookingForGenders = ValueObject.util_map(list, new w9j() { // from class: l.sko
                public final Object call(Object obj) {
                    return IntlMoreGender.m727a((LookingFor) obj);
                }
            });
        }
