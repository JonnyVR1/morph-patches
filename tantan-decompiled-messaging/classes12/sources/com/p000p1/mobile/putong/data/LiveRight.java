...
public class LiveRight extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveRight> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveRight>() { // from class: com.p1.mobile.putong.data.LiveRight.1
        ...
        public int computeAndCacheSize(LiveRight liveRight) {
            ...
            if (liveAvatarFrameConfig != null) {
                iO += CodedOutputByteBufferNano.l(6, liveAvatarFrameConfig, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
            ((MessageNano) liveRight).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public LiveRight m18370parse(nb5 nb5Var) throws IOException {
            LiveRight liveRight = new LiveRight();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (liveRight.f234id == null) {
                        liveRight.f234id = "";
                    }
                ...
                if (iU == 10) {
                    liveRight.f234id = nb5Var.s();
                } else if (iU == 18) {
                    liveRight.name = nb5Var.s();
                } else if (iU == 26) {
                    liveRight.rightType = nb5Var.s();
                } else if (iU == 34) {
                    liveRight.placeType = nb5Var.s();
                } else if (iU == 42) {
                    liveRight.description = nb5Var.s();
                } else {
                    if (iU != 50) {
                        if (liveRight.f234id == null) {
                            liveRight.f234id = "";
                    ...
                    liveRight.avatarFrameConfig = (LiveAvatarFrameConfig) nb5Var.l(LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
                }
            }
            return liveRight;
        }
        ...
        public void serialize(LiveRight liveRight, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            LiveAvatarFrameConfig liveAvatarFrameConfig = liveRight.avatarFrameConfig;
            if (liveAvatarFrameConfig != null) {
                codedOutputByteBufferNano.K(6, liveAvatarFrameConfig, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<LiveRight> JSON_ADAPTER = new ObjectJsonAdapter<LiveRight>() { // from class: com.p1.mobile.putong.data.LiveRight.2
        ...
        public LiveRight mo17830newInstance() {
        ...
        public boolean parseField(LiveRight liveRight, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "avatarFrameConfig":
                    liveRight.avatarFrameConfig = (LiveAvatarFrameConfig) LiveAvatarFrameConfig.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "id":
                    liveRight.f234id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public LiveRight m18369clone() {
        LiveRight liveRight = new LiveRight();
        liveRight.f234id = this.f234id;
        ...
        if (liveAvatarFrameConfig != null) {
            liveRight.avatarFrameConfig = liveAvatarFrameConfig.m18327clone();
        }
        return liveRight;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f234id, liveRight.f234id) && ValueObject.util_equals(this.name, liveRight.name) && ValueObject.util_equals(this.rightType, liveRight.rightType) && ValueObject.util_equals(this.placeType, liveRight.placeType) && ValueObject.util_equals(this.description, liveRight.description) && ValueObject.util_equals(this.avatarFrameConfig, liveRight.avatarFrameConfig);
    }
