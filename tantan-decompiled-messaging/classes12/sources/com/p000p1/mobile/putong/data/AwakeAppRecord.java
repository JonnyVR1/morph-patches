...
public class AwakeAppRecord extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AwakeAppRecord> PROTOBUF_ADAPTER = new MessageNanoAdapter<AwakeAppRecord>() { // from class: com.p1.mobile.putong.data.AwakeAppRecord.1
        ...
        public int computeAndCacheSize(AwakeAppRecord awakeAppRecord) {
            ...
            int iO = (str != null ? CodedOutputByteBufferNano.o(1, str) : 0) + CodedOutputByteBufferNano.j(2, awakeAppRecord.startPullAliveTime) + CodedOutputByteBufferNano.h(3, awakeAppRecord.hasPullAliveCount) + CodedOutputByteBufferNano.j(4, awakeAppRecord.lastPullAliveTime);
            ((MessageNano) awakeAppRecord).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public AwakeAppRecord m17739parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    awakeAppRecord.package_name = nb5Var.s();
                } else if (iU == 16) {
                    awakeAppRecord.startPullAliveTime = nb5Var.k();
                } else if (iU == 24) {
                    awakeAppRecord.hasPullAliveCount = nb5Var.j();
                } else {
                    if (iU != 32) {
                        if (awakeAppRecord.package_name != null) {
                            break;
                    ...
                    awakeAppRecord.lastPullAliveTime = nb5Var.k();
                }
            }
            return awakeAppRecord;
        }
        ...
        public void serialize(AwakeAppRecord awakeAppRecord, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.I(2, awakeAppRecord.startPullAliveTime);
            codedOutputByteBufferNano.G(3, awakeAppRecord.hasPullAliveCount);
            codedOutputByteBufferNano.I(4, awakeAppRecord.lastPullAliveTime);
        }
    };
    public static JsonAdapter<AwakeAppRecord> JSON_ADAPTER = new ObjectJsonAdapter<AwakeAppRecord>() { // from class: com.p1.mobile.putong.data.AwakeAppRecord.2
        ...
        public AwakeAppRecord mo17830newInstance() {
    ...
    public AwakeAppRecord m17738clone() {
        AwakeAppRecord awakeAppRecord = new AwakeAppRecord();
