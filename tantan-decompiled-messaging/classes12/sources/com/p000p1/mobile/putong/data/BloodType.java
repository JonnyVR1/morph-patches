...
public class BloodType extends TEnum {
    ...
    public static final String f187AB = "AB";

    /* JADX INFO: renamed from: B */
    public static final String f188B = "B";
    public static final TEnumJsonAdapter<BloodType> JSON_ADAPTER;

    /* JADX INFO: renamed from: O */
    public static final String f189O = "O";
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(f186A, 0);
        tEnumJsonAdapter.addExtJsonValue(f188B, 1);
        tEnumJsonAdapter.addExtJsonValue(f189O, 2);
        tEnumJsonAdapter.addExtJsonValue(f187AB, 3);
        tEnumJsonAdapter.addExtJsonValue("UNKNOWN", 4);
        supportEnum.add(f186A);
        supportEnum.add(f188B);
        supportEnum.add(f189O);
        supportEnum.add(f187AB);
