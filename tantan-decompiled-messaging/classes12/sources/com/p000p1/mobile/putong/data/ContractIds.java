...
import com.p000p1.mobile.putong.data.ContractIds;
...
public class ContractIds extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ContractIds> PROTOBUF_ADAPTER = new MessageNanoAdapter<ContractIds>() { // from class: com.p1.mobile.putong.data.ContractIds.1
        ...
        public int computeAndCacheSize(ContractIds contractIds) {
            ...
            ((MessageNano) contractIds).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public ContractIds m17863parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                contractIds.ids = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            return contractIds;
        }
    ...
    public static JsonAdapter<ContractIds> JSON_ADAPTER = new ObjectJsonAdapter<ContractIds>() { // from class: com.p1.mobile.putong.data.ContractIds.2
        ...
        public ContractIds mo17830newInstance() {
    ...
    public static /* synthetic */ String m625a(String str) {
        return str;
    }
    ...
    public ContractIds m17862clone() {
        ContractIds contractIds = new ContractIds();
        List<String> list = this.ids;
        if (list != null) {
            contractIds.ids = ValueObject.util_map(list, new w9j() { // from class: l.t16
                public final Object call(Object obj) {
                    return ContractIds.m625a((String) obj);
                }
            });
        }
        return contractIds;
