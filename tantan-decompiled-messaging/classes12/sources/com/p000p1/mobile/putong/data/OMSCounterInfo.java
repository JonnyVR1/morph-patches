...
public class OMSCounterInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSCounterInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSCounterInfo>() { // from class: com.p1.mobile.putong.data.OMSCounterInfo.1
        ...
        public int computeAndCacheSize(OMSCounterInfo oMSCounterInfo) {
            String str = oMSCounterInfo.f245id;
            ...
            if (oMSConstraint != null) {
                iO += CodedOutputByteBufferNano.l(3, oMSConstraint, OMSConstraint.PROTOBUF_ADAPTER);
            }
            ((MessageNano) oMSCounterInfo).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public OMSCounterInfo m18588parse(nb5 nb5Var) throws IOException {
            OMSCounterInfo oMSCounterInfo = new OMSCounterInfo();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 0) {
                    if (oMSCounterInfo.f245id == null) {
                        oMSCounterInfo.f245id = "";
                    }
                ...
                if (iU == 10) {
                    oMSCounterInfo.f245id = nb5Var.s();
                } else if (iU == 18) {
                    oMSCounterInfo.version = nb5Var.s();
                } else {
                    if (iU != 26) {
                        if (oMSCounterInfo.f245id == null) {
                            oMSCounterInfo.f245id = "";
                    ...
                    oMSCounterInfo.constraint = (OMSConstraint) nb5Var.l(OMSConstraint.PROTOBUF_ADAPTER);
                }
            }
            return oMSCounterInfo;
        }
        ...
        public void serialize(OMSCounterInfo oMSCounterInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            OMSConstraint oMSConstraint = oMSCounterInfo.constraint;
            if (oMSConstraint != null) {
                codedOutputByteBufferNano.K(3, oMSConstraint, OMSConstraint.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<OMSCounterInfo> JSON_ADAPTER = new ObjectJsonAdapter<OMSCounterInfo>() { // from class: com.p1.mobile.putong.data.OMSCounterInfo.2
        ...
        public OMSCounterInfo mo17830newInstance() {
        ...
        public boolean parseField(OMSCounterInfo oMSCounterInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "constraint":
                    oMSCounterInfo.constraint = (OMSConstraint) OMSConstraint.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "id":
                    oMSCounterInfo.f245id = jsonParser.getValueAsString();
                    return false;
                case "version":
    ...
    public OMSCounterInfo m18587clone() {
        OMSCounterInfo oMSCounterInfo = new OMSCounterInfo();
        oMSCounterInfo.f245id = this.f245id;
        oMSCounterInfo.version = this.version;
        OMSConstraint oMSConstraint = this.constraint;
        if (oMSConstraint != null) {
            oMSCounterInfo.constraint = oMSConstraint.m18584clone();
        }
        return oMSCounterInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f245id, oMSCounterInfo.f245id) && ValueObject.util_equals(this.version, oMSCounterInfo.version) && ValueObject.util_equals(this.constraint, oMSCounterInfo.constraint);
    }
