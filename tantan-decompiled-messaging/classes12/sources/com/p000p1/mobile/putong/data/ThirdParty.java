...
public class ThirdParty extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ThirdParty> PROTOBUF_ADAPTER = new MessageNanoAdapter<ThirdParty>() { // from class: com.p1.mobile.putong.data.ThirdParty.1
        ...
        public int computeAndCacheSize(ThirdParty thirdParty) {
            int iB = CodedOutputByteBufferNano.b(1, thirdParty.facebook) + CodedOutputByteBufferNano.b(2, thirdParty.wechat) + CodedOutputByteBufferNano.b(3, thirdParty.google) + CodedOutputByteBufferNano.b(4, thirdParty.apple);
            ((MessageNano) thirdParty).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public ThirdParty m19097parse(nb5 nb5Var) throws IOException {
            ThirdParty thirdParty = new ThirdParty();
            while (true) {
                int iU = nb5Var.u();
                if (iU == 8) {
                    thirdParty.facebook = nb5Var.g();
                } else if (iU == 16) {
                    thirdParty.wechat = nb5Var.g();
                } else if (iU == 24) {
                    thirdParty.google = nb5Var.g();
                } else {
                    if (iU != 32) {
                        return thirdParty;
                    }
                    thirdParty.apple = nb5Var.g();
                }
            }
        }

        public void serialize(ThirdParty thirdParty, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.A(1, thirdParty.facebook);
            codedOutputByteBufferNano.A(2, thirdParty.wechat);
            codedOutputByteBufferNano.A(3, thirdParty.google);
            codedOutputByteBufferNano.A(4, thirdParty.apple);
        }
    };
    public static JsonAdapter<ThirdParty> JSON_ADAPTER = new ObjectJsonAdapter<ThirdParty>() { // from class: com.p1.mobile.putong.data.ThirdParty.2
        ...
        public ThirdParty mo17830newInstance() {
