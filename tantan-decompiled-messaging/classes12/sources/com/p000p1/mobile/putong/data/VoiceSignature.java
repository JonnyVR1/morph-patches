...
import com.p000p1.mobile.putong.data.VoiceSignature;
...
public class VoiceSignature extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VoiceSignature> PROTOBUF_ADAPTER = new MessageNanoAdapter<VoiceSignature>() { // from class: com.p1.mobile.putong.data.VoiceSignature.1
        ...
        public int computeAndCacheSize(VoiceSignature voiceSignature) {
            ...
            ((MessageNano) voiceSignature).cachedSize = iL;
            return iL;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public VoiceSignature m19365parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    voiceSignature.url = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iU == 18) {
                    voiceSignature.duration = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iU != 26) {
                        if (voiceSignature.url == null) {
                            voiceSignature.url = new ArrayList();
                    ...
                    voiceSignature.mediaType = (List) nb5Var.l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return voiceSignature;
        }
    ...
    public static JsonAdapter<VoiceSignature> JSON_ADAPTER = new ObjectJsonAdapter<VoiceSignature>() { // from class: com.p1.mobile.putong.data.VoiceSignature.2
        ...
        public VoiceSignature mo17830newInstance() {
    ...
    public static /* synthetic */ String m1087a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m1088b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m1089c(String str) {
        return str;
    }
    ...
    public VoiceSignature m19364clone() {
        ...
        if (list2 != null) {
            voiceSignature.duration = ValueObject.util_map(list2, new w9j() { // from class: l.gko0
                public final Object call(Object obj) {
                    return VoiceSignature.m1088b((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            voiceSignature.mediaType = ValueObject.util_map(list3, new w9j() { // from class: l.hko0
                public final Object call(Object obj) {
                    return VoiceSignature.m1087a((String) obj);
                }
            });
        }
        return voiceSignature;
