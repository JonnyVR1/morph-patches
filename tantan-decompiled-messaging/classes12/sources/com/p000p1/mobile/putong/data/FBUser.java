...
public class FBUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FBUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<FBUser>() { // from class: com.p1.mobile.putong.data.FBUser.1
        ...
        public int computeAndCacheSize(FBUser fBUser) {
            ...
            if (fBProfile != null) {
                iO += CodedOutputByteBufferNano.l(4, fBProfile, FBProfile.PROTOBUF_ADAPTER);
            }
            ...
            if (fBPage != null) {
                iO += CodedOutputByteBufferNano.l(6, fBPage, FBPage.PROTOBUF_ADAPTER);
            }
            FBPage fBPage2 = fBUser.location;
            if (fBPage2 != null) {
                iO += CodedOutputByteBufferNano.l(7, fBPage2, FBPage.PROTOBUF_ADAPTER);
            }
            List<FBWork> list = fBUser.work;
            if (list != null) {
                iO += CodedOutputByteBufferNano.l(8, list, FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FBEducation> list2 = fBUser.education;
            if (list2 != null) {
                iO += CodedOutputByteBufferNano.l(9, list2, FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            FBLikes fBLikes = fBUser.music;
            if (fBLikes != null) {
                iO += CodedOutputByteBufferNano.l(10, fBLikes, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes2 = fBUser.movies;
            if (fBLikes2 != null) {
                iO += CodedOutputByteBufferNano.l(11, fBLikes2, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes3 = fBUser.books;
            if (fBLikes3 != null) {
                iO += CodedOutputByteBufferNano.l(12, fBLikes3, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes4 = fBUser.television;
            if (fBLikes4 != null) {
                iO += CodedOutputByteBufferNano.l(13, fBLikes4, FBLikes.PROTOBUF_ADAPTER);
            }
            ((MessageNano) fBUser).cachedSize = iO;
            return iO;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public FBUser m18061parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                switch (nb5Var.u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        fBUser.name = nb5Var.s();
                        continue;
                    case 18:
                        fBUser.gender = nb5Var.s();
                        continue;
                    case 26:
                        fBUser.birthday = nb5Var.s();
                        continue;
                    case 34:
                        fBUser.fbPicture = (FBProfile) nb5Var.l(FBProfile.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        fBUser.about = nb5Var.s();
                        continue;
                    case 50:
                        fBUser.hometown = (FBPage) nb5Var.l(FBPage.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        fBUser.location = (FBPage) nb5Var.l(FBPage.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        fBUser.work = (List) nb5Var.l(FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        fBUser.education = (List) nb5Var.l(FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 82:
                        fBUser.music = (FBLikes) nb5Var.l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        fBUser.movies = (FBLikes) nb5Var.l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    case 98:
                        fBUser.books = (FBLikes) nb5Var.l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        fBUser.television = (FBLikes) nb5Var.l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (fBUser.name == null) {
                            fBUser.name = "";
        ...
        public void serialize(FBUser fBUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            FBProfile fBProfile = fBUser.fbPicture;
            if (fBProfile != null) {
                codedOutputByteBufferNano.K(4, fBProfile, FBProfile.PROTOBUF_ADAPTER);
            }
            String str4 = fBUser.about;
            if (str4 != null) {
            ...
            FBPage fBPage = fBUser.hometown;
            if (fBPage != null) {
                codedOutputByteBufferNano.K(6, fBPage, FBPage.PROTOBUF_ADAPTER);
            }
            FBPage fBPage2 = fBUser.location;
            if (fBPage2 != null) {
                codedOutputByteBufferNano.K(7, fBPage2, FBPage.PROTOBUF_ADAPTER);
            }
            List<FBWork> list = fBUser.work;
            if (list != null) {
                codedOutputByteBufferNano.K(8, list, FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FBEducation> list2 = fBUser.education;
            if (list2 != null) {
                codedOutputByteBufferNano.K(9, list2, FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            FBLikes fBLikes = fBUser.music;
            if (fBLikes != null) {
                codedOutputByteBufferNano.K(10, fBLikes, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes2 = fBUser.movies;
            if (fBLikes2 != null) {
                codedOutputByteBufferNano.K(11, fBLikes2, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes3 = fBUser.books;
            if (fBLikes3 != null) {
                codedOutputByteBufferNano.K(12, fBLikes3, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes4 = fBUser.television;
            if (fBLikes4 != null) {
                codedOutputByteBufferNano.K(13, fBLikes4, FBLikes.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<FBUser> JSON_ADAPTER = new ObjectJsonAdapter<FBUser>() { // from class: com.p1.mobile.putong.data.FBUser.2
        ...
        public FBUser mo17830newInstance() {
            return new FBUser();
        }
        ...
        public boolean parseField(FBUser fBUser, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "television":
                    fBUser.television = (FBLikes) FBLikes.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "gender":
                    fBUser.gender = jsonParser.getValueAsString();
                    return true;
                case "movies":
                    fBUser.movies = (FBLikes) FBLikes.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "picture":
                    fBUser.fbPicture = (FBProfile) FBProfile.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "hometown":
                    fBUser.hometown = (FBPage) FBPage.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "education":
                ...
                case "about":
                    ...
                    return true;
                case "books":
                    fBUser.books = (FBLikes) FBLikes.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "music":
                    fBUser.music = (FBLikes) FBLikes.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "birthday":
                    fBUser.birthday = jsonParser.getValueAsString();
                    return true;
                case "location":
                    fBUser.location = (FBPage) FBPage.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
        ...
        public void serializeFields(FBUser fBUser, JsonGenerator jsonGenerator) throws IOException {
            ...
            String str3 = fBUser.birthday;
            if (str3 != null) {
                jsonGenerator.writeStringField(SchemeKey.birthday, str3);
            }
            if (fBUser.fbPicture != null) {
            ...
            if (fBUser.movies != null) {
                jsonGenerator.writeFieldName(Profile.MOVIES);
    ...
    public FBUser m18060clone() {
        ...
        if (fBProfile != null) {
            fBUser.fbPicture = fBProfile.m18054clone();
        }
        fBUser.about = this.about;
        FBPage fBPage = this.hometown;
        if (fBPage != null) {
            fBUser.hometown = fBPage.m18045clone();
        }
        FBPage fBPage2 = this.location;
        if (fBPage2 != null) {
            fBUser.location = fBPage2.m18045clone();
        }
        ...
        if (fBLikes != null) {
            fBUser.music = fBLikes.m18042clone();
        }
        FBLikes fBLikes2 = this.movies;
        if (fBLikes2 != null) {
            fBUser.movies = fBLikes2.m18042clone();
        }
        FBLikes fBLikes3 = this.books;
        if (fBLikes3 != null) {
            fBUser.books = fBLikes3.m18042clone();
        }
        FBLikes fBLikes4 = this.television;
        if (fBLikes4 != null) {
            fBUser.television = fBLikes4.m18042clone();
        }
        return fBUser;
    }
