...
public class VerificationTokenRequestParam extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerificationTokenRequestParam> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerificationTokenRequestParam>() { // from class: com.p1.mobile.putong.data.VerificationTokenRequestParam.1
        ...
        public int computeAndCacheSize(VerificationTokenRequestParam verificationTokenRequestParam) {
            ...
            if (verificationTokenIdentity != null) {
                iO += CodedOutputByteBufferNano.l(4, verificationTokenIdentity, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            ...
            if (verificationTokenIdentity2 != null) {
                iO += CodedOutputByteBufferNano.l(5, verificationTokenIdentity2, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            ...
            int iB = iO + CodedOutputByteBufferNano.b(8, verificationTokenRequestParam.enableVolcEnginePro) + CodedOutputByteBufferNano.b(9, verificationTokenRequestParam.newProcess);
            ((MessageNano) verificationTokenRequestParam).cachedSize = iB;
            return iB;
        }

        /* JADX INFO: renamed from: parse, reason: merged with bridge method [inline-methods] */
        public VerificationTokenRequestParam m19289parse(nb5 nb5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iU == 10) {
                    verificationTokenRequestParam.appId = nb5Var.s();
                } else if (iU == 18) {
                    verificationTokenRequestParam.productId = nb5Var.s();
                } else if (iU == 26) {
                    verificationTokenRequestParam.verifyType = nb5Var.s();
                } else if (iU == 34) {
                    verificationTokenRequestParam.identity = (VerificationTokenIdentity) nb5Var.l(VerificationTokenIdentity.PROTOBUF_ADAPTER);
                } else if (iU == 42) {
                    verificationTokenRequestParam.picture = (VerificationTokenIdentity) nb5Var.l(VerificationTokenIdentity.PROTOBUF_ADAPTER);
                } else if (iU == 50) {
                    verificationTokenRequestParam.region = nb5Var.s();
                } else if (iU == 58) {
                    verificationTokenRequestParam.retrieveId = nb5Var.s();
                } else if (iU == 64) {
                    verificationTokenRequestParam.enableVolcEnginePro = nb5Var.g();
                } else {
                    if (iU != 72) {
                        if (verificationTokenRequestParam.appId == null) {
                            verificationTokenRequestParam.appId = "";
                    ...
                    verificationTokenRequestParam.newProcess = nb5Var.g();
                }
            }
            return verificationTokenRequestParam;
        }
        ...
        public void serialize(VerificationTokenRequestParam verificationTokenRequestParam, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            VerificationTokenIdentity verificationTokenIdentity = verificationTokenRequestParam.identity;
            if (verificationTokenIdentity != null) {
                codedOutputByteBufferNano.K(4, verificationTokenIdentity, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            VerificationTokenIdentity verificationTokenIdentity2 = verificationTokenRequestParam.picture;
            if (verificationTokenIdentity2 != null) {
                codedOutputByteBufferNano.K(5, verificationTokenIdentity2, VerificationTokenIdentity.PROTOBUF_ADAPTER);
            }
            String str4 = verificationTokenRequestParam.region;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.A(8, verificationTokenRequestParam.enableVolcEnginePro);
            codedOutputByteBufferNano.A(9, verificationTokenRequestParam.newProcess);
        }
    };
    public static JsonAdapter<VerificationTokenRequestParam> JSON_ADAPTER = new ObjectJsonAdapter<VerificationTokenRequestParam>() { // from class: com.p1.mobile.putong.data.VerificationTokenRequestParam.2
        ...
        public VerificationTokenRequestParam mo17830newInstance() {
        ...
        public boolean parseField(VerificationTokenRequestParam verificationTokenRequestParam, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "region":
                    ...
                    return true;
                case "picture":
                    verificationTokenRequestParam.picture = (VerificationTokenIdentity) VerificationTokenIdentity.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "enableVolcEnginePro":
                    verificationTokenRequestParam.enableVolcEnginePro = jsonParser.getValueAsBoolean();
                    return true;
                case "identity":
                    verificationTokenRequestParam.identity = (VerificationTokenIdentity) VerificationTokenIdentity.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "appId":
    ...
    public static final class VerificationTokenRequestParamBuilder {
        ...
        public VerificationTokenRequestParamBuilder useAccountBackTemplate(String str, boolean z, String str2, String str3, String str4) {
            ...
            verificationTokenIdentityNew_.providerAppId = TTFacertificationClient.m1120q();
    ...
    public VerificationTokenRequestParam m19288clone() {
        VerificationTokenRequestParam verificationTokenRequestParam = new VerificationTokenRequestParam();
        verificationTokenRequestParam.appId = this.appId;
        verificationTokenRequestParam.productId = this.productId;
        ...
        VerificationTokenIdentity verificationTokenIdentity = this.identity;
        if (verificationTokenIdentity != null) {
            verificationTokenRequestParam.identity = verificationTokenIdentity.m19285clone();
        }
        VerificationTokenIdentity verificationTokenIdentity2 = this.picture;
        if (verificationTokenIdentity2 != null) {
            verificationTokenRequestParam.picture = verificationTokenIdentity2.m19285clone();
        }
