...
public final class wp60 extends AbstractC19757r4 {
    ...
    public wp60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        ...
        response.m131356o(response.getSticker());
        response.m131355n((aVarM179724g.m54784s().quarterly() || aVarM179724g.m54784s().semiAnnual()) ? pta.m173721n(aVarM179724g) : tab0.m189811h().m189820k(aVarM179724g.m54784s()));
        if (TextUtils.equals(getFrom(), cok0.f82895a)) {
            response.m131356o(null);
        }
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        request.getClass();
        if (wib0.m206573q(this.purchaseType) && request.getPurchaseSection().m54714m() && !joa.m146361M3()) {
            return v5b0.m199797w(request.getPurchaseSection().m54703b().m54784s()) || v5b0.m199793s(request.getPurchaseSection().m54703b().m54784s());
        }
        return false;
    }
}
