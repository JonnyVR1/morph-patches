...
public class lf20 {
    ...
    public static void m153963a(CardGuideActivity cardGuideActivity, String str) {
    ...
    public static boolean m153964b(Context context, boolean z) {
    ...
    public static boolean m153965c(Context context) {
    ...
    public static boolean m153966d(Context context, String str, String str2, String str3) {
    ...
    public static boolean m153967e(boolean z, Context context) {
        ...
        try {
            ...
            return z ? m153968f(context) : ((Boolean) clsLoadClass.getDeclaredMethod("startScan", Context.class).invoke(clsLoadClass.getDeclaredMethod("getInstance", null).invoke(null, null), context)).booleanValue();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static boolean m153968f(Context context) {
