...
public final class ixp extends d3q<IntlVoiceLiveManagerInviteItemView> {
    ...
    public ixp(@NotNull BLiveVoiceManagerInvite bLiveVoiceManagerInvite, @NotNull y20<BLiveVoiceManagerInvite> y20Var) {
    ...
    public void mo71749u(@Nullable IntlVoiceLiveManagerInviteItemView itemView) {
        super.mo71749u(itemView);
        if (itemView != null) {
            itemView.m79448k0(this.itemInfo, this.action);
        }
    }
