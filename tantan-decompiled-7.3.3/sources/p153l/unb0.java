...
@Metadata(m88120d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\r\b\u0000\u0018\u00002\u00020\u0001B!\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\f\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\f\u0010\rJ\u0017\u0010\u0010\u001a\u00020\n2\u0006\u0010\u000f\u001a\u00020\u000eH\u0002¢\u0006\u0004\b\u0010\u0010\u0011J\u001f\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\u0012H\u0017¢\u0006\u0004\b\u0015\u0010\u0016J\u0015\u0010\u0018\u001a\b\u0012\u0004\u0012\u00020\n0\u0017H\u0017¢\u0006\u0004\b\u0018\u0010\u0019J\u0017\u0010\u001b\u001a\u00020\u001a2\u0006\u0010\u000b\u001a\u00020\nH\u0017¢\u0006\u0004\b\u001b\u0010\u001cJ\u001d\u0010\u001e\u001a\u00020\u00142\f\u0010\u001d\u001a\b\u0012\u0004\u0012\u00020\n0\u0017H\u0017¢\u0006\u0004\b\u001e\u0010\u001fJ\u000f\u0010 \u001a\u00020\u0014H\u0017¢\u0006\u0004\b \u0010!R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\"R\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b \u0010#R\u0014\u0010\u0007\u001a\u00020\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001e\u0010$R\u0016\u0010&\u001a\u00020\u001a8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0018\u0010%¨\u0006'"}, m88121d2 = {"Ll/unb0;", "Ll/tnb0;", "Ll/z6c;", "dbHelper", "Ll/axl;", "logger", "Ll/oa5;", "clock", "<init>", "(Ll/z6c;Ll/axl;Ll/oa5;)V", "", "id", "f", "(Ljava/lang/String;)Ljava/lang/String;", "", "count", "g", "(I)Ljava/lang/String;", "", "ttlInSeconds", "", "a", "(Ljava/lang/String;J)V", "", Constants.INAPP_DATA_TAG, "()[Ljava/lang/String;", "", "e", "(Ljava/lang/String;)Z", "ids", "c", "([Ljava/lang/String;)V", "b", "()V", "Ll/z6c;", "Ll/axl;", "Ll/oa5;", "Z", "rtlDirtyFlag", "clevertap-core_release"}, m88122k = 1, m88123mv = {2, 0, 0}, m88125xi = 48)
...
public final class unb0 implements tnb0 {
    ...
    public unb0(@NotNull z6c z6cVar, @NotNull axl axlVar, @NotNull oa5 oa5Var) {
        z6cVar.getClass();
        axlVar.getClass();
        oa5Var.getClass();
    ...
    private final String m196831f(String id) {
        Exception exc;
    ...
    private final String m196832g(int count) {
    ...
    public void mo191878a(@NotNull String id, long ttlInSeconds) {
        id.getClass();
        ...
        String tableName = Table.PUSH_NOTIFICATIONS.getTableName();
        if (ttlInSeconds <= 0) {
            ttlInSeconds = this.clock.mo166827c() + Constants.DEFAULT_PUSH_TTL_SECONDS;
        }
    ...
    public void mo191879b() {
        long jMo166827c = this.clock.mo166827c();
        String tableName = Table.PUSH_NOTIFICATIONS.getTableName();
        try {
            this.dbHelper.getWritableDatabase().delete(tableName, "created_at <= " + jMo166827c, null);
        } catch (SQLiteException e) {
    ...
    public void mo191880c(@NotNull String[] ids) {
        ids.getClass();
        if (ids.length == 0) {
            return;
        }
        ...
        String strM196832g = m196832g(ids.length);
        try {
            this.dbHelper.getWritableDatabase().update(tableName, contentValues, "data IN (" + strM196832g + ')', ids);
    ...
    public boolean mo191882e(@NotNull String id) {
        id.getClass();
        return Intrinsics.m88377d(id, m196831f(id));
    }
}
