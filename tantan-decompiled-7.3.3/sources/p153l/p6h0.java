...
public final class p6h0 {
    ...
    public p6h0(@NotNull Act act) {
        act.getClass();
        this.act = act;
    }

    /* JADX INFO: renamed from: a */
    public static void m170887a(y20 y20Var, View view) {
        y20Var.call(0);
    }

    @Nullable
    /* JADX INFO: renamed from: b */
    public final View m170888b(@NotNull Act act, @NotNull ViewGroup root) {
        act.getClass();
        root.getClass();
        View viewInflate = LayoutInflater.from(act).inflate(rec0.f162527b0, root, false);
    ...
    public final void m170889c(@NotNull Act act) {
        act.getClass();
        m170890d();
    }

    /* JADX INFO: renamed from: d */
    public final void m170890d() {
        VText vText = this._feature_name_text;
        if (vText != null) {
            vText.setText(this.act.getString(IntlCountryCodeController.m29125v() ? R$string.f28524z8 : R$string.f28069L9));
        }
        VText vText2 = this._promotional_text;
        if (vText2 != null) {
            vText2.setText(this.act.getString(R$string.f28034I7));
        }
    ...
    public final void m170891e(@NotNull final y20<Integer> dismiss) {
        dismiss.getClass();
        bnl0.m105509E0(this._image_close, new View.OnClickListener() { // from class: l.o6h0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                p6h0.m170887a(dismiss, view);
            }
        });
    }
}
