...
@Metadata(m88120d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J'\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u000b\u0010\f¨\u0006\r"}, m88121d2 = {"Ll/hry;", "Ll/hzl;", "Lcom/p1/mobile/putong/core/ui/purchase/d$a;", "<init>", "()V", "Landroid/content/Context;", "context", "Lcom/p1/mobile/putong/core/data/PurchaseType;", "type", "detail", "", "b", "(Landroid/content/Context;Lcom/p1/mobile/putong/core/data/PurchaseType;Lcom/p1/mobile/putong/core/ui/purchase/d$a;)V", "pay_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
public final class hry implements hzl<C8928d.a> {
    ...
    public void mo106190a(@NotNull Context context, @NotNull PurchaseType type, @NotNull C8928d.a detail) {
        ...
        switch (string2.hashCode()) {
            case -2067215576:
                if (!string2.equals("superLikeMembership")) {
                    string = "";
                } else if ((!TEnum.equals(productCategory, ProductCategory.tttVip) || TEnum.equals(productCategory, "svip") || TEnum.equals(productCategory, "femaleVip") || TEnum.equals(productCategory, "youthVip")) && merchandiseM54784s.weekly()) {
                    string = "周";
                } else {
                    string = resources.getString(i == 1 ? R$string.f28459t9 : R$string.f28470u9);
                    string.getClass();
                }
                break;
            case -1403004683:
                if (!string2.equals(ProductCategory.noneLiveCoin)) {
                    ...
                    string = resources.getString(R$string.f28155T7);
                    string.getClass();
                }
                break;
            case -1338150991:
        ...
        detail.m54769i0(i);
        detail.m54771j0(string);
        detail.m54741N(productCategory);
    }
}
