...
public final class yp60 extends AbstractC19757r4 {
    ...
    public yp60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        ...
        String str = getNumberFormat().format(aVarM179724g.m54736I() ? aVarM179724g.m54784s().getFirstCouponPrice() : aVarM179724g.m54784s().defaultStockKeepUnit.prices.price);
        str.getClass();
        response.m131357p("免密支付" + str + "元");
    }
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        request.getClass();
        return TEnum.equals(request.getPayMethod(), "alipay") && m179723f();
    }
}
