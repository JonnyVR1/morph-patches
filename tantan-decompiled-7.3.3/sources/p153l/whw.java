...
public final class whw {
    ...
    @NotNull
    public static final whw INSTANCE = new whw();
    ...
    public static final void m206510a() {
        if (ztb.m221490d(whw.class)) {
            return;
        }
        try {
            INSTANCE.m206519g();
            ...
            ztb.m221488b(th, whw.class);
        }
    }

    @JvmStatic
    /* JADX INFO: renamed from: b */
    public static final void m206511b(@NotNull Bundle params, @NotNull String event) {
        if (ztb.m221490d(whw.class)) {
            return;
        }
        try {
            ...
            Locale localeM8924I = c1680e.m8924I();
            String language = localeM8924I != null ? localeM8924I.getLanguage() : null;
            String str = "";
            if (language == null) {
                language = "";
            }
            sb.append(language);
            sb.append('_');
            Locale localeM8924I2 = c1680e.m8924I();
            String country = localeM8924I2 != null ? localeM8924I2.getCountry() : null;
            if (country == null) {
                country = "";
            }
            sb.append(country);
            params.putString("_locale", sb.toString());
            String strM8926P = c1680e.m8926P();
            if (strM8926P == null) {
                strM8926P = "";
            }
            params.putString("_appVersion", strM8926P);
            ...
            params.putString("_nativeAppID", C1600c.m8102m());
            String strM8926P2 = c1680e.m8926P();
            if (strM8926P2 != null) {
                str = strM8926P2;
            }
            params.putString("_nativeAppShortVersion", str);
            params.putString("_timezone", c1680e.m8922E());
            params.putString("_carrier", c1680e.m8942z());
            params.putString("_deviceOSTypeName", "ANDROID");
            params.putString("_deviceOSVersion", Build.VERSION.RELEASE);
            params.putLong("_remainingDiskGB", c1680e.m8939x());
        } catch (Throwable th) {
            ztb.m221488b(th, whw.class);
        }
    }
    ...
    public static final String m206512c(@NotNull JSONObject logic) {
        if (ztb.m221490d(whw.class)) {
            return null;
        }
        try {
    ...
    public static final String m206513d(@Nullable Bundle params) {
        String strOptString;
        if (ztb.m221490d(whw.class)) {
            return null;
        }
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (strOptString2 != null) {
                    ...
                    if (jOptLong != 0 && (strOptString = jSONObject.optString(Message.RULE)) != null && m206515f(strOptString, params)) {
    ...
    public static final ArrayList<String> m206514e(@Nullable JSONArray jsonArray) {
        if (ztb.m221490d(whw.class) || jsonArray == null) {
            return null;
        }
        try {
    ...
    public static final boolean m206515f(@Nullable String ruleString, @Nullable Bundle data) {
        if (!ztb.m221490d(whw.class) && ruleString != null && data != null) {
            try {
                JSONObject jSONObject = new JSONObject(ruleString);
                String strM206512c = m206512c(jSONObject);
                if (strM206512c == null) {
                    return false;
                }
                Object obj = jSONObject.get(strM206512c);
                int iHashCode = strM206512c.hashCode();
                if (iHashCode != 3555) {
                    if (iHashCode != 96727) {
                        if (iHashCode == 109267 && strM206512c.equals("not")) {
                            return !m206515f(obj.toString(), data);
                        }
                    } else if (strM206512c.equals("and")) {
                        ...
                        int length = jSONArray.length();
                        for (int i = 0; i < length; i++) {
                            if (!m206515f(jSONArray.get(i).toString(), data)) {
                                return false;
                            }
                        }
                        return true;
                    }
                } else if (strM206512c.equals("or")) {
                    ...
                    for (int i2 = 0; i2 < length2; i2++) {
                        if (m206515f(jSONArray2.get(i2).toString(), data)) {
                            return true;
                        }
                    }
                    return false;
                ...
                return m206518j(strM206512c, jSONObject2, data);
            } catch (Throwable th) {
                ztb.m221488b(th, whw.class);
            }
        }
    ...
    public static final void m206516h(@Nullable Bundle params, @NotNull String event) {
        if (ztb.m221490d(whw.class)) {
            return;
        }
        try {
            ...
            try {
                m206511b(params, event);
                params.putString("_audiencePropertyIds", m206513d(params));
    ...
    public static final void m206517i(@NotNull Bundle params) {
        if (ztb.m221490d(whw.class)) {
            return;
        }
        try {
    ...
    public static final boolean m206518j(@NotNull String variable, @NotNull JSONObject values, @Nullable Bundle data) {
        Object obj;
        String lowerCase;
        String lowerCase2;
        String lowerCase3;
        ...
        try {
            variable.getClass();
            values.getClass();
            String strM206512c = m206512c(values);
            if (strM206512c == null) {
                return false;
            }
            String string = values.get(strM206512c).toString();
            ArrayList<String> arrayListM206514e = m206514e(values.optJSONArray(strM206512c));
            if (Intrinsics.m88377d(strM206512c, "exists")) {
            ...
            switch (strM206512c.hashCode()) {
                case -1729128927:
                    if (strM206512c.equals("i_not_contains")) {
                        ...
                        lowerCase7.getClass();
                        return !StringsKt.m94303P(lowerCase6, lowerCase7, false, 2, null);
                    }
                    return false;
                case -1179774633:
                    if (!strM206512c.equals("is_any")) {
                        return false;
                    }
                    if (arrayListM206514e == null) {
                        return false;
                    }
                    return arrayListM206514e.contains(obj.toString());
                case -1039699439:
                    if (!strM206512c.equals("not_in")) {
                        return false;
                    }
                    if (arrayListM206514e == null) {
                        return false;
                    ...
                    return arrayListM206514e.contains(obj.toString());
                case -969266188:
                    if (strM206512c.equals("starts_with")) {
                        return C15493d.m94374J(obj.toString(), string, false, 2, null);
                    }
                    return false;
                case -966353971:
                    if (strM206512c.equals("regex_match")) {
                        return new Regex(string).matches(obj.toString());
                    }
                    return false;
                case -665609109:
                    if (!strM206512c.equals("is_not_any")) {
                        return false;
                    }
                    if (arrayListM206514e == null) {
                        return false;
                    ...
                    return arrayListM206514e.contains(obj.toString());
                case -567445985:
                    if (strM206512c.equals("contains")) {
                        return StringsKt.m94303P(obj.toString(), string, false, 2, null);
                    }
                    return false;
                case -327990090:
                    if (!strM206512c.equals("i_str_neq")) {
                        return false;
                    }
                    ...
                    lowerCase9.getClass();
                    return !Intrinsics.m88377d(lowerCase8, lowerCase9);
                case -159812115:
                    if (!strM206512c.equals("i_is_any")) {
                        return false;
                    }
                    if (arrayListM206514e != null || arrayListM206514e.isEmpty()) {
                        return false;
                    }
                    for (String str : arrayListM206514e) {
                    ...
                    return false;
                case -92753547:
                    if (!strM206512c.equals("i_str_not_in")) {
                        return false;
                    }
                    if (arrayListM206514e == null) {
                        return false;
                    }
                    if (arrayListM206514e.isEmpty()) {
                        return true;
                    }
                    for (String str2 : arrayListM206514e) {
                        Locale locale4 = Locale.ROOT;
                        lowerCase3 = str2.toLowerCase(locale4);
                        lowerCase3.getClass();
                        lowerCase4 = obj.toString().toLowerCase(locale4);
                        lowerCase4.getClass();
                        if (Intrinsics.m88377d(lowerCase3, lowerCase4)) {
                            return false;
                        }
                    }
                    return true;
                case 60:
                    if (!strM206512c.equals("<")) {
                        return false;
                    }
                ...
                case 61:
                    ...
                    return Intrinsics.m88377d(obj.toString(), string);
                case 62:
                    if (!strM206512c.equals(">")) {
                        return false;
                    }
                ...
                case 1084:
                    ...
                    if (Intrinsics.m88377d(obj.toString(), string)) {
                        return false;
                    }
                    return true;
                case 1921:
                ...
                case 1983:
                    ...
                    return false;
                case 3244:
                    if (!strM206512c.equals("eq")) {
                        return false;
                    }
                    return Intrinsics.m88377d(obj.toString(), string);
                case 3294:
                    if (!strM206512c.equals("ge")) {
                        return false;
                    }
                    if (Double.parseDouble(obj.toString()) >= Double.parseDouble(string)) {
                        return true;
                ...
                case 108954:
                    ...
                    return false;
                case 127966736:
                    if (!strM206512c.equals("i_str_eq")) {
                        return false;
                    }
                    ...
                    return Intrinsics.m88377d(lowerCase10, lowerCase11);
                case 127966857:
                    if (!strM206512c.equals("i_str_in")) {
                        return false;
                    }
                    if (arrayListM206514e != null) {
                        return false;
                    ...
                    return false;
                case 363990325:
                    if (!strM206512c.equals("i_contains")) {
                        return false;
                    }
                    ...
                    return StringsKt.m94303P(lowerCase12, lowerCase13, false, 2, null);
                case 1091487233:
                    if (!strM206512c.equals("i_is_not_any")) {
                        return false;
                    }
                    if (arrayListM206514e == null) {
                        return false;
                    ...
                    return true;
                case 1918401035:
                    return strM206512c.equals("not_contains") && !StringsKt.m94303P(obj.toString(), string, false, 2, null);
                case 1961112862:
                    if (!strM206512c.equals("i_starts_with")) {
                        return false;
                    }
                    ...
                    return C15493d.m94374J(lowerCase14, lowerCase15, false, 2, null);
                default:
                    return false;
            }
        } catch (Throwable th) {
    ...
    public final void m206519g() {
        ...
        try {
            ...
            MACARules = c1679dM8747r.getMACARuleMatchingSetting();
        } catch (Throwable th) {
