...
public final class ai40 extends Act.AbstractC4455w<Act, w2c0> {
    ...
    /* JADX INFO: renamed from: l.ai40$a */
    @Metadata(m88120d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m88121d2 = {"l/ai40$a", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "onAnimationEnd", "(Landroid/animation/Animator;)V", "b_core_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C15712a extends AnimatorListenerAdapter {

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ w2c0 f71453b;

        public C15712a(w2c0 w2c0Var) {
            this.f71453b = w2c0Var;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) {
            animation.getClass();
            ai40.this.getQuickChatAudioHeaderView().mo43000h();
            ai40.this.getConversationsList().setTranslationY(0.0f);
            ai40.this.getConversationsList().setAlpha(1.0f);
            this.f71453b.mo42796E().setClipBounds(null);
        }
    }

    public ai40(@NotNull ConversationsList conversationsList, @NotNull QuickChatHeaderBaseView quickChatHeaderBaseView) {
    ...
    public static void m97952i(ai40 ai40Var, ValueAnimator valueAnimator) {
        valueAnimator.getClass();
        Object animatedValue = valueAnimator.getAnimatedValue();
        animatedValue.getClass();
        ai40Var.conversationsList.setTranslationY(((Rect) animatedValue).bottom - ai40Var.startY);
    }

    /* JADX INFO: renamed from: j */
    public static void m97953j(ai40 ai40Var, ValueAnimator valueAnimator) {
        valueAnimator.getClass();
        Object animatedValue = valueAnimator.getAnimatedValue();
        animatedValue.getClass();
        ai40Var.conversationsList.setTranslationY(((Rect) animatedValue).bottom - ai40Var.startBottom);
    }
    ...
    public Animator mo21408c(@NotNull Act from, @NotNull w2c0 toActHelper) {
        ...
        objectAnimatorOfObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.yh40
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ai40.m97953j(this.f199905a, valueAnimator);
            }
        });
        objectAnimatorOfObject.addListener(new C15712a(toActHelper));
    ...
    public Animator mo21409d(@NotNull Act from, @NotNull w2c0 toActHelper) {
        ...
        objectAnimatorOfObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.zh40
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ai40.m97952i(this.f204375a, valueAnimator);
            }
        });
