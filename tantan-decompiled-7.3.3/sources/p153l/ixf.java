...
public class ixf {
    ...
    public static Boolean m142513a(HashMap<String, Object> map, String str) {
    ...
    public static Integer m142514b(HashMap<String, Object> map, String str) {
        if (map == null || map.size() <= 0) {
            return 0;
        }
        Object obj = map.get(str);
    ...
    public static String m142515c(Context context, boolean z) {
        return z ? IdentityPlatform.getMetaInfo(context) : ZIMFacade.getMetaInfos(context);
    }

    /* JADX INFO: renamed from: d */
    public static String m142516d(HashMap<String, Object> map, String str) {
        if (map != null && map.size() > 0) {
            Object obj = map.get(str);
    ...
    public static String m142517e(String str) {
