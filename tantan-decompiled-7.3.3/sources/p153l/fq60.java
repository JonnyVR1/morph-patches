...
public final /* data */ class fq60 {
    ...
    public /* synthetic */ fq60(C8928d c8928d, PayMethod payMethod, double d, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(c8928d, payMethod, (i & 4) != 0 ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : d, (i & 8) != 0 ? true : z);
    }
    ...
    public final C8928d getPurchaseSection() {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof fq60)) {
            return false;
        }
        fq60 fq60Var = (fq60) other;
        return Intrinsics.m88377d(this.purchaseSection, fq60Var.purchaseSection) && Intrinsics.m88377d(this.payMethod, fq60Var.payMethod) && Double.compare(this.refundAmount, fq60Var.refundAmount) == 0 && this.showSticker == fq60Var.showSticker;
    }
    ...
    public fq60(@NotNull C8928d c8928d, @NotNull PayMethod payMethod, double d, boolean z) {
        c8928d.getClass();
        payMethod.getClass();
        this.purchaseSection = c8928d;
