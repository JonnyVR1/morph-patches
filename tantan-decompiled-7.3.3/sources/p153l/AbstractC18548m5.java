...
public abstract class AbstractC18548m5 {
    ...
    public AbstractC18548m5(@NotNull PurchaseType purchaseType, @NotNull List<? extends C8928d> list) {
    ...
    public abstract boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod);

    @NotNull
    /* JADX INFO: renamed from: b */
    public final List<C8928d> m157072b() {
