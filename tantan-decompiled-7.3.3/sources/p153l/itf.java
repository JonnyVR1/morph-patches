...
public class itf extends bs2 {

    /* JADX INFO: renamed from: d */
    private int f116827d;

    /* JADX INFO: renamed from: e */
    private int f116828e;

    /* JADX INFO: renamed from: f */
    private float f116829f = 0.2f;

    /* JADX INFO: renamed from: g */
    private float f116830g = 0.15f;
    ...
    public void initShaderHandles() {
        ...
        this.f116827d = GLES20.glGetUniformLocation(this.programHandle, "amount");
        this.f116828e = GLES20.glGetUniformLocation(this.programHandle, "speed");
    }

    @Override // p153l.bs2, p153l.wej
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f116827d, this.f116829f);
        GLES20.glUniform1f(this.f116828e, this.f116830g);
    }
}
