...
public final class ld90 extends AbstractC21509y4 {
    ...
    public ld90(@NotNull PrivilegeEntranceView.C8456a c8456a) {
        super(c8456a);
        c8456a.getClass();
    }

    /* JADX INFO: renamed from: t */
    public static final void m153741t(ld90 ld90Var, View view) {
        i4g0.m138520r(ld90Var.mo96815h(), ld90Var.m214188f());
        if (cs20.m112113a().m112118f()) {
            String strMo34342Ie = CoreModule.m30933P().m143405a().mo34342Ie();
            strMo34342Ie.getClass();
            ld90Var.m214193o(strMo34342Ie);
        } else {
            String strMo34450Y3 = CoreModule.m30933P().m143405a().mo34450Y3();
            strMo34450Y3.getClass();
            ld90Var.m214193o(strMo34450Y3);
        }
    }

    /* JADX INFO: renamed from: u */
    public static final void m153742u(ld90 ld90Var, PrivilegeEntrancePromotionBottomView privilegeEntrancePromotionBottomView, View view) {
        i4g0.m138520r(ld90Var.m153744s(), ld90Var.m214188f());
        ...
        String strMo34450Y3 = CoreModule.m30933P().m143405a().mo34450Y3();
        int iMo34592sk = CoreModule.m30933P().m143405a().mo34592sk(strMo34450Y3);
        Merchandise merchandise = ld90Var.merchandise;
        List<Coupon> list = merchandise != null ? merchandise.localCoupons : null;
        if (list == null || list.isEmpty()) {
            return;
        }
        Merchandise merchandise2 = ld90Var.merchandise;
        Coupon coupon = (Coupon) jyb.m147529r(merchandise2 != null ? merchandise2.localCoupons : null, new qcj() { // from class: l.kd90
            @Override // p153l.qcj
            public final Object call(Object obj) {
                return ld90.m153743v((Coupon) obj);
            }
        });
        if (coupon != null) {
    ...
    public static final Boolean m153743v(Coupon coupon) {
        coupon.getClass();
        return Boolean.valueOf(coupon.isBelongPromotion(MonetizationPromotionsId.lowPriceCustomerVIP) && v5b0.m199792r(coupon.f56859id));
    }

    @Override // p153l.m3m
    /* JADX INFO: renamed from: a */
    public boolean mo96813a() {
        if (!s7a.m184991t() && tqi.m192303c() && NullChecker.m82486a(CoreModule.f18264c.f20396j0.m31582D5(ProductCategory.get(ProductCategory.tttVip)))) {
            for (Merchandise merchandise : CoreModule.f18264c.f20396j0.m31582D5(ProductCategory.get(ProductCategory.tttVip))) {
                if (v5b0.m199786l(merchandise, MonetizationPromotionsId.lowPriceCustomerVIP)) {
    ...
    public void mo96817m() {
        ...
        if (privilegeEntranceSingleTextView != null) {
            ...
            bnl0.m105509E0(privilegeEntranceSingleTextView, new View.OnClickListener() { // from class: l.id90
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ld90.m153741t(this.f114494a, view);
                }
            });
        }
        ...
        if (privilegeEntrancePromotionBottomView != null) {
            ...
            bnl0.m105509E0(privilegeEntrancePromotionBottomView.get_goto_buy(), new View.OnClickListener() { // from class: l.jd90
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ld90.m153742u(this.f120117a, privilegeEntrancePromotionBottomView, view);
                }
            });
            Merchandise merchandise5 = this.merchandise;
            i4g0.m138492A("e_purchase_banner", OMSDialogPositon.p_navigation_view, jyb.m147494Y(BLiveOperationTitleShowType.duration, (merchandise5 != null ? Integer.valueOf(merchandise5.quantity) : null) + "m"), jyb.m147494Y("discount_type", "new_customer"), jyb.m147494Y("productType", "vip"));
        }
    }

    @NotNull
    /* JADX INFO: renamed from: s */
    public String m153744s() {
