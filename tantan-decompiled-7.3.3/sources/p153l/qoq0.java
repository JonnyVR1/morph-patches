...
public class qoq0 extends gp60 {
    public qoq0(PurchaseType purchaseType, mdf0 mdf0Var) {
    ...
    public C22421c<uxj0> mo104620b() {
        return CoreModule.f18264c.f20297C0.m146424v3(SummarizedPrivilegesId.get("youthVip")).distinctUntilChanged(new rcj() { // from class: l.ooq0
            @Override // p153l.rcj
            public final Object call(Object obj, Object obj2) {
                return Boolean.valueOf(((UserPrivilege) obj).content.expiredTime == ((UserPrivilege) obj2).content.expiredTime);
            }
        }).skip(1).map(new qcj() { // from class: l.poq0
            @Override // p153l.qcj
    ...
    public boolean mo104622e() {
        return wib0.m206580x(this.f105436a);
    }
}
