...
public class ocj extends qrm0<LucyParadiseEntranceView> {

    /* JADX INFO: renamed from: r */
    public kcg0 f146714r;

    public ocj(dum<? extends rwn0> dumVar, BLiveBottomButton bLiveBottomButton, Area area) {
        super(dumVar, bLiveBottomButton, area);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: u4 */
    public void m167229u4(long j) {
        if (j / 1000 > 0) {
            m177578X3().m78949z0(j);
        } else {
            psd0.m173633z(this.f146714r);
            m177578X3().m78941p0();
        }
    }
    ...
    public LucyParadiseEntranceView mo105688T3(int i, boolean z) {
        ...
        lucyParadiseEntranceView.setLayoutParams(new SweetGalleryLayoutManager.C13201d(qa00.m175859d(44.0f), qa00.m175859d(38.0f)));
    ...
    public final void m167231s4() {
        duringCreated(VirtualVoiceRoomApiProvider.getFunFairEntranceInfo(((rwn0) m213810E2()).m168526j0(), ((rwn0) m213810E2()).m202194o())).subscribe(dhw.m115829h(new lcj(this)));
    }
    ...
    public void mo73648t() {
        super.mo73648t();
        m167231s4();
        duringCreated(((rwn0) m213810E2()).m168545q1().m98268a()).subscribe(dhw.m115829h(new lcj(this)));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: t4 */
    public final void m167232t4(final BLiveLuckyParadiseBottomEntrance bLiveLuckyParadiseBottomEntrance) {
        ...
        if ((bLiveLuckyParadiseBottomEntrance.buff || bLiveLuckyParadiseBottomEntrance.isCrazyNow) && bLiveLuckyParadiseBottomEntrance.endTime > bLiveLuckyParadiseBottomEntrance.currentTime) {
            this.f146714r = m138858H3(((rwn0) m213810E2()).m168525i2(TimeUnit.SECONDS)).take((int) ((bLiveLuckyParadiseBottomEntrance.endTime - bLiveLuckyParadiseBottomEntrance.currentTime) / 1000)).map(new qcj() { // from class: l.mcj
                @Override // p153l.qcj
            ...
            }).subscribe(dhw.m115829h(new y20() { // from class: l.ncj
                @Override // p153l.y20
                public final void call(Object obj) {
                    this.f141368a.m167229u4(((Long) obj).longValue());
                }
            }));
        }
    }
