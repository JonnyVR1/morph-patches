...
public final class cq60 extends AbstractC19757r4 {
    ...
    public cq60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        ...
        response.m131355n(tab0.m189811h().m189820k(aVarM179724g.m54784s()));
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        request.getClass();
        return wib0.m206579w(this.purchaseType) && request.getPurchaseSection().m54714m() && v5b0.m199798x(request.getPurchaseSection().m54703b().m54784s());
    }
}
