...
public final class dq60 extends AbstractC19757r4 {
    ...
    public dq60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        ...
        if (TextUtils.equals(getFrom(), "purchasePage")) {
            response.m131352k(aVarM179724g.m54786u() + "元秒杀");
            return;
        }
        response.m131355n(aVarM179724g.m54786u() + "元秒杀");
    }
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        request.getClass();
        m179724g(request.getPurchaseSection());
        return false;
    }
}
