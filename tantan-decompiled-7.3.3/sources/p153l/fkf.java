...
public class fkf extends lp90 {

    /* JADX INFO: renamed from: e */
    public TextView f99503e;

    public fkf(Context context, LayoutDesc layoutDesc) {
    ...
    public ProfileButton mo112044e(ProfileButton.ProfileButtonType profileButtonType) {
        if (profileButtonType == ProfileButton.ProfileButtonType.Recovery) {
            return new ProfileButton(profileButtonType, this.f133028b.m53572a()).m53576b(this.f99503e);
        }
        return null;
    }
    ...
    public View mo112045g() {
        return LayoutInflater.from(this.f133029c).inflate(kec0.f125538N9, (ViewGroup) null);
    }
    ...
    public void mo112046h(View view) {
        ...
        this.f99503e = (TextView) view.findViewById(adc0.f70508pb);
    }
