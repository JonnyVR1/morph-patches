...
public final class nd0 implements tol {
    ...
    public CharSequence mo115313a(@NotNull bd0 requestData) {
        ...
        CharSequence charSequenceM105330M = bn60.m105330M(requestData.getPrivilegeStyle());
        charSequenceM105330M.getClass();
        return charSequenceM105330M;
    }
    ...
    public boolean mo115314b(@NotNull bd0 requestData) {
        requestData.getClass();
        return wib0.m206580x(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
