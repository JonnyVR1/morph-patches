...
public class sml extends t4f {

    /* JADX INFO: renamed from: a */
    private final xgw<String, String> f169588a = new xgw<>(20);

    /* JADX INFO: renamed from: b */
    private final Object f169589b = new Object();
    ...
    private boolean isSupportDns(String str) {
        ...
        return rmw.f163939a.getDnsInstance().useDNS(str);
    }
        ...
        try {
            ...
            if (isSupportDns(str)) {
                if (TextUtils.isEmpty(str2)) {
                    synchronized (this.f169589b) {
                        strM210956f = this.f169588a.m210956f(str + qmw.m177151a(new byte[]{10}) + ry3Var.hashCode());
                    }
                    str2 = strM210956f;
                }
                if (TextUtils.isEmpty(str2) || rmw.f163939a == null || rmw.f163939a.getDnsInstance() == null) {
                    return;
                }
                rmw.f163939a.getDnsInstance().requestFailedForDomain(str, str2);
            }
    ...
    private void recordSuccess(ry3 ry3Var) {
        ...
        try {
            ...
            if (isSupportDns(strM182286m)) {
                synchronized (this.f169589b) {
                    strM210956f = this.f169588a.m210956f(strM182286m + qmw.m177151a(new byte[]{10}) + ry3Var.hashCode());
                }
                if (TextUtils.isEmpty(strM210956f) || rmw.f163939a == null || rmw.f163939a.getDnsInstance() == null) {
                    return;
                }
                rmw.f163939a.getDnsInstance().requestSucceedForDomain(strM182286m, strM210956f);
            }
        } catch (Exception unused) {
        }
    }
    ...
    public void dnsEnd(ry3 ry3Var, String str, List<InetAddress> list) {
        ...
        synchronized (this.f169589b) {
            this.f169588a.m210955e(str + qmw.m177151a(new byte[]{10}) + ry3Var.hashCode(), hostAddress);
        }
    }
