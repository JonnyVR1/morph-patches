...
public class pzj extends yr2 {
    ...
    public List<String> mo107422b(BLiveTemplateItem bLiveTemplateItem, Template.TemplateData templateData, hzc0 hzc0Var) {
        ...
        return (hzc0Var == null || (liveChatMessage = hzc0Var.f112224d) == null) ? jyb.m147507f0(new String[0]) : jyb.m147507f0(liveChatMessage.getGift().getUrl());
    }
