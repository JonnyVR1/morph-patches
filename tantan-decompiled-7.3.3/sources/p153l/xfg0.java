...
public class xfg0 implements SeekableByteChannel {
    private final List<SeekableByteChannel> channels;
    private int currentChannelIdx;
    private long globalPosition;

    public xfg0(List list) {
    ...
    public static SeekableByteChannel forSeekableByteChannels(SeekableByteChannel... seekableByteChannelArr) {
        ...
        return seekableByteChannelArr.length == 1 ? seekableByteChannelArr[0] : new xfg0(Arrays.asList(seekableByteChannelArr));
    }
