...
public class t43 {
    ...
    public static Object f171973a = null;

    /* JADX INFO: renamed from: b */
    public static int f171974b = 25;

    /* JADX INFO: renamed from: a */
    public static Bitmap m189143a(Bitmap bitmap, int i, boolean z) {
        ...
        try {
            RenderScript renderScriptCreate = (RenderScript) f171973a;
            if (renderScriptCreate == null) {
                renderScriptCreate = RenderScript.create(App.f16088e);
                f171973a = renderScriptCreate;
            }
    ...
    /* JADX INFO: renamed from: b */
    public static Bitmap m189144b(Bitmap bitmap, int i, boolean z) {
        SystemClock.uptimeMillis();
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
        int i2 = width - (width % 4);
