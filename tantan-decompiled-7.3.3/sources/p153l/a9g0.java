...
public class a9g0 {
    ...
    public static Pattern f69042a = Pattern.compile("[a-zA-Z ]+");

    /* JADX INFO: renamed from: a */
    public static String m96566a(long j, long j2) {
        if (j <= j2) {
    ...
    public static String m96567b(double d) {
        return new DecimalFormat("0.00").format(d);
    }

    /* JADX INFO: renamed from: c */
    public static String m96568c(double d) {
        return new DecimalFormat(IdManager.DEFAULT_VERSION_NAME).format(new BigDecimal(d).setScale(1, 1).doubleValue());
    }

    /* JADX INFO: renamed from: d */
    public static String m96569d(double d) {
        return new DecimalFormat("#.#").format(d);
    }

    /* JADX INFO: renamed from: e */
    public static String m96570e(double d) {
        return new DecimalFormat("#.##").format(d);
    }

    /* JADX INFO: renamed from: f */
    public static String m96571f(int i) {
        return m96572g(i, 99);
    }

    /* JADX INFO: renamed from: g */
    public static String m96572g(int i, int i2) {
        if (i <= i2) {
            if (i > 0) {
    ...
    public static boolean m96573h(char c) {
    ...
    public static boolean m96574i(char c) {
        if (c == 0 || c == '\t' || c == '\n' || c == '\r') {
            return false;
        }
        if (c >= ' ' && c <= 55295) {
    ...
    public static boolean m96575j(String str) {
        return f69042a.matcher(str).matches();
    }

    /* JADX INFO: renamed from: k */
    public static String m96576k(long j) {
        if (j <= 0) {
            return "0 B";
        }
        double d = j;
    ...
    public static boolean m96577l(String str, String str2) {
        if (str != null) {
