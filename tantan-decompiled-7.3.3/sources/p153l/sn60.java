...
public final class sn60 implements j2m {
    ...
    public sn60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str, @Nullable ndb0 ndb0Var) {
        act.getClass();
    ...
    public boolean mo117054a(@NotNull jn60 paymentHandlerData, @NotNull AbstractC18347l5 paymentComponent) {
        ...
        ndb0Var.m55187A(paymentHandlerData, this.purchaseType);
        return false;
    }
}
