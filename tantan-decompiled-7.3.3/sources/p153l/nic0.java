...
public final class nic0 {
    ...
    public static final class ViewOnTouchListenerC18879a implements View.OnTouchListener {
        ...
        public ViewOnTouchListenerC18879a(@NotNull EventBinding eventBinding, @NotNull View view, @NotNull View view2) {
            ...
            this.existingOnTouchListener = gll0.m130682h(view2);
        ...
        public boolean onTouch(@NotNull View view, @NotNull MotionEvent motionEvent) {
            ...
            if (view2 != null && view3 != null && motionEvent.getAction() == 1) {
                qc5.m176111d(this.mapping, view2, view3);
            }
    ...
    public static final ViewOnTouchListenerC18879a m163271a(@NotNull EventBinding mapping, @NotNull View rootView, @NotNull View hostView) {
        if (ztb.m221490d(nic0.class)) {
            return null;
        }
        try {
            mapping.getClass();
            rootView.getClass();
            hostView.getClass();
            return new ViewOnTouchListenerC18879a(mapping, rootView, hostView);
        } catch (Throwable th) {
            ztb.m221488b(th, nic0.class);
            return null;
        }
    }
}
