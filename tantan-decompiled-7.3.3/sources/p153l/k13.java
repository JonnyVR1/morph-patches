...
public class k13 extends hs10 {

    /* JADX INFO: renamed from: a */
    private Bitmap f123441a;

    /* JADX INFO: renamed from: b */
    private int f123442b;

    /* JADX INFO: renamed from: c */
    private boolean f123443c;

    /* JADX INFO: renamed from: d */
    private HashMap<String, String> f123444d;

    /* JADX INFO: renamed from: e */
    public String f123445e;
    ...
    public k13() {
        ...
        this.f123444d = map;
        map.put("Add", getAddBlendFragmentShader());
        this.f123444d.put("Color", getColorFragmentShader());
        this.f123444d.put("ColorBurn", getColorBurnFragmentShader());
        this.f123444d.put("ColorDodge", getColorDodgeFragmentShader());
        this.f123444d.put("Darken", getDarkenFragmentShader());
        this.f123444d.put("Difference", getDifferenceFragmentShader());
        this.f123444d.put("Divide", getDivideFragmentShader());
        this.f123444d.put("Exclusion", getExclusionFragmentShader());
        this.f123444d.put("HardLight", getHardLightFragmentShader());
        this.f123444d.put("Hue", getHueFragmentShader());
        this.f123444d.put("Lighten", getLightenFragmentShader());
        this.f123444d.put("LinearBurn", getLinearBurnFragmentShader());
        this.f123444d.put("Luminosity", getLuminosityFragmentShader());
        this.f123444d.put("Mask", getMaskFragmentShader());
        this.f123444d.put("Multiply", getMultiplyFragmentShader());
        this.f123444d.put("Normal", getNormalFragmentShader());
        this.f123444d.put("Overlay", getOverlayFragmentShader());
        this.f123444d.put(p7f.TAG_SATURATION, getSaturationFragmentShader());
        this.f123444d.put("Screen", getScreenFragmentShader());
        this.f123444d.put("SoftLight", getSoftLightFragmentShader());
        this.f123444d.put("SourceOver", getSourceoverFragmentShader());
        this.f123444d.put("Subtract", getSubtractFragmentShader());
    }

    /* JADX INFO: renamed from: Q1 */
    public void m147844Q1(String str) {
    ...
    public void destroy() {
        ...
        Bitmap bitmap = this.f123441a;
        if (bitmap == null || bitmap.isRecycled()) {
            return;
        }
        this.f123441a.recycle();
        this.f123441a = null;
    }
    ...
    public String getFragmentShader() {
        String str = !TextUtils.isEmpty(this.f123445e) ? this.f123444d.get(this.f123445e) : null;
    ...
    public void newTextureReady(int i, gfj gfjVar, boolean z) {
        ...
        if (this.f123442b == 0 || this.f123443c) {
            Bitmap bitmap = this.f123441a;
            if (bitmap != null) {
                this.f123442b = oim.m167794a(bitmap);
            } else {
                this.f123442b = oim.m167794a(oim.m167796c(this.f123446f));
            }
            this.f123443c = false;
        }
        super.newTextureReady(this.f123442b, this, z);
