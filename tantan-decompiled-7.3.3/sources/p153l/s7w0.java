...
public final class s7w0 {

    /* JADX INFO: renamed from: a */
    public final v2s0 f166714a;

    @VisibleForTesting
    public s7w0(v2s0 v2s0Var) {
        this.f166714a = v2s0Var;
    }

    /* JADX INFO: renamed from: b */
    public static final Uri m185038b(Uri uri, String str) throws zzavj {
        if (uri != null) {
            try {
                try {
    ...
    /* JADX INFO: renamed from: a */
    public final Uri m185039a(Uri uri, Context context, View view, @Nullable Activity activity) throws zzavj {
        try {
            return m185038b(uri, this.f166714a.m199147c().mo165760g(context, uri.getQueryParameter("ai"), view, activity));
        } catch (UnsupportedOperationException unused) {
            throw new zzavj("Provided Uri is not in a valid state");
        }
    }
