...
public class trq0 {
    ...
    /* JADX INFO: renamed from: b */
    public static String m192524b(byte[] bArr) throws Exception {
        ...
        while (i < length) {
            ...
            int i3 = b & 255;
            if (i2 == length) {
                stringBuffer.append(f175916a[i3 >>> 2]);
                stringBuffer.append(f175916a[(b & 3) << 4]);
                stringBuffer.append("==");
                break;
            }
            int i4 = i + 2;
            ...
            if (i4 == length) {
                stringBuffer.append(f175916a[i3 >>> 2]);
                stringBuffer.append(f175916a[((b & 3) << 4) | ((b2 & 240) >>> 4)]);
                stringBuffer.append(f175916a[(b2 & 15) << 2]);
                stringBuffer.append("=");
                break;
            }
            i += 3;
            ...
            stringBuffer.append(f175916a[i3 >>> 2]);
            stringBuffer.append(f175916a[((b & 3) << 4) | ((b2 & 240) >>> 4)]);
            stringBuffer.append(f175916a[((b2 & 15) << 2) | ((b3 & 192) >>> 6)]);
            stringBuffer.append(f175916a[b3 & Utf8.REPLACEMENT_BYTE]);
        }
