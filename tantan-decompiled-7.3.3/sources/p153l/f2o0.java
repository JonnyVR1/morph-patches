...
public final class f2o0 extends d3q<VoiceLiveManagerInviteItemView> {
    ...
    public f2o0(@NotNull BLiveVoiceManagerInvite bLiveVoiceManagerInvite, @NotNull y20<BLiveVoiceManagerInvite> y20Var) {
    ...
    public void mo71749u(@Nullable VoiceLiveManagerInviteItemView itemView) {
        ...
        itemView.getClass();
        itemView.m79778k0(this.itemInfo, true, this.action);
    }
