...
public class l33 {
    ...
    public static Bitmap m152667a(String str) throws Throwable {
    ...
    public static Bitmap m152668b(String str) throws Throwable {
        Closeable closeable;
        Throwable th;
