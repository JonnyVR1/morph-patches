...
public class yks extends jk2<LongLinkGiftMessage.LiveGiftReceivedMsg, BLiveGivenGiftBrief> {
    public yks(wbg0<BLiveGivenGiftBrief, BLiveGivenGiftBrief> wbg0Var, zod zodVar) {
    ...
    public boolean mo95512q(LongLinkGiftMessage.LiveGiftReceivedMsg liveGiftReceivedMsg, String str) {
        wrv wrvVar;
        return (liveGiftReceivedMsg == null || (wrvVar = zrv.f205799a) == null || TextUtils.equals(wrvVar.m207631D0(), liveGiftReceivedMsg.getUserId())) ? false : true;
    }
