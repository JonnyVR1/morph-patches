...
public final class mx50 {
    ...
    public mx50(@NotNull String str, @NotNull String str2, @Nullable UserCardBean userCardBean, @NotNull User user) {
        str.getClass();
        str2.getClass();
        user.getClass();
        this.giftId = str;
