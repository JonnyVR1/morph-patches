...
public class mki {
    ...
    private static final String[] f137301a = {"../", "~/"};
    ...
    /* JADX INFO: renamed from: a */
    public static void m158787a(File file, File file2) throws Throwable {
    ...
    public static boolean m158788b(String str, String str2) {
        return m158789c(str, str2, false);
    }

    /* JADX INFO: renamed from: c */
    public static boolean m158789c(String str, String str2, boolean z) {
        try {
            m158790d(str, str2, z);
            return true;
        } catch (Exception e) {
    ...
    public static void m158790d(String str, String str2, boolean z) throws Exception {
    ...
    public static boolean m158791e(String str) {
        int length = f137301a.length;
        for (int i = 0; i < length; i++) {
            if (str.contains(f137301a[i])) {
                return false;
            }
        }
        return true;
