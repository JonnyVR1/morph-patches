...
public final class dq50 extends AbstractC18548m5 {
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        ...
        return (companion.m129216a(getPurchaseType()) || wib0.m206571o(getPurchaseType()) || wib0.m206565i(getPurchaseType()) || wib0.m206561e(getPurchaseType()) || TEnum.equals(currentPayMethod, "wechat") || companion.m129218c(getPurchaseType()) || wib0.m206563g(getPurchaseType()) || wib0.m206580x(getPurchaseType()) || wib0.m206572p(getPurchaseType()) || wib0.m206566j(getPurchaseType()) || !NullChecker.m82486a(section) || !NullChecker.m82486a(section.m54705d()) || !section.m54705d().m54735H() || !section.m54705d().m54784s().monthly()) ? false : true;
    }
}
