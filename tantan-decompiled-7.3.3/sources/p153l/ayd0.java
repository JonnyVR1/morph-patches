...
public final class ayd0 extends dyd0<BLiveResourceCDN> {
    ...
    public BLiveResourceCDN copyed(@Nullable BLiveResourceCDN to, @NotNull BLiveResourceCDN from) {
        from.getClass();
        BLiveResourceCDN bLiveResourceCDNMo225055clone = from.mo225055clone();
        bLiveResourceCDNMo225055clone.getClass();
        return bLiveResourceCDNMo225055clone;
    }
