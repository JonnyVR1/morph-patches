...
public final class fd0 implements tol {
    ...
    public fd0(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        act.getClass();
    ...
    public CharSequence mo115313a(@NotNull bd0 requestData) {
        ...
        if (requestData.getVipFrag() && s7a.m184986o()) {
            CharSequence charSequenceM105318A = bn60.m105318A(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), Color.parseColor("#735131"));
        ...
        if (requestData.getPrivilegeStyle()) {
            CharSequence charSequenceM105318A2 = bn60.m105318A(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), bn60.m105334Q(true));
            charSequenceM105318A2.getClass();
            return charSequenceM105318A2;
        }
        CharSequence charSequenceM105318A3 = bn60.m105318A(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), bn60.m105334Q(false));
        charSequenceM105318A3.getClass();
        return charSequenceM105318A3;
    }
    ...
    public boolean mo115314b(@NotNull bd0 requestData) {
        requestData.getClass();
        return wib0.m206565i(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
