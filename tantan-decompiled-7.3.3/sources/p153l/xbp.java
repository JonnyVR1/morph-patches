...
public final class xbp extends dyd0<BLiveIntlTemplateData> {
    ...
    public BLiveIntlTemplateData copyed(@Nullable BLiveIntlTemplateData to, @NotNull BLiveIntlTemplateData from) {
        from.getClass();
        BLiveIntlTemplateData bLiveIntlTemplateDataMo225055clone = from.mo225055clone();
        bLiveIntlTemplateDataMo225055clone.getClass();
        return bLiveIntlTemplateDataMo225055clone;
    }
    ...
    public BLiveIntlTemplateData retrieveValue() {
        ...
        if (string != null) {
            return BLiveIntlTemplateData.JSON_ADAPTER.parse(string);
        }
        return null;
    }
