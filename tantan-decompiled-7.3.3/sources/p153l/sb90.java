...
public final class sb90 extends AbstractC21509y4 {
    ...
    public sb90(@NotNull PrivilegeEntranceView.C8456a c8456a) {
        super(c8456a);
        c8456a.getClass();
    }

    /* JADX INFO: renamed from: s */
    public static final void m185299s(sb90 sb90Var, View view) {
        i4g0.m138520r(sb90Var.mo96815h(), sb90Var.m214188f());
        if (cs20.m112113a().m112118f()) {
            String strMo34342Ie = CoreModule.m30933P().m143405a().mo34342Ie();
            strMo34342Ie.getClass();
            sb90Var.m214193o(strMo34342Ie);
        } else {
            String strMo34450Y3 = CoreModule.m30933P().m143405a().mo34450Y3();
            strMo34450Y3.getClass();
            sb90Var.m214193o(strMo34450Y3);
        }
    }

    /* JADX INFO: renamed from: t */
    public static final void m185300t(sb90 sb90Var, View view) {
        i4g0.m138520r(sb90Var.m185301r(), sb90Var.m214188f());
    ...
    public boolean mo96813a() {
        if (!s7a.m184991t() && !dk90.m116230i() && joa.m146386f4() && NullChecker.m82486a(CoreModule.f18264c.f20396j0.m31582D5(ProductCategory.get("svip")))) {
            for (Merchandise merchandise : CoreModule.f18264c.f20396j0.m31582D5(ProductCategory.get("svip"))) {
                if (v5b0.m199786l(merchandise, MonetizationPromotionsId.lowPriceCustomerSVIP)) {
                    this.merchandise = merchandise;
                    return true;
                }
                if (v5b0.m199786l(merchandise, MonetizationPromotionsId.lowPriceCustomerUpliftSVIP)) {
                    this.merchandise = merchandise;
                    return true;
                }
            }
    ...
    public void mo96817m() {
        ...
        if (privilegeEntranceSingleTextView != null) {
            ...
            bnl0.m105509E0(privilegeEntranceSingleTextView, new View.OnClickListener() { // from class: l.qb90
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    sb90.m185299s(this.f156461a, view);
                }
            });
        }
        ...
        if (privilegeEntrancePromotionBottomView != null) {
            ...
            bnl0.m105509E0(privilegeEntrancePromotionBottomView.get_goto_buy(), new View.OnClickListener() { // from class: l.rb90
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    sb90.m185300t(this.f162001a, view);
                }
            });
