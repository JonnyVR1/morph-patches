...
public final class tp60 extends AbstractC19757r4 {
    ...
    public tp60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        request.getClass();
        return wib0.m206569m(this.purchaseType) && request.getPurchaseSection().m54714m() && v5b0.m199795u(request.getPurchaseSection().m54703b().m54784s());
    }
}
