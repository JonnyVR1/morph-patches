...
public final class tkq0 extends AbstractC18548m5 {
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!wib0.m206573q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "wechat")) {
            return false;
        }
        if (NullChecker.m82486a(section.m54703b()) && section.m54714m() && section.m54703b().m54784s().semiAnnual()) {
            return true;
        }
        return NullChecker.m82486a(section.m54705d()) && section.m54705d().m54784s().semiAnnual();
    }
}
