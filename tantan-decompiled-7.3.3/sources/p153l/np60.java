...
public final class np60 extends AbstractC19757r4 {
    ...
    public np60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        request.getClass();
        response.getClass();
        response.m131355n("立送3个月");
        response.m131352k("立送3个月");
        response.m131356o("");
    }
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        ...
        return s7a.m184977f() && TEnum.equals(aVarM179724g.m54762f(), "svip") && aVarM179724g.m54784s().autoRenewable() && aVarM179724g.m54784s().monthType() && aVarM179724g.m54784s().quantity == 6 && deh0.m115415f(aVarM179724g.m54784s());
    }
}
