...
public final class di0 extends AbstractC18548m5 {
    ...
    public static Boolean m115837d(C8928d c8928d) {
        return Boolean.valueOf(NullChecker.m82486a(c8928d.m54703b()) && c8928d.m54703b().m54784s().quarterly() && (v5b0.m199797w(c8928d.m54703b().m54784s()) || v5b0.m199796v("svip", c8928d.m54703b().m54784s())));
    }
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!wib0.m206573q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "alipay") || jyb.m147520m(m157072b(), new qcj() { // from class: l.ci0
            @Override // p153l.qcj
            public final Object call(Object obj) {
                return di0.m115837d((C8928d) obj);
            }
        })) {
            return false;
        }
