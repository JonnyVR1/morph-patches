...
public class pai extends Act.AbstractC4455w<PutongAct, FeedVideoFlowAct> {

    /* JADX INFO: renamed from: l.pai$a */
    public class C19328a extends AnimatorListenerAdapter {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ FeedVideoFlowAct f151280a;

        public C19328a(FeedVideoFlowAct feedVideoFlowAct) {
            this.f151280a = feedVideoFlowAct;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            super.onAnimationEnd(animator);
            this.f151280a.m67375g2();
        }
    }

    @Override // com.p051p1.mobile.android.app.Act.AbstractC4455w
    /* JADX INFO: renamed from: i, reason: merged with bridge method [inline-methods] */
    public Animator mo21408c(PutongAct putongAct, FeedVideoFlowAct feedVideoFlowAct) {
        View viewFindViewWithTag;
        C22700a.b bVar;
        FeedVideoViewFlowItemView feedVideoViewFlowItemView = feedVideoFlowAct.m67371b2().m205649l().f102994k;
        if (feedVideoViewFlowItemView == null || (viewFindViewWithTag = feedVideoViewFlowItemView.getViewModel().f43458b.findViewWithTag(0)) == null || (bVar = (C22700a.b) viewFindViewWithTag.findViewById(hdc0.f108949o1)) == null) {
            return null;
        }
        ...
        animatorM132180z.addListener(new C19328a(feedVideoFlowAct));
        return animatorM132180z;
    }

    @Override // com.p051p1.mobile.android.app.Act.AbstractC4455w
    /* JADX INFO: renamed from: j, reason: merged with bridge method [inline-methods] */
    public Animator mo21409d(PutongAct putongAct, FeedVideoFlowAct feedVideoFlowAct) {
        View viewFindViewWithTag;
        C22700a.b bVar;
        FeedVideoViewFlowItemView feedVideoViewFlowItemView = feedVideoFlowAct.m67371b2().m205649l().f102994k;
        if (feedVideoViewFlowItemView == null || (viewFindViewWithTag = feedVideoViewFlowItemView.getViewModel().f43458b.findViewWithTag(0)) == null || (bVar = (C22700a.b) viewFindViewWithTag.findViewById(hdc0.f108949o1)) == null) {
