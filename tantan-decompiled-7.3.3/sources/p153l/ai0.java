...
public final class ai0 extends AbstractC18548m5 {
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (CoreModule.m30933P().m143405a().mo34527j3() && TEnum.equals(currentPayMethod, "alipay") && CoreModule.f18264c.f20333O0.m31084u3(getPurchaseType()) && NullChecker.m82486a(section.m54703b()) && section.m54714m()) {
            if (!NullChecker.m82486a(section.m54705d())) {
                return true;
            }
            section.m54724w(false);
            return false;
        }
        if (TEnum.equals(currentPayMethod, PayMethod.jingdong) && (wib0.m206579w(getPurchaseType()) || wib0.m206573q(getPurchaseType()))) {
            if (!NullChecker.m82486a(section.m54705d())) {
                return true;
            }
            section.m54724w(false);
        ...
        if (agreementState == AgreementComponent.AgreementState.checked && NullChecker.m82486a(section.m54703b())) {
