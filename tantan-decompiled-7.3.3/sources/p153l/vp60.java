...
public final class vp60 extends AbstractC19757r4 {
    ...
    public vp60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        request.getClass();
        response.getClass();
        if ((wib0.m206565i(this.purchaseType) || wib0.m206566j(this.purchaseType)) && request.getRefundAmount() > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && !joa.m146357G3()) {
        ...
        if (!wib0.m206573q(this.purchaseType) || ((long) Math.floor(request.getRefundAmount())) <= 0 || joa.m146361M3()) {
            return;
        }
        response.m131356o(this.act.getString(R$string.f28451t1, String.valueOf((long) Math.floor(request.getRefundAmount()))));
    }
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        ...
        if (request.getRefundAmount() > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            return wib0.m206573q(this.purchaseType) || wib0.m206565i(this.purchaseType) || wib0.m206566j(this.purchaseType);
        }
        return false;
    }
}
