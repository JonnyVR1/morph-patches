...
public class j4g0 {
    ...
    /* JADX INFO: renamed from: l.j4g0$a */
    public static /* synthetic */ class C17873a {

        /* JADX INFO: renamed from: a */
        static final /* synthetic */ int[] f118293a;
        ...
        static {
            ...
            try {
                f118293a[IProcessOutput.ProcessType.PROCESS_IMAGE_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f118293a[IProcessOutput.ProcessType.PROCESS_VIDEO_TYPE.ordinal()] = 3;
    ...
    /* JADX INFO: renamed from: a */
    public static String m143415a(IProcessOutput.ProcessType processType, String str) {
            ...
            if (strArrSplit.length > 1) {
                if (str.contains("makeup_style") && "makeup_style".equals(strArrSplit[strArrSplit.length - 2])) {
                    ...
                    if (!TextUtils.isEmpty(str2)) {
                        int i = C17873a.f118293a[processType.ordinal()];
                        if (i == 1) {
                    ...
                    if (!TextUtils.isEmpty(str3)) {
                        int i2 = C17873a.f118293a[processType.ordinal()];
                        if (i2 == 1) {
    ...
    public static String m143416b(String str) {
