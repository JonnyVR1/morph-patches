...
public class t9i implements z9i<FeedUserSexAndAgeView> {
    @Override // p153l.z9i
    /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
    public void mo171362a(FeedUserSexAndAgeView feedUserSexAndAgeView, User user) {
        bnl0.m105505C0(feedUserSexAndAgeView.f44277a, qa00.m175859d(15.0f));
        if (mrb0.m159668v(user)) {
            bnl0.m105558h0(feedUserSexAndAgeView.f44277a, 0);
            bnl0.m105507D0(qa00.m175859d(15.0f), feedUserSexAndAgeView.f44277a);
        } else {
