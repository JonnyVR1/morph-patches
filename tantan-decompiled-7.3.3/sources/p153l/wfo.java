...
public final class wfo {
    ...
    public wfo(@NotNull IntlILikeFrag intlILikeFrag, @NotNull arn arnVar) {
        intlILikeFrag.getClass();
        arnVar.getClass();
        this.frag = intlILikeFrag;
        this.presenter = arnVar;
        ...
        this.affiliateCountdownResyncSub = intlILikeFrag.duringCreated(CoreModule.f18264c.f20438x0.m31208p4()).subscribe(psd0.m173596G(new y20() { // from class: l.ufo
            @Override // p153l.y20
            public final void call(Object obj) {
                wfo.m206132b(this.f178794a, (Boolean) obj);
            }
        }));
        this.affiliatePromotionsCacheSub = intlILikeFrag.duringCreated(CoreModule.f18264c.f20438x0.m31210q4()).subscribe(psd0.m173596G(new y20() { // from class: l.vfo
            @Override // p153l.y20
            public final void call(Object obj) {
                wfo.m206133c(this.f183961a, (Boolean) obj);
            }
        }));
    }

    /* JADX INFO: renamed from: a */
    public static void m206131a(wfo wfoVar, IapAffiliatePromotion iapAffiliatePromotion, View view) {
        Act act = wfoVar.frag.act();
        if (act == null) {
            return;
        }
        s3n.m184288f(act, iapAffiliatePromotion, s3n.m184284b(wfoVar.tab));
        CoreModule.m30933P().m143410g().mo36092zr(act, wfoVar.purchaseFrom);
    }

    /* JADX INFO: renamed from: b */
    public static void m206132b(wfo wfoVar, Boolean bool) {
        wfoVar.m206143m();
    }

    /* JADX INFO: renamed from: c */
    public static void m206133c(wfo wfoVar, Boolean bool) {
        wfoVar.m206143m();
    }

    /* JADX INFO: renamed from: d */
    public final void m206134d(IntlDiscountEntryBannerView b, boolean stopCountdown) {
    ...
    public final void m206135e(IntlDiscountEntryBannerView b) {
    ...
    public final void m206136f(IntlDiscountEntryBannerView b, IapAffiliatePromotionDisplaySlot slot) {
        String string;
    ...
    public final void m206137g(@NotNull FrameLayout container) {
        Context context;
        container.getClass();
        m206140j();
    ...
    public final CharSequence m206138h(IapAffiliatePromotionDisplaySlot slot) {
        String string;
        String string2;
        String string3;
        String str = slot.mainTitle;
    ...
    public final void m206139i() {
        ...
        if (intlDiscountEntryBannerView != null) {
            m206134d(intlDiscountEntryBannerView, true);
        }
        this.banner = null;
    }

    /* JADX INFO: renamed from: j */
    public final void m206140j() {
        IntlDiscountEntryBannerView intlDiscountEntryBannerView = this.banner;
    ...
    public final void m206141k() {
        m206143m();
    }

    /* JADX INFO: renamed from: l */
    public final IntlDiscountEntryTheme m206142l(String raw) {
    ...
    public final void m206143m() {
        ...
        if (this.frag.act() == null) {
            m206134d(intlDiscountEntryBannerView, false);
            return;
        }
        m206135e(intlDiscountEntryBannerView);
        intlDiscountEntryBannerView.setEntryTheme(m206142l(iapAffiliatePromotionDisplaySlotM31173G3.theme));
        ...
        m206136f(intlDiscountEntryBannerView, iapAffiliatePromotionDisplaySlotM31173G3);
        ...
        intlDiscountEntryBannerView.setOnBannerClickListener(new View.OnClickListener() { // from class: l.tfo
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                wfo.m206131a(this.f173983a, iapAffiliatePromotionM31168D3, view);
            }
        });
        intlDiscountEntryBannerView.setBannerContentDescription(m206138h(iapAffiliatePromotionDisplaySlotM31173G3));
    }
}
