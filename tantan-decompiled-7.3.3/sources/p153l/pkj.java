...
public class pkj extends AbstractC18340l4 {
    ...
    public boolean mo144687d(BLiveEffect bLiveEffect) {
        if (!this.f129922a.mo204914i(bLiveEffect.f45207id, bLiveEffect.hdType, bLiveEffect.zip)) {
            return false;
        }
    ...
    public boolean mo144688f(String str, boolean z, w8e w8eVar, e4d0 e4d0Var) {
        ...
        if (this.f129922a.mo204914i(bLiveEffectM152743c.f45207id, bLiveEffectM152743c.hdType, bLiveEffectM152743c.zip)) {
