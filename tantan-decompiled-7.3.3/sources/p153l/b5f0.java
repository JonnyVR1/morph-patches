...
public class b5f0 extends zh2 {

    /* JADX INFO: renamed from: d */
    public boolean f75058d = false;
    ...
    public List<LiveMessage> mo100025e(LiveMessage liveMessage, List<LiveMessage> list, pf60<Integer, Integer> pf60Var) {
        ...
        this.f75058d = false;
        if (liveMessage.isShootGameFoldMessage() && !liveMessage.isUserOwnMessage() && pf60Var != null && !jyb.m147479J(list)) {
