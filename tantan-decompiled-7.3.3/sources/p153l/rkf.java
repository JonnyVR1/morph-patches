...
public class rkf extends jt2 {
    ...
    public String getFragmentShader() {
        return this.f163567e;
    }

    @Override // p153l.wej
    public String getVertexShader() {
        return this.f163566d;
    }

    @Override // p153l.wej
    public void initWithGLContext() {
        super.initWithGLContext();
        this.f163564b = GLES20.glGetUniformLocation(this.programHandle, "twoTexelSize");
    }
