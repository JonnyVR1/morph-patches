...
public abstract class gr2 implements v4m<NetworkTrackInfo> {

    /* JADX INFO: renamed from: a */
    public WifiManager f105995a = (WifiManager) App.f16088e.getSystemService("wifi");

    /* JADX INFO: renamed from: l.gr2$a */
    public static /* synthetic */ class C17277a {

        /* JADX INFO: renamed from: a */
        public static final /* synthetic */ int[] f105996a;
        ...
        static {
            ...
            try {
                f105996a[Protocol.HTTP_1_1.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f105996a[Protocol.HTTP_1_0.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f105996a[Protocol.HTTP_2.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f105996a[Protocol.H2_PRIOR_KNOWLEDGE.ordinal()] = 5;
    ...
    public static String m131521b(Protocol protocol) {
        if (protocol == null) {
            return "-";
        }
        int i = C17277a.f105996a[protocol.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
    ...
    public final void m131522c(Map<String, String> map) {
        uqb0.f180379K.m134811e(map);
    }

    @Override // p153l.v4m
    /* JADX INFO: renamed from: d, reason: merged with bridge method [inline-methods] */
    public void mo119562a(NetworkTrackInfo networkTrackInfo) {
        if (networkTrackInfo == null || networkTrackInfo.isCancel() || !li20.m154277g().m154278d(networkTrackInfo)) {
            return;
        }
        m131522c(mo131523e(networkTrackInfo));
    }
    ...
    public HashMap<String, String> mo131523e(NetworkTrackInfo networkTrackInfo) {
        ...
        map.put("ver", uqb0.f180413s);
        map.put("http_client_state", Act.foreground_() != null ? "" : OMSResourceType.background);
        map.put("net", ConnectivityReceiver.m82464d());
        map.put("op", networkTrackInfo.getRequestMethod());
        map.put("url", networkTrackInfo.getRequestUrl());
        map.put("type", li20.m154277g().m154281h(networkTrackInfo.getRequest(), networkTrackInfo.getReportType().getTypeStr()));
        ...
        if (response != null) {
            map.put("http_ver", m131521b(response.m138666S()));
            String strM138675u = response.m138675u("X-B3-Traceid");
            if (TextUtils.isEmpty(strM138675u)) {
                strM138675u = "-";
            }
            map.put("x_id", strM138675u);
            map.put("s_down", String.valueOf(networkTrackInfo.getResponseBodyByteCount()));
            map.put("s_rsplen", String.valueOf(Math.max(networkTrackInfo.getResponseBodyByteCount() - response.m138659F().m118873a(), 0L)));
        } else {
            map.put("http_ver", "-");
            map.put("x_id", "-");
            map.put("s_down", "-");
