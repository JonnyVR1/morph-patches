...
public final class au2 extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    public void mo4594j(@NotNull Intent intent) {
        ...
        qzv.m178829e().mo178832a(bu2.f78421a, "Received " + intent.getAction());
    ...
    public Boolean mo100316d() {
        ...
        if (intentM145018l == null) {
            qzv.m178829e().mo178834c(bu2.f78421a, "getInitialState - null intent received");
            return Boolean.FALSE;
        }
        int intExtra = intentM145018l.getIntExtra(NotificationCompat.CATEGORY_STATUS, -1);
        float intExtra2 = intentM145018l.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1) / intentM145018l.getIntExtra(BigEyeFilter.UNIFORM_SCALE, -1);
        boolean z = true;
