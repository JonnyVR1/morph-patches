...
public final class j550 extends AbstractC18548m5 {
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        return wib0.m206565i(getPurchaseType()) && s7a.m184985n() && NullChecker.m82486a(section) && NullChecker.m82486a(section.m54703b()) && section.m54703b().m54735H() && section.m54703b().m54784s().quarterly() && section.m54703b().m54732E();
    }
}
