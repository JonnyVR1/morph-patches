...
@Metadata(m88120d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\r\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\r\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\n\u001a\u0004\u0018\u00010\t2\u0006\u0010\b\u001a\u00020\u0007¢\u0006\u0004\b\n\u0010\u000bJ\r\u0010\r\u001a\u00020\f¢\u0006\u0004\b\r\u0010\u000eJ\r\u0010\u000f\u001a\u00020\u0007¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0012\u001a\u00020\u0011H\u0002¢\u0006\u0004\b\u0012\u0010\u0013J\u0011\u0010\u0014\u001a\u0004\u0018\u00010\fH\u0002¢\u0006\u0004\b\u0014\u0010\u000eJ\u0017\u0010\u0016\u001a\u00020\f2\u0006\u0010\u0015\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\u0016\u0010\u0017R\u0014\u0010\u001b\u001a\u00020\u00188\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u001a\u0010\u001f\u001a\u00020\u00078\u0006X\u0086D¢\u0006\f\n\u0004\b\u001c\u0010\u001d\u001a\u0004\b\u001e\u0010\u0010R\u001d\u0010\"\u001a\u0004\u0018\u00010\f8FX\u0086\u0084\u0002¢\u0006\f\n\u0004\b\r\u0010 \u001a\u0004\b!\u0010\u000eR\u001b\u0010$\u001a\u00020\u00118FX\u0086\u0084\u0002¢\u0006\f\n\u0004\b\n\u0010 \u001a\u0004\b#\u0010\u0013¨\u0006%"}, m88121d2 = {"Ll/jfr;", "", "<init>", "()V", "", "j", "()Z", "", "type", "Lcom/p1/mobile/putong/core/data/LikeMindedItemStatusData;", Constants.INAPP_DATA_TAG, "(Ljava/lang/String;)Lcom/p1/mobile/putong/core/data/LikeMindedItemStatusData;", "Lcom/p1/mobile/putong/core/data/LikeMindedConfigData;", "c", "()Lcom/p1/mobile/putong/core/data/LikeMindedConfigData;", "e", "()Ljava/lang/String;", "", "g", "()I", RXScreenCaptureService.KEY_INDEX, "data", "k", "(Ljava/lang/String;)Lcom/p1/mobile/putong/core/data/LikeMindedConfigData;", "Ll/jxd0;", "a", "Ll/jxd0;", "isDebug", "b", "Ljava/lang/String;", "getTest", "test", "Lkotlin/Lazy;", "f", "likeMindedConfigData", "h", "swipeCount", "b_core_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
...
public final class jfr {
    ...
    @NotNull
    public static final jxd0 isDebug = new jxd0("like_minded_debug_" + CoreModule.m30929H().userId(), Boolean.FALSE);
    ...
    @NotNull
    public static final Lazy likeMindedConfigData = LazyKt__LazyJVMKt.m88118b(new Function0() { // from class: l.hfr
    ...
    @NotNull
    public static final Lazy swipeCount = LazyKt__LazyJVMKt.m88118b(new Function0() { // from class: l.ifr
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return Integer.valueOf(jfr.m144703a());
        }
    });

    /* JADX INFO: renamed from: a */
    public static int m144703a() {
        return INSTANCE.m144709g();
    }

    /* JADX INFO: renamed from: b */
    public static LikeMindedConfigData m144704b() {
        return INSTANCE.m144711i();
    }

    @NotNull
    /* JADX INFO: renamed from: c */
    public final LikeMindedConfigData m144705c() {
        return m144713k(test);
    }

    @Nullable
    /* JADX INFO: renamed from: d */
    public final LikeMindedItemStatusData m144706d(@NotNull String type) {
        ...
        type.getClass();
        LikeMindedConfigData likeMindedConfigDataM144705c = m144712j() ? m144705c() : m144708f();
        if (likeMindedConfigDataM144705c != null) {
            if (likeMindedConfigDataM144705c.mcc.containsKey(String.valueOf(uqb0.f180400f0)) && likeMindedConfigDataM144705c.mcc.get(String.valueOf(uqb0.f180400f0)) != null) {
                LikeMindedItemData likeMindedItemData = likeMindedConfigDataM144705c.same.get(type);
                LikeMindedItemStatusData likeMindedItemStatusData = (likeMindedItemData == null || (map2 = likeMindedItemData.multiLanguage) == null || (likeMindedItemLanguagesData2 = map2.get(INSTANCE.m144707e())) == null) ? null : likeMindedItemLanguagesData2.status;
                if (likeMindedItemStatusData != null) {
                    return likeMindedItemStatusData;
                }
                LikeMindedItemData likeMindedItemData2 = likeMindedConfigDataM144705c.same.get(type);
    ...
    public final LikeMindedConfigData m144708f() {
        return (LikeMindedConfigData) likeMindedConfigData.getValue();
    }

    /* JADX INFO: renamed from: g */
    public final int m144709g() {
        LikeMindedMccConfigData likeMindedMccConfigData;
        try {
            LikeMindedConfigData likeMindedConfigDataM144708f = m144708f();
            if (likeMindedConfigDataM144708f == null) {
                return -1;
            }
            String strValueOf = String.valueOf(uqb0.f180400f0);
            if (!likeMindedConfigDataM144708f.mcc.containsKey(strValueOf) || (likeMindedMccConfigData = likeMindedConfigDataM144708f.mcc.get(strValueOf)) == null) {
                return -1;
            }
    ...
    public final int m144710h() {
        return ((Number) swipeCount.getValue()).intValue();
    }

    /* JADX INFO: renamed from: i */
    public final LikeMindedConfigData m144711i() {
        try {
            String strM80485F = RemoteConfig.m80481x().m80485F("intl_same_config");
            strM80485F.getClass();
            return m144713k(strM80485F);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public final LikeMindedConfigData m144713k(String data) throws IOException {
