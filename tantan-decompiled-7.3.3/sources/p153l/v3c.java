...
public class v3c extends zh2 {

    /* JADX INFO: renamed from: d */
    public boolean f182177d = false;
    ...
    public List<LiveMessage> mo100025e(LiveMessage liveMessage, List<LiveMessage> list, pf60<Integer, Integer> pf60Var) {
        ...
        this.f182177d = false;
        if (liveMessage.isDanmuFoldMessage() && !liveMessage.isUserOwnMessage() && pf60Var != null && !jyb.m147479J(list) && !TextUtils.isEmpty(liveMessage.messageContent) && "为主播打call".equals(liveMessage.messageContent)) {
