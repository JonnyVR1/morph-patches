...
public class v9i implements z9i<FeedUserSexAndAgeView> {
    @Override // p153l.z9i
    ...
    public void mo171362a(FeedUserSexAndAgeView feedUserSexAndAgeView, User user) {
        ...
        if (zM159668v) {
            ...
            bnl0.m105550d0(vLinear, qa00.m175859d(5.5f));
            bnl0.m105552e0(feedUserSexAndAgeView.f44277a, qa00.m175859d(7.0f));
        }
    }
}
