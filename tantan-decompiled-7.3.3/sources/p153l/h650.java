...
public final class h650 extends AbstractC18548m5 {
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        return tab0.m189811h().m189835z() && wib0.m206565i(getPurchaseType()) && NullChecker.m82486a(section) && NullChecker.m82486a(section.m54703b()) && section.m54703b().m54784s().yearly();
    }
}
