...
public final class tr5 {
    ...
    public tr5(@NotNull Act act) {
        act.getClass();
        this.act = act;
    }

    /* JADX INFO: renamed from: a */
    public static void m192405a(y20 y20Var, View view) {
        y20Var.call(0);
    }

    @Nullable
    /* JADX INFO: renamed from: b */
    public final View m192406b(@NotNull Act act, @NotNull ViewGroup root) {
        act.getClass();
        root.getClass();
        View viewInflate = LayoutInflater.from(act).inflate(rec0.f162609u, root, false);
    ...
    public final void m192407c(@NotNull Act act) {
        act.getClass();
        m192408d();
    }

    /* JADX INFO: renamed from: d */
    public final void m192408d() {
        VText vText = this._feature_name_text;
        if (vText != null) {
            vText.setText(this.act.getString(R$string.f28252c3));
        }
        VText vText2 = this._promotional_text;
        if (vText2 != null) {
            vText2.setText(this.act.getString(R$string.f28240b3));
        }
    ...
    public final void m192409e(@NotNull final y20<Integer> dismiss) {
        dismiss.getClass();
        bnl0.m105509E0(this._image_close, new View.OnClickListener() { // from class: l.sr5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                tr5.m192405a(dismiss, view);
            }
        });
    }
}
