...
/* JADX INFO: renamed from: l.dy */
/* JADX INFO: loaded from: classes9.dex */
public class C16649dy extends q8g0 {
    /* JADX INFO: renamed from: n0 */
    public static String m118579n0(double d) {
        return new SimpleDateFormat("yyyy-MM-dd", Locale.US).format(new Date((long) d));
    }

    /* JADX INFO: renamed from: o0 */
    public static String m118580o0(String str) {
    ...
    public static String m118581p0(String str) {
        if (str.length() <= 4) {
            return str;
        }
