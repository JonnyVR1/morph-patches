...
public final class pp60 extends AbstractC19757r4 {
    ...
    public pp60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        request.getClass();
        response.getClass();
        response.m131355n("限时优惠");
        if (request.getPurchaseSection().m54714m()) {
            return;
        }
        C8928d.a aVarM179724g = m179724g(request.getPurchaseSection());
        response.m131354m(true);
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        response.m131357p(String.format("%s%s元获取", Arrays.copyOf(new Object[]{aVarM179724g.m54766h(), z7a.m218875r0(aVarM179724g.m54774l())}, 2)));
    }
    ...
    public boolean mo99415e(@NotNull fq60 request) {
        request.getClass();
        return wib0.m206561e(this.purchaseType) || wib0.m206559c(this.purchaseType);
    }
}
