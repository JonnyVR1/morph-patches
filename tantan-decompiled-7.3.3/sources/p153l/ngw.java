...
public class ngw {
    ...
    public static final Pattern f141863a = Pattern.compile("((\\[\\d{2}:\\d{2}\\.\\d{2,3}\\])+)(.+)");

    /* JADX INFO: renamed from: b */
    public static final Pattern f141864b = Pattern.compile("\\[(\\d{2}):(\\d{2})\\.(\\d{2,3})\\]");

    /* JADX INFO: renamed from: a */
    public static List<LrcBean> m163014a(String str) throws NumberFormatException {
        String strGroup;
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        Matcher matcher = f141863a.matcher(str.trim());
        if (!matcher.matches() || (strGroup = matcher.group(1)) == null) {
            return null;
        }
        String strGroup2 = matcher.group(3);
        ArrayList arrayList = new ArrayList();
        Matcher matcher2 = f141864b.matcher(strGroup);
        while (matcher2.find()) {
    ...
    /* JADX INFO: renamed from: b */
    public static LrcWrapperBean m163015b(File file) {
        ...
        try {
            ...
            while (true) {
                ...
                List<LrcBean> listM163014a = m163014a(line);
                if (listM163014a != null && !listM163014a.isEmpty()) {
                    arrayList.addAll(listM163014a);
                }
            }
