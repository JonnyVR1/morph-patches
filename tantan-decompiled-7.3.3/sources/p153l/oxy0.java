...
public final class oxy0 {
    ...
    public static final Pattern f149723a = Pattern.compile("^\\D?(\\d+)$");

    /* JADX INFO: renamed from: b */
    @GuardedBy("MediaCodecUtil.class")
    public static final HashMap f149724b = new HashMap();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:207:0x0366, code lost:
        ...
        p153l.y4w0.m214278f("MediaCodecUtil", "Ignoring malformed HEVC codec string: ".concat(java.lang.String.valueOf(r2)));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:209:0x0372, code lost:
        ...
        r3 = p153l.oxy0.f149723a.matcher(r11[1]);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:308:0x0517, code lost:
        ...
        r2 = 1024;
        p153l.y4w0.m214278f("MediaCodecUtil", "Unknown HEVC level string: ".concat(java.lang.String.valueOf(r0)));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:312:0x052f, code lost:
        ...
        p153l.y4w0.m214278f("MediaCodecUtil", "Unknown HEVC profile string: ".concat(java.lang.String.valueOf(r2)));
     */
    ...
    */
    public static android.util.Pair m169759a(p153l.sqr0 r34) {
        /*
            Method dump skipped, instruction units count: 2172
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: p153l.oxy0.m169759a(l.sqr0):android.util.Pair");
    }

    @Nullable
    /* JADX INFO: renamed from: b */
    public static hwy0 m169760b() throws zzth {
        List listM169763e = m169763e("audio/raw", false, false);
        if (listM169763e.isEmpty()) {
            return null;
        }
        return (hwy0) listM169763e.get(0);
    }

    @Nullable
    /* JADX INFO: renamed from: c */
    public static String m169761c(sqr0 sqr0Var) {
        Pair pairM169759a;
        if ("audio/eac3-joc".equals(sqr0Var.f170251l)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(sqr0Var.f170251l) || (pairM169759a = m169759a(sqr0Var)) == null) {
            return null;
        }
    ...
    public static List m169762d(dxy0 dxy0Var, sqr0 sqr0Var, boolean z, boolean z2) throws zzth {
        String strM169761c = m169761c(sqr0Var);
        return strM169761c == null ? zzgaa.zzl() : m169763e(strM169761c, z, z2);
    }

    /* JADX INFO: renamed from: e */
    public static synchronized List m169763e(String str, boolean z, boolean z2) throws zzth {
        try {
            hxy0 hxy0Var = new hxy0(str, z, z2);
            HashMap map = f149724b;
            List list = (List) map.get(hxy0Var);
            if (list != null) {
                return list;
            }
            int i = mpw0.f137957a;
            ArrayList arrayListM169766h = m169766h(hxy0Var, new mxy0(z, z2));
            if (z && arrayListM169766h.isEmpty() && mpw0.f137957a <= 23) {
                arrayListM169766h = m169766h(hxy0Var, new lxy0(null));
                if (!arrayListM169766h.isEmpty()) {
                    y4w0.m214278f("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((hwy0) arrayListM169766h.get(0)).f111951a);
                }
            }
            if ("audio/raw".equals(str)) {
                if (mpw0.f137957a < 26 && mpw0.f137958b.equals("R9") && arrayListM169766h.size() == 1 && ((hwy0) arrayListM169766h.get(0)).f111951a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                    arrayListM169766h.add(hwy0.m137543c("OMX.google.raw.decoder", "audio/raw", "audio/raw", null, false, true, false, false, false));
                }
                m169767i(arrayListM169766h, new nxy0() { // from class: l.fxy0
                    @Override // p153l.nxy0
                    public final int zza(Object obj) {
                        Pattern pattern = oxy0.f149723a;
                        String str2 = ((hwy0) obj).f111951a;
                        if (str2.startsWith("OMX.google") || str2.startsWith("c2.android")) {
                            return 1;
                        }
                        return (mpw0.f137957a >= 26 || !str2.equals("OMX.MTK.AUDIO.DECODER.RAW")) ? 0 : -1;
                    }
                });
            }
            if (mpw0.f137957a < 32 && arrayListM169766h.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((hwy0) arrayListM169766h.get(0)).f111951a)) {
                arrayListM169766h.add((hwy0) arrayListM169766h.remove(0));
            }
            zzgaa zzgaaVarZzj = zzgaa.zzj(arrayListM169766h);
            map.put(hxy0Var, zzgaaVarZzj);
            return zzgaaVarZzj;
        } catch (Throwable th) {
            throw th;
        }
    ...
    public static List m169764f(dxy0 dxy0Var, sqr0 sqr0Var, boolean z, boolean z2) throws zzth {
        List listM169763e = m169763e(sqr0Var.f170251l, z, z2);
        List listM169762d = m169762d(dxy0Var, sqr0Var, z, z2);
        mqw0 mqw0Var = new mqw0();
        mqw0Var.m159615i(listM169763e);
        mqw0Var.m159615i(listM169762d);
        return mqw0Var.m159616j();
    }

    @CheckResult
    /* JADX INFO: renamed from: g */
    public static List m169765g(List list, final sqr0 sqr0Var) {
        ArrayList arrayList = new ArrayList(list);
        m169767i(arrayList, new nxy0() { // from class: l.gxy0
            @Override // p153l.nxy0
            public final int zza(Object obj) {
                Pattern pattern = oxy0.f149723a;
                return ((hwy0) obj).m137548d(sqr0Var) ? 1 : 0;
            }
        });
        return arrayList;
    }
    ...
    public static ArrayList m169766h(hxy0 hxy0Var, jxy0 jxy0Var) throws zzth {
        int i;
        int i2;
        ...
        boolean zM169768j;
        String strM207228a;
        hxy0 hxy0Var2 = hxy0Var;
        try {
            ArrayList arrayList = new ArrayList();
            String str2 = hxy0Var2.f112083a;
            boolean zZze = jxy0Var.zze();
            int i6 = 0;
            for (int iZza = jxy0Var.zza(); i6 < iZza; iZza = i2) {
                MediaCodecInfo mediaCodecInfoMo147454e = jxy0Var.mo147454e(i6);
                int i7 = mpw0.f137957a;
                if (i7 < 29 || !mediaCodecInfoMo147454e.isAlias()) {
                    int i8 = iZza;
                    String name = mediaCodecInfoMo147454e.getName();
                    if (mediaCodecInfoMo147454e.isEncoder() || (!zZze && name.endsWith(".secure"))) {
                        i = i6;
                        i2 = i8;
                    } else if (i7 < 24 && (("OMX.SEC.aac.dec".equals(name) || "OMX.Exynos.AAC.Decoder".equals(name)) && "samsung".equals(mpw0.f137959c))) {
                        String str3 = mpw0.f137958b;
                        if (str3.startsWith("zeroflte") || str3.startsWith("zerolte") || str3.startsWith("zenlte") || "SC-05G".equals(str3) || "marinelteatt".equals(str3) || "404SC".equals(str3) || "SC-04G".equals(str3) || "SCV31".equals(str3)) {
                            i = i6;
                            i2 = i8;
                        } else if (i7 > 23) {
                            supportedTypes = mediaCodecInfoMo147454e.getSupportedTypes();
                            ...
                            if (str != null) {
                                capabilitiesForType = mediaCodecInfoMo147454e.getCapabilitiesForType(str);
                                zMo147452a = jxy0Var.mo147452a("tunneled-playback", str, capabilitiesForType);
                                zMo147453b = jxy0Var.mo147453b("tunneled-playback", str, capabilitiesForType);
                                if (hxy0Var2.f112085c) {
                                    if (zMo147452a) {
                                        zMo147452a2 = jxy0Var.mo147452a("secure-playback", str, capabilitiesForType);
                                        zMo147453b2 = jxy0Var.mo147453b("secure-playback", str, capabilitiesForType);
                                        zIsVendor = true;
                                        if (hxy0Var2.f112084b) {
                                            if (zMo147452a2) {
                                                zMo147452a2 = true;
                                                i5 = mpw0.f137957a;
                                                if (i5 >= 29) {
                                                    zIsHardwareAccelerated = mediaCodecInfoMo147454e.isHardwareAccelerated();
                                                    i2 = i8;
                                                } else {
                                                    i2 = i8;
                                                    if (m169768j(mediaCodecInfoMo147454e, str2)) {
                                                        zIsHardwareAccelerated = false;
                                                    } else {
                                                        zIsHardwareAccelerated = true;
                                                    }
                                                }
                                                zM169768j = m169768j(mediaCodecInfoMo147454e, str2);
                                                if (i5 >= 29) {
                                                    zIsVendor = mediaCodecInfoMo147454e.isVendor();
                                                } else {
                                                    strM207228a = wnw0.m207228a(mediaCodecInfoMo147454e.getName());
                                                    if (strM207228a.startsWith("omx.google.")) {
                                                        zIsVendor = false;
                                                    } else {
                                                        zIsVendor = false;
                                                    }
                                                ...
                                                if (zZze) {
                                                    if (!zZze) {
                                                        if (!hxy0Var2.f112084b) {
                                                            ...
                                                            i = i9;
                                                            i4 = 23;
                                                            arrayList.add(hwy0.m137543c(name, str2, str, capabilitiesForType, zIsHardwareAccelerated, zM169768j, zIsVendor, false, false));
                                                        }
                                                    }
                                                    int i10 = i6;
                                                    str = str;
                                            ...
                                            if (!zMo147453b2) {
                                                ...
                                                try {
                                                    ...
                                                    if (i5 >= 29) {
                                                        ...
                                                        strM207228a = wnw0.m207228a(mediaCodecInfoMo147454e.getName());
                                                        if (strM207228a.startsWith("omx.google.") || strM207228a.startsWith("c2.android.") || strM207228a.startsWith("c2.google.")) {
                                                            zIsVendor = false;
                                                        }
                                                    }
                                                    if (zZze || hxy0Var2.f112084b != zMo147452a2) {
                                                        if (!zZze) {
                                                            try {
                                                                if (!hxy0Var2.f112084b) {
                                                                    int i11111 = i6;
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        y4w0.m214275c("MediaCodecUtil", "Failed to query codec " + name + " (" + str + ")");
                                                                        throw e;
                                                                    }
                                                                }
                                                            } catch (Exception e2) {
                                                        ...
                                                        i4 = 23;
                                                        boolean z111110 = zMo147452a2;
                                                        boolean z111111 = zIsHardwareAccelerated;
                                                        if (zZze && z111110) {
                                                            name = name;
                                                            try {
                                                                arrayList.add(hwy0.m137543c(name + ".secure", str2, str, capabilitiesForType, z111111, zM169768j, z11119, false, true));
                                                                break;
                                                            } catch (Exception e3) {
                                                                e = e3;
                                                                if (mpw0.f137957a <= i4 || arrayList.isEmpty()) {
                                                                    y4w0.m214275c("MediaCodecUtil", "Failed to query codec " + name + " (" + str + ")");
                                                                    throw e;
                                                                }
                                                                y4w0.m214275c("MediaCodecUtil", "Skipping codec " + name + " (failed to query capabilities)");
                                                                i6 = i + 1;
                                                                hxy0Var2 = hxy0Var;
                                                            }
                                                        }
    ...
    public static void m169767i(List list, final nxy0 nxy0Var) {
        Collections.sort(list, new Comparator() { // from class: l.exy0
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                Pattern pattern = oxy0.f149723a;
                nxy0 nxy0Var2 = nxy0Var;
                return nxy0Var2.zza(obj2) - nxy0Var2.zza(obj);
            }
        });
    }

    /* JADX INFO: renamed from: j */
    public static boolean m169768j(MediaCodecInfo mediaCodecInfo, String str) {
        if (mpw0.f137957a >= 29) {
        ...
        String strM207228a = wnw0.m207228a(mediaCodecInfo.getName());
        if (strM207228a.startsWith("arc.")) {
            return false;
        }
        if (strM207228a.startsWith("omx.google.") || strM207228a.startsWith("omx.ffmpeg.") || ((strM207228a.startsWith("omx.sec.") && strM207228a.contains(".sw.")) || strM207228a.equals("omx.qcom.video.decoder.hevcswvdec") || strM207228a.startsWith("c2.android.") || strM207228a.startsWith("c2.google."))) {
            return true;
        }
        return (strM207228a.startsWith("omx.") || strM207228a.startsWith("c2.")) ? false : true;
    }
}
