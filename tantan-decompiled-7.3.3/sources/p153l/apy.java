...
public final class apy extends kg2 {
    ...
    public void mo99381B() {
        super.mo99381B();
        m149719h0("p_buzz_memoji_connecting");
    }
    ...
    public void mo99384f0() {
        super.mo99384f0();
        m149719h0("p_intl_buzz_memoji_waiting");
    }
    ...
    public void mo99385j0(@NotNull pf60<String, Object> pair, boolean bundle) {
        ...
        if (loveBuzzDataM134315v0 == null || (i = loveBuzzDataM134315v0.remainingMemojiBuzz) == getNOT_LIMIT_VALUE()) {
            return;
        }
        loveBuzzDataM134315v0.remainingMemojiBuzz = C15274a.m88486b(i - 1, 0);
    ...
    public void mo99386q() {
        super.mo99386q();
        m149719h0("p_buzz_memoji_searching");
    }
    ...
    public void mo99387r() {
        ...
        m149712Y().getHierarchy().m207042E(null);
        m149712Y().getHierarchy().m207045H(null);
        ViewGroup.LayoutParams layoutParams = m149712Y().getLayoutParams();
        int iM175859d = qa00.m175859d(140.0f);
        layoutParams.width = iM175859d;
        layoutParams.height = iM175859d;
        m149712Y().setLayoutParams(layoutParams);
        if (!m149730z("memojiBuzz")) {
            m149719h0("p_buzz_memoji_searching");
            return;
        }
        haw.Companion companion = haw.INSTANCE;
    ...
    public void mo99388v() {
        super.mo99388v();
        m149719h0("p_intl_buzz_memoji_paired");
        nbw.INSTANCE.m162250o("memojiBuzz");
    }
}
