...
public final class w0e0 implements k5m {
    ...
    public FrameLayout.LayoutParams mo148411a(int layoutWidth, int layoutHeight, int videoWidth, int videoHeight, @NotNull FrameLayout.LayoutParams layoutParams) {
        ...
        Pair<Integer, Integer> pairM204142b = m204142b(layoutWidth, layoutHeight, videoWidth, videoHeight);
        int iIntValue = pairM204142b.component1().intValue();
        int iIntValue2 = pairM204142b.component2().intValue();
    ...
    public final Pair<Integer, Integer> m204142b(int layoutWidth, int layoutHeight, int videoWidth, int videoHeight) {
        float f = layoutWidth;
