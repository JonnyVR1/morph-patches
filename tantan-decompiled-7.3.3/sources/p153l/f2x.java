...
public class f2x {
    ...
    public static String m123681a(User user) {
        String str;
        String strMo180499m;
        String str2;
        String str3;
        ...
        if (jyb.m147479J(list)) {
            ...
            str = list.get(0);
            if (TextUtils.isEmpty(str) || TextUtils.equals(str, CoreModule.f18263b.getString(R$string.f28732l2))) {
                str = "xx";
            }
        }
        ...
        if (jyb.m147479J(list3) && jyb.m147479J(list2)) {
            ...
            strMo180499m = CoreModule.m30933P().m143405a().mo180499m(list2, list3);
            if (TextUtils.isEmpty(strMo180499m) || TextUtils.equals(strMo180499m, CoreModule.f18263b.getString(R$string.f28732l2))) {
                strMo180499m = "xx";
            }
        }
        String strM123682b = m123682b(user);
        String strM123683c = m123683c(user);
        ...
        if (profile == null || (extensions = profile.extensions) == null || (profileExtensionBasic = extensions.basic) == null || jyb.m147479J(profileExtensionBasic.qualification)) {
            str2 = "xx";
        } else {
        ...
        if (iNextInt == 0) {
            ...
            if (!TextUtils.equals(strMo180499m, "xx")) {
                sb.append("年收入");
                sb.append(strMo180499m);
                sb.append("、");
            }
            if (!TextUtils.equals(strM123682b, "xx")) {
                sb.append("做");
                sb.append(strM123682b);
                sb.append("工作，");
            }
            if (!TextUtils.equals(strM123683c, "xx")) {
                sb.append(strM123683c);
                sb.append("、");
            }
    ...
    public static String m123682b(User user) {
        Profile profile = user.profile;
    ...
    public static String m123683c(User user) {
        return !TEnum.equals(user.profile.zodiac, ProfileZodiac.get("unknown_")) ? q8g0.m175804j0(user.profile.zodiac) : "xx";
    }

    /* JADX INFO: renamed from: d */
    public static boolean m123684d(String str) {
        return (TextUtils.isEmpty(str) || TextUtils.equals(str, CoreModule.f18263b.getString(R$string.f28732l2)) || TextUtils.equals(str, "不限") || TextUtils.equals(str, "暂无")) ? false : true;
    }
}
