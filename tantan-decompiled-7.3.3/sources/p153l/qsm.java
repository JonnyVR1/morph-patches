...
@Metadata(m88120d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u001f\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\bH\u0017¢\u0006\u0004\b\u000b\u0010\fJ\u001f\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u000e\u001a\u00020\rH\u0017¢\u0006\u0004\b\u000b\u0010\u000fR\"\u0010\u0012\u001a\u0010\u0012\f\u0012\n \u0011*\u0004\u0018\u00010\u00020\u00020\u00108\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013¨\u0006\u0014"}, m88121d2 = {"Ll/qsm;", "Landroid/webkit/WebViewClient;", "Lcom/clevertap/android/sdk/inapp/fragment/CTInAppBaseFragment;", "fragment", "<init>", "(Lcom/clevertap/android/sdk/inapp/fragment/CTInAppBaseFragment;)V", "Landroid/webkit/WebView;", OMSTemplateModeType.view, "", "url", "", "shouldOverrideUrlLoading", "(Landroid/webkit/WebView;Ljava/lang/String;)Z", "Landroid/webkit/WebResourceRequest;", SocialConstants.TYPE_REQUEST, "(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;)Z", "Ljava/lang/ref/WeakReference;", "kotlin.jvm.PlatformType", "fragmentWr", "Ljava/lang/ref/WeakReference;", "clevertap-core_release"}, m88122k = 1, m88123mv = {2, 0, 0}, m88125xi = 48)
public final class qsm extends WebViewClient {

    @NotNull
    private final WeakReference<CTInAppBaseFragment> fragmentWr;

    public qsm(@NotNull CTInAppBaseFragment cTInAppBaseFragment) {
    ...
    public boolean shouldOverrideUrlLoading(@NotNull WebView view, @NotNull WebResourceRequest request) throws UnsupportedEncodingException {
        ...
        if (url == null || (string = url.toString()) == null) {
            Logger.m5927v("InAppWebViewClient : Url to open is null; not processing");
            return true;
        }
        CTInAppBaseFragment cTInAppBaseFragment = this.fragmentWr.get();
        if (cTInAppBaseFragment != null) {
            cTInAppBaseFragment.m6453l4(string);
            return true;
        }
        Logger.m5927v("InAppWebViewClient : Android view is gone, not opening url");
        return true;
    }
    ...
    public boolean shouldOverrideUrlLoading(@NotNull WebView view, @NotNull String url) throws UnsupportedEncodingException {
        ...
        CTInAppBaseFragment cTInAppBaseFragment = this.fragmentWr.get();
        if (cTInAppBaseFragment != null) {
            cTInAppBaseFragment.m6453l4(url);
            return true;
        }
        Logger.m5927v("InAppWebViewClient : Android view is gone, not opening url");
        return true;
