...
public final class kd0 implements tol {
    ...
    public boolean mo115314b(@NotNull bd0 requestData) {
        requestData.getClass();
        return (wib0.m206572p(this.purchaseType) || wib0.m206566j(this.purchaseType)) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
