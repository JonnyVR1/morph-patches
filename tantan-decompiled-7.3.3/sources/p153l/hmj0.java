...
public class hmj0 {
    ...
    public static <T> Spannable m135865a(Context context, int i, CharSequence... charSequenceArr) {
    ...
    public static boolean m135866b(CharSequence charSequence) {
        return !TextUtils.isEmpty(charSequence);
    }

    /* JADX INFO: renamed from: c */
    public static Spannable m135867c(String str) {
    ...
    public static <T> CharSequence m135868d(List<CharSequence> list, String str) {
        if (list == null) {
            return null;
        }
    ...
    public static String m135869e(String str) {
        return str != null ? Pattern.compile("\r|\n").matcher(str).replaceAll("") : "";
    }

    /* JADX INFO: renamed from: f */
    public static Spannable m135870f(String str, String str2, CharacterStyle characterStyle) {
        SpannableString spannableString = new SpannableString(str);
    ...
    public static String m135871g(long j) {
        long j2 = j / 1000;
        long j3 = j2 / 60;
