...
public abstract class s2j<K, V> extends v2j implements Map<K, V> {
    public void clear() {
        delegate().clear();
    }
    ...
    public boolean standardContainsKey(Object obj) {
        return Maps.m16086g(this, obj);
    }

    public boolean standardContainsValue(Object obj) {
        return Maps.m16087h(this, obj);
    }
    ...
    public V standardRemove(Object obj) {
        ...
        while (it.hasNext()) {
            ...
            if (k950.m148863a(next.getKey(), obj)) {
