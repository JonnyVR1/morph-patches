...
public class vs9 extends q8g0 {
    /* JADX INFO: renamed from: N */
    public static SpannableStringBuilder m202574N(String str, int i, Typeface typeface) {
        return m202575O(str, i, typeface, 0);
    }

    /* JADX INFO: renamed from: O */
    public static SpannableStringBuilder m202575O(String str, int i, Typeface typeface, int i2) {
