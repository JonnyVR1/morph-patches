...
public class hjm {
    ...
    public hjm(@NotNull ImageRenderingInfra imageRenderingInfra) {
    ...
    public final List<Pair<String, Long>> m135367k() {
    ...
    public final void m135376t(@Nullable Long l2) {
        this.emptyEventTimestampNs = l2;
    }

    /* JADX INFO: renamed from: u */
    public final void m135377u(boolean z) {
        this.newIntermediateImageSetPointAvailable = z;
    }

    /* JADX INFO: renamed from: v */
    public final void m135378v(@Nullable Long l2) {
