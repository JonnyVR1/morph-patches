...
public class ixi extends mq2<LongLinkLiveMessage.LiveTemplateMsg> {
    public ixi(zod zodVar) {
        super(zodVar);
    }

    @Override // p153l.mq2
    /* JADX INFO: renamed from: A, reason: merged with bridge method [inline-methods] */
    public LiveControlMessage mo95513w(String str, LongLinkLiveMessage.LiveTemplateMsg liveTemplateMsg, String str2) {
