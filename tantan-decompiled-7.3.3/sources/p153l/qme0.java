...
public final class qme0 extends AbstractC18548m5 {
    ...
    public boolean mo97946a(@NotNull C8928d section, @Nullable AgreementComponent.AgreementState agreementState, @Nullable PayMethod currentPayMethod) {
        section.getClass();
        if (!wib0.m206573q(getPurchaseType()) || !TEnum.equals(currentPayMethod, "alipay")) {
            return false;
        }
        if (NullChecker.m82486a(section.m54703b()) && section.m54714m() && section.m54703b().m54784s().quarterly()) {
            return true;
        }
