...
public class bf5 extends jt2 {

    /* JADX INFO: renamed from: a */
    final String f76449a = BigEyeFilter.UNIFORM_TEXTURE_SIZE;

    /* JADX INFO: renamed from: b */
    final String f76450b = BigEyeFilter.UNIFORM_SCALE;

    /* JADX INFO: renamed from: c */
    final String f76451c = "angles";

    /* JADX INFO: renamed from: d */
    final String f76452d = "singleAngleMode";

    /* JADX INFO: renamed from: e */
    private float f76453e = 20.0f;

    /* JADX INFO: renamed from: f */
    private float[] f76454f = {0.7853982f, 0.7853982f, 0.7853982f, 0.0f};
    ...
    public void initShaderHandles() {
        ...
        this.f76455g = GLES20.glGetUniformLocation(this.programHandle, BigEyeFilter.UNIFORM_TEXTURE_SIZE);
        this.f76456i = GLES20.glGetUniformLocation(this.programHandle, BigEyeFilter.UNIFORM_SCALE);
        this.f76457j = GLES20.glGetUniformLocation(this.programHandle, "angles");
        this.f76458k = GLES20.glGetUniformLocation(this.programHandle, "singleAngleMode");
    }
    ...
    public void passShaderValues() {
        ...
        GLES20.glUniform2f(this.f76455g, getWidth(), getHeight());
        GLES20.glUniform1f(this.f76456i, this.f76453e);
        float[] fArr = this.f76454f;
        if (fArr.length > 0) {
            float f = fArr[0];
            float f2 = fArr[1];
            if (f == f2 && f2 == fArr[2]) {
                GLES20.glUniform1i(this.f76458k, 1);
            } else {
                GLES20.glUniform1i(this.f76458k, 0);
            }
        } else {
            GLES20.glUniform1i(this.f76458k, 0);
        }
        int i = this.f76457j;
        float[] fArr2 = this.f76454f;
