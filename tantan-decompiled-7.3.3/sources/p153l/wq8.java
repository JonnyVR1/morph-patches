...
public class wq8 implements ktl {
    @Override // p153l.ktl
    /* JADX INFO: renamed from: a */
    public HashMap<String, Object> mo151359a(VerificationToken verificationToken) {
        ...
        if (!verificationToken.isALiProvider()) {
            if (verificationToken.isTencentProvider()) {
                ...
                map.put("uiType", 1);
                map.toString();
                map.put("option-key-language", m207500b());
                return map;
            }
    ...
    public final String m207500b() {
        String script = CoreModule.f18263b.getResources().getConfiguration().locale.getScript();
        String language = CoreModule.f18263b.getResources().getConfiguration().locale.getLanguage();
        language.getClass();
        switch (language) {
            case "in":
