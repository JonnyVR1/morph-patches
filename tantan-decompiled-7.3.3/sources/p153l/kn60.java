...
public final class kn60 implements j2m {
    ...
    public kn60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str, @Nullable ndb0 ndb0Var) {
        act.getClass();
    ...
    public boolean mo117054a(@NotNull jn60 paymentHandlerData, @NotNull AbstractC18347l5 paymentComponent) {
        ...
        paymentComponent.m152853D(paymentHandlerData.getCurrentPayMethod());
        return true;
    }
}
