...
public class kvi0 extends c4k0 {
    @Override // p153l.c4k0
    /* JADX INFO: renamed from: c */
    public boolean mo106291c(OMSAction oMSAction) {
        Act act = this.f79710a.f55069a;
        act.startActivity(ProfileAct.m51922q2(act, CoreModule.m30929H().userId(), CoreStaticData.ProfileFromType.FROM_THIN_POPUP, false, true));
        m107886b();
        return true;
    }
