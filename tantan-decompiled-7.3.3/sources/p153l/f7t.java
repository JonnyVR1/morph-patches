...
import com.p051p1.mobile.putong.live.base.data.BLiveChatShadingConfig;
...
import com.p051p1.mobile.putong.live.base.data.BLiveOperationActionAfterClick;
...
import com.p051p1.mobile.putong.live.base.data.BLiveVoiceSing;
...
public class f7t {
    ...
    public static LiveMessage.ExtInfo m124479A(Template.TemplateData templateData, BLiveTemplate bLiveTemplate) {
        LiveMessage.ExtInfo extInfo = new LiveMessage.ExtInfo();
        m124486f(templateData, bLiveTemplate, extInfo);
        m124487g(templateData, bLiveTemplate, extInfo);
        m124489i(templateData, bLiveTemplate, extInfo);
        m124488h(templateData, bLiveTemplate, extInfo);
        return extInfo;
    }

    /* JADX INFO: renamed from: B */
    public static int m124480B(BLiveTemplate bLiveTemplate, final String str) {
        BLiveTemplateItem bLiveTemplateItem;
        int i;
        if (bLiveTemplate == null || (bLiveTemplateItem = (BLiveTemplateItem) jyb.m147529r(bLiveTemplate.format, new qcj() { // from class: l.c7t
            @Override // p153l.qcj
    ...
    /* JADX INFO: renamed from: a */
    public static /* synthetic */ BLiveDynamicEffectExtend m124481a(LongLinkGiftMessage.DynamicEffectExtend dynamicEffectExtend) {
    ...
    public static void m124486f(Template.TemplateData templateData, BLiveTemplate bLiveTemplate, LiveMessage.ExtInfo extInfo) {
        int iM124480B = m124480B(bLiveTemplate, "atUserId");
        if (iM124480B != -1) {
            BLiveAtUserInfo bLiveAtUserInfoNew_ = BLiveAtUserInfo.new_();
            bLiveAtUserInfoNew_.userId = templateData.getFields(iM124480B);
            extInfo.atUserInfo = bLiveAtUserInfoNew_;
        }
    }

    /* JADX INFO: renamed from: g */
    public static void m124487g(Template.TemplateData templateData, BLiveTemplate bLiveTemplate, LiveMessage.ExtInfo extInfo) {
        int iM124480B = m124480B(bLiveTemplate, "buttonUserId");
        if (iM124480B == -1 || templateData.getFieldsCount() <= iM124480B) {
            return;
        }
        BLiveAtUserInfo bLiveAtUserInfoNew_ = BLiveAtUserInfo.new_();
        bLiveAtUserInfoNew_.userId = templateData.getFields(iM124480B);
    ...
    public static void m124488h(Template.TemplateData templateData, BLiveTemplate bLiveTemplate, LiveMessage.ExtInfo extInfo) {
        int iM124480B = m124480B(bLiveTemplate, "buttonSchema");
        if (iM124480B != -1) {
            extInfo.buttonSchema = templateData.getFields(iM124480B);
        }
    }

    /* JADX INFO: renamed from: i */
    public static void m124489i(Template.TemplateData templateData, BLiveTemplate bLiveTemplate, LiveMessage.ExtInfo extInfo) {
        int iM124480B = m124480B(bLiveTemplate, "profileUserId");
        if (iM124480B != -1) {
            BLiveAtUserInfo bLiveAtUserInfoNew_ = BLiveAtUserInfo.new_();
            bLiveAtUserInfoNew_.userId = templateData.getFields(iM124480B);
            extInfo.atUserInfo = bLiveAtUserInfoNew_;
    ...
    public static LongLinkChatMessage.LiveBackgroundColorConfig m124490j(BLiveChatShadingConfig bLiveChatShadingConfig, boolean z) {
    ...
    public static LongLinkChatMessage.LiveChatShadingConfig m124491k(BLiveChatShadingConfig bLiveChatShadingConfig) {
        ...
        if (bLiveChatShadingConfig.hasChatShadingConfig()) {
            builderNewBuilder.setBackgroundColorConfig(m124490j(bLiveChatShadingConfig, true));
        }
        if (bLiveChatShadingConfig.hasBorderConfig()) {
            builderNewBuilder.setBorderColorConfig(m124490j(bLiveChatShadingConfig, false));
        }
        if (bLiveChatShadingConfig.hasCornerConfig()) {
            builderNewBuilder.setCornerConfig(m124492l(bLiveChatShadingConfig));
        }
        return builderNewBuilder.build();
    }

    /* JADX INFO: renamed from: l */
    public static LongLinkChatMessage.LiveCornerConfig m124492l(BLiveChatShadingConfig bLiveChatShadingConfig) {
    ...
    public static LongLinkChatMessage.MedalMessage m124493m(BLiveChatMessage bLiveChatMessage) {
        List<LongLinkChatMessage.Medal> listM124506z = m124506z(bLiveChatMessage.medal.singleRoomMedals);
        return LongLinkChatMessage.MedalMessage.newBuilder().setVersion(bLiveChatMessage.medal.version).addAllIds(bLiveChatMessage.medal.getAllId()).addAllSingleRoomMedals(listM124506z).addAllMultiRoomMedals(m124506z(bLiveChatMessage.medal.multiRoomMedals)).build();
    }

    @SuppressLint({"WrongConstant"})
    /* JADX INFO: renamed from: n */
    public static BLiveVoiceSingTogether m124494n(voiceSingTogether.VoiceSing voiceSing) {
        BLiveVoiceSingTogether bLiveVoiceSingTogetherNew_ = BLiveVoiceSingTogether.new_();
        bLiveVoiceSingTogetherNew_.f45358id = voiceSing.getId();
        if (voiceSing.getCurrentSing() != null) {
            bLiveVoiceSingTogetherNew_.currentSing = m124496p(voiceSing.getCurrentSing());
        }
        if (voiceSing.getNextSing() != null) {
            ...
            bLiveVoiceSingNew_.mask = f3t.m123802c(nextSing.getMask());
    ...
    public static BLiveCallEffectConfig m124495o(liveRight.AcquireUserLiveRightMsg acquireUserLiveRightMsg) {
    ...
    public static BLiveVoiceSing m124496p(voiceSingTogether.CurrentSing currentSing) {
        BLiveVoiceSing bLiveVoiceSingNew_ = BLiveVoiceSing.new_();
        bLiveVoiceSingNew_.userId = currentSing.getUserId();
        bLiveVoiceSingNew_.mask = v6o0.m200134a(currentSing.getMask());
    ...
    public static x8p0 m124497q(liveRight.AcquireUserLiveRightMsg acquireUserLiveRightMsg) {
        ...
        x8p0 x8p0Var = new x8p0(acquireUserLiveRightMsg.getAction() == liveRight.AcquireUserLiveRightMsg.AcquireUserLiveRightAction.unequip ? 1 : 0, userId, bLiveAvatarFrameConfigNew_);
        x8p0Var.m209751b(m124495o(acquireUserLiveRightMsg));
        x8p0Var.f192864e = userLiveRight.getRightType().name();
        return x8p0Var;
    }

    /* JADX INFO: renamed from: r */
    public static BLiveGivenGiftBrief m124498r(LongLinkGiftMessage.LiveGiftReceivedMsg liveGiftReceivedMsg, String str) {
        ...
        bLiveGivenGiftBrief.f45233id = (int) giftItemBrief.getId();
        ...
        bLiveGivenGiftBrief.sendGiftExtraInfo = new ine0(liveGiftReceivedMsg.getUserId(), liveGiftReceivedMsg.getAnchorId(), liveGiftReceivedMsg.getAnchorUserName(), str);
        ...
        if (!jyb.m147479J(coordinatesList)) {
            ...
            for (LongLinkGiftMessage.LiveCoordinate liveCoordinate : coordinatesList) {
                ...
                bLivePosition.f45278x = (int) liveCoordinate.getX();
                bLivePosition.f45279y = (int) liveCoordinate.getY();
        ...
        bLiveGivenGiftBrief.liveUserMask = f3t.m123801b(extraInfo.getUserMask());
        List<LongLinkGiftMessage.VideoEffectExtra> arrayList = jyb.m147479J(giftItemBrief.getExtraInfo().getVideoEffectExtrasList()) ? new ArrayList<>() : giftItemBrief.getExtraInfo().getVideoEffectExtrasList();
        ...
        if (extraInfo.hasPreviewMask() && extraInfo.getPreviewMask().isInitialized()) {
            bLiveGivenGiftBrief.previewUserMask = f3t.m123801b(extraInfo.getPreviewMask());
        }
        if (extraInfo.hasSenderShowMask() && extraInfo.getSenderShowMask().isInitialized()) {
            bLiveGivenGiftBrief.senderShowMask = f3t.m123801b(extraInfo.getSenderShowMask());
        }
        if (extraInfo.hasReceiverShowMask() && extraInfo.getReceiverShowMask().isInitialized()) {
            bLiveGivenGiftBrief.receiverShowMask = f3t.m123801b(extraInfo.getReceiverShowMask());
        }
        return bLiveGivenGiftBrief;
    }

    /* JADX INFO: renamed from: s */
    public static BLiveEnterRoom m124499s(LongLinkEnterRoomMessage.UserEnterRoomEffect userEnterRoomEffect) {
        ...
        bLiveEnterRoomNew_.contentText = m124503w(userEnterRoomEffect.getText(), userEnterRoomEffect.getInternalText());
        ...
        List<LongLinkEnterRoomMessage.VideoEffectExtra> arrayList = jyb.m147479J(userEnterRoomEffect.getVideoEffectExtrasList()) ? new ArrayList<>() : userEnterRoomEffect.getVideoEffectExtrasList();
        ArrayList arrayList2 = new ArrayList();
        for (LongLinkEnterRoomMessage.VideoEffectExtra videoEffectExtra : arrayList) {
            arrayList2.add(new BLiveSpecialEffectResources(videoEffectExtra.getId(), (int) videoEffectExtra.getType(), videoEffectExtra.getValue()));
        }
        bLiveEnterRoomNew_.videoEffectExtras = arrayList2;
        bLiveEnterRoomNew_.dynamicEffectExtends = jyb.m147486Q(userEnterRoomEffect.getDynamicEffectExtendsList(), new qcj() { // from class: l.d7t
            @Override // p153l.qcj
            public final Object call(Object obj) {
                return f7t.m124481a((LongLinkGiftMessage.DynamicEffectExtend) obj);
            }
        });
    ...
    public static BLiveOperationItem m124500t(LongLinkSocketMessage.OperationPopupNotice operationPopupNotice) {
        ...
        if (NullChecker.m82486a(operationPopupNotice.getTextDrawer())) {
        ...
        if (NullChecker.m82486a(operationPopupNotice.getH5PopUp())) {
        ...
        if (NullChecker.m82486a(operationPopupNotice.getDrawer())) {
            ...
            if (NullChecker.m82486a(operationPopupNotice.getDrawer().getLoading())) {
    ...
    public static BLiveUserUpgrade m124501u(LongLinkLiveUserLevel.UserHierarchyGrade userHierarchyGrade) {
    ...
    public static LiveUserInfo m124502v(LongLinkChatMessage.LiveChatMessage liveChatMessage) {
        ...
        LiveUserInfo liveUserInfo = new LiveUserInfo(liveChatMessage.getUserId(), liveChatMessage.getUsername(), v6o0.m200134a(extInfo.getUserMask()));
        liveUserInfo.isMaskMode = extInfo.getMaskMode();
        return liveUserInfo;
    }

    /* JADX INFO: renamed from: w */
    public static String m124503w(String str, String str2) {
        return TextUtils.isEmpty(str2) ? str : cpj.m111768D(str2);
    }

    /* JADX INFO: renamed from: x */
    public static String m124504x(BLiveTemplate bLiveTemplate) {
        BLiveTemplateItem bLiveTemplateItem;
        return (bLiveTemplate == null || (bLiveTemplateItem = (BLiveTemplateItem) jyb.m147529r(bLiveTemplate.format, new qcj() { // from class: l.a7t
            @Override // p153l.qcj
            public final Object call(Object obj) {
    ...
    public static LongLinkChatMessage.LiveChatMessage m124505y(BLiveChatMessage bLiveChatMessage, boolean z) {
        LongLinkChatMessage.LiveChatMessage.Builder chatShadingConfig = LongLinkChatMessage.LiveChatMessage.newBuilder().setRoomId(bLiveChatMessage.roomId).setSeq(bLiveChatMessage.seq).setUserId(bLiveChatMessage.userId).setUsername(bLiveChatMessage.username).setValue(bLiveChatMessage.value).setPreSeq(bLiveChatMessage.preSeq).setCreatedTime(bLiveChatMessage.createdTime).setPreTimestamp(bLiveChatMessage.preTimestamp).setTypeValue(Integer.parseInt(bLiveChatMessage.type)).setUserIdentity(bLiveChatMessage.userIdentity).setSharedVoiceLiveInfo(LongLinkChatMessage.SharedVoiceLiveInfo.newBuilder().setAudienceCount(bLiveChatMessage.sharedVoiceLiveInfo.audienceCount).setDescription(bLiveChatMessage.sharedVoiceLiveInfo.description).setLiveId(bLiveChatMessage.sharedVoiceLiveInfo.liveId).setRoomId(bLiveChatMessage.sharedVoiceLiveInfo.roomId).setAnchorId(bLiveChatMessage.sharedVoiceLiveInfo.anchorId).setVoiceCallCount(bLiveChatMessage.sharedVoiceLiveInfo.voiceCallCount)).setGift(LongLinkChatMessage.GiftMessage.newBuilder().setId(bLiveChatMessage.gift.f45227id).setUrl(bLiveChatMessage.gift.url).setType(String.valueOf(bLiveChatMessage.gift.type)).setCount(bLiveChatMessage.gift.count).setName(bLiveChatMessage.gift.name)).setH5(bLiveChatMessage.f45197h5).setTemplate(Template.TemplateData.newBuilder().setId(bLiveChatMessage.template.f45306id).addAllFields(bLiveChatMessage.template.fields)).setMedal(m124493m(bLiveChatMessage)).setHierarchy(LongLinkChatMessage.HierarchyMessage.newBuilder().setGrade(bLiveChatMessage.hierarchy.grade).build()).setChatShadingConfig(m124491k(bLiveChatMessage.chatShadingConfig));
        ...
        if (!jyb.m147479J(bLiveUserMask.userNameGradientColors)) {
        ...
        if (!jyb.m147479J(bLiveChatMessage.extInfo.atUserInfos)) {
            jyb.m147537z(bLiveChatMessage.extInfo.atUserInfos, new y20() { // from class: l.b7t
                @Override // p153l.y20
