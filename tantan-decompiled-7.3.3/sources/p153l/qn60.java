...
public final class qn60 implements j2m {
    ...
    public qn60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str, @Nullable ndb0 ndb0Var) {
        act.getClass();
    ...
    public boolean mo117054a(@NotNull jn60 paymentHandlerData, @NotNull AbstractC18347l5 paymentComponent) {
        ...
        if ((!wib0.m206579w(this.purchaseType) && !wib0.m206573q(this.purchaseType)) || !TextUtils.equals(this.from, cok0.f82895a) || !paymentHandlerData.getCurrentPurchaseSection().m54714m() || !v5b0.m199796v(this.purchaseType.productCategory().toString(), paymentHandlerData.getCurrentPurchaseSection().m54703b().m54784s())) {
            return false;
        }
        ou80.m169253h0(this.act, null, du80.m118106g().m118111d(true), "p_promotion,callback_privilege_button", null);
        return true;
    }
}
