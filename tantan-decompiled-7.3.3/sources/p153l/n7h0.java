...
public interface n7h0 extends Closeable {
    ...
    Cursor mo3898c0(@NotNull q7h0 query, @Nullable CancellationSignal cancellationSignal);
    ...
    int mo3899f(@NotNull String table, @Nullable String whereClause, @Nullable Object[] whereArgs);
