...
public final class jd0 implements tol {
    ...
    public CharSequence mo115313a(@NotNull bd0 requestData) {
        ...
        if (requestData.getPrivilegeStyle()) {
            CharSequence charSequenceM105320C = bn60.m105320C(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), bn60.m105335R(true));
            charSequenceM105320C.getClass();
            return charSequenceM105320C;
        }
        CharSequence charSequenceM105320C2 = bn60.m105320C(requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String(), bn60.m105335R(false));
        charSequenceM105320C2.getClass();
        return charSequenceM105320C2;
    }
    ...
    public boolean mo115314b(@NotNull bd0 requestData) {
        requestData.getClass();
        return wib0.m206571o(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
