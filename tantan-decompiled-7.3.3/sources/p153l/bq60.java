...
public final class bq60 extends AbstractC19757r4 {
    ...
    public bq60(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        super(str);
        act.getClass();
    ...
    private final String m105875h(fq60 request) {
        C8928d.a aVarM179724g = m179724g(request.getPurchaseSection());
        Merchandise merchandiseM54784s = aVarM179724g.m54784s();
        if (TEnum.equals(merchandiseM54784s.category, "oDiamond") || TEnum.equals(merchandiseM54784s.category, "platinum") || TEnum.equals(merchandiseM54784s.category, ProductCategory.oDiamondPrivateCustom) || TEnum.equals(merchandiseM54784s.category, "privateCustom") || pta.m173729v(aVarM179724g)) {
            return "";
        }
        ...
        double dM105876i = (TEnum.equals(merchandiseM54784s.category, "femaleVip") || TEnum.equals(merchandiseM54784s.category, "youthVip")) ? m105876i(merchandiseM54784s, firstCouponPrice, aVarM179724g) : Math.abs((aVarM179724g.m54758d() * ((double) merchandiseM54784s.quantity)) - firstCouponPrice);
        String str = aVarM179724g.m54766h() + getNumberFormat().format(dM105876i);
    ...
    private final double m105876i(Merchandise merchandise, double price, C8928d.a detail) {
    ...
    public void mo99414b(@NotNull fq60 request, @NotNull gq60 response) {
        ...
        if (!TextUtils.equals(getFrom(), "purchasePage")) {
            ...
            if (request.getPurchaseSection().m54715n()) {
                StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
                strString = String.format("确认协议并支付%s%s", Arrays.copyOf(new Object[]{aVarM179724g.m54766h(), str}, 2));
            } else {
                StringCompanionObject stringCompanionObject2 = StringCompanionObject.INSTANCE;
                strString = String.format(Locale.CHINESE, "%s%s %s", Arrays.copyOf(new Object[]{aVarM179724g.m54766h(), str, this.act.string(R$string.f28236b)}, 3));
            }
        ...
        } else if (request.getPurchaseSection().m54715n()) {
            strString = "确认协议并支付";
        } else {
            strString = this.act.string(R$string.f28236b);
            strString.getClass();
        }
        response.m131357p(strString);
        response.m131356o(m105875h(request));
        String str2 = null;
        if (wib0.m206565i(this.purchaseType)) {
            ...
            str2 = "限时特惠";
        } else if (wib0.m206572p(this.purchaseType) || wib0.m206566j(this.purchaseType)) {
            str2 = "限时优惠";
        }
        if (TextUtils.equals(getFrom(), "purchasePage")) {
            response.m131352k(str2);
        } else {
            response.m131355n(str2);
        }
    }
