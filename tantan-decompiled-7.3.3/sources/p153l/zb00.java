...
public class zb00 extends AbstractC17634i4 {

    /* JADX INFO: renamed from: a */
    private int f203613a;

    /* JADX INFO: renamed from: b */
    private int f203614b;
    ...
    public void initShaderHandles() {
        ...
        this.f203613a = GLES20.glGetUniformLocation(this.programHandle, "number");
    }

    @Override // p153l.wej
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.f203613a, this.f203614b);
    }

    @Override // p153l.AbstractC17634i4
    public void setFilterOptions(FilterOptions filterOptions) {
        super.setFilterOptions(filterOptions);
        this.f203614b = filterOptions.getType();
    }
}
