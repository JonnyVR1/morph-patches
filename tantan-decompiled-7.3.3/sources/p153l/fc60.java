...
public final class fc60 {
    ...
    /* JADX INFO: renamed from: l.fc60$a */
    @Metadata(m88120d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0083\u0004\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, m88121d2 = {"Ll/fc60$a;", "Landroidx/media3/exoplayer/upstream/DefaultLoadErrorHandlingPolicy;", "<init>", "(Ll/fc60;)V", "clevertap-core_release"}, m88122k = 1, m88123mv = {2, 0, 0}, m88125xi = 48)
    public final class C16944a extends DefaultLoadErrorHandlingPolicy {
        public C16944a() {
        }
    }

    /* JADX INFO: renamed from: l.fc60$b */
    @Metadata(m88120d1 = {"\u0000\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m88121d2 = {"l/fc60$b", "Landroidx/media3/common/Player$Listener;", "clevertap-core_release"}, m88122k = 1, m88123mv = {2, 0, 0}, m88125xi = 48)
    public static final class C16945b implements Player.Listener {

        /* JADX INFO: renamed from: b */
        final /* synthetic */ ExoPlayer f98196b;

        public C16945b(ExoPlayer exoPlayer) {
            this.f98196b = exoPlayer;
        }
    }

    /* JADX INFO: renamed from: l.fc60$c */
    @Metadata(m88120d1 = {"\u0000\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m88121d2 = {"l/fc60$c", "Landroidx/media3/common/Player$Listener;", "clevertap-core_release"}, m88122k = 1, m88123mv = {2, 0, 0}, m88125xi = 48)
    public static final class C16946c implements Player.Listener {
        public C16946c() {
        }
    }

    /* JADX INFO: renamed from: l.fc60$d */
    @Metadata(m88120d1 = {"\u0000\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m88121d2 = {"l/fc60$d", "Landroidx/media3/common/Player$Listener;", "clevertap-core_release"}, m88122k = 1, m88123mv = {2, 0, 0}, m88125xi = 48)
    public static final class C16947d implements Player.Listener {

        /* JADX INFO: renamed from: a */
        final /* synthetic */ Function1<PlaybackException, Unit> f98198a;

        public C16947d(Function1<? super PlaybackException, Unit> function1) {
            this.f98198a = function1;
        }
    }

    /* JADX INFO: renamed from: k */
    private final void m124986k(ExoPlayer player) {
        player.addListener(new C16945b(player));
    }

    /* JADX INFO: renamed from: l */
    private final void m124987l(ExoPlayer player) {
        C16946c c16946c = new C16946c();
        this.playingChangedListener = c16946c;
        player.addListener(c16946c);
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m124988a(@NotNull Context context) {
        context.getClass();
        if (this.playerView != null) {
            wtq0.m207906a("createSurface() called twice — previous PlayerView not released");
            return null;
        }
    ...
    public final void m124990c() {
        this.networkRetryEnabled = true;
    }

    /* JADX INFO: renamed from: d */
    public final void m124991d(@NotNull Context context, @NotNull String url) {
        context.getClass();
        url.getClass();
        if (this.player != null) {
            return;
        ...
        MediaSource.Factory loadErrorHandlingPolicy = new DefaultMediaSourceFactory(new DefaultDataSource.Factory(context, transferListener)).setLoadErrorHandlingPolicy(new C16944a());
    ...
    public final boolean m124994g() {
        ExoPlayer exoPlayer = this.player;
        return exoPlayer != null ? exoPlayer.isPlaying() : this._isPlaying;
    }

    /* JADX INFO: renamed from: h */
    public final void m124995h(@NotNull Function0<Unit> callback) {
        callback.getClass();
        synchronized (this.firstFrameLock) {
            try {
    ...
    public final View m124997j(@NotNull Context context) {
        context.getClass();
        ExoPlayer exoPlayer = this.player;
        if (exoPlayer == null) {
            return null;
        }
        View viewM124988a = m124988a(context);
        synchronized (this.firstFrameLock) {
            this.firstFrameReady = false;
            Unit unit = Unit.INSTANCE;
        }
    ...
    public final void m125000o(@NotNull Function1<? super PlaybackException, Unit> onError) {
        onError.getClass();
        ExoPlayer exoPlayer = this.player;
        if (exoPlayer == null) {
            return;
        ...
        C16947d c16947d = new C16947d(onError);
        this.errorListener = c16947d;
        exoPlayer.addListener(c16947d);
    }

    /* JADX INFO: renamed from: p */
    public final void m125001p(boolean muted) {
        this._isMuted = muted;
        ExoPlayer exoPlayer = this.player;
        if (exoPlayer != null) {
    ...
    public final void m125002q(@Nullable Function1<? super Boolean, Unit> function1) {
        this.onPlayingChanged = function1;
    }

    /* JADX INFO: renamed from: r */
    public final void m125003r() {
        ExoPlayer exoPlayer = this.player;
        if (exoPlayer != null) {
            exoPlayer.pause();
        }
    ...
    public final View m125005t() {
        View view = this.playerView;
        if (view != null) {
            return view;
        }
        wtq0.m207906a("videoSurface() called but no PlayerView exists — was createSurface() called?");
        return null;
    }
}
