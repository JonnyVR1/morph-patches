...
public final /* data */ class trf0 {
    ...
    public trf0(int i, double d, double d2, @NotNull String str) {
        str.getClass();
        this.quantity = i;
        this.totalPrice = d;
        this.unitPrice = d2;
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof trf0)) {
            return false;
        }
        trf0 trf0Var = (trf0) other;
        return this.quantity == trf0Var.quantity && Double.compare(this.totalPrice, trf0Var.totalPrice) == 0 && Double.compare(this.unitPrice, trf0Var.unitPrice) == 0 && Intrinsics.m88377d(this.currencySymbol, trf0Var.currencySymbol);
    }
