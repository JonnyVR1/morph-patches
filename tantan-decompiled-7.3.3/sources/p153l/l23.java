...
public class l23 implements mpl {
    ...
    public /* synthetic */ l23(boolean z, boolean z2, Logger logger, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public DownloadedBitmap mo152557a(@NotNull InputStream inputStream, @NotNull HttpURLConnection connection, long downloadStartTimeInMilliseconds) throws IOException {
        ...
        if (contentLength != -1 && contentLength != i) {
            ...
            return C1318a.INSTANCE.m6869b(DownloadedBitmap.Status.DOWNLOAD_FAILED, "Incomplete Download");
        }
        if (!this.saveBitmap) {
            C1318a c1318a = C1318a.INSTANCE;
            long jM5975r = Utils.m5975r() - downloadStartTimeInMilliseconds;
            byteArray.getClass();
            return c1318a.m6871f(jM5975r, byteArray);
        }
        ...
        if (bitmapDecodeByteArray == null) {
            ...
            return C1318a.INSTANCE.m6869b(DownloadedBitmap.Status.DOWNLOAD_FAILED, "DecodeByteArray error");
        }
        C1318a c1318a2 = C1318a.INSTANCE;
        long jM5975r2 = Utils.m5975r() - downloadStartTimeInMilliseconds;
        if (!this.saveBytes) {
            byteArray = null;
        }
        return c1318a2.m6870d(bitmapDecodeByteArray, jM5975r2, byteArray);
    }
    ...
    public l23(boolean z, boolean z2, @Nullable Logger logger) {
        this.saveBytes = z;
        this.saveBitmap = z2;
        this.logger = logger;
    }
