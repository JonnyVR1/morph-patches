...
public final class ed0 implements tol {
    ...
    public ed0(@NotNull Act act, @NotNull PurchaseType purchaseType, @Nullable String str) {
        act.getClass();
    ...
    public CharSequence mo115313a(@NotNull bd0 requestData) {
        ...
        CharSequence charSequenceM105356o = bn60.m105356o(requestData.getPrivilegeStyle());
        charSequenceM105356o.getClass();
        return charSequenceM105356o;
    }
    ...
    public boolean mo115314b(@NotNull bd0 requestData) {
        requestData.getClass();
        return wib0.m206563g(this.purchaseType) && requestData.getCom.p1.mobile.putong.core.data.Merchandise.TYPE java.lang.String().autoRenewable();
    }
}
