...
public class zjm {
    ...
    private static byte[] f204686a;

    @RequiresApi(api = 19)
    /* JADX INFO: renamed from: a */
    public static byte[] m219977a(Image image, int i, byte[] bArr) {
        int i2;
        byte[] bArr2;
        int i3 = i;
        byte[] bArr3 = bArr;
        ...
        if (bArr4 == null || bArr4.length != planes[0].getRowStride()) {
            f204686a = new byte[planes[0].getRowStride()];
        }
        int i7 = 1;
        int i8 = 0;
        int i9 = 0;
        while (i8 < planes.length) {
            ...
            while (i13 < i12) {
                if (pixelStride == 1 && i7 == 1) {
                    ...
                    bArr2 = bArr3;
                    buffer.get(f204686a, 0, i2);
                    for (int i14 = 0; i14 < i11; i14++) {
                        bArr2[i9] = f204686a[i14 * pixelStride];
                        i9 += i7;
                    }
                }
                if (i13 < i12 - 1) {
    ...
    private static boolean m219978b(Image image) {
        int format = image.getFormat();
