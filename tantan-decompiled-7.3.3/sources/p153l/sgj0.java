...
public class sgj0 {
    ...
    public static double[] m185784a(double d, double d2) {
        double d3 = d2 - 105.0d;
        double d4 = d - 35.0d;
        double dM185785b = m185785b(d3, d4);
        double dM185786c = m185786c(d3, d4);
        double d5 = (d / 180.0d) * 3.141592653589793d;
        double dSin = Math.sin(d5);
        double d6 = 1.0d - ((0.006693421622965943d * dSin) * dSin);
        double dSqrt = Math.sqrt(d6);
        return new double[]{(dM185785b * 180.0d) / ((6335552.717000426d / (d6 * dSqrt)) * 3.141592653589793d), (dM185786c * 180.0d) / (((6378245.0d / dSqrt) * Math.cos(d5)) * 3.141592653589793d)};
    }

    /* JADX INFO: renamed from: b */
    public static double m185785b(double d, double d2) {
        double d3 = d * 2.0d;
    ...
    public static double m185786c(double d, double d2) {
        double d3 = d * 0.1d;
