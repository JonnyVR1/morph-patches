...
public final class eqe0<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    public Object mo94149c(T t, @NotNull Continuation<? super Unit> continuation) {
        this.nextValue = t;
        this.state = 3;
    ...
    public Object mo94150d(@NotNull Iterator<? extends T> it, @NotNull Continuation<? super Unit> continuation) {
        if (!it.hasNext()) {
    ...
    public final Throwable m121916g() {
        int i = this.state;
        if (i == 4) {
    ...
    public final void m121918j(@Nullable Continuation<? super Unit> continuation) {
        this.nextStep = continuation;
    }
