...
public final class y16 extends p95 {
    ...
    public y16(@NotNull CleverTapInstanceConfig cleverTapInstanceConfig, @NotNull ContentFetchManager contentFetchManager) {
    ...
    private final void m213932b(JSONArray contentFetchArray, Context context) {
        ...
        contentFetchManager.m6834h(contentFetchArray, packageName);
    }

    @Override // p153l.o95
    /* JADX INFO: renamed from: a */
    public void mo98656a(@Nullable JSONObject jsonBody, @Nullable String stringBody, @NotNull Context context) {
        context.getClass();
