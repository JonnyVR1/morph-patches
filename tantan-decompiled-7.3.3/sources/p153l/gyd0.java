...
import com.p051p1.mobile.putong.data.UserFakeSettings;
...
public class gyd0 extends dyd0<SettingGroups> {
    public gyd0(String str, boolean z, String str2) {
    ...
    public SettingGroups copyed(SettingGroups settingGroups, @NonNull SettingGroups settingGroups2) {
        return settingGroups2.mo225055clone();
    }

    /* JADX INFO: renamed from: c */
    public final SettingGroups m132959c() {
    ...
    public SharedPreferences.Editor saveValue(SettingGroups settingGroups) {
        return pref().edit().putString(this.f111993id, settingGroups.toJson());
    }
}
