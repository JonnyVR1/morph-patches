...
public class otp0 {
    ...
    public static void m169160a(Act act, String str, String str2, String str3, String str4) {
        try {
            ...
            nae0.m162083m(act, builderAppendQueryParameter.appendQueryParameter("tracker", str4).build());
        } catch (Exception e) {
            CrashHelper.m82479c(new Exception("please ignore! visit browser error " + e.getMessage(), e));
        }
    }

    /* JADX INFO: renamed from: b */
    public static void m169161b(Act act, String str, String str2, String str3, boolean z, boolean z2, boolean z3) {
        ...
        nae0.m162083m(act, builderAppendQueryParameter2.build());
    }

    /* JADX INFO: renamed from: c */
    public static void m169162c(Act act, String str) {
        try {
            i4g0.m138520r("e_web_purchase", str);
