...
public final class C15529a {
    ...
    public static final class a<T> implements Continuation<T>, CoroutineStackFrame {
        ...
        public CoroutineContext getF64053a() {
            return this.delegate.getF64053a();
        }
    ...
    public /* synthetic */ class b {
        ...
        public static final /* synthetic */ AtomicIntegerFieldUpdater f67463a = AtomicIntegerFieldUpdater.newUpdater(b.class, "installations$volatile");

        /* JADX INFO: renamed from: b */
        public static final /* synthetic */ AtomicLongFieldUpdater f67464b = AtomicLongFieldUpdater.newUpdater(b.class, "sequenceNumber$volatile");
    ...
    static {
        C15529a c15529a = new C15529a();
        INSTANCE = c15529a;
        ARTIFICIAL_FRAME = new g11().m128487b();
        ...
        dynamicAttach = c15529a.m94942d();
        callerInfoCache = new ConcurrentWeakMap<>(true);
        f67460h = new b(defaultConstructorMarker);
    }

    /* JADX INFO: renamed from: d */
    public final Function1<Boolean, Unit> m94942d() {
        ...
        try {
            ...
            objM225066constructorimpl = Result.m225066constructorimpl((Function1) TypeIntrinsics.m88429g(objNewInstance, 1));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM225066constructorimpl = Result.m225066constructorimpl(ResultKt.m88127a(th));
        }
        return (Function1) (Result.m225072isFailureimpl(objM225066constructorimpl) ? null : objM225066constructorimpl);
    }

    /* JADX INFO: renamed from: e */
    public final boolean m94943e(a<?> aVar) {
        InterfaceC15593o interfaceC15593o;
        CoroutineContext coroutineContextM94932c = aVar.info.m94932c();
        if (coroutineContextM94932c == null || (interfaceC15593o = (InterfaceC15593o) coroutineContextM94932c.get(InterfaceC15593o.INSTANCE)) == null || !interfaceC15593o.mo94584m()) {
            return false;
        }
    ...
    public final void m94944f(a<?> owner) {
        CoroutineStackFrame coroutineStackFrameM94945g;
        capturedCoroutinesMap.remove(owner);
        CoroutineStackFrame coroutineStackFrameM94935f = owner.info.m94935f();
        if (coroutineStackFrameM94935f == null || (coroutineStackFrameM94945g = m94945g(coroutineStackFrameM94935f)) == null) {
            return;
        }
        callerInfoCache.remove(coroutineStackFrameM94945g);
    }

    /* JADX INFO: renamed from: g */
    public final CoroutineStackFrame m94945g(CoroutineStackFrame coroutineStackFrame) {
        do {
