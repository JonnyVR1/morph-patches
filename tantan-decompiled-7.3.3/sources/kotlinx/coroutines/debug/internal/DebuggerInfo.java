...
public final class DebuggerInfo implements Serializable {
    ...
    public DebuggerInfo(@NotNull DebugCoroutineInfoImpl debugCoroutineInfoImpl, @NotNull CoroutineContext coroutineContext) {
        Thread.State state;
        C15523d c15523d = (C15523d) coroutineContext.get(C15523d.INSTANCE);
        this.coroutineId = c15523d != null ? Long.valueOf(c15523d.getId()) : null;
        ContinuationInterceptor continuationInterceptor = (ContinuationInterceptor) coroutineContext.get(ContinuationInterceptor.INSTANCE);
        this.dispatcher = continuationInterceptor != null ? continuationInterceptor.toString() : null;
        C15530e c15530e = (C15530e) coroutineContext.get(C15530e.INSTANCE);
        this.name = c15530e != null ? c15530e.getCom.facebook.AuthenticationTokenClaims.JSON_KEY_NAME java.lang.String() : null;
        this.state = debugCoroutineInfoImpl.get_state();
        Thread thread = debugCoroutineInfoImpl.lastObservedThread;
        this.lastObservedThreadState = (thread == null || (state = thread.getState()) == null) ? null : state.toString();
        Thread thread2 = debugCoroutineInfoImpl.lastObservedThread;
        this.lastObservedThreadName = thread2 != null ? thread2.getName() : null;
        this.lastObservedStackTrace = debugCoroutineInfoImpl.m94937h();
