...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements of3<E> {
    ...
    @NotNull
    public final HashMap<gle0<?>, Object> onSendInternalResult;

    /* JADX INFO: renamed from: kotlinx.coroutines.channels.BroadcastChannelImpl$a */
    @Metadata(m88120d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0082\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u00020\u00062\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, m88121d2 = {"Lkotlinx/coroutines/channels/BroadcastChannelImpl$a;", "Lkotlinx/coroutines/channels/BufferedChannel;", "<init>", "(Lkotlinx/coroutines/channels/BroadcastChannelImpl;)V", "", "cause", "", "r1", "(Ljava/lang/Throwable;)Z", "kotlinx-coroutines-core"}, m88122k = 1, m88123mv = {1, 9, 0}, m88125xi = 48)
    @SourceDebugExtension
    public final class C15515a extends BufferedChannel<E> {
        ...
        public boolean mo94680J(@Nullable Throwable cause) {
            ...
            reentrantLock.lock();
            try {
                broadcastChannelImpl.m94687w1(this);
                return super.mo94680J(cause);
            } finally {
    ...
    @Metadata(m88120d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0082\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u00020\u00062\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, m88121d2 = {"Lkotlinx/coroutines/channels/BroadcastChannelImpl$b;", "Lkotlinx/coroutines/channels/b;", "<init>", "(Lkotlinx/coroutines/channels/BroadcastChannelImpl;)V", "", "cause", "", "v1", "(Ljava/lang/Throwable;)Z", "kotlinx-coroutines-core"}, m88122k = 1, m88123mv = {1, 9, 0}, m88125xi = 48)
    public final class C15516b extends C15522b<E> {
        public C15516b() {
        ...
        public boolean mo94680J(@Nullable Throwable cause) {
            BroadcastChannelImpl.this.m94687w1(this);
            return super.mo94680J(cause);
        }
    }
    ...
    public boolean mo94678D(@Nullable Throwable cause) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ((BufferedChannel) it.next()).mo94678D(cause);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ArrayList arrayList = new ArrayList();
            for (Object obj : list) {
                if (((BufferedChannel) obj).m94777k0()) {
                    arrayList.add(obj);
                }
            }
            this.subscribers = arrayList;
            return super.mo94678D(cause);
        } finally {
            reentrantLock.unlock();
        }
    }
    ...
    public java.lang.Object mo94679E(E r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
        ...
        L3e:
            ...
            r8.lock()
            boolean r2 = r6.mo94684s()     // Catch: java.lang.Throwable -> L54
            if (r2 != 0) goto L9e
        ...
        L65:
            ...
            r0.L$2 = r6
            r0.label = r3
            java.lang.Object r2 = r2.mo94762a1(r8, r0)
            if (r2 != r1) goto L80
            return r1
        L80:
            r5 = r0
        ...
        L84:
            ...
            if (r8 != 0) goto L98
            boolean r8 = r7.mo94684s()
            if (r8 != 0) goto L93
            goto L98
        L93:
            java.lang.Throwable r6 = r7.m94769f0()
            throw r6
        L98:
            r8 = r0
            r0 = r2
        ...
        L9b:
            ...
            return r6
        L9e:
            java.lang.Throwable r6 = r6.m94769f0()     // Catch: java.lang.Throwable -> L54
            throw r6     // Catch: java.lang.Throwable -> L54
        La3:
            r8.unlock()
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BroadcastChannelImpl.mo94679E(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public boolean mo94680J(@Nullable Throwable cause) {
        ...
        try {
            Iterator<T> it = this.subscribers.iterator();
            while (it.hasNext()) {
                ((BufferedChannel) it.next()).mo94680J(cause);
            }
            this.lastConflatedElement = pf3.f152151a;
            return super.mo94680J(cause);
        } finally {
            reentrantLock.unlock();
        }
    ...
    public void mo94681U0(@NotNull gle0<?> select, @Nullable Object element) {
        ...
        try {
            ...
            if (objRemove != null) {
                select.mo95203d(objRemove);
                reentrantLock.unlock();
            } else {
                Unit unit = Unit.INSTANCE;
                reentrantLock.unlock();
                xh3.m210980d(C15531f.m94947a(select.getContext()), null, CoroutineStart.UNDISPATCHED, new BroadcastChannelImpl$registerSelectForSend$2(this, element, select, null), 1, null);
            }
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
    ...
    @NotNull
    /* JADX INFO: renamed from: d */
    public ReceiveChannel<E> mo94682d() {
        ReentrantLock reentrantLock = this.lock;
        reentrantLock.lock();
        try {
            C15515a c15516b = this.capacity == -1 ? new C15516b() : new C15515a();
            if (mo94684s() && this.lastConflatedElement == pf3.f152151a) {
                ((BufferedChannel) c15516b).mo94678D(m94760Y());
                return c15516b;
            }
            if (this.lastConflatedElement != pf3.f152151a) {
                ((BufferedChannel) c15516b).mo94683l(m94686v1());
            }
            this.subscribers = CollectionsKt.plus((Collection<? extends ReceiveChannel<E>>) this.subscribers, c15516b);
            return c15516b;
        } finally {
            reentrantLock.unlock();
        }
    ...
    public Object mo94683l(E element) {
        ...
        try {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (((BufferedChannel) it.next()).mo94768e1()) {
                        Object objM94894b = C15521a.INSTANCE.m94894b();
                        reentrantLock.unlock();
                        return objM94894b;
                    }
                }
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo94683l(element);
            }
            Object objM94895c = C15521a.INSTANCE.m94895c(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM94895c;
        } catch (Throwable th) {
            reentrantLock.unlock();
    ...
    public final void m94687w1(ReceiveChannel<? extends E> s) {
        ReentrantLock reentrantLock = this.lock;
        reentrantLock.lock();
        try {
            List<? extends BufferedChannel<E>> list = this.subscribers;
