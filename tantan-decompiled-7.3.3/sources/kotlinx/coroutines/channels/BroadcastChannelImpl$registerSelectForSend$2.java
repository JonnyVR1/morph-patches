...
@DebugMetadata(m88262c = "kotlinx.coroutines.channels.BroadcastChannelImpl$registerSelectForSend$2", m88263f = "BroadcastChannel.kt", m88264l = {288}, m88265m = "invokeSuspend")
@SourceDebugExtension
public final class BroadcastChannelImpl$registerSelectForSend$2 extends SuspendLambda implements Function2<drb, Continuation<? super Unit>, Object> {
    final /* synthetic */ Object $element;
    final /* synthetic */ gle0<?> $select;
    int label;
    final /* synthetic */ BroadcastChannelImpl<E> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BroadcastChannelImpl$registerSelectForSend$2(BroadcastChannelImpl<E> broadcastChannelImpl, Object obj, gle0<?> gle0Var, Continuation<? super BroadcastChannelImpl$registerSelectForSend$2> continuation) {
    ...
    public final Object invoke(@NotNull drb drbVar, @Nullable Continuation<? super Unit> continuation) {
        return ((BroadcastChannelImpl$registerSelectForSend$2) create(drbVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r5) {
        /*
            ...
            if (r1 == 0) goto L18
            if (r1 != r2) goto L11
            kotlin.ResultKt.m88128b(r5)     // Catch: java.lang.Throwable -> Lf
            goto L3d
        Lf:
            r5 = move-exception
            goto L28
        ...
        L18:
            ...
            java.lang.Object r5 = r5.mo94679E(r1, r4)     // Catch: java.lang.Throwable -> Lf
            if (r5 != r0) goto L3d
            return r0
        L28:
            kotlinx.coroutines.channels.BroadcastChannelImpl<E> r0 = r4.this$0
            boolean r0 = r0.mo94684s()
            if (r0 == 0) goto L7e
            boolean r0 = r5 instanceof kotlinx.coroutines.channels.ClosedSendChannelException
            if (r0 != 0) goto L3c
            kotlinx.coroutines.channels.BroadcastChannelImpl<E> r0 = r4.this$0
            java.lang.Throwable r0 = r0.m94769f0()
            if (r0 != r5) goto L7e
        L3c:
            r2 = 0
        L3d:
            kotlinx.coroutines.channels.BroadcastChannelImpl<E> r5 = r4.this$0
            java.util.concurrent.locks.ReentrantLock r5 = kotlinx.coroutines.channels.BroadcastChannelImpl.m94675r1(r5)
            kotlinx.coroutines.channels.BroadcastChannelImpl<E> r0 = r4.this$0
            l.gle0<?> r4 = r4.$select
            r5.lock()
            java.util.HashMap r1 = kotlinx.coroutines.channels.BroadcastChannelImpl.m94676s1(r0)     // Catch: java.lang.Throwable -> L53
            if (r2 == 0) goto L55
        ...
        L53:
            ...
            goto L7a
        L55:
            l.goh0 r2 = kotlinx.coroutines.channels.BufferedChannelKt.m94842z()     // Catch: java.lang.Throwable -> L53
        L59:
            ...
            kotlinx.coroutines.selects.SelectImplementation r1 = (kotlinx.coroutines.selects.SelectImplementation) r1     // Catch: java.lang.Throwable -> L53
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch: java.lang.Throwable -> L53
            kotlinx.coroutines.selects.TrySelectDetailedResult r1 = r1.m95216z(r0, r2)     // Catch: java.lang.Throwable -> L53
            ...
            if (r1 == r3) goto L76
            java.util.HashMap r0 = kotlinx.coroutines.channels.BroadcastChannelImpl.m94676s1(r0)     // Catch: java.lang.Throwable -> L53
