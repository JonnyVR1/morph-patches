...
@DebugMetadata(m88262c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m88263f = "Delay.kt", m88264l = {204}, m88265m = "invokeSuspend")
public final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<el90<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public static final class C155381<T> implements bui {

        /* JADX INFO: renamed from: a */
        public final /* synthetic */ el90<Object> f67480a;

        public C155381(el90<Object> el90Var) {
            this.f67480a = el90Var;
        }
        ...
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                el90<Object> el90Var = this.f67480a;
                if (t == null) {
                    t = (T) h350.f107614a;
                }
                flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.label = 1;
                if (el90Var.mo94679E(t, flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1) == objM198688e) {
                    return objM198688e;
                }
            } else {
                if (i2 != 1) {
    ...
    public FlowKt__DelayKt$debounceInternal$1$values$1(aui<Object> auiVar, Continuation<? super FlowKt__DelayKt$debounceInternal$1$values$1> continuation) {
    ...
    public final Object invoke2(@NotNull el90<Object> el90Var, @Nullable Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$values$1) create(el90Var, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            aui<Object> auiVar = this.$this_debounceInternal;
            C155381 c155381 = new C155381(el90Var);
            this.label = 1;
            if (auiVar.collect(c155381, this) == objM198688e) {
                return objM198688e;
            }
        } else {
            if (i != 1) {
