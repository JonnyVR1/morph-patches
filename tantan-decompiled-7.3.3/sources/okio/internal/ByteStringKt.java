...
public final class ByteStringKt {
    ...
    @NotNull
    private static final ByteString COMMON_EMPTY = ByteString.INSTANCE.m222320of(new byte[0]);
    ...
    public static final ByteString commonSubstring(@NotNull ByteString byteString, int i, int i2) {
        ...
        if (i2 > byteString.getData().length) {
            sr3.m187590a("endIndex > length(", byteString.getData().length, 41);
            return null;
        }
        int i3 = i2 - i;
        if (i3 < 0) {
    ...
    public static final String commonToString(@NotNull ByteString byteString) {
        ...
        String strM94370F = C15493d.m94370F(C15493d.m94370F(C15493d.m94370F(strUtf8.substring(0, iCodePointIndexToCharIndex), "\\", "\\\\", false, 4, null), SignParameters.NEW_LINE, "\\n", false, 4, null), "\r", "\\r", false, 4, null);
        if (iCodePointIndexToCharIndex >= strUtf8.length()) {
            return "[text=" + strM94370F + ']';
        }
        return "[size=" + byteString.getData().length + " text=" + strM94370F + "…]";
    }
