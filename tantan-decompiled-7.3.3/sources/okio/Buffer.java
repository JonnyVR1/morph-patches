...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    @Metadata(m88119bv = {1, 0, 2}, m88120d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\u0011H\u0016J\u000e\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\bJ\u0006\u0010\u0014\u001a\u00020\bJ\u000e\u0010\u0015\u001a\u00020\n2\u0006\u0010\u0016\u001a\u00020\nJ\u000e\u0010\u0017\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000f\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0018"}, m88121d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", "end", "", IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET, "", "readWrite", "", "segment", "Lokio/Segment;", "start", "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "jvm"}, m88122k = 1, m88123mv = {1, 1, 11})
    public static final class UnsafeCursor implements Closeable {
        ...
        public final long expandBuffer(int minByteCount) {
            if (minByteCount <= 0) {
                plk0.m172832a("minByteCount <= 0: ", minByteCount);
                return 0L;
            }
            if (minByteCount > 8192) {
                plk0.m172832a("minByteCount > Segment.SIZE: ", minByteCount);
                return 0L;
            }
            ...
            if (!this.readWrite) {
                wtq0.m207906a("expandBuffer() only permitted for read/write buffers");
                return 0L;
            }
        ...
        public final long resizeBuffer(long newSize) {
            ...
            if (!this.readWrite) {
                wtq0.m207906a("resizeBuffer() only permitted for read/write buffers");
                return 0L;
            }
            long size = buffer.size();
            if (newSize <= size) {
                if (newSize < 0) {
                    iq70.m141659a("newSize < 0: ", newSize);
                    return 0L;
                }
        ...
        public final int seek(long offset) {
            ...
            if (offset < -1 || offset > buffer.size()) {
                ...
                zg3.m219589a("offset=%s > size=%s", Arrays.copyOf(new Object[]{Long.valueOf(offset), Long.valueOf(buffer.size())}, 2));
                return 0;
            }
            if (offset == -1 || offset == buffer.size()) {
                this.segment = null;
    ...
    public final byte m225915deprecated_getByte(long index) {
    ...
    public long indexOf(@NotNull ByteString bytes, long fromIndex) throws IOException {
        ...
        long j2 = 0;
        if (bytes.size() <= 0) {
            wg3.m206174a("bytes is empty");
            return 0L;
        }
        if (j < 0) {
            iq70.m141659a("fromIndex < 0: ", j);
            return 0L;
        }
        Segment segment3 = buffer.head;
        if (segment3 == null) {
    ...
    public long indexOfElement(@NotNull ByteString targetBytes, long fromIndex) {
        ...
        long size = 0;
        if (fromIndex < 0) {
            iq70.m141659a("fromIndex < 0: ", fromIndex);
            return 0L;
        }
        Segment segment = this.head;
        if (segment == null) {
    ...
    public byte[] readByteArray(long byteCount) throws EOFException {
        if (byteCount < 0 || byteCount > 2147483647L) {
            iq70.m141659a("byteCount: ", byteCount);
            return null;
        }
    ...
    public long readDecimalLong() throws EOFException {
            ...
            while (true) {
                ...
                if (b >= 48 && b <= 57) {
                    ...
                    if (b != 45 || i != 0) {
                        ...
                        ug3.m195884a("Expected leading [0-9] or '-' character but was 0x", Integer.toHexString(b));
                        return j;
                    }
                    j4--;
                    z = true;
        ...
        ug3.m195884a("Number too large: ", bufferWriteByte.readUtf8());
        return j;
    }
            ...
            while (i3 < i4) {
                ...
                if (b >= 48 && b <= 57) {
                    ...
                    if (b < 65 || b > 70) {
                        ...
                        ug3.m195884a("Expected leading [0-9a-fA-F] character but was 0x", Integer.toHexString(b));
                        return 0L;
                    }
                    i = b - 55;
                }
                if (((-1152921504606846976L) & j) != 0) {
                    ug3.m195884a("Number too large: ", new Buffer().writeHexadecimalUnsignedLong(j).writeByte((int) b).readUtf8());
                    return 0L;
                }
                j = (j << 4) | ((long) i);
                i3++;
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        ...
        xg3.m210876a(Math.min(this.size, limit), buffer.readByteString().hex());
        return null;
    }
    ...
    public Buffer writeString(@NotNull String string, int beginIndex, int endIndex, @NotNull Charset charset) {
        ...
        charset.getClass();
        if (beginIndex < 0) {
            plk0.m172832a("beginIndex < 0: ", beginIndex);
            return null;
        }
        if (endIndex < beginIndex) {
            nlk0.m163726a("endIndex < beginIndex: ", endIndex, " < ", beginIndex);
            return null;
        }
        if (endIndex > string.length()) {
            nlk0.m163726a("endIndex > string.length: ", endIndex, " > ", string.length());
            return null;
        }
        if (Intrinsics.m88377d(charset, Charsets.UTF_8)) {
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        ...
        if (codePoint > 1114111) {
            yg3.m215829a("Unexpected code point: ", Integer.toHexString(codePoint));
            return null;
        }
    ...
    public final ByteString snapshot(int byteCount) {
        return byteCount == 0 ? ByteString.EMPTY : SegmentedByteString.INSTANCE.m222324of(this, byteCount);
    }
    ...
    public final Buffer readFrom(@NotNull InputStream input, long byteCount) throws IOException {
        ...
        iq70.m141659a("byteCount < 0: ", byteCount);
        return null;
    }
