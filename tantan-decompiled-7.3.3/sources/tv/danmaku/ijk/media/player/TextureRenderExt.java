...
class TextureRenderExt {
    ...
    public void setDeblurEnabled(boolean z) {
        t9c.m189745c(TAG, "setDeblurEnabled:" + this.mDeblurEnabled + "--->" + z);
        this.mDeblurEnabled = z;
    }

    public void setDeblurWeight(float f) {
        t9c.m189745c(TAG, "setDeblurWeight:" + this.mDeblurWeight + "--->" + f);
        this.mDeblurWeight = f;
    }

    public void setSaturation(float f) {
        t9c.m189745c(TAG, "setSaturation:" + this.mSaturation + "--->" + f);
        this.mSaturation = f;
    }
