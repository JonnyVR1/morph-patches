...
public class IjkMediaMeta {
    ...
    public String getDurationInline() {
        long j = (this.mDurationUS + Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS) / 1000000;
        long j2 = j / 60;
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            return j < 1000 ? String.format(Locale.US, "%d bit/s", Long.valueOf(j)) : String.format(Locale.US, "%d kb/s", Long.valueOf(j / 1000));
        }
        ...
        public String getChannelLayoutInline() {
            ...
            return j == 3 ? "stereo" : String.format(Locale.US, "%x", Long.valueOf(j));
        }
        ...
        public String getResolutionInline() {
            ...
            return (this.mSarNum <= 0 || this.mSarDen <= 0) ? String.format(Locale.US, "%d x %d", Integer.valueOf(i), Integer.valueOf(this.mHeight)) : String.format(Locale.US, "%d x %d [SAR %d:%d]", Integer.valueOf(i), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen));
        }
