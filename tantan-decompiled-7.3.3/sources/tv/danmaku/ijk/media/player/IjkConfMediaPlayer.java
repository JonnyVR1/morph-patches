...
public class IjkConfMediaPlayer {
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkConfMediaPlayer == null || ijkConfMediaPlayer.mNativeMediaPlayer == 0) {
                t9c.m189751i(IjkConfMediaPlayer.TAG, "IjkConfMediaPlayer went away with unhandled events");
                return;
            }
            int i = message.what;
            if (i == 0 || i == 1) {
            ...
            if (i != 100) {
                ...
                t9c.m189745c(IjkConfMediaPlayer.TAG, "Unknown message type " + message.what);
                return;
            }
            t9c.m189745c(IjkConfMediaPlayer.TAG, "Error (" + message.arg1 + Constants.SEPARATOR_COMMA + message.arg2 + ")");
            ijkConfMediaPlayer.stayAwake(false);
        }
    }
            ...
            if (!mIsLibLoaded) {
                ...
                try {
                    ...
                    try {
                        ...
                        ylc0.m216566a(l26.f129743a, "ijkconfplayer");
    ...
    public void setDisplay(SurfaceHolder surfaceHolder) {
        ...
        String str = TAG;
        t9c.m189745c(str, "setDisplay" + surfaceHolder);
        try {
            if (surfaceHolder != null) {
            ...
            if (fakesurface != null) {
                ...
                t9c.m189745c(str, "_setVideoSurface" + surfaceHolder);
            }
        } catch (Error e) {
            e.printStackTrace();
        } catch (Exception e2) {
    ...
    public void setMediaCodecEnabled(boolean z) {
        t9c.m189745c(TAG, "setMediaCodecEnabled" + z);
        if (mIsLibLoaded) {
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                t9c.m189751i(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public void setSurfaceH(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            t9c.m189751i(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
        if (mIsLibLoaded) {
            _setVideoSurface(surface, surface);
        }
    ...
    public void setDisplay(Surface surface) {
        try {
            ...
            if (fakesurface != null) {
                ...
                t9c.m189745c(TAG, "_setVideoSurface" + surface);
            }
        } catch (Error e) {
            e.printStackTrace();
        } catch (Exception e2) {
