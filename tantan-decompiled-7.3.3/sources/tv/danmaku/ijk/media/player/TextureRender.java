...
class TextureRender {
    ...
    public void adjustImageScaling() {
        t9c.m189745c(TAG, "adjustImageScaling mOutputWidth:" + this.mOutputWidth + ";outputHeight:" + this.mOutputHeight + ";mImageWidth:" + this.mImageWidth + ";mImageHeight" + this.mImageHeight + ";mRotation:" + this.mRotation);
        ...
        float[] fArr = CUBE;
        float[] fArrM207891b = wti0.m207891b(this.mRotation, this.mFlipHorizontal, this.mFlipVertical);
        float f3 = (1.0f - (1.0f / fRound)) / 2.0f;
        float f4 = (1.0f - (1.0f / fRound2)) / 2.0f;
        float[] fArr2 = {addDistance(fArrM207891b[0], f3), addDistance(fArrM207891b[1], f4), addDistance(fArrM207891b[2], f3), addDistance(fArrM207891b[3], f4), addDistance(fArrM207891b[4], f3), addDistance(fArrM207891b[5], f4), addDistance(fArrM207891b[6], f3), addDistance(fArrM207891b[7], f4)};
    ...
    public void adjustImageScaling2() {
        float[] fArr = CUBE;
        float[] fArrM207891b = wti0.m207891b(this.mRotation, this.mFlipHorizontal, this.mFlipVertical);
        float[] fArr2 = {addDistance2(fArrM207891b[0], this.cut_l, this.cut_r), addDistance2(fArrM207891b[1], this.cut_t, this.cut_b), addDistance2(fArrM207891b[2], this.cut_l, this.cut_r), addDistance2(fArrM207891b[3], this.cut_t, this.cut_b), addDistance2(fArrM207891b[4], this.cut_l, this.cut_r), addDistance2(fArrM207891b[5], this.cut_t, this.cut_b), addDistance2(fArrM207891b[6], this.cut_l, this.cut_r), addDistance2(fArrM207891b[7], this.cut_t, this.cut_b)};
        this.mTarget_coords.clear();
        this.mTarget_coords.put(fArr).position(0);
        this.mSource_coords.clear();
        this.mSource_coords.put(fArr2).position(0);
    ...
    public void drawFrame(SurfaceTexture surfaceTexture) {
        ...
        if (this.bNeedUpdateRec) {
            ...
            t9c.m189745c(TAG, "@@@@@@@@@@  drawFrame NeedUpdateRec");
        }
    ...
    public void surfaceCreated() {
        ...
        if (iCreateProgram == 0) {
            t9c.m189743a(TAG, "failed creating program");
            this.mSurfce.setLastErr(-1);
            return;
        }
        ...
        if (this.maPositionHandle == -1) {
            t9c.m189743a(TAG, "Could not get attrib location for aPosition");
            this.mSurfce.setLastErr(-1);
            return;
        }
        ...
        if (this.maTextureHandle == -1) {
            t9c.m189743a(TAG, "Could not get attrib location for aTextureCoord");
            this.mSurfce.setLastErr(-1);
        } else {
            genTex();
            t9c.m189745c(TAG, "surfaceCreated: ");
        }
    }
    ...
    public void updateRec(float f, float f2, float f3, float f4) {
        ...
        t9c.m189745c(TAG, "@@@@@@@@@@  updateRec:" + f + ":" + f2 + ":" + f3 + ":" + f4);
    }
