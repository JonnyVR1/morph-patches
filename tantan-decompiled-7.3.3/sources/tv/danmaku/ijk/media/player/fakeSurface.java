...
class fakeSurface implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public static /* synthetic */ class C225731 {
        ...
        try {
            ...
            if (this.mScreenSurface == null) {
                ...
                if (this.mScreenWidth[0] != 0 && this.mScreenHight[0] != 0) {
                    int i = C225731.$SwitchMap$tv$danmaku$ijk$media$player$fakeSurface$RenderMode[this.mRenderMode.ordinal()];
                    if (i == 1) {
            ...
            t9c.m189743a(TAG, "activiteSurface_l eglSetup exception");
            this.mNeedRending = false;
            setLastErr(-1);
        }
    }
    ...
    private void checkEglError(String str) {
        while (true) {
            ...
            t9c.m189745c(TAG, str + ": EGL error: 0x" + Integer.toHexString(iEglGetError));
            setLastErr(-1);
        }
    }
    ...
    private void drawImageNormal() {
        ...
        try {
            ...
            if (this.mScreenWidth[0] != 0 && this.mScreenHight[0] != 0) {
                t9c.m189743a(TAG, "updateRec mEGLSurface width = " + this.mScreenWidth[0] + ";mEGLSurface hight =" + this.mScreenHight[0]);
            ...
            t9c.m189743a(TAG, " mSurfaceTexture.updateTexImage exception ");
        }
    }
    ...
    private void eglSetup(Object obj) {
        ...
        if (obj != null) {
            ...
            this.mEGL.eglQuerySurface(this.mEGLDisplay, this.mEGLSurface, 12375, this.mScreenWidth);
            t9c.m189743a(TAG, "mEGLSurface width = " + this.mScreenWidth[0] + ";mEGLSurface hight =" + this.mScreenHight[0]);
        } else {
    ...
    private void setup() {
        ...
        if (this.mTextureRender == null) {
            ...
            t9c.m189743a(TAG, "textureID=" + this.mTextureRender.getTextureId());
            try {
    ...
    public synchronized void activiteSurface(Object obj) {
        this.mLastError = 0;
        t9c.m189743a(TAG, "activiteSurface" + obj);
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        t9c.m189743a(TAG, "new frame available");
    ...
    public fakeSurface(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            t9c.m189743a(TAG, "eglSetup exception");
            setLastErr(-1);
        }
    }
}
