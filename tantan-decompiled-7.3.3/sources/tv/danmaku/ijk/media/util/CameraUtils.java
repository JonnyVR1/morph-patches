...
public class CameraUtils {
    ...
    public static final List<String> f209814a;

    /* JADX INFO: renamed from: b */
    public static final List<String> f209815b;

    /* JADX INFO: renamed from: c */
    public static final List<String> f209816c;
    ...
    /* JADX INFO: renamed from: a */
    public static int m224107a(Activity activity, int i) {
        Camera.CameraInfo cameraInfo = new Camera.CameraInfo();
        Camera.getCameraInfo(i, cameraInfo);
        int iM224108b = m224108b(activity);
        int i2 = cameraInfo.facing;
        int i3 = cameraInfo.orientation;
        return i2 == 1 ? (360 - ((i3 + iM224108b) % 360)) % 360 : ((i3 - iM224108b) + 360) % 360;
    }

    /* JADX INFO: renamed from: b */
    public static int m224108b(Activity activity) {
