...
public class VFrame_MaxWidth extends FrameLayout {
    ...
    public VFrame_MaxWidth(Context context) {
        super(context);
        this.f210037a = PlaybackException.CUSTOM_ERROR_CODE_BASE;
    }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), this.f210037a), View.MeasureSpec.getMode(i)), i2);
    }
