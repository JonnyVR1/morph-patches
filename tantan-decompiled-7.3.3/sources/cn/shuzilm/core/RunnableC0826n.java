...
class RunnableC0826n implements Runnable {
    ...
    public RunnableC0826n(Context context, String str, String str2) {
        this.f3829a = context;
        this.f3830b = str;
        this.f3831c = str2;
    }
    ...
    public void run() {
        try {
            ...
            DUHelper.f3733d.m4710a(this.f3829a, DUHelper.f3743n, this.f3830b);
            DUHelper.f3733d.m4715a(DUHelper.f3742m, this.f3831c);
