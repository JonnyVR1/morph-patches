...
class RunnableC0827o implements Runnable {
    ...
    public RunnableC0827o(Context context, String str, String str2) {
        this.f3832a = context;
        this.f3833b = str;
        this.f3834c = str2;
    }
    ...
    public void run() {
        try {
            ...
            DUHelper.f3733d.m4710a(this.f3832a, DUHelper.f3743n, this.f3833b);
            DUHelper.f3733d.m4715a(DUHelper.f3742m, this.f3834c);
