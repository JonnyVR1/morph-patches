...
public class AIClient {
    ...
    final class ServiceConnectionC0807AC implements ServiceConnection {
        ...
        private ServiceConnectionC0807AC() {
            this.f3709a = false;
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            AIClient.m4660b(this.f3710b, iBinder);
        }
    ...
    final class C0808AI implements IInterface {
        ...
        public C0808AI(IBinder iBinder, String str, int i) {
            this.f3712b = iBinder;
            this.f3713c = str;
            this.f3714d = i;
        }
    ...
    interface InterfaceC0810HI {

        /* JADX INFO: renamed from: cn.shuzilm.core.AIClient$HI$u */
        public abstract class u extends Binder implements InterfaceC0810HI {

            /* JADX INFO: renamed from: cn.shuzilm.core.AIClient$HI$u$d */
            public class d implements InterfaceC0810HI {
                ...
                @Override // cn.shuzilm.core.AIClient.InterfaceC0810HI
                /* JADX INFO: renamed from: b */
                public void mo4688b(HII.AbstractBinderC0811OI abstractBinderC0811OI) {
                    Parcel parcelObtain = Parcel.obtain();
                    Parcel parcelObtain2 = Parcel.obtain();
                    try {
                        parcelObtain.writeInterfaceToken("com.hihonor.cloudservice.oaid.IOAIDService");
                        parcelObtain.writeStrongBinder(abstractBinderC0811OI);
        ...
        /* JADX INFO: renamed from: b */
        void mo4688b(HII.AbstractBinderC0811OI abstractBinderC0811OI);
    }

    public interface HII extends IInterface {

        /* JADX INFO: renamed from: cn.shuzilm.core.AIClient$HII$OI */
        public abstract class AbstractBinderC0811OI extends Binder implements HII {

            /* JADX INFO: renamed from: a */
            String f3724a = "com.hihonor.cloudservice.oaid.IOAIDCallBack";

            public AbstractBinderC0811OI() {
            ...
            public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
                if (i == 2) {
                    try {
                        ...
                        mo4689go(parcel.readInt(), parcel.readInt() == 0 ? null : (Bundle) Bundle.CREATOR.createFromParcel(parcel));
        ...
        void mo4689go(int i, Bundle bundle);
    }
    ...
    final class HNO implements IInterface {
        ...
        public void getID() {
            try {
                ...
                Object objQueryLocalInterface = iBinder.queryLocalInterface(AIClient.this.m4650a(AIClient.f3666W));
                ((objQueryLocalInterface == null || !(objQueryLocalInterface instanceof InterfaceC0810HI.u.d)) ? new InterfaceC0810HI.u.d(this.f3726b) : (InterfaceC0810HI.u.d) objQueryLocalInterface).mo4688b(AIClient.this.new gid());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public class gid extends HII.AbstractBinderC0811OI {
        public gid() {
        }

        @Override // cn.shuzilm.core.AIClient.HII
        /* JADX INFO: renamed from: go */
        public void mo4689go(int i, Bundle bundle) {
            try {
                String string = bundle.getString(AIClient.this.m4650a(new int[]{238, 232, 229, 239, 214, 237, 224, 214, 232, 230, 0}));
                AIClient aIClient = AIClient.this;
                aIClient.m4652a(string, aIClient.m4650a(AIClient.f3667X));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    /* JADX INFO: renamed from: a */
    private void m4654a(String str, String str2, String str3, String str4, String str5, int i) {
        Intent intent;
        Intent intent2;
        C0808AI c0808ai;
        try {
            Intent intent3 = null;
            ServiceConnectionC0807AC serviceConnectionC0807AC = new ServiceConnectionC0807AC();
            if (i == 0) {
                ...
                if (i == 1) {
                    ...
                    if (i == 3) {
                        ...
                        intent3.setAction(str3);
                        intent3.putExtra(m4650a(f3654K), this.f3696aa.getApplicationInfo().packageName);
                    } else if (i == 7) {
                        intent2 = new Intent();
            ...
            if (this.f3696aa.bindService(intent3, serviceConnectionC0807AC, 1)) {
                try {
                    if (i == 2) {
                        try {
                            Thread.sleep(100L);
                        ...
                        String id = new AIO(serviceConnectionC0807AC.getBinder(), str4).getId(this.f3696aa.getPackageName(), m4668e(), m4650a(f3688s));
                        if (id != null) {
                            m4652a(id, str5);
                        }
                    } else if (i == 8) {
                        new HNO(serviceConnectionC0807AC.getBinder()).getID();
                    } else {
                        if (i == 3 || i == 6) {
                            c0808ai = new C0808AI(serviceConnectionC0807AC.getBinder(), str4, 3);
                        } else {
                            c0808ai = i == 7 ? new C0808AI(serviceConnectionC0807AC.getBinder(), str4, 2) : new C0808AI(serviceConnectionC0807AC.getBinder(), str4, 1);
                        }
                        String id2 = c0808ai.getId();
                        if (id2 != null) {
                            m4652a(id2, str5);
                        }
                    }
                ...
                this.f3696aa.unbindService(serviceConnectionC0807AC);
            }
    ...
    /* JADX INFO: renamed from: b */
    private boolean m4661b(String str, int i) {
        String absolutePath;
        int iLastIndexOf;
    ...
    /* JADX INFO: renamed from: c */
    private String m4663c(String str) {
        try {
            SharedPreferences sharedPreferences = this.f3696aa.getSharedPreferences(this.f3696aa.getPackageName() + m4650a(f3676g), 0);
    ...
    /* JADX INFO: renamed from: d */
    private String m4666d(String str) {
        if (str == null) {
            return null;
        }
        try {
            Class<?> cls = Class.forName(m4650a(f3685p));
    ...
    private void m4670f() {
        try {
            ...
            Object systemService = this.f3696aa.getSystemService(m4650a(new int[]{255, 232, 251, 255, 232, 254, 236, 254, 224, 210, 224, 248, 251, 226, 0}));
            if (systemService == null) {
                return;
            }
            String str = (String) systemService.getClass().getDeclaredMethod(m4650a(iArr), null).invoke(systemService, null);
            if (f3679j == null) {
                return;
            }
            m4652a(str, m4650a(iArr2));
        } catch (Exception unused) {
        }
    }
    ...
    /* JADX INFO: renamed from: k */
    private boolean m4676k() {
        String strM4666d = m4666d(m4650a(f3684o));
        return !TextUtils.isEmpty(strM4666d) && strM4666d.equals("1");
    }

    /* JADX INFO: renamed from: l */
    private boolean m4677l() {
        String strM4666d = m4666d(m4650a(f3662S));
        return !TextUtils.isEmpty(strM4666d) && strM4666d.equalsIgnoreCase(m4650a(f3661R));
    }

    /* JADX INFO: renamed from: n */
    private boolean m4678n() {
        String strM4666d = m4666d(m4650a(f3659P));
        return (TextUtils.isEmpty(strM4666d) || strM4666d.equalsIgnoreCase("unknown")) ? false : true;
    }

    /* JADX INFO: renamed from: o */
    private boolean m4679o() {
        PackageManager packageManager;
        try {
            return (!m4671f("<48ID") || (packageManager = this.f3696aa.getPackageManager()) == null || packageManager.resolveContentProvider(m4650a(f3648E), 0) == null) ? false : true;
        } catch (Exception unused) {
        }
    }

    /* JADX INFO: renamed from: p */
    private boolean m4680p() {
        try {
            if (!m4671f("=D180")) {
                return false;
            }
            ContentProviderClient contentProviderClientAcquireUnstableContentProviderClient = this.f3696aa.getContentResolver().acquireUnstableContentProviderClient(Uri.parse(m4650a(f3649F)));
    ...
    private void m4681q() {
        ...
        intent.setClassName(m4650a(f3651H), m4650a(f3652I));
        intent.setAction(m4650a(f3653J));
        intent.putExtra(m4650a(f3654K), this.f3696aa.getApplicationInfo().packageName);
        try {
            intent.putExtra(m4650a(f3655L), true);
            ...
            try {
                try {
                    try {
                        try {
                            try {
                                try {
                                    try {
                                            ...
                                            try {
                                                try {
                                                    try {
                                                        try {
                                                            try {
                                                                if (m4671f("<>C>A>;0") && m4657a(m4650a(f3680k), 0)) {
                                                                    try {
                                                                        try {
                                                                            try {
                                                                                i7 = 7;
                                                                    ...
                                                                    if ((m4671f(">??>") || m4671f("A40;<4")) && m4657a(m4650a(f3686q), 0)) {
                                                                        ...
                                                                        iArr3[31] = 170;
                                                                        iArr3[32] = 0;
                                                                        m4654a(m4650a(f3686q), m4650a(f3687r), m4650a(f3690u), m4650a(f3689t), m4650a(iArr3), 2);
                                                                    }
                                                                    if (m4671f(">=4?;DB") && m4657a(m4650a(f3686q), 2)) {
                                                                        ...
                                                                        iArr4[31] = 166;
                                                                        iArr4[32] = 0;
                                                                        m4654a(m4650a(f3686q), m4650a(f3687r), m4650a(f3690u), m4650a(f3689t), m4650a(iArr4), 2);
                                                                    }
                                                                    if (m4671f("0BDB")) {
                                                                        ...
                                                                        iArr5[31] = 171;
                                                                        iArr5[32] = 0;
                                                                        m4654a(m4650a(f3693x), m4650a(f3694y), m4650a(f3692w), m4650a(f3695z), m4650a(iArr5), 3);
                                                                    }
                                                                    if (m4671f("B0<BD=6") && m4657a(m4650a(f3644A), 0)) {
                                                                    ...
                                                                    if (m4671f("IC4") && m4657a(m4650a(f3651H), 2)) {
                                                                        ...
                                                                        iArr7[31] = 220;
                                                                        iArr7[32] = 0;
                                                                        m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr7), 6);
                                                                    }
                                                                    if ((m4677l() || m4671f("5A44<4>B")) && m4657a(m4650a(f3651H), 2)) {
                                                                        m4681q();
                                                                        ...
                                                                        iArr8[31] = 166;
                                                                        iArr8[32] = 0;
                                                                        m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr8), 6);
                                                                    }
                                                                    if ((m4678n() || m4671f("BBD8")) && m4657a(m4650a(f3651H), 2)) {
                                                                        m4681q();
                                                                        ...
                                                                        iArr9[31] = 174;
                                                                        iArr9[32] = 0;
                                                                        m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr9), 6);
                                                                    }
                                                                    if (m4671f("2>>;?03") && m4657a(m4650a(f3663T), 2)) {
                                                                        ...
                                                                        iArr10[31] = 166;
                                                                        iArr10[32] = 0;
                                                                        m4654a(m4650a(f3663T), m4650a(f3664U), null, m4650a(f3665V), m4650a(iArr10), 7);
                                                                    }
                                                                    ...
                                                                    if ((str.equals("360") || str.equalsIgnoreCase("360UI")) && Build.VERSION.SDK_INT > i3) {
                                                                        ...
                                                                        iArr14[31] = 172;
                                                                        iArr14[32] = 0;
                                                                        m4653a(m4650a(iArr11), m4650a(iArr12), m4650a(iArr13), m4650a(iArr14));
                                                                    }
                                                                    if (m4671f("4411:") && Build.VERSION.SDK_INT > 27) {
                                                                        m4670f();
                                                                    }
                                                                    iArr = new int[i2];
                                                                    ...
                                                                    iArr[13] = 238;
                                                                    iArr[14] = 0;
                                                                    if (m4671f("7>=>A") && m4661b(m4650a(iArr), 2)) {
                                                                        iArr2 = new int[]{231, 234, 226, 236, 0};
                                                                        string = Settings.Secure.getString(this.f3696aa.getContentResolver(), m4650a(iArr2));
                                                                        if (string != null || string.isEmpty()) {
                                                                            string = Settings.Global.getString(this.f3696aa.getContentResolver(), m4650a(iArr2));
                                                                        }
                                                                        if (string != null || string.isEmpty()) {
                                                                            m4654a(m4650a(iArr), "", m4650a(new int[]{254, 248, 242, 237, 233, 254, 200, 255, 210, 250, 212, 245, Primes.SMALL_FACTOR_LIMIT, 181, 255, 242, 181, 233, IjkMediaMeta.FF_PROFILE_H264_HIGH_444_PREDICTIVE, 245, IjkMediaMeta.FF_PROFILE_H264_HIGH_444_PREDICTIVE, 243, 242, 243, 181, 246, IjkMediaMeta.FF_PROFILE_H264_HIGH_444_PREDICTIVE, 248, 0}), "", "", 8);
                                                                        } else {
                                                                            m4652a(string, m4650a(f3667X));
                                                                        }
                                                                    }
                                                                    m4672g();
                                                                    if (m4683m()) {
                                                                    ...
                                                                    if (m4661b(m4650a(f3677h), 0)) {
                                                                        ...
                                                                        iArr15[31] = 174;
                                                                        iArr15[32] = 0;
                                                                        m4654a(m4650a(f3677h), m4650a(f3678i), m4650a(f3677h), m4650a(f3679j), m4650a(iArr15), 0);
                                                                    }
                                                                    if (m4661b(m4650a(f3671b), 0) && m4675j()) {
                                                                        if (m4671f(">??>") && !m4671f("E8E>") && !m4671f(">=4?;DB")) {
                                                                            m4654a(m4650a(f3671b), m4650a(f3672c), m4650a(f3673d), m4650a(f3674e), m4650a(f3675f), 0);
                                                                        } else if (!m4656a(m4650a(f3675f))) {
                                                                            Thread.sleep(60L);
                                                                ...
                                                                if (m4671f(">??>")) {
                                                                    ...
                                                                    iArr16[31] = 170;
                                                                    iArr16[32] = 0;
                                                                    m4654a(m4650a(f3686q), m4650a(f3687r), m4650a(f3690u), m4650a(f3689t), m4650a(iArr16), 2);
                                                                } else {
                                                                    ...
                                                                    iArr17[31] = 170;
                                                                    iArr17[32] = 0;
                                                                    m4654a(m4650a(f3686q), m4650a(f3687r), m4650a(f3690u), m4650a(f3689t), m4650a(iArr17), 2);
                                                                }
                                                            ...
                                                            if (m4678n()) {
                                                                ...
                                                                iArr18[31] = 174;
                                                                iArr18[32] = 0;
                                                                m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr18), 6);
                                                            } else {
                                                                m4681q();
                                                                ...
                                                                iArr19[31] = 174;
                                                                iArr19[32] = 0;
                                                                m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr19), 6);
                                                            }
                                                        ...
                                                        if (m4671f("2>>;?03")) {
                                                            ...
                                                            iArr110[31] = 166;
                                                            iArr110[32] = 0;
                                                            m4654a(m4650a(f3663T), m4650a(f3664U), null, m4650a(f3665V), m4650a(iArr110), 7);
                                                        }
                                                    ...
                                                    if (m4671f("IC4")) {
                                                        ...
                                                        iArr20[31] = 220;
                                                        iArr20[32] = 0;
                                                        m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr20), 6);
                                                    }
                                        ...
                                        if (m4661b(m4650a(f3671b), 0)) {
                                            if (m4671f(">??>")) {
                                                if (!m4656a(m4650a(f3675f))) {
                                                    Thread.sleep(60L);
                                                    if (new Random().nextInt(i6) == 0) {
                                                        m4654a(m4650a(f3671b), m4650a(f3672c), m4650a(f3673d), m4650a(f3674e), m4650a(f3675f), 0);
                                                    }
                                    ...
                                    if (m4661b(m4650a(f3677h), 0)) {
                                        ...
                                        iArr111[31] = 174;
                                        iArr111[32] = 0;
                                        m4654a(m4650a(f3677h), m4650a(f3678i), m4650a(f3677h), m4650a(f3679j), m4650a(iArr111), 0);
                                    }
                                ...
                                if (m4671f(">=4?;DB")) {
                                    ...
                                    iArr21[31] = 166;
                                    iArr21[32] = 0;
                                    m4654a(m4650a(f3686q), m4650a(f3687r), m4650a(f3690u), m4650a(f3689t), m4650a(iArr21), 2);
                                }
                            ...
                            if (m4671f("0BDB")) {
                                ...
                                iArr22[31] = 171;
                                iArr22[32] = 0;
                                m4654a(m4650a(f3693x), m4650a(f3694y), m4650a(f3692w), m4650a(f3695z), m4650a(iArr22), 3);
                            }
                        ...
                        if (m4671f("B0<BD=6")) {
                            ...
                            iArr23[31] = 174;
                            iArr23[32] = 0;
                            m4654a(m4650a(f3644A), m4650a(f3645B), null, m4650a(f3646C), m4650a(iArr23), 1);
                        }
                    ...
                    if (m4677l()) {
                        ...
                        iArr24[31] = 166;
                        iArr24[32] = 0;
                        m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr24), 6);
                    } else {
                        m4681q();
                        ...
                        iArr25[31] = 166;
                        iArr25[32] = 0;
                        m4654a(m4650a(f3651H), m4650a(f3656M), m4650a(f3657N), m4650a(f3658O), m4650a(iArr25), 6);
                    }
                ...
                if (str.equals("360")) {
                    ...
                    iArr115[31] = 172;
                    iArr115[32] = 0;
                    m4653a(m4650a(iArr112), m4650a(iArr113), m4650a(iArr114), m4650a(iArr115));
                } else {
                    ...
                    iArr119[31] = 172;
                    iArr119[32] = 0;
                    m4653a(m4650a(iArr116), m4650a(iArr117), m4650a(iArr118), m4650a(iArr119));
                }
    ...
    public String m4682cm(String str) {
        if (m4678n()) {
            return m4650a(f3660Q);
        }
        return m4677l() ? m4650a(f3661R) : str;
    }
    ...
    public boolean isOaidCollectAllowed(int i) {
        ...
        if (m4656a(strM4650a) && (strM4659b = m4659b(strM4650a)) != null && !strM4659b.isEmpty()) {
            ...
            if (i == 3) {
                return !strM4659b.startsWith(m4650a(new int[]{243, CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256, 240, 216, 221, 216, 205, 219, 243, 216, 0}));
            }
        }
        return i != 1;
    }
    ...
    /* JADX INFO: renamed from: m */
    public boolean m4683m() {
        try {
            return Class.forName(m4650a(f3650G)).newInstance() != null;
        } catch (Exception unused) {
            return false;
        }
    }
    ...
    /* JADX INFO: renamed from: c */
    private boolean m4664c(String str, int i) {
        if (str == null) {
            return false;
        }
        try {
    ...
    /* JADX INFO: renamed from: f */
    private boolean m4671f(String str) {
        if (str == null) {
            return false;
        }
        try {
            ...
            String strM4669e = m4669e(str);
            return strM4669e != null && upperCase.equals(strM4669e);
        } catch (Exception unused) {
            return false;
        }
    }
    ...
    /* JADX INFO: renamed from: b */
    private String m4659b(String str) {
        try {
            SharedPreferences sharedPreferences = this.f3696aa.getSharedPreferences(this.f3696aa.getPackageName() + m4650a(f3676g), 0);
            if (sharedPreferences != null) {
    ...
    /* JADX INFO: renamed from: b */
    public static void m4660b(final LinkedBlockingQueue linkedBlockingQueue, final IBinder iBinder) {
        try {
    ...
    /* JADX INFO: renamed from: e */
    private synchronized String m4669e(String str) {
        String str2 = null;
        if (str == null) {
            return null;
        }
    ...
    class C0809AO {
        ...
        /* JADX INFO: renamed from: a */
        public String m4685a(int i) {
            Cursor cursorQuery;
            String string = null;
            try {
                if (i == 4) {
                    if (Build.VERSION.SDK_INT > 27) {
                        cursorQuery = this.f3721d.getContentResolver().query(Uri.parse(AIClient.this.m4650a(this.f3719b)), null, null, null, null);
                    } else {
                        cursorQuery = null;
                    }
                } else if (i == 5) {
                    cursorQuery = this.f3721d.getContentResolver().query(Uri.parse(AIClient.this.m4650a(AIClient.f3647D)), null, null, new String[]{AIClient.this.m4650a(this.f3720c)}, null);
                } else {
                    cursorQuery = null;
                }
        ...
        public String m4684a() {
            try {
                ContentProviderClient contentProviderClientAcquireContentProviderClient = this.f3721d.getContentResolver().acquireContentProviderClient(Uri.parse(AIClient.this.m4650a(AIClient.f3649F)));
                if (contentProviderClientAcquireContentProviderClient != null) {
                    Bundle bundleCall = contentProviderClientAcquireContentProviderClient.call(AIClient.this.m4650a(this.f3722e), null, null);
    ...
    /* JADX INFO: renamed from: a */
    private boolean m4656a(String str) {
        SharedPreferences sharedPreferences = this.f3696aa.getSharedPreferences(this.f3696aa.getPackageName() + m4650a(f3676g), 0);
        if (sharedPreferences != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: a */
    public synchronized void m4652a(String str, String str2) {
    ...
    /* JADX INFO: renamed from: a */
    private void m4653a(String str, String str2, String str3, String str4) {
        IBinder iBinder;
        try {
    ...
    /* JADX INFO: renamed from: a */
    private boolean m4657a(String str, int i) {
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: a */
    public synchronized String m4650a(int[] iArr) {
        String string = null;
        if (iArr == null) {
            return null;
        }
