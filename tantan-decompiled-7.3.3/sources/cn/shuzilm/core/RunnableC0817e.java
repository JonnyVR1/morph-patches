...
class RunnableC0817e implements Runnable {
    ...
    public RunnableC0817e(Context context, boolean z, int i, Listener listener, Context context2) {
        this.f3815a = context;
        this.f3816b = z;
        this.f3817c = i;
    ...
    public void run() {
        try {
            ...
            if (AIClient.isf || !this.f3816b) {
                ...
                String strZZVTFJRA = DUHelper.zZVTFJRA(this.f3815a, DUHelper.f3732c.m4682cm(upperCase));
                if (strZZVTFJRA == null) {
                    strZZVTFJRA = "NA";
                }
