...
class RunnableC0829q implements Runnable {
    ...
    public RunnableC0829q(DUHelper dUHelper, Context context, String str, String str2, String str3, Listener listener) {
    ...
    public void run() {
        try {
            String strM4722b = DUHelper.f3733d.m4722b(this.f3837a, this.f3838b, this.f3839c, this.f3840d);
            Listener listener = this.f3841e;
            if (listener != null) {
                listener.handler(strM4722b);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
