...
public class SudRoundFrameLayout extends FrameLayout {
    ...
    public SudRoundFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C22511R.styleable.fsm_mgp_RoundFrameLayout, i, 0);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C22511R.styleable.fsm_mgp_RoundFrameLayout_sudTopLeftEnabled, true);
        this.leftTopCorner = z;
        boolean z2 = typedArrayObtainStyledAttributes.getBoolean(C22511R.styleable.fsm_mgp_RoundFrameLayout_sudTopRightEnabled, true);
        this.rightTopCorner = z2;
        boolean z3 = typedArrayObtainStyledAttributes.getBoolean(C22511R.styleable.fsm_mgp_RoundFrameLayout_sudBottomLeftEnabled, true);
        this.leftBottomCorner = z3;
        boolean z4 = typedArrayObtainStyledAttributes.getBoolean(C22511R.styleable.fsm_mgp_RoundFrameLayout_sudBottomRightEnabled, true);
        this.rightBottomCorner = z4;
        int dimension = (int) typedArrayObtainStyledAttributes.getDimension(C22511R.styleable.fsm_mgp_RoundFrameLayout_sudCornerRadius, 0.0f);
        if (z) {
            float f = dimension;
            fArr[0] = f;
            fArr[1] = f;
