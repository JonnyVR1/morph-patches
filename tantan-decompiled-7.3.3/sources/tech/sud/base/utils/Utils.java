...
public class Utils {
    ...
    private static Object getActivityThreadInActivityThreadStaticField() {
        try {
            ...
            SudLogger.m222813e(_TAG, "getActivityThreadInActivityThreadStaticField: " + e.getMessage());
            return null;
        }
    }
    ...
    private static Object getActivityThreadInActivityThreadStaticMethod() {
        try {
            ...
            SudLogger.m222813e(_TAG, "getActivityThreadInActivityThreadStaticMethod: " + e.getMessage());
            return null;
        }
    }
    ...
    public static Application getApp() {
        ...
        if (sApp == null) {
            mnd0.m159157a("reflect failed.");
            return null;
        }
        SudLogger.m222811d(_TAG, UtilsBridge.getCurrentProcessName() + " reflect app success.");
        return sApp;
    }
    ...
    public static void init(Application application) {
        if (application == null) {
            SudLogger.m222811d(_TAG, "app is null.");
            return;
        }
