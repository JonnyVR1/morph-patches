...
public final class RomUtils {
    ...
    private static final String[] ROM_HUAWEI = {HardwareEarMonitorUtils.MANUFACTURER_HUAWEI};
    private static final String[] ROM_VIVO = {HardwareEarMonitorUtils.MANUFACTURER_VIVO};
    private static final String[] ROM_XIAOMI = {HardwareEarMonitorUtils.MANUFACTURER_XIAOMI};
    private static final String[] ROM_OPPO = {HardwareEarMonitorUtils.MANUFACTURER_OPPO};
    ...
    public static RomInfo getRomInfo() {
        ...
        if (isRightRom(brand, manufacturer, strArr2)) {
            ...
            romInfo2.version = getRomVersion(VERSION_PROPERTY_VIVO);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr3)) {
            ...
            romInfo3.version = getRomVersion(VERSION_PROPERTY_XIAOMI);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr4)) {
            ...
            romInfo4.version = getRomVersion(VERSION_PROPERTY_OPPO);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr5)) {
            ...
            romInfo5.version = getRomVersion(VERSION_PROPERTY_LEECO);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr6)) {
            ...
            romInfo6.version = getRomVersion(VERSION_PROPERTY_360);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr7)) {
            ...
            romInfo7.version = getRomVersion(VERSION_PROPERTY_ZTE);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr8)) {
            ...
            romInfo8.version = getRomVersion(VERSION_PROPERTY_ONEPLUS);
            return bean;
        }
        ...
        if (isRightRom(brand, manufacturer, strArr9)) {
            ...
            romInfo9.version = getRomVersion(VERSION_PROPERTY_NUBIA);
            return bean;
        }
