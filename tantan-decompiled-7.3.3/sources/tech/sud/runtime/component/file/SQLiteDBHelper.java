...
public final class SQLiteDBHelper {
    ...
    private static Map<Integer, SQLiteDatabase> f208667a = new HashMap(5);

    /* JADX INFO: renamed from: b */
    private static int f208668b = 0;

    public static void addColumn(int i, String str, String str2) {
        SQLiteDatabase sQLiteDatabase = f208667a.get(Integer.valueOf(i));
    ...
    public static void clear() {
        Iterator<Map.Entry<Integer, SQLiteDatabase>> it = f208667a.entrySet().iterator();
        while (it.hasNext()) {
    ...
    public static void close(int i) {
        ...
        f208667a.remove(Integer.valueOf(i));
    }
    ...
    public static int open(String str) {
        int i = f208668b + 1;
        f208668b = i;
        if (!f208667a.containsKey(Integer.valueOf(i))) {
            ...
            f208667a.put(Integer.valueOf(i), sQLiteDatabaseOpenOrCreateDatabase);
        }
        return i;
    }
