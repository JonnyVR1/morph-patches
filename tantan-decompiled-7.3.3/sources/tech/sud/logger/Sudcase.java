...
public final class Sudcase {
    ...
    public final UtilsBridge.FileHead f211050Sudchar = new UtilsBridge.FileHead("Log");
    ...
    public Sudcase() {
        if (!UtilsBridge.isSDCardEnableByEnvironment() || Utils.getApp().getExternalFilesDir(null) == null) {
            ...
            String str = LogUtils.f211048Sudif;
            sb.append(str);
            sb.append("log");
            sb.append(str);
            this.f211051Suddo = sb.toString();
            return;
        }
        StringBuilder sb2 = new StringBuilder();
        sb2.append(Utils.getApp().getExternalFilesDir(null));
        String str2 = LogUtils.f211048Sudif;
        sb2.append(str2);
        sb2.append("log");
        sb2.append(str2);
        this.f211051Suddo = sb2.toString();
    }
    ...
    public final String toString() {
        ...
        sb.append(str2);
        sb.append("dir: ");
        String str3 = this.f211052Sudif;
        if (str3 == null) {
            str3 = this.f211051Suddo;
        }
        sb.append(str3);
        sb.append(str2);
        ...
        char[] cArr = LogUtils.f211047Suddo;
        sb.append(cArr[0]);
        sb.append(str2);
        ...
        sb.append(this.f211050Sudchar.getAppended());
        return sb.toString();
    }
}
