...
public final class LogUtils {
    ...
    public static final int f208450A = 7;

    /* JADX INFO: renamed from: D */
    public static final int f208451D = 3;

    /* JADX INFO: renamed from: E */
    public static final int f208452E = 6;

    /* JADX INFO: renamed from: I */
    public static final int f208453I = 4;
    public static boolean Sudint = false;
    public static SimpleDateFormat Sudnew = null;

    /* JADX INFO: renamed from: V */
    public static final int f208454V = 2;

    /* JADX INFO: renamed from: W */
    public static final int f208455W = 5;

    /* JADX INFO: renamed from: Suddo, reason: collision with root package name */
    public static final char[] f211047Suddo = {'V', 'D', 'I', 'W', 'E', 'A'};

    /* JADX INFO: renamed from: Sudif, reason: collision with root package name */
    public static final String f211048Sudif = System.getProperty("file.separator");
    ...
    public static void Suddo(String str, String str2, boolean z) throws BadPaddingException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        if (Sudfor.Sudelse) {
            if (z) {
                ...
                epg0 epg0Var = new epg0();
                epg0Var.f95249a = encoded;
                avg0.f73619a.put(str, epg0Var);
                ...
                String strM98821a = amg0.m98821a(bArr);
                SharedPreferences.Editor editorEdit = qlg0.m177003a().f158229a.edit();
                editorEdit.putString("key_aes_key_prefix_" + str, strM98821a);
                editorEdit.commit();
                ...
                String str3 = amg0.m98821a(bArrDoFinal) + LINE_SEP;
                Sudfor.getClass();
                UtilsBridge.writeFileFromString(str, str3, true);
            }
            str2 = avg0.m100463a(str, str2) + LINE_SEP;
        }
        Sudfor.getClass();
    ...
    /* JADX INFO: renamed from: a */
    public static void m222821a(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(7, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: d */
    public static void m222822d(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(3, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: e */
    public static void m222823e(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(6, "", objArr);
    }
    ...
    public static List<File> getLogFiles() {
        Sudcase sudcase = Sudfor;
        String str = sudcase.f211052Sudif;
        if (str == null) {
            str = sudcase.f211051Suddo;
        }
    ...
    /* JADX INFO: renamed from: i */
    public static void m222824i(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(4, "", objArr);
    }
        ...
        if (sudcase.Sudint || i3 == 16) {
            if (i2 >= 2 || i2 >= 2) {
                ...
                if (!sudcase2.Sudint || i3 == 16 || i2 < 2) {
                    ...
                    String str3 = sudelse.f211055Suddo;
                    String[] strArr = sudelse.f211056Sudif;
    ...
    /* JADX INFO: renamed from: v */
    public static void m222825v(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(2, "", objArr);
    }
    ...
    /* JADX INFO: renamed from: w */
    public static void m222826w(Object... objArr) {
        Sudfor.getClass();
        UtilsBridge.isSpace("");
        log(5, "", objArr);
    }
    ...
    public static boolean Suddo(String str, String str2) throws BadPaddingException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        if (zCreateNewFile) {
            Sudcase sudcase = Sudfor;
            sudcase.f211050Sudchar.addFirst("Date of Log", str2);
            Suddo(str, sudcase.f211050Sudchar.toString(), true);
        }
    ...
    public static void Suddo() {
        ...
        if (UtilsBridge.isSpace(logDirPath)) {
            config.f211052Sudif = null;
        } else {
            String str = f211048Sudif;
            if (!logDirPath.endsWith(str)) {
                logDirPath = logDirPath + str;
            }
            config.f211052Sudif = logDirPath;
        }
