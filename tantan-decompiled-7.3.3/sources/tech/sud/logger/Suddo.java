...
public final class Suddo implements Runnable {
    ...
    public final void run() {
        ...
        String str;
        int i2;
        int i3 = this.f211053Suddo;
        String str2 = this.f211054Sudif.f211055Suddo;
        String str3 = this.f211054Sudif.Sudfor + this.Sudfor;
        long j = this.Sudint;
        String str4 = this.Sudnew;
        int i4 = LogUtils.f208454V;
        Date date = new Date();
        ...
        String str6 = sudcase.f211052Sudif;
        if (str6 == null) {
            str6 = sudcase.f211051Suddo;
        }
        sb.append(str6);
        ...
        try {
            ...
            try {
                LogUtils.Suddo(strConcat, str5.substring(11) + str9 + LogUtils.f211047Suddo[i - 2] + "/" + str + str10 + str3 + LogUtils.LINE_SEP, false);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } catch (Exception e2) {
