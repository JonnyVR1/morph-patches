...
public class SQLiteQueryBuilder {
    ...
    public static String buildQueryString(boolean z, String str, String[] strArr, String str2, String str3, String str4, String str5, String str6) {
        if (TextUtils.isEmpty(str3) && !TextUtils.isEmpty(str4)) {
            wg3.m206174a("HAVING clauses are only permitted when using a groupBy clause");
            return null;
        }
        if (!TextUtils.isEmpty(str6) && !sLimitPattern.matcher(str6).matches()) {
            ypg0.m217021a("invalid LIMIT clauses:", str6);
            return null;
        }
        ...
        while (i < length) {
            ...
            if (str2 != null) {
                ...
                if (this.mStrict || !(str.contains(" AS ") || str.contains(" as "))) {
                    yg3.m215829a("Invalid column ", strArr[i]);
                    return null;
                }
                strArr3[i] = str;
            }
    ...
    private void validateQuerySql(SQLiteDatabase sQLiteDatabase, String str, fg4 fg4Var) {
        sQLiteDatabase.getThreadSession().prepare(str, sQLiteDatabase.getThreadDefaultConnectionFlags(true), fg4Var, null);
    }
    ...
    public Cursor query(SQLiteDatabase sQLiteDatabase, String[] strArr, String str, String[] strArr2, String str2, String str3, String str4, String str5, fg4 fg4Var) {
        fg4 fg4Var2;
        ...
        if (!this.mStrict || str == null || str.length() <= 0) {
            ...
            fg4Var2 = fg4Var;
            validateQuerySql(sQLiteDatabase, buildQuery(strArr, "(" + str + ")", str2, str3, str4, str5), fg4Var2);
        }
        String strBuildQuery = buildQuery(strArr, str, str2, str3, str4, str5);
        Log.isLoggable(TAG, 3);
        return sQLiteDatabase.rawQueryWithFactory(this.mFactory, strBuildQuery, strArr2, SQLiteDatabase.findEditTable(this.mTables), fg4Var2);
    }
