...
public final class SQLiteConnectionPool implements Closeable {
    ...
    private void throwIfClosedLocked() {
        ...
        wtq0.m207906a("Cannot perform this operation because the connection pool has been closed.");
    }
    ...
    private SQLiteConnection waitForConnection(String str, int i, fg4 fg4Var) {
        ...
        synchronized (this.mLock) {
            try {
                ...
                if (fg4Var != null) {
                    fg4Var.m125478d(new fg4.InterfaceC16973a() { // from class: io.requery.android.database.sqlite.SQLiteConnectionPool.1
    ...
    public SQLiteConnection acquireConnection(String str, int i, fg4 fg4Var) {
        return waitForConnection(str, i, fg4Var);
    }
    ...
    public void reconfigure(SQLiteDatabaseConfiguration sQLiteDatabaseConfiguration) {
        if (sQLiteDatabaseConfiguration == null) {
            wg3.m206174a("configuration must not be null.");
            return;
        }
        synchronized (this.mLock) {
            try {
