...
public class MusicContentCenterImpl extends IAgoraMusicContentCenter {
        ...
        synchronized (rtcEngineImpl) {
            try {
                if (this.mNativeHandle == 0 || this.mRtcEngine.getNativeHandle() == 0) {
                    Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (createMusicPlayer)");
                } else {
                    ...
                    if (j != 0) {
                        agoraMusicPlayerImpl = new AgoraMusicPlayerImpl(this.mRtcEngine, j, musicPlayerPropertyNativeCreateMusicPlayer.f64019id);
                    }
                }
            } catch (Throwable th) {
                throw th;
    ...
    public int destroyMusicPlayer(IAgoraMusicPlayer iAgoraMusicPlayer) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (destroyMusicPlayer)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public MusicCacheInfo[] getCaches() {
        ...
        synchronized (rtcEngineImpl) {
            try {
                if (this.mNativeHandle == 0 || this.mRtcEngine.getNativeHandle() == 0) {
                    Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (getCaches)");
    ...
    public long getInternalSongCode(long j, String str) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (getInternalSongCode)");
                return 0L;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public String getLyric(long j, int i) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (getLyric)");
                return null;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public String getMusicCharts() {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (getMusicCharts)");
                return null;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public String getMusicCollectionByMusicChartId(int i, int i2, int i3, String str) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (getMusicCollectionByMusicChartId)");
                return null;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public String getSongSimpleInfo(long j) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (getSongSimpleInfo)");
                return null;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int initialize(MusicContentCenterConfiguration musicContentCenterConfiguration) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (initialize)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int isPreloaded(long j) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (isPreloaded)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int preload(long j, String str) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (preload)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int registerEventHandler(IMusicContentCenterEventHandler iMusicContentCenterEventHandler) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (registerEventHandler)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int removeCache(long j) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (removeCache)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int renewToken(String str) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (renewToken)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public String searchMusic(String str, int i, int i2, String str2) {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (searchMusic)");
                return null;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public int unregisterEventHandler() {
        ...
        synchronized (rtcEngineImpl) {
            try {
                ...
                Logging.m88108e(TAG, "MusicContentCenter does not initialize or it may be destroyed (unregisterEventHandler)");
                return -7;
            } catch (Throwable th) {
                throw th;
            }
