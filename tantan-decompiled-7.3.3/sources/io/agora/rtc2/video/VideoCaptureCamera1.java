...
public class VideoCaptureCamera1 extends VideoCaptureCamera {
    ...
    public static class CameraLengthTask implements Runnable {
        ...
        public int getCameraIdLength() {
            ...
            if (!ThreadUtils.awaitUninterruptibly(this.countDown, 2000L)) {
                Logging.m88098e(VideoCaptureCamera1.TAG, "getNumberOfCameras timeout");
            }
            return length;
        }
        ...
        public void run() {
            try {
                try {
                    ...
                    Logging.m88098e(VideoCaptureCamera1.TAG, "getNumberOfCameras: " + e.toString());
                }
            } finally {
    ...
    public class CrErrorCallback implements Camera.ErrorCallback {
        ...
        public void onError(int i, Camera camera) {
            Logging.m88098e(VideoCaptureCamera1.TAG, "Camera ErrorCallback id: " + i);
            int i2 = 3;
    ...
    private static Camera.CameraInfo getCameraInfo(int i) {
        ...
        try {
            ...
            Logging.m88098e(TAG, "getCameraInfo: Camera.getCameraInfo: " + e.getMessage());
            return null;
        }
    }
        ...
        synchronized (mFocalLengthLock) {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m88099e(TAG, "Failed to get camera parameters " + i, e);
                }
                List<VideoCaptureFormat> formatsFromParemeters = getFormatsFromParemeters(parameters, IMAGE_FORMAT);
                try {
                    cameraOpen.release();
                } catch (Exception e2) {
                    Logging.m88099e(TAG, "Failed to release camera: " + i, e2);
                }
                return formatsFromParemeters;
            } catch (RuntimeException e3) {
                Logging.m88098e(TAG, "Camera.open: " + e3.getMessage());
                return null;
            }
        }
    }
    ...
    public static float getFocalLength(Camera.Parameters parameters) {
        if (parameters == null) {
            Logging.m88098e(TAG, "failed get focalLength");
            return -1.0f;
        }
        float focalLength = parameters.getFocalLength();
        Logging.m88097d(TAG, "getCameraParameters: Camera.focalLength: " + focalLength);
        return focalLength;
    }
                ...
                try {
                    ...
                    try {
                        if (focalLength < 2.4f || focalLength >= 3.5f) {
                            ...
                            int i7 = i5 + i4 + 2;
                            Logging.m88097d(str, "getFocalLengthInfo cameraDirection " + (z ? 1 : 0) + " index: " + i7 + " id: " + i2 + " focalLengthType: 2 front: " + z);
                        ...
                        int i8 = i5 + i3 + 1;
                        Logging.m88097d(str, "getFocalLengthInfo cameraDirection " + (z ? 1 : 0) + " index: " + i8 + " id: " + i2 + " focalLengthType: 1 front: " + z);
                        focalLengthInfoArr[i8] = new FocalLengthInfo(z ? 1 : 0, i8, i2, 1);
                        cameraOpen.release();
                    } catch (Exception e) {
                        Logging.m88099e(TAG, "Failed to release camera: " + i2, e);
                    }
                    z2 = true;
                    return z2;
                } catch (RuntimeException e2) {
                    Logging.m88099e(TAG, "Failed to get camera parameters " + i2, e2);
                    return false;
                }
            } catch (RuntimeException e3) {
                Logging.m88098e(TAG, "Camera.open: " + e3.getMessage());
    ...
    private static List<VideoCaptureFormat> getFormatsFromParemeters(@Nullable Camera.Parameters parameters, int i) {
        List<int[]> arrayList;
        String str = TAG;
        Logging.m88100i(str, "getFormatsFromParemeters() ");
        ArrayList arrayList2 = new ArrayList();
        if (parameters != null) {
            List<Integer> supportedPreviewFormats = parameters.getSupportedPreviewFormats();
            if (supportedPreviewFormats == null || supportedPreviewFormats.isEmpty()) {
                Logging.m88100i(str, "failed to getFormatsFromParemeters, preview formats null or empty");
                return arrayList2;
            }
            ...
            while (it.hasNext()) {
                if (it.next().intValue() == i) {
                    try {
                        ...
                        Logging.m88098e(TAG, "Camera.Parameters.getSupportedPreviewFpsRange: " + e.getMessage());
                        arrayList = null;
                    }
                    if (arrayList == null) {
    ...
    public static String getName(int i) {
        ...
        Logging.m88098e(TAG, "getName: " + i + " , failed to getCameraInfo.");
        return null;
    }
    ...
    private boolean isZoomSupported(Camera.Parameters parameters) {
        if (parameters != null) {
            ...
            Logging.m88102w(TAG, "camera zoom is not supported!");
        }
        return false;
    }
    ...
    private void listenForBytebufferFrames() {
        this.mCamera.setPreviewCallbackWithBuffer(new Camera.PreviewCallback() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.13
            ...
            public void onPreviewFrame(final byte[] bArr, final Camera camera) {
                ...
                if (bArr.length == VideoCaptureCamera1.this.mExpectedFrameSize) {
                    VideoFrame videoFrame = new VideoFrame(new NV21Buffer(bArr, VideoCaptureCamera1.this.mCaptureFormat.getWidth(), VideoCaptureCamera1.this.mCaptureFormat.getHeight(), new Runnable() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.13.1
                        ...
                        public void run() {
                            ...
                            C1517413 c1517413 = C1517413.this;
                            if (!z) {
                                VideoCaptureCamera1.this.mPreviewBufferLock.unlock();
                                return;
                            }
                ...
                Logging.m88100i(VideoCaptureCamera1.TAG, "first frame captured.");
        ...
        iSurfaceTextureHelper.startListening(new SurfaceTextureHelper.IVideoCapture() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.12
            ...
            public void onFrame(VideoFrame videoFrame) {
                ...
                try {
                    ...
                    if (buffer == null) {
                        onFrameDropped(9);
                        Logging.m88100i(VideoCaptureCamera1.TAG, "TextureVideoSinkListener copy frame error");
                        VideoCaptureCamera1.this.mPreviewBufferLock.unlock();
                        return;
                    }
    ...
    private void onFaceDetectionRequestChanged() {
        if (this.mEnableAutoFaceFocus) {
            Logging.m88100i(TAG, "startFaceDetection for auto focus enabled");
            Camera.FaceDetectionListener faceDetectionListener = new Camera.FaceDetectionListener() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.3
                ...
                public void onFaceDetection(Camera.Face[] faceArr, Camera camera) {
                    ...
                    if (faceArr[0].score <= 50) {
                        Logging.m88097d(VideoCaptureCamera1.TAG, "face score = " + faceArr[0].score);
                    ...
                    try {
                        ...
                        if (VideoCaptureCamera1.this.isAutoFaceFocusSupported()) {
                            camera.autoFocus(new Camera.AutoFocusCallback() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.3.1
                                ...
                                public void onAutoFocus(boolean z, Camera camera2) {
                                    Logging.m88097d(VideoCaptureCamera1.TAG, "auto face focus called api1 every 3 seconds");
                                    if (camera2 != null) {
                                        try {
                                            camera2.cancelAutoFocus();
                                        } catch (RuntimeException e) {
                                            Logging.m88102w(VideoCaptureCamera1.TAG, "Exception in cancelAutoFocus: " + Log.getStackTraceString(e));
                                        }
                                    }
                                }
                            });
                        ...
                        Logging.m88102w(VideoCaptureCamera1.TAG, "Exception in onFaceDetection callback: " + Log.getStackTraceString(e));
                    }
                }
            };
        ...
        Logging.m88100i(TAG, "startFaceDetection for face dectect enabled");
        ...
        synchronized (mFocalLengthLock) {
            try {
                try {
                    ...
                    Logging.m88098e(TAG, "allocate: Camera.open: " + e.getMessage());
                    return false;
                }
            } catch (Throwable th) {
                throw th;
    ...
    private void releaseCamera() {
        ...
        if (handler == null) {
            Logging.m88102w(TAG, "proxyThread unavailable");
            return;
        }
        try {
                ...
                public Void call() throws Exception {
                    try {
                        if (VideoCaptureCamera1.this.mCamera != null) {
                            ...
                            Logging.m88100i(VideoCaptureCamera1.TAG, "releaseCamera done!");
                        }
                    } catch (Exception e) {
                        Logging.m88098e(VideoCaptureCamera1.TAG, "releaseCamera: failed to release camera, " + e.getMessage());
                    }
                    return null;
                }
            });
        } catch (Exception e) {
            Logging.m88098e(TAG, "releaseCamera: failed to release camera, " + e.getMessage());
        }
    }

    private void safetyStarFaceDetection(Camera.FaceDetectionListener faceDetectionListener) {
        Logging.m88100i(TAG, "facedetect: " + this.mEnableFaceDetection);
        try {
            ...
            Logging.m88099e(TAG, "Failed to stop face detection", e);
    ...
    public void safetyStopFaceDetection() {
        Logging.m88100i(TAG, "stopFaceDetection()");
        try {
            if (this.mIsFaceDetectionStarted) {
                Camera camera = this.mCamera;
                if (camera != null) {
    ...
    private void setPreviewFrameRateMode(Camera.Parameters parameters, int i, boolean z) {
        ...
        if (supportedPreviewFpsRange == null || supportedPreviewFpsRange.size() == 0) {
            Logging.m88102w(TAG, "allocate: camera don't supported fps first.");
    ...
    private void setPreviewFrameRateModePQ(Camera.Parameters parameters, int i) {
        ...
        if (supportedPreviewFrameRates == null || supportedPreviewFrameRates.size() == 0) {
            Logging.m88102w(TAG, "allocate: camera don't supported PQ first.");
        ...
        Logging.m88100i(TAG, String.format(Locale.US, "allocate: matched (%d x %d) @%d -set- @%d, PQ first", Integer.valueOf(this.mCaptureFormat.mWidth), Integer.valueOf(this.mCaptureFormat.mHeight), Integer.valueOf(i), Integer.valueOf(iIntValue)));
    }
    ...
    public boolean allocate(@NonNull VideoCaptureFormat videoCaptureFormat) {
        ...
        Logging.m88100i(str, String.format(locale, "allocate: requested (%d x %d) @%dfps", Integer.valueOf(videoCaptureFormat.getWidth()), Integer.valueOf(videoCaptureFormat.getHeight()), Integer.valueOf(videoCaptureFormat.getFramerate())));
        if (this.mSurfaceTextureHelper == null) {
            Logging.m88098e(str, "surfaceTextureHelper null");
            return false;
        }
        ...
        if (cameraInfo == null) {
            Logging.m88098e(str, "failed to get camera info for " + this.mId);
            releaseCamera();
            return false;
        }
        this.physicalCameraInVaild = false;
        try {
            Boolean bool = (Boolean) ThreadUtils.invokeAtFrontUninterruptibly(this.mProxyThreadHandler, 2000L, new Callable<Boolean>() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.1
                ...
                public Boolean call() throws Exception {
                    Logging.m88100i(VideoCaptureCamera1.TAG, "allocate openCamera camera name:" + VideoCaptureCamera1.this.mPhysicalId);
                    if (VideoCaptureCamera1.this.mPhysicalId >= 0) {
                        synchronized (VideoCaptureCamera1.mFocalLengthLock) {
                            try {
                                Logging.m88100i(VideoCaptureCamera1.TAG, "allocate openCamera start");
                                VideoCaptureCamera1 videoCaptureCamera1 = VideoCaptureCamera1.this;
                                videoCaptureCamera1.mCamera = Camera.open(videoCaptureCamera1.mPhysicalId);
                                Logging.m88100i(VideoCaptureCamera1.TAG, "allocate openCamera done");
                            } catch (RuntimeException e) {
                                Logging.m88098e(VideoCaptureCamera1.TAG, "allocate: Camera.open: " + e.getMessage());
                        ...
                        synchronized (VideoCaptureCamera1.mFocalLengthLock) {
                            try {
                                ...
                                Logging.m88098e(VideoCaptureCamera1.TAG, "allocate: Camera.open: " + e2.getMessage());
            ...
            Logging.m88100i(str, "allocate openCamera result:" + bool);
            if (bool != null && bool.booleanValue()) {
                ...
                Logging.m88100i(str, String.format(locale, "allocate: Rotation dev=%d, cam=%d, facing back? %s", Integer.valueOf(getDeviceRotation()), Integer.valueOf(this.mCameraNativeOrientation), Boolean.valueOf(this.mInvertDeviceOrientationReadings)));
                try {
                    parameters = this.mCamera.getParameters();
                } catch (RuntimeException e) {
                    Logging.m88099e(TAG, "failed to get camera parameters for " + this.mId, e);
                    parameters = null;
                }
                if (parameters == null) {
                    Logging.m88098e(TAG, "failed to get camera parameters");
                    releaseCamera();
                    return false;
                }
                List<VideoCaptureFormat> formatsFromParemeters = getFormatsFromParemeters(parameters, IMAGE_FORMAT);
                ...
                String str2 = TAG;
                Logging.m88100i(str2, "format list: " + Arrays.toString(formatsFromParemeters.toArray()));
                ...
                if (videoCaptureFormatFindBestMatchedCapability == null) {
                    Logging.m88098e(str2, "failed to match capability");
                    releaseCamera();
                    return false;
                }
                ...
                if (supportedFocusModes != null && this.mCameraFocusMode != 0) {
                    Logging.m88100i(str2, "supported focusModes: " + Arrays.toString(supportedFocusModes.toArray()));
                    if (supportedFocusModes.contains("continuous-video") && ((i2 = this.mCameraFocusMode) == 2 || i2 == 1)) {
                        parameters.setFocusMode("continuous-video");
                        Logging.m88100i(str2, "Continuous focus mode continuous video.");
                    } else if (supportedFocusModes.contains("continuous-picture") && ((i = this.mCameraFocusMode) == 3 || i == 1)) {
                        parameters.setFocusMode("continuous-picture");
                        Logging.m88100i(str2, "Continuous focus mode continuous picture.");
                    } else if (supportedFocusModes.contains("auto") && this.mCameraFocusMode == 1) {
                        parameters.setFocusMode("auto");
                        Logging.m88100i(str2, "Continuous focus mode auto.");
                    } else {
                        Logging.m88100i(str2, "Continuous focus mode not supported.");
                    }
                }
                ...
                if (supportedWhiteBalance != null) {
                    Logging.m88100i(str2, "Camera " + this.mId + "supports white balance: " + Arrays.toString(supportedWhiteBalance.toArray()));
                ...
                try {
                    ...
                    try {
                        ...
                        Logging.m88098e(TAG, "allocate: " + e2.getMessage());
                        releaseCamera();
                        return false;
                    } catch (Exception e3) {
                        Logging.m88098e(TAG, "allocate: " + e3.getMessage());
                        releaseCamera();
                        return false;
                    }
                } catch (Exception e4) {
                    Logging.m88098e(TAG, "setParameters: " + e4.getMessage());
                    releaseCamera();
                }
            }
            return false;
        } catch (Exception e5) {
            Logging.m88098e(TAG, "allocate: " + e5.getMessage());
            return false;
        }
    }
    ...
    public void deallocate() {
        String str = TAG;
        Logging.m88100i(str, "deallocate()");
            ...
            handler.post(new Runnable() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.10
                ...
                public void run() {
                    try {
                        ...
                        Logging.m88098e(VideoCaptureCamera1.TAG, "deallocate: failed to setPreviewTexture " + e.getMessage());
                    }
    ...
    public Camera.Parameters getCameraParameters() {
        try {
            ...
            Logging.m88099e(TAG, "getCameraParameters: Camera.getParameters: ", e);
            if (this.mCamera == null) {
                return null;
            }
            safetyStopFaceDetection();
    ...
    public boolean isCameraExposureSupported() {
        ...
        if (this.mCamera != null && (cameraParameters = getCameraParameters()) != null) {
            ...
            Logging.m88100i(TAG, "isCameraExposureSupported compensation min: " + minExposureCompensation + " max: " + maxExposureCompensation);
    ...
    public boolean isFaceDetectSupported() {
        Camera.Parameters cameraParameters;
        if (this.mCamera != null && (cameraParameters = getCameraParameters()) != null) {
            Logging.m88100i(TAG, "face dedect, numDetectedFaces: " + cameraParameters.getMaxNumDetectedFaces());
    ...
    public void onCameraAvailable(String str) {
        if (str.equals(Integer.toString(this.mId))) {
            if (getCameraInfo(this.mId) == null) {
                Logging.m88098e(TAG, "failed to get camera info for " + this.mId);
                return;
            }
            ...
            try {
                ...
                Logging.m88100i(TAG, "onCameraAvailable, Wrong state, mIsRunning: " + this.mIsRunning + " cameraError: " + this.mCameraErrorTrigger);
                this.mPreviewBufferLock.unlock();
            } catch (Throwable th) {
                this.mPreviewBufferLock.unlock();
                throw th;
    ...
    public void onCameraUnavailable(String str) {
        if (str.equals(Integer.toString(this.mId))) {
            ...
            try {
                ...
                Logging.m88100i(TAG, "onCameraUnavailable, Wrong state, mIsRunning: " + this.mIsRunning + " cameraError: " + this.mCameraErrorTrigger);
                this.mPreviewBufferLock.unlock();
            } catch (Throwable th) {
                this.mPreviewBufferLock.unlock();
                throw th;
    ...
    public int setAntiBandingMode(final int i) {
        ...
        if (handler == null || (num = (Integer) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<Integer>() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.9
            ...
            public Integer call() {
                Camera.Parameters parameters;
                Logging.m88100i(VideoCaptureCamera1.TAG, "setAntiBandingMode:" + i);
                ...
                if (!VideoCaptureCamera1.isSupported(camera1ABMode, parameters.getSupportedAntibanding())) {
                    Logging.m88098e(VideoCaptureCamera1.TAG, "not supported anti-banding = " + camera1ABMode);
                    return -1;
                }
                Logging.m88100i(VideoCaptureCamera1.TAG, "AgoraVideo set anti-banding = " + camera1ABMode);
                parameters.setAntibanding(camera1ABMode);
                try {
                    VideoCaptureCamera1.this.mCamera.setParameters(parameters);
                } catch (Exception e) {
                    Logging.m88098e(VideoCaptureCamera1.TAG, "anti banding got exception:" + e);
                }
                return 0;
            }
        })) == null) {
    ...
    public int setEdgeEnhanceMode(int i) {
        Logging.m88098e(TAG, "EdgeEnhancement not supported in camera1 ");
        return -1;
    }
    ...
    public int setExposure(float f, float f2) {
        ...
        fArr2[1] = f2;
        String str = TAG;
        Logging.m88100i(str, "setExposure called camera api1 x = " + f + " y = " + f2);
        if (f < 0.0f || f > this.mRenderView.getWidth() || f2 < 0.0f || f2 > this.mRenderView.getHeight()) {
            Logging.m88100i(str, "setExposure unreasonable inputs!");
            return -1;
        }
        Camera.Parameters cameraParameters = getCameraParameters();
        this.mPreviewParameters = cameraParameters;
        ...
        if (this.mCamera != null) {
            ...
            if (cameraParameters2 == null) {
                Logging.m88097d(str, "getCameraParameters null");
                return -1;
            }
    ...
    public int setExposureCompensation(int i) {
        ...
        Logging.m88100i(str, "compensation step=" + exposureCompensationStep + ", min=" + minExposureCompensation + ", max=" + maxExposureCompensation + ", cur index=" + parameters.getExposureCompensation());
        ...
        try {
            ...
            Logging.m88100i(str, "cur index=" + exposureCompensation + ", ev=" + (exposureCompensationStep * exposureCompensation));
            return 0;
        } catch (Exception e) {
            Logging.m88098e(TAG, "exposure compensation got exception:" + e);
            return -1;
        }
    }
    ...
    public int setFocus(float f, float f2) {
        ...
        if (cameraParameters != null && cameraParameters.getPreviewSize() != null) {
            ...
            try {
                ...
                Logging.m88102w(TAG, "Failed to cancle AutoFocus" + e);
            }
            Camera.Parameters cameraParameters2 = getCameraParameters();
            if (cameraParameters2 == null) {
                return -1;
            ...
            if (cameraParameters2.getMaxNumFocusAreas() > 0) {
                ...
                Logging.m88102w(TAG, "focus areas not supported");
            }
            if (cameraParameters2.getMaxNumMeteringAreas() > 0) {
                ArrayList arrayList2 = new ArrayList();
                ...
                Logging.m88102w(TAG, "metering areas not supported");
            }
            ...
            if (rectFNormalizedToSensor == null) {
                Logging.m88098e(TAG, "Failed to translate input coordinate");
                return -1;
            }
            ...
            if (isSupported("macro", cameraParameters2.getSupportedFocusModes())) {
                ...
                synchronized (this.mObjectLock) {
                    try {
                        ...
                        Logging.m88102w(TAG, "mCamera.setParameters Exception: " + e2);
                    }
                }
            } else {
                Logging.m88102w("focus", "FOCUS_MODE_MACRO is not supported");
            }
            try {
                    ...
                    public void onAutoFocus(boolean z, Camera camera) {
                        ...
                        synchronized (VideoCaptureCamera1.this.mObjectLock) {
                            try {
                                ...
                                Logging.m88102w(VideoCaptureCamera1.TAG, "mCamera setParameters Exception: " + e3);
                            }
                        }
                    }
                });
                ...
                if (rectFNormalizedToView == null) {
                    Logging.m88102w(TAG, "failed to translate coordinate from normalized to view!");
                    return -1;
                }
                rectFNormalizedToView.round(rect);
                notifyCameraExposureAreaChanged(rect);
                ...
                Logging.m88102w(TAG, "mCamera.autoFocus Exception: " + e3);
            }
        }
        return -1;
    }
    ...
    public int setNoiseReductionMode(int i) {
        Logging.m88098e(TAG, "NoiseReduction not supported in camera1 ");
        return -1;
    }
    ...
    public int setTorchMode(boolean z) {
        ...
        this.mTorchMode = i;
        String str = TAG;
        Logging.m88100i(str, "setTorchMode isOn: " + z);
        Camera.Parameters cameraParameters = getCameraParameters();
        ...
        if (supportedFlashModes != null) {
            if (supportedFlashModes.contains("torch")) {
                Logging.m88102w(str, "setTorchMode isFlashSupported: true");
                if (z) {
                ...
                try {
                    ...
                    sb.append(", ");
                    sb.append(e);
                    Logging.m88102w(str2, sb.toString());
                    return -1;
                }
            }
        }
        Logging.m88102w(str, "setTorchMode isFlashSupported: false");
        return -1;
    }

    @Override // io.agora.rtc2.video.IVideoCaptureCamera
    public int setVideoEdgeMode(int i) {
        Logging.m88102w(TAG, "setVideoEdgeMode failure: " + i);
        return -1;
    }
    ...
    public int setVideoStabilityMode(int i) {
        Camera.Parameters cameraParameters;
        String str = TAG;
        Logging.m88102w(str, "setVideoStabilityMode: " + i);
        if (this.mCamera == null || (cameraParameters = getCameraParameters()) == null) {
            return -1;
        }
        if (!cameraParameters.isVideoStabilizationSupported()) {
            Logging.m88098e(str, "not supported VideoStability Mode = " + i);
            return -1;
        }
        if (i == 1) {
        ...
        try {
            ...
            Logging.m88102w(TAG, "setVideoStabilityMode failed, mode: " + i + ", " + e);
            return -1;
        }
    }
    ...
    public int setZoom(float f) {
        ...
        this.mCameraZoomFactor = f;
        Logging.m88100i(TAG, "setCameraZoom api1 called zoomValue =" + f);
        if (f < 0.0f) {
            return -1;
        }
        ...
        if (i2 > cameraParameters.getMaxZoom()) {
            Logging.m88102w(TAG, "zoom value is larger than maxZoom value");
            return -1;
        }
        ...
        try {
            ...
            Logging.m88102w(TAG, "setParameters failed, zoomLevel: " + i2 + ", " + e);
            return -1;
        }
    }
    ...
    public boolean startCaptureMaybeAsync() {
        ...
        if (this.mCamera == null) {
            Logging.m88098e(str, "startCaptureAsync: mCamera is null");
            return false;
        }
        if (this.mProxyThreadHandler == null) {
            Logging.m88102w(str, "proxyThread unavailable");
                ...
                Boolean bool = (Boolean) ThreadUtils.invokeAtFrontUninterruptibly(this.mProxyThreadHandler, 2000L, new Callable<Boolean>() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.2
                    ...
                    public Boolean call() throws Exception {
                        try {
                            ...
                            Logging.m88100i(VideoCaptureCamera1.TAG, "startCaptureMaybeAsync done.");
                            return Boolean.TRUE;
                        } catch (Exception e) {
                            Logging.m88098e(VideoCaptureCamera1.TAG, "startCaptureAsync: Camera.startPreview: " + e.getMessage());
                            return Boolean.FALSE;
                        }
                    }
                });
    ...
    public void stopCaptureAndBlockUntilStopped() {
        ...
        try {
            if (!this.mIsRunning) {
                ...
                if (this.mSurfaceTextureHelper != null) {
                    Logging.m88098e(str, "waiting camera proxy thread disposing timeout after 2000ms");
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(this.mProxyThreadHandler, 2000L, new Callable<Void>() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.7
                    ...
                    public Void call() throws Exception {
                        ...
                        try {
                            ...
                            Logging.m88100i(VideoCaptureCamera1.TAG, "stopPreview done!");
                        } catch (Exception e) {
                            Logging.m88098e(VideoCaptureCamera1.TAG, "stopPreview got exception:" + e.toString());
                        }
                        return null;
                    }
                });
            } catch (Exception e) {
                Logging.m88098e(TAG, "stopPreview got exception:" + e.toString());
            }
        } catch (Throwable th) {
            this.mPreviewBufferLock.unlock();
            ThreadUtils.invokeAtFrontUninterruptibly(this.mProxyThreadHandler, 2000L, new Callable<Void>() { // from class: io.agora.rtc2.video.VideoCaptureCamera1.5
            ...
            if (this.mSurfaceTextureHelper != null) {
                Logging.m88098e(TAG, "waiting camera proxy thread disposing timeout after 2000ms");
                this.mSurfaceTextureHelper.stopListening();
                this.mSurfaceTextureHelper.dispose();
                this.mSurfaceTextureHelper = null;
            }
