...
public class VideoCaptureScreen extends VideoCapture implements SurfaceTextureHelper.IVideoCapture {
    ...
    public VideoCaptureScreen(long j, EglBase.Context context, Intent intent) {
        ...
        this.mMediaProjectionCallback = new MediaProjection.Callback() { // from class: io.agora.rtc2.video.VideoCaptureScreen.1
            ...
            public void onStop() {
                Logging.m88102w(VideoCaptureScreen.TAG, "media projection stopped");
            }
        };
    ...
    public boolean allocate(@NonNull VideoCaptureFormat videoCaptureFormat) {
        int i;
        Logging.m88097d(TAG, String.format(Locale.US, "allocate: requested (%d x %d) %d", Integer.valueOf(videoCaptureFormat.mWidth), Integer.valueOf(videoCaptureFormat.mHeight), Integer.valueOf(videoCaptureFormat.mFramerate)));
    ...
    public synchronized void changeCaptureFormat(int i, int i2, int i3) {
        Logging.m88097d(TAG, "changeCaptureFormat, " + i + " x " + i2);
        this.mWidth = i;
        this.mHeight = i2;
    ...
    public void deallocate() {
        Logging.m88097d(TAG, "deallocate()");
    }
    ...
    public boolean startCaptureMaybeAsync() {
        Logging.m88097d(TAG, "startCaptureMaybeAsync()");
        try {
            ...
            if (mediaProjection == null) {
                Logging.m88098e(TAG, "getMediaProjection error. invalid mediaProjectionPermissionResultData");
                return false;
            }
            if (this.mSurfaceTextureHelper == null) {
                Logging.m88098e(TAG, "SurfaceTextureHelper null");
                return false;
            }
            ...
            Logging.m88099e(TAG, "Failed to getMediaProjection, IllegalStateException!", e);
            return false;
        } catch (SecurityException e2) {
            Logging.m88099e(TAG, "Failed to getMediaProjection, you should start a foreground service before capture screen!", e2);
            return false;
        }
    }
    ...
    public void stopCaptureAndBlockUntilStopped() {
        Logging.m88097d(TAG, "stopCaptureAndBlockUntilStopped()");
        ISurfaceTextureHelper iSurfaceTextureHelper = this.mSurfaceTextureHelper;
        if (iSurfaceTextureHelper == null) {
            return;
        }
                ...
                if (VideoCaptureScreen.this.mMediaProjection != null) {
                    ...
                    try {
                        try {
                            ...
                            Logging.m88098e(VideoCaptureScreen.TAG, "Exception when stopCaptureAndBlockUntilStopped: " + e.getMessage());
                        }
