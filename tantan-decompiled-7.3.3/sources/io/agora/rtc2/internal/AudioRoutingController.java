...
public class AudioRoutingController {
    ...
    public static final int f64027ON = 1;
    ...
    public class AudioDeviceChangedCallbackImpl implements AudioDeviceChangedCallback {
        ...
        public void onAudioDeviceChanged(boolean z, int i) {
            ...
            Logging.m88111i(AudioRoutingController.TAG, str);
        }
    ...
    public class AudioManagerScoStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("android.media.ACTION_SCO_AUDIO_STATE_UPDATED")) {
                ...
                Logging.m88111i(AudioRoutingController.TAG, "Receive SCO state event, prev: " + intent.getIntExtra("android.media.extra.SCO_AUDIO_PREVIOUS_STATE", -99) + ", curr: " + intExtra);
                if (intExtra == 0) {
                    Logging.m88111i(AudioRoutingController.TAG, "SCO state disconnected");
                    AudioRoutingController.this.sendEvent(3, 0);
                } else if (intExtra == 1) {
                    Logging.m88111i(AudioRoutingController.TAG, "SCO state connected");
                    AudioRoutingController.this.sendEvent(3, 1);
                } else {
                    Logging.m88111i(AudioRoutingController.TAG, "SCO device unknown event, state=" + intExtra);
                }
            }
        }
    ...
    public class ControllerAudioDeviceChangeCallback implements WebRtcAudioRecord.AudioRecordRouteCallback, WebRtcAudioTrack.AudioTrackRouteCallback {
        ...
        public void onAudioRecordRouteNotify(int i, AudioDeviceInfo audioDeviceInfo) {
            Logging.m88111i(AudioRoutingController.TAG, "[ADM] Enter ControllerAudioDeviceChangeCallback.onAudioRecordRouteNotify");
        ...
        public void onAudioTrackRouteNotify(int i, AudioDeviceInfo audioDeviceInfo) {
            Logging.m88111i(AudioRoutingController.TAG, "[ADM] Enter ControllerAudioDeviceChangeCallback.onAudioTrackRouteNotify");
            if (AudioRoutingController.deviceSpecialMonitor != null) {
    ...
    public abstract class ControllerBaseState implements ControllerState {
        ...
        public void onEvent(int i, int i2) {
            ...
            if (i == 10) {
                ...
                Logging.m88111i(AudioRoutingController.TAG, sb.toString());
                return;
            }
            if (i != 16) {
                if (i == 20) {
            ...
            Logging.m88113w(AudioRoutingController.TAG, "bluetooth protocol to: ".concat(AudioRoutingController.this.mForceUseA2dp == 1 ? "a2dp" : "hfp"));
        ...
        public void setState(int i) {
            if (i == getState()) {
                Logging.m88111i(AudioRoutingController.TAG, "setState: state not changed!");
            } else {
                AudioRoutingController audioRoutingController = AudioRoutingController.this;
    ...
    public class ControllerStartState extends ControllerBaseState {
        public ControllerStartState() {
            super();
            resetImpl();
            Logging.m88111i(AudioRoutingController.TAG, "ControllerStartState ctor, default routing: " + AudioRoutingController.this.getAudioRouteDesc(AudioRoutingController.this.mDefaultRouting) + ", current routing: " + AudioRoutingController.this.getAudioRouteDesc(AudioRoutingController.this.mCurrentRouting));
        }
        ...
        @Override // io.agora.rtc2.internal.AudioRoutingController.ControllerBaseState, io.agora.rtc2.internal.AudioRoutingController.ControllerState
        public void onEvent(int i, int i2) {
            Logging.m88105d(AudioRoutingController.TAG, "StartState: onEvent: " + AudioRoutingController.this.evtAsString(i) + ", info: " + i2);
            ...
            if (i == 11) {
                if (AudioRoutingController.this.mCurrentRouting == 2 || AudioRoutingController.this.mCurrentRouting == 0 || AudioRoutingController.this.mCurrentRouting == 6 || AudioRoutingController.this.mCurrentRouting == 8 || AudioRoutingController.this.mCurrentRouting == 5) {
                    Logging.m88111i(AudioRoutingController.TAG, "StartState: not proceed with force speaker event for BT/HS");
                    return;
                }
            ...
            if (i == 22) {
                Logging.m88111i(AudioRoutingController.TAG, "Phone state changed: " + i2);
                AudioRoutingController.this.mPhoneInCall = i2 > 0;
                AudioRoutingController audioRoutingController3 = AudioRoutingController.this;
                if (i2 == 0) {
            ...
            if (i == 23) {
                Logging.m88111i(AudioRoutingController.TAG, "Try reconnect bt: ");
            ...
            if (i == 26) {
                Logging.m88111i(AudioRoutingController.TAG, "set routing freeze " + i2);
            ...
            switch (i) {
                ...
                case 2:
                    if (i2 != 0 || AudioRoutingController.this.mIsBTHeadsetPlugged) {
                        ...
                        Logging.m88111i(AudioRoutingController.TAG, "Process BT event, final state: " + AudioRoutingController.this.mIsBTHeadsetPlugged + "(" + i2 + ")");
                        if (!AudioRoutingController.this.mPhoneInCall) {
                ...
                case 3:
                    ...
                    if (!AudioRoutingController.this.mPhoneInCall) {
                        if (i2 == 1) {
                            ...
                            Logging.m88113w(AudioRoutingController.TAG, "Sco disconnect when using Bluetooth device, use a2dp: " + AudioRoutingController.this.mForceUseA2dp);
                            if (AudioRoutingController.this.mForceUseA2dp != 1 && audioManager != null) {
                                ...
                                if (mode == 1 || mode == 2) {
                                    ...
                                    Logging.m88113w(AudioRoutingController.TAG, "Sco try reconnect");
    ...
    public class ControllerStopState extends ControllerBaseState {
        public ControllerStopState() {
            super();
            Logging.m88111i(AudioRoutingController.TAG, "ControllerStopState ctor");
        ...
        @Override // io.agora.rtc2.internal.AudioRoutingController.ControllerBaseState, io.agora.rtc2.internal.AudioRoutingController.ControllerState
        public void onEvent(int i, int i2) {
            Logging.m88105d(AudioRoutingController.TAG, "StopState: onEvent: " + AudioRoutingController.this.evtAsString(i) + ", info: " + i2);
            try {
                AudioManager audioManager = AudioRoutingController.this.getAudioManager();
                if (i != 11) {
                    super.onEvent(i, i2);
                ...
                Logging.m88109e(AudioRoutingController.TAG, "onEvent: Exception ", e);
            }
        }

        @Override // io.agora.rtc2.internal.AudioRoutingController.ControllerBaseState, io.agora.rtc2.internal.AudioRoutingController.ControllerState
        public void reset() {
            Logging.m88111i(AudioRoutingController.TAG, "Monitor stop state, reset");
            resetImpl();
        }
    }
    ...
    public void bluetoothTimeout() {
        ...
        if (this.mScoConnectionAttemps >= 2) {
            Logging.m88108e(TAG, "Start bluetooth sco timeout, actual routing: " + queryCurrentAudioRouting());
            cancelTimer();
            nativeAudioRoutingError(1030);
            checkFallbackA2dpIfNeed();
            return;
        }
        Logging.m88111i(TAG, "Attemps trying, bt sco started: " + this.mIsBTScoStarted + " sco connected: " + zIsBluetoothScoOn + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.mScoConnectionAttemps + " times " + this.mBtScoState + "[" + btStateAsString(this.mBtScoState) + Constants.AES_SUFFIX);
        if (zIsBluetoothScoOn) {
            Logging.m88105d(TAG, "Sco connected success.");
            cancelTimer();
            return;
        }
        startTimer();
    ...
    public void cancelScoPhonestateMonitorTimer() {
        Logging.m88105d(TAG, "cancel sco monitor timer");
    ...
    public void cancelTimer() {
        ...
        Logging.m88105d(TAG, "cancel bluetooth timer");
    ...
    private void checkFallbackA2dpIfNeed() {
        ...
        Logging.m88111i(TAG, "could not use a2dp also..");
    ...
    public int doSetAudioOutputRouting(int i) {
        Logging.m88111i(TAG, "Set audio output routing from " + getAudioRouteDesc(this.mCurrentRouting) + " to " + getAudioRouteDesc(i));
        if (this.mIsFreezed) {
            Logging.m88111i(TAG, "Ignore set routing for freezed");
            return 0;
        }
        try {
            AudioManager audioManager = getAudioManager();
            ...
            if (queryCurrentAudioRouting() != i) {
                ...
                Logging.m88111i(TAG, "Different audio routing from target " + i + ", actual routing: " + iQueryCurrentAudioRouting + "[" + getAudioRouteDesc(iQueryCurrentAudioRouting) + Constants.AES_SUFFIX);
                if (((i == 3 && iQueryCurrentAudioRouting != 3) || (i == 1 && iQueryCurrentAudioRouting != 1)) && audioManager != null && audioManager.getMode() == 3) {
                    Logging.m88105d(TAG, "In communication mode try recover routing! ");
                    audioManager.setMode(0);
                    audioManager.setMode(3);
                    Logging.m88111i(TAG, "Recover mode to : " + audioManager.getMode());
                    if (i != 3) {
                        z = false;
                    }
                    audioManager.setSpeakerphoneOn(z);
                    Logging.m88111i(TAG, "Final speaker is on : " + audioManager.isSpeakerphoneOn());
                }
            }
            ...
            Logging.m88111i(TAG, "Audio routing not changed, ignore: " + i);
            return 0;
        } catch (Exception e) {
            Logging.m88109e(TAG, "Set audio output routing failed:", e);
        }
    }
    ...
    public void doStartBTSco(AudioManager audioManager) {
        try {
            int mode = audioManager.getMode();
            Logging.m88111i(TAG, "doStartBTSco " + Build.VERSION.SDK_INT + " sco on: " + audioManager.isBluetoothScoOn() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + mode + "[" + modeAsString(mode) + Constants.AES_SUFFIX);
            if (audioManager.isBluetoothScoOn()) {
                audioManager.stopBluetoothSco();
                Thread.sleep(600L);
                Logging.m88111i(TAG, "doStartBTSco in sco already on, try stop old connect firstly!");
            }
            audioManager.startBluetoothSco();
        } catch (Exception e) {
            Logging.m88109e(TAG, "doStartBTSco fail ", e);
        }
    }

    private void doStopBTSco(AudioManager audioManager) {
        Logging.m88111i(TAG, "doStopBTSco " + Build.VERSION.SDK_INT + " sco on: " + audioManager.isBluetoothScoOn());
        try {
            audioManager.stopBluetoothSco();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private int getOutputDevicesByStream(int i) {
        try {
            ...
            Logging.m88109e(TAG, "Error while getDevicesForStream! ", e);
            return 0;
        }
    }
    ...
    public void notifyAudioRoutingChanged(int i) {
        Logging.m88111i(TAG, "Enter notifyAudioRoutingChanged: " + i + ", force a2dp: " + this.mForceUseA2dp);
        if (this.mDisposed) {
            Logging.m88113w(TAG, "notifyAudioRoutingChanged returned cause of disposed");
            return;
        }
        if (i == 5 && this.mForceUseA2dp == 1 && mockedBroadcaster == null) {
            AudioManager audioManager = getAudioManager();
            if (audioManager != null && !audioManager.isBluetoothA2dpOn()) {
                Logging.m88113w(TAG, "callback A2DP but its not stable yet");
            }
            i = 10;
        }
    ...
    public void resetAudioRouting() {
        ...
        if (z && this.mIsWiredHeadsetPlugged) {
            ...
            Logging.m88111i(TAG, "In multidevice connect, query target: " + sdkDeviceByAndroidType + ", " + outputDevicesByStream);
        ...
        Logging.m88111i(TAG, "Reset audio routing, default routing: " + getAudioRouteDesc(this.mDefaultRouting) + ", current routing: " + getAudioRouteDesc(this.mCurrentRouting) + ", target routing: " + getAudioRouteDesc(i) + ", actual system routing: " + getAudioRouteDesc(queryCurrentAudioRouting()));
    ...
    public void scoMonitorTimeout() {
        ...
        Logging.m88105d(TAG, "detect phone state exit, mode=" + mode + ", mForceUseA2dp=" + this.mForceUseA2dp);
        if (mode == 3) {
            audioManager.stopBluetoothSco();
            startTimer();
            startBtSco();
    ...
    public void selectRoutingForCommunication(int i) {
        ...
        Logging.m88111i(TAG, "Api select prefer communication route: " + i);
        if (i == 0) {
            if (!this.mAudioDeviceInventory.isDeviceAvaliable(i)) {
                Logging.m88113w(TAG, "Selected route is not connected");
                return;
            }
        } else if (i != 1) {
            if (i == 2) {
    ...
    public static void setAudioDeviceChangedSpecialMonitor(AudioDeviceChangedSpecialMonitor audioDeviceChangedSpecialMonitor) {
        Logging.m88111i(TAG, "setAudioDeviceChangedSpecialMonitor");
    ...
    private void startBtSco() {
        ...
        if (audioManager != null) {
            int mode = audioManager.getMode();
            Logging.m88111i(TAG, "Start opening bt sco " + this.mScoConnectionAttemps + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + mode + "[" + modeAsString(mode) + "] " + this.mBtScoState + "[" + btStateAsString(this.mBtScoState) + "] sco on: " + audioManager.isBluetoothScoOn());
            this.mBtScoState = 0;
            doStartBTSco(audioManager);
        }
    }
    ...
    public void startScoPhonestateMonitorTimer() {
        Logging.m88105d(TAG, "start sco monitor timer for phone state");
    ...
    public void startTimer() {
        ...
        Logging.m88113w(TAG, "start bluetooth timer " + this.dynamic_timeout);
    ...
    public void stopBtSco() {
        if (this.mIsFreezed) {
            Logging.m88111i(TAG, "stop sco ignored for freezed");
            return;
        }
        AudioManager audioManager = getAudioManager();
        if (audioManager != null) {
            int mode = audioManager.getMode();
            Logging.m88111i(TAG, "try to stopping bt sco " + mode + "[" + modeAsString(mode) + "] " + this.mBtScoState + "[" + btStateAsString(this.mBtScoState) + "] sco on: " + audioManager.isBluetoothScoOn());
    ...
    public int updateBluetoothSco(int i) {
        if (this.mPhoneInCall) {
            Logging.m88105d(TAG, "Not process updateBluetoothSco in call");
            return 0;
        }
        if (this.mIsFreezed) {
            Logging.m88111i(TAG, "update bluetoosh sco ignore for freezed");
            return 0;
        }
        Logging.m88105d(TAG, "Update sco control, current sco : " + this.mIsBTScoStarted + ", audio route target: " + i + "[" + getAudioRouteDesc(i) + "] current: " + this.mCurrentRouting + "[" + getAudioRouteDesc(this.mCurrentRouting) + Constants.AES_SUFFIX);
        if (i == 5) {
            if (this.mForceUseA2dp == 0) {
                Logging.m88111i(TAG, "Enable hfp");
                this.mIsBTScoStarted = true;
                startTimer();
                startBtSco();
            } else if (this.mIsBTScoStarted) {
                Logging.m88111i(TAG, "Enable a2dp");
    ...
    public void dispose() {
        ...
        try {
            ...
            Logging.m88109e(TAG, "AudioRoutingController dispose fail: ", e);
        }
    ...
    public String getCurrentUsbAudioDevicePID(int i) {
        ...
        Logging.m88105d(TAG, String.format("getPIDFromNative: mic_or_spk=%d, pid=%s", Integer.valueOf(i), strGetUSBDevicePID == null ? "null" : strGetUSBDevicePID));
    ...
    public String getCurrentUsbAudioDeviceVID(int i) {
        ...
        Logging.m88105d(TAG, String.format("getVIDFromNative: mic_or_spk=%d, vid=%s", Integer.valueOf(i), strGetUSBDeviceVID == null ? "null" : strGetUSBDeviceVID));
    ...
    public int handleHeadsetEvent(int i) {
        ...
        if (audioManager != null && audioManager.isWiredHeadsetOn() && this.mIsWiredHeadsetPlugged && i < 0) {
            Logging.m88111i(TAG, "not handle extra headset event, as headset still connect");
            return -1;
        }
        this.mHeadsetType = i;
        boolean z = i >= 0;
    ...
    public int initialize() {
        ...
        String str;
        Logging.m88111i(TAG, "AudioRoutingController initialize+ (Android: " + Build.VERSION.SDK_INT + ")");
        Context context = this.mContext.get();
        if (context == null) {
            ...
            if (audioManager != null) {
                ...
                sb.append(")");
                Logging.m88111i(TAG, sb.toString());
                this.mScoStateReceiver = new AudioManagerScoStateReceiver();
                IntentFilter intentFilter = new IntentFilter("android.media.ACTION_SCO_AUDIO_STATE_UPDATED");
                jj5.m145018l(context, this.mScoStateReceiver, intentFilter);
                MockedBroadcaseter mockedBroadcaseter = mockedBroadcaster;
                if (mockedBroadcaseter != null) {
                ...
                Logging.m88111i(TAG, "AudioRoutingController initialize-");
                return 0;
            }
            str = "invalid context: can't get AudioManager";
        }
        Logging.m88108e(TAG, str);
        return -1;
    }
    ...
    public int queryCurrentAudioRouting() {
        ...
        try {
            ...
            Logging.m88109e(TAG, "fatal error @queryCurrentAudioRouting", e);
            return -1;
        }
    }
    ...
    public void sendEvent(int i, int i2) {
        Logging.m88105d(TAG, "sendEvent: [" + i + "], extra arg: " + i2 + "... " + this.mEventHandler);
    ...
    public int startMonitoring() {
        Logging.m88105d(TAG, "startMonitoring()");
    ...
    public void stopMonitoring() {
        Logging.m88105d(TAG, "stopMonitoring()");
