package io.agora.mediaplayer.p120gl;
...
import io.agora.rtc2.p121gl.EglBaseProvider;
...
public class PlayerTextureHelper implements IPlayerTextureHelper, SurfaceTexture.OnFrameAvailableListener {
    ...
    private PlayerTextureHelper(EglBase.Context context, Handler handler) {
        ...
        if (handler.getLooper().getThread() != Thread.currentThread()) {
            wtq0.m207906a("SurfaceTextureHelperTest must be created on the handler thread");
            throw null;
        }
        Logging.m88111i(TAG, "PlayerTextureHelper new " + this);
    ...
    public static PlayerTextureHelper create() {
        if (!isEgl14Supported()) {
            Logging.m88111i(TAG, "device not support Egl14");
            return null;
        }
        ...
        Logging.m88111i(TAG, "PlayerTextureHelper create ".concat(str));
        ...
        try {
            return (PlayerTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<PlayerTextureHelper>() { // from class: io.agora.mediaplayer.gl.PlayerTextureHelper.1
                ...
                public PlayerTextureHelper call() {
                    try {
                        return new PlayerTextureHelper(eglBaseContext, handler);
                    } catch (RuntimeException e) {
                        Logging.m88109e(PlayerTextureHelper.TAG, str + " create failure", e);
                        return null;
                    }
                }
            });
        } catch (Exception e) {
            Logging.m88109e(TAG, str.concat(" create failure"), e);
            return null;
        }
    }
    ...
    public void release() {
        ...
        Logging.m88111i(TAG, "release player texture helper " + this);
    }
    ...
    private void stopListening() {
        Logging.m88105d(TAG, "stopListening()");
    ...
    private void tryDeliverTextureFrame() {
        ...
        if (this.textureWidth == 0 || this.textureHeight == 0) {
            Logging.m88107e("Texture size has not been set.");
            return;
        }
        float[] fArr = new float[16];
        ...
        Logging.m88107e("java oesTextureId:" + this.oesTextureId + " context:" + this.sharedContext.getNativeEglContext() + " java pts:" + this.surfaceTexture.getTimestamp());
    }
    ...
    public void updateTexImage() {
        try {
            ...
            Logging.m88108e(TAG, "failed to updateTexImage. " + e.getMessage());
        }
    }
    ...
    public void dispose() {
        ...
        try {
            ...
            Logging.m88109e(TAG, "dispose faile: ", e);
        }
    }
    ...
    public VideoFrame getFakeTextureInfo() {
        Logging.m88110i("getFakeTextureInfo");
    ...
    public Surface getRenderGlSurface() {
        ...
        Logging.m88111i(TAG, "getRenderGlSurface " + this + " renderSurface:" + this.renderSurface);
    ...
    public void resetTextureBufferQueue() {
        synchronized (this.newFrameLock) {
            try {
                Logging.m88111i(TAG, "resetTextureBufferQueue " + this.decodedTextureBuffers.size());
    ...
    public VideoFrame.TextureBuffer textureCopy(final VideoFrame.TextureBuffer textureBuffer) {
        if (textureBuffer.getTextureId() != this.oesTextureId) {
            wtq0.m207906a("textureCopy called with unexpected textureId");
            return null;
        }
        try {
            ...
            Logging.m88111i(TAG, "textureBufferPool release failed: " + e.getMessage());
            return null;
        }
    }
}
