...
public class ContentFileReader {
    ...
    public void closeFile() {
        ...
        if (fileChannel != null) {
            try {
                ...
                e.printStackTrace();
                Logging.m88098e(TAG, "closeFile Step1 error: " + e.getMessage());
            }
        ...
        if (fileInputStream != null) {
            try {
                ...
                e2.printStackTrace();
                Logging.m88098e(TAG, "ContentFileReader closeFile Step2 error: " + e2.getMessage());
            }
        ...
        if (parcelFileDescriptor != null) {
            try {
                ...
                e3.printStackTrace();
                Logging.m88098e(TAG, "ContentFileReader closeFile Step3 error: " + e3.getMessage());
            }
            this.pfd = null;
        }
    }
    ...
    public int read(ByteBuffer byteBuffer) {
        ...
        try {
            ...
            e.printStackTrace();
            Logging.m88098e(TAG, "ContentFileReader read error: " + e.getMessage());
            return -2;
        }
    }
    ...
    public long seek(long j) {
        ...
        try {
            ...
            e.printStackTrace();
            Logging.m88098e(TAG, "seek error: " + e.getMessage());
            return -2L;
        }
    }
}
