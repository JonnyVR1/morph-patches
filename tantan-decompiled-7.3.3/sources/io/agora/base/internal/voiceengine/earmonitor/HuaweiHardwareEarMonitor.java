...
public class HuaweiHardwareEarMonitor implements IHardwareEarMonitor {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            try {
                if ("onResult".equals(method.getName())) {
                    ...
                    Logging.m88097d(HuaweiHardwareEarMonitor.TAG, "onResult: " + iIntValue);
                    if (HuaweiHardwareEarMonitor.this.mIsDestroyed) {
                        Logging.m88097d(HuaweiHardwareEarMonitor.TAG, "ignore result after destroy");
                        ...
                        Logging.m88097d(HuaweiHardwareEarMonitor.TAG, "IAudioKitCallback: HwAudioKit init success");
                    } else {
                        if (iIntValue != 2) {
                            if (iIntValue != 1000) {
                                Logging.m88098e(HuaweiHardwareEarMonitor.TAG, "IAudioKitCallback: onResult error number " + iIntValue);
                                return obj;
                            }
                            ...
                            Logging.m88097d(HuaweiHardwareEarMonitor.TAG, "IAudioKitCallback: Karaoke feature created");
                            return obj;
                        }
                        Logging.m88097d(HuaweiHardwareEarMonitor.TAG, "IAudioKitCallback: HwAudioKit not installed");
                        if (HuaweiHardwareEarMonitor.this.mListener != null) {
                ...
                Logging.m88099e(HuaweiHardwareEarMonitor.TAG, "AudioKitCallbackImpl invoke failed ", th);
                return obj;
            }
        }
    }
    ...
    public void destroyImpl() {
        try {
            ...
            Logging.m88097d(TAG, "karaoke kit destroy call.");
        } catch (Throwable th) {
            Logging.m88099e(TAG, "destroy failed ", th);
        }
    }
    ...
    public void destroy() {
        Logging.m88097d(TAG, "karaoke kit destroy");
        this.mListener = null;
    ...
    public int enableHardwareEarMonitor(boolean z) {
        String str = TAG;
        Logging.m88097d(str, ">>enableHardwareEarMonitor " + z);
        try {
            ...
            if (iIntValue != 0) {
                Logging.m88098e(str, "enableKaraokeFeature failed ret " + iIntValue);
                return -1;
            }
            this.mEarMonitorEnabled = z;
            if (this.mEarMonitorEnabled) {
                Logging.m88097d(str, "latency: " + ((Integer) ReflectUtils.safeCallMethod(this.mHwAudioKaraokeFeatureKitClass, this.mHwAudioKaraokeFeatureKit, "getKaraokeLatency", new Class[0], new Object[0])).intValue());
            }
            return 0;
        } catch (Throwable th) {
            Logging.m88099e(TAG, "enableHardwareEarMonitor failed ", th);
            return -1;
        }
    }
    ...
    public void initialize() {
        String str = TAG;
        Logging.m88097d(str, "HwAudioKit initialize");
        if (this.mContext == null) {
            Logging.m88098e(str, "mContext is null!");
            return;
        }
        if (this.mInitialized) {
            Logging.m88102w(str, "already initialized, ignore");
            return;
        }
        try {
            ...
            Logging.m88097d(str, "HwAudioKit initialize success");
        } catch (Throwable unused) {
            Logging.m88098e(TAG, "HwAudioKit initialize failed");
        }
    }
    ...
    public boolean isHardwareEarMonitorSupported() {
        String str = TAG;
        Logging.m88097d(str, ">>isHardwareEarMonitorSupported");
        try {
            ...
            Logging.m88099e(TAG, "isHardwareEarMonitorSupported false ", th);
            return false;
        }
    }
    ...
    public int setHardwareEarMonitorVolume(int i) {
        ...
        String str = TAG;
        Logging.m88097d(str, ">>setHardwareEarMonitorVolume " + i);
        ...
        try {
            ...
            Logging.m88097d(str, "setParameter ret " + iIntValue);
            return iIntValue != 0 ? -1 : 0;
        } catch (Throwable th) {
            Logging.m88099e(TAG, "setHardwareEarMonitorVolume failed ", th);
            return -1;
        }
    }
