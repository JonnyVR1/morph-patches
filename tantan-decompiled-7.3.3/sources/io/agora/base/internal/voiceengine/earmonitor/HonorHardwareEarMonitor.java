...
public class HonorHardwareEarMonitor implements IHardwareEarMonitor {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) {
            try {
                if ("onResult".equals(method.getName())) {
                    ...
                    Logging.m88102w(HonorHardwareEarMonitor.TAG, "onResult: " + iIntValue);
                    if (HonorHardwareEarMonitor.this.mIsDestroyed) {
                        Logging.m88102w(HonorHardwareEarMonitor.TAG, "ignore result after destroy");
                        if (iIntValue == 0) {
                        ...
                        if (iIntValue != 0) {
                            if (iIntValue != 1000) {
                                Logging.m88098e(HonorHardwareEarMonitor.TAG, "IAudioServiceCallback: onResult error number " + iIntValue);
                                return obj;
                            }
                            ...
                            Logging.m88097d(HonorHardwareEarMonitor.TAG, "IAudioServiceCallback: Karaoke feature bind service success");
                            return obj;
                        }
                        ...
                        Logging.m88097d(HonorHardwareEarMonitor.TAG, "IAudioServiceCallback: HnAudioClient init success");
                    }
                }
                return obj;
            } catch (Throwable th) {
                Logging.m88099e(HonorHardwareEarMonitor.TAG, "AudioServiceCallbackImpl invoke failed ", th);
                return obj;
            }
        }
    }
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                if (((Integer) it.next()).intValue() == 1) {
                    ...
                    Logging.m88102w(TAG, "bind service success");
                    return;
                }
            }
        }
    ...
    private void initHnEarReturnClient() {
        Logging.m88097d(TAG, "initHnEarReturnClient");
    ...
    public void initialize() {
        String str = TAG;
        Logging.m88097d(str, "HnAudioClient initialize");
        ...
        try {
            ...
            Logging.m88097d(str, "HnAudioClient initialize success");
        } catch (Throwable unused) {
            Logging.m88098e(TAG, "HnAudioClient initialize failed");
        }
    }
    ...
    public int setHardwareEarMonitorVolume(int i) {
        ...
        try {
            ...
            Logging.m88098e(str, "setHardwareEarMonitorVolume failed ret " + iIntValue);
            return -1;
        } catch (Throwable th) {
