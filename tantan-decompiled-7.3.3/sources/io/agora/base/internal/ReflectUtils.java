...
public class ReflectUtils {
    ...
    public static Object safeCallMethod(Class<?> cls, Object obj, String str, Class<?>[] clsArr, Object[] objArr) {
        ...
        if (method == null) {
            Logging.m88098e(TAG, "cannot find method:  " + cls.getSimpleName() + "." + str + ":" + Arrays.toString(clsArr));
            return null;
        }
        try {
            return method.invoke(obj, objArr);
        } catch (Throwable th2) {
            Logging.m88098e(TAG, "cannot execute method:  " + cls.getSimpleName() + "." + str + ":" + Arrays.toString(clsArr));
