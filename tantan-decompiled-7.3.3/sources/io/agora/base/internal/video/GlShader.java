...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        Logging.m88100i(TAG, "program created.");
        ...
        if (iArr[0] == 1) {
            ...
            Logging.m88098e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    private static int compileShader(int i, String str) {
        ...
        Logging.m88098e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(iGlCreateShader) + " in shader:\n" + str);
    ...
    public void release() {
        Logging.m88100i(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
