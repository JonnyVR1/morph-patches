...
class MediaCodecUtils {
    ...
    public static /* synthetic */ class C150891 {
    ...
    public static void applyCustomConfig(MediaFormat mediaFormat, String str) {
        ...
        Logging.m88100i(TAG, "applying custom config: " + str);
        try {
            ...
            while (itKeys.hasNext()) {
                ...
                if (next.equals(HW_CONFIGURE_DECODE_FLAG)) {
                    Logging.m88100i(TAG, "unsupported config key.");
                    ...
                    Logging.m88098e(TAG, "unsupported config value type " + obj.getClass());
                }
            }
        } catch (Exception e) {
            Logging.m88098e(TAG, "abort applying custom config: " + e.getMessage());
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (jSONObject.has(HW_CONFIGURE_DECODE_FLAG)) {
                    ...
                    Logging.m88100i(TAG, "applying custom flags: " + iIntValue);
                    return iIntValue;
                }
            } catch (Exception e) {
                Logging.m88098e(TAG, "abort applying custom flags: " + e.getMessage());
                ThrowableExtension.printStackTrace(e);
                return iIntValue;
            }
        }
    ...
    public static Map<String, String> getCodecProperties(VideoCodecType videoCodecType, boolean z) {
        int i = C150891.$SwitchMap$io$agora$base$internal$video$VideoCodecType[videoCodecType.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return new HashMap();
        }
        if (i == 4) {
        ...
        ypg0.m217021a("Unsupported codec: ", videoCodecType);
        return null;
    }
