...
public class EncodedImage {
    ...
    public enum FrameType {
        ...
        public static FrameType fromNativeIndex(int i) {
            ...
            za50.m219101a("Unknown native frame type: ", i);
            return null;
        }
    ...
    @CalledByNative
    private EncodedImage(ByteBuffer byteBuffer, int i, int i2, long j, FrameType frameType, int i3, boolean z, Integer num, VideoFrame.ColorSpace colorSpace) {
    ...
    public static class Builder {
        ...
        /* JADX INFO: renamed from: qp */
        private Integer f64012qp;
        private int rotation;

        public EncodedImage createEncodedImage() {
            return new EncodedImage(this.buffer, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.completeFrame, this.f64012qp, null);
        }
