...
public class WrappedNativeTextureBuffer implements VideoFrame.TextureBuffer, IHandlerReplaceable {
    ...
    public VideoFrame.Buffer applyNewI420Handler(@NonNull Handler handler, @NonNull YuvConverter yuvConverter) {
        ...
        synchronized (this.nativeRefLock) {
            wrappedNativeTextureBuffer = new WrappedNativeTextureBuffer(this.eglContext, this.width, this.height, this.type, this.f64017id, this.transformMatrix, handler, yuvConverter, this.nativeRefCountedPointer, this.fenceObject, this.colorSpace);
        }
    ...
    public WrappedNativeTextureBuffer applyTransformMatrix(Matrix matrix, int i, int i2) {
        ...
        synchronized (this.nativeRefLock) {
            wrappedNativeTextureBuffer = new WrappedNativeTextureBuffer(this.eglContext, i, i2, this.type, this.f64017id, matrix2, this.toI420Handler, this.yuvConverter, this.nativeRefCountedPointer, this.fenceObject, this.colorSpace);
        }
        return wrappedNativeTextureBuffer;
    }
    ...
    public VideoFrame.I010Buffer toI010() {
        ...
        if (handler == null || this.yuvConverter == null) {
            wtq0.m207906a("toI010Handler or yuvConverter is null");
            return null;
        }
        ...
        try {
            ...
            Logging.m88098e("WrappedNativeTextureBuffer", "toI010 failure:" + e.toString());
        }
