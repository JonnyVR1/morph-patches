...
public class SurfaceTextureHelper implements ISurfaceTextureHelper {
    ...
    private SurfaceTextureHelper(String str, EglBase.Context context, Handler handler, int i, int i2) {
        ...
        this.setListenerRunnable = new Runnable() { // from class: io.agora.base.internal.video.SurfaceTextureHelper.2
            ...
            public void run() {
                Logging.m88100i(SurfaceTextureHelper.TAG, "Setting listener to " + SurfaceTextureHelper.this.pendingListener);
        ...
        try {
            ...
            Logging.m88099e(TAG, str + " create eglBase failure", e);
            try {
                this.eglBase.release();
            } catch (Exception e2) {
                Logging.m88099e(TAG, "Failed to release EglBase: " + this.eglBase, e2);
            }
    ...
    public static SurfaceTextureHelper create(String str, final EglBase.Context context, final int i, final int i2) {
        final String str2;
        Logging.m88100i(TAG, "create " + str);
        ...
        try {
            ...
            try {
                return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: io.agora.base.internal.video.SurfaceTextureHelper.1
                    ...
                    public SurfaceTextureHelper call() {
                        try {
                            ...
                            Logging.m88099e(SurfaceTextureHelper.TAG, str2 + " create failure", e);
                            return null;
                        }
                    }
                });
                ...
                e = e;
                Logging.m88099e(TAG, str2 + " create failure", e);
                return null;
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: io.agora.base.internal.video.SurfaceTextureHelper.9
            ...
            public void run() {
                ...
                Logging.m88100i(SurfaceTextureHelper.TAG, SurfaceTextureHelper.this.name + " not release yet, this: " + SurfaceTextureHelper.this + " isOesTextureInUse: " + SurfaceTextureHelper.this.isOesTextureInUse);
            }
        });
    }
    ...
    public VideoFrame.TextureBuffer textureCopy(final VideoFrame.TextureBuffer textureBuffer, final int i) {
        if (textureBuffer == null) {
            Logging.m88102w(TAG, "textureCopy: " + this.name + " textureBuffer is null, IllegalStateException");
            wtq0.m207906a("textureCopy called unexpected with textureBuffer is null");
            return null;
        }
        ...
        Logging.m88102w(TAG, "textureCopy: " + this.name + " handler is null, IllegalStateException");
        wtq0.m207906a("textureCopy called unexpected with handler is null");
        return null;
    }
