...
public class Logging {
    ...
    public static /* synthetic */ class C150501 {
    ...
    public static void m88097d(String str, String str2) {
    ...
    public static void m88099e(String str, String str2, Throwable th) {
    ...
    public static void m88100i(String str, String str2) {
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        int i = C150501.$SwitchMap$io$agora$base$internal$Logging$Severity[severity.ordinal()];
        if (i == 1) {
            level = Level.SEVERE;
        } else if (i != 2) {
    ...
    public static void m88101v(String str, String str2) {
        if ((nativeLogLevel & 2048) != 0) {
            log(Severity.LS_VERBOSE, str, str2);
        }
    }
    ...
    public static void m88103w(String str, String str2, Throwable th) {
    ...
    /* JADX INFO: renamed from: e */
    public static void m88098e(String str, String str2) {
        if ((nativeLogLevel & 4) != 0) {
    ...
    /* JADX INFO: renamed from: w */
    public static void m88102w(String str, String str2) {
        if ((nativeLogLevel & 2) != 0) {
