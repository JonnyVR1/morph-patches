...
public abstract class HttpServlet extends GenericServlet {
    ...
    public void doHead(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        rs40 rs40Var = new rs40(httpServletResponse);
        doGet(httpServletRequest, rs40Var);
        rs40Var.m182854a();
    }
    ...
    public void service(gse0 gse0Var, lse0 lse0Var) throws ServletException, IOException {
        if ((gse0Var instanceof HttpServletRequest) && (lse0Var instanceof HttpServletResponse)) {
            service((HttpServletRequest) gse0Var, (HttpServletResponse) lse0Var);
            return;
        }
