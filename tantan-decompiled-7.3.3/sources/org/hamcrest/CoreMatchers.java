...
import org.hamcrest.core.C22196Is;
...
public class CoreMatchers {
    ...
    public static <T> Matcher<T> m222367is(T t) {
        return C22196Is.m222372is(t);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C22196Is.isA(cls);
    }
    ...
    /* JADX INFO: renamed from: is */
    public static <T> Matcher<T> m222368is(Matcher<T> matcher) {
        return C22196Is.m222373is((Matcher) matcher);
    }
    ...
    /* JADX INFO: renamed from: is */
    public static <T> Matcher<T> m222366is(Class<T> cls) {
        return C22196Is.m222371is((Class) cls);
    }
