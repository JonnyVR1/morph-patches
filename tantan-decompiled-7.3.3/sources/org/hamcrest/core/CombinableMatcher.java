...
public class CombinableMatcher<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    public static final class CombinableEitherMatcher<X> {
        ...
        public CombinableMatcher<X> m222370or(Matcher<? super X> matcher) {
            return new CombinableMatcher(this.first).m222369or(matcher);
        }
    }
    ...
    /* JADX INFO: renamed from: or */
    public CombinableMatcher<T> m222369or(Matcher<? super T> matcher) {
