...
public abstract class FramedataImpl1 implements Framedata {
    ...
    public static /* synthetic */ class C222001 {
    ...
    public static FramedataImpl1 get(Framedata.Opcode opcode) {
        if (opcode == null) {
            wg3.m206174a("Supplied opcode cannot be null");
            return null;
        }
        switch (C222001.$SwitchMap$org$java_websocket$framing$Framedata$Opcode[opcode.ordinal()]) {
            case 1:
