...
public abstract class WebSocketServer extends AbstractWebSocket implements Runnable {
    ...
    public WebSocketServer(InetSocketAddress inetSocketAddress, int i, List<Draft> list, Collection<WebSocket> collection) {
        ...
        if (inetSocketAddress == null || i < 1 || collection == null) {
            wg3.m206174a("address and connectionscontainer must not be null and you need at least 1 decoder");
            throw null;
        }
        if (list == null) {
    ...
    public void start() {
        if (this.selectorthread == null) {
            ...
            wtq0.m207906a(getClass().getName().concat(" can only be started once."));
        }
    }
