...
public class SSLSocketChannel implements WrappedByteChannel, ByteChannel {
    ...
    public static /* synthetic */ class C221981 {
    ...
    public SSLSocketChannel(SocketChannel socketChannel, SSLEngine sSLEngine, ExecutorService executorService, SelectionKey selectionKey) throws IOException {
        if (socketChannel == null || sSLEngine == null || this.executor == executorService) {
            wg3.m206174a("parameter must not be null");
            throw null;
        }
    ...
    private boolean doHandshake() throws IOException {
        ...
        while (handshakeStatus2 != SSLEngineResult.HandshakeStatus.FINISHED && handshakeStatus2 != SSLEngineResult.HandshakeStatus.NOT_HANDSHAKING) {
            int i = C221981.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[handshakeStatus2.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    this.myNetData.clear();
                    try {
                        ...
                        int i2 = C221981.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultWrap.getStatus().ordinal()];
                        if (i2 == 1) {
                            this.myNetData.flip();
                            ...
                            if (i2 == 3) {
                                ...
                                if (i2 != 4) {
                                    qg50.m176437a("Invalid SSL status: ", sSLEngineResultWrap.getStatus());
                                    return false;
                                }
                                try {
                                    this.myNetData.flip();
                    ...
                    xtq0.m213103a("Invalid SSL status: ", handshakeStatus2);
                    return false;
                }
                ...
                try {
                    ...
                    int i3 = C221981.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultUnwrap.getStatus().ordinal()];
                    if (i3 != 1) {
                        if (i3 == 2) {
                            ...
                            if (i3 != 4) {
                                qg50.m176437a("Invalid SSL status: ", sSLEngineResultUnwrap.getStatus());
                                return false;
                            }
    ...
    public synchronized int read(ByteBuffer byteBuffer) throws IOException {
        ...
        if (i > 0 || this.peerNetData.hasRemaining()) {
            ...
            while (this.peerNetData.hasRemaining()) {
                ...
                try {
                    SSLEngineResult sSLEngineResultUnwrap = this.engine.unwrap(this.peerNetData, this.peerAppData);
                    int i2 = C221981.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultUnwrap.getStatus().ordinal()];
                    if (i2 == 1) {
                        this.peerAppData.flip();
                        return ByteBufferUtils.transferByteBuffer(this.peerAppData, byteBuffer);
                    }
    ...
    public synchronized int write(ByteBuffer byteBuffer) throws IOException {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            int i = C221981.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[sSLEngineResultWrap.getStatus().ordinal()];
            if (i == 1) {
                this.myNetData.flip();
                while (this.myNetData.hasRemaining()) {
