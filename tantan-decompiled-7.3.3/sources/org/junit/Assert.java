...
public class Assert {
    ...
    private static void failNotNull(String str, Object obj) {
        fail((str != null ? str.concat(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR) : "") + "expected null, but was:<" + obj + ">");
    }

    private static void failNotSame(String str, Object obj, Object obj2) {
        fail((str != null ? str.concat(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR) : "") + "expected same:<" + obj + "> was not:<" + obj2 + ">");
    }

    private static void failSame(String str) {
        fail((str != null ? str.concat(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR) : "").concat("expected not same"));
    }
    ...
    public static String format(String str, Object obj, Object obj2) {
        ...
        if (str != null && !str.equals("")) {
            strConcat = str.concat(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        }
