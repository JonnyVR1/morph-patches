...
import org.eclipse.jetty.p127io.BufferDateCache;
...
public class HttpFields {
    ...
    public static class DateGenerator {
        ...
        private final GregorianCalendar f206816gc;

        private DateGenerator() {
            this.buf = new StringBuilder(32);
            this.f206816gc = new GregorianCalendar(HttpFields.__GMT);
        }

        public void formatCookieDate(StringBuilder sb, long j) {
            this.f206816gc.setTimeInMillis(j);
            int i = this.f206816gc.get(7);
            int i2 = this.f206816gc.get(5);
            int i3 = this.f206816gc.get(2);
            int i4 = this.f206816gc.get(1) % 10000;
        ...
        public String formatDate(long j) {
            ...
            int i2 = this.f206816gc.get(5);
            int i3 = this.f206816gc.get(2);
            int i4 = this.f206816gc.get(1);
            int i5 = this.f206816gc.get(11);
            int i6 = this.f206816gc.get(12);
            int i7 = this.f206816gc.get(13);
    ...
    public long getDateField(String str) {
        ...
        wg3.m206174a("Cannot convert date: ".concat(strValueParameters));
        return 0L;
    }
    ...
    public Enumeration<String> getValues(String str) {
        ...
        return field == null ? Collections.enumeration(Collections.EMPTY_LIST) : new Enumeration<String>(field) { // from class: org.eclipse.jetty.http.HttpFields.4
            ...
            @Override // java.util.Enumeration
            public boolean hasMoreElements() {
                return this.f206814f != null;
            }

            @Override // java.util.Enumeration
            public String nextElement() throws NoSuchElementException {
                Field field2 = this.f206814f;
                if (field2 != null) {
                    this.f206814f = field2._next;
    ...
    public Enumeration<String> getValues(Buffer buffer) {
        ...
        return new Enumeration<String>(field) { // from class: org.eclipse.jetty.http.HttpFields.5
            ...
            @Override // java.util.Enumeration
            public boolean hasMoreElements() {
                return this.f206815f != null;
            }

            @Override // java.util.Enumeration
            public String nextElement() throws NoSuchElementException {
                Field field2 = this.f206815f;
                if (field2 != null) {
                    this.f206815f = field2._next;
                    return field2.getValue();
                }
                mor.m159308a();
                return null;
