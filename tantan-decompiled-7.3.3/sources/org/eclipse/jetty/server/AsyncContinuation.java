...
public class AsyncContinuation implements o21, Continuation {
    ...
    private List<r21> _asyncListeners;
    ...
    private List<r21> _lastAsyncListeners;
    ...
    public class AsyncEventState extends p21 {
        private ase0 _dispatchContext;
        private String _pathInContext;
        private final ase0 _suspendedContext;
        private Timeout.Task _timeout;

        public AsyncEventState(ase0 ase0Var, gse0 gse0Var, lse0 lse0Var) {
            super(AsyncContinuation.this, gse0Var, lse0Var);
            this._timeout = AsyncContinuation.this.new AsyncTimeout();
            this._suspendedContext = ase0Var;
        ...
        public ase0 getDispatchContext() {
        ...
        public ase0 getServletContext() {
            ase0 ase0Var = this._dispatchContext;
            return ase0Var == null ? this._suspendedContext : ase0Var;
        }

        public ase0 getSuspendedContext() {
    ...
    private void doSuspend(ase0 ase0Var, gse0 gse0Var, lse0 lse0Var) {
        synchronized (this) {
            try {
                int i = this._state;
                if (i != 1 && i != 6) {
                ...
                if (asyncEventState != null && gse0Var == asyncEventState.getSuppliedRequest() && lse0Var == this._event.getSuppliedResponse() && ase0Var == this._event.getServletContext()) {
                    this._event._dispatchContext = null;
                    this._event._pathInContext = null;
                } else {
                    this._event = new AsyncEventState(ase0Var, gse0Var, lse0Var);
                }
                this._state = 2;
                List<r21> list = this._lastAsyncListeners;
        ...
        List<r21> list2 = this._lastAsyncListeners;
        if (list2 != null) {
            Iterator<r21> it = list2.iterator();
            while (it.hasNext()) {
                try {
    ...
    @Override // p153l.o21
    public void addListener(r21 r21Var) {
        synchronized (this) {
            try {
                if (this._asyncListeners == null) {
                    this._asyncListeners = new ArrayList();
                }
                this._asyncListeners.add(r21Var);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // p153l.o21, org.eclipse.jetty.continuation.Continuation
    ...
    public <T extends r21> T createListener(Class<T> cls) throws ServletException {
        try {
            ...
            for (r21 r21Var : list2) {
                ...
                if (th != null) {
                    try {
                        ...
                        r21Var.onError(this._event);
                    } catch (Exception e) {
                        LOG.warn(e);
                    }
                } else {
                    r21Var.onComplete(asyncEventState);
                }
            }
        }
        if (list != null) {
        ...
        synchronized (this) {
            try {
                ...
                if (i == 2 || i == 4) {
                    ...
                    List<r21> list2 = this._asyncListeners;
                    this._expired = true;
                    if (list2 != null) {
                        Iterator<r21> it = list2.iterator();
                        while (it.hasNext()) {
    ...
    public void suspend(ase0 ase0Var, gse0 gse0Var, lse0 lse0Var) {
        synchronized (this) {
            try {
                this._responseWrapped = !(lse0Var instanceof Response);
                doSuspend(ase0Var, gse0Var, lse0Var);
                if (gse0Var instanceof HttpServletRequest) {
                    this._event._pathInContext = URIUtil.addPaths(((HttpServletRequest) gse0Var).getServletPath(), ((HttpServletRequest) gse0Var).getPathInfo());
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void addListener(r21 r21Var, gse0 gse0Var, lse0 lse0Var) {
        synchronized (this) {
            try {
                if (this._asyncListeners == null) {
                    this._asyncListeners = new ArrayList();
    ...
    public void suspend(lse0 lse0Var) {
        ...
        this._responseWrapped = true ^ (lse0Var instanceof Response);
        doSuspend(this._connection.getRequest().getServletContext(), this._connection.getRequest(), lse0Var);
    }
    ...
    public void dispatch(ase0 ase0Var, String str) {
        this._event._dispatchContext = ase0Var;
