...
public class ContextHandler extends ScopedHandler implements Attributes, Server.Graceful {
    ...
    public void callContextDestroyed(cse0 cse0Var, ServletContextEvent servletContextEvent) {
        cse0Var.contextDestroyed(servletContextEvent);
    }

    public void callContextInitialized(cse0 cse0Var, ServletContextEvent servletContextEvent) {
        cse0Var.contextInitialized(servletContextEvent);
        ...
        try {
                ...
                try {
                    ...
                    if (obj2 != null) {
                        ...
                        for (int i2 = 0; i2 < size2; i2++) {
                            ((ise0) LazyList.get(this._requestListeners, i2)).requestInitialized(servletRequestEvent);
                        }
                    }
                    ...
                    if (this._requestListeners != null) {
                        ...
                        while (true) {
                            ...
                            ((ise0) LazyList.get(this._requestListeners, i3)).requestDestroyed(servletRequestEvent2);
                            size3 = i3;
                        }
                    }
            ...
            if (this._requestListeners != null) {
                ...
                while (true) {
                    ...
                    ((ise0) LazyList.get(this._requestListeners, i5)).requestDestroyed(servletRequestEvent3);
                    size5 = i5;
                }
            }
            ...
            if (zTakeNewContext) {
                if (this._requestListeners != null) {
                    ...
                    while (true) {
                        ...
                        ((ise0) LazyList.get(this._requestListeners, i7)).requestDestroyed(servletRequestEvent4);
                        size7 = i7;
                    }
                }
    ...
    public void doStart() throws Exception {
        ...
        if (this._contextPath == null) {
            wtq0.m207906a("Null contextPath");
            return;
        }
        ...
        try {
            ...
            if (this._contextListeners != null) {
                ...
                while (true) {
                    ...
                    ((cse0) LazyList.get(this._contextListeners, i)).contextDestroyed(servletContextEvent);
                    size = i;
                }
            }
    ...
    public void startContext() throws Exception {
        ...
        if (this._contextListeners != null) {
            ...
            for (int i = 0; i < LazyList.size(this._contextListeners); i++) {
                callContextInitialized((cse0) LazyList.get(this._contextListeners, i), servletContextEvent);
            }
        }
    }
    ...
    public class Context implements ase0 {
        ...
        public umi.InterfaceC20598a addFilter(String str, Class<? extends gli> cls) {
        ...
        public fse0.InterfaceC17064a addServlet(String str, Class<? extends yre0> cls) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }
        ...
        public ase0 getContext(String str) {
            int i;
            int i2;
        ...
        @Deprecated
        public yre0 getServlet(String str) throws ServletException {
            return null;
        }
        ...
        public synchronized void removeAttribute(String str) {
            ...
            if (attribute != null && ContextHandler.this._contextAttributeListeners != null) {
                ...
                for (int i = 0; i < LazyList.size(ContextHandler.this._contextAttributeListeners); i++) {
                    ((bse0) LazyList.get(ContextHandler.this._contextAttributeListeners, i)).m106236i(servletContextAttributeEvent);
                }
            }
        }
        ...
        public synchronized void setAttribute(String str, Object obj) {
            try {
                ...
                if (ContextHandler.this._contextAttributeListeners != null) {
                    ...
                    for (int i = 0; i < LazyList.size(ContextHandler.this._contextAttributeListeners); i++) {
                        bse0 bse0Var = (bse0) LazyList.get(ContextHandler.this._contextAttributeListeners, i);
                        if (attribute == null) {
                            bse0Var.m106234b(servletContextAttributeEvent);
                        } else if (obj == null) {
                            bse0Var.m106236i(servletContextAttributeEvent);
                        } else {
                            bse0Var.m106235f(servletContextAttributeEvent);
                        }
                    }
                }
            } catch (Throwable th) {
        ...
        public umi.InterfaceC20598a addFilter(String str, gli gliVar) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }

        public fse0.InterfaceC17064a addServlet(String str, yre0 yre0Var) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }
        ...
        public umi.InterfaceC20598a addFilter(String str, String str2) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }

        public fse0.InterfaceC17064a addServlet(String str, String str2) {
            ContextHandler.LOG.warn(__unimplmented, new Object[0]);
            return null;
        }
    ...
    public static class CLDump implements Dumpable {
        ...
        public void dump(Appendable appendable, String str) throws IOException {
            ClassLoader parent;
            Object cLDump;
            appendable.append(String.valueOf(this._loader)).append(SignParameters.NEW_LINE);
