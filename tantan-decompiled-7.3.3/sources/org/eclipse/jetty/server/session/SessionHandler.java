...
public class SessionHandler extends ScopedHandler {
    ...
    public void checkRequestedSessionId(Request request, HttpServletRequest httpServletRequest) {
        ...
        if (requestedSessionId != null && sessionManager != null) {
            hnl httpSession = sessionManager.getHttpSession(requestedSessionId);
            ...
            try {
                ...
                try {
                    ...
                    if (this._sessionManager != null) {
                        ...
                        if (session2 == null) {
                            ...
                            try {
                                ...
                                hnlVar = session2;
                                if (hnlVar != null) {
                                    this._sessionManager.complete(hnlVar);
                                }
                                hnl session3 = request.getSession(false);
                                if (session3 != null && session == null && session3 != hnlVar) {
                    ...
                    if (logger.isDebugEnabled()) {
                        ...
                        logger.debug("session=" + hnlVar, new Object[0]);
                    }
                    ScopedHandler scopedHandler = this._nextScope;
                    ...
                    hnl session4 = request.getSession(false);
