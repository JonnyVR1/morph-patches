...
public abstract class AbstractSessionManager extends AbstractLifeCycle implements SessionManager {
    ...
    static final lnl __nullSessionContext = new lnl() { // from class: org.eclipse.jetty.server.session.AbstractSessionManager.1
        public Enumeration getIds() {
            return Collections.enumeration(Collections.EMPTY_LIST);
        }

        public hnl getSession(String str) {
            return null;
        }
    };
    ...
    protected final List<jnl> _sessionAttributeListeners = new CopyOnWriteArrayList();
    protected final List<mnl> _sessionListeners = new CopyOnWriteArrayList();
    ...
    protected String _sessionIdPathParameterNamePrefix = Constants.PACKNAME_END + this._sessionIdPathParameterName + "=";
    protected int _maxCookieAge = -1;
    protected final CounterStatistic _sessionsStats = new CounterStatistic();
    protected final SampleStatistic _sessionTimeStats = new SampleStatistic();
    private pse0 _cookieConfig = new pse0() { // from class: org.eclipse.jetty.server.session.AbstractSessionManager.2
    ...
    public interface SessionIf extends hnl {
        @Override // p153l.hnl
        ...
        /* synthetic */ ase0 getServletContext();

        AbstractSession getSession();

        /* synthetic */ lnl getSessionContext();
    ...
    public static hnl renewSession(HttpServletRequest httpServletRequest, hnl hnlVar, boolean z) {
        HashMap map = new HashMap();
        Enumeration<String> attributeNames = hnlVar.getAttributeNames();
        while (attributeNames.hasMoreElements()) {
            String strNextElement = attributeNames.nextElement();
            map.put(strNextElement, hnlVar.getAttribute(strNextElement));
            hnlVar.removeAttribute(strNextElement);
        }
        hnlVar.invalidate();
        hnl session = httpServletRequest.getSession(true);
        if (z) {
    ...
    public HttpCookie access(hnl hnlVar, boolean z) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        AbstractSession session = ((SessionIf) hnlVar).getSession();
        ...
        HttpCookie sessionCookie = getSessionCookie(hnlVar, context == null ? "/" : context.getContextPath(), z);
        session.cookieSet();
    ...
    public void addEventListener(EventListener eventListener) {
        if (eventListener instanceof jnl) {
            this._sessionAttributeListeners.add((jnl) eventListener);
        }
        if (eventListener instanceof mnl) {
            this._sessionListeners.add((mnl) eventListener);
        }
    }
    ...
    public void addSession(AbstractSession abstractSession, boolean z) {
        ...
        if (z) {
            ...
            if (this._sessionListeners != null) {
                ...
                Iterator<mnl> it = this._sessionListeners.iterator();
                while (it.hasNext()) {
    ...
    @Override // org.eclipse.jetty.server.SessionManager
    public void complete(hnl hnlVar) {
        ((SessionIf) hnlVar).getSession().complete();
    }
    ...
    public void doSessionAttributeListeners(AbstractSession abstractSession, String str, Object obj, Object obj2) {
        ...
        for (jnl jnlVar : this._sessionAttributeListeners) {
            if (obj == null) {
                jnlVar.m146262c(httpSessionBindingEvent);
            } else if (obj2 == null) {
                jnlVar.m146261a(httpSessionBindingEvent);
            } else {
                jnlVar.m146263h(httpSessionBindingEvent);
            }
        }
    }
    ...
    @Override // org.eclipse.jetty.server.SessionManager
    public String getClusterId(hnl hnlVar) {
        return ((SessionIf) hnlVar).getSession().getClusterId();
    }
    ...
    @Override // org.eclipse.jetty.server.SessionManager
    public hnl getHttpSession(String str) {
    ...
    @Override // org.eclipse.jetty.server.SessionManager
    public String getNodeId(hnl hnlVar) {
        return ((SessionIf) hnlVar).getSession().getNodeId();
    }
    ...
    @Override // org.eclipse.jetty.server.SessionManager
    public HttpCookie getSessionCookie(hnl hnlVar, String str, boolean z) {
        if (!isUsingCookies()) {
            return null;
        }
        ...
        String str3 = str;
        String nodeId = getNodeId(hnlVar);
        String str4 = this._sessionComment;
        String str5 = this._sessionCookie;
        if (str4 == null) {
            return new HttpCookie(str5, nodeId, this._sessionDomain, str3, this._cookieConfig.getMaxAge(), this._cookieConfig.isHttpOnly(), this._cookieConfig.isSecure() || (isSecureRequestOnly() && z));
        }
        return new HttpCookie(str5, nodeId, this._sessionDomain, str3, this._cookieConfig.getMaxAge(), this._cookieConfig.isHttpOnly(), this._cookieConfig.isSecure() || (isSecureRequestOnly() && z), this._sessionComment, 1);
    }
    ...
    @Override // org.eclipse.jetty.server.SessionManager
    public boolean isValid(hnl hnlVar) {
        return ((SessionIf) hnlVar).getSession().isValid();
    }

    @Override // org.eclipse.jetty.server.SessionManager
    public hnl newHttpSession(HttpServletRequest httpServletRequest) {
    ...
    public void setSessionIdPathParameterName(String str) {
        ...
        if (str != null && !"none".equals(str)) {
            str2 = Constants.PACKNAME_END + this._sessionIdPathParameterName + "=";
        }
    ...
    public void removeSession(hnl hnlVar, boolean z) {
        removeSession(((SessionIf) hnlVar).getSession(), z);
    }
