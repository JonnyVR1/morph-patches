        ...
        public Buffer getDirectBuffer() {
            ...
            if (buffer == null) {
                ...
                if (directBuffer == null) {
                    ...
                    buffer = m31.m156916a(this._directBuffer, null, directBuffer) ? directBuffer : this._directBuffer.get();
                }
            }
            if (buffer == null) {
                return null;
        ...
        public Buffer getIndirectBuffer() {
            ...
            if (buffer == null) {
                ...
                if (indirectBuffer == null) {
                    ...
                    buffer = m31.m156916a(this._indirectBuffer, null, indirectBuffer) ? indirectBuffer : this._indirectBuffer.get();
                }
            }
            if (buffer == null) {
                return null;
