...
public class Response implements HttpServletResponse {
    ...
    public static class NullOutput extends ese0 {
        private NullOutput() {
        }
        ...
        if (sessionManager != null) {
            ...
            if (sessionIdPathParameterNamePrefix != null) {
                ...
                if (request.isRequestedSessionIdFromCookie()) {
                    ...
                    hnl session = request.getSession(false);
    ...
    public ese0 getOutputStream() throws IOException {
        if (this._outputState != 0 && this._outputState != 1) {
            wtq0.m207906a("WRITER");
            return null;
        }
        ese0 outputStream = this._connection.getOutputStream();
        this._outputState = 1;
        return outputStream;
    }
    ...
    public void sendRedirect(String str) throws IOException {
        ...
        if (!URIUtil.hasScheme(str)) {
            ...
            if (str.startsWith("/")) {
                ...
                if (strAddPaths == null) {
                    wtq0.m207906a("path cannot be above root");
                    return;
                } else {
    ...
    public void setBufferSize(int i) {
        if (isCommitted() || getContentCount() > 0) {
            wtq0.m207906a("Committed or content written");
        } else {
