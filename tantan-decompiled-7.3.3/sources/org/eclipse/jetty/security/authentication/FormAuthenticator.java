...
public class FormAuthenticator extends LoginAuthenticator {
    ...
    public static class FormRequest extends fnl {
        public FormRequest(HttpServletRequest httpServletRequest) {
            super(httpServletRequest);
        }

        @Override // p153l.fnl, javax.servlet.http.HttpServletRequest
    ...
    public static class FormResponse extends gnl {
    ...
    public boolean isJSecurityCheck(String str) {
        ...
        int i = iIndexOf + 17;
        return i == str.length() || (cCharAt = str.charAt(i)) == ';' || cCharAt == '#' || cCharAt == '/' || cCharAt == '?';
    }

    public boolean isLoginOrErrorPage(String str) {
        if (str != null) {
            return str.equals(this._formErrorPath) || str.equals(this._formLoginPath);
        }
        return false;
    }
    ...
    public UserIdentity login(String str, Object obj, gse0 gse0Var) {
        UserIdentity userIdentityLogin = super.login(str, obj, gse0Var);
        if (userIdentityLogin != null) {
            ((HttpServletRequest) gse0Var).getSession(true).setAttribute(SessionAuthentication.__J_AUTHENTICATED, new SessionAuthentication(getAuthMethod(), userIdentityLogin, obj));
        }
    ...
    public Authentication validateRequest(gse0 gse0Var, lse0 lse0Var, boolean z) throws ServerAuthException {
        ...
        try {
            if (isJSecurityCheck(requestURI)) {
                ...
                hnl session2 = httpServletRequest.getSession(true);
                if (userIdentityLogin != null) {
                ...
                if (str == null) {
                    ...
                    c2d0 requestDispatcher = httpServletRequest.getRequestDispatcher(str);
            ...
            synchronized (session) {
                try {
                    if (session.getAttribute(__J_URI) == null || this._alwaysSaveUri) {
                        ...
                        if (MimeTypes.FORM_ENCODED.equalsIgnoreCase(gse0Var.getContentType()) && "POST".equals(httpServletRequest.getMethod())) {
                            Request request2 = gse0Var instanceof Request ? (Request) gse0Var : AbstractHttpConnection.getCurrentConnection().getRequest();
            ...
            if (this._dispatch) {
                c2d0 requestDispatcher2 = httpServletRequest.getRequestDispatcher(this._formLoginPage);
                httpServletResponse.setHeader("Cache-Control", "No-cache");
                httpServletResponse.setDateHeader("Expires", 1L);
