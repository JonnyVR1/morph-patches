...
public class ClientCertAuthenticator extends LoginAuthenticator {
    ...
    public Authentication validateRequest(gse0 gse0Var, lse0 lse0Var, boolean z) throws ServerAuthException {
        ...
        X509Certificate[] x509CertificateArr = (X509Certificate[]) ((HttpServletRequest) gse0Var).getAttribute("javax.servlet.request.X509Certificate");
                ...
                if (x509CertificateArr.length > 0) {
                    ...
                    for (X509Certificate x509Certificate : x509CertificateArr) {
                        if (x509Certificate != null) {
                            ...
                            UserIdentity userIdentityLogin = clientCertAuthenticator.login(subjectDN == null ? "clientcert" : subjectDN.getName(), B64Code.encode(x509Certificate.getSignature()), gse0Var);
