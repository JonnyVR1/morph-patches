...
public class Invoker extends HttpServlet {
    ...
    public class InvokedRequest extends fnl {
        boolean _included;
        String _pathInfo;
        String _servletPath;
        ...
        @Override // p153l.kse0, p153l.gse0
    ...
    public void init() {
        ...
        while (initParameterNames.hasMoreElements()) {
            ...
            if ("nonContextServlets".equals(strNextElement)) {
                this._nonContextServlets = initParameter.length() > 0 && lowerCase.startsWith(Constants.KEY_T);
            }
            if ("verbose".equals(strNextElement)) {
                if (initParameter.length() > 0 && lowerCase.startsWith(Constants.KEY_T)) {
                    z = true;
                }
                this._verbose = z;
            } else {
                    ...
                    if (holderEntry == null || holderEntry.equals(this._invokerEntry)) {
                        ...
                        try {
                            ...
                            if (!this._nonContextServlets) {
                                yre0 servlet = servletHolderAddServletWithMapping.getServlet();
