...
import org.eclipse.jetty.p127io.RuntimeIOException;
...
public class ServletHandler extends ScopedHandler {
    ...
    protected final ConcurrentMap<String, nli>[] _chainCache = new ConcurrentMap[31];
    protected final Queue<String>[] _chainLRU = new Queue[31];

    public class CachedChain implements nli {
        ...
        @Override // p153l.nli
        public void doFilter(gse0 gse0Var, lse0 lse0Var) throws ServletException, IOException {
            Request request = gse0Var instanceof Request ? (Request) gse0Var : AbstractHttpConnection.getCurrentConnection().getRequest();
            if (this._filterHolder == null) {
                ...
                if (this._servletHolder != null) {
                    ...
                    this._servletHolder.handle(request, gse0Var, lse0Var);
                    return;
                }
                Handler handler = ServletHandler.this.getHandler();
                ServletHandler servletHandler = ServletHandler.this;
                if (handler == null) {
                    servletHandler.notFound(httpServletRequest, (HttpServletResponse) lse0Var);
                    return;
                } else {
                    servletHandler.nextHandle(URIUtil.addPaths(httpServletRequest.getServletPath(), httpServletRequest.getPathInfo()), request, httpServletRequest, (HttpServletResponse) lse0Var);
                    return;
                }
            }
            if (ServletHandler.LOG.isDebugEnabled()) {
            ...
            gli filter = this._filterHolder.getFilter();
            if (this._filterHolder.isAsyncSupported()) {
                filter.doFilter(gse0Var, lse0Var, this._next);
                return;
            }
    ...
    public class Chain implements nli {
        ...
        public void doFilter(gse0 gse0Var, lse0 lse0Var) throws ServletException, IOException {
            ...
            if (this._filter >= LazyList.size(this._chain)) {
                ...
                if (this._servletHolder == null) {
                    if (ServletHandler.this.getHandler() == null) {
                        ServletHandler.this.notFound(httpServletRequest, (HttpServletResponse) lse0Var);
                        return;
                    } else {
                        ServletHandler.this.nextHandle(URIUtil.addPaths(httpServletRequest.getServletPath(), httpServletRequest.getPathInfo()), gse0Var instanceof Request ? (Request) gse0Var : AbstractHttpConnection.getCurrentConnection().getRequest(), httpServletRequest, (HttpServletResponse) lse0Var);
                        return;
                    }
                }
                if (ServletHandler.LOG.isDebugEnabled()) {
                ...
                this._servletHolder.handle(this._baseRequest, gse0Var, lse0Var);
                return;
            }
            ...
            gli filter = filterHolder.getFilter();
            if (filterHolder.isAsyncSupported() || !this._baseRequest.isAsyncSupported()) {
                filter.doFilter(gse0Var, lse0Var, this);
                return;
            }
            try {
    ...
    private nli getFilterChain(Request request, String str, ServletHolder servletHolder) {
        Object objAdd;
        MultiMap<String> multiMap;
        ConcurrentMap<String, nli>[] concurrentMapArr;
        nli nliVar;
        String name = str == null ? servletHolder.getName() : str;
        int iDispatch = FilterMapping.dispatch(request.getDispatcherType());
        if (this._filterChainsCached && (concurrentMapArr = this._chainCache) != null && (nliVar = concurrentMapArr[iDispatch].get(name)) != null) {
            return nliVar;
        }
        ...
        ConcurrentMap<String, nli> concurrentMap = this._chainCache[iDispatch];
    ...
    public void destroyFilter(gli gliVar) {
        ...
        if (servletContextHandler != null) {
            servletContextHandler.destroyFilter(gliVar);
        }
    }
    ...
    public void destroyServlet(yre0 yre0Var) {
        ServletContextHandler servletContextHandler = this._contextHandler;
        if (servletContextHandler != null) {
            servletContextHandler.destroyServlet(yre0Var);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r10v0, types: [org.eclipse.jetty.server.handler.HandlerWrapper, org.eclipse.jetty.server.handler.ScopedHandler, org.eclipse.jetty.servlet.ServletHandler] */
    /* JADX WARN: Type inference failed for: r10v21 */
    /* JADX WARN: Type inference failed for: r10v22, types: [l.gse0] */
    /* JADX WARN: Type inference failed for: r10v26 */
    /* JADX WARN: Type inference failed for: r13v0, types: [java.lang.Object, javax.servlet.http.HttpServletRequest, l.gse0] */
    /* JADX WARN: Type inference failed for: r2v1, types: [org.eclipse.jetty.servlet.ServletHolder] */
    /* JADX WARN: Type inference failed for: r4v0 */
    /* JADX WARN: Type inference failed for: r4v10 */
    /* JADX WARN: Type inference failed for: r4v11 */
    /* JADX WARN: Type inference failed for: r4v2, types: [java.lang.Object, l.nli] */
    ...
    public void doHandle(String str, Request request, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        ?? r2 = (ServletHolder) request.getUserIdentityScope();
        ?? filterChain = 0;
        filterChain = 0;
        filterChain = 0;
        filterChain = 0;
        ...
        filterChain = 0;
        if (str.startsWith("/")) {
            if (r2 != 0 && (filterMappingArr2 = this._filterMappings) != null && filterMappingArr2.length > 0) {
                filterChain = getFilterChain(request, str, r2);
            }
        } else if (r2 != 0 && (filterMappingArr = this._filterMappings) != null && filterMappingArr.length > 0) {
            filterChain = getFilterChain(request, null, r2);
        }
            ...
            try {
                try {
                    try {
                        try {
                            if (r2 != 0) {
                                ?? request2 = httpServletRequest instanceof ServletRequestHttpWrapper ? ((ServletRequestHttpWrapper) httpServletRequest).getRequest() : httpServletRequest;
                                lse0 response = httpServletResponse instanceof ServletResponseHttpWrapper ? ((ServletResponseHttpWrapper) httpServletResponse).getResponse() : httpServletResponse;
                                if (filterChain != 0) {
                                    filterChain.doFilter(request2, response);
                                } else {
                                    r2.handle(request, request2, response);
                                }
    ...
    public Set<String> setServletSecurity(fse0.InterfaceC17064a interfaceC17064a, nse0 nse0Var) {
        ServletContextHandler servletContextHandler = this._contextHandler;
        return servletContextHandler != null ? servletContextHandler.setServletSecurity(interfaceC17064a, nse0Var) : Collections.EMPTY_SET;
    }
    ...
    public synchronized void updateMappings() {
        try {
            ...
            ConcurrentMap<String, nli>[] concurrentMapArr = this._chainCache;
            if (concurrentMapArr != null) {
                ...
                while (true) {
                    ...
                    ConcurrentMap<String, nli> concurrentMap = this._chainCache[i3];
    ...
    public ServletHolder addServletWithMapping(Class<? extends yre0> cls, String str) throws Throwable {
    ...
    public FilterHolder addFilterWithMapping(Class<? extends gli> cls, String str, EnumSet<DispatcherType> enumSet) throws Throwable {
        FilterHolder filterHolderNewFilterHolder = newFilterHolder(Holder.Source.EMBEDDED);
    ...
    public FilterHolder addFilterWithMapping(Class<? extends gli> cls, String str, int i) throws Throwable {
        FilterHolder filterHolderNewFilterHolder = newFilterHolder(Holder.Source.EMBEDDED);
        filterHolderNewFilterHolder.setHeldClass(cls);
