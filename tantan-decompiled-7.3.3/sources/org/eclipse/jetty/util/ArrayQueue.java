...
public class ArrayQueue<E> extends AbstractList<E> implements Queue<E> {
    ...
    private E m222365at(int i) {
        return (E) this._elements[i];
    }

    private E dequeue() {
        E eM222365at = m222365at(this._nextE);
    ...
    public E element() {
        ...
        synchronized (this._lock) {
            try {
                ...
                eM222365at = m222365at(this._nextE);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public E getUnsafe(int i) {
        return m222365at((this._nextE + i) % this._elements.length);
    }
