...
public class UnixCrypt {
    ...
    static {
        ...
        for (int i13 = 0; i13 < 8; i13++) {
            int i14 = 0;
            while (i14 < 8) {
                int i15 = i14 < 2 ? 0 : f206826IP[ExpandTr[((i13 * 6) + i14) - 2] - 1];
                if (i15 > 32) {
                    i15 -= 32;
                } else if (i15 > 0) {
                    i15--;
        ...
        while (i21 < 8) {
            int i22 = 0;
            while (i22 < i) {
                byte b5 = f206827S[i21][((i22 & 1) << 5) | (((i22 >> 1) & 1) << 3) | (((i22 >> 2) & 1) << 2) | (((i22 >> 3) & 1) << 1) | ((i22 >> 4) & 1) | (((i22 >> 5) & 1) << 4)];
