...
public class LoggerLog extends AbstractLogger {
    ...
    public LoggerLog(Object obj) {
        try {
            ...
            this._infoMT = cls.getMethod(BaseSei.INFO, String.class, Throwable.class);
            this._infoMAA = cls.getMethod(BaseSei.INFO, String.class, Object[].class);
            ...
            this._getName = cls.getMethod("getName", null);
            this._debug = ((Boolean) method.invoke(obj, null)).booleanValue();
        } catch (Exception e) {
            xpg0.m212648a(e);
            throw null;
        }
    ...
    public String getName() {
        try {
            return (String) this._getName.invoke(this._logger, null);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
