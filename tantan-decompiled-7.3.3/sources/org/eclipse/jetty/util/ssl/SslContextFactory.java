...
public class SslContextFactory extends AbstractLifeCycle {
    ...
    public void checkKeyStore() {
        ...
        if (keyStore == null && this._keyStoreInputStream == null && this._keyStorePath == null) {
            wtq0.m207906a("SSL doesn't have a valid keystore");
            return;
        }
        ...
        try {
            ...
            C22074IO.copy(this._keyStoreInputStream, byteArrayOutputStream);
    ...
    public void checkNotStarted() {
        if (isStarted()) {
            qg50.m176437a("Cannot modify configuration when ", getState());
        }
    }
