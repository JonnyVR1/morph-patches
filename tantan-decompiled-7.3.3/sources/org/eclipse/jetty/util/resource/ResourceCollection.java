...
public class ResourceCollection extends Resource {
    ...
    public ResourceCollection(Resource... resourceArr) {
        ...
        for (Resource resource3 : resourceArr2) {
            if (!resource3.exists() || !resource3.isDirectory()) {
                ulk0.m196558a(resource3, " is not an existing directory.");
                throw null;
            }
        }
    }
    ...
    public Resource addPath(String str) throws IOException {
        if (this._resources == null) {
            wtq0.m207906a("*resources* not set.");
            return null;
        }
        if (str == null) {
    ...
    public void setResourcesAsCSV(String str) {
        ...
        if (iCountTokens == 0) {
            wg3.m206174a("ResourceCollection@setResourcesAsCSV(String)  argument must be a string containing one or more comma-separated resource strings.");
            return;
        }
