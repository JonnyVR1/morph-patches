...
public class BufferCache {
    ...
    public Buffer lookup(Buffer buffer) {
        ...
        if (cachedBuffer == null) {
            return buffer instanceof Buffer.CaseInsensitve ? buffer : new ByteArrayBuffer.CaseInsensitive(buffer.asArray(), 0, buffer.length(), 0);
        }
        return cachedBuffer;
    }

    public String toString() {
        return "CACHE[bufferMap=" + this._bufferMap + ",stringMap=" + this._stringMap + ",index=" + this._index + Constants.AES_SUFFIX;
    }
