...
public class FlowLayout extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            childAt.layout(layoutParams.f206805x + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, layoutParams.f206806y + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, layoutParams.f206805x + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + childAt.getMeasuredWidth(), layoutParams.f206806y + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + childAt.getMeasuredHeight());
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private int f206805x;

        /* JADX INFO: renamed from: y */
        private int f206806y;
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C21991R.styleable.FlowLayout_LayoutParams);
            try {
                this.newLine = typedArrayObtainStyledAttributes.getBoolean(C21991R.styleable.FlowLayout_LayoutParams_layout_newLine, false);
                this.gravity = typedArrayObtainStyledAttributes.getInt(C21991R.styleable.FlowLayout_LayoutParams_android_layout_gravity, 0);
                this.weight = typedArrayObtainStyledAttributes.getFloat(C21991R.styleable.FlowLayout_LayoutParams_layout_weight, -1.0f);
            } finally {
        ...
        public int getX() {
            return this.f206805x;
        }

        public int getY() {
            return this.f206806y;
        }
