...
public enum ErrorCode {
    ...
    ARGUMENT_VALUE_OUT_OF_RANGE(IdentityFaceState.FACE_OPEN_MOUTH_DONE, "An argument value is less than the minimum or more than the maximum value of the allowedValueRange, or is not in the allowedValueList"),
    ...
    TRANSPORT_LOCKED(IMediaPlayer.MEDIA_INFO_INITBUFFERING_END, "Transport locked"),
    ILLEGAL_MIME_TYPE(Constants.AUDIO_MIXING_STATE_FAILED, "Illegal mime-type");
