...
public class ServerClientTokens {
    ...
    public String getOsToken() {
        return getOsName().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "_") + "/" + getOsVersion().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "_");
    }
    ...
    public String getProductToken() {
        return getProductName().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "_") + "/" + getProductVersion().replaceAll(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "_");
    }
    ...
    public String toString() {
        return getOsName() + "/" + getOsVersion() + " UPnP/" + getMajorVersion() + "." + getMinorVersion() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + getProductName() + "/" + getProductVersion();
    }
