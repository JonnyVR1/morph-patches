...
public class FixedSunURLStreamHandler implements URLStreamHandlerFactory {
    ...
    public static final /* synthetic */ int f206882a = 0;
    ...
    public static class UpnpURLConnection extends HttpURLConnection {
        private static final String[] methods = {"GET", "POST", HttpMethods.HEAD, HttpMethods.OPTIONS, HttpMethods.PUT, HttpMethods.DELETE, "SUBSCRIBE", "UNSUBSCRIBE", "NOTIFY"};
        ...
        public synchronized OutputStream getOutputStream() throws IOException {
            ...
            try {
                ...
                if (this.method.equals(HttpMethods.PUT) || this.method.equals("POST") || this.method.equals("NOTIFY")) {
        ...
        public void setRequestMethod(String str) throws ProtocolException {
            if (this.connected) {
                e7b0.m119688a("Cannot reset method once connected");
                return;
            }
