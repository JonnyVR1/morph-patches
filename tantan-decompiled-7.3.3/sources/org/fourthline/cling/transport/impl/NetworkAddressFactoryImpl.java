...
public class NetworkAddressFactoryImpl implements NetworkAddressFactory {
    ...
    public NetworkAddressFactoryImpl(int i) throws InitializationException {
        ...
        if (property != null) {
            hashSet.addAll(Arrays.asList(property.split(Constants.SEPARATOR_COMMA)));
        }
        String property2 = System.getProperty(NetworkAddressFactory.SYSTEM_PROPERTY_NET_ADDRESSES);
        if (property2 != null) {
            hashSet2.addAll(Arrays.asList(property2.split(Constants.SEPARATOR_COMMA)));
        }
    ...
    public InetAddress getLocalAddress(NetworkInterface networkInterface, boolean z, InetAddress inetAddress) {
        ...
        qg50.m176437a("Can't find any IPv4 or IPv6 address on interface: ", networkInterface.getDisplayName());
        return null;
    }
    ...
    public InetAddress getMulticastGroup() {
        try {
            return InetAddress.getByName(org.fourthline.cling.model.Constants.IPV4_UPNP_MULTICAST_GROUP);
    ...
    public int getMulticastPort() {
        return org.fourthline.cling.model.Constants.UPNP_MULTICAST_PORT;
    }
