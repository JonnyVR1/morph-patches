...
public class AsyncServletStreamServerImpl implements StreamServer<AsyncServletStreamServerConfigurationImpl> {
    ...
    public yre0 createServlet(final Router router) {
        return new HttpServlet() { // from class: org.fourthline.cling.transport.impl.AsyncServletStreamServerImpl.1
            ...
            public void service(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
                ...
                o21 o21VarStartAsync = httpServletRequest.startAsync();
                o21VarStartAsync.setTimeout(AsyncServletStreamServerImpl.this.getConfiguration().getAsyncTimeoutSeconds() * 1000);
                o21VarStartAsync.addListener(new r21() { // from class: org.fourthline.cling.transport.impl.AsyncServletStreamServerImpl.1.1
                    @Override // p153l.r21
                    public void onComplete(p21 p21Var) throws IOException {
                        long jCurrentTimeMillis2 = System.currentTimeMillis() - jCurrentTimeMillis;
                        if (AsyncServletStreamServerImpl.log.isLoggable(Level.FINE)) {
                            AsyncServletStreamServerImpl.log.fine(String.format("AsyncListener.onComplete(): id: %3d, duration: %,4d, response: %s", Integer.valueOf(iAccess$008), Long.valueOf(jCurrentTimeMillis2), p21Var.getSuppliedResponse()));
                        }
                    }
                    ...
                    public void onError(p21 p21Var) throws IOException {
                        long jCurrentTimeMillis2 = System.currentTimeMillis() - jCurrentTimeMillis;
                        if (AsyncServletStreamServerImpl.log.isLoggable(Level.FINE)) {
                            AsyncServletStreamServerImpl.log.fine(String.format("AsyncListener.onError(): id: %3d, duration: %,4d, response: %s", Integer.valueOf(iAccess$008), Long.valueOf(jCurrentTimeMillis2), p21Var.getSuppliedResponse()));
                        }
                    }
                    ...
                    public void onStartAsync(p21 p21Var) throws IOException {
                        if (AsyncServletStreamServerImpl.log.isLoggable(Level.FINE)) {
                            AsyncServletStreamServerImpl.log.fine(String.format("AsyncListener.onStartAsync(): id: %3d, request: %s", Integer.valueOf(iAccess$008), p21Var.getSuppliedRequest()));
                        }
                    }
                    ...
                    public void onTimeout(p21 p21Var) throws IOException {
                        long jCurrentTimeMillis2 = System.currentTimeMillis() - jCurrentTimeMillis;
                        if (AsyncServletStreamServerImpl.log.isLoggable(Level.FINE)) {
                            AsyncServletStreamServerImpl.log.fine(String.format("AsyncListener.onTimeout(): id: %3d, duration: %,4d, request: %s", Integer.valueOf(iAccess$008), Long.valueOf(jCurrentTimeMillis2), p21Var.getSuppliedRequest()));
                        }
                    }
                });
                router.received(new AsyncServletUpnpStream(router.getProtocolFactory(), o21VarStartAsync, httpServletRequest) { // from class: org.fourthline.cling.transport.impl.AsyncServletStreamServerImpl.1.2
