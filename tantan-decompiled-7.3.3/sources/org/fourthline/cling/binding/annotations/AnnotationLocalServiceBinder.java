...
public class AnnotationLocalServiceBinder implements LocalServiceBinder {
    ...
    public static String toJavaActionName(String str) {
        if (str.length() < 1) {
            wg3.m206174a("Variable name must be at least 1 character long");
            return null;
        }
    ...
    public static String toUpnpActionName(String str) {
        if (str.length() < 1) {
            wg3.m206174a("Action name must be at least 1 character long");
            return null;
        }
    ...
    public Map<StateVariable, StateVariableAccessor> readStateVariables(Class<?> cls, Set<Class> set) throws LocalServiceBindingException {
        ...
        for (Method method : Reflections.getMethods(cls, UpnpStateVariable.class)) {
            ...
            if (methodPropertyName == null) {
                qr0.m177529a("Annotated method is not a getter method (: ", method);
                return null;
            }
            if (method.getParameterTypes().length > 0) {
                qr0.m177529a("Getter method defined as @UpnpStateVariable can not have parameters: ", method);
                return null;
            }
    ...
    public Set<Class> readStringConvertibleTypes(Class[] clsArr) throws LocalServiceBindingException {
        for (Class cls : clsArr) {
            if (!Modifier.isPublic(cls.getModifiers())) {
                qr0.m177529a("Declared string-convertible type must be public: ", cls);
                return null;
            }
            try {
                cls.getConstructor(String.class);
            } catch (NoSuchMethodException unused) {
                qr0.m177529a("Declared string-convertible type needs a public single-argument String constructor: ", cls);
                return null;
            }
        }
