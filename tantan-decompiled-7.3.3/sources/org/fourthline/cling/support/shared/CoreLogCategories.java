...
public class CoreLogCategories extends ArrayList<LogCategory> {
    public CoreLogCategories() {
        ...
        add(new LogCategory("UPnP Protocol", new LogCategory.Group[]{new LogCategory.Group("Discovery (Notification & Search)", new LogCategory.LoggerLevel[]{new LogCategory.LoggerLevel(ProtocolFactory.class.getName(), level2), new LogCategory.LoggerLevel("org.fourthline.cling.protocol.async", level2)}), new LogCategory.Group("Description", new LogCategory.LoggerLevel[]{new LogCategory.LoggerLevel(ProtocolFactory.class.getName(), level2), new LogCategory.LoggerLevel(RetrieveRemoteDescriptors.class.getName(), level), new LogCategory.LoggerLevel(ReceivingRetrieval.class.getName(), level), new LogCategory.LoggerLevel(DeviceDescriptorBinder.class.getName(), level), new LogCategory.LoggerLevel(ServiceDescriptorBinder.class.getName(), level)}), new LogCategory.Group(Constants.PATCH_CONTROL_SUFFIX, new LogCategory.LoggerLevel[]{new LogCategory.LoggerLevel(ProtocolFactory.class.getName(), level2), new LogCategory.LoggerLevel(ReceivingAction.class.getName(), level2), new LogCategory.LoggerLevel(SendingAction.class.getName(), level2)}), new LogCategory.Group("GENA ", new LogCategory.LoggerLevel[]{new LogCategory.LoggerLevel("org.fourthline.cling.model.gena", level2), new LogCategory.LoggerLevel(ProtocolFactory.class.getName(), level2), new LogCategory.LoggerLevel(ReceivingEvent.class.getName(), level2), new LogCategory.LoggerLevel(ReceivingSubscribe.class.getName(), level2), new LogCategory.LoggerLevel(ReceivingUnsubscribe.class.getName(), level2), new LogCategory.LoggerLevel(SendingEvent.class.getName(), level2), new LogCategory.LoggerLevel(SendingSubscribe.class.getName(), level2), new LogCategory.LoggerLevel(SendingUnsubscribe.class.getName(), level2), new LogCategory.LoggerLevel(SendingRenewal.class.getName(), level2)})}));
