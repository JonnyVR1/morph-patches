...
public class StorageVolume extends Container {
    ...
    public StorageVolume setStorageFree(Long l2) {
    ...
    public StorageVolume setStorageTotal(Long l2) {
        replaceFirstProperty(new DIDLObject.Property.UPNP.STORAGE_TOTAL(l2));
        return this;
    }

    public StorageVolume setStorageUsed(Long l2) {
    ...
    public StorageVolume(String str, Container container, String str2, String str3, Integer num, Long l2, Long l3, Long l4, StorageMedium storageMedium) {
        this(str, container.getId(), str2, str3, num, l2, l3, l4, storageMedium);
    }
