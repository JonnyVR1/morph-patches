...
public class SHA384Digest extends LongDigest {
    ...
    public void reset() {
        super.reset();
        this.f207303H1 = -3766243637369397544L;
        this.f207304H2 = 7105036623409894663L;
        this.f207305H3 = -7973340178411365097L;
        this.f207306H4 = 1526699215303891257L;
        this.f207307H5 = 7436329637833083697L;
        this.f207308H6 = -8163818279084223215L;
        this.f207309H7 = -2662702644619276377L;
        this.f207310H8 = 5167115440072839076L;
    }
