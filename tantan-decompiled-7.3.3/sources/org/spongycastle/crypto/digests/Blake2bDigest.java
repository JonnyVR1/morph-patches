...
public class Blake2bDigest implements ExtendedDigest {
    ...
    private long f207287t0;

    /* JADX INFO: renamed from: t1 */
    private long f207288t1;
    ...
    public Blake2bDigest(byte[] bArr, int i, byte[] bArr2, byte[] bArr3) {
        ...
        if (i < 1 || i > 64) {
            wg3.m206174a("Invalid digest length (required: 1 - 64)");
            throw null;
        }
        this.digestLength = i;
        if (bArr2 != null) {
            if (bArr2.length != 16) {
                wg3.m206174a("salt length must be exactly 16 bytes");
                throw null;
            }
        ...
        if (bArr3 != null) {
            if (bArr3.length != 16) {
                wg3.m206174a("personalization length must be exactly 16 bytes");
                throw null;
            }
        ...
        if (bArr != null) {
            ...
            if (bArr.length > 64) {
                wg3.m206174a("Keys > 64 are not supported");
                throw null;
            }
    ...
    private void m222390G(long j, long j2, int i, int i2, int i3, int i4) {
    ...
    private void compress(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < rOUNDS; i4++) {
            ...
            byte[] bArr3 = bArr2[i4];
            m222390G(jArr[bArr3[0]], jArr[bArr3[1]], 0, 4, 8, 12);
            byte[] bArr4 = bArr2[i4];
            m222390G(jArr[bArr4[2]], jArr[bArr4[3]], 1, 5, 9, 13);
            byte[] bArr5 = bArr2[i4];
            m222390G(jArr[bArr5[4]], jArr[bArr5[5]], 2, 6, 10, 14);
            byte[] bArr6 = bArr2[i4];
            m222390G(jArr[bArr6[6]], jArr[bArr6[7]], 3, 7, 11, 15);
            byte[] bArr7 = bArr2[i4];
            m222390G(jArr[bArr7[8]], jArr[bArr7[9]], 0, 5, 10, 15);
            byte[] bArr8 = bArr2[i4];
            m222390G(jArr[bArr8[10]], jArr[bArr8[11]], 1, 6, 11, 12);
            byte[] bArr9 = bArr2[i4];
            m222390G(jArr[bArr9[12]], jArr[bArr9[13]], 2, 7, 8, 13);
            byte[] bArr10 = bArr2[i4];
            m222390G(jArr[bArr10[14]], jArr[bArr10[15]], 3, 4, 9, 14);
        }
        while (true) {
    ...
    private void initializeInternalState() {
        ...
        long[] jArr3 = this.internalState;
        jArr3[12] = this.f207287t0 ^ jArr2[4];
        jArr3[13] = this.f207288t1 ^ jArr2[5];
        jArr3[14] = this.f207286f0 ^ jArr2[6];
        jArr3[15] = jArr2[7];
    }
    ...
    public Blake2bDigest(int i) {
        ...
        if (i != 160 && i != 256 && i != 384 && i != 512) {
            wg3.m206174a("Blake2b digest restricted to one of [160, 256, 384, 512]");
            throw null;
        }
        this.buffer = new byte[128];
        this.keyLength = 0;
