...
public class SkeinEngine implements Memoable {
    ...
    public SkeinEngine(int i, int i2) {
        ...
        if (i2 % 8 != 0) {
            za50.m219101a("Output size must be a multiple of 8 bits. :", i2);
            throw null;
        }
    ...
    private void checkInitialised() {
        ...
        wg3.m206174a("Skein engine is not initialised.");
    }
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        if (bArr.length < this.outputSizeBytes + i) {
            tyk0.m193596a("Output buffer is too short to hold output");
            return 0;
        }
        ubiFinal();
    ...
    public void init(SkeinParameters skeinParameters) {
        ...
        if (skeinParameters != null) {
            if (skeinParameters.getKey().length < 16) {
                wg3.m206174a("Skein key must be at least 128 bits.");
                return;
            }
    ...
    public void reset(Memoable memoable) {
        ...
        if (getBlockSize() == skeinEngine.getBlockSize() && this.outputSizeBytes == skeinEngine.outputSizeBytes) {
            ...
            wg3.m206174a("Incompatible parameters in provided SkeinEngine.");
        }
    }
    ...
    public static class UbiTweak {
        ...
        public void advancePosition(int i) {
            boolean z = this.extendedPosition;
            ...
            jArr2[0] = jArr[0] & 4294967295L;
            jArr2[1] = (jArr[0] >>> 32) & 4294967295L;
            jArr2[2] = jArr[1] & 4294967295L;
            long j2 = i;
