...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* JADX INFO: renamed from: _P */
    private ECPoint f207676_P;

    /* JADX INFO: renamed from: _Q */
    private ECPoint f207677_Q;
    private ECCurve.C22395Fp _curve;
    ...
    static {
        ...
        nistPoints = new DualECPoints[]{new DualECPoints(128, c22395Fp.createPoint(bigInteger, bigInteger2), c22395Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(192, c22395Fp.createPoint(bigInteger5, bigInteger6), c22395Fp.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c22395Fp.createPoint(bigInteger9, bigInteger10), c22395Fp.createPoint(bigInteger11, bigInteger12), 1)};
        ECCurve.C22395Fp c22395Fp = (ECCurve.C22395Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C22395Fp c22395Fp2 = (ECCurve.C22395Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C22395Fp c22395Fp3 = (ECCurve.C22395Fp) NISTNamedCurves.getByName("P-521").getCurve();
    }
    ...
    private byte[] getEntropy() {
        ...
        wtq0.m207906a("Insufficient entropy provided by entropy source");
        return null;
    }
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (Utils.isTooLarge(bArr2, 512)) {
            wg3.m206174a("Additional input too large");
            return 0;
        }
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f207678_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f207678_s);
        Arrays.fill(bArr, (byte) 0);
        int i = 0;
        for (int i2 = 0; i2 < length2; i2++) {
            bigInteger = getScalarMultipleXCoord(this.f207676_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f207677_Q, bigInteger).toByteArray();
        ...
        if (i < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f207676_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f207677_Q, bigInteger).toByteArray();
            ...
            if (length5 > i4) {
                ...
                System.arraycopy(byteArray2, 0, bArr, i + (i4 - byteArray2.length), length4);
            }
            this._reseedCounter++;
        }
        this.f207678_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f207676_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        if (Utils.isTooLarge(bArr, 512)) {
            wg3.m206174a("Additional input string too large");
            return;
        }
        this.f207678_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f207678_s, this._seedlen), getEntropy(), bArr), this._seedlen);
        this._reseedCounter = 0L;
    }
