...
public final class KDFFeedbackParameters implements DerivationParameters {
    ...
    private final byte[] f207652iv;

    /* JADX INFO: renamed from: ki */
    private final byte[] f207653ki;

    /* JADX INFO: renamed from: r */
    private final int f207654r;
    ...
    private KDFFeedbackParameters(byte[] bArr, byte[] bArr2, byte[] bArr3, int i, boolean z) {
        ...
        this.f207653ki = Arrays.clone(bArr);
        if (bArr3 == null) {
        ...
        this.f207654r = i;
        if (bArr2 == null) {
            this.f207652iv = new byte[0];
        } else {
            this.f207652iv = Arrays.clone(bArr2);
        }
        this.useCounter = z;
    }
    ...
    public byte[] getIV() {
        return this.f207652iv;
    }

    public byte[] getKI() {
        return this.f207653ki;
    }

    public int getR() {
        return this.f207654r;
    }
