...
public final class DERMacData {
    ...
    /* JADX INFO: renamed from: org.spongycastle.crypto.util.DERMacData$1 */
    public static /* synthetic */ class C223911 {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = C223911.$SwitchMap$org$spongycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            C223911 c223911 = null;
            if (i == 1 || i == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), c223911);
            }
            if (i == 3 || i == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), c223911);
            }
            wtq0.m207906a("Unknown type encountered in build");
            return null;
        }
    ...
    public /* synthetic */ DERMacData(byte[] bArr, C223911 c223911) {
        this(bArr);
    }
}
