...
public class CMac implements Mac {
    ...
    public CMac(BlockCipher blockCipher, int i) {
        if (i % 8 != 0) {
            wg3.m206174a("MAC size must be multiple of 8");
            throw null;
        }
        if (i > blockCipher.getBlockSize() * 8) {
            pvb.m173939a("MAC size must be less or equal to ", blockCipher.getBlockSize() * 8);
            throw null;
        }
    ...
    private static byte[] lookupPoly(int i) {
        ...
        switch (i2) {
            ...
            case 2048:
                ...
                break;
            default:
                za50.m219101a("Unknown block size for CMAC: ", i2);
                return null;
        }
    ...
    public void validate(CipherParameters cipherParameters) {
        ...
        wg3.m206174a("CMac mode only permits key to be set.");
    }
