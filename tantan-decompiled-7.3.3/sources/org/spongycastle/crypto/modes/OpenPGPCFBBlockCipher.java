...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    private byte[] f207590FR;
    private byte[] FRE;

    /* JADX INFO: renamed from: IV */
    private byte[] f207591IV;
    ...
    public OpenPGPCFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f207591IV = new byte[blockSize];
        this.f207590FR = new byte[blockSize];
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i7 > i5) {
            byte b = bArr[i];
            this.f207590FR[i5 - 2] = b;
            bArr2[i2] = encryptByte(b, i5 - 2);
            byte b2 = bArr[i + 1];
            byte[] bArr3 = this.f207590FR;
            int i9 = this.blockSize;
            bArr3[i9 - 1] = b2;
            bArr2[i2 + 1] = encryptByte(b2, i9 - 1);
            this.cipher.processBlock(this.f207590FR, 0, this.FRE, 0);
            while (i8 < this.blockSize) {
                byte b3 = bArr[i + i8];
                int i10 = i8 - 2;
                this.f207590FR[i10] = b3;
            ...
            byte[] bArr4 = this.f207590FR;
            System.arraycopy(bArr4, 2, bArr4, 0, this.blockSize - 2);
            byte[] bArr5 = this.f207590FR;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i7 > i5) {
            ...
            byte[] bArr7 = this.f207590FR;
            System.arraycopy(bArr7, 2, bArr7, 0, this.blockSize - 2);
            System.arraycopy(bArr2, i2, this.f207590FR, this.blockSize - 2, 2);
            this.cipher.processBlock(this.f207590FR, 0, this.FRE, 0);
            while (true) {
                i3 = this.blockSize;
                if (i8 >= i3) {
    ...
    public void reset() {
        this.count = 0;
        byte[] bArr = this.f207591IV;
        byte[] bArr2 = this.f207590FR;
