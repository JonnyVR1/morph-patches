...
public class EAXBlockCipher implements AEADBlockCipher {
    ...
    private int process(byte b, byte[] bArr, int i) {
        ...
        if (i3 == bArr2.length) {
            ...
            C17103g.m128363a("Output buffer is too short");
        }
        return 0;
    }
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        psl.m173659a("mac check in EAX failed");
        return 0;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            if (!(cipherParameters instanceof ParametersWithIV)) {
                wg3.m206174a("invalid parameters passed to EAX");
                return;
            }
    ...
    public void processAADByte(byte b) {
        if (this.cipherInitialized) {
            wtq0.m207906a("AAD data cannot be added after encryption/decryption processing has begun.");
        } else {
            this.mac.update(b);
        }
    }
