...
public class Tables8kGCMMultiplier implements GCMMultiplier {
    ...
    private byte[] f207600H;

    /* JADX INFO: renamed from: M */
    private int[][][] f207601M;

    @Override // org.spongycastle.crypto.modes.gcm.GCMMultiplier
    public void init(byte[] bArr) {
        int[][][] iArr;
        int i = 0;
        if (this.f207601M == null) {
            this.f207601M = (int[][][]) Array.newInstance((Class<?>) Integer.TYPE, 32, 16, 4);
        } else if (Arrays.areEqual(this.f207600H, bArr)) {
            return;
        }
        this.f207600H = Arrays.clone(bArr);
        GCMUtil.asInts(bArr, this.f207601M[1][8]);
        int i2 = 4;
        while (true) {
            iArr = this.f207601M;
            if (i2 < 1) {
