...
public class DSADigestSigner implements Signer {
    ...
    public byte[] generateSignature() {
        if (!this.forSigning) {
            wtq0.m207906a("DSADigestSigner not initialised for signature generation.");
            return null;
        }
        ...
        try {
            ...
            wtq0.m207906a("unable to encode signature");
            return null;
        }
    }
    ...
    public boolean verifySignature(byte[] bArr) {
        if (this.forSigning) {
            wtq0.m207906a("DSADigestSigner not initialised for verification");
            return false;
        }
