...
public class SkipjackEngine implements BlockCipher {
    ...
    private int m222461g(int i, int i2) {
        int i3 = (i2 >> 8) & 255;
        int i4 = i2 & 255;
        short[] sArr = ftable;
    ...
    private int m222462h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            int i9 = 0;
            while (i9 < 8) {
                int iM222462h = m222462h(i7, i4);
                int i10 = (i5 ^ iM222462h) ^ (i7 + 1);
                i7--;
                i9++;
                int i11 = i6;
                i6 = i3;
    ...
    public int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int i3 = (bArr[i] << 8) + (bArr[i + 1] & 255);
        int iM222461g = (bArr[i + 2] << 8) + (bArr[i + 3] & 255);
        ...
        for (int i7 = 0; i7 < 2; i7++) {
            int i8 = 0;
            while (i8 < 8) {
                int iM222461g2 = m222461g(i6, i3);
                i6++;
                i8++;
                int i9 = iM222461g;
                iM222461g = iM222461g2;
                i3 = (i5 ^ iM222461g2) ^ i6;
                i5 = i4;
                i4 = i9;
            }
            ...
            while (i10 < 8) {
                int i11 = i6 + 1;
                int i12 = (iM222461g ^ i3) ^ i11;
                i10++;
                iM222461g = m222461g(i6, i3);
                i3 = i5;
                i5 = i4;
                i4 = i12;
                i6 = i11;
        ...
        bArr2[i2] = (byte) (i3 >> 8);
        bArr2[i2 + 1] = (byte) i3;
        bArr2[i2 + 2] = (byte) (iM222461g >> 8);
        bArr2[i2 + 3] = (byte) iM222461g;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            wg3.m206174a("invalid parameter passed to SKIPJACK init - ".concat(cipherParameters.getClass().getName()));
            return;
        }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (this.key1 == null) {
            wtq0.m207906a("SKIPJACK engine not initialised");
            return 0;
        }
        if (i + 8 > bArr.length) {
