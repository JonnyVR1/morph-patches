...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private int[] f207464kw = new int[8];

    /* JADX INFO: renamed from: ke */
    private int[] f207463ke = new int[12];
    ...
    private int processBlock128(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            iArr4[i3] = iArr4[i3] ^ this.f207464kw[i3];
            i3++;
        }
    }
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            if (i3 >= 4) {
                ...
                camelliaF2(this.state, this.subkey, 28);
                camelliaF2(this.state, this.subkey, 32);
                camelliaFLs(this.state, this.f207463ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (length == 16) {
            ...
            if (length != 32) {
                wg3.m206174a("key sizes are only 16/24/32 bytes.");
                return;
            }
            iArr[0] = bytes2int(bArr, 0);
            iArr[1] = bytes2int(bArr, 4);
        ...
        if (this._keyis128) {
            ...
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f207463ke, 4);
                ...
                roldq(15, iArr2, 0, this.f207463ke, 0);
                ...
                roldq(17, iArr2, 0, this.f207464kw, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f207463ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f207463ke, 4);
            ...
            roldq(17, iArr2, 0, this.f207464kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldq(15, iArr, 0, this.f207463ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f207463ke, 0);
            ...
            roldqo32(51, iArr3, 0, this.f207464kw, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f207464kw, 0);
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            wg3.m206174a("only simple KeyParameter expected.");
        } else {
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException {
        if (!this.initialized) {
            wtq0.m207906a("Camellia is not initialized");
            return 0;
        }
        if (i + 16 > bArr.length) {
