...
public class ElGamalEngine implements AsymmetricBlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (z) {
            ...
            wg3.m206174a("ElGamalPublicKeyParameters are required for encryption.");
        } else {
            if (elGamalKeyParameters instanceof ElGamalPrivateKeyParameters) {
                return;
            }
            wg3.m206174a("ElGamalPrivateKeyParameters are required for decryption.");
        }
    }
    ...
    public byte[] processBlock(byte[] bArr, int i, int i2) {
        if (this.key == null) {
            wtq0.m207906a("ElGamal engine not initialised");
            return null;
        }
        if (i2 > (this.forEncryption ? (this.bitSize + 6) / 8 : getInputBlockSize())) {
            tyk0.m193596a("input too large for ElGamal cipher.\n");
            return null;
        }
