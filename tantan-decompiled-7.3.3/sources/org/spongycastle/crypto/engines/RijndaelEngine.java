...
public class RijndaelEngine implements BlockCipher {
    ...
    private long f207492A0;

    /* JADX INFO: renamed from: A1 */
    private long f207493A1;

    /* JADX INFO: renamed from: A2 */
    private long f207494A2;

    /* JADX INFO: renamed from: A3 */
    private long f207495A3;

    /* JADX INFO: renamed from: BC */
    private int f207496BC;
    ...
    public RijndaelEngine(int i) {
        if (i == 128) {
            ...
            if (i != 256) {
                wg3.m206174a("unknown blocksize to Rijndael");
                throw null;
            }
            this.f207496BC = 64;
            this.BC_MASK = -1L;
    ...
    private void InvMixColumn() {
        ...
        long jMul0xe3 = 0;
        long jMul0xe4 = 0;
        for (int i = 0; i < this.f207496BC; i += 8) {
            int i2 = (int) ((this.f207492A0 >> i) & 255);
            int i3 = (int) ((this.f207493A1 >> i) & 255);
            int i4 = (int) ((this.f207494A2 >> i) & 255);
            int i5 = (int) ((this.f207495A3 >> i) & 255);
            int i6 = -1;
        ...
        this.f207492A0 = jMul0xe;
        this.f207493A1 = jMul0xe4;
        this.f207494A2 = jMul0xe2;
        this.f207495A3 = jMul0xe3;
    }

    private void KeyAddition(long[] jArr) {
        this.f207492A0 ^= jArr[0];
        this.f207493A1 ^= jArr[1];
        this.f207494A2 ^= jArr[2];
        this.f207495A3 ^= jArr[3];
    }
    ...
    private void MixColumn() {
        ...
        this.f207492A0 = jMul0x2;
        this.f207493A1 = jMul0x5;
        this.f207494A2 = jMul0x3;
        this.f207495A3 = jMul0x4;
    }

    private void ShiftRow(byte[] bArr) {
        this.f207493A1 = shift(this.f207493A1, bArr[1]);
        this.f207494A2 = shift(this.f207494A2, bArr[2]);
        this.f207495A3 = shift(this.f207495A3, bArr[3]);
    }

    private void Substitution(byte[] bArr) {
        this.f207492A0 = applyS(this.f207492A0, bArr);
        this.f207493A1 = applyS(this.f207493A1, bArr);
        this.f207494A2 = applyS(this.f207494A2, bArr);
        this.f207495A3 = applyS(this.f207495A3, bArr);
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        if (length == 128) {
            ...
            if (length != 256) {
                wg3.m206174a("Key length not 128/160/192/224/256 bits.");
                return null;
            }
            i = 8;
        }
        if (length >= this.blockBits) {
            ...
            this.ROUNDS = (this.f207496BC / 8) + 6;
        }
        int i6 = 0;
        int i7 = 0;
        ...
        int i8 = 0;
        int i9 = 0;
        while (i8 < i && i9 < (this.ROUNDS + i3) * (this.f207496BC / i2)) {
            int i10 = i4;
            while (i10 < 4) {
                int i11 = this.f207496BC;
        ...
        int i13 = i4;
        int i14 = i13;
        while (i9 < (this.ROUNDS + 1) * (this.f207496BC / 8)) {
            int i15 = i13;
            while (i15 < i5) {
                byte[] bArr3 = bArr2[i15];
                i15++;
                bArr3[i13] = (byte) (bArr3[i13] ^ f207490S[bArr2[i15 % 4][i - 1] & 255]);
            }
            ...
            if (i <= 6) {
                ...
                for (int i21 = i13; i21 < i5; i21++) {
                    ...
                    bArr7[i5] = (byte) (bArr7[i5] ^ f207490S[bArr7[3] & 255]);
                }
            ...
            int i24 = i13;
            while (i24 < i && i9 < (this.ROUNDS + 1) * (this.f207496BC / 8)) {
                int i25 = i13;
                while (i25 < i5) {
                    int i26 = this.f207496BC;
    ...
    private void packBlock(byte[] bArr, int i) {
        for (int i2 = 0; i2 != this.f207496BC; i2 += 8) {
            bArr[i] = (byte) (this.f207492A0 >> i2);
            bArr[i + 1] = (byte) (this.f207493A1 >> i2);
            int i3 = i + 3;
            bArr[i + 2] = (byte) (this.f207494A2 >> i2);
            i += 4;
            bArr[i3] = (byte) (this.f207495A3 >> i2);
        }
    }

    private long shift(long j, int i) {
        return ((j << (this.f207496BC - i)) | (j >>> i)) & this.BC_MASK;
    }

    private void unpackBlock(byte[] bArr, int i) {
        this.f207492A0 = bArr[i] & 255;
        this.f207493A1 = bArr[i + 1] & 255;
        int i2 = i + 3;
        this.f207494A2 = bArr[i + 2] & 255;
        int i3 = i + 4;
        this.f207495A3 = bArr[i2] & 255;
        for (int i4 = 8; i4 != this.f207496BC; i4 += 8) {
            this.f207492A0 |= ((long) (bArr[i3] & 255)) << i4;
            this.f207493A1 |= ((long) (bArr[i3 + 1] & 255)) << i4;
            int i5 = i3 + 3;
            this.f207494A2 |= ((long) (bArr[i3 + 2] & 255)) << i4;
            i3 += 4;
            this.f207495A3 |= ((long) (bArr[i5] & 255)) << i4;
        }
    }
    ...
    public int getBlockSize() {
        return this.f207496BC / 2;
    }

    @Override // org.spongycastle.crypto.BlockCipher
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            wg3.m206174a("invalid parameter passed to Rijndael init - ".concat(cipherParameters.getClass().getName()));
        } else {
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (this.workingKey == null) {
            wtq0.m207906a("Rijndael engine not initialised");
            return 0;
        }
        int i3 = this.f207496BC;
