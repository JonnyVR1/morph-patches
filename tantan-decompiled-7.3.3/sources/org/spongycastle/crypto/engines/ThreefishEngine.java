...
public class ThreefishEngine implements BlockCipher {
    ...
    private long[] f207512kw;

    /* JADX INFO: renamed from: t */
    private long[] f207513t;
    ...
    public static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        public void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f207514kw;
            long[] jArr4 = this.f207515t;
    ...
    public static abstract class ThreefishCipher {
        ...
        /* JADX INFO: renamed from: kw */
        protected final long[] f207514kw;

        /* JADX INFO: renamed from: t */
        protected final long[] f207515t;
    ...
    public ThreefishEngine(int i) {
        ...
        if (i == 512) {
            ...
            wg3.m206174a("Invalid blocksize - Threefish is defined with block size of 256, 512, or 1024 bits");
            throw null;
        }
    }
    ...
    private void setKey(long[] jArr) {
        if (jArr.length != this.blocksizeWords) {
            vic0.m201333a("Threefish key must be same size as block (", this.blocksizeWords, " words)");
            return;
        }
        long j = C_240;
        int i = 0;
    ...
    private void setTweak(long[] jArr) {
        if (jArr.length != 2) {
            wg3.m206174a("Tweak must be 2 words.");
            return;
        }
        long[] jArr2 = this.f207513t;
        long j = jArr[0];
        jArr2[0] = j;
        long j2 = jArr[1];
        jArr2[1] = j2;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof TweakableBlockCipherParameters) {
            ...
            wg3.m206174a("Invalid parameter passed to Threefish init - ".concat(cipherParameters.getClass().getName()));
            return;
        } else {
        ...
        if (key == null) {
            ...
            if (key.length != this.blocksizeBytes) {
                vic0.m201333a("Threefish key must be same size as block (", this.blocksizeBytes, " bytes)");
                return;
            }
        ...
        if (tweak != null) {
            if (tweak.length != 16) {
                wg3.m206174a("Threefish tweak must be 16 bytes");
                return;
            }
    ...
    public int processBlock(long[] jArr, long[] jArr2) throws IllegalStateException, DataLengthException {
        ...
        wtq0.m207906a("Threefish engine not initialised");
        return 0;
    }
