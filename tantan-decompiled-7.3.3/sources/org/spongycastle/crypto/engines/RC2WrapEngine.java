...
public class RC2WrapEngine implements Wrapper {
    ...
    private byte[] f207482iv;
    private CipherParameters param;
    private ParametersWithIV paramPlusIV;

    /* JADX INFO: renamed from: sr */
    private SecureRandom f207483sr;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            this.f207483sr = parametersWithRandom.getRandom();
            cipherParameters = parametersWithRandom.getParameters();
        } else {
            this.f207483sr = new SecureRandom();
        }
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ...
            if (this.forWrapping) {
                ...
                this.f207482iv = bArr;
                this.f207483sr.nextBytes(bArr);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f207482iv);
                return;
            }
            return;
        }
        ...
        this.f207482iv = parametersWithIV.getIV();
        this.param = this.paramPlusIV.getParameters();
        if (!this.forWrapping) {
            wg3.m206174a("You should not supply an IV for unwrapping");
            return;
        }
        byte[] bArr2 = this.f207482iv;
        if (bArr2 == null || bArr2.length != 8) {
            wg3.m206174a("IV is not 8 octets");
        }
    }
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (bArr == null) {
            psl.m173659a("Null pointer as ciphertext");
            return null;
        }
        ...
        this.f207482iv = bArr4;
        int i6 = i2 - 8;
        byte[] bArr5 = new byte[i6];
        System.arraycopy(bArr3, 0, bArr4, 0, 8);
        System.arraycopy(bArr3, 8, bArr5, 0, i6);
        ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f207482iv);
        this.paramPlusIV = parametersWithIV;
        ...
        if (!checkCMSKeyChecksum(bArr7, bArr8)) {
            psl.m173659a("Checksum inside ciphertext is corrupted");
            return null;
        }
        int i9 = bArr7[0];
        if (i8 - ((i9 & 255) + 1) <= 7) {
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (!this.forWrapping) {
            wtq0.m207906a("Not initialized for wrapping");
            return null;
        }
        int i3 = i2 + 1;
        int i4 = i3 % 8;
        ...
        if (i6 > 0) {
            this.f207483sr.nextBytes(bArr3);
        ...
        if (length % this.engine.getBlockSize() != 0) {
            wtq0.m207906a("Not multiple of block length");
            return null;
        }
        ...
        byte[] bArr6 = this.f207482iv;
        int length2 = bArr6.length + length;
        byte[] bArr7 = new byte[length2];
        System.arraycopy(bArr6, 0, bArr7, 0, bArr6.length);
        System.arraycopy(bArr5, 0, bArr7, this.f207482iv.length, length);
