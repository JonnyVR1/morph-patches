...
public class SCrypt {
    ...
    public static byte[] generate(byte[] bArr, byte[] bArr2, int i, int i2, int i3, int i4) {
        if (bArr == null) {
            wg3.m206174a("Passphrase P must be provided.");
            return null;
        }
        if (bArr2 == null) {
            wg3.m206174a("Salt S must be provided.");
            return null;
        }
        if (i <= 1) {
            wg3.m206174a("Cost parameter N must be > 1.");
            return null;
        }
        if (i2 == 1 && i > 65536) {
            wg3.m206174a("Cost parameter N must be > 1 and < 65536.");
            return null;
        }
        if (i2 < 1) {
            wg3.m206174a("Block size r must be >= 1.");
            return null;
        }
        int i5 = Api.BaseClientBuilder.API_PRIORITY_OTHER / (i2 * 1024);
        if (i3 < 1 || i3 > i5) {
            vsd0.m202605a("Parallelisation parameter p must be >= 1 and <= ", i5, " (based on block size r of ", i2, ")");
            return null;
        }
        if (i4 >= 1) {
            return MFcrypt(bArr, bArr2, i, i2, i3, i4);
        }
        wg3.m206174a("Generated key length dkLen must be >= 1.");
        return null;
    }
