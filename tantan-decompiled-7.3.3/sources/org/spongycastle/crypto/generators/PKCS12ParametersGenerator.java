...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    private int f207536u;

    /* JADX INFO: renamed from: v */
    private int f207537v;

    public PKCS12ParametersGenerator(Digest digest) {
        this.digest = digest;
        if (!(digest instanceof ExtendedDigest)) {
            pnl.m173070a("Digest ", digest.getAlgorithmName(), " unsupported");
            throw null;
        }
        this.f207536u = digest.getDigestSize();
        this.f207537v = ((ExtendedDigest) digest).getByteLength();
    }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        ...
        int i12 = this.f207537v;
        byte[] bArr10 = new byte[i12];
        int i13 = this.f207536u;
        ...
        while (i15 <= i14) {
            ...
            int i20 = this.f207536u;
            if (i15 == i14) {
                int i21 = i15 - 1;
                int i22 = i21 * i20;
                int i23 = i2 - (i21 * i20);
                i3 = 0;
                System.arraycopy(bArr11, 0, bArr4, i22, i23);
            } else {
                i3 = 0;
                System.arraycopy(bArr11, 0, bArr4, (i15 - 1) * i20, i13);
            }
            i15++;
            i5 = i3;
            i7 = 1;
