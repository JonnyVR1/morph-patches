...
public class DSAParametersGenerator {
    ...
    private int f207526L;

    /* JADX INFO: renamed from: N */
    private int f207527N;
    ...
    private DSAParameters generateParameters_FIPS186_2() {
        ...
        int i2 = this.f207526L;
        int i3 = (i2 - 1) / 160;
        int i4 = i2 / 8;
        byte[] bArr5 = new byte[i4];
        if (!(this.digest instanceof SHA1Digest)) {
            wtq0.m207906a("can only use SHA-1 for generating FIPS 186-2 parameters");
            return null;
        }
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (bigIntegerSubtract.bitLength() == this.f207526L && isProbablePrime(bigIntegerSubtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f207527N / 8];
        int i2 = this.f207526L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f207527N - 1)).setBit(0).setBit(this.f207527N - 1);
            if (isProbablePrime(bit)) {
                byte[] bArrClone = Arrays.clone(bArr);
                int i7 = this.f207526L * 4;
                i = 0;
                while (i < i7) {
    ...
    public void init(DSAParameterGenerationParameters dSAParameterGenerationParameters) {
        ...
        if (l2 < 1024 || l2 > 3072 || l2 % 1024 != 0) {
            wg3.m206174a("L values must be between 1024 and 3072 and a multiple of 1024");
            return;
        }
        if (l2 == 1024 && n != 160) {
            wg3.m206174a("N must be 160 for L = 1024");
            return;
        }
        if (l2 == 2048 && n != 224 && n != 256) {
            wg3.m206174a("N must be 224 or 256 for L = 2048");
            return;
        }
        if (l2 == 3072 && n != 256) {
            wg3.m206174a("N must be 256 for L = 3072");
            return;
        }
        if (this.digest.getDigestSize() * 8 < n) {
            wtq0.m207906a("Digest output size too small for value of N");
            return;
        }
        this.f207526L = l2;
        this.f207527N = n;
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f207526L = i;
        this.f207527N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f207526L), (i2 + 1) / 2);
