...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    private final int f207528h;
    private byte[] ios;

    /* JADX INFO: renamed from: k */
    private byte[] f207529k;
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f207528h = macSize;
        this.f207529k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f207528h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f207529k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        if (i3 % this.f207528h == 0) {
            generateNext();
        }
        int i5 = this.generatedBytes;
        int i6 = this.f207528h;
        int i7 = i5 % i6;
        int iMin = Math.min(i6 - (i5 % i6), i2);
        System.arraycopy(this.f207529k, i7, bArr, i, iMin);
        ...
        while (true) {
            ...
            generateNext();
            iMin = Math.min(this.f207528h, i8);
            System.arraycopy(this.f207529k, 0, bArr, i, iMin);
            this.generatedBytes += iMin;
            i8 -= iMin;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f207528h));
