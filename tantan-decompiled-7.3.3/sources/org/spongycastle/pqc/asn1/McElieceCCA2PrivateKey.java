...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    private int f207798k;

    /* JADX INFO: renamed from: n */
    private int f207799n;
    private ASN1ObjectIdentifier oid;

    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.oid = (ASN1ObjectIdentifier) aSN1Sequence.getObjectAt(0);
        this.f207799n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f207798k = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public int getK() {
        return this.f207798k;
    }

    public int getN() {
        return this.f207799n;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f207799n));
        aSN1EncodableVector.add(new ASN1Integer(this.f207798k));
