...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private byte[] f207810b1;

    /* JADX INFO: renamed from: b2 */
    private byte[] f207811b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f207810b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f207811b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f207812vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f207812vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f207812vi;
            int i11 = i10 + 1;
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f207810b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f207811b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f207812vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f207810b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f207811b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f207812vi));
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f207810b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f207811b2 = RainbowUtil.convertArray(sArr4);
        this.f207812vi = RainbowUtil.convertIntArray(iArr);
