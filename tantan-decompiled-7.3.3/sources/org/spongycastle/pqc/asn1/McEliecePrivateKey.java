...
public class McEliecePrivateKey extends ASN1Object {
    ...
    private int f207802k;

    /* JADX INFO: renamed from: n */
    private int f207803n;
    private ASN1ObjectIdentifier oid;

    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.oid = (ASN1ObjectIdentifier) aSN1Sequence.getObjectAt(0);
        this.f207803n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f207802k = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public int getK() {
        return this.f207802k;
    }

    public int getN() {
        return this.f207803n;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f207803n));
        aSN1EncodableVector.add(new ASN1Integer(this.f207802k));
