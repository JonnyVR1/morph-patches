...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    private int f207800n;
    private ASN1ObjectIdentifier oid;

    /* JADX INFO: renamed from: t */
    private int f207801t;

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.oid = (ASN1ObjectIdentifier) aSN1Sequence.getObjectAt(0);
        this.f207800n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f207801t = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f207800n));
        aSN1EncodableVector.add(new ASN1Integer(this.f207801t));
