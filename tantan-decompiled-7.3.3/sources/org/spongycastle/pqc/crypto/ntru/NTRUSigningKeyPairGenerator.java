...
public class NTRUSigningKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public class FGBasis extends NTRUSigningPrivateKeyParameters.Basis {
        ...
        public IntegerPolynomial f207892F;

        /* JADX INFO: renamed from: G */
        public IntegerPolynomial f207893G;
        ...
        public FGBasis(Polynomial polynomial, Polynomial polynomial2, IntegerPolynomial integerPolynomial, IntegerPolynomial integerPolynomial2, IntegerPolynomial integerPolynomial3, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) {
            ...
            this.f207892F = integerPolynomial2;
            this.f207893G = integerPolynomial3;
        }
        ...
        public boolean isNormOk() {
            ...
            int i = nTRUSigningKeyGenerationParameters.f207891q;
            return ((double) this.f207892F.centeredNormSq(i)) < d && ((double) this.f207893G.centeredNormSq(i)) < d;
        }
    }
    ...
    private FGBasis generateBasis() {
        ...
        int i3 = nTRUSigningKeyGenerationParameters.f207886N;
        int i4 = nTRUSigningKeyGenerationParameters.f207891q;
        int i5 = nTRUSigningKeyGenerationParameters.f207887d;
        int i6 = nTRUSigningKeyGenerationParameters.f207888d1;
        int i7 = nTRUSigningKeyGenerationParameters.f207889d2;
        int i8 = nTRUSigningKeyGenerationParameters.f207890d3;
        ...
        bigIntPolynomial.mult(bigIntEuclideanCalculate.f207929x.multiply(BigInteger.valueOf(i4)));
        BigIntPolynomial bigIntPolynomial2 = (BigIntPolynomial) resultant.rho.clone();
        bigIntPolynomial2.mult(bigIntEuclideanCalculate.f207930y.multiply(BigInteger.valueOf(-i4)));
        int i14 = 0;
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        for (int i2 = this.params.f207885B; i2 >= 0; i2--) {
            Future future = (Future) arrayList.get(i2);
            try {
                arrayList2.add(future.get());
                if (i2 == this.params.f207885B) {
                    nTRUSigningPublicKeyParameters = new NTRUSigningPublicKeyParameters(((NTRUSigningPrivateKeyParameters.Basis) future.get()).f207902h, this.params.getSigningParameters());
                }
            } catch (Exception e) {
                xpg0.m212648a(e);
                return null;
    ...
    public AsymmetricCipherKeyPair generateKeyPairSingleThread() {
        ArrayList arrayList = new ArrayList();
        NTRUSigningPublicKeyParameters nTRUSigningPublicKeyParameters = null;
        for (int i = this.params.f207885B; i >= 0; i--) {
            ...
            if (i == 0) {
                nTRUSigningPublicKeyParameters = new NTRUSigningPublicKeyParameters(basisGenerateBoundedBasis.f207902h, this.params.getSigningParameters());
            }
        }
