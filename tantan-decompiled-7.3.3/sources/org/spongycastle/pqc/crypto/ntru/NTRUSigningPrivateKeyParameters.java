...
public class NTRUSigningPrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public NTRUSigningPrivateKeyParameters(InputStream inputStream, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) throws IOException {
        ...
        int i = 0;
        while (i <= nTRUSigningKeyGenerationParameters.f207885B) {
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < this.bases.size(); i++) {
            ...
            if (!basis.f207901f.equals(basis2.f207901f) || !basis.fPrime.equals(basis2.fPrime)) {
                return false;
            }
            if ((i != 0 && !basis.f207902h.equals(basis2.f207902h)) || !basis.params.equals(basis2.params)) {
                return false;
            }
        }
        return true;
    ...
    public static class Basis {
        ...
        public Polynomial f207901f;
        public Polynomial fPrime;

        /* JADX INFO: renamed from: h */
        public IntegerPolynomial f207902h;
        ...
        public Basis(InputStream inputStream, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters, boolean z) throws IOException {
            ...
            int i5 = nTRUSigningKeyGenerationParameters.f207888d1;
            int i6 = nTRUSigningKeyGenerationParameters.f207889d2;
            int i7 = nTRUSigningKeyGenerationParameters.f207890d3;
            ...
            if (nTRUSigningKeyGenerationParameters.polyType == 1) {
                ...
                this.f207901f = productFormPolynomialFromBinary;
            } else {
                i = i3;
                inputStream2 = inputStream;
                IntegerPolynomial integerPolynomialFromBinary3Tight = IntegerPolynomial.fromBinary3Tight(inputStream2, i);
                this.f207901f = z2 ? new SparseTernaryPolynomial(integerPolynomialFromBinary3Tight) : new DenseTernaryPolynomial(integerPolynomialFromBinary3Tight);
            }
            ...
            if (z) {
                this.f207902h = IntegerPolynomial.fromBinary(inputStream3, i2, i4);
            }
        }
        ...
        public void encode(OutputStream outputStream, boolean z) throws IOException {
            int i = this.params.f207891q;
            outputStream.write(getEncoded(this.f207901f));
            ...
            if (z) {
                outputStream.write(this.f207902h.toBinary(i));
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            Polynomial polynomial = this.f207901f;
            Polynomial polynomial2 = basis.f207901f;
            if (polynomial == null) {
                if (polynomial2 != null) {
                    return false;
                }
            ...
            IntegerPolynomial integerPolynomial = this.f207902h;
            IntegerPolynomial integerPolynomial2 = basis.f207902h;
        ...
        public Basis(Polynomial polynomial, Polynomial polynomial2, IntegerPolynomial integerPolynomial, NTRUSigningKeyGenerationParameters nTRUSigningKeyGenerationParameters) {
            this.f207901f = polynomial;
            this.fPrime = polynomial2;
            this.f207902h = integerPolynomial;
            this.params = nTRUSigningKeyGenerationParameters;
        }
    }
}
