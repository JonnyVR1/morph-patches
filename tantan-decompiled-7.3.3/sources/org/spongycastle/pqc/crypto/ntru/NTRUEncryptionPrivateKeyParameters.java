...
public class NTRUEncryptionPrivateKeyParameters extends NTRUEncryptionKeyParameters {
    ...
    public IntegerPolynomial f207881fp;

    /* JADX INFO: renamed from: h */
    public IntegerPolynomial f207882h;

    /* JADX INFO: renamed from: t */
    public Polynomial f207883t;
    ...
    public NTRUEncryptionPrivateKeyParameters(InputStream inputStream, NTRUEncryptionParameters nTRUEncryptionParameters) throws IOException {
        ...
        int i2 = nTRUEncryptionParameters.f207874N;
        if (i == 1) {
            ...
            this.f207882h = IntegerPolynomial.fromBinary(inputStream, i2, nTRUEncryptionParameters.f207880q);
            this.f207883t = ProductFormPolynomial.fromBinary(inputStream, i2, i3, i4, i5, i6);
        } else {
            this.f207882h = IntegerPolynomial.fromBinary(inputStream, i2, nTRUEncryptionParameters.f207880q);
            IntegerPolynomial integerPolynomialFromBinary3Tight = IntegerPolynomial.fromBinary3Tight(inputStream, nTRUEncryptionParameters.f207874N);
            this.f207883t = nTRUEncryptionParameters.sparse ? new SparseTernaryPolynomial(integerPolynomialFromBinary3Tight) : new DenseTernaryPolynomial(integerPolynomialFromBinary3Tight);
        }
        init();
    }
    ...
    private void init() {
        if (!this.params.fastFp) {
            this.f207881fp = this.f207883t.toIntegerPolynomial().invertF3();
            return;
        }
        IntegerPolynomial integerPolynomial = new IntegerPolynomial(this.params.f207874N);
        this.f207881fp = integerPolynomial;
    ...
    public boolean equals(Object obj) {
        ...
        Polynomial polynomial = this.f207883t;
        Polynomial polynomial2 = nTRUEncryptionPrivateKeyParameters.f207883t;
        if (polynomial == null) {
            if (polynomial2 != null) {
                return false;
            }
        ...
        return this.f207882h.equals(nTRUEncryptionPrivateKeyParameters.f207882h);
    }

    public byte[] getEncoded() {
        byte[] binary = this.f207882h.toBinary(this.params.f207880q);
        Polynomial polynomial = this.f207883t;
    ...
    public int hashCode() {
        ...
        IntegerPolynomial integerPolynomial = this.f207882h;
    ...
    public NTRUEncryptionPrivateKeyParameters(IntegerPolynomial integerPolynomial, Polynomial polynomial, IntegerPolynomial integerPolynomial2, NTRUEncryptionParameters nTRUEncryptionParameters) {
        super(true, nTRUEncryptionParameters);
        this.f207882h = integerPolynomial;
        this.f207883t = polynomial;
        this.f207881fp = integerPolynomial2;
    }
}
