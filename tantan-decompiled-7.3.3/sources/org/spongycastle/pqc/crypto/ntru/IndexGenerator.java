...
public class IndexGenerator {
    ...
    private int f207865N;
    private BitString buf;

    /* JADX INFO: renamed from: c */
    private int f207866c;
    private int hLen;
    ...
    public IndexGenerator(byte[] bArr, NTRUEncryptionParameters nTRUEncryptionParameters) {
        this.seed = bArr;
        this.f207865N = nTRUEncryptionParameters.f207874N;
        this.f207866c = nTRUEncryptionParameters.f207875c;
    ...
    public int nextIndex() {
        ...
        do {
            ...
            leadingAsInt = trailing.getLeadingAsInt(this.f207866c);
            i = this.f207866c;
            i2 = this.f207865N;
    ...
    public static class BitString {
        ...
        public void appendBits(byte b) {
            ...
            int i4 = i2 - 1;
            int i5 = b & 255;
            bArr2[i4] = (byte) ((i5 << i3) | bArr2[i4]);
            this.numBytes = i2 + 1;
            bArr2[i2] = (byte) (i5 >> (8 - i3));
        }
