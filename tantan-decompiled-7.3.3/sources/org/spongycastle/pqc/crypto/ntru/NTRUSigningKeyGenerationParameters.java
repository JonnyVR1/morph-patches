...
public class NTRUSigningKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    public int f207888d1;

    /* JADX INFO: renamed from: d2 */
    public int f207889d2;

    /* JADX INFO: renamed from: d3 */
    public int f207890d3;
    ...
    public NTRUSigningKeyGenerationParameters(InputStream inputStream) throws IOException {
        ...
        this.f207886N = dataInputStream.readInt();
        this.f207891q = dataInputStream.readInt();
        this.f207887d = dataInputStream.readInt();
        this.f207888d1 = dataInputStream.readInt();
        this.f207889d2 = dataInputStream.readInt();
        this.f207890d3 = dataInputStream.readInt();
        this.f207885B = dataInputStream.readInt();
    ...
    public NTRUSigningKeyGenerationParameters clone() {
        int i = this.polyType;
        int i2 = this.f207886N;
        return i == 0 ? new NTRUSigningKeyGenerationParameters(i2, this.f207891q, this.f207887d, this.f207885B, this.basisType, this.beta, this.normBound, this.keyNormBound, this.primeCheck, this.sparse, this.keyGenAlg, this.hashAlg) : new NTRUSigningKeyGenerationParameters(i2, this.f207891q, this.f207888d1, this.f207889d2, this.f207890d3, this.f207885B, this.basisType, this.beta, this.normBound, this.keyNormBound, this.primeCheck, this.sparse, this.keyGenAlg, this.hashAlg);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f207885B != nTRUSigningKeyGenerationParameters.f207885B || this.f207886N != nTRUSigningKeyGenerationParameters.f207886N || this.basisType != nTRUSigningKeyGenerationParameters.basisType || Double.doubleToLongBits(this.beta) != Double.doubleToLongBits(nTRUSigningKeyGenerationParameters.beta) || Double.doubleToLongBits(this.betaSq) != Double.doubleToLongBits(nTRUSigningKeyGenerationParameters.betaSq) || this.bitsF != nTRUSigningKeyGenerationParameters.bitsF || this.f207887d != nTRUSigningKeyGenerationParameters.f207887d || this.f207888d1 != nTRUSigningKeyGenerationParameters.f207888d1 || this.f207889d2 != nTRUSigningKeyGenerationParameters.f207889d2 || this.f207890d3 != nTRUSigningKeyGenerationParameters.f207890d3) {
            return false;
        }
        ...
        return this.keyGenAlg == nTRUSigningKeyGenerationParameters.keyGenAlg && Double.doubleToLongBits(this.keyNormBound) == Double.doubleToLongBits(nTRUSigningKeyGenerationParameters.keyNormBound) && Double.doubleToLongBits(this.keyNormBoundSq) == Double.doubleToLongBits(nTRUSigningKeyGenerationParameters.keyNormBoundSq) && Double.doubleToLongBits(this.normBound) == Double.doubleToLongBits(nTRUSigningKeyGenerationParameters.normBound) && Double.doubleToLongBits(this.normBoundSq) == Double.doubleToLongBits(nTRUSigningKeyGenerationParameters.normBoundSq) && this.polyType == nTRUSigningKeyGenerationParameters.polyType && this.primeCheck == nTRUSigningKeyGenerationParameters.primeCheck && this.f207891q == nTRUSigningKeyGenerationParameters.f207891q && this.signFailTolerance == nTRUSigningKeyGenerationParameters.signFailTolerance && this.sparse == nTRUSigningKeyGenerationParameters.sparse;
    }

    public NTRUSigningParameters getSigningParameters() {
        return new NTRUSigningParameters(this.f207886N, this.f207891q, this.f207887d, this.f207885B, this.beta, this.normBound, this.hashAlg);
    }

    public int hashCode() {
        int i = ((((this.f207885B + 31) * 31) + this.f207886N) * 31) + this.basisType;
        ...
        int i3 = ((((((((((((i2 * 31) + ((int) (jDoubleToLongBits2 ^ (jDoubleToLongBits2 >>> 32)))) * 31) + this.bitsF) * 31) + this.f207887d) * 31) + this.f207888d1) * 31) + this.f207889d2) * 31) + this.f207890d3) * 31;
        Digest digest = this.hashAlg;
        ...
        return (((((((((((i6 * 31) + ((int) (jDoubleToLongBits6 ^ (jDoubleToLongBits6 >>> 32)))) * 31) + this.polyType) * 31) + (this.primeCheck ? 1231 : 1237)) * 31) + this.f207891q) * 31) + this.signFailTolerance) * 31) + (this.sparse ? 1231 : 1237);
    }

    public String toString() {
        DecimalFormat decimalFormat = new DecimalFormat("0.00");
        StringBuilder sb = new StringBuilder("SignatureParameters(N=" + this.f207886N + " q=" + this.f207891q);
        if (this.polyType == 0) {
            sb.append(" polyType=SIMPLE d=" + this.f207887d);
        } else {
            sb.append(" polyType=PRODUCT d1=" + this.f207888d1 + " d2=" + this.f207889d2 + " d3=" + this.f207890d3);
        }
        sb.append(" B=" + this.f207885B + " basisType=" + this.basisType + " beta=" + decimalFormat.format(this.beta) + " normBound=" + decimalFormat.format(this.normBound) + " keyNormBound=" + decimalFormat.format(this.keyNormBound) + " prime=" + this.primeCheck + " sparse=" + this.sparse + " keyGenAlg=" + this.keyGenAlg + " hashAlg=" + this.hashAlg + ")");
        return sb.toString();
    }

    public void writeTo(OutputStream outputStream) throws IOException {
        DataOutputStream dataOutputStream = new DataOutputStream(outputStream);
        dataOutputStream.writeInt(this.f207886N);
        dataOutputStream.writeInt(this.f207891q);
        dataOutputStream.writeInt(this.f207887d);
        dataOutputStream.writeInt(this.f207888d1);
        dataOutputStream.writeInt(this.f207889d2);
        dataOutputStream.writeInt(this.f207890d3);
        dataOutputStream.writeInt(this.f207885B);
