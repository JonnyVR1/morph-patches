...
public class NTRUSigner {
    ...
    private IntegerPolynomial sign(IntegerPolynomial integerPolynomial, NTRUSigningPrivateKeyParameters nTRUSigningPrivateKeyParameters) {
        ...
        int i = nTRUSigningParameters.f207895N;
        int i2 = nTRUSigningParameters.f207900q;
        ...
        for (int i3 = nTRUSigningParameters.f207894B; i3 >= 1; i3--) {
            Polynomial polynomial = nTRUSigningPrivateKeyParameters.getBasis(i3).f207901f;
            ...
            IntegerPolynomial integerPolynomial3 = (IntegerPolynomial) nTRUSigningPrivateKeyParameters.getBasis(i3).f207902h.clone();
            if (i3 > 1) {
                integerPolynomial3.sub(nTRUSigningPrivateKeyParameters.getBasis(i3 - 1).f207902h);
            } else {
                integerPolynomial3.sub(publicKey.f207903h);
            }
            integerPolynomial = integerPolynomialMult2.mult(integerPolynomial3, i2);
        }
        Polynomial polynomial3 = nTRUSigningPrivateKeyParameters.getBasis(0).f207901f;
    ...
    private byte[] signHash(byte[] bArr, NTRUSigningPrivateKeyParameters nTRUSigningPrivateKeyParameters) {
        ...
        } while (!verify(integerPolynomialCreateMsgRep, integerPolynomialSign, publicKey.f207903h));
        byte[] binary = integerPolynomialSign.toBinary(this.params.f207900q);
    ...
    private boolean verify(IntegerPolynomial integerPolynomial, IntegerPolynomial integerPolynomial2, IntegerPolynomial integerPolynomial3) {
        NTRUSigningParameters nTRUSigningParameters = this.params;
        int i = nTRUSigningParameters.f207900q;
    ...
    private boolean verifyHash(byte[] bArr, byte[] bArr2, NTRUSigningPublicKeyParameters nTRUSigningPublicKeyParameters) {
        ...
        NTRUSigningParameters nTRUSigningParameters = this.params;
        return verify(createMsgRep(bArr, byteBufferWrap.getInt()), IntegerPolynomial.fromBinary(bArr3, nTRUSigningParameters.f207895N, nTRUSigningParameters.f207900q), nTRUSigningPublicKeyParameters.f207903h);
    }

    public IntegerPolynomial createMsgRep(byte[] bArr, int i) {
        NTRUSigningParameters nTRUSigningParameters = this.params;
        int i2 = nTRUSigningParameters.f207895N;
        int iNumberOfLeadingZeros = Integer.numberOfLeadingZeros(nTRUSigningParameters.f207900q);
    ...
    public byte[] generateSignature() {
        ...
        if (digest == null || this.signingKeyPair == null) {
            wtq0.m207906a("Call initSign first!");
            return null;
        }
    ...
    public void update(byte b) {
        ...
        if (digest != null) {
            ...
            wtq0.m207906a("Call initSign or initVerify first!");
        }
    }
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (digest == null || this.verificationKey == null) {
            wtq0.m207906a("Call initVerify first!");
            return false;
        }
