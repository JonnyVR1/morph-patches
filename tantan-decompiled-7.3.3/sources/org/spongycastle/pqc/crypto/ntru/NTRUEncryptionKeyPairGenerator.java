...
public class NTRUEncryptionKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        int i = nTRUEncryptionKeyGenerationParameters.f207867N;
        int i2 = nTRUEncryptionKeyGenerationParameters.f207873q;
        int i3 = nTRUEncryptionKeyGenerationParameters.f207870df;
        ...
        int i7 = nTRUEncryptionKeyGenerationParameters.f207871dg;
