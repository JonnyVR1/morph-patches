...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i4] = new Treehash[i6 - this.f207813K[i4]];
            if (i4 > 0) {
                int i7 = i4 - 1;
                int[] iArr2 = new int[2];
                ...
                treehashArr2[i7] = new Treehash[this.heightOfTrees[i4] - this.f207813K[i4]];
            }
        ...
        while (i11 >= 0) {
            GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i11], this.f207813K[i11], this.digestProvider);
            try {
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f207813K[i], this.digestProvider);
        ...
        while (true) {
            ...
            if (i6 == i4 && i5 < i7 - this.f207813K[i]) {
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i3 == i2 && i4 < i5 - this.f207813K[i]) {
    ...
    public void initialize(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f207813K = this.gmssPS.getK();
