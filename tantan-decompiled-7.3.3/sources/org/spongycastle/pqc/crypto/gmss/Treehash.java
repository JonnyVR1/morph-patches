...
public class Treehash {
    ...
    public String toString() {
        String strConcat = "Treehash    : ";
        for (int i = 0; i < this.tailLength + 6; i++) {
            strConcat = strConcat + getStatInt()[i] + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
        }
        for (int i2 = 0; i2 < this.tailLength + 3; i2++) {
            strConcat = getStatByte()[i2] != null ? strConcat + new String(Hex.encode(getStatByte()[i2])) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : strConcat.concat("null ");
        }
        return strConcat + "  " + this.messDigestTree.getDigestSize();
    }
