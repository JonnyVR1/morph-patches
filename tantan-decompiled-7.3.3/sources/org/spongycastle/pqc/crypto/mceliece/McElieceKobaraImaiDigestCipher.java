...
public class McElieceKobaraImaiDigestCipher {
    ...
    public byte[] messageDecrypt(byte[] bArr) {
        if (this.forEncrypting) {
            wtq0.m207906a("McElieceKobaraImaiDigestCipher not initialised for decrypting.");
            return null;
        }
        try {
    ...
    public byte[] messageEncrypt() {
        if (!this.forEncrypting) {
            wtq0.m207906a("McElieceKobaraImaiDigestCipher not initialised for encrypting.");
            return null;
        }
