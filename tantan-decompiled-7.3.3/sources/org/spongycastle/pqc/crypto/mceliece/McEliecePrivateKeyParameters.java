...
public class McEliecePrivateKeyParameters extends McElieceKeyParameters {
    ...
    private GF2Matrix f207857h;

    /* JADX INFO: renamed from: k */
    private int f207858k;

    /* JADX INFO: renamed from: n */
    private int f207859n;
    private String oid;

    /* JADX INFO: renamed from: p1 */
    private Permutation f207860p1;

    /* JADX INFO: renamed from: p2 */
    private Permutation f207861p2;
    ...
    public McEliecePrivateKeyParameters(String str, int i, int i2, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[][] bArr7, McElieceParameters mcElieceParameters) {
        ...
        this.f207860p1 = new Permutation(bArr4);
        this.f207861p2 = new Permutation(bArr5);
        this.f207857h = new GF2Matrix(bArr6);
    ...
    public GF2Matrix getH() {
        return this.f207857h;
    }

    public int getK() {
        return this.f207858k;
    }

    public int getN() {
        return this.f207859n;
    }
    ...
    public Permutation getP1() {
        return this.f207860p1;
    }

    public Permutation getP2() {
        return this.f207861p2;
    }
    ...
    public McEliecePrivateKeyParameters(String str, int i, int i2, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, GF2Matrix gF2Matrix, Permutation permutation, Permutation permutation2, GF2Matrix gF2Matrix2, PolynomialGF2mSmallM[] polynomialGF2mSmallMArr, McElieceParameters mcElieceParameters) {
        ...
        this.sInv = gF2Matrix;
        this.f207860p1 = permutation;
        this.f207861p2 = permutation2;
        this.f207857h = gF2Matrix2;
