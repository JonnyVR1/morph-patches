...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private int f207842k;
    McElieceCCA2KeyParameters key;
    private Digest messDigest;

    /* JADX INFO: renamed from: n */
    private int f207843n;

    /* JADX INFO: renamed from: sr */
    private SecureRandom f207844sr;

    /* JADX INFO: renamed from: t */
    private int f207845t;

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = mcElieceCCA2PublicKeyParameters.getParameters().getDigest();
        this.f207843n = mcElieceCCA2PublicKeyParameters.getN();
        this.f207842k = mcElieceCCA2PublicKeyParameters.getK();
        this.f207845t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f207844sr = new SecureRandom();
            ...
            this.f207844sr = parametersWithRandom.getRandom();
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f207843n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f207842k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f207845t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    @Override // org.spongycastle.pqc.crypto.MessageEncryptor
    public byte[] messageDecrypt(byte[] bArr) throws Exception {
        byte[] bArr2;
        int i = this.f207843n >> 3;
        if (bArr.length < i) {
            brq0.m106161a("Bad Padding: Ciphertext too short.");
            return null;
        }
        int digestSize = this.messDigest.getDigestSize();
        int i2 = this.f207842k >> 3;
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f207843n, bArr));
        ...
        byte[] bArrConcatenate = ByteUtils.concatenate(ByteUtils.concatenate(bArr2, Conversions.decode(this.f207843n, this.f207845t, gF2Vector)), encoded);
    ...
    public byte[] messageEncrypt(byte[] bArr) throws Exception {
        int digestSize = this.messDigest.getDigestSize();
        int i = this.f207842k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f207843n, this.f207845t).bitLength() - 1) >> 3;
        ...
        this.f207844sr.nextBytes(bArr4);
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f207842k, bArr9), Conversions.encode(this.f207843n, this.f207845t, bArr8)).getEncoded();
