...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        private GF2Matrix f207923h;

        /* JADX INFO: renamed from: p */
        private Permutation f207924p;

        /* JADX INFO: renamed from: s */
        private GF2Matrix f207925s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f207925s = gF2Matrix;
            this.f207923h = gF2Matrix2;
            this.f207924p = permutation;
        }

        public GF2Matrix getFirstMatrix() {
            return this.f207925s;
        }

        public Permutation getPermutation() {
            return this.f207924p;
        }

        public GF2Matrix getSecondMatrix() {
            return this.f207923h;
        }
    }
    ...
    public static class MatrixSet {
        ...
        private GF2Matrix f207926g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f207926g = gF2Matrix;
            this.setJ = iArr;
        }

        public GF2Matrix getG() {
            return this.f207926g;
        }
