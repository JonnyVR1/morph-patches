...
public class GF2nPolynomialElement extends GF2nElement {
    ...
    private void reduceThis() {
        ...
        boolean zIsTrinomial = ((GF2nPolynomialField) this.mField).isTrinomial();
        ...
        if (zIsTrinomial) {
            try {
                ...
                azk0.m101074a("GF2nPolynomialElement.reduce: the field polynomial is not a trinomial");
                return;
            }
        }
        ...
        try {
            ...
            azk0.m101074a("GF2nPolynomialElement.reduce: the field polynomial is not a pentanomial");
        }
    }
