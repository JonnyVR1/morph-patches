...
public class IntegerPolynomial implements Polynomial {
    ...
    public IntegerPolynomial mult(IntegerPolynomial integerPolynomial) {
        ...
        if (integerPolynomial.coeffs.length != length) {
            wg3.m206174a("Number of coefficients must be the same");
            return null;
        }
    ...
    public Resultant resultant() {
        ...
        while (true) {
            ...
            BigInteger bigIntegerMod = bigInteger2.multiply(bigIntEuclideanCalculate.f207929x.multiply(bigIntegerNextPrime)).add(modularResultantResultant.res.multiply(bigIntEuclideanCalculate.f207930y.multiply(bigInteger))).mod(bigIntegerMultiply);
