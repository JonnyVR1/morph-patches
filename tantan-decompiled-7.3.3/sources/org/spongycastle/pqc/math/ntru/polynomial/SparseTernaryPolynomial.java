...
public class SparseTernaryPolynomial implements TernaryPolynomial {
    ...
    public SparseTernaryPolynomial(int[] iArr) {
        ...
        for (int i3 = 0; i3 < this.f207936N; i3++) {
            ...
            if (i4 == -1) {
                ...
                if (i4 != 1) {
                    i2r0.m138234a("Illegal value: ", i4, ", must be one of {-1, 0, 1}");
                    throw null;
                }
                this.ones[i] = i3;
                i++;
    ...
    public boolean equals(Object obj) {
        ...
        return this.f207936N == sparseTernaryPolynomial.f207936N && Arrays.areEqual(this.negOnes, sparseTernaryPolynomial.negOnes) && Arrays.areEqual(this.ones, sparseTernaryPolynomial.ones);
    }
    ...
    public int hashCode() {
        return ((((this.f207936N + 31) * 31) + Arrays.hashCode(this.negOnes)) * 31) + Arrays.hashCode(this.ones);
    }
    ...
    public IntegerPolynomial toIntegerPolynomial() {
        int[] iArr = new int[this.f207936N];
        int i = 0;
        int i2 = 0;
        while (true) {
            int[] iArr2 = this.ones;
