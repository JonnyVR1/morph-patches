...
public class SecP160R2FieldElement extends ECFieldElement {
    ...
    public static final BigInteger f207734Q = SecP160R2Curve.f207731q;

    /* JADX INFO: renamed from: x */
    protected int[] f207735x;

    public SecP160R2FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f207734Q) >= 0) {
            wg3.m206174a("x value invalid for SecP160R2FieldElement");
            throw null;
        }
        this.f207735x = SecP160R2Field.fromBigInteger(bigInteger);
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.add(this.f207735x, ((SecP160R2FieldElement) eCFieldElement).f207735x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.addOne(this.f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        Mod.invert(SecP160R2Field.f207732P, ((SecP160R2FieldElement) eCFieldElement).f207735x, iArrCreate);
        SecP160R2Field.multiply(iArrCreate, this.f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R2FieldElement) {
            return Nat160.m222474eq(this.f207735x, ((SecP160R2FieldElement) obj).f207735x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f207734Q.bitLength();
    }

    public int hashCode() {
        return Arrays.hashCode(this.f207735x, 0, 5) ^ f207734Q.hashCode();
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat160.create();
        Mod.invert(SecP160R2Field.f207732P, this.f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f207735x);
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f207735x);
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.multiply(this.f207735x, ((SecP160R2FieldElement) eCFieldElement).f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.negate(this.f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f207735x;
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.square(this.f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.subtract(this.f207735x, ((SecP160R2FieldElement) eCFieldElement).f207735x, iArrCreate);
        return new SecP160R2FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f207735x, 0) == 1;
    }

    @Override // org.spongycastle.math.p135ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f207735x);
    }

    public SecP160R2FieldElement() {
        this.f207735x = Nat160.create();
    }
