...
public class SecP160R1Field {
    ...
    private static final long f207726M = 4294967295L;

    /* JADX INFO: renamed from: P4 */
    private static final int f207728P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv = -2147483647;

    /* JADX INFO: renamed from: P */
    static final int[] f207727P = {Api.BaseClientBuilder.API_PRIORITY_OTHER, -1, -1, -1, -1};
    static final int[] PExt = {1, 1073741825, 0, 0, 0, -2, -2, -1, -1, -1};
    private static final int[] PExtInv = {-1, -1073741826, -1, -1, -1, 1, 1};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f207727P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f207727P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f207727P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat160.isZero(iArr)) {
            ...
            Nat160.sub(f207727P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        long j = ((long) iArr[5]) & f207726M;
        long j2 = ((long) iArr[6]) & f207726M;
        long j3 = ((long) iArr[7]) & f207726M;
        long j4 = ((long) iArr[8]) & f207726M;
        long j5 = ((long) iArr[9]) & f207726M;
        long j6 = (((long) iArr[0]) & f207726M) + j + (j << 31);
        iArr2[0] = (int) j6;
        long j7 = (j6 >>> 32) + (((long) iArr[1]) & f207726M) + j2 + (j2 << 31);
        iArr2[1] = (int) j7;
        long j8 = (j7 >>> 32) + (((long) iArr[2]) & f207726M) + j3 + (j3 << 31);
        iArr2[2] = (int) j8;
        long j9 = (j8 >>> 32) + (((long) iArr[3]) & f207726M) + j4 + (j4 << 31);
        iArr2[3] = (int) j9;
        long j10 = (j9 >>> 32) + (f207726M & ((long) iArr[4])) + j5 + (j5 << 31);
        iArr2[4] = (int) j10;
        reduce32((int) (j10 >>> 32), iArr2);
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mulWordsAdd(PInv, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f207727P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f207727P))) {
            Nat.addWordTo(5, PInv, iArr2);
        }
    }
}
