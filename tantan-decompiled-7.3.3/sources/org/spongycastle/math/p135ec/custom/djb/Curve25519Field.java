...
public class Curve25519Field {
    ...
    private static final long f207713M = 4294967295L;

    /* JADX INFO: renamed from: P7 */
    private static final int f207715P7 = Integer.MAX_VALUE;
    private static final int PInv = 19;

    /* JADX INFO: renamed from: P */
    static final int[] f207714P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    private static final int[] PExt = {361, 0, 0, 0, 0, 0, 0, 0, -19, -1, -1, -1, -1, -1, -1, 1073741823};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        Nat256.add(iArr, iArr2, iArr3);
        if (Nat256.gte(iArr3, f207714P)) {
            subPFrom(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        ...
        if (Nat256.gte(iArr2, f207714P)) {
            subPFrom(iArr2);
        }
    }

    private static int addPExtTo(int[] iArr) {
        long j = ((long) iArr[0]) & f207713M;
        int[] iArr2 = PExt;
        long j2 = j + (((long) iArr2[0]) & f207713M);
        iArr[0] = (int) j2;
        long jIncAt = j2 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(8, iArr, 1);
        }
        long j3 = jIncAt + ((((long) iArr[8]) & f207713M) - 19);
        iArr[8] = (int) j3;
        long jDecAt = j3 >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(15, iArr, 9);
        }
        long j4 = jDecAt + (((long) iArr[15]) & f207713M) + (f207713M & ((long) (iArr2[15] + 1)));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }

    private static int addPTo(int[] iArr) {
        long j = (((long) iArr[0]) & f207713M) - 19;
        iArr[0] = (int) j;
        long jDecAt = j >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(7, iArr, 1);
        }
        long j2 = jDecAt + (f207713M & ((long) iArr[7])) + 2147483648L;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat256.add(iArr, f207714P, iArr2);
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat256.isZero(iArr)) {
            ...
            Nat256.sub(f207714P, iArr, iArr2);
        }
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j3 = jDecAt + (((long) iArr[8]) & f207713M) + 19;
        iArr[8] = (int) j3;
        long jIncAt = j3 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(15, iArr, 9);
        }
        long j4 = jIncAt + ((((long) iArr[15]) & f207713M) - (f207713M & ((long) (iArr2[15] + 1))));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int subPFrom(int[] iArr) {
        ...
        long j2 = jIncAt + ((f207713M & ((long) iArr[7])) - 2147483648L);
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
