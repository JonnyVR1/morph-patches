...
class Tnaf {
    ...
    public static BigInteger[] getLucas(byte b, int i, boolean z) {
        ...
        if (b != 1 && b != -1) {
            wg3.m206174a("mu must be 1 or -1");
            return null;
        }
        if (z) {
    ...
    public static byte getMu(ECCurve.AbstractF2m abstractF2m) {
        ...
        wg3.m206174a("No Koblitz curve (ABC), TNAF multiplication not possible");
        return (byte) 0;
    }
    ...
    public static int getShiftsForCofactor(BigInteger bigInteger) {
        ...
        wg3.m206174a("h (Cofactor) must be 2 or 4");
        return 0;
    }

    public static BigInteger[] getSi(ECCurve.AbstractF2m abstractF2m) {
        if (!abstractF2m.isKoblitz()) {
            wg3.m206174a("si is defined for Koblitz curves only");
            return null;
        }
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger bigInteger = zTauElement.f207710u;
        BigInteger bigIntegerMultiply = bigInteger.multiply(bigInteger);
        BigInteger bigIntegerMultiply2 = zTauElement.f207710u.multiply(zTauElement.f207711v);
        BigInteger bigInteger2 = zTauElement.f207711v;
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f207710u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(zTauElementRound.f207711v)), bigIntegerArr[1].multiply(zTauElementRound.f207710u).subtract(bigIntegerArr[0].multiply(zTauElementRound.f207711v)));
    }
    ...
    */
    public static ZTauElement round(SimpleBigDecimal simpleBigDecimal, SimpleBigDecimal simpleBigDecimal2, byte b) {
        ...
        if (simpleBigDecimal2.getScale() != simpleBigDecimal.getScale()) {
            wg3.m206174a("lambda0 and lambda1 do not have same scale");
            return null;
        }
        int i = -1;
        int i2 = 1;
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerClearBit = zTauElement.f207710u;
        BigInteger bigInteger = zTauElement.f207711v;
        int i = 0;
        int i2 = 0;
        while (true) {
            BigInteger bigInteger2 = ECConstants.ZERO;
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger bigIntegerAdd = zTauElement.f207710u;
        BigInteger bigIntegerAdd2 = zTauElement.f207711v;
        int i = 0;
        while (true) {
            ...
            if (bigIntegerAdd.testBit(0)) {
                ...
                if (z) {
                    bigIntegerAdd = bigIntegerAdd.subtract(zTauElementArr[bIntValue].f207710u);
                    bigIntegerAdd2 = bigIntegerAdd2.subtract(zTauElementArr[bIntValue].f207711v);
                } else {
                    bigIntegerAdd = bigIntegerAdd.add(zTauElementArr[bIntValue].f207710u);
                    bigIntegerAdd2 = bigIntegerAdd2.add(zTauElementArr[bIntValue].f207711v);
                }
            } else {
                bArr[i] = 0;
            }
