...
class LongArray implements Cloneable {
    ...
    public LongArray(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0) {
            wg3.m206174a("invalid F2m field value");
            throw null;
        }
        int i = 1;
    ...
    private void addShiftedByBitsSafe(LongArray longArray, int i, int i2) {
        ...
        long jAddShiftedUp = addShiftedUp(jArr, i4, longArray.m_ints, 0, i3, i5);
        if (jAddShiftedUp != 0) {
            long[] jArr2 = this.m_ints;
            int i6 = i3 + i4;
            jArr2[i6] = jAddShiftedUp ^ jArr2[i6];
        }
    }
    ...
    private static long interleave2_n(long j, int i) {
        while (i > 1) {
            i -= 2;
            j = (interleave4_16to64(((int) (j >>> 48)) & p7f.COLOR_SPACE_UNCALIBRATED) << 3) | (interleave4_16to64(((int) (j >>> 16)) & p7f.COLOR_SPACE_UNCALIBRATED) << 1) | interleave4_16to64(((int) j) & p7f.COLOR_SPACE_UNCALIBRATED) | (interleave4_16to64(((int) (j >>> 32)) & p7f.COLOR_SPACE_UNCALIBRATED) << 2);
        }
        if (i <= 0) {
            return j;
        }
    ...
    private static long interleave7(long j) {
        ...
        return (jArr[((int) (j >>> 54)) & UnixStat.DEFAULT_LINK_PERM] << 6) | (Long.MIN_VALUE & j) | jArr[((int) j) & UnixStat.DEFAULT_LINK_PERM] | (jArr[((int) (j >>> 9)) & UnixStat.DEFAULT_LINK_PERM] << 1) | (jArr[((int) (j >>> 18)) & UnixStat.DEFAULT_LINK_PERM] << 2) | (jArr[((int) (j >>> 27)) & UnixStat.DEFAULT_LINK_PERM] << 3) | (jArr[((int) (j >>> 36)) & UnixStat.DEFAULT_LINK_PERM] << 4) | (jArr[((int) (j >>> 45)) & UnixStat.DEFAULT_LINK_PERM] << 5);
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i7 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i8, jArr3, 0);
            return reduceResult(jArr3, 0, i9, i, iArr);
        }
        int i12 = (i3 + 78) >>> 6;
        int i13 = i12 * 8;
        int[] iArr2 = new int[16];
        ...
        interleave(longArray2.m_ints, 0, jArr4, 0, i16, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr4, i16, i8);
        int i17 = i16;
        int i18 = 1;
        while (i18 < 8) {
            int i19 = i17 + i12;
            int i20 = i16;
            shiftUp(jArr4, i20, jArr4, i19, i12, i18);
            i16 = i20;
            i18++;
            i17 = i19;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    int i26 = ((int) j2) & i4;
                    if (i26 != 0) {
                        add(jArr4, iArr2[i26] + i23, jArr4, i25, i12);
                    }
                    i24 += i11;
                    if (i24 == 8) {
                        break;
        ...
        while (true) {
            int i28 = i27 - 1;
            if (i28 <= i11) {
                return reduceResult(jArr4, iArr2[i11], i9, i, iArr);
            }
            if ((((long) i28) & 1) == 0) {
                int i29 = i9;
                i6 = i11;
                jArr2 = jArr4;
                addShiftedUp(jArr2, iArr2[i28 >>> 1], jArr4, iArr2[i28], i29, 16);
                i5 = i29;
            } else {
                long[] jArr6 = jArr4;
                i5 = i9;
                i6 = i11;
                jArr2 = jArr6;
                distribute(jArr2, iArr2[i28], iArr2[i27 - 2], iArr2[i6], i5);
            }
            long[] jArr7 = jArr2;
            i11 = i6;
            i9 = i5;
