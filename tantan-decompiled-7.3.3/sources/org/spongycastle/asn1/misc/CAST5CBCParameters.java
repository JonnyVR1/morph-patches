...
public class CAST5CBCParameters extends ASN1Object {
    ...
    ASN1OctetString f207180iv;
    ASN1Integer keyLength;

    public CAST5CBCParameters(ASN1Sequence aSN1Sequence) {
        this.f207180iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return this.f207180iv.getOctets();
    }
