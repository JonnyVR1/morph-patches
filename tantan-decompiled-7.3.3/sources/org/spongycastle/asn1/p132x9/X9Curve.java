...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID x9FieldID, ASN1Sequence aSN1Sequence) {
        ...
        if (identifier.equals(X9ObjectIdentifiers.prime_field)) {
            ...
            this.curve = new ECCurve.C22395Fp(value, new X9FieldElement(value, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(value, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
        } else {
            if (!this.fieldIdentifier.equals(X9ObjectIdentifiers.characteristic_two_field)) {
                wg3.m206174a("This type of ECCurve is not implemented");
                throw null;
            }
            ...
            if (aSN1ObjectIdentifier.equals(X9ObjectIdentifiers.tpBasis)) {
                ...
                if (!aSN1ObjectIdentifier.equals(X9ObjectIdentifiers.ppBasis)) {
                    wg3.m206174a("This type of EC basis is not implemented");
                    throw null;
                }
