...
public class X509Name extends ASN1Object {
    ...
    public static final ASN1ObjectIdentifier f207225C;

    /* JADX INFO: renamed from: CN */
    public static final ASN1ObjectIdentifier f207226CN;
    public static final ASN1ObjectIdentifier COUNTRY_OF_CITIZENSHIP;
    public static final ASN1ObjectIdentifier COUNTRY_OF_RESIDENCE;
    public static final ASN1ObjectIdentifier DATE_OF_BIRTH;

    /* JADX INFO: renamed from: DC */
    public static final ASN1ObjectIdentifier f207227DC;
    ...
    public static final ASN1ObjectIdentifier f207228E;
    ...
    public static final ASN1ObjectIdentifier f207229L;
    public static final ASN1ObjectIdentifier NAME;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH;

    /* JADX INFO: renamed from: O */
    public static final ASN1ObjectIdentifier f207230O;
    public static final Hashtable OIDLookUp;

    /* JADX INFO: renamed from: OU */
    public static final ASN1ObjectIdentifier f207231OU;
    ...
    public static final ASN1ObjectIdentifier f207232SN;

    /* JADX INFO: renamed from: ST */
    public static final ASN1ObjectIdentifier f207233ST;
    public static final ASN1ObjectIdentifier STREET;
    public static final ASN1ObjectIdentifier SURNAME;
    public static final Hashtable SymbolLookUp;

    /* JADX INFO: renamed from: T */
    public static final ASN1ObjectIdentifier f207234T;
    ...
    static {
        ...
        hashtable.put(aSN1ObjectIdentifier, c4s.C_ZONE);
        hashtable.put(aSN1ObjectIdentifier2, BloodType.f39576O);
        hashtable.put(aSN1ObjectIdentifier4, p7f.GPS_DIRECTION_TRUE);
        ...
        hashtable2.put(aSN1ObjectIdentifier, c4s.C_ZONE);
        hashtable2.put(aSN1ObjectIdentifier2, BloodType.f39576O);
        ...
        hashtable3.put(aSN1ObjectIdentifier, c4s.C_ZONE);
        hashtable3.put(aSN1ObjectIdentifier2, BloodType.f39576O);
        ...
        hashtable4.put(BLiveStormDanmakuGiftResourceType.f45292l, aSN1ObjectIdentifier8);
            ...
            while (i < aSN1Set.size()) {
                ...
                if (!(objectAt instanceof ASN1String) || (objectAt instanceof DERUniversalString)) {
                    try {
                        ...
                        wg3.m206174a("cannot encode value");
                        throw null;
                    }
                } else {
    ...
    private void addEntry(Hashtable hashtable, String str, Boolean bool) {
        ...
        if (!x509NameTokenizer.hasMoreTokens()) {
            wg3.m206174a("badly formatted directory string");
            return;
        }
    ...
    private ASN1ObjectIdentifier decodeOID(String str, Hashtable hashtable) {
        ...
        v1d0.m199002a("Unknown object id - ", strTrim, " - passed to distinguished name");
        return null;
    }
    ...
    private ASN1Primitive decodeObject(String str) {
        try {
            ...
            xtq0.m213103a("unknown encoding in name: ", e);
            return null;
        }
    }
    ...
    public X509Name(Vector vector, Hashtable hashtable, X509NameEntryConverter x509NameEntryConverter) {
        ...
        for (int i2 = 0; i2 != this.ordering.size(); i2++) {
            ...
            if (hashtable.get(aSN1ObjectIdentifier) != null) {
                ...
                pnl.m173070a("No attribute for object id - ", aSN1ObjectIdentifier.getId(), " - passed to distinguished name");
                throw null;
            }
        }
    }
    ...
    public X509Name(Vector vector, Vector vector2, X509NameEntryConverter x509NameEntryConverter) {
        ...
        wg3.m206174a("oids vector must be same length as values.");
        throw null;
    }
