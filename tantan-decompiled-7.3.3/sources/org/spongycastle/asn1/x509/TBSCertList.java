...
public class TBSCertList extends ASN1Object {
    ...
    public class RevokedCertificatesEnumeration implements Enumeration {
        ...
        private final Enumeration f207224en;

        public RevokedCertificatesEnumeration(Enumeration enumeration) {
            this.f207224en = enumeration;
        }

        @Override // java.util.Enumeration
        public boolean hasMoreElements() {
            return this.f207224en.hasMoreElements();
        }

        @Override // java.util.Enumeration
        public Object nextElement() {
            return CRLEntry.getInstance(this.f207224en.nextElement());
        }
    }
