...
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    public static ASN1ObjectIdentifier getInstance(Object obj) {
        ...
        try {
            ...
            yg3.m215829a("failed to construct object identifier from byte[]: ", e.getMessage());
            return null;
        }
    }
    ...
    public boolean m222388on(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        String id = getId();
    ...
    public ASN1ObjectIdentifier(String str) {
        if (str != null) {
            if (isValidIdentifier(str)) {
                ...
                v1d0.m199002a("string ", str, " not an OID");
                throw null;
            }
        }
        wg3.m206174a("'identifier' cannot be null");
        throw null;
    }
    ...
    public ASN1ObjectIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        v1d0.m199002a("string ", str, " not a valid OID branch");
        throw null;
    }
}
