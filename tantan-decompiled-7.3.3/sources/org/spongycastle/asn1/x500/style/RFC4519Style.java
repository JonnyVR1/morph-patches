...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f207210c;

    /* JADX INFO: renamed from: cn */
    public static final ASN1ObjectIdentifier f207211cn;

    /* JADX INFO: renamed from: dc */
    public static final ASN1ObjectIdentifier f207212dc;
    ...
    public static final ASN1ObjectIdentifier f207213l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* JADX INFO: renamed from: o */
    public static final ASN1ObjectIdentifier f207214o;

    /* JADX INFO: renamed from: ou */
    public static final ASN1ObjectIdentifier f207215ou;
    ...
    public static final ASN1ObjectIdentifier f207216sn;

    /* JADX INFO: renamed from: st */
    public static final ASN1ObjectIdentifier f207217st;
    ...
    static {
        ...
        f207213l = aSN1ObjectIdentifierIntern16;
        ...
        hashtable.put(aSN1ObjectIdentifierIntern16, BLiveStormDanmakuGiftResourceType.f45292l);
        hashtable.put(aSN1ObjectIdentifierIntern17, "member");
        hashtable.put(aSN1ObjectIdentifierIntern18, AuthenticationTokenClaims.JSON_KEY_NAME);
        hashtable.put(aSN1ObjectIdentifierIntern19, "o");
        hashtable.put(aSN1ObjectIdentifierIntern20, "ou");
        hashtable.put(aSN1ObjectIdentifierIntern21, Owner.TYPE);
        hashtable.put(aSN1ObjectIdentifierIntern22, "physicalDeliveryOfficeName");
        hashtable.put(aSN1ObjectIdentifierIntern23, "postalAddress");
        hashtable.put(aSN1ObjectIdentifierIntern24, "postalCode");
        ...
        hashtable.put(aSN1ObjectIdentifierIntern39, Oauth2AccessToken.KEY_UID);
        ...
        hashtable2.put(BLiveStormDanmakuGiftResourceType.f45292l, aSN1ObjectIdentifierIntern16);
        hashtable2.put("member", aSN1ObjectIdentifierIntern17);
        hashtable2.put(AuthenticationTokenClaims.JSON_KEY_NAME, aSN1ObjectIdentifierIntern18);
        hashtable2.put("o", aSN1ObjectIdentifierIntern19);
        hashtable2.put("ou", aSN1ObjectIdentifierIntern20);
        hashtable2.put(Owner.TYPE, aSN1ObjectIdentifierIntern21);
        ...
        hashtable2.put(Oauth2AccessToken.KEY_UID, aSN1ObjectIdentifierIntern39);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        if (aSN1ObjectIdentifier.equals(f207212dc)) {
            return new DERIA5String(str);
        }
        return (aSN1ObjectIdentifier.equals(f207210c) || aSN1ObjectIdentifier.equals(serialNumber) || aSN1ObjectIdentifier.equals(dnQualifier) || aSN1ObjectIdentifier.equals(telephoneNumber)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }

    @Override // org.spongycastle.asn1.x500.X500NameStyle
    public RDN[] fromString(String str) {
        RDN[] rdnArrRDNsFromString = IETFUtils.rDNsFromString(str, this);
        int length = rdnArrRDNsFromString.length;
        RDN[] rdnArr = new RDN[length];
        for (int i = 0; i != rdnArrRDNsFromString.length; i++) {
            rdnArr[(length - i) - 1] = rdnArrRDNsFromString[i];
        }
        return rdnArr;
    }
