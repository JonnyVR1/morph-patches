...
public class BCStyle extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f207200C;

    /* JADX INFO: renamed from: CN */
    public static final ASN1ObjectIdentifier f207201CN;
    public static final ASN1ObjectIdentifier COUNTRY_OF_CITIZENSHIP;
    public static final ASN1ObjectIdentifier COUNTRY_OF_RESIDENCE;
    public static final ASN1ObjectIdentifier DATE_OF_BIRTH;

    /* JADX INFO: renamed from: DC */
    public static final ASN1ObjectIdentifier f207202DC;
    ...
    public static final ASN1ObjectIdentifier f207203E;
    ...
    public static final ASN1ObjectIdentifier f207204L;
    public static final ASN1ObjectIdentifier NAME;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH;

    /* JADX INFO: renamed from: O */
    public static final ASN1ObjectIdentifier f207205O;

    /* JADX INFO: renamed from: OU */
    public static final ASN1ObjectIdentifier f207206OU;
    ...
    public static final ASN1ObjectIdentifier f207207SN;

    /* JADX INFO: renamed from: ST */
    public static final ASN1ObjectIdentifier f207208ST;
    public static final ASN1ObjectIdentifier STREET;
    public static final ASN1ObjectIdentifier SURNAME;

    /* JADX INFO: renamed from: T */
    public static final ASN1ObjectIdentifier f207209T;
    ...
    static {
        ...
        hashtable.put(aSN1ObjectIdentifierIntern, c4s.C_ZONE);
        hashtable.put(aSN1ObjectIdentifierIntern2, BloodType.f39576O);
        hashtable.put(aSN1ObjectIdentifierIntern4, p7f.GPS_DIRECTION_TRUE);
        ...
        hashtable2.put(Constants.KEY_T, aSN1ObjectIdentifierIntern4);
        hashtable2.put("ou", aSN1ObjectIdentifierIntern3);
        hashtable2.put("cn", aSN1ObjectIdentifierIntern5);
        hashtable2.put(BLiveStormDanmakuGiftResourceType.f45292l, aSN1ObjectIdentifierIntern8);
        ...
        hashtable2.put(Oauth2AccessToken.KEY_UID, aSN1ObjectIdentifier7);
        ...
        hashtable2.put(AuthenticationTokenClaims.JSON_KEY_NAME, aSN1ObjectIdentifier2);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        if (aSN1ObjectIdentifier.equals(EmailAddress) || aSN1ObjectIdentifier.equals(f207202DC)) {
            return new DERIA5String(str);
        }
        if (aSN1ObjectIdentifier.equals(DATE_OF_BIRTH)) {
            return new ASN1GeneralizedTime(str);
        }
        return (aSN1ObjectIdentifier.equals(f207200C) || aSN1ObjectIdentifier.equals(f207207SN) || aSN1ObjectIdentifier.equals(DN_QUALIFIER) || aSN1ObjectIdentifier.equals(TELEPHONE_NUMBER)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
