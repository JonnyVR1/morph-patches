...
public class AuthEnvelopedData extends ASN1Object {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Integer.getValue().intValue() != 0) {
            wg3.m206174a("AuthEnvelopedData version number must be 0");
            throw null;
        }
        ...
        if (aSN1Set2.size() == 0) {
            wg3.m206174a("AuthEnvelopedData requires at least 1 RecipientInfo");
            throw null;
        }
        ...
        if (aSN1Primitive2 instanceof ASN1TaggedObject) {
            ...
            wg3.m206174a("authAttrs must be present with non-data content");
            throw null;
        }
    ...
    public static AuthEnvelopedData getInstance(Object obj) {
        ...
        wg3.m206174a("Invalid AuthEnvelopedData: ".concat(obj.getClass().getName()));
        return null;
    }
