...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String {
    ...
    public ASN1BitString(byte[] bArr, int i) {
        if (bArr == null) {
            mnd0.m159157a("data cannot be null");
            throw null;
        }
        if (bArr.length == 0 && i != 0) {
            wg3.m206174a("zero length data with non-zero pad bits");
            throw null;
        }
        if (i > 7 || i < 0) {
            wg3.m206174a("pad bits cannot be greater than 7 or less than 0");
            throw null;
        }
    ...
    public static ASN1BitString fromInputStream(int i, InputStream inputStream) throws IOException {
        if (i < 1) {
            wg3.m206174a("truncated BIT STRING detected");
            return null;
        }
    ...
    public byte[] getOctets() {
        ...
        wtq0.m207906a("attempt to get non-octet aligned data from BIT STRING");
        return null;
    }
    ...
    public String getString() {
        ...
        try {
            ...
            C20716v1.m198963a("Internal error encoding BitString: ", e.getMessage(), e);
            return null;
        }
    }
