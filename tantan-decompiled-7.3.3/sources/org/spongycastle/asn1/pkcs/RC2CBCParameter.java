...
public class RC2CBCParameter extends ASN1Object {
    ...
    ASN1OctetString f207190iv;
    ASN1Integer version;

    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.version = null;
            this.f207190iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        } else {
            this.version = (ASN1Integer) aSN1Sequence.getObjectAt(0);
            this.f207190iv = (ASN1OctetString) aSN1Sequence.getObjectAt(1);
        }
    }
    ...
    public byte[] getIV() {
        return this.f207190iv.getOctets();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f207190iv);
        return new DERSequence(aSN1EncodableVector);
    }

    public RC2CBCParameter(int i, byte[] bArr) {
        this.version = new ASN1Integer(i);
        this.f207190iv = new DEROctetString(bArr);
    }
