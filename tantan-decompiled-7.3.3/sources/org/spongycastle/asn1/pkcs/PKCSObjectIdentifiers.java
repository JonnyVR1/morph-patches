...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        srsaOAEPEncryptionSET = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_INFO);
        id_RSAES_OAEP = aSN1ObjectIdentifier.branch("7");
        id_mgf1 = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        id_pSpecified = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        id_RSASSA_PSS = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        sha256WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        sha384WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        sha512WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        sha224WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        ...
        pbeWithMD5AndRC2_CBC = aSN1ObjectIdentifier3.branch(Constants.VIA_SHARE_TYPE_INFO);
        pbeWithSHA1AndDES_CBC = aSN1ObjectIdentifier3.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        pbeWithSHA1AndRC2_CBC = aSN1ObjectIdentifier3.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        id_PBES2 = aSN1ObjectIdentifier3.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        id_PBKDF2 = aSN1ObjectIdentifier3.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        ...
        id_hmacWithSHA224 = aSN1ObjectIdentifier5.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO).intern();
        id_hmacWithSHA256 = aSN1ObjectIdentifier5.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM).intern();
        id_hmacWithSHA384 = aSN1ObjectIdentifier5.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ).intern();
        id_hmacWithSHA512 = aSN1ObjectIdentifier5.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE).intern();
        ...
        pkcs_9_at_counterSignature = aSN1ObjectIdentifier6.branch(Constants.VIA_SHARE_TYPE_INFO).intern();
        pkcs_9_at_challengePassword = aSN1ObjectIdentifier6.branch("7").intern();
        pkcs_9_at_unstructuredAddress = aSN1ObjectIdentifier6.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO).intern();
        pkcs_9_at_extendedCertificateAttributes = aSN1ObjectIdentifier6.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM).intern();
        pkcs_9_at_signingDescription = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP).intern();
        pkcs_9_at_extensionRequest = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND).intern();
        pkcs_9_at_smimeCapabilities = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_WPA_STATE).intern();
        ASN1ObjectIdentifier aSN1ObjectIdentifierIntern = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_START_WAP).intern();
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        ...
        id_ct_compressedData = aSN1ObjectIdentifier7.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        id_ct_authEnvelopedData = aSN1ObjectIdentifier7.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        ...
        id_rsa_KEM = aSN1ObjectIdentifierBranch3.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        ...
        id_cti_ets_proofOfCreation = aSN1ObjectIdentifier8.branch(Constants.VIA_SHARE_TYPE_INFO);
        ...
        id_aa_contentReference = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        id_aa_encrypKeyPref = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        id_aa_signingCertificate = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        id_aa_signingCertificateV2 = aSN1ObjectIdentifier9.branch("47");
        id_aa_contentIdentifier = aSN1ObjectIdentifier9.branch("7");
        id_aa_signatureTimeStampToken = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch4 = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        id_aa_ets_sigPolicyId = aSN1ObjectIdentifierBranch4;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_START_WAP);
        id_aa_ets_commitmentType = aSN1ObjectIdentifierBranch5;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch6 = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        id_aa_ets_signerLocation = aSN1ObjectIdentifierBranch6;
        id_aa_ets_signerAttr = aSN1ObjectIdentifier9.branch("18");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch7 = aSN1ObjectIdentifier9.branch(Constants.VIA_ACT_TYPE_NINETEEN);
        ...
        id_aa_ets_revocationRefs = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        id_aa_ets_certValues = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        id_aa_ets_revocationValues = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_CHAT_AIO);
        id_aa_ets_escTimeStamp = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_CHAT_AUDIO);
        id_aa_ets_certCRLTimestamp = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_CHAT_VIDEO);
        ...
        safeContentsBag = aSN1ObjectIdentifierBranch8.branch(Constants.VIA_SHARE_TYPE_INFO);
        ...
        pbeWithSHAAnd40BitRC2_CBC = aSN1ObjectIdentifierBranch9.branch(Constants.VIA_SHARE_TYPE_INFO);
        pbewithSHAAnd40BitRC2_CBC = aSN1ObjectIdentifierBranch9.branch(Constants.VIA_SHARE_TYPE_INFO);
