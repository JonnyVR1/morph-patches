...
public class PKCS12PBEParams extends ASN1Object {
    ...
    ASN1OctetString f207189iv;

    private PKCS12PBEParams(ASN1Sequence aSN1Sequence) {
        this.f207189iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return this.f207189iv.getOctets();
    }
