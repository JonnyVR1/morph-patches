...
public class DERExternal extends ASN1Primitive {
    ...
    public DERExternal(ASN1EncodableVector aSN1EncodableVector) {
        ...
        if (aSN1EncodableVector.size() != i + 1) {
            wg3.m206174a("input vector too large");
            throw null;
        }
        if (!(objFromVector instanceof ASN1TaggedObject)) {
            wg3.m206174a("No tagged object found in vector. Structure doesn't seem to be of type External");
            throw null;
        }
    ...
    private ASN1Primitive getObjFromVector(ASN1EncodableVector aSN1EncodableVector, int i) {
        ...
        wg3.m206174a("too few objects in input vector");
        return null;
    }
    ...
    private void setEncoding(int i) {
        if (i < 0 || i > 2) {
            za50.m219101a("invalid encoding value: ", i);
        } else {
            this.encoding = i;
        }
    }
    ...
    public int hashCode() {
        ...
        return this.externalContent.hashCode() ^ iHashCode;
    }
