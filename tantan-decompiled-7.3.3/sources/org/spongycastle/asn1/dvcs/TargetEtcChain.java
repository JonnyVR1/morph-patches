...
public class TargetEtcChain extends ASN1Object {
    ...
    public String toString() {
        ...
        stringBuffer.append("target: " + this.target + SignParameters.NEW_LINE);
        if (this.chain != null) {
            stringBuffer.append("chain: " + this.chain + SignParameters.NEW_LINE);
        }
        if (this.pathProcInput != null) {
            stringBuffer.append("pathProcInput: " + this.pathProcInput + SignParameters.NEW_LINE);
        }
        stringBuffer.append("}\n");
