...
public interface OCSPObjectIdentifiers {
    ...
    static {
        ...
        id_pkix_ocsp_pref_sig_algs = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        id_pkix_ocsp_extended_revoke = aSN1ObjectIdentifier.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
    }
}
