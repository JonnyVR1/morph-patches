...
public class RSAPublicKey extends PublicKeyDataObject {
    ...
    public RSAPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 1) {
                ...
                if (tagNo != 2) {
                    vic0.m201333a("Unknown DERTaggedObject :", unsignedInteger.getTagNo(), "-> not an Iso7816RSAPublicKeyStructure");
                    throw null;
                }
        ...
        wg3.m206174a("missing argument -> not an Iso7816RSAPublicKeyStructure");
        throw null;
    }
    ...
    private void setExponent(UnsignedInteger unsignedInteger) {
        ...
        if ((i & i2) != 0) {
            wg3.m206174a("Exponent already set");
        } else {
            this.valid = i | i2;
    ...
    private void setModulus(UnsignedInteger unsignedInteger) {
        ...
        int i2 = modulusValid;
        if ((i & i2) != 0) {
            wg3.m206174a("Modulus already set");
        } else {
            this.valid = i | i2;
