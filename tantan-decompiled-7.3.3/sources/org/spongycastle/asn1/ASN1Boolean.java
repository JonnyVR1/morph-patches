...
public class ASN1Boolean extends ASN1Primitive {
    ...
    public ASN1Boolean(byte[] bArr) {
        if (bArr.length != 1) {
            wg3.m206174a("byte value should have 1 byte in it");
            throw null;
        }
        byte b = bArr[0];
        if (b == 0) {
    ...
    public static ASN1Boolean fromOctetString(byte[] bArr) {
        if (bArr.length != 1) {
            wg3.m206174a("BOOLEAN value should have 1 byte in it");
            return null;
        }
        byte b = bArr[0];
        if (b == 0) {
    ...
    public static ASN1Boolean getInstance(Object obj) {
        ...
        try {
            ...
            yg3.m215829a("failed to construct boolean from byte[]: ", e.getMessage());
            return null;
        }
    }
