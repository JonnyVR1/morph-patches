...
public class Base64Coder {
    ...
    public static byte[] decode(String str, int i) throws Throwable {
        ...
        if (str == null) {
            mnd0.m159157a("Input string was null.");
            return null;
        }
        try {
    ...
    public static int decode4to3(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        int i5;
        if (bArr == null) {
            mnd0.m159157a("Source array was null.");
            return 0;
        }
        if (bArr2 == null) {
            mnd0.m159157a("Destination array was null.");
            return 0;
        }
        if (i < 0 || (i4 = i + 3) >= bArr.length) {
            gzi0.m133102a("Source array with length %d cannot have offset of %d and still process four bytes.", new Object[]{Integer.valueOf(bArr.length), Integer.valueOf(i)});
            return 0;
        }
        if (i2 < 0 || (i5 = i2 + 2) >= bArr2.length) {
            gzi0.m133102a("Destination array with length %d cannot have offset of %d and still store three bytes.", new Object[]{Integer.valueOf(bArr2.length), Integer.valueOf(i2)});
            return 0;
        }
    ...
    public static byte[] encodeBytesToBytes(byte[] bArr, int i, int i2, int i3) throws Throwable {
        ...
        if (bArr2 == null) {
            mnd0.m159157a("Cannot serialize a null array.");
            return null;
        }
        if (i < 0) {
            za50.m219101a("Cannot have negative offset: ", i);
            return null;
        }
        if (i2 < 0) {
            za50.m219101a("Cannot have length offset: ", i2);
            return null;
        }
        if (i + i2 > bArr2.length) {
            gzi0.m133102a("Cannot have offset of %d and length of %d with array of length %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(bArr2.length)});
            return null;
        }
        if ((i3 & 2) == 0) {
    ...
    public static String encodeObject(Serializable serializable, int i) throws Throwable {
        ...
        if (serializable == null) {
            mnd0.m159157a("Cannot serialize a null object.");
            return null;
        }
        try {
            byteArrayOutputStream = new ByteArrayOutputStream();
    ...
    public static void encodeToFile(byte[] bArr, String str) throws Throwable {
        if (bArr == null) {
            mnd0.m159157a("Data to encode was null.");
            return;
        }
        OutputStream outputStream = null;
        try {
    ...
    public static class InputStream extends FilterInputStream {
        ...
        public int read() throws IOException {
            ...
            if (this.position < 0) {
                if (this.encode) {
                    ...
                    if (i5 != 4) {
                        ...
                        zpg0.m220844a("Improperly padded Base64 input.");
                        return 0;
                    }
            ...
            if (i6 < 0) {
                zpg0.m220844a("Error in Base64 code reading stream.");
                return 0;
            }
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void flushBase64() throws IOException {
            ...
            if (i > 0) {
                if (!this.encode) {
                    zpg0.m220844a("Base64 input not properly padded.");
                } else {
                    ((FilterOutputStream) this).out.write(Base64Coder.encode3to4(this.f207130b4, this.buffer, i, this.options));
                    this.position = 0;
                }
            }
        }
        ...
        public void write(int i) throws IOException {
            ...
            if (this.encode) {
                ...
                if (i3 >= i4) {
                    ((FilterOutputStream) this).out.write(Base64Coder.encode3to4(this.f207130b4, bArr, i4, this.options));
            ...
            if (b <= -5) {
                ...
                zpg0.m220844a("Invalid character in Base64 data.");
                return;
            }
            ...
            bArr2[i6] = (byte) i;
            if (i7 >= this.bufferLength) {
                ((FilterOutputStream) this).out.write(this.f207130b4, 0, Base64Coder.decode4to3(bArr2, 0, this.f207130b4, 0, this.options));
                this.position = 0;
            }
        }
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) throws IOException {
        ...
        if (bArr != null) {
            if (i < 0 || (i4 = i + i2) > bArr.length) {
                gzi0.m133102a("Source array with length %d cannot have offset of %d and process %d bytes.", new Object[]{Integer.valueOf(bArr.length), Integer.valueOf(i), Integer.valueOf(i2)});
                return null;
            }
            if (i2 == 0) {
                return new byte[0];
            ...
            za50.m219101a("Base64-encoded string must have at least four characters, but length specified was ", i2);
            return null;
        }
        mnd0.m159157a("Cannot decode null source array.");
        return null;
    }
