...
public class C22266IO {
    ...
    public static void writeBytes(File file, byte[] bArr) throws IOException {
        if (file == null) {
            wg3.m206174a("File should not be null.");
            return;
        }
        if (!file.exists()) {
        ...
        if (!file.isFile()) {
            ypg0.m217021a("Should not be a directory: ", file);
            return;
        }
        if (!file.canWrite()) {
            ypg0.m217021a("File cannot be written: ", file);
            return;
        }
    ...
    public static String readLines(InputStream inputStream) throws IOException {
        ...
        wg3.m206174a("Inputstream was null");
        return null;
    }
}
