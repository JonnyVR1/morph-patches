...
public class Reflections {
    ...
    public static Class getCollectionElementType(Type type) {
        if (!(type instanceof ParameterizedType)) {
            wg3.m206174a("collection type not parameterized");
            return null;
        }
        Type[] actualTypeArguments = ((ParameterizedType) type).getActualTypeArguments();
        if (actualTypeArguments.length == 0) {
            wg3.m206174a("no type arguments for collection type");
            return null;
        }
        ...
        wg3.m206174a("type argument not a class");
        return null;
    }
    ...
    public static Object invokeAndWrap(Method method, Object obj, Object... objArr) {
        try {
            ...
            evc0.m122777a("exception invoking: ", method.getName(), e);
            return null;
        }
    }
    ...
    public static boolean isInstanceOf(Class cls, String str) {
        if (str == null) {
            wg3.m206174a("name cannot be null");
            return false;
        }
