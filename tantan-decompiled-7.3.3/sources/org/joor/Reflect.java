...
public class Reflect {
    ...
    public static rcj<Object, Object[], Reflect> callRepeatably(String str, String str2, Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        Reflect reflectM222383on = m222383on(str);
        try {
            try {
                final Method methodExactMethod = reflectM222383on.exactMethod(str2, clsArrTypes);
                accessible(methodExactMethod);
                return new rcj() { // from class: l.luc0
                    @Override // p153l.rcj
                    public final Object call(Object obj, Object obj2) {
                        return Reflect.m222386on(false, methodExactMethod, obj, (Object[]) obj2);
                    }
                };
            ...
            final Method methodSimilarMethod = reflectM222383on.similarMethod(str2, clsArrTypes);
            accessible(methodSimilarMethod);
            return new rcj() { // from class: l.muc0
                @Override // p153l.rcj
                public final Object call(Object obj, Object obj2) {
                    return Reflect.m222386on(false, methodSimilarMethod, obj, (Object[]) obj2);
                }
            };
        }
    }
    ...
    public static Reflect m222386on(boolean z, Method method, Object obj, Object... objArr) throws ReflectException {
        if (z) {
            try {
                accessible(method);
            } catch (Exception e) {
        ...
        if (method.getReturnType() != Void.TYPE) {
            return m222382on(method.invoke(obj, objArr));
        }
        method.invoke(obj, objArr);
        return m222382on(obj);
    }
    ...
    public <P> P m222387as(Class<P> cls) {
        ...
        return (P) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: org.joor.Reflect.1
            ...
            public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
                ...
                try {
                    return Reflect.m222382on(Reflect.this.object).call(name, objArr).get();
    ...
    public Reflect call(String str, Object... objArr) throws ReflectException {
        ...
        try {
            try {
                return m222385on(exactMethod(str, clsArrTypes), this.object, objArr);
            } catch (NoSuchMethodException e) {
                throw new ReflectException(e);
            }
        } catch (NoSuchMethodException unused) {
            return m222385on(similarMethod(str, clsArrTypes), this.object, objArr);
        }
    }
    ...
    public Reflect create(Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        try {
            return m222384on(type().getDeclaredConstructor(clsArrTypes), objArr);
        } catch (NoSuchMethodException e) {
            for (Constructor<?> constructor : type().getDeclaredConstructors()) {
                if (match(constructor.getParameterTypes(), clsArrTypes)) {
                    return m222384on(constructor, objArr);
                }
            }
            throw new ReflectException(e);
        }
    ...
    public Reflect field(String str) throws ReflectException {
        try {
            return m222382on(field0(str).get(this.object));
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    }
    ...
    /* JADX INFO: renamed from: on */
    public static Reflect m222381on(Class<?> cls) {
        return new Reflect(cls);
    }

    /* JADX INFO: renamed from: on */
    public static Reflect m222382on(Object obj) {
        return new Reflect(obj);
    }

    /* JADX INFO: renamed from: on */
    private static Reflect m222384on(Constructor<?> constructor, Object... objArr) throws ReflectException {
        try {
            return m222382on(((Constructor) accessible(constructor)).newInstance(objArr));
        } catch (Exception e) {
            throw new ReflectException(e);
        }
    }

    public static rcj<Object, Object[], Reflect> callRepeatably(Class cls, String str, Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        Reflect reflectM222381on = m222381on((Class<?>) cls);
        try {
            try {
                final Method methodExactMethod = reflectM222381on.exactMethod(str, clsArrTypes);
                accessible(methodExactMethod);
                return new rcj() { // from class: l.nuc0
                    @Override // p153l.rcj
                    public final Object call(Object obj, Object obj2) {
                        return Reflect.m222386on(false, methodExactMethod, obj, (Object[]) obj2);
                    }
            ...
            final Method methodSimilarMethod = reflectM222381on.similarMethod(str, clsArrTypes);
            accessible(methodSimilarMethod);
            return new rcj() { // from class: l.ouc0
                @Override // p153l.rcj
                public final Object call(Object obj, Object obj2) {
                    return Reflect.m222386on(false, methodSimilarMethod, obj, (Object[]) obj2);
                }
    ...
    /* JADX INFO: renamed from: on */
    private static Reflect m222385on(Method method, Object obj, Object... objArr) throws ReflectException {
        return m222386on(true, method, obj, objArr);
    }

    /* JADX INFO: renamed from: on */
    public static Reflect m222383on(String str) throws ReflectException {
        return m222381on(forName(str));
    }

    public static rcj<Object, Object[], Reflect> callRepeatably(Object obj, String str, Object... objArr) throws ReflectException {
        Class<?>[] clsArrTypes = types(objArr);
        Reflect reflectM222382on = m222382on(obj);
        try {
            try {
                final Method methodExactMethod = reflectM222382on.exactMethod(str, clsArrTypes);
                accessible(methodExactMethod);
                return new rcj() { // from class: l.juc0
                    @Override // p153l.rcj
                    public final Object call(Object obj2, Object obj3) {
                        return Reflect.m222386on(false, methodExactMethod, obj2, (Object[]) obj3);
                    }
                };
            } catch (NoSuchMethodException e) {
                throw new ReflectException(e);
            ...
            final Method methodSimilarMethod = reflectM222382on.similarMethod(str, clsArrTypes);
            accessible(methodSimilarMethod);
            return new rcj() { // from class: l.kuc0
                @Override // p153l.rcj
                public final Object call(Object obj2, Object obj3) {
                    return Reflect.m222386on(false, methodSimilarMethod, obj2, (Object[]) obj3);
                }
            };
        }
    }
