...
public abstract class Suddo extends gjg0 {
    ...
    protected final drg0 f206804in;
    ...
    public Suddo(InputStream inputStream) {
        ...
        this.codeSize = 9;
        this.previousCode = -1;
        this.f206804in = new drg0(inputStream, byteOrder);
    }
    ...
    public int addRepeatOfPreviousCode() throws IOException {
        ...
        zpg0.m220844a("The first code can't be a reference to its preceding code");
        return 0;
    }

    @Override // java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
    public void close() throws IOException {
        this.f206804in.close();
    }
    ...
    public long getCompressedCount() {
        return this.f206804in.getBytesRead();
    }
    ...
    public void initializeTables(int i) {
        if (i <= 0) {
            i2r0.m138234a("maxCodeSize is ", i, ", must be bigger than 0");
            return;
        }
        int i2 = 1 << i;
    ...
    public int readNextCode() {
        int i = this.codeSize;
        if (i <= 31) {
            return (int) this.f206804in.readBits(i);
        }
        wg3.m206174a("Code size must not be bigger than 31");
        return 0;
    }
