...
public class ZipArchiveEntry extends ZipEntry implements ArchiveEntry {
    ...
    public static class ExtraFieldParsingMode implements ExtraFieldParsingBehavior {
        ...
        public final enum C219851 extends ExtraFieldParsingMode {
            private C219851(String str, int i, ExtraFieldUtils.UnparseableExtraField unparseableExtraField) {
        ...
        public final enum C219862 extends ExtraFieldParsingMode {
            private C219862(String str, int i, ExtraFieldUtils.UnparseableExtraField unparseableExtraField) {
                super(str, i, unparseableExtraField);
            }
        ...
        static {
            ...
            BEST_EFFORT = new C219851("BEST_EFFORT", 0, unparseableExtraField);
            ...
            ONLY_PARSEABLE_LENIENT = new C219862("ONLY_PARSEABLE_LENIENT", 2, unparseableExtraField2);
    ...
    public void setAlignment(int i) {
        if (((i - 1) & i) != 0 || i > 65535) {
            wg3.m206174a(dmg0.m116959a(i, "Invalid value for alignment, must be power of two and no bigger than 65535 but is "));
        } else {
            this.alignment = i;
        }
    }
    ...
    public void setMethod(int i) {
        if (i >= 0) {
            ...
            wg3.m206174a(dmg0.m116959a(i, "ZIP compression method can not be negative: "));
        }
    }
    ...
    public void setSize(long j) {
        if (j >= 0) {
            ...
            wg3.m206174a("Invalid entry size");
        }
    }
