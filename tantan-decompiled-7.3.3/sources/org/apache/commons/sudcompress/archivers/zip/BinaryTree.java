...
class BinaryTree {
    ...
    public BinaryTree(int i) {
        if (i < 0 || i > 30) {
            wg3.m206174a(dmg0.m116959a(i, "depth must be bigger than 0 and not bigger than 30 but is "));
            throw null;
        }
    ...
    public static BinaryTree decode(InputStream inputStream, int i) throws IOException {
        if (i < 0) {
            wg3.m206174a(dmg0.m116959a(i, "totalNumberOfValues must be bigger than 0, is "));
            return null;
        }
        int i2 = inputStream.read() + 1;
        if (i2 == 0) {
            zpg0.m220844a("Cannot read the size of the encoded tree, unexpected end of stream");
            return null;
        }
        byte[] bArr = new byte[i2];
        if (xeg0.m210676a(inputStream, bArr, 0, i2) != i2) {
            vg3.m201207a();
            return null;
        }
        int[] iArr = new int[i];
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            int i5 = ((b & 240) >> 4) + 1;
            if (i3 + i5 > i) {
                zpg0.m220844a("Number of values exceeds given total number of values");
                return null;
            }
            int i6 = (b & 15) + 1;
            int i7 = 0;
    ...
    public void addLeaf(int i, int i2, int i3, int i4) {
        ...
        if (i3 != 0) {
            ...
            cmq.m111312a("Tree value at index ", i, " has already been assigned (", this.tree[i], ")");
        }
    }
