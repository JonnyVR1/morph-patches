...
public class ResourceAlignmentExtraField implements ZipExtraField {
    ...
    public static final ZipShort f206793ID = new ZipShort(41246);
    ...
    public ResourceAlignmentExtraField(int i, boolean z, int i2) {
        this.padding = 0;
        if (i < 0 || i > 32767) {
            wg3.m206174a(dmg0.m116959a(i, "Alignment must be between 0 and 0x7fff, was: "));
            throw null;
        }
        if (i2 < 0) {
            wg3.m206174a(dmg0.m116959a(i2, "Padding must not be negative, was: "));
            throw null;
        }
    ...
    public void parseFromCentralDirectoryData(byte[] bArr, int i, int i2) throws ZipException {
        if (i2 < 2) {
            throw new ZipException(dmg0.m116959a(i2, "Too short content for ResourceAlignmentExtraField (0xa11e): "));
        }
