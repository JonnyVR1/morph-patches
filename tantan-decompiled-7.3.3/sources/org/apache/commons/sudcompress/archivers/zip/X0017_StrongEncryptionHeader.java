...
public class X0017_StrongEncryptionHeader extends PKWareExtraHeader {
    ...
    public void parseFileFormat(byte[] bArr, int i, int i2) throws ZipException {
        ...
        if (value3 == 0) {
            ...
            if (value4 < 4) {
                p11.m170187a("Invalid X0017_StrongEncryptionHeader: vSize ", value4, " is too small to hold CRC");
                return;
            }
            int i7 = i4 + 22 + value2;
        ...
        if (value6 < 4) {
            p11.m170187a("Invalid X0017_StrongEncryptionHeader: vSize ", value6, " is too small to hold CRC");
            return;
        }
