...
public class Rule {
    ...
    private static Scanner createScanner(String str) {
        ...
        wg3.m206174a("Unable to load resource: ".concat(str2));
        return null;
    }
    ...
    public static List<Rule> getInstance(NameType nameType, RuleType ruleType, String str) {
        ...
        gzi0.m133102a("No rules found for %s, %s, %s.", new Object[]{nameType.getName(), ruleType.getName(), str});
        return null;
    }
    ...
    private static Phoneme parsePhoneme(String str) {
        ...
        wg3.m206174a("Phoneme expression contains a '[' but does not end in ']'");
        return null;
    }
    ...
    private static PhonemeExpr parsePhonemeExpr(String str) {
        ...
        if (!str.endsWith(")")) {
            wg3.m206174a("Phoneme starts with '(' so must end with ')'");
            return null;
        }
    ...
    public boolean patternAndContextMatches(CharSequence charSequence, int i) {
        if (i < 0) {
            kym.m151996a("Can not match pattern at negative indexes");
            return false;
        }
    ...
    private static Scanner createScanner(NameType nameType, RuleType ruleType, String str) {
        ...
        ypg0.m217021a("Unable to load resource: ", strCreateResourceName);
        return null;
    }
