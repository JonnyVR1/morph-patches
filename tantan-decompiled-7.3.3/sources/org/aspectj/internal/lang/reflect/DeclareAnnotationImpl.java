...
public class DeclareAnnotationImpl implements DeclareAnnotation {
    ...
    public static /* synthetic */ class C219931 {
    ...
    public DeclareAnnotationImpl(AjType<?> ajType, String str, String str2, Annotation annotation, String str3) {
        ...
        if (str.equals("at_type")) {
            ...
            if (!str.equals("at_constructor")) {
                wtq0.m207906a("Unknown declare annotation kind: ".concat(str));
                throw null;
            }
    ...
    public String toString() {
        ...
        int i = C219931.$SwitchMap$org$aspectj$lang$reflect$DeclareAnnotation$Kind[getKind().ordinal()];
        if (i == 1) {
