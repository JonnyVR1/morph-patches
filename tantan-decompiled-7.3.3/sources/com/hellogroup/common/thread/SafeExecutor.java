...
public final class SafeExecutor implements ScheduledExecutorService, AutoCloseable {
    ...
    private static final Lazy f11870b = LazyKt__LazyJVMKt.m88118b(new Function0<Field>() { // from class: com.hellogroup.common.thread.SafeExecutor$Companion$callableField$2
    ...
    private static final Lazy f11871c = LazyKt__LazyJVMKt.m88118b(new Function0<Class<Callable<Object>>>() { // from class: com.hellogroup.common.thread.SafeExecutor$Companion$runnableAdapterClass$2

        /* JADX INFO: renamed from: com.hellogroup.common.thread.SafeExecutor$Companion$runnableAdapterClass$2$a */
        @Metadata(m88119bv = {1, 0, 3}, m88120d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, m88121d2 = {"<anonymous>", "", "run"}, m88122k = 3, m88123mv = {1, 1, 16})
        public static final class RunnableC3481a implements Runnable {
            public static final RunnableC3481a INSTANCE = new RunnableC3481a();
        ...
        public final Class<Callable<Object>> invoke() {
            return java.util.concurrent.Executors.callable(RunnableC3481a.INSTANCE).getClass();
        }
    });

    /* JADX INFO: renamed from: d */
    private static final Lazy f11872d = LazyKt__LazyJVMKt.m88118b(new Function0<Field>() { // from class: com.hellogroup.common.thread.SafeExecutor$Companion$taskField$2
        @Override // kotlin.jvm.functions.Function0
        @Nullable
        public final Field invoke() {
            try {
                Field declaredField = SafeExecutor.INSTANCE.m17560d().getDeclaredField("task");
                declaredField.getClass();
                declaredField.setAccessible(true);
                return declaredField;
            } catch (Exception unused) {
    ...
    /* JADX INFO: renamed from: com.hellogroup.common.thread.SafeExecutor$b */
    @Metadata(m88120d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0004\b\u0003\u0010\u0004J\u0010\u0010\u0006\u001a\u00020\u0005H\u0096\u0001¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m88121d2 = {"Lcom/hellogroup/common/thread/SafeExecutor$b;", "Ljava/lang/Runnable;", "delegate", "<init>", "(Ljava/lang/Runnable;)V", "", "run", "()V", "HelloFoundation_release"}, m88122k = 1, m88123mv = {1, 4, 0})
    public static final class RunnableC3483b implements Runnable {

        /* JADX INFO: renamed from: a */
        private final /* synthetic */ Runnable f11874a;

        public RunnableC3483b(@NotNull Runnable runnable) {
            runnable.getClass();
    ...
    public void execute(@Nullable Runnable command) {
        ...
        if (command == null) {
            ...
            scheduledExecutorService.execute(new RunnableC3483b(command));
        }
    }
    ...
    /* JADX INFO: renamed from: com.hellogroup.common.thread.SafeExecutor$a, reason: from kotlin metadata */
    @Metadata(m88120d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\b\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\bR\u001d\u0010\u000e\u001a\u0004\u0018\u00010\t8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\u001f\u0010\u0013\u001a\u0006\u0012\u0002\b\u00030\u000f8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0010\u0010\u000b\u001a\u0004\b\u0011\u0010\u0012R\u001d\u0010\u0016\u001a\u0004\u0018\u00010\t8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0014\u0010\u000b\u001a\u0004\b\u0015\u0010\r¨\u0006\u0017"}, m88121d2 = {"Lcom/hellogroup/common/thread/SafeExecutor$a;", "", "<init>", "()V", "Ljava/lang/Runnable;", "runnable", "", "b", "(Ljava/lang/Runnable;)Z", "Ljava/lang/reflect/Field;", "callableField$delegate", "Lkotlin/Lazy;", "c", "()Ljava/lang/reflect/Field;", "callableField", "Ljava/lang/Class;", "runnableAdapterClass$delegate", Constants.INAPP_DATA_TAG, "()Ljava/lang/Class;", "runnableAdapterClass", "taskField$delegate", "e", "taskField", "HelloFoundation_release"}, m88122k = 1, m88123mv = {1, 4, 0})
    public static final class Companion {
        private Companion() {
        }

        /* JADX INFO: renamed from: c */
        private final Field m17559c() {
            return (Field) SafeExecutor.f11870b.getValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX INFO: renamed from: d */
        public final Class<?> m17560d() {
            return (Class) SafeExecutor.f11871c.getValue();
        }

        /* JADX INFO: renamed from: e */
        private final Field m17561e() {
            return (Field) SafeExecutor.f11872d.getValue();
        }

        /* JADX INFO: renamed from: b */
        public final boolean m17562b(@NotNull Runnable runnable) {
            Object obj;
            Field fieldM17561e;
            Object obj2;
            runnable.getClass();
            ...
            try {
                Field fieldM17559c = m17559c();
                if (fieldM17559c != null && (obj = fieldM17559c.get(runnable)) != null && m17560d().isInstance(obj) && (fieldM17561e = m17561e()) != null && (obj2 = fieldM17561e.get(obj)) != null) {
                    return obj2 instanceof RunnableC3483b;
                }
            } catch (Exception unused) {
            }
            return false;
