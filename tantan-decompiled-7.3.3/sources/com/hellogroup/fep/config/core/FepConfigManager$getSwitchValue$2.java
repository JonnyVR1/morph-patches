...
final class FepConfigManager$getSwitchValue$2 extends Lambda implements Function1<bgi, Unit> {
    final /* synthetic */ String $key;
    final /* synthetic */ String $value;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FepConfigManager$getSwitchValue$2(String str, String str2) {
        super(1);
        this.$key = str;
        this.$value = str2;
    }
    ...
    public final void invoke2(@NotNull bgi bgiVar) {
        bgiVar.getClass();
        bgiVar.mo17603a("switch", this.$key, this.$value);
    }
