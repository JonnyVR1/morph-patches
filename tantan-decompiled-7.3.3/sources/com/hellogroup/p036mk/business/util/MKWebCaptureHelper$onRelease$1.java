...
@DebugMetadata(m88262c = "com.hellogroup.mk.business.util.MKWebCaptureHelper$onRelease$1", m88263f = "MKWebCaptureHelper.kt", m88264l = {}, m88265m = "invokeSuspend")
public final class MKWebCaptureHelper$onRelease$1 extends SuspendLambda implements Function2<drb, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        mKWebCaptureHelper$onRelease$1.f12312p$ = (drb) obj;
        return mKWebCaptureHelper$onRelease$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(drb drbVar, Continuation<? super Unit> continuation) {
        return ((MKWebCaptureHelper$onRelease$1) create(drbVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
