...
public class ControlGroup implements Parcelable {
    public static final Parcelable.Creator<ControlGroup> CREATOR = new C4146a();
    public final String group;

    /* JADX INFO: renamed from: id */
    public final int f14937id;
    public final String subsystems;

    /* JADX INFO: renamed from: com.jaredrummler.android.processes.models.ControlGroup$a */
    public static class C4146a implements Parcelable.Creator<ControlGroup> {
    ...
    public ControlGroup(String str) throws IndexOutOfBoundsException, NumberFormatException {
        ...
        this.f14937id = Integer.parseInt(strArrSplit[0]);
    ...
    public String toString() {
        return String.format("%d:%s:%s", Integer.valueOf(this.f14937id), this.subsystems, this.group);
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeInt(this.f14937id);
        parcel.writeString(this.subsystems);
        parcel.writeString(this.group);
    }

    public ControlGroup(Parcel parcel) {
        this.f14937id = parcel.readInt();
