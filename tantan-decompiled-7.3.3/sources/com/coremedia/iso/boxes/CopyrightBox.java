...
public class CopyrightBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_2 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setLanguage", "com.coremedia.iso.boxes.CopyrightBox", "java.lang.String", IjkMediaMeta.IJKM_KEY_LANGUAGE, "", Constants.VOID), 54);
        ajc$tjp_3 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setCopyright", "com.coremedia.iso.boxes.CopyrightBox", "java.lang.String", "copyright", "", Constants.VOID), 58);
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.copyright = y0q.m213891g(byteBuffer);
    }
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(slk0.m186593b(this.copyright));
        byteBuffer.put((byte) 0);
    }

    @Override // com.googlecode.mp4parser.AbstractBox
    public long getContentSize() {
        return slk0.m186594c(this.copyright) + 7;
    }
    ...
    public String toString() {
        ...
        return "CopyrightBox[language=" + getLanguage() + ";copyright=" + getCopyright() + com.clevertap.android.sdk.Constants.AES_SUFFIX;
    }
}
