...
public final class AppleLosslessSpecificBox extends AbstractFullBox {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.maxSamplePerFrame = y0q.m213895k(byteBuffer);
        this.unknown1 = y0q.m213898n(byteBuffer);
        this.sampleSize = y0q.m213898n(byteBuffer);
        this.historyMult = y0q.m213898n(byteBuffer);
        this.initialHistory = y0q.m213898n(byteBuffer);
        this.kModifier = y0q.m213898n(byteBuffer);
        this.channels = y0q.m213898n(byteBuffer);
        this.unknown2 = y0q.m213893i(byteBuffer);
        this.maxCodedFrameSize = y0q.m213895k(byteBuffer);
        this.bitRate = y0q.m213895k(byteBuffer);
        this.sampleRate = y0q.m213895k(byteBuffer);
    }
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        b1q.m101495g(byteBuffer, this.maxSamplePerFrame);
        b1q.m101498j(byteBuffer, this.unknown1);
        b1q.m101498j(byteBuffer, this.sampleSize);
        b1q.m101498j(byteBuffer, this.historyMult);
        b1q.m101498j(byteBuffer, this.initialHistory);
        b1q.m101498j(byteBuffer, this.kModifier);
        b1q.m101498j(byteBuffer, this.channels);
        b1q.m101493e(byteBuffer, this.unknown2);
        b1q.m101495g(byteBuffer, this.maxCodedFrameSize);
        b1q.m101495g(byteBuffer, this.bitRate);
        b1q.m101495g(byteBuffer, this.sampleRate);
    }
