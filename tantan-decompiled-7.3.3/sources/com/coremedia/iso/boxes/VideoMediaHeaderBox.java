...
public class VideoMediaHeaderBox extends AbstractMediaHeaderBox {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.graphicsmode = y0q.m213893i(byteBuffer);
        this.opcolor = new int[3];
        for (int i = 0; i < 3; i++) {
            this.opcolor[i] = y0q.m213893i(byteBuffer);
        }
    }
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        b1q.m101493e(byteBuffer, this.graphicsmode);
        for (int i : this.opcolor) {
            b1q.m101493e(byteBuffer, i);
        }
    }
    ...
    public void setOpcolor(int[] iArr) {
        f3d0.m123722b().m123723c(Factory.makeJP(ajc$tjp_3, this, this, iArr));
        this.opcolor = iArr;
    }
