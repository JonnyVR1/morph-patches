...
public class HttpWrapper {
    ...
    public class C4246a extends b2d0<ze2> {
        public C4246a() {
        }

        @Override // p153l.b2d0
        public void onError(int i, String str, String str2) {
            b7y.m102882c().m102888g("URL_OF_CREATECHANNEL ec:" + i + ",em:" + str + ",body:" + str2);
            super.onError(i, str, str2);
        }

        @Override // p153l.b2d0
        public void onSuccess(int i, ze2 ze2Var, String str) {
            super.onSuccess(i, ze2Var, str);
            b7y.m102882c().m102888g("URL_OF_CREATECHANNEL onSuccess");
        }
    }

    /* JADX INFO: renamed from: com.momo.piplineext.http.HttpWrapper$b */
    public class C4247b extends b2d0<ze2> {
        public C4247b() {
        }

        @Override // p153l.b2d0
        public void onError(int i, String str, String str2) {
            b7y.m102882c().m102888g("URL_OF_UPDATEECHANNEL update ec:" + i + ",em:" + str + ",body:" + str2);
            super.onError(i, str, str2);
        }
        ...
        public void onSuccess(int i, ze2 ze2Var, String str) {
            super.onSuccess(i, ze2Var, str);
            b7y.m102882c().m102888g("URL_OF_UPDATEECHANNEL success");
        }
    }

    /* JADX INFO: renamed from: com.momo.piplineext.http.HttpWrapper$c */
    public class C4248c extends b2d0<ze2> {
        public C4248c() {
        }

        @Override // p153l.b2d0
        public void onError(int i, String str, String str2) {
            b7y.m102882c().m102888g("URL_OF_DESTORYECHANNEL ec:" + i + ",em:" + str + ",body:" + str2);
            super.onError(i, str, str2);
        }

        @Override // p153l.b2d0
        public void onSuccess(int i, ze2 ze2Var, String str) {
            b7y.m102882c().m102888g("URL_OF_DESTORYECHANNEL success");
        }
    }

    /* JADX INFO: renamed from: com.momo.piplineext.http.HttpWrapper$d */
    public static class C4249d {

        /* JADX INFO: renamed from: a */
        private static HttpWrapper f15206a = new HttpWrapper(null);
    }
    ...
    public void createChannel(String str, String str2, int i, String str3, String str4, String str5, MixInfoBean mixInfoBean, String str6, String str7, String str8, int i2) {
        ...
        try {
            ...
            b7y.m102882c().m102888g("createChannel" + jSONObject.toJSONString());
            genCreateList();
            post(URL_OF_CREATECHANNEL, str6, str, str2, str3, str4, concurrentHashMap, new C4246a());
    ...
    public void destoryChannel(String str, String str2, int i, String str3, String str4, String str5, String str6, String str7, int i2) {
        ...
        jSONObject.put("biz", (Object) Integer.valueOf(i2));
        concurrentHashMap.put("body", jSONObject.toJSONString());
        b7y.m102882c().m102888g("destoryChannle:" + jSONObject.toJSONString());
        genSLAList();
        post(URL_OF_DESTORYECHANNEL, str6, str, str2, str3, str4, concurrentHashMap, new C4248c());
    }

    public void post(String str, String str2, String str3, String str4, String str5, String str6, ConcurrentHashMap<String, String> concurrentHashMap, b2d0<ze2> b2d0Var) {
        ...
        map.put("User-Agent", arx.m99789d().m99796g(str3));
        map.put("Content-Type", MimeTypes.FORM_ENCODED);
        map.put("x-forwarded-for", "172.16.232.161");
        new pof0(str, concurrentHashMap, map).m141755g(b2d0Var);
    }
    ...
    public void updateChannel(String str, String str2, int i, String str3, String str4, String str5, String str6, String str7, String str8, String str9, int i2) {
        ...
        b7y.m102882c().m102888g("updateChannle" + jSONObject.toJSONString());
        genSLAList();
        post(URL_OF_UPDATEECHANNEL, str6, str, str2, str3, str4, concurrentHashMap, new C4247b());
    }

    public /* synthetic */ HttpWrapper(C4246a c4246a) {
        this();
    }
}
