...
class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f15273ns;
    ...
    public void enable(int i) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            this.f15273ns = noiseSuppressorCreate;
            ...
            if (this.f15273ns.setEnabled(z) != 0) {
            ...
            sb2.append(z);
            sb2.append(", is now: ");
            sb2.append(this.f15273ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f15273ns;
    ...
    public boolean setNS(boolean z) {
        ...
        if (this.f15273ns == null || z == this.shouldEnableNs) {
