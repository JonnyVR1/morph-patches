...
public class RtpTransceiver {
    ...
    public enum RtpTransceiverDirection {
        ...
        public static RtpTransceiverDirection fromNativeIndex(int i) {
            ...
            za50.m219101a("Uknown native RtpTransceiverDirection type", i);
            return null;
        }
    ...
    private void checkRtpTransceiverExists() {
        ...
        wtq0.m207906a("RtpTransceiver has been disposed.");
    }
    ...
    public static final class RtpTransceiverInit {
        ...
        public RtpTransceiverInit(RtpTransceiverDirection rtpTransceiverDirection) {
            this(rtpTransceiverDirection, Collections.EMPTY_LIST);
        }
