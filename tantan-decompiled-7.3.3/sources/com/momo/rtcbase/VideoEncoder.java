...
public interface VideoEncoder {
    ...
    public static class Settings {
        ...
        public final boolean useVbr;
        public final int width;

        @CalledByNative("Settings")
        public Settings(int i, int i2, int i3, int i4, int i5, int i6, boolean z, boolean z2) {
    ...
    @CalledByNative
    void updateSharedContext(EglBase.Context context);
