...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private EglBase.Context glShareContext;
    ...
    public static /* synthetic */ void m21213a(SurfaceViewRenderer surfaceViewRenderer, int i, int i2) {
    ...
    private void logD(String str) {
        Logging.m21196d(TAG, this.resourceName + ": " + str);
    }
    ...
    private void updateSurfaceSize() {
        ...
        logD("updateSurfaceSize. Layout size: " + getWidth() + BaseSei.f14624X + getHeight() + ", frame size: " + this.rotatedFrameWidth + BaseSei.f14624X + this.rotatedFrameHeight + ", requested surface size: " + iMin + BaseSei.f14624X + iMin2 + ", old surface size: " + this.surfaceWidth + BaseSei.f14624X + this.surfaceHeight);
    ...
    public EglBase.Context getGlShareContext() {
        return this.glShareContext;
    }
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: l.cbh0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceViewRenderer.m21213a(this.f80820a, i4, i);
            }
        });
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD("onMeasure(). New size: " + pointMeasure.x + BaseSei.f14624X + pointMeasure.y);
    }
    ...
    public void setCutPosition(float f, float f2, float f3, float f4) {
        this.eglRenderer.setCutPosition(f, f2, f3, f4);
    }
    ...
    public void surfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        this.eglRenderer.releaseEglSurface(new bah0(countDownLatch));
