...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    private CameraCharacteristics getCameraCharacteristics(String str) {
        try {
            ...
            Logging.m21197e(TAG, "Camera access exception: " + e);
            return null;
        }
    }
    ...
    public static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (map) {
            try {
                ...
                Logging.m21196d(TAG, "Get supported formats for camera index " + str + "");
                ...
                try {
                    ...
                    for (Size size : supportedSizes) {
                        ...
                        Logging.m21196d(TAG, "Format: " + size.width + BaseSei.f14624X + size.height + "@" + iRound);
                    }
                    cachedSupportedFormats.put(str, arrayList);
                    Logging.m21196d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                    return arrayList;
                } catch (Exception e) {
                    Logging.m21197e(TAG, "getCameraCharacteristics(): " + e);
