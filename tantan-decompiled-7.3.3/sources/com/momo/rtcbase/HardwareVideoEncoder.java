...
class HardwareVideoEncoder implements VideoEncoder {
    ...
    private VideoCodecStatus encodeByteBuffer(VideoFrame videoFrame, VideoFrame.Buffer buffer, int i) {
        ...
        try {
            ...
            if (iDequeueInputBuffer == -1) {
                Logging.m21196d(TAG, "Dropped frame, no input buffers available");
    ...
    private VideoCodecStatus encodeTextureBuffer(VideoFrame videoFrame) {
        ...
        try {
            ...
            Logging.m21198e(TAG, "encodeTexture failed", e);
            releaseResource();
            return VideoCodecStatus.NO_OUTPUT;
        } catch (Exception e2) {
            Logging.m21198e(TAG, "encodeTexture failed", e2);
            releaseResource();
            return VideoCodecStatus.NO_OUTPUT;
        }
    }
    ...
    private VideoCodecStatus initEncodeInternal() {
        ...
        try {
            ...
            Logging.m21197e(TAG, "resetCodec initEncodeInternal startBitrate " + this.startBitrate);
                ...
                if (this.codecType == VideoCodecType.H264) {
                    ...
                    if (iHashCode != 1537948542) {
                        if (iHashCode == 1595523974 && str.equals("640c1f")) {
                            ...
                            Logging.m21200w(TAG, "Unknown profile level id: ".concat(str));
                        }
            ...
            Logging.m21197e(TAG, "Cannot create media encoder " + this.codecName);
            releaseResource();
            return VideoCodecStatus.OK;
        }
    }
    ...
    public void releaseCodecOnOutputThread() {
        ...
        try {
            ...
            Logging.m21198e(TAG, "Media encoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m21198e(TAG, "Media encoder release failed", e2);
    ...
    private void requestKeyFrame(long j) {
        ...
        try {
            ...
            Logging.m21198e(TAG, "requestKeyFrame failed", e);
        }
    }
    ...
    private VideoCodecStatus resetCodec(int i, int i2, boolean z) {
        ...
        Logging.m21197e(TAG, "resetCodec begin frame =" + this.bitrateAdjuster.getCodecConfigFramerate() + "biterate=" + this.bitrateAdjuster.getAdjustedBitrateBps() + ";resetCodecInterval =" + this.resetCodecInterval + ";viideoModem=" + this.bitrateMode);
        this.resetCodecPreTime = System.currentTimeMillis();
    ...
    public void deliverEncodedImage() {
        ...
        try {
            ...
            if ((bufferInfo.flags & 2) != 0) {
                ...
                if (z) {
                    Logging.m21197e(TAG, "Sync frame generated");
                }
                if (z && this.codecType == VideoCodecType.H264) {
                    Logging.m21196d(TAG, "Prepending config frame of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
            ...
            Logging.m21198e(TAG, "deliverOutput failed", e);
        }
    }
            ...
            try {
                ...
                if ((this.resetCodecInterval > 0 && this.adjustedBitrate != this.bitrateAdjuster.getAdjustedBitrateBps()) || this.isNeedUpdateShareContext) {
                    if (resetCodec(width, height, z) != VideoCodecStatus.OK) {
                        Logging.m21197e(TAG, "resetCodec fail");
                    } else {
                        this.adjustedBitrate = this.bitrateAdjuster.getAdjustedBitrateBps();
                        this.isNeedUpdateShareContext = false;
                    }
                ...
                if (this.outputBuilders.size() > 2) {
                    Logging.m21197e(TAG, "Dropped frame, encoder queue full");
                    return videoCodecStatus;
                }
                boolean z2 = false;
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        ...
        Logging.m21196d(TAG, "initEncode: " + this.width + " x " + this.height + ". @ " + settings.startBitrate + "kbps. Fps: " + settings.maxFramerate + " Use surface mode: " + this.useSurfaceMode);
        synchronized (this.codecSync) {
            videoCodecStatusInitEncodeInternal = initEncodeInternal();
        }
        return videoCodecStatusInitEncodeInternal;
    ...
    public VideoCodecStatus release() {
        this.encodeThreadChecker.checkIsOnValidThread();
        Logging.m21197e(TAG, "HardwareVideoEncoder release");
        synchronized (this.codecSync) {
            try {
                this.isNeedUpdateShareContext = true;
                if (this.outputThread == null) {
                    ...
                    if (!ThreadUtils.joinUninterruptibly(this.outputThread, Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS)) {
                        ...
                        Logging.m21198e(TAG, "Media encoder release exception", this.shutdownException);
    ...
    public VideoCodecStatus releaseResource() {
        Logging.m21197e(TAG, "HardwareVideoEncoder releaseResource");
        this.running = false;
    ...
    public void updateSharedContext(EglBase.Context context) {
        ...
        if (this.sharedContext != context2 || this.textureEglBase == null) {
            Logging.m21196d(TAG, "need release codec");
            this.isNeedUpdateShareContext = true;
        }
