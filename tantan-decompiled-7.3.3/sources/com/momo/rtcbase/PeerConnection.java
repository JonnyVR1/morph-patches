...
public class PeerConnection {
    ...
    public RtpSender addTrack(MediaStreamTrack mediaStreamTrack, List<String> list) {
        if (mediaStreamTrack == null || list == null) {
            mnd0.m159157a("No MediaStreamTrack specified in addTrack.");
            return null;
        }
        ...
        wtq0.m207906a("C++ addTrack failed.");
        return null;
    }
    ...
    public RtpTransceiver addTransceiver(MediaStreamTrack mediaStreamTrack, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit) {
        if (mediaStreamTrack == null) {
            mnd0.m159157a("No MediaStreamTrack specified for addTransceiver.");
            return null;
        }
        ...
        wtq0.m207906a("C++ addTransceiver failed.");
        return null;
    }
    ...
    public boolean removeTrack(RtpSender rtpSender) {
        ...
        mnd0.m159157a("No RtpSender specified for removeTrack.");
        return false;
    }
    ...
    public static class IceServer {
        ...
        public static class Builder {
            ...
            private Builder(List<String> list) {
                ...
                if (list == null || list.isEmpty()) {
                    ypg0.m217021a("urls == null || urls.isEmpty(): ", list);
                    throw null;
                }
                this.urls = list;
            }
        ...
        private IceServer(String str, List<String> list, String str2, String str3, TlsCertPolicy tlsCertPolicy, String str4, List<String> list2, List<String> list3) {
            if (str == null || list == null || list.isEmpty()) {
                wg3.m206174a("uri == null || urls == null || urls.isEmpty()");
                throw null;
            }
            Iterator<String> it = list.iterator();
            while (it.hasNext()) {
                if (it.next() == null) {
                    ypg0.m217021a("urls element is null: ", list);
                    throw null;
                }
            }
            if (str2 == null) {
                wg3.m206174a("username == null");
                throw null;
            }
            if (str3 == null) {
                wg3.m206174a("password == null");
                throw null;
            }
            if (str4 == null) {
                wg3.m206174a("hostname == null");
                throw null;
            }
            this.uri = str;
            this.urls = list;
    ...
    public RtpTransceiver addTransceiver(MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit) {
        ...
        mnd0.m159157a("No MediaType specified for addTransceiver.");
        return null;
    }
}
