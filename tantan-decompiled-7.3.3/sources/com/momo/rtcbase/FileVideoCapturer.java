...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private final TimerTask tickTask = new TimerTask() { // from class: com.momo.rtcbase.FileVideoCapturer.1
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i == -1) {
                    mce.m157919a("Found end of file before end of header for file: ", str);
                    throw null;
                }
                if (i == 10) {
                    ...
                    Logging.m21196d(TAG, "Color space: " + strSubstring);
                    if (!strSubstring.equals("420") && !strSubstring.equals("420mpeg2")) {
                        wg3.m206174a("Does not support any other color space than I420 or I420mpeg2");
                        throw null;
                    }
                    if (i2 % 2 == 1 || i3 % 2 == 1) {
                        wg3.m206174a("Does not support odd width or height");
                        throw null;
                    }
                    this.frameWidth = i2;
                    this.frameHeight = i3;
                    Logging.m21196d(TAG, "frame dim: (" + i2 + ", " + i3 + ")");
                    return;
                }
                sb.append((char) i);
            }
        ...
        @Override // com.momo.rtcbase.FileVideoCapturer.VideoReader
        public void close() {
            try {
                this.mediaFile.close();
            } catch (IOException e) {
                Logging.m21198e(TAG, "Problem closing file", e);
            }
        }
        ...
        public VideoFrame getNextFrame() {
            ...
            try {
                ...
                String str = new String(byteBufferAllocate.array(), Charset.forName(CharEncoding.US_ASCII));
                if (str.equals("FRAME\n")) {
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m21196d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
