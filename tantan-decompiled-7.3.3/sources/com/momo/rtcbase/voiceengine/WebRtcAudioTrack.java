...
public class WebRtcAudioTrack {
    ...
    private static AudioTrack createAudioTrackOnLollipopOrHigher(int i, int i2, int i3) {
        ...
        if (usageAttribute != DEFAULT_USAGE) {
            Logging.m21200w(TAG, "A non default usage attribute is used: " + usageAttribute);
        }
    ...
    public static void setAudioContentType(int i) {
        Logging.m21200w(TAG, "Audio track is changed from: " + audioContentType + " to " + i);
        audioContentType = i;
    }

    public static synchronized void setAudioTrackUsageAttribute(int i) {
        Logging.m21200w(TAG, "Default usage attribute is changed from: " + DEFAULT_USAGE + " to " + i);
        usageAttribute = i;
    }

    @Deprecated
    public static void setErrorCallback(WebRtcAudioTrackErrorCallback webRtcAudioTrackErrorCallback) {
        Logging.m21196d(TAG, "Set error callback (deprecated");
    ...
    public static void setErrorCallback(ErrorCallback errorCallback2) {
        Logging.m21196d(TAG, "Set extended error callback");
