...
public class RendererCommon {
    ...
    /* JADX INFO: renamed from: com.momo.rtcbase.RendererCommon$1 */
    public static /* synthetic */ class C43041 {
        static final /* synthetic */ int[] $SwitchMap$com$momo$rtcbase$RendererCommon$ScalingType;

        static {
            int[] iArr = new int[ScalingType.values().length];
            $SwitchMap$com$momo$rtcbase$RendererCommon$ScalingType = iArr;
            try {
                iArr[ScalingType.SCALE_ASPECT_FIT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$momo$rtcbase$RendererCommon$ScalingType[ScalingType.SCALE_ASPECT_FILL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$momo$rtcbase$RendererCommon$ScalingType[ScalingType.SCALE_ASPECT_BALANCED.ordinal()] = 3;
    ...
    private static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i = C43041.$SwitchMap$com$momo$rtcbase$RendererCommon$ScalingType[scalingType.ordinal()];
        if (i == 1) {
            return 1.0f;
        }
        if (i == 2) {
