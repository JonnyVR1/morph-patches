...
public class FaceSkinSmoothFilter extends FaceDetectFilter {
    ...
    public static /* synthetic */ class C41811 {
        ...
        static final /* synthetic */ int[] f14965x4e718477;

        static {
            int[] iArr = new int[edgePassFilterVersion.values().length];
            f14965x4e718477 = iArr;
            try {
                iArr[edgePassFilterVersion.surfaceFilter.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f14965x4e718477[edgePassFilterVersion.guidedFilter.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f14965x4e718477[edgePassFilterVersion.transitionalGuidedFilter.ordinal()] = 3;
    ...
    public FaceSkinSmoothFilter(edgePassFilterVersion edgepassfilterversion) {
        int i = C41811.f14965x4e718477[edgepassfilterversion.ordinal()];
        if (i == 1) {
    ...
    public String getFragmentShader() {
        ...
        int i = C41811.f14965x4e718477[this.edgePassFilterType_.ordinal()];
        if (i == 1) {
        ...
        MDLog.m7445e("Beauty log", "Parameters Error: Invalid filter type!");
        return "";
    }
    ...
    public void setMMCVInfo(omw omwVar) {
        ...
        if (iArrM164792w == null || iArrM164792w.length < 9) {
            int[] iArr = this.lowSkinThreshold;
            iArr[0] = 0;
            iArr[1] = 0;
            iArr[2] = 0;
        ...
        iArr4[0] = iArrM164792w[0];
        iArr4[1] = iArrM164792w[1];
        iArr4[2] = iArrM164792w[2];
        int[] iArr5 = this.highSkinThreshold;
        iArr5[0] = iArrM164792w[3];
        iArr5[1] = iArrM164792w[4];
        iArr5[2] = iArrM164792w[5];
        int[] iArr6 = this.defaultSkinThreshold;
        iArr6[0] = iArrM164792w[6];
        iArr6[1] = iArrM164792w[7];
        iArr6[2] = iArrM164792w[8];
    }
