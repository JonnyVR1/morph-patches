...
public class LightSkinSmoothFilter extends hs10 implements suf {
    ...
    public void drawSub() {
        ...
        for (int i = 0; i < this.mmcvInfo.m168299n(); i++) {
            facePassShaderValues();
            float[][] faceTriangulation = AIFaceTriangulation.getFaceTriangulation(this.mmcvInfo.m168295j(i).m164787r(), getWidth(), getHeight(), null);
    ...
    public void passShaderValues() {
        ...
        omw omwVar = this.mmcvInfo;
        GLES20.glUniform3f(this.blurAlphaHandle, (omwVar == null || omwVar.m168299n() <= 0) ? this.smoothLevel : this.bgBlur, 0.0f, 0.0f);
        GLES20.glUniform1f(this.widthOffsetHandle, this.widthOffset);
        GLES20.glUniform1f(this.heightOffsetHandle, this.heightOffset);
