...
public class StickerGestureTrackingFilter extends StickerMaskFilter {
    ...
    private void adjustRectF(RectF rectF) {
        ...
        float fWidth = rectF.width() / trackingRegion.f14970w;
        float fHeight = rectF.height() / trackingRegion.f14969h;
        float f = rectF.left - (trackingRegion.f14971x * fWidth);
        rectF.left = f;
        float f2 = rectF.top - (trackingRegion.f14972y * fHeight);
        rectF.top = f2;
    ...
    private void trackingUpdate() {
        ...
        if (z) {
            objectTracker.Update(this.mmFrame.m196796b(), this.trackerParams, this.trackerInfo);
        } else {
            objectTracker.ReInit(this.mmFrame.m196796b(), this.trackerParams);
        ...
        int i = mMRect2.f15483x_;
        rectF.left = i;
        int i2 = mMRect2.f15484y_;
        rectF.top = i2;
    ...
    @Override // com.momo.mcamera.mask.StickerMaskFilter, p153l.gfj, p153l.wej
    public void destroy() {
        super.destroy();
        ObjectTracker objectTracker = this.mTracker;
    ...
    @Override // com.momo.mcamera.mask.StickerMaskFilter, p153l.jt2, p153l.dfj
    ...
    @Override // com.momo.mcamera.mask.StickerMaskFilter, com.momo.mcamera.mask.FaceDetectFilter, p153l.suf
