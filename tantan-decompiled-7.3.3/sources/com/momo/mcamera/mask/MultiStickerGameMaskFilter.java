...
public class MultiStickerGameMaskFilter extends MultiStickerMaskFilter {
    ...
    private void updateFaceStatus(omw omwVar) {
        ...
        if (filterTriggerManager != null) {
            ...
            this.isMouthOpen = z;
            if (!z && this.lastOpenState && omwVar.m168299n() > 0) {
                float[] fArrM164781l = omwVar.m168295j(0).m164781l();
                float f = fArrM164781l[INDEX_MOUSE_UPTOP + 68];
                int i = this.triggerRegionOffset;
                float f2 = f - i;
                float f3 = fArrM164781l[INDEX_MOUSE_LEFT] - i;
                float f4 = fArrM164781l[INDEX_MOUSE_RIGHT] + i;
                float f5 = fArrM164781l[INDEX_MOUSE_DOWNBOTTOM + 68] + i;
    ...
    public void initGameFixStickerItem(Bitmap bitmap, Bitmap bitmap2, int i, int i2) {
        ...
        objectRegion.f14971x = (1.0f - width2) - 0.05f;
        objectRegion.f14972y = height + 0.05f;
        objectRegion.f14970w = f;
        objectRegion.f14969h = f3;
        ...
        objectRegion2.f14971x = (1.0f - width3) - 0.05f;
        objectRegion2.f14972y = height2 + 0.05f + 0.01f;
        objectRegion2.f14970w = f;
        objectRegion2.f14969h = f3;
    ...
    @Override // com.momo.mcamera.mask.MultiStickerMaskFilter, p153l.jt2, p153l.dfj
