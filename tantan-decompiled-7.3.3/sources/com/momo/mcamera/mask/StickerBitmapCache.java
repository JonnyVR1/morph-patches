...
public class StickerBitmapCache {
    ...
    private LinkedList<umw> linkedBlockingDeque = new LinkedList<>();
    ...
    public class MMCVImageCacheManager {
        ...
        private void updateImageArray() {
            for (int i = 0; i < this.totalSize; i++) {
                this.cacheArray[i] = new umw();
                umw umwVar = this.cacheArray[i];
            }
        }
        ...
        public umw getOneImageBuffer() {
            umw[] umwVarArr = this.cacheArray;
            int i = this.curIndex;
            umw umwVar = umwVarArr[i];
    ...
    public void addNewIndex(Context context, int i) {
        ...
        umw oneImageBuffer = this.cacheManager.getOneImageBuffer();
        if (oneImageBuffer != null) {
            ImageUtils.decodeMMCVImage(oneImageBuffer, this.imagePath);
        } else {
            oneImageBuffer = new umw();
            oneImageBuffer.m196801g(null);
        }
