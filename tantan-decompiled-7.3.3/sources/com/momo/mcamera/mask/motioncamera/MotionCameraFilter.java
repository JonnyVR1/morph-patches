...
public class MotionCameraFilter extends AbstractC17634i4 implements suf, MotionCameraFilterAdapter.OnCropRegionChangedListener {
    ...
    public void setMMCVInfo(omw omwVar) {
        this.adapter.updateMMCVInfo(omwVar, this.width, this.height);
    }
}
