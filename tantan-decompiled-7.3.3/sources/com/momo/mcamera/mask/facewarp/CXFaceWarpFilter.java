...
public class CXFaceWarpFilter extends BaseFaceWarpFilter {
    ...
    public BeautyWarpParams buildParams(omw omwVar, SingleFaceInfo singleFaceInfo) {
    ...
    public boolean notWarp() {
        ...
        return omwVar == null || omwVar.m168299n() == 0;
    }
}
