...
public class FaceCutFilter extends jt2 implements suf {
    ...
    private void buildTextureCoordinate() {
        ...
        float[] fArrM164779j = this.mmcvInfo.m168295j(0).m164779j();
        float fMin = Math.min(fArrM164779j[0], fArrM164779j[3]) / this.width;
        float fMin2 = Math.min(fArrM164779j[203], fArrM164779j[204]) / this.height;
        float fMax = Math.max(fArrM164779j[18], fArrM164779j[15]) / this.width;
        float f = fArrM164779j[113] / this.height;
    ...
    private void buildVertexCoordinate() {
        ...
        if (canCutFace() && iFindNearestIndex > -1) {
            ...
            if (iFindNearestIndex < fArr2.length) {
                ...
                fArr5[6] = f7;
                fArr5[7] = f8;
                this.offset.x = this.mmcvInfo.m168295j(0).m164779j()[75] / this.width;
                this.offset.y = 1.0f - (this.mmcvInfo.m168295j(0).m164779j()[179] / this.height);
                this.videoFaceRoll = (float) (((double) (fArr3[4] / 360.0f)) * 3.141592653589793d * 2.0d);
                this.cameraFaceRoll = (float) (((double) (this.mmcvInfo.m168295j(0).m164775c()[2] / 360.0f)) * 3.141592653589793d * 2.0d);
                return;
            }
        }
    ...
    private boolean canCutFace() {
        ...
        return (omwVar == null || omwVar.m168299n() <= 0 || this.timestamps == null || this.faceData == null) ? false : true;
    }
