...
public class VideoResourceInput extends MMTextureResourceInput1 implements SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private AssetFileDescriptor f14977fd;
    ...
    public VideoResourceInput(Context context, AssetFileDescriptor assetFileDescriptor) {
        ...
        this.f14977fd = assetFileDescriptor;
        start();
    }
    ...
    @Override // com.momo.mcamera.mask.videomix.MMTextureResourceInput1, p153l.gfj, p153l.wej
    public void destroy() {
        super.destroy();
        MediaPlayer mediaPlayer = this.mMediaPlayer;
        if (mediaPlayer != null) {
    ...
    @Override // com.momo.mcamera.mask.videomix.MMTextureResourceInput1, p153l.wej
    @RequiresApi(api = 15)
    ...
    public void start() {
        ...
        try {
            ...
            this.mMediaPlayer.setOnVideoSizeChangedListener(this);
            this.mMediaPlayer.setSurface(this.mSurface);
            AssetFileDescriptor assetFileDescriptor = this.f14977fd;
            MediaPlayer mediaPlayer2 = this.mMediaPlayer;
            if (assetFileDescriptor != null) {
                mediaPlayer2.setDataSource(assetFileDescriptor.getFileDescriptor(), this.f14977fd.getStartOffset(), this.f14977fd.getLength());
            } else {
