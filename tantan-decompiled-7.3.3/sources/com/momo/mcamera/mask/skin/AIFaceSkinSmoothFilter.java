...
public class AIFaceSkinSmoothFilter extends FaceDetectFilter {
    ...
    private void facePassShaderValues(int i) {
        ...
        GLES20.glUniform1f(this.mFaceWidthHandle, AIFaceTriangulation.getFaceTriangulationWidth(this.mMmcvInfo.m168295j(i).m164787r(), this.width / this.mMMCVWidth));
    }
    ...
    public void drawSub() {
        ...
        for (int i = 0; i < this.mMmcvInfo.m168299n(); i++) {
            ...
            float[][] faceTriangulation = AIFaceTriangulation.getFaceTriangulation(this.mMmcvInfo.m168295j(i).m164787r(), getWidth(), getHeight(), null);
    ...
    public void setMMCVInfo(omw omwVar) {
        ...
        if (i % 90 != 0 || i % 180 == 0) {
            ...
            this.mMMCVHeight = omwVar.f148019f;
        } else {
            this.mMMCVWidth = omwVar.f148019f;
            this.mMMCVHeight = omwVar.f148018e;
        }
    }
