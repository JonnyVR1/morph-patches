...
public class LightningEngineHelper implements IPatternDetect.ExpressDetectListener, IDetectManager.IGestureDetectListener, IDetectManager.IObjectDetectListener, IDetectManager.IPickNoseDetectListener {
    ...
    private int adjustState(omw omwVar, int i) {
        boolean z = false;
        if (omwVar != null) {
    ...
    private int updateEyeState(nuf nufVar) {
    ...
    private int updateNodState(nuf nufVar) {
        ...
        for (MMJoint[] mMJointArr2 : mMJointArr) {
            ...
            for (MMJoint mMJoint : mMJointArr2) {
                if (mMJoint != null) {
                    ...
                    joint.f15287x = mMJoint.f15478x_;
                    joint.f15288y = mMJoint.f15479y_;
    ...
    public void setBodyWarpInfo(omw omwVar) {
        BodyLandData bodyLandData;
        if (this.lightningRender.getEventDispatcher() == null) {
            return;
        }
        if (omwVar == null || (bodyLandData = omwVar.f148025l) == null) {
            setBodyInfos(null);
            return;
        }
    ...
    public void setCartoonFaceInfo(omw omwVar, CartoonfaceInfo cartoonfaceInfo) {
        byte[] bArr;
        float[] fArr;
        IXEventDispatcher eventDispatcher = this.lightningRender.getEventDispatcher();
        if (eventDispatcher == null) {
        ...
        this.xeCartoonFaceInfo.setFlipShowX(omwVar.f148014a);
    ...
    public void setFaceInfo(omw omwVar) {
        IXEventDispatcher eventDispatcher;
        int i;
        char c;
        char c2;
        ...
        float[] fArr;
        if (omwVar == null || (eventDispatcher = this.lightningRender.getEventDispatcher()) == null) {
            return;
        }
        ...
        int i2 = omwVar.f148038y;
        int i3 = 1;
        if (i2 < 1 || i2 >= iM168299n) {
            i2 = iM168299n;
        }
        float[][] fArr2 = this.mouthMatrix;
        char c3 = 2;
        if (fArr2 == null || fArr2.length != i2) {
            this.mouthMatrix = (float[][]) Array.newInstance((Class<?>) Float.TYPE, iM168299n, 9);
            int i4 = 0;
            while (true) {
        ...
        int i5 = 0;
        while (i5 < i2) {
            nuf nufVarM168295j = omwVar.m168295j(i5);
            SingleFaceInfo singleFaceInfo = omwVar.m168304s().facesinfo_[i5];
            if (nufVarM168295j == null) {
                i = i3;
                c = c3;
            } else {
                XEFaceInfo xEFaceInfo = new XEFaceInfo();
                xEFaceInfo.expression = adjustState(omwVar, i5);
                ...
                if (fArrM164775c != null && fArrM164775c.length >= 3) {
                    ...
                    xEFaceInfo.yaw = fArrM164775c[i3];
                    xEFaceInfo.roll = fArrM164775c[c3];
                }
                float f = nufVarM168295j.m164777e()[0];
                float f2 = nufVarM168295j.m164777e()[i3];
                float f3 = nufVarM168295j.m164777e()[c3] - nufVarM168295j.m164777e()[0];
                float f4 = nufVarM168295j.m164777e()[3] - nufVarM168295j.m164777e()[i3];
                i = i3;
                c = c3;
                ...
                if (nufVarM168295j.m164792w() != null) {
                    xEFaceInfo.skin_threshold = new float[nufVarM168295j.m164792w().length];
                    for (int i6 = 0; i6 < nufVarM168295j.m164792w().length; i6++) {
                        xEFaceInfo.skin_threshold[i6] = nufVarM168295j.m164792w()[i6];
                    }
                }
                if (i5 == 0 && (evfVarM168302q = omwVar.m168302q()) != null && (facerigV3Info = evfVarM168302q.f96000a) != null && (fArr = facerigV3Info.facerigV3_eulers_) != null && facerigV3Info.facerigV3_scores_ != null) {
                    float[] fArr5 = new float[54];
                    System.arraycopy(fArr, 0, fArr5, 0, 3);
                    System.arraycopy(evfVarM168302q.f96000a.facerigV3_scores_, 0, fArr5, 3, 51);
                    xEFaceInfo.facerigStates = fArr5;
                }
                float[][] fArrM168303r = omwVar.m168303r();
                if (fArrM168303r != null && fArrM168303r.length > i5) {
                    xEFaceInfo.src_warp_points = omwVar.m168303r()[i5];
                    xEFaceInfo.dst_warp_points = omwVar.m168294f()[i5];
                }
                ...
                if (singleFaceInfo.face_warp_mat == null || singleFaceInfo.face_mask_width == 0 || singleFaceInfo.face_mask_height == 0) {
                    ...
                    xEFaceMask.setFlipShowX(omwVar.f148014a);
                ...
                if (singleFaceInfo.mouth_warp_mat != null && singleFaceInfo.mouth_mask_width != 0 && singleFaceInfo.mouth_mask_height != 0) {
                    ...
                    xEFaceMask2.setFlipShowX(omwVar.f148014a);
                    xEFaceInfo.setMouthMask(xEFaceMask2);
                }
                LiquefyInfo[][] liquefyInfoArr = omwVar.f148037x;
                if (liquefyInfoArr != null && liquefyInfoArr.length > 0) {
                    ...
                    if (liquefyInfoArr2 != null && liquefyInfoArr2.length > 0) {
                        for (LiquefyInfo liquefyInfo : liquefyInfoArr2) {
                            ...
                            xEFaceLiquefy.mat = liquefyInfo.f15477m;
