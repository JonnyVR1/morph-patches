...
public class SobelFilter extends jt2 {
    private int sobelEnableHandler;
    private int sobelEnabled = 1;
    private int texelHeightHandler;
    private int texelWidthHandler;
    private int thresholdHandler;
    ...
    public void initShaderHandles() {
        ...
        this.thresholdHandler = GLES20.glGetUniformLocation(this.programHandle, "threshold");
        ...
        this.sobelEnableHandler = GLES20.glGetUniformLocation(this.programHandle, "sobelEnabled");
    }

    @Override // p153l.wej
    public void passShaderValues() {
        super.passShaderValues();
        GLES20.glUniform1f(this.thresholdHandler, 0.8f);
        GLES20.glUniform1f(this.texelWidthHandler, 1.0f / getWidth());
        GLES20.glUniform1f(this.texelHeightHandler, 1.0f / getHeight());
        GLES20.glUniform1i(this.sobelEnableHandler, this.sobelEnabled);
    }

    public void setSobelEnabled(boolean z) {
        this.sobelEnabled = z ? 1 : 0;
    }
}
