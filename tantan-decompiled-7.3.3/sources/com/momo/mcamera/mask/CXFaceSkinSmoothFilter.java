...
public class CXFaceSkinSmoothFilter extends sx3 implements suf {
    ...
    @Override // p153l.sx3, p153l.gfj, p153l.wej
    public void destroy() {
        super.destroy();
    ...
    public void drawSub() {
        ...
        if (i != 1) {
            ...
            for (int i2 = 0; i2 < this.mMmcvInfo.m168299n(); i2++) {
                if (this.mMmcvInfo.m168295j(i2).m164787r() != null) {
                    float[] fArrLandMark104ToPoint = landMark104ToPoint(this.mMmcvInfo.m168295j(i2).m164787r(), getWidth(), getHeight());
                    setParamters(this.mType, 1, 0, AIFaceTriangulation.getFaceTriangulationWidth(this.mMmcvInfo.m168295j(i2).m164787r(), this.width / this.mMMCVWidth), this.mDermabrasion, this.mEyesAreaAmount);
        ...
        for (int i3 = 0; i3 < this.mMmcvInfo.m168299n(); i3++) {
            if (this.mMmcvInfo.m168295j(i3).m164787r() != null) {
                float[] fArrLandMark104ToPoint2 = landMark104ToPoint(this.mMmcvInfo.m168295j(i3).m164787r(), getWidth(), getHeight());
                float faceTriangulationWidth = AIFaceTriangulation.getFaceTriangulationWidth(this.mMmcvInfo.m168295j(i3).m164787r(), this.width / this.mMMCVWidth);
    ...
    public void newTextureReady(int i, gfj gfjVar, boolean z) {
        ...
        if (this.maskTexture == 0 && !TextUtils.isEmpty(this.maskPath)) {
            umw umwVar = new umw();
            ImageUtils.decodeMMCVImage(umwVar, this.maskPath);
    ...
    public void setMMCVInfo(omw omwVar) {
        synchronized (getLockObject()) {
            try {
                ...
                iArr3[1] = 120;
                iArr3[2] = 110;
                int i = omwVar.f148016c;
                if (i % 90 != 0 || i % 180 == 0) {
                    this.mMMCVWidth = omwVar.f148018e;
                } else {
                    this.mMMCVWidth = omwVar.f148019f;
                }
            } catch (Throwable th) {
                throw th;
            }
