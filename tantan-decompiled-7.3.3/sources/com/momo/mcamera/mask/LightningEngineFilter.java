...
public class LightningEngineFilter extends FaceDetectFilter {
    ...
    private void get3DRenderImage() {
        ...
        byteBufferAllocate.position(0);
        this.isCapture = false;
        C3949c.m19427d(2, new Runnable() { // from class: com.momo.mcamera.mask.LightningEngineFilter.1
            ...
            public void run() {
                ...
                Bitmap bitmapCreateBitmap = rect2 != null ? Bitmap.createBitmap(lightningEngineFilter.cropWidth, LightningEngineFilter.this.cropHeight, Bitmap.Config.ARGB_8888) : Bitmap.createBitmap(((wej) lightningEngineFilter).width, ((wej) LightningEngineFilter.this).height, Bitmap.Config.ARGB_8888);
                ...
                if (LightningEngineFilter.this.mCapture3DImageListener != null) {
                    ...
                    LightningEngineFilter.this.mCapture3DImageListener.get3DRenderImage(rect3 != null ? Bitmap.createBitmap(bitmapCreateBitmap, 0, 0, lightningEngineFilter2.cropWidth, LightningEngineFilter.this.cropHeight, matrix, true) : Bitmap.createBitmap(bitmapCreateBitmap, 0, 0, ((wej) lightningEngineFilter2).width, ((wej) LightningEngineFilter.this).height, matrix, true));
                }
            }
        });
    }
        ...
        if (lightningEngineHelper != null) {
            ...
            if (omwVar.f148004B) {
                ...
                if (zIntercept) {
                    ...
                    lightningEngineHelper2.setBodyWarpInfo(omwVar);
                }
            }
            boolean zDoProcess = this.cartoonMutex.doProcess();
            CartoonProcess cartoonProcess = this.cartoonProcess;
            if (zDoProcess) {
                this.engineHelper.setCartoonFaceInfo(omwVar, cartoonProcess.process(omwVar, i, z));
            } else {
                cartoonProcess.delayRelease();
                this.engineHelper.setCartoonFaceInfo(omwVar, null);
            }
            CartoonfaceInfo cartoonfaceInfo = omwVar.f148010H;
            if (cartoonfaceInfo != null) {
                this.engineHelper.setCryingFaceInfo(cartoonfaceInfo, omwVar.f148014a);
            }
            StylizefaceInfo stylizefaceInfo = omwVar.f148011I;
            if (stylizefaceInfo != null) {
                this.engineHelper.setStylizeFaceInfo(stylizefaceInfo, omwVar.f148014a);
            }
            if (!"default".equals(omwVar.f148013K)) {
                this.engineHelper.setQRCodeInfo(omwVar.f148013K);
            }
            ArDetectInfo arDetectInfo = omwVar.f148012J;
