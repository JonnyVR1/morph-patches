...
public class MmcvImageLoader {
    ...
    public umw getMmcvImage(Context context) {
        ...
        if (this.mMMCVImage == null) {
            ...
            umw umwVar = new umw();
            this.mMMCVImage = umwVar;
            ImageUtils.decodeMMCVImage(umwVar, this.imagePath);
    ...
    public umw getMmcvImageByIndex(int i) {
        String imagePathByIndex = this.sticker.getImagePathByIndex(null, i);
        if (imagePathByIndex == null) {
            return null;
        }
        umw umwVar = new umw();
        ImageUtils.decodeMMCVImage(umwVar, imagePathByIndex);
        return umwVar;
    }

    public int getMmcvTexture(Context context, int i) {
        umw mmcvImage = getMmcvImage(context);
        if (mmcvImage != null && mmcvImage.m196796b() != null) {
