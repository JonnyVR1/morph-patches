...
public class FilterTriggerManager {
    ...
    public static boolean isTriggerRegionMatches(MMCVBoxes mMCVBoxes, String str, MaskModel maskModel, int i, int i2) {
        ...
        for (MMBox mMBox : mMCVBoxes.getDetectResult()) {
            if (str.equals(mMBox.class_name_)) {
                int i3 = mMBox.f15483x_;
                int i4 = mMBox.f15484y_;
    ...
    public void adjustStateBy(omw omwVar) {
        if (omwVar == null) {
            return;
        }
        if (this.faceIndex >= omwVar.m168299n()) {
            this.faceIndex = 0;
        }
        nuf nufVarM168295j = omwVar.m168295j(this.faceIndex);
        if (nufVarM168295j != null) {
            if (isContain(1) || isHiddenContain(1)) {
                updateMouseState(nufVarM168295j.m164781l());
            }
    ...
    public void updateEyeState(nuf nufVar) {
        this.leftEyeOpenAmount = nufVar.m164783n();
        float fM164789t = nufVar.m164789t();
        this.rightEyeOpenAmount = fM164789t;
