...
public class BigMouthMaskFilter extends AbstractC17634i4 implements suf {
    ...
    public void newTextureReady(int i, gfj gfjVar, boolean z) {
        if (this.maskTexture == 0 && !TextUtils.isEmpty(this.maskImagePath)) {
            this.maskTexture = oim.m167794a(oim.m167796c(this.maskImagePath));
        }
    ...
    public void passShaderValues() {
        ...
        float[] fArrM164782m = this.mmcvInfo.m168295j(0).m164782m();
        this.locationList.get(0).set(fArrM164782m[17], fArrM164782m[113]);
        this.locationList.get(1).set(fArrM164782m[16], fArrM164782m[112]);
        this.locationList.get(2).set(fArrM164782m[15], fArrM164782m[111]);
        this.locationList.get(3).set(fArrM164782m[14], fArrM164782m[110]);
        this.locationList.get(4).set(fArrM164782m[12], fArrM164782m[108]);
        this.locationList.get(5).set(fArrM164782m[11], fArrM164782m[107]);
        this.locationList.get(6).set(fArrM164782m[10], fArrM164782m[106]);
        this.locationList.get(7).set(fArrM164782m[9], fArrM164782m[105]);
        this.locationList.get(8).set(fArrM164782m[8], fArrM164782m[104]);
        this.locationList.get(9).set(fArrM164782m[7], fArrM164782m[103]);
        this.locationList.get(10).set(fArrM164782m[6], fArrM164782m[102]);
        this.locationList.get(11).set(fArrM164782m[4], fArrM164782m[100]);
        this.locationList.get(12).set(fArrM164782m[3], fArrM164782m[99]);
        this.locationList.get(13).set(fArrM164782m[2], fArrM164782m[98]);
        this.locationList.get(14).set(fArrM164782m[1], fArrM164782m[97]);
        PointF pointF = new PointF(fArrM164782m[24], fArrM164782m[120]);
        PointF pointF2 = new PointF(fArrM164782m[29], fArrM164782m[125]);
        PointF pointF3 = new PointF(fArrM164782m[63], fArrM164782m[159]);
        PointF pointF4 = new PointF(fArrM164782m[74], fArrM164782m[170]);
        ...
        PointF pointF5 = new PointF(fArrM164782m[64], fArrM164782m[160]);
        PointF pointF6 = new PointF(fArrM164782m[73], fArrM164782m[169]);
        this.locationList.get(17).set((pointF5.x + pointF6.x) / 2.0f, (pointF5.y + pointF6.y) / 2.0f);
        this.locationList.get(18).set(fArrM164782m[75], fArrM164782m[171]);
        PointF pointF7 = new PointF(fArrM164782m[51], fArrM164782m[147]);
        PointF pointF8 = new PointF(fArrM164782m[54], fArrM164782m[150]);
        PointF pointF9 = new PointF(fArrM164782m[57], fArrM164782m[153]);
        PointF pointF10 = new PointF(fArrM164782m[60], fArrM164782m[156]);
        this.locationList.get(19).set((((pointF7.x + pointF8.x) + pointF9.x) + pointF10.x) / 4.0f, (((pointF7.y + pointF8.y) + pointF9.y) + pointF10.y) / 4.0f);
        PointF pointF11 = new PointF(fArrM164782m[39], fArrM164782m[135]);
        PointF pointF12 = new PointF(fArrM164782m[42], fArrM164782m[138]);
        PointF pointF13 = new PointF(fArrM164782m[45], fArrM164782m[141]);
        PointF pointF14 = new PointF(fArrM164782m[48], fArrM164782m[144]);
        ...
        this.locationList.get(21).set(fArrM164782m[82], fArrM164782m[178]);
        this.locationList.get(22).set(fArrM164782m[76], fArrM164782m[172]);
        this.locationList.get(23).set(fArrM164782m[79], fArrM164782m[175]);
        this.locationList.get(24).set(fArrM164782m[90], fArrM164782m[186]);
        this.locationList.get(25).set(fArrM164782m[94], fArrM164782m[190]);
