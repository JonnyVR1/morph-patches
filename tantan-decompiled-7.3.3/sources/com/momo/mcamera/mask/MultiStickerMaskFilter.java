...
public class MultiStickerMaskFilter extends jt2 implements gam, suf, StickerAdjustFilter.IOrderable {
    ...
    private void drawAbsolutePostion(StickerItem stickerItem, FaceDetectFilter.FaceDetectParam faceDetectParam) {
        ...
        if (stickerItem instanceof StickerFixItem) {
            ...
            float width = (absolutePos.getCenter().f14971x * absolutePos.getCenter().f14970w) + ((getWidth() - absolutePos.getCenter().f14970w) / 2.0f);
            float f = absolutePos.getCenter().f14972y * absolutePos.getCenter().f14969h;
    ...
    private void drawFaceSticker(StickerItem stickerItem, FaceDetectFilter.FaceDetectParam faceDetectParam, omw omwVar, float[] fArr, float f) {
        PointF centerPoint;
        ...
        if (omwVar.m168299n() > 0) {
            faceDetectParam.points68 = omwVar.m168295j(0).m164781l();
            faceDetectParam.points96 = omwVar.m168295j(0).m164782m();
            faceDetectParam.points104 = omwVar.m168295j(0).m164779j();
            faceDetectParam.warpedPoints104 = omwVar.m168295j(0).m164795z();
        }
        faceDetectParam.filterTrigerManager = this.filterTriggerManager;
        stickerItem.setDetectParam(faceDetectParam);
    }
        ...
        synchronized (stickerItem.getLockObject()) {
            try {
                ...
                if (list == null || list.size() <= 0 || !stickerItem.isDraw) {
                    ...
                    umw mmcvImage = stickerItem.getMmcvImage(this.context);
    ...
    private void drawSubStickerItemByAll(StickerItem stickerItem) {
        if (stickerItem.getEffectTimeBean() == null || !stickerItem.sticker.isHaniSticker) {
            ...
            if (this.mCurrentTime < stickerItem.getEffectTimeBean().f148698a || this.mCurrentTime > stickerItem.getEffectTimeBean().f148699b) {
                return;
            }
            drawSubStickerItem(stickerItem);
        }
    ...
    private void updateFaceInfoBySingleItem(omw omwVar, float f, float[] fArr, boolean z, StickerItem stickerItem) {
        ...
        drawFaceSticker(stickerItem, faceDetectParam, omwVar, fArr, f);
    }
    ...
    public void setEffectTimeInfoByHaniId(ore oreVar, int i) {
        ...
        for (StickerItem stickerItem : this.stickerItemList) {
            if (stickerItem.sticker.getModelType() == i) {
                stickerItem.setEffectTimeInfo(oreVar);
            }
        }
    }
    ...
    public void setMMCVInfo(omw omwVar) {
        ...
        if (i != 0 && i < omwVar.m168299n()) {
            updateFaceInfo(omwVar, omwVar.m168295j(this.faceIndex).m164778f(), omwVar.m168295j(this.faceIndex).m164781l(), true);
            return;
        }
        for (int iM168299n = omwVar.m168299n() - 1; iM168299n >= 0; iM168299n--) {
            updateFaceInfo(omwVar, omwVar.m168295j(iM168299n).m164778f(), omwVar.m168295j(iM168299n).m164781l(), true);
        }
    }
    ...
    public void updateFaceInfo(omw omwVar, float f, float[] fArr, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            float f2 = f;
            float[] fArr2 = fArr;
            multiStickerMaskFilter.updateFaceInfoBySingleItem(omwVar2, f2, fArr2, z, it.next());
        ...
        while (it2.hasNext()) {
            multiStickerMaskFilter2.updateFaceInfoBySingleItem(omwVar3, f3, fArr3, z, it2.next());
        }
    }
