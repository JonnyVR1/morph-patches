...
public abstract class MediaEncoder implements Runnable {
    ...
    public MediaEncoder(MediaMuxerWrapper mediaMuxerWrapper, MediaEncoderListener mediaEncoderListener) {
        ...
        if (mediaEncoderListener == null) {
            mnd0.m159157a("MediaEncoderListener is null");
            throw null;
        }
        if (mediaMuxerWrapper == null) {
            mnd0.m159157a("MediaMuxerWrapper is null");
            throw null;
        }
            ...
            while (this.mIsCapturing) {
                ...
                if (iDequeueOutputBuffer == -1) {
                    ...
                    if (bufferInfo.size != 0) {
                        if (!this.mMuxerStarted) {
                            azk0.m101074a("drain:muxer hasn't started");
                            return;
                        }
                        if (this.processSurface.getCurrentBuffer() != null) {
                            ...
                            if (processSurface2 != null) {
                                ...
                                MDLog.m7443d("MediaEncoder", "MediaEncoder drain:recorder isDrawing" + this.processSurface.isRenderDrawing);
                            }
                        }
                    }
