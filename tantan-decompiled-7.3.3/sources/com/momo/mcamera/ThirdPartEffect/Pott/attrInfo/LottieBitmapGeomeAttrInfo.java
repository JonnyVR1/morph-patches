...
public class LottieBitmapGeomeAttrInfo extends LottieMMFrameGeomeAttrInfo {
    ...
    public void recycleImageBuffers() {
        ...
        bitmap.recycle();
        this.bitmap = null;
        MDLog.m7445e(MDLogTag.FILTER_TAG, "Recycle bitmap lottie info !");
    }

    @Override // com.momo.mcamera.ThirdPartEffect.Pott.attrInfo.LottieMMFrameGeomeAttrInfo, com.momo.mcamera.ThirdPartEffect.Pott.attrInfo.MMFrameGeomeAttrInfo, p153l.lim
