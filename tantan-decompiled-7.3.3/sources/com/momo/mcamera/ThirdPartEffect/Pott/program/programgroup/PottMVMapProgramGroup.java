...
public class PottMVMapProgramGroup extends EsTemplateProgramGroup {
        ...
        try {
            if (this.nomralForCountry != null && this.countryGInfo != null) {
                if (this.mapBuffer == null) {
                    lej lejVar = new lej(this.mapWidth, this.mapHeight);
                    this.mapBuffer = lejVar;
                    lejVar.m153895b(this.mapWidth, this.mapHeight);
                    this.nomralForCountry.updateInputeTexture(new int[]{this.mapBuffer.m153902i()[0]});
                }
                ...
                if (this.nomralForCountry.getFrameTexture() != null && this.nomralForCountry.getAlphaValue() > 0.0f) {
                    ...
                    GLES20.glBindFramebuffer(36160, this.mapBuffer.m153901h()[0]);
            ...
            MDLog.m7445e(MDLogTag.FILTER_TAG, "Parse Config error !! do not render ");
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public boolean onParseLayers(LottieConfig lottieConfig, Layers layers, AssetValue assetValue) {
        ...
        if (layerName.equalsIgnoreCase("flags")) {
            ...
            if (list == null) {
                MDLog.m7453w(MDLogTag.FILTER_TAG, "Do not set Location list !");
                return true;
            }
        ...
        MaskModel mask = MaskStore.getInstance().getMask(jv0.m147001a(), str3 + "/" + assetValue.getFolderPath());
        ...
        addRunerTask(this.normal, new StickerItemGeomeAttrInfo(mask.getStickers().get(0), l26.f129743a));
        return true;
    }
