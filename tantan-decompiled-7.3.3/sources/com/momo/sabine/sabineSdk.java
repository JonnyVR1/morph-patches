...
public class sabineSdk {
    ...
    public void sabineClose() {
        synchronized (this.object) {
            try {
                Log.e("sabine", "-----sabineClose:" + mIsLibLoaded + Constants.PACKNAME_END + this.mIsOpened);
                if (mIsLibLoaded && this.mIsOpened) {
                    closeSabineEf();
                    this.mIsOpened = false;
                }
                Log.e("sabine", "-----sabineClose:end" + mIsLibLoaded + Constants.PACKNAME_END + this.mIsOpened);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public void sabineOpen(int i, int i2, int i3) {
        synchronized (this.object) {
            try {
                Log.e("sabine", "-----sabineOpen:" + mIsLibLoaded + Constants.PACKNAME_END + this.mIsOpened);
                this.mIsOpened = false;
                if (mIsLibLoaded) {
    ...
    public void sabineReset() {
        synchronized (this.object) {
            try {
                Log.e("sabine", "-----sabineReset:" + mIsLibLoaded + Constants.PACKNAME_END + this.mIsOpened);
                if (mIsLibLoaded && this.mIsOpened) {
                    sabineeffectreset();
                }
            } catch (Throwable th) {
    ...
    public void sabineSet(int i, int i2, float f) {
        synchronized (this.object) {
            try {
                Log.e("sabine", "-----sabineSet:" + mIsLibLoaded + Constants.PACKNAME_END + this.mIsOpened);
                if (mIsLibLoaded && this.mIsOpened) {
