...
public class MMRtcEngineImpl extends MMRtcEngine implements IAudioEffectManager {
    ...
    private void registerReceiver(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        jj5.m145018l(this.mContext, broadcastReceiver, intentFilter);
    }
                ...
                if (this.mEngine != 0) {
                    ...
                    try {
                        ...
                        for (MMLiveTranscoding.MMLiveTranscodingUser mMLiveTranscodingUser : mMLiveTranscoding.getTranscodingUserMap().values()) {
                            ...
                            jSONObject3.put(BaseSei.f14624X, mMLiveTranscodingUser.posx);
                            jSONObject3.put(BaseSei.f14625Y, mMLiveTranscodingUser.posy);
