...
public class HeadSetReceiver extends BroadcastReceiver {
    ...
    private static AudioManager.OnAudioFocusChangeListener mAudioFocusListener = new AudioManager.OnAudioFocusChangeListener() { // from class: l.wzk
        @Override // android.media.AudioManager.OnAudioFocusChangeListener
        public final void onAudioFocusChange(int i) {
            HeadSetReceiver.m20644a(i);
        }
    };
    ...
    public static /* synthetic */ void m20644a(int i) {
    }
    ...
    public static boolean hasBluetoothHeadset() {
        return jj5.m145010d(BluetoothAdapter.getDefaultAdapter(), 1) == 2;
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (bluetoothAdapter == null || !bluetoothAdapter.isEnabled()) {
            ...
            int iM145010d = jj5.m145010d(this.mBluetoothAdapter, 1);
            jj5.m145010d(this.mBluetoothAdapter, 2);
            if (iM145010d == 2 || iM145010d == 1) {
                mBlueHeadSet = true;
                if (audioManager != null) {
                    audioManager.setSpeakerphoneOn(false);
                    if (isVoip) {
