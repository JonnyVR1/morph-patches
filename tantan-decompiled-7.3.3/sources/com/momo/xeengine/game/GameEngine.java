...
public final class GameEngine extends XEEngineInstanceJava implements IXEngine {
    ...
    public static /* synthetic */ void m21227a(GameEngine gameEngine, boolean z) {
    ...
    public static /* synthetic */ void m21228b(GameEngine gameEngine, DataEvent dataEvent) {
        long j = gameEngine.engineIns;
        if (j != 0) {
    ...
    public static /* synthetic */ void m21229c(GameEngine gameEngine, String str) {
        long j = gameEngine.engineIns;
        if (j != 0) {
    ...
    public static /* synthetic */ void m21230d(GameEngine gameEngine, IXAudioPlayer iXAudioPlayer) {
        long j = gameEngine.engineIns;
        if (j != 0) {
    ...
    public void addLibraryPath(@NotNull final String str) {
        ...
        this.renderThreadExecutor.execute(new Runnable() { // from class: l.wkj
            @Override // java.lang.Runnable
            public final void run() {
                this.f189554a.nativeAddLibraryPath(str);
            }
        });
    }
    ...
    public void removeLibraryPath(@NotNull final String str) {
        ...
        this.renderThreadExecutor.execute(new Runnable() { // from class: l.ukj
            @Override // java.lang.Runnable
            public final void run() {
                GameEngine.m21229c(this.f179416a, str);
            }
        });
    }
    ...
    public void sendEvent(@NotNull XEvent xEvent) {
        if (xEvent != null && (xEvent instanceof DataEvent)) {
            ...
            this.renderThreadExecutor.execute(new Runnable() { // from class: l.skj
                @Override // java.lang.Runnable
                public final void run() {
                    GameEngine.m21228b(this.f169290a, dataEvent);
                }
            });
        }
    }
    ...
    public void setUserAudioPlayer(@NotNull final IXAudioPlayer iXAudioPlayer) {
        ...
        this.renderThreadExecutor.execute(new Runnable() { // from class: l.vkj
            @Override // java.lang.Runnable
            public final void run() {
                GameEngine.m21230d(this.f184489a, iXAudioPlayer);
            }
        });
    }
    ...
    public void showDebugInfo(final boolean z) {
        this.renderThreadExecutor.execute(new Runnable() { // from class: l.tkj
            @Override // java.lang.Runnable
            public final void run() {
                GameEngine.m21227a(this.f174717a, z);
            }
        });
    }
