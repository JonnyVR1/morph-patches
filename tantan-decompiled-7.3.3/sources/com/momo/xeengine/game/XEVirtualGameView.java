...
public class XEVirtualGameView {
    ...
    public final class MyRender implements IXRender {
        ...
        public boolean onGLDrawFrame(EGL10 egl10) {
            ...
            if (zRender && XEVirtualGameView.this.preferredFramesPerSecond != XEVirtualGameView.FRAME_NO_LIMIT && gameEngine.getRenderMode() == GameEngine.RenderMode.Auto) {
                ...
                long j = 1000 / XEVirtualGameView.this.preferredFramesPerSecond;
    ...
    public static /* synthetic */ void m21237a(XEVirtualGameView xEVirtualGameView) {
    ...
    public static /* synthetic */ void m21238b(XEVirtualGameView xEVirtualGameView) {
        GameEngine gameEngine;
        MyRender myRender = xEVirtualGameView.mRender;
        if (myRender == null || (gameEngine = myRender.engine) == null) {
            return;
    ...
    public void pause() {
        ...
        XEngineRenderThread xEngineRenderThread = this.mGLThread;
        if (xEngineRenderThread != null) {
            xEngineRenderThread.queueEvent(new Runnable() { // from class: l.xlq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEVirtualGameView.m21237a(this.f195012a);
                }
            });
        }
    }
    ...
    public void resume() {
        ...
        XEngineRenderThread xEngineRenderThread = this.mGLThread;
        if (xEngineRenderThread != null) {
            xEngineRenderThread.queueEvent(new Runnable() { // from class: l.ylq0
                @Override // java.lang.Runnable
                public final void run() {
                    XEVirtualGameView.m21238b(this.f200579a);
                }
            });
        }
    }
