...
class GiftLogUploader {
    ...
    public static /* synthetic */ void m21242a(GiftLogUploader giftLogUploader, List list) {
    ...
    public static /* synthetic */ void m21243b(GiftLogUploader giftLogUploader) {
                        ...
                        if (this.eventQueue.isEmpty() && !this.hasTimer) {
                            ...
                            this.mainHandler.postDelayed(new Runnable() { // from class: com.momo.xeengine.gift.a
                                ...
                                public final void run() {
                                    GiftLogUploader.m21243b(this.f15308a);
                                }
        ...
        synchronized (this.lock) {
            try {
                ...
                this.executorService.execute(new Runnable() { // from class: com.momo.xeengine.gift.b
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftLogUploader.m21242a(this.f15309a, arrayList);
                    }
                });
            } catch (Throwable th) {
                throw th;
