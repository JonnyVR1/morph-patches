...
public final class GiftPlayer implements IGiftPlayer {
    ...
    private final GameDelegate gameDelegate = new C43411();
    private final XEGameViewCallback gameViewCallback = new C43422();
    ...
    public class C43411 implements GameDelegate {
        public C43411() {
        }

        /* JADX INFO: renamed from: a */
        public static /* synthetic */ void m21248a(C43411 c43411, String str) {
            GiftPlayer.this.giftView.stop();
            GiftPlayer.this.callPlayFinished(str);
        }

        /* JADX INFO: renamed from: b */
        public static /* synthetic */ void m21249b(C43411 c43411) {
        ...
        public static /* synthetic */ void m21250c(C43411 c43411, String str, GiftPlayerEventListener giftPlayerEventListener) {
            c43411.getClass();
            giftPlayerEventListener.onReceiveEvent(GiftPlayer.this, new GiftPlayerEvent(GiftPlayerEvent.EventType.Goto, str));
        }

        /* JADX INFO: renamed from: d */
        public static /* synthetic */ void m21251d(C43411 c43411, int i, String str) {
            c43411.getClass();
        ...
        public static /* synthetic */ void m21252e(C43411 c43411, GiftProgress giftProgress) {
            if (GiftPlayer.this.progressListener == null || GiftPlayer.this.giftPlayData == null) {
                return;
            }
            VideoGiftProgressListener videoGiftProgressListener = GiftPlayer.this.progressListener;
        ...
        public static /* synthetic */ void m21253f(C43411 c43411, String str) {
            String string;
        ...
        public static /* synthetic */ void m21254g(C43411 c43411, String str) {
        ...
        public static /* synthetic */ void m21255h(C43411 c43411, String str) {
            GiftPlayer.this.virtualGiftView.stop();
            GiftPlayer.this.callPlayFinished(str);
        }

        /* JADX INFO: renamed from: i */
        public static /* synthetic */ void m21256i(C43411 c43411) {
            if (GiftPlayer.this.progressListener == null || GiftPlayer.this.giftPlayData == null) {
                return;
            }
            VideoGiftProgressListener videoGiftProgressListener = GiftPlayer.this.progressListener;
        ...
        public void onGameError(final String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.k
                ...
                public final void run() {
                    GiftPlayer.C43411.m21253f(this.f15332a, str);
                }
            });
        }
        ...
        public void onGameFinished(final String str) {
            ...
            if (z) {
                giftPlayer.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.g
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftPlayer.C43411.m21255h(this.f15326a, str);
                    }
                });
            } else {
                giftPlayer.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.h
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftPlayer.C43411.m21248a(this.f15328a, str);
                    }
                });
            }
        }
        ...
        public String onGotoEvent(final String str) {
            ...
            if (giftPlayerEventListener != null && !TextUtils.isEmpty(str)) {
                GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.m
                    @Override // java.lang.Runnable
                    public final void run() {
                        GiftPlayer.C43411.m21250c(this.f15336a, str, giftPlayerEventListener);
                    }
                });
            }
            return null;
            ...
            try {
                ...
                if (GiftPlayer.this.eventListener != null) {
                    GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.f
                        @Override // java.lang.Runnable
                        public final void run() {
                            GiftPlayer.C43411.m21251d(this.f15323a, iOptInt, strOptString);
                        }
                    });
                }
            } catch (JSONException unused) {
        ...
        public String onVideoProgress(String str) {
            ...
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.l
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C43411.m21252e(this.f15334a, giftProgressFromJson);
                }
            });
            return null;
        }
        ...
        public String onVideoStart(String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.j
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C43411.m21256i(this.f15331a);
                }
            });
            return null;
        }
        ...
        public String onVideoStop(String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.i
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C43411.m21249b(this.f15330a);
                }
            });
            return null;
        }
        ...
        public String setValidTouchAreas(final String str) {
            GiftPlayer.this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.e
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.C43411.m21254g(this.f15321a, str);
                }
            });
            return null;
        }
    ...
    public class C43422 implements XEGameViewCallback {
        public C43422() {
        }
    ...
    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m21244a(GiftPlayer giftPlayer, Set set, Map map, boolean z, GiftPlayData giftPlayData, boolean z2) {
    ...
    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m21245b(GiftPlayer giftPlayer, GiftPlayerListener giftPlayerListener, GiftPlayData giftPlayData, int i, String str) {
        giftPlayer.getClass();
        giftPlayerListener.onGiftPlayFailed(giftPlayer, giftPlayData.getGiftEntity(), i, str);
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ void m21246c(String str, JSONObject jSONObject, String str2, ScriptBridge scriptBridge, boolean z) {
        if (z) {
            try {
    ...
    public void callDelegatePlayFailed(final int i, final String str) {
        ...
        if (giftPlayerListener != null) {
            this.handler.post(new Runnable() { // from class: com.momo.xeengine.gift.c
                @Override // java.lang.Runnable
                public final void run() {
                    GiftPlayer.m21245b(this.f15311a, giftPlayerListener, giftPlayData, i, str);
                }
            });
        }
    }
        ...
        if (!hashSet.isEmpty()) {
            this.resourceChecker.downloadResources(new ArrayList(hashSet), new ResourceChecker.ResourceDownloadCompletion() { // from class: com.momo.xeengine.gift.d
                ...
                public final void onComplete(boolean z2) {
                    GiftPlayer.m21244a(this.f15316a, hashSet, map, z, giftPlayData, z2);
                }
            });
        } else if (z) {
    ...
    private void playEngineGift() {
        ...
        Runnable runnable = new Runnable() { // from class: l.rwj
            @Override // java.lang.Runnable
            public final void run() {
                this.f165143a.onEngineStartTimeout();
            }
        };
    ...
    public void updateExtendValue(final String str, final String str2) {
        ...
        if (new File(GiftUtils.getResourcePathWithURL(str2)).exists()) {
            ...
            arrayList.add(str2);
            this.resourceChecker.downloadResources(arrayList, new ResourceChecker.ResourceDownloadCompletion() { // from class: l.qwj
                @Override // com.momo.xeengine.gift.ResourceChecker.ResourceDownloadCompletion
                public final void onComplete(boolean z) {
                    GiftPlayer.m21246c(str2, jSONObject, str, scriptBridge, z);
                }
            });
        }
    }
