...
public final class LuaScriptBridge implements ScriptBridge {
    ...
    public static /* synthetic */ void m21294a(LuaScriptBridge luaScriptBridge, String str, String str2, String str3) {
    ...
    private String callFormScript(String str, String str2, String str3) throws ScriptException {
        ...
        try {
            ...
            ghw.m130263a("no method ", str2, str);
            return null;
        } catch (Throwable unused2) {
            ghw.m130263a("error to call method ", str2, str);
            return null;
        }
    }
    ...
    public String call(final String str, final String str2, final String str3) {
        ...
        this.executor.execute(new Runnable() { // from class: l.hhw
            @Override // java.lang.Runnable
            public final void run() {
                LuaScriptBridge.m21294a(this.f109940a, str, str2, str3);
            }
        });
        return null;
    }
