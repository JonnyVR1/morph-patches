...
public class XHttpManager {
    ...
    public static /* synthetic */ void m21300a(XHttpManager xHttpManager, String str, long j, String str2, Map map, byte[] bArr, long j2) {
    ...
    public long asyncRequest(final String str, final String str2, final Map<String, String> map, final byte[] bArr, final long j) {
        ...
        Thread thread = new Thread(new Runnable() { // from class: l.zlq0
            @Override // java.lang.Runnable
            public final void run() {
                XHttpManager.m21300a(this.f204994a, str, j2, str2, map, bArr, j);
            }
        });
