...
@Metadata(m88119bv = {1, 0, 3}, m88120d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u0006J \u0010\u000b\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u00062\u0006\u0010\r\u001a\u00020\u00032\u0006\u0010\u000e\u001a\u00020\u000fH\u0002R\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m88121d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAPath;", "", "originValue", "", "(Ljava/lang/String;)V", "cachedPath", "Landroid/graphics/Path;", "replacedValue", "buildPath", "", "toPath", "operate", "finalPath", FirebaseAnalytics.Param.METHOD, "args", "Ljava/util/StringTokenizer;", "gift_player_release"}, m88122k = 1, m88123mv = {1, 1, 15})
public final class SVGAPath {
    ...
    public SVGAPath(@NotNull String str) {
        str.getClass();
        if (StringsKt.m94303P(str, Constants.SEPARATOR_COMMA, false, 2, null)) {
            str = C15493d.m94370F(str, Constants.SEPARATOR_COMMA, MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, false, 4, null);
        }
    ...
    private final void operate(Path finalPath, String method, StringTokenizer args) {
        ...
        if (!Intrinsics.m88377d(method, "M")) {
            if (Intrinsics.m88377d(method, "m")) {
                finalPath.rMoveTo(f8, f9);
                sVGAPoint = new SVGAPoint(sVGAPoint2.getX() + f8, sVGAPoint2.getY() + f9, 0.0f);
            }
            if (Intrinsics.m88377d(method, "L")) {
                finalPath.lineTo(f8, f9);
            } else if (Intrinsics.m88377d(method, BLiveStormDanmakuGiftResourceType.f45292l)) {
                finalPath.rLineTo(f8, f9);
            }
            if (Intrinsics.m88377d(method, c4s.C_ZONE)) {
                finalPath.cubicTo(f8, f9, f10, f11, f12, f7);
            } else {
                f = f7;
                if (Intrinsics.m88377d(method, "c")) {
                    finalPath.rCubicTo(f8, f9, f10, f11, f12, f);
                }
            }
            if (Intrinsics.m88377d(method, "Q")) {
                finalPath.quadTo(f8, f9, f10, f11);
            } else if (Intrinsics.m88377d(method, "q")) {
                finalPath.rQuadTo(f8, f9, f10, f11);
            }
            if (Intrinsics.m88377d(method, "H")) {
                finalPath.lineTo(f8, sVGAPoint.getY());
            } else if (Intrinsics.m88377d(method, "h")) {
                finalPath.rLineTo(f8, 0.0f);
            }
            if (Intrinsics.m88377d(method, p7f.GPS_MEASUREMENT_INTERRUPTED)) {
                finalPath.lineTo(sVGAPoint.getX(), f8);
            } else if (Intrinsics.m88377d(method, ResourceDirection.f39656v)) {
                finalPath.rLineTo(0.0f, f8);
            }
            if (Intrinsics.m88377d(method, "Z")) {
                finalPath.close();
            } else if (Intrinsics.m88377d(method, BaseSei.f14626Z)) {
                finalPath.close();
            }
        }
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.length() != 0) {
                if (SVGAPathKt.VALID_METHODS.contains(strNextToken)) {
                    if (Intrinsics.m88377d(strNextToken, "Z") || Intrinsics.m88377d(strNextToken, BaseSei.f14626Z)) {
