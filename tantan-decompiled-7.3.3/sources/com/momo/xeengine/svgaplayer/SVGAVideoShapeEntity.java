...
import com.momo.xeengine.svgaplayer.proto.ShapeEntity;
import com.momo.xeengine.svgaplayer.proto.Transform;
...
@Metadata(m88119bv = {1, 0, 3}, m88120d1 = {"\u0000Z\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001:\u0002+,B\u000f\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0006\u0010 \u001a\u00020!J\u0018\u0010\"\u001a\u00020#2\u0006\u0010$\u001a\u00020%2\u0006\u0010&\u001a\u00020#H\u0002J\u0010\u0010'\u001a\u00020!2\u0006\u0010\u0002\u001a\u00020\u0003H\u0002J\u0010\u0010(\u001a\u00020!2\u0006\u0010\u0002\u001a\u00020\u0003H\u0002J\u0010\u0010)\u001a\u00020!2\u0006\u0010\u0002\u001a\u00020\u0003H\u0002J\u0010\u0010*\u001a\u00020!2\u0006\u0010\u0002\u001a\u00020\u0003H\u0002R:\u0010\b\u001a\u0010\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u0001\u0018\u00010\u00062\u0014\u0010\u0005\u001a\u0010\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u0001\u0018\u00010\u0006@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u000b\u001a\u00020\f8F¢\u0006\u0006\u001a\u0004\b\u000b\u0010\rR\u001c\u0010\u000e\u001a\u0004\u0018\u00010\u000fX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013R\"\u0010\u0015\u001a\u0004\u0018\u00010\u00142\b\u0010\u0005\u001a\u0004\u0018\u00010\u0014@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u0016\u0010\u0017R\"\u0010\u0019\u001a\u0004\u0018\u00010\u00182\b\u0010\u0005\u001a\u0004\u0018\u00010\u0018@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u001a\u0010\u001bR\u001e\u0010\u001d\u001a\u00020\u001c2\u0006\u0010\u0005\u001a\u00020\u001c@BX\u0086\u000e¢\u0006\b\n\u0000\u001a\u0004\b\u001e\u0010\u001f¨\u0006-"}, m88121d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity;", "", "obj", "Lcom/momo/xeengine/svgaplayer/proto/ShapeEntity;", "(Lcom/momo/xeengine/svgaplayer/proto/ShapeEntity;)V", "<set-?>", "", "", "args", "getArgs", "()Ljava/util/Map;", "isKeep", "", "()Z", "shapePath", "Landroid/graphics/Path;", "getShapePath", "()Landroid/graphics/Path;", "setShapePath", "(Landroid/graphics/Path;)V", "Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Styles;", "styles", "getStyles", "()Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Styles;", "Landroid/graphics/Matrix;", "transform", "getTransform", "()Landroid/graphics/Matrix;", "Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Type;", "type", "getType", "()Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Type;", "buildPath", "", "dip2px", "", "context", "Landroid/content/Context;", "dpvalue", "parseArgs", "parseStyles", "parseTransform", "parseType", "Styles", "Type", "gift_player_release"}, m88122k = 1, m88123mv = {1, 1, 15})
public final class SVGAVideoShapeEntity {
    ...
    @Metadata(m88119bv = {1, 0, 3}, m88120d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010\u0014\n\u0002\b\u000e\n\u0002\u0010\u0007\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002R$\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0004@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\tR$\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0003\u001a\u00020\n@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR$\u0010\u0011\u001a\u00020\u00102\u0006\u0010\u0003\u001a\u00020\u0010@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0014\u0010\u0015R$\u0010\u0016\u001a\u00020\n2\u0006\u0010\u0003\u001a\u00020\n@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0017\u0010\r\"\u0004\b\u0018\u0010\u000fR$\u0010\u0019\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0004@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u001a\u0010\u0007\"\u0004\b\u001b\u0010\tR$\u0010\u001c\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0004@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u001d\u0010\u0007\"\u0004\b\u001e\u0010\tR$\u0010 \u001a\u00020\u001f2\u0006\u0010\u0003\u001a\u00020\u001f@@X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$¨\u0006%"}, m88121d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Styles;", "", "()V", "<set-?>", "", "fill", "getFill", "()I", "setFill$gift_player_release", "(I)V", "", "lineCap", "getLineCap", "()Ljava/lang/String;", "setLineCap$gift_player_release", "(Ljava/lang/String;)V", "", "lineDash", "getLineDash", "()[F", "setLineDash$gift_player_release", "([F)V", "lineJoin", "getLineJoin", "setLineJoin$gift_player_release", "miterLimit", "getMiterLimit", "setMiterLimit$gift_player_release", "stroke", "getStroke", "setStroke$gift_player_release", "", "strokeWidth", "getStrokeWidth", "()F", "setStrokeWidth$gift_player_release", "(F)V", "gift_player_release"}, m88122k = 1, m88123mv = {1, 1, 15})
    public static final class Styles {
        ...
        public final void setFill$gift_player_release(int i) {
            this.fill = i;
        }

        public final void setLineCap$gift_player_release(@NotNull String str) {
            str.getClass();
            this.lineCap = str;
        }

        public final void setLineDash$gift_player_release(@NotNull float[] fArr) {
            fArr.getClass();
            this.lineDash = fArr;
        }

        public final void setLineJoin$gift_player_release(@NotNull String str) {
            str.getClass();
            this.lineJoin = str;
        }

        public final void setMiterLimit$gift_player_release(int i) {
            this.miterLimit = i;
        }

        public final void setStroke$gift_player_release(int i) {
            this.stroke = i;
        }

        public final void setStrokeWidth$gift_player_release(float f) {
            this.strokeWidth = f;
        }
    }

    @Metadata(m88119bv = {1, 0, 3}, m88120d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m88121d2 = {"Lcom/momo/xeengine/svgaplayer/SVGAVideoShapeEntity$Type;", "", "(Ljava/lang/String;I)V", "shape", "rect", "ellipse", "keep", "gift_player_release"}, m88122k = 1, m88123mv = {1, 1, 15})
    public enum Type {
        shape,
        rect,
        ellipse,
    ...
    @Metadata(m88119bv = {1, 0, 3}, m88122k = 3, m88123mv = {1, 1, 15})
    ...
    private final void parseArgs(ShapeEntity obj) {
        ...
        if (shapeArgs != null && (str = shapeArgs.f15443d) != null) {
            map.put(Constants.INAPP_DATA_TAG, str);
        }
        ShapeEntity.EllipseArgs ellipseArgs = obj.ellipse;
        if (ellipseArgs != null) {
            Float f = ellipseArgs.f15435x;
            if (f == null) {
                f = fValueOf;
            }
            map.put(BaseSei.f14624X, f);
            Float f2 = ellipseArgs.f15436y;
            if (f2 == null) {
                f2 = fValueOf;
            }
            map.put(BaseSei.f14625Y, f2);
        ...
        if (rectArgs != null) {
            Float f5 = rectArgs.f15439x;
            if (f5 == null) {
                f5 = fValueOf;
            }
            map.put(BaseSei.f14624X, f5);
            Float f6 = rectArgs.f15440y;
            if (f6 == null) {
                f6 = fValueOf;
            }
            map.put(BaseSei.f14625Y, f6);
    ...
    private final void parseStyles(ShapeEntity obj) {
        ...
        if (shapeStyle != null) {
            ...
            if (rGBAColor != null) {
                Float f = rGBAColor.f15445a;
                int iFloatValue = (int) ((f != null ? f.floatValue() : 0.0f) * 255.0f);
                Float f2 = rGBAColor.f15448r;
                int iFloatValue2 = (int) ((f2 != null ? f2.floatValue() : 0.0f) * 255.0f);
                Float f3 = rGBAColor.f15447g;
                int iFloatValue3 = (int) ((f3 != null ? f3.floatValue() : 0.0f) * 255.0f);
                Float f4 = rGBAColor.f15446b;
                styles.setFill$gift_player_release(Color.argb(iFloatValue, iFloatValue2, iFloatValue3, (int) ((f4 != null ? f4.floatValue() : 0.0f) * 255.0f)));
            }
            ShapeEntity.ShapeStyle.RGBAColor rGBAColor2 = shapeStyle.stroke;
            if (rGBAColor2 != null) {
                Float f5 = rGBAColor2.f15445a;
                int iFloatValue4 = (int) ((f5 != null ? f5.floatValue() : 0.0f) * 255.0f);
                Float f6 = rGBAColor2.f15448r;
                int iFloatValue5 = (int) ((f6 != null ? f6.floatValue() : 0.0f) * 255.0f);
                Float f7 = rGBAColor2.f15447g;
                int iFloatValue6 = (int) ((f7 != null ? f7.floatValue() : 0.0f) * 255.0f);
                Float f8 = rGBAColor2.f15446b;
                styles.setStroke$gift_player_release(Color.argb(iFloatValue4, iFloatValue5, iFloatValue6, (int) ((f8 != null ? f8.floatValue() : 0.0f) * 255.0f)));
            }
            Float f9 = shapeStyle.strokeWidth;
            float fFloatValue = f9 != null ? f9.floatValue() : 0.0f;
            Context context = XEnginePreferences.getContext();
            if (context != null) {
                fFloatValue = dip2px(context, fFloatValue / 2.0f);
            }
            styles.setStrokeWidth$gift_player_release(fFloatValue);
            ShapeEntity.ShapeStyle.LineCap lineCap = shapeStyle.lineCap;
            if (lineCap != null) {
                int i = WhenMappings.$EnumSwitchMapping$1[lineCap.ordinal()];
                if (i == 1) {
                    styles.setLineCap$gift_player_release("butt");
                } else if (i == 2) {
                    styles.setLineCap$gift_player_release("round");
                } else if (i == 3) {
                    styles.setLineCap$gift_player_release(Square.TYPE);
                }
            }
            ...
            if (lineJoin != null) {
                ...
                if (i2 == 1) {
                    styles.setLineJoin$gift_player_release("bevel");
                } else if (i2 == 2) {
                    styles.setLineJoin$gift_player_release("miter");
                } else if (i2 == 3) {
                    styles.setLineJoin$gift_player_release("round");
                }
            }
            Float f10 = shapeStyle.miterLimit;
            styles.setMiterLimit$gift_player_release((int) (f10 != null ? f10.floatValue() : 0.0f));
            styles.setLineDash$gift_player_release(new float[3]);
    ...
    public final void buildPath() {
        ...
        if (type == Type.shape) {
            ...
            Object obj2 = map2 != null ? map2.get(BaseSei.f14624X) : null;
            ...
            Object obj3 = map3 != null ? map3.get(BaseSei.f14625Y) : null;
            ...
            Object obj6 = map6 != null ? map6.get(BaseSei.f14624X) : null;
            ...
            Object obj7 = map7 != null ? map7.get(BaseSei.f14625Y) : null;
