...
public final class Layout extends Message<Layout, Builder> {
    ...
    public static final class Builder extends Message.Builder<Layout, Builder> {
        ...
        public Layout build() {
            return new Layout(this.f15433x, this.f15434y, this.width, this.height, super.buildUnknownFields());
        }
        ...
        /* JADX INFO: renamed from: x */
        public Builder m21315x(Float f) {
            this.f15433x = f;
            return this;
        }

        /* JADX INFO: renamed from: y */
        public Builder m21316y(Float f) {
            this.f15434y = f;
            return this;
        }
    }
    ...
    public static final class ProtoAdapter_Layout extends ProtoAdapter<Layout> {
        ...
        public Layout decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag == 1) {
                    builder.m21315x(ProtoAdapter.FLOAT.decode(protoReader));
                } else if (iNextTag == 2) {
                    builder.m21316y(ProtoAdapter.FLOAT.decode(protoReader));
                } else if (iNextTag == 3) {
    ...
    public boolean equals(Object obj) {
        ...
        return unknownFields().equals(layout.unknownFields()) && Internal.equals(this.f15431x, layout.f15431x) && Internal.equals(this.f15432y, layout.f15432y) && Internal.equals(this.width, layout.width) && Internal.equals(this.height, layout.height);
    }
    ...
    public Builder newBuilder() {
        Builder builder = new Builder();
        builder.f15433x = this.f15431x;
        builder.f15434y = this.f15432y;
    ...
    public String toString() {
        ...
        if (this.f15431x != null) {
            sb.append(", x=");
            sb.append(this.f15431x);
        }
        if (this.f15432y != null) {
            sb.append(", y=");
            sb.append(this.f15432y);
        }
        if (this.width != null) {
            sb.append(", width=");
