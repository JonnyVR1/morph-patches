...
public class ConfigResponse {
    ...
    private int f15283ec = -1;

    /* JADX INFO: renamed from: em */
    private String f15284em = "操作成功";
    ...
    public static ConfigResponse fromJson(JSONObject jSONObject) {
        ...
        configResponse.f15283ec = jSONObject.optInt("ec", -1);
        configResponse.f15284em = jSONObject.optString("em", "");
    ...
    public int getEc() {
        return this.f15283ec;
    }

    public String getEm() {
        return this.f15284em;
    }
}
