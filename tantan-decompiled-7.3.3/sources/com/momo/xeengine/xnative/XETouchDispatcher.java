...
public class XETouchDispatcher extends XETouchDispatcherNative implements ITouchEventHandler {
    ...
    public static /* synthetic */ void m21344a(XETouchDispatcher xETouchDispatcher, int i, int[] iArr, float[] fArr, float[] fArr2) {
    ...
    public static /* synthetic */ void m21345b(XETouchDispatcher xETouchDispatcher, int i, int[] iArr, float[] fArr, float[] fArr2) {
        long j = xETouchDispatcher.eventDispatcherIns;
        if (j != 0) {
    ...
    public static /* synthetic */ void m21346c(XETouchDispatcher xETouchDispatcher, int i, int[] iArr, float[] fArr, float[] fArr2) {
        long j = xETouchDispatcher.eventDispatcherIns;
        if (j != 0) {
    ...
    public void handleTouchEvent(MotionEvent motionEvent, float f, float f2) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    this.executor.execute(new Runnable() { // from class: l.wlq0
                        @Override // java.lang.Runnable
                        public final void run() {
                            XETouchDispatcher.m21345b(this.f189719a, pointerCount, iArr, fArr, fArr2);
                        }
                    });
                    return;
            ...
            this.executor.execute(new Runnable() { // from class: l.vlq0
                @Override // java.lang.Runnable
                public final void run() {
                    XETouchDispatcher.m21344a(this.f184622a, pointerCount, iArr, fArr, fArr2);
                }
            });
            return;
        }
        this.executor.execute(new Runnable() { // from class: l.ulq0
            @Override // java.lang.Runnable
            public final void run() {
                XETouchDispatcher.m21346c(this.f179544a, pointerCount, iArr, fArr, fArr2);
            }
        });
    }
