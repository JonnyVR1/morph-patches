...
public class Vector4f {
    ...
    public Vector4f(Vector3f vector3f, float f) {
        ...
        this.points = fArr;
        fArr[0] = vector3f.m21301x();
        this.points[1] = vector3f.m21303y();
        this.points[2] = vector3f.m21305z();
        this.points[3] = f;
    }

    public void add(Vector3f vector3f, float f) {
        float[] fArr = this.points;
        fArr[0] = fArr[0] + vector3f.m21301x();
        float[] fArr2 = this.points;
        fArr2[1] = fArr2[1] + vector3f.m21303y();
        float[] fArr3 = this.points;
        fArr3[2] = fArr3[2] + vector3f.m21305z();
    ...
    public void copyFromV3f(Vector3f vector3f, float f) {
        this.points[0] = vector3f.m21301x();
        this.points[1] = vector3f.m21303y();
        this.points[2] = vector3f.m21305z();
        this.points[3] = f;
    }
    ...
    public float m21307w() {
        return this.points[3];
    }

    /* JADX INFO: renamed from: x */
    public float m21309x() {
        return this.points[0];
    }

    /* JADX INFO: renamed from: y */
    public float m21311y() {
        return this.points[1];
    }

    /* JADX INFO: renamed from: z */
    public float m21313z() {
        return this.points[2];
    }

    /* JADX INFO: renamed from: w */
    public void m21308w(float f) {
        this.points[3] = f;
    }

    /* JADX INFO: renamed from: x */
    public void m21310x(float f) {
        this.points[0] = f;
    }

    /* JADX INFO: renamed from: y */
    public void m21312y(float f) {
        this.points[1] = f;
    }

    /* JADX INFO: renamed from: z */
    public void m21314z(float f) {
        this.points[2] = f;
    }
