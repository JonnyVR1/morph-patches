...
public final class XInputActivity extends Activity implements TextWatcher, View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(fec0.f98654a);
        getWindow().addFlags(AudioRoutingController.DEVICE_OUT_USB_HEADSET);
        View viewFindViewById = findViewById(ucc0.f178420a);
        this.editText = (EditText) findViewById(ucc0.f178422c);
        this.submitBtn = (Button) findViewById(ucc0.f178421b);
