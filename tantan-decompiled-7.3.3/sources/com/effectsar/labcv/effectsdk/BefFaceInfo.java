...
public class BefFaceInfo {
    ...
    public static class Face106 {
        ...
        public String toString() {
            return "Face106{rect=" + this.rect + ", score=" + this.score + ", points_array=" + Arrays.toString(this.points_array) + ", visibility_array=" + Arrays.toString(this.visibility_array) + ", yaw=" + this.yaw + ", pitch=" + this.pitch + ", roll=" + this.roll + ", eye_dist=" + this.eye_dist + ", action=" + this.action + ", ID=" + this.f5858ID + '}';
        }
    }
    ...
    public static class FacePoint {
        ...
        public PointF asPoint() {
            return new PointF(this.f5860x, this.f5861y);
        }
        ...
        public String toString() {
            return "FacePoint{x=" + this.f5860x + ", y=" + this.f5861y + '}';
        }
    }
