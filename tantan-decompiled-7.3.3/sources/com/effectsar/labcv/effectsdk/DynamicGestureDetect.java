...
public class DynamicGestureDetect {
    ...
    private native int nativeDetect(ByteBuffer byteBuffer, int i, int i2, int i3, int i4, int i5, BefDynamicGestureInfo befDynamicGestureInfo);
    ...
    public BefDynamicGestureInfo detect(ByteBuffer byteBuffer, EffectsSDKEffectConstants.PixlFormat pixlFormat, int i, int i2, int i3, EffectsSDKEffectConstants.Rotation rotation) {
        if (!this.mInited) {
            return null;
        }
        BefDynamicGestureInfo befDynamicGestureInfo = new BefDynamicGestureInfo();
        int iNativeDetect = nativeDetect(byteBuffer, pixlFormat.getValue(), i, i2, i3, rotation.f5890id, befDynamicGestureInfo);
        if (iNativeDetect == 0) {
    ...
    public int setParamF(EffectsSDKEffectConstants.DynamicGestureParamType dynamicGestureParamType, float f) {
        if (this.mInited) {
            return nativeSetParamF(dynamicGestureParamType.getValue(), f);
        }
        return -1;
    }

    public int setParamI(EffectsSDKEffectConstants.DynamicGestureParamType dynamicGestureParamType, int i) {
        if (this.mInited) {
            return nativeSetParamI(dynamicGestureParamType.getValue(), i);
        }
        return -1;
    }
