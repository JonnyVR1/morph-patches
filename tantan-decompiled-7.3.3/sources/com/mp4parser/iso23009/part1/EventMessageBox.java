...
public class EventMessageBox extends AbstractFullBox {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.schemeIdUri = y0q.m213891g(byteBuffer);
        this.value = y0q.m213891g(byteBuffer);
        this.timescale = y0q.m213895k(byteBuffer);
        this.presentationTimeDelta = y0q.m213895k(byteBuffer);
        this.eventDuration = y0q.m213895k(byteBuffer);
        this.f15528id = y0q.m213895k(byteBuffer);
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        b1q.m101499k(byteBuffer, this.schemeIdUri);
        b1q.m101499k(byteBuffer, this.value);
        b1q.m101495g(byteBuffer, this.timescale);
        b1q.m101495g(byteBuffer, this.presentationTimeDelta);
        b1q.m101495g(byteBuffer, this.eventDuration);
        b1q.m101495g(byteBuffer, this.f15528id);
        byteBuffer.put(this.messageData);
    }

    @Override // com.googlecode.mp4parser.AbstractBox
    public long getContentSize() {
        return slk0.m186594c(this.schemeIdUri) + 22 + slk0.m186594c(this.value) + this.messageData.length;
    }
    ...
    public void setMessageData(byte[] bArr) {
        f3d0.m123722b().m123723c(Factory.makeJP(ajc$tjp_13, this, this, bArr));
        this.messageData = bArr;
    }
