...
public class PriotityRangeBox extends AbstractBox {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.reserved1 = (iM213898n & 192) >> 6;
        this.min_priorityId = iM213898n & 63;
        int iM213898n2 = y0q.m213898n(byteBuffer);
        this.reserved2 = (iM213898n2 & 192) >> 6;
        this.max_priorityId = iM213898n2 & 63;
    }

    @Override // com.googlecode.mp4parser.AbstractBox
    public void getContent(ByteBuffer byteBuffer) {
        b1q.m101498j(byteBuffer, (this.reserved1 << 6) + this.min_priorityId);
        b1q.m101498j(byteBuffer, (this.reserved2 << 6) + this.max_priorityId);
    }
