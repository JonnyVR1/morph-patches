...
public abstract class ProtoAdapter<E> {
    ...
    private ProtoAdapter<List<E>> createPacked() {
        ...
        wg3.m206174a("Unable to pack a length-delimited type.");
        return null;
    }
    ...
    public static final class MapProtoAdapter<K, V> extends ProtoAdapter<Map<K, V>> {
        ...
        public Map<K, V> decode(ProtoReader protoReader) throws IOException {
            ...
            if (kDecode == null) {
                wtq0.m207906a("Map entry with null key");
                return null;
            }
            if (vDecode != null) {
                return Collections.singletonMap(kDecode, vDecode);
            }
            wtq0.m207906a("Map entry with null value");
            return null;
        }
    ...
    public static ProtoAdapter<?> get(String str) {
        try {
            ...
            d7b0.m114716a("failed to access ", str, e);
            return null;
        }
    }
}
