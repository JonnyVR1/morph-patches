...
public final class ProtoReader {
    ...
    private int internalReadVarint32() throws IOException {
        ...
        if (b5 < 0) {
            ...
            e7b0.m119688a("Malformed VARINT");
            return 0;
        }
        return i5;
    }
    ...
    private void skipGroup(int i) throws IOException {
        while (this.pos < this.limit && !this.source.exhausted()) {
            ...
            if (iInternalReadVarint32 == 0) {
                e7b0.m119688a("Unexpected tag 0");
                return;
            }
            ...
            if (i3 == 0) {
                ...
                e7b0.m119688a("Unexpected end group");
                return;
            } else if (i3 != 5) {
                f7b0.m124433a("Unexpected field encoding: ", i3);
                return;
            } else {
                this.state = 5;
                readFixed32();
    ...
    public long beginMessage() throws IOException {
        if (this.state != 2) {
            wtq0.m207906a("Unexpected call to beginMessage()");
            return 0L;
        }
        int i = this.recursionDepth + 1;
        this.recursionDepth = i;
        if (i > 65) {
            zpg0.m220844a("Wire recursion limit exceeded");
            return 0L;
        }
    ...
    public void endMessage(long j) throws IOException {
        if (this.state != 6) {
            wtq0.m207906a("Unexpected call to endMessage()");
            return;
        }
        int i = this.recursionDepth - 1;
        this.recursionDepth = i;
        if (i < 0 || this.pushedLimit != -1) {
            wtq0.m207906a("No corresponding call to beginMessage()");
            return;
        }
    ...
    public int nextTag() throws IOException {
        ...
        if (i != 6) {
            wtq0.m207906a("Unexpected call to nextTag()");
            return 0;
        }
        while (this.pos < this.limit && !this.source.exhausted()) {
            int iInternalReadVarint32 = internalReadVarint32();
            ...
            if (i3 == 2) {
                ...
                if (iInternalReadVarint33 < 0) {
                    f7b0.m124433a("Negative length: ", iInternalReadVarint33);
                    return 0;
                }
    ...
    public long readVarint64() throws IOException {
        ...
        e7b0.m119688a("WireInput encountered a malformed varint");
        return 0L;
    }
    ...
    public void skip() throws IOException {
        ...
        if (i == 2) {
            ...
            wtq0.m207906a("Unexpected call to skip()");
        }
    }
}
