...
@DebugMetadata(m88262c = "com.p1.mobile.android.media.gltransition.impl.TransitionEngineImpl$applyUriData$1$invokeSuspend$$inlined$transform$1", m88263f = "TransitionEngineImpl.kt", m88264l = {40}, m88265m = "invokeSuspend", m88266v = 1)
@SourceDebugExtension
public final class C4483xe01cfc1e extends SuspendLambda implements Function2<bui<? super u1e0>, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1<T> implements bui {
        ...
        public final /* synthetic */ bui<u1e0> f16325a;

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ TransitionEngineImpl f16326b;
        ...
        @DebugMetadata(m88262c = "com.p1.mobile.android.media.gltransition.impl.TransitionEngineImpl$applyUriData$1$invokeSuspend$$inlined$transform$1$1", m88263f = "TransitionEngineImpl.kt", m88264l = {223}, m88265m = "emit", m88266v = 1)
        @SourceDebugExtension
        public static final class C228121 extends ContinuationImpl {
            int I$0;
            Object L$0;
            Object L$1;
            Object L$2;
            ...
            public C228121(Continuation continuation) {
                super(continuation);
            }
        ...
        public AnonymousClass1(bui buiVar, TransitionEngineImpl transitionEngineImpl) {
            this.f16326b = transitionEngineImpl;
            this.f16325a = buiVar;
        }
        ...
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) throws Throwable {
            C228121 c228121;
            if (continuation instanceof C228121) {
                c228121 = (C228121) continuation;
                int i = c228121.label;
                if ((i & Integer.MIN_VALUE) != 0) {
                    c228121.label = i - Integer.MIN_VALUE;
                } else {
                    c228121 = new C228121(continuation);
                }
            } else {
                c228121 = new C228121(continuation);
            }
            Object obj = c228121.result;
            Object objM198688e = uyp.m198688e();
            int i2 = c228121.label;
            if (i2 == 0) {
                ResultKt.m88128b(obj);
                bui<u1e0> buiVar = this.f16325a;
                Uri uri = (Uri) t;
                u1e0 u1e0VarCreateScene = this.f16326b.createScene(uri);
                c228121.L$0 = SpillingKt.m88273a(t);
                c228121.L$1 = SpillingKt.m88273a(c228121);
                c228121.L$2 = SpillingKt.m88273a(uri);
                c228121.L$3 = SpillingKt.m88273a(buiVar);
                c228121.I$0 = 0;
                c228121.label = 1;
                if (buiVar.emit(u1e0VarCreateScene, c228121) == objM198688e) {
                    return objM198688e;
                }
            } else {
                if (i2 != 1) {
    ...
    public C4483xe01cfc1e(aui auiVar, Continuation continuation, TransitionEngineImpl transitionEngineImpl) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        C4483xe01cfc1e c4483xe01cfc1e = new C4483xe01cfc1e(this.$this_transform, continuation, this.this$0);
        c4483xe01cfc1e.L$0 = obj;
        return c4483xe01cfc1e;
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull bui<? super u1e0> buiVar, @Nullable Continuation<? super Unit> continuation) {
        return ((C4483xe01cfc1e) create(buiVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
