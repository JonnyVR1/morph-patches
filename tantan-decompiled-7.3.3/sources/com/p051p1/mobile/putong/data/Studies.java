...
public class Studies extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Studies> PROTOBUF_ADAPTER = new MessageNanoAdapter<Studies>() { // from class: com.p1.mobile.putong.data.Studies.1
        ...
        public int computeAndCacheSize(Studies studies) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(3, studies.active) + CodedOutputByteBufferNano.m17275b(4, studies.verified);
            ...
            if (qualificationType != null) {
                iM17275b += CodedOutputByteBufferNano.m17281h(6, qualificationType.ordinal());
            }
            QualificationType qualificationType2 = studies.qualification;
            if (qualificationType2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(7, qualificationType2, QualificationType.PROTOBUF_ADAPTER);
            }
            studies.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Studies parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    studies.major = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    studies.school = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    studies.active = nc5Var.m162483g();
                } else if (iM162497u == 32) {
                    studies.verified = nc5Var.m162483g();
                } else if (iM162497u == 42) {
                    studies.grade = nc5Var.m162495s();
                    ...
                    studies.qualification = (QualificationType) nc5Var.m162488l(QualificationType.PROTOBUF_ADAPTER);
                }
            }
            return studies;
        }
        ...
        public void serialize(Studies studies, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(3, studies.active);
            codedOutputByteBufferNano.m17299A(4, studies.verified);
            String str3 = studies.grade;
            if (str3 != null) {
            ...
            QualificationType qualificationType = studies.qualification;
            if (qualificationType != null) {
                codedOutputByteBufferNano.m17305G(6, qualificationType.ordinal());
            }
            QualificationType qualificationType2 = studies.qualification;
            if (qualificationType2 != null) {
                codedOutputByteBufferNano.m17309K(7, qualificationType2, QualificationType.PROTOBUF_ADAPTER);
            }
        }
    };
