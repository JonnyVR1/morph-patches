...
public class OmsCardLiterature extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OmsCardLiterature> PROTOBUF_ADAPTER = new MessageNanoAdapter<OmsCardLiterature>() { // from class: com.p1.mobile.putong.data.OmsCardLiterature.1
        ...
        public int computeAndCacheSize(OmsCardLiterature omsCardLiterature) {
            ...
            if (list4 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(10, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<Action> list5 = omsCardLiterature.buttons;
            if (list5 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(11, list5, Action.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = omsCardLiterature.literatureID;
            if (str7 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(12, str7);
            }
            omsCardLiterature.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OmsCardLiterature parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        omsCardLiterature.pictures = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        omsCardLiterature.color = nc5Var.m162495s();
                        continue;
                    case 26:
                        omsCardLiterature.topLeftTags = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        omsCardLiterature.icons = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        omsCardLiterature.title = nc5Var.m162495s();
                        continue;
                    case 50:
                        omsCardLiterature.guidance = nc5Var.m162495s();
                        continue;
                    case 58:
                        omsCardLiterature.introduction = nc5Var.m162495s();
                        continue;
                    case 66:
                        omsCardLiterature.name = nc5Var.m162495s();
                        continue;
                    case 74:
                        omsCardLiterature.type = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        omsCardLiterature.author = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        omsCardLiterature.buttons = (List) nc5Var.m162488l(Action.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        omsCardLiterature.literatureID = nc5Var.m162495s();
                        continue;
                    default:
                        if (omsCardLiterature.pictures == null) {
                            omsCardLiterature.pictures = new ArrayList();
        ...
        public void serialize(OmsCardLiterature omsCardLiterature, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<String> list4 = omsCardLiterature.author;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(10, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<Action> list5 = omsCardLiterature.buttons;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(11, list5, Action.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = omsCardLiterature.literatureID;
            if (str7 != null) {
    ...
    public static JsonAdapter<OmsCardLiterature> JSON_ADAPTER = new ObjectJsonAdapter<OmsCardLiterature>() { // from class: com.p1.mobile.putong.data.OmsCardLiterature.2
        ...
        public OmsCardLiterature newInstance() {
    ...
    public static /* synthetic */ String m61138a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m61140c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m61142e(String str) {
        return str;
    }
    ...
    public OmsCardLiterature mo225055clone() {
        OmsCardLiterature omsCardLiterature = new OmsCardLiterature();
        List<Media> list = this.pictures;
        if (list != null) {
            omsCardLiterature.pictures = ValueObject.util_map(list, new qcj() { // from class: l.ni50
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            omsCardLiterature.topLeftTags = ValueObject.util_map(list2, new qcj() { // from class: l.oi50
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OmsCardLiterature.m61142e((String) obj);
                }
            });
        }
        List<String> list3 = this.icons;
        if (list3 != null) {
            omsCardLiterature.icons = ValueObject.util_map(list3, new qcj() { // from class: l.pi50
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OmsCardLiterature.m61140c((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            omsCardLiterature.author = ValueObject.util_map(list4, new qcj() { // from class: l.qi50
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OmsCardLiterature.m61138a((String) obj);
                }
            });
        }
        List<Action> list5 = this.buttons;
        if (list5 != null) {
            omsCardLiterature.buttons = ValueObject.util_map(list5, new qcj() { // from class: l.ri50
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Action) obj).mo225055clone();
                }
            });
        }
