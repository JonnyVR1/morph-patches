...
public class UserBoostSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserBoostSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserBoostSettings>() { // from class: com.p1.mobile.putong.data.UserBoostSettings.1
        ...
        public int computeAndCacheSize(UserBoostSettings userBoostSettings) {
            ...
            if (l2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17283j(2, l2.longValue());
            }
            Integer num2 = userBoostSettings.multiplier;
            if (num2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(3, num2.intValue());
            }
            userBoostSettings.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserBoostSettings parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    userBoostSettings.durationSeconds = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 16) {
                    userBoostSettings.expiresTime = Long.valueOf(nc5Var.m162487k());
                } else {
                    if (iM162497u != 24) {
                        if (userBoostSettings.durationSeconds == null) {
                            userBoostSettings.durationSeconds = 0;
                    ...
                    userBoostSettings.multiplier = Integer.valueOf(nc5Var.m162486j());
                }
            }
            return userBoostSettings;
        }
    ...
    public UserBoostSettings mo225055clone() {
        UserBoostSettings userBoostSettings = new UserBoostSettings();
