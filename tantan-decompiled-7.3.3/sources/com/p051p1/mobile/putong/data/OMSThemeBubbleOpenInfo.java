...
public class OMSThemeBubbleOpenInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSThemeBubbleOpenInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSThemeBubbleOpenInfo>() { // from class: com.p1.mobile.putong.data.OMSThemeBubbleOpenInfo.1
        ...
        public int computeAndCacheSize(OMSThemeBubbleOpenInfo oMSThemeBubbleOpenInfo) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, oMSThemeBubbleOpenInfo.swipeCnt) + CodedOutputByteBufferNano.m17281h(2, oMSThemeBubbleOpenInfo.day);
            ...
            oMSThemeBubbleOpenInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSThemeBubbleOpenInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    oMSThemeBubbleOpenInfo.swipeCnt = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    oMSThemeBubbleOpenInfo.day = nc5Var.m162486j();
                } else if (iM162497u == 26) {
                    oMSThemeBubbleOpenInfo.txt = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    oMSThemeBubbleOpenInfo.color = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (oMSThemeBubbleOpenInfo.txt == null) {
                            oMSThemeBubbleOpenInfo.txt = "";
                    ...
                    oMSThemeBubbleOpenInfo.bgColor = nc5Var.m162495s();
                }
            }
            return oMSThemeBubbleOpenInfo;
        }
        ...
        public void serialize(OMSThemeBubbleOpenInfo oMSThemeBubbleOpenInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, oMSThemeBubbleOpenInfo.swipeCnt);
            codedOutputByteBufferNano.m17305G(2, oMSThemeBubbleOpenInfo.day);
            String str = oMSThemeBubbleOpenInfo.txt;
            if (str != null) {
    ...
    public OMSThemeBubbleOpenInfo mo225055clone() {
        OMSThemeBubbleOpenInfo oMSThemeBubbleOpenInfo = new OMSThemeBubbleOpenInfo();
