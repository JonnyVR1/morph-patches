...
public class UserWealthGradeConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserWealthGradeConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserWealthGradeConfig>() { // from class: com.p1.mobile.putong.data.UserWealthGradeConfig.1
        ...
        public int computeAndCacheSize(UserWealthGradeConfig userWealthGradeConfig) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(3, userWealthGradeConfig.minGradeShow) + CodedOutputByteBufferNano.m17275b(4, userWealthGradeConfig.openNewIcon);
            userWealthGradeConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserWealthGradeConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    userWealthGradeConfig.wealthIconUrl = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    userWealthGradeConfig.wealthGradeDesc = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    userWealthGradeConfig.minGradeShow = nc5Var.m162486j();
                } else {
                    if (iM162497u != 32) {
                        if (userWealthGradeConfig.wealthIconUrl == null) {
                            userWealthGradeConfig.wealthIconUrl = "";
                    ...
                    userWealthGradeConfig.openNewIcon = nc5Var.m162483g();
                }
            }
            return userWealthGradeConfig;
        }
        ...
        public void serialize(UserWealthGradeConfig userWealthGradeConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(3, userWealthGradeConfig.minGradeShow);
            codedOutputByteBufferNano.m17299A(4, userWealthGradeConfig.openNewIcon);
        }
    };
    ...
    public UserWealthGradeConfig mo225055clone() {
        UserWealthGradeConfig userWealthGradeConfig = new UserWealthGradeConfig();
