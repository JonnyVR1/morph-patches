...
public class OMSADLink extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSADLink> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSADLink>() { // from class: com.p1.mobile.putong.data.OMSADLink.1
        ...
        public int computeAndCacheSize(OMSADLink oMSADLink) {
            ...
            int iM17281h = linkAction != null ? CodedOutputByteBufferNano.m17281h(1, linkAction.ordinal()) : 0;
            ...
            if (oMSFallbackLink != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(3, oMSFallbackLink, OMSFallbackLink.PROTOBUF_ADAPTER);
            }
            DeeplinkReport deeplinkReport = oMSADLink.deeplinkReport;
            if (deeplinkReport != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(4, deeplinkReport, DeeplinkReport.PROTOBUF_ADAPTER);
            }
            LinkAction linkAction2 = oMSADLink.action;
            if (linkAction2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, linkAction2, LinkAction.PROTOBUF_ADAPTER);
            }
            ...
            oMSADLink.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSADLink parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    ...
                    oMSADLink.url = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    oMSADLink.fallbackLink = (OMSFallbackLink) nc5Var.m162488l(OMSFallbackLink.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    oMSADLink.deeplinkReport = (DeeplinkReport) nc5Var.m162488l(DeeplinkReport.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    oMSADLink.action = (LinkAction) nc5Var.m162488l(LinkAction.PROTOBUF_ADAPTER);
                } else if (iM162497u == 50) {
                    oMSADLink.path = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    oMSADLink.originalId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 66) {
                        if (oMSADLink.action == null && numValueOf != null) {
                            oMSADLink.action = (LinkAction) LinkAction.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    oMSADLink.appID = nc5Var.m162495s();
                }
            }
            return oMSADLink;
        }
        ...
        public void serialize(OMSADLink oMSADLink, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            LinkAction linkAction = oMSADLink.action;
            if (linkAction != null) {
                codedOutputByteBufferNano.m17305G(1, linkAction.ordinal());
            }
            String str = oMSADLink.url;
            if (str != null) {
            ...
            OMSFallbackLink oMSFallbackLink = oMSADLink.fallbackLink;
            if (oMSFallbackLink != null) {
                codedOutputByteBufferNano.m17309K(3, oMSFallbackLink, OMSFallbackLink.PROTOBUF_ADAPTER);
            }
            DeeplinkReport deeplinkReport = oMSADLink.deeplinkReport;
            if (deeplinkReport != null) {
                codedOutputByteBufferNano.m17309K(4, deeplinkReport, DeeplinkReport.PROTOBUF_ADAPTER);
            }
            LinkAction linkAction2 = oMSADLink.action;
            if (linkAction2 != null) {
                codedOutputByteBufferNano.m17309K(5, linkAction2, LinkAction.PROTOBUF_ADAPTER);
            }
            String str2 = oMSADLink.path;
            if (str2 != null) {
