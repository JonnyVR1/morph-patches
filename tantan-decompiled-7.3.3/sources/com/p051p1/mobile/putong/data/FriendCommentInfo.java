...
import com.p051p1.mobile.putong.data.FriendComment;
import com.p051p1.mobile.putong.data.InterestUserSimple;
...
public class FriendCommentInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FriendCommentInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<FriendCommentInfo>() { // from class: com.p1.mobile.putong.data.FriendCommentInfo.1
        ...
        public int computeAndCacheSize(FriendCommentInfo friendCommentInfo) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, friendCommentInfo.interestsCount) + CodedOutputByteBufferNano.m17275b(3, friendCommentInfo.alreadyInterested);
            List<FriendComment> list = friendCommentInfo.friendsComments;
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, list, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<InterestUserSimple> list2 = friendCommentInfo.interestedUsers;
            if (list2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, list2, InterestUserSimple.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(6, friendCommentInfo.commentsCount);
            List<FriendComment> list3 = friendCommentInfo.friendsCommentsHistory;
            if (list3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(7, list3, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UnreadCounter unreadCounter = friendCommentInfo.unreadCounter;
            if (unreadCounter != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(8, unreadCounter, UnreadCounter.PROTOBUF_ADAPTER);
            }
            friendCommentInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FriendCommentInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    friendCommentInfo.userId = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    friendCommentInfo.interestsCount = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    friendCommentInfo.alreadyInterested = nc5Var.m162483g();
                } else if (iM162497u == 34) {
                    friendCommentInfo.friendsComments = (List) nc5Var.m162488l(FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 42) {
                    friendCommentInfo.interestedUsers = (List) nc5Var.m162488l(InterestUserSimple.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 48) {
                    friendCommentInfo.commentsCount = nc5Var.m162486j();
                } else if (iM162497u == 58) {
                    friendCommentInfo.friendsCommentsHistory = (List) nc5Var.m162488l(FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 66) {
                        if (friendCommentInfo.userId == null) {
                            friendCommentInfo.userId = "";
                    ...
                    friendCommentInfo.unreadCounter = (UnreadCounter) nc5Var.m162488l(UnreadCounter.PROTOBUF_ADAPTER);
                }
            }
            return friendCommentInfo;
        }
        ...
        public void serialize(FriendCommentInfo friendCommentInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, friendCommentInfo.interestsCount);
            codedOutputByteBufferNano.m17299A(3, friendCommentInfo.alreadyInterested);
            List<FriendComment> list = friendCommentInfo.friendsComments;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(4, list, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<InterestUserSimple> list2 = friendCommentInfo.interestedUsers;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(5, list2, InterestUserSimple.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(6, friendCommentInfo.commentsCount);
            List<FriendComment> list3 = friendCommentInfo.friendsCommentsHistory;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(7, list3, FriendComment.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UnreadCounter unreadCounter = friendCommentInfo.unreadCounter;
            if (unreadCounter != null) {
                codedOutputByteBufferNano.m17309K(8, unreadCounter, UnreadCounter.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FriendCommentInfo mo225055clone() {
        FriendCommentInfo friendCommentInfo = new FriendCommentInfo();
        ...
        if (list != null) {
            friendCommentInfo.friendsComments = ValueObject.util_map(list, new qcj() { // from class: l.k9j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FriendComment) obj).mo225055clone();
                }
            });
        }
        List<InterestUserSimple> list2 = this.interestedUsers;
        if (list2 != null) {
            friendCommentInfo.interestedUsers = ValueObject.util_map(list2, new qcj() { // from class: l.l9j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((InterestUserSimple) obj).mo225055clone();
                }
            });
        }
        ...
        if (list3 != null) {
            friendCommentInfo.friendsCommentsHistory = ValueObject.util_map(list3, new qcj() { // from class: l.m9j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FriendComment) obj).mo225055clone();
                }
        ...
        if (unreadCounter != null) {
            friendCommentInfo.unreadCounter = unreadCounter.mo225055clone();
        }
        return friendCommentInfo;
    }
