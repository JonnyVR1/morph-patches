...
public class OpenSDKInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OpenSDKInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OpenSDKInfo>() { // from class: com.p1.mobile.putong.data.OpenSDKInfo.1
        ...
        public int computeAndCacheSize(OpenSDKInfo openSDKInfo) {
            ...
            if (scopes != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, scopes, Scopes.PROTOBUF_ADAPTER);
            }
            String str2 = openSDKInfo.logo_url;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(3, str2);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(4, openSDKInfo.error);
            String str3 = openSDKInfo.message;
            if (str3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(5, str3);
            }
            openSDKInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OpenSDKInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    openSDKInfo.name = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    openSDKInfo.scopes = (Scopes) nc5Var.m162488l(Scopes.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    openSDKInfo.logo_url = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    openSDKInfo.error = nc5Var.m162486j();
                } else {
                    if (iM162497u != 42) {
                        if (openSDKInfo.name == null) {
                            openSDKInfo.name = "";
                    ...
                    openSDKInfo.message = nc5Var.m162495s();
                }
            }
            return openSDKInfo;
        }
        ...
        public void serialize(OpenSDKInfo openSDKInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Scopes scopes = openSDKInfo.scopes;
            if (scopes != null) {
                codedOutputByteBufferNano.m17309K(2, scopes, Scopes.PROTOBUF_ADAPTER);
            }
            String str2 = openSDKInfo.logo_url;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(3, str2);
            }
            codedOutputByteBufferNano.m17305G(4, openSDKInfo.error);
            String str3 = openSDKInfo.message;
            if (str3 != null) {
    ...
    public OpenSDKInfo mo225055clone() {
        OpenSDKInfo openSDKInfo = new OpenSDKInfo();
        openSDKInfo.name = this.name;
        Scopes scopes = this.scopes;
        if (scopes != null) {
            openSDKInfo.scopes = scopes.mo225055clone();
        }
