...
public class MiniWidgetData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MiniWidgetData> PROTOBUF_ADAPTER = new MessageNanoAdapter<MiniWidgetData>() { // from class: com.p1.mobile.putong.data.MiniWidgetData.1
        ...
        public int computeAndCacheSize(MiniWidgetData miniWidgetData) {
            ...
            int iM17285l = miniWidgetDataType != null ? CodedOutputByteBufferNano.m17285l(1, miniWidgetDataType, MiniWidgetDataType.PROTOBUF_ADAPTER) : 0;
            ...
            int iM17281h = iM17285l + CodedOutputByteBufferNano.m17281h(7, miniWidgetData.sustainSeconds);
            String str6 = miniWidgetData.deeplink;
            if (str6 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(8, str6);
            }
            miniWidgetData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MiniWidgetData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    miniWidgetData.type = (MiniWidgetDataType) nc5Var.m162488l(MiniWidgetDataType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    miniWidgetData.leftTopText = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    miniWidgetData.backgroundImage = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    miniWidgetData.avatar = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    miniWidgetData.line1textNearAvatar = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    miniWidgetData.line2textNearAvatar = nc5Var.m162495s();
                } else if (iM162497u == 56) {
                    miniWidgetData.sustainSeconds = nc5Var.m162486j();
                } else {
                    if (iM162497u != 66) {
                        if (miniWidgetData.type == null) {
                            miniWidgetData.type = (MiniWidgetDataType) MiniWidgetDataType.JSON_ADAPTER.defaultEnum();
                    ...
                    miniWidgetData.deeplink = nc5Var.m162495s();
                }
            }
            return miniWidgetData;
        }
        ...
        public void serialize(MiniWidgetData miniWidgetData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (miniWidgetDataType != null) {
                codedOutputByteBufferNano.m17309K(1, miniWidgetDataType, MiniWidgetDataType.PROTOBUF_ADAPTER);
            }
            String str = miniWidgetData.leftTopText;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17305G(7, miniWidgetData.sustainSeconds);
            String str6 = miniWidgetData.deeplink;
            if (str6 != null) {
    ...
    public MiniWidgetData mo225055clone() {
        MiniWidgetData miniWidgetData = new MiniWidgetData();
