...
public class VisitorCounter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VisitorCounter> PROTOBUF_ADAPTER = new MessageNanoAdapter<VisitorCounter>() { // from class: com.p1.mobile.putong.data.VisitorCounter.1
        ...
        public int computeAndCacheSize(VisitorCounter visitorCounter) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, visitorCounter.newCnt) + CodedOutputByteBufferNano.m17281h(2, visitorCounter.totalCnt);
            ...
            visitorCounter.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VisitorCounter parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    visitorCounter.newCnt = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    visitorCounter.totalCnt = nc5Var.m162486j();
                } else {
                    if (iM162497u != 26) {
                        if (visitorCounter.avatars != null) {
                            break;
                    ...
                    visitorCounter.avatars = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return visitorCounter;
        }
        ...
        public void serialize(VisitorCounter visitorCounter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, visitorCounter.newCnt);
            codedOutputByteBufferNano.m17305G(2, visitorCounter.totalCnt);
            List<String> list = visitorCounter.avatars;
            if (list != null) {
    ...
    public static /* synthetic */ String m61343a(String str) {
        return str;
    }
    ...
    public VisitorCounter mo225055clone() {
        VisitorCounter visitorCounter = new VisitorCounter();
        visitorCounter.newCnt = this.newCnt;
        visitorCounter.totalCnt = this.totalCnt;
        List<String> list = this.avatars;
        if (list != null) {
            visitorCounter.avatars = ValueObject.util_map(list, new qcj() { // from class: l.zem0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return VisitorCounter.m61343a((String) obj);
                }
            });
        }
        return visitorCounter;
