...
public class Vip extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Vip> PROTOBUF_ADAPTER = new MessageNanoAdapter<Vip>() { // from class: com.p1.mobile.putong.data.Vip.1
        ...
        public int computeAndCacheSize(Vip vip) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17277d(2, vip.beginTime) + CodedOutputByteBufferNano.m17277d(3, vip.endTime);
            String str2 = vip.defaultCampaignName;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(4, str2);
            }
            vip.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Vip parse(nc5 nc5Var) throws IOException {
            Vip vip = new Vip();
            while (true) {
                ...
                if (iM162497u == 10) {
                    vip.campaignName = nc5Var.m162495s();
                } else if (iM162497u == 17) {
                    vip.beginTime = nc5Var.m162484h();
                } else if (iM162497u == 25) {
                    vip.endTime = nc5Var.m162484h();
                } else {
                    if (iM162497u != 34) {
                        if (vip.campaignName == null) {
                            vip.campaignName = "";
                    ...
                    vip.defaultCampaignName = nc5Var.m162495s();
                }
            }
            return vip;
        }
        ...
        public void serialize(Vip vip, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17301C(2, vip.beginTime);
            codedOutputByteBufferNano.m17301C(3, vip.endTime);
            String str2 = vip.defaultCampaignName;
            if (str2 != null) {
