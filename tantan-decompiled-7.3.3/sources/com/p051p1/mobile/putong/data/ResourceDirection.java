...
public class ResourceDirection extends TEnum {
    ...
    public static final String f39655h = "h";
    ...
    public static final String f39656v = "v";
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(f39656v, 1);
        supportEnum.add("h");
        supportEnum.add(f39656v);
        _ResourceDirection = Collections.synchronizedMap(new l01());
    }
