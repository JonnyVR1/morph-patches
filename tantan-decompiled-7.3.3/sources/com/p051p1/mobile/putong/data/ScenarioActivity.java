...
public class ScenarioActivity extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ScenarioActivity> PROTOBUF_ADAPTER = new MessageNanoAdapter<ScenarioActivity>() { // from class: com.p1.mobile.putong.data.ScenarioActivity.1
        ...
        public int computeAndCacheSize(ScenarioActivity scenarioActivity) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, scenarioActivity.users) + CodedOutputByteBufferNano.m17277d(2, scenarioActivity.updatedTime);
            scenarioActivity.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ScenarioActivity parse(nc5 nc5Var) throws IOException {
            ScenarioActivity scenarioActivity = new ScenarioActivity();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    scenarioActivity.users = nc5Var.m162487k();
                } else {
                    if (iM162497u != 17) {
                        return scenarioActivity;
                    }
                    scenarioActivity.updatedTime = nc5Var.m162484h();
                }
            }
        }
        ...
        public void serialize(ScenarioActivity scenarioActivity, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, scenarioActivity.users);
            codedOutputByteBufferNano.m17301C(2, scenarioActivity.updatedTime);
        }
    };
    ...
    public ScenarioActivity mo225055clone() {
        ScenarioActivity scenarioActivity = new ScenarioActivity();
