...
public class PaymentParam extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PaymentParam> PROTOBUF_ADAPTER = new MessageNanoAdapter<PaymentParam>() { // from class: com.p1.mobile.putong.data.PaymentParam.1
        ...
        public int computeAndCacheSize(PaymentParam paymentParam) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(4, paymentParam.useAutoDeduct) + CodedOutputByteBufferNano.m17275b(5, paymentParam.signAndPay);
            ...
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(9, paymentParam.useJDNew);
            paymentParam.cachedSize = iM17275b2;
            return iM17275b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PaymentParam parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    paymentParam.itemId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    paymentParam.receipt = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    paymentParam.url = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    paymentParam.useAutoDeduct = nc5Var.m162483g();
                } else if (iM162497u == 40) {
                    paymentParam.signAndPay = nc5Var.m162483g();
                } else if (iM162497u == 50) {
                    paymentParam.tracker = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    paymentParam.ext = (PaymentParamExtra) nc5Var.m162488l(PaymentParamExtra.PROTOBUF_ADAPTER);
                } else if (iM162497u == 66) {
                    paymentParam.couponId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 72) {
                        if (paymentParam.itemId == null) {
                            paymentParam.itemId = "";
                    ...
                    paymentParam.useJDNew = nc5Var.m162483g();
                }
            }
            return paymentParam;
        }
        ...
        public void serialize(PaymentParam paymentParam, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(4, paymentParam.useAutoDeduct);
            codedOutputByteBufferNano.m17299A(5, paymentParam.signAndPay);
            String str4 = paymentParam.tracker;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17299A(9, paymentParam.useJDNew);
        }
    };
    ...
    public PaymentParam mo225055clone() {
        PaymentParam paymentParam = new PaymentParam();
        ...
        if (paymentParamExtra != null) {
            paymentParam.ext = paymentParamExtra.mo225055clone();
        }
