...
public abstract class TEnumColumn<T, Enum extends TEnum> extends OrderedColumn<T, TEnum> {
    ...
    public Filter<T> m61360EQ(String str) {
        return (this.ordinalColumnInner == null || this.tEnumJsonAdapter.getInteger(str) == null) ? this.nameColumnInner.mo61359EQ(str) : Filter.m82444OR(Filter.AND(this.nameColumnInner.NULL(), this.ordinalColumnInner.mo61359EQ(this.tEnumJsonAdapter.getInteger(str))), Filter.AND(this.nameColumnInner.NOT_NULL(), this.nameColumnInner.mo61359EQ(str)));
    }
    ...
    public Filter<T> EQ_CONSTANT(String str) {
        ...
        return integer == null ? stringColumn.EQ_CONSTANT(str) : Filter.m82444OR(Filter.AND(stringColumn.NULL(), this.ordinalColumnInner.EQ_CONSTANT(this.tEnumJsonAdapter.getInteger(str))), Filter.AND(this.nameColumnInner.NOT_NULL(), this.nameColumnInner.EQ_CONSTANT(str)));
    }

    /* JADX INFO: renamed from: IN */
    public Filter<T> m61361IN(List<String> list) {
        if (this.ordinalColumnInner == null) {
            return this.nameColumnInner.m82451IN(list);
        }
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < list.size(); i++) {
            Integer integer = this.tEnumJsonAdapter.getInteger(list.get(i));
            if (integer != null) {
                arrayList.add(this.ordinalColumnInner.mo61359EQ(integer));
            }
        }
        if (arrayList.size() == 0) {
            return this.nameColumnInner.m82451IN(list);
        }
        return Filter.m82444OR(Filter.AND(this.nameColumnInner.NOT_NULL(), this.nameColumnInner.m82451IN(list)), Filter.AND(this.nameColumnInner.NULL(), Filter.m82444OR((Filter[]) arrayList.toArray(new Filter[arrayList.size()]))));
    }
    ...
    public Filter<T> NEQ(String str) {
        return (this.ordinalColumnInner == null || this.tEnumJsonAdapter.getInteger(str) == null) ? this.nameColumnInner.NEQ(str) : Filter.m82444OR(Filter.AND(this.nameColumnInner.NULL(), this.ordinalColumnInner.NEQ(this.tEnumJsonAdapter.getInteger(str))), Filter.AND(this.nameColumnInner.NOT_NULL(), this.nameColumnInner.NEQ(str)));
    }
    ...
    public Filter<T> NOT_IN(List<String> list) {
        ...
        return Filter.m82444OR(Filter.AND(this.nameColumnInner.NOT_NULL(), this.nameColumnInner.NOT_IN(list)), Filter.AND(this.nameColumnInner.NULL(), Filter.AND((Filter[]) arrayList.toArray(new Filter[arrayList.size()]))));
    }
    ...
    public Filter<T> mo61359EQ(TEnum tEnum) {
        return m61360EQ(tEnum.toString());
    }
