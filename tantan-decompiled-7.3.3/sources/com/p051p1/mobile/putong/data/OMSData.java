...
import com.p051p1.mobile.putong.data.OMSDocumentInfo;
import com.p051p1.mobile.putong.data.OMSEmitterInfo;
...
import com.p051p1.mobile.putong.data.OMSWidgetInfo;
...
public class OMSData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSData> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSData>() { // from class: com.p1.mobile.putong.data.OMSData.1
        ...
        public int computeAndCacheSize(OMSData oMSData) {
            ...
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, list2, OMSDialogInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSDocumentInfo> list3 = oMSData.documents;
            if (list3 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, list3, OMSDocumentInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSLauncherInfo> list4 = oMSData.launchPages;
            if (list4 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, list4, OMSLauncherInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSEmitterInfo> list5 = oMSData.emitters;
            if (list5 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, list5, OMSEmitterInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSWidgetInfo> list6 = oMSData.widgets;
            if (list6 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(6, list6, OMSWidgetInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSCounterInfo> list7 = oMSData.counters;
            if (list7 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(7, list7, OMSCounterInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSDialogGlobalConstraint> list8 = oMSData.globalConstraints;
            if (list8 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(8, list8, OMSDialogGlobalConstraint.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSAdCardInfo> list9 = oMSData.cards;
            if (list9 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(9, list9, OMSAdCardInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSSlotsInfo> list10 = oMSData.slots;
            if (list10 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(10, list10, OMSSlotsInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<SwipeExcites> list11 = oMSData.swipeExcites;
            if (list11 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(11, list11, SwipeExcites.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSThemeInfo> list12 = oMSData.themes;
            if (list12 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(12, list12, OMSThemeInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            oMSData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        oMSData.omsMetas = (List) nc5Var.m162488l(OMSMetasData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        oMSData.dialogs = (List) nc5Var.m162488l(OMSDialogInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 26:
                        oMSData.documents = (List) nc5Var.m162488l(OMSDocumentInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        oMSData.launchPages = (List) nc5Var.m162488l(OMSLauncherInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        oMSData.emitters = (List) nc5Var.m162488l(OMSEmitterInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        oMSData.widgets = (List) nc5Var.m162488l(OMSWidgetInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        oMSData.counters = (List) nc5Var.m162488l(OMSCounterInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 66:
                        oMSData.globalConstraints = (List) nc5Var.m162488l(OMSDialogGlobalConstraint.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        oMSData.cards = (List) nc5Var.m162488l(OMSAdCardInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        oMSData.slots = (List) nc5Var.m162488l(OMSSlotsInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        oMSData.swipeExcites = (List) nc5Var.m162488l(SwipeExcites.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        oMSData.themes = (List) nc5Var.m162488l(OMSThemeInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (oMSData.omsMetas == null) {
                            oMSData.omsMetas = new ArrayList();
        ...
        public void serialize(OMSData oMSData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<OMSDialogInfo> list2 = oMSData.dialogs;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(2, list2, OMSDialogInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSDocumentInfo> list3 = oMSData.documents;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(3, list3, OMSDocumentInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSLauncherInfo> list4 = oMSData.launchPages;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(4, list4, OMSLauncherInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSEmitterInfo> list5 = oMSData.emitters;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(5, list5, OMSEmitterInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSWidgetInfo> list6 = oMSData.widgets;
            if (list6 != null) {
                codedOutputByteBufferNano.m17309K(6, list6, OMSWidgetInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSCounterInfo> list7 = oMSData.counters;
            if (list7 != null) {
                codedOutputByteBufferNano.m17309K(7, list7, OMSCounterInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSDialogGlobalConstraint> list8 = oMSData.globalConstraints;
            if (list8 != null) {
                codedOutputByteBufferNano.m17309K(8, list8, OMSDialogGlobalConstraint.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSAdCardInfo> list9 = oMSData.cards;
            if (list9 != null) {
                codedOutputByteBufferNano.m17309K(9, list9, OMSAdCardInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSSlotsInfo> list10 = oMSData.slots;
            if (list10 != null) {
                codedOutputByteBufferNano.m17309K(10, list10, OMSSlotsInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<SwipeExcites> list11 = oMSData.swipeExcites;
            if (list11 != null) {
                codedOutputByteBufferNano.m17309K(11, list11, SwipeExcites.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<OMSThemeInfo> list12 = oMSData.themes;
            if (list12 != null) {
                codedOutputByteBufferNano.m17309K(12, list12, OMSThemeInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public OMSData mo225055clone() {
        OMSData oMSData = new OMSData();
        List<OMSMetasData> list = this.omsMetas;
        if (list != null) {
            oMSData.omsMetas = ValueObject.util_map(list, new qcj() { // from class: l.t650
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            oMSData.dialogs = ValueObject.util_map(list2, new qcj() { // from class: l.y650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSDialogInfo) obj).mo225055clone();
                }
            });
        }
        List<OMSDocumentInfo> list3 = this.documents;
        if (list3 != null) {
            oMSData.documents = ValueObject.util_map(list3, new qcj() { // from class: l.z650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSDocumentInfo) obj).mo225055clone();
                }
            });
        }
        List<OMSLauncherInfo> list4 = this.launchPages;
        if (list4 != null) {
            oMSData.launchPages = ValueObject.util_map(list4, new qcj() { // from class: l.a750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSLauncherInfo) obj).mo225055clone();
                }
            });
        }
        List<OMSEmitterInfo> list5 = this.emitters;
        if (list5 != null) {
            oMSData.emitters = ValueObject.util_map(list5, new qcj() { // from class: l.b750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSEmitterInfo) obj).mo225055clone();
                }
            });
        }
        List<OMSWidgetInfo> list6 = this.widgets;
        if (list6 != null) {
            oMSData.widgets = ValueObject.util_map(list6, new qcj() { // from class: l.c750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSWidgetInfo) obj).mo225055clone();
                }
            });
        }
        List<OMSCounterInfo> list7 = this.counters;
        if (list7 != null) {
            oMSData.counters = ValueObject.util_map(list7, new qcj() { // from class: l.d750
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list8 != null) {
            oMSData.globalConstraints = ValueObject.util_map(list8, new qcj() { // from class: l.e750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSDialogGlobalConstraint) obj).mo225055clone();
                }
            });
        }
        List<OMSAdCardInfo> list9 = this.cards;
        if (list9 != null) {
            oMSData.cards = ValueObject.util_map(list9, new qcj() { // from class: l.u650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSAdCardInfo) obj).mo225055clone();
                }
            });
        }
        List<OMSSlotsInfo> list10 = this.slots;
        if (list10 != null) {
            oMSData.slots = ValueObject.util_map(list10, new qcj() { // from class: l.v650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSSlotsInfo) obj).mo225055clone();
                }
            });
        }
        List<SwipeExcites> list11 = this.swipeExcites;
        if (list11 != null) {
            oMSData.swipeExcites = ValueObject.util_map(list11, new qcj() { // from class: l.w650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((SwipeExcites) obj).mo225055clone();
                }
            });
        }
        List<OMSThemeInfo> list12 = this.themes;
        if (list12 != null) {
            oMSData.themes = ValueObject.util_map(list12, new qcj() { // from class: l.x650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSThemeInfo) obj).mo225055clone();
                }
            });
        }
        return oMSData;
