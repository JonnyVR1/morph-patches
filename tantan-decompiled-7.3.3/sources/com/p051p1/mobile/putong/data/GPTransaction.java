...
public class GPTransaction extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GPTransaction> PROTOBUF_ADAPTER = new MessageNanoAdapter<GPTransaction>() { // from class: com.p1.mobile.putong.data.GPTransaction.1
        ...
        public int computeAndCacheSize(GPTransaction gPTransaction) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, GPAffiliateTransaction.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            ...
            gPTransaction.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GPTransaction parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    gPTransaction.affiliateTransactions = (List) nc5Var.m162488l(GPAffiliateTransaction.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    gPTransaction.mmuid = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    gPTransaction.smid = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (gPTransaction.affiliateTransactions == null) {
                            gPTransaction.affiliateTransactions = new ArrayList();
                    ...
                    gPTransaction.source = nc5Var.m162495s();
                }
            }
            return gPTransaction;
        }
        ...
        public void serialize(GPTransaction gPTransaction, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<GPAffiliateTransaction> list = gPTransaction.affiliateTransactions;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, GPAffiliateTransaction.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = gPTransaction.mmuid;
            if (str != null) {
    ...
    public GPTransaction mo225055clone() {
        GPTransaction gPTransaction = new GPTransaction();
        List<GPAffiliateTransaction> list = this.affiliateTransactions;
        if (list != null) {
            gPTransaction.affiliateTransactions = ValueObject.util_map(list, new qcj() { // from class: l.njj
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((GPAffiliateTransaction) obj).mo225055clone();
                }
            });
        }
