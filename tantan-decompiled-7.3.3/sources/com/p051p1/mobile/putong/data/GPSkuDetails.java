...
public class GPSkuDetails extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GPSkuDetails> PROTOBUF_ADAPTER = new MessageNanoAdapter<GPSkuDetails>() { // from class: com.p1.mobile.putong.data.GPSkuDetails.1
        ...
        public int computeAndCacheSize(GPSkuDetails gPSkuDetails) {
            ...
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(4, gPSkuDetails.priceAmountMicros);
            ...
            int iM17283j2 = iM17283j + CodedOutputByteBufferNano.m17283j(8, gPSkuDetails.introductoryPriceAmountMicros);
            gPSkuDetails.cachedSize = iM17283j2;
            return iM17283j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GPSkuDetails parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    gPSkuDetails.productId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    gPSkuDetails.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    gPSkuDetails.price = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    gPSkuDetails.priceAmountMicros = nc5Var.m162487k();
                } else if (iM162497u == 42) {
                    gPSkuDetails.priceCurrencyCode = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    gPSkuDetails.title = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    gPSkuDetails.description = nc5Var.m162495s();
                } else {
                    if (iM162497u != 64) {
                        if (gPSkuDetails.productId == null) {
                            gPSkuDetails.productId = "";
                    ...
                    gPSkuDetails.introductoryPriceAmountMicros = nc5Var.m162487k();
                }
            }
            return gPSkuDetails;
        }
        ...
        public void serialize(GPSkuDetails gPSkuDetails, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(4, gPSkuDetails.priceAmountMicros);
            String str4 = gPSkuDetails.priceCurrencyCode;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17307I(8, gPSkuDetails.introductoryPriceAmountMicros);
        }
    };
    ...
    public GPSkuDetails mo225055clone() {
        GPSkuDetails gPSkuDetails = new GPSkuDetails();
