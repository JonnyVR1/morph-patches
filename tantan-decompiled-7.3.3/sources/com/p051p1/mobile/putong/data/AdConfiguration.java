...
public class AdConfiguration extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AdConfiguration> PROTOBUF_ADAPTER = new MessageNanoAdapter<AdConfiguration>() { // from class: com.p1.mobile.putong.data.AdConfiguration.1
        ...
        public int computeAndCacheSize(AdConfiguration adConfiguration) {
            ...
            int iM17285l = adReward != null ? CodedOutputByteBufferNano.m17285l(1, adReward, AdReward.PROTOBUF_ADAPTER) : 0;
            AdSplash adSplash = adConfiguration.adSplash;
            if (adSplash != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, adSplash, AdSplash.PROTOBUF_ADAPTER);
            }
            adConfiguration.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AdConfiguration parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    adConfiguration.adReward = (AdReward) nc5Var.m162488l(AdReward.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (adConfiguration.adReward == null) {
                            adConfiguration.adReward = AdReward.new_();
                    ...
                    adConfiguration.adSplash = (AdSplash) nc5Var.m162488l(AdSplash.PROTOBUF_ADAPTER);
                }
            }
            return adConfiguration;
        }
        ...
        public void serialize(AdConfiguration adConfiguration, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            AdReward adReward = adConfiguration.adReward;
            if (adReward != null) {
                codedOutputByteBufferNano.m17309K(1, adReward, AdReward.PROTOBUF_ADAPTER);
            }
            AdSplash adSplash = adConfiguration.adSplash;
            if (adSplash != null) {
                codedOutputByteBufferNano.m17309K(2, adSplash, AdSplash.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public AdConfiguration mo225055clone() {
        AdConfiguration adConfiguration = new AdConfiguration();
        AdReward adReward = this.adReward;
        if (adReward != null) {
            adConfiguration.adReward = adReward.mo225055clone();
        }
        AdSplash adSplash = this.adSplash;
        if (adSplash != null) {
            adConfiguration.adSplash = adSplash.mo225055clone();
        }
        return adConfiguration;
    }
