...
public class BannerAction extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BannerAction> PROTOBUF_ADAPTER = new MessageNanoAdapter<BannerAction>() { // from class: com.p1.mobile.putong.data.BannerAction.1
        ...
        public int computeAndCacheSize(BannerAction bannerAction) {
            ...
            int iM17285l = (bannerFrequency != null ? CodedOutputByteBufferNano.m17285l(1, bannerFrequency, BannerFrequency.PROTOBUF_ADAPTER) : 0) + CodedOutputByteBufferNano.m17281h(2, bannerAction.swipe_count);
            BannerRedDot bannerRedDot = bannerAction.red_dot;
            if (bannerRedDot != null) {
                iM17285l += CodedOutputByteBufferNano.m17281h(3, bannerRedDot.ordinal());
            }
            BannerScroll bannerScroll = bannerAction.scroll;
            if (bannerScroll != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, bannerScroll, BannerScroll.PROTOBUF_ADAPTER);
            }
            BannerRedDot bannerRedDot2 = bannerAction.red_dot;
            if (bannerRedDot2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, bannerRedDot2, BannerRedDot.PROTOBUF_ADAPTER);
            }
            bannerAction.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BannerAction parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bannerAction.frequency = (BannerFrequency) nc5Var.m162488l(BannerFrequency.PROTOBUF_ADAPTER);
                } else if (iM162497u == 16) {
                    bannerAction.swipe_count = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 34) {
                    bannerAction.scroll = (BannerScroll) nc5Var.m162488l(BannerScroll.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 42) {
                        if (bannerAction.red_dot == null && numValueOf != null) {
                            bannerAction.red_dot = (BannerRedDot) BannerRedDot.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    bannerAction.red_dot = (BannerRedDot) nc5Var.m162488l(BannerRedDot.PROTOBUF_ADAPTER);
                }
            }
            return bannerAction;
        }
        ...
        public void serialize(BannerAction bannerAction, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (bannerFrequency != null) {
                codedOutputByteBufferNano.m17309K(1, bannerFrequency, BannerFrequency.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(2, bannerAction.swipe_count);
            BannerRedDot bannerRedDot = bannerAction.red_dot;
            if (bannerRedDot != null) {
                codedOutputByteBufferNano.m17305G(3, bannerRedDot.ordinal());
            }
            BannerScroll bannerScroll = bannerAction.scroll;
            if (bannerScroll != null) {
                codedOutputByteBufferNano.m17309K(4, bannerScroll, BannerScroll.PROTOBUF_ADAPTER);
            }
            BannerRedDot bannerRedDot2 = bannerAction.red_dot;
            if (bannerRedDot2 != null) {
                codedOutputByteBufferNano.m17309K(5, bannerRedDot2, BannerRedDot.PROTOBUF_ADAPTER);
            }
        }
    };
