...
public class ContractData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ContractData> PROTOBUF_ADAPTER = new MessageNanoAdapter<ContractData>() { // from class: com.p1.mobile.putong.data.ContractData.1
        ...
        public int computeAndCacheSize(ContractData contractData) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, Contract.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            contractData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ContractData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                contractData.contracts = (List) nc5Var.m162488l(Contract.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return contractData;
        }
        ...
        public void serialize(ContractData contractData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<Contract> list = contractData.contracts;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, Contract.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public ContractData mo225055clone() {
        ContractData contractData = new ContractData();
        List<Contract> list = this.contracts;
        if (list != null) {
            contractData.contracts = ValueObject.util_map(list, new qcj() { // from class: l.x26
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Contract) obj).mo225055clone();
                }
            });
        }
        return contractData;
