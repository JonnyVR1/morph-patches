...
public class H5OutData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<H5OutData> PROTOBUF_ADAPTER = new MessageNanoAdapter<H5OutData>() { // from class: com.p1.mobile.putong.data.H5OutData.1
        ...
        public int computeAndCacheSize(H5OutData h5OutData) {
            ...
            h5OutData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public H5OutData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    h5OutData.schemeVersion = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    h5OutData.deviceId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    h5OutData.token = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    h5OutData.browserVersion = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    h5OutData.versionCode = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    h5OutData.platform = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    h5OutData.language = nc5Var.m162495s();
                } else if (iM162497u == 66) {
                    h5OutData.userId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 74) {
                        if (h5OutData.schemeVersion == null) {
                            h5OutData.schemeVersion = "";
                    ...
                    h5OutData.oneId = nc5Var.m162495s();
                }
            }
            return h5OutData;
        }
    ...
    public H5OutData mo225055clone() {
        H5OutData h5OutData = new H5OutData();
