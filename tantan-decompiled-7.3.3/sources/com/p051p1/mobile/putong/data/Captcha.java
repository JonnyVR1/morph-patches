...
public class Captcha extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Captcha> PROTOBUF_ADAPTER = new MessageNanoAdapter<Captcha>() { // from class: com.p1.mobile.putong.data.Captcha.1
        ...
        public int computeAndCacheSize(Captcha captcha) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(6, captcha.localExpired);
            captcha.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Captcha parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    captcha.captchaID = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    captcha.captchaOutput = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    captcha.genTime = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    captcha.lotNumber = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    captcha.passToken = nc5Var.m162495s();
                } else {
                    if (iM162497u != 48) {
                        if (captcha.captchaID == null) {
                            captcha.captchaID = "";
                    ...
                    captcha.localExpired = nc5Var.m162483g();
                }
            }
            return captcha;
        }
        ...
        public void serialize(Captcha captcha, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(6, captcha.localExpired);
        }
    };
