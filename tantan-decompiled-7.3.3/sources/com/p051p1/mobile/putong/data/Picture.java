...
public class Picture extends Media implements Cloneable, Serializable {
    ...
    public static final int[] MAX_PROFILE_SIZE = {TXEAudioDef.TXE_OPUS_SAMPLE_NUM, TXEAudioDef.TXE_OPUS_SAMPLE_NUM};
    public static final int[] SQUARE_SIZES = {128, 180, 300, 480, 640};
    public static final int[] SIZES = {180, 300, 480, 640, 720, TXEAudioDef.TXE_OPUS_SAMPLE_NUM};
    public static ProtobufAdapter<Picture> PROTOBUF_ADAPTER = new MessageNanoAdapter<Picture>() { // from class: com.p1.mobile.putong.data.Picture.1
        ...
        public int computeAndCacheSize(Picture picture) {
            ...
            int iM17275b = iM17281h + CodedOutputByteBufferNano.m17275b(9, picture.isPortrait);
            ...
            if (dimension != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(51, dimension, Dimension.PROTOBUF_ADAPTER);
            }
            AIPosition aIPosition = picture.aiPosition;
            if (aIPosition != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(52, aIPosition, AIPosition.PROTOBUF_ADAPTER);
            }
            List<Picture> list4 = picture.attachments;
            if (list4 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(53, list4, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GaussianBlurParameters gaussianBlurParameters = picture.gaussianBlurParameters;
            if (gaussianBlurParameters != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(54, gaussianBlurParameters, GaussianBlurParameters.PROTOBUF_ADAPTER);
            }
            MediaLocalStatus mediaLocalStatus2 = picture.status;
            if (mediaLocalStatus2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(55, mediaLocalStatus2, MediaLocalStatus.PROTOBUF_ADAPTER);
            }
            LivePhoto livePhoto = picture.livePhoto;
            if (livePhoto != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(56, livePhoto, LivePhoto.PROTOBUF_ADAPTER);
            }
            picture.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Picture parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    ...
                    case 8:
                        ...
                        continue;
                    case 18:
                        picture.url = nc5Var.m162495s();
                        continue;
                    case 26:
                        picture.urlKey = nc5Var.m162495s();
                        continue;
                    case 34:
                        picture.name = nc5Var.m162495s();
                        continue;
                    case 42:
                        picture.mediaType = nc5Var.m162495s();
                        continue;
                    case 50:
                        picture.meta = (MediaMeta) nc5Var.m162488l(MediaMeta.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        picture.originUrl = nc5Var.m162495s();
                        continue;
                    case 72:
                        picture.isPortrait = nc5Var.m162483g();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        picture.labels = (List) nc5Var.m162488l(MediaLabel.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        picture.tags = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        picture.tagIdealInfo = (List) nc5Var.m162488l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 410:
                        picture.size = (Dimension) nc5Var.m162488l(Dimension.PROTOBUF_ADAPTER);
                        continue;
                    case 418:
                        picture.aiPosition = (AIPosition) nc5Var.m162488l(AIPosition.PROTOBUF_ADAPTER);
                        continue;
                    case 426:
                        picture.attachments = (List) nc5Var.m162488l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 434:
                        picture.gaussianBlurParameters = (GaussianBlurParameters) nc5Var.m162488l(GaussianBlurParameters.PROTOBUF_ADAPTER);
                        continue;
                    case 442:
                        picture.status = (MediaLocalStatus) nc5Var.m162488l(MediaLocalStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 450:
                        picture.livePhoto = (LivePhoto) nc5Var.m162488l(LivePhoto.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (picture.status == null && numValueOf != null) {
                            picture.status = (MediaLocalStatus) MediaLocalStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Picture picture, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(9, picture.isPortrait);
            List<MediaLabel> list = picture.labels;
            if (list != null) {
            ...
            AIPosition aIPosition = picture.aiPosition;
            if (aIPosition != null) {
                codedOutputByteBufferNano.m17309K(52, aIPosition, AIPosition.PROTOBUF_ADAPTER);
            }
            List<Picture> list4 = picture.attachments;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(53, list4, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GaussianBlurParameters gaussianBlurParameters = picture.gaussianBlurParameters;
            if (gaussianBlurParameters != null) {
                codedOutputByteBufferNano.m17309K(54, gaussianBlurParameters, GaussianBlurParameters.PROTOBUF_ADAPTER);
            }
            MediaLocalStatus mediaLocalStatus2 = picture.status;
            if (mediaLocalStatus2 != null) {
                codedOutputByteBufferNano.m17309K(55, mediaLocalStatus2, MediaLocalStatus.PROTOBUF_ADAPTER);
            }
            LivePhoto livePhoto = picture.livePhoto;
            if (livePhoto != null) {
                codedOutputByteBufferNano.m17309K(56, livePhoto, LivePhoto.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ MediaLabel m61180d(MediaLabel mediaLabel) {
        return mediaLabel;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m61181e(String str) {
        return str;
    }
    ...
    public static boolean userWebpInPicture() {
        return !RemoteConfig.m80481x().m80513s("picture_format_config") && kl40.m150345c();
    }
    ...
    public Picture mo225055clone() {
        ...
        if (mediaMeta != null) {
            picture.meta = mediaMeta.mo225055clone();
        }
        picture.originUrl = this.originUrl;
        picture.isPortrait = this.isPortrait;
        List<MediaLabel> list = this.labels;
        if (list != null) {
            picture.labels = ValueObject.util_map(list, new qcj() { // from class: l.lp70
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return Picture.m61180d((MediaLabel) obj);
                }
            });
        }
        List<String> list2 = this.tags;
        if (list2 != null) {
            picture.tags = ValueObject.util_map(list2, new qcj() { // from class: l.mp70
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return Picture.m61181e((String) obj);
                }
            });
        }
        List<IdealTag> list3 = this.tagIdealInfo;
        if (list3 != null) {
            picture.tagIdealInfo = ValueObject.util_map(list3, new qcj() { // from class: l.np70
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        Dimension dimension = this.size;
        if (dimension != null) {
            picture.size = dimension.mo225055clone();
        }
        AIPosition aIPosition = this.aiPosition;
        if (aIPosition != null) {
            picture.aiPosition = aIPosition.mo225055clone();
        }
        List<Picture> list4 = this.attachments;
        if (list4 != null) {
            picture.attachments = ValueObject.util_map(list4, new qcj() { // from class: l.op70
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (gaussianBlurParameters != null) {
            picture.gaussianBlurParameters = gaussianBlurParameters.mo225055clone();
        }
        LivePhoto livePhoto = this.livePhoto;
        if (livePhoto != null) {
            picture.livePhoto = livePhoto.mo225055clone();
        }
        return picture;
    }
    ...
    public boolean isAiFakePic() {
        return !jyb.m147479J(this.labels) && this.labels.contains(MediaLabel.get(MediaLabel.WITH_AUDIT_AI_PICTURE));
    }
    ...
    public boolean isLabelJudge(MediaLabel mediaLabel) {
        return !jyb.m147479J(this.labels) && this.labels.contains(mediaLabel);
    }

    public boolean isLow() {
        return !jyb.m147479J(this.labels) && this.labels.contains(MediaLabel.get(MediaLabel.WITH_LOW));
    }
    ...
    public boolean isVerificationCheckFail() {
        return !jyb.m147479J(this.labels) && this.labels.contains(MediaLabel.get(MediaLabel.NOT_VERIFICATION));
    }
    ...
    public ImageUri momentPictureSmall() {
        return atMostShortDimension(qa00.m175859d(74.0f));
    }
    ...
    public ImageUri profileSmall() {
        return squareAtLeast(qa00.m175859d(42.0f));
    }
    ...
    public void removeLabel(final MediaLabel mediaLabel) {
        ...
        jyb.m147503d0(list, new qcj() { // from class: l.jp70
            @Override // p153l.qcj
            public final Object call(Object obj) {
    ...
    public void removeLowLabel() {
        ...
        jyb.m147503d0(list, new qcj() { // from class: l.kp70
            @Override // p153l.qcj
            public final Object call(Object obj) {
    ...
    public pf60<ImageUri, Point> stickerItemInMessages() {
        int iM175859d = qa00.m175859d(App.f16091h ? 128.0f : 144.0f);
        Dimension dimension = this.size;
        int i = dimension.width;
        int i2 = dimension.height;
        if (i > i2) {
            int iMin = Math.min(i, iM175859d);
            Dimension dimension2 = this.size;
            return jyb.m147494Y(aboutWidth(iMin, ".png"), new Point(iMin, (dimension2.height * iMin) / dimension2.width));
        }
        int iMin2 = Math.min(i2, iM175859d);
        Dimension dimension3 = this.size;
        int i3 = (dimension3.width * iMin2) / dimension3.height;
        return jyb.m147494Y(aboutWidth(i3, ".png"), new Point(i3, iMin2));
    }
    ...
    public static final class ImageUri {
        ...
        public boolean checkUrlBeanAvailable() {
            if (this.formatWidth <= 0 || !NullChecker.m82486a(this.orignalDimen)) {
                return false;
            }
        ...
        public String formatted(int i) {
            ...
            if (i2 == 2) {
                return strConcat + "?format=" + i + BaseSei.f14624X + i;
            }
            if (i2 == 1) {
