...
import com.p051p1.mobile.putong.data.DiamondVIPPrivateMatch;
...
public class DiamondVIPPrivateMatch extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DiamondVIPPrivateMatch> PROTOBUF_ADAPTER = new MessageNanoAdapter<DiamondVIPPrivateMatch>() { // from class: com.p1.mobile.putong.data.DiamondVIPPrivateMatch.1
        ...
        public int computeAndCacheSize(DiamondVIPPrivateMatch diamondVIPPrivateMatch) {
            ...
            int iM17281h = iM17285l + CodedOutputByteBufferNano.m17281h(3, diamondVIPPrivateMatch.beauty) + CodedOutputByteBufferNano.m17281h(4, diamondVIPPrivateMatch.enthusiasm) + CodedOutputByteBufferNano.m17281h(5, diamondVIPPrivateMatch.serious) + CodedOutputByteBufferNano.m17281h(6, diamondVIPPrivateMatch.profile) + CodedOutputByteBufferNano.m17281h(7, diamondVIPPrivateMatch.habbit);
            List<String> list3 = diamondVIPPrivateMatch.styleForMaleIdealType;
            if (list3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(8, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list4 = diamondVIPPrivateMatch.styleForFemaleIdealType;
            if (list4 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(9, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list5 = diamondVIPPrivateMatch.styleForMalePriority;
            if (list5 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(10, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list6 = diamondVIPPrivateMatch.styleForFemalePriority;
            if (list6 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(11, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            diamondVIPPrivateMatch.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DiamondVIPPrivateMatch parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        diamondVIPPrivateMatch.styleForMale = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        diamondVIPPrivateMatch.styleForFemale = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 24:
                        diamondVIPPrivateMatch.beauty = nc5Var.m162486j();
                        continue;
                    case 32:
                        diamondVIPPrivateMatch.enthusiasm = nc5Var.m162486j();
                        continue;
                    case 40:
                        diamondVIPPrivateMatch.serious = nc5Var.m162486j();
                        continue;
                    case 48:
                        diamondVIPPrivateMatch.profile = nc5Var.m162486j();
                        continue;
                    case 56:
                        diamondVIPPrivateMatch.habbit = nc5Var.m162486j();
                        continue;
                    case 66:
                        diamondVIPPrivateMatch.styleForMaleIdealType = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        diamondVIPPrivateMatch.styleForFemaleIdealType = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        diamondVIPPrivateMatch.styleForMalePriority = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        diamondVIPPrivateMatch.styleForFemalePriority = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (diamondVIPPrivateMatch.styleForMale == null) {
                            diamondVIPPrivateMatch.styleForMale = new ArrayList();
        ...
        public void serialize(DiamondVIPPrivateMatch diamondVIPPrivateMatch, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(3, diamondVIPPrivateMatch.beauty);
            codedOutputByteBufferNano.m17305G(4, diamondVIPPrivateMatch.enthusiasm);
            codedOutputByteBufferNano.m17305G(5, diamondVIPPrivateMatch.serious);
            codedOutputByteBufferNano.m17305G(6, diamondVIPPrivateMatch.profile);
            codedOutputByteBufferNano.m17305G(7, diamondVIPPrivateMatch.habbit);
            List<String> list3 = diamondVIPPrivateMatch.styleForMaleIdealType;
            if (list3 != null) {
            ...
            List<String> list4 = diamondVIPPrivateMatch.styleForFemaleIdealType;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(9, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list5 = diamondVIPPrivateMatch.styleForMalePriority;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(10, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list6 = diamondVIPPrivateMatch.styleForFemalePriority;
            if (list6 != null) {
                codedOutputByteBufferNano.m17309K(11, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m60932a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m60933b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m60934c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m60935d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m60936e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m60937f(String str) {
        return str;
    }
    ...
    public DiamondVIPPrivateMatch mo225055clone() {
        DiamondVIPPrivateMatch diamondVIPPrivateMatch = new DiamondVIPPrivateMatch();
        List<String> list = this.styleForMale;
        if (list != null) {
            diamondVIPPrivateMatch.styleForMale = ValueObject.util_map(list, new qcj() { // from class: l.h2e
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return DiamondVIPPrivateMatch.m60932a((String) obj);
                }
            });
        }
        List<String> list2 = this.styleForFemale;
        if (list2 != null) {
            diamondVIPPrivateMatch.styleForFemale = ValueObject.util_map(list2, new qcj() { // from class: l.i2e
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return DiamondVIPPrivateMatch.m60936e((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            diamondVIPPrivateMatch.styleForMaleIdealType = ValueObject.util_map(list3, new qcj() { // from class: l.j2e
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return DiamondVIPPrivateMatch.m60937f((String) obj);
                }
            });
        }
        List<String> list4 = this.styleForFemaleIdealType;
        if (list4 != null) {
            diamondVIPPrivateMatch.styleForFemaleIdealType = ValueObject.util_map(list4, new qcj() { // from class: l.k2e
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return DiamondVIPPrivateMatch.m60934c((String) obj);
                }
            });
        }
        List<String> list5 = this.styleForMalePriority;
        if (list5 != null) {
            diamondVIPPrivateMatch.styleForMalePriority = ValueObject.util_map(list5, new qcj() { // from class: l.l2e
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return DiamondVIPPrivateMatch.m60935d((String) obj);
                }
            });
        }
        List<String> list6 = this.styleForFemalePriority;
        if (list6 != null) {
            diamondVIPPrivateMatch.styleForFemalePriority = ValueObject.util_map(list6, new qcj() { // from class: l.m2e
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return DiamondVIPPrivateMatch.m60933b((String) obj);
                }
            });
        }
        return diamondVIPPrivateMatch;
