...
public class Counter extends ValueObject<Counter> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Counter> PROTOBUF_ADAPTER = new MessageNanoAdapter<Counter>() { // from class: com.p1.mobile.putong.data.Counter.1
        ...
        public int computeAndCacheSize(Counter counter) {
            ...
            int iM17285l = counterLikeLimit != null ? CodedOutputByteBufferNano.m17285l(1, counterLikeLimit, CounterLikeLimit.PROTOBUF_ADAPTER) : 0;
            CounterActivities counterActivities = counter.activities;
            if (counterActivities != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, counterActivities, CounterActivities.PROTOBUF_ADAPTER);
            }
            CounterSecretCrushLimit counterSecretCrushLimit = counter.secretCrushLimit;
            if (counterSecretCrushLimit != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, counterSecretCrushLimit, CounterSecretCrushLimit.PROTOBUF_ADAPTER);
            }
            CounterSuperlikeAndUndoLimit counterSuperlikeAndUndoLimit = counter.superLikeLimit;
            if (counterSuperlikeAndUndoLimit != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, counterSuperlikeAndUndoLimit, CounterSuperlikeAndUndoLimit.PROTOBUF_ADAPTER);
            }
            CounterSuperlikeAndUndoLimit counterSuperlikeAndUndoLimit2 = counter.undoLimit;
            if (counterSuperlikeAndUndoLimit2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, counterSuperlikeAndUndoLimit2, CounterSuperlikeAndUndoLimit.PROTOBUF_ADAPTER);
            }
            CounterFollowShips counterFollowShips = counter.followships;
            if (counterFollowShips != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(6, counterFollowShips, CounterFollowShips.PROTOBUF_ADAPTER);
            }
            CouterMoments couterMoments = counter.moments;
            if (couterMoments != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(7, couterMoments, CouterMoments.PROTOBUF_ADAPTER);
            }
            List<BoostLimit> list = counter.boostLimits;
            if (list != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(8, list, BoostLimit.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LikersLimit likersLimit = counter.likersLimit;
            if (likersLimit != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(9, likersLimit, LikersLimit.PROTOBUF_ADAPTER);
            }
            LiveChatLimit liveChatLimit = counter.liveChatLimit;
            if (liveChatLimit != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(10, liveChatLimit, LiveChatLimit.PROTOBUF_ADAPTER);
            }
            Mytantan mytantan = counter.mytantan;
            if (mytantan != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(11, mytantan, Mytantan.PROTOBUF_ADAPTER);
            }
            LivePushLimit livePushLimit = counter.livePushLimit;
            if (livePushLimit != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(12, livePushLimit, LivePushLimit.PROTOBUF_ADAPTER);
            }
            CounterFriendReminder counterFriendReminder = counter.friendReminders;
            if (counterFriendReminder != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(13, counterFriendReminder, CounterFriendReminder.PROTOBUF_ADAPTER);
            }
            CounterViewer counterViewer = counter.viewers;
            if (counterViewer != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(14, counterViewer, CounterViewer.PROTOBUF_ADAPTER);
            }
            CounterShuoshuo counterShuoshuo = counter.shuoshuos;
            if (counterShuoshuo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(15, counterShuoshuo, CounterShuoshuo.PROTOBUF_ADAPTER);
            }
            CounterKankan counterKankan = counter.kankan;
            if (counterKankan != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(16, counterKankan, CounterKankan.PROTOBUF_ADAPTER);
            }
            Swipes swipes = counter.swipes;
            if (swipes != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(17, swipes, Swipes.PROTOBUF_ADAPTER);
            }
            CounterGrowth counterGrowth = counter.growth;
            if (counterGrowth != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(18, counterGrowth, CounterGrowth.PROTOBUF_ADAPTER);
            }
            ProfileLike profileLike = counter.profileLike;
            if (profileLike != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(19, profileLike, ProfileLike.PROTOBUF_ADAPTER);
            }
            CounterPickUsers counterPickUsers = counter.pickUsers;
            if (counterPickUsers != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(20, counterPickUsers, CounterPickUsers.PROTOBUF_ADAPTER);
            }
            FakeLikeLimits fakeLikeLimits = counter.fakeLikeLimits;
            if (fakeLikeLimits != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(21, fakeLikeLimits, FakeLikeLimits.PROTOBUF_ADAPTER);
            }
            FeedFlower feedFlower = counter.flower;
            if (feedFlower != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(22, feedFlower, FeedFlower.PROTOBUF_ADAPTER);
            }
            VerificationLimit verificationLimit = counter.verification;
            if (verificationLimit != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(23, verificationLimit, VerificationLimit.PROTOBUF_ADAPTER);
            }
            counter.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Counter parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        counter.likeLimit = (CounterLikeLimit) nc5Var.m162488l(CounterLikeLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 18:
                        counter.activities = (CounterActivities) nc5Var.m162488l(CounterActivities.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        counter.secretCrushLimit = (CounterSecretCrushLimit) nc5Var.m162488l(CounterSecretCrushLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        counter.superLikeLimit = (CounterSuperlikeAndUndoLimit) nc5Var.m162488l(CounterSuperlikeAndUndoLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        counter.undoLimit = (CounterSuperlikeAndUndoLimit) nc5Var.m162488l(CounterSuperlikeAndUndoLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        counter.followships = (CounterFollowShips) nc5Var.m162488l(CounterFollowShips.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        counter.moments = (CouterMoments) nc5Var.m162488l(CouterMoments.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        counter.boostLimits = (List) nc5Var.m162488l(BoostLimit.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        counter.likersLimit = (LikersLimit) nc5Var.m162488l(LikersLimit.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        counter.liveChatLimit = (LiveChatLimit) nc5Var.m162488l(LiveChatLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        counter.mytantan = (Mytantan) nc5Var.m162488l(Mytantan.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        counter.livePushLimit = (LivePushLimit) nc5Var.m162488l(LivePushLimit.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        counter.friendReminders = (CounterFriendReminder) nc5Var.m162488l(CounterFriendReminder.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        counter.viewers = (CounterViewer) nc5Var.m162488l(CounterViewer.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        counter.shuoshuos = (CounterShuoshuo) nc5Var.m162488l(CounterShuoshuo.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        counter.kankan = (CounterKankan) nc5Var.m162488l(CounterKankan.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        counter.swipes = (Swipes) nc5Var.m162488l(Swipes.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        counter.growth = (CounterGrowth) nc5Var.m162488l(CounterGrowth.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        counter.profileLike = (ProfileLike) nc5Var.m162488l(ProfileLike.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        counter.pickUsers = (CounterPickUsers) nc5Var.m162488l(CounterPickUsers.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        counter.fakeLikeLimits = (FakeLikeLimits) nc5Var.m162488l(FakeLikeLimits.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        counter.flower = (FeedFlower) nc5Var.m162488l(FeedFlower.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        counter.verification = (VerificationLimit) nc5Var.m162488l(VerificationLimit.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (counter.likeLimit == null) {
                            counter.likeLimit = CounterLikeLimit.new_();
        ...
        public void serialize(Counter counter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (counterLikeLimit != null) {
                codedOutputByteBufferNano.m17309K(1, counterLikeLimit, CounterLikeLimit.PROTOBUF_ADAPTER);
            }
            CounterActivities counterActivities = counter.activities;
            if (counterActivities != null) {
                codedOutputByteBufferNano.m17309K(2, counterActivities, CounterActivities.PROTOBUF_ADAPTER);
            }
            CounterSecretCrushLimit counterSecretCrushLimit = counter.secretCrushLimit;
            if (counterSecretCrushLimit != null) {
                codedOutputByteBufferNano.m17309K(3, counterSecretCrushLimit, CounterSecretCrushLimit.PROTOBUF_ADAPTER);
            }
            CounterSuperlikeAndUndoLimit counterSuperlikeAndUndoLimit = counter.superLikeLimit;
            if (counterSuperlikeAndUndoLimit != null) {
                codedOutputByteBufferNano.m17309K(4, counterSuperlikeAndUndoLimit, CounterSuperlikeAndUndoLimit.PROTOBUF_ADAPTER);
            }
            CounterSuperlikeAndUndoLimit counterSuperlikeAndUndoLimit2 = counter.undoLimit;
            if (counterSuperlikeAndUndoLimit2 != null) {
                codedOutputByteBufferNano.m17309K(5, counterSuperlikeAndUndoLimit2, CounterSuperlikeAndUndoLimit.PROTOBUF_ADAPTER);
            }
            CounterFollowShips counterFollowShips = counter.followships;
            if (counterFollowShips != null) {
                codedOutputByteBufferNano.m17309K(6, counterFollowShips, CounterFollowShips.PROTOBUF_ADAPTER);
            }
            CouterMoments couterMoments = counter.moments;
            if (couterMoments != null) {
                codedOutputByteBufferNano.m17309K(7, couterMoments, CouterMoments.PROTOBUF_ADAPTER);
            }
            List<BoostLimit> list = counter.boostLimits;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(8, list, BoostLimit.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LikersLimit likersLimit = counter.likersLimit;
            if (likersLimit != null) {
                codedOutputByteBufferNano.m17309K(9, likersLimit, LikersLimit.PROTOBUF_ADAPTER);
            }
            LiveChatLimit liveChatLimit = counter.liveChatLimit;
            if (liveChatLimit != null) {
                codedOutputByteBufferNano.m17309K(10, liveChatLimit, LiveChatLimit.PROTOBUF_ADAPTER);
            }
            Mytantan mytantan = counter.mytantan;
            if (mytantan != null) {
                codedOutputByteBufferNano.m17309K(11, mytantan, Mytantan.PROTOBUF_ADAPTER);
            }
            LivePushLimit livePushLimit = counter.livePushLimit;
            if (livePushLimit != null) {
                codedOutputByteBufferNano.m17309K(12, livePushLimit, LivePushLimit.PROTOBUF_ADAPTER);
            }
            CounterFriendReminder counterFriendReminder = counter.friendReminders;
            if (counterFriendReminder != null) {
                codedOutputByteBufferNano.m17309K(13, counterFriendReminder, CounterFriendReminder.PROTOBUF_ADAPTER);
            }
            CounterViewer counterViewer = counter.viewers;
            if (counterViewer != null) {
                codedOutputByteBufferNano.m17309K(14, counterViewer, CounterViewer.PROTOBUF_ADAPTER);
            }
            CounterShuoshuo counterShuoshuo = counter.shuoshuos;
            if (counterShuoshuo != null) {
                codedOutputByteBufferNano.m17309K(15, counterShuoshuo, CounterShuoshuo.PROTOBUF_ADAPTER);
            }
            CounterKankan counterKankan = counter.kankan;
            if (counterKankan != null) {
                codedOutputByteBufferNano.m17309K(16, counterKankan, CounterKankan.PROTOBUF_ADAPTER);
            }
            Swipes swipes = counter.swipes;
            if (swipes != null) {
                codedOutputByteBufferNano.m17309K(17, swipes, Swipes.PROTOBUF_ADAPTER);
            }
            CounterGrowth counterGrowth = counter.growth;
            if (counterGrowth != null) {
                codedOutputByteBufferNano.m17309K(18, counterGrowth, CounterGrowth.PROTOBUF_ADAPTER);
            }
            ProfileLike profileLike = counter.profileLike;
            if (profileLike != null) {
                codedOutputByteBufferNano.m17309K(19, profileLike, ProfileLike.PROTOBUF_ADAPTER);
            }
            CounterPickUsers counterPickUsers = counter.pickUsers;
            if (counterPickUsers != null) {
                codedOutputByteBufferNano.m17309K(20, counterPickUsers, CounterPickUsers.PROTOBUF_ADAPTER);
            }
            FakeLikeLimits fakeLikeLimits = counter.fakeLikeLimits;
            if (fakeLikeLimits != null) {
                codedOutputByteBufferNano.m17309K(21, fakeLikeLimits, FakeLikeLimits.PROTOBUF_ADAPTER);
            }
            FeedFlower feedFlower = counter.flower;
            if (feedFlower != null) {
                codedOutputByteBufferNano.m17309K(22, feedFlower, FeedFlower.PROTOBUF_ADAPTER);
            }
            VerificationLimit verificationLimit = counter.verification;
            if (verificationLimit != null) {
                codedOutputByteBufferNano.m17309K(23, verificationLimit, VerificationLimit.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Counter mo225055clone() {
        Counter counter = new Counter();
        CounterLikeLimit counterLikeLimit = this.likeLimit;
        if (counterLikeLimit != null) {
            counter.likeLimit = counterLikeLimit.mo225055clone();
        }
        CounterActivities counterActivities = this.activities;
        if (counterActivities != null) {
            counter.activities = counterActivities.mo225055clone();
        }
        CounterSecretCrushLimit counterSecretCrushLimit = this.secretCrushLimit;
        if (counterSecretCrushLimit != null) {
            counter.secretCrushLimit = counterSecretCrushLimit.mo225055clone();
        }
        CounterSuperlikeAndUndoLimit counterSuperlikeAndUndoLimit = this.superLikeLimit;
        if (counterSuperlikeAndUndoLimit != null) {
            counter.superLikeLimit = counterSuperlikeAndUndoLimit.mo225055clone();
        }
        CounterSuperlikeAndUndoLimit counterSuperlikeAndUndoLimit2 = this.undoLimit;
        if (counterSuperlikeAndUndoLimit2 != null) {
            counter.undoLimit = counterSuperlikeAndUndoLimit2.mo225055clone();
        }
        CounterFollowShips counterFollowShips = this.followships;
        if (counterFollowShips != null) {
            counter.followships = counterFollowShips.mo225055clone();
        }
        CouterMoments couterMoments = this.moments;
        if (couterMoments != null) {
            counter.moments = couterMoments.mo225055clone();
        }
        List<BoostLimit> list = this.boostLimits;
        if (list != null) {
            counter.boostLimits = ValueObject.util_map(list, new qcj() { // from class: l.xrb
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BoostLimit) obj).mo225055clone();
                }
            });
        }
        LikersLimit likersLimit = this.likersLimit;
        if (likersLimit != null) {
            counter.likersLimit = likersLimit.mo225055clone();
        }
        LiveChatLimit liveChatLimit = this.liveChatLimit;
        if (liveChatLimit != null) {
            counter.liveChatLimit = liveChatLimit.mo225055clone();
        }
        Mytantan mytantan = this.mytantan;
        if (mytantan != null) {
            counter.mytantan = mytantan.mo225055clone();
        }
        LivePushLimit livePushLimit = this.livePushLimit;
        if (livePushLimit != null) {
            counter.livePushLimit = livePushLimit.mo225055clone();
        }
        CounterFriendReminder counterFriendReminder = this.friendReminders;
        if (counterFriendReminder != null) {
            counter.friendReminders = counterFriendReminder.mo225055clone();
        }
        CounterViewer counterViewer = this.viewers;
        if (counterViewer != null) {
            counter.viewers = counterViewer.mo225055clone();
        }
        CounterShuoshuo counterShuoshuo = this.shuoshuos;
        if (counterShuoshuo != null) {
            counter.shuoshuos = counterShuoshuo.mo225055clone();
        }
        CounterKankan counterKankan = this.kankan;
        if (counterKankan != null) {
            counter.kankan = counterKankan.mo225055clone();
        }
        Swipes swipes = this.swipes;
        if (swipes != null) {
            counter.swipes = swipes.mo225055clone();
        }
        CounterGrowth counterGrowth = this.growth;
        if (counterGrowth != null) {
            counter.growth = counterGrowth.mo225055clone();
        }
        ProfileLike profileLike = this.profileLike;
        if (profileLike != null) {
            counter.profileLike = profileLike.mo225055clone();
        }
        CounterPickUsers counterPickUsers = this.pickUsers;
        if (counterPickUsers != null) {
            counter.pickUsers = counterPickUsers.mo225055clone();
        }
        FakeLikeLimits fakeLikeLimits = this.fakeLikeLimits;
        if (fakeLikeLimits != null) {
            counter.fakeLikeLimits = fakeLikeLimits.mo225055clone();
        }
        FeedFlower feedFlower = this.flower;
        if (feedFlower != null) {
            counter.flower = feedFlower.mo225055clone();
        }
        VerificationLimit verificationLimit = this.verification;
        if (verificationLimit != null) {
            counter.verification = verificationLimit.mo225055clone();
        }
        return counter;
    }
    ...
    public boolean shouldMergeData() {
        String strM211120v = xi5.m211120v(this.requestUrl);
        return TextUtils.isEmpty(strM211120v) || "v2".equals(strM211120v) || xi5.API_VERSION_V3.equals(xi5.m211120v(this.requestUrl));
    }
