...
public class KanPostData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<KanPostData> PROTOBUF_ADAPTER = new MessageNanoAdapter<KanPostData>() { // from class: com.p1.mobile.putong.data.KanPostData.1
        ...
        public int computeAndCacheSize(KanPostData kanPostData) {
            ...
            if (kanKanStatus != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(2, kanKanStatus.ordinal());
            }
            ...
            if (kanKanStatus2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, kanKanStatus2, KanKanStatus.PROTOBUF_ADAPTER);
            }
            kanPostData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public KanPostData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    kanPostData.url = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 26) {
                    kanPostData.backgroundColor = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 34) {
                        if (kanPostData.status == null && numValueOf != null) {
                            kanPostData.status = (KanKanStatus) KanKanStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    kanPostData.status = (KanKanStatus) nc5Var.m162488l(KanKanStatus.PROTOBUF_ADAPTER);
                }
            }
            return kanPostData;
        }
        ...
        public void serialize(KanPostData kanPostData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            KanKanStatus kanKanStatus = kanPostData.status;
            if (kanKanStatus != null) {
                codedOutputByteBufferNano.m17305G(2, kanKanStatus.ordinal());
            }
            List<String> list = kanPostData.backgroundColor;
            if (list != null) {
            ...
            KanKanStatus kanKanStatus2 = kanPostData.status;
            if (kanKanStatus2 != null) {
                codedOutputByteBufferNano.m17309K(4, kanKanStatus2, KanKanStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m61000a(String str) {
        return str;
    }
    ...
    public KanPostData mo225055clone() {
        KanPostData kanPostData = new KanPostData();
        kanPostData.url = this.url;
        kanPostData.status = this.status;
        List<String> list = this.backgroundColor;
        if (list != null) {
            kanPostData.backgroundColor = ValueObject.util_map(list, new qcj() { // from class: l.dzq
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return KanPostData.m61000a((String) obj);
                }
            });
        }
        return kanPostData;
