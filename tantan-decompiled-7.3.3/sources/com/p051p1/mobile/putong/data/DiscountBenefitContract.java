...
public class DiscountBenefitContract extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DiscountBenefitContract> PROTOBUF_ADAPTER = new MessageNanoAdapter<DiscountBenefitContract>() { // from class: com.p1.mobile.putong.data.DiscountBenefitContract.1
        ...
        public int computeAndCacheSize(DiscountBenefitContract discountBenefitContract) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, discountBenefitContract.value);
            ...
            if (privilegesChangeContract != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, privilegesChangeContract, PrivilegesChangeContract.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(5, discountBenefitContract.hasPrivilegesChange);
            discountBenefitContract.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DiscountBenefitContract parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    discountBenefitContract.discountType = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    discountBenefitContract.value = nc5Var.m162486j();
                } else if (iM162497u == 26) {
                    discountBenefitContract.showDiscount = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    discountBenefitContract.privilegesChange = (PrivilegesChangeContract) nc5Var.m162488l(PrivilegesChangeContract.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 40) {
                        if (discountBenefitContract.discountType == null) {
                            discountBenefitContract.discountType = "";
                    ...
                    discountBenefitContract.hasPrivilegesChange = nc5Var.m162483g();
                }
            }
            return discountBenefitContract;
        }
        ...
        public void serialize(DiscountBenefitContract discountBenefitContract, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, discountBenefitContract.value);
            String str2 = discountBenefitContract.showDiscount;
            if (str2 != null) {
            ...
            PrivilegesChangeContract privilegesChangeContract = discountBenefitContract.privilegesChange;
            if (privilegesChangeContract != null) {
                codedOutputByteBufferNano.m17309K(4, privilegesChangeContract, PrivilegesChangeContract.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(5, discountBenefitContract.hasPrivilegesChange);
        }
    };
    ...
    public DiscountBenefitContract mo225055clone() {
        DiscountBenefitContract discountBenefitContract = new DiscountBenefitContract();
        ...
        if (privilegesChangeContract != null) {
            discountBenefitContract.privilegesChange = privilegesChangeContract.mo225055clone();
        }
