...
public class RememberUserInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RememberUserInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<RememberUserInfo>() { // from class: com.p1.mobile.putong.data.RememberUserInfo.1
        ...
        public int computeAndCacheSize(RememberUserInfo rememberUserInfo) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, rememberUserInfo.countryCode);
            ...
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(4, rememberUserInfo.pwdLength);
            AuthData authData = rememberUserInfo.auth;
            if (authData != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(5, authData, AuthData.PROTOBUF_ADAPTER);
            }
            String str3 = rememberUserInfo.name;
            if (str3 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(6, str3);
            }
            rememberUserInfo.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RememberUserInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    rememberUserInfo.countryCode = nc5Var.m162486j();
                } else if (iM162497u == 18) {
                    rememberUserInfo.phoneNumber = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    rememberUserInfo.imgUrl = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    rememberUserInfo.pwdLength = nc5Var.m162486j();
                } else if (iM162497u == 42) {
                    rememberUserInfo.auth = (AuthData) nc5Var.m162488l(AuthData.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 50) {
                        if (rememberUserInfo.phoneNumber == null) {
                            rememberUserInfo.phoneNumber = "";
                    ...
                    rememberUserInfo.name = nc5Var.m162495s();
                }
            }
            return rememberUserInfo;
        }
        ...
        public void serialize(RememberUserInfo rememberUserInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, rememberUserInfo.countryCode);
            String str = rememberUserInfo.phoneNumber;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17305G(4, rememberUserInfo.pwdLength);
            AuthData authData = rememberUserInfo.auth;
            if (authData != null) {
                codedOutputByteBufferNano.m17309K(5, authData, AuthData.PROTOBUF_ADAPTER);
            }
            String str3 = rememberUserInfo.name;
            if (str3 != null) {
    ...
    public RememberUserInfo mo225055clone() {
        RememberUserInfo rememberUserInfo = new RememberUserInfo();
        ...
        if (authData != null) {
            rememberUserInfo.auth = authData.mo225055clone();
        }
