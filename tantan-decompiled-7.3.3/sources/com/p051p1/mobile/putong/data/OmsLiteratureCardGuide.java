...
public class OmsLiteratureCardGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OmsLiteratureCardGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<OmsLiteratureCardGuide>() { // from class: com.p1.mobile.putong.data.OmsLiteratureCardGuide.1
        ...
        public int computeAndCacheSize(OmsLiteratureCardGuide omsLiteratureCardGuide) {
            ...
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, list2, LiteratureConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Action action = omsLiteratureCardGuide.action;
            if (action != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, action, Action.PROTOBUF_ADAPTER);
            }
            String str2 = omsLiteratureCardGuide.subTitle;
            if (str2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(5, str2);
            }
            omsLiteratureCardGuide.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OmsLiteratureCardGuide parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    omsLiteratureCardGuide.pictures = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    omsLiteratureCardGuide.title = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    omsLiteratureCardGuide.literatureConfigs = (List) nc5Var.m162488l(LiteratureConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 34) {
                    omsLiteratureCardGuide.action = (Action) nc5Var.m162488l(Action.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 42) {
                        if (omsLiteratureCardGuide.pictures == null) {
                            omsLiteratureCardGuide.pictures = new ArrayList();
                    ...
                    omsLiteratureCardGuide.subTitle = nc5Var.m162495s();
                }
            }
            return omsLiteratureCardGuide;
        }
        ...
        public void serialize(OmsLiteratureCardGuide omsLiteratureCardGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<LiteratureConfig> list2 = omsLiteratureCardGuide.literatureConfigs;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(3, list2, LiteratureConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Action action = omsLiteratureCardGuide.action;
            if (action != null) {
                codedOutputByteBufferNano.m17309K(4, action, Action.PROTOBUF_ADAPTER);
            }
            String str2 = omsLiteratureCardGuide.subTitle;
            if (str2 != null) {
    ...
    public OmsLiteratureCardGuide mo225055clone() {
        OmsLiteratureCardGuide omsLiteratureCardGuide = new OmsLiteratureCardGuide();
        List<Media> list = this.pictures;
        if (list != null) {
            omsLiteratureCardGuide.pictures = ValueObject.util_map(list, new qcj() { // from class: l.fk50
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            omsLiteratureCardGuide.literatureConfigs = ValueObject.util_map(list2, new qcj() { // from class: l.gk50
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((LiteratureConfig) obj).mo225055clone();
                }
            });
        }
        Action action = this.action;
        if (action != null) {
            omsLiteratureCardGuide.action = action.mo225055clone();
        }
        return omsLiteratureCardGuide;
    }
