...
public class LetterContent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LetterContent> PROTOBUF_ADAPTER = new MessageNanoAdapter<LetterContent>() { // from class: com.p1.mobile.putong.data.LetterContent.1
        ...
        public int computeAndCacheSize(LetterContent letterContent) {
            String str = letterContent.f39612id;
            ...
            letterContent.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LetterContent parse(nc5 nc5Var) throws IOException {
            LetterContent letterContent = new LetterContent();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (letterContent.f39612id == null) {
                        letterContent.f39612id = "";
                    }
                ...
                if (iM162497u == 10) {
                    letterContent.f39612id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    letterContent.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    letterContent.content = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (letterContent.f39612id == null) {
                            letterContent.f39612id = "";
                    ...
                    letterContent.gender = nc5Var.m162495s();
                }
            }
            return letterContent;
        }
        ...
        public boolean parseField(LetterContent letterContent, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "gender":
                    ...
                    return true;
                case "id":
                    letterContent.f39612id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public LetterContent mo225055clone() {
        LetterContent letterContent = new LetterContent();
        letterContent.f39612id = this.f39612id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39612id, letterContent.f39612id) && ValueObject.util_equals(this.type, letterContent.type) && ValueObject.util_equals(this.content, letterContent.content) && ValueObject.util_equals(this.gender, letterContent.gender);
    }
