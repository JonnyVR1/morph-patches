...
public class LiveUserMask extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveUserMask> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveUserMask>() { // from class: com.p1.mobile.putong.data.LiveUserMask.1
        ...
        public int computeAndCacheSize(LiveUserMask liveUserMask) {
            String str = liveUserMask.f39626id;
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(13, liveUserMask.isFresh);
            LiveAvatarConfig liveAvatarConfig = liveUserMask.avatarConfig;
            if (liveAvatarConfig != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(14, liveAvatarConfig, LiveAvatarConfig.PROTOBUF_ADAPTER);
            }
            LiveProfileConfig liveProfileConfig = liveUserMask.profileConfig;
            if (liveProfileConfig != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(15, liveProfileConfig, LiveProfileConfig.PROTOBUF_ADAPTER);
            }
            String str13 = liveUserMask.avatarResourceType;
            if (str13 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(16, str13);
            }
            liveUserMask.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveUserMask parse(nc5 nc5Var) throws IOException {
            LiveUserMask liveUserMask = new LiveUserMask();
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        if (liveUserMask.f39626id == null) {
                            liveUserMask.f39626id = "";
                        }
                        ...
                        break;
                    case 10:
                        liveUserMask.f39626id = nc5Var.m162495s();
                        continue;
                    case 18:
                        liveUserMask.userId = nc5Var.m162495s();
                        continue;
                    case 26:
                        liveUserMask.fakeId = nc5Var.m162495s();
                        continue;
                    case 34:
                        liveUserMask.originUserId = nc5Var.m162495s();
                        continue;
                    case 42:
                        liveUserMask.type = nc5Var.m162495s();
                        continue;
                    case 50:
                        liveUserMask.fakeType = nc5Var.m162495s();
                        continue;
                    case 58:
                        liveUserMask.name = nc5Var.m162495s();
                        continue;
                    case 66:
                        liveUserMask.avatar = nc5Var.m162495s();
                        continue;
                    case 74:
                        liveUserMask.status = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        liveUserMask.color = nc5Var.m162495s();
                        continue;
                    case 90:
                        liveUserMask.gender = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        liveUserMask.icon = nc5Var.m162495s();
                        continue;
                    case 104:
                        liveUserMask.isFresh = nc5Var.m162483g();
                        continue;
                    case 114:
                        liveUserMask.avatarConfig = (LiveAvatarConfig) nc5Var.m162488l(LiveAvatarConfig.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        liveUserMask.profileConfig = (LiveProfileConfig) nc5Var.m162488l(LiveProfileConfig.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        liveUserMask.avatarResourceType = nc5Var.m162495s();
                        continue;
                    default:
                        if (liveUserMask.f39626id == null) {
                            liveUserMask.f39626id = "";
        ...
        public void serialize(LiveUserMask liveUserMask, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(13, liveUserMask.isFresh);
            LiveAvatarConfig liveAvatarConfig = liveUserMask.avatarConfig;
            if (liveAvatarConfig != null) {
                codedOutputByteBufferNano.m17309K(14, liveAvatarConfig, LiveAvatarConfig.PROTOBUF_ADAPTER);
            }
            LiveProfileConfig liveProfileConfig = liveUserMask.profileConfig;
            if (liveProfileConfig != null) {
                codedOutputByteBufferNano.m17309K(15, liveProfileConfig, LiveProfileConfig.PROTOBUF_ADAPTER);
            }
            String str13 = liveUserMask.avatarResourceType;
            if (str13 != null) {
        ...
        public boolean parseField(LiveUserMask liveUserMask, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    liveUserMask.f39626id = jsonParser.getValueAsString();
                    return false;
                case 9:
    ...
    public LiveUserMask mo225055clone() {
        LiveUserMask liveUserMask = new LiveUserMask();
        liveUserMask.f39626id = this.f39626id;
        ...
        if (liveAvatarConfig != null) {
            liveUserMask.avatarConfig = liveAvatarConfig.mo225055clone();
        }
        LiveProfileConfig liveProfileConfig = this.profileConfig;
        if (liveProfileConfig != null) {
            liveUserMask.profileConfig = liveProfileConfig.mo225055clone();
        }
