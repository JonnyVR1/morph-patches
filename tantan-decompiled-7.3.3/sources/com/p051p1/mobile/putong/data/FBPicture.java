...
public class FBPicture extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FBPicture> PROTOBUF_ADAPTER = new MessageNanoAdapter<FBPicture>() { // from class: com.p1.mobile.putong.data.FBPicture.1
        ...
        public int computeAndCacheSize(FBPicture fBPicture) {
            ...
            fBPicture.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FBPicture parse(nc5 nc5Var) throws IOException {
            FBPicture fBPicture = new FBPicture();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (fBPicture.f39601id == null) {
                        fBPicture.f39601id = "";
                    }
                ...
                if (iM162497u == 10) {
                    fBPicture.f39601id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    fBPicture.source = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    fBPicture.url = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (fBPicture.f39601id == null) {
                            fBPicture.f39601id = "";
                    ...
                    fBPicture.thumbnail = nc5Var.m162495s();
                }
            }
            return fBPicture;
        }
        ...
        public boolean parseField(FBPicture fBPicture, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "picture":
                    ...
                    return true;
                case "id":
                    fBPicture.f39601id = jsonParser.getValueAsString();
                    return false;
                case "url":
    ...
    public FBPicture mo225055clone() {
        FBPicture fBPicture = new FBPicture();
        fBPicture.f39601id = this.f39601id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39601id, fBPicture.f39601id) && ValueObject.util_equals(this.source, fBPicture.source) && ValueObject.util_equals(this.url, fBPicture.url) && ValueObject.util_equals(this.thumbnail, fBPicture.thumbnail);
    }
