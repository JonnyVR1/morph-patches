...
public class NotificationSetting extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NotificationSetting> PROTOBUF_ADAPTER = new MessageNanoAdapter<NotificationSetting>() { // from class: com.p1.mobile.putong.data.NotificationSetting.1
        ...
        public int computeAndCacheSize(NotificationSetting notificationSetting) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, notificationSetting.match) + CodedOutputByteBufferNano.m17275b(2, notificationSetting.conversation) + CodedOutputByteBufferNano.m17275b(3, notificationSetting.greeting);
            ...
            if (list2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(5, list2, MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MomentNotifyBlockType> list3 = notificationSetting.momentComment;
            if (list3 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(6, list3, MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MomentNotifyBlockType> list4 = notificationSetting.momentLike;
            if (list4 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(7, list4, MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(8, notificationSetting.momentLiked) + CodedOutputByteBufferNano.m17275b(9, notificationSetting.extremePick) + CodedOutputByteBufferNano.m17275b(10, notificationSetting.status) + CodedOutputByteBufferNano.m17275b(11, notificationSetting.group) + CodedOutputByteBufferNano.m17275b(12, notificationSetting.chatPartners);
            notificationSetting.cachedSize = iM17275b2;
            return iM17275b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NotificationSetting parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        notificationSetting.match = nc5Var.m162483g();
                        continue;
                    case 16:
                        notificationSetting.conversation = nc5Var.m162483g();
                        continue;
                    case 24:
                        notificationSetting.greeting = nc5Var.m162483g();
                        continue;
                    case 34:
                        notificationSetting.teamAccount = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        notificationSetting.momentUpdate = (List) nc5Var.m162488l(MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        notificationSetting.momentComment = (List) nc5Var.m162488l(MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        notificationSetting.momentLike = (List) nc5Var.m162488l(MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 64:
                        notificationSetting.momentLiked = nc5Var.m162483g();
                        continue;
                    case 72:
                        notificationSetting.extremePick = nc5Var.m162483g();
                        continue;
                    case 80:
                        notificationSetting.status = nc5Var.m162483g();
                        continue;
                    case 88:
                        notificationSetting.group = nc5Var.m162483g();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        notificationSetting.chatPartners = nc5Var.m162483g();
                        continue;
                    default:
                        if (notificationSetting.teamAccount == null) {
                            notificationSetting.teamAccount = new ArrayList();
        ...
        public void serialize(NotificationSetting notificationSetting, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, notificationSetting.match);
            codedOutputByteBufferNano.m17299A(2, notificationSetting.conversation);
            codedOutputByteBufferNano.m17299A(3, notificationSetting.greeting);
            List<String> list = notificationSetting.teamAccount;
            if (list != null) {
            ...
            List<MomentNotifyBlockType> list2 = notificationSetting.momentUpdate;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(5, list2, MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MomentNotifyBlockType> list3 = notificationSetting.momentComment;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(6, list3, MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<MomentNotifyBlockType> list4 = notificationSetting.momentLike;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(7, list4, MomentNotifyBlockType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17299A(8, notificationSetting.momentLiked);
            codedOutputByteBufferNano.m17299A(9, notificationSetting.extremePick);
            codedOutputByteBufferNano.m17299A(10, notificationSetting.status);
            codedOutputByteBufferNano.m17299A(11, notificationSetting.group);
            codedOutputByteBufferNano.m17299A(12, notificationSetting.chatPartners);
        }
    };
    ...
    public static /* synthetic */ MomentNotifyBlockType m61059a(MomentNotifyBlockType momentNotifyBlockType) {
        return momentNotifyBlockType;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ MomentNotifyBlockType m61060b(MomentNotifyBlockType momentNotifyBlockType) {
        return momentNotifyBlockType;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m61061c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ MomentNotifyBlockType m61062d(MomentNotifyBlockType momentNotifyBlockType) {
        return momentNotifyBlockType;
    }
    ...
    public NotificationSetting mo225055clone() {
        NotificationSetting notificationSetting = new NotificationSetting();
        ...
        if (list != null) {
            notificationSetting.teamAccount = ValueObject.util_map(list, new qcj() { // from class: l.z150
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return NotificationSetting.m61061c((String) obj);
                }
            });
        }
        List<MomentNotifyBlockType> list2 = this.momentUpdate;
        if (list2 != null) {
            notificationSetting.momentUpdate = ValueObject.util_map(list2, new qcj() { // from class: l.a250
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return NotificationSetting.m61059a((MomentNotifyBlockType) obj);
                }
            });
        }
        List<MomentNotifyBlockType> list3 = this.momentComment;
        if (list3 != null) {
            notificationSetting.momentComment = ValueObject.util_map(list3, new qcj() { // from class: l.b250
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return NotificationSetting.m61062d((MomentNotifyBlockType) obj);
                }
            });
        }
        List<MomentNotifyBlockType> list4 = this.momentLike;
        if (list4 != null) {
            notificationSetting.momentLike = ValueObject.util_map(list4, new qcj() { // from class: l.c250
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return NotificationSetting.m61060b((MomentNotifyBlockType) obj);
                }
            });
        }
