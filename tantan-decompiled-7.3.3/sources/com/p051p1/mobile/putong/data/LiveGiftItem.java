...
public class LiveGiftItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveGiftItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveGiftItem>() { // from class: com.p1.mobile.putong.data.LiveGiftItem.1
        ...
        public int computeAndCacheSize(LiveGiftItem liveGiftItem) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, liveGiftItem.f39620id);
            ...
            if (langModel != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(4, langModel, LangModel.PROTOBUF_ADAPTER);
            }
            String str3 = liveGiftItem.url;
            if (str3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(5, str3);
            }
            int iM17277d = iM17281h + CodedOutputByteBufferNano.m17277d(6, liveGiftItem.unitPrice) + CodedOutputByteBufferNano.m17277d(7, liveGiftItem.purchasePrice);
            String str4 = liveGiftItem.status;
            if (str4 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(8, str4);
            }
            String str5 = liveGiftItem.tag;
            if (str5 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(9, str5);
            }
            LangModel langModel2 = liveGiftItem.localTag;
            if (langModel2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(10, langModel2, LangModel.PROTOBUF_ADAPTER);
            }
            int iM17281h2 = iM17277d + CodedOutputByteBufferNano.m17281h(11, liveGiftItem.giftLevel) + CodedOutputByteBufferNano.m17283j(12, liveGiftItem.combosDuration) + CodedOutputByteBufferNano.m17281h(13, liveGiftItem.fastGiftNum);
            String str6 = liveGiftItem.animationType;
            if (str6 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(14, str6);
            }
            int iM17283j = iM17281h2 + CodedOutputByteBufferNano.m17283j(15, liveGiftItem.version);
            String str7 = liveGiftItem.animationUrl;
            if (str7 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(16, str7);
            }
            String str8 = liveGiftItem.startTagColor;
            if (str8 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(17, str8);
            }
            String str9 = liveGiftItem.endTagColor;
            if (str9 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(18, str9);
            }
            String str10 = liveGiftItem.tagTextColor;
            if (str10 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(19, str10);
            }
            int iM17283j2 = iM17283j + CodedOutputByteBufferNano.m17283j(20, liveGiftItem.trayDuration) + CodedOutputByteBufferNano.m17281h(21, liveGiftItem.giftSource) + CodedOutputByteBufferNano.m17281h(22, liveGiftItem.remain) + CodedOutputByteBufferNano.m17283j(23, liveGiftItem.expiredTime) + CodedOutputByteBufferNano.m17275b(24, liveGiftItem.mobileVibration);
            liveGiftItem.cachedSize = iM17283j2;
            return iM17283j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveGiftItem parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        liveGiftItem.f39620id = nc5Var.m162486j();
                        continue;
                    case 18:
                        liveGiftItem.giftType = nc5Var.m162495s();
                        continue;
                    case 26:
                        liveGiftItem.name = nc5Var.m162495s();
                        continue;
                    case 34:
                        liveGiftItem.localName = (LangModel) nc5Var.m162488l(LangModel.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        liveGiftItem.url = nc5Var.m162495s();
                        continue;
                    case 49:
                        liveGiftItem.unitPrice = nc5Var.m162484h();
                        continue;
                    case 57:
                        liveGiftItem.purchasePrice = nc5Var.m162484h();
                        continue;
                    case 66:
                        liveGiftItem.status = nc5Var.m162495s();
                        continue;
                    case 74:
                        liveGiftItem.tag = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        liveGiftItem.localTag = (LangModel) nc5Var.m162488l(LangModel.PROTOBUF_ADAPTER);
                        continue;
                    case 88:
                        liveGiftItem.giftLevel = nc5Var.m162486j();
                        continue;
                    case Opcodes.IADD /* 96 */:
                        liveGiftItem.combosDuration = nc5Var.m162487k();
                        continue;
                    case 104:
                        liveGiftItem.fastGiftNum = nc5Var.m162486j();
                        continue;
                    case 114:
                        liveGiftItem.animationType = nc5Var.m162495s();
                        continue;
                    case 120:
                        liveGiftItem.version = nc5Var.m162487k();
                        continue;
                    case 130:
                        liveGiftItem.animationUrl = nc5Var.m162495s();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        liveGiftItem.startTagColor = nc5Var.m162495s();
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        liveGiftItem.endTagColor = nc5Var.m162495s();
                        continue;
                    case 154:
                        liveGiftItem.tagTextColor = nc5Var.m162495s();
                        continue;
                    case 160:
                        liveGiftItem.trayDuration = nc5Var.m162487k();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256 /* 168 */:
                        liveGiftItem.giftSource = nc5Var.m162486j();
                        continue;
                    case 176:
                        liveGiftItem.remain = nc5Var.m162486j();
                        continue;
                    case 184:
                        liveGiftItem.expiredTime = nc5Var.m162487k();
                        continue;
                    case 192:
                        liveGiftItem.mobileVibration = nc5Var.m162483g();
                        continue;
                    default:
                        if (liveGiftItem.giftType == null) {
                            liveGiftItem.giftType = "";
        ...
        public void serialize(LiveGiftItem liveGiftItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, liveGiftItem.f39620id);
            String str = liveGiftItem.giftType;
            if (str != null) {
            ...
            LangModel langModel = liveGiftItem.localName;
            if (langModel != null) {
                codedOutputByteBufferNano.m17309K(4, langModel, LangModel.PROTOBUF_ADAPTER);
            }
            String str3 = liveGiftItem.url;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(5, str3);
            }
            codedOutputByteBufferNano.m17301C(6, liveGiftItem.unitPrice);
            codedOutputByteBufferNano.m17301C(7, liveGiftItem.purchasePrice);
            String str4 = liveGiftItem.status;
            if (str4 != null) {
            ...
            LangModel langModel2 = liveGiftItem.localTag;
            if (langModel2 != null) {
                codedOutputByteBufferNano.m17309K(10, langModel2, LangModel.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(11, liveGiftItem.giftLevel);
            codedOutputByteBufferNano.m17307I(12, liveGiftItem.combosDuration);
            codedOutputByteBufferNano.m17305G(13, liveGiftItem.fastGiftNum);
            String str6 = liveGiftItem.animationType;
            if (str6 != null) {
                codedOutputByteBufferNano.m17316R(14, str6);
            }
            codedOutputByteBufferNano.m17307I(15, liveGiftItem.version);
            String str7 = liveGiftItem.animationUrl;
            if (str7 != null) {
            ...
            String str9 = liveGiftItem.endTagColor;
            if (str9 != null) {
                codedOutputByteBufferNano.m17316R(18, str9);
            }
            String str10 = liveGiftItem.tagTextColor;
            if (str10 != null) {
                codedOutputByteBufferNano.m17316R(19, str10);
            }
            codedOutputByteBufferNano.m17307I(20, liveGiftItem.trayDuration);
            codedOutputByteBufferNano.m17305G(21, liveGiftItem.giftSource);
            codedOutputByteBufferNano.m17305G(22, liveGiftItem.remain);
            codedOutputByteBufferNano.m17307I(23, liveGiftItem.expiredTime);
            codedOutputByteBufferNano.m17299A(24, liveGiftItem.mobileVibration);
        }
    };
    public static JsonAdapter<LiveGiftItem> JSON_ADAPTER = new ObjectJsonAdapter<LiveGiftItem>() { // from class: com.p1.mobile.putong.data.LiveGiftItem.2
        ...
        public boolean parseField(LiveGiftItem liveGiftItem, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 8:
                    ...
                    return true;
                case 9:
                    liveGiftItem.f39620id = jsonParser.getValueAsInt();
                    return false;
                case 10:
        ...
        public void serializeFields(LiveGiftItem liveGiftItem, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", liveGiftItem.f39620id);
            String str = liveGiftItem.giftType;
            if (str != null) {
    ...
    public LiveGiftItem mo225055clone() {
        LiveGiftItem liveGiftItem = new LiveGiftItem();
        liveGiftItem.f39620id = this.f39620id;
        liveGiftItem.giftType = this.giftType;
        liveGiftItem.name = this.name;
        LangModel langModel = this.localName;
        if (langModel != null) {
            liveGiftItem.localName = langModel.mo225055clone();
        }
        ...
        if (langModel2 != null) {
            liveGiftItem.localTag = langModel2.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f39620id == liveGiftItem.f39620id && ValueObject.util_equals(this.giftType, liveGiftItem.giftType) && ValueObject.util_equals(this.name, liveGiftItem.name) && ValueObject.util_equals(this.localName, liveGiftItem.localName) && ValueObject.util_equals(this.url, liveGiftItem.url) && this.unitPrice == liveGiftItem.unitPrice && this.purchasePrice == liveGiftItem.purchasePrice && ValueObject.util_equals(this.status, liveGiftItem.status) && ValueObject.util_equals(this.tag, liveGiftItem.tag) && ValueObject.util_equals(this.localTag, liveGiftItem.localTag) && this.giftLevel == liveGiftItem.giftLevel && this.combosDuration == liveGiftItem.combosDuration && this.fastGiftNum == liveGiftItem.fastGiftNum && ValueObject.util_equals(this.animationType, liveGiftItem.animationType) && this.version == liveGiftItem.version && ValueObject.util_equals(this.animationUrl, liveGiftItem.animationUrl) && ValueObject.util_equals(this.startTagColor, liveGiftItem.startTagColor) && ValueObject.util_equals(this.endTagColor, liveGiftItem.endTagColor) && ValueObject.util_equals(this.tagTextColor, liveGiftItem.tagTextColor) && this.trayDuration == liveGiftItem.trayDuration && this.giftSource == liveGiftItem.giftSource && this.remain == liveGiftItem.remain && this.expiredTime == liveGiftItem.expiredTime && this.mobileVibration == liveGiftItem.mobileVibration;
    }
