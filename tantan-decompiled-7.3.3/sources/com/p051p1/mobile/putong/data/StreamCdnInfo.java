...
public class StreamCdnInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StreamCdnInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<StreamCdnInfo>() { // from class: com.p1.mobile.putong.data.StreamCdnInfo.1
        ...
        public int computeAndCacheSize(StreamCdnInfo streamCdnInfo) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, streamCdnInfo.provider) + CodedOutputByteBufferNano.m17281h(2, streamCdnInfo.businessType);
            streamCdnInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StreamCdnInfo parse(nc5 nc5Var) throws IOException {
            StreamCdnInfo streamCdnInfo = new StreamCdnInfo();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    streamCdnInfo.provider = nc5Var.m162486j();
                } else {
                    if (iM162497u != 16) {
                        return streamCdnInfo;
                    }
                    streamCdnInfo.businessType = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(StreamCdnInfo streamCdnInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, streamCdnInfo.provider);
            codedOutputByteBufferNano.m17305G(2, streamCdnInfo.businessType);
        }
    };
    ...
    public StreamCdnInfo mo225055clone() {
        StreamCdnInfo streamCdnInfo = new StreamCdnInfo();
