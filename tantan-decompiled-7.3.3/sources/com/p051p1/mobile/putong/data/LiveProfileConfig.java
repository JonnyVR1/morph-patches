...
public class LiveProfileConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveProfileConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveProfileConfig>() { // from class: com.p1.mobile.putong.data.LiveProfileConfig.1
        ...
        public int computeAndCacheSize(LiveProfileConfig liveProfileConfig) {
            ...
            int iM17285l = liveAvatarFrameConfig != null ? CodedOutputByteBufferNano.m17285l(1, liveAvatarFrameConfig, LiveAvatarFrameConfig.PROTOBUF_ADAPTER) : 0;
            LiveAvatarFrameConfig liveAvatarFrameConfig2 = liveProfileConfig.backgroundPictureConfig;
            if (liveAvatarFrameConfig2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, liveAvatarFrameConfig2, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
            LiveUserCardButtonConfig liveUserCardButtonConfig = liveProfileConfig.buttonConfig;
            if (liveUserCardButtonConfig != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, liveUserCardButtonConfig, LiveUserCardButtonConfig.PROTOBUF_ADAPTER);
            }
            ...
            if (liveUserCardWholeFrameConfig != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, liveUserCardWholeFrameConfig, LiveUserCardWholeFrameConfig.PROTOBUF_ADAPTER);
            }
            int iM17281h = iM17285l + CodedOutputByteBufferNano.m17281h(5, liveProfileConfig.profileVersion);
            liveProfileConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveProfileConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    liveProfileConfig.topFrameConfig = (LiveAvatarFrameConfig) nc5Var.m162488l(LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    liveProfileConfig.backgroundPictureConfig = (LiveAvatarFrameConfig) nc5Var.m162488l(LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    liveProfileConfig.buttonConfig = (LiveUserCardButtonConfig) nc5Var.m162488l(LiveUserCardButtonConfig.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    liveProfileConfig.wholeFrameConfig = (LiveUserCardWholeFrameConfig) nc5Var.m162488l(LiveUserCardWholeFrameConfig.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 40) {
                        if (liveProfileConfig.topFrameConfig == null) {
                            liveProfileConfig.topFrameConfig = LiveAvatarFrameConfig.new_();
                    ...
                    liveProfileConfig.profileVersion = nc5Var.m162486j();
                }
            }
            return liveProfileConfig;
        }
        ...
        public void serialize(LiveProfileConfig liveProfileConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (liveAvatarFrameConfig != null) {
                codedOutputByteBufferNano.m17309K(1, liveAvatarFrameConfig, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
            LiveAvatarFrameConfig liveAvatarFrameConfig2 = liveProfileConfig.backgroundPictureConfig;
            if (liveAvatarFrameConfig2 != null) {
                codedOutputByteBufferNano.m17309K(2, liveAvatarFrameConfig2, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
            LiveUserCardButtonConfig liveUserCardButtonConfig = liveProfileConfig.buttonConfig;
            if (liveUserCardButtonConfig != null) {
                codedOutputByteBufferNano.m17309K(3, liveUserCardButtonConfig, LiveUserCardButtonConfig.PROTOBUF_ADAPTER);
            }
            LiveUserCardWholeFrameConfig liveUserCardWholeFrameConfig = liveProfileConfig.wholeFrameConfig;
            if (liveUserCardWholeFrameConfig != null) {
                codedOutputByteBufferNano.m17309K(4, liveUserCardWholeFrameConfig, LiveUserCardWholeFrameConfig.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(5, liveProfileConfig.profileVersion);
        }
    };
    ...
    public LiveProfileConfig mo225055clone() {
        LiveProfileConfig liveProfileConfig = new LiveProfileConfig();
        LiveAvatarFrameConfig liveAvatarFrameConfig = this.topFrameConfig;
        if (liveAvatarFrameConfig != null) {
            liveProfileConfig.topFrameConfig = liveAvatarFrameConfig.mo225055clone();
        }
        LiveAvatarFrameConfig liveAvatarFrameConfig2 = this.backgroundPictureConfig;
        if (liveAvatarFrameConfig2 != null) {
            liveProfileConfig.backgroundPictureConfig = liveAvatarFrameConfig2.mo225055clone();
        }
        LiveUserCardButtonConfig liveUserCardButtonConfig = this.buttonConfig;
        if (liveUserCardButtonConfig != null) {
            liveProfileConfig.buttonConfig = liveUserCardButtonConfig.mo225055clone();
        }
        LiveUserCardWholeFrameConfig liveUserCardWholeFrameConfig = this.wholeFrameConfig;
        if (liveUserCardWholeFrameConfig != null) {
            liveProfileConfig.wholeFrameConfig = liveUserCardWholeFrameConfig.mo225055clone();
        }
