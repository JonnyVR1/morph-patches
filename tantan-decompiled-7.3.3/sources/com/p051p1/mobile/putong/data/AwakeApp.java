...
public class AwakeApp extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AwakeApp> PROTOBUF_ADAPTER = new MessageNanoAdapter<AwakeApp>() { // from class: com.p1.mobile.putong.data.AwakeApp.1
        ...
        public int computeAndCacheSize(AwakeApp awakeApp) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, awakeApp.cycleTime) + CodedOutputByteBufferNano.m17281h(6, awakeApp.count) + CodedOutputByteBufferNano.m17281h(7, awakeApp.interval) + CodedOutputByteBufferNano.m17281h(8, awakeApp.mode) + CodedOutputByteBufferNano.m17281h(9, awakeApp.isOpen);
            String str5 = awakeApp.statisticsKey;
            if (str5 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(10, str5);
            }
            awakeApp.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AwakeApp parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        awakeApp.packageName = nc5Var.m162495s();
                        continue;
                    case 18:
                        awakeApp.action = nc5Var.m162495s();
                        continue;
                    case 26:
                        awakeApp.className = nc5Var.m162495s();
                        continue;
                    case 34:
                        awakeApp.from = nc5Var.m162495s();
                        continue;
                    case 40:
                        awakeApp.cycleTime = nc5Var.m162486j();
                        continue;
                    case 48:
                        awakeApp.count = nc5Var.m162486j();
                        continue;
                    case 56:
                        awakeApp.interval = nc5Var.m162486j();
                        continue;
                    case 64:
                        awakeApp.mode = nc5Var.m162486j();
                        continue;
                    case 72:
                        awakeApp.isOpen = nc5Var.m162486j();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        awakeApp.statisticsKey = nc5Var.m162495s();
                        continue;
                    default:
                        if (awakeApp.packageName == null) {
                            awakeApp.packageName = "";
        ...
        public void serialize(AwakeApp awakeApp, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(5, awakeApp.cycleTime);
            codedOutputByteBufferNano.m17305G(6, awakeApp.count);
            codedOutputByteBufferNano.m17305G(7, awakeApp.interval);
            codedOutputByteBufferNano.m17305G(8, awakeApp.mode);
            codedOutputByteBufferNano.m17305G(9, awakeApp.isOpen);
            String str5 = awakeApp.statisticsKey;
            if (str5 != null) {
