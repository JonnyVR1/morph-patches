...
public class SpVip extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpVip> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpVip>() { // from class: com.p1.mobile.putong.data.SpVip.1
        ...
        public int computeAndCacheSize(SpVip spVip) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, spVip.isSpvip) + CodedOutputByteBufferNano.m17275b(2, spVip.isOpenMystery) + CodedOutputByteBufferNano.m17281h(3, spVip.userCode);
            spVip.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SpVip parse(nc5 nc5Var) throws IOException {
            SpVip spVip = new SpVip();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    spVip.isSpvip = nc5Var.m162483g();
                } else if (iM162497u == 16) {
                    spVip.isOpenMystery = nc5Var.m162483g();
                } else {
                    if (iM162497u != 24) {
                        return spVip;
                    }
                    spVip.userCode = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(SpVip spVip, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, spVip.isSpvip);
            codedOutputByteBufferNano.m17299A(2, spVip.isOpenMystery);
            codedOutputByteBufferNano.m17305G(3, spVip.userCode);
        }
    };
