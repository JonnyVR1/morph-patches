...
public class SoulHead extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SoulHead> PROTOBUF_ADAPTER = new MessageNanoAdapter<SoulHead>() { // from class: com.p1.mobile.putong.data.SoulHead.1
        ...
        public int computeAndCacheSize(SoulHead soulHead) {
            ...
            soulHead.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SoulHead parse(nc5 nc5Var) throws IOException {
            SoulHead soulHead = new SoulHead();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (soulHead.f39669id == null) {
                        soulHead.f39669id = "";
                    }
                ...
                if (iM162497u == 10) {
                    soulHead.f39669id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    soulHead.url = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (soulHead.f39669id == null) {
                            soulHead.f39669id = "";
                    ...
                    soulHead.gender = nc5Var.m162495s();
                }
            }
            return soulHead;
        }
        ...
        public boolean parseField(SoulHead soulHead, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "gender":
                    ...
                    return true;
                case "id":
                    soulHead.f39669id = jsonParser.getValueAsString();
                    return false;
                case "url":
    ...
    public SoulHead mo225055clone() {
        SoulHead soulHead = new SoulHead();
        soulHead.f39669id = this.f39669id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39669id, soulHead.f39669id) && ValueObject.util_equals(this.url, soulHead.url) && ValueObject.util_equals(this.gender, soulHead.gender);
    }
