...
public class OMSDialogInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSDialogInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSDialogInfo>() { // from class: com.p1.mobile.putong.data.OMSDialogInfo.1
        ...
        public int computeAndCacheSize(OMSDialogInfo oMSDialogInfo) {
            String str = oMSDialogInfo.f39633id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            String str2 = oMSDialogInfo.identifier;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(2, str2);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(3, oMSDialogInfo.version) + CodedOutputByteBufferNano.m17275b(4, oMSDialogInfo.independent);
            OMSDisplayRule oMSDisplayRule = oMSDialogInfo.constraint;
            if (oMSDisplayRule != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, oMSDisplayRule, OMSDisplayRule.PROTOBUF_ADAPTER);
            }
            OMSTriggerRule oMSTriggerRule = oMSDialogInfo.rule;
            if (oMSTriggerRule != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(6, oMSTriggerRule, OMSTriggerRule.PROTOBUF_ADAPTER);
            }
            List<TriggerEvent> list = oMSDialogInfo.events;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(7, list, TriggerEvent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OMSPositionInfo oMSPositionInfo = oMSDialogInfo.position;
            if (oMSPositionInfo != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(8, oMSPositionInfo, OMSPositionInfo.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17281h + CodedOutputByteBufferNano.m17275b(9, oMSDialogInfo.remote) + CodedOutputByteBufferNano.m17275b(10, oMSDialogInfo.blockCard);
            ...
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(12, oMSDialogInfo.cancelAble);
            OMSDialogType oMSDialogType = oMSDialogInfo.contentType;
            if (oMSDialogType != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17281h(13, oMSDialogType.ordinal());
            }
            OMSDialogContent oMSDialogContent = oMSDialogInfo.content;
            if (oMSDialogContent != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(14, oMSDialogContent, OMSDialogContent.PROTOBUF_ADAPTER);
            }
            Map<String, String> map = oMSDialogInfo.variableMap;
            if (map != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(15, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            int iM17275b3 = iM17275b2 + CodedOutputByteBufferNano.m17275b(16, oMSDialogInfo.needLanguage);
            OMSLanguageInfo oMSLanguageInfo = oMSDialogInfo.languages;
            if (oMSLanguageInfo != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17285l(17, oMSLanguageInfo, OMSLanguageInfo.PROTOBUF_ADAPTER);
            }
            OMSDialogType oMSDialogType2 = oMSDialogInfo.contentType;
            if (oMSDialogType2 != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17285l(18, oMSDialogType2, OMSDialogType.PROTOBUF_ADAPTER);
            }
            oMSDialogInfo.cachedSize = iM17275b3;
            return iM17275b3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSDialogInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        if (oMSDialogInfo.f39633id == null) {
                            oMSDialogInfo.f39633id = "";
                        }
                        ...
                        break;
                    case 10:
                        oMSDialogInfo.f39633id = nc5Var.m162495s();
                        continue;
                    case 18:
                        oMSDialogInfo.identifier = nc5Var.m162495s();
                        continue;
                    case 24:
                        oMSDialogInfo.version = nc5Var.m162486j();
                        continue;
                    case 32:
                        oMSDialogInfo.independent = nc5Var.m162483g();
                        continue;
                    case 42:
                        oMSDialogInfo.constraint = (OMSDisplayRule) nc5Var.m162488l(OMSDisplayRule.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        oMSDialogInfo.rule = (OMSTriggerRule) nc5Var.m162488l(OMSTriggerRule.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        oMSDialogInfo.events = (List) nc5Var.m162488l(TriggerEvent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 66:
                        oMSDialogInfo.position = (OMSPositionInfo) nc5Var.m162488l(OMSPositionInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 72:
                        oMSDialogInfo.remote = nc5Var.m162483g();
                        continue;
                    case 80:
                        oMSDialogInfo.blockCard = nc5Var.m162483g();
                        continue;
                    case 90:
                        oMSDialogInfo.mercury = (OmsMerCuryData) nc5Var.m162488l(OmsMerCuryData.PROTOBUF_ADAPTER);
                        continue;
                    case Opcodes.IADD /* 96 */:
                        oMSDialogInfo.cancelAble = nc5Var.m162483g();
                        continue;
                    case 104:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 114:
                        oMSDialogInfo.content = (OMSDialogContent) nc5Var.m162488l(OMSDialogContent.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        oMSDialogInfo.variableMap = (Map) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
                        continue;
                    case 128:
                        oMSDialogInfo.needLanguage = nc5Var.m162483g();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        oMSDialogInfo.languages = (OMSLanguageInfo) nc5Var.m162488l(OMSLanguageInfo.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        oMSDialogInfo.contentType = (OMSDialogType) nc5Var.m162488l(OMSDialogType.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (oMSDialogInfo.contentType == null && numValueOf != null) {
                            oMSDialogInfo.contentType = (OMSDialogType) OMSDialogType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(OMSDialogInfo oMSDialogInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(3, oMSDialogInfo.version);
            codedOutputByteBufferNano.m17299A(4, oMSDialogInfo.independent);
            OMSDisplayRule oMSDisplayRule = oMSDialogInfo.constraint;
            if (oMSDisplayRule != null) {
                codedOutputByteBufferNano.m17309K(5, oMSDisplayRule, OMSDisplayRule.PROTOBUF_ADAPTER);
            }
            OMSTriggerRule oMSTriggerRule = oMSDialogInfo.rule;
            if (oMSTriggerRule != null) {
                codedOutputByteBufferNano.m17309K(6, oMSTriggerRule, OMSTriggerRule.PROTOBUF_ADAPTER);
            }
            List<TriggerEvent> list = oMSDialogInfo.events;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(7, list, TriggerEvent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OMSPositionInfo oMSPositionInfo = oMSDialogInfo.position;
            if (oMSPositionInfo != null) {
                codedOutputByteBufferNano.m17309K(8, oMSPositionInfo, OMSPositionInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(9, oMSDialogInfo.remote);
            codedOutputByteBufferNano.m17299A(10, oMSDialogInfo.blockCard);
            OmsMerCuryData omsMerCuryData = oMSDialogInfo.mercury;
            if (omsMerCuryData != null) {
                codedOutputByteBufferNano.m17309K(11, omsMerCuryData, OmsMerCuryData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(12, oMSDialogInfo.cancelAble);
            OMSDialogType oMSDialogType = oMSDialogInfo.contentType;
            if (oMSDialogType != null) {
                codedOutputByteBufferNano.m17305G(13, oMSDialogType.ordinal());
            }
            OMSDialogContent oMSDialogContent = oMSDialogInfo.content;
            if (oMSDialogContent != null) {
                codedOutputByteBufferNano.m17309K(14, oMSDialogContent, OMSDialogContent.PROTOBUF_ADAPTER);
            }
            Map<String, String> map = oMSDialogInfo.variableMap;
            if (map != null) {
                codedOutputByteBufferNano.m17309K(15, map, ProtobufAdapter.STRING_ADAPTER.MAP_ADAPTER());
            }
            codedOutputByteBufferNano.m17299A(16, oMSDialogInfo.needLanguage);
            OMSLanguageInfo oMSLanguageInfo = oMSDialogInfo.languages;
            if (oMSLanguageInfo != null) {
                codedOutputByteBufferNano.m17309K(17, oMSLanguageInfo, OMSLanguageInfo.PROTOBUF_ADAPTER);
            }
            OMSDialogType oMSDialogType2 = oMSDialogInfo.contentType;
            if (oMSDialogType2 != null) {
                codedOutputByteBufferNano.m17309K(18, oMSDialogType2, OMSDialogType.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(OMSDialogInfo oMSDialogInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    oMSDialogInfo.f39633id = jsonParser.getValueAsString();
                    return false;
                case 9:
    ...
    public static /* synthetic */ String m61087a(String str) {
        return str;
    }
    ...
    public OMSDialogInfo mo225055clone() {
        OMSDialogInfo oMSDialogInfo = new OMSDialogInfo();
        oMSDialogInfo.f39633id = this.f39633id;
        ...
        if (oMSDisplayRule != null) {
            oMSDialogInfo.constraint = oMSDisplayRule.mo225055clone();
        }
        OMSTriggerRule oMSTriggerRule = this.rule;
        if (oMSTriggerRule != null) {
            oMSDialogInfo.rule = oMSTriggerRule.mo225055clone();
        }
        List<TriggerEvent> list = this.events;
        if (list != null) {
            oMSDialogInfo.events = ValueObject.util_map(list, new qcj() { // from class: l.i750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((TriggerEvent) obj).mo225055clone();
                }
            });
        }
        OMSPositionInfo oMSPositionInfo = this.position;
        if (oMSPositionInfo != null) {
            oMSDialogInfo.position = oMSPositionInfo.mo225055clone();
        }
        oMSDialogInfo.remote = this.remote;
        oMSDialogInfo.blockCard = this.blockCard;
        OmsMerCuryData omsMerCuryData = this.mercury;
        if (omsMerCuryData != null) {
            oMSDialogInfo.mercury = omsMerCuryData.mo225055clone();
        }
        ...
        if (oMSDialogContent != null) {
            oMSDialogInfo.content = oMSDialogContent.mo225055clone();
        }
        Map<String, String> map = this.variableMap;
        if (map != null) {
            oMSDialogInfo.variableMap = ValueObject.util_map(map, new qcj() { // from class: l.j750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OMSDialogInfo.m61087a((String) obj);
                }
            });
        }
        ...
        if (oMSLanguageInfo != null) {
            oMSDialogInfo.languages = oMSLanguageInfo.mo225055clone();
        }
        return oMSDialogInfo;
    }
