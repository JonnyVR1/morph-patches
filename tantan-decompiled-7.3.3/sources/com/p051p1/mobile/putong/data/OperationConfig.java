...
public class OperationConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OperationConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<OperationConfig>() { // from class: com.p1.mobile.putong.data.OperationConfig.1
        ...
        public int computeAndCacheSize(OperationConfig operationConfig) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, operationConfig.clickType);
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(8, operationConfig.slideValue);
            String str7 = operationConfig.shakeSound;
            if (str7 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(9, str7);
            }
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(10, operationConfig.shakeValue);
            String str8 = operationConfig.shakeContent;
            if (str8 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(11, str8);
            }
            String str9 = operationConfig.shakeContentSecond;
            if (str9 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(12, str9);
            }
            operationConfig.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OperationConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        operationConfig.skipContent = nc5Var.m162495s();
                        continue;
                    case 16:
                        operationConfig.clickType = nc5Var.m162486j();
                        continue;
                    case 26:
                        operationConfig.buttonStyle = nc5Var.m162495s();
                        continue;
                    case 34:
                        operationConfig.buttonContent = nc5Var.m162495s();
                        continue;
                    case 42:
                        operationConfig.slideImg = nc5Var.m162495s();
                        continue;
                    case 50:
                        operationConfig.slideContent = nc5Var.m162495s();
                        continue;
                    case 58:
                        operationConfig.slideContentSecond = nc5Var.m162495s();
                        continue;
                    case 64:
                        operationConfig.slideValue = nc5Var.m162486j();
                        continue;
                    case 74:
                        operationConfig.shakeSound = nc5Var.m162495s();
                        continue;
                    case 80:
                        operationConfig.shakeValue = nc5Var.m162486j();
                        continue;
                    case 90:
                        operationConfig.shakeContent = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        operationConfig.shakeContentSecond = nc5Var.m162495s();
                        continue;
                    default:
                        if (operationConfig.skipContent == null) {
                            operationConfig.skipContent = "";
        ...
        public void serialize(OperationConfig operationConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, operationConfig.clickType);
            String str2 = operationConfig.buttonStyle;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17305G(8, operationConfig.slideValue);
            String str7 = operationConfig.shakeSound;
            if (str7 != null) {
                codedOutputByteBufferNano.m17316R(9, str7);
            }
            codedOutputByteBufferNano.m17305G(10, operationConfig.shakeValue);
            String str8 = operationConfig.shakeContent;
            if (str8 != null) {
    ...
    public OperationConfig mo225055clone() {
        OperationConfig operationConfig = new OperationConfig();
