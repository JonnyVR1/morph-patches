...
public class CouterMoments extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CouterMoments> PROTOBUF_ADAPTER = new MessageNanoAdapter<CouterMoments>() { // from class: com.p1.mobile.putong.data.CouterMoments.1
        ...
        public int computeAndCacheSize(CouterMoments couterMoments) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, couterMoments.unreadMomentLikes) + CodedOutputByteBufferNano.m17281h(2, couterMoments.unreadMomentComments) + CodedOutputByteBufferNano.m17281h(3, couterMoments.unreadFeeds) + CodedOutputByteBufferNano.m17281h(4, couterMoments.unreadLikeFeeds);
            couterMoments.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CouterMoments parse(nc5 nc5Var) throws IOException {
            CouterMoments couterMoments = new CouterMoments();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    couterMoments.unreadMomentLikes = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    couterMoments.unreadMomentComments = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    couterMoments.unreadFeeds = nc5Var.m162486j();
                } else {
                    if (iM162497u != 32) {
                        return couterMoments;
                    }
                    couterMoments.unreadLikeFeeds = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(CouterMoments couterMoments, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, couterMoments.unreadMomentLikes);
            codedOutputByteBufferNano.m17305G(2, couterMoments.unreadMomentComments);
            codedOutputByteBufferNano.m17305G(3, couterMoments.unreadFeeds);
            codedOutputByteBufferNano.m17305G(4, couterMoments.unreadLikeFeeds);
        }
    };
    ...
    public CouterMoments mo225055clone() {
        CouterMoments couterMoments = new CouterMoments();
