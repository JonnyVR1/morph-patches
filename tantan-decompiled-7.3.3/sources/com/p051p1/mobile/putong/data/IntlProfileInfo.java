...
public class IntlProfileInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlProfileInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlProfileInfo>() { // from class: com.p1.mobile.putong.data.IntlProfileInfo.1
        ...
        public int computeAndCacheSize(IntlProfileInfo intlProfileInfo) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(11, intlProfileInfo.selected);
            intlProfileInfo.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlProfileInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        intlProfileInfo.key = nc5Var.m162495s();
                        continue;
                    case 18:
                        intlProfileInfo.nameZh = nc5Var.m162495s();
                        continue;
                    case 26:
                        intlProfileInfo.nameEn = nc5Var.m162495s();
                        continue;
                    case 34:
                        intlProfileInfo.nameKo = nc5Var.m162495s();
                        continue;
                    case 42:
                        intlProfileInfo.nameJa = nc5Var.m162495s();
                        continue;
                    case 50:
                        intlProfileInfo.nameIn = nc5Var.m162495s();
                        continue;
                    case 58:
                        intlProfileInfo.nameTh = nc5Var.m162495s();
                        continue;
                    case 66:
                        intlProfileInfo.nameVi = nc5Var.m162495s();
                        continue;
                    case 74:
                        intlProfileInfo.nameZhTw = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        intlProfileInfo.nameLocal = nc5Var.m162495s();
                        continue;
                    case 88:
                        intlProfileInfo.selected = nc5Var.m162483g();
                        continue;
                    default:
                        if (intlProfileInfo.key == null) {
                            intlProfileInfo.key = "";
        ...
        public void serialize(IntlProfileInfo intlProfileInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(11, intlProfileInfo.selected);
        }
    };
    ...
    public IntlProfileInfo mo225055clone() {
        IntlProfileInfo intlProfileInfo = new IntlProfileInfo();
