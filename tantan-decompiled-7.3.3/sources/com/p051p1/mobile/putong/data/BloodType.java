...
public class BloodType extends TEnum {
    ...
    public static final String f39573A = "A";

    /* JADX INFO: renamed from: AB */
    public static final String f39574AB = "AB";

    /* JADX INFO: renamed from: B */
    public static final String f39575B = "B";
    public static final TEnumJsonAdapter<BloodType> JSON_ADAPTER;

    /* JADX INFO: renamed from: O */
    public static final String f39576O = "O";
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(f39576O, 2);
        tEnumJsonAdapter.addExtJsonValue(f39574AB, 3);
        tEnumJsonAdapter.addExtJsonValue("UNKNOWN", 4);
        supportEnum.add("A");
        supportEnum.add("B");
        supportEnum.add(f39576O);
        supportEnum.add(f39574AB);
        supportEnum.add("UNKNOWN");
        _BloodType = Collections.synchronizedMap(new l01());
    }
