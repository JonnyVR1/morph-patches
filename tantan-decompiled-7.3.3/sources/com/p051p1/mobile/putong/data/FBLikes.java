...
import com.p051p1.mobile.putong.data.FBLike;
...
public class FBLikes extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FBLikes> PROTOBUF_ADAPTER = new MessageNanoAdapter<FBLikes>() { // from class: com.p1.mobile.putong.data.FBLikes.1
        ...
        public int computeAndCacheSize(FBLikes fBLikes) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, FBLike.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            fBLikes.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FBLikes parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                fBLikes.data = (List) nc5Var.m162488l(FBLike.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return fBLikes;
        }
        ...
        public void serialize(FBLikes fBLikes, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<FBLike> list = fBLikes.data;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, FBLike.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public FBLikes mo225055clone() {
        FBLikes fBLikes = new FBLikes();
        List<FBLike> list = this.data;
        if (list != null) {
            fBLikes.data = ValueObject.util_map(list, new qcj() { // from class: l.isf
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FBLike) obj).mo225055clone();
                }
            });
        }
        return fBLikes;
