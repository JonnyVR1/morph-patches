...
public class AudioSignature extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AudioSignature> PROTOBUF_ADAPTER = new MessageNanoAdapter<AudioSignature>() { // from class: com.p1.mobile.putong.data.AudioSignature.1
        ...
        public int computeAndCacheSize(AudioSignature audioSignature) {
            int iM17279f = CodedOutputByteBufferNano.m17279f(1, audioSignature.duration);
            String str = audioSignature.mediaType;
            if (str != null) {
                iM17279f += CodedOutputByteBufferNano.m17288o(2, str);
            }
            String str2 = audioSignature.url;
            if (str2 != null) {
                iM17279f += CodedOutputByteBufferNano.m17288o(3, str2);
            }
            MediaLocalStatus mediaLocalStatus = audioSignature.status;
            if (mediaLocalStatus != null) {
                iM17279f += CodedOutputByteBufferNano.m17281h(4, mediaLocalStatus.ordinal());
            }
            MediaLocalStatus mediaLocalStatus2 = audioSignature.status;
            if (mediaLocalStatus2 != null) {
                iM17279f += CodedOutputByteBufferNano.m17285l(5, mediaLocalStatus2, MediaLocalStatus.PROTOBUF_ADAPTER);
            }
            audioSignature.cachedSize = iM17279f;
            return iM17279f;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AudioSignature parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 13) {
                    audioSignature.duration = nc5Var.m162485i();
                } else if (iM162497u == 18) {
                    audioSignature.mediaType = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    audioSignature.url = nc5Var.m162495s();
                    ...
                    audioSignature.status = (MediaLocalStatus) nc5Var.m162488l(MediaLocalStatus.PROTOBUF_ADAPTER);
                }
            }
            return audioSignature;
        }
        ...
        public void serialize(AudioSignature audioSignature, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17303E(1, audioSignature.duration);
            String str = audioSignature.mediaType;
            if (str != null) {
            ...
            MediaLocalStatus mediaLocalStatus = audioSignature.status;
            if (mediaLocalStatus != null) {
                codedOutputByteBufferNano.m17305G(4, mediaLocalStatus.ordinal());
            }
            MediaLocalStatus mediaLocalStatus2 = audioSignature.status;
            if (mediaLocalStatus2 != null) {
                codedOutputByteBufferNano.m17309K(5, mediaLocalStatus2, MediaLocalStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public AudioSignature mo225055clone() {
        AudioSignature audioSignature = new AudioSignature();
