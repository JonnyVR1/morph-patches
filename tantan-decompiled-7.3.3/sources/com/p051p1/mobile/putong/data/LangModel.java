...
public class LangModel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LangModel> PROTOBUF_ADAPTER = new MessageNanoAdapter<LangModel>() { // from class: com.p1.mobile.putong.data.LangModel.1
        ...
        public int computeAndCacheSize(LangModel langModel) {
            ...
            langModel.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LangModel parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    langModel.zh_cn = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    langModel.en_us = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    langModel.id_id = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    langModel.zh_tw = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    langModel.th_th = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    langModel.ko_kr = nc5Var.m162495s();
                } else {
                    if (iM162497u != 58) {
                        if (langModel.zh_cn == null) {
                            langModel.zh_cn = "";
                    ...
                    langModel.ja_jp = nc5Var.m162495s();
                }
            }
            return langModel;
        }
    ...
    public LangModel mo225055clone() {
        LangModel langModel = new LangModel();
