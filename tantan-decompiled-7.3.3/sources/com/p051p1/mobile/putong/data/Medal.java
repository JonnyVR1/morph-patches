...
public class Medal extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Medal> PROTOBUF_ADAPTER = new MessageNanoAdapter<Medal>() { // from class: com.p1.mobile.putong.data.Medal.1
        ...
        public int computeAndCacheSize(Medal medal) {
            ...
            medal.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Medal parse(nc5 nc5Var) throws IOException {
            Medal medal = new Medal();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (medal.f39627id == null) {
                        medal.f39627id = "";
                    }
                    if (medal.url == null) {
                        medal.url = "";
                ...
                if (iM162497u == 10) {
                    medal.f39627id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    medal.url = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    medal.showPlaces = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 34) {
                    medal.name = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    medal.mainDescription = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (medal.f39627id == null) {
                            medal.f39627id = "";
                    ...
                    medal.guestDescription = nc5Var.m162495s();
                }
            }
            return medal;
        }
        ...
        public boolean parseField(Medal medal, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "mainDescription":
                    ...
                    return true;
                case "id":
                    medal.f39627id = jsonParser.getValueAsString();
                    return false;
                case "url":
    ...
    public static /* synthetic */ String m61036a(String str) {
        return str;
    }
    ...
    public Medal mo225055clone() {
        Medal medal = new Medal();
        medal.f39627id = this.f39627id;
        medal.url = this.url;
        List<String> list = this.showPlaces;
        if (list != null) {
            medal.showPlaces = ValueObject.util_map(list, new qcj() { // from class: l.rox
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return Medal.m61036a((String) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39627id, medal.f39627id) && ValueObject.util_equals(this.url, medal.url) && ValueObject.util_equals(this.showPlaces, medal.showPlaces) && ValueObject.util_equals(this.name, medal.name) && ValueObject.util_equals(this.mainDescription, medal.mainDescription) && ValueObject.util_equals(this.guestDescription, medal.guestDescription);
    }
