...
public class StickerInfo extends DbObject<StickerInfo> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StickerInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<StickerInfo>() { // from class: com.p1.mobile.putong.data.StickerInfo.1
        ...
        public int computeAndCacheSize(StickerInfo stickerInfo) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, stickerInfo._id);
            String str = stickerInfo.f56859id;
            if (str != null) {
            ...
            int iM17283j2 = iM17283j + CodedOutputByteBufferNano.m17283j(54, stickerInfo.seq);
            String str4 = stickerInfo.hash;
            if (str4 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17288o(55, str4);
            }
            String str5 = stickerInfo.status;
            if (str5 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17288o(56, str5);
            }
            StickerSourceInfo stickerSourceInfo = stickerInfo.source;
            if (stickerSourceInfo != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17285l(57, stickerSourceInfo, StickerSourceInfo.PROTOBUF_ADAPTER);
            }
            stickerInfo.cachedSize = iM17283j2;
            return iM17283j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StickerInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    stickerInfo._id = nc5Var.m162487k();
                } else if (iM162497u == 18) {
                    stickerInfo.f56859id = nc5Var.m162495s();
                } else if (iM162497u == 410) {
                    stickerInfo.package_ = nc5Var.m162495s();
                } else if (iM162497u == 418) {
                    stickerInfo.name = nc5Var.m162495s();
                } else if (iM162497u == 426) {
                    stickerInfo.pictures = (List) nc5Var.m162488l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 432) {
                    stickerInfo.seq = nc5Var.m162487k();
                } else if (iM162497u == 442) {
                    stickerInfo.hash = nc5Var.m162495s();
                } else if (iM162497u == 450) {
                    stickerInfo.status = nc5Var.m162495s();
                } else {
                    if (iM162497u != 458) {
                        if (stickerInfo.package_ == null) {
                            stickerInfo.package_ = "";
                    ...
                    stickerInfo.source = (StickerSourceInfo) nc5Var.m162488l(StickerSourceInfo.PROTOBUF_ADAPTER);
                }
            }
            return stickerInfo;
        }
        ...
        public void serialize(StickerInfo stickerInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, stickerInfo._id);
            String str = stickerInfo.f56859id;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17307I(54, stickerInfo.seq);
            String str4 = stickerInfo.hash;
            if (str4 != null) {
            ...
            StickerSourceInfo stickerSourceInfo = stickerInfo.source;
            if (stickerSourceInfo != null) {
                codedOutputByteBufferNano.m17309K(57, stickerSourceInfo, StickerSourceInfo.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(StickerInfo stickerInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "pictures":
                    ...
                    return true;
                case "id":
                    stickerInfo.f56859id = jsonParser.getValueAsString();
                    return false;
                case "seq":
    ...
    public static final StringColumn<StickerInfo> f39670ID = new StringColumn<StickerInfo>("id_c") { // from class: com.p1.mobile.putong.data.StickerInfo.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(StickerInfo stickerInfo) {
            return stickerInfo.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(StickerInfo stickerInfo, String str) {
            stickerInfo.f56859id = str;
        }
    };
    ...
    public static vzf0<StickerInfo> DB_ADAPTER = new vzf0<StickerInfo>() { // from class: com.p1.mobile.putong.data.StickerInfo.12
        @Override // p153l.vzf0
        public String CREATE_TABLE(wzh0 wzh0Var) {
            return "CREATE TABLE IF NOT EXISTS " + wzh0Var.f191760d + " (_id INTEGER PRIMARY KEY,id_c TEXT,package__c TEXT,name_c TEXT,pictures_c BLOB,seq_c INTEGER,hash_c TEXT,status_c TEXT,source_c TEXT)";
        }
        ...
        public StickerInfo read(Cursor cursor, int i) {
            ...
            try {
                ...
                stickerInfo.f56859id = cursor.isNull(i2) ? null : cursor.getString(i2);
                int i3 = i + 2;
        ...
        public void write(StickerInfo stickerInfo, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", stickerInfo.f56859id);
    ...
    public StickerInfo mo225055clone() {
        StickerInfo stickerInfo = new StickerInfo();
        stickerInfo._id = this._id;
        stickerInfo.f56859id = this.f56859id;
        stickerInfo.package_ = this.package_;
        stickerInfo.name = this.name;
        List<Picture> list = this.pictures;
        if (list != null) {
            stickerInfo.pictures = ValueObject.util_map(list, new qcj() { // from class: l.m5g0
                @Override // p153l.qcj
