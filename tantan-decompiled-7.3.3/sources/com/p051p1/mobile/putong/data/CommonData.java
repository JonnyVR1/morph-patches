...
import com.p051p1.mobile.putong.data.AvatarFrameConfig;
...
import com.p051p1.mobile.putong.data.VisitorStatistics;
...
public class CommonData extends BaseData implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CommonData> PROTOBUF_ADAPTER = new MessageNanoAdapter<CommonData>() { // from class: com.p1.mobile.putong.data.CommonData.1
        ...
        public int computeAndCacheSize(CommonData commonData) {
            ...
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, list2, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Device> list3 = commonData.devices;
            if (list3 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, list3, Device.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Connector connector = commonData.connector;
            if (connector != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, connector, Connector.PROTOBUF_ADAPTER);
            }
            List<VerificationToken> list4 = commonData.verificationTokens;
            if (list4 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, list4, VerificationToken.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Link> list5 = commonData.links;
            if (list5 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(6, list5, Link.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Detect detect = commonData.detect;
            if (detect != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(7, detect, Detect.PROTOBUF_ADAPTER);
            }
            List<RecommendMessage> list6 = commonData.recommendMessage;
            if (list6 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(8, list6, RecommendMessage.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ReflectResponse> list7 = commonData.raySequences;
            if (list7 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(9, list7, ReflectResponse.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (sliderData != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(11, sliderData, SliderData.PROTOBUF_ADAPTER);
            }
            VisitorInfo visitorInfo = commonData.visitorInfo;
            if (visitorInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(12, visitorInfo, VisitorInfo.PROTOBUF_ADAPTER);
            }
            List<VisitorStatistics> list8 = commonData.visitorStatistics;
            if (list8 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(13, list8, VisitorStatistics.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            VisitorCounter visitorCounter = commonData.visitorCounter;
            if (visitorCounter != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(14, visitorCounter, VisitorCounter.PROTOBUF_ADAPTER);
            }
            List<AvatarFrameConfig> list9 = commonData.avatarFrameConfiguration;
            if (list9 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(15, list9, AvatarFrameConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LiveRightCDN liveRightCDN = commonData.liveRightCDN;
            if (liveRightCDN != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(16, liveRightCDN, LiveRightCDN.PROTOBUF_ADAPTER);
            }
            AdConfiguration adConfiguration = commonData.adConfiguration;
            if (adConfiguration != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(17, adConfiguration, AdConfiguration.PROTOBUF_ADAPTER);
            }
            AdRewardResult adRewardResult = commonData.adReward;
            if (adRewardResult != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(18, adRewardResult, AdRewardResult.PROTOBUF_ADAPTER);
            }
            List<UserPictureTags> list10 = commonData.pictureTags;
            if (list10 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(19, list10, UserPictureTags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UserActivityInfo userActivityInfo = commonData.userActivityInfo;
            if (userActivityInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(20, userActivityInfo, UserActivityInfo.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17285l + CodedOutputByteBufferNano.m17275b(21, commonData.newGuide) + CodedOutputByteBufferNano.m17275b(22, commonData.popUps) + CodedOutputByteBufferNano.m17275b(23, commonData.showDialog);
            String str2 = commonData.type;
            if (str2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(24, str2);
            }
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(25, commonData.showEntrance);
            Mobile mobile = commonData.mobile;
            if (mobile != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(26, mobile, Mobile.PROTOBUF_ADAPTER);
            }
            String str3 = commonData.email;
            if (str3 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(27, str3);
            }
            ThirdParty thirdParty = commonData.thirdparty;
            if (thirdParty != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(28, thirdParty, ThirdParty.PROTOBUF_ADAPTER);
            }
            Token token = commonData.token;
            if (token != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(29, token, Token.PROTOBUF_ADAPTER);
            }
            ThirdPartyEmail thirdPartyEmail = commonData.thirdpartyEmail;
            if (thirdPartyEmail != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(30, thirdPartyEmail, ThirdPartyEmail.PROTOBUF_ADAPTER);
            }
            commonData.cachedSize = iM17275b2;
            return iM17275b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CommonData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        commonData.users = (List) nc5Var.m162488l(User.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        commonData.media = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 26:
                        commonData.devices = (List) nc5Var.m162488l(Device.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        commonData.connector = (Connector) nc5Var.m162488l(Connector.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        commonData.verificationTokens = (List) nc5Var.m162488l(VerificationToken.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        commonData.links = (List) nc5Var.m162488l(Link.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        commonData.detect = (Detect) nc5Var.m162488l(Detect.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        commonData.recommendMessage = (List) nc5Var.m162488l(RecommendMessage.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        commonData.raySequences = (List) nc5Var.m162488l(ReflectResponse.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        commonData.stage = nc5Var.m162495s();
                        continue;
                    case 90:
                        commonData.captcha = (SliderData) nc5Var.m162488l(SliderData.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        commonData.visitorInfo = (VisitorInfo) nc5Var.m162488l(VisitorInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        commonData.visitorStatistics = (List) nc5Var.m162488l(VisitorStatistics.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 114:
                        commonData.visitorCounter = (VisitorCounter) nc5Var.m162488l(VisitorCounter.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        commonData.avatarFrameConfiguration = (List) nc5Var.m162488l(AvatarFrameConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 130:
                        commonData.liveRightCDN = (LiveRightCDN) nc5Var.m162488l(LiveRightCDN.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        commonData.adConfiguration = (AdConfiguration) nc5Var.m162488l(AdConfiguration.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        commonData.adReward = (AdRewardResult) nc5Var.m162488l(AdRewardResult.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        commonData.pictureTags = (List) nc5Var.m162488l(UserPictureTags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 162:
                        commonData.userActivityInfo = (UserActivityInfo) nc5Var.m162488l(UserActivityInfo.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256 /* 168 */:
                        commonData.newGuide = nc5Var.m162483g();
                        continue;
                    case 176:
                        commonData.popUps = nc5Var.m162483g();
                        continue;
                    case 184:
                        commonData.showDialog = nc5Var.m162483g();
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        commonData.type = nc5Var.m162495s();
                        continue;
                    case 200:
                        commonData.showEntrance = nc5Var.m162483g();
                        continue;
                    case 210:
                        commonData.mobile = (Mobile) nc5Var.m162488l(Mobile.PROTOBUF_ADAPTER);
                        continue;
                    case 218:
                        commonData.email = nc5Var.m162495s();
                        continue;
                    case 226:
                        commonData.thirdparty = (ThirdParty) nc5Var.m162488l(ThirdParty.PROTOBUF_ADAPTER);
                        continue;
                    case 234:
                        commonData.token = (Token) nc5Var.m162488l(Token.PROTOBUF_ADAPTER);
                        continue;
                    case 242:
                        commonData.thirdpartyEmail = (ThirdPartyEmail) nc5Var.m162488l(ThirdPartyEmail.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (commonData.users == null) {
                            commonData.users = new ArrayList();
        ...
        public void serialize(CommonData commonData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<Media> list2 = commonData.media;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(2, list2, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Device> list3 = commonData.devices;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(3, list3, Device.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Connector connector = commonData.connector;
            if (connector != null) {
                codedOutputByteBufferNano.m17309K(4, connector, Connector.PROTOBUF_ADAPTER);
            }
            List<VerificationToken> list4 = commonData.verificationTokens;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(5, list4, VerificationToken.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Link> list5 = commonData.links;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(6, list5, Link.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Detect detect = commonData.detect;
            if (detect != null) {
                codedOutputByteBufferNano.m17309K(7, detect, Detect.PROTOBUF_ADAPTER);
            }
            List<RecommendMessage> list6 = commonData.recommendMessage;
            if (list6 != null) {
                codedOutputByteBufferNano.m17309K(8, list6, RecommendMessage.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ReflectResponse> list7 = commonData.raySequences;
            if (list7 != null) {
                codedOutputByteBufferNano.m17309K(9, list7, ReflectResponse.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = commonData.stage;
            if (str != null) {
            ...
            SliderData sliderData = commonData.captcha;
            if (sliderData != null) {
                codedOutputByteBufferNano.m17309K(11, sliderData, SliderData.PROTOBUF_ADAPTER);
            }
            VisitorInfo visitorInfo = commonData.visitorInfo;
            if (visitorInfo != null) {
                codedOutputByteBufferNano.m17309K(12, visitorInfo, VisitorInfo.PROTOBUF_ADAPTER);
            }
            List<VisitorStatistics> list8 = commonData.visitorStatistics;
            if (list8 != null) {
                codedOutputByteBufferNano.m17309K(13, list8, VisitorStatistics.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            VisitorCounter visitorCounter = commonData.visitorCounter;
            if (visitorCounter != null) {
                codedOutputByteBufferNano.m17309K(14, visitorCounter, VisitorCounter.PROTOBUF_ADAPTER);
            }
            List<AvatarFrameConfig> list9 = commonData.avatarFrameConfiguration;
            if (list9 != null) {
                codedOutputByteBufferNano.m17309K(15, list9, AvatarFrameConfig.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            LiveRightCDN liveRightCDN = commonData.liveRightCDN;
            if (liveRightCDN != null) {
                codedOutputByteBufferNano.m17309K(16, liveRightCDN, LiveRightCDN.PROTOBUF_ADAPTER);
            }
            AdConfiguration adConfiguration = commonData.adConfiguration;
            if (adConfiguration != null) {
                codedOutputByteBufferNano.m17309K(17, adConfiguration, AdConfiguration.PROTOBUF_ADAPTER);
            }
            AdRewardResult adRewardResult = commonData.adReward;
            if (adRewardResult != null) {
                codedOutputByteBufferNano.m17309K(18, adRewardResult, AdRewardResult.PROTOBUF_ADAPTER);
            }
            List<UserPictureTags> list10 = commonData.pictureTags;
            if (list10 != null) {
                codedOutputByteBufferNano.m17309K(19, list10, UserPictureTags.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            UserActivityInfo userActivityInfo = commonData.userActivityInfo;
            if (userActivityInfo != null) {
                codedOutputByteBufferNano.m17309K(20, userActivityInfo, UserActivityInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(21, commonData.newGuide);
            codedOutputByteBufferNano.m17299A(22, commonData.popUps);
            codedOutputByteBufferNano.m17299A(23, commonData.showDialog);
            String str2 = commonData.type;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(24, str2);
            }
            codedOutputByteBufferNano.m17299A(25, commonData.showEntrance);
            Mobile mobile = commonData.mobile;
            if (mobile != null) {
                codedOutputByteBufferNano.m17309K(26, mobile, Mobile.PROTOBUF_ADAPTER);
            }
            String str3 = commonData.email;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(27, str3);
            }
            ThirdParty thirdParty = commonData.thirdparty;
            if (thirdParty != null) {
                codedOutputByteBufferNano.m17309K(28, thirdParty, ThirdParty.PROTOBUF_ADAPTER);
            }
            Token token = commonData.token;
            if (token != null) {
                codedOutputByteBufferNano.m17309K(29, token, Token.PROTOBUF_ADAPTER);
            }
            ThirdPartyEmail thirdPartyEmail = commonData.thirdpartyEmail;
            if (thirdPartyEmail != null) {
                codedOutputByteBufferNano.m17309K(30, thirdPartyEmail, ThirdPartyEmail.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public void addAll(BaseData baseData) {
        ...
        if (baseData instanceof CommonData) {
            ...
            if (NullChecker.m82486a(commonData.media)) {
                if (this.media == null) {
    ...
    public CommonData mo225055clone() {
        CommonData commonData = new CommonData();
        List<User> list = this.users;
        if (list != null) {
            commonData.users = ValueObject.util_map(list, new qcj() { // from class: l.kj5
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            commonData.media = ValueObject.util_map(list2, new qcj() { // from class: l.lj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list3 != null) {
            commonData.devices = ValueObject.util_map(list3, new qcj() { // from class: l.mj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Device) obj).mo225055clone();
                }
            });
        }
        Connector connector = this.connector;
        if (connector != null) {
            commonData.connector = connector.mo225055clone();
        }
        List<VerificationToken> list4 = this.verificationTokens;
        if (list4 != null) {
            commonData.verificationTokens = ValueObject.util_map(list4, new qcj() { // from class: l.nj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list5 != null) {
            commonData.links = ValueObject.util_map(list5, new qcj() { // from class: l.oj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (detect != null) {
            commonData.detect = detect.mo225055clone();
        }
        List<RecommendMessage> list6 = this.recommendMessage;
        if (list6 != null) {
            commonData.recommendMessage = ValueObject.util_map(list6, new qcj() { // from class: l.pj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list7 != null) {
            commonData.raySequences = ValueObject.util_map(list7, new qcj() { // from class: l.qj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((ReflectResponse) obj).mo225055clone();
                }
            });
        }
        ...
        if (sliderData != null) {
            commonData.captcha = sliderData.mo225055clone();
        }
        VisitorInfo visitorInfo = this.visitorInfo;
        if (visitorInfo != null) {
            commonData.visitorInfo = visitorInfo.mo225055clone();
        }
        List<VisitorStatistics> list8 = this.visitorStatistics;
        if (list8 != null) {
            commonData.visitorStatistics = ValueObject.util_map(list8, new qcj() { // from class: l.rj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((VisitorStatistics) obj).mo225055clone();
                }
            });
        }
        VisitorCounter visitorCounter = this.visitorCounter;
        if (visitorCounter != null) {
            commonData.visitorCounter = visitorCounter.mo225055clone();
        }
        List<AvatarFrameConfig> list9 = this.avatarFrameConfiguration;
        if (list9 != null) {
            commonData.avatarFrameConfiguration = ValueObject.util_map(list9, new qcj() { // from class: l.sj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((AvatarFrameConfig) obj).mo225055clone();
                }
            });
        }
        LiveRightCDN liveRightCDN = this.liveRightCDN;
        if (liveRightCDN != null) {
            commonData.liveRightCDN = liveRightCDN.mo225055clone();
        }
        AdConfiguration adConfiguration = this.adConfiguration;
        if (adConfiguration != null) {
            commonData.adConfiguration = adConfiguration.mo225055clone();
        }
        AdRewardResult adRewardResult = this.adReward;
        if (adRewardResult != null) {
            commonData.adReward = adRewardResult.mo225055clone();
        }
        List<UserPictureTags> list10 = this.pictureTags;
        if (list10 != null) {
            commonData.pictureTags = ValueObject.util_map(list10, new qcj() { // from class: l.tj5
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((UserPictureTags) obj).mo225055clone();
                }
            });
        }
        UserActivityInfo userActivityInfo = this.userActivityInfo;
        if (userActivityInfo != null) {
            commonData.userActivityInfo = userActivityInfo.mo225055clone();
        }
        ...
        if (mobile != null) {
            commonData.mobile = mobile.mo225055clone();
        }
        commonData.email = this.email;
        ThirdParty thirdParty = this.thirdparty;
        if (thirdParty != null) {
            commonData.thirdparty = thirdParty.mo225055clone();
        }
        Token token = this.token;
        if (token != null) {
            commonData.token = token.mo225055clone();
        }
        ThirdPartyEmail thirdPartyEmail = this.thirdpartyEmail;
        if (thirdPartyEmail != null) {
            commonData.thirdpartyEmail = thirdPartyEmail.mo225055clone();
        }
        return commonData;
    }
