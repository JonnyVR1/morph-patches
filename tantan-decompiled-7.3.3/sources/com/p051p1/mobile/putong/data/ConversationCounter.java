...
public class ConversationCounter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConversationCounter> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConversationCounter>() { // from class: com.p1.mobile.putong.data.ConversationCounter.1
        ...
        public int computeAndCacheSize(ConversationCounter conversationCounter) {
            ...
            int iM17285l = counterConversations != null ? CodedOutputByteBufferNano.m17285l(1, counterConversations, CounterConversations.PROTOBUF_ADAPTER) : 0;
            CounterMessages counterMessages = conversationCounter.messages;
            if (counterMessages != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, counterMessages, CounterMessages.PROTOBUF_ADAPTER);
            }
            int iM17277d = iM17285l + CodedOutputByteBufferNano.m17277d(3, conversationCounter.updatedTime);
            CounterMessages counterMessages2 = conversationCounter.groupMessages;
            if (counterMessages2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(4, counterMessages2, CounterMessages.PROTOBUF_ADAPTER);
            }
            CounterConversations counterConversations2 = conversationCounter.groupConversations;
            if (counterConversations2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(5, counterConversations2, CounterConversations.PROTOBUF_ADAPTER);
            }
            conversationCounter.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConversationCounter parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    conversationCounter.conversations = (CounterConversations) nc5Var.m162488l(CounterConversations.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    conversationCounter.messages = (CounterMessages) nc5Var.m162488l(CounterMessages.PROTOBUF_ADAPTER);
                } else if (iM162497u == 25) {
                    conversationCounter.updatedTime = nc5Var.m162484h();
                } else if (iM162497u == 34) {
                    conversationCounter.groupMessages = (CounterMessages) nc5Var.m162488l(CounterMessages.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 42) {
                        if (conversationCounter.conversations == null) {
                            conversationCounter.conversations = CounterConversations.new_();
                    ...
                    conversationCounter.groupConversations = (CounterConversations) nc5Var.m162488l(CounterConversations.PROTOBUF_ADAPTER);
                }
            }
            return conversationCounter;
        }
        ...
        public void serialize(ConversationCounter conversationCounter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (counterConversations != null) {
                codedOutputByteBufferNano.m17309K(1, counterConversations, CounterConversations.PROTOBUF_ADAPTER);
            }
            CounterMessages counterMessages = conversationCounter.messages;
            if (counterMessages != null) {
                codedOutputByteBufferNano.m17309K(2, counterMessages, CounterMessages.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17301C(3, conversationCounter.updatedTime);
            CounterMessages counterMessages2 = conversationCounter.groupMessages;
            if (counterMessages2 != null) {
                codedOutputByteBufferNano.m17309K(4, counterMessages2, CounterMessages.PROTOBUF_ADAPTER);
            }
            CounterConversations counterConversations2 = conversationCounter.groupConversations;
            if (counterConversations2 != null) {
                codedOutputByteBufferNano.m17309K(5, counterConversations2, CounterConversations.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ConversationCounter mo225055clone() {
        ConversationCounter conversationCounter = new ConversationCounter();
        CounterConversations counterConversations = this.conversations;
        if (counterConversations != null) {
            conversationCounter.conversations = counterConversations.mo225055clone();
        }
        CounterMessages counterMessages = this.messages;
        if (counterMessages != null) {
            conversationCounter.messages = counterMessages.mo225055clone();
        }
        conversationCounter.updatedTime = this.updatedTime;
        CounterMessages counterMessages2 = this.groupMessages;
        if (counterMessages2 != null) {
            conversationCounter.groupMessages = counterMessages2.mo225055clone();
        }
        CounterConversations counterConversations2 = this.groupConversations;
        if (counterConversations2 != null) {
            conversationCounter.groupConversations = counterConversations2.mo225055clone();
        }
        return conversationCounter;
    }
