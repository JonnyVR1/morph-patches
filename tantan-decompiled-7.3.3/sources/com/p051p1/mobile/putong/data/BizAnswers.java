...
import com.p051p1.mobile.putong.data.IceBreaking;
...
public class BizAnswers extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BizAnswers> PROTOBUF_ADAPTER = new MessageNanoAdapter<BizAnswers>() { // from class: com.p1.mobile.putong.data.BizAnswers.1
        ...
        public int computeAndCacheSize(BizAnswers bizAnswers) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, IceBreaking.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            List<IceBreaking> list2 = bizAnswers.mate;
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, list2, IceBreaking.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            bizAnswers.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BizAnswers parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bizAnswers.iceBreaking = (List) nc5Var.m162488l(IceBreaking.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (bizAnswers.iceBreaking == null) {
                            bizAnswers.iceBreaking = new ArrayList();
                    ...
                    bizAnswers.mate = (List) nc5Var.m162488l(IceBreaking.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return bizAnswers;
        }
        ...
        public void serialize(BizAnswers bizAnswers, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<IceBreaking> list = bizAnswers.iceBreaking;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, IceBreaking.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<IceBreaking> list2 = bizAnswers.mate;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(2, list2, IceBreaking.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public BizAnswers mo225055clone() {
        BizAnswers bizAnswers = new BizAnswers();
        List<IceBreaking> list = this.iceBreaking;
        if (list != null) {
            bizAnswers.iceBreaking = ValueObject.util_map(list, new qcj() { // from class: l.r33
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((IceBreaking) obj).mo225055clone();
                }
            });
        }
        List<IceBreaking> list2 = this.mate;
        if (list2 != null) {
            bizAnswers.mate = ValueObject.util_map(list2, new qcj() { // from class: l.s33
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((IceBreaking) obj).mo225055clone();
                }
