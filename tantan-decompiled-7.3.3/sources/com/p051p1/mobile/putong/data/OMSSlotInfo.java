...
public class OMSSlotInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSSlotInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSSlotInfo>() { // from class: com.p1.mobile.putong.data.OMSSlotInfo.1
        ...
        public int computeAndCacheSize(OMSSlotInfo oMSSlotInfo) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, NearbyBanner.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            oMSSlotInfo.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSSlotInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                oMSSlotInfo.nearbyBanners = (List) nc5Var.m162488l(NearbyBanner.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return oMSSlotInfo;
        }
        ...
        public void serialize(OMSSlotInfo oMSSlotInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<NearbyBanner> list = oMSSlotInfo.nearbyBanners;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, NearbyBanner.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public OMSSlotInfo mo225055clone() {
        OMSSlotInfo oMSSlotInfo = new OMSSlotInfo();
        List<NearbyBanner> list = this.nearbyBanners;
        if (list != null) {
            oMSSlotInfo.nearbyBanners = ValueObject.util_map(list, new qcj() { // from class: l.z750
                @Override // p153l.qcj
