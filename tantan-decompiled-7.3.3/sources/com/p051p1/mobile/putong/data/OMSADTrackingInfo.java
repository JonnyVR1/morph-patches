...
import com.p051p1.mobile.putong.data.OMSADTrackingInfo;
...
public class OMSADTrackingInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSADTrackingInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSADTrackingInfo>() { // from class: com.p1.mobile.putong.data.OMSADTrackingInfo.1
        ...
        public int computeAndCacheSize(OMSADTrackingInfo oMSADTrackingInfo) {
            ...
            oMSADTrackingInfo.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSADTrackingInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    oMSADTrackingInfo.viewURLs = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (oMSADTrackingInfo.viewURLs == null) {
                            oMSADTrackingInfo.viewURLs = new ArrayList();
                    ...
                    oMSADTrackingInfo.clickURLs = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return oMSADTrackingInfo;
        }
    ...
    public static /* synthetic */ String m61063a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m61064b(String str) {
        return str;
    }
    ...
    public OMSADTrackingInfo mo225055clone() {
        OMSADTrackingInfo oMSADTrackingInfo = new OMSADTrackingInfo();
        List<String> list = this.viewURLs;
        if (list != null) {
            oMSADTrackingInfo.viewURLs = ValueObject.util_map(list, new qcj() { // from class: l.k650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OMSADTrackingInfo.m61064b((String) obj);
                }
            });
        }
        List<String> list2 = this.clickURLs;
        if (list2 != null) {
            oMSADTrackingInfo.clickURLs = ValueObject.util_map(list2, new qcj() { // from class: l.l650
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OMSADTrackingInfo.m61063a((String) obj);
                }
            });
        }
        return oMSADTrackingInfo;
