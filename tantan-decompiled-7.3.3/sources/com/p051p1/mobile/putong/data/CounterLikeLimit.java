...
public class CounterLikeLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CounterLikeLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<CounterLikeLimit>() { // from class: com.p1.mobile.putong.data.CounterLikeLimit.1
        ...
        public int computeAndCacheSize(CounterLikeLimit counterLikeLimit) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, counterLikeLimit.remaining) + CodedOutputByteBufferNano.m17281h(2, counterLikeLimit.total) + CodedOutputByteBufferNano.m17281h(3, counterLikeLimit.reset) + CodedOutputByteBufferNano.m17283j(4, counterLikeLimit.serverTime) + CodedOutputByteBufferNano.m17281h(5, counterLikeLimit.count) + CodedOutputByteBufferNano.m17281h(6, counterLikeLimit.tribeTotalCount) + CodedOutputByteBufferNano.m17281h(7, counterLikeLimit.tribeRemaining);
            counterLikeLimit.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CounterLikeLimit parse(nc5 nc5Var) throws IOException {
            CounterLikeLimit counterLikeLimit = new CounterLikeLimit();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    counterLikeLimit.remaining = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    counterLikeLimit.total = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    counterLikeLimit.reset = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    counterLikeLimit.serverTime = nc5Var.m162487k();
                } else if (iM162497u == 40) {
                    counterLikeLimit.count = nc5Var.m162486j();
                } else if (iM162497u == 48) {
                    counterLikeLimit.tribeTotalCount = nc5Var.m162486j();
                } else {
                    if (iM162497u != 56) {
                        return counterLikeLimit;
                    }
                    counterLikeLimit.tribeRemaining = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(CounterLikeLimit counterLikeLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, counterLikeLimit.remaining);
            codedOutputByteBufferNano.m17305G(2, counterLikeLimit.total);
            codedOutputByteBufferNano.m17305G(3, counterLikeLimit.reset);
            codedOutputByteBufferNano.m17307I(4, counterLikeLimit.serverTime);
            codedOutputByteBufferNano.m17305G(5, counterLikeLimit.count);
            codedOutputByteBufferNano.m17305G(6, counterLikeLimit.tribeTotalCount);
            codedOutputByteBufferNano.m17305G(7, counterLikeLimit.tribeRemaining);
        }
    };
    ...
    public CounterLikeLimit mo225055clone() {
        CounterLikeLimit counterLikeLimit = new CounterLikeLimit();
    ...
    public void onApiParseComplete() {
        this.serverTime = uqb0.f180376H.guessedCurrentServerTime();
    }

    public long resetNowMillis() {
        return (((long) (this.reset * 1000)) + this.serverTime) - uqb0.f180376H.guessedCurrentServerTime();
    }
