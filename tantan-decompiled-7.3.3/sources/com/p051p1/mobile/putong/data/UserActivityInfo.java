...
public class UserActivityInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserActivityInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserActivityInfo>() { // from class: com.p1.mobile.putong.data.UserActivityInfo.1
        ...
        public int computeAndCacheSize(UserActivityInfo userActivityInfo) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, list, UserActivityInfoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(3, userActivityInfo.actorPrivilege);
            userActivityInfo.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserActivityInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    userActivityInfo.userId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    userActivityInfo.activityInfos = (List) nc5Var.m162488l(UserActivityInfoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 24) {
                        if (userActivityInfo.userId == null) {
                            userActivityInfo.userId = "";
                    ...
                    userActivityInfo.actorPrivilege = nc5Var.m162483g();
                }
            }
            return userActivityInfo;
        }
        ...
        public void serialize(UserActivityInfo userActivityInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<UserActivityInfoItem> list = userActivityInfo.activityInfos;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, UserActivityInfoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17299A(3, userActivityInfo.actorPrivilege);
        }
    };
    ...
    public UserActivityInfo mo225055clone() {
        UserActivityInfo userActivityInfo = new UserActivityInfo();
        ...
        if (list != null) {
            userActivityInfo.activityInfos = ValueObject.util_map(list, new qcj() { // from class: l.r6k0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((UserActivityInfoItem) obj).mo225055clone();
                }
            });
        }
        return userActivityInfo;
