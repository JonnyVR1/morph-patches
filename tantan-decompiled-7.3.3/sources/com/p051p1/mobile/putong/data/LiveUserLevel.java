...
public class LiveUserLevel extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveUserLevel> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveUserLevel>() { // from class: com.p1.mobile.putong.data.LiveUserLevel.1
        ...
        public int computeAndCacheSize(LiveUserLevel liveUserLevel) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, liveUserLevel.grade) + CodedOutputByteBufferNano.m17277d(2, liveUserLevel.wealthRatio) + CodedOutputByteBufferNano.m17283j(3, liveUserLevel.gap);
            ...
            int iM17283j2 = iM17283j + CodedOutputByteBufferNano.m17283j(6, liveUserLevel.superGrade);
            liveUserLevel.cachedSize = iM17283j2;
            return iM17283j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveUserLevel parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    liveUserLevel.grade = nc5Var.m162487k();
                } else if (iM162497u == 17) {
                    liveUserLevel.wealthRatio = nc5Var.m162484h();
                } else if (iM162497u == 24) {
                    liveUserLevel.gap = nc5Var.m162487k();
                } else if (iM162497u == 34) {
                    liveUserLevel.iconUrl = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    liveUserLevel.backendUrl = nc5Var.m162495s();
                } else {
                    if (iM162497u != 48) {
                        if (liveUserLevel.iconUrl == null) {
                            liveUserLevel.iconUrl = "";
                    ...
                    liveUserLevel.superGrade = nc5Var.m162487k();
                }
            }
            return liveUserLevel;
        }
        ...
        public void serialize(LiveUserLevel liveUserLevel, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, liveUserLevel.grade);
            codedOutputByteBufferNano.m17301C(2, liveUserLevel.wealthRatio);
            codedOutputByteBufferNano.m17307I(3, liveUserLevel.gap);
            String str = liveUserLevel.iconUrl;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17307I(6, liveUserLevel.superGrade);
        }
    };
    ...
    public LiveUserLevel mo225055clone() {
        LiveUserLevel liveUserLevel = new LiveUserLevel();
