...
public class Membership extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Membership> PROTOBUF_ADAPTER = new MessageNanoAdapter<Membership>() { // from class: com.p1.mobile.putong.data.Membership.1
        ...
        public int computeAndCacheSize(Membership membership) {
            ...
            int iM17281h = (membershipType != null ? CodedOutputByteBufferNano.m17281h(1, membershipType.ordinal()) : 0) + CodedOutputByteBufferNano.m17275b(2, membership.active) + CodedOutputByteBufferNano.m17277d(3, membership.expiresTime) + CodedOutputByteBufferNano.m17283j(4, membership.duration);
            VIPBadgeType vIPBadgeType = membership.vipBadgeType;
            if (vIPBadgeType != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(5, vIPBadgeType.ordinal());
            }
            int iM17275b = iM17281h + CodedOutputByteBufferNano.m17275b(6, membership.hideVIP) + CodedOutputByteBufferNano.m17275b(7, membership.hideActivityTime);
            MembershipType membershipType2 = membership.name;
            if (membershipType2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(8, membershipType2, MembershipType.PROTOBUF_ADAPTER);
            }
            VIPBadgeType vIPBadgeType2 = membership.vipBadgeType;
            if (vIPBadgeType2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(9, vIPBadgeType2, VIPBadgeType.PROTOBUF_ADAPTER);
            }
            membership.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Membership parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    ...
                    membership.active = nc5Var.m162483g();
                } else if (iM162497u == 25) {
                    membership.expiresTime = nc5Var.m162484h();
                } else if (iM162497u == 32) {
                    membership.duration = nc5Var.m162487k();
                } else if (iM162497u == 40) {
                    numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 48) {
                    membership.hideVIP = nc5Var.m162483g();
                } else if (iM162497u == 56) {
                    membership.hideActivityTime = nc5Var.m162483g();
                } else if (iM162497u == 66) {
                    membership.name = (MembershipType) nc5Var.m162488l(MembershipType.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 74) {
                        if (membership.name == null && numValueOf != null) {
                            membership.name = (MembershipType) MembershipType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    membership.vipBadgeType = (VIPBadgeType) nc5Var.m162488l(VIPBadgeType.PROTOBUF_ADAPTER);
                }
            }
            return membership;
        }
        ...
        public void serialize(Membership membership, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (membershipType != null) {
                codedOutputByteBufferNano.m17305G(1, membershipType.ordinal());
            }
            codedOutputByteBufferNano.m17299A(2, membership.active);
            codedOutputByteBufferNano.m17301C(3, membership.expiresTime);
            codedOutputByteBufferNano.m17307I(4, membership.duration);
            VIPBadgeType vIPBadgeType = membership.vipBadgeType;
            if (vIPBadgeType != null) {
                codedOutputByteBufferNano.m17305G(5, vIPBadgeType.ordinal());
            }
            codedOutputByteBufferNano.m17299A(6, membership.hideVIP);
            codedOutputByteBufferNano.m17299A(7, membership.hideActivityTime);
            MembershipType membershipType2 = membership.name;
            if (membershipType2 != null) {
            ...
            VIPBadgeType vIPBadgeType2 = membership.vipBadgeType;
            if (vIPBadgeType2 != null) {
                codedOutputByteBufferNano.m17309K(9, vIPBadgeType2, VIPBadgeType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Membership mo225055clone() {
        Membership membership = new Membership();
