...
public class Link extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Link> PROTOBUF_ADAPTER = new MessageNanoAdapter<Link>() { // from class: com.p1.mobile.putong.data.Link.1
        ...
        public int computeAndCacheSize(Link link) {
            String str = link.f39613id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            LinkIntent linkIntent = link.intent;
            if (linkIntent != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(2, linkIntent.ordinal());
            }
            LinkChannel linkChannel = link.channel;
            if (linkChannel != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(3, linkChannel.ordinal());
            }
            List<IdBoxed> list = link.resources;
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, list, IdBoxed.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (linkState != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(6, linkState.ordinal());
            }
            ...
            if (str4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(8, str4);
            }
            LinkIntent linkIntent2 = link.intent;
            if (linkIntent2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(9, linkIntent2, LinkIntent.PROTOBUF_ADAPTER);
            }
            LinkChannel linkChannel2 = link.channel;
            if (linkChannel2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(10, linkChannel2, LinkChannel.PROTOBUF_ADAPTER);
            }
            LinkState linkState2 = link.state;
            if (linkState2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(11, linkState2, LinkState.PROTOBUF_ADAPTER);
            }
            link.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Link parse(nc5 nc5Var) throws IOException {
            Link link = new Link();
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    ...
                    case 24:
                        ...
                        continue;
                    case 34:
                        link.resources = (List) nc5Var.m162488l(IdBoxed.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        link.href = nc5Var.m162495s();
                        continue;
                    case 48:
                        numValueOf3 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 58:
                        link.title = nc5Var.m162495s();
                        continue;
                    case 66:
                        link.owner = nc5Var.m162495s();
                        continue;
                    case 74:
                        link.intent = (LinkIntent) nc5Var.m162488l(LinkIntent.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        link.channel = (LinkChannel) nc5Var.m162488l(LinkChannel.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        link.state = (LinkState) nc5Var.m162488l(LinkState.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (link.intent == null && numValueOf != null) {
                            link.intent = (LinkIntent) LinkIntent.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Link link, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            LinkIntent linkIntent = link.intent;
            if (linkIntent != null) {
                codedOutputByteBufferNano.m17305G(2, linkIntent.ordinal());
            }
            LinkChannel linkChannel = link.channel;
            if (linkChannel != null) {
                codedOutputByteBufferNano.m17305G(3, linkChannel.ordinal());
            }
            List<IdBoxed> list = link.resources;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(4, list, IdBoxed.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = link.href;
            if (str2 != null) {
            ...
            LinkState linkState = link.state;
            if (linkState != null) {
                codedOutputByteBufferNano.m17305G(6, linkState.ordinal());
            }
            String str3 = link.title;
            if (str3 != null) {
            ...
            LinkIntent linkIntent2 = link.intent;
            if (linkIntent2 != null) {
                codedOutputByteBufferNano.m17309K(9, linkIntent2, LinkIntent.PROTOBUF_ADAPTER);
            }
            LinkChannel linkChannel2 = link.channel;
            if (linkChannel2 != null) {
                codedOutputByteBufferNano.m17309K(10, linkChannel2, LinkChannel.PROTOBUF_ADAPTER);
            }
            LinkState linkState2 = link.state;
            if (linkState2 != null) {
                codedOutputByteBufferNano.m17309K(11, linkState2, LinkState.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Link link, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "intent":
                    ...
                    return true;
                case "id":
                    link.f39613id = jsonParser.getValueAsString();
                    return false;
                case "href":
    ...
    public Link mo225055clone() {
        Link link = new Link();
        link.f39613id = this.f39613id;
        link.intent = this.intent;
        link.channel = this.channel;
        List<IdBoxed> list = this.resources;
        if (list != null) {
            link.resources = ValueObject.util_map(list, new qcj() { // from class: l.oor
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((IdBoxed) obj).mo225055clone();
                }
            });
        }
        link.href = this.href;
