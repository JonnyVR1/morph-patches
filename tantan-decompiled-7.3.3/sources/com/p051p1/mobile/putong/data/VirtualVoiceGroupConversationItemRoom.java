...
import com.p051p1.mobile.putong.data.VirtualVoiceGroupConversationItemRoom;
...
public class VirtualVoiceGroupConversationItemRoom extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VirtualVoiceGroupConversationItemRoom> PROTOBUF_ADAPTER = new MessageNanoAdapter<VirtualVoiceGroupConversationItemRoom>() { // from class: com.p1.mobile.putong.data.VirtualVoiceGroupConversationItemRoom.1
        ...
        public int computeAndCacheSize(VirtualVoiceGroupConversationItemRoom virtualVoiceGroupConversationItemRoom) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, virtualVoiceGroupConversationItemRoom.memberCount);
            ...
            int iM17275b = iM17281h + CodedOutputByteBufferNano.m17275b(8, virtualVoiceGroupConversationItemRoom.isLiving);
            String str6 = virtualVoiceGroupConversationItemRoom.anchorId;
            if (str6 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(9, str6);
            }
            virtualVoiceGroupConversationItemRoom.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VirtualVoiceGroupConversationItemRoom parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    virtualVoiceGroupConversationItemRoom.roomId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    virtualVoiceGroupConversationItemRoom.title = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    virtualVoiceGroupConversationItemRoom.avatars = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 34) {
                    virtualVoiceGroupConversationItemRoom.liveId = nc5Var.m162495s();
                } else if (iM162497u == 40) {
                    virtualVoiceGroupConversationItemRoom.memberCount = nc5Var.m162486j();
                } else if (iM162497u == 50) {
                    virtualVoiceGroupConversationItemRoom.roomStateText = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    virtualVoiceGroupConversationItemRoom.roomStateTextColor = nc5Var.m162495s();
                } else if (iM162497u == 64) {
                    virtualVoiceGroupConversationItemRoom.isLiving = nc5Var.m162483g();
                } else {
                    if (iM162497u != 74) {
                        if (virtualVoiceGroupConversationItemRoom.roomId == null) {
                            virtualVoiceGroupConversationItemRoom.roomId = "";
                    ...
                    virtualVoiceGroupConversationItemRoom.anchorId = nc5Var.m162495s();
                }
            }
            return virtualVoiceGroupConversationItemRoom;
        }
        ...
        public void serialize(VirtualVoiceGroupConversationItemRoom virtualVoiceGroupConversationItemRoom, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(5, virtualVoiceGroupConversationItemRoom.memberCount);
            String str4 = virtualVoiceGroupConversationItemRoom.roomStateText;
            if (str4 != null) {
            ...
            codedOutputByteBufferNano.m17299A(8, virtualVoiceGroupConversationItemRoom.isLiving);
            String str6 = virtualVoiceGroupConversationItemRoom.anchorId;
            if (str6 != null) {
    ...
    public static /* synthetic */ String m61340a(String str) {
        return str;
    }
    ...
    public VirtualVoiceGroupConversationItemRoom mo225055clone() {
        VirtualVoiceGroupConversationItemRoom virtualVoiceGroupConversationItemRoom = new VirtualVoiceGroupConversationItemRoom();
        virtualVoiceGroupConversationItemRoom.roomId = this.roomId;
        virtualVoiceGroupConversationItemRoom.title = this.title;
        List<String> list = this.avatars;
        if (list != null) {
            virtualVoiceGroupConversationItemRoom.avatars = ValueObject.util_map(list, new qcj() { // from class: l.l8m0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return VirtualVoiceGroupConversationItemRoom.m61340a((String) obj);
                }
            });
        }
