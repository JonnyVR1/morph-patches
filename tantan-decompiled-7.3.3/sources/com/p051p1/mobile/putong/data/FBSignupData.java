...
public class FBSignupData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FBSignupData> PROTOBUF_ADAPTER = new MessageNanoAdapter<FBSignupData>() { // from class: com.p1.mobile.putong.data.FBSignupData.1
        ...
        public int computeAndCacheSize(FBSignupData fBSignupData) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, list, FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FBWork> list2 = fBSignupData.work;
            if (list2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, list2, FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Tag> list3 = fBSignupData.pages;
            if (list3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, list3, Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            fBSignupData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FBSignupData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    fBSignupData.about = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    fBSignupData.hometown = (FBPage) nc5Var.m162488l(FBPage.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    fBSignupData.location = (FBPage) nc5Var.m162488l(FBPage.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    fBSignupData.education = (List) nc5Var.m162488l(FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 42) {
                    fBSignupData.work = (List) nc5Var.m162488l(FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 50) {
                        if (fBSignupData.about == null) {
                            fBSignupData.about = "";
                    ...
                    fBSignupData.pages = (List) nc5Var.m162488l(Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return fBSignupData;
        }
        ...
        public void serialize(FBSignupData fBSignupData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<FBEducation> list = fBSignupData.education;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(4, list, FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FBWork> list2 = fBSignupData.work;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(5, list2, FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Tag> list3 = fBSignupData.pages;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(6, list3, Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public FBSignupData mo225055clone() {
        FBSignupData fBSignupData = new FBSignupData();
        fBSignupData.about = this.about;
        FBPage fBPage = this.hometown;
        if (fBPage != null) {
            fBSignupData.hometown = fBPage.mo225055clone();
        }
        FBPage fBPage2 = this.location;
        if (fBPage2 != null) {
            fBSignupData.location = fBPage2.mo225055clone();
        }
        List<FBEducation> list = this.education;
        if (list != null) {
            fBSignupData.education = ValueObject.util_map(list, new qcj() { // from class: l.ksf
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            fBSignupData.work = ValueObject.util_map(list2, new qcj() { // from class: l.lsf
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list3 != null) {
            fBSignupData.pages = ValueObject.util_map(list3, new qcj() { // from class: l.msf
                @Override // p153l.qcj
                public final Object call(Object obj) {
