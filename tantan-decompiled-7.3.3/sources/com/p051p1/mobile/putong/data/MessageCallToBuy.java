...
public class MessageCallToBuy extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageCallToBuy> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageCallToBuy>() { // from class: com.p1.mobile.putong.data.MessageCallToBuy.1
        ...
        public int computeAndCacheSize(MessageCallToBuy messageCallToBuy) {
            ...
            if (messageCallToBuyButton != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, messageCallToBuyButton, MessageCallToBuyButton.PROTOBUF_ADAPTER);
            }
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, list, MessageCallToBuyMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            messageCallToBuy.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageCallToBuy parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    messageCallToBuy.cardVersion = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    messageCallToBuy.previewText = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    messageCallToBuy.button = (MessageCallToBuyButton) nc5Var.m162488l(MessageCallToBuyButton.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    messageCallToBuy.text = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    messageCallToBuy.imageWaterMark = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (messageCallToBuy.cardVersion == null) {
                            messageCallToBuy.cardVersion = "";
                    ...
                    messageCallToBuy.medias = (List) nc5Var.m162488l(MessageCallToBuyMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return messageCallToBuy;
        }
        ...
        public void serialize(MessageCallToBuy messageCallToBuy, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            MessageCallToBuyButton messageCallToBuyButton = messageCallToBuy.button;
            if (messageCallToBuyButton != null) {
                codedOutputByteBufferNano.m17309K(3, messageCallToBuyButton, MessageCallToBuyButton.PROTOBUF_ADAPTER);
            }
            String str3 = messageCallToBuy.text;
            if (str3 != null) {
            ...
            List<MessageCallToBuyMedia> list = messageCallToBuy.medias;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(6, list, MessageCallToBuyMedia.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public MessageCallToBuy mo225055clone() {
        MessageCallToBuy messageCallToBuy = new MessageCallToBuy();
        ...
        if (messageCallToBuyButton != null) {
            messageCallToBuy.button = messageCallToBuyButton.mo225055clone();
        }
        ...
        if (list != null) {
            messageCallToBuy.medias = ValueObject.util_map(list, new qcj() { // from class: l.p3z
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((MessageCallToBuyMedia) obj).mo225055clone();
                }
            });
        }
        return messageCallToBuy;
