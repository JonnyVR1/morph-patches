...
import com.p051p1.mobile.putong.data.SlideCardsAndReward;
...
public class MaleRule extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MaleRule> PROTOBUF_ADAPTER = new MessageNanoAdapter<MaleRule>() { // from class: com.p1.mobile.putong.data.MaleRule.1
        ...
        public int computeAndCacheSize(MaleRule maleRule) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, maleRule.seeListConditions) + CodedOutputByteBufferNano.m17281h(2, maleRule.toastConditions);
            List<SlideCardsAndReward> list = maleRule.slideCardsAndRewards;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(3, list, SlideCardsAndReward.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            maleRule.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MaleRule parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    maleRule.seeListConditions = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    maleRule.toastConditions = nc5Var.m162486j();
                } else {
                    if (iM162497u != 26) {
                        if (maleRule.slideCardsAndRewards != null) {
                            break;
                    ...
                    maleRule.slideCardsAndRewards = (List) nc5Var.m162488l(SlideCardsAndReward.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return maleRule;
        }
        ...
        public void serialize(MaleRule maleRule, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, maleRule.seeListConditions);
            codedOutputByteBufferNano.m17305G(2, maleRule.toastConditions);
            List<SlideCardsAndReward> list = maleRule.slideCardsAndRewards;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(3, list, SlideCardsAndReward.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public MaleRule mo225055clone() {
        ...
        if (list != null) {
            maleRule.slideCardsAndRewards = ValueObject.util_map(list, new qcj() { // from class: l.cuw
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((SlideCardsAndReward) obj).mo225055clone();
                }
            });
        }
        return maleRule;
