...
import com.p051p1.mobile.putong.data.FemaleRule;
...
public class FemaleRule extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FemaleRule> PROTOBUF_ADAPTER = new MessageNanoAdapter<FemaleRule>() { // from class: com.p1.mobile.putong.data.FemaleRule.1
        ...
        public int computeAndCacheSize(FemaleRule femaleRule) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, femaleRule.seeListConditions) + CodedOutputByteBufferNano.m17281h(2, femaleRule.toastConditions);
            ...
            femaleRule.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FemaleRule parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    femaleRule.seeListConditions = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    femaleRule.toastConditions = nc5Var.m162486j();
                } else {
                    if (iM162497u != 26) {
                        if (femaleRule.rewardsCardsNumber != null) {
                            break;
                    ...
                    femaleRule.rewardsCardsNumber = (List) nc5Var.m162488l(ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return femaleRule;
        }
        ...
        public void serialize(FemaleRule femaleRule, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, femaleRule.seeListConditions);
            codedOutputByteBufferNano.m17305G(2, femaleRule.toastConditions);
            List<Integer> list = femaleRule.rewardsCardsNumber;
            if (list != null) {
    ...
    public static /* synthetic */ Integer m60957a(Integer num) {
        return num;
    }
    ...
    public FemaleRule mo225055clone() {
        FemaleRule femaleRule = new FemaleRule();
        ...
        if (list != null) {
            femaleRule.rewardsCardsNumber = ValueObject.util_map(list, new qcj() { // from class: l.zdi
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FemaleRule.m60957a((Integer) obj);
                }
            });
        }
        return femaleRule;
