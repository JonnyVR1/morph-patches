...
public class AdSdk extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AdSdk> PROTOBUF_ADAPTER = new MessageNanoAdapter<AdSdk>() { // from class: com.p1.mobile.putong.data.AdSdk.1
        ...
        public int computeAndCacheSize(AdSdk adSdk) {
            ...
            int iM17285l = adSdkConfig != null ? CodedOutputByteBufferNano.m17285l(1, adSdkConfig, AdSdkConfig.PROTOBUF_ADAPTER) : 0;
            AdSdkConfig adSdkConfig2 = adSdk.momo;
            if (adSdkConfig2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, adSdkConfig2, AdSdkConfig.PROTOBUF_ADAPTER);
            }
            adSdk.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AdSdk parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    adSdk.gdt = (AdSdkConfig) nc5Var.m162488l(AdSdkConfig.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (adSdk.gdt == null) {
                            adSdk.gdt = AdSdkConfig.new_();
                    ...
                    adSdk.momo = (AdSdkConfig) nc5Var.m162488l(AdSdkConfig.PROTOBUF_ADAPTER);
                }
            }
            return adSdk;
        }
        ...
        public void serialize(AdSdk adSdk, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            AdSdkConfig adSdkConfig = adSdk.gdt;
            if (adSdkConfig != null) {
                codedOutputByteBufferNano.m17309K(1, adSdkConfig, AdSdkConfig.PROTOBUF_ADAPTER);
            }
            AdSdkConfig adSdkConfig2 = adSdk.momo;
            if (adSdkConfig2 != null) {
                codedOutputByteBufferNano.m17309K(2, adSdkConfig2, AdSdkConfig.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public AdSdk mo225055clone() {
        AdSdk adSdk = new AdSdk();
        AdSdkConfig adSdkConfig = this.gdt;
        if (adSdkConfig != null) {
            adSdk.gdt = adSdkConfig.mo225055clone();
        }
        AdSdkConfig adSdkConfig2 = this.momo;
        if (adSdkConfig2 != null) {
            adSdk.momo = adSdkConfig2.mo225055clone();
        }
        return adSdk;
    }
