...
public class LiveMedals extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveMedals> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveMedals>() { // from class: com.p1.mobile.putong.data.LiveMedals.1
        ...
        public int computeAndCacheSize(LiveMedals liveMedals) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, list, Medal.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            liveMedals.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveMedals parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    liveMedals.version = nc5Var.m162495s();
                } else {
                    if (iM162497u != 18) {
                        if (liveMedals.version == null) {
                            liveMedals.version = "";
                    ...
                    liveMedals.medals = (List) nc5Var.m162488l(Medal.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return liveMedals;
        }
        ...
        public void serialize(LiveMedals liveMedals, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<Medal> list = liveMedals.medals;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, Medal.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public LiveMedals mo225055clone() {
        LiveMedals liveMedals = new LiveMedals();
        liveMedals.version = this.version;
        List<Medal> list = this.medals;
        if (list != null) {
            liveMedals.medals = ValueObject.util_map(list, new qcj() { // from class: l.y3t
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Medal) obj).mo225055clone();
                }
            });
        }
        return liveMedals;
