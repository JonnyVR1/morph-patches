...
public class OMSAdCardContent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSAdCardContent> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSAdCardContent>() { // from class: com.p1.mobile.putong.data.OMSAdCardContent.1
        ...
        public int computeAndCacheSize(OMSAdCardContent oMSAdCardContent) {
            ...
            int iM17285l = omsCard != null ? CodedOutputByteBufferNano.m17285l(1, omsCard, OmsCard.PROTOBUF_ADAPTER) : 0;
            OmsCardLiterature omsCardLiterature = oMSAdCardContent.omsCardLiterature;
            if (omsCardLiterature != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, omsCardLiterature, OmsCardLiterature.PROTOBUF_ADAPTER);
            }
            OmsCardSound omsCardSound = oMSAdCardContent.omsCardSound;
            if (omsCardSound != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, omsCardSound, OmsCardSound.PROTOBUF_ADAPTER);
            }
            OmsTagCard omsTagCard = oMSAdCardContent.tagCard;
            if (omsTagCard != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, omsTagCard, OmsTagCard.PROTOBUF_ADAPTER);
            }
            OmsLiteratureCardGuide omsLiteratureCardGuide = oMSAdCardContent.literatureCardGuide;
            if (omsLiteratureCardGuide != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, omsLiteratureCardGuide, OmsLiteratureCardGuide.PROTOBUF_ADAPTER);
            }
            oMSAdCardContent.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSAdCardContent parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    oMSAdCardContent.omsCard = (OmsCard) nc5Var.m162488l(OmsCard.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    oMSAdCardContent.omsCardLiterature = (OmsCardLiterature) nc5Var.m162488l(OmsCardLiterature.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    oMSAdCardContent.omsCardSound = (OmsCardSound) nc5Var.m162488l(OmsCardSound.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    oMSAdCardContent.tagCard = (OmsTagCard) nc5Var.m162488l(OmsTagCard.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 42) {
                        if (oMSAdCardContent.omsCard == null) {
                            oMSAdCardContent.omsCard = OmsCard.new_();
                    ...
                    oMSAdCardContent.literatureCardGuide = (OmsLiteratureCardGuide) nc5Var.m162488l(OmsLiteratureCardGuide.PROTOBUF_ADAPTER);
                }
            }
            return oMSAdCardContent;
        }
        ...
        public void serialize(OMSAdCardContent oMSAdCardContent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            OmsCard omsCard = oMSAdCardContent.omsCard;
            if (omsCard != null) {
                codedOutputByteBufferNano.m17309K(1, omsCard, OmsCard.PROTOBUF_ADAPTER);
            }
            OmsCardLiterature omsCardLiterature = oMSAdCardContent.omsCardLiterature;
            if (omsCardLiterature != null) {
                codedOutputByteBufferNano.m17309K(2, omsCardLiterature, OmsCardLiterature.PROTOBUF_ADAPTER);
            }
            OmsCardSound omsCardSound = oMSAdCardContent.omsCardSound;
            if (omsCardSound != null) {
                codedOutputByteBufferNano.m17309K(3, omsCardSound, OmsCardSound.PROTOBUF_ADAPTER);
            }
            OmsTagCard omsTagCard = oMSAdCardContent.tagCard;
            if (omsTagCard != null) {
                codedOutputByteBufferNano.m17309K(4, omsTagCard, OmsTagCard.PROTOBUF_ADAPTER);
            }
            OmsLiteratureCardGuide omsLiteratureCardGuide = oMSAdCardContent.literatureCardGuide;
            if (omsLiteratureCardGuide != null) {
                codedOutputByteBufferNano.m17309K(5, omsLiteratureCardGuide, OmsLiteratureCardGuide.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public OMSAdCardContent mo225055clone() {
        OMSAdCardContent oMSAdCardContent = new OMSAdCardContent();
        OmsCard omsCard = this.omsCard;
        if (omsCard != null) {
            oMSAdCardContent.omsCard = omsCard.mo225055clone();
        }
        OmsCardLiterature omsCardLiterature = this.omsCardLiterature;
        if (omsCardLiterature != null) {
            oMSAdCardContent.omsCardLiterature = omsCardLiterature.mo225055clone();
        }
        OmsCardSound omsCardSound = this.omsCardSound;
        if (omsCardSound != null) {
            oMSAdCardContent.omsCardSound = omsCardSound.mo225055clone();
        }
        OmsTagCard omsTagCard = this.tagCard;
        if (omsTagCard != null) {
            oMSAdCardContent.tagCard = omsTagCard.mo225055clone();
        }
        OmsLiteratureCardGuide omsLiteratureCardGuide = this.literatureCardGuide;
        if (omsLiteratureCardGuide != null) {
            oMSAdCardContent.literatureCardGuide = omsLiteratureCardGuide.mo225055clone();
        }
        return oMSAdCardContent;
    }
