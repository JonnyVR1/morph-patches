...
public class OMSWidgeIconInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSWidgeIconInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSWidgeIconInfo>() { // from class: com.p1.mobile.putong.data.OMSWidgeIconInfo.1
        ...
        public int computeAndCacheSize(OMSWidgeIconInfo oMSWidgeIconInfo) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, oMSWidgeIconInfo.width) + CodedOutputByteBufferNano.m17281h(3, oMSWidgeIconInfo.height);
            oMSWidgeIconInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSWidgeIconInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    oMSWidgeIconInfo.identifier = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    oMSWidgeIconInfo.width = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        if (oMSWidgeIconInfo.identifier != null) {
                            break;
                    ...
                    oMSWidgeIconInfo.height = nc5Var.m162486j();
                }
            }
            return oMSWidgeIconInfo;
        }
        ...
        public void serialize(OMSWidgeIconInfo oMSWidgeIconInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, oMSWidgeIconInfo.width);
            codedOutputByteBufferNano.m17305G(3, oMSWidgeIconInfo.height);
        }
    };
    ...
    public OMSWidgeIconInfo mo225055clone() {
        OMSWidgeIconInfo oMSWidgeIconInfo = new OMSWidgeIconInfo();
