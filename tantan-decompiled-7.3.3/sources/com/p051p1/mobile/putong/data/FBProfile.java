...
public class FBProfile extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FBProfile> PROTOBUF_ADAPTER = new MessageNanoAdapter<FBProfile>() { // from class: com.p1.mobile.putong.data.FBProfile.1
        ...
        public int computeAndCacheSize(FBProfile fBProfile) {
            ...
            int iM17285l = fBPicture != null ? CodedOutputByteBufferNano.m17285l(1, fBPicture, FBPicture.PROTOBUF_ADAPTER) : 0;
            fBProfile.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FBProfile parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                fBProfile.data = (FBPicture) nc5Var.m162488l(FBPicture.PROTOBUF_ADAPTER);
            }
            return fBProfile;
        }
        ...
        public void serialize(FBProfile fBProfile, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            FBPicture fBPicture = fBProfile.data;
            if (fBPicture != null) {
                codedOutputByteBufferNano.m17309K(1, fBPicture, FBPicture.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FBProfile mo225055clone() {
        FBProfile fBProfile = new FBProfile();
        FBPicture fBPicture = this.data;
        if (fBPicture != null) {
            fBProfile.data = fBPicture.mo225055clone();
        }
        return fBProfile;
    }
