...
public class Mobile extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Mobile> PROTOBUF_ADAPTER = new MessageNanoAdapter<Mobile>() { // from class: com.p1.mobile.putong.data.Mobile.1
        ...
        public int computeAndCacheSize(Mobile mobile) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, mobile.countryCode);
            String str = mobile.mobileNumber;
            if (str != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(2, str);
            }
            mobile.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Mobile parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    mobile.countryCode = nc5Var.m162486j();
                } else {
                    if (iM162497u != 18) {
                        if (mobile.mobileNumber != null) {
                            break;
                    ...
                    mobile.mobileNumber = nc5Var.m162495s();
                }
            }
            return mobile;
        }
        ...
        public void serialize(Mobile mobile, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, mobile.countryCode);
            String str = mobile.mobileNumber;
            if (str != null) {
