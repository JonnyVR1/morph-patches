...
public class AllowPayments extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AllowPayments> PROTOBUF_ADAPTER = new MessageNanoAdapter<AllowPayments>() { // from class: com.p1.mobile.putong.data.AllowPayments.1
        ...
        public int computeAndCacheSize(AllowPayments allowPayments) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, allowPayments.signup_country);
            ...
            allowPayments.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AllowPayments parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    allowPayments.signup_country = nc5Var.m162486j();
                } else {
                    if (iM162497u != 18) {
                        if (allowPayments.payments != null) {
                            break;
                    ...
                    allowPayments.payments = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return allowPayments;
        }
        ...
        public void serialize(AllowPayments allowPayments, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, allowPayments.signup_country);
            List<String> list = allowPayments.payments;
            if (list != null) {
    ...
    public static /* synthetic */ String m60848a(String str) {
        return str;
    }
    ...
    public AllowPayments mo225055clone() {
        AllowPayments allowPayments = new AllowPayments();
        allowPayments.signup_country = this.signup_country;
        List<String> list = this.payments;
        if (list != null) {
            allowPayments.payments = ValueObject.util_map(list, new qcj() { // from class: l.pj0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return AllowPayments.m60848a((String) obj);
                }
            });
        }
        return allowPayments;
