...
public class NavigationViewPicture extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NavigationViewPicture> PROTOBUF_ADAPTER = new MessageNanoAdapter<NavigationViewPicture>() { // from class: com.p1.mobile.putong.data.NavigationViewPicture.1
        ...
        public int computeAndCacheSize(NavigationViewPicture navigationViewPicture) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, navigationViewPicture.height) + CodedOutputByteBufferNano.m17281h(3, navigationViewPicture.width);
            navigationViewPicture.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NavigationViewPicture parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    navigationViewPicture.identifier = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    navigationViewPicture.height = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        if (navigationViewPicture.identifier != null) {
                            break;
                    ...
                    navigationViewPicture.width = nc5Var.m162486j();
                }
            }
            return navigationViewPicture;
        }
        ...
        public void serialize(NavigationViewPicture navigationViewPicture, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, navigationViewPicture.height);
            codedOutputByteBufferNano.m17305G(3, navigationViewPicture.width);
        }
    };
    ...
    public NavigationViewPicture mo225055clone() {
        NavigationViewPicture navigationViewPicture = new NavigationViewPicture();
