...
public class MessageLocation extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageLocation> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageLocation>() { // from class: com.p1.mobile.putong.data.MessageLocation.1
        ...
        public int computeAndCacheSize(MessageLocation messageLocation) {
            ...
            if (doublePair != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, doublePair, DoublePair.PROTOBUF_ADAPTER);
            }
            String str3 = messageLocation.distance;
            if (str3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(4, str3);
            }
            messageLocation.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageLocation parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    messageLocation.name = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    messageLocation.address = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    messageLocation.coordinates = (DoublePair) nc5Var.m162488l(DoublePair.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 34) {
                        if (messageLocation.name == null) {
                            messageLocation.name = "";
                    ...
                    messageLocation.distance = nc5Var.m162495s();
                }
            }
            return messageLocation;
        }
        ...
        public void serialize(MessageLocation messageLocation, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            DoublePair doublePair = messageLocation.coordinates;
            if (doublePair != null) {
                codedOutputByteBufferNano.m17309K(3, doublePair, DoublePair.PROTOBUF_ADAPTER);
            }
            String str3 = messageLocation.distance;
            if (str3 != null) {
