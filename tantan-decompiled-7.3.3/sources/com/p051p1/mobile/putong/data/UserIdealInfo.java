...
public class UserIdealInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserIdealInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserIdealInfo>() { // from class: com.p1.mobile.putong.data.UserIdealInfo.1
        ...
        public int computeAndCacheSize(UserIdealInfo userIdealInfo) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            List<PictureIdealInfo> list2 = userIdealInfo.mediaTagIdeal;
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, list2, PictureIdealInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            userIdealInfo.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserIdealInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    userIdealInfo.details = (List) nc5Var.m162488l(IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (userIdealInfo.details == null) {
                            userIdealInfo.details = new ArrayList();
                    ...
                    userIdealInfo.mediaTagIdeal = (List) nc5Var.m162488l(PictureIdealInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return userIdealInfo;
        }
        ...
        public void serialize(UserIdealInfo userIdealInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<IdealTag> list = userIdealInfo.details;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, IdealTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<PictureIdealInfo> list2 = userIdealInfo.mediaTagIdeal;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(2, list2, PictureIdealInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public UserIdealInfo mo225055clone() {
        UserIdealInfo userIdealInfo = new UserIdealInfo();
        List<IdealTag> list = this.details;
        if (list != null) {
            userIdealInfo.details = ValueObject.util_map(list, new qcj() { // from class: l.pek0
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            userIdealInfo.mediaTagIdeal = ValueObject.util_map(list2, new qcj() { // from class: l.qek0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((PictureIdealInfo) obj).mo225055clone();
                }
            });
        }
        return userIdealInfo;
