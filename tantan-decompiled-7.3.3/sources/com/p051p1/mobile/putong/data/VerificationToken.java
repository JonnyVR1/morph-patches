...
public class VerificationToken extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerificationToken> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerificationToken>() { // from class: com.p1.mobile.putong.data.VerificationToken.1
        ...
        public int computeAndCacheSize(VerificationToken verificationToken) {
            ...
            if (tencentToken != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(8, tencentToken, TencentToken.PROTOBUF_ADAPTER);
            }
            String str8 = verificationToken.certifyId;
            if (str8 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(9, str8);
            }
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(10, verificationToken.omitLiveData) + CodedOutputByteBufferNano.m17275b(11, verificationToken.withPV);
            ReflectResponse reflectResponse = verificationToken.response;
            if (reflectResponse != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(12, reflectResponse, ReflectResponse.PROTOBUF_ADAPTER);
            }
            VolcEngineProToken volcEngineProToken = verificationToken.volcEngineProToken;
            if (volcEngineProToken != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(13, volcEngineProToken, VolcEngineProToken.PROTOBUF_ADAPTER);
            }
            String str9 = verificationToken.bizSeq;
            if (str9 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(14, str9);
            }
            String str10 = verificationToken.transactionId;
            if (str10 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(15, str10);
            }
            verificationToken.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerificationToken parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        verificationToken.uid = nc5Var.m162495s();
                        continue;
                    case 18:
                        verificationToken.verifyType = nc5Var.m162495s();
                        continue;
                    case 26:
                        verificationToken.provider = nc5Var.m162495s();
                        continue;
                    case 34:
                        verificationToken.token = nc5Var.m162495s();
                        continue;
                    case 42:
                        verificationToken.bizId = nc5Var.m162495s();
                        continue;
                    case 50:
                        verificationToken.expiredTime = nc5Var.m162495s();
                        continue;
                    case 58:
                        verificationToken.userId = nc5Var.m162495s();
                        continue;
                    case 66:
                        verificationToken.tencentToken = (TencentToken) nc5Var.m162488l(TencentToken.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        verificationToken.certifyId = nc5Var.m162495s();
                        continue;
                    case 80:
                        verificationToken.omitLiveData = nc5Var.m162483g();
                        continue;
                    case 88:
                        verificationToken.withPV = nc5Var.m162483g();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        verificationToken.response = (ReflectResponse) nc5Var.m162488l(ReflectResponse.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        verificationToken.volcEngineProToken = (VolcEngineProToken) nc5Var.m162488l(VolcEngineProToken.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        verificationToken.bizSeq = nc5Var.m162495s();
                        continue;
                    case 122:
                        verificationToken.transactionId = nc5Var.m162495s();
                        continue;
                    default:
                        if (verificationToken.uid == null) {
                            verificationToken.uid = "";
        ...
        public void serialize(VerificationToken verificationToken, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            TencentToken tencentToken = verificationToken.tencentToken;
            if (tencentToken != null) {
                codedOutputByteBufferNano.m17309K(8, tencentToken, TencentToken.PROTOBUF_ADAPTER);
            }
            String str8 = verificationToken.certifyId;
            if (str8 != null) {
                codedOutputByteBufferNano.m17316R(9, str8);
            }
            codedOutputByteBufferNano.m17299A(10, verificationToken.omitLiveData);
            codedOutputByteBufferNano.m17299A(11, verificationToken.withPV);
            ReflectResponse reflectResponse = verificationToken.response;
            if (reflectResponse != null) {
                codedOutputByteBufferNano.m17309K(12, reflectResponse, ReflectResponse.PROTOBUF_ADAPTER);
            }
            VolcEngineProToken volcEngineProToken = verificationToken.volcEngineProToken;
            if (volcEngineProToken != null) {
                codedOutputByteBufferNano.m17309K(13, volcEngineProToken, VolcEngineProToken.PROTOBUF_ADAPTER);
            }
            String str9 = verificationToken.bizSeq;
            if (str9 != null) {
                codedOutputByteBufferNano.m17316R(14, str9);
            }
            String str10 = verificationToken.transactionId;
            if (str10 != null) {
                codedOutputByteBufferNano.m17316R(15, str10);
            }
        }
    };
    ...
    public VerificationToken mo225055clone() {
        VerificationToken verificationToken = new VerificationToken();
        ...
        if (tencentToken != null) {
            verificationToken.tencentToken = tencentToken.mo225055clone();
        }
        ...
        if (reflectResponse != null) {
            verificationToken.response = reflectResponse.mo225055clone();
        }
        VolcEngineProToken volcEngineProToken = this.volcEngineProToken;
        if (volcEngineProToken != null) {
            verificationToken.volcEngineProToken = volcEngineProToken.mo225055clone();
        }
