...
public class FoulWords extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FoulWords> PROTOBUF_ADAPTER = new MessageNanoAdapter<FoulWords>() { // from class: com.p1.mobile.putong.data.FoulWords.1
        ...
        public int computeAndCacheSize(FoulWords foulWords) {
            ...
            foulWords.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FoulWords parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    foulWords.contains = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    foulWords.exact = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 26) {
                    foulWords.spoofing = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 34) {
                    foulWords.badMoodContains = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 42) {
                    foulWords.badMoodExact = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 50) {
                    foulWords.harassRegex = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 58) {
                    foulWords.spoofingNew = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 66) {
                    foulWords.chatSearchContains = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 74) {
                        if (foulWords.contains == null) {
                            foulWords.contains = new ArrayList();
                    ...
                    foulWords.chatSearchExact = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return foulWords;
        }
    ...
    public static /* synthetic */ String m60961a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m60962b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m60963c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m60964d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m60965e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m60966f(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m60967k(String str) {
        return str;
    }

    /* JADX INFO: renamed from: l */
    public static /* synthetic */ String m60968l(String str) {
        return str;
    }

    /* JADX INFO: renamed from: m */
    public static /* synthetic */ String m60969m(String str) {
        return str;
    }
    ...
    public FoulWords mo225055clone() {
        FoulWords foulWords = new FoulWords();
        List<String> list = this.contains;
        if (list != null) {
            foulWords.contains = ValueObject.util_map(list, new qcj() { // from class: l.d3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60967k((String) obj);
                }
            });
        }
        List<String> list2 = this.exact;
        if (list2 != null) {
            foulWords.exact = ValueObject.util_map(list2, new qcj() { // from class: l.e3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60964d((String) obj);
                }
            });
        }
        List<String> list3 = this.spoofing;
        if (list3 != null) {
            foulWords.spoofing = ValueObject.util_map(list3, new qcj() { // from class: l.f3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60962b((String) obj);
                }
            });
        }
        List<String> list4 = this.badMoodContains;
        if (list4 != null) {
            foulWords.badMoodContains = ValueObject.util_map(list4, new qcj() { // from class: l.g3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60965e((String) obj);
                }
            });
        }
        List<String> list5 = this.badMoodExact;
        if (list5 != null) {
            foulWords.badMoodExact = ValueObject.util_map(list5, new qcj() { // from class: l.h3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60963c((String) obj);
                }
            });
        }
        List<String> list6 = this.harassRegex;
        if (list6 != null) {
            foulWords.harassRegex = ValueObject.util_map(list6, new qcj() { // from class: l.i3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60966f((String) obj);
                }
            });
        }
        List<String> list7 = this.spoofingNew;
        if (list7 != null) {
            foulWords.spoofingNew = ValueObject.util_map(list7, new qcj() { // from class: l.j3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60968l((String) obj);
                }
            });
        }
        List<String> list8 = this.chatSearchContains;
        if (list8 != null) {
            foulWords.chatSearchContains = ValueObject.util_map(list8, new qcj() { // from class: l.k3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60961a((String) obj);
                }
            });
        }
        List<String> list9 = this.chatSearchExact;
        if (list9 != null) {
            foulWords.chatSearchExact = ValueObject.util_map(list9, new qcj() { // from class: l.l3j
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FoulWords.m60969m((String) obj);
                }
            });
        }
        return foulWords;
