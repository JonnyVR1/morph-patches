...
public class ProfileTbh extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ProfileTbh> PROTOBUF_ADAPTER = new MessageNanoAdapter<ProfileTbh>() { // from class: com.p1.mobile.putong.data.ProfileTbh.1
        ...
        public int computeAndCacheSize(ProfileTbh profileTbh) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, profileTbh.friends) + CodedOutputByteBufferNano.m17281h(2, profileTbh.receivedVotes) + CodedOutputByteBufferNano.m17281h(3, profileTbh.receivedVotedPolls) + CodedOutputByteBufferNano.m17277d(4, profileTbh.createdTime);
            profileTbh.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ProfileTbh parse(nc5 nc5Var) throws IOException {
            ProfileTbh profileTbh = new ProfileTbh();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    profileTbh.friends = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    profileTbh.receivedVotes = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    profileTbh.receivedVotedPolls = nc5Var.m162486j();
                } else {
                    if (iM162497u != 33) {
                        return profileTbh;
                    }
                    profileTbh.createdTime = nc5Var.m162484h();
                }
            }
        }
        ...
        public void serialize(ProfileTbh profileTbh, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, profileTbh.friends);
            codedOutputByteBufferNano.m17305G(2, profileTbh.receivedVotes);
            codedOutputByteBufferNano.m17305G(3, profileTbh.receivedVotedPolls);
            codedOutputByteBufferNano.m17301C(4, profileTbh.createdTime);
        }
    };
    ...
    public ProfileTbh mo225055clone() {
        ProfileTbh profileTbh = new ProfileTbh();
