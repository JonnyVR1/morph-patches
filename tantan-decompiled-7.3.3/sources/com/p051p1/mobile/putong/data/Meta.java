...
public class Meta extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Meta> PROTOBUF_ADAPTER = new MessageNanoAdapter<Meta>() { // from class: com.p1.mobile.putong.data.Meta.1
        ...
        public int computeAndCacheSize(Meta meta) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, meta.code);
            List<MetaError> list = meta.errors;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(2, list, MetaError.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = meta.message;
            if (str != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(3, str);
            }
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(4, meta.subCode);
            String str2 = meta.subMsg;
            if (str2 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(5, str2);
            }
            meta.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Meta parse(nc5 nc5Var) throws IOException {
            Meta meta = new Meta();
            while (true) {
                ...
                if (iM162497u == 8) {
                    meta.code = nc5Var.m162486j();
                } else if (iM162497u == 18) {
                    meta.errors = (List) nc5Var.m162488l(MetaError.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 26) {
                    meta.message = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    meta.subCode = nc5Var.m162486j();
                } else {
                    if (iM162497u != 42) {
                        if (meta.subMsg != null) {
                            break;
        ...
        public void serialize(Meta meta, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, meta.code);
            List<MetaError> list = meta.errors;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, MetaError.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = meta.message;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(3, str);
            }
            codedOutputByteBufferNano.m17305G(4, meta.subCode);
            String str2 = meta.subMsg;
            if (str2 != null) {
    ...
    public Meta mo225055clone() {
        Meta meta = new Meta();
        meta.code = this.code;
        List<MetaError> list = this.errors;
        if (list != null) {
            meta.errors = ValueObject.util_map(list, new qcj() { // from class: l.u900
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((MetaError) obj).mo225055clone();
                }
            });
        }
