...
public class NearbyBanner extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NearbyBanner> PROTOBUF_ADAPTER = new MessageNanoAdapter<NearbyBanner>() { // from class: com.p1.mobile.putong.data.NearbyBanner.1
        ...
        public int computeAndCacheSize(NearbyBanner nearbyBanner) {
            String str = nearbyBanner.f39631id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            List<Material> list = nearbyBanner.materials;
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, list, Material.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Long> list2 = nearbyBanner.timeRange;
            if (list2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, list2, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(4, nearbyBanner.slideshowSec);
            nearbyBanner.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NearbyBanner parse(nc5 nc5Var) throws IOException {
            NearbyBanner nearbyBanner = new NearbyBanner();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (nearbyBanner.f39631id == null) {
                        nearbyBanner.f39631id = "";
                    }
                ...
                if (iM162497u == 10) {
                    nearbyBanner.f39631id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    nearbyBanner.materials = (List) nc5Var.m162488l(Material.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 26) {
                    nearbyBanner.timeRange = (List) nc5Var.m162488l(ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 32) {
                        if (nearbyBanner.f39631id == null) {
                            nearbyBanner.f39631id = "";
                    ...
                    nearbyBanner.slideshowSec = nc5Var.m162487k();
                }
            }
            return nearbyBanner;
        }
        ...
        public void serialize(NearbyBanner nearbyBanner, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<Material> list = nearbyBanner.materials;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, Material.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Long> list2 = nearbyBanner.timeRange;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(3, list2, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17307I(4, nearbyBanner.slideshowSec);
        }
    };
        ...
        public boolean parseField(NearbyBanner nearbyBanner, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "slideshowSec":
                    ...
                    return true;
                case "id":
                    nearbyBanner.f39631id = jsonParser.getValueAsString();
                    return false;
                case "timeRange":
    ...
    public static /* synthetic */ Long m61052b(Long l2) {
        return l2;
    }
    ...
    public NearbyBanner mo225055clone() {
        NearbyBanner nearbyBanner = new NearbyBanner();
        nearbyBanner.f39631id = this.f39631id;
        List<Material> list = this.materials;
        if (list != null) {
            nearbyBanner.materials = ValueObject.util_map(list, new qcj() { // from class: l.pf20
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Material) obj).mo225055clone();
                }
            });
        }
        List<Long> list2 = this.timeRange;
        if (list2 != null) {
            nearbyBanner.timeRange = ValueObject.util_map(list2, new qcj() { // from class: l.qf20
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return NearbyBanner.m61052b((Long) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39631id, nearbyBanner.f39631id) && ValueObject.util_equals(this.materials, nearbyBanner.materials) && ValueObject.util_equals(this.timeRange, nearbyBanner.timeRange) && this.slideshowSec == nearbyBanner.slideshowSec;
    }
