...
public class CounterSecretCrushLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CounterSecretCrushLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<CounterSecretCrushLimit>() { // from class: com.p1.mobile.putong.data.CounterSecretCrushLimit.1
        ...
        public int computeAndCacheSize(CounterSecretCrushLimit counterSecretCrushLimit) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, counterSecretCrushLimit.remaining) + CodedOutputByteBufferNano.m17281h(2, counterSecretCrushLimit.total) + CodedOutputByteBufferNano.m17281h(3, counterSecretCrushLimit.received);
            counterSecretCrushLimit.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CounterSecretCrushLimit parse(nc5 nc5Var) throws IOException {
            CounterSecretCrushLimit counterSecretCrushLimit = new CounterSecretCrushLimit();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    counterSecretCrushLimit.remaining = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    counterSecretCrushLimit.total = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        return counterSecretCrushLimit;
                    }
                    counterSecretCrushLimit.received = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(CounterSecretCrushLimit counterSecretCrushLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, counterSecretCrushLimit.remaining);
            codedOutputByteBufferNano.m17305G(2, counterSecretCrushLimit.total);
            codedOutputByteBufferNano.m17305G(3, counterSecretCrushLimit.received);
        }
    };
    ...
    public CounterSecretCrushLimit mo225055clone() {
        CounterSecretCrushLimit counterSecretCrushLimit = new CounterSecretCrushLimit();
