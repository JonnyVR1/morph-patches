...
public class UserWealth extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserWealth> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserWealth>() { // from class: com.p1.mobile.putong.data.UserWealth.1
        ...
        public int computeAndCacheSize(UserWealth userWealth) {
            ...
            userWealth.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserWealth parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        userWealth.upperIncome = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        userWealth.lowIncome = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 26:
                        userWealth.car = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        userWealth.house = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        userWealth.houseRegion = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        userWealth.houseSubRegion = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        userWealth.pet = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 66:
                        userWealth.carImg = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        userWealth.houseImg = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        userWealth.petImg = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        userWealth.monthlyCost = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (userWealth.monthlyCost == null) {
                            userWealth.monthlyCost = new ArrayList();
    ...
    public static /* synthetic */ String m61323a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m61324b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m61325c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m61326d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m61327e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m61328f(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m61329k(String str) {
        return str;
    }

    /* JADX INFO: renamed from: l */
    public static /* synthetic */ String m61330l(String str) {
        return str;
    }

    /* JADX INFO: renamed from: m */
    public static /* synthetic */ String m61331m(String str) {
        return str;
    }

    /* JADX INFO: renamed from: n */
    public static /* synthetic */ String m61332n(String str) {
        return str;
    }
    ...
    public static /* synthetic */ String m61333o(String str) {
        return str;
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public UserWealth mo225055clone() {
        UserWealth userWealth = new UserWealth();
        List<String> list = this.upperIncome;
        if (list != null) {
            userWealth.upperIncome = ValueObject.util_map(list, new qcj() { // from class: l.vkk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61327e((String) obj);
                }
            });
        }
        List<String> list2 = this.lowIncome;
        if (list2 != null) {
            userWealth.lowIncome = ValueObject.util_map(list2, new qcj() { // from class: l.ykk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61326d((String) obj);
                }
            });
        }
        List<String> list3 = this.car;
        if (list3 != null) {
            userWealth.car = ValueObject.util_map(list3, new qcj() { // from class: l.zkk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61324b((String) obj);
                }
            });
        }
        List<String> list4 = this.house;
        if (list4 != null) {
            userWealth.house = ValueObject.util_map(list4, new qcj() { // from class: l.alk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61332n((String) obj);
                }
            });
        }
        List<String> list5 = this.houseRegion;
        if (list5 != null) {
            userWealth.houseRegion = ValueObject.util_map(list5, new qcj() { // from class: l.blk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61330l((String) obj);
                }
            });
        }
        List<String> list6 = this.houseSubRegion;
        if (list6 != null) {
            userWealth.houseSubRegion = ValueObject.util_map(list6, new qcj() { // from class: l.clk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61328f((String) obj);
                }
            });
        }
        List<String> list7 = this.pet;
        if (list7 != null) {
            userWealth.pet = ValueObject.util_map(list7, new qcj() { // from class: l.dlk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61329k((String) obj);
                }
            });
        }
        List<String> list8 = this.carImg;
        if (list8 != null) {
            userWealth.carImg = ValueObject.util_map(list8, new qcj() { // from class: l.elk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61333o((String) obj);
                }
            });
        }
        List<String> list9 = this.houseImg;
        if (list9 != null) {
            userWealth.houseImg = ValueObject.util_map(list9, new qcj() { // from class: l.flk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61325c((String) obj);
                }
            });
        }
        List<String> list10 = this.petImg;
        if (list10 != null) {
            userWealth.petImg = ValueObject.util_map(list10, new qcj() { // from class: l.wkk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61323a((String) obj);
                }
            });
        }
        List<String> list11 = this.monthlyCost;
        if (list11 != null) {
            userWealth.monthlyCost = ValueObject.util_map(list11, new qcj() { // from class: l.xkk0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return UserWealth.m61331m((String) obj);
                }
            });
        }
        return userWealth;
