...
public class OMSResource extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSResource> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSResource>() { // from class: com.p1.mobile.putong.data.OMSResource.1
        ...
        public int computeAndCacheSize(OMSResource oMSResource) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, oMSResource.index);
            List<OMSResourceInfo> list = oMSResource.nodes;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(2, list, OMSResourceInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            oMSResource.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSResource parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    oMSResource.index = nc5Var.m162486j();
                } else {
                    if (iM162497u != 18) {
                        if (oMSResource.nodes != null) {
                            break;
                    ...
                    oMSResource.nodes = (List) nc5Var.m162488l(OMSResourceInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return oMSResource;
        }
        ...
        public void serialize(OMSResource oMSResource, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, oMSResource.index);
            List<OMSResourceInfo> list = oMSResource.nodes;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, OMSResourceInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public OMSResource mo225055clone() {
        OMSResource oMSResource = new OMSResource();
        oMSResource.index = this.index;
        List<OMSResourceInfo> list = this.nodes;
        if (list != null) {
            oMSResource.nodes = ValueObject.util_map(list, new qcj() { // from class: l.w750
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((OMSResourceInfo) obj).mo225055clone();
                }
            });
        }
        return oMSResource;
