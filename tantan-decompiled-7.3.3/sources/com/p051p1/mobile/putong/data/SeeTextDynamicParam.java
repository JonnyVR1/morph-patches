...
public class SeeTextDynamicParam extends TEnum {
    ...
    public static final String f39660TA = "TA";
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(f39660TA, 7);
        ...
        supportEnum.add(f39660TA);
        _SeeTextDynamicParam = Collections.synchronizedMap(new l01());
    }
