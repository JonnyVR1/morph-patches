...
public class UserPrivacySettings extends ValueObject<UserPrivacySettings> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserPrivacySettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserPrivacySettings>() { // from class: com.p1.mobile.putong.data.UserPrivacySettings.1
        ...
        public int computeAndCacheSize(UserPrivacySettings userPrivacySettings) {
            ...
            if (str != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(12, str);
            }
            Boolean bool12 = userPrivacySettings.verifiedUserMsg;
            if (bool12 != null) {
                iM17275b += CodedOutputByteBufferNano.m17275b(13, bool12.booleanValue());
            }
            userPrivacySettings.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserPrivacySettings parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        userPrivacySettings.hideActivityTime = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 16:
                        userPrivacySettings.hideContacts = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 24:
                        userPrivacySettings.hideMutualContacts = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 32:
                        userPrivacySettings.hidePublicMoments = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 40:
                        userPrivacySettings.hideSchool = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 48:
                        userPrivacySettings.hideVIP = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 56:
                        userPrivacySettings.personalizeSuggest = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 64:
                        userPrivacySettings.heartbeatDisable = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 72:
                        userPrivacySettings.adsSuggest = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 80:
                        userPrivacySettings.onlineReminder = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 88:
                        userPrivacySettings.unrepliedReminder = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        userPrivacySettings.aiPictureEnable = nc5Var.m162495s();
                        continue;
                    case 104:
                        userPrivacySettings.verifiedUserMsg = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    default:
                        if (userPrivacySettings.hideActivityTime == null) {
                            userPrivacySettings.hideActivityTime = Boolean.FALSE;
        ...
        public void serialize(UserPrivacySettings userPrivacySettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            String str = userPrivacySettings.aiPictureEnable;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(12, str);
            }
            Boolean bool12 = userPrivacySettings.verifiedUserMsg;
            if (bool12 != null) {
                codedOutputByteBufferNano.m17299A(13, bool12.booleanValue());
            }
        }
    };
    ...
    public UserPrivacySettings mo225055clone() {
        UserPrivacySettings userPrivacySettings = new UserPrivacySettings();
