...
public class ProfileCompletion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ProfileCompletion> PROTOBUF_ADAPTER = new MessageNanoAdapter<ProfileCompletion>() { // from class: com.p1.mobile.putong.data.ProfileCompletion.1
        ...
        public int computeAndCacheSize(ProfileCompletion profileCompletion) {
            ...
            profileCompletion.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ProfileCompletion parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    profileCompletion.briefIntroduction = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (profileCompletion.briefIntroduction == null) {
                            profileCompletion.briefIntroduction = new ArrayList();
                    ...
                    profileCompletion.progress = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return profileCompletion;
        }
    ...
    public static /* synthetic */ String m61190a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m61191b(String str) {
        return str;
    }
    ...
    public ProfileCompletion mo225055clone() {
        ProfileCompletion profileCompletion = new ProfileCompletion();
        List<String> list = this.briefIntroduction;
        if (list != null) {
            profileCompletion.briefIntroduction = ValueObject.util_map(list, new qcj() { // from class: l.sq90
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ProfileCompletion.m61191b((String) obj);
                }
            });
        }
        List<String> list2 = this.progress;
        if (list2 != null) {
            profileCompletion.progress = ValueObject.util_map(list2, new qcj() { // from class: l.tq90
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ProfileCompletion.m61190a((String) obj);
                }
            });
        }
        return profileCompletion;
