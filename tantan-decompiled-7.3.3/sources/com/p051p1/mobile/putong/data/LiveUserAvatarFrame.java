...
public class LiveUserAvatarFrame extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveUserAvatarFrame> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveUserAvatarFrame>() { // from class: com.p1.mobile.putong.data.LiveUserAvatarFrame.1
        ...
        public int computeAndCacheSize(LiveUserAvatarFrame liveUserAvatarFrame) {
            String str = liveUserAvatarFrame.f39625id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            String str2 = liveUserAvatarFrame.url;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(2, str2);
            }
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(3, liveUserAvatarFrame.expireTime);
            LiveRight liveRight = liveUserAvatarFrame.liveRight;
            if (liveRight != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(4, liveRight, LiveRight.PROTOBUF_ADAPTER);
            }
            liveUserAvatarFrame.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveUserAvatarFrame parse(nc5 nc5Var) throws IOException {
            LiveUserAvatarFrame liveUserAvatarFrame = new LiveUserAvatarFrame();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (liveUserAvatarFrame.f39625id == null) {
                        liveUserAvatarFrame.f39625id = "";
                    }
                ...
                if (iM162497u == 10) {
                    liveUserAvatarFrame.f39625id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    liveUserAvatarFrame.url = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    liveUserAvatarFrame.expireTime = nc5Var.m162487k();
                } else {
                    if (iM162497u != 34) {
                        if (liveUserAvatarFrame.f39625id == null) {
                            liveUserAvatarFrame.f39625id = "";
                    ...
                    liveUserAvatarFrame.liveRight = (LiveRight) nc5Var.m162488l(LiveRight.PROTOBUF_ADAPTER);
                }
            }
            return liveUserAvatarFrame;
        }
        ...
        public void serialize(LiveUserAvatarFrame liveUserAvatarFrame, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(3, liveUserAvatarFrame.expireTime);
            LiveRight liveRight = liveUserAvatarFrame.liveRight;
            if (liveRight != null) {
                codedOutputByteBufferNano.m17309K(4, liveRight, LiveRight.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(LiveUserAvatarFrame liveUserAvatarFrame, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "expireTime":
                    ...
                    return true;
                case "id":
                    liveUserAvatarFrame.f39625id = jsonParser.getValueAsString();
                    return false;
                case "url":
    ...
    public boolean canShow() {
        return !TextUtils.isEmpty(this.url) && this.expireTime >= pzi0.m174454o() / 1000 && NullChecker.m82486a(this.liveRight);
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public LiveUserAvatarFrame mo225055clone() {
        LiveUserAvatarFrame liveUserAvatarFrame = new LiveUserAvatarFrame();
        liveUserAvatarFrame.f39625id = this.f39625id;
        liveUserAvatarFrame.url = this.url;
        liveUserAvatarFrame.expireTime = this.expireTime;
        LiveRight liveRight = this.liveRight;
        if (liveRight != null) {
            liveUserAvatarFrame.liveRight = liveRight.mo225055clone();
        }
        return liveUserAvatarFrame;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39625id, liveUserAvatarFrame.f39625id) && ValueObject.util_equals(this.url, liveUserAvatarFrame.url) && this.expireTime == liveUserAvatarFrame.expireTime && ValueObject.util_equals(this.liveRight, liveUserAvatarFrame.liveRight);
    }
