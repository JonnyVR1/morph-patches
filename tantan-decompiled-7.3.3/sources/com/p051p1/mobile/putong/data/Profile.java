...
import com.p051p1.mobile.putong.data.Social;
...
public class Profile extends ValueObject<Profile> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Profile> PROTOBUF_ADAPTER = new MessageNanoAdapter<Profile>() { // from class: com.p1.mobile.putong.data.Profile.1
        ...
        public int computeAndCacheSize(Profile profile) {
            ...
            if (l2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17283j(4, l2.longValue());
            }
            List<Tag> list = profile.tags;
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, list, Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (mutualContactsLocalLookups != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(7, mutualContactsLocalLookups, MutualContactsLocalLookups.PROTOBUF_ADAPTER);
            }
            List<Social> list2 = profile.social;
            if (list2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(8, list2, Social.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Answer> list3 = profile.answers;
            if (list3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(9, list3, Answer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ProfileZodiac profileZodiac = profile.zodiac;
            if (profileZodiac != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(10, profileZodiac.ordinal());
            }
            String str5 = profile.occupation;
            if (str5 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(11, str5);
            }
            Work work = profile.work;
            if (work != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(12, work, Work.PROTOBUF_ADAPTER);
            }
            Studies studies = profile.studies;
            if (studies != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(13, studies, Studies.PROTOBUF_ADAPTER);
            }
            List<String> list4 = profile.scenarios;
            if (list4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(14, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str6 = profile.receivedLikesRank;
            if (str6 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(15, str6);
            }
            ProfileTbh profileTbh = profile.tbh;
            if (profileTbh != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(16, profileTbh, ProfileTbh.PROTOBUF_ADAPTER);
            }
            FollowshipCounters followshipCounters = profile.followships;
            if (followshipCounters != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(17, followshipCounters, FollowshipCounters.PROTOBUF_ADAPTER);
            }
            Moments moments = profile.moments;
            if (moments != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(18, moments, Moments.PROTOBUF_ADAPTER);
            }
            UserProfileMood userProfileMood = profile.mood;
            if (userProfileMood != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(19, userProfileMood, UserProfileMood.PROTOBUF_ADAPTER);
            }
            Extensions extensions = profile.extensions;
            if (extensions != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(20, extensions, Extensions.PROTOBUF_ADAPTER);
            }
            MoodMoment moodMoment = profile.moodMoment;
            if (moodMoment != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(21, moodMoment, MoodMoment.PROTOBUF_ADAPTER);
            }
            BizAnswers bizAnswers = profile.bizAnswers;
            if (bizAnswers != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(22, bizAnswers, BizAnswers.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(23, profile.onlyShowAboutMeInside);
            ProfileZodiac profileZodiac2 = profile.zodiac;
            if (profileZodiac2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(24, profileZodiac2, ProfileZodiac.PROTOBUF_ADAPTER);
            }
            profile.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Profile parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        profile.school = nc5Var.m162495s();
                        continue;
                    case 18:
                        profile.hangouts = nc5Var.m162495s();
                        continue;
                    case 26:
                        profile.hometown = nc5Var.m162495s();
                        continue;
                    case 32:
                        profile.receivedLikes = Long.valueOf(nc5Var.m162487k());
                        continue;
                    case 42:
                        profile.tags = (List) nc5Var.m162488l(Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        profile.job = nc5Var.m162495s();
                        continue;
                    case 58:
                        profile.contactLookups = (MutualContactsLocalLookups) nc5Var.m162488l(MutualContactsLocalLookups.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        profile.social = (List) nc5Var.m162488l(Social.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        profile.answers = (List) nc5Var.m162488l(Answer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 80:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 90:
                        profile.occupation = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        profile.work = (Work) nc5Var.m162488l(Work.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        profile.studies = (Studies) nc5Var.m162488l(Studies.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        profile.scenarios = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 122:
                        profile.receivedLikesRank = nc5Var.m162495s();
                        continue;
                    case 130:
                        profile.tbh = (ProfileTbh) nc5Var.m162488l(ProfileTbh.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        profile.followships = (FollowshipCounters) nc5Var.m162488l(FollowshipCounters.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        profile.moments = (Moments) nc5Var.m162488l(Moments.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        profile.mood = (UserProfileMood) nc5Var.m162488l(UserProfileMood.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        profile.extensions = (Extensions) nc5Var.m162488l(Extensions.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        profile.moodMoment = (MoodMoment) nc5Var.m162488l(MoodMoment.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        profile.bizAnswers = (BizAnswers) nc5Var.m162488l(BizAnswers.PROTOBUF_ADAPTER);
                        continue;
                    case 184:
                        profile.onlyShowAboutMeInside = nc5Var.m162483g();
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        profile.zodiac = (ProfileZodiac) nc5Var.m162488l(ProfileZodiac.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (profile.zodiac == null && numValueOf != null) {
                            profile.zodiac = (ProfileZodiac) ProfileZodiac.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Profile profile, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Long l2 = profile.receivedLikes;
            if (l2 != null) {
                codedOutputByteBufferNano.m17307I(4, l2.longValue());
            }
            List<Tag> list = profile.tags;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(5, list, Tag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = profile.job;
            if (str4 != null) {
            ...
            MutualContactsLocalLookups mutualContactsLocalLookups = profile.contactLookups;
            if (mutualContactsLocalLookups != null) {
                codedOutputByteBufferNano.m17309K(7, mutualContactsLocalLookups, MutualContactsLocalLookups.PROTOBUF_ADAPTER);
            }
            List<Social> list2 = profile.social;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(8, list2, Social.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<Answer> list3 = profile.answers;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(9, list3, Answer.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ProfileZodiac profileZodiac = profile.zodiac;
            if (profileZodiac != null) {
                codedOutputByteBufferNano.m17305G(10, profileZodiac.ordinal());
            }
            String str5 = profile.occupation;
            if (str5 != null) {
            ...
            Work work = profile.work;
            if (work != null) {
                codedOutputByteBufferNano.m17309K(12, work, Work.PROTOBUF_ADAPTER);
            }
            Studies studies = profile.studies;
            if (studies != null) {
                codedOutputByteBufferNano.m17309K(13, studies, Studies.PROTOBUF_ADAPTER);
            }
            List<String> list4 = profile.scenarios;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(14, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str6 = profile.receivedLikesRank;
            if (str6 != null) {
            ...
            ProfileTbh profileTbh = profile.tbh;
            if (profileTbh != null) {
                codedOutputByteBufferNano.m17309K(16, profileTbh, ProfileTbh.PROTOBUF_ADAPTER);
            }
            FollowshipCounters followshipCounters = profile.followships;
            if (followshipCounters != null) {
                codedOutputByteBufferNano.m17309K(17, followshipCounters, FollowshipCounters.PROTOBUF_ADAPTER);
            }
            Moments moments = profile.moments;
            if (moments != null) {
                codedOutputByteBufferNano.m17309K(18, moments, Moments.PROTOBUF_ADAPTER);
            }
            UserProfileMood userProfileMood = profile.mood;
            if (userProfileMood != null) {
                codedOutputByteBufferNano.m17309K(19, userProfileMood, UserProfileMood.PROTOBUF_ADAPTER);
            }
            Extensions extensions = profile.extensions;
            if (extensions != null) {
                codedOutputByteBufferNano.m17309K(20, extensions, Extensions.PROTOBUF_ADAPTER);
            }
            MoodMoment moodMoment = profile.moodMoment;
            if (moodMoment != null) {
                codedOutputByteBufferNano.m17309K(21, moodMoment, MoodMoment.PROTOBUF_ADAPTER);
            }
            BizAnswers bizAnswers = profile.bizAnswers;
            if (bizAnswers != null) {
                codedOutputByteBufferNano.m17309K(22, bizAnswers, BizAnswers.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(23, profile.onlyShowAboutMeInside);
            ProfileZodiac profileZodiac2 = profile.zodiac;
            if (profileZodiac2 != null) {
                codedOutputByteBufferNano.m17309K(24, profileZodiac2, ProfileZodiac.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m61186b(String str) {
        return str;
    }
    ...
    public Profile mo225055clone() {
        ...
        if (list != null) {
            profile.tags = ValueObject.util_map(list, new qcj() { // from class: l.em90
                @Override // p153l.qcj
        ...
        if (partialIdList != null) {
            profile.api_only_mutualContacts = partialIdList.mo225055clone();
        }
        MutualContactsLocalLookups mutualContactsLocalLookups = this.contactLookups;
        if (mutualContactsLocalLookups != null) {
            profile.contactLookups = mutualContactsLocalLookups.mo225055clone();
        }
        List<Social> list2 = this.social;
        if (list2 != null) {
            profile.social = ValueObject.util_map(list2, new qcj() { // from class: l.fm90
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Social) obj).mo225055clone();
                }
            });
        }
        List<Answer> list3 = this.answers;
        if (list3 != null) {
            profile.answers = ValueObject.util_map(list3, new qcj() { // from class: l.gm90
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        Work work = this.work;
        if (work != null) {
            profile.work = work.mo225055clone();
        }
        Studies studies = this.studies;
        if (studies != null) {
            profile.studies = studies.mo225055clone();
        }
        List<String> list4 = this.scenarios;
        if (list4 != null) {
            profile.scenarios = ValueObject.util_map(list4, new qcj() { // from class: l.hm90
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return Profile.m61186b((String) obj);
                }
            });
        }
        ...
        if (profileTbh != null) {
            profile.tbh = profileTbh.mo225055clone();
        }
        FollowshipCounters followshipCounters = this.followships;
        if (followshipCounters != null) {
            profile.followships = followshipCounters.mo225055clone();
        }
        Moments moments = this.moments;
        if (moments != null) {
            profile.moments = moments.mo225055clone();
        }
        UserProfileMood userProfileMood = this.mood;
        if (userProfileMood != null) {
            profile.mood = userProfileMood.mo225055clone();
        }
        Extensions extensions = this.extensions;
        if (extensions != null) {
            profile.extensions = extensions.mo225055clone();
        }
        MoodMoment moodMoment = this.moodMoment;
        if (moodMoment != null) {
            profile.moodMoment = moodMoment.mo225055clone();
        }
        BizAnswers bizAnswers = this.bizAnswers;
        if (bizAnswers != null) {
            profile.bizAnswers = bizAnswers.mo225055clone();
        }
    ...
    public List<Tag> placesTag() {
        return jyb.m147479J(this.tags) ? new ArrayList() : jyb.m147522n(this.tags, new qcj() { // from class: l.dm90
            @Override // p153l.qcj
            public final Object call(Object obj) {
