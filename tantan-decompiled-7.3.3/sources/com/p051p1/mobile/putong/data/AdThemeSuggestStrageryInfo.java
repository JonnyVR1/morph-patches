...
import com.p051p1.mobile.putong.data.AdThemeSuggestStrageryInfo;
...
public class AdThemeSuggestStrageryInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AdThemeSuggestStrageryInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<AdThemeSuggestStrageryInfo>() { // from class: com.p1.mobile.putong.data.AdThemeSuggestStrageryInfo.1
        ...
        public int computeAndCacheSize(AdThemeSuggestStrageryInfo adThemeSuggestStrageryInfo) {
            ...
            adThemeSuggestStrageryInfo.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AdThemeSuggestStrageryInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    adThemeSuggestStrageryInfo.tags = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (adThemeSuggestStrageryInfo.tags == null) {
                            adThemeSuggestStrageryInfo.tags = new ArrayList();
                    ...
                    adThemeSuggestStrageryInfo.groupID = nc5Var.m162495s();
                }
            }
            return adThemeSuggestStrageryInfo;
        }
    ...
    public static /* synthetic */ String m60845a(String str) {
        return str;
    }
    ...
    public AdThemeSuggestStrageryInfo mo225055clone() {
        AdThemeSuggestStrageryInfo adThemeSuggestStrageryInfo = new AdThemeSuggestStrageryInfo();
        List<String> list = this.tags;
        if (list != null) {
            adThemeSuggestStrageryInfo.tags = ValueObject.util_map(list, new qcj() { // from class: l.x70
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return AdThemeSuggestStrageryInfo.m60845a((String) obj);
                }
            });
        }
