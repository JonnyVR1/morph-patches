...
public class BannerEnvelope extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BannerEnvelope> PROTOBUF_ADAPTER = new MessageNanoAdapter<BannerEnvelope>() { // from class: com.p1.mobile.putong.data.BannerEnvelope.1
        ...
        public int computeAndCacheSize(BannerEnvelope bannerEnvelope) {
            ...
            if (bannerData != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, bannerData, BannerData.PROTOBUF_ADAPTER);
            }
            bannerEnvelope.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BannerEnvelope parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bannerEnvelope.meta = (Meta) nc5Var.m162488l(Meta.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (bannerEnvelope.meta == null) {
                            bannerEnvelope.meta = Meta.new_();
                    ...
                    bannerEnvelope.data = (BannerData) nc5Var.m162488l(BannerData.PROTOBUF_ADAPTER);
                }
            }
            return bannerEnvelope;
        }
        ...
        public void serialize(BannerEnvelope bannerEnvelope, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BannerData bannerData = bannerEnvelope.data;
            if (bannerData != null) {
                codedOutputByteBufferNano.m17309K(2, bannerData, BannerData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public BannerEnvelope mo225055clone() {
        BannerEnvelope bannerEnvelope = new BannerEnvelope();
        Meta meta = this.meta;
        if (meta != null) {
            bannerEnvelope.meta = meta.mo225055clone();
        }
        BannerData bannerData = this.data;
        if (bannerData != null) {
            bannerEnvelope.data = bannerData.mo225055clone();
        }
        return bannerEnvelope;
    }
