...
public class PhoneNumber extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PhoneNumber> PROTOBUF_ADAPTER = new MessageNanoAdapter<PhoneNumber>() { // from class: com.p1.mobile.putong.data.PhoneNumber.1
        ...
        public int computeAndCacheSize(PhoneNumber phoneNumber) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, phoneNumber.countryCode);
            String str = phoneNumber.number;
            if (str != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(2, str);
            }
            phoneNumber.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PhoneNumber parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    phoneNumber.countryCode = nc5Var.m162486j();
                } else {
                    if (iM162497u != 18) {
                        if (phoneNumber.number != null) {
                            break;
                    ...
                    phoneNumber.number = nc5Var.m162495s();
                }
            }
            return phoneNumber;
        }
        ...
        public void serialize(PhoneNumber phoneNumber, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, phoneNumber.countryCode);
            String str = phoneNumber.number;
            if (str != null) {
    ...
    public PhoneNumber mo225055clone() {
        PhoneNumber phoneNumber = new PhoneNumber();
