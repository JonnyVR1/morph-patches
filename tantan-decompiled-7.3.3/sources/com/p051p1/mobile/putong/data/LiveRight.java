...
public class LiveRight extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveRight> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveRight>() { // from class: com.p1.mobile.putong.data.LiveRight.1
        ...
        public int computeAndCacheSize(LiveRight liveRight) {
            ...
            if (liveAvatarFrameConfig != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, liveAvatarFrameConfig, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
            liveRight.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveRight parse(nc5 nc5Var) throws IOException {
            LiveRight liveRight = new LiveRight();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (liveRight.f39621id == null) {
                        liveRight.f39621id = "";
                    }
                ...
                if (iM162497u == 10) {
                    liveRight.f39621id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    liveRight.name = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    liveRight.rightType = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    liveRight.placeType = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    liveRight.description = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (liveRight.f39621id == null) {
                            liveRight.f39621id = "";
                    ...
                    liveRight.avatarFrameConfig = (LiveAvatarFrameConfig) nc5Var.m162488l(LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
                }
            }
            return liveRight;
        }
        ...
        public void serialize(LiveRight liveRight, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            LiveAvatarFrameConfig liveAvatarFrameConfig = liveRight.avatarFrameConfig;
            if (liveAvatarFrameConfig != null) {
                codedOutputByteBufferNano.m17309K(6, liveAvatarFrameConfig, LiveAvatarFrameConfig.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(LiveRight liveRight, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "avatarFrameConfig":
                    ...
                    return true;
                case "id":
                    liveRight.f39621id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public LiveRight mo225055clone() {
        LiveRight liveRight = new LiveRight();
        liveRight.f39621id = this.f39621id;
        ...
        if (liveAvatarFrameConfig != null) {
            liveRight.avatarFrameConfig = liveAvatarFrameConfig.mo225055clone();
        }
        return liveRight;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f39621id, liveRight.f39621id) && ValueObject.util_equals(this.name, liveRight.name) && ValueObject.util_equals(this.rightType, liveRight.rightType) && ValueObject.util_equals(this.placeType, liveRight.placeType) && ValueObject.util_equals(this.description, liveRight.description) && ValueObject.util_equals(this.avatarFrameConfig, liveRight.avatarFrameConfig);
    }
