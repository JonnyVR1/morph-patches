...
import com.p051p1.mobile.putong.data.FriendState;
import com.p051p1.mobile.putong.data.FriendStatus;
...
public class FriendStatus extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FriendStatus> PROTOBUF_ADAPTER = new MessageNanoAdapter<FriendStatus>() { // from class: com.p1.mobile.putong.data.FriendStatus.1
        ...
        public int computeAndCacheSize(FriendStatus friendStatus) {
            ...
            if (list4 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, FriendState.covertToOldEnumList(list4), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FriendState> list5 = friendStatus.status;
            if (list5 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, list5, FriendState.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            friendStatus.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FriendStatus parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    friendStatus.labelType = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    friendStatus.labelName = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 26) {
                    friendStatus.endTime = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                    ...
                    friendStatus.status = (List) nc5Var.m162488l(FriendState.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return friendStatus;
        }
        ...
        public void serialize(FriendStatus friendStatus, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<FriendState> list4 = friendStatus.status;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(4, FriendState.covertToOldEnumList(list4), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FriendState> list5 = friendStatus.status;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(5, list5, FriendState.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m60975a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ FriendState m60976b(FriendState friendState) {
        return friendState;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m60977c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m60978d(String str) {
        return str;
    }
    ...
    public FriendStatus mo225055clone() {
        FriendStatus friendStatus = new FriendStatus();
        List<String> list = this.labelType;
        if (list != null) {
            friendStatus.labelType = ValueObject.util_map(list, new qcj() { // from class: l.caj
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FriendStatus.m60978d((String) obj);
                }
            });
        }
        List<String> list2 = this.labelName;
        if (list2 != null) {
            friendStatus.labelName = ValueObject.util_map(list2, new qcj() { // from class: l.daj
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FriendStatus.m60977c((String) obj);
                }
            });
        }
        List<String> list3 = this.endTime;
        if (list3 != null) {
            friendStatus.endTime = ValueObject.util_map(list3, new qcj() { // from class: l.eaj
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FriendStatus.m60975a((String) obj);
                }
            });
        }
        List<FriendState> list4 = this.status;
        if (list4 != null) {
            friendStatus.status = ValueObject.util_map(list4, new qcj() { // from class: l.faj
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FriendStatus.m60976b((FriendState) obj);
                }
            });
        }
        return friendStatus;
