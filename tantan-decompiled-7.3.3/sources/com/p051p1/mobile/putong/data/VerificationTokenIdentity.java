...
public class VerificationTokenIdentity extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VerificationTokenIdentity> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerificationTokenIdentity>() { // from class: com.p1.mobile.putong.data.VerificationTokenIdentity.1
        ...
        public int computeAndCacheSize(VerificationTokenIdentity verificationTokenIdentity) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(5, verificationTokenIdentity.dynamicProvider) + CodedOutputByteBufferNano.m17275b(6, verificationTokenIdentity.upgrade);
            String str5 = verificationTokenIdentity.metaInfo;
            if (str5 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(7, str5);
            }
            verificationTokenIdentity.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerificationTokenIdentity parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    verificationTokenIdentity.provider = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    verificationTokenIdentity.identityName = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    verificationTokenIdentity.identityNumber = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    verificationTokenIdentity.providerAppId = nc5Var.m162495s();
                } else if (iM162497u == 40) {
                    verificationTokenIdentity.dynamicProvider = nc5Var.m162483g();
                } else if (iM162497u == 48) {
                    verificationTokenIdentity.upgrade = nc5Var.m162483g();
                } else {
                    if (iM162497u != 58) {
                        if (verificationTokenIdentity.provider == null) {
                            verificationTokenIdentity.provider = "";
                    ...
                    verificationTokenIdentity.metaInfo = nc5Var.m162495s();
                }
            }
            return verificationTokenIdentity;
        }
        ...
        public void serialize(VerificationTokenIdentity verificationTokenIdentity, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(5, verificationTokenIdentity.dynamicProvider);
            codedOutputByteBufferNano.m17299A(6, verificationTokenIdentity.upgrade);
            String str5 = verificationTokenIdentity.metaInfo;
            if (str5 != null) {
    ...
    public VerificationTokenIdentity mo225055clone() {
        VerificationTokenIdentity verificationTokenIdentity = new VerificationTokenIdentity();
