...
public class OMSTemplateModeType extends TEnum {
    ...
    static {
        ...
        tEnumJsonAdapter.addExtJsonValue(checkbox, 10);
        tEnumJsonAdapter.addExtJsonValue(switch_btn, 11);
        tEnumJsonAdapter.addExtJsonValue(toast, 12);
        ...
        _OMSTemplateModeType = Collections.synchronizedMap(new l01());
    }
