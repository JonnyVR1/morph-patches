...
import com.p051p1.mobile.putong.data.FBEducation;
import com.p051p1.mobile.putong.data.FBWork;
...
public class FBUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FBUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<FBUser>() { // from class: com.p1.mobile.putong.data.FBUser.1
        ...
        public int computeAndCacheSize(FBUser fBUser) {
            ...
            if (fBProfile != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, fBProfile, FBProfile.PROTOBUF_ADAPTER);
            }
            ...
            if (fBPage != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, fBPage, FBPage.PROTOBUF_ADAPTER);
            }
            FBPage fBPage2 = fBUser.location;
            if (fBPage2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(7, fBPage2, FBPage.PROTOBUF_ADAPTER);
            }
            List<FBWork> list = fBUser.work;
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(8, list, FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FBEducation> list2 = fBUser.education;
            if (list2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(9, list2, FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            FBLikes fBLikes = fBUser.music;
            if (fBLikes != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(10, fBLikes, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes2 = fBUser.movies;
            if (fBLikes2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(11, fBLikes2, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes3 = fBUser.books;
            if (fBLikes3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(12, fBLikes3, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes4 = fBUser.television;
            if (fBLikes4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(13, fBLikes4, FBLikes.PROTOBUF_ADAPTER);
            }
            fBUser.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FBUser parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        fBUser.name = nc5Var.m162495s();
                        continue;
                    case 18:
                        fBUser.gender = nc5Var.m162495s();
                        continue;
                    case 26:
                        fBUser.birthday = nc5Var.m162495s();
                        continue;
                    case 34:
                        fBUser.fbPicture = (FBProfile) nc5Var.m162488l(FBProfile.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        fBUser.about = nc5Var.m162495s();
                        continue;
                    case 50:
                        fBUser.hometown = (FBPage) nc5Var.m162488l(FBPage.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        fBUser.location = (FBPage) nc5Var.m162488l(FBPage.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        fBUser.work = (List) nc5Var.m162488l(FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        fBUser.education = (List) nc5Var.m162488l(FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        fBUser.music = (FBLikes) nc5Var.m162488l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        fBUser.movies = (FBLikes) nc5Var.m162488l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        fBUser.books = (FBLikes) nc5Var.m162488l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        fBUser.television = (FBLikes) nc5Var.m162488l(FBLikes.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (fBUser.name == null) {
                            fBUser.name = "";
        ...
        public void serialize(FBUser fBUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            FBProfile fBProfile = fBUser.fbPicture;
            if (fBProfile != null) {
                codedOutputByteBufferNano.m17309K(4, fBProfile, FBProfile.PROTOBUF_ADAPTER);
            }
            String str4 = fBUser.about;
            if (str4 != null) {
            ...
            FBPage fBPage = fBUser.hometown;
            if (fBPage != null) {
                codedOutputByteBufferNano.m17309K(6, fBPage, FBPage.PROTOBUF_ADAPTER);
            }
            FBPage fBPage2 = fBUser.location;
            if (fBPage2 != null) {
                codedOutputByteBufferNano.m17309K(7, fBPage2, FBPage.PROTOBUF_ADAPTER);
            }
            List<FBWork> list = fBUser.work;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(8, list, FBWork.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<FBEducation> list2 = fBUser.education;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(9, list2, FBEducation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            FBLikes fBLikes = fBUser.music;
            if (fBLikes != null) {
                codedOutputByteBufferNano.m17309K(10, fBLikes, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes2 = fBUser.movies;
            if (fBLikes2 != null) {
                codedOutputByteBufferNano.m17309K(11, fBLikes2, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes3 = fBUser.books;
            if (fBLikes3 != null) {
                codedOutputByteBufferNano.m17309K(12, fBLikes3, FBLikes.PROTOBUF_ADAPTER);
            }
            FBLikes fBLikes4 = fBUser.television;
            if (fBLikes4 != null) {
                codedOutputByteBufferNano.m17309K(13, fBLikes4, FBLikes.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FBUser mo225055clone() {
        ...
        if (fBProfile != null) {
            fBUser.fbPicture = fBProfile.mo225055clone();
        }
        fBUser.about = this.about;
        FBPage fBPage = this.hometown;
        if (fBPage != null) {
            fBUser.hometown = fBPage.mo225055clone();
        }
        FBPage fBPage2 = this.location;
        if (fBPage2 != null) {
            fBUser.location = fBPage2.mo225055clone();
        }
        List<FBWork> list = this.work;
        if (list != null) {
            fBUser.work = ValueObject.util_map(list, new qcj() { // from class: l.nsf
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FBWork) obj).mo225055clone();
                }
            });
        }
        List<FBEducation> list2 = this.education;
        if (list2 != null) {
            fBUser.education = ValueObject.util_map(list2, new qcj() { // from class: l.osf
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FBEducation) obj).mo225055clone();
                }
            });
        }
        FBLikes fBLikes = this.music;
        if (fBLikes != null) {
            fBUser.music = fBLikes.mo225055clone();
        }
        FBLikes fBLikes2 = this.movies;
        if (fBLikes2 != null) {
            fBUser.movies = fBLikes2.mo225055clone();
        }
        FBLikes fBLikes3 = this.books;
        if (fBLikes3 != null) {
            fBUser.books = fBLikes3.mo225055clone();
        }
        FBLikes fBLikes4 = this.television;
        if (fBLikes4 != null) {
            fBUser.television = fBLikes4.mo225055clone();
        }
        return fBUser;
    }
