...
import com.p051p1.mobile.putong.data.OMSSwipeAction;
import com.p051p1.mobile.putong.data.TriggerProperty;
...
public class TriggerProperty extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TriggerProperty> PROTOBUF_ADAPTER = new MessageNanoAdapter<TriggerProperty>() { // from class: com.p1.mobile.putong.data.TriggerProperty.1
        ...
        public int computeAndCacheSize(TriggerProperty triggerProperty) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, OMSSwipeAction.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            OMSSwipeMoment oMSSwipeMoment = triggerProperty.moment;
            if (oMSSwipeMoment != null) {
                iM17285l += CodedOutputByteBufferNano.m17281h(2, oMSSwipeMoment.ordinal());
            }
            ...
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, list2, OMSSwipeAction.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OMSSwipeMoment oMSSwipeMoment2 = triggerProperty.moment;
            if (oMSSwipeMoment2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, oMSSwipeMoment2, OMSSwipeMoment.PROTOBUF_ADAPTER);
            }
            triggerProperty.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TriggerProperty parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    ...
                    triggerProperty.pageID = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    triggerProperty.action = (List) nc5Var.m162488l(OMSSwipeAction.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 42) {
                        if (triggerProperty.action == null && list != null) {
                            triggerProperty.action = OMSSwipeAction.oldEnumCovertList(list);
                    ...
                    triggerProperty.moment = (OMSSwipeMoment) nc5Var.m162488l(OMSSwipeMoment.PROTOBUF_ADAPTER);
                }
            }
            return triggerProperty;
        }
        ...
        public void serialize(TriggerProperty triggerProperty, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<OMSSwipeAction> list = triggerProperty.action;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, OMSSwipeAction.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OMSSwipeMoment oMSSwipeMoment = triggerProperty.moment;
            if (oMSSwipeMoment != null) {
                codedOutputByteBufferNano.m17305G(2, oMSSwipeMoment.ordinal());
            }
            String str = triggerProperty.pageID;
            if (str != null) {
            ...
            List<OMSSwipeAction> list2 = triggerProperty.action;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(4, list2, OMSSwipeAction.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            OMSSwipeMoment oMSSwipeMoment2 = triggerProperty.moment;
            if (oMSSwipeMoment2 != null) {
                codedOutputByteBufferNano.m17309K(5, oMSSwipeMoment2, OMSSwipeMoment.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ OMSSwipeAction m61290a(OMSSwipeAction oMSSwipeAction) {
    ...
    public TriggerProperty mo225055clone() {
        TriggerProperty triggerProperty = new TriggerProperty();
        List<OMSSwipeAction> list = this.action;
        if (list != null) {
            triggerProperty.action = ValueObject.util_map(list, new qcj() { // from class: l.yjj0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return TriggerProperty.m61290a((OMSSwipeAction) obj);
                }
            });
        }
