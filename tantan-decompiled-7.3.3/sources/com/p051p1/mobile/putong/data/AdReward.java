...
public class AdReward extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AdReward> PROTOBUF_ADAPTER = new MessageNanoAdapter<AdReward>() { // from class: com.p1.mobile.putong.data.AdReward.1
        ...
        public int computeAndCacheSize(AdReward adReward) {
            ...
            int iM17285l = adScenes != null ? CodedOutputByteBufferNano.m17285l(1, adScenes, AdScenes.PROTOBUF_ADAPTER) : 0;
            adReward.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AdReward parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                adReward.swipe = (AdScenes) nc5Var.m162488l(AdScenes.PROTOBUF_ADAPTER);
            }
            return adReward;
        }
        ...
        public void serialize(AdReward adReward, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            AdScenes adScenes = adReward.swipe;
            if (adScenes != null) {
                codedOutputByteBufferNano.m17309K(1, adScenes, AdScenes.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public AdReward mo225055clone() {
        AdReward adReward = new AdReward();
        AdScenes adScenes = this.swipe;
        if (adScenes != null) {
            adReward.swipe = adScenes.mo225055clone();
        }
        return adReward;
    }
