...
public class UserStateContent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserStateContent> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserStateContent>() { // from class: com.p1.mobile.putong.data.UserStateContent.1
        ...
        public int computeAndCacheSize(UserStateContent userStateContent) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, userStateContent.active);
            String str = userStateContent.reason;
            if (str != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(2, str);
            }
            int iM17277d = iM17275b + CodedOutputByteBufferNano.m17277d(3, userStateContent.expireTime);
            String str2 = userStateContent.code;
            if (str2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(4, str2);
            }
            userStateContent.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserStateContent parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    userStateContent.active = nc5Var.m162483g();
                } else if (iM162497u == 18) {
                    userStateContent.reason = nc5Var.m162495s();
                } else if (iM162497u == 25) {
                    userStateContent.expireTime = nc5Var.m162484h();
                } else {
                    if (iM162497u != 34) {
                        if (userStateContent.reason == null) {
                            userStateContent.reason = "";
                    ...
                    userStateContent.code = nc5Var.m162495s();
                }
            }
            return userStateContent;
        }
        ...
        public void serialize(UserStateContent userStateContent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, userStateContent.active);
            String str = userStateContent.reason;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(2, str);
            }
            codedOutputByteBufferNano.m17301C(3, userStateContent.expireTime);
            String str2 = userStateContent.code;
            if (str2 != null) {
    ...
    public UserStateContent mo225055clone() {
        UserStateContent userStateContent = new UserStateContent();
