...
public class ActivityUser extends ValueObject<ActivityUser> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ActivityUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<ActivityUser>() { // from class: com.p1.mobile.putong.data.ActivityUser.1
        ...
        public int computeAndCacheSize(ActivityUser activityUser) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17283j(2, activityUser.score);
            activityUser.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ActivityUser parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    activityUser.action = nc5Var.m162495s();
                } else {
                    if (iM162497u != 16) {
                        if (activityUser.action != null) {
                            break;
                    ...
                    activityUser.score = nc5Var.m162487k();
                }
            }
            return activityUser;
        }
        ...
        public void serialize(ActivityUser activityUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(2, activityUser.score);
        }
    };
    ...
    public ActivityUser mo225055clone() {
        ActivityUser activityUser = new ActivityUser();
