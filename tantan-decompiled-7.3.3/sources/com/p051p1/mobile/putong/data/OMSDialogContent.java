...
public class OMSDialogContent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OMSDialogContent> PROTOBUF_ADAPTER = new MessageNanoAdapter<OMSDialogContent>() { // from class: com.p1.mobile.putong.data.OMSDialogContent.1
        ...
        public int computeAndCacheSize(OMSDialogContent oMSDialogContent) {
            ...
            int iM17285l = oMSWebDialogResource != null ? CodedOutputByteBufferNano.m17285l(1, oMSWebDialogResource, OMSWebDialogResource.PROTOBUF_ADAPTER) : 0;
            OMSDialog oMSDialog = oMSDialogContent.morph;
            if (oMSDialog != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, oMSDialog, OMSDialog.PROTOBUF_ADAPTER);
            }
            oMSDialogContent.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OMSDialogContent parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    oMSDialogContent.web = (OMSWebDialogResource) nc5Var.m162488l(OMSWebDialogResource.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (oMSDialogContent.web == null) {
                            oMSDialogContent.web = OMSWebDialogResource.new_();
                    ...
                    oMSDialogContent.morph = (OMSDialog) nc5Var.m162488l(OMSDialog.PROTOBUF_ADAPTER);
                }
            }
            return oMSDialogContent;
        }
        ...
        public void serialize(OMSDialogContent oMSDialogContent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (oMSWebDialogResource != null) {
                codedOutputByteBufferNano.m17309K(1, oMSWebDialogResource, OMSWebDialogResource.PROTOBUF_ADAPTER);
            }
            OMSDialog oMSDialog = oMSDialogContent.morph;
            if (oMSDialog != null) {
                codedOutputByteBufferNano.m17309K(2, oMSDialog, OMSDialog.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public OMSDialogContent mo225055clone() {
        OMSDialogContent oMSDialogContent = new OMSDialogContent();
        OMSWebDialogResource oMSWebDialogResource = this.web;
        if (oMSWebDialogResource != null) {
            oMSDialogContent.web = oMSWebDialogResource.mo225055clone();
        }
        OMSDialog oMSDialog = this.morph;
        if (oMSDialog != null) {
            oMSDialogContent.morph = oMSDialog.mo225055clone();
        }
        return oMSDialogContent;
    }
