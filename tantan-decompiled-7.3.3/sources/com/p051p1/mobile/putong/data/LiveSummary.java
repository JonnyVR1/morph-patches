...
public class LiveSummary extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveSummary> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveSummary>() { // from class: com.p1.mobile.putong.data.LiveSummary.1
        ...
        public int computeAndCacheSize(LiveSummary liveSummary) {
            ...
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(3, liveSummary.liveOrder) + CodedOutputByteBufferNano.m17283j(4, liveSummary.duration) + CodedOutputByteBufferNano.m17277d(5, liveSummary.rewardPoint) + CodedOutputByteBufferNano.m17277d(6, liveSummary.rewarderCount) + CodedOutputByteBufferNano.m17277d(7, liveSummary.newFollowCount) + CodedOutputByteBufferNano.m17277d(8, liveSummary.audienceCount) + CodedOutputByteBufferNano.m17277d(9, liveSummary.startTime) + CodedOutputByteBufferNano.m17277d(10, liveSummary.endTime);
            String str3 = liveSummary.type;
            if (str3 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(11, str3);
            }
            liveSummary.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveSummary parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        liveSummary.liveId = nc5Var.m162495s();
                        continue;
                    case 18:
                        liveSummary.roomId = nc5Var.m162495s();
                        continue;
                    case 24:
                        liveSummary.liveOrder = nc5Var.m162487k();
                        continue;
                    case 32:
                        liveSummary.duration = nc5Var.m162487k();
                        continue;
                    case 41:
                        liveSummary.rewardPoint = nc5Var.m162484h();
                        continue;
                    case 49:
                        liveSummary.rewarderCount = nc5Var.m162484h();
                        continue;
                    case 57:
                        liveSummary.newFollowCount = nc5Var.m162484h();
                        continue;
                    case 65:
                        liveSummary.audienceCount = nc5Var.m162484h();
                        continue;
                    case EACTags.CARDHOLDER_PUBLIC_KEY_TEMPLATE /* 73 */:
                        liveSummary.startTime = nc5Var.m162484h();
                        continue;
                    case EACTags.FILE_REFERENCE /* 81 */:
                        liveSummary.endTime = nc5Var.m162484h();
                        continue;
                    case 90:
                        liveSummary.type = nc5Var.m162495s();
                        continue;
                    default:
                        if (liveSummary.liveId == null) {
                            liveSummary.liveId = "";
        ...
        public void serialize(LiveSummary liveSummary, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(3, liveSummary.liveOrder);
            codedOutputByteBufferNano.m17307I(4, liveSummary.duration);
            codedOutputByteBufferNano.m17301C(5, liveSummary.rewardPoint);
            codedOutputByteBufferNano.m17301C(6, liveSummary.rewarderCount);
            codedOutputByteBufferNano.m17301C(7, liveSummary.newFollowCount);
            codedOutputByteBufferNano.m17301C(8, liveSummary.audienceCount);
            codedOutputByteBufferNano.m17301C(9, liveSummary.startTime);
            codedOutputByteBufferNano.m17301C(10, liveSummary.endTime);
            String str3 = liveSummary.type;
            if (str3 != null) {
    ...
    public LiveSummary mo225055clone() {
        LiveSummary liveSummary = new LiveSummary();
