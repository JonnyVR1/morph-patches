...
public class FriendComment extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FriendComment> PROTOBUF_ADAPTER = new MessageNanoAdapter<FriendComment>() { // from class: com.p1.mobile.putong.data.FriendComment.1
        ...
        public int computeAndCacheSize(FriendComment friendComment) {
            ...
            int iM17277d = iM17288o + CodedOutputByteBufferNano.m17277d(7, friendComment.createdTime);
            friendComment.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FriendComment parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    friendComment.commentId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    friendComment.headImgUrl = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    friendComment.content = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    friendComment.commentRole = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    friendComment.nickname = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    friendComment.status = nc5Var.m162495s();
                } else {
                    if (iM162497u != 57) {
                        if (friendComment.commentId == null) {
                            friendComment.commentId = "";
                    ...
                    friendComment.createdTime = nc5Var.m162484h();
                }
            }
            return friendComment;
        }
        ...
        public void serialize(FriendComment friendComment, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17301C(7, friendComment.createdTime);
        }
    };
    ...
    public FriendComment mo225055clone() {
        FriendComment friendComment = new FriendComment();
