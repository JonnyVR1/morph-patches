...
public class NKResult implements Parcelable {
    public static final Parcelable.Creator<NKResult> CREATOR = new C4844a();
    ...
    public class C4844a implements Parcelable.Creator<NKResult> {
    ...
    public NKResult(Parcel parcel) {
        ...
        this.res = bArr;
        this.f17876iv = new byte[i];
        parcel.readByteArray(bArr);
        parcel.readByteArray(this.f17876iv);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeByteArray(this.f17876iv);
    }
