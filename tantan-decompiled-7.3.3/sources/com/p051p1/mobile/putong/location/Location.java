...
public class Location implements Parcelable {
    ...
    private static ThreadLocal<C13225c> sBearingDistanceCache = new C13223a();
    public static final Parcelable.Creator<Location> CREATOR = new C13224b();
    ...
    public class C13223a extends ThreadLocal<C13225c> {
        @Override // java.lang.ThreadLocal
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public C13225c initialValue() {
            return new C13225c();
        }
    }

    /* JADX INFO: renamed from: com.p1.mobile.putong.location.Location$b */
    public class C13224b implements Parcelable.Creator<Location> {
    ...
    public static class C13225c {

        /* JADX INFO: renamed from: a */
        public double f54803a;

        /* JADX INFO: renamed from: b */
        public double f54804b;

        /* JADX INFO: renamed from: c */
        public double f54805c;

        /* JADX INFO: renamed from: d */
        public double f54806d;

        /* JADX INFO: renamed from: e */
        public float f54807e;

        /* JADX INFO: renamed from: f */
        public float f54808f;

        /* JADX INFO: renamed from: g */
        public float f54809g;

        public C13225c() {
            this.f54803a = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
            this.f54804b = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
            this.f54805c = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
            this.f54806d = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
            this.f54807e = 0.0f;
            this.f54808f = 0.0f;
            this.f54809g = 0.0f;
        }
    ...
    public static void m79997q(double d, double d2, double d3, double d4, C13225c c13225c) {
        double d5;
        ...
        while (i < 20) {
            ...
            if (Math.abs((d28 - d15) / d28) < 1.0E-12d) {
                d13 = d27;
                d14 = d23;
                c13225c.f54807e = (float) (6356752.3142d * d14 * (dAtan3 - d13));
                double d29 = dCos * d5;
                c13225c.f54808f = (float) (((double) ((float) Math.atan2(dCos2 * dSin3, d29 - ((dSin * dCos2) * dCos3)))) * 57.29577951308232d);
                c13225c.f54809g = (float) (((double) ((float) Math.atan2(dCos * dSin3, ((-dSin) * dCos2) + (d29 * dCos3)))) * 57.29577951308232d);
                c13225c.f54803a = d6;
                c13225c.f54805c = d7;
                c13225c.f54804b = d8;
                c13225c.f54806d = d9;
        ...
        c13225c.f54807e = (float) (6356752.3142d * d14 * (dAtan3 - d13));
        double d210 = dCos * d5;
        c13225c.f54808f = (float) (((double) ((float) Math.atan2(dCos2 * dSin3, d210 - ((dSin * dCos2) * dCos3)))) * 57.29577951308232d);
        c13225c.f54809g = (float) (((double) ((float) Math.atan2(dCos * dSin3, ((-dSin) * dCos2) + (d210 * dCos3)))) * 57.29577951308232d);
        c13225c.f54803a = d6;
        c13225c.f54805c = d7;
        c13225c.f54804b = d8;
        c13225c.f54806d = d9;
    ...
    public void m80007J(float f) {
        this.mHorizontalAccuracyMeters = f;
        this.mFieldsMask |= 8;
    }

    /* JADX INFO: renamed from: K */
    public void m80008K(double d) {
        this.mLatitude = d;
    }

    /* JADX INFO: renamed from: L */
    public void m80009L(int i) {
        this.mLocType = i;
    }

    /* JADX INFO: renamed from: M */
    public void m80010M(double d) {
        this.mLongitude = d;
    }
    ...
    public float m80011r(Location location) {
        C13225c c13225c = sBearingDistanceCache.get();
        if (this.mLatitude != c13225c.f54803a || this.mLongitude != c13225c.f54804b || location.mLatitude != c13225c.f54805c || location.mLongitude != c13225c.f54806d) {
            m79997q(this.mLatitude, this.mLongitude, location.mLatitude, location.mLongitude, c13225c);
        }
        return c13225c.f54807e;
    }

    /* JADX INFO: renamed from: s */
    public float m80012s() {
        return this.mHorizontalAccuracyMeters;
    }

    /* JADX INFO: renamed from: t */
    public double m80013t() {
    ...
    public double m80016x() {
        return this.mLongitude;
    }

    /* JADX INFO: renamed from: y */
    public String m80017y() {
