...
public class BasicInfoComponent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BasicInfoComponent> PROTOBUF_ADAPTER = new MessageNanoAdapter<BasicInfoComponent>() { // from class: com.p1.mobile.putong.feed.data.BasicInfoComponent.1
        ...
        public int computeAndCacheSize(BasicInfoComponent basicInfoComponent) {
            ...
            if (buryingPointParam != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, buryingPointParam, BuryingPointParam.PROTOBUF_ADAPTER);
            }
            String str2 = basicInfoComponent.type;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(3, str2);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(4, basicInfoComponent.priority) + CodedOutputByteBufferNano.m17283j(5, basicInfoComponent.expireTime);
            String str3 = basicInfoComponent.name;
            if (str3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(6, str3);
            }
            basicInfoComponent.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BasicInfoComponent parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    basicInfoComponent.pageId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    basicInfoComponent.param = (BuryingPointParam) nc5Var.m162488l(BuryingPointParam.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    basicInfoComponent.type = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    basicInfoComponent.priority = nc5Var.m162486j();
                } else if (iM162497u == 40) {
                    basicInfoComponent.expireTime = nc5Var.m162487k();
                } else {
                    if (iM162497u != 50) {
                        if (basicInfoComponent.pageId == null) {
                            basicInfoComponent.pageId = "";
                    ...
                    basicInfoComponent.name = nc5Var.m162495s();
                }
            }
            return basicInfoComponent;
        }
        ...
        public void serialize(BasicInfoComponent basicInfoComponent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BuryingPointParam buryingPointParam = basicInfoComponent.param;
            if (buryingPointParam != null) {
                codedOutputByteBufferNano.m17309K(2, buryingPointParam, BuryingPointParam.PROTOBUF_ADAPTER);
            }
            String str2 = basicInfoComponent.type;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(3, str2);
            }
            codedOutputByteBufferNano.m17305G(4, basicInfoComponent.priority);
            codedOutputByteBufferNano.m17307I(5, basicInfoComponent.expireTime);
            String str3 = basicInfoComponent.name;
            if (str3 != null) {
    ...
    public BasicInfoComponent mo225055clone() {
        BasicInfoComponent basicInfoComponent = new BasicInfoComponent();
        basicInfoComponent.pageId = this.pageId;
        BuryingPointParam buryingPointParam = this.param;
        if (buryingPointParam != null) {
            basicInfoComponent.param = buryingPointParam.mo225055clone();
        }
