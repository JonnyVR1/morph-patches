...
public class VoiceLiveStates extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<VoiceLiveStates> PROTOBUF_ADAPTER = new MessageNanoAdapter<VoiceLiveStates>() { // from class: com.p1.mobile.putong.feed.data.VoiceLiveStates.1
        ...
        public int computeAndCacheSize(VoiceLiveStates voiceLiveStates) {
            String str = voiceLiveStates.f40100id;
            ...
            if (textTheme != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, textTheme, TextTheme.PROTOBUF_ADAPTER);
            }
            Emotion emotion = voiceLiveStates.emotion;
            if (emotion != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(7, emotion, Emotion.PROTOBUF_ADAPTER);
            }
            voiceLiveStates.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VoiceLiveStates parse(nc5 nc5Var) throws IOException {
            VoiceLiveStates voiceLiveStates = new VoiceLiveStates();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (voiceLiveStates.f40100id == null) {
                        voiceLiveStates.f40100id = "";
                    }
                ...
                if (iM162497u == 10) {
                    voiceLiveStates.f40100id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    voiceLiveStates.userId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    voiceLiveStates.userAvatars = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 34) {
                    voiceLiveStates.topicId = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    voiceLiveStates.topicName = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    voiceLiveStates.textTheme = (TextTheme) nc5Var.m162488l(TextTheme.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 58) {
                        if (voiceLiveStates.f40100id == null) {
                            voiceLiveStates.f40100id = "";
                    ...
                    voiceLiveStates.emotion = (Emotion) nc5Var.m162488l(Emotion.PROTOBUF_ADAPTER);
                }
            }
            return voiceLiveStates;
        }
        ...
        public void serialize(VoiceLiveStates voiceLiveStates, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            TextTheme textTheme = voiceLiveStates.textTheme;
            if (textTheme != null) {
                codedOutputByteBufferNano.m17309K(6, textTheme, TextTheme.PROTOBUF_ADAPTER);
            }
            Emotion emotion = voiceLiveStates.emotion;
            if (emotion != null) {
                codedOutputByteBufferNano.m17309K(7, emotion, Emotion.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(VoiceLiveStates voiceLiveStates, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userId":
                    ...
                    return true;
                case "id":
                    voiceLiveStates.f40100id = jsonParser.getValueAsString();
                    return false;
                case "topicName":
    ...
    public static /* synthetic */ String m62099a(String str) {
        return str;
    }
    ...
    public VoiceLiveStates mo225055clone() {
        VoiceLiveStates voiceLiveStates = new VoiceLiveStates();
        voiceLiveStates.f40100id = this.f40100id;
        voiceLiveStates.userId = this.userId;
        List<String> list = this.userAvatars;
        if (list != null) {
            voiceLiveStates.userAvatars = ValueObject.util_map(list, new qcj() { // from class: l.g5o0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return VoiceLiveStates.m62099a((String) obj);
                }
            });
        }
        ...
        if (textTheme != null) {
            voiceLiveStates.textTheme = textTheme.mo225055clone();
        }
        Emotion emotion = this.emotion;
        if (emotion != null) {
            voiceLiveStates.emotion = emotion.mo225055clone();
        }
        return voiceLiveStates;
    }
