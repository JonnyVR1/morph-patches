...
public class MyTabPostGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MyTabPostGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<MyTabPostGuide>() { // from class: com.p1.mobile.putong.feed.data.MyTabPostGuide.1
        ...
        public int computeAndCacheSize(MyTabPostGuide myTabPostGuide) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(7, myTabPostGuide.style);
            myTabPostGuide.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MyTabPostGuide parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    myTabPostGuide.title = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    myTabPostGuide.subtitle = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    myTabPostGuide.picture = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    myTabPostGuide.buttonText = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    myTabPostGuide.topicId = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    myTabPostGuide.topicName = nc5Var.m162495s();
                } else {
                    if (iM162497u != 56) {
                        if (myTabPostGuide.title == null) {
                            myTabPostGuide.title = "";
                    ...
                    myTabPostGuide.style = nc5Var.m162486j();
                }
            }
            return myTabPostGuide;
        }
        ...
        public void serialize(MyTabPostGuide myTabPostGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(7, myTabPostGuide.style);
        }
    };
    ...
    public MyTabPostGuide mo225055clone() {
        MyTabPostGuide myTabPostGuide = new MyTabPostGuide();
