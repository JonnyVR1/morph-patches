...
public class ButtonInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ButtonInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<ButtonInfo>() { // from class: com.p1.mobile.putong.feed.data.ButtonInfo.1
        ...
        public int computeAndCacheSize(ButtonInfo buttonInfo) {
            ...
            if (dialogBtnType != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, dialogBtnType, DialogBtnType.PROTOBUF_ADAPTER);
            }
            buttonInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ButtonInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    buttonInfo.content = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    buttonInfo.deepLink = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (buttonInfo.content == null) {
                            buttonInfo.content = "";
                    ...
                    buttonInfo.type = (DialogBtnType) nc5Var.m162488l(DialogBtnType.PROTOBUF_ADAPTER);
                }
            }
            return buttonInfo;
        }
        ...
        public void serialize(ButtonInfo buttonInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            DialogBtnType dialogBtnType = buttonInfo.type;
            if (dialogBtnType != null) {
                codedOutputByteBufferNano.m17309K(3, dialogBtnType, DialogBtnType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ButtonInfo mo225055clone() {
        ButtonInfo buttonInfo = new ButtonInfo();
