...
public class DetectMediaInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DetectMediaInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<DetectMediaInfo>() { // from class: com.p1.mobile.putong.feed.data.DetectMediaInfo.1
        ...
        public int computeAndCacheSize(DetectMediaInfo detectMediaInfo) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, detectMediaInfo.index);
            String str2 = detectMediaInfo.type;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(3, str2);
            }
            detectMediaInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DetectMediaInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    detectMediaInfo.url = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    detectMediaInfo.index = nc5Var.m162486j();
                } else {
                    if (iM162497u != 26) {
                        if (detectMediaInfo.url == null) {
                            detectMediaInfo.url = "";
                    ...
                    detectMediaInfo.type = nc5Var.m162495s();
                }
            }
            return detectMediaInfo;
        }
        ...
        public void serialize(DetectMediaInfo detectMediaInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, detectMediaInfo.index);
            String str2 = detectMediaInfo.type;
            if (str2 != null) {
    ...
    public DetectMediaInfo mo225055clone() {
        DetectMediaInfo detectMediaInfo = new DetectMediaInfo();
