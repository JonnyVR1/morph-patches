...
public class PoiGuidePopWindow extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PoiGuidePopWindow> PROTOBUF_ADAPTER = new MessageNanoAdapter<PoiGuidePopWindow>() { // from class: com.p1.mobile.putong.feed.data.PoiGuidePopWindow.1
        ...
        public int computeAndCacheSize(PoiGuidePopWindow poiGuidePopWindow) {
            String str = poiGuidePopWindow.f40087id;
            ...
            if (poiGuidePopType != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, poiGuidePopType, PoiGuidePopType.PROTOBUF_ADAPTER);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(6, poiGuidePopWindow.swipeLimit) + CodedOutputByteBufferNano.m17275b(7, poiGuidePopWindow.firstTimeShow) + CodedOutputByteBufferNano.m17281h(8, poiGuidePopWindow.intervalHours);
            List<PoiEmotionGuide> list = poiGuidePopWindow.emotionGuides;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(9, list, PoiEmotionGuide.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageLocation messageLocation = poiGuidePopWindow.location;
            if (messageLocation != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(10, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            String str5 = poiGuidePopWindow.desc;
            if (str5 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(11, str5);
            }
            String str6 = poiGuidePopWindow.emotionId;
            if (str6 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(12, str6);
            }
            String str7 = poiGuidePopWindow.userPostType;
            if (str7 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(13, str7);
            }
            poiGuidePopWindow.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PoiGuidePopWindow parse(nc5 nc5Var) throws IOException {
            PoiGuidePopWindow poiGuidePopWindow = new PoiGuidePopWindow();
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        if (poiGuidePopWindow.f40087id == null) {
                            poiGuidePopWindow.f40087id = "";
                        }
                        ...
                        break;
                    case 10:
                        poiGuidePopWindow.f40087id = nc5Var.m162495s();
                        continue;
                    case 18:
                        poiGuidePopWindow.title = nc5Var.m162495s();
                        continue;
                    case 26:
                        poiGuidePopWindow.subTitle = nc5Var.m162495s();
                        continue;
                    case 34:
                        poiGuidePopWindow.icon = nc5Var.m162495s();
                        continue;
                    case 42:
                        poiGuidePopWindow.type = (PoiGuidePopType) nc5Var.m162488l(PoiGuidePopType.PROTOBUF_ADAPTER);
                        continue;
                    case 48:
                        poiGuidePopWindow.swipeLimit = nc5Var.m162486j();
                        continue;
                    case 56:
                        poiGuidePopWindow.firstTimeShow = nc5Var.m162483g();
                        continue;
                    case 64:
                        poiGuidePopWindow.intervalHours = nc5Var.m162486j();
                        continue;
                    case 74:
                        poiGuidePopWindow.emotionGuides = (List) nc5Var.m162488l(PoiEmotionGuide.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        poiGuidePopWindow.location = (MessageLocation) nc5Var.m162488l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        poiGuidePopWindow.desc = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        poiGuidePopWindow.emotionId = nc5Var.m162495s();
                        continue;
                    case 106:
                        poiGuidePopWindow.userPostType = nc5Var.m162495s();
                        continue;
                    default:
                        if (poiGuidePopWindow.f40087id == null) {
                            poiGuidePopWindow.f40087id = "";
        ...
        public void serialize(PoiGuidePopWindow poiGuidePopWindow, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            PoiGuidePopType poiGuidePopType = poiGuidePopWindow.type;
            if (poiGuidePopType != null) {
                codedOutputByteBufferNano.m17309K(5, poiGuidePopType, PoiGuidePopType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(6, poiGuidePopWindow.swipeLimit);
            codedOutputByteBufferNano.m17299A(7, poiGuidePopWindow.firstTimeShow);
            codedOutputByteBufferNano.m17305G(8, poiGuidePopWindow.intervalHours);
            List<PoiEmotionGuide> list = poiGuidePopWindow.emotionGuides;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(9, list, PoiEmotionGuide.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MessageLocation messageLocation = poiGuidePopWindow.location;
            if (messageLocation != null) {
                codedOutputByteBufferNano.m17309K(10, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            String str5 = poiGuidePopWindow.desc;
            if (str5 != null) {
        ...
        public boolean parseField(PoiGuidePopWindow poiGuidePopWindow, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userPostType":
                    ...
                    return true;
                case "id":
                    poiGuidePopWindow.f40087id = jsonParser.getValueAsString();
                    return false;
                case "desc":
    ...
    public PoiGuidePopWindow mo225055clone() {
        PoiGuidePopWindow poiGuidePopWindow = new PoiGuidePopWindow();
        poiGuidePopWindow.f40087id = this.f40087id;
        ...
        if (list != null) {
            poiGuidePopWindow.emotionGuides = ValueObject.util_map(list, new qcj() { // from class: l.di80
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((PoiEmotionGuide) obj).mo225055clone();
                }
            });
        }
        MessageLocation messageLocation = this.location;
        if (messageLocation != null) {
            poiGuidePopWindow.location = messageLocation.mo225055clone();
        }
