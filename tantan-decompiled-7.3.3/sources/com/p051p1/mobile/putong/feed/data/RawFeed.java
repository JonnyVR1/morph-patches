...
public class RawFeed extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RawFeed> PROTOBUF_ADAPTER = new MessageNanoAdapter<RawFeed>() { // from class: com.p1.mobile.putong.feed.data.RawFeed.1
        ...
        public int computeAndCacheSize(RawFeed rawFeed) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(53, rawFeed.canGreeting);
            ...
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(58, rawFeed.showUnreadSplitLine);
            String str7 = rawFeed.relationshipType;
            if (str7 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(59, str7);
            }
            List<BubbleInfo> list = rawFeed.states;
            if (list != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(60, list, BubbleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str8 = rawFeed.recommendReason;
            if (str8 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(61, str8);
            }
            InteractionReason interactionReason = rawFeed.interaction;
            if (interactionReason != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(62, interactionReason, InteractionReason.PROTOBUF_ADAPTER);
            }
            int iM17275b3 = iM17275b2 + CodedOutputByteBufferNano.m17275b(63, rawFeed.isRoamHighlight);
            String str9 = rawFeed.city;
            if (str9 != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17288o(64, str9);
            }
            int iM17275b4 = iM17275b3 + CodedOutputByteBufferNano.m17275b(65, rawFeed.showLikeSplitLine);
            String str10 = rawFeed.recommendReasonIcon;
            if (str10 != null) {
                iM17275b4 += CodedOutputByteBufferNano.m17288o(66, str10);
            }
            String str11 = rawFeed.recommendReasonBackgroundColor;
            if (str11 != null) {
                iM17275b4 += CodedOutputByteBufferNano.m17288o(67, str11);
            }
            String str12 = rawFeed.recommendReasonFontColor;
            if (str12 != null) {
                iM17275b4 += CodedOutputByteBufferNano.m17288o(68, str12);
            }
            List<String> list2 = rawFeed.duplicateImgs;
            if (list2 != null) {
                iM17275b4 += CodedOutputByteBufferNano.m17285l(69, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            MomentExpose momentExpose = rawFeed.momentExpose;
            if (momentExpose != null) {
                iM17275b4 += CodedOutputByteBufferNano.m17285l(70, momentExpose, MomentExpose.PROTOBUF_ADAPTER);
            }
            rawFeed.cachedSize = iM17275b4;
            return iM17275b4;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RawFeed parse(nc5 nc5Var) throws IOException {
            RawFeed rawFeed = new RawFeed();
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        if (rawFeed.f40091id == null) {
                            rawFeed.f40091id = "";
                        }
                        ...
                        break;
                    case 410:
                        rawFeed.f40091id = nc5Var.m162495s();
                        continue;
                    case 418:
                        rawFeed.type = nc5Var.m162495s();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        rawFeed.canGreeting = nc5Var.m162483g();
                        continue;
                    case 434:
                        rawFeed.activityName = nc5Var.m162495s();
                        continue;
                    case 442:
                        rawFeed.locationName = nc5Var.m162495s();
                        continue;
                    case 450:
                        rawFeed.relationshipName = nc5Var.m162495s();
                        continue;
                    case 458:
                        rawFeed.relationshipIconUrl = nc5Var.m162495s();
                        continue;
                    case 464:
                        rawFeed.showUnreadSplitLine = nc5Var.m162483g();
                        continue;
                    case 474:
                        rawFeed.relationshipType = nc5Var.m162495s();
                        continue;
                    case 482:
                        rawFeed.states = (List) nc5Var.m162488l(BubbleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 490:
                        rawFeed.recommendReason = nc5Var.m162495s();
                        continue;
                    case 498:
                        rawFeed.interaction = (InteractionReason) nc5Var.m162488l(InteractionReason.PROTOBUF_ADAPTER);
                        continue;
                    case HttpStatus.GATEWAY_TIMEOUT_504 /* 504 */:
                        rawFeed.isRoamHighlight = nc5Var.m162483g();
                        continue;
                    case 514:
                        rawFeed.city = nc5Var.m162495s();
                        continue;
                    case 520:
                        rawFeed.showLikeSplitLine = nc5Var.m162483g();
                        continue;
                    case 530:
                        rawFeed.recommendReasonIcon = nc5Var.m162495s();
                        continue;
                    case 538:
                        rawFeed.recommendReasonBackgroundColor = nc5Var.m162495s();
                        continue;
                    case 546:
                        rawFeed.recommendReasonFontColor = nc5Var.m162495s();
                        continue;
                    case 554:
                        rawFeed.duplicateImgs = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 562:
                        rawFeed.momentExpose = (MomentExpose) nc5Var.m162488l(MomentExpose.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (rawFeed.f40091id == null) {
                            rawFeed.f40091id = "";
        ...
        public void serialize(RawFeed rawFeed, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(53, rawFeed.canGreeting);
            String str3 = rawFeed.activityName;
            if (str3 != null) {
            ...
            codedOutputByteBufferNano.m17299A(58, rawFeed.showUnreadSplitLine);
            String str7 = rawFeed.relationshipType;
            if (str7 != null) {
                codedOutputByteBufferNano.m17316R(59, str7);
            }
            List<BubbleInfo> list = rawFeed.states;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(60, list, BubbleInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str8 = rawFeed.recommendReason;
            if (str8 != null) {
                codedOutputByteBufferNano.m17316R(61, str8);
            }
            InteractionReason interactionReason = rawFeed.interaction;
            if (interactionReason != null) {
                codedOutputByteBufferNano.m17309K(62, interactionReason, InteractionReason.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(63, rawFeed.isRoamHighlight);
            String str9 = rawFeed.city;
            if (str9 != null) {
                codedOutputByteBufferNano.m17316R(64, str9);
            }
            codedOutputByteBufferNano.m17299A(65, rawFeed.showLikeSplitLine);
            String str10 = rawFeed.recommendReasonIcon;
            if (str10 != null) {
                codedOutputByteBufferNano.m17316R(66, str10);
            }
            String str11 = rawFeed.recommendReasonBackgroundColor;
            if (str11 != null) {
                codedOutputByteBufferNano.m17316R(67, str11);
            }
            String str12 = rawFeed.recommendReasonFontColor;
            if (str12 != null) {
                codedOutputByteBufferNano.m17316R(68, str12);
            }
            List<String> list2 = rawFeed.duplicateImgs;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(69, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            MomentExpose momentExpose = rawFeed.momentExpose;
            if (momentExpose != null) {
                codedOutputByteBufferNano.m17309K(70, momentExpose, MomentExpose.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(RawFeed rawFeed, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 12:
                    ...
                    return true;
                case 13:
                    rawFeed.f40091id = jsonParser.getValueAsString();
                    return false;
                case 14:
    ...
    public static /* synthetic */ String m62076a(String str) {
        return str;
    }
    ...
    public RawFeed mo225055clone() {
        RawFeed rawFeed = new RawFeed();
        rawFeed.f40091id = this.f40091id;
        ...
        if (momentFeedsExtra != null) {
            rawFeed.extra = momentFeedsExtra.mo225055clone();
        }
        ...
        if (list != null) {
            rawFeed.states = ValueObject.util_map(list, new qcj() { // from class: l.llc0
                @Override // p153l.qcj
        ...
        if (interactionReason != null) {
            rawFeed.interaction = interactionReason.mo225055clone();
        }
        ...
        if (list2 != null) {
            rawFeed.duplicateImgs = ValueObject.util_map(list2, new qcj() { // from class: l.mlc0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return RawFeed.m62076a((String) obj);
                }
            });
        }
        MomentExpose momentExpose = this.momentExpose;
        if (momentExpose != null) {
            rawFeed.momentExpose = momentExpose.mo225055clone();
        }
        return rawFeed;
    }
    ...
    public RawFeed subtract(RawFeed rawFeed) {
        ...
        if (!ValueObject.util_equals(this.f40091id, rawFeed.f40091id)) {
            rawFeed2.f40091id = this.f40091id;
        }
