...
public class MomentBoostVouchers extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentBoostVouchers> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentBoostVouchers>() { // from class: com.p1.mobile.putong.feed.data.MomentBoostVouchers.1
        ...
        public int computeAndCacheSize(MomentBoostVouchers momentBoostVouchers) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, momentBoostVouchers.IOSCoins) + CodedOutputByteBufferNano.m17281h(2, momentBoostVouchers.androidCoins);
            SvipValues svipValues = momentBoostVouchers.values;
            if (svipValues != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(3, svipValues, SvipValues.PROTOBUF_ADAPTER);
            }
            momentBoostVouchers.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentBoostVouchers parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    momentBoostVouchers.IOSCoins = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    momentBoostVouchers.androidCoins = nc5Var.m162486j();
                } else {
                    if (iM162497u != 26) {
                        if (momentBoostVouchers.values != null) {
                            break;
                    ...
                    momentBoostVouchers.values = (SvipValues) nc5Var.m162488l(SvipValues.PROTOBUF_ADAPTER);
                }
            }
            return momentBoostVouchers;
        }
        ...
        public void serialize(MomentBoostVouchers momentBoostVouchers, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, momentBoostVouchers.IOSCoins);
            codedOutputByteBufferNano.m17305G(2, momentBoostVouchers.androidCoins);
            SvipValues svipValues = momentBoostVouchers.values;
            if (svipValues != null) {
                codedOutputByteBufferNano.m17309K(3, svipValues, SvipValues.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public MomentBoostVouchers mo225055clone() {
        MomentBoostVouchers momentBoostVouchers = new MomentBoostVouchers();
        ...
        if (svipValues != null) {
            momentBoostVouchers.values = svipValues.mo225055clone();
        }
        return momentBoostVouchers;
    }
