...
public class MomentActivity extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentActivity> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentActivity>() { // from class: com.p1.mobile.putong.feed.data.MomentActivity.1
        ...
        public int computeAndCacheSize(MomentActivity momentActivity) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, momentActivity._id);
            String str = momentActivity.f56859id;
            if (str != null) {
            ...
            if (activityActionApi != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(54, activityActionApi.ordinal());
            }
            int iM17275b = iM17283j + CodedOutputByteBufferNano.m17275b(55, momentActivity.read);
            MomentIdBoxed momentIdBoxed = momentActivity.reference;
            if (momentIdBoxed != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(56, momentIdBoxed, MomentIdBoxed.PROTOBUF_ADAPTER);
            }
            int iM17277d = iM17275b + CodedOutputByteBufferNano.m17277d(57, momentActivity.createdTime);
            String str5 = momentActivity.messageid;
            if (str5 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(58, str5);
            }
            ActivitySetting activitySetting = momentActivity.settings;
            if (activitySetting != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(59, activitySetting, ActivitySetting.PROTOBUF_ADAPTER);
            }
            int iM17275b2 = iM17277d + CodedOutputByteBufferNano.m17275b(60, momentActivity.acceptGift);
            ActivityActionApi activityActionApi2 = momentActivity.action;
            if (activityActionApi2 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(61, activityActionApi2, ActivityActionApi.PROTOBUF_ADAPTER);
            }
            String str6 = momentActivity.parentMessageid;
            if (str6 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(62, str6);
            }
            String str7 = momentActivity.replyMessageId;
            if (str7 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(63, str7);
            }
            List<String> list = momentActivity.userIds;
            if (list != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(64, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17281h = iM17275b2 + CodedOutputByteBufferNano.m17281h(65, momentActivity.count);
            momentActivity.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentActivity parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        momentActivity._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        momentActivity.f56859id = nc5Var.m162495s();
                        continue;
                    case 410:
                        momentActivity.value = nc5Var.m162495s();
                        continue;
                    case 418:
                        momentActivity.owner = nc5Var.m162495s();
                        continue;
                    case 426:
                        momentActivity.actors = nc5Var.m162495s();
                        continue;
                    case 432:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 440:
                        momentActivity.read = nc5Var.m162483g();
                        continue;
                    case 450:
                        momentActivity.reference = (MomentIdBoxed) nc5Var.m162488l(MomentIdBoxed.PROTOBUF_ADAPTER);
                        continue;
                    case 457:
                        momentActivity.createdTime = nc5Var.m162484h();
                        continue;
                    case 466:
                        momentActivity.messageid = nc5Var.m162495s();
                        continue;
                    case 474:
                        momentActivity.settings = (ActivitySetting) nc5Var.m162488l(ActivitySetting.PROTOBUF_ADAPTER);
                        continue;
                    case 480:
                        momentActivity.acceptGift = nc5Var.m162483g();
                        continue;
                    case 490:
                        momentActivity.action = (ActivityActionApi) nc5Var.m162488l(ActivityActionApi.PROTOBUF_ADAPTER);
                        continue;
                    case 498:
                        momentActivity.parentMessageid = nc5Var.m162495s();
                        continue;
                    case 506:
                        momentActivity.replyMessageId = nc5Var.m162495s();
                        continue;
                    case 514:
                        momentActivity.userIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 520:
                        momentActivity.count = nc5Var.m162486j();
                        continue;
                    default:
                        if (momentActivity.action == null && numValueOf != null) {
                            momentActivity.action = (ActivityActionApi) ActivityActionApi.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(MomentActivity momentActivity, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, momentActivity._id);
            String str = momentActivity.f56859id;
            if (str != null) {
            ...
            ActivityActionApi activityActionApi = momentActivity.action;
            if (activityActionApi != null) {
                codedOutputByteBufferNano.m17305G(54, activityActionApi.ordinal());
            }
            codedOutputByteBufferNano.m17299A(55, momentActivity.read);
            MomentIdBoxed momentIdBoxed = momentActivity.reference;
            if (momentIdBoxed != null) {
                codedOutputByteBufferNano.m17309K(56, momentIdBoxed, MomentIdBoxed.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17301C(57, momentActivity.createdTime);
            String str5 = momentActivity.messageid;
            if (str5 != null) {
                codedOutputByteBufferNano.m17316R(58, str5);
            }
            ActivitySetting activitySetting = momentActivity.settings;
            if (activitySetting != null) {
                codedOutputByteBufferNano.m17309K(59, activitySetting, ActivitySetting.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(60, momentActivity.acceptGift);
            ActivityActionApi activityActionApi2 = momentActivity.action;
            if (activityActionApi2 != null) {
                codedOutputByteBufferNano.m17309K(61, activityActionApi2, ActivityActionApi.PROTOBUF_ADAPTER);
            }
            String str6 = momentActivity.parentMessageid;
            if (str6 != null) {
            ...
            List<String> list = momentActivity.userIds;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(64, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(65, momentActivity.count);
        }
    };
        ...
        public boolean parseField(MomentActivity momentActivity, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    momentActivity.f56859id = jsonParser.getValueAsString();
                    return false;
                case 9:
    ...
    public static final StringColumn<MomentActivity> f40079ID = new StringColumn<MomentActivity>("id_c") { // from class: com.p1.mobile.putong.feed.data.MomentActivity.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(MomentActivity momentActivity) {
            return momentActivity.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(MomentActivity momentActivity, String str) {
            momentActivity.f56859id = str;
        }
    };
    ...
    public static final StringColumn<MomentActivity> REFERENCE_ID = new StringColumn<MomentActivity>("reference_id_c") { // from class: com.p1.mobile.putong.feed.data.MomentActivity.10
        @Override // com.tantanapp.common.data.orm.Column
        public String get(MomentActivity momentActivity) {
            return momentActivity.reference.f40080id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(MomentActivity momentActivity, String str) {
            momentActivity.reference.f40080id = str;
        }
    };
    ...
    public static vzf0<MomentActivity> DB_ADAPTER = new vzf0<MomentActivity>() { // from class: com.p1.mobile.putong.feed.data.MomentActivity.20
        ...
        public MomentActivity read(Cursor cursor, int i) {
            ...
            try {
                ...
                momentActivity.f56859id = cursor.isNull(i3) ? null : cursor.getString(i3);
                int i4 = i + 2;
                ...
                int i8 = i + 7;
                momentActivity.reference.f40080id = cursor.isNull(i8) ? null : cursor.getString(i8);
                int i9 = i + 8;
        ...
        public void write(MomentActivity momentActivity, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", momentActivity.f56859id);
                ...
                DbObject.cvPut(contentValues, "reference_id_c", momentActivity.reference.f40080id);
    ...
    public static /* synthetic */ String m62048a(String str) {
        return str;
    }
    ...
    public MomentActivity mo225055clone() {
        MomentActivity momentActivity = new MomentActivity();
        momentActivity._id = this._id;
        momentActivity.f56859id = this.f56859id;
        ...
        if (momentIdBoxed != null) {
            momentActivity.reference = momentIdBoxed.mo225055clone();
        }
        ...
        if (activitySetting != null) {
            momentActivity.settings = activitySetting.mo225055clone();
        }
        ...
        if (list != null) {
            momentActivity.userIds = ValueObject.util_map(list, new qcj() { // from class: l.jh00
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return MomentActivity.m62048a((String) obj);
                }
            });
        }
