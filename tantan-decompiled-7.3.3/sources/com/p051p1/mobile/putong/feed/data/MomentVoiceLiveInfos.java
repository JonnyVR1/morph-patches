...
public class MomentVoiceLiveInfos extends DbObject<MomentVoiceLiveInfos> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MomentVoiceLiveInfos> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentVoiceLiveInfos>() { // from class: com.p1.mobile.putong.feed.data.MomentVoiceLiveInfos.1
        ...
        public int computeAndCacheSize(MomentVoiceLiveInfos momentVoiceLiveInfos) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, momentVoiceLiveInfos._id);
            String str = momentVoiceLiveInfos.f56859id;
            if (str != null) {
            ...
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(55, momentVoiceLiveInfos.memberCount);
            LiveType liveType = momentVoiceLiveInfos.state;
            if (liveType != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(56, liveType, LiveType.PROTOBUF_ADAPTER);
            }
            String str6 = momentVoiceLiveInfos.title;
            if (str6 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(57, str6);
            }
            String str7 = momentVoiceLiveInfos.topicID;
            if (str7 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(58, str7);
            }
            List<MemberUsers> list = momentVoiceLiveInfos.memberUsers;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(59, list, MemberUsers.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(60, momentVoiceLiveInfos.audienceCount);
            String str8 = momentVoiceLiveInfos.topicName;
            if (str8 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(61, str8);
            }
            MomentVoiceUser momentVoiceUser = momentVoiceLiveInfos.momentVoiceUser;
            if (momentVoiceUser != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(62, momentVoiceUser, MomentVoiceUser.PROTOBUF_ADAPTER);
            }
            momentVoiceLiveInfos.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentVoiceLiveInfos parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        momentVoiceLiveInfos._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        momentVoiceLiveInfos.f56859id = nc5Var.m162495s();
                        continue;
                    case 410:
                        momentVoiceLiveInfos.anchorUserID = nc5Var.m162495s();
                        continue;
                    case 418:
                        momentVoiceLiveInfos.liveID = nc5Var.m162495s();
                        continue;
                    case 426:
                        momentVoiceLiveInfos.roomID = nc5Var.m162495s();
                        continue;
                    case 434:
                        momentVoiceLiveInfos.schemaSearch = nc5Var.m162495s();
                        continue;
                    case 440:
                        momentVoiceLiveInfos.memberCount = nc5Var.m162486j();
                        continue;
                    case 450:
                        momentVoiceLiveInfos.state = (LiveType) nc5Var.m162488l(LiveType.PROTOBUF_ADAPTER);
                        continue;
                    case 458:
                        momentVoiceLiveInfos.title = nc5Var.m162495s();
                        continue;
                    case 466:
                        momentVoiceLiveInfos.topicID = nc5Var.m162495s();
                        continue;
                    case 474:
                        momentVoiceLiveInfos.memberUsers = (List) nc5Var.m162488l(MemberUsers.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 480:
                        momentVoiceLiveInfos.audienceCount = nc5Var.m162486j();
                        continue;
                    case 490:
                        momentVoiceLiveInfos.topicName = nc5Var.m162495s();
                        continue;
                    case 498:
                        momentVoiceLiveInfos.momentVoiceUser = (MomentVoiceUser) nc5Var.m162488l(MomentVoiceUser.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (momentVoiceLiveInfos.anchorUserID == null) {
                            momentVoiceLiveInfos.anchorUserID = "";
        ...
        public void serialize(MomentVoiceLiveInfos momentVoiceLiveInfos, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, momentVoiceLiveInfos._id);
            String str = momentVoiceLiveInfos.f56859id;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17305G(55, momentVoiceLiveInfos.memberCount);
            LiveType liveType = momentVoiceLiveInfos.state;
            if (liveType != null) {
                codedOutputByteBufferNano.m17309K(56, liveType, LiveType.PROTOBUF_ADAPTER);
            }
            String str6 = momentVoiceLiveInfos.title;
            if (str6 != null) {
            ...
            List<MemberUsers> list = momentVoiceLiveInfos.memberUsers;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(59, list, MemberUsers.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(60, momentVoiceLiveInfos.audienceCount);
            String str8 = momentVoiceLiveInfos.topicName;
            if (str8 != null) {
            ...
            MomentVoiceUser momentVoiceUser = momentVoiceLiveInfos.momentVoiceUser;
            if (momentVoiceUser != null) {
                codedOutputByteBufferNano.m17309K(62, momentVoiceUser, MomentVoiceUser.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(MomentVoiceLiveInfos momentVoiceLiveInfos, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "anchorUserID":
                    ...
                    return true;
                case "id":
                    momentVoiceLiveInfos.f56859id = jsonParser.getValueAsString();
                    return false;
                case "state":
    ...
    public MomentVoiceLiveInfos mo225055clone() {
        MomentVoiceLiveInfos momentVoiceLiveInfos = new MomentVoiceLiveInfos();
        momentVoiceLiveInfos._id = this._id;
        momentVoiceLiveInfos.f56859id = this.f56859id;
        ...
        if (list != null) {
            momentVoiceLiveInfos.memberUsers = ValueObject.util_map(list, new qcj() { // from class: l.vu00
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((MemberUsers) obj).mo225055clone();
                }
            });
        }
        ...
        if (momentVoiceUser != null) {
            momentVoiceLiveInfos.momentVoiceUser = momentVoiceUser.mo225055clone();
        }
        return momentVoiceLiveInfos;
    }
