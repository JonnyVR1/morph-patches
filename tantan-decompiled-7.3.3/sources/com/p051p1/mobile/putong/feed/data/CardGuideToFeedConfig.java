...
public class CardGuideToFeedConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CardGuideToFeedConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<CardGuideToFeedConfig>() { // from class: com.p1.mobile.putong.feed.data.CardGuideToFeedConfig.1
        ...
        public int computeAndCacheSize(CardGuideToFeedConfig cardGuideToFeedConfig) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, cardGuideToFeedConfig.disLikeNewUserLimite) + CodedOutputByteBufferNano.m17281h(2, cardGuideToFeedConfig.misMatchNewUserLimite) + CodedOutputByteBufferNano.m17281h(3, cardGuideToFeedConfig.disLikeSwipeCountLimite) + CodedOutputByteBufferNano.m17281h(4, cardGuideToFeedConfig.misMatchSwipeCountLimite);
            ...
            if (str7 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(11, str7);
            }
            String str8 = cardGuideToFeedConfig.misMatchNoFollowTypeTipsMale;
            if (str8 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(12, str8);
            }
            ...
            cardGuideToFeedConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CardGuideToFeedConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        cardGuideToFeedConfig.disLikeNewUserLimite = nc5Var.m162486j();
                        continue;
                    case 16:
                        cardGuideToFeedConfig.misMatchNewUserLimite = nc5Var.m162486j();
                        continue;
                    case 24:
                        cardGuideToFeedConfig.disLikeSwipeCountLimite = nc5Var.m162486j();
                        continue;
                    case 32:
                        cardGuideToFeedConfig.misMatchSwipeCountLimite = nc5Var.m162486j();
                        continue;
                    case 42:
                        cardGuideToFeedConfig.disLikeFollowTypeTipsFemal = nc5Var.m162495s();
                        continue;
                    case 50:
                        cardGuideToFeedConfig.misMatchFollowTypeTipsFemal = nc5Var.m162495s();
                        continue;
                    case 58:
                        cardGuideToFeedConfig.disLikeFollowTypeTipsMale = nc5Var.m162495s();
                        continue;
                    case 66:
                        cardGuideToFeedConfig.misMatchFollowTypeTipsMale = nc5Var.m162495s();
                        continue;
                    case 74:
                        cardGuideToFeedConfig.disLikeNoFollowTypeTipsFemal = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        cardGuideToFeedConfig.misMatchNoFollowTypeTipsFemal = nc5Var.m162495s();
                        continue;
                    case 90:
                        cardGuideToFeedConfig.disLikeNoFollowTypeTipsMale = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        cardGuideToFeedConfig.misMatchNoFollowTypeTipsMale = nc5Var.m162495s();
                        continue;
                    case 106:
                        cardGuideToFeedConfig.disLikeLikeTypeTipsFemal = nc5Var.m162495s();
                        continue;
                    case 114:
                        cardGuideToFeedConfig.misMatchLikeTypeTipsFemal = nc5Var.m162495s();
                        continue;
                    case 122:
                        cardGuideToFeedConfig.disLikeLikeTypeTipsMale = nc5Var.m162495s();
                        continue;
                    case 130:
                        cardGuideToFeedConfig.misMatchLikeTypeTipsMale = nc5Var.m162495s();
                        continue;
                    default:
                        if (cardGuideToFeedConfig.disLikeFollowTypeTipsFemal == null) {
                            cardGuideToFeedConfig.disLikeFollowTypeTipsFemal = "";
        ...
        public void serialize(CardGuideToFeedConfig cardGuideToFeedConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, cardGuideToFeedConfig.disLikeNewUserLimite);
            codedOutputByteBufferNano.m17305G(2, cardGuideToFeedConfig.misMatchNewUserLimite);
            codedOutputByteBufferNano.m17305G(3, cardGuideToFeedConfig.disLikeSwipeCountLimite);
            codedOutputByteBufferNano.m17305G(4, cardGuideToFeedConfig.misMatchSwipeCountLimite);
            String str = cardGuideToFeedConfig.disLikeFollowTypeTipsFemal;
            if (str != null) {
    ...
    public CardGuideToFeedConfig mo225055clone() {
        CardGuideToFeedConfig cardGuideToFeedConfig = new CardGuideToFeedConfig();
