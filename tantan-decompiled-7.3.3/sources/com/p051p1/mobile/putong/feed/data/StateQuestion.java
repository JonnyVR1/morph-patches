...
public class StateQuestion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StateQuestion> PROTOBUF_ADAPTER = new MessageNanoAdapter<StateQuestion>() { // from class: com.p1.mobile.putong.feed.data.StateQuestion.1
        ...
        public int computeAndCacheSize(StateQuestion stateQuestion) {
            ...
            String str2 = stateQuestion.f40093id;
            if (str2 != null) {
        ...
        public StateQuestion parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 0) {
                    ...
                    if (stateQuestion.f40093id != null) {
                        break;
                    }
                    stateQuestion.f40093id = "";
                    break;
                }
                if (iM162497u == 10) {
                    ...
                    stateQuestion.f40093id = nc5Var.m162495s();
                }
            }
            return stateQuestion;
        }
        ...
        public boolean parseField(StateQuestion stateQuestion, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "stateOptions":
                    ...
                    return true;
                case "id":
                    stateQuestion.f40093id = jsonParser.getValueAsString();
                    return false;
                default:
                    return false;
            }
    ...
    public StateQuestion mo225055clone() {
        ...
        if (list != null) {
            stateQuestion.stateOptions = ValueObject.util_map(list, new qcj() { // from class: l.t3g0
                @Override // p153l.qcj
        ...
        stateQuestion.f40093id = this.f40093id;
        return stateQuestion;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.question, stateQuestion.question) && ValueObject.util_equals(this.stateOptions, stateQuestion.stateOptions) && ValueObject.util_equals(this.f40093id, stateQuestion.f40093id);
    }
