...
import com.p051p1.mobile.putong.data.DyMomentSource;
...
import com.p051p1.mobile.putong.data.MomentLabels;
...
public class Moment extends DbObject<Moment> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Moment> PROTOBUF_ADAPTER = new MessageNanoAdapter<Moment>() { // from class: com.p1.mobile.putong.feed.data.Moment.1
        ...
        public int computeAndCacheSize(Moment moment) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, moment._id);
            String str = moment.f56859id;
            if (str != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(2, str);
            }
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(51, moment.localCreatedSession) + CodedOutputByteBufferNano.m17275b(52, moment.localInFeed) + CodedOutputByteBufferNano.m17275b(53, moment.localInUserFeed);
            String str2 = moment.value;
            if (str2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(54, str2);
            }
            int iM17277d = iM17281h + CodedOutputByteBufferNano.m17277d(55, moment.createdTime);
            String str3 = moment.owner;
            if (str3 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(56, str3);
            }
            PartialIdList partialIdList = moment.likes;
            if (partialIdList != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(57, partialIdList, PartialIdList.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17277d + CodedOutputByteBufferNano.m17275b(58, moment.haveLiked);
            MessageLocation messageLocation = moment.location;
            if (messageLocation != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(59, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            List<Media> list = moment.media;
            if (list != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(60, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = moment.landingPage;
            if (str4 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(61, str4);
            }
            PartialIdList partialIdList2 = moment.messages;
            if (partialIdList2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(62, partialIdList2, PartialIdList.PROTOBUF_ADAPTER);
            }
            MomentSettings momentSettings = moment.settings;
            if (momentSettings != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(63, momentSettings, MomentSettings.PROTOBUF_ADAPTER);
            }
            DyMomentSource dyMomentSource = moment.dynamicType;
            if (dyMomentSource != null) {
                iM17275b += CodedOutputByteBufferNano.m17281h(64, dyMomentSource.ordinal());
            }
            String str5 = moment.musicId;
            if (str5 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(65, str5);
            }
            String str6 = moment.status;
            if (str6 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(66, str6);
            }
            MomentType momentType = moment.momentType;
            if (momentType != null) {
                iM17275b += CodedOutputByteBufferNano.m17281h(67, momentType.ordinal());
            }
            List<TopicMomentIdBox> list2 = moment.topics;
            if (list2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(68, list2, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = moment.hyperlink;
            if (str7 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(69, str7);
            }
            DyMomentSource dyMomentSource2 = moment.dynamicType;
            if (dyMomentSource2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(70, dyMomentSource2, DyMomentSource.PROTOBUF_ADAPTER);
            }
            MomentType momentType2 = moment.momentType;
            if (momentType2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(71, momentType2, MomentType.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility = moment.userSetVisibility;
            if (userSetVisibility != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(72, userSetVisibility, UserSetVisibility.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility2 = moment.userSetVisibility;
            if (userSetVisibility2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17281h(73, userSetVisibility2.ordinal());
            }
            MomentSimpleActivity momentSimpleActivity = moment.simpleActivity;
            if (momentSimpleActivity != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(74, momentSimpleActivity, MomentSimpleActivity.PROTOBUF_ADAPTER);
            }
            MomentAdditionalData momentAdditionalData = moment.additionalData;
            if (momentAdditionalData != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(75, momentAdditionalData, MomentAdditionalData.PROTOBUF_ADAPTER);
            }
            GroupIdBox groupIdBox = moment.group;
            if (groupIdBox != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(76, groupIdBox, GroupIdBox.PROTOBUF_ADAPTER);
            }
            String str8 = moment.deeplink;
            if (str8 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(77, str8);
            }
            ThirdShareSource thirdShareSource = moment.thirdShareSource;
            if (thirdShareSource != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(78, thirdShareSource, ThirdShareSource.PROTOBUF_ADAPTER);
            }
            int iM17281h2 = iM17275b + CodedOutputByteBufferNano.m17281h(79, moment.attitudeId);
            Attitudes attitudes = moment.attitudes;
            if (attitudes != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(80, attitudes, Attitudes.PROTOBUF_ADAPTER);
            }
            int iM17275b2 = iM17281h2 + CodedOutputByteBufferNano.m17275b(81, moment.shareMyVote);
            MomentAllowForwardState momentAllowForwardState = moment.allowForward;
            if (momentAllowForwardState != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(82, momentAllowForwardState, MomentAllowForwardState.PROTOBUF_ADAPTER);
            }
            MomentForwards momentForwards = moment.forwards;
            if (momentForwards != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(83, momentForwards, MomentForwards.PROTOBUF_ADAPTER);
            }
            int iM17275b3 = iM17275b2 + CodedOutputByteBufferNano.m17275b(84, moment.isNewUserAIMoment);
            moment.cachedSize = iM17275b3;
            return iM17275b3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Moment parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        moment._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        moment.f56859id = nc5Var.m162495s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        moment.localCreatedSession = nc5Var.m162486j();
                        continue;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        moment.localInFeed = nc5Var.m162483g();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        moment.localInUserFeed = nc5Var.m162483g();
                        continue;
                    case 434:
                        moment.value = nc5Var.m162495s();
                        continue;
                    case 441:
                        moment.createdTime = nc5Var.m162484h();
                        continue;
                    case 450:
                        moment.owner = nc5Var.m162495s();
                        continue;
                    case 458:
                        moment.likes = (PartialIdList) nc5Var.m162488l(PartialIdList.PROTOBUF_ADAPTER);
                        continue;
                    case 464:
                        moment.haveLiked = nc5Var.m162483g();
                        continue;
                    case 474:
                        moment.location = (MessageLocation) nc5Var.m162488l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 482:
                        moment.media = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 490:
                        moment.landingPage = nc5Var.m162495s();
                        continue;
                    case 498:
                        moment.messages = (PartialIdList) nc5Var.m162488l(PartialIdList.PROTOBUF_ADAPTER);
                        continue;
                    case 506:
                        moment.settings = (MomentSettings) nc5Var.m162488l(MomentSettings.PROTOBUF_ADAPTER);
                        continue;
                    case 512:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 522:
                        moment.musicId = nc5Var.m162495s();
                        continue;
                    case 530:
                        moment.status = nc5Var.m162495s();
                        continue;
                    case 536:
                        numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 546:
                        moment.topics = (List) nc5Var.m162488l(TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 554:
                        moment.hyperlink = nc5Var.m162495s();
                        continue;
                    case 562:
                        moment.dynamicType = (DyMomentSource) nc5Var.m162488l(DyMomentSource.PROTOBUF_ADAPTER);
                        continue;
                    case 570:
                        moment.momentType = (MomentType) nc5Var.m162488l(MomentType.PROTOBUF_ADAPTER);
                        continue;
                    case IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED_BASELINE /* 578 */:
                        moment.userSetVisibility = (UserSetVisibility) nc5Var.m162488l(UserSetVisibility.PROTOBUF_ADAPTER);
                        continue;
                    case 584:
                        numValueOf3 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 594:
                        moment.simpleActivity = (MomentSimpleActivity) nc5Var.m162488l(MomentSimpleActivity.PROTOBUF_ADAPTER);
                        continue;
                    case 602:
                        moment.additionalData = (MomentAdditionalData) nc5Var.m162488l(MomentAdditionalData.PROTOBUF_ADAPTER);
                        continue;
                    case 610:
                        moment.group = (GroupIdBox) nc5Var.m162488l(GroupIdBox.PROTOBUF_ADAPTER);
                        continue;
                    case 618:
                        moment.deeplink = nc5Var.m162495s();
                        continue;
                    case 626:
                        moment.thirdShareSource = (ThirdShareSource) nc5Var.m162488l(ThirdShareSource.PROTOBUF_ADAPTER);
                        continue;
                    case 632:
                        moment.attitudeId = nc5Var.m162486j();
                        continue;
                    case 642:
                        moment.attitudes = (Attitudes) nc5Var.m162488l(Attitudes.PROTOBUF_ADAPTER);
                        continue;
                    case 648:
                        moment.shareMyVote = nc5Var.m162483g();
                        continue;
                    case 658:
                        moment.allowForward = (MomentAllowForwardState) nc5Var.m162488l(MomentAllowForwardState.PROTOBUF_ADAPTER);
                        continue;
                    case 666:
                        moment.forwards = (MomentForwards) nc5Var.m162488l(MomentForwards.PROTOBUF_ADAPTER);
                        continue;
                    case 672:
                        moment.isNewUserAIMoment = nc5Var.m162483g();
                        continue;
                    default:
                        if (moment.dynamicType == null && numValueOf != null) {
                            moment.dynamicType = (DyMomentSource) DyMomentSource.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Moment moment, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, moment._id);
            String str = moment.f56859id;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(2, str);
            }
            codedOutputByteBufferNano.m17305G(51, moment.localCreatedSession);
            codedOutputByteBufferNano.m17299A(52, moment.localInFeed);
            codedOutputByteBufferNano.m17299A(53, moment.localInUserFeed);
            String str2 = moment.value;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(54, str2);
            }
            codedOutputByteBufferNano.m17301C(55, moment.createdTime);
            String str3 = moment.owner;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(56, str3);
            }
            PartialIdList partialIdList = moment.likes;
            if (partialIdList != null) {
                codedOutputByteBufferNano.m17309K(57, partialIdList, PartialIdList.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(58, moment.haveLiked);
            MessageLocation messageLocation = moment.location;
            if (messageLocation != null) {
                codedOutputByteBufferNano.m17309K(59, messageLocation, MessageLocation.PROTOBUF_ADAPTER);
            }
            List<Media> list = moment.media;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(60, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = moment.landingPage;
            if (str4 != null) {
                codedOutputByteBufferNano.m17316R(61, str4);
            }
            PartialIdList partialIdList2 = moment.messages;
            if (partialIdList2 != null) {
                codedOutputByteBufferNano.m17309K(62, partialIdList2, PartialIdList.PROTOBUF_ADAPTER);
            }
            MomentSettings momentSettings = moment.settings;
            if (momentSettings != null) {
                codedOutputByteBufferNano.m17309K(63, momentSettings, MomentSettings.PROTOBUF_ADAPTER);
            }
            DyMomentSource dyMomentSource = moment.dynamicType;
            if (dyMomentSource != null) {
                codedOutputByteBufferNano.m17305G(64, dyMomentSource.ordinal());
            }
            String str5 = moment.musicId;
            if (str5 != null) {
                codedOutputByteBufferNano.m17316R(65, str5);
            }
            String str6 = moment.status;
            if (str6 != null) {
                codedOutputByteBufferNano.m17316R(66, str6);
            }
            MomentType momentType = moment.momentType;
            if (momentType != null) {
                codedOutputByteBufferNano.m17305G(67, momentType.ordinal());
            }
            List<TopicMomentIdBox> list2 = moment.topics;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(68, list2, TopicMomentIdBox.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str7 = moment.hyperlink;
            if (str7 != null) {
                codedOutputByteBufferNano.m17316R(69, str7);
            }
            DyMomentSource dyMomentSource2 = moment.dynamicType;
            if (dyMomentSource2 != null) {
                codedOutputByteBufferNano.m17309K(70, dyMomentSource2, DyMomentSource.PROTOBUF_ADAPTER);
            }
            MomentType momentType2 = moment.momentType;
            if (momentType2 != null) {
                codedOutputByteBufferNano.m17309K(71, momentType2, MomentType.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility = moment.userSetVisibility;
            if (userSetVisibility != null) {
                codedOutputByteBufferNano.m17309K(72, userSetVisibility, UserSetVisibility.PROTOBUF_ADAPTER);
            }
            UserSetVisibility userSetVisibility2 = moment.userSetVisibility;
            if (userSetVisibility2 != null) {
                codedOutputByteBufferNano.m17305G(73, userSetVisibility2.ordinal());
            }
            MomentSimpleActivity momentSimpleActivity = moment.simpleActivity;
            if (momentSimpleActivity != null) {
                codedOutputByteBufferNano.m17309K(74, momentSimpleActivity, MomentSimpleActivity.PROTOBUF_ADAPTER);
            }
            MomentAdditionalData momentAdditionalData = moment.additionalData;
            if (momentAdditionalData != null) {
                codedOutputByteBufferNano.m17309K(75, momentAdditionalData, MomentAdditionalData.PROTOBUF_ADAPTER);
            }
            GroupIdBox groupIdBox = moment.group;
            if (groupIdBox != null) {
                codedOutputByteBufferNano.m17309K(76, groupIdBox, GroupIdBox.PROTOBUF_ADAPTER);
            }
            String str8 = moment.deeplink;
            if (str8 != null) {
                codedOutputByteBufferNano.m17316R(77, str8);
            }
            ThirdShareSource thirdShareSource = moment.thirdShareSource;
            if (thirdShareSource != null) {
                codedOutputByteBufferNano.m17309K(78, thirdShareSource, ThirdShareSource.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(79, moment.attitudeId);
            Attitudes attitudes = moment.attitudes;
            if (attitudes != null) {
                codedOutputByteBufferNano.m17309K(80, attitudes, Attitudes.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(81, moment.shareMyVote);
            MomentAllowForwardState momentAllowForwardState = moment.allowForward;
            if (momentAllowForwardState != null) {
                codedOutputByteBufferNano.m17309K(82, momentAllowForwardState, MomentAllowForwardState.PROTOBUF_ADAPTER);
            }
            MomentForwards momentForwards = moment.forwards;
            if (momentForwards != null) {
                codedOutputByteBufferNano.m17309K(83, momentForwards, MomentForwards.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(84, moment.isNewUserAIMoment);
        }
    };
        ...
        public boolean parseField(Moment moment, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 22:
                    ...
                    return true;
                case 23:
                    moment.f56859id = jsonParser.getValueAsString();
                    return false;
                case 24:
    ...
    public static final StringColumn<Moment> f40078ID = new StringColumn<Moment>("id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Moment moment) {
            return moment.f56859id;
        }
    ...
    public static final StringColumn<Moment> SIMPLEACTIVITY_ID = new StringColumn<Moment>("simpleActivity_id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.34
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Moment moment) {
            return moment.simpleActivity.f40083id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Moment moment, String str) {
            moment.simpleActivity.f40083id = str;
        }
    };
    ...
    public static final StringColumn<Moment> ADDITIONALDATA_SENDFROM_ID = new StringColumn<Moment>("additionalData_sendFrom_id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.36
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Moment moment) {
            return moment.additionalData.sendFrom.f40082id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Moment moment, String str) {
            moment.additionalData.sendFrom.f40082id = str;
        }
    };
    ...
    public static final StringColumn<Moment> GROUP_ID = new StringColumn<Moment>("group_id_c") { // from class: com.p1.mobile.putong.feed.data.Moment.39
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Moment moment) {
            return moment.group.f40071id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Moment moment, String str) {
            moment.group.f40071id = str;
        }
    };
    ...
    public static vzf0<Moment> DB_ADAPTER = new vzf0<Moment>() { // from class: com.p1.mobile.putong.feed.data.Moment.59
        ...
        public Moment read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i7 = i + 1;
                moment.f56859id = cursor.isNull(i7) ? null : cursor.getString(i7);
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                int i33 = i + 36;
                                                moment.simpleActivity.f40083id = cursor.isNull(i33) ? null : cursor.getString(i33);
                                                int i34 = i + 37;
                                                moment.simpleActivity.name = cursor.isNull(i34) ? null : cursor.getString(i34);
                                                int i35 = i + 38;
                                                moment.additionalData.sendFrom.f40082id = cursor.isNull(i35) ? null : cursor.getString(i35);
                                                int i36 = i + 39;
                                                ...
                                                int i38 = i + 41;
                                                moment.group.f40071id = cursor.isNull(i38) ? null : cursor.getString(i38);
                                                int i39 = i + 42;
        ...
        public void write(Moment moment, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", moment.f56859id);
                ...
                DbObject.cvPut(contentValues, "simpleActivity_id_c", moment.simpleActivity.f40083id);
                DbObject.cvPut(contentValues, "simpleActivity_name_c", moment.simpleActivity.name);
                DbObject.cvPut(contentValues, "additionalData_sendFrom_id_c", moment.additionalData.sendFrom.f40082id);
                ...
                DbObject.cvPut(contentValues, "group_id_c", moment.group.f40071id);
    ...
    public ftn0.C17070a voiceLiveApiInfo = null;
    public pbi feedVoiceUserEntryInfo = null;
    ...
    public static /* synthetic */ String m62047e(String str) {
        return str;
    }
    ...
    public Moment mo225055clone() {
        Moment moment = new Moment();
        moment._id = this._id;
        moment.f56859id = this.f56859id;
        ...
        if (partialIdList != null) {
            moment.likes = partialIdList.mo225055clone();
        }
        moment.haveLiked = this.haveLiked;
        MessageLocation messageLocation = this.location;
        if (messageLocation != null) {
            moment.location = messageLocation.mo225055clone();
        }
        List<Media> list = this.media;
        if (list != null) {
            moment.media = ValueObject.util_map(list, new qcj() { // from class: l.kg00
                @Override // p153l.qcj
        ...
        if (partialIdList2 != null) {
            moment.messages = partialIdList2.mo225055clone();
        }
        MomentSettings momentSettings = this.settings;
        if (momentSettings != null) {
            moment.settings = momentSettings.mo225055clone();
        }
        ...
        if (list2 != null) {
            moment.topics = ValueObject.util_map(list2, new qcj() { // from class: l.lg00
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        Live live = this.live;
        if (live != null) {
            moment.live = live.mo225055clone();
        }
        moment.isVoiceLive = this.isVoiceLive;
        VoiceLive voiceLive = this.voiceLive;
        if (voiceLive != null) {
            moment.voiceLive = voiceLive.mo225055clone();
        }
        ...
        if (list3 != null) {
            moment.labels = ValueObject.util_map(list3, new qcj() { // from class: l.mg00
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((MomentLabels) obj).mo225055clone();
                }
            });
        }
        ...
        if (liveMultiCallInfo != null) {
            moment.multiCallInfo = liveMultiCallInfo.mo225055clone();
        }
        MomentSimpleActivity momentSimpleActivity = this.simpleActivity;
        if (momentSimpleActivity != null) {
            moment.simpleActivity = momentSimpleActivity.mo225055clone();
        }
        MomentAdditionalData momentAdditionalData = this.additionalData;
        if (momentAdditionalData != null) {
            moment.additionalData = momentAdditionalData.mo225055clone();
        }
        GroupIdBox groupIdBox = this.group;
        if (groupIdBox != null) {
            moment.group = groupIdBox.mo225055clone();
        }
        moment.deeplink = this.deeplink;
        List<String> list4 = this.cameraStickerIds;
        if (list4 != null) {
            moment.cameraStickerIds = ValueObject.util_map(list4, new qcj() { // from class: l.ng00
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return Moment.m62047e((String) obj);
                }
            });
        }
        ThirdShareSource thirdShareSource = this.thirdShareSource;
        if (thirdShareSource != null) {
            moment.thirdShareSource = thirdShareSource.mo225055clone();
        }
        moment.attitudeId = this.attitudeId;
        Attitudes attitudes = this.attitudes;
        if (attitudes != null) {
            moment.attitudes = attitudes.mo225055clone();
        }
        ...
        if (momentForwards != null) {
            moment.forwards = momentForwards.mo225055clone();
        }
        MomentViewerBox momentViewerBox = this.momentViewer;
        if (momentViewerBox != null) {
            moment.momentViewer = momentViewerBox.mo225055clone();
        }
        List<NotifyUser> list5 = this.notifyUsers;
        if (list5 != null) {
            moment.notifyUsers = ValueObject.util_map(list5, new qcj() { // from class: l.og00
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((NotifyUser) obj).mo225055clone();
                }
            });
        }
    ...
    public boolean isAnonymousGroup() {
        GroupIdBox groupIdBox = this.group;
        if (groupIdBox != null && !TextUtils.isEmpty(groupIdBox.f40071id)) {
            Group groupM145799u7 = FeedModule.f39703d.m145799u7(this.group.f40071id);
            if (NullChecker.m82486a(groupM145799u7)) {
                return groupM145799u7.isGroupAnonymousType();
            }
        }
        return false;
    }
    ...
    public boolean isAnonymousMoment() {
        return (!jyb.m147479J(this.mTopicList) && this.mTopicList.get(0).isTopicAnonymousType()) || TEnum.equals(this.momentType, "anonymous") || isAnonymousGroup();
    }
    ...
    public boolean isOnlyMatchVisiable() {
        return NullChecker.m82486a(this.settings) && TEnum.equals(this.settings.userSetVisibility, "matches");
    }

    public boolean isQATopicMoment() {
        return !jyb.m147479J(this.mTopicList) && this.mTopicList.get(0).isQATopicType();
    }

    public boolean isVoteTopicMoment() {
        return !jyb.m147479J(this.mTopicList) && this.mTopicList.get(0).isTopicVoteType();
    }
    ...
    public void mergeData(Moment moment, String str) {
        ...
        if (!jyb.m147479J(moment.mediaRepeatIndexList)) {
