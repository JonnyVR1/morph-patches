...
import com.p051p1.mobile.putong.feed.data.RankingBoard;
...
public class RankingBoard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RankingBoard> PROTOBUF_ADAPTER = new MessageNanoAdapter<RankingBoard>() { // from class: com.p1.mobile.putong.feed.data.RankingBoard.1
        ...
        public int computeAndCacheSize(RankingBoard rankingBoard) {
            String str = rankingBoard.f40089id;
        ...
        public RankingBoard parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 0) {
                    if (rankingBoard.f40089id == null) {
                        rankingBoard.f40089id = "";
                    }
                ...
                if (iM162497u == 10) {
                    rankingBoard.f40089id = nc5Var.m162495s();
        ...
        public boolean parseField(RankingBoard rankingBoard, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "topicIds":
                    ...
                    return true;
                case "id":
                    rankingBoard.f40089id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public static /* synthetic */ String m62071a(String str) {
        return str;
    }
    ...
    public RankingBoard mo225055clone() {
        RankingBoard rankingBoard = new RankingBoard();
        rankingBoard.f40089id = this.f40089id;
        rankingBoard.name = this.name;
        List<String> list = this.topicIds;
        if (list != null) {
            rankingBoard.topicIds = ValueObject.util_map(list, new qcj() { // from class: l.pkc0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return RankingBoard.m62071a((String) obj);
                }
            });
        }
        return rankingBoard;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f40089id, rankingBoard.f40089id) && ValueObject.util_equals(this.name, rankingBoard.name) && ValueObject.util_equals(this.topicIds, rankingBoard.topicIds);
    }
