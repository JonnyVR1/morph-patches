...
public class StateOption extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StateOption> PROTOBUF_ADAPTER = new MessageNanoAdapter<StateOption>() { // from class: com.p1.mobile.putong.feed.data.StateOption.1
        ...
        public int computeAndCacheSize(StateOption stateOption) {
            ...
            if (emotion != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, emotion, Emotion.PROTOBUF_ADAPTER);
            }
            String str2 = stateOption.defaultContent;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(3, str2);
            }
            stateOption.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StateOption parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    stateOption.option = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    stateOption.stateEmotion = (Emotion) nc5Var.m162488l(Emotion.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 26) {
                        if (stateOption.option == null) {
                            stateOption.option = "";
                    ...
                    stateOption.defaultContent = nc5Var.m162495s();
                }
            }
            return stateOption;
        }
        ...
        public void serialize(StateOption stateOption, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Emotion emotion = stateOption.stateEmotion;
            if (emotion != null) {
                codedOutputByteBufferNano.m17309K(2, emotion, Emotion.PROTOBUF_ADAPTER);
            }
            String str2 = stateOption.defaultContent;
            if (str2 != null) {
    ...
    public StateOption mo225055clone() {
        StateOption stateOption = new StateOption();
        stateOption.option = this.option;
        Emotion emotion = this.stateEmotion;
        if (emotion != null) {
            stateOption.stateEmotion = emotion.mo225055clone();
        }
