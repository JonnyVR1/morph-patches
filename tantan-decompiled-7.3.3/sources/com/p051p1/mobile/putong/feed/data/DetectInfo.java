...
import com.p051p1.mobile.putong.feed.data.DetectMediaInfo;
import com.p051p1.mobile.putong.feed.data.DetectTextInfo;
...
public class DetectInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DetectInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<DetectInfo>() { // from class: com.p1.mobile.putong.feed.data.DetectInfo.1
        ...
        public int computeAndCacheSize(DetectInfo detectInfo) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, DetectTextInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            List<DetectMediaInfo> list2 = detectInfo.media;
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, list2, DetectMediaInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = detectInfo.category;
            if (str != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(3, str);
            }
            detectInfo.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DetectInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    detectInfo.text = (List) nc5Var.m162488l(DetectTextInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    detectInfo.media = (List) nc5Var.m162488l(DetectMediaInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 26) {
                        if (detectInfo.text == null) {
                            detectInfo.text = new ArrayList();
                    ...
                    detectInfo.category = nc5Var.m162495s();
                }
            }
            return detectInfo;
        }
        ...
        public void serialize(DetectInfo detectInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<DetectTextInfo> list = detectInfo.text;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, DetectTextInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<DetectMediaInfo> list2 = detectInfo.media;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(2, list2, DetectMediaInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = detectInfo.category;
            if (str != null) {
    ...
    public DetectInfo mo225055clone() {
        DetectInfo detectInfo = new DetectInfo();
        List<DetectTextInfo> list = this.text;
        if (list != null) {
            detectInfo.text = ValueObject.util_map(list, new qcj() { // from class: l.iyd
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((DetectTextInfo) obj).mo225055clone();
                }
            });
        }
        List<DetectMediaInfo> list2 = this.media;
        if (list2 != null) {
            detectInfo.media = ValueObject.util_map(list2, new qcj() { // from class: l.jyd
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((DetectMediaInfo) obj).mo225055clone();
                }
            });
        }
