...
public class OccasionComponent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OccasionComponent> PROTOBUF_ADAPTER = new MessageNanoAdapter<OccasionComponent>() { // from class: com.p1.mobile.putong.feed.data.OccasionComponent.1
        ...
        public int computeAndCacheSize(OccasionComponent occasionComponent) {
            ...
            int iM17285l = occasionType != null ? CodedOutputByteBufferNano.m17285l(1, occasionType, OccasionType.PROTOBUF_ADAPTER) : 0;
            String str = occasionComponent.pageId;
            if (str != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(2, str);
            }
            int iM17281h = iM17285l + CodedOutputByteBufferNano.m17281h(3, occasionComponent.readCount) + CodedOutputByteBufferNano.m17281h(4, occasionComponent.intervalDays) + CodedOutputByteBufferNano.m17281h(5, occasionComponent.showTimes) + CodedOutputByteBufferNano.m17281h(6, occasionComponent.days);
            occasionComponent.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OccasionComponent parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    occasionComponent.type = (OccasionType) nc5Var.m162488l(OccasionType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    occasionComponent.pageId = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    occasionComponent.readCount = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    occasionComponent.intervalDays = nc5Var.m162486j();
                } else if (iM162497u == 40) {
                    occasionComponent.showTimes = nc5Var.m162486j();
                } else {
                    if (iM162497u != 48) {
                        if (occasionComponent.type == null) {
                            occasionComponent.type = (OccasionType) OccasionType.JSON_ADAPTER.defaultEnum();
                    ...
                    occasionComponent.days = nc5Var.m162486j();
                }
            }
            return occasionComponent;
        }
        ...
        public void serialize(OccasionComponent occasionComponent, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (occasionType != null) {
                codedOutputByteBufferNano.m17309K(1, occasionType, OccasionType.PROTOBUF_ADAPTER);
            }
            String str = occasionComponent.pageId;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(2, str);
            }
            codedOutputByteBufferNano.m17305G(3, occasionComponent.readCount);
            codedOutputByteBufferNano.m17305G(4, occasionComponent.intervalDays);
            codedOutputByteBufferNano.m17305G(5, occasionComponent.showTimes);
            codedOutputByteBufferNano.m17305G(6, occasionComponent.days);
        }
    };
    ...
    public OccasionComponent mo225055clone() {
        OccasionComponent occasionComponent = new OccasionComponent();
