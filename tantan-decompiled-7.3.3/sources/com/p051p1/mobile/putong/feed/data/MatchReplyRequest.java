...
import com.p051p1.mobile.putong.feed.data.MatchReplyRequest;
...
public class MatchReplyRequest extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MatchReplyRequest> PROTOBUF_ADAPTER = new MessageNanoAdapter<MatchReplyRequest>() { // from class: com.p1.mobile.putong.feed.data.MatchReplyRequest.1
        ...
        public int computeAndCacheSize(MatchReplyRequest matchReplyRequest) {
            ...
            matchReplyRequest.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MatchReplyRequest parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    matchReplyRequest.state = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    matchReplyRequest.status = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 26) {
                        if (matchReplyRequest.state == null) {
                            matchReplyRequest.state = "";
                    ...
                    matchReplyRequest.message = (IdBoxed) nc5Var.m162488l(IdBoxed.PROTOBUF_ADAPTER);
                }
            }
            return matchReplyRequest;
        }
    ...
    public static /* synthetic */ String m62042a(String str) {
        return str;
    }
    ...
    public MatchReplyRequest mo225055clone() {
        MatchReplyRequest matchReplyRequest = new MatchReplyRequest();
        matchReplyRequest.state = this.state;
        List<String> list = this.status;
        if (list != null) {
            matchReplyRequest.status = ValueObject.util_map(list, new qcj() { // from class: l.uex
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return MatchReplyRequest.m62042a((String) obj);
                }
            });
        }
        IdBoxed idBoxed = this.message;
        if (idBoxed != null) {
            matchReplyRequest.message = idBoxed.mo225055clone();
        }
        return matchReplyRequest;
    }
