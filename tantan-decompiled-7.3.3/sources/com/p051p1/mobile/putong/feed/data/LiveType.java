...
public class LiveType extends TEnum {
    ...
    static {
        TEnumJsonAdapter<LiveType> tEnumJsonAdapter = new TEnumJsonAdapter<LiveType>() { // from class: com.p1.mobile.putong.feed.data.LiveType.1
        ...
        PROTOBUF_ADAPTER = new TEnumProtobufAdapter<LiveType>() { // from class: com.p1.mobile.putong.feed.data.LiveType.2
