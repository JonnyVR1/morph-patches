...
import com.p051p1.mobile.putong.feed.data.RankingTopic;
...
public class RankingBoards extends ValueObject implements Cloneable, Serializable {
    ...
    public RankingBoards mo225055clone() {
        ...
        if (list != null) {
            rankingBoards.boards = ValueObject.util_map(list, new qcj() { // from class: l.skc0
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            rankingBoards.topics = ValueObject.util_map(list2, new qcj() { // from class: l.ukc0
                @Override // p153l.qcj
                public final Object call(Object obj) {
