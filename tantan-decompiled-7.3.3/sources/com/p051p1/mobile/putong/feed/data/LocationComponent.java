...
public class LocationComponent extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LocationComponent> PROTOBUF_ADAPTER = new MessageNanoAdapter<LocationComponent>() { // from class: com.p1.mobile.putong.feed.data.LocationComponent.1
        ...
        public int computeAndCacheSize(LocationComponent locationComponent) {
            ...
            locationComponent.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LocationComponent parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                locationComponent.locations = (List) nc5Var.m162488l(MessageLocation.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return locationComponent;
        }
    ...
    public LocationComponent mo225055clone() {
        LocationComponent locationComponent = new LocationComponent();
        List<MessageLocation> list = this.locations;
        if (list != null) {
            locationComponent.locations = ValueObject.util_map(list, new qcj() { // from class: l.pxv
                @Override // p153l.qcj
