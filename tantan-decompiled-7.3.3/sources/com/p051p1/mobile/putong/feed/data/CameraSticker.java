...
public class CameraSticker extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CameraSticker> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraSticker>() { // from class: com.p1.mobile.putong.feed.data.CameraSticker.1
        {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(CameraSticker cameraSticker) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(57, cameraSticker.index) + CodedOutputByteBufferNano.m17277d(58, cameraSticker.createdTime) + CodedOutputByteBufferNano.m17277d(59, cameraSticker.updateTime);
            String str7 = cameraSticker.category;
            if (str7 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(60, str7);
            }
            String str8 = cameraSticker.extra;
            if (str8 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(61, str8);
            }
            cameraSticker.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CameraSticker parse(nc5 nc5Var) throws IOException {
            CameraSticker cameraSticker = new CameraSticker();
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        if (cameraSticker.f40067id == null) {
                            cameraSticker.f40067id = "";
                        }
                        ...
                        break;
                    case 410:
                        cameraSticker.f40067id = nc5Var.m162495s();
                        continue;
                    case 418:
                        cameraSticker.name = nc5Var.m162495s();
                        continue;
                    case 426:
                        cameraSticker.icon = nc5Var.m162495s();
                        continue;
                    case 434:
                        cameraSticker.resource = nc5Var.m162495s();
                        continue;
                    case 442:
                        cameraSticker.resourceMD5 = nc5Var.m162495s();
                        continue;
                    case 450:
                        cameraSticker.minVersion = nc5Var.m162495s();
                        continue;
                    case 456:
                        cameraSticker.index = nc5Var.m162486j();
                        continue;
                    case 465:
                        cameraSticker.createdTime = nc5Var.m162484h();
                        continue;
                    case 473:
                        cameraSticker.updateTime = nc5Var.m162484h();
                        continue;
                    case 482:
                        cameraSticker.category = nc5Var.m162495s();
                        continue;
                    case 490:
                        cameraSticker.extra = nc5Var.m162495s();
                        continue;
                    default:
                        if (cameraSticker.f40067id == null) {
                            cameraSticker.f40067id = "";
        ...
        public void serialize(CameraSticker cameraSticker, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(57, cameraSticker.index);
            codedOutputByteBufferNano.m17301C(58, cameraSticker.createdTime);
            codedOutputByteBufferNano.m17301C(59, cameraSticker.updateTime);
            String str7 = cameraSticker.category;
            if (str7 != null) {
                codedOutputByteBufferNano.m17316R(60, str7);
            }
            String str8 = cameraSticker.extra;
            if (str8 != null) {
    ...
    public static JsonAdapter<CameraSticker> JSON_ADAPTER = new ObjectJsonAdapter<CameraSticker>() { // from class: com.p1.mobile.putong.feed.data.CameraSticker.2
        ...
        public boolean parseField(CameraSticker cameraSticker, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "updateTime":
                    ...
                    return true;
                case "id":
                    cameraSticker.f40067id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public CameraSticker mo225055clone() {
        CameraSticker cameraSticker = new CameraSticker();
        cameraSticker.f40067id = this.f40067id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f40067id, cameraSticker.f40067id) && ValueObject.util_equals(this.name, cameraSticker.name) && ValueObject.util_equals(this.icon, cameraSticker.icon) && ValueObject.util_equals(this.resource, cameraSticker.resource) && ValueObject.util_equals(this.resourceMD5, cameraSticker.resourceMD5) && ValueObject.util_equals(this.minVersion, cameraSticker.minVersion) && this.index == cameraSticker.index && this.createdTime == cameraSticker.createdTime && this.updateTime == cameraSticker.updateTime && ValueObject.util_equals(this.category, cameraSticker.category) && ValueObject.util_equals(this.extra, cameraSticker.extra);
    }
    ...
    public CameraSticker subtract(CameraSticker cameraSticker) {
        ...
        if (!ValueObject.util_equals(this.f40067id, cameraSticker.f40067id)) {
            cameraSticker2.f40067id = this.f40067id;
        }
