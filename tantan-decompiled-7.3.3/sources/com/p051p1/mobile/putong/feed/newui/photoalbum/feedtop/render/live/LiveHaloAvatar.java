package com.p051p1.mobile.putong.feed.newui.photoalbum.feedtop.render.live;
...
import com.p051p1.mobile.putong.feed.newui.photoalbum.feedtop.render.live.LiveHaloAvatar;
...
public final class LiveHaloAvatar extends View {
    ...
    public LiveHaloAvatar(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.eus
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LiveHaloAvatar.m65901b(this.f95954a, valueAnimatorOfFloat, valueAnimator);
            }
        });
        this.animator = valueAnimatorOfFloat;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, shc0.f168682v);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(shc0.f168688y, 0);
        this.haloSize = dimensionPixelSize;
        this.avatarSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(shc0.f168684w, 0);
        this.haloStartColor = typedArrayObtainStyledAttributes.getColor(shc0.f168690z, -38485);
        this.haloEndColor = typedArrayObtainStyledAttributes.getColor(shc0.f168686x, -41238);
    ...
    public static final void m65901b(LiveHaloAvatar liveHaloAvatar, ValueAnimator valueAnimator, ValueAnimator valueAnimator2) {
    ...
    public final void m65902c(int startColor, int endColor) {
    ...
    public final void m65903d() {
        m65904e();
        this.animator.start();
    }

    /* JADX INFO: renamed from: e */
    public final void m65904e() {
