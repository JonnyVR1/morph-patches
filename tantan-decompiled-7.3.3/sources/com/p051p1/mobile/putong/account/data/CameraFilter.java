...
public class CameraFilter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CameraFilter> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraFilter>() { // from class: com.p1.mobile.putong.account.data.CameraFilter.1
        ...
        public int computeAndCacheSize(CameraFilter cameraFilter) {
            String str = cameraFilter.f17062id;
        ...
        public CameraFilter parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 0) {
                    if (cameraFilter.f17062id == null) {
                        cameraFilter.f17062id = "";
                    }
                ...
                if (iM162497u == 410) {
                    cameraFilter.f17062id = nc5Var.m162495s();
        ...
        public boolean parseField(CameraFilter cameraFilter, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "minVersion":
                    ...
                    return true;
                case "id":
                    cameraFilter.f17062id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public CameraFilter mo225055clone() {
        CameraFilter cameraFilter = new CameraFilter();
        cameraFilter.f17062id = this.f17062id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f17062id, cameraFilter.f17062id) && ValueObject.util_equals(this.name, cameraFilter.name) && ValueObject.util_equals(this.icon, cameraFilter.icon) && ValueObject.util_equals(this.resource, cameraFilter.resource) && ValueObject.util_equals(this.resourceMD5, cameraFilter.resourceMD5) && ValueObject.util_equals(this.minVersion, cameraFilter.minVersion) && this.index == cameraFilter.index;
    }
    ...
    public CameraFilter subtract(CameraFilter cameraFilter) {
        ...
        if (!ValueObject.util_equals(this.f17062id, cameraFilter.f17062id)) {
            cameraFilter2.f17062id = this.f17062id;
        }
