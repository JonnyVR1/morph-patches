...
public class WeChatToken extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<WeChatToken> PROTOBUF_ADAPTER = new MessageNanoAdapter<WeChatToken>() { // from class: com.p1.mobile.putong.account.data.WeChatToken.1
        ...
        public int computeAndCacheSize(WeChatToken weChatToken) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, weChatToken.thirdpartyExpiresIn);
            weChatToken.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public WeChatToken parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    weChatToken.thirdpartyAccessToken = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    weChatToken.thirdpartyRefreshToken = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    weChatToken.thirdpartyId = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    weChatToken.thirdpartyScope = nc5Var.m162495s();
                } else {
                    if (iM162497u != 40) {
                        if (weChatToken.thirdpartyAccessToken == null) {
                            weChatToken.thirdpartyAccessToken = "";
                    ...
                    weChatToken.thirdpartyExpiresIn = nc5Var.m162486j();
                }
            }
            return weChatToken;
        }
        ...
        public void serialize(WeChatToken weChatToken, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(5, weChatToken.thirdpartyExpiresIn);
        }
    };
    ...
    public WeChatToken mo225055clone() {
        WeChatToken weChatToken = new WeChatToken();
