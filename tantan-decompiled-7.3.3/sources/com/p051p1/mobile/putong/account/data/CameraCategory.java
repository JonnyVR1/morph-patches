...
public class CameraCategory extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CameraCategory> PROTOBUF_ADAPTER = new MessageNanoAdapter<CameraCategory>() { // from class: com.p1.mobile.putong.account.data.CameraCategory.1
        ...
        public CameraCategory parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 0) {
                    if (cameraCategory.f17061id == null) {
                        cameraCategory.f17061id = "";
                    }
                ...
                if (iM162497u == 10) {
                    cameraCategory.f17061id = nc5Var.m162495s();
        ...
        public boolean parseField(CameraCategory cameraCategory, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    cameraCategory.f17061id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public CameraCategory mo225055clone() {
        CameraCategory cameraCategory = new CameraCategory();
        cameraCategory.f17061id = this.f17061id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f17061id, cameraCategory.f17061id) && ValueObject.util_equals(this.name, cameraCategory.name) && ValueObject.util_equals(this.category, cameraCategory.category) && ValueObject.util_equals(this.type, cameraCategory.type) && this.cameraUpdateTime == cameraCategory.cameraUpdateTime && ValueObject.util_equals(this.status, cameraCategory.status);
    }
