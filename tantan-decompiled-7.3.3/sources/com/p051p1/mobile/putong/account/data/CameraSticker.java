...
public class CameraSticker extends ValueObject implements Cloneable, Serializable {
        ...
        public CameraSticker parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        if (cameraSticker.f17063id == null) {
                            cameraSticker.f17063id = "";
                        }
                        ...
                        break;
                    case 410:
                        cameraSticker.f17063id = nc5Var.m162495s();
                        continue;
                    case 418:
        ...
        public boolean parseField(CameraSticker cameraSticker, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "updateTime":
                    ...
                    return true;
                case "id":
                    cameraSticker.f17063id = jsonParser.getValueAsString();
                    return false;
                case "icon":
    ...
    public CameraSticker mo225055clone() {
        CameraSticker cameraSticker = new CameraSticker();
        cameraSticker.f17063id = this.f17063id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f17063id, cameraSticker.f17063id) && ValueObject.util_equals(this.name, cameraSticker.name) && ValueObject.util_equals(this.icon, cameraSticker.icon) && ValueObject.util_equals(this.resource, cameraSticker.resource) && ValueObject.util_equals(this.resourceMD5, cameraSticker.resourceMD5) && ValueObject.util_equals(this.minVersion, cameraSticker.minVersion) && this.index == cameraSticker.index && this.createdTime == cameraSticker.createdTime && this.updateTime == cameraSticker.updateTime && ValueObject.util_equals(this.category, cameraSticker.category) && ValueObject.util_equals(this.extra, cameraSticker.extra);
    }
    ...
    public CameraSticker subtract(CameraSticker cameraSticker) {
        ...
        if (!ValueObject.util_equals(this.f17063id, cameraSticker.f17063id)) {
            cameraSticker2.f17063id = this.f17063id;
        }
