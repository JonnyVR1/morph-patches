...
public class BLiveVoiceRankingMsgType extends TEnum {
    ...
    public class C12521a extends TEnumJsonAdapter<BLiveVoiceRankingMsgType> {
    ...
    public class C12522b extends TEnumProtobufAdapter<BLiveVoiceRankingMsgType> {
    ...
    static {
        C12521a c12521a = new C12521a();
        JSON_ADAPTER = c12521a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12522b();
        c12521a.addExtJsonValue("unknown_", -1);
        supportEnum.add("normal");
        supportEnum.add("start");
        supportEnum.add("progress");
        supportEnum.add("sprint");
        _BLiveVoiceRankingMsgType = Collections.synchronizedMap(new l01());
    }
