...
public class BLiveLabel extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveLabel> JSON_ADAPTER = new ObjectJsonAdapter<BLiveLabel>() { // from class: com.p1.mobile.putong.live.base.data.BLiveLabel.1
        ...
        public boolean parseField(BLiveLabel bLiveLabel, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "textSize":
                    ...
                    return true;
                case "id":
                    bLiveLabel.f45240id = jsonParser.getValueAsString();
                    return false;
                case "url":
        ...
        public void serializeFields(BLiveLabel bLiveLabel, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveLabel.f45240id;
            if (str != null) {
    ...
    public BLiveLabel mo225055clone() {
        BLiveLabel bLiveLabel = new BLiveLabel();
        bLiveLabel.f45240id = this.f45240id;
        ...
        if (bLiveBackground != null) {
            bLiveLabel.background = bLiveBackground.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45240id, bLiveLabel.f45240id) && this.textSize == bLiveLabel.textSize && ValueObject.util_equals(this.textColor, bLiveLabel.textColor) && ValueObject.util_equals(this.background, bLiveLabel.background) && ValueObject.util_equals(this.url, bLiveLabel.url) && this.alpha == bLiveLabel.alpha;
    }
