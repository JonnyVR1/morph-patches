...
public class BLiveCallInviteState extends TEnum {
    ...
    public class C11705a extends TEnumJsonAdapter<BLiveCallInviteState> {
    ...
    public class C11706b extends TEnumProtobufAdapter<BLiveCallInviteState> {
    ...
    static {
        C11705a c11705a = new C11705a();
        JSON_ADAPTER = c11705a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11706b();
        c11705a.addExtJsonValue("unknown_", -1);
        c11705a.addExtJsonValue("not-invited", 0);
        c11705a.addExtJsonValue("invited", 1);
        c11705a.addExtJsonValue("accepted", 2);
        supportEnum.add("not-invited");
        supportEnum.add("invited");
        supportEnum.add("accepted");
        _BLiveCallInviteState = Collections.synchronizedMap(new l01());
    }
