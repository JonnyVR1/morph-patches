...
public class BLiveShootGameStatus extends TEnum {
    ...
    public class C12228a extends TEnumJsonAdapter<BLiveShootGameStatus> {
    ...
    public class C12229b extends TEnumProtobufAdapter<BLiveShootGameStatus> {
    ...
    static {
        ...
        JSON_ADAPTER = c12228a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12229b();
        c12228a.addExtJsonValue("unknown_", -1);
        c12228a.addExtJsonValue("completed", 0);
        c12228a.addExtJsonValue("received", 1);
        c12228a.addExtJsonValue("ongoing", 2);
        c12228a.addExtJsonValue(autoReceived, 3);
        c12228a.addExtJsonValue("default", 4);
        ...
        _BLiveShootGameStatus = Collections.synchronizedMap(new l01());
    }
