...
public class BLiveOperationTitleShowType extends TEnum {
    ...
    public class C12090a extends TEnumJsonAdapter<BLiveOperationTitleShowType> {
    ...
    public class C12091b extends TEnumProtobufAdapter<BLiveOperationTitleShowType> {
    ...
    static {
        C12090a c12090a = new C12090a();
        JSON_ADAPTER = c12090a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12091b();
        c12090a.addExtJsonValue("unknown_", -1);
        c12090a.addExtJsonValue(constant, 0);
        c12090a.addExtJsonValue(duration, 1);
        c12090a.addExtJsonValue(off, 2);
        supportEnum.add(constant);
        supportEnum.add(duration);
        supportEnum.add(off);
        _BLiveOperationTitleShowType = Collections.synchronizedMap(new l01());
    }
