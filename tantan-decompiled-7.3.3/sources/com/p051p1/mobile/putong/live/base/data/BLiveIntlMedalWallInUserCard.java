...
public class BLiveIntlMedalWallInUserCard extends ValueObject implements Cloneable, Serializable {
    ...
    public String title;
    public static ProtobufAdapter<BLiveIntlMedalWallInUserCard> PROTOBUF_ADAPTER = new C11941a();
    ...
    public class C11941a extends MessageNanoAdapter<BLiveIntlMedalWallInUserCard> {
        public C11941a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveIntlMedalWallInUserCard bLiveIntlMedalWallInUserCard) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(4, bLiveIntlMedalWallInUserCard.amount);
            bLiveIntlMedalWallInUserCard.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveIntlMedalWallInUserCard parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bLiveIntlMedalWallInUserCard.guildId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    bLiveIntlMedalWallInUserCard.icon = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    bLiveIntlMedalWallInUserCard.title = nc5Var.m162495s();
                } else {
                    if (iM162497u != 32) {
                        if (bLiveIntlMedalWallInUserCard.guildId == null) {
                            bLiveIntlMedalWallInUserCard.guildId = "";
                    ...
                    bLiveIntlMedalWallInUserCard.amount = nc5Var.m162486j();
                }
            }
            return bLiveIntlMedalWallInUserCard;
        }
        ...
        public void serialize(BLiveIntlMedalWallInUserCard bLiveIntlMedalWallInUserCard, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(4, bLiveIntlMedalWallInUserCard.amount);
        }
    }
    ...
    public BLiveIntlMedalWallInUserCard mo225055clone() {
        BLiveIntlMedalWallInUserCard bLiveIntlMedalWallInUserCard = new BLiveIntlMedalWallInUserCard();
