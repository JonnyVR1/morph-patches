...
import com.p051p1.mobile.putong.live.base.data.BLiveHeaddressCoinMarketItem;
...
public class BLiveHeaddressCoinMarket extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveHeaddressCoinMarket mo225055clone() {
        BLiveHeaddressCoinMarket bLiveHeaddressCoinMarket = new BLiveHeaddressCoinMarket();
        ...
        if (list != null) {
            bLiveHeaddressCoinMarket.products = ValueObject.util_map(list, new qcj() { // from class: l.l12
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveHeaddressCoinMarketItem) obj).mo225055clone();
                }
            });
        }
        return bLiveHeaddressCoinMarket;
