...
public class BLiveRole extends TEnum {
    ...
    public class C12188a extends TEnumJsonAdapter<BLiveRole> {
    ...
    public class C12189b extends TEnumProtobufAdapter<BLiveRole> {
    ...
    static {
        C12188a c12188a = new C12188a();
        JSON_ADAPTER = c12188a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12189b();
        c12188a.addExtJsonValue("unknown_", -1);
        c12188a.addExtJsonValue("anchor", 0);
        c12188a.addExtJsonValue("admin", 1);
        c12188a.addExtJsonValue("audience", 2);
        c12188a.addExtJsonValue(caller, 3);
        supportEnum.add("anchor");
        supportEnum.add("admin");
        supportEnum.add("audience");
        supportEnum.add(caller);
        _BLiveRole = Collections.synchronizedMap(new l01());
    }
