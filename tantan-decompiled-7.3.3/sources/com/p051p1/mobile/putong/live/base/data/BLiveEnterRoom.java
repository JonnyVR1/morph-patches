...
public class BLiveEnterRoom extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69112b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m69113c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m69114d(String str) {
        return str;
    }
    ...
    public BLiveEnterRoom mo225055clone() {
        BLiveEnterRoom bLiveEnterRoom = new BLiveEnterRoom();
        ...
        if (list != null) {
            bLiveEnterRoom.userNameGradientColors = ValueObject.util_map(list, new qcj() { // from class: l.gz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveEnterRoom.m69112b((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveEnterRoom.avatarGradients = ValueObject.util_map(list2, new qcj() { // from class: l.hz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveEnterRoom.m69114d((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            bLiveEnterRoom.backgroundGradients = ValueObject.util_map(list3, new qcj() { // from class: l.iz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveEnterRoom.m69113c((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            bLiveEnterRoom.videoEffectExtras = ValueObject.util_map(list4, new qcj() { // from class: l.jz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list5 != null) {
            bLiveEnterRoom.dynamicEffectExtends = ValueObject.util_map(list5, new qcj() { // from class: l.kz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
    ...
    public String getContentText(Context context) {
        return TextUtils.isEmpty(this.contentText) ? context.getResources().getString(R$string.f45063w) : this.contentText;
    }
