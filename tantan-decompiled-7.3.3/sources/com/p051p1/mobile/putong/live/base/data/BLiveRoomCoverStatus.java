...
public class BLiveRoomCoverStatus extends TEnum {
    ...
    public class C12193a extends TEnumJsonAdapter<BLiveRoomCoverStatus> {
    ...
    public class C12194b extends TEnumProtobufAdapter<BLiveRoomCoverStatus> {
    ...
    static {
        C12193a c12193a = new C12193a();
        JSON_ADAPTER = c12193a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12194b();
        c12193a.addExtJsonValue("unknown_", -1);
        c12193a.addExtJsonValue("pending", 0);
        c12193a.addExtJsonValue("default", 1);
        c12193a.addExtJsonValue("rejected", 2);
        supportEnum.add("pending");
        supportEnum.add("default");
        supportEnum.add("rejected");
        _BLiveRoomCoverStatus = Collections.synchronizedMap(new l01());
    }
