...
public class BLiveUndercoverGameResult extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveUndercoverGameResult mo225055clone() {
        BLiveUndercoverGameResult bLiveUndercoverGameResult = new BLiveUndercoverGameResult();
        bLiveUndercoverGameResult.winnerRole = this.winnerRole;
        List<BLiveUserMask> list = this.normalMasks;
        if (list != null) {
            bLiveUndercoverGameResult.normalMasks = ValueObject.util_map(list, new qcj() { // from class: l.k72
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            bLiveUndercoverGameResult.undercoverMasks = ValueObject.util_map(list2, new qcj() { // from class: l.l72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveUserMask) obj).mo225055clone();
                }
