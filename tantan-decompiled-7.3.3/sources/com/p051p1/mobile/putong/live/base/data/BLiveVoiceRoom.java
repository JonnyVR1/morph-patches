...
public class BLiveVoiceRoom extends BLiveAbsRoom implements Cloneable, Serializable {
        ...
        public boolean parseField(BLiveVoiceRoom bLiveVoiceRoom, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 10:
                    ...
                    return true;
                case 11:
                    bLiveVoiceRoom.f45172id = jsonParser.getValueAsString();
                    return false;
                case 12:
    ...
    public static /* synthetic */ String m69612b(String str) {
        return str;
    }
    ...
    public BLiveVoiceRoom mo225055clone() {
        BLiveVoiceRoom bLiveVoiceRoom = new BLiveVoiceRoom();
        bLiveVoiceRoom.f45172id = this.f45172id;
        BLiveOwner bLiveOwner = this.owner;
        if (bLiveOwner != null) {
            bLiveVoiceRoom.owner = bLiveOwner.mo225055clone();
        }
        bLiveVoiceRoom.title = this.title;
        BLiveRoomCover bLiveRoomCover = this.cover;
        if (bLiveRoomCover != null) {
            bLiveVoiceRoom.cover = bLiveRoomCover.mo225055clone();
        }
        bLiveVoiceRoom.type = this.type;
        List<BLiveVoiceTopic> list = this.topics;
        if (list != null) {
            bLiveVoiceRoom.topics = ValueObject.util_map(list, new qcj() { // from class: l.p92
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            bLiveVoiceRoom.topicIds = ValueObject.util_map(list2, new qcj() { // from class: l.q92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceRoom.m69612b((String) obj);
                }
            });
        }
        ...
        if (bLiveVoiceRoomCallPlaceResource != null) {
            bLiveVoiceRoom.callPlaceResource = bLiveVoiceRoomCallPlaceResource.mo225055clone();
        }
        return bLiveVoiceRoom;
    }
