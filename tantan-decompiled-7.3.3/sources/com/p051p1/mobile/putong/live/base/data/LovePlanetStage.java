...
public class LovePlanetStage extends TEnum {
    ...
    public class C12602a extends TEnumJsonAdapter<LovePlanetStage> {
    ...
    public class C12603b extends TEnumProtobufAdapter<LovePlanetStage> {
    ...
    static {
        C12602a c12602a = new C12602a();
        JSON_ADAPTER = c12602a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12603b();
        c12602a.addExtJsonValue("unknown_", -1);
        supportEnum.add("prepare");
        supportEnum.add("introduction");
        supportEnum.add(choice);
        supportEnum.add(result);
        supportEnum.add("trip");
        _LovePlanetStage = Collections.synchronizedMap(new l01());
    }
