...
public class BLiveRankingMsgType extends TEnum {
    ...
    public class C12168a extends TEnumJsonAdapter<BLiveRankingMsgType> {
    ...
    public class C12169b extends TEnumProtobufAdapter<BLiveRankingMsgType> {
    ...
    static {
        C12168a c12168a = new C12168a();
        JSON_ADAPTER = c12168a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12169b();
        c12168a.addExtJsonValue("unknown_", -1);
        c12168a.addExtJsonValue("normal", 0);
        c12168a.addExtJsonValue("start", 1);
        c12168a.addExtJsonValue("progress", 2);
        c12168a.addExtJsonValue("sprint", 3);
        supportEnum.add("normal");
        supportEnum.add("start");
        supportEnum.add("progress");
        supportEnum.add("sprint");
        _BLiveRankingMsgType = Collections.synchronizedMap(new l01());
    }
