...
public class BLiveHierarchyProgress extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69193a(String str) {
        return str;
    }
    ...
    public BLiveHierarchyProgress mo225055clone() {
        BLiveHierarchyProgress bLiveHierarchyProgress = new BLiveHierarchyProgress();
        ...
        if (list != null) {
            bLiveHierarchyProgress.buttons = ValueObject.util_map(list, new qcj() { // from class: l.m12
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveWealthButton) obj).mo225055clone();
                }
            });
        }
        BLiveHierarchyProgressStyle bLiveHierarchyProgressStyle = this.style;
        if (bLiveHierarchyProgressStyle != null) {
            bLiveHierarchyProgress.style = bLiveHierarchyProgressStyle.mo225055clone();
        }
        List<String> list2 = this.progressTexts;
        if (list2 != null) {
            bLiveHierarchyProgress.progressTexts = ValueObject.util_map(list2, new qcj() { // from class: l.n12
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveHierarchyProgress.m69193a((String) obj);
                }
            });
        }
        return bLiveHierarchyProgress;
