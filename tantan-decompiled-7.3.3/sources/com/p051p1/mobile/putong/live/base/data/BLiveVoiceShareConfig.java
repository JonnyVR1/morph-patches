...
import com.p051p1.mobile.putong.live.base.data.BLiveVoiceShareConfig;
...
public class BLiveVoiceShareConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69625a(String str) {
        return str;
    }
    ...
    public BLiveVoiceShareConfig mo225055clone() {
        BLiveVoiceShareConfig bLiveVoiceShareConfig = new BLiveVoiceShareConfig();
        List<String> list = this.momentTitles;
        if (list != null) {
            bLiveVoiceShareConfig.momentTitles = ValueObject.util_map(list, new qcj() { // from class: l.da2
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceShareConfig.m69625a((String) obj);
                }
            });
        }
