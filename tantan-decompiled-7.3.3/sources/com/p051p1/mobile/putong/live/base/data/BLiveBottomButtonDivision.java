...
public class BLiveBottomButtonDivision extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m68885a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m68886b(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ Integer m68887c(Integer num) {
        return num;
    }
    ...
    public BLiveBottomButtonDivision mo225055clone() {
        BLiveBottomButtonDivision bLiveBottomButtonDivision = new BLiveBottomButtonDivision();
        List<Integer> list = this.inputZone;
        if (list != null) {
            bLiveBottomButtonDivision.inputZone = ValueObject.util_map(list, new qcj() { // from class: l.bs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomButtonDivision.m68886b((Integer) obj);
                }
            });
        }
        List<Integer> list2 = this.quickZone;
        if (list2 != null) {
            bLiveBottomButtonDivision.quickZone = ValueObject.util_map(list2, new qcj() { // from class: l.cs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomButtonDivision.m68887c((Integer) obj);
                }
            });
        }
        List<Integer> list3 = this.settingZone;
        if (list3 != null) {
            bLiveBottomButtonDivision.settingZone = ValueObject.util_map(list3, new qcj() { // from class: l.ds1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomButtonDivision.m68885a((Integer) obj);
                }
            });
        }
        return bLiveBottomButtonDivision;
