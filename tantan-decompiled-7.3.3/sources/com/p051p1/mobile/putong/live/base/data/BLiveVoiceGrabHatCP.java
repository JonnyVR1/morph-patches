...
public class BLiveVoiceGrabHatCP extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVoiceGrabHatCP> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceGrabHatCP>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceGrabHatCP.1
        ...
        public boolean parseField(BLiveVoiceGrabHatCP bLiveVoiceGrabHatCP, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userMask":
                    ...
                    return true;
                case "id":
                    bLiveVoiceGrabHatCP.f45347id = jsonParser.getValueAsString();
                    return false;
                default:
                    return false;
            }
        ...
        public void serializeFields(BLiveVoiceGrabHatCP bLiveVoiceGrabHatCP, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoiceGrabHatCP.f45347id;
            if (str != null) {
    ...
    public BLiveVoiceGrabHatCP mo225055clone() {
        BLiveVoiceGrabHatCP bLiveVoiceGrabHatCP = new BLiveVoiceGrabHatCP();
        bLiveVoiceGrabHatCP.f45347id = this.f45347id;
        ...
        if (bLiveUserMask != null) {
            bLiveVoiceGrabHatCP.userMask = bLiveUserMask.mo225055clone();
        }
        BLiveUserMask bLiveUserMask2 = this.otherUserMask;
        if (bLiveUserMask2 != null) {
            bLiveVoiceGrabHatCP.otherUserMask = bLiveUserMask2.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45347id, bLiveVoiceGrabHatCP.f45347id) && ValueObject.util_equals(this.userId, bLiveVoiceGrabHatCP.userId) && ValueObject.util_equals(this.otherUserId, bLiveVoiceGrabHatCP.otherUserId) && ValueObject.util_equals(this.userMask, bLiveVoiceGrabHatCP.userMask) && ValueObject.util_equals(this.otherUserMask, bLiveVoiceGrabHatCP.otherUserMask) && this.lovePoint == bLiveVoiceGrabHatCP.lovePoint;
    }
