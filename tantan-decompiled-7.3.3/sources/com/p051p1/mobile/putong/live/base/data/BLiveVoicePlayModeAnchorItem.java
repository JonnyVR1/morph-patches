...
public class BLiveVoicePlayModeAnchorItem extends ValueObject implements Cloneable, Serializable {
    ...
    public long score;
    public static ProtobufAdapter<BLiveVoicePlayModeAnchorItem> PROTOBUF_ADAPTER = new C12513a();
    ...
    public class C12513a extends MessageNanoAdapter<BLiveVoicePlayModeAnchorItem> {
        public C12513a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveVoicePlayModeAnchorItem bLiveVoicePlayModeAnchorItem) {
            ...
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(5, bLiveVoicePlayModeAnchorItem.score) + CodedOutputByteBufferNano.m17283j(6, bLiveVoicePlayModeAnchorItem.rank) + CodedOutputByteBufferNano.m17283j(7, bLiveVoicePlayModeAnchorItem.memberNum);
            bLiveVoicePlayModeAnchorItem.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveVoicePlayModeAnchorItem parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bLiveVoicePlayModeAnchorItem.anchorId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    bLiveVoicePlayModeAnchorItem.anchorName = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    bLiveVoicePlayModeAnchorItem.anchorAvatar = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    bLiveVoicePlayModeAnchorItem.gender = nc5Var.m162495s();
                } else if (iM162497u == 40) {
                    bLiveVoicePlayModeAnchorItem.score = nc5Var.m162487k();
                } else if (iM162497u == 48) {
                    bLiveVoicePlayModeAnchorItem.rank = nc5Var.m162487k();
                } else {
                    if (iM162497u != 56) {
                        if (bLiveVoicePlayModeAnchorItem.anchorId == null) {
                            bLiveVoicePlayModeAnchorItem.anchorId = "";
                    ...
                    bLiveVoicePlayModeAnchorItem.memberNum = nc5Var.m162487k();
                }
            }
            return bLiveVoicePlayModeAnchorItem;
        }
        ...
        public void serialize(BLiveVoicePlayModeAnchorItem bLiveVoicePlayModeAnchorItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(5, bLiveVoicePlayModeAnchorItem.score);
            codedOutputByteBufferNano.m17307I(6, bLiveVoicePlayModeAnchorItem.rank);
            codedOutputByteBufferNano.m17307I(7, bLiveVoicePlayModeAnchorItem.memberNum);
        }
    }
    ...
    public BLiveVoicePlayModeAnchorItem mo225055clone() {
        BLiveVoicePlayModeAnchorItem bLiveVoicePlayModeAnchorItem = new BLiveVoicePlayModeAnchorItem();
