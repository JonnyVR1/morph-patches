...
public class BLiveVideoChatSummary extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVideoChatSummary> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVideoChatSummary>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVideoChatSummary.1
        ...
        public boolean parseField(BLiveVideoChatSummary bLiveVideoChatSummary, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "roomId":
                    ...
                    return true;
                case "id":
                    bLiveVideoChatSummary.f45326id = jsonParser.getValueAsString();
                    return false;
                case "rewardPoint":
        ...
        public void serializeFields(BLiveVideoChatSummary bLiveVideoChatSummary, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVideoChatSummary.f45326id;
            if (str != null) {
    ...
    public BLiveVideoChatSummary mo225055clone() {
        BLiveVideoChatSummary bLiveVideoChatSummary = new BLiveVideoChatSummary();
        bLiveVideoChatSummary.f45326id = this.f45326id;
        ...
        if (bLiveVideoChatUser != null) {
            bLiveVideoChatSummary.anchor = bLiveVideoChatUser.mo225055clone();
        }
        BLiveVideoChatUser bLiveVideoChatUser2 = this.audience;
        if (bLiveVideoChatUser2 != null) {
            bLiveVideoChatSummary.audience = bLiveVideoChatUser2.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45326id, bLiveVideoChatSummary.f45326id) && ValueObject.util_equals(this.chatId, bLiveVideoChatSummary.chatId) && ValueObject.util_equals(this.liveId, bLiveVideoChatSummary.liveId) && ValueObject.util_equals(this.roomId, bLiveVideoChatSummary.roomId) && ValueObject.util_equals(this.anchor, bLiveVideoChatSummary.anchor) && ValueObject.util_equals(this.audience, bLiveVideoChatSummary.audience) && this.duration == bLiveVideoChatSummary.duration && this.rewardPoint == bLiveVideoChatSummary.rewardPoint && this.endTime == bLiveVideoChatSummary.endTime && this.startTime == bLiveVideoChatSummary.startTime && this.orderMinutes == bLiveVideoChatSummary.orderMinutes;
    }
