...
public class LiveHonorGiftCardView extends ConstraintLayout {
    ...
    public static /* synthetic */ void m68678h0(VDraweeView vDraweeView, VDraweeView vDraweeView2, VDraweeView vDraweeView3) {
    ...
    public static /* synthetic */ void m68679i0(VDraweeView vDraweeView, VDraweeView vDraweeView2, VDraweeView vDraweeView3) {
    ...
    private void m68680j0() {
        ...
        this.f45099bg.setController(null);
    }

    /* JADX INFO: renamed from: k0 */
    public final void m68681k0() {
    ...
    public final void m68682l0(final VDraweeView vDraweeView, final VDraweeView vDraweeView2, final VDraweeView vDraweeView3, final VDraweeView vDraweeView4, final VDraweeView vDraweeView5, final VDraweeView vDraweeView6, xys xysVar) {
        ...
        gt0.m132177w(duration, new Runnable() { // from class: l.yys
            @Override // java.lang.Runnable
            public final void run() {
                LiveHonorGiftCardView.m68679i0(vDraweeView, vDraweeView2, vDraweeView5);
            }
        }, new Runnable() { // from class: l.zys
            @Override // java.lang.Runnable
            public final void run() {
                LiveHonorGiftCardView.m68678h0(vDraweeView3, vDraweeView4, vDraweeView6);
            }
        });
        this.animator.start();
    }
    ...
    public void m68683m0(xys xysVar) {
        ...
        if (i != 1) {
            ...
            m68682l0(vDraweeView5, vDraweeView, vDraweeView2, vDraweeView3, vDraweeView6, vDraweeView4, xysVar);
            izs.m142868s("context_square", this.f45099bg, zft.f204218m);
        }
    ...
    public void onFinishInflate() {
        ...
        layoutParams.height = (int) ((iM105592y0 * 136.0f) / 176.0f);
        ...
        this.f45099bg = (VDraweeView) findViewById(jdc0.f120224q);
    }
