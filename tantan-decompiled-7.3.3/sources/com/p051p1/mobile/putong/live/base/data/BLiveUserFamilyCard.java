...
public class BLiveUserFamilyCard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BLiveUserFamilyCard> PROTOBUF_ADAPTER = new C12358a();
    ...
    public class C12358a extends MessageNanoAdapter<BLiveUserFamilyCard> {
        public C12358a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveUserFamilyCard bLiveUserFamilyCard) {
            ...
            bLiveUserFamilyCard.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveUserFamilyCard parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        bLiveUserFamilyCard.pic = nc5Var.m162495s();
                        continue;
                    case 18:
                        bLiveUserFamilyCard.title = nc5Var.m162495s();
                        continue;
                    case 26:
                        bLiveUserFamilyCard.subTitle = nc5Var.m162495s();
                        continue;
                    case 34:
                        bLiveUserFamilyCard.schema = nc5Var.m162495s();
                        continue;
                    case 42:
                        bLiveUserFamilyCard.bgPic = nc5Var.m162495s();
                        continue;
                    case 50:
                        bLiveUserFamilyCard.familyPic = nc5Var.m162495s();
                        continue;
                    case 58:
                        bLiveUserFamilyCard.titleColor = nc5Var.m162495s();
                        continue;
                    case 66:
                        bLiveUserFamilyCard.subTitleColor = nc5Var.m162495s();
                        continue;
                    case 74:
                        bLiveUserFamilyCard.bgStartColor = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        bLiveUserFamilyCard.bgEndColor = nc5Var.m162495s();
                        continue;
                    default:
                        if (bLiveUserFamilyCard.pic == null) {
                            bLiveUserFamilyCard.pic = "";
    ...
    public BLiveUserFamilyCard mo225055clone() {
        BLiveUserFamilyCard bLiveUserFamilyCard = new BLiveUserFamilyCard();
