...
import com.p051p1.mobile.putong.live.base.data.BLiveShootGameRevenue;
...
public class BLiveShootGameInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveShootGameInfo mo225055clone() {
        BLiveShootGameInfo bLiveShootGameInfo = new BLiveShootGameInfo();
        ...
        if (list != null) {
            bLiveShootGameInfo.shootGameTasks = ValueObject.util_map(list, new qcj() { // from class: l.w52
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveShootGameTask) obj).mo225055clone();
                }
            });
        }
        List<BLiveShootGameRevenue> list2 = this.shootGameRevenues;
        if (list2 != null) {
            bLiveShootGameInfo.shootGameRevenues = ValueObject.util_map(list2, new qcj() { // from class: l.x52
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveShootGameRevenue) obj).mo225055clone();
                }
            });
        }
        return bLiveShootGameInfo;
