...
public class BLiveUndercoverGame extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveUndercoverGame> JSON_ADAPTER = new ObjectJsonAdapter<BLiveUndercoverGame>() { // from class: com.p1.mobile.putong.live.base.data.BLiveUndercoverGame.1
        ...
        public boolean parseField(BLiveUndercoverGame bLiveUndercoverGame, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    bLiveUndercoverGame.f45312id = jsonParser.getValueAsString();
                    return false;
                case "votes":
        ...
        public void serializeFields(BLiveUndercoverGame bLiveUndercoverGame, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveUndercoverGame.f45312id;
            if (str != null) {
    ...
    public BLiveUndercoverGame mo225055clone() {
        BLiveUndercoverGame bLiveUndercoverGame = new BLiveUndercoverGame();
        bLiveUndercoverGame.f45312id = this.f45312id;
        bLiveUndercoverGame.status = this.status;
        List<BLiveUndercoverCurrentPlayer> list = this.currentPlayers;
        if (list != null) {
            bLiveUndercoverGame.currentPlayers = ValueObject.util_map(list, new qcj() { // from class: l.i72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveUndercoverCurrentPlayer) obj).mo225055clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveUndercoverGame.votes = ValueObject.util_map(list2, new qcj() { // from class: l.j72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveUndercoverVote) obj).mo225055clone();
                }
            });
        }
        BLiveUndercoverVoteResult bLiveUndercoverVoteResult = this.voteResult;
        if (bLiveUndercoverVoteResult != null) {
            bLiveUndercoverGame.voteResult = bLiveUndercoverVoteResult.mo225055clone();
        }
        BLiveUndercoverGameResult bLiveUndercoverGameResult = this.gameResult;
        if (bLiveUndercoverGameResult != null) {
            bLiveUndercoverGame.gameResult = bLiveUndercoverGameResult.mo225055clone();
        }
        return bLiveUndercoverGame;
    }
    ...
    public String toString() {
        return "BLiveUndercoverGame{liveId='" + this.liveId + "', toast='" + this.toast + "', id='" + this.f45312id + "', status='" + this.status + "', currentPlayers=" + this.currentPlayers + ", remainSeconds=" + this.remainSeconds + ", countDownSeconds=" + this.countDownSeconds + ", votes=" + this.votes + ", voteResult=" + this.voteResult + ", gameResult=" + this.gameResult + '}';
    }
}
