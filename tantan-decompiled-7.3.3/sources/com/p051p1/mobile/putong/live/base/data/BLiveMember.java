...
public class BLiveMember extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveMember> JSON_ADAPTER = new ObjectJsonAdapter<BLiveMember>() { // from class: com.p1.mobile.putong.live.base.data.BLiveMember.1
        ...
        public boolean parseField(BLiveMember bLiveMember, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "callConnections":
                    ...
                    return true;
                case "id":
                    bLiveMember.f45246id = jsonParser.getValueAsString();
                    return false;
                case "role":
        ...
        public void serializeFields(BLiveMember bLiveMember, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveMember.f45246id;
            if (str != null) {
    ...
    public static /* synthetic */ String m69238a(String str) {
        return str;
    }
    ...
    public BLiveMember mo225055clone() {
        BLiveMember bLiveMember = new BLiveMember();
        bLiveMember.f45246id = this.f45246id;
        ...
        if (list != null) {
            bLiveMember.callConnections = ValueObject.util_map(list, new qcj() { // from class: l.q22
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveCallConnection) obj).mo225055clone();
                }
            });
        }
        List<String> list2 = this.userNameGradientColors;
        if (list2 != null) {
            bLiveMember.userNameGradientColors = ValueObject.util_map(list2, new qcj() { // from class: l.r22
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveMember.m69238a((String) obj);
                }
            });
        }
        return bLiveMember;
    ...
    public BLiveMember subtract(BLiveMember bLiveMember) {
        ...
        if (!ValueObject.util_equals(this.f45246id, bLiveMember.f45246id)) {
            bLiveMember2.f45246id = this.f45246id;
        }
