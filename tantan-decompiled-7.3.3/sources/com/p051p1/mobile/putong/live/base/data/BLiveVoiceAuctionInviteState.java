...
public class BLiveVoiceAuctionInviteState extends TEnum {
    ...
    public class C12406a extends TEnumJsonAdapter<BLiveVoiceAuctionInviteState> {
    ...
    public class C12407b extends TEnumProtobufAdapter<BLiveVoiceAuctionInviteState> {
    ...
    static {
        ...
        _BLiveVoiceAuctionInviteState = Collections.synchronizedMap(new l01());
    }
