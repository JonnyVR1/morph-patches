...
public class BLiveUnreadTypeEnum extends TEnum {
    ...
    public class C12336a extends TEnumJsonAdapter<BLiveUnreadTypeEnum> {
    ...
    public class C12337b extends TEnumProtobufAdapter<BLiveUnreadTypeEnum> {
    ...
    static {
        C12336a c12336a = new C12336a();
        JSON_ADAPTER = c12336a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12337b();
        c12336a.addExtJsonValue("unknown_", -1);
        c12336a.addExtJsonValue("number", 0);
        c12336a.addExtJsonValue(redDot, 1);
        c12336a.addExtJsonValue(liveIcon, 2);
        supportEnum.add("number");
        supportEnum.add(redDot);
        supportEnum.add(liveIcon);
        supportEnum.add(guild);
        _BLiveUnreadTypeEnum = Collections.synchronizedMap(new l01());
    }
