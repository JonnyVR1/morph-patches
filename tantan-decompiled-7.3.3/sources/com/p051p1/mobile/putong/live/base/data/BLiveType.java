...
public class BLiveType extends TEnum {
    ...
    public class C12327a extends TEnumJsonAdapter<BLiveType> {
    ...
    public class C12328b extends TEnumProtobufAdapter<BLiveType> {
    ...
    static {
        C12327a c12327a = new C12327a();
        JSON_ADAPTER = c12327a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12328b();
        c12327a.addExtJsonValue("unknown_", -1);
        c12327a.addExtJsonValue("live", 0);
        c12327a.addExtJsonValue(voiceLive, 1);
        c12327a.addExtJsonValue("app", 2);
        supportEnum.add("live");
        supportEnum.add(voiceLive);
        supportEnum.add("app");
        _BLiveType = Collections.synchronizedMap(new l01());
    }
