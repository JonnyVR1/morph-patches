...
public class BLivePkSetting extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69344a(String str) {
        return str;
    }
    ...
    public BLivePkSetting mo225055clone() {
        BLivePkSetting bLivePkSetting = new BLivePkSetting();
        BLivePkEntranceShowLimit bLivePkEntranceShowLimit = this.entranceShowLimit;
        if (bLivePkEntranceShowLimit != null) {
            bLivePkSetting.entranceShowLimit = bLivePkEntranceShowLimit.mo225055clone();
        }
        List<BLivePkPunishMotion> list = this.pkMotions;
        if (list != null) {
            bLivePkSetting.pkMotions = ValueObject.util_map(list, new qcj() { // from class: l.q42
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLivePkPunishMotion) obj).mo225055clone();
                }
            });
        }
        BLivePkStartMessage bLivePkStartMessage = this.startShowMessage;
        if (bLivePkStartMessage != null) {
            bLivePkSetting.startShowMessage = bLivePkStartMessage.mo225055clone();
        }
        bLivePkSetting.victoryMotionId = this.victoryMotionId;
        List<String> list2 = this.punishMotionSelectIds;
        if (list2 != null) {
            bLivePkSetting.punishMotionSelectIds = ValueObject.util_map(list2, new qcj() { // from class: l.r42
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLivePkSetting.m69344a((String) obj);
                }
            });
        }
        BLiveQuitPkMessages bLiveQuitPkMessages = this.quitPkMessages;
        if (bLiveQuitPkMessages != null) {
            bLivePkSetting.quitPkMessages = bLiveQuitPkMessages.mo225055clone();
        }
        BLiveQuitPkMessages bLiveQuitPkMessages2 = this.stopLiveMessages;
        if (bLiveQuitPkMessages2 != null) {
            bLivePkSetting.stopLiveMessages = bLiveQuitPkMessages2.mo225055clone();
        }
        ...
        if (bLiveCommonConfig != null) {
            bLivePkSetting.winTimesTag = bLiveCommonConfig.mo225055clone();
        }
        return bLivePkSetting;
    }
