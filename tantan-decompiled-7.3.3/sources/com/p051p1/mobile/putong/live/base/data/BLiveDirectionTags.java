...
public class BLiveDirectionTags extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveDirectionTags mo225055clone() {
        BLiveDirectionTags bLiveDirectionTags = new BLiveDirectionTags();
        List<BLiveVoiceTag> list = this.topTags;
        if (list != null) {
            bLiveDirectionTags.topTags = ValueObject.util_map(list, new qcj() { // from class: l.yy1
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            bLiveDirectionTags.bottomTags = ValueObject.util_map(list2, new qcj() { // from class: l.zy1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceTag) obj).mo225055clone();
                }
        ...
        if (list3 != null) {
            bLiveDirectionTags.leftTopTags = ValueObject.util_map(list3, new qcj() { // from class: l.az1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceTag) obj).mo225055clone();
                }
