...
public class BLiveOperationPopupType extends TEnum {
    ...
    public class C12087a extends TEnumJsonAdapter<BLiveOperationPopupType> {
    ...
    public class C12088b extends TEnumProtobufAdapter<BLiveOperationPopupType> {
    ...
    static {
        C12087a c12087a = new C12087a();
        JSON_ADAPTER = c12087a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12088b();
        c12087a.addExtJsonValue("unknown_", -1);
        c12087a.addExtJsonValue("none", 0);
        c12087a.addExtJsonValue(H5Drawer, 1);
        c12087a.addExtJsonValue(TextDrawer, 2);
        c12087a.addExtJsonValue(H5PopUp, 3);
        supportEnum.add("none");
        supportEnum.add(H5Drawer);
        supportEnum.add(TextDrawer);
        supportEnum.add(H5PopUp);
        _BLiveOperationPopupType = Collections.synchronizedMap(new l01());
    }
