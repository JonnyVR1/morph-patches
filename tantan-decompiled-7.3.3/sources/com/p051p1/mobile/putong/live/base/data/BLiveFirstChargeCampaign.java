...
public class BLiveFirstChargeCampaign extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Double m69139b(Double d) {
        return d;
    }
    ...
    public BLiveFirstChargeCampaign mo225055clone() {
        BLiveFirstChargeCampaign bLiveFirstChargeCampaign = new BLiveFirstChargeCampaign();
        ...
        if (list != null) {
            bLiveFirstChargeCampaign.detailInset = ValueObject.util_map(list, new qcj() { // from class: l.b02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveFirstChargeCampaign.m69139b((Double) obj);
                }
            });
        }
        List<BLiveFirstChargeActivity> list2 = this.activityArray;
        if (list2 != null) {
            bLiveFirstChargeCampaign.activityArray = ValueObject.util_map(list2, new qcj() { // from class: l.c02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveFirstChargeActivity) obj).mo225055clone();
                }
            });
        }
