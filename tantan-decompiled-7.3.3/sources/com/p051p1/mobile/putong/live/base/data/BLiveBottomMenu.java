...
public class BLiveBottomMenu extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68898e(String str) {
        return str;
    }
    ...
    public BLiveBottomMenu mo225055clone() {
        BLiveBottomMenu bLiveBottomMenu = new BLiveBottomMenu();
        BLiveSettingButton bLiveSettingButton = this.settingButton;
        if (bLiveSettingButton != null) {
            bLiveBottomMenu.settingButton = bLiveSettingButton.mo225055clone();
        }
        List<BLiveBottomButton> list = this.buttons;
        if (list != null) {
            bLiveBottomMenu.buttons = ValueObject.util_map(list, new qcj() { // from class: l.es1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveBottomButton) obj).mo225055clone();
                }
            });
        }
        List<BLiveSettingButtonCategory> list2 = this.categorys;
        if (list2 != null) {
            bLiveBottomMenu.categorys = ValueObject.util_map(list2, new qcj() { // from class: l.fs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveSettingButtonCategory) obj).mo225055clone();
                }
            });
        }
        BLiveBottomButtonDivision bLiveBottomButtonDivision = this.menu;
        if (bLiveBottomButtonDivision != null) {
            bLiveBottomMenu.menu = bLiveBottomButtonDivision.mo225055clone();
        }
        List<String> list3 = this.bubbleOrder;
        if (list3 != null) {
            bLiveBottomMenu.bubbleOrder = ValueObject.util_map(list3, new qcj() { // from class: l.gs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomMenu.m68898e((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            bLiveBottomMenu.bubbles = ValueObject.util_map(list4, new qcj() { // from class: l.hs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list5 != null) {
            bLiveBottomMenu.chatBox = ValueObject.util_map(list5, new qcj() { // from class: l.is1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveChatBox) obj).mo225055clone();
                }
            });
        }
