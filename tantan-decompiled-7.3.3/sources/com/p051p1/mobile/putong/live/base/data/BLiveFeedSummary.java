...
public class BLiveFeedSummary extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveFeedSummary> JSON_ADAPTER = new ObjectJsonAdapter<BLiveFeedSummary>() { // from class: com.p1.mobile.putong.live.base.data.BLiveFeedSummary.1
        ...
        public boolean parseField(BLiveFeedSummary bLiveFeedSummary, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userIds":
                    ...
                    return true;
                case "id":
                    bLiveFeedSummary.f45215id = jsonParser.getValueAsString();
                    return false;
                case "type":
        ...
        public void serializeFields(BLiveFeedSummary bLiveFeedSummary, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveFeedSummary.f45215id;
            if (str != null) {
    ...
    public static /* synthetic */ String m69134a(String str) {
        return str;
    }
    ...
    public BLiveFeedSummary mo225055clone() {
        BLiveFeedSummary bLiveFeedSummary = new BLiveFeedSummary();
        bLiveFeedSummary.f45215id = this.f45215id;
        ...
        if (list != null) {
            bLiveFeedSummary.userIds = ValueObject.util_map(list, new qcj() { // from class: l.a02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveFeedSummary.m69134a((String) obj);
                }
            });
        }
        return bLiveFeedSummary;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45215id, bLiveFeedSummary.f45215id) && ValueObject.util_equals(this.type, bLiveFeedSummary.type) && ValueObject.util_equals(this.description, bLiveFeedSummary.description) && this.display == bLiveFeedSummary.display && ValueObject.util_equals(this.subDescription, bLiveFeedSummary.subDescription) && ValueObject.util_equals(this.userIds, bLiveFeedSummary.userIds);
    }
