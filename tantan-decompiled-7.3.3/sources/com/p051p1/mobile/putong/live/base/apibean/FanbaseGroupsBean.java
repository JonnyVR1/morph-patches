...
public class FanbaseGroupsBean extends BaseLiveBean {
    ...
    public class CategoryBean {
        ...
        public String toString() {
            return "CategoryBean{id='" + this.f45081id + "', name='" + this.name + "', color='" + this.color + "'}";
        }
    }
    ...
    public class FansbaseGroupsItem {
        ...
        public String toString() {
            return "FansbaseGroupsItem{id='" + this.f45082id + "', name='" + this.name + "', tags=" + this.tags + ", desc='" + this.desc + "', avatar='" + this.avatar + "', canJoin=" + this.canJoin + ", cannotJoinReason='" + this.cannotJoinReason + "', statusDesc='" + this.statusDesc + "', category=" + this.category + ", maxMemberCount=" + this.maxMemberCount + ", currentMemberCount=" + this.currentMemberCount + '}';
        }
    }
