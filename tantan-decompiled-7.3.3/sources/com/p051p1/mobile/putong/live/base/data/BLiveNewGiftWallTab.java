...
public class BLiveNewGiftWallTab extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveNewGiftWallTab> JSON_ADAPTER = new ObjectJsonAdapter<BLiveNewGiftWallTab>() { // from class: com.p1.mobile.putong.live.base.data.BLiveNewGiftWallTab.1
        ...
        public boolean parseField(BLiveNewGiftWallTab bLiveNewGiftWallTab, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "progress":
                    ...
                    return true;
                case "id":
                    bLiveNewGiftWallTab.f45263id = jsonParser.getValueAsString();
                    return false;
                case "name":
        ...
        public void serializeFields(BLiveNewGiftWallTab bLiveNewGiftWallTab, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveNewGiftWallTab.f45263id;
            if (str != null) {
    ...
    public static /* synthetic */ String m69276b(String str) {
        return str;
    }
    ...
    public BLiveNewGiftWallTab mo225055clone() {
        BLiveNewGiftWallTab bLiveNewGiftWallTab = new BLiveNewGiftWallTab();
        bLiveNewGiftWallTab.f45263id = this.f45263id;
        ...
        if (bLiveNewGiftWallProgress != null) {
            bLiveNewGiftWallTab.progress = bLiveNewGiftWallProgress.mo225055clone();
        }
        List<String> list = this.giftIds;
        if (list != null) {
            bLiveNewGiftWallTab.giftIds = ValueObject.util_map(list, new qcj() { // from class: l.y32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveNewGiftWallTab.m69276b((String) obj);
                }
            });
        }
        List<BLiveNewGiftWallSubTab> list2 = this.subTabs;
        if (list2 != null) {
            bLiveNewGiftWallTab.subTabs = ValueObject.util_map(list2, new qcj() { // from class: l.z32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveNewGiftWallSubTab) obj).mo225055clone();
                }
            });
        }
        return bLiveNewGiftWallTab;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45263id, bLiveNewGiftWallTab.f45263id) && ValueObject.util_equals(this.type, bLiveNewGiftWallTab.type) && ValueObject.util_equals(this.name, bLiveNewGiftWallTab.name) && ValueObject.util_equals(this.categoryId, bLiveNewGiftWallTab.categoryId) && ValueObject.util_equals(this.progress, bLiveNewGiftWallTab.progress) && ValueObject.util_equals(this.giftIds, bLiveNewGiftWallTab.giftIds) && ValueObject.util_equals(this.subTabs, bLiveNewGiftWallTab.subTabs);
    }
