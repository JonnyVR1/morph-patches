...
public class BLiveTreasureBoxStatus extends TEnum {
    ...
    public class C12324a extends TEnumJsonAdapter<BLiveTreasureBoxStatus> {
    ...
    public class C12325b extends TEnumProtobufAdapter<BLiveTreasureBoxStatus> {
    ...
    static {
        C12324a c12324a = new C12324a();
        JSON_ADAPTER = c12324a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12325b();
        c12324a.addExtJsonValue("unknown_", -1);
        c12324a.addExtJsonValue("deleted", 0);
        c12324a.addExtJsonValue("created", 1);
        c12324a.addExtJsonValue("pending", 2);
        c12324a.addExtJsonValue("completed", 3);
        c12324a.addExtJsonValue(taken, 4);
        supportEnum.add("deleted");
        supportEnum.add("created");
        supportEnum.add("pending");
        supportEnum.add("completed");
        supportEnum.add(taken);
        _BLiveTreasureBoxStatus = Collections.synchronizedMap(new l01());
    }
