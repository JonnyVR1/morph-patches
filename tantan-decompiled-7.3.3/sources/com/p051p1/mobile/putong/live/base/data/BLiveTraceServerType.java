...
public class BLiveTraceServerType extends TEnum {
    ...
    public static final String f45310H5 = "H5";
    ...
    public class C12319a extends TEnumJsonAdapter<BLiveTraceServerType> {
    ...
    public class C12320b extends TEnumProtobufAdapter<BLiveTraceServerType> {
    ...
    static {
        C12319a c12319a = new C12319a();
        JSON_ADAPTER = c12319a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12320b();
        c12319a.addExtJsonValue("unknown_", -1);
        c12319a.addExtJsonValue(Native, 0);
        c12319a.addExtJsonValue("H5", 1);
        supportEnum.add(Native);
        supportEnum.add("H5");
        supportEnum.add(flowerLeaderboard);
        _BLiveTraceServerType = Collections.synchronizedMap(new l01());
    }
