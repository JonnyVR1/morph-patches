...
public class BLivePkOwner extends ValueObject implements Cloneable, Serializable {
    ...
    public BLivePkOwner mo225055clone() {
        BLivePkOwner bLivePkOwner = new BLivePkOwner();
        ...
        if (list != null) {
            bLivePkOwner.contributors = ValueObject.util_map(list, new qcj() { // from class: l.m42
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLivePkContributor) obj).mo225055clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLivePkOwner.itemCardList = ValueObject.util_map(list2, new qcj() { // from class: l.n42
                @Override // p153l.qcj
                public final Object call(Object obj) {
