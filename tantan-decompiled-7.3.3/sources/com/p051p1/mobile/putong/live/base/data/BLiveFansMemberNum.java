...
public class BLiveFansMemberNum extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BLiveFansMemberNum> PROTOBUF_ADAPTER = new C11811a();
    ...
    public class C11811a extends MessageNanoAdapter<BLiveFansMemberNum> {
        public C11811a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveFansMemberNum bLiveFansMemberNum) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, bLiveFansMemberNum.memberNum);
            bLiveFansMemberNum.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveFansMemberNum parse(nc5 nc5Var) throws IOException {
            BLiveFansMemberNum bLiveFansMemberNum = new BLiveFansMemberNum();
            while (nc5Var.m162497u() == 8) {
                bLiveFansMemberNum.memberNum = nc5Var.m162486j();
            }
        ...
        public void serialize(BLiveFansMemberNum bLiveFansMemberNum, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, bLiveFansMemberNum.memberNum);
        }
    }
    ...
    public BLiveFansMemberNum mo225055clone() {
        BLiveFansMemberNum bLiveFansMemberNum = new BLiveFansMemberNum();
