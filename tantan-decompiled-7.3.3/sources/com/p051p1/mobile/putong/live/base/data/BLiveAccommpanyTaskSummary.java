...
import com.p051p1.mobile.putong.live.base.data.BLiveAccommpanyTaskSummaryUser;
...
public class BLiveAccommpanyTaskSummary extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveAccommpanyTaskSummary mo225055clone() {
        BLiveAccommpanyTaskSummary bLiveAccommpanyTaskSummary = new BLiveAccommpanyTaskSummary();
        ...
        if (list != null) {
            bLiveAccommpanyTaskSummary.users = ValueObject.util_map(list, new qcj() { // from class: l.br1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveAccommpanyTaskSummaryUser) obj).mo225055clone();
                }
            });
        }
