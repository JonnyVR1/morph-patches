...
public class BLiveFollowRateChatV2 extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69146a(String str) {
        return str;
    }
    ...
    public BLiveFollowRateChatV2 mo225055clone() {
        BLiveFollowRateChatV2 bLiveFollowRateChatV2 = new BLiveFollowRateChatV2();
        List<String> list = this.triggerEvents;
        if (list != null) {
            bLiveFollowRateChatV2.triggerEvents = ValueObject.util_map(list, new qcj() { // from class: l.g02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveFollowRateChatV2.m69146a((String) obj);
                }
            });
        }
        ...
        if (bLiveFollowConditions != null) {
            bLiveFollowRateChatV2.conditions = bLiveFollowConditions.mo225055clone();
        }
