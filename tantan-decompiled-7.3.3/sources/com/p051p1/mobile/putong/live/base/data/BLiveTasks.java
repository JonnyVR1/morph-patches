...
public class BLiveTasks extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69447a(String str) {
        return str;
    }
    ...
    public BLiveTasks mo225055clone() {
        BLiveTasks bLiveTasks = new BLiveTasks();
        bLiveTasks.taskId = this.taskId;
        bLiveTasks.preTaskId = this.preTaskId;
        List<String> list = this.preTaskIds;
        if (list != null) {
            bLiveTasks.preTaskIds = ValueObject.util_map(list, new qcj() { // from class: l.z62
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveTasks.m69447a((String) obj);
                }
            });
        }
        ...
        if (bLiveTotalTaskCompleteReward != null) {
            bLiveTasks.reward = bLiveTotalTaskCompleteReward.mo225055clone();
        }
