...
public class BLiveSignInTask extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m69415b(Integer num) {
        return num;
    }
    ...
    public BLiveSignInTask mo225055clone() {
        BLiveSignInTask bLiveSignInTask = new BLiveSignInTask();
        ...
        if (list != null) {
            bLiveSignInTask.descriptionAdditional = ValueObject.util_map(list, new qcj() { // from class: l.e62
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveSignInTask.m69415b((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveSignInTask.rewards = ValueObject.util_map(list2, new qcj() { // from class: l.f62
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveSignInReward) obj).mo225055clone();
                }
            });
        }
        return bLiveSignInTask;
