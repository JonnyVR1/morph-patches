...
public class BLiveVoiceRoomFeed extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69619c(String str) {
        return str;
    }
    ...
    public static BLiveVoiceRoomFeed convertFrom(BLiveAbsData bLiveAbsData, BLiveAbsRoom bLiveAbsRoom, User user) {
        ...
        bLiveVoiceRoomFeedNew_.liveId = bLiveAbsData.f45171id;
        bLiveVoiceRoomFeedNew_.roomId = bLiveAbsData.room.f45267id;
        bLiveVoiceRoomFeedNew_.anchorId = bLiveAbsData.anchor.f45267id;
    ...
    public BLiveVoiceRoomFeed mo225055clone() {
        BLiveVoiceRoomFeed bLiveVoiceRoomFeed = new BLiveVoiceRoomFeed();
        ...
        if (list != null) {
            bLiveVoiceRoomFeed.liveTags = ValueObject.util_map(list, new qcj() { // from class: l.v92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceTag) obj).mo225055clone();
                }
            });
        }
        List<BLiveVoiceMemberAvatar> list2 = this.memberAvatars;
        if (list2 != null) {
            bLiveVoiceRoomFeed.memberAvatars = ValueObject.util_map(list2, new qcj() { // from class: l.w92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceMemberAvatar) obj).mo225055clone();
                }
            });
        }
        ...
        if (list3 != null) {
            bLiveVoiceRoomFeed.feedTags = ValueObject.util_map(list3, new qcj() { // from class: l.x92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceRoomFeed.m69619c((String) obj);
                }
            });
        }
