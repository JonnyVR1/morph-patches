...
public class BLiveVoiceGame extends ValueObject implements Cloneable, Serializable {
    ...
    public int width;
    public static ProtobufAdapter<BLiveVoiceGame> PROTOBUF_ADAPTER = new C12455a();
    public static JsonAdapter<BLiveVoiceGame> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceGame>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceGame.2
        ...
        public boolean parseField(BLiveVoiceGame bLiveVoiceGame, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userIds":
                    ...
                    return true;
                case "id":
                    bLiveVoiceGame.f45345id = jsonParser.getValueAsString();
                    return false;
                case "type":
        ...
        public void serializeFields(BLiveVoiceGame bLiveVoiceGame, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoiceGame.f45345id;
            if (str != null) {
    ...
    public class C12455a extends MessageNanoAdapter<BLiveVoiceGame> {
        public C12455a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveVoiceGame bLiveVoiceGame) {
            ...
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(6, bLiveVoiceGame.agoraGameId) + CodedOutputByteBufferNano.m17281h(7, bLiveVoiceGame.width) + CodedOutputByteBufferNano.m17281h(8, bLiveVoiceGame.height);
            String str5 = bLiveVoiceGame.backgroundImage;
            if (str5 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(9, str5);
            }
            bLiveVoiceGame.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveVoiceGame parse(nc5 nc5Var) throws IOException {
            BLiveVoiceGame bLiveVoiceGame = new BLiveVoiceGame();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (bLiveVoiceGame.f45345id == null) {
                        bLiveVoiceGame.f45345id = "";
                    }
                ...
                if (iM162497u == 10) {
                    bLiveVoiceGame.f45345id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    bLiveVoiceGame.providerRoundId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    bLiveVoiceGame.userIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 34) {
                    bLiveVoiceGame.state = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    bLiveVoiceGame.type = nc5Var.m162495s();
                } else if (iM162497u == 48) {
                    bLiveVoiceGame.agoraGameId = nc5Var.m162487k();
                } else if (iM162497u == 56) {
                    bLiveVoiceGame.width = nc5Var.m162486j();
                } else if (iM162497u == 64) {
                    bLiveVoiceGame.height = nc5Var.m162486j();
                } else {
                    if (iM162497u != 74) {
                        if (bLiveVoiceGame.f45345id == null) {
                            bLiveVoiceGame.f45345id = "";
                    ...
                    bLiveVoiceGame.backgroundImage = nc5Var.m162495s();
                }
            }
            return bLiveVoiceGame;
        }
        ...
        public void serialize(BLiveVoiceGame bLiveVoiceGame, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(6, bLiveVoiceGame.agoraGameId);
            codedOutputByteBufferNano.m17305G(7, bLiveVoiceGame.width);
            codedOutputByteBufferNano.m17305G(8, bLiveVoiceGame.height);
            String str5 = bLiveVoiceGame.backgroundImage;
            if (str5 != null) {
    ...
    public static /* synthetic */ String m69556a(String str) {
        return str;
    }
    ...
    public BLiveVoiceGame mo225055clone() {
        BLiveVoiceGame bLiveVoiceGame = new BLiveVoiceGame();
        bLiveVoiceGame.f45345id = this.f45345id;
        bLiveVoiceGame.providerRoundId = this.providerRoundId;
        List<String> list = this.userIds;
        if (list != null) {
            bLiveVoiceGame.userIds = ValueObject.util_map(list, new qcj() { // from class: l.z82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceGame.m69556a((String) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45345id, bLiveVoiceGame.f45345id) && ValueObject.util_equals(this.providerRoundId, bLiveVoiceGame.providerRoundId) && ValueObject.util_equals(this.userIds, bLiveVoiceGame.userIds) && ValueObject.util_equals(this.state, bLiveVoiceGame.state) && ValueObject.util_equals(this.type, bLiveVoiceGame.type) && this.agoraGameId == bLiveVoiceGame.agoraGameId && this.width == bLiveVoiceGame.width && this.height == bLiveVoiceGame.height && ValueObject.util_equals(this.backgroundImage, bLiveVoiceGame.backgroundImage);
    }
