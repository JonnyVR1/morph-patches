...
import com.p051p1.mobile.putong.live.base.data.BLiveVoiceGiftWallPics;
...
public class BLiveVoiceGiftWallBrief extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceGiftWallBrief mo225055clone() {
        BLiveVoiceGiftWallBrief bLiveVoiceGiftWallBrief = new BLiveVoiceGiftWallBrief();
        ...
        if (list != null) {
            bLiveVoiceGiftWallBrief.pics = ValueObject.util_map(list, new qcj() { // from class: l.b92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceGiftWallPics) obj).mo225055clone();
                }
            });
        }
        return bLiveVoiceGiftWallBrief;
