...
public class BLiveProductType extends TEnum {
    ...
    public class C12154a extends TEnumJsonAdapter<BLiveProductType> {
    ...
    public class C12155b extends TEnumProtobufAdapter<BLiveProductType> {
    ...
    static {
        ...
        c12154a.addExtJsonValue("consumable", 0);
        c12154a.addExtJsonValue("auto-renewable", 1);
        c12154a.addExtJsonValue("none-renewing", 2);
        supportEnum.add("consumable");
        supportEnum.add("auto-renewable");
        supportEnum.add("none-renewing");
        _BLiveProductType = Collections.synchronizedMap(new l01());
    }
