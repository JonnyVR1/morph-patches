...
public class LiveConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveConfig> PROTOBUF_ADAPTER = new C12598a();
    ...
    public class C12598a extends MessageNanoAdapter<LiveConfig> {
        public C12598a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(LiveConfig liveConfig) {
            ...
            int iM17285l = liveEntranceHide != null ? CodedOutputByteBufferNano.m17285l(1, liveEntranceHide, LiveEntranceHide.PROTOBUF_ADAPTER) : 0;
            VoiceLiveEntranceHide voiceLiveEntranceHide = liveConfig.voiceLiveEntranceHide;
            if (voiceLiveEntranceHide != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, voiceLiveEntranceHide, VoiceLiveEntranceHide.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17285l + CodedOutputByteBufferNano.m17275b(3, liveConfig.walletLiveEntranceHide) + CodedOutputByteBufferNano.m17275b(4, liveConfig.settingLiveEntranceHide) + CodedOutputByteBufferNano.m17275b(5, liveConfig.settingNoticeEntranceHide) + CodedOutputByteBufferNano.m17275b(6, liveConfig.canSwitchAccount) + CodedOutputByteBufferNano.m17275b(7, liveConfig.gameEntranceHide);
            liveConfig.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public LiveConfig parse(nc5 nc5Var) throws IOException {
            LiveConfig liveConfig = new LiveConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 10) {
                    liveConfig.liveEntranceHide = (LiveEntranceHide) nc5Var.m162488l(LiveEntranceHide.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    liveConfig.voiceLiveEntranceHide = (VoiceLiveEntranceHide) nc5Var.m162488l(VoiceLiveEntranceHide.PROTOBUF_ADAPTER);
                } else if (iM162497u == 24) {
                    liveConfig.walletLiveEntranceHide = nc5Var.m162483g();
                } else if (iM162497u == 32) {
                    liveConfig.settingLiveEntranceHide = nc5Var.m162483g();
                } else if (iM162497u == 40) {
                    liveConfig.settingNoticeEntranceHide = nc5Var.m162483g();
                } else if (iM162497u == 48) {
                    liveConfig.canSwitchAccount = nc5Var.m162483g();
                } else {
                    if (iM162497u != 56) {
                        return liveConfig;
                    }
                    liveConfig.gameEntranceHide = nc5Var.m162483g();
                }
            }
        }
        ...
        public void serialize(LiveConfig liveConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (liveEntranceHide != null) {
                codedOutputByteBufferNano.m17309K(1, liveEntranceHide, LiveEntranceHide.PROTOBUF_ADAPTER);
            }
            VoiceLiveEntranceHide voiceLiveEntranceHide = liveConfig.voiceLiveEntranceHide;
            if (voiceLiveEntranceHide != null) {
                codedOutputByteBufferNano.m17309K(2, voiceLiveEntranceHide, VoiceLiveEntranceHide.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(3, liveConfig.walletLiveEntranceHide);
            codedOutputByteBufferNano.m17299A(4, liveConfig.settingLiveEntranceHide);
            codedOutputByteBufferNano.m17299A(5, liveConfig.settingNoticeEntranceHide);
            codedOutputByteBufferNano.m17299A(6, liveConfig.canSwitchAccount);
            codedOutputByteBufferNano.m17299A(7, liveConfig.gameEntranceHide);
        }
    }
    ...
    public LiveConfig mo225055clone() {
        LiveConfig liveConfig = new LiveConfig();
        LiveEntranceHide liveEntranceHide = this.liveEntranceHide;
        if (liveEntranceHide != null) {
            liveConfig.liveEntranceHide = liveEntranceHide.mo225055clone();
        }
        VoiceLiveEntranceHide voiceLiveEntranceHide = this.voiceLiveEntranceHide;
        if (voiceLiveEntranceHide != null) {
            liveConfig.voiceLiveEntranceHide = voiceLiveEntranceHide.mo225055clone();
        }
