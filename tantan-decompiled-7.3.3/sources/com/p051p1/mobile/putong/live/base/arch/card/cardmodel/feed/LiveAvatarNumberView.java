...
public class LiveAvatarNumberView extends FrameLayout {
    ...
    public final void m68623b(FrameLayout frameLayout, int i, List<String> list) {
    ...
    public void setImageData(List<String> list) {
        jyb.m147537z(this.list, new y20() { // from class: l.twr
            @Override // p153l.y20
        ...
        for (int i = 4; i > 0; i--) {
            if (i <= this.images.size()) {
                m68623b(this.list.get(i - 1), i, this.images);
            }
        }
        m68624c();
    }
