...
public class BLiveTemplate extends ValueObject implements Cloneable, Serializable {
    ...
    public static JsonAdapter<BLiveTemplate> JSON_ADAPTER = new ObjectJsonAdapter<BLiveTemplate>() { // from class: com.p1.mobile.putong.live.base.data.BLiveTemplate.1
        ...
        public boolean parseField(BLiveTemplate bLiveTemplate, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "format":
                    ...
                    return true;
                case "h5":
                    bLiveTemplate.f45304h5 = jsonParser.getValueAsString();
                    return true;
                case "id":
                    bLiveTemplate.f45305id = jsonParser.getValueAsInt();
                    return false;
                case "menu":
        ...
        public void serializeFields(BLiveTemplate bLiveTemplate, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", bLiveTemplate.f45305id);
            jsonGenerator.writeNumberField("action", bLiveTemplate.action);
            String str = bLiveTemplate.f45304h5;
            if (str != null) {
                jsonGenerator.writeStringField(BLiveOperationClickAction.f45265h5, str);
            }
    ...
    public BLiveTemplate mo225055clone() {
        BLiveTemplate bLiveTemplate = new BLiveTemplate();
        bLiveTemplate.f45305id = this.f45305id;
        bLiveTemplate.action = this.action;
        bLiveTemplate.f45304h5 = this.f45304h5;
        List<BLiveTemplateMenu> list = this.menu;
        if (list != null) {
            bLiveTemplate.menu = ValueObject.util_map(list, new qcj() { // from class: l.a72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveTemplateMenu) obj).mo225055clone();
                }
            });
        }
        List<BLiveTemplateItem> list2 = this.format;
        if (list2 != null) {
            bLiveTemplate.format = ValueObject.util_map(list2, new qcj() { // from class: l.b72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveTemplateItem) obj).mo225055clone();
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f45305id == bLiveTemplate.f45305id && this.action == bLiveTemplate.action && ValueObject.util_equals(this.f45304h5, bLiveTemplate.f45304h5) && ValueObject.util_equals(this.menu, bLiveTemplate.menu) && ValueObject.util_equals(this.format, bLiveTemplate.format) && this.category == bLiveTemplate.category;
    }
    ...
    public int hashCode() {
        ...
        int i2 = ((((i * 41) + this.f45305id) * 41) + this.action) * 41;
        String str = this.f45304h5;
