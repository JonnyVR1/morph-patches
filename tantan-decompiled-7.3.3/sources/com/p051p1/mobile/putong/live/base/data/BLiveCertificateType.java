...
public class BLiveCertificateType extends TEnum {
    ...
    public class C11716a extends TEnumJsonAdapter<BLiveCertificateType> {
    ...
    public class C11717b extends TEnumProtobufAdapter<BLiveCertificateType> {
    ...
    static {
        C11716a c11716a = new C11716a();
        JSON_ADAPTER = c11716a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11717b();
        c11716a.addExtJsonValue("unknown_", -1);
        c11716a.addExtJsonValue("idCard", 0);
        supportEnum.add("idCard");
        _BLiveCertificateType = Collections.synchronizedMap(new l01());
    }
