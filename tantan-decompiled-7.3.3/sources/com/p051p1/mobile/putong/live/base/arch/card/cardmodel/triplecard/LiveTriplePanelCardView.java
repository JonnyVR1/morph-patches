package com.p051p1.mobile.putong.live.base.arch.card.cardmodel.triplecard;
...
public class LiveTriplePanelCardView extends FrameLayout {
    ...
    public static int m68698a(List<String> list, int i) {
    ...
    public void m68699b(rbt rbtVar) {
        ...
        this.bgView.setBackground(fc2.m124980j(m68698a(rbtVar.background, 0), m68698a(rbtVar.background, 1), 10));
    }
