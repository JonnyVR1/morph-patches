...
public class BLiveOperationPlaceType extends TEnum {
    ...
    public class C12085a extends TEnumJsonAdapter<BLiveOperationPlaceType> {
    ...
    public class C12086b extends TEnumProtobufAdapter<BLiveOperationPlaceType> {
    ...
    static {
        C12085a c12085a = new C12085a();
        JSON_ADAPTER = c12085a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12086b();
        c12085a.addExtJsonValue("unknown_", -1);
        c12085a.addExtJsonValue("default", 0);
        c12085a.addExtJsonValue(turboCard, 1);
        c12085a.addExtJsonValue(lotteryGiftRedPacket, 2);
        c12085a.addExtJsonValue(turboCoupon, 3);
        supportEnum.add("default");
        supportEnum.add(turboCard);
        supportEnum.add(lotteryGiftRedPacket);
        supportEnum.add(turboCoupon);
        _BLiveOperationPlaceType = Collections.synchronizedMap(new l01());
    }
