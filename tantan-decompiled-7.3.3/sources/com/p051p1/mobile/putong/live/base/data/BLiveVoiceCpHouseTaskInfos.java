...
public class BLiveVoiceCpHouseTaskInfos extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceCpHouseTaskInfos mo225055clone() {
        BLiveVoiceCpHouseTaskInfos bLiveVoiceCpHouseTaskInfos = new BLiveVoiceCpHouseTaskInfos();
        ...
        if (bLiveVoiceCpHouseInfo != null) {
            bLiveVoiceCpHouseTaskInfos.voiceCpHouseInfo = bLiveVoiceCpHouseInfo.mo225055clone();
        }
        List<BLiveVoiceSweetCpTask> list = this.taskList;
        if (list != null) {
            bLiveVoiceCpHouseTaskInfos.taskList = ValueObject.util_map(list, new qcj() { // from class: l.s82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceSweetCpTask) obj).mo225055clone();
                }
            });
        }
        return bLiveVoiceCpHouseTaskInfos;
