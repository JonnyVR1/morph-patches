...
public class BLiveGiftItem extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveGiftItem> JSON_ADAPTER = new ObjectJsonAdapter<BLiveGiftItem>() { // from class: com.p1.mobile.putong.live.base.data.BLiveGiftItem.1
        ...
        public boolean parseField(BLiveGiftItem bLiveGiftItem, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 26:
                    ...
                    return true;
                case 27:
                    bLiveGiftItem.f45225id = jsonParser.getValueAsInt();
                    return false;
                case 28:
        ...
        public void serializeFields(BLiveGiftItem bLiveGiftItem, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", bLiveGiftItem.f45225id);
    ...
    public static /* synthetic */ String m69166b(String str) {
        return str;
    }
    ...
    public BLiveGiftItem mo225055clone() {
        BLiveGiftItem bLiveGiftItem = new BLiveGiftItem();
        bLiveGiftItem.f45225id = this.f45225id;
        bLiveGiftItem.giftType = this.giftType;
        bLiveGiftItem.name = this.name;
        LangModel langModel = this.localName;
        if (langModel != null) {
            bLiveGiftItem.localName = langModel.mo225055clone();
        }
        ...
        if (langModel2 != null) {
            bLiveGiftItem.localTag = langModel2.mo225055clone();
        }
        ...
        if (list != null) {
            bLiveGiftItem.luckyPrizeGiftInfos = ValueObject.util_map(list, new qcj() { // from class: l.r02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveLuckyGiftInfo) obj).mo225055clone();
                }
            });
        }
        ...
        if (bLiveGiftInteractRules != null) {
            bLiveGiftItem.interactRules = bLiveGiftInteractRules.mo225055clone();
        }
        ...
        if (list2 != null) {
            bLiveGiftItem.labels = ValueObject.util_map(list2, new qcj() { // from class: l.s02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveGiftItem.m69166b((String) obj);
                }
            });
        }
        BLiveGiftShowRules bLiveGiftShowRules = this.showAnimRules;
        if (bLiveGiftShowRules != null) {
            bLiveGiftItem.showAnimRules = bLiveGiftShowRules.mo225055clone();
        }
        BLiveSlotGiftInfo bLiveSlotGiftInfo = this.slotGiftInfo;
        if (bLiveSlotGiftInfo != null) {
            bLiveGiftItem.slotGiftInfo = bLiveSlotGiftInfo.mo225055clone();
        }
        ...
        if (bLiveGiftGearInfo != null) {
            bLiveGiftItem.gear = bLiveGiftGearInfo.mo225055clone();
        }
        List<BLiveDiscountItem> list3 = this.discounts;
        if (list3 != null) {
            bLiveGiftItem.discounts = ValueObject.util_map(list3, new qcj() { // from class: l.t02
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (bLiveGiftDiamondPrice != null) {
            bLiveGiftItem.diamondPrice = bLiveGiftDiamondPrice.mo225055clone();
        }
        BLiveIntlFlyMicEffectConfig bLiveIntlFlyMicEffectConfig = this.flyMicInfo;
        if (bLiveIntlFlyMicEffectConfig != null) {
            bLiveGiftItem.flyMicInfo = bLiveIntlFlyMicEffectConfig.mo225055clone();
        }
        return bLiveGiftItem;
    }
    ...
    public long getCoinPrice() {
        if (jyb.m147479J(this.discounts)) {
            return this.purchasePrice;
        }
        ArrayList arrayListM147522n = jyb.m147522n(this.discounts, new qcj() { // from class: l.v02
            @Override // p153l.qcj
            public final Object call(Object obj) {
        ...
        return (long) Math.ceil(this.purchasePrice * (((double) ((BLiveDiscountItem) arrayListM147522n.get(0)).discount) / 100.0d));
    }
    ...
    public long getDiamondPrice() {
        ...
        ArrayList arrayListM147522n = jyb.m147522n(this.discounts, new qcj() { // from class: l.q02
            @Override // p153l.qcj
            public final Object call(Object obj) {
                return Boolean.valueOf(((BLiveDiscountItem) obj).remain > 0);
            }
        ...
        return (long) Math.ceil(this.diamondPrice.purchasePrice * (((double) ((BLiveDiscountItem) arrayListM147522n.get(0)).discount) / 100.0d));
    }

    public List<String> getGearsEffectIds() {
        return isGearsGift() ? jyb.m147486Q(this.gear.gearEffects, new qcj() { // from class: l.u02
            @Override // p153l.qcj
            public final Object call(Object obj) {
    ...
    public long getPrice() {
        return u8n.m195065a() ? getDiamondPrice() : getCoinPrice();
    }
    ...
    public boolean isDiscountCard() {
        return !jyb.m147479J(this.labels) && this.labels.contains("discountCard");
    }
    ...
    public boolean isGearsGift() {
        return !jyb.m147479J(this.gear.gearEffects);
    }
    ...
    public boolean isSupportDiscountGift() {
        return !jyb.m147479J(this.discounts);
    }
