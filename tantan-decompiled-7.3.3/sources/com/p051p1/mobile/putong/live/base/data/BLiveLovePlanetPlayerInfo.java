...
public class BLiveLovePlanetPlayerInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveLovePlanetPlayerInfo mo225055clone() {
        BLiveLovePlanetPlayerInfo bLiveLovePlanetPlayerInfo = new BLiveLovePlanetPlayerInfo();
        ...
        if (bLiveMaskAvatarConfig != null) {
            bLiveLovePlanetPlayerInfo.avatarConfig = bLiveMaskAvatarConfig.mo225055clone();
        }
        return bLiveLovePlanetPlayerInfo;
    }
    ...
    public String getAvatarUrl() {
        return (NullChecker.m82486a(this.avatarConfig) && this.avatarConfig.frameConfig.checkNeedChangeVoice() && !TextUtils.isEmpty(this.avatarConfig.frameConfig.funnyUrl)) ? this.avatarConfig.frameConfig.funnyUrl : this.avatar;
    }
