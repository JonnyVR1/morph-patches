...
public class BLivePkStage extends TEnum {
    ...
    public class C12137a extends TEnumJsonAdapter<BLivePkStage> {
    ...
    public class C12138b extends TEnumProtobufAdapter<BLivePkStage> {
    ...
    static {
        C12137a c12137a = new C12137a();
        JSON_ADAPTER = c12137a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12138b();
        c12137a.addExtJsonValue("unknown_", -1);
        c12137a.addExtJsonValue("preparing", 0);
        c12137a.addExtJsonValue("playing", 1);
        c12137a.addExtJsonValue(punishing, 2);
        c12137a.addExtJsonValue("ended", 3);
        supportEnum.add("preparing");
        supportEnum.add("playing");
        supportEnum.add(punishing);
        supportEnum.add("ended");
        _BLivePkStage = Collections.synchronizedMap(new l01());
    }
