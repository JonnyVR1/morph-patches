...
public class BLiveUndercoverVote extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m69475a(Integer num) {
        return num;
    }
    ...
    public BLiveUndercoverVote mo225055clone() {
        BLiveUndercoverVote bLiveUndercoverVote = new BLiveUndercoverVote();
        BLiveUserMask bLiveUserMask = this.candidateMask;
        if (bLiveUserMask != null) {
            bLiveUndercoverVote.candidateMask = bLiveUserMask.mo225055clone();
        }
        bLiveUndercoverVote.number = this.number;
        List<Integer> list = this.voterNumbers;
        if (list != null) {
            bLiveUndercoverVote.voterNumbers = ValueObject.util_map(list, new qcj() { // from class: l.m72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveUndercoverVote.m69475a((Integer) obj);
                }
            });
        }
        return bLiveUndercoverVote;
