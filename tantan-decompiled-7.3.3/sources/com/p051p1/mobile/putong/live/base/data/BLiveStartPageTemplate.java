...
public class BLiveStartPageTemplate extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69422a(String str) {
        return str;
    }
    ...
    public BLiveStartPageTemplate mo225055clone() {
        BLiveStartPageTemplate bLiveStartPageTemplate = new BLiveStartPageTemplate();
        ...
        if (list != null) {
            bLiveStartPageTemplate.announcements = ValueObject.util_map(list, new qcj() { // from class: l.j62
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveStartPageTemplate.m69422a((String) obj);
                }
            });
        }
        return bLiveStartPageTemplate;
