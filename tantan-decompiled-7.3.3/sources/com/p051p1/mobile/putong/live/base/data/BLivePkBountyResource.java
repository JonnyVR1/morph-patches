...
public class BLivePkBountyResource extends ValueObject implements Cloneable, Serializable {
    ...
    public BLivePkBountyResource mo225055clone() {
        BLivePkBountyResource bLivePkBountyResource = new BLivePkBountyResource();
        ...
        if (list != null) {
            bLivePkBountyResource.effectExtras = ValueObject.util_map(list, new qcj() { // from class: l.j42
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLivePkBountyEffectExtras) obj).mo225055clone();
                }
            });
        }
        return bLivePkBountyResource;
