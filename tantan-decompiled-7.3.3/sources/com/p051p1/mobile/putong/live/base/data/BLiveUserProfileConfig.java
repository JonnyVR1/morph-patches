...
public class BLiveUserProfileConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69502a(String str) {
        return str;
    }
    ...
    public BLiveUserProfileConfig mo225055clone() {
        BLiveUserProfileConfig bLiveUserProfileConfig = new BLiveUserProfileConfig();
        ...
        if (list != null) {
            bLiveUserProfileConfig.jumpConfig = ValueObject.util_map(list, new qcj() { // from class: l.y72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveUserProfileConfig.m69502a((String) obj);
                }
            });
        }
        List<BLiveUserProfileConfigHierarchy> list2 = this.hierarchy;
        if (list2 != null) {
            bLiveUserProfileConfig.hierarchy = ValueObject.util_map(list2, new qcj() { // from class: l.z72
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (bLiveUserFamilyCard != null) {
            bLiveUserProfileConfig.familyCard = bLiveUserFamilyCard.mo225055clone();
        }
        return bLiveUserProfileConfig;
    }
