...
public class BFansRecallUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BFansRecallUser> PROTOBUF_ADAPTER = new C11612a();
    ...
    public class C11612a extends MessageNanoAdapter<BFansRecallUser> {
        public C11612a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BFansRecallUser bFansRecallUser) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(5, bFansRecallUser.following) + CodedOutputByteBufferNano.m17275b(6, bFansRecallUser.followed) + CodedOutputByteBufferNano.m17281h(7, bFansRecallUser.fanbaseGrade) + CodedOutputByteBufferNano.m17281h(8, bFansRecallUser.grade) + CodedOutputByteBufferNano.m17275b(9, bFansRecallUser.isOnline) + CodedOutputByteBufferNano.m17275b(10, bFansRecallUser.isRecalled);
            bFansRecallUser.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BFansRecallUser parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        bFansRecallUser.userId = nc5Var.m162495s();
                        continue;
                    case 18:
                        bFansRecallUser.avatar = nc5Var.m162495s();
                        continue;
                    case 26:
                        bFansRecallUser.name = nc5Var.m162495s();
                        continue;
                    case 34:
                        bFansRecallUser.desc = nc5Var.m162495s();
                        continue;
                    case 40:
                        bFansRecallUser.following = nc5Var.m162483g();
                        continue;
                    case 48:
                        bFansRecallUser.followed = nc5Var.m162483g();
                        continue;
                    case 56:
                        bFansRecallUser.fanbaseGrade = nc5Var.m162486j();
                        continue;
                    case 64:
                        bFansRecallUser.grade = nc5Var.m162486j();
                        continue;
                    case 72:
                        bFansRecallUser.isOnline = nc5Var.m162483g();
                        continue;
                    case 80:
                        bFansRecallUser.isRecalled = nc5Var.m162483g();
                        continue;
                    default:
                        if (bFansRecallUser.userId == null) {
                            bFansRecallUser.userId = "";
        ...
        public void serialize(BFansRecallUser bFansRecallUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(5, bFansRecallUser.following);
            codedOutputByteBufferNano.m17299A(6, bFansRecallUser.followed);
            codedOutputByteBufferNano.m17305G(7, bFansRecallUser.fanbaseGrade);
            codedOutputByteBufferNano.m17305G(8, bFansRecallUser.grade);
            codedOutputByteBufferNano.m17299A(9, bFansRecallUser.isOnline);
            codedOutputByteBufferNano.m17299A(10, bFansRecallUser.isRecalled);
        }
    }
    ...
    public BFansRecallUser mo225055clone() {
        BFansRecallUser bFansRecallUser = new BFansRecallUser();
