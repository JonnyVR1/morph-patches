...
public class BLiveFollowRatePopupV2 extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69147a(String str) {
        return str;
    }
    ...
    public BLiveFollowRatePopupV2 mo225055clone() {
        BLiveFollowRatePopupV2 bLiveFollowRatePopupV2 = new BLiveFollowRatePopupV2();
        List<String> list = this.triggerEvents;
        if (list != null) {
            bLiveFollowRatePopupV2.triggerEvents = ValueObject.util_map(list, new qcj() { // from class: l.h02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveFollowRatePopupV2.m69147a((String) obj);
                }
            });
        }
        ...
        if (bLiveFollowConditions != null) {
            bLiveFollowRatePopupV2.conditions = bLiveFollowConditions.mo225055clone();
        }
