...
public class VirtualVoiceMotionType extends TEnum {
    ...
    public class C12608a extends TEnumJsonAdapter<VirtualVoiceMotionType> {
    ...
    public class C12609b extends TEnumProtobufAdapter<VirtualVoiceMotionType> {
    ...
    static {
        C12608a c12608a = new C12608a();
        JSON_ADAPTER = c12608a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12609b();
        c12608a.addExtJsonValue("unknown_", -1);
        ...
        _VirtualVoiceMotionType = Collections.synchronizedMap(new l01());
    }
