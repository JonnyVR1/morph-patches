...
public class BLiveButtonAnimation extends ValueObject implements Cloneable, Serializable {
    ...
    public String url;
    public static ProtobufAdapter<BLiveButtonAnimation> PROTOBUF_ADAPTER = new C11695a();
    ...
    public class C11695a extends MessageNanoAdapter<BLiveButtonAnimation> {
        public C11695a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveButtonAnimation bLiveButtonAnimation) {
            String str = bLiveButtonAnimation.url;
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17283j(2, bLiveButtonAnimation.enterPlayOffsetSeconds) + CodedOutputByteBufferNano.m17283j(3, bLiveButtonAnimation.playGapSeconds);
            bLiveButtonAnimation.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveButtonAnimation parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bLiveButtonAnimation.url = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    bLiveButtonAnimation.enterPlayOffsetSeconds = nc5Var.m162487k();
                } else {
                    if (iM162497u != 24) {
                        if (bLiveButtonAnimation.url != null) {
                            break;
                    ...
                    bLiveButtonAnimation.playGapSeconds = nc5Var.m162487k();
                }
            }
            return bLiveButtonAnimation;
        }
        ...
        public void serialize(BLiveButtonAnimation bLiveButtonAnimation, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(2, bLiveButtonAnimation.enterPlayOffsetSeconds);
            codedOutputByteBufferNano.m17307I(3, bLiveButtonAnimation.playGapSeconds);
        }
    }
    ...
    public BLiveButtonAnimation mo225055clone() {
        BLiveButtonAnimation bLiveButtonAnimation = new BLiveButtonAnimation();
