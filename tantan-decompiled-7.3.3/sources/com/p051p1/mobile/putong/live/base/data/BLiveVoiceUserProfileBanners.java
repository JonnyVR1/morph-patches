...
public class BLiveVoiceUserProfileBanners extends ValueObject implements Cloneable, Serializable {
    ...
    public List<nsv<User>> users = new ArrayList();

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ String m69632a(String str) {
        return str;
    }
    ...
    public BLiveVoiceUserProfileBanners mo225055clone() {
        BLiveVoiceUserProfileBanners bLiveVoiceUserProfileBanners = new BLiveVoiceUserProfileBanners();
        ...
        if (list != null) {
            bLiveVoiceUserProfileBanners.userIds = ValueObject.util_map(list, new qcj() { // from class: l.ha2
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileBanners.m69632a((String) obj);
                }
            });
        }
        return bLiveVoiceUserProfileBanners;
