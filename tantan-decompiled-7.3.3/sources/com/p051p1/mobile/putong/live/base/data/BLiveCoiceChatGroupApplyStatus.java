...
public class BLiveCoiceChatGroupApplyStatus extends TEnum {
    ...
    public class C11739a extends TEnumJsonAdapter<BLiveCoiceChatGroupApplyStatus> {
    ...
    public class C11740b extends TEnumProtobufAdapter<BLiveCoiceChatGroupApplyStatus> {
    ...
    static {
        ...
        JSON_ADAPTER = c11739a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11740b();
        c11739a.addExtJsonValue("unknown_", -1);
        c11739a.addExtJsonValue(applying, 0);
        c11739a.addExtJsonValue("approved", 1);
        supportEnum.add(applying);
        supportEnum.add("approved");
        _BLiveCoiceChatGroupApplyStatus = Collections.synchronizedMap(new l01());
    }
