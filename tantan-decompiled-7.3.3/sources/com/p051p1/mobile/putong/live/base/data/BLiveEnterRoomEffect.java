...
public class BLiveEnterRoomEffect extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69117b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m69119d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m69120e(String str) {
        return str;
    }
    ...
    public BLiveEnterRoomEffect mo225055clone() {
        BLiveEnterRoomEffect bLiveEnterRoomEffect = new BLiveEnterRoomEffect();
        ...
        if (list != null) {
            bLiveEnterRoomEffect.userNameGradientColors = ValueObject.util_map(list, new qcj() { // from class: l.lz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveEnterRoomEffect.m69120e((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveEnterRoomEffect.backgroundGradients = ValueObject.util_map(list2, new qcj() { // from class: l.mz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveEnterRoomEffect.m69119d((String) obj);
                }
            });
        }
        ...
        if (bLiveWealthHierarchys != null) {
            bLiveEnterRoomEffect.hierarchys = bLiveWealthHierarchys.mo225055clone();
        }
        bLiveEnterRoomEffect.avatarGradientDirection = this.avatarGradientDirection;
        List<String> list3 = this.avatarGradients;
        if (list3 != null) {
            bLiveEnterRoomEffect.avatarGradients = ValueObject.util_map(list3, new qcj() { // from class: l.nz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveEnterRoomEffect.m69117b((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            bLiveEnterRoomEffect.videoEffectExtras = ValueObject.util_map(list4, new qcj() { // from class: l.oz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list5 != null) {
            bLiveEnterRoomEffect.dynamicEffectExtends = ValueObject.util_map(list5, new qcj() { // from class: l.pz1
                @Override // p153l.qcj
                public final Object call(Object obj) {
