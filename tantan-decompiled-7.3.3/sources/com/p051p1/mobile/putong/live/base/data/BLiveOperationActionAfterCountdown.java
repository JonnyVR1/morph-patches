...
public class BLiveOperationActionAfterCountdown extends TEnum {
    ...
    public class C12057a extends TEnumJsonAdapter<BLiveOperationActionAfterCountdown> {
    ...
    public class C12058b extends TEnumProtobufAdapter<BLiveOperationActionAfterCountdown> {
    ...
    static {
        ...
        JSON_ADAPTER = c12057a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12058b();
        c12057a.addExtJsonValue("unknown_", -1);
        c12057a.addExtJsonValue(refresh, 0);
        c12057a.addExtJsonValue("jumpToScheme", 1);
        c12057a.addExtJsonValue("close", 2);
        c12057a.addExtJsonValue(textDrawer, 3);
        c12057a.addExtJsonValue("h5Drawer", 4);
        c12057a.addExtJsonValue("none", 5);
        ...
        _BLiveOperationActionAfterCountdown = Collections.synchronizedMap(new l01());
    }
