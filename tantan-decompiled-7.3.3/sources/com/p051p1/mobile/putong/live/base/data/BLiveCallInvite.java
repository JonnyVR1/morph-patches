...
public class BLiveCallInvite extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveCallInvite> JSON_ADAPTER = new ObjectJsonAdapter<BLiveCallInvite>() { // from class: com.p1.mobile.putong.live.base.data.BLiveCallInvite.1
        ...
        public boolean parseField(BLiveCallInvite bLiveCallInvite, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "liveId":
                    ...
                    return true;
                case "id":
                    bLiveCallInvite.f45191id = jsonParser.getValueAsString();
                    return false;
                case "to":
                    bLiveCallInvite.f45192to = Converter.USER_ID.parse(jsonParser, str2);
                    return true;
                case "type":
        ...
        public void serializeFields(BLiveCallInvite bLiveCallInvite, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveCallInvite.f45191id;
            if (str != null) {
            ...
            if (bLiveCallInvite.f45192to != null) {
                jsonGenerator.writeFieldName("to");
                Converter.USER_ID.serialize(bLiveCallInvite.f45192to, jsonGenerator, true);
            }
    ...
    public BLiveCallInvite mo225055clone() {
        BLiveCallInvite bLiveCallInvite = new BLiveCallInvite();
        bLiveCallInvite.f45191id = this.f45191id;
        bLiveCallInvite.liveId = this.liveId;
        bLiveCallInvite.f45192to = this.f45192to;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45191id, bLiveCallInvite.f45191id) && ValueObject.util_equals(this.liveId, bLiveCallInvite.liveId) && ValueObject.util_equals(this.f45192to, bLiveCallInvite.f45192to) && ValueObject.util_equals(this.state, bLiveCallInvite.state) && this.rewardPoint == bLiveCallInvite.rewardPoint && ValueObject.util_equals(this.type, bLiveCallInvite.type);
    }
    ...
    public int hashCode() {
        ...
        int i2 = i * 41;
        String str = this.f45191id;
        int iHashCode = (i2 + (str != null ? str.hashCode() : 0)) * 41;
        String str2 = this.liveId;
        int iHashCode2 = (iHashCode + (str2 != null ? str2.hashCode() : 0)) * 41;
        String str3 = this.f45192to;
    ...
    public void nullCheck() {
        if (this.f45191id == null) {
            this.f45191id = "";
        }
        if (this.liveId == null) {
            this.liveId = "";
        }
        if (this.f45192to == null) {
            this.f45192to = "";
        }
        if (this.state == null) {
