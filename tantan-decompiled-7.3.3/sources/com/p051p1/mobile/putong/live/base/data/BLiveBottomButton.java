...
public class BLiveBottomButton extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveBottomButton> JSON_ADAPTER = new ObjectJsonAdapter<BLiveBottomButton>() { // from class: com.p1.mobile.putong.live.base.data.BLiveBottomButton.1
        ...
        public boolean parseField(BLiveBottomButton bLiveBottomButton, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 8:
                    ...
                    return true;
                case 9:
                    bLiveBottomButton.f45187id = jsonParser.getValueAsInt();
                    return false;
                case 10:
        ...
        public void serializeFields(BLiveBottomButton bLiveBottomButton, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", bLiveBottomButton.f45187id);
    ...
    public static /* synthetic */ Integer m68882a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m68883b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m68884c(String str) {
        return str;
    }
    ...
    public BLiveBottomButton mo225055clone() {
        BLiveBottomButton bLiveBottomButton = new BLiveBottomButton();
        bLiveBottomButton.f45187id = this.f45187id;
        ...
        if (list != null) {
            bLiveBottomButton.bubbleIds = ValueObject.util_map(list, new qcj() { // from class: l.yr1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomButton.m68882a((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveBottomButton.icon = ValueObject.util_map(list2, new qcj() { // from class: l.zr1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomButton.m68884c((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            bLiveBottomButton.labels = ValueObject.util_map(list3, new qcj() { // from class: l.as1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveBottomButton.m68883b((String) obj);
                }
            });
        }
        ...
        if (bLiveTicker != null) {
            bLiveBottomButton.ticker = bLiveTicker.mo225055clone();
        }
        BLiveButtonAnimation bLiveButtonAnimation = this.animation;
        if (bLiveButtonAnimation != null) {
            bLiveBottomButton.animation = bLiveButtonAnimation.mo225055clone();
        }
    ...
    public boolean isGiftSwitch() {
        return this.f45187id == 118;
    }

    public boolean isMsgRemind() {
        return this.f45187id == 141;
    }
