...
public class BLiveVoiceChatGroupApply extends ValueObject implements Cloneable, Serializable {
        ...
        public boolean parseField(BLiveVoiceChatGroupApply bLiveVoiceChatGroupApply, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userId":
                    ...
                    return true;
                case "id":
                    bLiveVoiceChatGroupApply.f45340id = jsonParser.getValueAsString();
                    return false;
                case "mask":
    ...
    public BLiveVoiceChatGroupApply mo225055clone() {
        BLiveVoiceChatGroupApply bLiveVoiceChatGroupApply = new BLiveVoiceChatGroupApply();
        bLiveVoiceChatGroupApply.f45340id = this.f45340id;
        bLiveVoiceChatGroupApply.userId = this.userId;
        BLiveUserMask bLiveUserMask = this.mask;
        if (bLiveUserMask != null) {
            bLiveVoiceChatGroupApply.mask = bLiveUserMask.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45340id, bLiveVoiceChatGroupApply.f45340id) && ValueObject.util_equals(this.userId, bLiveVoiceChatGroupApply.userId) && ValueObject.util_equals(this.mask, bLiveVoiceChatGroupApply.mask) && ValueObject.util_equals(this.status, bLiveVoiceChatGroupApply.status);
    }
