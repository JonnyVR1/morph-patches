...
public class BLive extends BLiveAbsData implements Cloneable, Serializable {
        ...
        public boolean parseField(BLive bLive, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 14:
                    ...
                    return true;
                case 15:
                    bLive.f45171id = jsonParser.getValueAsString();
                    return false;
                case 16:
    ...
    public static /* synthetic */ String m68843d(String str) {
        return str;
    }
    ...
    public BLive mo225055clone() {
        BLive bLive = new BLive();
        bLive.f45171id = this.f45171id;
        BLiveOwner bLiveOwner = this.room;
        if (bLiveOwner != null) {
            bLive.room = bLiveOwner.mo225055clone();
        }
        BLiveOwner bLiveOwner2 = this.anchor;
        if (bLiveOwner2 != null) {
            bLive.anchor = bLiveOwner2.mo225055clone();
        }
        BLiveRecommendInfo bLiveRecommendInfo = this.recommendInfo;
        if (bLiveRecommendInfo != null) {
            bLive.recommendInfo = bLiveRecommendInfo.mo225055clone();
        }
        bLive.state = this.state;
        List<BLiveSuggestLabel> list = this.basicLabels;
        if (list != null) {
            bLive.basicLabels = ValueObject.util_map(list, new qcj() { // from class: l.wq1
                @Override // p153l.qcj
        ...
        if (media != null) {
            bLive.videoCapture = media.mo225055clone();
        }
        ...
        if (bLiveStreamCdnInfo != null) {
            bLive.streamCdnInfo = bLiveStreamCdnInfo.mo225055clone();
        }
        BLiveStreamUrl bLiveStreamUrl = this.streamUrl;
        if (bLiveStreamUrl != null) {
            bLive.streamUrl = bLiveStreamUrl.mo225055clone();
        }
        ...
        if (list2 != null) {
            bLive.specialLabels = ValueObject.util_map(list2, new qcj() { // from class: l.xq1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveSuggestLabel) obj).mo225055clone();
                }
        ...
        if (list3 != null) {
            bLive.redPacketIds = ValueObject.util_map(list3, new qcj() { // from class: l.yq1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLive.m68843d((String) obj);
                }
            });
        }
        BLivePkInfo bLivePkInfo = this.pkInfo;
        if (bLivePkInfo != null) {
            bLive.pkInfo = bLivePkInfo.mo225055clone();
        }
        BLiveVideoQualityConf bLiveVideoQualityConf = this.videoQualityConf;
        if (bLiveVideoQualityConf != null) {
            bLive.videoQualityConf = bLiveVideoQualityConf.mo225055clone();
        }
        BLiveCallInfo bLiveCallInfo = this.callInfo;
        if (bLiveCallInfo != null) {
            bLive.callInfo = bLiveCallInfo.mo225055clone();
        }
        BLiveRtcInfo bLiveRtcInfo = this.rtcInfo;
        if (bLiveRtcInfo != null) {
            bLive.rtcInfo = bLiveRtcInfo.mo225055clone();
        }
        ...
        if (bLiveMultiCallInfo != null) {
            bLive.multiCallInfo = bLiveMultiCallInfo.mo225055clone();
        }
        ...
        if (bLiveOfficialShowCurrentAnchorInfo != null) {
            bLive.officialShowCurrentAnchorInfo = bLiveOfficialShowCurrentAnchorInfo.mo225055clone();
        }
        BLiveOfficialShowInfo bLiveOfficialShowInfo = this.officialShowLiveInfo;
        if (bLiveOfficialShowInfo != null) {
            bLive.officialShowLiveInfo = bLiveOfficialShowInfo.mo225055clone();
        }
        return bLive;
    }
    ...
    public boolean isMultiCall() {
        return NullChecker.m82486a(this.multiCallInfo) && this.multiCallInfo.onGoing;
    }
