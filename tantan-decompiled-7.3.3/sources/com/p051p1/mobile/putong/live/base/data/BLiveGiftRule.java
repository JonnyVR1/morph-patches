...
public class BLiveGiftRule extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Integer m69174b(Integer num) {
        return num;
    }
    ...
    public BLiveGiftRule mo225055clone() {
        BLiveGiftRule bLiveGiftRule = new BLiveGiftRule();
        bLiveGiftRule.action = this.action;
        bLiveGiftRule.scheme = this.scheme;
        List<Integer> list = this.combosHitNums;
        if (list != null) {
            bLiveGiftRule.combosHitNums = ValueObject.util_map(list, new qcj() { // from class: l.y02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveGiftRule.m69174b((Integer) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveGiftRule.expirationInfos = ValueObject.util_map(list2, new qcj() { // from class: l.z02
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list3 != null) {
            bLiveGiftRule.combosGears = ValueObject.util_map(list3, new qcj() { // from class: l.a12
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveGiftCombosGears) obj).mo225055clone();
                }
            });
        }
