...
public class VoiceLiveMode extends TEnum {
    ...
    public class C12612a extends TEnumJsonAdapter<VoiceLiveMode> {
    ...
    public class C12613b extends TEnumProtobufAdapter<VoiceLiveMode> {
    ...
    static {
        C12612a c12612a = new C12612a();
        JSON_ADAPTER = c12612a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12613b();
        c12612a.addExtJsonValue("unknown_", -1);
        supportEnum.add("normal");
        supportEnum.add("auction");
        _VoiceLiveMode = Collections.synchronizedMap(new l01());
    }
