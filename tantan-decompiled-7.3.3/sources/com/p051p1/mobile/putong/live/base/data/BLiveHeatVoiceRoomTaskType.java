...
public class BLiveHeatVoiceRoomTaskType extends TEnum {
    ...
    public class C11909a extends TEnumJsonAdapter<BLiveHeatVoiceRoomTaskType> {
    ...
    public class C11910b extends TEnumProtobufAdapter<BLiveHeatVoiceRoomTaskType> {
    ...
    static {
        ...
        JSON_ADAPTER = c11909a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11910b();
        c11909a.addExtJsonValue("unknown_", -1);
        ...
        _BLiveHeatVoiceRoomTaskType = Collections.synchronizedMap(new l01());
    }
