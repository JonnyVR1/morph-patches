...
public class BLiveActivitySummary extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveActivitySummary> JSON_ADAPTER = new ObjectJsonAdapter<BLiveActivitySummary>() { // from class: com.p1.mobile.putong.live.base.data.BLiveActivitySummary.1
        ...
        public boolean parseField(BLiveActivitySummary bLiveActivitySummary, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "cardLives":
                    ...
                    return true;
                case "id":
                    bLiveActivitySummary.f45176id = jsonParser.getValueAsInt();
                    return false;
                case "type":
        ...
        public void serializeFields(BLiveActivitySummary bLiveActivitySummary, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", bLiveActivitySummary.f45176id);
    ...
    public static /* synthetic */ String m68849a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m68850b(String str) {
        return str;
    }
    ...
    public BLiveActivitySummary mo225055clone() {
        BLiveActivitySummary bLiveActivitySummary = new BLiveActivitySummary();
        bLiveActivitySummary.f45176id = this.f45176id;
        BLiveActivityDesc bLiveActivityDesc = this.description;
        if (bLiveActivityDesc != null) {
            bLiveActivitySummary.description = bLiveActivityDesc.mo225055clone();
        }
        BLiveActivitySummaryCounters bLiveActivitySummaryCounters = this.counters;
        if (bLiveActivitySummaryCounters != null) {
            bLiveActivitySummary.counters = bLiveActivitySummaryCounters.mo225055clone();
        }
        List<String> list = this.ongoingLiveIds;
        if (list != null) {
            bLiveActivitySummary.ongoingLiveIds = ValueObject.util_map(list, new qcj() { // from class: l.dr1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveActivitySummary.m68850b((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveActivitySummary.icons = ValueObject.util_map(list2, new qcj() { // from class: l.er1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveActivitySummary.m68849a((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            bLiveActivitySummary.cardLives = ValueObject.util_map(list3, new qcj() { // from class: l.fr1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveActivityCardLive) obj).mo225055clone();
                }
            });
        }
        return bLiveActivitySummary;
