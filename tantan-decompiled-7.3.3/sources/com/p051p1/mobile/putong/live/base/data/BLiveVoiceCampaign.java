...
public class BLiveVoiceCampaign extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVoiceCampaign> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceCampaign>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceCampaign.1
        ...
        public boolean parseField(BLiveVoiceCampaign bLiveVoiceCampaign, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "entranceUrl":
                    ...
                    return true;
                case "id":
                    bLiveVoiceCampaign.f45338id = jsonParser.getValueAsString();
                    return false;
                case "campaignType":
        ...
        public void serializeFields(BLiveVoiceCampaign bLiveVoiceCampaign, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoiceCampaign.f45338id;
            if (str != null) {
    ...
    public static /* synthetic */ Integer m69534a(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Integer m69535b(Integer num) {
        return num;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ Integer m69536c(Integer num) {
        return num;
    }
    ...
    public BLiveVoiceCampaign mo225055clone() {
        BLiveVoiceCampaign bLiveVoiceCampaign = new BLiveVoiceCampaign();
        bLiveVoiceCampaign.f45338id = this.f45338id;
        ...
        if (list != null) {
            bLiveVoiceCampaign.entranceSize = ValueObject.util_map(list, new qcj() { // from class: l.m82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceCampaign.m69535b((Integer) obj);
                }
            });
        }
        List<Integer> list2 = this.detailInset;
        if (list2 != null) {
            bLiveVoiceCampaign.detailInset = ValueObject.util_map(list2, new qcj() { // from class: l.n82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceCampaign.m69536c((Integer) obj);
                }
            });
        }
        List<Integer> list3 = this.validPeriod;
        if (list3 != null) {
            bLiveVoiceCampaign.validPeriod = ValueObject.util_map(list3, new qcj() { // from class: l.o82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceCampaign.m69534a((Integer) obj);
                }
            });
        }
