...
public class BLiveBoardGuard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BLiveBoardGuard> PROTOBUF_ADAPTER = new C11670a();
    ...
    public class C11670a extends MessageNanoAdapter<BLiveBoardGuard> {
        public C11670a() {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(BLiveBoardGuard bLiveBoardGuard) {
            ...
            bLiveBoardGuard.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
        public BLiveBoardGuard parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bLiveBoardGuard.name = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    bLiveBoardGuard.userId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    bLiveBoardGuard.userAvatar = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    bLiveBoardGuard.userAvatarFrame = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (bLiveBoardGuard.name == null) {
                            bLiveBoardGuard.name = "";
                    ...
                    bLiveBoardGuard.schema = nc5Var.m162495s();
                }
            }
            return bLiveBoardGuard;
        }
    ...
    public BLiveBoardGuard mo225055clone() {
        BLiveBoardGuard bLiveBoardGuard = new BLiveBoardGuard();
