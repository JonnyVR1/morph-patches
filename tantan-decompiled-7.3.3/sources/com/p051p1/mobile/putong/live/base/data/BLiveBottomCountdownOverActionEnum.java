...
public class BLiveBottomCountdownOverActionEnum extends TEnum {
    ...
    public class C11684a extends TEnumJsonAdapter<BLiveBottomCountdownOverActionEnum> {
    ...
    public class C11685b extends TEnumProtobufAdapter<BLiveBottomCountdownOverActionEnum> {
    ...
    static {
        C11684a c11684a = new C11684a();
        JSON_ADAPTER = c11684a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C11685b();
        c11684a.addExtJsonValue("unknown_", -1);
        supportEnum.add("none");
        supportEnum.add(buttonLightUp);
        supportEnum.add(buttonLightDown);
        _BLiveBottomCountdownOverActionEnum = Collections.synchronizedMap(new l01());
    }
