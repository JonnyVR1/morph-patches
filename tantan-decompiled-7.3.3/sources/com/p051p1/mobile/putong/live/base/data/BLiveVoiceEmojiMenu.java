...
public class BLiveVoiceEmojiMenu extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveVoiceEmojiMenu mo225055clone() {
        BLiveVoiceEmojiMenu bLiveVoiceEmojiMenu = new BLiveVoiceEmojiMenu();
        ...
        if (list != null) {
            bLiveVoiceEmojiMenu.buttons = ValueObject.util_map(list, new qcj() { // from class: l.u82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceEmojiMenuButton) obj).mo225055clone();
                }
            });
        }
        return bLiveVoiceEmojiMenu;
