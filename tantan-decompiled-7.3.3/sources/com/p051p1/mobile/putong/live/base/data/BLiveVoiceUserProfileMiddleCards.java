...
public class BLiveVoiceUserProfileMiddleCards extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69646a(String str) {
        return str;
    }
    ...
    public BLiveVoiceUserProfileMiddleCards mo225055clone() {
        BLiveVoiceUserProfileMiddleCards bLiveVoiceUserProfileMiddleCards = new BLiveVoiceUserProfileMiddleCards();
        ...
        if (list != null) {
            bLiveVoiceUserProfileMiddleCards.avatars = ValueObject.util_map(list, new qcj() { // from class: l.sa2
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceUserProfileMiddleCards.m69646a((String) obj);
                }
            });
        }
