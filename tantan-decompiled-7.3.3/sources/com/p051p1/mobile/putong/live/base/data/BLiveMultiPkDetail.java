...
public class BLiveMultiPkDetail extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveMultiPkDetail> JSON_ADAPTER = new ObjectJsonAdapter<BLiveMultiPkDetail>() { // from class: com.p1.mobile.putong.live.base.data.BLiveMultiPkDetail.1
        ...
        public boolean parseField(BLiveMultiPkDetail bLiveMultiPkDetail, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "players":
                    ...
                    return true;
                case "id":
                    bLiveMultiPkDetail.f45255id = jsonParser.getValueAsString();
                    return false;
                case "stage":
        ...
        public void serializeFields(BLiveMultiPkDetail bLiveMultiPkDetail, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveMultiPkDetail.f45255id;
            if (str != null) {
    ...
    public BLiveMultiPkDetail mo225055clone() {
        BLiveMultiPkDetail bLiveMultiPkDetail = new BLiveMultiPkDetail();
        bLiveMultiPkDetail.f45255id = this.f45255id;
        ...
        if (list != null) {
            bLiveMultiPkDetail.players = ValueObject.util_map(list, new qcj() { // from class: l.g32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveMultiPkPlayer) obj).mo225055clone();
                }
            });
        }
        return bLiveMultiPkDetail;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45255id, bLiveMultiPkDetail.f45255id) && ValueObject.util_equals(this.stage, bLiveMultiPkDetail.stage) && this.startTs == bLiveMultiPkDetail.startTs && this.duration == bLiveMultiPkDetail.duration && ValueObject.util_equals(this.winnerUserId, bLiveMultiPkDetail.winnerUserId) && ValueObject.util_equals(this.players, bLiveMultiPkDetail.players);
    }
