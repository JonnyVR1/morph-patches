...
public class BLiveHourLeaderBoard extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveHourLeaderBoard mo225055clone() {
        BLiveHourLeaderBoard bLiveHourLeaderBoard = new BLiveHourLeaderBoard();
        List<BLiveHourLeaderBoardItem> list = this.currentRoomLeaderboards;
        if (list != null) {
            bLiveHourLeaderBoard.currentRoomLeaderboards = ValueObject.util_map(list, new qcj() { // from class: l.o12
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            bLiveHourLeaderBoard.allLeaderboards = ValueObject.util_map(list2, new qcj() { // from class: l.p12
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveHourLeaderBoardItem) obj).mo225055clone();
                }
        ...
        if (list3 != null) {
            bLiveHourLeaderBoard.notices = ValueObject.util_map(list3, new qcj() { // from class: l.q12
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (bLiveCurrentHourSuggestConfig != null) {
            bLiveHourLeaderBoard.currentHourSuggestConfig = bLiveCurrentHourSuggestConfig.mo225055clone();
        }
        BLiveHourLeaderBoardBattle bLiveHourLeaderBoardBattle = this.hourLeaderboardBattle;
        if (bLiveHourLeaderBoardBattle != null) {
            bLiveHourLeaderBoard.hourLeaderboardBattle = bLiveHourLeaderBoardBattle.mo225055clone();
        }
        return bLiveHourLeaderBoard;
    }
