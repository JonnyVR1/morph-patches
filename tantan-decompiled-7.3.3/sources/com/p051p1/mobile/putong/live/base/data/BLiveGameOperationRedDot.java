...
public class BLiveGameOperationRedDot extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69149a(String str) {
        return str;
    }
    ...
    public BLiveGameOperationRedDot mo225055clone() {
        BLiveGameOperationRedDot bLiveGameOperationRedDot = new BLiveGameOperationRedDot();
        List<String> list = this.data;
        if (list != null) {
            bLiveGameOperationRedDot.data = ValueObject.util_map(list, new qcj() { // from class: l.j02
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveGameOperationRedDot.m69149a((String) obj);
                }
            });
        }
        return bLiveGameOperationRedDot;
