...
public class BLiveVoiceRoomAsset extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69613a(String str) {
        return str;
    }
    ...
    public BLiveVoiceRoomAsset mo225055clone() {
        BLiveVoiceRoomAsset bLiveVoiceRoomAsset = new BLiveVoiceRoomAsset();
        List<BLiveVoiceGuideTemplate> list = this.templates;
        if (list != null) {
            bLiveVoiceRoomAsset.templates = ValueObject.util_map(list, new qcj() { // from class: l.r92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceGuideTemplate) obj).mo225055clone();
                }
            });
        }
        List<String> list2 = this.tips;
        if (list2 != null) {
            bLiveVoiceRoomAsset.tips = ValueObject.util_map(list2, new qcj() { // from class: l.s92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveVoiceRoomAsset.m69613a((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            bLiveVoiceRoomAsset.startPageTemplates = ValueObject.util_map(list3, new qcj() { // from class: l.t92
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveStartPageTemplate) obj).mo225055clone();
                }
            });
        }
        return bLiveVoiceRoomAsset;
