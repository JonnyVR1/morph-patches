...
public class BLiveState extends TEnum {
    ...
    public class C12259a extends TEnumJsonAdapter<BLiveState> {
    ...
    public class C12260b extends TEnumProtobufAdapter<BLiveState> {
    ...
    static {
        ...
        c12259a.addExtJsonValue("onlive", 0);
        c12259a.addExtJsonValue("suspended", 1);
        c12259a.addExtJsonValue("stopped", 2);
        c12259a.addExtJsonValue("born", 3);
        supportEnum.add("onlive");
        supportEnum.add("suspended");
        supportEnum.add("stopped");
        supportEnum.add("born");
        supportEnum.add("preparing");
        _BLiveState = Collections.synchronizedMap(new l01());
    }
