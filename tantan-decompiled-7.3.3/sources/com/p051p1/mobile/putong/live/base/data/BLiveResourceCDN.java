...
public class BLiveResourceCDN extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69373a(String str) {
        return str;
    }
    ...
    public BLiveResourceCDN mo225055clone() {
        BLiveResourceCDN bLiveResourceCDN = new BLiveResourceCDN();
        ...
        if (list != null) {
            bLiveResourceCDN.loadTypes = ValueObject.util_map(list, new qcj() { // from class: l.b52
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveResourceCDN.m69373a((String) obj);
                }
            });
        }
        BLiveResourceCDNLoadTypeItem bLiveResourceCDNLoadTypeItem = this.loadResourceIdsMap;
        if (bLiveResourceCDNLoadTypeItem != null) {
            bLiveResourceCDN.loadResourceIdsMap = bLiveResourceCDNLoadTypeItem.mo225055clone();
        }
