...
public final class C12633c {
    ...
    @Nullable
    public mi80 curPoint;

    public C12633c(@NotNull Src src) {
        src.getClass();
        this.id = "";
    ...
    public final void m69885b(@Nullable mi80 mi80Var) {
        this.curPoint = mi80Var;
    }
}
