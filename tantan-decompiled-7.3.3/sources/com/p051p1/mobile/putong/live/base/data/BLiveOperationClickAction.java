...
public class BLiveOperationClickAction extends TEnum {
    ...
    public static final String f45265h5 = "h5";
    ...
    public class C12063a extends TEnumJsonAdapter<BLiveOperationClickAction> {
    ...
    public class C12064b extends TEnumProtobufAdapter<BLiveOperationClickAction> {
    ...
    static {
        C12063a c12063a = new C12063a();
        JSON_ADAPTER = c12063a;
        supportEnum = new HashSet<>();
        PROTOBUF_ADAPTER = new C12064b();
        c12063a.addExtJsonValue("unknown_", -1);
        c12063a.addExtJsonValue(f45265h5, 0);
        c12063a.addExtJsonValue(scheme, 1);
        supportEnum.add(f45265h5);
        supportEnum.add(scheme);
        _BLiveOperationClickAction = Collections.synchronizedMap(new l01());
    }
