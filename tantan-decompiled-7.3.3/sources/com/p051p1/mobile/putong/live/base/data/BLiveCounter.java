...
public class BLiveCounter extends ValueObject<BLiveCounter> implements Cloneable, Serializable {
    ...
    public BLiveCounter mo225055clone() {
        BLiveCounter bLiveCounter = new BLiveCounter();
        ...
        if (bLiveActivityCounter != null) {
            bLiveCounter.activity = bLiveActivityCounter.mo225055clone();
        }
        ...
        if (list != null) {
            bLiveCounter.voiceLiveTextRedDot = ValueObject.util_map(list, new qcj() { // from class: l.xs1
                @Override // p153l.qcj
