...
public class BLiveVoiceFeedBanners extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveVoiceFeedBanners> JSON_ADAPTER = new ObjectJsonAdapter<BLiveVoiceFeedBanners>() { // from class: com.p1.mobile.putong.live.base.data.BLiveVoiceFeedBanners.1
        ...
        public boolean parseField(BLiveVoiceFeedBanners bLiveVoiceFeedBanners, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "cardIndex":
                    ...
                    return true;
                case "id":
                    bLiveVoiceFeedBanners.f45343id = jsonParser.getValueAsString();
                    return false;
                case "tabs":
        ...
        public void serializeFields(BLiveVoiceFeedBanners bLiveVoiceFeedBanners, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveVoiceFeedBanners.f45343id;
            if (str != null) {
    ...
    public BLiveVoiceFeedBanners mo225055clone() {
        BLiveVoiceFeedBanners bLiveVoiceFeedBanners = new BLiveVoiceFeedBanners();
        bLiveVoiceFeedBanners.f45343id = this.f45343id;
        List<BLiveVoiceBannerTab> list = this.tabs;
        if (list != null) {
            bLiveVoiceFeedBanners.tabs = ValueObject.util_map(list, new qcj() { // from class: l.y82
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveVoiceBannerTab) obj).mo225055clone();
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45343id, bLiveVoiceFeedBanners.f45343id) && ValueObject.util_equals(this.tabs, bLiveVoiceFeedBanners.tabs) && ValueObject.util_equals(this.type, bLiveVoiceFeedBanners.type) && this.cardIndex == bLiveVoiceFeedBanners.cardIndex && this.duration == bLiveVoiceFeedBanners.duration;
    }
