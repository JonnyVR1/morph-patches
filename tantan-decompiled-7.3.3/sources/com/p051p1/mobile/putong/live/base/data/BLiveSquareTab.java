...
public class BLiveSquareTab extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveSquareTab> JSON_ADAPTER = new ObjectJsonAdapter<BLiveSquareTab>() { // from class: com.p1.mobile.putong.live.base.data.BLiveSquareTab.1
        ...
        public boolean parseField(BLiveSquareTab bLiveSquareTab, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "hasSearch":
                    ...
                    return true;
                case "id":
                    bLiveSquareTab.f45289id = jsonParser.getValueAsString();
                    return false;
                case "name":
        ...
        public void serializeFields(BLiveSquareTab bLiveSquareTab, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveSquareTab.f45289id;
            if (str != null) {
    ...
    public BLiveSquareTab mo225055clone() {
        BLiveSquareTab bLiveSquareTab = new BLiveSquareTab();
        bLiveSquareTab.f45289id = this.f45289id;
        ...
        if (bLiveAnchorSuggest != null) {
            bLiveSquareTab.anchorSuggest = bLiveAnchorSuggest.mo225055clone();
        }
        ...
        if (list != null) {
            bLiveSquareTab.subTabs = ValueObject.util_map(list, new qcj() { // from class: l.i62
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveSquareSubTab) obj).mo225055clone();
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45289id, bLiveSquareTab.f45289id) && ValueObject.util_equals(this.title, bLiveSquareTab.title) && ValueObject.util_equals(this.name, bLiveSquareTab.name) && this.hasBanner == bLiveSquareTab.hasBanner && ValueObject.util_equals(this.anchorSuggest, bLiveSquareTab.anchorSuggest) && this.layoutColumn == bLiveSquareTab.layoutColumn && ValueObject.util_equals(this.bannerType, bLiveSquareTab.bannerType) && this.showNearby == bLiveSquareTab.showNearby && ValueObject.util_equals(this.subTabs, bLiveSquareTab.subTabs) && ValueObject.util_equals(this.pageId, bLiveSquareTab.pageId) && this.hasSearch == bLiveSquareTab.hasSearch && this.hasActivityExposure == bLiveSquareTab.hasActivityExposure && this.hasRedDot == bLiveSquareTab.hasRedDot;
    }
