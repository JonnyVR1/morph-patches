...
public class BLiveNewGiftWallSubTab extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveNewGiftWallSubTab> JSON_ADAPTER = new ObjectJsonAdapter<BLiveNewGiftWallSubTab>() { // from class: com.p1.mobile.putong.live.base.data.BLiveNewGiftWallSubTab.1
        ...
        public boolean parseField(BLiveNewGiftWallSubTab bLiveNewGiftWallSubTab, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "progress":
                    ...
                    return true;
                case "id":
                    bLiveNewGiftWallSubTab.f45262id = jsonParser.getValueAsString();
                    return false;
                case "name":
        ...
        public void serializeFields(BLiveNewGiftWallSubTab bLiveNewGiftWallSubTab, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveNewGiftWallSubTab.f45262id;
            if (str != null) {
    ...
    public static /* synthetic */ String m69274a(String str) {
        return str;
    }
    ...
    public BLiveNewGiftWallSubTab mo225055clone() {
        BLiveNewGiftWallSubTab bLiveNewGiftWallSubTab = new BLiveNewGiftWallSubTab();
        bLiveNewGiftWallSubTab.f45262id = this.f45262id;
        ...
        if (bLiveNewGiftWallProgress != null) {
            bLiveNewGiftWallSubTab.progress = bLiveNewGiftWallProgress.mo225055clone();
        }
        List<String> list = this.giftIds;
        if (list != null) {
            bLiveNewGiftWallSubTab.giftIds = ValueObject.util_map(list, new qcj() { // from class: l.x32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveNewGiftWallSubTab.m69274a((String) obj);
                }
            });
        }
        return bLiveNewGiftWallSubTab;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45262id, bLiveNewGiftWallSubTab.f45262id) && ValueObject.util_equals(this.name, bLiveNewGiftWallSubTab.name) && ValueObject.util_equals(this.progress, bLiveNewGiftWallSubTab.progress) && ValueObject.util_equals(this.giftIds, bLiveNewGiftWallSubTab.giftIds);
    }
