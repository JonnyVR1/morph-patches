...
public final class LiveHaloAvatar extends View {
    ...
    public LiveHaloAvatar(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.fus
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LiveHaloAvatar.m69913b(this.f100939a, valueAnimatorOfFloat, valueAnimator);
            }
        });
        this.animator = valueAnimatorOfFloat;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, thc0.f174331m);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(thc0.f174334p, 0);
        this.haloSize = dimensionPixelSize;
        this.avatarSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(thc0.f174332n, 0);
        this.innerStrokeWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(thc0.f174336r, qa00.f156317d);
        this.outerStrokeWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(thc0.f174337s, qa00.f156316c);
        int color = typedArrayObtainStyledAttributes.getColor(thc0.f174335q, -38485);
        this.haloStartColor = color;
        this.haloEndColor = typedArrayObtainStyledAttributes.getColor(thc0.f174333o, -41238);
    ...
    public static final void m69913b(LiveHaloAvatar liveHaloAvatar, ValueAnimator valueAnimator, ValueAnimator valueAnimator2) {
    ...
    public final void m69914c(int haloStartColor, int haloEndColor) {
    ...
    public final void m69915d() {
        m69916e();
        this.animator.start();
    }

    /* JADX INFO: renamed from: e */
    public final void m69916e() {
