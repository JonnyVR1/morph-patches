...
public class BLiveMultiCallExtend extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveMultiCallExtend mo225055clone() {
        BLiveMultiCallExtend bLiveMultiCallExtend = new BLiveMultiCallExtend();
        ...
        if (list != null) {
            bLiveMultiCallExtend.users = ValueObject.util_map(list, new qcj() { // from class: l.e32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveMultiCallExtendUser) obj).mo225055clone();
                }
            });
        }
