...
public class BLiveFanBase extends ValueObject implements Cloneable, Serializable {
    ...
    public BLiveFanBase mo225055clone() {
        BLiveFanBase bLiveFanBase = new BLiveFanBase();
        bLiveFanBase.f45211id = this.f45211id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45211id, bLiveFanBase.f45211id) && ValueObject.util_equals(this.anchorId, bLiveFanBase.anchorId);
    }
