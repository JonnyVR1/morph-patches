...
import com.p051p1.mobile.putong.live.base.data.BLiveButtonConfig;
...
public class BLiveMonetizationConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m69247a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m69249c(String str) {
        return str;
    }
    ...
    public BLiveMonetizationConfig mo225055clone() {
        BLiveMonetizationConfig bLiveMonetizationConfig = new BLiveMonetizationConfig();
        bLiveMonetizationConfig.isPaidUser = this.isPaidUser;
        List<BLiveBubbleConfig> list = this.bubbleConfigs;
        if (list != null) {
            bLiveMonetizationConfig.bubbleConfigs = ValueObject.util_map(list, new qcj() { // from class: l.z22
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveBubbleConfig) obj).mo225055clone();
                }
            });
        }
        ...
        if (list2 != null) {
            bLiveMonetizationConfig.buttonConfigs = ValueObject.util_map(list2, new qcj() { // from class: l.a32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveButtonConfig) obj).mo225055clone();
                }
            });
        }
        BLiveToolBar bLiveToolBar = this.toolBar;
        if (bLiveToolBar != null) {
            bLiveMonetizationConfig.toolBar = bLiveToolBar.mo225055clone();
        }
        List<String> list3 = this.anchorBubblePriority;
        if (list3 != null) {
            bLiveMonetizationConfig.anchorBubblePriority = ValueObject.util_map(list3, new qcj() { // from class: l.b32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveMonetizationConfig.m69247a((String) obj);
                }
            });
        }
        List<String> list4 = this.audienceBubblePriority;
        if (list4 != null) {
            bLiveMonetizationConfig.audienceBubblePriority = ValueObject.util_map(list4, new qcj() { // from class: l.c32
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveMonetizationConfig.m69249c((String) obj);
                }
            });
        }
