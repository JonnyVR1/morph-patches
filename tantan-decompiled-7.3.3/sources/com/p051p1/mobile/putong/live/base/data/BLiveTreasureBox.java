...
public class BLiveTreasureBox extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ Double m69463a(Double d) {
        return d;
    }
    ...
    public BLiveTreasureBox mo225055clone() {
        BLiveTreasureBox bLiveTreasureBox = new BLiveTreasureBox();
        ...
        if (bubbleIdsConfig != null) {
            bLiveTreasureBox.bubbleIdsConfig = bubbleIdsConfig.mo225055clone();
        }
        List<Double> list = this.detailInset;
        if (list != null) {
            bLiveTreasureBox.detailInset = ValueObject.util_map(list, new qcj() { // from class: l.g72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveTreasureBox.m69463a((Double) obj);
                }
            });
        }
