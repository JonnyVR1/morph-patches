...
public class BLiveChatMangerSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68927a(String str) {
        return str;
    }
    ...
    public BLiveChatMangerSettings mo225055clone() {
        BLiveChatMangerSettings bLiveChatMangerSettings = new BLiveChatMangerSettings();
        bLiveChatMangerSettings.jailedType = this.jailedType;
        List<String> list = this.shieldingWords;
        if (list != null) {
            bLiveChatMangerSettings.shieldingWords = ValueObject.util_map(list, new qcj() { // from class: l.qs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveChatMangerSettings.m68927a((String) obj);
                }
            });
        }
