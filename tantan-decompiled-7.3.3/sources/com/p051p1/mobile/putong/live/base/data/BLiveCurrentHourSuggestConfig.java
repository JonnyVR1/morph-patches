...
public class BLiveCurrentHourSuggestConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m68945a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ Long m68946b(Long l2) {
        return l2;
    }
    ...
    public BLiveCurrentHourSuggestConfig mo225055clone() {
        BLiveCurrentHourSuggestConfig bLiveCurrentHourSuggestConfig = new BLiveCurrentHourSuggestConfig();
        ...
        if (list != null) {
            bLiveCurrentHourSuggestConfig.nodes = ValueObject.util_map(list, new qcj() { // from class: l.zs1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveCurrentHourSuggestConfig.m68946b((Long) obj);
                }
            });
        }
        List<String> list2 = this.scrollTexts;
        if (list2 != null) {
            bLiveCurrentHourSuggestConfig.scrollTexts = ValueObject.util_map(list2, new qcj() { // from class: l.at1
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BLiveCurrentHourSuggestConfig.m68945a((String) obj);
                }
            });
        }
        return bLiveCurrentHourSuggestConfig;
