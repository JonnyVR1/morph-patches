...
public class BLiveUpgradeGiftInfo extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveUpgradeGiftInfo> JSON_ADAPTER = new ObjectJsonAdapter<BLiveUpgradeGiftInfo>() { // from class: com.p1.mobile.putong.live.base.data.BLiveUpgradeGiftInfo.1
        ...
        public boolean parseField(BLiveUpgradeGiftInfo bLiveUpgradeGiftInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "giftLevels":
                    ...
                    return true;
                case "id":
                    bLiveUpgradeGiftInfo.f45313id = jsonParser.getValueAsString();
                    return false;
                case "name":
        ...
        public void serializeFields(BLiveUpgradeGiftInfo bLiveUpgradeGiftInfo, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveUpgradeGiftInfo.f45313id;
            if (str != null) {
    ...
    public BLiveUpgradeGiftInfo mo225055clone() {
        BLiveUpgradeGiftInfo bLiveUpgradeGiftInfo = new BLiveUpgradeGiftInfo();
        bLiveUpgradeGiftInfo.f45313id = this.f45313id;
        ...
        if (list != null) {
            bLiveUpgradeGiftInfo.giftLevels = ValueObject.util_map(list, new qcj() { // from class: l.n72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveUpgradeGiftResLevel) obj).mo225055clone();
                }
            });
        }
        List<BLiveUpgradeGiftInfoItem> list2 = this.slotGiftInfos;
        if (list2 != null) {
            bLiveUpgradeGiftInfo.slotGiftInfos = ValueObject.util_map(list2, new qcj() { // from class: l.o72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveUpgradeGiftInfoItem) obj).mo225055clone();
                }
            });
        }
        BLiveUpgradeGiftRule bLiveUpgradeGiftRule = this.rule;
        if (bLiveUpgradeGiftRule != null) {
            bLiveUpgradeGiftInfo.rule = bLiveUpgradeGiftRule.mo225055clone();
        }
        List<BLiveUpgradeGiftActInfo> list3 = this.activityInfos;
        if (list3 != null) {
            bLiveUpgradeGiftInfo.activityInfos = ValueObject.util_map(list3, new qcj() { // from class: l.p72
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((BLiveUpgradeGiftActInfo) obj).mo225055clone();
                }
            });
        }
        return bLiveUpgradeGiftInfo;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45313id, bLiveUpgradeGiftInfo.f45313id) && ValueObject.util_equals(this.name, bLiveUpgradeGiftInfo.name) && ValueObject.util_equals(this.storeName, bLiveUpgradeGiftInfo.storeName) && ValueObject.util_equals(this.type, bLiveUpgradeGiftInfo.type) && ValueObject.util_equals(this.giftLevels, bLiveUpgradeGiftInfo.giftLevels) && ValueObject.util_equals(this.slotGiftInfos, bLiveUpgradeGiftInfo.slotGiftInfos) && ValueObject.util_equals(this.rule, bLiveUpgradeGiftInfo.rule) && ValueObject.util_equals(this.activityInfos, bLiveUpgradeGiftInfo.activityInfos);
    }
