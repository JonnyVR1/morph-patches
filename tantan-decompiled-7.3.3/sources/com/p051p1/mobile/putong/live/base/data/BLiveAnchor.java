...
public class BLiveAnchor extends ValueObject implements Cloneable, Serializable {
    public static JsonAdapter<BLiveAnchor> JSON_ADAPTER = new ObjectJsonAdapter<BLiveAnchor>() { // from class: com.p1.mobile.putong.live.base.data.BLiveAnchor.1
        ...
        public boolean parseField(BLiveAnchor bLiveAnchor, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "pkRecommendSource":
                    ...
                    return true;
                case "id":
                    bLiveAnchor.f45179id = jsonParser.getValueAsString();
                    return false;
                case "room":
        ...
        public void serializeFields(BLiveAnchor bLiveAnchor, JsonGenerator jsonGenerator) throws IOException {
            String str = bLiveAnchor.f45179id;
            if (str != null) {
    ...
    public BLiveAnchor mo225055clone() {
        BLiveAnchor bLiveAnchor = new BLiveAnchor();
        bLiveAnchor.f45179id = this.f45179id;
        ...
        if (bLiveAnchorData != null) {
            bLiveAnchor.liveData = bLiveAnchorData.mo225055clone();
        }
        BLiveReward bLiveReward = this.reward;
        if (bLiveReward != null) {
            bLiveAnchor.reward = bLiveReward.mo225055clone();
        }
        BLiveOwner bLiveOwner = this.room;
        if (bLiveOwner != null) {
            bLiveAnchor.room = bLiveOwner.mo225055clone();
        }
        BLiveAnchorSetting bLiveAnchorSetting = this.liveSetting;
        if (bLiveAnchorSetting != null) {
            bLiveAnchor.liveSetting = bLiveAnchorSetting.mo225055clone();
        }
        ...
        if (bLiveMultiCallInfo != null) {
            bLiveAnchor.multiCallInfo = bLiveMultiCallInfo.mo225055clone();
        }
        return bLiveAnchor;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f45179id, bLiveAnchor.f45179id) && ValueObject.util_equals(this.status, bLiveAnchor.status) && this.availableTime == bLiveAnchor.availableTime && ValueObject.util_equals(this.type, bLiveAnchor.type) && ValueObject.util_equals(this.liveData, bLiveAnchor.liveData) && ValueObject.util_equals(this.reward, bLiveAnchor.reward) && ValueObject.util_equals(this.room, bLiveAnchor.room) && ValueObject.util_equals(this.liveSetting, bLiveAnchor.liveSetting) && this.isPking == bLiveAnchor.isPking && ValueObject.util_equals(this.pkRecommendSource, bLiveAnchor.pkRecommendSource) && ValueObject.util_equals(this.multiCallInfo, bLiveAnchor.multiCallInfo);
    }
