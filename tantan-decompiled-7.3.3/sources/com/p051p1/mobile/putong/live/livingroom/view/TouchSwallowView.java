...
public class TouchSwallowView extends FrameLayout {
    ...
    /* JADX INFO: renamed from: a */
    public final boolean m77837a(View view) {
        if (view == 0 || view.getVisibility() != 0) {
            return true;
        }
        return (view instanceof h7m) && ((h7m) view).m133804a();
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (getChildCount() == 0 || getChildAt(0) == null || m77837a(getChildAt(0))) {
            return super.dispatchTouchEvent(motionEvent);
        }
        if (this.f52942a != null) {
            int action = motionEvent.getAction();
            if (action == 0 || action == 2) {
                this.f52942a.requestDisallowInterceptTouchEvent(true);
            } else {
                this.f52942a.requestDisallowInterceptTouchEvent(false);
            }
        }
        return super.dispatchTouchEvent(motionEvent);
    }
