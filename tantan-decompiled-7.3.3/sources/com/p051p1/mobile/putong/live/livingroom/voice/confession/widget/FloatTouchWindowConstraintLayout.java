package com.p051p1.mobile.putong.live.livingroom.voice.confession.widget;
...
public final class FloatTouchWindowConstraintLayout extends ConstraintLayout {
    ...
    @Nullable
    public InterfaceC13176b listener;

    /* JADX INFO: renamed from: com.p1.mobile.putong.live.livingroom.voice.confession.widget.FloatTouchWindowConstraintLayout$b */
    @Metadata(m88120d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007À\u0006\u0003"}, m88121d2 = {"Lcom/p1/mobile/putong/live/livingroom/voice/confession/widget/FloatTouchWindowConstraintLayout$b;", "", "", "isScrollUp", "", "a", "(Z)V", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public interface InterfaceC13176b {
        /* JADX INFO: renamed from: a */
        void mo79243a(boolean isScrollUp);
    }
    ...
    public boolean onInterceptTouchEvent(@NotNull MotionEvent event) {
        ...
        if (action == 0) {
            ...
            if (rawY > qa00.m175859d(5.0f) || Math.abs(rawY) > qa00.m175859d(5.0f)) {
                return true;
            }
        }
    ...
    public boolean onTouchEvent(@NotNull MotionEvent event) {
        ...
        InterfaceC13176b interfaceC13176b2;
        event.getClass();
        int action = event.getAction();
        if (action == 1 || action == 3) {
            float rawY = this.downY - event.getRawY();
            if (rawY > qa00.m175859d(5.0f) && (interfaceC13176b2 = this.listener) != null) {
                interfaceC13176b2.mo79243a(true);
                return true;
            }
            if (Math.abs(rawY) > qa00.m175859d(5.0f) && (interfaceC13176b = this.listener) != null) {
                interfaceC13176b.mo79243a(false);
                return true;
            }
        }
    ...
    public final void setFloatTouchWindowListener(@NotNull InterfaceC13176b floatTouchWindowListener) {
