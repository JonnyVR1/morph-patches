package com.p051p1.mobile.putong.live.livingroom.voice.membermanager.requestmic;
...
public final class MemberRequestMicPageView extends ConstraintLayout {
    ...
    public static final class Companion {
        ...
        public final MemberRequestMicPageView m79835a(@NotNull LayoutInflater inflater) {
            inflater.getClass();
            View viewInflate = inflater.inflate(yec0.f198923T3, (ViewGroup) null, false);
    ...
    @SourceDebugExtension
    public static final class C13209b implements Animator.AnimatorListener {

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ boolean f54580b;

        public C13209b(boolean z) {
            this.f54580b = z;
        }
        ...
        public void onAnimationEnd(@NotNull Animator animator) {
            animator.getClass();
            MemberRequestMicPageView.this.get_point_bg().setBackground(n3d0.m161278b(this.f54580b ? obc0.f146381j7 : obc0.f146369i7));
            MemberRequestMicPageView.this.get_round_point().setBackground(n3d0.m161278b(this.f54580b ? obc0.f146405l7 : obc0.f146393k7));
        }
    ...
    public static void m79828h0(lmy lmyVar, MemberRequestMicPageView memberRequestMicPageView, View view) {
        lmyVar.m154938v4(!memberRequestMicPageView.switchIsOpen);
    }

    @JvmStatic
    @NotNull
    /* JADX INFO: renamed from: j0 */
    public static final MemberRequestMicPageView m79829j0(@NotNull LayoutInflater layoutInflater) {
        return INSTANCE.m79835a(layoutInflater);
    }

    /* JADX INFO: renamed from: m0 */
    private final void m79830m0(boolean isOpen) {
        Property property = View.TRANSLATION_X;
        ObjectAnimator objectAnimatorOfFloat = isOpen ? ObjectAnimator.ofFloat(get_round_point(), (Property<View, Float>) property, 0.0f, qa00.m175859d(16.0f)) : ObjectAnimator.ofFloat(get_round_point(), (Property<View, Float>) property, qa00.m175859d(16.0f), 0.0f);
        ...
        objectAnimatorOfFloat.addListener(new C13209b(isOpen));
    ...
    public final ConstraintLayout get_free_call_container() {
        ...
        Intrinsics.m88391r("_free_call_container");
        return null;
    }
    ...
    public final void m79831i0(View view) {
        rly.m182035a(this, view);
    }

    /* JADX INFO: renamed from: k0 */
    public final void m79832k0(@Nullable LiveBaseAdapter adapter) {
    ...
    public final void m79833l0(@Nullable LiveBaseAdapter adapter, @NotNull final lmy<rwn0, ply> presenter) {
        presenter.getClass();
        m79832k0(adapter);
        bnl0.m105509E0(get_switch_open(), new View.OnClickListener() { // from class: l.qly
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MemberRequestMicPageView.m79828h0(presenter, this, view);
            }
        });
    }

    /* JADX INFO: renamed from: n0 */
    public final void m79834n0(boolean isOpen) {
