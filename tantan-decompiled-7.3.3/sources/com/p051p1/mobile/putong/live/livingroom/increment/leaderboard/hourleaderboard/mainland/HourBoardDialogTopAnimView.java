...
public final class HourBoardDialogTopAnimView extends ConstraintLayout {
    ...
    @Metadata(m88120d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/increment/leaderboard/hourleaderboard/mainland/HourBoardDialogTopAnimView$a", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "onAnimationStart", "(Landroid/animation/Animator;)V", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13016a extends AnimatorListenerAdapter {
        public C13016a() {
        }
        ...
        public void onAnimationStart(Animator animation) {
            animation.getClass();
            bnl0.m105525M0(HourBoardDialogTopAnimView.this.get_bg_svga(), true);
        }
    }
    ...
    @Metadata(m88120d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/increment/leaderboard/hourleaderboard/mainland/HourBoardDialogTopAnimView$b", "Ll/wo0;", "", "g", "()V", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13017b extends wo0 {
        public C13017b() {
        }
    ...
    public final void m76000F0(boolean show) {
        bnl0.m105524M(get_bottom_bg(), show);
        bnl0.m105524M(get_bg_svga(), show);
        bnl0.m105524M(get_top_bg(), show);
    }
    ...
    public final void m76001h0(View view) {
        cil.m109905a(this, view);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m76002j0() {
    ...
    public final void m76003k0() {
        ...
        animatorSet.addListener(new C13016a());
        this.bgAnim = animatorSet;
    }

    /* JADX INFO: renamed from: l0 */
    public final void m76004l0(boolean isHourBoard) {
        if (isHourBoard) {
            izs.m142868s("context_livingAct", get_bottom_bg(), zft.f204200H);
        } else {
            izs.m142868s("context_livingAct", get_bottom_bg(), zft.f204230y);
        }
        get_bg_svga().m69688o();
        get_bg_svga().mo69685l(isHourBoard ? "https://auto.tancdn.com/v1/raw/f9f9b9db-0e97-4823-8f39-547baf3e7f4f12.pdf" : "https://fe-static.tancdn.com/v1/raw/ed012a8a-8019-44d8-b2ae-201e6a2a2fe212.svga", -1, new C13017b());
    }
