...
public class LiveGameHandler {
    ...
    private InterfaceC12963b luaCallback;
    private InterfaceC12965d rhythmGameCallback;
    ...
    public interface InterfaceC12963b extends InterfaceC12962a {
    ...
    public static class C12964c implements InterfaceC12963b {
        @Override // com.p051p1.mobile.putong.live.livingroom.increment.gift.game.LiveGameHandler.InterfaceC12963b
        /* JADX INFO: renamed from: a */
        public void mo74783a(int i) {
        }

        @Override // com.p051p1.mobile.putong.live.livingroom.increment.gift.game.LiveGameHandler.InterfaceC12962a
        /* JADX INFO: renamed from: b */
    ...
    public interface InterfaceC12965d extends InterfaceC12962a {
    }
    ...
    public void apiWithUrlParams(String str, ScriptBridge.Callback callback) {
        InterfaceC12963b interfaceC12963b = this.luaCallback;
        if (interfaceC12963b != null) {
            interfaceC12963b.uploadScore(str, callback);
        }
    }
    ...
    public String getClientInfo() {
        ...
        try {
            jSONObject.put("appVersionName", uqb0.f180413s);
            jSONObject.put(RemoteConfigConstants.RequestFieldKey.APP_VERSION, uqb0.f180415t + "");
    ...
    public String getSystemInfo() {
        return tl8.m191616M().toJson();
    }

    public void playerDead(String str) {
        InterfaceC12963b interfaceC12963b = this.luaCallback;
        if (interfaceC12963b != null) {
            interfaceC12963b.playerDead(str);
        }
    }
    ...
    public void register() {
        ...
        if (iXEngine2 == null || iXEngine2.getScriptBridge() == null) {
            clj.m110636o("game.register.fail: ".concat(str));
        } else {
    ...
    public void removeGame(String str) {
        InterfaceC12963b interfaceC12963b = this.luaCallback;
        if (interfaceC12963b != null) {
            interfaceC12963b.removeGame(str);
        }
    }
    ...
    public void setLuaCallback(InterfaceC12963b interfaceC12963b) {
        this.luaCallback = interfaceC12963b;
    }

    public void setRhythmCallback(InterfaceC12965d interfaceC12965d) {
    }

    public void touchArea(String str) {
        InterfaceC12963b interfaceC12963b = this.luaCallback;
        if (interfaceC12963b != null) {
            interfaceC12963b.setTouchArea(str);
        }
    }
    ...
    public void uploadCurrentScore(String str) {
        try {
            ...
            InterfaceC12963b interfaceC12963b = this.luaCallback;
            if (interfaceC12963b != null) {
                interfaceC12963b.mo74783a(iOptInt);
            }
        } catch (JSONException e) {
            CrashHelper.m82479c(e);
            e.toString();
    ...
    public void uploadGameScore(String str) {
        InterfaceC12963b interfaceC12963b = this.luaCallback;
        if (interfaceC12963b != null) {
            interfaceC12963b.uploadScore(str);
        }
    }
    ...
    public String userInfo(String str) {
        InterfaceC12963b interfaceC12963b = this.luaCallback;
        if (interfaceC12963b != null) {
            return interfaceC12963b.getUserInfo();
        }
        return null;
    }
}
