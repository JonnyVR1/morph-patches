...
public final class PacketCountdownView extends ConstraintLayout {
    ...
    public final CircleCountdownView get_circleCountdown() {
        ...
        Intrinsics.m88391r("_circleCountdown");
        return null;
    }
    ...
    public final VText get_countdownText() {
        ...
        Intrinsics.m88391r("_countdownText");
        return null;
    }

    /* JADX INFO: renamed from: h0 */
    public final void m75111h0(View view) {
        zc60.m219235a(this, view);
    }

    /* JADX INFO: renamed from: i0 */
    public final void m75112i0(@NotNull BLivePacketSystemCommentStatus info) {
        info.getClass();
        this.bagStatus = info;
        get_countdownText().setText(info.getCountdownText());
        get_circleCountdown().m75110d(info.getCurrentCountdownProgress());
    }

    @SuppressLint({"SetTextI18n"})
    /* JADX INFO: renamed from: j0 */
    public final void m75113j0() {
        get_circleCountdown().m75109c();
    ...
    public final void m75114k0(int countdown, float progress) {
        get_countdownText().setText(countdown + BLiveStormDanmakuGiftResourceType.f45294s);
        get_circleCountdown().m75110d(progress);
    }
