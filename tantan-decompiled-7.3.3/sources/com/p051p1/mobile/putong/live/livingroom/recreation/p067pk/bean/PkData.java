...
public class PkData {
    ...
    public PkData(BLivePk bLivePk, List<User> list, User user) {
        ...
        if (user == null) {
            ...
            this.anchorId = user.f56859id;
            this.otherUser = (BLivePkOwner) jyb.m147529r(bLivePk.players, new qcj() { // from class: l.nu70
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return this.f143682a.lambda$new$0((BLivePkOwner) obj);
                }
            });
        }
        updateContributors();
        updatePkWinTimes();
        this.pkBountyData = new PkBountyData(this.f52415pk, this.anchorId);
    }
    ...
    public /* synthetic */ Boolean lambda$otherUser$3(User user) {
        return Boolean.valueOf(TextUtils.equals(user.f56859id, this.otherUser.userId));
    }
    ...
    public /* synthetic */ void lambda$updateContributors$1(BLivePkContributor bLivePkContributor) {
        ...
        bLivePkContributor.image = user.m61308fp().profileSmall().base;
    ...
    private void updateContributors() {
        if (jyb.m147479J(this.f52415pk.players) || this.f52415pk.players.size() < 2) {
            this.mHostContributors = new ArrayList();
            this.mOtherContributors = new ArrayList();
            return;
        }
        BLivePkOwner bLivePkOwner = this.f52415pk.players.get(0);
        if (TextUtils.equals(bLivePkOwner.userId, this.anchorId)) {
            this.mHostContributors = bLivePkOwner.contributors;
            this.mOtherContributors = this.f52415pk.players.get(1).contributors;
        } else {
            this.mHostContributors = this.f52415pk.players.get(1).contributors;
            this.mOtherContributors = bLivePkOwner.contributors;
        }
        jyb.m147537z(this.mHostContributors, new y20() { // from class: l.ou70
            @Override // p153l.y20
            public final void call(Object obj) {
                this.f149067a.lambda$updateContributors$1((BLivePkContributor) obj);
            }
        });
        jyb.m147537z(this.mOtherContributors, new y20() { // from class: l.pu70
            @Override // p153l.y20
            public final void call(Object obj) {
                this.f154155a.lambda$updateContributors$2((BLivePkContributor) obj);
            }
        });
    }
    ...
    public User getUser(final String str) {
        return (User) jyb.m147529r(this.users, new qcj() { // from class: l.lu70
            @Override // p153l.qcj
            public final Object call(Object obj) {
    ...
    public boolean isBountyPk() {
        return TEnum.equals(this.f52415pk.categoryV2, BLivePkCategory.bounty);
    }
    ...
    public boolean isRandom() {
        return TEnum.equals(this.f52415pk.categoryV2, BLivePkCategory.random);
    }

    public boolean isRankPk() {
        return TEnum.equals(this.f52415pk.categoryV2, BLivePkCategory.rank);
    }

    public boolean isSameStatus(PkData pkData) {
        return pkData != null && TEnum.equals(this.state, pkData.state) && TextUtils.equals(this.f52415pk.f45269id, pkData.f52415pk.f45269id);
    }
    ...
    public User otherUser() {
        return (User) jyb.m147529r(this.users, new qcj() { // from class: l.qu70
            @Override // p153l.qcj
            public final Object call(Object obj) {
                return this.f159530a.lambda$otherUser$3((User) obj);
            }
        });
    }
    ...
    public String toString() {
        return hashCode() + "PkData{users=" + this.users.size() + ", pk=" + this.f52415pk + ", otherUser='" + this.otherUser + "', anchorId='" + this.anchorId + "', state=" + this.state + ", lastState=" + this.lastState + ", isOnceMore=" + this.isOnceMore + ", mHostContributors=" + contributions(this.mHostContributors) + ", mOtherContributors=" + contributions(this.mOtherContributors) + '}';
    }
    ...
    public void updatePkWinTimes() {
        ...
        BLivePk bLivePk = this.f52415pk;
        this.showWinTimesTag = bLivePk.showWinTimesTag;
        jyb.m147537z(bLivePk.players, new y20() { // from class: l.mu70
            @Override // p153l.y20
            public final void call(Object obj) {
                this.f138751a.lambda$updatePkWinTimes$5((BLivePkOwner) obj);
            }
        });
    }
    ...
    public PkData(BLivePkStage bLivePkStage) {
        ...
        this.f52415pk = bLivePkNew_;
        bLivePkNew_.f45269id = "-991";
        this.anchorId = "";
        this.otherUser = BLivePkOwner.new_();
        this.users = new ArrayList();
        this.pkBountyData = new PkBountyData(this.f52415pk, "");
    }
}
