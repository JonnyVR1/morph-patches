package com.p051p1.mobile.putong.live.livingroom.increment.gift.giftwallnew.category;
...
public final class LiveGiftWallCategoryItemView extends ConstraintLayout {
    ...
    public static void m74827i0(BLiveNewGiftWallGiftDetail bLiveNewGiftWallGiftDetail, wns wnsVar, View view) {
        ...
        wnsVar.m207224V3(bLiveNewGiftWallGift);
    }

    /* JADX INFO: renamed from: l0 */
    public static final void m74828l0(wns wnsVar, BLiveNewGiftWallUser bLiveNewGiftWallUser, View view) {
        wnsVar.m207225W3(bLiveNewGiftWallUser);
    }
    ...
    public final LiveGiftFiveStarView get_gift_five_star() {
        ...
        Intrinsics.m88391r("_gift_five_star");
        return null;
    }
    ...
    public final SVGAnimationView get_item_svga_bg() {
        ...
        Intrinsics.m88391r("_item_svga_bg");
        return null;
    }
    ...
    public final View get_unlock_mask() {
        ...
        Intrinsics.m88391r("_unlock_mask");
        return null;
    }
    ...
    public final View get_user_icon_bg() {
        ...
        Intrinsics.m88391r("_user_icon_bg");
        return null;
    }

    /* JADX INFO: renamed from: j0 */
    public final void m74829j0(View view) {
        sns.m187000a(this, view);
    }

    /* JADX INFO: renamed from: k0 */
    public final void m74830k0(@Nullable final BLiveNewGiftWallGiftDetail item, @NotNull final wns presenter) {
        BLiveNewGiftWallGift bLiveNewGiftWallGift;
        final BLiveNewGiftWallUser bLiveNewGiftWallUser;
        BLiveNewGiftWallCategory bLiveNewGiftWallCategory;
        presenter.getClass();
        bnl0.m105509E0(this, new View.OnClickListener() { // from class: l.qns
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LiveGiftWallCategoryItemView.m74827i0(item, presenter, view);
            }
        });
        get_item_svga_bg().stopAnimation(true);
        bnl0.m105524M(get_item_svga_bg(), false);
        if (item != null && (bLiveNewGiftWallCategory = item.category) != null) {
            izs.m142868s("context_livingAct", get_bg(), bLiveNewGiftWallCategory.cardBgUrl);
            bnl0.m105524M(get_item_svga_bg(), !TextUtils.isEmpty(bLiveNewGiftWallCategory.cardBgSvgaUrl));
        ...
        if (item != null) {
            bnl0.m105524M(get_user_icon_bg(), NullChecker.m82486a(item.user) && !TextUtils.isEmpty(item.category.avatarBorderColor));
        }
        bnl0.m105524M(get_user_icon(), NullChecker.m82486a(item != null ? item.user : null));
        if (item != null && (bLiveNewGiftWallUser = item.user) != null) {
            izs.m142868s("context_livingAct", get_user_icon(), bLiveNewGiftWallUser.avatar);
            get_user_icon_bg().setBackground(n3d0.m161279c(item.category.avatarBorderColor, 30));
            bnl0.m105509E0(get_user_icon(), new View.OnClickListener() { // from class: l.rns
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LiveGiftWallCategoryItemView.m74828l0(presenter, bLiveNewGiftWallUser, view);
                }
            });
        }
        ...
        izs.m142868s("context_livingAct", get_item_icon(), bLiveNewGiftWallGift.icon);
        get_item_title().setText(xau.m209909s(bLiveNewGiftWallGift.name, 5));
        get_gift_five_star().m74851j0(bLiveNewGiftWallGift.grade);
        bnl0.m105524M(get_item_svga_bg(), bLiveNewGiftWallGift.grade > 0 && !TextUtils.isEmpty(item.category.cardBgSvgaUrl));
        n3d0.m161285i(get_item_icon(), bLiveNewGiftWallGift.grade <= 0);
        bnl0.m105524M(get_unlock_mask(), bLiveNewGiftWallGift.grade <= 0);
    }
