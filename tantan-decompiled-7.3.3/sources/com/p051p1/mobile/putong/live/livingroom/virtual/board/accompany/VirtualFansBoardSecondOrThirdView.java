...
public final class VirtualFansBoardSecondOrThirdView extends ConstraintLayout {
    ...
    @Metadata(m88120d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0005\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/virtual/board/accompany/VirtualFansBoardSecondOrThirdView$a", "Ll/wo0;", "", "b", "()V", "g", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13112a extends wo0 {
        public C13112a() {
        }
        ...
        public void mo70745b() {
            bnl0.m105525M0(VirtualFansBoardSecondOrThirdView.this.get_rank_svga(), false);
        }
        ...
        public void mo70786g() {
            super.mo70786g();
            bnl0.m105525M0(VirtualFansBoardSecondOrThirdView.this.get_rank_svga(), true);
        }
    }
    ...
    public static void m78038h0(osn0 osn0Var, BLiveVoiceHourLeaderBoardItem bLiveVoiceHourLeaderBoardItem, View view) {
        osn0Var.mo78062p(bLiveVoiceHourLeaderBoardItem);
    }

    /* JADX INFO: renamed from: l0 */
    private final void m78039l0(int index) {
        if (index == 1) {
    ...
    public final void m78041i0(View view) {
        zyl0.m222127a(this, view);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m78042j0() {
    ...
    public final void m78043k0(int index) {
        bnl0.m105525M0(get_rank_svga(), true);
        get_rank_svga().clearDynamicData();
        get_rank_svga().m69687n();
        get_rank_svga().m69686m(index == 1 ? "https://auto.tancdn.com/v1/raw/69cadcb7-182a-4b98-870f-ba7525d5954d12.pdf" : "https://auto.tancdn.com/v1/raw/2dc517cd-df03-4c46-bfa2-0fa8c16604d413.pdf", 1, new C13112a(), false);
    }

    /* JADX INFO: renamed from: m0 */
    public final void m78044m0(@NotNull final BLiveVoiceHourLeaderBoardItem item, @NotNull final osn0 listener, int index) {
        item.getClass();
        listener.getClass();
        this.mHourLeaderBoardItem = item;
        get_avatar().getRealAvatarView().getHierarchy().m207041D(obc0.f146169R2);
        usn0.m197951f(get_avatar(), item, qa00.m175859d(73.0f));
        bnl0.m105524M(get_crown(), !get_avatar().m73304k0());
        get_name().setText(item.user.name);
        bnl0.m105524M(get_living(), false);
        bnl0.m105524M(get_heart(), true);
        get_heart().setText(usn0.m197949d(item.amount));
        setOnClickListener(new View.OnClickListener() { // from class: l.yyl0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VirtualFansBoardSecondOrThirdView.m78038h0(listener, item, view);
            }
        });
        m78039l0(index);
    }
    ...
    public final void m78045n0(int index) {
        m78042j0();
        m78039l0(index);
    }
