package com.p051p1.mobile.putong.live.livingroom.common.usercard.bean;
...
public class UserCardData {
    ...
    private final x20 jumpToOtherRoomClick;
    ...
    public static class Builder {
        ...
        private x20 jumpToOtherRoomClick;
        ...
        public UserCardData build() {
            if (TextUtils.isEmpty(this.userId) || "0".equals(this.userId)) {
                CrashHelper.m82479c(new Exception("UserCardData userId is null"));
            }
        ...
        public Builder jumpToOtherRoom(String str, String str2, x20 x20Var) {
            if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                this.roomId = str2;
                this.liveId = str;
                this.jumpToOtherRoomClick = x20Var;
            }
            return this;
        }
    ...
    public UserCardData(Builder builder) {
        ...
        this.f50242to = builder.f50243to;
    ...
    public x20 jumpOtherRoomCallBack() {
