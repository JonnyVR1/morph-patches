...
public final class VoiceChatGroupEnterView extends LinearLayout implements iam<r6n0> {
    ...
    public static Unit m79277a(VoiceChatGroupEnterView voiceChatGroupEnterView, View view) {
        view.getClass();
        r6n0 r6n0Var = voiceChatGroupEnterView.presenter;
        if (r6n0Var != null) {
            r6n0Var.mo96481K3();
        }
    ...
    public final void m79278b(View view) {
        t6n0.m189540a(this, view);
    }

    @Override // p153l.iam
    /* JADX INFO: renamed from: c, reason: merged with bridge method [inline-methods] */
    public void mo22064i1(@Nullable r6n0 presenter) {
    ...
    public final void m79280r() {
        czq.m113347c(get_root(), new Function1() { // from class: l.s6n0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return VoiceChatGroupEnterView.m79277a(this.f166593a, (View) obj);
            }
        });
    }
