...
public final class CircleCountdownView extends View {
    ...
    public CircleCountdownView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m75107a(context, attributeSet);
    }

    /* JADX INFO: renamed from: a */
    public final void m75107a(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, vhc0.f184124e);
            this.ringColor = typedArrayObtainStyledAttributes.getColor(vhc0.f184126f, RoundedDrawable.DEFAULT_BORDER_COLOR);
            this.ringWidth = typedArrayObtainStyledAttributes.getDimension(vhc0.f184128g, qa00.m175859d(5.0f));
    ...
    public final void m75109c() {
        m75110d(1.0f);
    }

    /* JADX INFO: renamed from: d */
    public final void m75110d(float progress) {
