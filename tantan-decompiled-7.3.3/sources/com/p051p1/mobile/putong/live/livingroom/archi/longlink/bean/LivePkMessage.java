...
public class LivePkMessage {
    ...
    public String toString() {
        return "LivePkMessage{pkInfo=" + this.pkInfo + ", type='" + this.type + "', id='" + this.f48600id + "', pkResult=" + this.pkResult + ", pkEnd=" + this.pkEnd + ", inviteMsg=" + this.inviteMsg + ", isOnceMore=" + this.isOnceMore + '}';
    }
