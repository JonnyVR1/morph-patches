...
public final class HourBoardSecondOrThirdView extends ConstraintLayout {
    ...
    @Metadata(m88120d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004J\u000f\u0010\u0005\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/increment/leaderboard/hourleaderboard/mainland/HourBoardSecondOrThirdView$a", "Ll/wo0;", "", "b", "()V", "g", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13023a extends wo0 {
        public C13023a() {
        }
        ...
        public void mo70745b() {
            bnl0.m105525M0(HourBoardSecondOrThirdView.this.get_rank_svga(), false);
        }
        ...
        public void mo70786g() {
            super.mo70786g();
            bnl0.m105525M0(HourBoardSecondOrThirdView.this.get_rank_svga(), true);
        }
    }
    ...
    public static void m76054h0(y20 y20Var, User user, View view) {
        y20Var.call(user.f56859id);
    }

    /* JADX INFO: renamed from: i0 */
    public static void m76055i0(uhl uhlVar, BLiveHourLeaderBoardItem bLiveHourLeaderBoardItem, View view) {
        uhlVar.mo76107F(bLiveHourLeaderBoardItem);
    }

    /* JADX INFO: renamed from: j0 */
    public static void m76056j0(View view) {
    }

    /* JADX INFO: renamed from: p0 */
    private final void m76057p0(int index) {
        if (index == 1) {
            get_crown().setImageResource(obc0.f146509u3);
            get_bg().setBackgroundResource(obc0.f146473r3);
        } else {
            if (index != 2) {
                return;
            }
            get_crown().setImageResource(obc0.f146521v3);
            get_bg().setBackgroundResource(obc0.f146485s3);
        }
    }

    /* JADX INFO: renamed from: q0 */
    private final void m76058q0(BLiveLeaderBoards boards, String week) {
    ...
    private final void m76059r() {
        ...
        int i3 = (int) (0.41353384f * fM105592y0);
        bnl0.m105507D0(i3, get_avatar());
        bnl0.m105505C0(get_avatar(), i3);
        int i4 = (int) (0.6315789f * fM105592y0);
        bnl0.m105507D0(i4, get_crown());
        bnl0.m105505C0(get_crown(), i4);
        bnl0.m105540X(get_avatar(), (int) (0.22556391f * fM105592y0));
    ...
    public final void m76060k0(View view) {
        ikl.m140408a(this, view);
    }

    /* JADX INFO: renamed from: l0 */
    public final void m76061l0() {
        ...
        bnl0.m105525M0(get_rank_svga(), false);
    ...
    public final String m76062m0(BLiveHourLeaderBoardItem item) {
        long j = item.rank;
        if (j < 0) {
            return "上榜还需" + icr.m139459b(item.gap) + "人气";
        }
        long j2 = item.gap;
        if (j > 1) {
    ...
    public final void m76063n0(int index) {
        bnl0.m105525M0(get_rank_svga(), true);
        get_rank_svga().clearDynamicData();
        get_rank_svga().m69687n();
        get_rank_svga().mo69685l(index == 1 ? "https://auto.tancdn.com/v1/raw/69cadcb7-182a-4b98-870f-ba7525d5954d12.pdf" : "https://auto.tancdn.com/v1/raw/2dc517cd-df03-4c46-bfa2-0fa8c16604d413.pdf", 1, new C13023a());
    }

    /* JADX INFO: renamed from: o0 */
    public final void m76064o0(String userImage, String userName, long amount, int index) {
    ...
    public final void m76065r0(@NotNull final BLiveHourLeaderBoardItem hourLeaderBoardItem, @NotNull final uhl listener, int index) {
        ...
        str2.getClass();
        m76064o0(str, str2, hourLeaderBoardItem.amount, index);
        bnl0.m105509E0(this, new View.OnClickListener() { // from class: l.fkl
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                HourBoardSecondOrThirdView.m76055i0(listener, hourLeaderBoardItem, view);
            }
        });
    ...
    public final void m76066s0(@NotNull nsv<BLiveLeaderBoards> leaderBoards, @NotNull final y20<String> listener, int index, @NotNull String week) {
        ...
        if (NullChecker.m82486a(user)) {
            ...
            m76058q0(bLiveLeaderBoards, week);
            String str = user.pictures.get(0).url;
            str.getClass();
            String str2 = user.name;
            str2.getClass();
            m76064o0(str, str2, (long) leaderBoards.f143542a.amount, index);
            setOnClickListener(new View.OnClickListener() { // from class: l.gkl
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    HourBoardSecondOrThirdView.m76054h0(listener, user, view);
                }
            });
        }
    }
    ...
    public final void setHeartColorAndText(@NotNull BLiveHourLeaderBoardItem item) {
        item.getClass();
        get_heart().setTextColor(Color.parseColor("#FE7E1D"));
        get_heart().setText(m76062m0(item));
    ...
    public final void m76067t0(int index) {
        m76057p0(index);
        get_name().setText(zrv.f205803e.getString(R$string.f48209l6));
        setOnClickListener(new View.OnClickListener() { // from class: l.hkl
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                HourBoardSecondOrThirdView.m76056j0(view);
            }
        });
