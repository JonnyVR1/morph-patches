...
public final class HourBoardHeaderView extends ConstraintLayout {
    ...
    @Metadata(m88120d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/increment/leaderboard/hourleaderboard/mainland/HourBoardHeaderView$b", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "onAnimationStart", "(Landroid/animation/Animator;)V", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13019b extends AnimatorListenerAdapter {
        public C13019b() {
        }
        ...
        public void onAnimationStart(Animator animation) {
            ...
            bnl0.m105525M0(HourBoardHeaderView.this.get_first_user(), true);
        }
    }
    ...
    @Metadata(m88120d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0007\u0010\u0006¨\u0006\b"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/increment/leaderboard/hourleaderboard/mainland/HourBoardHeaderView$c", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "onAnimationStart", "(Landroid/animation/Animator;)V", "onAnimationEnd", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13020c extends AnimatorListenerAdapter {
        public C13020c() {
        }
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (HourBoardHeaderView.this.canPlaySvga) {
                HourBoardHeaderView.this.get_second_user().m76063n0(1);
            }
        }
        ...
        public void onAnimationStart(Animator animation) {
            ...
            bnl0.m105525M0(HourBoardHeaderView.this.get_second_user(), true);
        }
    }
    ...
    @Metadata(m88120d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\u0007\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0007\u0010\u0006¨\u0006\b"}, m88121d2 = {"com/p1/mobile/putong/live/livingroom/increment/leaderboard/hourleaderboard/mainland/HourBoardHeaderView$d", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "onAnimationStart", "(Landroid/animation/Animator;)V", "onAnimationEnd", "livingroom_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C13021d extends AnimatorListenerAdapter {
        public C13021d() {
        }
        ...
        public void onAnimationEnd(Animator animation) {
            animation.getClass();
            if (HourBoardHeaderView.this.canPlaySvga) {
                HourBoardHeaderView.this.get_third_user().m76063n0(2);
            }
        }
        ...
        public void onAnimationStart(Animator animation) {
            ...
            bnl0.m105525M0(HourBoardHeaderView.this.get_third_user(), true);
        }
    }
    ...
    private final void m76018j0(Animator anim) {
        if (anim != null) {
            anim.end();
        }
        if (anim != null) {
    ...
    public final void m76021G() {
        this.canPlaySvga = false;
        m76018j0(this.firstShowAnim);
        m76018j0(this.secondShowAnim);
        m76018j0(this.thirdShowAnim);
        bnl0.m105525M0(get_first_user(), false);
        bnl0.m105525M0(get_second_user(), false);
        bnl0.m105525M0(get_third_user(), false);
        get_first_user().m76010l0();
        get_second_user().m76061l0();
        get_third_user().m76061l0();
    }
    ...
    public final HourBoardFirstView get_first_user() {
        ...
        Intrinsics.m88391r("_first_user");
        return null;
    }
    ...
    public final HourBoardSecondOrThirdView get_second_user() {
        ...
        Intrinsics.m88391r("_second_user");
        return null;
    }
    ...
    public final HourBoardSecondOrThirdView get_third_user() {
        ...
        Intrinsics.m88391r("_third_user");
        return null;
    }

    /* JADX INFO: renamed from: h0 */
    public final void m76022h0(View view) {
        til.m191336a(this, view);
    }

    /* JADX INFO: renamed from: l0 */
    public final void m76023l0() {
        if (this.firstShowAnim == null) {
            ...
            animatorSet.addListener(new C13019b());
            this.firstShowAnim = animatorSet;
        }
    }

    /* JADX INFO: renamed from: m0 */
    public final void m76024m0() {
        if (this.secondShowAnim == null) {
            ...
            objectAnimatorOfFloat.setDuration(1000L);
            objectAnimatorOfFloat.setInterpolator(new DecelerateInterpolator());
            ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(get_second_user(), (Property<HourBoardSecondOrThirdView, Float>) View.TRANSLATION_X, qa00.f156322i, 0.0f);
            ...
            animatorSet.addListener(new C13020c());
            this.secondShowAnim = animatorSet;
        }
    }

    /* JADX INFO: renamed from: n0 */
    public final void m76025n0() {
        if (this.thirdShowAnim == null) {
            ...
            objectAnimatorOfFloat.setDuration(1000L);
            objectAnimatorOfFloat.setInterpolator(new DecelerateInterpolator());
            ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(get_third_user(), (Property<HourBoardSecondOrThirdView, Float>) View.TRANSLATION_X, -qa00.f156322i, 0.0f);
            objectAnimatorOfFloat2.setDuration(1000L);
            objectAnimatorOfFloat2.setInterpolator(new DecelerateInterpolator());
            AnimatorSet animatorSet = new AnimatorSet();
            animatorSet.play(objectAnimatorOfFloat).with(objectAnimatorOfFloat2).after(animatorM132164j);
            animatorSet.addListener(new C13021d());
            this.thirdShowAnim = animatorSet;
        }
    }

    /* JADX INFO: renamed from: o0 */
    public final void m76026o0(LivingUsers<BLiveLeaderBoards> list, y20<String> listener, String week) {
        if (list.isEmpty()) {
            get_first_user().m76016r0();
            get_second_user().m76067t0(1);
            get_third_user().m76067t0(2);
            return;
        }
        if (list.size() < 3) {
            get_third_user().m76067t0(2);
        ...
        for (Object obj : list) {
            ...
            nsv<BLiveLeaderBoards> nsvVar = (nsv) obj;
            if (i == 0) {
                HourBoardFirstView hourBoardFirstView = get_first_user();
                nsvVar.getClass();
                hourBoardFirstView.m76015q0(nsvVar, listener, week);
            } else if (i == 1) {
                HourBoardSecondOrThirdView hourBoardSecondOrThirdView = get_second_user();
                nsvVar.getClass();
                hourBoardSecondOrThirdView.m76066s0(nsvVar, listener, i, week);
            } else if (i == 2) {
                HourBoardSecondOrThirdView hourBoardSecondOrThirdView2 = get_third_user();
                nsvVar.getClass();
                hourBoardSecondOrThirdView2.m76066s0(nsvVar, listener, i, week);
            }
            i = i2;
        }
    }
    ...
    public final void m76027p0(List<? extends BLiveHourLeaderBoardItem> list, uhl listener, boolean isListOptimization) {
        if (list.isEmpty()) {
            get_first_user().m76016r0();
            get_second_user().m76067t0(1);
            get_third_user().m76067t0(2);
        ...
        for (Object obj : list) {
            ...
            if (i == 0) {
                get_first_user().m76014p0(bLiveHourLeaderBoardItem, listener);
                if (isListOptimization) {
                    get_first_user().setHeartColorAndText(this.isCur);
                }
            } else if (i == 1) {
                get_second_user().m76065r0(bLiveHourLeaderBoardItem, listener, i);
                if (isListOptimization) {
                    get_second_user().setHeartColorAndText(bLiveHourLeaderBoardItem);
                }
            } else if (i == 2) {
                get_third_user().m76065r0(bLiveHourLeaderBoardItem, listener, i);
                if (isListOptimization) {
    ...
    public final void m76028q0(@NotNull LivingUsers<BLiveLeaderBoards> list, @NotNull y20<String> listener, @NotNull String week) {
        list.getClass();
        listener.getClass();
        week.getClass();
        bnl0.m105524M(get_notice(), false);
        bnl0.m105540X(get_first_user(), qa00.m175859d(30.0f));
        m76026o0(list, listener, week);
        m76020u0();
    }

    /* JADX INFO: renamed from: r0 */
    public final void m76029r0(@NotNull List<? extends BLiveHourLeaderBoardItem> list, @NotNull uhl listener, @Nullable BLiveHourLeaderBoard leaderBoard) {
        list.getClass();
        listener.getClass();
        this.listener = listener;
        bnl0.m105540X(get_first_user(), get_notice().m76069i0(leaderBoard) ? 0 : qa00.m175859d(30.0f));
        m76027p0(list, listener, false);
    ...
    public final void m76030s0(@NotNull List<? extends BLiveHourLeaderBoardItem> list, @NotNull uhl listener, @NotNull List<BLiveCurrentHourNotices> noticesList, boolean isCur) {
        list.getClass();
        listener.getClass();
        noticesList.getClass();
        this.listener = listener;
        this.isCur = isCur;
        bnl0.m105540X(get_first_user(), get_notice().m76070j0(noticesList) ? 0 : qa00.m175859d(30.0f));
        m76027p0(list, listener, true);
        m76020u0();
    }
