...
public final class VoiceVirtualRoomInfoTitleItem extends ConstraintLayout {
    ...
    public final void m78712h0(View view) {
        uip0.m196298a(this, view);
    }

    @NotNull
    /* JADX INFO: renamed from: i0 */
    public final VoiceVirtualRoomInfoTitleItem m78713i0(@NotNull String text, @NotNull View.OnClickListener clickListener) {
        text.getClass();
        clickListener.getClass();
        get_name().setText(text);
        bnl0.m105509E0(get_root(), clickListener);
        return this;
    }

    @NotNull
    /* JADX INFO: renamed from: j0 */
    public final VoiceVirtualRoomInfoTitleItem m78714j0(@NotNull String text, @NotNull String content, @NotNull View.OnClickListener clickListener) {
        text.getClass();
        content.getClass();
        clickListener.getClass();
        get_name().setText(text);
    ...
    public final void setArrowVisible(boolean visible) {
        bnl0.m105524M(get_go_arrow(), visible);
    }
