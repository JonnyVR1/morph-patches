...
public class LiveDialogEnum {
    ...
    public static final LiveDialogEnum GIFT_SHOW_EXPIRATION_DIALOG = new C127731("GIFT_SHOW_EXPIRATION_DIALOG", 24);
    ...
    public final enum C127731 extends LiveDialogEnum {
        private C127731(String str, int i) {
            super(str, i);
        }

        @Override // com.p051p1.mobile.putong.live.livingroom.archi.dialogcenter.LiveDialogEnum
