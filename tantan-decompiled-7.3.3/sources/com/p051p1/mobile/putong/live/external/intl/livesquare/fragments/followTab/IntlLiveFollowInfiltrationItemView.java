...
public final class IntlLiveFollowInfiltrationItemView extends LinearLayout {
    ...
    public final void m71261a(View view) {
        swn.m188331a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m71262b(@NotNull ActivitySuggests it) {
        it.getClass();
        this.liveSuggests = it;
    }

    /* JADX INFO: renamed from: c */
    public final void m71263c(@NotNull i5o presenter, @NotNull mvn liveActivitiesInfo) {
        int i;
        int i2;
        presenter.getClass();
        liveActivitiesInfo.getClass();
        mao maoVar = liveActivitiesInfo.m160292l().get(this.liveSuggests);
        if (maoVar != null) {
            IntlLiveFollowInfiltrationItemPicView intlLiveFollowInfiltrationItemPicView = get_hor_item_1();
            int i3 = 4;
            if (maoVar.m157731a().size() < 1) {
                i = 4;
            } else {
                get_hor_item_1().m71260d(presenter, maoVar.m157731a().get(0), liveActivitiesInfo, this.liveSuggests, 0);
                i = 0;
            }
            ...
            if (maoVar.m157731a().size() < 2) {
                i2 = 4;
            } else {
                get_hor_item_2().m71260d(presenter, maoVar.m157731a().get(1), liveActivitiesInfo, this.liveSuggests, 1);
                i2 = 0;
            }
            ...
            if (maoVar.m157731a().size() >= 3) {
                get_hor_item_3().m71260d(presenter, maoVar.m157731a().get(2), liveActivitiesInfo, this.liveSuggests, 2);
                i3 = 0;
            }
