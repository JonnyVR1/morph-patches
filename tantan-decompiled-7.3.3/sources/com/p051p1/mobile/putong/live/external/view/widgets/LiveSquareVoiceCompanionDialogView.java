...
public final class LiveSquareVoiceCompanionDialogView extends LinearLayout {
    ...
    public static void m72095a(LiveSquareVoiceCompanionDialogView liveSquareVoiceCompanionDialogView, Bitmap bitmap) {
        liveSquareVoiceCompanionDialogView.get_avatar().setAvatar(bitmap);
    }

    /* JADX INFO: renamed from: b */
    public static void m72096b(LiveSquareVoiceCompanionDialogView liveSquareVoiceCompanionDialogView, View view) {
    ...
    public static void m72097c(LiveSquareVoiceCompanionDialogView liveSquareVoiceCompanionDialogView, View view) {
    ...
    public final void m72098d(View view) {
        e7u.m119771a(this, view);
    }

    /* JADX INFO: renamed from: e */
    public final void m72099e(@NotNull BLiveAnchors data) {
        data.getClass();
        ImageRequest imageRequestM8668a = uqb0.f180374G.m98797n(data.avatar.url).m8661O(new q3d0(get_avatar().getAvatarSize(), get_avatar().getAvatarSize(), 0.0f, 0.0f, 12, null)).m8668a();
        imageRequestM8668a.getClass();
        uqb0.f180374G.m127102F(imageRequestM8668a, new y20() { // from class: l.b7u
            @Override // p153l.y20
            public final void call(Object obj) {
                LiveSquareVoiceCompanionDialogView.m72095a(this.f75338a, (Bitmap) obj);
            }
        });
        ...
        layoutParams2.bottomMargin = bnl0.m105587w(2.0f);
        get_name().setLayoutParams(layoutParams2);
        get_btn_negative().setText(getContext().getString(R$string.f45720J));
        bnl0.m105509E0(get_btn_positive(), new View.OnClickListener() { // from class: l.c7u
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LiveSquareVoiceCompanionDialogView.m72097c(this.f80142a, view);
            }
        });
        bnl0.m105509E0(get_btn_negative(), new View.OnClickListener() { // from class: l.d7u
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                LiveSquareVoiceCompanionDialogView.m72096b(this.f85548a, view);
            }
        });
    }
