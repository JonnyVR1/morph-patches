...
public final class IntlFeedbackQuestionItemView extends VLinear {
    ...
    public static void m71137P(IntlFeedbackPageData.GroupsDTO.FaqListDTO faqListDTO, IntlFeedbackQuestionItemView intlFeedbackQuestionItemView, Function1 function1, View view) {
        if (faqListDTO.isUnFold()) {
            intlFeedbackQuestionItemView.get_answer().setVisibility(8);
            faqListDTO.setUnFold(false);
            intlFeedbackQuestionItemView.get_question_icon().setImageResource(nbc0.f141091C);
        } else {
            intlFeedbackQuestionItemView.get_answer().setVisibility(0);
            faqListDTO.setUnFold(true);
            intlFeedbackQuestionItemView.get_question_icon().setImageResource(nbc0.f141097E);
        }
        if (function1 != null) {
    ...
    public final void m71138Q(View view) {
        ogn.m167659a(this, view);
    }

    /* JADX INFO: renamed from: R */
    public final void m71139R(@NotNull final IntlFeedbackPageData.GroupsDTO.FaqListDTO question, @Nullable final Function1<? super Boolean, Unit> function) {
        question.getClass();
        ...
        get_question_icon().setImageResource(question.isUnFold() ? nbc0.f141097E : nbc0.f141091C);
        bnl0.m105509E0(get_question(), new View.OnClickListener() { // from class: l.ngn
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                IntlFeedbackQuestionItemView.m71137P(question, this, function, view);
            }
        });
    }
    ...
    public final VText get_question_title() {
        ...
        Intrinsics.m88391r("_question_title");
        return null;
    }
