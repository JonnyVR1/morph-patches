...
public abstract class BaseAsyncPlug {
    ...
    public BaseAsyncPlug(@NotNull ner nerVar) {
        nerVar.getClass();
        this.lifecycleProvider = nerVar;
        this.behaviorSubject = LazyKt__LazyJVMKt.m88118b(new Function0() { // from class: l.bf2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return BaseAsyncPlug.m71992e();
            }
        });
    }

    /* JADX INFO: renamed from: a */
    public static void m71988a(BaseAsyncPlug baseAsyncPlug, final Function1 function1, final ModelData modelData) {
        baseAsyncPlug.safeFunc(new Function0() { // from class: l.cf2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static Boolean m71990c(ModelData modelData) {
        return Boolean.valueOf(modelData != null);
    }

    /* JADX INFO: renamed from: d */
    public static Boolean m71991d(Function1 function1, Object obj) {
        return (Boolean) function1.invoke(obj);
    }

    /* JADX INFO: renamed from: e */
    public static C22507a m71992e() {
        return C22507a.m222758b();
    }

    private final C22507a<ModelData> getBehaviorSubject() {
    ...
    public final void observe(@NotNull final Function1<? super ModelData, Unit> call) {
        ...
        final Function1 function1 = new Function1() { // from class: l.df2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return BaseAsyncPlug.m71990c((ModelData) obj);
            }
        };
        c22421cDuringCreated.filter(new qcj() { // from class: l.ef2
            @Override // p153l.qcj
            public final Object call(Object obj) {
                return BaseAsyncPlug.m71991d(function1, obj);
            }
        }).subscribe(dhw.m115825d(new y20() { // from class: l.ff2
            @Override // p153l.y20
            public final void call(Object obj) {
                BaseAsyncPlug.m71988a(this.f98739a, call, (ModelData) obj);
            }
        }));
    }
