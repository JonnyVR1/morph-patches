...
public class H5StockKeepUnit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<H5StockKeepUnit> PROTOBUF_ADAPTER = new MessageNanoAdapter<H5StockKeepUnit>() { // from class: com.p1.mobile.putong.core.data.H5StockKeepUnit.1
        ...
        public int computeAndCacheSize(H5StockKeepUnit h5StockKeepUnit) {
            String str = h5StockKeepUnit.f21153id;
            ...
            if (h5DisplayOption != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, h5DisplayOption, H5DisplayOption.PROTOBUF_ADAPTER);
            }
            ...
            h5StockKeepUnit.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public H5StockKeepUnit parse(nc5 nc5Var) throws IOException {
            H5StockKeepUnit h5StockKeepUnit = new H5StockKeepUnit();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (h5StockKeepUnit.f21153id == null) {
                        h5StockKeepUnit.f21153id = "";
                    }
                ...
                if (iM162497u == 10) {
                    h5StockKeepUnit.f21153id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    h5StockKeepUnit.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    h5StockKeepUnit.extraDisplayOption = (H5DisplayOption) nc5Var.m162488l(H5DisplayOption.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    h5StockKeepUnit.prices = (Prices) nc5Var.m162488l(Prices.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 42) {
                        if (h5StockKeepUnit.f21153id == null) {
                            h5StockKeepUnit.f21153id = "";
                    ...
                    h5StockKeepUnit.tracker = nc5Var.m162495s();
                }
            }
            return h5StockKeepUnit;
        }
        ...
        public void serialize(H5StockKeepUnit h5StockKeepUnit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            H5DisplayOption h5DisplayOption = h5StockKeepUnit.extraDisplayOption;
            if (h5DisplayOption != null) {
                codedOutputByteBufferNano.m17309K(3, h5DisplayOption, H5DisplayOption.PROTOBUF_ADAPTER);
            }
            Prices prices = h5StockKeepUnit.prices;
            if (prices != null) {
        ...
        public boolean parseField(H5StockKeepUnit h5StockKeepUnit, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "extraDisplayOption":
                    ...
                    return true;
                case "id":
                    h5StockKeepUnit.f21153id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public H5StockKeepUnit mo225055clone() {
        H5StockKeepUnit h5StockKeepUnit = new H5StockKeepUnit();
        h5StockKeepUnit.f21153id = this.f21153id;
        h5StockKeepUnit.type = this.type;
        H5DisplayOption h5DisplayOption = this.extraDisplayOption;
        if (h5DisplayOption != null) {
            h5StockKeepUnit.extraDisplayOption = h5DisplayOption.mo225055clone();
        }
        Prices prices = this.prices;
        if (prices != null) {
            h5StockKeepUnit.prices = prices.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21153id, h5StockKeepUnit.f21153id) && ValueObject.util_equals(this.type, h5StockKeepUnit.type) && ValueObject.util_equals(this.extraDisplayOption, h5StockKeepUnit.extraDisplayOption) && ValueObject.util_equals(this.prices, h5StockKeepUnit.prices) && ValueObject.util_equals(this.tracker, h5StockKeepUnit.tracker);
    }
