...
public class FakeGoodLifeUserInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FakeGoodLifeUserInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<FakeGoodLifeUserInfo>() { // from class: com.p1.mobile.putong.core.data.FakeGoodLifeUserInfo.1
        ...
        public int computeAndCacheSize(FakeGoodLifeUserInfo fakeGoodLifeUserInfo) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, fakeGoodLifeUserInfo.likeNum) + CodedOutputByteBufferNano.m17281h(3, fakeGoodLifeUserInfo.avatar) + CodedOutputByteBufferNano.m17281h(4, fakeGoodLifeUserInfo.picSmall);
            String str2 = fakeGoodLifeUserInfo.picBig;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(5, str2);
            }
            fakeGoodLifeUserInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FakeGoodLifeUserInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    fakeGoodLifeUserInfo.name = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    fakeGoodLifeUserInfo.likeNum = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    fakeGoodLifeUserInfo.avatar = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    fakeGoodLifeUserInfo.picSmall = nc5Var.m162486j();
                } else {
                    if (iM162497u != 42) {
                        if (fakeGoodLifeUserInfo.name == null) {
                            fakeGoodLifeUserInfo.name = "";
                    ...
                    fakeGoodLifeUserInfo.picBig = nc5Var.m162495s();
                }
            }
            return fakeGoodLifeUserInfo;
        }
        ...
        public void serialize(FakeGoodLifeUserInfo fakeGoodLifeUserInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, fakeGoodLifeUserInfo.likeNum);
            codedOutputByteBufferNano.m17305G(3, fakeGoodLifeUserInfo.avatar);
            codedOutputByteBufferNano.m17305G(4, fakeGoodLifeUserInfo.picSmall);
            String str2 = fakeGoodLifeUserInfo.picBig;
            if (str2 != null) {
    ...
    public FakeGoodLifeUserInfo mo225055clone() {
        FakeGoodLifeUserInfo fakeGoodLifeUserInfo = new FakeGoodLifeUserInfo();
