...
import com.p051p1.mobile.putong.core.data.ResourceData;
...
public class ResourceData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ResourceData> PROTOBUF_ADAPTER = new MessageNanoAdapter<ResourceData>() { // from class: com.p1.mobile.putong.core.data.ResourceData.1
        ...
        public int computeAndCacheSize(ResourceData resourceData) {
            ...
            if (resourceDataCard != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, resourceDataCard, ResourceDataCard.PROTOBUF_ADAPTER);
            }
            String str4 = resourceData.gid;
            if (str4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(5, str4);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(6, resourceData.insertOffsetPosition);
            ...
            resourceData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ResourceData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    resourceData.resourceKey = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    resourceData.business = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    resourceData.ruleKey = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    resourceData.card = (ResourceDataCard) nc5Var.m162488l(ResourceDataCard.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    resourceData.gid = nc5Var.m162495s();
                } else if (iM162497u == 48) {
                    resourceData.insertOffsetPosition = nc5Var.m162486j();
                } else {
                    if (iM162497u != 58) {
                        if (resourceData.resourceKey == null) {
                            resourceData.resourceKey = "";
                    ...
                    resourceData.pendingDelete = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return resourceData;
        }
        ...
        public void serialize(ResourceData resourceData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ResourceDataCard resourceDataCard = resourceData.card;
            if (resourceDataCard != null) {
                codedOutputByteBufferNano.m17309K(4, resourceDataCard, ResourceDataCard.PROTOBUF_ADAPTER);
            }
            String str4 = resourceData.gid;
            if (str4 != null) {
                codedOutputByteBufferNano.m17316R(5, str4);
            }
            codedOutputByteBufferNano.m17305G(6, resourceData.insertOffsetPosition);
            List<String> list = resourceData.pendingDelete;
            if (list != null) {
    ...
    public static /* synthetic */ String m36825a(String str) {
        return str;
    }
    ...
    public ResourceData mo225055clone() {
        ResourceData resourceData = new ResourceData();
        ...
        if (resourceDataCard != null) {
            resourceData.card = resourceDataCard.mo225055clone();
        }
        resourceData.gid = this.gid;
        resourceData.insertOffsetPosition = this.insertOffsetPosition;
        List<String> list = this.pendingDelete;
        if (list != null) {
            resourceData.pendingDelete = ValueObject.util_map(list, new qcj() { // from class: l.y3d0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ResourceData.m36825a((String) obj);
                }
            });
        }
        return resourceData;
