...
public class CommonTipBox extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CommonTipBox> PROTOBUF_ADAPTER = new MessageNanoAdapter<CommonTipBox>() { // from class: com.p1.mobile.putong.core.data.CommonTipBox.1
        ...
        public int computeAndCacheSize(CommonTipBox commonTipBox) {
            ...
            commonTipBox.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CommonTipBox parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    commonTipBox.type = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    commonTipBox.title = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    commonTipBox.subtitle = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    commonTipBox.iconUrl = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    commonTipBox.button = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    commonTipBox.schema = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    commonTipBox.disabledButton = nc5Var.m162495s();
                } else if (iM162497u == 66) {
                    commonTipBox.statsModuleId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 74) {
                        if (commonTipBox.type == null) {
                            commonTipBox.type = "";
                    ...
                    commonTipBox.statsModuleParameter = nc5Var.m162495s();
                }
            }
            return commonTipBox;
        }
    ...
    public CommonTipBox mo225055clone() {
        CommonTipBox commonTipBox = new CommonTipBox();
