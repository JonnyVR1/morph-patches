...
import com.p051p1.mobile.putong.core.data.TriggerParams;
...
public class TriggerParams extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TriggerParams> PROTOBUF_ADAPTER = new MessageNanoAdapter<TriggerParams>() { // from class: com.p1.mobile.putong.core.data.TriggerParams.1
        ...
        public int computeAndCacheSize(TriggerParams triggerParams) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17283j(2, triggerParams.position) + CodedOutputByteBufferNano.m17281h(3, triggerParams.rangeStartPosition) + CodedOutputByteBufferNano.m17281h(4, triggerParams.rangeInterval);
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(7, triggerParams.count);
            triggerParams.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TriggerParams parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    triggerParams.type = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    triggerParams.position = nc5Var.m162487k();
                } else if (iM162497u == 24) {
                    triggerParams.rangeStartPosition = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    triggerParams.rangeInterval = nc5Var.m162486j();
                } else if (iM162497u == 42) {
                    triggerParams.buttons = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 50) {
                    triggerParams.direction = nc5Var.m162495s();
                } else {
                    if (iM162497u != 56) {
                        if (triggerParams.type == null) {
                            triggerParams.type = "";
                    ...
                    triggerParams.count = nc5Var.m162486j();
                }
            }
            return triggerParams;
        }
        ...
        public void serialize(TriggerParams triggerParams, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(2, triggerParams.position);
            codedOutputByteBufferNano.m17305G(3, triggerParams.rangeStartPosition);
            codedOutputByteBufferNano.m17305G(4, triggerParams.rangeInterval);
            List<String> list = triggerParams.buttons;
            if (list != null) {
            ...
            codedOutputByteBufferNano.m17305G(7, triggerParams.count);
        }
    };
    ...
    public static /* synthetic */ String m36888a(String str) {
        return str;
    }
    ...
    public TriggerParams mo225055clone() {
        TriggerParams triggerParams = new TriggerParams();
        ...
        if (list != null) {
            triggerParams.buttons = ValueObject.util_map(list, new qcj() { // from class: l.xjj0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return TriggerParams.m36888a((String) obj);
                }
            });
        }
