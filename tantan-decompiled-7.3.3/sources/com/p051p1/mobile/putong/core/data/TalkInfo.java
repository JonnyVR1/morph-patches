...
public class TalkInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TalkInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<TalkInfo>() { // from class: com.p1.mobile.putong.core.data.TalkInfo.1
        ...
        public int computeAndCacheSize(TalkInfo talkInfo) {
            ...
            talkInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TalkInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    talkInfo.talkId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    talkInfo.talkMsg = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    talkInfo.talkQuestion = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (talkInfo.talkId == null) {
                            talkInfo.talkId = "";
                    ...
                    talkInfo.talkAnswer = nc5Var.m162495s();
                }
            }
            return talkInfo;
        }
