...
public class RedDotMvOptConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RedDotMvOptConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<RedDotMvOptConfig>() { // from class: com.p1.mobile.putong.core.data.RedDotMvOptConfig.1
        ...
        public int computeAndCacheSize(RedDotMvOptConfig redDotMvOptConfig) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, redDotMvOptConfig.enable) + CodedOutputByteBufferNano.m17281h(2, redDotMvOptConfig.mv_max);
            redDotMvOptConfig.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RedDotMvOptConfig parse(nc5 nc5Var) throws IOException {
            RedDotMvOptConfig redDotMvOptConfig = new RedDotMvOptConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    redDotMvOptConfig.enable = nc5Var.m162483g();
                } else {
                    if (iM162497u != 16) {
                        return redDotMvOptConfig;
                    }
                    redDotMvOptConfig.mv_max = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(RedDotMvOptConfig redDotMvOptConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, redDotMvOptConfig.enable);
            codedOutputByteBufferNano.m17305G(2, redDotMvOptConfig.mv_max);
        }
    };
    ...
    public RedDotMvOptConfig mo225055clone() {
        RedDotMvOptConfig redDotMvOptConfig = new RedDotMvOptConfig();
