...
public class BarLoverConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BarLoverConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<BarLoverConfig>() { // from class: com.p1.mobile.putong.core.data.BarLoverConfig.1
        ...
        public int computeAndCacheSize(BarLoverConfig barLoverConfig) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, barLoverConfig.barLoverDlg1MaxShowNoClick) + CodedOutputByteBufferNano.m17275b(2, barLoverConfig.barLoverDlg2CanShow) + CodedOutputByteBufferNano.m17281h(3, barLoverConfig.barLoverCardInsertMax);
            barLoverConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BarLoverConfig parse(nc5 nc5Var) throws IOException {
            BarLoverConfig barLoverConfig = new BarLoverConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    barLoverConfig.barLoverDlg1MaxShowNoClick = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    barLoverConfig.barLoverDlg2CanShow = nc5Var.m162483g();
                } else {
                    if (iM162497u != 24) {
                        return barLoverConfig;
                    }
                    barLoverConfig.barLoverCardInsertMax = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(BarLoverConfig barLoverConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, barLoverConfig.barLoverDlg1MaxShowNoClick);
            codedOutputByteBufferNano.m17299A(2, barLoverConfig.barLoverDlg2CanShow);
            codedOutputByteBufferNano.m17305G(3, barLoverConfig.barLoverCardInsertMax);
        }
    };
    ...
    public BarLoverConfig mo225055clone() {
        BarLoverConfig barLoverConfig = new BarLoverConfig();
