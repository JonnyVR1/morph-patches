...
public class IntlFlashStickerDialogSummaryData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlFlashStickerDialogSummaryData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlFlashStickerDialogSummaryData>() { // from class: com.p1.mobile.putong.core.data.IntlFlashStickerDialogSummaryData.1
        ...
        public int computeAndCacheSize(IntlFlashStickerDialogSummaryData intlFlashStickerDialogSummaryData) {
            ...
            intlFlashStickerDialogSummaryData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlFlashStickerDialogSummaryData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    intlFlashStickerDialogSummaryData.bg_color = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    intlFlashStickerDialogSummaryData.bg_url = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    intlFlashStickerDialogSummaryData.desc_color = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    intlFlashStickerDialogSummaryData.sub_desc_color = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    intlFlashStickerDialogSummaryData.count_down_font_color = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    intlFlashStickerDialogSummaryData.passed_progress_bar_color = nc5Var.m162495s();
                } else {
                    if (iM162497u != 58) {
                        if (intlFlashStickerDialogSummaryData.bg_color == null) {
                            intlFlashStickerDialogSummaryData.bg_color = "";
                    ...
                    intlFlashStickerDialogSummaryData.remain_progress_bar_color = nc5Var.m162495s();
                }
            }
            return intlFlashStickerDialogSummaryData;
        }
    ...
    public IntlFlashStickerDialogSummaryData mo225055clone() {
        IntlFlashStickerDialogSummaryData intlFlashStickerDialogSummaryData = new IntlFlashStickerDialogSummaryData();
