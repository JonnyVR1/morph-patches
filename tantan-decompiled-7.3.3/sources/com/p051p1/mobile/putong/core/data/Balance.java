...
public class Balance extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Balance> PROTOBUF_ADAPTER = new MessageNanoAdapter<Balance>() { // from class: com.p1.mobile.putong.core.data.Balance.1
        ...
        public int computeAndCacheSize(Balance balance) {
            String str = balance.f21093id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            BalanceOpsType balanceOpsType = balance.operation;
            if (balanceOpsType != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(2, balanceOpsType.ordinal());
            }
            int iM17277d = iM17288o + CodedOutputByteBufferNano.m17277d(3, balance.amount) + CodedOutputByteBufferNano.m17277d(4, balance.actualAmount);
            BalanceStatusType balanceStatusType = balance.status;
            if (balanceStatusType != null) {
                iM17277d += CodedOutputByteBufferNano.m17281h(5, balanceStatusType.ordinal());
            }
            int iM17277d2 = iM17277d + CodedOutputByteBufferNano.m17277d(6, balance.createdTime) + CodedOutputByteBufferNano.m17277d(7, balance.updatedTime);
            String str2 = balance.failedReason;
            if (str2 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17288o(8, str2);
            }
            String str3 = balance.otherUserName;
            if (str3 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17288o(9, str3);
            }
            RedPacketGiftType redPacketGiftType = balance.giftType;
            if (redPacketGiftType != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17281h(10, redPacketGiftType.ordinal());
            }
            BalanceOpsType balanceOpsType2 = balance.operation;
            if (balanceOpsType2 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17285l(11, balanceOpsType2, BalanceOpsType.PROTOBUF_ADAPTER);
            }
            BalanceStatusType balanceStatusType2 = balance.status;
            if (balanceStatusType2 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17285l(12, balanceStatusType2, BalanceStatusType.PROTOBUF_ADAPTER);
            }
            RedPacketGiftType redPacketGiftType2 = balance.giftType;
            if (redPacketGiftType2 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17285l(13, redPacketGiftType2, RedPacketGiftType.PROTOBUF_ADAPTER);
            }
            balance.cachedSize = iM17277d2;
            return iM17277d2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Balance parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        balance.f21093id = nc5Var.m162495s();
                        continue;
                    case 16:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 25:
                        balance.amount = nc5Var.m162484h();
                        continue;
                    case 33:
                        balance.actualAmount = nc5Var.m162484h();
                        continue;
                    case 40:
                        numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 49:
                        balance.createdTime = nc5Var.m162484h();
                        continue;
                    case 57:
                        balance.updatedTime = nc5Var.m162484h();
                        continue;
                    case 66:
                        balance.failedReason = nc5Var.m162495s();
                        continue;
                    case 74:
                        balance.otherUserName = nc5Var.m162495s();
                        continue;
                    case 80:
                        numValueOf3 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 90:
                        balance.operation = (BalanceOpsType) nc5Var.m162488l(BalanceOpsType.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        balance.status = (BalanceStatusType) nc5Var.m162488l(BalanceStatusType.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        balance.giftType = (RedPacketGiftType) nc5Var.m162488l(RedPacketGiftType.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (balance.operation == null && numValueOf != null) {
                            balance.operation = (BalanceOpsType) BalanceOpsType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Balance balance, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            BalanceOpsType balanceOpsType = balance.operation;
            if (balanceOpsType != null) {
                codedOutputByteBufferNano.m17305G(2, balanceOpsType.ordinal());
            }
            codedOutputByteBufferNano.m17301C(3, balance.amount);
            codedOutputByteBufferNano.m17301C(4, balance.actualAmount);
            BalanceStatusType balanceStatusType = balance.status;
            if (balanceStatusType != null) {
                codedOutputByteBufferNano.m17305G(5, balanceStatusType.ordinal());
            }
            codedOutputByteBufferNano.m17301C(6, balance.createdTime);
            codedOutputByteBufferNano.m17301C(7, balance.updatedTime);
            String str2 = balance.failedReason;
            if (str2 != null) {
            ...
            RedPacketGiftType redPacketGiftType = balance.giftType;
            if (redPacketGiftType != null) {
                codedOutputByteBufferNano.m17305G(10, redPacketGiftType.ordinal());
            }
            BalanceOpsType balanceOpsType2 = balance.operation;
            if (balanceOpsType2 != null) {
                codedOutputByteBufferNano.m17309K(11, balanceOpsType2, BalanceOpsType.PROTOBUF_ADAPTER);
            }
            BalanceStatusType balanceStatusType2 = balance.status;
            if (balanceStatusType2 != null) {
                codedOutputByteBufferNano.m17309K(12, balanceStatusType2, BalanceStatusType.PROTOBUF_ADAPTER);
            }
            RedPacketGiftType redPacketGiftType2 = balance.giftType;
            if (redPacketGiftType2 != null) {
                codedOutputByteBufferNano.m17309K(13, redPacketGiftType2, RedPacketGiftType.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Balance balance, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "createdTime":
                    ...
                    return true;
                case "id":
                    balance.f21093id = jsonParser.getValueAsString();
                    return false;
                case "actualAmount":
    ...
    public Balance mo225055clone() {
        Balance balance = new Balance();
        balance.f21093id = this.f21093id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21093id, balance.f21093id) && ValueObject.util_equals(this.operation, balance.operation) && this.amount == balance.amount && this.actualAmount == balance.actualAmount && ValueObject.util_equals(this.status, balance.status) && this.createdTime == balance.createdTime && this.updatedTime == balance.updatedTime && ValueObject.util_equals(this.failedReason, balance.failedReason) && ValueObject.util_equals(this.otherUserName, balance.otherUserName) && ValueObject.util_equals(this.giftType, balance.giftType);
    }
