...
public class LimitTimePicture extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LimitTimePicture> PROTOBUF_ADAPTER = new MessageNanoAdapter<LimitTimePicture>() { // from class: com.p1.mobile.putong.core.data.LimitTimePicture.1
        ...
        public int computeAndCacheSize(LimitTimePicture limitTimePicture) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, limitTimePicture.duration);
            LimitTimePictureStatus limitTimePictureStatus = limitTimePicture.status;
            if (limitTimePictureStatus != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(2, limitTimePictureStatus, LimitTimePictureStatus.PROTOBUF_ADAPTER);
            }
            limitTimePicture.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LimitTimePicture parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    limitTimePicture.duration = nc5Var.m162486j();
                } else {
                    if (iM162497u != 18) {
                        if (limitTimePicture.status != null) {
                            break;
                    ...
                    limitTimePicture.status = (LimitTimePictureStatus) nc5Var.m162488l(LimitTimePictureStatus.PROTOBUF_ADAPTER);
                }
            }
            return limitTimePicture;
        }
        ...
        public void serialize(LimitTimePicture limitTimePicture, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, limitTimePicture.duration);
            LimitTimePictureStatus limitTimePictureStatus = limitTimePicture.status;
            if (limitTimePictureStatus != null) {
                codedOutputByteBufferNano.m17309K(2, limitTimePictureStatus, LimitTimePictureStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LimitTimePicture mo225055clone() {
        LimitTimePicture limitTimePicture = new LimitTimePicture();
