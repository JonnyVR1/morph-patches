...
public class LoveScript extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LoveScript> PROTOBUF_ADAPTER = new MessageNanoAdapter<LoveScript>() { // from class: com.p1.mobile.putong.core.data.LoveScript.1
        ...
        public int computeAndCacheSize(LoveScript loveScript) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, loveScript.createdTime) + CodedOutputByteBufferNano.m17283j(2, loveScript.expireTime);
            String str = loveScript.roomId;
            if (str != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(3, str);
            }
            int iM17275b = iM17283j + CodedOutputByteBufferNano.m17275b(4, loveScript.firstMessageInserted);
            loveScript.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LoveScript parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    loveScript.createdTime = nc5Var.m162487k();
                } else if (iM162497u == 16) {
                    loveScript.expireTime = nc5Var.m162487k();
                } else if (iM162497u == 26) {
                    loveScript.roomId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 32) {
                        if (loveScript.roomId != null) {
                            break;
                    ...
                    loveScript.firstMessageInserted = nc5Var.m162483g();
                }
            }
            return loveScript;
        }
        ...
        public void serialize(LoveScript loveScript, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, loveScript.createdTime);
            codedOutputByteBufferNano.m17307I(2, loveScript.expireTime);
            String str = loveScript.roomId;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(3, str);
            }
            codedOutputByteBufferNano.m17299A(4, loveScript.firstMessageInserted);
        }
    };
    ...
    public LoveScript mo225055clone() {
        LoveScript loveScript = new LoveScript();
