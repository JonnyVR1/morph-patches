...
public class MessageType extends TEnum {
    ...
    static {
        TEnumJsonAdapter<MessageType> tEnumJsonAdapter = new TEnumJsonAdapter<MessageType>() { // from class: com.p1.mobile.putong.core.data.MessageType.1
            ...
            public MessageType newTEnum(String str, int i) {
        ...
        tEnumJsonAdapter.addExtJsonValue(operation, 39);
        tEnumJsonAdapter.addExtJsonValue(song, 40);
        tEnumJsonAdapter.addExtJsonValue(ice_breaking, 41);
        tEnumJsonAdapter.addExtJsonValue(soul_test_guide, 42);
        tEnumJsonAdapter.addExtJsonValue(oneweekcp_task, 43);
        tEnumJsonAdapter.addExtJsonValue(local_create_chat_group, 44);
        tEnumJsonAdapter.addExtJsonValue(conversation_notification, 45);
        tEnumJsonAdapter.addExtJsonValue(red_packet, 46);
        tEnumJsonAdapter.addExtJsonValue(red_packet_notification, 47);
        tEnumJsonAdapter.addExtJsonValue(red_packet_text_record, 48);
        tEnumJsonAdapter.addExtJsonValue(chat_gift, 49);
        tEnumJsonAdapter.addExtJsonValue(moment_gift, 50);
        tEnumJsonAdapter.addExtJsonValue(new_survey, 51);
        tEnumJsonAdapter.addExtJsonValue(picture_text_style, 52);
        tEnumJsonAdapter.addExtJsonValue(real_shot, 53);
        tEnumJsonAdapter.addExtJsonValue(local_greeting_reply, 54);
        tEnumJsonAdapter.addExtJsonValue(local_send_agreematch_notice, 55);
        tEnumJsonAdapter.addExtJsonValue(local_greeting_agree_match, 56);
        tEnumJsonAdapter.addExtJsonValue(local_greeting_match_success, 57);
        tEnumJsonAdapter.addExtJsonValue(local_chat_greeting_tip, 58);
        tEnumJsonAdapter.addExtJsonValue(moment_notification, 59);
        tEnumJsonAdapter.addExtJsonValue(local_countdown_like_notify, 60);
        tEnumJsonAdapter.addExtJsonValue(local_countdown_like_success, 61);
        tEnumJsonAdapter.addExtJsonValue(local_real_shot_tips, 62);
        tEnumJsonAdapter.addExtJsonValue(local_chat_inc_temp_warn, 63);
        tEnumJsonAdapter.addExtJsonValue(local_meet_reply, 64);
        tEnumJsonAdapter.addExtJsonValue(christmas_match, 65);
        tEnumJsonAdapter.addExtJsonValue(soul_match_invite_upload_profile, 66);
        ...
        _MessageType = Collections.synchronizedMap(new l01());
    }
    ...
    public static MessageType get(String str) {
        ...
        if (messageType == null) {
            ...
            messageType = integer == null ? new MessageType(str, -1) : new MessageType(str, integer.intValue());
