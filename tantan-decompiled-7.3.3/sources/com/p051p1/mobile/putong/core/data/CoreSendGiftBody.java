...
public class CoreSendGiftBody extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreSendGiftBody> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreSendGiftBody>() { // from class: com.p1.mobile.putong.core.data.CoreSendGiftBody.1
        ...
        public int computeAndCacheSize(CoreSendGiftBody coreSendGiftBody) {
            ...
            if (sendGiftExtra != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, sendGiftExtra, SendGiftExtra.PROTOBUF_ADAPTER);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(4, coreSendGiftBody.giftAmount);
            ...
            if (giftSubBizType != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(7, giftSubBizType, GiftSubBizType.PROTOBUF_ADAPTER);
            }
            GiftSubBizType giftSubBizType2 = coreSendGiftBody.subBizType;
            if (giftSubBizType2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(8, giftSubBizType2.ordinal());
            }
            ...
            coreSendGiftBody.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreSendGiftBody parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        coreSendGiftBody.bizIdentifier = nc5Var.m162495s();
                        continue;
                    case 18:
                        coreSendGiftBody.bizType = nc5Var.m162495s();
                        continue;
                    case 26:
                        coreSendGiftBody.extra = (SendGiftExtra) nc5Var.m162488l(SendGiftExtra.PROTOBUF_ADAPTER);
                        continue;
                    case 32:
                        coreSendGiftBody.giftAmount = nc5Var.m162486j();
                        continue;
                    case 42:
                        coreSendGiftBody.giftID = nc5Var.m162495s();
                        continue;
                    case 50:
                        coreSendGiftBody.recvUserID = nc5Var.m162495s();
                        continue;
                    case 58:
                        coreSendGiftBody.subBizType = (GiftSubBizType) nc5Var.m162488l(GiftSubBizType.PROTOBUF_ADAPTER);
                        continue;
                    case 64:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 74:
                        coreSendGiftBody.consumeType = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        coreSendGiftBody.coinSign = nc5Var.m162495s();
                        continue;
                    default:
                        if (coreSendGiftBody.subBizType == null && numValueOf != null) {
                            coreSendGiftBody.subBizType = (GiftSubBizType) GiftSubBizType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(CoreSendGiftBody coreSendGiftBody, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            SendGiftExtra sendGiftExtra = coreSendGiftBody.extra;
            if (sendGiftExtra != null) {
                codedOutputByteBufferNano.m17309K(3, sendGiftExtra, SendGiftExtra.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(4, coreSendGiftBody.giftAmount);
            String str3 = coreSendGiftBody.giftID;
            if (str3 != null) {
            ...
            GiftSubBizType giftSubBizType = coreSendGiftBody.subBizType;
            if (giftSubBizType != null) {
                codedOutputByteBufferNano.m17309K(7, giftSubBizType, GiftSubBizType.PROTOBUF_ADAPTER);
            }
            GiftSubBizType giftSubBizType2 = coreSendGiftBody.subBizType;
            if (giftSubBizType2 != null) {
                codedOutputByteBufferNano.m17305G(8, giftSubBizType2.ordinal());
            }
            String str5 = coreSendGiftBody.consumeType;
            if (str5 != null) {
    ...
    public CoreSendGiftBody mo225055clone() {
        CoreSendGiftBody coreSendGiftBody = new CoreSendGiftBody();
        ...
        if (sendGiftExtra != null) {
            coreSendGiftBody.extra = sendGiftExtra.mo225055clone();
        }
