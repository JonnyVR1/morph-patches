...
public class MomentTag extends ValueObject implements Cloneable, Serializable {
    ...
    public String value;
    public static ProtobufAdapter<MomentTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<MomentTag>() { // from class: com.p1.mobile.putong.core.data.MomentTag.1
        {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(MomentTag momentTag) {
            ...
            momentTag.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MomentTag parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    momentTag.value = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    momentTag.href = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (momentTag.value == null) {
                            momentTag.value = "";
                    ...
                    momentTag.icon = nc5Var.m162495s();
                }
            }
            return momentTag;
        }
    ...
    public static JsonAdapter<MomentTag> JSON_ADAPTER = new ObjectJsonAdapter<MomentTag>() { // from class: com.p1.mobile.putong.core.data.MomentTag.2
    ...
    public MomentTag mo225055clone() {
        MomentTag momentTag = new MomentTag();
