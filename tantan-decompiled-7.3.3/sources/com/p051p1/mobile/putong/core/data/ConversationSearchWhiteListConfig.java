...
import com.p051p1.mobile.putong.core.data.ConversationSearchWhiteListConfig;
...
public class ConversationSearchWhiteListConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConversationSearchWhiteListConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConversationSearchWhiteListConfig>() { // from class: com.p1.mobile.putong.core.data.ConversationSearchWhiteListConfig.1
        ...
        public int computeAndCacheSize(ConversationSearchWhiteListConfig conversationSearchWhiteListConfig) {
            ...
            conversationSearchWhiteListConfig.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConversationSearchWhiteListConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                conversationSearchWhiteListConfig.white_list = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            return conversationSearchWhiteListConfig;
        }
    ...
    public static /* synthetic */ String m36305a(String str) {
        return str;
    }
    ...
    public ConversationSearchWhiteListConfig mo225055clone() {
        ConversationSearchWhiteListConfig conversationSearchWhiteListConfig = new ConversationSearchWhiteListConfig();
        List<String> list = this.white_list;
        if (list != null) {
            conversationSearchWhiteListConfig.white_list = ValueObject.util_map(list, new qcj() { // from class: l.il6
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ConversationSearchWhiteListConfig.m36305a((String) obj);
                }
            });
        }
        return conversationSearchWhiteListConfig;
