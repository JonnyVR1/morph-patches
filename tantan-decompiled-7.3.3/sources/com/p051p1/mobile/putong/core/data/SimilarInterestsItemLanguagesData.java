...
public class SimilarInterestsItemLanguagesData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SimilarInterestsItemLanguagesData> PROTOBUF_ADAPTER = new MessageNanoAdapter<SimilarInterestsItemLanguagesData>() { // from class: com.p1.mobile.putong.core.data.SimilarInterestsItemLanguagesData.1
        ...
        public int computeAndCacheSize(SimilarInterestsItemLanguagesData similarInterestsItemLanguagesData) {
            ...
            int iM17285l = similarInterestsItemSwipeData != null ? CodedOutputByteBufferNano.m17285l(1, similarInterestsItemSwipeData, SimilarInterestsItemSwipeData.PROTOBUF_ADAPTER) : 0;
            ...
            if (similarInterestsItemStatusData != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, similarInterestsItemStatusData, SimilarInterestsItemStatusData.PROTOBUF_ADAPTER);
            }
            ...
            if (str3 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(5, str3);
            }
            String str4 = similarInterestsItemLanguagesData.avatarTitle;
            if (str4 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(6, str4);
            }
            similarInterestsItemLanguagesData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SimilarInterestsItemLanguagesData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    similarInterestsItemLanguagesData.swipe = (SimilarInterestsItemSwipeData) nc5Var.m162488l(SimilarInterestsItemSwipeData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    similarInterestsItemLanguagesData.status = (SimilarInterestsItemStatusData) nc5Var.m162488l(SimilarInterestsItemStatusData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    similarInterestsItemLanguagesData.titleIcon = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    similarInterestsItemLanguagesData.desc = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    similarInterestsItemLanguagesData.avatar = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (similarInterestsItemLanguagesData.titleIcon == null) {
                            similarInterestsItemLanguagesData.titleIcon = "";
                    ...
                    similarInterestsItemLanguagesData.avatarTitle = nc5Var.m162495s();
                }
            }
            return similarInterestsItemLanguagesData;
        }
        ...
        public void serialize(SimilarInterestsItemLanguagesData similarInterestsItemLanguagesData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (similarInterestsItemSwipeData != null) {
                codedOutputByteBufferNano.m17309K(1, similarInterestsItemSwipeData, SimilarInterestsItemSwipeData.PROTOBUF_ADAPTER);
            }
            SimilarInterestsItemStatusData similarInterestsItemStatusData = similarInterestsItemLanguagesData.status;
            if (similarInterestsItemStatusData != null) {
                codedOutputByteBufferNano.m17309K(2, similarInterestsItemStatusData, SimilarInterestsItemStatusData.PROTOBUF_ADAPTER);
            }
            String str = similarInterestsItemLanguagesData.titleIcon;
            if (str != null) {
    ...
    public SimilarInterestsItemLanguagesData mo225055clone() {
        SimilarInterestsItemLanguagesData similarInterestsItemLanguagesData = new SimilarInterestsItemLanguagesData();
        ...
        if (similarInterestsItemSwipeData != null) {
            similarInterestsItemLanguagesData.swipe = similarInterestsItemSwipeData.mo225055clone();
        }
        SimilarInterestsItemStatusData similarInterestsItemStatusData = this.status;
        if (similarInterestsItemStatusData != null) {
            similarInterestsItemLanguagesData.status = similarInterestsItemStatusData.mo225055clone();
        }
        return similarInterestsItemLanguagesData;
    }
