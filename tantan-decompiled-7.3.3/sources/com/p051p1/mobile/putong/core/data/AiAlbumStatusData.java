...
public class AiAlbumStatusData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AiAlbumStatusData> PROTOBUF_ADAPTER = new MessageNanoAdapter<AiAlbumStatusData>() { // from class: com.p1.mobile.putong.core.data.AiAlbumStatusData.1
        ...
        public int computeAndCacheSize(AiAlbumStatusData aiAlbumStatusData) {
            ...
            if (aiAlbumCheckingData != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, aiAlbumCheckingData, AiAlbumCheckingData.PROTOBUF_ADAPTER);
            }
            AiAlbumProcessingData aiAlbumProcessingData = aiAlbumStatusData.processing;
            if (aiAlbumProcessingData != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, aiAlbumProcessingData, AiAlbumProcessingData.PROTOBUF_ADAPTER);
            }
            AiAlbumFinishedData aiAlbumFinishedData = aiAlbumStatusData.finished;
            if (aiAlbumFinishedData != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, aiAlbumFinishedData, AiAlbumFinishedData.PROTOBUF_ADAPTER);
            }
            String str3 = aiAlbumStatusData.templateId;
            if (str3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(6, str3);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(7, aiAlbumStatusData.availableTimes);
            aiAlbumStatusData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AiAlbumStatusData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    aiAlbumStatusData.albumId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    aiAlbumStatusData.status = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    aiAlbumStatusData.checking = (AiAlbumCheckingData) nc5Var.m162488l(AiAlbumCheckingData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    aiAlbumStatusData.processing = (AiAlbumProcessingData) nc5Var.m162488l(AiAlbumProcessingData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    aiAlbumStatusData.finished = (AiAlbumFinishedData) nc5Var.m162488l(AiAlbumFinishedData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 50) {
                    aiAlbumStatusData.templateId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 56) {
                        if (aiAlbumStatusData.albumId == null) {
                            aiAlbumStatusData.albumId = "";
                    ...
                    aiAlbumStatusData.availableTimes = nc5Var.m162486j();
                }
            }
            return aiAlbumStatusData;
        }
        ...
        public void serialize(AiAlbumStatusData aiAlbumStatusData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            AiAlbumCheckingData aiAlbumCheckingData = aiAlbumStatusData.checking;
            if (aiAlbumCheckingData != null) {
                codedOutputByteBufferNano.m17309K(3, aiAlbumCheckingData, AiAlbumCheckingData.PROTOBUF_ADAPTER);
            }
            AiAlbumProcessingData aiAlbumProcessingData = aiAlbumStatusData.processing;
            if (aiAlbumProcessingData != null) {
                codedOutputByteBufferNano.m17309K(4, aiAlbumProcessingData, AiAlbumProcessingData.PROTOBUF_ADAPTER);
            }
            AiAlbumFinishedData aiAlbumFinishedData = aiAlbumStatusData.finished;
            if (aiAlbumFinishedData != null) {
                codedOutputByteBufferNano.m17309K(5, aiAlbumFinishedData, AiAlbumFinishedData.PROTOBUF_ADAPTER);
            }
            String str3 = aiAlbumStatusData.templateId;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(6, str3);
            }
            codedOutputByteBufferNano.m17305G(7, aiAlbumStatusData.availableTimes);
        }
    };
    ...
    public AiAlbumStatusData mo225055clone() {
        AiAlbumStatusData aiAlbumStatusData = new AiAlbumStatusData();
        ...
        if (aiAlbumCheckingData != null) {
            aiAlbumStatusData.checking = aiAlbumCheckingData.mo225055clone();
        }
        AiAlbumProcessingData aiAlbumProcessingData = this.processing;
        if (aiAlbumProcessingData != null) {
            aiAlbumStatusData.processing = aiAlbumProcessingData.mo225055clone();
        }
        AiAlbumFinishedData aiAlbumFinishedData = this.finished;
        if (aiAlbumFinishedData != null) {
            aiAlbumStatusData.finished = aiAlbumFinishedData.mo225055clone();
        }
