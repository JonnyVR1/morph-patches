...
public class PaymentOrder extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PaymentOrder> PROTOBUF_ADAPTER = new MessageNanoAdapter<PaymentOrder>() { // from class: com.p1.mobile.putong.core.data.PaymentOrder.1
        ...
        public int computeAndCacheSize(PaymentOrder paymentOrder) {
            String str = paymentOrder.f21207id;
            ...
            if (productCategory != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(5, productCategory.ordinal());
            }
            int iM17277d = iM17288o + CodedOutputByteBufferNano.m17277d(6, paymentOrder.amount);
            PaymentOrderStatus paymentOrderStatus = paymentOrder.status;
            if (paymentOrderStatus != null) {
                iM17277d += CodedOutputByteBufferNano.m17281h(7, paymentOrderStatus.ordinal());
            }
            int iM17277d2 = iM17277d + CodedOutputByteBufferNano.m17277d(8, paymentOrder.createdTime);
            ProductCategory productCategory2 = paymentOrder.productType;
            if (productCategory2 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17285l(9, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            PaymentOrderStatus paymentOrderStatus2 = paymentOrder.status;
            if (paymentOrderStatus2 != null) {
                iM17277d2 += CodedOutputByteBufferNano.m17285l(10, paymentOrderStatus2, PaymentOrderStatus.PROTOBUF_ADAPTER);
            }
            paymentOrder.cachedSize = iM17277d2;
            return iM17277d2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PaymentOrder parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        if (paymentOrder.f21207id == null) {
                            paymentOrder.f21207id = "";
                        }
                        ...
                        break;
                    case 10:
                        paymentOrder.f21207id = nc5Var.m162495s();
                        continue;
                    case 18:
                        paymentOrder.type = nc5Var.m162495s();
                        continue;
                    case 26:
                        paymentOrder.itemId = nc5Var.m162495s();
                        continue;
                    case 34:
                        paymentOrder.itemName = nc5Var.m162495s();
                        continue;
                    case 40:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 49:
                        paymentOrder.amount = nc5Var.m162484h();
                        continue;
                    case 56:
                        numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 65:
                        paymentOrder.createdTime = nc5Var.m162484h();
                        continue;
                    case 74:
                        paymentOrder.productType = (ProductCategory) nc5Var.m162488l(ProductCategory.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        paymentOrder.status = (PaymentOrderStatus) nc5Var.m162488l(PaymentOrderStatus.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (paymentOrder.productType == null && numValueOf != null) {
                            paymentOrder.productType = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(PaymentOrder paymentOrder, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ProductCategory productCategory = paymentOrder.productType;
            if (productCategory != null) {
                codedOutputByteBufferNano.m17305G(5, productCategory.ordinal());
            }
            codedOutputByteBufferNano.m17301C(6, paymentOrder.amount);
            PaymentOrderStatus paymentOrderStatus = paymentOrder.status;
            if (paymentOrderStatus != null) {
                codedOutputByteBufferNano.m17305G(7, paymentOrderStatus.ordinal());
            }
            codedOutputByteBufferNano.m17301C(8, paymentOrder.createdTime);
            ProductCategory productCategory2 = paymentOrder.productType;
            if (productCategory2 != null) {
                codedOutputByteBufferNano.m17309K(9, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            PaymentOrderStatus paymentOrderStatus2 = paymentOrder.status;
            if (paymentOrderStatus2 != null) {
                codedOutputByteBufferNano.m17309K(10, paymentOrderStatus2, PaymentOrderStatus.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(PaymentOrder paymentOrder, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "createdTime":
                    ...
                    return true;
                case "id":
                    paymentOrder.f21207id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public PaymentOrder mo225055clone() {
        PaymentOrder paymentOrder = new PaymentOrder();
        paymentOrder.f21207id = this.f21207id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21207id, paymentOrder.f21207id) && ValueObject.util_equals(this.type, paymentOrder.type) && ValueObject.util_equals(this.itemId, paymentOrder.itemId) && ValueObject.util_equals(this.itemName, paymentOrder.itemName) && ValueObject.util_equals(this.productType, paymentOrder.productType) && this.amount == paymentOrder.amount && ValueObject.util_equals(this.status, paymentOrder.status) && this.createdTime == paymentOrder.createdTime;
    }
