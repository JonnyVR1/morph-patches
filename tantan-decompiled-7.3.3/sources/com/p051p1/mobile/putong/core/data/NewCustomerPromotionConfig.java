...
public class NewCustomerPromotionConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NewCustomerPromotionConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<NewCustomerPromotionConfig>() { // from class: com.p1.mobile.putong.core.data.NewCustomerPromotionConfig.1
        ...
        public int computeAndCacheSize(NewCustomerPromotionConfig newCustomerPromotionConfig) {
            ...
            if (newCustomerPromotionConfigItem != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, newCustomerPromotionConfigItem, NewCustomerPromotionConfigItem.PROTOBUF_ADAPTER);
            }
            ...
            newCustomerPromotionConfig.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NewCustomerPromotionConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    newCustomerPromotionConfig.couponId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    newCustomerPromotionConfig.purchaseButtonText = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    newCustomerPromotionConfig.privilegeText = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    newCustomerPromotionConfig.privilegeBannerText = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    newCustomerPromotionConfig.purchaseItem = (NewCustomerPromotionConfigItem) nc5Var.m162488l(NewCustomerPromotionConfigItem.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 50) {
                        if (newCustomerPromotionConfig.couponId == null) {
                            newCustomerPromotionConfig.couponId = "";
                    ...
                    newCustomerPromotionConfig.privilegeSwitchTexts = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return newCustomerPromotionConfig;
        }
        ...
        public void serialize(NewCustomerPromotionConfig newCustomerPromotionConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            NewCustomerPromotionConfigItem newCustomerPromotionConfigItem = newCustomerPromotionConfig.purchaseItem;
            if (newCustomerPromotionConfigItem != null) {
                codedOutputByteBufferNano.m17309K(5, newCustomerPromotionConfigItem, NewCustomerPromotionConfigItem.PROTOBUF_ADAPTER);
            }
            List<String> list = newCustomerPromotionConfig.privilegeSwitchTexts;
            if (list != null) {
    ...
    public static /* synthetic */ String m36720a(String str) {
        return str;
    }
    ...
    public NewCustomerPromotionConfig mo225055clone() {
        NewCustomerPromotionConfig newCustomerPromotionConfig = new NewCustomerPromotionConfig();
        ...
        if (newCustomerPromotionConfigItem != null) {
            newCustomerPromotionConfig.purchaseItem = newCustomerPromotionConfigItem.mo225055clone();
        }
        List<String> list = this.privilegeSwitchTexts;
        if (list != null) {
            newCustomerPromotionConfig.privilegeSwitchTexts = ValueObject.util_map(list, new qcj() { // from class: l.nu20
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return NewCustomerPromotionConfig.m36720a((String) obj);
                }
            });
        }
        return newCustomerPromotionConfig;
