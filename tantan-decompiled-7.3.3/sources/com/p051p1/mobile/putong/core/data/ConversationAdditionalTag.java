...
public class ConversationAdditionalTag extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConversationAdditionalTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConversationAdditionalTag>() { // from class: com.p1.mobile.putong.core.data.ConversationAdditionalTag.1
        ...
        public int computeAndCacheSize(ConversationAdditionalTag conversationAdditionalTag) {
            ...
            int iM17285l = (conversationAdditionalTagType != null ? CodedOutputByteBufferNano.m17285l(1, conversationAdditionalTagType, ConversationAdditionalTagType.PROTOBUF_ADAPTER) : 0) + CodedOutputByteBufferNano.m17275b(2, conversationAdditionalTag.top) + CodedOutputByteBufferNano.m17283j(3, conversationAdditionalTag.expireTime);
            conversationAdditionalTag.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConversationAdditionalTag parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    conversationAdditionalTag.type = (ConversationAdditionalTagType) nc5Var.m162488l(ConversationAdditionalTagType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 16) {
                    conversationAdditionalTag.top = nc5Var.m162483g();
                } else {
                    if (iM162497u != 24) {
                        if (conversationAdditionalTag.type != null) {
                            break;
                    ...
                    conversationAdditionalTag.expireTime = nc5Var.m162487k();
                }
            }
            return conversationAdditionalTag;
        }
        ...
        public void serialize(ConversationAdditionalTag conversationAdditionalTag, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (conversationAdditionalTagType != null) {
                codedOutputByteBufferNano.m17309K(1, conversationAdditionalTagType, ConversationAdditionalTagType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(2, conversationAdditionalTag.top);
            codedOutputByteBufferNano.m17307I(3, conversationAdditionalTag.expireTime);
        }
    };
    ...
    public ConversationAdditionalTag mo225055clone() {
        ConversationAdditionalTag conversationAdditionalTag = new ConversationAdditionalTag();
