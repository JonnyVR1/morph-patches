...
public class MbtiConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MbtiConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<MbtiConfig>() { // from class: com.p1.mobile.putong.core.data.MbtiConfig.1
        ...
        public int computeAndCacheSize(MbtiConfig mbtiConfig) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, MbtiInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            mbtiConfig.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MbtiConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                mbtiConfig.mbtis = (List) nc5Var.m162488l(MbtiInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return mbtiConfig;
        }
        ...
        public void serialize(MbtiConfig mbtiConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<MbtiInfo> list = mbtiConfig.mbtis;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, MbtiInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public MbtiConfig mo225055clone() {
        MbtiConfig mbtiConfig = new MbtiConfig();
        List<MbtiInfo> list = this.mbtis;
        if (list != null) {
            mbtiConfig.mbtis = ValueObject.util_map(list, new qcj() { // from class: l.thx
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((MbtiInfo) obj).mo225055clone();
                }
            });
        }
        return mbtiConfig;
