...
public class PurposeItemData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PurposeItemData> PROTOBUF_ADAPTER = new MessageNanoAdapter<PurposeItemData>() { // from class: com.p1.mobile.putong.core.data.PurposeItemData.1
        ...
        public int computeAndCacheSize(PurposeItemData purposeItemData) {
            ...
            purposeItemData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PurposeItemData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    purposeItemData.text = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    purposeItemData.key = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    purposeItemData.picSelected = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    purposeItemData.pic = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    purposeItemData.purposeReport = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    purposeItemData.enableRule = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 58) {
                    purposeItemData.icon1 = nc5Var.m162495s();
                } else {
                    if (iM162497u != 66) {
                        if (purposeItemData.text == null) {
                            purposeItemData.text = "";
                    ...
                    purposeItemData.icon2 = nc5Var.m162495s();
                }
            }
            return purposeItemData;
        }
    ...
    public static /* synthetic */ String m36790a(String str) {
        return str;
    }
    ...
    public PurposeItemData mo225055clone() {
        PurposeItemData purposeItemData = new PurposeItemData();
        ...
        if (list != null) {
            purposeItemData.enableRule = ValueObject.util_map(list, new qcj() { // from class: l.xkb0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return PurposeItemData.m36790a((String) obj);
                }
            });
        }
