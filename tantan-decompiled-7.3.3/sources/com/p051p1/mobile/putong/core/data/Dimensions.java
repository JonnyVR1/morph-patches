...
public class Dimensions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Dimensions> PROTOBUF_ADAPTER = new MessageNanoAdapter<Dimensions>() { // from class: com.p1.mobile.putong.core.data.Dimensions.1
        ...
        public int computeAndCacheSize(Dimensions dimensions) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, dimensions.value);
            dimensions.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Dimensions parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    dimensions.key = nc5Var.m162495s();
                } else {
                    if (iM162497u != 16) {
                        if (dimensions.key != null) {
                            break;
                    ...
                    dimensions.value = nc5Var.m162486j();
                }
            }
            return dimensions;
        }
        ...
        public void serialize(Dimensions dimensions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, dimensions.value);
        }
    };
    ...
    public Dimensions mo225055clone() {
        Dimensions dimensions = new Dimensions();
