...
public class RecallMembershipData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RecallMembershipData> PROTOBUF_ADAPTER = new MessageNanoAdapter<RecallMembershipData>() { // from class: com.p1.mobile.putong.core.data.RecallMembershipData.1
        ...
        public int computeAndCacheSize(RecallMembershipData recallMembershipData) {
            ...
            recallMembershipData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RecallMembershipData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        recallMembershipData.cardBackgroundUrl = nc5Var.m162495s();
                        continue;
                    case 18:
                        recallMembershipData.cardTitle = nc5Var.m162495s();
                        continue;
                    case 26:
                        recallMembershipData.cardDesc = nc5Var.m162495s();
                        continue;
                    case 34:
                        recallMembershipData.cardLogo = nc5Var.m162495s();
                        continue;
                    case 42:
                        recallMembershipData.cardBtnTitle = nc5Var.m162495s();
                        continue;
                    case 50:
                        recallMembershipData.cardBtnSubTitle = nc5Var.m162495s();
                        continue;
                    case 58:
                        recallMembershipData.membershipType = nc5Var.m162495s();
                        continue;
                    case 66:
                        recallMembershipData.quantity = nc5Var.m162495s();
                        continue;
                    case 74:
                        recallMembershipData.h5URL = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        recallMembershipData.channel = nc5Var.m162495s();
                        continue;
                    default:
                        if (recallMembershipData.cardBackgroundUrl == null) {
                            recallMembershipData.cardBackgroundUrl = "";
    ...
    public RecallMembershipData mo225055clone() {
        RecallMembershipData recallMembershipData = new RecallMembershipData();
