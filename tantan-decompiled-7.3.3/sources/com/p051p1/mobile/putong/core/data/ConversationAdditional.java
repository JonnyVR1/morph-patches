...
public class ConversationAdditional extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConversationAdditional> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConversationAdditional>() { // from class: com.p1.mobile.putong.core.data.ConversationAdditional.1
        ...
        public int computeAndCacheSize(ConversationAdditional conversationAdditional) {
            ...
            int iM17285l = conversationAdditionalQuickChat != null ? CodedOutputByteBufferNano.m17285l(1, conversationAdditionalQuickChat, ConversationAdditionalQuickChat.PROTOBUF_ADAPTER) : 0;
            VoiceCallAdditional voiceCallAdditional = conversationAdditional.voiceCall;
            if (voiceCallAdditional != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, voiceCallAdditional, VoiceCallAdditional.PROTOBUF_ADAPTER);
            }
            TimeLimited timeLimited = conversationAdditional.timeLimited;
            if (timeLimited != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, timeLimited, TimeLimited.PROTOBUF_ADAPTER);
            }
            ...
            if (oneSideNoMatchConversation != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, oneSideNoMatchConversation, OneSideNoMatchConversation.PROTOBUF_ADAPTER);
            }
            ...
            if (conversationAdditionalOneSide != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, conversationAdditionalOneSide, ConversationAdditionalOneSide.PROTOBUF_ADAPTER);
            }
            ...
            if (conversationAdditionalKanKanContent != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(6, conversationAdditionalKanKanContent, ConversationAdditionalKanKanContent.PROTOBUF_ADAPTER);
            }
            CoreFeedStateCounter coreFeedStateCounter = conversationAdditional.feedStateCounter;
            if (coreFeedStateCounter != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(7, coreFeedStateCounter, CoreFeedStateCounter.PROTOBUF_ADAPTER);
            }
            ...
            if (suggestedTimeLimitedMatch != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(8, suggestedTimeLimitedMatch, SuggestedTimeLimitedMatch.PROTOBUF_ADAPTER);
            }
            HeartbeatMatch heartbeatMatch = conversationAdditional.heartbeatMatch;
            if (heartbeatMatch != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(9, heartbeatMatch, HeartbeatMatch.PROTOBUF_ADAPTER);
            }
            AvatarSummaryCounter avatarSummaryCounter = conversationAdditional.avatarSummary;
            if (avatarSummaryCounter != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(10, avatarSummaryCounter, AvatarSummaryCounter.PROTOBUF_ADAPTER);
            }
            ...
            if (coreInteractionMessageCounter != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(11, coreInteractionMessageCounter, CoreInteractionMessageCounter.PROTOBUF_ADAPTER);
            }
            ...
            if (virtualVoiceGroupConversationCell != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(12, virtualVoiceGroupConversationCell, VirtualVoiceGroupConversationCell.PROTOBUF_ADAPTER);
            }
            ConversationMomentInfo conversationMomentInfo = conversationAdditional.localMomentInfo;
            if (conversationMomentInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(13, conversationMomentInfo, ConversationMomentInfo.PROTOBUF_ADAPTER);
            }
            LiveActivityConversation liveActivityConversation = conversationAdditional.liveActivity;
            if (liveActivityConversation != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(14, liveActivityConversation, LiveActivityConversation.PROTOBUF_ADAPTER);
            }
            ConversationGame conversationGame = conversationAdditional.game;
            if (conversationGame != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(15, conversationGame, ConversationGame.PROTOBUF_ADAPTER);
            }
            ConversationAdditionalTag conversationAdditionalTag = conversationAdditional.tag;
            if (conversationAdditionalTag != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(16, conversationAdditionalTag, ConversationAdditionalTag.PROTOBUF_ADAPTER);
            }
            ...
            if (conversationAdditionalChatAssistantQuestion != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(17, conversationAdditionalChatAssistantQuestion, ConversationAdditionalChatAssistantQuestion.PROTOBUF_ADAPTER);
            }
            ContinuousChat continuousChat = conversationAdditional.continuousChat;
            if (continuousChat != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(18, continuousChat, ContinuousChat.PROTOBUF_ADAPTER);
            }
            PlatinumPinChat platinumPinChat = conversationAdditional.pinChat;
            if (platinumPinChat != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(19, platinumPinChat, PlatinumPinChat.PROTOBUF_ADAPTER);
            }
            ReSwipeInfo reSwipeInfo = conversationAdditional.reSwipe;
            if (reSwipeInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(20, reSwipeInfo, ReSwipeInfo.PROTOBUF_ADAPTER);
            }
            GrowthConversationBlindBox growthConversationBlindBox = conversationAdditional.blindbox;
            if (growthConversationBlindBox != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(21, growthConversationBlindBox, GrowthConversationBlindBox.PROTOBUF_ADAPTER);
            }
            List<String> list = conversationAdditional.previewTexts;
            if (list != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(22, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            GreetingInfo greetingInfo = conversationAdditional.greetingInfo;
            if (greetingInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(23, greetingInfo, GreetingInfo.PROTOBUF_ADAPTER);
            }
            ...
            if (conversationAdditionalFateRadar != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(24, conversationAdditionalFateRadar, ConversationAdditionalFateRadar.PROTOBUF_ADAPTER);
            }
            LowPayOneside lowPayOneside = conversationAdditional.lowPayOneside;
            if (lowPayOneside != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(25, lowPayOneside, LowPayOneside.PROTOBUF_ADAPTER);
            }
            ConvAdditionalMatchInfo convAdditionalMatchInfo = conversationAdditional.matchInfo;
            if (convAdditionalMatchInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(26, convAdditionalMatchInfo, ConvAdditionalMatchInfo.PROTOBUF_ADAPTER);
            }
            ExposureNewMatch exposureNewMatch = conversationAdditional.newMatch;
            if (exposureNewMatch != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(27, exposureNewMatch, ExposureNewMatch.PROTOBUF_ADAPTER);
            }
            ConvAdditionalLoveLetter convAdditionalLoveLetter = conversationAdditional.loveLetter;
            if (convAdditionalLoveLetter != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(28, convAdditionalLoveLetter, ConvAdditionalLoveLetter.PROTOBUF_ADAPTER);
            }
            ChatMM chatMM = conversationAdditional.chatMM;
            if (chatMM != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(29, chatMM, ChatMM.PROTOBUF_ADAPTER);
            }
            BlackList blackList = conversationAdditional.blackList;
            if (blackList != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(30, blackList, BlackList.PROTOBUF_ADAPTER);
            }
            MessageRelate messageRelate = conversationAdditional.messageRelate;
            if (messageRelate != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(31, messageRelate, MessageRelate.PROTOBUF_ADAPTER);
            }
            ConvAdditionalCompliment convAdditionalCompliment = conversationAdditional.compliment;
            if (convAdditionalCompliment != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(32, convAdditionalCompliment, ConvAdditionalCompliment.PROTOBUF_ADAPTER);
            }
            ConvAdditionalSwiper convAdditionalSwiper = conversationAdditional.swiper;
            if (convAdditionalSwiper != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(33, convAdditionalSwiper, ConvAdditionalSwiper.PROTOBUF_ADAPTER);
            }
            conversationAdditional.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConversationAdditional parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        conversationAdditional.quickChat = (ConversationAdditionalQuickChat) nc5Var.m162488l(ConversationAdditionalQuickChat.PROTOBUF_ADAPTER);
                        continue;
                    case 18:
                        conversationAdditional.voiceCall = (VoiceCallAdditional) nc5Var.m162488l(VoiceCallAdditional.PROTOBUF_ADAPTER);
                        continue;
                    case 26:
                        conversationAdditional.timeLimited = (TimeLimited) nc5Var.m162488l(TimeLimited.PROTOBUF_ADAPTER);
                        continue;
                    case 34:
                        conversationAdditional.oneSideNoMatch = (OneSideNoMatchConversation) nc5Var.m162488l(OneSideNoMatchConversation.PROTOBUF_ADAPTER);
                        continue;
                    case 42:
                        conversationAdditional.oneSide = (ConversationAdditionalOneSide) nc5Var.m162488l(ConversationAdditionalOneSide.PROTOBUF_ADAPTER);
                        continue;
                    case 50:
                        conversationAdditional.kankan = (ConversationAdditionalKanKanContent) nc5Var.m162488l(ConversationAdditionalKanKanContent.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        conversationAdditional.feedStateCounter = (CoreFeedStateCounter) nc5Var.m162488l(CoreFeedStateCounter.PROTOBUF_ADAPTER);
                        continue;
                    case 66:
                        conversationAdditional.suggestedTimeLimitedMatch = (SuggestedTimeLimitedMatch) nc5Var.m162488l(SuggestedTimeLimitedMatch.PROTOBUF_ADAPTER);
                        continue;
                    case 74:
                        conversationAdditional.heartbeatMatch = (HeartbeatMatch) nc5Var.m162488l(HeartbeatMatch.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        conversationAdditional.avatarSummary = (AvatarSummaryCounter) nc5Var.m162488l(AvatarSummaryCounter.PROTOBUF_ADAPTER);
                        continue;
                    case 90:
                        conversationAdditional.feedInteractionCounter = (CoreInteractionMessageCounter) nc5Var.m162488l(CoreInteractionMessageCounter.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        conversationAdditional.liveVirtualVoice = (VirtualVoiceGroupConversationCell) nc5Var.m162488l(VirtualVoiceGroupConversationCell.PROTOBUF_ADAPTER);
                        continue;
                    case 106:
                        conversationAdditional.localMomentInfo = (ConversationMomentInfo) nc5Var.m162488l(ConversationMomentInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 114:
                        conversationAdditional.liveActivity = (LiveActivityConversation) nc5Var.m162488l(LiveActivityConversation.PROTOBUF_ADAPTER);
                        continue;
                    case 122:
                        conversationAdditional.game = (ConversationGame) nc5Var.m162488l(ConversationGame.PROTOBUF_ADAPTER);
                        continue;
                    case 130:
                        conversationAdditional.tag = (ConversationAdditionalTag) nc5Var.m162488l(ConversationAdditionalTag.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        conversationAdditional.chatAssistantQuestion = (ConversationAdditionalChatAssistantQuestion) nc5Var.m162488l(ConversationAdditionalChatAssistantQuestion.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        conversationAdditional.continuousChat = (ContinuousChat) nc5Var.m162488l(ContinuousChat.PROTOBUF_ADAPTER);
                        continue;
                    case 154:
                        conversationAdditional.pinChat = (PlatinumPinChat) nc5Var.m162488l(PlatinumPinChat.PROTOBUF_ADAPTER);
                        continue;
                    case 162:
                        conversationAdditional.reSwipe = (ReSwipeInfo) nc5Var.m162488l(ReSwipeInfo.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        conversationAdditional.blindbox = (GrowthConversationBlindBox) nc5Var.m162488l(GrowthConversationBlindBox.PROTOBUF_ADAPTER);
                        continue;
                    case 178:
                        conversationAdditional.previewTexts = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        conversationAdditional.greetingInfo = (GreetingInfo) nc5Var.m162488l(GreetingInfo.PROTOBUF_ADAPTER);
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 /* 194 */:
                        conversationAdditional.fateRadar = (ConversationAdditionalFateRadar) nc5Var.m162488l(ConversationAdditionalFateRadar.PROTOBUF_ADAPTER);
                        continue;
                    case 202:
                        conversationAdditional.lowPayOneside = (LowPayOneside) nc5Var.m162488l(LowPayOneside.PROTOBUF_ADAPTER);
                        continue;
                    case 210:
                        conversationAdditional.matchInfo = (ConvAdditionalMatchInfo) nc5Var.m162488l(ConvAdditionalMatchInfo.PROTOBUF_ADAPTER);
                        continue;
                    case 218:
                        conversationAdditional.newMatch = (ExposureNewMatch) nc5Var.m162488l(ExposureNewMatch.PROTOBUF_ADAPTER);
                        continue;
                    case 226:
                        conversationAdditional.loveLetter = (ConvAdditionalLoveLetter) nc5Var.m162488l(ConvAdditionalLoveLetter.PROTOBUF_ADAPTER);
                        continue;
                    case 234:
                        conversationAdditional.chatMM = (ChatMM) nc5Var.m162488l(ChatMM.PROTOBUF_ADAPTER);
                        continue;
                    case 242:
                        conversationAdditional.blackList = (BlackList) nc5Var.m162488l(BlackList.PROTOBUF_ADAPTER);
                        continue;
                    case 250:
                        conversationAdditional.messageRelate = (MessageRelate) nc5Var.m162488l(MessageRelate.PROTOBUF_ADAPTER);
                        continue;
                    case 258:
                        conversationAdditional.compliment = (ConvAdditionalCompliment) nc5Var.m162488l(ConvAdditionalCompliment.PROTOBUF_ADAPTER);
                        continue;
                    case 266:
                        conversationAdditional.swiper = (ConvAdditionalSwiper) nc5Var.m162488l(ConvAdditionalSwiper.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (conversationAdditional.quickChat == null) {
                            conversationAdditional.quickChat = ConversationAdditionalQuickChat.new_();
        ...
        public void serialize(ConversationAdditional conversationAdditional, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (conversationAdditionalQuickChat != null) {
                codedOutputByteBufferNano.m17309K(1, conversationAdditionalQuickChat, ConversationAdditionalQuickChat.PROTOBUF_ADAPTER);
            }
            VoiceCallAdditional voiceCallAdditional = conversationAdditional.voiceCall;
            if (voiceCallAdditional != null) {
                codedOutputByteBufferNano.m17309K(2, voiceCallAdditional, VoiceCallAdditional.PROTOBUF_ADAPTER);
            }
            TimeLimited timeLimited = conversationAdditional.timeLimited;
            if (timeLimited != null) {
                codedOutputByteBufferNano.m17309K(3, timeLimited, TimeLimited.PROTOBUF_ADAPTER);
            }
            OneSideNoMatchConversation oneSideNoMatchConversation = conversationAdditional.oneSideNoMatch;
            if (oneSideNoMatchConversation != null) {
                codedOutputByteBufferNano.m17309K(4, oneSideNoMatchConversation, OneSideNoMatchConversation.PROTOBUF_ADAPTER);
            }
            ConversationAdditionalOneSide conversationAdditionalOneSide = conversationAdditional.oneSide;
            if (conversationAdditionalOneSide != null) {
                codedOutputByteBufferNano.m17309K(5, conversationAdditionalOneSide, ConversationAdditionalOneSide.PROTOBUF_ADAPTER);
            }
            ConversationAdditionalKanKanContent conversationAdditionalKanKanContent = conversationAdditional.kankan;
            if (conversationAdditionalKanKanContent != null) {
                codedOutputByteBufferNano.m17309K(6, conversationAdditionalKanKanContent, ConversationAdditionalKanKanContent.PROTOBUF_ADAPTER);
            }
            CoreFeedStateCounter coreFeedStateCounter = conversationAdditional.feedStateCounter;
            if (coreFeedStateCounter != null) {
                codedOutputByteBufferNano.m17309K(7, coreFeedStateCounter, CoreFeedStateCounter.PROTOBUF_ADAPTER);
            }
            SuggestedTimeLimitedMatch suggestedTimeLimitedMatch = conversationAdditional.suggestedTimeLimitedMatch;
            if (suggestedTimeLimitedMatch != null) {
                codedOutputByteBufferNano.m17309K(8, suggestedTimeLimitedMatch, SuggestedTimeLimitedMatch.PROTOBUF_ADAPTER);
            }
            HeartbeatMatch heartbeatMatch = conversationAdditional.heartbeatMatch;
            if (heartbeatMatch != null) {
                codedOutputByteBufferNano.m17309K(9, heartbeatMatch, HeartbeatMatch.PROTOBUF_ADAPTER);
            }
            AvatarSummaryCounter avatarSummaryCounter = conversationAdditional.avatarSummary;
            if (avatarSummaryCounter != null) {
                codedOutputByteBufferNano.m17309K(10, avatarSummaryCounter, AvatarSummaryCounter.PROTOBUF_ADAPTER);
            }
            CoreInteractionMessageCounter coreInteractionMessageCounter = conversationAdditional.feedInteractionCounter;
            if (coreInteractionMessageCounter != null) {
                codedOutputByteBufferNano.m17309K(11, coreInteractionMessageCounter, CoreInteractionMessageCounter.PROTOBUF_ADAPTER);
            }
            VirtualVoiceGroupConversationCell virtualVoiceGroupConversationCell = conversationAdditional.liveVirtualVoice;
            if (virtualVoiceGroupConversationCell != null) {
                codedOutputByteBufferNano.m17309K(12, virtualVoiceGroupConversationCell, VirtualVoiceGroupConversationCell.PROTOBUF_ADAPTER);
            }
            ConversationMomentInfo conversationMomentInfo = conversationAdditional.localMomentInfo;
            if (conversationMomentInfo != null) {
                codedOutputByteBufferNano.m17309K(13, conversationMomentInfo, ConversationMomentInfo.PROTOBUF_ADAPTER);
            }
            LiveActivityConversation liveActivityConversation = conversationAdditional.liveActivity;
            if (liveActivityConversation != null) {
                codedOutputByteBufferNano.m17309K(14, liveActivityConversation, LiveActivityConversation.PROTOBUF_ADAPTER);
            }
            ConversationGame conversationGame = conversationAdditional.game;
            if (conversationGame != null) {
                codedOutputByteBufferNano.m17309K(15, conversationGame, ConversationGame.PROTOBUF_ADAPTER);
            }
            ConversationAdditionalTag conversationAdditionalTag = conversationAdditional.tag;
            if (conversationAdditionalTag != null) {
                codedOutputByteBufferNano.m17309K(16, conversationAdditionalTag, ConversationAdditionalTag.PROTOBUF_ADAPTER);
            }
            ConversationAdditionalChatAssistantQuestion conversationAdditionalChatAssistantQuestion = conversationAdditional.chatAssistantQuestion;
            if (conversationAdditionalChatAssistantQuestion != null) {
                codedOutputByteBufferNano.m17309K(17, conversationAdditionalChatAssistantQuestion, ConversationAdditionalChatAssistantQuestion.PROTOBUF_ADAPTER);
            }
            ContinuousChat continuousChat = conversationAdditional.continuousChat;
            if (continuousChat != null) {
                codedOutputByteBufferNano.m17309K(18, continuousChat, ContinuousChat.PROTOBUF_ADAPTER);
            }
            PlatinumPinChat platinumPinChat = conversationAdditional.pinChat;
            if (platinumPinChat != null) {
                codedOutputByteBufferNano.m17309K(19, platinumPinChat, PlatinumPinChat.PROTOBUF_ADAPTER);
            }
            ReSwipeInfo reSwipeInfo = conversationAdditional.reSwipe;
            if (reSwipeInfo != null) {
                codedOutputByteBufferNano.m17309K(20, reSwipeInfo, ReSwipeInfo.PROTOBUF_ADAPTER);
            }
            GrowthConversationBlindBox growthConversationBlindBox = conversationAdditional.blindbox;
            if (growthConversationBlindBox != null) {
                codedOutputByteBufferNano.m17309K(21, growthConversationBlindBox, GrowthConversationBlindBox.PROTOBUF_ADAPTER);
            }
            List<String> list = conversationAdditional.previewTexts;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(22, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            GreetingInfo greetingInfo = conversationAdditional.greetingInfo;
            if (greetingInfo != null) {
                codedOutputByteBufferNano.m17309K(23, greetingInfo, GreetingInfo.PROTOBUF_ADAPTER);
            }
            ConversationAdditionalFateRadar conversationAdditionalFateRadar = conversationAdditional.fateRadar;
            if (conversationAdditionalFateRadar != null) {
                codedOutputByteBufferNano.m17309K(24, conversationAdditionalFateRadar, ConversationAdditionalFateRadar.PROTOBUF_ADAPTER);
            }
            LowPayOneside lowPayOneside = conversationAdditional.lowPayOneside;
            if (lowPayOneside != null) {
                codedOutputByteBufferNano.m17309K(25, lowPayOneside, LowPayOneside.PROTOBUF_ADAPTER);
            }
            ConvAdditionalMatchInfo convAdditionalMatchInfo = conversationAdditional.matchInfo;
            if (convAdditionalMatchInfo != null) {
                codedOutputByteBufferNano.m17309K(26, convAdditionalMatchInfo, ConvAdditionalMatchInfo.PROTOBUF_ADAPTER);
            }
            ExposureNewMatch exposureNewMatch = conversationAdditional.newMatch;
            if (exposureNewMatch != null) {
                codedOutputByteBufferNano.m17309K(27, exposureNewMatch, ExposureNewMatch.PROTOBUF_ADAPTER);
            }
            ConvAdditionalLoveLetter convAdditionalLoveLetter = conversationAdditional.loveLetter;
            if (convAdditionalLoveLetter != null) {
                codedOutputByteBufferNano.m17309K(28, convAdditionalLoveLetter, ConvAdditionalLoveLetter.PROTOBUF_ADAPTER);
            }
            ChatMM chatMM = conversationAdditional.chatMM;
            if (chatMM != null) {
                codedOutputByteBufferNano.m17309K(29, chatMM, ChatMM.PROTOBUF_ADAPTER);
            }
            BlackList blackList = conversationAdditional.blackList;
            if (blackList != null) {
                codedOutputByteBufferNano.m17309K(30, blackList, BlackList.PROTOBUF_ADAPTER);
            }
            MessageRelate messageRelate = conversationAdditional.messageRelate;
            if (messageRelate != null) {
                codedOutputByteBufferNano.m17309K(31, messageRelate, MessageRelate.PROTOBUF_ADAPTER);
            }
            ConvAdditionalCompliment convAdditionalCompliment = conversationAdditional.compliment;
            if (convAdditionalCompliment != null) {
                codedOutputByteBufferNano.m17309K(32, convAdditionalCompliment, ConvAdditionalCompliment.PROTOBUF_ADAPTER);
            }
            ConvAdditionalSwiper convAdditionalSwiper = conversationAdditional.swiper;
            if (convAdditionalSwiper != null) {
                codedOutputByteBufferNano.m17309K(33, convAdditionalSwiper, ConvAdditionalSwiper.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m36299a(String str) {
        return str;
    }
    ...
    public ConversationAdditional mo225055clone() {
        ConversationAdditional conversationAdditional = new ConversationAdditional();
        ConversationAdditionalQuickChat conversationAdditionalQuickChat = this.quickChat;
        if (conversationAdditionalQuickChat != null) {
            conversationAdditional.quickChat = conversationAdditionalQuickChat.mo225055clone();
        }
        VoiceCallAdditional voiceCallAdditional = this.voiceCall;
        if (voiceCallAdditional != null) {
            conversationAdditional.voiceCall = voiceCallAdditional.mo225055clone();
        }
        TimeLimited timeLimited = this.timeLimited;
        if (timeLimited != null) {
            conversationAdditional.timeLimited = timeLimited.mo225055clone();
        }
        OneSideNoMatchConversation oneSideNoMatchConversation = this.oneSideNoMatch;
        if (oneSideNoMatchConversation != null) {
            conversationAdditional.oneSideNoMatch = oneSideNoMatchConversation.mo225055clone();
        }
        ConversationAdditionalOneSide conversationAdditionalOneSide = this.oneSide;
        if (conversationAdditionalOneSide != null) {
            conversationAdditional.oneSide = conversationAdditionalOneSide.mo225055clone();
        }
        ConversationAdditionalKanKanContent conversationAdditionalKanKanContent = this.kankan;
        if (conversationAdditionalKanKanContent != null) {
            conversationAdditional.kankan = conversationAdditionalKanKanContent.mo225055clone();
        }
        CoreFeedStateCounter coreFeedStateCounter = this.feedStateCounter;
        if (coreFeedStateCounter != null) {
            conversationAdditional.feedStateCounter = coreFeedStateCounter.mo225055clone();
        }
        SuggestedTimeLimitedMatch suggestedTimeLimitedMatch = this.suggestedTimeLimitedMatch;
        if (suggestedTimeLimitedMatch != null) {
            conversationAdditional.suggestedTimeLimitedMatch = suggestedTimeLimitedMatch.mo225055clone();
        }
        HeartbeatMatch heartbeatMatch = this.heartbeatMatch;
        if (heartbeatMatch != null) {
            conversationAdditional.heartbeatMatch = heartbeatMatch.mo225055clone();
        }
        AvatarSummaryCounter avatarSummaryCounter = this.avatarSummary;
        if (avatarSummaryCounter != null) {
            conversationAdditional.avatarSummary = avatarSummaryCounter.mo225055clone();
        }
        CoreInteractionMessageCounter coreInteractionMessageCounter = this.feedInteractionCounter;
        if (coreInteractionMessageCounter != null) {
            conversationAdditional.feedInteractionCounter = coreInteractionMessageCounter.mo225055clone();
        }
        VirtualVoiceGroupConversationCell virtualVoiceGroupConversationCell = this.liveVirtualVoice;
        if (virtualVoiceGroupConversationCell != null) {
            conversationAdditional.liveVirtualVoice = virtualVoiceGroupConversationCell.mo225055clone();
        }
        ConversationMomentInfo conversationMomentInfo = this.localMomentInfo;
        if (conversationMomentInfo != null) {
            conversationAdditional.localMomentInfo = conversationMomentInfo.mo225055clone();
        }
        LiveActivityConversation liveActivityConversation = this.liveActivity;
        if (liveActivityConversation != null) {
            conversationAdditional.liveActivity = liveActivityConversation.mo225055clone();
        }
        ConversationGame conversationGame = this.game;
        if (conversationGame != null) {
            conversationAdditional.game = conversationGame.mo225055clone();
        }
        ConversationAdditionalTag conversationAdditionalTag = this.tag;
        if (conversationAdditionalTag != null) {
            conversationAdditional.tag = conversationAdditionalTag.mo225055clone();
        }
        ConversationAdditionalChatAssistantQuestion conversationAdditionalChatAssistantQuestion = this.chatAssistantQuestion;
        if (conversationAdditionalChatAssistantQuestion != null) {
            conversationAdditional.chatAssistantQuestion = conversationAdditionalChatAssistantQuestion.mo225055clone();
        }
        ContinuousChat continuousChat = this.continuousChat;
        if (continuousChat != null) {
            conversationAdditional.continuousChat = continuousChat.mo225055clone();
        }
        PlatinumPinChat platinumPinChat = this.pinChat;
        if (platinumPinChat != null) {
            conversationAdditional.pinChat = platinumPinChat.mo225055clone();
        }
        ReSwipeInfo reSwipeInfo = this.reSwipe;
        if (reSwipeInfo != null) {
            conversationAdditional.reSwipe = reSwipeInfo.mo225055clone();
        }
        GrowthConversationBlindBox growthConversationBlindBox = this.blindbox;
        if (growthConversationBlindBox != null) {
            conversationAdditional.blindbox = growthConversationBlindBox.mo225055clone();
        }
        List<String> list = this.previewTexts;
        if (list != null) {
            conversationAdditional.previewTexts = ValueObject.util_map(list, new qcj() { // from class: l.v46
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ConversationAdditional.m36299a((String) obj);
                }
            });
        }
        GreetingInfo greetingInfo = this.greetingInfo;
        if (greetingInfo != null) {
            conversationAdditional.greetingInfo = greetingInfo.mo225055clone();
        }
        ConversationAdditionalFateRadar conversationAdditionalFateRadar = this.fateRadar;
        if (conversationAdditionalFateRadar != null) {
            conversationAdditional.fateRadar = conversationAdditionalFateRadar.mo225055clone();
        }
        LowPayOneside lowPayOneside = this.lowPayOneside;
        if (lowPayOneside != null) {
            conversationAdditional.lowPayOneside = lowPayOneside.mo225055clone();
        }
        ConvAdditionalMatchInfo convAdditionalMatchInfo = this.matchInfo;
        if (convAdditionalMatchInfo != null) {
            conversationAdditional.matchInfo = convAdditionalMatchInfo.mo225055clone();
        }
        ExposureNewMatch exposureNewMatch = this.newMatch;
        if (exposureNewMatch != null) {
            conversationAdditional.newMatch = exposureNewMatch.mo225055clone();
        }
        ConvAdditionalLoveLetter convAdditionalLoveLetter = this.loveLetter;
        if (convAdditionalLoveLetter != null) {
            conversationAdditional.loveLetter = convAdditionalLoveLetter.mo225055clone();
        }
        ChatMM chatMM = this.chatMM;
        if (chatMM != null) {
            conversationAdditional.chatMM = chatMM.mo225055clone();
        }
        BlackList blackList = this.blackList;
        if (blackList != null) {
            conversationAdditional.blackList = blackList.mo225055clone();
        }
        MessageRelate messageRelate = this.messageRelate;
        if (messageRelate != null) {
            conversationAdditional.messageRelate = messageRelate.mo225055clone();
        }
        ConvAdditionalCompliment convAdditionalCompliment = this.compliment;
        if (convAdditionalCompliment != null) {
            conversationAdditional.compliment = convAdditionalCompliment.mo225055clone();
        }
        ConvAdditionalSwiper convAdditionalSwiper = this.swiper;
        if (convAdditionalSwiper != null) {
            conversationAdditional.swiper = convAdditionalSwiper.mo225055clone();
        }
        return conversationAdditional;
    }
