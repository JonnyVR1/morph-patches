...
public class InactivateReason extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<InactivateReason> PROTOBUF_ADAPTER = new MessageNanoAdapter<InactivateReason>() { // from class: com.p1.mobile.putong.core.data.InactivateReason.1
        ...
        public int computeAndCacheSize(InactivateReason inactivateReason) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, list, InactivateReasonDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            inactivateReason.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public InactivateReason parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    inactivateReason.key = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    inactivateReason.name = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (inactivateReason.key == null) {
                            inactivateReason.key = "";
                    ...
                    inactivateReason.reasons = (List) nc5Var.m162488l(InactivateReasonDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return inactivateReason;
        }
        ...
        public void serialize(InactivateReason inactivateReason, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<InactivateReasonDetail> list = inactivateReason.reasons;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(3, list, InactivateReasonDetail.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public InactivateReason mo225055clone() {
        InactivateReason inactivateReason = new InactivateReason();
        inactivateReason.key = this.key;
        inactivateReason.name = this.name;
        List<InactivateReasonDetail> list = this.reasons;
        if (list != null) {
            inactivateReason.reasons = ValueObject.util_map(list, new qcj() { // from class: l.tsm
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((InactivateReasonDetail) obj).mo225055clone();
                }
            });
        }
        return inactivateReason;
