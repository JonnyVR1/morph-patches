...
public class ReceiveRecords extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ReceiveRecords> PROTOBUF_ADAPTER = new MessageNanoAdapter<ReceiveRecords>() { // from class: com.p1.mobile.putong.core.data.ReceiveRecords.1
        ...
        public int computeAndCacheSize(ReceiveRecords receiveRecords) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(3, receiveRecords.highest) + CodedOutputByteBufferNano.m17283j(4, receiveRecords.createTime);
            ...
            if (redPacketUserPicture != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(6, redPacketUserPicture, RedPacketUserPicture.PROTOBUF_ADAPTER);
            }
            receiveRecords.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ReceiveRecords parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    receiveRecords.userId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    receiveRecords.amount = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    receiveRecords.highest = nc5Var.m162483g();
                } else if (iM162497u == 32) {
                    receiveRecords.createTime = nc5Var.m162487k();
                } else if (iM162497u == 42) {
                    receiveRecords.name = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (receiveRecords.userId == null) {
                            receiveRecords.userId = "";
                    ...
                    receiveRecords.picture = (RedPacketUserPicture) nc5Var.m162488l(RedPacketUserPicture.PROTOBUF_ADAPTER);
                }
            }
            return receiveRecords;
        }
        ...
        public void serialize(ReceiveRecords receiveRecords, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(3, receiveRecords.highest);
            codedOutputByteBufferNano.m17307I(4, receiveRecords.createTime);
            String str3 = receiveRecords.name;
            if (str3 != null) {
            ...
            RedPacketUserPicture redPacketUserPicture = receiveRecords.picture;
            if (redPacketUserPicture != null) {
                codedOutputByteBufferNano.m17309K(6, redPacketUserPicture, RedPacketUserPicture.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ReceiveRecords mo225055clone() {
        ReceiveRecords receiveRecords = new ReceiveRecords();
        ...
        if (redPacketUserPicture != null) {
            receiveRecords.picture = redPacketUserPicture.mo225055clone();
        }
        return receiveRecords;
    }
