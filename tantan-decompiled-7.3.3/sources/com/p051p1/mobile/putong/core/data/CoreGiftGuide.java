...
public class CoreGiftGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreGiftGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreGiftGuide>() { // from class: com.p1.mobile.putong.core.data.CoreGiftGuide.1
        ...
        public int computeAndCacheSize(CoreGiftGuide coreGiftGuide) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, coreGiftGuide.show);
            GiftGuideStyle giftGuideStyle = coreGiftGuide.style;
            if (giftGuideStyle != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(2, giftGuideStyle, GiftGuideStyle.PROTOBUF_ADAPTER);
            }
            String str = coreGiftGuide.tracker;
            if (str != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(3, str);
            }
            coreGiftGuide.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreGiftGuide parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    coreGiftGuide.show = nc5Var.m162483g();
                } else if (iM162497u == 18) {
                    coreGiftGuide.style = (GiftGuideStyle) nc5Var.m162488l(GiftGuideStyle.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 26) {
                        if (coreGiftGuide.style == null) {
                            coreGiftGuide.style = GiftGuideStyle.new_();
                    ...
                    coreGiftGuide.tracker = nc5Var.m162495s();
                }
            }
            return coreGiftGuide;
        }
        ...
        public void serialize(CoreGiftGuide coreGiftGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, coreGiftGuide.show);
            GiftGuideStyle giftGuideStyle = coreGiftGuide.style;
            if (giftGuideStyle != null) {
                codedOutputByteBufferNano.m17309K(2, giftGuideStyle, GiftGuideStyle.PROTOBUF_ADAPTER);
            }
            String str = coreGiftGuide.tracker;
            if (str != null) {
    ...
    public CoreGiftGuide mo225055clone() {
        CoreGiftGuide coreGiftGuide = new CoreGiftGuide();
        coreGiftGuide.show = this.show;
        GiftGuideStyle giftGuideStyle = this.style;
        if (giftGuideStyle != null) {
            coreGiftGuide.style = giftGuideStyle.mo225055clone();
        }
