...
public class SurpriseGift extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SurpriseGift> PROTOBUF_ADAPTER = new MessageNanoAdapter<SurpriseGift>() { // from class: com.p1.mobile.putong.core.data.SurpriseGift.1
        ...
        public int computeAndCacheSize(SurpriseGift surpriseGift) {
            ...
            if (chatPartners != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, chatPartners, ChatPartners.PROTOBUF_ADAPTER);
            }
            surpriseGift.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SurpriseGift parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    surpriseGift.surpriseGiftType = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    surpriseGift.matchUserId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (surpriseGift.surpriseGiftType == null) {
                            surpriseGift.surpriseGiftType = "";
                    ...
                    surpriseGift.chatPartners = (ChatPartners) nc5Var.m162488l(ChatPartners.PROTOBUF_ADAPTER);
                }
            }
            return surpriseGift;
        }
        ...
        public void serialize(SurpriseGift surpriseGift, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ChatPartners chatPartners = surpriseGift.chatPartners;
            if (chatPartners != null) {
                codedOutputByteBufferNano.m17309K(3, chatPartners, ChatPartners.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public SurpriseGift mo225055clone() {
        SurpriseGift surpriseGift = new SurpriseGift();
        ...
        if (chatPartners != null) {
            surpriseGift.chatPartners = chatPartners.mo225055clone();
        }
        return surpriseGift;
    }
