...
public class MembershipRecommendUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MembershipRecommendUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<MembershipRecommendUser>() { // from class: com.p1.mobile.putong.core.data.MembershipRecommendUser.1
        ...
        public int computeAndCacheSize(MembershipRecommendUser membershipRecommendUser) {
            String str = membershipRecommendUser.f21181id;
            ...
            if (membershipRecommendUserType != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, membershipRecommendUserType, MembershipRecommendUserType.PROTOBUF_ADAPTER);
            }
            ...
            if (relationshipStatus2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, relationshipStatus2, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            PicksTagType picksTagType = membershipRecommendUser.picksTagType;
            if (picksTagType != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, picksTagType, PicksTagType.PROTOBUF_ADAPTER);
            }
            String str2 = membershipRecommendUser.picksTracker;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(6, str2);
            }
            membershipRecommendUser.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MembershipRecommendUser parse(nc5 nc5Var) throws IOException {
            MembershipRecommendUser membershipRecommendUser = new MembershipRecommendUser();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (membershipRecommendUser.f21181id == null) {
                        membershipRecommendUser.f21181id = "";
                    }
                ...
                if (iM162497u == 10) {
                    membershipRecommendUser.f21181id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    membershipRecommendUser.type = (MembershipRecommendUserType) nc5Var.m162488l(MembershipRecommendUserType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    membershipRecommendUser.status = (RelationshipStatus) nc5Var.m162488l(RelationshipStatus.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    membershipRecommendUser.otherStatus = (RelationshipStatus) nc5Var.m162488l(RelationshipStatus.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    membershipRecommendUser.picksTagType = (PicksTagType) nc5Var.m162488l(PicksTagType.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 50) {
                        if (membershipRecommendUser.f21181id == null) {
                            membershipRecommendUser.f21181id = "";
                    ...
                    membershipRecommendUser.picksTracker = nc5Var.m162495s();
                }
            }
            return membershipRecommendUser;
        }
        ...
        public void serialize(MembershipRecommendUser membershipRecommendUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            MembershipRecommendUserType membershipRecommendUserType = membershipRecommendUser.type;
            if (membershipRecommendUserType != null) {
                codedOutputByteBufferNano.m17309K(2, membershipRecommendUserType, MembershipRecommendUserType.PROTOBUF_ADAPTER);
            }
            RelationshipStatus relationshipStatus = membershipRecommendUser.status;
            if (relationshipStatus != null) {
            ...
            RelationshipStatus relationshipStatus2 = membershipRecommendUser.otherStatus;
            if (relationshipStatus2 != null) {
                codedOutputByteBufferNano.m17309K(4, relationshipStatus2, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            PicksTagType picksTagType = membershipRecommendUser.picksTagType;
            if (picksTagType != null) {
                codedOutputByteBufferNano.m17309K(5, picksTagType, PicksTagType.PROTOBUF_ADAPTER);
            }
            String str2 = membershipRecommendUser.picksTracker;
            if (str2 != null) {
        ...
        public boolean parseField(MembershipRecommendUser membershipRecommendUser, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    membershipRecommendUser.f21181id = jsonParser.getValueAsString();
                    return false;
                case "type":
    ...
    public MembershipRecommendUser mo225055clone() {
        MembershipRecommendUser membershipRecommendUser = new MembershipRecommendUser();
        membershipRecommendUser.f21181id = this.f21181id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21181id, membershipRecommendUser.f21181id) && ValueObject.util_equals(this.type, membershipRecommendUser.type) && ValueObject.util_equals(this.status, membershipRecommendUser.status) && ValueObject.util_equals(this.otherStatus, membershipRecommendUser.otherStatus) && ValueObject.util_equals(this.picksTagType, membershipRecommendUser.picksTagType) && ValueObject.util_equals(this.picksTracker, membershipRecommendUser.picksTracker);
    }
