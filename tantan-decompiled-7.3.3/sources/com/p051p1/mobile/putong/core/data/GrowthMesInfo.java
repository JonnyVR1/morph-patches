...
public class GrowthMesInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GrowthMesInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<GrowthMesInfo>() { // from class: com.p1.mobile.putong.core.data.GrowthMesInfo.1
        ...
        public int computeAndCacheSize(GrowthMesInfo growthMesInfo) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, list, GrowthMesUser.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            growthMesInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GrowthMesInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    growthMesInfo.title = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    growthMesInfo.content = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    growthMesInfo.link = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (growthMesInfo.title == null) {
                            growthMesInfo.title = "";
                    ...
                    growthMesInfo.mesUsers = (List) nc5Var.m162488l(GrowthMesUser.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return growthMesInfo;
        }
        ...
        public void serialize(GrowthMesInfo growthMesInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<GrowthMesUser> list = growthMesInfo.mesUsers;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(4, list, GrowthMesUser.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public GrowthMesInfo mo225055clone() {
        GrowthMesInfo growthMesInfo = new GrowthMesInfo();
        ...
        if (list != null) {
            growthMesInfo.mesUsers = ValueObject.util_map(list, new qcj() { // from class: l.stk
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((GrowthMesUser) obj).mo225055clone();
                }
            });
        }
        return growthMesInfo;
