...
import com.p051p1.mobile.putong.core.data.RankingExtra;
import com.p051p1.mobile.putong.core.data.RankingTag;
...
public class RankingExtra extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RankingExtra> PROTOBUF_ADAPTER = new MessageNanoAdapter<RankingExtra>() { // from class: com.p1.mobile.putong.core.data.RankingExtra.1
        ...
        public int computeAndCacheSize(RankingExtra rankingExtra) {
            ...
            rankingExtra.cachedSize = iM17285l;
            return iM17285l;
        }
    ...
    public static /* synthetic */ String m36810a(String str) {
        return str;
    }
    ...
    public RankingExtra mo225055clone() {
        ...
        if (list != null) {
            rankingExtra.tags = ValueObject.util_map(list, new qcj() { // from class: l.xkc0
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            rankingExtra.presetTexts = ValueObject.util_map(list2, new qcj() { // from class: l.zkc0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return RankingExtra.m36810a((String) obj);
                }
            });
        }
        return rankingExtra;
