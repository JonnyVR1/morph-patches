...
public class PrivilegeTime extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PrivilegeTime> PROTOBUF_ADAPTER = new MessageNanoAdapter<PrivilegeTime>() { // from class: com.p1.mobile.putong.core.data.PrivilegeTime.1
        ...
        public int computeAndCacheSize(PrivilegeTime privilegeTime) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, privilegeTime.count) + CodedOutputByteBufferNano.m17283j(3, privilegeTime.expireTime);
            privilegeTime.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PrivilegeTime parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    privilegeTime.type = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    privilegeTime.count = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        if (privilegeTime.type != null) {
                            break;
                    ...
                    privilegeTime.expireTime = nc5Var.m162487k();
                }
            }
            return privilegeTime;
        }
        ...
        public void serialize(PrivilegeTime privilegeTime, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, privilegeTime.count);
            codedOutputByteBufferNano.m17307I(3, privilegeTime.expireTime);
        }
    };
    ...
    public PrivilegeTime mo225055clone() {
        PrivilegeTime privilegeTime = new PrivilegeTime();
