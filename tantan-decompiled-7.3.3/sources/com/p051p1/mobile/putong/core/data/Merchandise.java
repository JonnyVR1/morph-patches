...
public class Merchandise extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Merchandise> PROTOBUF_ADAPTER = new MessageNanoAdapter<Merchandise>() { // from class: com.p1.mobile.putong.core.data.Merchandise.1
        ...
        public int computeAndCacheSize(Merchandise merchandise) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, merchandise._id);
            String str = merchandise.f56859id;
            if (str != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(2, str);
            }
            ProductCategory productCategory = merchandise.category;
            if (productCategory != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(51, productCategory.ordinal());
            }
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(52, merchandise.quantity);
            ProductType productType = merchandise.productType;
            if (productType != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(53, productType.ordinal());
            }
            StockKeepUnit stockKeepUnit = merchandise.defaultStockKeepUnit;
            if (stockKeepUnit != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(54, stockKeepUnit, StockKeepUnit.PROTOBUF_ADAPTER);
            }
            ProductCategory productCategory2 = merchandise.category;
            if (productCategory2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(55, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            ProductType productType2 = merchandise.productType;
            if (productType2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(56, productType2, ProductType.PROTOBUF_ADAPTER);
            }
            List<Coupon> list = merchandise.localCoupons;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(57, list, Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MerchandiseDurationDesc merchandiseDurationDesc = merchandise.duration;
            if (merchandiseDurationDesc != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(58, merchandiseDurationDesc, MerchandiseDurationDesc.PROTOBUF_ADAPTER);
            }
            MerchandiseExtra merchandiseExtra = merchandise.extra;
            if (merchandiseExtra != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(59, merchandiseExtra, MerchandiseExtra.PROTOBUF_ADAPTER);
            }
            merchandise.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Merchandise parse(nc5 nc5Var) throws IOException {
                ...
                switch (nc5Var.m162497u()) {
                    case 0:
                        if (merchandise.category == null && numValueOf != null) {
                            merchandise.category = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                        }
                        if (merchandise.productType == null && numValueOf2 != null) {
                            merchandise.productType = (ProductType) ProductType.JSON_ADAPTER.newTEnum(null, numValueOf2.intValue());
                        }
                        ...
                        break;
                    case 8:
                        merchandise._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        merchandise.f56859id = nc5Var.m162495s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        merchandise.quantity = nc5Var.m162486j();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 434:
                        merchandise.defaultStockKeepUnit = (StockKeepUnit) nc5Var.m162488l(StockKeepUnit.PROTOBUF_ADAPTER);
                        continue;
                    case 442:
                        merchandise.category = (ProductCategory) nc5Var.m162488l(ProductCategory.PROTOBUF_ADAPTER);
                        continue;
                    case 450:
                        merchandise.productType = (ProductType) nc5Var.m162488l(ProductType.PROTOBUF_ADAPTER);
                        continue;
                    case 458:
                        merchandise.localCoupons = (List) nc5Var.m162488l(Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 466:
                        merchandise.duration = (MerchandiseDurationDesc) nc5Var.m162488l(MerchandiseDurationDesc.PROTOBUF_ADAPTER);
                        continue;
                    case 474:
                        merchandise.extra = (MerchandiseExtra) nc5Var.m162488l(MerchandiseExtra.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (merchandise.category == null && numValueOf != null) {
                            merchandise.category = (ProductCategory) ProductCategory.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Merchandise merchandise, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, merchandise._id);
            String str = merchandise.f56859id;
            if (str != null) {
            ...
            ProductCategory productCategory = merchandise.category;
            if (productCategory != null) {
                codedOutputByteBufferNano.m17305G(51, productCategory.ordinal());
            }
            codedOutputByteBufferNano.m17305G(52, merchandise.quantity);
            ProductType productType = merchandise.productType;
            if (productType != null) {
                codedOutputByteBufferNano.m17305G(53, productType.ordinal());
            }
            StockKeepUnit stockKeepUnit = merchandise.defaultStockKeepUnit;
            if (stockKeepUnit != null) {
                codedOutputByteBufferNano.m17309K(54, stockKeepUnit, StockKeepUnit.PROTOBUF_ADAPTER);
            }
            ProductCategory productCategory2 = merchandise.category;
            if (productCategory2 != null) {
                codedOutputByteBufferNano.m17309K(55, productCategory2, ProductCategory.PROTOBUF_ADAPTER);
            }
            ProductType productType2 = merchandise.productType;
            if (productType2 != null) {
                codedOutputByteBufferNano.m17309K(56, productType2, ProductType.PROTOBUF_ADAPTER);
            }
            List<Coupon> list = merchandise.localCoupons;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(57, list, Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            MerchandiseDurationDesc merchandiseDurationDesc = merchandise.duration;
            if (merchandiseDurationDesc != null) {
                codedOutputByteBufferNano.m17309K(58, merchandiseDurationDesc, MerchandiseDurationDesc.PROTOBUF_ADAPTER);
            }
            MerchandiseExtra merchandiseExtra = merchandise.extra;
            if (merchandiseExtra != null) {
                codedOutputByteBufferNano.m17309K(59, merchandiseExtra, MerchandiseExtra.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<Merchandise> JSON_ADAPTER = new ObjectJsonAdapter<Merchandise>() { // from class: com.p1.mobile.putong.core.data.Merchandise.2
        ...
        public boolean parseField(Merchandise merchandise, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "duration":
                    merchandise.duration = MerchandiseDurationDesc.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "productType":
                    merchandise.productType = ProductType.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "defaultStockKeepUnit":
                    merchandise.defaultStockKeepUnit = StockKeepUnit.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                case "quantity":
                ...
                case "localCoupons":
                    ...
                    return true;
                case "id":
                    merchandise.f56859id = jsonParser.getValueAsString();
                    return false;
                case "category":
                    merchandise.category = ProductCategory.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                case "extra":
                    merchandise.extra = MerchandiseExtra.JSON_ADAPTER.parse(jsonParser, str2, arrayList, dataChecker);
                    return true;
                default:
                    return false;
            }
        ...
        public void serializeFields(Merchandise merchandise, JsonGenerator jsonGenerator) throws IOException {
            ...
            jsonGenerator.writeNumberField(FirebaseAnalytics.Param.QUANTITY, merchandise.quantity);
            if (merchandise.productType != null) {
    ...
    public static final LongColumn<Merchandise> _ID = new LongColumn<Merchandise>("_id") { // from class: com.p1.mobile.putong.core.data.Merchandise.3
        ...
        public Long get(Merchandise merchandise) {
            return Long.valueOf(merchandise._id);
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Merchandise merchandise, Long l2) {
            merchandise._id = l2.longValue();
        }
    };

    /* JADX INFO: renamed from: ID */
    public static final StringColumn<Merchandise> f21182ID = new StringColumn<Merchandise>("id_c") { // from class: com.p1.mobile.putong.core.data.Merchandise.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Merchandise merchandise) {
            return merchandise.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Merchandise merchandise, String str) {
            merchandise.f56859id = str;
        }
    };
    ...
    public static final StringColumn<Merchandise> DEFAULTSTOCKKEEPUNIT_ID = new StringColumn<Merchandise>("defaultStockKeepUnit_id_c") { // from class: com.p1.mobile.putong.core.data.Merchandise.8
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Merchandise merchandise) {
            return merchandise.defaultStockKeepUnit.f21249id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Merchandise merchandise, String str) {
            merchandise.defaultStockKeepUnit.f21249id = str;
        }
    };
    ...
    public static vzf0<Merchandise> DB_ADAPTER = new vzf0<Merchandise>() { // from class: com.p1.mobile.putong.core.data.Merchandise.27
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // p153l.vzf0
        public Merchandise read(Cursor cursor, int i) {
            String str;
            int i2;
            int i3;
            String string;
            ...
            try {
                ...
                merchandise._id = cursor.getLong(i);
                int i5 = i + 1;
                String string3 = null;
                merchandise.f56859id = cursor.isNull(i5) ? null : cursor.getString(i5);
                int i6 = i + 2;
                ...
                try {
                    ...
                    int i8 = i + 5;
                    merchandise.defaultStockKeepUnit.f21249id = cursor.isNull(i8) ? null : cursor.getString(i8);
                    int i9 = i + 6;
                    ...
                    try {
                        ...
                        int i19 = i + 22;
                        merchandise.localCoupons = cursor.isNull(i19) ? null : Coupon.PROTOBUF_ADAPTER.ARRAY_ADAPTER().parse(cursor.getBlob(i19));
        ...
        public void write(Merchandise merchandise, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", merchandise.f56859id);
                ProductCategory productCategory = merchandise.category;
                ...
                DbObject.cvPut(contentValues, "defaultStockKeepUnit_id_c", merchandise.defaultStockKeepUnit.f21249id);
    ...
    public boolean autoRenewable() {
        return TEnum.equals(this.productType, "auto-renewable");
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public Merchandise mo225055clone() {
        Merchandise merchandise = new Merchandise();
        merchandise._id = this._id;
        merchandise.f56859id = this.f56859id;
        ...
        if (stockKeepUnit != null) {
            merchandise.defaultStockKeepUnit = stockKeepUnit.mo225055clone();
        }
        List<Coupon> list = this.localCoupons;
        if (list != null) {
            merchandise.localCoupons = ValueObject.util_map(list, new qcj() { // from class: l.rqy
                @Override // p153l.qcj
        ...
        if (merchandiseDurationDesc != null) {
            merchandise.duration = merchandiseDurationDesc.mo225055clone();
        }
        MerchandiseExtra merchandiseExtra = this.extra;
        if (merchandiseExtra != null) {
            merchandise.extra = merchandiseExtra.mo225055clone();
        }
        return merchandise;
    }

    public boolean consumable() {
        return TEnum.equals(this.productType, "consumable");
    }

    public boolean daily() {
        if (this.quantity != 1 || !NullChecker.m82486a(this.duration)) {
            return false;
        }
        MerchandiseDurationDesc merchandiseDurationDesc = this.duration;
        return merchandiseDurationDesc.times == 1 && TextUtils.equals(merchandiseDurationDesc.timeUnit, "day");
    }
    ...
    public Coupon getCouponForPromotion(String str) {
        ...
        return jyb.m147479J(arrayList) ? Coupon.new_() : (Coupon) arrayList.get(0);
    }
    ...
    public Coupon getCouponWithId(String str) {
        for (Coupon coupon : this.localCoupons) {
            if (TextUtils.equals(str, coupon.f56859id)) {
                return coupon;
            }
        }
        return null;
    ...
    public double getFirstCouponPrice() {
        if (jyb.m147479J(this.localCoupons)) {
    ...
    public boolean hour() {
        ...
        MerchandiseDurationDesc merchandiseDurationDesc = this.duration;
        return merchandiseDurationDesc.times == 1 && TextUtils.equals(merchandiseDurationDesc.timeUnit, "hour");
    }
    ...
    public boolean isBelongCouponId(String str) {
        ...
        while (it.hasNext()) {
            if (TextUtils.equals(str, it.next().f56859id)) {
                return true;
            }
        }
        return false;
    ...
    public boolean noneRenewable() {
        return TEnum.equals(this.productType, "none-renewing");
    }
