...
public class Explore extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Explore> PROTOBUF_ADAPTER = new MessageNanoAdapter<Explore>() { // from class: com.p1.mobile.putong.core.data.Explore.1
        ...
        public int computeAndCacheSize(Explore explore) {
            ...
            int iM17285l = (list != null ? CodedOutputByteBufferNano.m17285l(1, list, CardInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0) + CodedOutputByteBufferNano.m17275b(2, explore.can_swiped) + CodedOutputByteBufferNano.m17275b(3, explore.matched);
            String str = explore.background_color;
            if (str != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(4, str);
            }
            int iM17281h = iM17285l + CodedOutputByteBufferNano.m17281h(5, explore.Remaining_swipes) + CodedOutputByteBufferNano.m17281h(6, explore.remaining_likes);
            String str2 = explore.pop_up_icon;
            if (str2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(7, str2);
            }
            String str3 = explore.pop_up_title;
            if (str3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(8, str3);
            }
            String str4 = explore.pop_up_sub_title;
            if (str4 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(9, str4);
            }
            String str5 = explore.skip;
            if (str5 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(10, str5);
            }
            String str6 = explore.tag_icon;
            if (str6 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(11, str6);
            }
            ...
            if (str8 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(13, str8);
            }
            String str9 = explore.new_pop_up_sub_title;
            if (str9 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(14, str9);
            }
            String str10 = explore.new_pop_up_box_title;
            if (str10 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(15, str10);
            }
            String str11 = explore.new_pop_up_warning;
            if (str11 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(16, str11);
            }
            explore.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Explore parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        explore.cards = (List) nc5Var.m162488l(CardInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 16:
                        explore.can_swiped = nc5Var.m162483g();
                        continue;
                    case 24:
                        explore.matched = nc5Var.m162483g();
                        continue;
                    case 34:
                        explore.background_color = nc5Var.m162495s();
                        continue;
                    case 40:
                        explore.Remaining_swipes = nc5Var.m162486j();
                        continue;
                    case 48:
                        explore.remaining_likes = nc5Var.m162486j();
                        continue;
                    case 58:
                        explore.pop_up_icon = nc5Var.m162495s();
                        continue;
                    case 66:
                        explore.pop_up_title = nc5Var.m162495s();
                        continue;
                    case 74:
                        explore.pop_up_sub_title = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        explore.skip = nc5Var.m162495s();
                        continue;
                    case 90:
                        explore.tag_icon = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        explore.tag_background_color = nc5Var.m162495s();
                        continue;
                    case 106:
                        explore.new_pop_up_title = nc5Var.m162495s();
                        continue;
                    case 114:
                        explore.new_pop_up_sub_title = nc5Var.m162495s();
                        continue;
                    case 122:
                        explore.new_pop_up_box_title = nc5Var.m162495s();
                        continue;
                    case 130:
                        explore.new_pop_up_warning = nc5Var.m162495s();
                        continue;
                    default:
                        if (explore.cards == null) {
                            explore.cards = new ArrayList();
        ...
        public void serialize(Explore explore, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<CardInfo> list = explore.cards;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, CardInfo.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17299A(2, explore.can_swiped);
            codedOutputByteBufferNano.m17299A(3, explore.matched);
            String str = explore.background_color;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(4, str);
            }
            codedOutputByteBufferNano.m17305G(5, explore.Remaining_swipes);
            codedOutputByteBufferNano.m17305G(6, explore.remaining_likes);
            String str2 = explore.pop_up_icon;
            if (str2 != null) {
            ...
            String str11 = explore.new_pop_up_warning;
            if (str11 != null) {
                codedOutputByteBufferNano.m17316R(16, str11);
            }
        }
    };
    ...
    public Explore mo225055clone() {
        Explore explore = new Explore();
        List<CardInfo> list = this.cards;
        if (list != null) {
            explore.cards = ValueObject.util_map(list, new qcj() { // from class: l.wof
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((CardInfo) obj).mo225055clone();
                }
            });
        }
