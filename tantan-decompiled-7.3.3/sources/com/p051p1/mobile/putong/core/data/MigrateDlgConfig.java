...
public class MigrateDlgConfig extends BaseData implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MigrateDlgConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<MigrateDlgConfig>() { // from class: com.p1.mobile.putong.core.data.MigrateDlgConfig.1
        ...
        public int computeAndCacheSize(MigrateDlgConfig migrateDlgConfig) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, migrateDlgConfig.showDialog);
            ...
            if (migrateDlgTextConfig != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(4, migrateDlgTextConfig, MigrateDlgTextConfig.PROTOBUF_ADAPTER);
            }
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(5, migrateDlgConfig.migrateDlgClosable);
            String str3 = migrateDlgConfig.homepageURL;
            if (str3 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(6, str3);
            }
            int iM17275b3 = iM17275b2 + CodedOutputByteBufferNano.m17275b(7, migrateDlgConfig.ignoreHw);
            migrateDlgConfig.cachedSize = iM17275b3;
            return iM17275b3;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MigrateDlgConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    migrateDlgConfig.showDialog = nc5Var.m162483g();
                } else if (iM162497u == 18) {
                    migrateDlgConfig.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    migrateDlgConfig.picUrl = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    migrateDlgConfig.texts = (MigrateDlgTextConfig) nc5Var.m162488l(MigrateDlgTextConfig.PROTOBUF_ADAPTER);
                } else if (iM162497u == 40) {
                    migrateDlgConfig.migrateDlgClosable = nc5Var.m162483g();
                } else if (iM162497u == 50) {
                    migrateDlgConfig.homepageURL = nc5Var.m162495s();
                } else {
                    if (iM162497u != 56) {
                        if (migrateDlgConfig.type == null) {
                            migrateDlgConfig.type = "";
                    ...
                    migrateDlgConfig.ignoreHw = nc5Var.m162483g();
                }
            }
            return migrateDlgConfig;
        }
        ...
        public void serialize(MigrateDlgConfig migrateDlgConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, migrateDlgConfig.showDialog);
            String str = migrateDlgConfig.type;
            if (str != null) {
            ...
            MigrateDlgTextConfig migrateDlgTextConfig = migrateDlgConfig.texts;
            if (migrateDlgTextConfig != null) {
                codedOutputByteBufferNano.m17309K(4, migrateDlgTextConfig, MigrateDlgTextConfig.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(5, migrateDlgConfig.migrateDlgClosable);
            String str3 = migrateDlgConfig.homepageURL;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(6, str3);
            }
            codedOutputByteBufferNano.m17299A(7, migrateDlgConfig.ignoreHw);
        }
    };
    ...
    public MigrateDlgConfig mo225055clone() {
        MigrateDlgConfig migrateDlgConfig = new MigrateDlgConfig();
        ...
        if (migrateDlgTextConfig != null) {
            migrateDlgConfig.texts = migrateDlgTextConfig.mo225055clone();
        }
