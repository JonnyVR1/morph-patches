...
public class ChatInviteToVerifyConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatInviteToVerifyConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatInviteToVerifyConfig>() { // from class: com.p1.mobile.putong.core.data.ChatInviteToVerifyConfig.1
        ...
        public int computeAndCacheSize(ChatInviteToVerifyConfig chatInviteToVerifyConfig) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, chatInviteToVerifyConfig.enable) + CodedOutputByteBufferNano.m17281h(2, chatInviteToVerifyConfig.insertMessageLiming);
            String str = chatInviteToVerifyConfig.functionStartTime;
            if (str != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(3, str);
            }
            chatInviteToVerifyConfig.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatInviteToVerifyConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    chatInviteToVerifyConfig.enable = nc5Var.m162483g();
                } else if (iM162497u == 16) {
                    chatInviteToVerifyConfig.insertMessageLiming = nc5Var.m162486j();
                } else {
                    if (iM162497u != 26) {
                        if (chatInviteToVerifyConfig.functionStartTime != null) {
                            break;
                    ...
                    chatInviteToVerifyConfig.functionStartTime = nc5Var.m162495s();
                }
            }
            return chatInviteToVerifyConfig;
        }
        ...
        public void serialize(ChatInviteToVerifyConfig chatInviteToVerifyConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, chatInviteToVerifyConfig.enable);
            codedOutputByteBufferNano.m17305G(2, chatInviteToVerifyConfig.insertMessageLiming);
            String str = chatInviteToVerifyConfig.functionStartTime;
            if (str != null) {
    ...
    public ChatInviteToVerifyConfig mo225055clone() {
        ChatInviteToVerifyConfig chatInviteToVerifyConfig = new ChatInviteToVerifyConfig();
