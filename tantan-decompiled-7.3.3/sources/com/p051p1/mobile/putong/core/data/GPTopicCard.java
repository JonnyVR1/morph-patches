...
public class GPTopicCard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GPTopicCard> PROTOBUF_ADAPTER = new MessageNanoAdapter<GPTopicCard>() { // from class: com.p1.mobile.putong.core.data.GPTopicCard.1
        ...
        public int computeAndCacheSize(GPTopicCard gPTopicCard) {
            ...
            gPTopicCard.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GPTopicCard parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    gPTopicCard.name = nc5Var.m162495s();
                } else {
                    if (iM162497u != 18) {
                        if (gPTopicCard.name == null) {
                            gPTopicCard.name = "";
                    ...
                    gPTopicCard.pictures = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return gPTopicCard;
        }
    ...
    public GPTopicCard mo225055clone() {
        GPTopicCard gPTopicCard = new GPTopicCard();
        gPTopicCard.name = this.name;
        List<Media> list = this.pictures;
        if (list != null) {
            gPTopicCard.pictures = ValueObject.util_map(list, new qcj() { // from class: l.jjj
                @Override // p153l.qcj
