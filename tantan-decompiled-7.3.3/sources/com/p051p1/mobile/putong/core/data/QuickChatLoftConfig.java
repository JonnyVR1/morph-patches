...
public class QuickChatLoftConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuickChatLoftConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuickChatLoftConfig>() { // from class: com.p1.mobile.putong.core.data.QuickChatLoftConfig.1
        ...
        public int computeAndCacheSize(QuickChatLoftConfig quickChatLoftConfig) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, quickChatLoftConfig.online_poll_interval) + CodedOutputByteBufferNano.m17281h(2, quickChatLoftConfig.online_count_max);
            quickChatLoftConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuickChatLoftConfig parse(nc5 nc5Var) throws IOException {
            QuickChatLoftConfig quickChatLoftConfig = new QuickChatLoftConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    quickChatLoftConfig.online_poll_interval = nc5Var.m162486j();
                } else {
                    if (iM162497u != 16) {
                        return quickChatLoftConfig;
                    }
                    quickChatLoftConfig.online_count_max = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(QuickChatLoftConfig quickChatLoftConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, quickChatLoftConfig.online_poll_interval);
            codedOutputByteBufferNano.m17305G(2, quickChatLoftConfig.online_count_max);
        }
    };
    ...
    public QuickChatLoftConfig mo225055clone() {
        QuickChatLoftConfig quickChatLoftConfig = new QuickChatLoftConfig();
