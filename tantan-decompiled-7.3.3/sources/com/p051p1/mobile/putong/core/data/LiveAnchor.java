...
public class LiveAnchor extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveAnchor> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveAnchor>() { // from class: com.p1.mobile.putong.core.data.LiveAnchor.1
        ...
        public int computeAndCacheSize(LiveAnchor liveAnchor) {
            ...
            if (verificationStatus != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(2, verificationStatus.ordinal());
            }
            VerificationStatus verificationStatus2 = liveAnchor.status;
            if (verificationStatus2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, verificationStatus2, VerificationStatus.PROTOBUF_ADAPTER);
            }
            liveAnchor.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveAnchor parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    liveAnchor.guildId = nc5Var.m162495s();
                    ...
                    liveAnchor.status = (VerificationStatus) nc5Var.m162488l(VerificationStatus.PROTOBUF_ADAPTER);
                }
            }
            return liveAnchor;
        }
        ...
        public void serialize(LiveAnchor liveAnchor, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            VerificationStatus verificationStatus = liveAnchor.status;
            if (verificationStatus != null) {
                codedOutputByteBufferNano.m17305G(2, verificationStatus.ordinal());
            }
            VerificationStatus verificationStatus2 = liveAnchor.status;
            if (verificationStatus2 != null) {
                codedOutputByteBufferNano.m17309K(3, verificationStatus2, VerificationStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LiveAnchor mo225055clone() {
        LiveAnchor liveAnchor = new LiveAnchor();
