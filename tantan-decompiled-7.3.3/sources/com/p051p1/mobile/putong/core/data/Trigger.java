    ...
    public static ProtobufAdapter<Trigger> PROTOBUF_ADAPTER = new MessageNanoAdapter<Trigger>() { // from class: com.p1.mobile.putong.core.data.Trigger.1
        ...
        public int computeAndCacheSize(Trigger trigger) {
            ...
            if (triggerParams != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, triggerParams, TriggerParams.PROTOBUF_ADAPTER);
            }
            trigger.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Trigger parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    trigger.triggerKey = nc5Var.m162495s();
                } else {
                    if (iM162497u != 18) {
                        if (trigger.triggerKey == null) {
                            trigger.triggerKey = "";
                    ...
                    trigger.params = (TriggerParams) nc5Var.m162488l(TriggerParams.PROTOBUF_ADAPTER);
                }
            }
            return trigger;
        }
        ...
        public void serialize(Trigger trigger, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            TriggerParams triggerParams = trigger.params;
            if (triggerParams != null) {
                codedOutputByteBufferNano.m17309K(2, triggerParams, TriggerParams.PROTOBUF_ADAPTER);
            }
        }
    };
