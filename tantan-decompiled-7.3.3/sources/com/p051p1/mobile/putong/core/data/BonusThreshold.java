...
public class BonusThreshold extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BonusThreshold> PROTOBUF_ADAPTER = new MessageNanoAdapter<BonusThreshold>() { // from class: com.p1.mobile.putong.core.data.BonusThreshold.1
        ...
        public int computeAndCacheSize(BonusThreshold bonusThreshold) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, bonusThreshold.textBuzz) + CodedOutputByteBufferNano.m17281h(2, bonusThreshold.voiceBuzz) + CodedOutputByteBufferNano.m17281h(3, bonusThreshold.videoBuzz) + CodedOutputByteBufferNano.m17281h(4, bonusThreshold.memojiBuzz);
            bonusThreshold.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BonusThreshold parse(nc5 nc5Var) throws IOException {
            BonusThreshold bonusThreshold = new BonusThreshold();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    bonusThreshold.textBuzz = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    bonusThreshold.voiceBuzz = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    bonusThreshold.videoBuzz = nc5Var.m162486j();
                } else {
                    if (iM162497u != 32) {
                        return bonusThreshold;
                    }
                    bonusThreshold.memojiBuzz = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(BonusThreshold bonusThreshold, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, bonusThreshold.textBuzz);
            codedOutputByteBufferNano.m17305G(2, bonusThreshold.voiceBuzz);
            codedOutputByteBufferNano.m17305G(3, bonusThreshold.videoBuzz);
            codedOutputByteBufferNano.m17305G(4, bonusThreshold.memojiBuzz);
        }
    };
    ...
    public BonusThreshold mo225055clone() {
        BonusThreshold bonusThreshold = new BonusThreshold();
