...
public class DynamicLable extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<DynamicLable> PROTOBUF_ADAPTER = new MessageNanoAdapter<DynamicLable>() { // from class: com.p1.mobile.putong.core.data.DynamicLable.1
        ...
        public int computeAndCacheSize(DynamicLable dynamicLable) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(4, dynamicLable.textBold);
            ...
            if (labelBackground != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(6, labelBackground, LabelBackground.PROTOBUF_ADAPTER);
            }
            LabelIconStyle labelIconStyle = dynamicLable.iconStyle;
            if (labelIconStyle != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(7, labelIconStyle, LabelIconStyle.PROTOBUF_ADAPTER);
            }
            LabelStatistics labelStatistics = dynamicLable.statistics;
            if (labelStatistics != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(8, labelStatistics, LabelStatistics.PROTOBUF_ADAPTER);
            }
            LabelshowTips labelshowTips = dynamicLable.showTips;
            if (labelshowTips != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(9, labelshowTips, LabelshowTips.PROTOBUF_ADAPTER);
            }
            dynamicLable.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public DynamicLable parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    dynamicLable.label = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    dynamicLable.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    dynamicLable.textColor = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    dynamicLable.textBold = nc5Var.m162483g();
                } else if (iM162497u == 42) {
                    dynamicLable.deeplink = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    dynamicLable.background = (LabelBackground) nc5Var.m162488l(LabelBackground.PROTOBUF_ADAPTER);
                } else if (iM162497u == 58) {
                    dynamicLable.iconStyle = (LabelIconStyle) nc5Var.m162488l(LabelIconStyle.PROTOBUF_ADAPTER);
                } else if (iM162497u == 66) {
                    dynamicLable.statistics = (LabelStatistics) nc5Var.m162488l(LabelStatistics.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 74) {
                        if (dynamicLable.label == null) {
                            dynamicLable.label = "";
                    ...
                    dynamicLable.showTips = (LabelshowTips) nc5Var.m162488l(LabelshowTips.PROTOBUF_ADAPTER);
                }
            }
            return dynamicLable;
        }
        ...
        public void serialize(DynamicLable dynamicLable, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(4, dynamicLable.textBold);
            String str4 = dynamicLable.deeplink;
            if (str4 != null) {
            ...
            LabelBackground labelBackground = dynamicLable.background;
            if (labelBackground != null) {
                codedOutputByteBufferNano.m17309K(6, labelBackground, LabelBackground.PROTOBUF_ADAPTER);
            }
            LabelIconStyle labelIconStyle = dynamicLable.iconStyle;
            if (labelIconStyle != null) {
                codedOutputByteBufferNano.m17309K(7, labelIconStyle, LabelIconStyle.PROTOBUF_ADAPTER);
            }
            LabelStatistics labelStatistics = dynamicLable.statistics;
            if (labelStatistics != null) {
                codedOutputByteBufferNano.m17309K(8, labelStatistics, LabelStatistics.PROTOBUF_ADAPTER);
            }
            LabelshowTips labelshowTips = dynamicLable.showTips;
            if (labelshowTips != null) {
                codedOutputByteBufferNano.m17309K(9, labelshowTips, LabelshowTips.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public DynamicLable mo225055clone() {
        DynamicLable dynamicLable = new DynamicLable();
        ...
        if (labelBackground != null) {
            dynamicLable.background = labelBackground.mo225055clone();
        }
        LabelIconStyle labelIconStyle = this.iconStyle;
        if (labelIconStyle != null) {
            dynamicLable.iconStyle = labelIconStyle.mo225055clone();
        }
        LabelStatistics labelStatistics = this.statistics;
        if (labelStatistics != null) {
            dynamicLable.statistics = labelStatistics.mo225055clone();
        }
        LabelshowTips labelshowTips = this.showTips;
        if (labelshowTips != null) {
            dynamicLable.showTips = labelshowTips.mo225055clone();
        }
        return dynamicLable;
    }
