...
public class FateRadar extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FateRadar> PROTOBUF_ADAPTER = new MessageNanoAdapter<FateRadar>() { // from class: com.p1.mobile.putong.core.data.FateRadar.1
        ...
        public int computeAndCacheSize(FateRadar fateRadar) {
            ...
            int iM17285l = fateRadarSwitchStatus != null ? CodedOutputByteBufferNano.m17285l(1, fateRadarSwitchStatus, FateRadarSwitchStatus.PROTOBUF_ADAPTER) : 0;
            FateRadarSearchConditions fateRadarSearchConditions = fateRadar.searchConditions;
            if (fateRadarSearchConditions != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, fateRadarSearchConditions, FateRadarSearchConditions.PROTOBUF_ADAPTER);
            }
            FateRadarGreeting fateRadarGreeting = fateRadar.greetings;
            if (fateRadarGreeting != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, fateRadarGreeting, FateRadarGreeting.PROTOBUF_ADAPTER);
            }
            AiGreetingValue aiGreetingValue = fateRadar.aiGreeting;
            if (aiGreetingValue != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, aiGreetingValue, AiGreetingValue.PROTOBUF_ADAPTER);
            }
            fateRadar.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FateRadar parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    fateRadar.switchSetting = (FateRadarSwitchStatus) nc5Var.m162488l(FateRadarSwitchStatus.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    fateRadar.searchConditions = (FateRadarSearchConditions) nc5Var.m162488l(FateRadarSearchConditions.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    fateRadar.greetings = (FateRadarGreeting) nc5Var.m162488l(FateRadarGreeting.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 34) {
                        if (fateRadar.switchSetting == null) {
                            fateRadar.switchSetting = FateRadarSwitchStatus.new_();
                    ...
                    fateRadar.aiGreeting = (AiGreetingValue) nc5Var.m162488l(AiGreetingValue.PROTOBUF_ADAPTER);
                }
            }
            return fateRadar;
        }
        ...
        public void serialize(FateRadar fateRadar, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (fateRadarSwitchStatus != null) {
                codedOutputByteBufferNano.m17309K(1, fateRadarSwitchStatus, FateRadarSwitchStatus.PROTOBUF_ADAPTER);
            }
            FateRadarSearchConditions fateRadarSearchConditions = fateRadar.searchConditions;
            if (fateRadarSearchConditions != null) {
                codedOutputByteBufferNano.m17309K(2, fateRadarSearchConditions, FateRadarSearchConditions.PROTOBUF_ADAPTER);
            }
            FateRadarGreeting fateRadarGreeting = fateRadar.greetings;
            if (fateRadarGreeting != null) {
                codedOutputByteBufferNano.m17309K(3, fateRadarGreeting, FateRadarGreeting.PROTOBUF_ADAPTER);
            }
            AiGreetingValue aiGreetingValue = fateRadar.aiGreeting;
            if (aiGreetingValue != null) {
                codedOutputByteBufferNano.m17309K(4, aiGreetingValue, AiGreetingValue.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public FateRadar mo225055clone() {
        FateRadar fateRadar = new FateRadar();
        FateRadarSwitchStatus fateRadarSwitchStatus = this.switchSetting;
        if (fateRadarSwitchStatus != null) {
            fateRadar.switchSetting = fateRadarSwitchStatus.mo225055clone();
        }
        FateRadarSearchConditions fateRadarSearchConditions = this.searchConditions;
        if (fateRadarSearchConditions != null) {
            fateRadar.searchConditions = fateRadarSearchConditions.mo225055clone();
        }
        FateRadarGreeting fateRadarGreeting = this.greetings;
        if (fateRadarGreeting != null) {
            fateRadar.greetings = fateRadarGreeting.mo225055clone();
        }
        AiGreetingValue aiGreetingValue = this.aiGreeting;
        if (aiGreetingValue != null) {
            fateRadar.aiGreeting = aiGreetingValue.mo225055clone();
        }
        return fateRadar;
    }
