...
public class ODiamondFeed extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ODiamondFeed> PROTOBUF_ADAPTER = new MessageNanoAdapter<ODiamondFeed>() { // from class: com.p1.mobile.putong.core.data.ODiamondFeed.1
        ...
        public int computeAndCacheSize(ODiamondFeed oDiamondFeed) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, oDiamondFeed.redDot);
            ...
            if (oDiamondFeedType != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(3, oDiamondFeedType, ODiamondFeedType.PROTOBUF_ADAPTER);
            }
            ...
            if (oDiamondFeedLatestVisitor != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(7, oDiamondFeedLatestVisitor, ODiamondFeedLatestVisitor.PROTOBUF_ADAPTER);
            }
            ODiamondFeedInstantChat oDiamondFeedInstantChat = oDiamondFeed.instantChat;
            if (oDiamondFeedInstantChat != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(8, oDiamondFeedInstantChat, ODiamondFeedInstantChat.PROTOBUF_ADAPTER);
            }
            oDiamondFeed.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ODiamondFeed parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    oDiamondFeed.redDot = nc5Var.m162483g();
                } else if (iM162497u == 18) {
                    oDiamondFeed.userIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 26) {
                    oDiamondFeed.feedType = (ODiamondFeedType) nc5Var.m162488l(ODiamondFeedType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    oDiamondFeed.text = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    oDiamondFeed.subText = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    oDiamondFeed.highLight = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    oDiamondFeed.latestVisitor = (ODiamondFeedLatestVisitor) nc5Var.m162488l(ODiamondFeedLatestVisitor.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 66) {
                        if (oDiamondFeed.userIds == null) {
                            oDiamondFeed.userIds = new ArrayList();
                    ...
                    oDiamondFeed.instantChat = (ODiamondFeedInstantChat) nc5Var.m162488l(ODiamondFeedInstantChat.PROTOBUF_ADAPTER);
                }
            }
            return oDiamondFeed;
        }
        ...
        public void serialize(ODiamondFeed oDiamondFeed, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, oDiamondFeed.redDot);
            List<String> list = oDiamondFeed.userIds;
            if (list != null) {
            ...
            ODiamondFeedType oDiamondFeedType = oDiamondFeed.feedType;
            if (oDiamondFeedType != null) {
                codedOutputByteBufferNano.m17309K(3, oDiamondFeedType, ODiamondFeedType.PROTOBUF_ADAPTER);
            }
            String str = oDiamondFeed.text;
            if (str != null) {
            ...
            ODiamondFeedLatestVisitor oDiamondFeedLatestVisitor = oDiamondFeed.latestVisitor;
            if (oDiamondFeedLatestVisitor != null) {
                codedOutputByteBufferNano.m17309K(7, oDiamondFeedLatestVisitor, ODiamondFeedLatestVisitor.PROTOBUF_ADAPTER);
            }
            ODiamondFeedInstantChat oDiamondFeedInstantChat = oDiamondFeed.instantChat;
            if (oDiamondFeedInstantChat != null) {
                codedOutputByteBufferNano.m17309K(8, oDiamondFeedInstantChat, ODiamondFeedInstantChat.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m36728a(String str) {
        return str;
    }
    ...
    public ODiamondFeed mo225055clone() {
        ODiamondFeed oDiamondFeed = new ODiamondFeed();
        oDiamondFeed.redDot = this.redDot;
        List<String> list = this.userIds;
        if (list != null) {
            oDiamondFeed.userIds = ValueObject.util_map(list, new qcj() { // from class: l.m450
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ODiamondFeed.m36728a((String) obj);
                }
            });
        }
        ...
        if (oDiamondFeedLatestVisitor != null) {
            oDiamondFeed.latestVisitor = oDiamondFeedLatestVisitor.mo225055clone();
        }
        ODiamondFeedInstantChat oDiamondFeedInstantChat = this.instantChat;
        if (oDiamondFeedInstantChat != null) {
            oDiamondFeed.instantChat = oDiamondFeedInstantChat.mo225055clone();
        }
        return oDiamondFeed;
    }
