...
public class TopicMomentIdBox extends ValueObject implements Cloneable, Serializable {
    ...
    public String f21264id;

    @NonNull
    @ProtobufIndex(index = 2)
    public String name;
    public static ProtobufAdapter<TopicMomentIdBox> PROTOBUF_ADAPTER = new MessageNanoAdapter<TopicMomentIdBox>() { // from class: com.p1.mobile.putong.core.data.TopicMomentIdBox.1
        {
            this.wireFormat = 2;
        }
        ...
        public int computeAndCacheSize(TopicMomentIdBox topicMomentIdBox) {
            String str = topicMomentIdBox.f21264id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            String str2 = topicMomentIdBox.name;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(2, str2);
            }
            topicMomentIdBox.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TopicMomentIdBox parse(nc5 nc5Var) throws IOException {
            TopicMomentIdBox topicMomentIdBox = new TopicMomentIdBox();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (topicMomentIdBox.f21264id == null) {
                        topicMomentIdBox.f21264id = "";
                    }
                ...
                if (iM162497u == 10) {
                    topicMomentIdBox.f21264id = nc5Var.m162495s();
                } else {
                    if (iM162497u != 18) {
                        if (topicMomentIdBox.f21264id == null) {
                            topicMomentIdBox.f21264id = "";
                    ...
                    topicMomentIdBox.name = nc5Var.m162495s();
                }
            }
            return topicMomentIdBox;
        }
    ...
    public static JsonAdapter<TopicMomentIdBox> JSON_ADAPTER = new ObjectJsonAdapter<TopicMomentIdBox>() { // from class: com.p1.mobile.putong.core.data.TopicMomentIdBox.2
        ...
        public boolean parseField(TopicMomentIdBox topicMomentIdBox, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            str.getClass();
            if (str.equals("id")) {
                topicMomentIdBox.f21264id = jsonParser.getValueAsString();
                return false;
            }
    ...
    public TopicMomentIdBox mo225055clone() {
        TopicMomentIdBox topicMomentIdBox = new TopicMomentIdBox();
        topicMomentIdBox.f21264id = this.f21264id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21264id, topicMomentIdBox.f21264id) && ValueObject.util_equals(this.name, topicMomentIdBox.name);
    }
