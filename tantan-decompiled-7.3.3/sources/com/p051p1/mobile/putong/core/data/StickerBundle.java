...
public class StickerBundle extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StickerBundle> PROTOBUF_ADAPTER = new MessageNanoAdapter<StickerBundle>() { // from class: com.p1.mobile.putong.core.data.StickerBundle.1
        ...
        public int computeAndCacheSize(StickerBundle stickerBundle) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(3, stickerBundle.price);
            List<Picture> list = stickerBundle.pictures;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(4, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = stickerBundle.f21247id;
            if (str3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(5, str3);
            }
            BundleStatus bundleStatus = stickerBundle.status;
            if (bundleStatus != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(6, bundleStatus.ordinal());
            }
            ...
            if (bundleStatus2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(9, bundleStatus2, BundleStatus.PROTOBUF_ADAPTER);
            }
            stickerBundle.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StickerBundle parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 0) {
                    ...
                    if (stickerBundle.f21247id == null) {
                        stickerBundle.f21247id = "";
                    }
                ...
                if (iM162497u == 10) {
                    stickerBundle.name = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    stickerBundle.description = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    stickerBundle.price = nc5Var.m162486j();
                } else if (iM162497u == 34) {
                    stickerBundle.pictures = (List) nc5Var.m162488l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 42) {
                    stickerBundle.f21247id = nc5Var.m162495s();
                } else if (iM162497u == 48) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 58) {
                    stickerBundle.currency = nc5Var.m162495s();
                } else if (iM162497u == 66) {
                    stickerBundle.packages = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 74) {
                        if (stickerBundle.status == null && numValueOf != null) {
                            stickerBundle.status = (BundleStatus) BundleStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    stickerBundle.status = (BundleStatus) nc5Var.m162488l(BundleStatus.PROTOBUF_ADAPTER);
                }
            }
            return stickerBundle;
        }
        ...
        public void serialize(StickerBundle stickerBundle, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(3, stickerBundle.price);
            List<Picture> list = stickerBundle.pictures;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(4, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = stickerBundle.f21247id;
            if (str3 != null) {
            ...
            BundleStatus bundleStatus = stickerBundle.status;
            if (bundleStatus != null) {
                codedOutputByteBufferNano.m17305G(6, bundleStatus.ordinal());
            }
            String str4 = stickerBundle.currency;
            if (str4 != null) {
            ...
            BundleStatus bundleStatus2 = stickerBundle.status;
            if (bundleStatus2 != null) {
                codedOutputByteBufferNano.m17309K(9, bundleStatus2, BundleStatus.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(StickerBundle stickerBundle, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "pictures":
                    ...
                    return true;
                case "id":
                    stickerBundle.f21247id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public static /* synthetic */ String m36864b(String str) {
        return str;
    }
    ...
    public StickerBundle mo225055clone() {
        StickerBundle stickerBundle = new StickerBundle();
        ...
        if (list != null) {
            stickerBundle.pictures = ValueObject.util_map(list, new qcj() { // from class: l.d5g0
                @Override // p153l.qcj
        ...
        stickerBundle.f21247id = this.f21247id;
        stickerBundle.status = this.status;
        stickerBundle.currency = this.currency;
        List<String> list2 = this.packages;
        if (list2 != null) {
            stickerBundle.packages = ValueObject.util_map(list2, new qcj() { // from class: l.e5g0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return StickerBundle.m36864b((String) obj);
                }
            });
        }
        return stickerBundle;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.name, stickerBundle.name) && ValueObject.util_equals(this.description, stickerBundle.description) && this.price == stickerBundle.price && ValueObject.util_equals(this.pictures, stickerBundle.pictures) && ValueObject.util_equals(this.f21247id, stickerBundle.f21247id) && ValueObject.util_equals(this.status, stickerBundle.status) && ValueObject.util_equals(this.currency, stickerBundle.currency) && ValueObject.util_equals(this.packages, stickerBundle.packages);
    }
