...
import com.p051p1.mobile.putong.core.data.OutLikeMsgFrontTextListConfig;
...
public class OutLikeMsgFrontTextListConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OutLikeMsgFrontTextListConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<OutLikeMsgFrontTextListConfig>() { // from class: com.p1.mobile.putong.core.data.OutLikeMsgFrontTextListConfig.1
        ...
        public int computeAndCacheSize(OutLikeMsgFrontTextListConfig outLikeMsgFrontTextListConfig) {
            ...
            outLikeMsgFrontTextListConfig.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OutLikeMsgFrontTextListConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    outLikeMsgFrontTextListConfig.female = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (outLikeMsgFrontTextListConfig.female == null) {
                            outLikeMsgFrontTextListConfig.female = new ArrayList();
                    ...
                    outLikeMsgFrontTextListConfig.male = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return outLikeMsgFrontTextListConfig;
        }
    ...
    public static /* synthetic */ String m36744a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m36745b(String str) {
        return str;
    }
    ...
    public OutLikeMsgFrontTextListConfig mo225055clone() {
        OutLikeMsgFrontTextListConfig outLikeMsgFrontTextListConfig = new OutLikeMsgFrontTextListConfig();
        List<String> list = this.female;
        if (list != null) {
            outLikeMsgFrontTextListConfig.female = ValueObject.util_map(list, new qcj() { // from class: l.g760
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OutLikeMsgFrontTextListConfig.m36744a((String) obj);
                }
            });
        }
        List<String> list2 = this.male;
        if (list2 != null) {
            outLikeMsgFrontTextListConfig.male = ValueObject.util_map(list2, new qcj() { // from class: l.h760
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OutLikeMsgFrontTextListConfig.m36745b((String) obj);
                }
            });
        }
        return outLikeMsgFrontTextListConfig;
