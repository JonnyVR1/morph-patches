...
public class FaceidToken extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FaceidToken> PROTOBUF_ADAPTER = new MessageNanoAdapter<FaceidToken>() { // from class: com.p1.mobile.putong.core.data.FaceidToken.1
        ...
        public int computeAndCacheSize(FaceidToken faceidToken) {
            ...
            int iM17277d = iM17288o + CodedOutputByteBufferNano.m17277d(3, faceidToken.expiredTime) + CodedOutputByteBufferNano.m17275b(4, faceidToken.withPV) + CodedOutputByteBufferNano.m17275b(5, faceidToken.omitLiveData);
            faceidToken.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FaceidToken parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    faceidToken.faceidToken = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    faceidToken.value = nc5Var.m162495s();
                } else if (iM162497u == 25) {
                    faceidToken.expiredTime = nc5Var.m162484h();
                } else if (iM162497u == 32) {
                    faceidToken.withPV = nc5Var.m162483g();
                } else {
                    if (iM162497u != 40) {
                        if (faceidToken.faceidToken == null) {
                            faceidToken.faceidToken = "";
                    ...
                    faceidToken.omitLiveData = nc5Var.m162483g();
                }
            }
            return faceidToken;
        }
        ...
        public void serialize(FaceidToken faceidToken, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17301C(3, faceidToken.expiredTime);
            codedOutputByteBufferNano.m17299A(4, faceidToken.withPV);
            codedOutputByteBufferNano.m17299A(5, faceidToken.omitLiveData);
        }
    };
    ...
    public FaceidToken mo225055clone() {
        FaceidToken faceidToken = new FaceidToken();
