    ...
    public static ProtobufAdapter<GroupCreate> PROTOBUF_ADAPTER = new MessageNanoAdapter<GroupCreate>() { // from class: com.p1.mobile.putong.core.data.GroupCreate.1
        ...
        public int computeAndCacheSize(GroupCreate groupCreate) {
            ...
            if (groupCategory != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, groupCategory, GroupCategory.PROTOBUF_ADAPTER);
            }
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            groupCreate.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GroupCreate parse(nc5 nc5Var) throws IOException {
            GroupCreate groupCreate = new GroupCreate();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 10) {
                    groupCreate.name = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    groupCreate.description = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    groupCreate.category = (GroupCategory) nc5Var.m162488l(GroupCategory.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    groupCreate.type = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        return groupCreate;
                    }
                    groupCreate.avatars = (List) nc5Var.m162488l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
        }
        ...
        public void serialize(GroupCreate groupCreate, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            GroupCategory groupCategory = groupCreate.category;
            if (groupCategory != null) {
                codedOutputByteBufferNano.m17309K(3, groupCategory, GroupCategory.PROTOBUF_ADAPTER);
            }
            String str3 = groupCreate.type;
            if (str3 != null) {
            ...
            List<Picture> list = groupCreate.avatars;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(5, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
