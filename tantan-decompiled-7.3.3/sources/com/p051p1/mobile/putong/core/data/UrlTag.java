...
public class UrlTag extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UrlTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<UrlTag>() { // from class: com.p1.mobile.putong.core.data.UrlTag.1
        ...
        public int computeAndCacheSize(UrlTag urlTag) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, list, UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            urlTag.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UrlTag parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    ...
                    urlTag.tags = (List) nc5Var.m162488l(UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return urlTag;
        }
        ...
        public void serialize(UrlTag urlTag, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<UserTagData> list = urlTag.tags;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, UserTagData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public UrlTag mo225055clone() {
        UrlTag urlTag = new UrlTag();
        urlTag.url = this.url;
        List<UserTagData> list = this.tags;
        if (list != null) {
            urlTag.tags = ValueObject.util_map(list, new qcj() { // from class: l.w5k0
                @Override // p153l.qcj
