...
public class CreditScoreData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CreditScoreData> PROTOBUF_ADAPTER = new MessageNanoAdapter<CreditScoreData>() { // from class: com.p1.mobile.putong.core.data.CreditScoreData.1
        ...
        public int computeAndCacheSize(CreditScoreData creditScoreData) {
            String str = creditScoreData.f21126id;
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, creditScoreData.creditScore) + CodedOutputByteBufferNano.m17275b(3, creditScoreData.show);
            creditScoreData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CreditScoreData parse(nc5 nc5Var) throws IOException {
            CreditScoreData creditScoreData = new CreditScoreData();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (creditScoreData.f21126id != null) {
                        break;
                    }
                    creditScoreData.f21126id = "";
                    break;
                }
                if (iM162497u == 10) {
                    creditScoreData.f21126id = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    creditScoreData.creditScore = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        if (creditScoreData.f21126id != null) {
                            break;
                    ...
                    creditScoreData.show = nc5Var.m162483g();
                }
            }
            return creditScoreData;
        }
        ...
        public void serialize(CreditScoreData creditScoreData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, creditScoreData.creditScore);
            codedOutputByteBufferNano.m17299A(3, creditScoreData.show);
        }
    };
        ...
        public boolean parseField(CreditScoreData creditScoreData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "creditScore":
                    ...
                    return true;
                case "id":
                    creditScoreData.f21126id = jsonParser.getValueAsString();
                    return false;
                case "show":
    ...
    public CreditScoreData mo225055clone() {
        CreditScoreData creditScoreData = new CreditScoreData();
        creditScoreData.f21126id = this.f21126id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21126id, creditScoreData.f21126id) && this.creditScore == creditScoreData.creditScore && this.show == creditScoreData.show;
    }
