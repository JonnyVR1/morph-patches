...
public class ChatGroup extends DbObject<ChatGroup> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatGroup> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatGroup>() { // from class: com.p1.mobile.putong.core.data.ChatGroup.1
        ...
        public int computeAndCacheSize(ChatGroup chatGroup) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, chatGroup._id);
            String str = chatGroup.f56859id;
            if (str != null) {
            ...
            if (list != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(52, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (chatGroupStatus != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(54, chatGroupStatus.ordinal());
            }
            String str4 = chatGroup.localConId;
            if (str4 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(55, str4);
            }
            ...
            if (list2 != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(57, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str6 = chatGroup.creatorUserId;
            if (str6 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(58, str6);
            }
            ChatGroupType chatGroupType = chatGroup.groupType;
            if (chatGroupType != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(59, chatGroupType.ordinal());
            }
            List<String> list3 = chatGroup.memberIds;
            if (list3 != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(60, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(61, chatGroup.memberCount) + CodedOutputByteBufferNano.m17281h(62, chatGroup.memberLimit);
            List<GroupMemberStatistic> list4 = chatGroup.memberStatistics;
            if (list4 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(63, list4, GroupMemberStatistic.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17277d = iM17281h + CodedOutputByteBufferNano.m17277d(64, chatGroup.createdTime) + CodedOutputByteBufferNano.m17277d(65, chatGroup.updatedTime) + CodedOutputByteBufferNano.m17275b(66, chatGroup.localMembersLoaded);
            String str7 = chatGroup.publicId;
            if (str7 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(67, str7);
            }
            ChatGroupCateGory chatGroupCateGory = chatGroup.category;
            if (chatGroupCateGory != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(68, chatGroupCateGory, ChatGroupCateGory.PROTOBUF_ADAPTER);
            }
            String str8 = chatGroup.description;
            if (str8 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(69, str8);
            }
            List<ChatGroupTag> list5 = chatGroup.tags;
            if (list5 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(70, list5, ChatGroupTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GroupApply groupApply = chatGroup.groupApply;
            if (groupApply != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(71, groupApply, GroupApply.PROTOBUF_ADAPTER);
            }
            ChatGroupSilence chatGroupSilence = chatGroup.silence;
            if (chatGroupSilence != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(72, chatGroupSilence, ChatGroupSilence.PROTOBUF_ADAPTER);
            }
            ChatPunishment chatPunishment = chatGroup.punishment;
            if (chatPunishment != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(73, chatPunishment, ChatPunishment.PROTOBUF_ADAPTER);
            }
            ChatGroupStatus chatGroupStatus2 = chatGroup.status;
            if (chatGroupStatus2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(74, chatGroupStatus2, ChatGroupStatus.PROTOBUF_ADAPTER);
            }
            ChatGroupType chatGroupType2 = chatGroup.groupType;
            if (chatGroupType2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(75, chatGroupType2, ChatGroupType.PROTOBUF_ADAPTER);
            }
            int iM17283j2 = iM17277d + CodedOutputByteBufferNano.m17283j(76, chatGroup.expiredTime) + CodedOutputByteBufferNano.m17281h(77, chatGroup.joinRemainedTime);
            String str9 = chatGroup.source;
            if (str9 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17288o(78, str9);
            }
            String str10 = chatGroup.token;
            if (str10 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17288o(79, str10);
            }
            ChatGroupTopic chatGroupTopic = chatGroup.groupTopic;
            if (chatGroupTopic != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17285l(80, chatGroupTopic, ChatGroupTopic.PROTOBUF_ADAPTER);
            }
            int iM17275b = iM17283j2 + CodedOutputByteBufferNano.m17275b(81, chatGroup.upgraded) + CodedOutputByteBufferNano.m17283j(82, chatGroup.duration);
            JoinCondition joinCondition = chatGroup.joinCondition;
            if (joinCondition != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(83, joinCondition, JoinCondition.PROTOBUF_ADAPTER);
            }
            int iM17281h2 = iM17275b + CodedOutputByteBufferNano.m17281h(84, chatGroup.onlineCount) + CodedOutputByteBufferNano.m17281h(85, chatGroup.adminLimit);
            Permissions permissions = chatGroup.permissions;
            if (permissions != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(86, permissions, Permissions.PROTOBUF_ADAPTER);
            }
            InModeration inModeration = chatGroup.inModeration;
            if (inModeration != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(87, inModeration, InModeration.PROTOBUF_ADAPTER);
            }
            String str11 = chatGroup.shareToken;
            if (str11 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(88, str11);
            }
            chatGroup.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatGroup parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        chatGroup._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        chatGroup.f56859id = nc5Var.m162495s();
                        continue;
                    case 410:
                        chatGroup.name = nc5Var.m162495s();
                        continue;
                    case 418:
                        chatGroup.avatars = (List) nc5Var.m162488l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 426:
                        chatGroup.announcement = nc5Var.m162495s();
                        continue;
                    case 432:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 442:
                        chatGroup.localConId = nc5Var.m162495s();
                        continue;
                    case 450:
                        chatGroup.ownerUserId = nc5Var.m162495s();
                        continue;
                    case 458:
                        chatGroup.adminUserIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 466:
                        chatGroup.creatorUserId = nc5Var.m162495s();
                        continue;
                    case 472:
                        numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 482:
                        chatGroup.memberIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 488:
                        chatGroup.memberCount = nc5Var.m162486j();
                        continue;
                    case 496:
                        chatGroup.memberLimit = nc5Var.m162486j();
                        continue;
                    case 506:
                        chatGroup.memberStatistics = (List) nc5Var.m162488l(GroupMemberStatistic.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 513:
                        chatGroup.createdTime = nc5Var.m162484h();
                        continue;
                    case 521:
                        chatGroup.updatedTime = nc5Var.m162484h();
                        continue;
                    case 528:
                        chatGroup.localMembersLoaded = nc5Var.m162483g();
                        continue;
                    case 538:
                        chatGroup.publicId = nc5Var.m162495s();
                        continue;
                    case 546:
                        chatGroup.category = (ChatGroupCateGory) nc5Var.m162488l(ChatGroupCateGory.PROTOBUF_ADAPTER);
                        continue;
                    case 554:
                        chatGroup.description = nc5Var.m162495s();
                        continue;
                    case 562:
                        chatGroup.tags = (List) nc5Var.m162488l(ChatGroupTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 570:
                        chatGroup.groupApply = (GroupApply) nc5Var.m162488l(GroupApply.PROTOBUF_ADAPTER);
                        continue;
                    case IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED_BASELINE /* 578 */:
                        chatGroup.silence = (ChatGroupSilence) nc5Var.m162488l(ChatGroupSilence.PROTOBUF_ADAPTER);
                        continue;
                    case 586:
                        chatGroup.punishment = (ChatPunishment) nc5Var.m162488l(ChatPunishment.PROTOBUF_ADAPTER);
                        continue;
                    case 594:
                        chatGroup.status = (ChatGroupStatus) nc5Var.m162488l(ChatGroupStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 602:
                        chatGroup.groupType = (ChatGroupType) nc5Var.m162488l(ChatGroupType.PROTOBUF_ADAPTER);
                        continue;
                    case 608:
                        chatGroup.expiredTime = nc5Var.m162487k();
                        continue;
                    case 616:
                        chatGroup.joinRemainedTime = nc5Var.m162486j();
                        continue;
                    case 626:
                        chatGroup.source = nc5Var.m162495s();
                        continue;
                    case 634:
                        chatGroup.token = nc5Var.m162495s();
                        continue;
                    case 642:
                        chatGroup.groupTopic = (ChatGroupTopic) nc5Var.m162488l(ChatGroupTopic.PROTOBUF_ADAPTER);
                        continue;
                    case 648:
                        chatGroup.upgraded = nc5Var.m162483g();
                        continue;
                    case 656:
                        chatGroup.duration = nc5Var.m162487k();
                        continue;
                    case 666:
                        chatGroup.joinCondition = (JoinCondition) nc5Var.m162488l(JoinCondition.PROTOBUF_ADAPTER);
                        continue;
                    case 672:
                        chatGroup.onlineCount = nc5Var.m162486j();
                        continue;
                    case 680:
                        chatGroup.adminLimit = nc5Var.m162486j();
                        continue;
                    case 690:
                        chatGroup.permissions = (Permissions) nc5Var.m162488l(Permissions.PROTOBUF_ADAPTER);
                        continue;
                    case 698:
                        chatGroup.inModeration = (InModeration) nc5Var.m162488l(InModeration.PROTOBUF_ADAPTER);
                        continue;
                    case 706:
                        chatGroup.shareToken = nc5Var.m162495s();
                        continue;
                    default:
                        if (chatGroup.status == null && numValueOf != null) {
                            chatGroup.status = (ChatGroupStatus) ChatGroupStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(ChatGroup chatGroup, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, chatGroup._id);
            String str = chatGroup.f56859id;
            if (str != null) {
            ...
            List<Picture> list = chatGroup.avatars;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(52, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = chatGroup.announcement;
            if (str3 != null) {
            ...
            ChatGroupStatus chatGroupStatus = chatGroup.status;
            if (chatGroupStatus != null) {
                codedOutputByteBufferNano.m17305G(54, chatGroupStatus.ordinal());
            }
            String str4 = chatGroup.localConId;
            if (str4 != null) {
            ...
            List<String> list2 = chatGroup.adminUserIds;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(57, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str6 = chatGroup.creatorUserId;
            if (str6 != null) {
                codedOutputByteBufferNano.m17316R(58, str6);
            }
            ChatGroupType chatGroupType = chatGroup.groupType;
            if (chatGroupType != null) {
                codedOutputByteBufferNano.m17305G(59, chatGroupType.ordinal());
            }
            List<String> list3 = chatGroup.memberIds;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(60, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(61, chatGroup.memberCount);
            codedOutputByteBufferNano.m17305G(62, chatGroup.memberLimit);
            List<GroupMemberStatistic> list4 = chatGroup.memberStatistics;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(63, list4, GroupMemberStatistic.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17301C(64, chatGroup.createdTime);
            codedOutputByteBufferNano.m17301C(65, chatGroup.updatedTime);
            codedOutputByteBufferNano.m17299A(66, chatGroup.localMembersLoaded);
            String str7 = chatGroup.publicId;
            if (str7 != null) {
                codedOutputByteBufferNano.m17316R(67, str7);
            }
            ChatGroupCateGory chatGroupCateGory = chatGroup.category;
            if (chatGroupCateGory != null) {
                codedOutputByteBufferNano.m17309K(68, chatGroupCateGory, ChatGroupCateGory.PROTOBUF_ADAPTER);
            }
            String str8 = chatGroup.description;
            if (str8 != null) {
                codedOutputByteBufferNano.m17316R(69, str8);
            }
            List<ChatGroupTag> list5 = chatGroup.tags;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(70, list5, ChatGroupTag.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            GroupApply groupApply = chatGroup.groupApply;
            if (groupApply != null) {
                codedOutputByteBufferNano.m17309K(71, groupApply, GroupApply.PROTOBUF_ADAPTER);
            }
            ChatGroupSilence chatGroupSilence = chatGroup.silence;
            if (chatGroupSilence != null) {
                codedOutputByteBufferNano.m17309K(72, chatGroupSilence, ChatGroupSilence.PROTOBUF_ADAPTER);
            }
            ChatPunishment chatPunishment = chatGroup.punishment;
            if (chatPunishment != null) {
                codedOutputByteBufferNano.m17309K(73, chatPunishment, ChatPunishment.PROTOBUF_ADAPTER);
            }
            ChatGroupStatus chatGroupStatus2 = chatGroup.status;
            if (chatGroupStatus2 != null) {
                codedOutputByteBufferNano.m17309K(74, chatGroupStatus2, ChatGroupStatus.PROTOBUF_ADAPTER);
            }
            ChatGroupType chatGroupType2 = chatGroup.groupType;
            if (chatGroupType2 != null) {
                codedOutputByteBufferNano.m17309K(75, chatGroupType2, ChatGroupType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17307I(76, chatGroup.expiredTime);
            codedOutputByteBufferNano.m17305G(77, chatGroup.joinRemainedTime);
            String str9 = chatGroup.source;
            if (str9 != null) {
                codedOutputByteBufferNano.m17316R(78, str9);
            }
            String str10 = chatGroup.token;
            if (str10 != null) {
                codedOutputByteBufferNano.m17316R(79, str10);
            }
            ChatGroupTopic chatGroupTopic = chatGroup.groupTopic;
            if (chatGroupTopic != null) {
                codedOutputByteBufferNano.m17309K(80, chatGroupTopic, ChatGroupTopic.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(81, chatGroup.upgraded);
            codedOutputByteBufferNano.m17307I(82, chatGroup.duration);
            JoinCondition joinCondition = chatGroup.joinCondition;
            if (joinCondition != null) {
                codedOutputByteBufferNano.m17309K(83, joinCondition, JoinCondition.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(84, chatGroup.onlineCount);
            codedOutputByteBufferNano.m17305G(85, chatGroup.adminLimit);
            Permissions permissions = chatGroup.permissions;
            if (permissions != null) {
                codedOutputByteBufferNano.m17309K(86, permissions, Permissions.PROTOBUF_ADAPTER);
            }
            InModeration inModeration = chatGroup.inModeration;
            if (inModeration != null) {
                codedOutputByteBufferNano.m17309K(87, inModeration, InModeration.PROTOBUF_ADAPTER);
            }
            String str11 = chatGroup.shareToken;
            if (str11 != null) {
                codedOutputByteBufferNano.m17316R(88, str11);
            }
        }
    };
        ...
        public boolean parseField(ChatGroup chatGroup, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 13:
                    ...
                    return true;
                case 14:
                    chatGroup.f56859id = jsonParser.getValueAsString();
                    return false;
                case 15:
    ...
    public static final StringColumn<ChatGroup> f21104ID = new StringColumn<ChatGroup>("id_c") { // from class: com.p1.mobile.putong.core.data.ChatGroup.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ChatGroup chatGroup) {
            return chatGroup.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ChatGroup chatGroup, String str) {
            chatGroup.f56859id = str;
        }
    };
    ...
    public static final StringColumn<ChatGroup> CATEGORY_ID = new StringColumn<ChatGroup>("category_id_c") { // from class: com.p1.mobile.putong.core.data.ChatGroup.22
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ChatGroup chatGroup) {
            return chatGroup.category.f21105id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ChatGroup chatGroup, String str) {
            chatGroup.category.f21105id = str;
        }
    };
    ...
    public static final StringColumn<ChatGroup> GROUPAPPLY_ID = new StringColumn<ChatGroup>("groupApply_id_c") { // from class: com.p1.mobile.putong.core.data.ChatGroup.29
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ChatGroup chatGroup) {
            return chatGroup.groupApply.f21146id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ChatGroup chatGroup, String str) {
            chatGroup.groupApply.f21146id = str;
        }
    };
    ...
    public static final StringColumn<ChatGroup> GROUPTOPIC_ID = new StringColumn<ChatGroup>("groupTopic_id_c") { // from class: com.p1.mobile.putong.core.data.ChatGroup.46
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ChatGroup chatGroup) {
            return chatGroup.groupTopic.f21107id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ChatGroup chatGroup, String str) {
            chatGroup.groupTopic.f21107id = str;
        }
    };
    ...
    public static vzf0<ChatGroup> DB_ADAPTER = new vzf0<ChatGroup>() { // from class: com.p1.mobile.putong.core.data.ChatGroup.62
        ...
        public ChatGroup read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i6 = i + 1;
                String string4 = null;
                chatGroup.f56859id = cursor.isNull(i6) ? null : cursor.getString(i6);
                int i7 = i + 2;
                ...
                try {
                    ...
                    try {
                        ...
                        int i19 = i + 19;
                        chatGroup.category.f21105id = cursor.isNull(i19) ? null : cursor.getString(i19);
                        int i20 = i + 20;
                        ...
                        int i25 = i + 26;
                        chatGroup.groupApply.f21146id = cursor.isNull(i25) ? null : cursor.getString(i25);
                        int i26 = i + 27;
                        ...
                        try {
                            ...
                            try {
                                ...
                                int i35 = i + 46;
                                chatGroup.groupTopic.f21107id = cursor.isNull(i35) ? null : cursor.getString(i35);
                                int i36 = i + 47;
        ...
        public void write(ChatGroup chatGroup, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", chatGroup.f56859id);
                ...
                DbObject.cvPut(contentValues, "category_id_c", chatGroup.category.f21105id);
                ...
                DbObject.cvPut(contentValues, "groupApply_id_c", chatGroup.groupApply.f21146id);
                ...
                DbObject.cvPut(contentValues, "groupTopic_id_c", chatGroup.groupTopic.f21107id);
    ...
    public static /* synthetic */ String m36258b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m36259c(String str) {
        return str;
    }
    ...
    public ChatGroup mo225055clone() {
        ChatGroup chatGroup = new ChatGroup();
        chatGroup._id = this._id;
        chatGroup.f56859id = this.f56859id;
        chatGroup.name = this.name;
        List<Picture> list = this.avatars;
        if (list != null) {
            chatGroup.avatars = ValueObject.util_map(list, new qcj() { // from class: l.qu4
                @Override // p153l.qcj
        ...
        if (list2 != null) {
            chatGroup.adminUserIds = ValueObject.util_map(list2, new qcj() { // from class: l.ru4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ChatGroup.m36259c((String) obj);
                }
            });
        }
        ...
        if (list3 != null) {
            chatGroup.memberIds = ValueObject.util_map(list3, new qcj() { // from class: l.su4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ChatGroup.m36258b((String) obj);
                }
            });
        }
        ...
        if (list4 != null) {
            chatGroup.memberStatistics = ValueObject.util_map(list4, new qcj() { // from class: l.tu4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((GroupMemberStatistic) obj).mo225055clone();
                }
            });
        }
        ...
        if (chatGroupCateGory != null) {
            chatGroup.category = chatGroupCateGory.mo225055clone();
        }
        chatGroup.description = this.description;
        List<ChatGroupTag> list5 = this.tags;
        if (list5 != null) {
            chatGroup.tags = ValueObject.util_map(list5, new qcj() { // from class: l.uu4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((ChatGroupTag) obj).mo225055clone();
                }
            });
        }
        GroupApply groupApply = this.groupApply;
        if (groupApply != null) {
            chatGroup.groupApply = groupApply.mo225055clone();
        }
        ChatGroupSilence chatGroupSilence = this.silence;
        if (chatGroupSilence != null) {
            chatGroup.silence = chatGroupSilence.mo225055clone();
        }
        ChatPunishment chatPunishment = this.punishment;
        if (chatPunishment != null) {
            chatGroup.punishment = chatPunishment.mo225055clone();
        }
        ...
        if (chatGroupTopic != null) {
            chatGroup.groupTopic = chatGroupTopic.mo225055clone();
        }
        ...
        if (permissions != null) {
            chatGroup.permissions = permissions.mo225055clone();
        }
        InModeration inModeration = this.inModeration;
        if (inModeration != null) {
            chatGroup.inModeration = inModeration.mo225055clone();
        }
