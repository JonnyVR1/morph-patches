...
public class QuickChatBubble extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuickChatBubble> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuickChatBubble>() { // from class: com.p1.mobile.putong.core.data.QuickChatBubble.1
        ...
        public int computeAndCacheSize(QuickChatBubble quickChatBubble) {
            ...
            if (relationshipStatus != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, relationshipStatus, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            quickChatBubble.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuickChatBubble parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 0) {
                    ...
                    quickChatBubble.rsStateReceiverToSender = (RelationshipStatus) RelationshipStatus.JSON_ADAPTER.defaultEnum();
                    break;
                }
                if (iM162497u == 10) {
                    quickChatBubble.biz = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    quickChatBubble.stage = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    quickChatBubble.type = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (quickChatBubble.biz == null) {
                            quickChatBubble.biz = "";
                    ...
                    quickChatBubble.rsStateReceiverToSender = (RelationshipStatus) nc5Var.m162488l(RelationshipStatus.PROTOBUF_ADAPTER);
                }
            }
            return quickChatBubble;
        }
    ...
    public static JsonAdapter<QuickChatBubble> JSON_ADAPTER = new ObjectJsonAdapter<QuickChatBubble>() { // from class: com.p1.mobile.putong.core.data.QuickChatBubble.2
        ...
        public QuickChatBubble newInstance() {
        ...
        public boolean parseField(QuickChatBubble quickChatBubble, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "rsStateReceiverToSender":
                    quickChatBubble.rsStateReceiverToSender = RelationshipStatus.JSON_ADAPTER.parse(jsonParser, str2);
                    return true;
                default:
                    return false;
            }
    ...
    public QuickChatBubble mo225055clone() {
        QuickChatBubble quickChatBubble = new QuickChatBubble();
    ...
    public void nullCheck() {
        ...
        if (this.rsStateReceiverToSender == null) {
            this.rsStateReceiverToSender = (RelationshipStatus) RelationshipStatus.JSON_ADAPTER.defaultEnum();
        }
    }
