...
import com.p051p1.mobile.putong.core.data.ChatGuideMedia;
...
public class ChatGuideMedia extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatGuideMedia> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatGuideMedia>() { // from class: com.p1.mobile.putong.core.data.ChatGuideMedia.1
        ...
        public int computeAndCacheSize(ChatGuideMedia chatGuideMedia) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, chatGuideMedia.f21108id);
            ...
            if (list2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, list2, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = chatGuideMedia.confirmButton;
            if (str3 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(6, str3);
            }
            chatGuideMedia.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatGuideMedia parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    chatGuideMedia.f21108id = nc5Var.m162486j();
                } else if (iM162497u == 18) {
                    chatGuideMedia.guideType = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    chatGuideMedia.title = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    chatGuideMedia.subTitles = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 42) {
                    chatGuideMedia.medias = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 50) {
                        if (chatGuideMedia.guideType == null) {
                            chatGuideMedia.guideType = "";
                    ...
                    chatGuideMedia.confirmButton = nc5Var.m162495s();
                }
            }
            return chatGuideMedia;
        }
        ...
        public void serialize(ChatGuideMedia chatGuideMedia, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, chatGuideMedia.f21108id);
            String str = chatGuideMedia.guideType;
            if (str != null) {
            ...
            List<Media> list2 = chatGuideMedia.medias;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(5, list2, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str3 = chatGuideMedia.confirmButton;
            if (str3 != null) {
    ...
    public static JsonAdapter<ChatGuideMedia> JSON_ADAPTER = new ObjectJsonAdapter<ChatGuideMedia>() { // from class: com.p1.mobile.putong.core.data.ChatGuideMedia.2
        ...
        public boolean parseField(ChatGuideMedia chatGuideMedia, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "confirmButton":
                    ...
                    return true;
                case "id":
                    chatGuideMedia.f21108id = jsonParser.getValueAsInt();
                    return false;
                case "title":
        ...
        public void serializeFields(ChatGuideMedia chatGuideMedia, JsonGenerator jsonGenerator) throws IOException {
            jsonGenerator.writeNumberField("id", chatGuideMedia.f21108id);
            String str = chatGuideMedia.guideType;
            if (str != null) {
    ...
    public static /* synthetic */ String m36268b(String str) {
        return str;
    }
    ...
    public ChatGuideMedia mo225055clone() {
        ChatGuideMedia chatGuideMedia = new ChatGuideMedia();
        chatGuideMedia.f21108id = this.f21108id;
        chatGuideMedia.guideType = this.guideType;
        chatGuideMedia.title = this.title;
        List<String> list = this.subTitles;
        if (list != null) {
            chatGuideMedia.subTitles = ValueObject.util_map(list, new qcj() { // from class: l.cv4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ChatGuideMedia.m36268b((String) obj);
                }
            });
        }
        List<Media> list2 = this.medias;
        if (list2 != null) {
            chatGuideMedia.medias = ValueObject.util_map(list2, new qcj() { // from class: l.dv4
                @Override // p153l.qcj
                public final Object call(Object obj) {
