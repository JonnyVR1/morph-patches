...
public class IntlInsertCardData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlInsertCardData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlInsertCardData>() { // from class: com.p1.mobile.putong.core.data.IntlInsertCardData.1
        ...
        public int computeAndCacheSize(IntlInsertCardData intlInsertCardData) {
            String str = intlInsertCardData.f21166id;
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, intlInsertCardData.cardType) + CodedOutputByteBufferNano.m17281h(3, intlInsertCardData.showType);
            BuzzUser buzzUser = intlInsertCardData.buzzUser;
            if (buzzUser != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, buzzUser, BuzzUser.PROTOBUF_ADAPTER);
            }
            FloatUserCardData floatUserCardData = intlInsertCardData.floatUserCardData;
            if (floatUserCardData != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, floatUserCardData, FloatUserCardData.PROTOBUF_ADAPTER);
            }
            RecallMembershipData recallMembershipData = intlInsertCardData.recallMembership;
            if (recallMembershipData != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, recallMembershipData, RecallMembershipData.PROTOBUF_ADAPTER);
            }
            intlInsertCardData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlInsertCardData parse(nc5 nc5Var) throws IOException {
            IntlInsertCardData intlInsertCardData = new IntlInsertCardData();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (intlInsertCardData.f21166id == null) {
                        intlInsertCardData.f21166id = "";
                    }
                ...
                if (iM162497u == 10) {
                    intlInsertCardData.f21166id = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    intlInsertCardData.cardType = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    intlInsertCardData.showType = nc5Var.m162486j();
                } else if (iM162497u == 34) {
                    intlInsertCardData.buzzUser = (BuzzUser) nc5Var.m162488l(BuzzUser.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    intlInsertCardData.floatUserCardData = (FloatUserCardData) nc5Var.m162488l(FloatUserCardData.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 50) {
                        if (intlInsertCardData.f21166id == null) {
                            intlInsertCardData.f21166id = "";
                    ...
                    intlInsertCardData.recallMembership = (RecallMembershipData) nc5Var.m162488l(RecallMembershipData.PROTOBUF_ADAPTER);
                }
            }
            return intlInsertCardData;
        }
        ...
        public void serialize(IntlInsertCardData intlInsertCardData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, intlInsertCardData.cardType);
            codedOutputByteBufferNano.m17305G(3, intlInsertCardData.showType);
            BuzzUser buzzUser = intlInsertCardData.buzzUser;
            if (buzzUser != null) {
                codedOutputByteBufferNano.m17309K(4, buzzUser, BuzzUser.PROTOBUF_ADAPTER);
            }
            FloatUserCardData floatUserCardData = intlInsertCardData.floatUserCardData;
            if (floatUserCardData != null) {
                codedOutputByteBufferNano.m17309K(5, floatUserCardData, FloatUserCardData.PROTOBUF_ADAPTER);
            }
            RecallMembershipData recallMembershipData = intlInsertCardData.recallMembership;
            if (recallMembershipData != null) {
                codedOutputByteBufferNano.m17309K(6, recallMembershipData, RecallMembershipData.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(IntlInsertCardData intlInsertCardData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "cardType":
                    ...
                    return true;
                case "id":
                    intlInsertCardData.f21166id = jsonParser.getValueAsString();
                    return false;
                default:
                    return false;
            }
    ...
    public IntlInsertCardData mo225055clone() {
        IntlInsertCardData intlInsertCardData = new IntlInsertCardData();
        intlInsertCardData.f21166id = this.f21166id;
        intlInsertCardData.cardType = this.cardType;
        intlInsertCardData.showType = this.showType;
        BuzzUser buzzUser = this.buzzUser;
        if (buzzUser != null) {
            intlInsertCardData.buzzUser = buzzUser.mo225055clone();
        }
        FloatUserCardData floatUserCardData = this.floatUserCardData;
        if (floatUserCardData != null) {
            intlInsertCardData.floatUserCardData = floatUserCardData.mo225055clone();
        }
        RecallMembershipData recallMembershipData = this.recallMembership;
        if (recallMembershipData != null) {
            intlInsertCardData.recallMembership = recallMembershipData.mo225055clone();
        }
        return intlInsertCardData;
    }
