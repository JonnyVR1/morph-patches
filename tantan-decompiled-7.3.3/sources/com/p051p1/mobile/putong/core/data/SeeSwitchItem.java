...
public class SeeSwitchItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SeeSwitchItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<SeeSwitchItem>() { // from class: com.p1.mobile.putong.core.data.SeeSwitchItem.1
        ...
        public int computeAndCacheSize(SeeSwitchItem seeSwitchItem) {
            ...
            int iM17281h = seeSwitchName != null ? CodedOutputByteBufferNano.m17281h(1, seeSwitchName.ordinal()) : 0;
            Boolean bool = seeSwitchItem.is_open_for_new_user;
            if (bool != null) {
                iM17281h += CodedOutputByteBufferNano.m17275b(2, bool.booleanValue());
            }
            SeeSwitchOpenType seeSwitchOpenType = seeSwitchItem.open_time;
            if (seeSwitchOpenType != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(3, seeSwitchOpenType.ordinal());
            }
            SeeSwitchName seeSwitchName2 = seeSwitchItem.see_switch_name;
            if (seeSwitchName2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(4, seeSwitchName2, SeeSwitchName.PROTOBUF_ADAPTER);
            }
            SeeSwitchOpenType seeSwitchOpenType2 = seeSwitchItem.open_time;
            if (seeSwitchOpenType2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, seeSwitchOpenType2, SeeSwitchOpenType.PROTOBUF_ADAPTER);
            }
            seeSwitchItem.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SeeSwitchItem parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    ...
                    seeSwitchItem.is_open_for_new_user = Boolean.valueOf(nc5Var.m162483g());
                } else if (iM162497u == 24) {
                    numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 34) {
                    seeSwitchItem.see_switch_name = (SeeSwitchName) nc5Var.m162488l(SeeSwitchName.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 42) {
                        if (seeSwitchItem.see_switch_name == null && numValueOf != null) {
                            seeSwitchItem.see_switch_name = (SeeSwitchName) SeeSwitchName.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    seeSwitchItem.open_time = (SeeSwitchOpenType) nc5Var.m162488l(SeeSwitchOpenType.PROTOBUF_ADAPTER);
                }
            }
            return seeSwitchItem;
        }
        ...
        public void serialize(SeeSwitchItem seeSwitchItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (seeSwitchName != null) {
                codedOutputByteBufferNano.m17305G(1, seeSwitchName.ordinal());
            }
            Boolean bool = seeSwitchItem.is_open_for_new_user;
            if (bool != null) {
            ...
            SeeSwitchOpenType seeSwitchOpenType = seeSwitchItem.open_time;
            if (seeSwitchOpenType != null) {
                codedOutputByteBufferNano.m17305G(3, seeSwitchOpenType.ordinal());
            }
            SeeSwitchName seeSwitchName2 = seeSwitchItem.see_switch_name;
            if (seeSwitchName2 != null) {
                codedOutputByteBufferNano.m17309K(4, seeSwitchName2, SeeSwitchName.PROTOBUF_ADAPTER);
            }
            SeeSwitchOpenType seeSwitchOpenType2 = seeSwitchItem.open_time;
            if (seeSwitchOpenType2 != null) {
                codedOutputByteBufferNano.m17309K(5, seeSwitchOpenType2, SeeSwitchOpenType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public SeeSwitchItem mo225055clone() {
        SeeSwitchItem seeSwitchItem = new SeeSwitchItem();
