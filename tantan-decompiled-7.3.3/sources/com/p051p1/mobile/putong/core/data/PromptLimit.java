...
public class PromptLimit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PromptLimit> PROTOBUF_ADAPTER = new MessageNanoAdapter<PromptLimit>() { // from class: com.p1.mobile.putong.core.data.PromptLimit.1
        ...
        public int computeAndCacheSize(PromptLimit promptLimit) {
            ...
            int iM17285l = schoolVerificationLimit != null ? CodedOutputByteBufferNano.m17285l(1, schoolVerificationLimit, SchoolVerificationLimit.PROTOBUF_ADAPTER) : 0;
            AssetsTbh assetsTbh = promptLimit.tbh;
            if (assetsTbh != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, assetsTbh, AssetsTbh.PROTOBUF_ADAPTER);
            }
            promptLimit.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PromptLimit parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    promptLimit.schoolVerificationLimit = (SchoolVerificationLimit) nc5Var.m162488l(SchoolVerificationLimit.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (promptLimit.schoolVerificationLimit == null) {
                            promptLimit.schoolVerificationLimit = SchoolVerificationLimit.new_();
                    ...
                    promptLimit.tbh = (AssetsTbh) nc5Var.m162488l(AssetsTbh.PROTOBUF_ADAPTER);
                }
            }
            return promptLimit;
        }
        ...
        public void serialize(PromptLimit promptLimit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (schoolVerificationLimit != null) {
                codedOutputByteBufferNano.m17309K(1, schoolVerificationLimit, SchoolVerificationLimit.PROTOBUF_ADAPTER);
            }
            AssetsTbh assetsTbh = promptLimit.tbh;
            if (assetsTbh != null) {
                codedOutputByteBufferNano.m17309K(2, assetsTbh, AssetsTbh.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public PromptLimit mo225055clone() {
        PromptLimit promptLimit = new PromptLimit();
        SchoolVerificationLimit schoolVerificationLimit = this.schoolVerificationLimit;
        if (schoolVerificationLimit != null) {
            promptLimit.schoolVerificationLimit = schoolVerificationLimit.mo225055clone();
        }
        AssetsTbh assetsTbh = this.tbh;
        if (assetsTbh != null) {
            promptLimit.tbh = assetsTbh.mo225055clone();
        }
        return promptLimit;
    }
