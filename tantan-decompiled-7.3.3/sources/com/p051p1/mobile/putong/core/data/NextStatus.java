...
public class NextStatus extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NextStatus> PROTOBUF_ADAPTER = new MessageNanoAdapter<NextStatus>() { // from class: com.p1.mobile.putong.core.data.NextStatus.1
        ...
        public int computeAndCacheSize(NextStatus nextStatus) {
            ...
            int iM17281h = awardStatus != null ? CodedOutputByteBufferNano.m17281h(1, awardStatus.ordinal()) : 0;
            List<AwardType> list = nextStatus.awards;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(2, list, AwardType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (awardStatus2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, awardStatus2, AwardStatus.PROTOBUF_ADAPTER);
            }
            nextStatus.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NextStatus parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    ...
                    nextStatus.awards = (List) nc5Var.m162488l(AwardType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 26) {
                    nextStatus.updateWay = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    nextStatus.updateWayVal = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (nextStatus.status == null && numValueOf != null) {
                            nextStatus.status = (AwardStatus) AwardStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    nextStatus.status = (AwardStatus) nc5Var.m162488l(AwardStatus.PROTOBUF_ADAPTER);
                }
            }
            return nextStatus;
        }
        ...
        public void serialize(NextStatus nextStatus, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            AwardStatus awardStatus = nextStatus.status;
            if (awardStatus != null) {
                codedOutputByteBufferNano.m17305G(1, awardStatus.ordinal());
            }
            List<AwardType> list = nextStatus.awards;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(2, list, AwardType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = nextStatus.updateWay;
            if (str != null) {
            ...
            AwardStatus awardStatus2 = nextStatus.status;
            if (awardStatus2 != null) {
                codedOutputByteBufferNano.m17309K(5, awardStatus2, AwardStatus.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public NextStatus mo225055clone() {
        NextStatus nextStatus = new NextStatus();
        nextStatus.status = this.status;
        List<AwardType> list = this.awards;
        if (list != null) {
            nextStatus.awards = ValueObject.util_map(list, new qcj() { // from class: l.jr40
                @Override // p153l.qcj
