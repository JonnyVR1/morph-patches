...
public class IntlCurrencyDiamond extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlCurrencyDiamond> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlCurrencyDiamond>() { // from class: com.p1.mobile.putong.core.data.IntlCurrencyDiamond.1
        ...
        public int computeAndCacheSize(IntlCurrencyDiamond intlCurrencyDiamond) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, intlCurrencyDiamond.available) + CodedOutputByteBufferNano.m17283j(2, intlCurrencyDiamond.agentAvailable);
            intlCurrencyDiamond.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlCurrencyDiamond parse(nc5 nc5Var) throws IOException {
            IntlCurrencyDiamond intlCurrencyDiamond = new IntlCurrencyDiamond();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    intlCurrencyDiamond.available = nc5Var.m162487k();
                } else {
                    if (iM162497u != 16) {
                        return intlCurrencyDiamond;
                    }
                    intlCurrencyDiamond.agentAvailable = nc5Var.m162487k();
                }
            }
        }
        ...
        public void serialize(IntlCurrencyDiamond intlCurrencyDiamond, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, intlCurrencyDiamond.available);
            codedOutputByteBufferNano.m17307I(2, intlCurrencyDiamond.agentAvailable);
        }
    };
    ...
    public IntlCurrencyDiamond mo225055clone() {
        IntlCurrencyDiamond intlCurrencyDiamond = new IntlCurrencyDiamond();
