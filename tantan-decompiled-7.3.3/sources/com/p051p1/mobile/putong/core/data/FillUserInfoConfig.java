...
public class FillUserInfoConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FillUserInfoConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<FillUserInfoConfig>() { // from class: com.p1.mobile.putong.core.data.FillUserInfoConfig.1
        ...
        public int computeAndCacheSize(FillUserInfoConfig fillUserInfoConfig) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, fillUserInfoConfig.expire_days);
            List<String> list = fillUserInfoConfig.male_self_intro_tags_1;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(6, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list2 = fillUserInfoConfig.male_self_intro_tags_2;
            if (list2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(7, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            fillUserInfoConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FillUserInfoConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        fillUserInfoConfig.male_avatar_url = nc5Var.m162495s();
                        continue;
                    case 18:
                        fillUserInfoConfig.female_avatar_url = nc5Var.m162495s();
                        continue;
                    case 26:
                        fillUserInfoConfig.male_name = nc5Var.m162495s();
                        continue;
                    case 34:
                        fillUserInfoConfig.female_name = nc5Var.m162495s();
                        continue;
                    case 40:
                        fillUserInfoConfig.expire_days = nc5Var.m162486j();
                        continue;
                    case 50:
                        fillUserInfoConfig.male_self_intro_tags_1 = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        fillUserInfoConfig.male_self_intro_tags_2 = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 66:
                        fillUserInfoConfig.female_self_intro_tags_1 = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        fillUserInfoConfig.female_self_intro_tags_2 = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        fillUserInfoConfig.male_other_tags = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        fillUserInfoConfig.female_other_tags = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (fillUserInfoConfig.male_avatar_url == null) {
                            fillUserInfoConfig.male_avatar_url = "";
        ...
        public void serialize(FillUserInfoConfig fillUserInfoConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(5, fillUserInfoConfig.expire_days);
            List<String> list = fillUserInfoConfig.male_self_intro_tags_1;
            if (list != null) {
    ...
    public static /* synthetic */ String m36527a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m36528b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m36529c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m36530d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: e */
    public static /* synthetic */ String m36531e(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m36532f(String str) {
        return str;
    }
    ...
    public FillUserInfoConfig mo225055clone() {
        FillUserInfoConfig fillUserInfoConfig = new FillUserInfoConfig();
        ...
        if (list != null) {
            fillUserInfoConfig.male_self_intro_tags_1 = ValueObject.util_map(list, new qcj() { // from class: l.ali
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FillUserInfoConfig.m36531e((String) obj);
                }
            });
        }
        List<String> list2 = this.male_self_intro_tags_2;
        if (list2 != null) {
            fillUserInfoConfig.male_self_intro_tags_2 = ValueObject.util_map(list2, new qcj() { // from class: l.bli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FillUserInfoConfig.m36528b((String) obj);
                }
            });
        }
        List<String> list3 = this.female_self_intro_tags_1;
        if (list3 != null) {
            fillUserInfoConfig.female_self_intro_tags_1 = ValueObject.util_map(list3, new qcj() { // from class: l.cli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FillUserInfoConfig.m36530d((String) obj);
                }
            });
        }
        List<String> list4 = this.female_self_intro_tags_2;
        if (list4 != null) {
            fillUserInfoConfig.female_self_intro_tags_2 = ValueObject.util_map(list4, new qcj() { // from class: l.dli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FillUserInfoConfig.m36527a((String) obj);
                }
            });
        }
        List<String> list5 = this.male_other_tags;
        if (list5 != null) {
            fillUserInfoConfig.male_other_tags = ValueObject.util_map(list5, new qcj() { // from class: l.eli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FillUserInfoConfig.m36532f((String) obj);
                }
            });
        }
        List<String> list6 = this.female_other_tags;
        if (list6 != null) {
            fillUserInfoConfig.female_other_tags = ValueObject.util_map(list6, new qcj() { // from class: l.fli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FillUserInfoConfig.m36529c((String) obj);
                }
            });
        }
        return fillUserInfoConfig;
