...
public class GrowthBlindBox extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GrowthBlindBox> PROTOBUF_ADAPTER = new MessageNanoAdapter<GrowthBlindBox>() { // from class: com.p1.mobile.putong.core.data.GrowthBlindBox.1
        ...
        public int computeAndCacheSize(GrowthBlindBox growthBlindBox) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, growthBlindBox.isOpen) + CodedOutputByteBufferNano.m17277d(2, growthBlindBox.latestTime);
            GrowthBlindBoxInfo growthBlindBoxInfo = growthBlindBox.view;
            if (growthBlindBoxInfo != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(3, growthBlindBoxInfo, GrowthBlindBoxInfo.PROTOBUF_ADAPTER);
            }
            growthBlindBox.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GrowthBlindBox parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    growthBlindBox.isOpen = nc5Var.m162483g();
                } else if (iM162497u == 17) {
                    growthBlindBox.latestTime = nc5Var.m162484h();
                } else {
                    if (iM162497u != 26) {
                        if (growthBlindBox.view != null) {
                            break;
                    ...
                    growthBlindBox.view = (GrowthBlindBoxInfo) nc5Var.m162488l(GrowthBlindBoxInfo.PROTOBUF_ADAPTER);
                }
            }
            return growthBlindBox;
        }
        ...
        public void serialize(GrowthBlindBox growthBlindBox, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, growthBlindBox.isOpen);
            codedOutputByteBufferNano.m17301C(2, growthBlindBox.latestTime);
            GrowthBlindBoxInfo growthBlindBoxInfo = growthBlindBox.view;
            if (growthBlindBoxInfo != null) {
                codedOutputByteBufferNano.m17309K(3, growthBlindBoxInfo, GrowthBlindBoxInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public GrowthBlindBox mo225055clone() {
        GrowthBlindBox growthBlindBox = new GrowthBlindBox();
        ...
        if (growthBlindBoxInfo != null) {
            growthBlindBox.view = growthBlindBoxInfo.mo225055clone();
        }
        return growthBlindBox;
    }
