...
public class LatestVisitors extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LatestVisitors> PROTOBUF_ADAPTER = new MessageNanoAdapter<LatestVisitors>() { // from class: com.p1.mobile.putong.core.data.LatestVisitors.1
        ...
        public int computeAndCacheSize(LatestVisitors latestVisitors) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, latestVisitors.visitCount) + CodedOutputByteBufferNano.m17283j(3, latestVisitors.latestVisitTime);
            ...
            latestVisitors.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LatestVisitors parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    latestVisitors.userId = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    latestVisitors.visitCount = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    latestVisitors.latestVisitTime = nc5Var.m162487k();
                } else if (iM162497u == 34) {
                    latestVisitors.text = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    latestVisitors.subText = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (latestVisitors.userId == null) {
                            latestVisitors.userId = "";
                    ...
                    latestVisitors.highLight = nc5Var.m162495s();
                }
            }
            return latestVisitors;
        }
        ...
        public void serialize(LatestVisitors latestVisitors, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, latestVisitors.visitCount);
            codedOutputByteBufferNano.m17307I(3, latestVisitors.latestVisitTime);
            String str2 = latestVisitors.text;
            if (str2 != null) {
    ...
    public LatestVisitors mo225055clone() {
        LatestVisitors latestVisitors = new LatestVisitors();
