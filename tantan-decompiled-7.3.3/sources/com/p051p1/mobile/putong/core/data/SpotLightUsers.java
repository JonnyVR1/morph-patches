...
public class SpotLightUsers extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpotLightUsers> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpotLightUsers>() { // from class: com.p1.mobile.putong.core.data.SpotLightUsers.1
        ...
        public int computeAndCacheSize(SpotLightUsers spotLightUsers) {
            ...
            int iM17285l = spotLightLiveInfo != null ? CodedOutputByteBufferNano.m17285l(1, spotLightLiveInfo, SpotLightLiveInfo.PROTOBUF_ADAPTER) : 0;
            ...
            if (spotLightSeeInfo != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, spotLightSeeInfo, SpotLightSeeInfo.PROTOBUF_ADAPTER);
            }
            spotLightUsers.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SpotLightUsers parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    spotLightUsers.liveInfo = (SpotLightLiveInfo) nc5Var.m162488l(SpotLightLiveInfo.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    spotLightUsers.userInfo = (User) nc5Var.m162488l(User.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 26) {
                        if (spotLightUsers.liveInfo == null) {
                            spotLightUsers.liveInfo = SpotLightLiveInfo.new_();
                    ...
                    spotLightUsers.seeInfo = (SpotLightSeeInfo) nc5Var.m162488l(SpotLightSeeInfo.PROTOBUF_ADAPTER);
                }
            }
            return spotLightUsers;
        }
        ...
        public void serialize(SpotLightUsers spotLightUsers, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (spotLightLiveInfo != null) {
                codedOutputByteBufferNano.m17309K(1, spotLightLiveInfo, SpotLightLiveInfo.PROTOBUF_ADAPTER);
            }
            User user = spotLightUsers.userInfo;
            if (user != null) {
            ...
            SpotLightSeeInfo spotLightSeeInfo = spotLightUsers.seeInfo;
            if (spotLightSeeInfo != null) {
                codedOutputByteBufferNano.m17309K(3, spotLightSeeInfo, SpotLightSeeInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public SpotLightUsers mo225055clone() {
        SpotLightUsers spotLightUsers = new SpotLightUsers();
        SpotLightLiveInfo spotLightLiveInfo = this.liveInfo;
        if (spotLightLiveInfo != null) {
            spotLightUsers.liveInfo = spotLightLiveInfo.mo225055clone();
        }
        SpotLightSeeInfo spotLightSeeInfo = this.seeInfo;
        if (spotLightSeeInfo != null) {
            spotLightUsers.seeInfo = spotLightSeeInfo.mo225055clone();
        }
        User user = this.userInfo;
        if (user != null) {
            spotLightUsers.userInfo = user.mo225055clone();
        }
        return spotLightUsers;
    }
