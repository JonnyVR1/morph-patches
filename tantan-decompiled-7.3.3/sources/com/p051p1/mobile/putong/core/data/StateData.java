...
public class StateData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StateData> PROTOBUF_ADAPTER = new MessageNanoAdapter<StateData>() { // from class: com.p1.mobile.putong.core.data.StateData.1
        ...
        public int computeAndCacheSize(StateData stateData) {
            ...
            stateData.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StateData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    stateData.value = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    stateData.emotionId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    stateData.emotionText = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    stateData.emotionUrl = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (stateData.value == null) {
                            stateData.value = "";
                    ...
                    stateData.sourceFlag = nc5Var.m162495s();
                }
            }
            return stateData;
        }
    ...
    public StateData mo225055clone() {
        StateData stateData = new StateData();
