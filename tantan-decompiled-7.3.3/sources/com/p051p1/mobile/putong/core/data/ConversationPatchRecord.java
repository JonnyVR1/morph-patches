...
public class ConversationPatchRecord extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConversationPatchRecord> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConversationPatchRecord>() { // from class: com.p1.mobile.putong.core.data.ConversationPatchRecord.1
        ...
        public int computeAndCacheSize(ConversationPatchRecord conversationPatchRecord) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, conversationPatchRecord._id);
            String str = conversationPatchRecord.f56859id;
            if (str != null) {
            ...
            if (conversationPatchState != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(52, conversationPatchState.ordinal());
            }
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(53, conversationPatchRecord.retryCount);
            ConversationPatchState conversationPatchState2 = conversationPatchRecord.state;
            if (conversationPatchState2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(54, conversationPatchState2, ConversationPatchState.PROTOBUF_ADAPTER);
            }
            conversationPatchRecord.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConversationPatchRecord parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    conversationPatchRecord._id = nc5Var.m162487k();
                } else if (iM162497u == 18) {
                    conversationPatchRecord.f56859id = nc5Var.m162495s();
                } else if (iM162497u == 410) {
                    conversationPatchRecord.readUtil = nc5Var.m162495s();
                } else if (iM162497u == 416) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 424) {
                    conversationPatchRecord.retryCount = nc5Var.m162486j();
                } else {
                    if (iM162497u != 434) {
                        if (conversationPatchRecord.state == null && numValueOf != null) {
                            conversationPatchRecord.state = (ConversationPatchState) ConversationPatchState.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    conversationPatchRecord.state = (ConversationPatchState) nc5Var.m162488l(ConversationPatchState.PROTOBUF_ADAPTER);
                }
            }
            return conversationPatchRecord;
        }
        ...
        public void serialize(ConversationPatchRecord conversationPatchRecord, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, conversationPatchRecord._id);
            String str = conversationPatchRecord.f56859id;
            if (str != null) {
            ...
            ConversationPatchState conversationPatchState = conversationPatchRecord.state;
            if (conversationPatchState != null) {
                codedOutputByteBufferNano.m17305G(52, conversationPatchState.ordinal());
            }
            codedOutputByteBufferNano.m17305G(53, conversationPatchRecord.retryCount);
            ConversationPatchState conversationPatchState2 = conversationPatchRecord.state;
            if (conversationPatchState2 != null) {
                codedOutputByteBufferNano.m17309K(54, conversationPatchState2, ConversationPatchState.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(ConversationPatchRecord conversationPatchRecord, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "readUtil":
                    ...
                    return true;
                case "id":
                    conversationPatchRecord.f56859id = jsonParser.getValueAsString();
                    return false;
                case "state":
    ...
    public static final StringColumn<ConversationPatchRecord> f21117ID = new StringColumn<ConversationPatchRecord>("id_c") { // from class: com.p1.mobile.putong.core.data.ConversationPatchRecord.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ConversationPatchRecord conversationPatchRecord) {
            return conversationPatchRecord.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ConversationPatchRecord conversationPatchRecord, String str) {
            conversationPatchRecord.f56859id = str;
        }
    };
    ...
    public static vzf0<ConversationPatchRecord> DB_ADAPTER = new vzf0<ConversationPatchRecord>() { // from class: com.p1.mobile.putong.core.data.ConversationPatchRecord.8
        @Override // p153l.vzf0
        public String CREATE_TABLE(wzh0 wzh0Var) {
            return "CREATE TABLE IF NOT EXISTS " + wzh0Var.f191760d + " (_id INTEGER PRIMARY KEY,id_c TEXT,readUtil_c TEXT,state_c INTEGER,retryCount_c INTEGER,str_state_c TEXT)";
        }
        ...
        public ConversationPatchRecord read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i3 = i + 1;
                conversationPatchRecord.f56859id = cursor.isNull(i3) ? null : cursor.getString(i3);
                int i4 = i + 2;
        ...
        public void write(ConversationPatchRecord conversationPatchRecord, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", conversationPatchRecord.f56859id);
    ...
    public ConversationPatchRecord mo225055clone() {
        ConversationPatchRecord conversationPatchRecord = new ConversationPatchRecord();
        conversationPatchRecord._id = this._id;
        conversationPatchRecord.f56859id = this.f56859id;
