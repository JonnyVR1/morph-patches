...
public class LoveLetterEntryInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LoveLetterEntryInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<LoveLetterEntryInfo>() { // from class: com.p1.mobile.putong.core.data.LoveLetterEntryInfo.1
        ...
        public int computeAndCacheSize(LoveLetterEntryInfo loveLetterEntryInfo) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, loveLetterEntryInfo.display) + CodedOutputByteBufferNano.m17281h(2, loveLetterEntryInfo.count) + CodedOutputByteBufferNano.m17277d(3, loveLetterEntryInfo.startTime) + CodedOutputByteBufferNano.m17277d(4, loveLetterEntryInfo.endTime);
            LoveLetterMessageInfo loveLetterMessageInfo = loveLetterEntryInfo.message;
            if (loveLetterMessageInfo != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(5, loveLetterMessageInfo, LoveLetterMessageInfo.PROTOBUF_ADAPTER);
            }
            int iM17281h = iM17275b + CodedOutputByteBufferNano.m17281h(6, loveLetterEntryInfo.msgLimit);
            String str = loveLetterEntryInfo.shadingWord;
            if (str != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(7, str);
            }
            loveLetterEntryInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LoveLetterEntryInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    loveLetterEntryInfo.display = nc5Var.m162483g();
                } else if (iM162497u == 16) {
                    loveLetterEntryInfo.count = nc5Var.m162486j();
                } else if (iM162497u == 25) {
                    loveLetterEntryInfo.startTime = nc5Var.m162484h();
                } else if (iM162497u == 33) {
                    loveLetterEntryInfo.endTime = nc5Var.m162484h();
                } else if (iM162497u == 42) {
                    loveLetterEntryInfo.message = (LoveLetterMessageInfo) nc5Var.m162488l(LoveLetterMessageInfo.PROTOBUF_ADAPTER);
                } else if (iM162497u == 48) {
                    loveLetterEntryInfo.msgLimit = nc5Var.m162486j();
                } else {
                    if (iM162497u != 58) {
                        if (loveLetterEntryInfo.shadingWord != null) {
                            break;
                    ...
                    loveLetterEntryInfo.shadingWord = nc5Var.m162495s();
                }
            }
            return loveLetterEntryInfo;
        }
        ...
        public void serialize(LoveLetterEntryInfo loveLetterEntryInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, loveLetterEntryInfo.display);
            codedOutputByteBufferNano.m17305G(2, loveLetterEntryInfo.count);
            codedOutputByteBufferNano.m17301C(3, loveLetterEntryInfo.startTime);
            codedOutputByteBufferNano.m17301C(4, loveLetterEntryInfo.endTime);
            LoveLetterMessageInfo loveLetterMessageInfo = loveLetterEntryInfo.message;
            if (loveLetterMessageInfo != null) {
                codedOutputByteBufferNano.m17309K(5, loveLetterMessageInfo, LoveLetterMessageInfo.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(6, loveLetterEntryInfo.msgLimit);
            String str = loveLetterEntryInfo.shadingWord;
            if (str != null) {
    ...
    public LoveLetterEntryInfo mo225055clone() {
        LoveLetterEntryInfo loveLetterEntryInfo = new LoveLetterEntryInfo();
        ...
        if (loveLetterMessageInfo != null) {
            loveLetterEntryInfo.message = loveLetterMessageInfo.mo225055clone();
        }
