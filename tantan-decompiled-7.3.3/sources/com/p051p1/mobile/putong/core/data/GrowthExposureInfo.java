...
public class GrowthExposureInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GrowthExposureInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<GrowthExposureInfo>() { // from class: com.p1.mobile.putong.core.data.GrowthExposureInfo.1
        ...
        public int computeAndCacheSize(GrowthExposureInfo growthExposureInfo) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, growthExposureInfo.continuousSignDays) + CodedOutputByteBufferNano.m17281h(2, growthExposureInfo.exposureNum) + CodedOutputByteBufferNano.m17283j(3, growthExposureInfo.lastSignTime) + CodedOutputByteBufferNano.m17275b(4, growthExposureInfo.isSignedToday);
            growthExposureInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GrowthExposureInfo parse(nc5 nc5Var) throws IOException {
            GrowthExposureInfo growthExposureInfo = new GrowthExposureInfo();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    growthExposureInfo.continuousSignDays = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    growthExposureInfo.exposureNum = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    growthExposureInfo.lastSignTime = nc5Var.m162487k();
                } else {
                    if (iM162497u != 32) {
                        return growthExposureInfo;
                    }
                    growthExposureInfo.isSignedToday = nc5Var.m162483g();
                }
            }
        }
        ...
        public void serialize(GrowthExposureInfo growthExposureInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, growthExposureInfo.continuousSignDays);
            codedOutputByteBufferNano.m17305G(2, growthExposureInfo.exposureNum);
            codedOutputByteBufferNano.m17307I(3, growthExposureInfo.lastSignTime);
            codedOutputByteBufferNano.m17299A(4, growthExposureInfo.isSignedToday);
        }
    };
    ...
    public GrowthExposureInfo mo225055clone() {
        GrowthExposureInfo growthExposureInfo = new GrowthExposureInfo();
