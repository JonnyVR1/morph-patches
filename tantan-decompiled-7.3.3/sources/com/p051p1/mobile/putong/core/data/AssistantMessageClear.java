...
public class AssistantMessageClear extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AssistantMessageClear> PROTOBUF_ADAPTER = new MessageNanoAdapter<AssistantMessageClear>() { // from class: com.p1.mobile.putong.core.data.AssistantMessageClear.1
        ...
        public int computeAndCacheSize(AssistantMessageClear assistantMessageClear) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, assistantMessageClear.enabled) + CodedOutputByteBufferNano.m17281h(2, assistantMessageClear.limit_days);
            assistantMessageClear.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AssistantMessageClear parse(nc5 nc5Var) throws IOException {
            AssistantMessageClear assistantMessageClear = new AssistantMessageClear();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    assistantMessageClear.enabled = nc5Var.m162483g();
                } else {
                    if (iM162497u != 16) {
                        return assistantMessageClear;
                    }
                    assistantMessageClear.limit_days = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(AssistantMessageClear assistantMessageClear, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, assistantMessageClear.enabled);
            codedOutputByteBufferNano.m17305G(2, assistantMessageClear.limit_days);
        }
    };
    ...
    public AssistantMessageClear mo225055clone() {
        AssistantMessageClear assistantMessageClear = new AssistantMessageClear();
