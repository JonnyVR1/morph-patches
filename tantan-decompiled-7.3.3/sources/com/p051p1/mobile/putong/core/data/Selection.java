...
public class Selection extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Selection> PROTOBUF_ADAPTER = new MessageNanoAdapter<Selection>() { // from class: com.p1.mobile.putong.core.data.Selection.1
        ...
        public int computeAndCacheSize(Selection selection) {
            ...
            int iM17285l = (list != null ? CodedOutputByteBufferNano.m17285l(1, list, Options.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0) + CodedOutputByteBufferNano.m17281h(2, selection.maxChoices);
            selection.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Selection parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    selection.options = (List) nc5Var.m162488l(Options.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 16) {
                        if (selection.options != null) {
                            break;
                    ...
                    selection.maxChoices = nc5Var.m162486j();
                }
            }
            return selection;
        }
        ...
        public void serialize(Selection selection, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<Options> list = selection.options;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, Options.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(2, selection.maxChoices);
        }
    };
    ...
    public Selection mo225055clone() {
        Selection selection = new Selection();
        List<Options> list = this.options;
        if (list != null) {
            selection.options = ValueObject.util_map(list, new qcj() { // from class: l.hme0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((Options) obj).mo225055clone();
                }
            });
        }
