...
public class ChristmasMatchMsgData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChristmasMatchMsgData> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChristmasMatchMsgData>() { // from class: com.p1.mobile.putong.core.data.ChristmasMatchMsgData.1
        ...
        public int computeAndCacheSize(ChristmasMatchMsgData christmasMatchMsgData) {
            ...
            if (christmasMatchMsgDataText != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, christmasMatchMsgDataText, ChristmasMatchMsgDataText.PROTOBUF_ADAPTER);
            }
            christmasMatchMsgData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChristmasMatchMsgData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    christmasMatchMsgData.media = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (christmasMatchMsgData.media == null) {
                            christmasMatchMsgData.media = new ArrayList();
                    ...
                    christmasMatchMsgData.text = (ChristmasMatchMsgDataText) nc5Var.m162488l(ChristmasMatchMsgDataText.PROTOBUF_ADAPTER);
                }
            }
            return christmasMatchMsgData;
        }
        ...
        public void serialize(ChristmasMatchMsgData christmasMatchMsgData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ChristmasMatchMsgDataText christmasMatchMsgDataText = christmasMatchMsgData.text;
            if (christmasMatchMsgDataText != null) {
                codedOutputByteBufferNano.m17309K(2, christmasMatchMsgDataText, ChristmasMatchMsgDataText.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ChristmasMatchMsgData mo225055clone() {
        ChristmasMatchMsgData christmasMatchMsgData = new ChristmasMatchMsgData();
        List<Media> list = this.media;
        if (list != null) {
            christmasMatchMsgData.media = ValueObject.util_map(list, new qcj() { // from class: l.l45
                @Override // p153l.qcj
        ...
        if (christmasMatchMsgDataText != null) {
            christmasMatchMsgData.text = christmasMatchMsgDataText.mo225055clone();
        }
        return christmasMatchMsgData;
    }
