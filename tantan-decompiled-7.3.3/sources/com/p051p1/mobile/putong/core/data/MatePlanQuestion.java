...
public class MatePlanQuestion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MatePlanQuestion> PROTOBUF_ADAPTER = new MessageNanoAdapter<MatePlanQuestion>() { // from class: com.p1.mobile.putong.core.data.MatePlanQuestion.1
        ...
        public int computeAndCacheSize(MatePlanQuestion matePlanQuestion) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(3, matePlanQuestion.index);
            ...
            if (matePlanQuestionAttribute != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(6, matePlanQuestionAttribute, MatePlanQuestionAttribute.PROTOBUF_ADAPTER);
            }
            ...
            int iM17277d = iM17281h + CodedOutputByteBufferNano.m17277d(9, matePlanQuestion.createdTime) + CodedOutputByteBufferNano.m17277d(10, matePlanQuestion.updatedTime);
            matePlanQuestion.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MatePlanQuestion parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        matePlanQuestion.questionId = nc5Var.m162495s();
                        continue;
                    case 18:
                        matePlanQuestion.content = nc5Var.m162495s();
                        continue;
                    case 24:
                        matePlanQuestion.index = nc5Var.m162486j();
                        continue;
                    case 34:
                        matePlanQuestion.category = nc5Var.m162495s();
                        continue;
                    case 42:
                        matePlanQuestion.questionType = nc5Var.m162495s();
                        continue;
                    case 50:
                        matePlanQuestion.attribute = (MatePlanQuestionAttribute) nc5Var.m162488l(MatePlanQuestionAttribute.PROTOBUF_ADAPTER);
                        continue;
                    case 58:
                        matePlanQuestion.logo = nc5Var.m162495s();
                        continue;
                    case 66:
                        matePlanQuestion.status = nc5Var.m162495s();
                        continue;
                    case EACTags.CARDHOLDER_PUBLIC_KEY_TEMPLATE /* 73 */:
                        matePlanQuestion.createdTime = nc5Var.m162484h();
                        continue;
                    case EACTags.FILE_REFERENCE /* 81 */:
                        matePlanQuestion.updatedTime = nc5Var.m162484h();
                        continue;
                    default:
                        if (matePlanQuestion.questionId == null) {
                            matePlanQuestion.questionId = "";
        ...
        public void serialize(MatePlanQuestion matePlanQuestion, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(3, matePlanQuestion.index);
            String str3 = matePlanQuestion.category;
            if (str3 != null) {
            ...
            MatePlanQuestionAttribute matePlanQuestionAttribute = matePlanQuestion.attribute;
            if (matePlanQuestionAttribute != null) {
                codedOutputByteBufferNano.m17309K(6, matePlanQuestionAttribute, MatePlanQuestionAttribute.PROTOBUF_ADAPTER);
            }
            String str5 = matePlanQuestion.logo;
            if (str5 != null) {
            ...
            codedOutputByteBufferNano.m17301C(9, matePlanQuestion.createdTime);
            codedOutputByteBufferNano.m17301C(10, matePlanQuestion.updatedTime);
        }
    };
    ...
    public MatePlanQuestion mo225055clone() {
        MatePlanQuestion matePlanQuestion = new MatePlanQuestion();
        ...
        if (matePlanQuestionAttribute != null) {
            matePlanQuestion.attribute = matePlanQuestionAttribute.mo225055clone();
        }
