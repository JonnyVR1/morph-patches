...
public class PicExchangeEditPopWindowConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<PicExchangeEditPopWindowConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<PicExchangeEditPopWindowConfig>() { // from class: com.p1.mobile.putong.core.data.PicExchangeEditPopWindowConfig.1
        ...
        public int computeAndCacheSize(PicExchangeEditPopWindowConfig picExchangeEditPopWindowConfig) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, picExchangeEditPopWindowConfig.randomTime) + CodedOutputByteBufferNano.m17281h(2, picExchangeEditPopWindowConfig.randomNum) + CodedOutputByteBufferNano.m17283j(3, picExchangeEditPopWindowConfig.switchFunTime) + CodedOutputByteBufferNano.m17281h(4, picExchangeEditPopWindowConfig.switchFunNum);
            picExchangeEditPopWindowConfig.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public PicExchangeEditPopWindowConfig parse(nc5 nc5Var) throws IOException {
            PicExchangeEditPopWindowConfig picExchangeEditPopWindowConfig = new PicExchangeEditPopWindowConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    picExchangeEditPopWindowConfig.randomTime = nc5Var.m162487k();
                } else if (iM162497u == 16) {
                    picExchangeEditPopWindowConfig.randomNum = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    picExchangeEditPopWindowConfig.switchFunTime = nc5Var.m162487k();
                } else {
                    if (iM162497u != 32) {
                        return picExchangeEditPopWindowConfig;
                    }
                    picExchangeEditPopWindowConfig.switchFunNum = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(PicExchangeEditPopWindowConfig picExchangeEditPopWindowConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, picExchangeEditPopWindowConfig.randomTime);
            codedOutputByteBufferNano.m17305G(2, picExchangeEditPopWindowConfig.randomNum);
            codedOutputByteBufferNano.m17307I(3, picExchangeEditPopWindowConfig.switchFunTime);
            codedOutputByteBufferNano.m17305G(4, picExchangeEditPopWindowConfig.switchFunNum);
        }
    };
    ...
    public PicExchangeEditPopWindowConfig mo225055clone() {
        PicExchangeEditPopWindowConfig picExchangeEditPopWindowConfig = new PicExchangeEditPopWindowConfig();
