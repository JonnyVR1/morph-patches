...
public class LiveDefaultTabData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveDefaultTabData> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveDefaultTabData>() { // from class: com.p1.mobile.putong.core.data.LiveDefaultTabData.1
        ...
        public int computeAndCacheSize(LiveDefaultTabData liveDefaultTabData) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, liveDefaultTabData.visible);
            LiveDefaultTabDataInfo liveDefaultTabDataInfo = liveDefaultTabData.dataInfo;
            if (liveDefaultTabDataInfo != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(2, liveDefaultTabDataInfo, LiveDefaultTabDataInfo.PROTOBUF_ADAPTER);
            }
            liveDefaultTabData.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveDefaultTabData parse(nc5 nc5Var) throws IOException {
            LiveDefaultTabData liveDefaultTabData = new LiveDefaultTabData();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    liveDefaultTabData.visible = nc5Var.m162483g();
                } else {
                    if (iM162497u != 18) {
                        return liveDefaultTabData;
                    }
                    liveDefaultTabData.dataInfo = (LiveDefaultTabDataInfo) nc5Var.m162488l(LiveDefaultTabDataInfo.PROTOBUF_ADAPTER);
                }
            }
        }
        ...
        public void serialize(LiveDefaultTabData liveDefaultTabData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, liveDefaultTabData.visible);
            LiveDefaultTabDataInfo liveDefaultTabDataInfo = liveDefaultTabData.dataInfo;
            if (liveDefaultTabDataInfo != null) {
                codedOutputByteBufferNano.m17309K(2, liveDefaultTabDataInfo, LiveDefaultTabDataInfo.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LiveDefaultTabData mo225055clone() {
        LiveDefaultTabData liveDefaultTabData = new LiveDefaultTabData();
        liveDefaultTabData.visible = this.visible;
        LiveDefaultTabDataInfo liveDefaultTabDataInfo = this.dataInfo;
        if (liveDefaultTabDataInfo != null) {
            liveDefaultTabData.dataInfo = liveDefaultTabDataInfo.mo225055clone();
        }
        return liveDefaultTabData;
    }
