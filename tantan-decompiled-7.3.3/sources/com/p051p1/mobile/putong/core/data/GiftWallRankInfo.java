...
public class GiftWallRankInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GiftWallRankInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<GiftWallRankInfo>() { // from class: com.p1.mobile.putong.core.data.GiftWallRankInfo.1
        ...
        public int computeAndCacheSize(GiftWallRankInfo giftWallRankInfo) {
            ...
            if (rankLevel != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(6, rankLevel.ordinal());
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(7, giftWallRankInfo.totalGiftAmount);
            RankLevel rankLevel2 = giftWallRankInfo.rankLevel;
            if (rankLevel2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(8, rankLevel2, RankLevel.PROTOBUF_ADAPTER);
            }
            giftWallRankInfo.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GiftWallRankInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    giftWallRankInfo.city = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    giftWallRankInfo.country = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    giftWallRankInfo.district = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    giftWallRankInfo.province = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    giftWallRankInfo.rank = nc5Var.m162495s();
                } else if (iM162497u == 48) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 56) {
                    giftWallRankInfo.totalGiftAmount = nc5Var.m162486j();
                } else {
                    if (iM162497u != 66) {
                        if (giftWallRankInfo.rankLevel == null && numValueOf != null) {
                            giftWallRankInfo.rankLevel = (RankLevel) RankLevel.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    giftWallRankInfo.rankLevel = (RankLevel) nc5Var.m162488l(RankLevel.PROTOBUF_ADAPTER);
                }
            }
            return giftWallRankInfo;
        }
        ...
        public void serialize(GiftWallRankInfo giftWallRankInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            RankLevel rankLevel = giftWallRankInfo.rankLevel;
            if (rankLevel != null) {
                codedOutputByteBufferNano.m17305G(6, rankLevel.ordinal());
            }
            codedOutputByteBufferNano.m17305G(7, giftWallRankInfo.totalGiftAmount);
            RankLevel rankLevel2 = giftWallRankInfo.rankLevel;
            if (rankLevel2 != null) {
                codedOutputByteBufferNano.m17309K(8, rankLevel2, RankLevel.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public GiftWallRankInfo mo225055clone() {
        GiftWallRankInfo giftWallRankInfo = new GiftWallRankInfo();
