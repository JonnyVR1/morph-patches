...
public class SpryEmojiArgsConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SpryEmojiArgsConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<SpryEmojiArgsConfig>() { // from class: com.p1.mobile.putong.core.data.SpryEmojiArgsConfig.1
        ...
        public int computeAndCacheSize(SpryEmojiArgsConfig spryEmojiArgsConfig) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, spryEmojiArgsConfig.spry_emoji_show_max);
            SpryEmojiData spryEmojiData = spryEmojiArgsConfig.spry_emoji_array;
            if (spryEmojiData != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(2, spryEmojiData, SpryEmojiData.PROTOBUF_ADAPTER);
            }
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(3, spryEmojiArgsConfig.hint_emoji_show_max);
            List<String> list = spryEmojiArgsConfig.hint_emoji_array;
            if (list != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(4, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            spryEmojiArgsConfig.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SpryEmojiArgsConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    spryEmojiArgsConfig.spry_emoji_show_max = nc5Var.m162486j();
                } else if (iM162497u == 18) {
                    spryEmojiArgsConfig.spry_emoji_array = (SpryEmojiData) nc5Var.m162488l(SpryEmojiData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 24) {
                    spryEmojiArgsConfig.hint_emoji_show_max = nc5Var.m162486j();
                } else {
                    if (iM162497u != 34) {
                        if (spryEmojiArgsConfig.spry_emoji_array == null) {
                            spryEmojiArgsConfig.spry_emoji_array = SpryEmojiData.new_();
                    ...
                    spryEmojiArgsConfig.hint_emoji_array = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return spryEmojiArgsConfig;
        }
        ...
        public void serialize(SpryEmojiArgsConfig spryEmojiArgsConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, spryEmojiArgsConfig.spry_emoji_show_max);
            SpryEmojiData spryEmojiData = spryEmojiArgsConfig.spry_emoji_array;
            if (spryEmojiData != null) {
                codedOutputByteBufferNano.m17309K(2, spryEmojiData, SpryEmojiData.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(3, spryEmojiArgsConfig.hint_emoji_show_max);
            List<String> list = spryEmojiArgsConfig.hint_emoji_array;
            if (list != null) {
    ...
    public static /* synthetic */ String m36856a(String str) {
        return str;
    }
    ...
    public SpryEmojiArgsConfig mo225055clone() {
        SpryEmojiArgsConfig spryEmojiArgsConfig = new SpryEmojiArgsConfig();
        spryEmojiArgsConfig.spry_emoji_show_max = this.spry_emoji_show_max;
        SpryEmojiData spryEmojiData = this.spry_emoji_array;
        if (spryEmojiData != null) {
            spryEmojiArgsConfig.spry_emoji_array = spryEmojiData.mo225055clone();
        }
        spryEmojiArgsConfig.hint_emoji_show_max = this.hint_emoji_show_max;
        List<String> list = this.hint_emoji_array;
        if (list != null) {
            spryEmojiArgsConfig.hint_emoji_array = ValueObject.util_map(list, new qcj() { // from class: l.kzf0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return SpryEmojiArgsConfig.m36856a((String) obj);
                }
            });
        }
        return spryEmojiArgsConfig;
