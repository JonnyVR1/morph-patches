...
public class WarmingUpResConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<WarmingUpResConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<WarmingUpResConfig>() { // from class: com.p1.mobile.putong.core.data.WarmingUpResConfig.1
        ...
        public int computeAndCacheSize(WarmingUpResConfig warmingUpResConfig) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            List<WarmingUpEmoItem> list2 = warmingUpResConfig.restore_heat_guide_poke_sticker;
            if (list2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, list2, WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<WarmingUpEmoItem> list3 = warmingUpResConfig.restore_heat_guide_intimate_sticker;
            if (list3 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, list3, WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            ...
            if (str5 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(8, str5);
            }
            String str6 = warmingUpResConfig.core_warming_up_rq_4;
            if (str6 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(9, str6);
            }
            String str7 = warmingUpResConfig.core_love_heart_1;
            if (str7 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(10, str7);
            }
            String str8 = warmingUpResConfig.core_love_heart_2;
            if (str8 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(11, str8);
            }
            String str9 = warmingUpResConfig.core_love_heart_3;
            if (str9 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(12, str9);
            }
            String str10 = warmingUpResConfig.core_love_heart_4;
            if (str10 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(13, str10);
            }
            String str11 = warmingUpResConfig.core_up_left_bottom_1;
            if (str11 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(14, str11);
            }
            String str12 = warmingUpResConfig.core_up_left_bottom_2;
            if (str12 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(15, str12);
            }
            String str13 = warmingUpResConfig.core_up_left_bottom_3;
            if (str13 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(16, str13);
            }
            String str14 = warmingUpResConfig.core_up_left_bottom_4;
            if (str14 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(17, str14);
            }
            String str15 = warmingUpResConfig.core_down_left_bottom_1;
            if (str15 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(18, str15);
            }
            String str16 = warmingUpResConfig.core_down_left_bottom_2;
            if (str16 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(19, str16);
            }
            String str17 = warmingUpResConfig.core_down_left_bottom_3;
            if (str17 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(20, str17);
            }
            String str18 = warmingUpResConfig.core_temp_down_rq;
            if (str18 != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(21, str18);
            }
            warmingUpResConfig.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public WarmingUpResConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        warmingUpResConfig.restore_heat_guide_text = (List) nc5Var.m162488l(WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        warmingUpResConfig.restore_heat_guide_poke_sticker = (List) nc5Var.m162488l(WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 26:
                        warmingUpResConfig.restore_heat_guide_intimate_sticker = (List) nc5Var.m162488l(WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 34:
                        warmingUpResConfig.h5_url = nc5Var.m162495s();
                        continue;
                    case 42:
                        warmingUpResConfig.core_warming_up_rq_0 = nc5Var.m162495s();
                        continue;
                    case 50:
                        warmingUpResConfig.core_warming_up_rq_1 = nc5Var.m162495s();
                        continue;
                    case 58:
                        warmingUpResConfig.core_warming_up_rq_2 = nc5Var.m162495s();
                        continue;
                    case 66:
                        warmingUpResConfig.core_warming_up_rq_3 = nc5Var.m162495s();
                        continue;
                    case 74:
                        warmingUpResConfig.core_warming_up_rq_4 = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        warmingUpResConfig.core_love_heart_1 = nc5Var.m162495s();
                        continue;
                    case 90:
                        warmingUpResConfig.core_love_heart_2 = nc5Var.m162495s();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        warmingUpResConfig.core_love_heart_3 = nc5Var.m162495s();
                        continue;
                    case 106:
                        warmingUpResConfig.core_love_heart_4 = nc5Var.m162495s();
                        continue;
                    case 114:
                        warmingUpResConfig.core_up_left_bottom_1 = nc5Var.m162495s();
                        continue;
                    case 122:
                        warmingUpResConfig.core_up_left_bottom_2 = nc5Var.m162495s();
                        continue;
                    case 130:
                        warmingUpResConfig.core_up_left_bottom_3 = nc5Var.m162495s();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                        warmingUpResConfig.core_up_left_bottom_4 = nc5Var.m162495s();
                        continue;
                    case CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA /* 146 */:
                        warmingUpResConfig.core_down_left_bottom_1 = nc5Var.m162495s();
                        continue;
                    case 154:
                        warmingUpResConfig.core_down_left_bottom_2 = nc5Var.m162495s();
                        continue;
                    case 162:
                        warmingUpResConfig.core_down_left_bottom_3 = nc5Var.m162495s();
                        continue;
                    case CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 /* 170 */:
                        warmingUpResConfig.core_temp_down_rq = nc5Var.m162495s();
                        continue;
                    default:
                        if (warmingUpResConfig.restore_heat_guide_text == null) {
                            warmingUpResConfig.restore_heat_guide_text = new ArrayList();
        ...
        public void serialize(WarmingUpResConfig warmingUpResConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<WarmingUpEmoItem> list = warmingUpResConfig.restore_heat_guide_text;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<WarmingUpEmoItem> list2 = warmingUpResConfig.restore_heat_guide_poke_sticker;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(2, list2, WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<WarmingUpEmoItem> list3 = warmingUpResConfig.restore_heat_guide_intimate_sticker;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(3, list3, WarmingUpEmoItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str = warmingUpResConfig.h5_url;
            if (str != null) {
            ...
            String str12 = warmingUpResConfig.core_up_left_bottom_2;
            if (str12 != null) {
                codedOutputByteBufferNano.m17316R(15, str12);
            }
            String str13 = warmingUpResConfig.core_up_left_bottom_3;
            if (str13 != null) {
                codedOutputByteBufferNano.m17316R(16, str13);
            }
            String str14 = warmingUpResConfig.core_up_left_bottom_4;
            if (str14 != null) {
    ...
    public WarmingUpResConfig mo225055clone() {
        WarmingUpResConfig warmingUpResConfig = new WarmingUpResConfig();
        List<WarmingUpEmoItem> list = this.restore_heat_guide_text;
        if (list != null) {
            warmingUpResConfig.restore_heat_guide_text = ValueObject.util_map(list, new qcj() { // from class: l.cpp0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((WarmingUpEmoItem) obj).mo225055clone();
                }
            });
        }
        List<WarmingUpEmoItem> list2 = this.restore_heat_guide_poke_sticker;
        if (list2 != null) {
            warmingUpResConfig.restore_heat_guide_poke_sticker = ValueObject.util_map(list2, new qcj() { // from class: l.dpp0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((WarmingUpEmoItem) obj).mo225055clone();
                }
        ...
        if (list3 != null) {
            warmingUpResConfig.restore_heat_guide_intimate_sticker = ValueObject.util_map(list3, new qcj() { // from class: l.epp0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((WarmingUpEmoItem) obj).mo225055clone();
                }
