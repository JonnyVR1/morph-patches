...
public class QuestionnaireOptions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<QuestionnaireOptions> PROTOBUF_ADAPTER = new MessageNanoAdapter<QuestionnaireOptions>() { // from class: com.p1.mobile.putong.core.data.QuestionnaireOptions.1
        ...
        public int computeAndCacheSize(QuestionnaireOptions questionnaireOptions) {
            ...
            if (nextQuestionnaire != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, nextQuestionnaire, NextQuestionnaire.PROTOBUF_ADAPTER);
            }
            String str3 = questionnaireOptions.value;
            if (str3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(4, str3);
            }
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(5, questionnaireOptions.checked);
            questionnaireOptions.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public QuestionnaireOptions parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    questionnaireOptions.image = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    questionnaireOptions.imageSelected = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    questionnaireOptions.nextPage = (NextQuestionnaire) nc5Var.m162488l(NextQuestionnaire.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    questionnaireOptions.value = nc5Var.m162495s();
                } else {
                    if (iM162497u != 40) {
                        if (questionnaireOptions.value == null) {
                            questionnaireOptions.value = "";
                    ...
                    questionnaireOptions.checked = nc5Var.m162483g();
                }
            }
            return questionnaireOptions;
        }
        ...
        public void serialize(QuestionnaireOptions questionnaireOptions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            NextQuestionnaire nextQuestionnaire = questionnaireOptions.nextPage;
            if (nextQuestionnaire != null) {
                codedOutputByteBufferNano.m17309K(3, nextQuestionnaire, NextQuestionnaire.PROTOBUF_ADAPTER);
            }
            String str3 = questionnaireOptions.value;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(4, str3);
            }
            codedOutputByteBufferNano.m17299A(5, questionnaireOptions.checked);
        }
    };
    ...
    public QuestionnaireOptions mo225055clone() {
        QuestionnaireOptions questionnaireOptions = new QuestionnaireOptions();
        ...
        if (nextQuestionnaire != null) {
            questionnaireOptions.nextPage = nextQuestionnaire.mo225055clone();
        }
        return questionnaireOptions;
    }
