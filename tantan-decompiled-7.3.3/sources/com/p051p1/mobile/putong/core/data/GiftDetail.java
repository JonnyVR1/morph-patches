...
public class GiftDetail extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GiftDetail> PROTOBUF_ADAPTER = new MessageNanoAdapter<GiftDetail>() { // from class: com.p1.mobile.putong.core.data.GiftDetail.1
        ...
        public int computeAndCacheSize(GiftDetail giftDetail) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, giftDetail.giftItemId);
            String str = giftDetail.giftType;
            if (str != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(2, str);
            }
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(3, giftDetail.total);
            String str2 = giftDetail.url;
            if (str2 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(4, str2);
            }
            giftDetail.cachedSize = iM17281h2;
            return iM17281h2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GiftDetail parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    giftDetail.giftItemId = nc5Var.m162486j();
                } else if (iM162497u == 18) {
                    giftDetail.giftType = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    giftDetail.total = nc5Var.m162486j();
                } else {
                    if (iM162497u != 34) {
                        if (giftDetail.giftType != null) {
                            break;
                    ...
                    giftDetail.url = nc5Var.m162495s();
                }
            }
            return giftDetail;
        }
        ...
        public void serialize(GiftDetail giftDetail, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, giftDetail.giftItemId);
            String str = giftDetail.giftType;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(2, str);
            }
            codedOutputByteBufferNano.m17305G(3, giftDetail.total);
            String str2 = giftDetail.url;
            if (str2 != null) {
    ...
    public GiftDetail mo225055clone() {
        GiftDetail giftDetail = new GiftDetail();
