...
public class UserLiveHierarchy extends BaseData implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserLiveHierarchy> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserLiveHierarchy>() { // from class: com.p1.mobile.putong.core.data.UserLiveHierarchy.1
        ...
        public int computeAndCacheSize(UserLiveHierarchy userLiveHierarchy) {
            ...
            int iM17285l = userLiveGradeData != null ? CodedOutputByteBufferNano.m17285l(1, userLiveGradeData, UserLiveGradeData.PROTOBUF_ADAPTER) : 0;
            UserLiveGradeData userLiveGradeData2 = userLiveHierarchy.anchorHierarchy;
            if (userLiveGradeData2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, userLiveGradeData2, UserLiveGradeData.PROTOBUF_ADAPTER);
            }
            userLiveHierarchy.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserLiveHierarchy parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    userLiveHierarchy.hierarchy = (UserLiveGradeData) nc5Var.m162488l(UserLiveGradeData.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (userLiveHierarchy.hierarchy == null) {
                            userLiveHierarchy.hierarchy = UserLiveGradeData.new_();
                    ...
                    userLiveHierarchy.anchorHierarchy = (UserLiveGradeData) nc5Var.m162488l(UserLiveGradeData.PROTOBUF_ADAPTER);
                }
            }
            return userLiveHierarchy;
        }
        ...
        public void serialize(UserLiveHierarchy userLiveHierarchy, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (userLiveGradeData != null) {
                codedOutputByteBufferNano.m17309K(1, userLiveGradeData, UserLiveGradeData.PROTOBUF_ADAPTER);
            }
            UserLiveGradeData userLiveGradeData2 = userLiveHierarchy.anchorHierarchy;
            if (userLiveGradeData2 != null) {
                codedOutputByteBufferNano.m17309K(2, userLiveGradeData2, UserLiveGradeData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public UserLiveHierarchy mo225055clone() {
        UserLiveHierarchy userLiveHierarchy = new UserLiveHierarchy();
        UserLiveGradeData userLiveGradeData = this.hierarchy;
        if (userLiveGradeData != null) {
            userLiveHierarchy.hierarchy = userLiveGradeData.mo225055clone();
        }
        UserLiveGradeData userLiveGradeData2 = this.anchorHierarchy;
        if (userLiveGradeData2 != null) {
            userLiveHierarchy.anchorHierarchy = userLiveGradeData2.mo225055clone();
        }
        return userLiveHierarchy;
    }
