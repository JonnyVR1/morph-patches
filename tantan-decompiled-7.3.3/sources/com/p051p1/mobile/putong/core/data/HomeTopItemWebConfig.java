...
public class HomeTopItemWebConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<HomeTopItemWebConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<HomeTopItemWebConfig>() { // from class: com.p1.mobile.putong.core.data.HomeTopItemWebConfig.1
        ...
        public int computeAndCacheSize(HomeTopItemWebConfig homeTopItemWebConfig) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, homeTopItemWebConfig.enable);
            ...
            int iM17281h = iM17275b + CodedOutputByteBufferNano.m17281h(4, homeTopItemWebConfig.priority);
            List<String> list = homeTopItemWebConfig.rightItems;
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17275b2 = iM17281h + CodedOutputByteBufferNano.m17275b(6, homeTopItemWebConfig.showDailyRedDot);
            homeTopItemWebConfig.cachedSize = iM17275b2;
            return iM17275b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public HomeTopItemWebConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    homeTopItemWebConfig.enable = nc5Var.m162483g();
                } else if (iM162497u == 18) {
                    homeTopItemWebConfig.title = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    homeTopItemWebConfig.url = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    homeTopItemWebConfig.priority = nc5Var.m162486j();
                } else if (iM162497u == 42) {
                    homeTopItemWebConfig.rightItems = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 48) {
                        if (homeTopItemWebConfig.title == null) {
                            homeTopItemWebConfig.title = "";
                    ...
                    homeTopItemWebConfig.showDailyRedDot = nc5Var.m162483g();
                }
            }
            return homeTopItemWebConfig;
        }
        ...
        public void serialize(HomeTopItemWebConfig homeTopItemWebConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, homeTopItemWebConfig.enable);
            String str = homeTopItemWebConfig.title;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17305G(4, homeTopItemWebConfig.priority);
            List<String> list = homeTopItemWebConfig.rightItems;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(5, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17299A(6, homeTopItemWebConfig.showDailyRedDot);
        }
    };
    ...
    public static /* synthetic */ String m36590a(String str) {
        return str;
    }
    ...
    public HomeTopItemWebConfig mo225055clone() {
        HomeTopItemWebConfig homeTopItemWebConfig = new HomeTopItemWebConfig();
        ...
        if (list != null) {
            homeTopItemWebConfig.rightItems = ValueObject.util_map(list, new qcj() { // from class: l.cgl
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return HomeTopItemWebConfig.m36590a((String) obj);
                }
            });
        }
        return homeTopItemWebConfig;
