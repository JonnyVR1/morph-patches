...
public class MyTabOptV2Config extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MyTabOptV2Config> PROTOBUF_ADAPTER = new MessageNanoAdapter<MyTabOptV2Config>() { // from class: com.p1.mobile.putong.core.data.MyTabOptV2Config.1
        ...
        public int computeAndCacheSize(MyTabOptV2Config myTabOptV2Config) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, myTabOptV2Config.enable) + CodedOutputByteBufferNano.m17281h(2, myTabOptV2Config.createTimeLimit) + CodedOutputByteBufferNano.m17281h(3, myTabOptV2Config.cert_center_entry_red_dot_limit);
            myTabOptV2Config.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MyTabOptV2Config parse(nc5 nc5Var) throws IOException {
            MyTabOptV2Config myTabOptV2Config = new MyTabOptV2Config();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    myTabOptV2Config.enable = nc5Var.m162483g();
                } else if (iM162497u == 16) {
                    myTabOptV2Config.createTimeLimit = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        return myTabOptV2Config;
                    }
                    myTabOptV2Config.cert_center_entry_red_dot_limit = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(MyTabOptV2Config myTabOptV2Config, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, myTabOptV2Config.enable);
            codedOutputByteBufferNano.m17305G(2, myTabOptV2Config.createTimeLimit);
            codedOutputByteBufferNano.m17305G(3, myTabOptV2Config.cert_center_entry_red_dot_limit);
        }
    };
    ...
    public MyTabOptV2Config mo225055clone() {
        MyTabOptV2Config myTabOptV2Config = new MyTabOptV2Config();
