...
public class LiveSchema extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LiveSchema> PROTOBUF_ADAPTER = new MessageNanoAdapter<LiveSchema>() { // from class: com.p1.mobile.putong.core.data.LiveSchema.1
        ...
        public int computeAndCacheSize(LiveSchema liveSchema) {
            String str = liveSchema.f21177id;
            ...
            liveSchema.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LiveSchema parse(nc5 nc5Var) throws IOException {
            LiveSchema liveSchema = new LiveSchema();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (liveSchema.f21177id == null) {
                        liveSchema.f21177id = "";
                    }
                ...
                if (iM162497u == 10) {
                    liveSchema.f21177id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    liveSchema.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    liveSchema.schema = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (liveSchema.f21177id == null) {
                            liveSchema.f21177id = "";
                    ...
                    liveSchema.tip = nc5Var.m162495s();
                }
            }
            return liveSchema;
        }
        ...
        public boolean parseField(LiveSchema liveSchema, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "schema":
                    ...
                    return true;
                case "id":
                    liveSchema.f21177id = jsonParser.getValueAsString();
                    return false;
                case "tip":
    ...
    public LiveSchema mo225055clone() {
        LiveSchema liveSchema = new LiveSchema();
        liveSchema.f21177id = this.f21177id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21177id, liveSchema.f21177id) && ValueObject.util_equals(this.type, liveSchema.type) && ValueObject.util_equals(this.schema, liveSchema.schema) && ValueObject.util_equals(this.tip, liveSchema.tip);
    }
