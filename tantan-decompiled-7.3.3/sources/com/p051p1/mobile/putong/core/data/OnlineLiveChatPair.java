...
public class OnlineLiveChatPair extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OnlineLiveChatPair> PROTOBUF_ADAPTER = new MessageNanoAdapter<OnlineLiveChatPair>() { // from class: com.p1.mobile.putong.core.data.OnlineLiveChatPair.1
        ...
        public int computeAndCacheSize(OnlineLiveChatPair onlineLiveChatPair) {
            ...
            if (liveMultiCallInfo != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(9, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
            String str9 = onlineLiveChatPair.schema;
            if (str9 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(10, str9);
            }
            onlineLiveChatPair.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OnlineLiveChatPair parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        onlineLiveChatPair.userId = nc5Var.m162495s();
                        continue;
                    case 18:
                        onlineLiveChatPair.liveId = nc5Var.m162495s();
                        continue;
                    case 26:
                        onlineLiveChatPair.name = nc5Var.m162495s();
                        continue;
                    case 34:
                        onlineLiveChatPair.avatar = nc5Var.m162495s();
                        continue;
                    case 42:
                        onlineLiveChatPair.text = nc5Var.m162495s();
                        continue;
                    case 50:
                        onlineLiveChatPair.voiceRoomTopicId = nc5Var.m162495s();
                        continue;
                    case 58:
                        onlineLiveChatPair.anchorId = nc5Var.m162495s();
                        continue;
                    case 66:
                        onlineLiveChatPair.liveState = nc5Var.m162495s();
                        continue;
                    case 74:
                        onlineLiveChatPair.multiCallInfo = (LiveMultiCallInfo) nc5Var.m162488l(LiveMultiCallInfo.PROTOBUF_ADAPTER);
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        onlineLiveChatPair.schema = nc5Var.m162495s();
                        continue;
                    default:
                        if (onlineLiveChatPair.userId == null) {
                            onlineLiveChatPair.userId = "";
        ...
        public void serialize(OnlineLiveChatPair onlineLiveChatPair, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            LiveMultiCallInfo liveMultiCallInfo = onlineLiveChatPair.multiCallInfo;
            if (liveMultiCallInfo != null) {
                codedOutputByteBufferNano.m17309K(9, liveMultiCallInfo, LiveMultiCallInfo.PROTOBUF_ADAPTER);
            }
            String str9 = onlineLiveChatPair.schema;
            if (str9 != null) {
    ...
    public OnlineLiveChatPair mo225055clone() {
        OnlineLiveChatPair onlineLiveChatPair = new OnlineLiveChatPair();
        ...
        if (liveMultiCallInfo != null) {
            onlineLiveChatPair.multiCallInfo = liveMultiCallInfo.mo225055clone();
        }
