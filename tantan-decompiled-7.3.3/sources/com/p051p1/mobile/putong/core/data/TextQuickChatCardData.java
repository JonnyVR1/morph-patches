...
public class TextQuickChatCardData extends BaseData implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TextQuickChatCardData> PROTOBUF_ADAPTER = new MessageNanoAdapter<TextQuickChatCardData>() { // from class: com.p1.mobile.putong.core.data.TextQuickChatCardData.1
        ...
        public int computeAndCacheSize(TextQuickChatCardData textQuickChatCardData) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, TextCardData.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            ...
            textQuickChatCardData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TextQuickChatCardData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    textQuickChatCardData.cards = (List) nc5Var.m162488l(TextCardData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (textQuickChatCardData.cards == null) {
                            textQuickChatCardData.cards = new ArrayList();
                    ...
                    textQuickChatCardData.users = (List) nc5Var.m162488l(User.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return textQuickChatCardData;
        }
        ...
        public void serialize(TextQuickChatCardData textQuickChatCardData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<TextCardData> list = textQuickChatCardData.cards;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, TextCardData.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<User> list2 = textQuickChatCardData.users;
            if (list2 != null) {
    ...
    public TextQuickChatCardData mo225055clone() {
        TextQuickChatCardData textQuickChatCardData = new TextQuickChatCardData();
        List<TextCardData> list = this.cards;
        if (list != null) {
            textQuickChatCardData.cards = ValueObject.util_map(list, new qcj() { // from class: l.bsi0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((TextCardData) obj).mo225055clone();
                }
            });
        }
        List<User> list2 = this.users;
        if (list2 != null) {
            textQuickChatCardData.users = ValueObject.util_map(list2, new qcj() { // from class: l.csi0
                @Override // p153l.qcj
                public final Object call(Object obj) {
