...
public class EmojiCacheItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<EmojiCacheItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<EmojiCacheItem>() { // from class: com.p1.mobile.putong.core.data.EmojiCacheItem.1
        ...
        public int computeAndCacheSize(EmojiCacheItem emojiCacheItem) {
            ...
            int iM17285l = (list != null ? CodedOutputByteBufferNano.m17285l(1, list, Sticker.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0) + CodedOutputByteBufferNano.m17283j(2, emojiCacheItem.useNumber);
            emojiCacheItem.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public EmojiCacheItem parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    emojiCacheItem.dataList = (List) nc5Var.m162488l(Sticker.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 16) {
                        if (emojiCacheItem.dataList != null) {
                            break;
                    ...
                    emojiCacheItem.useNumber = nc5Var.m162487k();
                }
            }
            return emojiCacheItem;
        }
        ...
        public void serialize(EmojiCacheItem emojiCacheItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<Sticker> list = emojiCacheItem.dataList;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, Sticker.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17307I(2, emojiCacheItem.useNumber);
        }
    };
    ...
    public EmojiCacheItem mo225055clone() {
        EmojiCacheItem emojiCacheItem = new EmojiCacheItem();
        List<Sticker> list = this.dataList;
        if (list != null) {
            emojiCacheItem.dataList = ValueObject.util_map(list, new qcj() { // from class: l.gye
                @Override // p153l.qcj
