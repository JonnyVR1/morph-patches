...
public class FloatsCardData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FloatsCardData> PROTOBUF_ADAPTER = new MessageNanoAdapter<FloatsCardData>() { // from class: com.p1.mobile.putong.core.data.FloatsCardData.1
        ...
        public int computeAndCacheSize(FloatsCardData floatsCardData) {
            String str = floatsCardData.f21134id;
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(8, floatsCardData.gradualHeight);
            floatsCardData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FloatsCardData parse(nc5 nc5Var) throws IOException {
            FloatsCardData floatsCardData = new FloatsCardData();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (floatsCardData.f21134id == null) {
                        floatsCardData.f21134id = "";
                    }
                ...
                if (iM162497u == 10) {
                    floatsCardData.f21134id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    floatsCardData.title = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    floatsCardData.buttonTitle = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    floatsCardData.buttonTitleColor = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    floatsCardData.buttonColor = nc5Var.m162495s();
                } else if (iM162497u == 50) {
                    floatsCardData.borderColor = nc5Var.m162495s();
                } else if (iM162497u == 58) {
                    floatsCardData.gradualImg = nc5Var.m162495s();
                } else {
                    if (iM162497u != 64) {
                        if (floatsCardData.f21134id == null) {
                            floatsCardData.f21134id = "";
                    ...
                    floatsCardData.gradualHeight = nc5Var.m162486j();
                }
            }
            return floatsCardData;
        }
        ...
        public void serialize(FloatsCardData floatsCardData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(8, floatsCardData.gradualHeight);
        }
    };
        ...
        public boolean parseField(FloatsCardData floatsCardData, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "buttonTitle":
                    ...
                    return true;
                case "id":
                    floatsCardData.f21134id = jsonParser.getValueAsString();
                    return false;
                case "title":
    ...
    public FloatsCardData mo225055clone() {
        FloatsCardData floatsCardData = new FloatsCardData();
        floatsCardData.f21134id = this.f21134id;
