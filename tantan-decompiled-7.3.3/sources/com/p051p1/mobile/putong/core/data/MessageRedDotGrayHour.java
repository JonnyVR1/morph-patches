...
public class MessageRedDotGrayHour extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageRedDotGrayHour> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageRedDotGrayHour>() { // from class: com.p1.mobile.putong.core.data.MessageRedDotGrayHour.1
        ...
        public int computeAndCacheSize(MessageRedDotGrayHour messageRedDotGrayHour) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, messageRedDotGrayHour.red_dot_gray_hour) + CodedOutputByteBufferNano.m17281h(2, messageRedDotGrayHour.patch_max);
            messageRedDotGrayHour.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageRedDotGrayHour parse(nc5 nc5Var) throws IOException {
            MessageRedDotGrayHour messageRedDotGrayHour = new MessageRedDotGrayHour();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    messageRedDotGrayHour.red_dot_gray_hour = nc5Var.m162486j();
                } else {
                    if (iM162497u != 16) {
                        return messageRedDotGrayHour;
                    }
                    messageRedDotGrayHour.patch_max = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(MessageRedDotGrayHour messageRedDotGrayHour, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, messageRedDotGrayHour.red_dot_gray_hour);
            codedOutputByteBufferNano.m17305G(2, messageRedDotGrayHour.patch_max);
        }
    };
    ...
    public MessageRedDotGrayHour mo225055clone() {
        MessageRedDotGrayHour messageRedDotGrayHour = new MessageRedDotGrayHour();
