...
public class VerificationCenter extends DbObject implements Cloneable, Serializable {
    ...
    public static vzf0<VerificationCenter> DB_ADAPTER = null;
    ...
    public static ProtobufAdapter<VerificationCenter> PROTOBUF_ADAPTER = new MessageNanoAdapter<VerificationCenter>() { // from class: com.p1.mobile.putong.core.data.VerificationCenter.1
        ...
        public int computeAndCacheSize(VerificationCenter verificationCenter) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, verificationCenter._id);
            String str = verificationCenter.f56859id;
            if (str != null) {
            ...
            if (picVerificationInfo != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(53, picVerificationInfo, PicVerificationInfo.PROTOBUF_ADAPTER);
            }
            IdCardVerificationInfo idCardVerificationInfo = verificationCenter.idCard;
            if (idCardVerificationInfo != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(54, idCardVerificationInfo, IdCardVerificationInfo.PROTOBUF_ADAPTER);
            }
            AgeVerificationInfo ageVerificationInfo = verificationCenter.ageVerificationInfo;
            if (ageVerificationInfo != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(55, ageVerificationInfo, AgeVerificationInfo.PROTOBUF_ADAPTER);
            }
            VoiceAnchorVerifyResult voiceAnchorVerifyResult = verificationCenter.voiceAnchor;
            if (voiceAnchorVerifyResult != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(56, voiceAnchorVerifyResult, VoiceAnchorVerifyResult.PROTOBUF_ADAPTER);
            }
            PicVerificationInfo picVerificationInfo2 = verificationCenter.ctdidVerificationInfo;
            if (picVerificationInfo2 != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(57, picVerificationInfo2, PicVerificationInfo.PROTOBUF_ADAPTER);
            }
            verificationCenter.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public VerificationCenter parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    verificationCenter._id = nc5Var.m162487k();
                } else if (iM162497u == 18) {
                    verificationCenter.f56859id = nc5Var.m162495s();
                } else if (iM162497u == 410) {
                    verificationCenter.userId = nc5Var.m162495s();
                } else if (iM162497u == 418) {
                    verificationCenter.verificationType = nc5Var.m162495s();
                } else if (iM162497u == 426) {
                    verificationCenter.picVerificationInfo = (PicVerificationInfo) nc5Var.m162488l(PicVerificationInfo.PROTOBUF_ADAPTER);
                } else if (iM162497u == 434) {
                    verificationCenter.idCard = (IdCardVerificationInfo) nc5Var.m162488l(IdCardVerificationInfo.PROTOBUF_ADAPTER);
                } else if (iM162497u == 442) {
                    verificationCenter.ageVerificationInfo = (AgeVerificationInfo) nc5Var.m162488l(AgeVerificationInfo.PROTOBUF_ADAPTER);
                } else if (iM162497u == 450) {
                    verificationCenter.voiceAnchor = (VoiceAnchorVerifyResult) nc5Var.m162488l(VoiceAnchorVerifyResult.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 458) {
                        if (verificationCenter.userId == null) {
                            verificationCenter.userId = "";
                    ...
                    verificationCenter.ctdidVerificationInfo = (PicVerificationInfo) nc5Var.m162488l(PicVerificationInfo.PROTOBUF_ADAPTER);
                }
            }
            return verificationCenter;
        }
        ...
        public void serialize(VerificationCenter verificationCenter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, verificationCenter._id);
            String str = verificationCenter.f56859id;
            if (str != null) {
            ...
            PicVerificationInfo picVerificationInfo = verificationCenter.picVerificationInfo;
            if (picVerificationInfo != null) {
                codedOutputByteBufferNano.m17309K(53, picVerificationInfo, PicVerificationInfo.PROTOBUF_ADAPTER);
            }
            IdCardVerificationInfo idCardVerificationInfo = verificationCenter.idCard;
            if (idCardVerificationInfo != null) {
                codedOutputByteBufferNano.m17309K(54, idCardVerificationInfo, IdCardVerificationInfo.PROTOBUF_ADAPTER);
            }
            AgeVerificationInfo ageVerificationInfo = verificationCenter.ageVerificationInfo;
            if (ageVerificationInfo != null) {
                codedOutputByteBufferNano.m17309K(55, ageVerificationInfo, AgeVerificationInfo.PROTOBUF_ADAPTER);
            }
            VoiceAnchorVerifyResult voiceAnchorVerifyResult = verificationCenter.voiceAnchor;
            if (voiceAnchorVerifyResult != null) {
                codedOutputByteBufferNano.m17309K(56, voiceAnchorVerifyResult, VoiceAnchorVerifyResult.PROTOBUF_ADAPTER);
            }
            PicVerificationInfo picVerificationInfo2 = verificationCenter.ctdidVerificationInfo;
            if (picVerificationInfo2 != null) {
                codedOutputByteBufferNano.m17309K(57, picVerificationInfo2, PicVerificationInfo.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(VerificationCenter verificationCenter, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "identity":
                    ...
                    return true;
                case "id":
                    verificationCenter.f56859id = jsonParser.getValueAsString();
                    return false;
                case "age":
    ...
    public static final StringColumn<VerificationCenter> f21270ID = new StringColumn<VerificationCenter>("id_c") { // from class: com.p1.mobile.putong.core.data.VerificationCenter.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(VerificationCenter verificationCenter) {
            return verificationCenter.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(VerificationCenter verificationCenter, String str) {
            verificationCenter.f56859id = str;
        }
    };
        ...
        DB_ADAPTER = new vzf0<VerificationCenter>() { // from class: com.p1.mobile.putong.core.data.VerificationCenter.14
            ...
            public VerificationCenter read(Cursor cursor, int i) {
                ...
                try {
                    ...
                    verificationCenter.f56859id = cursor.isNull(i6) ? null : cursor.getString(i6);
                    int i7 = i + 2;
            ...
            public void write(VerificationCenter verificationCenter, ContentValues contentValues) {
                try {
                    DbObject.cvPut(contentValues, "id_c", verificationCenter.f56859id);
    ...
    public VerificationCenter mo225055clone() {
        VerificationCenter verificationCenter = new VerificationCenter();
        verificationCenter._id = this._id;
        verificationCenter.f56859id = this.f56859id;
        ...
        if (picVerificationInfo != null) {
            verificationCenter.picVerificationInfo = picVerificationInfo.mo225055clone();
        }
        LiveAnchor liveAnchor = this.anchor;
        if (liveAnchor != null) {
            verificationCenter.anchor = liveAnchor.mo225055clone();
        }
        Identity identity = this.identity;
        if (identity != null) {
            verificationCenter.identity = identity.mo225055clone();
        }
        IdCardVerificationInfo idCardVerificationInfo = this.idCard;
        if (idCardVerificationInfo != null) {
            verificationCenter.idCard = idCardVerificationInfo.mo225055clone();
        }
        AgeVerificationInfo ageVerificationInfo = this.ageVerificationInfo;
        if (ageVerificationInfo != null) {
            verificationCenter.ageVerificationInfo = ageVerificationInfo.mo225055clone();
        }
        VoiceAnchorVerifyResult voiceAnchorVerifyResult = this.voiceAnchor;
        if (voiceAnchorVerifyResult != null) {
            verificationCenter.voiceAnchor = voiceAnchorVerifyResult.mo225055clone();
        }
        PicVerificationInfo picVerificationInfo2 = this.ctdidVerificationInfo;
        if (picVerificationInfo2 != null) {
            verificationCenter.ctdidVerificationInfo = picVerificationInfo2.mo225055clone();
        }
        return verificationCenter;
    }
