...
public class LoveBuzzData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LoveBuzzData> PROTOBUF_ADAPTER = new MessageNanoAdapter<LoveBuzzData>() { // from class: com.p1.mobile.putong.core.data.LoveBuzzData.1
        ...
        public int computeAndCacheSize(LoveBuzzData loveBuzzData) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17281h(2, loveBuzzData.mcc) + CodedOutputByteBufferNano.m17275b(3, loveBuzzData.textBuzzToggle);
            String str2 = loveBuzzData.conversationId;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(4, str2);
            }
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(5, loveBuzzData.isTextBuzzExhausted) + CodedOutputByteBufferNano.m17275b(6, loveBuzzData.isBoosted) + CodedOutputByteBufferNano.m17281h(7, loveBuzzData.remainingVoiceBuzz) + CodedOutputByteBufferNano.m17281h(8, loveBuzzData.remainingProlongCount) + CodedOutputByteBufferNano.m17275b(9, loveBuzzData.matched) + CodedOutputByteBufferNano.m17281h(10, loveBuzzData.totalDuration) + CodedOutputByteBufferNano.m17281h(11, loveBuzzData.prolongDuration);
            String str3 = loveBuzzData.voiceBuzzRTCVendor;
            if (str3 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(12, str3);
            }
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(13, loveBuzzData.isTextBuzzBoosted) + CodedOutputByteBufferNano.m17281h(14, loveBuzzData.remainingVideoBuzz);
            String str4 = loveBuzzData.videoBuzzRTCVendor;
            if (str4 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(15, str4);
            }
            List<String> list = loveBuzzData.enabledBuzz;
            if (list != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17285l(16, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17281h = iM17275b2 + CodedOutputByteBufferNano.m17281h(17, loveBuzzData.remainingTextBuzz) + CodedOutputByteBufferNano.m17281h(18, loveBuzzData.textBuzzPairFailHintTimeout) + CodedOutputByteBufferNano.m17281h(19, loveBuzzData.voiceBuzzPairFailHintTimeout) + CodedOutputByteBufferNano.m17281h(20, loveBuzzData.videoBuzzPairFailHintTimeout) + CodedOutputByteBufferNano.m17275b(21, loveBuzzData.voiceBuzzToggle) + CodedOutputByteBufferNano.m17275b(22, loveBuzzData.videoBuzzToggle);
            List<String> list2 = loveBuzzData.showedPassiveModeBuzz;
            if (list2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(23, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(24, loveBuzzData.voiceBuzzConnectTimeout) + CodedOutputByteBufferNano.m17281h(25, loveBuzzData.videoBuzzConnectTimeout) + CodedOutputByteBufferNano.m17281h(26, loveBuzzData.voiceBuzzReactTimeout) + CodedOutputByteBufferNano.m17281h(27, loveBuzzData.videoBuzzReactTimeout) + CodedOutputByteBufferNano.m17281h(28, loveBuzzData.voiceBuzzWaitingTimeout) + CodedOutputByteBufferNano.m17281h(29, loveBuzzData.videoBuzzWaitingTimeout);
            RemainingBonus remainingBonus = loveBuzzData.remainingBonus;
            if (remainingBonus != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(30, remainingBonus, RemainingBonus.PROTOBUF_ADAPTER);
            }
            RateLimited rateLimited = loveBuzzData.rateLimited;
            if (rateLimited != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(31, rateLimited, RateLimited.PROTOBUF_ADAPTER);
            }
            BonusThreshold bonusThreshold = loveBuzzData.bonusThreshold;
            if (bonusThreshold != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17285l(32, bonusThreshold, BonusThreshold.PROTOBUF_ADAPTER);
            }
            int iM17275b3 = iM17281h2 + CodedOutputByteBufferNano.m17275b(33, loveBuzzData.memojiBuzzToggle) + CodedOutputByteBufferNano.m17281h(34, loveBuzzData.memojiBuzzConnectTimeout) + CodedOutputByteBufferNano.m17281h(35, loveBuzzData.memojiBuzzPairFailHintTimeout) + CodedOutputByteBufferNano.m17281h(36, loveBuzzData.memojiBuzzReactTimeout) + CodedOutputByteBufferNano.m17281h(37, loveBuzzData.memojiBuzzWaitingTimeout) + CodedOutputByteBufferNano.m17281h(38, loveBuzzData.remainingMemojiBuzz);
            String str5 = loveBuzzData.memojiBuzzRTCVendor;
            if (str5 != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17288o(39, str5);
            }
            List<Integer> list3 = loveBuzzData.allowedMCCSwitchList;
            if (list3 != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17285l(40, list3, ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            BuzzResolution buzzResolution = loveBuzzData.recommendResolution;
            if (buzzResolution != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17285l(41, buzzResolution, BuzzResolution.PROTOBUF_ADAPTER);
            }
            List<String> list4 = loveBuzzData.bonusEnabledBuzz;
            if (list4 != null) {
                iM17275b3 += CodedOutputByteBufferNano.m17285l(42, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17275b4 = iM17275b3 + CodedOutputByteBufferNano.m17275b(43, loveBuzzData.potentialPremium);
            loveBuzzData.cachedSize = iM17275b4;
            return iM17275b4;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LoveBuzzData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        loveBuzzData.userId = nc5Var.m162495s();
                        continue;
                    case 16:
                        loveBuzzData.mcc = nc5Var.m162486j();
                        continue;
                    case 24:
                        loveBuzzData.textBuzzToggle = nc5Var.m162483g();
                        continue;
                    case 34:
                        loveBuzzData.conversationId = nc5Var.m162495s();
                        continue;
                    case 40:
                        loveBuzzData.isTextBuzzExhausted = nc5Var.m162483g();
                        continue;
                    case 48:
                        loveBuzzData.isBoosted = nc5Var.m162483g();
                        continue;
                    case 56:
                        loveBuzzData.remainingVoiceBuzz = nc5Var.m162486j();
                        continue;
                    case 64:
                        loveBuzzData.remainingProlongCount = nc5Var.m162486j();
                        continue;
                    case 72:
                        loveBuzzData.matched = nc5Var.m162483g();
                        continue;
                    case 80:
                        loveBuzzData.totalDuration = nc5Var.m162486j();
                        continue;
                    case 88:
                        loveBuzzData.prolongDuration = nc5Var.m162486j();
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        loveBuzzData.voiceBuzzRTCVendor = nc5Var.m162495s();
                        continue;
                    case 104:
                        loveBuzzData.isTextBuzzBoosted = nc5Var.m162483g();
                        continue;
                    case 112:
                        loveBuzzData.remainingVideoBuzz = nc5Var.m162486j();
                        continue;
                    case 122:
                        loveBuzzData.videoBuzzRTCVendor = nc5Var.m162495s();
                        continue;
                    case 130:
                        loveBuzzData.enabledBuzz = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA /* 136 */:
                        loveBuzzData.remainingTextBuzz = nc5Var.m162486j();
                        continue;
                    case 144:
                        loveBuzzData.textBuzzPairFailHintTimeout = nc5Var.m162486j();
                        continue;
                    case CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA /* 152 */:
                        loveBuzzData.voiceBuzzPairFailHintTimeout = nc5Var.m162486j();
                        continue;
                    case 160:
                        loveBuzzData.videoBuzzPairFailHintTimeout = nc5Var.m162486j();
                        continue;
                    case CipherSuite.TLS_PSK_WITH_AES_128_GCM_SHA256 /* 168 */:
                        loveBuzzData.voiceBuzzToggle = nc5Var.m162483g();
                        continue;
                    case 176:
                        loveBuzzData.videoBuzzToggle = nc5Var.m162483g();
                        continue;
                    case CipherSuite.TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 /* 186 */:
                        loveBuzzData.showedPassiveModeBuzz = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 192:
                        loveBuzzData.voiceBuzzConnectTimeout = nc5Var.m162486j();
                        continue;
                    case 200:
                        loveBuzzData.videoBuzzConnectTimeout = nc5Var.m162486j();
                        continue;
                    case 208:
                        loveBuzzData.voiceBuzzReactTimeout = nc5Var.m162486j();
                        continue;
                    case 216:
                        loveBuzzData.videoBuzzReactTimeout = nc5Var.m162486j();
                        continue;
                    case 224:
                        loveBuzzData.voiceBuzzWaitingTimeout = nc5Var.m162486j();
                        continue;
                    case 232:
                        loveBuzzData.videoBuzzWaitingTimeout = nc5Var.m162486j();
                        continue;
                    case 242:
                        loveBuzzData.remainingBonus = (RemainingBonus) nc5Var.m162488l(RemainingBonus.PROTOBUF_ADAPTER);
                        continue;
                    case 250:
                        loveBuzzData.rateLimited = (RateLimited) nc5Var.m162488l(RateLimited.PROTOBUF_ADAPTER);
                        continue;
                    case 258:
                        loveBuzzData.bonusThreshold = (BonusThreshold) nc5Var.m162488l(BonusThreshold.PROTOBUF_ADAPTER);
                        continue;
                    case 264:
                        loveBuzzData.memojiBuzzToggle = nc5Var.m162483g();
                        continue;
                    case 272:
                        loveBuzzData.memojiBuzzConnectTimeout = nc5Var.m162486j();
                        continue;
                    case 280:
                        loveBuzzData.memojiBuzzPairFailHintTimeout = nc5Var.m162486j();
                        continue;
                    case 288:
                        loveBuzzData.memojiBuzzReactTimeout = nc5Var.m162486j();
                        continue;
                    case 296:
                        loveBuzzData.memojiBuzzWaitingTimeout = nc5Var.m162486j();
                        continue;
                    case HttpStatus.NOT_MODIFIED_304 /* 304 */:
                        loveBuzzData.remainingMemojiBuzz = nc5Var.m162486j();
                        continue;
                    case 314:
                        loveBuzzData.memojiBuzzRTCVendor = nc5Var.m162495s();
                        continue;
                    case 322:
                        loveBuzzData.allowedMCCSwitchList = (List) nc5Var.m162488l(ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 330:
                        loveBuzzData.recommendResolution = (BuzzResolution) nc5Var.m162488l(BuzzResolution.PROTOBUF_ADAPTER);
                        continue;
                    case 338:
                        loveBuzzData.bonusEnabledBuzz = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 344:
                        loveBuzzData.potentialPremium = nc5Var.m162483g();
                        continue;
                    default:
                        if (loveBuzzData.userId == null) {
                            loveBuzzData.userId = "";
        ...
        public void serialize(LoveBuzzData loveBuzzData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(2, loveBuzzData.mcc);
            codedOutputByteBufferNano.m17299A(3, loveBuzzData.textBuzzToggle);
            String str2 = loveBuzzData.conversationId;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(4, str2);
            }
            codedOutputByteBufferNano.m17299A(5, loveBuzzData.isTextBuzzExhausted);
            codedOutputByteBufferNano.m17299A(6, loveBuzzData.isBoosted);
            codedOutputByteBufferNano.m17305G(7, loveBuzzData.remainingVoiceBuzz);
            codedOutputByteBufferNano.m17305G(8, loveBuzzData.remainingProlongCount);
            codedOutputByteBufferNano.m17299A(9, loveBuzzData.matched);
            codedOutputByteBufferNano.m17305G(10, loveBuzzData.totalDuration);
            codedOutputByteBufferNano.m17305G(11, loveBuzzData.prolongDuration);
            String str3 = loveBuzzData.voiceBuzzRTCVendor;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(12, str3);
            }
            codedOutputByteBufferNano.m17299A(13, loveBuzzData.isTextBuzzBoosted);
            codedOutputByteBufferNano.m17305G(14, loveBuzzData.remainingVideoBuzz);
            String str4 = loveBuzzData.videoBuzzRTCVendor;
            if (str4 != null) {
            ...
            List<String> list = loveBuzzData.enabledBuzz;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(16, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(17, loveBuzzData.remainingTextBuzz);
            codedOutputByteBufferNano.m17305G(18, loveBuzzData.textBuzzPairFailHintTimeout);
            codedOutputByteBufferNano.m17305G(19, loveBuzzData.voiceBuzzPairFailHintTimeout);
            codedOutputByteBufferNano.m17305G(20, loveBuzzData.videoBuzzPairFailHintTimeout);
            codedOutputByteBufferNano.m17299A(21, loveBuzzData.voiceBuzzToggle);
            codedOutputByteBufferNano.m17299A(22, loveBuzzData.videoBuzzToggle);
            List<String> list2 = loveBuzzData.showedPassiveModeBuzz;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(23, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17305G(24, loveBuzzData.voiceBuzzConnectTimeout);
            codedOutputByteBufferNano.m17305G(25, loveBuzzData.videoBuzzConnectTimeout);
            codedOutputByteBufferNano.m17305G(26, loveBuzzData.voiceBuzzReactTimeout);
            codedOutputByteBufferNano.m17305G(27, loveBuzzData.videoBuzzReactTimeout);
            codedOutputByteBufferNano.m17305G(28, loveBuzzData.voiceBuzzWaitingTimeout);
            codedOutputByteBufferNano.m17305G(29, loveBuzzData.videoBuzzWaitingTimeout);
            RemainingBonus remainingBonus = loveBuzzData.remainingBonus;
            if (remainingBonus != null) {
                codedOutputByteBufferNano.m17309K(30, remainingBonus, RemainingBonus.PROTOBUF_ADAPTER);
            }
            RateLimited rateLimited = loveBuzzData.rateLimited;
            if (rateLimited != null) {
                codedOutputByteBufferNano.m17309K(31, rateLimited, RateLimited.PROTOBUF_ADAPTER);
            }
            BonusThreshold bonusThreshold = loveBuzzData.bonusThreshold;
            if (bonusThreshold != null) {
                codedOutputByteBufferNano.m17309K(32, bonusThreshold, BonusThreshold.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17299A(33, loveBuzzData.memojiBuzzToggle);
            codedOutputByteBufferNano.m17305G(34, loveBuzzData.memojiBuzzConnectTimeout);
            codedOutputByteBufferNano.m17305G(35, loveBuzzData.memojiBuzzPairFailHintTimeout);
            codedOutputByteBufferNano.m17305G(36, loveBuzzData.memojiBuzzReactTimeout);
            codedOutputByteBufferNano.m17305G(37, loveBuzzData.memojiBuzzWaitingTimeout);
            codedOutputByteBufferNano.m17305G(38, loveBuzzData.remainingMemojiBuzz);
            String str5 = loveBuzzData.memojiBuzzRTCVendor;
            if (str5 != null) {
                codedOutputByteBufferNano.m17316R(39, str5);
            }
            List<Integer> list3 = loveBuzzData.allowedMCCSwitchList;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(40, list3, ProtobufAdapter.INT_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            BuzzResolution buzzResolution = loveBuzzData.recommendResolution;
            if (buzzResolution != null) {
                codedOutputByteBufferNano.m17309K(41, buzzResolution, BuzzResolution.PROTOBUF_ADAPTER);
            }
            List<String> list4 = loveBuzzData.bonusEnabledBuzz;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(42, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17299A(43, loveBuzzData.potentialPremium);
        }
    };
    ...
    public static /* synthetic */ String m36657a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m36658b(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m36659c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ Integer m36660d(Integer num) {
        return num;
    }
    ...
    public LoveBuzzData mo225055clone() {
        LoveBuzzData loveBuzzData = new LoveBuzzData();
        ...
        if (list != null) {
            loveBuzzData.enabledBuzz = ValueObject.util_map(list, new qcj() { // from class: l.q6w
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return LoveBuzzData.m36658b((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            loveBuzzData.showedPassiveModeBuzz = ValueObject.util_map(list2, new qcj() { // from class: l.r6w
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return LoveBuzzData.m36659c((String) obj);
                }
            });
        }
        ...
        if (remainingBonus != null) {
            loveBuzzData.remainingBonus = remainingBonus.mo225055clone();
        }
        RateLimited rateLimited = this.rateLimited;
        if (rateLimited != null) {
            loveBuzzData.rateLimited = rateLimited.mo225055clone();
        }
        BonusThreshold bonusThreshold = this.bonusThreshold;
        if (bonusThreshold != null) {
            loveBuzzData.bonusThreshold = bonusThreshold.mo225055clone();
        }
        ...
        if (list3 != null) {
            loveBuzzData.allowedMCCSwitchList = ValueObject.util_map(list3, new qcj() { // from class: l.s6w
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return LoveBuzzData.m36660d((Integer) obj);
                }
            });
        }
        BuzzResolution buzzResolution = this.recommendResolution;
        if (buzzResolution != null) {
            loveBuzzData.recommendResolution = buzzResolution.mo225055clone();
        }
        List<String> list4 = this.bonusEnabledBuzz;
        if (list4 != null) {
            loveBuzzData.bonusEnabledBuzz = ValueObject.util_map(list4, new qcj() { // from class: l.t6w
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return LoveBuzzData.m36657a((String) obj);
                }
            });
        }
