...
public class ConversationType extends TEnum {
    ...
    static {
        TEnumJsonAdapter<ConversationType> tEnumJsonAdapter = new TEnumJsonAdapter<ConversationType>() { // from class: com.p1.mobile.putong.core.data.ConversationType.1
            ...
            public ConversationType newTEnum(String str, int i) {
        ...
        tEnumJsonAdapter.addExtJsonValue(greetset, 4);
        tEnumJsonAdapter.addExtJsonValue(svipad, 5);
        tEnumJsonAdapter.addExtJsonValue("quickchat", 6);
        ...
        _ConversationType = Collections.synchronizedMap(new l01());
    }
    ...
    public static ConversationType get(String str) {
        ...
        if (conversationType == null) {
            ...
            conversationType = integer == null ? new ConversationType(str, -1) : new ConversationType(str, integer.intValue());
