...
public class FriendSuggestInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FriendSuggestInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<FriendSuggestInfo>() { // from class: com.p1.mobile.putong.core.data.FriendSuggestInfo.1
        ...
        public int computeAndCacheSize(FriendSuggestInfo friendSuggestInfo) {
            ...
            if (friendSuggestReason != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(3, friendSuggestReason.ordinal());
            }
            FriendSuggestReason friendSuggestReason2 = friendSuggestInfo.reason;
            if (friendSuggestReason2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, friendSuggestReason2, FriendSuggestReason.PROTOBUF_ADAPTER);
            }
            InteractionType interactionType = friendSuggestInfo.interactionType;
            if (interactionType != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, interactionType, InteractionType.PROTOBUF_ADAPTER);
            }
            Relation relation = friendSuggestInfo.relation;
            if (relation != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, relation, Relation.PROTOBUF_ADAPTER);
            }
            String str3 = friendSuggestInfo.roomId;
            if (str3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(7, str3);
            }
            friendSuggestInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FriendSuggestInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    friendSuggestInfo.forceText = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    friendSuggestInfo.text = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 34) {
                    friendSuggestInfo.reason = (FriendSuggestReason) nc5Var.m162488l(FriendSuggestReason.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    friendSuggestInfo.interactionType = (InteractionType) nc5Var.m162488l(InteractionType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 50) {
                    friendSuggestInfo.relation = (Relation) nc5Var.m162488l(Relation.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 58) {
                        if (friendSuggestInfo.reason == null && numValueOf != null) {
                            friendSuggestInfo.reason = (FriendSuggestReason) FriendSuggestReason.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    friendSuggestInfo.roomId = nc5Var.m162495s();
                }
            }
            return friendSuggestInfo;
        }
        ...
        public void serialize(FriendSuggestInfo friendSuggestInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            FriendSuggestReason friendSuggestReason = friendSuggestInfo.reason;
            if (friendSuggestReason != null) {
                codedOutputByteBufferNano.m17305G(3, friendSuggestReason.ordinal());
            }
            FriendSuggestReason friendSuggestReason2 = friendSuggestInfo.reason;
            if (friendSuggestReason2 != null) {
                codedOutputByteBufferNano.m17309K(4, friendSuggestReason2, FriendSuggestReason.PROTOBUF_ADAPTER);
            }
            InteractionType interactionType = friendSuggestInfo.interactionType;
            if (interactionType != null) {
                codedOutputByteBufferNano.m17309K(5, interactionType, InteractionType.PROTOBUF_ADAPTER);
            }
            Relation relation = friendSuggestInfo.relation;
            if (relation != null) {
                codedOutputByteBufferNano.m17309K(6, relation, Relation.PROTOBUF_ADAPTER);
            }
            String str3 = friendSuggestInfo.roomId;
            if (str3 != null) {
    ...
    public FriendSuggestInfo mo225055clone() {
        FriendSuggestInfo friendSuggestInfo = new FriendSuggestInfo();
