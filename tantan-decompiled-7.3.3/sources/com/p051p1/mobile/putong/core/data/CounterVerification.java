...
public class CounterVerification extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CounterVerification> PROTOBUF_ADAPTER = new MessageNanoAdapter<CounterVerification>() { // from class: com.p1.mobile.putong.core.data.CounterVerification.1
        ...
        public int computeAndCacheSize(CounterVerification counterVerification) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, counterVerification.total) + CodedOutputByteBufferNano.m17275b(2, counterVerification.needSync) + CodedOutputByteBufferNano.m17277d(3, counterVerification.latestUpdatedTime) + CodedOutputByteBufferNano.m17277d(4, counterVerification.lastVerifyTime) + CodedOutputByteBufferNano.m17277d(5, counterVerification.nextVerifyTime) + CodedOutputByteBufferNano.m17275b(6, counterVerification.syncAll);
            counterVerification.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CounterVerification parse(nc5 nc5Var) throws IOException {
            CounterVerification counterVerification = new CounterVerification();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    counterVerification.total = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    counterVerification.needSync = nc5Var.m162483g();
                } else if (iM162497u == 25) {
                    counterVerification.latestUpdatedTime = nc5Var.m162484h();
                } else if (iM162497u == 33) {
                    counterVerification.lastVerifyTime = nc5Var.m162484h();
                } else if (iM162497u == 41) {
                    counterVerification.nextVerifyTime = nc5Var.m162484h();
                } else {
                    if (iM162497u != 48) {
                        return counterVerification;
                    }
                    counterVerification.syncAll = nc5Var.m162483g();
                }
            }
        }
        ...
        public void serialize(CounterVerification counterVerification, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, counterVerification.total);
            codedOutputByteBufferNano.m17299A(2, counterVerification.needSync);
            codedOutputByteBufferNano.m17301C(3, counterVerification.latestUpdatedTime);
            codedOutputByteBufferNano.m17301C(4, counterVerification.lastVerifyTime);
            codedOutputByteBufferNano.m17301C(5, counterVerification.nextVerifyTime);
            codedOutputByteBufferNano.m17299A(6, counterVerification.syncAll);
        }
    };
    ...
    public CounterVerification mo225055clone() {
        CounterVerification counterVerification = new CounterVerification();
