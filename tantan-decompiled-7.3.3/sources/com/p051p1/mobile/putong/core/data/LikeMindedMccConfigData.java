...
public class LikeMindedMccConfigData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikeMindedMccConfigData> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikeMindedMccConfigData>() { // from class: com.p1.mobile.putong.core.data.LikeMindedMccConfigData.1
        ...
        public int computeAndCacheSize(LikeMindedMccConfigData likeMindedMccConfigData) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, likeMindedMccConfigData.swipeCount);
            ...
            likeMindedMccConfigData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LikeMindedMccConfigData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    likeMindedMccConfigData.swipeCount = nc5Var.m162486j();
                } else {
                    if (iM162497u != 18) {
                        if (likeMindedMccConfigData.items != null) {
                            break;
                    ...
                    likeMindedMccConfigData.items = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return likeMindedMccConfigData;
        }
        ...
        public void serialize(LikeMindedMccConfigData likeMindedMccConfigData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, likeMindedMccConfigData.swipeCount);
            List<String> list = likeMindedMccConfigData.items;
            if (list != null) {
    ...
    public static /* synthetic */ String m36645a(String str) {
        return str;
    }
    ...
    public LikeMindedMccConfigData mo225055clone() {
        LikeMindedMccConfigData likeMindedMccConfigData = new LikeMindedMccConfigData();
        likeMindedMccConfigData.swipeCount = this.swipeCount;
        List<String> list = this.items;
        if (list != null) {
            likeMindedMccConfigData.items = ValueObject.util_map(list, new qcj() { // from class: l.rfr
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return LikeMindedMccConfigData.m36645a((String) obj);
                }
            });
        }
        return likeMindedMccConfigData;
