...
public class BulkGroupInviteMessages extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BulkGroupInviteMessages> PROTOBUF_ADAPTER = new MessageNanoAdapter<BulkGroupInviteMessages>() { // from class: com.p1.mobile.putong.core.data.BulkGroupInviteMessages.1
        ...
        public int computeAndCacheSize(BulkGroupInviteMessages bulkGroupInviteMessages) {
            ...
            if (message != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, message, Message.PROTOBUF_ADAPTER);
            }
            bulkGroupInviteMessages.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BulkGroupInviteMessages parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    bulkGroupInviteMessages.toUserIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (bulkGroupInviteMessages.toUserIds == null) {
                            bulkGroupInviteMessages.toUserIds = new ArrayList();
                    ...
                    bulkGroupInviteMessages.message = (Message) nc5Var.m162488l(Message.PROTOBUF_ADAPTER);
                }
            }
            return bulkGroupInviteMessages;
        }
        ...
        public void serialize(BulkGroupInviteMessages bulkGroupInviteMessages, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Message message = bulkGroupInviteMessages.message;
            if (message != null) {
                codedOutputByteBufferNano.m17309K(2, message, Message.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public static /* synthetic */ String m36230a(String str) {
        return str;
    }
    ...
    public BulkGroupInviteMessages mo225055clone() {
        BulkGroupInviteMessages bulkGroupInviteMessages = new BulkGroupInviteMessages();
        List<String> list = this.toUserIds;
        if (list != null) {
            bulkGroupInviteMessages.toUserIds = ValueObject.util_map(list, new qcj() { // from class: l.di3
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return BulkGroupInviteMessages.m36230a((String) obj);
                }
            });
        }
        Message message = this.message;
        if (message != null) {
            bulkGroupInviteMessages.message = message.mo225055clone();
        }
        return bulkGroupInviteMessages;
    }
