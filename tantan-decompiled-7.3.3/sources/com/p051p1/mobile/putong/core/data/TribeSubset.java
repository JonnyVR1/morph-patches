...
public class TribeSubset extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TribeSubset> PROTOBUF_ADAPTER = new MessageNanoAdapter<TribeSubset>() { // from class: com.p1.mobile.putong.core.data.TribeSubset.1
        ...
        public int computeAndCacheSize(TribeSubset tribeSubset) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, list, TribeSubsetContent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            tribeSubset.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TribeSubset parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    tribeSubset.groupCategory = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    tribeSubset.mainHead = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    tribeSubset.subHead = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (tribeSubset.groupCategory == null) {
                            tribeSubset.groupCategory = "";
                    ...
                    tribeSubset.subsetContent = (List) nc5Var.m162488l(TribeSubsetContent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return tribeSubset;
        }
        ...
        public void serialize(TribeSubset tribeSubset, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<TribeSubsetContent> list = tribeSubset.subsetContent;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(4, list, TribeSubsetContent.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public TribeSubset mo225055clone() {
        TribeSubset tribeSubset = new TribeSubset();
        ...
        if (list != null) {
            tribeSubset.subsetContent = ValueObject.util_map(list, new qcj() { // from class: l.njj0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((TribeSubsetContent) obj).mo225055clone();
                }
            });
        }
        return tribeSubset;
