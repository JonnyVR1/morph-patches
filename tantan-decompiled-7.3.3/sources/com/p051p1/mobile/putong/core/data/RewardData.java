...
import com.p051p1.mobile.putong.core.data.PrivilegeReward;
...
public class RewardData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<RewardData> PROTOBUF_ADAPTER = new MessageNanoAdapter<RewardData>() { // from class: com.p1.mobile.putong.core.data.RewardData.1
        ...
        public int computeAndCacheSize(RewardData rewardData) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, PrivilegeReward.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            rewardData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public RewardData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                rewardData.items = (List) nc5Var.m162488l(PrivilegeReward.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            return rewardData;
        }
        ...
        public void serialize(RewardData rewardData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<PrivilegeReward> list = rewardData.items;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, PrivilegeReward.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public RewardData mo225055clone() {
        RewardData rewardData = new RewardData();
        List<PrivilegeReward> list = this.items;
        if (list != null) {
            rewardData.items = ValueObject.util_map(list, new qcj() { // from class: l.g8d0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((PrivilegeReward) obj).mo225055clone();
                }
            });
        }
        return rewardData;
