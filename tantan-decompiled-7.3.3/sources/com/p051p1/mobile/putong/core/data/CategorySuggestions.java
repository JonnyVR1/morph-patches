...
public class CategorySuggestions extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CategorySuggestions> PROTOBUF_ADAPTER = new MessageNanoAdapter<CategorySuggestions>() { // from class: com.p1.mobile.putong.core.data.CategorySuggestions.1
        ...
        public int computeAndCacheSize(CategorySuggestions categorySuggestions) {
            ...
            if (map2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, map2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().MAP_ADAPTER());
            }
            ...
            if (list3 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list4 = categorySuggestions.sports;
            if (list4 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(6, list4, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list5 = categorySuggestions.literature;
            if (list5 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(7, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list6 = categorySuggestions.food;
            if (list6 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(8, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list7 = categorySuggestions.places;
            if (list7 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(9, list7, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list8 = categorySuggestions.movies;
            if (list8 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(10, list8, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            categorySuggestions.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CategorySuggestions parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        categorySuggestions.industry = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 18:
                        categorySuggestions.department = (Map) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().MAP_ADAPTER());
                        continue;
                    case 26:
                        categorySuggestions.hometown = (Map) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().MAP_ADAPTER());
                        continue;
                    case 34:
                        categorySuggestions.personality = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 42:
                        categorySuggestions.music = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 50:
                        categorySuggestions.sports = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 58:
                        categorySuggestions.literature = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 66:
                        categorySuggestions.food = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 74:
                        categorySuggestions.places = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        categorySuggestions.movies = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    default:
                        if (categorySuggestions.industry == null) {
                            categorySuggestions.industry = new ArrayList();
        ...
        public void serialize(CategorySuggestions categorySuggestions, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Map<String, List<String>> map2 = categorySuggestions.hometown;
            if (map2 != null) {
                codedOutputByteBufferNano.m17309K(3, map2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER().MAP_ADAPTER());
            }
            List<String> list2 = categorySuggestions.personality;
            if (list2 != null) {
            ...
            List<String> list3 = categorySuggestions.music;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(5, list3, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list4 = categorySuggestions.sports;
            if (list4 != null) {
            ...
            List<String> list5 = categorySuggestions.literature;
            if (list5 != null) {
                codedOutputByteBufferNano.m17309K(7, list5, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list6 = categorySuggestions.food;
            if (list6 != null) {
                codedOutputByteBufferNano.m17309K(8, list6, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list7 = categorySuggestions.places;
            if (list7 != null) {
                codedOutputByteBufferNano.m17309K(9, list7, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list8 = categorySuggestions.movies;
            if (list8 != null) {
                codedOutputByteBufferNano.m17309K(10, list8, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m36239a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: c */
    public static /* synthetic */ String m36241c(String str) {
        return str;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ String m36242d(String str) {
        return str;
    }

    /* JADX INFO: renamed from: f */
    public static /* synthetic */ String m36244f(String str) {
        return str;
    }

    /* JADX INFO: renamed from: k */
    public static /* synthetic */ String m36245k(String str) {
        return str;
    }

    /* JADX INFO: renamed from: l */
    public static /* synthetic */ String m36246l(String str) {
        return str;
    }

    /* JADX INFO: renamed from: m */
    public static /* synthetic */ String m36247m(String str) {
        return str;
    }

    /* JADX INFO: renamed from: n */
    public static /* synthetic */ String m36248n(String str) {
        return str;
    }
    ...
    public static /* synthetic */ String m36249o(String str) {
        return str;
    }

    /* JADX INFO: renamed from: p */
    public static /* synthetic */ String m36250p(String str) {
        return str;
    }

    @Override // com.tantanapp.common.data.ValueObject, com.google.protobuf.nano.MessageNano
    /* JADX INFO: renamed from: clone */
    public CategorySuggestions mo225055clone() {
        CategorySuggestions categorySuggestions = new CategorySuggestions();
        List<String> list = this.industry;
        if (list != null) {
            categorySuggestions.industry = ValueObject.util_map(list, new qcj() { // from class: l.vn4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36239a((String) obj);
                }
            });
        }
        Map<String, List<String>> map = this.department;
        if (map != null) {
            categorySuggestions.department = ValueObject.util_map(map, new qcj() { // from class: l.wn4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ValueObject.util_map((List) obj, new qcj() { // from class: l.sn4
                        @Override // p153l.qcj
                        public final Object call(Object obj2) {
                            return CategorySuggestions.m36248n((String) obj2);
                        }
                    });
                }
            });
        ...
        if (map2 != null) {
            categorySuggestions.hometown = ValueObject.util_map(map2, new qcj() { // from class: l.xn4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ValueObject.util_map((List) obj, new qcj() { // from class: l.un4
                        @Override // p153l.qcj
                        public final Object call(Object obj2) {
                            return CategorySuggestions.m36246l((String) obj2);
                        }
                    });
                }
            });
        ...
        if (list2 != null) {
            categorySuggestions.personality = ValueObject.util_map(list2, new qcj() { // from class: l.yn4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36242d((String) obj);
                }
            });
        }
        List<String> list3 = this.music;
        if (list3 != null) {
            categorySuggestions.music = ValueObject.util_map(list3, new qcj() { // from class: l.zn4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36249o((String) obj);
                }
            });
        }
        List<String> list4 = this.sports;
        if (list4 != null) {
            categorySuggestions.sports = ValueObject.util_map(list4, new qcj() { // from class: l.ao4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36244f((String) obj);
                }
            });
        }
        List<String> list5 = this.literature;
        if (list5 != null) {
            categorySuggestions.literature = ValueObject.util_map(list5, new qcj() { // from class: l.bo4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36250p((String) obj);
                }
            });
        }
        List<String> list6 = this.food;
        if (list6 != null) {
            categorySuggestions.food = ValueObject.util_map(list6, new qcj() { // from class: l.co4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36241c((String) obj);
                }
            });
        }
        List<String> list7 = this.places;
        if (list7 != null) {
            categorySuggestions.places = ValueObject.util_map(list7, new qcj() { // from class: l.do4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36247m((String) obj);
                }
            });
        }
        List<String> list8 = this.movies;
        if (list8 != null) {
            categorySuggestions.movies = ValueObject.util_map(list8, new qcj() { // from class: l.tn4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CategorySuggestions.m36245k((String) obj);
                }
            });
        }
        return categorySuggestions;
