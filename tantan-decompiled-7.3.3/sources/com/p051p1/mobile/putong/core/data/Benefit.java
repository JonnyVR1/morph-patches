...
public class Benefit extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Benefit> PROTOBUF_ADAPTER = new MessageNanoAdapter<Benefit>() { // from class: com.p1.mobile.putong.core.data.Benefit.1
        ...
        public int computeAndCacheSize(Benefit benefit) {
            ...
            int iM17285l = localBenefit != null ? CodedOutputByteBufferNano.m17285l(1, localBenefit, LocalBenefit.PROTOBUF_ADAPTER) : 0;
            benefit.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Benefit parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                benefit.localBenefit = (LocalBenefit) nc5Var.m162488l(LocalBenefit.PROTOBUF_ADAPTER);
            }
            return benefit;
        }
        ...
        public void serialize(Benefit benefit, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (localBenefit != null) {
                codedOutputByteBufferNano.m17309K(1, localBenefit, LocalBenefit.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Benefit mo225055clone() {
        Benefit benefit = new Benefit();
        LocalBenefit localBenefit = this.localBenefit;
        if (localBenefit != null) {
            benefit.localBenefit = localBenefit.mo225055clone();
        }
        return benefit;
    }
