...
public class IdealTypeConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IdealTypeConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<IdealTypeConfig>() { // from class: com.p1.mobile.putong.core.data.IdealTypeConfig.1
        ...
        public int computeAndCacheSize(IdealTypeConfig idealTypeConfig) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, idealTypeConfig.ideal_swipe_guide_dislike_limit) + CodedOutputByteBufferNano.m17281h(2, idealTypeConfig.ideal_swipe_guide_limit) + CodedOutputByteBufferNano.m17281h(3, idealTypeConfig.ideal_chat_guide_not_send_message_limit) + CodedOutputByteBufferNano.m17281h(4, idealTypeConfig.ideal_chat_guide_limit) + CodedOutputByteBufferNano.m17281h(5, idealTypeConfig.ideal_swipe_guide_like_ideal_limit) + CodedOutputByteBufferNano.m17275b(6, idealTypeConfig.enable) + CodedOutputByteBufferNano.m17281h(7, idealTypeConfig.ideal_feedback_show_timeout) + CodedOutputByteBufferNano.m17281h(8, idealTypeConfig.ideal_feedback_scroll_show_timeout) + CodedOutputByteBufferNano.m17281h(9, idealTypeConfig.feedback_limit_one_day_no_ideal) + CodedOutputByteBufferNano.m17281h(10, idealTypeConfig.feedback_limit_one_day_has_ideal);
            idealTypeConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IdealTypeConfig parse(nc5 nc5Var) throws IOException {
            IdealTypeConfig idealTypeConfig = new IdealTypeConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    idealTypeConfig.ideal_swipe_guide_dislike_limit = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    idealTypeConfig.ideal_swipe_guide_limit = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    idealTypeConfig.ideal_chat_guide_not_send_message_limit = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    idealTypeConfig.ideal_chat_guide_limit = nc5Var.m162486j();
                } else if (iM162497u == 40) {
                    idealTypeConfig.ideal_swipe_guide_like_ideal_limit = nc5Var.m162486j();
                } else if (iM162497u == 48) {
                    idealTypeConfig.enable = nc5Var.m162483g();
                } else if (iM162497u == 56) {
                    idealTypeConfig.ideal_feedback_show_timeout = nc5Var.m162486j();
                } else if (iM162497u == 64) {
                    idealTypeConfig.ideal_feedback_scroll_show_timeout = nc5Var.m162486j();
                } else if (iM162497u == 72) {
                    idealTypeConfig.feedback_limit_one_day_no_ideal = nc5Var.m162486j();
                } else {
                    if (iM162497u != 80) {
                        return idealTypeConfig;
                    }
                    idealTypeConfig.feedback_limit_one_day_has_ideal = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(IdealTypeConfig idealTypeConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, idealTypeConfig.ideal_swipe_guide_dislike_limit);
            codedOutputByteBufferNano.m17305G(2, idealTypeConfig.ideal_swipe_guide_limit);
            codedOutputByteBufferNano.m17305G(3, idealTypeConfig.ideal_chat_guide_not_send_message_limit);
            codedOutputByteBufferNano.m17305G(4, idealTypeConfig.ideal_chat_guide_limit);
            codedOutputByteBufferNano.m17305G(5, idealTypeConfig.ideal_swipe_guide_like_ideal_limit);
            codedOutputByteBufferNano.m17299A(6, idealTypeConfig.enable);
            codedOutputByteBufferNano.m17305G(7, idealTypeConfig.ideal_feedback_show_timeout);
            codedOutputByteBufferNano.m17305G(8, idealTypeConfig.ideal_feedback_scroll_show_timeout);
            codedOutputByteBufferNano.m17305G(9, idealTypeConfig.feedback_limit_one_day_no_ideal);
            codedOutputByteBufferNano.m17305G(10, idealTypeConfig.feedback_limit_one_day_has_ideal);
        }
    };
    ...
    public IdealTypeConfig mo225055clone() {
        IdealTypeConfig idealTypeConfig = new IdealTypeConfig();
