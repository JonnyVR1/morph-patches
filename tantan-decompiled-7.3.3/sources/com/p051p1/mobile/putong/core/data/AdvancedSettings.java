...
public class AdvancedSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AdvancedSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<AdvancedSettings>() { // from class: com.p1.mobile.putong.core.data.AdvancedSettings.1
        ...
        public int computeAndCacheSize(AdvancedSettings advancedSettings) {
            String str = advancedSettings.f21084id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            Boolean bool = advancedSettings.online;
            if (bool != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(2, bool.booleanValue());
            }
            Boolean bool2 = advancedSettings.realFace;
            if (bool2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(3, bool2.booleanValue());
            }
            Boolean bool3 = advancedSettings.active;
            if (bool3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(4, bool3.booleanValue());
            }
            Boolean bool4 = advancedSettings.newUser;
            if (bool4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(5, bool4.booleanValue());
            }
            Boolean bool5 = advancedSettings.popular;
            if (bool5 != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(6, bool5.booleanValue());
            }
            List<ProfileZodiac> list = advancedSettings.zodiacs;
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(7, ProfileZodiac.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool6 = advancedSettings.student;
            if (bool6 != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(8, bool6.booleanValue());
            }
            Boolean bool7 = advancedSettings.filterReportUser;
            if (bool7 != null) {
                iM17288o += CodedOutputByteBufferNano.m17275b(9, bool7.booleanValue());
            }
            List<BloodType> list2 = advancedSettings.bloodType;
            if (list2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(10, BloodType.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ProfileZodiac> list3 = advancedSettings.zodiacs;
            if (list3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(11, list3, ProfileZodiac.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<BloodType> list4 = advancedSettings.bloodType;
            if (list4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(12, list4, BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = advancedSettings.intlFriendPurpose;
            if (str2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17288o(13, str2);
            }
            advancedSettings.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AdvancedSettings parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        if (advancedSettings.f21084id == null) {
                            advancedSettings.f21084id = "";
                        }
                        ...
                        break;
                    case 10:
                        advancedSettings.f21084id = nc5Var.m162495s();
                        continue;
                    case 16:
                        advancedSettings.online = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 24:
                        advancedSettings.realFace = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 32:
                        advancedSettings.active = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 40:
                        advancedSettings.newUser = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 48:
                        advancedSettings.popular = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 58:
                        list = (List) nc5Var.m162488l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 64:
                        advancedSettings.student = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case 72:
                        advancedSettings.filterReportUser = Boolean.valueOf(nc5Var.m162483g());
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        list2 = (List) nc5Var.m162488l(OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 90:
                        advancedSettings.zodiacs = (List) nc5Var.m162488l(ProfileZodiac.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case EACTags.FCP_TEMPLATE /* 98 */:
                        advancedSettings.bloodType = (List) nc5Var.m162488l(BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 106:
                        advancedSettings.intlFriendPurpose = nc5Var.m162495s();
                        continue;
                    default:
                        if (advancedSettings.zodiacs == null && list != null) {
                            advancedSettings.zodiacs = ProfileZodiac.oldEnumCovertList(list);
        ...
        public void serialize(AdvancedSettings advancedSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Boolean bool = advancedSettings.online;
            if (bool != null) {
                codedOutputByteBufferNano.m17299A(2, bool.booleanValue());
            }
            Boolean bool2 = advancedSettings.realFace;
            if (bool2 != null) {
            ...
            Boolean bool4 = advancedSettings.newUser;
            if (bool4 != null) {
                codedOutputByteBufferNano.m17299A(5, bool4.booleanValue());
            }
            Boolean bool5 = advancedSettings.popular;
            if (bool5 != null) {
            ...
            List<ProfileZodiac> list = advancedSettings.zodiacs;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(7, ProfileZodiac.covertToOldEnumList(list), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            Boolean bool6 = advancedSettings.student;
            if (bool6 != null) {
            ...
            List<BloodType> list2 = advancedSettings.bloodType;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(10, BloodType.covertToOldEnumList(list2), OldEnumProtobufAdapter.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<ProfileZodiac> list3 = advancedSettings.zodiacs;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(11, list3, ProfileZodiac.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<BloodType> list4 = advancedSettings.bloodType;
            if (list4 != null) {
                codedOutputByteBufferNano.m17309K(12, list4, BloodType.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = advancedSettings.intlFriendPurpose;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(13, str2);
            }
        }
    };
        ...
        public boolean parseField(AdvancedSettings advancedSettings, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 6:
                    ...
                    return true;
                case 7:
                    advancedSettings.f21084id = jsonParser.getValueAsString();
                    return false;
                case 8:
    ...
    public static /* synthetic */ ProfileZodiac m36211a(ProfileZodiac profileZodiac) {
        return profileZodiac;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ BloodType m36212b(BloodType bloodType) {
        return bloodType;
    }
    ...
    public AdvancedSettings mo225055clone() {
        AdvancedSettings advancedSettings = new AdvancedSettings();
        advancedSettings.f21084id = this.f21084id;
        ...
        if (list != null) {
            advancedSettings.zodiacs = ValueObject.util_map(list, new qcj() { // from class: l.x90
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return AdvancedSettings.m36211a((ProfileZodiac) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            advancedSettings.bloodType = ValueObject.util_map(list2, new qcj() { // from class: l.y90
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return AdvancedSettings.m36212b((BloodType) obj);
                }
            });
        }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21084id, advancedSettings.f21084id) && ValueObject.util_equals(this.online, advancedSettings.online) && ValueObject.util_equals(this.realFace, advancedSettings.realFace) && ValueObject.util_equals(this.active, advancedSettings.active) && ValueObject.util_equals(this.newUser, advancedSettings.newUser) && ValueObject.util_equals(this.popular, advancedSettings.popular) && ValueObject.util_equals(this.zodiacs, advancedSettings.zodiacs) && ValueObject.util_equals(this.student, advancedSettings.student) && ValueObject.util_equals(this.filterReportUser, advancedSettings.filterReportUser) && ValueObject.util_equals(this.bloodType, advancedSettings.bloodType) && ValueObject.util_equals(this.intlFriendPurpose, advancedSettings.intlFriendPurpose);
    }
    ...
    public AdvancedSettings subtract(AdvancedSettings advancedSettings) {
        ...
        if (!ValueObject.util_equals(this.f21084id, advancedSettings.f21084id)) {
            advancedSettings2.f21084id = this.f21084id;
        }
