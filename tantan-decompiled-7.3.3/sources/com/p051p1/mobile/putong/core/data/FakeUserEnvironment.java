...
public class FakeUserEnvironment extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FakeUserEnvironment> PROTOBUF_ADAPTER = new MessageNanoAdapter<FakeUserEnvironment>() { // from class: com.p1.mobile.putong.core.data.FakeUserEnvironment.1
        ...
        public int computeAndCacheSize(FakeUserEnvironment fakeUserEnvironment) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, fakeUserEnvironment.female_fake_user_toast_limit) + CodedOutputByteBufferNano.m17281h(2, fakeUserEnvironment.male_fake_user_toast_limit) + CodedOutputByteBufferNano.m17281h(3, fakeUserEnvironment.female_good_user_toast_limit) + CodedOutputByteBufferNano.m17281h(4, fakeUserEnvironment.male_good_user_toast_limit);
            fakeUserEnvironment.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FakeUserEnvironment parse(nc5 nc5Var) throws IOException {
            FakeUserEnvironment fakeUserEnvironment = new FakeUserEnvironment();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    fakeUserEnvironment.female_fake_user_toast_limit = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    fakeUserEnvironment.male_fake_user_toast_limit = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    fakeUserEnvironment.female_good_user_toast_limit = nc5Var.m162486j();
                } else {
                    if (iM162497u != 32) {
                        return fakeUserEnvironment;
                    }
                    fakeUserEnvironment.male_good_user_toast_limit = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(FakeUserEnvironment fakeUserEnvironment, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, fakeUserEnvironment.female_fake_user_toast_limit);
            codedOutputByteBufferNano.m17305G(2, fakeUserEnvironment.male_fake_user_toast_limit);
            codedOutputByteBufferNano.m17305G(3, fakeUserEnvironment.female_good_user_toast_limit);
            codedOutputByteBufferNano.m17305G(4, fakeUserEnvironment.male_good_user_toast_limit);
        }
    };
    ...
    public FakeUserEnvironment mo225055clone() {
        FakeUserEnvironment fakeUserEnvironment = new FakeUserEnvironment();
