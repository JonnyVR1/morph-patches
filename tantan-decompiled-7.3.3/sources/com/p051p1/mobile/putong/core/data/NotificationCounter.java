...
public class NotificationCounter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NotificationCounter> PROTOBUF_ADAPTER = new MessageNanoAdapter<NotificationCounter>() { // from class: com.p1.mobile.putong.core.data.NotificationCounter.1
        ...
        public int computeAndCacheSize(NotificationCounter notificationCounter) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, notificationCounter.unread) + CodedOutputByteBufferNano.m17277d(2, notificationCounter.latestNotificationTime);
            notificationCounter.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NotificationCounter parse(nc5 nc5Var) throws IOException {
            NotificationCounter notificationCounter = new NotificationCounter();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    notificationCounter.unread = nc5Var.m162486j();
                } else {
                    if (iM162497u != 17) {
                        return notificationCounter;
                    }
                    notificationCounter.latestNotificationTime = nc5Var.m162484h();
                }
            }
        }
        ...
        public void serialize(NotificationCounter notificationCounter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, notificationCounter.unread);
            codedOutputByteBufferNano.m17301C(2, notificationCounter.latestNotificationTime);
        }
    };
    ...
    public NotificationCounter mo225055clone() {
        NotificationCounter notificationCounter = new NotificationCounter();
