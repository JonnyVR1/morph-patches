...
public class H5PaymentChannels extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<H5PaymentChannels> PROTOBUF_ADAPTER = new MessageNanoAdapter<H5PaymentChannels>() { // from class: com.p1.mobile.putong.core.data.H5PaymentChannels.1
        ...
        public int computeAndCacheSize(H5PaymentChannels h5PaymentChannels) {
            ...
            h5PaymentChannels.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public H5PaymentChannels parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    h5PaymentChannels.payment = nc5Var.m162495s();
                } else {
                    if (iM162497u != 18) {
                        if (h5PaymentChannels.payment == null) {
                            h5PaymentChannels.payment = "";
                    ...
                    h5PaymentChannels.categories = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return h5PaymentChannels;
        }
    ...
    public static /* synthetic */ String m36578a(String str) {
        return str;
    }
    ...
    public H5PaymentChannels mo225055clone() {
        H5PaymentChannels h5PaymentChannels = new H5PaymentChannels();
        h5PaymentChannels.payment = this.payment;
        List<String> list = this.categories;
        if (list != null) {
            h5PaymentChannels.categories = ValueObject.util_map(list, new qcj() { // from class: l.bxk
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return H5PaymentChannels.m36578a((String) obj);
                }
            });
        }
        return h5PaymentChannels;
