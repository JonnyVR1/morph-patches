...
public class ProfileLikeComment extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ProfileLikeComment> PROTOBUF_ADAPTER = new MessageNanoAdapter<ProfileLikeComment>() { // from class: com.p1.mobile.putong.core.data.ProfileLikeComment.1
        ...
        public int computeAndCacheSize(ProfileLikeComment profileLikeComment) {
            String str = profileLikeComment.f21217id;
            ...
            int iM17277d = iM17288o + CodedOutputByteBufferNano.m17277d(6, profileLikeComment.createdTime);
            ...
            profileLikeComment.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ProfileLikeComment parse(nc5 nc5Var) throws IOException {
            ProfileLikeComment profileLikeComment = new ProfileLikeComment();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (profileLikeComment.f21217id == null) {
                        profileLikeComment.f21217id = "";
                    }
                ...
                if (iM162497u == 10) {
                    profileLikeComment.f21217id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    profileLikeComment.userId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    profileLikeComment.module = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    profileLikeComment.category = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    profileLikeComment.comment = nc5Var.m162495s();
                } else if (iM162497u == 49) {
                    profileLikeComment.createdTime = nc5Var.m162484h();
                } else if (iM162497u == 58) {
                    profileLikeComment.identifier = nc5Var.m162495s();
                } else {
                    if (iM162497u != 66) {
                        if (profileLikeComment.f21217id == null) {
                            profileLikeComment.f21217id = "";
                    ...
                    profileLikeComment.snapshot = nc5Var.m162495s();
                }
            }
            return profileLikeComment;
        }
        ...
        public void serialize(ProfileLikeComment profileLikeComment, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17301C(6, profileLikeComment.createdTime);
            String str6 = profileLikeComment.identifier;
            if (str6 != null) {
        ...
        public boolean parseField(ProfileLikeComment profileLikeComment, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "createdTime":
                    ...
                    return true;
                case "id":
                    profileLikeComment.f21217id = jsonParser.getValueAsString();
                    return false;
                case "category":
    ...
    public ProfileLikeComment mo225055clone() {
        ProfileLikeComment profileLikeComment = new ProfileLikeComment();
        profileLikeComment.f21217id = this.f21217id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21217id, profileLikeComment.f21217id) && ValueObject.util_equals(this.userId, profileLikeComment.userId) && ValueObject.util_equals(this.module, profileLikeComment.module) && ValueObject.util_equals(this.category, profileLikeComment.category) && ValueObject.util_equals(this.identifier, profileLikeComment.identifier) && ValueObject.util_equals(this.snapshot, profileLikeComment.snapshot) && ValueObject.util_equals(this.comment, profileLikeComment.comment) && this.createdTime == profileLikeComment.createdTime;
    }
