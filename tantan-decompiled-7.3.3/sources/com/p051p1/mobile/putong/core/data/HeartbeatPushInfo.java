...
public class HeartbeatPushInfo {
    ...
    public boolean isActiveMsg() {
        return NullChecker.m82486a(this.pushMessage) && !TextUtils.isEmpty(this.pushMessage.triggeredUserId) && TextUtils.equals(this.pushMessage.triggeredUserId, CoreModule.m30929H().userId());
    }
