...
public class UserPrivilege extends DbObject<UserPrivilege> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<UserPrivilege> PROTOBUF_ADAPTER = new MessageNanoAdapter<UserPrivilege>() { // from class: com.p1.mobile.putong.core.data.UserPrivilege.1
        ...
        public int computeAndCacheSize(UserPrivilege userPrivilege) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, userPrivilege._id);
            ...
            if (userPrivilegeContent != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(51, userPrivilegeContent, UserPrivilegeContent.PROTOBUF_ADAPTER);
            }
            userPrivilege.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public UserPrivilege parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    userPrivilege._id = nc5Var.m162487k();
                } else if (iM162497u == 18) {
                    userPrivilege.f56859id = nc5Var.m162495s();
                } else {
                    if (iM162497u != 410) {
                        if (userPrivilege.content != null) {
                            break;
                    ...
                    userPrivilege.content = (UserPrivilegeContent) nc5Var.m162488l(UserPrivilegeContent.PROTOBUF_ADAPTER);
                }
            }
            return userPrivilege;
        }
        ...
        public void serialize(UserPrivilege userPrivilege, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, userPrivilege._id);
            String str = userPrivilege.f56859id;
            if (str != null) {
            ...
            UserPrivilegeContent userPrivilegeContent = userPrivilege.content;
            if (userPrivilegeContent != null) {
                codedOutputByteBufferNano.m17309K(51, userPrivilegeContent, UserPrivilegeContent.PROTOBUF_ADAPTER);
            }
        }
    };
    public static JsonAdapter<UserPrivilege> JSON_ADAPTER = new ObjectJsonAdapter<UserPrivilege>() { // from class: com.p1.mobile.putong.core.data.UserPrivilege.2
        ...
        public boolean parseField(UserPrivilege userPrivilege, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            str.getClass();
            if (str.equals("id")) {
                userPrivilege.f56859id = jsonParser.getValueAsString();
                return false;
            }
    ...
    public static final StringColumn<UserPrivilege> f21267ID = new StringColumn<UserPrivilege>("id_c") { // from class: com.p1.mobile.putong.core.data.UserPrivilege.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(UserPrivilege userPrivilege) {
            return userPrivilege.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(UserPrivilege userPrivilege, String str) {
            userPrivilege.f56859id = str;
        }
    };
    ...
    public static vzf0<UserPrivilege> DB_ADAPTER = new vzf0<UserPrivilege>() { // from class: com.p1.mobile.putong.core.data.UserPrivilege.11
        @Override // p153l.vzf0
        public String CREATE_TABLE(wzh0 wzh0Var) {
            return "CREATE TABLE IF NOT EXISTS " + wzh0Var.f191760d + " (_id INTEGER PRIMARY KEY,id_c TEXT,content_expiredTime_c INTEGER,content_inExperience_c INTEGER,content_remaining_c INTEGER,content_unlimit_c INTEGER,content_beginTime_c INTEGER,content_refreshMaxRemaining_c INTEGER)";
        }
        ...
        public UserPrivilege read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i2 = i + 1;
                userPrivilege.f56859id = cursor.isNull(i2) ? null : cursor.getString(i2);
        ...
        public void write(UserPrivilege userPrivilege, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", userPrivilege.f56859id);
    ...
    public UserPrivilege mo225055clone() {
        UserPrivilege userPrivilege = new UserPrivilege();
        userPrivilege._id = this._id;
        userPrivilege.f56859id = this.f56859id;
        UserPrivilegeContent userPrivilegeContent = this.content;
        if (userPrivilegeContent != null) {
            userPrivilege.content = userPrivilegeContent.mo225055clone();
        }
        return userPrivilege;
    }
