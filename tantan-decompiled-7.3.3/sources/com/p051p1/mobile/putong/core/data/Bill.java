...
public class Bill extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Bill> PROTOBUF_ADAPTER = new MessageNanoAdapter<Bill>() { // from class: com.p1.mobile.putong.core.data.Bill.1
        ...
        public int computeAndCacheSize(Bill bill) {
            ...
            bill.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Bill parse(nc5 nc5Var) throws IOException {
            Bill bill = new Bill();
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        bill.appid = nc5Var.m162495s();
                        continue;
                    case 18:
                        bill.partner = nc5Var.m162495s();
                        continue;
                    case 26:
                        bill.prepay = nc5Var.m162495s();
                        continue;
                    case 34:
                        bill.packageValue = nc5Var.m162495s();
                        continue;
                    case 42:
                        bill.noncestr = nc5Var.m162495s();
                        continue;
                    case 50:
                        bill.timestamp = nc5Var.m162495s();
                        continue;
                    case 58:
                        bill.sign = nc5Var.m162495s();
                        continue;
                    case 66:
                        bill.product = nc5Var.m162495s();
                        continue;
                    case 74:
                        bill.customer = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        bill.info = nc5Var.m162495s();
                        continue;
                    default:
                        if (bill.appid == null) {
                            bill.appid = "";
