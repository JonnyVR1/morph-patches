...
public class AnalysisGuide extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AnalysisGuide> PROTOBUF_ADAPTER = new MessageNanoAdapter<AnalysisGuide>() { // from class: com.p1.mobile.putong.core.data.AnalysisGuide.1
        ...
        public int computeAndCacheSize(AnalysisGuide analysisGuide) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, analysisGuide.isShow) + CodedOutputByteBufferNano.m17275b(2, analysisGuide.used);
            analysisGuide.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AnalysisGuide parse(nc5 nc5Var) throws IOException {
            AnalysisGuide analysisGuide = new AnalysisGuide();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    analysisGuide.isShow = nc5Var.m162483g();
                } else {
                    if (iM162497u != 16) {
                        return analysisGuide;
                    }
                    analysisGuide.used = nc5Var.m162483g();
                }
            }
        }
        ...
        public void serialize(AnalysisGuide analysisGuide, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, analysisGuide.isShow);
            codedOutputByteBufferNano.m17299A(2, analysisGuide.used);
        }
    };
    ...
    public AnalysisGuide mo225055clone() {
        AnalysisGuide analysisGuide = new AnalysisGuide();
