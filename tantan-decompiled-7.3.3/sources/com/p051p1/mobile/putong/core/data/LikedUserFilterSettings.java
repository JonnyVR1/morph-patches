...
public class LikedUserFilterSettings extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikedUserFilterSettings> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikedUserFilterSettings>() { // from class: com.p1.mobile.putong.core.data.LikedUserFilterSettings.1
        ...
        public int computeAndCacheSize(LikedUserFilterSettings likedUserFilterSettings) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, likedUserFilterSettings.distance) + CodedOutputByteBufferNano.m17281h(2, likedUserFilterSettings.minAge) + CodedOutputByteBufferNano.m17281h(3, likedUserFilterSettings.maxAge);
            LikedUserFilter likedUserFilter = likedUserFilterSettings.filter;
            if (likedUserFilter != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(4, likedUserFilter.ordinal());
            }
            LikeFilterSortType likeFilterSortType = likedUserFilterSettings.sort;
            if (likeFilterSortType != null) {
                iM17281h += CodedOutputByteBufferNano.m17281h(5, likeFilterSortType.ordinal());
            }
            LikedUserFilter likedUserFilter2 = likedUserFilterSettings.filter;
            if (likedUserFilter2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(6, likedUserFilter2, LikedUserFilter.PROTOBUF_ADAPTER);
            }
            LikeFilterSortType likeFilterSortType2 = likedUserFilterSettings.sort;
            if (likeFilterSortType2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(7, likeFilterSortType2, LikeFilterSortType.PROTOBUF_ADAPTER);
            }
            likedUserFilterSettings.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LikedUserFilterSettings parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    likedUserFilterSettings.distance = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    likedUserFilterSettings.minAge = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    likedUserFilterSettings.maxAge = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 40) {
                    numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 50) {
                    likedUserFilterSettings.filter = (LikedUserFilter) nc5Var.m162488l(LikedUserFilter.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 58) {
                        if (likedUserFilterSettings.filter == null && numValueOf != null) {
                            likedUserFilterSettings.filter = (LikedUserFilter) LikedUserFilter.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    likedUserFilterSettings.sort = (LikeFilterSortType) nc5Var.m162488l(LikeFilterSortType.PROTOBUF_ADAPTER);
                }
            }
            return likedUserFilterSettings;
        }
        ...
        public void serialize(LikedUserFilterSettings likedUserFilterSettings, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, likedUserFilterSettings.distance);
            codedOutputByteBufferNano.m17305G(2, likedUserFilterSettings.minAge);
            codedOutputByteBufferNano.m17305G(3, likedUserFilterSettings.maxAge);
            LikedUserFilter likedUserFilter = likedUserFilterSettings.filter;
            if (likedUserFilter != null) {
                codedOutputByteBufferNano.m17305G(4, likedUserFilter.ordinal());
            }
            LikeFilterSortType likeFilterSortType = likedUserFilterSettings.sort;
            if (likeFilterSortType != null) {
                codedOutputByteBufferNano.m17305G(5, likeFilterSortType.ordinal());
            }
            LikedUserFilter likedUserFilter2 = likedUserFilterSettings.filter;
            if (likedUserFilter2 != null) {
                codedOutputByteBufferNano.m17309K(6, likedUserFilter2, LikedUserFilter.PROTOBUF_ADAPTER);
            }
            LikeFilterSortType likeFilterSortType2 = likedUserFilterSettings.sort;
            if (likeFilterSortType2 != null) {
                codedOutputByteBufferNano.m17309K(7, likeFilterSortType2, LikeFilterSortType.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public LikedUserFilterSettings mo225055clone() {
        LikedUserFilterSettings likedUserFilterSettings = new LikedUserFilterSettings();
