...
public class TaskAvatarDesc extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<TaskAvatarDesc> PROTOBUF_ADAPTER = new MessageNanoAdapter<TaskAvatarDesc>() { // from class: com.p1.mobile.putong.core.data.TaskAvatarDesc.1
        ...
        public int computeAndCacheSize(TaskAvatarDesc taskAvatarDesc) {
            ...
            taskAvatarDesc.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public TaskAvatarDesc parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    taskAvatarDesc.avatars = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 18) {
                        if (taskAvatarDesc.avatars == null) {
                            taskAvatarDesc.avatars = new ArrayList();
                    ...
                    taskAvatarDesc.text = nc5Var.m162495s();
                }
            }
            return taskAvatarDesc;
        }
    ...
    public static /* synthetic */ String m36874a(String str) {
        return str;
    }
    ...
    public TaskAvatarDesc mo225055clone() {
        TaskAvatarDesc taskAvatarDesc = new TaskAvatarDesc();
        List<String> list = this.avatars;
        if (list != null) {
            taskAvatarDesc.avatars = ValueObject.util_map(list, new qcj() { // from class: l.lni0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return TaskAvatarDesc.m36874a((String) obj);
                }
            });
        }
