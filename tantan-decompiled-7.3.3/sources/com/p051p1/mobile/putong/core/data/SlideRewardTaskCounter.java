...
public class SlideRewardTaskCounter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SlideRewardTaskCounter> PROTOBUF_ADAPTER = new MessageNanoAdapter<SlideRewardTaskCounter>() { // from class: com.p1.mobile.putong.core.data.SlideRewardTaskCounter.1
        ...
        public int computeAndCacheSize(SlideRewardTaskCounter slideRewardTaskCounter) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, slideRewardTaskCounter.total) + CodedOutputByteBufferNano.m17281h(2, slideRewardTaskCounter.reward) + CodedOutputByteBufferNano.m17275b(3, slideRewardTaskCounter.notify) + CodedOutputByteBufferNano.m17281h(4, slideRewardTaskCounter.lotteryChoice);
            slideRewardTaskCounter.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SlideRewardTaskCounter parse(nc5 nc5Var) throws IOException {
            SlideRewardTaskCounter slideRewardTaskCounter = new SlideRewardTaskCounter();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    slideRewardTaskCounter.total = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    slideRewardTaskCounter.reward = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    slideRewardTaskCounter.notify = nc5Var.m162483g();
                } else {
                    if (iM162497u != 32) {
                        return slideRewardTaskCounter;
                    }
                    slideRewardTaskCounter.lotteryChoice = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(SlideRewardTaskCounter slideRewardTaskCounter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, slideRewardTaskCounter.total);
            codedOutputByteBufferNano.m17305G(2, slideRewardTaskCounter.reward);
            codedOutputByteBufferNano.m17299A(3, slideRewardTaskCounter.notify);
            codedOutputByteBufferNano.m17305G(4, slideRewardTaskCounter.lotteryChoice);
        }
    };
    ...
    public SlideRewardTaskCounter mo225055clone() {
        SlideRewardTaskCounter slideRewardTaskCounter = new SlideRewardTaskCounter();
