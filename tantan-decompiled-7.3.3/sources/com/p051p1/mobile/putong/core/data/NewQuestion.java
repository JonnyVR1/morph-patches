...
public class NewQuestion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NewQuestion> PROTOBUF_ADAPTER = new MessageNanoAdapter<NewQuestion>() { // from class: com.p1.mobile.putong.core.data.NewQuestion.1
        ...
        public int computeAndCacheSize(NewQuestion newQuestion) {
            String str = newQuestion.f21197id;
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, newQuestion.index);
            String str5 = newQuestion.roundId;
            if (str5 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(6, str5);
            }
            int iM17275b = iM17281h + CodedOutputByteBufferNano.m17275b(7, newQuestion.fallback);
            newQuestion.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NewQuestion parse(nc5 nc5Var) throws IOException {
            NewQuestion newQuestion = new NewQuestion();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (newQuestion.f21197id == null) {
                        newQuestion.f21197id = "";
                    }
                ...
                if (iM162497u == 10) {
                    newQuestion.f21197id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    newQuestion.actorId = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    newQuestion.receiverId = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    newQuestion.questionId = nc5Var.m162495s();
                } else if (iM162497u == 40) {
                    newQuestion.index = nc5Var.m162486j();
                } else if (iM162497u == 50) {
                    newQuestion.roundId = nc5Var.m162495s();
                } else {
                    if (iM162497u != 56) {
                        if (newQuestion.f21197id == null) {
                            newQuestion.f21197id = "";
                    ...
                    newQuestion.fallback = nc5Var.m162483g();
                }
            }
            return newQuestion;
        }
        ...
        public void serialize(NewQuestion newQuestion, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(5, newQuestion.index);
            String str5 = newQuestion.roundId;
            if (str5 != null) {
                codedOutputByteBufferNano.m17316R(6, str5);
            }
            codedOutputByteBufferNano.m17299A(7, newQuestion.fallback);
        }
    };
        ...
        public boolean parseField(NewQuestion newQuestion, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "actorId":
                    ...
                    return true;
                case "id":
                    newQuestion.f21197id = jsonParser.getValueAsString();
                    return false;
                case "index":
    ...
    public NewQuestion mo225055clone() {
        NewQuestion newQuestion = new NewQuestion();
        newQuestion.f21197id = this.f21197id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21197id, newQuestion.f21197id) && ValueObject.util_equals(this.actorId, newQuestion.actorId) && ValueObject.util_equals(this.receiverId, newQuestion.receiverId) && ValueObject.util_equals(this.questionId, newQuestion.questionId) && this.index == newQuestion.index && ValueObject.util_equals(this.roundId, newQuestion.roundId) && this.fallback == newQuestion.fallback;
    }
