...
public class NextQuestionnaire extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<NextQuestionnaire> PROTOBUF_ADAPTER = new MessageNanoAdapter<NextQuestionnaire>() { // from class: com.p1.mobile.putong.core.data.NextQuestionnaire.1
        ...
        public int computeAndCacheSize(NextQuestionnaire nextQuestionnaire) {
            ...
            if (list != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, list, NextQuestionnaireOptions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            nextQuestionnaire.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public NextQuestionnaire parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    nextQuestionnaire.title = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    nextQuestionnaire.description = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (nextQuestionnaire.title == null) {
                            nextQuestionnaire.title = "";
                    ...
                    nextQuestionnaire.options = (List) nc5Var.m162488l(NextQuestionnaireOptions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return nextQuestionnaire;
        }
        ...
        public void serialize(NextQuestionnaire nextQuestionnaire, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            List<NextQuestionnaireOptions> list = nextQuestionnaire.options;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(3, list, NextQuestionnaireOptions.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public NextQuestionnaire mo225055clone() {
        NextQuestionnaire nextQuestionnaire = new NextQuestionnaire();
        ...
        if (list != null) {
            nextQuestionnaire.options = ValueObject.util_map(list, new qcj() { // from class: l.gr40
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((NextQuestionnaireOptions) obj).mo225055clone();
                }
            });
        }
        return nextQuestionnaire;
