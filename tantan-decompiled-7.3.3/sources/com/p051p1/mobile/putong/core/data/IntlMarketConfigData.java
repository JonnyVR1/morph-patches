...
public class IntlMarketConfigData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlMarketConfigData> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlMarketConfigData>() { // from class: com.p1.mobile.putong.core.data.IntlMarketConfigData.1
        ...
        public int computeAndCacheSize(IntlMarketConfigData intlMarketConfigData) {
            ...
            int iM17285l = intlMarketConfigDataMeta != null ? CodedOutputByteBufferNano.m17285l(1, intlMarketConfigDataMeta, IntlMarketConfigDataMeta.PROTOBUF_ADAPTER) : 0;
            IntlMarketConfigEntrypoint intlMarketConfigEntrypoint = intlMarketConfigData.entrypoint;
            if (intlMarketConfigEntrypoint != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, intlMarketConfigEntrypoint, IntlMarketConfigEntrypoint.PROTOBUF_ADAPTER);
            }
            IntlMarketSummaryData intlMarketSummaryData = intlMarketConfigData.regular_summary;
            if (intlMarketSummaryData != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, intlMarketSummaryData, IntlMarketSummaryData.PROTOBUF_ADAPTER);
            }
            IntlMarketStickerData intlMarketStickerData = intlMarketConfigData.regular_sticker;
            if (intlMarketStickerData != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(4, intlMarketStickerData, IntlMarketStickerData.PROTOBUF_ADAPTER);
            }
            IntlMarketSummaryData intlMarketSummaryData2 = intlMarketConfigData.quiz_summary;
            if (intlMarketSummaryData2 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(5, intlMarketSummaryData2, IntlMarketSummaryData.PROTOBUF_ADAPTER);
            }
            IntlMarketQuestionData intlMarketQuestionData = intlMarketConfigData.quiz_question;
            if (intlMarketQuestionData != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(6, intlMarketQuestionData, IntlMarketQuestionData.PROTOBUF_ADAPTER);
            }
            intlMarketConfigData.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlMarketConfigData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    intlMarketConfigData.meta = (IntlMarketConfigDataMeta) nc5Var.m162488l(IntlMarketConfigDataMeta.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    intlMarketConfigData.entrypoint = (IntlMarketConfigEntrypoint) nc5Var.m162488l(IntlMarketConfigEntrypoint.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    intlMarketConfigData.regular_summary = (IntlMarketSummaryData) nc5Var.m162488l(IntlMarketSummaryData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    intlMarketConfigData.regular_sticker = (IntlMarketStickerData) nc5Var.m162488l(IntlMarketStickerData.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    intlMarketConfigData.quiz_summary = (IntlMarketSummaryData) nc5Var.m162488l(IntlMarketSummaryData.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 50) {
                        if (intlMarketConfigData.meta == null) {
                            intlMarketConfigData.meta = IntlMarketConfigDataMeta.new_();
                    ...
                    intlMarketConfigData.quiz_question = (IntlMarketQuestionData) nc5Var.m162488l(IntlMarketQuestionData.PROTOBUF_ADAPTER);
                }
            }
            return intlMarketConfigData;
        }
        ...
        public void serialize(IntlMarketConfigData intlMarketConfigData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (intlMarketConfigDataMeta != null) {
                codedOutputByteBufferNano.m17309K(1, intlMarketConfigDataMeta, IntlMarketConfigDataMeta.PROTOBUF_ADAPTER);
            }
            IntlMarketConfigEntrypoint intlMarketConfigEntrypoint = intlMarketConfigData.entrypoint;
            if (intlMarketConfigEntrypoint != null) {
                codedOutputByteBufferNano.m17309K(2, intlMarketConfigEntrypoint, IntlMarketConfigEntrypoint.PROTOBUF_ADAPTER);
            }
            IntlMarketSummaryData intlMarketSummaryData = intlMarketConfigData.regular_summary;
            if (intlMarketSummaryData != null) {
                codedOutputByteBufferNano.m17309K(3, intlMarketSummaryData, IntlMarketSummaryData.PROTOBUF_ADAPTER);
            }
            IntlMarketStickerData intlMarketStickerData = intlMarketConfigData.regular_sticker;
            if (intlMarketStickerData != null) {
                codedOutputByteBufferNano.m17309K(4, intlMarketStickerData, IntlMarketStickerData.PROTOBUF_ADAPTER);
            }
            IntlMarketSummaryData intlMarketSummaryData2 = intlMarketConfigData.quiz_summary;
            if (intlMarketSummaryData2 != null) {
                codedOutputByteBufferNano.m17309K(5, intlMarketSummaryData2, IntlMarketSummaryData.PROTOBUF_ADAPTER);
            }
            IntlMarketQuestionData intlMarketQuestionData = intlMarketConfigData.quiz_question;
            if (intlMarketQuestionData != null) {
                codedOutputByteBufferNano.m17309K(6, intlMarketQuestionData, IntlMarketQuestionData.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public IntlMarketConfigData mo225055clone() {
        IntlMarketConfigData intlMarketConfigData = new IntlMarketConfigData();
        IntlMarketConfigDataMeta intlMarketConfigDataMeta = this.meta;
        if (intlMarketConfigDataMeta != null) {
            intlMarketConfigData.meta = intlMarketConfigDataMeta.mo225055clone();
        }
        IntlMarketConfigEntrypoint intlMarketConfigEntrypoint = this.entrypoint;
        if (intlMarketConfigEntrypoint != null) {
            intlMarketConfigData.entrypoint = intlMarketConfigEntrypoint.mo225055clone();
        }
        IntlMarketSummaryData intlMarketSummaryData = this.regular_summary;
        if (intlMarketSummaryData != null) {
            intlMarketConfigData.regular_summary = intlMarketSummaryData.mo225055clone();
        }
        IntlMarketStickerData intlMarketStickerData = this.regular_sticker;
        if (intlMarketStickerData != null) {
            intlMarketConfigData.regular_sticker = intlMarketStickerData.mo225055clone();
        }
        IntlMarketSummaryData intlMarketSummaryData2 = this.quiz_summary;
        if (intlMarketSummaryData2 != null) {
            intlMarketConfigData.quiz_summary = intlMarketSummaryData2.mo225055clone();
        }
        IntlMarketQuestionData intlMarketQuestionData = this.quiz_question;
        if (intlMarketQuestionData != null) {
            intlMarketConfigData.quiz_question = intlMarketQuestionData.mo225055clone();
        }
        return intlMarketConfigData;
    }
