...
import com.p051p1.mobile.putong.core.data.CoreLiveVoiceRoomInProfile;
...
public class CoreLiveVoiceRoomInProfile extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreLiveVoiceRoomInProfile> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreLiveVoiceRoomInProfile>() { // from class: com.p1.mobile.putong.core.data.CoreLiveVoiceRoomInProfile.1
        ...
        public int computeAndCacheSize(CoreLiveVoiceRoomInProfile coreLiveVoiceRoomInProfile) {
            ...
            int iM17275b = iM17288o + CodedOutputByteBufferNano.m17275b(3, coreLiveVoiceRoomInProfile.isPersonal);
            ...
            int iM17275b2 = iM17275b + CodedOutputByteBufferNano.m17275b(6, coreLiveVoiceRoomInProfile.needBuild);
            String str4 = coreLiveVoiceRoomInProfile.voiceLiveId;
            if (str4 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(7, str4);
            }
            String str5 = coreLiveVoiceRoomInProfile.voiceRoomId;
            if (str5 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(8, str5);
            }
            String str6 = coreLiveVoiceRoomInProfile.anchorId;
            if (str6 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(9, str6);
            }
            String str7 = coreLiveVoiceRoomInProfile.background;
            if (str7 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(10, str7);
            }
            String str8 = coreLiveVoiceRoomInProfile.topicId;
            if (str8 != null) {
                iM17275b2 += CodedOutputByteBufferNano.m17288o(11, str8);
            }
            coreLiveVoiceRoomInProfile.cachedSize = iM17275b2;
            return iM17275b2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreLiveVoiceRoomInProfile parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        coreLiveVoiceRoomInProfile.title = nc5Var.m162495s();
                        continue;
                    case 18:
                        coreLiveVoiceRoomInProfile.subTitle = nc5Var.m162495s();
                        continue;
                    case 24:
                        coreLiveVoiceRoomInProfile.isPersonal = nc5Var.m162483g();
                        continue;
                    case 34:
                        coreLiveVoiceRoomInProfile.membersText = nc5Var.m162495s();
                        continue;
                    case 42:
                        coreLiveVoiceRoomInProfile.userAvatars = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 48:
                        coreLiveVoiceRoomInProfile.needBuild = nc5Var.m162483g();
                        continue;
                    case 58:
                        coreLiveVoiceRoomInProfile.voiceLiveId = nc5Var.m162495s();
                        continue;
                    case 66:
                        coreLiveVoiceRoomInProfile.voiceRoomId = nc5Var.m162495s();
                        continue;
                    case 74:
                        coreLiveVoiceRoomInProfile.anchorId = nc5Var.m162495s();
                        continue;
                    case EACTags.COMMAND_TO_PERFORM /* 82 */:
                        coreLiveVoiceRoomInProfile.background = nc5Var.m162495s();
                        continue;
                    case 90:
                        coreLiveVoiceRoomInProfile.topicId = nc5Var.m162495s();
                        continue;
                    default:
                        if (coreLiveVoiceRoomInProfile.title == null) {
                            coreLiveVoiceRoomInProfile.title = "";
        ...
        public void serialize(CoreLiveVoiceRoomInProfile coreLiveVoiceRoomInProfile, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(3, coreLiveVoiceRoomInProfile.isPersonal);
            String str3 = coreLiveVoiceRoomInProfile.membersText;
            if (str3 != null) {
            ...
            codedOutputByteBufferNano.m17299A(6, coreLiveVoiceRoomInProfile.needBuild);
            String str4 = coreLiveVoiceRoomInProfile.voiceLiveId;
            if (str4 != null) {
    ...
    public static /* synthetic */ String m36486a(String str) {
        return str;
    }
    ...
    public CoreLiveVoiceRoomInProfile mo225055clone() {
        CoreLiveVoiceRoomInProfile coreLiveVoiceRoomInProfile = new CoreLiveVoiceRoomInProfile();
        ...
        if (list != null) {
            coreLiveVoiceRoomInProfile.userAvatars = ValueObject.util_map(list, new qcj() { // from class: l.sl9
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CoreLiveVoiceRoomInProfile.m36486a((String) obj);
                }
            });
        }
