...
public class OOFQuestion extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OOFQuestion> PROTOBUF_ADAPTER = new MessageNanoAdapter<OOFQuestion>() { // from class: com.p1.mobile.putong.core.data.OOFQuestion.1
        ...
        public int computeAndCacheSize(OOFQuestion oOFQuestion) {
            ...
            oOFQuestion.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OOFQuestion parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    oOFQuestion.questionText = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    oOFQuestion.questionID = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (oOFQuestion.questionText == null) {
                            oOFQuestion.questionText = "";
                    ...
                    oOFQuestion.userIds = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return oOFQuestion;
        }
    ...
    public static /* synthetic */ String m36737a(String str) {
        return str;
    }
    ...
    public OOFQuestion mo225055clone() {
        OOFQuestion oOFQuestion = new OOFQuestion();
        oOFQuestion.questionText = this.questionText;
        oOFQuestion.questionID = this.questionID;
        List<String> list = this.userIds;
        if (list != null) {
            oOFQuestion.userIds = ValueObject.util_map(list, new qcj() { // from class: l.k850
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return OOFQuestion.m36737a((String) obj);
                }
            });
        }
        return oOFQuestion;
