...
import com.p051p1.mobile.putong.core.data.SeeTrialStatus;
...
public class SeeTrialStatus extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SeeTrialStatus> PROTOBUF_ADAPTER = new MessageNanoAdapter<SeeTrialStatus>() { // from class: com.p1.mobile.putong.core.data.SeeTrialStatus.1
        ...
        public int computeAndCacheSize(SeeTrialStatus seeTrialStatus) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER()) : 0;
            String str = seeTrialStatus.status;
            if (str != null) {
                iM17285l += CodedOutputByteBufferNano.m17288o(2, str);
            }
            int iM17283j = iM17285l + CodedOutputByteBufferNano.m17283j(3, seeTrialStatus.startAt) + CodedOutputByteBufferNano.m17283j(4, seeTrialStatus.expireAt);
            seeTrialStatus.cachedSize = iM17283j;
            return iM17283j;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SeeTrialStatus parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    seeTrialStatus.seeUsers = (List) nc5Var.m162488l(ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    seeTrialStatus.status = nc5Var.m162495s();
                } else if (iM162497u == 24) {
                    seeTrialStatus.startAt = nc5Var.m162487k();
                } else {
                    if (iM162497u != 32) {
                        if (seeTrialStatus.seeUsers == null) {
                            seeTrialStatus.seeUsers = new ArrayList();
                    ...
                    seeTrialStatus.expireAt = nc5Var.m162487k();
                }
            }
            return seeTrialStatus;
        }
        ...
        public void serialize(SeeTrialStatus seeTrialStatus, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<Long> list = seeTrialStatus.seeUsers;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, ProtobufAdapter.LONG_BOXED_ADAPTER.ARRAY_ADAPTER());
            }
            String str = seeTrialStatus.status;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(2, str);
            }
            codedOutputByteBufferNano.m17307I(3, seeTrialStatus.startAt);
            codedOutputByteBufferNano.m17307I(4, seeTrialStatus.expireAt);
        }
    };
    ...
    public static /* synthetic */ Long m36835a(Long l2) {
        return l2;
    }
    ...
    public SeeTrialStatus mo225055clone() {
        SeeTrialStatus seeTrialStatus = new SeeTrialStatus();
        List<Long> list = this.seeUsers;
        if (list != null) {
            seeTrialStatus.seeUsers = ValueObject.util_map(list, new qcj() { // from class: l.uje0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return SeeTrialStatus.m36835a((Long) obj);
                }
            });
        }
