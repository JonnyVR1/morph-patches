...
public class ChatPunishment extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatPunishment> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatPunishment>() { // from class: com.p1.mobile.putong.core.data.ChatPunishment.1
        ...
        public int computeAndCacheSize(ChatPunishment chatPunishment) {
            ...
            int iM17285l = chatSendMessage != null ? CodedOutputByteBufferNano.m17285l(1, chatSendMessage, ChatSendMessage.PROTOBUF_ADAPTER) : 0;
            SendRedPacket sendRedPacket = chatPunishment.sendRedPacket;
            if (sendRedPacket != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, sendRedPacket, SendRedPacket.PROTOBUF_ADAPTER);
            }
            chatPunishment.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatPunishment parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    chatPunishment.sendMessage = (ChatSendMessage) nc5Var.m162488l(ChatSendMessage.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (chatPunishment.sendMessage == null) {
                            chatPunishment.sendMessage = ChatSendMessage.new_();
                    ...
                    chatPunishment.sendRedPacket = (SendRedPacket) nc5Var.m162488l(SendRedPacket.PROTOBUF_ADAPTER);
                }
            }
            return chatPunishment;
        }
        ...
        public void serialize(ChatPunishment chatPunishment, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (chatSendMessage != null) {
                codedOutputByteBufferNano.m17309K(1, chatSendMessage, ChatSendMessage.PROTOBUF_ADAPTER);
            }
            SendRedPacket sendRedPacket = chatPunishment.sendRedPacket;
            if (sendRedPacket != null) {
                codedOutputByteBufferNano.m17309K(2, sendRedPacket, SendRedPacket.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public ChatPunishment mo225055clone() {
        ChatPunishment chatPunishment = new ChatPunishment();
        ChatSendMessage chatSendMessage = this.sendMessage;
        if (chatSendMessage != null) {
            chatPunishment.sendMessage = chatSendMessage.mo225055clone();
        }
        SendRedPacket sendRedPacket = this.sendRedPacket;
        if (sendRedPacket != null) {
            chatPunishment.sendRedPacket = sendRedPacket.mo225055clone();
        }
        return chatPunishment;
    }
