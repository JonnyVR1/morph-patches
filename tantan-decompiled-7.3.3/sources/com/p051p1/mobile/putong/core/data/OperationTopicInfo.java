    ...
    public static ProtobufAdapter<OperationTopicInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<OperationTopicInfo>() { // from class: com.p1.mobile.putong.core.data.OperationTopicInfo.1
        ...
        public int computeAndCacheSize(OperationTopicInfo operationTopicInfo) {
            ...
            if (operationCoverPicture != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, operationCoverPicture, OperationCoverPicture.PROTOBUF_ADAPTER);
            }
            ...
            operationTopicInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OperationTopicInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    operationTopicInfo.operationId = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    operationTopicInfo.coverPicture = (OperationCoverPicture) nc5Var.m162488l(OperationCoverPicture.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    operationTopicInfo.title = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    operationTopicInfo.subtitle = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (operationTopicInfo.operationId == null) {
                            operationTopicInfo.operationId = "";
                    ...
                    operationTopicInfo.url = nc5Var.m162495s();
                }
            }
            return operationTopicInfo;
        }
        ...
        public void serialize(OperationTopicInfo operationTopicInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            OperationCoverPicture operationCoverPicture = operationTopicInfo.coverPicture;
            if (operationCoverPicture != null) {
                codedOutputByteBufferNano.m17309K(2, operationCoverPicture, OperationCoverPicture.PROTOBUF_ADAPTER);
            }
            String str2 = operationTopicInfo.title;
            if (str2 != null) {
