...
public class IceBreakingQA extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IceBreakingQA> PROTOBUF_ADAPTER = new MessageNanoAdapter<IceBreakingQA>() { // from class: com.p1.mobile.putong.core.data.IceBreakingQA.1
        ...
        public int computeAndCacheSize(IceBreakingQA iceBreakingQA) {
            ...
            iceBreakingQA.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IceBreakingQA parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    iceBreakingQA.state = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    iceBreakingQA.title = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    iceBreakingQA.answer = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    iceBreakingQA.originUserID = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (iceBreakingQA.state == null) {
                            iceBreakingQA.state = "";
                    ...
                    iceBreakingQA.refMsgID = nc5Var.m162495s();
                }
            }
            return iceBreakingQA;
        }
    ...
    public IceBreakingQA mo225055clone() {
        IceBreakingQA iceBreakingQA = new IceBreakingQA();
