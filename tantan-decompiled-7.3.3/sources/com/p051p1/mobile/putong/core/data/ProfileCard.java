...
public class ProfileCard extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ProfileCard> PROTOBUF_ADAPTER = new MessageNanoAdapter<ProfileCard>() { // from class: com.p1.mobile.putong.core.data.ProfileCard.1
        ...
        public int computeAndCacheSize(ProfileCard profileCard) {
            ...
            profileCard.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ProfileCard parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    profileCard.title = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    profileCard.subTitle = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    profileCard.buttonText = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    profileCard.url = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (profileCard.title == null) {
                            profileCard.title = "";
                    ...
                    profileCard.eventlog = nc5Var.m162495s();
                }
            }
            return profileCard;
        }
    ...
    public ProfileCard mo225055clone() {
        ProfileCard profileCard = new ProfileCard();
