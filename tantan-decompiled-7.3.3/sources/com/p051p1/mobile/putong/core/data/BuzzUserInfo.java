...
public class BuzzUserInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<BuzzUserInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<BuzzUserInfo>() { // from class: com.p1.mobile.putong.core.data.BuzzUserInfo.1
        ...
        public int computeAndCacheSize(BuzzUserInfo buzzUserInfo) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, buzzUserInfo.age);
            ...
            int iM17281h2 = iM17281h + CodedOutputByteBufferNano.m17281h(4, buzzUserInfo.popLevel);
            String str3 = buzzUserInfo.modStatus;
            if (str3 != null) {
                iM17281h2 += CodedOutputByteBufferNano.m17288o(5, str3);
            }
            int iM17275b = iM17281h2 + CodedOutputByteBufferNano.m17275b(6, buzzUserInfo.vipStatus) + CodedOutputByteBufferNano.m17275b(7, buzzUserInfo.svipStatus) + CodedOutputByteBufferNano.m17275b(8, buzzUserInfo.seeStatus);
            buzzUserInfo.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public BuzzUserInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    buzzUserInfo.age = nc5Var.m162486j();
                } else if (iM162497u == 18) {
                    buzzUserInfo.gender = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    buzzUserInfo.lookingForGender = nc5Var.m162495s();
                } else if (iM162497u == 32) {
                    buzzUserInfo.popLevel = nc5Var.m162486j();
                } else if (iM162497u == 42) {
                    buzzUserInfo.modStatus = nc5Var.m162495s();
                } else if (iM162497u == 48) {
                    buzzUserInfo.vipStatus = nc5Var.m162483g();
                } else if (iM162497u == 56) {
                    buzzUserInfo.svipStatus = nc5Var.m162483g();
                } else {
                    if (iM162497u != 64) {
                        if (buzzUserInfo.gender == null) {
                            buzzUserInfo.gender = "";
                    ...
                    buzzUserInfo.seeStatus = nc5Var.m162483g();
                }
            }
            return buzzUserInfo;
        }
        ...
        public void serialize(BuzzUserInfo buzzUserInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, buzzUserInfo.age);
            String str = buzzUserInfo.gender;
            if (str != null) {
            ...
            codedOutputByteBufferNano.m17305G(4, buzzUserInfo.popLevel);
            String str3 = buzzUserInfo.modStatus;
            if (str3 != null) {
                codedOutputByteBufferNano.m17316R(5, str3);
            }
            codedOutputByteBufferNano.m17299A(6, buzzUserInfo.vipStatus);
            codedOutputByteBufferNano.m17299A(7, buzzUserInfo.svipStatus);
            codedOutputByteBufferNano.m17299A(8, buzzUserInfo.seeStatus);
        }
    };
    ...
    public BuzzUserInfo mo225055clone() {
        BuzzUserInfo buzzUserInfo = new BuzzUserInfo();
