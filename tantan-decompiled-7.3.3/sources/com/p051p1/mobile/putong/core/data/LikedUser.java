...
public class LikedUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LikedUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<LikedUser>() { // from class: com.p1.mobile.putong.core.data.LikedUser.1
        ...
        public int computeAndCacheSize(LikedUser likedUser) {
            String str = likedUser.f21174id;
            int iM17288o = str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0;
            RelationshipStatus relationshipStatus = likedUser.status;
            if (relationshipStatus != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(2, relationshipStatus.ordinal());
            }
            RelationshipStatus relationshipStatus2 = likedUser.otherStatus;
            if (relationshipStatus2 != null) {
                iM17288o += CodedOutputByteBufferNano.m17281h(3, relationshipStatus2.ordinal());
            }
            RelationshipStatus relationshipStatus3 = likedUser.status;
            if (relationshipStatus3 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, relationshipStatus3, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            RelationshipStatus relationshipStatus4 = likedUser.otherStatus;
            if (relationshipStatus4 != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(5, relationshipStatus4, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            RelationshipExt relationshipExt = likedUser.relationshipExt;
            if (relationshipExt != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(6, relationshipExt, RelationshipExt.PROTOBUF_ADAPTER);
            }
            likedUser.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LikedUser parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    likedUser.f21174id = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    numValueOf = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 24) {
                    numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                } else if (iM162497u == 34) {
                    likedUser.status = (RelationshipStatus) nc5Var.m162488l(RelationshipStatus.PROTOBUF_ADAPTER);
                } else if (iM162497u == 42) {
                    likedUser.otherStatus = (RelationshipStatus) nc5Var.m162488l(RelationshipStatus.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 50) {
                        if (likedUser.status == null && numValueOf != null) {
                            likedUser.status = (RelationshipStatus) RelationshipStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
                    ...
                    likedUser.relationshipExt = (RelationshipExt) nc5Var.m162488l(RelationshipExt.PROTOBUF_ADAPTER);
                }
            }
            return likedUser;
        }
        ...
        public void serialize(LikedUser likedUser, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            RelationshipStatus relationshipStatus = likedUser.status;
            if (relationshipStatus != null) {
                codedOutputByteBufferNano.m17305G(2, relationshipStatus.ordinal());
            }
            RelationshipStatus relationshipStatus2 = likedUser.otherStatus;
            if (relationshipStatus2 != null) {
                codedOutputByteBufferNano.m17305G(3, relationshipStatus2.ordinal());
            }
            RelationshipStatus relationshipStatus3 = likedUser.status;
            if (relationshipStatus3 != null) {
                codedOutputByteBufferNano.m17309K(4, relationshipStatus3, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            RelationshipStatus relationshipStatus4 = likedUser.otherStatus;
            if (relationshipStatus4 != null) {
                codedOutputByteBufferNano.m17309K(5, relationshipStatus4, RelationshipStatus.PROTOBUF_ADAPTER);
            }
            RelationshipExt relationshipExt = likedUser.relationshipExt;
            if (relationshipExt != null) {
                codedOutputByteBufferNano.m17309K(6, relationshipExt, RelationshipExt.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(LikedUser likedUser, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "status":
                    ...
                    return true;
                case "id":
                    likedUser.f21174id = jsonParser.getValueAsString();
                    return false;
                default:
                    return false;
            }
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21174id, likedUser.f21174id) && ValueObject.util_equals(this.status, likedUser.status) && ValueObject.util_equals(this.otherStatus, likedUser.otherStatus) && ValueObject.util_equals(this.relationshipExt, likedUser.relationshipExt);
    }
