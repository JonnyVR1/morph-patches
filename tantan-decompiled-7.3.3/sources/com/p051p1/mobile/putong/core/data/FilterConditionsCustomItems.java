...
public class FilterConditionsCustomItems extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<FilterConditionsCustomItems> PROTOBUF_ADAPTER = new MessageNanoAdapter<FilterConditionsCustomItems>() { // from class: com.p1.mobile.putong.core.data.FilterConditionsCustomItems.1
        ...
        public int computeAndCacheSize(FilterConditionsCustomItems filterConditionsCustomItems) {
            ...
            int iM17285l = list != null ? CodedOutputByteBufferNano.m17285l(1, list, FilterConditionsStatusItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER()) : 0;
            ...
            if (list3 != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(3, list3, FilterConditionsStatusItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            filterConditionsCustomItems.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public FilterConditionsCustomItems parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    filterConditionsCustomItems.status = (List) nc5Var.m162488l(FilterConditionsStatusItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    filterConditionsCustomItems.selectedInterest = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 26) {
                        if (filterConditionsCustomItems.status == null) {
                            filterConditionsCustomItems.status = new ArrayList();
                    ...
                    filterConditionsCustomItems.feature = (List) nc5Var.m162488l(FilterConditionsStatusItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return filterConditionsCustomItems;
        }
        ...
        public void serialize(FilterConditionsCustomItems filterConditionsCustomItems, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            List<FilterConditionsStatusItem> list = filterConditionsCustomItems.status;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(1, list, FilterConditionsStatusItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            List<String> list2 = filterConditionsCustomItems.selectedInterest;
            if (list2 != null) {
            ...
            List<FilterConditionsStatusItem> list3 = filterConditionsCustomItems.feature;
            if (list3 != null) {
                codedOutputByteBufferNano.m17309K(3, list3, FilterConditionsStatusItem.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ String m36535c(String str) {
        return str;
    }
    ...
    public FilterConditionsCustomItems mo225055clone() {
        FilterConditionsCustomItems filterConditionsCustomItems = new FilterConditionsCustomItems();
        List<FilterConditionsStatusItem> list = this.status;
        if (list != null) {
            filterConditionsCustomItems.status = ValueObject.util_map(list, new qcj() { // from class: l.pli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FilterConditionsStatusItem) obj).mo225055clone();
                }
            });
        }
        List<FilterConditionsStatusItem> list2 = this.feature;
        if (list2 != null) {
            filterConditionsCustomItems.feature = ValueObject.util_map(list2, new qcj() { // from class: l.qli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((FilterConditionsStatusItem) obj).mo225055clone();
                }
        ...
        if (list3 != null) {
            filterConditionsCustomItems.selectedInterest = ValueObject.util_map(list3, new qcj() { // from class: l.rli
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return FilterConditionsCustomItems.m36535c((String) obj);
                }
            });
        }
        return filterConditionsCustomItems;
