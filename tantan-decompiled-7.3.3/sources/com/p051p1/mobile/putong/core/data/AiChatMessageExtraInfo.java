...
public class AiChatMessageExtraInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<AiChatMessageExtraInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<AiChatMessageExtraInfo>() { // from class: com.p1.mobile.putong.core.data.AiChatMessageExtraInfo.1
        ...
        public int computeAndCacheSize(AiChatMessageExtraInfo aiChatMessageExtraInfo) {
            ...
            if (aIMessageStatus != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(2, aIMessageStatus, AIMessageStatus.PROTOBUF_ADAPTER);
            }
            AIMessageFeedback aIMessageFeedback = aiChatMessageExtraInfo.feedback;
            if (aIMessageFeedback != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, aIMessageFeedback, AIMessageFeedback.PROTOBUF_ADAPTER);
            }
            ...
            aiChatMessageExtraInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public AiChatMessageExtraInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    aiChatMessageExtraInfo.content = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    aiChatMessageExtraInfo.status = (AIMessageStatus) nc5Var.m162488l(AIMessageStatus.PROTOBUF_ADAPTER);
                } else if (iM162497u == 26) {
                    aiChatMessageExtraInfo.feedback = (AIMessageFeedback) nc5Var.m162488l(AIMessageFeedback.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    aiChatMessageExtraInfo.response_uuid = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (aiChatMessageExtraInfo.content == null) {
                            aiChatMessageExtraInfo.content = "";
                    ...
                    aiChatMessageExtraInfo.scene = nc5Var.m162495s();
                }
            }
            return aiChatMessageExtraInfo;
        }
        ...
        public void serialize(AiChatMessageExtraInfo aiChatMessageExtraInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            AIMessageStatus aIMessageStatus = aiChatMessageExtraInfo.status;
            if (aIMessageStatus != null) {
                codedOutputByteBufferNano.m17309K(2, aIMessageStatus, AIMessageStatus.PROTOBUF_ADAPTER);
            }
            AIMessageFeedback aIMessageFeedback = aiChatMessageExtraInfo.feedback;
            if (aIMessageFeedback != null) {
                codedOutputByteBufferNano.m17309K(3, aIMessageFeedback, AIMessageFeedback.PROTOBUF_ADAPTER);
            }
            String str2 = aiChatMessageExtraInfo.response_uuid;
            if (str2 != null) {
    ...
    public AiChatMessageExtraInfo mo225055clone() {
        AiChatMessageExtraInfo aiChatMessageExtraInfo = new AiChatMessageExtraInfo();
