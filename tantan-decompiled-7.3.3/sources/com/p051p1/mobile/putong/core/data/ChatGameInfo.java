...
public class ChatGameInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatGameInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatGameInfo>() { // from class: com.p1.mobile.putong.core.data.ChatGameInfo.1
        ...
        public int computeAndCacheSize(ChatGameInfo chatGameInfo) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17275b(2, chatGameInfo.enable);
            ...
            chatGameInfo.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatGameInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    chatGameInfo.name = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    chatGameInfo.enable = nc5Var.m162483g();
                } else if (iM162497u == 26) {
                    chatGameInfo.link = nc5Var.m162495s();
                } else {
                    if (iM162497u != 34) {
                        if (chatGameInfo.name == null) {
                            chatGameInfo.name = "";
                    ...
                    chatGameInfo.icon = nc5Var.m162495s();
                }
            }
            return chatGameInfo;
        }
        ...
        public void serialize(ChatGameInfo chatGameInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(2, chatGameInfo.enable);
            String str2 = chatGameInfo.link;
            if (str2 != null) {
    ...
    public ChatGameInfo mo225055clone() {
        ChatGameInfo chatGameInfo = new ChatGameInfo();
