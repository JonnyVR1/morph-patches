...
public class LogoutCounter extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LogoutCounter> PROTOBUF_ADAPTER = new MessageNanoAdapter<LogoutCounter>() { // from class: com.p1.mobile.putong.core.data.LogoutCounter.1
        ...
        public int computeAndCacheSize(LogoutCounter logoutCounter) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, logoutCounter.liked) + CodedOutputByteBufferNano.m17281h(2, logoutCounter.matches) + CodedOutputByteBufferNano.m17281h(3, logoutCounter.moments) + CodedOutputByteBufferNano.m17281h(4, logoutCounter.momentLiked) + CodedOutputByteBufferNano.m17281h(5, logoutCounter.followers);
            logoutCounter.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LogoutCounter parse(nc5 nc5Var) throws IOException {
            LogoutCounter logoutCounter = new LogoutCounter();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    logoutCounter.liked = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    logoutCounter.matches = nc5Var.m162486j();
                } else if (iM162497u == 24) {
                    logoutCounter.moments = nc5Var.m162486j();
                } else if (iM162497u == 32) {
                    logoutCounter.momentLiked = nc5Var.m162486j();
                } else {
                    if (iM162497u != 40) {
                        return logoutCounter;
                    }
                    logoutCounter.followers = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(LogoutCounter logoutCounter, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, logoutCounter.liked);
            codedOutputByteBufferNano.m17305G(2, logoutCounter.matches);
            codedOutputByteBufferNano.m17305G(3, logoutCounter.moments);
            codedOutputByteBufferNano.m17305G(4, logoutCounter.momentLiked);
            codedOutputByteBufferNano.m17305G(5, logoutCounter.followers);
        }
    };
    ...
    public LogoutCounter mo225055clone() {
        LogoutCounter logoutCounter = new LogoutCounter();
