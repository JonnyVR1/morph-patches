...
import com.p051p1.mobile.putong.core.data.MomentTag;
import com.p051p1.mobile.putong.core.data.TopicMomentIdBox;
import com.p051p1.mobile.putong.core.data.VideoBullet;
...
public class CoreMomentInfo extends CopyObject<CoreMomentInfo> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CoreMomentInfo> PROTOBUF_ADAPTER = new MessageNanoAdapter<CoreMomentInfo>() { // from class: com.p1.mobile.putong.core.data.CoreMomentInfo.1
        ...
        public int computeAndCacheSize(CoreMomentInfo coreMomentInfo) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, coreMomentInfo._id);
            String str = coreMomentInfo.f56856id;
            if (str != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(2, str);
            }
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(51, coreMomentInfo.localCreatedSession) + CodedOutputByteBufferNano.m17275b(52, coreMomentInfo.localInFeed) + CodedOutputByteBufferNano.m17275b(53, coreMomentInfo.localInUserFeed);
            String str2 = coreMomentInfo.value;
            if (str2 != null) {
                iM17281h += CodedOutputByteBufferNano.m17288o(54, str2);
            }
            int iM17277d = iM17281h + CodedOutputByteBufferNano.m17277d(55, coreMomentInfo.createdTime);
            ...
            if (list != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(57, list, Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17275b = iM17277d + CodedOutputByteBufferNano.m17275b(58, coreMomentInfo.haveLiked);
            ...
            if (coreMomentType != null) {
                iM17275b += CodedOutputByteBufferNano.m17281h(60, coreMomentType.ordinal());
            }
            CoreMomentType coreMomentType2 = coreMomentInfo.momentType;
            if (coreMomentType2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(61, coreMomentType2, CoreMomentType.PROTOBUF_ADAPTER);
            }
            List<VideoBullet> list2 = coreMomentInfo.videoBullets;
            if (list2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(62, list2, VideoBullet.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = coreMomentInfo.musicId;
            if (str4 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(63, str4);
            }
            MomentCard momentCard = coreMomentInfo.momentCard;
            if (momentCard != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(64, momentCard, MomentCard.PROTOBUF_ADAPTER);
            }
            String str5 = coreMomentInfo.sourceType;
            if (str5 != null) {
                iM17275b += CodedOutputByteBufferNano.m17288o(65, str5);
            }
            coreMomentInfo.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CoreMomentInfo parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        coreMomentInfo._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        coreMomentInfo.f56856id = nc5Var.m162495s();
                        continue;
                    case HttpStatus.REQUEST_TIMEOUT_408 /* 408 */:
                        coreMomentInfo.localCreatedSession = nc5Var.m162486j();
                        continue;
                    case HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE_416 /* 416 */:
                        coreMomentInfo.localInFeed = nc5Var.m162483g();
                        continue;
                    case HttpStatus.FAILED_DEPENDENCY_424 /* 424 */:
                        coreMomentInfo.localInUserFeed = nc5Var.m162483g();
                        continue;
                    case 434:
                        coreMomentInfo.value = nc5Var.m162495s();
                        continue;
                    case 441:
                        coreMomentInfo.createdTime = nc5Var.m162484h();
                        continue;
                    case 450:
                        coreMomentInfo.owner = nc5Var.m162495s();
                        continue;
                    case 458:
                        coreMomentInfo.media = (List) nc5Var.m162488l(Media.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 464:
                        coreMomentInfo.haveLiked = nc5Var.m162483g();
                        continue;
                    case 474:
                        coreMomentInfo.location = (MessageLocation) nc5Var.m162488l(MessageLocation.PROTOBUF_ADAPTER);
                        continue;
                    case 480:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 490:
                        coreMomentInfo.momentType = (CoreMomentType) nc5Var.m162488l(CoreMomentType.PROTOBUF_ADAPTER);
                        continue;
                    case 498:
                        coreMomentInfo.videoBullets = (List) nc5Var.m162488l(VideoBullet.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 506:
                        coreMomentInfo.musicId = nc5Var.m162495s();
                        continue;
                    case 514:
                        coreMomentInfo.momentCard = (MomentCard) nc5Var.m162488l(MomentCard.PROTOBUF_ADAPTER);
                        continue;
                    case 522:
                        coreMomentInfo.sourceType = nc5Var.m162495s();
                        continue;
                    default:
                        if (coreMomentInfo.momentType == null && numValueOf != null) {
                            coreMomentInfo.momentType = (CoreMomentType) CoreMomentType.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(CoreMomentInfo coreMomentInfo, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, coreMomentInfo._id);
            String str = coreMomentInfo.f56856id;
            if (str != null) {
                codedOutputByteBufferNano.m17316R(2, str);
            }
            codedOutputByteBufferNano.m17305G(51, coreMomentInfo.localCreatedSession);
            codedOutputByteBufferNano.m17299A(52, coreMomentInfo.localInFeed);
            codedOutputByteBufferNano.m17299A(53, coreMomentInfo.localInUserFeed);
            String str2 = coreMomentInfo.value;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(54, str2);
            }
            codedOutputByteBufferNano.m17301C(55, coreMomentInfo.createdTime);
            String str3 = coreMomentInfo.owner;
            if (str3 != null) {
            ...
            codedOutputByteBufferNano.m17299A(58, coreMomentInfo.haveLiked);
            MessageLocation messageLocation = coreMomentInfo.location;
            if (messageLocation != null) {
            ...
            CoreMomentType coreMomentType = coreMomentInfo.momentType;
            if (coreMomentType != null) {
                codedOutputByteBufferNano.m17305G(60, coreMomentType.ordinal());
            }
            CoreMomentType coreMomentType2 = coreMomentInfo.momentType;
            if (coreMomentType2 != null) {
                codedOutputByteBufferNano.m17309K(61, coreMomentType2, CoreMomentType.PROTOBUF_ADAPTER);
            }
            List<VideoBullet> list2 = coreMomentInfo.videoBullets;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(62, list2, VideoBullet.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            String str4 = coreMomentInfo.musicId;
            if (str4 != null) {
                codedOutputByteBufferNano.m17316R(63, str4);
            }
            MomentCard momentCard = coreMomentInfo.momentCard;
            if (momentCard != null) {
                codedOutputByteBufferNano.m17309K(64, momentCard, MomentCard.PROTOBUF_ADAPTER);
            }
            String str5 = coreMomentInfo.sourceType;
            if (str5 != null) {
        ...
        public boolean parseField(CoreMomentInfo coreMomentInfo, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 5:
                    ...
                    return true;
                case 6:
                    coreMomentInfo.f56856id = jsonParser.getValueAsString();
                    return false;
                case 7:
    ...
    public CoreMomentInfo mo225055clone() {
        CoreMomentInfo coreMomentInfo = new CoreMomentInfo();
        coreMomentInfo._id = this._id;
        coreMomentInfo.f56856id = this.f56856id;
        ...
        if (list != null) {
            coreMomentInfo.media = ValueObject.util_map(list, new qcj() { // from class: l.p0a
                @Override // p153l.qcj
        ...
        if (messageLocation != null) {
            coreMomentInfo.location = messageLocation.mo225055clone();
        }
        ...
        if (partialIdList != null) {
            coreMomentInfo.likes = partialIdList.mo225055clone();
        }
        PartialIdList partialIdList2 = this.messages;
        if (partialIdList2 != null) {
            coreMomentInfo.messages = partialIdList2.mo225055clone();
        }
        List<TopicMomentIdBox> list2 = this.topics;
        if (list2 != null) {
            coreMomentInfo.topics = ValueObject.util_map(list2, new qcj() { // from class: l.q0a
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list3 != null) {
            coreMomentInfo.tags = ValueObject.util_map(list3, new qcj() { // from class: l.r0a
                @Override // p153l.qcj
                public final Object call(Object obj) {
        ...
        if (list4 != null) {
            coreMomentInfo.videoBullets = ValueObject.util_map(list4, new qcj() { // from class: l.s0a
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ((VideoBullet) obj).mo225055clone();
                }
            });
        }
        ...
        if (momentCard != null) {
            coreMomentInfo.momentCard = momentCard.mo225055clone();
        }
