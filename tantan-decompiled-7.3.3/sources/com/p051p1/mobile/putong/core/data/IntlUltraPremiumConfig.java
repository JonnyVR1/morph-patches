...
public class IntlUltraPremiumConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<IntlUltraPremiumConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<IntlUltraPremiumConfig>() { // from class: com.p1.mobile.putong.core.data.IntlUltraPremiumConfig.1
        ...
        public int computeAndCacheSize(IntlUltraPremiumConfig intlUltraPremiumConfig) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, intlUltraPremiumConfig.androidEnable) + CodedOutputByteBufferNano.m17281h(2, intlUltraPremiumConfig.intl_instant_match_tips_swipe_num);
            intlUltraPremiumConfig.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public IntlUltraPremiumConfig parse(nc5 nc5Var) throws IOException {
            IntlUltraPremiumConfig intlUltraPremiumConfig = new IntlUltraPremiumConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    intlUltraPremiumConfig.androidEnable = nc5Var.m162483g();
                } else {
                    if (iM162497u != 16) {
                        return intlUltraPremiumConfig;
                    }
                    intlUltraPremiumConfig.intl_instant_match_tips_swipe_num = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(IntlUltraPremiumConfig intlUltraPremiumConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, intlUltraPremiumConfig.androidEnable);
            codedOutputByteBufferNano.m17305G(2, intlUltraPremiumConfig.intl_instant_match_tips_swipe_num);
        }
    };
    ...
    public IntlUltraPremiumConfig mo225055clone() {
        IntlUltraPremiumConfig intlUltraPremiumConfig = new IntlUltraPremiumConfig();
