...
public class MessageTopic extends BaseData implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MessageTopic> PROTOBUF_ADAPTER = new MessageNanoAdapter<MessageTopic>() { // from class: com.p1.mobile.putong.core.data.MessageTopic.1
        ...
        public int computeAndCacheSize(MessageTopic messageTopic) {
            String str = messageTopic.f21190id;
            ...
            if (messageTopicMomentInfo != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(3, messageTopicMomentInfo, MessageTopicMomentInfo.PROTOBUF_ADAPTER);
            }
            ...
            messageTopic.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MessageTopic parse(nc5 nc5Var) throws IOException {
            MessageTopic messageTopic = new MessageTopic();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (messageTopic.f21190id == null) {
                        messageTopic.f21190id = "";
                    }
                ...
                if (iM162497u == 10) {
                    messageTopic.f21190id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    messageTopic.type = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    messageTopic.moment = (MessageTopicMomentInfo) nc5Var.m162488l(MessageTopicMomentInfo.PROTOBUF_ADAPTER);
                } else if (iM162497u == 34) {
                    messageTopic.text = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (messageTopic.f21190id == null) {
                            messageTopic.f21190id = "";
                    ...
                    messageTopic.replyButtonText = nc5Var.m162495s();
                }
            }
            return messageTopic;
        }
        ...
        public void serialize(MessageTopic messageTopic, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            MessageTopicMomentInfo messageTopicMomentInfo = messageTopic.moment;
            if (messageTopicMomentInfo != null) {
                codedOutputByteBufferNano.m17309K(3, messageTopicMomentInfo, MessageTopicMomentInfo.PROTOBUF_ADAPTER);
            }
            String str3 = messageTopic.text;
            if (str3 != null) {
        ...
        public boolean parseField(MessageTopic messageTopic, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "moment":
                    ...
                    return true;
                case "id":
                    messageTopic.f21190id = jsonParser.getValueAsString();
                    return false;
                case "text":
    ...
    public MessageTopic mo225055clone() {
        MessageTopic messageTopic = new MessageTopic();
        messageTopic.f21190id = this.f21190id;
        messageTopic.type = this.type;
        MessageTopicMomentInfo messageTopicMomentInfo = this.moment;
        if (messageTopicMomentInfo != null) {
            messageTopic.moment = messageTopicMomentInfo.mo225055clone();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this == obj && ValueObject.util_equals(this.f21190id, messageTopic.f21190id) && ValueObject.util_equals(this.type, messageTopic.type) && ValueObject.util_equals(this.moment, messageTopic.moment) && ValueObject.util_equals(this.text, messageTopic.text) && ValueObject.util_equals(this.replyButtonText, messageTopic.replyButtonText);
    }
