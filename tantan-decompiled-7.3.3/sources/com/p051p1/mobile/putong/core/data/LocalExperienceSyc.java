...
import com.p051p1.mobile.putong.core.data.LocalExperienceSyc;
...
public class LocalExperienceSyc extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<LocalExperienceSyc> PROTOBUF_ADAPTER = new MessageNanoAdapter<LocalExperienceSyc>() { // from class: com.p1.mobile.putong.core.data.LocalExperienceSyc.1
        ...
        public int computeAndCacheSize(LocalExperienceSyc localExperienceSyc) {
            ...
            localExperienceSyc.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public LocalExperienceSyc parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                localExperienceSyc.groups = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            return localExperienceSyc;
        }
    ...
    public static /* synthetic */ String m36654a(String str) {
        return str;
    }
    ...
    public LocalExperienceSyc mo225055clone() {
        LocalExperienceSyc localExperienceSyc = new LocalExperienceSyc();
        List<String> list = this.groups;
        if (list != null) {
            localExperienceSyc.groups = ValueObject.util_map(list, new qcj() { // from class: l.guv
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return LocalExperienceSyc.m36654a((String) obj);
                }
            });
        }
        return localExperienceSyc;
