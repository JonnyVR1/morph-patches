...
public class StartSpotLightData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<StartSpotLightData> PROTOBUF_ADAPTER = new MessageNanoAdapter<StartSpotLightData>() { // from class: com.p1.mobile.putong.core.data.StartSpotLightData.1
        ...
        public int computeAndCacheSize(StartSpotLightData startSpotLightData) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17275b(2, startSpotLightData.active);
            ...
            int iM17283j = iM17288o + CodedOutputByteBufferNano.m17283j(5, startSpotLightData.duration) + CodedOutputByteBufferNano.m17283j(6, startSpotLightData.startTimeInt) + CodedOutputByteBufferNano.m17283j(7, startSpotLightData.endTimeInt);
            String str4 = startSpotLightData.boostType;
            if (str4 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(8, str4);
            }
            int iM17281h = iM17283j + CodedOutputByteBufferNano.m17281h(9, startSpotLightData.available) + CodedOutputByteBufferNano.m17281h(10, startSpotLightData.remain);
            startSpotLightData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public StartSpotLightData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 10:
                        startSpotLightData.userId = nc5Var.m162495s();
                        continue;
                    case 16:
                        startSpotLightData.active = nc5Var.m162483g();
                        continue;
                    case 26:
                        startSpotLightData.startTime = nc5Var.m162495s();
                        continue;
                    case 34:
                        startSpotLightData.endTime = nc5Var.m162495s();
                        continue;
                    case 40:
                        startSpotLightData.duration = nc5Var.m162487k();
                        continue;
                    case 48:
                        startSpotLightData.startTimeInt = nc5Var.m162487k();
                        continue;
                    case 56:
                        startSpotLightData.endTimeInt = nc5Var.m162487k();
                        continue;
                    case 66:
                        startSpotLightData.boostType = nc5Var.m162495s();
                        continue;
                    case 72:
                        startSpotLightData.available = nc5Var.m162486j();
                        continue;
                    case 80:
                        startSpotLightData.remain = nc5Var.m162486j();
                        continue;
                    default:
                        if (startSpotLightData.userId == null) {
                            startSpotLightData.userId = "";
        ...
        public void serialize(StartSpotLightData startSpotLightData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17299A(2, startSpotLightData.active);
            String str2 = startSpotLightData.startTime;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17307I(5, startSpotLightData.duration);
            codedOutputByteBufferNano.m17307I(6, startSpotLightData.startTimeInt);
            codedOutputByteBufferNano.m17307I(7, startSpotLightData.endTimeInt);
            String str4 = startSpotLightData.boostType;
            if (str4 != null) {
                codedOutputByteBufferNano.m17316R(8, str4);
            }
            codedOutputByteBufferNano.m17305G(9, startSpotLightData.available);
            codedOutputByteBufferNano.m17305G(10, startSpotLightData.remain);
        }
    };
    ...
    public StartSpotLightData mo225055clone() {
        StartSpotLightData startSpotLightData = new StartSpotLightData();
