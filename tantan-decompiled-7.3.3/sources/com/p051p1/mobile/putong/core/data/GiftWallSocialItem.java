...
public class GiftWallSocialItem extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GiftWallSocialItem> PROTOBUF_ADAPTER = new MessageNanoAdapter<GiftWallSocialItem>() { // from class: com.p1.mobile.putong.core.data.GiftWallSocialItem.1
        ...
        public int computeAndCacheSize(GiftWallSocialItem giftWallSocialItem) {
            int iM17275b = CodedOutputByteBufferNano.m17275b(1, giftWallSocialItem.canChat);
            ...
            if (gender != null) {
                iM17275b += CodedOutputByteBufferNano.m17281h(6, gender.ordinal());
            }
            Gender gender2 = giftWallSocialItem.gender;
            if (gender2 != null) {
                iM17275b += CodedOutputByteBufferNano.m17285l(7, gender2, Gender.PROTOBUF_ADAPTER);
            }
            giftWallSocialItem.cachedSize = iM17275b;
            return iM17275b;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GiftWallSocialItem parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    giftWallSocialItem.canChat = nc5Var.m162483g();
                } else if (iM162497u == 18) {
                    giftWallSocialItem.giftAmount = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    giftWallSocialItem.userAvatar = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    giftWallSocialItem.userID = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    giftWallSocialItem.userName = nc5Var.m162495s();
                    ...
                    giftWallSocialItem.gender = (Gender) nc5Var.m162488l(Gender.PROTOBUF_ADAPTER);
                }
            }
            return giftWallSocialItem;
        }
        ...
        public void serialize(GiftWallSocialItem giftWallSocialItem, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17299A(1, giftWallSocialItem.canChat);
            String str = giftWallSocialItem.giftAmount;
            if (str != null) {
            ...
            Gender gender = giftWallSocialItem.gender;
            if (gender != null) {
                codedOutputByteBufferNano.m17305G(6, gender.ordinal());
            }
            Gender gender2 = giftWallSocialItem.gender;
            if (gender2 != null) {
                codedOutputByteBufferNano.m17309K(7, gender2, Gender.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public GiftWallSocialItem mo225055clone() {
        GiftWallSocialItem giftWallSocialItem = new GiftWallSocialItem();
