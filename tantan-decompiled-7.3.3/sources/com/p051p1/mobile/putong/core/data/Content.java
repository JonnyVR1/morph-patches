...
public class Content extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Content> PROTOBUF_ADAPTER = new MessageNanoAdapter<Content>() { // from class: com.p1.mobile.putong.core.data.Content.1
        ...
        public int computeAndCacheSize(Content content) {
            ...
            int iM17285l = selection != null ? CodedOutputByteBufferNano.m17285l(1, selection, Selection.PROTOBUF_ADAPTER) : 0;
            FillBlank fillBlank = content.fillBlank;
            if (fillBlank != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, fillBlank, FillBlank.PROTOBUF_ADAPTER);
            }
            content.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Content parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    content.selection = (Selection) nc5Var.m162488l(Selection.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 18) {
                        if (content.selection == null) {
                            content.selection = Selection.new_();
                    ...
                    content.fillBlank = (FillBlank) nc5Var.m162488l(FillBlank.PROTOBUF_ADAPTER);
                }
            }
            return content;
        }
        ...
        public void serialize(Content content, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            Selection selection = content.selection;
            if (selection != null) {
                codedOutputByteBufferNano.m17309K(1, selection, Selection.PROTOBUF_ADAPTER);
            }
            FillBlank fillBlank = content.fillBlank;
            if (fillBlank != null) {
                codedOutputByteBufferNano.m17309K(2, fillBlank, FillBlank.PROTOBUF_ADAPTER);
            }
        }
    };
    ...
    public Content mo225055clone() {
        Content content = new Content();
        Selection selection = this.selection;
        if (selection != null) {
            content.selection = selection.mo225055clone();
        }
        FillBlank fillBlank = this.fillBlank;
        if (fillBlank != null) {
            content.fillBlank = fillBlank.mo225055clone();
        }
        return content;
    }
