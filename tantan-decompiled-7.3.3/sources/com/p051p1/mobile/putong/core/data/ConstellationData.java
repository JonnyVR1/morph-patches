...
public class ConstellationData extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ConstellationData> PROTOBUF_ADAPTER = new MessageNanoAdapter<ConstellationData>() { // from class: com.p1.mobile.putong.core.data.ConstellationData.1
        ...
        public int computeAndCacheSize(ConstellationData constellationData) {
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(6, constellationData.nameColor);
            constellationData.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ConstellationData parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    constellationData.name = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    constellationData.keywords = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    constellationData.meaning = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    constellationData.image = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    constellationData.cardBg = nc5Var.m162495s();
                } else {
                    if (iM162497u != 48) {
                        if (constellationData.name == null) {
                            constellationData.name = "";
                    ...
                    constellationData.nameColor = nc5Var.m162486j();
                }
            }
            return constellationData;
        }
        ...
        public void serialize(ConstellationData constellationData, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17305G(6, constellationData.nameColor);
        }
    };
    ...
    public ConstellationData mo225055clone() {
        ConstellationData constellationData = new ConstellationData();
