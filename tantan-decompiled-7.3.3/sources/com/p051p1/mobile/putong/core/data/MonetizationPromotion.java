...
public class MonetizationPromotion extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<MonetizationPromotion> PROTOBUF_ADAPTER = new MessageNanoAdapter<MonetizationPromotion>() { // from class: com.p1.mobile.putong.core.data.MonetizationPromotion.1
        ...
        public int computeAndCacheSize(MonetizationPromotion monetizationPromotion) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, monetizationPromotion._id);
            String str = monetizationPromotion.f56859id;
            if (str != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(2, str);
            }
            List<String> list = monetizationPromotion.coupons;
            if (list != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(51, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            int iM17277d = iM17283j + CodedOutputByteBufferNano.m17277d(52, monetizationPromotion.beginTime) + CodedOutputByteBufferNano.m17277d(53, monetizationPromotion.endTime);
            List<String> list2 = monetizationPromotion.userCouponIDs;
            if (list2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(54, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = monetizationPromotion.state;
            if (str2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17288o(55, str2);
            }
            monetizationPromotion.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public MonetizationPromotion parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 8) {
                    monetizationPromotion._id = nc5Var.m162487k();
                } else if (iM162497u == 18) {
                    monetizationPromotion.f56859id = nc5Var.m162495s();
                } else if (iM162497u == 410) {
                    monetizationPromotion.coupons = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 417) {
                    monetizationPromotion.beginTime = nc5Var.m162484h();
                } else if (iM162497u == 425) {
                    monetizationPromotion.endTime = nc5Var.m162484h();
                } else if (iM162497u == 434) {
                    monetizationPromotion.userCouponIDs = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else {
                    if (iM162497u != 442) {
                        if (monetizationPromotion.coupons == null) {
                            monetizationPromotion.coupons = new ArrayList();
                    ...
                    monetizationPromotion.state = nc5Var.m162495s();
                }
            }
            return monetizationPromotion;
        }
        ...
        public void serialize(MonetizationPromotion monetizationPromotion, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, monetizationPromotion._id);
            String str = monetizationPromotion.f56859id;
            if (str != null) {
            ...
            List<String> list = monetizationPromotion.coupons;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(51, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            codedOutputByteBufferNano.m17301C(52, monetizationPromotion.beginTime);
            codedOutputByteBufferNano.m17301C(53, monetizationPromotion.endTime);
            List<String> list2 = monetizationPromotion.userCouponIDs;
            if (list2 != null) {
                codedOutputByteBufferNano.m17309K(54, list2, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str2 = monetizationPromotion.state;
            if (str2 != null) {
                codedOutputByteBufferNano.m17316R(55, str2);
            }
        }
    };
        ...
        public boolean parseField(MonetizationPromotion monetizationPromotion, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "userCouponIDs":
                    ...
                    return true;
                case "id":
                    monetizationPromotion.f56859id = jsonParser.getValueAsString();
                    return false;
                case "state":
    ...
    public static final StringColumn<MonetizationPromotion> f21193ID = new StringColumn<MonetizationPromotion>("id_c") { // from class: com.p1.mobile.putong.core.data.MonetizationPromotion.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(MonetizationPromotion monetizationPromotion) {
            return monetizationPromotion.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(MonetizationPromotion monetizationPromotion, String str) {
            monetizationPromotion.f56859id = str;
        }
    };
    ...
    public static vzf0<MonetizationPromotion> DB_ADAPTER = new vzf0<MonetizationPromotion>() { // from class: com.p1.mobile.putong.core.data.MonetizationPromotion.10
        @Override // p153l.vzf0
        public String CREATE_TABLE(wzh0 wzh0Var) {
            return "CREATE TABLE IF NOT EXISTS " + wzh0Var.f191760d + " (_id INTEGER PRIMARY KEY,id_c TEXT,coupons_c BLOB,beginTime_c REAL,endTime_c REAL,userCouponIDs_c BLOB,state_c TEXT)";
        }
        ...
        public MonetizationPromotion read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i2 = i + 1;
                String string = null;
                monetizationPromotion.f56859id = cursor.isNull(i2) ? null : cursor.getString(i2);
                int i3 = i + 2;
        ...
        public void write(MonetizationPromotion monetizationPromotion, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", monetizationPromotion.f56859id);
    ...
    public static /* synthetic */ String m36700a(String str) {
        return str;
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ String m36701b(String str) {
        return str;
    }
    ...
    public MonetizationPromotion mo225055clone() {
        MonetizationPromotion monetizationPromotion = new MonetizationPromotion();
        monetizationPromotion._id = this._id;
        monetizationPromotion.f56859id = this.f56859id;
        List<String> list = this.coupons;
        if (list != null) {
            monetizationPromotion.coupons = ValueObject.util_map(list, new qcj() { // from class: l.x510
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return MonetizationPromotion.m36700a((String) obj);
                }
            });
        }
        ...
        if (list2 != null) {
            monetizationPromotion.userCouponIDs = ValueObject.util_map(list2, new qcj() { // from class: l.y510
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return MonetizationPromotion.m36701b((String) obj);
                }
            });
        }
