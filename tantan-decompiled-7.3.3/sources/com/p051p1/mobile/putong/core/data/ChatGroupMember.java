...
public class ChatGroupMember extends DbObject<ChatGroupMember> implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<ChatGroupMember> PROTOBUF_ADAPTER = new MessageNanoAdapter<ChatGroupMember>() { // from class: com.p1.mobile.putong.core.data.ChatGroupMember.1
        ...
        public int computeAndCacheSize(ChatGroupMember chatGroupMember) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, chatGroupMember._id);
            String str = chatGroupMember.f56859id;
            if (str != null) {
            ...
            if (list != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(57, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str8 = chatGroupMember.searchCategory;
            if (str8 != null) {
                iM17283j += CodedOutputByteBufferNano.m17288o(58, str8);
            }
            ChatGroupMemberStatus chatGroupMemberStatus = chatGroupMember.status;
            if (chatGroupMemberStatus != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(59, chatGroupMemberStatus.ordinal());
            }
            int iM17277d = iM17283j + CodedOutputByteBufferNano.m17277d(60, chatGroupMember.joinTime) + CodedOutputByteBufferNano.m17277d(61, chatGroupMember.createdTime) + CodedOutputByteBufferNano.m17277d(62, chatGroupMember.updatedTime);
            ChatGroupSilence chatGroupSilence = chatGroupMember.silence;
            if (chatGroupSilence != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(63, chatGroupSilence, ChatGroupSilence.PROTOBUF_ADAPTER);
            }
            ChatGroupSilence chatGroupSilence2 = chatGroupMember.operationSilence;
            if (chatGroupSilence2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(64, chatGroupSilence2, ChatGroupSilence.PROTOBUF_ADAPTER);
            }
            Gender gender = chatGroupMember.gender;
            if (gender != null) {
                iM17277d += CodedOutputByteBufferNano.m17281h(65, gender.ordinal());
            }
            ChatGroupMemberStatus chatGroupMemberStatus2 = chatGroupMember.status;
            if (chatGroupMemberStatus2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(66, chatGroupMemberStatus2, ChatGroupMemberStatus.PROTOBUF_ADAPTER);
            }
            Gender gender2 = chatGroupMember.gender;
            if (gender2 != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(67, gender2, Gender.PROTOBUF_ADAPTER);
            }
            InModeration inModeration = chatGroupMember.inModeration;
            if (inModeration != null) {
                iM17277d += CodedOutputByteBufferNano.m17285l(68, inModeration, InModeration.PROTOBUF_ADAPTER);
            }
            chatGroupMember.cachedSize = iM17277d;
            return iM17277d;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public ChatGroupMember parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        chatGroupMember._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        chatGroupMember.f56859id = nc5Var.m162495s();
                        continue;
                    case 410:
                        chatGroupMember.groupId = nc5Var.m162495s();
                        continue;
                    case 418:
                        chatGroupMember.userId = nc5Var.m162495s();
                        continue;
                    case 426:
                        chatGroupMember.nickName = nc5Var.m162495s();
                        continue;
                    case 434:
                        chatGroupMember.userName = nc5Var.m162495s();
                        continue;
                    case 442:
                        chatGroupMember.nickNamePinyin = nc5Var.m162495s();
                        continue;
                    case 450:
                        chatGroupMember.avatar = nc5Var.m162495s();
                        continue;
                    case 458:
                        chatGroupMember.searchIndices = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 466:
                        chatGroupMember.searchCategory = nc5Var.m162495s();
                        continue;
                    case 472:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 481:
                        chatGroupMember.joinTime = nc5Var.m162484h();
                        continue;
                    case 489:
                        chatGroupMember.createdTime = nc5Var.m162484h();
                        continue;
                    case 497:
                        chatGroupMember.updatedTime = nc5Var.m162484h();
                        continue;
                    case 506:
                        chatGroupMember.silence = (ChatGroupSilence) nc5Var.m162488l(ChatGroupSilence.PROTOBUF_ADAPTER);
                        continue;
                    case 514:
                        chatGroupMember.operationSilence = (ChatGroupSilence) nc5Var.m162488l(ChatGroupSilence.PROTOBUF_ADAPTER);
                        continue;
                    case 520:
                        numValueOf2 = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 530:
                        chatGroupMember.status = (ChatGroupMemberStatus) nc5Var.m162488l(ChatGroupMemberStatus.PROTOBUF_ADAPTER);
                        continue;
                    case 538:
                        chatGroupMember.gender = (Gender) nc5Var.m162488l(Gender.PROTOBUF_ADAPTER);
                        continue;
                    case 546:
                        chatGroupMember.inModeration = (InModeration) nc5Var.m162488l(InModeration.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (chatGroupMember.status == null && numValueOf != null) {
                            chatGroupMember.status = (ChatGroupMemberStatus) ChatGroupMemberStatus.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(ChatGroupMember chatGroupMember, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, chatGroupMember._id);
            String str = chatGroupMember.f56859id;
            if (str != null) {
            ...
            List<String> list = chatGroupMember.searchIndices;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(57, list, ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
            }
            String str8 = chatGroupMember.searchCategory;
            if (str8 != null) {
                codedOutputByteBufferNano.m17316R(58, str8);
            }
            ChatGroupMemberStatus chatGroupMemberStatus = chatGroupMember.status;
            if (chatGroupMemberStatus != null) {
                codedOutputByteBufferNano.m17305G(59, chatGroupMemberStatus.ordinal());
            }
            codedOutputByteBufferNano.m17301C(60, chatGroupMember.joinTime);
            codedOutputByteBufferNano.m17301C(61, chatGroupMember.createdTime);
            codedOutputByteBufferNano.m17301C(62, chatGroupMember.updatedTime);
            ChatGroupSilence chatGroupSilence = chatGroupMember.silence;
            if (chatGroupSilence != null) {
                codedOutputByteBufferNano.m17309K(63, chatGroupSilence, ChatGroupSilence.PROTOBUF_ADAPTER);
            }
            ChatGroupSilence chatGroupSilence2 = chatGroupMember.operationSilence;
            if (chatGroupSilence2 != null) {
                codedOutputByteBufferNano.m17309K(64, chatGroupSilence2, ChatGroupSilence.PROTOBUF_ADAPTER);
            }
            Gender gender = chatGroupMember.gender;
            if (gender != null) {
                codedOutputByteBufferNano.m17305G(65, gender.ordinal());
            }
            ChatGroupMemberStatus chatGroupMemberStatus2 = chatGroupMember.status;
            if (chatGroupMemberStatus2 != null) {
                codedOutputByteBufferNano.m17309K(66, chatGroupMemberStatus2, ChatGroupMemberStatus.PROTOBUF_ADAPTER);
            }
            Gender gender2 = chatGroupMember.gender;
            if (gender2 != null) {
                codedOutputByteBufferNano.m17309K(67, gender2, Gender.PROTOBUF_ADAPTER);
            }
            InModeration inModeration = chatGroupMember.inModeration;
            if (inModeration != null) {
                codedOutputByteBufferNano.m17309K(68, inModeration, InModeration.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(ChatGroupMember chatGroupMember, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (b) {
                ...
                case 10:
                    ...
                    return true;
                case 11:
                    chatGroupMember.f56859id = jsonParser.getValueAsString();
                    return false;
                case 12:
    ...
    public static final StringColumn<ChatGroupMember> f21106ID = new StringColumn<ChatGroupMember>("id_c") { // from class: com.p1.mobile.putong.core.data.ChatGroupMember.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(ChatGroupMember chatGroupMember) {
            return chatGroupMember.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(ChatGroupMember chatGroupMember, String str) {
            chatGroupMember.f56859id = str;
        }
    };
    ...
    public static vzf0<ChatGroupMember> DB_ADAPTER = new vzf0<ChatGroupMember>() { // from class: com.p1.mobile.putong.core.data.ChatGroupMember.27
        ...
        public ChatGroupMember read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i5 = i + 1;
                String string3 = null;
                chatGroupMember.f56859id = cursor.isNull(i5) ? null : cursor.getString(i5);
                int i6 = i + 2;
        ...
        public void write(ChatGroupMember chatGroupMember, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", chatGroupMember.f56859id);
    ...
    public static /* synthetic */ String m36262a(String str) {
        return str;
    }
    ...
    public ChatGroupMember mo225055clone() {
        ChatGroupMember chatGroupMember = new ChatGroupMember();
        chatGroupMember._id = this._id;
        chatGroupMember.f56859id = this.f56859id;
        ...
        if (list != null) {
            chatGroupMember.searchIndices = ValueObject.util_map(list, new qcj() { // from class: l.vu4
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return ChatGroupMember.m36262a((String) obj);
                }
            });
        }
        ...
        if (chatGroupSilence != null) {
            chatGroupMember.silence = chatGroupSilence.mo225055clone();
        }
        ChatGroupSilence chatGroupSilence2 = this.operationSilence;
        if (chatGroupSilence2 != null) {
            chatGroupMember.operationSilence = chatGroupSilence2.mo225055clone();
        }
        chatGroupMember.gender = this.gender;
        InModeration inModeration = this.inModeration;
        if (inModeration != null) {
            chatGroupMember.inModeration = inModeration.mo225055clone();
        }
        return chatGroupMember;
    }
    ...
    public boolean isMe() {
        return TextUtils.equals(this.userId, uqb0.f180397c0.userId());
    }
    ...
    public void onApiParseComplete() {
        ...
        this.f56859id = this.groupId + this.userId;
    }
