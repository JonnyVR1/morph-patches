...
import com.p051p1.mobile.putong.core.data.CommentInfo;
...
public class CommentInfo extends ValueObject implements Cloneable, Serializable {
    ...
    public static /* synthetic */ String m36286a(String str) {
        return str;
    }
    ...
    public CommentInfo mo225055clone() {
        ...
        if (list != null) {
            commentInfo.subMessageIds = ValueObject.util_map(list, new qcj() { // from class: l.fi5
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return CommentInfo.m36286a((String) obj);
                }
            });
        }
