...
public class OptimizeRecommendStickerConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<OptimizeRecommendStickerConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<OptimizeRecommendStickerConfig>() { // from class: com.p1.mobile.putong.core.data.OptimizeRecommendStickerConfig.1
        ...
        public int computeAndCacheSize(OptimizeRecommendStickerConfig optimizeRecommendStickerConfig) {
            int iM17281h = CodedOutputByteBufferNano.m17281h(1, optimizeRecommendStickerConfig.max_times_of_showing_recommend_sticker_b) + CodedOutputByteBufferNano.m17281h(2, optimizeRecommendStickerConfig.max_times_of_showing_recommend_sticker_c) + CodedOutputByteBufferNano.m17281h(3, optimizeRecommendStickerConfig.max_days_since_last_message);
            optimizeRecommendStickerConfig.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public OptimizeRecommendStickerConfig parse(nc5 nc5Var) throws IOException {
            OptimizeRecommendStickerConfig optimizeRecommendStickerConfig = new OptimizeRecommendStickerConfig();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 8) {
                    optimizeRecommendStickerConfig.max_times_of_showing_recommend_sticker_b = nc5Var.m162486j();
                } else if (iM162497u == 16) {
                    optimizeRecommendStickerConfig.max_times_of_showing_recommend_sticker_c = nc5Var.m162486j();
                } else {
                    if (iM162497u != 24) {
                        return optimizeRecommendStickerConfig;
                    }
                    optimizeRecommendStickerConfig.max_days_since_last_message = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(OptimizeRecommendStickerConfig optimizeRecommendStickerConfig, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17305G(1, optimizeRecommendStickerConfig.max_times_of_showing_recommend_sticker_b);
            codedOutputByteBufferNano.m17305G(2, optimizeRecommendStickerConfig.max_times_of_showing_recommend_sticker_c);
            codedOutputByteBufferNano.m17305G(3, optimizeRecommendStickerConfig.max_days_since_last_message);
        }
    };
    ...
    public OptimizeRecommendStickerConfig mo225055clone() {
        OptimizeRecommendStickerConfig optimizeRecommendStickerConfig = new OptimizeRecommendStickerConfig();
