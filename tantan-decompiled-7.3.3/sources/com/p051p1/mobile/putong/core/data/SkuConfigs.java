...
public class SkuConfigs extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<SkuConfigs> PROTOBUF_ADAPTER = new MessageNanoAdapter<SkuConfigs>() { // from class: com.p1.mobile.putong.core.data.SkuConfigs.1
        ...
        public int computeAndCacheSize(SkuConfigs skuConfigs) {
            ...
            if (productType != null) {
                iM17285l += CodedOutputByteBufferNano.m17285l(2, productType, ProductType.PROTOBUF_ADAPTER);
            }
            int iM17281h = iM17285l + CodedOutputByteBufferNano.m17281h(3, skuConfigs.times);
            ...
            if (list != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(5, list, PayMethod.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            skuConfigs.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public SkuConfigs parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    skuConfigs.category = (ProductCategory) nc5Var.m162488l(ProductCategory.PROTOBUF_ADAPTER);
                } else if (iM162497u == 18) {
                    skuConfigs.renewType = (ProductType) nc5Var.m162488l(ProductType.PROTOBUF_ADAPTER);
                } else if (iM162497u == 24) {
                    skuConfigs.times = nc5Var.m162486j();
                } else if (iM162497u == 34) {
                    skuConfigs.timeType = nc5Var.m162495s();
                } else {
                    if (iM162497u != 42) {
                        if (skuConfigs.category == null) {
                            skuConfigs.category = (ProductCategory) ProductCategory.JSON_ADAPTER.defaultEnum();
                    ...
                    skuConfigs.supportsChannels = (List) nc5Var.m162488l(PayMethod.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                }
            }
            return skuConfigs;
        }
        ...
        public void serialize(SkuConfigs skuConfigs, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ProductType productType = skuConfigs.renewType;
            if (productType != null) {
                codedOutputByteBufferNano.m17309K(2, productType, ProductType.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(3, skuConfigs.times);
            String str = skuConfigs.timeType;
            if (str != null) {
            ...
            List<PayMethod> list = skuConfigs.supportsChannels;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(5, list, PayMethod.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
        }
    };
    ...
    public static /* synthetic */ PayMethod m36848a(PayMethod payMethod) {
        return payMethod;
    }
    ...
    public SkuConfigs mo225055clone() {
        SkuConfigs skuConfigs = new SkuConfigs();
        ...
        if (list != null) {
            skuConfigs.supportsChannels = ValueObject.util_map(list, new qcj() { // from class: l.srf0
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return SkuConfigs.m36848a((PayMethod) obj);
                }
            });
        }
        return skuConfigs;
