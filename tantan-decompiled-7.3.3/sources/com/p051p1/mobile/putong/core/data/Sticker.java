...
public class Sticker extends DbObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<Sticker> PROTOBUF_ADAPTER = new MessageNanoAdapter<Sticker>() { // from class: com.p1.mobile.putong.core.data.Sticker.1
        ...
        public int computeAndCacheSize(Sticker sticker) {
            int iM17283j = CodedOutputByteBufferNano.m17283j(1, sticker._id);
            String str = sticker.f56859id;
            if (str != null) {
            ...
            if (list != null) {
                iM17283j += CodedOutputByteBufferNano.m17285l(53, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            StickerSource stickerSource = sticker.source;
            if (stickerSource != null) {
                iM17283j += CodedOutputByteBufferNano.m17281h(54, stickerSource.ordinal());
            }
            int iM17283j2 = iM17283j + CodedOutputByteBufferNano.m17283j(55, sticker.seq);
            String str4 = sticker.hash;
            if (str4 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17288o(56, str4);
            }
            String str5 = sticker.status;
            if (str5 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17288o(57, str5);
            }
            StickerSource stickerSource2 = sticker.source;
            if (stickerSource2 != null) {
                iM17283j2 += CodedOutputByteBufferNano.m17285l(58, stickerSource2, StickerSource.PROTOBUF_ADAPTER);
            }
            sticker.cachedSize = iM17283j2;
            return iM17283j2;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public Sticker parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                switch (nc5Var.m162497u()) {
                    case 0:
                        ...
                        break;
                    case 8:
                        sticker._id = nc5Var.m162487k();
                        continue;
                    case 18:
                        sticker.f56859id = nc5Var.m162495s();
                        continue;
                    case 410:
                        sticker.package_ = nc5Var.m162495s();
                        continue;
                    case 418:
                        sticker.name = nc5Var.m162495s();
                        continue;
                    case 426:
                        sticker.pictures = (List) nc5Var.m162488l(Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
                        continue;
                    case 432:
                        numValueOf = Integer.valueOf(nc5Var.m162486j());
                        continue;
                    case 440:
                        sticker.seq = nc5Var.m162487k();
                        continue;
                    case 450:
                        sticker.hash = nc5Var.m162495s();
                        continue;
                    case 458:
                        sticker.status = nc5Var.m162495s();
                        continue;
                    case 466:
                        sticker.source = (StickerSource) nc5Var.m162488l(StickerSource.PROTOBUF_ADAPTER);
                        continue;
                    default:
                        if (sticker.source == null && numValueOf != null) {
                            sticker.source = (StickerSource) StickerSource.JSON_ADAPTER.newTEnum(null, numValueOf.intValue());
        ...
        public void serialize(Sticker sticker, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            codedOutputByteBufferNano.m17307I(1, sticker._id);
            String str = sticker.f56859id;
            if (str != null) {
            ...
            List<Picture> list = sticker.pictures;
            if (list != null) {
                codedOutputByteBufferNano.m17309K(53, list, Picture.PROTOBUF_ADAPTER.ARRAY_ADAPTER());
            }
            StickerSource stickerSource = sticker.source;
            if (stickerSource != null) {
                codedOutputByteBufferNano.m17305G(54, stickerSource.ordinal());
            }
            codedOutputByteBufferNano.m17307I(55, sticker.seq);
            String str4 = sticker.hash;
            if (str4 != null) {
            ...
            StickerSource stickerSource2 = sticker.source;
            if (stickerSource2 != null) {
                codedOutputByteBufferNano.m17309K(58, stickerSource2, StickerSource.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(Sticker sticker, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "pictures":
                    ...
                    return true;
                case "id":
                    sticker.f56859id = jsonParser.getValueAsString();
                    return false;
                case "seq":
    ...
    public static final StringColumn<Sticker> f21246ID = new StringColumn<Sticker>("id_c") { // from class: com.p1.mobile.putong.core.data.Sticker.4
        @Override // com.tantanapp.common.data.orm.Column
        public String get(Sticker sticker) {
            return sticker.f56859id;
        }

        @Override // com.tantanapp.common.data.orm.Column
        public void set(Sticker sticker, String str) {
            sticker.f56859id = str;
        }
    };
    ...
    public static vzf0<Sticker> DB_ADAPTER = new vzf0<Sticker>() { // from class: com.p1.mobile.putong.core.data.Sticker.12
        @Override // p153l.vzf0
        public String CREATE_TABLE(wzh0 wzh0Var) {
            return "CREATE TABLE IF NOT EXISTS " + wzh0Var.f191760d + " (_id INTEGER PRIMARY KEY,id_c TEXT,package__c TEXT,name_c TEXT,pictures_c BLOB,source_c INTEGER,seq_c INTEGER,hash_c TEXT,status_c TEXT,str_source_c TEXT)";
        }
        ...
        public Sticker read(Cursor cursor, int i) {
            ...
            try {
                ...
                int i3 = i + 1;
                sticker.f56859id = cursor.isNull(i3) ? null : cursor.getString(i3);
                int i4 = i + 2;
        ...
        public void write(Sticker sticker, ContentValues contentValues) {
            try {
                DbObject.cvPut(contentValues, "id_c", sticker.f56859id);
    ...
    public Sticker mo225055clone() {
        Sticker sticker = new Sticker();
        sticker._id = this._id;
        sticker.f56859id = this.f56859id;
        sticker.package_ = this.package_;
        sticker.name = this.name;
        List<Picture> list = this.pictures;
        if (list != null) {
            sticker.pictures = ValueObject.util_map(list, new qcj() { // from class: l.v4g0
                @Override // p153l.qcj
    ...
    public StickerInfo cloneSticker() {
        ...
        stickerInfoNew_.f56859id = this.f56859id;
    ...
    public void mergeDataFromStickerInfo(StickerInfo stickerInfo) {
        this.f56859id = stickerInfo.f56859id;
