...
import com.p051p1.mobile.putong.core.data.GiftInfoTag;
...
public class GiftInfoTag extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GiftInfoTag> PROTOBUF_ADAPTER = new MessageNanoAdapter<GiftInfoTag>() { // from class: com.p1.mobile.putong.core.data.GiftInfoTag.1
        ...
        public int computeAndCacheSize(GiftInfoTag giftInfoTag) {
            ...
            giftInfoTag.cachedSize = iM17285l;
            return iM17285l;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GiftInfoTag parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    giftInfoTag.backgroundColors = (List) nc5Var.m162488l(ProtobufAdapter.STRING_ADAPTER.ARRAY_ADAPTER());
                } else if (iM162497u == 18) {
                    giftInfoTag.text = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (giftInfoTag.backgroundColors == null) {
                            giftInfoTag.backgroundColors = new ArrayList();
                    ...
                    giftInfoTag.privilegeName = nc5Var.m162495s();
                }
            }
            return giftInfoTag;
        }
    ...
    public static /* synthetic */ String m36557a(String str) {
        return str;
    }
    ...
    public GiftInfoTag mo225055clone() {
        GiftInfoTag giftInfoTag = new GiftInfoTag();
        List<String> list = this.backgroundColors;
        if (list != null) {
            giftInfoTag.backgroundColors = ValueObject.util_map(list, new qcj() { // from class: l.btj
                @Override // p153l.qcj
                public final Object call(Object obj) {
                    return GiftInfoTag.m36557a((String) obj);
                }
            });
        }
