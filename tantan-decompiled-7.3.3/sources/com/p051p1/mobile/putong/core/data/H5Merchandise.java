...
public class H5Merchandise extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<H5Merchandise> PROTOBUF_ADAPTER = new MessageNanoAdapter<H5Merchandise>() { // from class: com.p1.mobile.putong.core.data.H5Merchandise.1
        ...
        public int computeAndCacheSize(H5Merchandise h5Merchandise) {
            String str = h5Merchandise.f21152id;
            ...
            if (productCategory != null) {
                iM17288o += CodedOutputByteBufferNano.m17285l(4, productCategory, ProductCategory.PROTOBUF_ADAPTER);
            }
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, h5Merchandise.quantity);
            ProductType productType = h5Merchandise.productType;
            if (productType != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(6, productType, ProductType.PROTOBUF_ADAPTER);
            }
            H5StockKeepUnit h5StockKeepUnit = h5Merchandise.defaultStockKeepUnit;
            if (h5StockKeepUnit != null) {
                iM17281h += CodedOutputByteBufferNano.m17285l(7, h5StockKeepUnit, H5StockKeepUnit.PROTOBUF_ADAPTER);
            }
            h5Merchandise.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public H5Merchandise parse(nc5 nc5Var) throws IOException {
            H5Merchandise h5Merchandise = new H5Merchandise();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (h5Merchandise.f21152id == null) {
                        h5Merchandise.f21152id = "";
                    }
                ...
                if (iM162497u == 10) {
                    h5Merchandise.f21152id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    h5Merchandise.payment = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    h5Merchandise.tracker = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    h5Merchandise.category = (ProductCategory) nc5Var.m162488l(ProductCategory.PROTOBUF_ADAPTER);
                } else if (iM162497u == 40) {
                    h5Merchandise.quantity = nc5Var.m162486j();
                } else if (iM162497u == 50) {
                    h5Merchandise.productType = (ProductType) nc5Var.m162488l(ProductType.PROTOBUF_ADAPTER);
                } else {
                    if (iM162497u != 58) {
                        if (h5Merchandise.f21152id == null) {
                            h5Merchandise.f21152id = "";
                    ...
                    h5Merchandise.defaultStockKeepUnit = (H5StockKeepUnit) nc5Var.m162488l(H5StockKeepUnit.PROTOBUF_ADAPTER);
                }
            }
            return h5Merchandise;
        }
        ...
        public void serialize(H5Merchandise h5Merchandise, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            ProductCategory productCategory = h5Merchandise.category;
            if (productCategory != null) {
                codedOutputByteBufferNano.m17309K(4, productCategory, ProductCategory.PROTOBUF_ADAPTER);
            }
            codedOutputByteBufferNano.m17305G(5, h5Merchandise.quantity);
            ProductType productType = h5Merchandise.productType;
            if (productType != null) {
                codedOutputByteBufferNano.m17309K(6, productType, ProductType.PROTOBUF_ADAPTER);
            }
            H5StockKeepUnit h5StockKeepUnit = h5Merchandise.defaultStockKeepUnit;
            if (h5StockKeepUnit != null) {
                codedOutputByteBufferNano.m17309K(7, h5StockKeepUnit, H5StockKeepUnit.PROTOBUF_ADAPTER);
            }
        }
    };
        ...
        public boolean parseField(H5Merchandise h5Merchandise, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                ...
                case "payment":
                    ...
                    return true;
                case "id":
                    h5Merchandise.f21152id = jsonParser.getValueAsString();
                    return false;
                case "category":
    ...
    public H5Merchandise mo225055clone() {
        H5Merchandise h5Merchandise = new H5Merchandise();
        h5Merchandise.f21152id = this.f21152id;
        ...
        if (h5StockKeepUnit != null) {
            h5Merchandise.defaultStockKeepUnit = h5StockKeepUnit.mo225055clone();
        }
        return h5Merchandise;
    }
