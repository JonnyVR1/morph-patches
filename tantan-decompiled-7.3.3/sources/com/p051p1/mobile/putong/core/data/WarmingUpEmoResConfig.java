...
public class WarmingUpEmoResConfig extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<WarmingUpEmoResConfig> PROTOBUF_ADAPTER = new MessageNanoAdapter<WarmingUpEmoResConfig>() { // from class: com.p1.mobile.putong.core.data.WarmingUpEmoResConfig.1
        ...
        public int computeAndCacheSize(WarmingUpEmoResConfig warmingUpEmoResConfig) {
            ...
            warmingUpEmoResConfig.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public WarmingUpEmoResConfig parse(nc5 nc5Var) throws IOException {
            ...
            while (true) {
                ...
                if (iM162497u == 10) {
                    warmingUpEmoResConfig.poke_sticker_svga_bixin = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    warmingUpEmoResConfig.poke_sticker_svga_dk = nc5Var.m162495s();
                } else if (iM162497u == 26) {
                    warmingUpEmoResConfig.poke_sticker_svga_dx = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    warmingUpEmoResConfig.poke_sticker_svga_jy = nc5Var.m162495s();
                } else if (iM162497u == 42) {
                    warmingUpEmoResConfig.poke_sticker_svga_wanan = nc5Var.m162495s();
                } else {
                    if (iM162497u != 50) {
                        if (warmingUpEmoResConfig.poke_sticker_svga_bixin == null) {
                            warmingUpEmoResConfig.poke_sticker_svga_bixin = "";
                    ...
                    warmingUpEmoResConfig.poke_sticker_svga_zaima = nc5Var.m162495s();
                }
            }
            return warmingUpEmoResConfig;
        }
    ...
    public WarmingUpEmoResConfig mo225055clone() {
        WarmingUpEmoResConfig warmingUpEmoResConfig = new WarmingUpEmoResConfig();
