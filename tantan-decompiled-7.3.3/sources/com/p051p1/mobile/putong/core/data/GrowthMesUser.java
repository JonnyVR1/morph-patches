...
public class GrowthMesUser extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<GrowthMesUser> PROTOBUF_ADAPTER = new MessageNanoAdapter<GrowthMesUser>() { // from class: com.p1.mobile.putong.core.data.GrowthMesUser.1
        ...
        public int computeAndCacheSize(GrowthMesUser growthMesUser) {
            String str = growthMesUser.f21150id;
            ...
            growthMesUser.cachedSize = iM17288o;
            return iM17288o;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public GrowthMesUser parse(nc5 nc5Var) throws IOException {
            GrowthMesUser growthMesUser = new GrowthMesUser();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 0) {
                    if (growthMesUser.f21150id == null) {
                        growthMesUser.f21150id = "";
                    }
                ...
                if (iM162497u == 10) {
                    growthMesUser.f21150id = nc5Var.m162495s();
                } else if (iM162497u == 18) {
                    growthMesUser.name = nc5Var.m162495s();
                } else {
                    if (iM162497u != 26) {
                        if (growthMesUser.f21150id == null) {
                            growthMesUser.f21150id = "";
                    ...
                    growthMesUser.avatar = nc5Var.m162495s();
                }
            }
            return growthMesUser;
        }
        ...
        public boolean parseField(GrowthMesUser growthMesUser, String str, JsonParser jsonParser, String str2, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            ...
            switch (str) {
                case "avatar":
                    ...
                    return true;
                case "id":
                    growthMesUser.f21150id = jsonParser.getValueAsString();
                    return false;
                case "name":
    ...
    public GrowthMesUser mo225055clone() {
        GrowthMesUser growthMesUser = new GrowthMesUser();
        growthMesUser.f21150id = this.f21150id;
    ...
    public boolean equals(Object obj) {
        ...
        return ValueObject.util_equals(this.f21150id, growthMesUser.f21150id) && ValueObject.util_equals(this.name, growthMesUser.name) && ValueObject.util_equals(this.avatar, growthMesUser.avatar);
    }
