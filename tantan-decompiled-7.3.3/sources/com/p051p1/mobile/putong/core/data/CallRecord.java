...
public class CallRecord extends ValueObject implements Cloneable, Serializable {
    ...
    public static ProtobufAdapter<CallRecord> PROTOBUF_ADAPTER = new MessageNanoAdapter<CallRecord>() { // from class: com.p1.mobile.putong.core.data.CallRecord.1
        ...
        public int computeAndCacheSize(CallRecord callRecord) {
            ...
            int iM17288o = (str != null ? CodedOutputByteBufferNano.m17288o(1, str) : 0) + CodedOutputByteBufferNano.m17283j(2, callRecord.duration);
            ...
            int iM17281h = iM17288o + CodedOutputByteBufferNano.m17281h(5, callRecord.status);
            callRecord.cachedSize = iM17281h;
            return iM17281h;
        }

        @Override // com.tantanapp.common.data.ProtobufAdapter
        public CallRecord parse(nc5 nc5Var) throws IOException {
            CallRecord callRecord = new CallRecord();
            while (true) {
                int iM162497u = nc5Var.m162497u();
                if (iM162497u == 10) {
                    callRecord.callType = nc5Var.m162495s();
                } else if (iM162497u == 16) {
                    callRecord.duration = nc5Var.m162487k();
                } else if (iM162497u == 26) {
                    callRecord.channelName = nc5Var.m162495s();
                } else if (iM162497u == 34) {
                    callRecord.device = nc5Var.m162495s();
                } else {
                    if (iM162497u != 40) {
                        return callRecord;
                    }
                    callRecord.status = nc5Var.m162486j();
                }
            }
        }
        ...
        public void serialize(CallRecord callRecord, CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            codedOutputByteBufferNano.m17307I(2, callRecord.duration);
            String str2 = callRecord.channelName;
            if (str2 != null) {
            ...
            codedOutputByteBufferNano.m17305G(5, callRecord.status);
        }
    };
    ...
    public CallRecord mo225055clone() {
        CallRecord callRecord = new CallRecord();
