...
import p153l.C18920nq;
import p153l.C21846zp;
import p153l.jyb;
import p153l.l4g0;

/* JADX INFO: loaded from: classes8.dex */
public class AccountInactiveConfirmAct extends PutongMvpAct<C21846zp, C18920nq> {
    /* JADX INFO: renamed from: Z1 */
    public static Intent m45288Z1(Act act, String str, String str2, String str3, String str4) {
    ...
    public String m45289a2(String str) {
        str.getClass();
        byte b = -1;
        switch (str.hashCode()) {
            case -2049471274:
    ...
    public C21846zp mo29671X1() {
        return new C21846zp(this);
    }

    @Override // com.p051p1.mobile.putong.app.PutongMvpAct
    /* JADX INFO: renamed from: c2, reason: merged with bridge method [inline-methods] */
    public C18920nq mo29672Y1() {
        return new C18920nq(this);
    }

    @Override // com.p051p1.mobile.putong.app.PutongAct
    public void initPageHelper() {
        l4g0 l4g0Var = new l4g0(this);
        this.pageHelper = l4g0Var;
        l4g0Var.m152781p(jyb.m147494Y("delete_account_reason_block_page", m45289a2(getIntent().getStringExtra("InactivateReasonKey"))));
    }
