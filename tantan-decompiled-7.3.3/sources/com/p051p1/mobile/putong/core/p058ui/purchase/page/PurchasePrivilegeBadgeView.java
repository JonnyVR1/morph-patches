...
public final class PurchasePrivilegeBadgeView extends FrameLayout {
    ...
    public final void m55361a(View view) {
        agb0.m97592a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m55362b(@NotNull Privilege privilege) {
        privilege.getClass();
        User userM116600p9 = CoreModule.f18264c.f20381e0.m116600p9();
        if (Privilege.svip_badge == privilege) {
            get_avatar().setImageUrl(userM116600p9.m61308fp().url);
            get_vip_icon().setImageResource(jbc0.f119453W8);
            get_avatar_area().setBackgroundResource(jbc0.f119440V8);
            get_vip_badge().setImageResource(jbc0.f119481Ya);
            return;
        }
        get_avatar().setImageUrl(userM116600p9.m61308fp().url);
        get_vip_icon().setImageResource(CoreModule.m30933P().m143408e().mo35991ul());
        get_avatar_area().setBackgroundResource(jbc0.f119466X8);
        get_vip_badge().setImageResource(jbc0.f119479Y8);
    }
    ...
    public final FrameLayout get_avatar_area() {
        ...
        Intrinsics.m88391r("_avatar_area");
        return null;
    }
