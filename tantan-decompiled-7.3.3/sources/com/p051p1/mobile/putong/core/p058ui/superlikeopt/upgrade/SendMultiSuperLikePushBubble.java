...
public final class SendMultiSuperLikePushBubble extends LinearLayout {
    ...
    public final void m56953a(View view) {
        ape0.m99314a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m56954b(@NotNull User user) {
        user.getClass();
        uqb0.f180374G.m127115L0(get_avatar(), user.m61308fp().profileSmall().formatted());
    }
