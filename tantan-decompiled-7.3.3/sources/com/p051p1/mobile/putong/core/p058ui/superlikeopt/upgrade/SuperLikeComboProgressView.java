...
import com.p051p1.mobile.putong.core.p058ui.superlikeopt.upgrade.SuperLikeComboProgressView;
...
public final class SuperLikeComboProgressView extends View {
    ...
    @Metadata(m88120d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\f\b\u0002\u0018\u0000 \u00192\u00020\u0001:\u0001\u0007B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\bJ\u001d\u0010\f\u001a\u00020\u000b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\t¢\u0006\u0004\b\f\u0010\rR\u0016\u0010\u0010\u001a\u00020\u000e8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0007\u0010\u000fR\"\u0010\n\u001a\u00020\t8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\f\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0014\u0010\u0015R\u0016\u0010\u0018\u001a\u00020\u00068\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017¨\u0006\u001a"}, m88121d2 = {"Lcom/p1/mobile/putong/core/ui/superlikeopt/upgrade/SuperLikeComboProgressView$a;", "", "<init>", "()V", "Landroid/view/View;", ResourceDirection.f39656v, "", "a", "(Landroid/view/View;)F", "", BLiveOperationTitleShowType.duration, "", "b", "(Landroid/view/View;I)V", "", "J", StudentVerRejectedReason.startTime, "I", "getDuration", "()I", "setDuration", "(I)V", "c", "F", "percent", "Companion", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C9072a {
        ...
        public final float m56983a(@NotNull View v2) {
            v2.getClass();
        ...
        public final void m56984b(@NotNull View v2, int duration) {
            v2.getClass();
    ...
    public SuperLikeComboProgressView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        context.getClass();
        this.paint = LazyKt__LazyJVMKt.m88118b(new Function0() { // from class: l.u4h0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return SuperLikeComboProgressView.m56979a();
            }
        });
        this.path = LazyKt__LazyJVMKt.m88118b(new Function0() { // from class: l.v4h0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return SuperLikeComboProgressView.m56980b();
            }
        });
        this.hpTimer = new C9072a();
        this.maxPercent = 10.0f;
    }

    /* JADX INFO: renamed from: a */
    public static Paint m56979a() {
    ...
    /* JADX INFO: renamed from: b */
    public static Path m56980b() {
        return new Path();
    }

    /* JADX INFO: renamed from: c */
    public final void m56981c(int duration, int num) {
        this.currentMax = num;
        this.hpTimer.m56984b(this, duration);
        if (num == 4) {
    ...
    public void onDraw(@NotNull Canvas canvas) {
        canvas.getClass();
        super.onDraw(canvas);
        float fM56983a = this.hpTimer.m56983a(this);
        float f = this.maxPercent;
        float f2 = (1.0f / f) * fM56983a;
