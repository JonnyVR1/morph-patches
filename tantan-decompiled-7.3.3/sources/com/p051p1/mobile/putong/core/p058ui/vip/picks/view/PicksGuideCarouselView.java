...
public final class PicksGuideCarouselView extends FrameLayout {
    ...
    @SourceDebugExtension
    public static final class C9134a implements Animator.AnimatorListener {
        public C9134a() {
        }
        ...
        public void onAnimationEnd(@NotNull Animator animator) {
            animator.getClass();
            l51.m152888H(PicksGuideCarouselView.this.getContext(), PicksGuideCarouselView.this.getCarouselAnimRunnable(), PicksGuideCarouselView.this.getCarouselInternal());
        }
    ...
    public PicksGuideCarouselView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.padding = qa00.f156324k;
        this.imageSize = qa00.m175859d(44.0f);
        this.imageOffset = qa00.f156322i;
        this.imageBorder = qa00.f156316c;
        this.duration = 600L;
        this.fadeInDuration = 400L;
        this.carouselInternal = 400L;
        this.startDelay = 1200L;
        this.carouselAnimRunnable = new Runnable() { // from class: l.im70
            @Override // java.lang.Runnable
            public final void run() {
                PicksGuideCarouselView.m57980a(this.f115708a);
            }
        };
    ...
    public static void m57980a(PicksGuideCarouselView picksGuideCarouselView) {
        picksGuideCarouselView.m57989j();
    }

    /* JADX INFO: renamed from: b */
    public static void m57981b(FrameLayout.LayoutParams layoutParams, PicksGuideCarouselView picksGuideCarouselView, PicksGuideCarouselItemView picksGuideCarouselItemView, ValueAnimator valueAnimator) {
    ...
    public static void m57982c(FrameLayout.LayoutParams layoutParams, int i, int i2, PicksGuideCarouselItemView picksGuideCarouselItemView, ValueAnimator valueAnimator) {
        valueAnimator.getClass();
    ...
    public static void m57983d(PicksGuideCarouselView picksGuideCarouselView, FrameLayout.LayoutParams layoutParams, PicksGuideCarouselItemView picksGuideCarouselItemView, ValueAnimator valueAnimator) {
        valueAnimator.getClass();
    ...
    public final Animator m57984e(final PicksGuideCarouselItemView view) {
        view.setTag(ddc0.f87918x, Integer.valueOf(this.STATE_NORMAL));
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        layoutParams.getClass();
        final FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) layoutParams;
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.lm70
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PicksGuideCarouselView.m57981b(layoutParams2, this, view, valueAnimator);
            }
        });
    ...
    public final Animator m57985f(final PicksGuideCarouselItemView view) {
        Pair<Integer, User> pairM57990k = m57990k();
        int iIntValue = pairM57990k.component1().intValue();
        User userComponent2 = pairM57990k.component2();
        view.setTag(ddc0.f87919y, Integer.valueOf(iIntValue));
        view.m57979b(this.showFemaleStyle, userComponent2);
        view.setTag(ddc0.f87918x, Integer.valueOf(this.STATE_FADE_IN));
        view.bringToFront();
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        layoutParams.getClass();
        final FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) layoutParams;
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.km70
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PicksGuideCarouselView.m57982c(layoutParams2, i, width, view, valueAnimator);
            }
        });
    ...
    public final void m57986g() {
        View viewInflate = p9r.m171370a(getContext()).inflate(pec0.f151971b1, (ViewGroup) this, false);
        ...
        if (picksGuideCarouselItemView == null) {
            Intrinsics.m88391r("carouselItemView1");
            picksGuideCarouselItemView = null;
        }
        picksGuideCarouselItemView.setTag(ddc0.f87918x, Integer.valueOf(this.STATE_NORMAL));
        ...
        View viewInflate2 = p9r.m171370a(getContext()).inflate(pec0.f151971b1, (ViewGroup) this, false);
        ...
        if (picksGuideCarouselItemView2 == null) {
            Intrinsics.m88391r("carouselItemView2");
            picksGuideCarouselItemView2 = null;
        }
        picksGuideCarouselItemView2.setTag(ddc0.f87918x, Integer.valueOf(this.STATE_FADE_IN));
        ...
        View viewInflate3 = p9r.m171370a(getContext()).inflate(pec0.f151971b1, (ViewGroup) this, false);
        ...
        if (picksGuideCarouselItemView3 == null) {
            Intrinsics.m88391r("carouselItemView3");
            picksGuideCarouselItemView3 = null;
        }
        picksGuideCarouselItemView3.setTag(ddc0.f87918x, Integer.valueOf(this.STATE_FADE_OUT));
    ...
    public final Animator m57987h(int current, PicksGuideCarouselItemView view) {
        ...
        return i2 == this.STATE_FADE_OUT ? m57988i(view) : m57985f(view);
    }

    /* JADX INFO: renamed from: i */
    public final Animator m57988i(final PicksGuideCarouselItemView view) {
        view.setTag(ddc0.f87918x, Integer.valueOf(this.STATE_FADE_OUT));
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        layoutParams.getClass();
        final FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) layoutParams;
        view.setAlpha(1.0f);
        ...
        view.setScaleY(1.0f);
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.jm70
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PicksGuideCarouselView.m57983d(this.f121647a, layoutParams2, view, valueAnimator);
            }
        });
        valueAnimatorOfFloat.setDuration(this.duration);
        valueAnimatorOfFloat.setInterpolator(this.interpolator);
    ...
    public final void m57989j() {
        ...
        Object tag = picksGuideCarouselItemView.getTag(ddc0.f87918x);
        tag.getClass();
        ...
        Animator animatorM57987h = m57987h(iIntValue, picksGuideCarouselItemView3);
        ...
        Object tag2 = picksGuideCarouselItemView4.getTag(ddc0.f87918x);
        tag2.getClass();
        ...
        Animator animatorM57987h2 = m57987h(iIntValue2, picksGuideCarouselItemView5);
        ...
        Object tag3 = picksGuideCarouselItemView6.getTag(ddc0.f87918x);
        tag3.getClass();
        ...
        Animator animatorM57987h3 = m57987h(iIntValue3, picksGuideCarouselItemView2);
        AnimatorSet animatorSet = new AnimatorSet();
        this.carouselAnimatorSet = animatorSet;
        animatorSet.playTogether(animatorM57987h, animatorM57987h2, animatorM57987h3);
        animatorSet.addListener(new C9134a());
        animatorSet.start();
    }

    /* JADX INFO: renamed from: k */
    public final Pair<Integer, User> m57990k() {
        int iNextInt;
        PicksGuideCarouselItemView picksGuideCarouselItemView = this.carouselItemView1;
        ...
        Integer num = (Integer) picksGuideCarouselItemView.getTag(ddc0.f87919y);
        PicksGuideCarouselItemView picksGuideCarouselItemView2 = this.carouselItemView2;
        if (picksGuideCarouselItemView2 == null) {
            Intrinsics.m88391r("carouselItemView2");
            picksGuideCarouselItemView2 = null;
        }
        Integer num2 = (Integer) picksGuideCarouselItemView2.getTag(ddc0.f87919y);
        PicksGuideCarouselItemView picksGuideCarouselItemView3 = this.carouselItemView3;
        if (picksGuideCarouselItemView3 == null) {
            Intrinsics.m88391r("carouselItemView3");
            picksGuideCarouselItemView3 = null;
        }
        Integer num3 = (Integer) picksGuideCarouselItemView3.getTag(ddc0.f87919y);
        while (true) {
            Random.Companion companion = Random.INSTANCE;
            List<? extends User> list2 = this.carouselUsers;
            if (list2 == null) {
                Intrinsics.m88391r("carouselUsers");
                list2 = null;
            }
    ...
    public final void m57991l(boolean showFemaleStyle, @NotNull List<? extends User> carouselUsers) {
        ...
        picksGuideCarouselItemView.setTag(ddc0.f87919y, Integer.valueOf(iIntValue));
        PicksGuideCarouselItemView picksGuideCarouselItemView3 = this.carouselItemView1;
        if (picksGuideCarouselItemView3 == null) {
            Intrinsics.m88391r("carouselItemView1");
            picksGuideCarouselItemView3 = null;
        }
        picksGuideCarouselItemView3.m57979b(showFemaleStyle, userComponent2);
        Pair<Integer, User> pairM57990k2 = m57990k();
        int iIntValue2 = pairM57990k2.component1().intValue();
        User userComponent3 = pairM57990k2.component2();
        PicksGuideCarouselItemView picksGuideCarouselItemView4 = this.carouselItemView2;
        if (picksGuideCarouselItemView4 == null) {
            Intrinsics.m88391r("carouselItemView2");
            picksGuideCarouselItemView4 = null;
        }
        picksGuideCarouselItemView4.setTag(ddc0.f87919y, Integer.valueOf(iIntValue2));
        PicksGuideCarouselItemView picksGuideCarouselItemView5 = this.carouselItemView2;
        if (picksGuideCarouselItemView5 == null) {
            Intrinsics.m88391r("carouselItemView2");
            picksGuideCarouselItemView5 = null;
        }
        picksGuideCarouselItemView5.m57979b(showFemaleStyle, userComponent3);
        Pair<Integer, User> pairM57990k3 = m57990k();
        int iIntValue3 = pairM57990k3.component1().intValue();
        User userComponent4 = pairM57990k3.component2();
        PicksGuideCarouselItemView picksGuideCarouselItemView6 = this.carouselItemView3;
        if (picksGuideCarouselItemView6 == null) {
            Intrinsics.m88391r("carouselItemView3");
            picksGuideCarouselItemView6 = null;
        }
        picksGuideCarouselItemView6.setTag(ddc0.f87919y, Integer.valueOf(iIntValue3));
        PicksGuideCarouselItemView picksGuideCarouselItemView7 = this.carouselItemView3;
        if (picksGuideCarouselItemView7 == null) {
            Intrinsics.m88391r("carouselItemView3");
        } else {
        ...
        picksGuideCarouselItemView2.m57979b(showFemaleStyle, userComponent4);
    }

    /* JADX INFO: renamed from: m */
    public final void m57992m() {
        m57993n();
        l51.m152888H(getContext(), this.carouselAnimRunnable, this.startDelay);
    }

    /* JADX INFO: renamed from: n */
    public final void m57993n() {
