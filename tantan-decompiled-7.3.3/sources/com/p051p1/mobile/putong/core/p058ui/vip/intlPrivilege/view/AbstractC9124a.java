...
public abstract class AbstractC9124a extends lb2 {
    ...
    public final FrameLayout mo40046p(@NotNull ViewGroup container, int position) {
        ...
        if (position == 0) {
            ...
            frameLayout.setPadding(companion.m57720b(), 0, companion.m57719a(), 0);
        } else if (position == getCount() - 1) {
            IntlTopCardLayout.Companion companion2 = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion2.m57719a(), 0, companion2.m57720b(), 0);
        } else {
            IntlTopCardLayout.Companion companion3 = IntlTopCardLayout.INSTANCE;
            frameLayout.setPadding(companion3.m57719a(), 0, companion3.m57719a(), 0);
        }
        container.addView(frameLayout, new ViewGroup.LayoutParams(-1, -2));
        return mo57722r(frameLayout, position);
    }

    @NotNull
    /* JADX INFO: renamed from: r */
    public abstract FrameLayout mo57722r(@NotNull FrameLayout container, int position);
}
