...
public final class IntlBottomContentCoverView extends FrameLayout {
    ...
    public IntlBottomContentCoverView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m58868a(layoutInflaterM171370a, this);
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m58868a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM102619b = b5n.m102619b(this, inflater, parent);
        viewM102619b.getClass();
        return viewM102619b;
    }

    /* JADX INFO: renamed from: b */
    public final void m58869b(float alpha) {
