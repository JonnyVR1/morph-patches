...
public final class ComboNumView extends FrameLayout {
    ...
    public final void m56947a(View view) {
        pf5.m172084a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m56948b(int num) {
        C9073a.Companion companion = C9073a.INSTANCE;
        if (num <= companion.m56996a().size()) {
            bnl0.m105524M(get_nums(), true);
            bnl0.m105524M(get_digits_bg(), false);
            bnl0.m105524M(get_digits(), false);
            Integer num2 = companion.m56996a().get(Integer.valueOf(num));
            if (num2 != null) {
                get_nums().setImageResource(num2.intValue());
            }
            get_white_bg().getLayoutParams().width = qa00.f156328o;
            return;
        }
        bnl0.m105524M(get_nums(), false);
        bnl0.m105524M(get_digits_bg(), true);
        bnl0.m105524M(get_digits(), true);
        ...
        if (num > 0) {
            ...
            bnl0.m105524M(get_digits_ones(), true);
            bnl0.m105524M(get_digits_bg_ones_bg(), true);
            bnl0.m105538V(get_digits_ones(), 0);
            bnl0.m105538V(get_digits_bg_ones_bg(), 0);
            C9073a.Companion companion2 = C9073a.INSTANCE;
            Integer num3 = companion2.m56998c().get(Integer.valueOf(iIntValue));
            if (num3 != null) {
                get_digits_ones().setImageResource(num3.intValue());
            }
            Integer num4 = companion2.m56997b().get(Integer.valueOf(iIntValue));
            if (num4 != null) {
                get_digits_bg_ones_bg().setImageResource(num4.intValue());
            }
            if (!(num / 10 > 0)) {
                bnl0.m105524M(get_digits_tens(), false);
                bnl0.m105524M(get_digits_bg_tens_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = qa00.m175859d(47.0f);
            int iIntValue2 = ((Number) arrayList.get(1)).intValue();
            bnl0.m105524M(get_digits_tens(), true);
            bnl0.m105524M(get_digits_bg_tens_bg(), true);
            bnl0.m105538V(get_digits_tens(), 0);
            bnl0.m105538V(get_digits_bg_tens_bg(), 0);
            bnl0.m105538V(get_digits_ones(), qa00.m175859d(-13.0f));
            bnl0.m105538V(get_digits_bg_ones_bg(), qa00.m175859d(-13.0f));
            Integer num5 = companion2.m56998c().get(Integer.valueOf(iIntValue2));
            if (num5 != null) {
                get_digits_tens().setImageResource(num5.intValue());
            }
            Integer num6 = companion2.m56997b().get(Integer.valueOf(iIntValue2));
            if (num6 != null) {
                get_digits_bg_tens_bg().setImageResource(num6.intValue());
            }
            if (!(num / 100 > 0)) {
                bnl0.m105524M(get_digits_hundreds(), false);
                bnl0.m105524M(get_digits_bg_hundreds_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = qa00.m175859d(74.0f);
            int iIntValue3 = ((Number) arrayList.get(2)).intValue();
            bnl0.m105524M(get_digits_hundreds(), true);
            bnl0.m105524M(get_digits_bg_hundreds_bg(), true);
            bnl0.m105538V(get_digits_hundreds(), 0);
            bnl0.m105538V(get_digits_bg_hundreds_bg(), 0);
            bnl0.m105538V(get_digits_tens(), qa00.m175859d(-13.0f));
            bnl0.m105538V(get_digits_bg_tens_bg(), qa00.m175859d(-13.0f));
            Integer num7 = companion2.m56998c().get(Integer.valueOf(iIntValue3));
            if (num7 != null) {
                get_digits_hundreds().setImageResource(num7.intValue());
            }
            Integer num8 = companion2.m56997b().get(Integer.valueOf(iIntValue3));
            if (num8 != null) {
                get_digits_bg_hundreds_bg().setImageResource(num8.intValue());
            }
            if (!(num / 1000 > 0)) {
                bnl0.m105524M(get_digits_thousands(), false);
                bnl0.m105524M(get_digits_bg_thousands_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = qa00.m175859d(101.0f);
            int iIntValue4 = ((Number) arrayList.get(3)).intValue();
            bnl0.m105524M(get_digits_thousands(), true);
            bnl0.m105524M(get_digits_bg_thousands_bg(), true);
            bnl0.m105538V(get_digits_thousands(), 0);
            bnl0.m105538V(get_digits_bg_thousands_bg(), 0);
            bnl0.m105538V(get_digits_hundreds(), qa00.m175859d(-13.0f));
            bnl0.m105538V(get_digits_bg_hundreds_bg(), qa00.m175859d(-13.0f));
            Integer num9 = companion2.m56998c().get(Integer.valueOf(iIntValue4));
            if (num9 != null) {
                get_digits_thousands().setImageResource(num9.intValue());
            }
            Integer num10 = companion2.m56997b().get(Integer.valueOf(iIntValue4));
            if (num10 != null) {
                get_digits_bg_thousands_bg().setImageResource(num10.intValue());
            }
            if (!(num / 10000 > 0)) {
                bnl0.m105524M(get_digits_plus(), false);
                bnl0.m105524M(get_digits_bg_plus_bg(), false);
                return;
            }
            get_white_bg().getLayoutParams().width = qa00.m175859d(128.0f);
            bnl0.m105524M(get_digits_plus(), true);
            bnl0.m105524M(get_digits_bg_plus_bg(), true);
            get_digits_plus().setImageResource(gbc0.f103116G2);
            get_digits_bg_thousands_bg().setImageResource(gbc0.f103109F2);
        }
    }

    /* JADX INFO: renamed from: c */
    public final void m56949c() {
        Integer num = C9073a.INSTANCE.m56996a().get(1);
        if (num != null) {
        ...
        Iterator<View> it = ViewGroupKt.m1330b(get_digits_bg()).iterator();
        while (it.hasNext()) {
            bnl0.m105524M(it.next(), false);
        }
        Iterator<View> it2 = ViewGroupKt.m1330b(get_digits()).iterator();
        while (it2.hasNext()) {
            bnl0.m105524M(it2.next(), false);
        }
    }
    ...
    public final ImageView get_digits_bg_hundreds_bg() {
        ...
        Intrinsics.m88391r("_digits_bg_hundreds_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_ones_bg() {
        ...
        Intrinsics.m88391r("_digits_bg_ones_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_plus_bg() {
        ...
        Intrinsics.m88391r("_digits_bg_plus_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_tens_bg() {
        ...
        Intrinsics.m88391r("_digits_bg_tens_bg");
        return null;
    }
    ...
    public final ImageView get_digits_bg_thousands_bg() {
        ...
        Intrinsics.m88391r("_digits_bg_thousands_bg");
        return null;
    }
    ...
    public final ImageView get_digits_hundreds() {
        ...
        Intrinsics.m88391r("_digits_hundreds");
        return null;
    }
    ...
    public final ImageView get_digits_ones() {
        ...
        Intrinsics.m88391r("_digits_ones");
        return null;
    }
    ...
    public final ImageView get_digits_plus() {
        ...
        Intrinsics.m88391r("_digits_plus");
        return null;
    }
    ...
    public final ImageView get_digits_tens() {
        ...
        Intrinsics.m88391r("_digits_tens");
        return null;
    }
    ...
    public final ImageView get_digits_thousands() {
        ...
        Intrinsics.m88391r("_digits_thousands");
        return null;
    }
