package com.p051p1.mobile.putong.core.p058ui.home.member.likeme;
...
public final class LikeMeFilterView extends HorizontalScrollView implements View.OnClickListener {
    ...
    @Nullable
    public InterfaceC8535a callback;

    /* JADX INFO: renamed from: l, reason: from kotlin metadata */
    @Nullable
    public y20<Boolean> onScrollChangeBottom;

    /* JADX INFO: renamed from: m, reason: from kotlin metadata */
    public long lastClickTime;

    /* JADX INFO: renamed from: com.p1.mobile.putong.core.ui.home.member.likeme.LikeMeFilterView$a */
    @Metadata(m88120d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u001f\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H&¢\u0006\u0004\b\u0007\u0010\bJ\u001f\u0010\n\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H&¢\u0006\u0004\b\n\u0010\u000b¨\u0006\fÀ\u0006\u0003"}, m88121d2 = {"Lcom/p1/mobile/putong/core/ui/home/member/likeme/LikeMeFilterView$a;", "", "", "type", "Landroid/view/View;", OMSTemplateModeType.view, "", "a", "(Ljava/lang/String;Landroid/view/View;)Z", "", "b", "(Ljava/lang/String;Landroid/view/View;)V", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public interface InterfaceC8535a {
        /* JADX INFO: renamed from: a */
        boolean mo47275a(@NotNull String type, @NotNull View view);

        /* JADX INFO: renamed from: b */
        void mo47276b(@NotNull String type, @NotNull View view);
    }
    ...
    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m47271a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM219504b = zer.m219504b(this, inflater, parent);
        viewM219504b.getClass();
        return viewM219504b;
    }

    /* JADX INFO: renamed from: b */
    public final void m47272b(@NotNull InterfaceC8535a callback) {
        callback.getClass();
    ...
    public final String m47273c(View v2) {
        if (Intrinsics.m88377d(v2, get_match_filter())) {
            return "match_filter";
        }
        if (Intrinsics.m88377d(v2, get_nearby_filter())) {
            return "NEARBY_FILTER";
        }
        if (Intrinsics.m88377d(v2, get_online_filter())) {
            return "ONLINE_FILTER";
        }
        if (Intrinsics.m88377d(v2, get_pop_filter())) {
            return "POP_FILTER";
        }
        if (Intrinsics.m88377d(v2, get_verified_filter())) {
            return "VERIFIED_FILTER";
        }
        if (Intrinsics.m88377d(v2, get_real_avatar_filter())) {
            return "REAL_AVATAR_FILTER";
        }
        if (Intrinsics.m88377d(v2, get_info_rich_filter())) {
    ...
    public final void m47274d(@NotNull Pair<String, Boolean>... types) {
        types.getClass();
    ...
    @Nullable
    public final InterfaceC8535a getCallback() {
    ...
    @Nullable
    public final y20<Boolean> getOnScrollChangeBottom() {
    ...
    public final VText get_info_rich_filter() {
        ...
        Intrinsics.m88391r("_info_rich_filter");
        return null;
    }
    ...
    public final FrameLayout get_match_filter() {
        ...
        Intrinsics.m88391r("_match_filter");
        return null;
    }
    ...
    public final View get_match_filter_match_dot() {
        ...
        Intrinsics.m88391r("_match_filter_match_dot");
        return null;
    }
    ...
    public final VText get_match_filter_match_text() {
        ...
        Intrinsics.m88391r("_match_filter_match_text");
        return null;
    }
    ...
    public final VText get_nearby_filter() {
        ...
        Intrinsics.m88391r("_nearby_filter");
        return null;
    }
    ...
    public final VText get_online_filter() {
        ...
        Intrinsics.m88391r("_online_filter");
        return null;
    }
    ...
    public final VText get_pop_filter() {
        ...
        Intrinsics.m88391r("_pop_filter");
        return null;
    }
    ...
    public final VText get_real_avatar_filter() {
        ...
        Intrinsics.m88391r("_real_avatar_filter");
        return null;
    }
    ...
    public final VText get_verified_filter() {
        ...
        Intrinsics.m88391r("_verified_filter");
        return null;
    }
    ...
    public void onClick(@NotNull View v2) {
        ...
        String strM47273c = m47273c(v2);
        if (strM47273c != null) {
            InterfaceC8535a interfaceC8535a = this.callback;
            if (interfaceC8535a != null ? interfaceC8535a.mo47275a(strM47273c, v2) : true) {
                v2.setSelected(!v2.isSelected());
                InterfaceC8535a interfaceC8535a2 = this.callback;
                if (interfaceC8535a2 != null) {
                    interfaceC8535a2.mo47276b(strM47273c, v2);
                }
            }
        }
    }
    ...
    public void onScrollChanged(int l2, int t, int oldl, int oldt) {
        ...
        y20<Boolean> y20Var = this.onScrollChangeBottom;
        if (y20Var != null) {
            y20Var.call(Boolean.valueOf(width >= getChildAt(0).getWidth()));
        }
    }

    public final void setCallback(@Nullable InterfaceC8535a interfaceC8535a) {
        this.callback = interfaceC8535a;
    }
    ...
    public final void setOnScrollChangeBottom(@Nullable y20<Boolean> y20Var) {
        this.onScrollChangeBottom = y20Var;
    }
    ...
    public LikeMeFilterView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        m47271a(layoutInflaterM171370a, this);
    }
