...
public final class PurchasePrivilegeHideMeFromNearbyView extends FrameLayout {
    ...
    public final void m55367a(View view) {
        dgb0.m115644a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m55368b() {
        get_model().setImageResource(jbc0.f119477Y6);
        uqb0.f180374G.m127120O(get_avatar(), CoreModule.f18264c.f20381e0.m116600p9().m61308fp().profileSmall().formatted(), 2, 8);
    }
