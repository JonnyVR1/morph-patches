...
@Metadata(m88120d1 = {"\u0000r\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0002\b\u000b\n\u0002\u0010\u000b\n\u0002\b\b\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\u000b\u001a\u00020\nH\u0014¢\u0006\u0004\b\u000b\u0010\fJ3\u0010\u0016\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u0010\u001a\u00020\u000f2\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00120\u00112\u0006\u0010\u0015\u001a\u00020\u0014¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u001a\u001a\u00020\n2\u0006\u0010\u0019\u001a\u00020\u0018H\u0002¢\u0006\u0004\b\u001a\u0010\u001bR\"\u0010#\u001a\u00020\u001c8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u001d\u0010\u001e\u001a\u0004\b\u001f\u0010 \"\u0004\b!\u0010\"R\"\u0010+\u001a\u00020$8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b%\u0010&\u001a\u0004\b'\u0010(\"\u0004\b)\u0010*R\"\u00103\u001a\u00020,8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b-\u0010.\u001a\u0004\b/\u00100\"\u0004\b1\u00102R\"\u00107\u001a\u00020$8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b4\u0010&\u001a\u0004\b5\u0010(\"\u0004\b6\u0010*R\"\u0010?\u001a\u0002088\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b9\u0010:\u001a\u0004\b;\u0010<\"\u0004\b=\u0010>R\"\u0010C\u001a\u00020,8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b@\u0010.\u001a\u0004\bA\u00100\"\u0004\bB\u00102R\"\u0010K\u001a\u00020D8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\bE\u0010F\u001a\u0004\bG\u0010H\"\u0004\bI\u0010J¨\u0006L"}, m88121d2 = {"Lcom/p1/mobile/putong/core/ui/vip/picks/view/header/PicksStateExpandView;", "Lv/VRelative;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", "onFinishInflate", "()V", "Ll/sm70;", "presenter", "Ll/eo70;", "adapter", "", "Lcom/p1/mobile/putong/core/data/PicksUser;", "list", "Ll/x20;", "onClose", "H", "(Ll/sm70;Ll/eo70;Ljava/util/List;Ll/x20;)V", "Landroid/view/View;", OMSTemplateModeType.view, "B", "(Landroid/view/View;)V", "Landroid/widget/LinearLayout;", Constants.INAPP_DATA_TAG, "Landroid/widget/LinearLayout;", "get_title_layout", "()Landroid/widget/LinearLayout;", "set_title_layout", "(Landroid/widget/LinearLayout;)V", "_title_layout", "Lv/VImage;", "e", "Lv/VImage;", "get_title_icon", "()Lv/VImage;", "set_title_icon", "(Lv/VImage;)V", "_title_icon", "Lv/VText;", "f", "Lv/VText;", "get_title", "()Lv/VText;", "set_title", "(Lv/VText;)V", "_title", "g", "get_close", "set_close", "_close", "Lv/VPullUpRecyclerView;", "h", "Lv/VPullUpRecyclerView;", "get_list", "()Lv/VPullUpRecyclerView;", "set_list", "(Lv/VPullUpRecyclerView;)V", "_list", RXScreenCaptureService.KEY_INDEX, "get_goto_picks", "set_goto_picks", "_goto_picks", "", "j", "Z", "getHasTrackMv", "()Z", "setHasTrackMv", "(Z)V", "hasTrackMv", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
public final class PicksStateExpandView extends VRelative {
    ...
    @Metadata(m88120d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0017\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m88121d2 = {"com/p1/mobile/putong/core/ui/vip/picks/view/header/PicksStateExpandView$a", "Landroidx/recyclerview/widget/GridLayoutManager$c;", "", "p0", "f", "(I)I", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class C9136a extends GridLayoutManager.AbstractC0554c {
        @Override // androidx.recyclerview.widget.GridLayoutManager.AbstractC0554c
        /* JADX INFO: renamed from: f */
        public int mo3330f(int p0) {
            return 1;
        }
    }
    ...
    public static void m58007p(sm70 sm70Var, PicksStateExpandView picksStateExpandView, View view) {
        Act act = sm70Var.act();
        i4g0.m138520r("e_picks_module_more", act != null ? act.pageId() : null);
        Intent intentMo36985a9 = CoreMemberModule.m37004F().m187693b().mo36985a9(sm70Var.act());
        Act act2 = sm70Var.act();
        if (act2 != null) {
            act2.startActivity(intentMo36985a9);
        }
        picksStateExpandView.get_close().performClick();
    }

    /* JADX INFO: renamed from: q */
    public static void m58008q(x20 x20Var, View view) {
        x20Var.call();
    }

    /* JADX INFO: renamed from: z */
    public static void m58009z(PicksStateExpandView picksStateExpandView) {
        View childAt;
        if (picksStateExpandView.get_list().getAdapter() == null || (childAt = picksStateExpandView.get_list().getChildAt(0)) == null) {
            return;
        }
        int height = (childAt.getHeight() * 2) + qa00.f156328o;
        ...
        layoutParams2.height = picksStateExpandView.get_goto_picks().getHeight() + picksStateExpandView.get_title_layout().getHeight() + qa00.m175859d(30.0f) + height;
        picksStateExpandView.setLayoutParams(layoutParams2);
    }

    /* JADX INFO: renamed from: B */
    public final void m58010B(View view) {
        io70.m141282a(this, view);
    }

    /* JADX INFO: renamed from: H */
    public final void m58011H(@NotNull final sm70 presenter, @NotNull eo70 adapter, @NotNull List<? extends PicksUser> list, @NotNull final x20 onClose) {
        presenter.getClass();
        adapter.getClass();
        list.getClass();
        onClose.getClass();
        if (!this.hasTrackMv) {
            ...
            i4g0.m138526x("e_picks_module", act != null ? act.pageId() : null);
        }
        bringChildToFront(get_list());
        get_close().setOnClickListener(new View.OnClickListener() { // from class: l.fo70
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PicksStateExpandView.m58008q(onClose, view);
            }
        });
        ...
        gridLayoutManager.m3327v(new C9136a());
        ...
        new C0607k(presenter.m186768m0()).m3751g(get_list());
        adapter.m121736N(list);
        VText vText = get_title();
        Typeface typeface = Typeface.DEFAULT_BOLD;
        vText.setTypeface(typeface);
        get_goto_picks().setTypeface(typeface);
        get_goto_picks().setOnClickListener(new View.OnClickListener() { // from class: l.go70
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PicksStateExpandView.m58007p(presenter, this, view);
            }
        });
        get_list().post(new Runnable() { // from class: l.ho70
            @Override // java.lang.Runnable
            public final void run() {
                PicksStateExpandView.m58009z(this.f110874a);
            }
        });
    }
    ...
    public final VText get_goto_picks() {
        ...
        Intrinsics.m88391r("_goto_picks");
        return null;
    }
    ...
    public final LinearLayout get_title_layout() {
        ...
        Intrinsics.m88391r("_title_layout");
        return null;
    }
