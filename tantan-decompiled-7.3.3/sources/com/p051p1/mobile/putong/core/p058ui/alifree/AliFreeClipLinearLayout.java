...
public class AliFreeClipLinearLayout extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        canvas.clipPath(this.f29295a, Region.Op.INTERSECT);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        Path path = this.f29295a;
        if (path == null) {
            this.f29295a = new Path();
        } else {
            path.reset();
        }
        this.f29295a.addRoundRect(new RectF(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight()), qa00.m175859d(24.0f), qa00.m175859d(24.0f), Path.Direction.CW);
    }
