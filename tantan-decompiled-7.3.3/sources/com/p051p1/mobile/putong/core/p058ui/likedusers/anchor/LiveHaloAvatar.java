...
public final class LiveHaloAvatar extends View {
    ...
    public LiveHaloAvatar(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, nhc0.f141971k);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(nhc0.f141974n, 0);
        this.haloSize = dimensionPixelSize;
        this.avatarSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(nhc0.f141972l, 0);
        int color = typedArrayObtainStyledAttributes.getColor(nhc0.f141975o, -38485);
        this.haloStartColor = color;
        this.haloEndColor = typedArrayObtainStyledAttributes.getColor(nhc0.f141973m, -41238);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(nhc0.f141976p, true);
    ...
    public static final void m47993c(LiveHaloAvatar liveHaloAvatar, ValueAnimator valueAnimator, ValueAnimator valueAnimator2) {
    ...
    public final void m47994b() {
        final ValueAnimator valueAnimator = this.animator;
        valueAnimator.setInterpolator(new LinearInterpolator());
        valueAnimator.setDuration(1500L);
        valueAnimator.setRepeatCount(-1);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: l.dus
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                LiveHaloAvatar.m47993c(this.f90847a, valueAnimator, valueAnimator2);
            }
        });
    }

    /* JADX INFO: renamed from: d */
    public final void m47995d(int haloStartColor, int haloEndColor) {
    ...
    public final void m47996e() {
        m47997f();
        this.animator.start();
    }

    /* JADX INFO: renamed from: f */
    public final void m47997f() {
