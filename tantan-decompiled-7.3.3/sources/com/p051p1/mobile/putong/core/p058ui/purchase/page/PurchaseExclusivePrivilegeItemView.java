...
public final class PurchaseExclusivePrivilegeItemView extends LinearLayout {
    ...
    public static final /* synthetic */ class C8943a {
    ...
    /* JADX INFO: renamed from: a */
    public final void m55319a(View view) {
        hbb0.m134362a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final CharSequence m55320b(PurchaseType purchaseType, Privilege privilege) {
        switch (C8943a.f35746a[privilege.ordinal()]) {
            case 1:
                return "无限右滑";
            case 2:
                ...
                String string = CoreModule.f18263b.getString(R$string.f28298g1);
                string.getClass();
                return string;
            case 3:
                return CoreModule.m30933P().m143405a().mo34436Vf() ? "反悔特权" : "滑错反悔";
            case 4:
                return "修改定位";
            case 5:
                return "会员标识";
            case 6:
                return "解密谁喜欢我";
            case 7:
                return wib0.m206565i(purchaseType) ? "无限次在线闪聊" : "闪聊配对";
            case 8:
                return wib0.m206565i(purchaseType) ? "全程优先推荐" : "每月3次优先推荐";
            case 9:
                return "解锁我喜欢过的人";
            case 10:
                return "语音闪聊";
            ...
            case 18:
                return "每天5条\"资料留言\"";
            case 19:
                return wib0.m206565i(purchaseType) ? "全程动态超级曝光" : String.format("每月%s次动态超级曝光", Integer.valueOf(CoreModule.m30932N().mo61539h8()));
            case 20:
                return "一键配对";
            case 21:
                return "我的访客";
            ...
            case 34:
                return "任意修改定位";
            case 35:
                return String.format("每天%s次免费找搭子特权", Integer.valueOf(CoreModule.f18264c.f20340Q1.f20859R.m35758I()));
            case 36:
                return String.format("每天%s次额外免费盲盒", Integer.valueOf(CoreModule.f18264c.f20340Q1.f20859R.m35757H()));
            case 37:
                return "每天1个超级喜欢";
            case 38:
                return "查看消息是否已读";
    ...
    public final void m55321c(@NotNull PurchaseType purchaseType, @NotNull Privilege privilege) {
        purchaseType.getClass();
        privilege.getClass();
        if (wib0.m206565i(purchaseType)) {
            get_icon().setImageResource(jbc0.f119504a7);
            get_privilege().setTextColor(Color.parseColor("#CCFFDEA2"));
        } else {
            get_icon().setImageResource(jbc0.f119490Z6);
            get_privilege().setTextColor(getResources().getColor(h9c0.f108369g));
        }
        get_privilege().setText(m55320b(purchaseType, privilege));
    }
