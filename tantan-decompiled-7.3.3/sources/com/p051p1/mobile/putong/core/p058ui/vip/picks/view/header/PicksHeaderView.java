...
@Metadata(m88120d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\r\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u000f\u0010\u000b\u001a\u00020\nH\u0014¢\u0006\u0004\b\u000b\u0010\fJ\u0015\u0010\u000f\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\r¢\u0006\u0004\b\u000f\u0010\u0010J\u0017\u0010\u0013\u001a\u00020\n2\u0006\u0010\u0012\u001a\u00020\u0011H\u0002¢\u0006\u0004\b\u0013\u0010\u0014R\"\u0010\u001a\u001a\u00020\u00008\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0013\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019R\"\u0010!\u001a\u00020\u001b8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u000f\u0010\u001c\u001a\u0004\b\u001d\u0010\u001e\"\u0004\b\u001f\u0010 R\"\u0010%\u001a\u00020\u001b8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\"\u0010\u001c\u001a\u0004\b#\u0010\u001e\"\u0004\b$\u0010 R\"\u0010-\u001a\u00020&8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b'\u0010(\u001a\u0004\b)\u0010*\"\u0004\b+\u0010,R\"\u00105\u001a\u00020.8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b/\u00100\u001a\u0004\b1\u00102\"\u0004\b3\u00104R\"\u0010\u000e\u001a\u00020\r8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b6\u00107\u001a\u0004\b8\u00109\"\u0004\b:\u0010\u0010¨\u0006;"}, m88121d2 = {"Lcom/p1/mobile/putong/core/ui/vip/picks/view/header/PicksHeaderView;", "Landroid/widget/FrameLayout;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", "onFinishInflate", "()V", "Lcom/p1/mobile/putong/core/ui/vip/picks/PicksHelper$HeaderType;", "type", "b", "(Lcom/p1/mobile/putong/core/ui/vip/picks/PicksHelper$HeaderType;)V", "Landroid/view/View;", OMSTemplateModeType.view, "a", "(Landroid/view/View;)V", "Lcom/p1/mobile/putong/core/ui/vip/picks/view/header/PicksHeaderView;", "get_picks_header", "()Lcom/p1/mobile/putong/core/ui/vip/picks/view/header/PicksHeaderView;", "set_picks_header", "(Lcom/p1/mobile/putong/core/ui/vip/picks/view/header/PicksHeaderView;)V", "_picks_header", "Landroid/view/ViewStub;", "Landroid/view/ViewStub;", "get_state_hide", "()Landroid/view/ViewStub;", "set_state_hide", "(Landroid/view/ViewStub;)V", "_state_hide", "c", "get_state_expand", "set_state_expand", "_state_expand", "Ll/an70;", Constants.INAPP_DATA_TAG, "Ll/an70;", "getViewModel", "()Ll/an70;", "setViewModel", "(Ll/an70;)V", "viewModel", "Ll/sm70;", "e", "Ll/sm70;", "getPresenter", "()Ll/sm70;", "setPresenter", "(Ll/sm70;)V", "presenter", "f", "Lcom/p1/mobile/putong/core/ui/vip/picks/PicksHelper$HeaderType;", "getType", "()Lcom/p1/mobile/putong/core/ui/vip/picks/PicksHelper$HeaderType;", "setType", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
public final class PicksHeaderView extends FrameLayout {
    ...
    public PicksHeaderView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        context.getClass();
        if (context instanceof ner) {
            setPresenter(new sm70((Act) context));
            setViewModel(new an70(this, context));
            getPresenter().mo52715C(getViewModel());
            getPresenter().mo40472Z();
        }
    }

    /* JADX INFO: renamed from: a */
    public final void m58005a(View view) {
        bn70.m105368a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m58006b(@NotNull PicksHelper.HeaderType type) {
        type.getClass();
        setType(type);
        getPresenter().mo40473a0();
    }

    @NotNull
    public final sm70 getPresenter() {
    ...
    public final PicksHelper.HeaderType getType() {
        ...
        Intrinsics.m88391r("type");
        return null;
    }

    @NotNull
    public final an70 getViewModel() {
        an70 an70Var = this.viewModel;
        if (an70Var != null) {
            return an70Var;
        }
    ...
    public final PicksHeaderView get_picks_header() {
        ...
        Intrinsics.m88391r("_picks_header");
        return null;
    }
    ...
    public final ViewStub get_state_expand() {
        ...
        Intrinsics.m88391r("_state_expand");
        return null;
    }
    ...
    public final ViewStub get_state_hide() {
        ...
        Intrinsics.m88391r("_state_hide");
        return null;
    }
    ...
    public final void setPresenter(@NotNull sm70 sm70Var) {
        sm70Var.getClass();
    ...
    public final void setViewModel(@NotNull an70 an70Var) {
        an70Var.getClass();
        this.viewModel = an70Var;
    }
