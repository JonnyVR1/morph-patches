package com.p051p1.mobile.putong.core.p058ui.lovebuzz.video.end;
...
@Metadata(m88120d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0006\u0018\u0000 \u000e2\u00020\u0001:\u0001\u000fB\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u00020\u00062\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0014¢\u0006\u0004\b\u0007\u0010\bJ\u000f\u0010\t\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\t\u0010\u0003J\u000f\u0010\u000b\u001a\u00020\nH\u0016¢\u0006\u0004\b\u000b\u0010\fJ\u000f\u0010\r\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\r\u0010\u0003¨\u0006\u0010"}, m88121d2 = {"Lcom/p1/mobile/putong/core/ui/lovebuzz/video/end/VideoBuzzCallEndFrag;", "Lcom/p1/mobile/putong/core/ui/lovebuzz/common/BaseBuzzCallEndFrag;", "<init>", "()V", "Landroid/os/Bundle;", "sis", "", "g4", "(Landroid/os/Bundle;)V", "a5", "", "b5", "()Z", "onDestroyView", "Companion", "a", "buzz_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
public final class VideoBuzzCallEndFrag extends BaseBuzzCallEndFrag {
    ...
    public void mo48093a5() {
        ...
        if (videoBuzzAct != null) {
            videoBuzzAct.mo48105X1("search_video");
        }
    }
    ...
    public boolean mo48094b5() {
        ...
        if (loveBuzzDataM134315v0 != null) {
            z = loveBuzzDataM134315v0.remainingVideoBuzz > 0 || loveBuzzDataM134315v0.remainingVoiceBuzz == -1;
    ...
    public void mo21585g4(@Nullable Bundle sis) {
        super.mo21585g4(sis);
        m48088U4().setBackgroundResource(ebc0.f92899p0);
        m48086S4().setBackgroundResource(ebc0.f92897o0);
        boolean zMo48094b5 = mo48094b5();
        nbw nbwVar = nbw.INSTANCE;
        nbwVar.m162215J().m152781p(jyb.m147494Y("buzz_continue", zMo48094b5 ? "true" : "false"));
        w1e.m204402f(nbwVar.m162215J());
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        w1e.m204401e(nbw.INSTANCE.m162215J());
    }
}
