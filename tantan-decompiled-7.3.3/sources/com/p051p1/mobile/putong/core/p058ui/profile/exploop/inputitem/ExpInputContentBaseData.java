...
public class ExpInputContentBaseData implements Serializable {
    ...
    public ExpProfileLoopSelectTypeData getSelectType() {
        return this instanceof ExpProfileLoopSelectTypeData ? (ExpProfileLoopSelectTypeData) this : new ExpProfileLoopSelectTypeData(jyb.m147507f0(new ExpProfileLoopSelectTypeData.ItemData[0]));
    }
