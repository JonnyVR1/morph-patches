...
public class ExpLoopInputHouse extends ExpLoopInputType {
    ...
    public ExpLoopInputHouse() {
        ...
        this.haveHouseStr = CoreModule.f18263b.getString(R$string.f18385D6);
        this.noHouseStr = CoreModule.f18263b.getString(R$string.f19190dk);
        this.notRevealStr = CoreModule.f18263b.getString(R$string.f19066Zj);
        this.regionList = new ArrayList<>();
    }

    private List<String> getSubRegionList(String str) {
        if (!TextUtils.isEmpty(str) && !TextUtils.equals(str, "-") && NullChecker.m82486a(LoopFragmentFactory.m52683u())) {
    ...
    private void setWheelData3(User user, ExpProfileLoopWheelTypeData expProfileLoopWheelTypeData, String str) {
        ...
        if (jyb.m147479J(subRegionList)) {
            expProfileLoopWheelTypeData.selectItem3 = "-";
            expProfileLoopWheelTypeData.wheelData3 = jyb.m147507f0("-");
            return;
        }
    ...
    public void fillInputContentData(final User user, final ExpProfileEditLoopBaseFrag expProfileEditLoopBaseFrag) {
        ...
        if (expProfileEditLoopBaseFrag instanceof ExpProfileLoopWheelTypeFrag) {
            ((ExpProfileLoopWheelTypeFrag) expProfileEditLoopBaseFrag).m52583e5(new a30() { // from class: l.zff
                @Override // p153l.a30
                /* JADX INFO: renamed from: a */
                public final void mo37058a(Object obj, Object obj2, Object obj3) {
                    this.f204127a.lambda$fillInputContentData$0(user, expProfileLoopWheelTypeData, expProfileEditLoopBaseFrag, (Integer) obj, (String) obj2, (Integer) obj3);
                }
            });
        }
    }
    ...
    public boolean hasInfoExist(User user, LoopFragmentFactory.LoopCreateEntryType loopCreateEntryType) {
        return FriendPurposeHelper.m60615j((!NullChecker.m82486a(user.profile.extensions.wealth) || jyb.m147479J(user.profile.extensions.wealth.house)) ? "" : user.profile.extensions.wealth.house.get(0));
    }
    ...
    public boolean hasWheelDataChanged(User user) {
        ...
        if (jyb.m147479J(list) || TextUtils.isEmpty(list.get(0)) || !TextUtils.equals(list.get(0), wheelType.selectItem1)) {
            return true;
        }
        if (jyb.m147479J(list2) || TextUtils.isEmpty(list2.get(0)) || !list2.get(0).equals(wheelType.selectItem2)) {
            zEquals = TextUtils.equals("-", wheelType.selectItem2);
        } else {
            zEquals = (jyb.m147479J(list3) || TextUtils.isEmpty(list3.get(0))) ? TextUtils.equals("-", wheelType.selectItem3) : TextUtils.equals(list3.get(0), wheelType.selectItem3);
        }
        return !zEquals;
    }
    ...
    public void saveUserInfo(User user) {
        ...
        user.profile.extensions.wealth.house = jyb.m147507f0(str);
        user.profile.extensions.wealth.houseRegion = jyb.m147507f0(str4);
        user.profile.extensions.wealth.houseSubRegion = jyb.m147507f0(str3);
    }
    ...
    public void setWheelData2AndData3(User user, ExpProfileLoopWheelTypeData expProfileLoopWheelTypeData, String str) {
        if (!TextUtils.equals(str, this.haveHouseStr)) {
            ...
            if (jyb.m147479J(this.regionList)) {
                return;
            }
