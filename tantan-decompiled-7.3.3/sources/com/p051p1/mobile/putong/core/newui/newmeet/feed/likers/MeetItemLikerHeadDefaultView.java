...
public final class MeetItemLikerHeadDefaultView extends FrameLayout {
    ...
    public MeetItemLikerHeadDefaultView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m43838a(layoutInflaterFrom, this);
        get_title().setTypeface(lyh0.m156283c(3));
    ...
    public final View m43838a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM134440b = hby.m134440b(this, inflater, parent);
        viewM134440b.getClass();
        return viewM134440b;
    }
