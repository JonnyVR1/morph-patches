package com.p051p1.mobile.putong.core.newui.meet;
...
public final class MeetTabView extends ConstraintLayout {
    ...
    public final VText get_num_badge_tv() {
        ...
        Intrinsics.m88391r("_num_badge_tv");
        return null;
    }
    ...
    public final Space get_red_dot_reference_point() {
        ...
        Intrinsics.m88391r("_red_dot_reference_point");
        return null;
    }
    ...
    public final void m41508h0(View view) {
        yfy.m215828a(this, view);
    }

    /* JADX INFO: renamed from: i0 */
    public final void m41509i0() {
        bnl0.m105524M(get_num_badge_tv(), false);
        bnl0.m105524M(get_red_dot(), false);
    }

    /* JADX INFO: renamed from: j0 */
    public final void m41510j0(int newLikersCount) {
        if (newLikersCount > 0) {
            m41513m0(String.valueOf(Math.min(RoomDatabase.MAX_BIND_PARAMETER_CNT, newLikersCount)));
        } else {
            m41509i0();
        }
    }
    ...
    public final void m41511k0(@NotNull CharSequence text) {
        text.getClass();
        get_title_tv().setText(text);
    }

    /* JADX INFO: renamed from: l0 */
    public final void m41512l0(int totalCount, int newCount) {
        m41509i0();
        if (newCount > 0) {
            if (t450.m189176k()) {
                m41513m0(String.valueOf(Math.min(RoomDatabase.MAX_BIND_PARAMETER_CNT, newCount)));
                return;
            } else {
                m41514n0(true);
                return;
    ...
    public final void m41513m0(String count) {
        get_num_badge_tv().setText(count);
        bnl0.m105524M(get_num_badge_tv(), true);
        bnl0.m105524M(get_red_dot(), false);
    }

    /* JADX INFO: renamed from: n0 */
    public final void m41514n0(boolean show) {
