...
public final class MeetNearbyUserItemView extends FrameLayout {
    ...
    public static void m43930a(x20 x20Var, View view) {
        if (x20Var != null) {
            x20Var.call();
        }
    }
    ...
    public final void m43931b(View view) {
        key.m149343a(this, view);
    }

    @NotNull
    /* JADX INFO: renamed from: c */
    public final Act m43932c() {
    ...
    public final String m43933d(int distance) {
        String strValueOf;
        String str = "km";
        if (distance >= 10000) {
            strValueOf = "10+";
    ...
    public final void m43934e(@NotNull User user, boolean hasPrivilege, boolean fromMyTab) {
        user.getClass();
        ...
        if (this.shouldBlur) {
            uqb0.f180374G.m127120O(get_image(), user.m61308fp().profile480().formatted(), 4, 30);
        } else {
    ...
    public final void m43935f(boolean fromMyTab) {
        if (this.shouldBlur) {
            bnl0.m105524M(get_pairing(), false);
            return;
        }
        if (fromMyTab && CoreModule.m30933P().m143405a().mo34609v4()) {
            get_pairing().setImageResource(gbc0.f103399s1);
        }
        bnl0.m105524M(get_pairing(), true);
    }

    /* JADX INFO: renamed from: g */
    public final void m43936g(User user) {
        if (this.shouldBlur) {
            get_blur_desc().setText(m43933d(user.location.distance));
            bnl0.m105524M(get_user_info(), false);
            bnl0.m105524M(get_blur_desc(), true);
        } else {
            get_user_name().setText(user.name);
            get_user_distance().setText(m43933d(user.location.distance));
    ...
    public final void setPairingClickAction(@Nullable final x20 action) {
        bnl0.m105522L(get_pairing(), new View.OnClickListener() { // from class: l.jey
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetNearbyUserItemView.m43930a(action, view);
            }
        });
    }
