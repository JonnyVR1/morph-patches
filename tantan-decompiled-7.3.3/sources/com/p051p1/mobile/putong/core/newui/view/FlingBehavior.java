...
public class FlingBehavior extends AppBarLayout.Behavior {
    ...
    public boolean onNestedFling(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, float f, float f2, boolean z) {
        if ((f2 > 0.0f && !this.f27761a) || (f2 < 0.0f && this.f27761a)) {
            f2 *= -1.0f;
        }
        float f3 = f2;
    ...
    /* JADX INFO: renamed from: b */
    public final void m44894b(Context context) {
        if (NullChecker.m82486a(this.f27762b)) {
            return;
        }
        this.f27762b = new OverScroller(context);
        try {
            Field declaredField = getClass().getSuperclass().getSuperclass().getDeclaredField("mScroller");
            declaredField.setAccessible(true);
            declaredField.set(this, this.f27762b);
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int i, int i2, int[] iArr, int i3) {
        if (NullChecker.m82486a(this.f27762b) && this.f27762b.computeScrollOffset()) {
            this.f27762b.abortAnimation();
        }
