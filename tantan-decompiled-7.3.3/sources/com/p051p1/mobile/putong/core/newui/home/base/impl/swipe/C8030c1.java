...
import com.p051p1.mobile.putong.core.newui.home.base.impl.swipe.C8030c1;
...
public class C8030c1 extends AbstractC8022a {
    /* JADX INFO: renamed from: p */
    public static /* synthetic */ void m38581p(C8049j.a aVar) {
    ...
    public static /* synthetic */ void m38582q(C8049j.a aVar) {
        aVar.f22836a.m101965V8(false);
        if (NullChecker.m82486a(aVar.f22837b.m38128A2().mo39812d()) && (aVar.f22837b.m38128A2().mo39812d() instanceof t7m)) {
    ...
    public VSwipeStack.OnCardSwipeResult mo38500a(final C8049j.a aVar) {
        if (!aVar.f22836a.m102049n6()) {
            ...
            a5i0.m96085B1(aVar.f22837b.act(), PurchaseType.TYPE_GET_LETTER, new x20() { // from class: l.vlh0
                @Override // p153l.x20
                public final void call() {
                    C8030c1.m38581p(aVar);
                }
            }, new x20() { // from class: l.wlh0
                @Override // p153l.x20
                public final void call() {
                    C8030c1.m38582q(aVar);
                }
            });
        }
