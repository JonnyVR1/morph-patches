...
public final class MeetItemLikerHeadView extends FrameLayout {
    ...
    public MeetItemLikerHeadView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        context.getClass();
        this.isNewHeadStyle = CoreModule.m30933P().m143410g().mo36007D9();
        LayoutInflater layoutInflaterFrom = LayoutInflater.from(context);
        layoutInflaterFrom.getClass();
        m43840b(layoutInflaterFrom, this);
    }

    /* JADX INFO: renamed from: a */
    public static void m43839a(x20 x20Var, View view) {
        x20Var.call();
    }

    @NotNull
    /* JADX INFO: renamed from: b */
    public final View m43840b(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM144334b = jby.m144334b(this, inflater, parent);
        viewM144334b.getClass();
        return viewM144334b;
    }

    /* JADX INFO: renamed from: c */
    public final CharSequence m43841c(User user) {
        String strM107525r0 = c17.m107525r0(user.location.distance);
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String string = getContext().getString(R$string.f21374b1);
        string.getClass();
        return String.format(string, Arrays.copyOf(new Object[]{strM107525r0}, 1));
    }

    /* JADX INFO: renamed from: d */
    public final void m43842d(boolean hasSVIPPrivilege, int newLikersCount, int likersTotalCount, @Nullable User user) {
        String str;
        CharSequence charSequenceM43841c;
        if (newLikersCount > 0) {
            str = "收到新喜欢 · " + c17.m107524q0(newLikersCount);
        } else if (hasSVIPPrivilege) {
            str = "喜欢我的人 · " + c17.m107524q0(likersTotalCount);
        } else {
            str = "解密喜欢我的 " + c17.m107524q0(likersTotalCount) + "人";
        }
        if (hasSVIPPrivilege) {
            charSequenceM43841c = "TA喜欢了我? 右滑立即配对!";
        } else if (user == null || (charSequenceM43841c = m43841c(user)) == null) {
            charSequenceM43841c = "";
        }
        if (this.isInMyTabStyle) {
            get_meet_head_layout_my_tab_style().m43964b(str);
            bnl0.m105524M(get_title_layout_default(), false);
            bnl0.m105524M(get_meet_head_layout(), false);
            bnl0.m105524M(get_meet_head_layout_my_tab_style(), true);
            return;
        }
        if (this.isNewHeadStyle) {
            get_meet_head_layout().m43962b(Integer.valueOf(gbc0.f103263b1), str, charSequenceM43841c);
            bnl0.m105524M(get_title_layout_default(), false);
            bnl0.m105524M(get_meet_head_layout(), true);
            bnl0.m105524M(get_meet_head_layout_my_tab_style(), false);
            return;
        }
        get_title_layout_default().get_title().setText(str);
        get_title_layout_default().get_subtitle().setText(charSequenceM43841c);
        bnl0.m105524M(get_title_layout_default(), false);
        bnl0.m105524M(get_meet_head_layout(), true);
        bnl0.m105524M(get_meet_head_layout_my_tab_style(), false);
    }
    ...
    public final void m43843e(boolean hasSVIPPrivilege) {
        String str;
        String str2 = hasSVIPPrivilege ? "喜欢我的人" : "解密谁喜欢我";
        if (hasSVIPPrivilege) {
            str = "右滑越多, 配对越多!";
        } else {
            str = "偷偷知晓" + (c17.m107528u0() ? "他" : "她") + "的心意, 直接配对";
        }
        if (this.isInMyTabStyle) {
            get_meet_head_layout_my_tab_style().m43964b(str2);
            bnl0.m105524M(get_title_layout_default(), false);
            bnl0.m105524M(get_meet_head_layout(), false);
            bnl0.m105524M(get_meet_head_layout_my_tab_style(), true);
            return;
        ...
        if (this.isNewHeadStyle) {
            get_meet_head_layout().m43962b(Integer.valueOf(gbc0.f103263b1), str2, str);
            bnl0.m105524M(get_title_layout_default(), false);
            bnl0.m105524M(get_meet_head_layout(), true);
            bnl0.m105524M(get_meet_head_layout_my_tab_style(), false);
            return;
    ...
    public final void m43844f(boolean isMyTabStyle, @NotNull final x20 e_meet_see_total) {
        e_meet_see_total.getClass();
        this.isInMyTabStyle = isMyTabStyle;
        if (isMyTabStyle) {
            bnl0.m105509E0(get_meet_head_layout_my_tab_style().get_more(), new View.OnClickListener() { // from class: l.iby
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    MeetItemLikerHeadView.m43839a(e_meet_see_total, view);
                }
            });
        }
    }
    ...
    public final MeetItemEntryHeadView get_meet_head_layout() {
        ...
        Intrinsics.m88391r("_meet_head_layout");
        return null;
    }
    ...
    public final MeetItemEntryHeadViewMyTabStyle get_meet_head_layout_my_tab_style() {
        ...
        Intrinsics.m88391r("_meet_head_layout_my_tab_style");
        return null;
    }
    ...
    public final MeetItemLikerHeadDefaultView get_title_layout_default() {
        ...
        Intrinsics.m88391r("_title_layout_default");
        return null;
    }
