...
public final class QuickChatBgTopView extends View {
    ...
    public final void m43085a(int heigh) {
        int i;
        int i2 = f26312j;
        if (heigh <= i2) {
            i = f26310h;
            ...
            int i3 = f26311i;
            i = heigh >= i3 ? f26309g : (((heigh - i2) * (f26309g - f26310h)) / (i3 - i2)) + i2;
        }
        this.rount = i;
        ...
        if (z) {
            ...
            paint.setAlpha((int) (127.5f - ((heigh - i2) * (127.5f / (f26313k - i2)))));
        }
        invalidate();
    }

    /* JADX INFO: renamed from: b */
    public final void m43086b(boolean show) {
        ...
        if (show) {
            ...
            int i2 = f26312j;
            paint.setAlpha((int) (127.5f - ((i - i2) * (127.5f / (f26313k - i2)))));
        }
        invalidate();
    }
