...
public final class SupremeUserHeaderView extends LinearLayout {
    ...
    public static void m44854a(final Act act, View view) {
        if (CoreModule.f18264c.f20386f2.m214441u3() != null && CoreModule.f18264c.f20386f2.m214441u3().hasIdealTypesSelected()) {
            CoreModule.f18264c.f20386f2.m214435L3(act, new x20() { // from class: l.y9h0
                @Override // p153l.x20
                public final void call() {
                    SupremeUserHeaderView.m44856e(act);
                }
            });
        } else if (act != null) {
    ...
    public static final void m44856e(Act act) {
        if (act != null) {
            act.startActivity(SupremeCustomAct.Companion.m44786c(SupremeCustomAct.INSTANCE, act, 0, 2, null));
        }
    }
    ...
    public final void m44857c(View view) {
        z9h0.m219076a(this, view);
    }

    /* JADX INFO: renamed from: d */
    public final void m44858d(@Nullable final Act act, boolean isEmpty, boolean hasIdealTypesSelected) {
        bnl0.m105509E0(get_custom_layout(), new View.OnClickListener() { // from class: l.x9h0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SupremeUserHeaderView.m44854a(act, view);
            }
        });
        if (!isEmpty) {
    ...
    public final void m44859f(TextView textView, int[] colors) {
    ...
    public void onFinishInflate() {
        ...
        m44857c(this);
        m44859f(get_custom_layout_rl_content_title(), new int[]{Color.parseColor("#C5AD7D"), Color.parseColor("#F9ECCA"), Color.parseColor("#C5AD7D")});
        m44859f(get_custom_layout_rl_content_subtitle(), new int[]{Color.parseColor("#B3C5AD7D"), Color.parseColor("#B3F9ECCA"), Color.parseColor("#B3C5AD7D")});
    }
