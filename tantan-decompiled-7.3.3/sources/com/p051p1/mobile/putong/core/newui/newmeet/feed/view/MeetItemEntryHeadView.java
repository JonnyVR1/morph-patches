package com.p051p1.mobile.putong.core.newui.newmeet.feed.view;
...
public final class MeetItemEntryHeadView extends RelativeLayout {
    ...
    public MeetItemEntryHeadView(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m43961a(layoutInflaterFrom, this);
        get_title().setTypeface(lyh0.m156283c(3), 1);
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m43961a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM129813b = gby.m129813b(this, inflater, parent);
        viewM129813b.getClass();
        return viewM129813b;
    }

    /* JADX INFO: renamed from: b */
    public final void m43962b(@DrawableRes @Nullable Integer resourceId, @Nullable CharSequence title, @Nullable CharSequence desc) {
        if (resourceId != null) {
        ...
        bnl0.m105524M(get_icon(), resourceId != null);
        bnl0.m105524M(get_title(), title != null && title.length() > 0);
        bnl0.m105524M(get_desc(), desc != null && desc.length() > 0);
    }
