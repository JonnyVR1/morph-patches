...
@Metadata(m88120d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0017\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B)\b\u0007\u0012\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u0017\u0010\r\u001a\u00020\f2\u0006\u0010\u000b\u001a\u00020\nH\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\fH\u0014¢\u0006\u0004\b\u000f\u0010\u0010J\u0015\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0012\u001a\u00020\u0011¢\u0006\u0004\b\u0013\u0010\u0014J\u0017\u0010\u0017\u001a\u00020\f2\u0006\u0010\u0016\u001a\u00020\u0015H\u0002¢\u0006\u0004\b\u0017\u0010\u0018R\"\u0010\u001f\u001a\u00020\u00198\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0017\u0010\u001a\u001a\u0004\b\u001b\u0010\u001c\"\u0004\b\u001d\u0010\u001eR\"\u0010$\u001a\u00020\n8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0013\u0010 \u001a\u0004\b!\u0010\"\"\u0004\b#\u0010\u000eR\"\u0010(\u001a\u00020\n8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b%\u0010 \u001a\u0004\b&\u0010\"\"\u0004\b'\u0010\u000eR\"\u0010,\u001a\u00020\n8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b)\u0010 \u001a\u0004\b*\u0010\"\"\u0004\b+\u0010\u000eR\"\u00100\u001a\u00020\n8\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b-\u0010 \u001a\u0004\b.\u0010\"\"\u0004\b/\u0010\u000eR\"\u00108\u001a\u0002018\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b2\u00103\u001a\u0004\b4\u00105\"\u0004\b6\u00107¨\u00069"}, m88121d2 = {"Lcom/p1/mobile/putong/core/newui/supreme/SupremeCountDownView;", "Landroid/widget/LinearLayout;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Landroid/widget/TextView;", "textView", "", "setTitleStyles", "(Landroid/widget/TextView;)V", "onFinishInflate", "()V", "", "time", "b", "(J)V", "Landroid/view/View;", OMSTemplateModeType.view, "a", "(Landroid/view/View;)V", "Landroid/widget/RelativeLayout;", "Landroid/widget/RelativeLayout;", "get_rl_content", "()Landroid/widget/RelativeLayout;", "set_rl_content", "(Landroid/widget/RelativeLayout;)V", "_rl_content", "Landroid/widget/TextView;", "get_rl_content_title", "()Landroid/widget/TextView;", "set_rl_content_title", "_rl_content_title", "c", "get_rl_content_tv_hour", "set_rl_content_tv_hour", "_rl_content_tv_hour", Constants.INAPP_DATA_TAG, "get_rl_content_tv_minute", "set_rl_content_tv_minute", "_rl_content_tv_minute", "e", "get_rl_content_tv_second", "set_rl_content_tv_second", "_rl_content_tv_second", "Landroid/widget/ImageView;", "f", "Landroid/widget/ImageView;", "get_image", "()Landroid/widget/ImageView;", "set_image", "(Landroid/widget/ImageView;)V", "_image", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
public final class SupremeCountDownView extends LinearLayout {
    ...
    public /* synthetic */ SupremeCountDownView(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final void m44782a(View view) {
        t7h0.m189574a(this, view);
    }

    /* JADX INFO: renamed from: b */
    public final void m44783b(long time) {
        List<String> listM174450k = pzi0.m174450k(time);
        if (listM174450k.size() == 1) {
            get_rl_content_tv_hour().setText("0");
            get_rl_content_tv_minute().setText("0");
            get_rl_content_tv_second().setText("1");
        } else {
            get_rl_content_tv_hour().setText(listM174450k.get(0));
            get_rl_content_tv_minute().setText(listM174450k.get(1));
            get_rl_content_tv_second().setText(listM174450k.get(2));
        }
    }
    ...
    public final RelativeLayout get_rl_content() {
        ...
        Intrinsics.m88391r("_rl_content");
        return null;
    }
    ...
    public final TextView get_rl_content_title() {
        ...
        Intrinsics.m88391r("_rl_content_title");
        return null;
    }
    ...
    public final TextView get_rl_content_tv_hour() {
        ...
        Intrinsics.m88391r("_rl_content_tv_hour");
        return null;
    }
    ...
    public final TextView get_rl_content_tv_minute() {
        ...
        Intrinsics.m88391r("_rl_content_tv_minute");
        return null;
    }
    ...
    public final TextView get_rl_content_tv_second() {
        ...
        Intrinsics.m88391r("_rl_content_tv_second");
        return null;
    }
    ...
    @JvmOverloads
    public SupremeCountDownView(@Nullable Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
    }

    @JvmOverloads
    public SupremeCountDownView(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
    }

    @JvmOverloads
    public SupremeCountDownView(@Nullable Context context) {
