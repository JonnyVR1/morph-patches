...
public class C8081w extends AbstractC8022a {
    @Override // p153l.g6m
    /* JADX INFO: renamed from: r, reason: merged with bridge method [inline-methods] */
    public VSwipeStack.OnCardSwipeResult mo38500a(final C8049j.a aVar) {
        CoreModule.f18264c.f20405m0.f20193t0.put(Boolean.TRUE);
        CoreDlg.m46301y1(aVar.f22837b.act(), aVar.f22838c.m140259d(), true, new Runnable() { // from class: l.igh0
            @Override // java.lang.Runnable
            public final void run() {
                aVar.f22837b.m38128A2().mo39825y();
            }
        }, new Runnable() { // from class: l.jgh0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean mo38501b(C8049j.a aVar) {
        return (aVar.f22839d == SwipeDirection.UP || d09.m113370g() || !m38514k(aVar) || CoreModule.f18264c.f20405m0.f20193t0.get().booleanValue()) ? false : true;
    }
}
