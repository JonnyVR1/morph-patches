...
public final class MeetItemEntryHeadViewMyTabStyle extends LinearLayout {
    ...
    public MeetItemEntryHeadViewMyTabStyle(@Nullable Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m43963a(layoutInflaterFrom, this);
        get_title().setTypeface(lyh0.m156283c(3), 0);
        if (CoreModule.m30933P().m143405a().mo34609v4()) {
            get_more().setCompoundDrawablesWithIntrinsicBounds(0, 0, gbc0.f103335k1, 0);
        } else {
            get_more().setCompoundDrawablesWithIntrinsicBounds(0, 0, gbc0.f103327j1, 0);
        }
    }

    @NotNull
    /* JADX INFO: renamed from: a */
    public final View m43963a(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM124966b = fby.m124966b(this, inflater, parent);
        viewM124966b.getClass();
        return viewM124966b;
    }

    /* JADX INFO: renamed from: b */
    public final void m43964b(@Nullable CharSequence title) {
        if (title != null) {
