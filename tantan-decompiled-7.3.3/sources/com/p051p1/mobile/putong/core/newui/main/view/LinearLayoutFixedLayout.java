...
public class LinearLayoutFixedLayout extends FrameLayout {
    ...
    public LinearLayoutFixedLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, khc0.f126746M0);
            this.f25288a = typedArrayObtainStyledAttributes.getDimension(khc0.f126749N0, 0.0f);
