...
public final class NearbyAct extends PutongAct {
    ...
    @Metadata(m88120d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001f\u0010\t\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0007¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, m88121d2 = {"Lcom/p1/mobile/putong/core/newui/nearby/NearbyAct$a;", "", "<init>", "()V", "Landroid/content/Context;", "context", "", "from", "Landroid/content/Intent;", "a", "(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;", "member_intlGmsRelease"}, m88122k = 1, m88123mv = {2, 2, 0}, m88125xi = 48)
    public static final class Companion {
        ...
        public final Intent m43704a(@NotNull Context context, @NotNull String from) {
            context.getClass();
            from.getClass();
    ...
    public static final Intent m43703X1(@NotNull Context context, @NotNull String str) {
        return INSTANCE.m43704a(context, str);
    }
    ...
    public View inflateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup parent) {
        ...
        frameLayout.setId(ddc0.f87914t);
        FragmentManager supportFragmentManager = this.act.getSupportFragmentManager();
        supportFragmentManager.getClass();
        Fragment fragmentM2558i0 = supportFragmentManager.m2558i0(this.FRAG_TAG);
        if (rs9.INSTANCE.m182943c()) {
            if (fragmentM2558i0 instanceof SupremePartnerTabFrag) {
                this.frag = (PutongFrag) fragmentM2558i0;
                return frameLayout;
            }
            ...
            abstractC0428kM2568m.m2805c(ddc0.f87914t, supremePartnerTabFrag, this.FRAG_TAG);
            abstractC0428kM2568m.mo2709j();
            this.frag = supremePartnerTabFrag;
            return frameLayout;
        }
        if (fragmentM2558i0 instanceof NearbyFrag) {
            this.frag = (PutongFrag) fragmentM2558i0;
            return frameLayout;
        }
        NearbyFrag nearbyFragM43719b = NearbyFrag.Companion.m43719b(NearbyFrag.INSTANCE, null, 1, null);
        Bundle bundle2 = new Bundle();
        bundle2.putBoolean("hideNavigation", false);
        bundle2.putString("from", getIntent().getStringExtra("from"));
        nearbyFragM43719b.setArguments(bundle2);
        getIntent().putExtra("hideNavigation", false);
        AbstractC0428k abstractC0428kM2568m2 = supportFragmentManager.m2568m();
        abstractC0428kM2568m2.getClass();
        abstractC0428kM2568m2.m2805c(ddc0.f87914t, nearbyFragM43719b, this.FRAG_TAG);
        abstractC0428kM2568m2.mo2709j();
        this.frag = nearbyFragM43719b;
        return frameLayout;
    }
