package com.p051p1.mobile.putong.core.newui.newmeet.feed.weekly;
...
public final class MeetFeedSvipWeeklyItemView extends LinearLayout {
    ...
    public static void m43965a(MeetFeedSvipWeeklyItemView meetFeedSvipWeeklyItemView, View view) {
        meetFeedSvipWeeklyItemView.m43972h();
    }

    /* JADX INFO: renamed from: b */
    public static void m43966b(MeetFeedSvipWeeklyItemView meetFeedSvipWeeklyItemView, View view) {
        i4g0.m138520r("e_svip_report_rebuy", "p_meet");
        Act act = meetFeedSvipWeeklyItemView.getPresenter().act();
        if (act != null) {
            CoreModule.m30933P().m143405a().mo34568pr(act, "p_meet,e_svip_report_rebuy,click", Privilege.see_who_likes_me);
        }
    }

    /* JADX INFO: renamed from: c */
    public static void m43967c(MeetFeedSvipWeeklyItemView meetFeedSvipWeeklyItemView, View view) {
        i4g0.m138520r("e_svip_report_upgrade", "p_meet");
        Act act = meetFeedSvipWeeklyItemView.getPresenter().act();
        if (act != null) {
            CoreModule.m30933P().m143410g().mo36024Og(act, "p_meet,e_svip_report_upgrade,click", null, null, null, Privilege.oDiamondVisitor);
        }
    }

    /* JADX INFO: renamed from: d */
    public final void m43968d(View view) {
        may.m157755a(this, view);
    }

    /* JADX INFO: renamed from: e */
    public final void m43969e() {
        ...
        bnl0.m105524M(get_weekly_content_container(), false);
        get_header_arrow_ic().setImageResource(gbc0.f103379p5);
    }

    /* JADX INFO: renamed from: f */
    public final void m43970f() {
        int i = this.curArrowState;
        ...
        this.curArrowState = i2;
        bnl0.m105524M(get_weekly_content_container(), true);
        get_header_arrow_ic().setImageResource(gbc0.f103387q5);
        m43974j();
    }

    /* JADX INFO: renamed from: g */
    public final void m43971g(Act act) {
        if (act != null) {
            get_weekly_content_root().removeAllViews();
            this.hasInitedWeeklyItem = true;
            iay iayVar = iay.INSTANCE;
            List<MeetFeedSvipWeeklyItemData.SvipWeeklyItem> list = getWeeklyItemData().svipWeeklyItems;
            list.getClass();
            iayVar.m139219j(act, list, get_weekly_content_root());
        }
    }
    ...
    public final MeetFeedSvipWeeklyItemData getWeeklyItemData() {
        ...
        Intrinsics.m88391r("weeklyItemData");
        return null;
    }
    ...
    public final ImageView get_header_arrow_ic() {
        ...
        Intrinsics.m88391r("_header_arrow_ic");
        return null;
    }
    ...
    public final RelativeLayout get_header_container() {
        ...
        Intrinsics.m88391r("_header_container");
        return null;
    }
    ...
    public final ImageView get_header_privilege_ic() {
        ...
        Intrinsics.m88391r("_header_privilege_ic");
        return null;
    }
    ...
    public final VText get_header_subtitle() {
        ...
        Intrinsics.m88391r("_header_subtitle");
        return null;
    }
    ...
    public final VText get_header_title() {
        ...
        Intrinsics.m88391r("_header_title");
        return null;
    }
    ...
    public final VText get_odiamond_buy_btn() {
        ...
        Intrinsics.m88391r("_odiamond_buy_btn");
        return null;
    }
    ...
    public final VText get_svip_renew_btn() {
        ...
        Intrinsics.m88391r("_svip_renew_btn");
        return null;
    }
    ...
    public final VLinear get_weekly_content_container() {
        ...
        Intrinsics.m88391r("_weekly_content_container");
        return null;
    }
    ...
    public final VLinear get_weekly_content_root() {
        ...
        Intrinsics.m88391r("_weekly_content_root");
        return null;
    }

    /* JADX INFO: renamed from: h */
    public final void m43972h() {
        String str;
        int i = this.curArrowState;
        ...
        i4g0.m138523u("e_svip_weekly_report", "p_meet", jyb.m147494Y("action", str));
    }

    /* JADX INFO: renamed from: i */
    public final void m43973i(@NotNull MeetFeedSvipWeeklyItemData weeklyItemData, @NotNull NewMeetFragPresenter presenter) {
        weeklyItemData.getClass();
        presenter.getClass();
        if (this.weeklyItemData != null && !Intrinsics.m88377d(getWeeklyItemData(), weeklyItemData)) {
            this.hasInitedWeeklyItem = false;
        }
        setWeeklyItemData(weeklyItemData);
        setPresenter(presenter);
        if (!this.hasInitedWeeklyItem) {
            m43971g(getPresenter().act());
        }
        if (this.curArrowState == this.ARROW_STATE_TYPE_UN_INITIALIZED) {
            if (Intrinsics.m88377d("svip_weekly_report", presenter.getFrom())) {
                m43970f();
            } else {
                m43969e();
            }
        ...
        bnl0.m105509E0(get_header_arrow_ic(), new View.OnClickListener() { // from class: l.jay
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetFeedSvipWeeklyItemView.m43965a(this.f119071a, view);
            }
        });
        bnl0.m105509E0(get_svip_renew_btn(), new View.OnClickListener() { // from class: l.kay
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetFeedSvipWeeklyItemView.m43966b(this.f124731a, view);
            }
        });
        bnl0.m105509E0(get_odiamond_buy_btn(), new View.OnClickListener() { // from class: l.lay
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MeetFeedSvipWeeklyItemView.m43967c(this.f130746a, view);
            }
        });
    }

    /* JADX INFO: renamed from: j */
    public final void m43974j() {
        ...
        i4g0.m138527y("e_svip_report_module", "p_meet", map);
    }

    /* JADX INFO: renamed from: k */
    public final void m43975k() {
        String str;
        ...
        i4g0.m138492A("e_svip_weekly_report", "p_meet", jyb.m147494Y("action", str));
