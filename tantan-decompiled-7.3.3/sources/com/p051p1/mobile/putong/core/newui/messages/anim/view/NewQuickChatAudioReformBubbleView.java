...
public final class NewQuickChatAudioReformBubbleView extends QuickChatAudioBaseHeaderUserView {
    ...
    public NewQuickChatAudioReformBubbleView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        m43015n0(layoutInflaterM171370a, this);
        this.floatFormat = new DecimalFormat("#.0");
    }

    /* JADX INFO: renamed from: k0 */
    public static void m43011k0(z20 z20Var, boolean z, View view) {
        z20Var.call(Boolean.valueOf(z), "");
    }

    /* JADX INFO: renamed from: l0 */
    public static void m43012l0(z20 z20Var, boolean z, View view) {
        z20Var.call(Boolean.valueOf(z), "");
    }

    /* JADX INFO: renamed from: m0 */
    public static void m43013m0(y20 y20Var, boolean z, View view) {
        y20Var.call(Boolean.valueOf(z));
    }

    /* JADX INFO: renamed from: o0 */
    private final String m43014o0(Location location) {
        int i;
    ...
    public final VText get_name_age_info() {
        ...
        Intrinsics.m88391r("_name_age_info");
        return null;
    }
    ...
    public final ImageView get_quick_chat_pop_icon() {
        ...
        Intrinsics.m88391r("_quick_chat_pop_icon");
        return null;
    }
    ...
    public final TextView get_quick_chat_pop_info() {
        ...
        Intrinsics.m88391r("_quick_chat_pop_info");
        return null;
    }
    ...
    public void mo43009j0(@Nullable Act act, @Nullable OnlineMatchPushUser onlineMatchPushUser, final boolean isMatch, @Nullable OnlineMatchMatchUser matchUser, @NotNull final z20<Boolean, String> click, @NotNull final y20<Boolean> close) {
        ...
        get_name_age_info().setText(m43016p0(user));
        String str = onlineMatchPushUser != null ? onlineMatchPushUser.fitReason : null;
        if (Intrinsics.m88377d(str, "distance")) {
            m43018r0(user);
        } else if (Intrinsics.m88377d(str, ProfileLikeCategoryType.friendPurpose)) {
            m43019s0(onlineMatchPushUser.friendPurpose);
        } else {
            m43017q0(user);
        }
        get_gotochat().setText("立即和" + (user.isFemale() ? "她" : "他") + "聊");
        setOnClickListener(new View.OnClickListener() { // from class: l.nh40
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NewQuickChatAudioReformBubbleView.m43012l0(click, isMatch, view);
            }
        });
        get_gotochat().setOnClickListener(new View.OnClickListener() { // from class: l.oh40
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NewQuickChatAudioReformBubbleView.m43011k0(click, isMatch, view);
            }
        });
        get_close().setOnClickListener(new View.OnClickListener() { // from class: l.ph40
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NewQuickChatAudioReformBubbleView.m43013m0(close, isMatch, view);
            }
        });
    }
    ...
    public final View m43015n0(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM176530b = qh40.m176530b(this, inflater, parent);
        viewM176530b.getClass();
        return viewM176530b;
    }

    /* JADX INFO: renamed from: p0 */
    public final String m43016p0(User user) {
    ...
    public final void m43017q0(User user) {
        get_quick_chat_pop_icon().setImageResource(dbc0.f86513Qo);
        get_quick_chat_pop_info().setText("附近的" + (user.isFemale() ? "她" : "他") + "刚发来一条消息");
    }

    /* JADX INFO: renamed from: r0 */
    public final void m43018r0(User user) {
        get_quick_chat_pop_icon().setImageResource(dbc0.f86545Ro);
        get_quick_chat_pop_info().setText("与你相距" + m43014o0(user.location));
    }

    /* JADX INFO: renamed from: s0 */
    public final void m43019s0(String friendPurpose) {
        get_quick_chat_pop_icon().setImageResource(dbc0.f86577So);
        get_quick_chat_pop_info().setText(h1c0.INSTANCE.m133320a(friendPurpose));
    }
