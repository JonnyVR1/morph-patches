package com.p051p1.mobile.putong.core.newui.mytab.biz4.container;
...
public final class NewMyTabBiz4TabItem extends RelativeLayout {
    ...
    public final void setBadge(int num) {
        if (num < 0) {
            bnl0.m105524M(get_badge(), false);
            return;
        }
        get_badge().setMinWidth(num == 0 ? qa00.m175859d(12.0f) : qa00.m175859d(20.0f));
        ViewGroup.LayoutParams layoutParams = get_badge().getLayoutParams();
        layoutParams.width = num == 0 ? qa00.m175859d(12.0f) : -2;
        layoutParams.height = num == 0 ? qa00.m175859d(12.0f) : qa00.m175859d(20.0f);
    ...
    public void setSelected(boolean selected) {
        bnl0.m105524M(get_indicator(), selected);
    }
