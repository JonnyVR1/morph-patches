...
public class MeetAct extends PutongMvpAct<wey, hgy> {
    /* JADX INFO: renamed from: Z1 */
    public static Intent m41505Z1(Context context, String str, String str2) {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (((wey) this.f17891c).m206039k0(i, i2, intent)) {
            return;
        }
