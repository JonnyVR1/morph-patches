...
public final class QuickChatAudioNewUiHeaderUserView extends QuickChatAudioBaseHeaderUserView {
    ...
    public static void m43081k0(z20 z20Var, boolean z, View view) {
        z20Var.call(Boolean.valueOf(z), "");
    }

    /* JADX INFO: renamed from: l0 */
    public static void m43082l0(z20 z20Var, boolean z, View view) {
        z20Var.call(Boolean.valueOf(z), "");
    }

    /* JADX INFO: renamed from: m0 */
    public static void m43083m0(y20 y20Var, boolean z, View view) {
    ...
    public void init() {
        ...
        m43084n0(layoutInflaterM171370a, this);
    }
    ...
    public void mo43009j0(@Nullable Act act, @Nullable OnlineMatchPushUser onlineMatchPushUser, final boolean isMatch, @Nullable OnlineMatchMatchUser matchUser, @NotNull final z20<Boolean, String> click, @NotNull final y20<Boolean> close) {
        ...
        setOnClickListener(new View.OnClickListener() { // from class: l.x0c0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                QuickChatAudioNewUiHeaderUserView.m43082l0(click, isMatch, view);
            }
        });
        get_gotochat().setOnClickListener(new View.OnClickListener() { // from class: l.y0c0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                QuickChatAudioNewUiHeaderUserView.m43081k0(click, isMatch, view);
            }
        });
        get_close().setOnClickListener(new View.OnClickListener() { // from class: l.z0c0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                QuickChatAudioNewUiHeaderUserView.m43083m0(close, isMatch, view);
            }
        });
    }
    ...
    public final View m43084n0(@NotNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        inflater.getClass();
        View viewM95483b = a1c0.m95483b(this, inflater, parent);
        viewM95483b.getClass();
        return viewM95483b;
    }
