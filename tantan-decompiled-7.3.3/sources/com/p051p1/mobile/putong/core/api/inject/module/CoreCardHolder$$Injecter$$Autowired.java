...
public class CoreCardHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) mum.m160228d().m160230a("/card_module/module").navigation();
        ((CoreCardHolder) obj).cardModule = module;
        if (module != null) {
            return;
        }
        zzq0.m222278a("The field 'cardModule' is null, in class '", CoreCardHolder.class.getName(), "!");
    }
}
