...
public class CoreInnovationHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) mum.m160228d().m160230a("/innovation_module/module").navigation();
        ((CoreInnovationHolder) obj).innovationModule = module;
        if (module != null) {
            return;
        }
        zzq0.m222278a("The field 'innovationModule' is null, in class '", CoreInnovationHolder.class.getName(), "!");
    }
}
