...
public class CoreProfileHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) mum.m160228d().m160230a("/profile_module/module").navigation();
        ((CoreProfileHolder) obj).profileModule = module;
        if (module != null) {
            return;
        }
        zzq0.m222278a("The field 'profileModule' is null, in class '", CoreProfileHolder.class.getName(), "!");
    }
}
