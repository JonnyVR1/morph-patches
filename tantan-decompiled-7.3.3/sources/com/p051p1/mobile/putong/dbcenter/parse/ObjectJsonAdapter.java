package com.p051p1.mobile.putong.dbcenter.parse;
...
public abstract class ObjectJsonAdapter<T extends ValueObject> extends JsonAdapter<T> {
    ...
    public T parse(JsonParser jsonParser, String str, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
        ...
        if (valueObjectNewInstance instanceof Data) {
            ...
            ArrayList<ObjectJsonAdapter> arrayListM182816a = rrq.m182815b().m182816a();
            ArrayList<Pair> arrayList3 = new ArrayList();
            ArrayList<BaseData> arrayList4 = new ArrayList<>();
            for (ObjectJsonAdapter objectJsonAdapter : arrayListM182816a) {
            ...
            ArrayList<Pair<String, ObjectJsonAdapter>> arrayListM182817c = rrq.m182815b().m182817c(classParseName);
            if (arrayListM182817c == null || arrayListM182817c.size() <= 0) {
                z = false;
                arrayList2 = null;
                map = null;
            } else {
                ...
                z = false;
                for (Pair<String, ObjectJsonAdapter> pair4 : arrayListM182817c) {
