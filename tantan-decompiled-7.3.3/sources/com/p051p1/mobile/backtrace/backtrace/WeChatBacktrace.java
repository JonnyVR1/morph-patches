...
public class WeChatBacktrace {
    ...
    public static /* synthetic */ class C45382 {

        /* JADX INFO: renamed from: $SwitchMap$com$p1$mobile$backtrace$backtrace$WeChatBacktrace$Mode */
        static final /* synthetic */ int[] f16642xf4ed677d;

        static {
            int[] iArr = new int[Mode.values().length];
            f16642xf4ed677d = iArr;
            try {
                iArr[Mode.Fp.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16642xf4ed677d[Mode.Quicken.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16642xf4ed677d[Mode.Dwarf.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16642xf4ed677d[Mode.FpUntilQuickenWarmedUp.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16642xf4ed677d[Mode.DwarfUntilQuickenWarmedUp.ordinal()] = 5;
    ...
    public enum Mode {
        ...
        public String toString() {
            int i = C45382.f16642xf4ed677d[ordinal()];
            if (i == 1) {
    ...
    public void configure(Configuration configuration) throws Throwable {
        if (runningInIsolateProcess(configuration)) {
            MatrixLog.m22185i(TAG, "Isolate process does not need any configuration.", new Object[0]);
            return;
        }
        ...
        MatrixLog.m22185i(TAG, configuration.toString(), new Object[0]);
        ...
        if (mode3 == mode4 || mode3 == Mode.FpUntilQuickenWarmedUp || mode3 == Mode.DwarfUntilQuickenWarmedUp || configuration.mQuickenAlwaysOn) {
            ...
            MatrixLog.m22185i(TAG, "Set saving path: %s", strValidateSavingPath);
            ...
            MatrixLog.m22185i(TAG, "Has warmed up: %s", Boolean.valueOf(zHasWarmedUp));
        ...
        if (configuration.mIsWarmUpProcess) {
            ...
            if (configuration.mCoolDownIfApkUpdated && fileWarmUpMarkedFile.exists()) {
                ...
                if (fileContent == null) {
                    ...
                    MatrixLog.m22185i(TAG, "Apk updated, remove warmed-up file.", new Object[0]);
                    configuration.mCoolDown = true;
                }
            }
    ...
    public static void loadLibrary(LibraryLoader libraryLoader) {
        ...
        if (libraryLoader == null) {
            ...
            MatrixLog.m22185i(TAG, "Using custom library loader: %s.", libraryLoader);
