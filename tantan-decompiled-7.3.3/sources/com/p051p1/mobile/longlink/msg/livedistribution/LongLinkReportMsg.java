package com.p051p1.mobile.longlink.msg.livedistribution;
...
public final class LongLinkReportMsg {
    ...
    public static /* synthetic */ class C45971 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16676xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16676xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16676xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface LiveReportMsgOrBuilder extends lfz {
        String getData();
    ...
    public static final class LiveReportMsg extends GeneratedMessageLite<LiveReportMsg, Builder> implements LiveReportMsgOrBuilder {
        ...
        private static volatile ng60<LiveReportMsg> PARSER = null;
        public static final int REPORTTYPE_FIELD_NUMBER = 1;
        private long delaySeconds_;
        private String reportType_ = "";
        private String data_ = "";

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<LiveReportMsg, Builder> implements LiveReportMsgOrBuilder {
            private Builder() {
        ...
        public static ng60<LiveReportMsg> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45971.f16676xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.reportType_ = interfaceC3409h.mo17052f(!this.reportType_.isEmpty(), this.reportType_, !liveReportMsg.reportType_.isEmpty(), liveReportMsg.reportType_);
                    long j = this.delaySeconds_;
                    boolean z2 = j != 0;
                    long j2 = liveReportMsg.delaySeconds_;
                    this.delaySeconds_ = interfaceC3409h.mo17055i(z2, j, j2 != 0, j2);
                    this.data_ = interfaceC3409h.mo17052f(!this.data_.isEmpty(), this.data_, !liveReportMsg.data_.isEmpty(), liveReportMsg.data_);
                ...
                case 6:
                    ...
                    while (!z) {
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    this.reportType_ = c3430e.m17170L();
                                } else if (iM17171M == 16) {
                                    this.delaySeconds_ = c3430e.m17197v();
                                } else if (iM17171M == 26) {
        ...
        public int getSerializedSize() {
            ...
            int iM16956K = !this.reportType_.isEmpty() ? CodedOutputStream.m16956K(1, getReportType()) : 0;
            long j = this.delaySeconds_;
            if (j != 0) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.reportType_.isEmpty()) {
                codedOutputStream.mo16994D0(1, getReportType());
            }
            long j = this.delaySeconds_;
            if (j != 0) {
        ...
        public static LiveReportMsg parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveReportMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveReportMsg parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveReportMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static LiveReportMsg parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveReportMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static LiveReportMsg parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveReportMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveReportMsg parseFrom(C3430e c3430e) throws IOException {
            return (LiveReportMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static LiveReportMsg parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (LiveReportMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
}
