package com.p051p1.mobile.longlink.msg.liveredpacket;
...
public final class LongLinkRedPacketMessage {
    ...
    public static /* synthetic */ class C46071 {
        ...
        static {
            ...
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16683xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface JoinLotteryGiftRedPacketMsgOrBuilder extends lfz {
        @Override // p153l.lfz
    ...
    public static final class JoinLotteryGiftRedPacketMsg extends GeneratedMessageLite<JoinLotteryGiftRedPacketMsg, Builder> implements JoinLotteryGiftRedPacketMsgOrBuilder {
        ...
        private static volatile ng60<JoinLotteryGiftRedPacketMsg> PARSER = null;
        ...
        public static ng60<JoinLotteryGiftRedPacketMsg> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C46071.f16683xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.userId_ = interfaceC3409h.mo17052f(!this.userId_.isEmpty(), this.userId_, !joinLotteryGiftRedPacketMsg.userId_.isEmpty(), joinLotteryGiftRedPacketMsg.userId_);
                    this.userName_ = interfaceC3409h.mo17052f(!this.userName_.isEmpty(), this.userName_, !joinLotteryGiftRedPacketMsg.userName_.isEmpty(), joinLotteryGiftRedPacketMsg.userName_);
                    this.jumpScheme_ = interfaceC3409h.mo17052f(!this.jumpScheme_.isEmpty(), this.jumpScheme_, !joinLotteryGiftRedPacketMsg.jumpScheme_.isEmpty(), joinLotteryGiftRedPacketMsg.jumpScheme_);
                    boolean z = this.isAggregate_;
                    boolean z2 = joinLotteryGiftRedPacketMsg.isAggregate_;
                    this.isAggregate_ = interfaceC3409h.mo17050d(z, z, z2, z2);
                    this.roomId_ = interfaceC3409h.mo17052f(!this.roomId_.isEmpty(), this.roomId_, true ^ joinLotteryGiftRedPacketMsg.roomId_.isEmpty(), joinLotteryGiftRedPacketMsg.roomId_);
                    this.template_ = (Template.TemplateData) interfaceC3409h.mo17061o(this.template_, joinLotteryGiftRedPacketMsg.template_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.isAggregate_ = c3430e.m17188m();
                                } else if (iM17171M == 42) {
        ...
        public int getSerializedSize() {
            ...
            if (!this.jumpScheme_.isEmpty()) {
                iM16956K += CodedOutputStream.m16956K(3, getJumpScheme());
            }
            boolean z = this.isAggregate_;
            if (z) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.jumpScheme_.isEmpty()) {
                codedOutputStream.mo16994D0(3, getJumpScheme());
            }
            boolean z = this.isAggregate_;
            if (z) {
        ...
        public static JoinLotteryGiftRedPacketMsg parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (JoinLotteryGiftRedPacketMsg) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static JoinLotteryGiftRedPacketMsg parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (JoinLotteryGiftRedPacketMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<JoinLotteryGiftRedPacketMsg, Builder> implements JoinLotteryGiftRedPacketMsgOrBuilder {
            private Builder() {
        ...
        public static JoinLotteryGiftRedPacketMsg parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (JoinLotteryGiftRedPacketMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static JoinLotteryGiftRedPacketMsg parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (JoinLotteryGiftRedPacketMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static JoinLotteryGiftRedPacketMsg parseFrom(C3430e c3430e) throws IOException {
            return (JoinLotteryGiftRedPacketMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static JoinLotteryGiftRedPacketMsg parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (JoinLotteryGiftRedPacketMsg) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
}
