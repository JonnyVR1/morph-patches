package com.p051p1.mobile.longlink.msg.livePkRank;
...
public final class LongLinkSocketMessage {
    ...
    public static /* synthetic */ class C45831 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16670xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16670xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16670xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface PkRankUpgradeOrBuilder extends lfz {
        String getAnchorId();
    ...
    public static final class PkRankUpgrade extends GeneratedMessageLite<PkRankUpgrade, Builder> implements PkRankUpgradeOrBuilder {
        ...
        private static volatile ng60<PkRankUpgrade> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<PkRankUpgrade, Builder> implements PkRankUpgradeOrBuilder {
            private Builder() {
        ...
        public static ng60<PkRankUpgrade> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C45831.f16670xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.anchorId_ = interfaceC3409h.mo17052f(!this.anchorId_.isEmpty(), this.anchorId_, !pkRankUpgrade.anchorId_.isEmpty(), pkRankUpgrade.anchorId_);
                    this.anchorName_ = interfaceC3409h.mo17052f(!this.anchorName_.isEmpty(), this.anchorName_, !pkRankUpgrade.anchorName_.isEmpty(), pkRankUpgrade.anchorName_);
                    this.rankName_ = interfaceC3409h.mo17052f(!this.rankName_.isEmpty(), this.rankName_, !pkRankUpgrade.rankName_.isEmpty(), pkRankUpgrade.rankName_);
                    long j = this.starCount_;
                    boolean z2 = j != 0;
                    long j2 = pkRankUpgrade.starCount_;
                    this.starCount_ = interfaceC3409h.mo17055i(z2, j, j2 != 0, j2);
                    this.rankSvga_ = interfaceC3409h.mo17052f(!this.rankSvga_.isEmpty(), this.rankSvga_, !pkRankUpgrade.rankSvga_.isEmpty(), pkRankUpgrade.rankSvga_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.rankName_ = c3430e.m17170L();
                                } else if (iM17171M == 32) {
                                    this.starCount_ = c3430e.m17197v();
                                } else if (iM17171M == 42) {
                                    this.rankSvga_ = c3430e.m17170L();
        ...
        public int getSerializedSize() {
            ...
            if (!this.anchorName_.isEmpty()) {
                iM16956K += CodedOutputStream.m16956K(2, getAnchorName());
            }
            if (!this.rankName_.isEmpty()) {
                iM16956K += CodedOutputStream.m16956K(3, getRankName());
            }
            long j = this.starCount_;
            if (j != 0) {
            ...
            if (!this.rankSvga_.isEmpty()) {
                iM16956K += CodedOutputStream.m16956K(5, getRankSvga());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.anchorName_.isEmpty()) {
                codedOutputStream.mo16994D0(2, getAnchorName());
            }
            if (!this.rankName_.isEmpty()) {
                codedOutputStream.mo16994D0(3, getRankName());
            }
            long j = this.starCount_;
            if (j != 0) {
            ...
            codedOutputStream.mo16994D0(5, getRankSvga());
        }

        public static PkRankUpgrade parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (PkRankUpgrade) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static PkRankUpgrade parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (PkRankUpgrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static PkRankUpgrade parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (PkRankUpgrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static PkRankUpgrade parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (PkRankUpgrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static PkRankUpgrade parseFrom(C3430e c3430e) throws IOException {
            return (PkRankUpgrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static PkRankUpgrade parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (PkRankUpgrade) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
}
