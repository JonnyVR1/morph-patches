...
public final class LongLinkMessage {
    ...
    public static /* synthetic */ class C45541 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16654xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16654xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16654xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface I18nOrBuilder extends lfz {
    ...
    public interface IdTypeOrBuilder extends lfz {
        @Override // p153l.lfz
        /* synthetic */ InterfaceC3442q getDefaultInstanceForType();
    ...
    public interface MsgOrBuilder extends lfz {
        Any getData();
    ...
    public interface MsgsOrBuilder extends lfz {
        @Override // p153l.lfz
        /* synthetic */ InterfaceC3442q getDefaultInstanceForType();
    ...
    public interface PushContentOrBuilder extends lfz {
    ...
    public static final class I18n extends GeneratedMessageLite<I18n, Builder> implements I18nOrBuilder {
        ...
        private static volatile ng60<I18n> PARSER = null;
        public static final int VALUE_FIELD_NUMBER = 1;
        private int bitField0_;
        private MapFieldLite<String, String> locales_ = MapFieldLite.emptyMapField();
        private String value_ = "";
        private C3437l.h<String> params_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllParams(Iterable<String> iterable) {
            ...
            AbstractC3426a.addAll(iterable, this.params_);
        }
        ...
        public static ng60<I18n> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            C45541 c45541 = null;
            switch (C45541.f16654xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                    return new I18n();
                case 2:
                    return DEFAULT_INSTANCE;
                case 3:
                    ...
                    this.params_.mo17139n();
                    return null;
                case 4:
                    return new Builder(c45541);
                case 5:
                    GeneratedMessageLite.InterfaceC3409h interfaceC3409h = (GeneratedMessageLite.InterfaceC3409h) obj;
                    I18n i18n = (I18n) obj2;
                    this.value_ = interfaceC3409h.mo17052f(!this.value_.isEmpty(), this.value_, true ^ i18n.value_.isEmpty(), i18n.value_);
                    this.locales_ = interfaceC3409h.mo17058l(this.locales_, i18n.internalGetLocales());
                    this.params_ = interfaceC3409h.mo17053g(this.params_, i18n.params_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    LocalesDefaultEntryHolder.defaultEntry.m17335e(this.locales_, c3430e, c3433h);
                                } else if (iM17171M == 26) {
                                    String strM17170L = c3430e.m17170L();
                                    if (!this.params_.mo17140q()) {
                                        this.params_ = GeneratedMessageLite.mutableCopy(this.params_);
                                    }
                                    this.params_.add(strM17170L);
        ...
        public int getSerializedSize() {
            ...
            for (Map.Entry<String, String> entry : internalGetLocales().entrySet()) {
                iM16956K += LocalesDefaultEntryHolder.defaultEntry.m17334a(2, entry.getKey(), entry.getValue());
            }
            int iM16957L = 0;
            for (int i2 = 0; i2 < this.params_.size(); i2++) {
                iM16957L += CodedOutputStream.m16957L(this.params_.get(i2));
            }
            int size = iM16956K + iM16957L + getParamsList().size();
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (Map.Entry<String, String> entry : internalGetLocales().entrySet()) {
                LocalesDefaultEntryHolder.defaultEntry.m17336f(codedOutputStream, 2, entry.getKey(), entry.getValue());
            }
            for (int i = 0; i < this.params_.size(); i++) {
                codedOutputStream.mo16994D0(3, this.params_.get(i));
            }
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<I18n, Builder> implements I18nOrBuilder {
            private Builder() {
            ...
            public /* synthetic */ Builder(C45541 c45541) {
                this();
            }
        }

        public static I18n parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (I18n) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static I18n parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (I18n) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static I18n parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (I18n) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static I18n parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (I18n) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static I18n parseFrom(C3430e c3430e) throws IOException {
            return (I18n) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static I18n parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (I18n) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class IdType extends GeneratedMessageLite<IdType, Builder> implements IdTypeOrBuilder {
        ...
        private static volatile ng60<IdType> PARSER = null;
        ...
        public static ng60<IdType> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45541.f16654xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3409h.mo17052f(!this.id_.isEmpty(), this.id_, !idType.id_.isEmpty(), idType.id_);
                    this.type_ = interfaceC3409h.mo17052f(!this.type_.isEmpty(), this.type_, true ^ idType.type_.isEmpty(), idType.type_);
                    this.parent_ = (IdType) interfaceC3409h.mo17061o(this.parent_, idType.parent_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    IdType idType3 = (IdType) c3430e.m17198w(parser(), c3433h);
        ...
        public int getSerializedSize() {
            ...
            if (this.parent_ != null) {
                iM16956K += CodedOutputStream.m16948C(3, getParent());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.parent_ != null) {
                codedOutputStream.mo17029w0(3, getParent());
            }
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<IdType, Builder> implements IdTypeOrBuilder {
            private Builder() {
        ...
        public static IdType parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (IdType) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static IdType parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (IdType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static IdType parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (IdType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static IdType parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (IdType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static IdType parseFrom(C3430e c3430e) throws IOException {
            return (IdType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static IdType parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (IdType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class Msg extends GeneratedMessageLite<Msg, Builder> implements MsgOrBuilder {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setData(Any.C3389b c3389b) {
            this.data_ = c3389b.build();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45541.f16654xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.msgId_ = interfaceC3409h.mo17052f(!this.msgId_.isEmpty(), this.msgId_, !msg.msgId_.isEmpty(), msg.msgId_);
                    this.data_ = (Any) interfaceC3409h.mo17061o(this.data_, msg.data_);
                    this.push_ = (PushContent) interfaceC3409h.mo17061o(this.push_, msg.push_);
                    this.msgTypeName_ = interfaceC3409h.mo17052f(!this.msgTypeName_.isEmpty(), this.msgTypeName_, !msg.msgTypeName_.isEmpty(), msg.msgTypeName_);
                    this.version_ = interfaceC3409h.mo17052f(!this.version_.isEmpty(), this.version_, !msg.version_.isEmpty(), msg.version_);
                    boolean z3 = this.isAck_;
                    boolean z4 = msg.isAck_;
                    this.isAck_ = interfaceC3409h.mo17050d(z3, z3, z4, z4);
                    boolean z5 = this.isReliable_;
                    boolean z6 = msg.isReliable_;
                    this.isReliable_ = interfaceC3409h.mo17050d(z5, z5, z6, z6);
                    GeneratedMessageLite.C3408g c3408g = GeneratedMessageLite.C3408g.INSTANCE;
                    return this;
                case 6:
                    C3430e c3430e = (C3430e) obj;
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 8) {
                                    ...
                                    Any any = this.data_;
                                    Any.C3389b builder = any != null ? any.toBuilder() : null;
                                    Any any2 = (Any) c3430e.m17198w(Any.parser(), c3433h);
                                    this.data_ = any2;
                                    if (builder != null) {
                                    ...
                                    PushContent pushContent2 = (PushContent) c3430e.m17198w(PushContent.parser(), c3433h);
                                    ...
                                    this.msgTypeName_ = c3430e.m17170L();
                                } else if (iM17171M == 58) {
                                    this.version_ = c3430e.m17170L();
                                } else if (iM17171M == 64) {
                                    this.isAck_ = c3430e.m17188m();
                                } else if (iM17171M == 72) {
        ...
        public int getSerializedSize() {
            ...
            int iM16977m = this.type_ != MsgTypeEnum.MSG_TYPE_CHAT_MSG.getNumber() ? CodedOutputStream.m16977m(1, this.type_) : 0;
            if (!this.msgId_.isEmpty()) {
                iM16977m += CodedOutputStream.m16956K(2, getMsgId());
            }
            if (this.data_ != null) {
                iM16977m += CodedOutputStream.m16948C(3, getData());
            }
            if (this.push_ != null) {
                iM16977m += CodedOutputStream.m16948C(4, getPush());
            }
            if (!this.msgTypeName_.isEmpty()) {
                iM16977m += CodedOutputStream.m16956K(5, getMsgTypeName());
            }
            if (!this.version_.isEmpty()) {
                iM16977m += CodedOutputStream.m16956K(7, getVersion());
            }
            boolean z = this.isAck_;
            if (z) {
                iM16977m += CodedOutputStream.m16970f(8, z);
            }
            boolean z2 = this.isReliable_;
            if (z2) {
                iM16977m += CodedOutputStream.m16970f(9, z2);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (this.data_ != null) {
                codedOutputStream.mo17029w0(3, getData());
            }
            if (this.push_ != null) {
                codedOutputStream.mo17029w0(4, getPush());
            }
            if (!this.msgTypeName_.isEmpty()) {
                codedOutputStream.mo16994D0(5, getMsgTypeName());
            }
            if (!this.version_.isEmpty()) {
                codedOutputStream.mo16994D0(7, getVersion());
            }
            boolean z = this.isAck_;
            if (z) {
            ...
            boolean z2 = this.isReliable_;
            if (z2) {
                codedOutputStream.mo17005a0(9, z2);
            }
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<Msg, Builder> implements MsgOrBuilder {
            private Builder() {
            ...
            public Builder setData(Any.C3389b c3389b) {
                copyOnWrite();
                ((Msg) this.instance).setData(c3389b);
                return this;
            }
    ...
    public static final class Msgs extends GeneratedMessageLite<Msgs, Builder> implements MsgsOrBuilder {
        ...
        private static volatile ng60<Msgs> PARSER;
        private C3437l.h<Msg> msgs_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public void addAllMsgs(Iterable<? extends Msg> iterable) {
            ensureMsgsIsMutable();
            AbstractC3426a.addAll(iterable, this.msgs_);
        }
        ...
        public static ng60<Msgs> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45541.f16654xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 4:
                    return new Builder(c45541);
                case 5:
                    this.msgs_ = ((GeneratedMessageLite.InterfaceC3409h) obj).mo17053g(this.msgs_, ((Msgs) obj2).msgs_);
                    GeneratedMessageLite.C3408g c3408g = GeneratedMessageLite.C3408g.INSTANCE;
                    return this;
                case 6:
                    C3430e c3430e = (C3430e) obj;
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.msgs_.add((Msg) c3430e.m17198w(Msg.parser(), c3433h));
                                } else if (!c3430e.m17176R(iM17171M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            for (int i2 = 0; i2 < this.msgs_.size(); i2++) {
                iM16948C += CodedOutputStream.m16948C(1, this.msgs_.get(i2));
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            for (int i = 0; i < this.msgs_.size(); i++) {
                codedOutputStream.mo17029w0(1, this.msgs_.get(i));
            }
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<Msgs, Builder> implements MsgsOrBuilder {
            private Builder() {
        ...
        public static Msgs parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (Msgs) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static Msgs parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (Msgs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static Msgs parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (Msgs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static Msgs parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (Msgs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static Msgs parseFrom(C3430e c3430e) throws IOException {
            return (Msgs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static Msgs parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (Msgs) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    ...
    public static final class PushContent extends GeneratedMessageLite<PushContent, Builder> implements PushContentOrBuilder {
        ...
        private static volatile ng60<PushContent> PARSER = null;
        ...
        public static ng60<PushContent> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45541.f16654xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.content_ = (IdType) interfaceC3409h.mo17061o(this.content_, pushContent.content_);
                    this.title_ = (I18n) interfaceC3409h.mo17061o(this.title_, pushContent.title_);
                    this.value_ = (I18n) interfaceC3409h.mo17061o(this.value_, pushContent.value_);
                    this.ticker_ = (I18n) interfaceC3409h.mo17061o(this.ticker_, pushContent.ticker_);
                    this.primaryPicture_ = interfaceC3409h.mo17052f(!this.primaryPicture_.isEmpty(), this.primaryPicture_, !pushContent.primaryPicture_.isEmpty(), pushContent.primaryPicture_);
                    int i = this.priority_;
                    boolean z2 = i != 0;
                    int i2 = pushContent.priority_;
                    this.priority_ = interfaceC3409h.mo17051e(z2, i, i2 != 0, i2);
                    int i3 = this.stackId_;
                    boolean z3 = i3 != 0;
                    int i4 = pushContent.stackId_;
                    this.stackId_ = interfaceC3409h.mo17051e(z3, i3, i4 != 0, i4);
                    boolean z4 = this.silentAggregation_;
                    boolean z5 = pushContent.silentAggregation_;
                    this.silentAggregation_ = interfaceC3409h.mo17050d(z4, z4, z5, z5);
                    boolean z6 = this.silent_;
                    boolean z7 = pushContent.silent_;
                    this.silent_ = interfaceC3409h.mo17050d(z6, z6, z7, z7);
                    this.message_ = interfaceC3409h.mo17052f(!this.message_.isEmpty(), this.message_, !pushContent.message_.isEmpty(), pushContent.message_);
                    this.intent_ = interfaceC3409h.mo17052f(!this.intent_.isEmpty(), this.intent_, !pushContent.intent_.isEmpty(), pushContent.intent_);
                    long j = this.createTime_;
                    boolean z8 = j != 0;
                    long j2 = pushContent.createTime_;
                    this.createTime_ = interfaceC3409h.mo17055i(z8, j, j2 != 0, j2);
                    this.imageURLWithoutFormat_ = interfaceC3409h.mo17052f(!this.imageURLWithoutFormat_.isEmpty(), this.imageURLWithoutFormat_, !pushContent.imageURLWithoutFormat_.isEmpty(), pushContent.imageURLWithoutFormat_);
                    this.reqId_ = interfaceC3409h.mo17052f(!this.reqId_.isEmpty(), this.reqId_, !pushContent.reqId_.isEmpty(), pushContent.reqId_);
                    this.link_ = interfaceC3409h.mo17052f(!this.link_.isEmpty(), this.link_, !pushContent.link_.isEmpty(), pushContent.link_);
                    int i5 = this.counter_;
                    boolean z9 = i5 != 0;
                    int i6 = pushContent.counter_;
                    this.counter_ = interfaceC3409h.mo17051e(z9, i5, i6 != 0, i6);
                    this.messageCustom_ = interfaceC3409h.mo17058l(this.messageCustom_, pushContent.internalGetMessageCustom());
                    if (interfaceC3409h == GeneratedMessageLite.C3408g.INSTANCE) {
                        ...
                        try {
                            ...
                            switch (iM17171M) {
                                ...
                                case 10:
                                    ...
                                    IdType idType2 = (IdType) c3430e.m17198w(IdType.parser(), c3433h);
                                ...
                                case 18:
                                    ...
                                    I18n i18n2 = (I18n) c3430e.m17198w(I18n.parser(), c3433h);
                                    this.title_ = i18n2;
                                    if (builder2 != null) {
                                ...
                                case 26:
                                    ...
                                    I18n i18n4 = (I18n) c3430e.m17198w(I18n.parser(), c3433h);
                                    this.value_ = i18n4;
                                    if (builder3 != null) {
                                ...
                                case 34:
                                    ...
                                    I18n i18n6 = (I18n) c3430e.m17198w(I18n.parser(), c3433h);
                                    this.ticker_ = i18n6;
                                    if (builder4 != null) {
                                    ...
                                    break;
                                case 42:
                                    this.primaryPicture_ = c3430e.m17170L();
                                    continue;
                                case 48:
                                    this.priority_ = c3430e.m17196u();
                                    continue;
                                case 56:
                                    this.stackId_ = c3430e.m17196u();
                                    continue;
                                case 64:
                                    this.silentAggregation_ = c3430e.m17188m();
                                    continue;
                                case 72:
                                    this.silent_ = c3430e.m17188m();
                                    continue;
                                case EACTags.COMMAND_TO_PERFORM /* 82 */:
                                    this.message_ = c3430e.m17170L();
                                    continue;
                                case 90:
                                    this.intent_ = c3430e.m17170L();
                                    continue;
                                case Opcodes.IADD /* 96 */:
                                    this.createTime_ = c3430e.m17197v();
                                    continue;
                                case 106:
                                    this.imageURLWithoutFormat_ = c3430e.m17170L();
                                    continue;
                                case 114:
                                    this.reqId_ = c3430e.m17170L();
                                    continue;
                                case 122:
                                    this.link_ = c3430e.m17170L();
                                    continue;
                                case 128:
                                    this.counter_ = c3430e.m17196u();
                                    continue;
                                case CipherSuite.TLS_PSK_WITH_RC4_128_SHA /* 138 */:
                                    if (!this.messageCustom_.isMutable()) {
                                        this.messageCustom_ = this.messageCustom_.mutableCopy();
                                    }
                                    MessageCustomDefaultEntryHolder.defaultEntry.m17335e(this.messageCustom_, c3430e, c3433h);
                                    continue;
                                default:
        ...
        public int getSerializedSize() {
            ...
            int iM16948C = this.content_ != null ? CodedOutputStream.m16948C(1, getContent()) : 0;
            if (this.title_ != null) {
                iM16948C += CodedOutputStream.m16948C(2, getTitle());
            }
            if (this.value_ != null) {
                iM16948C += CodedOutputStream.m16948C(3, getValue());
            }
            if (this.ticker_ != null) {
                iM16948C += CodedOutputStream.m16948C(4, getTicker());
            }
            if (!this.primaryPicture_.isEmpty()) {
                iM16948C += CodedOutputStream.m16956K(5, getPrimaryPicture());
            }
            int i2 = this.priority_;
            if (i2 != 0) {
                iM16948C += CodedOutputStream.m16984t(6, i2);
            }
            int i3 = this.stackId_;
            if (i3 != 0) {
                iM16948C += CodedOutputStream.m16984t(7, i3);
            }
            boolean z = this.silentAggregation_;
            if (z) {
                iM16948C += CodedOutputStream.m16970f(8, z);
            }
            boolean z2 = this.silent_;
            if (z2) {
                iM16948C += CodedOutputStream.m16970f(9, z2);
            }
            if (!this.message_.isEmpty()) {
                iM16948C += CodedOutputStream.m16956K(10, getMessage());
            }
            if (!this.intent_.isEmpty()) {
                iM16948C += CodedOutputStream.m16956K(11, getIntent());
            }
            long j = this.createTime_;
            if (j != 0) {
                iM16948C += CodedOutputStream.m16986v(12, j);
            }
            if (!this.imageURLWithoutFormat_.isEmpty()) {
                iM16948C += CodedOutputStream.m16956K(13, getImageURLWithoutFormat());
            }
            if (!this.reqId_.isEmpty()) {
                iM16948C += CodedOutputStream.m16956K(14, getReqId());
            }
            if (!this.link_.isEmpty()) {
                iM16948C += CodedOutputStream.m16956K(15, getLink());
            }
            int i4 = this.counter_;
            if (i4 != 0) {
                iM16948C += CodedOutputStream.m16984t(16, i4);
            }
            for (Map.Entry<String, String> entry : internalGetMessageCustom().entrySet()) {
                iM16948C += MessageCustomDefaultEntryHolder.defaultEntry.m17334a(17, entry.getKey(), entry.getValue());
            }
            this.memoizedSerializedSize = iM16948C;
            return iM16948C;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.content_ != null) {
                codedOutputStream.mo17029w0(1, getContent());
            }
            if (this.title_ != null) {
                codedOutputStream.mo17029w0(2, getTitle());
            }
            if (this.value_ != null) {
                codedOutputStream.mo17029w0(3, getValue());
            }
            if (this.ticker_ != null) {
                codedOutputStream.mo17029w0(4, getTicker());
            }
            if (!this.primaryPicture_.isEmpty()) {
                codedOutputStream.mo16994D0(5, getPrimaryPicture());
            }
            int i = this.priority_;
            if (i != 0) {
                codedOutputStream.mo17025s0(6, i);
            }
            ...
            if (!this.message_.isEmpty()) {
                codedOutputStream.mo16994D0(10, getMessage());
            }
            if (!this.intent_.isEmpty()) {
                codedOutputStream.mo16994D0(11, getIntent());
            }
            long j = this.createTime_;
            if (j != 0) {
            ...
            if (!this.imageURLWithoutFormat_.isEmpty()) {
                codedOutputStream.mo16994D0(13, getImageURLWithoutFormat());
            }
            if (!this.reqId_.isEmpty()) {
                codedOutputStream.mo16994D0(14, getReqId());
            }
            if (!this.link_.isEmpty()) {
                codedOutputStream.mo16994D0(15, getLink());
            }
            int i3 = this.counter_;
            if (i3 != 0) {
                codedOutputStream.mo17025s0(16, i3);
            }
            for (Map.Entry<String, String> entry : internalGetMessageCustom().entrySet()) {
                MessageCustomDefaultEntryHolder.defaultEntry.m17336f(codedOutputStream, 17, entry.getKey(), entry.getValue());
            }
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<PushContent, Builder> implements PushContentOrBuilder {
            private Builder() {
        ...
        public static PushContent parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (PushContent) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static PushContent parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (PushContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static PushContent parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (PushContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static PushContent parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (PushContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static PushContent parseFrom(C3430e c3430e) throws IOException {
            return (PushContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static PushContent parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (PushContent) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }

    public enum MsgTypeEnum implements C3437l.c {
        MSG_TYPE_CHAT_MSG(0),
        MSG_TYPE_PUSH_ACK(1),
        MSG_TYPE_AUTH(2),
        MSG_TYPE_AUTH_ACK(3),
        ...
        private static final C3437l.d<MsgTypeEnum> internalValueMap = new C3437l.d<MsgTypeEnum>() { // from class: com.p1.mobile.longlink.msg.connector.LongLinkMessage.MsgTypeEnum.1
        ...
        public static C3437l.d<MsgTypeEnum> internalGetValueMap() {
