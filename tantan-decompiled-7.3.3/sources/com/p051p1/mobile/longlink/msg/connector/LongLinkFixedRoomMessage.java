...
public final class LongLinkFixedRoomMessage {
    ...
    public static /* synthetic */ class C45491 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke */
        static final /* synthetic */ int[] f16650xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f16650xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16650xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface LiveFixedRoomChatCellChatInfoOrBuilder extends lfz {
    ...
    public interface LiveFixedRoomChatCellInfoOrBuilder extends lfz {
        @Override // p153l.lfz
        /* synthetic */ InterfaceC3442q getDefaultInstanceForType();
    ...
    public interface LiveFixedRoomChatCellOrBuilder extends lfz {
    ...
    public interface LiveFixedRoomChatCellRoomInfoOrBuilder extends lfz {
    ...
    public static final class LiveFixedRoomChatCell extends GeneratedMessageLite<LiveFixedRoomChatCell, Builder> implements LiveFixedRoomChatCellOrBuilder {
        ...
        private static volatile ng60<LiveFixedRoomChatCell> PARSER = null;
        ...
        public static ng60<LiveFixedRoomChatCell> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45491.f16650xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.cellInfo_ = (LiveFixedRoomChatCellInfo) interfaceC3409h.mo17061o(this.cellInfo_, liveFixedRoomChatCell.cellInfo_);
                    this.roomInfo_ = (LiveFixedRoomChatCellRoomInfo) interfaceC3409h.mo17061o(this.roomInfo_, liveFixedRoomChatCell.roomInfo_);
                    this.chatInfo_ = (LiveFixedRoomChatCellChatInfo) interfaceC3409h.mo17061o(this.chatInfo_, liveFixedRoomChatCell.chatInfo_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    LiveFixedRoomChatCellInfo liveFixedRoomChatCellInfo2 = (LiveFixedRoomChatCellInfo) c3430e.m17198w(LiveFixedRoomChatCellInfo.parser(), c3433h);
                                    ...
                                    LiveFixedRoomChatCellRoomInfo liveFixedRoomChatCellRoomInfo2 = (LiveFixedRoomChatCellRoomInfo) c3430e.m17198w(LiveFixedRoomChatCellRoomInfo.parser(), c3433h);
                                    ...
                                    LiveFixedRoomChatCellChatInfo liveFixedRoomChatCellChatInfo2 = (LiveFixedRoomChatCellChatInfo) c3430e.m17198w(LiveFixedRoomChatCellChatInfo.parser(), c3433h);
        ...
        public int getSerializedSize() {
            ...
            int iM16948C = this.cellInfo_ != null ? CodedOutputStream.m16948C(1, getCellInfo()) : 0;
            if (this.roomInfo_ != null) {
                iM16948C += CodedOutputStream.m16948C(2, getRoomInfo());
            }
            if (this.chatInfo_ != null) {
                iM16948C += CodedOutputStream.m16948C(3, getChatInfo());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.cellInfo_ != null) {
                codedOutputStream.mo17029w0(1, getCellInfo());
            }
            if (this.roomInfo_ != null) {
                codedOutputStream.mo17029w0(2, getRoomInfo());
            }
            if (this.chatInfo_ != null) {
                codedOutputStream.mo17029w0(3, getChatInfo());
            }
        }

        public static LiveFixedRoomChatCell parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCell) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCell parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCell) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<LiveFixedRoomChatCell, Builder> implements LiveFixedRoomChatCellOrBuilder {
            private Builder() {
        ...
        public static LiveFixedRoomChatCell parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCell) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static LiveFixedRoomChatCell parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCell) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCell parseFrom(C3430e c3430e) throws IOException {
            return (LiveFixedRoomChatCell) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static LiveFixedRoomChatCell parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCell) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class LiveFixedRoomChatCellChatInfo extends GeneratedMessageLite<LiveFixedRoomChatCellChatInfo, Builder> implements LiveFixedRoomChatCellChatInfoOrBuilder {
        ...
        private static volatile ng60<LiveFixedRoomChatCellChatInfo> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<LiveFixedRoomChatCellChatInfo, Builder> implements LiveFixedRoomChatCellChatInfoOrBuilder {
            private Builder() {
        ...
        public static ng60<LiveFixedRoomChatCellChatInfo> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45491.f16650xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.unreadedCount_ = interfaceC3409h.mo17055i(z2, j, j2 != 0, j2);
                    long j3 = this.currentSeq_;
                    boolean z3 = j3 != 0;
                    long j4 = liveFixedRoomChatCellChatInfo.currentSeq_;
                    this.currentSeq_ = interfaceC3409h.mo17055i(z3, j3, j4 != 0, j4);
                    this.currentSenderName_ = interfaceC3409h.mo17052f(!this.currentSenderName_.isEmpty(), this.currentSenderName_, !liveFixedRoomChatCellChatInfo.currentSenderName_.isEmpty(), liveFixedRoomChatCellChatInfo.currentSenderName_);
                    this.currentMsg_ = interfaceC3409h.mo17052f(!this.currentMsg_.isEmpty(), this.currentMsg_, !liveFixedRoomChatCellChatInfo.currentMsg_.isEmpty(), liveFixedRoomChatCellChatInfo.currentMsg_);
                    boolean z4 = false;
                    ...
                    this.currentTime_ = interfaceC3409h.mo17055i(z4, j5, j6 != 0, j6);
                    GeneratedMessageLite.C3408g c3408g = GeneratedMessageLite.C3408g.INSTANCE;
                    return this;
                case 6:
                    C3430e c3430e = (C3430e) obj;
                    while (!z) {
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 8) {
                                    this.unreadedCount_ = c3430e.m17197v();
                                } else if (iM17171M == 16) {
                                    this.currentSeq_ = c3430e.m17173O();
                                } else if (iM17171M == 26) {
                                    this.currentSenderName_ = c3430e.m17170L();
                                } else if (iM17171M == 34) {
                                    this.currentMsg_ = c3430e.m17170L();
                                } else if (iM17171M == 40) {
        ...
        public int getSerializedSize() {
            ...
            if (j2 != 0) {
                iM16986v += CodedOutputStream.m16961P(2, j2);
            }
            if (!this.currentSenderName_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(3, getCurrentSenderName());
            }
            if (!this.currentMsg_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(4, getCurrentMsg());
            }
            long j3 = this.currentTime_;
            if (j3 != 0) {
                iM16986v += CodedOutputStream.m16986v(5, j3);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            long j2 = this.currentSeq_;
            if (j2 != 0) {
                codedOutputStream.mo16999I0(2, j2);
            }
            if (!this.currentSenderName_.isEmpty()) {
                codedOutputStream.mo16994D0(3, getCurrentSenderName());
            }
            if (!this.currentMsg_.isEmpty()) {
                codedOutputStream.mo16994D0(4, getCurrentMsg());
            }
            long j3 = this.currentTime_;
            if (j3 != 0) {
        ...
        public static LiveFixedRoomChatCellChatInfo parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellChatInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCellChatInfo parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCellChatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static LiveFixedRoomChatCellChatInfo parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCellChatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static LiveFixedRoomChatCellChatInfo parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellChatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCellChatInfo parseFrom(C3430e c3430e) throws IOException {
            return (LiveFixedRoomChatCellChatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static LiveFixedRoomChatCellChatInfo parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellChatInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class LiveFixedRoomChatCellInfo extends GeneratedMessageLite<LiveFixedRoomChatCellInfo, Builder> implements LiveFixedRoomChatCellInfoOrBuilder {
        ...
        private static volatile ng60<LiveFixedRoomChatCellInfo> PARSER;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<LiveFixedRoomChatCellInfo, Builder> implements LiveFixedRoomChatCellInfoOrBuilder {
            private Builder() {
        ...
        public static ng60<LiveFixedRoomChatCellInfo> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C45491.f16650xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.isOnTop_ = interfaceC3409h.mo17050d(z, z, z2, z2);
                    boolean z3 = this.isShow_;
                    boolean z4 = liveFixedRoomChatCellInfo.isShow_;
                    this.isShow_ = interfaceC3409h.mo17050d(z3, z3, z4, z4);
                    boolean z5 = this.isRemoved_;
                    boolean z6 = liveFixedRoomChatCellInfo.isRemoved_;
                    this.isRemoved_ = interfaceC3409h.mo17050d(z5, z5, z6, z6);
                    boolean z7 = this.isDissolved_;
                    boolean z8 = liveFixedRoomChatCellInfo.isDissolved_;
                    this.isDissolved_ = interfaceC3409h.mo17050d(z7, z7, z8, z8);
                    this.dissolveReason_ = interfaceC3409h.mo17052f(!this.dissolveReason_.isEmpty(), this.dissolveReason_, true ^ liveFixedRoomChatCellInfo.dissolveReason_.isEmpty(), liveFixedRoomChatCellInfo.dissolveReason_);
                    boolean z9 = this.isRemind_;
                    boolean z10 = liveFixedRoomChatCellInfo.isRemind_;
                    this.isRemind_ = interfaceC3409h.mo17050d(z9, z9, z10, z10);
                    GeneratedMessageLite.C3408g c3408g = GeneratedMessageLite.C3408g.INSTANCE;
                    return this;
                case 6:
                    C3430e c3430e = (C3430e) obj;
                    ...
                    while (!z11) {
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 8) {
                                    this.isOnTop_ = c3430e.m17188m();
                                } else if (iM17171M == 16) {
                                    this.isShow_ = c3430e.m17188m();
                                } else if (iM17171M == 24) {
                                    this.isRemoved_ = c3430e.m17188m();
                                } else if (iM17171M == 32) {
                                    this.isDissolved_ = c3430e.m17188m();
                                } else if (iM17171M == 42) {
                                    this.dissolveReason_ = c3430e.m17170L();
                                } else if (iM17171M == 48) {
                                    this.isRemind_ = c3430e.m17188m();
                                } else if (!c3430e.m17176R(iM17171M)) {
                                }
                            }
                            z11 = true;
        ...
        public int getSerializedSize() {
            ...
            if (z3) {
                iM16970f += CodedOutputStream.m16970f(3, z3);
            }
            boolean z4 = this.isDissolved_;
            if (z4) {
                iM16970f += CodedOutputStream.m16970f(4, z4);
            }
            if (!this.dissolveReason_.isEmpty()) {
                iM16970f += CodedOutputStream.m16956K(5, getDissolveReason());
            }
            boolean z5 = this.isRemind_;
            if (z5) {
                iM16970f += CodedOutputStream.m16970f(6, z5);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            boolean z3 = this.isRemoved_;
            if (z3) {
                codedOutputStream.mo17005a0(3, z3);
            }
            boolean z4 = this.isDissolved_;
            if (z4) {
                codedOutputStream.mo17005a0(4, z4);
            }
            if (!this.dissolveReason_.isEmpty()) {
                codedOutputStream.mo16994D0(5, getDissolveReason());
            }
            boolean z5 = this.isRemind_;
            if (z5) {
                codedOutputStream.mo17005a0(6, z5);
            }
        }

        public static LiveFixedRoomChatCellInfo parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCellInfo parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCellInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static LiveFixedRoomChatCellInfo parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCellInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static LiveFixedRoomChatCellInfo parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCellInfo parseFrom(C3430e c3430e) throws IOException {
            return (LiveFixedRoomChatCellInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static LiveFixedRoomChatCellInfo parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class LiveFixedRoomChatCellRoomInfo extends GeneratedMessageLite<LiveFixedRoomChatCellRoomInfo, Builder> implements LiveFixedRoomChatCellRoomInfoOrBuilder {
        ...
        private static volatile ng60<LiveFixedRoomChatCellRoomInfo> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<LiveFixedRoomChatCellRoomInfo, Builder> implements LiveFixedRoomChatCellRoomInfoOrBuilder {
            private Builder() {
        ...
        public static ng60<LiveFixedRoomChatCellRoomInfo> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C45491.f16650xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.roomId_ = interfaceC3409h.mo17052f(!this.roomId_.isEmpty(), this.roomId_, !liveFixedRoomChatCellRoomInfo.roomId_.isEmpty(), liveFixedRoomChatCellRoomInfo.roomId_);
                    this.title_ = interfaceC3409h.mo17052f(!this.title_.isEmpty(), this.title_, !liveFixedRoomChatCellRoomInfo.title_.isEmpty(), liveFixedRoomChatCellRoomInfo.title_);
                    this.avatars_ = interfaceC3409h.mo17053g(this.avatars_, liveFixedRoomChatCellRoomInfo.avatars_);
                    long j = this.memberCount_;
                    boolean z2 = j != 0;
                    long j2 = liveFixedRoomChatCellRoomInfo.memberCount_;
                    this.memberCount_ = interfaceC3409h.mo17055i(z2, j, j2 != 0, j2);
                    this.liveId_ = interfaceC3409h.mo17052f(!this.liveId_.isEmpty(), this.liveId_, !liveFixedRoomChatCellRoomInfo.liveId_.isEmpty(), liveFixedRoomChatCellRoomInfo.liveId_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.memberCount_ = c3430e.m17197v();
                                } else if (iM17171M == 42) {
        ...
        public int getSerializedSize() {
            ...
            int size = iM16956K + iM16957L + getAvatarsList().size();
            long j = this.memberCount_;
            if (j != 0) {
                size += CodedOutputStream.m16986v(4, j);
            }
            if (!this.liveId_.isEmpty()) {
                size += CodedOutputStream.m16956K(5, getLiveId());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i = 0; i < this.avatars_.size(); i++) {
                codedOutputStream.mo16994D0(3, this.avatars_.get(i));
            }
            long j = this.memberCount_;
            if (j != 0) {
        ...
        public static LiveFixedRoomChatCellRoomInfo parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellRoomInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCellRoomInfo parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCellRoomInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static LiveFixedRoomChatCellRoomInfo parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (LiveFixedRoomChatCellRoomInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static LiveFixedRoomChatCellRoomInfo parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellRoomInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static LiveFixedRoomChatCellRoomInfo parseFrom(C3430e c3430e) throws IOException {
            return (LiveFixedRoomChatCellRoomInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static LiveFixedRoomChatCellRoomInfo parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (LiveFixedRoomChatCellRoomInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
}
