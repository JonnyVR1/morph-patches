...
public final class LongLinkVoiceLiveAuctionMsg {
    ...
    public static /* synthetic */ class C46781 {
        ...
        static {
            ...
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16703xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface AuctionLeaderboardOrBuilder extends lfz {
        long getAmount();
    ...
    public interface VoiceLiveAuctionPledgeChooseOrBuilder extends lfz {
        String getAuctionId();
    ...
    public interface VoiceLiveAuctionUpdateOrBuilder extends lfz {
        String getAuctionId();
    ...
    public static final class AuctionLeaderboard extends GeneratedMessageLite<AuctionLeaderboard, Builder> implements AuctionLeaderboardOrBuilder {
        ...
        private static volatile ng60<AuctionLeaderboard> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<AuctionLeaderboard, Builder> implements AuctionLeaderboardOrBuilder {
            private Builder() {
        ...
        public static ng60<AuctionLeaderboard> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C46781.f16703xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.userId_ = interfaceC3409h.mo17052f(!this.userId_.isEmpty(), this.userId_, !auctionLeaderboard.userId_.isEmpty(), auctionLeaderboard.userId_);
                    this.userName_ = interfaceC3409h.mo17052f(!this.userName_.isEmpty(), this.userName_, !auctionLeaderboard.userName_.isEmpty(), auctionLeaderboard.userName_);
                    this.avatar_ = interfaceC3409h.mo17052f(!this.avatar_.isEmpty(), this.avatar_, !auctionLeaderboard.avatar_.isEmpty(), auctionLeaderboard.avatar_);
                    this.avatarFrameUrl_ = interfaceC3409h.mo17052f(!this.avatarFrameUrl_.isEmpty(), this.avatarFrameUrl_, !auctionLeaderboard.avatarFrameUrl_.isEmpty(), auctionLeaderboard.avatarFrameUrl_);
                    this.avatarFrameDynamicUrl_ = interfaceC3409h.mo17052f(!this.avatarFrameDynamicUrl_.isEmpty(), this.avatarFrameDynamicUrl_, !auctionLeaderboard.avatarFrameDynamicUrl_.isEmpty(), auctionLeaderboard.avatarFrameDynamicUrl_);
                    this.background_ = interfaceC3409h.mo17052f(!this.background_.isEmpty(), this.background_, !auctionLeaderboard.background_.isEmpty(), auctionLeaderboard.background_);
                    this.amountBackgroundId_ = interfaceC3409h.mo17052f(!this.amountBackgroundId_.isEmpty(), this.amountBackgroundId_, !auctionLeaderboard.amountBackgroundId_.isEmpty(), auctionLeaderboard.amountBackgroundId_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 8) {
                                    ...
                                    this.avatarFrameUrl_ = c3430e.m17170L();
                                } else if (iM17171M == 58) {
                                    this.avatarFrameDynamicUrl_ = c3430e.m17170L();
                                } else if (iM17171M == 66) {
                                    this.background_ = c3430e.m17170L();
                                } else if (iM17171M == 74) {
                                    this.amountBackgroundId_ = c3430e.m17170L();
        ...
        public int getSerializedSize() {
            ...
            if (!this.userName_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(4, getUserName());
            }
            if (!this.avatar_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(5, getAvatar());
            }
            if (!this.avatarFrameUrl_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(6, getAvatarFrameUrl());
            }
            if (!this.avatarFrameDynamicUrl_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(7, getAvatarFrameDynamicUrl());
            }
            if (!this.background_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(8, getBackground());
            }
            if (!this.amountBackgroundId_.isEmpty()) {
                iM16986v += CodedOutputStream.m16956K(9, getAmountBackgroundId());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.avatar_.isEmpty()) {
                codedOutputStream.mo16994D0(5, getAvatar());
            }
            if (!this.avatarFrameUrl_.isEmpty()) {
                codedOutputStream.mo16994D0(6, getAvatarFrameUrl());
            }
            if (!this.avatarFrameDynamicUrl_.isEmpty()) {
                codedOutputStream.mo16994D0(7, getAvatarFrameDynamicUrl());
            }
            if (!this.background_.isEmpty()) {
                codedOutputStream.mo16994D0(8, getBackground());
            }
            if (this.amountBackgroundId_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16994D0(9, getAmountBackgroundId());
        }

        public static AuctionLeaderboard parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (AuctionLeaderboard) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static AuctionLeaderboard parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (AuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static AuctionLeaderboard parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (AuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static AuctionLeaderboard parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (AuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static AuctionLeaderboard parseFrom(C3430e c3430e) throws IOException {
            return (AuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static AuctionLeaderboard parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (AuctionLeaderboard) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public enum UpdateType implements C3437l.c {
        ...
        private static final C3437l.d<UpdateType> internalValueMap = new C3437l.d<UpdateType>() { // from class: com.p1.mobile.longlink.msg.liveroom.LongLinkVoiceLiveAuctionMsg.UpdateType.1
    ...
    public static final class VoiceLiveAuctionPledgeChoose extends GeneratedMessageLite<VoiceLiveAuctionPledgeChoose, Builder> implements VoiceLiveAuctionPledgeChooseOrBuilder {
        ...
        private static volatile ng60<VoiceLiveAuctionPledgeChoose> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<VoiceLiveAuctionPledgeChoose, Builder> implements VoiceLiveAuctionPledgeChooseOrBuilder {
            private Builder() {
        ...
        public static ng60<VoiceLiveAuctionPledgeChoose> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C46781.f16703xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.auctionId_ = interfaceC3409h.mo17052f(!this.auctionId_.isEmpty(), this.auctionId_, !voiceLiveAuctionPledgeChoose.auctionId_.isEmpty(), voiceLiveAuctionPledgeChoose.auctionId_);
                    this.pledgeAName_ = interfaceC3409h.mo17052f(!this.pledgeAName_.isEmpty(), this.pledgeAName_, !voiceLiveAuctionPledgeChoose.pledgeAName_.isEmpty(), voiceLiveAuctionPledgeChoose.pledgeAName_);
                    this.pledgeBName_ = interfaceC3409h.mo17052f(!this.pledgeBName_.isEmpty(), this.pledgeBName_, true ^ voiceLiveAuctionPledgeChoose.pledgeBName_.isEmpty(), voiceLiveAuctionPledgeChoose.pledgeBName_);
                    GeneratedMessageLite.C3408g c3408g = GeneratedMessageLite.C3408g.INSTANCE;
                    return this;
                case 6:
                    C3430e c3430e = (C3430e) obj;
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.pledgeAName_ = c3430e.m17170L();
                                } else if (iM17171M == 26) {
                                    this.pledgeBName_ = c3430e.m17170L();
                                } else if (!c3430e.m17176R(iM17171M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            int iM16956K = !this.auctionId_.isEmpty() ? CodedOutputStream.m16956K(1, getAuctionId()) : 0;
            if (!this.pledgeAName_.isEmpty()) {
                iM16956K += CodedOutputStream.m16956K(2, getPledgeAName());
            }
            if (!this.pledgeBName_.isEmpty()) {
                iM16956K += CodedOutputStream.m16956K(3, getPledgeBName());
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (!this.auctionId_.isEmpty()) {
                codedOutputStream.mo16994D0(1, getAuctionId());
            }
            if (!this.pledgeAName_.isEmpty()) {
                codedOutputStream.mo16994D0(2, getPledgeAName());
            }
            if (this.pledgeBName_.isEmpty()) {
                return;
            }
            codedOutputStream.mo16994D0(3, getPledgeBName());
        }

        public static VoiceLiveAuctionPledgeChoose parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (VoiceLiveAuctionPledgeChoose) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static VoiceLiveAuctionPledgeChoose parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionPledgeChoose) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static VoiceLiveAuctionPledgeChoose parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionPledgeChoose) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static VoiceLiveAuctionPledgeChoose parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (VoiceLiveAuctionPledgeChoose) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static VoiceLiveAuctionPledgeChoose parseFrom(C3430e c3430e) throws IOException {
            return (VoiceLiveAuctionPledgeChoose) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static VoiceLiveAuctionPledgeChoose parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (VoiceLiveAuctionPledgeChoose) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class VoiceLiveAuctionUpdate extends GeneratedMessageLite<VoiceLiveAuctionUpdate, Builder> implements VoiceLiveAuctionUpdateOrBuilder {
        ...
        private static volatile ng60<VoiceLiveAuctionUpdate> PARSER = null;
        ...
        private C3437l.h<AuctionLeaderboard> leaderboards_ = GeneratedMessageLite.emptyProtobufList();
        ...
        public static ng60<VoiceLiveAuctionUpdate> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C46781.f16703xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.auctionId_ = interfaceC3409h.mo17052f(!this.auctionId_.isEmpty(), this.auctionId_, !voiceLiveAuctionUpdate.auctionId_.isEmpty(), voiceLiveAuctionUpdate.auctionId_);
                    long j3 = this.worth_;
                    boolean z4 = j3 != 0;
                    long j4 = voiceLiveAuctionUpdate.worth_;
                    this.worth_ = interfaceC3409h.mo17055i(z4, j3, j4 != 0, j4);
                    this.panelBgId_ = interfaceC3409h.mo17052f(!this.panelBgId_.isEmpty(), this.panelBgId_, !voiceLiveAuctionUpdate.panelBgId_.isEmpty(), voiceLiveAuctionUpdate.panelBgId_);
                    long j5 = this.level_;
                    boolean z5 = j5 != 0;
                    long j6 = voiceLiveAuctionUpdate.level_;
                    this.level_ = interfaceC3409h.mo17055i(z5, j5, j6 != 0, j6);
                    this.leaderboards_ = interfaceC3409h.mo17053g(this.leaderboards_, voiceLiveAuctionUpdate.leaderboards_);
                    long j7 = this.leaderboardGap_;
                    boolean z6 = j7 != 0;
                    long j8 = voiceLiveAuctionUpdate.leaderboardGap_;
                    this.leaderboardGap_ = interfaceC3409h.mo17055i(z6, j7, j8 != 0, j8);
                    this.worthBubble_ = interfaceC3409h.mo17052f(!this.worthBubble_.isEmpty(), this.worthBubble_, !voiceLiveAuctionUpdate.worthBubble_.isEmpty(), voiceLiveAuctionUpdate.worthBubble_);
                    boolean z7 = false;
                    ...
                    this.worthBubbleLevel_ = interfaceC3409h.mo17055i(z7, j9, j10 != 0, j10);
                    boolean z8 = this.isChoosingPledgeRelation_;
                    boolean z9 = voiceLiveAuctionUpdate.isChoosingPledgeRelation_;
                    this.isChoosingPledgeRelation_ = interfaceC3409h.mo17050d(z8, z8, z9, z9);
                        ...
                        try {
                            ...
                            switch (iM17171M) {
                                ...
                                case 26:
                                    ...
                                    continue;
                                case 32:
                                    this.worth_ = c3430e.m17197v();
                                    continue;
                                case 42:
                                    this.panelBgId_ = c3430e.m17170L();
                                    continue;
                                case 48:
                                ...
                                case 58:
                                    ...
                                    this.leaderboards_.add((AuctionLeaderboard) c3430e.m17198w(AuctionLeaderboard.parser(), c3433h));
                                    continue;
                                case 64:
                                    this.leaderboardGap_ = c3430e.m17197v();
                                    continue;
                                case 74:
                                    this.worthBubble_ = c3430e.m17170L();
                                    continue;
                                case 80:
                                    this.worthBubbleLevel_ = c3430e.m17197v();
                                    continue;
                                case 88:
                                    this.isChoosingPledgeRelation_ = c3430e.m17188m();
                                    continue;
                                default:
        ...
        public int getSerializedSize() {
            ...
            int iM16977m = this.updateType_ != UpdateType.refreshAuction.getNumber() ? CodedOutputStream.m16977m(1, this.updateType_) : 0;
            long j = this.currentTime_;
            if (j != 0) {
                iM16977m += CodedOutputStream.m16986v(2, j);
            }
            if (!this.auctionId_.isEmpty()) {
                iM16977m += CodedOutputStream.m16956K(3, getAuctionId());
            }
            long j2 = this.worth_;
            if (j2 != 0) {
                iM16977m += CodedOutputStream.m16986v(4, j2);
            }
            if (!this.panelBgId_.isEmpty()) {
                iM16977m += CodedOutputStream.m16956K(5, getPanelBgId());
            }
            long j3 = this.level_;
            if (j3 != 0) {
                iM16977m += CodedOutputStream.m16986v(6, j3);
            }
            for (int i2 = 0; i2 < this.leaderboards_.size(); i2++) {
                iM16977m += CodedOutputStream.m16948C(7, this.leaderboards_.get(i2));
            }
            long j4 = this.leaderboardGap_;
            if (j4 != 0) {
                iM16977m += CodedOutputStream.m16986v(8, j4);
            }
            if (!this.worthBubble_.isEmpty()) {
                iM16977m += CodedOutputStream.m16956K(9, getWorthBubble());
            }
            long j5 = this.worthBubbleLevel_;
            if (j5 != 0) {
                iM16977m += CodedOutputStream.m16986v(10, j5);
            }
            boolean z = this.isChoosingPledgeRelation_;
            if (z) {
                iM16977m += CodedOutputStream.m16970f(11, z);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (!this.panelBgId_.isEmpty()) {
                codedOutputStream.mo16994D0(5, getPanelBgId());
            }
            long j3 = this.level_;
            if (j3 != 0) {
            ...
            for (int i = 0; i < this.leaderboards_.size(); i++) {
                codedOutputStream.mo17029w0(7, this.leaderboards_.get(i));
            }
            long j4 = this.leaderboardGap_;
            if (j4 != 0) {
            ...
            if (!this.worthBubble_.isEmpty()) {
                codedOutputStream.mo16994D0(9, getWorthBubble());
            }
            long j5 = this.worthBubbleLevel_;
            if (j5 != 0) {
        ...
        public static VoiceLiveAuctionUpdate parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (VoiceLiveAuctionUpdate) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static VoiceLiveAuctionUpdate parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionUpdate) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }

        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<VoiceLiveAuctionUpdate, Builder> implements VoiceLiveAuctionUpdateOrBuilder {
            private Builder() {
        ...
        public static VoiceLiveAuctionUpdate parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (VoiceLiveAuctionUpdate) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static VoiceLiveAuctionUpdate parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (VoiceLiveAuctionUpdate) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static VoiceLiveAuctionUpdate parseFrom(C3430e c3430e) throws IOException {
            return (VoiceLiveAuctionUpdate) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static VoiceLiveAuctionUpdate parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (VoiceLiveAuctionUpdate) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
