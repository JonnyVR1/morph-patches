...
public final class LongLinkLiveVoiceActiveGiftMessage {
    ...
    public static /* synthetic */ class C46521 {
        ...
        static {
            ...
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16696xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface VoiceGiftItemOrBuilder extends lfz {
        long getCount();
    ...
    public static final class VoiceGiftItem extends GeneratedMessageLite<VoiceGiftItem, Builder> implements VoiceGiftItemOrBuilder {
        ...
        private static volatile ng60<VoiceGiftItem> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<VoiceGiftItem, Builder> implements VoiceGiftItemOrBuilder {
            private Builder() {
        ...
        public static ng60<VoiceGiftItem> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            boolean z = false;
            switch (C46521.f16696xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    this.id_ = interfaceC3409h.mo17052f(!this.id_.isEmpty(), this.id_, !voiceGiftItem.id_.isEmpty(), voiceGiftItem.id_);
                    this.name_ = interfaceC3409h.mo17052f(!this.name_.isEmpty(), this.name_, !voiceGiftItem.name_.isEmpty(), voiceGiftItem.name_);
                    this.url_ = interfaceC3409h.mo17052f(!this.url_.isEmpty(), this.url_, !voiceGiftItem.url_.isEmpty(), voiceGiftItem.url_);
                    long j = this.count_;
                    boolean z2 = j != 0;
                    long j2 = voiceGiftItem.count_;
                    this.count_ = interfaceC3409h.mo17055i(z2, j, j2 != 0, j2);
                    boolean z3 = false;
                    ...
                    this.tantanCoins_ = interfaceC3409h.mo17055i(z3, j3, j4 != 0, j4);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.count_ = c3430e.m17197v();
                                } else if (iM17171M == 40) {
                                    this.tantanCoins_ = c3430e.m17197v();
        ...
        public static VoiceGiftItem parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (VoiceGiftItem) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static VoiceGiftItem parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (VoiceGiftItem) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static VoiceGiftItem parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (VoiceGiftItem) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static VoiceGiftItem parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (VoiceGiftItem) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static VoiceGiftItem parseFrom(C3430e c3430e) throws IOException {
            return (VoiceGiftItem) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static VoiceGiftItem parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (VoiceGiftItem) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
}
