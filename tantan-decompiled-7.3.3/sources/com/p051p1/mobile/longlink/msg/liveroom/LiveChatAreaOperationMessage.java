...
public final class LiveChatAreaOperationMessage {
    ...
    public static /* synthetic */ class C46211 {
        ...
        static {
            ...
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16685xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    public interface ChatAreaOperationSiteContainerOrBuilder extends lfz {
        @Override // p153l.lfz
    ...
    public interface JumpLinkOrBuilder extends lfz {
        @Override // p153l.lfz
        /* synthetic */ InterfaceC3442q getDefaultInstanceForType();
    ...
    public static final class ChatAreaOperationSiteContainer extends GeneratedMessageLite<ChatAreaOperationSiteContainer, Builder> implements ChatAreaOperationSiteContainerOrBuilder {
        ...
        private static volatile ng60<ChatAreaOperationSiteContainer> PARSER;
        ...
        public static ng60<ChatAreaOperationSiteContainer> parser() {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (C46211.f16685xa1df5c61[methodToInvoke.ordinal()]) {
                case 1:
                ...
                case 4:
                    return new Builder();
                case 5:
                    this.jumpLinkItem_ = (JumpLink) ((GeneratedMessageLite.InterfaceC3409h) obj).mo17061o(this.jumpLinkItem_, ((ChatAreaOperationSiteContainer) obj2).jumpLinkItem_);
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    JumpLink jumpLink2 = (JumpLink) c3430e.m17198w(JumpLink.parser(), c3433h);
        ...
        public int getSerializedSize() {
            ...
            int iM16948C = this.jumpLinkItem_ != null ? CodedOutputStream.m16948C(1, getJumpLinkItem()) : 0;
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            if (this.jumpLinkItem_ != null) {
                codedOutputStream.mo17029w0(1, getJumpLinkItem());
            }
        }

        public static ChatAreaOperationSiteContainer parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (ChatAreaOperationSiteContainer) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static ChatAreaOperationSiteContainer parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (ChatAreaOperationSiteContainer) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<ChatAreaOperationSiteContainer, Builder> implements ChatAreaOperationSiteContainerOrBuilder {
            private Builder() {
        ...
        public static ChatAreaOperationSiteContainer parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (ChatAreaOperationSiteContainer) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static ChatAreaOperationSiteContainer parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (ChatAreaOperationSiteContainer) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static ChatAreaOperationSiteContainer parseFrom(C3430e c3430e) throws IOException {
            return (ChatAreaOperationSiteContainer) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static ChatAreaOperationSiteContainer parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (ChatAreaOperationSiteContainer) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
    ...
    public static final class JumpLink extends GeneratedMessageLite<JumpLink, Builder> implements JumpLinkOrBuilder {
        ...
        private static volatile ng60<JumpLink> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.AbstractC3403b<JumpLink, Builder> implements JumpLinkOrBuilder {
            private Builder() {
        ...
        public static ng60<JumpLink> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (C46211.f16685xa1df5c61[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    this.url_ = interfaceC3409h.mo17052f(!this.url_.isEmpty(), this.url_, !jumpLink.url_.isEmpty(), jumpLink.url_);
                    ...
                    this.widthHighRatio_ = interfaceC3409h.mo17062p(z3, f, f2 != 0.0f, f2);
                    float f3 = this.widthScreenRatio_;
                    boolean z4 = f3 != 0.0f;
                    float f4 = jumpLink.widthScreenRatio_;
                    this.widthScreenRatio_ = interfaceC3409h.mo17062p(z4, f3, f4 != 0.0f, f4);
                    boolean z5 = this.enableClose_;
                    boolean z6 = jumpLink.enableClose_;
                    this.enableClose_ = interfaceC3409h.mo17050d(z5, z5, z6, z6);
                    this.schema_ = interfaceC3409h.mo17052f(!this.schema_.isEmpty(), this.schema_, !jumpLink.schema_.isEmpty(), jumpLink.schema_);
                    boolean z7 = this.isClientDeal_;
                    boolean z8 = jumpLink.isClientDeal_;
                    this.isClientDeal_ = interfaceC3409h.mo17050d(z7, z7, z8, z8);
                    GeneratedMessageLite.C3408g c3408g = GeneratedMessageLite.C3408g.INSTANCE;
                    return this;
                case 6:
                    C3430e c3430e = (C3430e) obj;
                        ...
                        try {
                            ...
                            if (iM17171M != 0) {
                                if (iM17171M == 10) {
                                    ...
                                    this.widthHighRatio_ = c3430e.m17194s();
                                } else if (iM17171M == 37) {
                                    this.widthScreenRatio_ = c3430e.m17194s();
                                } else if (iM17171M == 40) {
                                    this.enableClose_ = c3430e.m17188m();
                                } else if (iM17171M == 50) {
                                    this.schema_ = c3430e.m17170L();
                                } else if (iM17171M == 56) {
                                    this.isClientDeal_ = c3430e.m17188m();
                                } else if (!c3430e.m17176R(iM17171M)) {
                                }
                            }
                            z = true;
        ...
        public int getSerializedSize() {
            ...
            float f = this.widthHighRatio_;
            if (f != 0.0f) {
                iM16956K += CodedOutputStream.m16981q(3, f);
            }
            float f2 = this.widthScreenRatio_;
            if (f2 != 0.0f) {
                iM16956K += CodedOutputStream.m16981q(4, f2);
            }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            float f = this.widthHighRatio_;
            if (f != 0.0f) {
                codedOutputStream.m17021o0(3, f);
            }
            float f2 = this.widthScreenRatio_;
            if (f2 != 0.0f) {
                codedOutputStream.m17021o0(4, f2);
            }
            boolean z = this.enableClose_;
            if (z) {
        ...
        public static JumpLink parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (JumpLink) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static JumpLink parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
            return (JumpLink) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
        }
        ...
        public static JumpLink parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
            return (JumpLink) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
        }
        ...
        public static JumpLink parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
            return (JumpLink) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
        }

        public static JumpLink parseFrom(C3430e c3430e) throws IOException {
            return (JumpLink) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
        }
        ...
        public static JumpLink parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
            return (JumpLink) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
        }
    }
}
