...
public class RecordService {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    o6r0.m166283c(sb.toString());
                                }
                            } catch (Exception e2) {
                                e = e2;
                                bufferedWriter = bufferedWriter2;
                                o6r0.m166283c("cacheLog error: " + e.getMessage());
                                ...
                                if (bufferedWriter != null) {
                                    try {
                                        ...
                                        o6r0.m166283c("cacheLog error: " + e4.getMessage());
                                        throw th;
                                    }
                                }
                                if (fileWriter != null) {
    ...
    public static void recordAlertAppear(String str) {
        ...
        if (dfm.f88185f.equalsIgnoreCase(str)) {
            ...
            str2 = str.equalsIgnoreCase(dfm.f88191l) ? "overTimesAlertAppear" : "interruptedAlertAppear";
        }
    ...
    public static void recordAlertBtn(String str) {
        ...
        if (dfm.f88185f.equalsIgnoreCase(str)) {
            ...
            str2 = str.equalsIgnoreCase(dfm.f88191l) ? "overTimesExitBtn" : "interruptedRetryBtn";
        }
        getInstance().recordEventBehavior(RecordLevel.LOG_INFO, "PAGER_BEHAVIOR", str2, "FACE");
    }
    ...
    public static void recordAlertClose(String str) {
        ...
        if (dfm.f88185f.equalsIgnoreCase(str)) {
            ...
            str2 = str.equalsIgnoreCase(dfm.f88191l) ? "overTimesAlertClose" : "interruptedAlertClose";
        }
        getInstance().recordEventBehavior(RecordLevel.LOG_INFO, "PAGER_BEHAVIOR", str2, "FACE");
    }
    ...
    private void recordEventEx(RecordLevel recordLevel, String str, String... strArr) {
        ...
        o6r0.m166281a("action(" + this.clientIdx + ")=> " + str + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + map.toString());
    ...
    private void tryUpload(boolean z) {
        if (this.records.size() >= 10 || z) {
            ...
            qk20.m176913j(arrayList, false, new n3k0() { // from class: com.idv.identity.platform.log.RecordService.1
                @Override // p153l.n3k0
    ...
    public void init(Context context, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8) {
        ...
        o6r0.m166281a("logFilePath: ".concat(str9));
    ...
    public void recordEventBehavior(RecordLevel recordLevel, String str, String str2, String str3, String str4, String str5) {
        recordEvent(recordLevel, str, "time", this.simpleDateFormat.format(new Date()), "productCode", afm.m97360H().m97458i0(), "currentPage", str3, "cost", str5, "currentAlert", str4, "eventName", str2);
    }

    public void recordEventPage(RecordLevel recordLevel, String str, String str2, String str3, String str4) {
        recordEvent(recordLevel, str, "time", this.simpleDateFormat.format(new Date()), "currentPage", str2, "productCode", afm.m97360H().m97458i0(), "cost", str3, "exitReason", str4);
    }
