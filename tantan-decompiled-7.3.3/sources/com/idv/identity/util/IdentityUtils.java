...
public class IdentityUtils {
    ...
    public static native String m19239gk();

    /* JADX INFO: renamed from: gs */
    public static native String m19240gs(String str);

    /* JADX INFO: renamed from: sd */
    public static native String m19241sd(byte[] bArr, String str);

    /* JADX INFO: renamed from: se */
    public static native String m19242se(byte[] bArr, String str);
}
