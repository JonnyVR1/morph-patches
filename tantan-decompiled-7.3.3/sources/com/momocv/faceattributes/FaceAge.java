...
public class FaceAge {
    ...
    private static native boolean nativeProcessFrame(long j, MMFrame mMFrame, FaceAgeParams faceAgeParams, FaceAgeInfo faceAgeInfo);
    ...
    public synchronized boolean ProcessFrame(MMFrame mMFrame, FaceAgeParams faceAgeParams, FaceAgeInfo faceAgeInfo) {
        long j = this.mOBJPtr;
        if (j == 0 || !this.inited) {
            return false;
        }
        return nativeProcessFrame(j, mMFrame, faceAgeParams, faceAgeInfo);
    }
