...
public class DataRecycle {
    ...
    private static native boolean nativeProcessFrame(long j, MMFrame mMFrame, BaseParams baseParams, DataRecycleInfo dataRecycleInfo);
    ...
    public synchronized boolean ProcessFrame(MMFrame mMFrame, BaseParams baseParams, DataRecycleInfo dataRecycleInfo) {
        long j;
        j = this.mOBJPtr;
        return (j == 0 || !this.inited) ? false : nativeProcessFrame(j, mMFrame, baseParams, dataRecycleInfo);
    }
