...
public class XCameraWarpLevelParams implements Serializable {
    ...
    public float cheekbone_width_ = 0.0f;
    public float jaw_width_ = 0.0f;
    public float extern_ratio_ = 0.0f;
    public float height_bbox_ratio_ = 0.0f;
    public boolean thinface_euler_switch_ = false;
    public float small_face_ = 0.0f;
}
