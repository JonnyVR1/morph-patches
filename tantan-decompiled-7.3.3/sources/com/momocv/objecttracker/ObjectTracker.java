...
public class ObjectTracker {
    ...
    public int f15491n = 3;

    /* JADX INFO: renamed from: N */
    public int f15490N = 10;
    ...
    public synchronized void Create() throws Throwable {
        try {
            try {
                Release();
                this.mOBJ = nativeCreate(this.mOBJ, this.num_orientation, this.f15491n, this.f15490N, this.enable_detect_scale, this.enable_detect_loss, this.update_model);
            } catch (Throwable th) {
                th = th;
                throw th;
            }
