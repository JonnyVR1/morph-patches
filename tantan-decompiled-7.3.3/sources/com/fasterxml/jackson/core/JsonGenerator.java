...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    public void _writeSimpleObject(Object obj) throws IOException {
        ...
        m5j.m157106a("No ObjectCodec defined for the generator, can only serialize simple wrapper types (type passed ", obj.getClass().getName(), ")");
    }
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int iM9306id = currentToken.m9306id();
        if (iM9306id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            iM9306id = jsonParser.nextToken().m9306id();
        }
        if (iM9306id == 1) {
            writeStartObject();
