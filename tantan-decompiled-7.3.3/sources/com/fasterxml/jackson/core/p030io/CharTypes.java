...
public final class CharTypes {
    ...
    private static final byte[] f6908HB;

    /* JADX INFO: renamed from: HC */
    private static final char[] f6909HC;
    ...
    static {
        ...
        f6908HB = new byte[length];
        for (int i2 = 0; i2 < length; i2++) {
            f6908HB[i2] = (byte) f6909HC[i2];
        }
    ...
    public static byte[] copyHexBytes() {
        return (byte[]) f6908HB.clone();
    }

    public static char[] copyHexChars() {
        return (char[]) f6909HC.clone();
    }
