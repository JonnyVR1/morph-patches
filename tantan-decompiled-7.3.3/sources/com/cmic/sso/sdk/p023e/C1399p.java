...
public class C1399p {
    ...
    public static String[] m7356a(boolean z) {
        String[] strArr = {"", ""};
        ...
        try {
            ...
            C1386c.m7288b("UmcIPUtils", "onlyMobileDataIp " + z + " IPV6 ip：" + sb.toString());
            C1386c.m7288b("UmcIPUtils", "onlyMobileDataIp " + z + " IPV4 ip：" + sb2.toString());
            return strArr;
        } catch (Exception e) {
            e.printStackTrace();
            return strArr;
