        ...
        if (intentServiceName != null) {
            try {
                try {
                    ...
                    Logger.m5919d("No Intent Service found");
                    cls = null;
                }
        ...
        if (jSONArray != null && jSONArray.length() > 0) {
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                try {
                    ...
                    String strOptString = jSONObject.optString(BLiveStormDanmakuGiftResourceType.f45292l);
                    ...
                    if (strOptString.isEmpty() || strOptString4.isEmpty()) {
                        Logger.m5919d("not adding push notification action: action label or id missing");
                    } else {
                        if (strOptString3.isEmpty()) {
                            ...
                            try {
                                ...
                                Logger.m5919d("unable to add notification action icon: " + th.getLocalizedMessage());
                                identifier = 0;
                            }
                        }
                        ...
                        if (launchIntentForPackage != null) {
                            ...
                            try {
                                ...
                                th = th2;
                                Logger.m5919d("error adding notification action : " + th.getLocalizedMessage());
                            }
                        }
