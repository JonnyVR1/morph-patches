...
public abstract class CTInAppBasePartialHtmlFragment extends CTInAppBasePartialFragment implements View.OnTouchListener, View.OnLongClickListener {
    ...
    public final class C1268b extends GestureDetector.SimpleOnGestureListener {
        ...
        /* JADX INFO: renamed from: a */
        public final boolean m6493a(boolean ltr) {
            AnimationSet animationSet = new AnimationSet(true);
            animationSet.addAnimation(ltr ? new TranslateAnimation(0.0f, CTInAppBasePartialHtmlFragment.this.m6451i4(50), 0.0f, 0.0f) : new TranslateAnimation(0.0f, -CTInAppBasePartialHtmlFragment.this.m6451i4(50), 0.0f, 0.0f));
    ...
    private final View m6490y4(LayoutInflater inflater, ViewGroup container) {
        try {
            View viewMo6491A4 = mo6491A4(inflater, container);
            ViewGroup viewGroupMo6492z4 = mo6492z4(viewMo6491A4);
            Context context = inflater.getContext();
            context.getClass();
            CTInAppWebView cTInAppWebView = new CTInAppWebView(context, m6448f4().getWidth(), m6448f4().getHeight(), m6448f4().getWidthPercentage(), m6448f4().getHeightPercentage(), m6448f4().getAspectRatio());
            ...
            if (viewGroupMo6492z4 != null) {
                viewGroupMo6492z4.addView(cTInAppWebView);
            }
            return viewMo6491A4;
        } catch (Throwable th) {
    ...
    public abstract View mo6491A4(@NotNull LayoutInflater inflater, @Nullable ViewGroup container);

    @Override // com.clevertap.android.sdk.inapp.fragment.CTInAppBaseFragment, androidx.fragment.app.Fragment
    public void onAttach(@NotNull Context context) {
        context.getClass();
        super.onAttach(context);
        this.gd = new GestureDetector(context, new C1268b());
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        inflater.getClass();
        return m6490y4(inflater, container);
    }
    ...
    public abstract ViewGroup mo6492z4(@Nullable View view);
}
