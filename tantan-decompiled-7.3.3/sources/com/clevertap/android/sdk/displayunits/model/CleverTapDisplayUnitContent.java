...
public class CleverTapDisplayUnitContent implements Parcelable {
    public static final Parcelable.Creator<CleverTapDisplayUnitContent> CREATOR = new C1206a();
    ...
    public class C1206a implements Parcelable.Creator<CleverTapDisplayUnitContent> {
    ...
    public static CleverTapDisplayUnitContent m6059b(JSONObject jSONObject) {
        String string;
        String string2;
        String string3;
        String string4;
        ...
        try {
            ...
            Logger.m5920d(Constants.FEATURE_DISPLAY_UNIT, "Unable to init CleverTapDisplayUnitContent with JSON - " + e.getLocalizedMessage());
            return new CleverTapDisplayUnitContent("", "", "", "", "", "", "", "", "", "Error Creating DisplayUnit Content from JSON : " + e.getLocalizedMessage());
        }
    }

    /* JADX INFO: renamed from: a */
    public String m6060a() {
        return this.error;
    }
    ...
    public /* synthetic */ CleverTapDisplayUnitContent(Parcel parcel, C1206a c1206a) {
        this(parcel);
    }
}
