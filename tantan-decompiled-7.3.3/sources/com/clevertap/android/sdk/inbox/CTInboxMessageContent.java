...
public class CTInboxMessageContent implements Parcelable {
    public static final Parcelable.Creator<CTInboxMessageContent> CREATOR = new C1304a();
    ...
    public class C1304a implements Parcelable.Creator<CTInboxMessageContent> {
    ...
    public CTInboxMessageContent(Parcel parcel) {
        ...
        try {
            ...
            Logger.m5927v("Unable to init CTInboxMessageContent with Parcel - " + e.getLocalizedMessage());
        }
    ...
    public boolean m6746A() {
        return m6769x() || m6747B();
    }

    /* JADX INFO: renamed from: B */
    public boolean m6747B() {
        String strM6749b = m6749b();
        return (strM6749b == null || this.media == null || !strM6749b.startsWith("video")) ? false : true;
    }

    /* JADX INFO: renamed from: a */
    public String m6748a() {
    ...
    public String m6750c() {
        return this.icon;
    }

    /* JADX INFO: renamed from: d */
    public String m6751d() {
    ...
    public String m6752e(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
            ...
            Logger.m5927v("Unable to get Link Text Color with JSON - " + e.getLocalizedMessage());
            return null;
        }
    }

    /* JADX INFO: renamed from: f */
    public String m6753f(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
    ...
    public String m6754g(JSONObject jSONObject) {
        if (jSONObject == null) {
            return "";
        }
        try {
            ...
            Logger.m5927v("Unable to get Link Text with JSON - " + e.getLocalizedMessage());
            return "";
        }
    }

    /* JADX INFO: renamed from: h */
    public HashMap<String, String> m6755h(JSONObject jSONObject) {
        if (jSONObject != null && jSONObject.has(Constants.KEY_KV)) {
            try {
                ...
                Logger.m5927v("Unable to get Link Key Value with JSON - " + e.getLocalizedMessage());
            }
        }
        return null;
    }
    ...
    public String m6756i(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
    ...
    public String m6757k(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
            ...
            Logger.m5927v("Unable to get Link URL with JSON - " + e.getLocalizedMessage());
            return null;
        }
    }

    /* JADX INFO: renamed from: l */
    public JSONArray m6758l() {
        return this.links;
    }

    /* JADX INFO: renamed from: m */
    public String m6759m(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
            ...
            Logger.m5927v("Unable to get Link Type with JSON - " + e.getLocalizedMessage());
            return null;
        }
    }

    /* JADX INFO: renamed from: n */
    public String m6760n() {
        return this.media;
    }

    /* JADX INFO: renamed from: o */
    public String m6761o() {
        return this.mediaContentDescription;
    }

    /* JADX INFO: renamed from: p */
    public String m6762p() {
        return this.message;
    }

    /* JADX INFO: renamed from: q */
    public String m6763q() {
        return this.messageColor;
    }

    /* JADX INFO: renamed from: r */
    public String m6764r() {
        return this.posterUrl;
    }

    /* JADX INFO: renamed from: s */
    public String m6765s() {
        return this.title;
    }

    /* JADX INFO: renamed from: t */
    public String m6766t() {
        return this.titleColor;
    }

    /* JADX INFO: renamed from: u */
    public CTInboxMessageContent m6767u(JSONObject jSONObject) {
        String str = "links";
        try {
            ...
            Logger.m5927v("Unable to init CTInboxMessageContent with JSON - " + e.getLocalizedMessage());
            return this;
        }
    }

    /* JADX INFO: renamed from: w */
    public boolean m6768w(JSONObject jSONObject) {
        if (jSONObject == null) {
            return false;
        }
        try {
            ...
            Logger.m5927v("Unable to get fallback settings key with JSON - " + e.getLocalizedMessage());
            return false;
        }
    }
    ...
    public boolean m6769x() {
        String strM6749b = m6749b();
        return (strM6749b == null || this.media == null || !strM6749b.startsWith("audio")) ? false : true;
    }

    /* JADX INFO: renamed from: y */
    public boolean m6770y() {
        String strM6749b = m6749b();
        return (strM6749b == null || this.media == null || !strM6749b.equals("image/gif")) ? false : true;
    }

    /* JADX INFO: renamed from: z */
    public boolean m6771z() {
        String strM6749b = m6749b();
        return (strM6749b == null || this.media == null || !strM6749b.startsWith("image") || strM6749b.equals("image/gif")) ? false : true;
    }
