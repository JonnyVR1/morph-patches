...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i, int i2, int i3, int i4) {
        ...
        retain();
        return new TextureBufferImpl(i, i2, i3, i4, this.type, this.f4771id, this.scaleFilter, matrix2, this.toI420Handler, this.yuvConverter, new Runnable() { // from class: l.cti0
    ...
    public static /* synthetic */ TextureBufferImpl m5775e(final TextureBufferImpl textureBufferImpl) {
        ...
        textureBufferImpl.yuvConverter.drawTexture(textureBufferImpl.type == VideoFrame.TextureBuffer.Type.OES ? 11 : 10, textureBufferImpl.f4771id, iDequeueTexture, textureBufferImpl.width, textureBufferImpl.height);
        return new TextureBufferImpl(textureBufferImpl.width, textureBufferImpl.height, VideoFrame.TextureBuffer.Type.RGB, iDequeueTexture, textureBufferImpl.transformMatrix, textureBufferImpl.toI420Handler, textureBufferImpl.yuvConverter, new Runnable() { // from class: l.dti0
            @Override // java.lang.Runnable
            public final void run() {
                this.f90598a.yuvConverter.queueTexture(iDequeueTexture);
            }
        });
    }
    ...
    public VideoFrame.Buffer copyData() {
        return (VideoFrame.Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: l.eti0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureBufferImpl.m5775e(this.f95757a);
            }
        });
    }
    ...
    public EGLContext getEglContext() {
        ...
        return (EGLContext) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: l.ati0
            @Override // java.util.concurrent.Callable
            public final Object call() {
    ...
    public VideoFrame.I420Buffer toI420() {
        ...
        return (filterType == null || filterType == FilterType.Origin) ? (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: l.fti0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                TextureBufferImpl textureBufferImpl = this.f100749a;
                return textureBufferImpl.yuvConverter.convert(textureBufferImpl);
            }
        }) : (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: l.gti0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                TextureBufferImpl textureBufferImpl = this.f106420a;
