...
public class YuvHelper {
    public static void I420Copy(ByteBuffer byteBuffer, int i, ByteBuffer byteBuffer2, int i2, ByteBuffer byteBuffer3, int i3, ByteBuffer byteBuffer4, int i4, int i5) {
        ...
        if (byteBuffer4.capacity() < i9) {
            dpq0.m117417a("Expected destination buffer capacity to be at least ", i9, " was ", byteBuffer4.capacity());
            return;
        }
        ...
        nativeI420Copy(byteBuffer, i, byteBuffer2, i2, byteBuffer3, i3, byteBufferSlice, i4, byteBufferSlice2, i6, byteBuffer4.slice(), i6, i4, i5);
    }
    ...
    public static void I420Rotate(ByteBuffer byteBuffer, int i, ByteBuffer byteBuffer2, int i2, ByteBuffer byteBuffer3, int i3, ByteBuffer byteBuffer4, int i4, int i5, int i6) {
        ...
        if (byteBuffer4.capacity() < i14) {
            dpq0.m117417a("Expected destination buffer capacity to be at least ", i14, " was ", byteBuffer4.capacity());
            return;
        }
        byteBuffer4.position(0);
        ByteBuffer byteBufferSlice = byteBuffer4.slice();
    ...
    public static void I420ToNV12(ByteBuffer byteBuffer, int i, ByteBuffer byteBuffer2, int i2, ByteBuffer byteBuffer3, int i3, ByteBuffer byteBuffer4, int i4, int i5) {
        ...
        if (byteBuffer4.capacity() < i8) {
            dpq0.m117417a("Expected destination buffer capacity to be at least ", i8, " was ", byteBuffer4.capacity());
            return;
        }
        byteBuffer4.position(0);
        ByteBuffer byteBufferSlice = byteBuffer4.slice();
        byteBuffer4.position(i7);
        nativeI420ToNV12(byteBuffer, i, byteBuffer2, i2, byteBuffer3, i3, byteBufferSlice, i4, byteBuffer4.slice(), i6 * 2, i4, i5);
    }
    ...
    public static void NV12Copy(ByteBuffer byteBuffer, int i, ByteBuffer byteBuffer2, int i2, ByteBuffer byteBuffer3, int i3, int i4) {
        ...
        if (byteBuffer3.capacity() < i7) {
            dpq0.m117417a("Expected destination buffer capacity to be at least ", i7, " was ", byteBuffer3.capacity());
            return;
        }
        byteBuffer3.position(0);
        ByteBuffer byteBufferSlice = byteBuffer3.slice();
        byteBuffer3.position(i6);
        nativeNV12Copy(byteBuffer, i, byteBuffer2, i2, byteBufferSlice, i3, byteBuffer3.slice(), i5 * 2, i3, i4);
    }
    ...
    private static native void nativeNV12Copy(ByteBuffer byteBuffer, int i, ByteBuffer byteBuffer2, int i2, ByteBuffer byteBuffer3, int i3, ByteBuffer byteBuffer4, int i4, int i5, int i6);
