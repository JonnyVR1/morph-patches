...
public class YuvConverter {
    ...
    public VideoFrame.I420Buffer convert(VideoFrame.TextureBuffer textureBuffer, FilterType filterType, int i, int i2) {
        ...
        if (iGlGetError != 0) {
            ...
            RXLogging.m5742e("YUVConverter", "convert i420 failed as opengl error " + iGlGetError);
        ...
        return JavaI420Buffer.wrap(width, height, byteBufferSlice, i3, byteBufferSlice2, i3, byteBufferNativeAllocateByteBuffer.slice(), i3, new Runnable() { // from class: l.cpq0
