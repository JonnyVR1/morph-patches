...
public class EglBase14 implements EglBase {
    ...
    private static EGLContext createEglContext(@Nullable Context context, int i, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
        ...
        if (eGLContextEglCreateContext != EGL14.EGL_NO_CONTEXT) {
            egl14ContextCount++;
            RXLogging.m5746w(TAG, "EGL14 context create. current count is:" + egl14ContextCount);
    ...
    private void eglDetachCurrent() {
        ...
        rdd0.m180845a("eglDetachCurrent failed: 0x", Integer.toHexString(EGL14.eglGetError()));
    }
    ...
    private void eglMakeCurrent() {
        ...
        rdd0.m180845a("eglMakeCurrent failed: 0x", Integer.toHexString(EGL14.eglGetError()));
    }
    ...
    private void init(int i, Context context, int[] iArr) {
        ...
        try {
            ...
            if (i != 3) {
                RXLogging.m5746w(TAG, "EGL14 GLES context create failed.");
                throw e;
            }
            RXLogging.m5746w(TAG, "EGL14 GLES3 context create failed: " + e.toString() + ". trying falback to EGLS2");
    ...
    public void createPbufferSurface(int i, int i2) {
        ...
        Log.e(TAG, "Failed to create pixel buffer surface with size " + i + BaseSei.f14624X + i2 + ": 0x" + Integer.toHexString(EGL14.eglGetError()));
    ...
    public void release() {
        ...
        this.eglConfig = null;
        egl14ContextCount--;
        RXLogging.m5746w(TAG, "EGL14 context destroy. current count is:" + egl14ContextCount);
    }
