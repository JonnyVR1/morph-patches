...
class AndroidVideoDecoder extends MediaCodec.Callback implements VideoDecoder, VideoSink {
    ...
    public AndroidVideoDecoder(MediaCodecWrapperFactory mediaCodecWrapperFactory, String str, RXVideoCodecStandard rXVideoCodecStandard, int i) {
        ...
        RXLogging.m5746w(TAG, "ctor name: " + str + " type: " + rXVideoCodecStandard + " color format(19:I420 21:NV12): " + i);
    ...
    public static /* synthetic */ int m5748a(AndroidVideoDecoder androidVideoDecoder, int i, MediaCodec.BufferInfo bufferInfo, boolean z) {
        ...
        try {
            ...
            RXLogging.m5747w(TAG, "releaseOutputBuffer failed", e);
            return 0;
        }
    }
    ...
    public static /* synthetic */ void m5749b(AndroidVideoDecoder androidVideoDecoder, HandlerThread handlerThread) {
    ...
    private NativeRXByteMemory copyI420Buffer(ByteBuffer byteBuffer, int i, int i2, int i3, int i4) {
        ...
        if (i % 2 != 0) {
            RXLogging.m5742e(TAG, "Stride is not divisible by two: " + i);
            return null;
        }
        int i5 = (i3 + 1) / 2;
        ...
        try {
            ...
            try {
                ...
                e = e;
                RXLogging.m5743e(TAG, "buffer err:", e);
                nativeRXByteMemory.release();
                return null;
            }
        } catch (Exception e2) {
    ...
    private NativeRXByteMemory copyNV12Buffer(ByteBuffer byteBuffer, int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            RXLogging.m5743e(TAG, "copyNV12Buffer err:", e);
            nativeRXByteMemoryCreateRXByteMemory.release();
            return null;
        }
    }
    ...
    private void deliverByteFrame(int i, MediaCodec.BufferInfo bufferInfo) {
        ...
        if (i6 < ((i2 * i3) * 3) / 2) {
            RXLogging.m5742e(TAG, "Insufficient output buffer size: " + bufferInfo.size);
            return;
        }
        ...
        try {
            ...
            try {
                ...
                if (nativeRXByteMemory == null) {
                    RXLogging.m5742e(TAG, "byteMemory is null, colorFormat:" + androidVideoDecoder.colorFormat);
                ...
                try {
                    ...
                    RXLogging.m5742e(TAG, "callback is null, dropDecodedFrameCount:" + androidVideoDecoder.dropDecodedFrameCount);
                    androidVideoDecoder.dropDecodedFrameCount = androidVideoDecoder.dropDecodedFrameCount + 1;
                    nativeRXByteMemory.release();
                    nativeRXVideoFrameCreateRXVideoFrame.release();
                } catch (Exception e2) {
                    RXLogging.m5743e(TAG, "releaseOutputBuffer failed!", e2);
                    nativeRXByteMemory.release();
                }
            } catch (Exception e3) {
                e = e3;
            ...
            RXLogging.m5743e(TAG, "getOutputBuffer failed!", e4);
        }
    }
    ...
    private void deliverTextureFrame(int i, MediaCodec.BufferInfo bufferInfo) {
        ...
        if (this.enableRetryDeliver && this.running) {
            ...
            RXLogging.m5744i(TAG, "currentFrameCache:" + this.currentFrameCache);
            ...
            RXLogging.m5744i(TAG, "retry delivering frame take ms: " + (SystemClock.elapsedRealtime() - jElapsedRealtime));
        }
        VideoDecoder.Callback callback = this.callback;
        synchronized (this.renderedTextureMetadataLock) {
            if (this.renderedTextureMetadata != null && (mediaCodecWrapper = this.codec) != null) {
                try {
                    ...
                    RXLogging.m5743e(TAG, "releaseOutputBuffer failed", e3);
                }
            ...
            synchronized (this.surfaceTextureHelperLock) {
                ...
                if (surfaceTextureHelper != null) {
                    ...
                    if (mediaCodecWrapper2 != null) {
                        try {
                            ...
                            RXLogging.m5743e(TAG, "releaseOutputBuffer failed!", e4);
                        }
                    }
                    return;
                }
                ...
                RXLogging.m5742e(TAG, "surfaceTextureHelper is null, drop current decoded frame.");
                ...
                if (mediaCodecWrapper3 != null) {
                    try {
                        ...
                        RXLogging.m5743e(TAG, "releaseOutputBuffer failed", e5);
                    }
                }
                return;
            }
    ...
    private void deliverTextureFrameOutSide(final int i, final MediaCodec.BufferInfo bufferInfo) {
        ...
        synchronized (this.surfaceTextureHelperLock) {
            ...
            if (surfaceTextureHelper != null) {
                ...
                this.outSideSurfaceTextureHelper.onFrame(new MediaCodecTextureBufferHelper(new MediaCodecTextureBufferHelper.ReleaseOutPutBuffer() { // from class: com.bytedance.realx.video.b
                    ...
                    public final int release(boolean z) {
                        return AndroidVideoDecoder.m5748a(this.f4776a, i, bufferInfo, z);
                    }
                }));
                return;
            }
            ...
            RXLogging.m5742e(TAG, "outSideSurfaceTextureHelper is null, drop current decoded frame.");
            MediaCodecWrapper mediaCodecWrapper = this.codec;
            if (mediaCodecWrapper != null) {
                try {
                    mediaCodecWrapper.releaseOutputBuffer(i, false);
                } catch (Exception e) {
                    RXLogging.m5743e(TAG, "releaseOutputBuffer failed", e);
                }
            }
        }
    }
    ...
    public void directRenderByVSync() {
        try {
                ...
                public void doFrame(long j) {
                    ...
                    if (outputBufferInfo != null) {
                        try {
                            ...
                            RXLogging.m5743e(AndroidVideoDecoder.TAG, "releaseOutputBuffer err:", e);
            ...
            RXLogging.m5743e(TAG, "direct render by vsync is error", e);
        }
    }
    ...
    private void drainOutputFrame(MediaCodec.BufferInfo bufferInfo, int i) {
        ...
        if (this.isError.get()) {
            RXLogging.m5746w(TAG, "codec is error when call drainOutputFrame");
            return;
        }
        VideoDecoder.Callback callback = this.callback;
        if (callback == null) {
            RXLogging.m5742e(TAG, "callback is null, return");
            return;
        }
    ...
    private VideoCodecStatus feedInputBufferAsync(EncodedImage encodedImage) {
        ...
        if (iIntValue == -1) {
            RXLogging.m5746w(TAG, "decode() - no HW buffers available; decoder falling behind");
        ...
        try {
            ...
            if (inputBuffer.capacity() < iRemaining) {
                RXLogging.m5742e(TAG, "decode() - HW buffer too small");
                return VideoCodecStatus.OVERLOAD;
            }
            ...
            try {
                ...
                RXLogging.m5743e(TAG, "queueInputBuffer failed", e2);
                return VideoCodecStatus.ERROR;
            }
        } catch (Exception e3) {
            RXLogging.m5743e(TAG, "getInputBuffer failed", e3);
            return VideoCodecStatus.ERROR;
        }
    }
    ...
    private VideoCodecStatus feedInputBufferSync(EncodedImage encodedImage) {
        ...
        try {
            ...
            if (iDequeueInputBuffer < 0) {
                RXLogging.m5742e(TAG, "decode() - no HW buffers available; decoder falling behind");
                return VideoCodecStatus.OVERLOAD;
            }
            try {
                ...
                if (inputBuffer == null) {
                    RXLogging.m5742e(TAG, "decode() - HW buffer is null");
                    return VideoCodecStatus.OVERLOAD;
                }
                ...
                RXLogging.m5742e(TAG, "getInputBuffers failed,useNewInputBufferAPI" + this.useNewInputBufferAPI + "exception:" + e2);
                return VideoCodecStatus.ERROR;
            }
        } catch (IllegalStateException e3) {
    ...
    private VideoCodecStatus initDecodeInternal(int i, int i2) {
        ...
        if (this.callback == null) {
            RXLogging.m5741d(TAG, "callback uninitalized");
        ...
        try {
            ...
            if (this.enableCheckSysResolutionSupport && !this.codec.getCodecInfo().getCapabilitiesForType(this.codecType.mimeType()).getVideoCapabilities().isSizeSupported(i, i2)) {
                this.codec.release();
                releaseSurface();
                RXLogging.m5746w(TAG, "isSizeSupported return false with the resolution:" + i + "xheight, fallback software");
                this.callback.onMediaCodecStatus(VideoCodecStatus.MEDIACODEC_OUT_OF_RESOLUTION, "isSizeSupported return false with the resolution:" + i + BaseSei.f14624X + i2);
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
            try {
                ...
                if (this.outSideSurfaceTextureHelper == null || (surface = this.surface) == null) {
                    ...
                    if (surface2 != null) {
                        ...
                        RXLogging.m5746w(TAG, "init codec done with external surface:" + this.exSurface);
                    } else {
                        this.codec.configure(mediaFormatCreateVideoFormat, this.surface, null, 0);
                        RXLogging.m5746w(TAG, "init codec done with internal surface:" + this.surface);
                    }
                } else {
                    this.codec.configure(mediaFormatCreateVideoFormat, surface, null, 0);
                    RXLogging.m5746w(TAG, "init codec done control by outside with internal surface:" + this.surface);
                }
                this.codec.start();
                ...
                RXLogging.m5746w(TAG, "current decoder SupportedHeights:" + capabilitiesForType.getVideoCapabilities().getSupportedHeights());
                RXLogging.m5746w(TAG, "current decoder SupportedWidths:" + capabilitiesForType.getVideoCapabilities().getSupportedWidths());
                RXLogging.m5746w(TAG, "current decoder SupportedFrameRates:" + capabilitiesForType.getVideoCapabilities().getSupportedFrameRates());
                if (!capabilitiesForType.getVideoCapabilities().getSupportedHeights().contains(Integer.valueOf(i2)) || !capabilitiesForType.getVideoCapabilities().getSupportedWidths().contains(Integer.valueOf(i))) {
                    this.callback.onMediaCodecStatus(VideoCodecStatus.MEDIACODEC_OUT_OF_RESOLUTION, "hardware decoder not support the resolution:" + i + BaseSei.f14624X + i2);
                    this.codec.release();
                    releaseSurface();
                    RXLogging.m5746w(TAG, "initDecodeInternal err,decoder not support the resolution:" + i + "xheight, fallback software");
                    return VideoCodecStatus.FALLBACK_SOFTWARE;
                }
                RXLogging.m5742e(TAG, "initDecode Argument err, try reset Argument and reconfig");
                ...
                try {
                    ...
                    RXLogging.m5742e(TAG, "initDecode failed when retry config:" + e);
                    StringWriter stringWriter = new StringWriter();
                    e.printStackTrace(new PrintWriter(stringWriter));
            ...
            if (!this.useAsyncMode) {
                ...
                try {
                    ...
                    this.codec.release();
                    releaseSurface();
                    RXLogging.m5743e(TAG, "outputThread create err, fallback software:", e2);
                    return VideoCodecStatus.FALLBACK_SOFTWARE;
                }
            }
            ...
            RXLogging.m5746w(TAG, "initDecodeInternal done,init video decoder cost time:" + (SystemClock.elapsedRealtime() - jElapsedRealtime));
            ...
            RXLogging.m5742e(TAG, "Cannot create media decoder " + this.codecName);
            releaseSurface();
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    private void initMediaFormat(MediaFormat mediaFormat) {
        if ((this.sharedContext == null || this.settings.enableYUVOutput) && this.exSurface == null) {
            RXLogging.m5746w(TAG, "init colorFormat is(I420:19):" + this.colorFormat);
        ...
        if (mediaCodecWrapper != null && mediaCodecWrapper.getCodecInfo().getCapabilitiesForType(this.codecType.mimeType()).isFeatureSupported("adaptive-playback")) {
            ...
            if (z) {
                ...
                RXLogging.m5746w(TAG, "enable adaptive playback max_width: " + this.adaptive_playback_max_width + ", max_height: " + this.adaptive_playback_max_height);
            }
        }
        VideoDecoder.Settings settings = this.settings;
        ...
        for (Map.Entry<String, String> entry : this.privateParams.entrySet()) {
            if (!entry.getKey().equals("max-width") && !entry.getKey().equals("max-height")) {
                RXLogging.m5746w(TAG, "set android hardware decoder private param with Key:" + entry.getKey() + " Value:" + entry.getValue());
                if (entry.getKey().equals(HISI_DECODER_END_CODE) && "0".equals(entry.getValue())) {
                    this.enableHisiEndCode = false;
                    RXLogging.m5746w(TAG, "set android hardware decoder close hisi hw decoder endcode");
                } else {
                    RXLogging.m5746w(TAG, "set android hardware decoder private param with Key:" + entry.getKey() + " Value:" + entry.getValue());
    ...
    private VideoCodecStatus initOutSideSurfaceTextureHelper(int i, int i2) {
        try {
            ...
            RXLogging.m5742e(TAG, "err when create surface:" + e);
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    private void reformat(MediaFormat mediaFormat) {
        ...
        if (mediaFormat.containsKey(MEDIA_FORMAT_KEY_CROP_LEFT) && mediaFormat.containsKey(MEDIA_FORMAT_KEY_CROP_RIGHT) && mediaFormat.containsKey(MEDIA_FORMAT_KEY_CROP_BOTTOM) && mediaFormat.containsKey(MEDIA_FORMAT_KEY_CROP_TOP)) {
            ...
            RXLogging.m5744i(TAG, "stream have crop info newWidth:" + integer + " newHeight:" + integer2);
        } else {
            ...
            try {
                if (!this.hasDecodedFirstFrame || (this.width == integer && this.height == integer2)) {
                    ...
                    if (((this.surfaceTextureHelper == null && this.outSideSurfaceTextureHelper == null && this.exSurface == null) || this.settings.enableYUVOutput) && mediaFormat.containsKey("color-format")) {
                        ...
                        RXLogging.m5744i(TAG, "Color: 0x" + Integer.toHexString(this.colorFormat));
                    ...
                    synchronized (this.dimensionLock) {
                        try {
                            ...
                            RXLogging.m5744i(TAG, "Frame stride and slice height: " + this.stride + " x " + this.sliceHeight);
    ...
    private VideoCodecStatus reinitDecode(int i, int i2) {
        ...
        if (videoCodecStatusReleaseInternal != VideoCodecStatus.OK) {
            RXLogging.m5742e(TAG, "releaseInternal err");
    ...
    public void releaseCodecOnOutputThread() {
        try {
            ...
            RXLogging.m5742e(TAG, "thread check err");
        }
        RXLogging.m5744i(TAG, "Releasing MediaCodec on output thread");
        try {
            this.codec.stop();
        } catch (Exception e) {
            RXLogging.m5743e(TAG, "Media decoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            RXLogging.m5743e(TAG, "Media decoder release failed", e2);
    ...
    private VideoCodecStatus releaseInternal() {
        if (!this.running) {
            RXLogging.m5741d(TAG, "release: Decoder is not running.");
            return VideoCodecStatus.OK;
        }
        try {
            ...
            RXLogging.m5743e(TAG, "directRenderThread join error", e);
        }
        if (this.useAsyncMode) {
            VideoCodecStatus videoCodecStatus = VideoCodecStatus.OK;
            this.running = false;
            ...
            if (handlerThread != null) {
                this.asyncHandler.post(new Runnable() { // from class: com.bytedance.realx.video.a
                    ...
                    public final void run() {
                        AndroidVideoDecoder.m5749b(this.f4774a, handlerThread);
                    }
                });
                if (!ThreadUtils.joinUninterruptibly(this.asyncOutputThread, 6000L)) {
                    RXLogging.m5743e(TAG, "Media decoder release timeout", new RuntimeException());
        ...
        try {
            ...
            RXLogging.m5743e(TAG, "Media decoder release error", new RuntimeException(this.shutdownException));
        ...
        for (Map.Entry<String, String> entry : this.privateParams.entrySet()) {
            if (entry.getKey().equals(str) && isNumeric(entry.getValue())) {
                ...
                if (iMax > ADAPTIVE_PLAYBACK_MAX_DIMENSION || iMax <= 0) {
                    RXLogging.m5746w(TAG, "setAdaptivePlaybackParam failed! exceeding the valid range(0, 10000], key: " + entry.getKey() + ", value: " + iMax + " {privateConfig: " + Integer.parseInt(entry.getValue()) + ", resoluion: " + num + "}");
                    return false;
                }
                mediaFormat.setInteger(entry.getKey(), iMax);
                RXLogging.m5746w(TAG, "setAdaptivePlaybackParam params key: " + entry.getKey() + ", value:" + Math.max(Integer.parseInt(entry.getValue()), num.intValue()) + " {privateConfig: " + Integer.parseInt(entry.getValue()) + ", resoluion: " + num + "}");
                return true;
            }
        }
        RXLogging.m5746w(TAG, "setAdaptivePlaybackParam, but private key isn't setted, params: " + str);
        return false;
    }
    ...
    private void setIntegerParam(MediaFormat mediaFormat, String str, Integer num) {
        for (Map.Entry<String, String> entry : this.privateParams.entrySet()) {
            if (entry.getKey().equals(str)) {
                if (isNumeric(entry.getValue())) {
                    mediaFormat.setInteger(entry.getKey(), Integer.parseInt(entry.getValue()));
                    RXLogging.m5746w(TAG, "the decoder params " + entry.getKey() + " is coverd by vpaas with value:" + entry.getValue());
                    this.privateParams.remove(str);
                    return;
                }
                this.privateParams.remove(str);
                if (entry.getValue().length() <= 0) {
                    RXLogging.m5746w(TAG, "the decoder params " + entry.getKey() + " is disabled by vpaas,skip it");
                    return;
                }
                RXLogging.m5746w(TAG, "the decoder params " + entry.getKey() + " set by vpaas is invalid with value:" + entry.getValue() + ",skip it");
            }
        }
        RXLogging.m5746w(TAG, "decoder int params has been set with Key:" + str + " Value:" + num);
    ...
    private void setStringParam(MediaFormat mediaFormat, String str, String str2) {
        ...
        RXLogging.m5746w(TAG, "decoder string params has been set with Key:" + str + " Value:" + str2);
        ...
        for (Map.Entry<String, String> entry : this.privateParams.entrySet()) {
            if (entry.getKey().equals(ENABLE_CHECK_SYS_RESOLUTION_SUPPORT)) {
                if (entry.getValue() == "0") {
                    ...
                    RXLogging.m5746w(TAG, "set android hardware decoder close check sys resolution support");
                } else if (entry.getValue() == "1") {
                    this.enableCheckSysResolutionSupport = true;
                    RXLogging.m5746w(TAG, "set android hardware decoder open check sys resolution support");
                }
            }
        }
    }
    ...
    public VideoCodecStatus decode(EncodedImage encodedImage) {
        ...
        if (this.isError.get()) {
            RXLogging.m5742e(TAG, "mediacodec error.");
            return VideoCodecStatus.ERROR;
        }
        try {
            ...
            if (i != this.encoded_width || encodedImage.encodedHeight != this.encoded_height) {
                if (this.codec != null && this.enable_adaptive_playback && (i > this.adaptive_playback_max_width || encodedImage.encodedHeight > this.adaptive_playback_max_height)) {
                    RXLogging.m5746w(TAG, "frame resolution(" + encodedImage.encodedWidth + "*" + encodedImage.encodedHeight + " exceeded maximum limit of adaptive playback max_width: " + this.adaptive_playback_max_width + ", max_height: " + this.adaptive_playback_max_height);
            ...
            if (this.codec != null && this.callback != null) {
                ...
                if (byteBuffer == null) {
                    RXLogging.m5742e(TAG, "decode() - no input data");
                    return VideoCodecStatus.ERR_PARAMETER;
                }
                if (byteBuffer.remaining() == 0) {
                    RXLogging.m5742e(TAG, "decode() - input buffer empty");
                    return VideoCodecStatus.ERR_PARAMETER;
                }
                if (this.keyFrameRequired) {
                    if (encodedImage.frameType != EncodedImage.FrameType.kIntra) {
                        RXLogging.m5742e(TAG, "decode() - key frame required first");
                        return VideoCodecStatus.NO_OUTPUT;
                    }
                    if (!encodedImage.completeFrame) {
                        RXLogging.m5742e(TAG, "decode() - complete frame required first");
                        return VideoCodecStatus.NO_OUTPUT;
                    }
                }
                VideoCodecStatus videoCodecStatus = VideoCodecStatus.OK;
                ...
                if (settings.enableSmoothOutput && !settings.latencyInsensitiveMode && !settings.enableBFrameDecode) {
                    ...
                    if (j5 >= 0 && j4 > j5) {
                        try {
                            ...
                            RXLogging.m5742e(TAG, "currentFrameCache:" + this.currentFrameCache + " minFrameCache:" + this.minFrameCache);
                        }
                    }
                }
            ...
            RXLogging.m5741d(TAG, sb2.toString());
            return VideoCodecStatus.UNINITIALIZED;
        } catch (Exception e) {
            RXLogging.m5743e(TAG, "android decode err", e);
            return VideoCodecStatus.ERROR;
        }
    }
    ...
    public void deliverDecodedFrame() {
        try {
            this.outputThreadChecker.checkIsOnValidThread();
            if (this.codec == null) {
                RXLogging.m5746w(TAG, "codec is null when call deliverDecodedFrame");
                return;
            }
            ...
            if (iDequeueOutputBuffer == -2) {
                ...
                RXLogging.m5746w(TAG, "dequeueOutputBuffer err, returned " + iDequeueOutputBuffer);
            }
        } catch (Exception unused) {
            RXLogging.m5742e(TAG, "deliverDecodedFrame failed");
        }
    }

    @Override // com.bytedance.realx.video.VideoDecoder
    public void disableExternalSurface() {
        RXLogging.m5746w(TAG, "disable external surface.");
        this.exSurface = null;
    }
    ...
    public void onFrame(RXVideoFrameInterface rXVideoFrameInterface) {
        ...
        if (callback == null) {
            this.dropDecodedFrameCount++;
            RXLogging.m5742e(TAG, "callback is null, dropDecodedFrameCount:" + this.dropDecodedFrameCount);
            return;
        }
        synchronized (this.renderedTextureMetadataLock) {
            try {
                ...
                if (decodedTextureMetadata == null) {
                    RXLogging.m5742e(TAG, "renderedTextureMetadata is null drop current decoded frame,running:" + this.running);
    ...
    public void onOutputFormatChanged(MediaCodec mediaCodec, MediaFormat mediaFormat) {
        MediaCodecWrapper mediaCodecWrapper;
        RXLogging.m5742e(TAG, "onOutputFormatChanged ");
        if (this.running && (mediaCodecWrapper = this.codec) != null && mediaCodecWrapper.getRealCodec() == mediaCodec) {
    ...
    public VideoCodecStatus release() {
        RXLogging.m5746w(TAG, "mediacodec release start");
        VideoCodecStatus videoCodecStatusReleaseInternal = releaseInternal();
        releaseSurface();
    ...
    public void releaseSurface() {
        RXLogging.m5746w(TAG, "releaseSurface start");
        try {
            if (this.surface != null) {
                RXLogging.m5746w(TAG, "release surface");
            ...
            synchronized (this.surfaceTextureHelperLock) {
                try {
                    if (this.surfaceTextureHelper != null) {
                        RXLogging.m5746w(TAG, "surfaceTextureHelper.stopListening()");
            ...
            RXLogging.m5742e(TAG, "releaseSurface:" + e);
        }
        RXLogging.m5746w(TAG, "releaseSurface end");
    }
    ...
    public void releaseSurfaceTextureHelper() {
        synchronized (this.surfaceTextureHelperLock) {
            try {
                if (this.surfaceTextureHelper != null) {
                    RXLogging.m5746w(TAG, "release surfaceTextureHelper");
                    this.surfaceTextureHelper.dispose();
                    this.surfaceTextureHelper = null;
                    curEglContextNum--;
                    RXLogging.m5746w(TAG, "release surfaceTextureHelper done, curEglContextNum:" + curEglContextNum);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public VideoCodecStatus setDeliverParams(boolean z, int i, float f, float f2, int i2) {
        RXLogging.m5746w(TAG, "got android hardware decoder setDeliverParams enable:" + z + ", maxTryCount:" + i + ", minAccelerateRatio:" + f + ", maxDeaccelerateRatio:" + f2 + ", frameCacheThreshold:" + i2);
    ...
    public VideoCodecStatus setPrivateParam(String str, String str2) {
        RXLogging.m5746w(TAG, "got android hardware decoder setPrivateParam key:" + str + " value:" + str2);
        ...
        if (str.equals(MAX_EGL_NUM)) {
            ...
            RXLogging.m5746w(TAG, "this is not a param set to HW Decoder, only for control.");
            return VideoCodecStatus.OK;
        }
        if (str.equals(FLAG_CHECK_TEXTURE_SIZE)) {
            this.enableTextureSizeCheck = "true".equalsIgnoreCase(str2);
            RXLogging.m5746w(TAG, "set FLAG_CHECK_TEXTURE_SIZE to " + this.enableTextureSizeCheck);
            return VideoCodecStatus.OK;
        }
        if (str.equals(NEW_INPUT_BUFFER_API)) {
            ...
            RXLogging.m5746w(TAG, "this is not a param set to HW Decoder, only for control. useNewInputBufferAPI:" + this.useNewInputBufferAPI);
            return VideoCodecStatus.OK;
        }
        ...
        RXLogging.m5746w(TAG, "this is not a param set to HW Decoder, only for control. useNewOutputBufferAPI:" + this.useNewOutputBufferAPI);
        return VideoCodecStatus.OK;
    }
