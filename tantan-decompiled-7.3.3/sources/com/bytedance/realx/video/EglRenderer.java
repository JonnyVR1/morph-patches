...
public class EglRenderer implements VideoSink {
    ...
    /* JADX INFO: renamed from: com.bytedance.realx.video.EglRenderer$3 */
    public static /* synthetic */ class C11563 {
    ...
    public static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) throws Exception {
            try {
                ...
                RXLogging.m5743e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
    ...
    public static /* synthetic */ void m5751b(EglRenderer eglRenderer, Runnable runnable) {
    ...
    public static /* synthetic */ void m5753d(EglRenderer eglRenderer, EglBase.Context context, int[] iArr) {
        if (context == null) {
    ...
    public static /* synthetic */ void m5754e(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f, boolean z) {
        if (glDrawer == null) {
    ...
    public static /* synthetic */ void m5755f(EglRenderer eglRenderer, CountDownLatch countDownLatch) {
    ...
    public static /* synthetic */ void m5756g(EglRenderer eglRenderer, CountDownLatch countDownLatch, FrameListener frameListener) {
    ...
    public static /* synthetic */ void m5757h(EglRenderer eglRenderer, Looper looper) {
        eglRenderer.logD("Quitting render thread.");
        looper.quit();
    }

    private void logD(String str) {
        RXLogging.m5744i(TAG, this.name + str);
    }
    ...
    private void logW(String str) {
        RXLogging.m5746w(TAG, this.name + str);
    }

    private void notifyCallbacks(RXVideoFrameInterface rXVideoFrameInterface, boolean z) {
    ...
    public void renderFrameOnRenderThread() {
        ...
        float f4;
        float f5;
        RXVideoFrameInterface rXVideoFrameInterface;
        long jNanoTime;
        boolean z2;
        EglBase eglBase;
        long jNanoTime2;
        synchronized (this.frameLock) {
            try {
                ...
                if (rXVideoFrameInterface2 == null) {
                    return;
                }
                ...
                if (rXVideoFrameInterface2.getRotatedHeight() <= 0) {
                    return;
                }
                float rotatedWidth = rXVideoFrameInterface2.getRotatedWidth() / rXVideoFrameInterface2.getRotatedHeight();
                ...
                int i3 = C11563.$SwitchMap$com$bytedance$realx$video$RendererCommon$ScalingType[this.renderModel.ordinal()];
                if (i3 != 1) {
                    if (i3 == 2) {
                        iSurfaceWidth = 0;
                        iSurfaceHeight = 0;
                        ...
                        iSurfaceWidth = 0;
                        iSurfaceHeight = 0;
                        rXVideoFrameInterface2 = rXVideoFrameInterface2;
                        f2 = 1.0f;
                        i = iSurfaceWidth2;
                        i2 = iSurfaceHeight2;
                        f4 = 1.0f;
                    ...
                    if (z) {
                        ...
                        rXVideoFrameInterface = rXVideoFrameInterface2;
                        this.frameDrawer.drawFrame(rXVideoFrameInterface, this.drawer, this.drawMatrix, iSurfaceWidth, iSurfaceHeight, i, i2);
                        jNanoTime = System.nanoTime();
                        z2 = this.usePresentationTimeStamp;
                        eglBase = this.eglBase;
                        if (z2) {
                            eglBase.swapBuffers(rXVideoFrameInterface.getTimestampNs());
                        } else {
                            eglBase.swapBuffers();
                        }
                    ...
                    notifyCallbacks(rXVideoFrameInterface, z);
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, @Nullable final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: l.pse
            @Override // java.lang.Runnable
            public final void run() {
                EglRenderer.m5754e(this.f153895a, glDrawer, frameListener, f, z);
            }
        });
    }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            try {
                ...
                handler.postAtFrontOfQueue(new Runnable() { // from class: l.jse
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f122455a.clearSurfaceOnRenderThread(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public void init(@Nullable final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            try {
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: l.mse
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5753d(this.f138473a, context, iArr);
                    }
                });
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        RXVideoFrameInterface rXVideoFrameInterface2 = this.pendingFrame;
                        z = rXVideoFrameInterface2 != null;
                        if (z) {
                            rXVideoFrameInterface2.release();
                        }
                        this.pendingFrame = rXVideoFrameInterface;
                        rXVideoFrameInterface.retain();
                        this.renderThreadHandler.post(new Runnable() { // from class: l.bte
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f78352a.renderFrameOnRenderThread();
                            }
                        });
                    } catch (Throwable th) {
                        throw th;
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.vse
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5755f(this.f185599a, countDownLatch);
                    }
                });
                final Looper looper = this.renderThreadHandler.getLooper();
                this.renderThreadHandler.post(new Runnable() { // from class: l.yse
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5757h(this.f201393a, looper);
                    }
                });
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                if (handler == null) {
                    ...
                    this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.sse
                        @Override // java.lang.Runnable
                        public final void run() {
                            EglRenderer.m5751b(this.f170447a, runnable);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: l.ete
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m5756g(this.f95713a, countDownLatch, frameListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
