...
public abstract class RXVideoMemory implements RXVideoMemoryInterface {
    ...
    RefObject refCounted = new RefObject(new Runnable() { // from class: l.yjc0
        @Override // java.lang.Runnable
        public final void run() {
            RXVideoMemory.m5781a(this.f200285a);
        }
    });
    ...
    public static /* synthetic */ void m5781a(RXVideoMemory rXVideoMemory) {
