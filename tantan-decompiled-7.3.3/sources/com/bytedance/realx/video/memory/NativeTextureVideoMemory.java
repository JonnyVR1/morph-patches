...
public class NativeTextureVideoMemory extends RXVideoTextureMemory {
    ...
    public NativeTextureVideoMemory(long j) {
        this.nativeHandle = j;
        setReleaseCallback(new Runnable() { // from class: l.ze20
            @Override // java.lang.Runnable
            public final void run() {
                NativeTextureVideoMemory.m5779b(this.f203971a);
            }
        });
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m5779b(NativeTextureVideoMemory nativeTextureVideoMemory) {
