...
public class NativeRXVideoFrame implements RXVideoFrameInterface {
    ...
    RefObject refCounted = new RefObject(new Runnable() { // from class: l.ye20
        @Override // java.lang.Runnable
        public final void run() {
            NativeRXVideoFrame.m5778a(this.f198659a);
        }
    });
    ...
    public static /* synthetic */ void m5778a(NativeRXVideoFrame nativeRXVideoFrame) {
