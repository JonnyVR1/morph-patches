...
public class SurfaceTextureHelper {
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, boolean z2, boolean z3) {
        ...
        if (z3) {
            wtq0.m207906a("non agfx package not support SurfaceTextureHelper with AGFX");
            throw null;
        }
        ...
        setOnFrameAvailableListener(surfaceTexture, new SurfaceTexture.OnFrameAvailableListener() { // from class: l.yah0
            @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                SurfaceTextureHelper.m5767e(this.f198206a, surfaceTexture2);
            }
        }, handler);
        if (z3) {
    ...
    public static /* synthetic */ void m5763a(SurfaceTextureHelper surfaceTextureHelper) {
    ...
    public static /* synthetic */ void m5766d(SurfaceTextureHelper surfaceTextureHelper) {
    ...
    public static /* synthetic */ void m5767e(SurfaceTextureHelper surfaceTextureHelper, SurfaceTexture surfaceTexture) {
        if (!surfaceTextureHelper.enableOutsideControlTextureMemory) {
    ...
    public static /* synthetic */ void m5768f(SurfaceTextureHelper surfaceTextureHelper, int i, int i2) {
    ...
    public static /* synthetic */ void m5769g(SurfaceTextureHelper surfaceTextureHelper) {
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: l.pah0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.m5766d(this.f151279a);
            }
        });
    }
    ...
    public void tryDeliverTextureFrame() {
        ...
        try {
            ...
            if (this.capture2DTexture) {
                ...
                nativeRXOpenGLMemoryCreateRXOpenGLMemory = NativeRXOpenGLMemory.createRXOpenGLMemory(i4, i5, i4, i5, this.twoDTextureId, RXPixelFormat.kTexture2D, fArr, EGL14.eglGetCurrentContext(), RXVideoScaleFilter.kOpenGLOrigin, RXVideoRotation.fromId(this.frameRotation), new mah0(this));
            } else {
                int i6 = this.textureWidth;
                int i7 = this.textureHeight;
                nativeRXOpenGLMemoryCreateRXOpenGLMemory = NativeRXOpenGLMemory.createRXOpenGLMemory(i6, i7, i6, i7, this.oesTextureId, RXPixelFormat.kTextureOES, fArr, EGL14.eglGetCurrentContext(), RXVideoScaleFilter.kOpenGLOrigin, RXVideoRotation.fromId(this.frameRotation), new mah0(this));
            }
            ...
            RXLogging.m5743e(TAG, " updateTexImage failure", e);
    ...
    private void unbind() {
        if (this.useAgfx) {
            ...
            if (jCurrentTimeMillis - this.lastBindTimestamp > 1000) {
                RXLogging.m5746w(TAG, "AGFX bind time: " + (jCurrentTimeMillis - this.lastBindTimestamp));
            }
            this.lastBindTimestamp = 0L;
        }
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: l.sah0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.m5769g(this.f167048a);
            }
        });
    }
    ...
    public void onFrame(MediaCodecTextureBufferHelper mediaCodecTextureBufferHelper) {
        ...
        if (this.capture2DTexture) {
            ...
            int i4 = this.textureWidth;
            int i5 = this.textureHeight;
            nativeRXOpenGLMemoryCreateRXOpenGLMemory = NativeRXOpenGLMemory.createRXOpenGLMemory(i4, i5, i4, i5, this.twoDTextureId, RXPixelFormat.kTexture2D, fArr, this.eglBase.getEglBaseContext().getEgl14Context(), RXVideoScaleFilter.kOpenGLOrigin, RXVideoRotation.fromId(this.frameRotation), new mah0(this));
        } else {
            int i6 = this.textureWidth;
            int i7 = this.textureHeight;
            nativeRXOpenGLMemoryCreateRXOpenGLMemory = NativeRXOpenGLMemory.createRXOpenGLMemory(i6, i7, i6, i7, this.oesTextureId, RXPixelFormat.kTextureOES, fArr, this.eglBase.getEglBaseContext().getEgl14Context(), RXVideoScaleFilter.kOpenGLOrigin, RXVideoRotation.fromId(this.frameRotation), new mah0(this));
        }
        NativeRXOpenGLMemory nativeRXOpenGLMemory = nativeRXOpenGLMemoryCreateRXOpenGLMemory;
    ...
    public void setFrameRotation(final int i) {
        this.handler.post(new Runnable() { // from class: l.jah0
            @Override // java.lang.Runnable
            public final void run() {
                this.f118984a.frameRotation = i;
            }
        });
    }
    ...
    public void setTextureSize(final int i, final int i2, boolean z) {
        ...
        if (i <= 0) {
            ...
            this.handler.post(new Runnable() { // from class: l.vah0
                @Override // java.lang.Runnable
                public final void run() {
                    SurfaceTextureHelper.m5768f(this.f183094a, i, i2);
                }
            });
        }
    }
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: l.gah0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.m5763a(this.f102985a);
            }
        });
    }
            ...
            while (!this.isAvaliable) {
                try {
                    try {
                        ...
                        RXLogging.m5742e(TAG, "updateTexImage exception: " + e.getMessage());
                        return false;
                    }
                } catch (Throwable th) {
                    throw th;
