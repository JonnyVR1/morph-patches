...
class MediaCodecVideoDecoderFactory {
    ...
    public static VideoDecoder createDecoder(RXVideoCodecDesc rXVideoCodecDesc) {
        ...
        for (int i : capabilitiesForType.colorFormats) {
            RXLogging.m5746w(TAG, "support codecColorFormat:" + i);
        }
    ...
    public static void enableEglLock(boolean z) {
        RXLogging.m5742e(TAG, "MediaCodecVideoDecoderFactory enableEglLock:" + z);
        ...
        for (int i = 0; i < MediaCodecList.getCodecCount(); i++) {
            try {
                try {
                    ...
                    RXLogging.m5743e(TAG, "Cannot retrieve decoder codec info", e);
                    codecInfoAt = null;
                }
                ...
                RXLogging.m5743e(TAG, "findCodecForType got system error:", e2);
            }
        }
        return null;
    }
    ...
    private static boolean isSoftwareDecoder(MediaCodecInfo mediaCodecInfo) {
        try {
            ...
            RXLogging.m5743e(TAG, "check decoder softonly error.", e);
            return false;
        }
    }
