...
class MediaCodecUtils {
    ...
    public static /* synthetic */ class C11641 {
    ...
    public static Map<String, String> getCodecProperties(RXVideoCodecStandard rXVideoCodecStandard, boolean z) {
        int i = C11641.$SwitchMap$com$bytedance$realx$video$RXVideoCodecStandard[rXVideoCodecStandard.ordinal()];
        if (i == 1 || i == 2) {
            return new HashMap();
        }
        if (i == 3) {
        ...
        ypg0.m217021a("Unsupported codec: ", rXVideoCodecStandard);
        return null;
    }
