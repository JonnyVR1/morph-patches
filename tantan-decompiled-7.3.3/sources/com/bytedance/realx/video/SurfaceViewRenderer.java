...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    public static /* synthetic */ void m5770a(SurfaceViewRenderer surfaceViewRenderer, int i, int i2) {
    ...
    private void logD(String str) {
        RXLogging.m5744i(TAG, this.resourceName + ": " + str);
    }
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: l.dbh0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceViewRenderer.m5770a(this.f87670a, i4, i);
            }
        });
    }
