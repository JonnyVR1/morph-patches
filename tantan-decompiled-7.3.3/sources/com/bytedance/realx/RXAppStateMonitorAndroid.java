...
public class RXAppStateMonitorAndroid implements Application.ActivityLifecycleCallbacks {
    ...
    public RXAppStateMonitorAndroid(long j) {
        ...
        if (applicationContext == null) {
            RXLogging.m5742e("ASMonitorAndroid", "context is null.");
            return;
        }
        ...
        if (applicationContext2 instanceof Application) {
            ...
            RXLogging.m5742e("ASMonitorAndroid", "context not a Application obj.");
        }
    ...
    private boolean checkBackground(Context context) {
        try {
            ...
            if (activityManager == null) {
                RXLogging.m5742e("ASMonitorAndroid", "activityManager is null.");
                return false;
            }
            List<ActivityManager.RunningAppProcessInfo> runningAppProcesses = activityManager.getRunningAppProcesses();
            if (runningAppProcesses == null) {
                RXLogging.m5742e("ASMonitorAndroid", "processInfoList is null.");
                return false;
            }
            ...
            RXLogging.m5742e("ASMonitorAndroid", "Get App background state failed. " + e);
            return false;
        }
    }
    ...
    public void onActivityStopped(@NonNull Activity activity) {
        ...
        if (zContains) {
            ...
            RXLogging.m5746w("ASMonitorAndroid", "started set not contain activity" + activity);
        }
        onStateChange(z);
