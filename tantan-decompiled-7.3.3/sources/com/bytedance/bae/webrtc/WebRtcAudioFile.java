...
class WebRtcAudioFile {
    ...
    private HttpURLConnection f4740oc;
    private int mSampleRate = 0;
    private int mChannels = 0;

    @CalledByNative
    public WebRtcAudioFile() {
        RXLogging.m5742e(TAG, "AudioMix WebRtcAudioFile");
    }
    ...
    private boolean isAvailableOnlineURL(String str) {
        ...
        try {
            ...
            this.f4740oc = httpURLConnection;
            httpURLConnection.setUseCaches(false);
            this.f4740oc.setConnectTimeout(TXLiteAVCode.WARNING_START_CAPTURE_IGNORED);
            RXLogging.m5742e(TAG, "connect done....");
            int responseCode = this.f4740oc.getResponseCode();
            if (200 == responseCode) {
                z = true;
            } else {
            ...
            InputStream inputStream = this.f4740oc.getInputStream();
            if (inputStream != null) {
                inputStream.close();
            }
            return z;
            ...
            HttpURLConnection httpURLConnection2 = this.f4740oc;
    ...
    public void disConnectURL() {
        ...
        HttpURLConnection httpURLConnection = this.f4740oc;
