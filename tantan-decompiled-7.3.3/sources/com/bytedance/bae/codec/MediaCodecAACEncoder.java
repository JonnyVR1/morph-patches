...
public class MediaCodecAACEncoder {
    ...
    public MediaCodecAACEncoder() {
        RXLogging.m5742e(TAG, "MediaCodecAAC Encoder Created");
    }
    ...
    public void closeEncoder() {
        try {
            ...
            if (mediaCodec != null) {
                ...
                RXLogging.m5742e(TAG, "close AAC encoder success");
            }
        } catch (Exception e) {
            e.printStackTrace();
            RXLogging.m5742e(TAG, "close AAC encoder failed");
        }
    }
    ...
    public boolean configAndStartEncoder() {
        try {
            ...
            RXLogging.m5742e(TAG, "config AAC encoder success");
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            RXLogging.m5742e(TAG, "Config and Start Encoder Error");
            return false;
        }
    }
    ...
    public boolean encodeProcess(byte[] bArr) {
        try {
            ...
            e.printStackTrace();
            RXLogging.m5742e(TAG, "AAC Encoder Encode failed");
            return false;
        }
    }
    ...
    public boolean openEncoder() {
        try {
            ...
            RXLogging.m5742e(TAG, "open AAC encoder success");
            return this.mAACEncoder != null;
        } catch (Exception e) {
            e.printStackTrace();
            this.mAACEncoder = null;
            RXLogging.m5742e(TAG, "Open AAC encoder failed");
            return false;
        }
    }
