...
import com.p074ss.bytertc.engine.InternalExpressDetectInfo;
import com.p074ss.bytertc.engine.InternalRectangle;
import com.p074ss.bytertc.engine.video.ExpressionDetectInfo;
import com.p074ss.bytertc.engine.video.ExpressionDetectResult;
import com.p074ss.bytertc.engine.video.FaceDetectionResult;
import com.p074ss.bytertc.engine.video.IFaceDetectionObserver;
import com.p074ss.bytertc.engine.video.RTCVideoEffect;
import com.p074ss.bytertc.engine.video.Rectangle;
    ...
    public void OnFaceDetectResult(int i, int i2, int i3, int i4, InternalRectangle[] internalRectangleArr, long j) {
        ...
        if (internalRectangleArr == null || internalRectangleArr.length <= 0) {
            ...
            for (int i5 = 0; i5 < i4; i5++) {
                ...
                rectangleArr[i5] = new Rectangle(internalRectangle.f56453x, internalRectangle.f56454y, internalRectangle.width, internalRectangle.height);
            }
        }
