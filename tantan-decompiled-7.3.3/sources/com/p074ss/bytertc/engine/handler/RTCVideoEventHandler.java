...
import com.p074ss.bytertc.engine.InternalSourceWantedData;
...
public class RTCVideoEventHandler {
    ...
    public void onActiveSpeaker(String str, String str2) {
        ...
        LogUtil.m82083d(TAG, "onActiveSpeaker");
        try {
            ...
            LogUtil.m82084e(TAG, "onActiveSpeaker callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioAEDStateUpdate(AudioAEDType audioAEDType) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioAEDStateUpdate");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioAEDStateUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioDeviceStateChanged(String str, AudioDeviceType audioDeviceType, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioDeviceStateChanged, AudioDeviceType: " + audioDeviceType + ", device_state: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioDeviceStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioDeviceWarning(String str, AudioDeviceType audioDeviceType, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioDeviceWarning, AudioDeviceType: " + audioDeviceType + ", device_warning " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioDeviceWarning callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioDumpStateChanged(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioDumpStateChanged...status: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioDumpStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioFramePlayStateChanged(String str, InternalRTCUser internalRTCUser, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioFramePlayStateChanged, user: " + internalRTCUser + ", state: " + i2);
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onAudioFramePlayStateChanged callback catch exception.\n");
        }
    }
    ...
    public void onAudioFrameSendStateChanged(String str, InternalRTCUser internalRTCUser, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioFrameSendStateChanged,  state: " + i2);
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onAudioFrameSendStateChanged callback catch exception.\n");
        }
    }
    ...
    public void onAudioMixingPlayingProgress(int i, long j) {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onAudioMixingPlayingProgress callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioPlaybackDeviceTestVolume(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioPlaybackDeviceTestVolume");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioPlaybackDeviceTestVolume callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioRecordingStateUpdate(int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioRecordingStateUpdate, state: " + i + ", errorCode: " + i2);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioRecordingStateUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioRouteChanged(AudioRoute audioRoute) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioRouteChanged...device: " + audioRoute.value());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onAudioRouteChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioVADStateUpdate(AudioVADType audioVADType) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onAudioVADStateUpdate");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLocalAudioPropertiesReport callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onCloudProxyConnected(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onCloudProxyConnected, interval: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onCloudProxyConnected callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onConnectionStateChanged(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onConnectionStateChanged, state: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onConnectionStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onDeadLockError(DeadLockMsg deadLockMsg) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onDeadLockError...: " + deadLockMsg);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onDeadLockError callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onEchoTestResult(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onEchoTestResult...error code: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onEchoTestResult callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onEffectError(EffectErrorType effectErrorType, String str) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onEffectError error: " + effectErrorType + ", msg: " + str);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onEffectError callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onError(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onError...errorNum: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onError callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onExperimentalCallback(String str) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onExperimentalCallback...param: " + str);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onExperimentalCallback callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onExtensionAccessError(String str, String str2) {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onExtensionAccessError callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onExternalScreenFrameUpdate(FrameUpdateInfo frameUpdateInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onExternalScreenFrameUpdate, info: " + frameUpdateInfo.toString());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82083d(TAG, "onExternalScreenFrameUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onFirstLocalAudioFrame(StreamIndex streamIndex) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onFirstLocalAudioFrame...streamIndex: " + streamIndex.value());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onFirstLocalAudioFrame callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onFirstLocalVideoFrameCaptured(StreamIndex streamIndex, VideoFrameInfo videoFrameInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onFirstLocalVideoFrame...width: " + videoFrameInfo.getWidth() + ", height: " + videoFrameInfo.getHeight());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onFirstLocalVideoFrame callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onFirstRemoteAudioFrame(RemoteStreamKey remoteStreamKey) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onFirstRemoteAudioFrame...uid: " + remoteStreamKey.getUserId() + ", roomid: " + remoteStreamKey.getRoomId() + ", streamIndex: " + remoteStreamKey.getStreamIndex().value());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onFirstRemoteAudioFrame callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onFirstRemoteVideoFrameDecoded(RemoteStreamKey remoteStreamKey, VideoFrameInfo videoFrameInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onFirstRemoteVideoFrameDecoded...uid: " + remoteStreamKey.getUserId() + ", StreamIndex:" + remoteStreamKey.getStreamIndex() + ", width: " + videoFrameInfo.getWidth() + ", height: " + videoFrameInfo.getHeight());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onFirstRemoteVideoFrameDecoded callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onFirstRemoteVideoFrameRendered(RemoteStreamKey remoteStreamKey, VideoFrameInfo videoFrameInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onFirstRemoteVideoFrameRendered...uid: " + remoteStreamKey.getUserId() + ", StreamIndex:" + remoteStreamKey.getStreamIndex() + ", width: " + videoFrameInfo.getWidth() + ", height: " + videoFrameInfo.getHeight());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onFirstRemoteVideoFrameRendered callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onGetPeerOnlineStatus(String str, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onGetPeerOnlineStatus: " + str + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onGetPeerOnlineStatus callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onHardwareEchoDetectionResult(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onHardwareEchoDetectionResult...result code: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onHardwareEchoDetectionResult callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLicenseWillExpire(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLicenseWillExpire, days: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLicenseWillExpire callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLocalAudioPropertiesReport(LocalAudioPropertiesInfo[] localAudioPropertiesInfoArr) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLocalAudioPropertiesReport");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
    ...
    public void onLocalAudioStateChanged(LocalAudioStreamState localAudioStreamState, LocalAudioStreamError localAudioStreamError) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLocalAudioStateChanged...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLocalAudioStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLocalProxyStateChanged(LocalProxyType localProxyType, LocalProxyState localProxyState, LocalProxyError localProxyError) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLocalProxyStateChanged...: " + localProxyType.value() + ", state: " + localProxyState.value() + ", error: " + localProxyError.value());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLocalProxyStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLocalStreamStats(StreamIndex streamIndex, InternalLocalStreamStats internalLocalStreamStats) {
        ...
        LogUtil.m82083d(TAG, "onLocalStreamStats, streamIndex: " + streamIndex);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
    ...
    public void onLocalVideoSizeChanged(StreamIndex streamIndex, VideoFrameInfo videoFrameInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLocalVideoSizeChanged... streamIndex: " + streamIndex + ", frameInfo: " + videoFrameInfo);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLocalVideoSizeChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLocalVideoStateChanged(StreamIndex streamIndex, LocalVideoStreamState localVideoStreamState, LocalVideoStreamError localVideoStreamError) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLocalVideoStateChanged...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLocalVideoStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLogReport(String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                LogUtil.m82083d(TAG, "onLogReport...parse json catch exception: " + e.getMessage());
            }
        } catch (Exception e2) {
            LogUtil.m82084e(TAG, "onLogReport callback catch exception.\n" + e2.getMessage());
        }
    }
    ...
    public void onLoginResult(String str, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "OnLoginResult: " + str + i + i2);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLoginResult callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onLogout(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onLogout: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onLogout callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onMixedStreamEvent(MixedStreamTaskInfo mixedStreamTaskInfo, MixedStreamTaskEvent mixedStreamTaskEvent, MixedStreamTaskErrorCode mixedStreamTaskErrorCode) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onMixedStreamEvent");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onMixedStreamEvent callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onNetworkProbeResult(int i, int i2, int i3, double d, int i4, int i5) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onNetworkProbeResult: " + i + Constants.SEPARATOR_COMMA + i2 + Constants.SEPARATOR_COMMA + i3 + Constants.SEPARATOR_COMMA + d + Constants.SEPARATOR_COMMA + i4 + Constants.SEPARATOR_COMMA + i5);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onNetworkDetectionResult callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onNetworkProbeStopped(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onNetworkProbeStopped: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onNetworkDetectionStopped callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onNetworkTimeSynchronized() {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onNetworkTimeSynchronized...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onNetworkTimeSynchronized callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onNetworkTypeChanged(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onNetworkTypeChanged, type: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onNetworkTypeChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onPerformanceAlarms(int i, String str, int i2, InternalSourceWantedData internalSourceWantedData) {
        ...
        LogUtil.m82083d(TAG, "onPerformanceAlarms, level: " + i2 + ", data: " + internalSourceWantedData);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            ...
            LogUtil.m82084e(TAG, "onPerformanceAlarms callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onPushPublicStreamResult(String str, String str2, PublicStreamErrorCode publicStreamErrorCode) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onPushPublicStreamError error(" + publicStreamErrorCode.value() + ") streamId:" + str2);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onPushPublicStreamError callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRecordingProgressUpdate(StreamIndex streamIndex, RecordingProgress recordingProgress, RecordingInfo recordingInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRecordingProgressUpdate, StreamIndex: " + streamIndex + ", progress.dur: " + recordingProgress.duration + ", progress.fileSize: " + recordingProgress.fileSize + ", info.filePath: " + recordingInfo.filePath);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRecordingProgressUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRecordingStateUpdate(StreamIndex streamIndex, int i, int i2, RecordingInfo recordingInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRecordingStateUpdate, StreamIndex: " + streamIndex + ", RecordingState: " + i + ", RecordingErrorCode: " + i2 + ", info.filePath: " + recordingInfo.filePath);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRecordingStateUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRemoteAudioPropertiesReport(RemoteAudioPropertiesInfo[] remoteAudioPropertiesInfoArr, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRemoteAudioPropertiesReport");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRemoteAudioPropertiesReport callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRemoteAudioStateChanged(RemoteStreamKey remoteStreamKey, RemoteAudioState remoteAudioState, RemoteAudioStateChangeReason remoteAudioStateChangeReason) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRemoteAudioStateChanged...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRemoteAudioStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRemoteRenderError(RemoteStreamKey remoteStreamKey, RenderError renderError, String str) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRemoteRenderError, key: " + remoteStreamKey.toString() + ", error: ; message: " + str);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82083d(TAG, "onRemoteRenderError callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRemoteStreamStats(StreamKey streamKey, InternalRemoteStreamStats internalRemoteStreamStats) {
        IRTCEngineEventHandlerEx rtcEngineHandlerEx;
        LogUtil.m82083d(TAG, "onRemoteStreamStats, streamIndex: " + streamKey.getStreamIndex());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandlerEx = rTCEngineImpl.getRtcEngineHandlerEx()) == null) {
                return;
    ...
    public void onRemoteVideoSizeChanged(RemoteStreamKey remoteStreamKey, VideoFrameInfo videoFrameInfo) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRemoteVideoSizeChanged... RemoteStreamKey: " + remoteStreamKey + ", frameInfo: " + videoFrameInfo);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRemoteVideoSizeChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRemoteVideoStateChanged(RemoteStreamKey remoteStreamKey, RemoteVideoState remoteVideoState, RemoteVideoStateChangeReason remoteVideoStateChangeReason) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRemoteVideoStateChanged...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRemoteVideoStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onRemoteVideoSuperResolutionModeChanged(RemoteStreamKey remoteStreamKey, VideoSuperResolutionMode videoSuperResolutionMode, VideoSuperResolutionModeChangedReason videoSuperResolutionModeChangedReason) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onRemoteVideoSuperResolutionModeChanged...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onRemoteVideoSuperResolutionModeChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onSEIMessageReceived(RemoteStreamKey remoteStreamKey, ByteBuffer byteBuffer) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onSEIMessageReceived" + remoteStreamKey.getRoomId() + remoteStreamKey.getUserId());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onSEIMessageReceived callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onSEIStreamUpdate(RemoteStreamKey remoteStreamKey, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onSEIStreamUpdate" + remoteStreamKey.getRoomId() + remoteStreamKey.getUserId());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onSEIStreamUpdate callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onScreenVideoFramePlayStateChanged(String str, InternalRTCUser internalRTCUser, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onScreenVideoFramePlayStateChanged, user: " + internalRTCUser + ", state: " + i);
        FirstFramePlayState firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYING;
        if (i != 0) {
            if (i == 1) {
                firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYED;
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onScreenVideoFramePlayStateChanged callback catch exception.\n");
        }
    }
    ...
    public void onScreenVideoFrameSendStateChanged(String str, InternalRTCUser internalRTCUser, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onScreenVideoFrameSendStateChanged, user: " + internalRTCUser + ", state: " + i);
        FirstFrameSendState firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENDING;
        if (i != 0) {
            if (i == 1) {
                firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENT;
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onScreenVideoFrameSendStateChanged callback catch exception.\n");
        }
    }
    ...
    public void onServerMessageSendResult(long j, int i, ByteBuffer byteBuffer) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onServerMessageSendResult: " + j + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onServerMessageSendResult callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onServerParamsSetResult(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onServerParamsSetResult: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onServerParamsSetResult callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onSimulcastSubscribeFallback(InternalRemoteStreamSwitch internalRemoteStreamSwitch) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onSimulcastSubscribeFallback, uid: " + internalRemoteStreamSwitch.uid + ", before_video_index: " + internalRemoteStreamSwitch.beforeVideoIndex + ", after_video_index: " + internalRemoteStreamSwitch.afterVideoIndex + ", before_enable: " + internalRemoteStreamSwitch.beforeEnable + ", after_enable: " + internalRemoteStreamSwitch.afterEnable + ", reason: " + internalRemoteStreamSwitch.reason);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
    ...
    public void onSingleStreamEvent(String str, SingleStreamTaskEvent singleStreamTaskEvent, SingleStreamTaskErrorCode singleStreamTaskErrorCode) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onSingleStreamEvent");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onSingleStreamEvent callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onSnapshotTakenToFile(RemoteStreamKey remoteStreamKey, String str, int i, int i2, SnapshotErrorCode snapshotErrorCode, long j) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onSnapshotTakenToFile, streamKey: " + remoteStreamKey.toString() + " filePath: " + str + " width: " + i + " height: " + i2 + " errorCode: " + snapshotErrorCode.toString() + " taskId: " + j);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82083d(TAG, "onSnapshotTakenToFile callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onStreamSyncInfoReceived(RemoteStreamKey remoteStreamKey, ByteBuffer byteBuffer, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onStreamSyncInfoReceived");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onStreamSyncInfoReceived callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onSysStats(SysStats sysStats) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onSysStats... " + sysStats.toString());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onSysStats callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserBinaryMessageReceivedOutsideRoom(String str, ByteBuffer byteBuffer, long j) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserBinaryMessageReceivedOutsideRoom: " + str + byteBuffer.capacity());
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserBinaryMessageReceivedOutsideRoom callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserMessageReceivedOutsideRoom(String str, String str2, long j) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserMessageReceivedOutsideRoom: " + str + str2);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserMessageReceivedOutsideRoom callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserMessageSendResultOutsideRoom(long j, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserMessageSendResultOutsideRoom: " + j + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserMessageSendResultOutsideRoom callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserStartAudioCapture(String str, String str2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserStartAudioCapture... uid: " + str2 + ", roomId: " + str);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserStartAudioCapture callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserStartVideoCapture(String str, String str2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserStartVideoCapture... uid: " + str2 + ", roomId: " + str);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserStartVideoCapture callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserStopAudioCapture(String str, String str2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserStopAudioCapture... uid: " + str2);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserStopAudioCapture callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onUserStopVideoCapture(String str, String str2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onUserStopVideoCapture... uid: " + str2 + ", roomId: " + str);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onUserStopVideoCapture callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoDenoiseModeChanged(VideoDenoiseMode videoDenoiseMode, VideoDenoiseModeChangedReason videoDenoiseModeChangedReason) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onVideoDenoiseModeChanged...");
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onVideoDenoiseModeChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoDeviceStateChanged(String str, VideoDeviceType videoDeviceType, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onVideoDeviceStateChanged, VideoDeviceType: " + videoDeviceType + ", device_state: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onVideoDeviceStateChanged callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoDeviceWarning(String str, VideoDeviceType videoDeviceType, int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onVideoDeviceWarning, VideoDeviceType: " + videoDeviceType + ", device_warning " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onVideoDeviceWarning callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onVideoFramePlayStateChanged(String str, InternalRTCUser internalRTCUser, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onVideoFramePlayStateChanged, user: " + internalRTCUser + ", state: " + i2);
        FirstFramePlayState firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYING;
        if (i2 != 0) {
            if (i2 == 1) {
                firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYED;
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onVideoFramePlayStateChanged callback catch exception.\n");
        }
    }
    ...
    public void onVideoFrameSendStateChanged(String str, InternalRTCUser internalRTCUser, int i, int i2) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onVideoFrameSendStateChanged, user: " + internalRTCUser + ", state: " + i2);
        FirstFrameSendState firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENDING;
        if (i2 != 0) {
            if (i2 == 1) {
                firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENT;
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "onVideoFrameSendStateChanged callback catch exception.\n");
        }
    }
    ...
    public void onWarning(int i) {
        IRTCEngineEventHandler rtcEngineHandler;
        LogUtil.m82083d(TAG, "onWarning, warnNum: " + i);
        try {
            RTCEngineImpl rTCEngineImpl = this.mRTCVideoImpl.get();
            if (rTCEngineImpl == null || (rtcEngineHandler = rTCEngineImpl.getRtcEngineHandler()) == null) {
                return;
            ...
            LogUtil.m82084e(TAG, "onWarning callback catch exception.\n" + e.getMessage());
        }
    }
    ...
    public void onAudioFrameSendStateChanged(StreamKey streamKey, String str, int i) {
        IRTCEngineEventHandlerEx rtcEngineHandlerEx;
        LogUtil.m82083d(TAG, "onAudioFrameSendStateChanged,  state: " + i);
        FirstFrameSendState firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENDING;
        if (i != 0) {
            if (i == 1) {
                firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENT;
    ...
    public void onAudioFramePlayStateChanged(StreamKey streamKey, String str, int i) {
        IRTCEngineEventHandlerEx rtcEngineHandlerEx;
        LogUtil.m82083d(TAG, "onAudioFramePlayStateChanged, user: " + streamKey.getUserId() + ", state: " + i);
        FirstFramePlayState firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYING;
        if (i != 0) {
            if (i == 1) {
                firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYED;
    ...
    public void onVideoFramePlayStateChanged(StreamKey streamKey, String str, int i) {
        IRTCEngineEventHandlerEx rtcEngineHandlerEx;
        LogUtil.m82083d(TAG, "onVideoFramePlayStateChanged, user: " + streamKey.getUserId() + ", state: " + i);
        FirstFramePlayState firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYING;
        if (i != 0) {
            if (i == 1) {
                firstFramePlayState = FirstFramePlayState.FIRST_FRAME_PLAY_STATE_PLAYED;
    ...
    public void onVideoFrameSendStateChanged(StreamKey streamKey, String str, int i) {
        IRTCEngineEventHandlerEx rtcEngineHandlerEx;
        LogUtil.m82083d(TAG, "onVideoFrameSendStateChanged, user: " + streamKey.getUserId() + ", state: " + i);
        FirstFrameSendState firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENDING;
        if (i != 0) {
            if (i == 1) {
                firstFrameSendState = FirstFrameSendState.FIRST_FRAME_SEND_STATE_SENT;
