...
public class GameRoomImpl extends IGameRoom {
    ...
    @Override // com.p074ss.bytertc.engine.IGameRoom
    public void destroy() {
    ...
    public int enableAudioReceive(String str, boolean z) {
        ...
        LogUtil.m82083d(TAG, "enableAudioReceive. enable : " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeGameRtcRoom;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native rtcroom is invalid, enableSpeakerphone failed.");
    ...
    public int enableAudioSend(boolean z) {
        ...
        LogUtil.m82083d(TAG, "enableAudioSend. enable : " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeGameRtcRoom;
            if (j == 0) {
    ...
    public int enableMicrophone(boolean z) {
        ...
        LogUtil.m82083d(TAG, "enableMicrophone. enable : " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeGameRtcRoom;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native rtcroom is invalid, enableMicrophone failed.");
    ...
    public int enableSpeakerphone(boolean z) {
        ...
        LogUtil.m82083d(TAG, "enableSpeakerphone. enable : " + z);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeGameRtcRoom;
            if (j == 0) {
    ...
    public int setRemoteRoomAudioPlaybackVolume(int i) {
        ...
        LogUtil.m82083d(TAG, "setRemoteRoomAudioPlaybackVolume volume : " + i);
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeGameRtcRoom;
            if (j == 0) {
