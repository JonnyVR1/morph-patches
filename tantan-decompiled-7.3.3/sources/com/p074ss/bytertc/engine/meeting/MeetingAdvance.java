package com.p074ss.bytertc.engine.meeting;
...
import com.p074ss.bytertc.engine.SubscribeVideoBaseline;
...
import com.p074ss.bytertc.engine.type.SubscribeMode;
...
public abstract class MeetingAdvance {
    ...
    public static int enableAutoSubscribe(RTCRoom rTCRoom, SubscribeMode subscribeMode, SubscribeMode subscribeMode2) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, enableAutoSubscribe failed.");
        return -1;
    }
    ...
    public static int enableRescaleAudioVolume(RTCRoom rTCRoom, boolean z) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, enableRescaleAudioVolume failed.");
        return -1;
    }
    ...
    public static int enableSimulcastMode(RTCEngine rTCEngine, boolean z) {
        ...
        LogUtil.m82084e(TAG, "video native handle is invalid, enableSimulcastMode failed.");
        return -1;
    }
    ...
    public static IAmazingEffect getAmazingEffectInterface(RTCEngine rTCEngine) {
        if (mGetAmazingEffectMethod == null) {
            try {
                int i = RTCEngineImpl.f56479a;
                mGetAmazingEffectMethod = RTCEngineImpl.class.getMethod("getAmazingEffectInterface", null);
            } catch (Exception unused) {
                LogUtil.m82084e(TAG, "fail to find method getAmazingEffectInterface");
            }
        }
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "fail to invoke method getAmazingEffectInterface");
            return null;
        }
    }
    ...
    public static int getDownlinkNetworkBandwidthEstimationStatus(RTCRoom rTCRoom) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, getUplinkNetworkBandwidthEstimationStatus failed.");
        return -1;
    }
    ...
    private static long getNativeRoomHandle(RTCRoom rTCRoom) {
        if (mGetNativeMethod == null) {
            try {
                ...
                LogUtil.m82084e(TAG, "fail to find method getNativeHandle");
            }
        }
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "fail to invoke method getNativeHandle");
            return 0L;
        }
    }
    ...
    public static boolean isStreamUnpublished(RTCRoom rTCRoom, int i) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, isStreamUnpublished failed.");
        return false;
    }
    ...
    public static void resetScreenVideoConfigs(RTCEngine rTCEngine) {
        long nativeVideoHandle = getNativeVideoHandle(rTCEngine);
        if (nativeVideoHandle == 0) {
            LogUtil.m82084e(TAG, "video native handle is invalid, resetScreenVideoConfigs failed.");
        } else {
    ...
    public static void setExternalSurface(RTCEngine rTCEngine, RemoteStreamKey remoteStreamKey, Surface surface) {
        long nativeVideoHandle = getNativeVideoHandle(rTCEngine);
        if (nativeVideoHandle == 0) {
            LogUtil.m82084e(TAG, "room native handle is invalid, setExternalSurface failed.");
            return;
        }
        LogUtil.m82086i(TAG, "setExternalSurface, roomId:" + remoteStreamKey.roomId + ", userId: " + remoteStreamKey.userId + ", index: " + remoteStreamKey.streamIndex + ", externalSurface:" + surface);
    ...
    public static int setPublishChannel(RTCRoom rTCRoom, String str) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, setPublishChannel failed.");
        return -1;
    }
    ...
    public static int setPublishSpecialStream(RTCRoom rTCRoom, StreamIndex streamIndex, int i) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, setPublishSpecialStream failed.");
        return -1;
    }
    ...
    public static void setScreenVideoConfigs(RTCEngine rTCEngine) {
        long nativeVideoHandle = getNativeVideoHandle(rTCEngine);
        if (nativeVideoHandle == 0) {
            LogUtil.m82084e(TAG, "video native handle is invalid, setScreenVideoConfigs failed.");
        } else {
    ...
    public static void setSubscribeBaselineData(RTCRoom rTCRoom, String str, boolean z, SubscribeVideoBaseline subscribeVideoBaseline) {
        long nativeRoomHandle = getNativeRoomHandle(rTCRoom);
        if (nativeRoomHandle == 0) {
            LogUtil.m82084e(TAG, "room native handle is invalid, setSubscribeBaselineData failed.");
        } else {
    ...
    public static int setSubscribeChannels(RTCRoom rTCRoom, String[] strArr, boolean z) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, setSubscribeChannels failed.");
        return -1;
    }
    ...
    public static int setSubscribeSpecialStream(RTCRoom rTCRoom, int[] iArr) {
        ...
        LogUtil.m82084e(TAG, "room native handle is invalid, setSubscribeSpecialStream failed.");
        return -1;
    }

    public static int setVideoEncoderConfig(RTCEngine rTCEngine, List<VideoEncoderConfig> list, List<VideoEncoderConfig> list2) {
        LogUtil.m82083d(TAG, "setVideoEncoderConfig ");
        long nativeVideoHandle = getNativeVideoHandle(rTCEngine);
        if (nativeVideoHandle == 0) {
            LogUtil.m82084e(TAG, "room native handle is invalid, isMuteLocalVideo failed.");
            return -1;
        }
        if (list == null) {
            return -1;
