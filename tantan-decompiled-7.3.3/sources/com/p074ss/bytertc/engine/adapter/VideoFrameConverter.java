...
public class VideoFrameConverter {
    ...
    public VideoFrame.I420Buffer convertToJavaI420Buffer(ByteBuffer byteBuffer, int i, int i2, boolean z) {
        ...
        if (pendingBuffer == null) {
            ...
            if (i3 >= 60) {
                LogUtil.m82084e(TAG, "drop frame > 60 !!! please check Buffer for release");
                this.abandonFrameCount = 0;
            }
            return null;
        }
        ...
        return z ? CountDownLatchI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: l.eel0
            @Override // java.lang.Runnable
            public final void run() {
                pendingBuffer.setPending(false);
            }
        }) : JavaI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: l.fel0
            @Override // java.lang.Runnable
            public final void run() {
                pendingBuffer.setPending(false);
            }
    ...
    public VideoFrame.I420Buffer convertToJavaI420Buffer(byte[] bArr, int i, int i2, boolean z) {
        ...
        if (z) {
            return CountDownLatchI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: l.gel0
                @Override // java.lang.Runnable
                public final void run() {
                    pendingBuffer.setPending(false);
                }
        ...
        return JavaI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: l.hel0
            @Override // java.lang.Runnable
            public final void run() {
                pendingBuffer.setPending(false);
            }
