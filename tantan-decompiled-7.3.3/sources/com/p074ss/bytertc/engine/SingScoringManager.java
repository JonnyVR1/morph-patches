...
import com.p074ss.bytertc.engine.data.SingScoringConfig;
...
public class SingScoringManager extends ISingScoringManager {
    ...
    @Override // com.p074ss.bytertc.engine.audio.ISingScoringManager
    public int getAverageScore() {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, getAverageScore failed.");
            return -1;
        } finally {
    ...
    public int getLastSentenceScore() {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, getLastSentenceScore failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public List<StandardPitchInfo> getStandardPitchInfo(String str) {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, getStandardPitchInfo failed.");
            return null;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int getTotalScore() {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, getTotalScore failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int initSingScoring(String str, String str2, ISingScoringEventHandler iSingScoringEventHandler) {
        ...
        try {
            if (this.mNativeSingScoringManager == 0) {
                LogUtil.m82084e(TAG, "native SingScoringManager is invalid, initSingScoring failed.");
                return -1;
            }
    ...
    public int setSingScoringConfig(SingScoringConfig singScoringConfig) {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, setSingScoringConfig failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int startSingScoring(int i, int i2) {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, startSingScoring failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
    ...
    public int stopSingScoring() {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SingScoringManager is invalid, stopSingScoring failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
