...
import com.p074ss.bytertc.engine.handler.RTCAudioEffectPlayerEventHandler;
...
public class AudioEffectPlayer extends IAudioEffectPlayer {
    ...
    @Override // com.p074ss.bytertc.engine.audio.IAudioEffectPlayer
    public synchronized int getDuration(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, getDuration failed.");
    ...
    public synchronized int getPosition(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, getPosition failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int getVolume(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, getVolume failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int pause(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, pause failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int pauseAll() {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, pauseAll failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int preload(int i, String str) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, preload failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int resume(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, resume failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int resumeAll() {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, resumeAll failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setEventHandler(IAudioEffectPlayerEventHandler iAudioEffectPlayerEventHandler) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid or nativeEngine is invalid, setEventHandler failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setPosition(int i, int i2) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, setPosition failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setVolume(int i, int i2) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, setVolume failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setVolumeAll(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, setVolumeAll failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int start(int i, String str, AudioEffectPlayerConfig audioEffectPlayerConfig) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, start failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int stop(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, stop failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int stopAll() {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, stopAll failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int unload(int i) {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, unload failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int unloadAll() {
        ...
        LogUtil.m82084e(TAG, "native AudioEffectPlayer is invalid, unloadAll failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
