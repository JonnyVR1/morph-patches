package com.p074ss.bytertc.engine.p075ui;
...
import com.p074ss.bytertc.base.media.EglRenderer;
import com.p074ss.bytertc.engine.adapter.VideoFrameConverter;
...
import com.p074ss.bytertc.engine.mediaio.TextureEglRenderer;
import com.p074ss.bytertc.engine.p075ui.VideoFrameRender;
import com.p074ss.bytertc.engine.utils.ByteBufferUtils;
import com.p074ss.bytertc.engine.utils.LogUtil;
import com.p074ss.bytertc.engine.video.IVideoFrame;
import com.p074ss.bytertc.engine.video.converter.WebRTCConverter;
...
public class VideoFrameRender implements View.OnLayoutChangeListener, RendererCommon.RendererEvents, EglRenderer.FirstVideoFrameRenderListener {
    ...
    private final SurfaceLifecycleCallback mSurfaceLifecycleCallbackCallback = new SurfaceLifecycleCallback() { // from class: com.ss.bytertc.engine.ui.VideoFrameRender.1
        ...
        public void onCreated() {
            ...
            LogUtil.m82084e(VideoFrameRender.TAG, "Already has an another surface created.");
        }
        ...
        public void onDestroy() {
            ...
            if (!z) {
                ...
                LogUtil.m82084e(VideoFrameRender.TAG, "Already has an another surface destroyed.");
            }
        }
    };
    ...
    public static /* synthetic */ void m82077a(ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3) {
    ...
    public static /* synthetic */ void m82078b() {
    }
    ...
    private VideoFrame.Buffer createYUV(byte[] bArr, int i, int i2) {
        if (bArr != null && bArr.length != 0) {
            ...
            if (byteBufferNativeAllocateBuffer != null && byteBufferNativeAllocateBuffer2 != null && byteBufferNativeAllocateBuffer3 != null) {
                ...
                return this.mEglRenderer instanceof TextureEglRenderer ? CountDownLatchI420Buffer.wrap(i, i2, byteBufferNativeAllocateBuffer, i, byteBufferNativeAllocateBuffer2, i3, byteBufferNativeAllocateBuffer3, i3, new Runnable() { // from class: l.pel0
                    @Override // java.lang.Runnable
                    public final void run() {
                        VideoFrameRender.m82080d(byteBufferNativeAllocateBuffer, byteBufferNativeAllocateBuffer2, byteBufferNativeAllocateBuffer3);
                    }
                }) : JavaI420Buffer.wrap(i, i2, byteBufferNativeAllocateBuffer, i, byteBufferNativeAllocateBuffer2, i3, byteBufferNativeAllocateBuffer3, i3, new Runnable() { // from class: l.qel0
                    @Override // java.lang.Runnable
                    public final void run() {
                        VideoFrameRender.m82077a(byteBufferNativeAllocateBuffer, byteBufferNativeAllocateBuffer2, byteBufferNativeAllocateBuffer3);
                    }
                });
            }
    ...
    public static /* synthetic */ void m82080d(ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3) {
        ByteBufferUtils.nativeReleaseBuffer(byteBuffer);
        ByteBufferUtils.nativeReleaseBuffer(byteBuffer2);
        ByteBufferUtils.nativeReleaseBuffer(byteBuffer3);
    }
    ...
    public static /* synthetic */ void m82081e(VideoFrameRender videoFrameRender, int i, int i2) {
    ...
    private void renderTextureFrame(int i, VideoFrame.TextureBuffer.Type type, int i2, int i3, int i4, long j, float[] fArr, Looper looper) {
        VideoFrame videoFrame = new VideoFrame(new TextureBufferImpl(i2, i3, type, i, RendererCommon.convertMatrixToAndroidGraphicsMatrix(fArr), new Handler(looper), new YuvConverter(), new Runnable() { // from class: l.rel0
            @Override // java.lang.Runnable
            public final void run() {
                VideoFrameRender.m82078b();
            }
        }), i4, j);
        onVideoFrame(videoFrame);
        videoFrame.release();
    ...
    private void updateSurfaceSize() {
        ...
        LogUtil.m82083d(TAG, "updateSurfaceSize. Layout size: " + this.mSurfaceView.getWidth() + BaseSei.f14624X + this.mSurfaceView.getHeight() + ", frame size: " + this.rotatedFrameWidth + BaseSei.f14624X + this.rotatedFrameHeight + ", requested surface size: " + iMin + BaseSei.f14624X + iMin2 + ", old surface size: " + this.surfaceWidth + BaseSei.f14624X + this.surfaceHeight);
    ...
    public void init(final EglBase.Context context) {
        if (!this.mHasInitAtomic.compareAndSet(false, true)) {
            wtq0.m207906a("Already initialized");
            return;
        }
        synchronized (this.mRenderLock) {
            try {
                ...
                if (this.mEglRenderer instanceof SurfaceEglRender) {
                    ThreadUtils.invokeAtFrontUninterruptibly(new Handler(Looper.getMainLooper()), new Runnable() { // from class: l.oel0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f147002a.mEglRenderer.init(context, EglBase.CONFIG_PLAIN, new GlRectDrawer());
                        }
                    });
                } else {
    ...
    public void onDispose() {
        if (!this.mHasInitAtomic.compareAndSet(true, false)) {
            wtq0.m207906a("Try to dispose an not initialized VideoFrameRender");
            return;
        }
        synchronized (this.mRenderLock) {
            try {
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: l.nel0
            @Override // java.lang.Runnable
            public final void run() {
                VideoFrameRender.m82081e(this.f141666a, i4, i);
            }
        });
    }
