...
public class AudioFocusManager {
    ...
    private Application.ActivityLifecycleCallbacks mActivityLifecycleCallback = new Application.ActivityLifecycleCallbacks() { // from class: com.ss.bytertc.engine.AudioFocusManager.2
        ...
        public void onActivityResumed(@NonNull Activity activity) {
            ...
            if ((Build.VERSION.SDK_INT < 26 ? audioManager.requestAudioFocus(AudioFocusManager.this.onAudioFocusChangeListener, 3, 1) : audioManager.requestAudioFocus(ta1.m189769a(1).setOnAudioFocusChangeListener(AudioFocusManager.this.onAudioFocusChangeListener).build())) == 1) {
    ...
    public void releaseAudioFocus(boolean z) {
        ...
        if (audioManager != null) {
            if (Build.VERSION.SDK_INT < 26) {
                ...
                audioManager.abandonAudioFocusRequest(ta1.m189769a(1).setOnAudioFocusChangeListener(this.onAudioFocusChangeListener).build());
            }
    ...
    public void requestAudioFocus() {
        ...
        if (audioManager != null) {
            if (Build.VERSION.SDK_INT < 26) {
                ...
                audioManager.requestAudioFocus(ta1.m189769a(1).setOnAudioFocusChangeListener(this.onAudioFocusChangeListener).build());
            }
