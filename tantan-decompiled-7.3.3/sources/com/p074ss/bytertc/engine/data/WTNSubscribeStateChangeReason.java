...
public enum WTNSubscribeStateChangeReason {
    ...
    public static /* synthetic */ class C136051 {

        /* JADX INFO: renamed from: $SwitchMap$com$ss$bytertc$engine$data$WTNSubscribeStateChangeReason */
        static final /* synthetic */ int[] f56478x6bc8b388;

        static {
            int[] iArr = new int[WTNSubscribeStateChangeReason.values().length];
            f56478x6bc8b388 = iArr;
            try {
                iArr[WTNSubscribeStateChangeReason.SUBSCRIBE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f56478x6bc8b388[WTNSubscribeStateChangeReason.UNSUBSCRIBE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56478x6bc8b388[WTNSubscribeStateChangeReason.REMOTE_UNPUBLISH.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56478x6bc8b388[WTNSubscribeStateChangeReason.OVER_CLIENT_SUBSCRIBE_STREAM_LIMIT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f56478x6bc8b388[WTNSubscribeStateChangeReason.OVER_STREAM_SUBSCRIBE_USER_LIMIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f56478x6bc8b388[WTNSubscribeStateChangeReason.OVER_STREAM_SUBSCRIBE_REQUEST_LIMIT.ordinal()] = 6;
    ...
    public String toString() {
        switch (C136051.f56478x6bc8b388[ordinal()]) {
            case 1:
