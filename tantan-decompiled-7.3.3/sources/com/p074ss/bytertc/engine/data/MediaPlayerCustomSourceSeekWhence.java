...
public enum MediaPlayerCustomSourceSeekWhence {
    ...
    public static /* synthetic */ class C135891 {

        /* JADX INFO: renamed from: $SwitchMap$com$ss$bytertc$engine$data$MediaPlayerCustomSourceSeekWhence */
        static final /* synthetic */ int[] f56463x231e5261;

        static {
            int[] iArr = new int[MediaPlayerCustomSourceSeekWhence.values().length];
            f56463x231e5261 = iArr;
            try {
                iArr[MediaPlayerCustomSourceSeekWhence.SET.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f56463x231e5261[MediaPlayerCustomSourceSeekWhence.CUR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f56463x231e5261[MediaPlayerCustomSourceSeekWhence.END.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f56463x231e5261[MediaPlayerCustomSourceSeekWhence.SIZE.ordinal()] = 4;
    ...
    public String toString() {
        int i = C135891.f56463x231e5261[ordinal()];
        if (i == 1) {
            return "SET";
        }
        if (i == 2) {
