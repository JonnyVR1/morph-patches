...
import com.p074ss.bytertc.engine.NativeAmazingEffectFunctions;
...
public class AmazingEffect extends IAmazingEffect {
    ...
    public AmazingEffect(long j) {
        ...
        LogUtil.m82086i(TAG, "create amazing effect");
    }
    ...
    @Override // com.p074ss.bytertc.engine.video.IAmazingEffect
    public int appendEffectNodes(List<String> list) {
        ...
        if (list == null) {
            LogUtil.m82084e(TAG, "param invalid, appendEffectNodes failed.");
            return -1;
        }
    ...
    public void dispose() {
        LogUtil.m82086i(TAG, "dispose amazing effect");
