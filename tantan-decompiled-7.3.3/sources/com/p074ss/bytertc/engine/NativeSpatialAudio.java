...
public class NativeSpatialAudio implements ISpatialAudio {
    ...
    @Override // com.p074ss.bytertc.engine.audio.ISpatialAudio
    public void disableRemoteOrientation() {
        this.mJniReadLock.lock();
        try {
            long j = this.mNaiveInstance;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native SpatialAudio is invalid, disableRemoteOrientation failed.");
            } else {
    ...
    public void enableSpatialAudio(boolean z) {
        ...
        try {
            long j = this.mNaiveInstance;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native SpatialAudio is invalid, enableSpatialAudio failed.");
            } else {
    ...
    public int removeAllRemotePosition() {
        ...
        try {
            ...
            LogUtil.m82084e(TAG, "native SpatialAudio is invalid, updatePosition failed.");
            return -1;
        } finally {
            this.mJniReadLock.unlock();
        }
