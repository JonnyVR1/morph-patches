...
import com.p074ss.bytertc.engine.handler.RTCMediaPlayerAudioFrameObserver;
import com.p074ss.bytertc.engine.handler.RTCMediaPlayerCustomSourceProvider;
import com.p074ss.bytertc.engine.handler.RTCMediaPlayerEventHandler;
...
public class RtcMediaPlayer extends IMediaPlayer {
    ...
    @Override // com.p074ss.bytertc.engine.audio.IMediaPlayer
    public synchronized int getAudioTrackCount() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, getAudioTrackCount failed.");
    ...
    public synchronized int getPlaybackDuration() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, getPlaybackDuration failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int getPosition() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, getPosition failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized PlayerState getState() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, getState failed.");
    ...
    public synchronized int getTotalDuration() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, getTotalDuration failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int getVolume(AudioMixingType audioMixingType) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, getVolume failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int open(String str, MediaPlayerConfig mediaPlayerConfig) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, open failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int openWithCustomSource(MediaPlayerCustomSource mediaPlayerCustomSource, MediaPlayerConfig mediaPlayerConfig) {
        if (this.mNativeMediaPlayer == 0) {
            LogUtil.m82084e(TAG, "native MediaPlayer is invalid, openWithCustomSource failed.");
            return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
        }
    ...
    public synchronized int pause() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, pause failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int pushExternalAudioFrame(AudioFrame audioFrame) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, pushExternalAudioFrame failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int registerAudioFrameObserver(IMediaPlayerAudioFrameObserver iMediaPlayerAudioFrameObserver) {
        if (this.mNativeMediaPlayer == 0) {
            LogUtil.m82084e(TAG, "native MediaPlayer is invalid, registerAudioFrameObserver failed.");
            return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
        }
    ...
    public synchronized int resume() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, resume failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int selectAudioTrack(int i) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, selectAudioTrack failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setAudioDualMonoMode(AudioMixingDualMonoMode audioMixingDualMonoMode) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setAudioDualMonoMode failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setAudioPitch(int i) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setAudioPitch failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setEventHandler(IMediaPlayerEventHandler iMediaPlayerEventHandler) {
        if (this.mNativeMediaPlayer == 0) {
            LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setEventHandler failed.");
            return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
        }
    ...
    public synchronized int setLoudness(float f) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setLoudness failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setPlaybackSpeed(int i) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setPlaybackSpeed failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setPosition(int i) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setPosition failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setProgressInterval(long j) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setProgressInterval failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int setVolume(int i, AudioMixingType audioMixingType) {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, setVolume failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int start() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, start failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
    ...
    public synchronized int stop() {
        ...
        LogUtil.m82084e(TAG, "native MediaPlayer is invalid, stop failed.");
        return ReturnStatus.RETURN_STATUS_NATIVE_IN_VALID.value();
    }
