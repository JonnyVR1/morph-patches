...
import com.p074ss.bytertc.engine.NativeKTVPlayerFunctions;
import com.p074ss.bytertc.engine.handler.KTVPlayEventHandler;
import com.p074ss.bytertc.engine.utils.LogUtil;
import com.p074ss.bytertc.ktv.data.AudioPlayType;
import com.p074ss.bytertc.ktv.data.AudioTrackType;
...
public class KTVPlayerImpl extends IKTVPlayer {
    ...
    @Override // com.p074ss.bytertc.ktv.IKTVPlayer
    public void pauseMusic(@NonNull String str) {
        this.mJniReadLock.lock();
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, pauseMusic failed.");
            } else {
    ...
    public void playMusic(@NonNull String str, @NonNull AudioTrackType audioTrackType, @NonNull AudioPlayType audioPlayType) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, playMusic failed.");
            } else {
    ...
    public void resumeMusic(@NonNull String str) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, resumeMusic failed.");
            } else {
    ...
    public void seekMusic(@NonNull String str, int i) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, seekMusic failed.");
            } else {
    ...
    public void setMusicPitch(@NonNull String str, int i) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, setMusicPitch failed.");
            } else {
    ...
    public void setMusicVolume(@NonNull String str, int i) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, setMusicVolume failed.");
            } else {
    ...
    public void stopMusic(@NonNull String str) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, stopMusic failed.");
            } else {
    ...
    public void switchAudioTrackType(@NonNull String str) {
        ...
        try {
            long j = this.mNativeKTVPlayer;
            if (j == 0) {
                LogUtil.m82084e(TAG, "native mNativeKTVPlayer is invalid, switchAudioTrackType failed.");
            } else {
