...
import com.p074ss.bytertc.audio.device.router.device.VivoKTVHelper;
...
public class VivoEarback implements IHardWareEarback {
    ...
    private void printLog(String str) {
        String str2 = TAG;
        RXLogging.m5744i(str2, str2 + ":" + str);
    }
    ...
    public int setEffect(int i) {
        if (this.vivoKtvHelper != null) {
            ...
            RXLogging.m5746w(TAG, String.format("ByteAudioEarBackEffect vivo valid is [%d,%d], value is %d, ignore it", 0, Integer.valueOf(this.vivoKtvHelper.getEffectSize()), Integer.valueOf(i)));
        }
        return -1;
    }
