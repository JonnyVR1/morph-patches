...
import com.p074ss.bytertc.audio.device.hwearback.ovm.OVMAuthManager;
...
public class OVMAuthManager extends Handler {
    ...
    private OVMAuthManager() {
        ...
        this.notifyResultRunnable = new Runnable() { // from class: l.q850
            @Override // java.lang.Runnable
            public final void run() {
                OVMAuthManager.m82011a(this.f156077a);
            }
        };
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m82011a(OVMAuthManager oVMAuthManager) {
        ArrayList arrayList;
    ...
    public void handleMessage(@NonNull Message message) {
        ...
        synchronized (this) {
            try {
                ...
                if (data == null) {
                    RXLogging.m5742e(TAG, "handleMessage get bundle is null");
                } else {
    ...
    public void startAuth(Context context, String str) {
        if (ManufacturerChecker.getManufacturerType() != ManufacturerChecker.Type.OP) {
            RXLogging.m5742e(TAG, "no need to auth");
        ...
        try {
            ...
            RXLogging.m5744i(TAG, "url is not exist, do not need auth ");
            this.mAuthResultCode = -3;
            notifyResult();
        } catch (RuntimeException e) {
            RXLogging.m5742e(TAG, "auth error " + e.toString());
