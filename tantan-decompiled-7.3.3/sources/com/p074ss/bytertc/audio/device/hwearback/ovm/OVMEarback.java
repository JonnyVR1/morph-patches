...
import com.p074ss.bytertc.audio.device.hwearback.BaseEarback;
import com.p074ss.bytertc.audio.device.hwearback.SlientPlayer;
...
public class OVMEarback extends BaseEarback {
    ...
    public static /* synthetic */ void m82014a(OVMEarback oVMEarback, int i) {
        oVMEarback.getClass();
        RXLogging.m5744i(TAG, "connection result: " + i);
        if (i != 1001) {
    ...
    private boolean checkAudioParams() {
        ...
        if (hardwareEarbackParams == null) {
            ...
            if (list != null && list.size() > 0) {
                ...
                for (HardwareEarbackParams.Play play : hardwareEarbackParams.playParamsList) {
                    ...
                    z2 |= z3;
                    if (z2) {
                        RXLogging.m5744i(TAG, "updating slientPlayer params: " + play.sampleRate + ", " + play.flags);
        ...
        RXLogging.m5744i(TAG, stringBuffer.toString());
        return z;
    }
    ...
    private String getReportParameters() {
        ...
        try {
            ...
            RXLogging.m5742e(TAG, "parse report params error, not json format");
    ...
    @Override // com.p074ss.bytertc.audio.device.hwearback.BaseEarback
    ...
    @Override // com.p074ss.bytertc.audio.device.hwearback.BaseEarback
    public void onInit() {
        this.client.setAuthCallback(new OVMAuthManager.AuthCallback() { // from class: l.t850
            @Override // com.ss.bytertc.audio.device.hwearback.ovm.OVMAuthManager.AuthCallback
            public final void onResult(int i) {
                OVMEarback.m82014a(this.f172491a, i);
            }
        });
    }
