...
public class OVMKaraokeMediaHelper {
    ...
    private Method getMethod(String str, Class<?>... clsArr) {
        ...
        try {
            ...
            RXLogging.m5743e(TAG, "Can not get method: " + str, th);
            return null;
        }
    }
    ...
    public void closeKTVDevice() {
        try {
            ...
            RXLogging.m5743e(TAG, "closeKTVDevice operate not allowed", th);
        }
    }
    ...
    public String getKaraokeSupportParameters() {
        try {
            ...
            RXLogging.m5743e(TAG, "getKaraokeSupportParameters operate not allowed", th);
            return "";
        }
    }
    ...
    public int getListenRecordSame() {
        try {
            ...
            RXLogging.m5743e(TAG, "getListenRecordSame operate not allowed", th);
        }
        return 0;
    }
    ...
    public int getMicVolParam() {
        try {
            ...
            RXLogging.m5743e(TAG, "getMicVolParam operate not allowed", th);
        }
        return 0;
    }
    ...
    public int getPlayFeedbackParam() {
        try {
            ...
            RXLogging.m5743e(TAG, "getPlayFeedbackParam operate not allowed", th);
        }
        return 0;
    }
    ...
    public boolean isAppSupportKaraoke(String str) {
        try {
            ...
            RXLogging.m5743e(TAG, "isAppSupportKaraoke operate not allowed", th);
            return false;
        }
    }
    ...
    public boolean isDeviceSupportKaraoke() {
        try {
            ...
            RXLogging.m5743e(TAG, "isDeviceSupportKaraoke operate not allowed", th);
        }
        return false;
    }
    ...
    public void openKTVDevice() {
        try {
            ...
            RXLogging.m5743e(TAG, "openKTVDevice operate not allowed", th);
        }
    }
    ...
    public void setEqualizerType(int i) {
        try {
            ...
            th.printStackTrace();
            RXLogging.m5743e(TAG, "setEqualizerType operate not allowed", th);
        }
    }
    ...
    public void setListenRecordSame(int i) {
        try {
            ...
            RXLogging.m5743e(TAG, "setListenRecordSame operate not allowed", th);
        }
    }
    ...
    public void setMicVolParam(int i) {
        try {
            ...
            RXLogging.m5743e(TAG, "setMicVolParam operate not allowed", th);
        }
    }
    ...
    public void setMixerSoundType(int i) {
        try {
            ...
            RXLogging.m5743e(TAG, "setMixerSoundType operate not allowed", th);
        }
    }
    ...
    public void setPlayFeedbackParam(int i) {
        try {
            ...
            RXLogging.m5743e(TAG, "setPlayFeedbackParam operate not allowed", th);
        }
    }
}
