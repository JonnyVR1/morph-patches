...
public class VivoKTVHelper {
    ...
    static {
        int[][] iArr = {new int[]{200, 1000, 500, 4500, 1000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{5000, 4500, 1200, 4500, 6500, 1200}, new int[]{4500, TXRecordCommon.AUDIO_SAMPLERATE_8000, 1000, TXLiteAVCode.WARNING_START_CAPTURE_IGNORED, 6500, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{2500, 3000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED, TXLiteAVCode.WARNING_START_CAPTURE_IGNORED, 5000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{3500, 5500, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED, 5000, 5500, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{TXLiteAVCode.WARNING_START_CAPTURE_IGNORED, 3000, 1000, 2500, 5500, 1200}, new int[]{500, 5000, 800, 4500, 3000, 1200}, new int[]{20, 500, 60, 4500, 5000, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED}, new int[]{0, 0, 0, TXLiteAVCode.WARNING_START_CAPTURE_IGNORED, 0, 1200}};
        ...
        EchoCustomParams = new int[][]{new int[]{3200, 150, ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED, 2000}};
    }
    ...
    private int getKTVParam(String str) {
        if (!Build.MANUFACTURER.trim().contains(HardwareEarMonitorUtils.MANUFACTURER_VIVO)) {
            return 0;
        }
