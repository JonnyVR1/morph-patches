...
import com.p074ss.bytertc.base.media.RTCSurfaceTextureListener;
...
public class RTCSurfaceTextureListener implements TextureView.SurfaceTextureListener {
    ...
    public RTCSurfaceTextureListener(TextureView textureView, final long j, final String str) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: l.ijc0
            @Override // java.lang.Runnable
            public final void run() {
                RTCSurfaceTextureListener.m82026a(this.f115206a, surfaceTexture, j, str);
            }
        });
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m82026a(RTCSurfaceTextureListener rTCSurfaceTextureListener, SurfaceTexture surfaceTexture, long j, String str) {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        if (this.nativeSurfaceHelperHandle != 0) {
            RXLogging.m5744i("RTCSurfaceTextureListener", "onSurfaceTextureAvailable key:" + this.key);
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        RXLogging.m5744i("RTCSurfaceTextureListener", "onSurfaceTextureDestroyed key:" + this.key);
