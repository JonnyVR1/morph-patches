...
import com.p074ss.bytertc.base.media.RXNativeFunctions;
import com.p074ss.bytertc.base.media.SurfaceTextureHelper;
import com.p074ss.bytertc.base.media.VideoCapturer;
import com.p074ss.bytertc.base.media.screen.ScreenCapturerAndroid;
...
public class RXVideoCaptureAndroid {
    ...
    private CapturerObserver localCapturerObserver = new CapturerObserver() { // from class: com.ss.bytertc.base.media.camera.RXVideoCaptureAndroid.1
        @Override // com.p074ss.bytertc.base.media.CapturerObserver
        public void onCapturerError(String str) {
            RXLogging.m5742e(RXVideoCaptureAndroid.TAG, "onCapturerError: " + str);
        ...
        public void onCapturerFormatSelected(int i, int i2, int i3, int i4, int i5) {
            RXLogging.m5746w(RXVideoCaptureAndroid.TAG, "onCapturerFormatSelected...");
        ...
        public void onCapturerStarted(boolean z) {
            if (!z) {
                ...
                RXLogging.m5746w(RXVideoCaptureAndroid.TAG, "onCapturerStarted...");
        ...
        public void onCapturerStopped() {
            RXLogging.m5746w(RXVideoCaptureAndroid.TAG, "onCapturerStopped...");
    ...
    public RXVideoCaptureAndroid(boolean z, long j, EglBase.Context context) {
        ...
        RXLogging.m5746w(TAG, "RXVideoCaptureAndroid Created, CaptureScreen=" + z);
        ...
        try {
            if (z) {
                return new ScreenCapturerAndroid(intent, new MediaProjection.Callback() { // from class: com.ss.bytertc.base.media.camera.RXVideoCaptureAndroid.3
                    ...
                    public void onStop() {
                        RXLogging.m5742e(RXVideoCaptureAndroid.TAG, "User revoked permission to capture the screen.");
                    }
                });
            }
            boolean z2 = true;
            ...
            if (deviceNames.length > i && i >= 0 && (cameraVideoCapturerCreateCapturer = camera1Enumerator.createCapturer(deviceNames[i], this.mCameraEventsHandler)) != null) {
                RXLogging.m5744i(TAG, "createVideoCapturer, deviceUniqueId: " + i);
                return cameraVideoCapturerCreateCapturer;
            }
            RXLogging.m5746w(TAG, "enumerator camera but cannot find a match one, use default. deviceUniqueId: " + i + ", deviceNames: " + deviceNames.length);
            if (deviceNames.length > 0) {
                ...
                RXLogging.m5742e(TAG, "VideoCapturer first camera create null, name:" + str);
            } else {
                RXLogging.m5742e(TAG, "num of camera in device is zero");
            }
            RXLogging.m5742e(TAG, "cannot init VideoCapture: ");
            return null;
        } catch (IllegalArgumentException e) {
            RXLogging.m5742e(TAG, "Create VideoCapture fail : " + e.getMessage());
            return null;
        }
    }
    ...
    public static int[] getCameraSensorOrientations() {
        ...
        if (numberOfCameras <= 0) {
            RXLogging.m5746w(TAG, "getNumberOfCameras failed on count " + numberOfCameras);
            return null;
        }
        ...
        for (int i = 0; i < numberOfCameras; i++) {
            try {
                ...
                RXLogging.m5746w(TAG, "getCameraInfo failed on index " + i + ',' + e.getMessage());
                return null;
            }
        }
        return iArr;
    ...
    private void startVideoCapture(int i, int i2, int i3) {
        RXLogging.m5746w(TAG, String.format("startVideoCapture: width: %d, height: &d, fps: &d", Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)));
        ...
        if (videoCapturer != null) {
            try {
                ...
                RXLogging.m5742e(TAG, "VideoCapture startCapture fail : " + e.getMessage());
            }
        }
    }
    ...
    public int getUIOrientation() {
        int rotation = ((WindowManager) ContextUtils.getApplicationContext().getSystemService(BLiveBottomPopupStyleTypeEnum.window)).getDefaultDisplay().getRotation();
        if (rotation == 1) {
            return 270;
        }
        if (rotation != 2) {
    ...
    public void startCapture(int i, int i2, int i3, int i4, Intent intent, boolean z, int i5) {
        RXLogging.m5746w(TAG, "startCapture...");
        this.mWidth = i;
        this.mHeight = i2;
        this.mCaptureScreenIntent = intent;
        this.mCaptureBufferType = i4;
        if (j26.m143188a(ContextUtils.getApplicationContext(), "android.permission.CAMERA") != 0) {
        ...
        if (this.mVideoCapturer == null) {
            RXLogging.m5742e(TAG, "mVideoCapturer is null...");
        }
    ...
    public void stopCapture() {
        RXLogging.m5746w(TAG, "stopCapture...");
        VideoCapturer videoCapturer = this.mVideoCapturer;
        if (videoCapturer != null && this.mIsVideoCaptureInited && this.mIsVideoCaptureWorking) {
            try {
