...
public class EglRenderer implements VideoSink {
    ...
    public static /* synthetic */ class C135163 {
    ...
    public static /* synthetic */ void m82018a(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f, boolean z) {
        if (glDrawer == null) {
    ...
    public static /* synthetic */ void m82019b(EglRenderer eglRenderer, CountDownLatch countDownLatch, FrameListener frameListener) {
    ...
    public static /* synthetic */ void m82021d(EglRenderer eglRenderer, Runnable runnable) {
    ...
    public static /* synthetic */ void m82022e(EglRenderer eglRenderer, EglBase.Context context, int[] iArr) {
        if (context == null) {
    ...
    public static /* synthetic */ void m82023f(EglRenderer eglRenderer, CountDownLatch countDownLatch) {
    ...
    public static /* synthetic */ void m82025h(EglRenderer eglRenderer, Looper looper) {
    ...
    public void renderFrameOnRenderThread() {
        ...
        synchronized (this.frameLock) {
            try {
                ...
                int i3 = C135163.$SwitchMap$com$bytedance$realx$video$RendererCommon$ScalingType[this.renderModel.ordinal()];
                if (i3 != 1) {
                    if (i3 == 2) {
                        iSurfaceWidth = 0;
                        iSurfaceHeight = 0;
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, @Nullable final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: l.dte
            @Override // java.lang.Runnable
            public final void run() {
                EglRenderer.m82018a(this.f90562a, glDrawer, frameListener, f, z);
            }
        });
    }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            try {
                ...
                handler.postAtFrontOfQueue(new Runnable() { // from class: l.ose
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f148813a.clearSurfaceOnRenderThread(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public void init(@Nullable final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            try {
                ...
                ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: l.ate
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m82022e(this.f73344a, context, iArr);
                    }
                });
            ...
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        videoFrame.retain();
                        this.renderThreadHandler.post(new Runnable() { // from class: l.rse
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f164653a.renderFrameOnRenderThread();
                            }
                        });
                    } catch (Throwable th) {
                        throw th;
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.use
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m82023f(this.f180774a, countDownLatch);
                    }
                });
                final Looper looper = this.renderThreadHandler.getLooper();
                this.renderThreadHandler.post(new Runnable() { // from class: l.xse
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m82025h(this.f196083a, looper);
                    }
                });
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                if (handler == null) {
                    ...
                    this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: l.lse
                        @Override // java.lang.Runnable
                        public final void run() {
                            EglRenderer.m82021d(this.f133419a, runnable);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            try {
                ...
                postToRenderThread(new Runnable() { // from class: l.ise
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.m82019b(this.f116643a, countDownLatch, frameListener);
                    }
                });
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
