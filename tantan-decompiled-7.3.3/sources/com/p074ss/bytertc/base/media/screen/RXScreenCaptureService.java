...
import com.p074ss.bytertc.base.media.screen.ScreenAudioCaptureAndroidManager;
import com.p074ss.bytertc.base.media.screen.ScreenCaptureAndroidManager;
...
public class RXScreenCaptureService extends Service {
    ...
    private void audioDispose() {
        this.mHandler.post(new Runnable() { // from class: l.ujc0
    ...
    private void changeCaptureFormat(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: l.rjc0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void createNotificationChannel() {
        ...
        if (i >= 26) {
            ((NotificationManager) getSystemService("notification")).createNotificationChannel(iy40.m142608a("notification_id", "notification_name", 2));
        }
    ...
    public static /* synthetic */ void m82054d(RXScreenCaptureService rXScreenCaptureService) {
    ...
    private void dispose(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: l.pjc0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static /* synthetic */ void m82056f(RXScreenCaptureService rXScreenCaptureService, int i, int i2, int i3, int i4) {
        rXScreenCaptureService.getClass();
    ...
    public static /* synthetic */ void m82058h(RXScreenCaptureService rXScreenCaptureService) {
    ...
    private void startAudioCapture() {
        ...
        this.mHandler.post(new Runnable() { // from class: l.wjc0
            @Override // java.lang.Runnable
            public final void run() {
                RXScreenCaptureService.m82054d(this.f189430a);
            }
        });
    }
    ...
    private void startCapture(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: l.qjc0
            @Override // java.lang.Runnable
            public final void run() {
                RXScreenCaptureService.m82056f(this.f157953a, intExtra, intExtra2, intExtra3, intExtra4);
            }
        });
    }
    ...
    private void stop() {
        ...
        this.mHandler.post(new Runnable() { // from class: l.tjc0
            @Override // java.lang.Runnable
            public final void run() {
                RXScreenCaptureService.m82058h(this.f174570a);
            }
        });
    }

    private void stopAudioCapture() {
        this.mHandler.post(new Runnable() { // from class: l.vjc0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void stopCapture(Intent intent) {
        this.mHandler.post(new Runnable() { // from class: l.sjc0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onCreate() {
        ...
        RXLogging.m5746w(TAG, String.format("[ScreenCapture] RXScreenCaptureService::onCreate success!", new Object[0]));
