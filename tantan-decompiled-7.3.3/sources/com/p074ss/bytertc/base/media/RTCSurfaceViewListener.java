...
import com.p074ss.bytertc.base.media.RTCSurfaceViewListener;
...
public class RTCSurfaceViewListener implements SurfaceHolder.Callback {
    ...
    public RTCSurfaceViewListener(SurfaceView surfaceView, final long j, final String str) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: l.jjc0
            @Override // java.lang.Runnable
            public final void run() {
                RTCSurfaceViewListener.m82027a(this.f121160a, surface2, j, str);
            }
        });
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ void m82027a(RTCSurfaceViewListener rTCSurfaceViewListener, Surface surface, long j, String str) {
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        ...
        RXLogging.m5744i("RTCSurfaceViewListener", "surfaceCreated key:" + this.key);
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        if (this.nativeSurfaceHelperHandle != 0) {
            RXLogging.m5744i("RTCSurfaceViewListener", "surfaceDestroyed key:" + this.key);
