...
public class TEFrameSizei implements Parcelable {
    public static final Parcelable.Creator<TEFrameSizei> CREATOR = new C13484a();
    public int height;
    public int width;

    /* JADX INFO: renamed from: com.ss.android.ttvecamera.TEFrameSizei$a */
    public static class C13484a implements Parcelable.Creator<TEFrameSizei> {
    ...
    public String toString() {
        return this.width + BaseSei.f14624X + this.height;
    }
