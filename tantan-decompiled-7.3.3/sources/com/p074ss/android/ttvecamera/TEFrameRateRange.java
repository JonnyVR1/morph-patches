...
public class TEFrameRateRange implements Parcelable {
    public static final Parcelable.Creator<TEFrameRateRange> CREATOR = new C13483a();
    public int fpsUnitFactor;
    public int max;
    public int min;

    /* JADX INFO: renamed from: com.ss.android.ttvecamera.TEFrameRateRange$a */
    public static class C13483a implements Parcelable.Creator<TEFrameRateRange> {
    ...
    public static int m81718a(List<int[]> list) {
