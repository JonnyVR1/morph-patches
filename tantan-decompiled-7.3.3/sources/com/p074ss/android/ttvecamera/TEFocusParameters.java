...
public class TEFocusParameters implements Parcelable {
    public static final Parcelable.Creator<TEFocusParameters> CREATOR = new C13479a();
    ...
    public static class C13479a implements Parcelable.Creator<TEFocusParameters> {
