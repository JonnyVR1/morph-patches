...
public class OneSecAdapter implements IOneSecAdapter {
    ...
    private OneSecAdapter(Context context, TXILiveRoomDefine.TXILiveConfig tXILiveConfig, TXILiveRoomDelegateAdapter tXILiveRoomDelegateAdapter) {
        ...
        TXCLog.m84152i(TAG, "create: new OneSecAdapter");
        TXCLog.m84152i(TAG, "new adapter = " + this + " version = " + getSDKVersionStr() + " delegate = " + tXILiveRoomDelegateAdapter);
        this.mSDKInstance = new C14108a(context, null, tXILiveRoomDelegateAdapter);
    }
        ...
        synchronized (OneSecAdapter.class) {
            try {
                if (sOneSecAdapterInstance == null) {
                    ...
                    TXCLog.m84152i(TAG, "create: use old OneSecAdapter.");
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static String getSDKVersionStr() {
        boolean zM84239f = C14215f.m84239f();
        sIsLoadedSDKSuccess = zM84239f;
        return zM84239f ? TXCCommonUtil.getSDKVersionStr() : "0.0.0";
    }
    ...
    public void addDelegate(TXILiveRoomDelegateAdapter tXILiveRoomDelegateAdapter) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " addDelegate: ");
    ...
    public void clearDelegate() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " clearDelegate: ");
    ...
    public void clearLocalMixConfig() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " clearLocalMixConfig: ");
    ...
    public void clearMixTranscodingConfig() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " clearMixTranscodingConfig: ");
    ...
    public void connectOtherRoom(String str, long j) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " connectOtherRoom roomName = " + str + " userId = " + j);
    ...
    public void destroy() {
        ...
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " destroy: ");
    ...
    public void disconnectOtherRoom() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " disconnectOtherRoom");
    ...
    public void enableAudioMessage(boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " enableAudioMessage: " + z);
    ...
    public int enableEncSmallVideoStream(boolean z, TXILiveRoomDefine.TXILiveSize tXILiveSize, int i, int i2) {
        ...
        TXCLog.m84152i(TAG, this + " enableEncSmallVideoStream: enable = " + z + " size = " + tXILiveSize + " fps = " + i + " videoBitrate = " + i2);
    ...
    public void joinRoom(OneSecAdapterParams oneSecAdapterParams, TXILiveRoomDefine.TXILiveRoomConfig tXILiveRoomConfig) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " joinRoom, params = " + oneSecAdapterParams + ", config = " + tXILiveRoomConfig);
    ...
    public void muteAllRemoteAudio(boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " muteAllRemoteAudio: mute = " + z);
    ...
    public void muteAllRemoteVideo(boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " muteAllRemoteVideo: mute = " + z);
    ...
    public void muteLocalAudio(boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " muteLocalAudio: enable = " + z);
    ...
    public void muteLocalVideo(boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " muteLocalVideo: enable = " + z);
    ...
    public void muteRemoteAudio(long j, boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " muteRemoteAudio: userId = " + j + " mute = " + z);
    ...
    public void muteRemoteVideo(long j, boolean z) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " muteRemoteVideo: userId = " + j + " mute = " + z);
    ...
    public void pauseMusic() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " pauseMusic: ");
    ...
    public void playEffectWithId(int i, String str, boolean z, boolean z2) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " playEffectWithId: effect id = " + i + " path = " + str + " loop = " + z2 + " loopback = " + z);
    ...
    public void playMusicWithUrl(String str, boolean z, int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " playMusicWithUrl: url = " + str + " loopback = " + z + " repeat = " + i);
    ...
    public void quitRoom() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " quitRoom: ");
    ...
    public void removeDelegate(TXILiveRoomDelegateAdapter tXILiveRoomDelegateAdapter) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " removeDelegate: ");
    ...
    public void resume() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " resume: ");
    ...
    public boolean resumeMusic() {
        ...
        TXCLog.m84152i(TAG, this + " resumeMusic: ");
    ...
    public void setAudioDelegate(TXILiveRoomAudioDelegateAdapter tXILiveRoomAudioDelegateAdapter) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setAudioDelegate: ");
    ...
    public void setAudioExpandBlockThreshold(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setAudioExpandBlockThreshold: " + i);
    ...
    public void setAudioExpandCountPerBlock(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setAudioExpandCountPerBlock: " + i);
    ...
    public void setAudioMode(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setAudioRoute: mode = " + i);
    ...
    public void setAudioVolumeIndication(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setAudioVolumeIndication: interval = " + i);
    ...
    public int setEffectsVolume(double d) {
        ...
        TXCLog.m84152i(TAG, this + " setEffectsVolume: volume = " + d);
    ...
    public void setLocalMixConfig(TXILiveRoomDefine.TXILiveRoomLocalMixConfig tXILiveRoomLocalMixConfig) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setLocalMixConfig: config = " + tXILiveRoomLocalMixConfig);
    ...
    public void setMicVolume(float f) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setMicVolume: volume = " + f);
    ...
    public void setMixTranscodingConfig(TXILiveRoomDefine.TXILiveRoomTranscodingConfig tXILiveRoomTranscodingConfig) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setMixTranscodingConfig: config = " + tXILiveRoomTranscodingConfig);
    ...
    public int setMusicPitch(int i) {
        ...
        TXCLog.m84152i(TAG, this + " setMusicPitch: " + i);
        if (i > 12 || i < -12) {
            return -1;
        }
    ...
    public int setMusicPosition(int i) {
        ...
        TXCLog.m84152i(TAG, this + " setMusicPosition: " + i);
    ...
    public void setMusicVolume(float f) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setMusicVolume: volume = " + f);
    ...
    public void setPlaybackVolume(float f) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setPlaybackVolume: " + f);
            if (f >= 0.0f && f <= 4.0f) {
                this.mSDKInstance.setPlaybackVolume(f);
                return;
            }
            TXCLog.m84149e(TAG, this + "setPlaybackVolume: invalid volume = " + f);
        }
    }
    ...
    public int setPriorRemoteVideoStreamType(int i) {
        ...
        TXCLog.m84152i(TAG, this + " setPriorRemoteVideoStreamType: streamType = " + i);
    ...
    public int setRemoteVideoStreamType(String str, int i) {
        ...
        TXCLog.m84152i(TAG, this + " setRemoteVideoStreamType: userId = " + str + " streamType = " + i);
    ...
    public void setSurfaceSize(long j, int i, int i2) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setSurfaceSize: userId = " + j + " w = " + i + " h = " + i2);
    ...
    public void setVideoRenderDelegate(long j, TXILiveRoomVideoRenderDelegate tXILiveRoomVideoRenderDelegate) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setVideoRenderDelegate: userId = " + j + " delegate = " + tXILiveRoomVideoRenderDelegate);
    ...
    public int setVolumeOfEffect(int i, double d) {
        ...
        TXCLog.m84152i(TAG, this + " setVolumeOfEffect: effectId = " + i + " volume = " + d);
    ...
    public void setVolumeType(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " setVolumeType: " + i);
    ...
    public void startPublishCDNStream(String str) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " startPublishCDNStream:");
    ...
    public void startRemoteRender(long j, SurfaceView surfaceView) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " startRemoteRender: userId " + j + " surface view = " + surfaceView);
    ...
    public void stopAllEffect() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " stopAllEffect: ");
    ...
    public void stopAllRemoteRender() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " stopAllRemoteRender: ");
    ...
    public void stopEffectWithId(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " stopEffectWithId: effectId = " + i);
    ...
    public void stopMusic() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " stopMusic: ");
    ...
    public void stopPublishCDNStream() {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " stopPublishCDNStream: ");
    ...
    public void stopRemoteRender(long j) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " stopRemoteRender: userId = " + j);
    ...
    public void switchRole(int i) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " switchRole: role " + i);
    ...
    public void startRemoteRender(long j, TextureView textureView) {
        if (this.mSDKInstance != null) {
            TXCLog.m84152i(TAG, this + " startRemoteRender: userId " + j + " textureView = " + textureView);
