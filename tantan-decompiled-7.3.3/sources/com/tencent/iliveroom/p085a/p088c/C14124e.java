...
public class C14124e extends TXILiveRoomDelegateAdapter {

    /* JADX INFO: renamed from: a */
    private LinkedList<TXILiveRoomDelegateAdapter> f58701a = new LinkedList<>();

    /* JADX INFO: renamed from: b */
    private Handler f58702b = new Handler(Looper.getMainLooper());

    /* JADX INFO: renamed from: a */
    public void m83823a(final TXILiveRoomDelegateAdapter tXILiveRoomDelegateAdapter) {
        if (tXILiveRoomDelegateAdapter != null) {
            this.f58702b.post(new Runnable() { // from class: com.tencent.iliveroom.a.c.e.1
                @Override // java.lang.Runnable
                public void run() {
                    if (C14124e.this.f58701a.contains(tXILiveRoomDelegateAdapter)) {
                        return;
                    }
                    C14124e.this.f58701a.add(tXILiveRoomDelegateAdapter);
                    TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->add Delegate size: " + C14124e.this.f58701a.size());
                }
            });
        } else {
            TXCLog.m84149e("TXRoomDelegate", "TXRoomDelegate: add null delegate fail.");
        }
    }

    /* JADX INFO: renamed from: b */
    public void m83824b(final TXILiveRoomDelegateAdapter tXILiveRoomDelegateAdapter) {
        if (tXILiveRoomDelegateAdapter != null) {
            this.f58702b.post(new Runnable() { // from class: com.tencent.iliveroom.a.c.e.12
                @Override // java.lang.Runnable
                public void run() {
                    C14124e.this.f58701a.remove(tXILiveRoomDelegateAdapter);
                    TXCLog.m84152i("TXRoomDelegate", "removeDelegate->remove Delegate size: " + C14124e.this.f58701a.size());
                }
            });
        } else {
            TXCLog.m84149e("TXRoomDelegate", "TXRoomDelegate: remove null delegate fail.");
        }
    }
    ...
    public void onClearMixTranscodingConfig(final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onClearMixTranscodingConfig err:" + i + ", msg:" + str);
        Runnable runnable = new Runnable() { // from class: com.tencent.iliveroom.a.c.e.21
            @Override // java.lang.Runnable
            public void run() {
                for (TXILiveRoomDelegateAdapter tXILiveRoomDelegateAdapter : C14124e.this.f58701a) {
                    if (tXILiveRoomDelegateAdapter != null) {
        ...
        if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
            ...
            this.f58702b.post(runnable);
        }
    }

    @Override // com.tencent.iliveroom.TXILiveRoomDelegateAdapter
    public void onConnectOtherRoom(final long j, final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onConnectOtherRoom userId:" + j + ", code:" + i + ", msg:" + str);
    ...
    public void onDetectFacePoints(float[] fArr) {
        Iterator<TXILiveRoomDelegateAdapter> it = this.f58701a.iterator();
        while (it.hasNext()) {
    ...
    public void onDisconnectOtherRoom(final int i, final String str) {
        ...
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onDisconnectOtherRoom code:" + i + ", msg:" + str);
    ...
    public void onError(final long j, final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onError user:" + j + ", code:" + i + ", msg:" + str);
    ...
    public void onEvent(final long j, final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onEvent user:" + j + ", code:" + i + ", msg:" + str);
    ...
    public void onJoinRoomFailed(final String str, final int i, final String str2) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onJoinRoomFailed roomName:" + str + ", code:" + i + ", msg:" + str2);
    ...
    public void onJoinRoomSuccess(final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onJoinRoomSuccess roomName:" + str);
    ...
    public void onKickOut(final String str, final long j) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onKickOut roomName:" + str + " userId:" + j);
    ...
    public void onQuitRoomFailed(final String str, final int i, final String str2) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onQuitRoomFailed roomName:" + str + ", code:" + i + ", msg:" + str2);
    ...
    public void onQuitRoomSuccess(final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onQuitRoomSuccess roomName:" + str);
    ...
    public void onRoomAudioMuted(final String str, final long j, final boolean z) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomAudioMuted roomName:" + str + ", user:" + j);
    ...
    public void onRoomBroadcasterIn(final String str, final long j) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomBroadcasterIn roomName:" + str + ", user:" + j);
    ...
    public void onRoomBroadcasterOut(final String str, final long j, final int i) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomBroadcasterOut roomName:" + str + ", user:" + j);
    ...
    public void onRoomHasVideo(final String str, final long j) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomHasVideo roomName:" + str + ", user:" + j);
    ...
    public void onRoomRoleChanged(final String str, final int i, final int i2) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomRoleChanged roomName:" + str + ", oldRole:" + i + ", newRole: " + i2);
    ...
    public void onRoomVideoMuted(final String str, final long j, final boolean z) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomVideoMuted roomName:" + str + ", user:" + j);
    ...
    public void onRoomVideoQosChanged(final String str, final int i, final int i2) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onRoomVideoQosChanged roomName:" + str + ", fps:" + i + ", bitrate: " + i2);
    ...
    public void onSetMixTranscodingConfig(final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onSetMixTranscodingConfig err:" + i + ", msg:" + str);
    ...
    public void onStartPublishCDNStream(final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onStartPublishCDNStream err:" + i + ", msg:" + str);
    ...
    public void onStopPublishCDNStream(final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onStopPublishCDNStream err:" + i + ", msg:" + str);
    ...
    public void onWarning(final long j, final int i, final String str) {
        TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->onWarning user:" + j + ", code:" + i + ", msg:" + str);
    ...
    /* JADX INFO: renamed from: a */
    public void m83822a() {
        this.f58702b.post(new Runnable() { // from class: com.tencent.iliveroom.a.c.e.22
            @Override // java.lang.Runnable
            public void run() {
                TXCLog.m84152i("TXRoomDelegate", "TXRoomDelegate->clean Delegate");
                C14124e.this.f58701a.clear();
            }
        });
    }
}
