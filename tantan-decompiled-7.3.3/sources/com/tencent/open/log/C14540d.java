...
public class C14540d {

    /* JADX INFO: renamed from: com.tencent.open.log.d$a */
    public static final class a {
        /* JADX INFO: renamed from: a */
        public static final boolean m85538a(int i, int i2) {
            return i2 == (i & i2);
        }
    }
    ...
    public static final class b {
        ...
        /* JADX INFO: renamed from: a */
        public static SimpleDateFormat m85539a(String str) {
            return new SimpleDateFormat(str);
        }
    }

    /* JADX INFO: renamed from: a */
    public static boolean m85536a(String str) {
    ...
    public static Bundle m85537b(Bundle bundle) {
        if (!m85535a(bundle)) {
            return bundle;
        }
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m85535a(Bundle bundle) {
