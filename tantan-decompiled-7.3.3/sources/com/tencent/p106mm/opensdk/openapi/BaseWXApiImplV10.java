...
import com.tencent.p106mm.opensdk.channel.MMessageActV2;
...
import com.tencent.p106mm.opensdk.modelbiz.AddCardToWXCardPackage;
import com.tencent.p106mm.opensdk.modelbiz.ChooseCardFromWXCardPackage;
import com.tencent.p106mm.opensdk.modelbiz.CreateChatroom;
import com.tencent.p106mm.opensdk.modelbiz.HandleScanResult;
import com.tencent.p106mm.opensdk.modelbiz.IWXChannelJumpInfo;
import com.tencent.p106mm.opensdk.modelbiz.JoinChatroom;
import com.tencent.p106mm.opensdk.modelbiz.OpenWebview;
import com.tencent.p106mm.opensdk.modelbiz.SubscribeMessage;
import com.tencent.p106mm.opensdk.modelbiz.SubscribeMiniProgramMsg;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelBaseJumpInfo;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelJumpMiniProgramInfo;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelJumpUrlInfo;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelOpenFeed;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelOpenLive;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelOpenProfile;
import com.tencent.p106mm.opensdk.modelbiz.WXChannelShareVideo;
import com.tencent.p106mm.opensdk.modelbiz.WXInvoiceAuthInsert;
import com.tencent.p106mm.opensdk.modelbiz.WXLaunchMiniProgram;
import com.tencent.p106mm.opensdk.modelbiz.WXLaunchMiniProgramWithToken;
import com.tencent.p106mm.opensdk.modelbiz.WXLaunchWxaRedirectingPage;
import com.tencent.p106mm.opensdk.modelbiz.WXNontaxPay;
import com.tencent.p106mm.opensdk.modelbiz.WXOpenBusinessView;
import com.tencent.p106mm.opensdk.modelbiz.WXOpenBusinessWebview;
import com.tencent.p106mm.opensdk.modelbiz.WXOpenCustomerServiceChat;
import com.tencent.p106mm.opensdk.modelbiz.WXPayInsurance;
import com.tencent.p106mm.opensdk.modelbiz.WXPreloadMiniProgram;
import com.tencent.p106mm.opensdk.modelbiz.WXPreloadMiniProgramEnvironment;
import com.tencent.p106mm.opensdk.modelbiz.WXQRCodePay;
import com.tencent.p106mm.opensdk.modelmsg.GetMessageFromWX;
import com.tencent.p106mm.opensdk.modelmsg.LaunchFromWX;
import com.tencent.p106mm.opensdk.modelmsg.SendAuth;
import com.tencent.p106mm.opensdk.modelmsg.SendMessageToWX;
import com.tencent.p106mm.opensdk.modelmsg.SendTdiAuth;
import com.tencent.p106mm.opensdk.modelmsg.ShowMessageFromWX;
import com.tencent.p106mm.opensdk.modelmsg.WXMediaMessage;
import com.tencent.p106mm.opensdk.modelmsg.WXMiniProgramObject;
import com.tencent.p106mm.opensdk.modelmsg.WXStateSceneDataObject;
import com.tencent.p106mm.opensdk.modelmsg.WXTextObject;
import com.tencent.p106mm.opensdk.modelmsg.WXWebpageObject;
import com.tencent.p106mm.opensdk.modelpay.JumpToOfflinePay;
import com.tencent.p106mm.opensdk.modelpay.PayResp;
import com.tencent.p106mm.opensdk.modelpay.WXJointPay;
...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = 2;
        Log.m85357d(TAG, "<init>, appId = " + str + ", checkSignature = " + z + ", launchMode = " + i);
        this.context = context;
        this.appId = str;
        this.checkSignature = z;
        this.launchMode = i;
        C14503b.f60971a = context.getApplicationContext();
    }
    ...
    private String getTokenFromWX(Context context) {
        ...
        if (cursorQuery == null || !cursorQuery.moveToFirst()) {
            Log.m85358e(TAG, "getTokenFromWX , token is null , if your app targetSdkVersion >= 30, include 'com.tencent.mm' in a set of <package> elements inside the <queries> element");
            return null;
        }
        String string = cursorQuery.getString(0);
        Log.m85359i(TAG, "getTokenFromWX token is " + string);
        cursorQuery.close();
        return string;
    }

    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        Log.m85359i(TAG, "handleWxInternalRespType, extInfo = " + str);
        try {
            Uri uri = Uri.parse(str);
            String queryParameter = uri.getQueryParameter("wx_internal_resptype");
            Log.m85359i(TAG, "handleWxInternalRespType, respType = " + queryParameter);
            if (C14503b.m85366b(queryParameter)) {
                Log.m85358e(TAG, "handleWxInternalRespType fail, respType is null");
                return false;
            }
            if (queryParameter.equals("subscribemessage")) {
                ...
                if (queryParameter2 != null && queryParameter2.length() > 0) {
                    resp.errCode = C14503b.m85364a(queryParameter2, 0);
                }
                resp.openId = uri.getQueryParameter("openid");
                resp.templateID = uri.getQueryParameter("template_id");
                resp.scene = C14503b.m85364a(uri.getQueryParameter("scene"), 0);
            ...
            if (queryParameter.contains("invoice_auth_insert")) {
                ...
                if (queryParameter3 != null && queryParameter3.length() > 0) {
                    resp2.errCode = C14503b.m85364a(queryParameter3, 0);
                }
            ...
            if (queryParameter.contains("payinsurance")) {
                ...
                if (queryParameter4 != null && queryParameter4.length() > 0) {
                    resp3.errCode = C14503b.m85364a(queryParameter4, 0);
                }
            ...
            if (queryParameter.contains("nontaxpay")) {
                ...
                if (queryParameter5 != null && queryParameter5.length() > 0) {
                    resp4.errCode = C14503b.m85364a(queryParameter5, 0);
                }
            ...
            if (!"subscribeminiprogrammsg".equals(queryParameter) && !"5".equals(queryParameter)) {
                Log.m85358e(TAG, "this open sdk version not support the request type");
                return false;
            }
            ...
            if (queryParameter6 != null && queryParameter6.length() > 0) {
                resp5.errCode = C14503b.m85364a(queryParameter6, 0);
            }
            ...
            Log.m85358e(TAG, "handleWxInternalRespType fail, ex = " + e.getMessage());
        }
    }
    ...
    private void launchWXUsingPendingIntent() {
        if (this.detached) {
            wtq0.m207906a("openWXApp fail, WXMsgImpl has been detached");
            return;
        }
        if (!isWXAppInstalled()) {
            Log.m85358e(TAG, "openWXApp failed, not installed or signature check failed");
            return;
        }
        try {
            Log.m85359i(TAG, "launchWXUsingPendingIntent");
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), 134217728).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
                ...
                public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i, String str, Bundle bundle) {
                    Log.m85357d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i + ", resultData: " + str);
                }
            }, null);
        } catch (Exception e) {
            Log.m85358e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e.getMessage());
            openWXApp();
        }
    }
    ...
    private boolean sendFinderOpenFeed(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m85359i(TAG, "sendFinderOpenFeed");
    ...
    private boolean sendFinderOpenLive(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m85359i(TAG, "sendFinderOpenLive");
    ...
    private boolean sendFinderOpenProfile(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m85359i(TAG, "sendFinderOpenProfile");
    ...
    private boolean sendFinderShareVideo(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Log.m85359i(TAG, "sendFinderShareVideo");
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            Log.m85357d(TAG, "pay, set wxappPayEntryClassname = " + wxappPayEntryClassname);
            if (wxappPayEntryClassname == null) {
                try {
                    ...
                    Log.m85358e(TAG, "get from metaData failed : " + e.getMessage());
                }
            }
            if (wxappPayEntryClassname == null) {
                Log.m85358e(TAG, "pay fail, wxappPayEntryClassname is null");
                return false;
            }
        }
        ...
        try {
            ...
            Log.m85358e(TAG, "getTokenFromWX fail, exception = " + e2);
        }
    ...
    @Override // com.tencent.p106mm.opensdk.openapi.IWXAPI
    public void detach() {
        Log.m85357d(TAG, "detach");
        this.detached = true;
        this.context = null;
    }
    ...
    public int getWXAppSupportAPI() {
        if (this.detached) {
            wtq0.m207906a("getWXAppSupportAPI fail, WXMsgImpl has been detached");
            return 0;
        }
        if (!isWXAppInstalled()) {
            Log.m85358e(TAG, "open wx app failed, not installed or signature check failed");
            return 0;
        }
        this.wxSdkVersion = 0;
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        C14503b.f60975e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
            ...
            public void run() {
                try {
                    ...
                    Log.m85361w(BaseWXApiImplV10.TAG, e.getMessage());
                }
        ...
        try {
            ...
            Log.m85361w(TAG, e.getMessage());
        }
        Log.m85357d(TAG, "wxSdkVersion = " + this.wxSdkVersion);
        if (this.wxSdkVersion == 0) {
            try {
                ...
                Log.m85357d(TAG, "OPEN_SDK_VERSION = " + this.wxSdkVersion);
            } catch (Exception e2) {
                Log.m85358e(TAG, "get from metaData failed : " + e2.getMessage());
            }
        }
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            if (!WXApiImplComm.isIntentFromWx(intent, ConstantsAPI.Token.WX_TOKEN_VALUE_MSG)) {
                Log.m85359i(TAG, "handleIntent fail, intent not from weixin msg");
                return false;
            }
            if (this.detached) {
            ...
            if (stringExtra2 != null && stringExtra2.length() != 0) {
                if (!checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), C14495a.m85345a(stringExtra, intExtra, stringExtra2))) {
                    Log.m85358e(TAG, "checksum fail");
                    return false;
                }
                int intExtra2 = intent.getIntExtra("_wxapi_command_type", 0);
                Log.m85359i(TAG, "handleIntent, cmd = " + intExtra2);
                switch (intExtra2) {
                    case 1:
                    ...
                    case 4:
                        ...
                        if (str != null && str.contains("wx_internal_resptype")) {
                            ...
                            Log.m85359i(TAG, "handleIntent, extInfo contains wx_internal_resptype, ret = " + zHandleWxInternalRespType);
                            ...
                            try {
                                ...
                                if (uri != null && "openbusinesswebview".equals(uri.getHost())) {
                                    ...
                                    if (queryParameter != null && queryParameter.length() > 0) {
                                        resp.errCode = C14503b.m85364a(queryParameter, 0);
                                    }
                                    resp.resultInfo = uri.getQueryParameter("resultInfo");
                                    resp.errStr = uri.getQueryParameter("errmsg");
                                    String queryParameter2 = uri.getQueryParameter("type");
                                    if (queryParameter2 != null && queryParameter2.length() > 0) {
                                        resp.businessType = C14503b.m85364a(queryParameter2, 0);
                                    }
                                    iWXAPIEventHandler.onResp(resp);
                                    return true;
                                }
                                Log.m85357d(TAG, "not openbusinesswebview %".concat(str));
                            } catch (Exception e) {
                                Log.m85358e(TAG, "parse fail, ex = " + e.getMessage());
                            }
                        }
                    ...
                    case 23:
                    default:
                        Log.m85358e(TAG, "unknown cmd = " + intExtra2);
                        break;
                    case 9:
            ...
            Log.m85358e(TAG, "invalid argument");
            return false;
        } catch (Exception e2) {
            Log.m85358e(TAG, "handleIntent fail, ex = " + e2.getMessage());
        }
        return false;
    }
    ...
    public boolean isWXAppInstalled() {
        if (this.detached) {
            wtq0.m207906a("isWXAppInstalled fail, WXMsgImpl has been detached");
            return false;
        }
        try {
    ...
    public boolean openWXApp() {
        ...
        try {
            ...
            Log.m85358e(TAG, "startActivity fail, exception = " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean registerApp(String str, long j) {
        if (this.detached) {
            wtq0.m207906a("registerApp fail, WXMsgImpl has been detached");
            return false;
        }
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m85358e(TAG, "register app failed for wechat app signature check failed");
            return false;
        }
        Log.m85357d(TAG, "registerApp, appId = " + str);
        if (str != null) {
            this.appId = str;
        }
        Log.m85357d(TAG, "registerApp, appId = " + str);
        ...
        Log.m85357d(TAG, "register app " + this.context.getPackageName());
        C14495a.a aVar = new C14495a.a();
        aVar.f60930a = "com.tencent.mm";
        aVar.f60931b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        aVar.f60932c = "weixin://registerapp?appid=" + this.appId;
        aVar.f60933d = j;
        return C14495a.m85343a(this.context, aVar);
    }
    ...
    public boolean sendReq(BaseReq baseReq) {
        ...
        String str2;
        if (this.detached) {
            wtq0.m207906a("sendReq fail, WXMsgImpl has been detached");
            return false;
        }
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m85358e(TAG, "sendReq failed for wechat app signature check failed");
            return false;
        }
        ...
        if (!baseReq.checkArgs()) {
            Log.m85358e(TAG, "sendReq checkArgs fail");
            return false;
        }
        Log.m85359i(TAG, "sendReq, req type = " + baseReq.getType());
        ...
        try {
            ...
            Log.m85358e(TAG, "getTokenFromWX fail, exception = " + e);
        }
    ...
    public boolean sendResp(BaseResp baseResp) {
        if (this.detached) {
            wtq0.m207906a("sendResp fail, WXMsgImpl has been detached");
            return false;
        }
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m85358e(TAG, "sendResp failed for wechat app signature check failed");
            return false;
        }
        if (!baseResp.checkArgs()) {
            Log.m85358e(TAG, "sendResp checkArgs fail");
            return false;
        }
        Bundle bundle = new Bundle();
    ...
    public void unregisterApp() {
        if (this.detached) {
            wtq0.m207906a("unregisterApp fail, WXMsgImpl has been detached");
            return;
        }
        if (!WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            Log.m85358e(TAG, "unregister app failed for wechat app signature check failed");
            return;
        }
        Log.m85357d(TAG, "unregisterApp, appId = " + this.appId);
        String str = this.appId;
        if (str == null || str.length() == 0) {
            Log.m85358e(TAG, "unregisterApp fail, appId is empty");
            return;
        }
        Log.m85357d(TAG, "unregister app " + this.context.getPackageName());
        C14495a.a aVar = new C14495a.a();
        aVar.f60930a = "com.tencent.mm";
        aVar.f60931b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        aVar.f60932c = "weixin://unregisterapp?appid=" + this.appId;
        C14495a.m85343a(this.context, aVar);
    }
