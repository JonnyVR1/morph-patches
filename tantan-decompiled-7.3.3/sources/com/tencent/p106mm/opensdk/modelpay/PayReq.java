...
public class PayReq extends BaseReq {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C14495a.m85342a(bundle, "_wxapi_payoptions_callback_classname");
            this.callbackFlags = C14495a.m85340a(bundle, "_wxapi_payoptions_callback_flags", -1);
        }
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.appId = C14495a.m85342a(bundle, "_wxapi_payreq_appid");
        this.partnerId = C14495a.m85342a(bundle, "_wxapi_payreq_partnerid");
        this.prepayId = C14495a.m85342a(bundle, "_wxapi_payreq_prepayid");
        this.nonceStr = C14495a.m85342a(bundle, "_wxapi_payreq_noncestr");
        this.timeStamp = C14495a.m85342a(bundle, "_wxapi_payreq_timestamp");
        this.packageValue = C14495a.m85342a(bundle, "_wxapi_payreq_packagevalue");
        this.sign = C14495a.m85342a(bundle, "_wxapi_payreq_sign");
        this.extData = C14495a.m85342a(bundle, "_wxapi_payreq_extdata");
        this.signType = C14495a.m85342a(bundle, "_wxapi_payreq_sign_type");
