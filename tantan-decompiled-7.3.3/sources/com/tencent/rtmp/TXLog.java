...
public class TXLog {
    ...
    public static void m85708d(String str, String str2) {
        wrietLogMessage(1, str, str2);
    }

    /* JADX INFO: renamed from: e */
    public static void m85709e(String str, String str2) {
        wrietLogMessage(4, str, str2);
    }

    /* JADX INFO: renamed from: i */
    public static void m85710i(String str, String str2) {
        wrietLogMessage(2, str, str2);
    }

    /* JADX INFO: renamed from: w */
    public static void m85711w(String str, String str2) {
