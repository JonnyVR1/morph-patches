...
public class TraeAudioSession extends BroadcastReceiver {
        ...
        if (context != null) {
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m85773e("TRAE", 2, "registerReceiver Exception: " + e.getMessage());
                }
            }
        }
        registerAudioSession(this, true);
        if (QLog.isColorLevel()) {
            QLog.m85778w("TRAE", 2, "TraeAudioSession create, mSessionId: " + this.mSessionId);
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            if (intent2 == null) {
                if (QLog.isColorLevel()) {
                    QLog.m85778w("TRAE", 2, "[ERROR] intent = null!!");
                    return;
                }
                return;
            }
            ...
            if (zEquals) {
                if (TraeAudioManager.NOTIFY_SERVICE_STATE.equals(stringExtra)) {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.m85778w("TRAE", 2, "AudioSession|[onServiceStateUpdate]".concat(booleanExtra ? "on" : BLiveOperationTitleShowType.off));
                    }
                ...
                try {
                    if (TraeAudioManager.NOTIFY_DEVICELIST_UPDATE.equals(stringExtra)) {
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.m85778w("TRAE", 2, "AudioSession|[onDeviceListUpdate]  connected:" + stringExtra2 + " prevConnected:" + stringExtra3 + " bt:" + stringExtra4 + " Num:" + stringArrayExtra.length + str3);
                        }
                    ...
                    if (TraeAudioManager.NOTIFY_DEVICECHANGABLE_UPDATE.equals(stringExtra)) {
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.m85778w("TRAE", 2, "AudioSession|[onDeviceChangabledUpdate]" + booleanExtra2);
                        }
                    ...
                    if (TraeAudioManager.NOTIFY_STREAMTYPE_UPDATE.equals(stringExtra)) {
                        ...
                        if (intExtra != 0 && QLog.isColorLevel()) {
                            QLog.m85778w("TRAE", 2, "AudioSession|[onStreamTypeUpdate] err:" + intExtra + " st:" + intExtra2);
                        }
                    ...
                    str = "TRAE";
                    if (QLog.isColorLevel()) {
                        QLog.m85773e(str, 2, "AudioSession| nSessinId = " + this.mSessionId + " onReceive::intent:" + intent2.toString() + " intent.getAction():" + intent2.getAction() + " Exception:" + e.getMessage());
                    }
                }
            }
            try {
                if (TraeAudioManager.ACTION_TRAEAUDIOMANAGER_RES.equals(intent2.getAction()) && this.mSessionId == longExtra) {
                    try {
                        ...
                        if (TraeAudioManager.OPERATION_CONNECTDEVICE.equals(stringExtra)) {
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m85778w("TRAE", 2, "AudioSession|[onConnectDeviceRes] err:" + intExtra + " dev:" + stringExtra11);
                            }
                        ...
                        if (TraeAudioManager.OPERATION_EARACTION.equals(stringExtra)) {
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m85778w("TRAE", 2, "AudioSession|[onConnectDeviceRes] err:" + intExtra + " earAction:" + intExtra3);
                                return;
                            }
                            return;
                        }
                        ...
                        if (TraeAudioManager.OPERATION_GETCONNECTEDDEVICE.equals(stringExtra)) {
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m85778w("TRAE", 2, "AudioSession|[onGetConnectedDeviceRes] err:" + intExtra + " dev:" + stringExtra12);
                            }
                        ...
                        if (TraeAudioManager.OPERATION_GETCONNECTINGDEVICE.equals(stringExtra)) {
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m85778w("TRAE", 2, "AudioSession|[onGetConnectingDeviceRes] err:" + intExtra + " dev:" + stringExtra13);
                            }
                        ...
                        if (TraeAudioManager.OPERATION_GETSTREAMTYPE.equals(stringExtra)) {
                            ...
                            if (QLog.isColorLevel()) {
                                QLog.m85778w("TRAE", 2, "AudioSession|[onGetStreamTypeRes] err:" + intExtra + " st:" + intExtra4);
                            }
                        ...
                        if (!TraeAudioManager.NOTIFY_RING_COMPLETION.equals(stringExtra)) {
                            if (TraeAudioManager.OPERATION_VOICECALL_PREPROCESS.equals(stringExtra)) {
                                if (QLog.isColorLevel()) {
                                    QLog.m85778w("TRAE", 2, "AudioSession|[onVoicecallPreprocess] err:" + intExtra);
                                }
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.m85778w("TRAE", 2, "AudioSession|[onRingCompletion] err:" + intExtra + " userData:" + stringExtra14);
                        }
    ...
    public void onReceiveCallback(Intent intent) {
        try {
            ...
            if (TraeAudioManager.ACTION_TRAEAUDIOMANAGER_RES.equals(intent.getAction()) && this.mSessionId == longExtra && TraeAudioManager.OPERATION_VOICECALL_PREPROCESS.equals(stringExtra)) {
                if (QLog.isColorLevel()) {
                    QLog.m85778w("TRAE", 2, "AudioSession|[onReceiveCallback onVoicecallPreprocess] err:" + intExtra);
                }
                ITraeAudioCallback iTraeAudioCallback = this.mCallback;
                if (iTraeAudioCallback != null) {
            ...
            if (QLog.isColorLevel()) {
                QLog.m85773e("TRAE", 2, "AudioSession| nSessinId = " + this.mSessionId + " onReceive::intent:" + intent.toString() + " intent.getAction():" + intent.getAction() + " Exception:" + e.getMessage());
            }
        }
    }
    ...
    public void release() {
        if (QLog.isColorLevel()) {
            QLog.m85778w("TRAE", 2, "TraeAudioSession release, mSessionId: " + this.mSessionId);
        }
        Context context = this.mContext;
        if (context != null) {
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m85773e("TRAE", 2, "unregisterReceiver failed." + e.getMessage());
                }
            }
        }
