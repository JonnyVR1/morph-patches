...
public class MediaCodecEncoder {
        ...
        try {
            ...
            if (mDumpEnable) {
                ...
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.m85773e(TAG, 2, "open jnirecord.aac file failed.");
                    }
                }
            }
            if (!QLog.isColorLevel()) {
            ...
            QLog.m85778w(TAG, 2, "createAACEncoder succeed!!! : (" + i + ", " + i2 + ", " + i3 + ")");
            return 0;
        } catch (Exception unused2) {
            if (QLog.isColorLevel()) {
                QLog.m85773e(TAG, 2, "create AAC Encoder failed.");
            }
            if (!QLog.isColorLevel()) {
                return -1;
            }
            QLog.m85773e(TAG, 2, "[ERROR] creating aac encode stream failed!!! : (" + i + ", " + i2 + ", " + i3 + ")");
            return -1;
        }
    }
    ...
    public int encodeAACFrame(int i) {
        ...
        if (mDumpEnable && this.mRecFileOut != null) {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m85773e(TAG, 2, "write file failed.");
                }
            }
        }
    ...
    public int encodeInternalAACFrame(int i) {
        try {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m85773e(TAG, 2, "[ERROR] encoding aac stream failed!!!");
                }
                return i3;
            }
        } catch (Exception e) {
            ...
            QLog.m85773e(TAG, 2, "encode failed." + e.getMessage());
            return 0;
        }
    }
    ...
    public int releaseAACEncoder() {
        try {
            ...
            if (mediaCodec != null) {
                ...
                QLog.m85778w(TAG, 2, "releaseAACEncoder, release aac encode stream succeed!!");
                return 0;
            }
        } catch (Exception e) {
            if (QLog.isColorLevel()) {
                QLog.m85773e(TAG, 2, "release aac encoder failed." + e.getMessage());
            }
        }
        if (!QLog.isColorLevel()) {
            return -1;
        }
        QLog.m85773e(TAG, 2, "[ERROR] releaseAACEncoder, release aac encode stream failed!!!");
        return -1;
    }
    ...
    public int setAACEncodeBitrate(int i) {
        ...
        QLog.m85778w(TAG, 2, "Set AAC bitrate = " + i);
        return 0;
    }
