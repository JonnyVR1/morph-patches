        ...
        try {
            ...
            if (mediaCodec != null) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.m85778w(TAG, 2, "createAACDecoder succeed!!! : (" + i + ", " + i2 + ")");
                }
            }
            return 0;
            ...
            QLog.m85773e("TRAE", 2, "Error when creating aac decode stream");
            return -1;
        }
    }
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.m85773e("TRAE", 2, "Error when decoding aac stream");
                    }
                    i = i2;
                }
            } catch (Exception unused2) {
                if (QLog.isColorLevel()) {
                    QLog.m85773e("TRAE", 2, "decode failed.");
                }
                return 0;
            }
        }
    ...
    public int releaseAACDecoder() {
        try {
            ...
            if (mediaCodec != null) {
                ...
                QLog.m85778w(TAG, 2, "releaseAACDecoder, release aac decode stream succeed!!");
                return 0;
            }
        } catch (Exception unused) {
            if (QLog.isColorLevel()) {
                QLog.m85773e("TRAE", 2, "release aac decoder failed.");
            }
        }
        if (!QLog.isColorLevel()) {
            return -1;
        }
        QLog.m85773e("TRAE", 2, "releaseAACDecoder, Error when releasing aac decode stream");
        return -1;
    }
}
