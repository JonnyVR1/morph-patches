...
public final class MediaType {
    ...
    public static final Pattern f57171e = Pattern.compile("([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)/([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)");

    /* JADX INFO: renamed from: f */
    public static final Pattern f57172f = Pattern.compile(";\\s*(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)=(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)|\"([^\"]*)\"))?");
    ...
    public static MediaType get(String str) {
        Matcher matcher = f57171e.matcher(str);
        String str2 = null;
        ...
        Matcher matcher2 = f57172f.matcher(str);
    ...
    public boolean equals(Object obj) {
        return (obj instanceof MediaType) && ((MediaType) obj).f57173a.equals(this.f57173a);
    }
