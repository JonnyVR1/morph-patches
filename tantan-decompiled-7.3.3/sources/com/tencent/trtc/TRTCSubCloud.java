...
public class TRTCSubCloud extends TRTCCloudImpl {
    ...
    private RunnableC14597a mVolumeLevelCalTask;

    /* JADX INFO: renamed from: com.tencent.trtc.TRTCSubCloud$5 */
    public class RunnableC145935 implements Runnable {
        ...
        final /* synthetic */ TRTCCloudListener.TRTCSnapshotListener f61327c;

        public RunnableC145935(String str, int i, TRTCCloudListener.TRTCSnapshotListener tRTCSnapshotListener) {
            this.f61325a = str;
            this.f61326b = i;
            this.f61327c = tRTCSnapshotListener;
        }
        ...
        public void run() {
            ...
            if (this.f61325a != null) {
                TRTCRoomInfo.UserInfo user = ((TRTCCloudImpl) TRTCSubCloud.this).mRoomInfo.getUser(this.f61325a);
                if (this.f61326b == 2) {
                    if (user == null || (renderInfo2 = user.mainRender) == null || renderInfo2.render == null) {
                        videoRender = null;
                    } else {
                        TRTCSubCloud.this.apiLog("snapshotRemoteSubStreamView->userId: " + this.f61325a);
                        videoRender = user.subRender.render.getVideoRender();
                    }
                } else if (user == null || (renderInfo = user.mainRender) == null || renderInfo.render == null) {
                    videoRender = null;
                } else {
                    TRTCSubCloud.this.apiLog("snapshotRemoteView->userId: " + this.f61325a);
                    videoRender = user.mainRender.render.getVideoRender();
                }
                if (videoRender != null) {
                    videoRender.m85101a(new InterfaceC14185o() { // from class: com.tencent.trtc.TRTCSubCloud.5.1
                        ...
                        public void onTakePhotoComplete(final Bitmap bitmap) {
                            TRTCSubCloud.this.runOnListenerThread(new Runnable() { // from class: com.tencent.trtc.TRTCSubCloud.5.1.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    TRTCCloudListener.TRTCSnapshotListener tRTCSnapshotListener = RunnableC145935.this.f61327c;
    ...
    public static class RunnableC14597a implements Runnable {

        /* JADX INFO: renamed from: a */
        private WeakReference<TRTCSubCloud> f61341a;

        public RunnableC14597a(TRTCSubCloud tRTCSubCloud) {
            this.f61341a = new WeakReference<>(tRTCSubCloud);
        }

        @Override // java.lang.Runnable
        public void run() {
            WeakReference<TRTCSubCloud> weakReference = this.f61341a;
    ...
    public TRTCSubCloud(Context context, WeakReference<TRTCCloudImpl> weakReference, HandlerC14214e handlerC14214e) {
        super(context, handlerC14214e);
    ...
    public void destroy() {
        runOnSDKThread(new Runnable() { // from class: com.tencent.trtc.TRTCSubCloud.1
            ...
            public void run() {
                ...
                C14143a.m83848a().m83849a(TRTCSubCloud.this.hashCode());
            }
        });
    }
    ...
    public void enterRoom(TRTCCloudDef.TRTCParams tRTCParams, final int i) {
        ...
        runOnSDKThread(new Runnable() { // from class: com.tencent.trtc.TRTCSubCloud.2
            ...
            public void run() {
                ...
                TRTCSubCloud.this.apiLog("========================================================================================================");
                TRTCSubCloud.this.apiLog(String.format("============= SDK Version:%s Device Name:%s System Version:%s =============", TXCCommonUtil.getSDKVersionStr(), C14215f.m84232c(), C14215f.m84234d()));
                TRTCSubCloud.this.apiLog("========================================================================================================");
                TRTCSubCloud.this.apiLog("========================================================================================================");
                TRTCSubCloud tRTCSubCloud = TRTCSubCloud.this;
                ...
                if (i5 != 0) {
                    if (i5 != 1) {
                        if (i5 == 2) {
                            ...
                            TXCLog.m84156w(TRTCSubCloud.TAG, "enter room scene:%u error! default to VideoCall! " + i + " self:" + TRTCSubCloud.this.hashCode());
                        } else {
                            str5 = "VoiceChatRoom";
                            i5 = 1;
                        }
                ...
                Monitor.m84161a(1, string2, String.format("bussInfo:%s, appScene:%s, role:%s, streamid:%s", str2, str5, i3 == 20 ? "Anchor" : "Audience", tRTCParams2.streamId), 0);
                ...
                tRTCSubCloud5.nativeEnterRoom(((TRTCCloudImpl) tRTCSubCloud5).mNativeRtcContext, j, str11, str7, str9, i3, 255, 0, i, ((TRTCCloudImpl) TRTCSubCloud.this).mPerformanceMode, C14215f.m84232c(), C14215f.m84234d(), ((TRTCCloudImpl) TRTCSubCloud.this).mRecvMode, str13, str15);
    ...
    public void exitRoomInternal(boolean z, String str) {
        ...
        this.mRoomInfo.forEachUser(new TRTCRoomInfo.UserAction() { // from class: com.tencent.trtc.TRTCSubCloud.4
            ...
            public void accept(String str2, TRTCRoomInfo.UserInfo userInfo) {
                ...
                C14143a.m83848a().m83850a(String.valueOf(userInfo.tinyID), TRTCSubCloud.this.hashCode());
    ...
    public void muteLocalAudio(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.trtc.TRTCSubCloud.7
            ...
            public void run() {
                ...
                Monitor.m84161a(1, String.format("muteLocalAudio mute:%b", Boolean.valueOf(z)) + " self:" + TRTCSubCloud.this.hashCode(), "", 0);
    ...
    public void muteLocalVideo(final boolean z) {
        runOnSDKThread(new Runnable() { // from class: com.tencent.trtc.TRTCSubCloud.6
            ...
            public void run() {
                ...
                Monitor.m84161a(1, String.format("muteLocalVideo mute:%b", Boolean.valueOf(z)) + " self:" + TRTCSubCloud.this.hashCode(), "", 0);
                TRTCCloudImpl tRTCCloudImpl = TRTCSubCloud.this.mMainCloud.get();
                if (tRTCCloudImpl != null) {
    ...
    public void snapshotVideo(String str, int i, TRTCCloudListener.TRTCSnapshotListener tRTCSnapshotListener) {
        ...
        runOnSDKThread(new RunnableC145935(str, i, tRTCSnapshotListener));
    }
    ...
    public void startVolumeLevelCal(boolean z) {
        ...
        if (!z) {
            ...
            RunnableC14597a runnableC14597a = new RunnableC14597a(this);
            this.mVolumeLevelCalTask = runnableC14597a;
            this.mSDKHandler.postDelayed(runnableC14597a, this.mAudioVolumeEvalInterval);
        }
    }
