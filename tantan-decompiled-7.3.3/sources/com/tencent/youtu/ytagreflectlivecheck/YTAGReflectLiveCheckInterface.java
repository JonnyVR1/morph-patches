...
public class YTAGReflectLiveCheckInterface {
    ...
    public static InterfaceC14668a mReflectNotice;
    ...
    public interface LightLiveCheckResult {
        ...
        void onSuccess(C14667a c14667a);
    }
    ...
    public static void onFinish() {
        ...
        if (dataPack != null) {
            ...
            c14667a.f61671a = rawImgDataArr;
            c14667a.f61672b = j;
            c14667a.f61673c = j2;
            c14667a.f61674d = jArr;
            c14667a.f61675e = f;
            c14667a.f61676f = i;
            c14667a.f61677g = i2;
            c14667a.f61678h = i3;
            c14667a.f61679i = i4;
            c14667a.f61680j = i5;
            c14667a.f61681k = bArr;
        }
        mCheckResult.onSuccess(c14667a);
    }
    ...
    public static void onStateChanged(int i) {
        ...
        try {
            ...
            if (i == 1) {
                InterfaceC14668a interfaceC14668a = mReflectNotice;
                if (interfaceC14668a != null) {
                    ReflectLivenessState.this.f61548k = false;
                    return;
                }
                return;
            }
    ...
    public static void setReflectNotice(InterfaceC14668a interfaceC14668a) {
        mReflectNotice = interfaceC14668a;
    }
