...
public class FileUtils {
    ...
    public static void loadLibrary(String str) {
        if (mLoadedLibrary.get(str) == null) {
            YtLogger.m85810i(TAG, "[YTUtils.loadLibrary] " + System.getProperty("java.library.path"));
                ...
                try {
                    try {
                        ...
                        if (line == null) {
                            try {
                                ...
                                vtq0.m202761a("IOException occurred. ", e2);
                                return null;
                            }
                        }
                    ...
                    if (bufferedReader != null) {
                        try {
                            ...
                            vtq0.m202761a("IOException occurred. ", e4);
                            return null;
                        }
                    }
                    throw th;
                    ...
                    try {
                        ...
                        if (line == null) {
                            try {
                                ...
                                vtq0.m202761a("IOException occurred. ", e);
                                return null;
                            }
                        }
                        if (!sb.toString().equals("")) {
