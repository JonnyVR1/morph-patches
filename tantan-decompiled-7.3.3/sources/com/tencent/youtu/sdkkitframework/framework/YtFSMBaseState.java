...
public abstract class YtFSMBaseState {
    ...
    public void enter() {
        ...
        YtLogger.m85808d(TAG, this.stateName + " enter");
    }

    public abstract void enterFirst();

    public void exit() {
        YtLogger.m85808d(TAG, this.stateName + " exit");
    }
    ...
    public void loadStateWith(String str, JSONObject jSONObject, YtSdkConfig ytSdkConfig) {
        ...
        try {
            ...
            YtLogger.m85809e(TAG, "load state with catch error:", e);
            OperateInfoManager.getInstance().setCatchErrorData(Log.getStackTraceString(e));
        }
        YtLogger.m85810i(TAG, "load " + this.stateSimpleName);
    ...
    public JSONObject makeStateInfo(String str, int i) {
        ...
        try {
            ...
            YtLogger.m85809e(TAG, "make log info error", e);
            return jSONObject;
        }
    }

    public void moveToNextState() {
        YtLogger.m85808d(TAG, this.stateName + " move to next");
    }
    ...
    public void reset() {
        ...
        YtLogger.m85810i(TAG, this.stateName + " reset");
    }
    ...
    public void unload() {
        YtLogger.m85810i(TAG, "unload " + this.stateSimpleName);
        this.stateData.clear();
    }
    ...
    public void update(YTImageData yTImageData, long j) {
        ...
        if (System.currentTimeMillis() - this.printFrameLogTime > 2000) {
            ...
            YtLogger.m85808d(TAG, this.stateName + " update bgr image width:" + yTImageData.getWidth() + ",height:" + yTImageData.height);
        }
    }
