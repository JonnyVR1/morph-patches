...
public class C14655f extends HashMap<String, Object> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ Exception f61643a;

    public C14655f(NetLivenessReqResultState netLivenessReqResultState, Exception exc) {
        this.f61643a = exc;
