...
public class C14664o {

    /* JADX INFO: renamed from: a */
    public static int f61652a;

    /* JADX INFO: renamed from: b */
    public static int f61653b;
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: b */
        public final float f61655b;

        /* JADX INFO: renamed from: c */
        public final float f61656c;

        /* JADX INFO: renamed from: d */
        public final float f61657d;

        /* JADX INFO: renamed from: e */
        public final float f61658e;
    ...
    /* JADX INFO: renamed from: a */
    public static int m85846a(float[] fArr, a aVar) {
        if (fArr == null) {
            YtLogger.m85809e("o", "[YTFaceTraceInterface.blockJudge] input pointsVis is null.", null);
            return -1;
        }
        if (fArr.length != 90) {
            YtLogger.m85809e("o", "[YTFaceTraceInterface.blockJudge] input pointsVis.length != 90. current pointsVis.length: " + fArr.length, null);
            return -2;
        }
        int i = 0;
        ...
        if (i2 >= 4) {
            ...
            YtLogger.m85811o("o", m85850a("SHELTER_NOSE", stringBuffer.toString(), aVar2.f61655b));
            return 5;
        }
        int i6 = 0;
        for (int i7 = 46; i7 <= 67; i7++) {
            if (fArr[i7 - 1] < aVar2.f61657d) {
                i6++;
            }
        }
        if (i6 >= 4) {
            ...
            YtLogger.m85811o("o", m85850a("SHELTER_MOUTH", stringBuffer2.toString(), aVar2.f61657d));
            return 3;
        }
        int i10 = 0;
        for (int i11 = 9; i11 <= 16; i11++) {
            if (fArr[i11 - 1] < aVar2.f61658e) {
                i10++;
            }
        }
        for (int i12 = 25; i12 <= 32; i12++) {
            if (fArr[i12 - 1] < aVar2.f61658e) {
                i10++;
            }
        }
        if (fArr[89] < aVar2.f61658e) {
            i10++;
        }
        if (i10 >= 4) {
            return 6;
        ...
        for (int i14 = 1; i14 <= 8; i14++) {
            if (fArr[i14 - 1] < aVar2.f61658e) {
                i13++;
            }
        }
        for (int i15 = 17; i15 <= 24; i15++) {
            if (fArr[i15 - 1] < aVar2.f61658e) {
                i13++;
            }
        }
        if (fArr[88] < aVar2.f61658e) {
            i13++;
        }
        if (i13 >= 4) {
            return 7;
        ...
        if (i16 >= 3) {
            ...
            YtLogger.m85811o("o", m85850a("SHELTER_LEFT_FACE", stringBuffer3.toString(), aVar2.f61654a));
            return 1;
        }
        int i22 = i19;
        for (int i23 = 82; i23 <= 88; i23++) {
            if (fArr[i23 - 1] < aVar2.f61654a) {
                i22++;
            }
        }
        if (i22 >= 3) {
            ...
            YtLogger.m85811o("o", m85850a("SHELTER_RIGHT_FACE", stringBuffer4.toString(), aVar2.f61654a));
            return 4;
        }
        int i26 = i19;
        for (int i27 = 75; i27 <= 81; i27++) {
            if (fArr[i27 - 1] < aVar2.f61656c) {
                i26++;
            }
        }
        if (i26 < 3) {
        ...
        YtLogger.m85811o("o", m85850a("SHELTER_CHIN", stringBuffer5.toString(), aVar2.f61656c));
        return 2;
    }

    /* JADX INFO: renamed from: b */
    public static String m85857b(int i) {
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: a */
    public static YTFaceTracker.TrackedFace[] m85856a(YTFaceTracker.TrackedFace[] trackedFaceArr) {
    ...
    /* JADX INFO: renamed from: a */
    public static Rect m85848a(YTFaceTracker.TrackedFace trackedFace) {
        float[] fArr = trackedFace.faceShape;
        float f = fArr[0];
        float fMax = fArr[1];
        float fMin = f;
    ...
    /* JADX INFO: renamed from: a */
    public static Rect m85847a(Rect rect, Rect rect2) {
        return new Rect(Math.max(rect.left, rect2.left), Math.max(rect.top, rect2.top), Math.min(rect.right, rect2.right), Math.min(rect.bottom, rect2.bottom));
    }

    /* JADX INFO: renamed from: a */
    public static String m85849a(int i) {
        if (i == 4) {
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m85854a(YTFaceTracker.TrackedFace trackedFace, float f, float f2, float f3) {
        ...
        if (!z) {
            ...
            try {
                ...
                YtLogger.m85809e("o", "make log json error", e);
            }
            YtLogger.m85811o("o", jSONObject);
        }
        return z;
    }

    /* JADX INFO: renamed from: a */
    public static JSONArray m85852a(Rect rect) {
    ...
    /* JADX INFO: renamed from: a */
    public static JSONArray m85853a(float[] fArr, boolean z) {
        JSONArray jSONArray = new JSONArray();
        for (float f : fArr) {
            if (z) {
                f *= 100.0f;
    ...
    /* JADX INFO: renamed from: a */
    public static String m85851a(YTFaceTracker.TrackedFace[] trackedFaceArr, int i, int i2) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("TraceType", "FaceTracker");
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("detect_rect", m85852a(YtSDKKitFramework.getInstance().getDetectRect()));
            ...
            if (trackedFaceArr != null) {
                for (YTFaceTracker.TrackedFace trackedFace : trackedFaceArr) {
                    ...
                    jSONObject3.put("rect", m85852a(trackedFace.faceRect));
                    jSONObject3.put("points", m85853a(trackedFace.faceShape, false));
                    jSONObject3.put("visible", m85853a(trackedFace.faceVisible, true));
            ...
            jSONObject.put("TraceData", jSONObject2);
            YtLogger.m85808d("o", "TraceJson: " + jSONObject);
            jSONObject.put("TraceData", Base64.encodeToString(m85855a(jSONObject2.toString()), 2));
        } catch (JSONException e) {
            YtLogger.m85809e("o", "make log info error", e);
        }
    ...
    /* JADX INFO: renamed from: a */
    public static byte[] m85855a(String str) throws Throwable {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                YtLogger.m85809e("o", " gzip.close(): ", e);
                                return byteArray;
                            }
                        } catch (IOException e2) {
                            e = e2;
                            YtLogger.m85809e("o", "compress Exception e: ", e);
                            if (gZIPOutputStream != null) {
                                try {
                                    gZIPOutputStream.close();
                                } catch (IOException e3) {
                                    YtLogger.m85809e("o", " gzip.close(): ", e3);
                                }
                            }
                            return null;
                        }
                        ...
                        if (outputStream2 != null) {
                            try {
                                ...
                                YtLogger.m85809e("o", " gzip.close(): ", e5);
                            }
                        }
                        throw th;
                    }
    ...
    /* JADX INFO: renamed from: a */
    public static String m85850a(String str, String str2, float f) {
        JSONObject jSONObject = new JSONObject();
        try {
        ...
        try {
            ...
            YtLogger.m85809e("o", "make log info error", e2);
        }
