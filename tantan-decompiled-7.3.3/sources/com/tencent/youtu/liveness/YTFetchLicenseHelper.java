...
public class YTFetchLicenseHelper {
    ...
    public class C1FetchThreadRunnable implements Runnable {
        ...
        public FetchLicenseResult f61350a;

        /* JADX INFO: renamed from: b */
        public final /* synthetic */ String f61351b;
        ...
        public final /* synthetic */ String f61355f;

        /* JADX INFO: renamed from: g */
        public final /* synthetic */ String f61356g;
        ...
        public C1FetchThreadRunnable(String str, String str2, String str3, String str4, String str5, String str6, String str7) {
            ...
            this.f61356g = str6;
            this.f61357h = str7;
            this.f61350a = new FetchLicenseResult(YTFetchLicenseHelper.this);
        }
        ...
        public void run() throws Throwable {
            ...
            try {
                try {
                    ...
                    String str = this.f61351b + "-" + jCurrentTimeMillis;
                    Mac mac = Mac.getInstance("HmacSHA256");
                    mac.init(new SecretKeySpec(this.f61352c.getBytes(), "HmacSHA256"));
                    String strEncodeToString = Base64.encodeToString(mac.doFinal(str.getBytes()), 2);
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(Constants.JumpUrlConstants.URL_KEY_APPID, this.f61351b);
                    jSONObject.put("auth_string", strEncodeToString);
                    jSONObject.put("machine_type", this.f61353d);
                    jSONObject.put("machine_id", this.f61354e);
                    jSONObject.put("machine_info", this.f61355f);
                    jSONObject.put("package_name", this.f61356g);
                    jSONObject.put("time_stamp", jCurrentTimeMillis);
                    String string = jSONObject.toString();
                    httpsURLConnection = (HttpsURLConnection) new URL(this.f61357h).openConnection();
                    try {
                        ...
                        this.f61350a.http_status = httpsURLConnection.getResponseCode();
                        if (this.f61350a.http_status == 200) {
                            ...
                            try {
                                ...
                                if (jSONObject2.has(StateEvent.Name.ERROR_CODE)) {
                                    this.f61350a.error_code = jSONObject2.optInt(StateEvent.Name.ERROR_CODE);
                                    this.f61350a.error_msg = jSONObject2.optString("error_msg");
                                    FetchLicenseResult fetchLicenseResult = this.f61350a;
                                    if (fetchLicenseResult.error_code == 0) {
                                        fetchLicenseResult.license = jSONObject2.optString("license");
                                        this.f61350a.bind_type = jSONObject2.optString("bind_type");
                                        this.f61350a.auth_type = jSONObject2.optString("auth_type");
                                    }
                                }
                            ...
                            Log.e("YTCommon_FetchLicense", "connection status: " + this.f61350a.http_status);
                        }
                        if (bufferedReader != null) {
                            try {
                                bufferedReader.close();
    ...
    public FetchLicenseResult fetchLicenseOnline(Context context, String str, String str2, String str3, YTDeviceInfo yTDeviceInfo) {
        ...
        return c1FetchThreadRunnable.f61350a;
    }
}
