...
public class JsonCallBackListener implements CallBackListener {
    ...
    public IJsonDataListener f58140a;

    /* JADX INFO: renamed from: b */
    public Handler f58141b = new Handler(Looper.getMainLooper());

    public JsonCallBackListener(IJsonDataListener iJsonDataListener) {
        this.f58140a = iJsonDataListener;
    }

    @Override // com.tencent.could.component.common.p084ai.net.CallBackListener
    ...
    public void onFailed(final String str) {
        this.f58141b.post(new Runnable() { // from class: com.tencent.could.component.common.ai.net.JsonCallBackListener.3
            @Override // java.lang.Runnable
            public void run() {
                IJsonDataListener iJsonDataListener = JsonCallBackListener.this.f58140a;
    ...
    public void onSuccess(InputStream inputStream, boolean z) {
        ...
        this.f58141b.post(new Runnable() { // from class: com.tencent.could.component.common.ai.net.JsonCallBackListener.1
            @Override // java.lang.Runnable
            public void run() {
                IJsonDataListener iJsonDataListener = JsonCallBackListener.this.f58140a;
                if (iJsonDataListener != null) {
    ...
    public void onSuccess(final String str) {
        this.f58141b.post(new Runnable() { // from class: com.tencent.could.component.common.ai.net.JsonCallBackListener.2
            @Override // java.lang.Runnable
            public void run() {
                IJsonDataListener iJsonDataListener = JsonCallBackListener.this.f58140a;
                if (iJsonDataListener != null) {
