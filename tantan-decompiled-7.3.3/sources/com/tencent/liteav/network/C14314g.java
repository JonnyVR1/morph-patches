...
public class C14314g {

    /* JADX INFO: renamed from: a */
    private final int f60380a = 5;

    /* JADX INFO: renamed from: b */
    private final int f60381b = 2;

    /* JADX INFO: renamed from: c */
    private String f60382c = "";

    /* JADX INFO: renamed from: d */
    private String f60383d = "";

    /* JADX INFO: renamed from: e */
    private int f60384e = 0;

    /* JADX INFO: renamed from: f */
    private String f60385f = "";

    /* JADX INFO: renamed from: g */
    private Handler f60386g;

    /* JADX INFO: renamed from: com.tencent.liteav.network.g$a */
    public interface a {
        /* JADX INFO: renamed from: a */
        void mo84854a(int i, String str, Vector<C14312e> vector);
    }

    public C14314g(Context context) {
        if (context != null) {
            this.f60386g = new Handler(context.getMainLooper());
        }
    }
    ...
    /* JADX INFO: renamed from: e */
    public long m84911e() {
        return C14188c.m84036a().m84061a("Network", "AccRetryCountWithoutSecret");
    }

    /* JADX INFO: renamed from: a */
    public int m84912a(String str, int i, final a aVar) {
        this.f60382c = "";
        this.f60383d = "";
        this.f60384e = 0;
        this.f60385f = "";
        ...
        final String strM84904a = m84904a("bizid", str);
        final String strM84904a2 = m84904a("txSecret", str);
        final String strM84904a3 = m84904a("txTime", str);
        if (!m84907a(true, strM84904a, strM84904a3, strM84904a2)) {
            return -3;
        }
        m84905a(streamIDByStreamUrl, strM84904a, strM84904a2, strM84904a3, i, new a() { // from class: com.tencent.liteav.network.g.1
            @Override // com.tencent.liteav.network.C14314g.a
            /* JADX INFO: renamed from: a */
            public void mo84854a(int i2, String str2, Vector<C14312e> vector) {
                C14314g.this.f60382c = streamIDByStreamUrl;
                C14314g.this.f60383d = strM84904a;
                C14314g.this.f60384e = i2;
                C14314g.this.f60385f = str2;
                if (vector == null || vector.isEmpty()) {
                    a aVar2 = aVar;
                    if (aVar2 != null) {
                        aVar2.mo84854a(i2, str2, null);
                        return;
                    }
                    return;
                }
                Vector<C14312e> vector2 = new Vector<>();
                for (C14312e c14312e : vector) {
                    String strSubstring = c14312e.f60378a;
                    if (strSubstring.indexOf("?") != -1) {
                        strSubstring = strSubstring.substring(0, strSubstring.indexOf("?"));
                    }
                    vector2.add(new C14312e(strSubstring + "?txSecret=" + strM84904a2 + "&txTime=" + strM84904a3 + "&bizid=" + strM84904a, c14312e.f60379b));
                }
                if (aVar != null) {
                    for (C14312e c14312e2 : vector2) {
                        TXCLog.m84149e("TXRTMPAccUrlFetcher", "accurl = " + c14312e2.f60378a + " quic = " + c14312e2.f60379b);
                    }
                    aVar.mo84854a(i2, str2, vector2);
                }
            }
        });
        return 0;
    ...
    /* JADX INFO: renamed from: b */
    public String m84914b() {
        return this.f60383d;
    }

    /* JADX INFO: renamed from: a */
    public String m84913a() {
        return this.f60382c;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: a */
    public boolean m84907a(boolean z, String str, String str2, String str3) {
        if (z) {
    ...
    /* JADX INFO: renamed from: a */
    private void m84905a(final String str, final String str2, final String str3, final String str4, final int i, final a aVar) {
        new Thread("getRTMPAccUrl") { // from class: com.tencent.liteav.network.g.2
            ...
            public void run() {
                ...
                ?? r14 = 1;
                if (!C14314g.this.m84907a(true, str2, str4, str3)) {
                    iM84911e = (int) C14314g.this.m84911e();
                    if (iM84911e <= 0) {
                        iM84911e = 1;
                        i2 = 1;
                    }
                    ...
                    while (i4 >= r14) {
                        try {
                            try {
                                ...
                                r8.setHostnameVerifier(TXHttpRequest.C14208c.f59332a);
                                r8.setDoOutput(r14);
                                r8.setDoInput(r14);
                                r8.setUseCaches(z2);
                                ...
                                TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl: sendHttpRequest[ " + string3 + "] retryIndex = " + i4);
                                ...
                                TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl: receive response, strResponse = " + str8);
                                ...
                                if (i3 != 0) {
                                    ...
                                    TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl: errorCode = " + i3 + " errorMessage = " + string);
                                }
                                if (jSONObject.has(str9)) {
                                    ...
                                    if (jSONArray == null) {
                                        try {
                                            if (jSONArray.length() == 0) {
                                                str5 = str9;
                                                str6 = str10;
                                                TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl: no pull_addr");
                                            } else {
                                                i5 = 0;
                                                    ...
                                                    if (jSONObject2 != null) {
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                sb.append(" Q channel = ");
                                                                sb.append(z);
                                                                TXCLog.m84149e("TXRTMPAccUrlFetcher", sb.toString());
                                                                ...
                                                                if (streamIDByStreamUrl == null && streamIDByStreamUrl.equalsIgnoreCase(str)) {
                                                                    if (z) {
                                                                        vector.add(new C14312e(string2, z));
                                                                    } else {
                                                                        vector2.add(new C14312e(string2, z));
                                                                    }
                                                                }
                                                            } catch (Exception e) {
                                                                e = e;
                                                                r11 = 1;
                                                                TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl exception:" + e.toString());
                                                                r12 = r11;
                                                                z2 = false;
                                    ...
                                    if (i6 == 1) {
                                        try {
                                            if (vector2.size() > 0) {
                                                C14314g.this.f60386g.post(new Runnable() { // from class: com.tencent.liteav.network.g.2.1
                                                    @Override // java.lang.Runnable
                                                    public void run() {
                                                        a aVar2 = aVar;
                                                        if (aVar2 != null) {
                                                            aVar2.mo84854a(0, "Success", vector2);
                                                        }
                                                    }
                                                });
                                                return;
                                        ...
                                        try {
                                            if (vector.size() > 0) {
                                                C14314g.this.f60386g.post(new Runnable() { // from class: com.tencent.liteav.network.g.2.2
                                                    @Override // java.lang.Runnable
                                                    public void run() {
                                                        a aVar2 = aVar;
                                                        if (aVar2 != null) {
                                                            aVar2.mo84854a(0, "Success", vector);
                                                        }
                                                    }
                                                });
                                                return;
                                        ...
                                        it = vector2.iterator();
                                        while (it.hasNext()) {
                                            vector.add((C14312e) it.next());
                                        }
                                        if (vector.size() > 0) {
                                            C14314g.this.f60386g.post(new Runnable() { // from class: com.tencent.liteav.network.g.2.3
                                                @Override // java.lang.Runnable
                                                public void run() {
                                                    a aVar2 = aVar;
                                                    if (aVar2 != null) {
                            ...
                            TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl exception sleep");
                        }
                        z2 = false;
                        i4--;
                        str9 = str5;
                    ...
                    C14314g.this.f60386g.post(new Runnable() { // from class: com.tencent.liteav.network.g.2.4
                        @Override // java.lang.Runnable
                        public void run() {
                            a aVar2 = aVar;
                            if (aVar2 != null) {
                                aVar2.mo84854a(i3, string, null);
                            }
                        }
                    });
                }
                ...
                while (i4 >= r14) {
                    ...
                    r9.setHostnameVerifier(TXHttpRequest.C14208c.f59332a);
                    r9.setDoOutput(r14);
                    r9.setDoInput(r14);
                    r9.setUseCaches(z2);
                    ...
                    TXCLog.m84149e("TXRTMPAccUrlFetcher", "getAccelerateStreamPlayUrl: sendHttpRequest[ " + string4 + "] retryIndex = " + i4);
                        ...
                        if (jSONArray == null) {
                            ...
                            while (i5 < jSONArray.length()) {
                                ...
                                if (jSONObject2 != null) {
                                    ...
                                    sb2.append(z);
                                    TXCLog.m84149e("TXRTMPAccUrlFetcher", sb2.toString());
                                    streamIDByStreamUrl = TXCCommonUtil.getStreamIDByStreamUrl(string2);
    ...
    /* JADX INFO: renamed from: a */
    private String m84904a(String str, String str2) {
