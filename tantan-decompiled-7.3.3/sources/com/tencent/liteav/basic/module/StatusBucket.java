...
public class StatusBucket {
    ...
    public static void testStatusBucket() {
        ...
        String str = TAG;
        TXCLog.m84149e(str, "test_status_bucket: id:1, key:1, value:" + statusBucket.getBooleanStatus("1", 1));
        TXCLog.m84149e(str, "test_status_bucket: id:1, key:4, value:" + statusBucket.getIntStatus("1", 4));
        TXCLog.m84149e(str, "test_status_bucket: id:2, key:2, value:" + statusBucket.getIntStatus("2", 2));
        TXCLog.m84149e(str, "test_status_bucket: id:3, key:3, value:" + statusBucket.getLongStatus("3", 3));
        TXCLog.m84149e(str, "test_status_bucket: id:5, key:5, value:" + statusBucket.getBooleanStatus("5", 5));
        TXCLog.m84149e(str, "test_status_bucket: id:6, key:6, value:" + statusBucket.getLongStatus(Constants.VIA_SHARE_TYPE_INFO, 6));
    }
