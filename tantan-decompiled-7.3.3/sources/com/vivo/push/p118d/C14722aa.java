...
final class C14722aa extends AbstractC14755z {
    public C14722aa(AbstractC14769o abstractC14769o) {
    ...
    public final void mo85986a(AbstractC14769o abstractC14769o) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            if (arrayList.size() > 0) {
                C14756e.m86032a().m86055a(arrayList);
            }
            C14756e.m86032a().m86051a(c14702t.m85945g(), arrayList3.size() > 0 ? 10000 : iM85946h);
            c14722aa = this;
            C14765m.m86086b(new RunnableC14723ab(c14722aa, iM85946h, arrayList, arrayList3, strM85945g));
        } else {
            c14722aa = this;
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            if (arrayList2.size() > 0) {
                C14756e.m86032a().m86059b((String) arrayList2.get(0));
            }
            C14756e.m86032a().m86051a(c14702t.m85945g(), iM85946h);
            C14765m.m86086b(new RunnableC14724ac(c14722aa, iM85946h, arrayList2, arrayList4, strM85945g));
        }
    }
}
