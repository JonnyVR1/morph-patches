...
public abstract class BasePushMessageReceiver extends BroadcastReceiver implements PushMessageCallback {
    ...
    public boolean isAllowNet(Context context) {
        if (context == null) {
            C14795p.m86179a(TAG, "isAllowNet sContext is null");
            return false;
        }
        String packageName = context.getPackageName();
        if (TextUtils.isEmpty(packageName)) {
            C14795p.m86179a(TAG, "isAllowNet pkgName is null");
            return false;
        }
        ...
        if (listQueryIntentServices != null && listQueryIntentServices.size() > 0) {
            return C14799t.m86201a(context, packageName);
        }
        C14795p.m86179a(TAG, "this is client sdk");
        return true;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        C14756e.m86032a().m86046a(applicationContext);
        C14795p.m86192d(TAG, "PushMessageReceiver " + applicationContext.getPackageName() + " ; requestId = " + intent.getStringExtra("req_id"));
        try {
            C14756e.m86032a().m86047a(intent, this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
