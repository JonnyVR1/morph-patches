...
/* JADX INFO: renamed from: com.vivo.push.util.q */
/* JADX INFO: loaded from: classes2.dex */
public final class C14796q {
    /* JADX INFO: renamed from: a */
    public static InsideNotificationItem m86194a(String str) {
        InsideNotificationItem insideNotificationItem = new InsideNotificationItem();
        try {
            if (TextUtils.isEmpty(str)) {
                C14795p.m86179a("MessageConvertUtil", "notify msg pack to obj is null");
                return null;
            }
            ...
            if (jSONArray.length() > 11) {
                insideNotificationItem.setParams(C14792m.m86164a(new JSONObject(jSONArray.getString(11))));
            }
            ...
            C14795p.m86180a("MessageConvertUtil", "notify msg pack to obj error", e);
            return insideNotificationItem;
        }
    }

    /* JADX INFO: renamed from: b */
    public static String m86196b(InsideNotificationItem insideNotificationItem) {
        ...
        if (insideNotificationItem.getParams() != null) {
            ...
            jSONArray.put(WeJson.EMPTY_MAP);
        }
    ...
    /* JADX INFO: renamed from: a */
    public static UPSNotificationMessage m86195a(InsideNotificationItem insideNotificationItem) {
