...
public class ContextDelegate {
    ...
    public static class C14779a {

        /* JADX INFO: renamed from: a */
        private static ContextDelegate f61942a = new ContextDelegate();
    }
    ...
    public static ContextDelegate getInstance() {
        return C14779a.f61942a;
    }

    public static boolean isFBEProject() {
        if (mIsFbeProject == null) {
            try {
                mIsFbeProject = Boolean.valueOf("file".equals(C14789j.m86155a("ro.crypto.type", CardButtonsShowAndHideType.unknow)));
                C14795p.m86186b(TAG, "mIsFbeProject = " + mIsFbeProject.toString());
            } catch (Exception e) {
                C14795p.m86179a(TAG, "mIsFbeProject = " + e.getMessage());
            }
        }
