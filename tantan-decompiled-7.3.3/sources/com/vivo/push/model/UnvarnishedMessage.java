...
import com.vivo.push.util.C14792m;
    ...
    private void packToObj(String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                C14795p.m86179a(TAG, "unvarnishedMsg pack to obj is null");
                return;
            }
            ...
            this.mParams = C14792m.m86164a(new JSONObject(jSONArray.getString(3)));
        } catch (JSONException e) {
            e.printStackTrace();
            C14795p.m86180a(TAG, "unvarnishedMsg pack to obj error", e);
        }
    }
