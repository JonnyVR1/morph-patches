...
public abstract class GLRenderer extends Thread {
    ...
    private boolean makeOutputSurface(GLSurface gLSurface) {
        try {
            ...
            if (i == 0) {
                ...
                if (i != 1) {
                    if (i == 2) {
                        MDLog.m7453w("mediaRender", "nonsupport pixmap surface");
                        return false;
                    }
                    MDLog.m7453w("mediaRender", "surface type error " + gLSurface.type);
                    return false;
                }
            ...
            MDLog.m7445e("mediaRender", "can't create eglSurface");
    ...
    private void render() {
        for (GLSurface gLSurface : this.outputSurfaces) {
            if (gLSurface.eglSurface != EGL14.EGL_NO_SURFACE || makeOutputSurface(gLSurface)) {
                ...
                GLSurface.Viewport viewport = gLSurface.viewport;
                GLES20.glViewport(viewport.f5770x, viewport.f5771y, viewport.width, viewport.height);
    ...
    public void addSurface(@NonNull GLSurface gLSurface) {
        ...
        MDLog.m7445e("mediaRender", "queue full");
    }
    ...
    public void run() {
        MDLog.m7443d("mediaRender", getName() + ": render create");
        createGL();
        onCreated();
            ...
            try {
                ...
                switch (eventTake.event) {
                    ...
                    case 7:
                        ...
                        break;
                    default:
                        MDLog.m7445e("mediaRender", "event error: " + eventTake);
                        break;
                }
            } catch (InterruptedException e) {
                e.printStackTrace();
        ...
        MDLog.m7443d("mediaRender", getName() + ": render release");
    }

    @Override // java.lang.Thread
    public void start() {
        MDLog.m7453w("mediaRender", "Don't call this function");
    }
