...
public class HandSegmentHelper {
    ...
    public static void dispatchSegmentInfo(HandsgInfo handsgInfo, omw omwVar) {
        float[] fArr;
        ...
        cvSegmentInfo.setFlipShowX(omwVar.f148014a);
    ...
    public static HandsgInfo process(umw umwVar, lnw lnwVar, omw omwVar) {
            ...
            try {
                ...
                try {
                    ...
                    if (!segmentation.LoadModel(modelBuff)) {
                        MDLog.m7445e(TAG, "The HandSegment mode lode failed !!!");
                    }
                    try {
                    ...
                    try {
                        ...
                        if (modelBuff != null) {
                            ...
                            BaseParams baseParamsM155008c = lnwVar.m155008c();
                            baseParamsM155008c.fliped_show_ = omwVar.f148014a;
                            omwVar.m168285B(baseParamsM155008c);
                            segmentation.ProcessFrame(umwVar.m196796b(), (HandsgParams) baseParamsM155008c, info);
                        }
                        return info;
                    } catch (Throwable th3) {
                        if (fileInputStream != null) {
                            try {
                                ...
                                MDLog.m7445e(TAG, "The HandSegment mode lode failed !!!" + e3.toString());
                            }
                        }
                        throw th3;
                    }
        ...
        if (modelBuff != null) {
            ...
            BaseParams baseParamsM155008c2 = lnwVar.m155008c();
            baseParamsM155008c2.fliped_show_ = omwVar.f148014a;
            omwVar.m168285B(baseParamsM155008c2);
            segmentation.ProcessFrame(umwVar.m196796b(), (HandsgParams) baseParamsM155008c2, info);
        }
        return info;
    }

    public static HandsgInfo processInfo(umw umwVar, lnw lnwVar) {
        return process(umwVar, lnwVar, null);
    }
    ...
    public static void release() {
        ...
        cvSegmentInfo = null;
        MDLog.m7449i(TAG, "HandSegmentHelper release !!!");
    }
