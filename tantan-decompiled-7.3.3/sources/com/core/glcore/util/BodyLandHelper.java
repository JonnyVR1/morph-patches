...
public class BodyLandHelper {
    ...
    public static synchronized void process(umw umwVar, lnw lnwVar, BodyLandmarkPostInfo bodyLandmarkPostInfo) {
        try {
            if (modelPath != null && bodyLandmarkPostInfo != null) {
                ...
                if (bodyLandmark3 != null) {
                    bodyLandmark3.ProcessFrame(umwVar.m196796b(), (BodyLandmarkParams) lnwVar.m155008c(), bodyLandmarkPostInfo);
                }
                return;
            }
            MDLog.m7445e(MDLogTag.MOMENT_CV_TAG, "The BodyLand modelPath is null or bodyLandmarkPostInfo is null !!!");
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public static synchronized void release() {
        ...
        useBodyLand = false;
        isWhiteList = false;
        MDLog.m7445e(MDLogTag.MOMENT_CV_TAG, "The BodyLandHelper release !!!");
    }
