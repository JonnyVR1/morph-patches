...
public class GLESTools {
    ...
    public static int createProgram(String str, String str2) {
        if (str == null || str2 == null) {
            azk0.m101074a("invalid shader code");
            return 0;
        }
        ...
        if (iArr[0] == 0) {
            rdd0.m180845a("vertext shader compile,failed:", GLES20.glGetShaderInfoLog(iGlCreateShader));
            return 0;
        }
        GLES20.glCompileShader(iGlCreateShader2);
        GLES20.glGetShaderiv(iGlCreateShader2, 35713, iArr, 0);
        if (iArr[0] == 0) {
            rdd0.m180845a("fragment shader compile,failed:", GLES20.glGetShaderInfoLog(iGlCreateShader2));
            return 0;
        }
        ...
        rdd0.m180845a("link program,failed:", GLES20.glGetProgramInfoLog(iGlCreateProgram));
        return 0;
    }
