...
public class TextureHelper {
    public static int bitmapToTexture(umw umwVar) {
        int[] iArr = new int[1];
        ...
        if (umwVar != null && umwVar.m196795a() != null) {
            GLES20.glTexImage2D(3553, 0, 6408, umwVar.m196799e(), umwVar.m196797c(), 0, 6408, 5121, ByteBuffer.wrap(umwVar.m196795a()));
        }
        return iArr[0];
    }
    ...
    public static int loadDataToTexture(int i, umw umwVar) {
    ...
    public static void updateBitmap(umw umwVar, int i) {
        GLES20.glBindTexture(3553, i);
        GLES20.glTexParameterf(3553, 10240, 9729.0f);
        GLES20.glTexParameterf(3553, 10241, 9729.0f);
        GLES20.glTexParameterf(3553, 10242, 33071.0f);
        ...
        GLES20.glTexSubImage2D(3553, 0, 6408, umwVar.m196799e(), umwVar.m196797c(), 0, 6408, 5121, ByteBuffer.wrap(umwVar.m196795a()));
    }
