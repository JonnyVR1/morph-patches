...
/* JADX INFO: renamed from: com.xiaomi.push.gk */
/* JADX INFO: loaded from: classes2.dex */
public enum EnumC14893gk {
    UploadSwitch(1),
    UploadFrequency(2),
    ...
    OnetrackSwitch(140),
    NotificationGroupUpdateTimeSwitch(CipherSuite.TLS_PSK_WITH_AES_256_CBC_SHA),
    KASwitch(CipherSuite.TLS_DHE_PSK_WITH_RC4_128_SHA),
    IntelligentHeartbeatForUnsupportWifiDigestBoolean(CipherSuite.TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA),
