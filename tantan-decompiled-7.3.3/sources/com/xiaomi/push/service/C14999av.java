...
public class C14999av {

    /* JADX INFO: renamed from: a */
    private static RSAPublicKey f63833a;

    /* JADX INFO: renamed from: a */
    private static final byte[] f63834a;
    ...
    static {
        ...
        f63834a = bArr;
        try {
            f63833a = (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(bArr));
        } catch (Throwable unused) {
            ouq0.m169378B("rsa key pair init failure!!!");
        }
    }

    /* JADX INFO: renamed from: a */
    private static byte[] m87741a(Cipher cipher, int i, byte[] bArr, int i2) {
    ...
    /* JADX INFO: renamed from: a */
    public static String m87740a(String str) {
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        try {
            Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
            cipher.init(1, f63833a);
            return Base64.encodeToString(m87741a(cipher, 1, str.getBytes("UTF-8"), f63833a.getModulus().bitLength()), 2);
        } catch (Throwable unused) {
            return null;
        }
    }
