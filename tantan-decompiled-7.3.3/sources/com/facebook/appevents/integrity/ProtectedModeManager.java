...
public final class ProtectedModeManager {
    ...
    @NotNull
    public static final Lazy defaultStandardParameterNames = LazyKt__LazyJVMKt.m88118b(new Function0<HashSet<String>>() { // from class: com.facebook.appevents.integrity.ProtectedModeManager$defaultStandardParameterNames$2
    ...
    public static final void m7971b() {
        if (ztb.m221490d(ProtectedModeManager.class)) {
            return;
        }
        try {
            enabled = true;
            ...
            ztb.m221488b(th, ProtectedModeManager.class);
        }
    }

    @JvmStatic
    /* JADX INFO: renamed from: d */
    public static final boolean m7972d() {
        if (ztb.m221490d(ProtectedModeManager.class)) {
            return false;
        }
        try {
    ...
    public static final void m7973f(@Nullable Bundle parameters) {
        if (ztb.m221490d(ProtectedModeManager.class)) {
            return;
        }
        try {
    ...
    public final HashSet<String> m7974a(JSONArray jsonArray) {
    ...
    public final HashSet<String> m7975c() {
    ...
    public final void m7976e() {
        ...
        try {
            ...
            HashSet<String> hashSetM7974a = m7974a(c1679dM8747r.getProtectedModeStandardParamsSetting());
            if (hashSetM7974a == null) {
                hashSetM7974a = m7975c();
            }
            standardParams = hashSetM7974a;
        } catch (Throwable th) {
            ztb.m221488b(th, this);
        }
    }
    ...
    public final boolean m7977g(@Nullable Bundle parameters) {
        if (ztb.m221490d(this) || parameters == null) {
            return false;
        }
        try {
            return parameters.containsKey("pm") && Intrinsics.m88377d(parameters.get("pm"), "1");
        } catch (Throwable th) {
            ztb.m221488b(th, this);
            return false;
        }
