...
public final class AuthenticationTokenHeader implements Parcelable {
    ...
    @JvmField
    @NotNull
    public static final Parcelable.Creator<AuthenticationTokenHeader> CREATOR = new C1518a();

    /* JADX INFO: renamed from: com.facebook.AuthenticationTokenHeader$a */
    @Metadata(m88120d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u001f\u0010\n\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\t2\u0006\u0010\b\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m88121d2 = {"com/facebook/AuthenticationTokenHeader$a", "Landroid/os/Parcelable$Creator;", "Lcom/facebook/AuthenticationTokenHeader;", "Landroid/os/Parcel;", "source", "a", "(Landroid/os/Parcel;)Lcom/facebook/AuthenticationTokenHeader;", "", "size", "", "b", "(I)[Lcom/facebook/AuthenticationTokenHeader;", "facebook-core_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public static final class C1518a implements Parcelable.Creator<AuthenticationTokenHeader> {
    ...
    public final boolean m7513b(String headerString) {
        g0l0.m128436g(headerString, "encodedHeaderString");
        ...
        try {
            ...
            boolean z = strOptString.length() > 0 && Intrinsics.m88377d(strOptString, "RS256");
    ...
    public final JSONObject m7514c() throws JSONException {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.m88377d(this.alg, authenticationTokenHeader.alg) && Intrinsics.m88377d(this.typ, authenticationTokenHeader.typ) && Intrinsics.m88377d(this.kid, authenticationTokenHeader.kid);
    }
    ...
    public AuthenticationTokenHeader(@NotNull Parcel parcel) {
        parcel.getClass();
        this.alg = g0l0.m128440k(parcel.readString(), "alg");
        this.typ = g0l0.m128440k(parcel.readString(), "typ");
        this.kid = g0l0.m128440k(parcel.readString(), "kid");
    }
