...
public final class AuthenticationToken implements Parcelable {
    ...
    @JvmField
    @NotNull
    public static final Parcelable.Creator<AuthenticationToken> CREATOR = new C1514a();

    /* JADX INFO: renamed from: com.facebook.AuthenticationToken$a */
    @Metadata(m88120d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u001f\u0010\n\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\t2\u0006\u0010\b\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m88121d2 = {"com/facebook/AuthenticationToken$a", "Landroid/os/Parcelable$Creator;", "Lcom/facebook/AuthenticationToken;", "Landroid/os/Parcel;", "source", "a", "(Landroid/os/Parcel;)Lcom/facebook/AuthenticationToken;", "", "size", "", "b", "(I)[Lcom/facebook/AuthenticationToken;", "facebook-core_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public static final class C1514a implements Parcelable.Creator<AuthenticationToken> {
    ...
    @Metadata(m88120d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0019\u0010\u0007\u001a\u00020\u00062\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\bR\u0014\u0010\n\u001a\u00020\t8\u0006X\u0086T¢\u0006\u0006\n\u0004\b\n\u0010\u000bR\u0014\u0010\f\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\f\u0010\u000bR\u001a\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00040\r8\u0006X\u0087\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u0014\u0010\u0010\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0010\u0010\u000bR\u0014\u0010\u0011\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0011\u0010\u000bR\u0014\u0010\u0012\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0012\u0010\u000bR\u0014\u0010\u0013\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0013\u0010\u000b¨\u0006\u0014"}, m88121d2 = {"Lcom/facebook/AuthenticationToken$b;", "", "<init>", "()V", "Lcom/facebook/AuthenticationToken;", "authenticationToken", "", "a", "(Lcom/facebook/AuthenticationToken;)V", "", "AUTHENTICATION_TOKEN_KEY", "Ljava/lang/String;", "CLAIMS_KEY", "Landroid/os/Parcelable$Creator;", "CREATOR", "Landroid/os/Parcelable$Creator;", "EXPECTED_NONCE_KEY", "HEADER_KEY", "SIGNATURE_KEY", "TOKEN_STRING_KEY", "facebook-core_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public static final class Companion {
        ...
        public final void m7505a(@Nullable AuthenticationToken authenticationToken) {
            AuthenticationTokenManager.INSTANCE.m7523a().m7521e(authenticationToken);
        }
    ...
    public AuthenticationToken(@NotNull String str, @NotNull String str2) {
        str.getClass();
        str2.getClass();
        g0l0.m128436g(str, "token");
        g0l0.m128436g(str2, "expectedNonce");
        List listSplit$default = StringsKt.split$default(str, new String[]{"."}, false, 0, 6, null);
        if (listSplit$default.size() != 3) {
            wg3.m206174a("Invalid IdToken string");
            throw null;
        }
        ...
        if (m7501a(str3, str4, str5, authenticationTokenHeader.getKid())) {
            this.signature = str5;
        } else {
            wg3.m206174a("Invalid Signature");
            throw null;
        }
    }

    /* JADX INFO: renamed from: a */
    public final boolean m7501a(String headerString, String claimsString, String sigString, String kid) {
        try {
            String strM167524c = og50.m167524c(kid);
            if (strM167524c == null) {
                return false;
            }
            return og50.m167525d(og50.m167523b(strM167524c), headerString + '.' + claimsString, sigString);
    ...
    public final JSONObject m7502b() throws JSONException {
        JSONObject jSONObject = new JSONObject();
        jSONObject.put(TOKEN_STRING_KEY, this.token);
        jSONObject.put(EXPECTED_NONCE_KEY, this.expectedNonce);
        jSONObject.put(HEADER_KEY, this.header.m7514c());
        jSONObject.put(CLAIMS_KEY, this.claims.m7507b());
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.m88377d(this.token, authenticationToken.token) && Intrinsics.m88377d(this.expectedNonce, authenticationToken.expectedNonce) && Intrinsics.m88377d(this.header, authenticationToken.header) && Intrinsics.m88377d(this.claims, authenticationToken.claims) && Intrinsics.m88377d(this.signature, authenticationToken.signature);
    }
    ...
    public AuthenticationToken(@NotNull Parcel parcel) {
        ...
        this.expectedNonce = g0l0.m128440k(parcel.readString(), "expectedNonce");
        ...
        if (parcelable != null) {
            ...
            if (parcelable2 != null) {
                ...
                this.signature = g0l0.m128440k(parcel.readString(), "signature");
                return;
            } else {
    ...
    public AuthenticationToken(@NotNull JSONObject jSONObject) throws JSONException {
        ...
        AuthenticationTokenClaims.Companion c1517b = AuthenticationTokenClaims.INSTANCE;
        jSONObject3.getClass();
        this.claims = c1517b.m7510a(jSONObject3);
    }
}
