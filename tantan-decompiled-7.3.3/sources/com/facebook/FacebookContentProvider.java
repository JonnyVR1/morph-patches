...
public final class FacebookContentProvider extends ContentProvider {
    ...
    public static final class Companion {
        ...
        public final String m7546a(@Nullable String applicationId, @NotNull UUID callId, @Nullable String attachmentName) {
            callId.getClass();
    ...
    public static final String getAttachmentUrl(@Nullable String str, @NotNull UUID uuid, @Nullable String str2) {
        return INSTANCE.m7546a(str, uuid, str2);
    }
    ...
    public ParcelFileDescriptor openFile(@NotNull Uri uri, @NotNull String mode) throws FileNotFoundException {
        ...
        try {
            File fileM125157c = fe20.m125157c((UUID) callIdAndAttachmentName.first, (String) callIdAndAttachmentName.second);
            if (fileM125157c != null) {
                return ParcelFileDescriptor.open(fileM125157c, SQLiteDatabase.CREATE_IF_NECESSARY);
            }
            throw new FileNotFoundException();
