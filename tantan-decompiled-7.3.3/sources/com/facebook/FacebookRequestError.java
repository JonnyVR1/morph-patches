...
import com.facebook.internal.C1676a;
...
public final class FacebookRequestError implements Parcelable {
    ...
    @NotNull
    private static final C1533c HTTP_RANGE_SUCCESS = new C1533c(200, 299);

    @JvmField
    @NotNull
    public static final Parcelable.Creator<FacebookRequestError> CREATOR = new C1531a();

    @Metadata(m88120d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, m88121d2 = {"Lcom/facebook/FacebookRequestError$Category;", "", "(Ljava/lang/String;I)V", "LOGIN_RECOVERABLE", "OTHER", "TRANSIENT", "facebook-core_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    ...
    @Metadata(m88120d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0005\u0010\u0006J\u001f\u0010\n\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\t2\u0006\u0010\b\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\n\u0010\u000b¨\u0006\f"}, m88121d2 = {"com/facebook/FacebookRequestError$a", "Landroid/os/Parcelable$Creator;", "Lcom/facebook/FacebookRequestError;", "Landroid/os/Parcel;", "parcel", "a", "(Landroid/os/Parcel;)Lcom/facebook/FacebookRequestError;", "", "size", "", "b", "(I)[Lcom/facebook/FacebookRequestError;", "facebook-core_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public static final class C1531a implements Parcelable.Creator<FacebookRequestError> {
    ...
    public static final class Companion {
        ...
        public final FacebookRequestError m7557a(@NotNull JSONObject singleResult, @Nullable Object batchResult, @Nullable HttpURLConnection connection) {
            String strOptString;
            int iOptInt;
            String str;
            boolean zOptBoolean;
            ...
            try {
                if (singleResult.has("code")) {
                    ...
                    Object objM8875O = C1680e.m8875O(singleResult, FacebookRequestError.BODY_KEY, "FACEBOOK_NON_JSON_RESULT");
                    if (objM8875O == null || !(objM8875O instanceof JSONObject)) {
                        str2 = FacebookRequestError.BODY_KEY;
                    } else {
                        boolean z = true;
                        int iOptInt2 = -1;
                        if (((JSONObject) objM8875O).has("error")) {
                            JSONObject jSONObject = (JSONObject) C1680e.m8875O((JSONObject) objM8875O, "error", null);
                        ...
                        } else if (((JSONObject) objM8875O).has("error_code") || ((JSONObject) objM8875O).has(FacebookRequestError.ERROR_MSG_KEY) || ((JSONObject) objM8875O).has(FacebookRequestError.ERROR_REASON_KEY)) {
                            String strOptString5 = ((JSONObject) objM8875O).optString(FacebookRequestError.ERROR_REASON_KEY, null);
                            strOptString = ((JSONObject) objM8875O).optString(FacebookRequestError.ERROR_MSG_KEY, null);
                            iOptInt2 = ((JSONObject) objM8875O).optInt("error_code", -1);
                            iOptInt = ((JSONObject) objM8875O).optInt(FacebookRequestError.ERROR_SUB_CODE_KEY, -1);
                            str = strOptString5;
                            zOptBoolean = false;
                            strOptString2 = null;
                            strOptString3 = null;
                        ...
                        if (z) {
                            return new FacebookRequestError(i, iOptInt2, iOptInt, str, strOptString, strOptString2, strOptString3, (JSONObject) objM8875O, singleResult, batchResult, connection, null, zOptBoolean, null);
                        }
                    }
                    if (!m7559c().m7560a(i)) {
                        return new FacebookRequestError(i, -1, -1, null, null, null, null, singleResult.has(str2) ? (JSONObject) C1680e.m8875O(singleResult, str2, "FACEBOOK_NON_JSON_RESULT") : null, singleResult, batchResult, connection, null, false, null);
                    }
                }
        ...
        public final synchronized C1676a m7558b() {
            C1679d c1679dM8743f = FetchedAppSettingsManager.m8743f(C1600c.m8102m());
            if (c1679dM8743f == null) {
                return C1676a.INSTANCE.m8812b();
            }
            return c1679dM8743f.getErrorClassification();
        }

        @NotNull
        /* JADX INFO: renamed from: c */
        public final C1533c m7559c() {
    ...
    @Metadata(m88120d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0019\b\u0000\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u0018\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\u0002H\u0086\u0002¢\u0006\u0004\b\t\u0010\nR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\u000bR\u0014\u0010\u0004\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\u000b¨\u0006\r"}, m88121d2 = {"Lcom/facebook/FacebookRequestError$c;", "", "", "start", "end", "<init>", "(II)V", "value", "", "a", "(I)Z", "I", "b", "facebook-core_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public static final class C1533c {
        ...
        public C1533c(int i, int i2) {
            this.start = i;
            this.end = i2;
        }

        /* JADX INFO: renamed from: a */
        public final boolean m7560a(int value) {
    ...
    public FacebookRequestError(int i, int i2, int i3, String str, String str2, String str3, String str4, JSONObject jSONObject, JSONObject jSONObject2, Object obj, HttpURLConnection httpURLConnection, FacebookException facebookException, boolean z) {
        ...
        if (facebookException != null) {
            ...
            categoryM8809c = Category.OTHER;
        } else {
            this.exception = new FacebookServiceException(this, m7550c());
            categoryM8809c = INSTANCE.m7558b().m8809c(i2, i3, z);
        }
        this.category = categoryM8809c;
        this.errorRecoveryMessage = INSTANCE.m7558b().m8810d(categoryM8809c);
    }
    ...
    public String toString() {
        return "{HttpStatus: " + this.requestStatusCode + ", errorCode: " + this.errorCode + ", subErrorCode: " + this.subErrorCode + ", errorType: " + this.errorType + ", errorMessage: " + m7550c() + "}";
    }
