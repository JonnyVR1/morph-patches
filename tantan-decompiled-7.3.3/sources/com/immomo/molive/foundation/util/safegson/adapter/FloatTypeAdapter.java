...
public class FloatTypeAdapter extends SafeErrorHandleTypeAdapter<Float> {
    ...
    public static /* synthetic */ class C3959a {
        ...
        static {
            ...
            try {
                f13817a[JsonToken.STRING.ordinal()] = 2;
    ...
    public Float read2(JsonReader jsonReader) throws IOException {
        ...
        int i = C3959a.f13817a[jsonTokenPeek.ordinal()];
        if (i == 1) {
            return Float.valueOf((float) jsonReader.nextDouble());
        }
        if (i != 2) {
            mo19603b(jsonReader, TypeToken.get(Float.class), jsonReader.getPath(), jsonTokenPeek);
