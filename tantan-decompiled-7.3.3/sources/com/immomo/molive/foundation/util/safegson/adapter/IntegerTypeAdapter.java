...
public class IntegerTypeAdapter extends SafeErrorHandleTypeAdapter<Integer> {
    ...
    public static /* synthetic */ class C3960a {
        ...
        static {
            ...
            try {
                f13818a[JsonToken.STRING.ordinal()] = 2;
    ...
    public Integer read2(JsonReader jsonReader) throws IOException {
        ...
        int i = C3960a.f13818a[jsonTokenPeek.ordinal()];
        if (i == 1) {
            try {
        ...
        if (i != 2) {
            mo19603b(jsonReader, TypeToken.get(Integer.class), jsonReader.getPath(), jsonTokenPeek);
