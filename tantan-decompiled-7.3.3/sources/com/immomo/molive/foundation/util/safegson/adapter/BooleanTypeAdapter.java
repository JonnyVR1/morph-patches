...
public class BooleanTypeAdapter extends SafeErrorHandleTypeAdapter<Boolean> {
    ...
    public static /* synthetic */ class C3957a {
        ...
        static {
            ...
            try {
                f13815a[JsonToken.STRING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f13815a[JsonToken.NUMBER.ordinal()] = 3;
    ...
    public Boolean read2(JsonReader jsonReader) throws IOException {
        ...
        int i = C3957a.f13815a[jsonTokenPeek.ordinal()];
        if (i == 1) {
            return Boolean.valueOf(jsonReader.nextBoolean());
        }
        if (i == 2) {
            mo19603b(jsonReader, TypeToken.get(Boolean.class), jsonReader.getPath(), jsonTokenPeek);
