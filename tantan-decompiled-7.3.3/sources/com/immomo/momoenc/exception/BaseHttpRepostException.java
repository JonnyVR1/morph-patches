...
public class BaseHttpRepostException extends Exception {
    ...
    public void countExctionTimes() {
        ...
        reported = true;
        Date date = new Date();
        k0f.m147785b(new Exception("(BaseHttpRepostException so muchtimes - starttime: " + startRecordTime.getTime() + "  reportTime:" + date.getTime() + ")" + getMessage() + "totle:" + (date.getTime() - startRecordTime.getTime())));
    }
}
