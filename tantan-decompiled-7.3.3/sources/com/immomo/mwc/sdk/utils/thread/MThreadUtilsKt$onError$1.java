...
final class MThreadUtilsKt$onError$1 extends Lambda implements Function1<Throwable, Unit> {
    ...
    /* JADX INFO: renamed from: com.immomo.mwc.sdk.utils.thread.MThreadUtilsKt$onError$1$1 */
    ...
    @DebugMetadata(m88262c = "com.immomo.mwc.sdk.utils.thread.MThreadUtilsKt$onError$1$1", m88263f = "MThreadUtils.kt", m88264l = {CipherSuite.TLS_DH_DSS_WITH_AES_128_GCM_SHA256}, m88265m = "invokeSuspend")
    public static final class C40751 extends SuspendLambda implements Function2<drb, Continuation<? super Unit>, Object> {
        ...
        public C40751(Ref.ObjectRef objectRef, Continuation continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            ...
            C40751 c40751 = MThreadUtilsKt$onError$1.this.new C40751(this.$exception, continuation);
            c40751.f14731p$ = (drb) obj;
            return c40751;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(drb drbVar, Continuation<? super Unit> continuation) {
            return ((C40751) create(drbVar, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final void invoke2(@Nullable Throwable th) {
        ...
        if (((Throwable) objectRef.element) != null) {
            xh3.m210980d(l4k.INSTANCE, r5e.m179862c(), null, new C40751(objectRef, null), 2, null);
        }
    }
