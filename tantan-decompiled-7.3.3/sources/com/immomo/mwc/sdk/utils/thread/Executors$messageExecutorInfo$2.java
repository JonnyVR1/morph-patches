...
final class Executors$messageExecutorInfo$2 extends Lambda implements Function0<Executors$ExecutorInfo> {
    public static final Executors$messageExecutorInfo$2 INSTANCE = new Executors$messageExecutorInfo$2();

    public Executors$messageExecutorInfo$2() {
        super(0);
    }
