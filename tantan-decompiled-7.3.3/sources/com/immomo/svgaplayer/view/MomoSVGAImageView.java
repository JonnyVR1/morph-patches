...
public class MomoSVGAImageView extends ClickSVGAImageView {
    ...
    @Metadata(m88119bv = {1, 0, 2}, m88120d1 = {"\u0000\u001b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0007H\u0016¨\u0006\b"}, m88121d2 = {"com/immomo/svgaplayer/view/MomoSVGAImageView$loadNetSVGA$1", "Lcom/immomo/svgaplayer/adaptercallback/SVGAResLoadCallBack;", "(Lcom/immomo/svgaplayer/view/MomoSVGAImageView;)V", "onResLoadFail", "", "onResLoadSuccess", "filePath", "", "svgalibrary_release"}, m88122k = 1, m88123mv = {1, 1, 10})
    public static final class C41241 implements SVGAResLoadCallBack {
        public C41241() {
        }
    ...
    public MomoSVGAImageView(@Nullable Context context) {
        ...
        this.stepToPercentage = DoubleCompanionObject.INSTANCE.m88368a();
    }
    ...
    private final void loadNetSVGA(String url) {
        ...
        if (mSVGAResLoadAdapter != null) {
            mSVGAResLoadAdapter.loadSVGARes(true, url, new C41241());
            return;
        }
        SVGAParser sVGAParser = this.mSVGAParser;
        if (sVGAParser != null) {
    ...
    private final void loadSVGA() {
        ...
        if (str != null) {
            ...
            if (C15493d.m94374J(str, "http", false, 2, null)) {
                loadNetSVGA(str);
                return;
            }
            if (fileIsExists(str)) {
                ...
                if (!TextUtils.isEmpty(insertTextBean.getRichText())) {
                    ...
                    if (insertTextBean.getSingleLine()) {
                        ...
                        if (mSVGAEntity != null) {
                            ...
                            mSVGAEntity.setDynamicText(key, new BoringLayoutBean(spannedFromHtml, textPaint, insertTextBean.getAlignType(), insertTextBean.m225058getEllipsize()));
                        }
                    } else {
                        SVGADynamicEntity mSVGAEntity2 = getMSVGAEntity();
                        if (mSVGAEntity2 != null) {
                    ...
                    if (insertTextBean.getSingleLine()) {
                        SVGADynamicEntity mSVGAEntity3 = getMSVGAEntity();
                        if (mSVGAEntity3 != null) {
                            mSVGAEntity3.setDynamicText(insertTextBean.getKey(), new BoringLayoutBean(insertTextBean.getText(), textPaint2, insertTextBean.getAlignType(), insertTextBean.m225058getEllipsize()));
                        }
                    } else {
