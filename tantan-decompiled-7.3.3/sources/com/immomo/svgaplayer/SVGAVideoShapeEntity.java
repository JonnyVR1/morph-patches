...
public final class SVGAVideoShapeEntity {
    ...
    @Metadata(m88119bv = {1, 0, 2}, m88120d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m88121d2 = {"Lcom/immomo/svgaplayer/SVGAVideoShapeEntity$Type;", "", "(Ljava/lang/String;I)V", "shape", "rect", "ellipse", "keep", "svgalibrary_release"}, m88122k = 1, m88123mv = {1, 1, 10})
    public enum Type {
        shape,
        rect,
        ellipse,
    ...
    @Metadata(m88119bv = {1, 0, 2}, m88122k = 3, m88123mv = {1, 1, 10})
    ...
    private final void parseArgs(ShapeEntity obj) {
        ...
        if (shapeArgs != null && (str = shapeArgs.f14793d) != null) {
        ...
        if (rectArgs != null) {
            Float f5 = rectArgs.f14789x;
            if (f5 == null) {
                f5 = fValueOf;
            }
            map.put(BaseSei.f14624X, f5);
            Float f6 = rectArgs.f14790y;
            if (f6 == null) {
                f6 = fValueOf;
            }
