...
public final class ShapeEntity extends Message<ShapeEntity, Builder> {
    ...
    public static final class ProtoAdapter_ShapeEntity extends ProtoAdapter<ShapeEntity> {
        ...
        @Override // com.squareup.wire.ProtoAdapter
        public ShapeEntity redact(ShapeEntity shapeEntity) throws EOFException {
    ...
    public ShapeEntity(ShapeType shapeType, ShapeStyle shapeStyle, Transform transform, ShapeArgs shapeArgs, RectArgs rectArgs, EllipseArgs ellipseArgs, ByteString byteString) {
        ...
        if (Internal.countNonNull(shapeArgs, rectArgs, ellipseArgs) > 1) {
            wg3.m206174a("at most one of shape, rect, ellipse may be non-null");
            throw null;
        }
        this.type = shapeType;
        this.styles = shapeStyle;
    ...
    public static final class ShapeArgs extends Message<ShapeArgs, Builder> {
        ...
        public static final class Builder extends Message.Builder<ShapeArgs, Builder> {
            ...
            public ShapeArgs build() {
                return new ShapeArgs(this.f14794d, super.buildUnknownFields());
            }

            /* JADX INFO: renamed from: d */
            public Builder m20469d(String str) {
                this.f14794d = str;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_ShapeArgs extends ProtoAdapter<ShapeArgs> {
            ...
            public ShapeArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag != 1) {
                        ...
                        builder.m20469d(ProtoAdapter.STRING.decode(protoReader));
                    }
                }
            }
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public ShapeArgs redact(ShapeArgs shapeArgs) throws EOFException {
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(shapeArgs.unknownFields()) && Internal.equals(this.f14793d, shapeArgs.f14793d);
        }
    ...
    public static final class ShapeStyle extends Message<ShapeStyle, Builder> {
        ...
        public static final class ProtoAdapter_ShapeStyle extends ProtoAdapter<ShapeStyle> {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public ShapeStyle redact(ShapeStyle shapeStyle) throws EOFException {
        ...
        public static final class RGBAColor extends Message<RGBAColor, Builder> {
            ...
            public static final class Builder extends Message.Builder<RGBAColor, Builder> {
                ...
                /* JADX INFO: renamed from: r */
                public Float f14802r;

                /* JADX INFO: renamed from: a */
                public Builder m20470a(Float f) {
                    this.f14799a = f;
                    return this;
                }

                /* JADX INFO: renamed from: b */
                public Builder m20471b(Float f) {
                    this.f14800b = f;
                    return this;
                }
                ...
                public RGBAColor build() {
                    return new RGBAColor(this.f14802r, this.f14801g, this.f14800b, this.f14799a, super.buildUnknownFields());
                }

                /* JADX INFO: renamed from: g */
                public Builder m20472g(Float f) {
                    this.f14801g = f;
                    return this;
                }

                /* JADX INFO: renamed from: r */
                public Builder m20473r(Float f) {
                    this.f14802r = f;
                    return this;
                }
            }
            ...
            public static final class ProtoAdapter_RGBAColor extends ProtoAdapter<RGBAColor> {
                ...
                public RGBAColor decode(ProtoReader protoReader) throws IOException {
                    ...
                    while (true) {
                        ...
                        if (iNextTag == 1) {
                            builder.m20473r(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag == 2) {
                            builder.m20472g(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag == 3) {
                            builder.m20471b(ProtoAdapter.FLOAT.decode(protoReader));
                        } else if (iNextTag != 4) {
                            FieldEncoding fieldEncodingPeekFieldEncoding = protoReader.peekFieldEncoding();
                            builder.addUnknownField(iNextTag, fieldEncodingPeekFieldEncoding, fieldEncodingPeekFieldEncoding.rawProtoAdapter().decode(protoReader));
                        } else {
                            builder.m20470a(ProtoAdapter.FLOAT.decode(protoReader));
                        }
                    }
                }
                ...
                @Override // com.squareup.wire.ProtoAdapter
                public RGBAColor redact(RGBAColor rGBAColor) throws EOFException {
            ...
            public boolean equals(Object obj) {
                ...
                return unknownFields().equals(rGBAColor.unknownFields()) && Internal.equals(this.f14798r, rGBAColor.f14798r) && Internal.equals(this.f14797g, rGBAColor.f14797g) && Internal.equals(this.f14796b, rGBAColor.f14796b) && Internal.equals(this.f14795a, rGBAColor.f14795a);
            }
            ...
            public Builder newBuilder() {
                Builder builder = new Builder();
                builder.f14802r = this.f14798r;
                builder.f14801g = this.f14797g;
                builder.f14800b = this.f14796b;
                builder.f14799a = this.f14795a;
                builder.addUnknownFields(unknownFields());
                return builder;
            }
    ...
    public static final class EllipseArgs extends Message<EllipseArgs, Builder> {
        ...
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 1)
        public final Float f14785x;

        /* JADX INFO: renamed from: y */
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 2)
        public final Float f14786y;
        ...
        public static final class Builder extends Message.Builder<EllipseArgs, Builder> {
            ...
            public EllipseArgs build() {
                return new EllipseArgs(this.f14787x, this.f14788y, this.radiusX, this.radiusY, super.buildUnknownFields());
            }
            ...
            /* JADX INFO: renamed from: x */
            public Builder m20465x(Float f) {
                this.f14787x = f;
                return this;
            }

            /* JADX INFO: renamed from: y */
            public Builder m20466y(Float f) {
                this.f14788y = f;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_EllipseArgs extends ProtoAdapter<EllipseArgs> {
            ...
            public EllipseArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == 1) {
                        builder.m20465x(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 2) {
                        builder.m20466y(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 3) {
            ...
            public void encode(ProtoWriter protoWriter, EllipseArgs ellipseArgs) throws IOException {
                Float f = ellipseArgs.f14785x;
                if (f != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 1, f);
                }
                Float f2 = ellipseArgs.f14786y;
                if (f2 != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 2, f2);
                }
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public EllipseArgs redact(EllipseArgs ellipseArgs) throws EOFException {
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(ellipseArgs.unknownFields()) && Internal.equals(this.f14785x, ellipseArgs.f14785x) && Internal.equals(this.f14786y, ellipseArgs.f14786y) && Internal.equals(this.radiusX, ellipseArgs.radiusX) && Internal.equals(this.radiusY, ellipseArgs.radiusY);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = unknownFields().hashCode() * 37;
            Float f = this.f14785x;
            int iHashCode2 = (iHashCode + (f != null ? f.hashCode() : 0)) * 37;
            Float f2 = this.f14786y;
            int iHashCode3 = (iHashCode2 + (f2 != null ? f2.hashCode() : 0)) * 37;
        ...
        public Builder newBuilder() {
            Builder builder = new Builder();
            builder.f14787x = this.f14785x;
            builder.f14788y = this.f14786y;
    ...
    public static final class RectArgs extends Message<RectArgs, Builder> {
        ...
        /* JADX INFO: renamed from: x */
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 1)
        public final Float f14789x;

        /* JADX INFO: renamed from: y */
        @WireField(adapter = "com.squareup.wire.ProtoAdapter#FLOAT", tag = 2)
        public final Float f14790y;
        ...
        public static final class Builder extends Message.Builder<RectArgs, Builder> {
            ...
            /* JADX INFO: renamed from: x */
            public Float f14791x;

            /* JADX INFO: renamed from: y */
            public Float f14792y;

            @Override // com.squareup.wire.Message.Builder
            public RectArgs build() {
                return new RectArgs(this.f14791x, this.f14792y, this.width, this.height, this.cornerRadius, super.buildUnknownFields());
            }
            ...
            /* JADX INFO: renamed from: x */
            public Builder m20467x(Float f) {
                this.f14791x = f;
                return this;
            }

            /* JADX INFO: renamed from: y */
            public Builder m20468y(Float f) {
                this.f14792y = f;
                return this;
            }
        }
        ...
        public static final class ProtoAdapter_RectArgs extends ProtoAdapter<RectArgs> {
            ...
            public RectArgs decode(ProtoReader protoReader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == 1) {
                        builder.m20467x(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 2) {
                        builder.m20468y(ProtoAdapter.FLOAT.decode(protoReader));
                    } else if (iNextTag == 3) {
            ...
            public void encode(ProtoWriter protoWriter, RectArgs rectArgs) throws IOException {
                Float f = rectArgs.f14789x;
                if (f != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 1, f);
                }
                Float f2 = rectArgs.f14790y;
                if (f2 != null) {
                    ProtoAdapter.FLOAT.encodeWithTag(protoWriter, 2, f2);
                }
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public RectArgs redact(RectArgs rectArgs) throws EOFException {
        ...
        public boolean equals(Object obj) {
            ...
            return unknownFields().equals(rectArgs.unknownFields()) && Internal.equals(this.f14789x, rectArgs.f14789x) && Internal.equals(this.f14790y, rectArgs.f14790y) && Internal.equals(this.width, rectArgs.width) && Internal.equals(this.height, rectArgs.height) && Internal.equals(this.cornerRadius, rectArgs.cornerRadius);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = unknownFields().hashCode() * 37;
            Float f = this.f14789x;
            int iHashCode2 = (iHashCode + (f != null ? f.hashCode() : 0)) * 37;
            Float f2 = this.f14790y;
            int iHashCode3 = (iHashCode2 + (f2 != null ? f2.hashCode() : 0)) * 37;
            Float f3 = this.width;
            int iHashCode4 = (iHashCode3 + (f3 != null ? f3.hashCode() : 0)) * 37;
        ...
        public Builder newBuilder() {
            Builder builder = new Builder();
            builder.f14791x = this.f14789x;
            builder.f14792y = this.f14790y;
        ...
        public String toString() {
            ...
            if (this.f14789x != null) {
                sb.append(", x=");
                sb.append(this.f14789x);
            }
            if (this.f14790y != null) {
                sb.append(", y=");
                sb.append(this.f14790y);
            }
            if (this.width != null) {
                sb.append(", width=");
