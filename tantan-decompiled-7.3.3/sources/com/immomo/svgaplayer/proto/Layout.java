...
public final class Layout extends Message<Layout, Builder> {
    ...
    public static final class Builder extends Message.Builder<Layout, Builder> {
        ...
        /* JADX INFO: renamed from: x */
        public Float f14783x;

        /* JADX INFO: renamed from: y */
        public Float f14784y;

        @Override // com.squareup.wire.Message.Builder
        public Layout build() {
            return new Layout(this.f14783x, this.f14784y, this.width, this.height, super.buildUnknownFields());
        }
        ...
        /* JADX INFO: renamed from: x */
        public Builder m20463x(Float f) {
            this.f14783x = f;
            return this;
        }

        /* JADX INFO: renamed from: y */
        public Builder m20464y(Float f) {
            this.f14784y = f;
            return this;
        }
    }
    ...
    public static final class ProtoAdapter_Layout extends ProtoAdapter<Layout> {
        ...
        public Layout decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag == 1) {
                    builder.m20463x(ProtoAdapter.FLOAT.decode(protoReader));
                } else if (iNextTag == 2) {
                    builder.m20464y(ProtoAdapter.FLOAT.decode(protoReader));
                } else if (iNextTag == 3) {
    ...
    public boolean equals(Object obj) {
        ...
        return unknownFields().equals(layout.unknownFields()) && Internal.equals(this.f14781x, layout.f14781x) && Internal.equals(this.f14782y, layout.f14782y) && Internal.equals(this.width, layout.width) && Internal.equals(this.height, layout.height);
    }
    ...
    public Builder newBuilder() {
        Builder builder = new Builder();
        builder.f14783x = this.f14781x;
        builder.f14784y = this.f14782y;
    ...
    public String toString() {
        ...
        if (this.f14781x != null) {
            sb.append(", x=");
            sb.append(this.f14781x);
        }
        if (this.f14782y != null) {
            sb.append(", y=");
            sb.append(this.f14782y);
        }
        if (this.width != null) {
            sb.append(", width=");
