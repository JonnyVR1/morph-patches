...
public final class NotifyInfo extends GeneratedMessageLite<NotifyInfo, C4104b> implements lfz {
    ...
    private static volatile ng60<NotifyInfo> PARSER = null;
    ...
    public static /* synthetic */ class C4103a {
        ...
        static {
            ...
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.IS_INITIALIZED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.MAKE_IMMUTABLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.VISIT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.MERGE_FROM_STREAM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f14765a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 8;
    ...
    public static final class C4105c {

        /* JADX INFO: renamed from: a */
        static final C3441p<String, String> f14766a;

        static {
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f14766a = C3441p.m17331c(fieldType, "", fieldType, "");
        }
    }
    ...
    public static C4104b newBuilder(NotifyInfo notifyInfo) {
    ...
    public static ng60<NotifyInfo> parser() {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        C4103a c4103a = null;
        boolean z = false;
        switch (C4103a.f14765a[methodToInvoke.ordinal()]) {
            case 1:
            ...
            case 3:
                ...
                return null;
            case 4:
                return new C4104b(c4103a);
            case 5:
                GeneratedMessageLite.InterfaceC3409h interfaceC3409h = (GeneratedMessageLite.InterfaceC3409h) obj;
                NotifyInfo notifyInfo = (NotifyInfo) obj2;
                this.type_ = interfaceC3409h.mo17052f(!this.type_.isEmpty(), this.type_, !notifyInfo.type_.isEmpty(), notifyInfo.type_);
                this.title_ = interfaceC3409h.mo17052f(!this.title_.isEmpty(), this.title_, !notifyInfo.title_.isEmpty(), notifyInfo.title_);
                this.desc_ = interfaceC3409h.mo17052f(!this.desc_.isEmpty(), this.desc_, !notifyInfo.desc_.isEmpty(), notifyInfo.desc_);
                int i = this.actionType_;
                boolean z2 = i != 0;
                int i2 = notifyInfo.actionType_;
                this.actionType_ = interfaceC3409h.mo17051e(z2, i, i2 != 0, i2);
                this.action_ = interfaceC3409h.mo17052f(!this.action_.isEmpty(), this.action_, !notifyInfo.action_.isEmpty(), notifyInfo.action_);
                this.icon_ = interfaceC3409h.mo17052f(!this.icon_.isEmpty(), this.icon_, !notifyInfo.icon_.isEmpty(), notifyInfo.icon_);
                int i3 = this.sound_;
                boolean z3 = i3 != 0;
                int i4 = notifyInfo.sound_;
                this.sound_ = interfaceC3409h.mo17051e(z3, i3, i4 != 0, i4);
                this.soundType_ = interfaceC3409h.mo17052f(!this.soundType_.isEmpty(), this.soundType_, !notifyInfo.soundType_.isEmpty(), notifyInfo.soundType_);
                int i5 = this.vibrate_;
                boolean z4 = i5 != 0;
                int i6 = notifyInfo.vibrate_;
                this.vibrate_ = interfaceC3409h.mo17051e(z4, i5, i6 != 0, i6);
                int i7 = this.light_;
                boolean z5 = i7 != 0;
                int i8 = notifyInfo.light_;
                this.light_ = interfaceC3409h.mo17051e(z5, i7, i8 != 0, i8);
                int i9 = this.backgroundShow_;
                boolean z6 = i9 != 0;
                int i10 = notifyInfo.backgroundShow_;
                this.backgroundShow_ = interfaceC3409h.mo17051e(z6, i9, i10 != 0, i10);
                this.data_ = interfaceC3409h.mo17058l(this.data_, notifyInfo.internalGetData());
                long j = this.showTime_;
                boolean z7 = j != 0;
                long j2 = notifyInfo.showTime_;
                this.showTime_ = interfaceC3409h.mo17055i(z7, j, j2 != 0, j2);
                boolean z8 = false;
                ...
                this.showExpire_ = interfaceC3409h.mo17055i(z8, j3, j4 != 0, j4);
                boolean z9 = this.popNotify_;
                boolean z10 = notifyInfo.popNotify_;
                this.popNotify_ = interfaceC3409h.mo17050d(z9, z9, z10, z10);
                boolean z11 = this.autoCancel_;
                boolean z12 = notifyInfo.autoCancel_;
                this.autoCancel_ = interfaceC3409h.mo17050d(z11, z11, z12, z12);
                    ...
                    try {
                        ...
                        switch (iM17171M) {
                            ...
                            case 26:
                                ...
                                continue;
                            case 32:
                                this.actionType_ = c3430e.m17196u();
                                continue;
                            case 42:
                            ...
                            case 50:
                                ...
                                continue;
                            case 56:
                                this.sound_ = c3430e.m17196u();
                                continue;
                            case 66:
                                this.soundType_ = c3430e.m17170L();
                                continue;
                            case 72:
                                this.vibrate_ = c3430e.m17196u();
                                continue;
                            case 80:
                                this.light_ = c3430e.m17196u();
                                continue;
                            case 88:
                                this.backgroundShow_ = c3430e.m17196u();
                                continue;
                            case EACTags.FCP_TEMPLATE /* 98 */:
                                if (!this.data_.isMutable()) {
                                    this.data_ = this.data_.mutableCopy();
                                }
                                C4105c.f14766a.m17335e(this.data_, c3430e, c3433h);
                                continue;
                            case 104:
                                this.showTime_ = c3430e.m17197v();
                                continue;
                            case 112:
                                this.showExpire_ = c3430e.m17197v();
                                continue;
                            case 120:
                                this.popNotify_ = c3430e.m17188m();
                                continue;
                            case 128:
                                this.autoCancel_ = c3430e.m17188m();
                                continue;
                            default:
    ...
    public int getSerializedSize() {
        ...
        if (!this.desc_.isEmpty()) {
            iM16956K += CodedOutputStream.m16956K(3, getDesc());
        }
        ...
        if (!this.action_.isEmpty()) {
            iM16956K += CodedOutputStream.m16956K(5, getAction());
        }
        if (!this.icon_.isEmpty()) {
            iM16956K += CodedOutputStream.m16956K(6, getIcon());
        }
        int i3 = this.sound_;
        if (i3 != 0) {
        ...
        if (!this.soundType_.isEmpty()) {
            iM16956K += CodedOutputStream.m16956K(8, getSoundType());
        }
        int i4 = this.vibrate_;
        if (i4 != 0) {
            iM16956K += CodedOutputStream.m16984t(9, i4);
        }
        int i5 = this.light_;
        if (i5 != 0) {
        ...
        if (i6 != 0) {
            iM16956K += CodedOutputStream.m16984t(11, i6);
        }
        for (Map.Entry<String, String> entry : internalGetData().entrySet()) {
            iM16956K += C4105c.f14766a.m17334a(12, entry.getKey(), entry.getValue());
        }
        long j = this.showTime_;
        if (j != 0) {
            iM16956K += CodedOutputStream.m16986v(13, j);
        }
        long j2 = this.showExpire_;
        if (j2 != 0) {
            iM16956K += CodedOutputStream.m16986v(14, j2);
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (!this.desc_.isEmpty()) {
            codedOutputStream.mo16994D0(3, getDesc());
        }
        int i = this.actionType_;
        if (i != 0) {
        ...
        if (!this.action_.isEmpty()) {
            codedOutputStream.mo16994D0(5, getAction());
        }
        if (!this.icon_.isEmpty()) {
            codedOutputStream.mo16994D0(6, getIcon());
        }
        int i2 = this.sound_;
        if (i2 != 0) {
        ...
        if (!this.soundType_.isEmpty()) {
            codedOutputStream.mo16994D0(8, getSoundType());
        }
        int i3 = this.vibrate_;
        if (i3 != 0) {
            codedOutputStream.mo17025s0(9, i3);
        }
        int i4 = this.light_;
        if (i4 != 0) {
        ...
        if (i5 != 0) {
            codedOutputStream.mo17025s0(11, i5);
        }
        for (Map.Entry<String, String> entry : internalGetData().entrySet()) {
            C4105c.f14766a.m17336f(codedOutputStream, 12, entry.getKey(), entry.getValue());
        }
        long j = this.showTime_;
        if (j != 0) {
            codedOutputStream.m17027u0(13, j);
        }
        long j2 = this.showExpire_;
        if (j2 != 0) {
            codedOutputStream.m17027u0(14, j2);
        }
        boolean z = this.popNotify_;
        if (z) {
    ...
    public static final class C4104b extends GeneratedMessageLite.AbstractC3403b<NotifyInfo, C4104b> implements lfz {
        private C4104b() {
            super(NotifyInfo.DEFAULT_INSTANCE);
        }

        public /* synthetic */ C4104b(C4103a c4103a) {
            this();
        }
    }

    public static NotifyInfo parseDelimitedFrom(InputStream inputStream, C3433h c3433h) throws IOException {
        return (NotifyInfo) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, c3433h);
    }

    public static NotifyInfo parseFrom(ByteString byteString, C3433h c3433h) throws InvalidProtocolBufferException {
        return (NotifyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, c3433h);
    }
    ...
    public static NotifyInfo parseFrom(byte[] bArr, C3433h c3433h) throws InvalidProtocolBufferException {
        return (NotifyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, c3433h);
    }
    ...
    public static NotifyInfo parseFrom(InputStream inputStream, C3433h c3433h) throws IOException {
        return (NotifyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, c3433h);
    }

    public static NotifyInfo parseFrom(C3430e c3430e) throws IOException {
        return (NotifyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e);
    }

    public static C4104b newBuilder() {
        return DEFAULT_INSTANCE.toBuilder();
    }

    public static NotifyInfo parseFrom(C3430e c3430e, C3433h c3433h) throws IOException {
        return (NotifyInfo) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, c3430e, c3433h);
    }
}
