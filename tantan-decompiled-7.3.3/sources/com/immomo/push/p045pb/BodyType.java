...
public enum BodyType implements C3437l.c {
    RET(0),
    SAUTH(1),
    SAUTH_RET(2),
    MSG_PSH(3),
    ...
    private static final C3437l.d<BodyType> internalValueMap = new C3437l.d<BodyType>() { // from class: com.immomo.push.pb.BodyType.a
    ...
    public static C3437l.d<BodyType> internalGetValueMap() {
