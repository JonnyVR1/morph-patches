...
public class VideoDataRetrieverBySoft extends n7y {
    ...
    public class BestFrameFilter {
        ...
        public void setFrameCnt(int i, int i2) {
            ...
            lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "  setFrameCnt method,  mNeedFrameCnt:" + this.mNeedFrameCnt + ", mInterval:" + this.mInterval + ", mMaxCnt:" + this.mMaxCnt + ", mDuration:" + VideoDataRetrieverBySoft.this.mDuration + ",mPtsStep:" + this.mPtsStep);
        }
        ...
        public void doFrameFilter() throws Exception {
            lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "doFrameFilter is called");
            ...
            float f = -1.0f;
            if (i != 1) {
                lyv.m156389c(videoDataRetrieverBySoft.TAG, "doFrameFilter:mInterval != 1");
                int i2 = 0;
                long j = 0;
                float f2 = -1.0f;
                for (int i3 = 0; i3 < this.mMaxCnt; i3++) {
                    lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "  doFrameFilter:needPts " + j);
                    ...
                    if (iNativeDecodeOneFrame < 0 || VideoDataRetrieverBySoft.this.mHandler == 0) {
                        lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "doFrameFilter nativeDecodeOneFrame or mHandler is error!");
                        lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "            mHandler:" + VideoDataRetrieverBySoft.this.mHandler);
                    } else {
                ...
                while (j2 <= autoMaxLength && !VideoDataRetrieverBySoft.this.mExit) {
                    lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "  doFrameFilter:needPts " + j2);
            ...
            lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "doFrameFilter is complete, VideoDataRetrieverBySoft will be release!");
        }

        public float doMMCVFilter(byte[] bArr) {
            cr2 cr2Var = new cr2();
            this.processInput = cr2Var;
            cr2Var.f83276g = 17;
            cr2Var.f83274e = bArr;
            cr2Var.f83270a = VideoDataRetrieverBySoft.this.mWidth;
            this.processInput.f83271b = VideoDataRetrieverBySoft.this.mHeight;
    ...
    public VideoDataRetrieverBySoft() {
        this.mHandler = 0L;
        lrw.m155653j().m155661g();
        this.mHandler = nativeCreateVideoDataRetriver();
    }

    public static /* synthetic */ o3m access$200(VideoDataRetrieverBySoft videoDataRetrieverBySoft) {
    ...
    public void executeFrameFilter() {
        if (this.mFrameFilter != null) {
            new Thread(new Runnable() { // from class: com.immomo.moment.mediautils.VideoDataRetrieverBySoft.1
                ...
                public void run() {
                    lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "executeFrameFilter is called，thread will run!");
                    if (byx.m107100a()) {
                        VideoDataRetrieverBySoft.access$200(VideoDataRetrieverBySoft.this);
                    }
                    try {
                        ...
                        lyv.m156389c(VideoDataRetrieverBySoft.this.TAG, "executeFrameFilter thread is exception, will release!");
                        e.printStackTrace();
            ...
            }, "DataRetriverBySoft" + g8g0.m129407b()).start();
        }
    }
                ...
                while (this.mIndex < list.size() && !this.mExit) {
                    ...
                    if (i == 1) {
                        ...
                        if (bitmapDecodecOneFrameToBmp != null) {
                            ...
                            lyv.m156389c(this.TAG, "get cur frame cost " + (System.currentTimeMillis() - jCurrentTimeMillis));
                    ...
                    if (i3 < list.size() && (list.get(this.mIndex).pts < node.pts || list.get(this.mIndex).pts - node.pts >= 1000000)) {
                        lyv.m156389c(this.TAG, "seek to new pos " + list.get(this.mIndex).pts);
