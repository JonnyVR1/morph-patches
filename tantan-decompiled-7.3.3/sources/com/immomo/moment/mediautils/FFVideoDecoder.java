...
public class FFVideoDecoder {
    ...
    public synchronized void destroy() {
        if (this.decoderHandler != 0) {
            MDLog.m7443d(TAG, "destroy decoder ");
    ...
    public synchronized ad60 getAudioFrame() {
        AVFrame aVFrame;
        try {
            if (nativeGetAudioFrame(this.decoderHandler, this.audioFrame) <= 0 || (aVFrame = this.audioFrame) == null || aVFrame.frame == null) {
                return null;
            }
            ad60 ad60Var = this.mAudioPacket;
            if (ad60Var == null || (ad60Var.m97016b() != null && this.mAudioPacket.m97016b().size != this.audioFrame.frame.length)) {
                this.mAudioPacket = new ad60(ByteBuffer.wrap(this.audioFrame.frame));
            }
            ad60 ad60Var2 = this.mAudioPacket;
            AVFrame aVFrame2 = this.audioFrame;
            ad60Var2.m97018d(aVFrame2.size, 0, 0, aVFrame2.pts * 1000, 0);
    ...
    public synchronized ad60 getVideoFrame() {
        AVFrame aVFrame;
        byte[] bArr;
        try {
            ...
            if (this.mVideoPacket == null) {
                this.mVideoPacket = new ad60(ByteBuffer.wrap(bArr));
            }
            ad60 ad60Var = this.mVideoPacket;
            AVFrame aVFrame2 = this.videoFrame;
            ad60Var.m97018d(aVFrame2.size, 0, 0, 1000 * aVFrame2.pts, 0);
