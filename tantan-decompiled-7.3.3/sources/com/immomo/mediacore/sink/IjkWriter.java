...
public class IjkWriter extends SinkBase {
    ...
    private static wfm sLocalLibLoader = new wfm() { // from class: com.immomo.mediacore.sink.IjkWriter.1
        @Override // p153l.wfm
    ...
    private static void loadLibrariesOnce(wfm wfmVar) {
        synchronized (IjkWriter.class) {
            if (!mIsLibLoaded) {
                ...
                try {
                    wfmVar.loadLibrary("ijkstreamer");
                    mIsLibLoaded = true;
    ...
    public long getWriteByte() {
        try {
            ...
            t9c.m189745c("IjkWriter", "----getWriteByte: " + j_getWriteByte);
            return j_getWriteByte;
        } catch (Error e) {
            e.printStackTrace();
            t9c.m189745c("IjkWriter", "----getWriteByte: ----0");
            return 0L;
        } catch (Exception e2) {
            e2.printStackTrace();
            t9c.m189745c("IjkWriter", "----getWriteByte: ----0");
    ...
    public boolean prepare() {
        ...
        t9c.m189745c("zjlfound", "prepare:end ret :" + z);
        return z;
    }
    ...
    public void startRecording() {
        t9c.m189745c("IjkWriter", "zjlfound startRecording");
    ...
    public void stopSurroundMusic() {
        t9c.m189745c("IjkWriter", "stopSurroundMusic:");
    ...
    public void writeVideoPacket(long j, ByteBuffer byteBuffer, int i, boolean z) {
        ...
        try {
            boolean zM112267K0 = csx.m112235R().m112267K0();
