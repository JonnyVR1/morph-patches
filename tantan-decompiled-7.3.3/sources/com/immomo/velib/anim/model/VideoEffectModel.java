...
public class VideoEffectModel {
    ...
    public static VideoEffectModel parseByPath(String str) {
        String strM207218f = wnk0.m207218f(getConfigPath(str));
        VideoEffectModel videoEffectModel = null;
        if (TextUtils.isEmpty(strM207218f)) {
            return null;
        }
        try {
            videoEffectModel = (VideoEffectModel) new Gson().fromJson(strM207218f, VideoEffectModel.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
