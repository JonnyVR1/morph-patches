...
public class MediaCodecWrapper {
                    ...
                    if (MediaCodecWrapper.this.mOutterPauseFlag) {
                        ...
                        if (MediaCodecWrapper.this.mTextureRenderListener == null || MediaCodecWrapper.this.mCodecType != 1 || MediaCodecWrapper.this.mCodecSurface == null || !this.needWaitFrameProcessComplete) {
                            try {
                                    ...
                                    if (iDequeueOutputBuffer != -2) {
                                        ...
                                        if (iDequeueOutputBuffer != -1) {
                                            ...
                                            if ((this.mBufferInfo.flags & 4) != 0) {
                                                ...
                                                sb.append(str);
                                                Log4Cam.m19388e("MedaiCodecWrapper", sb.toString());
                                ...
                                e2.printStackTrace();
                                Log4Cam.m19388e("MedaiCodecWrapper", "Codec Exception !!!!!!!!!!!!!!!!!");
                                if (MediaCodecWrapper.this.mStatusListener != null) {
                                ...
                                if (iDequeueOutputBuffer != -2) {
                                    ...
                                    if (iDequeueOutputBuffer != -1) {
                                        ...
                                        if ((this.mBufferInfo.flags & 4) != 0) {
                                            ...
                                            sb2.append(str);
                                            Log4Cam.m19388e("MedaiCodecWrapper", sb2.toString());
                                            if (MediaCodecWrapper.this.mCompleteListener != null) {
                                                MediaCodecWrapper.this.mCompleteListener.onComplete();
                                            }
    ...
    private boolean checkEncoderCapability(MediaFormat mediaFormat) {
        ...
        if (this.mCodecName.startsWith("audio")) {
            ...
            Log4Cam.m19388e("MedaiCodecWrapper", "audio issupported !!!!!! " + capabilitiesForType.isFormatSupported(mediaFormat2));
        ...
        Log4Cam.m19388e("MedaiCodecWrapper", "video issupported !!!!!! " + capabilitiesForType.isFormatSupported(mediaFormat2));
        return capabilitiesForType.isFormatSupported(mediaFormat2);
    }
            ...
            for (int i2 = 0; i2 < codecCount; i2++) {
                ...
                if (codecInfoAt != null && codecInfoAt.isEncoder() && (supportedTypes = codecInfoAt.getSupportedTypes()) != null) {
                    for (int i3 = 0; i3 < supportedTypes.length; i3++) {
                        Log4Cam.m19388e("codec", supportedTypes[i3]);
    ...
    public static boolean isSurpportH265Dec() {
        ...
        for (int i = 0; i < codecCount; i++) {
            ...
            Log4Cam.m19387e("codec" + codecInfoAt.getName());
            if (!codecInfoAt.isEncoder() && (supportedTypes = codecInfoAt.getSupportedTypes()) != null) {
                for (int i2 = 0; i2 < supportedTypes.length; i2++) {
                    Log4Cam.m19388e("codec", supportedTypes[i2]);
    ...
    public boolean createMediaCodec(MediaFormat mediaFormat, int i) {
        synchronized (this.mMediaCodecSync) {
            if (mediaFormat == null || i > 1 || i < 0) {
                Log4Cam.m19388e("MedaiCodecWrapper", "Media format is null");
                return false;
            }
            try {
                this.mCodecType = i;
                ...
                if (string == null) {
                    Log4Cam.m19388e("MedaiCodecWrapper", "Media codec name is null");
                    return false;
                }
                ...
                this.mMediaCodec = null;
                Log4Cam.m19388e("MedaiCodecWrapper", "CreateMediaCodec Error [" + e.toString() + Constants.AES_SUFFIX);
                return false;
            }
        }
    }
