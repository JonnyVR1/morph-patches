...
public class MDDNSEntrance {
    ...
    private void checkInited() {
        ...
        azk0.m101074a("please call com.immomo.mmdns.DNSManager.init(android.content.Context, com.immomo.mmdns.IMDDNSConfig) first");
    }
    ...
    public synchronized String getUsableHost(String str, boolean z) {
        Span spanM178148b = GlobalTracer.m20319b(MT_TRACER).mo20317a("getUsableHost").m178147a("domain", str).m178147a("findV6", String.valueOf(z)).m178148b();
        lbe0 lbe0VarMo20314e = spanM178148b.mo20314e();
        try {
            if (this.openDNS && !TextUtils.isEmpty(str)) {
                ...
                MDLog.m7450i(LogTag.DNS, "replace %s ——> %s", str, strNativeGetUsableHost);
                ...
                spanM178148b.mo20313d(String.format("replace %s ——> %s", str, strNativeGetUsableHost));
                if (lbe0VarMo20314e != null) {
                    lbe0VarMo20314e.close();
                }
    ...
    public synchronized String getUsableHostFromUrl(String str, boolean z) {
        if (this.openDNS && !TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                MDLog.m7450i(LogTag.DNS, "replace %s ——> %s", host, strNativeGetUsableHost);
    ...
    public synchronized String[] getUsableHostList(String str, boolean z) {
        lbe0 lbe0VarMo20314e = GlobalTracer.m20319b(MT_TRACER).mo20317a("getUsableHostList").m178147a("domain", str).m178147a("findV6", String.valueOf(z)).m178148b().mo20314e();
        try {
            if (this.openDNS && !TextUtils.isEmpty(str)) {
                checkInited();
        ...
        if (this.openDNS && !TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                if (!TextUtils.equals(host, strNativeGetUsableHost)) {
                    ...
                    MDLog.m7450i(LogTag.DNS, "replace %s ——> %s", str, strReplaceFirst);
                    ipHostMap.put(strNativeGetUsableHost, host);
                    this.dnsLogger.recordDnsResult(System.currentTimeMillis() - jCurrentTimeMillis, host, strNativeGetUsableHost);
    ...
    public void requestFailedForDomain(String str, String str2) {
        ...
        checkInited();
        MDLog.m7446e(LogTag.DNS, "Failed For Domain %s ——> %s", str, str2);
    ...
    public void requestFailedForOriURL(String str, String str2) {
        ...
        try {
            String host = new URL(str).getHost();
            MDLog.m7446e(LogTag.DNS, "Failed For Domain %s ——> %s", host, str2);
    ...
    public void requestSucceedForDomain(String str, String str2) {
        ...
        checkInited();
        MDLog.m7450i(LogTag.DNS, "Success For Domain %s ——> %s", str, str2);
        if (this.currentEnv == 11) {
            return;
        }
