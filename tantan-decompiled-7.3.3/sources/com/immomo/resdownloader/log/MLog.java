...
public class MLog {
    ...
    public static void m20458d(String str, String str2, Object... objArr) {
        if (TOGGLE) {
    ...
    public static void m20461e(String str, String str2, Object... objArr) {
    ...
    public static void m20462w(String str, String str2) {
    }

    /* JADX INFO: renamed from: e */
    public static void m20460e(String str, String str2) {
    ...
    /* JADX INFO: renamed from: d */
    public static void m20459d(String str, Object... objArr) {
        if (TOGGLE) {
