...
final class Executors$localExecutorInfo$2 extends Lambda implements Function0<Executors$ExecutorInfo> {
    public static final Executors$localExecutorInfo$2 INSTANCE = new Executors$localExecutorInfo$2();

    public Executors$localExecutorInfo$2() {
        super(0);
    }
