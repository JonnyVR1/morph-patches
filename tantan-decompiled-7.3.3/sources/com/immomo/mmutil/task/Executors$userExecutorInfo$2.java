...
final class Executors$userExecutorInfo$2 extends Lambda implements Function0<Executors$ExecutorInfo> {
    public static final Executors$userExecutorInfo$2 INSTANCE = new Executors$userExecutorInfo$2();

    public Executors$userExecutorInfo$2() {
        super(0);
    }
