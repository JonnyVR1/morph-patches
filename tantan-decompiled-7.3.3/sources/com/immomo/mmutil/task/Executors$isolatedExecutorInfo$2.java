...
final class Executors$isolatedExecutorInfo$2 extends Lambda implements Function0<Executors$ExecutorInfo> {
    public static final Executors$isolatedExecutorInfo$2 INSTANCE = new Executors$isolatedExecutorInfo$2();

    public Executors$isolatedExecutorInfo$2() {
        super(0);
    }
