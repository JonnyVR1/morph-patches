...
public class FaceFeatureHelper {
    private umw mMMFrame = new umw();
    private lnw mParamsInfo = new lnw(1);
    ...
    private void wrapFaceDetectParams(byte[] bArr, omw omwVar) {
        this.mMMFrame.m196802h(17);
        this.mMMFrame.m196807m(omwVar.f148018e);
        this.mMMFrame.m196804j(omwVar.f148019f);
        this.mMMFrame.m196801g(ByteBuffer.wrap(bArr).array());
        this.mMMFrame.m196800f(bArr.length);
        this.mMMFrame.m196806l(omwVar.f148018e);
        this.mParamsInfo.m154993A(omwVar.f148015b);
        this.mParamsInfo.m155031z(omwVar.f148016c);
        this.mParamsInfo.m155021p(omwVar.f148014a);
        this.mParamsInfo.m155013h(true);
        this.mParamsInfo.m155016k(false);
        this.mParamsInfo.m155017l(false);
        this.mParamsInfo.m155014i(false);
        this.mParamsInfo.m154998F(true);
        this.mParamsInfo.m155019n(false);
        this.mParamsInfo.m155028w(1);
        this.mParamsInfo.m155015j(2);
        this.mParamsInfo.m154994B(false);
    }

    public void transformFaceFeature(BefFaceInfo befFaceInfo, omw omwVar, int i, int i2) {
        int iM168305t = omwVar.m168305t();
        int iM168298m = omwVar.m168298m();
        int i3 = omwVar.f148015b;
        if (i3 == 90 || i3 == 270) {
            iM168305t = omwVar.m168298m();
            iM168298m = omwVar.m168305t();
        }
        omwVar.f148003A = (i * 1.0f) / iM168305t;
        BefFaceInfo.Face106[] face106s = befFaceInfo.getFace106s();
        VideoInfo videoInfoM168304s = omwVar.m168304s();
        videoInfoM168304s.facesinfo_ = new SingleFaceInfo[face106s.length];
        videoInfoM168304s.faces_attributes_ = new FaceAttribute[face106s.length];
        for (int i4 = 0; i4 < videoInfoM168304s.facesinfo_.length; i4++) {
            SingleFaceInfo singleFaceInfo = new SingleFaceInfo();
            BefFaceInfo.Face106 face106 = face106s[i4];
            transformFaceLandmark(singleFaceInfo, face106.getPoints_array(), iM168305t, iM168298m);
            ...
            videoInfoM168304s.facesinfo_[i4] = singleFaceInfo;
            FaceAttribute faceAttribute = new FaceAttribute();
            faceAttribute.expression_ = face106.getAction();
            videoInfoM168304s.faces_attributes_[i4] = faceAttribute;
        }
        omwVar.m168289a();
        if (ByteDanceFacerigHelper.isUseAnimojiFaceRig()) {
            wrapFaceDetectParams(omwVar.f148020g, omwVar);
            evf evfVarProcessFacrigFrame = ByteDanceFacerigHelper.processFacrigFrame(this.mMMFrame, this.mParamsInfo, omwVar);
            if (evfVarProcessFacrigFrame != null) {
                omwVar.m168287D(evfVarProcessFacrigFrame);
            }
        }
    }
}
