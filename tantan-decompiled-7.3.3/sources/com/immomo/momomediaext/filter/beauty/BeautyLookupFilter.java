...
public class BeautyLookupFilter extends jt2 {
    ...
    public void newTextureReady(int i, gfj gfjVar, boolean z) {
        ...
        umw umwVar = new umw();
        ImageUtils.decodeMMCVImage(umwVar, this.lookupPath);
        int i2 = this.lookupTexture;
        if (i2 == 0) {
            this.lookupTexture = TextureHelper.bitmapToTexture(umwVar);
        } else {
            this.lookupTexture = TextureHelper.loadDataToTexture(i2, umwVar);
        }
