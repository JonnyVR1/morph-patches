...
public final class BatteryMetrics extends BroadcastReceiver {
    ...
    private void getWifiInfo(Context context) {
        ...
        if (connectionInfo == null || connectionInfo.getBSSID() == null) {
            u6y.m194722F().m194779p0(this.mPhoneSignalLevel);
            u6y.m194722F().m194783r0("other");
            esx.m122396a("NetUtils", "wifi down.");
            return;
        }
        ...
        u6y.m194722F().m194779p0(iCalculateSignalLevel);
        u6y.m194722F().m194783r0("wifi");
        esx.m122396a("NetUtils", "ssid " + ssid + " level " + iCalculateSignalLevel + ",speed " + linkSpeed + ",rssi " + rssi);
    }
    ...
    public synchronized void init(Context context) {
        esx.m122399d(TAG, " context " + context + " | " + this.mContextRef);
        if (this.mContextRef == null) {
            WeakReference<Context> weakReference = new WeakReference<>(context.getApplicationContext());
            this.mContextRef = weakReference;
            if (weakReference.get() != null) {
                jj5.m145018l(this.mContextRef.get(), this, getFilter());
            }
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        esx.m122396a(TAG, "get update: ".concat(sb.toString()));
    }

    public synchronized void uninit() {
        esx.m122399d(TAG, "context " + this.mContextRef);
        try {
            try {
