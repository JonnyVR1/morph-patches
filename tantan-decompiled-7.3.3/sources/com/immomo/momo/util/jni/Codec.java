...
public class Codec {
    ...
    static {
        MDLog.m7450i("momoenc", "loadLibrary :%b", Boolean.valueOf(k0f.m147784a().loadLibrary("mjni")));
        hacc = null;
        pacc = null;
        acct = null;
        mccc = null;
    ...
    public static native String m20016dm();
    ...
    public static native String m20017dr();

    /* JADX INFO: renamed from: ds */
    public static native String m20018ds();

    /* JADX INFO: renamed from: du */
    public static native String m20019du();
    ...
    public static native String m20020em();
    ...
    public static native String m20021mm();
