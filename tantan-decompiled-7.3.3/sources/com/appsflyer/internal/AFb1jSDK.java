    ...
    public final String getMonetizationNetwork(AFb1qSDK aFb1qSDK) throws Throwable {
        ...
        try {
            ...
            if (fileArrListFiles != null && fileArrListFiles.length > 40) {
                AFLogger.INSTANCE.m5255i(AFg1cSDK.CACHE, "reached cache limit, not caching request");
                return null;
            }
            AFLogger aFLogger = AFLogger.INSTANCE;
            AFg1cSDK aFg1cSDK = AFg1cSDK.CACHE;
            ...
            try {
                ...
                aFLogger.m5255i(aFg1cSDK, "done, cacheKey: ".concat(String.valueOf(string)));
                try {
    ...
    public final void getMonetizationNetwork() {
        try {
            ...
            for (File file2 : fileArrListFiles) {
                ...
                sb2.append(" from cache");
                aFLogger.m5255i(aFg1cSDK, sb2.toString());
                file2.delete();
            }
        } catch (Exception e) {
            AFLogger.afErrorLog("CACHE: Could not cache request", e);
