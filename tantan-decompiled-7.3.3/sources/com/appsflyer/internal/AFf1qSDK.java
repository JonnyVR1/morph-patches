    ...
    public final AFe1dSDK getMonetizationNetwork() throws Exception {
        for (AFb1qSDK aFb1qSDK : this.component2.getCurrencyIso4217Code()) {
            ...
            try {
                ...
                aFe1aSDK.AFAdRevenueData.execute(aFe1aSDK.new RunnableC09595(new AFf1fSDK(aFh1lSDK, this.component3)));
            } catch (Exception e) {
                AFLogger.INSTANCE.m5251e(AFg1cSDK.QUEUE, "Failed to resend cached request", e);
            }
        }
