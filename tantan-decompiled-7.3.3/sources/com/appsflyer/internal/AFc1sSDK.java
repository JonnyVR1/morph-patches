...
public final class AFc1sSDK {
    ...
    private boolean m5219r_(Intent intent, Context context, AFc1kSDK aFc1kSDK) {
        String string;
        Uri uriM5220s_;
        Uri uri = null;
        ...
        if (data != null) {
            ...
            if (!aFj1sSDK.getCurrencyIso4217Code("af_consumed")) {
                aFj1sSDK.m5269I_("af_consumed", System.currentTimeMillis());
                m5222q_(context, aFc1kSDK, data);
                return true;
            }
        ...
        if (data2 != null) {
            ...
            if (!aFj1sSDK2.getCurrencyIso4217Code("af_consumed")) {
                aFj1sSDK2.m5269I_("af_consumed", System.currentTimeMillis());
                m5222q_(context, aFc1kSDK, data2);
                return true;
            }
        ...
        if (!aFj1sSDK3.getCurrencyIso4217Code("af_consumed")) {
            aFj1sSDK3.m5269I_("af_consumed", System.currentTimeMillis());
            m5222q_(context, aFc1kSDK, uri);
            return true;
        }
    ...
    private Uri m5220s_(Object obj, Iterator<String> it) {
    ...
    public final void AFAdRevenueData(Map<String, String> map) {
        ...
        try {
            try {
                ...
                AFLogger.INSTANCE.m5252e(AFg1cSDK.DDL, "Error occurred", e, true);
    ...
    public final void getCurrencyIso4217Code(String str, DeepLinkResult.Error error) {
        if (this.getRevenue == null) {
            ...
            AFLogger.INSTANCE.m5250d(AFg1cSDK.DDL, "Error occurred: ".concat(String.valueOf(str)));
    ...
    public final void getRevenue(DeepLinkResult deepLinkResult) {
        if (this.getRevenue == null) {
            AFLogger.INSTANCE.m5250d(AFg1cSDK.DDL, "skipping, no callback registered");
            return;
        }
    ...
    public final void m5221p_(AFc1kSDK aFc1kSDK, Intent intent, Context context) {
        ...
        if (!m5219r_(intent, context, aFc1kSDK) && this.getRevenue != null && this.areAllFieldsValid.getMediationNetwork().getRevenue.getMonetizationNetwork("appsFlyerCount", 0) == 0 && !this.areAllFieldsValid.getRevenue().AFAdRevenueData("ddl_sent")) {
            AFc1qSDK aFc1qSDK = new AFc1qSDK();
            AFe1aSDK aFe1aSDKCopy = this.areAllFieldsValid.copy();
            aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09595(new AFf1hSDK(aFc1qSDK, this.areAllFieldsValid)));
        }
        this.areAllFieldsValid.getRevenue().AFAdRevenueData("ddl_sent", true);
    }

    /* JADX INFO: renamed from: q_ */
    public final void m5222q_(Context context, AFc1kSDK aFc1kSDK, Uri uri) {
        AFf1iSDK aFf1iSDK = new AFf1iSDK(context, aFc1kSDK, uri, this.component1);
        AFe1aSDK aFe1aSDKCopy = this.areAllFieldsValid.copy();
        aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09595(aFf1iSDK));
