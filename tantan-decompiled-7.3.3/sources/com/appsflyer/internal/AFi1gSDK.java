...
public class AFi1gSDK extends AFi1hSDK {
    ...
    public class C09735 implements InstallReferrerStateListener {
        final /* synthetic */ Context val$context;
        final /* synthetic */ InstallReferrerClient val$referrerClient;

        public C09735(InstallReferrerClient installReferrerClient, Context context) {
        ...
        public final void onInstallReferrerServiceDisconnected() {
            AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Install Referrer service disconnected");
        }
    ...
    public final void AFAdRevenueData(InstallReferrerClient installReferrerClient, Context context, int i) {
        ...
        if (i == -1) {
            AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "InstallReferrer SERVICE_DISCONNECTED");
            ...
            try {
                ...
                aFLogger.m5250d(aFg1cSDK, "InstallReferrer connected");
                if (installReferrerClient.isReady()) {
                    ...
                    try {
                        ...
                        AFLogger.INSTANCE.m5253e(AFg1cSDK.REFERRER, "some method not exist", e2, false, false);
                    }
                    if (!map.isEmpty()) {
                    ...
                    aFLogger.m5257w(aFg1cSDK, "ReferrerClient: InstallReferrer is not ready");
                ...
                aFLogger2.m5257w(aFg1cSDK2, sb.toString());
                this.getCurrencyIso4217Code.put(NotificationCompat.CATEGORY_ERROR, th.getMessage());
                aFLogger2.m5253e(aFg1cSDK2, "Failed to get install referrer", th, false, false);
            }
        } else if (i == 1) {
            this.getMediationNetwork.put("response", "SERVICE_UNAVAILABLE");
            AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "InstallReferrer not supported");
        } else if (i == 2) {
            AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "InstallReferrer FEATURE_NOT_SUPPORTED");
            this.getMediationNetwork.put("response", "FEATURE_NOT_SUPPORTED");
        } else if (i != 3) {
            AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "responseCode not found.");
        } else {
            AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "InstallReferrer DEVELOPER_ERROR");
            this.getMediationNetwork.put("response", "DEVELOPER_ERROR");
        }
        AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Install Referrer collected locally");
        AFAdRevenueData();
    }
    ...
    public final void getMonetizationNetwork(Context context) {
        if (AFAdRevenueData(context)) {
            ...
            try {
                ...
                AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Connecting to Install Referrer Library...");
                installReferrerClientBuild.startConnection(new C09735(installReferrerClientBuild, context));
            } catch (Throwable th) {
                AFLogger.INSTANCE.m5251e(AFg1cSDK.REFERRER, "referrerClient -> startConnection", th);
            }
        }
    }
    ...
    private boolean AFAdRevenueData(@NonNull Context context) {
        ...
        try {
            if (AFb1vSDK.getCurrencyIso4217Code(context, "com.google.android.finsky.permission.BIND_GET_INSTALL_REFERRER_SERVICE")) {
                AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Install referrer is allowed");
                return true;
            }
            AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Install referrer is not allowed");
            return false;
        } catch (ClassNotFoundException e) {
            AFLogger.afErrorLogForExcManagerOnly("InstallReferrerClient not found", e);
            AFLogger.INSTANCE.m5256v(AFg1cSDK.REFERRER, "Class com.android.installreferrer.api.InstallReferrerClient not found");
            return false;
        } catch (Throwable th) {
            AFLogger.INSTANCE.m5251e(AFg1cSDK.REFERRER, "An error occurred while trying to verify manifest : ".concat("com.android.installreferrer.api.InstallReferrerClient"), th);
            return false;
        }
    }
}
