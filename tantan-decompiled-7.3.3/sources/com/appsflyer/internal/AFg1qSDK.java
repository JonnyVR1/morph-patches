...
public final class AFg1qSDK implements AFg1nSDK {
    ...
    public final void getMediationNetwork(@NotNull Map<String, Object> map, @NotNull AFf1zSDK aFf1zSDK) {
        ...
        revenue.getClass();
        revenue.put("api", MapsKt.mapOf(TuplesKt.m88129a(AppsFlyerProperties.ENABLE_TCF_DATA_COLLECTION, this.getCurrencyIso4217Code.getString(AppsFlyerProperties.ENABLE_TCF_DATA_COLLECTION))));
    }
}
