...
public final class AFj1ySDK extends AFi1hSDK {
    ...
    private boolean getCurrencyIso4217Code() {
        ...
        try {
            ...
            AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Xiaomi Install Referrer is allowed");
            return true;
        } catch (ClassNotFoundException unused) {
            AFLogger.INSTANCE.m5256v(AFg1cSDK.REFERRER, "Class com.miui.referrer.api.GetAppsReferrerClient not found");
            return false;
        } catch (Throwable th) {
            AFLogger.INSTANCE.m5251e(AFg1cSDK.REFERRER, "An error occurred while trying to access GetAppsReferrerClient", th);
            return false;
        }
    }
        ...
        if (getCurrencyIso4217Code()) {
            ...
            getAppsReferrerClientBuild.startConnection(new GetAppsReferrerStateListener() { // from class: com.appsflyer.internal.AFj1ySDK.2
                public final void onGetAppsReferrerSetupFinished(int i) {
                    ...
                    if (i == -1) {
                        AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "XiaomiInstallReferrer SERVICE_DISCONNECTED");
                        ...
                        try {
                            ...
                            aFLogger.m5250d(aFg1cSDK, "XiaomiInstallReferrer connected");
                            if (getAppsReferrerClient.isReady()) {
                                ...
                                aFLogger.m5257w(aFg1cSDK, "XiaomiReferrerClient: XiaomiInstallReferrer is not ready");
                            }
                        } catch (Throwable th) {
                        ...
                        AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "XiaomiInstallReferrer not supported");
                    } else if (i == 2) {
                        AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "XiaomiInstallReferrer FEATURE_NOT_SUPPORTED");
                        AFj1ySDK.this.getMediationNetwork.put("response", "FEATURE_NOT_SUPPORTED");
                    } else if (i == 3) {
                        AFLogger.INSTANCE.m5257w(AFg1cSDK.REFERRER, "XiaomiInstallReferrer DEVELOPER_ERROR");
                    ...
                    AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Xiaomi Install Referrer collected locally");
