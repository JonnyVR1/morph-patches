...
public final class AFi1tSDK extends AFi1wSDK {
    ...
    private static boolean m5265x_(NetworkCapabilities networkCapabilities) {
        ...
        try {
            ...
            if (connectivityManager != null && (allNetworks = connectivityManager.getAllNetworks()) != null) {
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        if (m5265x_((NetworkCapabilities) it.next())) {
                            return true;
                        }
                    }
                }
    ...
    public final String getMediationNetwork() {
        ...
        Sequence sequenceM94186O;
        Object next;
        ConnectivityManager connectivityManager = this.getMonetizationNetwork;
        if (connectivityManager != null && (allNetworks = connectivityManager.getAllNetworks()) != null && (sequenceAsSequence = ArraysKt.asSequence(allNetworks)) != null && (sequenceM94186O = SequencesKt___SequencesKt.m94186O(sequenceAsSequence, new Function1<Network, NetworkInfo>() { // from class: com.appsflyer.internal.AFi1tSDK.1
            {
                super(1);
            }
            ...
            Iterator it = sequenceM94186O.iterator();
            do {
                if (!it.hasNext()) {
                    next = null;
                    break;
                ...
                next = it.next();
            } while (!AFi1wSDK.m5267w_((NetworkInfo) next));
