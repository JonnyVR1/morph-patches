...
public final class AFb1vSDK {
    ...
    public static boolean AFAdRevenueData(@Nullable Context context) {
        if (context != null && Build.VERSION.SDK_INT >= 33) {
            try {
                return jox.m146483a(context.getApplicationContext().getSystemService(iox.m141358a())) != null;
            } catch (Throwable th) {
                AFLogger.INSTANCE.m5253e(AFg1cSDK.PRIVACY_SANDBOX, th.getMessage() != null ? th.getMessage() : "", th, false, false);
            }
        }
        return false;
    }
    ...
    public static boolean m5214c_(Context context, Intent intent) {
        return context.getPackageManager().queryIntentServices(intent, 0).size() > 0;
    }

    /* JADX WARN: Code duplicated, block: B:25:0x005a  */
    /* JADX INFO: renamed from: d_ */
    public static Map<String, String> m5215d_(Context context, Map<String, String> map, Uri uri) {
    ...
    public static String m5216e_(PackageManager packageManager, String str) throws NoSuchAlgorithmException, PackageManager.NameNotFoundException, CertificateException {
    ...
    public static Application m5217f_(@NonNull Context context) {
