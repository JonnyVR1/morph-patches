...
public final class AFg1lSDK {
    ...
    public static boolean getMediationNetwork(Context context) {
        ...
        try {
            ...
            return AFb1vSDK.m5214c_(context, new Intent(ServiceStarter.ACTION_MESSAGING_EVENT, null, context, FirebaseMessagingServiceListener.class));
        } catch (ClassNotFoundException unused) {
        } catch (Throwable th) {
            AFLogger.INSTANCE.m5251e(AFg1cSDK.UNINSTALL, "An error occurred while trying to verify manifest declarations: ", th);
        }
    }
    ...
    public static void AFAdRevenueData(String str) {
        ...
        aFe1aSDKCopy.AFAdRevenueData.execute(aFe1aSDKCopy.new RunnableC09595(aFf1bSDK));
    }
}
