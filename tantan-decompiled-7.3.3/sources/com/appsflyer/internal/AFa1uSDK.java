...
public final class AFa1uSDK implements AFd1vSDK {
    ...
    public final AFd1vSDK.AFa1ySDK getMonetizationNetwork(@NonNull Context context) {
        ...
        float f = 0.0f;
        try {
            Intent intentM145018l = jj5.m145018l(context, null, getMonetizationNetwork);
            if (intentM145018l != null) {
                if (2 == intentM145018l.getIntExtra(NotificationCompat.CATEGORY_STATUS, -1)) {
                    int intExtra = intentM145018l.getIntExtra("plugged", -1);
                    if (intExtra == 1) {
                ...
                int intExtra2 = intentM145018l.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1);
                int intExtra3 = intentM145018l.getIntExtra(BigEyeFilter.UNIFORM_SCALE, -1);
