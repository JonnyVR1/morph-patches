...
public final class AFd1nSDK implements AFd1fSDK {
    ...
    public final AFi1xSDK AFLogger() {
        if (this.f4252e == null) {
            ...
            if (context == null) {
                wtq0.m207906a("Context must be set via setContext method before calling this dependency.");
                return null;
            }
    ...
    public final AFi1mSDK afInfoLog() {
        try {
            ...
            AFLogger.INSTANCE.m5253e(AFg1cSDK.PLAY_INTEGRITY_API, th2.getMessage() != null ? th2.getMessage() : "", th2, false, false);
        }
    ...
    @NonNull
    /* JADX INFO: renamed from: d */
    public final synchronized AFc1eSDK mo5228d() {
        try {
    ...
    public final synchronized AFd1pSDK getMediationNetwork() {
        try {
            if (this.areAllFieldsValid == null) {
                ...
                AFd1tSDK aFd1tSDK = new AFd1tSDK(AFb1tSDK.m5209i_(context));
                if (this.afErrorLog == null) {
                    this.afErrorLog = new AFd1mSDK();
                }
    ...
    public final AFd1rSDK getRevenue() {
        Context context = this.getMediationNetwork.getCurrencyIso4217Code;
        if (context != null) {
            return new AFd1tSDK(AFb1tSDK.m5209i_(context));
        }
        wtq0.m207906a("Context must be set via setContext method before calling this dependency.");
        return null;
    }
