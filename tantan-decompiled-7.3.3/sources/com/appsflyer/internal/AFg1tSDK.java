...
public final class AFg1tSDK {
    ...
    private AFh1aSDK getCurrencyIso4217Code() {
        ...
        if (currencyIso4217Code == null) {
            AFLogger.INSTANCE.m5250d(AFg1cSDK.REMOTE_CONTROL, "No configuration found in cache");
            return null;
        }
        try {
            return new AFh1aSDK(new String(Base64.decode(currencyIso4217Code, 2), Charset.defaultCharset()));
        } catch (Exception e) {
            AFLogger.INSTANCE.m5252e(AFg1cSDK.REMOTE_CONTROL, "Error reading malformed configuration from cache, requires fetching from remote again", e, true);
            return null;
        }
    }
}
