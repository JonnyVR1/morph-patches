...
public abstract class AFf1oSDK<Result> extends AFf1wSDK<AFe1kSDK<Result>> {
    ...
    public final void getMediationNetwork(Throwable th) {
        ...
        if (th instanceof AFf1uSDK) {
            th2 = th;
            AFLogger.INSTANCE.m5253e(AFg1cSDK.HTTP_CLIENT, "AppsFlyer SDK is stopped: the request was not sent to the server", th2, true, false);
        } else {
            th2 = th;
            AFLogger.INSTANCE.m5254e(AFg1cSDK.HTTP_CLIENT, "Error while sending request to server: ".concat(String.valueOf(th2)), th2, true, true, z);
        }
    ...
    public AFe1dSDK getMonetizationNetwork() throws Exception {
        if (mo5242a_() && this.areAllFieldsValid.getMonetizationNetwork()) {
            AppsFlyerRequestListener appsFlyerRequestListenerComponent1 = component1();
            if (appsFlyerRequestListenerComponent1 != null) {
