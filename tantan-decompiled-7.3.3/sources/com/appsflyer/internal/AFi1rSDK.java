...
public final class AFi1rSDK extends AFi1wSDK {
    ...
    public AFi1rSDK(@NotNull Context context) {
        ...
        try {
            ...
            if (connectivityManager != null) {
                jj5.m145016j(connectivityManager, new NetworkRequest.Builder().build(), aFa1zSDK);
            }
        } catch (Throwable th) {
    ...
    private static boolean m5264z_(NetworkCapabilities networkCapabilities) {
    ...
    public final boolean AFAdRevenueData() {
        ...
        if (Intrinsics.m88377d(this.getMonetizationNetwork, "NetworkLost")) {
            network = null;
        }
        if (network == null) {
            return false;
        ...
        if (networkCapabilities != null) {
            return m5264z_(networkCapabilities);
        }
        return false;
    }
