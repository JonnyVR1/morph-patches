...
public final class AFh1bSDK {
    ...
    private static AFi1zSDK AFAdRevenueData(JSONObject jSONObject) {
        ...
        try {
            ...
            objM225066constructorimpl = Result.m225066constructorimpl(aFi1zSDK);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM225066constructorimpl = Result.m225066constructorimpl(ResultKt.m88127a(th));
        }
        return (AFi1zSDK) (Result.m225072isFailureimpl(objM225066constructorimpl) ? null : objM225066constructorimpl);
    }
    ...
    private static AFh1cSDK getMediationNetwork(JSONObject jSONObject) {
        ...
        try {
            ...
            objM225066constructorimpl = Result.m225066constructorimpl(mediationNetwork != null ? new AFh1cSDK(mediationNetwork.optDouble("send_rate", 1.0d)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM225066constructorimpl = Result.m225066constructorimpl(ResultKt.m88127a(th));
        }
        return (AFh1cSDK) (Result.m225072isFailureimpl(objM225066constructorimpl) ? null : objM225066constructorimpl);
    }
    ...
    private static AFh1fSDK getRevenue(JSONObject jSONObject) {
        ...
        try {
            ...
            objM225066constructorimpl = Result.m225066constructorimpl(mediationNetwork != null ? new AFh1fSDK(mediationNetwork.getString(Constants.PARAM_SDK_VER), mediationNetwork.optInt("min", -1), mediationNetwork.optInt("expire", -1), mediationNetwork.optLong("ttl", -1L)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM225066constructorimpl = Result.m225066constructorimpl(ResultKt.m88127a(th));
        }
        return (AFh1fSDK) (Result.m225072isFailureimpl(objM225066constructorimpl) ? null : objM225066constructorimpl);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.m88377d(AFh1bSDK.class, obj != null ? obj.getClass() : null)) {
            return false;
        }
        if (obj != null) {
            AFh1bSDK aFh1bSDK = (AFh1bSDK) obj;
            return Intrinsics.m88377d(this.getCurrencyIso4217Code, aFh1bSDK.getCurrencyIso4217Code) && Intrinsics.m88377d(this.getMonetizationNetwork, aFh1bSDK.getMonetizationNetwork) && Intrinsics.m88377d(this.getMediationNetwork, aFh1bSDK.getMediationNetwork);
        }
        mnd0.m159157a("null cannot be cast to non-null type com.appsflyer.internal.model.rc.Features");
        return false;
    }
