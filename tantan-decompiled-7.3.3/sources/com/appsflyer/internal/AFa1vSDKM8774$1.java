...
public final class AFa1vSDKM8774$1 extends HashMap<String, String> {
    private /* synthetic */ Object getCurrencyIso4217Code;

    public AFa1vSDKM8774$1(Object obj) {
        this.getCurrencyIso4217Code = obj;
        put(Network.AUTH_ACCOUNT, "ro.arch");
        put("ab", "ro.chipname");
        put(Network.AUTH_CORE, "ro.dalvik.vm.native.bridge");
