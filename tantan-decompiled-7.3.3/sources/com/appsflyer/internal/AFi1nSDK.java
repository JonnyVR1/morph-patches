...
public final class AFi1nSDK implements AFi1lSDK {
    ...
    public final Map<String, Object> getMonetizationNetwork() {
        Map<String, Object> mapMutableMapOf = MapsKt.mutableMapOf(TuplesKt.m88129a("platform", this.getMonetizationNetwork.getPlugin().getPluginName()), TuplesKt.m88129a(WBConstants.AUTH_PARAMS_VERSION, this.getMonetizationNetwork.getVersion()));
