...
public final class AFi1cSDK extends AFi1hSDK {
    ...
    private boolean getMediationNetwork(Context context) {
        if (!getMonetizationNetwork()) {
            AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Huawei referrer collection disallowed by counter.");
            return false;
        }
        if (!this.getCurrencyIso4217Code.getMediationNetwork(context)) {
            AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Huawei referrer collection disallowed by missing content provider.");
            return false;
        }
        if (this.getCurrencyIso4217Code.getRevenue(context)) {
            return true;
        }
        AFLogger.INSTANCE.m5250d(AFg1cSDK.REFERRER, "Huawei referrer collection disallowed by invalid content provider.");
        return false;
    }
    ...
    public /* synthetic */ void getRevenue(Context context) {
        ...
        try {
            ...
            try {
                ...
                AFLogger.INSTANCE.m5253e(AFg1cSDK.REFERRER, th.getMessage() != null ? th.getMessage() : "", th, false, true);
                if (0 != 0) {
                }
            } catch (Throwable th2) {
                if (0 == 0) {
