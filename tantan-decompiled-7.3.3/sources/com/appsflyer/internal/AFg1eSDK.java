...
public final class AFg1eSDK implements AFg1fSDK {
    ...
    public AFg1eSDK(@NotNull Context context, @NotNull AFi1lSDK aFi1lSDK, @NotNull AFd1vSDK aFd1vSDK, @NotNull AFj1uSDK aFj1uSDK, @NotNull AFb1zSDK aFb1zSDK, @NotNull AFh1qSDK aFh1qSDK, @NotNull AFd1rSDK aFd1rSDK, @NotNull AFd1pSDK aFd1pSDK, @NotNull AFi1xSDK aFi1xSDK, @NotNull AFg1rSDK aFg1rSDK, @NotNull AFb1aSDK aFb1aSDK, @NotNull AFd1kSDK aFd1kSDK, @NotNull AFg1kSDK aFg1kSDK, @NotNull AFd1mSDK aFd1mSDK) {
        ...
        this.copy = LazyKt__LazyJVMKt.m88118b(new Function0<AppsFlyerProperties>() { // from class: com.appsflyer.internal.AFg1eSDK.2
        ...
        this.AFKeystoreWrapper = LazyKt__LazyJVMKt.m88118b(new Function0<SimpleDateFormat>() { // from class: com.appsflyer.internal.AFg1eSDK.1
            @Override // kotlin.jvm.functions.Function0
            /* JADX INFO: renamed from: getCurrencyIso4217Code, reason: merged with bridge method [inline-methods] */
    ...
    private void AFLogger(@NotNull Map<String, Object> map) {
        map.getClass();
        AFb1ySDK aFb1ySDKM5201b_ = AFb1rSDK.m5201b_(this.getMonetizationNetwork.getContentResolver());
        if (aFb1ySDKM5201b_ == null) {
            AFInAppEventType = (values + 107) % 128;
            return;
        }
        values = (AFInAppEventType + 73) % 128;
        map.put("amazon_aid", aFb1ySDKM5201b_.AFAdRevenueData);
        map.put("amazon_aid_limit", String.valueOf(aFb1ySDKM5201b_.getMediationNetwork));
    }

    /* JADX INFO: renamed from: a */
    private static void m5245a(int[] iArr, boolean z, String str, Object[] objArr) throws UnsupportedEncodingException {
        String str2 = str;
        $11 = ($10 + 5) % 128;
        Object bytes = str2;
        if (str2 != null) {
    ...
    private static /* synthetic */ Object component1(Object[] objArr) {
        ...
        values = i % 128;
        if (i % 2 != 0) {
            return AFb1vSDK.m5216e_(aFg1eSDK.getMonetizationNetwork.getApplicationContext().getPackageManager(), aFg1eSDK.getMonetizationNetwork.getApplicationContext().getPackageName());
        }
        int i2 = 22 / 0;
        return AFb1vSDK.m5216e_(aFg1eSDK.getMonetizationNetwork.getApplicationContext().getPackageManager(), aFg1eSDK.getMonetizationNetwork.getApplicationContext().getPackageName());
    }
    ...
    */
    private static /* synthetic */ Object component2(Object[] objArr) {
        ...
        if (((AppsFlyerProperties) getCurrencyIso4217Code(new Object[]{aFg1eSDK}, -1797995787, 1797995794, System.identityHashCode(aFg1eSDK))).getBoolean(AppsFlyerProperties.COLLECT_ANDROID_ID, false)) {
            if (str != null) {
                int i = values + 23;
                AFInAppEventType = i % 128;
                if (i % 2 != 0) {
            ...
            if (i2 % 2 != 0) {
                aFg1eSDK.AFKeystoreWrapper();
                throw null;
            }
            if (aFg1eSDK.AFKeystoreWrapper()) {
                return aFg1eSDK.copy();
            }
            return null;
        }
        if (str != null) {
    ...
    private static void component3(@NotNull Map<String, Object> map) throws UnsupportedEncodingException {
        ...
        m5245a(new int[]{15, 5, 181, 3}, true, "\u0000\u0001\u0000\u0000\u0000", objArr);
    ...
    */
    private boolean component4() {
        ...
        values = i % 128;
        int i2 = i % 2;
        boolean currencyIso4217Code = this.component3.getCurrencyIso4217Code("appsFlyerCount");
        if (i2 == 0) {
            int i3 = 7 / 0;
        }
    }
    ...
    private void m5246d(@NotNull Map<String, Object> map) {
        getCurrencyIso4217Code(new Object[]{this, map}, -2016950660, 2016950665, System.identityHashCode(this));
    }

    /* JADX INFO: renamed from: e */
    private void m5247e(@NotNull Map<String, Object> map) {
        int i = values + 75;
        AFInAppEventType = i % 128;
        if (i % 2 != 0) {
            map.getClass();
    ...
    private final void getMonetizationNetwork(Map<String, Object> map) {
        ...
        try {
            ...
            Object[] objArr = new Object[1];
            m5245a(new int[]{0, 15, 0, 7}, true, "\u0001\u0001\u0000\u0001\u0001\u0001\u0001\u0001\u0001\u0001\u0001\u0000\u0001\u0001\u0001", objArr);
    ...
    private static PackageInfo m5248v_(PackageManager packageManager, String str) throws PackageManager.NameNotFoundException {
    ...
    private void valueOf(@NotNull Map<String, Object> map) {
        ...
        boolean z = false;
        boolean z2 = (str == null || Intrinsics.m88377d(str, strComponent4)) ? false : true;
    ...
    public final void AFAdRevenueData(@NotNull AFa1mSDK aFa1mSDK) throws UnsupportedEncodingException {
        ...
        AFLogger(revenue);
        revenue.put("cell", MapsKt.mapOf(TuplesKt.m88129a("mcc", Integer.valueOf(this.getMonetizationNetwork.getResources().getConfiguration().mcc)), TuplesKt.m88129a("mnc", Integer.valueOf(this.getMonetizationNetwork.getResources().getConfiguration().mnc))));
    ...
    public final void getRevenue(@NotNull AFa1mSDK aFa1mSDK) {
        ...
        if (aFh1pSDK2 != null) {
            ...
            if (i3 == 0) {
                Intrinsics.m88377d(bool, Boolean.TRUE);
                throw null;
            }
            zM88377d = Intrinsics.m88377d(bool, Boolean.TRUE);
        } else {
            zM88377d = false;
        }
        aFa1mSDK.getMonetizationNetwork("GAID_retry", String.valueOf(zM88377d));
    ...
    public final Long getMonetizationNetwork() throws PackageManager.NameNotFoundException {
        ...
        if (i2 == 0) {
            ...
            if (packageManager != null) {
                ...
                packageName.getClass();
                PackageInfo packageInfoM5248v_ = m5248v_(packageManager, packageName);
                if (packageInfoM5248v_ != null) {
                    int i3 = values + 31;
                    AFInAppEventType = i3 % 128;
                    if (i3 % 2 == 0) {
                        return Long.valueOf(packageInfoM5248v_.firstInstallTime);
                    }
                    long j = packageInfoM5248v_.firstInstallTime;
                    throw null;
                }
            }
        ...
        if (str != null) {
            if (map.get("af_deeplink") != null) {
                ...
                if (thM225069exceptionOrNullimpl != null) {
                    AFh1ySDK.e$default(AFLogger.INSTANCE, AFg1cSDK.GENERAL, "Exception while trying to create JSONObject from pushPayload", thM225069exceptionOrNullimpl, false, false, false, false, 120, null);
                } else {
                    AFInAppEventType = (values + 67) % 128;
                }
                Result.m225065boximpl(objM225066constructorimpl);
            }
        }
    ...
    private static File getMonetizationNetwork(String str) {
        if (str != null) {
            ...
            try {
                if (i % 2 != 0) {
                    if (StringsKt.m94324Z0(str).toString().length() > 0) {
                        return new File(StringsKt.m94324Z0(str).toString());
                    }
                } else {
                    StringsKt.m94324Z0(str).toString().length();
                    throw null;
                }
            } catch (Throwable th) {
    ...
    */
    ...
    public final void getCurrencyIso4217Code(@NotNull AFa1mSDK aFa1mSDK) {
        ...
        if (str != null && !StringsKt.m94329e0(str)) {
    ...
    private static String getCurrencyIso4217Code(@Nullable String str) {
        ...
        try {
            if (i % 2 == 0) {
                ...
                new Object[0][1] = str;
                objInvoke = method.invoke(null, null);
                if (objInvoke != null) {
