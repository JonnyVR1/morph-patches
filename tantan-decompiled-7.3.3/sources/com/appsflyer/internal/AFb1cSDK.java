...
public final class AFb1cSDK implements AFb1bSDK {
    ...
    private synchronized void AFAdRevenueData(String str, String str2, String str3) {
        ...
        try {
            ...
            m5198a("婹璸牍氲썥頋", 5 - (ViewConfiguration.getScrollBarSize() >> 8), objArr);
    ...
    private static void m5198a(String str, int i, Object[] objArr) {
        char[] charArray;
        $10 = ($11 + 101) % 128;
        if (str != null) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    AFLogger.INSTANCE.m5254e(AFg1cSDK.PROXY, "Error while starting remote debugger", th, true, true, true);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    private static /* synthetic */ Object getCurrencyIso4217Code(Object[] objArr) {
        ...
        try {
            if (i % 2 != 0) {
                aFb1cSDK.component1.getMonetizationNetwork().getMediationNetwork(aFb1cSDK.m5199n_(str, packageManager), aFb1cSDK.component1.AFKeystoreWrapper().component1);
                throw null;
            }
            final AFe1wSDK mediationNetwork = aFb1cSDK.component1.getMonetizationNetwork().getMediationNetwork(aFb1cSDK.m5199n_(str, packageManager), aFb1cSDK.component1.AFKeystoreWrapper().component1);
    ...
    private Map<String, Object> m5199n_(String str, PackageManager packageManager) {
        int i = equals + 99;
        hashCode = i % 128;
        int i2 = i % 2;
        AFd1fSDK aFd1fSDK = this.component1;
        if (i2 == 0) {
            m5200o_(str, packageManager, aFd1fSDK.AFKeystoreWrapper(), this.component1.mo5229e());
            copy();
            throw null;
        }
        m5200o_(str, packageManager, aFd1fSDK.AFKeystoreWrapper(), this.component1.mo5229e());
    ...
    private synchronized void m5200o_(String str, PackageManager packageManager, AFg1rSDK aFg1rSDK, AFd1mSDK aFd1mSDK) {
        try {
    ...
    public final synchronized void getMonetizationNetwork() {
        ...
        if (this.areAllFieldsValid || this.AFAdRevenueData) {
            ...
            try {
                ...
                AFLogger.INSTANCE.m5254e(AFg1cSDK.PROXY, "Error while stopping remote debugger", th, true, true, true);
            }
        }
    }
    ...
    public final void mo5197m_(String str, PackageManager packageManager) {
    ...
    */
    private static AFi1zSDK getRevenue(@Nullable AFh1aSDK aFh1aSDK) {
        AFh1bSDK aFh1bSDK;
        if (aFh1aSDK != null) {
            int i = hashCode + 125;
            equals = i % 128;
