...
public class HwAudioKaraokeFeatureKit extends AudioFeaturesKit {
    ...
    private ServiceConnection mConnection = new ServiceConnection() { // from class: com.huawei.multimedia.liteav.audiokit.interfaces.HwAudioKaraokeFeatureKit.1
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            TXCLog.m84152i(HwAudioKaraokeFeatureKit.TAG, "onServiceConnected");
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            TXCLog.m84152i(HwAudioKaraokeFeatureKit.TAG, "onServiceDisconnected");
    ...
    private IBinder.DeathRecipient mDeathRecipient = new IBinder.DeathRecipient() { // from class: com.huawei.multimedia.liteav.audiokit.interfaces.HwAudioKaraokeFeatureKit.2
        ...
        public void binderDied() {
            TXCLog.m84149e(HwAudioKaraokeFeatureKit.TAG, "binderDied");
    ...
    public void serviceInit(String str) {
        try {
            ...
            TXCLog.m84151e(TAG, "isFeatureSupported,RemoteException ex : %s", e.getMessage());
        }
    }
    ...
    public void serviceLinkToDeath(IBinder iBinder) {
        ...
        if (iBinder != null) {
            try {
                ...
                TXCLog.m84149e(TAG, "serviceLinkToDeath, RemoteException");
            }
        }
    }

    public void destroy() {
        TXCLog.m84153i(TAG, "destroy, mIsServiceConnected = %b", Boolean.valueOf(this.mIsServiceConnected));
    ...
    public int enableKaraokeFeature(boolean z) {
        TXCLog.m84153i(TAG, "enableKaraokeFeature, enable = %b", Boolean.valueOf(z));
        try {
            IHwAudioKaraokeFeature iHwAudioKaraokeFeature = this.mIHwAudioKaraokeFeatureAidl;
            if (iHwAudioKaraokeFeature == null || !this.mIsServiceConnected) {
                return -2;
            ...
            TXCLog.m84151e(TAG, "enableKaraokeFeature,RemoteException ex : %s", e.getMessage());
            return -2;
        }
    }

    public int getKaraokeLatency() {
        TXCLog.m84152i(TAG, "getKaraokeLatency");
        try {
            IHwAudioKaraokeFeature iHwAudioKaraokeFeature = this.mIHwAudioKaraokeFeatureAidl;
            if (iHwAudioKaraokeFeature == null || !this.mIsServiceConnected) {
                return -1;
            ...
            TXCLog.m84151e(TAG, "getKaraokeLatency,RemoteException ex : %s", e.getMessage());
            return -1;
        }
    }

    public void initialize(Context context) {
        TXCLog.m84152i(TAG, "initialize");
        if (context == null) {
            TXCLog.m84152i(TAG, "initialize, context is null");
        } else if (this.mFeatureKitManager.isAudioKitSupport(context)) {
            bindService(context);
        } else {
            this.mFeatureKitManager.onCallBack(2);
            TXCLog.m84152i(TAG, "initialize, not install AudioEngine");
        }
    }

    public boolean isKaraokeFeatureSupport() {
        TXCLog.m84152i(TAG, "isKaraokeFeatureSupport");
        try {
            IHwAudioKaraokeFeature iHwAudioKaraokeFeature = this.mIHwAudioKaraokeFeatureAidl;
            if (iHwAudioKaraokeFeature == null || !this.mIsServiceConnected) {
                return false;
    ...
    public int setParameter(ParameName parameName, int i) {
        ...
        try {
            TXCLog.m84153i(TAG, "parame.getParameName() = %s, parameValue = %d", parameName.getParameName(), Integer.valueOf(i));
            IHwAudioKaraokeFeature iHwAudioKaraokeFeature = this.mIHwAudioKaraokeFeatureAidl;
            if (iHwAudioKaraokeFeature == null || !this.mIsServiceConnected) {
                return -2;
            }
            ...
            TXCLog.m84151e(TAG, "setParameter,RemoteException ex : %s", e.getMessage());
            return -2;
        }
    }
}
