...
final class C3476 {
    ...
    private static int f11843 = 0;

    /* JADX INFO: renamed from: ॱ */
    private static int f11845 = 1;

    /* JADX INFO: renamed from: ˏ */
    private static final byte[] f11844 = {42, 97, -55, 88, -12, 11, -13, 4, 7, 6, 55, -52, -11, 2, -5, Tnaf.POW_2_WIDTH, -8, -5, 71, -20, -43, 2, -5, Tnaf.POW_2_WIDTH, -18, 5, -11, 3, 64, -56, -7, 1, 9, -4, 8, 56, -50, -12, 11, -13, 4, 7, 6, 55, -56, -5, -5, -11, 3, 64, -56, -7, 1, 9, -4, 8, 56, -50, -12, 11, -13, 4, 7, 6, 55, -56, -5, -5, 70, -50, -2, -14, 70, -58, 6, 0, -8, -5, 12, 4, -2, 5, -12, 69, PSSSigner.TRAILER_IMPLICIT, 15, -12, -3, 14, 7, -1, 56, -36, 0, 20, -16, -1, -11, 3, 64, -50, -12, 11, -13, 4, 7, 6, 55, -71, 18, -8, 11, -4, -4, 8, 3, -14, 37, -16, -1, -7, 11, -5, 3, 25, -19, -12, 14, -5, 3, -12};

    /* JADX INFO: renamed from: ˊ */
    private static int f11842 = 130;
    ...
    public static class C22803 implements IInterface {

        /* JADX INFO: renamed from: ˋ */
        private static int f11846 = 0;

        /* JADX INFO: renamed from: ˎ */
        private static final byte[] f11847 = {30, 53, -82, 52, -17, -3, HttpTokens.COLON, -62, -13, -5, 3, -10, 2, 50, -56, -18, 5, -19, -2, 1, 0, 49, -62, -11, -11, 64, -56, -8, -20, 64, -64, 0, -6, -14, -11, 6, -2, -8, -1, -18, Utf8.REPLACEMENT_BYTE, -64, -10, -11, 10, -18, -1, 8, -16, 57, -32, 3, -40, -23, 12, -18, -7, 6, -15, 5, -10, 2, 25, -32, 12, -23, -18, -9, 8, 1, -7};

        /* JADX INFO: renamed from: ॱ */
        private static int f11848 = 1;

        /* JADX INFO: renamed from: ˏ */
        private IBinder f11849;

        public C22803(IBinder iBinder) {
            this.f11849 = iBinder;
        }

        @Override // android.os.IInterface
        public final IBinder asBinder() {
            int i = (f11846 + 111) % 128;
            f11848 = i;
            IBinder iBinder = this.f11849;
            f11846 = ((i & 41) + (i | 41)) % 128;
            return iBinder;
        }
        ...
        /*  JADX ERROR: JadxOverflowException in pass: RegionMakerVisitor
            ...
            */
        /* JADX INFO: renamed from: ˏ */
        public final java.lang.String m17513() throws android.os.RemoteException {
            /*
                Method dump skipped, instruction units count: 204
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.guardsquare.dexguard.runtime.devicefingerprinting.C3476.C22803.m17513():java.lang.String");
        }
    }

    /* JADX INFO: renamed from: ˎ */
    public static String m17511(Context context) throws Throwable {
        f11845 = (f11843 + 33) % 128;
        try {
            byte[] bArr = f11844;
            ((PackageManager) Class.forName(m17512((short) 28, AlertDescription.certificate_unobtainable, bArr[75])).getMethod(m17512((short) 34, bArr[75], bArr[27]), null).invoke(context, null)).getPackageInfo(m17512((byte) (f11842 >>> 2), bArr[109], bArr[31]), 0);
            Intent intent = new Intent(m17512(bArr[75], (byte) (-bArr[84]), bArr[31]));
            byte b = bArr[3];
            intent.setPackage(m17512((short) 29, (byte) ((b ^ 1) + ((b & 1) << 1)), bArr[31]));
            ServiceConnectionC22804 serviceConnectionC22804 = new ServiceConnectionC22804((byte) 0);
            try {
                if (context.bindService(intent, serviceConnectionC22804, 1)) {
                    String strM17513 = new C22803(serviceConnectionC22804.m17514()).m17513();
                    context.unbindService(serviceConnectionC22804);
                    f11843 = (f11845 + 93) % 128;
                    return strM17513;
                }
                context.unbindService(serviceConnectionC22804);
                int i = (f11843 + 11) % 128;
    ...
    /* JADX INFO: renamed from: ॱ */
    private static String m17512(short s, short s2, short s3) {
        int i;
        int i2;
        byte[] bArr;
        int i3;
    ...
    public static class ServiceConnectionC22804 implements ServiceConnection {

        /* JADX INFO: renamed from: ˋ */
        private static int f11850 = 0;

        /* JADX INFO: renamed from: ˏ */
        private static int f11851 = 1;

        /* JADX INFO: renamed from: ˊ */
        private final LinkedBlockingQueue<IBinder> f11852;

        private ServiceConnectionC22804() {
            this.f11852 = new LinkedBlockingQueue<>(1);
        }
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            f11850 = i % 128;
            int i2 = i % 2;
            LinkedBlockingQueue<IBinder> linkedBlockingQueue = this.f11852;
            try {
                if (i2 == 0) {
        ...
        /* JADX INFO: renamed from: ˋ */
        public final IBinder m17514() throws InterruptedException {
            int i = f11851 + 109;
            f11850 = i % 128;
            int i2 = i % 2;
            IBinder iBinderTake = this.f11852.take();
            if (i2 != 0) {
                throw null;
            }
            int i3 = f11851;
            f11850 = ((i3 ^ 5) + ((i3 & 5) << 1)) % 128;
            return iBinderTake;
        }

        public /* synthetic */ ServiceConnectionC22804(byte b) {
            this();
        }
    }
}
