...
public class JSObject extends JSValue {
        ...
        for (final Method method : obj.getClass().getMethods()) {
            if (method.getAnnotation(JavascriptInterface.class) != null) {
                ...
                if (method.getReturnType().equals(Void.TYPE)) {
                    jSObject.registerJavaMethod(new JavaVoidCallback() { // from class: l.xkq
                        @Override // com.quickjs.JavaVoidCallback
                        public final void invoke(JSObject jSObject2, JSArray jSArray) {
                            JSObject.m81552b(method, obj, jSObject2, jSArray);
                        }
                    }, name);
                } else {
                    jSObject.registerJavaMethod(new JavaCallback() { // from class: l.ykq
                        @Override // com.quickjs.JavaCallback
                        public final Object invoke(JSObject jSObject2, JSArray jSArray) {
                            return JSObject.m81553d(method, obj, jSObject2, jSArray);
                        }
                    }, name);
                }
            }
    ...
    public static /* synthetic */ void m81552b(Method method, Object obj, JSObject jSObject, JSArray jSArray) {
        try {
    ...
    public static /* synthetic */ Object m81553d(Method method, Object obj, JSObject jSObject, JSArray jSArray) {
        try {
    ...
    public static /* synthetic */ Object m81554e(JavaConstructorCallback javaConstructorCallback, JSObject jSObject, JSArray jSArray) {
    ...
    public JSFunction registerClass(final JavaConstructorCallback javaConstructorCallback, String str) {
        JavaCallback javaCallback = new JavaCallback() { // from class: l.zkq
            @Override // com.quickjs.JavaCallback
            public final Object invoke(JSObject jSObject, JSArray jSArray) {
                return JSObject.m81554e(javaConstructorCallback, jSObject, jSArray);
            }
        };
