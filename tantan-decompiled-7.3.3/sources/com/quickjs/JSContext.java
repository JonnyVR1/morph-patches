...
public class JSContext extends JSObject implements Closeable {
    ...
    private void checkReleaseObjPtrPool() {
        getQuickJS().postEventQueue(new Runnable() { // from class: l.nkq
            @Override // java.lang.Runnable
            public final void run() {
                JSContext.m81550g(this.f142477a);
            }
        });
    }

    /* JADX INFO: renamed from: g */
    public static /* synthetic */ void m81550g(JSContext jSContext) {
    ...
    public static /* synthetic */ void m81551h(JSContext jSContext) {
    ...
    public void close() {
        postEventQueue(new Runnable() { // from class: l.mkq
            @Override // java.lang.Runnable
            public final void run() {
                JSContext.m81551h(this.f137327a);
            }
        });
    }
