...
public abstract class WorkerPlugin extends Plugin {
    ...
    public static class Worker implements Closeable {
        ...
        public static /* synthetic */ void m81563d(Worker worker, String str) {
        ...
        public static /* synthetic */ void m81564e(Worker worker, String str) {
        ...
        public void sendMessageReceiver(final String str) {
            this.workerObj.postEventQueue(new Runnable() { // from class: com.quickjs.plugin.a
                ...
                public final void run() {
                    WorkerPlugin.Worker.m81563d(this.f55746a, str);
                }
            });
        }
        ...
        public void close() {
            ...
            quickJS.getClass();
            quickJS.postEventQueue(new Runnable() { // from class: l.jkq0
                @Override // java.lang.Runnable
                public final void run() {
                    quickJS.close();
                }
        ...
        public void postMessage(final String str) {
            this.quickJS.postEventQueue(new Runnable() { // from class: com.quickjs.plugin.c
                @Override // java.lang.Runnable
                public final void run() {
                    WorkerPlugin.Worker.m81564e(this.f55749a, str);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m81561a(WorkerPlugin workerPlugin, JSObject jSObject, JSArray jSArray) {
    ...
    public void setup(JSContext jSContext) {
        jSContext.registerClass(new JavaConstructorCallback() { // from class: l.ikq0
            @Override // com.quickjs.JavaConstructorCallback
            public final void invoke(JSObject jSObject, JSArray jSArray) {
                WorkerPlugin.m81561a(this.f115441a, jSObject, jSArray);
            }
