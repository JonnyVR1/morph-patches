...
public class TimeCodeBox extends AbstractBox implements SampleEntry {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.dataReferenceIndex = y0q.m213893i(byteBuffer);
        this.reserved1 = byteBuffer.getInt();
        this.flags = y0q.m213895k(byteBuffer);
        this.timeScale = byteBuffer.getInt();
        this.frameDuration = byteBuffer.getInt();
        this.numberOfFrames = y0q.m213898n(byteBuffer);
        this.reserved2 = y0q.m213894j(byteBuffer);
    ...
    public void getContent(ByteBuffer byteBuffer) {
        ...
        b1q.m101493e(byteBuffer, this.dataReferenceIndex);
        byteBuffer.putInt(this.reserved1);
        b1q.m101495g(byteBuffer, this.flags);
        byteBuffer.putInt(this.timeScale);
        byteBuffer.putInt(this.frameDuration);
        b1q.m101498j(byteBuffer, this.numberOfFrames);
        b1q.m101494f(byteBuffer, this.reserved2);
    ...
    public void setReserved2(int i) {
        f3d0.m123722b().m123723c(Factory.makeJP(ajc$tjp_12, this, this, Conversions.intObject(i)));
        this.reserved2 = i;
    }

    public void setRest(byte[] bArr) {
        f3d0.m123722b().m123723c(Factory.makeJP(ajc$tjp_16, this, this, bArr));
        this.rest = bArr;
    }
