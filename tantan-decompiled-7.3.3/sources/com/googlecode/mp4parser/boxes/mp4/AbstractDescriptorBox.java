...
public class AbstractDescriptorBox extends AbstractFullBox {
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        try {
            this.data.rewind();
            this.descriptor = b950.m103053a(-1, this.data);
        } catch (IOException e) {
    ...
    public void setData(ByteBuffer byteBuffer) {
        f3d0.m123722b().m123723c(Factory.makeJP(ajc$tjp_4, this, this, byteBuffer));
        this.data = byteBuffer;
    }

    public void setDescriptor(cj2 cj2Var) {
        f3d0.m123722b().m123723c(Factory.makeJP(ajc$tjp_3, this, this, cj2Var));
        this.descriptor = cj2Var;
    }
}
