...
public class LogThreadPoolManager {
    ...
    private LogThreadPoolManager() {
        ...
        ThreadFactory threadFactory = new ThreadFactory() { // from class: com.alibaba.sdk.android.oss.common.LogThreadPoolManager.2
        ...
        this.mThreadPool = new ThreadPoolExecutor(1, 1, Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS, timeUnit, arrayBlockingQueue, threadFactory, rejectedExecutionHandler);
