...
public final class JSONScanner extends JSONLexerBase {
    ...
    public String info() {
        ...
        if (length < 65535) {
            ...
            sb.append(str.substring(0, p7f.COLOR_SPACE_UNCALIBRATED));
        }
        return sb.toString();
    }
    ...
    public final int scanInt(char c) {
        ...
        while (true) {
            ...
            int i9 = i8 * 10;
            if (i9 < i8) {
                wkq.m206856a("parseInt error : ", subString(i2, i3));
                return 0;
            }
            i8 = i9 + (cCharAt - '0');
            i3 = i;
    ...
    public boolean seekArrayToItem(int i) {
        if (i < 0) {
            za50.m219101a("index must > 0, but ", i);
            return false;
        }
        int i2 = this.token;
        if (i2 == 20) {
        ...
        if (i != 13) {
            ...
            if (i != 15) {
                ...
                while (true) {
                    ...
                    while (i5 < this.text.length()) {
                        ...
                        if (cCharAt == '\\') {
                            ...
                            if (i5 == this.text.length()) {
                                wkq.m206856a("unclosed str, ", info());
                                return 0;
                            }
                    ...
                    if (this.f3873ch != ':') {
                        wkq.m206856a("illegal json, ", info());
                        return 0;
                    }
                    int i12 = this.f3872bp + 1;
                    this.f3872bp = i12;
