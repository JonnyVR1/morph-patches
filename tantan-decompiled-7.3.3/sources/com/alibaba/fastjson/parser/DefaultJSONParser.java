...
public class DefaultJSONParser implements Closeable {
    ...
    public final void accept(int i) {
        ...
        if (jSONLexer.token() == i) {
            ...
            pg60.m172225a("syntax error, expect ", JSONToken.name(i), ", actual ", JSONToken.name(jSONLexer.token()));
        }
    }
    ...
    public void acceptType(String str) {
        ...
        if (jSONLexer.token() != 4) {
            qkq.m176968a("type not match error");
            return;
        }
    ...
    public Object[] parseArray(Type[] typeArr) {
        ...
        int i4 = 14;
        if (i3 != 14) {
            wkq.m206856a("syntax error : ", this.lexer.tokenName());
            return null;
        }
                    ...
                    if (!zIsArray || this.lexer.token() == i4) {
                        ...
                        if (this.lexer.token() != 15) {
                            ...
                            if (jSONLexer.token() != 15) {
                                wkq.m206856a("syntax error :", JSONToken.name(this.lexer.token()));
                                return objArr4;
                            }
                        } else {
                            objArr3 = objArr5;
    ...
    public Object parseArrayWithType(Type type) {
        ...
        if (actualTypeArguments.length != 1) {
            rkq.m181878a("not support type ", type);
            return null;
        }
        ...
        if (type2 instanceof TypeVariable) {
            ...
            if (bounds.length != 1) {
                rkq.m181878a("not support : ", typeVariable);
                return null;
            }
            Type type4 = bounds[0];
    ...
    public final Object parseObject(Map map, Object obj) {
        ...
        if (jSONLexer.token() != 12 && jSONLexer.token() != 16) {
            pg60.m172225a("syntax error, expect {, actual ", jSONLexer.tokenName(), ", ", jSONLexer.info());
            return null;
        }
    ...
    public void parseArray(Type type, Collection collection, Object obj) {
        ...
        if (i == 14) {
            ...
            pg60.m172225a("expect '[', but ", JSONToken.name(i), ", ", this.lexer.info());
        }
    }
    ...
    public Object parse(Object obj) {
        ...
        if (i == 18) {
            ...
            wkq.m206856a("syntax error, ", jSONLexer.info());
            return null;
        }
        if (i != 26) {
            switch (i) {
                ...
                default:
                    switch (i) {
                        case 20:
                            ...
                            wkq.m206856a("unterminated json string, ", jSONLexer.info());
                            return null;
                        case 21:
                            jSONLexer.nextToken();
    ...
    public void parseObject(Object obj) {
        ...
        if (this.lexer.token() != 12 && this.lexer.token() != 16) {
            wkq.m206856a("syntax error, expect {, actual ", this.lexer.tokenName());
            return;
        }
        while (true) {
            ...
            if (fieldDeserializer == null) {
                if (this.lexer.isEnabled(Feature.IgnoreNotMatch)) {
                    ...
                    pg60.m172225a("setter not found, class ", cls.getName(), ", property ", strScanSymbol);
                    return;
                }
            } else {
