...
public class ParserConfig {
    ...
    public Class<?> checkAutoType(String str, Class<?> cls, int i) throws Throwable {
        ...
        if (str.length() >= 192 || str.length() < 3) {
            qkq.m176968a("autoType is not support. ".concat(str));
            return null;
        }
        ...
        if (clsLoadClass != null) {
            ...
            pg60.m172225a("type not match. ", str, " -> ", cls.getName());
            return null;
        }
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> cls, Type type) {
        ...
        try {
            ...
            okq.m168043a("create asm deserializer error, ".concat(cls2.getName()), e);
            return null;
        }
    }
