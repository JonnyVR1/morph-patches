...
public class AwtCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type == Point.class) {
            ...
            if (type != Font.class) {
                rkq.m181878a("not support awt class : ", type);
                return null;
            }
        ...
        while (jSONLexer.token() != 13) {
            ...
            if (strStringVal.equalsIgnoreCase("r")) {
                ...
                if (!strStringVal.equalsIgnoreCase("alpha")) {
                    qkq.m176968a("syntax error, ".concat(strStringVal));
                    return null;
                }
                i4 = iIntValue;
            }
        ...
        while (jSONLexer.token() != 13) {
            ...
            if (strStringVal2.equalsIgnoreCase(AuthenticationTokenClaims.JSON_KEY_NAME)) {
                ...
                if (!strStringVal2.equalsIgnoreCase("size")) {
                    qkq.m176968a("syntax error, ".concat(strStringVal2));
                    return null;
                }
                if (jSONLexer.token() != 2) {
                    qkq.m176968a("syntax error");
        ...
        while (jSONLexer.token() != 13) {
            ...
            if (JSON.DEFAULT_TYPE_KEY.equals(strStringVal)) {
                ...
                if (i3 == 2) {
                    ...
                    if (i3 != 3) {
                        wkq.m206856a("syntax error : ", jSONLexer.tokenName());
                        return null;
                    }
                    iFloatValue = (int) jSONLexer.floatValue();
                    jSONLexer.nextToken();
                }
                if (strStringVal.equalsIgnoreCase(BaseSei.f14624X)) {
                    i = iFloatValue;
                } else {
                    if (!strStringVal.equalsIgnoreCase(BaseSei.f14625Y)) {
                        qkq.m176968a("syntax error, ".concat(strStringVal));
                        return null;
                    }
                    i2 = iFloatValue;
    ...
    public Rectangle parseRectangle(DefaultJSONParser defaultJSONParser) {
        ...
        while (jSONLexer.token() != 13) {
            ...
            if (strStringVal.equalsIgnoreCase(BaseSei.f14624X)) {
                i = iFloatValue;
            } else if (strStringVal.equalsIgnoreCase(BaseSei.f14625Y)) {
                i2 = iFloatValue;
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (obj instanceof Point) {
            ...
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Point.class, '{'), BaseSei.f14624X, point.x);
            serializeWriter.writeFieldValue(',', BaseSei.f14625Y, point.y);
            ...
            serializeWriter.writeFieldValue(writeClassName(serializeWriter, Rectangle.class, '{'), BaseSei.f14624X, rectangle.x);
            serializeWriter.writeFieldValue(',', BaseSei.f14625Y, rectangle.y);
            serializeWriter.writeFieldValue(',', "width", rectangle.width);
            serializeWriter.writeFieldValue(',', "height", rectangle.height);
        } else {
            if (!(obj instanceof Color)) {
                qkq.m176968a("not support awt class : ".concat(obj.getClass().getName()));
                return;
            }
