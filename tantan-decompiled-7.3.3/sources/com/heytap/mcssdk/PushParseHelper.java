...
import com.heytap.mcssdk.p041a.AbstractC3616c;
...
public class PushParseHelper {
    public static void parseCommandMessage(Context context, CommandMessage commandMessage, PushManager pushManager) {
        if (context == null) {
            LogUtil.m18545e("context is null , please check param of parseCommandMessage(2)");
        }
        if (commandMessage == null) {
            LogUtil.m18545e("message is null , please check param of parseCommandMessage(2)");
            return;
        }
        if (pushManager == null) {
            LogUtil.m18545e("pushManager is null , please check param of parseCommandMessage(2)");
            return;
        }
        if (pushManager.getPushCallback() == null) {
            LogUtil.m18545e("pushManager.getPushCallback() is null , please check param of parseCommandMessage(2)");
            return;
        }
    ...
    public static void parseIntent(Context context, Intent intent, MessageCallback messageCallback) {
        ...
        if (context == null) {
            ...
            if (messageCallback != null) {
                for (Message message : AbstractC3616c.m18539a(context, intent)) {
                    if (message != null) {
                        for (InterfaceC3622c interfaceC3622c : PushManager.getInstance().getProcessors()) {
                            if (interfaceC3622c != null) {
                                interfaceC3622c.mo18540a(context, message, messageCallback);
                            }
                        }
                    }
                }
    ...
    public static void parseCommandMessage(Context context, CommandMessage commandMessage, PushCallback pushCallback) {
        if (context == null) {
            LogUtil.m18545e("context is null , please check param of parseCommandMessage()");
        }
        if (commandMessage == null) {
            LogUtil.m18545e("message is null , please check param of parseCommandMessage()");
            return;
        }
        if (pushCallback == null) {
            LogUtil.m18545e("callback is null , please check param of parseCommandMessage()");
            return;
        }
        switch (commandMessage.getCommand()) {
            case CommandMessage.COMMAND_REGISTER /* 12289 */:
