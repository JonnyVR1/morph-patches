...
public class ReceiverChannel extends BroadcastReceiver {
    ...
    public static void registerChannelReceiver(String str) {
        ...
        MDLog.m7449i(LogTag.CHANNEL, "registerChannelReceiver");
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            jj5.m145018l(AppContext.getContext(), sChannelReceiver, intentFilter);
        }
    }
    ...
    public static void sendChannelRequest(String str) {
        ...
        MDLog.m7450i(LogTag.CHANNEL, "sendBRChannelRequest %s", packageName);
        AppContext.getContext().sendBroadcast(intent);
    }

    public static void unRegisterChannelReceiver() {
        MDLog.m7449i(LogTag.CHANNEL, "unRegisterChannelReceiver");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        MDLog.m7450i(LogTag.CHANNEL, "BR onReceive packageName:%s", stringExtra);
