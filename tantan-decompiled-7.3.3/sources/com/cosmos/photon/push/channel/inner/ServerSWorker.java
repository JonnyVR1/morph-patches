        ...
        private int processConnect(LocalSocket localSocket) throws Throwable {
            ...
            try {
                try {
                    ...
                    MDLog.m7449i(LogTag.CHANNEL, "serverSocket accept connection: uid:" + peerCredentials.getUid() + " pid:" + peerCredentials.getPid());
                            ...
                            try {
                                try {
                                    ...
                                    if (iHashCode != 931221187) {
                                        ...
                                        MDLog.m7449i(LogTag.CHANNEL, "serverSocket accept cmd: " + line);
        ...
        public void run() {
            try {
                try {
                    ...
                    MDLog.m7449i(LogTag.CHANNEL, "serverSocket begin listener: " + ServerSWorker.this.mAddress);
                ...
                MDLog.m7449i(LogTag.CHANNEL, "ServerSocketThread end");
            } catch (Throwable th) {
                if (this.server != null) {
                    try {
                        this.server.close();
