...
public class ClientWorker {
    ...
    public static void onReceiver(String str) {
        MDLog.m7450i(LogTag.CHANNEL, "query by Receiver：%s", str);
        Object obj = lock;
        synchronized (obj) {
            try {
                sPackageName = str;
    ...
    public static boolean sendMessage(final String str, final String str2, int i, final StringBuilder sb) {
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            MDLog.m7450i(LogTag.CHANNEL, "send:-------->\n %s", str2);
                            ...
                            try {
                                ...
                                try {
                                    try {
                                        ...
                                        MDLog.m7445e(LogTag.CHANNEL, e.getMessage());
                                        reentrantLock.lock();
                                        try {
                                            conditionNewCondition.signalAll();
                                        } catch (Throwable th3) {
        ...
        MDLog.m7450i(LogTag.CHANNEL, "query by LocalSocket：%s", sb);
        return z;
    }

    public static String sendMessageByBR(String str, int i) {
        MDLog.m7450i(LogTag.CHANNEL, "sendMessageByBR：%d", Integer.valueOf(i));
        Object obj = lock;
        synchronized (obj) {
    ...
    public static String sendMessageByFile(String str) {
        ...
        MDLog.m7450i(LogTag.CHANNEL, "query by file：%s", config);
        return config;
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    MDLog.m7450i(LogTag.CHANNEL, "simple send:-------->\n %s", str2);
