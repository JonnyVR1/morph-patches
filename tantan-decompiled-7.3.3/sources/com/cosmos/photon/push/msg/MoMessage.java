...
public class MoMessage implements Serializable {
    ...
    public String toString() {
        return "MoMessage{id='" + this.f5846id + "', toPkg='" + this.toPkg + "', time=" + this.time + ", type=" + this.type + ", text='" + this.text + "'}";
    }

    public static MoMessage create(MsgV2 msgV2) {
        MoMessage moMessage = new MoMessage();
        moMessage.f5846id = msgV2.getId();
