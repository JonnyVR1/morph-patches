...
public class Res {
    ...
    public static Bitmap getAppIconV26(PackageManager packageManager, String str) {
        try {
            ...
            if (!g3d0.m128724a(applicationIcon)) {
                return null;
            }
            LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{h3d0.m133463a(applicationIcon).getBackground(), h3d0.m133463a(applicationIcon).getForeground()});
    ...
    public static final int m7461id(Context context, String str) {
