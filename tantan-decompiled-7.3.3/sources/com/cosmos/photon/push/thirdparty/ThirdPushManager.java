...
import com.cosmos.photon.push.thirdparty.p026mi.MiPushEngine;
...
public class ThirdPushManager {
    ...
    public class DefaultBridge extends PushBridge {
        ...
        public void onGetTokenResult(boolean z, String str) {
            PushLogger.m7458i("DefaultBridge onGetTokenResult ----> " + z + " - " + str);
        }

        @Override // com.cosmos.photon.push.thirdparty.IPushBridge
        public void onPushRegisterResult(int i, int i2, String str) {
            PushLogger.m7458i("DefaultBridge onPushRegisterResult ----> " + i + " - " + i2 + " - " + str);
            this.registerToken = str;
        }

        @Override // com.cosmos.photon.push.thirdparty.IPushBridge
        public void onReceiveAssistThirdNotification(int i, NotificationWrapper notificationWrapper) {
            PushLogger.m7458i("DefaultBridge onReceiveAssistThirdNotification ----> " + i + " - " + notificationWrapper);
        }

        @Override // com.cosmos.photon.push.thirdparty.IPushBridge
        public void onReceiveAssistThirdToken(int i, String str) {
            PushLogger.m7458i("DefaultBridge onReceiveAssistThirdToken ----> " + i + " - " + str);
        }

        @Override // com.cosmos.photon.push.thirdparty.IPushBridge
        public void onReceivePassThroughMessage(int i, String str) {
            PushLogger.m7458i("DefaultBridge onReceivePassThroughMessage ----> " + i + " - " + str);
        }

        @Override // com.cosmos.photon.push.thirdparty.IPushBridge
        public void onUnRegisterResult(int i, int i2) {
            PushLogger.m7458i("DefaultBridge onUnRegisterResult ----> " + i + " - " + i2);
        }
    }
    ...
    public void init(Application application, PushBridge pushBridge, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7) {
        ...
        if (pushSdk == 1) {
            ...
            pushEngine = new C4116a(pushBridge);
        } else if (pushSdk == 3) {
            ...
            PushLogger.m7456e("this device not support vendor push");
        } else {
            pushEngine = new MiPushEngine(pushBridge);
        }
        if (mEnableFcmPush) {
    ...
    public void register() {
        PushLogger.m7458i("ThirdPushManager register");
        IPushEngine iPushEngine = pushEngine;
        if (iPushEngine != null) {
    ...
    public void unregister() {
        PushLogger.m7458i("ThirdPushManager unregisterregister");
        IPushEngine iPushEngine = pushEngine;
        if (iPushEngine != null) {
