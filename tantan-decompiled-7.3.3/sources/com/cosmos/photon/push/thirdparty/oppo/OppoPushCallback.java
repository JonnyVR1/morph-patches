...
public class OppoPushCallback implements PushCallback {
    ...
    public void onRegister(int i, String str) {
        ...
        if (i != 0) {
            PushLogger.m7458i("OPush register 失败:" + i + " message:" + str);
        ...
        PushLogger.m7458i("OPush register 成功");
        PushLogger.m7458i("RegistrationId:" + str);
    ...
    public void onUnRegister(int i) {
        if (i == 0) {
            PushLogger.m7458i("OPush 注销 成功");
            this.mPushEngine.pushBridge.onUnRegisterResult(11, 3001);
        } else {
            PushLogger.m7458i("OPush 注销 失败:" + i);
