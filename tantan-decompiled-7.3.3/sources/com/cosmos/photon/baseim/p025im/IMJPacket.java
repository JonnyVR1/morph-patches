...
public class IMJPacket implements Parcelable, IPacket {
    ...
    private String f5833AT;
    private String AT_TEXT;
    private String Action;
    private String From;

    /* JADX INFO: renamed from: ID */
    private String f5834ID;
    private String NameSpace;
    private String Text;
    private String TextV2;

    /* JADX INFO: renamed from: To */
    private String f5835To;
    private String Type;
    ...
    public String[] getATPeople() {
        try {
            if (!this.jsonObj.has(this.f5833AT)) {
                return null;
            }
            JSONArray jSONArray = this.jsonObj.getJSONArray(this.f5833AT);
    ...
    public String getId() {
        return this.jsonObj.optString(this.f5834ID);
    }
    ...
    public String getTo() {
        return this.jsonObj.optString(this.f5835To);
    }
    ...
    public void setATPeople(JSONArray jSONArray) {
        try {
            this.jsonObj.put(this.f5833AT, jSONArray);
        } catch (JSONException unused) {
        }
    }
    ...
    public void setId(String str) {
        try {
            this.jsonObj.put(this.f5834ID, str);
    ...
    public void setTo(String str) {
        try {
            this.jsonObj.put(this.f5835To, str);
        } catch (JSONException unused) {
        }
    }
