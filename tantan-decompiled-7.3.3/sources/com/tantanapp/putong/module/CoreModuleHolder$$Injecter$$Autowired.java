...
public class CoreModuleHolder$$Injecter$$Autowired implements ISyringe {
    ...
    public void inject(Object obj) {
        Module module = (Module) mum.m160228d().m160230a("/base_module/module").navigation();
        ((CoreModuleHolder) obj).module = module;
        if (module != null) {
            return;
        }
        zzq0.m222278a("The field 'module' is null, in class '", CoreModuleHolder.class.getName(), "!");
    }
}
