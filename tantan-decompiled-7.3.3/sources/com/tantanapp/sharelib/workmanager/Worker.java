...
public abstract class Worker extends Observable {
    ...
    @Metadata(m88120d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010#\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\u000e\u001a\u00020\u00002\u0006\u0010\u0005\u001a\u00020\u0006J\u000e\u0010\u000f\u001a\u00020\u00002\u0006\u0010\u0010\u001a\u00020\nJ\u000e\u0010\u0011\u001a\u00020\u00002\u0006\u0010\u0012\u001a\u00020\rJ#\u0010\u0013\u001a\u0002H\u0014\"\b\b\u0000\u0010\u0014*\u00020\u00152\f\u0010\u0016\u001a\b\u0012\u0004\u0012\u0002H\u00140\u0017¢\u0006\u0002\u0010\u0018J\u000e\u0010\u0019\u001a\u00020\u00002\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\r0\fX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001a"}, m88121d2 = {"Lcom/tantanapp/sharelib/workmanager/Worker$Builder;", "", "appContext", "Landroid/content/Context;", "(Landroid/content/Context;)V", "constraints", "Lcom/tantanapp/sharelib/workmanager/Constraints;", "id", "Ljava/util/UUID;", "inputData", "Lcom/tantanapp/sharelib/workmanager/Data;", "tags", "", "", "addConstraints", "addInputData", "data", "addTag", "tag", "from", p7f.GPS_DIRECTION_TRUE, "Lcom/tantanapp/sharelib/workmanager/Worker;", "kClass", "Ljava/lang/Class;", "(Ljava/lang/Class;)Lcom/tantanapp/sharelib/workmanager/Worker;", "setID", "workmanager_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    @SourceDebugExtension
    public static final class Builder {
        ...
        public Builder(@NotNull Context context) {
            ...
            this.inputData = Data.INSTANCE.m82726a();
        ...
        public final <T extends Worker> T from(@NotNull Class<T> kClass) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
            ...
            T tNewInstance = constructor.newInstance(context, new WorkInfo(uuid, set, state, data, companion.m82726a(), companion.m82726a(), this.constraints));
    ...
    @Metadata(m88120d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00002\u0006\u0010\u0006\u001a\u00020\u0004R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m88121d2 = {"Lcom/tantanapp/sharelib/workmanager/Worker$Companion;", "", "()V", "TAG", "", "log", "msg", "workmanager_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    @SourceDebugExtension
    public static final class Companion {
        ...
        public final Companion log(@NotNull String msg) {
            msg.getClass();
            if (WorkManager.INSTANCE.m82744a()) {
    ...
    private final void updateFailed(Result.Failure result) {
        getSettableResult().m82759d(result);
        getSettableResult().m82758c(result.getThrowable());
        this.info.m82737e(result.getThrowable());
        updateState(WorkInfo.State.FAILED);
    }

    private final void updateState(WorkInfo.State state) {
        this.info.m82742j(state);
    }

    private final void updateSuccess(Result result) {
        getSettableResult().m82759d(result);
        this.info.m82740h(result.getOutput());
    ...
    public final SettableResult getSettableResult() {
        ...
        Intrinsics.m88391r("settableResult");
        return null;
    }
    ...
    public final SettableResult startWork() {
        setSettableResult(SettableResult.INSTANCE.m82760a());
        try {
            try {
                getConstraints().m82714e();
                ...
                updateFailed(Result.INSTANCE.m82729b(e));
            }
        } finally {
