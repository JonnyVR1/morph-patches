...
public final /* data */ class WorkInfo extends Observable {
    ...
    @Metadata(m88120d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0007\u001a\u00020\bH\u0016R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\r¨\u0006\u000e"}, m88121d2 = {"Lcom/tantanapp/sharelib/workmanager/WorkInfo$State;", "", "value", "", "(Ljava/lang/String;II)V", "getValue", "()I", "toString", "", "IDLE", "ENQUEUED", AbstractLifeCycle.RUNNING, "SUCCEEDED", "FAILED", "workmanager_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public enum State {
        IDLE(0),
        ENQUEUED(1),
        RUNNING(2),
    ...
    public WorkInfo() {
        ...
        this(uuidRandomUUID, setSingleton, state, companion.m82726a(), companion.m82726a(), companion.m82726a(), new Constraints(0));
    }
    ...
    public final Set<String> m82736d() {
        return this.tags;
    }

    /* JADX INFO: renamed from: e */
    public final void m82737e(@Nullable Throwable err) {
        Throwable th = this.exception;
        if (th == null) {
            this.exception = err;
            return;
        }
        if (Intrinsics.m88377d(th, err)) {
            this.exception = err;
            return;
        }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.m88377d(this.id, workInfo.id) && Intrinsics.m88377d(this.tags, workInfo.tags) && this.state == workInfo.state && Intrinsics.m88377d(this.input, workInfo.input) && Intrinsics.m88377d(this.output, workInfo.output) && Intrinsics.m88377d(this.progress, workInfo.progress) && Intrinsics.m88377d(this.constraints, workInfo.constraints);
    }

    /* JADX INFO: renamed from: f */
    public final void m82738f(@NotNull Data input) {
        input.getClass();
        this.input.m82720e(input);
    }

    /* JADX INFO: renamed from: g */
    public final void m82739g() {
        setChanged();
    ...
    public final void m82740h(@NotNull Data result) {
        result.getClass();
        this.output.m82720e(result);
    }
    ...
    /* JADX INFO: renamed from: i */
    public final void m82741i(@NotNull Data progress) {
        progress.getClass();
        this.progress.m82720e(progress);
        m82739g();
    }

    /* JADX INFO: renamed from: j */
    public final void m82742j(@NotNull State state) {
        state.getClass();
        this.state = state;
        m82739g();
    }
