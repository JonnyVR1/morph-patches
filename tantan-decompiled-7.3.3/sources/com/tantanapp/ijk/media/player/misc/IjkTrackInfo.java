...
public class IjkTrackInfo implements ITrackInfo {
    ...
    @Override // com.tantanapp.ijk.media.player.misc.ITrackInfo
    ...
    public String getLanguage() {
        ...
        return (ijkStreamMeta == null || TextUtils.isEmpty(ijkStreamMeta.mLanguage)) ? LanguageIdentifier.UNDETERMINED_LANGUAGE_TAG : this.mStreamMeta.mLanguage;
    }
