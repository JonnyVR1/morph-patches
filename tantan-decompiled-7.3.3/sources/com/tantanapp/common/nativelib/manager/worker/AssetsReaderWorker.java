...
@Metadata(m88120d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u0000 \u000f2\u00020\u0001:\u0001\u0010B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u000f\u0010\t\u001a\u00020\bH\u0016¢\u0006\u0004\b\t\u0010\nR\u001a\u0010\r\u001a\b\u0012\u0004\u0012\u00020\f0\u000b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000e¨\u0006\u0011"}, m88121d2 = {"Lcom/tantanapp/common/nativelib/manager/worker/AssetsReaderWorker;", "Lcom/tantanapp/sharelib/workmanager/Worker;", "Landroid/content/Context;", "appContext", "Lcom/tantanapp/sharelib/workmanager/WorkInfo;", "workInfo", "<init>", "(Landroid/content/Context;Lcom/tantanapp/sharelib/workmanager/WorkInfo;)V", "Lcom/tantanapp/sharelib/workmanager/Result;", "doWork", "()Lcom/tantanapp/sharelib/workmanager/Result;", "", "Lcom/tantanapp/common/nativelib/manager/bean/ZipFileInfo;", "downloadInfo", "Ljava/util/List;", "Companion", "a", "sharedlibrarymanager_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
...
public final class AssetsReaderWorker extends Worker {
    ...
    @Metadata(m88120d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u0001¨\u0006\u0004"}, m88121d2 = {"com/tantanapp/common/nativelib/manager/worker/AssetsReaderWorker$b", "Lcom/google/gson/reflect/TypeToken;", "", "Lcom/tantanapp/common/nativelib/manager/bean/ZipFileInfo;", "sharedlibrarymanager_release"}, m88122k = 1, m88123mv = {1, 8, 0}, m88125xi = 48)
    public static final class C13781b extends TypeToken<List<? extends ZipFileInfo>> {
    }
        ...
        if (list != null) {
            ...
            for (String str : list) {
                if (str != null && str.length() != 0) {
                    str.getClass();
                    if (C15493d.m94374J(str, ASSETS_FILE_PREFIX, false, 2, null)) {
                        arrayList.add(str);
                    }
                }
            }
            ...
            while (it.hasNext()) {
                ...
                List list2 = (List) o8g0.m166574b().fromJson(new InputStreamReader(inputStreamOpen, Charsets.UTF_8), type);
                List<ZipFileInfo> list3 = this.downloadInfo;
                list2.getClass();
                list3.addAll(list2);
            }
        }
        return new Result.Success(new Data.Builder().m82724d("key_download_info_list", this.downloadInfo).m82721a());
    }
}
