...
public final /* data */ class LibraryZipInfo {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof LibraryZipInfo) && Intrinsics.m88377d(this.name, ((LibraryZipInfo) other).name);
    }
