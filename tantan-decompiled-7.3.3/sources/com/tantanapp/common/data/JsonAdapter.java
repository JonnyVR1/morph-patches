...
public abstract class JsonAdapter<T> implements INetParser<T> {
    ...
    public static JsonFactory f56860jf;

    /* JADX INFO: renamed from: aa */
    private JsonAdapter<List<T>> f56861aa = null;

    /* JADX INFO: renamed from: ma */
    private JsonAdapter<Map<String, T>> f56862ma = null;
    public static final JsonAdapter<uxj0> UNIT_ADAPTER = new JsonAdapter<uxj0>() { // from class: com.tantanapp.common.data.JsonAdapter.1
        @Override // com.tantanapp.common.data.JsonAdapter
        public /* bridge */ /* synthetic */ uxj0 parse(JsonParser jsonParser, String str, ArrayList arrayList, DataChecker dataChecker) throws IOException {
        ...
        public uxj0 parse2(JsonParser jsonParser, String str, ArrayList<BaseData> arrayList, DataChecker dataChecker) throws IOException {
            return uxj0.f181467a;
        }

        @Override // com.tantanapp.common.data.JsonAdapter
        public void serialize(uxj0 uxj0Var, JsonGenerator jsonGenerator, boolean z) throws IOException {
    ...
    public JsonAdapter<List<T>> ARRAY_ADAPTER() {
        if (this.f56861aa == null) {
            this.f56861aa = ARRAY_ADAPTER(this);
        }
        return this.f56861aa;
    }

    public JsonAdapter<Map<String, T>> MAP_ADAPTER() {
        if (this.f56862ma == null) {
            this.f56862ma = MAP_ADAPTER(this);
        }
        return this.f56862ma;
    }
