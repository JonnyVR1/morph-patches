...
public class TinkerLoadLibrary {
    ...
    public static boolean installNativeLibraryABIWithoutTinkerInstalled(Application application, File file) {
        if (file == null) {
            TinkerLog.m82605e(TAG, "failed to get current patch directory.", new Object[0]);
            return false;
        }
        if (!file.exists()) {
            TinkerLog.m82605e(TAG, "tinker lib path [%s] is not exists.", file);
            return false;
        }
        ClassLoader classLoader = application.getClassLoader();
        if (classLoader == null) {
            TinkerLog.m82605e(TAG, "classloader is null", new Object[0]);
            return false;
        }
        TinkerLog.m82606i(TAG, "before hack classloader:" + classLoader.toString(), new Object[0]);
        try {
            try {
                ...
                TinkerLog.m82606i(TAG, "after hack classloader:" + classLoader.toString(), new Object[0]);
                return true;
            } catch (IllegalAccessException e) {
                TinkerLog.m82605e(TAG, "installNativeLibraryPath fail:" + file + ", e: " + e, new Object[0]);
                TinkerLog.m82606i(TAG, "after hack classloader:" + classLoader.toString(), new Object[0]);
                return false;
            } catch (NoSuchMethodException e2) {
                TinkerLog.m82605e(TAG, "installNativeLibraryPath fail:" + file + ", e: " + e2, new Object[0]);
                TinkerLog.m82606i(TAG, "after hack classloader:" + classLoader.toString(), new Object[0]);
                return false;
            } catch (InvocationTargetException e3) {
                TinkerLog.m82605e(TAG, "installNativeLibraryPath fail:" + file + ", e: " + e3, new Object[0]);
                TinkerLog.m82606i(TAG, "after hack classloader:" + classLoader.toString(), new Object[0]);
                return false;
            }
        } catch (Throwable th) {
            ...
            if (file.exists()) {
                ...
                if ((i != 25 || getPreviousSdkInt() == 0) && i <= 25) {
                    try {
                        ...
                        TinkerLog.m82605e(TAG, "installNativeLibraryPath, v23 fail, sdk: %d, error: %s, try to fallback to V14", Integer.valueOf(Build.VERSION.SDK_INT), th.getMessage());
                ...
                try {
                    ...
                    TinkerLog.m82605e(TAG, "installNativeLibraryPath, v25 fail, sdk: %d, error: %s, try to fallback to V23", Integer.valueOf(Build.VERSION.SDK_INT), th2.getMessage());
                    V23.install(classLoader, file);
                }
                throw th;
            }
        }
        TinkerLog.m82605e(TAG, "installNativeLibraryPath, folder %s is illegal", file);
    }
}
