...
public class TTMediaProxy {
    ...
    private static InterfaceC13823a mPreloadTaskCompleteListener = null;
    private static Context sAppContext = null;
    private static InterfaceC13824b sProxyServerResultListener = null;
    ...
    public interface InterfaceC13823a {
        /* JADX INFO: renamed from: a */
        void mo82540a(int i, int i2, String str, String str2, String str3, long j, PreloadTaskInfo preloadTaskInfo);

        /* JADX INFO: renamed from: b */
        void mo82541b(int i, String str, String str2, String str3, long j, PreloadTaskInfo preloadTaskInfo);
    }

    /* JADX INFO: renamed from: com.tantanapp.media.proxy.api.TTMediaProxy$b */
    public interface InterfaceC13824b {
        /* JADX INFO: renamed from: a */
        void mo82542a(String str);
    }
    ...
    private static void postEventFromNativeDeal(int i, int i2, Object obj) {
        ...
        dtd0.m117850a(TAG, "url: " + preloadTaskInfo.mUrl + "; offset: " + preloadTaskInfo.mRequireStart);
        if (i > 7 || i < 0) {
            dtd0.m117851b(TAG, "EventCode illegal!!!  EventCode:" + i + " EventSubCode:" + i2);
            return;
        }
        switch (i) {
            case 1:
            ...
            case 4:
            case 7:
                InterfaceC13823a interfaceC13823a = mPreloadTaskCompleteListener;
                if (interfaceC13823a == null) {
                    i3 = i2;
                } else {
                    i3 = i2;
                    interfaceC13823a.mo82540a(i3, preloadTaskInfo.mTaskId, preloadTaskInfo.mUrl, preloadTaskInfo.mKey, preloadTaskInfo.mSessionID, preloadTaskInfo.mDownloadedSize, preloadTaskInfo);
                    preloadTaskInfo = preloadTaskInfo;
                }
                break;
            case 3:
                InterfaceC13823a interfaceC13823a2 = mPreloadTaskCompleteListener;
                if (interfaceC13823a2 != null) {
                    interfaceC13823a2.mo82541b(preloadTaskInfo.mTaskId, preloadTaskInfo.mUrl, preloadTaskInfo.mKey, preloadTaskInfo.mSessionID, preloadTaskInfo.mDownloadedSize, preloadTaskInfo);
                }
                i3 = i2;
                break;
            case 5:
            case 6:
                InterfaceC13823a interfaceC13823a3 = mPreloadTaskCompleteListener;
                if (interfaceC13823a3 != null) {
                    interfaceC13823a3.mo82541b(preloadTaskInfo.mTaskId, preloadTaskInfo.mUrl, preloadTaskInfo.mKey, preloadTaskInfo.mSessionID, preloadTaskInfo.mDownloadedSize, preloadTaskInfo);
                }
                i3 = i2;
                break;
            default:
    ...
    public void setOnPreloadTaskCompleteListener(InterfaceC13823a interfaceC13823a) {
        mPreloadTaskCompleteListener = interfaceC13823a;
    }

    public void setProxyServerResultListener(InterfaceC13824b interfaceC13824b) {
        sProxyServerResultListener = interfaceC13824b;
    }
}
