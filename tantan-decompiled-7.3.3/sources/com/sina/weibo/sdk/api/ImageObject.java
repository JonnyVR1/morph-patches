...
public class ImageObject extends BaseMediaObject {
    ...
    public boolean checkArgs() {
        ...
        if (bArr == null && this.imagePath == null) {
            LogUtil.m81662e("Weibo.ImageObject", "imageData and imagePath are null");
            return false;
        }
        if (bArr != null && bArr.length > 2097152) {
            LogUtil.m81662e("Weibo.ImageObject", "imageData is too large");
            return false;
        }
        String str = this.imagePath;
        if (str != null && str.length() > 512) {
            LogUtil.m81662e("Weibo.ImageObject", "imagePath is too length");
            return false;
        }
        ...
        try {
            ...
            LogUtil.m81662e("Weibo.ImageObject", "checkArgs fail, image content is too large or not exists");
            return false;
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        LogUtil.m81662e("Weibo.ImageObject", "put thumb failed");
