...
public class WbSdk {
    ...
    public static void checkInit() {
        ...
        azk0.m101074a("weibo sdk was not initall! please use: WbSdk.install() in your app Application or your main Activity. when you want to use weibo sdk function, make sure call WbSdk.install() before this function");
    }
    ...
    public static void install(Context context, AuthInfo authInfo2) {
        ...
        if (authInfo2 == null || TextUtils.isEmpty(authInfo2.getAppKey()) || TextUtils.isEmpty(authInfo2.getRedirectUrl())) {
            azk0.m101074a("please set right app info (appKey,redirect");
            return;
        }
        authInfo = authInfo2;
