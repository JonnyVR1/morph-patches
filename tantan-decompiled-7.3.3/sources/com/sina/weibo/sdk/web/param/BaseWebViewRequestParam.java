...
public abstract class BaseWebViewRequestParam {
    ...
    public static /* synthetic */ class C133831 {
    ...
    public Bundle fillBundle(Bundle bundle) {
        ...
        if (baseWebViewRequestData == null) {
            mnd0.m159157a("构造方法错误，请使用全参数的构造方法构建");
            return null;
        }
        bundle.putSerializable("base", baseWebViewRequestData);
        int i = C133831.$SwitchMap$com$sina$weibo$sdk$web$WebRequestType[this.baseData.getType().ordinal()];
        if (i == 1) {
