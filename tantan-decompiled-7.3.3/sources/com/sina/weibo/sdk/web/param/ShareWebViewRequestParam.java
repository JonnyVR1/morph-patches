...
public class ShareWebViewRequestParam extends BaseWebViewRequestParam {
    ...
    private void getBaseUrl() throws IOException {
        ...
        if (this.multiMessage.textObject != null) {
            sb.append(this.multiMessage.textObject.text + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        }
    ...
    public void childFillBundle(Bundle bundle) {
        ...
        bundle.putString(RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME, this.packageName);
    ...
    public void doExtraTask(final BaseWebViewRequestParam.ExtraTaskCallback extraTaskCallback) {
        ...
        LogUtil.m81663i("Share", "ShareWebViewRequestParam.doExtraTask()");
        ...
        requestService.asyncRequest(builder.build(), new SimpleTarget() { // from class: com.sina.weibo.sdk.web.param.ShareWebViewRequestParam.1
            ...
            public void onFailure(Exception exc) {
                LogUtil.m81663i("Share", "ShareWebViewRequestParam.doExtraTask().onFailure(),e =" + exc.getMessage());
            ...
            public void onSuccess(String str2) {
                LogUtil.m81663i("Share", "ShareWebViewRequestParam.doExtraTask().onSuccess(),response = " + str2);
    ...
    public String getRequestUrl() {
        ...
        if (!TextUtils.isEmpty(this.token)) {
            builderBuildUpon.appendQueryParameter("access_token", this.token);
        }
    ...
    public void transformChildBundle(Bundle bundle) throws IOException {
        ...
        this.packageName = bundle.getString(RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME);
