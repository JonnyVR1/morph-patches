...
public class RolloutsStateSubscriptionsHandler {
    ...
    public static /* synthetic */ void m16915a(RolloutsStateSubscriptionsHandler rolloutsStateSubscriptionsHandler, Task task, final RolloutsStateSubscriber rolloutsStateSubscriber, ConfigContainer configContainer) {
        rolloutsStateSubscriptionsHandler.getClass();
        try {
            ConfigContainer configContainer2 = (ConfigContainer) task.mo15427l();
            if (configContainer2 != null) {
                ...
                rolloutsStateSubscriptionsHandler.executor.execute(new Runnable() { // from class: l.pdd0
    ...
    public void publishActiveRolloutsState(@NonNull ConfigContainer configContainer) {
        try {
            ...
            for (final RolloutsStateSubscriber rolloutsStateSubscriber : this.subscribers) {
                this.executor.execute(new Runnable() { // from class: l.qdd0
                    @Override // java.lang.Runnable
                    public final void run() {
                        rolloutsStateSubscriber.onRolloutsStateChanged(activeRolloutsState);
                    }
    ...
    public void registerRolloutsStateSubscriber(@NonNull final RolloutsStateSubscriber rolloutsStateSubscriber) {
        ...
        task.mo15420e(this.executor, new to50() { // from class: l.odd0
            @Override // p153l.to50
            public final void onSuccess(Object obj) {
                RolloutsStateSubscriptionsHandler.m16915a(this.f146885a, task, rolloutsStateSubscriber, (ConfigContainer) obj);
            }
        });
    }
}
