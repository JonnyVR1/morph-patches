...
public final class RemoteConfigKt$configUpdates$1$registration$1 implements ConfigUpdateListener {
    ...
    public static void m16902a(el90 el90Var, ConfigUpdate configUpdate) {
        el90Var.getClass();
    ...
    public void onUpdate(@NotNull final ConfigUpdate configUpdate) {
        ...
        firebaseRemoteConfig.schedule(new Runnable() { // from class: l.fyc0
            @Override // java.lang.Runnable
            public final void run() {
                RemoteConfigKt$configUpdates$1$registration$1.m16902a(el90Var, configUpdate);
            }
        });
    }
}
