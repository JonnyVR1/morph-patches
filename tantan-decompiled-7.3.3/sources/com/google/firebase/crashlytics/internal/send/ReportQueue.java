...
final class ReportQueue {
    ...
    public final class ReportRunnable implements Runnable {
        ...
        private final sni0<CrashlyticsReportWithSessionId> tcs;

        private ReportRunnable(CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, sni0<CrashlyticsReportWithSessionId> sni0Var) {
        ...
        public void run() {
            ...
            Logger.getLogger().m16776d("Delay for: " + String.format(Locale.US, "%.2f", Double.valueOf(dCalcDelay / 1000.0d)) + " s for report: " + this.reportWithSessionId.getSessionId());
    ...
    public static /* synthetic */ void m16833a(ReportQueue reportQueue, sni0 sni0Var, boolean z, CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, Exception exc) {
        ...
        sni0Var.m186943e(crashlyticsReportWithSessionId);
    }

    /* JADX INFO: renamed from: b */
    public static /* synthetic */ void m16834b(ReportQueue reportQueue, CountDownLatch countDownLatch) {
        reportQueue.getClass();
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void sendReport(final CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, final sni0<CrashlyticsReportWithSessionId> sni0Var) {
        Logger.getLogger().m16776d("Sending report through Google DataTransport: " + crashlyticsReportWithSessionId.getSessionId());
        ...
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new TransportScheduleCallback() { // from class: com.google.firebase.crashlytics.internal.send.b
            ...
            public final void onSchedule(Exception exc) {
                ReportQueue.m16833a(this.f11490a, sni0Var, z, crashlyticsReportWithSessionId, exc);
            }
        });
    }
    ...
    public sni0<CrashlyticsReportWithSessionId> enqueueReport(CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, boolean z) {
        synchronized (this.queue) {
            try {
                sni0<CrashlyticsReportWithSessionId> sni0Var = new sni0<>();
                if (!z) {
                    sendReport(crashlyticsReportWithSessionId, sni0Var);
                    return sni0Var;
                }
                this.onDemandCounter.incrementRecordedOnDemandExceptions();
                if (!isQueueAvailable()) {
                    calcStep();
                    Logger.getLogger().m16776d("Dropping report due to queue being full: " + crashlyticsReportWithSessionId.getSessionId());
                    this.onDemandCounter.incrementDroppedOnDemandExceptions();
                    sni0Var.m186943e(crashlyticsReportWithSessionId);
                    return sni0Var;
                }
                Logger.getLogger().m16776d("Enqueueing report: " + crashlyticsReportWithSessionId.getSessionId());
                Logger.getLogger().m16776d("Queue size: " + this.queue.size());
                this.singleThreadExecutor.execute(new ReportRunnable(crashlyticsReportWithSessionId, sni0Var));
                Logger.getLogger().m16776d("Closing task for report: " + crashlyticsReportWithSessionId.getSessionId());
                sni0Var.m186943e(crashlyticsReportWithSessionId);
                return sni0Var;
            } catch (Throwable th) {
                throw th;
    ...
    public void flushScheduledReportsIfAble() {
        ...
        new Thread(new Runnable() { // from class: com.google.firebase.crashlytics.internal.send.a
            ...
            public final void run() {
                ReportQueue.m16834b(this.f11488a, countDownLatch);
            }
        }).start();
