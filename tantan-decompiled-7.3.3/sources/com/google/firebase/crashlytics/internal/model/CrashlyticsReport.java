...
public abstract class CrashlyticsReport {
    ...
    public static abstract class ApplicationExitInfo {
        ...
        public static abstract class BuildIdMappingForArch {
            ...
            public static Builder builder() {
                return new C3175xb26d2aa8.Builder();
            }
        ...
        public static abstract class Event {
            ...
            public static abstract class Application {
                ...
                public static abstract class Execution {
                    ...
                    public static abstract class BinaryImage {
                        ...
                        @NonNull
                        public static Builder builder() {
                            return new C3186xfe724d07.Builder();
                        }
                    ...
                    public static abstract class Exception {
                        ...
                        @NonNull
                        public static Builder builder() {
                            return new C3187xc2f5febc.Builder();
                        }
                    ...
                    public static abstract class Signal {
                        ...
                        @NonNull
                        public static Builder builder() {
                            return new C3188x7c929f5b.Builder();
                        }
                    ...
                    public static abstract class Thread {
                        ...
                        public static abstract class Frame {
                            ...
                            @NonNull
                            public static Builder builder() {
                                return new C3190xce3d994b.Builder();
                            }
                        ...
                        @NonNull
                        public static Builder builder() {
                            return new C3189x7e3e3ebd.Builder();
                        }
                ...
                public static abstract class ProcessDetails {
                    ...
                    @NonNull
                    public static Builder builder() {
                        return new C3191x94fa915f.Builder();
                    }
            ...
            public static abstract class RolloutAssignment {
                ...
                public static abstract class RolloutVariant {
                    ...
                    public static Builder builder() {
                        return new C3195x87204092.Builder();
                    }
    ...
    public CrashlyticsReport withEvents(@NonNull List<Session.Event> list) {
        ...
        wtq0.m207906a("Reports without sessions cannot have events added to them.");
        return null;
    }
