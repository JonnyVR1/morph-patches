...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    private final CrashlyticsReport.Session.OperatingSystem f11484os;
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f11484os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", appQualitySessionId=" + this.appQualitySessionId + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f11484os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* JADX INFO: renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f11485os;
        private byte set$0;
        ...
        public CrashlyticsReport.Session build() {
            ...
            if (this.set$0 == 7 && (str = this.generator) != null && (str2 = this.identifier) != null && (application = this.app) != null) {
                return new AutoValue_CrashlyticsReport_Session(str, str2, this.appQualitySessionId, this.startedAt, this.endedAt, this.crashed, application, this.user, this.f11485os, this.device, this.events, this.generatorType);
            }
