...
final class C3186xfe724d07 extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.BinaryImage build() {
            ...
            if (this.set$0 == 3 && (str = this.name) != null) {
                return new C3186xfe724d07(this.baseAddress, this.size, str, this.uuid);
            }
    ...
    private C3186xfe724d07(long j, long j2, String str, @Nullable String str2) {
        this.baseAddress = j;
        this.size = j2;
        this.name = str;
        this.uuid = str2;
