...
class DisplayNotification {
    ...
    private void showNotification(CommonNotificationBuilder.DisplayNotificationInfo displayNotificationInfo) {
        ...
        jj5.m145014h((NotificationManager) this.context.getSystemService("notification"), displayNotificationInfo.tag, displayNotificationInfo.f11501id, displayNotificationInfo.notificationBuilder.build());
    }
    ...
    private void waitForAndApplyImageDownload(NotificationCompat.Builder builder, @Nullable ImageDownload imageDownload) {
        ...
        try {
            Bitmap bitmap = (Bitmap) toi0.m192064b(imageDownload.getTask(), 5L, TimeUnit.SECONDS);
