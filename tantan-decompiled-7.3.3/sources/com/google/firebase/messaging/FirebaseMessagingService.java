...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    private vnd0 getRpc(Context context) {
        if (this.rpc == null) {
            this.rpc = new vnd0(context.getApplicationContext());
        }
        return this.rpc;
    }
    ...
    private void handleMessageIntent(Intent intent) {
        ...
        getRpc(this).m201988b(new CloudMessage(intent));
    }
    ...
    @VisibleForTesting
    public void setRpcForTesting(vnd0 vnd0Var) {
        this.rpc = vnd0Var;
    }
}
