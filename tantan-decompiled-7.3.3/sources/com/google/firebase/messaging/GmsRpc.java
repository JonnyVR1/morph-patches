...
public class GmsRpc {
    ...
    public GmsRpc(FirebaseApp firebaseApp, Metadata metadata, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi) {
        this(firebaseApp, metadata, new vnd0(firebaseApp.getApplicationContext()), provider, provider2, firebaseInstallationsApi);
    }

    /* JADX INFO: renamed from: a */
    public static /* synthetic */ String m16879a(GmsRpc gmsRpc, Task task) {
        gmsRpc.getClass();
        return gmsRpc.handleResponse((Bundle) task.mo15428m(IOException.class));
    }
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.mo15422g(new pox(), new s26() { // from class: com.google.firebase.messaging.h
            @Override // p153l.s26
            public final Object then(Task task2) {
                return GmsRpc.m16879a(this.f11515a, task2);
            }
        });
    }
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        if (bundle == null) {
            zpg0.m220844a("SERVICE_NOT_AVAILABLE");
            return null;
        }
        ...
        if (CMD_RST.equals(string3)) {
            zpg0.m220844a(ERROR_INSTANCE_ID_RESET);
            return null;
        }
        if (string3 != null) {
            zpg0.m220844a(string3);
            return null;
        }
        bundle.toString();
        new Throwable();
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        try {
            String token = ((InstallationTokenResult) toi0.m192063a(this.firebaseInstallations.getToken(false))).getToken();
        ...
        bundle.putString("appid", (String) toi0.m192063a(this.firebaseInstallations.getId()));
        bundle.putString(PARAM_CLIENT_VER, "fcm-24.0.2");
    ...
    private Task<Bundle> startRpc(String str, String str2, Bundle bundle) {
        try {
            ...
            return this.rpc.m201989c(bundle);
        } catch (InterruptedException | ExecutionException e) {
    ...
    @VisibleForTesting
    public GmsRpc(FirebaseApp firebaseApp, Metadata metadata, vnd0 vnd0Var, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi) {
