...
class WithinAppServiceConnection implements ServiceConnection {
    ...
    public static class BindRequest {
        final Intent intent;
        private final sni0<Void> taskCompletionSource = new sni0<>();
        ...
        public static /* synthetic */ void m16889b(BindRequest bindRequest) {
        ...
        public void arrangeTimeout(ScheduledExecutorService scheduledExecutorService) {
            final ScheduledFuture<?> scheduledFutureSchedule = scheduledExecutorService.schedule(new Runnable() { // from class: com.google.firebase.messaging.p
                ...
                public final void run() {
                    WithinAppServiceConnection.BindRequest.m16889b(this.f11531a);
                }
            }, 20L, TimeUnit.SECONDS);
            getTask().mo15417b(scheduledExecutorService, new OnCompleteListener() { // from class: com.google.firebase.messaging.q
        ...
        public void finish() {
            this.taskCompletionSource.m186943e(null);
        }

        public Task<Void> getTask() {
            return this.taskCompletionSource.m186939a();
        }
    }
