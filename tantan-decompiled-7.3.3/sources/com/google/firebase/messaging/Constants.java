...
public final class Constants {
    ...
    public static final long WAKE_LOCK_ACQUIRE_TIMEOUT_MILLIS = 180000;
    ...
    public static final class MessagePayloadKeys {
        ...
        public static final String f11502TO = "google.to";
        public static final String TTL = "google.ttl";

        private MessagePayloadKeys() {
        }

        public static l01<String, String> extractDeveloperDefinedPayload(Bundle bundle) {
