...
public class ImageDownload implements Closeable {
    ...
    public static /* synthetic */ void m16880b(ImageDownload imageDownload, sni0 sni0Var) {
        imageDownload.getClass();
        try {
            sni0Var.m186941c(imageDownload.blockingDownload());
        } catch (Exception e) {
            sni0Var.m186940b(e);
        }
    }
    ...
    private byte[] blockingDownloadBytes() throws IOException {
        ...
        if (uRLConnectionOpenConnection.getContentLength() > 1048576) {
            zpg0.m220844a("Content-Length exceeds max size of 1048576");
            return null;
        }
        ...
        try {
            ...
            zpg0.m220844a("Image exceeds max size of 1048576");
            return null;
        } catch (Throwable th) {
            if (inputStream != null) {
                try {
    ...
    public Bitmap blockingDownload() throws IOException {
        ...
        if (bitmapDecodeByteArray == null) {
            rr10.m182681a("Failed to decode image: ", this.url);
            return null;
        }
    ...
    public void start(ExecutorService executorService) {
        ...
        this.future = executorService.submit(new Runnable() { // from class: l.vhm
            @Override // java.lang.Runnable
            public final void run() {
                ImageDownload.m16880b(this.f184175a, sni0Var);
            }
        });
        this.task = sni0Var.m186939a();
    }
}
