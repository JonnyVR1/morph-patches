...
public final class FirebaseAnalytics {
    ...
    private FirebaseAnalytics(zyu0 zyu0Var) {
        Preconditions.checkNotNull(zyu0Var);
        this.zzb = zyu0Var;
    }
    ...
    public static FirebaseAnalytics getInstance(@NonNull Context context) {
        if (zza == null) {
            synchronized (FirebaseAnalytics.class) {
                try {
                    if (zza == null) {
                        zza = new FirebaseAnalytics(zyu0.m222157i(context));
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    @Nullable
    @Keep
    public static k9y0 getScionFrontendApiImplementation(Context context, @Nullable Bundle bundle) {
        zyu0 zyu0VarM222158j = zyu0.m222158j(context, null, null, null, bundle);
        if (zyu0VarM222158j == null) {
            return null;
        }
        return new zzd(zyu0VarM222158j);
    }
    ...
    public final Task<String> getAppInstanceId() {
        try {
            return toi0.m192065c(zza(), new zzc(this));
        } catch (RuntimeException e) {
            this.zzb.m222192k(5, "Failed to schedule task for getAppInstanceId", null, null, null);
    ...
    public final String getFirebaseInstanceId() {
        try {
            return (String) toi0.m192064b(FirebaseInstallations.getInstance().getId(), HuiYanOsConfig.LONG_CHECK_OVERSEAS_DEFAULT_TIME_OUT, TimeUnit.MILLISECONDS);
        } catch (InterruptedException e) {
            xpg0.m212648a(e);
            return null;
        } catch (ExecutionException e2) {
            xpg0.m212648a(e2.getCause());
            return null;
    ...
    public final Task<Long> getSessionId() {
        try {
            return toi0.m192065c(zza(), new zzb(this));
        } catch (RuntimeException e) {
            this.zzb.m222192k(5, "Failed to schedule task for getSessionId", null, null, null);
            return toi0.m192067e(e);
        }
    }

    public final void logEvent(@NonNull @Size(max = 40, min = 1) String str, @Nullable Bundle bundle) {
        this.zzb.m222199r(str, bundle);
    }
    ...
    public final void setAnalyticsCollectionEnabled(boolean z) {
        this.zzb.m222197p(Boolean.valueOf(z));
    }
    ...
    public final void setCurrentScreen(@NonNull Activity activity, @Nullable @Size(max = 36, min = 1) String str, @Nullable @Size(max = 36, min = 1) String str2) {
        this.zzb.m222194m(activity, str, str2);
    }
