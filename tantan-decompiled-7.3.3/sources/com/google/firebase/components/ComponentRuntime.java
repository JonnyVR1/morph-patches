...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new Provider() { // from class: l.vs5
    ...
    public static final class Builder {
        ...
        public static /* synthetic */ ComponentRegistrar m16737a(ComponentRegistrar componentRegistrar) {
        ...
        public Builder addComponentRegistrar(final ComponentRegistrar componentRegistrar) {
            this.lazyRegistrars.add(new Provider() { // from class: l.xs5
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
                    return ComponentRuntime.Builder.m16737a(componentRegistrar);
                }
            });
            return this;
        }
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection, ComponentRegistrarProcessor componentRegistrarProcessor) {
        ...
        arrayList.add(Component.m16731of(eventBus, (Class<EventBus>) EventBus.class, (Class<? super EventBus>[]) new Class[]{Subscriber.class, Publisher.class}));
        arrayList.add(Component.m16731of(this, (Class<ComponentRuntime>) ComponentLoader.class, (Class<? super ComponentRuntime>[]) new Class[0]));
    ...
    /* JADX INFO: renamed from: a */
    public static /* synthetic */ Object m16733a(ComponentRuntime componentRuntime, Component component) {
    ...
    public static /* synthetic */ ComponentRegistrar m16735c(ComponentRegistrar componentRegistrar) {
        return componentRegistrar;
    }
    ...
    private void discoverComponents(List<Component<?>> list) {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: l.ws5
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return ComponentRuntime.m16733a(this.f190595a, component);
                    }
                }));
            }
    ...
    private static Iterable<Provider<ComponentRegistrar>> toProviders(Iterable<ComponentRegistrar> iterable) {
        ...
        for (final ComponentRegistrar componentRegistrar : iterable) {
            arrayList.add(new Provider() { // from class: l.us5
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
                    return ComponentRuntime.m16735c(componentRegistrar);
                }
            });
        }
        return arrayList;
    ...
    public <T> Deferred<T> getDeferred(Qualified<T> qualified) {
        ...
        return provider instanceof OptionalProvider ? (OptionalProvider) provider : OptionalProvider.m16742of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (m31.m156916a(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
