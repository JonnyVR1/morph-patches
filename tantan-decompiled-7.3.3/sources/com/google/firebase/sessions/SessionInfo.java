...
public final /* data */ class SessionInfo {
    ...
    public final SessionInfo copy(@NotNull String sessionId, @NotNull String firstSessionId, int sessionIndex, long eventTimestampUs, @NotNull DataCollectionStatus dataCollectionStatus, @NotNull String firebaseInstallationId, @NotNull String firebaseAuthenticationToken) {
        ...
        dataCollectionStatus.getClass();
        firebaseInstallationId.getClass();
        firebaseAuthenticationToken.getClass();
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.m88377d(this.sessionId, sessionInfo.sessionId) && Intrinsics.m88377d(this.firstSessionId, sessionInfo.firstSessionId) && this.sessionIndex == sessionInfo.sessionIndex && this.eventTimestampUs == sessionInfo.eventTimestampUs && Intrinsics.m88377d(this.dataCollectionStatus, sessionInfo.dataCollectionStatus) && Intrinsics.m88377d(this.firebaseInstallationId, sessionInfo.firebaseInstallationId) && Intrinsics.m88377d(this.firebaseAuthenticationToken, sessionInfo.firebaseAuthenticationToken);
    }
