...
public final class EventGDTLogger implements EventGDTLoggerInterface {
    ...
    public void log(@NotNull SessionEvent sessionEvent) {
        ...
        this.transportFactoryProvider.get().getTransport(AQS_LOG_SOURCE, SessionEvent.class, Encoding.m9346of("json"), new Transformer() { // from class: l.n4f
            @Override // com.google.android.datatransport.Transformer
            public final Object apply(Object obj) {
                return this.f140227a.encode((SessionEvent) obj);
            }
