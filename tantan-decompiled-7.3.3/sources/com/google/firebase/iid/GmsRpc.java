...
public class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.mo15422g(FirebaseIidExecutors.directExecutor(), new s26(this) { // from class: com.google.firebase.iid.GmsRpc$$Lambda$0
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        if (bundle == null) {
            zpg0.m220844a(ERROR_SERVICE_NOT_AVAILABLE);
            return null;
        }
        ...
        if ("RST".equals(string3)) {
            zpg0.m220844a("INSTANCE_ID_RESET");
            return null;
        }
        if (string3 != null) {
    ...
    public final /* synthetic */ String lambda$extractResponseWhenComplete$0$GmsRpc(Task task) throws Exception {
        return handleResponse((Bundle) task.mo15428m(IOException.class));
    }
