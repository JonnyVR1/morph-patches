...
public class FirebaseInstanceId {
    ...
    public FirebaseInstanceId(FirebaseApp firebaseApp, Metadata metadata, Executor executor, Executor executor2, Provider<UserAgentPublisher> provider, Provider<HeartBeatInfo> provider2, FirebaseInstallationsApi firebaseInstallationsApi) {
        ...
        if (Metadata.getDefaultSenderId(firebaseApp) == null) {
            wtq0.m207906a("FirebaseInstanceId failed to initialize, FirebaseApp is missing project ID");
            throw null;
        }
    ...
    private <T> T awaitTask(Task<T> task) throws IOException {
        try {
            return (T) toi0.m192064b(task, HuiYanOsConfig.LONG_CHECK_OVERSEAS_DEFAULT_TIME_OUT, TimeUnit.MILLISECONDS);
        } catch (InterruptedException | TimeoutException unused) {
            zpg0.m220844a(GmsRpc.ERROR_SERVICE_NOT_AVAILABLE);
            return null;
    ...
    private static <T> T awaitTaskAllowOnMainThread(@NonNull Task<T> task) throws InterruptedException {
        ...
        task.mo15417b(FirebaseInstanceId$$Lambda$1.$instance, new OnCompleteListener(countDownLatch) { // from class: com.google.firebase.iid.FirebaseInstanceId$$Lambda$2
    ...
    private Task<InstanceIdResult> getInstanceId(final String str, String str2) {
        ...
        return toi0.m192068f(null).mo15424i(this.fileIoExecutor, new s26(this, str, strRationaliseScope) { // from class: com.google.firebase.iid.FirebaseInstanceId$$Lambda$0
    ...
    public final /* synthetic */ Task lambda$getInstanceId$0$FirebaseInstanceId(String str, String str2, String str3, String str4) throws Exception {
        ...
        return toi0.m192068f(new InstanceIdResultImpl(str3, str4));
    }
    ...
    public final /* synthetic */ Task lambda$getInstanceId$2$FirebaseInstanceId(final String str, final String str2, final String str3, final Store.Token token) {
        return this.rpc.getToken(str, str2, str3).mo15432q(this.fileIoExecutor, new zdg0(this, str2, str3, str) { // from class: com.google.firebase.iid.FirebaseInstanceId$$Lambda$4
            private final FirebaseInstanceId arg$1;
            private final String arg$2;
            private final String arg$3;
        ...
        }).mo15420e(FirebaseInstanceId$$Lambda$5.$instance, new to50(this, token) { // from class: com.google.firebase.iid.FirebaseInstanceId$$Lambda$6
            private final FirebaseInstanceId arg$1;
