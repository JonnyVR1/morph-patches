...
final class PausableExecutorServiceImpl implements PausableExecutorService {
    ...
    public static /* synthetic */ Object m16767b(Runnable runnable) {
        runnable.run();
        return null;
    }

    /* JADX INFO: renamed from: d */
    public static /* synthetic */ Object m16768d(Runnable runnable, Object obj) {
        runnable.run();
        return obj;
    }
    ...
    public <T> Future<T> submit(final Runnable runnable, final T t) {
        return submit(new Callable() { // from class: com.google.firebase.concurrent.r
            ...
            public final Object call() {
                return PausableExecutorServiceImpl.m16768d(runnable, t);
            }
        });
    }
    ...
    public Future<?> submit(final Runnable runnable) {
        return submit(new Callable() { // from class: com.google.firebase.concurrent.q
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return PausableExecutorServiceImpl.m16767b(runnable);
            }
        });
    }
}
