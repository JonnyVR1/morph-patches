...
public final class zzbpn extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzbpn> CREATOR = new oss0();
    ...
    public zzbpn(@SafeParcelable.Param(m12518id = 1) String str, @SafeParcelable.Param(m12518id = 2) Bundle bundle) {
        this.zza = str;
        this.zzb = bundle;
    }
