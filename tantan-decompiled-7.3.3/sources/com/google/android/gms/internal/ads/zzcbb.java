...
public final class zzcbb extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzcbb> CREATOR = new i8t0();
    ...
    public zzcbb(@SafeParcelable.Param(m12518id = 1) String str, @SafeParcelable.Param(m12518id = 2) String str2) {
        this.zza = str;
        this.zzb = str2;
    }
