...
final class zzfm extends BroadcastReceiver {
    ...
    public final /* synthetic */ C2233o1 f10264a;

    public /* synthetic */ zzfm(C2233o1 c2233o1, vbw0 vbw0Var) {
        this.f10264a = c2233o1;
    }
    ...
    public final void onReceive(Context context, Intent intent) throws Throwable {
        ...
        if (mpw0.f137957a < 31 || i != 5) {
            C2233o1.m13125c(this.f10264a, i);
            return;
        }
        C2233o1 c2233o1 = this.f10264a;
        try {
            TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
            if (telephonyManager == null) {
                throw null;
            }
            uaw0 uaw0Var = new uaw0(c2233o1);
            telephonyManager.registerTelephonyCallback(context.getMainExecutor(), uaw0Var);
            telephonyManager.unregisterTelephonyCallback(uaw0Var);
        } catch (RuntimeException unused2) {
            C2233o1.m13125c(c2233o1, 5);
        }
    }
}
