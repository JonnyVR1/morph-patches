...
public final class zzcei extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzcei> CREATOR = new ict0();
    ...
    public zzcei(@SafeParcelable.Param(m12518id = 2) String str, @SafeParcelable.Param(m12518id = 3) int i, @SafeParcelable.Param(m12518id = 4) int i2, @SafeParcelable.Param(m12518id = 5) boolean z, @SafeParcelable.Param(m12518id = 6) boolean z2) {
        this.zza = str;
        this.zzb = i;
        this.zzc = i2;
        this.zzd = z;
