...
final class zzgbp extends zzgad {
    ...
    public static zzgbp zzj(int i, Object[] objArr, C2298w2 c2298w2) {
        boolean z;
        int i2;
        char c;
        ?? r3;
        ...
        tow0.m192087b(i4, objArrCopyOf.length >> 1, FirebaseAnalytics.Param.INDEX);
        ...
        if (i4 != 1) {
            ...
            if (iZzh <= 128) {
                ...
                while (i7 < i4) {
                    ...
                    tpw0.m192214b(obj3, obj4);
                    int iM146640a = jqw0.m146640a(obj3.hashCode());
                    while (true) {
                        int i11 = iM146640a & i6;
                        z2 = z5;
                        i3 = i5;
                        ...
                        if (obj3.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                            ...
                            srw0 srw0Var5 = new srw0(obj3, obj4, obj5);
                ...
                if (iZzh <= 32768) {
                    ...
                    for (int i15 = 0; i15 < i4; i15++) {
                        ...
                        tpw0.m192214b(obj6, obj7);
                        int iM146640a2 = jqw0.m146640a(obj6.hashCode());
                        while (true) {
                            int i18 = iM146640a2 & i6;
                            ...
                            if (obj6.equals(objArrCopyOf[c4])) {
                                ...
                                srw0 srw0Var6 = new srw0(obj6, obj7, obj8);
                    ...
                    if (i14 == i4) {
                        ...
                        r5 = new Object[]{sArr, Integer.valueOf(i14), srw0Var4};
                        z4 = z;
                    }
                } else {
                    ...
                    while (i20 < i4) {
                        ...
                        tpw0.m192214b(obj9, obj10);
                        int iM146640a3 = jqw0.m146640a(obj9.hashCode());
                        while (true) {
                            int i24 = iM146640a3 & i6;
                            int i25 = iArr[i24];
                            if (i25 == -1) {
                                iArr[i24] = i22;
                                if (i21 < i20) {
                            ...
                            if (obj9.equals(objArrCopyOf[i25])) {
                                ...
                                srw0 srw0Var7 = new srw0(obj9, obj10, obj11);
            ...
            if (z3) {
                objArr2 = (Object[]) r3;
                srw0Var = (srw0) objArr2[c];
                if (c2298w2 != null) {
                    throw srw0Var.m187639a();
                }
                c2298w2.f10135c = srw0Var;
        ...
        if (obj == null) {
            ...
            if (i == 1) {
                ...
                if (obj4 == null) {
                    ...
                    int iM146640a = jqw0.m146640a(obj.hashCode());
                    while (true) {
                        int i2 = iM146640a & length;
                        int i3 = bArr[i2] & 255;
                        if (i3 == 255) {
                            break;
                        }
                    ...
                    int iM146640a2 = jqw0.m146640a(obj.hashCode());
                    while (true) {
                        int i4 = iM146640a2 & length2;
                        char c = (char) sArr[i4];
                        if (c == 65535) {
                            break;
                        }
                    ...
                    int iM146640a3 = jqw0.m146640a(obj.hashCode());
                    while (true) {
                        int i5 = iM146640a3 & length3;
                        int i6 = iArr[i5];
                        if (i6 == -1) {
                            break;
                        }
