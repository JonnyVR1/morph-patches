...
public abstract class zzu extends zzq implements List, RandomAccess {
    private static final jjr0 zza = new kuy0(zzy.zza, 0);
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i = 0; i < size; i++) {
                if (!uqw0.m197378a(get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !uqw0.m197378a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    public final jjr0 listIterator(int i) {
        j3y0.m143369b(i, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new kuy0(this, i);
    }
}
