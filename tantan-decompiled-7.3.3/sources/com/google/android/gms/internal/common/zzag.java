...
public abstract class zzag extends zzac implements List, RandomAccess {
    private static final bor0 zza = new mgr0(zzai.zza, 0);
    ...
    public static zzag zzj(Iterable iterable) {
        ...
        bfr0 bfr0Var = new bfr0(4);
        bfr0Var.m103979b(next);
        bfr0Var.m103980c(it);
        bfr0Var.f188163c = true;
        return zzi(bfr0Var.f188161a, bfr0Var.f188162b);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i = 0; i < size; i++) {
                if (!osy0.m169065a(get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !osy0.m169065a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    public final bor0 listIterator(int i) {
        tuy0.m192767b(i, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new mgr0(this, i);
    }
}
