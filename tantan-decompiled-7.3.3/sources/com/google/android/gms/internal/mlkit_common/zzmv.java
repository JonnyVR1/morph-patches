...
public enum zzmv {
    ...
    ON_DEVICE_IMAGE_LABEL_CREATE(CipherSuite.TLS_DHE_PSK_WITH_RC4_128_SHA),
    ...
    CLOUD_WEB_SEARCH_CLOSE(CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID_RELEASE(HttpStatus.METHOD_NOT_ALLOWED_405),
    OPTIONAL_MODULE_NLCLASSIFIER(HttpStatus.LENGTH_REQUIRED_411),
    OPTIONAL_MODULE_NLCLASSIFIER_CREATE(HttpStatus.PRECONDITION_FAILED_412),
    OPTIONAL_MODULE_NLCLASSIFIER_INIT(HttpStatus.REQUEST_ENTITY_TOO_LARGE_413),
    OPTIONAL_MODULE_NLCLASSIFIER_INFERENCE(HttpStatus.REQUEST_URI_TOO_LONG_414),
    OPTIONAL_MODULE_NLCLASSIFIER_RELEASE(HttpStatus.UNSUPPORTED_MEDIA_TYPE_415),
    NLCLASSIFIER_CLIENT_LIBRARY(421),
    NLCLASSIFIER_CLIENT_LIBRARY_CREATE(HttpStatus.UNPROCESSABLE_ENTITY_422),
    NLCLASSIFIER_CLIENT_LIBRARY_CLASSIFY(HttpStatus.LOCKED_423),
    NLCLASSIFIER_CLIENT_LIBRARY_CLOSE(HttpStatus.FAILED_DEPENDENCY_424),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(HttpStatus.BAD_GATEWAY_502),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(HttpStatus.SERVICE_UNAVAILABLE_503),
    ON_DEVICE_EXPLICIT_CONTENT_CLOSE(HttpStatus.GATEWAY_TIMEOUT_504),
    ON_DEVICE_FACE_MESH_CREATE(UnixStat.DEFAULT_LINK_PERM),
    ...
    ON_DEVICE_IMAGE_CAPTIONING_CREATE(IdentityFaceState.FACE_OPEN_MOUTH_DONE),
    ...
    ON_DEVICE_STAIN_REMOVAL_LOAD(DetectDelayStopHelper.TYPE_DETECT_RIG),
    ...
    ON_DEVICE_SHADOW_REMOVAL_CLOSE(IMediaPlayer.MEDIA_INFO_INITBUFFERING_START),
    OPTIONAL_MODULE_SHADOW_REMOVAL_CREATE(Constants.AUDIO_MIXING_STATE_PAUSED),
    OPTIONAL_MODULE_SHADOW_REMOVAL_INIT(712),
    OPTIONAL_MODULE_SHADOW_REMOVAL_INFERENCE(Constants.AUDIO_MIXING_STATE_STOPPED),
    OPTIONAL_MODULE_SHADOW_REMOVAL_CLOSE(Constants.AUDIO_MIXING_STATE_FAILED),
    ON_DEVICE_DIGITAL_INK_SEGMENTATION_CREATE(Constants.AUDIO_MIXING_REASON_ONE_LOOP_COMPLETED),
    ON_DEVICE_DIGITAL_INK_SEGMENTATION_LOAD(722),
    ON_DEVICE_DIGITAL_INK_SEGMENTATION_DOWNLOAD(Constants.AUDIO_MIXING_REASON_ALL_LOOPS_COMPLETED),
    ON_DEVICE_DIGITAL_INK_SEGMENTATION_PROCESS(Constants.AUDIO_MIXING_REASON_STOPPED_BY_USER),
    ...
    ON_DEVICE_SUBJECT_SEGMENTATION_CREATE(DetectDelayStopHelper.TYPE_DETECT_BODY),
    ON_DEVICE_SUBJECT_SEGMENTATION_LOAD(DetectDelayStopHelper.TYPE_DETECT_CARTOON),
    ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(DetectDelayStopHelper.TYPE_DETECT_CRYING_FACE),
    ON_DEVICE_SUBJECT_SEGMENTATION_CLOSE(DetectDelayStopHelper.TYPE_DETECT_AR_GIFT),
