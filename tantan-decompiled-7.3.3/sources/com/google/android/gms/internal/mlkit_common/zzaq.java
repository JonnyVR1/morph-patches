...
final class zzaq extends zzai {
    ...
    public static zzaq zzg(int i, Object[] objArr, C2393a c2393a) {
        int iHighestOneBit;
        boolean z;
        int i2;
        char c;
        ...
        mwy0.m160611b(i4, objArrCopyOf.length >> 1, FirebaseAnalytics.Param.INDEX);
        char c3 = 2;
        ...
        if (iMax < 751619276) {
            ...
            if (iMax >= 1073741824) {
                wg3.m206174a("collection too large");
                return null;
            }
        }
        if (i4 != 1) {
            ...
            if (iHighestOneBit <= 128) {
                ...
                while (i7 < i4) {
                    ...
                    j1z0.m143160a(obj3, obj4);
                    int iM184599a = s4z0.m184599a(obj3.hashCode());
                    while (true) {
                        int i11 = iM184599a & i6;
                        z2 = z5;
                        i3 = i5;
                        ...
                        if (obj3.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                            ...
                            ijr0 ijr0Var5 = new ijr0(obj3, obj4, obj5);
                ...
                if (iHighestOneBit <= 32768) {
                    ...
                    for (int i15 = 0; i15 < i4; i15++) {
                        ...
                        j1z0.m143160a(obj6, obj7);
                        int iM184599a2 = s4z0.m184599a(obj6.hashCode());
                        while (true) {
                            int i18 = iM184599a2 & i6;
                            ...
                            if (obj6.equals(objArrCopyOf[c4])) {
                                ...
                                ijr0 ijr0Var6 = new ijr0(obj6, obj7, obj8);
                    ...
                    if (i14 == i4) {
                        ...
                        r5 = new Object[]{sArr, Integer.valueOf(i14), ijr0Var4};
                        z4 = z;
                    }
                } else {
                    ...
                    while (i20 < i4) {
                        ...
                        j1z0.m143160a(obj9, obj10);
                        int iM184599a3 = s4z0.m184599a(obj9.hashCode());
                        while (true) {
                            int i24 = iM184599a3 & i6;
                            int i25 = iArr[i24];
                            if (i25 == -1) {
                                iArr[i24] = i22;
                                if (i21 < i20) {
                            ...
                            if (obj9.equals(objArrCopyOf[i25])) {
                                ...
                                ijr0 ijr0Var7 = new ijr0(obj9, obj10, obj11);
            ...
            if (z3) {
                objArr2 = (Object[]) r3;
                ijr0Var = (ijr0) objArr2[c];
                if (c2393a != null) {
                    throw ijr0Var.m140239a();
                }
                c2393a.f10340c = ijr0Var;
        ...
        if (obj == null) {
            ...
            if (i == 1) {
                ...
                if (obj4 == null) {
                    ...
                    int iM184599a = s4z0.m184599a(obj.hashCode());
                    while (true) {
                        int i2 = iM184599a & length;
                        int i3 = bArr[i2] & 255;
                        if (i3 == 255) {
                            break;
                        }
                    ...
                    int iM184599a2 = s4z0.m184599a(obj.hashCode());
                    while (true) {
                        int i4 = iM184599a2 & length2;
                        char c = (char) sArr[i4];
                        if (c == 65535) {
                            break;
                        }
                    ...
                    int iM184599a3 = s4z0.m184599a(obj.hashCode());
                    while (true) {
                        int i5 = iM184599a3 & length3;
                        int i6 = iArr[i5];
                        if (i6 == -1) {
                            break;
                        }
