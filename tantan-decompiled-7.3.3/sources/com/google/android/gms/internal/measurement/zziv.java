...
class zziv extends zzis {
    ...
    public final boolean zza(zzik zzikVar, int i, int i2) {
        if (i2 > zzikVar.zzb()) {
            pgx0.m172284a(i2, zzb());
            return false;
        }
        if (i2 > zzikVar.zzb()) {
            dpq0.m117417a("Ran off end of other: 0, ", i2, ", ", zzikVar.zzb());
            return false;
        }
    ...
    public final int zzb(int i, int i2, int i3) {
        return i2y0.m138249a(i, this.zzb, zzc(), i3);
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzik
    public final void zza(vvx0 vvx0Var) throws IOException {
        vvx0Var.mo14767a(this.zzb, zzc(), zzb());
    }
