...
final class zzdr extends zzcw {
    ...
    public final boolean containsAll(Collection collection) {
        if (collection instanceof p6u0) {
            collection = ((p6u0) collection).zza();
        }
        if (!C2402d.m14810a(((zzcw) this).zza, collection) || collection.size() <= 1) {
            return super.containsAll(collection);
        }
        vxu0 vxu0VarListIterator = this.zzd.listIterator(0);
        Iterator it = collection.iterator();
        if (!vxu0VarListIterator.hasNext()) {
            return false;
        }
        Object next = it.next();
        E next2 = vxu0VarListIterator.next();
        while (true) {
            try {
                ...
                if (iCompare < 0) {
                    ...
                    next2 = vxu0VarListIterator.next();
                } else {
                    if (iCompare != 0) {
                        return false;
                    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!C2402d.m14810a(((zzcw) this).zza, set)) {
            return containsAll(set);
        }
        Iterator it = set.iterator();
        try {
            vxu0 vxu0VarListIterator = this.zzd.listIterator(0);
            while (vxu0VarListIterator.hasNext()) {
                E next = vxu0VarListIterator.next();
    ...
    public final pwu0 descendingIterator() {
