...
public final class C2419l0 {

    /* JADX INFO: renamed from: a */
    public static final /* synthetic */ int f10389a = 0;

    static {
        if (q1y0.m174932C() && q1y0.m174933D()) {
            int i = kpw0.f128134a;
        }
    }

    /* JADX INFO: renamed from: a */
    public static /* bridge */ /* synthetic */ int m14917a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 == 0) {
            if (b <= -12) {
    ...
    public static int m14918b(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
    ...
    public static int m14919c(String str) {
        int length = str.length();
        int i = 0;
    ...
    public static boolean m14920d(byte[] bArr, int i, int i2) {
        while (i < i2 && bArr[i] >= 0) {
            i++;
        }
        if (i >= i2) {
        ...
        while (i < i2) {
            ...
            if (iM14917a >= 0) {
                ...
                int i5 = i + 2;
                int i6 = bArr[i3];
                if (i6 > -65 || (((iM14917a << 28) + (i6 + 112)) >> 30) != 0) {
                    return false;
                }
                int i7 = i + 3;
                if (bArr[i5] > -65) {
