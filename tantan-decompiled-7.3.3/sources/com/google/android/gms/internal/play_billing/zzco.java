...
public abstract class zzco extends zzcj implements List, RandomAccess {
    private static final vxu0 zza = new ukt0(zzdk.zza, 0);
    ...
    public static zzco zzm(Object obj) {
        Object[] objArr = {obj};
        c9u0.m108459b(objArr, 1);
        return zzj(objArr, 1);
    }

    public static Collector zzo() {
        return vzs0.m204124a();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i = 0; i < size; i++) {
                if (!sds0.m185509a(get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        ...
        while (it.hasNext()) {
            if (!it2.hasNext() || !sds0.m185509a(it.next(), it2.next())) {
                return false;
            }
        }
        return !it2.hasNext();
    ...
    public zzco subList(int i, int i2) {
        ses0.m185570e(i, i2, size());
        int i3 = i2 - i;
        if (i3 == size()) {
            return this;
        }
        return i3 == 0 ? zzdk.zza : new zzcn(this, i, i3);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzn, reason: merged with bridge method [inline-methods] */
    public final vxu0 listIterator(int i) {
        ses0.m185567b(i, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new ukt0(this, i);
    }
}
