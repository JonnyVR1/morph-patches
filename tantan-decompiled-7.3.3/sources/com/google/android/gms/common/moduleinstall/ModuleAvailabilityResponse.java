...
public class ModuleAvailabilityResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "areModulesAvailable", m12517id = 1)
    private final boolean zaa;

    @SafeParcelable.Field(getter = "getAvailabilityStatus", m12517id = 2)
    ...
    @KeepForSdk
    public ModuleAvailabilityResponse(@SafeParcelable.Param(m12518id = 1) boolean z, @SafeParcelable.Param(m12518id = 2) int i) {
        this.zaa = z;
        this.zab = i;
    }
