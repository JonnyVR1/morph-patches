...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getApiFeatures", m12517id = 1)
    private final List zab;

    @SafeParcelable.Field(getter = "getIsUrgent", m12517id = 2)
    private final boolean zac;

    @Nullable
    @SafeParcelable.Field(getter = "getFeatureRequestSessionId", m12517id = 3)
    private final String zad;

    @Nullable
    @SafeParcelable.Field(getter = "getCallingPackage", m12517id = 4)
    private final String zae;

    @SafeParcelable.Constructor
    public ApiFeatureRequest(@NonNull @SafeParcelable.Param(m12518id = 1) List list, @SafeParcelable.Param(m12518id = 2) boolean z, @Nullable @SafeParcelable.Param(m12518id = 3) String str, @Nullable @SafeParcelable.Param(m12518id = 4) String str2) {
