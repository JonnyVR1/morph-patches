...
public class ModuleInstallIntentResponse extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m12517id = 1)
    private final PendingIntent zaa;

    @SafeParcelable.Constructor
    @KeepForSdk
    public ModuleInstallIntentResponse(@Nullable @SafeParcelable.Param(m12518id = 1) PendingIntent pendingIntent) {
