...
public final class zaaw implements zabf {
    ...
    private final void zaB(boolean z) {
        o7r0 o7r0Var = this.zak;
        if (o7r0Var != null) {
            if (o7r0Var.isConnected() && z) {
                o7r0Var.zaa();
            }
            o7r0Var.disconnect();
            this.zao = null;
    ...
    private final void zaC() {
        ...
        if (o7r0Var != null) {
            if (this.zap) {
                o7r0Var.mo149032a((IAccountAccessor) Preconditions.checkNotNull(this.zao), this.zaq);
            }
            zaB(false);
        }
    ...
    /* JADX WARN: Type inference failed for: r0v13, types: [com.google.android.gms.common.api.Api$Client, l.o7r0] */
    @Override // com.google.android.gms.common.api.internal.zabf
