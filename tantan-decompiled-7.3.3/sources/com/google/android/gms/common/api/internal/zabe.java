...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public zabe(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, Api.AbstractClientBuilder abstractClientBuilder, Map map, List list, List list2, Map map2, int i, int i2, ArrayList arrayList) {
        ...
        this.zar = Constants.PN_IMAGE_DOWNLOAD_TIMEOUT_IN_MILLIS;
    ...
    private final void zal(int i) {
        ...
        if (num == null) {
            ...
            uid0.m196153a("Cannot use sign-in mode: ", zag(i), ". Mode was already set to ", zag(this.zaw.intValue()));
            return;
        }
        if (this.zal != null) {
            return;
        ...
        } else if (!zRequiresSignIn) {
            wtq0.m207906a("SIGN_IN_MODE_REQUIRED cannot be used on a GoogleApiClient that does not contain any authenticated APIs. Use connect() instead.");
            return;
        } else if (zProvidesSignIn) {
            wtq0.m207906a("Cannot use SIGN_IN_MODE_REQUIRED with GOOGLE_SIGN_IN_API. Use connect(SIGN_IN_MODE_OPTIONAL) instead.");
            return;
        }
    ...
    public final void stopAutoManage(@NonNull FragmentActivity fragmentActivity) {
        ...
        if (this.zam >= 0) {
            ...
            wtq0.m207906a("Called stopAutoManage but automatic lifecycle management is not enabled.");
        }
    }
