...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new p01();
    private final Set zaq = new p01();

    @KeepForSdk
    private GoogleApiManager(Context context, Looper looper, GoogleApiAvailability googleApiAvailability) {
        this.zas = true;
        this.zai = context;
        n8r0 n8r0Var = new n8r0(looper, this);
        this.zar = n8r0Var;
        ...
        n8r0Var.sendMessage(n8r0Var.obtainMessage(6));
    }
    ...
    private final void zaJ(sni0 sni0Var, int i, GoogleApi googleApi) {
        zacd zacdVarZaa;
        if (i == 0 || (zacdVarZaa = zacd.zaa(this, i, googleApi.getApiKey())) == null) {
            return;
        }
        Task taskM186939a = sni0Var.m186939a();
        final Handler handler = this.zar;
        handler.getClass();
        taskM186939a.mo15417b(new Executor() { // from class: com.google.android.gms.common.api.internal.zabk
        ...
        switch (i) {
            ...
            case 14:
                ...
                if (this.zan.containsKey(apiKeyZaa)) {
                    zaafVar.zab().m186941c(Boolean.valueOf(((zabq) this.zan.get(apiKeyZaa)).zaO(false)));
                } else {
                    zaafVar.zab().m186941c(Boolean.FALSE);
                }
                return true;
            case 15:
    ...
    public final Task zao(@NonNull GoogleApi googleApi, @NonNull RegisterListenerMethod registerListenerMethod, @NonNull UnregisterListenerMethod unregisterListenerMethod, @NonNull Runnable runnable) {
        ...
        zaJ(sni0Var, registerListenerMethod.zaa(), googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(8, new zach(new zaf(new zaci(registerListenerMethod, unregisterListenerMethod, runnable), sni0Var), this.zam.get(), googleApi)));
    ...
    public final Task zap(@NonNull GoogleApi googleApi, @NonNull ListenerHolder.ListenerKey listenerKey, int i) {
        sni0 sni0Var = new sni0();
        zaJ(sni0Var, i, googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(13, new zach(new zah(listenerKey, sni0Var), this.zam.get(), googleApi)));
        return sni0Var.m186939a();
    }
    ...
    public final void zav(@NonNull GoogleApi googleApi, int i, @NonNull TaskApiCall taskApiCall, @NonNull sni0 sni0Var, @NonNull StatusExceptionMapper statusExceptionMapper) {
        zaJ(sni0Var, taskApiCall.zaa(), googleApi);
        this.zar.sendMessage(this.zar.obtainMessage(4, new zach(new zag(i, taskApiCall, sni0Var, statusExceptionMapper), this.zam.get(), googleApi)));
    }
