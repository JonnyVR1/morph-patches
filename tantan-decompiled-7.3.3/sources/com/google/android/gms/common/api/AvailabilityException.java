...
public class AvailabilityException extends Exception {
    ...
    public AvailabilityException(@NonNull l01 l01Var) {
        this.zaa = l01Var;
    }
    ...
    public ConnectionResult getConnectionResult(@NonNull GoogleApi<? extends Api.ApiOptions> googleApi) {
        ...
        Preconditions.checkArgument(l01Var.get(apiKey) != null, "The given API (" + apiKey.zaa() + ") was not part of the availability request.");
