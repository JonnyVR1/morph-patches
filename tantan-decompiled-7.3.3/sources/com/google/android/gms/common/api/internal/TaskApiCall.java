...
public abstract class TaskApiCall<A extends Api.AnyClient, ResultT> {
    ...
    public static class Builder<A extends Api.AnyClient, ResultT> {
        ...
        @KeepForSdk
        @Deprecated
        public Builder<A, ResultT> execute(@NonNull final BiConsumer<A, sni0<ResultT>> biConsumer) {
            this.zaa = new RemoteCall() { // from class: com.google.android.gms.common.api.internal.zacu
                @Override // com.google.android.gms.common.api.internal.RemoteCall
                public final void accept(Object obj, Object obj2) {
                    biConsumer.accept((Api.AnyClient) obj, (sni0) obj2);
                }
            };
            return this;
        }
        ...
        @NonNull
        @KeepForSdk
        public Builder<A, ResultT> run(@NonNull RemoteCall<A, sni0<ResultT>> remoteCall) {
            this.zaa = remoteCall;
            return this;
        }
    ...
    @KeepForSdk
    public abstract void doExecute(@NonNull A a, @NonNull sni0<ResultT> sni0Var) throws RemoteException;
