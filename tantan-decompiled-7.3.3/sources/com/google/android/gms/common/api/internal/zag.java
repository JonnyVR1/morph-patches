...
public final class zag extends zac {
    ...
    private final sni0 zab;
    private final StatusExceptionMapper zad;

    public zag(int i, TaskApiCall taskApiCall, sni0 sni0Var, StatusExceptionMapper statusExceptionMapper) {
        super(i);
        this.zab = sni0Var;
        this.zaa = taskApiCall;
        this.zad = statusExceptionMapper;
        if (i == 2 && taskApiCall.shouldAutoResolveMissingFeatures()) {
            wg3.m206174a("Best-effort write calls cannot pass methods that should auto-resolve missing features.");
            throw null;
        }
    }
    ...
    public final void zad(@NonNull Status status) {
        this.zab.m186942d(this.zad.getException(status));
    }

    @Override // com.google.android.gms.common.api.internal.zai
    public final void zae(@NonNull Exception exc) {
        this.zab.m186942d(exc);
    }
