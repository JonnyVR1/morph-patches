...
@RestrictedInheritance(allowedOnPath = ".*java.*/com/google/android/gms.*", allowlistAnnotations = {i7r0.class, n7r0.class}, explanation = "Sub classing of GMS Core's APIs are restricted to GMS Core client libs and testing fakes.", link = "go/gmscore-restrictedinheritance")
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Task<Void> checkApiAvailability(@NonNull GoogleApi<?> googleApi, @NonNull GoogleApi<?>... googleApiArr) {
        return zai(googleApi, googleApiArr).mo15433r(new zdg0() { // from class: com.google.android.gms.common.zab
            @Override // p153l.zdg0
    ...
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i, @NonNull c60<IntentSenderRequest> c60Var, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i, null, onCancelListener, new zac(this, activity, i, c60Var));
        if (dialogZaa == null) {
            return false;
        }
    ...
    public final zabx zac(Context context, zabw zabwVar) {
        ...
        h8r0.m133944p(context, zabxVar, intentFilter);
        zabxVar.zaa(context);
    ...
    public final void zae(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                style.addAction(bcc0.f76127a, resources.getString(com.google.android.gms.base.R$string.f9837o), pendingIntent);
            } else {
                style.setContentIntent(pendingIntent);
            }
        } else {
            style.setSmallIcon(android.R.drawable.stat_sys_warning).setTicker(resources.getString(com.google.android.gms.base.R$string.f9830h)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                String string = context.getResources().getString(com.google.android.gms.base.R$string.f9829g);
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(iy40.m142608a("com.google.android.gms.availability", string, 4));
    ...
    public final boolean zah(@NonNull Context context, @NonNull ConnectionResult connectionResult, int i) {
        ...
        zae(context, connectionResult.getErrorCode(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), i8r0.f113366a | 134217728));
        return true;
    }
    ...
    public Task<Void> checkApiAvailability(@NonNull HasApiKey<?> hasApiKey, @NonNull HasApiKey<?>... hasApiKeyArr) {
        return zai(hasApiKey, hasApiKeyArr).mo15433r(new zdg0() { // from class: com.google.android.gms.common.zaa
            @Override // p153l.zdg0
            public final Task then(Object obj) {
                int i = GoogleApiAvailability.GOOGLE_PLAY_SERVICES_VERSION_CODE;
                return toi0.m192068f(null);
