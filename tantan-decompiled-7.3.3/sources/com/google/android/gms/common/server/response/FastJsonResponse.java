...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, @Nullable Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                o4c.m165980a("Unsupported type for conversion: ", i);
                break;
            case 4:
                if (objZae == null) {
                    zaG(str);
    ...
    public boolean isFieldSet(@NonNull Field field) {
        ...
        if (field.zad) {
            pr3.m173429a("Concrete type arrays not supported");
            return false;
        }
        pr3.m173429a("Concrete types not supported");
        return false;
    }
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "getTypeIn", m12517id = 2)
        protected final int zaa;

        @SafeParcelable.Field(getter = "isTypeInArray", m12517id = 3)
        protected final boolean zab;

        @SafeParcelable.Field(getter = "getTypeOut", m12517id = 4)
        protected final int zac;

        @SafeParcelable.Field(getter = "isTypeOutArray", m12517id = 5)
        protected final boolean zad;

        @NonNull
        @SafeParcelable.Field(getter = "getOutputFieldName", m12517id = 6)
        protected final String zae;

        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", m12517id = 7)
        ...
        @Nullable
        @SafeParcelable.Field(getter = "getConcreteTypeName", m12517id = 8)
        protected final String zah;

        @SafeParcelable.VersionField(getter = "getVersionCode", m12520id = 1)
        private final int zai;
        private zan zaj;

        @Nullable
        @SafeParcelable.Field(getter = "getWrappedConverter", m12517id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        private final FieldConverter zak;

        @SafeParcelable.Constructor
        public Field(@SafeParcelable.Param(m12518id = 1) int i, @SafeParcelable.Param(m12518id = 2) int i2, @SafeParcelable.Param(m12518id = 3) boolean z, @SafeParcelable.Param(m12518id = 4) int i3, @SafeParcelable.Param(m12518id = 5) boolean z2, @SafeParcelable.Param(m12518id = 6) String str, @SafeParcelable.Param(m12518id = 7) int i4, @Nullable @SafeParcelable.Param(m12518id = 8) String str2, @Nullable @SafeParcelable.Param(m12518id = 9) com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zai = i;
            this.zaa = i2;
            this.zab = z;
            this.zac = i3;
