...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m12517id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m12518id = 1) int i, @SafeParcelable.Param(m12518id = 2) ArrayList arrayList, @SafeParcelable.Param(m12518id = 3) String str) {
        this.zaa = i;
