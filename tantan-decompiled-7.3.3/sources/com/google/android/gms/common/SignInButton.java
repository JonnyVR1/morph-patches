...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, ahc0.f71337a, 0, 0);
        try {
            this.zaa = typedArrayObtainStyledAttributes.getInt(ahc0.f71338b, 0);
            this.zab = typedArrayObtainStyledAttributes.getInt(ahc0.f71339c, 2);
