...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.Field(getter = "getColumns", m12517id = 1)
    private final String[] zag;

    @SafeParcelable.Field(getter = "getWindows", m12517id = 2)
    private final CursorWindow[] zah;

    @SafeParcelable.Field(getter = "getStatusCode", m12517id = 3)
    private final int zai;

    @Nullable
    @SafeParcelable.Field(getter = "getMetadata", m12517id = 4)
    ...
    private final void zae(String str, int i) {
        ...
        if (bundle == null || !bundle.containsKey(str)) {
            wg3.m206174a("No such column: ".concat(String.valueOf(str)));
        } else if (isClosed()) {
            wg3.m206174a("Buffer is closed.");
    ...
    public DataHolder(@SafeParcelable.Param(m12518id = 1000) int i, @SafeParcelable.Param(m12518id = 1) String[] strArr, @SafeParcelable.Param(m12518id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(m12518id = 3) int i2, @Nullable @SafeParcelable.Param(m12518id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
