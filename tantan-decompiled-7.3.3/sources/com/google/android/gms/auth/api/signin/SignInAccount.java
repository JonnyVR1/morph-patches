...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    public static final Parcelable.Creator<SignInAccount> CREATOR = new b4u0();

    @SafeParcelable.Field(defaultValue = "", m12517id = 4)
    @Deprecated
    private String zzbv;

    @SafeParcelable.Field(getter = "getGoogleSignInAccount", m12517id = 7)
    private GoogleSignInAccount zzbw;

    @SafeParcelable.Field(defaultValue = "", m12517id = 8)
    @Deprecated
    private String zzbx;

    @SafeParcelable.Constructor
    public SignInAccount(@SafeParcelable.Param(m12518id = 4) String str, @SafeParcelable.Param(m12518id = 7) GoogleSignInAccount googleSignInAccount, @SafeParcelable.Param(m12518id = 8) String str2) {
