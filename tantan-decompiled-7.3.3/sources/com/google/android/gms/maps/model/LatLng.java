...
public final class LatLng extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @KeepForSdk
    public static final Parcelable.Creator<LatLng> CREATOR = new gyv0();
    ...
    public LatLng(@SafeParcelable.Param(m12518id = 2) double d, @SafeParcelable.Param(m12518id = 3) double d2) {
