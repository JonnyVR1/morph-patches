...
public class StreetViewPanoramaCamera extends AbstractSafeParcelable implements ReflectedParcelable {
    public static final Parcelable.Creator<StreetViewPanoramaCamera> CREATOR = new rdy0();
    ...
    public StreetViewPanoramaCamera(@SafeParcelable.Param(m12518id = 2) float f, @SafeParcelable.Param(m12518id = 3) float f2, @SafeParcelable.Param(m12518id = 4) float f3) {
        ...
        this.zzeg = new StreetViewPanoramaOrientation.C2469a().m15113c(f2).m15111a(f3).m15112b();
    }
