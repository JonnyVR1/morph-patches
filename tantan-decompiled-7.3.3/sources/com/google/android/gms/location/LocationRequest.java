...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "Priority.PRIORITY_BALANCED_POWER_ACCURACY", getter = "getPriority", m12517id = 1)
    private int zza;

    @SafeParcelable.Field(defaultValue = "3600000", getter = "getIntervalMillis", m12517id = 2)
    private long zzb;

    @SafeParcelable.Field(defaultValue = "600000", getter = "getMinUpdateIntervalMillis", m12517id = 3)
    private long zzc;

    @SafeParcelable.Field(defaultValue = "0", getter = "getMaxUpdateDelayMillis", m12517id = 8)
    private long zzd;

    @SafeParcelable.Field(defaultValueUnchecked = "Long.MAX_VALUE", getter = "getDurationMillis", m12517id = 10)
    private long zze;

    @SafeParcelable.Field(defaultValueUnchecked = "Integer.MAX_VALUE", getter = "getMaxUpdates", m12517id = 6)
    private int zzf;

    @SafeParcelable.Field(defaultValue = "0", getter = "getMinUpdateDistanceMeters", m12517id = 7)
    private float zzg;

    @SafeParcelable.Field(defaultValue = "false", getter = "isWaitForAccurateLocation", m12517id = 9)
    private boolean zzh;

    @SafeParcelable.Field(defaultValueUnchecked = User.ID_TEAM_ACCOUNT, getter = "getMaxUpdateAgeMillis", m12517id = 11)
    private long zzi;

    @SafeParcelable.Field(defaultValueUnchecked = "Granularity.GRANULARITY_PERMISSION_LEVEL", getter = "getGranularity", m12517id = 12)
    private final int zzj;

    @SafeParcelable.Field(defaultValueUnchecked = "ThrottleBehavior.THROTTLE_BACKGROUND", getter = "getThrottleBehavior", m12517id = 13)
    private final int zzk;

    @Nullable
    @SafeParcelable.Field(getter = "getModuleId", m12517id = 14)
    private final String zzl;

    @SafeParcelable.Field(defaultValue = "false", getter = "isBypass", m12517id = 15)
    private final boolean zzm;

    @SafeParcelable.Field(defaultValueUnchecked = "new android.os.WorkSource()", getter = "getWorkSource", m12517id = 16)
    private final WorkSource zzn;

    @Nullable
    @SafeParcelable.Field(getter = "getImpersonation", m12517id = 17)
    private final com.google.android.gms.internal.location.zzd zzo;

    @SafeParcelable.Constructor
    public LocationRequest(@SafeParcelable.Param(m12518id = 1) int i, @SafeParcelable.Param(m12518id = 2) long j, @SafeParcelable.Param(m12518id = 3) long j2, @SafeParcelable.Param(m12518id = 8) long j3, @SafeParcelable.RemovedParam(defaultValueUnchecked = "Long.MAX_VALUE", m12519id = 5) long j4, @SafeParcelable.Param(m12518id = 10) long j5, @SafeParcelable.Param(m12518id = 6) int i2, @SafeParcelable.Param(m12518id = 7) float f, @SafeParcelable.Param(m12518id = 9) boolean z, @SafeParcelable.Param(m12518id = 11) long j6, @SafeParcelable.Param(m12518id = 12) int i3, @SafeParcelable.Param(m12518id = 13) int i4, @Nullable @SafeParcelable.Param(m12518id = 14) String str, @SafeParcelable.Param(m12518id = 15) boolean z2, @SafeParcelable.Param(m12518id = 16) WorkSource workSource, @Nullable @SafeParcelable.Param(m12518id = 17) com.google.android.gms.internal.location.zzd zzdVar) {
        this.zza = i;
        this.zzb = j;
        this.zzc = j2;
        this.zzd = j3;
    ...
    private static String zzf(long j) {
        return j == Long.MAX_VALUE ? "∞" : ogu0.m167663a(j);
    }
    ...
    public LocationRequest setNumUpdates(int i) {
        ...
        za50.m219101a("invalid numUpdates: ", i);
        return null;
    }
    ...
    public LocationRequest setSmallestDisplacement(float f) {
        ...
        hnd0.m136059a("invalid displacement: ", f);
        return null;
    }
