...
public final class zzaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStartHour", m12517id = 1)
    private final int zza;

    @SafeParcelable.Field(getter = "getStartMinute", m12517id = 2)
    private final int zzb;

    @SafeParcelable.Field(getter = "getEndHour", m12517id = 3)
    private final int zzc;

    @SafeParcelable.Field(getter = "getEndMinute", m12517id = 4)
    private final int zzd;

    @SafeParcelable.Constructor
    public zzaj(@SafeParcelable.Param(m12518id = 1) int i, @SafeParcelable.Param(m12518id = 2) int i2, @SafeParcelable.Param(m12518id = 3) int i3, @SafeParcelable.Param(m12518id = 4) int i4) {
