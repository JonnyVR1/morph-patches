...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStartTimeMillis", m12517id = 1)
    private final long zza;

    @SafeParcelable.Field(getter = "getEndTimeMillis", m12517id = 2)
    private final long zzb;

    @SafeParcelable.Field(getter = "getStatus", m12517id = 3)
    private final int zzc;

    @SafeParcelable.Field(getter = "getMissingDataDurationMinutes", m12517id = 4)
    private final int zzd;

    @SafeParcelable.Field(getter = "getNinetiethPctConfidence", m12517id = 5)
    private final int zze;

    @ShowFirstParty
    @SafeParcelable.Constructor
    public SleepSegmentEvent(@SafeParcelable.Param(m12518id = 1) long j, @SafeParcelable.Param(m12518id = 2) long j2, @SafeParcelable.Param(m12518id = 3) int i, @SafeParcelable.Param(m12518id = 4) int i2, @SafeParcelable.Param(m12518id = 5) int i3) {
