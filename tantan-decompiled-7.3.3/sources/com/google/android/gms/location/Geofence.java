...
public interface Geofence {
    ...
    public static final class Builder {
        ...
        public Geofence build() {
            if (this.zza == null) {
                wg3.m206174a("Request ID not set.");
                return null;
            }
            int i = this.zzb;
            if (i == 0) {
                wg3.m206174a("Transitions types not set.");
                return null;
            }
            if ((i & 4) != 0 && this.zzi < 0) {
                wg3.m206174a("Non-negative loitering delay needs to be set when transition types include GEOFENCE_TRANSITION_DWELL.");
                return null;
            }
            if (this.zzc == Long.MIN_VALUE) {
                wg3.m206174a("Expiration not set.");
                return null;
            }
            if (this.zzd == -1) {
                wg3.m206174a("Geofence region not set.");
                return null;
            }
            if (this.zzh >= 0) {
                return new zzdh(this.zza, this.zzb, (short) 1, this.zze, this.zzf, this.zzg, this.zzc, this.zzh, this.zzi);
            }
            wg3.m206174a("Notification responsiveness should be nonnegative.");
            return null;
        }
