...
public final class LastLocationRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "com.google.android.gms.location.Granularity.GRANULARITY_PERMISSION_LEVEL", getter = "getGranularity", m12517id = 2)
    private final int zzb;

    @SafeParcelable.Field(defaultValue = "false", getter = "isBypass", m12517id = 3)
    private final boolean zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getModuleId", m12517id = 4)
    private final String zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getImpersonation", m12517id = 5)
    private final com.google.android.gms.internal.location.zzd zze;

    @SafeParcelable.Constructor
    public LastLocationRequest(@SafeParcelable.Param(m12518id = 1) long j, @SafeParcelable.Param(m12518id = 2) int i, @SafeParcelable.Param(m12518id = 3) boolean z, @Nullable @SafeParcelable.Param(m12518id = 4) String str, @Nullable @SafeParcelable.Param(m12518id = 5) com.google.android.gms.internal.location.zzd zzdVar) {
        this.zza = j;
        this.zzb = i;
        this.zzc = z;
        this.zzd = str;
