...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", m12517id = 4)
    int zzc;

    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", getter = "getCellStatus", m12517id = 1)
    private final int zzd;

    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", getter = "getWifiStatus", m12517id = 2)
    private final int zze;

    @SafeParcelable.Field(defaultValueUnchecked = "0", getter = "getElapsedRealtimeNs", m12517id = 3)
    private final long zzf;

    @SafeParcelable.Field(getter = "getBatchedStatus", m12517id = 5)
    ...
    public LocationAvailability(@SafeParcelable.Param(m12518id = 4) int i, @SafeParcelable.Param(m12518id = 1) int i2, @SafeParcelable.Param(m12518id = 2) int i3, @SafeParcelable.Param(m12518id = 3) long j, @SafeParcelable.Param(m12518id = 5) zzac[] zzacVarArr, @SafeParcelable.Param(m12518id = 6) boolean z) {
