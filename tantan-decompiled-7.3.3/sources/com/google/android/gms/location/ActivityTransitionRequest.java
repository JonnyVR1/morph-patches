...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getActivityTransitions", m12517id = 1)
    private final List zza;

    @Nullable
    @SafeParcelable.Field(getter = "getTag", m12517id = 2)
    private final String zzb;

    @SafeParcelable.Field(getter = "getClients", m12517id = 3)
    private final List zzc;

    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getContextAttributionTag", m12517id = 4)
    private String zzd;

    @SafeParcelable.Constructor
    public ActivityTransitionRequest(@NonNull @SafeParcelable.Param(m12518id = 1) List list, @Nullable @SafeParcelable.Param(m12518id = 2) String str, @Nullable @SafeParcelable.Param(m12518id = 3) List list2, @Nullable @SafeParcelable.Param(m12518id = 4) String str2) {
