...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(m12518id = 1) List list, @SafeParcelable.Param(m12518id = 2) long j, @SafeParcelable.Param(m12518id = 3) long j2, @SafeParcelable.Param(m12518id = 4) int i, @Nullable @SafeParcelable.Param(m12518id = 5) Bundle bundle) {
    ...
    public String toString() {
        return "ActivityRecognitionResult [probableActivities=" + String.valueOf(this.zza) + ", timeMillis=" + this.zzb + ", elapsedRealtimeMillis=" + this.zzc + Constants.AES_SUFFIX;
    }
