...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getLocationSettingsStates", m12517id = 2)
    private final LocationSettingsStates zzb;

    @SafeParcelable.Constructor
    public LocationSettingsResult(@NonNull @SafeParcelable.Param(m12518id = 1) Status status, @Nullable @SafeParcelable.Param(m12518id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
