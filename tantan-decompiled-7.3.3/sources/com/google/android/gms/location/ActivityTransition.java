...
public class ActivityTransition extends AbstractSafeParcelable {
    ...
    public ActivityTransition(@SafeParcelable.Param(m12518id = 1) int i, @SafeParcelable.Param(m12518id = 2) int i2) {
        this.zza = i;
        this.zzb = i2;
    }
    ...
    public String toString() {
        return "ActivityTransition [mActivityType=" + this.zza + ", mTransitionType=" + this.zzb + Constants.AES_SUFFIX;
    }
