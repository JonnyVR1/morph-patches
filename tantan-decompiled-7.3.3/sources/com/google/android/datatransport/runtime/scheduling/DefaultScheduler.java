...
public class DefaultScheduler implements Scheduler {
    ...
    public static /* synthetic */ Object m9358a(DefaultScheduler defaultScheduler, TransportContext transportContext, EventInternal eventInternal) {
    ...
    public static /* synthetic */ void m9359b(final DefaultScheduler defaultScheduler, final TransportContext transportContext, TransportScheduleCallback transportScheduleCallback, EventInternal eventInternal) {
        ...
        try {
            ...
            if (transportBackend == null) {
                ...
                defaultScheduler.guard.runCriticalSection(new SynchronizationGuard.CriticalSection() { // from class: l.csd
                    @Override // com.google.android.datatransport.runtime.synchronization.SynchronizationGuard.CriticalSection
                    public final Object execute() {
                        return DefaultScheduler.m9358a(this.f83452a, transportContext, eventInternalDecorate);
                    }
                });
    ...
    public void schedule(final TransportContext transportContext, final EventInternal eventInternal, final TransportScheduleCallback transportScheduleCallback) {
        this.executor.execute(new Runnable() { // from class: l.bsd
            @Override // java.lang.Runnable
            public final void run() {
                DefaultScheduler.m9359b(this.f78138a, transportContext, transportScheduleCallback, eventInternal);
            }
        });
    }
}
