...
public final class MotionPhotoMetadata implements Metadata.Entry {
    public static final Parcelable.Creator<MotionPhotoMetadata> CREATOR = new C1931a();
    ...
    public class C1931a implements Parcelable.Creator<MotionPhotoMetadata> {
    ...
    public int hashCode() {
        return ((((((((527 + Longs.m16529e(this.photoStartPosition)) * 31) + Longs.m16529e(this.photoSize)) * 31) + Longs.m16529e(this.photoPresentationTimestampUs)) * 31) + Longs.m16529e(this.videoStartPosition)) * 31) + Longs.m16529e(this.videoSize);
    }
    ...
    public /* synthetic */ MotionPhotoMetadata(Parcel parcel, C1931a c1931a) {
        this(parcel);
    }
}
