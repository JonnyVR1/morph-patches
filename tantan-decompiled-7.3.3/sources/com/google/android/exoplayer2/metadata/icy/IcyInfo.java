...
public final class IcyInfo implements Metadata.Entry {
    public static final Parcelable.Creator<IcyInfo> CREATOR = new C1918a();
    ...
    public class C1918a implements Parcelable.Creator<IcyInfo> {
    ...
    public IcyInfo(Parcel parcel) {
        this.rawMetadata = (byte[]) w11.m204369e(parcel.createByteArray());
