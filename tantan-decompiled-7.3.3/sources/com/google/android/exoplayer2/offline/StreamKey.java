...
@Deprecated
public final class StreamKey implements Comparable<StreamKey>, Parcelable, InterfaceC1886e {
    public final int groupIndex;
    public final int periodIndex;
    public final int streamIndex;
    public static final Parcelable.Creator<StreamKey> CREATOR = new C1949a();
    private static final String FIELD_PERIOD_INDEX = bmk0.m105181z0(0);
    private static final String FIELD_GROUP_INDEX = bmk0.m105181z0(1);
    private static final String FIELD_STREAM_INDEX = bmk0.m105181z0(2);

    /* JADX INFO: renamed from: com.google.android.exoplayer2.offline.StreamKey$a */
    public class C1949a implements Parcelable.Creator<StreamKey> {
    ...
    public static StreamKey m10857b(Bundle bundle) {
