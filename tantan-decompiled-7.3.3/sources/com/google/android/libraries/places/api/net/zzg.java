...
final class zzg extends FetchPlaceRequest {
    ...
    public /* synthetic */ zzg(String str, List list, AutocompleteSessionToken autocompleteSessionToken, gg4 gg4Var, String str2, zzf zzfVar) {
        this.zza = str;
        this.zzb = list;
    ...
    public final int hashCode() {
        ...
        gg4 gg4Var = this.zzd;
        int iHashCode3 = (iHashCode2 ^ (gg4Var == null ? 0 : gg4Var.hashCode())) * 1000003;
        String str = this.zze;
    ...
    public final String toString() {
        gg4 gg4Var = this.zzd;
        AutocompleteSessionToken autocompleteSessionToken = this.zzc;
        return "FetchPlaceRequest{placeId=" + this.zza + ", placeFields=" + this.zzb.toString() + ", sessionToken=" + String.valueOf(autocompleteSessionToken) + ", cancellationToken=" + String.valueOf(gg4Var) + ", regionCode=" + this.zze + "}";
    }
}
