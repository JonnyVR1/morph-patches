...
final class zzk extends FetchResolvedPhotoUriRequest {
    ...
    public /* synthetic */ zzk(Integer num, Integer num2, PhotoMetadata photoMetadata, gg4 gg4Var, zzj zzjVar) {
        this.zza = num;
        this.zzb = num2;
        ...
        if (obj instanceof FetchResolvedPhotoUriRequest) {
            ...
            if (num != null ? num.equals(fetchResolvedPhotoUriRequest.getMaxWidth()) : fetchResolvedPhotoUriRequest.getMaxWidth() == null) {
                ...
                if (num2 != null ? num2.equals(fetchResolvedPhotoUriRequest.getMaxHeight()) : fetchResolvedPhotoUriRequest.getMaxHeight() == null) {
                    if (this.zzc.equals(fetchResolvedPhotoUriRequest.getPhotoMetadata()) && ((gg4Var = this.zzd) != null ? gg4Var.equals(fetchResolvedPhotoUriRequest.getCancellationToken()) : fetchResolvedPhotoUriRequest.getCancellationToken() == null)) {
                        return true;
                    }
                }
            }
    ...
    public final String toString() {
        gg4 gg4Var = this.zzd;
        return "FetchResolvedPhotoUriRequest{maxWidth=" + this.zza + ", maxHeight=" + this.zzb + ", photoMetadata=" + this.zzc.toString() + ", cancellationToken=" + String.valueOf(gg4Var) + "}";
    }
}
