...
final class zzbs extends zzae {
    ...
    public zzbs(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, Double d, AuthorAttribution authorAttribution, String str6, @Nullable String str7) {
