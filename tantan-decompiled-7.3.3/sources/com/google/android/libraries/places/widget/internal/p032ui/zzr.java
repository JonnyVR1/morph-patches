...
import androidx.recyclerview.widget.AbstractC0612p;
...
public final class zzr extends AbstractC0612p {
    private int zza;
    private boolean zzb;
    ...
    @Override // androidx.recyclerview.widget.AbstractC0612p
    ...
    public final zzt onCreateViewHolder(ViewGroup viewGroup, int i) {
        try {
            return new zzt(this.zzc, LayoutInflater.from(viewGroup.getContext()).inflate(C2485R.layout.places_autocomplete_prediction, viewGroup, false));
        } catch (Error | RuntimeException e) {
            zzkd.zzb(e);
            throw e;
        }
