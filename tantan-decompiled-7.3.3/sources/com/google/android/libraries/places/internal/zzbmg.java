...
final class zzbmg {
    ...
    public zzbmg(Map map, boolean z, int i, int i2) {
        long j;
        zzbpp zzbppVar;
        zzbje zzbjeVar;
        ...
        if (mapZzj == null) {
            ...
            j = 0;
            zzmt.zzj(dDoubleValue > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, "backoffMultiplier must be greater than 0: %s", dZzb);
