...
class zzawg extends AbstractMap {
    ...
    public /* synthetic */ zzawg(int i, zzawf zzawfVar) {
        this.zza = i;
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i2 = 0;
        if (i >= 0) {
            int iCompareTo = comparable.compareTo(((zzawa) this.zzb.get(i)).zza());
            if (iCompareTo > 0) {
                return -(size + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int iCompareTo2 = comparable.compareTo(((zzawa) this.zzb.get(i3)).zza());
            if (iCompareTo2 < 0) {
                i = i3 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzawa) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final Object get(Object obj) {
        ...
        return iZzk >= 0 ? ((zzawa) this.zzb.get(iZzk)).getValue() : this.zzc.get(comparable);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = 0;
        for (int i = 0; i < iZzb; i++) {
            iHashCode += ((zzawa) this.zzb.get(i)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzk = zzk(comparable);
        if (iZzk >= 0) {
            return ((zzawa) this.zzb.get(iZzk)).setValue(obj);
        }
        zzn();
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzawa zzawaVar = (zzawa) this.zzb.remove(i2 - 1);
            zzm().put(zzawaVar.zza(), zzawaVar.getValue());
        }
        this.zzb.add(i, new zzawa(this, comparable, obj));
        return null;
    }
