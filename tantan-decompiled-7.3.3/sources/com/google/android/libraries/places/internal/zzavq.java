...
final class zzavq extends zzarw implements RandomAccess {
    private static final zzavq zza = new zzavq(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzauc zzd(int i) {
        if (i >= this.zzc) {
            return new zzavq(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        fig0.m125680a();
        return null;
    }

    private zzavq(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }
