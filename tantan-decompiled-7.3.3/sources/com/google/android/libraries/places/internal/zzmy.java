...
public final class zzmy {
    ...
    public static zzmy zzb(zzma zzmaVar) {
        return new zzmy(new zzmv(zzmaVar), false, zzly.zza, Api.BaseClientBuilder.API_PRIORITY_OTHER);
    }
    ...
    public final zzmy zzc(zzma zzmaVar) {
        zzmaVar.getClass();
        return new zzmy(this.zzb, false, zzmaVar, Api.BaseClientBuilder.API_PRIORITY_OTHER);
    }
