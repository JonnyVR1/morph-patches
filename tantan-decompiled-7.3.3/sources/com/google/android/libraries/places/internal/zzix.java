...
final class zzix {
    ...
    static {
        ...
        zznzVar2.zza("bar", Place.Type.BAR);
        ...
        zznzVar2.zza("country", Place.Type.COUNTRY);
        ...
        zznzVar2.zza("doctor", Place.Type.DOCTOR);
        ...
        zznzVar2.zza("finance", Place.Type.FINANCE);
        ...
        zznzVar2.zza("food", Place.Type.FOOD);
        ...
        zznzVar2.zza("university", Place.Type.UNIVERSITY);
    ...
    @Nullable
    @VisibleForTesting
    public static LocalDate zza(@Nullable String str) {
        if (str == null) {
            return null;
        }
        try {
    ...
    public static Place.BooleanPlaceAttributeValue zzb(@Nullable Boolean bool) {
        if (bool == null) {
    ...
    @Nullable
    @VisibleForTesting
    public static TimeOfWeek zzc(@Nullable zzja.zzd.zzc zzcVar) {
        DayOfWeek dayOfWeek;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final Place zzg(@Nullable zzja zzjaVar, @Nullable List list) throws ApiException {
        ...
        if (zzjaVar != null) {
            ...
            zzja.zzf zzfVarZze = zzjaVar.zze();
            if (zzfVarZze == null) {
                plusCodeBuild = null;
            } else {
