...
public final class zzga implements PlacesClient {
    ...
    public final Task zza(final FetchPhotoRequest fetchPhotoRequest, int i) {
        try {
            ...
            final int i2 = 1;
            return this.zza.zza(fetchPhotoRequest, 1).mo15423h(new s26(fetchPhotoRequest, i2, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfw
    ...
    public final Task zzb(final FetchPlaceRequest fetchPlaceRequest, final int i) {
        try {
            ...
            final zzej zzejVarZza = zzej.zza();
            if (!this.zzg.zzh() || i == 2) {
                return this.zza.zzb(fetchPlaceRequest, i).mo15423h(new s26() { // from class: com.google.android.libraries.places.internal.zzfv
                    @Override // p153l.s26
                    public final Object then(Task task) {
            ...
            final int i2 = 1;
            return this.zzf.zzg(fetchPlaceRequest, 1).mo15423h(new s26(fetchPlaceRequest, i2, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfu
    ...
    public final Task zzc(final FetchResolvedPhotoUriRequest fetchResolvedPhotoUriRequest, int i) {
        try {
            ...
            final zzej zzejVarZza = zzej.zza();
            final int i2 = 1;
            return this.zzf.zzf(fetchResolvedPhotoUriRequest, 1).mo15423h(new s26(fetchResolvedPhotoUriRequest, i2, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzft
    ...
    public final Task zzd(final FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, final int i) {
        try {
            ...
            final zzej zzejVarZza = zzej.zza();
            if (!this.zzg.zzh() || i == 2) {
                return this.zza.zzc(findAutocompletePredictionsRequest, i).mo15423h(new s26() { // from class: com.google.android.libraries.places.internal.zzfq
                    @Override // p153l.s26
                    public final Object then(Task task) {
            ...
            final int i2 = 1;
            return this.zzf.zze(findAutocompletePredictionsRequest, 1).mo15423h(new s26(findAutocompletePredictionsRequest, i2, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfp
    ...
    public final Task zze(final FindCurrentPlaceRequest findCurrentPlaceRequest, @Nullable String str, int i) {
        try {
            ...
            final int i2 = 1;
            final int i3 = 1;
            return this.zzb.zza(findCurrentPlaceRequest.getCancellationToken()).mo15433r(new zdg0(findCurrentPlaceRequest, str2, i2) { // from class: com.google.android.libraries.places.internal.zzfn
            ...
            }).mo15423h(new s26(findCurrentPlaceRequest, jZza, i3, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfo
                public final /* synthetic */ FindCurrentPlaceRequest zzb;
    ...
    public final Task zzf(IsOpenRequest isOpenRequest, int i) {
        ...
        try {
            ...
            if (arrayList.isEmpty()) {
                ...
                sni0Var.m186941c(IsOpenResponse.newInstance(com.google.android.libraries.places.api.model.zzce.zza(place, utcTimeMillis)));
            ...
            final zzej zzejVarZza = zzej.zza();
            final int i3 = 1;
            return this.zzg.zzh() ? this.zzf.zzg(fetchPlaceRequestBuild, 1).mo15423h(new s26(fetchPlaceRequestBuild, i3, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfx
                public final /* synthetic */ FetchPlaceRequest zzb;
                public final /* synthetic */ zzej zzc;
            ...
            }).mo15433r(new zdg0() { // from class: com.google.android.libraries.places.internal.zzfy
                @Override // p153l.zdg0
                public final Task then(Object obj) {
                    ...
                    sni0Var2.m186941c(IsOpenResponse.newInstance(com.google.android.libraries.places.api.model.zzce.zza(builder2.build(), j)));
                    return sni0Var2.m186939a();
                }
            }).mo15425j(new zzfr()) : this.zza.zzb(fetchPlaceRequestBuild, 1).mo15423h(new s26(fetchPlaceRequestBuild, i3, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfz
                public final /* synthetic */ FetchPlaceRequest zzb;
                public final /* synthetic */ zzej zzc;
            ...
            }).mo15433r(new zdg0() { // from class: com.google.android.libraries.places.internal.zzfm
                @Override // p153l.zdg0
                public final Task then(Object obj) {
                    Place place2 = ((FetchPlaceResponse) obj).getPlace();
                    Place.BusinessStatus businessStatus2 = place2.getBusinessStatus();
    ...
    public final Task zzh(final SearchByTextRequest searchByTextRequest, int i) {
        try {
            ...
            final zzej zzejVarZza = zzej.zza();
            final int i2 = 1;
            return this.zzf.zzm(searchByTextRequest, 1).mo15423h(new s26(searchByTextRequest, i2, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfl
    ...
    public final Task zzi(final SearchNearbyRequest searchNearbyRequest, int i) {
        try {
            ...
            final zzej zzejVarZza = zzej.zza();
            final int i2 = 1;
            return this.zzf.zzn(searchNearbyRequest, 1).mo15423h(new s26(searchNearbyRequest, i2, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfs
    ...
    public final /* synthetic */ FetchPhotoResponse zzj(FetchPhotoRequest fetchPhotoRequest, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (FetchPhotoResponse) task.mo15427l();
    }
    ...
    public final /* synthetic */ FetchPlaceResponse zzk(FetchPlaceRequest fetchPlaceRequest, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (FetchPlaceResponse) task.mo15427l();
    }
    ...
    public final /* synthetic */ FetchResolvedPhotoUriResponse zzo(FetchResolvedPhotoUriRequest fetchResolvedPhotoUriRequest, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (FetchResolvedPhotoUriResponse) task.mo15427l();
    }
    ...
    public final /* synthetic */ FindAutocompletePredictionsResponse zzp(FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (FindAutocompletePredictionsResponse) task.mo15427l();
    }
    ...
    public final /* synthetic */ FindCurrentPlaceResponse zzr(FindCurrentPlaceRequest findCurrentPlaceRequest, long j, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (FindCurrentPlaceResponse) task.mo15427l();
    }
    ...
    public final /* synthetic */ SearchByTextResponse zzs(SearchByTextRequest searchByTextRequest, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (SearchByTextResponse) task.mo15427l();
    }
    ...
    public final /* synthetic */ SearchNearbyResponse zzt(SearchNearbyRequest searchNearbyRequest, int i, zzej zzejVar, Task task) throws Exception {
        ...
        return (SearchNearbyResponse) task.mo15427l();
    }
}
