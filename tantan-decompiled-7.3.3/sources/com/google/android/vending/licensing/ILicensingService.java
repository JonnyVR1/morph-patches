...
public interface ILicensingService extends IInterface {
    ...
    public static abstract class AbstractBinderC2658a extends Binder implements ILicensingService {
        ...
        public static class a implements ILicensingService {
            ...
            public void mo15438p3(long j, String str, InterfaceC2659a interfaceC2659a) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.android.vending.licensing.ILicensingService");
                    parcelObtain.writeLong(j);
                    parcelObtain.writeString(str);
                    parcelObtain.writeStrongBinder(interfaceC2659a != null ? interfaceC2659a.asBinder() : null);
                    this.f10624a.transact(1, parcelObtain, null, 1);
                } finally {
        ...
        public AbstractBinderC2658a() {
            attachInterface(this, "com.android.vending.licensing.ILicensingService");
        }

        /* JADX INFO: renamed from: O */
        public static ILicensingService m15439O(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                mo15438p3(parcel.readLong(), parcel.readString(), InterfaceC2659a.a.m15441O(parcel.readStrongBinder()));
                return true;
            }
            if (i != 1598968902) {
    ...
    /* JADX INFO: renamed from: p3 */
    void mo15438p3(long j, String str, InterfaceC2659a interfaceC2659a) throws RemoteException;
}
