...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(@NonNull Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C2489R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C2489R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C2489R.attr.colorSurface, 0);
        this.displayDensity = context.getResources().getDisplayMetrics().density;
    }

    private boolean isThemeSurfaceColor(@ColorInt int i) {
        return gf5.m130052o(i, 255) == this.colorSurface;
    }
    ...
    public int compositeOverlay(@ColorInt int i, float f) {
        ...
        return gf5.m130052o(MaterialColors.layer(gf5.m130052o(i, 255), this.elevationOverlayColor, fCalculateOverlayAlphaFraction), Color.alpha(i));
    }
