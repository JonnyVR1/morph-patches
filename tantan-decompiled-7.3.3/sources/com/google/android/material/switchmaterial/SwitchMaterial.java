...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C2489R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2489R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.SwitchMaterial_useMaterialThemeColors, false);
        typedArrayObtainStyledAttributes.recycle();
    }

    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C2489R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C2489R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C2489R.dimen.mtrl_switch_thumb_elevation);
    ...
    public SwitchMaterial(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2489R.attr.switchStyle);
    }
