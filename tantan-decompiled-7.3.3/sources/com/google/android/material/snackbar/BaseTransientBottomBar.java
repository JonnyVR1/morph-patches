...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C2489R.attr.snackbarStyle};
    ...
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        @Override // com.google.android.material.behavior.SwipeDismissBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0227c
    ...
    public BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            wg3.m206174a("Transient bottom bar must have non-null parent");
            throw null;
        }
        if (view == null) {
            wg3.m206174a("Transient bottom bar must have non-null content");
            throw null;
        }
        if (contentViewCallback == null) {
            wg3.m206174a("Transient bottom bar must have non-null callback");
            throw null;
        }
        ...
        if (snackbarBaseLayout.getBackground() == null) {
            kkl0.m150170m0(snackbarBaseLayout, createThemedBackground());
        }
        ...
        kkl0.m150168l0(snackbarBaseLayout, 1);
        kkl0.m150184t0(snackbarBaseLayout, 1);
        kkl0.m150180r0(snackbarBaseLayout, true);
        kkl0.m150194y0(snackbarBaseLayout, new il50() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.3
            @Override // p153l.il50
            @NonNull
            public dgq0 onApplyWindowInsets(View view2, @NonNull dgq0 dgq0Var) {
                BaseTransientBottomBar.this.extraBottomMarginWindowInset = dgq0Var.m115683i();
                BaseTransientBottomBar.this.extraLeftMarginWindowInset = dgq0Var.m115684j();
                BaseTransientBottomBar.this.extraRightMarginWindowInset = dgq0Var.m115685k();
                BaseTransientBottomBar.this.updateMargins();
                return dgq0Var;
            }
        });
        kkl0.m150164j0(snackbarBaseLayout, new C16932fb() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.4
    ...
    private Drawable createThemedBackground() {
        ...
        int iLayer = MaterialColors.layer(snackbarBaseLayout, C2489R.attr.colorSurface, C2489R.attr.colorOnSurface, snackbarBaseLayout.getBackgroundOverlayColorAlpha());
        float dimension = this.view.getResources().getDimension(C2489R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    private boolean isSwipeDismissable() {
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        return (layoutParams instanceof CoordinatorLayout.C0230f) && (((CoordinatorLayout.C0230f) layoutParams).m1182f() instanceof SwipeDismissBehavior);
    }

    private void setUpBehavior(CoordinatorLayout.C0230f c0230f) {
    ...
    public void startSlideInAnimation() {
        ...
        SnackbarBaseLayout snackbarBaseLayout = this.view;
        if (z) {
            kkl0.m150140V(snackbarBaseLayout, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.15
            ...
            public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator2) {
                ...
                BaseTransientBottomBar baseTransientBottomBar = BaseTransientBottomBar.this;
                if (z2) {
                    kkl0.m150140V(baseTransientBottomBar.view, iIntValue - this.previousAnimatedIntValue);
                } else {
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C2489R.layout.mtrl_layout_snackbar : C2489R.layout.design_layout_snackbar;
    }
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        za50.m219101a("Unable to find anchor view with id: ", i);
        return null;
    }
    ...
    public final void showView() {
        ...
        if (this.view.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.C0230f) {
                setUpBehavior((CoordinatorLayout.C0230f) layoutParams);
            }
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(@NonNull Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2489R.styleable.SnackbarLayout);
            if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.SnackbarLayout_elevation)) {
                kkl0.m150178q0(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = typedArrayObtainStyledAttributes.getFloat(C2489R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            this.actionTextColorAlpha = typedArrayObtainStyledAttributes.getFloat(C2489R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            typedArrayObtainStyledAttributes.recycle();
