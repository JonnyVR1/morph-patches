...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C2489R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(viewGroupFindSuitableParent.getContext()) ? C2489R.layout.mtrl_layout_snackbar_include : C2489R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
    ...
    public Snackbar setBackgroundTint(@ColorInt int i) {
        ...
        if (background != null) {
            oce.m167174n(background.mutate(), i);
        }
        return this;
    }
    ...
    public Snackbar setBackgroundTintList(ColorStateList colorStateList) {
        oce.m167175o(this.view.getBackground().mutate(), colorStateList);
        return this;
    }
