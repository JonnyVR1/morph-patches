...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final nj80<Tab> tabPool = new rj80(16);
    ...
    private final nj80<TabView> tabViewPool;
    ...
    public class AdapterChangeListener implements ViewPager.InterfaceC0717i {
        ...
        public void onAdapterChanged(@NonNull ViewPager viewPager, @Nullable cf60 cf60Var, @Nullable cf60 cf60Var2) {
            ...
            if (tabLayout.viewPager == viewPager) {
                tabLayout.setPagerAdapter(cf60Var2, this.autoRefresh);
            }
        }
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            if (i3 >= 0 && this.indicatorRight > i3) {
                ...
                Drawable drawableM167178r = oce.m167178r(drawable2);
                drawableM167178r.setBounds(this.indicatorLeft, height, this.indicatorRight, intrinsicHeight);
                Paint paint = this.selectedIndicatorPaint;
                if (paint != null) {
                    oce.m167174n(drawableM167178r, paint.getColor());
                }
                drawableM167178r.draw(canvas);
            }
            super.draw(canvas);
        }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.InterfaceC0718j {
    ...
    public final class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            kkl0.m150196z0(this, TabLayout.this.tabPaddingStart, TabLayout.this.tabPaddingTop, TabLayout.this.tabPaddingEnd, TabLayout.this.tabPaddingBottom);
            setGravity(17);
            setOrientation(!TabLayout.this.inlineLabel ? 1 : 0);
            setClickable(true);
            kkl0.m150111A0(this, ni80.m163268b(getContext(), 1002));
            kkl0.m150164j0(this, null);
        }
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C2489R.layout.design_layout_tab_icon, viewGroup, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C2489R.layout.design_layout_tab_text, viewGroup, false);
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (i != 0) {
                ...
                this.baseBackgroundDrawable = drawableM192702b;
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                rippleDrawable = new RippleDrawable(colorStateListConvertToRippleDrawableColor, gradientDrawable, z ? null : gradientDrawable3);
            }
        ...
        private void updateTextAndIcon(@Nullable TextView textView, @Nullable ImageView imageView) {
            Tab tab = this.tab;
            Drawable drawableMutate = (tab == null || tab.getIcon() == null) ? null : oce.m167178r(this.tab.getIcon()).mutate();
            Tab tab2 = this.tab;
            ...
            Tab tab3 = this.tab;
            h2j0.m133392a(this, zIsEmpty ? tab3 != null ? tab3.contentDesc : null : null);
        }
        ...
        public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent accessibilityEvent) {
            ...
            accessibilityEvent.setClassName(c30.AbstractC16171c.class.getName());
        }
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setClassName(c30.AbstractC16171c.class.getName());
            BadgeDrawable badgeDrawable = this.badgeDrawable;
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (this.textView != null) {
                ...
                int iM159806d = msi0.m159806d(this.textView);
        ...
        public final void update() {
            ...
            if (customView != null) {
                ...
                if (textView2 != null) {
                    this.defaultMaxLines = msi0.m159806d(textView2);
                }
            ...
            if (this.customView == null) {
                ...
                if (tab != null && tab.getIcon() != null) {
                    drawableMutate = oce.m167178r(tab.getIcon()).mutate();
                }
                if (drawableMutate != null) {
                    oce.m167175o(drawableMutate, TabLayout.this.tabIconTint);
                ...
                if (this.textView == null) {
                    ...
                    this.defaultMaxLines = msi0.m159806d(this.textView);
                }
                msi0.m159817o(this.textView, TabLayout.this.tabTextAppearance);
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.tabViewPool = new pj80(12);
        setHorizontalScrollBarEnabled(false);
        SlidingTabIndicator slidingTabIndicator = new SlidingTabIndicator(context);
        this.slidingTabIndicator = slidingTabIndicator;
        super.addView(slidingTabIndicator, 0, new FrameLayout.LayoutParams(-2, -1));
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2489R.styleable.TabLayout, i, C2489R.style.Widget_Design_TabLayout, C2489R.styleable.TabLayout_tabTextAppearance);
        ...
        slidingTabIndicator.setSelectedIndicatorHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabIndicatorHeight, -1));
        slidingTabIndicator.setSelectedIndicatorColor(typedArrayObtainStyledAttributes.getColor(C2489R.styleable.TabLayout_tabIndicatorColor, 0));
        setSelectedTabIndicator(MaterialResources.getDrawable(context, typedArrayObtainStyledAttributes, C2489R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(typedArrayObtainStyledAttributes.getInt(C2489R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabPaddingStart, dimensionPixelSize);
        this.tabPaddingTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C2489R.styleable.TabLayout_tabTextAppearance, C2489R.style.TextAppearance_Design_Tab);
        this.tabTextAppearance = resourceId;
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(resourceId, gic0.f104327V2);
        try {
            this.tabTextSize = typedArrayObtainStyledAttributes2.getDimensionPixelSize(gic0.f104331W2, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes2, gic0.f104343Z2);
            typedArrayObtainStyledAttributes2.recycle();
            if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2489R.styleable.TabLayout_tabTextColor);
            }
            if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), typedArrayObtainStyledAttributes.getColor(C2489R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2489R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C2489R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2489R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.requestedTabMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = typedArrayObtainStyledAttributes.getResourceId(C2489R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.TabLayout_tabContentStart, 0);
            this.mode = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.TabLayout_tabUnboundedRipple, false);
            typedArrayObtainStyledAttributes.recycle();
            Resources resources = getResources();
            this.tabTextMultiLineSize = resources.getDimensionPixelSize(C2489R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = resources.getDimensionPixelSize(C2489R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            typedArrayObtainStyledAttributes2.recycle();
            throw th;
    ...
    private void animateToTab(int i) {
        ...
        if (getWindowToken() == null || !kkl0.m150134P(this) || this.slidingTabIndicator.childrenNeedLayout()) {
    ...
    private void applyModeAndGravity() {
        int i = this.mode;
        kkl0.m150196z0(this.slidingTabIndicator, (i == 0 || i == 2) ? Math.max(0, this.contentInsetStart - this.tabPaddingStart) : 0, 0, 0, 0);
        int i2 = this.mode;
        if (i2 == 0) {
    ...
    private TabView createTabView(@NonNull Tab tab) {
        nj80<TabView> nj80Var = this.tabViewPool;
    ...
    private void setupWithViewPager(@Nullable ViewPager viewPager, boolean z, boolean z2) {
        ...
        if (viewPager2 != null) {
            ...
            if (tabLayoutOnPageChangeListener != null) {
                viewPager2.m4177P(tabLayoutOnPageChangeListener);
            }
            AdapterChangeListener adapterChangeListener = this.adapterChangeListener;
            if (adapterChangeListener != null) {
                this.viewPager.m4176O(adapterChangeListener);
            }
        }
        ...
        if (viewPager != null) {
            ...
            viewPager.m4187d(this.pageChangeListener);
            ...
            viewPager.m4186c(this.adapterChangeListener);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode == 0) {
                i2 = View.MeasureSpec.makeMeasureSpec(iDpToPx + getPaddingTop() + getPaddingBottom(), 1073741824);
            }
    ...
    public void populateFromPagerAdapter() {
        int currentItem;
        removeAllTabs();
        cf60 cf60Var = this.pagerAdapter;
        if (cf60Var != null) {
    ...
    public void removeTab(@NonNull Tab tab) {
        if (tab.parent == this) {
            ...
            wg3.m206174a("Tab does not belong to this TabLayout.");
        }
    }
    ...
    public void setPagerAdapter(@Nullable cf60 cf60Var, boolean z) {
        DataSetObserver dataSetObserver;
        cf60 cf60Var2 = this.pagerAdapter;
        if (cf60Var2 != null && (dataSetObserver = this.pagerAdapterObserver) != null) {
            cf60Var2.unregisterDataSetObserver(dataSetObserver);
        }
        this.pagerAdapter = cf60Var;
        if (z && cf60Var != null) {
            if (this.pagerAdapterObserver == null) {
                this.pagerAdapterObserver = new PagerAdapterObserver();
            }
            cf60Var.registerDataSetObserver(this.pagerAdapterObserver);
        }
    ...
    public void setSelectedTabIndicatorGravity(int i) {
        if (this.tabIndicatorGravity != i) {
            ...
            kkl0.m150146a0(this.slidingTabIndicator);
        }
    }
    ...
    public static class Tab {
        ...
        public Tab setIcon(@DrawableRes int i) {
            TabLayout tabLayout = this.parent;
            if (tabLayout != null) {
                return setIcon(tu0.m192702b(tabLayout.getContext(), i));
            }
            wg3.m206174a("Tab not attached to a TabLayout");
            return null;
        }
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2489R.attr.tabStyle);
    }
