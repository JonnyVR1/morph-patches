...
public class BottomNavigationMenuView extends ViewGroup implements InterfaceC0093h {
    ...
    private final nj80<BottomNavigationItemView> itemPool;
    ...
    @NonNull
    private final eij0 set;
    private int[] tempChildWidths;

    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.itemPool = new rj80(5);
        this.selectedItemId = 0;
        this.selectedItemPosition = 0;
        this.badgeDrawables = new SparseArray<>(5);
        Resources resources = getResources();
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C2489R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C2489R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C2489R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C2489R.dimen.design_bottom_navigation_active_item_min_width);
        this.itemHeight = resources.getDimensionPixelSize(C2489R.dimen.design_bottom_navigation_height);
        this.itemTextColorDefault = createDefaultColorStateList(R.attr.textColorSecondary);
        sj1 sj1Var = new sj1();
        this.set = sj1Var;
        sj1Var.m120909t(0);
        sj1Var.setDuration(ACTIVE_ANIMATION_DURATION_MS);
        sj1Var.setInterpolator(new zjg());
        sj1Var.m120898f(new TextScale());
    ...
    public ColorStateList createDefaultColorStateList(int i) {
        ...
        return new ColorStateList(new int[][]{iArr, CHECKED_STATE_SET, ViewGroup.EMPTY_STATE_SET}, new int[]{colorStateListM192701a.getColorForState(iArr, defaultColor), i2, defaultColor});
    }
