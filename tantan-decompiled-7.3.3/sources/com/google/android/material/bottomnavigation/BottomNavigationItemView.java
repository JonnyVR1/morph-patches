...
public class BottomNavigationItemView extends FrameLayout implements InterfaceC0093h.a {
    ...
    public BottomNavigationItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2489R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C2489R.drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C2489R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2489R.id.icon);
        TextView textView = (TextView) findViewById(C2489R.id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C2489R.id.largeLabel);
        this.largeLabel = textView2;
        kkl0.m150184t0(textView, 2);
        kkl0.m150184t0(textView2, 2);
        setFocusable(true);
    ...
    public void initialize(@NonNull MenuItemImpl menuItemImpl, int i) {
        ...
        h2j0.m133392a(this, !TextUtils.isEmpty(menuItemImpl.getTooltipText()) ? menuItemImpl.getTooltipText() : menuItemImpl.getTitle());
    ...
    public void setTextAppearanceActive(@StyleRes int i) {
        msi0.m159817o(this.largeLabel, i);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }

    public void setTextAppearanceInactive(@StyleRes int i) {
        msi0.m159817o(this.smallLabel, i);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        h2j0.m133392a(this, charSequence);
    }
    ...
    public void setItemBackground(int i) {
        setItemBackground(i == 0 ? null : j26.m143192e(getContext(), i));
    }
