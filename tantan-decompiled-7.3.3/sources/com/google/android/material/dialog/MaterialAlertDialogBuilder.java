...
public class MaterialAlertDialogBuilder extends DialogInterfaceC0075a.a {

    @AttrRes
    private static final int DEF_STYLE_ATTR = C2489R.attr.alertDialogStyle;

    @StyleRes
    private static final int DEF_STYLE_RES = C2489R.style.MaterialAlertDialog_MaterialComponents;

    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C2489R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C2489R.attr.colorSurface, getClass().getCanonicalName());
    ...
    private static Context createMaterialAlertDialogThemedContext(@NonNull Context context) {
        ...
        return materialAlertDialogThemeOverlay == 0 ? contextCreateThemedContext : new r26(contextCreateThemedContext, materialAlertDialogThemeOverlay);
    }
    ...
    @Override // androidx.appcompat.app.DialogInterfaceC0075a.a
    public DialogInterfaceC0075a create() {
        DialogInterfaceC0075a dialogInterfaceC0075aCreate = super.create();
        Window window = dialogInterfaceC0075aCreate.getWindow();
        View decorView = window.getDecorView();
        Drawable drawable = this.background;
        if (drawable instanceof MaterialShapeDrawable) {
            ((MaterialShapeDrawable) drawable).setElevation(kkl0.m150183t(decorView));
        }
        window.setBackgroundDrawable(MaterialDialogs.insetDrawable(this.background, this.backgroundInsets));
        decorView.setOnTouchListener(new InsetDialogOnTouchListener(dialogInterfaceC0075aCreate, this.backgroundInsets));
