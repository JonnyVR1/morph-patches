...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C2489R.dimen.design_textinput_caption_translate_y);
    }
    ...
    private boolean shouldAnimateCaptionView(@Nullable TextView textView, @Nullable CharSequence charSequence) {
        if (kkl0.m150134P(this.textInputView) && this.textInputView.isEnabled()) {
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            kkl0.m150196z0(this.indicatorArea, kkl0.m150112B(this.textInputView.getEditText()), 0, kkl0.m150110A(this.textInputView.getEditText()), 0);
        }
    }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C2489R.id.textinput_error);
            ...
            kkl0.m150168l0(this.errorView, 1);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C2489R.id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
                this.helperTextView.setTypeface(typeface);
            }
            this.helperTextView.setVisibility(4);
            kkl0.m150168l0(this.helperTextView, 1);
