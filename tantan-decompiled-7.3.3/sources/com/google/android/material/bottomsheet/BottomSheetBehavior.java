...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.AbstractC0227c<V> {
    private static final int CORNER_ANIMATION_DURATION = 500;
    private static final int DEF_STYLE_RES = C2489R.style.Widget_Design_BottomSheet_Modal;
    ...
    int collapsedOffset;
    private final ykl0.AbstractC21619c dragCallback;
    float elevation;
    int expandedOffset;
    ...
    public class SettleRunnable implements Runnable {
        ...
        public void run() {
            ykl0 ykl0Var = BottomSheetBehavior.this.viewDragHelper;
    ...
    public BottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.dragCallback = new ykl0.AbstractC21619c() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
            ...
            public int clampViewPositionVertical(@NonNull View view, int i2, int i3) {
                ...
                return jhx.m144942b(i2, expandedOffset, bottomSheetBehavior.hideable ? bottomSheetBehavior.parentHeight : bottomSheetBehavior.collapsedOffset);
            }
        ...
        this.shapeThemingEnabled = typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.BottomSheetBehavior_Layout_shapeAppearance);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        if (zHasValue) {
            createMaterialShapeDrawable(context, attributeSet, zHasValue, MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C2489R.styleable.BottomSheetBehavior_Layout_backgroundTint));
        } else {
            createMaterialShapeDrawable(context, attributeSet, zHasValue);
        }
        createShapeValueAnimator();
        this.elevation = typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        TypedValue typedValuePeekValue = typedArrayObtainStyledAttributes.peekValue(C2489R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (typedValuePeekValue == null || (i = typedValuePeekValue.data) != -1) {
            setPeekHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(i);
        }
        ...
        setFitToContents(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        ...
        setSaveFlags(typedArrayObtainStyledAttributes.getInt(C2489R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(typedArrayObtainStyledAttributes.getFloat(C2489R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, 0.5f));
        setExpandedOffset(typedArrayObtainStyledAttributes.getInt(C2489R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        typedArrayObtainStyledAttributes.recycle();
        this.maximumVelocity = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
    }

    private void addAccessibilityActionForState(V v2, C15967bc.a aVar, final int i) {
        kkl0.m150156f0(v2, aVar, null, new InterfaceC16750ec() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
            @Override // p153l.InterfaceC16750ec
            public boolean perform(@NonNull View view, @Nullable InterfaceC16750ec.a aVar2) {
    ...
    private void createMaterialShapeDrawable(@NonNull Context context, AttributeSet attributeSet, boolean z, @Nullable ColorStateList colorStateList) {
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attributeSet, C2489R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
    ...
    public static <V extends View> BottomSheetBehavior<V> from(@NonNull V v2) {
        ...
        if (abstractC0227cM1182f instanceof BottomSheetBehavior) {
            return (BottomSheetBehavior) abstractC0227cM1182f;
        }
        wg3.m206174a("The view is not associated with BottomSheetBehavior");
        return null;
    }
    ...
    private void settleToStatePendingLayout(final int i) {
        ...
        if (parent != null && parent.isLayoutRequested() && kkl0.m150133O(v2)) {
    ...
    private void updateAccessibilityActions() {
        ...
        kkl0.m150152d0(v2, 524288);
        kkl0.m150152d0(v2, 262144);
        kkl0.m150152d0(v2, 1048576);
        if (this.hideable && this.state != 5) {
            addAccessibilityActionForState(v2, C15967bc.a.f76076y, 5);
        }
        int i = this.state;
        if (i == 3) {
            addAccessibilityActionForState(v2, C15967bc.a.f76075x, this.fitToContents ? 4 : 6);
            return;
        }
        if (i == 4) {
            addAccessibilityActionForState(v2, C15967bc.a.f76074w, this.fitToContents ? 3 : 6);
        } else {
            if (i != 6) {
                return;
            }
            addAccessibilityActionForState(v2, C15967bc.a.f76075x, 4);
            addAccessibilityActionForState(v2, C15967bc.a.f76074w, 3);
        }
    }
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull MotionEvent motionEvent) {
        ...
        if (!this.ignoreEvents && (ykl0Var = this.viewDragHelper) != null && ykl0Var.m216500P(motionEvent)) {
            return true;
        }
        WeakReference<View> weakReference2 = this.nestedScrollingChildRef;
        View view2 = weakReference2 != null ? weakReference2.get() : null;
        return (actionMasked != 2 || view2 == null || this.ignoreEvents || this.state == 1 || coordinatorLayout.isPointInChildBounds(view2, (int) motionEvent.getX(), (int) motionEvent.getY()) || this.viewDragHelper == null || Math.abs(((float) this.initialY) - motionEvent.getY()) <= ((float) this.viewDragHelper.m216526z())) ? false : true;
    }
    ...
    public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, int i) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C2489R.dimen.design_bottom_sheet_peek_height_min);
            this.viewRef = new WeakReference<>(v2);
            if (this.shapeThemingEnabled && (materialShapeDrawable = this.materialShapeDrawable) != null) {
                kkl0.m150170m0(v2, materialShapeDrawable);
            }
            MaterialShapeDrawable materialShapeDrawable2 = this.materialShapeDrawable;
            if (materialShapeDrawable2 != null) {
                float fM150183t = this.elevation;
                if (fM150183t == -1.0f) {
                    fM150183t = kkl0.m150183t(v2);
                }
                materialShapeDrawable2.setElevation(fM150183t);
                boolean z = this.state == 3;
                this.isShapeExpanded = z;
                this.materialShapeDrawable.setInterpolation(z ? 0.0f : 1.0f);
            }
            updateAccessibilityActions();
            if (kkl0.m150187v(v2) == 0) {
                kkl0.m150184t0(v2, 1);
            }
        }
        if (this.viewDragHelper == null) {
            this.viewDragHelper = ykl0.m216484p(coordinatorLayout, this.dragCallback);
        }
        int top = v2.getTop();
        ...
        int i2 = this.state;
        if (i2 == 3) {
            kkl0.m150140V(v2, getExpandedOffset());
        } else if (i2 == 6) {
            kkl0.m150140V(v2, this.halfExpandedOffset);
        } else if (this.hideable && i2 == 5) {
            kkl0.m150140V(v2, this.parentHeight);
        } else if (i2 == 4) {
            kkl0.m150140V(v2, this.collapsedOffset);
        } else if (i2 == 1 || i2 == 2) {
    ...
    public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull View view, int i, int i2, @NonNull int[] iArr, int i3) {
        ...
        if (i2 > 0) {
            if (i4 < getExpandedOffset()) {
                ...
                kkl0.m150140V(v2, -expandedOffset);
                setStateInternal(3);
            } else {
                iArr[1] = i2;
                kkl0.m150140V(v2, -i2);
    ...
    public boolean onTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v2, @NonNull MotionEvent motionEvent) {
        ...
        this.velocityTracker.addMovement(motionEvent);
        if (actionMasked == 2 && !this.ignoreEvents && Math.abs(this.initialY - motionEvent.getY()) > this.viewDragHelper.m216526z()) {
            this.viewDragHelper.m216505c(v2, motionEvent.getPointerId(motionEvent.getActionIndex()));
        }
    ...
    public void setExpandedOffset(int i) {
        if (i >= 0) {
            ...
            wg3.m206174a("offset must be greater than or equal to 0");
        }
    }
    ...
    public void setHalfExpandedRatio(@FloatRange(from = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, to = 1.0d) float f) {
        if (f <= 0.0f || f >= 1.0f) {
            wg3.m206174a("ratio must be a float value between 0 and 1");
        } else {
    ...
    public void settleToState(@NonNull View view, int i) {
        ...
        if (i == 4) {
            ...
            if (!this.hideable || i != 5) {
                za50.m219101a("Illegal state argument: ", i);
                return;
            }
            expandedOffset = this.parentHeight;
        }
    ...
    public void startSettlingAnimation(View view, int i, int i2, boolean z) {
        ykl0 ykl0Var = this.viewDragHelper;
        if (!(z ? ykl0Var.m216499O(view.getLeft(), i2) : ykl0Var.m216501Q(view, view.getLeft(), i2))) {
            setStateInternal(i);
            return;
        }
        setStateInternal(2);
        ...
        settleRunnable.targetState = i;
        kkl0.m150148b0(view, settleRunnable);
