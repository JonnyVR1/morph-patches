...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.InterfaceC0226b {
    private static final long ANIMATION_DURATION = 300;
    private static final int DEF_STYLE_RES = C2489R.style.Widget_MaterialComponents_BottomAppBar;
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2489R.styleable.BottomAppBar, i, i2, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C2489R.styleable.BottomAppBar_backgroundTint);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.BottomAppBar_elevation, 0);
        float dimensionPixelOffset = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2489R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2489R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C2489R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.hideOnScroll = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.BottomAppBar_hideOnScroll, false);
        typedArrayObtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C2489R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        ...
        oce.m167175o(materialShapeDrawable, colorStateList);
        ...
        ViewUtils.doOnApplyWindowInsets(this, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            ...
            public dgq0 onApplyWindowInsets(View view, @NonNull dgq0 dgq0Var, @NonNull ViewUtils.RelativePadding relativePadding) {
                BottomAppBar.this.bottomInset = dgq0Var.m115683i();
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode == i || !kkl0.m150134P(this)) {
            return;
        }
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i, boolean z) {
        boolean z2 = kkl0.m150191x(this) == 1;
        int measuredWidth = z2 ? getMeasuredWidth() : 0;
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            View childAt = getChildAt(i2);
            if ((childAt.getLayoutParams() instanceof Toolbar.C0160e) && (((Toolbar.C0160e) childAt.getLayoutParams()).f79555a & 8388615) == 8388611) {
    ...
    public void setBackgroundTint(@Nullable ColorStateList colorStateList) {
        oce.m167175o(this.materialShapeDrawable, colorStateList);
    }
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
            ...
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        ((ViewGroup.MarginLayoutParams) c0230f).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C2489R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - iHeight) / 2));
                    }
                }
            };
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0227c
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, int i) {
            this.viewRef = new WeakReference<>(bottomAppBar);
            View viewFindDependentView = bottomAppBar.findDependentView();
            if (viewFindDependentView != null && !kkl0.m150134P(viewFindDependentView)) {
                CoordinatorLayout.C0230f c0230f = (CoordinatorLayout.C0230f) viewFindDependentView.getLayoutParams();
                c0230f.f1376d = 49;
                this.originalBottomMargin = ((ViewGroup.MarginLayoutParams) c0230f).bottomMargin;
                if (viewFindDependentView instanceof FloatingActionButton) {
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2489R.attr.bottomAppBarStyle);
    }
