...
@CoordinatorLayout.InterfaceC0228d(Behavior.class)
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, i, C2489R.style.Widget_Design_AppBarLayout);
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2489R.styleable.AppBarLayout, i, C2489R.style.Widget_Design_AppBarLayout, new int[0]);
        kkl0.m150170m0(this, typedArrayObtainStyledAttributes.getDrawable(C2489R.styleable.AppBarLayout_android_background));
        ...
        if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.AppBarLayout_expanded)) {
            setExpanded(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = typedArrayObtainStyledAttributes.getResourceId(C2489R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(typedArrayObtainStyledAttributes.getDrawable(C2489R.styleable.AppBarLayout_statusBarForeground));
        typedArrayObtainStyledAttributes.recycle();
        kkl0.m150194y0(this, new il50() { // from class: com.google.android.material.appbar.AppBarLayout.1
            @Override // p153l.il50
            public dgq0 onApplyWindowInsets(View view, dgq0 dgq0Var) {
                return AppBarLayout.this.onWindowInsetChanged(dgq0Var);
            }
        });
    }
    ...
    private boolean shouldOffsetFirstChild() {
        if (getChildCount() > 0) {
            ...
            if (childAt.getVisibility() != 8 && !kkl0.m150185u(childAt)) {
                return true;
            }
        }
        return false;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(@NonNull final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        float dimension = getResources().getDimension(C2489R.dimen.design_appbar_elevation);
        ...
        valueAnimatorOfFloat.setDuration(getResources().getInteger(C2489R.integer.app_bar_elevation_anim_duration));
    ...
    public int getDownNestedPreScrollRange() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i3 & 5) != 5) {
                ...
                if ((i3 & 8) != 0) {
                    iM150193y = kkl0.m150193y(childAt);
                } else {
                    if ((i3 & 2) != 0) {
                        iM150193y = measuredHeight - kkl0.m150193y(childAt);
                    } else {
                        iMin = i4 + measuredHeight;
                    }
                    if (childCount == 0 && kkl0.m150185u(childAt)) {
    ...
    public int getDownNestedScrollRange() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            iM150193y += measuredHeight;
            if ((i3 & 2) != 0) {
                iM150193y -= kkl0.m150193y(childAt);
                break;
            }
        }
        int iMax = Math.max(0, iM150193y);
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        if (iM150193y == 0) {
            int childCount = getChildCount();
            iM150193y = childCount >= 1 ? kkl0.m150193y(getChildAt(childCount - 1)) : 0;
            if (iM150193y == 0) {
                return getHeight() / 3;
            }
        }
        return (iM150193y * 2) + topInset;
    }
    ...
    public final int getTotalScrollRange() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            iM150193y += measuredHeight + ((LinearLayout.LayoutParams) layoutParams).topMargin + ((LinearLayout.LayoutParams) layoutParams).bottomMargin;
            if (i2 == 0 && kkl0.m150185u(childAt)) {
                iM150193y -= getTopInset();
            }
            if ((i3 & 2) != 0) {
                iM150193y -= kkl0.m150193y(childAt);
                break;
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        int i2 = C2489R.attr.state_liftable;
        if (!z) {
            i2 = -i2;
        }
        iArr[0] = i2;
        iArr[1] = (z && this.lifted) ? C2489R.attr.state_lifted : -C2489R.attr.state_lifted;
        int i3 = C2489R.attr.state_collapsible;
        if (!z) {
            i3 = -i3;
        }
        iArr[2] = i3;
        iArr[3] = (z && this.lifted) ? C2489R.attr.state_collapsed : -C2489R.attr.state_collapsed;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (kkl0.m150185u(this) && shouldOffsetFirstChild()) {
            int topInset = getTopInset();
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
                kkl0.m150140V(getChildAt(childCount), topInset);
            }
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && kkl0.m150185u(this) && shouldOffsetFirstChild()) {
            int measuredHeight = getMeasuredHeight();
            if (mode == Integer.MIN_VALUE) {
                measuredHeight = jhx.m144942b(getMeasuredHeight() + getTopInset(), 0, View.MeasureSpec.getSize(i2));
            } else if (mode == 0) {
    ...
    public dgq0 onWindowInsetChanged(dgq0 dgq0Var) {
    ...
    public void setOrientation(int i) {
        if (i == 1) {
            ...
            wg3.m206174a("AppBarLayout is always vertical and does not support horizontal orientation");
        }
    }
    ...
    public void setStatusBarForeground(@Nullable Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawableMutate != null) {
                ...
                oce.m167173m(this.statusBarForeground, kkl0.m150191x(this));
    ...
    public void setStatusBarForegroundResource(@DrawableRes int i) {
        setStatusBarForeground(tu0.m192702b(getContext(), i));
    }
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private View findFirstScrollingChild(@NonNull CoordinatorLayout coordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if ((childAt instanceof ai20) || (childAt instanceof ListView) || (childAt instanceof ScrollView)) {
                    return childAt;
                }
            }
            return null;
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (iAbs >= childAt.getTop() && iAbs <= childAt.getBottom()) {
                    ...
                    if ((scrollFlags & 1) != 0) {
                        ...
                        if ((scrollFlags & 2) != 0) {
                            topInset -= kkl0.m150193y(childAt);
                        }
                    }
                    if (kkl0.m150185u(childAt)) {
        ...
        private boolean shouldJumpElevationState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            for (int i = 0; i < size; i++) {
                CoordinatorLayout.AbstractC0227c abstractC0227cM1182f = ((CoordinatorLayout.C0230f) dependents.get(i).getLayoutParams()).m1182f();
                if (abstractC0227cM1182f instanceof ScrollingViewBehavior) {
                    return ((ScrollingViewBehavior) abstractC0227cM1182f).getOverlayTop() != 0;
                }
            }
            return false;
        }
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    int iM150193y = -childAt.getBottom();
                    if (childIndexOnOffset == t.getChildCount() - 1) {
                        iM150193y += t.getTopInset();
                    }
                    if (checkFlag(scrollFlags, 2)) {
                        iM150193y += kkl0.m150193y(childAt);
                    } else if (checkFlag(scrollFlags, 5)) {
                        int iM150193y2 = kkl0.m150193y(childAt) + iM150193y;
                        if (topBottomOffsetForScrollingSibling < iM150193y2) {
                            i = iM150193y2;
                        } else {
                            iM150193y = iM150193y2;
                        }
                    }
                    if (checkFlag(scrollFlags, 32)) {
                        i += ((LinearLayout.LayoutParams) layoutParams).topMargin;
                        iM150193y -= ((LinearLayout.LayoutParams) layoutParams).bottomMargin;
                    }
                    if (topBottomOffsetForScrollingSibling < (iM150193y + i) / 2) {
                        i = iM150193y;
                    }
                    animateOffsetTo(coordinatorLayout, t, jhx.m144942b(i, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        private void updateAppBarLayoutDrawableState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, boolean z) {
            ...
            if (appBarChildOnOffset != null) {
                ...
                if ((scrollFlags & 1) != 0) {
                    int iM150193y = kkl0.m150193y(appBarChildOnOffset);
                    if (i2 <= 0 || (scrollFlags & 12) == 0 ? !((scrollFlags & 2) == 0 || (-i) < (appBarChildOnOffset.getBottom() - iM150193y) - t.getTopInset()) : (-i) >= (appBarChildOnOffset.getBottom() - iM150193y) - t.getTopInset()) {
                        zShouldLift = true;
                    }
                }
                if (t.isLiftOnScroll()) {
        ...
        @Override // com.google.android.material.appbar.ViewOffsetBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0227c
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                View childAt = t.getChildAt(i2);
                setHeaderTopBottomOffset(coordinatorLayout, t, (-childAt.getBottom()) + (this.offsetToChildIndexOnLayoutIsMinHeight ? kkl0.m150193y(childAt) + t.getTopInset() : Math.round(childAt.getHeight() * this.offsetToChildIndexOnLayoutPerc)));
            ...
            this.offsetToChildIndexOnLayout = -1;
            setTopAndBottomOffset(jhx.m144942b(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, int i3, int i4) {
            if (((ViewGroup.MarginLayoutParams) ((CoordinatorLayout.C0230f) t.getLayoutParams())).height != -2) {
        ...
        public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ...
                    savedState.firstVisibleChildAtMinimumHeight = bottom == kkl0.m150193y(childAt) + t.getTopInset();
        ...
        public int setHeaderTopBottomOffset(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, int i3) {
            ...
            int iM144942b = jhx.m144942b(i, i2, i3);
            if (topBottomOffsetForScrollingSibling != iM144942b) {
                int iInterpolateOffset = t.hasChildWithInterpolator() ? interpolateOffset(t, iM144942b) : iM144942b;
                boolean topAndBottomOffset = setTopAndBottomOffset(iInterpolateOffset);
                i4 = topBottomOffsetForScrollingSibling - iM144942b;
                this.offsetDelta = iM144942b - iInterpolateOffset;
                if (!topAndBottomOffset && t.hasChildWithInterpolator()) {
                    coordinatorLayout.dispatchDependentViewsChanged(t);
                }
                t.onOffsetChanged(getTopAndBottomOffset());
                updateAppBarLayoutDrawableState(coordinatorLayout, t, iM144942b, iM144942b < topBottomOffsetForScrollingSibling ? -1 : 1, false);
            }
            return i4;
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2489R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            typedArrayObtainStyledAttributes.recycle();
        }

        private static int getAppBarLayoutOffset(@NonNull AppBarLayout appBarLayout) {
            CoordinatorLayout.AbstractC0227c abstractC0227cM1182f = ((CoordinatorLayout.C0230f) appBarLayout.getLayoutParams()).m1182f();
            if (abstractC0227cM1182f instanceof BaseBehavior) {
                return ((BaseBehavior) abstractC0227cM1182f).getTopBottomOffsetForScrollingSibling();
            }
            return 0;
        }

        private void offsetChildAsNeeded(@NonNull View view, @NonNull View view2) {
            CoordinatorLayout.AbstractC0227c abstractC0227cM1182f = ((CoordinatorLayout.C0230f) view2.getLayoutParams()).m1182f();
            if (abstractC0227cM1182f instanceof BaseBehavior) {
                kkl0.m150140V(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) abstractC0227cM1182f).offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
        ...
        @Override // com.google.android.material.appbar.HeaderScrollingViewBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0227c
    ...
    public void setExpanded(boolean z) {
        setExpanded(z, kkl0.m150134P(this));
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.scrollFlags = 1;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2489R.styleable.AppBarLayout_Layout);
            this.scrollFlags = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, typedArrayObtainStyledAttributes.getResourceId(C2489R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            typedArrayObtainStyledAttributes.recycle();
        }
    ...
    public AppBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2489R.attr.appBarLayoutStyle);
    }
