...
class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2489R.animator.design_fab_hide_motion_spec);
        }
        return (MotionSpec) yn80.m216775e(this.defaultHideMotionSpec);
    }

    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2489R.animator.design_fab_show_motion_spec);
        }
        return (MotionSpec) yn80.m216775e(this.defaultShowMotionSpec);
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return kkl0.m150134P(this.view) && !this.view.isInEditMode();
    }
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new MaterialShapeDrawable((ShapeAppearanceModel) yn80.m216775e(this.shapeAppearance));
    }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) yn80.m216775e(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    public void onPaddingUpdated(@NonNull Rect rect) {
        yn80.m216776f(this.contentBackground, "Didn't initialize content background");
        if (!shouldAddPadding()) {
    ...
    public void setRippleColor(@Nullable ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            oce.m167175o(drawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
