...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.InterfaceC0226b {
    private static final int ANIM_STATE_HIDING = 1;
    private static final int ANIM_STATE_NONE = 0;
    private static final int ANIM_STATE_SHOWING = 2;
    private static final int DEF_STYLE_RES = C2489R.style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    static final Property<View, Float> HEIGHT;
    static final Property<View, Float> WIDTH;
    private int animState;

    @NonNull
    private final CoordinatorLayout.AbstractC0227c<ExtendedFloatingActionButton> behavior;
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C2489R.animator.mtrl_extended_fab_change_size_motion_spec;
        }
    ...
    public class HideStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C2489R.animator.mtrl_extended_fab_hide_motion_spec;
        }
    ...
    public class ShowStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C2489R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C2489R.styleable.ExtendedFloatingActionButton;
        ...
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2489R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2489R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec motionSpecCreateFromAttribute3 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2489R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec motionSpecCreateFromAttribute4 = MotionSpec.createFromAttribute(context, typedArrayObtainStyledAttributes, C2489R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
    ...
    private boolean shouldAnimateVisibilityChange() {
        return kkl0.m150134P(this) && !isInEditMode();
    }
    ...
    @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.InterfaceC0226b
    @NonNull
    public CoordinatorLayout.AbstractC0227c<ExtendedFloatingActionButton> getBehavior() {
        return this.behavior;
    }

    @VisibleForTesting
    public int getCollapsedSize() {
        return (Math.min(kkl0.m150112B(this), kkl0.m150110A(this)) * 2) + getIconSize();
    }
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.AbstractC0227c<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2489R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            CoordinatorLayout.C0230f c0230f = (CoordinatorLayout.C0230f) extendedFloatingActionButton.getLayoutParams();
            int i2 = 0;
            if (extendedFloatingActionButton.getRight() >= coordinatorLayout.getWidth() - ((ViewGroup.MarginLayoutParams) c0230f).rightMargin) {
                i = rect.right;
            } else {
                i = extendedFloatingActionButton.getLeft() <= ((ViewGroup.MarginLayoutParams) c0230f).leftMargin ? -rect.left : 0;
            }
            if (extendedFloatingActionButton.getBottom() >= coordinatorLayout.getHeight() - ((ViewGroup.MarginLayoutParams) c0230f).bottomMargin) {
                i2 = rect.bottom;
            } else if (extendedFloatingActionButton.getTop() <= ((ViewGroup.MarginLayoutParams) c0230f).topMargin) {
                i2 = -rect.top;
            }
            if (i2 != 0) {
                kkl0.m150140V(extendedFloatingActionButton, i2);
            }
            if (i != 0) {
                kkl0.m150139U(extendedFloatingActionButton, i);
            }
        }
        ...
        private boolean shouldUpdateVisibility(@NonNull View view, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((CoordinatorLayout.C0230f) extendedFloatingActionButton.getLayoutParams()).m1181e() == view.getId();
        }
        ...
        private boolean updateFabVisibilityForBottomSheet(@NonNull View view, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if (view.getTop() < (extendedFloatingActionButton.getHeight() / 2) + ((ViewGroup.MarginLayoutParams) ((CoordinatorLayout.C0230f) extendedFloatingActionButton.getLayoutParams())).topMargin) {
                shrinkOrHide(extendedFloatingActionButton);
                return true;
            }
            extendOrShow(extendedFloatingActionButton);
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2489R.attr.extendedFloatingActionButtonStyle);
    }
