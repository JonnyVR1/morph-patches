...
class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, rect.top, 0.0f, rect.bottom, new int[]{gf5.m130047j(this.topOuterStrokeColor, this.currentBorderTintColor), gf5.m130047j(this.topInnerStrokeColor, this.currentBorderTintColor), gf5.m130047j(gf5.m130052o(this.topInnerStrokeColor, 0), this.currentBorderTintColor), gf5.m130047j(gf5.m130052o(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), gf5.m130047j(this.bottomInnerStrokeColor, this.currentBorderTintColor), gf5.m130047j(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, fHeight, 0.5f, 0.5f, 1.0f - fHeight, 1.0f}, Shader.TileMode.CLAMP);
    }
