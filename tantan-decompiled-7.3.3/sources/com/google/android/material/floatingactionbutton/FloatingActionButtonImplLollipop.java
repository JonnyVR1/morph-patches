...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        BorderDrawable borderDrawable = new BorderDrawable((ShapeAppearanceModel) yn80.m216775e(this.shapeAppearance));
        borderDrawable.setGradientColors(j26.m143190c(context, C2489R.color.design_fab_stroke_top_outer_color), j26.m143190c(context, C2489R.color.design_fab_stroke_top_inner_color), j26.m143190c(context, C2489R.color.design_fab_stroke_end_inner_color), j26.m143190c(context, C2489R.color.design_fab_stroke_end_outer_color));
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new AlwaysStatefulMaterialShapeDrawable((ShapeAppearanceModel) yn80.m216775e(this.shapeAppearance));
    }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            layerDrawable = new LayerDrawable(new Drawable[]{(Drawable) yn80.m216775e(this.borderDrawable), (Drawable) yn80.m216775e(this.shapeDrawable)});
        } else {
