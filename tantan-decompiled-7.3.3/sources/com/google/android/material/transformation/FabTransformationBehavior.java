...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private ViewGroup calculateChildContentContainer(@NonNull View view) {
        View viewFindViewById = view.findViewById(C2489R.id.mtrl_child_content_container);
    ...
    private void createElevationAnimation(View view, @NonNull View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
        float fM150183t = kkl0.m150183t(view2) - kkl0.m150183t(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-fM150183t);
            }
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, 0.0f);
        } else {
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, -fM150183t);
        }
    ...
    private int getBackgroundTint(@NonNull View view) {
        ColorStateList colorStateListM150175p = kkl0.m150175p(view);
        if (colorStateListM150175p != null) {
            return colorStateListM150175p.getColorForState(view.getDrawableState(), colorStateListM150175p.getDefaultColor());
        }
        return 0;
    }
    ...
    @Override // com.google.android.material.transformation.ExpandableBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0227c
    @CallSuper
    public boolean layoutDependsOn(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull View view2) {
        if (view.getVisibility() == 8) {
            wtq0.m207906a("This behavior cannot be attached to a GONE view. Set the view to INVISIBLE instead.");
            return false;
        }
