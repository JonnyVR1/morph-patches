...
public class MaterialShapeDrawable extends Drawable implements Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C2489R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
    ...
    private boolean updateTintFilter() {
        ...
        return (l950.m153327a(porterDuffColorFilter, this.tintFilter) && l950.m153327a(porterDuffColorFilter2, this.strokeTintFilter)) ? false : true;
    }
