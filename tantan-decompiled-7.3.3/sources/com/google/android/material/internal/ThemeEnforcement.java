...
public final class ThemeEnforcement {
    ...
    private static final int[] APPCOMPAT_CHECK_ATTRS = {C2489R.attr.colorPrimary};
    private static final int[] MATERIAL_CHECK_ATTRS = {C2489R.attr.colorPrimaryVariant};
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C2489R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C2489R.attr.materialThemeOverlay};
    ...
    private static void checkCompatibleTheme(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2489R.styleable.ThemeEnforcement, i, i2);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
        typedArrayObtainStyledAttributes.recycle();
        if (z) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(C2489R.attr.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i, @StyleRes int i2, @Nullable @StyleableRes int... iArr2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2489R.styleable.ThemeEnforcement, i, i2);
        if (!typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.ThemeEnforcement_enforceTextAppearance, false)) {
            typedArrayObtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 == null || iArr2.length == 0) {
            zIsCustomTextAppearanceValid = typedArrayObtainStyledAttributes.getResourceId(C2489R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1;
        } else {
        ...
        wg3.m206174a("This component requires that you specify a valid TextAppearance attribute. Update your app theme to inherit from Theme.MaterialComponents (or a descendant).");
    }
    ...
    private static void checkTheme(@NonNull Context context, @NonNull int[] iArr, String str) {
        ...
        v1d0.m199002a("The style on this component requires your app theme to be ", str, " (or a descendant).");
    }
    ...
    public static Context createThemedContext(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        if (iObtainMaterialThemeOverlayId == 0 || ((context instanceof r26) && ((r26) context).m179532b() == iObtainMaterialThemeOverlayId)) {
            return context;
        }
        r26 r26Var = new r26(context, iObtainMaterialThemeOverlayId);
        int iObtainAndroidThemeOverlayId = obtainAndroidThemeOverlayId(r26Var, attributeSet);
        return iObtainAndroidThemeOverlayId != 0 ? new r26(r26Var, iObtainAndroidThemeOverlayId) : r26Var;
    }
    ...
    public static t0j0 obtainTintedStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i, @StyleRes int i2, @StyleableRes int... iArr2) {
        checkCompatibleTheme(context, attributeSet, i, i2);
        checkTextAppearance(context, attributeSet, iArr, i, i2, iArr2);
        return t0j0.m188782u(context, attributeSet, iArr, i, i2);
    }
}
