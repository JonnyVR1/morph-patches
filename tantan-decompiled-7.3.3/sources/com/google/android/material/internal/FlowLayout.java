...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2489R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.FlowLayout_itemSpacing, 0);
        ...
        for (int i7 = 0; i7 < getChildCount(); i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                    ...
                    iM174249b = pxw.m174249b(marginLayoutParams);
                    iM174248a = pxw.m174248a(marginLayoutParams);
                } else {
                    iM174248a = 0;
                    iM174249b = 0;
                }
                int measuredWidth2 = measuredWidth + iM174249b + childAt.getMeasuredWidth();
                if (!this.singleLine && measuredWidth2 > i5) {
                    i6 = this.lineSpacing + paddingTop;
                    measuredWidth = paddingRight;
                }
                int i8 = measuredWidth + iM174249b;
                int measuredWidth3 = childAt.getMeasuredWidth() + i8;
                int measuredHeight = childAt.getMeasuredHeight() + i6;
                if (z2) {
                    childAt.layout(i5 - measuredWidth3, i6, (i5 - measuredWidth) - iM174249b, measuredHeight);
                } else {
                    childAt.layout(i8, i6, measuredWidth3, measuredHeight);
                }
                measuredWidth += iM174249b + iM174248a + childAt.getMeasuredWidth() + this.itemSpacing;
