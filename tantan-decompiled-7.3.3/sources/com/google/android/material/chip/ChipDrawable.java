...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void applyChildDrawable(@Nullable Drawable drawable) {
        ...
        oce.m167173m(drawable, oce.m167166f(this));
        ...
        if (drawable == this.closeIcon) {
            ...
            oce.m167175o(drawable, this.closeIconTint);
            return;
        }
        if (drawable.isStateful()) {
        ...
        if (drawable == drawable2 && this.hasChipIconTint) {
            oce.m167175o(drawable2, this.chipIconTint);
        }
    }
    ...
    public static ChipDrawable createFromResource(@NonNull Context context, @XmlRes int i) {
        ...
        if (styleAttribute == 0) {
            styleAttribute = C2489R.style.Widget_MaterialComponents_Chip_Entry;
        }
        return createFromAttributes(context, drawableXml, C2489R.attr.chipStandaloneStyle, styleAttribute);
    }
    ...
    private void drawDebug(@NonNull Canvas canvas, @NonNull Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(gf5.m130052o(RoundedDrawable.DEFAULT_BORDER_COLOR, 127));
            ...
            this.debugPaint.setColor(gf5.m130052o(-65536, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas2.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(gf5.m130052o(-16711936, 127));
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, C2489R.styleable.Chip, i, i2, new int[0]);
        this.isShapeThemingEnabled = typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.Chip_shapeAppearance);
        setChipSurfaceColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_chipSurfaceColor));
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_chipBackgroundColor));
        setChipMinHeight(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipMinHeight, 0.0f));
        if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.Chip_chipCornerRadius)) {
            setChipCornerRadius(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipCornerRadius, 0.0f));
        }
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_rippleColor));
        setText(typedArrayObtainStyledAttributes.getText(C2489R.styleable.Chip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_android_textAppearance));
        int i3 = typedArrayObtainStyledAttributes.getInt(C2489R.styleable.Chip_android_ellipsize, 0);
        if (i3 == 1) {
        ...
        setChipIconVisible(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_chipIconVisible, false));
        if (attributeSet != null && attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") != null && attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconVisible") == null) {
            setChipIconVisible(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_chipIconEnabled, false));
        }
        setChipIcon(MaterialResources.getDrawable(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_chipIcon));
        if (typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.Chip_chipIconTint)) {
            setChipIconTint(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_chipIconTint));
        }
        setChipIconSize(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipIconSize, 0.0f));
        setCloseIconVisible(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_closeIconVisible, false));
        if (attributeSet != null && attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") != null && attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconVisible") == null) {
            setCloseIconVisible(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_closeIconEnabled, false));
        }
        setCloseIcon(MaterialResources.getDrawable(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_closeIconTint));
        setCloseIconSize(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_closeIconSize, 0.0f));
        setCheckable(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_android_checkable, false));
        setCheckedIconVisible(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_checkedIconVisible, false));
        if (attributeSet != null && attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") != null && attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") == null) {
            setCheckedIconVisible(typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_checkedIconEnabled, false));
        }
        setCheckedIcon(MaterialResources.getDrawable(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_checkedIcon));
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, typedArrayObtainStyledAttributes, C2489R.styleable.Chip_hideMotionSpec));
        setChipStartPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipStartPadding, 0.0f));
        setIconStartPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_iconStartPadding, 0.0f));
        setIconEndPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_iconEndPadding, 0.0f));
        setTextStartPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_textStartPadding, 0.0f));
        setTextEndPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_textEndPadding, 0.0f));
        setCloseIconStartPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_closeIconStartPadding, 0.0f));
        setCloseIconEndPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_closeIconEndPadding, 0.0f));
        setChipEndPadding(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipEndPadding, 0.0f));
        setMaxWidth(typedArrayObtainStyledAttributes.getDimensionPixelSize(C2489R.styleable.Chip_android_maxWidth, Api.BaseClientBuilder.API_PRIORITY_OTHER));
    ...
    public boolean onLayoutDirectionChanged(int i) {
        ...
        if (showsChipIcon()) {
            zOnLayoutDirectionChanged |= oce.m167173m(this.chipIcon, i);
        }
        if (showsCheckedIcon()) {
            zOnLayoutDirectionChanged |= oce.m167173m(this.checkedIcon, i);
        }
        if (showsCloseIcon()) {
            zOnLayoutDirectionChanged |= oce.m167173m(this.closeIcon, i);
        }
    ...
    public void setCheckedIconResource(@DrawableRes int i) {
        setCheckedIcon(tu0.m192702b(this.context, i));
    }
    ...
    public void setChipBackgroundColorResource(@ColorRes int i) {
        setChipBackgroundColor(tu0.m192701a(this.context, i));
    }
    ...
    public void setChipIcon(@Nullable Drawable drawable) {
        ...
        if (chipIcon != drawable) {
            float fCalculateChipIconWidth = calculateChipIconWidth();
            this.chipIcon = drawable != null ? oce.m167178r(drawable).mutate() : null;
            float fCalculateChipIconWidth2 = calculateChipIconWidth();
    ...
    public void setChipIconResource(@DrawableRes int i) {
        setChipIcon(tu0.m192702b(this.context, i));
    }
    ...
    public void setChipIconTint(@Nullable ColorStateList colorStateList) {
        ...
        if (this.chipIconTint != colorStateList) {
            ...
            if (showsChipIcon()) {
                oce.m167175o(this.chipIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setChipIconTintResource(@ColorRes int i) {
        setChipIconTint(tu0.m192701a(this.context, i));
    }
    ...
    public void setChipStrokeColorResource(@ColorRes int i) {
        setChipStrokeColor(tu0.m192701a(this.context, i));
    }
    ...
    public void setCloseIcon(@Nullable Drawable drawable) {
        ...
        if (closeIcon != drawable) {
            ...
            this.closeIcon = drawable != null ? oce.m167178r(drawable).mutate() : null;
            if (RippleUtils.USE_FRAMEWORK_RIPPLE) {
    ...
    public void setCloseIconContentDescription(@Nullable CharSequence charSequence) {
        if (this.closeIconContentDescription != charSequence) {
            this.closeIconContentDescription = lx2.m156132c().m156137h(charSequence);
            invalidateSelf();
        }
    }
    ...
    public void setCloseIconResource(@DrawableRes int i) {
        setCloseIcon(tu0.m192702b(this.context, i));
    }
    ...
    public void setCloseIconTint(@Nullable ColorStateList colorStateList) {
        if (this.closeIconTint != colorStateList) {
            ...
            if (showsCloseIcon()) {
                oce.m167175o(this.closeIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconTintResource(@ColorRes int i) {
        setCloseIconTint(tu0.m192701a(this.context, i));
    }
    ...
    public void setRippleColorResource(@ColorRes int i) {
        setRippleColor(tu0.m192701a(this.context, i));
    }
