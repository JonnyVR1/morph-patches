...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public class ChipTouchHelper extends dpf {
        ...
        public void onPopulateNodeForHost(@NonNull C15967bc c15967bc) {
            c15967bc.m103427m0(Chip.this.isCheckable());
            c15967bc.m103433p0(Chip.this.isClickable());
            if (Chip.this.isCheckable() || Chip.this.isClickable()) {
                c15967bc.m103431o0(Chip.this.isCheckable() ? Chip.COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : Chip.BUTTON_ACCESSIBILITY_CLASS_NAME);
            } else {
                c15967bc.m103431o0(Chip.GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME);
            }
            c15967bc.m103394Q0(Chip.this.getText());
        }

        @Override // p153l.dpf
        public void onPopulateNodeForVirtualView(int i, @NonNull C15967bc c15967bc) {
            if (i != 1) {
                c15967bc.m103438s0("");
                c15967bc.m103421j0(Chip.EMPTY_BOUNDS);
                return;
            }
            CharSequence closeIconContentDescription = Chip.this.getCloseIconContentDescription();
            if (closeIconContentDescription != null) {
                c15967bc.m103438s0(closeIconContentDescription);
            } else {
                CharSequence text = Chip.this.getText();
                c15967bc.m103438s0(Chip.this.getContext().getString(C2489R.string.mtrl_chip_close_icon_content_description, TextUtils.isEmpty(text) ? "" : text).trim());
            }
            c15967bc.m103421j0(Chip.this.getCloseIconTouchBoundsInt());
            c15967bc.m103407b(C15967bc.a.f76060i);
            c15967bc.m103444v0(Chip.this.isEnabled());
        }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable chipDrawableCreateFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C2489R.style.Widget_MaterialComponents_Chip_Action);
        initMinTouchTarget(context, attributeSet, i);
        setChipDrawable(chipDrawableCreateFromAttributes);
        chipDrawableCreateFromAttributes.setElevation(kkl0.m150183t(this));
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2489R.styleable.Chip, i, C2489R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C2489R.styleable.Chip_shapeAppearance);
        typedArrayObtainStyledAttributes.recycle();
        ChipTouchHelper chipTouchHelper = new ChipTouchHelper(this);
        this.touchHelper = chipTouchHelper;
        kkl0.m150164j0(this, chipTouchHelper);
        if (!zHasValue) {
            initOutlineProvider();
        }
        ...
        this.lastLayoutDirection = kkl0.m150191x(this);
    }
    ...
    private boolean handleAccessibilityExit(@NonNull MotionEvent motionEvent) {
        ...
        try {
            Field declaredField = dpf.class.getDeclaredField("mHoveredVirtualViewId");
            declaredField.setAccessible(true);
            if (((Integer) declaredField.get(this.touchHelper)).intValue() == Integer.MIN_VALUE) {
                return false;
            }
            Method declaredMethod = dpf.class.getDeclaredMethod("updateHoveredVirtualView", Integer.TYPE);
    ...
    private void initMinTouchTarget(Context context, @Nullable AttributeSet attributeSet, int i) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2489R.styleable.Chip, i, C2489R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        this.ensureMinTouchTargetSize = typedArrayObtainStyledAttributes.getBoolean(C2489R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(typedArrayObtainStyledAttributes.getDimension(C2489R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    private void updateBackgroundDrawable() {
        ...
        kkl0.m150170m0(this, getBackgroundDrawable());
    ...
    private void updateFrameworkRippleBackground() {
        ...
        kkl0.m150170m0(this, this.ripple);
    }
    ...
    private void updatePaddingInternal() {
        ...
        kkl0.m150196z0(this, (int) (this.chipDrawable.getChipStartPadding() + this.chipDrawable.getTextStartPadding() + this.chipDrawable.calculateChipIconWidth()), getPaddingTop(), (int) (chipDrawable.getChipEndPadding() + this.chipDrawable.getTextEndPadding() + this.chipDrawable.calculateCloseIconWidth()), getPaddingBottom());
    }
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableLeft") != null) {
            pr3.m173429a("Please set left drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableStart") != null) {
            pr3.m173429a("Please set start drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableEnd") != null) {
            pr3.m173429a("Please set end drawable using R.attr#closeIcon.");
            return;
        }
        ...
        if (attributeSet.getAttributeBooleanValue(NAMESPACE_ANDROID, "singleLine", true) && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "lines", 1) == 1 && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "minLines", 1) == 1 && attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "maxLines", 1) == 1) {
            ...
            pr3.m173429a("Chip does not support multi-line text");
        }
    }
    ...
    public void setEllipsize(TextUtils.TruncateAt truncateAt) {
        ...
        if (truncateAt == TextUtils.TruncateAt.MARQUEE) {
            pr3.m173429a("Text within a chip are not allowed to scroll.");
            return;
        }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(@Nullable Drawable drawable, @Nullable Drawable drawable2, @Nullable Drawable drawable3, @Nullable Drawable drawable4) {
        if (drawable != null) {
            ...
            pr3.m173429a("Please set right drawable using R.attr#closeIcon.");
        }
    }

    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2489R.attr.chipStyle);
    }
