...
class UtcDates {
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll(Constants.INAPP_DATA_TAG, resources.getString(C2489R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C2489R.string.mtrl_picker_text_input_month_abbr)).replaceAll(BaseSei.f14625Y, resources.getString(C2489R.string.mtrl_picker_text_input_year_abbr));
    }
