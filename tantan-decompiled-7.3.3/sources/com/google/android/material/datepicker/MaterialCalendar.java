...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C2489R.id.month_navigation_fragment_toggle);
        materialButton.setTag(SELECTOR_TOGGLE_TAG);
        kkl0.m150164j0(materialButton, new C16932fb() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, @NonNull C15967bc c15967bc) {
                ...
                c15967bc.m103362A0(visibility == 0 ? materialCalendar.getString(C2489R.string.mtrl_picker_toggle_to_year_selection) : materialCalendar.getString(C2489R.string.mtrl_picker_toggle_to_day_selection));
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C2489R.id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C2489R.id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C2489R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C2489R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        materialButton.setText(this.current.getLongName());
        this.recyclerView.addOnScrollListener(new RecyclerView.AbstractC0584t() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
    ...
    @NonNull
    private RecyclerView.AbstractC0578n createItemDecoration() {
        return new RecyclerView.AbstractC0578n() { // from class: com.google.android.material.datepicker.MaterialCalendar.4
            ...
            public void onDraw(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.C0561a0 c0561a0) {
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (pf60<Long, Long> pf60Var : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        Long l2 = pf60Var.f152156a;
                        if (l2 != null && pf60Var.f152157b != null) {
                            this.startItem.setTimeInMillis(l2.longValue());
                            this.endItem.setTimeInMillis(pf60Var.f152157b.longValue());
                            ...
                            int iM3318m = positionForYear / gridLayoutManager.m3318m();
                            int iM3318m2 = positionForYear2 / gridLayoutManager.m3318m();
                            int i = iM3318m;
                            while (i <= iM3318m2) {
                                View viewFindViewByPosition3 = gridLayoutManager.findViewByPosition(gridLayoutManager.m3318m() * i);
                                if (viewFindViewByPosition3 != null) {
                                    canvas.drawRect(i == iM3318m ? viewFindViewByPosition.getLeft() + (viewFindViewByPosition.getWidth() / 2) : 0, viewFindViewByPosition3.getTop() + MaterialCalendar.this.calendarStyle.year.getTopInset(), i == iM3318m2 ? viewFindViewByPosition2.getLeft() + (viewFindViewByPosition2.getWidth() / 2) : recyclerView.getWidth(), viewFindViewByPosition3.getBottom() - MaterialCalendar.this.calendarStyle.year.getBottomInset(), MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                                i++;
                            }
                        }
    ...
    public static int getDayHeight(@NonNull Context context) {
        return context.getResources().getDimensionPixelSize(C2489R.dimen.mtrl_calendar_day_height);
    }
    ...
    @Override // com.google.android.material.datepicker.PickerFragment, androidx.lifecycle.InterfaceC0476e
    @NotNull
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i = C2489R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C2489R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(i, viewGroup, false);
        GridView gridView = (GridView) viewInflate.findViewById(C2489R.id.mtrl_calendar_days_of_week);
        kkl0.m150164j0(gridView, new C16932fb() { // from class: com.google.android.material.datepicker.MaterialCalendar.1
            @Override // p153l.C16932fb
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull C15967bc c15967bc) {
                ...
                c15967bc.m103435q0(null);
            }
        });
        gridView.setAdapter((ListAdapter) new DaysOfWeekAdapter());
        gridView.setNumColumns(start.daysInWeek);
        gridView.setEnabled(false);
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C2489R.id.mtrl_calendar_months);
        final int i3 = i2;
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C2489R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) viewInflate.findViewById(C2489R.id.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C2489R.id.month_navigation_fragment_toggle) != null) {
            addActionsToMonthNavigation(viewInflate, monthsPagerAdapter);
        }
        if (!MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            new C0611o().mo3858b(this.recyclerView);
        }
