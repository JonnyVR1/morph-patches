...
final class MaterialCalendarGridView extends GridView {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (MaterialDatePicker.isFullscreen(getContext())) {
            setNextFocusLeftId(C2489R.id.cancel_button);
            setNextFocusRightId(C2489R.id.confirm_button);
        }
        kkl0.m150164j0(this, new C16932fb() { // from class: com.google.android.material.datepicker.MaterialCalendarGridView.1
    ...
    public final void onDraw(@NonNull Canvas canvas) {
        ...
        for (pf60<Long, Long> pf60Var : dateSelector.getSelectedRanges()) {
    ...
    public final void setAdapter(ListAdapter listAdapter) {
        if (listAdapter instanceof MonthAdapter) {
            ...
            gzi0.m133102a("%1$s must have its Adapter set to a %2$s", new Object[]{MaterialCalendarGridView.class.getCanonicalName(), MonthAdapter.class.getCanonicalName()});
        }
    }
