...
@Deprecated
public class ShadowDrawableWrapper extends ide {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = j26.m143190c(context, C2489R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = j26.m143190c(context, C2489R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = j26.m143190c(context, C2489R.color.design_fab_shadow_end_color);
    ...
    public void setShadowSize(float f, float f2) {
        if (f < 0.0f || f2 < 0.0f) {
            wg3.m206174a("invalid shadow size");
            return;
        }
        float even = toEven(f);
