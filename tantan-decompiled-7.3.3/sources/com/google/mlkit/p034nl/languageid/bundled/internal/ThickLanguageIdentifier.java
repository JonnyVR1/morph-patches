...
public class ThickLanguageIdentifier implements b9r {
    private static boolean zba;
    private final Context zbb;
    private long zbc;

    public ThickLanguageIdentifier(Context context, z8r z8rVar) {
        this.zbb = context;
    }
    ...
    public static synchronized void m16936b() throws MlKitException {
        if (zba) {
            return;
        }
        try {
    ...
    public final List mo16937a(@NonNull String str, float f) {
        ...
        for (IdentifiedLanguage identifiedLanguage : identifiedLanguageArrNativeIdentifyPossibleLanguages) {
            arrayList.add(new IdentifiedLanguage(identifiedLanguage.m16935b(), identifiedLanguage.m16934a()));
        }
        return arrayList;
    }
