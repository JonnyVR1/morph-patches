...
public abstract class HashCode {
    ...
    public static final class BytesHashCode extends HashCode implements Serializable {
        ...
        public BytesHashCode(byte[] bArr) {
            this.bytes = (byte[]) xn80.m212111p(bArr);
        }
        ...
        public int asInt() {
            ...
            xn80.m212119x(bArr.length >= 4, "HashCode#asInt() requires >= 4 bytes (it only has %s bytes).", bArr.length);
        ...
        public long asLong() {
            byte[] bArr = this.bytes;
            xn80.m212119x(bArr.length >= 8, "HashCode#asLong() requires >= 8 bytes (it only has %s bytes).", bArr.length);
            return padToLong();
        }
    ...
    public static final class IntHashCode extends HashCode implements Serializable {
        ...
        @Override // com.google.common.hash.HashCode
        public long padToLong() {
            return UnsignedInts.m16548f(this.hash);
        }
    ...
    public static HashCode fromBytes(byte[] bArr) {
        xn80.m212100e(bArr.length >= 1, "A HashCode must contain at least 1 byte.");
    ...
    public static HashCode fromString(String str) {
        xn80.m212106k(str.length() >= 2, "input string (%s) must have at least 2 characters", str);
        xn80.m212106k(str.length() % 2 == 0, "input string (%s) must have an even number of characters", str);
    ...
    public int writeBytesTo(byte[] bArr, int i, int i2) {
        int iM16522l = Ints.m16522l(i2, bits() / 8);
        xn80.m212116u(i, i + iM16522l, bArr.length);
        writeBytesToImpl(bArr, i, iM16522l);
        return iM16522l;
    }
