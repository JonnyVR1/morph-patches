...
final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    public static abstract class ImmutableArrayMap<K, V> extends ImmutableMap.IteratorBasedImmutableMap<K, V> {
        ...
        public class C2783a extends AbstractIterator<Map.Entry<K, V>> {
            ...
            public C2783a() {
                this.f10893d = ImmutableArrayMap.this.keyToIndex().size();
            }

            @Override // com.google.common.collect.AbstractIterator
            /* JADX INFO: renamed from: d, reason: merged with bridge method [inline-methods] */
            public Map.Entry<K, V> mo15619a() {
                int i = this.f10892c;
                while (true) {
                    this.f10892c = i + 1;
                    int i2 = this.f10892c;
                    ...
                    if (value != null) {
                        return Maps.m16089j(ImmutableArrayMap.this.getKey(this.f10892c), value);
                    }
                    i = this.f10892c;
                }
            }
    ...
    public DenseImmutableTable(ImmutableList<InterfaceC3002r.a<R, C, V>> immutableList, ImmutableSet<R> immutableSet, ImmutableSet<C> immutableSet2) {
        this.values = (V[][]) ((Object[][]) Array.newInstance((Class<?>) Object.class, immutableSet.size(), immutableSet2.size()));
        ImmutableMap<R, Integer> immutableMapM16090k = Maps.m16090k(immutableSet);
        this.rowKeyToIndex = immutableMapM16090k;
        ImmutableMap<C, Integer> immutableMapM16090k2 = Maps.m16090k(immutableSet2);
        this.columnKeyToIndex = immutableMapM16090k2;
        this.rowCounts = new int[immutableMapM16090k.size()];
        this.columnCounts = new int[immutableMapM16090k2.size()];
    ...
    @Override // com.google.common.collect.ImmutableTable, com.google.common.collect.AbstractC2989e, com.google.common.collect.InterfaceC3002r
