...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<>(ImmutableList.m15739of(), Ordering.natural());
    ...
    public boolean containsAll(Collection<?> collection) {
        ...
        if (!buf0.m106520b(comparator(), collection) || collection.size() <= 1) {
    ...
    @Override // com.google.common.collect.ImmutableSortedSet, java.util.NavigableSet
    public gyj0<E> descendingIterator() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!buf0.m106520b(this.comparator, set)) {
    ...
    public int headIndex(E e, boolean z) {
        int iBinarySearch = Collections.binarySearch(this.elements, xn80.m212111p(e), comparator());
        if (iBinarySearch >= 0) {
