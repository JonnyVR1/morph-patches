...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
        ...
        public ImmutableList<Map.Entry<K, V>> createAsList() {
            return new ImmutableList<Map.Entry<K, V>>() { // from class: com.google.common.collect.RegularImmutableMap.EntrySet.1
                ...
                public Map.Entry<K, V> get(int i) {
                    xn80.m212109n(i, EntrySet.this.size);
                    int i2 = i * 2;
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i, Object[] objArr, ImmutableMap.C2809b<K, V> c2809b) {
        if (i == 0) {
        ...
        if (i == 1) {
            ...
            Objects.requireNonNull(obj2);
            se5.m185515a(obj, obj2);
            return new RegularImmutableMap<>(null, objArr, 1);
        }
        xn80.m212114s(i, objArr.length >> 1);
        ...
        if (objCreateHashTable instanceof Object[]) {
            ...
            ImmutableMap.C2809b.a aVar = (ImmutableMap.C2809b.a) objArr2[2];
            if (c2809b == null) {
                throw aVar.m15786a();
            }
            c2809b.f10929e = aVar;
    ...
    private static Object createHashTable(Object[] objArr, int i, int i2, int i3) {
        int i4;
        ImmutableMap.C2809b.a aVar = null;
        int i5 = 1;
        if (i == 1) {
        ...
        if (i2 <= 128) {
            ...
            for (int i8 = 0; i8 < i; i8++) {
                ...
                se5.m185515a(obj3, obj4);
                int iM107165c = bzk.m107165c(obj3.hashCode());
                while (true) {
                    int i11 = iM107165c & i6;
                    ...
                    if (obj3.equals(objArr[i12])) {
                        ...
                        aVar = new ImmutableMap.C2809b.a(obj3, obj4, obj5);
                        objArr[i13] = obj4;
                        break;
                    }
                    iM107165c = i11 + 1;
        ...
        if (i2 <= 32768) {
            ...
            for (int i15 = 0; i15 < i; i15++) {
                ...
                se5.m185515a(obj6, obj7);
                int iM107165c2 = bzk.m107165c(obj6.hashCode());
                while (true) {
                    int i18 = iM107165c2 & i6;
                    ...
                    if (obj6.equals(objArr[i19])) {
                        ...
                        aVar = new ImmutableMap.C2809b.a(obj6, obj7, obj8);
                        objArr[i20] = obj7;
                        break;
                    }
                    iM107165c2 = i18 + 1;
        ...
        while (i21 < i) {
            ...
            se5.m185515a(obj9, obj10);
            int iM107165c3 = bzk.m107165c(obj9.hashCode());
            while (true) {
                int i25 = iM107165c3 & i6;
                int i26 = iArr[i25];
                if (i26 == -1) {
                    iArr[i25] = i24;
                    if (i22 < i21) {
                ...
                if (obj9.equals(objArr[i26])) {
                    ...
                    aVar = new ImmutableMap.C2809b.a(obj9, obj10, obj11);
                    objArr[i27] = obj10;
                    break;
                }
                iM107165c3 = i25 + 1;
    ...
    public static Object createHashTableOrThrow(Object[] objArr, int i, int i2, int i3) {
        ...
        if (objCreateHashTable instanceof Object[]) {
            throw ((ImmutableMap.C2809b.a) ((Object[]) objCreateHashTable)[2]).m15786a();
        }
    ...
    public static Object get(Object obj, Object[] objArr, int i, int i2, Object obj2) {
        ...
        if (obj instanceof byte[]) {
            ...
            int iM107165c = bzk.m107165c(obj2.hashCode());
            while (true) {
                int i3 = iM107165c & length;
            ...
            int iM107165c2 = bzk.m107165c(obj2.hashCode());
            while (true) {
                int i5 = iM107165c2 & length2;
            ...
            int iM107165c3 = bzk.m107165c(obj2.hashCode());
            while (true) {
                int i7 = iM107165c3 & length3;
                int i8 = iArr[i7];
                if (i8 == -1) {
                    return null;
                }
