...
public class HashBasedTable<R, C, V> extends StandardTable<R, C, V> {
    ...
    public static class Factory<C, V> implements b7h0<Map<C, V>>, Serializable {
        private static final long serialVersionUID = 0;
        ...
        @Override // p153l.b7h0
        public Map<C, V> get() {
            return Maps.m16099t(this.expectedSize);
        }
    }
    ...
    public static <R, C, V> HashBasedTable<R, C, V> create(int i, int i2) {
        se5.m185516b(i2, "expectedCellsPerRow");
        return new HashBasedTable<>(Maps.m16099t(i), new Factory(i2));
    }
    ...
    public static <R, C, V> HashBasedTable<R, C, V> create(InterfaceC3002r<? extends R, ? extends C, ? extends V> interfaceC3002r) {
        HashBasedTable<R, C, V> hashBasedTableCreate = create();
        hashBasedTableCreate.putAll(interfaceC3002r);
