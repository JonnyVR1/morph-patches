...
abstract class AbstractSortedSetMultimap<K, V> extends AbstractSetMultimap<K, V> implements cuf0<K, V> {
    ...
    public <E> SortedSet<E> unmodifiableCollectionSubclass(Collection<E> collection) {
        return collection instanceof NavigableSet ? Sets.m16182m((NavigableSet) collection) : Collections.unmodifiableSortedSet((SortedSet) collection);
    }
    ...
    public Collection<V> wrapCollection(K k, Collection<V> collection) {
        return collection instanceof NavigableSet ? new AbstractMapBasedMultimap.C2754m(k, (NavigableSet) collection, null) : new AbstractMapBasedMultimap.C2756o(k, (SortedSet) collection, null);
    }
}
