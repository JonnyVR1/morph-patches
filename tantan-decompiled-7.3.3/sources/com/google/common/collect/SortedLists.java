...
public final class SortedLists {
    ...
    public static <E> int m16184a(List<? extends E> list, E e, Comparator<? super E> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        xn80.m212111p(comparator);
        xn80.m212111p(list);
        xn80.m212111p(keyPresentBehavior);
        xn80.m212111p(keyAbsentBehavior);
        if (!(list instanceof RandomAccess)) {
            list = Lists.m15978k(list);
        }
        int size = list.size() - 1;
        int i = 0;
        while (i <= size) {
    ...
    public static <E, K extends Comparable> int m16185b(List<E> list, adj<? super E, K> adjVar, K k, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        xn80.m212111p(k);
        return m16186c(list, adjVar, k, Ordering.natural(), keyPresentBehavior, keyAbsentBehavior);
    }

    /* JADX INFO: renamed from: c */
    public static <E, K> int m16186c(List<E> list, adj<? super E, K> adjVar, K k, Comparator<? super K> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        return m16184a(Lists.m15985r(list, adjVar), k, comparator, keyPresentBehavior, keyAbsentBehavior);
    }
}
