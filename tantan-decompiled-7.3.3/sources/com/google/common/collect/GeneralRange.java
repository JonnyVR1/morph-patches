...
final class GeneralRange<T> implements Serializable {
    ...
    private GeneralRange(Comparator<? super T> comparator, boolean z, T t, BoundType boundType, boolean z2, T t2, BoundType boundType2) {
        ...
        this.lowerBoundType = (BoundType) xn80.m212111p(boundType);
        this.upperEndpoint = t2;
        this.upperBoundType = (BoundType) xn80.m212111p(boundType2);
        if (z) {
            comparator.compare((Object) k350.m147997a(t), (Object) k350.m147997a(t));
        }
        if (z2) {
            comparator.compare((Object) k350.m147997a(t2), (Object) k350.m147997a(t2));
        }
        if (z && z2) {
            int iCompare = comparator.compare((Object) k350.m147997a(t), (Object) k350.m147997a(t2));
            xn80.m212107l(iCompare <= 0, "lowerEndpoint (%s) > upperEndpoint (%s)", t, t2);
            if (iCompare == 0) {
                BoundType boundType3 = BoundType.OPEN;
                xn80.m212099d((boundType == boundType3 && boundType2 == boundType3) ? false : true);
            }
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GeneralRange) {
            ...
            if (this.comparator.equals(generalRange.comparator) && this.hasLowerBound == generalRange.hasLowerBound && this.hasUpperBound == generalRange.hasUpperBound && getLowerBoundType().equals(generalRange.getLowerBoundType()) && getUpperBoundType().equals(generalRange.getUpperBoundType()) && k950.m148863a(getLowerEndpoint(), generalRange.getLowerEndpoint()) && k950.m148863a(getUpperEndpoint(), generalRange.getUpperEndpoint())) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return k950.m148864b(this.comparator, getLowerEndpoint(), getLowerBoundType(), getUpperEndpoint(), getUpperBoundType());
    }
    ...
    public GeneralRange<T> intersect(GeneralRange<T> generalRange) {
        ...
        int iCompare3;
        BoundType boundType;
        xn80.m212111p(generalRange);
        xn80.m212099d(this.comparator.equals(generalRange.comparator));
    ...
    public boolean isEmpty() {
        if (hasUpperBound() && tooLow(k350.m147997a(getUpperEndpoint()))) {
            return true;
        }
        return hasLowerBound() && tooHigh(k350.m147997a(getLowerEndpoint()));
    }
    ...
    public boolean tooHigh(T t) {
        ...
        int iCompare = this.comparator.compare(t, k350.m147997a(getUpperEndpoint()));
    ...
    public boolean tooLow(T t) {
        ...
        int iCompare = this.comparator.compare(t, k350.m147997a(getLowerEndpoint()));
