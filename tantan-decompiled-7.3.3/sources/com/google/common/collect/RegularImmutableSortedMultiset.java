...
final class RegularImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    public InterfaceC2995k.a<E> getEntry(int i) {
        return Multisets.m16150g(this.elementSet.asList().get(i), getCount(i));
    }
    ...
    public ImmutableSortedMultiset<E> headMultiset(E e, BoundType boundType) {
        return getSubMultiset(0, this.elementSet.headIndex(e, xn80.m212111p(boundType) == BoundType.CLOSED));
    }
    ...
    public int size() {
        long[] jArr = this.cumulativeCounts;
        int i = this.offset;
        return Ints.m16523m(jArr[this.length + i] - jArr[i]);
    }

    @Override // com.google.common.collect.ImmutableSortedMultiset, com.google.common.collect.InterfaceC3000p
    public ImmutableSortedMultiset<E> tailMultiset(E e, BoundType boundType) {
        return getSubMultiset(this.elementSet.tailIndex(e, xn80.m212111p(boundType) == BoundType.CLOSED), this.length);
    }
