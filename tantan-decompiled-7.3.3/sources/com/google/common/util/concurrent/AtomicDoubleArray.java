...
public class AtomicDoubleArray implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        ImmutableLongArray.C3041b c3041bBuilder = ImmutableLongArray.builder();
        for (int i2 = 0; i2 < i; i2++) {
            c3041bBuilder.m16506a(Double.doubleToRawLongBits(objectInputStream.readDouble()));
        }
        this.longs = new AtomicLongArray(c3041bBuilder.m16509d().toArray());
    }
