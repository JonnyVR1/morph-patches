...
public final class AtomicLongMap<K> implements Serializable {
    ...
    public class C3081a implements adj<AtomicLong, Long> {
        public C3081a(AtomicLongMap atomicLongMap) {
        }
    ...
    private AtomicLongMap(ConcurrentHashMap<K, AtomicLong> concurrentHashMap) {
        this.map = (ConcurrentHashMap) xn80.m212111p(concurrentHashMap);
    }
    ...
    private Map<K, Long> createAsMap() {
        return Collections.unmodifiableMap(Maps.m16069D(this.map, new C3081a(this)));
    }
