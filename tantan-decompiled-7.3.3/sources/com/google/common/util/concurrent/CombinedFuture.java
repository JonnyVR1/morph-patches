...
public final class CombinedFuture<V> extends AggregateFuture<Object, V> {
    ...
    public abstract class CombinedFutureInterruptibleTask<T> extends InterruptibleTask<T> {
        ...
        public CombinedFutureInterruptibleTask(CombinedFuture combinedFuture, Executor executor) {
            this.listenerExecutor = (Executor) xn80.m212111p(executor);
        }

        @Override // com.google.common.util.concurrent.InterruptibleTask
        public final void afterRanInterruptiblyFailure(Throwable th) {
            CombinedFuture.m16692H(null, null);
    ...
    public static /* synthetic */ CombinedFutureInterruptibleTask m16692H(CombinedFuture combinedFuture, CombinedFutureInterruptibleTask combinedFutureInterruptibleTask) {
        throw null;
    }

    public final class AsyncCallableInterruptibleTask extends CombinedFuture<V>.CombinedFutureInterruptibleTask<hpr<V>> {
        private final n21<V> callable;
        final /* synthetic */ CombinedFuture this$0;

        public AsyncCallableInterruptibleTask(CombinedFuture combinedFuture, n21<V> n21Var, Executor executor) {
            super(combinedFuture, executor);
        ...
        @Override // com.google.common.util.concurrent.CombinedFuture.CombinedFutureInterruptibleTask
        public void setValue(hpr<V> hprVar) {
            throw null;
        }
    }
}
