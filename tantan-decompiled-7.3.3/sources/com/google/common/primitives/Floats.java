...
public final class Floats extends zti {
    ...
    public static int m16466c(float f) {
        return Float.valueOf(f).hashCode();
    }

    /* JADX INFO: renamed from: d */
    public static int m16467d(float[] fArr, float f, int i, int i2) {
        while (i < i2) {
            if (fArr[i] == f) {
                return i;
            }
    ...
    public static int m16468e(float[] fArr, float f, int i, int i2) {
    ...
    public static class FloatArrayAsList extends AbstractList<Float> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Float) && Floats.m16467d(this.array, ((Float) obj).floatValue(), this.start, this.end) != -1;
        }
        ...
        public int hashCode() {
            ...
            for (int i = this.start; i < this.end; i++) {
                iM16466c = (iM16466c * 31) + Floats.m16466c(this.array[i]);
            }
            return iM16466c;
        }
        ...
        public int indexOf(Object obj) {
            int iM16467d;
            if (!(obj instanceof Float) || (iM16467d = Floats.m16467d(this.array, ((Float) obj).floatValue(), this.start, this.end)) < 0) {
                return -1;
            }
            return iM16467d - this.start;
        }
        ...
        public int lastIndexOf(Object obj) {
            int iM16468e;
            if (!(obj instanceof Float) || (iM16468e = Floats.m16468e(this.array, ((Float) obj).floatValue(), this.start, this.end)) < 0) {
                return -1;
            }
            return iM16468e - this.start;
        }
        ...
        public Float set(int i, Float f) {
            ...
            int i2 = this.start;
            float f2 = fArr[i2 + i];
            fArr[i2 + i] = ((Float) xn80.m212111p(f)).floatValue();
