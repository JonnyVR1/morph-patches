...
public final class Booleans {
    ...
    public enum LexicographicalComparator implements Comparator<boolean[]> {
        ...
        public int compare(boolean[] zArr, boolean[] zArr2) {
            ...
            for (int i = 0; i < iMin; i++) {
                int iM16436c = Booleans.m16436c(zArr[i], zArr2[i]);
                if (iM16436c != 0) {
                    return iM16436c;
                }
            }
    ...
    public static int m16436c(boolean z, boolean z2) {
        if (z == z2) {
            return 0;
        }
        return z ? 1 : -1;
    ...
    public static boolean m16437d(boolean[] zArr, boolean z) {
        for (boolean z2 : zArr) {
            if (z2 == z) {
                return true;
            }
    ...
    public static int m16438e(boolean z) {
        return z ? 1231 : 1237;
    }

    /* JADX INFO: renamed from: f */
    public static int m16439f(boolean[] zArr, boolean z, int i, int i2) {
        while (i < i2) {
            if (zArr[i] == z) {
                return i;
            }
    ...
    public static int m16440g(boolean[] zArr, boolean z, int i, int i2) {
    ...
    public static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Boolean) && Booleans.m16439f(this.array, ((Boolean) obj).booleanValue(), this.start, this.end) != -1;
        }
        ...
        public int hashCode() {
            ...
            for (int i = this.start; i < this.end; i++) {
                iM16438e = (iM16438e * 31) + Booleans.m16438e(this.array[i]);
            }
            return iM16438e;
        }
        ...
        public int indexOf(Object obj) {
            int iM16439f;
            if (!(obj instanceof Boolean) || (iM16439f = Booleans.m16439f(this.array, ((Boolean) obj).booleanValue(), this.start, this.end)) < 0) {
                return -1;
            }
            return iM16439f - this.start;
        }
        ...
        public int lastIndexOf(Object obj) {
            int iM16440g;
            if (!(obj instanceof Boolean) || (iM16440g = Booleans.m16440g(this.array, ((Boolean) obj).booleanValue(), this.start, this.end)) < 0) {
                return -1;
            }
            return iM16440g - this.start;
        }
        ...
        public Boolean set(int i, Boolean bool) {
            ...
            int i2 = this.start;
            boolean z = zArr[i2 + i];
            zArr[i2 + i] = ((Boolean) xn80.m212111p(bool)).booleanValue();
