        ...
        if (i2 >= 13) {
            ...
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    int iHash64k = LZ4Utils.hash64k(SafeUtils.readInt(bArr, i12));
                    i7 = SafeUtils.readShort(sArr, iHash64k) + i8;
                    i5 = i9;
                    SafeUtils.writeShort(sArr, iHash64k, i12 - i8);
                    if (LZ4SafeUtils.readIntEquals(bArr, i7, i12)) {
                        break;
                    }
                    i12 = i17;
                    i9 = i5;
                ...
                int iCommonBytesBackward = LZ4SafeUtils.commonBytesBackward(bArr, i7, i12, i8, i14);
                ...
                if (i22 >= 15) {
                    SafeUtils.writeByte(bArr2, i13, 240);
                    iWriteLen = LZ4SafeUtils.writeLen(i22 - 15, bArr2, iWriteLen);
                } else {
                    SafeUtils.writeByte(bArr2, i13, i22 << 4);
                }
                LZ4SafeUtils.wildArraycopy(bArr, i14, bArr2, iWriteLen, i22);
                int i23 = iWriteLen + i22;
                while (true) {
                    SafeUtils.writeShortLE(bArr2, i23, (short) (i20 - i21));
                    int iWriteLen2 = i23 + 2;
                    int i24 = i20 + 4;
                    int iCommonBytes = LZ4SafeUtils.commonBytes(bArr, i21 + 4, i24, i10);
                    if (i23 + 8 + (iCommonBytes >>> 8) > i4) {
                        throw new LZ4Exception("maxDestLen is too small");
                    }
                    i20 = i24 + iCommonBytes;
                    if (iCommonBytes >= 15) {
                        SafeUtils.writeByte(bArr2, i13, SafeUtils.readByte(bArr2, i13) | 15);
                        iWriteLen2 = LZ4SafeUtils.writeLen(iCommonBytes - 15, bArr2, iWriteLen2);
                    } else {
                        SafeUtils.writeByte(bArr2, i13, iCommonBytes | SafeUtils.readByte(bArr2, i13));
                    }
                    i13 = iWriteLen2;
                    if (i20 > i11) {
                        i8 = i20;
                    ...
                    int i25 = i20 - 2;
                    SafeUtils.writeShort(sArr, LZ4Utils.hash64k(SafeUtils.readInt(bArr, i25)), i25 - i8);
                    int iHash64k2 = LZ4Utils.hash64k(SafeUtils.readInt(bArr, i20));
                    i21 = i8 + SafeUtils.readShort(sArr, iHash64k2);
                    SafeUtils.writeShort(sArr, iHash64k2, i20 - i8);
                    if (!LZ4SafeUtils.readIntEquals(bArr, i20, i21)) {
                        break;
                    }
                    i23 = i13 + 1;
                    SafeUtils.writeByte(bArr2, i13, 0);
                }
                i14 = i20;
                i12 = i20 + 1;
                i9 = i5;
    ...
    public int compress(ByteBuffer byteBuffer, int i, int i2, ByteBuffer byteBuffer2, int i3, int i4) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                i7 = SafeUtils.readInt(iArr, iHash);
                i5 = i10;
                i8 = i14 - i7;
                SafeUtils.writeInt(iArr, iHash, i14);
            ...
            while (true) {
                ...
                int i26 = i21 - 2;
                SafeUtils.writeInt(iArr, LZ4Utils.hash(ByteBufferUtils.readInt(byteBufferInNativeByteOrder, i26)), i26);
                int iHash2 = LZ4Utils.hash(ByteBufferUtils.readInt(byteBufferInNativeByteOrder, i21));
                i22 = SafeUtils.readInt(iArr, iHash2);
                SafeUtils.writeInt(iArr, iHash2, i21);
                i8 = i21 - i22;
            ...
            loop0: while (true) {
                ...
                if (iWriteLen + i22 + 8 + (i22 >>> 8) <= i4) {
                    ...
                    while (true) {
                        ...
                        int i25 = i20 - 2;
                        SafeUtils.writeShort(sArr, LZ4Utils.hash64k(ByteBufferUtils.readInt(byteBuffer, i25)), i25 - i8);
    ...
    public int compress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        loop0: while (true) {
            ...
            while (true) {
                ...
                int iHash = LZ4Utils.hash(SafeUtils.readInt(bArr, i14));
                i7 = SafeUtils.readInt(iArr, iHash);
                i5 = i10;
                i8 = i14 - i7;
                SafeUtils.writeInt(iArr, iHash, i14);
            ...
            if (iWriteLen + i23 + 8 + (i23 >>> 8) <= i9) {
                if (i23 >= 15) {
                    SafeUtils.writeByte(bArr2, i13, 240);
                    iWriteLen = LZ4SafeUtils.writeLen(i23 - 15, bArr2, iWriteLen);
                } else {
                    SafeUtils.writeByte(bArr2, i13, i23 << 4);
                }
                LZ4SafeUtils.wildArraycopy(bArr, i15, bArr2, iWriteLen, i23);
                int i24 = iWriteLen + i23;
                while (true) {
                    SafeUtils.writeShortLE(bArr2, i24, i8);
                    int iWriteLen2 = i24 + 2;
                    int i25 = i21 + 4;
                    ...
                    int i26 = i21 - 2;
                    SafeUtils.writeInt(iArr, LZ4Utils.hash(SafeUtils.readInt(bArr, i26)), i26);
                    int iHash2 = LZ4Utils.hash(SafeUtils.readInt(bArr, i21));
                    i22 = SafeUtils.readInt(iArr, iHash2);
                    SafeUtils.writeInt(iArr, iHash2, i21);
                    i8 = i21 - i22;
        ...
        return LZ4SafeUtils.lastLiterals(bArr, i6, i5 - i6, bArr2, i13, i9) - i3;
    }
}
