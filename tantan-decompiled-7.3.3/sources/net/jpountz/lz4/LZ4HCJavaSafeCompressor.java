...
final class LZ4HCJavaSafeCompressor extends LZ4Compressor {
    ...
    public int compress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        while (iEnd < i8) {
            ...
            if (hashTable2.insertAndFindBestMatch(bArr, iEnd, i9, match3)) {
                ...
                while (true) {
                        ...
                        if (hashTable2.insertAndFindWiderMatch(bArr, match3.end() - 2, match3.start + 1, i9, match3.len, match4)) {
                            ...
                            if (match4.start - match3.start < 3) {
                                ...
                                while (true) {
                                        ...
                                        if (hashTable2.insertAndFindWiderMatch(bArr, match4.end() - 3, match4.start, i9, match4.len, match6)) {
                                            if (match6.start < match3.end() + 3) {
                                                if (match6.start >= match3.end()) {
                                                    ...
                                                    iEncodeSequence2 = LZ4SafeUtils.encodeSequence(bArr, i11, match3.start, match3.ref, match3.len, bArr2, iEncodeSequence2, i7);
                                                ...
                                                iEncodeSequence2 = LZ4SafeUtils.encodeSequence(bArr, i18, match3.start, match3.ref, match3.len, bArr2, i19, i7);
                                    ...
                                    iEncodeSequence = LZ4SafeUtils.encodeSequence(bArr, match3.end(), match4.start, match4.ref, match4.len, bArr2, LZ4SafeUtils.encodeSequence(bArr, i11, match3.start, match3.ref, match3.len, bArr2, i22, i7), i7);
                                    match5 = match;
                                    iEnd = match4.end();
                                }
                            }
                    ...
                    hashTable = hashTable2;
                    i5 = i9;
                    iEncodeSequence = LZ4SafeUtils.encodeSequence(bArr, i11, match3.start, match3.ref, match3.len, bArr2, iEncodeSequence2, i7);
                    iEnd = match3.end();
                    i10 = iEnd;
                    match4 = match4;
                    i9 = i5;
        ...
        return LZ4SafeUtils.lastLiterals(bArr, i10, i6 - i10, bArr2, iEncodeSequence, i7) - i3;
    }
}
