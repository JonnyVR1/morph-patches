...
final class LZ4JavaUnsafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    public int decompress(ByteBuffer byteBuffer, int i, int i2, ByteBuffer byteBuffer2, int i3, int i4) {
        ...
        while (true) {
            ...
            int i19 = i7 - shortLE;
            if (i19 < i3) {
                f7r.m124476a("Malformed input at ", i18);
                return i8;
            }
            int i20 = b & 15;
            if (i20 == 15) {
        ...
        f7r.m124476a("Malformed input at ", i5);
        return i8;
    }
    ...
    public int decompress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        int i13 = i3;
        while (true) {
            byte b = UnsafeUtils.readByte(bArr, i12);
            i5 = i12 + i9;
            i6 = (b & 255) >>> 4;
            if (i6 == 15) {
                byte b2 = -1;
                while (i5 < i10) {
                    int i14 = i5 + 1;
                    byte b3 = UnsafeUtils.readByte(bArr, i5);
                    if (b3 != -1) {
                        b2 = b3;
                        i5 = i14;
                        break;
            ...
            int shortLE = UnsafeUtils.readShortLE(bArr, i8);
            int i16 = i8 + 2;
            int i17 = i7 - shortLE;
            if (i17 < i3) {
                f7r.m124476a("Malformed input at ", i16);
                return 0;
            }
            int i18 = b & 15;
            if (i18 == 15) {
                ...
                while (i16 < i10) {
                    int i19 = i16 + 1;
                    byte b5 = UnsafeUtils.readByte(bArr, i16);
                    if (b5 != -1) {
                        i16 = i19;
                        b4 = b5;
                        break;
            ...
            i13 = i7 + i20;
            if (i13 <= i15) {
                LZ4UnsafeUtils.wildIncrementalCopy(bArr2, i17, i7, i13);
            } else if (i13 <= i11) {
                LZ4UnsafeUtils.safeIncrementalCopy(bArr2, i17, i7, i20);
            } else {
                f7r.m124476a("Malformed input at ", i16);
                return 0;
            }
