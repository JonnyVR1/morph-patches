...
public enum Native {
    ...
    public enum EnumC21951OS {
        ...
        EnumC21951OS(String str, String str2) {
            this.name = str;
    ...
    public static class C21952a implements FilenameFilter {

        /* JADX INFO: renamed from: a */
        private final String f206766a = "liblz4-java-";
    ...
    private static void cleanupOldTempLibs() {
        File[] fileArrListFiles = new File(new File(System.getProperty("java.io.tmpdir")).getAbsolutePath()).listFiles(new C21952a());
    ...
    public static synchronized void load() {
        ...
        synchronized (Native.class) {
            ...
            try {
                ...
                try {
                    try {
                        CreateTempFile = File.createTempFile("liblz4-java-", "." + m222296os().libExtension + ".lck");
                        try {
    ...
    private static EnumC21951OS m222296os() {
        String property = System.getProperty("os.name");
        if (property.contains("Linux")) {
            return EnumC21951OS.LINUX;
        }
        if (property.contains("Mac")) {
            return EnumC21951OS.MAC;
        }
        if (property.contains("Windows")) {
            return EnumC21951OS.WINDOWS;
        }
        if (property.contains("Solaris") || property.contains("SunOS")) {
            return EnumC21951OS.SOLARIS;
        }
        pr3.m173429a("Unsupported operating system: ".concat(property));
        return null;
    }

    private static String resourceName() {
        EnumC21951OS enumC21951OSM222296os = m222296os();
        return "/" + Native.class.getPackage().getName().replace('.', '/') + "/" + enumC21951OSM222296os.name + "/" + arch() + "/liblz4-java." + enumC21951OSM222296os.libExtension;
    }
}
