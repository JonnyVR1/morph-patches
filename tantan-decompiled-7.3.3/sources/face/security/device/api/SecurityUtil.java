...
public class SecurityUtil {
    ...
    public static String m88090cs(Map<String, String> map, String str) throws Exception {
    ...
    private static int m88091dw(String str, String str2) {
        return -1;
    }
    ...
    private static String m88092fd(Date date) {
    ...
    public static String spr(String str, Map<String, String> map, Map<String, String> map2) {
        ...
        map3.put("TimestampKeep", m88092fd(new Date()));
        ...
        if (map2 != null) {
            ...
            if (str2 != null && !str2.isEmpty() && str2.equals("2020-04-25")) {
                map3.put("Timestamp", m88092fd(new Date()));
            }
        }
        try {
            map3.put(RequestParameters.SIGNATURE, m88090cs(map3, "UTF-8"));
