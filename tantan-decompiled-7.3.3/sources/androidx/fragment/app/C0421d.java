...
public class C0421d {
    ...
    public class a implements fg4.InterfaceC16973a {
    ...
    public class b implements Animation.AnimationListener {
        ...
        public final /* synthetic */ C0429l.g f2042c;

        /* JADX INFO: renamed from: d */
        public final /* synthetic */ fg4 f2043d;
        ...
        public class a implements Runnable {
            ...
            public void run() {
                if (b.this.f2041b.getAnimatingAway() != null) {
                    ...
                    b bVar = b.this;
                    bVar.f2042c.mo2614a(bVar.f2041b, bVar.f2043d);
                }
            }
        }

        public b(ViewGroup viewGroup, Fragment fragment, C0429l.g gVar, fg4 fg4Var) {
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        /* JADX INFO: renamed from: d */
        public final /* synthetic */ C0429l.g f2048d;

        /* JADX INFO: renamed from: e */
        public final /* synthetic */ fg4 f2049e;

        public c(ViewGroup viewGroup, View view, Fragment fragment, C0429l.g gVar, fg4 fg4Var) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.f2048d.mo2614a(this.f2047c, this.f2049e);
        }
    }

    /* JADX INFO: renamed from: a */
    public static void m2738a(@NonNull Fragment fragment, @NonNull d dVar, @NonNull C0429l.g gVar) {
        View view = fragment.mView;
        ViewGroup viewGroup = fragment.mContainer;
        viewGroup.startViewTransition(view);
        fg4 fg4Var = new fg4();
        fg4Var.m125478d(new a(fragment));
        gVar.mo2615b(fragment, fg4Var);
        if (dVar.f2050a != null) {
            e eVar = new e(dVar.f2050a, viewGroup, view);
            fragment.setAnimatingAway(fragment.mView);
            eVar.setAnimationListener(new b(viewGroup, fragment, gVar, fg4Var));
            fragment.mView.startAnimation(eVar);
            return;
        }
        Animator animator = dVar.f2051b;
        fragment.setAnimator(animator);
        animator.addListener(new c(viewGroup, view, fragment, gVar, fg4Var));
    ...
    /* JADX INFO: renamed from: b */
    public static d m2739b(@NonNull Context context, @NonNull Fragment fragment, boolean z) {
        Animator animatorLoadAnimator;
        int nextTransition = fragment.getNextTransition();
        int nextAnim = fragment.getNextAnim();
        fragment.setNextAnim(0);
        ViewGroup viewGroup = fragment.mContainer;
        if (viewGroup != null && viewGroup.getTag(udc0.f178518c) != null) {
            fragment.mContainer.setTag(udc0.f178518c, null);
        }
        ...
        if (nextAnim == 0 && nextTransition != 0) {
            nextAnim = m2740c(nextTransition, z);
        }
        if (nextAnim != 0) {
    ...
    @AnimRes
    /* JADX INFO: renamed from: c */
    public static int m2740c(int i, boolean z) {
        if (i == 4097) {
            return z ? f8c0.f97715e : f8c0.f97716f;
        }
        if (i == 4099) {
            return z ? f8c0.f97713c : f8c0.f97714d;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? f8c0.f97711a : f8c0.f97712b;
    }
    ...
    public static class d {
        ...
        public d(Animation animation) {
            ...
            wtq0.m207906a("Animation cannot be null");
            throw null;
        }
        ...
        public d(Animator animator) {
            ...
            wtq0.m207906a("Animator cannot be null");
            throw null;
        }
    }
    ...
    public static class e extends AnimationSet implements Runnable {
        ...
        public boolean getTransformation(long j, @NonNull Transformation transformation) {
            ...
            if (!super.getTransformation(j, transformation)) {
                this.f2054c = true;
                eq50.m121892a(this.f2052a, this);
            }
            return true;
        }
