...
public final class C0418a extends AbstractC0428k implements FragmentManager.InterfaceC0403n {
    ...
    public C0418a(@NonNull FragmentManager fragmentManager) {
        super(fragmentManager.m2584r0(), fragmentManager.m2593u0() != null ? fragmentManager.m2593u0().m175362f().getClassLoader() : null);
        this.f1997v = -1;
        this.f1995t = fragmentManager;
    }

    /* JADX INFO: renamed from: J */
    public static boolean m2694J(AbstractC0428k.a aVar) {
        Fragment fragment = aVar.f2102b;
        return (fragment == null || !fragment.mAdded || fragment.mView == null || fragment.mDetached || fragment.mHidden || !fragment.isPostponed()) ? false : true;
    }

    /* JADX INFO: renamed from: A */
    public int m2695A(boolean z) {
        if (this.f1996u) {
            wtq0.m207906a("commit already called");
            return 0;
        }
        ...
        this.f1996u = true;
        if (this.f2090i) {
            this.f1997v = this.f1995t.m2560j();
        } else {
            this.f1997v = -1;
        }
        this.f1995t.m2533Y(this, z);
        return this.f1997v;
    }

    /* JADX INFO: renamed from: B */
    public void m2696B(String str, PrintWriter printWriter) {
        m2697C(str, printWriter, true);
    }

    /* JADX INFO: renamed from: C */
    public void m2697C(String str, PrintWriter printWriter, boolean z) {
        String str2;
        if (z) {
        ...
        for (int i = 0; i < size; i++) {
            AbstractC0428k.a aVar = this.f2084c.get(i);
            switch (aVar.f2101a) {
                case 0:
                    str2 = "NULL";
                    break;
    ...
    public void m2698D() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (aVar.f2101a) {
                case 1:
                    ...
                    this.f1995t.m2579p1(fragment, false);
                    this.f1995t.m2551g(fragment);
                    break;
                case 2:
                default:
                    pvb.m173939a("Unknown cmd: ", aVar.f2101a);
                    return;
                case 3:
                    fragment.setNextAnim(aVar.f2104d);
                    this.f1995t.m2553g1(fragment);
                    break;
                case 4:
                    fragment.setNextAnim(aVar.f2104d);
                    this.f1995t.m2493D0(fragment);
                    break;
                case 5:
                    fragment.setNextAnim(aVar.f2103c);
                    this.f1995t.m2579p1(fragment, false);
                    this.f1995t.m2594u1(fragment);
                    break;
                case 6:
                    fragment.setNextAnim(aVar.f2104d);
                    this.f1995t.m2601x(fragment);
                    break;
                case 7:
                    fragment.setNextAnim(aVar.f2103c);
                    this.f1995t.m2579p1(fragment, false);
                    this.f1995t.m2566l(fragment);
                    break;
                case 8:
                    this.f1995t.m2588s1(fragment);
                    break;
                case 9:
                    this.f1995t.m2588s1(null);
                    break;
                case 10:
                    this.f1995t.m2585r1(fragment, aVar.f2108h);
                    break;
            }
            if (!this.f2099r && aVar.f2101a != 1 && fragment != null && !FragmentManager.f1881P) {
                this.f1995t.m2518Q0(fragment);
            }
        }
        ...
        fragmentManager.m2520R0(fragmentManager.f1912q, true);
    }

    /* JADX INFO: renamed from: E */
    public void m2699E(boolean z) {
        for (int size = this.f2084c.size() - 1; size >= 0; size--) {
            AbstractC0428k.a aVar = this.f2084c.get(size);
            Fragment fragment = aVar.f2102b;
            if (fragment != null) {
                fragment.setNextTransition(FragmentManager.m2486l1(this.f2089h));
                fragment.setSharedElementNames(this.f2098q, this.f2097p);
            }
            switch (aVar.f2101a) {
                case 1:
                    fragment.setNextAnim(aVar.f2106f);
                    this.f1995t.m2579p1(fragment, true);
                    this.f1995t.m2553g1(fragment);
                    break;
                case 2:
                default:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.f1995t.m2585r1(fragment, aVar.f2107g);
                    break;
            }
    ...
    public Fragment m2700F(ArrayList<Fragment> arrayList, Fragment fragment) {
        ...
        while (i < this.f2084c.size()) {
            ...
            if (i2 == 1) {
                    ...
                    if (fragment4.mContainerId == i3) {
                        if (fragment4 == fragment3) {
                            ...
                            if (fragment4 == fragment2) {
                                this.f2084c.add(i, new AbstractC0428k.a(9, fragment4));
                                i++;
                                fragment2 = null;
                            }
                            AbstractC0428k.a aVar2 = new AbstractC0428k.a(3, fragment4);
                ...
                if (fragment5 == fragment2) {
                    this.f2084c.add(i, new AbstractC0428k.a(9, fragment5));
                    i++;
                    fragment2 = null;
                }
            } else if (i2 == 7) {
                ...
                this.f2084c.add(i, new AbstractC0428k.a(9, fragment2));
                i++;
    ...
    public String m2701G() {
        return this.f2092k;
    }

    /* JADX INFO: renamed from: H */
    public boolean m2702H(int i) {
        int size = this.f2084c.size();
    ...
    public boolean m2703I(ArrayList<C0418a> arrayList, int i, int i2) {
        if (i2 == i) {
            return false;
        }
        int size = this.f2084c.size();
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (i5 != 0 && i5 != i3) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    int size2 = c0418a.f2084c.size();
                    for (int i7 = 0; i7 < size2; i7++) {
                        Fragment fragment2 = c0418a.f2084c.get(i7).f2102b;
    ...
    public boolean m2704K() {
        for (int i = 0; i < this.f2084c.size(); i++) {
            if (m2694J(this.f2084c.get(i))) {
                return true;
            }
        }
        return false;
    ...
    public void m2706M(Fragment.InterfaceC0384k interfaceC0384k) {
        for (int i = 0; i < this.f2084c.size(); i++) {
            AbstractC0428k.a aVar = this.f2084c.get(i);
            if (m2694J(aVar)) {
                aVar.f2102b.setOnStartEnterTransitionListener(interfaceC0384k);
            }
        }
    }
    ...
    public Fragment m2707N(ArrayList<Fragment> arrayList, Fragment fragment) {
        for (int size = this.f2084c.size() - 1; size >= 0; size--) {
            AbstractC0428k.a aVar = this.f2084c.get(size);
            int i = aVar.f2101a;
            if (i == 1) {
    ...
    public boolean mo2636a(@NonNull ArrayList<C0418a> arrayList, @NonNull ArrayList<Boolean> arrayList2) {
        ...
        this.f1995t.m2545e(this);
        return true;
    }

    @Override // androidx.fragment.app.AbstractC0428k
    /* JADX INFO: renamed from: i */
    public int mo2708i() {
        return m2695A(false);
    }
    ...
    public void mo2710k() {
        m2811n();
        this.f1995t.m2539b0(this, false);
    }
    ...
    public AbstractC0428k mo2712m(@NonNull Fragment fragment) {
        ...
        if (fragmentManager == null || fragmentManager == this.f1995t) {
            return super.mo2712m(fragment);
        }
        ec2.m120291a("Cannot detach Fragment attached to a different FragmentManager. Fragment ", fragment);
        return null;
    }
    ...
    public void mo2713o(int i, Fragment fragment, @Nullable String str, int i2) {
        super.mo2713o(i, fragment, str, i2);
    ...
    public AbstractC0428k mo2714p(@NonNull Fragment fragment) {
        FragmentManager fragmentManager = fragment.mFragmentManager;
        if (fragmentManager == null || fragmentManager == this.f1995t) {
            return super.mo2714p(fragment);
        }
        ec2.m120291a("Cannot hide Fragment attached to a different FragmentManager. Fragment ", fragment);
        return null;
    }
    ...
    public AbstractC0428k mo2716r(@NonNull Fragment fragment) {
        FragmentManager fragmentManager = fragment.mFragmentManager;
        if (fragmentManager == null || fragmentManager == this.f1995t) {
            return super.mo2716r(fragment);
        }
        ec2.m120291a("Cannot remove Fragment attached to a different FragmentManager. Fragment ", fragment);
        return null;
    }
    ...
    public AbstractC0428k mo2717w(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager != this.f1995t) {
            yg3.m215829a("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ", this.f1995t);
            return null;
        }
        if (state == Lifecycle.State.INITIALIZED && fragment.mState > -1) {
            v1d0.m199002a("Cannot set maximum Lifecycle to ", state, " after the Fragment has been created");
            return null;
        }
        if (state != Lifecycle.State.DESTROYED) {
            return super.mo2717w(fragment, state);
        }
        v1d0.m199002a("Cannot set maximum Lifecycle to ", state, ". Use remove() to remove the fragment from the FragmentManager and trigger its destruction.");
        return null;
    }
    ...
    public AbstractC0428k mo2718y(@NonNull Fragment fragment) {
        FragmentManager fragmentManager = fragment.mFragmentManager;
        if (fragmentManager == null || fragmentManager == this.f1995t) {
            return super.mo2718y(fragment);
        }
        ec2.m120291a("Cannot show Fragment attached to a different FragmentManager. Fragment ", fragment);
        return null;
    }

    /* JADX INFO: renamed from: z */
    public void m2719z(int i) {
        if (this.f2090i) {
            if (FragmentManager.m2481G0(2)) {
                toString();
            }
            int size = this.f2084c.size();
            for (int i2 = 0; i2 < size; i2++) {
                AbstractC0428k.a aVar = this.f2084c.get(i2);
                Fragment fragment = aVar.f2102b;
                if (fragment != null) {
