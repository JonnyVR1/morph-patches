...
@Deprecated
public abstract class AbstractC0426i extends cf60 {
    ...
    public AbstractC0426i(@NonNull FragmentManager fragmentManager, int i) {
        this.f2074c = null;
    ...
    public void destroyItem(@NonNull ViewGroup viewGroup, int i, @NonNull Object obj) {
        ...
        if (this.f2074c == null) {
            this.f2074c = this.f2072a.m2568m();
        }
        while (true) {
        ...
        arrayList.set(i, fragment.isAdded() ? this.f2072a.m2573n1(fragment) : null);
        this.f2076e.set(i, null);
        this.f2074c.mo2716r(fragment);
    ...
    public void finishUpdate(@NonNull ViewGroup viewGroup) {
        AbstractC0428k abstractC0428k = this.f2074c;
    ...
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int i) {
        ...
        this.f2074c.m2804b(viewGroup.getId(), item);
        if (this.f2073b == 1) {
            this.f2074c.mo2717w(item, Lifecycle.State.STARTED);
        }
        return item;
    }
        ...
        if (parcelable != null) {
            ...
            for (String str : bundle.keySet()) {
                if (str.startsWith("f")) {
                    ...
                    Fragment fragmentM2578p0 = this.f2072a.m2578p0(bundle, str);
                    if (fragmentM2578p0 != null) {
                        while (this.f2076e.size() <= i) {
                            this.f2076e.add(null);
                        }
                        fragmentM2578p0.setMenuVisibility(false);
                        this.f2076e.set(i, fragmentM2578p0);
                    }
                }
            }
        }
    ...
    public Parcelable saveState() {
        ...
        for (int i = 0; i < this.f2076e.size(); i++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.f2072a.m2544d1(bundle, "f" + i, fragment);
            }
        }
        return bundle;
    }
        ...
        if (fragment != fragment2) {
            if (fragment2 != null) {
                ...
                if (this.f2073b == 1) {
                    ...
                    this.f2074c.mo2717w(this.f2077f, Lifecycle.State.STARTED);
                } else {
            ...
            if (this.f2073b == 1) {
                ...
                this.f2074c.mo2717w(fragment, Lifecycle.State.RESUMED);
            } else {
    ...
    @Deprecated
    public AbstractC0426i(@NonNull FragmentManager fragmentManager) {
