...
public class PagerTitleStrip extends ViewGroup {
    ...
    public final C0706a f3223k;

    /* JADX INFO: renamed from: l */
    public WeakReference<cf60> f3224l;
    ...
    public class C0706a extends DataSetObserver implements ViewPager.InterfaceC0718j, ViewPager.InterfaceC0717i {
        ...
        public void onAdapterChanged(ViewPager viewPager, cf60 cf60Var, cf60 cf60Var2) {
            PagerTitleStrip.this.m4146b(cf60Var, cf60Var2);
        }

        @Override // android.database.DataSetObserver
        public void onChanged() {
            PagerTitleStrip pagerTitleStrip = PagerTitleStrip.this;
            pagerTitleStrip.m4147c(pagerTitleStrip.f3213a.getCurrentItem(), PagerTitleStrip.this.f3213a.getAdapter());
            PagerTitleStrip pagerTitleStrip2 = PagerTitleStrip.this;
            float f = pagerTitleStrip2.f3218f;
            if (f < 0.0f) {
                f = 0.0f;
            }
            pagerTitleStrip2.mo4144d(pagerTitleStrip2.f3213a.getCurrentItem(), f, true);
        }
        ...
        public void onPageScrolled(int i, float f, int i2) {
            ...
            PagerTitleStrip.this.mo4144d(i, f, false);
        }
    ...
    public static class C0707b extends SingleLineTransformationMethod {
    ...
    public PagerTitleStrip(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            msi0.m159817o(this.f3214b, resourceId);
            msi0.m159817o(this.f3215c, resourceId);
            msi0.m159817o(this.f3216d, resourceId);
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(1, 0);
        if (dimensionPixelSize != 0) {
            m4145a(0, dimensionPixelSize);
        }
    ...
    private static void setSingleLineAllCaps(TextView textView) {
        textView.setTransformationMethod(new C0707b(textView.getContext()));
    }

    /* JADX INFO: renamed from: a */
    public void m4145a(int i, float f) {
    ...
    /* JADX INFO: renamed from: b */
    public void m4146b(cf60 cf60Var, cf60 cf60Var2) {
        if (cf60Var != null) {
            cf60Var.unregisterDataSetObserver(this.f3223k);
            this.f3224l = null;
        }
        if (cf60Var2 != null) {
            cf60Var2.registerDataSetObserver(this.f3223k);
            this.f3224l = new WeakReference<>(cf60Var2);
        }
        ViewPager viewPager = this.f3213a;
        if (viewPager != null) {
            this.f3217e = -1;
            this.f3218f = -1.0f;
            m4147c(viewPager.getCurrentItem(), cf60Var2);
            requestLayout();
        }
    }

    /* JADX INFO: renamed from: c */
    public void m4147c(int i, cf60 cf60Var) {
        int count = cf60Var != null ? cf60Var.getCount() : 0;
        this.f3221i = true;
        CharSequence pageTitle = null;
        this.f3214b.setText((i < 1 || cf60Var == null) ? null : cf60Var.getPageTitle(i - 1));
        this.f3215c.setText((cf60Var == null || i >= count) ? null : cf60Var.getPageTitle(i));
        int i2 = i + 1;
        if (i2 < count && cf60Var != null) {
            pageTitle = cf60Var.getPageTitle(i2);
        }
        ...
        this.f3217e = i;
        if (!this.f3222j) {
            mo4144d(i, this.f3218f, false);
        }
        this.f3221i = false;
    }

    /* JADX INFO: renamed from: d */
    public void mo4144d(int i, float f, boolean z) {
        int i2;
        int i3;
        int i4;
        int i5;
        if (i != this.f3217e) {
            m4147c(i, this.f3213a.getAdapter());
    ...
    public void onAttachedToWindow() {
        ...
        if (!(parent instanceof ViewPager)) {
            wtq0.m207906a("PagerTitleStrip must be a direct child of a ViewPager.");
            return;
        }
        ViewPager viewPager = (ViewPager) parent;
        cf60 adapter = viewPager.getAdapter();
        viewPager.m4181W(this.f3223k);
        viewPager.m4186c(this.f3223k);
        this.f3213a = viewPager;
        WeakReference<cf60> weakReference = this.f3224l;
        m4146b(weakReference != null ? weakReference.get() : null, adapter);
    }
    ...
    public void onDetachedFromWindow() {
        ...
        ViewPager viewPager = this.f3213a;
        if (viewPager != null) {
            m4146b(viewPager.getAdapter(), null);
            this.f3213a.m4181W(null);
            this.f3213a.m4176O(this.f3223k);
            this.f3213a = null;
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            wtq0.m207906a("Must measure with an exact width");
            return;
        }
