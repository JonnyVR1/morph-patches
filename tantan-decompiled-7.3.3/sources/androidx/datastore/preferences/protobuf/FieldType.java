...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C0292a.f1566a[collection.ordinal()];
        if (i4 == 1 || i4 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C0292a.f1567b[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : true;
    }
    ...
    private static Type getListParameter(Class<?> cls, Type[] typeArr) {
        while (true) {
            ...
            if (cls == List.class) {
                ...
                azk0.m101074a("Unable to identify parameter type for List<T>");
                return null;
            }
                ...
                for (int i2 = 0; i2 < actualTypeArguments.length; i2++) {
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        if (typeArr.length != typeParameters.length) {
                            azk0.m101074a("Type array mismatch");
                            return null;
                        }
                        int i3 = 0;
                        while (true) {
                            if (i3 >= typeParameters.length) {
                                mce.m157919a("Unable to find replacement for ", type);
                                return null;
                            }
