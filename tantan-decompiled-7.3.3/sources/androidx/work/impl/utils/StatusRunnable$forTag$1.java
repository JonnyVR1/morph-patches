...
final class StatusRunnable$forTag$1 extends Lambda implements Function1<WorkDatabase, List<? extends WorkInfo>> {
    ...
    public final List<WorkInfo> invoke(WorkDatabase workDatabase) {
        ...
        List<WorkInfo> listApply = mjq0.f137114z.apply(workDatabase.workSpecDao().mo163433E(this.$tag));
        listApply.getClass();
        return listApply;
    }
}
