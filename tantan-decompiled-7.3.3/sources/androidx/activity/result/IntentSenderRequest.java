...
public final class IntentSenderRequest implements Parcelable {
    ...
    @NonNull
    public static final Parcelable.Creator<IntentSenderRequest> CREATOR = new C0054a();
    ...
    public class C0054a implements Parcelable.Creator<IntentSenderRequest> {
    ...
    public static final class C0055b {
        ...
        public C0055b(@NonNull PendingIntent pendingIntent) {
            this(pendingIntent.getIntentSender());
        }

        @NonNull
        /* JADX INFO: renamed from: a */
        public IntentSenderRequest m227a() {
            return new IntentSenderRequest(this.f97a, this.f98b, this.f99c, this.f100d);
        }

        @NonNull
        /* JADX INFO: renamed from: b */
        public C0055b m228b(@Nullable Intent intent) {
            this.f98b = intent;
            return this;
        }
        ...
        @NonNull
        /* JADX INFO: renamed from: c */
        public C0055b m229c(int i, int i2) {
            this.f100d = i;
            this.f99c = i2;
            return this;
        }

        public C0055b(@NonNull IntentSender intentSender) {
