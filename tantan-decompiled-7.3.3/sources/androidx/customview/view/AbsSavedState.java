...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new C0265a();

    /* JADX INFO: renamed from: androidx.customview.view.AbsSavedState$a */
    public static class C0265a implements Parcelable.ClassLoaderCreator<AbsSavedState> {
        ...
        public AbsSavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
            ...
            wtq0.m207906a("superState must be null");
            return null;
        }
    ...
    public AbsSavedState(@NonNull Parcelable parcelable) {
        if (parcelable != null) {
            ...
            wg3.m206174a("superState must not be null");
            throw null;
        }
    }
