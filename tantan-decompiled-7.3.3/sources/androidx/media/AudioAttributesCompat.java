...
public class AudioAttributesCompat implements t9l0 {
    ...
    /* JADX INFO: renamed from: a */
    public static int m3125a(boolean z, int i, int i2) {
        if ((i & 1) == 1) {
            return z ? 1 : 7;
        }
        if ((i & 4) == 4) {
        ...
        switch (i2) {
            ...
            default:
                ...
                i2r0.m138234a("Unknown usage value ", i2, " in audio attributes");
                return 0;
        }
    }

    /* JADX INFO: renamed from: b */
    public static String m3126b(int i) {
        switch (i) {
            case 0:
    ...
    @Nullable
    /* JADX INFO: renamed from: c */
    public static AudioAttributesCompat m3127c(@NonNull Object obj) {
        if (f2382c) {
            return null;
        }
