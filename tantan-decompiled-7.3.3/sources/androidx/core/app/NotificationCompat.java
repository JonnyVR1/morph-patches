...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            int i = 0;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, wec0.f188687c, false);
            remoteViewsApplyStandardTemplate.removeAllViews(kdc0.f125173L);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(kdc0.f125173L, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(kdc0.f125173L, i);
            remoteViewsApplyStandardTemplate.setViewVisibility(kdc0.f125170I, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? wec0.f188686b : wec0.f188685a);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(kdc0.f125171J, createColoredBitmap(iconCompat, s9c0.f166927c));
            }
            remoteViews.setTextViewText(kdc0.f125172K, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(kdc0.f125169H, action.actionIntent);
            }
            remoteViews.setContentDescription(kdc0.f125169H, action.title);
            return remoteViews;
        }
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public void apply(ny40 ny40Var) {
            ny40Var.mo1212a().setStyle(Api24Impl.createDecoratedCustomViewStyle());
        }
        ...
        @Override // androidx.core.app.NotificationCompat.Style
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public RemoteViews makeBigContentView(ny40 ny40Var) {
            return null;
        }

        @Override // androidx.core.app.NotificationCompat.Style
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public RemoteViews makeContentView(ny40 ny40Var) {
            return null;
        }

        @Override // androidx.core.app.NotificationCompat.Style
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public RemoteViews makeHeadsUpContentView(ny40 ny40Var) {
            return null;
        }
    }
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            wyc0[] wyc0VarArr2 = new wyc0[remoteInputs.length];
            for (int i2 = 0; i2 < remoteInputs.length; i2++) {
                RemoteInput remoteInput = remoteInputs[i2];
                wyc0VarArr2[i2] = new wyc0(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, Api20Impl.getExtras(remoteInput), null);
            }
            wyc0VarArr = wyc0VarArr2;
        }
        ...
        if (Api23Impl.getIcon(action) != null || (i = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.m1291d(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), wyc0VarArr, (wyc0[]) null, z, semanticAction, z2, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(i, action.title, action.actionIntent, Api20Impl.getExtras(action), wyc0VarArr, (wyc0[]) null, z, semanticAction, z2, zIsContextual, zIsAuthenticationRequired);
    }
    ...
    public static List<Action> getInvisibleActions(@NonNull Notification notification) {
        ...
        if (bundle2 != null && (bundle = bundle2.getBundle("invisible_actions")) != null) {
            for (int i = 0; i < bundle.size(); i++) {
                arrayList.add(C0245b.m1258c(bundle.getBundle(Integer.toString(i))));
            }
        }
        return arrayList;
    }
    ...
    @Nullable
    public static jyv getLocusId(@NonNull Notification notification) {
        LocusId locusId;
        if (Build.VERSION.SDK_INT < 29 || (locusId = Api29Impl.getLocusId(notification)) == null) {
            return null;
        }
        return jyv.m147624c(locusId);
    }
    ...
    @NonNull
    public static List<C0246c> getPeople(@NonNull Notification notification) {
        ArrayList arrayList = new ArrayList();
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(C0246c.m1263a(mz40.m160894a(it.next())));
                }
            }
        } else {
            ...
            if (stringArray != null && stringArray.length != 0) {
                for (String str : stringArray) {
                    arrayList.add(new C0246c.b().m1282g(str).m1276a());
                }
            }
        }
        return arrayList;
    ...
    public static Bitmap reduceLargeIconSize(@NonNull Context context, @Nullable Bitmap bitmap) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(oac0.f145680b);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(oac0.f145679a);
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(@Nullable Parcelable parcelable) {
            ...
            if (parcelable instanceof Icon) {
                return IconCompat.m1290c((Icon) parcelable);
            }
            if (parcelable instanceof Bitmap) {
                return IconCompat.m1295h((Bitmap) parcelable);
            }
            return null;
        }
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public void apply(ny40 ny40Var) {
            Notification.BigPictureStyle bigContentTitle = new Notification.BigPictureStyle(ny40Var.mo1212a()).setBigContentTitle(this.mBigContentTitle);
            IconCompat iconCompat = this.mPictureIcon;
            if (iconCompat != null) {
                if (Build.VERSION.SDK_INT >= 31) {
                    Api31Impl.setBigPicture(bigContentTitle, this.mPictureIcon.m1314y(ny40Var instanceof C0244a ? ((C0244a) ny40Var).m1216f() : null));
                } else if (iconCompat.m1306q() == 1) {
                    bigContentTitle = bigContentTitle.bigPicture(this.mPictureIcon.m1303m());
                }
            }
            if (this.mBigLargeIconSet) {
                if (this.mBigLargeIcon == null) {
                    ...
                    Api23Impl.setBigLargeIcon(bigContentTitle, this.mBigLargeIcon.m1314y(ny40Var instanceof C0244a ? ((C0244a) ny40Var).m1216f() : null));
                }
            }
        ...
        public BigPictureStyle bigLargeIcon(@Nullable Bitmap bitmap) {
            this.mBigLargeIcon = bitmap == null ? null : IconCompat.m1295h(bitmap);
        ...
        public BigPictureStyle bigPicture(@Nullable Bitmap bitmap) {
            this.mPictureIcon = bitmap == null ? null : IconCompat.m1295h(bitmap);
            return this;
        }
        ...
        public BigPictureStyle bigPicture(@Nullable Icon icon) {
            this.mPictureIcon = IconCompat.m1290c(icon);
            return this;
        }
        ...
        public BigPictureStyle bigLargeIcon(@Nullable Icon icon) {
            this.mBigLargeIcon = icon == null ? null : IconCompat.m1290c(icon);
            this.mBigLargeIconSet = true;
            return this;
        }
    }
    ...
    public static class BigTextStyle extends Style {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public void apply(ny40 ny40Var) {
            Notification.BigTextStyle bigTextStyleBigText = new Notification.BigTextStyle(ny40Var.mo1212a()).setBigContentTitle(this.mBigContentTitle).bigText(this.mBigText);
            if (this.mSummaryTextSet) {
    ...
    public static class Builder {
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public ArrayList<C0246c> mPersonList;
        int mPriority;
        int mProgress;
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (largeIcon != null) {
                this.mLargeIcon = IconCompat.m1290c(largeIcon);
            }
            Notification.Action[] actionArr = notification.actions;
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(C0246c.m1263a(mz40.m160894a(it2.next())));
                }
            }
        ...
        public RemoteViews createBigContentView() {
            ...
            Style style = this.mStyle;
            return (style == null || (remoteViewsMakeBigContentView = style.makeBigContentView(c0244a)) == null) ? Api24Impl.createBigContentView(Api24Impl.recoverBuilder(this.mContext, c0244a.m1214c())) : remoteViewsMakeBigContentView;
        }
        ...
        public RemoteViews createContentView() {
            ...
            C0244a c0244a = new C0244a(this);
            Style style = this.mStyle;
            return (style == null || (remoteViewsMakeContentView = style.makeContentView(c0244a)) == null) ? Api24Impl.createContentView(Api24Impl.recoverBuilder(this.mContext, c0244a.m1214c())) : remoteViewsMakeContentView;
        }
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            C0244a c0244a = new C0244a(this);
            Style style = this.mStyle;
            return (style == null || (remoteViewsMakeHeadsUpContentView = style.makeHeadsUpContentView(c0244a)) == null) ? Api24Impl.createHeadsUpContentView(Api24Impl.recoverBuilder(this.mContext, c0244a.m1214c())) : remoteViewsMakeHeadsUpContentView;
        }
        ...
        public Builder setLargeIcon(@Nullable Bitmap bitmap) {
            this.mLargeIcon = bitmap == null ? null : IconCompat.m1295h(NotificationCompat.reduceLargeIconSize(this.mContext, bitmap));
            return this;
        }
        ...
        @NonNull
        public Builder setLocusId(@Nullable jyv jyvVar) {
            this.mLocusId = jyvVar;
            return this;
        }
        ...
        public Builder setSmallIcon(@NonNull IconCompat iconCompat) {
            this.mSmallIcon = iconCompat.m1314y(this.mContext);
            return this;
        }
        ...
        @NonNull
        public Builder addPerson(@Nullable C0246c c0246c) {
            if (c0246c != null) {
                this.mPersonList.add(c0246c);
            }
            return this;
        }
        ...
        public Builder setLargeIcon(@Nullable Icon icon) {
            this.mLargeIcon = icon == null ? null : IconCompat.m1290c(icon);
            return this;
        }

        @NonNull
        public Builder setShortcutInfo(@Nullable c7f0 c7f0Var) {
            return this;
        }
    ...
    public static class CallStyle extends Style {
        ...
        private CallStyle(int i, @NonNull C0246c c0246c, @Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable PendingIntent pendingIntent3) {
            if (c0246c == null || TextUtils.isEmpty(c0246c.m1267e())) {
                wg3.m206174a("person must have a non-empty a name");
                throw null;
            }
            this.mCallType = i;
            this.mPerson = c0246c;
        ...
        @NonNull
        public static CallStyle forIncomingCall(@NonNull C0246c c0246c, @NonNull PendingIntent pendingIntent, @NonNull PendingIntent pendingIntent2) {
            Objects.requireNonNull(pendingIntent, "declineIntent is required");
            Objects.requireNonNull(pendingIntent2, "answerIntent is required");
            return new CallStyle(1, c0246c, null, pendingIntent, pendingIntent2);
        }

        @NonNull
        public static CallStyle forOngoingCall(@NonNull C0246c c0246c, @NonNull PendingIntent pendingIntent) {
            Objects.requireNonNull(pendingIntent, "hangUpIntent is required");
            return new CallStyle(2, c0246c, pendingIntent, null, null);
        }

        @NonNull
        public static CallStyle forScreeningCall(@NonNull C0246c c0246c, @NonNull PendingIntent pendingIntent, @NonNull PendingIntent pendingIntent2) {
            Objects.requireNonNull(pendingIntent, "hangUpIntent is required");
            Objects.requireNonNull(pendingIntent2, "answerIntent is required");
            return new CallStyle(3, c0246c, pendingIntent, null, pendingIntent2);
        }
        ...
        private Action makeAction(int i, int i2, Integer num, int i3, PendingIntent pendingIntent) {
            if (num == null) {
                num = Integer.valueOf(j26.m143190c(this.mBuilder.mContext, i3));
            }
            ...
            Action actionBuild = new Action.Builder(IconCompat.m1298k(this.mBuilder.mContext, i), spannableStringBuilder, pendingIntent).build();
        ...
        private Action makeAnswerAction() {
            int i = vbc0.f183223b;
            int i2 = vbc0.f183222a;
            PendingIntent pendingIntent = this.mAnswerIntent;
            if (pendingIntent == null) {
                return null;
            }
            boolean z = this.mIsVideo;
            return makeAction(z ? i : i2, z ? R$string.f1393b : R$string.f1392a, this.mAnswerButtonColor, s9c0.f166925a, pendingIntent);
        }
        ...
        private Action makeNegativeAction() {
            ...
            return pendingIntent == null ? makeAction(i, R$string.f1395d, num, s9c0.f166926b, this.mHangUpIntent) : makeAction(i, R$string.f1394c, num, s9c0.f166926b, pendingIntent);
        }
        ...
        public void addCompatExtras(@NonNull Bundle bundle) {
            ...
            C0246c c0246c = this.mPerson;
            if (c0246c != null) {
                if (Build.VERSION.SDK_INT >= 28) {
                    bundle.putParcelable(NotificationCompat.EXTRA_CALL_PERSON, Api28Impl.castToParcelable(c0246c.m1272j()));
                } else {
                    bundle.putParcelable(NotificationCompat.EXTRA_CALL_PERSON_COMPAT, c0246c.m1273k());
                }
            }
            IconCompat iconCompat = this.mVerificationIcon;
            if (iconCompat != null) {
                bundle.putParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON, Api23Impl.castToParcelable(iconCompat.m1314y(this.mBuilder.mContext)));
            }
        ...
        public void apply(ny40 ny40Var) {
            ...
            defaultText = null;
            if (i < 31) {
                Notification.Builder builderMo1212a = ny40Var.mo1212a();
                C0246c c0246c = this.mPerson;
                builderMo1212a.setContentTitle(c0246c != null ? c0246c.m1267e() : null);
                ...
                builderMo1212a.setContentText(defaultText);
                C0246c c0246c2 = this.mPerson;
                if (c0246c2 != null) {
                    if (c0246c2.m1265c() != null) {
                        Api23Impl.setLargeIcon(builderMo1212a, this.mPerson.m1265c().m1314y(this.mBuilder.mContext));
                    }
                    C0246c c0246c3 = this.mPerson;
                    if (i >= 28) {
                        Api28Impl.addPerson(builderMo1212a, c0246c3.m1272j());
                    } else {
                        Api21Impl.addPerson(builderMo1212a, c0246c3.m1268f());
                    }
                }
                Api21Impl.setCategory(builderMo1212a, "call");
                return;
            }
            int i2 = this.mCallType;
            if (i2 == 1) {
                callStyleForIncomingCall = Api31Impl.forIncomingCall(this.mPerson.m1272j(), this.mDeclineIntent, this.mAnswerIntent);
            } else if (i2 == 2) {
                callStyleForIncomingCall = Api31Impl.forOngoingCall(this.mPerson.m1272j(), this.mHangUpIntent);
            } else if (i2 == 3) {
                callStyleForIncomingCall = Api31Impl.forScreeningCall(this.mPerson.m1272j(), this.mHangUpIntent, this.mAnswerIntent);
            } else if (Log.isLoggable(NotificationCompat.TAG, 3)) {
                String.valueOf(this.mCallType);
            }
            if (callStyleForIncomingCall != null) {
                callStyleForIncomingCall.setBuilder(ny40Var.mo1212a());
                Integer num = this.mAnswerButtonColor;
                if (num != null) {
                ...
                IconCompat iconCompat = this.mVerificationIcon;
                if (iconCompat != null) {
                    Api31Impl.setVerificationIcon(callStyleForIncomingCall, iconCompat.m1314y(this.mBuilder.mContext));
                }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = C0246c.m1263a(mz40.m160894a(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            } else if (bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON_COMPAT)) {
                this.mPerson = C0246c.m1264b(bundle.getBundle(NotificationCompat.EXTRA_CALL_PERSON_COMPAT));
            }
            if (bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.m1290c((Icon) bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON));
            } else if (bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON_COMPAT)) {
                this.mVerificationIcon = IconCompat.m1289b(bundle.getBundle(NotificationCompat.EXTRA_VERIFICATION_ICON_COMPAT));
            }
        ...
        public CallStyle setVerificationIcon(@Nullable Icon icon) {
            this.mVerificationIcon = icon == null ? null : IconCompat.m1290c(icon);
            return this;
        }
        ...
        public CallStyle setVerificationIcon(@Nullable Bitmap bitmap) {
            this.mVerificationIcon = IconCompat.m1295h(bitmap);
            return this;
        }
    ...
    public static class InboxStyle extends Style {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public void apply(ny40 ny40Var) {
            Notification.InboxStyle bigContentTitle = new Notification.InboxStyle(ny40Var.mo1212a()).setBigContentTitle(this.mBigContentTitle);
            if (this.mSummaryTextSet) {
                bigContentTitle.setSummaryText(this.mSummaryText);
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        public MessagingStyle(@NonNull C0246c c0246c) {
            if (TextUtils.isEmpty(c0246c.m1267e())) {
                wg3.m206174a("User's name must not be empty.");
                throw null;
            }
            this.mUser = c0246c;
        }
        ...
        private Message findLatestIncomingMessage() {
            ...
            while (true) {
                ...
                if (message.getPerson() != null && !TextUtils.isEmpty(message.getPerson().m1267e())) {
                    return message;
                }
            }
        }
        ...
        private boolean hasMessagesWithoutSender() {
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                ...
                if (message.getPerson() != null && message.getPerson().m1267e() == null) {
                    return true;
                }
            }
            return false;
        ...
        private CharSequence makeMessageLine(@NonNull Message message) {
            lx2 lx2VarM156132c = lx2.m156132c();
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            CharSequence charSequenceM1267e = message.getPerson() == null ? "" : message.getPerson().m1267e();
            boolean zIsEmpty = TextUtils.isEmpty(charSequenceM1267e);
            int color = RoundedDrawable.DEFAULT_BORDER_COLOR;
            if (zIsEmpty) {
                charSequenceM1267e = this.mUser.m1267e();
                if (this.mBuilder.getColor() != 0) {
                    color = this.mBuilder.getColor();
                }
            }
            CharSequence charSequenceM156137h = lx2VarM156132c.m156137h(charSequenceM1267e);
            spannableStringBuilder.append(charSequenceM156137h);
            spannableStringBuilder.setSpan(makeFontColorSpan(color), spannableStringBuilder.length() - charSequenceM156137h.length(), spannableStringBuilder.length(), 33);
            spannableStringBuilder.append((CharSequence) "  ").append(lx2VarM156132c.m156137h(message.getText() != null ? message.getText() : ""));
        ...
        public void addCompatExtras(@NonNull Bundle bundle) {
            super.addCompatExtras(bundle);
            bundle.putCharSequence(NotificationCompat.EXTRA_SELF_DISPLAY_NAME, this.mUser.m1267e());
            bundle.putBundle(NotificationCompat.EXTRA_MESSAGING_STYLE_USER, this.mUser.m1273k());
        ...
        public MessagingStyle addMessage(@Nullable CharSequence charSequence, long j, @Nullable CharSequence charSequence2) {
            this.mMessages.add(new Message(charSequence, j, new C0246c.b().m1281f(charSequence2).m1276a()));
        ...
        public void apply(ny40 ny40Var) {
            ...
            int i = Build.VERSION.SDK_INT;
            C0246c c0246c = this.mUser;
            Notification.MessagingStyle messagingStyleCreateMessagingStyle = i >= 28 ? Api28Impl.createMessagingStyle(c0246c.m1272j()) : Api24Impl.createMessagingStyle(c0246c.m1267e());
            ...
            messagingStyleCreateMessagingStyle.setBuilder(ny40Var.mo1212a());
        }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (bundle.containsKey(NotificationCompat.EXTRA_MESSAGING_STYLE_USER)) {
                this.mUser = C0246c.m1264b(bundle.getBundle(NotificationCompat.EXTRA_MESSAGING_STYLE_USER));
            } else {
                this.mUser = new C0246c.b().m1281f(bundle.getString(NotificationCompat.EXTRA_SELF_DISPLAY_NAME)).m1276a();
            }
        ...
        public static final class Message {
            ...
            public Message(@Nullable CharSequence charSequence, long j, @Nullable C0246c c0246c) {
                this.mExtras = new Bundle();
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            c0246cM1276a = C0246c.m1264b(bundle.getBundle(KEY_PERSON));
                        } else if (!bundle.containsKey(KEY_NOTIFICATION_PERSON) || Build.VERSION.SDK_INT < 28) {
                            c0246cM1276a = bundle.containsKey("sender") ? new C0246c.b().m1281f(bundle.getCharSequence("sender")).m1276a() : null;
                        } else {
                            c0246cM1276a = C0246c.m1263a(mz40.m160894a(bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        }
                        Message message = new Message(bundle.getCharSequence("text"), bundle.getLong(KEY_TIMESTAMP), c0246cM1276a);
            ...
            private Bundle toBundle() {
                ...
                C0246c c0246c = this.mPerson;
                if (c0246c != null) {
                    bundle.putCharSequence("sender", c0246c.m1267e());
                    int i = Build.VERSION.SDK_INT;
                    C0246c c0246c2 = this.mPerson;
                    if (i >= 28) {
                        bundle.putParcelable(KEY_NOTIFICATION_PERSON, Api28Impl.castToParcelable(c0246c2.m1272j()));
                    } else {
                        bundle.putBundle(KEY_PERSON, c0246c2.m1273k());
                    }
                }
            ...
            public Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                C0246c person = getPerson();
                if (Build.VERSION.SDK_INT >= 28) {
                    messageCreateMessage = Api28Impl.createMessage(getText(), getTimestamp(), person != null ? person.m1272j() : null);
                } else {
                    messageCreateMessage = Api24Impl.createMessage(getText(), getTimestamp(), person != null ? person.m1267e() : null);
                }
            ...
            public Message(@Nullable CharSequence charSequence, long j, @Nullable CharSequence charSequence2) {
                this(charSequence, j, new C0246c.b().m1281f(charSequence2).m1276a());
            }
        }

        @Deprecated
        public MessagingStyle(@NonNull CharSequence charSequence) {
            this.mUser = new C0246c.b().m1281f(charSequence).m1276a();
        }

        @NonNull
        public MessagingStyle addMessage(@Nullable CharSequence charSequence, long j, @Nullable C0246c c0246c) {
            addMessage(new Message(charSequence, j, c0246c));
            return this;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(oac0.f145687i);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(oac0.f145688j);
        ...
        private Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i, int i2) {
            Drawable drawableM1309t = iconCompat.m1309t(this.mBuilder.mContext);
            int intrinsicWidth = i2 == 0 ? drawableM1309t.getIntrinsicWidth() : i2;
            if (i2 == 0) {
                i2 = drawableM1309t.getIntrinsicHeight();
            }
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(intrinsicWidth, i2, Bitmap.Config.ARGB_8888);
            drawableM1309t.setBounds(0, 0, intrinsicWidth, i2);
            if (i != 0) {
                drawableM1309t.mutate().setColorFilter(new PorterDuffColorFilter(i, PorterDuff.Mode.SRC_IN));
            }
            drawableM1309t.draw(new Canvas(bitmapCreateBitmap));
            return bitmapCreateBitmap;
        }

        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = vbc0.f183225d;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(kdc0.f125205i0, 8);
            remoteViews.setViewVisibility(kdc0.f125201g0, 8);
            remoteViews.setViewVisibility(kdc0.f125199f0, 8);
        }
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (builder.mLargeIcon != null) {
                remoteViews.setViewVisibility(kdc0.f125175N, 0);
                remoteViews.setImageViewBitmap(kdc0.f125175N, createColoredBitmap(this.mBuilder.mLargeIcon, 0));
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(oac0.f145683e);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(oac0.f145684f) * 2);
                    Builder builder2 = this.mBuilder;
                    remoteViews.setImageViewBitmap(kdc0.f125181T, createIconWithBackground(builder2.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, builder2.getColor()));
                    remoteViews.setViewVisibility(kdc0.f125181T, 0);
                }
            } else if (z && builder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(kdc0.f125175N, 0);
                int dimensionPixelSize3 = resources.getDimensionPixelSize(oac0.f145682d) - resources.getDimensionPixelSize(oac0.f145681c);
                int dimensionPixelSize4 = resources.getDimensionPixelSize(oac0.f145685g);
                Builder builder3 = this.mBuilder;
                remoteViews.setImageViewBitmap(kdc0.f125175N, createIconWithBackground(builder3.mNotification.icon, dimensionPixelSize3, dimensionPixelSize4, builder3.getColor()));
            }
            CharSequence charSequence3 = this.mBuilder.mContentTitle;
            if (charSequence3 != null) {
                remoteViews.setTextViewText(kdc0.f125205i0, charSequence3);
            }
            CharSequence charSequence4 = this.mBuilder.mContentText;
            boolean z6 = true;
            if (charSequence4 != null) {
                remoteViews.setTextViewText(kdc0.f125199f0, charSequence4);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (charSequence5 == null) {
                if (builder4.mNumber > 0) {
                    if (this.mBuilder.mNumber > resources.getInteger(aec0.f70783a)) {
                        remoteViews.setTextViewText(kdc0.f125176O, resources.getString(R$string.f1399h));
                    } else {
                        remoteViews.setTextViewText(kdc0.f125176O, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                    }
                    remoteViews.setViewVisibility(kdc0.f125176O, 0);
                } else {
                    remoteViews.setViewVisibility(kdc0.f125176O, 8);
                    z4 = false;
                }
                charSequence = this.mBuilder.mSubText;
                if (charSequence != null) {
                    remoteViews.setTextViewText(kdc0.f125199f0, charSequence);
                    charSequence2 = this.mBuilder.mContentText;
                    if (charSequence2 != null) {
                        remoteViews.setTextViewText(kdc0.f125201g0, charSequence2);
                        remoteViews.setViewVisibility(kdc0.f125201g0, 0);
                        if (z2) {
                            remoteViews.setTextViewTextSize(kdc0.f125199f0, 0, resources.getDimensionPixelSize(oac0.f145686h));
                        }
                        remoteViews.setViewPadding(kdc0.f125177P, 0, 0, 0, 0);
                    } else {
                        remoteViews.setViewVisibility(kdc0.f125201g0, 8);
                    }
                }
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    ...
                    remoteViews.setViewVisibility(kdc0.f125174M, 0);
                    remoteViews.setLong(kdc0.f125174M, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    remoteViews.setBoolean(kdc0.f125174M, "setStarted", true);
                    z5 = this.mBuilder.mChronometerCountDown;
                    if (z5) {
                        Api24Impl.setChronometerCountDown(remoteViews, kdc0.f125174M, z5);
                    }
                } else {
                    remoteViews.setViewVisibility(kdc0.f125203h0, 0);
                    remoteViews.setLong(kdc0.f125203h0, "setTime", this.mBuilder.getWhenIfShowing());
                }
                int i3 = kdc0.f125182U;
                if (z6) {
                    i2 = 0;
                } else {
                    i2 = 8;
                ...
                remoteViews.setViewVisibility(kdc0.f125178Q, z3 ? 0 : 8);
                return remoteViews;
            }
            remoteViews.setTextViewText(kdc0.f125176O, charSequence5);
            remoteViews.setViewVisibility(kdc0.f125176O, 0);
            z3 = true;
            z4 = true;
            charSequence = this.mBuilder.mSubText;
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(kdc0.f125179R);
            remoteViews.addView(kdc0.f125179R, remoteViews2.clone());
            remoteViews.setViewVisibility(kdc0.f125179R, 0);
            remoteViews.setViewPadding(kdc0.f125180S, 0, calculateTopPadding(), 0, 0);
        }
        ...
        private Bitmap createColoredBitmap(int i, int i2, int i3) {
            return createColoredBitmap(IconCompat.m1298k(this.mBuilder.mContext, i), i2, i3);
        }
    ...
    public static final class BubbleMetadata {
        ...
        public static class Api29Impl {
            ...
            public static BubbleMetadata fromPlatform(@Nullable Notification.BubbleMetadata bubbleMetadata) {
                ...
                Builder suppressNotification = new Builder(bubbleMetadata.getIntent(), IconCompat.m1290c(bubbleMetadata.getIcon())).setAutoExpandBubble(bubbleMetadata.getAutoExpandBubble()).setDeleteIntent(bubbleMetadata.getDeleteIntent()).setSuppressNotification(bubbleMetadata.isNotificationSuppressed());
            ...
            public static Notification.BubbleMetadata toPlatform(@Nullable BubbleMetadata bubbleMetadata) {
                ...
                Notification.BubbleMetadata.Builder suppressNotification = new Notification.BubbleMetadata.Builder().setIcon(bubbleMetadata.getIcon().m1313x()).setIntent(bubbleMetadata.getIntent()).setDeleteIntent(bubbleMetadata.getDeleteIntent()).setAutoExpandBubble(bubbleMetadata.getAutoExpandBubble()).setSuppressNotification(bubbleMetadata.isNotificationSuppressed());
                if (bubbleMetadata.getDesiredHeight() != 0) {
                    suppressNotification.setDesiredHeight(bubbleMetadata.getDesiredHeight());
                }
                if (bubbleMetadata.getDesiredHeightResId() != 0) {
        ...
        public static class Api30Impl {
            ...
            public static BubbleMetadata fromPlatform(@Nullable Notification.BubbleMetadata bubbleMetadata) {
                ...
                Builder builder = bubbleMetadata.getShortcutId() != null ? new Builder(bubbleMetadata.getShortcutId()) : new Builder(bubbleMetadata.getIntent(), IconCompat.m1290c(bubbleMetadata.getIcon()));
            ...
            public static Notification.BubbleMetadata toPlatform(@Nullable BubbleMetadata bubbleMetadata) {
                ...
                Notification.BubbleMetadata.Builder builder = bubbleMetadata.getShortcutId() != null ? new Notification.BubbleMetadata.Builder(bubbleMetadata.getShortcutId()) : new Notification.BubbleMetadata.Builder(bubbleMetadata.getIntent(), bubbleMetadata.getIcon().m1313x());
        ...
        public static final class Builder {
            ...
            public Builder(@NonNull PendingIntent pendingIntent, @NonNull IconCompat iconCompat) {
                if (pendingIntent == null) {
                    mnd0.m159157a("Bubble requires non-null pending intent");
                    throw null;
                }
                if (iconCompat == null) {
                    mnd0.m159157a("Bubbles require non-null icon");
                    throw null;
                }
                this.mPendingIntent = pendingIntent;
                this.mIcon = iconCompat;
            ...
            public BubbleMetadata build() {
                ...
                if (str == null && this.mPendingIntent == null) {
                    mnd0.m159157a("Must supply pending intent or shortcut to bubble");
                    return null;
                }
                if (str == null && this.mIcon == null) {
                    mnd0.m159157a("Must supply an icon or shortcut for the bubble");
                    return null;
                }
            ...
            public Builder setIcon(@NonNull IconCompat iconCompat) {
                if (this.mShortcutId != null) {
                    wtq0.m207906a("Created as a shortcut bubble, cannot set an Icon. Consider using BubbleMetadata.Builder(PendingIntent,Icon) instead.");
                    return null;
                }
                if (iconCompat != null) {
                    this.mIcon = iconCompat;
            ...
            public Builder setIntent(@NonNull PendingIntent pendingIntent) {
                if (this.mShortcutId != null) {
                    wtq0.m207906a("Created as a shortcut bubble, cannot set a PendingIntent. Consider using BubbleMetadata.Builder(PendingIntent,Icon) instead.");
                    return null;
                }
                if (pendingIntent != null) {
                    this.mPendingIntent = pendingIntent;
            ...
            public Builder(@NonNull String str) {
                if (!TextUtils.isEmpty(str)) {
                    ...
                    mnd0.m159157a("Bubble requires a non-null shortcut id");
                    throw null;
                }
            }
    ...
    public static class Action {
        ...
        private final wyc0[] mDataOnlyRemoteInputs;
        final Bundle mExtras;

        @Nullable
        private IconCompat mIcon;
        private final boolean mIsContextual;
        private final wyc0[] mRemoteInputs;
        ...
        public Action(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable wyc0[] wyc0VarArr, @Nullable wyc0[] wyc0VarArr2, boolean z, int i, boolean z2, boolean z3, boolean z4) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
            if (iconCompat != null && iconCompat.m1306q() == 2) {
                this.icon = iconCompat.m1304n();
            }
            this.title = Builder.limitCharSequenceLength(charSequence);
            this.actionIntent = pendingIntent;
            this.mExtras = bundle == null ? new Bundle() : bundle;
            this.mRemoteInputs = wyc0VarArr;
            this.mDataOnlyRemoteInputs = wyc0VarArr2;
        ...
        @Nullable
        public wyc0[] getDataOnlyRemoteInputs() {
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i = this.icon) != 0) {
                this.mIcon = IconCompat.m1299l(null, "", i);
            }
            return this.mIcon;
        }

        @Nullable
        public wyc0[] getRemoteInputs() {
        ...
        public static final class Builder {
            ...
            private ArrayList<wyc0> mRemoteInputs;
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable wyc0[] wyc0VarArr, boolean z, int i, boolean z2, boolean z3, boolean z4) {
                ...
                this.mExtras = bundle;
                this.mRemoteInputs = wyc0VarArr == null ? null : new ArrayList<>(Arrays.asList(wyc0VarArr));
                this.mAllowGeneratedReplies = z;
                this.mSemanticAction = i;
                this.mShowsUserInterface = z2;
                this.mIsContextual = z3;
            ...
            private void checkContextualActionNullFields() {
                if (this.mIsContextual && this.mIntent == null) {
                    mnd0.m159157a("Contextual Actions must contain a valid PendingIntent");
                }
            }
            ...
            public static Builder fromAndroidAction(@NonNull Notification.Action action) {
                Builder builder = Api23Impl.getIcon(action) != null ? new Builder(IconCompat.m1291d(Api23Impl.getIcon(action)), action.title, action.actionIntent) : new Builder(action.icon, action.title, action.actionIntent);
                RemoteInput[] remoteInputs = Api20Impl.getRemoteInputs(action);
                if (remoteInputs != null && remoteInputs.length != 0) {
                    for (RemoteInput remoteInput : remoteInputs) {
                        builder.addRemoteInput(wyc0.m208585c(remoteInput));
                    }
                }
            ...
            @NonNull
            public Builder addRemoteInput(@Nullable wyc0 wyc0Var) {
                if (this.mRemoteInputs == null) {
                    this.mRemoteInputs = new ArrayList<>();
                }
                if (wyc0Var != null) {
                    this.mRemoteInputs.add(wyc0Var);
                }
                return this;
            }
            ...
            public Action build() {
                ...
                ArrayList<wyc0> arrayList3 = this.mRemoteInputs;
                if (arrayList3 != null) {
                    for (wyc0 wyc0Var : arrayList3) {
                        if (wyc0Var.m208594l()) {
                            arrayList.add(wyc0Var);
                        } else {
                            arrayList2.add(wyc0Var);
                        }
                    }
                }
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, arrayList2.isEmpty() ? null : (wyc0[]) arrayList2.toArray(new wyc0[arrayList2.size()]), arrayList.isEmpty() ? null : (wyc0[]) arrayList.toArray(new wyc0[arrayList.size()]), this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface, this.mIsContextual, this.mAuthenticationRequired);
            }
            ...
            public Builder(int i, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
                this(i != 0 ? IconCompat.m1299l(null, "", i) : null, charSequence, pendingIntent, new Bundle(), null, true, 0, true, false, false);
            }
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m225032clone() {
        ...
        public Action(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
            this(iconCompat, charSequence, pendingIntent, new Bundle(), (wyc0[]) null, (wyc0[]) null, true, 0, true, false, false);
        }

        public Action(int i, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable wyc0[] wyc0VarArr, @Nullable wyc0[] wyc0VarArr2, boolean z, int i2, boolean z2, boolean z3, boolean z4) {
            this(i != 0 ? IconCompat.m1299l(null, "", i) : null, charSequence, pendingIntent, bundle, wyc0VarArr, wyc0VarArr2, z, i2, z2, z3, z4);
        }

        public Action(int i, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
            this(i != 0 ? IconCompat.m1299l(null, "", i) : null, charSequence, pendingIntent);
        }
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation {
            ...
            private final wyc0 mRemoteInput;
            ...
            public static class Builder {
                ...
                @NonNull
                public Builder setReplyAction(@Nullable PendingIntent pendingIntent, @Nullable wyc0 wyc0Var) {
                    this.mRemoteInput = wyc0Var;
                    this.mReplyPendingIntent = pendingIntent;
                    return this;
                }
            }

            public UnreadConversation(@Nullable String[] strArr, @Nullable wyc0 wyc0Var, @Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable String[] strArr2, long j) {
        ...
        private static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            wyc0 remoteInput = unreadConversation.getRemoteInput();
            if (remoteInput != null) {
                RemoteInput.Builder builderCreateBuilder = Api20Impl.createBuilder(remoteInput.m208593j());
                Api20Impl.setLabel(builderCreateBuilder, remoteInput.m208592i());
                Api20Impl.setChoices(builderCreateBuilder, remoteInput.m208589f());
                Api20Impl.setAllowFreeFormInput(builderCreateBuilder, remoteInput.m208587d());
                Api20Impl.addExtras(builderCreateBuilder, remoteInput.m208591h());
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            return new UnreadConversation(strArr, remoteInput != null ? new wyc0(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, Api20Impl.getExtras(remoteInput), null) : null, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            IconCompat iconCompat = action.getIconCompat();
            Notification.Action.Builder builderCreateBuilder = Api23Impl.createBuilder(iconCompat == null ? null : iconCompat.m1313x(), action.getTitle(), action.getActionIntent());
            ...
            wyc0[] remoteInputs = action.getRemoteInputs();
            if (remoteInputs != null) {
                for (RemoteInput remoteInput : wyc0.m208584b(remoteInputs)) {
        ...
        @NonNull
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m225033clone() {
            WearableExtender wearableExtender = new WearableExtender();
