...
public class C0089d extends BaseAdapter {
    ...
    public C0089d(MenuBuilder menuBuilder, LayoutInflater layoutInflater, boolean z, int i) {
        this.f426d = z;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        InterfaceC0093h.a aVar = (InterfaceC0093h.a) view;
        if (this.f425c) {
