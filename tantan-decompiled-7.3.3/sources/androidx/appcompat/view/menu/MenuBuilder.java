...
public class MenuBuilder implements f7h0 {
    private static final String ACTION_VIEW_STATES_KEY = "android:menu:actionviewstates";
    private static final String EXPANDED_ACTION_VIEW_ID = "android:menu:expandedactionview";
    private static final String PRESENTER_KEY = "android:menu:presenters";
    private static final String TAG = "MenuBuilder";
    private static final int[] sCategoryToOrder = {1, 4, 5, 3, 2, 0};
    private InterfaceC0079a mCallback;
    ...
    private CopyOnWriteArrayList<WeakReference<InterfaceC0092g>> mPresenters = new CopyOnWriteArrayList<>();
    ...
    public interface InterfaceC0080b {
        ...
        boolean mo376c(MenuItemImpl menuItemImpl);
    }
    ...
    private void dispatchPresenterUpdate(boolean z) {
        ...
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            InterfaceC0092g interfaceC0092g = weakReference.get();
            if (interfaceC0092g == null) {
                this.mPresenters.remove(weakReference);
            } else {
                interfaceC0092g.updateMenuView(z);
            }
        }
    ...
    private void dispatchRestoreInstanceState(Bundle bundle) {
        ...
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            ...
            if (interfaceC0092g == null) {
                ...
                int id = interfaceC0092g.getId();
                if (id > 0 && (parcelable = (Parcelable) sparseParcelableArray.get(id)) != null) {
                    interfaceC0092g.onRestoreInstanceState(parcelable);
                }
            }
        }
    }
    ...
    private void dispatchSaveInstanceState(Bundle bundle) {
        ...
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            ...
            if (interfaceC0092g == null) {
                ...
                int id = interfaceC0092g.getId();
                if (id > 0 && (parcelableOnSaveInstanceState = interfaceC0092g.onSaveInstanceState()) != null) {
    ...
    private boolean dispatchSubMenuSelected(SubMenuC0095j subMenuC0095j, InterfaceC0092g interfaceC0092g) {
        if (this.mPresenters.isEmpty()) {
            return false;
        }
        boolean zOnSubMenuSelected = interfaceC0092g != null ? interfaceC0092g.onSubMenuSelected(subMenuC0095j) : false;
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            InterfaceC0092g interfaceC0092g2 = weakReference.get();
            if (interfaceC0092g2 == null) {
                this.mPresenters.remove(weakReference);
            } else if (!zOnSubMenuSelected) {
                zOnSubMenuSelected = interfaceC0092g2.onSubMenuSelected(subMenuC0095j);
            }
        }
    ...
    private static int getOrdering(int i) {
        ...
        if (i2 >= 0) {
            ...
            if (i2 < iArr.length) {
                return (i & p7f.COLOR_SPACE_UNCALIBRATED) | (iArr[i2] << 16);
            }
        }
        wg3.m206174a("order does not contain a valid category.");
        return 0;
    }
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i2, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i2 > 0) {
                this.mHeaderIcon = j26.m143192e(getContext(), i2);
    ...
    private void setShortcutsVisibleInner(boolean z) {
        boolean z2;
        if (z) {
            z2 = this.mResources.getConfiguration().keyboard != 1 && nkl0.m163651m(ViewConfiguration.get(this.mContext), this.mContext);
        }
    ...
    public void addMenuPresenter(InterfaceC0092g interfaceC0092g, Context context) {
        this.mPresenters.add(new WeakReference<>(interfaceC0092g));
        interfaceC0092g.initForMenu(context, this);
    ...
    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        ...
        SubMenuC0095j subMenuC0095j = new SubMenuC0095j(this.mContext, this, menuItemImpl);
        menuItemImpl.setSubMenu(subMenuC0095j);
        return subMenuC0095j;
    }

    public void changeMenuMode() {
        InterfaceC0079a interfaceC0079a = this.mCallback;
        if (interfaceC0079a != null) {
            interfaceC0079a.onMenuModeChange(this);
        }
    }
    ...
    public final void close(boolean z) {
        ...
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            ...
            if (interfaceC0092g == null) {
                ...
                interfaceC0092g.onCloseMenu(this, z);
            }
        }
    ...
    public boolean collapseItemActionView(MenuItemImpl menuItemImpl) {
        ...
        if (!this.mPresenters.isEmpty() && this.mExpandedItem == menuItemImpl) {
            ...
            for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
                InterfaceC0092g interfaceC0092g = weakReference.get();
                if (interfaceC0092g != null) {
                    zCollapseItemActionView = interfaceC0092g.collapseItemActionView(this, menuItemImpl);
    ...
    public boolean dispatchMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
        InterfaceC0079a interfaceC0079a = this.mCallback;
        return interfaceC0079a != null && interfaceC0079a.onMenuItemSelected(menuBuilder, menuItem);
    }
    ...
    public boolean expandItemActionView(MenuItemImpl menuItemImpl) {
        ...
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            InterfaceC0092g interfaceC0092g = weakReference.get();
            if (interfaceC0092g != null) {
                zExpandItemActionView = interfaceC0092g.expandItemActionView(this, menuItemImpl);
        ...
        if (this.mIsActionItemsStale) {
            ...
            for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
                ...
                if (interfaceC0092g == null) {
                    ...
                    zFlagActionItems |= interfaceC0092g.flagActionItems();
                }
            }
    ...
    public boolean performItemAction(MenuItem menuItem, InterfaceC0092g interfaceC0092g, int i) {
        MenuItemImpl menuItemImpl = (MenuItemImpl) menuItem;
        if (menuItemImpl == null || !menuItemImpl.isEnabled()) {
            return false;
        }
        boolean zInvoke = menuItemImpl.invoke();
        t30 supportActionProvider = menuItemImpl.getSupportActionProvider();
        boolean z = supportActionProvider != null && supportActionProvider.mo385a();
        ...
        if (!menuItemImpl.hasSubMenu()) {
            menuItemImpl.setSubMenu(new SubMenuC0095j(getContext(), this, menuItemImpl));
        }
        SubMenuC0095j subMenuC0095j = (SubMenuC0095j) menuItemImpl.getSubMenu();
        if (z) {
            supportActionProvider.mo388f(subMenuC0095j);
        }
        boolean zDispatchSubMenuSelected = dispatchSubMenuSelected(subMenuC0095j, interfaceC0092g) | zInvoke;
    ...
    public void removeMenuPresenter(InterfaceC0092g interfaceC0092g) {
        for (WeakReference<InterfaceC0092g> weakReference : this.mPresenters) {
            InterfaceC0092g interfaceC0092g2 = weakReference.get();
            if (interfaceC0092g2 == null || interfaceC0092g2 == interfaceC0092g) {
                this.mPresenters.remove(weakReference);
            }
        }
    }
    ...
    public void restoreActionViewStates(Bundle bundle) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (item.hasSubMenu()) {
                ((SubMenuC0095j) item.getSubMenu()).restoreActionViewStates(bundle);
            }
        }
    ...
    public void saveActionViewStates(Bundle bundle) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (item.hasSubMenu()) {
                ((SubMenuC0095j) item.getSubMenu()).saveActionViewStates(bundle);
            }
        }
        if (sparseArray != null) {
    ...
    public void setCallback(InterfaceC0079a interfaceC0079a) {
        this.mCallback = interfaceC0079a;
    }
    ...
    public void addMenuPresenter(InterfaceC0092g interfaceC0092g) {
        addMenuPresenter(interfaceC0092g, this.mContext);
    }
