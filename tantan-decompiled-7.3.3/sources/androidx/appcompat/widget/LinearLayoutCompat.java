...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        t0j0 t0j0VarM188782u = t0j0.m188782u(context, attributeSet, gic0.f104356c1, i, 0);
        int iM188793k = t0j0VarM188782u.m188793k(gic0.f104366e1, -1);
        if (iM188793k >= 0) {
            setOrientation(iM188793k);
        }
        int iM188793k2 = t0j0VarM188782u.m188793k(gic0.f104361d1, -1);
        if (iM188793k2 >= 0) {
            setGravity(iM188793k2);
        }
        boolean zM188783a = t0j0VarM188782u.m188783a(gic0.f104371f1, true);
        if (!zM188783a) {
            setBaselineAligned(zM188783a);
        }
        this.mWeightSum = t0j0VarM188782u.m188791i(gic0.f104381h1, -1.0f);
        this.mBaselineAlignedChildIndex = t0j0VarM188782u.m188793k(gic0.f104376g1, -1);
        this.mUseLargestChild = t0j0VarM188782u.m188783a(gic0.f104396k1, false);
        setDividerDrawable(t0j0VarM188782u.m188789g(gic0.f104386i1));
        this.mShowDividers = t0j0VarM188782u.m188793k(gic0.f104401l1, 0);
        this.mDividerPadding = t0j0VarM188782u.m188788f(gic0.f104391j1, 0);
    ...
    private void forceUniformHeight(int i, int i2) {
        ...
        while (i4 < i) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                C0132a c0132a = (C0132a) virtualChildAt.getLayoutParams();
                if (((ViewGroup.MarginLayoutParams) c0132a).height == -1) {
                    int i5 = ((ViewGroup.MarginLayoutParams) c0132a).width;
                    ((ViewGroup.MarginLayoutParams) c0132a).width = virtualChildAt.getMeasuredWidth();
                    linearLayoutCompat = this;
                    i3 = i2;
                    linearLayoutCompat.measureChildWithMargins(virtualChildAt, i3, 0, iMakeMeasureSpec, 0);
                    ((ViewGroup.MarginLayoutParams) c0132a).width = i5;
                } else {
                    linearLayoutCompat = this;
                    i3 = i2;
                }
        ...
        while (i4 < i) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                ...
                if (((ViewGroup.MarginLayoutParams) c0132a).width == -1) {
                    ...
                    ((ViewGroup.MarginLayoutParams) c0132a).height = virtualChildAt.getMeasuredHeight();
                    linearLayoutCompat = this;
                    i3 = i2;
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (virtualChildAt != null && virtualChildAt.getVisibility() != 8 && hasDividerBeforeChildAt(i2)) {
                C0132a c0132a = (C0132a) virtualChildAt.getLayoutParams();
                drawVerticalDivider(canvas, zM146265b ? virtualChildAt.getRight() + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin : (virtualChildAt.getLeft() - ((ViewGroup.MarginLayoutParams) c0132a).leftMargin) - this.mDividerWidth);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 != null) {
                C0132a c0132a2 = (C0132a) virtualChildAt2.getLayoutParams();
                if (zM146265b) {
                    left = virtualChildAt2.getLeft() - ((ViewGroup.MarginLayoutParams) c0132a2).leftMargin;
                    i = this.mDividerWidth;
                    right = left - i;
                } else {
                    right = virtualChildAt2.getRight() + ((ViewGroup.MarginLayoutParams) c0132a2).rightMargin;
                }
            } else if (zM146265b) {
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < virtualChildCount; i++) {
            ...
            if (virtualChildAt != null && virtualChildAt.getVisibility() != 8 && hasDividerBeforeChildAt(i)) {
                drawHorizontalDivider(canvas, (virtualChildAt.getTop() - ((ViewGroup.MarginLayoutParams) ((C0132a) virtualChildAt.getLayoutParams())).topMargin) - this.mDividerHeight);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            drawHorizontalDivider(canvas, virtualChildAt2 == null ? (getHeight() - getPaddingBottom()) - this.mDividerHeight : virtualChildAt2.getBottom() + ((ViewGroup.MarginLayoutParams) ((C0132a) virtualChildAt2.getLayoutParams())).bottomMargin);
        }
    }
    ...
    @Override // android.view.ViewGroup
    public C0132a generateDefaultLayoutParams() {
        int i = this.mOrientation;
        if (i == 0) {
            return new C0132a(-2, -2);
        }
        if (i == 1) {
            return new C0132a(-1, -2);
        }
        return null;
    }

    @Override // android.view.ViewGroup
    public C0132a generateLayoutParams(AttributeSet attributeSet) {
    ...
    public int getBaseline() {
        ...
        if (childCount <= i2) {
            azk0.m101074a("mBaselineAlignedChildIndex of LinearLayout set to an index that is out of bounds.");
            return 0;
        }
        ...
        if (baseline == -1) {
            ...
            azk0.m101074a("mBaselineAlignedChildIndex of LinearLayout points to a View that doesn't know how to get its baseline.");
            return 0;
        }
        ...
        return bottom + ((ViewGroup.MarginLayoutParams) ((C0132a) childAt.getLayoutParams())).topMargin + baseline;
    }
    ...
    public void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int iM157578b = m9k.m157578b(8388615 & i14, kkl0.m150191x(this));
        char c3 = 2;
        char c4 = 1;
        if (iM157578b != 1) {
            paddingLeft = iM157578b != 5 ? getPaddingLeft() : ((getPaddingLeft() + i3) - i) - this.mTotalLength;
        } else {
        ...
        while (i16 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() != 8) {
                    ...
                    if (z) {
                        i8 = measuredHeight2;
                        baseline = ((ViewGroup.MarginLayoutParams) c0132a).height != -1 ? virtualChildAt.getBaseline() : -1;
                        i9 = c0132a.f682b;
                        if (i9 < 0) {
                            i9 = i15;
                        }
                        ...
                        if (i10 != 16) {
                            if (i10 != 48) {
                                i11 = i7 + ((ViewGroup.MarginLayoutParams) c0132a).topMargin;
                                if (baseline != -1) {
                                ...
                                i11 = (paddingBottom - i8) - ((ViewGroup.MarginLayoutParams) c0132a).bottomMargin;
                                if (baseline != -1) {
                            ...
                            int i20 = ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + i12;
                            setChildFrame(virtualChildAt, getLocationOffset(virtualChildAt) + i20, i11, measuredWidth, i8);
                            int nextLocationOffset = i20 + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin + measuredWidth + getNextLocationOffset(virtualChildAt);
                            childrenSkipCount = getChildrenSkipCount(virtualChildAt, i17) + i18;
                            paddingLeft = nextLocationOffset;
                        } else {
                            i11 = i7 + ((paddingBottom2 - i8) / 2) + ((ViewGroup.MarginLayoutParams) c0132a).topMargin;
                            measuredHeight = ((ViewGroup.MarginLayoutParams) c0132a).bottomMargin;
                        }
                        i11 -= measuredHeight;
                        if (hasDividerBeforeChildAt(i17)) {
                            i12 = i19 + this.mDividerWidth;
                        ...
                        int i21 = ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + i12;
                        setChildFrame(virtualChildAt, getLocationOffset(virtualChildAt) + i21, i11, measuredWidth, i8);
                        int nextLocationOffset2 = i21 + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin + measuredWidth + getNextLocationOffset(virtualChildAt);
                        childrenSkipCount = getChildrenSkipCount(virtualChildAt, i17) + i18;
                    ...
                    if (i10 != 16) {
                        ...
                        int i22 = ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + i12;
                        setChildFrame(virtualChildAt, getLocationOffset(virtualChildAt) + i22, i11, measuredWidth, i8);
                        int nextLocationOffset3 = i22 + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin + measuredWidth + getNextLocationOffset(virtualChildAt);
                        childrenSkipCount = getChildrenSkipCount(virtualChildAt, i17) + i18;
                    ...
                    int i23 = ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + i12;
                    setChildFrame(virtualChildAt, getLocationOffset(virtualChildAt) + i23, i11, measuredWidth, i8);
                    int nextLocationOffset4 = i23 + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin + measuredWidth + getNextLocationOffset(virtualChildAt);
                    childrenSkipCount = getChildrenSkipCount(virtualChildAt, i17) + i18;
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() != 8) {
                    ...
                    if (iM157578b != 1) {
                        ...
                        paddingTop = i14 + measuredHeight + ((ViewGroup.MarginLayoutParams) c0132a).bottomMargin + linearLayoutCompat.getNextLocationOffset(virtualChildAt);
                    ...
                    paddingTop = i16 + measuredHeight + ((ViewGroup.MarginLayoutParams) c0132a).bottomMargin + linearLayoutCompat.getNextLocationOffset(virtualChildAt);
                    childrenSkipCount += linearLayoutCompat.getChildrenSkipCount(virtualChildAt, childrenSkipCount);
                }
                childrenSkipCount++;
                this = linearLayoutCompat;
        ...
        while (true) {
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() == 8) {
                    ...
                    C0132a c0132a = (C0132a) virtualChildAt.getLayoutParams();
                    float f3 = c0132a.f681a;
                    float f4 = f2 + f3;
                    if (mode == i14 && ((ViewGroup.MarginLayoutParams) c0132a).width == 0 && f3 > 0.0f) {
                        int i16 = this.mTotalLength;
                        if (z5) {
                            this.mTotalLength = i16 + ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin;
                        } else {
                            this.mTotalLength = Math.max(i16, ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + i16 + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin);
                        }
                        if (z10) {
                        ...
                        if (((ViewGroup.MarginLayoutParams) c0132a).width != 0 || f3 <= 0.0f) {
                            b = -2;
                            i11 = Integer.MIN_VALUE;
                        } else {
                            b = -2;
                            ((ViewGroup.MarginLayoutParams) c0132a).width = -2;
                            i11 = 0;
                        }
                        ...
                        if (i17 != Integer.MIN_VALUE) {
                            ((ViewGroup.MarginLayoutParams) c0132a).width = i17;
                        }
                        int measuredWidth = view.getMeasuredWidth();
                        int i18 = this.mTotalLength;
                        if (z5) {
                            this.mTotalLength = i18 + ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + measuredWidth + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin + getNextLocationOffset(view);
                        } else {
                            this.mTotalLength = Math.max(i18, i18 + measuredWidth + ((ViewGroup.MarginLayoutParams) c0132a).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a).rightMargin + getNextLocationOffset(view));
                        }
                        if (z) {
                            iMax2 = Math.max(measuredWidth, iMax2);
                        }
                    }
                    if (mode2 == i13 || ((ViewGroup.MarginLayoutParams) c0132a).height != -1) {
                        z2 = false;
                    } else {
                        z2 = true;
                        z8 = true;
                    }
                    int i19 = ((ViewGroup.MarginLayoutParams) c0132a).topMargin + ((ViewGroup.MarginLayoutParams) c0132a).bottomMargin;
                    int measuredHeight = view.getMeasuredHeight() + i19;
                    iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, view.getMeasuredState());
                    if (z10 && (baseline2 = view.getBaseline()) != -1) {
                        int i20 = c0132a.f682b;
                        if (i20 < 0) {
                            i20 = this.mGravity;
                        }
                    ...
                    z9 = z9 && ((ViewGroup.MarginLayoutParams) c0132a).height == -1;
                    if (c0132a.f681a > 0.0f) {
                        if (!z2) {
                            i19 = measuredHeight;
                        }
                ...
                while (childrenSkipCount2 < i4) {
                    ...
                    if (virtualChildAt2 == null) {
                        ...
                        if (virtualChildAt2.getVisibility() == 8) {
                            ...
                            if (z5) {
                                this.mTotalLength = i25 + ((ViewGroup.MarginLayoutParams) c0132a2).leftMargin + iMax2 + ((ViewGroup.MarginLayoutParams) c0132a2).rightMargin + getNextLocationOffset(virtualChildAt2);
                            } else {
                                this.mTotalLength = Math.max(i25, i25 + iMax2 + ((ViewGroup.MarginLayoutParams) c0132a2).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a2).rightMargin + getNextLocationOffset(virtualChildAt2));
                            }
                        }
                        childrenSkipCount2++;
                        f2 = f2;
        ...
        if (z7 || (i26 != 0 && f > 0.0f)) {
            ...
            while (i27 < i4) {
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    C0132a c0132a3 = (C0132a) virtualChildAt3.getLayoutParams();
                    float f6 = c0132a3.f681a;
                    if (f6 > 0.0f) {
                        int i28 = (int) ((i26 * f6) / f);
                        f -= f6;
                        i26 -= i28;
                        int childMeasureSpec = ViewGroup.getChildMeasureSpec(i2, getPaddingTop() + getPaddingBottom() + ((ViewGroup.MarginLayoutParams) c0132a3).topMargin + ((ViewGroup.MarginLayoutParams) c0132a3).bottomMargin, ((ViewGroup.MarginLayoutParams) c0132a3).height);
                        if (((ViewGroup.MarginLayoutParams) c0132a3).width == 0) {
                            i10 = 1073741824;
                            if (i5 == 1073741824) {
                                if (i28 <= 0) {
                                    i28 = 0;
                    ...
                    if (z5) {
                        this.mTotalLength = i29 + virtualChildAt3.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) c0132a3).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a3).rightMargin + getNextLocationOffset(virtualChildAt3);
                    } else {
                        this.mTotalLength = Math.max(i29, virtualChildAt3.getMeasuredWidth() + i29 + ((ViewGroup.MarginLayoutParams) c0132a3).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a3).rightMargin + getNextLocationOffset(virtualChildAt3));
                    }
                    boolean z13 = mode2 != 1073741824 && ((ViewGroup.MarginLayoutParams) c0132a3).height == -1;
                    int i30 = ((ViewGroup.MarginLayoutParams) c0132a3).topMargin + ((ViewGroup.MarginLayoutParams) c0132a3).bottomMargin;
                    ...
                    if (z9) {
                        i8 = -1;
                        boolean z14 = ((ViewGroup.MarginLayoutParams) c0132a3).height == -1;
            ...
            if (z12 && i5 != 1073741824) {
                for (int i34 = 0; i34 < i4; i34++) {
                    ...
                    if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((C0132a) virtualChildAt4.getLayoutParams()).f681a > 0.0f) {
        ...
        while (true) {
                ...
                if (z7 && (i23 == Integer.MIN_VALUE || i23 == 0)) {
                    ...
                    while (childrenSkipCount2 < i3) {
                        ...
                        if (virtualChildAt == null) {
                            ...
                            this.mTotalLength = Math.max(i24, i24 + i22 + ((ViewGroup.MarginLayoutParams) c0132a).topMargin + ((ViewGroup.MarginLayoutParams) c0132a).bottomMargin + getNextLocationOffset(virtualChildAt));
                        }
                        childrenSkipCount2++;
                        i18 = 8;
                    }
                ...
                if (z4 || (i25 != 0 && f2 > 0.0f)) {
                    ...
                    while (i27 < i3) {
                        ...
                        if (virtualChildAt2.getVisibility() == 8) {
                            ...
                            C0132a c0132a2 = (C0132a) virtualChildAt2.getLayoutParams();
                            float f5 = c0132a2.f681a;
                            if (f5 > 0.0f) {
                                int i28 = (int) ((i26 * f5) / f4);
                                f4 -= f5;
                                i26 -= i28;
                                int childMeasureSpec = ViewGroup.getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + ((ViewGroup.MarginLayoutParams) c0132a2).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a2).rightMargin, ((ViewGroup.MarginLayoutParams) c0132a2).width);
                                if (((ViewGroup.MarginLayoutParams) c0132a2).height == 0) {
                                    i5 = 1073741824;
                                    if (i23 == 1073741824) {
                            ...
                            int i29 = ((ViewGroup.MarginLayoutParams) c0132a2).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a2).rightMargin;
                            int measuredWidth = virtualChildAt2.getMeasuredWidth() + i29;
                            iMax6 = Math.max(iMax6, measuredWidth);
                            if (mode != 1073741824) {
                                i4 = -1;
                                if (((ViewGroup.MarginLayoutParams) c0132a2).width == -1) {
                                    measuredWidth = i29;
                                }
                            } else {
                                i4 = -1;
                            ...
                            boolean z8 = z6 && ((ViewGroup.MarginLayoutParams) c0132a2).width == i4;
                            int i30 = this.mTotalLength;
                            this.mTotalLength = Math.max(i30, i30 + virtualChildAt2.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) c0132a2).topMargin + ((ViewGroup.MarginLayoutParams) c0132a2).bottomMargin + getNextLocationOffset(virtualChildAt2));
                            iMax5 = iMax7;
                            z6 = z8;
                        }
                        i27++;
                    ...
                    if (z7 && i23 != 1073741824) {
                        for (int i31 = 0; i31 < i3; i31++) {
                            ...
                            if (virtualChildAt3 != null && virtualChildAt3.getVisibility() != 8 && ((C0132a) virtualChildAt3.getLayoutParams()).f681a > 0.0f) {
            ...
            if (virtualChildAt4 == null) {
                ...
                if (virtualChildAt4.getVisibility() == 8) {
                    ...
                    C0132a c0132a3 = (C0132a) virtualChildAt4.getLayoutParams();
                    float f7 = c0132a3.f681a;
                    float f8 = f6 + f7;
                    if (mode2 == 1073741824 && ((ViewGroup.MarginLayoutParams) c0132a3).height == 0 && f7 > 0.0f) {
                        int i32 = this.mTotalLength;
                        this.mTotalLength = Math.max(i32, ((ViewGroup.MarginLayoutParams) c0132a3).topMargin + i32 + ((ViewGroup.MarginLayoutParams) c0132a3).bottomMargin);
                        iMax2 = i15;
                        ...
                        if (((ViewGroup.MarginLayoutParams) c0132a3).height != 0 || f7 <= 0.0f) {
                            i6 = Integer.MIN_VALUE;
                        } else {
                            ((ViewGroup.MarginLayoutParams) c0132a3).height = -2;
                            i6 = 0;
                        }
                        if (f8 == 0.0f) {
                            int i33 = i17;
                        ...
                        if (i6 != Integer.MIN_VALUE) {
                            ((ViewGroup.MarginLayoutParams) c0132a3).height = i6;
                        }
                        int measuredHeight2 = view.getMeasuredHeight();
                        int i35 = this.mTotalLength;
                        this.mTotalLength = Math.max(i35, i35 + measuredHeight2 + ((ViewGroup.MarginLayoutParams) c0132a3).topMargin + ((ViewGroup.MarginLayoutParams) c0132a3).bottomMargin + getNextLocationOffset(view));
                    ...
                    if (childrenSkipCount < i14 && c0132a3.f681a > 0.0f) {
                        azk0.m101074a("A child of LinearLayout with index less than mBaselineAlignedChildIndex has weight > 0, which won't work.  Either remove the weight, or don't set mBaselineAlignedChildIndex.");
                        return;
                    }
                    if (mode == 1073741824 || ((ViewGroup.MarginLayoutParams) c0132a3).width != -1) {
                        z2 = false;
                    } else {
                        z2 = true;
                        z5 = true;
                    }
                    int i36 = ((ViewGroup.MarginLayoutParams) c0132a3).leftMargin + ((ViewGroup.MarginLayoutParams) c0132a3).rightMargin;
                    ...
                    if (z6) {
                        ...
                        z6 = ((ViewGroup.MarginLayoutParams) c0132a3).width == -1;
                        if (c0132a3.f681a > 0.0f) {
                            if (!z2) {
                                i36 = measuredWidth2;
                            }
    ...
    public void setBaselineAlignedChildIndex(int i) {
        if (i < 0 || i >= getChildCount()) {
            vic0.m201333a("base aligned child index out of range (0, ", getChildCount(), ")");
        } else {
    ...
    @Override // android.view.ViewGroup
    public C0132a generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return new C0132a(layoutParams);
    }

    /* JADX INFO: renamed from: androidx.appcompat.widget.LinearLayoutCompat$a */
    public static class C0132a extends ViewGroup.MarginLayoutParams {
        ...
        public C0132a(Context context, AttributeSet attributeSet) {
            ...
            this.f682b = -1;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, gic0.f104406m1);
            this.f681a = typedArrayObtainStyledAttributes.getFloat(gic0.f104416o1, 0.0f);
            this.f682b = typedArrayObtainStyledAttributes.getInt(gic0.f104411n1, -1);
