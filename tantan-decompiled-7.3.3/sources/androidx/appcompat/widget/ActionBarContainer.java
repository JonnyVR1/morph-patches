...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        kkl0.m150170m0(this, new d30(this));
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, gic0.f104344a);
        this.f484e = typedArrayObtainStyledAttributes.getDrawable(gic0.f104349b);
        this.f485f = typedArrayObtainStyledAttributes.getDrawable(gic0.f104359d);
        this.f489j = typedArrayObtainStyledAttributes.getDimensionPixelSize(gic0.f104389j, -1);
        boolean z = true;
        if (getId() == xdc0.f193547N) {
            this.f487h = true;
            this.f486g = typedArrayObtainStyledAttributes.getDrawable(gic0.f104354c);
        }
    ...
    /* JADX INFO: renamed from: a */
    public final int m456a(View view) {
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
        return view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin;
    }

    /* JADX INFO: renamed from: b */
    public final boolean m457b(View view) {
    ...
    public void onFinishInflate() {
        ...
        this.f482c = findViewById(xdc0.f193556a);
        this.f483d = findViewById(xdc0.f193561f);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (m457b(this.f482c)) {
            iM456a = !m457b(this.f483d) ? m456a(this.f483d) : 0;
        } else {
            iM456a = m456a(this.f482c);
        }
        setMeasuredDimension(getMeasuredWidth(), Math.min(iM456a + m456a(this.f481b), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i2) : Api.BaseClientBuilder.API_PRIORITY_OTHER));
    }
