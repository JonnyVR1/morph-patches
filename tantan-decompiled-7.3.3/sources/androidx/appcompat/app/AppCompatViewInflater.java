...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new l01();
    ...
    public static class ViewOnClickListenerC0074a implements View.OnClickListener {
        ...
        public ViewOnClickListenerC0074a(@NonNull View view, @NonNull String str) {
            this.f310a = view;
            this.f311b = str;
        }
        ...
        @NonNull
        /* JADX INFO: renamed from: a */
        public final void m356a(@Nullable Context context, @NonNull String str) {
            String str2;
            Method method;
            while (context != null) {
                try {
            ...
            bkq0.m104842a("Could not find method ", this.f311b, "(View) in a parent or ancestor Context for android:onClick attribute defined on view ", this.f310a.getClass(), str2);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(@NonNull View view) {
            if (this.f312c == null) {
                m356a(this.f310a.getContext(), this.f311b);
            }
            try {
                this.f312c.invoke(this.f313d, view);
            } catch (IllegalAccessException e) {
                yzv.m218057a("Could not execute non-public method for android:onClick", e);
            } catch (InvocationTargetException e2) {
                yzv.m218057a("Could not execute method for android:onClick", e2);
            }
        }
    }
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if ((context instanceof ContextWrapper) && kkl0.m150129K(view)) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, sOnClickAttrs);
            String string = typedArrayObtainStyledAttributes.getString(0);
            if (string != null) {
                view.setOnClickListener(new ViewOnClickListenerC0074a(view, string));
            }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, gic0.f104273K3, 0, 0);
        int resourceId = z ? typedArrayObtainStyledAttributes.getResourceId(gic0.f104278L3, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = typedArrayObtainStyledAttributes.getResourceId(gic0.f104283M3, 0);
        }
        typedArrayObtainStyledAttributes.recycle();
        return (resourceId == 0 || ((context instanceof r26) && ((r26) context).m179532b() == resourceId)) ? context : new r26(context, resourceId);
    }
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z4) {
            context2 = q0j0.m174714b(context2);
        }
        str.getClass();
        byte b = -1;
        switch (str.hashCode()) {
