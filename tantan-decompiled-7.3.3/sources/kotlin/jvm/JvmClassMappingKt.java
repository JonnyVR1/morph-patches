...
@Metadata(m88120d1 = {"\u0000\u001e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0000\n\u0002\b\u0007\n\u0002\u0010\u001b\n\u0002\b\u0004\"-\u0010\u0007\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002\"\u0004\b\u0000\u0010\u0000*\b\u0012\u0004\u0012\u00028\u00000\u00018G¢\u0006\f\u0012\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0003\u0010\u0004\"-\u0010\n\u001a\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\u0002\"\b\b\u0000\u0010\u0000*\u00020\b*\b\u0012\u0004\u0012\u00028\u00000\u00018F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0004\"+\u0010\f\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002\"\b\b\u0000\u0010\u0000*\u00020\b*\b\u0012\u0004\u0012\u00028\u00000\u00018F¢\u0006\u0006\u001a\u0004\b\u000b\u0010\u0004\"+\u0010\u000f\u001a\b\u0012\u0004\u0012\u00028\u00000\u0001\"\b\b\u0000\u0010\u0000*\u00020\b*\b\u0012\u0004\u0012\u00028\u00000\u00028G¢\u0006\u0006\u001a\u0004\b\r\u0010\u000e\"'\u0010\u0013\u001a\n\u0012\u0006\b\u0001\u0012\u00028\u00000\u0001\"\b\b\u0000\u0010\u0000*\u00020\u0010*\u00028\u00008F¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u0014"}, m88121d2 = {p7f.GPS_DIRECTION_TRUE, "Lkotlin/reflect/KClass;", "Ljava/lang/Class;", "b", "(Lkotlin/reflect/KClass;)Ljava/lang/Class;", "getJavaClass$annotations", "(Lkotlin/reflect/KClass;)V", "java", "", Constants.INAPP_DATA_TAG, "javaPrimitiveType", "c", "javaObjectType", "e", "(Ljava/lang/Class;)Lkotlin/reflect/KClass;", "kotlin", "", "a", "(Ljava/lang/annotation/Annotation;)Lkotlin/reflect/KClass;", "annotationClass", "kotlin-stdlib"}, m88122k = 2, m88123mv = {2, 2, 0}, m88125xi = 48)
@JvmName
public final class JvmClassMappingKt {
    @NotNull
    /* JADX INFO: renamed from: a */
    public static final <T extends Annotation> KClass<? extends T> m88340a(@NotNull T t) {
        t.getClass();
        Class<? extends Annotation> clsAnnotationType = t.annotationType();
        clsAnnotationType.getClass();
        KClass<? extends T> kClassM88344e = m88344e(clsAnnotationType);
        kClassM88344e.getClass();
        return kClassM88344e;
    }

    @JvmName
    @NotNull
    /* JADX INFO: renamed from: b */
    public static final <T> Class<T> m88341b(@NotNull KClass<T> kClass) {
        kClass.getClass();
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).mo88354d();
        cls.getClass();
        return cls;
    }
    ...
    public static final <T> Class<T> m88342c(@NotNull KClass<T> kClass) {
        kClass.getClass();
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).mo88354d();
        if (!cls.isPrimitive()) {
            return cls;
    ...
    public static final <T> Class<T> m88343d(@NotNull KClass<T> kClass) {
        kClass.getClass();
        Class<T> cls = (Class<T>) ((ClassBasedDeclarationContainer) kClass).mo88354d();
        if (cls.isPrimitive()) {
            return cls;
    ...
    public static final <T> KClass<T> m88344e(@NotNull Class<T> cls) {
        cls.getClass();
        return Reflection.m88396b(cls);
    }
}
