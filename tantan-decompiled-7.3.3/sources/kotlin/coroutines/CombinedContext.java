...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    public static Unit m88244a(CoroutineContext[] coroutineContextArr, Ref.IntRef intRef, Unit unit, CoroutineContext.Element element) {
        unit.getClass();
        element.getClass();
    ...
    public static String m88245c(String str, CoroutineContext.Element element) {
        str.getClass();
        element.getClass();
        if (str.length() == 0) {
    ...
    private final boolean contains(CoroutineContext.Element element) {
        return Intrinsics.m88377d(get(element.getKey()), element);
    }
    ...
    private final Object writeReplace() {
        ...
        fold(Unit.INSTANCE, new Function2() { // from class: l.nf5
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return CombinedContext.m88244a(coroutineContextArr, intRef, (Unit) obj, (CoroutineContext.Element) obj2);
            }
        });
    ...
    public /* bridge */ CoroutineContext plus(@NotNull CoroutineContext coroutineContext) {
        return CoroutineContext.DefaultImpls.m88250b(this, coroutineContext);
    }

    @NotNull
    public String toString() {
        return "[" + ((String) fold("", new Function2() { // from class: l.of5
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return CombinedContext.m88245c((String) obj, (CoroutineContext.Element) obj2);
            }
        })) + ']';
    }
}
