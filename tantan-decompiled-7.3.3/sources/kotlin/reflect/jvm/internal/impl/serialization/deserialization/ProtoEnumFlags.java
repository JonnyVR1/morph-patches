...
public final class ProtoEnumFlags {
    ...
    public static final /* synthetic */ class WhenMappings {
        ...
        public static final /* synthetic */ int[] f66713b;

        /* JADX INFO: renamed from: c */
        public static final /* synthetic */ int[] f66714c;

        /* JADX INFO: renamed from: d */
        public static final /* synthetic */ int[] f66715d;

        /* JADX INFO: renamed from: e */
        public static final /* synthetic */ int[] f66716e;

        /* JADX INFO: renamed from: f */
        public static final /* synthetic */ int[] f66717f;

        /* JADX INFO: renamed from: g */
        public static final /* synthetic */ int[] f66718g;

        /* JADX INFO: renamed from: h */
        public static final /* synthetic */ int[] f66719h;
    ...
    @NotNull
    /* JADX INFO: renamed from: a */
    public final ClassKind m93135a(@Nullable ProtoBuf.Class.Kind kind) {
        switch (kind == null ? -1 : WhenMappings.f66715d[kind.ordinal()]) {
            case 1:
    ...
    @NotNull
    /* JADX INFO: renamed from: b */
    public final Modality m93136b(@Nullable ProtoBuf.Modality modality) {
        int i = modality == null ? -1 : WhenMappings.f66712a[modality.ordinal()];
        if (i == 1) {
    ...
    @NotNull
    /* JADX INFO: renamed from: c */
    public final Variance m93137c(@NotNull ProtoBuf.Type.Argument.Projection projection) {
        projection.getClass();
        int i = WhenMappings.f66718g[projection.ordinal()];
        if (i == 1) {
        ...
        ypg0.m217021a("Only IN, OUT and INV are supported. Actual argument: ", projection);
        return null;
    }

    @NotNull
    /* JADX INFO: renamed from: d */
    public final Variance m93138d(@NotNull ProtoBuf.TypeParameter.Variance variance) {
        variance.getClass();
        int i = WhenMappings.f66717f[variance.ordinal()];
        if (i == 1) {
            return Variance.IN_VARIANCE;
        }
        if (i == 2) {
