...
public abstract class DeclarationDescriptorImpl extends AnnotatedImpl implements DeclarationDescriptor {
    ...
    private static /* synthetic */ void m89597P(int i) {
    ...
    public static String m89598l0(@NotNull DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            m89597P(4);
        }
        try {
            return DescriptorRenderer.f66419j.mo92338O(declarationDescriptor) + "[" + declarationDescriptor.getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(declarationDescriptor)) + Constants.AES_SUFFIX;
