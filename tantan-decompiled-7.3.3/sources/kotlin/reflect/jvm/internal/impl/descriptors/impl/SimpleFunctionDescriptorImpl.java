...
public class SimpleFunctionDescriptorImpl extends FunctionDescriptorImpl implements SimpleFunctionDescriptor {
    ...
    private static /* synthetic */ void m89788P(int i) {
    ...
    public static SimpleFunctionDescriptorImpl m89789e1(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, @NotNull Name name, @NotNull CallableMemberDescriptor.Kind kind, @NotNull SourceElement sourceElement) {
        if (declarationDescriptor == null) {
            m89788P(5);
        }
        if (annotations == null) {
    ...
    public SimpleFunctionDescriptor mo89343a0(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z) {
        SimpleFunctionDescriptor simpleFunctionDescriptor = (SimpleFunctionDescriptor) super.mo89343a0(declarationDescriptor, modality, descriptorVisibility, kind, z);
    ...
    public SimpleFunctionDescriptor mo89336a() {
        SimpleFunctionDescriptor simpleFunctionDescriptor = (SimpleFunctionDescriptor) super.mo89336a();
        if (simpleFunctionDescriptor == null) {
            m89788P(24);
        }
        return simpleFunctionDescriptor;
    ...
    public SimpleFunctionDescriptorImpl mo89634K0(@Nullable ReceiverParameterDescriptor receiverParameterDescriptor, @Nullable ReceiverParameterDescriptor receiverParameterDescriptor2, @NotNull List<ReceiverParameterDescriptor> list, @NotNull List<? extends TypeParameterDescriptor> list2, @NotNull List<ValueParameterDescriptor> list3, @Nullable KotlinType kotlinType, @Nullable Modality modality, @NotNull DescriptorVisibility descriptorVisibility) {
        ...
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplMo89793h1 = mo89793h1(receiverParameterDescriptor, receiverParameterDescriptor2, list, list2, list3, kotlinType, modality, descriptorVisibility, null);
    ...
    public SimpleFunctionDescriptorImpl mo89793h1(@Nullable ReceiverParameterDescriptor receiverParameterDescriptor, @Nullable ReceiverParameterDescriptor receiverParameterDescriptor2, @NotNull List<ReceiverParameterDescriptor> list, @NotNull List<? extends TypeParameterDescriptor> list2, @NotNull List<ValueParameterDescriptor> list3, @Nullable KotlinType kotlinType, @Nullable Modality modality, @NotNull DescriptorVisibility descriptorVisibility, @Nullable Map<? extends CallableDescriptor.UserDataKey<?>, ?> map) {
        ...
        super.mo89634K0(receiverParameterDescriptor, receiverParameterDescriptor2, list, list2, list3, kotlinType, modality, descriptorVisibility);
        if (map != null && !map.isEmpty()) {
            this.f64829D = new LinkedHashMap(map);
        }
        return this;
    }
    ...
    public FunctionDescriptor.CopyBuilder<? extends SimpleFunctionDescriptor> mo89405k() {
        FunctionDescriptor.CopyBuilder copyBuilderMo89405k = super.mo89405k();
        if (copyBuilderMo89405k == null) {
            m89788P(30);
        }
        return copyBuilderMo89405k;
    }
}
