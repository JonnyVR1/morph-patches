...
public final class KMutableProperty0Impl<V> extends KProperty0Impl<V> implements KMutableProperty0<V> {
    ...
    public static final class Setter<R> extends KPropertyImpl.Setter<R> implements KMutableProperty0.Setter<R> {
        ...
        public KMutableProperty0Impl<R> mo88499g() {
            return this.property;
        }

        /* JADX INFO: renamed from: h0 */
        public void m88764h0(R value) throws IllegalCallableAccessException {
            mo88499g().m88761t0(value);
        }
    ...
    public KMutableProperty0Impl(@NotNull KDeclarationContainerImpl kDeclarationContainerImpl, @NotNull String str, @NotNull String str2, @Nullable Object obj) {
        ...
        str.getClass();
        str2.getClass();
        this._setter = LazyKt__LazyJVMKt.m88117a(LazyThreadSafetyMode.PUBLICATION, new uxq(this));
    }

    /* JADX INFO: renamed from: q0 */
    public static final Setter m88758q0(KMutableProperty0Impl kMutableProperty0Impl) {
    ...
    public void m88761t0(V value) throws IllegalCallableAccessException {
