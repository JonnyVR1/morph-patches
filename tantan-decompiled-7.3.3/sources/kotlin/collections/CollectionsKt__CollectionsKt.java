...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    @SourceDebugExtension
    public static final class C152291<T> implements Function1<T, Integer> {
        ...
        public C152291(Function1 function1, Comparable comparable) {
        ...
        public final Integer invoke(T t) {
            return Integer.valueOf(go5.m131087d((Comparable) this.$selector.invoke(t), this.$key));
        }
    }
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(@NotNull List<? extends T> list, @Nullable K k, int i, int i2, @NotNull Function1<? super T, ? extends K> function1) {
        list.getClass();
        function1.getClass();
        return binarySearch(list, i, i2, new C152291(function1, k));
    }
    ...
    public static /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i, int i2, Function1 function1, int i3, Object obj) {
        ...
        list.getClass();
        function1.getClass();
        return binarySearch(list, i, i2, new C152291(function1, comparable));
    }
    ...
    private static final void rangeCheck$CollectionsKt__CollectionsKt(int i, int i2, int i3) {
        if (i2 > i3) {
            vsd0.m202605a("fromIndex (", i2, ") is greater than toIndex (", i3, ").");
        } else if (i2 < 0) {
            bqg0.m105918a("fromIndex (", i2, ") is less than zero.");
        } else {
            if (i3 <= i) {
                return;
            }
            z8g0.m218966a("toIndex (", i3, ") is greater than size (", i);
        }
    }
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(@NotNull List<? extends T> list, @Nullable T t, int i, int i2) {
        ...
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
            int iM131087d = go5.m131087d(list.get(i4), t);
            if (iM131087d < 0) {
                i = i4 + 1;
            } else {
                if (iM131087d <= 0) {
