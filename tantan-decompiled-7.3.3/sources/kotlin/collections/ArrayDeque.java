...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    private final void ensureCapacity(int minCapacity) {
        if (minCapacity < 0) {
            wtq0.m207906a("Deque is too big.");
            return;
        }
        ...
        if (objArr == emptyElementData) {
            this.elementData = new Object[C15274a.m88486b(minCapacity, 10)];
        } else {
    ...
    public final E first() {
        ...
        npj0.m164229a("ArrayDeque is empty.");
        return null;
    }
    ...
    public int indexOf(Object element) {
        ...
        if (length < iPositiveMod) {
            while (length < iPositiveMod) {
                if (Intrinsics.m88377d(element, this.elementData[length])) {
                    i = this.head;
                } else {
                    length++;
                }
        ...
        for (int i2 = 0; i2 < iPositiveMod; i2++) {
            if (Intrinsics.m88377d(element, this.elementData[i2])) {
    ...
    public int lastIndexOf(Object element) {
        ...
        if (i2 < iPositiveMod) {
            ...
            if (i2 <= lastIndex) {
                while (!Intrinsics.m88377d(element, this.elementData[lastIndex])) {
                    if (lastIndex != i2) {
                        lastIndex--;
                    }
                }
        ...
        if (i2 > iPositiveMod) {
            do {
                ...
                return lastIndex - i;
            } while (!Intrinsics.m88377d(element, objArr[iPositiveMod]));
    ...
    public ArrayDeque(int i) {
        ...
        if (i == 0) {
            ...
            za50.m219101a("Illegal Capacity: ", i);
            throw null;
        }
        this.elementData = objArr;
    }
