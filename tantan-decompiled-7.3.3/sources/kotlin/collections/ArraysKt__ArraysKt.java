...
public class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr != objArr2) {
                ...
                if ((objArr instanceof Object[]) && (objArr2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m225291contentEqualskV0jMPg(((UByteArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String(), ((UByteArray) objArr2).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String())) {
                        return false;
                    }
                } else if ((objArr instanceof UShortArray) && (objArr2 instanceof UShortArray)) {
                    if (!UArraysKt.m225289contentEqualsFGO6Aew(((UShortArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String(), ((UShortArray) objArr2).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String())) {
                        return false;
                    }
                } else if ((objArr instanceof UIntArray) && (objArr2 instanceof UIntArray)) {
                    if (!UArraysKt.m225290contentEqualsKJPZfPQ(((UIntArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String(), ((UIntArray) objArr2).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String())) {
                        return false;
                    }
                } else if ((objArr instanceof ULongArray) && (objArr2 instanceof ULongArray)) {
                    if (!UArraysKt.m225292contentEqualslec5QzE(((ULongArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String(), ((ULongArray) objArr2).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String())) {
                        return false;
                    }
                } else if (!Intrinsics.m88377d(objArr, objArr2)) {
                    return false;
                }
            }
        }
    ...
    public static final <T> String contentDeepToString(@Nullable T[] tArr) {
        ...
        StringBuilder sb = new StringBuilder((C15274a.m88489e(tArr.length, 429496729) * 5) + 2);
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (objArr == 0) {
                ...
                sb.append(UArraysKt.m225297contentToString2csIQuQ(((UByteArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String()));
            } else if (objArr instanceof UShortArray) {
                sb.append(UArraysKt.m225299contentToStringd6D3K8(((UShortArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String()));
            } else if (objArr instanceof UIntArray) {
                sb.append(UArraysKt.m225298contentToStringXUkPCBk(((UIntArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String()));
            } else if (objArr instanceof ULongArray) {
                sb.append(UArraysKt.m225300contentToStringuLth9ew(((ULongArray) objArr).getCom.google.android.libraries.places.api.model.PlaceTypes.STORAGE java.lang.String()));
            } else {
