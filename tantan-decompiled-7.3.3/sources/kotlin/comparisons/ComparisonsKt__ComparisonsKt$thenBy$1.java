...
public final class ComparisonsKt__ComparisonsKt$thenBy$1<T> implements Comparator {
    ...
    public final /* synthetic */ Comparator<T> f64099a;

    /* JADX INFO: renamed from: b */
    public final /* synthetic */ Function1<T, Comparable<?>> f64100b;

    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int iCompare = this.f64099a.compare(t, t2);
        if (iCompare != 0) {
            return iCompare;
        }
        Function1<T, Comparable<?>> function1 = this.f64100b;
