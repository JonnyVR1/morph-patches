...
val gmsCompatibilityPatch = bytecodePatch(
    ...
    execute {
        ...
        // REMOVED: Three broad classDefForEach loops that corrupted zzo class
        // These loops scanned all 50,000+ classes and caused VerifyError crashes
        // despite multiple zzo exclusion attempts. Targeted patches above are sufficient.
