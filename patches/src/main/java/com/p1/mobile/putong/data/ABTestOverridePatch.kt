...
private fun buildI0Instructions(paramReg: Int, useV2: Boolean): String {
    val resultReg = if (useV2) "v2" else "v1"
    return """
        move-object v0, v$paramReg

        const-string v1, "chat_newmatch_continue"
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_chat_newmatch
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_quick_message
        const-string v0, "exp"
        return-object v0
        :skip_quick_message
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_batch_icebreak
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_icebreak_lead
        const-string v0, "exp"
        return-object v0
        :skip_icebreak_lead
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_chat_match
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_chat_view_opt
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_chat_cell
        const-string v0, "exp"
        return-object v0
        :skip_chat_cell
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_verified_chat
        const-string v0, "exp"
        return-object v0
        :skip_verified_chat
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_push_largepic
        const-string v0, "exp"
        return-object v0
        :skip_push_largepic
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_surprisebox
        const-string v0, "exp"
        return-object v0
        :skip_surprisebox
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_quickchat_ring
        const-string v0, "exp1"
        return-object v0
        :skip_quickchat_ring
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_anti_harass
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_friend_remind
        const-string v0, "exp"
        return-object v0
        :skip_friend_remind
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_heartbeat
...
private fun buildJ0Instructions(paramReg: Int, useV2: Boolean): String {
    val resultReg = if (useV2) "v2" else "v1"
    return """
        move-object v0, v$paramReg
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_instantmatch
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_iap_page
        ...
        invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
        move-result $resultReg
        if-eqz $resultReg, :skip_card_tag
        ...
        classDefByOrNull("Lcom/p1/mobile/putong/api/ABManager;")?.let { classDef ->
            ...
            mutableClassDef.methods
                ...
                .forEach { method ->
                    ...
                    when {
                        registerCount >= 3 -> {
                            method.addInstructions(0, buildI0Instructions(paramReg, useV2 = true))
                        }
                        registerCount == 2 -> {
                            method.addInstructions(0, buildI0Instructions(paramReg, useV2 = false))
                        }
                    }
                }
            ...
            mutableClassDef.methods
                ...
                .forEach { method ->
                    ...
                    when {
                        registerCount >= 3 -> {
                            method.addInstructions(0, buildJ0Instructions(paramReg, useV2 = true))
                        }
                        registerCount == 2 -> {
                            method.addInstructions(0, buildJ0Instructions(paramReg, useV2 = false))
                        }
                    }
                }
        }
